...
const IrDropdown = class {
    ...
    render() {
        return (h("div", { key: 'd57e304735578fefcdb51ff8b4973535bb12dc77', class: "dropdown-container" }, h("button", { key: '51628e4ae49365c479e53b4993bee93ff98e8005', ref: el => (this.buttonRef = el), type: "button", class: "SelectTrigger", "aria-haspopup": "listbox", "aria-expanded": this.isDropdownVisible.toString(), onClick: () => this.toggleDropdown() }, h("slot", { key: '8ff00b7b7e50c80192c01dbb74901ab81f3a14e2', name: "dropdown-trigger-body" }, this.selectedItemName || this.dropdownTitle), h("svg", { key: 'f67cd84091b9ba21f878f77c843e62fcf9c727a2', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '1cb64571a152fda9ed81047d9531141944cc8cd9', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))), this.isDropdownVisible && (h("ul", { class: "SelectContent", role: "listbox", ref: el => (this.listRef = el), tabindex: "-1" }, this.itemNames.map((item, index) => (h("li", { "data-disabled": item.disabled, "data-state": this.currentHighlightedIndex === index ? 'checked' : 'unchecked', "data-highlighted": this.currentHighlightedIndex === index ? 'true' : 'false', class: 'combobox-item', tabindex: item.disabled ? -1 : 0, role: "option", "aria-disabled": item.disabled ? 'true' : 'false', "aria-selected": this.selectedItemName === item.item ? 'true' : 'false', onClick: () => {
