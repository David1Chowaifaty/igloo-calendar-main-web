import { L as toDate, M as startOfWeek, N as defaultOptions, O as enUS, P as isSameWeek, e as dateFns, b as app_store, d as booking_store, p as modifyBookingStore, a as createStore, Q as injectHTML, t as getDateDifference, l as localizedWords } from './utils-95187352.js';
...
class PaymentService {
    ...
    async GeneratePaymentCaller({ token, params, onRedirect, onScriptRun, }) {
        ...
        const { data } = await axios$1.post('/Generate_Payment_Caller', Object.assign(Object.assign({}, params), { callback_url: `https://${app_store.property.perma_link}.bookingmystay.com/invoice` }), { headers: { Authorization: token } });
        if (data['ExceptionMsg'] !== '') {
            throw new Error(data.ExceptionMsg);
        }
        const res = data['My_Result'];
...
//# sourceMappingURL=Token-488b707d.js.map