...
var _index2$1A = defaultOptions$1;
...
function startOfWeek(date, options) {
  const defaultOptions = (0, _index2$1A.getDefaultOptions)();
  const weekStartsOn =
...
function isSameWeek(dateLeft, dateRight, options) {
  const dateLeftStartOfWeek = (0, _index$3X.startOfWeek)(dateLeft, options);
  const dateRightStartOfWeek = (0, _index$3X.startOfWeek)(dateRight, options);
...
var _index$3U = buildFormatLongFn$1;
...
(formatLong.formatLong = {
  date: (0, _index$3U.buildFormatLongFn)({
    formats: dateFormats,
    defaultWidth: "full",
  }),

  time: (0, _index$3U.buildFormatLongFn)({
    formats: timeFormats,
    defaultWidth: "full",
  }),

  dateTime: (0, _index$3U.buildFormatLongFn)({
...
export { MissingTokenError as M, Token as T, buildLocalizeFn$1 as a, buildFormatLongFn$1 as b, buildMatchFn$1 as c, buildMatchPatternFn$1 as d, formatRelative$3 as e, formatDistance$3 as f, enUS as g, dateFns as h, isSameWeek$1 as i, localize as l, match as m, toDate$1 as t };

//# sourceMappingURL=index-f5b207f5.js.map