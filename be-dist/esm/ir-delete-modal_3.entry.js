...
import { H as HouseKeepingService, h as housekeeping_store, g as getDefaultProperties } from './housekeeping.service-0fce7ec1.js';
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (h(Host, { key: '2ae1e964e281522587f3c03b00e71c62d2cab3ee' }, h("ir-title", { key: '6cc6356ffd9fc4815be01769e630a5977ed3e9b7', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: 'd41de302b4e912f919c89c8c3016cec14bd9d9b2', class: "px-1" }, h("table", { key: '03d38e71e8d7ab739e06830dbdb21eda62351770' }, h("thead", { key: '67fe054dfd9b79dfd376cb5ffd0968c8662b771b' }, h("th", { key: '84defb427feedf5319940fbfa5463fd64ba8396f', class: "sr-only" }, "room name"), h("th", { key: 'b5499567b62852a3ecb18b39013d684c00d28989', class: "sr-only" }, "housekeeper name"), h("th", { key: '2bfca2497147c50d9a5f5fe90e1f08627de5f691', class: "sr-only" }, "actions")), h("tbody", { key: '21af5a6e627e9ba9628fba55b892b9faf3928ac1' }, this.renderRooms())), h("div", { key: '18e28373dca2fb52a4beecbefe8a05ab662e8301', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: '680a3a5b1f487696b8e674c03197431f56d181d9', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: 'fa0219d63a73e912100aaaf9c9bfb1064ca949aa', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e2d34ad689c874d63a21a71146cb844ba7051e08' }, h("ir-title", { key: '2a2e636e7b8fcf5f382cc14b1d0254611eca5c20', class: "px-1", displayContext: "sidebar", label: this.isEdit ? locales.entries.Lcz_EditHousekeeperProfile : locales.entries.Lcz_CreateHousekeeperProfile }), h("section", { key: 'be5a6afa55cc2a0614e51fda5abdd6d83fb77edb', class: "px-1" }, h("ir-input-text", { key: '57b57ba61bf02f069874a8c0d3f580dfc4280941', error: ((_b = (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.length) > 0, label: locales.entries.Lcz_Name, placeholder: locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this) }), h("ir-phone-input", { key: '882891dc379a705be26d0602c51b51c40613b79c', placeholder: locales.entries.Lcz_Mobile, error: ((_d = (_c = this.errors) === null || _c === void 0 ? void 0 : _c.mobile) === null || _d === void 0 ? void 0 : _d.length) > 0, language: this.default_properties.language, token: this.default_properties.token, default_country: calendar_data.country.id, phone_prefix: (_e = this.user) === null || _e === void 0 ? void 0 : _e.phone_prefix, label: locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), h("ir-input-text", { key: '5ce57cb66a809a78ee5a70b91373dc75a4b742b5', disabled: this.user !== null, label: locales.entries.Lcz_Username, placeholder: locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), h("ir-input-text", { key: '7d55b85040d6b85cb5c00dc4783604c479d3cb67', label: locales.entries.Lcz_Password, placeholder: locales.entries.Lcz_MinimumCharacter, value: this.userInfo.password, type: "password", error: ((_g = (_f = this.errors) === null || _f === void 0 ? void 0 : _f.password) === null || _g === void 0 ? void 0 : _g.length) > 0, onTextChange: e => this.updateUserField('password', e.detail) }), h("ir-input-text", { key: '7eaba2b193edc5136303a1be2aa9f88697f425eb', label: locales.entries.Lcz_Note, placeholder: locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) }), h("div", { key: '9a4ceb3b86e2a1d8fd194fe747462dab71041d83', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: 'ddfcaeeb0cd093919ccc48b9ad9f83ae35aadd3a', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: '39a2f35f6130b5594fa1a850487957924dbbc85e', isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: locales.entries.Lcz_Save })))));
    }
};
