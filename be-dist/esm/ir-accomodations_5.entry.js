import { r as registerInstance, h, c as createEvent, F as Fragment, H as Host, g as getElement } from './index-21632897.js';
import { o as onAppDataChange } from './app.store-8618e61b.js';
import { l as localizedWords } from './localization.store-fa344f38.js';
...
const IrCarousel = class {
    ...
    render() {
        return (h("div", { key: 'ece6c3a11a5efdb27541d8f0a3c1672f8ce14b1c', class: "swiper", ref: el => (this.carouselEl = el) }, h("div", { key: 'f16d16ad4253ba39fdfcf5f3604c6f687c910a12', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide" }, h("img", { src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: 'c54f79c03f162c193280b5052f27027562693a3b', class: "swiper-pagination" }), h("div", { key: 'b44ec876afda85c7af354330a64cff2e724fab71', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: '37e013b9ff6aeda378ab52eb65391550a8f7e1f4', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'fc875b37800c56a9b9cf1c68288c46a1f4c0d702', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '03304fdc83203fb76090f4b3fe8fafe79b8d9085', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '430814ec40c0fa0aad8530e193cfa3c655eb9f5f', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '936c1780ac3bfc685b33ae7d2305398f00c8816f', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
};
...
const IrGallery = class {
    ...
    render() {
        return (h("div", { key: '55d543d9e2f7f0f3e99559c4919e291c61d590f3', class: "gallery-container" }, this.totalImages > 0 && (h("button", { onClick: () => this.openGallery.emit(null), class: "total-images-number" }, h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "14", width: "15.75", viewBox: "0 0 576 512" }, h("path", { fill: "currentColor", d: "M160 80H512c8.8 0 16 7.2 16 16V320c0 8.8-7.2 16-16 16H490.8L388.1 178.9c-4.4-6.8-12-10.9-20.1-10.9s-15.7 4.1-20.1 10.9l-52.2 79.8-12.4-16.9c-4.5-6.2-11.7-9.8-19.4-9.8s-14.8 3.6-19.4 9.8L175.6 336H160c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16zM96 96V320c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H160c-35.3 0-64 28.7-64 64zM48 120c0-13.3-10.7-24-24-24S0 106.7 0 120V344c0 75.1 60.9 136 136 136H456c13.3 0 24-10.7 24-24s-10.7-24-24-24H136c-48.6 0-88-39.4-88-88V120zm208 24a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), h("span", null, this.totalImages, " +"))), h("div", { key: '9347b9ebea5888bc2021cb43cc7798cfc973fd5b', class: "swiper", ref: el => (this.carouselEl = el) }, h("div", { key: '16849e2b0d60774123a43099280184b20fa7c537', class: "swiper-wrapper" }, this.images.map(image => (h("div", { class: "swiper-slide" }, h("button", { class: "absolute" }, h("p", { class: "sr-only" }, "open gallery")), h("img", { onClick: () => this.openGallery.emit(null), draggable: false, src: image.url, alt: image.alt }))))), h("div", { key: '0e375c813e45c7681704b6cb15db2f7a46d43553', class: "swiper-button-prev", ref: el => (this.prevEl = el) }, h("svg", { key: 'e747d0b657205be3a327557c7d9d45949ef390b3', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'a7c659ee586551e60f0e1ca215d0f20e33b4c1a8', d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '55f87fcf280510dcb1615227f84d1fd3452ae25a', class: "swiper-button-next", ref: el => (this.nextEl = el) }, h("svg", { key: '7ae6d4d16309788790140d7863cde36a65944192', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '8ee8ada3f6575a8b9dc480e8e13bb12aa71985cc', d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), h("div", { key: '5c70411bfc35848ba8e7624c8027b23ff1aa3d6b', class: "gallery" }, this.images.map(image => (h("figure", { class: "gallery-item" }, h("button", { class: "absolute" }, h("p", { class: "sr-only" }, "open gallery")), h("img", { onClick: () => this.openGallery.emit(null), src: image.url, alt: image.alt })))))));
    }
};
