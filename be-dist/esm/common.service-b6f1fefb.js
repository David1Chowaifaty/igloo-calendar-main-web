import { L as toDate, M as startOfWeek, N as defaultOptions, O as enUS, P as isSameWeek, e as dateFns, b as app_store, d as booking_store, p as modifyBookingStore, a as createStore, Q as injectHTML, t as getDateDifference, l as localizedWords } from './utils-eb7b05fd.js';
...
class PaymentService {
    ...
    async GeneratePaymentCaller({ token, params, onRedirect, onScriptRun, }) {
        ...
        const { data } = await axios$1.post(`/Generate_Payment_Caller`, Object.assign(Object.assign({}, params), { callback_url: `https://${app_store.property.perma_link}.bookingmystay.com/invoice` }));
        if (data['ExceptionMsg'] !== '') {
            throw new Error(data.ExceptionMsg);
        }
        const res = data['My_Result'];
    ...
    processAlicablePolicies(policies, book_date) {
        ...
        let cancelation = policies.find(po => { var _a; return po.type === 'cancelation' && ((_a = po === null || po === void 0 ? void 0 : po.brackets) === null || _a === void 0 ? void 0 : _a.some(b => dateFns.isBefore(book_date, new Date(b.due_on)) || dateFns.isSameDay(new Date(b.due_on), book_date), book_date)); });
        if (cancelation) {
            isInFreeCancelationZone = true;
            const cancelationAmount = (_d = (_c = cancelation.brackets.find(b => dateFns.isBefore(book_date, new Date(b.due_on)) || dateFns.isSameDay(new Date(b.due_on), book_date))) === null || _c === void 0 ? void 0 : _c.gross_amount) !== null && _d !== void 0 ? _d : null;
...
export { CommonService as C, PropertyService as P, Token as T, axios$1 as a, PaymentService as b, checkout_store as c, updatePickupFormData as d, updatePartialPickupFormData as e, onCheckoutDataChange as o, updateUserFormData as u };

//# sourceMappingURL=common.service-b6f1fefb.js.map