import { H as toDate, I as startOfWeek, J as defaultOptions, K as enUS, L as isSameWeek, d as dateFns, a as app_store, b as booking_store, k as modifyBookingStore, c as createStore, M as injectHTML, q as getDateDifference, w as calculateTotalCost, l as localizedWords } from './utils-409b836b.js';
...
class PaymentService extends Token {
    ...
    async GeneratePaymentCaller({ token, params, onRedirect, onScriptRun, }) {
        ...
        const { data } = await axios$1.post(`/Generate_Payment_Caller?Ticket=${token}`, Object.assign(Object.assign({}, params), { callback_url: `https://${app_store.property.perma_link}.bookingmystay.com/invoice` }));
        if (data['ExceptionMsg'] !== '') {
            throw new Error(data.ExceptionMsg);
        }
        const res = data['My_Result'];
...
//# sourceMappingURL=common.service-14da73ed.js.map