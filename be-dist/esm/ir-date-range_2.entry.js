...
const IrPopover = class {
    ...
    render() {
        return (h(Fragment, { key: '17d780f16bb26d386a7139f1aee84c963c8745d5' }, this.isMobile && (h("div", { key: '2e9aee5077c96951b214b60290dae861e5c21e54', class: "w-full md:hidden" }, h("div", { key: '1504c97fe2033c4566261ff3af286c1d3a61c2fe', class: "w-full", onClick: () => {
                this.dialogElement.openModal();
            } }, h("slot", { key: '8e321b3d7353f1c7bb76c769cdd52eeedbdca933', name: "trigger" })), h("ir-dialog", { key: '8ec59fa9ea28c83063c8d3b775d1205fd538907d', closeButton: this.showCloseButton, ref: el => (this.dialogElement = el), onOpenChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isDialogOpen = e.detail;
                this.openChange.emit(e.detail);
            } }, h("div", { key: 'fb42e3e6d31bb16af7c2d0b3d624e1217fb06bd7', slot: "modal-body" }, h("slot", { key: '5003bdefe35e08f60624c1b3becbd2eca80ef828', name: "popover-content" }))))), !this.isMobile && (h("div", { key: 'aec2d470eabcc876b5066c687c6b5993a472c744', class: "hidden sm:block" }, h("div", { key: '97a8073723da26d1bd0d338eb1765927a3efc227', ref: el => (this.triggerElement = el), onClick: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.toggleVisibility();
            } }, h("slot", { key: '177537434a3ac8c850b5fe9405f9ee76d257f180', name: "trigger" }, h("button", { key: '8dd5bc7f816c1c41fdd95ea1729cacd8a9a17287', class: "trigger" }, h("span", { key: 'b294e726868916a5e22713f7f18733ce4689c58f' }, this.trigger_label), h("svg", { key: '3ade871e954ac6be4e2bd5eb75b8f098023dfd4c', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '9bf8a4153cfa0a18cf2f3d75857bdf58e9e4d516', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), h("div", { key: '73949e6f0b859cf577452f7ea44aa707456ae4ad', class: "popover-content", ref: el => (this.contentElement = el) }, this.isVisible && (h("div", { key: '6d81588f4873c6ee75e8629e763bfe8ad4bfe26f' }, h("slot", { key: '6e0a1bde25cf9b7da6b661ec7938860b283b65c3', name: "popover-content" }))))))));
    }
