...
const IrDateRange = class {
    ...
    handleFromDateChange(newValue, oldValue) {
        if (!dateFns.isSameDay(newValue || new Date(), oldValue || new Date())) {
...
const IrPopover = class {
    ...
    render() {
        return (h(Fragment, { key: 'c46c5a9081e53869dcb721b6b3870ffd6aa2d7a4' }, this.isMobile && (h("div", { class: "w-full md:hidden" }, h("div", { class: "w-full", onClick: () => {
