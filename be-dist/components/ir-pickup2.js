...
import { P as PickupService } from './pickup.service.js';
import { b as app_store, o as onAppDataChange } from './app.store.js';
import { l as localizedWords, b as booking_store, u as formatAmount } from './utils.js';
...
const PickupFormData = z.object({
    ...
    arrival_date: z.custom((val) => hooks.isMoment(val), {
