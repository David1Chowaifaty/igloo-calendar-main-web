...
const IrPickup = /*@__PURE__*/ proxyCustomElement(class IrPickup extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("section", { key: '08f49f487eee85456204b5a04789915de0aa7eca', class: "space-y-5" }, h("div", { key: '9691a84c25376f687e7c93c81d9af320d2126220', class: "flex items-center gap-2 rounded-md bg-gray-100 px-4 py-2" }, h("ir-icons", { key: '53636baf34d34fda3fb92f90863d2494e656ce9e', name: "car" }), h("p", { key: '80bef8131479c2e0d5acd5fbc172e0b7bc4bcb5d' }, "Need Pickup?"), h("ir-select", { key: 'e2c038710579d95df21c29b01cc99e61c71f1dac', value: (_a = checkout_store.pickup) === null || _a === void 0 ? void 0 : _a.location, onValueChange: this.handleLocationChange.bind(this), data: [{ id: -1, value: 'No thank you' }, ...this.pickupService.getAvailableLocations('yes from')] })), checkout_store.pickup.location && (h("div", { class: 'flex items-center  justify-between' }, h("div", { class: "flex-1 space-y-5" }, h("div", { class: 'flex items-center gap-4' }, h("ir-popover", { ref: el => (this.popover = el), class: "w-fit" }, this.dateTrigger(), h("div", { slot: "popover-content", class: "date-range-container w-full border-0 p-2 shadow-none sm:w-auto sm:border sm:shadow-sm md:p-4 " }, h("ir-calendar", null))), h("ir-input", { onTextChanged: e => updatePickupFormData('arrival_time', e.detail), label: "Arrival hour",
            // placeholder="HH:MM"
