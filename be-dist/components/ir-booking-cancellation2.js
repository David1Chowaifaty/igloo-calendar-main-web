...
const IrBookingCancellation = /*@__PURE__*/ proxyCustomElement(class IrBookingCancellation extends HTMLElement {
    ...
    static get style() { return IrBookingCancellationStyle0; }
}, [1, "ir-booking-cancellation", {
        "property_id": [2],
        "booking": [16],
        "isLoading": [32],
        "isOpen": [32],
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-cancellation", "ir-alert-dialog", "ir-button", "ir-icons", "ir-skeleton"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-booking-cancellation":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrBookingCancellation);
            }
            break;
...
export { IrBookingCancellation as I, defineCustomElement as d };

//# sourceMappingURL=ir-booking-cancellation2.js.map