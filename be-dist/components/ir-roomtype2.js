...
const IrRoomtype = /*@__PURE__*/ proxyCustomElement(class IrRoomtype extends HTMLElement {
    ...
    static get style() { return IrRoomtypeStyle0; }
}, [1, "ir-roomtype", {
        "roomtype": [16]
    }]);
function defineCustomElement() {
    ...
    const components = ["ir-roomtype", "ir-accomodations", "ir-button", "ir-carousel", "ir-dialog", "ir-gallery", "ir-icons", "ir-property-gallery", "ir-rateplan", "ir-room-type-amenities", "ir-select", "ir-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-roomtype":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrRoomtype);
            }
            break;
...
export { IrRoomtype as I, defineCustomElement as d };

//# sourceMappingURL=ir-roomtype2.js.map