...
const IrCalendar = /*@__PURE__*/ proxyCustomElement(class IrCalendar extends HTMLElement {
    ...
    handleDateChange(newDate, oldDate) {
        if (!dateFns.isSameDay(newDate, oldDate)) {
