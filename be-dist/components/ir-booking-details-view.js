...
function defineCustomElement$1() {
    ...
    const components = ["ir-booking-details-view", "ir-alert-dialog", "ir-booking-cancelation", "ir-button", "ir-facilities", "ir-icons", "ir-skeleton"];
