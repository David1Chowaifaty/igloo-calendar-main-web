...
import { u as getDateDifference, l as localizedWords, d as dateFns, r as formatAmount } from './utils.js';
...
import { d as defineCustomElement$4 } from './ir-facilities2.js';
...
const IrBookingDetailsView$1 = /*@__PURE__*/ proxyCustomElement(class IrBookingDetailsView extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return IrBookingDetailsViewStyle0; }
}, [1, "ir-booking-details-view", {
        "booking": [1040]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["ir-booking-details-view", "ir-alert-dialog", "ir-booking-cancellation", "ir-button", "ir-facilities", "ir-icons", "ir-skeleton"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-booking-details-view":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrBookingDetailsView$1);
            }
            break;
...
const IrBookingDetailsView = IrBookingDetailsView$1;
const defineCustomElement = defineCustomElement$1;

export { IrBookingDetailsView, defineCustomElement };
