...
const IrCreditCardInput$1 = /*@__PURE__*/ proxyCustomElement(class IrCreditCardInput extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-credit-card-input":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrCreditCardInput$1);
            }
            break;
    } });
}

const IrCreditCardInput = IrCreditCardInput$1;
const defineCustomElement = defineCustomElement$1;

export { IrCreditCardInput, defineCustomElement };
