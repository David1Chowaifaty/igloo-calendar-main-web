...
import { o as getUserPreference, w as checkAffiliate, l as localizedWords } from './utils.js';
...
import { d as defineCustomElement$s } from './ir-booking-cancellation2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-listing", "ir-alert-dialog", "ir-auth", "ir-badge", "ir-badge-group", "ir-booking-cancellation", "ir-booking-card", "ir-booking-code", "ir-booking-header", "ir-booking-overview", "ir-button", "ir-checkbox", "ir-dialog", "ir-footer", "ir-google-maps", "ir-icons", "ir-input", "ir-interceptor", "ir-invoice", "ir-language-picker", "ir-menu", "ir-modal", "ir-nav", "ir-pagination", "ir-phone-input", "ir-privacy-policy", "ir-select", "ir-sheet", "ir-signin", "ir-signup", "ir-skeleton", "ir-user-avatar", "ir-user-profile"];
