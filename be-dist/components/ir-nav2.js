...
const IrNav = /*@__PURE__*/ proxyCustomElement(class IrNav extends HTMLElement {
    ...
    render() {
        ...
        return (h(Fragment, { key: '74d75d6bacf84ba859d461b75dcc0c38bae14605' }, h("nav", { key: '8beba46f47d8d3ba050c3478a7f2a0fd95615225', class: "ir-nav" }, h("div", { key: 'f3fbd4cc3deca3d547c16417ec6dd2ad6ad57045', class: "ir-nav-container", "data-state": isInjected ? 'injected' : 'default' }, !isInjected && (h("div", { key: '56ece3fa329cbba2f55eea8f346650af0d119afc', class: "ir-nav-left" }, h("a", { key: '8412dea23d6abd077551e12420711e82c30560a9', "aria-label": "home", target: "_blank", href: `https://${this.website}` }, h("img", { key: 'f592c9db8244ae4adf5fd0b8019d67224e368061', src: ((_a = app_store.app_data) === null || _a === void 0 ? void 0 : _a.affiliate) ? (_c = (_b = app_store.app_data) === null || _b === void 0 ? void 0 : _b.affiliate.sites[0]) === null || _c === void 0 ? void 0 : _c.logo : this.logo, alt: `${(_d = app_store.property) === null || _d === void 0 ? void 0 : _d.name}, ${(_e = app_store.property) === null || _e === void 0 ? void 0 : _e.country.name}`, class: "ir-nav-logo" })), h("div", { key: 'bbefb0e2a4a1bd99de533feaeb746bb5db552682', class: "ir-nav-property-details" }, h("h3", { key: '714d4a58d91d0cbb7fe20219f1eeddfeb772e1f8', class: "ir-property-name" }, (_f = app_store.property) === null || _f === void 0 ? void 0 : _f.name), h("button", { key: '0f60b09fb3d8461e6fc31363787be11e1cf13fbc', onClick: () => this.handleButtonClick(undefined, 'map'), class: "ir-property-location" }, renderPropertyLocation(), h("span", { key: '2a0b97b026dc6a7f5f9c5145aa0db6f3531ef175', class: 'mx-1' }), h("svg", { key: 'e7286bd3feb5b2449bd1b139ec41eaf56d1c1b3d', slot: "btn-icon", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 384 512" }, h("path", { key: 'c2579b6de1aae6c912cef72d0b781783418f5947', fill: "currentColor", d: "M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z" }), h("title", { key: '6f61cff5552a328576fa7f85b3a53a98d9cd6b37' }, "Location")))))), h("div", { key: 'fd52a37e9d5b89b9edd69cb3bf2e0e6fc8b30b17', class: `ir-burger-menu ${isInjected ? 'ir-nav-injected' : ''}` }, !app_store.is_signed_in ? (h("ir-button", { class: "ir-sheet-button", variants: "ghost", label: "Sign in", name: "auth", onButtonClick: this.handleSignIn.bind(this) })) : (this.menuShown && (h("ir-menu", { data: [
                { id: 1, item: 'My bookings' },
                { id: 3, item: 'Personal profile' },
                { id: 2, item: 'Sign out' },
            ], onMenuItemClick: this.handleItemSelect.bind(this) }, h("ir-user-avatar", { slot: "menu-trigger" })))), this.showBookingCode && this.showCurrency && h("ir-button", { key: '1b64f64561a39db61681c3ea4d1447d1eeb34457', variants: "icon", iconName: "burger_menu", onClick: () => this.sheetRef.openSheet() })), h("ul", { key: '337ec230d69f6daec67df930b34e879f92db61fe', class: cn('ir-nav-links', { 'ir-nav-links-injected': isInjected }) }, !isInjected && currentPage !== 'checkout' && (h("li", { key: '46625e076c41c3d2989e5498d4cc6c092156d727' }, h("ir-button", { key: '06b2216a580c2c3dd5c6d29efc9478b24a8509ae', variants: "ghost", haveLeftIcon: true, title: "home", onButtonClick: () => window.open(`https://${this.website}`, '_blank') }, h("p", { key: '228af443d196cb6f79cd53a7450d4cf8b846f59a', slot: "left-icon", class: "sr-only" }, "home"), h("ir-icons", { key: '0d786bb3ba6da13b4b1013052098946113a309a7', slot: "left-icon", name: "home", svgClassName: "ir-icon-size" })))), currentPage === 'booking' && this.showBookingCode && (h("li", { key: '149aa4374a09384961e2235e5c9c12a65e47d620' }, h("ir-button", { key: '8f30cc7001acc68df94282cb85c5f39dbd55dec1', variants: "ghost", label: localizedWords.entries.Lcz_BookingCode, name: "booking_code", onButtonClick: e => this.handleButtonClick(e, 'booking_code') }))), this.showCurrency && h("li", { key: '7f2d56c4a559be62d2dcc5d1a735ecc742bceccc' }, this.renderLanguageTrigger()), !app_store.is_signed_in ? (h("li", null, h("ir-button", { variants: "ghost", label: localizedWords.entries.Lcz_SignIn, name: "auth", onButtonClick: this.handleSignIn.bind(this) }))) : (this.menuShown && (h("li", null, h("ir-menu", { data: [
                { id: 1, item: 'My bookings' },
                { id: 3, item: 'Personal profile' },
                { id: 2, item: 'Sign out' },
            ], onMenuItemClick: this.handleItemSelect.bind(this) }, h("ir-user-avatar", { slot: "menu-trigger" })))))))), h("ir-sheet", { key: 'b6505592f45e2f6a465a7aca6227aca6387c5ef7', ref: el => (this.sheetRef = el) }, h("ul", { key: 'f547640ac9465337681ee3712b2a28a067e89b15', slot: "sheet-content", class: "ir-sheet-content" }, !isInjected && (h("li", { key: '2fd0a80735cecd32419659d5d0deda0543fa8347' }, h("ir-button", { key: 'b486764035ee72711b7da7e186e40a8fe3121faa', onButtonClick: () => window.open(`https://${this.website}`), class: "ir-sheet-button", buttonClassName: "justify-start", variants: "ghost", label: "Home", name: "home" }))), h("li", { key: '9ce689644332775bb66cba3878b111c9d6a319c3' }, h("ir-button", { key: 'a83586b9ed68f7572cdd9ad78d4a7713694b8f81', class: "ir-sheet-button", onButtonClick: () => this.handleButtonClick(undefined, 'language'), buttonClassName: "justify-start", variants: "ghost", label: this.preferences.currency, name: "home" })), h("li", { key: '36db06f14fe25ca20507ff4b5b0ab2897e892a87' }, h("ir-button", { key: '471a758626b248fb89cb93d2468b09f5bccc4f47', class: "ir-sheet-button", onButtonClick: () => this.handleButtonClick(undefined, 'language'), buttonClassName: "justify-start", variants: "ghost", label: this.preferences.language, name: "home" })), h("li", { key: '35d971b1fa1724cb37be0f16c2cedca22544ea02' }, h("ir-button", { key: 'eb3abb60030e42e9f1967d7148ccbcb90017ed19', class: "ir-sheet-button", buttonClassName: "justify-start", variants: "ghost", label: "Booking code", name: "booking_code", onButtonClick: e => this.handleButtonClick(e, 'booking_code') })))), !app_store.is_signed_in && h("ir-modal", { key: '256a9deaa7eeb99dd8cde3ab18b8cd8ac1454358', ref: el => (this.modalRef = el), style: { '--ir-modal-max-width': '32rem' } }), h("ir-dialog", { key: '7d2890802b3c4ef56892ec73ecd06a5dae7d0aa1', ref: el => (this.dialogRef = el), style: { '--ir-dialog-max-width': this.currentPage === 'map' ? '80%' : '32rem' } }, this.renderDialogBody())));
    }
