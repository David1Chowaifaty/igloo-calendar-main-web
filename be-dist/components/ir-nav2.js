...
const IrNav = /*@__PURE__*/ proxyCustomElement(class IrNav extends HTMLElement {
    ...
    render() {
        ...
        return (h(Fragment, { key: '90f90854eb1bed2b91f51d2688df47a37f969d84' }, h("nav", { key: '52dfca1d30a936d56a2a72682cb408ee65cd2369', class: "nav" }, h("div", { key: '853408fb07ac768cc581f076f732f93a3d4eea07', class: "nav-container" }, !isInjected && (h("div", { class: "nav-left" }, h("a", { "aria-label": "home", href: `${(_a = this.website) === null || _a === void 0 ? void 0 : _a.replace('www.', 'https://')}` }, h("img", { src: this.logo, alt: `${(_b = app_store.property) === null || _b === void 0 ? void 0 : _b.name}, ${(_c = app_store.property) === null || _c === void 0 ? void 0 : _c.country.name}`, class: "nav-logo" })), h("div", { class: "nav-property-details" }, h("h3", { class: "property-name" }, (_d = app_store.property) === null || _d === void 0 ? void 0 : _d.name), h("p", { class: "property-location" }, this.renderLocationField((_e = app_store.property) === null || _e === void 0 ? void 0 : _e.country.name, false), this.renderLocationField((_f = app_store.property) === null || _f === void 0 ? void 0 : _f.city.name), this.renderLocationField((_g = app_store.property) === null || _g === void 0 ? void 0 : _g.area), this.renderLocationField((_h = app_store.property) === null || _h === void 0 ? void 0 : _h.postal))))), h("div", { key: '5fe2c57fbf771d3c1b77f1c7ee2d4f6c41830789', class: `burger-menu ${isInjected ? 'nav-injected' : ''}` }, h("ir-button", { key: 'c8297cceb09ede44b1618d93a6881ca448d5e475', class: "sheet-button", variants: "ghost", label: "Sign in", name: "auth", onButtonClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.currentPage = 'auth';
                this.modalRef.openModal();
            } }), h("ir-button", { key: '3441d349cda3cfa4c5505e1edeaea55d98b8ee31', variants: "icon", onClick: () => this.sheetRef.openSheet() }, h("p", { key: '982f94c683f327b376fbddfae6ca3610a8463a3d', slot: "btn-icon", class: "sr-only" }, "burger menu"), h("ir-icons", { key: 'f92fea7be97ed3c290220042b902b7e776741891', slot: "btn-icon", name: "burger_menu" }))), h("ul", { key: '2f7136094a07e41c7c9e688daaa1372d447522f9', class: cn('nav-links', { 'nav-links-injected': isInjected }) }, !isInjected && currentPage !== 'checkout' && (h("li", null, h("ir-button", { variants: "ghost", haveLeftIcon: true, title: "home" }, h("p", { slot: "left-icon", class: "sr-only" }, "home"), h("ir-icons", { slot: "left-icon", name: "home", svgClassName: "icon-size" })))), currentPage === 'booking' && (h("li", null, h("ir-button", { variants: "ghost", label: localizedWords.entries.Lcz_BookingCode, name: "booking_code", onButtonClick: e => this.handleButtonClick(e, 'booking_code') }))), h("li", { key: '097ef24586eddb28d1221a8d2610325392056546' }, this.renderLanguageTrigger()), !this.isBookingListing && (h("li", null, h("ir-button", { variants: "ghost", label: localizedWords.entries.Lcz_SignIn, name: "auth", onButtonClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.currentPage = 'auth';
                this.modalRef.openModal();
            } })))))), h("ir-sheet", { key: 'e60cbad4a378e1892dd26f1319d05f7450dd6faa', ref: el => (this.sheetRef = el) }, h("ul", { key: 'f72977944964ae2cb2fa66d2985dcfdd187db21f', slot: "sheet-content", class: "sheet-content" }, h("li", { key: 'cf721af1ba37d2b34001698bfd3d03d644c517b9' }, this.renderLanguageTrigger()), !isInjected && (h("li", null, h("ir-button", { class: "sheet-button", buttonClassName: "justify-start", variants: "ghost", label: "Home", name: "home" }))), h("li", { key: '575a5391994326a4c28043fe2b15c51e989e8dba' }, h("ir-button", { key: '09f014dc584c9df807d11adbadfa5afd741d94f4', class: "sheet-button", buttonClassName: "justify-start", variants: "ghost", label: "Booking code", name: "booking_code", onButtonClick: e => this.handleButtonClick(e, 'booking_code') })))), h("ir-modal", { key: '7e99d7702b6c97b7015fe3d255e1356abca70d09', ref: el => (this.modalRef = el), style: { '--ir-modal-max-width': '32rem' } }), h("ir-dialog", { key: '6e6aba9ddfd02d3f2198919e5b339607098ebd6c', ref: el => (this.dialogRef = el), style: { '--ir-dialog-max-width': '32rem' } }, this.renderDialogBody())));
    }
