...
import { d as defineCustomElement$b } from './ir-auth2.js';
...
const IrNav = /*@__PURE__*/ proxyCustomElement(class IrNav extends HTMLElement {
    ...
    render() {
        ...
        return (h(Fragment, null, h("nav", { class: "flex h-14  w-full bg-white items-center justify-between" }, h("div", { class: "flex items-center space-x-4" }, h("a", { href: `${(_a = this.website) === null || _a === void 0 ? void 0 : _a.replace('www.', 'https://')}` }, h("img", { src: this.logo, class: "object-fill h-10  w-auto" })), h("div", { class: "hidden md:block" }, h("h3", { class: "font-medium text-lg" }, this.exposed_property.name), h("p", { class: "text-sm text-slate-700" }, this.renderLocationField(this.exposed_property.country.name, false), this.renderLocationField(this.exposed_property.city.name), this.renderLocationField(this.exposed_property.area), this.renderLocationField(this.exposed_property.postal)))), h("div", { class: "md:hidden" }, h("ir-button", { variants: "icon", onClick: () => this.sheetRef.openSheet() }, h("p", { slot: "btn-icon", class: "sr-only" }, "burger menu"), h("ir-icons", { slot: "btn-icon", name: "burger_menu" }))), h("ul", { class: "hidden md:flex items-center gap-2" }, h("li", null, h("ir-button", { variants: "outline", haveLeftIcon: true }, h("p", { slot: "left-icon", class: "sr-only" }, "home"), h("ir-icons", { slot: "left-icon", name: "home", svgClassName: "h-4 w-4" }))), h("li", null, h("ir-button", { variants: "outline", label: "Booking code", name: "booking_code", onButtonClick: e => this.handleButtonClick(e, 'booking_code') })), h("li", null, h("ir-button", { variants: "outline", label: "language", name: "language", onButtonClick: e => this.handleButtonClick(e, 'language') })), h("li", null, h("ir-button", { variants: "outline", label: "Login", name: "auth", onButtonClick: e => this.handleButtonClick(e, 'auth') })))), h("ir-sheet", { ref: el => (this.sheetRef = el) }, h("ul", { slot: "sheet-content", class: "flex flex-col p-4 py-6 md:hidden gap-2" }, h("li", null, h("ir-button", { class: "w-full", buttonClassName: "justify-start", variants: "ghost", label: "Home", name: "home" })), h("li", null, h("ir-button", { class: "w-full", buttonClassName: "justify-start", variants: "ghost", label: "Booking code", name: "booking_code", onButtonClick: e => this.handleButtonClick(e, 'booking_code') })), h("li", null, h("ir-button", { class: "w-full", buttonClassName: "justify-start", variants: "ghost", label: "language", name: "language", onButtonClick: e => this.handleButtonClick(e, 'language') })), h("li", null, h("ir-button", { class: "w-full", buttonClassName: "justify-start", variants: "ghost", label: "Login", name: "auth", onButtonClick: e => this.handleButtonClick(e, 'auth') })))), h("ir-dialog", { ref: el => (this.dialogRef = el) }, this.renderDialogBody())));
    }
...
function defineCustomElement() {
    ...
    const components = ["ir-nav", "ir-auth", "ir-booking-code", "ir-button", "ir-dialog", "ir-icons", "ir-input", "ir-language-picker", "ir-select", "ir-sheet", "ir-signin", "ir-signup"];
