...
function defineCustomElement() {
    ...
    const components = ["ir-user-form", "ir-auth", "ir-badge-group", "ir-button", "ir-checkbox", "ir-dialog", "ir-icons", "ir-input", "ir-phone-input", "ir-select", "ir-signin", "ir-signup", "ir-social-button", "ir-textarea"];
