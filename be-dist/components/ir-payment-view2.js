...
import { d as defineCustomElement$3 } from './ir-credit-card-input2.js';
...
const IrPaymentView = /*@__PURE__*/ proxyCustomElement(class IrPaymentView extends HTMLElement {
    ...
    renderPaymentMethod() {
        ...
        if (this.selectedPaymentMethod === '001' || this.selectedPaymentMethod === '004')
            return (h("div", { class: "flex w-full gap-4", key: method.code }, h("div", { class: 'flex-1 space-y-4' }, h("fieldset", null, h("ir-input", { placeholder: "", onTextChanged: e => {
                ...
                }, label: localizedWords.entries.Lcz_NameOnCard, class: "w-full" })), h("ir-credit-card-input", { onCreditCardChange: e => {
    ...
    render() {
        return (h("div", { key: '01ef3aa7adc440943eee0f83dbe2dc5ed96d7119', class: "w-full space-y-4 rounded-md border border-solid bg-white  p-4" }, this.renderPaymentOptions(), this.renderPaymentMethod()));
    }
