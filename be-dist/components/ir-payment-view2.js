...
const IrPaymentView = /*@__PURE__*/ proxyCustomElement(class IrPaymentView extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '9b1cb02aef4fcc08111d552c28c252d5d5d64782', class: "w-full space-y-4 rounded-md border border-solid bg-white  p-4" }, !hasAgentWithCode001 && this.prepaymentAmount === 0 && this.selectedPaymentMethod === '001' && h("p", { key: '65f176d95969d0f9cacdc8ade6c1b577ee339023' }, localizedWords.entries.Lcz_PaymentSecurity), !hasAgentWithCode001 && this.renderPaymentOptions(), !hasAgentWithCode001 && this.renderPaymentMethod(), hasAgentWithCode001 && h("p", { key: '2a00c86f425e840ab92aaf0a016a3c0a5e287924', class: 'text-center' }, localizedWords.entries.Lcz_OnCredit), this.cardType !== '' &&
            this.cardType === 'AMEX' &&
            !app_store.property.allowed_cards.find(c => { var _a; return c.name.toLowerCase().includes(this.cardType === 'AMEX' ? 'american express' : (_a = this.cardType) === null || _a === void 0 ? void 0 : _a.toLowerCase()); }) && (h("p", { key: '312f234ca8ccb2460cc7ba2728628caf232ce02e', class: 'text-red-500' }, localizedWords.entries.Lcz_CardTypeNotSupport, ' ', (_e = (_d = app_store.property) === null || _d === void 0 ? void 0 : _d.allowed_cards) === null || _e === void 0 ? void 0 :
            _e.map((c, i) => { var _a; return `${c.name}${i < ((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.allowed_cards.length) - 1 ? ', ' : ''}`; }))), selectedPaymentMethodImage && !this.imageLoadError && (h("img", { key: 'bb30eefa8ddfce8fa1550864e1fd68ca2b0664cc', style: {
                maxWidth: '270px',
                marginLeft: 'auto',
                marginRight: 'auto',
                height: '24px',
