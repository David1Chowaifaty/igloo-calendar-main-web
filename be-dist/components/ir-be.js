...
import { l as getUserPrefernce, v as validateCoupon, n as validateAgentCode, o as matchLocale, p as checkGhs, d as dateFns, q as setDefaultLocale, r as checkAffiliate, a as modifyBookingStore, b as booking_store } from './utils.js';
...
import { d as defineCustomElement$X } from './ir-availibility-header2.js';
...
function defineCustomElement$1() {
    ...
    const components = ["ir-be", "ir-accomodations", "ir-adult-child-counter", "ir-alert-dialog", "ir-auth", "ir-availibility-header", "ir-badge", "ir-badge-group", "ir-booking-cancelation", "ir-booking-card", "ir-booking-code", "ir-booking-details", "ir-booking-header", "ir-booking-listing", "ir-booking-overview", "ir-booking-page", "ir-booking-summary", "ir-button", "ir-calendar", "ir-carousel", "ir-checkbox", "ir-checkout-page", "ir-checkout-skeleton", "ir-coupon-dialog", "ir-credit-card-input", "ir-date-popup", "ir-date-range", "ir-dialog", "ir-facilities", "ir-footer", "ir-gallery", "ir-google-maps", "ir-home-loader", "ir-icons", "ir-input", "ir-interceptor", "ir-invoice", "ir-language-picker", "ir-loyalty", "ir-menu", "ir-modal", "ir-nav", "ir-pagination", "ir-payment-view", "ir-phone-input", "ir-pickup", "ir-popover", "ir-privacy-policy", "ir-property-gallery", "ir-quick-auth", "ir-rateplan", "ir-room-type-amenities", "ir-roomtype", "ir-select", "ir-sheet", "ir-signin", "ir-signup", "ir-skeleton", "ir-textarea", "ir-tooltip", "ir-user-avatar", "ir-user-form", "ir-user-profile"];
