import { getElement, proxyCustomElement, HTMLElement as HTMLElement$1, createEvent, h, Host } from '@stencil/core/internal/client';
...
const IrPopup = /*@__PURE__*/ proxyCustomElement(class IrPopup extends HTMLElement$1 {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return IrPopupStyle0; }
}, [1, "ir-popup", {
        "distance": [2],
        "placement": [1],
        "strategy": [1],
        "offsetSkid": [2, "offset-skid"],
        "offsetDistance": [2, "offset-distance"],
        "allowFlip": [4, "allow-flip"],
        "fallbackPlacements": [1, "fallback-placements"],
        "overflowPadding": [2, "overflow-padding"],
        "withArrow": [4, "with-arrow"],
        "sync": [1],
        "modal": [516],
        "isOpen": [32],
        "open": [64],
...
function defineCustomElement() {
    ...
    const components = ["ir-popup"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-popup":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrPopup);
            }
            break;
    } });
}

export { IrPopup as I, defineCustomElement as d };

//# sourceMappingURL=ir-popup2.js.map