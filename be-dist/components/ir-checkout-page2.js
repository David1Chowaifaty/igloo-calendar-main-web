...
import { C as passedBookingCutoff, b as booking_store, D as detectCardType, E as validateBooking, F as generateCheckoutUrl, g as getCurrencyByCode, n as normalize, y as getDateDifference, w as calculateTotalRooms, G as injectHTMLAndRunScript, B as clearCheckoutRooms, l as localizedWords } from './utils.js';
...
import { d as defineCustomElement$k } from './ir-alert-dialog2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-checkout-page", "ir-alert-dialog", "ir-booking-details", "ir-booking-summary", "ir-button", "ir-calendar", "ir-checkbox", "ir-checkout-skeleton", "ir-credit-card-input", "ir-dialog", "ir-icons", "ir-input", "ir-payment-view", "ir-phone-input", "ir-pickup", "ir-popover", "ir-quick-auth", "ir-select", "ir-textarea", "ir-tooltip", "ir-user-form"];
