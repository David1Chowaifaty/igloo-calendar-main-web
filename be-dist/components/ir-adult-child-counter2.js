...
const IrAdultChildCounter = /*@__PURE__*/ proxyCustomElement(class IrAdultChildCounter extends HTMLElement {
    ...
    static get watchers() { return {
        "baseChildrenAges": ["handleBaseChildrenAgesChange"]
    }; }
    static get style() { return IrAdultChildCounterStyle0; }
}, [1, "ir-adult-child-counter", {
        "adultCount": [1026, "adult-count"],
        "childrenCount": [1026, "children-count"],
        "infant_nbr": [1026],
        "error": [1028],
...
function defineCustomElement() {
    ...
    const components = ["ir-adult-child-counter", "ir-button", "ir-dialog", "ir-icons", "ir-popover", "ir-select"];
