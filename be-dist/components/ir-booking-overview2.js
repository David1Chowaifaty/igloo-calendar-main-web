...
import { z as runScriptAndRemove, l as localizedWords, d as dateFns, t as formatFullLocation, u as formatAmount, c as cn } from './utils.js';
import { b as app_store, m as moment } from './app.store.js';
...
import { d as defineCustomElement$8 } from './ir-booking-cancellation2.js';
...
const irBookingOverviewCss = "*.sc-ir-booking-overview,.sc-ir-booking-overview:after,.sc-ir-booking-overview:before{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;border:0 solid #e5e7eb;box-sizing:border-box}.sc-ir-booking-overview::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}.sc-ir-booking-overview:after,.sc-ir-booking-overview:before{--tw-content:\"\"}.sc-ir-booking-overview-h,html.sc-ir-booking-overview{-webkit-text-size-adjust:100%;font-feature-settings:normal;-webkit-tap-highlight-color:transparent;font-family:ui-sans-serif,system-ui,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;font-variation-settings:normal;line-height:1.5;-moz-tab-size:4;tab-size:4}body.sc-ir-booking-overview{line-height:inherit;margin:0}hr.sc-ir-booking-overview{border-top-width:1px;color:inherit;height:0}abbr.sc-ir-booking-overview:where([title]){text-decoration:underline dotted}h1.sc-ir-booking-overview,h2.sc-ir-booking-overview,h3.sc-ir-booking-overview,h4.sc-ir-booking-overview,h5.sc-ir-booking-overview,h6.sc-ir-booking-overview{font-size:inherit;font-weight:inherit}a.sc-ir-booking-overview{color:inherit;text-decoration:inherit}b.sc-ir-booking-overview,strong.sc-ir-booking-overview{font-weight:bolder}code.sc-ir-booking-overview,kbd.sc-ir-booking-overview,pre.sc-ir-booking-overview,samp.sc-ir-booking-overview{font-feature-settings:normal;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace;font-size:1em;font-variation-settings:normal}small.sc-ir-booking-overview{font-size:80%}sub.sc-ir-booking-overview,sup.sc-ir-booking-overview{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub.sc-ir-booking-overview{bottom:-.25em}sup.sc-ir-booking-overview{top:-.5em}table.sc-ir-booking-overview{border-collapse:collapse;border-color:inherit;text-indent:0}button.sc-ir-booking-overview,input.sc-ir-booking-overview,optgroup.sc-ir-booking-overview,select.sc-ir-booking-overview,textarea.sc-ir-booking-overview{font-feature-settings:inherit;color:inherit;font-family:inherit;font-size:100%;font-variation-settings:inherit;font-weight:inherit;letter-spacing:inherit;line-height:inherit;margin:0;padding:0}button.sc-ir-booking-overview,select.sc-ir-booking-overview{text-transform:none}button.sc-ir-booking-overview,input.sc-ir-booking-overview:where([type=button]),input.sc-ir-booking-overview:where([type=reset]),input.sc-ir-booking-overview:where([type=submit]){-webkit-appearance:button;background-color:transparent;background-image:none}.sc-ir-booking-overview:-moz-focusring{outline:auto}.sc-ir-booking-overview:-moz-ui-invalid{box-shadow:none}progress.sc-ir-booking-overview{vertical-align:baseline}.sc-ir-booking-overview::-webkit-inner-spin-button,.sc-ir-booking-overview::-webkit-outer-spin-button{height:auto}[type=search].sc-ir-booking-overview{-webkit-appearance:textfield;outline-offset:-2px}.sc-ir-booking-overview::-webkit-search-decoration{-webkit-appearance:none}.sc-ir-booking-overview::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}summary.sc-ir-booking-overview{display:list-item}blockquote.sc-ir-booking-overview,dd.sc-ir-booking-overview,dl.sc-ir-booking-overview,fieldset.sc-ir-booking-overview,figure.sc-ir-booking-overview,h1.sc-ir-booking-overview,h2.sc-ir-booking-overview,h3.sc-ir-booking-overview,h4.sc-ir-booking-overview,h5.sc-ir-booking-overview,h6.sc-ir-booking-overview,hr.sc-ir-booking-overview,p.sc-ir-booking-overview,pre.sc-ir-booking-overview{margin:0}fieldset.sc-ir-booking-overview,legend.sc-ir-booking-overview{padding:0}menu.sc-ir-booking-overview,ol.sc-ir-booking-overview,ul.sc-ir-booking-overview{list-style:none;margin:0;padding:0}dialog.sc-ir-booking-overview{padding:0}textarea.sc-ir-booking-overview{resize:vertical}input.sc-ir-booking-overview::placeholder,textarea.sc-ir-booking-overview::placeholder{color:#9ca3af;opacity:1}[role=button].sc-ir-booking-overview,button.sc-ir-booking-overview{cursor:pointer}.sc-ir-booking-overview:disabled{cursor:default}audio.sc-ir-booking-overview,canvas.sc-ir-booking-overview,embed.sc-ir-booking-overview,iframe.sc-ir-booking-overview,img.sc-ir-booking-overview,object.sc-ir-booking-overview,svg.sc-ir-booking-overview,video.sc-ir-booking-overview{display:block;vertical-align:middle}img.sc-ir-booking-overview,video.sc-ir-booking-overview{height:auto;max-width:100%}[hidden].sc-ir-booking-overview:where(:not([hidden=until-found])){display:none}.block.sc-ir-booking-overview{display:block}.flex.sc-ir-booking-overview{display:flex}.border.sc-ir-booking-overview{border-width:1px}.sc-ir-booking-overview-h{display:block}.ct-menu-container.sc-ir-booking-overview{align-items:center;border:1px solid var(--gray-300,#d0d5dd);border-radius:min(var(--radius,.5rem),.5rem);display:flex;padding:0;width:-moz-fit-content;width:fit-content}.ct-menu-trigger.sc-ir-booking-overview{align-items:center;display:flex;justify-content:center}.ct-menu-button.sc-ir-booking-overview,.ct-menu-trigger.sc-ir-booking-overview{padding:.25rem .5rem}.ct-menu-button.sc-ir-booking-overview:dir(rtl){border-left:1px solid var(--gray-300,#d0d5dd)}.ct-menu-button.sc-ir-booking-overview:dir(ltr){border-right:1px solid var(--gray-300,#d0d5dd)}.booking-details-btn.sc-ir-booking-overview{border:1px solid var(--gray-300,#d0d5dd);border-radius:min(var(--radius,.5rem),.5rem);padding:.25rem .5rem}.group-hover[data-state=hovered].sc-ir-booking-overview{background:var(--gray-100,#f2f4f7)!important}.ir-table-cell[data-state=affiliate].sc-ir-booking-overview{padding-bottom:0}.ir-table-cell[data-state=booking-affiliate].sc-ir-booking-overview{padding-top:.5rem}.property-location.sc-ir-booking-overview{color:#475467;font-size:small;font-weight:500}.static.sc-ir-booking-overview{position:static}.relative.sc-ir-booking-overview{position:relative}.sticky.sc-ir-booking-overview{position:sticky}.top-0.sc-ir-booking-overview{top:0}.z-20.sc-ir-booking-overview{z-index:20}.m-0.sc-ir-booking-overview{margin:0}.mx-auto.sc-ir-booking-overview{margin-left:auto;margin-right:auto}.w-full.sc-ir-booking-overview{width:100%}.max-w-6xl.sc-ir-booking-overview{max-width:72rem}.flex-1.sc-ir-booking-overview{flex:1 1 0%}.flex-col.sc-ir-booking-overview{flex-direction:column}.space-y-5.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(1.25rem*var(--tw-space-y-reverse));margin-top:calc(1.25rem*(1 - var(--tw-space-y-reverse)))}.p-0.sc-ir-booking-overview{padding:0}.px-4.sc-ir-booking-overview{padding-left:1rem;padding-right:1rem}.shadow.sc-ir-booking-overview{--tw-shadow:0 1px 3px 0 rgba(0,0,0,.1),0 1px 2px -1px rgba(0,0,0,.1);--tw-shadow-colored:0 1px 3px 0 var(--tw-shadow-color),0 1px 2px -1px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}@media (min-width:1024px){.lg\\:px-6.sc-ir-booking-overview{padding-left:1.5rem;padding-right:1.5rem}}.h-full.sc-ir-booking-overview{height:100%}.top-\\[20\\%\\].sc-ir-booking-overview{top:20%}.z-50.sc-ir-booking-overview{z-index:50}.mt-1\\.5.sc-ir-booking-overview{margin-top:.375rem}.aspect-\\[1\\/1\\].sc-ir-booking-overview{aspect-ratio:1/1}.max-h-32.sc-ir-booking-overview{max-height:8rem}.flex-wrap.sc-ir-booking-overview{flex-wrap:wrap}.items-center.sc-ir-booking-overview{align-items:center}.justify-center.sc-ir-booking-overview{justify-content:center}.justify-between.sc-ir-booking-overview{justify-content:space-between}.gap-1.sc-ir-booking-overview{gap:.25rem}.gap-16.sc-ir-booking-overview{gap:4rem}.gap-4.sc-ir-booking-overview{gap:1rem}.space-y-2.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.5rem*var(--tw-space-y-reverse));margin-top:calc(.5rem*(1 - var(--tw-space-y-reverse)))}.object-cover.sc-ir-booking-overview{object-fit:cover}.text-center.sc-ir-booking-overview{text-align:center}.text-lg.sc-ir-booking-overview{font-size:1.125rem;line-height:1.75rem}.text-sm.sc-ir-booking-overview{font-size:.875rem;line-height:1.25rem}.text-xl.sc-ir-booking-overview{font-size:1.25rem;line-height:1.75rem}.text-xs.sc-ir-booking-overview{font-size:.75rem;line-height:1rem}.font-medium.sc-ir-booking-overview{font-weight:500}.text-gray-700.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(55 65 81/var(--tw-text-opacity,1))}.text-green-600.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(22 163 74/var(--tw-text-opacity,1))}.text-red-500.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(239 68 68/var(--tw-text-opacity,1))}.outline.sc-ir-booking-overview{outline-style:solid}@media (min-width:768px){.md\\:w-fit.sc-ir-booking-overview{width:fit-content}.md\\:flex-row.sc-ir-booking-overview{flex-direction:row}.md\\:items-center.sc-ir-booking-overview{align-items:center}.md\\:text-right.sc-ir-booking-overview{text-align:right}}.size-6.sc-ir-booking-overview{height:1.5rem;width:1.5rem}.pb-2.sc-ir-booking-overview{padding-bottom:.5rem}.font-semibold.sc-ir-booking-overview{font-weight:600}.grid.sc-ir-booking-overview{display:grid}.hidden.sc-ir-booking-overview{display:none}.aspect-\\[16\\/9\\].sc-ir-booking-overview{aspect-ratio:16/9}.h-28.sc-ir-booking-overview{height:7rem}.h-4.sc-ir-booking-overview{height:1rem}.h-44.sc-ir-booking-overview{height:11rem}.h-6.sc-ir-booking-overview{height:1.5rem}.h-60.sc-ir-booking-overview{height:15rem}.h-8.sc-ir-booking-overview{height:2rem}.w-1\\/2.sc-ir-booking-overview{width:50%}.w-24.sc-ir-booking-overview{width:6rem}.w-3\\/4.sc-ir-booking-overview{width:75%}.w-3\\/5.sc-ir-booking-overview{width:60%}.w-40.sc-ir-booking-overview{width:10rem}.w-48.sc-ir-booking-overview{width:12rem}.w-80.sc-ir-booking-overview{width:20rem}.gap-2.sc-ir-booking-overview{gap:.5rem}.space-x-2.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-x-reverse:0;margin-left:calc(.5rem*(1 - var(--tw-space-x-reverse)));margin-right:calc(.5rem*var(--tw-space-x-reverse))}.space-y-4.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(1rem*var(--tw-space-y-reverse));margin-top:calc(1rem*(1 - var(--tw-space-y-reverse)))}.p-4.sc-ir-booking-overview{padding:1rem}@media (min-width:768px){.md\\:col-span-2.sc-ir-booking-overview{grid-column:span 2/span 2}.md\\:grid.sc-ir-booking-overview{display:grid}.md\\:h-20.sc-ir-booking-overview{height:5rem}.md\\:grid-cols-3.sc-ir-booking-overview{grid-template-columns:repeat(3,minmax(0,1fr))}}@media (min-width:1024px){.lg\\:block.sc-ir-booking-overview{display:block}.lg\\:grid-cols-2.sc-ir-booking-overview{grid-template-columns:repeat(2,minmax(0,1fr))}.lg\\:space-y-10.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(2.5rem*var(--tw-space-y-reverse));margin-top:calc(2.5rem*(1 - var(--tw-space-y-reverse)))}.lg\\:p-6.sc-ir-booking-overview{padding:1.5rem}}.absolute.sc-ir-booking-overview{position:absolute}.mb-2.sc-ir-booking-overview{margin-bottom:.5rem}.h-10.sc-ir-booking-overview{height:2.5rem}.h-12.sc-ir-booking-overview{height:3rem}.h-14.sc-ir-booking-overview{height:3.5rem}.h-64.sc-ir-booking-overview{height:16rem}.h-screen.sc-ir-booking-overview{height:100vh}.min-h-screen.sc-ir-booking-overview{min-height:100vh}.w-56.sc-ir-booking-overview{width:14rem}.max-w-md.sc-ir-booking-overview{max-width:28rem}.animate-pulse.sc-ir-booking-overview{animation:pulse 2s cubic-bezier(.4,0,.6,1) infinite}.place-content-center.sc-ir-booking-overview{place-content:center}.self-center.sc-ir-booking-overview{align-self:center}.rounded-full.sc-ir-booking-overview{border-radius:9999px}.rounded-md.sc-ir-booking-overview{border-radius:.375rem}.bg-gray-200.sc-ir-booking-overview{--tw-bg-opacity:1;background-color:rgb(229 231 235/var(--tw-bg-opacity,1))}.py-4.sc-ir-booking-overview{padding-bottom:1rem;padding-top:1rem}@media (min-width:768px){.md\\:hidden.sc-ir-booking-overview{display:none}}.bottom-2.sc-ir-booking-overview{bottom:.5rem}.z-40.sc-ir-booking-overview{z-index:40}.mb-5.sc-ir-booking-overview{margin-bottom:1.25rem}.mt-14.sc-ir-booking-overview{margin-top:3.5rem}.w-auto.sc-ir-booking-overview{width:auto}.justify-end.sc-ir-booking-overview{justify-content:flex-end}.bg-gray-700\\/80.sc-ir-booking-overview{background-color:rgba(55,65,81,.8)}.px-6.sc-ir-booking-overview{padding-left:1.5rem;padding-right:1.5rem}.py-2.sc-ir-booking-overview{padding-bottom:.5rem;padding-top:.5rem}.py-8.sc-ir-booking-overview{padding-bottom:2rem;padding-top:2rem}.pb-5.sc-ir-booking-overview{padding-bottom:1.25rem}.text-base.sc-ir-booking-overview{font-size:1rem;line-height:1.5rem}.text-gray-200.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(229 231 235/var(--tw-text-opacity,1))}.filter.sc-ir-booking-overview{filter:var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)}@media (min-width:768px){.md\\:text-lg.sc-ir-booking-overview{font-size:1.125rem;line-height:1.75rem}}@media (min-width:1024px){.lg\\:w-60.sc-ir-booking-overview{width:15rem}.lg\\:gap-10.sc-ir-booking-overview{gap:2.5rem}.lg\\:text-2xl.sc-ir-booking-overview{font-size:1.5rem;line-height:2rem}.lg\\:size-7.sc-ir-booking-overview{height:1.75rem;width:1.75rem}}.sr-only.sc-ir-booking-overview{clip:rect(0,0,0,0);border-width:0;height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}.table.sc-ir-booking-overview{display:table}.gap-2\\.5.sc-ir-booking-overview{gap:.625rem}.space-y-8.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(2rem*var(--tw-space-y-reverse));margin-top:calc(2rem*(1 - var(--tw-space-y-reverse)))}.text-2xl.sc-ir-booking-overview{font-size:1.5rem;line-height:2rem}@media (min-width:768px){.md\\:sticky.sc-ir-booking-overview{position:sticky}.md\\:top-20.sc-ir-booking-overview{top:5rem}.md\\:flex.sc-ir-booking-overview{display:flex}.md\\:max-w-4xl.sc-ir-booking-overview{max-width:56rem}.md\\:max-w-md.sc-ir-booking-overview{max-width:28rem}.md\\:items-start.sc-ir-booking-overview{align-items:flex-start}.md\\:justify-end.sc-ir-booking-overview{justify-content:flex-end}}.capitalize.sc-ir-booking-overview{text-transform:capitalize}.text-end.sc-ir-booking-overview{text-align:end}.text-gray-400.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(156 163 175/var(--tw-text-opacity,1))}.visible.sc-ir-booking-overview{visibility:visible}.h-5.sc-ir-booking-overview{height:1.25rem}.w-5.sc-ir-booking-overview{width:1.25rem}.fixed.sc-ir-booking-overview{position:fixed}.mx-1.sc-ir-booking-overview{margin-left:.25rem;margin-right:.25rem}.justify-start.sc-ir-booking-overview{justify-content:flex-start}.gap-1\\.5.sc-ir-booking-overview{gap:.375rem}@media (min-width:768px){.md\\:block.sc-ir-booking-overview{display:block}}.mb-4.sc-ir-booking-overview{margin-bottom:1rem}.max-h-\\[83vh\\].sc-ir-booking-overview{max-height:83vh}.overflow-y-auto.sc-ir-booking-overview{overflow-y:auto}.font-normal.sc-ir-booking-overview{font-weight:400}.text-\\[var\\(--gray-600\\2c \\#475467\\)\\].sc-ir-booking-overview{color:var(--gray-600,#475467)}.text-\\[var\\(--gray-700\\2c \\#344054\\)\\].sc-ir-booking-overview{color:var(--gray-700,#344054)}@media (min-width:768px){.md\\:p-6.sc-ir-booking-overview{padding:1.5rem}}.resize.sc-ir-booking-overview{resize:both}@media (min-width:640px){.sm\\:block.sc-ir-booking-overview{display:block}}.right-0.sc-ir-booking-overview{right:0}.right-4.sc-ir-booking-overview{right:1rem}.top-4.sc-ir-booking-overview{top:1rem}.mt-8.sc-ir-booking-overview{margin-top:2rem}.min-w-\\[70\\%\\].sc-ir-booking-overview{min-width:70%}.max-w-full.sc-ir-booking-overview{max-width:100%}.translate-x-0.sc-ir-booking-overview{--tw-translate-x:0px}.translate-x-0.sc-ir-booking-overview,.translate-x-\\[100\\%\\].sc-ir-booking-overview{transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.translate-x-\\[100\\%\\].sc-ir-booking-overview{--tw-translate-x:100%}.bg-white.sc-ir-booking-overview{--tw-bg-opacity:1;background-color:rgb(255 255 255/var(--tw-bg-opacity,1))}.shadow.sc-ir-booking-overview,.shadow-md.sc-ir-booking-overview{box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}.shadow-md.sc-ir-booking-overview{--tw-shadow:0 4px 6px -1px rgba(0,0,0,.1),0 2px 4px -2px rgba(0,0,0,.1);--tw-shadow-colored:0 4px 6px -1px var(--tw-shadow-color),0 2px 4px -2px var(--tw-shadow-color)}.transition-transform.sc-ir-booking-overview{transition-duration:.15s;transition-property:transform;transition-timing-function:cubic-bezier(.4,0,.2,1)}.duration-300.sc-ir-booking-overview{transition-duration:.3s}.ease-in-out.sc-ir-booking-overview{transition-timing-function:cubic-bezier(.4,0,.2,1)}.data-\\[state\\=\\'closed\\'\\]\\:translate-x-\\[100\\%\\][data-state=closed].sc-ir-booking-overview{--tw-translate-x:100%}.data-\\[state\\=\\'closed\\'\\]\\:translate-x-\\[100\\%\\][data-state=closed].sc-ir-booking-overview,.data-\\[state\\=\\'opened\\'\\]\\:translate-x-0[data-state=opened].sc-ir-booking-overview{transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.data-\\[state\\=\\'opened\\'\\]\\:translate-x-0[data-state=opened].sc-ir-booking-overview{--tw-translate-x:0px}.pointer-events-none.sc-ir-booking-overview{pointer-events:none}.inset-y-0.sc-ir-booking-overview{bottom:0;top:0}.end-1.sc-ir-booking-overview{inset-inline-end:.25rem}.start-2.sc-ir-booking-overview{inset-inline-start:.5rem}.px-\\[0\\.3rem\\].sc-ir-booking-overview{padding-left:.3rem;padding-right:.3rem}.ps-9.sc-ir-booking-overview{padding-inline-start:2.25rem}.pt-1.sc-ir-booking-overview{padding-top:.25rem}.text-\\[\\#667085\\].sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(102 112 133/var(--tw-text-opacity,1))}.max-w-xs.sc-ir-booking-overview{max-width:20rem}.rounded-lg.sc-ir-booking-overview{border-radius:.5rem}.px-3.sc-ir-booking-overview{padding-left:.75rem;padding-right:.75rem}.size-\\[1\\.125rem\\].sc-ir-booking-overview{height:1.125rem;width:1.125rem}.h-\\[14px\\].sc-ir-booking-overview{height:14px}.h-\\[3rem\\].sc-ir-booking-overview{height:3rem}.w-\\[12\\.25px\\].sc-ir-booking-overview{width:12.25px}.gap-0\\.5.sc-ir-booking-overview{gap:.125rem}.border-0.sc-ir-booking-overview{border-width:0}.pt-14.sc-ir-booking-overview{padding-top:3.5rem}.lowercase.sc-ir-booking-overview{text-transform:lowercase}.shadow.sc-ir-booking-overview,.shadow-none.sc-ir-booking-overview{box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}.shadow-none.sc-ir-booking-overview{--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000}@media (min-width:640px){.sm\\:w-auto.sc-ir-booking-overview{width:auto}.sm\\:w-fit.sc-ir-booking-overview{width:fit-content}.sm\\:border.sc-ir-booking-overview{border-width:1px}.sm\\:pt-4.sc-ir-booking-overview{padding-top:1rem}.sm\\:shadow-sm.sc-ir-booking-overview{--tw-shadow:0 1px 2px 0 rgba(0,0,0,.05);--tw-shadow-colored:0 1px 2px 0 var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}.sm\\:hidden.sc-ir-booking-overview{display:none}}@media (min-width:1280px){.xl\\:text-cyan-50.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(236 254 255/var(--tw-text-opacity,1))}}.transform.sc-ir-booking-overview{transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.mx-2.sc-ir-booking-overview{margin-left:.5rem;margin-right:.5rem}.mt-2\\.5.sc-ir-booking-overview{margin-top:.625rem}.space-y-1\\.5.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.375rem*var(--tw-space-y-reverse));margin-top:calc(.375rem*(1 - var(--tw-space-y-reverse)))}.rounded-xl.sc-ir-booking-overview{border-radius:.75rem}.bg-gray-100.sc-ir-booking-overview{--tw-bg-opacity:1;background-color:rgb(243 244 246/var(--tw-bg-opacity,1))}.p-6.sc-ir-booking-overview{padding:1.5rem}.pt-2.sc-ir-booking-overview{padding-top:.5rem}.leading-none.sc-ir-booking-overview{line-height:1}.tracking-tight.sc-ir-booking-overview{letter-spacing:-.025em}.size-4.sc-ir-booking-overview{height:1rem;width:1rem}.gap-3.sc-ir-booking-overview{gap:.75rem}.h-80.sc-ir-booking-overview{height:20rem}.h-\\[80vh\\].sc-ir-booking-overview{height:80vh}.overflow-x-auto.sc-ir-booking-overview{overflow-x:auto}.overflow-x-hidden.sc-ir-booking-overview{overflow-x:hidden}.px-\\[1\\.25rem\\].sc-ir-booking-overview{padding-left:1.25rem;padding-right:1.25rem}.pt-\\[1rem\\].sc-ir-booking-overview{padding-top:1rem}.text-start.sc-ir-booking-overview{text-align:start}@media (min-width:1024px){.lg\\:table-cell.sc-ir-booking-overview{display:table-cell}}.mt-4.sc-ir-booking-overview{margin-top:1rem}.h-\\[1px\\].sc-ir-booking-overview{height:1px}.min-w-\\[1rem\\].sc-ir-booking-overview{min-width:1rem}.cursor-pointer.sc-ir-booking-overview{cursor:pointer}.space-y-1.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.25rem*var(--tw-space-y-reverse));margin-top:calc(.25rem*(1 - var(--tw-space-y-reverse)))}.rounded-t-md.sc-ir-booking-overview{border-top-left-radius:.375rem;border-top-right-radius:.375rem}.border-gray-300.sc-ir-booking-overview{--tw-border-opacity:1;border-color:rgb(209 213 219/var(--tw-border-opacity,1))}.bg-gray-300.sc-ir-booking-overview{background-color:rgb(209 213 219/var(--tw-bg-opacity,1))}.bg-gray-300.sc-ir-booking-overview,.bg-white.sc-ir-booking-overview{--tw-bg-opacity:1}.p-2.sc-ir-booking-overview{padding:.5rem}.underline.sc-ir-booking-overview{text-decoration-line:underline}@media (min-width:768px){.md\\:max-w-sm.sc-ir-booking-overview{max-width:24rem}}@media (min-width:1024px){.lg\\:aspect-\\[16\\/9\\].sc-ir-booking-overview{aspect-ratio:16/9}}.ml-1.sc-ir-booking-overview{margin-left:.25rem}.line-clamp-3.sc-ir-booking-overview{-webkit-box-orient:vertical;-webkit-line-clamp:3;display:-webkit-box;overflow:hidden}.inline-flex.sc-ir-booking-overview{display:inline-flex}.h-16.sc-ir-booking-overview{height:4rem}.w-16.sc-ir-booking-overview{width:4rem}.max-w-\\[60\\%\\].sc-ir-booking-overview{max-width:60%}.flex-row.sc-ir-booking-overview{flex-direction:row}.space-y-9.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(2.25rem*var(--tw-space-y-reverse));margin-top:calc(2.25rem*(1 - var(--tw-space-y-reverse)))}.pb-1\\.5.sc-ir-booking-overview{padding-bottom:.375rem}.pl-0.sc-ir-booking-overview{padding-left:0}.pt-0\\.5.sc-ir-booking-overview{padding-top:.125rem}.text-right.sc-ir-booking-overview{text-align:right}.text-\\[var\\(--ir-green\\)\\].sc-ir-booking-overview{color:var(--ir-green)}.text-gray-500.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(107 114 128/var(--tw-text-opacity,1))}@media (min-width:768px){.md\\:w-full.sc-ir-booking-overview{width:100%}.md\\:max-w-full.sc-ir-booking-overview{max-width:100%}}@media (min-width:1024px){.lg\\:flex-row.sc-ir-booking-overview{flex-direction:row}}@media (min-width:1280px){.xl\\:text-xl.sc-ir-booking-overview{font-size:1.25rem;line-height:1.75rem}}@media (min-width:640px){.sm\\:p-6.sc-ir-booking-overview{padding:1.5rem}}@media (min-width:768px){.md\\:flex-row-reverse.sc-ir-booking-overview{flex-direction:row-reverse}}.h-24.sc-ir-booking-overview{height:6rem}.gap-12.sc-ir-booking-overview{gap:3rem}.gap-8.sc-ir-booking-overview{gap:2rem}@media (min-width:1024px){.lg\\:max-w-sm.sc-ir-booking-overview{max-width:24rem}}.size-3.sc-ir-booking-overview{height:.75rem;width:.75rem}.-bottom-0.sc-ir-booking-overview{bottom:0}.left-8.sc-ir-booking-overview{left:2rem}.top-8.sc-ir-booking-overview{top:2rem}.z-0.sc-ir-booking-overview{z-index:0}.z-10.sc-ir-booking-overview{z-index:10}.mb-1.sc-ir-booking-overview{margin-bottom:.25rem}.size-10.sc-ir-booking-overview{height:2.5rem;width:2.5rem}.max-h-\\[80vh\\].sc-ir-booking-overview{max-height:80vh}.max-h-\\[90vh\\].sc-ir-booking-overview{max-height:90vh}.w-72.sc-ir-booking-overview{width:18rem}.items-end.sc-ir-booking-overview{align-items:flex-end}.overflow-hidden.sc-ir-booking-overview{overflow:hidden}.bg-white\\/80.sc-ir-booking-overview{background-color:hsla(0,0%,100%,.8)}.px-2.sc-ir-booking-overview{padding-left:.5rem;padding-right:.5rem}.pb-4.sc-ir-booking-overview,.py-4.sc-ir-booking-overview{padding-bottom:1rem}.pt-0.sc-ir-booking-overview{padding-top:0}.ordinal.sc-ir-booking-overview{--tw-ordinal:ordinal;font-variant-numeric:var(--tw-ordinal) var(--tw-slashed-zero) var(--tw-numeric-figure) var(--tw-numeric-spacing) var(--tw-numeric-fraction)}.text-white.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(255 255 255/var(--tw-text-opacity,1))}.hover\\:bg-gray-400.sc-ir-booking-overview:hover{--tw-bg-opacity:1;background-color:rgb(156 163 175/var(--tw-bg-opacity,1))}@media (min-width:768px){.md\\:w-auto.sc-ir-booking-overview{width:auto}.md\\:p-4.sc-ir-booking-overview{padding:1rem}.md\\:pt-0.sc-ir-booking-overview{padding-top:0}.md\\:pt-4.sc-ir-booking-overview{padding-top:1rem}.md\\:text-xl.sc-ir-booking-overview{font-size:1.25rem;line-height:1.75rem}}.ml-4.sc-ir-booking-overview{margin-left:1rem}.grid-cols-2.sc-ir-booking-overview{grid-template-columns:repeat(2,minmax(0,1fr))}.gap-6.sc-ir-booking-overview{gap:1.5rem}.space-y-3.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.75rem*var(--tw-space-y-reverse));margin-top:calc(.75rem*(1 - var(--tw-space-y-reverse)))}.pb-6.sc-ir-booking-overview{padding-bottom:1.5rem}.text-gray-800.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(31 41 55/var(--tw-text-opacity,1))}@media (min-width:640px){.sm\\:flex-row.sc-ir-booking-overview{flex-direction:row}.sm\\:items-center.sc-ir-booking-overview{align-items:center}.sm\\:text-sm.sc-ir-booking-overview{font-size:.875rem;line-height:1.25rem}}@media (min-width:1024px){.lg\\:grid-cols-3.sc-ir-booking-overview{grid-template-columns:repeat(3,minmax(0,1fr))}}.w-fit.sc-ir-booking-overview{width:fit-content}@media (min-width:640px){.sm\\:w-full.sc-ir-booking-overview{width:100%}}@media (min-width:1024px){.lg\\:w-fit.sc-ir-booking-overview{width:fit-content}}.col-span-6.sc-ir-booking-overview{grid-column:span 6/span 6}.w-12.sc-ir-booking-overview{width:3rem}.place-items-center.sc-ir-booking-overview{place-items:center}.pt-2.sc-ir-booking-overview,.py-2.sc-ir-booking-overview{padding-top:.5rem}.pt-4.sc-ir-booking-overview{padding-top:1rem}.text-slate-900.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(15 23 42/var(--tw-text-opacity,1))}@media (min-width:768px){.md\\:space-y-2.sc-ir-booking-overview>.sc-ir-booking-overview:not([hidden])~.sc-ir-booking-overview:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.5rem*var(--tw-space-y-reverse));margin-top:calc(.5rem*(1 - var(--tw-space-y-reverse)))}.md\\:p-0.sc-ir-booking-overview{padding:0}}.col-span-2.sc-ir-booking-overview{grid-column:span 2/span 2}.mb-6.sc-ir-booking-overview{margin-bottom:1.5rem}.mt-6.sc-ir-booking-overview{margin-top:1.5rem}.min-h-\\[80vh\\].sc-ir-booking-overview{min-height:80vh}.max-w-xl.sc-ir-booking-overview{max-width:36rem}@media (min-width:768px){.md\\:grid-cols-2.sc-ir-booking-overview{grid-template-columns:repeat(2,minmax(0,1fr))}}.h-72.sc-ir-booking-overview{height:18rem}.size-\\[18px\\].sc-ir-booking-overview{height:18px;width:18px}.text-slate-500.sc-ir-booking-overview{--tw-text-opacity:1;color:rgb(100 116 139/var(--tw-text-opacity,1))}@media (min-width:640px){.sm\\:p-4.sc-ir-booking-overview{padding:1rem}}.text-\\[hsl\\(var\\(--brand-600\\)\\)\\].sc-ir-booking-overview{color:hsl(var(--brand-600))}.border-solid.sc-ir-booking-overview{border-style:solid}.mb-2\\.5.sc-ir-booking-overview{margin-bottom:.625rem}.w-\\[45\\%\\].sc-ir-booking-overview{width:45%}.bg-\\[var\\(--gray-200\\)\\].sc-ir-booking-overview{background-color:var(--gray-200)}.text-\\[var\\(--gray-500\\)\\].sc-ir-booking-overview{color:var(--gray-500)}";
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-overview", "ir-alert-dialog", "ir-badge", "ir-booking-cancellation", "ir-booking-card", "ir-booking-header", "ir-button", "ir-icons", "ir-menu", "ir-pagination", "ir-skeleton"];
