...
const IrGoogleMaps$1 = /*@__PURE__*/ proxyCustomElement(class IrGoogleMaps extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-google-maps":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrGoogleMaps$1);
            }
            break;
    } });
}

const IrGoogleMaps = IrGoogleMaps$1;
const defineCustomElement = defineCustomElement$1;

export { IrGoogleMaps, defineCustomElement };
