...
import { b as booking_store, E as updateRoomParams, d as dateFns, r as formatAmount, g as getDateDifference, F as reserveRooms } from './utils.js';
...
const IrRateplan = /*@__PURE__*/ proxyCustomElement(class IrRateplan extends HTMLElement {
    ...
    render() {
        ...
        const isInventoryFull = ((_a = this.visibleInventory) === null || _a === void 0 ? void 0 : _a.visibleInventory) === 0 ||
            !((_d = (_c = (_b = this.visibleInventory) === null || _b === void 0 ? void 0 : _b.selected_variation) === null || _c === void 0 ? void 0 : _c.variation) === null || _d === void 0 ? void 0 : _d.amount) ||
            Object.values(booking_store.ratePlanSelections[this.roomTypeId]).some(f => f.visibleInventory === f.reserved);
        return (h("div", { class: "rateplan-container" }, h("div", { class: `rateplan-header ${this.isRatePlanAvailable ? 'available' : 'not-available'}` }, h("div", { class: "rateplan-details-wrapper" }, h("p", { class: "rateplan-name" }, h("span", { class: "rateplan-short-name" }, this.ratePlan.short_name), this.ratePlan.is_non_refundable ? (h("p", { class: "rateplan-tooltip text-xs", style: { color: 'var(--ir-green)' } }, localizedWords.entries.Lcz_NonRefundable)) : (h("ir-tooltip", { labelColors: booking_store.isInFreeCancelationZone ? 'green' : 'default', class: `rateplan-tooltip`, open_behavior: "click", label: booking_store.isInFreeCancelationZone ? localizedWords.entries.Lcz_FreeCancellation : localizedWords.entries.Lcz_IfICancel, message: `${this.cancelationMessage || this.ratePlan.cancelation} ${(_e = this.ratePlan.guarantee) !== null && _e !== void 0 ? _e : ''}`, onTooltipOpenChange: e => {
                if (e.detail) {
                    this.fetchCancelationMessage(this.ratePlan.id, this.roomTypeId);
                }
            } }))), this.isLoading ? (h("div", { class: "grid place-items-center md:hidden" }, h("ir-skeleton", { class: "h-4 w-12" }))) : (h(Fragment, null, this.isRatePlanAvailable ? (!((_h = (_g = (_f = this.visibleInventory) === null || _f === void 0 ? void 0 : _f.selected_variation) === null || _g === void 0 ? void 0 : _g.variation) === null || _h === void 0 ? void 0 : _h.IS_MLS_VIOLATED) &&
            ((_l = (_k = (_j = this.visibleInventory) === null || _j === void 0 ? void 0 : _j.selected_variation) === null || _k === void 0 ? void 0 : _k.variation) === null || _l === void 0 ? void 0 : _l.amount) && (h("div", { class: "rateplan-pricing-mobile" }, ((_p = (_o = (_m = this.visibleInventory) === null || _m === void 0 ? void 0 : _m.selected_variation) === null || _o === void 0 ? void 0 : _o.variation) === null || _p === void 0 ? void 0 : _p.discount_pct) > 0 && (h("p", { class: "rateplan-discounted-amount" }, formatAmount((_s = (_r = (_q = this.visibleInventory) === null || _q === void 0 ? void 0 : _q.selected_variation) === null || _r === void 0 ? void 0 : _r.variation) === null || _s === void 0 ? void 0 : _s.total_before_discount, app_store.userPreferences.currency_id, 0))), h("p", { class: "rateplan-amount" }, formatAmount((_v = (_u = (_t = this.visibleInventory) === null || _t === void 0 ? void 0 : _t.selected_variation) === null || _u === void 0 ? void 0 : _u.variation) === null || _v === void 0 ? void 0 : _v.amount, app_store.userPreferences.currency_id, 0))))) : (h("p", { class: "no-availability" }, localizedWords.entries.Lcz_NotAvailable))))), h("div", { class: "rateplan-description" }, this.ratePlan.is_non_refundable ? (h("p", { class: "rateplan-tooltip text-xs", style: { color: 'var(--ir-green)' } }, localizedWords.entries.Lcz_NonRefundable)) : (h("ir-tooltip", { labelColors: booking_store.isInFreeCancelationZone ? 'green' : 'default', class: `rateplan-tooltip`, open_behavior: "click", label: booking_store.isInFreeCancelationZone ? localizedWords.entries.Lcz_FreeCancellation : localizedWords.entries.Lcz_IfICancel, message: `${((_w = this.cancelationMessage) !== null && _w !== void 0 ? _w : '') || ((_x = this.ratePlan.cancelation) !== null && _x !== void 0 ? _x : '')} ${(_y = this.ratePlan.guarantee) !== null && _y !== void 0 ? _y : ''}`, onTooltipOpenChange: e => {
                if (e.detail) {
                    this.fetchCancelationMessage(this.ratePlan.id, this.roomTypeId);
                }
            ...
            })) }))), !((_1 = (_0 = (_z = this.visibleInventory) === null || _z === void 0 ? void 0 : _z.selected_variation) === null || _0 === void 0 ? void 0 : _0.variation) === null || _1 === void 0 ? void 0 : _1.IS_MLS_VIOLATED) ? (h(Fragment, null, ((_4 = (_3 = (_2 = this.visibleInventory) === null || _2 === void 0 ? void 0 : _2.selected_variation) === null || _3 === void 0 ? void 0 : _3.variation) === null || _4 === void 0 ? void 0 : _4.amount) && (h(Fragment, null, ((_7 = (_6 = (_5 = this.visibleInventory) === null || _5 === void 0 ? void 0 : _5.selected_variation) === null || _6 === void 0 ? void 0 : _6.variation) === null || _7 === void 0 ? void 0 : _7.discount_pct) > 0 && (h("div", { class: "rateplan-pricing" }, h("p", { class: "rateplan-discounted-amount" }, formatAmount((_10 = (_9 = (_8 = this.visibleInventory) === null || _8 === void 0 ? void 0 : _8.selected_variation) === null || _9 === void 0 ? void 0 : _9.variation) === null || _10 === void 0 ? void 0 : _10.total_before_discount, app_store.userPreferences.currency_id, 0)), h("p", { class: "rateplan-discount" }, `-${(_13 = (_12 = (_11 = this.visibleInventory) === null || _11 === void 0 ? void 0 : _11.selected_variation) === null || _12 === void 0 ? void 0 : _12.variation) === null || _13 === void 0 ? void 0 : _13.discount_pct}%`))), h("div", { class: "rateplan-final-pricing", "data-style": ((_16 = (_15 = (_14 = this.visibleInventory) === null || _14 === void 0 ? void 0 : _14.selected_variation) === null || _15 === void 0 ? void 0 : _15.variation) === null || _16 === void 0 ? void 0 : _16.discount_pct) > 0 ? '' : 'full-width' }, h("p", { class: "rateplan-amount" }, formatAmount((_19 = (_18 = (_17 = this.visibleInventory) === null || _17 === void 0 ? void 0 : _17.selected_variation) === null || _18 === void 0 ? void 0 : _18.variation) === null || _19 === void 0 ? void 0 : _19.amount, app_store.userPreferences.currency_id, 0)), getDateDifference((_20 = booking_store.bookingAvailabilityParams.from_date) !== null && _20 !== void 0 ? _20 : new Date(), (_21 = booking_store.bookingAvailabilityParams.to_date) !== null && _21 !== void 0 ? _21 : new Date()) >
            1 && (h("p", { class: "rateplan-amount-per-night" }, `${formatAmount((_24 = (_23 = (_22 = this.visibleInventory) === null || _22 === void 0 ? void 0 : _22.selected_variation) === null || _23 === void 0 ? void 0 : _23.variation) === null || _24 === void 0 ? void 0 : _24.amount_per_night, app_store.userPreferences.currency_id, 0)}/${localizedWords.entries.Lcz_night}`))))), ((_25 = this.visibleInventory) === null || _25 === void 0 ? void 0 : _25.reserved) > 0 ? (h("ir-select", { onValueChange: e => {
                reserveRooms(this.roomTypeId, this.ratePlan.id, Number(e.detail));
                this.animateBookingButton.emit(null);
            }, label: localizedWords.entries.Lcz_Rooms, value: (_26 = this.visibleInventory) === null || _26 === void 0 ? void 0 : _26.reserved, class: "rateplan-select-rooms", data: (_27 = [...new Array(this.roomTypeInventory + 1)]) === null || _27 === void 0 ? void 0 : _27.map((_, i) => {
                var _a, _b, _c, _d;
                return ({
                    id: i,
                    value: i === 0
            ...
            }), containerStyle: 'triggerStyle', customStyles: 'selectStyle' })) : (h("ir-button", { disabled: isInventoryFull, class: "rateplan-select-rooms", buttonStyles: { background: 'white', width: '100%', opacity: isInventoryFull ? '0.5' : '1' }, label: localizedWords.entries.Lcz_Select, variants: "outline-primary", onButtonClick: () => {
                reserveRooms(this.roomTypeId, this.ratePlan.id, 1);
                this.animateBookingButton.emit(null);
            } })))) : (h("p", { class: "mls_alert" }, localizedWords.entries.Lcz_MLS_Alert.replace('{0}', (_29 = (_28 = this.visibleInventory.selected_variation) === null || _28 === void 0 ? void 0 : _28.variation) === null || _29 === void 0 ? void 0 : _29.MLS_ALERT_VALUE)))))))));
    }
