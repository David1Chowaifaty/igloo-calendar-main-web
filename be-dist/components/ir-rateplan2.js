...
import { b as booking_store, D as updateRoomParams, d as dateFns, u as formatAmount, g as getDateDifference, E as reserveRooms } from './utils.js';
...
const IrRateplan = /*@__PURE__*/ proxyCustomElement(class IrRateplan extends HTMLElement {
    ...
    render() {
        ...
        const isInventoryFull = ((_a = this.visibleInventory) === null || _a === void 0 ? void 0 : _a.visibleInventory) === 0 || Object.values(booking_store.ratePlanSelections[this.roomTypeId]).some(f => f.visibleInventory === f.reserved);
        return (h("div", { class: "rateplan-container" }, h("div", { class: `rateplan-header ${this.isRatePlanAvailable ? 'available' : 'not-available'}` }, h("div", { class: "rateplan-details-wrapper" }, h("p", { class: "rateplan-name" }, h("span", { class: "rateplan-short-name" }, this.ratePlan.short_name), this.ratePlan.is_non_refundable ? (h("p", { class: "rateplan-tooltip text-xs", style: { color: 'var(--ir-green)' } }, localizedWords.entries.Lcz_NonRefundable)) : (h("ir-tooltip", { labelColors: booking_store.isInFreeCancelationZone ? 'green' : 'default', class: `rateplan-tooltip`, open_behavior: "click", label: booking_store.isInFreeCancelationZone ? localizedWords.entries.Lcz_FreeCancellation : localizedWords.entries.Lcz_IfICancel, message: `${this.cancelationMessage || this.ratePlan.cancelation} ${(_b = this.ratePlan.guarantee) !== null && _b !== void 0 ? _b : ''}`, onTooltipOpenChange: e => {
                if (e.detail) {
                    this.fetchCancelationMessage(this.ratePlan.id, this.roomTypeId);
                }
            } }))), this.isLoading ? (h("div", { class: "grid place-items-center md:hidden" }, h("ir-skeleton", { class: "h-4 w-12" }))) : (h(Fragment, null, this.isRatePlanAvailable ? (!((_e = (_d = (_c = this.visibleInventory) === null || _c === void 0 ? void 0 : _c.selected_variation) === null || _d === void 0 ? void 0 : _d.variation) === null || _e === void 0 ? void 0 : _e.IS_MLS_VIOLATED) && (h("div", { class: "rateplan-pricing-mobile" }, ((_h = (_g = (_f = this.visibleInventory) === null || _f === void 0 ? void 0 : _f.selected_variation) === null || _g === void 0 ? void 0 : _g.variation) === null || _h === void 0 ? void 0 : _h.discount_pct) > 0 && (h("p", { class: "rateplan-discounted-amount" }, formatAmount((_l = (_k = (_j = this.visibleInventory) === null || _j === void 0 ? void 0 : _j.selected_variation) === null || _k === void 0 ? void 0 : _k.variation) === null || _l === void 0 ? void 0 : _l.total_before_discount, app_store.userPreferences.currency_id, 0))), h("p", { class: "rateplan-amount" }, formatAmount((_p = (_o = (_m = this.visibleInventory) === null || _m === void 0 ? void 0 : _m.selected_variation) === null || _o === void 0 ? void 0 : _o.variation) === null || _p === void 0 ? void 0 : _p.amount, app_store.userPreferences.currency_id, 0))))) : (h("p", { class: "no-availability" }, localizedWords.entries.Lcz_NotAvailable))))), h("div", { class: "rateplan-description" }, this.ratePlan.is_non_refundable ? (h("p", { class: "rateplan-tooltip text-xs", style: { color: 'var(--ir-green)' } }, localizedWords.entries.Lcz_NonRefundable)) : (h("ir-tooltip", { labelColors: booking_store.isInFreeCancelationZone ? 'green' : 'default', class: `rateplan-tooltip`, open_behavior: "click", label: booking_store.isInFreeCancelationZone ? localizedWords.entries.Lcz_FreeCancellation : localizedWords.entries.Lcz_IfICancel, message: `${((_q = this.cancelationMessage) !== null && _q !== void 0 ? _q : '') || ((_r = this.ratePlan.cancelation) !== null && _r !== void 0 ? _r : '')} ${(_s = this.ratePlan.guarantee) !== null && _s !== void 0 ? _s : ''}`, onTooltipOpenChange: e => {
                if (e.detail) {
                    this.fetchCancelationMessage(this.ratePlan.id, this.roomTypeId);
                }
            } })), h("p", { class: "rateplan-custom-text", innerHTML: this.ratePlan.custom_text }))), this.isRatePlanAvailable && (h("div", { class: `rateplan-details ${this.ratePlan.custom_text ? 'rateplan-details-no-custom-text' : ''}` }, this.isLoading ? (h("div", { class: "col-span-6 w-full " }, h("ir-skeleton", { class: "block h-12 w-full" }))) : (h(Fragment, null, h("div", { class: "rateplan-travelers" }, this.ratePlan.variations && (h("ir-select", { class: "rateplan-select-travelers", label: localizedWords.entries.Lcz_Travelers, value: this.ratePlan.variations
            ...
            })) }))), !((_v = (_u = (_t = this.visibleInventory) === null || _t === void 0 ? void 0 : _t.selected_variation) === null || _u === void 0 ? void 0 : _u.variation) === null || _v === void 0 ? void 0 : _v.IS_MLS_VIOLATED) ? (h(Fragment, null, ((_y = (_x = (_w = this.visibleInventory) === null || _w === void 0 ? void 0 : _w.selected_variation) === null || _x === void 0 ? void 0 : _x.variation) === null || _y === void 0 ? void 0 : _y.discount_pct) > 0 && (h("div", { class: "rateplan-pricing" }, h("p", { class: "rateplan-discounted-amount" }, formatAmount((_1 = (_0 = (_z = this.visibleInventory) === null || _z === void 0 ? void 0 : _z.selected_variation) === null || _0 === void 0 ? void 0 : _0.variation) === null || _1 === void 0 ? void 0 : _1.total_before_discount, app_store.userPreferences.currency_id, 0)), h("p", { class: "rateplan-discount" }, `-${(_4 = (_3 = (_2 = this.visibleInventory) === null || _2 === void 0 ? void 0 : _2.selected_variation) === null || _3 === void 0 ? void 0 : _3.variation) === null || _4 === void 0 ? void 0 : _4.discount_pct}%`))), h("div", { class: "rateplan-final-pricing", "data-style": ((_7 = (_6 = (_5 = this.visibleInventory) === null || _5 === void 0 ? void 0 : _5.selected_variation) === null || _6 === void 0 ? void 0 : _6.variation) === null || _7 === void 0 ? void 0 : _7.discount_pct) > 0 ? '' : 'full-width' }, h("p", { class: "rateplan-amount" }, formatAmount((_10 = (_9 = (_8 = this.visibleInventory) === null || _8 === void 0 ? void 0 : _8.selected_variation) === null || _9 === void 0 ? void 0 : _9.variation) === null || _10 === void 0 ? void 0 : _10.amount, app_store.userPreferences.currency_id, 0)), getDateDifference((_11 = booking_store.bookingAvailabilityParams.from_date) !== null && _11 !== void 0 ? _11 : new Date(), (_12 = booking_store.bookingAvailabilityParams.to_date) !== null && _12 !== void 0 ? _12 : new Date()) > 1 && (h("p", { class: "rateplan-amount-per-night" }, `${formatAmount((_15 = (_14 = (_13 = this.visibleInventory) === null || _13 === void 0 ? void 0 : _13.selected_variation) === null || _14 === void 0 ? void 0 : _14.variation) === null || _15 === void 0 ? void 0 : _15.amount_per_night, app_store.userPreferences.currency_id, 0)}/${localizedWords.entries.Lcz_night}`))), ((_16 = this.visibleInventory) === null || _16 === void 0 ? void 0 : _16.reserved) > 0 ? (h("ir-select", { onValueChange: e => {
                reserveRooms(this.roomTypeId, this.ratePlan.id, Number(e.detail));
                this.animateBookingButton.emit(null);
            }, label: localizedWords.entries.Lcz_Rooms, value: (_17 = this.visibleInventory) === null || _17 === void 0 ? void 0 : _17.reserved, class: "rateplan-select-rooms", data: (_18 = [...new Array(this.roomTypeInventory + 1)]) === null || _18 === void 0 ? void 0 : _18.map((_, i) => {
                var _a, _b, _c, _d;
                return ({
                    id: i,
                    value: i === 0
            ...
            }), containerStyle: 'triggerStyle', customStyles: 'selectStyle' })) : (h("ir-button", { disabled: isInventoryFull, class: "rateplan-select-rooms", buttonStyles: { background: 'white', width: '100%', opacity: isInventoryFull ? '0.5' : '1' }, label: localizedWords.entries.Lcz_Select.replace('…', ''), variants: "outline-primary", onButtonClick: () => {
                reserveRooms(this.roomTypeId, this.ratePlan.id, 1);
                this.animateBookingButton.emit(null);
            } })))) : (h("p", { class: "mls_alert" }, (_20 = (_19 = this.visibleInventory.selected_variation) === null || _19 === void 0 ? void 0 : _19.variation) === null || _20 === void 0 ? void 0 : _20.MLS_ALERT))))))));
    }
    static get watchers() { return {
        "roomTypeInventory": ["handleRTICHange"]
    }; }
    static get style() { return IrRateplanStyle0; }
}, [1, "ir-rateplan", {
        "display": [513],
        "ratePlan": [16],
        "visibleInventory": [16],
        "roomTypeInventory": [2, "room-type-inventory"],
        "roomTypeId": [2, "room-type-id"],
        "isLoading": [32],
        "cancelationMessage": [32],
        "isRatePlanAvailable": [32]
    }, undefined, {
        "roomTypeInventory": ["handleRTICHange"]
    }]);
function defineCustomElement() {
    ...
    const components = ["ir-rateplan", "ir-button", "ir-icons", "ir-select", "ir-skeleton", "ir-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-rateplan":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrRateplan);
            }
            break;
        case "ir-button":
            if (!customElements.get(tagName)) {
...
export { IrRateplan as I, defineCustomElement as d };

//# sourceMappingURL=ir-rateplan2.js.map