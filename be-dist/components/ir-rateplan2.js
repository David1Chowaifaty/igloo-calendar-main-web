...
import { b as booking_store, F as updateRoomParams, d as dateFns, u as formatAmount, g as getDateDifference, G as reserveRooms } from './utils.js';
...
const IrRateplan = /*@__PURE__*/ proxyCustomElement(class IrRateplan extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { class: "rateplan-container" }, h("div", { class: `rateplan-header ${this.isRatePlanAvailable ? 'available' : 'not-available'}` }, h("div", { class: "rateplan-details-wrapper" }, h("p", { class: "rateplan-name" }, h("span", { class: "rateplan-short-name" }, this.ratePlan.short_name), this.ratePlan.is_non_refundable ? (h("p", { class: "rateplan-tooltip text-xs", style: { color: 'var(--ir-green)' } }, localizedWords.entries.Lcz_NonRefundable)) : (h("ir-tooltip", { labelColors: booking_store.isInFreeCancelationZone ? 'green' : 'default', class: `rateplan-tooltip`, open_behavior: "click", label: booking_store.isInFreeCancelationZone ? localizedWords.entries.Lcz_FreeCancellation : localizedWords.entries.Lcz_IfICancel, message: `${this.cancelationMessage || this.ratePlan.cancelation} ${(_e = this.ratePlan.guarantee) !== null && _e !== void 0 ? _e : ''}`, onTooltipOpenChange: e => {
            ...
            } })), h("p", { class: "rateplan-custom-text", innerHTML: this.ratePlan.custom_text }))), this.isRatePlanAvailable && (h("div", { class: `rateplan-details ${this.ratePlan.custom_text ? 'rateplan-details-no-custom-text' : ''}` }, this.isLoading || ((_z = this.ratePlan.variations) === null || _z === void 0 ? void 0 : _z.length) === 0 ? (h("div", { class: "col-span-6 w-full " }, h("ir-skeleton", { class: "block h-12 w-full" }))) : (h(Fragment, null, h("div", { class: "rateplan-travelers" }, this.ratePlan.variations && (h("ir-select", { class: "rateplan-select-travelers", label: 'Travelers', value: this.ratePlan.variations
            ...
            })) }))), !((_2 = (_1 = (_0 = this.visibleInventory) === null || _0 === void 0 ? void 0 : _0.selected_variation) === null || _1 === void 0 ? void 0 : _1.variation) === null || _2 === void 0 ? void 0 : _2.IS_MLS_VIOLATED) ? (h(Fragment, null, ((_5 = (_4 = (_3 = this.visibleInventory) === null || _3 === void 0 ? void 0 : _3.selected_variation) === null || _4 === void 0 ? void 0 : _4.variation) === null || _5 === void 0 ? void 0 : _5.amount) && (h(Fragment, null, ((_8 = (_7 = (_6 = this.visibleInventory) === null || _6 === void 0 ? void 0 : _6.selected_variation) === null || _7 === void 0 ? void 0 : _7.variation) === null || _8 === void 0 ? void 0 : _8.discount_pct) > 0 && (h("div", { class: "rateplan-pricing" }, h("p", { class: "rateplan-discounted-amount" }, formatAmount((_11 = (_10 = (_9 = this.visibleInventory) === null || _9 === void 0 ? void 0 : _9.selected_variation) === null || _10 === void 0 ? void 0 : _10.variation) === null || _11 === void 0 ? void 0 : _11.total_before_discount, app_store.userPreferences.currency_id, 0)), h("p", { class: "rateplan-discount" }, `-${(_14 = (_13 = (_12 = this.visibleInventory) === null || _12 === void 0 ? void 0 : _12.selected_variation) === null || _13 === void 0 ? void 0 : _13.variation) === null || _14 === void 0 ? void 0 : _14.discount_pct}%`))), h("div", { class: "rateplan-final-pricing", "data-style": ((_17 = (_16 = (_15 = this.visibleInventory) === null || _15 === void 0 ? void 0 : _15.selected_variation) === null || _16 === void 0 ? void 0 : _16.variation) === null || _17 === void 0 ? void 0 : _17.discount_pct) > 0 ? '' : 'full-width' }, h("p", { class: "rateplan-amount" }, formatAmount((_20 = (_19 = (_18 = this.visibleInventory) === null || _18 === void 0 ? void 0 : _18.selected_variation) === null || _19 === void 0 ? void 0 : _19.variation) === null || _20 === void 0 ? void 0 : _20.amount, app_store.userPreferences.currency_id, 0)), getDateDifference((_21 = booking_store.bookingAvailabilityParams.from_date) !== null && _21 !== void 0 ? _21 : new Date(), (_22 = booking_store.bookingAvailabilityParams.to_date) !== null && _22 !== void 0 ? _22 : new Date()) >
            1 && (h("p", { class: "rateplan-amount-per-night" }, `${formatAmount((_25 = (_24 = (_23 = this.visibleInventory) === null || _23 === void 0 ? void 0 : _23.selected_variation) === null || _24 === void 0 ? void 0 : _24.variation) === null || _25 === void 0 ? void 0 : _25.amount_per_night, app_store.userPreferences.currency_id, 0)}/${localizedWords.entries.Lcz_night}`))))), ((_26 = this.visibleInventory) === null || _26 === void 0 ? void 0 : _26.reserved) > 0 ? (h("ir-select", { onValueChange: e => {
                reserveRooms(this.roomTypeId, this.ratePlan.id, Number(e.detail));
                this.animateBookingButton.emit(null);
            }, label: localizedWords.entries.Lcz_Rooms, value: (_27 = this.visibleInventory) === null || _27 === void 0 ? void 0 : _27.reserved, class: "rateplan-select-rooms", data: (_28 = [...new Array(this.roomTypeInventory + 1)]) === null || _28 === void 0 ? void 0 : _28.map((_, i) => {
                var _a, _b, _c, _d;
                return ({
                    id: i,
                    value: i === 0
                ...
                this.animateBookingButton.emit(null);
            } })))) : (h("p", { class: "mls_alert" }, localizedWords.entries.Lcz_MLS_Alert.replace('{0}', (_30 = (_29 = this.visibleInventory.selected_variation) === null || _29 === void 0 ? void 0 : _29.variation) === null || _30 === void 0 ? void 0 : _30.MLS_ALERT_VALUE)))))))));
    }
