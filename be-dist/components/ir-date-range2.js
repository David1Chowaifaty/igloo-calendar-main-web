...
import './index5.js';
import { d as dateFns, j as getAbbreviatedWeekdays } from './utils.js';
...
const IrDateRange = /*@__PURE__*/ proxyCustomElement(class IrDateRange extends HTMLElement {
    ...
    selectDay(day) {
        const isDateDisabled = !!this.dateModifiers[dateFns.format(day, 'yyyy-MM-dd')];
