...
const IrSeoInjector = /*@__PURE__*/ proxyCustomElement(class IrSeoInjector extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-seo-injector":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrSeoInjector);
            }
            break;
    } });
}

export { IrSeoInjector as I, defineCustomElement as d };

//# sourceMappingURL=ir-seo-injector2.js.map