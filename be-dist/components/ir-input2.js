...
const IrInput = /*@__PURE__*/ proxyCustomElement(class IrInput extends HTMLElement {
    ...
    render() {
        return (h("div", { key: 'd8f3144c2e22fd38f2d10aa0c56ee5ab03b6d224', ref: el => (this.inputEl = el), class: `input-container  ${this.disabled ? 'disabled' : ''}`, "data-context": this.leftIcon ? 'icon' : '' }, this.leftIcon && (h("label", { key: 'ed3344c1460f9e4f79cc110424f588e693375097', htmlFor: this.inputId, class: "left-icon" }, h("slot", { key: '81056eac6e3430182efc19b07b79089597abfc46', name: "left-icon" }))), h("input", { key: '67165578cac2d62447ec1041df6f33d4fa7960a8', type: this.type, name: this.name, placeholder: this.placeholder, id: this.inputId, class: this.class, required: this.required, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, pattern: this.pattern, autocomplete: this.autocomplete, autofocus: this.autofocus, size: this.size, multiple: this.multiple, value: this.value, onInput: e => this.textChanged.emit(e.target.value), onBlur: this.handleBlur.bind(this), onFocus: e => this.inputFocus.emit(e) }), h("p", { key: 'bdcd4764da4e22d8893f26f84a3ae304f2881ec5', slot: "tooltip-trigger", title: this.tooltip, class: "placeholder", style: { '--label-background': this.labelBackground } }, this.label), this.rightIcon && (h("label", { key: '64b21f309e752fbe9fbe486e3e34793634101bad', htmlFor: this.inputId, class: "right-icon" }, h("slot", { key: '548fcbb776a961f3ade7da112c04df6b193254da', name: "right-icon" })))));
    }
    get el() { return this; }
