...
const IrInput = /*@__PURE__*/ proxyCustomElement(class IrInput extends HTMLElement {
    ...
    render() {
        return (h("div", { key: '9edd83e63d567b92cc7975f17d54dc7b1512b34a', ref: el => (this.inputEl = el), class: `input-container  ${this.disabled ? 'disabled' : ''}`, "data-context": this.leftIcon ? 'icon' : '' }, this.leftIcon && (h("label", { key: '41cbaa690e32547b9a8a44977816656ed981021b', htmlFor: this.inputId, class: "left-icon" }, h("slot", { key: 'eae46ab3fe8bc0b192443fe0d2734419d9e9b0d8', name: "left-icon" }))), h("input", { key: 'fd234060e08bcf593e62a3675e11ca6c88fd5852', type: this.type, name: this.name, placeholder: this.placeholder, id: this.inputId, class: this.class, required: this.required, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, pattern: this.pattern, autocomplete: this.autocomplete, autofocus: this.autofocus, size: this.size, multiple: this.multiple, value: this.value, onInput: e => this.textChanged.emit(e.target.value), onBlur: this.handleBlur.bind(this), onFocus: e => this.inputFocus.emit(e) }), h("p", { key: '0203266816756dc85e1db59c4a4596a8edde5d2a', slot: "tooltip-trigger", title: this.tooltip, class: "placeholder", style: { '--label-background': this.labelBackground } }, this.label), this.rightIcon && (h("label", { key: '035f7477880044f0ae7105e42d8f4fa276026598', htmlFor: this.inputId, class: "right-icon" }, h("slot", { key: '2e77a21ce556ac4d8358bb48e47c8a726ee329ae', name: "right-icon" })))));
    }
    get el() { return this; }
