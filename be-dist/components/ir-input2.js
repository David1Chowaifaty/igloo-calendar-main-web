...
const IrInput = /*@__PURE__*/ proxyCustomElement(class IrInput extends HTMLElement {
    ...
    render() {
        return (h("div", { key: '15bc68731a04119209aeb4a45a5485504cf3c21c', ref: el => (this.inputEl = el), class: `input-container  ${this.disabled ? 'disabled' : ''}`, "data-context": this.leftIcon ? 'icon' : '' }, this.leftIcon && (h("label", { key: '4e849d6297875164e029e91e9f0623ddbddc1a21', htmlFor: this.inputId, class: "left-icon" }, h("slot", { key: '3b1724c66899f9773ec0bef52f663336b3aeaa1a', name: "left-icon" }))), h("input", { key: 'f96ceacf17e2910d8b988001484a7ed7fdf47b59', type: this.type, name: this.name, placeholder: this.placeholder, id: this.inputId, class: this.class, required: this.required, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, pattern: this.pattern, autocomplete: this.autocomplete, autofocus: this.autofocus, size: this.size, multiple: this.multiple, value: this.value, onInput: e => this.textChanged.emit(e.target.value), onBlur: this.handleBlur.bind(this), onFocus: e => this.inputFocus.emit(e) }), h("p", { key: '8592ac4ea04dea421ba83075060a665fd2845b91', slot: "tooltip-trigger", title: this.tooltip, class: "placeholder", style: { '--label-background': this.labelBackground } }, this.label), this.rightIcon && (h("label", { key: '09680f522147578c74c914f59f9faa34b2afa9c6', htmlFor: this.inputId, class: "right-icon" }, h("slot", { key: '503d67f68457ae8e2f8ea8809dfd6f388c49188b', name: "right-icon" })))));
    }
    get el() { return this; }
