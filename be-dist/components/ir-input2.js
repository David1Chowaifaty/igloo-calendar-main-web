...
const IrInput = /*@__PURE__*/ proxyCustomElement(class IrInput extends HTMLElement {
    ...
    render() {
        return (h("div", { key: 'ad5c3ad7246c18690218d15fc5339083e8d0db6f', ref: el => (this.inputEl = el), class: `input-container  ${this.disabled ? 'disabled' : ''}`, "data-context": this.leftIcon ? 'icon' : '' }, this.leftIcon && (h("label", { key: '4d0e6f3179d65cee146c63ad26c620616b9dd7a8', htmlFor: this.inputId, class: "left-icon" }, h("slot", { key: '35a6a9f29aeab632299606a5805ea4bcb35a13c4', name: "left-icon" }))), h("input", { key: '1932b76d124669dfe46f3aaf631dce1f7445ac3b', type: this.type, name: this.name, placeholder: this.placeholder, id: this.inputId, class: this.class, required: this.required, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, pattern: this.pattern, autocomplete: this.autocomplete, autofocus: this.autofocus, size: this.size, multiple: this.multiple, value: this.value, onInput: e => this.textChanged.emit(e.target.value), onBlur: this.handleBlur.bind(this), onFocus: e => this.inputFocus.emit(e) }), h("p", { key: '3153d7fb1e5d70c9477c799a1936d000f9da8fb6', slot: "tooltip-trigger", title: this.tooltip, class: "placeholder", style: { '--label-background': this.labelBackground } }, this.label), this.rightIcon && (h("label", { key: 'a4b6f43a287f588a5c930001fc2cd38bdc58b272', htmlFor: this.inputId, class: "right-icon" }, h("slot", { key: 'eac80fe2271690e49dded27f3258afb6388d5984', name: "right-icon" })))));
    }
    get el() { return this; }
