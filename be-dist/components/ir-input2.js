...
const IrInput = /*@__PURE__*/ proxyCustomElement(class IrInput extends HTMLElement {
    ...
    render() {
        return (h("div", { key: '99c644b398359a7186482b2dea4fc1e345915587', ref: el => (this.inputEl = el), class: `input-container  ${this.disabled ? 'disabled' : ''}`, "data-context": this.leftIcon ? 'icon' : '' }, this.leftIcon && (h("label", { key: '0daa207c7168fce702b76bdffebc4590537233d5', htmlFor: this.inputId, class: "left-icon" }, h("slot", { key: 'e06312d5a910802e3f8892f7af19d25d2ee5fc25', name: "left-icon" }))), h("input", { key: 'aa0c73aa88aaf8f557113799b4317ad22065c976', type: this.type, name: this.name, placeholder: this.placeholder, id: this.inputId, class: this.class, required: this.required, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, pattern: this.pattern, autocomplete: this.autocomplete, autofocus: this.autofocus, size: this.size, multiple: this.multiple, value: this.value, onInput: e => this.textChanged.emit(e.target.value), onBlur: this.handleBlur.bind(this), onFocus: e => this.inputFocus.emit(e) }), h("p", { key: '59416909a0cf6c146a42a445215804002335179a', slot: "tooltip-trigger", title: this.tooltip, class: "placeholder", style: { '--label-background': this.labelBackground } }, this.label), this.rightIcon && (h("label", { key: 'ce7472c64cec511970f34e9ae7a246bccde7d616', htmlFor: this.inputId, class: "right-icon" }, h("slot", { key: '9c0b3845d800cb8a0d9361e6b8ba902d0ac85f39', name: "right-icon" })))));
    }
    get el() { return this; }
