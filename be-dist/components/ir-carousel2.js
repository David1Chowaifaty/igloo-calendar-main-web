...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        return (h("div", { key: 'f597e0cdc8a25ec968afd4fe6823d564c2370441', class: "swiper", ref: el => (this.carouselEl = el) }, h("div", { key: '27e5926f79b17e203c13ff6394e401698607c2c9', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide" }, h("img", { src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '3c36560c4ccf51f24edc69b384356eeb3c0b1ae1', class: "swiper-pagination" }), h("div", { key: '8d7f45be70d0f255261ff2cf8212ddf736280168', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: '3a23d859d1af451b00e994d13278b9105af947b5', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '1579cf5b2a08a77e7fd41e5db5a206e76d4faba6', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: 'ef8ba3bdde8959a3e8dc1d149c97193d09b70d3c', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: 'b4fbcf83c1701c201e3bae2815980d5d2e3d3638', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'f6382d4a60011eaedb2952453044520629f03354', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
