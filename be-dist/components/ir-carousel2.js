...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        return (h("div", { key: '4519e84b11d51384687e6e082524b545b58c1bc2', class: "swiper", ref: el => (this.carouselEl = el) }, h("div", { key: 'eda336eddc7b177927f37a7bad6bdcb112017df8', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide" }, h("img", { src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '51e6df09934b75172126d49c9a02fd2398402052', class: "swiper-pagination" }), h("div", { key: 'c09266322722e137990f8a9683e835a465ebc16e', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: '1889c7d34273c9939dd9df361e41bf47dfd676c0', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'c899827d3e8f8c774b0854a9e573914b5f0c1364', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: 'af3d7d7fa53d81b2559f649a1614dc171096f4ef', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '330cf5437437920104ca10584ded8fd618ba2099', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'c77880a2445c267bf8383326d95d9a7caca7805b', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
