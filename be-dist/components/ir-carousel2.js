...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        return (h("div", { key: 'cc569c0c5206b9fac81479fed56be9282a152dcf', class: "swiper", ref: el => (this.carouselEl = el) }, h("div", { key: '499fb6bb97697af1f04a7014720547c9fbce9d1e', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide" }, h("img", { src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '9acbb53a6b89eefb693c3d7141269e2a463d581c', class: "swiper-pagination" }), h("div", { key: '08390083aa888d719712094b7052e2a703df3d36', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: 'c8f09d4ffb87d8cca83a35894436a54861d12b2a', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'efa60e79fa9aa5556a6d31a945cefaf10b38abaf', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '53e5fc994880d7adfbf21203141994e22bd3f8d3', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: 'aef63345102a664a6a09a03ee2d6956806ad08e5', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'c46a0699a2d127430c18de218f541fb1782f0196', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
