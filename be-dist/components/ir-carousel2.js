...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '8b1dc4a4c1d97e9602e616eda613f79813b6806a', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: '259311e62d00f8327b5ad4c12bd7842bb15f3090', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, h("ir-image", { thumbnail: slide.thumbnail, class: "slide-img", src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: 'a7aac01891664af6b27080b8e5ac04328b4dcd8d', class: "swiper-pagination" }), h("div", { key: 'f4e50e943cc6c6d3bc724fa3f2be218ba6d1f4df', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: '86db127daae5e5f43dbe8cccc8d7c2125b57f8f3', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '353eddaaed0d5a81583a1f7fea7550622080d3c1', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '9171127bcceb0c9ebf831ae30d38489e40b9b908', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '6a64730f95bfd3fc3c432394c795bb3fdf00ee39', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'd4c71ea6664d9b18b767aade2d0c5d085b3c35f1', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
