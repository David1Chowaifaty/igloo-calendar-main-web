...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: 'd67d2ea52ce4b7cd1ddf37c18a4efb38fc387711', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: 'd9de4d4984c3402a1ecd89ce7bb446b3ecc6b65a', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, h("img", { loading: "lazy", src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '1fd9f5c0ee07a96ac0c2574e0a38e8572789c2bd', class: "swiper-pagination" }), h("div", { key: '3f856fad27d2ef8a481c0a21af6c5ade3ce5763c', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: 'b3311512df268f64bf3564aa981a330d6a4b7b01', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '3b880c9c0c8235d79eabd5807efb8bc23eeed80d', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '23764c8209fbb358309d8853abc7309874059663', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '6eebf475da841256ab4d6d90f9e5873e8f650c21', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '7ce3a09520db3b391c5677e2946448e0bc3faed6', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
