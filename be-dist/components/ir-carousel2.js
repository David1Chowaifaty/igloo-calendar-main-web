...
import { d as defineCustomElement$1 } from './ir-image2.js';
...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '22ab0fdb670b300f5de07aa63cccb5f7549b6600', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: 'a7ffeb235de2502e52e3e8f80b2f302cc8bc5cd2', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, h("ir-image", { thumbnail: slide.thumbnail, class: "slide-img", src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '00b294555403c15f9d53eb73153224551e47776c', class: "swiper-pagination" }), h("div", { key: 'aae970774cbe5870c429b2a05a38dda23f291c25', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: 'd4eccc30db40ea77a5fadabc9a0a70a94ae7fbd4', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'd8cb7d01266de25c03e6c429df744469e15ea2a6', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '3abf2e27d1f8890f8398d98684e9c812a2503cdc', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '05a8a05a4381426cc44c3ff96133aac18942e8cc', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '87c50700542dfcdb8a4bb95db29861c7002c16c2', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
...
function defineCustomElement() {
    ...
    const components = ["ir-carousel", "ir-image"];
