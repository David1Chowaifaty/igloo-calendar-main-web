...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '1ff27e3b0f45e26ef9a825ef5443ffc24106bb78', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: 'bc7c49c7216fb86b1c037e2001ddda3f4cbd8d3f', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, h("ir-image", { thumbnail: slide.thumbnail, class: "slide-img", src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '7865afc4a531295455017d2d91d6b992ce5f208d', class: "swiper-pagination" }), h("div", { key: '7652daff793cd451444cecb2741fbee9f9aec937', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: '2da649142ae8ceef6827013be90172b7ca260818', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '21f742662765ce24998faed28588293b6151562d', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: 'b8237a49ae20766f89b4a5b725b17520d2d7260e', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '298f3516a338e030fdd1621c6af081991da1239f', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '689030a47deba3a9b07856ce0380d7862579f2e5', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
