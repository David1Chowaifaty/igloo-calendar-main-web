...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        return (h("div", { key: '5efb72243eb0de503dcbc7fe7c7b410f293d0efd', class: "swiper", ref: el => (this.carouselEl = el) }, h("div", { key: '01ff47d30cca9a9b39cd88e97ce76da835799877', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide" }, h("img", { src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '82d30d02772d53ae9ca3cf2646377e412a151c15', class: "swiper-pagination" }), h("div", { key: 'f21aa8f14868684cad05b62fb9dbb936ccc6d695', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: '9193a92c5d6c46479a39654e0a848a7b128b7a3a', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '37b9e6cc6ecb9d7d80922978ece17399999b85a2', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '7f0d46638716f26c2b96ee054f8b32c6a6dc4267', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '3ffae7e014ca02f76d24b893e03202ab5fa0ea43', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '45da97b2fecb3aae38231f009faf62c3d0838d99', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
