...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        return (h("div", { key: 'e994c14f3416642a39e1b78a712bbf63fd69e83d', class: "swiper", ref: el => (this.carouselEl = el) }, h("div", { key: 'ed19c9ad8333533c320e676ccc1ee22f934a9319', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide" }, h("img", { src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '654dec0743db1c77ee7fb2c25d86cd7a50cf433c', class: "swiper-pagination" }), h("div", { key: '9f7c073de96a32c8537cbac85a3959ab80978081', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: '67179b206dd135e5d5ac9a4d7138502305b9a237', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '286fc526560ec2b20c540c654a470aa569c5a2af', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '5b625854d3796ecc453f8367af44c75d63ac2488', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '531734bae43dae463863eec009b7c7320135578e', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '70be88b7bed3152605e5dad96631bdc25fe9af35', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
