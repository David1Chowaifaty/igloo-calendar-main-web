...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '025c22412fb1d44148c56d9728e052349171120c', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: '678ab6b4f23fd30d2fce2778a890b121826baa75', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, h("ir-image", { thumbnail: slide.thumbnail, class: "slide-img", src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: 'a640341171ea172404e1232641ce2d1be6302cd4', class: "swiper-pagination" }), h("div", { key: '33e5bd8a94643c9e24dcb49941c1bfa87d570a26', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: 'c80aa2627e0789a16fbfa6dc478580e622d685f7', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'a2e877cba770b1bfa078f4715b083232dab43679', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: 'b3007a6cda7552e441b83f53645394b2d89e3382', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '6d35bc1ee2ed8054de68c3d807ec9233a4f7a79a', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '25c418cbe1c85cc52805c1c6bc2e7f1d56aa693b', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
