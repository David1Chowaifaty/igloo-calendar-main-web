...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '1ff27e3b0f45e26ef9a825ef5443ffc24106bb78', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: 'bc7c49c7216fb86b1c037e2001ddda3f4cbd8d3f', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, h("img", { loading: "lazy", src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: 'ad744fc98bb7823b82443dbc88d0025e76280a6c', class: "swiper-pagination" }), h("div", { key: 'dc1bb96f4d7f4772f67c8c30b94bba8567be7043', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: 'a4852a7f2da3e7c0f403fd5196dd0dd0532b13dd', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'd1d3c0043207da59431ca0bec595de5ea0327b54', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '2596f849840f978773c1600111ffa53a7b46c681', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '75c23d68afe13e14fb629cf70e43107c2be0a458', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'ed2243b33c7e5106da3e48fbaac756ecd6fc63f6', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
