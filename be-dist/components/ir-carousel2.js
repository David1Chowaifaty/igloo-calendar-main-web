...
const IrCarousel = /*@__PURE__*/ proxyCustomElement(class IrCarousel extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '8b1dc4a4c1d97e9602e616eda613f79813b6806a', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: '259311e62d00f8327b5ad4c12bd7842bb15f3090', class: "swiper-wrapper" }, this.slides.map(slide => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, h("ir-image", { class: "slide-img", src: slide.image_uri, onClick: () => this.carouselImageClicked.emit(null), key: slide.id, alt: slide.alt }))))), h("div", { key: '50424d84c997e01230046765509abc165443e824', class: "swiper-pagination" }), h("div", { key: '9ae5acb118a514a3308a949ad43c8cd43d766841', class: "swiper-button-prev lg:size-7", ref: el => (this.prevEl = el) }, h("svg", { key: 'd7e5d8f424ee371670492734376b28735cd2e472', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'c2af5b70d4f9f70aa4c2e32ecc775ce30e8e1378', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '1d029e4c532f4cb7f14790ce440984e4251b9e87', class: "swiper-button-next lg:size-7", ref: el => (this.nextEl = el) }, h("svg", { key: '873b37d8190ec43a3d3ddc24615ad9bde16f6691', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '0e2ccd3f2e2d8f3dd853b08d6d0bce9f45de6616', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))));
    }
