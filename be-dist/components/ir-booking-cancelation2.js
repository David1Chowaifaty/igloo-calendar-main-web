...
const IrBookingCancelation = /*@__PURE__*/ proxyCustomElement(class IrBookingCancelation extends HTMLElement {
    ...
    async setOverdueAmount() {
        ...
        try {
            ...
            if (cancelationBrackets) {
                this.paymentAmount = (_b = (_a = cancelationBrackets.brackets.find(b => dateFns.isBefore(new Date(b.due_on), book_date) || dateFns.isSameDay(new Date(b.due_on), book_date))) === null || _a === void 0 ? void 0 : _a.gross_amount) !== null && _b !== void 0 ? _b : 0;
            }
    ...
    static get style() { return IrBookingCancelationStyle0; }
}, [1, "ir-booking-cancelation", {
        "booking_nbr": [1],
        "cancelation": [1],
        "cancelation_policies": [16],
        "currency": [16],
        "booking": [16],
        "paymentAmount": [32],
        "isLoading": [32],
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-cancelation", "ir-alert-dialog", "ir-button", "ir-icons", "ir-skeleton"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-booking-cancelation":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrBookingCancelation);
            }
            break;
...
export { IrBookingCancelation as I, defineCustomElement as d };

//# sourceMappingURL=ir-booking-cancelation2.js.map