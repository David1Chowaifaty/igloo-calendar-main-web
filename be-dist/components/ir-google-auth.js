...
const IrGoogleAuth$1 = /*@__PURE__*/ proxyCustomElement(class IrGoogleAuth extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    static get style() { return IrGoogleAuthStyle0; }
}, [2, "ir-google-auth"]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["ir-google-auth"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-google-auth":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrGoogleAuth$1);
            }
            break;
    } });
}

const IrGoogleAuth = IrGoogleAuth$1;
const defineCustomElement = defineCustomElement$1;

export { IrGoogleAuth, defineCustomElement };
