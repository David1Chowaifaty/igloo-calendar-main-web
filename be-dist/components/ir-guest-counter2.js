...
const IrGuestCounter = /*@__PURE__*/ proxyCustomElement(class IrGuestCounter extends HTMLElement {
    ...
    render() {
        return (h("div", { key: '98588c2107623a447624c8333b2df60e0bee1788', class: "counter-container" }, h("div", { key: '96e379e50c482a9e7e0777ecb8715792c74c8c98', class: "counter-item" }, h("div", { key: '746436533c6215bed4fdfd83396991c062064e03' }, h("p", { key: '8005ff47deef9414bd3076bbe736ddffed8da8d4', class: "main-text" }, "Adults"), h("p", { key: 'bb9005bcbe52dac6459520bcc329f076497a7a6d', class: "secondary-text" }, "Age ", this.childMaxAge + 1, "+")), h("div", { key: '590c72aa0009f2b5a80fa260f781c4140439d5ed', class: "counter-buttons-group" }, h("ir-button", { key: '7e2ae7bb16e8515f4cf2b54370880edb7eb03ea8', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), h("p", { key: '2abeb3972dffb55674ab8180004db3115d7338f3' }, this.adultCount), h("ir-button", { key: '4395557986bd037e4d73fa5d4691a7916375bbae', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), h("div", { key: '3aeadebbe27d17fa81fab3bdcf69a2a25500447e', class: "counter-item" }, h("div", { key: 'e8224e52ea6074098815501995bf8238aefa50d6' }, h("p", { key: '3f8ab613a93f815ab9db980910aaa7b263f49ad2', class: "main-text" }, "Children"), h("p", { key: 'f8ad9e30caae92d8ae9c34ad0ee6c75221fa90c0', class: "secondary-text" }, "Ages 1-", this.childMaxAge)), h("div", { key: '4793799511eb5750cdb7210a765a04212cf4218e', class: "counter-buttons-group" }, h("ir-button", { key: '72a5eda5c03a8303f17d3eb9ff8a176a228ca69b', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), h("p", { key: '39e7867b53eb8ff20208b5e2b24e01fa1404fde4' }, this.childrenCount), h("ir-button", { key: '8506b0f9b045a373b5a1387550ccb6404d7ced0a', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" }))), h("ir-button", { key: '63c494626414c4610c750af114d229699b2aa437', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
