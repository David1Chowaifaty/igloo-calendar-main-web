...
const IrPopover = /*@__PURE__*/ proxyCustomElement(class IrPopover extends HTMLElement {
    ...
    render() {
        return (h(Fragment, { key: 'ac9cd2b343553fe19120841050289c1314bc9f2f' }, this.isMobile && (h("div", { key: 'eb8ce80ac2ea0f01b811cf163d9fab3d952c9330', class: "w-full md:hidden" }, h("div", { key: '3add338e5e894a2a90e03b60b348b6d4dadecc6e', class: "w-full", onClick: () => {
                this.dialogElement.openModal();
            } }, h("slot", { key: '309729c604cc8d3ddfbc40610875fcbb8ac16f35', name: "trigger" })), h("ir-dialog", { key: '05d48a069cb58d74fb3ce61464c949e7d1f07e8e', closeButton: this.showCloseButton, ref: el => (this.dialogElement = el), onOpenChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isDialogOpen = e.detail;
                this.openChange.emit(e.detail);
            } }, h("div", { key: 'e4ced42dec750e02d539fbb8da5e500d12765adf', slot: "modal-body" }, h("slot", { key: '6101f8a4a6b27a2bb0db5ac6fbfdeca78346e69c', name: "popover-content" }))))), !this.isMobile && (h("div", { key: '9f48e0f81e9d8a98a134dc8028ecf749d3a44cee', class: "hidden sm:block" }, h("div", { key: 'a726b55e20d3afc0684adddf79281a360e0ede77', ref: el => (this.triggerElement = el), onClick: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.toggleVisibility();
            } }, h("slot", { key: 'f384b2c9fafa5cb417b1fa98301b8bff11873c40', name: "trigger" }, h("button", { key: 'acbaf47da8991ed832f72404a37959f163c94cb1', class: "trigger" }, h("span", { key: '3c56a273cc3e13f353984b003a59b7f1d9491d10' }, this.trigger_label), h("svg", { key: 'e55dbc26b53b7a2ac4d562356d474b8b52d4f78c', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'b0d0c0c85c1e5041997107b02a77e7e8025c7557', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), h("div", { key: '680a19a3d6c64c1e07106b6ff5c24c2d8addcb86', class: "popover-content", ref: el => (this.contentElement = el) }, this.isVisible && (h("div", { key: '9360aff45e9ca948f6338d9837585d4460f62780' }, h("slot", { key: 'ee8069ac3bbeb870dc9d437c8533f6387711a7f4', name: "popover-content" }))))))));
    }
    get el() { return this; }
