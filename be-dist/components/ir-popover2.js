...
const IrPopover = /*@__PURE__*/ proxyCustomElement(class IrPopover extends HTMLElement {
    ...
    render() {
        return (h(Fragment, { key: '53c9b8132d7ff689731ed0c3e1a63bca0fc22293' }, this.isMobile && (h("div", { key: 'ef84fddf6134f9d4eb56d6e648a27c103f8cd493', class: "w-full md:hidden" }, h("div", { key: 'fe82f205dd706ef2ab621538e871a2dd927ba4a0', class: "w-full", onClick: () => {
                this.dialogElement.openModal();
            } }, h("slot", { key: '7c0f59566684afc8f904fd8cbbdc26ac3c23f038', name: "trigger" })), h("ir-dialog", { key: '044fcce7693ec8d2c4b977a0cdbe3921887a62a7', closeButton: this.showCloseButton, ref: el => (this.dialogElement = el), onOpenChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isDialogOpen = e.detail;
                this.openChange.emit(e.detail);
            } }, h("div", { key: '746863ea30dc8e2c78d9fb3a0af23a4ec4b1c2e4', slot: "modal-body" }, h("slot", { key: '66fc383d2c1db4bf70ba59037a0333c5f59d6178', name: "popover-content" }))))), !this.isMobile && (h("div", { key: 'c1f613ae1f013343b5d289319bd392314b62a4f6', class: "hidden sm:block" }, h("div", { key: 'a9617b335062f6d825905b31cb5ff389c1486d27', ref: el => (this.triggerElement = el), onClick: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.toggleVisibility();
            } }, h("slot", { key: '54eae6f15a7fb6af28bd45e51c2f794d73804057', name: "trigger" }, h("button", { key: '563f4e007dd7e1d6bbd771fb7fee497f74df949b', class: "trigger" }, h("span", { key: 'f7088f4fc7f2cce04633220649026bdddf682096' }, this.trigger_label), h("svg", { key: 'c33ce1bb29096c67c6e7ccd7330bf9657b9ce9b1', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '6837b96307365f5c25ebf0236413d3cbda2aa66c', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), h("div", { key: '241d3232d0a615dc0116a1bc7fb50914b203a37f', class: "popover-content", ref: el => (this.contentElement = el) }, this.isVisible && (h("div", { key: '863ec4b4d1fd15f1b36d8791b453e4590860d94b' }, h("slot", { key: '2d289e30a11f96ad855ec5a8d7436a13691bfb4a', name: "popover-content" }))))))));
    }
    get el() { return this; }
