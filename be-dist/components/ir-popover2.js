...
const IrPopover = /*@__PURE__*/ proxyCustomElement(class IrPopover extends HTMLElement {
    ...
    render() {
        return (h(Fragment, { key: 'bf6a740c7242afe851b5af478c7ab14f95d89f2b' }, this.isMobile && (h("div", { key: '36f0c9befb2999cdb556f072988625187f5220c7', class: "w-full md:hidden" }, h("div", { key: '0536514d13ab7fabaceaa4ed71282092a1111eec', class: "w-full", onClick: () => {
                this.dialogElement.openModal();
            } }, h("slot", { key: '9bc425776d0834013cb4836da71d87523746bacb', name: "trigger" })), h("ir-dialog", { key: 'f3bb450a260cbc2c2b66b12162c2c07ab978567f', closeButton: this.showCloseButton, ref: el => (this.dialogElement = el), onOpenChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isDialogOpen = e.detail;
                this.openChange.emit(e.detail);
            } }, h("div", { key: '39616c2c60fc0042aee854785b693b678c400415', slot: "modal-body" }, h("slot", { key: '07293254c44379a2e3f15e77f2b3addd8a770b74', name: "popover-content" }))))), !this.isMobile && (h("div", { key: '357b955a5d838505b34d846bbb0a76e8514fdabf', class: "hidden sm:block" }, h("div", { key: '53467322256bbcdd7fa2ef230e5b0bcd27396750', ref: el => (this.triggerElement = el), onClick: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.toggleVisibility();
            } }, h("slot", { key: 'db56f6e204124516def21044cdd0255f722949fa', name: "trigger" }, h("button", { key: '3dc8db2495e5dd1477c5b33ecd85ce17f8489d27', class: "trigger" }, h("span", { key: '171d4cd7f435a97d33ebdee60762855812038874' }, this.trigger_label), h("svg", { key: '9e323f1e05cfc5780a79d93d57a89b3e7322583e', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '46f77be4470eb11ef18161ebecc10a5b4d3bad53', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), h("div", { key: '95029dd924c09208598ccf4d9c7e3f1eac5309f3', class: "popover-content", ref: el => (this.contentElement = el) }, this.isVisible && (h("div", { key: 'b0e6b87dc5a5fdbf3a1fd0631e83aef44b228bee' }, h("slot", { key: '2980e72f736b139cb3fef5be6ecbcbb5fb4572dd', name: "popover-content" }))))))));
    }
    get el() { return this; }
