...
const IrPopover = /*@__PURE__*/ proxyCustomElement(class IrPopover extends HTMLElement {
    ...
    render() {
        return (h(Fragment, { key: 'a246de40fb6c2c09275536cca6457ab22546559d' }, this.isMobile && (h("div", { key: '74807471b2cfcef1daa56a579d42b5684697e9f6', class: "w-full md:hidden" }, h("div", { key: 'e26184817d0417b330b30c1565b142669ae7b15c', class: "w-full", onClick: () => {
                this.dialogElement.openModal();
            } }, h("slot", { key: '6efc0199d1c8ea02c8616143effcd58fdb773c22', name: "trigger" })), h("ir-dialog", { key: '289364f7a48637f0436b01c3b7bced03c41a81bd', closeButton: this.showCloseButton, ref: el => (this.dialogElement = el), onOpenChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isDialogOpen = e.detail;
                this.openChange.emit(e.detail);
            } }, h("div", { key: 'e638f57e415fde7a9f722eb47d492c11f3e6fea6', slot: "modal-body" }, h("slot", { key: 'ce8a6f1a06e9fa27920f7c67cb88996e8148cd95', name: "popover-content" }))))), !this.isMobile && (h("div", { key: '149a6afbe69be0cd320db0ebfe493b080d9ad001', class: "hidden sm:block" }, h("div", { key: 'f2ebe5a10434d848cc43902f2f67a25444f08f70', ref: el => (this.triggerElement = el), onClick: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.toggleVisibility();
            } }, h("slot", { key: 'c8459abd3cfe4fa5a2699896fc110160d37c5bc0', name: "trigger" }, h("button", { key: 'ee9e8444c062486ed4df640612af7fb16566ddc6', class: "trigger" }, h("span", { key: 'a33cbc2fd7afb3645e34de843b3b80e3ecf99ca9' }, this.trigger_label), h("svg", { key: '83abb91a75c9fa00d84d0a23aec0ba42e1affc63', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '650f7eaa976100fadeebdf5bda178d782a46aaaf', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), h("div", { key: '742a115f3a788005ae0dfb2d0bed4e2ace9fb3de', class: "popover-content", ref: el => (this.contentElement = el) }, this.isVisible && (h("div", { key: 'bb28fe9e29e3f81b84c3a8797e3e3ddc30ce7497' }, h("slot", { key: '8b582f3a731c4fd990f02adfb6d41706fe53d220', name: "popover-content" }))))))));
    }
    get el() { return this; }
