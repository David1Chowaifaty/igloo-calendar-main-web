...
const IrPopover = /*@__PURE__*/ proxyCustomElement(class IrPopover extends HTMLElement {
    ...
    render() {
        return (h(Fragment, { key: '89c1a29a5e022ffae7a4907b1f352c5325ec3a5f' }, this.isMobile && (h("div", { key: '8c3e7be43dc7f31ec4972b59f1f545512b0d60c6', class: "w-full md:hidden" }, h("div", { key: 'f1cc4c949f08c8527712a30e332d17b1f955d938', class: "w-full", onClick: () => {
                this.dialogElement.openModal();
            } }, h("slot", { key: '3c28ea5f91bed9ea1265cf31aa1392d80c021dfc', name: "trigger" })), h("ir-dialog", { key: 'd503cc8e8b7f758ccefdcd5545182ed2fc1392b6', closeButton: this.showCloseButton, ref: el => (this.dialogElement = el), onOpenChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isDialogOpen = e.detail;
                this.openChange.emit(e.detail);
            } }, h("div", { key: '66e6834aff51e0fd66187961e80e57550fabe054', slot: "modal-body" }, h("slot", { key: '1c39905b2f0ea65e88cc503de6df2f34cca450ab', name: "popover-content" }))))), !this.isMobile && (h("div", { key: '7e9c20f5965c6c759a74e3f8b7793400fc28163c', class: "hidden sm:block" }, h("div", { key: '990f66725ff52f807b55b4e52d327b0cd81ba1ec', ref: el => (this.triggerElement = el), onClick: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.toggleVisibility();
            } }, h("slot", { key: 'e8944ea5720f072ed1f42bc75c2fd8bce7a1e895', name: "trigger" }, h("button", { key: '30419175571b800f125dcdcb4c6a1a1c8357773c', class: "trigger" }, h("span", { key: '27c8ce8e335b6dfb5c045baed348d79fd87a259b' }, this.trigger_label), h("svg", { key: 'fc5d41dc0006ba75733cf8f33d4ca768eacaaf21', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '1cbabb63cc7295e8bd8ebe57414208f439bdff42', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), h("div", { key: 'cd052575bc2afcbc884eaac875928885991c3dad', class: "popover-content", ref: el => (this.contentElement = el) }, this.isVisible && (h("div", { key: '440813900416558152ed2811467bfc95a4b15f0f' }, h("slot", { key: 'c7c51b7a9f9153633c1c1cc6a783fd80aedbbed8', name: "popover-content" }))))))));
    }
    get el() { return this; }
