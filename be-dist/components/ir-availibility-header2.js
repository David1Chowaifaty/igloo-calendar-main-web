...
const IrAvailibilityHeader = /*@__PURE__*/ proxyCustomElement(class IrAvailibilityHeader extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '2662d6336183b8766ac3034aa099a0dc4ba8cb62', class: "availability-container" }, h("div", { key: '6b9cd9fa219421e2887bb40ab22ca50b152ae6b6', class: "availability-inputs" }, h("ir-date-popup", { key: '9d59682efd62610c38d3422bef00be4afeab9d19', "data-state": ((_a = this.errorCause) === null || _a === void 0 ? void 0 : _a.find(c => c === 'date')) ? 'error' : '', dates: {
            ...
            }, class: "date-popup" }), h("div", { key: 'cc351d7594561ce4a4c8356adc8b00e8ded37720', class: "availability-controls" }, h("ir-adult-child-counter", { key: 'a5a1200d7abd6c1cfd9692274df52c82cd1959a4', "data-state": ((_d = this.errorCause) === null || _d === void 0 ? void 0 : _d.find(c => c === 'adult_child')) ? 'error' : '', adultCount: this.exposedBookingAvailabiltyParams.adult_nbr, childrenCount: this.exposedBookingAvailabiltyParams.child_nbr, minAdultCount: 0, maxAdultCount: app_store.property.adult_child_constraints.adult_max_nbr, maxChildrenCount: app_store.property.adult_child_constraints.child_max_nbr, childMaxAge: app_store.property.adult_child_constraints.child_max_age, class: "adult-child-counter" }), h("ir-button", { key: '200efba64f565e5907e58307ffc1bb6fedf45948', isLoading: this.isLoading, onButtonClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.handleCheckAvailability();
            }, size: "pill", variants: "icon-primary", iconName: "search", label: "Check availability" }))), ((_e = app_store === null || app_store === void 0 ? void 0 : app_store.property) === null || _e === void 0 ? void 0 : _e.promotions) && (h("div", { key: 'ddd0ac85007ef5ac1f0727facb1c276570c4237c', class: "promotions-container" }, h("ir-coupon-dialog", { key: '93f6378c5ca6d0fede2b43073131a78ec95ac39d', class: "coupon-dialog" }), h("ir-loyalty", { key: '2dd4f7b1c208dc0fa09f5e580e52d88803b5a230', class: "loyalty" })))));
    }
