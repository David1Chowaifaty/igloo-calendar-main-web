...
import { g as getDateDifference, f as formatAmount, c as cn, d as dateFns } from './utils.js';
...
const IrInvoice = /*@__PURE__*/ proxyCustomElement(class IrInvoice extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, null, h("ir-interceptor", null), h("main", { class: "relative flex w-full flex-col space-y-5" }, this.headerShown && (h("section", { class: "sticky top-0 z-50 m-0  w-full  p-0" }, h("ir-nav", { class: 'm-0 p-0', showBookingCode: false, website: (_a = app_store.property) === null || _a === void 0 ? void 0 : _a.space_theme.website, logo: (_c = (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.space_theme) === null || _c === void 0 ? void 0 : _c.logo }))), h("section", { class: "flex-1 px-4 lg:px-6" }, h("div", { class: "mx-auto flex max-w-6xl gap-16" }, h("div", { class: "invoice-container" }, h("section", { class: "flex items-center gap-4" }, this.status === 1 ? (h("a", { href: google_maps_url, target: "_blank", class: cn(`button-outline`, 'flex items-center justify-center'), "data-size": "sm" }, localizedWords.entries.Lcz_GetDirections)) : (payment_option.is_payment_gateway && h("ir-button", { variants: "outline", label: "Retry Payment" })), h("a", { href: this.getPropertyEmail(), target: "_blank", class: cn(`button-outline`, 'flex items-center justify-center'), "data-size": "sm" }, "Message property"), h("ir-button", { variants: "outline", label: localizedWords.entries.Lcz_CancelBooking, onButtonClick: () => {
