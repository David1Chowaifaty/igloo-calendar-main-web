...
import { g as getDateDifference, c as cn, d as dateFns, f as formatAmount } from './utils.js';
...
import { d as defineCustomElement$c } from './ir-google-maps2.js';
...
import { d as defineCustomElement$8 } from './ir-language-picker2.js';
import { d as defineCustomElement$7 } from './ir-modal2.js';
import { d as defineCustomElement$6 } from './ir-nav2.js';
...
const irInvoiceCss = "*.sc-ir-invoice,.sc-ir-invoice:after,.sc-ir-invoice:before{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;border:0 solid #e5e7eb;box-sizing:border-box}.sc-ir-invoice:after,.sc-ir-invoice:before{--tw-content:\"\"}.sc-ir-invoice-h,html.sc-ir-invoice{-webkit-text-size-adjust:100%;font-feature-settings:normal;-webkit-tap-highlight-color:transparent;font-family:ui-sans-serif,system-ui,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;font-variation-settings:normal;line-height:1.5;-moz-tab-size:4;tab-size:4}body.sc-ir-invoice{line-height:inherit;margin:0}hr.sc-ir-invoice{border-top-width:1px;color:inherit;height:0}abbr.sc-ir-invoice:where([title]){text-decoration:underline dotted}h1.sc-ir-invoice,h2.sc-ir-invoice,h3.sc-ir-invoice,h4.sc-ir-invoice,h5.sc-ir-invoice,h6.sc-ir-invoice{font-size:inherit;font-weight:inherit}a.sc-ir-invoice{color:inherit;text-decoration:inherit}b.sc-ir-invoice,strong.sc-ir-invoice{font-weight:bolder}code.sc-ir-invoice,kbd.sc-ir-invoice,pre.sc-ir-invoice,samp.sc-ir-invoice{font-feature-settings:normal;font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace;font-size:1em;font-variation-settings:normal}small.sc-ir-invoice{font-size:80%}sub.sc-ir-invoice,sup.sc-ir-invoice{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub.sc-ir-invoice{bottom:-.25em}sup.sc-ir-invoice{top:-.5em}table.sc-ir-invoice{border-collapse:collapse;border-color:inherit;text-indent:0}button.sc-ir-invoice,input.sc-ir-invoice,optgroup.sc-ir-invoice,select.sc-ir-invoice,textarea.sc-ir-invoice{font-feature-settings:inherit;color:inherit;font-family:inherit;font-size:100%;font-variation-settings:inherit;font-weight:inherit;line-height:inherit;margin:0;padding:0}button.sc-ir-invoice,select.sc-ir-invoice{text-transform:none}[type=button].sc-ir-invoice,[type=reset].sc-ir-invoice,[type=submit].sc-ir-invoice,button.sc-ir-invoice{-webkit-appearance:button;background-color:transparent;background-image:none}.sc-ir-invoice:-moz-focusring{outline:auto}.sc-ir-invoice:-moz-ui-invalid{box-shadow:none}progress.sc-ir-invoice{vertical-align:baseline}.sc-ir-invoice::-webkit-inner-spin-button,.sc-ir-invoice::-webkit-outer-spin-button{height:auto}[type=search].sc-ir-invoice{-webkit-appearance:textfield;outline-offset:-2px}.sc-ir-invoice::-webkit-search-decoration{-webkit-appearance:none}.sc-ir-invoice::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}summary.sc-ir-invoice{display:list-item}blockquote.sc-ir-invoice,dd.sc-ir-invoice,dl.sc-ir-invoice,fieldset.sc-ir-invoice,figure.sc-ir-invoice,h1.sc-ir-invoice,h2.sc-ir-invoice,h3.sc-ir-invoice,h4.sc-ir-invoice,h5.sc-ir-invoice,h6.sc-ir-invoice,hr.sc-ir-invoice,p.sc-ir-invoice,pre.sc-ir-invoice{margin:0}fieldset.sc-ir-invoice,legend.sc-ir-invoice{padding:0}menu.sc-ir-invoice,ol.sc-ir-invoice,ul.sc-ir-invoice{list-style:none;margin:0;padding:0}dialog.sc-ir-invoice{padding:0}textarea.sc-ir-invoice{resize:vertical}input.sc-ir-invoice::placeholder,textarea.sc-ir-invoice::placeholder{color:#9ca3af;opacity:1}[role=button].sc-ir-invoice,button.sc-ir-invoice{cursor:pointer}.sc-ir-invoice:disabled{cursor:default}audio.sc-ir-invoice,canvas.sc-ir-invoice,embed.sc-ir-invoice,iframe.sc-ir-invoice,img.sc-ir-invoice,object.sc-ir-invoice,svg.sc-ir-invoice,video.sc-ir-invoice{display:block;vertical-align:middle}img.sc-ir-invoice,video.sc-ir-invoice{height:auto;max-width:100%}[hidden].sc-ir-invoice{display:none}.sc-ir-invoice::backdrop{--tw-border-spacing-x:0;--tw-border-spacing-y:0;--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;--tw-scroll-snap-strictness:proximity;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(59,130,246,.5);--tw-ring-offset-shadow:0 0 #0000;--tw-ring-shadow:0 0 #0000;--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000;}.relative.sc-ir-invoice{position:relative}.block.sc-ir-invoice{display:block}.flex.sc-ir-invoice{display:flex}.hidden.sc-ir-invoice{display:none}.transform.sc-ir-invoice{transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.border.sc-ir-invoice{border-width:1px}.underline.sc-ir-invoice{text-decoration-line:underline}.filter.sc-ir-invoice{filter:var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)}.transition.sc-ir-invoice{transition-duration:.15s;transition-property:color,background-color,border-color,text-decoration-color,fill,stroke,opacity,box-shadow,transform,filter,backdrop-filter;transition-timing-function:cubic-bezier(.4,0,.2,1)}.sc-ir-invoice-h{box-sizing:border-box;display:block}[class^=button].sc-ir-invoice{all:unset;border-radius:min(var(--radius,.5rem),30rem);box-sizing:border-box;color:#fff;cursor:pointer;font-weight:500;gap:.5rem;transition:all .3s ease-in-out;width:var(--ir-btn-width,inherit)}[class^=button].sc-ir-invoice:disabled{pointer-events:none;-webkit-user-select:none;-moz-user-select:none;user-select:none}[class^=button].sc-ir-invoice:active,[class^=button].sc-ir-invoice:focus-visible{box-shadow:0 .0625rem .125rem rgba(0,0,0,.1),0 0 0 .25rem hsla(var(--brand-100,209,100%,91%),.2)}.button-default.sc-ir-invoice,.button-icon-primary.sc-ir-invoice{background:hsla(var(--brand-600,215,87%,51%),1)}.button-default.sc-ir-invoice:hover,.button-icon-primary.sc-ir-invoice:hover{background:hsl(var(--brand-700,218,80%,46%))}.button-default.sc-ir-invoice:disabled,.button-icon-primary.sc-ir-invoice:disabled{background:hsl(var(--brand-200,206,100%,85%))}.button-secondary.sc-ir-invoice,.button-secondary.sc-ir-invoice:active,.button-secondary.sc-ir-invoice:focus{background:hsl(var(--brand-50,206,100%,97%));color:hsl(var(--brand-700,218,80%,46%))}.button-secondary.sc-ir-invoice .loader.sc-ir-invoice{background-color:hsl(var(--brand-700,218,80%,46%))}.button-secondary.sc-ir-invoice:hover{background:hsl(var(--brand-100,209,100%,91%))}.button-secondary.sc-ir-invoice:disabled{color:hsl(var(--brand-300,206,100%,76%))}.button-outline.sc-ir-invoice{background:#fff;border:.0625rem solid var(--gray-300,#d0d5dd);color:var(--gray-700,#344054)}.button-outline.sc-ir-invoice .loader.sc-ir-invoice{background-color:var(--gray-700,#344054)}.button-outline.sc-ir-invoice:hover{background:var(--gray-50,#f9fafb);color:var(--gray-800,#1d2939)}.button-outline.sc-ir-invoice:disabled{background:var(--gray-50,#f9fafb);border-color:var(--gray-300,#d0d5dd);color:var(--gray-300,#d0d5dd)}.button-outline.sc-ir-invoice:active,.button-outline.sc-ir-invoice:focus-visible{box-shadow:0 .0625rem .125rem rgba(0,0,0,.1),0 0 0 .25rem var(--gray-100,#f2f4f7)}.button-outline-primary.sc-ir-invoice{border:.0625rem solid hsl(var(--brand-600,#d0d5dd));color:hsl(var(--brand-700,#344054))}.button-outline-primary.sc-ir-invoice .loader.sc-ir-invoice{background-color:hsl(var(--gray-700,#344054))}.button-outline-primary.sc-ir-invoice:hover{background:hsla(var(--brand-50,#f9fafb),.05);color:hsl(var(--brand-800,#1d2939))}.button-outline-primary.sc-ir-invoice:disabled{background:hsl(var(--brand-200,#eaecf0));color:hsl(var(--brand-300,#d0d5dd))}.button-outline-primary.sc-ir-invoice:active,.button-outline-primary.sc-ir-invoice:focus-visible{box-shadow:0 .0625rem .125rem rgba(0,0,0,.1),0 0 0 .25rem hsl(var(--brand-100,#f2f4f7),.1)}.button-ghost.sc-ir-invoice,.button-icon.sc-ir-invoice{color:var(--gray-600,#475467)}.button-ghost.sc-ir-invoice:hover,.button-icon.sc-ir-invoice:hover{background:var(--gray-100,#fcfcfd);color:var(--gray-700,#344054)}.button-ghost.sc-ir-invoice:active,.button-icon.sc-ir-invoice:active{box-shadow:none}.button-ghost.sc-ir-invoice:disabled,.button-icon.sc-ir-invoice:disabled{color:var(--gray-300,#d0d5dd)}.button-ghost-primary.sc-ir-invoice{background:#fff;color:hsl(var(--brand-600,215,87%,51%))}.button-ghost-primary.sc-ir-invoice:hover{background:hsla(var(--brand-50,206,100%,97%),.2);color:hsl(var(--brand-700,218,80%,46%))}.button-ghost-primary.sc-ir-invoice:disabled{background:#fff;color:var(--brand-300,#d0d5dd)}.button-link.sc-ir-invoice{background:#fff;color:var(--gray-600,#475467)}.button-link.sc-ir-invoice:hover{text-decoration:underline}.button-link.sc-ir-invoice:disabled{background:#fff;color:var(--gray-300,#d0d5dd)}.button-destructive.sc-ir-invoice{background:var(--error-600,#d92d20)}.button-destructive.sc-ir-invoice:hover{background:var(--error-700,#b42318)}.button-destructive.sc-ir-invoice:disabled{background:var(--error-200,#fecdca)}.button-destructive.sc-ir-invoice:active,.button-destructive.sc-ir-invoice:focus-visible{box-shadow:0 .0625rem .125rem rgba(0,0,0,.1),0 0 0 .25rem var(--error-100,#fee4e2)}[class^=button][data-size=sm].sc-ir-invoice{font-size:.875rem;line-height:.875rem;padding:.5rem 1rem}[class^=button][data-size=md].sc-ir-invoice{font-size:1rem;line-height:1.5rem;padding:.5rem 1.2rem}[class^=button][data-size=lg].sc-ir-invoice{font-size:1rem;line-height:1.5rem;padding:.6875rem 1.35rem}.button-icon-primary[data-size=sm].sc-ir-invoice,.button-icon[data-size=sm].sc-ir-invoice{padding:.5rem}.button-icon-primary[data-size=md].sc-ir-invoice,.button-icon[data-size=md].sc-ir-invoice{height:3rem;padding:.625rem}.button-icon-primary[data-size=lg].sc-ir-invoice,.button-icon[data-size=lg].sc-ir-invoice{padding:.75rem}.button-icon-primary[data-size=pill].sc-ir-invoice{height:2.5rem;width:2.5rem}.loader.sc-ir-invoice{--_m:conic-gradient(#0000 10%,#000),linear-gradient(#000 0 0) content-box;animation:l3 1s linear infinite;aspect-ratio:1;background:#fff;border-radius:50%;-webkit-mask:var(--_m);mask:var(--_m);-webkit-mask-composite:source-out;mask-composite:subtract;padding:.125rem;width:.75rem}@keyframes l3{to{transform:rotate(1turn)}}button.is-loading.sc-ir-invoice slot[name=btn-icon].sc-ir-invoice{display:none}.booking-info.sc-ir-invoice{border-bottom:1px solid var(--gray-300,#d0d5dd)}.booking-info-text.sc-ir-invoice,.room-info-text.sc-ir-invoice{color:var(--gray-800,#1d293a);font-size:.875rem;font-weight:500}.booking-info-text.sc-ir-invoice span.sc-ir-invoice,.room-info-text.sc-ir-invoice span.sc-ir-invoice{color:var(--gray-600,#344055);font-weight:400}.room-info.sc-ir-invoice,section.sc-ir-invoice{padding:1rem 0}.booking-details-header.sc-ir-invoice{font-size:1.1rem;font-weight:600}.room-type.sc-ir-invoice{font-size:1rem;font-weight:600;margin-bottom:.3rem}p.sc-ir-invoice{font-size:.875rem}.total-payment.sc-ir-invoice{font-size:1rem}.mapLink.sc-ir-invoice{background:#000;overflow:hidden;position:relative;width:100%}.mapLink.sc-ir-invoice img.sc-ir-invoice{-o-object-fit:cover;object-fit:cover}.mapLink.sc-ir-invoice:hover img.sc-ir-invoice{filter:brightness(.9)}.property_info.sc-ir-invoice{background-color:#f3f4f6;border-radius:min(var(--radius,.5rem),1rem);display:none;height:-moz-fit-content;height:fit-content}.property_img.sc-ir-invoice{border-top-left-radius:min(var(--radius,.5rem),1rem);border-top-right-radius:min(var(--radius,.5rem),1rem)}.contact-info.sc-ir-invoice{align-items:center;display:flex;font-size:.875rem;gap:.25rem;justify-content:center;padding:1rem}.contact-link.sc-ir-invoice{color:inherit;text-decoration:none;transition:color .2s}.contact-link.sc-ir-invoice:hover{color:#334155;text-decoration:underline}a.sc-ir-invoice:hover{text-decoration:none}@media (min-width:768px){.mapLink.sc-ir-invoice img.sc-ir-invoice{aspect-ratio:16/9;height:200px}.property_info.sc-ir-invoice{display:flex;flex-direction:column}}.static.sc-ir-invoice{position:static}.sticky.sc-ir-invoice{position:sticky}.top-0.sc-ir-invoice{top:0}.top-\\[20\\%\\].sc-ir-invoice{top:20%}.z-50.sc-ir-invoice{z-index:50}.m-0.sc-ir-invoice{margin:0}.mx-auto.sc-ir-invoice{margin-left:auto;margin-right:auto}.aspect-\\[1\\/1\\].sc-ir-invoice{aspect-ratio:1/1}.h-full.sc-ir-invoice{height:100%}.max-h-32.sc-ir-invoice{max-height:8rem}.w-full.sc-ir-invoice{width:100%}.max-w-6xl.sc-ir-invoice{max-width:72rem}.flex-1.sc-ir-invoice{flex:1 1 0%}.flex-col.sc-ir-invoice{flex-direction:column}.flex-wrap.sc-ir-invoice{flex-wrap:wrap}.items-center.sc-ir-invoice{align-items:center}.justify-center.sc-ir-invoice{justify-content:center}.justify-between.sc-ir-invoice{justify-content:space-between}.gap-1.sc-ir-invoice{gap:.25rem}.gap-16.sc-ir-invoice{gap:4rem}.gap-4.sc-ir-invoice{gap:1rem}.space-y-2.sc-ir-invoice>.sc-ir-invoice:not([hidden])~.sc-ir-invoice:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.5rem*var(--tw-space-y-reverse));margin-top:calc(.5rem*(1 - var(--tw-space-y-reverse)))}.space-y-5.sc-ir-invoice>.sc-ir-invoice:not([hidden])~.sc-ir-invoice:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(1.25rem*var(--tw-space-y-reverse));margin-top:calc(1.25rem*(1 - var(--tw-space-y-reverse)))}.object-cover.sc-ir-invoice{object-fit:cover}.p-0.sc-ir-invoice{padding:0}.px-4.sc-ir-invoice{padding-left:1rem;padding-right:1rem}.text-center.sc-ir-invoice{text-align:center}.text-lg.sc-ir-invoice{font-size:1.125rem;line-height:1.75rem}.font-medium.sc-ir-invoice{font-weight:500}.text-green-500.sc-ir-invoice{--tw-text-opacity:1;color:rgb(34 197 94/var(--tw-text-opacity))}.outline.sc-ir-invoice{outline-style:solid}@media (min-width:768px){.md\\:text-right.sc-ir-invoice{text-align:right}}@media (min-width:1024px){.lg\\:aspect-\\[16\\/9\\].sc-ir-invoice{aspect-ratio:16/9}.lg\\:px-6.sc-ir-invoice{padding-left:1.5rem;padding-right:1.5rem}}.shadow.sc-ir-invoice{--tw-shadow:0 1px 3px 0 rgba(0,0,0,.1),0 1px 2px -1px rgba(0,0,0,.1);--tw-shadow-colored:0 1px 3px 0 var(--tw-shadow-color),0 1px 2px -1px var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}.h-5.sc-ir-invoice{height:1.25rem}.w-5.sc-ir-invoice{width:1.25rem}.absolute.sc-ir-invoice{position:absolute}.right-3.sc-ir-invoice{right:.75rem}.top-3.sc-ir-invoice{top:.75rem}.mb-4.sc-ir-invoice{margin-bottom:1rem}.max-h-\\[83vh\\].sc-ir-invoice{max-height:83vh}.overflow-y-auto.sc-ir-invoice{overflow-y:auto}.p-4.sc-ir-invoice{padding:1rem}.text-sm.sc-ir-invoice{font-size:.875rem;line-height:1.25rem}.text-xl.sc-ir-invoice{font-size:1.25rem;line-height:1.75rem}.font-semibold.sc-ir-invoice{font-weight:600}.text-\\[var\\(--gray-600\\2c \\#475467\\)\\].sc-ir-invoice{color:var(--gray-600,#475467)}.text-\\[var\\(--gray-700\\2c \\#344054\\)\\].sc-ir-invoice{color:var(--gray-700,#344054)}@media (min-width:768px){.md\\:p-6.sc-ir-invoice{padding:1.5rem}}.sr-only.sc-ir-invoice{clip:rect(0,0,0,0);border-width:0;height:1px;margin:-1px;overflow:hidden;padding:0;position:absolute;white-space:nowrap;width:1px}.mx-1.sc-ir-invoice{margin-left:.25rem;margin-right:.25rem}.justify-start.sc-ir-invoice{justify-content:flex-start}.pointer-events-none.sc-ir-invoice{pointer-events:none}.inset-y-0.sc-ir-invoice{bottom:0;top:0}.end-1.sc-ir-invoice{inset-inline-end:.25rem}.start-2.sc-ir-invoice{inset-inline-start:.5rem}.rounded-md.sc-ir-invoice{border-radius:.375rem}.bg-white.sc-ir-invoice{--tw-bg-opacity:1;background-color:rgb(255 255 255/var(--tw-bg-opacity))}.px-\\[0\\.3rem\\].sc-ir-invoice{padding-left:.3rem;padding-right:.3rem}.px-\\[0\\.875rem\\].sc-ir-invoice{padding-left:.875rem;padding-right:.875rem}.py-1.sc-ir-invoice{padding-bottom:.25rem;padding-top:.25rem}.py-\\[0\\.625rem\\].sc-ir-invoice{padding-bottom:.625rem;padding-top:.625rem}.pe-7.sc-ir-invoice{padding-inline-end:1.75rem}.ps-9.sc-ir-invoice{padding-inline-start:2.25rem}.pt-1.sc-ir-invoice{padding-top:.25rem}.text-\\[1rem\\].sc-ir-invoice{font-size:1rem}.text-xs.sc-ir-invoice{font-size:.75rem;line-height:1rem}.text-\\[\\#667085\\].sc-ir-invoice{--tw-text-opacity:1;color:rgb(102 112 133/var(--tw-text-opacity))}.text-gray-900.sc-ir-invoice{--tw-text-opacity:1;color:rgb(17 24 39/var(--tw-text-opacity))}.fixed.sc-ir-invoice{position:fixed}.right-0.sc-ir-invoice{right:0}.right-4.sc-ir-invoice{right:1rem}.top-4.sc-ir-invoice{top:1rem}.mt-8.sc-ir-invoice{margin-top:2rem}.h-screen.sc-ir-invoice{height:100vh}.min-w-\\[70\\%\\].sc-ir-invoice{min-width:70%}.max-w-full.sc-ir-invoice{max-width:100%}.translate-x-0.sc-ir-invoice{--tw-translate-x:0px}.translate-x-0.sc-ir-invoice,.translate-x-\\[100\\%\\].sc-ir-invoice{transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.translate-x-\\[100\\%\\].sc-ir-invoice{--tw-translate-x:100%}.shadow.sc-ir-invoice,.shadow-md.sc-ir-invoice{box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}.shadow-md.sc-ir-invoice{--tw-shadow:0 4px 6px -1px rgba(0,0,0,.1),0 2px 4px -2px rgba(0,0,0,.1);--tw-shadow-colored:0 4px 6px -1px var(--tw-shadow-color),0 2px 4px -2px var(--tw-shadow-color)}.transition-transform.sc-ir-invoice{transition-duration:.15s;transition-property:transform;transition-timing-function:cubic-bezier(.4,0,.2,1)}.duration-300.sc-ir-invoice{transition-duration:.3s}.ease-in-out.sc-ir-invoice{transition-timing-function:cubic-bezier(.4,0,.2,1)}.data-\\[state\\=\\'closed\\'\\]\\:translate-x-\\[100\\%\\][data-state=closed].sc-ir-invoice{--tw-translate-x:100%}.data-\\[state\\=\\'closed\\'\\]\\:translate-x-\\[100\\%\\][data-state=closed].sc-ir-invoice,.data-\\[state\\=\\'opened\\'\\]\\:translate-x-0[data-state=opened].sc-ir-invoice{transform:translate(var(--tw-translate-x),var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.data-\\[state\\=\\'opened\\'\\]\\:translate-x-0[data-state=opened].sc-ir-invoice{--tw-translate-x:0px}.text-red-500.sc-ir-invoice{--tw-text-opacity:1;color:rgb(239 68 68/var(--tw-text-opacity))}@media (min-width:640px){.sm\\:p-6.sc-ir-invoice{padding:1.5rem}}@media (min-width:768px){.md\\:w-fit.sc-ir-invoice{width:fit-content}.md\\:flex-row-reverse.sc-ir-invoice{flex-direction:row-reverse}}.mb-2.sc-ir-invoice{margin-bottom:.5rem}.mb-2\\.5.sc-ir-invoice{margin-bottom:.625rem}.mb-6.sc-ir-invoice{margin-bottom:1.5rem}.mt-4.sc-ir-invoice{margin-top:1rem}.h-\\[1px\\].sc-ir-invoice{height:1px}.w-\\[45\\%\\].sc-ir-invoice{width:45%}.space-y-3.sc-ir-invoice>.sc-ir-invoice:not([hidden])~.sc-ir-invoice:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.75rem*var(--tw-space-y-reverse));margin-top:calc(.75rem*(1 - var(--tw-space-y-reverse)))}.bg-\\[var\\(--gray-200\\)\\].sc-ir-invoice{background-color:var(--gray-200)}.text-\\[var\\(--gray-500\\)\\].sc-ir-invoice{color:var(--gray-500)}.gap-2.sc-ir-invoice{gap:.5rem}.gap-2\\.5.sc-ir-invoice{gap:.625rem}.space-y-4.sc-ir-invoice>.sc-ir-invoice:not([hidden])~.sc-ir-invoice:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(1rem*var(--tw-space-y-reverse));margin-top:calc(1rem*(1 - var(--tw-space-y-reverse)))}.space-y-8.sc-ir-invoice>.sc-ir-invoice:not([hidden])~.sc-ir-invoice:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(2rem*var(--tw-space-y-reverse));margin-top:calc(2rem*(1 - var(--tw-space-y-reverse)))}.text-2xl.sc-ir-invoice{font-size:1.5rem;line-height:2rem}@media (min-width:768px){.md\\:sticky.sc-ir-invoice{position:sticky}.md\\:top-20.sc-ir-invoice{top:5rem}.md\\:flex.sc-ir-invoice{display:flex}.md\\:max-w-4xl.sc-ir-invoice{max-width:56rem}.md\\:max-w-md.sc-ir-invoice{max-width:28rem}.md\\:flex-row.sc-ir-invoice{flex-direction:row}.md\\:items-start.sc-ir-invoice{align-items:flex-start}.md\\:justify-end.sc-ir-invoice{justify-content:flex-end}}.bottom-2.sc-ir-invoice{bottom:.5rem}.z-40.sc-ir-invoice{z-index:40}.mb-5.sc-ir-invoice{margin-bottom:1.25rem}.mt-14.sc-ir-invoice{margin-top:3.5rem}.w-auto.sc-ir-invoice{width:auto}.justify-end.sc-ir-invoice{justify-content:flex-end}.bg-gray-700\\/80.sc-ir-invoice{background-color:rgba(55,65,81,.8)}.px-6.sc-ir-invoice{padding-left:1.5rem;padding-right:1.5rem}.py-2.sc-ir-invoice{padding-bottom:.5rem;padding-top:.5rem}.py-8.sc-ir-invoice{padding-bottom:2rem;padding-top:2rem}.pb-5.sc-ir-invoice{padding-bottom:1.25rem}.text-base.sc-ir-invoice{font-size:1rem;line-height:1.5rem}.text-gray-200.sc-ir-invoice{--tw-text-opacity:1;color:rgb(229 231 235/var(--tw-text-opacity))}@media (min-width:768px){.md\\:text-lg.sc-ir-invoice{font-size:1.125rem;line-height:1.75rem}}@media (min-width:1024px){.lg\\:w-60.sc-ir-invoice{width:15rem}.lg\\:gap-10.sc-ir-invoice{gap:2.5rem}.lg\\:text-2xl.sc-ir-invoice{font-size:1.5rem;line-height:2rem}}.table.sc-ir-invoice{display:table}.grid.sc-ir-invoice{display:grid}@media (min-width:1024px){.lg\\:size-7.sc-ir-invoice{height:1.75rem;width:1.75rem}}.visible.sc-ir-invoice{visibility:visible}.max-w-xs.sc-ir-invoice{max-width:20rem}.rounded-lg.sc-ir-invoice{border-radius:.5rem}.px-3.sc-ir-invoice{padding-left:.75rem;padding-right:.75rem}.resize.sc-ir-invoice{resize:both}@media (min-width:640px){.sm\\:block.sc-ir-invoice{display:block}}@media (min-width:768px){.md\\:hidden.sc-ir-invoice{display:none}}.size-\\[18px\\].sc-ir-invoice{height:18px;width:18px}.h-\\[14px\\].sc-ir-invoice{height:14px}.h-\\[3rem\\].sc-ir-invoice{height:3rem}.w-\\[12\\.25px\\].sc-ir-invoice{width:12.25px}.gap-0.sc-ir-invoice{gap:0}.gap-0\\.5.sc-ir-invoice{gap:.125rem}.border-0.sc-ir-invoice{border-width:0}.pt-14.sc-ir-invoice{padding-top:3.5rem}.shadow.sc-ir-invoice,.shadow-none.sc-ir-invoice{box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}.shadow-none.sc-ir-invoice{--tw-shadow:0 0 #0000;--tw-shadow-colored:0 0 #0000}@media (min-width:640px){.sm\\:w-auto.sc-ir-invoice{width:auto}.sm\\:w-fit.sc-ir-invoice{width:fit-content}.sm\\:border.sc-ir-invoice{border-width:1px}.sm\\:pt-4.sc-ir-invoice{padding-top:1rem}.sm\\:shadow-sm.sc-ir-invoice{--tw-shadow:0 1px 2px 0 rgba(0,0,0,.05);--tw-shadow-colored:0 1px 2px 0 var(--tw-shadow-color);box-shadow:var(--tw-ring-offset-shadow,0 0 #0000),var(--tw-ring-shadow,0 0 #0000),var(--tw-shadow)}}.w-fit.sc-ir-invoice{width:fit-content}.bg-gray-100.sc-ir-invoice{--tw-bg-opacity:1;background-color:rgb(243 244 246/var(--tw-bg-opacity))}.p-6.sc-ir-invoice{padding:1.5rem}.text-start.sc-ir-invoice{text-align:start}@media (min-width:768px){.md\\:justify-between.sc-ir-invoice{justify-content:space-between}.md\\:gap-8.sc-ir-invoice{gap:2rem}}.space-y-1.sc-ir-invoice>.sc-ir-invoice:not([hidden])~.sc-ir-invoice:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.25rem*var(--tw-space-y-reverse));margin-top:calc(.25rem*(1 - var(--tw-space-y-reverse)))}.text-slate-900.sc-ir-invoice{--tw-text-opacity:1;color:rgb(15 23 42/var(--tw-text-opacity))}@media (min-width:768px){.md\\:block.sc-ir-invoice{display:block}}.w-56.sc-ir-invoice{width:14rem}.min-w-\\[1rem\\].sc-ir-invoice{min-width:1rem}.rounded-t-md.sc-ir-invoice{border-top-left-radius:.375rem;border-top-right-radius:.375rem}.border-gray-300.sc-ir-invoice{--tw-border-opacity:1;border-color:rgb(209 213 219/var(--tw-border-opacity))}.bg-gray-300.sc-ir-invoice{--tw-bg-opacity:1;background-color:rgb(209 213 219/var(--tw-bg-opacity))}.p-2.sc-ir-invoice{padding:.5rem}@media (min-width:768px){.md\\:max-w-sm.sc-ir-invoice{max-width:24rem}}@media (min-width:1024px){.lg\\:p-6.sc-ir-invoice{padding:1.5rem}}.-bottom-0.sc-ir-invoice{bottom:0}.-bottom-1.sc-ir-invoice{bottom:-.25rem}.z-0.sc-ir-invoice{z-index:0}.mb-1.sc-ir-invoice{margin-bottom:.25rem}.size-10.sc-ir-invoice{height:2.5rem;width:2.5rem}.size-3.sc-ir-invoice{height:.75rem;width:.75rem}.h-48.sc-ir-invoice{height:12rem}.max-h-\\[80vh\\].sc-ir-invoice{max-height:80vh}.cursor-pointer.sc-ir-invoice{cursor:pointer}.items-end.sc-ir-invoice{align-items:flex-end}.overflow-hidden.sc-ir-invoice{overflow:hidden}.rounded-\\[var\\(--radius\\2c 8px\\)\\].sc-ir-invoice{border-radius:var(--radius,8px)}.bg-white\\/80.sc-ir-invoice{background-color:hsla(0,0%,100%,.8)}.px-2.sc-ir-invoice{padding-left:.5rem;padding-right:.5rem}.py-4.sc-ir-invoice{padding-bottom:1rem;padding-top:1rem}.pb-2.sc-ir-invoice{padding-bottom:.5rem}.pb-4.sc-ir-invoice{padding-bottom:1rem}.pt-0.sc-ir-invoice{padding-top:0}.font-normal.sc-ir-invoice{font-weight:400}.ordinal.sc-ir-invoice{--tw-ordinal:ordinal;font-variant-numeric:var(--tw-ordinal) var(--tw-slashed-zero) var(--tw-numeric-figure) var(--tw-numeric-spacing) var(--tw-numeric-fraction)}.text-gray-700.sc-ir-invoice{--tw-text-opacity:1;color:rgb(55 65 81/var(--tw-text-opacity))}.text-white.sc-ir-invoice{--tw-text-opacity:1;color:rgb(255 255 255/var(--tw-text-opacity))}.hover\\:bg-gray-400.sc-ir-invoice:hover{--tw-bg-opacity:1;background-color:rgb(156 163 175/var(--tw-bg-opacity))}@media (min-width:768px){.md\\:max-h-\\[200px\\].sc-ir-invoice{max-height:200px}.md\\:w-auto.sc-ir-invoice{width:auto}.md\\:p-4.sc-ir-invoice{padding:1rem}.md\\:pt-0.sc-ir-invoice{padding-top:0}.md\\:pt-4.sc-ir-invoice{padding-top:1rem}.md\\:text-xl.sc-ir-invoice{font-size:1.25rem;line-height:1.75rem}}@media (min-width:1280px){.xl\\:max-h-\\[250px\\].sc-ir-invoice{max-height:250px}}.ml-1.sc-ir-invoice{margin-left:.25rem}.line-clamp-3.sc-ir-invoice{-webkit-box-orient:vertical;-webkit-line-clamp:3;display:-webkit-box;overflow:hidden}.inline-flex.sc-ir-invoice{display:inline-flex}.size-4.sc-ir-invoice{height:1rem;width:1rem}.h-6.sc-ir-invoice{height:1.5rem}.max-w-\\[60\\%\\].sc-ir-invoice{max-width:60%}.flex-row.sc-ir-invoice{flex-direction:row}.gap-3.sc-ir-invoice{gap:.75rem}.space-y-14.sc-ir-invoice>.sc-ir-invoice:not([hidden])~.sc-ir-invoice:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(3.5rem*var(--tw-space-y-reverse));margin-top:calc(3.5rem*(1 - var(--tw-space-y-reverse)))}.pl-0.sc-ir-invoice{padding-left:0}.pt-0\\.5.sc-ir-invoice{padding-top:.125rem}.text-right.sc-ir-invoice{text-align:right}.text-end.sc-ir-invoice{text-align:end}.text-gray-500.sc-ir-invoice{--tw-text-opacity:1;color:rgb(107 114 128/var(--tw-text-opacity))}@media (min-width:768px){.md\\:w-full.sc-ir-invoice{width:100%}.md\\:max-w-full.sc-ir-invoice{max-width:100%}}@media (min-width:1024px){.lg\\:flex-row.sc-ir-invoice{flex-direction:row}}@media (min-width:1280px){.xl\\:text-xl.sc-ir-invoice{font-size:1.25rem;line-height:1.75rem}}.w-72.sc-ir-invoice{width:18rem}.ml-4.sc-ir-invoice{margin-left:1rem}.grid-cols-2.sc-ir-invoice{grid-template-columns:repeat(2,minmax(0,1fr))}.pb-6.sc-ir-invoice{padding-bottom:1.5rem}.text-gray-800.sc-ir-invoice{--tw-text-opacity:1;color:rgb(31 41 55/var(--tw-text-opacity))}@media (min-width:640px){.sm\\:flex-row.sc-ir-invoice{flex-direction:row}.sm\\:items-center.sc-ir-invoice{align-items:center}.sm\\:text-sm.sc-ir-invoice{font-size:.875rem;line-height:1.25rem}}@media (min-width:1024px){.lg\\:grid-cols-3.sc-ir-invoice{grid-template-columns:repeat(3,minmax(0,1fr))}}.h-10.sc-ir-invoice{height:2.5rem}.h-14.sc-ir-invoice{height:3.5rem}.h-24.sc-ir-invoice{height:6rem}.h-28.sc-ir-invoice{height:7rem}@keyframes pulse{50%{opacity:.5}}.animate-pulse.sc-ir-invoice{animation:pulse 2s cubic-bezier(.4,0,.6,1) infinite}.gap-12.sc-ir-invoice{gap:3rem}.gap-8.sc-ir-invoice{gap:2rem}.bg-gray-200.sc-ir-invoice{--tw-bg-opacity:1;background-color:rgb(229 231 235/var(--tw-bg-opacity))}@media (min-width:1024px){.lg\\:max-w-sm.sc-ir-invoice{max-width:24rem}}.text-\\[hsl\\(var\\(--brand-600\\)\\)\\].sc-ir-invoice{color:hsl(var(--brand-600))}.text-slate-500.sc-ir-invoice{--tw-text-opacity:1;color:rgb(100 116 139/var(--tw-text-opacity))}@media (min-width:640px){.sm\\:p-4.sc-ir-invoice{padding:1rem}}.space-y-1\\.5.sc-ir-invoice>.sc-ir-invoice:not([hidden])~.sc-ir-invoice:not([hidden]){--tw-space-y-reverse:0;margin-bottom:calc(.375rem*var(--tw-space-y-reverse));margin-top:calc(.375rem*(1 - var(--tw-space-y-reverse)))}.border-solid.sc-ir-invoice{border-style:solid}";
...
const IrInvoice = /*@__PURE__*/ proxyCustomElement(class IrInvoice extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, null, h("ir-interceptor", null), h("main", { class: "relative flex w-full flex-col space-y-5" }, h("section", { class: "sticky top-0 z-50 m-0  w-full  p-0" }, h("ir-nav", { class: 'm-0 p-0', website: (_a = app_store.property) === null || _a === void 0 ? void 0 : _a.space_theme.website, logo: (_c = (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.space_theme) === null || _c === void 0 ? void 0 : _c.logo })), h("section", { class: "flex-1 px-4 lg:px-6" }, h("div", { class: "mx-auto flex max-w-6xl gap-16" }, h("div", { class: "invoice-container" }, h("section", { class: "flex items-center gap-4" }, this.status === 1 ? (h("a", { href: google_maps_url, target: "_blank", class: cn(`button-outline`, 'flex items-center justify-center'), "data-size": "sm" }, localizedWords.entries.Lcz_GetDirections)) : (h("ir-button", { variants: "outline", label: "Retry Payment" })), h("a", { href: this.getPropertyEmail(), target: "_blank", class: cn(`button-outline`, 'flex items-center justify-center'), "data-size": "sm" }, "Message property"), h("ir-button", { variants: "outline", label: localizedWords.entries.Lcz_CancelBooking, onButtonClick: () => {
                this.paymentService.RequestBookingCancelation(this.bookingNbr);
...
function defineCustomElement() {
    ...
    const components = ["ir-invoice", "ir-auth", "ir-badge-group", "ir-booking-code", "ir-button", "ir-dialog", "ir-footer", "ir-google-maps", "ir-icons", "ir-input", "ir-interceptor", "ir-language-picker", "ir-modal", "ir-nav", "ir-privacy-policy", "ir-select", "ir-sheet", "ir-signin", "ir-signup"];
