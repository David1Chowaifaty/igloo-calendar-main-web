...
import { h as getUserPreference, u as getDateDifference, l as localizedWords, r as formatAmount, w as runScriptAndRemove, d as dateFns, c as cn } from './utils.js';
...
import { d as defineCustomElement$n } from './ir-booking-cancellation2.js';
...
const IrInvoice = /*@__PURE__*/ proxyCustomElement(class IrInvoice extends HTMLElement {
    ...
    static get style() { return IrInvoiceStyle0; }
        ...
        "isConfermation": [4, "is-confermation"],
        "status": [2],
        "perma_link": [1],
        "aName": [1, "a-name"],
...
function defineCustomElement() {
    ...
    const components = ["ir-invoice", "ir-alert-dialog", "ir-auth", "ir-badge-group", "ir-booking-cancellation", "ir-booking-code", "ir-button", "ir-checkbox", "ir-dialog", "ir-footer", "ir-google-maps", "ir-icons", "ir-input", "ir-interceptor", "ir-language-picker", "ir-menu", "ir-modal", "ir-nav", "ir-phone-input", "ir-privacy-policy", "ir-select", "ir-sheet", "ir-signin", "ir-signup", "ir-skeleton", "ir-user-avatar", "ir-user-profile"];
