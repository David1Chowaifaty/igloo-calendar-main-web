...
import { d as defineCustomElement$l } from './ir-alert-dialog2.js';
import { d as defineCustomElement$k } from './ir-auth2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-invoice", "ir-alert-dialog", "ir-auth", "ir-badge-group", "ir-booking-code", "ir-button", "ir-dialog", "ir-footer", "ir-google-maps", "ir-icons", "ir-input", "ir-interceptor", "ir-language-picker", "ir-menu", "ir-modal", "ir-nav", "ir-privacy-policy", "ir-select", "ir-sheet", "ir-signin", "ir-signup", "ir-user-avatar"];
