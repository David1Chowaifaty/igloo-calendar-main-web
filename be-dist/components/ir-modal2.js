...
import { d as defineCustomElement$8 } from './ir-auth2.js';
...
const IrModal = /*@__PURE__*/ proxyCustomElement(class IrModal extends HTMLElement {
    constructor() {
        ...
        this.authStatus = createEvent(this, "authStatus", 7);
        this.isOpen = false;
    }
    componentWillLoad() {
        this.createPortal();
    ...
    static get style() { return IrModalStyle0; }
        ...
        "openModal": [64],
        "closeModal": [64]
    }, [[0, "authFinish", "handleAuthFinish"], [4, "keydown", "handleKeyDown"]]]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["ir-modal", "ir-auth", "ir-badge-group", "ir-button", "ir-dialog", "ir-icons", "ir-input", "ir-signin", "ir-signup"];
