...
function defineCustomElement() {
    ...
    const components = ["ir-modal", "ir-auth", "ir-badge-group", "ir-button", "ir-icons", "ir-input", "ir-signin", "ir-signup", "ir-social-button"];
