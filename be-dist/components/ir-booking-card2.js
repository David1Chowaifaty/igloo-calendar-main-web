...
import './index5.js';
import { d as defineCustomElement$3 } from './ir-badge2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-card", "ir-badge", "ir-button", "ir-icons"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-booking-card":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrBookingCard);
            }
            break;
        case "ir-badge":
            if (!customElements.get(tagName)) {
...
export { BookingListingAppService as B, IrBookingCard as I, defineCustomElement as d };

//# sourceMappingURL=ir-booking-card2.js.map