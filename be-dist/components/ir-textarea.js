...
const IrTextarea$1 = /*@__PURE__*/ proxyCustomElement(class IrTextarea extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrTextarea$1);
            }
            break;
    } });
}

const IrTextarea = IrTextarea$1;
