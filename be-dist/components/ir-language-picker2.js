...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '05e296f1ec934e0458a396bc06dc13160c63ee29', class: "picker-container" }, h("p", { key: '74b73865eecfa7919f078d73088d41b4b6f24244', class: "picker-title" }, "Display settings"), h("div", { key: '7b6925def0d147934a7010fb7c98a66f612cfb31', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: '836b375e189c86b6eb02b772b24596d54ae42ded', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
                value: `${currency.code} ${currency.symbol}`,
            })) }), h("div", { key: '073b1282c488e5cfe5fe8d0d9c660604dead1e2b', class: "actions-container" }, h("ir-button", { key: '0938d7efc86404b74d5c0711615aec5ee7f9718c', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '0c1190d6aa1d5e0b6c70951a1bf75f098265a579', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
