...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '55aa709ccfd7cf6feeca8de5d58f0a5822086faf', class: "picker-container" }, h("p", { key: '058e4cf163a59a8db7b863733d65f46d4e558df5', class: "picker-title" }, "Display settings"), h("div", { key: '06b2bd826a25c9b8513b84319d5b3b459478b493', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: '49388c4f4a430c671a966181c8f551b874d5339c', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: 'e203b53080ce57e4eb6801ac6601603b2e60c237', class: "actions-container" }, h("ir-button", { key: 'e5fc8737c21f118bbf63611b81e58e309f0b9620', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '5190bc283e16bb4f3aa8fef2bd293a3262aebf25', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
