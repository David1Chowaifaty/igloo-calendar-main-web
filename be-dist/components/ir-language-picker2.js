...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '5eadb8ffaecf23af4b98cd71df03c408f3233193', class: "picker-container" }, h("p", { key: '70e6108245b6e926444e036dd9ce9116de62f15d', class: "picker-title" }, "Display settings"), h("div", { key: '0330dd397868051843934826d3820ae89327dcf3', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: '8442babfd1760caa4d381caee836e14e2e8d149d', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: '53e942d9f4b0499de231ef15e5b8b9206612e1ab', class: "actions-container" }, h("ir-button", { key: '2f1f0c3d74e386fff457a2e883783939d9ae617b', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: 'fc3e82d58e761fff904a318f0f55a23f5fe2abb8', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
