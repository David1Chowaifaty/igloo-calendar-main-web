...
import { h as modifyQueryParam, o as matchLocale, c as cn } from './utils.js';
...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: 'f5dd3ef3edea9426878ff8d25b1589eb83da2a42', class: "picker-container" }, h("p", { key: '77dee3b0410dc134fafdfd1cf0cb8aa9d173af1c', class: "picker-title" }, localizedWords.entries.Lcz_DisplaSettings), h("div", { key: 'f2a083185f3396098adaabc56f7dbd9729ae7702', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: '77d077e0cd01da660b7faa82089f595fa6bdf8c9', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: localizedWords.entries.Lcz_Currency, select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: 'dad55da01085214bf755efb0acdf0b278d77086f', class: "actions-container" }, h("ir-button", { key: '31a07d8a84d240172417b06041e77081d2029642', size: "md", label: localizedWords.entries['Lcz_Confirm'], class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '68f4aa09f5304a945778e762c5edbc9f26e4bf48', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: localizedWords.entries.Lcz_Cancel, variants: "outline", class: "cancel-button" }))));
    }
