...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        ...
        })), h("ir-select", { key: '37419aeeb0b24e45c97305da973a79c670513bcb', variant: "double-line", value: app_store.userPreferences.currency_id, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
                value: `${currency.code} ${currency.symbol}`,
            })) }), h("div", { key: 'b80d3a6292ab3ad8abe28c5ed7b712e2036e39ba', class: "mt-8 flex w-full flex-col  gap-4 md:flex-row-reverse" }, h("ir-button", { key: 'c890906ceea299d2c686fecac056f2f1f5a15abb', size: "md", label: "Confirm", class: "w-full md:w-fit", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '969a58fb15e36908624352202fc2a18347532888', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "w-full md:w-fit" }))));
    }
