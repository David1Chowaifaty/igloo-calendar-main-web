...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: 'c04ccecaadf8f61fc744eddda13d64dfaeae81c1', class: "picker-container" }, h("p", { key: 'a3dca032f9da19a7038827d5700d51d0ac220370', class: "picker-title" }, "Display settings"), h("div", { key: '996b05e96e35944279e99549bb4e4e5d40edeb56', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: 'f8a7ac7cb63b43709b1048992ae470bfc99c9476', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: 'ef499580c3f01598a409f9a1cbb2aa6206270abd', class: "actions-container" }, h("ir-button", { key: 'd8830b253f9edc8a49f23cb9f8884c6944c9e0cb', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: 'df38a8d0907e49ac158e151e183809f59f80876b', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
