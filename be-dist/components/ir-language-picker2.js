...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '43f289a6c79c7d13dc22f3561aef657badc76fdb', class: "picker-container" }, h("p", { key: '5f319629aad39b0cf3fa7479ccc6fc320fca08c5', class: "picker-title" }, "Display settings"), h("div", { key: '8cf6b0e1975f6327c7c675ce8e12bb64d3e69e6c', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: 'b9b6cf454e1fc224f6c45967dbdbd21a3ee7127d', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: '331b4aa0e7cb2318da158c33aec1de61fa775cd8', class: "actions-container" }, h("ir-button", { key: '4de7cae646cb70d94f88d89c1dc972851834455a', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: 'e99e3aa21d4c611f877b9ee85a317521d6237445', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
