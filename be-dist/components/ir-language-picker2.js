...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: 'ee9c4a6695011e86b1aaef690eb90b720f7ba5a7', class: "picker-container" }, h("p", { key: 'd6484d2cdf160e08a83d7ebe549ee33707f0bdc2', class: "picker-title" }, "Display settings"), h("div", { key: 'a4d87a6e9c74699a13634dce4edc9fc7bb939b81', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: '74323fffaba8761fed393948d49c4b272d2b4479', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: 'f6d3740029056fa0e74913754baf54ff9e285551', class: "actions-container" }, h("ir-button", { key: '1fdc60334502a904f9053985047ce4d3cb1b0f62', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: 'cb3a0a8cd525c8923b02a5f902510a7f21f27735', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
