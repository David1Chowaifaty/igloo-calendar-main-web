...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '24ee16407140db73fa065208368fbfa473bfe44a', class: "picker-container" }, h("p", { key: '260910febed88c9d98b8856ed300315626a71bc0', class: "picker-title" }, "Display settings"), h("div", { key: 'c3640d8f01fee8e95c0e37f127b5043d2462b940', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: 'cad4f6d34502c6af1ba72b6f7fe372652ada6b11', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: 'a025a28aa3eacfb09fa13fd75a00d10d9e9a9b59', class: "actions-container" }, h("ir-button", { key: '2acb5062625388a8c16dc76400ebc4ecbf2173e8', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '358d245724211da938c3a6d4ae805562a5c6bcd0', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
