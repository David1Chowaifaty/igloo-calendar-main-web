...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '917379eb85bdd6a464adc8a43cee3882d33553dc', class: "picker-container" }, h("p", { key: '8ba2b688100f4cb7136ecac68787f32c69b916ce', class: "picker-title" }, localizedWords.entries.Lcz_DisplaSettings), h("div", { key: 'af9d36cdec01e2d7ee28682bd202682abaaa0e2f', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: '374799e983f09e40122ecdd645b7f006ebf28a32', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: localizedWords.entries.Lcz_Currency, select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: '6737f58d9c64126d121416439dcabe36c4df022c', class: "actions-container" }, h("ir-button", { key: 'f22ec5513b32069e1d71909d8461e5c4b5a2020b', size: "md", label: localizedWords.entries['Lcz_Confirm'], class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '609507d271b72c4e31f9088bb76757594e331cc6', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: localizedWords.entries.Lcz_Cancel, variants: "outline", class: "cancel-button" }))));
    }
