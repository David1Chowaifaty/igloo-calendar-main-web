...
import { e as modifyQueryParam, k as matchLocale, l as localizedWords, c as cn } from './utils.js';
...
const IrLanguagePicker = /*@__PURE__*/ proxyCustomElement(class IrLanguagePicker extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: '41f454fa9008bf8060dabd1fae18cd622b9bfa51', class: "picker-container" }, h("p", { key: '03b9523b5dacaf91bfa0b93baab1c6bdfe6ca213', class: "picker-title" }, localizedWords.entries.Lcz_DisplaSettings), h("div", { key: 'c5982a1a9b6650ed272aa56afc75b7660521d51c', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: '5d109f523dac09a4f8d0549ce94dd42254e452db', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: localizedWords.entries.Lcz_Currency, select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: 'df49bc3c96cc60b1a1e2f1862ecc7ed8fe394c9e', class: "actions-container" }, h("ir-button", { key: 'b12cfd514037000a81bbd2d2eed5b1c266c2f6c0', size: "md", label: localizedWords.entries['Lcz_Confirm'], class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '96b18d97288b605cd84421f3cbbf6ca902f30ce3', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: localizedWords.entries.Lcz_Cancel, variants: "outline", class: "cancel-button" }))));
    }
