...
const IrPhoneInput = /*@__PURE__*/ proxyCustomElement(class IrPhoneInput extends HTMLElement {
    ...
    render() {
        var _a, _b, _c;
        return (h("div", { key: '8728cba531933934628b0347f70a2b84338aebf1', ref: el => (this.triggerElement = el), class: "phone-input-container" }, h("div", { key: 'e30fdac580d73a265cc61c050f0f5af13857c0a1', class: `input-trigger ${this.error ? 'error' : ''}` }, h("div", { key: 'bb3313207a77f07fd4addc3c3eb7724f76db943d', class: "input-section" }, h("label", { key: '74ce5f66858b30e89cac22f48efb5a213dde4077', htmlFor: "country_picker" }, localizedWords.entries.Lcz_Country), h("div", { key: 'a893bf04fec54b22411efb83d5e736567b35e824', id: "country_picker", onClick: () => {
                this.toggleVisibility();
            }, class: "input-subtrigger" }, this.selectedItem ? (h(Fragment, null, h("img", { src: (_a = this.selectedItem) === null || _a === void 0 ? void 0 : _a.flag, alt: (_b = this.selectedItem) === null || _b === void 0 ? void 0 : _b.name, class: "flag-icon" }), h("span", null, (_c = this.selectedItem) === null || _c === void 0 ? void 0 : _c.phone_prefix))) : (h("span", null, "Select")), h("svg", { key: 'bbba3d99407368d9b7a36a01881bc16ed2ca7ba1', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '3226467fe875d336df06b4fee8be6d9103bd4a9f', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" })))), h("div", { key: '79cd152849fb681067b4857a576c87b42e298b91', class: "input-section" }, h("label", { key: '6c5b4e512d5cd9c0145e9ae283465db97a1b718f', htmlFor: "phone_number" }, "Mobile number"), h("input", { key: '3b7013a25c2f6a251c0f941251aad75ff76ba201', type: "phone", ref: el => (this.phoneInput = el), onBlur: e => this.phoneInputBlur.emit(e), onFocus: e => this.phoneInputFocus.emit(e), onInput: e => this.handleInputChange(e), id: "phone_number", value: this.inputValue, class: "input-subtrigger" }))), h("div", { key: '156ffeeda8d6769d38b08b142c9d8e917f0d221a', ref: el => (this.contentElement = el), class: "dropdown-container" }, this.isVisible && (h("ul", { class: "dropdown-content" }, h("li", { class: "filter-container" }, h("ir-icons", { name: "search", svgClassName: "filter-icon" }), h("input", { placeholder: "Search...", ref: el => (this.searchInput = el), type: "text", onInput: this.handleFilterInputChange.bind(this), class: "filter-input", onKeyDown: this.handleAutoCompleteKeyDown.bind(this) })), this.filteredCountries.map((value, index) => (h("li", { "data-state": this.currentHighlightedIndex === index ? 'checked' : 'unchecked', "data-highlighted": this.currentHighlightedIndex === index ? 'true' : 'false', class: "combobox-item", key: index, role: "option", onClick: () => {
