...
const IrPhoneInput = /*@__PURE__*/ proxyCustomElement(class IrPhoneInput extends HTMLElement {
    ...
    render() {
        var _a, _b, _c;
        return (h("div", { key: '0a0437f76d582fc8f6c24e787f9a669d094da0c2', ref: el => (this.triggerElement = el), class: "phone-input-container" }, h("div", { key: '1e436fb9603a8891d30b489f53c06fb27b1741f8', class: `input-trigger ${this.error ? 'error' : ''}` }, h("div", { key: 'b0d6c634e34d520a3ccd755e1587a0caf50c8d4c', class: "input-section" }, h("label", { key: '71b2cc84a0d28e601dbd58d1e1ec56aa56ad052a', htmlFor: "country_picker" }, localizedWords.entries.Lcz_Country), h("div", { key: '2493a5d6a0adf89294cff31589525f5bea1dee0b', id: "country_picker", onClick: () => {
                this.toggleVisibility();
            }, class: "input-subtrigger" }, this.selectedItem ? (h(Fragment, null, h("img", { src: (_a = this.selectedItem) === null || _a === void 0 ? void 0 : _a.flag, alt: (_b = this.selectedItem) === null || _b === void 0 ? void 0 : _b.name, class: "flag-icon" }), h("span", null, (_c = this.selectedItem) === null || _c === void 0 ? void 0 : _c.phone_prefix))) : (h("span", null, "Select")), h("svg", { key: 'fda4f2e134032bbda1f58cde9870158c5cd7dd5b', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'efeccd7e11f94f3330751b0cc748a907f47aacd8', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" })))), h("div", { key: 'd052ab381f7179065391703b7faa0fa66ff99c0b', class: "input-section" }, h("label", { key: '9dadb7242de63cf919ac07b58dec774a25b42bbc', htmlFor: "phone_number" }, localizedWords.entries.Lcz_MobileNumber), h("input", { key: '7c492e01e8f451c542e9744e53257185f6314921', type: "phone", ref: el => (this.phoneInput = el), onBlur: e => this.phoneInputBlur.emit(e), onFocus: e => this.phoneInputFocus.emit(e), onInput: e => this.handleInputChange(e), id: "phone_number", value: this.inputValue, class: "input-subtrigger" }))), h("div", { key: '603f3db1a427cc34f0825cf8cdebdee6cbbf3303', ref: el => (this.contentElement = el), class: "dropdown-container" }, this.isVisible && (h("ul", { key: 'f524555196ea5f5576278858425a3dddd8feb653', class: "dropdown-content" }, h("li", { key: '0bfdfc7ad94ea657b9e5a73586e51f16115efee1', class: "filter-container" }, h("ir-icons", { key: 'b98b45bb9fcbfa94f43d6710b3b74c96e3d5fb35', name: "search", svgClassName: "filter-icon" }), h("input", { key: 'c4dcf5dabb0b839df03b133a0b85d69f1d9cfe5a', placeholder: localizedWords.entries.Lcz_Search, ref: el => (this.searchInput = el), type: "text", onInput: this.handleFilterInputChange.bind(this), class: "filter-input", onKeyDown: this.handleAutoCompleteKeyDown.bind(this) })), this.filteredCountries.map((value, index) => (h("li", { "data-state": this.currentHighlightedIndex === index ? 'checked' : 'unchecked', "data-highlighted": this.currentHighlightedIndex === index ? 'true' : 'false', class: "combobox-item", key: index, role: "option", onClick: () => {
