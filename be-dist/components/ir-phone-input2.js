...
const IrPhoneInput = /*@__PURE__*/ proxyCustomElement(class IrPhoneInput extends HTMLElement {
    ...
    render() {
        var _a, _b, _c;
        return (h("div", { key: '5095b62d9acd5ad71c8919d7908c78faf9299130', ref: el => (this.triggerElement = el), class: "phone-input-container" }, h("div", { key: 'fcfedacaff63d1202976ff2bda2fc225abd7ba81', class: `input-trigger ${this.error ? 'error' : ''}` }, h("div", { key: 'b41af9978298eec210362abcb5c6137e30531de1', class: "input-section" }, h("label", { key: '2c6fb98fa1ad45c96de7551cd0ed9c1539e32f76', htmlFor: "country_picker" }, localizedWords.entries.Lcz_Country), h("div", { key: 'b392f913d3e24ceab76652fe535ac55a751aa077', id: "country_picker", onClick: () => {
                this.toggleVisibility();
            }, class: "input-subtrigger" }, this.selectedItem ? (h(Fragment, null, h("img", { loading: "lazy", src: (_a = this.selectedItem) === null || _a === void 0 ? void 0 : _a.flag, alt: (_b = this.selectedItem) === null || _b === void 0 ? void 0 : _b.name, class: "flag-icon" }), h("span", null, (_c = this.selectedItem) === null || _c === void 0 ? void 0 : _c.phone_prefix))) : (h("span", null, "Select")), h("svg", { key: 'e1bd87b1d20152aa0a0955ef9d75645b7f995c74', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'e4a6873e787777cf7a58f446fe4803613f82e534', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" })))), h("div", { key: 'e005be08de12db4cc86dc7340873c125eb325c01', class: "input-section" }, h("label", { key: 'f55a998e2da770331220da1a2dfbe85d8e3d8968', htmlFor: "phone_number" }, localizedWords.entries.Lcz_MobileNumber), h("input", { key: '4ca76efd3d11c8f514461a33e0d64aa1885c4f34', type: "phone", ref: el => (this.phoneInput = el), onBlur: e => this.phoneInputBlur.emit(e), onFocus: e => this.phoneInputFocus.emit(e), onInput: e => this.handleInputChange(e), id: "phone_number", value: this.inputValue, class: "input-subtrigger" }))), h("div", { key: 'ae665d0b87a0cceac6c167456b73ffa4c98ad6b1', ref: el => (this.contentElement = el), class: "dropdown-container" }, this.isVisible && (h("ul", { key: 'a097efb18cc693ef53fcfc6da341c2ee66445131', class: "dropdown-content" }, h("li", { key: '75b2ee4c90aad2ce1b3b4c685ca59d96bea31b00', class: "filter-container" }, h("ir-icons", { key: 'f964e855c1d4555bda03df3b851d14b389493d2e', name: "search", svgClassName: "filter-icon" }), h("input", { key: '6fc11cb2ffcd78d1ba56c9c195bcef598a20a030', placeholder: localizedWords.entries.Lcz_Search, ref: el => (this.searchInput = el), type: "text", onInput: this.handleFilterInputChange.bind(this), class: "filter-input", onKeyDown: this.handleAutoCompleteKeyDown.bind(this) })), this.filteredCountries.map((value, index) => (h("li", { "data-state": this.currentHighlightedIndex === index ? 'checked' : 'unchecked', "data-highlighted": this.currentHighlightedIndex === index ? 'true' : 'false', class: "combobox-item", key: index, role: "option", onClick: () => {
