...
import { b as booking_store, d as dateFns, g as getDateDifference, r as formatAmount } from './utils.js';
...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '0214a12b572f7c357d78381108c6cfffe649c842' }, h("div", { key: 'e1a7d43879697b4be9482ca681fc3446d1067cf2', class: "w-full" }, h("section", { key: '5c2bdef33c35e818156435e39e7718a45daa655d', class: "mb-5 flex flex-col flex-wrap items-center gap-2 rounded-md bg-gray-100 px-4 py-2 lg:flex-row" }, h("div", { key: '7ede19ce89bee5ae1153baa658be6b0db93020c0', class: "flex flex-1 items-center gap-2" }, h("ir-icons", { key: '27996fc1140e49ac200a35d705589e7659ed084c', name: "bed" }), h("p", { key: 'b7890be180a548b3b7b013d110a554eafd38d014' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night, " - ", booking_store.bookingAvailabilityParams.adult_nbr, ' ', booking_store.bookingAvailabilityParams.adult_nbr > 1 ? localizedWords.entries.Lcz_Persons : localizedWords.entries.Lcz_Person, " - ", total_rooms, ' ', total_rooms > 1 ? localizedWords.entries.Lcz_Rooms : localizedWords.entries.Lcz_Room)), h("p", { key: 'b4a9fef6e5a0d4828c7ed08d2ea15fd1f9952bb7', class: " text-right text-xs text-gray-500" }, (_c = booking_store.tax_statement) === null || _c === void 0 ? void 0 : _c.message)), h("section", { key: 'e9177c1814a04ecad6df9b6b098695d68a15614d', class: 'space-y-14' }, Object.keys(booking_store.ratePlanSelections).map(roomTypeId => {
            return Object.keys(booking_store.ratePlanSelections[roomTypeId]).map(ratePlanId => {
                const r = booking_store.ratePlanSelections[roomTypeId][ratePlanId];
                if (r.reserved === 0) {
                    return null;
        ...
        }))), h("ir-dialog", { key: '5ca9aa3c7b7adcf708273fc2d315d4cbe3b0dbe9', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: '977646b176414847584962945cd69397ac9ad3d5', slot: "modal-body", class: "p-6 " }, h("p", { key: '24aa7dc0edd1c5a20a413773d1d14550759bbb0e', class: 'px-6', innerHTML: this.cancelationMessage || ((_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation) }), h("p", { key: 'f1a35a3d6592b27066dd36afa7b6a9c102cd8f82', class: 'px-6', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
