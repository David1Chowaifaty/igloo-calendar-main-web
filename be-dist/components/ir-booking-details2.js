...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '247001cb410d5c1a5f591da0a3f14be2c7f31aea' }, h("div", { key: '228114e2915c6b048afe9f4e3fb52faac6182375', class: "w-full" }, h("section", { key: '2b030181da3d192d50c29f306c6305dd5b1e1876', class: "mb-5 flex flex-col flex-wrap items-center gap-2 rounded-md bg-gray-100 px-4 py-2 lg:flex-row" }, h("div", { key: '4f954d6d095fba2a62ace94464afbcca9f35631e', class: "flex flex-1 items-center gap-2" }, h("ir-icons", { key: 'a553b353e5fdb99290df9fd00ac3f2f2d9715faf', name: "bed" }), h("p", { key: 'a85b10d63f365dab202530983fe4746a2dc404eb' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night, " - ", booking_store.bookingAvailabilityParams.adult_nbr, ' ', booking_store.bookingAvailabilityParams.adult_nbr > 1 ? localizedWords.entries.Lcz_Persons : localizedWords.entries.Lcz_Person, " - ", total_rooms, ' ', total_rooms > 1 ? localizedWords.entries.Lcz_Rooms : localizedWords.entries.Lcz_Room)), h("p", { key: '00584d94f003fe164054529a6c0cbb56bbefb643', class: " text-right text-xs text-gray-500" }, (_c = booking_store.tax_statement) === null || _c === void 0 ? void 0 : _c.message)), h("section", { key: 'bc584764fb176467f134694fe976ad2e9aa3579d', class: 'space-y-14' }, Object.keys(booking_store.ratePlanSelections).map(roomTypeId => {
            return Object.keys(booking_store.ratePlanSelections[roomTypeId]).map(ratePlanId => {
                const r = booking_store.ratePlanSelections[roomTypeId][ratePlanId];
                if (r.reserved === 0) {
                    return null;
        ...
        }))), h("ir-dialog", { key: '9e0053558d0a8e9d93e71a81f9cbc920d0d8a20d', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: '8f58901a194a58a3250116a2a2a89ce7a289d125', slot: "modal-body", class: "p-6 " }, h("p", { key: '871b4ee0d95c43cbb3c19151da0392a166a968f9', class: 'px-6', innerHTML: this.cancelationMessage || ((_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation) }), h("p", { key: '4d32759a97f31f4c47a1a05a033d7ffb33055290', class: 'px-6', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
