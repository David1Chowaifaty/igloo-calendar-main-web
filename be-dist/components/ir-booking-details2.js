...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        }))), h("ir-dialog", { key: 'fe244fc12a4bb4cc68fe8825a5563ae781d5d4d8', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: 'a9e260bfc899d149b47d2335c31aee81cb8e2be1', slot: "modal-body", class: "p-6 " }, h("p", { key: '774b7c7f3d3f7ecebe611a2ee55d182beedbf697', class: 'px-6', innerHTML: this.cancelationMessage || ((_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation) }), h("p", { key: 'b7a4ffea6528bfa78a5e30deb43c6cd1ac44652e', class: 'px-6', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
