...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '804e59255b0430e1b32b6977ba19c7afa9b15fb8' }, h("div", { key: '2936db53f350015fee43617b2bc92a204fde49d8', class: "w-full" }, h("section", { key: '5abf581c0ccf6c6a34fea5ee809ec874a891f0da', class: "mb-5 flex flex-col flex-wrap items-center gap-2 rounded-md bg-gray-100 px-4 py-2 lg:flex-row" }, h("div", { key: '6cec6e3f88a2a2f3095cf73e0bd7a5276e111e4e', class: "flex flex-1 items-center gap-2" }, h("ir-icons", { key: 'a7557ab52b69fe37a741d78aa09b972987e7599a', name: "bed" }), h("p", { key: '63e922f71609d38baa9c3e53f886a4ef9e48975a' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night, " - ", booking_store.bookingAvailabilityParams.adult_nbr, ' ', booking_store.bookingAvailabilityParams.adult_nbr > 1 ? localizedWords.entries.Lcz_Persons : localizedWords.entries.Lcz_Person, " - ", total_rooms, ' ', total_rooms > 1 ? localizedWords.entries.Lcz_Rooms : localizedWords.entries.Lcz_Room)), h("p", { key: '49904b1477a57b0f353df4d9574d6b3c2fc81925', class: " text-right text-xs text-gray-500" }, (_c = booking_store.tax_statement) === null || _c === void 0 ? void 0 : _c.message)), h("section", { key: 'd3f738858337764a9662727d2676b6a558a339a4', class: 'space-y-14' }, Object.keys(booking_store.ratePlanSelections).map(roomTypeId => {
            return Object.keys(booking_store.ratePlanSelections[roomTypeId]).map(ratePlanId => {
                const r = booking_store.ratePlanSelections[roomTypeId][ratePlanId];
                if (r.reserved === 0) {
                    return null;
        ...
        }))), h("ir-dialog", { key: '76c5851a76ee024bd712861939d24e60f0ae8393', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: '2659dc7e86481f6b8d98989b560a1672cce210e3', slot: "modal-body", class: "p-4 md:p-6" }, h("p", { key: '4a08d4689b3ade667dc1f3e028b37f3b88aa66f0', innerHTML: (_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation }), h("p", { key: '0ecda6ecec712386f49ca4bc041804f2dd238675', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
