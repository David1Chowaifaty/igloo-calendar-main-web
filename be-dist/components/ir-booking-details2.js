...
import { b as booking_store, d as dateFns, g as getDateDifference, w as formatAmount } from './utils.js';
...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'ddebd218c58e9101cf90d8fe909167720b3df13b' }, h("div", { key: '3d774335827dc36a8656cf7cef543b7832647f7e', class: "w-full" }, h("section", { key: 'a23546a5390eed595d2e0de8b356869899d8a879', class: "mb-5 flex flex-col flex-wrap items-center gap-2 rounded-md bg-gray-100 px-4 py-2 lg:flex-row" }, h("div", { key: '7ffd96b5487bf568c8f2bc5e19572805093b2def', class: "flex flex-1 items-center gap-2" }, h("ir-icons", { key: '6753ba9988c06e14cd113c2c6250b15234ae2f74', name: "bed" }), h("p", { key: '8e2e3009bf7bff499f5f55410513e2760cc1418c' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night, " - ", booking_store.bookingAvailabilityParams.adult_nbr, ' ', booking_store.bookingAvailabilityParams.adult_nbr > 1 ? localizedWords.entries.Lcz_Persons : localizedWords.entries.Lcz_Person, " - ", total_rooms, ' ', total_rooms > 1 ? localizedWords.entries.Lcz_Rooms : localizedWords.entries.Lcz_Room)), h("p", { key: 'dbb536617831eedcac794396d8ab51b0f057d619', class: " text-right text-xs text-gray-500" }, (_c = booking_store.tax_statement) === null || _c === void 0 ? void 0 : _c.message)), h("section", { key: '2e313c4324773a8855ff4985465fbd844881f1ed', class: 'space-y-14' }, Object.keys(booking_store.ratePlanSelections).map(roomTypeId => {
            return Object.keys(booking_store.ratePlanSelections[roomTypeId]).map(ratePlanId => {
                const r = booking_store.ratePlanSelections[roomTypeId][ratePlanId];
                if (r.reserved === 0) {
                    return null;
                ...
                return [...new Array(r.reserved)].map((_, index) => {
                    ...
                    return (h("div", { class: "flex items-center justify-between" }, h("div", { class: "flex-1 space-y-2" }, h("div", null, h("div", { class: "flex items-center gap-3" }, h("div", { class: "flex flex-row items-center gap-3 " }, h("h3", { class: "font-semibold" }, r.roomtype.name), r.ratePlan.is_non_refundable ? (h("p", { class: "text-xs text-[var(--ir-green)]" }, "Non refundable")) : (h("div", { class: 'inline-flex  h-6 items-center justify-center pt-0.5' }, h("ir-button", { haveRightIcon: true, variants: "link", class: "text-sm", buttonClassName: "pl-0", buttonStyles: { paddingLeft: '0', fontSize: '12px', paddingTop: '0', paddingBottom: '0' }, onButtonClick: async () => {
        ...
        }))), h("ir-dialog", { key: '67338e8eb00f53d88a6523f8aaa60a9bf5b9b0dc', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: 'becac8bfa4fc400c3d5a5121ab2872cf7df3677a', slot: "modal-body", class: "p-6 " }, h("p", { key: '60e7c162b4ef696d2b0ef0f5d884e406847a1586', class: 'px-6', innerHTML: this.cancelationMessage || ((_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation) }), h("p", { key: '811a904748dbfa93596aebbbe4831c9738bba975', class: 'px-6', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
