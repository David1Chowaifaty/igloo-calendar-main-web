...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        }))), h("ir-dialog", { key: '41aaa76724d07b236bfe8a57b9b241b3d41ffd41', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: 'e0159389bd29f4d35be43a67e6687eeee8247ed6', slot: "modal-body", class: "p-6 " }, h("p", { key: 'a793fc67cab698b96b80c3eddcffefe3e4f0adae', class: 'px-6', innerHTML: this.cancelationMessage || ((_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation) }), h("p", { key: 'b50949a26bb115d428e49b9fd13b852e7dfb282d', class: 'px-6', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
