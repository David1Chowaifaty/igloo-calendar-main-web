...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '87d94e37d8bdc805fc9602aa2a6b73ab95b56b17' }, h("div", { key: '041a734d728afc756be2e47289a63a0db64d8845', class: "w-full" }, h("section", { key: 'f744adb7a1d3098ea40a30d97001cb5eef0c2640', class: "mb-5 flex flex-col flex-wrap items-center gap-2 rounded-md bg-gray-100 px-4 py-2 lg:flex-row" }, h("div", { key: 'ad30bf90346200c9bb27fec6c33776389a94ed7e', class: "flex flex-1 items-center gap-2" }, h("ir-icons", { key: '46db11cbb08b0f8288d9332d1019cb62d29e0ec2', name: "bed" }), h("p", { key: 'b81455b8f8fa903fd2a20489e55f56b160ccffd9' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night, " - ", booking_store.bookingAvailabilityParams.adult_nbr, ' ', booking_store.bookingAvailabilityParams.adult_nbr > 1 ? localizedWords.entries.Lcz_Persons : localizedWords.entries.Lcz_Person, " - ", total_rooms, ' ', total_rooms > 1 ? localizedWords.entries.Lcz_Rooms : localizedWords.entries.Lcz_Room)), h("p", { key: 'b0d68b365bf1c83a6ac996a7e8de4ff1dee5b832', class: " text-right text-xs text-gray-500" }, (_c = booking_store.tax_statement) === null || _c === void 0 ? void 0 : _c.message)), h("section", { key: '21e4aa494058078f37f47babaf6a7ad7459325df', class: 'space-y-14' }, Object.keys(booking_store.ratePlanSelections).map(roomTypeId => {
            return Object.keys(booking_store.ratePlanSelections[roomTypeId]).map(ratePlanId => {
                const r = booking_store.ratePlanSelections[roomTypeId][ratePlanId];
                if (r.reserved === 0) {
                    return null;
        ...
        }))), h("ir-dialog", { key: '710f058d0837c0b15365fec0befb20da590dc256', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: 'c0f70167c312f7804f97b039771bdd041692261a', slot: "modal-body", class: "p-6 " }, h("p", { key: '1a6cca188b984a11a2a5c3a635e136de859cc5e9', class: 'px-6', innerHTML: this.cancelationMessage || ((_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation) }), h("p", { key: '32a9c2483bf6eca8649a4a25dd08d677296d794c', class: 'px-6', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
