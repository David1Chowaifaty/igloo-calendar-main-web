...
import { d as dateFns, g as getDateDifference, f as formatAmount } from './utils.js';
...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '9285ca1faf27229f64bdb2a37da8d5b13cf2119b' }, h("div", { key: '7679a6505a24925341450df8e547b2d164671d8b', class: "w-full" }, h("section", { key: '98536d99c2b23a81a0f29bc5a1c0c1671eb4d18b', class: "mb-5 flex flex-col flex-wrap items-center gap-2 rounded-md bg-gray-100 px-4 py-2 lg:flex-row" }, h("div", { key: 'dc6471b55c3d89ee8d30c5857cd01f6266c18bab', class: "flex flex-1 items-center gap-2" }, h("ir-icons", { key: '01884734ce1e41df267f4b730005f018a55b3977', name: "bed" }), h("p", { key: 'be49df081c40d8f868d0b7352e87ad5cdf79aa49' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night, " - ", booking_store.bookingAvailabilityParams.adult_nbr, ' ', booking_store.bookingAvailabilityParams.adult_nbr > 1 ? localizedWords.entries.Lcz_Persons : localizedWords.entries.Lcz_Person, " - ", total_rooms, ' ', total_rooms > 1 ? localizedWords.entries.Lcz_Rooms : localizedWords.entries.Lcz_Room)), h("p", { key: '6a5c35f2660776b097e849c77c7376307e7304b6', class: " text-right text-xs text-gray-500" }, (_c = booking_store.tax_statement) === null || _c === void 0 ? void 0 : _c.message)), h("section", { key: '04ee007b2f56643d7bb103bf963c175b03293993', class: 'space-y-14' }, Object.keys(booking_store.ratePlanSelections).map(roomTypeId => {
            return Object.keys(booking_store.ratePlanSelections[roomTypeId]).map(ratePlanId => {
                const r = booking_store.ratePlanSelections[roomTypeId][ratePlanId];
                if (r.reserved === 0) {
                    return null;
        ...
        }))), h("ir-dialog", { key: '8de65d63af545b86f6d3e6799359a5b4327aa0a3', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: '80061b653dfb6318899a451b00ef6c65685e7dc4', slot: "modal-body", class: "p-4 md:p-6" }, h("p", { key: '4a3e3bbd5f4a609e972a3faa1f05307d2440a5fc', innerHTML: (_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation }), h("p", { key: '7ebc1128c1ea772837b7b84e4e1ca5ef2e3e708b', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
