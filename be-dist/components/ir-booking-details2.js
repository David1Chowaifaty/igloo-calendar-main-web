...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'befbfe384ad1154a45e8d25271591209bf4cabe0' }, h("div", { key: '17005adad92deb32d861b44be93cacc689d9957d', class: "w-full" }, h("section", { key: 'f0f228e63830633168cdc1fa3f7a171b1d4f792a', class: "mb-5 flex flex-col flex-wrap items-center gap-2 rounded-md bg-gray-100 px-4 py-2 lg:flex-row" }, h("div", { key: '448515a16ed672869ffcd7abe9a501c7af25839d', class: "flex flex-1 items-center gap-2" }, h("ir-icons", { key: '46d58337bd8b4eaccfa30b3e295dea8ea704bc44', name: "bed" }), h("p", { key: '26e206ffd2ebad57a1aec85c05393bff5eaa7381' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night, " - ", booking_store.bookingAvailabilityParams.adult_nbr, ' ', booking_store.bookingAvailabilityParams.adult_nbr > 1 ? localizedWords.entries.Lcz_Persons : localizedWords.entries.Lcz_Person, " - ", total_rooms, ' ', total_rooms > 1 ? localizedWords.entries.Lcz_Rooms : localizedWords.entries.Lcz_Room)), h("p", { key: '9446963f567ddde784ecceb4043aea78e4b6f18c', class: " text-right text-xs text-gray-500" }, (_c = booking_store.tax_statement) === null || _c === void 0 ? void 0 : _c.message)), h("section", { key: '9fbb4054b9257afad615459e081443ef6c8915e5', class: 'space-y-14' }, Object.keys(booking_store.ratePlanSelections).map(roomTypeId => {
            return Object.keys(booking_store.ratePlanSelections[roomTypeId]).map(ratePlanId => {
                const r = booking_store.ratePlanSelections[roomTypeId][ratePlanId];
                if (r.reserved === 0) {
                    return null;
        ...
        }))), h("ir-dialog", { key: '57b46f5a997cb288eee6ae9f4b44c294a7d9dd24', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: '45ab5784168ba48bb1916542c3e88b258eca8cf4', slot: "modal-body", class: "p-4 md:p-6" }, h("p", { key: 'e409a5302f4bffcc8a192cf50afbd27674de75b0', innerHTML: (_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation }), h("p", { key: '7d97072538b6a666cf7933b4546f431ee49202fe', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
