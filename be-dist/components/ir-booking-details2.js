...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '4623feec9d978cc33ef6a10c53128ac9b2855b22' }, h("div", { key: '11f1964a4c169072ea67fdc8773d40e227348645', class: "w-full" }, h("section", { key: '78cab99488cf80d104ee523119b1291670d29fc2', class: "mb-5 flex flex-col flex-wrap items-center gap-2 rounded-md bg-gray-100 px-4 py-2 lg:flex-row" }, h("div", { key: '804364208dc331b08fb0f5f8478005a5e18da69e', class: "flex flex-1 items-center gap-2" }, h("ir-icons", { key: 'e9b25972110b02656cde2ab2c3e3efad70aa2e50', name: "bed" }), h("p", { key: '94d575bd09efe9f6f5a6bbef59f58ac633eccacf' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night, " - ", booking_store.bookingAvailabilityParams.adult_nbr, ' ', booking_store.bookingAvailabilityParams.adult_nbr > 1 ? localizedWords.entries.Lcz_Persons : localizedWords.entries.Lcz_Person, " - ", total_rooms, ' ', total_rooms > 1 ? localizedWords.entries.Lcz_Rooms : localizedWords.entries.Lcz_Room)), h("p", { key: '491a8dbb1d940d4437e8d531e10654c3e104ceba', class: " text-right text-xs text-gray-500" }, (_c = booking_store.tax_statement) === null || _c === void 0 ? void 0 : _c.message)), h("section", { key: 'fc2cb09ce4b2a36e438f81e2a32a1aea0d4beeb0', class: 'space-y-14' }, Object.keys(booking_store.ratePlanSelections).map(roomTypeId => {
            return Object.keys(booking_store.ratePlanSelections[roomTypeId]).map(ratePlanId => {
                const r = booking_store.ratePlanSelections[roomTypeId][ratePlanId];
                if (r.reserved === 0) {
                    return null;
        ...
        }))), h("ir-dialog", { key: '25b08156bc062bd9067af5bcba57e59700c98cef', ref: el => (this.dialogRef = el), onOpenChange: e => {
                if (!e.detail) {
                    this.currentRatePlan = null;
                }
            } }, h("div", { key: '7cd10ea9c2d4a47be8537228768257820ef9e606', slot: "modal-body", class: "p-4 md:p-6" }, h("p", { key: '22a7374915d4b44bb61c7c5958a843eed0443d6f', innerHTML: (_d = this.currentRatePlan) === null || _d === void 0 ? void 0 : _d.cancelation }), h("p", { key: '6570818e202287cc24d84ff873604d1674d9fd19', innerHTML: (_e = this.currentRatePlan) === null || _e === void 0 ? void 0 : _e.guarantee })))));
    }
