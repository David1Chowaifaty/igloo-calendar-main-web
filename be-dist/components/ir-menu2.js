...
const IrMenu = /*@__PURE__*/ proxyCustomElement(class IrMenu extends HTMLElement {
    ...
    render() {
        return (h(Fragment, { key: '05a12ab812bb04f6ee44212de87a96f0db3203c8' }, h("button", { key: 'a63956f72971211baf2045930406629385f25323', ref: el => (this.buttonRef = el), type: "button", "aria-haspopup": "listbox", "aria-expanded": this.isDropdownVisible ? 'true' : 'false', onClick: () => {
                this.toggleDropdown();
            } }, h("slot", { key: '6a104ab5005a994b4c863045bb5563a84864535e', name: "menu-trigger" }, h("div", { key: '2e98d2bc5dd8d7aadd74325eb78936b5fb775296', class: "SelectTrigger" }, this.selectedItemName || this.menuItem, h("svg", { key: 'c580d5a4fcab62ae380c6b41b1fe161f34b79b3c', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '4593a702ffe5b6948f2828d5e18f5d1d069843a1', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), h("div", { key: '438737387cb53332d1fcd0c23e17d49d9b136817', ref: el => (this.contentElement = el), class: "SelectContent", "data-state": this.isDropdownVisible ? 'open' : 'closed' }, this.isDropdownVisible && (h("ul", { key: 'c279b6e3ad8645d6ec72ae03fe89966bb407b866', role: "menu", ref: el => (this.listRef = el), tabindex: "-1" }, this.data.map((item, index) => (h("li", { "data-disabled": item.disabled, "data-state": this.currentHighlightedIndex === index ? 'checked' : 'unchecked', "data-highlighted": this.currentHighlightedIndex === index ? 'true' : 'false', class: 'menu-item', tabindex: -1, role: "menuitem", "aria-disabled": item.disabled ? 'true' : 'false', "aria-selected": this.selectedItemName === item.item ? 'true' : 'false', onClick: () => {
