...
const IrBookingWidget$1 = /*@__PURE__*/ proxyCustomElement(class IrBookingWidget extends HTMLElement {
    ...
    static get style() { return IrBookingWidgetStyle0; }
}, [1, "ir-booking-widget", {
        "position": [513],
...
function defineCustomElement$1() {
    ...
    const components = ["ir-booking-widget", "ir-button", "ir-date-range", "ir-dialog", "ir-guest-counter", "ir-icons", "ir-popover"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-booking-widget":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrBookingWidget$1);
            }
            break;
        case "ir-button":
            if (!customElements.get(tagName)) {
...
const IrBookingWidget = IrBookingWidget$1;
const defineCustomElement = defineCustomElement$1;

export { IrBookingWidget, defineCustomElement };
