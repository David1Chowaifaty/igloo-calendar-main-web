...
export class IrTooltip {
    ...
    render() {
        return (h(Host, { key: '132f7d270c40403ed262a88dc88ec5af61675831' }, h("button", { key: '7c06d07411680f2d6bb4b4ff0674327a4de18dfe', ref: el => (this.trigger = el), onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (h("svg", { "data-toggle": "tooltip", "data-placement": "top", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", class: "tooltip-icon", viewBox: "0 0 512 512" }, h("path", { fill: 'currentColor', d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (h("slot", { name: "tooltip-trigger" }))), h("div", { key: 'c629fb867b9ec38ff8d5953a69a3d2ea52581670', ref: el => (this.content = el), class: "z-50", role: "tooltip" }, this.open && (h(Fragment, null, h("div", { class: "tooltip-content max-w-xs rounded-lg\r\n              px-3 py-2 text-xs " }, h("div", { innerHTML: this.message })))))));
    }
