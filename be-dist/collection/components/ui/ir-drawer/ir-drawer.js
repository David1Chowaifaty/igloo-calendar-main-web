...
export class IrDrawer {
    ...
    render() {
        return (h("div", { key: '3312e90e1eb5afce2111b74eb7bff37915964765', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, h("div", { key: '4cdab0c77ac32b5d24979b9ea01c4af5c2c98ef9', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), h("div", { key: '11fd0007c65b7a328c28938ba788c7627e4a51f4', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (h("header", { key: '6cb75484f2c3e27533c0cd64a7727eb0e00a7247', part: "header", class: "drawer__header" }, h("span", { key: '164b7c49f6c89db6b8cd1425225c4138e545aafe', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, h("slot", { key: '38d2768f28eb09d422418d42eee559e55e99de12', name: "label" }, this.label || String.fromCharCode(65279))), h("six-icon-button", { key: '837fa2f8d3e0c30bc3b0b4b1e4fe48fcf3230863', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), h("div", { key: '65f4fa9bf0f3815dc891a05cb2ebc698e696ea20', part: "body", class: "drawer__body" }, h("slot", { key: '498784c34e3b48b31379f7827f778fde5e6d3449' })), h("footer", { key: '8c7f3794a1b11514af50065037dbc1810876b9f0', part: "footer", class: "drawer__footer" }, h("slot", { key: '64b00e8882320d7665ff05056a2e1ba9e2da8e34', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
