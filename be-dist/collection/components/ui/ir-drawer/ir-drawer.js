...
export class IrDrawer {
    ...
    render() {
        return (h("div", { key: '2d5d1b3eca2ce83eb1325678914d8d1268db670b', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
