...
export class IrDrawer {
    ...
    render() {
        return (h("div", { key: '1f955f73e24a1351945dc4826d2b9fceb09ff427', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, h("div", { key: '2349a371370a881eef147cdd2a053984fe0079e9', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), h("div", { key: '51036a46da18723fc1f4a27f2bae056cc9e3ea02', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (h("header", { key: '391086593b180838d0f806e929111ef1098c7e2a', part: "header", class: "drawer__header" }, h("span", { key: 'b45e254ed4402fb02b5d351a75ce179011622d61', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, h("slot", { key: '0ae31eba4d28358b02949b2047329836171a2639', name: "label" }, this.label || String.fromCharCode(65279))), h("six-icon-button", { key: '77dbeab241f8b5ae36e8c67cb4efd07aa7e4966a', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), h("div", { key: '699f56cf185bea7ce3640bee560db106cd0fdceb', part: "body", class: "drawer__body" }, h("slot", { key: 'cd061e2822af5b8e7205a55d74790b66b7a677b7' })), h("footer", { key: '86dadbf8c3ef2b393385d41233af47058122fc47', part: "footer", class: "drawer__footer" }, h("slot", { key: 'cad6f5ce9caca099adcc081a6877ffb9657c9b73', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
