...
export class IrDrawer {
    ...
    render() {
        return (h("div", { key: '4ec0efa441887f9930c835f1786df3d45c52cdda', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, h("div", { key: 'f8a8b6447218dac0216d38cf5afe6dcae2f8a527', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), h("div", { key: '13d37b97c2e7a14e75c7e64b031586d40f864419', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (h("header", { part: "header", class: "drawer__header" }, h("span", { part: "title", class: "drawer__title", id: `${this.componentId}-title` }, h("slot", { name: "label" }, this.label || String.fromCharCode(65279))), h("six-icon-button", { exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), h("div", { key: '0b0fdf4cfe3f3d3c11273d315fad0f80aa9b6337', part: "body", class: "drawer__body" }, h("slot", { key: '05f28fac7162b949ba7643ebad7b182b582aa4ad' })), h("footer", { key: 'e8130670231b4770821ad2cc6e40561ad8a0f412', part: "footer", class: "drawer__footer" }, h("slot", { key: '732286f65e9122fb8609411de513491dac64e260', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
