...
export class IrDrawer {
    ...
    render() {
        return (h("div", { key: '9bd9f60967d2c3e23b62c56a56c667b4b3b72f48', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, h("div", { key: '4a33e78eb9f8f39545ffe0af1336bda2849d7b44', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), h("div", { key: '355855b9aef7f830bc55a49efca8ed2570df24d1', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (h("header", { key: 'd70a83bca6045cdfdaff62c546983965e1876143', part: "header", class: "drawer__header" }, h("span", { key: 'b7eea971cf698f2ba54603e580af39aed3416cd1', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, h("slot", { key: 'c6ea7454a982f389514ad62fc2f917c9e1a99643', name: "label" }, this.label || String.fromCharCode(65279))), h("six-icon-button", { key: '1cb14044b64f7e04aed5cc29b28e5b5f29b726f5', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), h("div", { key: '2a1b14ed0c5213840dd70cff3f653c6200d65f48', part: "body", class: "drawer__body" }, h("slot", { key: '258ae41013eaa05ba1a88fa4a58804437af99651' })), h("footer", { key: '72e88ae669a423c70d9a6831386c64c45c597c04', part: "footer", class: "drawer__footer" }, h("slot", { key: 'e7d0691338bb2139818e46ff369fae9f9cd28603', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
