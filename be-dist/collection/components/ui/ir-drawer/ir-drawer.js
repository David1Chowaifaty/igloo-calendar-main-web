...
export class IrDrawer {
    ...
    render() {
        return (h("div", { key: '50da9ba79dc71e8f1d41c1b26432a4aa77c3511a', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, h("div", { key: '47ca0f631e114be3432917714aa879d5399b9d6d', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), h("div", { key: 'b7b679086de280cbc75ca3e381b6962e230e5579', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (h("header", { key: '0c68ff5e6b48163439140c6e6008592dd2e5c2a8', part: "header", class: "drawer__header" }, h("span", { key: 'b0bef6b4f89b740cec7ecb3d29f6e4280d726c74', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, h("slot", { key: '26daf3a49a67bbe23d6c906aa5f99c10cc16a00e', name: "label" }, this.label || String.fromCharCode(65279))), h("six-icon-button", { key: '4c401dd09198c5f5538c4fe52dfb35ac6340640f', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), h("div", { key: 'e9c20fac24f3e56a873c6cbf09d437b0d8079498', part: "body", class: "drawer__body" }, h("slot", { key: '89168c5038d964211990548b00f37505f2ff56f5' })), h("footer", { key: '1ae32f83194edf5ab4fae74cb0b9d12e7bbdef32', part: "footer", class: "drawer__footer" }, h("slot", { key: '81ae5ddba1bbc67fcee1db107301f2aea1ce48ba', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
