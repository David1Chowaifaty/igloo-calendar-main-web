...
export class IrDrawer {
    ...
    render() {
        return (h("div", { key: '10abf47b34f96a71839302cf941973f258214f30', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
