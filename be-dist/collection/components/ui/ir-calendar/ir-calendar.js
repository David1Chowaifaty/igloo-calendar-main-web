...
export class IrCalendar {
    ...
    render() {
        ...
        return (h("div", { key: '68d29b11bb20b70255c9ca0689e66f0c7a2ad452', class: 'date-picker' }, h("table", { key: '036458d95e23c670b3c25aff39570a7992d64fbb', class: "calendar ", role: "grid" }, h("thead", { key: '00aedf854a23e6b8b79c2b00ec77be710b2d598d' }, h("tr", { key: '68c6e4d421434e12237b031640ae8865f8b2720c', class: "calendar-header" }, h("th", { key: '1d05b200d329db2b5194a17edc290fc5219a0667', colSpan: 7 }, h("div", { key: '23d0969a03d8cb095713a3c797275edb70174516', class: "month-navigation" }, h("button", { key: 'f219214b6167328a03893a8a4dd3201aac02c744', name: "previous month", class: "navigation-buttons", type: "button", onClick: this.goToPreviousMonth.bind(this) }, h("p", { key: '6a5a5cef213af8331ef026d2242eb421f1474ad1', class: "sr-only" }, "previous month"), h("svg", { key: '0bbb61840fcb0fd66a4ec2c0ec177d2a191874f6', xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, h("path", { key: '205841b1663c9a5956047cf2f87a003f44c94306', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("span", { key: 'e1bf2a33cf90bb2bd47d7383b793b2d73eec1874' }, format(month, 'MMMM yyyy', { locale: this.locale })), h("button", { key: 'ab2c17b049154fa1fdcee0d7168c1786cfced15b', name: "next month", class: "navigation-buttons", type: "button", onClick: this.goToNextMonth.bind(this) }, h("p", { key: '99bed84373df35973ee195111bd2f65137a73271', class: "sr-only " }, "next month"), h("svg", { key: 'd3ac28f5d37b1aca30064538e4edfe886af020a2', xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, h("path", { key: '2dfa82cf20ff1c652a49c43fb16244bdb118437d', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))))), h("tr", { key: 'f1916066a3ebf350c7cd5af1448c5056f34c26ad', class: "weekday-header", role: "row" }, this.weekdays.map(weekday => (h("th", { class: "weekday-name", key: weekday }, weekday))))), h("tbody", { key: 'ad829d6bfa9f3afe7698bb42d87b157b65333e1d', class: "days-grid" }, days
