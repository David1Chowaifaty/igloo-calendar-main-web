...
export class IrCalendar {
    ...
    render() {
        ...
        return (h("div", { key: '9726aef5b60cc8389a4043a6e87e21fe63897273', class: 'date-picker' }, h("table", { key: '33a456f3f64e85b693f15c1850cd9fe703a46241', class: "calendar ", role: "grid" }, h("thead", { key: '868068b7077838a3368c4666a4c57852859d4939' }, h("tr", { key: 'cd19eab70c4d54a3183786af198683c93d2627ec', class: "calendar-header" }, h("th", { key: '407d62aa7101ede3a35cd20b610365665de4a3d5', colSpan: 7 }, h("div", { key: '79360aff954d0bccb8cb9de2db8711422ad1dc2f', class: "month-navigation" }, h("button", { key: '9f06cc2dd2975a60e8016afcf28861dd5ad96c66', name: "previous month", class: "navigation-buttons", type: "button", onClick: this.goToPreviousMonth.bind(this) }, h("p", { key: 'f90bb796dc204f9f4417081d1d1fd1efd8187590', class: "sr-only" }, "previous month"), h("svg", { key: 'fa8a6c1277e4bc947bb67f56aa2a4ac93edee623', xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, h("path", { key: '25a22858e8aa7e58f26a020c6305b3cd9ce88676', fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("span", { key: 'e4522912fb90bce2b6d84772ba0412276658e1bf' }, format(month, 'MMMM yyyy', { locale: this.locale })), h("button", { key: 'd96e4df066859a866ba2967e16120947669337d7', name: "next month", class: "navigation-buttons", type: "button", onClick: this.goToNextMonth.bind(this) }, h("p", { key: '5652cec19d47d18858bbde99ed89dd050a24129d', class: "sr-only " }, "next month"), h("svg", { key: '9b3a18709f92b36cb150b8ba862f5b156c676814', xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, h("path", { key: 'bffa4a019cb5f9559655c836ff2a6f1ca2b3c0f2', fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))))), h("tr", { key: 'cf9061795840988259b923c9bac48284a0147721', class: "weekday-header", role: "row" }, this.weekdays.map(weekday => (h("th", { class: "weekday-name", key: weekday }, weekday))))), h("tbody", { key: '6321006f62eacf47619c5e778f1de6ed861676e9', class: "days-grid" }, days
