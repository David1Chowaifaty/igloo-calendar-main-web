...
export class IrInput {
    ...
    render() {
        return (h("div", { key: 'e810f67f40671a3225a24389bb840b5946b1d95d', ref: el => (this.inputEl = el), class: `input-container  ${this.disabled ? 'disabled' : ''}`, "data-context": this.leftIcon ? 'icon' : '' }, this.leftIcon && (h("label", { key: 'a57cce28832df0a5ce27a08f3371a19b439d231f', htmlFor: this.inputId, class: "left-icon" }, h("slot", { key: '5287f6b8fc494a7cdc29d7f06730f201e1763123', name: "left-icon" }))), h("input", { key: '0021f40b8026d814de47babc8a1b7621429f7233', type: this.type, name: this.name, placeholder: this.placeholder, id: this.inputId, class: this.class, required: this.required, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, pattern: this.pattern, autocomplete: this.autocomplete, autofocus: this.autofocus, size: this.size, multiple: this.multiple, value: this.value, onInput: e => this.textChanged.emit(e.target.value), onBlur: this.handleBlur.bind(this), onFocus: e => this.inputFocus.emit(e) }), h("p", { key: '1b9106912f70fa2fd858de59d1dfefb96d747e2e', slot: "tooltip-trigger", title: this.tooltip, class: "placeholder", style: { '--label-background': this.labelBackground } }, this.label), this.rightIcon && (h("label", { key: 'ee0f711df3071e2803a7a93e54bb5707635a6727', htmlFor: this.inputId, class: "right-icon" }, h("slot", { key: '41a51973665095c0ad3b414675ae228b32030c9a', name: "right-icon" })))));
    }
