...
export class IrInput {
    ...
    render() {
        return (h("div", { key: '24d829f13a8c942964d94b599e8e485ce2bd60e1', ref: el => (this.inputEl = el), class: `input-container  ${this.disabled ? 'disabled' : ''}`, "data-context": this.leftIcon ? 'icon' : '' }, this.leftIcon && (h("label", { key: '36e4332f834bbd98478a9ad41fd5d9fdd405109c', htmlFor: this.inputId, class: "left-icon" }, h("slot", { key: 'c9389a5fc1278599ebee9667b3a8d6155c75685b', name: "left-icon" }))), h("input", { key: '08d0e2b6b0a6d83ad348782edba44e6b70b6f934', type: this.type, name: this.name, placeholder: this.placeholder, id: this.inputId, class: this.class, required: this.required, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, pattern: this.pattern, autocomplete: this.autocomplete, autofocus: this.autofocus, size: this.size, multiple: this.multiple, value: this.value, onInput: e => this.textChanged.emit(e.target.value), onBlur: this.handleBlur.bind(this), onFocus: e => this.inputFocus.emit(e) }), h("p", { key: 'a8d586ae080e8c68c712dff51354a6f7c3103b13', slot: "tooltip-trigger", title: this.tooltip, class: "placeholder", style: { '--label-background': this.labelBackground } }, this.label), this.rightIcon && (h("label", { key: 'fda02b0e613a7ef104369509a7fb5424d66c2dd3', htmlFor: this.inputId, class: "right-icon" }, h("slot", { key: '1927dae5f0576e292898730cf8d3f1b678a2650c', name: "right-icon" })))));
    }
