...
export class IrInput {
    ...
    render() {
        return (h("div", { key: '4067f71e2f16529ea8d2bb0d05386c1caf117072', ref: el => (this.inputEl = el), class: `input-container  ${this.disabled ? 'disabled' : ''}`, "data-context": this.leftIcon ? 'icon' : '' }, this.leftIcon && (h("label", { key: '9b3fcd058d76375e8ee4419973a8206453c84d1b', htmlFor: this.inputId, class: "left-icon" }, h("slot", { key: 'c6de5e03df1c0046919a6a7af55a9c305d3d110f', name: "left-icon" }))), h("input", { key: '1e35e5c316a66ca93bc25ec7dca89f48c1be7c8f', type: this.type, name: this.name, placeholder: this.placeholder, id: this.inputId, class: this.class, required: this.required, disabled: this.disabled, readonly: this.readonly, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, pattern: this.pattern, autocomplete: this.autocomplete, autofocus: this.autofocus, size: this.size, multiple: this.multiple, value: this.value, onInput: e => this.textChanged.emit(e.target.value), onBlur: this.handleBlur.bind(this), onFocus: e => this.inputFocus.emit(e) }), h("p", { key: 'fd6c335c880000284ec122a418fbd3452e699383', slot: "tooltip-trigger", title: this.tooltip, class: "placeholder", style: { '--label-background': this.labelBackground } }, this.label), this.rightIcon && (h("label", { key: 'c91a851192df2f4fb6ad36be284fb9e4ac6882ef', htmlFor: this.inputId, class: "right-icon" }, h("slot", { key: 'c2d763cc3d83dcd1eb81b524157b5a783b0f8101', name: "right-icon" })))));
    }
