...
export class IrGallery {
    ...
    render() {
        var _a;
        return (h("div", { key: '9dcab23b54ae2613b254583eea29e1fa2a2569ae', class: "gallery-container" }, this.totalImages > 1 && (h("button", { key: '15f87211c843ed0c951b6c54de3c8d8a3efe7530', onClick: () => this.handleOpenGallery(), class: "total-images-number" }, h("svg", { key: '9276d496845cfecc934725485cc0cc4343ffb268', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "15.75", viewBox: "0 0 576 512" }, h("path", { key: '1334a1376f2e3b353cd5fe11b4ec090e8c26ad7c', fill: "currentColor", d: "M160 80H512c8.8 0 16 7.2 16 16V320c0 8.8-7.2 16-16 16H490.8L388.1 178.9c-4.4-6.8-12-10.9-20.1-10.9s-15.7 4.1-20.1 10.9l-52.2 79.8-12.4-16.9c-4.5-6.2-11.7-9.8-19.4-9.8s-14.8 3.6-19.4 9.8L175.6 336H160c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16zM96 96V320c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H160c-35.3 0-64 28.7-64 64zM48 120c0-13.3-10.7-24-24-24S0 106.7 0 120V344c0 75.1 60.9 136 136 136H456c13.3 0 24-10.7 24-24s-10.7-24-24-24H136c-48.6 0-88-39.4-88-88V120zm208 24a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), h("span", { key: '49a225f86d84f968652837930fb91afa5682a2f7' }, this.totalImages, " +"))), h("div", { key: 'e215098c68f7cb5f7db7ac712d00f55a523f491b', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: 'c450ceaeecd3f4637aa430389babf30a1affbf01', class: "swiper-wrapper" }, this.images.map(image => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, !this.disableCarouselClick && (h("button", { class: "absolute" }, h("p", { class: "sr-only" }, "open gallery"))), h("img", { "data-disabled": this.disableCarouselClick, onClick: () => {
                if (this.disableCarouselClick) {
                    return;
                }
                this.handleOpenGallery();
            }, importance: "high", draggable: false, src: image.url, alt: image.alt }))))), h("div", { key: '704d1dad8877604f1c55e41e7c8f50c53b5c6e7a', class: "swiper-button-prev", ref: el => (this.prevEl = el) }, h("svg", { key: '2e85bd7731b244b5b5c503c04951469a140f149f', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '6ae86813f4a81f39aeff45a28ea988a4d1e4df38', d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: 'a179b3fc4c2f4186f40d01fe53820975203e2f6a', class: "swiper-button-next", ref: el => (this.nextEl = el) }, h("svg", { key: 'e2a51333edb8088ec2409adf3be7ff9c40107c66', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '87df93d3b39e8c902ca0bea1396dcb7f7e0f409f', d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), h("div", { key: '46fad22819e2fdf0f961418b27aef28290c8ed2d', class: 'gallery', "data-images": this.images.length }, this.images.slice(0, this.maxLength).map((image, idx) => (h("figure", { class: "gallery-item" }, h("button", { class: "absolute" }, h("p", { class: "sr-only" }, "open gallery")), h("img", { loading: "lazy", onClick: () => this.handleOpenGallery(idx), src: image.url, alt: image.alt })))))));
    }
