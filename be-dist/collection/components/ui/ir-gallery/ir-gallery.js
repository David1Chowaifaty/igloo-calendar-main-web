...
export class IrGallery {
    ...
    render() {
        var _a;
        return (h("div", { key: '1fe21839ce392f25fb4c14cda058713dff6531cd', class: "gallery-container" }, this.totalImages > 1 && (h("button", { key: 'f52a4f04fd55f0d4bfa2c21276ff2579ad7bc2d9', onClick: () => this.handleOpenGallery(), class: "total-images-number" }, h("svg", { key: 'f231e6d8d4e3fc8d5c105fda8ebdef998cae5882', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "15.75", viewBox: "0 0 576 512" }, h("path", { key: 'e19101de4919bcf212030043a47c150d1a9dd16a', fill: "currentColor", d: "M160 80H512c8.8 0 16 7.2 16 16V320c0 8.8-7.2 16-16 16H490.8L388.1 178.9c-4.4-6.8-12-10.9-20.1-10.9s-15.7 4.1-20.1 10.9l-52.2 79.8-12.4-16.9c-4.5-6.2-11.7-9.8-19.4-9.8s-14.8 3.6-19.4 9.8L175.6 336H160c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16zM96 96V320c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H160c-35.3 0-64 28.7-64 64zM48 120c0-13.3-10.7-24-24-24S0 106.7 0 120V344c0 75.1 60.9 136 136 136H456c13.3 0 24-10.7 24-24s-10.7-24-24-24H136c-48.6 0-88-39.4-88-88V120zm208 24a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), h("span", { key: 'd529e546bb9354e79c85f96f2c2fb0a645f66b9e' }, this.totalImages, " +"))), h("div", { key: '915591eb351c52cf5aa1b15134f53819c9ebb26a', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: '8eff60525c10b99500253a7bad383caa1583cb60', class: "swiper-wrapper" }, this.images.map(image => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, !this.disableCarouselClick && (h("button", { class: "absolute" }, h("p", { class: "sr-only" }, "open gallery"))), h("ir-image", { thumbnail: image.thumbnail, class: "slide-image", "data-disabled": this.disableCarouselClick, onClick: () => {
                if (this.disableCarouselClick) {
                    return;
                }
                this.handleOpenGallery();
            }, draggable: false, src: image.url, alt: image.alt }))))), h("div", { key: 'aeeb97179ebf57ac5435e422ca0a99ec28b3ae41', class: "swiper-button-prev", ref: el => (this.prevEl = el) }, h("svg", { key: '9d0d1380ee8ff0194b57ca7dd0cdbcd18128a531', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'bd76a89b9452f8596b6b4c6b999ad96c495b7fd5', d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '83cc20ba0f6790d3e0c675f63e145947167bd308', class: "swiper-button-next", ref: el => (this.nextEl = el) }, h("svg", { key: '5bb37251e1197cde343cb4c7b3aab414ce917812', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '85876b2715ddb5bcbd311f97da6a203da63fe1b6', d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), h("div", { key: '7481e55a8346fa90f56facbe50066bb2527bf5cb', class: 'gallery', "data-images": this.images.length }, this.images.slice(0, this.maxLength).map((image, idx) => (h("figure", { class: "gallery-item" }, h("button", { class: "absolute" }, h("p", { class: "sr-only" }, "open gallery")), h("ir-image", { thumbnail: image.thumbnail, class: "gallery-image", onClick: () => this.handleOpenGallery(idx), src: image.url, alt: image.alt })))))));
    }
    ...
    static get properties() {
        return {
            "images": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "{ url: string; alt: string; thumbnail: string }[]",
                    "resolved": "{ url: string; alt: string; thumbnail: string; }[]",
                    "references": {}
                },
                "required": false,
                "optional": false,
