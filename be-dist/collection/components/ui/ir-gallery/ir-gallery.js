...
export class IrGallery {
    ...
    render() {
        var _a;
        return (h("div", { key: 'f4577e0772f677605fcfa11a9fc0ec01bc81f61d', class: "gallery-container" }, this.totalImages > 1 && (h("button", { key: '7c12745d3a17362221b0267c592aa35e2ac3c132', onClick: () => this.handleOpenGallery(), class: "total-images-number" }, h("svg", { key: '2839e03ed3d6d88af77737e1f746f2f07e07aee6', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "15.75", viewBox: "0 0 576 512" }, h("path", { key: '838b864ff1a102e4804f0185d0febba2e63c6330', fill: "currentColor", d: "M160 80H512c8.8 0 16 7.2 16 16V320c0 8.8-7.2 16-16 16H490.8L388.1 178.9c-4.4-6.8-12-10.9-20.1-10.9s-15.7 4.1-20.1 10.9l-52.2 79.8-12.4-16.9c-4.5-6.2-11.7-9.8-19.4-9.8s-14.8 3.6-19.4 9.8L175.6 336H160c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16zM96 96V320c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H160c-35.3 0-64 28.7-64 64zM48 120c0-13.3-10.7-24-24-24S0 106.7 0 120V344c0 75.1 60.9 136 136 136H456c13.3 0 24-10.7 24-24s-10.7-24-24-24H136c-48.6 0-88-39.4-88-88V120zm208 24a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), h("span", { key: '0007127899c035b02b630e46b130d63ed9e45a9c' }, this.totalImages, " +"))), h("div", { key: '8da7571f0e5efd03834b6cffab9d4308899327b2', class: `swiper ${(_a = this.carouselClasses) !== null && _a !== void 0 ? _a : ''}`, ref: el => (this.carouselEl = el) }, h("div", { key: '7fa4d210125d90bce7a322025703ebd5bc090916', class: "swiper-wrapper" }, this.images.map(image => (h("div", { class: "swiper-slide", "data-swipable": this.enableCarouselSwipe }, !this.disableCarouselClick && (h("button", { class: "absolute" }, h("p", { class: "sr-only" }, "open gallery"))), h("img", { "data-disabled": this.disableCarouselClick, onClick: () => {
                if (this.disableCarouselClick) {
                    return;
                }
                this.handleOpenGallery();
            }, importance: "high", draggable: false, src: image.url, alt: image.alt }))))), h("div", { key: 'b6827e54bf0321201f98c8fd180828e6ac8fe9a8', class: "swiper-button-prev", ref: el => (this.prevEl = el) }, h("svg", { key: 'e4a127142f0c3cf9e08d68dc130e8e9e9370b423', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: 'c1cc20f48d71207efb4f13f786192e8463aee4a0', d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), h("div", { key: '3744a2b015fd436812d15d1ed10bc0710abd879f', class: "swiper-button-next", ref: el => (this.nextEl = el) }, h("svg", { key: 'df1705627beec50b011d7cc0be89391cc6bb99fc', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, h("path", { key: '8ae881d62dd896ea9234ef3a2310c1ea7bf32ca6', d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), h("div", { key: '28e90d098253ebff1f3bbe1c5f128cdd588c37b7', class: 'gallery', "data-images": this.images.length }, this.images.slice(0, this.maxLength).map((image, idx) => (h("figure", { class: "gallery-item" }, h("button", { class: "absolute" }, h("p", { class: "sr-only" }, "open gallery")), h("img", { loading: "lazy", onClick: () => this.handleOpenGallery(idx), src: image.url, alt: image.alt })))))));
    }
