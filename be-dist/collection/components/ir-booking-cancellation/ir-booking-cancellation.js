...
export class IrBookingCancellation {
    ...
    render() {
        ...
        return (h("div", { key: '4ac6d41be0ae24cdfdc446fbc6d1908c7e4946f1' }, h("ir-alert-dialog", { key: '6381f38c1a9692bced1f9ec69096263939b4e0db', ref: el => (this.alertDialog = el), onOpenChange: e => {
            ...
            }, size: "md" }), h("ir-button", { key: '95396ef0e08f45dc895c4aba348983e2be2d0451', disabled: isPending, size: "md", label: localizedWords.entries.Lcz_AcceptAndConfirm, isLoading: isRequestPending('/Change_Exposed_Booking_Status'),
