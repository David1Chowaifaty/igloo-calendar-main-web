...
export class IrSignin {
    ...
    render() {
        ...
        return (h(Host, { key: '6daef757f730551ccaf6d4f1d0c709a4aaeaa84d' }, h("h1", { key: '84aae058db26e9073e5b73f9ac205049ac7fcdde', class: "title" }, "Sign in to your booking"), h("form", { key: 'a6329e1fb44644e4a9c388e59e80f4b0a00456c7', onSubmit: this.handleSignIn.bind(this) }, ((_a = this.formState) === null || _a === void 0 ? void 0 : _a.cause) === 'auth' && ((_b = this.formState) === null || _b === void 0 ? void 0 : _b.errors) && (h("div", { key: '026a4fd80783ec18b7b1f2531044c722c35a3076', class: "error" }, h("ir-badge-group", { key: '8a127ed5f03d8bea302b5da88355dcdc6b5828c6', variant: "error", badge: "Error", message: (_e = (_d = (_c = this.formState) === null || _c === void 0 ? void 0 : _c.errors) === null || _d === void 0 ? void 0 : _d.email) !== null && _e !== void 0 ? _e : '' }))), h("fieldset", { key: 'd560388b012e6db1ed84789a9e8c779cd3e47094' }, h("ir-input", { key: '1426b44f4c8a6fd0d40d521cc5ca20e36e5e6132', error: !!((_g = (_f = this.formState) === null || _f === void 0 ? void 0 : _f.errors) === null || _g === void 0 ? void 0 : _g.email), onTextChanged: e => this.modifySignInParams({ email: e.detail }), autofocus: true, inputId: "email", label: "Enter your email", onInputBlur: e => {
                ...
                if (target.hasAttribute('data-state'))
                    target.removeAttribute('data-state');
            } })), h("button", { key: 'd965ceea07bfd3538b227480e2ebf15dba322e26', type: "submit", class: "button-default ir-button", "data-size": 'md' }, this.isLoading && h("span", { key: '3ddf673ef44d02a7b31ead59a062ff7869809cd4', class: "loader" }), "Sign in"), !app_store.app_data.hideGoogleSignIn && (h("div", { key: '86f0712f444b9ea0745ca953d1c018ed86a502ac', class: "divider" }, h("div", { key: '3e04a06082511614e72b445e87ecf0225d02e4aa', class: "divider-line" }), h("span", { key: '33397d5c16ac61c36c4fa70d936b7205748a2cb3', class: "divider-text" }, "OR"), h("div", { key: 'f866c1a6b304845f4e380caf2f4d9c766d532a1c', class: "divider-line" }))))));
    }
