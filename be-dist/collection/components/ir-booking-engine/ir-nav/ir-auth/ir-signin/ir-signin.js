...
export class IrSignin {
    ...
    render() {
        ...
        return (h(Host, { key: '50d0f75717dd29051b2f8b386d23c4cbc5f44954' }, h("h1", { key: '7badf65359e5b258099544b493d040bad51f5f51', class: "title" }, "Sign in to your booking"), h("form", { key: '32f7d9b0b631226d22bab466cce505aca07aba28', onSubmit: this.handleSignIn.bind(this) }, ((_a = this.formState) === null || _a === void 0 ? void 0 : _a.cause) === 'auth' && ((_b = this.formState) === null || _b === void 0 ? void 0 : _b.errors) && (h("div", { key: 'dff151f57d18fb76a79f0099680ce1d8f7876e0f', class: "error" }, h("ir-badge-group", { key: '7060d2e258b1000c8ec0aa89c31c21b56443b7ab', variant: "error", badge: "Error", message: (_e = (_d = (_c = this.formState) === null || _c === void 0 ? void 0 : _c.errors) === null || _d === void 0 ? void 0 : _d.email) !== null && _e !== void 0 ? _e : '' }))), h("fieldset", { key: '76a10fe9d0c741da504d624304866db60e90dca9' }, h("ir-input", { key: 'b5366a8b806f59303be963ba602ae06fba1412d1', error: !!((_g = (_f = this.formState) === null || _f === void 0 ? void 0 : _f.errors) === null || _g === void 0 ? void 0 : _g.email), onTextChanged: e => this.modifySignInParams({ email: e.detail }), autofocus: true, inputId: "email", label: "Enter your email", onInputBlur: e => {
                ...
                if (target.hasAttribute('data-state'))
                    target.removeAttribute('data-state');
            } })), h("button", { key: '3914b920c557871911c6b12f7ac2ccf26c8f642c', type: "submit", class: "button-default ir-button", "data-size": 'md' }, this.isLoading && h("span", { key: '6ce1cb91bb65bf460874428c7ea2e7e18284e970', class: "loader" }), "Sign in"), !app_store.app_data.hideGoogleSignIn && (h("div", { key: 'ec9c76be7e1b3b6d70b24062b8b90e868fe4c05a', class: "divider" }, h("div", { key: '61601a3b41e334ed3144f59a13b00e007ffea05c', class: "divider-line" }), h("span", { key: 'ddf07f4cc218c226698e8dda5a8d86cbdbfbd02d', class: "divider-text" }, "OR"), h("div", { key: 'ddba1649c00451b7d0579db8db1819d6357e42b1', class: "divider-line" }))))));
    }
