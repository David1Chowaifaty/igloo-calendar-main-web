...
export class IrSignin {
    ...
    render() {
        ...
        return (h(Host, { key: 'dba0047c674d7ee6347645aa9aae9e5b32629a71' }, h("h1", { key: '6ecdfeb0be0a00f418079814187e72ac54ad8ac1', class: "title" }, localizedWords.entries.Lcz_SignInToYourBooking), h("form", { key: 'ac4e6eca734ecfa67b8854c4110be9f64dc0542c', onSubmit: this.handleSignIn.bind(this) }, ((_a = this.formState) === null || _a === void 0 ? void 0 : _a.cause) === 'auth' && ((_b = this.formState) === null || _b === void 0 ? void 0 : _b.errors) && (h("div", { key: '34f726e7016d03e19fca728a61f76b912102a8ae', class: "error" }, h("ir-badge-group", { key: 'f3cada15514ef002b2b912137d6be23af1970640', variant: "error", badge: "Error", message: (_e = (_d = (_c = this.formState) === null || _c === void 0 ? void 0 : _c.errors) === null || _d === void 0 ? void 0 : _d.email) !== null && _e !== void 0 ? _e : '' }))), h("fieldset", { key: '95b025fae541d4d190a0d785eabcac0e6adbbe79' }, h("ir-input", { key: '572da83cb21a6cc3e57242cb3c572e44eb8ffde5', error: !!((_g = (_f = this.formState) === null || _f === void 0 ? void 0 : _f.errors) === null || _g === void 0 ? void 0 : _g.email), onTextChanged: e => this.modifySignInParams({ email: e.detail }), autofocus: true, inputId: "email", label: localizedWords.entries.Lcz_EnterYourEmail, onInputBlur: e => {
                ...
                if (target.hasAttribute('data-state'))
                    target.removeAttribute('data-state');
            } })), h("button", { key: '4c6cf5efd31f9592748ab01fcb07cf3c0d852a8c', type: "submit", class: "button-default ir-button", "data-size": 'md' }, this.isLoading && h("span", { key: '19560a3a3cfec08c5072202529a881690b107a26', class: "loader" }), localizedWords.entries.Lcz_SignIn), !app_store.app_data.hideGoogleSignIn && (h("div", { key: 'f10987c01988f688ce5e1993ad3c5795d1690a0b', class: "divider" }, h("div", { key: '1e24fe40335a831dc1fcf5bae2aabc3777b44dbc', class: "divider-line" }), h("span", { key: 'b2fb86c315c52a55718f4c4c0f8ed0d22a0e27b0', class: "divider-text" }, localizedWords.entries.Lcz_Or), h("div", { key: '94b654e40ad0aae885f2a0b3a8083eb82f511986', class: "divider-line" }))))));
    }
