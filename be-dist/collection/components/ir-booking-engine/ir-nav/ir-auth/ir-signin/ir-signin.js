...
export class IrSignin {
    ...
    render() {
        ...
        return (h(Host, { key: '53c1dc65a03ca67ae3557363d635903432b4e785' }, h("h1", { key: 'e30ce16ed27e41dee7359fb44ccba7a780e72d37', class: "title" }, "Sign in to your booking"), h("form", { key: '1a12ff2f5e3eb90f5ab8da5521f83d8304550724', onSubmit: this.handleSignIn.bind(this) }, ((_a = this.formState) === null || _a === void 0 ? void 0 : _a.cause) === 'auth' && ((_b = this.formState) === null || _b === void 0 ? void 0 : _b.errors) && (h("div", { key: 'a5b491f53f2157a510172614697e0b94922b0446', class: "error" }, h("ir-badge-group", { key: 'bf6e6d04eea4734ec1ccaf9338f0621e45d0ea4e', variant: "error", badge: "Error", message: (_e = (_d = (_c = this.formState) === null || _c === void 0 ? void 0 : _c.errors) === null || _d === void 0 ? void 0 : _d.email) !== null && _e !== void 0 ? _e : '' }))), h("fieldset", { key: 'a74622497d37fc102053d2e8e8b5a83e56cc8136' }, h("ir-input", { key: '5a8e3ce2fbe2959320548144329d72fc8f9048f5', error: !!((_g = (_f = this.formState) === null || _f === void 0 ? void 0 : _f.errors) === null || _g === void 0 ? void 0 : _g.email), onTextChanged: e => this.modifySignInParams({ email: e.detail }), autofocus: true, inputId: "email", label: "Enter your email", onInputBlur: e => {
