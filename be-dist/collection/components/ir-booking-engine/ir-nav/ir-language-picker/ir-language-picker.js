...
export class IrLanguagePicker {
    ...
    render() {
        ...
        return (h("div", { key: '5feba85d8d085bb7de19b6addb249ea25f10a268', class: "picker-container" }, h("p", { key: 'c0839a987393e6602e0e72b5ad78854a0cef501d', class: "picker-title" }, "Display settings"), h("div", { key: '26cd6b885bcdc3d8ad3ef22dab0c29d4d208739d', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
        ...
        })), h("ir-select", { key: '7d41f8613a6b6342d0284168fd01f2c7abb04961', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: 'e386dad4368d1042b311c1b526721eb0fb2f3207', class: "actions-container" }, h("ir-button", { key: '200ce2d3e58132784cc014e39694687c3d9892c4', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '1f6e6d5c5eccc53602c9382c9cd21a38ce14d4d2', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
