...
export class IrLanguagePicker {
    ...
    render() {
        var _a;
        return (h("div", { key: '10055c2570d04cb24864ba3a803bfc248cc74229', class: "picker-container" }, h("p", { key: 'c655ba405a2f318a1784a68e6c2eb501d7843664', class: "picker-title" }, "Display settings"), h("div", { key: '88e564a0f010e45f83e1ef937ccc935025ce5d0b', role: "radiogroup", "aria-required": "false", "aria-label": "booking engine language", onKeyDown: e => this.handleKeyDown(e), class: "language-grid", tabIndex: 0 }, this.languages.map((language, i) => {
            var _a, _b, _c;
        ...
        })), h("ir-select", { key: '1ce67868d7823b7a43226e68aeea434c3c3a867e', variant: "double-line", value: (_a = this.selectedCurrency) === null || _a === void 0 ? void 0 : _a.code, onValueChange: this.handleCurrencyChange.bind(this), label: "Currency", select_id: "currency_selector", data: this.currencies.map(currency => ({
                id: currency.code,
            ...
            })) }), h("div", { key: 'a30dcf5ba53811b0d546ebd542fb81fe9bc444f8', class: "actions-container" }, h("ir-button", { key: '5e0896804d88f6035dca985893b0274dbc182ecb', size: "md", label: "Confirm", class: "confirm-button", onClick: this.handleConfirm.bind(this) }), h("ir-button", { key: '8f6a499c3bbf0b27c6ac769c9a6c680b4fd0c700', onButtonClick: () => this.closeDialog.emit(null), size: "md", label: "Cancel", variants: "outline", class: "cancel-button" }))));
    }
