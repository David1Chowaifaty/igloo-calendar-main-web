...
export class IrBookingSummary {
    ...
    render() {
        ...
        return (h(Host, { key: '034a43c1447cee0aa7d6dbcf7177fbf5769ff42e' }, h("div", { key: 'fa363d0c4920d15a03b3b8b2ddaa89008e4f4328', class: "w-full rounded-md bg-gray-100  text-sm md:max-w-sm" }, ((_c = app_store.property) === null || _c === void 0 ? void 0 : _c.space_theme.background_image) && (h("div", { class: "aspect-[1/1] max-h-32 w-full lg:aspect-[16/9]" }, h("img", { class: "h-full w-full rounded-t-md object-cover", src: (_d = app_store.property) === null || _d === void 0 ? void 0 : _d.space_theme.background_image, alt: "" }))), h("section", { key: '0d00f7813a901fbd9d2dfb91711a675368802647', class: "flex flex-col items-center space-y-4 p-4 lg:p-6" }, h("div", { key: '13219f5a601b1e8b88ba184ad8f256fb2d66f9a0', class: "flex w-full flex-1 items-center " }, h("div", { key: 'ce9d1f507eaf9b8c535fefbe5a3da43e19ad1af7', class: "w-56 rounded-md border border-gray-300 bg-white p-2 text-center text-xs" }, h("p", { key: 'fe500dbd17307ef8df2a2502b95e1b6066f339df' }, localizedWords.entries.Lcz_CheckIn), h("p", { key: 'ee4118069f75fe23f118eda68ff90172674a3aca', class: "text-sm font-semibold" }, format(((_e = booking_store.bookingAvailabilityParams) === null || _e === void 0 ? void 0 : _e.from_date) ? new Date((_f = booking_store.bookingAvailabilityParams) === null || _f === void 0 ? void 0 : _f.from_date) : new Date(), 'eee, dd MMM yyyy')), h("p", { key: 'aaa22ecb0ed87c9541d3c2576a41ed2c61293ffd' }, localizedWords.entries.Lcz_From, " ", (_g = app_store.property) === null || _g === void 0 ? void 0 :
            ...
            _k.time_constraints.check_out_till))), h("ir-button", { key: 'cc9a4120ca66ee9d3d5fd64b6c4d42070e6b8a5a', onButtonClick: () => this.routing.emit('booking'), label: localizedWords.entries.Lcz_ChangeDetails, variants: "outline-primary", class: "w-full" }), h("div", { key: 'ff3f1d6eca7ffc97bfeb0384afb6b3e57c71a03d', class: 'mt-4  w-full' }, h("ul", { key: '4a5e90fe5b15f885bb0da45417af7592d243d21b', class: 'w-full space-y-2' }, h("li", { key: '866aeaac0935dfea607290f9f04bb37664fff36e', class: 'flex w-full items-center justify-between' }, h("span", { key: '66c6c0f81d7bfa38a2c18a4163249ffbb262b5ab' }, total_nights, " ", total_nights > 1 ? localizedWords.entries.Lcz_Nights : localizedWords.entries.Lcz_night), h("span", { key: '58535ee487cdce932ba0ad6c9556f615af558185' }, formatAmount(totalAmount, app_store.userPreferences.currency_id))), ((_l = checkout_store.pickup) === null || _l === void 0 ? void 0 : _l.location) && (h("li", { class: 'flex w-full items-center justify-between' }, h("span", null, localizedWords.entries.Lcz_PickupFee), h("span", null, formatAmount(checkout_store.pickup.location ? Number(checkout_store.pickup.due_upon_booking) : 0, app_store.userPreferences.currency_id)))), h("li", { key: '89901e716119c23b07385c450aec970c85dadd49', class: 'flex w-full items-center justify-between' }, h("span", { key: 'a76b50ddd8346d46efe844955874a7fd0fc02680' }, localizedWords.entries.Lcz_Total), h("span", { key: 'acf49173205c9b2743ff99e7c2a41ce7cbd4418e', class: "text-lg font-medium" }, formatAmount(totalAmount + (checkout_store.pickup.location ? Number(checkout_store.pickup.due_upon_booking) : 0), app_store.userPreferences.currency_id))), prePaymentAmount > 0 && (h("li", { class: 'flex w-full items-center justify-between pt-1' }, h("span", null, localizedWords.entries.Lcz_PayNow), h("span", { class: "text-base" }, formatAmount(prePaymentAmount, app_store.userPreferences.currency_id)))))), h("ir-payment-view", { key: 'fc3dd61f08c54b343dcb69a11fb3bd36345f2364', class: "w-full" }), h("div", { key: '619bf186dbf4c3456559ea9a6b207c027fa10e51', class: "w-full space-y-1" }, h("div", { key: '3b214ce9028050d828117d85d957b51101262168', class: 'flex w-full items-center gap-1' }, h("ir-checkbox", { key: 'f4db1792a24d18916781ba6d5b2afb893bad0483', label: "I agree to the", checked: checkout_store.agreed_to_services, onCheckChange: e => (checkout_store.agreed_to_services = e.detail) }), h("ir-privacy-policy", { key: '372f17e89d1665a58753f466bbbf07bba15fe427', label: "privacy policy.", policyTriggerStyle: { color: 'inherit' }, id: "checkout-policy" })), this.error && !checkout_store.agreed_to_services && h("p", { class: "text-sm text-red-500" }, localizedWords.entries.Lcz_YouMustAcceptPrivacyPolicy)), h("ir-button", { key: '8d6d7f55999e20a6abe38e828f1ea69f5c89c8de', isLoading: this.isLoading, size: "md", class: "w-full", label: localizedWords.entries.Lcz_ConfirmBooking, onButtonClick: this.handleBooking.bind(this) })))));
    }
