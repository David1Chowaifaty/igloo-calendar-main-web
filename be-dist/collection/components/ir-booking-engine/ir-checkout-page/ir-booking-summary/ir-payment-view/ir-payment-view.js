...
export class IrPaymentView {
    ...
    render() {
        var _a, _b;
        return (h("div", { key: 'fa662c6dc6aa2b176cdd4482ab86fd11203ccc79', class: "w-full space-y-4 rounded-md border border-solid bg-white  p-4" }, ((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.allowed_payment_methods.length) > 1 ? (h("ir-select", { variant: "double-line", label: localizedWords.entries.Lcz_SelectYourPaymentMethod, data: (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.allowed_payment_methods.map(apm => ({
                id: apm.code,
