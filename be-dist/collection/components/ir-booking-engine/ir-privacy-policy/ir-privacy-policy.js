...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '9e20f64d5d1c13e73e6a86a8968e190990de6897' }, h("ir-button", { key: '884b1c321c6a8b178fa1fa83f11db1252a47bb9e', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: 'c8bcfdb0e43760361cde1c3b3171f92e2c16f3f0', ref: el => (this.dialogRef = el) }, h("div", { key: '0efb9a1dbf66de519cbcd8c590518fe25ec3c182', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: 'af3a3cf02ce734b8877bb33aa7f7ac0515818aa5', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: '45c5df343d5796088ea9ceb8201cb159479be486', class: "text-sm" }, h("p", { key: '3a5a58d7905e7fb53dbd8af0bbdb86f6bbc9b667', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
