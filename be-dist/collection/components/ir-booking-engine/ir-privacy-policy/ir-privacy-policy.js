...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: 'f7773b88ae2eb6d277a0b66f46e774ffd792623e' }, h("ir-button", { key: 'c3b421ece643ed03d28a4b6e00199fb4108fa02f', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: 'a729a3c030b6dfe2608d6f119df7ed02b304153d', ref: el => (this.dialogRef = el) }, h("div", { key: '809de9548f427b132ffb3459b6b82fdf6ad903a4', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: 'b1531992227566089da16a529518090e5e20cb01', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: 'eb6a501f7e0f40be87a92fc6fc310f7e6819528c', class: "text-sm" }, h("p", { key: '839a0afef21ca49cb54f9d0cbe02d45893f0d94c', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
