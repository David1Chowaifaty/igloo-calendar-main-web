...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: 'f0ad57859d9a2c10b84c1038b78ccd1f91e24951' }, !this.hideTrigger && (h("ir-button", { key: 'eca5e54ff93eb2a090776c9054154ed34032d423', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() })), h("ir-dialog", { key: '1acf5a1904e34fc4f98b942eda61d6e54c9f8671', ref: el => (this.dialogRef = el) }, h("div", { key: '3999496bc5707b60fd4e122576884e71485ef0df', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: '6e9f21c76cfba80bc5117d8cd67a8f7eac6c4ef6', class: "mb-4 text-xl font-semibold capitalize text-[var(--gray-700,#344054)]" }, localizedWords.entries.Lcz_PrivacyPolicy), h("div", { key: '597caedea129125c202b814b72542ae056413257', class: "text-sm font-normal" }, h("p", { key: '3cf417653af6fc99dd3b38d868d48d65ff1cde73', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
