...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '093a02d260459baa833a81fc800ea42f841a69c1' }, h("ir-button", { key: '2e77babc2952e4e7d1a4286543b77abd38fa3e76', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: '1e8e57d3884c54fadfba1e23b21863e13069c0df', ref: el => (this.dialogRef = el) }, h("div", { key: 'a5cb867fb799365deb1b284f018c5ed0314b5b16', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: 'bf2c60c44e4ef9c74090cd51c7631681800e9c3f', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: '597349d99906b0e7d9777fa0752abf1840cb650b', class: "text-sm" }, h("p", { key: '2af130936aba62efe5f8ebfa75534f69bd1aec4a', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
