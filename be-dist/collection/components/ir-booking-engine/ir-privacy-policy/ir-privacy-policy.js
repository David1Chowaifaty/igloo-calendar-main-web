...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: 'ffa9a3eb56bb1de7ef29e9e96d7f8f8db9857163' }, h("ir-button", { key: 'd2e35bd71f0eca3164c8ce523826dd41f756b449', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: 'ee6f4a633fdea4ca7e7d5ed725b5c66861e1186a', ref: el => (this.dialogRef = el) }, h("div", { key: '3ca635e564a79a395bdaee6342ad22a77a9ea816', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: 'f4e4c4296c498f057517b15faa03e3ebd47ed346', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: '813d4eda072dcce1bf3dcc13f7c350db5f87042e', class: "text-sm" }, h("p", { key: 'bbaa3b8ff4b5cdd14976152dd67a2ca69b9efa5c', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
