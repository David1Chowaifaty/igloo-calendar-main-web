...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '5f62ed2fac8f4c9156c40e70e84de453f3a4d76f' }, h("ir-button", { key: '98079a392f4b57ecd6b89ccc5eb3c1ef452667af', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: '44bfbe622cfe149c41d28c229a7b3c9b9f930267', ref: el => (this.dialogRef = el) }, h("div", { key: '8bf9184a1e7f7e029530305beef9f4f34c0045c4', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: 'a922911fe47754aa24f3041d5be9c2c0940f63bd', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: 'f5fc69a0e99924948da98f25cf19798e8f2a0186', class: "text-sm" }, h("p", { key: 'd7c7085500688b125a32dfef76c05ddfd4936426', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
