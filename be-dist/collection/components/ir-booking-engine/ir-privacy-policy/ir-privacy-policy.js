...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '68e1265e535b50d0b855f0c95401dac98a45c89a' }, h("ir-button", { key: 'ec03f413c2b6ca69cddc6b9c4300fd2d6fde39db', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: '09b4bf95d141c6fc7419220f343ebcccf0e8d227', ref: el => (this.dialogRef = el) }, h("div", { key: '50a532b2c0c81ba17687179af2fd1e73f81c155c', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: '097a647aca471429fced86a42b2846fdf7bb3331', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: '0c9e7e03201ccd7750e406b9aefc6fa9bc99001f', class: "text-sm" }, h("p", { key: 'de104f8ecc22d2145666c8887e08a8d1dd75566b', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
