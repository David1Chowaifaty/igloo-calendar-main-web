...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '66013616fb1a5f43bd58f9b09b41bb669a494751' }, !this.hideTrigger && (h("ir-button", { key: '6fbb95218f9251c4aaa99bf26f07f2f7e5ec94fc', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() })), h("ir-dialog", { key: '8f560168cc2da531a6a10ef128f63971f946e140', ref: el => (this.dialogRef = el) }, h("div", { key: '99ea62aaff1db834574c71d22bc15c12d64f3d74', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: '63f26f58b12028beec6d8cf3cacd8549fa958ea8', class: "mb-4 text-xl font-semibold capitalize text-[var(--gray-700,#344054)]" }, localizedWords.entries.Lcz_PrivacyPolicy), h("div", { key: '93972dfd6f9a13c65e91cc25ea25aa0a16fe13f1', class: "text-sm font-normal" }, h("p", { key: 'e6eae75a0a366717688d567259d792b3fe48ab1a', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
