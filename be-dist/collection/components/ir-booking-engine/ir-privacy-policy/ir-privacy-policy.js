...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: 'c70b1425803bb805aa723fb7ac46e76a155e8c11' }, h("ir-button", { key: 'f8ba71f2cf39ca390eac6113fc89eb137a5d9d6f', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: 'dbac170a096fa0edf1621bdb68ce6520610e5705', ref: el => (this.dialogRef = el) }, h("div", { key: 'd5ad8489d3add84c7f5bd0dadccd816ee95fdbce', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: '8a5cc99a984278c5fa0d4e4ac46a9723d17341e5', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: 'e38d3e294e033aca2e56ba59dcac8b26c93669a3', class: "text-sm" }, h("p", { key: 'f874fb1db01c06699dce7b4f3847623ce8692f96', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
