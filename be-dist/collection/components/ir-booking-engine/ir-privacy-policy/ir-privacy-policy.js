...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '9518288a964c1300f3d9bf814c6215566dc32187' }, h("ir-button", { key: '582761e7fffafb8f730ff309df703393c2ed87f1', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: 'f679fd13dbdbd41a37e2f105b1dda28e376a749a', ref: el => (this.dialogRef = el) }, h("div", { key: '6996eeae6c2e4ae1f4e1dd11666d59cdc7fa16e3', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: '1705eba406611ad303a7461ca6e841573c3a77c1', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: '8e321fc7d23d5180d244944fd6afb4c347124f10', class: "text-sm" }, h("p", { key: '4e350de510dd8ed7353bb6d35b2dcfdf098f24e1', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
