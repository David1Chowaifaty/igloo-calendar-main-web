...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '09ead21b6194fb3b1b0674e681774e63efcb2f95' }, h("ir-button", { key: '1dd1b36c974a0dbfbde315c062af13d58ba8f8ae', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: 'b6682cb550f9e5b498ea8cb3c62f90273d7e7e4b', ref: el => (this.dialogRef = el) }, h("div", { key: 'eb1858ed3b9033af9feea13c7fc3843d633e7a5a', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: 'a0371b22285a1339854b559ee35a5f4d474a9371', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: '9bfed4d6a1f8b1df30df9f85fc774c23d88470c2', class: "text-sm" }, h("p", { key: '91443c86526d9eb517970cf3590552a89abe9e58', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
