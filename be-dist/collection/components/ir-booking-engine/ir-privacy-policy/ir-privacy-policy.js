...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: 'a05d967724610e2b23755c32958adfeff15164f1' }, !this.hideTrigger && (h("ir-button", { key: '7c6b4676d2c63bda62f45447affc7c0c015136a6', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() })), h("ir-dialog", { key: 'db7e8c7e4c65b60b1d6dd8608821fb89cbbc179a', ref: el => (this.dialogRef = el) }, h("div", { key: 'cb7ed887213d9ff4d54f8778c23d79c37f03ac8a', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: '4290a741f7beb35adf110d9be92f8d61f064d4c6', class: "mb-4 text-xl font-semibold capitalize text-[var(--gray-700,#344054)]" }, localizedWords.entries.Lcz_PrivacyPolicy), h("div", { key: 'fbf5cf9e9df8134bd1928e64fc9dd2bf64a03db1', class: "text-sm font-normal" }, h("p", { key: '50289a8f795307fce37389e05c4ca9ae909a2dbb', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
