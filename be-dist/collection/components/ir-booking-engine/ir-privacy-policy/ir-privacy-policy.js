...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '2f21f3e1693f85b13c68ffc13b4981e61d26f5e6' }, !this.hideTrigger && (h("ir-button", { key: '029e8bb5f1e1eec09177b2447a98a9324f1dde76', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() })), h("ir-dialog", { key: '1ffa602eaf7b6d833543a8db5a611fa887cb2634', ref: el => (this.dialogRef = el) }, h("div", { key: 'aa4e8de259a46ed3ecea89766cf7e463d205a5ba', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: '01848c4c3a7442f5cdeb7d6459365f38697c06d2', class: "mb-4 text-xl font-semibold capitalize text-[var(--gray-700,#344054)]" }, localizedWords.entries.Lcz_PrivacyPolicy), h("div", { key: 'bf119ae9ca3be94e0af80680bb37efe5e58f0b00', class: "text-sm font-normal" }, h("p", { key: 'c6cdcd4a0acd881a3ab1dbb50d0b8843ff1c33cd', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
