...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: 'f791981f6ec3ff72d0b6ee1555eea6920cdafadc' }, h("ir-button", { key: 'f733ca7091213d8b487767e7d7f4ee8a933fee02', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: 'abea6ba0d5c3e3e0b917fedcfed98899e1514d97', ref: el => (this.dialogRef = el) }, h("div", { key: '0d20fda0818b9da43bb0576623820bd0ddd2807b', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: 'fa7378aeb777e258c4538922e3a6b080e4bb4364', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: '5105842eea5581bc92d41d6cbd78ff259c248f41', class: "text-sm" }, h("p", { key: 'a7a9c1116884380dc00fe3c1d71df5a06c0dbeb3', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
