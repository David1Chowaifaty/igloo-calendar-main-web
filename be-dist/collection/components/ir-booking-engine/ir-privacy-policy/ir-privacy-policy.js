...
export class IrPrivacyPolicy {
    ...
    render() {
        ...
        return (h(Host, { key: '7eac66cb3d327d1915b0b7a6e10ade03d8d134d9' }, h("ir-button", { key: 'bbac2e00f9ee7e34276ec08a9f2672cacb6d1fa3', label: this.label, buttonStyles: Object.assign({ padding: '0', background: 'transparent' }, this.policyTriggerStyle), variants: "link", onButtonClick: () => this.dialogRef.openModal() }), h("ir-dialog", { key: 'e18676a11e44386f329272e508734139a2d9a40a', ref: el => (this.dialogRef = el) }, h("div", { key: '08a419159f059ede2cfbb2a195af159a2c23ab57', class: "max-h-[83vh] overflow-y-auto p-4  text-[var(--gray-600,#475467)] md:p-6", slot: "modal-title" }, h("h1", { key: 'ce86e8c9d0884177a46f1beca0353903046e16bb', class: "mb-4 text-xl font-semibold text-[var(--gray-700,#344054)]" }, "Privacy and policy"), h("div", { key: 'def80509b1f24986cefe7c0eba727f61a123e441', class: "text-sm" }, h("p", { key: '8c4b89fbe78da6d2dcb98c139efa70571685078f', innerHTML: this.replaceStringByObjectValue((_a = app_store.property) === null || _a === void 0 ? void 0 : _a.privacy_policy, {
