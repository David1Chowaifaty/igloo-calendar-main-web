...
export class IrBookingPage {
    ...
    render() {
        ...
        return (h(Host, null, h("div", { class: "space-y-5 " }, !isInjected && (h("div", { ref: el => (this.propertyGalleryRef = el) }, h("ir-property-gallery", null))), h("div", null, h("ir-availibility-header", {
            // ages={this.ages}
