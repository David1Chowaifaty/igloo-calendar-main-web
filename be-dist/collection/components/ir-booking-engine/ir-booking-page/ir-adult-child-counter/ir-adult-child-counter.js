...
export class IrAdultChildCounter {
    ...
    render() {
        return (h("ir-popover", { key: 'e1b512c806a094f3164228ab7fe1afa3ac6ab153', ref: el => (this.popover = el), onOpenChange: this.handlePopoverToggle.bind(this) }, this.guestTrigger(), h("div", { key: '5161cd7915069450c8f21714f61eb90a5b4670da', class: "counter-container w-full border-0 p-4 pt-14 shadow-none sm:w-auto sm:border sm:pt-4 sm:shadow-sm", slot: "popover-content" }, h("div", { key: '61523f7066aec7a417db14e4c70ad47cc9d20f24', class: "counter-item" }, h("div", { key: 'cc0f82216f297f73e59c46acb1a063d9967749b0' }, h("p", { key: 'a3f34f5241b77a3faa00eca5b0cfbced3db1bb97', class: "main-text" }, localizedWords.entries.Lcz_Adults), h("p", { key: '15ea453280376bf6fd48ce025121fb80668f23bc', class: "secondary-text" }, localizedWords.entries.Lcz_Age, " ", this.childMaxAge + 1, "+")), h("div", { key: '6405f7d4bc87a296c0db83519667de8ab33ed6e3', class: "counter-buttons-group", role: "group" }, h("ir-button", { key: '5606884fca8b2a4d62b7c3fabef2e99e07f0a454', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), h("p", { key: '9761f8a4c74f6b7e8e46c336c12a65ac5ccda41f' }, this.adultCount), h("ir-button", { key: 'd1a13c434637d741e207981f1cf41917ca0b492e', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), h("div", { key: '8f9d0c309c0314e8a54110fc8058190cdb69c42a', class: "counter-item" }, h("div", { key: '1a4a28072b7183d09f216e53fff5a9c19fbf419d' }, h("p", { key: '5220186f91313effbcc8ac79d83a9949efee602c', class: "main-text" }, localizedWords.entries.Lcz_Children), h("p", { key: '6a54705f35260869f2f96312a5d6c12a8de54a5b', class: "secondary-text" }, localizedWords.entries.Lcz_Ages, " 1-", this.childMaxAge)), h("div", { key: '6ebd428c4580e0a6061d727787db499d189da6e5', class: "counter-buttons-group", role: "group" }, h("ir-button", { key: '8666da38b1d55ec4febbb31825633ddb6018f1cf', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), h("p", { key: '9e942614f2d353ea1396a22aeba0326ac2ff2bde' }, this.childrenCount), h("ir-button", { key: 'e7dfab474d8eb728f5582ecb360c45989ed72d87', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" }))), h("ir-button", { key: '5b65357e03b4c62707294c7628c74b84989edb73', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button", label: localizedWords.entries.Lcz_Done, "aria-label": "Confirm selection" }))));
    }
