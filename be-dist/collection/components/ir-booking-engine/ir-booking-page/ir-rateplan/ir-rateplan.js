...
export class IrRateplan {
    ...
    render() {
        ...
        return (h("div", { key: '2f2342e232ce506977defee416984439ac965db9', class: "rateplan-container" }, h("div", { key: '8e0cd2e3399851252f9fc422160290910c450eed', class: `rateplan-header ${this.roomTypeInventory > 0 ? 'available' : 'not-available'}` }, h("p", { key: 'e80c2ecdc4967925923da79ad7d84ebea60c862a', class: "rateplan-name" }, h("span", { key: '273af307a77210fd6f47c3adb09574463100a63d', class: "rateplan-short-name" }, this.ratePlan.short_name), h("span", { key: 'a2db12c05176aecaf716658839b776d0d159ccf1', class: "rateplan-custom-text rateplan-custom-text-hidden" }, this.ratePlan.custom_text)), this.roomTypeInventory > 0 ? (h("div", { class: "rateplan-pricing-mobile" }, h("p", { class: "rateplan-amount" }, formatAmount((_b = (_a = this.visibleInventory) === null || _a === void 0 ? void 0 : _a.selected_variation) === null || _b === void 0 ? void 0 : _b.amount, app_store.userPreferences.currency_id)), ((_d = (_c = this.visibleInventory) === null || _c === void 0 ? void 0 : _c.selected_variation) === null || _d === void 0 ? void 0 : _d.discount_pct) > 0 && (h("p", { class: "rateplan-discounted-amount" }, formatAmount((_f = (_e = this.visibleInventory) === null || _e === void 0 ? void 0 : _e.selected_variation) === null || _f === void 0 ? void 0 : _f.total_before_discount, app_store.userPreferences.currency_id))))) : (h("p", { class: "no-availability" }, "Not available"))), h("p", { key: 'bb0ae106e9e67c7f456306d13b7365db8e337ae8', class: "rateplan-custom-text rateplan-custom-text-mobile" }, this.ratePlan.custom_text), this.roomTypeInventory > 0 && (h("div", { class: `rateplan-details ${this.ratePlan.custom_text ? 'rateplan-details-no-custom-text' : ''}` }, h("div", { class: "rateplan-travelers" }, this.ratePlan.variations && (h("ir-select", { class: "rateplan-select-travelers", label: "Travelers", value: (((_h = (_g = this.visibleInventory) === null || _g === void 0 ? void 0 : _g.selected_variation) === null || _h === void 0 ? void 0 : _h.adult_nbr) + ((_k = (_j = this.visibleInventory) === null || _j === void 0 ? void 0 : _j.selected_variation) === null || _k === void 0 ? void 0 : _k.child_nbr)).toString(), onValueChange: e => {
