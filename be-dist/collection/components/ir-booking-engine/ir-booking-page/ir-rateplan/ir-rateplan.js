...
export class IrRateplan {
    ...
    render() {
        ...
        return (h("div", { class: "rateplan-container" }, h("div", { class: `rateplan-header ${this.isRatePlanAvailable ? 'available' : 'not-available'}` }, h("div", { class: "rateplan-details-wrapper" }, h("p", { class: "rateplan-name" }, h("span", { class: "rateplan-short-name" }, this.ratePlan.short_name), this.ratePlan.is_non_refundable ? (h("p", { class: "rateplan-tooltip text-xs", style: { color: 'var(--ir-green)' } }, localizedWords.entries.Lcz_NonRefundable)) : (this.ratePlan.is_available_to_book && (h("ir-tooltip", { labelColors: isInFreeCancelationZone ? 'green' : 'default', class: `rateplan-tooltip`, open_behavior: "click", label: isInFreeCancelationZone ? localizedWords.entries.Lcz_FreeCancellation : localizedWords.entries.Lcz_IfICancel, message: `${this.cancelationMessage || this.ratePlan.cancelation} ${(_f = this.ratePlan.guarantee) !== null && _f !== void 0 ? _f : ''}`, onTooltipOpenChange: e => {
            ...
            } }))), h("div", { class: "flex gap-4" }, getDateDifference(booking_store.bookingAvailabilityParams.from_date, booking_store.bookingAvailabilityParams.to_date) > 1 && (h("p", { class: "rateplan-amount-per-night grid-view" }, `${formatAmount((_y = (_x = this.visibleInventory) === null || _x === void 0 ? void 0 : _x.selected_variation) === null || _y === void 0 ? void 0 : _y.amount_per_night, app_store.userPreferences.currency_id, 0)}/${localizedWords.entries.Lcz_night}`)), ((_0 = (_z = this.visibleInventory) === null || _z === void 0 ? void 0 : _z.selected_variation) === null || _0 === void 0 ? void 0 : _0.discount_pct) > 0 && !this.ratePlan.custom_text && (h("p", { class: `rateplan-discount ${app_store.app_data.displayMode === 'default' ? 'ir-default' : ''}` }, `-${Number((_2 = (_1 = this.visibleInventory) === null || _1 === void 0 ? void 0 : _1.selected_variation) === null || _2 === void 0 ? void 0 : _2.discount_pct).toPrecision(2)}%`)))), this.display === 'default' && h("p", { class: "rateplan-custom-text", innerHTML: this.ratePlan.custom_text }))), !this.ratePlan.is_available_to_book && this.ratePlan.not_available_reason.includes('MLS') && (h("p", { class: "mls_alert_grid" }, localizedWords.entries.Lcz_MLS_Alert.replace('{0}', (_3 = this.ratePlan.not_available_reason) === null || _3 === void 0 ? void 0 : _3.replace('MLS-', ''))))), this.isRatePlanAvailable && (h("div", { class: `rateplan-details ${this.ratePlan.custom_text ? 'rateplan-details-no-custom-text' : ''}` }, this.isLoading ? (h("div", { class: "col-span-6 w-full " }, h("ir-skeleton", { class: "block h-12 w-full" }))) : (h(Fragment, null, h("div", { class: "rateplan-travelers" }, this.ratePlan.variations && this.ratePlan.is_available_to_book && (h("ir-select", { class: "rateplan-select-travelers", label: 'Travelers', value: this.ratePlan.variations
                .findIndex(f => {
                var _a, _b, _c, _d;
                ...
                html: true,
            })) }))), !((_4 = this.ratePlan.not_available_reason) === null || _4 === void 0 ? void 0 : _4.includes('MLS')) ? (h(Fragment, null, ((_6 = (_5 = this.visibleInventory) === null || _5 === void 0 ? void 0 : _5.selected_variation) === null || _6 === void 0 ? void 0 : _6.discounted_amount) && (h(Fragment, null, ((_8 = (_7 = this.visibleInventory) === null || _7 === void 0 ? void 0 : _7.selected_variation) === null || _8 === void 0 ? void 0 : _8.discount_pct) > 0 && (h("div", { class: "rateplan-pricing" }, h("p", { class: "rateplan-discounted-amount" }, formatAmount((_10 = (_9 = this.visibleInventory) === null || _9 === void 0 ? void 0 : _9.selected_variation) === null || _10 === void 0 ? void 0 : _10.amount, app_store.userPreferences.currency_id, 0)), h("p", { class: "rateplan-discount" }, `-${Number((_12 = (_11 = this.visibleInventory) === null || _11 === void 0 ? void 0 : _11.selected_variation) === null || _12 === void 0 ? void 0 : _12.discount_pct).toPrecision(2)}%`))), h("div", { class: "rateplan-final-pricing", "data-style": ((_14 = (_13 = this.visibleInventory) === null || _13 === void 0 ? void 0 : _13.selected_variation) === null || _14 === void 0 ? void 0 : _14.discount_pct) > 0 ? '' : 'full-width' }, h("p", { class: "rateplan-amount" }, formatAmount((_16 = (_15 = this.visibleInventory) === null || _15 === void 0 ? void 0 : _15.selected_variation) === null || _16 === void 0 ? void 0 : _16.discounted_amount, app_store.userPreferences.currency_id, 0)), getDateDifference(booking_store.bookingAvailabilityParams.from_date, booking_store.bookingAvailabilityParams.to_date) > 1 && (h("p", { class: "rateplan-amount-per-night" }, `${formatAmount((_18 = (_17 = this.visibleInventory) === null || _17 === void 0 ? void 0 : _17.selected_variation) === null || _18 === void 0 ? void 0 : _18.amount_per_night, app_store.userPreferences.currency_id, 0)}/${localizedWords.entries.Lcz_night}`))))), ((_19 = this.visibleInventory) === null || _19 === void 0 ? void 0 : _19.reserved) > 0 ? (h("ir-select", { onValueChange: e => {
                reserveRooms(this.roomTypeId, this.ratePlan.id, Number(e.detail));
                this.animateBookingButton.emit(null);
            }, label: localizedWords.entries.Lcz_Rooms, value: (_20 = this.visibleInventory) === null || _20 === void 0 ? void 0 : _20.reserved, class: "rateplan-select-rooms", data: (_21 = [...new Array(this.roomTypeInventory + 1)]) === null || _21 === void 0 ? void 0 : _21.map((_, i) => {
                var _a, _b, _c;
                return ({
                    id: i,
                    value: i === 0
                ...
                this.animateBookingButton.emit(null);
            } })))) : (h("p", { class: "mls_alert" }, localizedWords.entries.Lcz_MLS_Alert.replace('{0}', (_22 = this.ratePlan.not_available_reason) === null || _22 === void 0 ? void 0 : _22.replace('MLS-', ''))))))))));
    }
    formatVariation(v) {
