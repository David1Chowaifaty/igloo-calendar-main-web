    ...
    render() {
        ...
        return (h("div", { class: "rateplan-container" }, h("div", { class: `rateplan-header ${this.isRatePlanAvailable ? 'available' : 'not-available'}` }, h("div", { class: "rateplan-details-wrapper" }, h("p", { class: "rateplan-name" }, h("span", { class: "rateplan-short-name" }, this.ratePlan.short_name), this.ratePlan.is_non_refundable ? (h("p", { class: "rateplan-tooltip text-xs", style: { color: 'var(--ir-green)' } }, localizedWords.entries.Lcz_NonRefundable)) : (this.ratePlan.is_available_to_book && (h("ir-tooltip", { labelColors: isInFreeCancelationZone ? 'green' : 'default', class: `rateplan-tooltip`, open_behavior: "click", label: isInFreeCancelationZone ? localizedWords.entries.Lcz_FreeCancellation : localizedWords.entries.Lcz_IfICancel, message: `${this.cancelationMessage || this.ratePlan.cancelation} ${(_f = this.ratePlan.guarantee) !== null && _f !== void 0 ? _f : ''}`, onTooltipOpenChange: e => {
            ...
            getDateDifference(booking_store.bookingAvailabilityParams.from_date, booking_store.bookingAvailabilityParams.to_date) > 1 && (h("p", { class: "rateplan-amount-per-night grid-view" }, `${formatAmount((_z = (_y = this.visibleInventory) === null || _y === void 0 ? void 0 : _y.selected_variation) === null || _z === void 0 ? void 0 : _z.amount_per_night, app_store.userPreferences.currency_id, 0)}/${localizedWords.entries.Lcz_night}`)), ((_1 = (_0 = this.visibleInventory) === null || _0 === void 0 ? void 0 : _0.selected_variation) === null || _1 === void 0 ? void 0 : _1.discount_pct) > 0 && !this.ratePlan.custom_text && (h("p", { class: `rateplan-discount ${app_store.app_data.displayMode === 'default' ? 'ir-default' : ''}` }, `-${Number((_3 = (_2 = this.visibleInventory) === null || _2 === void 0 ? void 0 : _2.selected_variation) === null || _3 === void 0 ? void 0 : _3.discount_pct)}%`)))), this.display === 'default' && h("p", { class: "rateplan-custom-text", innerHTML: this.ratePlan.custom_text }))), !this.ratePlan.is_available_to_book && this.ratePlan.not_available_reason.includes('MLS') && (h("p", { class: "mls_alert_grid" }, localizedWords.entries.Lcz_MLS_Alert.replace('{0}', (_4 = this.ratePlan.not_available_reason) === null || _4 === void 0 ? void 0 : _4.replace('MLS-', ''))))), this.isRatePlanAvailable && (h("div", { class: `rateplan-details ${this.ratePlan.custom_text ? 'rateplan-details-no-custom-text' : ''}` }, this.isLoading ? (h("div", { class: "col-span-6 w-full " }, h("ir-skeleton", { class: "block h-12 w-full" }))) : (h(Fragment, null, h("div", { class: "rateplan-travelers" }, this.ratePlan.variations && this.ratePlan.is_available_to_book && (h("ir-select", { class: "rateplan-select-travelers", label: 'Travelers', value: this.ratePlan.variations
                ...
                html: true,
            })) }))), !((_5 = this.ratePlan.not_available_reason) === null || _5 === void 0 ? void 0 : _5.includes('MLS')) ? (h(Fragment, null, ((_7 = (_6 = this.visibleInventory) === null || _6 === void 0 ? void 0 : _6.selected_variation) === null || _7 === void 0 ? void 0 : _7.discounted_amount) && (h(Fragment, null, ((_9 = (_8 = this.visibleInventory) === null || _8 === void 0 ? void 0 : _8.selected_variation) === null || _9 === void 0 ? void 0 : _9.discount_pct) > 0 && (h("div", { class: "rateplan-pricing" }, h("p", { class: "rateplan-discounted-amount" }, formatAmount((_11 = (_10 = this.visibleInventory) === null || _10 === void 0 ? void 0 : _10.selected_variation) === null || _11 === void 0 ? void 0 : _11.amount, app_store.userPreferences.currency_id, 0)), h("p", { class: "rateplan-discount" }, `-${Number((_13 = (_12 = this.visibleInventory) === null || _12 === void 0 ? void 0 : _12.selected_variation) === null || _13 === void 0 ? void 0 : _13.discount_pct)}%`))), h("div", { class: "rateplan-final-pricing", "data-style": ((_15 = (_14 = this.visibleInventory) === null || _14 === void 0 ? void 0 : _14.selected_variation) === null || _15 === void 0 ? void 0 : _15.discount_pct) > 0 ? '' : 'full-width' }, h("p", { class: "rateplan-amount" }, formatAmount((_17 = (_16 = this.visibleInventory) === null || _16 === void 0 ? void 0 : _16.selected_variation) === null || _17 === void 0 ? void 0 : _17.discounted_amount, app_store.userPreferences.currency_id, 0)), ((_18 = this.visibleInventory) === null || _18 === void 0 ? void 0 : _18.selected_variation) &&
