...
export class IrPropertyGallery {
    ...
    render() {
        ...
        return (h("div", { key: 'f02c249f902653163b08eaf5de9990d430300a41' }, this.property_state === 'gallery' ? (h("ir-gallery", { totalImages: (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.images.length, images: (_d = (_c = app_store.property) === null || _c === void 0 ? void 0 : _c.images) === null || _d === void 0 ? void 0 : _d.map(i => ({ url: i.url, alt: i.tooltip })).slice(0, 5) })) : (h(Fragment, null, h("div", { class: "flex flex-wrap items-center gap-2 py-2 text-sm font-normal text-gray-700 md:hidden" }, h("ir-accomodations", { bookingAttributes: {
                ...
                id: v4(),
                image_uri: img.url,
            })) }), this.showPlanLimitations()))), h("ir-button", { onButtonClick: () => this.irDialog.openModal(), variants: "link", label: "More details", buttonStyles: { paddingLeft: '0' } })))), h("ir-dialog", { key: 'e0a91cd8c89eaa997bc133dc9a98adb882df6992', ref: el => (this.irDialog = el) }, h("div", { key: '6bd2d46310b85b186679bf2317ca39ce36de9168', slot: "modal-body", class: "modal-container max-h-[80vh] overflow-y-auto px-4 pb-4  pt-0 md:p-4 md:pt-0" }, h("div", { key: '230b9159c3fb41d5a2ccecd1e789db709b091c10', class: " sticky top-0 z-50 mb-2 flex w-full  items-center justify-between bg-white py-2 md:pt-4" }, h("h2", { key: '7a4a10236f0f65644a49c9c295f3767a641554a2', class: "text-lg font-semibold md:text-xl" }, this.property_state === 'carousel' ? this.roomType.name : (_k = app_store.property) === null || _k === void 0 ? void 0 : _k.name), h("ir-button", { key: 'a925a65c751f7cc8eb995b9213967c316dc5d657', variants: "icon", onButtonClick: () => this.irDialog.closeModal() }, h("div", { key: '13d86c52072710443df5a78e65882f940a251a4a', slot: "btn-icon" }, h("ir-icons", { key: '4cb049e86569dd8d671673f3e311313d3dbc87ef', name: "xmark" })))), h("section", { key: '0c4ef3739b6ca0a5915196723416de4dec60106a', class: "max-h-[80vh]" }, h("div", { key: '43ac286e2d0417ca78906e01da486c55539c51ec', class: "coursel_gallery_container" }, h("ir-carousel", { key: '274cc46d98044de5a979c784303a867219be761d', slides: images === null || images === void 0 ? void 0 : images.map(img => ({
                alt: img.tooltip,
                id: v4(),
                image_uri: img.url,
