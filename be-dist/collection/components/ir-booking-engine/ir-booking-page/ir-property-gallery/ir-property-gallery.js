...
export class IrPropertyGallery {
    ...
    render() {
        ...
        return (h("div", { key: 'c7d4f36786de87da7631e0f4218c4088b7097156' }, this.property_state === 'gallery' ? (h("ir-gallery", { totalImages: (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.images.length, images: (_d = (_c = app_store.property) === null || _c === void 0 ? void 0 : _c.images) === null || _d === void 0 ? void 0 : _d.map(i => ({ url: i.url, alt: formatImageAlt(i.tooltip) })).slice(0, 5) })) : (h(Fragment, null, h("div", { class: "flex flex-wrap items-center gap-2 py-2 text-sm font-normal text-gray-700 md:hidden" }, h("ir-accomodations", { bookingAttributes: {
            ...
            }) }), this.showPlanLimitations()))), h("ir-button", { onButtonClick: () => this.irDialog.openModal(), variants: "link", label: localizedWords.entries.Lcz_MoreDetails, class: "more-details-button", buttonStyles: { paddingLeft: '0', paddingBottom: '0', background: 'transparent', fontSize: '12px' } })))), h("ir-dialog", { key: '39291a62b464a69b61cf70761d7eb2f360f4c227', ref: el => (this.irDialog = el), closeButton: false }, h("div", { key: '41d9a88c1ac3fbe00bf82e9810b5f50a82804a4d', slot: "modal-body", class: "modal-container max-h-[80vh] overflow-y-auto px-4 pb-4  pt-0 md:p-4 md:pt-0", dir: "ltr" }, h("div", { key: 'cacae51a745636070c1588b62c5f44e8567deaec', class: " sticky top-0 z-50 mb-2 flex w-full  items-center justify-between bg-white py-2 md:pt-4", dir: app_store.dir }, h("h2", { key: '0cd4ad902583fc5e25dc6746f3c66ae393f41cd2', class: "text-lg font-semibold md:text-xl" }, this.property_state === 'carousel' ? this.roomType.name : (_m = app_store.property) === null || _m === void 0 ? void 0 : _m.name), h("ir-button", { key: '1519566be7aff44a85d8e48bc0e1de617f9e6a67', iconName: "xmark", variants: "icon", onButtonClick: () => this.irDialog.closeModal() })), h("section", { key: '18eb4be676eee223e5c4b845f0d210139f043324', class: "max-h-[80vh]" }, images.length > 0 && (h("div", { key: '8f79d2963dee4ff8d22b5b409be25e1ab9a1316d', class: "coursel_gallery_container hidden sm:block" }, h("ir-carousel", { dir: app_store.dir, key: ((_o = this.roomType) === null || _o === void 0 ? void 0 : _o.id) + '_' + app_store.dir, slides: images === null || images === void 0 ? void 0 : images.map(img => {
                var _a;
                return ({
                    alt: formatImageAlt(img.tooltip, (_a = this.roomType) === null || _a === void 0 ? void 0 : _a.name),
                    id: v4(),
                ...
                e.stopPropagation();
            } }), this.showPlanLimitations(false))), this.property_state === 'carousel' && (h("section", { key: '59ab3d36db334b4d1ed3c64cb92626c6ef3f3907', class: 'z-0 py-4 text-sm', dir: app_store.dir }, h("ir-room-type-amenities", { key: '3f80e44b2743aa85c835e25858e6d66a54b8a7a5', aminities: (_p = app_store.property) === null || _p === void 0 ? void 0 : _p.amenities, roomType: this.roomType }))))))));
    }
