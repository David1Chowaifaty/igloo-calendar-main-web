...
export class IrPropertyGallery {
    ...
    render() {
        ...
        return (h("div", { key: 'a32538eb27c7c38e2cec3dacc3ec50b86f3bf6bc' }, this.property_state === 'gallery' ? (h("ir-gallery", { totalImages: (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.images.length, images: (_d = (_c = app_store.property) === null || _c === void 0 ? void 0 : _c.images) === null || _d === void 0 ? void 0 : _d.map(i => i.url).slice(0, 5) })) : (h(Fragment, null, h("div", { class: "flex flex-wrap items-center gap-2 py-2 text-sm font-normal text-gray-700 md:hidden" }, h("ir-accomodations", { bookingAttributes: {
                ...
                id: v4(),
                image_uri: img.url,
            })) }), this.showPlanLimitations()))), h("ir-button", { onButtonClick: () => this.irDialog.openModal(), variants: "link", label: "More details", buttonStyles: { paddingLeft: '0' } })))), h("ir-dialog", { key: '0980acd7d40788ba7fef6031b8f08d08cff4e9ea', ref: el => (this.irDialog = el) }, h("div", { key: '437b0b20ae2f859ebe7a77a9cca9d2030ff4616e', slot: "modal-body", class: "modal-container max-h-[80vh] overflow-y-auto px-4 pb-4  pt-0 md:p-4 md:pt-0" }, h("div", { key: 'ff8273f669edd738bcd9a7e044b2ade15ec4b973', class: " sticky top-0 z-50 mb-2 flex w-full  items-center justify-between bg-white py-2 md:pt-4" }, h("h2", { key: '2e098655b9b76cfa9902f9f160d7a760d45a1508', class: "text-lg font-semibold md:text-xl" }, this.property_state === 'carousel' ? this.roomType.name : (_k = app_store.property) === null || _k === void 0 ? void 0 : _k.name), h("ir-button", { key: '9b41e3f552b49a9233413d37d3284ec74531567f', variants: "icon", onButtonClick: () => this.irDialog.closeModal() }, h("div", { key: '08c2cb62b45dadb461f380dbcaf82ef92831da1c', slot: "btn-icon" }, h("ir-icons", { key: '13aac3eb026cf7bf2312d26f45dbab64404e2062', name: "xmark" })))), h("section", { key: '7cf80ff6b7153211061c56779b220443b9305aed', class: "max-h-[80vh]" }, h("div", { key: 'ffd98b2608954d95607bdcc9abaa166d8df0b6ae', class: "coursel_gallery_container" }, h("ir-carousel", { key: 'f8cbaff216a17312843dedb0ae6b52e612c7f1f1', slides: images === null || images === void 0 ? void 0 : images.map(img => ({
                alt: img.tooltip,
                id: v4(),
                image_uri: img.url,
