...
export class IrPropertyGallery {
    ...
    render() {
        ...
        return (h("div", { key: '0ffabff13d89eb1c1aac56d116ce4ff76742e5cc' }, this.property_state === 'gallery' ? (h("ir-gallery", { totalImages: (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.images.length, images: (_d = (_c = app_store.property) === null || _c === void 0 ? void 0 : _c.images) === null || _d === void 0 ? void 0 : _d.map(i => ({ url: i.url, alt: formatImageAlt(i.tooltip) })), maxLength: 5, disableCarouselClick: true, enableCarouselSwipe: true })) : (h(Fragment, null, h("div", { class: `carousel-container relative aspect-[16/9] w-full overflow-hidden  ${this.display === 'default' ? 'md:hidden' : ''}` }, this.roomType.images.length === 0 ? (h(Fragment, null, h("div", { onClick: () => this.irDialog.openModal(), class: "gallery-img icon  bg-gray-300 text-white" }, h("ir-icons", { name: "image", svgClassName: "size-10 mb-4" })), this.showPlanLimitations({ showMoreTag: true, withRoomSize: true }))) : this.roomType.images.length === 1 ? (h("img", { onClick: () => this.irDialog.openModal(), class: "gallery-img object-cover ", src: this.roomType.images[0].url, alt: formatImageAlt(this.roomType.images[0].tooltip, (_e = this.roomType) === null || _e === void 0 ? void 0 : _e.name) })) : (h("ir-carousel", { carouselClasses: "pg_carousel", onCarouselImageIndexChange: e => (this.activeIndex = e.detail), slides: (_g = (_f = this.roomType) === null || _f === void 0 ? void 0 : _f.images) === null || _g === void 0 ? void 0 : _g.map(img => {
            ...
            }) }), this.showPlanLimitations({ showMoreTag: true, withRoomSize: true })))))))), h("ir-dialog", { key: '3909a463e1b5f4072f93563d7b6003b06fcda866', ref: el => (this.irDialog = el), closeButton: false }, h("div", { key: '94ab325d7b1d7503ef16a352fbef076aab0ea1e7', slot: "modal-body", class: "modal-container max-h-[80vh] overflow-y-auto px-4 pb-4  pt-0 md:p-4 md:pt-0", dir: "ltr" }, h("div", { key: 'd0a2d8304db144a8567b1cea096fb3fa9e41289a', class: " sticky top-0 z-50 mb-2 flex w-full  items-center justify-between bg-white py-2 md:pt-4", dir: app_store.dir }, h("h2", { key: '39e24de320d2f5a7e1d4eef751babaacb17bb1e5', class: "text-lg font-semibold md:text-xl" }, this.property_state === 'carousel' ? this.roomType.name : (_l = app_store.property) === null || _l === void 0 ? void 0 : _l.name), h("ir-button", { key: '125f72d957bdc715f1f870873385cb70e1090ca3', iconName: "xmark", variants: "icon", onButtonClick: () => this.irDialog.closeModal() })), h("section", { key: 'dd127d63f3a3f0d54cdbb5aaa8f5cda37e5fda30', class: "max-h-[80vh]" }, images.length > 0 && (h("div", { key: 'bf83e0876b861f3883783017e8517ad475bbb75f', class: "coursel_gallery_container hidden sm:block" }, h("ir-carousel", { enableCarouselSwipe: true, activeIndex: this.activeIndex, dir: app_store.dir, key: ((_m = this.roomType) === null || _m === void 0 ? void 0 : _m.id) + '_' + app_store.dir, slides: images === null || images === void 0 ? void 0 : images.map(img => {
                var _a;
                return ({
                    alt: formatImageAlt(img.tooltip, (_a = this.roomType) === null || _a === void 0 ? void 0 : _a.name),
                    id: v4(),
                ...
                e.stopPropagation();
            } }))), this.property_state === 'carousel' && (h("section", { key: '4b2e328807e213c94f027b8f33ae601f531b22bb', class: 'z-0 py-4 text-sm', dir: app_store.dir }, h("ir-room-type-amenities", { key: 'aa4be17ae943dcafaa5ac8a1c9d9691c5d15a510', aminities: (_o = app_store.property) === null || _o === void 0 ? void 0 : _o.amenities, roomType: this.roomType }))))))));
    }
