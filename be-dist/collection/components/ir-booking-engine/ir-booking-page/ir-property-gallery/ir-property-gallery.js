...
export class IrPropertyGallery {
    ...
    render() {
        ...
        return (h("div", { key: 'c03dd72e7abaa036c3c68e87e5ab4a4635cecbb5' }, this.property_state === 'gallery' ? (h("ir-gallery", { totalImages: (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.images.length, images: (_d = (_c = app_store.property) === null || _c === void 0 ? void 0 : _c.images) === null || _d === void 0 ? void 0 : _d.map(i => ({ url: i.url, alt: formatImageAlt(i.tooltip) })), maxLength: 5, disableCarouselClick: true, enableCarouselSwipe: true })) : (h(Fragment, null, h("div", { class: "flex flex-wrap items-center gap-2 py-2 text-sm font-normal text-gray-700 md:hidden" }, h("ir-accomodations", { bookingAttributes: {
            ...
            }) })), this.showPlanLimitations({ showMoreTag: true, withRoomSize: true })), h("div", { class: "hidden  md:block" }, h("div", { class: "carousel-container relative mb-1 w-full rounded-md md:max-h-[200px] md:w-auto xl:max-h-[250px] " }, this.roomType.images.length === 0 ? (h(Fragment, null, h("div", { onClick: () => this.irDialog.openModal(), class: "gallery-img icon hover:bg-gray-400" }, h("ir-icons", { name: "image", svgClassName: "size-10 mb-4" })), this.showPlanLimitations({ showMoreTag: true, withRoomSize: true }))) : ((_j = this.roomType.images) === null || _j === void 0 ? void 0 : _j.length) === 1 ? (h(Fragment, null, h("img", { onClick: () => this.irDialog.openModal(), src: this.roomType.images[0].url, alt: formatImageAlt(this.roomType.images[0].tooltip, (_k = this.roomType) === null || _k === void 0 ? void 0 : _k.name), class: "h-full w-full cursor-pointer rounded-[var(--radius,8px)] object-cover " }), this.showPlanLimitations({ showMoreTag: true, withRoomSize: true }))) : (h(Fragment, null, h("ir-carousel", { onCarouselImageIndexChange: e => (this.activeIndex = e.detail), slides: (_l = this.roomType.images) === null || _l === void 0 ? void 0 : _l.map(img => {
                var _a;
                return ({
                    alt: formatImageAlt(img.tooltip, (_a = this.roomType) === null || _a === void 0 ? void 0 : _a.name),
                    id: v4(),
            ...
            }) }), this.showPlanLimitations({ showMoreTag: true, withRoomSize: true }))))))), h("ir-dialog", { key: '501f500372f3eece6487a3dd4e4b4df2440e597e', ref: el => (this.irDialog = el), closeButton: false }, h("div", { key: 'bc9c2eed804294aff44b46be95a08384c119bf97', slot: "modal-body", class: "modal-container max-h-[80vh] overflow-y-auto px-4 pb-4  pt-0 md:p-4 md:pt-0", dir: "ltr" }, h("div", { key: 'c7cd7e79136a91b82b7c55ca1a1d9492e98ee8ff', class: " sticky top-0 z-50 mb-2 flex w-full  items-center justify-between bg-white py-2 md:pt-4", dir: app_store.dir }, h("h2", { key: '0d7c64e5dd9c27a7dc900966c4af967b263dcd09', class: "text-lg font-semibold md:text-xl" }, this.property_state === 'carousel' ? this.roomType.name : (_m = app_store.property) === null || _m === void 0 ? void 0 : _m.name), h("ir-button", { key: '61406f91d1094f492bc94d9b6cc0255085ad85a2', iconName: "xmark", variants: "icon", onButtonClick: () => this.irDialog.closeModal() })), h("section", { key: '99785f8819b0069a897f58eb2712a3ab16a41886', class: "max-h-[80vh]" }, images.length > 0 && (h("div", { key: '827a1996c7addd59b4e8effd08b6b032ec4854d9', class: "coursel_gallery_container hidden sm:block" }, h("ir-carousel", { enableCarouselSwipe: true, activeIndex: this.activeIndex, dir: app_store.dir, key: ((_o = this.roomType) === null || _o === void 0 ? void 0 : _o.id) + '_' + app_store.dir, slides: images === null || images === void 0 ? void 0 : images.map(img => {
                var _a;
                return ({
                    alt: formatImageAlt(img.tooltip, (_a = this.roomType) === null || _a === void 0 ? void 0 : _a.name),
                    id: v4(),
                ...
                e.stopPropagation();
            } }), this.showPlanLimitations({ showMoreTag: false, withRoomSize: false }))), this.property_state === 'carousel' && (h("section", { key: '1e9eb784d3bb655705a64e1f91071a70e7a30a59', class: 'z-0 py-4 text-sm', dir: app_store.dir }, h("ir-room-type-amenities", { key: '2149efa89d4b2c5823ed3484ce95c4fba8f6f6cb', aminities: (_p = app_store.property) === null || _p === void 0 ? void 0 : _p.amenities, roomType: this.roomType }))))))));
    }
