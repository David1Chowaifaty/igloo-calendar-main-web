...
export class IrPropertyGallery {
    ...
    render() {
        ...
        return (h("div", { key: 'e54a7b1bd2cd81447b45e94916da053d8c7a7cef' }, this.property_state === 'gallery' ? (h("ir-gallery", { totalImages: (_b = app_store.property) === null || _b === void 0 ? void 0 : _b.images.length, images: (_d = (_c = app_store.property) === null || _c === void 0 ? void 0 : _c.images) === null || _d === void 0 ? void 0 : _d.map(i => ({ url: i.url, alt: i.tooltip })).slice(0, 5) })) : (h(Fragment, null, h("div", { class: "flex flex-wrap items-center gap-2 py-2 text-sm font-normal text-gray-700 md:hidden" }, h("ir-accomodations", { bookingAttributes: {
                ...
                id: v4(),
                image_uri: img.url,
            })) }), this.showPlanLimitations()))), h("ir-button", { onButtonClick: () => this.irDialog.openModal(), variants: "link", label: localizedWords.entries.Lcz_MoreDetails, class: "more-details-button", buttonStyles: { paddingLeft: '0', paddingBottom: '0', background: 'transparent', fontSize: '12px' } })))), h("ir-dialog", { key: 'd3bc911d2c660c0f7a7b4c77d7c2fa7262af2971', ref: el => (this.irDialog = el), closeButton: false }, h("div", { key: 'b2d957f39553f9981ccbb3d18cb0c6dfe2c88568', slot: "modal-body", class: "modal-container max-h-[80vh] overflow-y-auto px-4 pb-4  pt-0 md:p-4 md:pt-0", dir: "ltr" }, h("div", { key: '06c5195fe714caba28548d52fd63af67def46290', class: " sticky top-0 z-50 mb-2 flex w-full  items-center justify-between bg-white py-2 md:pt-4", dir: app_store.dir }, h("h2", { key: '7c716ce3c76367a25926532ae8ce4789e3c5635a', class: "text-lg font-semibold md:text-xl" }, this.property_state === 'carousel' ? this.roomType.name : (_k = app_store.property) === null || _k === void 0 ? void 0 : _k.name), h("ir-button", { key: '206ec7d8a05f0ed03b9572594ba9357303820b41', iconName: "xmark", variants: "icon", onButtonClick: () => this.irDialog.closeModal() })), h("section", { key: 'c099c92d2210c7f6298b31879304f83603f5495c', class: "max-h-[80vh]" }, images.length > 0 && (h("div", { key: 'b7e675c8e54c998a43097a7e62c2ec82054c9ed9', class: "coursel_gallery_container hidden sm:block" }, h("ir-carousel", { dir: app_store.dir, key: ((_l = this.roomType) === null || _l === void 0 ? void 0 : _l.id) + '_' + app_store.dir, slides: images === null || images === void 0 ? void 0 : images.map(img => ({
                alt: img.tooltip,
                id: v4(),
                image_uri: img.url,
                ...
                e.stopPropagation();
            } }), this.showPlanLimitations(false))), this.property_state === 'carousel' && (h("section", { key: '9109b8075da23ff50039c5f5a8bbc77fc4e6051b', class: 'z-0 py-4 text-sm', dir: app_store.dir }, h("ir-room-type-amenities", { key: 'fda517f6089521de9cdac44dd7b5738ef60265e4', aminities: (_m = app_store.property) === null || _m === void 0 ? void 0 : _m.amenities, roomType: this.roomType }))))))));
    }
