...
export class IrAccomodations {
    ...
    render() {
        var _a, _b, _c;
        return (h("div", { key: '9f2d9ee78b04309e5f9170af3cda3912fd4ecf97', class: "space-y-2 pb-2 text-xs font-normal text-gray-700" }, ((_a = this.bookingAttributes) === null || _a === void 0 ? void 0 : _a.bedding_setup.length) > 0 && (h("div", { key: '5308de141826cdaa51241ccba82b6f5829058388', class: "flex flex-wrap items-center gap-2.5" }, h("ir-icons", { key: 'ade223cbaddd0df405e2057f396f1267ffd0f791', name: "bed" }), h("div", { key: 'df0337144d8d23a79f5d938d647712ead6077e41', class: "flex items-center" }, (_c = (_b = this.bookingAttributes) === null || _b === void 0 ? void 0 : _b.bedding_setup) === null || _c === void 0 ? void 0 : _c.map((bed_setup, index) => (h("p", { key: bed_setup.code }, bed_setup.name, " ", index < this.bookingAttributes.bedding_setup.length - 1 && h("span", null, "-\u00A0"))))))), this.renderAmeneties()));
    }
