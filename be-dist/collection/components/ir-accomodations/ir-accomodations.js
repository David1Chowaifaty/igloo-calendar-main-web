...
export class IrAccomodations {
    ...
    render() {
        var _a, _b, _c;
        return (h("div", { key: '3745220772ff6932968710850d1de745bba7e06d', class: "text-gray-700 space-y-2 font-normal text-sm" }, ((_a = this.bookingAttributes) === null || _a === void 0 ? void 0 : _a.bedding_setup.length) > 0 && (h("div", { class: "flex items-center gap-2 flex-wrap" }, h("ir-icons", { name: "bed" }), ' ', (_c = (_b = this.bookingAttributes) === null || _b === void 0 ? void 0 : _b.bedding_setup) === null || _c === void 0 ? void 0 :
            _c.map((bed_setup, index) => (h("p", { key: bed_setup.code }, bed_setup.name, " ", index < this.bookingAttributes.bedding_setup.length - 1 && h("span", null, " - ")))))), this.renderAmeneties()));
    }
