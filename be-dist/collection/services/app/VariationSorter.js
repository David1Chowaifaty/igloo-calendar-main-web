export class VariationSorter {
    ...
    mergeSort(items, maxAdults, maxChildren) {
        if (items.length <= 1) {
            return items;
        }
    ...
    merge(left, right, maxAdults, maxChildren) {
    ...
    compareVariations(a, b, maxAdults, maxChildren) {
...
//# sourceMappingURL=VariationSorter.js.map
