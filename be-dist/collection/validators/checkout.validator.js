...
export const ZCreditCardSchema = z
    ...
    const cardType = Object.keys(cardNumberPatterns).find(type => cardNumberPatterns[type].test(data.cardNumber));
    if (cardType && !cvcPatterns[cardType].test(data.cvc)) {
        ctx.addIssue({
            code: 'custom',
            path: ['cvc'],
            message: "'Invalid CVC",
...
//# sourceMappingURL=checkout.validator.js.map
