...
const IrTextarea = class {
    ...
    render() {
        return (index.h("textarea", { key: 'e57bbbb215573ed1e0cdfb5c5d285ede12a2abdd', name: this.name, autoFocus: this.autofocus, disabled: this.disabled, value: this.value, class: this.error ? 'error' : '', id: this.inputId, onFocus: e => this.inputFocus.emit(e), onBlur: e => this.inputBlur.emit(e), onInput: e => this.textChanged.emit(e.target.value) }));
    }
};
