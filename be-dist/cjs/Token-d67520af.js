...
const utils$3 = require('./utils-145d3901.js');
                ...
                if (rp.reserved > 0) {
                    [...new Array(rp.reserved)].map((_, index) => {
                        ...
                        rooms.push({
                            ...
                            notes: null,
                            days: this.propertyHelpers.generateDays(utils$3.booking_store.bookingAvailabilityParams.from_date, utils$3.booking_store.bookingAvailabilityParams.to_date, Number(rp.checkoutVariations[index].discounted_amount) /
                                utils$3.getDateDifference(utils$3.booking_store.bookingAvailabilityParams.from_date, utils$3.booking_store.bookingAvailabilityParams.to_date)),
                            guest: {
                                email: null,
                                first_name,
                                last_name,
...
//# sourceMappingURL=Token-d67520af.js.map