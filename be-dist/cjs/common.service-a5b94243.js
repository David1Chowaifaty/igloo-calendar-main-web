...
class PaymentService {
    ...
    async GeneratePaymentCaller({ token, params, onRedirect, onScriptRun, }) {
        ...
        const { data } = await axios$1.post(`/Generate_Payment_Caller`, Object.assign(Object.assign({}, params), { callback_url: `https://${utils$3.app_store.property.perma_link}.bookingmystay.com/invoice` }));
        if (data['ExceptionMsg'] !== '') {
            throw new Error(data.ExceptionMsg);
        }
        const res = data['My_Result'];
...
//# sourceMappingURL=common.service-a5b94243.js.map