...
const Token = require('./Token-2248a01e.js');
...
const IrBookingWidget = class {
    ...
    async handlePropertyChange(newValue, oldValue) {
        ...
        const [property] = await Promise.all([
            ...
            this.propertyService.getExposedNonBookableNights({
                ...
                from_date: utils.moment().format('YYYY-MM-DD'),
                to_date: utils.moment().add(1, 'years').format('YYYY-MM-DD'),
                perma_link: null,
                aname: null,
            }),
        ]);
    ...
    hasDisabledDateInRange(from, to, dateModifiers) {
        ...
        if (!from || !to || !dateModifiers)
            return false;
        const cursor = utils.moment(from);
        const end = utils.moment(to);
    ...
    getDateModifiers() {
        var _a, _b, _c;
        if (!((_b = Object.keys((_a = utils.app_store === null || utils.app_store === void 0 ? void 0 : utils.app_store.nonBookableNights) !== null && _a !== void 0 ? _a : {})) === null || _b === void 0 ? void 0 : _b.length)) {
            return undefined;
        }
        const nights = {};
        (_c = Object.keys(utils.app_store === null || utils.app_store === void 0 ? void 0 : utils.app_store.nonBookableNights)) === null || _c === void 0 ? void 0 : _c.forEach(nbn => {
            nights[nbn] = {
                disabled: true,
            };
        });
    ...
    renderMultiWidget() {
        var _a;
        return (index.h("ir-multi-property-widget", { isFetchingProperty: this.isFetchingProperty, selectedCity: this.selectedCity, level2Properties: this.level2Properties, linkedProperties: this.linkedProperties, selectedPropertyId: (_a = this.selectedProperty) === null || _a === void 0 ? void 0 : _a.id, dateModifiers: this.dateModifiers, property: this.selectedProperty, locale: utils.app_store.selectedLocale, dates: this.dates, guests: this.guests, error: this.error, position: this.position, exportparts: "container, property-select, cta", onCityChange: e => {
    ...
    render() {
        ...
        if (this.isLevel2Mode) {
            ...
            return (index.h("ir-popup", { sync: "width", ref: el => (this.mainWidgetPopupRef = el), distance: -45, class: "ir-multi-property-widget__popup" }, index.h("ir-button", { slot: "anchor", part: "anchor", size: "md", class: "ir-multi-property-widget__anchor", label: localization_store.localizedWords.entries.Lcz_BookNow }), index.h("header", { class: "ir-multi-property-widget__header", part: "header" }, index.h("h5", null, localization_store.localizedWords.entries.Lcz_BookNow), index.h("ir-button", { onButtonClick: e => {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    this.mainWidgetPopupRef.close();
                }, iconName: "xmark", variants: "icon" })), this.renderMultiWidget()));
        }
        return (index.h(index.Host, { "data-multi": this.isMultiProperties ? 'true' : 'false' }, index.h("div", { part: "container", class: "ir-widget", "data-multi": this.isMultiProperties ? 'true' : 'false', ref: el => (this.containerRef = el) }, index.h("div", { part: "hover", class: 'ir-widget__hover' }), this.isMultiProperties && (index.h("select", { part: "property-select", class: "ir-widget__property-select", onChange: e => {
                const propertyId = e.target.value;
                this.selectedProperty = this.linkedProperties.find(p => p.id.toString() === propertyId);
            } }, this.linkedProperties.map(property => (index.h("option", { selected: this.selectedProperty.id.toString() === property.id.toString(), value: property.id }, property.name))))), index.h(index.Fragment, null, index.h("ir-widget-date-popup", { class: "ir-widget__date-popup", dateModifiers: this.dateModifiers, exportparts: "date-trigger", dates: this.dates, locale: utils.app_store.selectedLocale, maxSpanDays: (_a = this.property) === null || _a === void 0 ? void 0 : _a.max_nights, onDateChange: e => {
                this.dates = e.detail;
            } }), index.h("ir-widget-occupancy-popup", { exportparts: "guests-trigger", class: "ir-widget__guests-popup", error: this.error, guests: this.guests, property: this.property, onGuestsChange: e => (this.guests = Object.assign({}, e.detail)) })), index.h("button", { part: "cta", class: "ir-widget__cta", onClick: this.handleBooknow.bind(this) }, this.isMultiProperties ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: 24, width: 24, viewBox: "0 0 640 640" }, index.h("path", { fill: "currentColor", d: "M480 272C480 317.9 465.1 360.3 440 394.7L566.6 521.4C579.1 533.9 579.1 554.2 566.6 566.7C554.1 579.2 533.8 579.2 521.3 566.7L394.7 440C360.3 465.1 317.9 480 272 480C157.1 480 64 386.9 64 272C64 157.1 157.1 64 272 64C386.9 64 480 157.1 480 272zM272 416C351.5 416 416 351.5 416 272C416 192.5 351.5 128 272 128C192.5 128 128 192.5 128 272C128 351.5 192.5 416 272 416z" }))) : (localization_store.localizedWords.entries.Lcz_BookNow)))));
    }
