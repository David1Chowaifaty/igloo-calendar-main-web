...
const IrBookingWidget = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: "booking-widget-container", style: this.contentContainerStyle }, index.h("div", { class: 'hovered-container' }), index.h("ir-popover", { allowFlip: false, class: 'ir-popover', showCloseButton: false, placement: this.position === 'fixed' ? 'top-start' : 'auto', ref: el => (this.popover = el), onOpenChange: e => {
