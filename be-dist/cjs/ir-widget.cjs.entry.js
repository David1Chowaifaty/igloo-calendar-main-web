...
const Token = require('./Token-b0bb26b1.js');
...
const IrBookingWidget = class {
    ...
    renderDateTrigger() {
        ...
        return (index.h("div", { class: "date-trigger", slot: "trigger" }, index.h("ir-icons", { name: "calendar", svgClassName: "size-4" }), fromLabel && toLabel ? (index.h("div", null, index.h("p", null, index.h("span", null, fromLabel), index.h("span", null, " - "), index.h("span", null, toLabel)))) : (index.h("div", null, index.h("p", null, "Your dates")))));
    }
