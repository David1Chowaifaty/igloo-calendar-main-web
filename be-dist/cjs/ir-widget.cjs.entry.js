...
const common_service = require('./common.service-aefa20b9.js');
...
const IrBookingWidget = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: "booking-widget-container", style: this.contentContainerStyle }, index.h("div", { class: 'hovered-container' }), index.h("ir-popover", { class: 'ir-popover', showCloseButton: false, placement: "auto", ref: el => (this.popover = el), onOpenChange: e => {
            ...
            } }))), index.h("ir-popover", { ref: el => (this.guestPopover = el), class: 'ir-popover', showCloseButton: false, placement: "auto" }, this.renderAdultChildTrigger(), index.h("ir-guest-counter", { slot: "popover-content", adults: (_c = this.guests) === null || _c === void 0 ? void 0 : _c.adultCount, child: (_d = this.guests) === null || _d === void 0 ? void 0 : _d.childrenCount, minAdultCount: 0, maxAdultCount: (_e = utils.app_store === null || utils.app_store === void 0 ? void 0 : utils.app_store.property) === null || _e === void 0 ? void 0 : _e.adult_child_constraints.adult_max_nbr, maxChildrenCount: (_f = utils.app_store === null || utils.app_store === void 0 ? void 0 : utils.app_store.property) === null || _f === void 0 ? void 0 : _f.adult_child_constraints.child_max_nbr, childMaxAge: (_g = utils.app_store.property) === null || _g === void 0 ? void 0 : _g.adult_child_constraints.child_max_age, onUpdateCounts: e => (this.guests = e.detail), class: 'h-full', onCloseGuestCounter: () => this.guestPopover.toggleVisibility() })), index.h("button", { class: "btn-flip", onClick: this.handleBooknow.bind(this) }, "Book now"))));
    }
