...
const IrBookingWidget = class {
    ...
    renderAdultChildTrigger() {
        const { adultCount, childrenCount } = this.guests;
        return (index.h("div", { class: "guests-trigger", slot: "trigger" }, index.h("ir-icons", { name: "user", svgClassName: "size-4" }), index.h("p", { class: 'guests' }, adultCount > 0 ? (index.h(index.Fragment, null, index.h("span", null, adultCount, " ", adultCount === 1 ? utils.localizedWords.entries.Lcz_Adult : utils.localizedWords.entries.Lcz_Adults), index.h("span", null, ", ", childrenCount, " ", childrenCount === 1 ? utils.localizedWords.entries.Lcz_Child : utils.localizedWords.entries.Lcz_Children))) : (index.h("span", null, "Guests")))));
    }
    render() {
