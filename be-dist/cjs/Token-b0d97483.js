...
const utils$3 = require('./utils-9986c511.js');
...
class PaymentService {
    async getExposedCancelationDueAmount(params) {
        const { data } = await axios$1.post(`/Get_Exposed_Cancelation_Due_Amount`, Object.assign({}, params));
    ...
    async GeneratePaymentCaller({ token, params, onRedirect, onScriptRun, }) {
        ...
        const { data } = await axios$1.post('/Generate_Payment_Caller', Object.assign(Object.assign({}, params), { callback_url: `https://${utils$3.app_store.property.perma_link}.bookingmystay.com/invoice` }), { headers: { Authorization: token } });
        if (data['ExceptionMsg'] !== '') {
            throw new Error(data.ExceptionMsg);
        }
        const res = data['My_Result'];
    ...
    async RequestBookingCancelation(booking_nbr) {
        const { data } = await axios$1.post(`/Request_Booking_Cancelation`, { BOOK_NBR: booking_nbr });
        if (data['ExceptionMsg'] !== '') {
            throw new Error(data.ExceptionMsg);
        }
    ...
    async GetExposedApplicablePolicies({ params, book_date, }) {
        const { data } = await axios$1.post(`/Get_Exposed_Applicable_Policies`, params);
        if (data['ExceptionMsg'] !== '') {
            throw new Error(data.ExceptionMsg);
        }
    ...
    processAlicablePolicies(policies, book_date) {
        ...
        let cancelation = policies.find(po => { var _a; return po.type === 'cancelation' && ((_a = po === null || po === void 0 ? void 0 : po.brackets) === null || _a === void 0 ? void 0 : _a.some(b => utils$3.dateFns.isBefore(book_date, new Date(b.due_on)) || utils$3.dateFns.isSameDay(new Date(b.due_on), book_date), book_date)); });
        if (cancelation) {
            isInFreeCancelationZone = true;
            const cancelationAmount = (_d = (_c = cancelation.brackets.find(b => utils$3.dateFns.isBefore(book_date, new Date(b.due_on)) || utils$3.dateFns.isSameDay(new Date(b.due_on), book_date))) === null || _c === void 0 ? void 0 : _c.gross_amount) !== null && _d !== void 0 ? _d : null;
...
class PropertyHelpers {
    ...
    async fetchAvailabilityData(props, roomtypeIds, rateplanIds) {
        const response = await axios$1.post(`/Get_Exposed_Booking_Availability`, Object.assign(Object.assign({}, props.params), { identifier: props.identifier, room_type_ids: roomtypeIds, rate_plan_ids: rateplanIds, skip_getting_assignable_units: true, is_specific_variation: true, is_backend: false }));
    ...
    async bookUser() {
        ...
        try {
            ...
            const body = {
                ...
                is_pms: false,
                is_direct: true,
                language: ((_f = utils$3.app_store === null || utils$3.app_store === void 0 ? void 0 : utils$3.app_store.userPreferences) === null || _f === void 0 ? void 0 : _f.language_id) || 'en',
                ...
                promo_key: (_g = utils$3.booking_store.bookingAvailabilityParams.coupon) !== null && _g !== void 0 ? _g : null,
                booking: {
                    booking_nbr: '',
                    from_date: utils$3.dateFns.format(utils$3.booking_store.bookingAvailabilityParams.from_date, 'yyyy-MM-dd'),
                    to_date: utils$3.dateFns.format(utils$3.booking_store.bookingAvailabilityParams.to_date, 'yyyy-MM-dd'),
...
//# sourceMappingURL=Token-b0d97483.js.map