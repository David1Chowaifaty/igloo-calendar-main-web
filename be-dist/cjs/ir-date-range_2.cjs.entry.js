...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'c46c5a9081e53869dcb721b6b3870ffd6aa2d7a4' }, this.isMobile && (index.h("div", { class: "w-full md:hidden" }, index.h("div", { class: "w-full", onClick: () => {
