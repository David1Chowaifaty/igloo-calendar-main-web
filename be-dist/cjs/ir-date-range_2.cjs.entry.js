...
const IrDateRange = class {
    constructor(hostRef) {
        ...
        this.fromDate = null;
        this.toDate = null;
        this.minDate = index$1.dateFns.addYears(new Date(), -24);
        this.maxDate = index$1.dateFns.addYears(new Date(), 24);
    ...
    componentWillLoad() {
        ...
        const nextMonth = index$1.dateFns.addMonths(currentMonth, 1);
    ...
    handleFromDateChange(newValue, oldValue) {
        if (!index$1.dateFns.isSameDay(newValue || new Date(), oldValue || new Date())) {
    ...
    getMonthDays(month) {
        return {
            month,
            days: index$1.dateFns.eachDayOfInterval({
                start: index$1.dateFns.startOfWeek(index$1.dateFns.startOfMonth(month), { weekStartsOn: 1, locale: this.locale }),
                end: index$1.dateFns.endOfWeek(index$1.dateFns.endOfMonth(month), { weekStartsOn: 1, locale: this.locale }),
            }),
        };
    }
    decrementDate() {
        if (this.selectedDates.start && this.selectedDates.end) {
            this.selectedDates = {
                start: index$1.dateFns.addDays(new Date(this.selectedDates.start), -1),
    ...
    incrementDate() {
        if (this.selectedDates.start && this.selectedDates.end) {
            this.selectedDates = {
                ...
                end: index$1.dateFns.addDays(new Date(this.selectedDates.end), 1),
            };
        }
    }
    goToNextMonth(e) {
        ...
        const newSecondMonth = index$1.dateFns.addMonths(currentSecondMonth, 1);
        if (index$1.dateFns.isBefore(index$1.dateFns.endOfMonth(newSecondMonth), this.minDate) || index$1.dateFns.isAfter(index$1.dateFns.startOfMonth(newSecondMonth), this.maxDate)) {
            return;
        }
    ...
    goToPreviousMonth(e) {
        ...
        const newFirstMonth = index$1.dateFns.addMonths(currentFirstMonth, -1);
        if (index$1.dateFns.isBefore(index$1.dateFns.endOfMonth(newFirstMonth), this.minDate) || index$1.dateFns.isAfter(index$1.dateFns.startOfMonth(newFirstMonth), this.maxDate)) {
            return;
        }
        this.displayedDaysArr = [this.getMonthDays(newFirstMonth), this.displayedDaysArr[0]];
    }
    selectDay(day) {
        if (index$1.dateFns.isSameDay(new Date(this.selectedDates.start), new Date(day)) || index$1.dateFns.isSameDay(new Date(this.selectedDates.end), new Date(day))) {
            ...
            if (this.selectedDates.start === null) {
                ...
                if (this.selectedDates.end === null) {
                    if (index$1.dateFns.isBefore(day, this.selectedDates.start)) {
                        this.selectedDates = { start: day, end: null };
                    }
                    else {
    ...
    isDaySelected(day) {
        ...
        if (this.selectedDates.start && !this.selectedDates.end && this.hoveredDate && index$1.dateFns.isAfter(this.hoveredDate, start)) {
            if (index$1.dateFns.isAfter(date, start) && index$1.dateFns.isBefore(date, end)) {
                return true;
            }
        }
        else if (index$1.dateFns.isAfter(date, start) && this.selectedDates.end && index$1.dateFns.isBefore(date, end)) {
            return true;
        }
        return false;
    }
    getMonthStyles(index) {
        if (index === 0) {
            if (!index$1.dateFns.isAfter(index$1.dateFns.startOfMonth(this.displayedDaysArr[0].month), this.minDate)) {
                return 'margin-horizontal';
            }
            return 'margin-right';
        }
        else {
            if (!index$1.dateFns.isBefore(index$1.dateFns.endOfMonth(this.displayedDaysArr[1].month), this.maxDate)) {
    ...
    checkDatePresence(day) {
        ...
        const formatedDate = index$1.dateFns.format(day, 'yyyy-MM-dd');
    ...
    render() {
        return (index.h("div", { key: '907807a035371a07a9cbf870bc1c3eee9ec6d950', class: 'date-picker' }, this.displayedDaysArr.map((month, index$2) => (index.h("table", { class: "calendar ", role: "grid" }, index.h("thead", null, index.h("tr", { class: "calendar-header" }, index.h("th", { colSpan: 7 }, index.h("div", { class: "month-navigation" }, index$2 === 0 && index$1.dateFns.isAfter(index$1.dateFns.startOfMonth(this.displayedDaysArr[0].month), this.minDate) && (index.h("button", { name: "previous month", class: "navigation-buttons previous-month", type: "button", onClick: this.goToPreviousMonth.bind(this) }, index.h("p", { class: "sr-only" }, "previous month"), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, index.h("path", { fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" })))), index.h("span", null, index$1.dateFns.format(month.month, 'MMMM yyyy', { locale: this.locale })), index$2 === 0 && (index.h("button", { name: "next month", class: "navigation-buttons button-next", type: "button", onClick: this.goToNextMonth.bind(this) }, index.h("p", { slot: "icon", class: "sr-only" }, "next month"), index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, index.h("path", { d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), index$2 === 1 && index$1.dateFns.isBefore(index$1.dateFns.endOfMonth(this.displayedDaysArr[1].month), this.maxDate) && (index.h("button", { name: "next month", class: "navigation-buttons button-next-main", type: "button", onClick: this.goToNextMonth.bind(this) }, index.h("p", { class: "sr-only " }, "next month"), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, index.h("path", { fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" }))))))), index.h("tr", { class: "weekday-header", role: "row" }, this.weekdays.map(weekday => (index.h("th", { class: "weekday-name", key: weekday }, weekday))))), index.h("tbody", { class: "days-grid" }, month.days
            ...
            return (index.h("td", { class: "day-cell", key: index$1.dateFns.format(day, 'yyyy-MM-dd'), role: "gridcell" }, index$1.dateFns.isSameMonth(day, month.month) && (index.h("button", { disabled: index$1.dateFns.isBefore(day, this.minDate) || index$1.dateFns.isAfter(day, this.maxDate) || (checkedDate === null || checkedDate === void 0 ? void 0 : checkedDate.disabled), onMouseEnter: () => this.handleMouseEnter(day), onMouseLeave: () => this.handleMouseLeave(), onClick: e => {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    this.selectDay(day);
                }, "aria-label": `${index$1.dateFns.format(day, 'EEEE, MMMM do yyyy', { locale: this.locale })} ${index$1.dateFns.isBefore(day, this.minDate) || index$1.dateFns.isAfter(day, this.maxDate) ? 'Not available' : ''}`, "aria-disabled": index$1.dateFns.isBefore(day, this.minDate) || index$1.dateFns.isAfter(day, this.maxDate) || (checkedDate === null || checkedDate === void 0 ? void 0 : checkedDate.disabled) ? 'true' : 'false', "aria-selected": (this.selectedDates.start && index$1.dateFns.isSameDay(new Date(this.selectedDates.start), new Date(day))) ||
                    this.isDaySelected(day) ||
                    (this.selectedDates.end && index$1.dateFns.isSameDay(new Date((_a = this.selectedDates.end) !== null && _a !== void 0 ? _a : new Date()), new Date(day))), class: `day-button  ${this.selectedDates.start && index$1.dateFns.isSameDay(new Date(this.selectedDates.start), new Date(day)) ? 'day-range-start' : ''}
                          ${this.selectedDates.end && index$1.dateFns.isSameDay(new Date((_b = this.selectedDates.end) !== null && _b !== void 0 ? _b : new Date()), new Date(day)) ? 'day-range-end' : ''}  
                            ${this.isDaySelected(day) ? 'highlight' : ''}
                            ` }, index.h("p", { class: `day ${index$1.dateFns.isToday(day) ? 'current-date' : ''}` }, index$1.dateFns.format(day, 'd', { locale: this.locale })), this.showPrice && index.h("p", { class: "price" }, (checkedDate === null || checkedDate === void 0 ? void 0 : checkedDate.withPrice.price) ? '_' : checkedDate.withPrice.price)))));
        }))))))))));
    }
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '17d780f16bb26d386a7139f1aee84c963c8745d5' }, this.isMobile && (index.h("div", { key: '2e9aee5077c96951b214b60290dae861e5c21e54', class: "w-full md:hidden" }, index.h("div", { key: '1504c97fe2033c4566261ff3af286c1d3a61c2fe', class: "w-full", onClick: () => {
                this.dialogElement.openModal();
            } }, index.h("slot", { key: '8e321b3d7353f1c7bb76c769cdd52eeedbdca933', name: "trigger" })), index.h("ir-dialog", { key: '8ec59fa9ea28c83063c8d3b775d1205fd538907d', closeButton: this.showCloseButton, ref: el => (this.dialogElement = el), onOpenChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isDialogOpen = e.detail;
                this.openChange.emit(e.detail);
            } }, index.h("div", { key: 'fb42e3e6d31bb16af7c2d0b3d624e1217fb06bd7', slot: "modal-body" }, index.h("slot", { key: '5003bdefe35e08f60624c1b3becbd2eca80ef828', name: "popover-content" }))))), !this.isMobile && (index.h("div", { key: 'aec2d470eabcc876b5066c687c6b5993a472c744', class: "hidden sm:block" }, index.h("div", { key: '97a8073723da26d1bd0d338eb1765927a3efc227', ref: el => (this.triggerElement = el), onClick: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.toggleVisibility();
            } }, index.h("slot", { key: '177537434a3ac8c850b5fe9405f9ee76d257f180', name: "trigger" }, index.h("button", { key: '8dd5bc7f816c1c41fdd95ea1729cacd8a9a17287', class: "trigger" }, index.h("span", { key: 'b294e726868916a5e22713f7f18733ce4689c58f' }, this.trigger_label), index.h("svg", { key: '3ade871e954ac6be4e2bd5eb75b8f098023dfd4c', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '9bf8a4153cfa0a18cf2f3d75857bdf58e9e4d516', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), index.h("div", { key: '73949e6f0b859cf577452f7ea44aa707456ae4ad', class: "popover-content", ref: el => (this.contentElement = el) }, this.isVisible && (index.h("div", { key: '6d81588f4873c6ee75e8629e763bfe8ad4bfe26f' }, index.h("slot", { key: '6e0a1bde25cf9b7da6b661ec7938860b283b65c3', name: "popover-content" }))))))));
    }
...
//# sourceMappingURL=ir-date-range_2.cjs.entry.js.map