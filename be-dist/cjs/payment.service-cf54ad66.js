...
class PaymentService {
    ...
    async GeneratePaymentCaller({ token, params, onRedirect, onScriptRun, }) {
        ...
        const { data } = await axios.axios.post(`/Generate_Payment_Caller`, Object.assign(Object.assign({}, params), { callback_url: `https://${localization_store.app_store.property.perma_link}.bookingmystay.com/invoice` }));
        if (data['ExceptionMsg'] !== '') {
            throw new Error(data.ExceptionMsg);
        }
        const res = data['My_Result'];
...
//# sourceMappingURL=payment.service-cf54ad66.js.map