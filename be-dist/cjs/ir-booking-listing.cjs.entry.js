...
const common_service = require('./common.service-995efeb6.js');
const bookingListing_service = require('./booking-listing.service-01c56091.js');
...
class BookingListingService extends common_service.Token {
    async getExposedGuestBookings(params) {
        ...
        const { data } = await common_service.axios.post(`/Get_Exposed_Guest_Bookings?Ticket=${token}`, params);
...
const IrBookingListing = class {
    ...
    async componentWillLoad() {
        ...
        if (isAuthenticated) {
            ...
            if (token) {
                utils.app_store.app_data.token = token;
            }
            // this.initializeServices();
            // this.initializeApp();
        }
        ...
        try {
            ...
            let requests = [
                this.propertyService.getExposedProperty({
                    id: this.propertyid,
                    language: ((_a = utils.app_store.userPreferences) === null || _a === void 0 ? void 0 : _a.language_id) || 'en',
                    aname: this.aName,
