...
class BookingListingService extends property_service.Token {
    async getExposedGuestToken(property_id) {
        ...
        const { data } = await property_service.axios.post(`/Get_Exposed_Guest_Bookings?Ticket=${token}`, {
            property_id,
        });
