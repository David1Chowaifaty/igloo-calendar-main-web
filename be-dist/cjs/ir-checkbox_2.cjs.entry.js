...
const phone_store = require('./phone.store-289d3e99.js');
const popper = require('./popper-31badbf8.js');
require('./axios-bc0bd15c.js');
require('./index-ac85ebdb.js');
...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fcc2fbe2987b0e3bfa154902c525c84b3bb8a838' }, index.h("button", { key: '353d5b9e9c97a94dfddd22db33c96e218171be15', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'd3fa919722c645a4437d73b696c2310f388d5197', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'e86d49a37b10eca3086d9fc520d4408b0f300543', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: 'aa49424218bfc7bca7b0bc9fd27f7700418efde1', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: 'bc055401dff80a2d7a076738c95f9d5289ac79ec', htmlFor: this.checkboxId, class: "checkbox-label" }, this.label))));
    }
...
const IrPhoneInput = class {
    ...
    async initializeCountries() {
        if (phone_store.phone_input_store.countries.length === 0) {
            const requests = [this.commonService.getCountries(localization_store.app_store.userPreferences.language_id)];
            if (!this.country_code) {
                requests.push(this.setUpUserDefaultCountry());
            }
            const [countries] = await Promise.all(requests);
            phone_store.phone_input_store.countries = countries;
        }
        ...
        this.filteredCountries = phone_store.phone_input_store.countries;
    }
    ...
    selectCountryByProperty(property, value) {
        const selectedCountry = phone_store.phone_input_store.countries.find(c => c[property].toString() === value.toString());
        if (selectedCountry) {
            if (this.mode === 'country_code_and_prefix') {
                checkout_store.updateUserFormData('country_id', selectedCountry.id);
            }
            checkout_store.updateUserFormData('country_phone_prefix', selectedCountry.phone_prefix);
    ...
    async setUpUserDefaultCountry() {
        ...
        this.user_country = await this.commonService.getUserDefaultCountry({
            id: (_b = (_a = localization_store.app_store.app_data) === null || _a === void 0 ? void 0 : _a.property_id) === null || _b === void 0 ? void 0 : _b.toString(),
            aname: (_c = localization_store.app_store.app_data) === null || _c === void 0 ? void 0 : _c.aName,
            perma_link: (_d = localization_store.app_store.app_data) === null || _d === void 0 ? void 0 : _d.perma_link,
        });
    }
    initializePopover() {
        if (this.triggerElement && this.contentElement) {
            this.popoverInstance = popper.createPopper(this.triggerElement, this.contentElement, {
                placement: localization_store.app_store.dir === 'LTR' ? 'auto-start' : 'auto-end',
                modifiers: [
                    {
                        name: 'offset',
                        options: {
    ...
    async toggleVisibility() {
        ...
        if (this.isVisible && this.popoverInstance) {
            ...
            const currentDir = localization_store.app_store.dir.toLowerCase() || 'ltr';
    ...
    filterData(str) {
        if (str === '') {
            return (this.filteredCountries = [...phone_store.phone_input_store.countries]);
        }
        this.filteredCountries = [...phone_store.phone_input_store.countries.filter(d => d.name.toLowerCase().startsWith(str.trim()))];
    }
    ...
    render() {
        var _a, _b, _c;
        return (index.h("div", { key: '03b9cd12aff70972797f9ece7f18420a2c97b5a1', ref: el => (this.triggerElement = el), class: "phone-input-container" }, index.h("div", { key: 'a43a84e2d8c1f2a6691aaabf22769c5abab11fe3', class: `input-trigger ${this.error ? 'error' : ''}` }, index.h("div", { key: '876a2061cfbd4df226bb9fc30cc4223ca4f2d672', class: "input-section" }, index.h("label", { key: 'cad15ef0f05e98bc0dddffa90eff52870dd765dc', htmlFor: "country_picker" }, localization_store.localizedWords.entries.Lcz_Country), index.h("div", { key: '285afe38b0e470016aee87d01cbd1f539412ca91', id: "country_picker", onClick: () => {
                this.toggleVisibility();
            }, class: "input-subtrigger" }, this.selectedItem ? (index.h(index.Fragment, null, index.h("img", { loading: "lazy", src: (_a = this.selectedItem) === null || _a === void 0 ? void 0 : _a.flag, alt: (_b = this.selectedItem) === null || _b === void 0 ? void 0 : _b.name, class: "flag-icon" }), index.h("span", null, (_c = this.selectedItem) === null || _c === void 0 ? void 0 : _c.phone_prefix))) : (index.h("span", null, "Select")), index.h("svg", { key: 'a38b731165c48addc39f253a4d23a06d738c7f6a', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '80a257b9ae59bcb4ee89a68f3a51451e1545c077', d: "M4.93179 5.43179C4.75605 5.60753 4.75605 5.89245 4.93179 6.06819C5.10753 6.24392 5.39245 6.24392 5.56819 6.06819L7.49999 4.13638L9.43179 6.06819C9.60753 6.24392 9.89245 6.24392 10.0682 6.06819C10.2439 5.89245 10.2439 5.60753 10.0682 5.43179L7.81819 3.18179C7.73379 3.0974 7.61933 3.04999 7.49999 3.04999C7.38064 3.04999 7.26618 3.0974 7.18179 3.18179L4.93179 5.43179ZM10.0682 9.56819C10.2439 9.39245 10.2439 9.10753 10.0682 8.93179C9.89245 8.75606 9.60753 8.75606 9.43179 8.93179L7.49999 10.8636L5.56819 8.93179C5.39245 8.75606 5.10753 8.75606 4.93179 8.93179C4.75605 9.10753 4.75605 9.39245 4.93179 9.56819L7.18179 11.8182C7.35753 11.9939 7.64245 11.9939 7.81819 11.8182L10.0682 9.56819Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" })))), index.h("div", { key: 'be92dec2f18f5743fd7a2e051be680a04abca87a', class: "input-section" }, index.h("label", { key: '6e9a07e235438a4af1e631569c1f2e517e5d3458', htmlFor: "phone_number" }, localization_store.localizedWords.entries.Lcz_MobileNumber), index.h("input", { key: '3ded776d9fabf1ae97b1f287657d2a4efb94cfa0', type: "phone", ref: el => (this.phoneInput = el), onBlur: e => this.phoneInputBlur.emit(e), onFocus: e => this.phoneInputFocus.emit(e), onInput: e => this.handleInputChange(e), id: "phone_number", value: this.inputValue, class: "input-subtrigger" }))), index.h("div", { key: '6e1ef6d9e6174977b0ed282e264f034fe9c31528', ref: el => (this.contentElement = el), class: "dropdown-container" }, this.isVisible && (index.h("ul", { key: '54c3e9edee13ce38a4d41bc3be515b1260b06122', class: "dropdown-content" }, index.h("li", { key: 'ff57cc07fc6836d5121b378f3e3b5f17b7b1e88a', class: "filter-container" }, index.h("ir-icons", { key: 'f623e5f165e6b8eacdf33a9260175896a0cfd3fb', name: "search", svgClassName: "filter-icon" }), index.h("input", { key: '050404f6d9f4d5e4569a7fecdb65dfe6ad78acea', placeholder: localization_store.localizedWords.entries.Lcz_Search, ref: el => (this.searchInput = el), type: "text", onInput: this.handleFilterInputChange.bind(this), class: "filter-input", onKeyDown: this.handleAutoCompleteKeyDown.bind(this) })), this.filteredCountries.map((value, index$1) => (index.h("li", { "data-state": this.currentHighlightedIndex === index$1 ? 'checked' : 'unchecked', "data-highlighted": this.currentHighlightedIndex === index$1 ? 'true' : 'false', class: "combobox-item", key: index$1, role: "option", onClick: () => {
