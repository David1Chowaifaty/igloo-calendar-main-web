...
const IrBookingListing = class {
    ...
    async componentWillLoad() {
        ...
        if (isAuthenticated) {
            ...
            app_store.app_store.app_data.token = this.token;
        }
        else {
            const token = await this.commonService.getBEToken();
            if (token) {
                app_store.app_store.app_data.token = token;
            }
        }
            ...
            if (!this.be) {
                requests = [
                    ...
                    this.propertyService.getExposedProperty({
                        id: this.propertyid,
                        language: ((_a = app_store.app_store.userPreferences) === null || _a === void 0 ? void 0 : _a.language_id) || 'en',
                        aname: this.aName,
    ...
    renderPages() {
        switch (this.currentPage) {
            case 'bookings':
                return (index.h("ir-booking-overview", { aff: this.isAffiliate, token: this.token, propertyid: this.propertyid, language: this.language, maxPages: this.maxPages, showAllBookings: this.showAllBookings, be: this.be }));
            case 'booking-details':
                return (index.h("div", { class: this.be ? '' : 'mx-auto px-4 lg:px-6' }, index.h("div", { class: "header-left" }, index.h("ir-button", { variants: "icon", onButtonClick: e => {
                    ...
                    }, iconName: app_store.app_store.dir === 'RTL' ? 'angle_right' : 'angle_left' }), index.h("p", { class: "header-title" }, "My bookings")), index.h("ir-invoice", { locationShown: false, headerShown: false, footerShown: false, propertyId: this.propertyid, perma_link: this.perma_link, aName: this.aName, language: this.language, baseUrl: this.baseUrl, email: this.selectedBooking.email, bookingNbr: this.selectedBooking.booking_nbr, status: 1, be: true })));
            case 'user-profile':
                if (this.be) {
                    return;
                }
                return (index.h("ir-user-profile", { be: this.be, user_data: {
                        id: checkout_store.checkout_store.userFormData.id,
                        email: checkout_store.checkout_store.userFormData.email,
                        first_name: checkout_store.checkout_store.userFormData.firstName,
                        last_name: checkout_store.checkout_store.userFormData.lastName,
                        country_id: checkout_store.checkout_store.userFormData.country_id,
                        mobile: checkout_store.checkout_store.userFormData.mobile_number,
                        country_phone_prefix: checkout_store.checkout_store.userFormData.country_phone_prefix.toString(),
                    } }));
            default:
                return (index.h("ir-booking-overview", { aff: this.isAffiliate, token: this.token, propertyid: this.propertyid, language: this.language, maxPages: this.maxPages, showAllBookings: this.showAllBookings, be: this.be }));
        }
    ...
    renderAuthScreen() {
        return (index.h("main", { class: "flex h-screen flex-col  justify-center" }, index.h("div", { class: "mx-auto w-full max-w-md px-4" }, index.h("ir-auth", { enableSignUp: false }))));
    }
    renderBookingsScreen() {
        ...
        return (index.h(index.Fragment, null, this.headerShown && (index.h("ir-nav", { isBookingListing: true, showBookingCode: false, showCurrency: false, website: (_a = app_store.app_store.property) === null || _a === void 0 ? void 0 : _a.space_theme.website, logo: (_c = (_b = app_store.app_store.property) === null || _b === void 0 ? void 0 : _b.space_theme) === null || _c === void 0 ? void 0 : _c.logo })), index.h("div", { class: `mx-auto max-w-6xl ` }, this.renderPages()), this.footerShown && index.h("ir-footer", { version: this.version })));
    }
    render() {
        return (index.h(index.Host, { key: '6cbbdffa51b16b0217fe392a8f2de4b28e2d2527' }, !this.be && index.h("ir-interceptor", { key: '92f2249144ddc952c0c135a1f5ca3ae168a6ead9' }), !this.token ? this.renderAuthScreen() : this.renderBookingsScreen()));
    }
...
const IrBookingPage = class {
    ...
    componentWillLoad() {
        this.property = Object.assign({}, app_store.app_store.property);
        app_store.onAppDataChange('property', (newValue) => {
    ...
    renderTotalNights() {
        ...
        return `${diff} ${diff > 1 ? localization_store.localizedWords.entries.Lcz_Nights : localization_store.localizedWords.entries.Lcz_night}`;
    }
    render() {
        var _a, _b, _c;
        if (!this.property) {
...
const IrCheckoutPage = class {
    constructor(hostRef) {
        ...
        this.authService = new auth_service.AuthService();
        this.isLoading = false;
        this.error = undefined;
        this.selectedPaymentMethod = null;
    }
    componentWillLoad() {
        const token = app_store.app_store.app_data.token;
    ...
    validatePolicyAcceptance() {
        if (checkout_store.checkout_store.agreed_to_services) {
            return false;
        }
    ...
    validatePayment() {
        var _a, _b, _c, _d;
        const currentPayment = app_store.app_store.property.allowed_payment_methods.find(p => { var _a; return p.code === ((_a = checkout_store.checkout_store.payment) === null || _a === void 0 ? void 0 : _a.code); });
        ...
        try {
            checkout_validator.ZCreditCardSchemaWithCvc.parse({
                cardNumber: (_b = (_a = checkout_store.checkout_store.payment) === null || _a === void 0 ? void 0 : _a.cardNumber) === null || _b === void 0 ? void 0 : _b.replace(/ /g, ''),
                cardHolderName: checkout_store.checkout_store.payment.cardHolderName,
                expiryDate: (_c = checkout_store.checkout_store.payment) === null || _c === void 0 ? void 0 : _c.expiry_month,
                cvc: (_d = checkout_store.checkout_store.payment) === null || _d === void 0 ? void 0 : _d.cvc,
            });
            return true;
        }
        catch (error) {
    ...
    validateUserForm() {
        try {
            user_form.IrUserFormData.parse(checkout_store.checkout_store.userFormData);
            return true;
        }
        catch (error) {
            if (error instanceof index$1.ZodError) {
    ...
    validatePickupForm() {
        if (checkout_store.checkout_store.pickup.location) {
            try {
                pickup.PickupFormData.parse(checkout_store.checkout_store.pickup);
                return true;
            }
            catch (error) {
                if (error instanceof index$1.ZodError) {
    ...
    async processBooking() {
        ...
        try {
            ...
            const conversionTag = (_a = app_store.app_store.property) === null || _a === void 0 ? void 0 : _a.tags.find(t => t.key === 'conversion');
            ...
            if (!this.selectedPaymentMethod || !((_b = this.selectedPaymentMethod) === null || _b === void 0 ? void 0 : _b.is_payment_gateway)) {
                ...
                let token = app_store.app_store.app_data.token;
    ...
    render() {
        if (irInterceptor_store.isRequestPending('/Get_Setup_Entries_By_TBL_NAME_MULTI') || irInterceptor_store.isRequestPending('/Get_Exposed_Countries')) {
            return index.h("ir-checkout-skeleton", null);
        }
...
//# sourceMappingURL=ir-booking-listing_3.cjs.entry.js.map