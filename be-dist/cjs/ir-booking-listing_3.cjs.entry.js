...
const user_form = require('./user_form-b8fa3cb6.js');
...
const IrCheckoutPage = class {
    constructor(hostRef) {
        ...
        this.authService = new user_form.AuthService();
        this.isLoading = false;
    ...
    validatePolicyAcceptance() {
        if (property_service.checkout_store.agreed_to_services) {
            return false;
        }
    ...
    validatePayment() {
        var _a, _b, _c, _d;
        const currentPayment = app_store.app_store.property.allowed_payment_methods.find(p => { var _a; return p.code === ((_a = property_service.checkout_store.payment) === null || _a === void 0 ? void 0 : _a.code); });
        ...
        try {
            checkout_validator.ZCreditCardSchemaWithCvc.parse({
                cardNumber: (_b = (_a = property_service.checkout_store.payment) === null || _a === void 0 ? void 0 : _a.cardNumber) === null || _b === void 0 ? void 0 : _b.replace(/ /g, ''),
                cardHolderName: property_service.checkout_store.payment.cardHolderName,
                expiryDate: (_c = property_service.checkout_store.payment) === null || _c === void 0 ? void 0 : _c.expiry_month,
                cvc: (_d = property_service.checkout_store.payment) === null || _d === void 0 ? void 0 : _d.cvc,
            });
            return true;
        }
        catch (error) {
    ...
    validateUserForm() {
        try {
            user_form.IrUserFormData.parse(property_service.checkout_store.userFormData);
            return true;
        }
        catch (error) {
            if (error instanceof index$1.ZodError) {
    ...
    validatePickupForm() {
        if (property_service.checkout_store.pickup.location) {
            try {
                pickup.PickupFormData.parse(property_service.checkout_store.pickup);
                return true;
            }
            catch (error) {
                if (error instanceof index$1.ZodError) {
