...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e25998e3e50b91bec5c689fa944438e8e85ce64f' }, index.h("button", { key: '59f041c9264ea4c4e07298db3aca85d0376d4899', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '77379e4134a607669131567b48452a28c1c95e61', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '377179928c0e3eafee9c1360b0d115080a27d5b0', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: 'aa6ef199487fccc27e5f86d5c1f6212918d4d8c5', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: 'ae0d65099cca4b9eac66981d58f39a0a47beb5cf', htmlFor: this.checkboxId }, this.label)));
    }
