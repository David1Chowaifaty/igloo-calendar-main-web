...
class PaymentService extends Token {
    ...
    async GeneratePaymentCaller({ token, params, onRedirect, onScriptRun, }) {
        ...
        const { data } = await axios$1.post(`/Generate_Payment_Caller?Ticket=${token}`, Object.assign(Object.assign({}, params), { callback_url: `https://${app_store.app_store.property.perma_link}.bookingmystay.com/invoice` }));
...
//# sourceMappingURL=payment.service-cc0881b8.js.map