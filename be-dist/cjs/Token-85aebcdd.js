...
const utils$3 = require('./utils-e31e3531.js');
                ...
                if (rp.reserved > 0) {
                    [...new Array(rp.reserved)].map((_, index) => {
                        ...
                        rooms.push({
                            ...
                            notes: null,
                            days: this.propertyHelpers.generateDays(utils$3.booking_store.bookingAvailabilityParams.from_date, utils$3.booking_store.bookingAvailabilityParams.to_date, Number(variation.discounted_amount) / utils$3.getDateDifference(utils$3.booking_store.bookingAvailabilityParams.from_date, utils$3.booking_store.bookingAvailabilityParams.to_date)),
...
//# sourceMappingURL=Token-85aebcdd.js.map