...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '2d5d1b3eca2ce83eb1325678914d8d1268db670b', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '337fa0174c59e1e8b00a0e851721f89899e61d46', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: 'b4be44e12d86251792017fe0e2b57214476cde39', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { part: "header", class: "drawer__header" }, index.h("span", { part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: '600c2df09142b6cd8957f47ad10bb0105d686ac8', part: "body", class: "drawer__body" }, index.h("slot", { key: '2ab907c50a9a6bee1463c35c81f508cf4c4f3e71' })), index.h("footer", { key: 'cc7199f012c5dc81995b0f960c940177bb6c087f', part: "footer", class: "drawer__footer" }, index.h("slot", { key: 'e1ab71796a3be5d99bc47843548dccadcbae978b', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
