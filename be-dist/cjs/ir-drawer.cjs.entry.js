...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'f2c028126f7ca7d547d7ff19ad7533f0879ace86', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '94e4291c6d579b4c505d69a470f3706f542e6a62', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: 'e7c77a5fa6daa60cd3f0f6888076a7cd61593777', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { key: '56bd12602aa6d78fac6ba7ba211399a3b214f902', part: "header", class: "drawer__header" }, index.h("span", { key: '3f5eb8fe9bb474fab71f82c907c735b200373aee', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { key: 'dc2dc00032e2356a2be5878cec51f3ec16ee3dd6', name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { key: '671720ce3add15913aaa44725ee419eb1ab649d5', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: '4c605167335c256d9fc231ea02f6903364ca6b8e', part: "body", class: "drawer__body" }, index.h("slot", { key: 'bb87cabab702e5e827a179c94d4bb99be1fd0ad4' })), index.h("footer", { key: 'c5cf1f6feda7ceba77b2bd9ae35366b33e37bb76', part: "footer", class: "drawer__footer" }, index.h("slot", { key: 'cbeb11f968acc89cf74584ca63827e528d6df7c0', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
