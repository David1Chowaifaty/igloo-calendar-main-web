...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'cc002e3eed1f6c48e36b3cbc738bba211ac89df6', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '19a4860e7d0d851c3f9d46146631017dc2c306f6', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: '0ea835fe7996925c9a64de675d57b9cd26660a0d', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { part: "header", class: "drawer__header" }, index.h("span", { part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: '2bbad753f51c6464fcd56ea9b94cc9453be1cc64', part: "body", class: "drawer__body" }, index.h("slot", { key: 'ce62cebdf3991de955f9fee51ce9cbad66943fc6' })), index.h("footer", { key: '169da4fad14082f3534dea5cb4239ec5bf3cea79', part: "footer", class: "drawer__footer" }, index.h("slot", { key: '361b11a4b93b5151cbe14eea0ccac9ef00be6ae6', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
