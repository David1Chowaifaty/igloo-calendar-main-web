...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'e4dfa1d4141a0749c992ba1f7dc95b27c445e831', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '36bb446448c417008279a91113821867a3028902', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: '72af01e669dd1278004a1c15545ef97ab5d8e402', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { key: 'ffe8e9dbadeb152c78d45bc5ccb93db7791f89e3', part: "header", class: "drawer__header" }, index.h("span", { key: '0d88a5b90fce66ccbe0075f587aa76a92beac8f5', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { key: 'c85bd2a9625ea6b019e245dd2675fb95fdd201a0', name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { key: '2e5e8add74f16050630e1f368be91e3cc96b3f74', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: '47e5a1d2a8d788f1a3a1408aef7e9d4742af9b3a', part: "body", class: "drawer__body" }, index.h("slot", { key: 'deb1277006c3eccd7e374bd5fd07bd50f1327318' })), index.h("footer", { key: 'ab2267e6081c6980f0ae97352043bb31d95d286e', part: "footer", class: "drawer__footer" }, index.h("slot", { key: '577368fedcd0c067b357444a17cb9f2ecf25870d', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
