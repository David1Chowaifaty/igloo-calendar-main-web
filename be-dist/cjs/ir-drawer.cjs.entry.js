...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '8b58fb4b3d1a816a3f0ea76fe7b20f36453f40a4', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '6b5810702f861217f51da6dee20f3658a40c7089', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: 'b14253960cb18333b49ff58e6cdc45ced1ef5007', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { key: '4734b6fe49ee12a1a0026437db93b72006c1074d', part: "header", class: "drawer__header" }, index.h("span", { key: '5283f80bdf7a11b1d5b671d92ca1918fde7862d4', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { key: 'b64fd542a814696556f49fd8f652f58505eaf823', name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { key: 'db608f18334af499613fe7b89770cd5334436b9d', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: 'a5a76bb0ad19e6e28ad0ab077587c3175f999b76', part: "body", class: "drawer__body" }, index.h("slot", { key: '2e235e0f70d143bb53d8eae4fb82948dad9f5462' })), index.h("footer", { key: '34f74d90112793f70a9028a992e3cb95737c1bc7', part: "footer", class: "drawer__footer" }, index.h("slot", { key: '3d849970a40b1413caac58f4465b4209886f1a30', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
