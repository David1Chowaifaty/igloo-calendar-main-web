...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'd9bc733f9ae8223d61658f4edfeed99fbb0de736', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: 'ddd62adde621f6e1afc9dd8186468b5509344f42', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: 'd0b5b60c410b36526cf1499220b1f786eade2a32', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { key: '1c12e995df9fbcc5b04743c8203c9ad4bcecbfff', part: "header", class: "drawer__header" }, index.h("span", { key: '64dc2b995bb70c5bc690b9a31fd8ff16d33fa962', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { key: 'c71bf7ac8aa41414c68c254f29bbdcc0e7b9a253', name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { key: 'bfc85d406f6359d21a2b7fd87a4bbf0102ec99e8', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: '28d5c6cf191331ea6f5d1fddfb6f5c33313cf700', part: "body", class: "drawer__body" }, index.h("slot", { key: '31604460dfd03b461d0e585c0df9ac632af80e82' })), index.h("footer", { key: 'dad12ab47a277228a0a5cf21639a46a211777a61', part: "footer", class: "drawer__footer" }, index.h("slot", { key: '7df81a25b7dfa6d5465d66220536da64384fe228', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
