...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'e6fef55bc3fb018af3b23a893a611d5f9e182ace', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '75ed0e1f39714d781da0cff3002fd1ef686437fd', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: 'c628da5ab52204f2262c1908190ef7aa54359ca1', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { part: "header", class: "drawer__header" }, index.h("span", { part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: '02576b7068ee9e614be5fb98062855bcf6b8ebfd', part: "body", class: "drawer__body" }, index.h("slot", { key: 'e295ee314ba587d1340bedd116a6f99804eb9b4f' })), index.h("footer", { key: '754cd28bc2fff695a02401c1094756ac29299329', part: "footer", class: "drawer__footer" }, index.h("slot", { key: '62b87b711e8875a4e3872d28ba5db264a778cbdf', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
