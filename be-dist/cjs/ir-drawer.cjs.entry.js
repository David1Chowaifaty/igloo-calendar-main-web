...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '0882e8af83b786b4eaa995379b6f02ee62a489a9', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '671a5dc5c73599085b3ff16e9ce32d06f23fc66c', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: 'd5b2306cf2a95e4a54e2f6750c5275c5cd30effb', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { part: "header", class: "drawer__header" }, index.h("span", { part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: 'dafb997f983ee875a1386ae75e71f09cac3a4377', part: "body", class: "drawer__body" }, index.h("slot", { key: '3de477da20595e051829fb84d8578eadccd474f4' })), index.h("footer", { key: 'd586b34a69255f95aa901778f81b590dbab533f0', part: "footer", class: "drawer__footer" }, index.h("slot", { key: '41699b197206e9d162436e7ea30d06134c3c25c5', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
