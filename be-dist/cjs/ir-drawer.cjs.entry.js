...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '72ae1d5594845113b209456cff022edcb8f78473', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '70b70acb820dcd2abbbc3c9fd175d0f511a5670c', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: '4aa27870f060cb4695a00a4c0c48674ff96db4f1', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { key: '1688235e3114505fd4cc51b86c4996a5e279bdd5', part: "header", class: "drawer__header" }, index.h("span", { key: '2df352082f19719fa1dc5934ee0796746028c7f4', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { key: 'a6310b74f227677a5efe2e28ca85456d7d5a765b', name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { key: 'a1bfc76f7d3e6f318dc2041ef1b43f003d61542a', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: '57e738bd0f79362ac07f81a50f532a0feac5c325', part: "body", class: "drawer__body" }, index.h("slot", { key: '53860d460f191b1fa75fdcac6f5015cde95d41dc' })), index.h("footer", { key: 'a97b6b528f0c700d5c31465b844f9be9c69a7fb0', part: "footer", class: "drawer__footer" }, index.h("slot", { key: 'e458d9171d02908ddc3c0f9e18a2a76194ec5afe', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
