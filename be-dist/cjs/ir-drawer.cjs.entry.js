...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'aa04ca2dec0be2119203ded9adc7fad317b6108c', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: 'c9058ae700a0958532c5da3bf8df7a66c53a6c78', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: '5657f01d69f794c865b9b9f7f0042a30dcb4c73a', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { key: '94645d0231a45898e6b754ef8189bc4ddaf062f3', part: "header", class: "drawer__header" }, index.h("span", { key: '9f61807a10d6731905fa77ac2cf3be60fec5eb24', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { key: 'bc4a113e4bf8e7a70597c4a559893285700e3bdc', name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { key: 'da615de0e9f0f7a4411d90f793dd1d619d1bd986', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: 'b364d2e4661ed78e89f0c3833f5c9d800fac772e', part: "body", class: "drawer__body" }, index.h("slot", { key: 'ba12a39ea3525c1c4a7e7ddbd70705925ac9059a' })), index.h("footer", { key: '1287fc01dc56dca57388eab4b8b3f62562796b2a', part: "footer", class: "drawer__footer" }, index.h("slot", { key: '1089cf637cb7f912b4203435b37e59215f67f2f8', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
