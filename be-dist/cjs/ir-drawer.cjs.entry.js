...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '10abf47b34f96a71839302cf941973f258214f30', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: '8ee74c03ad490ee7d3c0906fe6cfc5c3980770cc', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: 'f8db6e10f2239fa60e95695cedd63b7617d691c6', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { part: "header", class: "drawer__header" }, index.h("span", { part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: '7630591b8d0ecd74e128cd73fabeeb0d8b3ef42d', part: "body", class: "drawer__body" }, index.h("slot", { key: '0d0f5c861dd0423ccb5dfa4b861b88608c21e179' })), index.h("footer", { key: '56f7aa4742d7fc3bd60f6ea4b4153f909d3ba828', part: "footer", class: "drawer__footer" }, index.h("slot", { key: 'ad85079e7d8e29f2275b0d92144ffdb045fd8294', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
