...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'b7257d4bdaa4d14e35e0de6bb187d54fdbe718be', ref: el => (this.drawer = el), part: "base", class: {
                'drawer': true,
            ...
            }, onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd }, index.h("div", { key: 'bcd8a10bd3c718925153ca05b840c81fce60e45f', part: "overlay", class: "drawer__overlay", onClick: this.handleOverlayClick, tabIndex: -1 }), index.h("div", { key: '708d742bdeda7b0765c0b45131036b364a13e605', ref: el => (this.panel = el), part: "panel", class: "drawer__panel", role: "dialog", "aria-modal": "true", "aria-hidden": this.open ? 'false' : 'true', "aria-label": this.noHeader ? this.label : null, "aria-labelledby": !this.noHeader ? `${this.componentId}-title` : null, tabIndex: 0 }, !this.noHeader && (index.h("header", { key: 'af78c5475cc6e34eb24e292f0d2498c8d4cd4246', part: "header", class: "drawer__header" }, index.h("span", { key: '00c74f061ec51974de0d918a05455f8743689a8f', part: "title", class: "drawer__title", id: `${this.componentId}-title` }, index.h("slot", { key: '4c9f85fa890127d472feaefacef72ef82bf0cab9', name: "label" }, this.label || String.fromCharCode(65279))), index.h("six-icon-button", { key: '9d0f1207cd63a82dcf37e571ec18ac73761b47be', exportparts: "base:close-button", class: "drawer__close", name: "close", onClick: this.handleCloseClick }))), index.h("div", { key: 'ce94cf8e2e41267207351247808129d5157b5b56', part: "body", class: "drawer__body" }, index.h("slot", { key: '25fd476781c31e69751f5d2ab6af130026e9950f' })), index.h("footer", { key: '939b15e99a9745a268e5509572ce97c810902f33', part: "footer", class: "drawer__footer" }, index.h("slot", { key: 'd914bfed993c5af6e382d8a194f077fe83779aaf', name: "footer", onSlotchange: this.handleSlotChange })))));
    }
