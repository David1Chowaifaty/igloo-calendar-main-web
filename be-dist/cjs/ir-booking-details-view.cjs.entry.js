...
const bookingListing_service = require('./booking-listing.service-8cc4b7ea.js');
...
const IrBookingDetailsView = class {
    ...
    componentWillLoad() {
        var _a, _b;
        const { email } = (_b = (_a = app_store.app_store.property) === null || _a === void 0 ? void 0 : _a.contacts) === null || _b === void 0 ? void 0 : _b.find(c => c.type === 'booking');
        this.email = email;
    }
    ...
    renderLocation() {
        var _a, _b;
        const { city, country, area, address } = app_store.app_store.property;
    ...
    formatGuest() {
        var _a, _b, _c, _d;
        const values = [this.email, `${((_b = (_a = app_store.app_store.property) === null || _a === void 0 ? void 0 : _a.country) === null || _b === void 0 ? void 0 : _b.phone_prefix) || ''} ${(_c = app_store.app_store.property) === null || _c === void 0 ? void 0 : _c.phone}`];
    ...
    render() {
        ...
        return (index.h("div", { class: "booking-details-container text-sm" }, index.h("div", { class: "header" }, index.h("div", { class: "header-left" }, index.h("ir-button", { variants: "icon", onButtonClick: e => {
            ...
            }, iconName: app_store.app_store.dir === 'RTL' ? 'angle_right' : 'angle_left' }), index.h("p", { class: "header-title" }, "My bookings")), cancel && index.h("ir-button", { label: "Cancel Request", class: "cancel-button", onButtonClick: () => this.bookingCancelation.openDialog() })), index.h("h2", { class: "section-title" }, "Booking reference ", this.booking.booking_nbr, " - ", app_store.app_store.property.name), index.h("section", { class: "detail-container" }, index.h("div", { class: "details-section" }, index.h("div", null, index.h("p", { class: "booking-info-text" }, localization_store.localizedWords.entries.Lcz_BookedBy, ' ', index.h("span", null, this.booking.guest.first_name, " ", this.booking.guest.last_name)), index.h("p", { class: "booking-info-text" }, localization_store.localizedWords.entries.Lcz_CheckIn, ": ", index.h("span", null, index$1.dateFns.format(this.booking.from_date, 'eee, dd MMM yyyy'), " "), index.h("span", null, localization_store.localizedWords.entries.Lcz_From, " ", (_a = app_store.app_store.property) === null || _a === void 0 ? void 0 :
            _a.time_constraints.check_in_from)), index.h("p", { class: "booking-info-text" }, localization_store.localizedWords.entries.Lcz_CheckOut, ": ", index.h("span", null, index$1.dateFns.format(this.booking.to_date, 'eee, dd MMM yyyy'), " "), index.h("span", null, localization_store.localizedWords.entries.Lcz_Before, " ", (_b = app_store.app_store.property) === null || _b === void 0 ? void 0 :
            _b.time_constraints.check_out_till)), index.h("p", { class: "booking-info-text" }, localization_store.localizedWords.entries.Lcz_ArrivalTime, " ", index.h("span", null, this.booking.arrival.description)), this.booking.remark && (index.h("p", { class: "booking-info-text" }, "Special request: ", index.h("span", null, this.booking.remark)))), index.h("div", null, index.h("p", { class: "booking-info-text" }, "Address:", index.h("span", null, " ", this.renderLocation())), index.h("p", { class: "booking-info-text" }, "GPS:", index.h("span", null, ' ', "Latitude ", app_store.app_store.property.location.latitude, ", Longitude ", app_store.app_store.property.location.longitude)), index.h("p", { class: "booking-info-text" }, "Phone:", ' ', index.h("span", null, ' ', index.h("a", { class: "contact-link", href: `tel:${(_c = app_store.app_store.property) === null || _c === void 0 ? void 0 : _c.phone}` }, ((_e = (_d = app_store.app_store.property) === null || _d === void 0 ? void 0 : _d.country) === null || _e === void 0 ? void 0 : _e.phone_prefix) || '', " ", (_f = app_store.app_store.property) === null || _f === void 0 ? void 0 :
            _f.phone))), this.renderPropertyEmail())), index.h("div", { class: "booking-details" }, index.h("div", { class: "booking-header" }, index.h("div", { class: "header-left" }, index.h("ir-icons", { name: "bed" }), index.h("h3", { class: "booking-header-title" }, this.renderBookingDetailHeader())), index.h("p", null, (_g = app_store.app_store.property) === null || _g === void 0 ? void 0 : _g.tax_statement)), index.h("div", null, (_h = this.booking.rooms) === null || _h === void 0 ? void 0 : _h.map(room => (index.h("div", { class: "room-info", key: room.identifier }, index.h("div", { class: "room-header" }, index.h("h4", { class: "room-type" }, room.roomtype.name), index.h("p", { class: "room-price" }, utils.formatAmount(room.gross_total, this.booking.currency.code))), index.h("p", { class: "room-info-text" }, localization_store.localizedWords.entries.Lcz_GuestName, ' ', index.h("span", null, room.guest.first_name, " ", room.guest.last_name, " (", room.rateplan.selected_variation.adult_child_offering, ")")), index.h("p", { class: "room-info-text" }, localization_store.localizedWords.entries.Lcz_MealPlan, " ", index.h("span", null, room.rateplan.name)), index.h("p", { class: "room-info-text", innerHTML: room.rateplan.cancelation }), index.h("p", { class: "room-info-text", innerHTML: room.rateplan.guarantee }))))))), index.h("section", { class: "hotel-policies" }, index.h("h2", { class: "section-title" }, "Hotel Policies"), index.h("ir-facilities", null)), index.h("section", { class: "payment-details" }, index.h("h2", { class: "section-title" }, "Payment Details"), index.h("div", { class: "detail-container" }, index.h("p", null, localization_store.localizedWords.entries.Lcz_YourBookingIsGuaranteed), index.h("p", null, localization_store.localizedWords.entries.Lcz_YourBookingIsNotGuaranteed))), index.h("section", { class: "guest-service" }, index.h("h2", { class: "section-title" }, "Guest Service"), index.h("p", { class: "detail-container", innerHTML: this.formatGuest() })), index.h("ir-booking-cancelation", { ref: el => (this.bookingCancelation = el), booking_nbr: (_j = this.booking) === null || _j === void 0 ? void 0 : _j.booking_nbr, cancelation: (_k = this.booking) === null || _k === void 0 ? void 0 : _k.rooms[0].rateplan.cancelation, onCancelationResult: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
