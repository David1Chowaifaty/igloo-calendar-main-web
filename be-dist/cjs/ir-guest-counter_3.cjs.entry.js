...
const IrGuestCounter = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '445f201898b4c20b8afa86329bdec76d85826905', class: "counter-container p-4" }, index.h("div", { key: 'df7a13b1bddf95cc83be7098e1a8831124a8569e', class: "counter-item" }, index.h("div", { key: '571baead73fd8b83a61d5ea96df8d985e296e225' }, index.h("p", { key: '568dd53c6c107782dc0f4d38aa8db52295c5c3e6', class: "main-text" }, "Adults"), index.h("p", { key: 'f87ce75f2c6f91c010e7a491297f340562e5d8e8', class: "secondary-text" }, "Ages ", this.childMaxAge + 1, "+")), index.h("div", { key: 'd9938842f0ae92a2c0f0857a20bd00c98d6551a6', class: "counter-buttons-group" }, index.h("ir-button", { key: 'dfcf3dd9deb5a72e7ab7fe36da0058555449c787', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: 'c722f7ea9f4d5d4d3cdac6dc984787b4902e005b' }, this.adultCount), index.h("ir-button", { key: 'bb1331c1aaa4065deacbf03fb12bf92c6de7efdb', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), this.childMaxAge > 0 && (index.h("div", { key: '4e61e053c3240030f4c50d371267639519e99d44', class: "counter-item" }, index.h("div", { key: '061b1cc98dbbe2cbf318babbcec420e2c337f7f5' }, index.h("p", { key: '1adc9d78ad217b84e2d525de7055ad454a46bb68', class: "main-text" }, "Children"), index.h("p", { key: '59a041e41547f6be7639a1852a5166aba7de5c78', class: "secondary-text" }, "Ages 0-", this.childMaxAge)), index.h("div", { key: 'b477da059b0279b3d2044f52a695154e3054fed2', class: "counter-buttons-group" }, index.h("ir-button", { key: 'eef8f4de33f0ce58e86400ed117fc143c42ecab4', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '8904b06de4acdd0ba21ec2e2e7f40a925efcf1e8' }, this.childrenCount), index.h("ir-button", { key: 'a19e14ff2573857494effab92d77fdb41439776f', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" })))), (_a = this.childrenAges) === null || _a === void 0 ? void 0 :
            _a.map((v, i) => (index.h("div", null, index.h("ir-select", { addDummyOption: true, value: v, key: `child_${i}_age`, "data-state": this.error && v === '' ? 'error' : '', variant: "double-line", label: `Child ${i + 1} age`, onValueChange: e => {
                    ...
                    id: index.toString(),
                    value: index === 0 ? localization_store.localizedWords.entries['Lcz_under1'] : index.toString(),
                })) }), this.error && v === '' && index.h("p", { class: 'm-0 p-0 text-xs text-red-500' }, localization_store.localizedWords.entries.Lcz_enterchildage)))), index.h("ir-button", { key: '2a48a541911a5419e5ec9885fe52e229b4e7417e', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
...
const IrWidgetDatePopup = class {
    ...
    renderDateTrigger(slot = 'trigger') {
        ...
        let toLabel = '';
        if (from) {
            fromLabel = utils.moment(from).format('DD MMM YYYY');
        }
        if (to) {
            toLabel = utils.moment(to).format('DD MMM YYYY');
        }
        return (index.h("button", { disabled: this.disabled, class: `ir-widget__date-trigger relative ${this.absoluteIcon ? '--absolute-icon' : ''}`, part: "date-trigger", slot: slot }, index.h("div", { class: this.absoluteIcon ? 'pointer-events-none absolute inset-y-0 start-2 flex  items-center' : '' }, index.h("ir-icons", { name: "calendar", svgClassName: "ir-widget__icon", removeClassName: true, height: 16, width: 16 })), fromLabel && toLabel ? (index.h("div", null, index.h("p", null, index.h("span", null, fromLabel), index.h("span", null, " - "), index.h("span", null, toLabel)))) : (index.h("div", null, index.h("p", null, "Your dates")))));
    }
    renderLoadingTrigger(slot = 'trigger') {
        return (index.h("div", { class: `ir-widget__date-trigger ir-widget__trigger--loading relative ${this.absoluteIcon ? '--absolute-icon' : ''}`, part: "date-trigger", slot: slot, "aria-busy": "true" }, index.h("div", { class: this.absoluteIcon ? 'pointer-events-none absolute inset-y-0 start-2 flex  items-center' : '' }, index.h("span", { class: "ir-widget__loading-icon ir-widget__shimmer" })), index.h("div", { class: "ir-widget__loading-range" }, index.h("span", { class: "ir-widget__loading-line --short ir-widget__shimmer" }), index.h("span", { class: "ir-widget__loading-line --medium ir-widget__shimmer" }))));
    }
    renderDateRange() {
        var _a, _b;
        return (index.h("ir-date-range", { dateModifiers: this.dateModifiers, minDate: utils.moment(), style: { '--radius': 'var(--ir-widget-radius)' }, fromDate: ((_a = this.dates) === null || _a === void 0 ? void 0 : _a.from_date) ? utils.moment(this.dates.from_date) : null, toDate: ((_b = this.dates) === null || _b === void 0 ? void 0 : _b.to_date) ? utils.moment(this.dates.to_date) : null, locale: this.locale, maxSpanDays: this.maxSpanDays, onDateChange: e => {
                var _a;
    ...
    render() {
        return (index.h(index.Host, { key: 'f67a1acc36e75c9d21d2723cfd683a5f9368474f' }, index.h("ir-popup", { key: '39d51223cf3b3ed419f26d4e44c35fe35c7e91ea', modal: true, withArrow: true, class: "ir-multi-property-date-popup__popup", ref: el => (this.mobileDatePopupModal = el) }, this.isLoading ? this.renderLoadingTrigger('anchor') : this.renderDateTrigger('anchor'), !this.isLoading && (index.h("header", { key: '4c62383e58bb1c56ae22233a1e60ff6c1dfbf09b', class: 'ir-multi-property-date-popup__header' }, index.h("ir-button", { key: '242a92260e3a6d7a7059c4cd7c16b80d88d4ebfd', onButtonClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.mobileDatePopupModal.close();
            }, iconName: "xmark", variants: "icon" }))), !this.isLoading && this.renderDateRange()), index.h("ir-popup", { key: '57e684d42b907805e6391f2a35fb3e53481606e6', withArrow: true, class: "ir-multi-property-date-popup__popup", ref: el => (this.dateWidgetPopupRef = el) }, this.isLoading ? this.renderLoadingTrigger('anchor') : this.renderDateTrigger('anchor'), !this.isLoading && this.renderDateRange())));
    }
};
...
const IrWidgetOccupancyPopup = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.guestsChange = index.createEvent(this, "guestsChange", 7);
        this.absoluteIcon = false;
    }
    renderAdultChildTrigger(slot = 'trigger') {
        ...
        return (index.h("button", { disabled: this.disabled, class: `ir-widget__guests-trigger relative ${this.absoluteIcon ? '--absolute-icon' : ''}`, part: "guests-trigger", slot: slot }, index.h("div", { class: this.absoluteIcon ? 'pointer-events-none absolute inset-y-0 start-2 flex  items-center' : '' }, index.h("ir-icons", { name: "user", class: `${slot}-icon`, removeClassName: true, height: 16, width: 16, svgClassName: "ir-widget__icon" })), index.h("p", { class: 'ir-widget__guests' }, adultCount > 0 ? (index.h("span", null, index.h("span", { class: "ir-widget__text-lower" }, adultCount, " ", adultCount === 1 ? localization_store.localizedWords.entries.Lcz_Adult : localization_store.localizedWords.entries.Lcz_Adults), childMaxAge > 0 && (index.h("span", { class: "ir-widget__text-lower" }, ", ", childrenCount, " ", childrenCount === 1 ? localization_store.localizedWords.entries.Lcz_Child : localization_store.localizedWords.entries.Lcz_Children)))) : (index.h("span", null, "Guests")))));
    }
    renderLoadingTrigger(slot = 'trigger') {
        return (index.h("div", { class: `ir-widget__guests-trigger ir-widget__trigger--loading relative ${this.absoluteIcon ? '--absolute-icon' : ''}`, part: "guests-trigger", slot: slot, "aria-busy": "true" }, index.h("div", { class: this.absoluteIcon ? 'pointer-events-none absolute inset-y-0 start-2 flex items-center' : '' }, index.h("span", { class: "ir-widget__loading-icon ir-widget__shimmer" })), index.h("div", { class: "ir-widget__loading-text" }, index.h("span", { class: "ir-widget__loading-line --primary ir-widget__shimmer" }))));
    }
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (index.h(index.Host, { key: 'b2e71727e479fbe8e21c03d8a5e5d52df843e69f' }, index.h("ir-popup", { key: '7b571c2bda963fd07cc54856170f3afeaac01436', class: "ir-multi-property-occupancy-popup__popup", ref: el => (this.guestsWidgetPopupRef = el) }, this.isLoading ? this.renderLoadingTrigger('anchor') : this.renderAdultChildTrigger('anchor'), !this.isLoading && (index.h("ir-guest-counter", { key: 'de52b37ff24768990add1f57c64d89307e640129', error: this.error, adults: (_a = this.guests) === null || _a === void 0 ? void 0 : _a.adultCount, child: (_b = this.guests) === null || _b === void 0 ? void 0 : _b.childrenCount, minAdultCount: 0, maxAdultCount: (_d = (_c = this.property) === null || _c === void 0 ? void 0 : _c.adult_child_constraints) === null || _d === void 0 ? void 0 : _d.adult_max_nbr, maxChildrenCount: (_f = (_e = this.property) === null || _e === void 0 ? void 0 : _e.adult_child_constraints) === null || _f === void 0 ? void 0 : _f.child_max_nbr, childMaxAge: (_h = (_g = this.property) === null || _g === void 0 ? void 0 : _g.adult_child_constraints) === null || _h === void 0 ? void 0 : _h.child_max_age, onUpdateCounts: e => this.guestsChange.emit(Object.assign({}, e.detail)), part: "guest-counter", onCloseGuestCounter: () => this.guestsWidgetPopupRef.close() })))));
    }
};
IrWidgetOccupancyPopup.style = IrWidgetOccupancyPopupStyle0;

exports.ir_guest_counter = IrGuestCounter;
exports.ir_widget_date_popup = IrWidgetDatePopup;
exports.ir_widget_occupancy_popup = IrWidgetOccupancyPopup;

//# sourceMappingURL=ir-guest-counter_3.cjs.entry.js.map