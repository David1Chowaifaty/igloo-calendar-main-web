...
class PropertyHelpers {
    ...
    async fetchAvailabilityData(token, props, roomtypeIds, rateplanIds) {
        const response = await axios$1.post(`/Get_Exposed_Booking_Availability?Ticket=${token}`, Object.assign(Object.assign({}, props.params), { identifier: props.identifier, room_type_ids: roomtypeIds, rate_plan_ids: rateplanIds, skip_getting_assignable_units: true, is_specific_variation: true }));
                ...
                if (rp.reserved > 0) {
                    [...new Array(rp.reserved)].map((_, index) => {
                        ...
                        rooms.push({
                            ...
                            from_date: utils$3.dateFns.format(booking_store.bookingAvailabilityParams.from_date, 'yyyy-MM-dd'),
                            to_date: utils$3.dateFns.format(booking_store.bookingAvailabilityParams.to_date, 'yyyy-MM-dd'),
                            notes: null,
                            days: this.propertyHelpers.generateDays(booking_store.bookingAvailabilityParams.from_date, booking_store.bookingAvailabilityParams.to_date, +rp.checkoutVariations[index].amount / utils$3.getDateDifference(booking_store.bookingAvailabilityParams.from_date, booking_store.bookingAvailabilityParams.to_date)),
                            guest: {
                                email: null,
                                first_name,
                                last_name,
        ...
        try {
            ...
            const body = {
                ...
                booking: {
                    ...
                    source: utils$3.app_store.app_data.source,
                    referrer_site: utils$3.app_store.app_data.affiliate ? window.location.href : 'www.igloorooms.com',
