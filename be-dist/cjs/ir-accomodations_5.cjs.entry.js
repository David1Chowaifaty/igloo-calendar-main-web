...
const IrGallery = class {
    ...
    render() {
        return (index.h("div", { key: '55d543d9e2f7f0f3e99559c4919e291c61d590f3', class: "gallery-container" }, this.totalImages > 0 && (index.h("button", { onClick: () => this.openGallery.emit(null), class: "total-images-number" }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "14", width: "15.75", viewBox: "0 0 576 512" }, index.h("path", { fill: "currentColor", d: "M160 80H512c8.8 0 16 7.2 16 16V320c0 8.8-7.2 16-16 16H490.8L388.1 178.9c-4.4-6.8-12-10.9-20.1-10.9s-15.7 4.1-20.1 10.9l-52.2 79.8-12.4-16.9c-4.5-6.2-11.7-9.8-19.4-9.8s-14.8 3.6-19.4 9.8L175.6 336H160c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16zM96 96V320c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H160c-35.3 0-64 28.7-64 64zM48 120c0-13.3-10.7-24-24-24S0 106.7 0 120V344c0 75.1 60.9 136 136 136H456c13.3 0 24-10.7 24-24s-10.7-24-24-24H136c-48.6 0-88-39.4-88-88V120zm208 24a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), index.h("span", null, this.totalImages, " +"))), index.h("div", { key: '9347b9ebea5888bc2021cb43cc7798cfc973fd5b', class: "swiper", ref: el => (this.carouselEl = el) }, index.h("div", { key: '16849e2b0d60774123a43099280184b20fa7c537', class: "swiper-wrapper" }, this.images.map(image => (index.h("div", { class: "swiper-slide" }, index.h("button", { class: "absolute" }, index.h("p", { class: "sr-only" }, "open gallery")), index.h("img", { onClick: () => this.openGallery.emit(null), draggable: false, src: image.url, alt: image.alt }))))), index.h("div", { key: '0e375c813e45c7681704b6cb15db2f7a46d43553', class: "swiper-button-prev", ref: el => (this.prevEl = el) }, index.h("svg", { key: 'e747d0b657205be3a327557c7d9d45949ef390b3', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, index.h("path", { key: 'a7c659ee586551e60f0e1ca215d0f20e33b4c1a8', d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), index.h("div", { key: '55f87fcf280510dcb1615227f84d1fd3452ae25a', class: "swiper-button-next", ref: el => (this.nextEl = el) }, index.h("svg", { key: '7ae6d4d16309788790140d7863cde36a65944192', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, index.h("path", { key: '8ee8ada3f6575a8b9dc480e8e13bb12aa71985cc', d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), index.h("div", { key: '5c70411bfc35848ba8e7624c8027b23ff1aa3d6b', class: "gallery" }, this.images.map(image => (index.h("figure", { class: "gallery-item" }, index.h("button", { class: "absolute" }, index.h("p", { class: "sr-only" }, "open gallery")), index.h("img", { onClick: () => this.openGallery.emit(null), src: image.url, alt: image.alt })))))));
    }
};
...
const IrRoomTypeAmenities = class {
    ...
    render() {
        var _a, _b, _c, _d;
        return (index.h("div", { key: '70dcc41fc038d6bb4c35a56aa3b9fb327095cb05', class: "space-y-3" }, index.h("div", { key: 'bcc0d9536ae8e71f7227d0739d2ba41ccdcf2950', class: "flex flex-col gap-4 sm:flex-row sm:items-center" }, index.h("div", { key: 'c016a44f6204b91e40b5ad17959159cf78181db2', class: " flex items-center gap-4" }, index.h("div", { key: '0f91f44df62aee8f1db7960f69ed1f45a48bb1fa', class: "flex items-center gap-2" }, index.h("ir-icons", { key: 'e2879133c94963167b060ab54128a6e214125736', name: "dimensions" }), index.h("p", { key: '96bf7fbcba5281eb56da496c7e41141642b359f9' }, this.roomType.size, ' ', index.h("span", { key: '6b3b115c00d91693e2800ad8bbd4bc52311ed08a', class: "ordinal" }, "m", index.h("sup", { key: 'a67bad516664a5f8498d878dfeb1bb6bd2b90eb6' }, "2")))), ' ', index.h("div", { key: '0593e7c6366ed101f97467c03881f36ab59d2599', class: "flex items-center gap-2" }, index.h("ir-icons", { key: '2b41b0cebe1d9d61c3c3b5940af4c7a7899ccf44', name: "wifi" }), index.h("p", { key: '97fa661fb65032c2f0a41b2fdc49510164322166' }, ((_a = this.aminities) === null || _a === void 0 ? void 0 : _a.some(amenity => amenity.amenity_type === 'room' && amenity.code === 'freewifi')) ? localization_store.localizedWords.entries.Lcz_wifi : '', " "))), index.h("div", { key: 'bba93927cc89f0872e39618f855593e185bbd5a6', class: "flex items-center gap-4" }, index.h("div", { key: '443a222cf539ccf4a3a71c5b1446c31a39db987a', class: "flex items-center gap-2" }, index.h("ir-icons", { key: '2f183681126647dbddf6805813dcab2baeb92001', name: "bed" }), (_c = (_b = this.roomType) === null || _b === void 0 ? void 0 : _b.bedding_setup) === null || _c === void 0 ? void 0 :
            _c.map((bed_setup, index$1) => (index.h("p", { key: bed_setup.code }, bed_setup.name, " ", index$1 < this.roomType.bedding_setup.length - 1 && index.h("span", null, " - "))))))), this.roomType.images.length === 0 && (index.h("div", { class: "flex flex-1 items-center gap-4" }, index.h("div", { class: "flex items-center gap-2" }, this.renderOccupancyView()))), index.h("p", { key: '4d48b25686d28cef091def5bc095584a5a0d9444', innerHTML: (_d = this.roomType) === null || _d === void 0 ? void 0 : _d.description, class: "py-4" }), index.h("h3", { key: 'bdbda06cae31531a76ced3808720b4647a7032f6', class: "text-lg font-medium text-gray-800" }, localization_store.localizedWords.entries.Lcz_Amenities), index.h("ul", { key: 'c99a9377cb0a0a9ebaf375a5199b3fed4e48b3a4', class: "grid grid-cols-2 gap-4 pb-6 text-xs sm:text-sm lg:grid-cols-3" }, this.aminities.map(aminity => {
