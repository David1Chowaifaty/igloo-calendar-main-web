...
const IrGallery = class {
    ...
    render() {
        return (index.h("div", { key: '3498332e5416e7a694b17bac97fe02a8a66d362b', class: "gallery-container" }, this.totalImages > 0 && (index.h("button", { onClick: () => this.openGallery.emit(null), class: "total-images-number" }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "14", width: "15.75", viewBox: "0 0 576 512" }, index.h("path", { fill: "currentColor", d: "M160 80H512c8.8 0 16 7.2 16 16V320c0 8.8-7.2 16-16 16H490.8L388.1 178.9c-4.4-6.8-12-10.9-20.1-10.9s-15.7 4.1-20.1 10.9l-52.2 79.8-12.4-16.9c-4.5-6.2-11.7-9.8-19.4-9.8s-14.8 3.6-19.4 9.8L175.6 336H160c-8.8 0-16-7.2-16-16V96c0-8.8 7.2-16 16-16zM96 96V320c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H160c-35.3 0-64 28.7-64 64zM48 120c0-13.3-10.7-24-24-24S0 106.7 0 120V344c0 75.1 60.9 136 136 136H456c13.3 0 24-10.7 24-24s-10.7-24-24-24H136c-48.6 0-88-39.4-88-88V120zm208 24a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), index.h("span", null, this.totalImages, " +"))), index.h("div", { key: '18869cebcbb19645881649f5460261541749ddc3', class: "swiper", ref: el => (this.carouselEl = el) }, index.h("div", { key: 'bf6dd9238108de7d49cf114bf2a8112d5d30de84', class: "swiper-wrapper" }, this.images.map(image => (index.h("div", { class: "swiper-slide" }, index.h("button", { class: "absolute" }, index.h("p", { class: "sr-only" }, "open gallery")), index.h("img", { onClick: () => this.openGallery.emit(null), draggable: false, src: image.url, alt: image.alt }))))), index.h("div", { key: 'f671a5a51519128b20d1b4a7f82690672abf8eba', class: "swiper-button-prev", ref: el => (this.prevEl = el) }, index.h("svg", { key: '2100b9e1215fe845df96ecd078fe626eab2bd5bf', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, index.h("path", { key: '42e6d946458adc06ec69449128a5f6162700b756', d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" }))), index.h("div", { key: '26089db6492b42e66a70e8e6a5dcf4c9434b53f0', class: "swiper-button-next", ref: el => (this.nextEl = el) }, index.h("svg", { key: '14276c80ab143480c7b7bd5fd783096efa7769f0', xmlns: "http://www.w3.org/2000/svg", height: "10", width: "6.25", viewBox: "0 0 320 512" }, index.h("path", { key: '94207e435342bb85570f329924e66a214bd7be5d', d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), index.h("div", { key: '615299b6f998116e046fe29712010db2c48e19f5', class: "gallery" }, this.images.map(image => (index.h("figure", { class: "gallery-item" }, index.h("button", { class: "absolute" }, index.h("p", { class: "sr-only" }, "open gallery")), index.h("img", { onClick: () => this.openGallery.emit(null), src: image.url, alt: image.alt })))))));
    }
};
...
const IrRoomTypeAmenities = class {
    ...
    render() {
        var _a, _b, _c, _d;
        return (index.h("div", { key: 'c230393ca3c42e5075f4581f22be6fa33956adcf', class: "space-y-3" }, index.h("div", { key: 'f85e35f09c0167f616610d9a900488c5240c4b0d', class: "flex flex-col gap-4 sm:flex-row sm:items-center" }, index.h("div", { key: '6de25340907a0d84349e163453e38e18a7be1eac', class: " flex items-center gap-4" }, index.h("div", { key: 'b6d932f7acfa0e7d0f10629a6272cbeaaf22d1b8', class: "flex items-center gap-2" }, index.h("ir-icons", { key: '9101fbb9eb4837ae6e0d59ff3c3248d1ea1d73db', name: "dimensions" }), index.h("p", { key: 'ab4c5212e5ebc1d7537d27d12c2a08d7b43ba90a' }, this.roomType.size, ' ', index.h("span", { key: '6c1996aa8679ceeffd6d53f768b36e739305c267', class: "ordinal" }, "m", index.h("sup", { key: '6c60331d2f714164b01929bffa33bc102d739443' }, "2")))), ' ', index.h("div", { key: 'a14ebf742659b78dbbcae9fbdc971b59ca0e5e8f', class: "flex items-center gap-2" }, index.h("ir-icons", { key: '126be709d48eb9aeb566fdfa52f31ccb84554a3b', name: "wifi" }), index.h("p", { key: 'fd6558b3b560962ff00031cdca7be0f1fb7af8c4' }, ((_a = this.aminities) === null || _a === void 0 ? void 0 : _a.some(amenity => amenity.amenity_type === 'room' && amenity.code === 'freewifi')) ? 'wifi' : '', " "))), index.h("div", { key: '61e3524c0cb5a554bd46dc247a17a8fbd64304ee', class: "flex items-center gap-4" }, index.h("div", { key: 'ed70201ebbb87094b8a3a84c20dcd8a7d666d147', class: "flex items-center gap-2" }, index.h("ir-icons", { key: 'b9dd6e2228aa691d057d906a61c0ea7ee8354887', name: "bed" }), (_c = (_b = this.roomType) === null || _b === void 0 ? void 0 : _b.bedding_setup) === null || _c === void 0 ? void 0 :
            _c.map((bed_setup, index$1) => (index.h("p", { key: bed_setup.code }, bed_setup.name, " ", index$1 < this.roomType.bedding_setup.length - 1 && index.h("span", null, " - "))))))), index.h("p", { key: '2312d472b1d0e34c52871b142b8bc38bcf4a9d87', innerHTML: (_d = this.roomType) === null || _d === void 0 ? void 0 : _d.description, class: "py-4" }), index.h("h3", { key: '8145528c6b5d17b354e5795a171c7192fedc2aaf', class: "text-lg font-medium text-gray-800" }, localization_store.localizedWords.entries.Lcz_Amenities), index.h("ul", { key: '8e667b4bf8c7b07690979998e8305627c55abd9e', class: "grid grid-cols-2 gap-4 pb-6 text-xs sm:text-sm lg:grid-cols-3" }, this.aminities.map(aminity => {
