...
const utils$3 = require('./utils-8aac96b0.js');
...
class PropertyService extends Token {
    ...
    async bookUser() {
        var _a;
        const { prePaymentAmount } = utils$3.calculateTotalCost();
        try {
            const token = this.getToken();
            if (!token) {
                throw new MissingTokenError();
            ...
            const body = {
                ...
                booking: {
                    ...
                    currency: utils$3.app_store.property.currency,
...
//# sourceMappingURL=common.service-007aa23d.js.map