...
const utils$2 = require('./utils-7adffbb7.js');
...
class PropertyService extends Token {
    ...
    async getExposedProperty(params, initTheme = true) {
        ...
        const { data } = await axios$1.post(`/Get_Exposed_Property?Ticket=${token}`, Object.assign(Object.assign({}, params), { currency: utils$2.app_store.userPreferences.currency_id, include_sales_rate_plans: !!booking_store.bookingAvailabilityParams.agent }));
        const result = data;
...
//# sourceMappingURL=common.service-afa2f5d3.js.map