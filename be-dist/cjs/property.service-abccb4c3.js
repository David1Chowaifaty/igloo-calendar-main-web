...
const utils$2 = require('./utils-28a4de68.js');
...
class PropertyService extends Token {
    ...
    async getExposedBookingAvailability(params) {
        ...
        let roomtypeIds = [];
        const { injected, roomtype_id } = app_store.app_store.app_data;
        if (injected) {
        ...
        try {
            ...
            const body = {
                ...
                booking: {
                    ...
                    source: null,
                    referrer_site: app_store.app_store.property.affiliates.includes(window.location.href) ? window.location.href : 'www.igloorooms.com',
...
//# sourceMappingURL=property.service-abccb4c3.js.map