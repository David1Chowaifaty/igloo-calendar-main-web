...
const overlay_store = require('./overlay.store-d7aa65dc.js');
require('./index-ab6de843.js');
...
const IrAlertDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4406baa69051a40636561e1bcc819183cf9ebf50' }, index.h("div", { key: '2cc4ca89ef7c136a8b6d26122bd16fe83436503f', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed' }), this.isOpen && (index.h("div", { class: "modal-container", tabIndex: -1, role: "alertdialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("div", { class: 'modal-title', id: "dialog1Title" }, index.h("slot", { name: "modal-title" })), index.h("div", { class: "modal-body", id: "dialog1Desc" }, index.h("slot", { name: "modal-body" })), index.h("div", { class: "modal-footer" }, index.h("slot", { name: "modal-footer" }))))));
    }
