...
const availability_service = require('./availability.service-4ae34a46.js');
const checkout_store = require('./checkout.store-c57806bb.js');
const v4 = require('./v4-9b297151.js');
const index$1 = require('./index-505d795c.js');
require('./localization.store-636d94a8.js');
require('./index-10c552bd.js');
require('./payment.service-0b0bf1f6.js');
require('./index-e2246344.js');
require('./index-42419b2e.js');
...
const IrBookingEngine = class {
    constructor(hostRef) {
        ...
        this.availabiltyService = new availability_service.AvailabiltyService();
    ...
    async componentWillLoad() {
        Token.axios.defaults.withCredentials = true;
        Token.axios.defaults.baseURL = this.baseUrl;
        utils.getUserPrefernce(this.language);
        if (this.property) {
            app_store.app_store.property = Object.assign({}, this.property);
        }
    ...
    setSource(newSource) {
        app_store.app_store.app_data = Object.assign(Object.assign({}, app_store.app_store.app_data), { source: newSource });
    }
    modifyLanguage(code) {
        var _a;
        if (!this.languages) {
    ...
    async initRequest() {
        ...
        let requests = [
            ...
            this.propertyService.getExposedProperty({ id: this.propertyId, language: ((_a = app_store.app_store.userPreferences) === null || _a === void 0 ? void 0 : _a.language_id) || 'en', aname: this.p, perma_link: this.perma_link }),
        ];
        ...
        if (!p) {
            ...
            let currency = app_store.app_store.userDefaultCountry.currency;
            if (this.cur) {
        ...
        app_store.app_store.app_data = Object.assign(Object.assign({}, app_store.app_store.app_data), { affiliate: utils.checkAffiliate((_b = this.aff) === null || _b === void 0 ? void 0 : _b.toLowerCase().trim()) });
        this.isLoading = false;
    }
    ...
    handleVariationChange(e, variations, rateplanId, roomTypeId) {
        ...
        utils.updateRoomParams({ params: { selected_variation: { variation: selectedVariation, state: 'modified' } }, ratePlanId: rateplanId, roomTypeId });
    }
    modifyLoyalty() {
    ...
    handleAuthFinish(e) {
        ...
        if (state === 'success') {
            if (payload.method === 'direct') {
                ...
                app_store.app_store.currentPage = 'booking-listing';
            }
        }
    }
    async resetBooking(resetType = 'completeReset') {
        ...
        if (resetType === 'discountOnly' && app_store.app_store.fetchedBooking) {
            ...
            queries = [
                ...
                ...[
                    this.commonService.getExposedLanguage(),
                    this.propertyService.getExposedProperty({ id: app_store.app_store.app_data.property_id, language: ((_a = app_store.app_store.userPreferences) === null || _a === void 0 ? void 0 : _a.language_id) || 'en', aname: this.p, perma_link: this.perma_link }, false),
                ],
            ];
    ...
    async checkAvailability() {
        ...
        await this.propertyService.getExposedBookingAvailability({
            params: {
                ...
                from_date: index$1.dateFns.format(utils.booking_store.bookingAvailabilityParams.from_date, 'yyyy-MM-dd'),
                to_date: index$1.dateFns.format(utils.booking_store.bookingAvailabilityParams.to_date, 'yyyy-MM-dd'),
                room_type_ids: [],
    ...
    renderScreens() {
        switch (app_store.app_store.currentPage) {
            case 'booking':
                return index.h("ir-booking-page", { adultCount: this.adults, childrenCount: this.child, fromDate: this.checkin, toDate: this.checkout });
            case 'checkout':
                return index.h("ir-checkout-page", null);
            case 'invoice':
                return (index.h("ir-invoice", { version: this.version, headerShown: false, footerShown: false, propertyId: this.propertyId, perma_link: this.perma_link, aName: this.p, language: this.language, baseUrl: this.baseUrl, email: app_store.app_store.invoice.email, bookingNbr: app_store.app_store.invoice.booking_number, status: 1, be: true }));
            case 'booking-listing':
                return (index.h("ir-booking-listing", { version: this.version, startScreen: this.bookingListingScreenOptions, showAllBookings: false, headerShown: false, footerShown: false, propertyid: this.propertyId, perma_link: this.perma_link, aName: this.p, be: true, baseUrl: this.baseUrl, aff: this.aff }));
            case 'user-profile':
    ...
    render() {
        ...
        return (index.h("main", { class: "relative  flex w-full flex-col space-y-5 " }, index.h("ir-interceptor", null), index.h("section", { class: `${this.injected ? '' : 'sticky top-0 z-50'}  m-0 w-full p-0 ` }, index.h("ir-nav", { class: 'm-0 p-0', website: (_a = app_store.app_store.property) === null || _a === void 0 ? void 0 : _a.space_theme.website, logo: (_c = (_b = app_store.app_store.property) === null || _b === void 0 ? void 0 : _b.space_theme) === null || _c === void 0 ? void 0 : _c.logo, currencies: this.currencies, languages: this.languages })), index.h("section", { class: "flex-1 px-4 lg:px-6" }, index.h("div", { class: "mx-auto max-w-6xl" }, this.renderScreens())), !this.injected && index.h("ir-footer", { version: this.version })));
    }
...
//# sourceMappingURL=ir-be.cjs.entry.js.map