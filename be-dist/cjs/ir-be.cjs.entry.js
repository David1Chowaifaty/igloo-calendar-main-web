...
const Token = require('./Token-45b0bd4d.js');
...
const IrBookingEngine = class {
    ...
    async componentWillLoad() {
        ...
        utils.getUserPreference(this.language);
        if (this.property) {
    ...
    handleAppViewChange(newValue, oldValue) {
        if (newValue !== oldValue) {
            localization_store.app_store.app_data.view = newValue;
        }
    }
    setSource(newSource) {
    ...
    async checkAvailability() {
        var _a;
        console.warn('here');
        utils.booking_store.resetBooking = false;
        await this.propertyService.getExposedBookingAvailability({
            ...
            agent_id: ((_a = utils.booking_store.bookingAvailabilityParams.agent) === null || _a === void 0 ? void 0 : _a.id) || 0,
