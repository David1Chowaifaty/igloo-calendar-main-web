...
const availability_service = require('./availability.service-86a44bd2.js');
...
const IrBookingEngine = class {
    ...
    async componentWillLoad() {
        payment_service.axios.defaults.withCredentials = true;
        payment_service.axios.defaults.baseURL = this.baseUrl;
    ...
    async checkAvailability() {
        ...
        await this.propertyService.getExposedBookingAvailability({
            params: {
                ...
                is_in_affiliate_mode: !!app_store.app_store.app_data.affiliate,
                affiliate_id: app_store.app_store.app_data.affiliate ? app_store.app_store.app_data.affiliate.id : null,
            },
    ...
    renderScreens() {
        switch (app_store.app_store.currentPage) {
            ...
            case 'booking-listing':
                return (index.h("ir-booking-listing", { version: this.version, startScreen: this.bookingListingScreenOptions, showAllBookings: false, headerShown: false, footerShown: false, propertyid: app_store.app_store.app_data.property_id, perma_link: this.perma_link, aName: this.p, be: true, baseUrl: this.baseUrl, aff: this.aff }));
            case 'user-profile':
                return (index.h("ir-user-profile", { user_data: {
                        id: property_service.checkout_store.userFormData.id,
                        email: property_service.checkout_store.userFormData.email,
                        first_name: property_service.checkout_store.userFormData.firstName,
                        last_name: property_service.checkout_store.userFormData.lastName,
                        country_id: property_service.checkout_store.userFormData.country_id,
                        mobile: property_service.checkout_store.userFormData.mobile_number,
                        country_phone_prefix: property_service.checkout_store.userFormData.country_phone_prefix.toString(),
                    } }));
            default:
                return null;
        }
