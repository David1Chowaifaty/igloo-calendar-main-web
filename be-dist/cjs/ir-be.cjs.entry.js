...
const common_service = require('./common.service-5e4b3114.js');
const property_service = require('./property.service-128e6af6.js');
const utils = require('./utils-d5a9d664.js');
const localization_store = require('./localization.store-874cf51c.js');
const availability_service = require('./availability.service-27eec045.js');
const checkout_store = require('./checkout.store-6fa2aadc.js');
const payment_service = require('./payment.service-cf54ad66.js');
const v4 = require('./v4-9b297151.js');
const index$1 = require('./index-ac85ebdb.js');
...
const IrBookingEngine = class {
    constructor(hostRef) {
        ...
        this.token = new payment_service.Token();
    ...
    async componentWillLoad() {
        ...
        if (this.property) {
            localization_store.app_store.property = Object.assign({}, this.property);
        }
    ...
    handleCurrencyChange(newValue, oldValue) {
        if (newValue !== oldValue) {
            localization_store.updateUserPreference({
    ...
    setSource(newSource) {
        localization_store.app_store.app_data = Object.assign(Object.assign({}, localization_store.app_store.app_data), { source: newSource });
    }
    modifyLanguage(code) {
        var _a;
        if (!this.languages) {
        ...
        localization_store.changeLocale(((_a = this.languages.find(l => l.code.toLowerCase() === code)) === null || _a === void 0 ? void 0 : _a.direction) || 'LTR', utils.matchLocale(code));
        localization_store.updateUserPreference({
            language_id: code,
        });
    }
    initializeApp() {
        var _a;
        localization_store.app_store.app_data = {
            aName: this.p,
            origin: this.origin,
    ...
    async initRequest() {
        ...
        let requests = [
            ...
            this.propertyService.getExposedProperty({ id: this.propertyId, language: ((_b = localization_store.app_store.userPreferences) === null || _b === void 0 ? void 0 : _b.language_id) || 'en', aname: this.p, perma_link: this.perma_link }),
            this.propertyService.getExposedNonBookableNights({
                porperty_id: this.propertyId,
                from_date: index$1.dateFns.format(new Date(), 'yyyy-MM-dd'),
                to_date: index$1.dateFns.format(index$1.dateFns.addYears(new Date(), 1), 'yyyy-MM-dd'),
                perma_link: this.perma_link,
                aname: this.p,
            }),
        ];
        if (localization_store.app_store.is_signed_in) {
        ...
        if (!p) {
            ...
            let currency = localization_store.app_store.userDefaultCountry.currency;
            if (this.cur) {
        ...
        localization_store.app_store.app_data = Object.assign(Object.assign({}, localization_store.app_store.app_data), { affiliate: utils.checkAffiliate((_c = this.aff) === null || _c === void 0 ? void 0 : _c.toLowerCase().trim()) });
        this.isLoading = false;
    }
    ...
    handleNavigation(e) {
        e.stopImmediatePropagation();
        e.stopPropagation();
        localization_store.app_store.currentPage = e.detail;
    }
    ...
    handleAuthFinish(e) {
        ...
        if (state === 'success') {
            if (payload.method === 'direct') {
                ...
                localization_store.app_store.currentPage = 'booking-listing';
            }
        }
    }
    async resetBooking(resetType = 'completeReset') {
        var _a;
        let queries = [];
        if (resetType === 'partialReset' && localization_store.app_store.fetchedBooking) {
            ...
            queries = [
                ...
                ...[
                    this.commonService.getExposedLanguage(),
                    this.propertyService.getExposedProperty({ id: localization_store.app_store.app_data.property_id, language: ((_a = localization_store.app_store.userPreferences) === null || _a === void 0 ? void 0 : _a.language_id) || 'en', aname: this.p, perma_link: this.perma_link }, false),
                ],
            ];
            if (localization_store.app_store.fetchedBooking) {
                queries.push(this.checkAvailability());
            }
        }
    ...
    async checkAvailability() {
        ...
        await this.propertyService.getExposedBookingAvailability({
            params: {
                propertyid: localization_store.app_store.app_data.property_id,
                ...
                language: localization_store.app_store.userPreferences.language_id,
                currency_ref: localization_store.app_store.userPreferences.currency_id,
                ...
                is_in_affiliate_mode: !!localization_store.app_store.app_data.affiliate,
                affiliate_id: localization_store.app_store.app_data.affiliate ? localization_store.app_store.app_data.affiliate.id : null,
            },
    ...
    renderScreens() {
        var _a;
        switch (localization_store.app_store.currentPage) {
            case 'booking':
            ...
            case 'invoice':
                return (index.h("ir-invoice", { version: this.version, headerShown: false, footerShown: false, propertyId: this.propertyId, perma_link: this.perma_link, aName: this.p, language: (_a = this.language) === null || _a === void 0 ? void 0 : _a.toLowerCase(), baseUrl: this.baseUrl, email: localization_store.app_store.invoice.email, bookingNbr: localization_store.app_store.invoice.booking_number, status: 1, be: true }));
            case 'booking-listing':
                return (index.h("ir-booking-listing", { version: this.version, startScreen: this.bookingListingScreenOptions, showAllBookings: false, headerShown: false, footerShown: false, propertyid: localization_store.app_store.app_data.property_id, perma_link: this.perma_link, aName: this.p, be: true, baseUrl: this.baseUrl, aff: this.aff }));
            case 'user-profile':
    ...
    render() {
        ...
        return (index.h("main", { class: "relative  flex w-full flex-col space-y-5 " }, index.h("ir-interceptor", null), index.h("section", { class: `${this.injected ? '' : 'sticky top-0 z-20'}  m-0 w-full p-0 ` }, index.h("ir-nav", { class: 'm-0 p-0', website: (_a = localization_store.app_store.property) === null || _a === void 0 ? void 0 : _a.space_theme.website, logo: (_c = (_b = localization_store.app_store.property) === null || _b === void 0 ? void 0 : _b.space_theme) === null || _c === void 0 ? void 0 : _c.logo, currencies: this.currencies, languages: this.languages })), index.h("section", { class: "flex-1 px-4 lg:px-6" }, index.h("div", { class: "mx-auto max-w-6xl" }, this.renderScreens())), index.h("ir-privacy-policy", { ref: el => (this.privacyPolicyRef = el), hideTrigger: true }), !this.injected && index.h("ir-footer", { version: this.version })));
    }
