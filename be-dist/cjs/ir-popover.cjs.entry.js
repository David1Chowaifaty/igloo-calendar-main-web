...
const IrPopover = class {
    ...
    initializePopover() {
        if (this.triggerElement && this.contentElement) {
            this.popoverInstance = popper.createPopper(this.triggerElement, this.contentElement, {
                placement: this.placement || app_store.app_store.dir === 'LTR' ? 'bottom-start' : 'bottom-end',
                modifiers: [
                    {
                        name: 'offset',
                        options: {
    ...
    async toggleVisibility() {
        ...
        if (this.isVisible && this.popoverInstance) {
            const currentDir = app_store.app_store.dir.toLowerCase() || 'ltr';
    ...
    render() {
        return (index.h(index.Fragment, { key: 'c5c017a544e560015b6c508a1ee12657ad029dcf' }, this.isMobile && (index.h("div", { class: "w-full md:hidden" }, index.h("div", { class: "w-full", onClick: () => {
                this.dialogElement.openModal();
            } }, index.h("slot", { name: "trigger" })), index.h("ir-dialog", { closeButton: this.showCloseButton, ref: el => (this.dialogElement = el), onOpenChange: e => {
