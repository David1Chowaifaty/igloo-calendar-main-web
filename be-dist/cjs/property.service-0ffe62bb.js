...
class PropertyHelpers {
    ...
    async fetchAvailabilityData(token, props, roomtypeIds, rateplanIds) {
        const response = await Token.axios.post(`/Get_Exposed_Booking_Availability?Ticket=${token}`, Object.assign(Object.assign({}, props.params), { identifier: props.identifier, room_type_ids: roomtypeIds, rate_plan_ids: rateplanIds, skip_getting_assignable_units: true, is_specific_variation: true, is_backend: false }));
...
class PropertyService extends Token.Token {
    constructor() {
        super(...arguments);
    ...
    async getExposedProperty(params, initTheme = true) {
        ...
        const { data } = await Token.axios.post(`/Get_Exposed_Property?Ticket=${token}`, Object.assign(Object.assign({}, params), { currency: app_store.app_store.userPreferences.currency_id, include_sales_rate_plans: !!utils.booking_store.bookingAvailabilityParams.agent }));
        const result = data;
        if (result.ExceptionMsg !== '') {
            throw new Error(result.ExceptionMsg);
        }
    ...
    async getExposedBooking(params, withExtras = true) {
        ...
        const { data } = await Token.axios.post(`/Get_Exposed_Booking?Ticket=${token}`, Object.assign(Object.assign({}, params), { extras: withExtras
                ? [
                    ...
                    [...new Array(rp.reserved)].map((_, index$1) => {
                        ...
                        rooms.push({
                            ...
                            guest: {
                                ...
                                cci: ['001', '004'].includes((_a = checkout_store.checkout_store.payment) === null || _a === void 0 ? void 0 : _a.code)
                                    ? () => {
                                        const payment = checkout_store.checkout_store.payment;
                                        return {
        ...
        try {
            ...
            const body = {
                ...
                booking: {
                    ...
                    referrer_site: app_store.app_store.app_data.affiliate ? window.location.href : 'www.igloorooms.com',
...
//# sourceMappingURL=property.service-0ffe62bb.js.map