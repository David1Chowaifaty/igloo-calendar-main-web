...
const utils$3 = require('./utils-6c8593a1.js');
...
class PropertyHelpers {
    ...
    updateBookingStore(data) {
        try {
            ...
            utils$3.booking_store.roomTypes = [...sortedRoomTypes.map(rt => (Object.assign(Object.assign({}, rt), { rateplans: rt.rateplans.map(rp => (Object.assign(Object.assign({}, rp), { variations: this.sortVariations(rp.variations) }))) })))];
...
//# sourceMappingURL=Token-7b763924.js.map