...
const utils$3 = require('./utils-772f5a2e.js');
...
class PaymentService extends Token {
    ...
    async fetchCancelationMessage(id, roomTypeId, booking_nbr, showCancelation) {
        var _a, _b;
        if (booking_nbr === void 0) { booking_nbr = (_a = utils$3.booking_store.fictus_booking_nbr) === null || _a === void 0 ? void 0 : _a.nbr; }
...
//# sourceMappingURL=common.service-7d90e728.js.map