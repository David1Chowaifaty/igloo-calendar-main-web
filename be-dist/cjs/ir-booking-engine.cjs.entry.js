...
const IrBookingEngine = class {
    ...
    async componentWillLoad() {
        ...
        console.log(app_store.app_store.userPreferences);
    }
    ...
    async initRequest() {
        ...
        const [property, currencies, languages] = await Promise.all([
            this.propertyService.getExposedProperty({ id: this.propertyId, language: ((_a = app_store.app_store.userPreferences) === null || _a === void 0 ? void 0 : _a.language_id) || 'en' }),
        ...
        if (property.space_theme) {
            ...
            const shades = utils.generateColorShades(property.space_theme.button_bg_color);
    ...
    async resetBooking() {
        ...
        if (app_store.app_store.fetchedBooking) {
            await Promise.all([
                ...
                this.commonService.getExposedLanguage(),
                this.propertyService.getExposedProperty({ id: app_store.app_store.app_data.property_id, language: ((_a = app_store.app_store.userPreferences) === null || _a === void 0 ? void 0 : _a.language_id) || 'en' }),
            ]);
            ...
            await Promise.all([
                this.commonService.getExposedLanguage(),
                this.propertyService.getExposedProperty({ id: app_store.app_store.app_data.property_id, language: ((_b = app_store.app_store.userPreferences) === null || _b === void 0 ? void 0 : _b.language_id) || 'en' }),
            ]);
        }
    }
    async checkAvailability() {
        await this.propertyService.getExposedBookingAvailability({
            ...
            is_in_loyalty_mode: !!property_service.booking_store.bookingAvailabilityParams.coupon,
    ...
    renderScreens() {
        switch (app_store.app_store.currentPage) {
            case 'booking':
                return index.h("ir-booking-page", null);
            case 'checkout':
                return index.h("ir-checkout-page", null);
            case 'invoice':
                return index.h("ir-invoice", null);
            default:
                return null;
        }
    }
    render() {
        ...
        return (index.h("main", { class: "relative  flex w-full flex-col space-y-5 " }, index.h("ir-interceptor", null), index.h("section", { class: "sticky top-0 z-50 w-full " }, index.h("ir-nav", { website: (_a = app_store.app_store.property) === null || _a === void 0 ? void 0 : _a.space_theme.website, logo: (_c = (_b = app_store.app_store.property) === null || _b === void 0 ? void 0 : _b.space_theme) === null || _c === void 0 ? void 0 : _c.logo, currencies: this.currencies, languages: this.languages })), index.h("section", { class: "flex-1 px-4 lg:px-6" }, index.h("div", { class: "mx-auto max-w-6xl" }, this.renderScreens())), !this.injected && index.h("ir-footer", null)));
    }
