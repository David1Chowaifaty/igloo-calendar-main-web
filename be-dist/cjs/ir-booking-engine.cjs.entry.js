...
const IrBookingEngine = class {
    ...
    checkAffiliate() {
        var _a;
        if (this.aff) {
            const affiliate = (_a = app_store.app_store === null || app_store.app_store === void 0 ? void 0 : app_store.app_store.property) === null || _a === void 0 ? void 0 : _a.affiliates.find(aff => aff.afname.toLowerCase().trim() === this.aff.toLowerCase().trim());
            if (!affiliate) {
                return null;
            }
            return affiliate;
