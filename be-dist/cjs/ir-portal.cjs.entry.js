...
const IrPortal = class {
    ...
    initializePopper() {
        this.popperInstance = popper.createPopper(this.reference, this.portal, {
    ...
    render() {
        return (index.h(index.Host, { key: '7271d3baccf16f03e8aac5a01b1f664eece957c8' }, index.h("slot", { key: '31854a37635cd9b2bd8451d3577d33939c26a875', name: "portal-body" })));
    }
    get hostElement() { return index.getElement(this); }
};
IrPortal.style = IrPortalStyle0;

exports.ir_portal = IrPortal;

//# sourceMappingURL=ir-portal.cjs.entry.js.map