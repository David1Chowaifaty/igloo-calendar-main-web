...
const utils$3 = require('./utils-70eab1c7.js');
...
class PropertyService {
    ...
    filterRooms() {
        let rooms = [];
        const variationService = new utils$3.VariationService();
                ...
                if (rp.reserved > 0) {
                    [...new Array(rp.reserved)].map((_, index) => {
                        ...
                        rooms.push({
                            ...
                            notes: null,
                            days: this.propertyHelpers.generateDays(utils$3.booking_store.bookingAvailabilityParams.from_date, utils$3.booking_store.bookingAvailabilityParams.to_date, Number(variation.discounted_gross_amount) / utils$3.getDateDifference(utils$3.booking_store.bookingAvailabilityParams.from_date, utils$3.booking_store.bookingAvailabilityParams.to_date)),
    ...
    async bookUser() {
        ...
        try {
            let guest = {
                ...
                cci: utils$3.booking_store.bookingAvailabilityParams.agent && ((_b = (_a = utils$3.booking_store.bookingAvailabilityParams.agent) === null || _a === void 0 ? void 0 : _a.payment_mode) === null || _b === void 0 ? void 0 : _b.code) === '001'
                    ? null
            ...
            const body = {
                ...
                is_pms: false,
                is_direct: true,
                language: (_k = (_j = utils$3.app_store === null || utils$3.app_store === void 0 ? void 0 : utils$3.app_store.userPreferences) === null || _j === void 0 ? void 0 : _j.language_id) !== null && _k !== void 0 ? _k : 'en',
                agent: utils$3.booking_store.bookingAvailabilityParams.agent ? { id: (_l = utils$3.booking_store.bookingAvailabilityParams.agent) === null || _l === void 0 ? void 0 : _l.id } : null,
                is_in_loyalty_mode: utils$3.booking_store.bookingAvailabilityParams.loyalty,
                promo_key: (_m = utils$3.booking_store.bookingAvailabilityParams.coupon) !== null && _m !== void 0 ? _m : null,
                booking: {
                    booking_nbr: '',
                    from_date: utils$3.dateFns.format(utils$3.booking_store.bookingAvailabilityParams.from_date, 'yyyy-MM-dd'),
                    to_date: utils$3.dateFns.format(utils$3.booking_store.bookingAvailabilityParams.to_date, 'yyyy-MM-dd'),
                ...
                extras: [
                    ...
                    prePaymentAmount > 0
                        ...
                        : null,
                    utils$3.booking_store.bookingAvailabilityParams.agent
                        ? {
                            key: 'agent_payment_mode',
                            value: utils$3.booking_store.bookingAvailabilityParams.agent.payment_mode.code,
                        }
                        : null,
                    {
...
//# sourceMappingURL=Token-e78f2fb3.js.map