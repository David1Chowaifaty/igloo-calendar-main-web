...
const IrGuestCounter = class {
    ...
    render() {
        return (index.h("div", { key: '7d49c0fcf0d84b4aac435201a9da992fbe8597bc', class: "counter-container p-4" }, index.h("div", { key: '3aa3faa6004451fbb9793913aa0211ca178971f1', class: "counter-item" }, index.h("div", { key: 'f2d7de6507364d2b5db4bc4ec7c4cb1842a75d90' }, index.h("p", { key: '7a207fa1d9669106237f8b4c63789ef1632a792f', class: "main-text" }, "Adults"), index.h("p", { key: 'bef74bf2f0aeb2f86c235a53a76c636190feb86a', class: "secondary-text" }, "Age ", this.childMaxAge + 1, "+")), index.h("div", { key: 'b267d299e1865237c6c76424f8db3a8242ff56c3', class: "counter-buttons-group" }, index.h("ir-button", { key: '6bef0b0386dfc2d1b959759e25f42638efa1c369', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '4d58ed1fb9b6c027980d9efddcb52c5f2f47a897' }, this.adultCount), index.h("ir-button", { key: '1205190a5249a4a428b357ab2f35b2643fa0e7b0', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), this.childMaxAge > 0 && (index.h("div", { key: 'd64876cf0b0223a029f3d0900c32d9ef6b72eaf3', class: "counter-item" }, index.h("div", { key: '07497cdd28f56aea0b500544e85951dc8e5cfdc0' }, index.h("p", { key: '32c21988695c6b7dd55f2f4ffe4c868c4081eaa0', class: "main-text" }, "Children"), index.h("p", { key: 'f392669492a19cddce35dc82c0e3aed974b5c441', class: "secondary-text" }, "Ages 1-", this.childMaxAge)), index.h("div", { key: 'f693e1c4ab6a5c974e49a83ff49c925af1f69236', class: "counter-buttons-group" }, index.h("ir-button", { key: '528567133bb81af17b178b02e918b90603d26887', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '97b3fe210bc62cd9a128bd4417490efbd9affd61' }, this.childrenCount), index.h("ir-button", { key: '94860a5369daec102dbe1d0bb66ddc6490830da8', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" })))), index.h("ir-button", { key: '14d0d6d92198fb3d7e1469e9b4772bea4e20a161', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
