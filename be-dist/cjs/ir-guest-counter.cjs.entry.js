...
const IrGuestCounter = class {
    ...
    render() {
        return (index.h("div", { key: 'e8baa3e524ac3628f99ab88d7e14357e54f60229', class: "counter-container p-4" }, index.h("div", { key: '03052707a01b93b0b7007c074e1e75a9d87e11e4', class: "counter-item" }, index.h("div", { key: '425c01af0580a3e8e5f9cdea297d482c424b0c63' }, index.h("p", { key: '7bcb058691b53b0cf0f36961a418eac67691ea18', class: "main-text" }, "Adults"), index.h("p", { key: 'c9693687a1d61785b93e85c793285d73ffd999b7', class: "secondary-text" }, "Age ", this.childMaxAge + 1, "+")), index.h("div", { key: '02ac0bf8a1b4a95adddfc2992e0752ca31322804', class: "counter-buttons-group" }, index.h("ir-button", { key: '107b6bc09441750af32461c77eb277364bee3b3e', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '54f43323e471049209d6e0db062d00aea819a515' }, this.adultCount), index.h("ir-button", { key: '54f03999658662b9d3515742ace40dfbf5260373', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), this.childMaxAge > 0 && (index.h("div", { key: 'a66bec2d6e74a4963013983058423b0cbbb98d8e', class: "counter-item" }, index.h("div", { key: '6b93aa43b8c04f9ca64c4d800d19245d3931e6ff' }, index.h("p", { key: '3c899a43eec5ffe1ad602ed4becd2df17681333a', class: "main-text" }, "Children"), index.h("p", { key: '5e20011e6f643a3b2cbc962a647273a6acdcdb62', class: "secondary-text" }, "Ages 1-", this.childMaxAge)), index.h("div", { key: '78de8eef797dcca546b79a44940120a3d05cb95d', class: "counter-buttons-group" }, index.h("ir-button", { key: 'e42d415d8975636374d0a6a94c001617166ae9b1', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: 'f8dbf02927c36547c0eed26597d900db8c630ab7' }, this.childrenCount), index.h("ir-button", { key: 'bf172bb79d20d71d6de38d874b240fab5c798bf3', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" })))), index.h("ir-button", { key: '8597280cb7b897d4151ed79652187ac35bf18a9f', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
