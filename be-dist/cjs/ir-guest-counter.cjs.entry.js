...
const IrGuestCounter = class {
    ...
    render() {
        return (index.h("div", { key: 'ecec458be869a0be53614c50efc370556940a0b3', class: "counter-container" }, index.h("div", { key: '07f337c0f99f87f9d2f1f3e10f28c077cf18dfc4', class: "counter-item" }, index.h("div", { key: 'fa609e6e8f4e8ec06175d8a1803ce638f38bb130' }, index.h("p", { key: '734c56b034f4b09248eb26864a3e07141b5c8567', class: "main-text" }, "Adults"), index.h("p", { key: '99e7dec1c2f845ac5807dfbbd789816580e821dd', class: "secondary-text" }, "Age ", this.childMaxAge + 1, "+")), index.h("div", { key: '160b73868e8feefec5eee74b98daffb6a365f764', class: "counter-buttons-group" }, index.h("ir-button", { key: '848f88a601ab8693b5ce8bc1e009aa0826142021', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: 'f2674e60ec279245ee3abe68ca345175e2253173' }, this.adultCount), index.h("ir-button", { key: 'c0d585bed19a334ab326eee649a9be9527215e5d', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), index.h("div", { key: '619840061fd0efaefdb7cd1e1794aae650101284', class: "counter-item" }, index.h("div", { key: 'ee349de91b884d35adf5519aed92546dfe4c9901' }, index.h("p", { key: '31f3f89d9679b62e458002982760749438b58123', class: "main-text" }, "Children"), index.h("p", { key: '18006d5302f2cbcdbd1775789753f10e37f30527', class: "secondary-text" }, "Ages 1-", this.childMaxAge)), index.h("div", { key: 'dfad623f34ade0cebf313f053b15d8341add5aae', class: "counter-buttons-group" }, index.h("ir-button", { key: '9727282c81c77ec8bd7a86316cfcab784dc3cbb7', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: 'bb72d8569e9c5a7a6ccc91a48479ab74b0232d0a' }, this.childrenCount), index.h("ir-button", { key: 'ab578a0f4a0447b48a037d21722afb4a00fdbea5', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" }))), index.h("ir-button", { key: '39dc263606a522d490cfe35651747a2325c98cb3', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
