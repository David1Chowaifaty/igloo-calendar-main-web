...
const IrGuestCounter = class {
    ...
    render() {
        return (index.h("div", { key: '1a67e0e971948962c17c8c4a5cc59ae7aeb38f70', class: "counter-container" }, index.h("div", { key: '3979662318433fd8fccbdbe1f06d0323fe82ae9a', class: "counter-item" }, index.h("div", { key: '7cb59744140f601fba956949ce533ca2c576f170' }, index.h("p", { key: '2317d5a833ee7c3a2e1e01e0ad52d0cc0a744ff5', class: "main-text" }, "Adults"), index.h("p", { key: '19465632c7da4c6014c998e6b13fb1806c3ba137', class: "secondary-text" }, "Age ", this.childMaxAge + 1, "+")), index.h("div", { key: '3ae036ec3a7a03ae0bd67f2113bb7b3cbe351c4d', class: "counter-buttons-group" }, index.h("ir-button", { key: 'ec8d83f2db0ac6604670abb1fc5fea877137f0c5', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '66af34e40a613ace93260f89d1c2251419ac54a0' }, this.adultCount), index.h("ir-button", { key: '4f86608f6fab88e683083c4058e8752bc3e5fae2', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), index.h("div", { key: '7abc99f1bfae038f39c9aa64db73543130c7d5ba', class: "counter-item" }, index.h("div", { key: 'a1a75c2097b00b66313c0ac0b56c6548869187e5' }, index.h("p", { key: 'cc5a66e7b6b0284db99806768e68a22bc9150485', class: "main-text" }, "Children"), index.h("p", { key: '051f3de35f9e4b50ad9e5e24e4915f9d3ae98803', class: "secondary-text" }, "Ages 1-", this.childMaxAge)), index.h("div", { key: '73a1e848d8a1c0aa3ac688c3924fe553adc2feb7', class: "counter-buttons-group" }, index.h("ir-button", { key: 'a17abc39144dcb2069db9830645fa26a8a9c9319', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: 'c3f33375da6bf73054e3008dd556993148f389b6' }, this.childrenCount), index.h("ir-button", { key: '778f42d3f4d326d7f3ccf2b1f781539c08e38619', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" }))), index.h("ir-button", { key: '4c3a60a281644605e77a577418c397aaf3422ee3', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
