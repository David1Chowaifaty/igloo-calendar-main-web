...
const IrGuestCounter = class {
    ...
    render() {
        return (index.h("div", { key: 'a7a1210accbed17bd92b17d419be6bd09430a011', class: "counter-container p-4" }, index.h("div", { key: '9cb5ea64ffcaaff970ec9b1e4ff34ef82fc384b2', class: "counter-item" }, index.h("div", { key: 'd597d05779ee372a8769cb0fd877f79cac751b16' }, index.h("p", { key: 'da5cd75e2594a0f59a0b9f8f3822ef1c31ff3380', class: "main-text" }, "Adults"), index.h("p", { key: '7d000c22618d6adad29cee9182292bd1084c7c93', class: "secondary-text" }, "Age ", this.childMaxAge + 1, "+")), index.h("div", { key: '7075280a4b1c2dc777c277e3ad72fbd14e921f94', class: "counter-buttons-group" }, index.h("ir-button", { key: 'e8e256c4206ea5833f0228d87521fc64c32f7a43', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '3fc4d6bc8e79537e846cd55e5300cf113c3a81fd' }, this.adultCount), index.h("ir-button", { key: '1a5339be490fd5092e03b9557d9d4102246162fd', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), this.childMaxAge > 0 && (index.h("div", { key: '50095f05cd401e990c2a27ad1c75b0e27e2418eb', class: "counter-item" }, index.h("div", { key: 'f2198810cbc31a7d0eb77e2433dbc91ab72a996b' }, index.h("p", { key: 'fce6f967426e554cbbe3a452ad54898911931379', class: "main-text" }, "Children"), index.h("p", { key: '6fc36ad6d3ae44616ae87b96db8abe008e7160d3', class: "secondary-text" }, "Ages 1-", this.childMaxAge)), index.h("div", { key: 'eda560014ad95e58661e95b169db608020dd662a', class: "counter-buttons-group" }, index.h("ir-button", { key: '5abfec69b454938f1130203c33c22e66ebe1d97b', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: 'c0a2f53c6a92644518016da4f50de880f0358fdb' }, this.childrenCount), index.h("ir-button", { key: 'dc83e3eadb3f0584ce1a3f2d08a91741b69924a2', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" })))), index.h("ir-button", { key: '308e2626bbf1db9e6d5565fca6556d36b061bb90', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
