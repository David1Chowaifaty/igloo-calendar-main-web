...
const IrGuestCounter = class {
    ...
    render() {
        return (index.h("div", { key: '80b5ce573c2fa4b26fc67e03c028b7792369bb44', class: "counter-container p-4" }, index.h("div", { key: '8a29b862ca827424c8c8cf9d54241425c47e7ef9', class: "counter-item" }, index.h("div", { key: '8d7fe416bb44b33a3723d72376952946f9b4c239' }, index.h("p", { key: 'a40011b8b199ae3c0c12be58988593be778d8b5b', class: "main-text" }, "Adults"), index.h("p", { key: '9c33f4ab41f795d5f15576a204bc1a196654f939', class: "secondary-text" }, "Age ", this.childMaxAge + 1, "+")), index.h("div", { key: '579494de7ab14a75142f878b196472943a1edbea', class: "counter-buttons-group" }, index.h("ir-button", { key: 'd80b8209e72601d53fbeca660a49d4a6b6693650', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: 'ae76aa89d5b8b3798d3623069317c5dd49172051' }, this.adultCount), index.h("ir-button", { key: '76ec5836e4bc6477d5637aa4d830100033890586', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), this.childMaxAge > 0 && (index.h("div", { key: 'b9817de7c81417506e723c82d3143b1eedb941fa', class: "counter-item" }, index.h("div", { key: 'ae92010e6de68578bae1773aa3a42c822413cf81' }, index.h("p", { key: '345b5522d2a229a18abb346ae40f1d9b9f10f995', class: "main-text" }, "Children"), index.h("p", { key: '3cb2bba0175cadecc839b0f4fc8784fe771c9f74', class: "secondary-text" }, "Ages 1-", this.childMaxAge)), index.h("div", { key: '72c28598660d8b5da6ba6e5613b7813f4f135823', class: "counter-buttons-group" }, index.h("ir-button", { key: '0b75c1ac099a0d1efa015d5e008f8ce1dbd5553e', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '41d891c63ad920da91c47c7dd98ff89459149299' }, this.childrenCount), index.h("ir-button", { key: 'bf33448244d27f9b15996d323d924d4802dab8cb', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" })))), index.h("ir-button", { key: 'bf3a6953167ec072d084549ca25fb09b94ac4b7c', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
