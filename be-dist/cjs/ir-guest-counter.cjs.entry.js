...
const utils = require('./utils-01e1e9b0.js');
...
const IrGuestCounter = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '663b4e612d8ba085a84b3648d65551b33287c1e8', class: "counter-container p-4" }, index.h("div", { key: '819bea032ff84629e829e0d43d9b68f55ad5779d', class: "counter-item" }, index.h("div", { key: '50f27134254274b3fe3fc906fc68b12cbea743d5' }, index.h("p", { key: 'd69e426e5d7588c8adb312f8f1e902fa8ccfc67f', class: "main-text" }, "Adults"), index.h("p", { key: 'b3a32ddbc06d1e2094af6f0798c1dd00fe6bb55c', class: "secondary-text" }, "Ages ", this.childMaxAge + 1, "+")), index.h("div", { key: 'cb013b8465487a279618e3c45e67ec1b5dd13de4', class: "counter-buttons-group" }, index.h("ir-button", { key: '3d611bf0e7524a1e8094bb518d4d24a939f03e4d', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '462e2d7f52071ae4c153660b732ed59f87ff3b98' }, this.adultCount), index.h("ir-button", { key: 'c30f053c5c704d3c2789e400e077b72d6d4beb77', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), this.childMaxAge > 0 && (index.h("div", { key: 'e16aa63f22081ab70e14f625cee5236fe6d1a65b', class: "counter-item" }, index.h("div", { key: 'fc0987a8f3aad10109927d4dc6c4a964a2a67040' }, index.h("p", { key: '3a3bf38162bf4a1d68d79cffd0b5d036d7a9797e', class: "main-text" }, "Children"), index.h("p", { key: 'b6b9a9aa4ac0b65e8497c87f79cc13709111be04', class: "secondary-text" }, "Ages 0-", this.childMaxAge)), index.h("div", { key: '60d70170073ffbf25732942c45c1e126441da4b0', class: "counter-buttons-group" }, index.h("ir-button", { key: 'f59613110648ba54e5a1207ed3eeac2bdc42c70d', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: 'e948b2ece4a11c5c1c7e395e79a62dbd76171408' }, this.childrenCount), index.h("ir-button", { key: '7f63e0454365ef4e841873618f1f33b58672799f', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" })))), (_a = this.childrenAges) === null || _a === void 0 ? void 0 :
            _a.map((v, i) => (index.h("div", null, index.h("ir-select", { addDummyOption: true, value: v, key: `child_${i}_age`, "data-state": this.error && v === '' ? 'error' : '', variant: "double-line", label: `Child ${i + 1} age`, onValueChange: e => {
                ...
                })) }), this.error && v === '' && index.h("p", { class: 'm-0 p-0 text-xs text-red-500' }, utils.localizedWords.entries.Lcz_enterchildage)))), index.h("ir-button", { key: 'cadff0ba02fd437ab7654818e2b6265a0194c0fe', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
