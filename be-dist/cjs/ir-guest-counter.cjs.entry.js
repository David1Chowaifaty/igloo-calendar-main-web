...
const IrGuestCounter = class {
    ...
    render() {
        return (index.h("div", { key: 'bc4f77bfc92ec9147aef97a59901604adc4d6a00', class: "counter-container p-4" }, index.h("div", { key: '990492adb5c3ff8525b238a54ea2e8fde54cc870', class: "counter-item" }, index.h("div", { key: 'b89c07e464e2c8f42ff78d993fb70219ceefad55' }, index.h("p", { key: '4791cfc3fb325d68ac249c164dc869872aa59c81', class: "main-text" }, "Adults"), index.h("p", { key: 'c3c53a552fea2eeac9d5f2ae5fbeeab7bd47f70c', class: "secondary-text" }, "Age ", this.childMaxAge + 1, "+")), index.h("div", { key: 'b44b4d843793db59ecd4d7d19655057274e613ba', class: "counter-buttons-group" }, index.h("ir-button", { key: '9772d9be6e5851547373d2da4a5226b4a04c373d', iconName: "minus", disabled: this.adultCount === this.minAdultCount, variants: "icon", onButtonClick: this.decrementAdultCount.bind(this), "aria-label": "Decrease adult count", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '4f17a860b5d0f576e7761bfdb3be70b6510407f6' }, this.adultCount), index.h("ir-button", { key: '0d573eb44c63ca91a8469d68fbf1d4d1a8be6812', iconName: "plus", disabled: this.adultCount === this.maxAdultCount, variants: "icon", onButtonClick: this.incrementAdultCount.bind(this), "aria-label": "Increase adult count", svgClassName: "h-[14px] w-[12.25px]" }))), this.childMaxAge > 0 && (index.h("div", { key: 'd79ee47d3f41b9fa67abe693ce8f892f8d8c1b10', class: "counter-item" }, index.h("div", { key: '1bb74184df1e458dea274e63c11ceda510c6294a' }, index.h("p", { key: 'aad289ffb69affff867464ee0d2c997c22fc4020', class: "main-text" }, "Children"), index.h("p", { key: '0c3b5a2b03610cc4edecd713f80c19f38a2de8b0', class: "secondary-text" }, "Ages 1-", this.childMaxAge)), index.h("div", { key: '263fd49b23208c95f4835a07e7d65f7540839f8a', class: "counter-buttons-group" }, index.h("ir-button", { key: '7bfe93abe1515012fd609306253c215472255747', disabled: this.childrenCount === this.minChildrenCount, variants: "icon", onButtonClick: this.decrementChildrenCount.bind(this), "aria-label": "Decrease child count", iconName: "minus", svgClassName: "h-[14px] w-[12.25px]" }), index.h("p", { key: '266d8942cef9f1f49adbed5ebf9083d5cce780b3' }, this.childrenCount), index.h("ir-button", { key: '094e9605028b5b3f40abbae013ee3c5c9dcd85b3', disabled: this.childrenCount === this.maxChildrenCount, variants: "icon", onButtonClick: this.incrementChildrenCount.bind(this), "aria-label": "Increase child count", iconName: "plus", svgClassName: "h-[14px] w-[12.25px]" })))), index.h("ir-button", { key: '8b70f6cb7b3bf47d811ac82750401278cab2e976', onButtonClick: this.addChildrenAndAdult.bind(this), size: "md", class: "done-button",
