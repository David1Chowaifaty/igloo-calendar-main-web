...
const utils$3 = require('./utils-cf3ca506.js');
...
class PropertyHelpers {
    ...
    updateBookingStore(data) {
        try {
            ...
            utils$3.booking_store.roomTypes = [...sortedRoomTypes.map(rt => (Object.assign(Object.assign({}, rt), { rateplans: rt.rateplans.map(rp => { var _a; return (Object.assign(Object.assign({}, rp), { variations: (_a = rp.variations) === null || _a === void 0 ? void 0 : _a.reverse() })); }) })))];
...
//# sourceMappingURL=Token-390571d5.js.map