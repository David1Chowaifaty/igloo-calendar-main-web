...
const IrOptionDetails = class {
    ...
    render() {
        ...
        return (h(Host, null, h("form", { class: 'p-1 mt-2', onSubmit: this.saveOption.bind(this) }, payment_option_store.selectedOption.code === '005' ? (h("div", null, h("div", { class: "mb-1" }, h("ir-select", { selectedValue: this.selectedLanguage, LabelAvailable: false, showFirstOption: false, data: payment_option_store.languages.map(l => ({
                text: l.description,
                value: l.id.toString(),
            })) })), h("div", null, this.invalid && h("p", { class: "text-danger p-0 m-0" }, "You must fill out the english field."), h("ir-textarea", { placeholder: "", "aria-invalid": this.invalid ? 'true' : 'false', textareaClassname: "money-transfer-form", label: "", onTextChange: this.handleTextAreaChange.bind(this), value: (_a = payment_option_store.selectedOption.localizables[this.localizationIdx].description) !== null && _a !== void 0 ? _a : '' })))) : (h("div", null, (_b = payment_option_store.selectedOption.data) === null || _b === void 0 ? void 0 : _b.map((d, idx) => {
            var _a, _b;
            return (h("fieldset", { key: d.key }, h("ir-input-text", { value: d.value, onTextChange: e => this.handlePaymentGatewayInfoChange(e, idx), id: `input_${d.key}`, label: d.key, placeholder: "", "aria-invalid": this.invalid && (d.value === null || ((_b = ((_a = d.value) !== null && _a !== void 0 ? _a : '')) === null || _b === void 0 ? void 0 : _b.trim()) === '') ? 'true' : 'false' })));
        }))), h("div", { class: 'd-flex flex-column flex-sm-row mt-3' }, h("ir-button", { onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill mr-sm-1`, icon: "", text: 'Cancel', btn_color: "secondary", btn_type: "button" }), h("ir-button", { btn_type: "submit", btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: isRequestPending('/Handle_Payment_Method'), text: 'Save', btn_color: "primary" })))));
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: 'bf6bbfe4529f6a454eb59a3262e015354eed5b68', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '593e531d92ad8db63aa3fbd9491b554032c05ed9', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '6d6302ba3b33245e893676752652eb7f8d6d0b6e', class: 'sidebar-title' }, h("p", { key: 'd0b41c25133998f41484251cfbc9514adc8cb6c4', class: 'p-0 m-0' }, this.label), h("div", { key: '2648826b1ae736a7b9d59d5bc0d65cc9601fd720', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '31000db74995fc681432b7fc0f0fcd3c971e707d', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '60e44999dc8e3e59f0531fd214ebd4f879050734', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '84a8dce12efa851e4f86e8cba3b4f74577f755c5', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '10f09cfb0b3910e74be25a4540bd36ec32e52e99', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (h(Host, { key: '5f54b8c9214947a1c3cbf59386c34823afe0dc6b' }, h("button", { key: '3c525722d5b6a93fc595ec6104360112f73d6940', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, h("span", { key: '1cd056254c5f6846aa6c3e2d19f51e515cc01326', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), h("input", { key: 'eb6e3417af122923a1e7d1d59077e009ab667893', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: '0fbefd9b39f29e3f465e6164d7353f45351fa294' });
    }
