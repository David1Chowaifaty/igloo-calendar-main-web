...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (h("wa-card", { key: '8b5404abf73865fefc4080c939bae965edc8f7a0', class: expanded ? '' : 'filters__card__collapsed' }, h("div", { key: '7cf7d000e93b04706b3093ca4d2f077070cc6d28', part: "header", class: "filters__header", slot: "header" }, h("div", { key: '8273af4968c0e3e3e356b940c39324b766058bc1', class: "filters__title-group" }, h("wa-icon", { key: '823e05139fb82823956f1bad740c2e74a94c9305', name: "filter", style: { fontSize: '1rem' } }), h("h4", { key: 'c5ccd06991ff86b9edeffe54f5aee89f32289fd5', class: "filters__title" }, "Filter")), !this.isDesktop && (h("ir-custom-button", { key: '1f7e4d4ce1a46faa840ff700db73b487bc56fb99', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '8328cf1b1af23ff889ceb10a5ba51c17368155e1', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), h("div", { key: '16363af45f950b5b6a217fff42e6153a10562395', part: "filter-body", class: 'filters__body' }, h("slot", { key: '440e19eac84700270ffb4fa342a08cb6165e3a05' })), h("div", { key: 'f4162427298cbede8054a0b6eee33c180f620b3e', part: "footer", class: 'filters__actions' }, h("slot", { key: 'defd4f2fadf39f457e808b5c101057526cccdcbb', name: "footer" }))));
    }
};
