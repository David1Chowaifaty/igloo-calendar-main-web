...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (h("wa-card", { key: '4c661fa1bce5bf35475490c81b7ee3a9541355b7', class: expanded ? '' : 'filters__card__collapsed' }, h("div", { key: '70168ce10b0d5feb3ba4162850a2828b19082879', part: "header", class: "filters__header", slot: "header" }, h("div", { key: '73e4197081599bf1d92d5e190f74612d40f68633', class: "filters__title-group" }, h("wa-icon", { key: '249a608210843c242752c109e4794ef1e429b83b', name: "filter", style: { fontSize: '1rem' } }), h("h4", { key: 'b37a02d4881509a87494d98cc1a7d07492c211de', class: "filters__title" }, "Filter")), !this.isDesktop && (h("ir-custom-button", { key: '43b56aa4ab77871b27803d2bc6e60ffa2530432e', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '4a49ac2efc0b18706bb56c37de7152b9e07d10ab', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), h("div", { key: '7f94c832dfd944827bcc878c6a397abc74deef32', part: "filter-body", class: 'filters__body' }, h("slot", { key: '0de1a2ece193d65f5d4d5f293f47e9b0f32e9980' })), h("div", { key: 'aec07ba346da2cf0abae581a542ad43846d4cdaf', part: "footer", class: 'filters__actions' }, h("slot", { key: '1bc49dc970f970b054e60412922bf049c0ec421f', name: "footer" }))));
    }
};
