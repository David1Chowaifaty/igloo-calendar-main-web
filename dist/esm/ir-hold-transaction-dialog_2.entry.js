...
const IrHoldTransactionDialog = class {
    ...
    render() {
        ...
        return (h(Host, { key: '336f84db437f8820b4c40674870a70cf4a907288' }, h("ir-dialog", { key: '986f5ce1578a535a95c07b7f12d0db97e64a33cd', label: isHeld ? 'Revert Transaction' : 'Hold Transaction', ref: el => (this.dialogRef = el) }, h("div", { key: '5a07e84d2a0e84bc46aa605a962ad5316a82b4f5', class: "hold-dialog__body" }, isHeld ? (h("p", null, "Revert this transaction back to ", h("strong", null, "Unbilled"), " status? It will re-enter the billing queue.")) : (h("p", null, "Place this transaction on ", h("strong", null, "Hold"), "? It will be excluded from invoicing until released."))), h("div", { key: '6b9940a529686a4fbe61f2032dfc40b9ec9a2594', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '8e3e90baaa686144a9fa3da6d059966b8d6a3cf4', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: '96177672ba71a26254d6d845a194605b0f9a3178', size: "medium", loading: this.isLoading, onClickHandler: () => this.handleConfirm(), appearance: "accent", variant: "brand" }, "Confirm")))));
    }
};
