...
const IrHoldTransactionDialog = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'afb8e18d2ec6ecf0081f41b75fd22c50d2e83211' }, h("ir-dialog", { key: '6c73c63f85599e76fbfed861664bee697d2449df', label: isHeld ? 'Revert Transaction' : 'Hold Transaction', ref: el => (this.dialogRef = el) }, h("div", { key: 'caf48e2d1ba5bf209bf01eeb77ebd3f119a1724d', class: "hold-dialog__body" }, isHeld ? (h("p", null, "Revert this transaction back to ", h("strong", null, "Unbilled"), " status? It will re-enter the billing queue.")) : (h("p", null, "Place this transaction on ", h("strong", null, "Hold"), "? It will be excluded from invoicing until released."))), h("div", { key: '91349fe5c2ab4f56a604d619a80ed12c12a993cf', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '3a1b8979ec486ec670e3172aafed9d2b9732f9a0', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: '2f22e482523c5277a66f70f398b1c8e622fa75db', size: "medium", loading: this.isLoading, onClickHandler: () => this.handleConfirm(), appearance: "accent", variant: "brand" }, "Confirm")))));
    }
};
...
const IrInputCell = class {
    ...
    render() {
        return (h("div", { key: '7337830a8861d3fb4411e1128c4b3c83e61e3945', onDblClick: () => {
                if (this.disabled) {
                    return;
                }
                if (!this.active) {
