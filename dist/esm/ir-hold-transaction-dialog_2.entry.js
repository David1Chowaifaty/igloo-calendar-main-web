import { r as registerInstance, c as createEvent, h, H as Host, d as getElement } from './index-JbQjGrUG.js';
...
const IrInputCell = class {
    ...
    render() {
        return (h("div", { key: '83abb540462f57fbcd57dc35222e085608c016a9', onDblClick: () => {
                if (this.disabled) {
                    return;
                }
                if (!this.active) {
