...
const IrDailyRevenueFilters = class {
    ...
    render() {
        return (h("div", { key: 'c7521f4ac98498f4067e7a5a28e0cfd3e95211cb', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, h("div", { key: '64943f67c3ddc006788d72bb9a820e649408c05b', class: "d-flex align-items-center justify-content-between sales-filters-header" }, h("div", { key: '7f164a33f85b8c08adfcf25b7a727d65477c9de3', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: '10ffa2aa6ff29434be10dbc01fcf3c0a5cbf3aec', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'e7d06d4c2bd32dc77099a4842dbd5f77a0a497bd', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'c2dff065ad5003a5c3a05148eb27ddedec19a17a', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '774035e66881f045c74ec9b403341a08c468f13a', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#dailyRevenueFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "dailyRevenueFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: '166af9f8b88df5dd1f5479c7c48869bc9c897e78', class: "m-0 p-0 collapse filters-section", id: "dailyRevenueFiltersCollapse" }, h("div", { key: 'c8bf13c570797fa803184b1e1f839cda1afed9f5', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'c8c0ba51cdaaa4ef41872e22ec41329b97dc649b', class: "pt-1 filter-group" }, h("label", { key: 'c8c40767ac3568f17c028f38364bbe8ddac42e98', htmlFor: "period", class: "px-0 m-0", style: { paddingBottom: '0.25rem' } }, "Selected period"), h("div", { key: '941bb09bebeacca9acba113a8f0045f2e0ce857d', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, h("ir-select", { key: 'c1caf5de7c9e4656df118cb1866ac0e2f502724c', selectedValue: this.filters?.date?.toString(), onSelectChange: e => {
            ...
            firstOption: "...", data: this.getLast30Days() }), h("p", { key: '460503bb7df398b87cc6472497ced47a2972e0f8', class: "m-0 p-0 text-center" }, "Or"), h("ir-range-picker", { key: 'ab69fcd266fe130fb72f365a17e008f68fcf40d1', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, fromDate: hooks(this.filters?.from_date, 'YYYY-MM-DD'), toDate: hooks(this.filters?.to_date, 'YYYY-MM-DD'), maxDate: hooks().format('YYYY-MM-DD'), withOverlay: false }))), h("div", { key: 'cf4ccba392b13738f6054d3b75676694b55fc979', class: "d-flex mt-1 align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, h("ir-button", { key: 'eb6764f938d49889838afe80c467d8b3899353e5', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: '868a2e56873c2b03078032603d5030d83116ba72', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
