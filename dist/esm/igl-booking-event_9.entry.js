...
import { B as BookingService } from './booking.service-9a337d1a.js';
import { t as transformNewBooking, w as isBlockUnit, c as calculateDaysBetweenDates, h as hooks, C as compareTime, D as createDateWithOffsetAndHour, p as calendar_dates, d as dateToFormattedString, E as getDaysArray, F as convertDatePrice, G as formatDate } from './utils-42064951.js';
import { E as EventsService } from './events.service-f5c27134.js';
...
import { T as ToBeAssignedService } from './toBeAssigned.service-b6efee17.js';
...
const IglCalBody = class {
    ...
    getRoomsByCategory(roomCategory) {
        ...
        return (_a = this.getCategoryRooms(roomCategory)) === null || _a === void 0 ? void 0 : _a.map(room => {
            ...
            return (h("div", { class: "roomRow" }, h("div", { class: `cellData room text-left align-items-center roomHeaderCell  roomTitle ${this.getTotalPhysicalRooms(roomCategory) <= 1 ? 'pl10' : ''} ${'room_' + this.getRoomId(room)}`, "data-room": this.getRoomId(room), onClick: () => {
                ...
                } }, h("ir-interactive-title", { hkStatus: room.hk_status !== '001', popoverTitle: this.getTotalPhysicalRooms(roomCategory) <= 1 ? this.getCategoryName(roomCategory) : this.getRoomName(room) })), this.getGeneralRoomDayColumns(this.getRoomId(room), roomCategory, room.name)));
        });
    }
    getRoomRows() {
        var _a;
    ...
    render() {
        ...
        return (h(Host, { key: 'd587b3ba5d015b45578355d62dbd3f64e5a40a62' }, h("div", { key: '5dc23e1159204a866d72b47f4cf98df499f15c64', class: "bodyContainer" }, this.getRoomRows(), h("div", { key: '51831b57d6697ffb2336b143cb71aefcd3b7da31', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglCalHeader = class {
    ...
    render() {
        return (h(Host, { key: '51f68e9d1ccbb6424ee589be989d3a4ca313df91' }, h("div", { key: '176d54dd3dacce8ea2a95d2c0466bb6eb65ea817', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, h("div", { key: '544a3cebf62c8458bfff1ca15cf1f40bb4f7ac2f', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (h("ir-button", { key: '1ba771805c3d5643d561ab8e458da44727fca046', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), h("ir-date-picker", { key: 'c980f0a47f70fd1ecf7a8be113a17c7d6403dd48', minDate: hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
...
const IrInteractiveTitle = class {
    ...
    render() {
        return (h(Host, { key: 'da39da707972fb12e74f1652d00cf9be42f86612', style: { '--ir-popover-left': this.irPopoverLeft } }, h("p", { key: 'b90aea99dd8be01c211c8c9e4c4498f244268dcc', class: "popover-title", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, h("span", { key: '43fb9a93b0f1c2d98bb7778c31a2dc50e1051497', ref: el => (this.croppedTitleEl = el), class: "croppedTitle" }, this.croppedTitle), this.hkStatus && (h("div", { key: '4a99cf3c92051651f5317bf6ce56133c834a30e6', title: "This unit is dirty", class: `hk-dot` }, h("svg", { key: '909e3571f88b91217d9da329b01213c7d8dc141b', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512" }, h("path", { key: '0cb472baaaccce5fea3855b3b20af5ea59064e11',
            // fill="currentColor"
