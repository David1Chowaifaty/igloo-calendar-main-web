...
import { t as transformNewBooking, n as isBlockUnit, a as calculateDaysBetweenDates, v as compareTime, w as createDateWithOffsetAndHour, k as dateToFormattedString, x as getDaysArray, y as convertDatePrice, A as formatDate } from './utils-47ed7fdc.js';
import { h as hooks } from './moment-ab846cee.js';
import { E as EventsService } from './events.service-244a704b.js';
import { l as locales } from './locales.store-53ec3957.js';
import { H as HouseKeepingService } from './housekeeping.service-64b661f9.js';
import { c as calendar_dates } from './calendar-dates.store-10b2707b.js';
import { c as calendar_data } from './calendar-data-26906e0c.js';
import { T as ToBeAssignedService } from './toBeAssigned.service-6fadf01c.js';
...
import './booking.store-910c3544.js';
import './index-c1c77241.js';
import './booking.service-79a5db522.js';
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '7dcc4c0cb50bf69f456af3f2879f04eeddf57c4c', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, h("div", { key: 'debd25cfc192f21253fd458d34de44c3c320f36e', class: `bookingEventBase  ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, h("div", { key: '013854bdfd6acdd2394e65891bea94766ce097ea', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), (this.bookingEvent.is_direct || isBlockUnit(this.bookingEvent.STATUS_CODE)) && (h(Fragment, { key: 'f64f79d88efa06f7b9405dcfc26a162cd3c9e2f4' }, h("div", { key: 'a951f75538d67bf3de088a402b4e9ac1b2c806ee', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), h("div", { key: '75cf736aba7f0e59db4c82461a72c39c14ffe7cc', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglCalFooter = class {
    ...
    render() {
        return (h(Host, { key: 'c1e80a82c616f424fa4915a3d443af8db7eba435', class: "footerContainer" }, h("div", { key: '6ad24e188ecc0240bc652db90c4b7a7c26a7738e', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, h("div", { key: 'e7eb92c0a57f58f54ab349d8dc75642f8ac50841', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, h("i", { key: 'ec7d93258618295e740ba65b90f10e28ecd4e1f0', class: "la la-square" }), h("u", { key: 'f29eca8c46aac405c4eb72e03884b9effbe3138d' }, locales.entries.Lcz_Legend), h("span", { key: '2bc43c1bd49287626fa96f41da0301d994b018e7' }, " - v1.007"))), this.calendarData.days.map(dayInfo => (h("div", { class: "footerCell align-items-center" }, h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (h(Host, { key: '78b143f0b1196395199c22db661148b38359fa81' }, h("div", { key: 'ea49bf7d76e4a96f234f5e08a1fc15da7a1d8043', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, h("div", { key: 'e22a5478247bf28aa3f35765aea57afeb1903e8b', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (h("ir-button", { key: '97edb4907640ac6ce7cc828dd3ae01e0f077c9b7', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), h("ir-date-picker", { key: '2f9b89721b31768ee67023c2426b540529970fbe', minDate: hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'd5f7fa759f4dce4af8b8e5d8fce137d19c50b05e' }, h("div", { key: '17937baaae3e4237b40a75013c90d110fe59530f', class: "sectionContainer" }, h("div", { key: 'e090baa9fb3607c50b50befa93203640455941d6', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
