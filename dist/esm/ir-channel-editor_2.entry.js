...
import './calendar-data-46cc7189.js';
...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '4d37925833b0b6a688e50214c099ceede77eb409', class: " d-flex flex-column h-100" }, h("nav", { key: 'be03ef607a7b4eea514de246e40a94db892f8ac4', class: "px-1 position-sticky sticky-top py-1 top-0 bg-white" }, h("div", { key: 'a02e86af1a4362ddaff849ef96ad939d0f712742', class: "d-flex align-items-center  justify-content-between" }, h("h3", { key: 'ddadba159dd8390983afa554d408b87854a53db2', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), h("ir-icon", { key: 'a25210922adf6038770f4d6bed5f826c42365789', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: 'bc2dadf926d154756a8a7bf64fc613091ec8bfe3', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '682362c10fa58ab25d0ac6ce779042e3f72b0e3c', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), h("ir-channel-header", { key: '50177bfcc4ef877b8dd455b36309a4fd3c9dc4e1', class: "mt-1 px-0", headerTitles: this.headerTitles })), h("section", { key: '42612b5b8401e0129e6de8cdf678c1ff46dc0d1e', class: "py-1 flex-fill tab-container px-1" }, this.renderTabScreen()), h("ir-button", { key: 'dd1d112d5904457e0a3babb2ce2db6f02ee1c25b', isLoading: this.isLoading, onClickHanlder: () => this.saveConnectedChannel(), class: "px-1 py-1 top-border", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Save })));
    }
};
