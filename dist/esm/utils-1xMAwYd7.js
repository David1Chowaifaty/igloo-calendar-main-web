...
const ExtraServiceSchema = libExports.z.object({
    ...
    pr_id: libExports.z.number().nullable().optional().default(null),
    room_identifier: libExports.z.string().nullable().optional().default(null),
    ...
    from_time: libExports.z.string().optional().nullable().default(null),
    to_time: libExports.z.string().optional().nullable().default(null),
 ...
 */
function calculateTrend(current, previous, decimals = 0) {
    if (previous === 0) {
...
export { getNextDay as A, addTwoMonthToDate as B, computeEndDate as C, convertDMYToISO as D, AgentBaseSchema as E, AgentsTypes as F, ExposedAgentsPropsSchema as G, ExposedAgentPropsSchema as H, HandleExposedAgentPropsSchema as I, AgentSchema as J, getFormSubmitter as K, ExtraServiceSchema as L, toFloat as M, getEntryValue as N, renderTime as O, calculateTrend as P, validateSharedPerson as Q, ROOM_IN_OUT as R, ZSharedPerson as Z, canCheckout as a, checkMealPlan as b, canCheckIn as c, checkUserAuthState as d, downloadFile as e, formatAmount as f, groupEntryTablesResult as g, dateDifference as h, isBlockUnit as i, isPrivilegedUser as j, extras as k, sleep as l, manageAnchorSession as m, getDaysArray as n, convertDatePrice as o, formatDate as p, handleBodyOverflow as q, getReleaseHoursString as r, showToast as s, dateToFormattedString as t, convertDateToTime as u, convertDateToCustomFormat as v, validateEmail as w, findCountry as x, isWeekend as y, formatLegendColors as z };
