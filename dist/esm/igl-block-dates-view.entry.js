...
import { B as BookingService } from './booking.service-230ca55b.js';
...
const IglBlockDatesView = class {
    ...
    render() {
        return (h(Host, { key: '56e01d7c2546307563b31883cb93e0fa8f75d44a' }, h("div", { key: '3ef96e192fbc15d0dc5eeb4585b70de252607229', class: `m-0 p-0 mb-1` }, h("div", { key: '52e17026e044161a9f55785c5cc433cecd944f55', class: "text-left p-0" }, h("ir-date-view", { key: '7a43971e899b2e633cd35d1d4b49e3ca27fa30bc', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), h("div", { key: '89b87978f6480265f331706d454f407b8343ec97', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, h("div", { key: 'de99a6edb242bba5c276a75076e5216f4016a2ea', class: "mb-1 " }, h("label", { key: '866d4b30519c2c91a7ca304ab5ca27cbd8a2f0cd', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales.entries.Lcz_Reason, ":"), h("div", { key: '1a1df9a4e889588baf3693753cec1b3335a39a39', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, h("input", { key: '04fc08cfd21fe6d1a6944ebfa139fd8f7bbfeab6', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), h("span", { key: '78da223396579ef573bddb1f912859da4abcd2d8', class: "align-middle out-of-service-label" }, locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (h("div", null, h("div", { class: "mb-1 d-flex  align-items-center" }, h("span", { class: "align-middle" }, locales.entries.Lcz_Or, " "), h("div", { class: "d-inline-flex col pr-0 align-middle" }, h("input", { class: "form-control", type: "text", placeholder: locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), h("div", { class: "mb-1 w-100 pr-0 " }, h("span", { class: "text-bold-700 font-medium-1" }, locales.entries.Lcz_AutomaticReleaseIn, ": "), h("div", { class: "d-inline-block" }, h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (h("div", { class: "d-inline-block releaseTime" }, h("em", null, locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
