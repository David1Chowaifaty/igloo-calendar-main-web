...
import { d as dateDifference, i as isBlockUnit } from './utils-CKFOUZvS.js';
...
function isEarlyCheckout(room) {
    ...
    return hooks().startOf('day').isBefore(hooks(room.to_date, 'YYYY-MM-DD'), 'day');
}
...
export { DAY_USE_STATUS_ICON as D, calculateDaysBetweenDates as a, compareTime as b, calendar_dates as c, createDateWithOffsetAndHour as d, getPrivateNote as e, formatName as f, getMyBookings as g, buildSplitIndex as h, getSplitRole as i, isEarlyCheckout as j, addCleaningTasks as k, getRoomStatus as l, cleanRoom as m, addRoomForCleaning as n, transformNewBLockedRooms as o, bookingStatus as p, getDayUseUnitAvailability as q, formatDayUseStatusText as r, transformNewBooking as t };
