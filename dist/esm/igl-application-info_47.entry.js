...
const IrBookingHeader = class {
    ...
    render() {
        return (h("div", { key: 'af768a9ae460d1a412b56286520bf6c6074eed4b', class: "fluid-container p-1" }, h("div", { key: 'e279daa73e44948b11c498a219cfff5a145f1cb3', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, h("div", { key: '2325ed5bcb9d69563a3569290b67de85317a3b7a', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, h("p", { key: '45cbb5e0e1c0d9e9001a42e6b86c08b3e69aaa3d', class: "font-size-large m-0 p-0" }, `${locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), h("p", { key: '223460533fb43b7690a81877da78205b6f7bda4e', class: "m-0 p-0" }, !this.booking.is_direct && h("span", { key: '72bbcb90670e850e2b41409c1ee7cd56c32872e8', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), h("div", { key: '69ac3417a0af136ddcc96339dc54c0e1b878974d', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, h("span", { key: 'b4a167cc973654093ca0ba69a7164219bc2efde3', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (h("div", { key: 'a3aa31cdda09a3fc8c4cd9a1571d8d4620b34238', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, h("ir-select", { key: '230d7be4868273187200b3310f8ee63f2083d9f7', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), h("ir-button", { key: 'ef7a58a20a41d8e800573e306836543c4d587b7f', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), h("ir-button", { key: 'c32e5842743374cc3f07328a8f6eeb043457afb7', size: "sm", btn_color: "outline", text: locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendar_data.is_pms_enabled && (h("ir-button", { key: 'e23f5eda9e0b21f47c7850aa2c41131f28e3cb1a', size: "sm", btn_color: "outline", text: locales.entries.Lcz_pms, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && h("ir-button", { key: 'bcf794a8529b4a5efa3540943db199141bc37037', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && h("ir-button", { key: '62e3b7f5b16d04fea077bf2e2f2d5b98bd9bbc22', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && h("ir-button", { key: '5a4d0831978923d047582d6bb1d8736c55803d32', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && h("ir-button", { key: '5de8eba7d34193adaa83eee8764b91be06665550', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (h("ir-button", { key: '584b5ba254968194465dea4d884dc4bc5b39c1ff', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), h("ir-dialog", { key: '110dcf28cce0d0f1e48e0209805412854426363d', onOpenChange: e => {
                if (!e.detail) {
...
const IrRoom = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '97cf2fbe4f2063ae0987bd842fb706265c43175d', class: "p-1 d-flex m-0" }, h("ir-button", { key: '95e2f15b57330807911ee3aeaee12fcbec42c15e', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '81dc9e07db2dc8c3c592c4b5489ab40cefa52bbd', class: "flex-fill m-0 " }, h("div", { key: 'f37966ffb914f41c539b64f2a460d3ca78e20aa4', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '9e727448b20092822a60958a30a5d2630bad310e', class: "m-0 p-0" }, h("span", { key: 'f580bed05eafbe6f14881d058a8c9a61609dd7c6', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.item.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '5b366179af95c01358c519e1c3489ad64a02a607', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: '40781326d36e0cd1635aaa09eee9dbacbfafc11c', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: '79f2ca179a5914528cc5ed7ed6cffd5759cae4a4', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '4b9f53ea08f27cd81e69071b1bec02543847a783', variant: "icon", onClickHandler: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: '5f899c3c4a70df916fd73243ef2390bedb6afae6', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: '1e9a4bddfe4030f5c78e57a69b282acb639d3492', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && h("ir-button", { key: '28319088f734edc7ebf3850eebf40f4cef040208', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && h("ir-button", { key: 'd074bd3fa3a120cb07a37e274257ca4bb56ba481', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !isSingleUnit(this.item.roomtype.id) && calendar_data.is_frontdesk_enabled && this.item.unit && (h("div", { key: 'c4a46bce81b0fbcf860338ded9d8e94ecd6e003f', class: 'd-flex justify-content-end' }, h("span", { key: '97c958a8de59fde871d7c777213b8299120e4b77', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), h("div", { key: 'b17db41d14333c57e30918370437eba6f2a789d5' }, h("span", { key: 'ea30804b53343240c62ccbf407dc7efa0440ba54', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && h("span", { key: 'a5b7f13dec4b53c211d621ff276aaa38fc8ce3ec', innerHTML: this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy) }, " ")), h("div", { key: '136aacce4b4ccc7486cf00e6366ef5edca178a5b', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, h("div", { key: 'f603a98d5899e4c27bb660133484244d6544555a', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: 'baa080d74de94ec40d631be32f0db2959ce858b1', class: " sm-padding-top" }, h("p", { key: '871a4f11a70da52431f438facea973fe8001c51a', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '34ba8d7704b6c8d169325289231a49ea2f28e2cc', class: 'flex-fill' }, h("table", { key: 'e456b696d85d998c2032c4839366d52e7345efb5' }, this.item.days.length > 0 &&
            ...
            }), h("tr", { key: '341ca8f60aeb12cf3703cc2c87925ec351b629af', class: '' }, h("th", { key: '9303bdd3ce02e1d025702a1daf7b208de2e1d539', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '4dbbed3cacc1e7a93ea7f7bc9af41ff28cf35fb1', class: "text-right subtotal_row" }, formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && h("th", { key: '2d91801acbf004199e19c8afed0991aa48fe8520', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), this.item.rateplan.cancelation && (h("ir-label", { key: 'ff937453481df50bf918940dca2e6a2d87024ecd', labelText: `${locales.entries.Lcz_Cancellation}:`, content: this.item.rateplan.cancelation || '', renderContentAsHtml: true })), this.item.rateplan.guarantee && h("ir-label", { key: 'ece6d9b79dc7a0b6d0f83c705e96864c43c1ed57', labelText: `${locales.entries.Lcz_Guarantee}:`, content: this.item.rateplan.guarantee || '', renderContentAsHtml: true }), this.bookingEvent.is_direct && h("ir-label", { key: 'a5405ad63fb717f8158522ee2ae587d46ff699fd', labelText: `${locales.entries.Lcz_MealPlan}:`, content: this.mealCodeName }))), h("ir-modal", { key: 'c3ead3808faf65f194106ac583d8892b4d1999eb', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales.entries.Lcz_Confirmation, modalBody: `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${locales.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: 'fb02b2cfb00ab0e0878cb73cb856083532ba3544' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTextArea = class {
    ...
    render() {
        if (this.variant === 'prepend') {
            return (h("fieldset", { class: "input-group" }, h("div", { class: `input-group-prepend col-${this.labelWidth} prepend-textarea` }, h("span", { class: "input-group-text" }, this.label)), h("textarea", { value: this.value, class: `form-control`, style: { height: '7rem' }, maxLength: this.maxLength, onChange: e => this.textChange.emit(e.target.value), "aria-label": this.label })));
        }
...
const IrTitle = class {
    ...
    render() {
        return (h(Host, { key: '3c5dd5817cb6c63c6d115aa1d41d9b83b8acdbb1' }, h("h4", { key: '1fafd9b914e489c3b29da1552af8d152d331ca7c', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: '66540e2fcc746a4e269a2b4c3eab57f9a679e005', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '2db8d6738ac141fdc2936e2bee5bf560048d3e1c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '71c37934e0d93c56d31cc55a3f61aabaee3c00ab', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: '59cc5fb6cf6468a4dba5cad0fb9260ecc52fef61', class: 'title-body' }, h("slot", { key: '4e7a9b8121b6061d0270e27f1200c64c4719ad2b', name: "title-body" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: 'b8037345bdc57d4f9ee45bdbc8b68b5283745f6c' });
    }
    get element() { return getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (h(Host, { key: '42d288990cc44ed44cc6f6600da9c92f6967b1a8', class: "m-0 p-0" }, h("span", { key: '60fb761887f1f49ba5c7eed15d65bec08c04258b', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (h("slot", { name: "tooltip-trigger" }))), this.open && (h("div", { key: '6cf92316c0fc74e99e65813dacd052c0ffb03547', class: "tooltip bottom show position-absolute", role: "tooltip" }, h("div", { key: '1a675d41d4df2d69dc10ca2d112cf76ea68119c1', class: "tooltip-arrow" }), h("div", { key: '38cfeff681b9b9a6566bcb0d38a3f44478ed3208', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, h("span", { key: 'fa1c690bba45598d12ceae6b3b13c9c2dd54d56e', innerHTML: this.message }))))));
    }
};
