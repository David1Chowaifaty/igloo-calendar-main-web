...
import { c as colorVariants, i as icons } from './icons-3050e6b6.js';
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (h(Host, { key: 'bceee4d7bc85a2cadb2b3654eb76192f9dfdaff8', class: 'px-0' }, h("ir-title", { key: 'e1f835df599ee9892ecc1e88c466660ad2dd0a1b', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), h("form", { key: '33b70df72dd52ea2349347652ae414e92bf6e37a', class: 'px-1', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, h("ir-textarea", { key: '8ef6dd30cd3a394e0bfae173a22ad5e0539e43c1', placeholder: locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) }), h("div", { key: '7fa5393a4de2d870456c38b0458cf046a2ae9924', class: 'd-flex flex-column flex-sm-row mt-3' }, h("ir-button", { key: 'ac684314f88209bbd7ff3dfca3b50dbb165c729f', onClickHanlder: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: 'b33006042bce149cb59958a7746d91d304cc2ac2', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (h("div", { key: 'f1aadc19138fd50850e221477fd77033faa01a25', class: "fluid-container p-1" }, h("div", { key: '0ae359722db67c305792a46323109f9dfdbeff55', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, h("div", { key: '4aae74367b409c1df315413a9ebb7b54f206ce05', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, h("p", { key: '6086ddc2a70329b26fe2accb55e4507a25c65a94', class: "font-size-large m-0 p-0" }, `${locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), h("p", { key: '74170968df73190108647ff3c183315fb62d2849', class: "m-0 p-0" }, !this.booking.is_direct && h("span", { key: '0147aa058da22fdb583a1704ba60f035fe0dfb0d', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), h("div", { key: 'ada4afd4879660d58e9b83f88b3f80dc45a1f6ca', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, h("span", { key: '024de5621958d2c6ecbb82a4aeeec2fb0f51bc55', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (h("div", { key: 'f1fb378e94d07fdbac2f0e2d6e03608e72ac384d', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, h("ir-select", { key: '31e072165b606b39dd3d1e76049a3b657f555c6e', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 " }), h("ir-button", { key: 'ed64afcca4b6747d1d01639255959feb43cd68e8', onClickHanlder: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), h("button", { key: '9d4d1e0f857799bb8a539e0222fbb7f33de7a622', type: "button", class: "btn btn-outline btn-sm m-0", onClick: () => this.openDialog({ type: 'events-log' }) }, 'Events log'), calendar_data.is_pms_enabled && (h("button", { key: '6cc845b1073a2003269c4d059b261b37b1a3d8bf', type: "button", class: "btn btn-outline btn-sm m-0", onClick: () => this.openDialog({ type: 'pms' }) }, locales.entries.Lcz_pms)), this.hasReceipt && h("ir-button", { key: '711f396826e2b28200c7c4a48e7a881dd3d617ad', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && h("ir-button", { key: 'd11f3b893416ce9a4a7cd4555d8272f705732bb7', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && h("ir-button", { key: 'f11139888806b643a3d5cb082d12acb3f038534d', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && h("ir-button", { key: 'd69c0ad52f2baae0be35f183c3f825eef22f8937', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (h("ir-button", { key: 'f63e076baf6c492f93ff461303153ba5465625fa', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHanlder: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), h("ir-dialog", { key: 'b60090a51c9993053ec75a61b48dbe2a17be321e', onOpenChange: e => {
                if (!e.detail) {
...
const IrCommon = class {
    ...
    render() {
        return (h(Host, { key: 'e2bfd4a9c63a47796a001df0062355b556b82e9e' }, h("slot", { key: 'aa40d2cf03363bfe9b83617eef4ed46088bccd68' })));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '392693d35b602cdd716871fbe63f95e8a167594b', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '6f089ed8ca4784a962995812ddfd2b0d9fccc90b', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: 'c790cba6037841f71d0c8d0e958755ddeb457ec6' }, this.isLoading && !this.isPageLoadingStoped && (h("div", { key: 'ab09da82ca15c061d8308bae115976d33ff0630a', class: "loadingScreenContainer" }, h("div", { key: 'c79d79bb8ec7760e6937dd4200d5844654994ded', class: "loaderContainer" }, h("span", { key: 'b45f38b903fdc85aab5b9abfe85422dc103210a9', class: "page-loader" }))))));
    }
};
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: 'de154e33fc36f9c00956dbe88a4c250cc8765d15', class: "input-group price-input-group m-0 p-0" }, this.label && (h("div", { key: 'c0b28eb9542b90f136c57d05108b60efc56963ba', class: "input-group-prepend" }, h("span", { key: '92db7bef637e2009c60da3fc49b8af2c0ece572f', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: 'da1aea05176b5c7cd1c2fcf265c6ed1af8eabe1c', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: '12778a1b99e326e947b2af74cbcad572928a600b', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '64f2a6554891e62f2540b8cc37ee2a8267475b2d', class: `input-group-prepend` }, h("span", { key: '9574f028bd54ebbe4f16b3edd6e3e0d2a8b6cb4c', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: 'ca3b5084073a2d8d986828ef2e8a0feb5dd718bb', disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrSelect = class {
    ...
    render() {
        let className = 'form-control';
        let label = (h("div", { key: '46cffc49c14b1b6c650df291009efd57f434afc7', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, h("label", { key: '7dae5cf8c476506c700f21cd28a587d491e9a8b5', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (h("div", { key: 'd35ed83be598423da885022044a6b05625cd5cd1', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'afb61c6fd726080f9469e3963530d2766679937b', class: "input-group row m-0" }, label, h("select", { key: '91a5823d89d626d2bb83353ac62f03f202d92fe6', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'cb7330db14af47b7e63a31a98a4a1ecf481a9a31', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '81601f3e5f2c44a097400b12b7032ba22b7a8db6', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '120c15f4d8271650156a1f82ad663466f19185be', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '2e7b7ba1ed22fd3b92fb269bdddf7344b16cfde8', class: 'sidebar-title' }, h("p", { key: '1139b49d494eba1f83f47512f66c14ab16ca6998', class: 'p-0 m-0' }, this.label), h("div", { key: 'cbd60e2ce2eadd338b3e7d1207aa6e5da4165dbc', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: 'ec1f574e8736aa2bf646cb21016f2f5d86ea1740', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '16a3c35cba9abaee44c807ade1f3beaff086bb08', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '214094bb5af712b284b1448f92b43309fae7ebf2', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '2615c1640bb144732058986d66d002e060e6fe26', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '145230759fe23bac28df53f49b69f6c344a683e1' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (h(Host, { key: '079f37385b2fa453b596cce1ad8f8d0d2bf16de5' }, h("h4", { key: 'e217ab283004975ccacc5d0eed81dfd82b807ff1', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: 'a4c268c8dce62f8ee96a79d85ef42ff7913e8023', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: 'c389f86c228fac8631d036821ee94ff8f96508ff', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: 'c0e1fb7e189c73ab7dc2b373113e9bc9bcf2929c', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: 'caf31be8296f636791c3229212996bdf60a6adfe', class: 'title-body' }, h("slot", { key: '2678631694f99e3d883843b93d5333de9fe4dc6e', name: "title-body" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: 'a9294813762c16d3eec4d8c998ecbef847a03aa5' });
    }
    get element() { return getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (h(Host, { key: '5193682acbe1584dc29c5401e9bdf64c0339b86f', class: "m-0 p-0" }, h("span", { key: 'eae2243f63c415e8b858d67aa920f74e5df52889', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (h("slot", { name: "tooltip-trigger" }))), this.open && (h("div", { key: '65456e60a67ed3821214dd7621d299de3b947aae', class: "tooltip bottom show position-absolute", role: "tooltip" }, h("div", { key: 'a4254d213e3529005954342f8f70bc32505ef033', class: "tooltip-arrow" }), h("div", { key: 'cc94fc6da56089d8d604085817dacabc55448ba5', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, h("span", { key: 'efa6aafcb7eed5f236878b00948ead90cc9a0606', innerHTML: this.message }))))));
    }
};
