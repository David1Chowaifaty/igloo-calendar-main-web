...
import { B as BookingService, t as transformNewBLockedRooms, c as calculateDaysBetweenDates, g as getPrivateNote, f as formatName } from './booking.service-c3924016.js';
...
import { c as colorVariants, i as icons } from './icons-fddb6c6d.js';
...
const IrTooltip = class {
    ...
    render() {
        return (h(Host, { key: '55671000f1e2e743f69c9b6d7a90ffdbddf62758', class: "m-0 p-0" }, h("span", { key: 'c3e52cf138b8a54fcaf727db9fb00c1d60d13956', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (h("svg", { "data-toggle": "tooltip", "data-placement": "top", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", class: "tooltip-icon", viewBox: "0 0 512 512" }, h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (h("slot", { name: "tooltip-trigger" }))), this.open && (h("div", { key: '07a843b80a910f700a7d978f83db64096e2889a7', class: "tooltip bottom show position-absolute", role: "tooltip" }, h("div", { key: '9551e228096361e149b08587d3fb62e6b367929a', class: "tooltip-arrow" }), h("div", { key: '4748fd23572fe84da6bb9d6cf1f00cde5fbd5f2b', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, h("span", { key: 'a9f1944ffe31e37575d34ea95b30dc2cd5cf9285', innerHTML: this.message }))))));
    }
};
