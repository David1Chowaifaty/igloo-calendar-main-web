...
import { F as FdTypes, C as CityLedgerService, b as FdStatus } from './index-DvP9iFEw.js';
...
const IrFiscalDocumentsFilters = class {
    ...
    render() {
        return (h("form", { key: '1cb2093e7ee63191d64146b3b371947fdcdad34e', onSubmit: e => {
                e.preventDefault();
                this.applyFilters.emit(this.filters);
            } }, h("div", { key: '66a2508854144e4d3172c55eab65da84668cfddc', class: "filters-bar" }, h("ir-validator", { key: 'bcfefee888bd2319461ae725c2ba2117dbfcad6b', value: this.filters?.fromDate || this.filters?.toDate, schema: libExports.z.string().nonempty(), class: "filters-bar__dates" }, h("ir-date-range-filter", { key: 'cfca75c7ee74d359d4dc09037f2e50ce18d8a4f6', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), h("div", { key: '24ba362a81b1a3123622599416939ce926fac834', class: "filters-bar__search-group" }, h("div", { key: 'a924257b5a12c86e987fb52e06cb2ca0812a3ee0', class: "filters-bar__type-group" }, h("wa-select", { key: '00b0dc3bfb7239541b18f5991f817a654f643894', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (h("wa-option", { value: option.value, key: option.value }, option.label)))), h("wa-select", { key: 'b1bf797562d3f2159379dcd86075e336003e5912', class: "filters-bar__status-select", value: this.filters.folioType, defaultValue: this.filters.folioType, onchange: e => this.handleFolioTypeChange(e.target.value), size: "s", placeholder: "Folios" }, this.folioOptions.map(option => (h("wa-option", { value: option.value, key: option.value }, option.label)))), h("wa-switch", { key: 'b104cdf93e1d1c0fd9b9151de2e66ab55fe54b85', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes")), this.filters.folioType === 'agent' && (h("ir-autocomplete", { key: 'e31ae89d566f26bc64829ddbe1ba7656792a2d1b', class: "filters-bar__folio-select", size: "s", placeholder: "Select agent", value: this.filters.agentId ? (this.agents.find(a => a.id === this.filters.agentId)?.name ?? '') : ALL_AGENTS_LABEL, "onText-change": (e) => {
                this.agentSearch = e.detail ?? '';
            }, "onCombobox-change": (e) => {
                this.agentSearch = '';
                this.updateFilters({ agentId: e.detail && e.detail !== ALL_AGENTS_VALUE ? Number(e.detail) : null });
            } }, h("ir-autocomplete-option", { key: '24aaf4e09cad4beecb5bb6640eec8fd1b158b72f', label: ALL_AGENTS_LABEL, value: ALL_AGENTS_VALUE }, ALL_AGENTS_LABEL), this.filteredAgents.map(agent => (h("ir-autocomplete-option", { key: agent.id, label: agent.name, value: String(agent.id) }, agent.name))))), this.filters.folioType === 'guest' && (h("ir-picker", { key: '0974a2fc2167d79f80a22b6c207f1166c5bcdcd4', class: "filters-bar__folio-select", size: "s", placeholder: "Search customer by email or name", withClear: true, mode: "select-async", debounce: 500, loading: isRequestPending('/Fetch_Exposed_Guests'), "onText-change": event => this.fetchGuests(event.detail), "onCombobox-select": this.handleGuestSelect.bind(this), "onCombobox-clear": () => this.updateFilters({ guestId: null }) }, this.guests?.map(guest => {
            const label = `${guest.email} - ${guest.first_name} ${guest.last_name}`;
            return (h("ir-picker-item", { label: label, value: guest.id?.toString(), key: guest.id }, label));
        }))), h("div", { key: '8902c7d29ba6436f9987a450d3736517ba51a108', class: "filters-bar__search-actions" }, h("ir-input", { key: '9f603ede319a339d3950309a89a35ecc8cc7c786', class: "filters-bar__search-input", placeholder: this.searchPlaceholder, value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, h("wa-icon", { key: '9c2901cc3af55c01691735d591dd05b088a27a98', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), h("ir-custom-button", { key: 'c293b6c5bdd769382e3177be807c6a78e52bc2e9', class: "filters-bar__search-submit", variant: "neutral", appearance: "outlined", type: "submit" }, h("wa-icon", { key: 'e9efde3ce761f946beb1bb9ce4c430f88f1a2186', name: "magnifying-glass" })))))));
    }
