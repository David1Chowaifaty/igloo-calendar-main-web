...
const IrFiscalDocumentsFilters = class {
    ...
    render() {
        return (h("form", { key: 'b636fe22479e1364be1a18c2c1182f5e51893d0e', onSubmit: e => {
            ...
            } }, h("div", { key: 'ea4e7f4a252c6266a166b58792b29116a7fbffcb', class: "filters-bar" }, h("ir-validator", { key: '235035e590cf065321fba83267c497200b20e6a2', value: this.draft?.fromDate || this.draft?.toDate, schema: libExports.z.string().nonempty(), class: "filters-bar__dates" }, h("ir-date-range-filter", { key: '9d43b61259ec7a94e4597e9610b1bcd3974945cd', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.draft.fromDate, toDate: this.draft.toDate, onDatesChanged: e => {
