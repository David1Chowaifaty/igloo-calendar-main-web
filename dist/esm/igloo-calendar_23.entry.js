...
import { y as formatLegendColors, d as dateToFormattedString, i as isBlockUnit, z as getNextDay, A as addTwoMonthToDate, B as computeEndDate, C as convertDMYToISO, h as showToast, k as isPrivilegedUser, j as downloadFile } from './utils-BtgW0txG.js';
import { t, a as tRaw } from './t-Bk78Wumj.js';
import { f as formatDate, h as calendarPreference, C as CalendarPreferenceController, i as toApiDate, g as getWeekdayLabels, j as getFirstDayOfWeek } from './ir-date-DFR8GVLZ.js';
...
import { k as isEarlyCheckout, e as calendar_dates, l as addCleaningTasks, m as formatName, n as getRoomStatus, o as cleanRoom, p as addRoomForCleaning, t as transformNewBooking, q as transformNewBLockedRooms, r as bookingStatus, d as getPrivateNote, c as calculateDaysBetweenDates } from './booking-DuWdYels.js';
import { l as locales } from './locales.store-CXJn6ls-.js';
import { c as calendar_data, g as getDayUseBlockState, b as getBabyCotPricingModel, d as getExtraServiceDefaultPrice } from './calendar-data-BZeaTRgj.js';
import { h as handleUnAssignedDatesChange, d as addUnassignedDates, r as removeUnassignedDates, R as ROOM_HEADER_WIDTH } from './calendar-grid-ClupdXwR.js';
import { A as ApiClient } from './ApiClient-4jHvz1N4.js';
import { v as v4 } from './v4-CK3_k8jD.js';
import { H as HouseKeepingService, h as housekeeping_store, u as updateHKStore } from './housekeeping.service-X6dZ6dBt.js';
...
import { c as setArrivalsPageSize, o as onArrivalsStoreChange, a as arrivalsStore, d as setArrivalsTotal, i as initializeArrivalsStore, e as setArrivalsPage } from './arrivals.store-CUZkg3al.js';
import { a as axios } from './axios-B50ozOIF.js';
import { B as BookingListingService, u as updateUserSelection, b as booking_listing, s as setPaginationPageSize, o as onBookingListingChange, a as updatePaginationFromSelection, c as updateUserSelections, d as setPaginationPage } from './booking_listing.service-CXCZWwpY.js';
import { d as setChannelIdAndActiveState, u as updateChannelSettings, s as selectChannel, t as testConnection, C as ChannelService, r as resetStore, c as channels_data } from './channel.service-QI2dLMvM.js';
import { S as SystemService } from './system.service-DN8zRqj9.js';
import { o as onDeparturesStoreChange, d as departuresStore, b as setDepartureTotal, i as initializeDeparturesStore, c as setDeparturesPage, e as setDeparturesPageSize } from './departures.store-D8R8QQXh.js';
import { g as groupSvcCategoriesByParent, t as toAccChargeRule, f as findAccTax, a as getAccTaxPayloadFields, b as getTopLevelSvcCategories } from './svc-category.utils-g9PVvjZL.js';
...
import { b as formatCount, d as formatPercent, f as formatAmount, c as formatNumber } from './number-DegV2dS7.js';
import { P as PaymentOptionService, p as payment_option_store } from './payment-option.store-CFc75Vwr.js';
import { e as extraServicesCategories } from './index-Dcy1XLWp.js';
...
function hasUnassignedDatesInRange(data, { fromDate, toDate }) {
    const from = hooks(fromDate, 'YYYY-MM-DD').startOf('day').valueOf();
    const to = hooks(toDate, 'YYYY-MM-DD').startOf('day').valueOf();
