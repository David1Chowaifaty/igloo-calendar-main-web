...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory } from './booking.service-37116ba1.js';
import { l as locales } from './locales.store-53ec3957.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-a6093df2.js';
import { f as formatAmount, h as hooks, e as extras, a as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, b as getPrivateNote, i as downloadFile, t as toFloat, r as renderTime, j as formatName } from './utils-3b3188e6.js';
...
import { c as colorVariants, i as icons } from './icons-c78fdb83.js';
import { c as createStore } from './index-c1c77241.js';
import { _ as _formatTime, a as _formatDate, b as _getDay } from './functions-0a50e76b.js';
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '6911c6ff8c38e5c844b9b104302feedc81e9c4f4' }, h("div", { key: '4d095670a31d895fdf87a9d406e5d8e4ca0617c5', class: 'd-flex align-items-center ' }, h("label", { key: 'bb1fdd8b0c627df42dc1d5dadcf7ed9a0d66b92a', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: 'b98857b3add891841aec25124e4237e44ac422f8', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: 'a6c82d50ed9740849985832047c6bf7eab3cde07', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: '857c69f2f9e5085a4dc484608900f0289e2eb673', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: '4b117cab2fc60867de703924dc4ee58fbc3de422', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: 'd8393188477ee92b2532162dba20c4a41f2c6cb9', class: 'sr-only' }, "clear input"), h("svg", { key: '39e3b6eb7c1a4315023a40111c282785f1b9bf3a', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '75f793881d9936d833064c69c8e2b6d331589a91', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
        ...
        return (h(Host, null, h("ir-interceptor", null), h("ir-toast", null), h("div", { class: "p-1 main-container" }, h("ir-listing-header", { propertyId: this.propertyid, p: this.p, language: this.language }), h("section", null, h("div", { class: "card p-1 flex-fill m-0 mt-2" }, h("table", { class: "table table-striped table-bordered no-footer dataTable" }, h("thead", null, h("tr", null, h("th", { scope: "col", class: "text-left" }, (_a = locales.entries) === null || _a === void 0 ? void 0 :
            ...
            _o.map(booking => {
                ...
                return (h("tr", { key: booking.booking_nbr }, h("td", { class: "text-left" }, h("ir-button", { btn_color: "link", btnStyle: { padding: '0', margin: '0' }, onClickHandler: () => (this.editBookingItem = { booking, cause: 'edit' }), text: booking.booking_nbr }), booking.channel_booking_nbr && h("p", { class: "p-0 m-0 text-center secondary-p" }, booking.channel_booking_nbr)), h("td", null, h("p", { class: "p-0 m-0 date-p" }, hooks(booking.booked_on.date, 'YYYY-MM-DD').format('DD-MMM-YYYY')), h("p", { class: "p-0 m-0 secondary-p" }, _formatTime(booking.booked_on.hour.toString(), booking.booked_on.minute.toString()))), h("td", null, h("div", { class: "h-100 d-flex align-items-center ", style: { width: 'max-content' } }, h("img", { class: "mr-2 logo", src: booking.origin.Icon, alt: booking.origin.Label }), h("div", { class: "text-left" }, h("div", { class: "d-flex align-items-center" }, h("div", { class: "booking_name m-0 p-0" }, h("ir-button", { btn_color: "link", onClickHandler: () => (this.editBookingItem = { booking, cause: 'guest' }), text: `${booking.guest.first_name} ${(_a = booking.guest.last_name) !== null && _a !== void 0 ? _a : ''}`, btnStyle: {
                    ...
                    ? '_'
                    : formatAmount(booking.currency.symbol, booking.financial.gross_cost))), h("td", null, h("p", { class: `m-0 badge ${confirmationBG} ct_ir_badge` }, booking.is_requested_to_cancel ? (_d = locales === null || locales === void 0 ? void 0 : locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_CancellationRequested : booking.status.description), booking.events && booking.events[0].type.toLowerCase() === 'modified' && (h("p", { class: "mx-0 p-0 small", style: { marginTop: '0.25rem', marginBottom: '0' } }, "Modified")), lastManipulation && (h("ir-popover", { trigger: "hover", content: `Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}` }, h("p", { class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, h("b", null, "Modified"))))), h("td", null, h("div", { class: "d-flex justify-content-center align-items-center", style: { gap: '8px' } }, h("ir-button", { title: "Edit booking", variant: "icon", icon_name: "edit", onClickHandler: () => (this.editBookingItem = { booking, cause: 'edit' }) }), h("ir-button", { title: "Delete booking", style: { '--icon-button-color': '#ff4961', '--icon-button-hover-color': '#FF1635' }, variant: "icon", icon_name: "trash", onClickHandler: () => {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (h("form", { key: '15e3651e664e08b210616ec8961bc4e71bdf17a6', class: "dropdown m-0 p-0" }, h("ir-input-text", { key: '58e31ae5957b8b604f286b222c94fef3b69e7510', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), h("div", { key: 'd45c463788997d7de6be9d9921fb05ae102a5634', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (h(Fragment, { key: '673c7c5f9affa37b67bf406812eb85d572b10975' }, h("button", { key: '338dcb3501efe5a5d2d329cd12df6968c18192e3', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, h("img", { key: '9d1c4e8cdf26458306533a3030b1efb7f21e2fce', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), h("p", { key: 'c4b4c750c1d2ccc1fe0f5f4a8b5c3a276e409757', class: "pl-1 m-0" }, this.propertyCountry.name)), h("div", { key: 'f5aa633d09025a7693c47eab191a47edb42609ca', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && h("p", { key: '5f26802960be12881401826a75fec468e8e5f102', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (h("div", { key: 'ce47cee63897a24a5cf72f0e51ab93a7627cc253', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && h("slot", { key: '51119bd03316288b65b15c8f4b0246cb287b2cc6', name: "trigger" }), h("input", { key: '2ef7ced552a8528e0fdc5b59037dc795defc1a89', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: '8c960babc6ba9be2ffa83dec69db523922b662e7' }, h("input", { key: '8fffd4467ef6b8f92e2b557829b08c60ca521a0e', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return getElement(this); }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: 'd9e88719512abc8227ae07a935c40f1f4b8adfa2' }, h("div", { key: '858729b8aa51102c9b6c435128cc986237faaa4a', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '53ab9cc84b8312f3ab019a782dd7e433b01742f3', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'b125f0b8215c685f6a585b616ac51a32019fa622', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '3f1d0c42b17388844f4a9cdc65567e48bf2e1f5e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '8cbe1d590a47cdec2e050cb18b66c46a4f09c8d0', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '4f9e2cb4e7d2ff2a5093432cc92d304a19dcb93f', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '2544b78f8ac2eb59ffd8701c2cff435825ede06b', name: "modal-title" })), h("div", { key: 'd94cb21f5f47f9ed2c2157441e2619affc86c91b', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '4a5dbcc0869ac628a7b9c2d860e53633b37404ed', name: "modal-body" })), h("div", { key: '66b1a4d92f6831444713382455bedd6ddde6def5', class: "modal-footer" }, h("slot", { key: '68d9b390c0dfcf596f6bc7473f68e2c843f5c36b', name: "modal-footer" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '5ae23f90d0b3e25f2051b261b3c948d8455a2d62', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '8b13ee45f756e30655c6bbeef19a8fa6b62b6c2f', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'f13b776a5a5608963bd86eb92650864adf3058b3', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '574566f9dcb2390706758c4a5bca7ceaada77801', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '20c24190e2f39edea775316535fa9c245b894123', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'ffcc5fe7e7b8c17ea577c259921844464dfae501', class: `ir-alert-header` }, h("p", { key: 'eb1f181b3d26c29dec40908cf0818c31163df69e' }, this.modalTitle))), h("div", { key: 'f69a968495cc42d6583beb2664b984b927dab170', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '160dfb5e9c3a471dfd002fa84df0d22f79291f6c' }, this.modalBody)), h("div", { key: '0d4849f0fecfad8d0ce398ca883e0b48dd0b16f1', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '43815c315e5fac80dc69232d5058fb9a2e8fd0eb', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (h("ir-button", { key: '42e14935ccbffab8f5e1c6b986e90ac9564e8325', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '61d166d6c66f4ab5393e7659395a3c8ee6ed8f23' }, h("div", { key: '3a47f2df5dcaae17e10f313b1db8290df199bf24', class: "form-group mr-0" }, h("div", { key: '874a52666d7615afeb0cdebe9f1dca13a708d9c5', class: "input-group row m-0 p-0 position-relative" }, this.label && (h("div", { key: '2978ec586a5209447edf33a7e61ba63eadfd8936', class: `input-group-prepend col-3 p-0 text-dark border-none` }, h("label", { key: 'e5c50e9200a51e3719e4b80701c64a3d10fea73f', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), h("div", { key: 'aa6f89312a041e6f6be8914d46386e388b61944a', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, h("button", { key: '24e1b141593e086938a5dc89143d1f39d57900dd', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : h("p", { class: "p-0 m-0 " }, locales.entries.Lcz_Select), h("svg", { key: 'ee75ad02de644b45ff346cf78a53c9d15233ee39', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'e75490272852a9288b7b15d9b0a77df089af14c8', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), h("p", { key: '16f27f4f8f06b51f3783441f8bbc655d734e64c9', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), h("input", { key: '3b32f49bd34a051497d3c7b3739120b1d0b39cc0', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (h("div", { key: 'cbfe0a9ad5551c9ae38cc142f2d35d891654e962', class: "ir-dropdown-container" }, h("ir-combobox", { key: '35858bf17f9e69aea3ebbff3a290d7d7f96a2054', onComboboxValueChange: e => {
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'e90f4615dec4704693c94d5457d953ac7bd9596b', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: '3711dac141512c64f4698d6d4f143428eba9c1be', class: "input-group price-input-group m-0 p-0" }, this.label && (h("div", { key: '5d996322dbff8fcc66b66b5ed942e4782ba979e2', class: "input-group-prepend" }, h("span", { key: '6801b3036ba3fb423d0bd236bad54de4d6132901', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: '2ce79a48fa22dc0f515cb6f08b5d32d654c6b98e', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: '3a1618b7d46f8e0b467d8c0dcdc6d6e230b9b5fe', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: 'f4f8b17e32e77b1eefa9bdc531ecf308cbd67700', class: `input-group-prepend` }, h("span", { key: '6d491df9450dbe9e7a953ba72f538176384e935f', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: '130ea0369f06f5c58ba38ffa4899d6bda7d242d8', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: 'e3675863ef9aa761c3dc64fab207322bc3b22862', class: "p-1 d-flex m-0" }, h("ir-button", { key: '9610a4b247568faab6bc235d7ca8bd48bd1e6dc8', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '2f70d75a0b3554acd8382fa81c06b8c499521a22', class: "flex-fill m-0 " }, h("div", { key: '69a4c7434c2852739f0c1f50ac86ca78452722da', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '7ee2e4fcfcc1b1367dbd734ac33428fd7cd890de', class: "m-0 p-0" }, h("span", { key: '2d26fced6c7012efe9531bcd3f5fd28b6b487f66', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '584ebaf78a12014a7de439a0c05925eeb59cf0f7', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: '2f6e322bd779df4ea1c09dbc21ddf503a0993ae3', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: '1e146d3c2d29dfe5f64fe1f45dd60e40fc27736f', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '1e4c75836ef8ae5a5104e7eb0c163baca8f67379', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: 'a761406ee93810ed3d7cbd57930bec6c3cb1c3bf', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: '4ced57e7fa40b54c123d1f26b087d1e3fe087d3a', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: 'ef5deb54e95c8b5bf62ac73c0f007e65827362fc', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: '84a7fbc86a8d57ae8d4b4eaace400ee932587eef', message: this.room.unit.name, customSlot: true }, h("span", { key: '334816d42a8aae3e802e18729b15219bde66125c', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: '46a1358ffb38561571be8bd63ab8f8926dd59ac7', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: '6c537f5233798316a67f78d2a7fe68c4b20c9c91', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: '0f1697632d4f926e2d55b0cb42a2d4c93d42dde3', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '85e56354d23d146aff8079b7947adaa689f249b9', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: '44f2f6162b8eb15d250d29e5033a11b98abda627', class: "m-0 p-0" }, "(", bed, ")")), h("div", { key: '552d8396bf26c4d10ae3d566d062d6eef2ef1888', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, h("div", { key: '06f70572def00958845244bd97094885670fe0ef', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '3607ecfbafa48d2eebde47498246e09038ab76db', class: " sm-padding-top" }, h("p", { key: '9db61733abe33873b9797d231f37caf7b47c3664', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '2bddd9ad1b50d419a1b8087405adfaa488da04b0', class: 'flex-fill' }, h("table", { key: '6b574aec91954e90fb3aece1c6ee2da0af2673c2' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '6906d3a40e9bbc87571352bbe9ebf6b5daf2a05f', class: '' }, h("th", { key: '6d6d682e9f4d4b0204511e6d35b5697a9f7a2d65', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '771fe19d24c8e50073aded97375c319e7a06d97b', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: '22221523e150dea63a64b1eeae5c7dd973145d6b', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '3630f37116e3915b7eaab5aa4faa838203bb83d4', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: '80acf7229c7aa1a2c63e07a1d6b4a8a74e2a3300' }, this.room.rateplan.cancelation && (h("ir-label", { key: '9fda0c77a0ba217d38541d001cc5f7df096fbb91', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: 'db6a0f01c234cb7352f445f295e1ab3fd9c1fb2d', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '2d5db27bba446ee05106ea94d96d828898de4293' }, h("ir-label", { key: '3a5b15ba7530f19aa533fb3c186d503bfc0380d7', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '05e5bc80e735a75ca532e9d1bc105c1a6449aeb0', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), h("ir-modal", { key: 'f41f578d939c23446bf3569422ef9c8539e951dd', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '828a25ebd41d26c7e8a48a59e8761d26d63532a2', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '79a0a7410ae0c84b6f66b06b67579015bedd45e9', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '821c30377d38709b4a3ae698a81a0ed03548c157', class: 'sidebar-title' }, h("p", { key: '11261a7f58a13402e0e414d792f8384be01a9049', class: 'p-0 m-0' }, this.label), h("div", { key: 'b7aaa8d3b1ff7e6d038b598b0f03296bd47b5a0e', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '6d26333aa71c4e20ec09869583a58f8bcca0d6ba', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'd12f4333233b3284df4e7cd7a5c06ecad8d1b07a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '2f2e4a5ee867c418aa6398f7a947cb355d50727c', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '7efefc8efa292bf243e4bf49666cd7e1f8965fde', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: 'fce65043be0494981adb391da0a318b566461c23' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: 'a3c0b6de4829050dbe01b7ed9d74fcb173f81f80' });
    }
    get element() { return getElement(this); }
};
...
//# sourceMappingURL=igl-application-info_61.entry.js.map