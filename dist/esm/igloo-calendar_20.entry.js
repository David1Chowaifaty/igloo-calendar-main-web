import { r as registerInstance, c as createEvent, d as getElement, h, F as Fragment, H as Host } from './index-D7D7fhZS.js';
import { R as RoomService } from './room.service-RYuSnrxp.js';
import { B as BookingService } from './booking.store-CDncsUUD.js';
import { C as formatLegendColors, d as dateToFormattedString, n as isBlockUnit, D as getNextDay, E as addTwoMonthToDate, F as computeEndDate, G as convertDMYToISO, k as showToast, o as isPrivilegedUser, l as downloadFile, j as groupEntryTablesResult, p as getEntryValue } from './utils-DvzWTdKJ.js';
...
import { e as calendar_dates, i as addCleaningTasks, j as formatName, k as getRoomStatus, l as cleanRoom, m as addRoomForCleaning, t as transformNewBooking, n as transformNewBLockedRooms, o as bookingStatus, d as getPrivateNote, c as calculateDaysBetweenDates } from './booking-C5iTFi9B.js';
import { l as locales } from './locales.store-C0aS6UDK.js';
import { c as calendar_data } from './calendar-data-15-64PrB.js';
import { h as handleUnAssignedDatesChange, a as addUnassignedDates, r as removeUnassignedDates } from './unassigned_dates.store-CCbSyPhF.js';
...
import { d as setChannelIdAndActiveState, u as updateChannelSettings, s as selectChannel, t as testConnection, C as ChannelService, r as resetStore, c as channels_data } from './channel.service-7pNMVp-P.js';
import { S as SystemService } from './system.service-DN8zRqj9.js';
import { o as onDeparturesStoreChange, d as departuresStore, b as setDepartureTotal, i as initializeDeparturesStore, c as setDeparturesPage, e as setDeparturesPageSize } from './departures.store-BtOzp5s3.js';
...
const IglooCalendar = class {
    ...
    render() {
        ...
        return (h(Host, { key: '24ce3db6ff12edd5e79cbdb3b1a78c8af0b0275b' }, h("ir-toast", { key: '475d127b9eb6a12e5a6151369694b2f423b54b8f' }), h("ir-interceptor", { key: '95a008f3cd2ac5064e0aa4608a5e082109f345f3' }), h("div", { key: '22899bd66d3d4eda0488dd86cc66341fcc6139f0', id: "iglooCalendar", class: { 'igl-calendar': true, 'showToBeAssigned': this.showToBeAssigned, 'showLegend': this.showLegend } }, this.shouldRenderCalendarView() ? (h(Fragment, { "data-testid": "ir-calendar" }, this.showToBeAssigned && (h("igl-to-be-assigned", { unassignedDatesProp: this.unassignedDates, to_date: this.to_date, from_date: this.from_date, propertyid: this.property_id, class: "tobeAssignedContainer", calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) })), this.showLegend && h("igl-legend", { class: "legendContainer", legendData: this.calendarData.legendData, onOptionEvent: evt => this.onOptionSelect(evt) }), h("div", { class: "calendarScrollContainer", onMouseDown: event => this.dragScrollContent(event), onScroll: () => this.calendarScrolling() }, h("div", { id: "calendarContainer" }, h("igl-cal-header", { unassignedDates: this.unassignedDates, to_date: this.to_date, propertyid: this.property_id, today: this.today, calendarData: this.calendarData, highlightedDate: this.highlightedDate, onOptionEvent: evt => this.onOptionSelect(evt) }), h("igl-cal-body", { propertyId: this.property_id, language: this.language, countries: this.countries, currency: this.calendarData.currency, today: this.today, highlightedDate: this.highlightedDate, isScrollViewDragging: this.scrollViewDragging, calendarData: this.calendarData }), h("igl-cal-footer", { isLegendOpen: this.showLegend, highlightedDate: this.highlightedDate, today: this.today, calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) }))))) : (h("ir-loading-screen", { message: "Preparing Calendar Data" }))), h("ir-sidebar", { key: 'c2d0dfe0192117fe2361643249761ad9c7c7ccb9', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: this.isSidebarOpen, showCloseButton: false, sidebarStyles: {
            ...
            }, checkOut: this.bookingItem?.TO_DATE }), h("igl-bulk-operations-drawer", { key: '2f268072b23bcb8fd9c5edde4d0e4ad17698545d', property_id: this.property_id, onCloseDrawer: () => (this.calendarSidebarState = null), open: this.calendarSidebarState?.type === 'bulk-blocks' }), h("igl-blocked-date-drawer", { key: 'fb31110a4c3b9cb0210563339bdb3b7e50f0089e', onBlockedDateDrawerClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingItem = null;
...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (h(Host, { key: '986e4f96ba816c408bf3ecdcf42626d199d4d8a8', class: "p-1" }, h("ir-interceptor", { key: '5cfb6fa48b0d45415652cc392e71a9519de0f334', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), h("ir-toast", { key: '4112cf840d1752fa3ecfde5ff3864dd6066fa2f0' }), h("div", { key: 'bb47b7a3c0daadcb2d8df100fc40e3bf613d7731', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, h("ir-input-text", { key: '914b779261dee48213f62bd3fe5da278d4be4214', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), h("ir-button", { key: 'e610f4198f1a2c03191ef0fc09f35845857c6895', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), h("p", { key: '8f0df2cdc13ecf3e4a942a5fa6dfc348bd762fce' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
