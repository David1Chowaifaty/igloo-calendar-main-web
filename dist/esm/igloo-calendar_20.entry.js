import { r as registerInstance, c as createEvent, d as getElement, h, F as Fragment, H as Host } from './index-Nexq2OjX.js';
import { R as RoomService } from './room.service-6cGJ6nq0.js';
import { B as BookingService } from './booking.store-CvDLuSL3.js';
import { C as formatLegendColors, d as dateToFormattedString, n as isBlockUnit, D as getNextDay, E as addTwoMonthToDate, F as computeEndDate, G as convertDMYToISO, k as showToast, o as isPrivilegedUser, l as downloadFile, j as groupEntryTablesResult, p as getEntryValue } from './utils-CRe_zSvY.js';
import { r as realtimeService } from './realtime.service-BLk631kq.js';
import { E as EventsService } from './events.service-CDYH4LRM.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { T as ToBeAssignedService } from './toBeAssigned.service-CkGLtlaA.js';
import { e as calendar_dates, i as addCleaningTasks, j as formatName, k as getRoomStatus, l as cleanRoom, m as addRoomForCleaning, t as transformNewBooking, n as transformNewBLockedRooms, o as bookingStatus, d as getPrivateNote, c as calculateDaysBetweenDates } from './booking-D8tDiK7e.js';
import { l as locales } from './locales.store-flvFxs7J.js';
import { c as calendar_data } from './calendar-data-CPCc-_Kx.js';
import { h as handleUnAssignedDatesChange, a as addUnassignedDates, r as removeUnassignedDates } from './unassigned_dates.store-svctA4Oi.js';
import { T as Token } from './Token-CkxFIO_J.js';
import { v as v4 } from './v4-CK3_k8jD.js';
import { H as HouseKeepingService, h as housekeeping_store, u as updateHKStore } from './housekeeping.service-DmcArWic.js';
import { A as AgentsService } from './agents.service-CfKXQqnt.js';
import { P as PropertyService } from './index-BxG2jpy5.js';
import { c as setArrivalsPageSize, o as onArrivalsStoreChange, a as arrivalsStore, d as setArrivalsTotal, i as initializeArrivalsStore, e as setArrivalsPage } from './arrivals.store-ZJgsv-tc.js';
import { a as axios } from './axios-B50ozOIF.js';
import { B as BookingListingService, u as updateUserSelection, b as booking_listing, s as setPaginationPageSize, o as onBookingListingChange, a as updatePaginationFromSelection, c as updateUserSelections, d as setPaginationPage } from './booking_listing.service-CDLCS3Rc.js';
import { d as setChannelIdAndActiveState, u as updateChannelSettings, s as selectChannel, t as testConnection, C as ChannelService, r as resetStore, c as channels_data } from './channel.service-O5yLFsTZ.js';
import { S as SystemService } from './system.service-DN8zRqj9.js';
import { o as onDeparturesStoreChange, d as departuresStore, b as setDepartureTotal, i as initializeDeparturesStore, c as setDeparturesPage, e as setDeparturesPageSize } from './departures.store-J2OHMKxw.js';
import { F as FdTypes } from './enums-yWZS7fV2.js';
import { l as libExports } from './index-DeW5X45W.js';
import { m as setLoading, b as updateTasks, h as hkTasksStore, c as clearSelectedTasks, n as updateSelectedTasks } from './hk-tasks.store-Dyr-zfQX.js';
import { P as PaymentOptionService, p as payment_option_store } from './payment-option.store-DKdz9Uso.js';
...
const IglooCalendar = class {
    ...
    render() {
        ...
        return (h(Host, { key: '3a6f38ec06d590800c67579182f7b3eefb45b409' }, h("ir-toast", { key: '92d30ee14ddd4b429716bceb5e522b5e4933cd78' }), h("ir-interceptor", { key: '366c9b4c3a0279adc6ae22decc640c4fb89cc23b' }), h("div", { key: '8799c4c95d6398f13546978f5841703c324516d8', id: "iglooCalendar", class: { 'igl-calendar': true, 'showToBeAssigned': this.showToBeAssigned, 'showLegend': this.showLegend } }, this.shouldRenderCalendarView() ? (h(Fragment, { "data-testid": "ir-calendar" }, this.showToBeAssigned && (h("igl-to-be-assigned", { unassignedDatesProp: this.unassignedDates, to_date: this.to_date, from_date: this.from_date, propertyid: this.property_id, class: "tobeAssignedContainer", calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) })), this.showLegend && h("igl-legend", { class: "legendContainer", legendData: this.calendarData.legendData, onOptionEvent: evt => this.onOptionSelect(evt) }), h("div", { class: "calendarScrollContainer", onMouseDown: event => this.dragScrollContent(event), onScroll: () => this.calendarScrolling() }, h("div", { id: "calendarContainer" }, h("igl-cal-header", { unassignedDates: this.unassignedDates, to_date: this.to_date, propertyid: this.property_id, today: this.today, calendarData: this.calendarData, highlightedDate: this.highlightedDate, onOptionEvent: evt => this.onOptionSelect(evt) }), h("igl-cal-body", { propertyId: this.property_id, language: this.language, countries: this.countries, currency: this.calendarData.currency, today: this.today, highlightedDate: this.highlightedDate, isScrollViewDragging: this.scrollViewDragging, calendarData: this.calendarData }), h("igl-cal-footer", { isLegendOpen: this.showLegend, highlightedDate: this.highlightedDate, today: this.today, calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) }))))) : (h("ir-loading-screen", { message: "Preparing Calendar Data" }))), h("ir-sidebar", { key: '902488946520bec295b3e67235371e457b555e30', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: this.isSidebarOpen, showCloseButton: false, sidebarStyles: {
            ...
            }, checkOut: this.bookingItem?.TO_DATE }), h("igl-bulk-operations-drawer", { key: '07e8ae831c59d328d4c9677a6bb2d8fdc5cc089d', property_id: this.property_id, onCloseDrawer: () => (this.calendarSidebarState = null), open: this.calendarSidebarState?.type === 'bulk-blocks' }), h("ir-rectifier-drawer", { key: '4c2df8886a08ff2bf6a71cf10b8ac32590d79853', onCloseDrawer: () => (this.calendarSidebarState = null), open: this.calendarSidebarState?.type === 'rectifier' }), h("igl-blocked-date-drawer", { key: 'dec7b3faf7bcf0fa3d3c27744c4ccbc3c3eacf5b', onBlockedDateDrawerClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingItem = null;
...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (h(Host, { key: 'fe8a068209da0560aa754b8d6a5f7c5273a0bfd3', class: "p-1" }, h("ir-interceptor", { key: 'f36b15ea328e406f4c55599f0ef574fe95b3841d', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), h("ir-toast", { key: '396036984b73ec7f094c55897a1a1fc2ff0695a1' }), h("div", { key: '8990415e7c498c09454daa8e9a529912e59622a0', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, h("ir-input-text", { key: '8896581f52c64435e7700f59eee38e22ee5649ef', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), h("ir-button", { key: 'f79b993cfb87d3a9c6f8f13d11b4552202cb27b9', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), h("p", { key: '111747189c4a371b47ffbe66e6a4882369f30d0d' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
