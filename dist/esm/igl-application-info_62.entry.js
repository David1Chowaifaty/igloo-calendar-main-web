...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory, e as buildPaymentTypes } from './booking.service-546a9a71.js';
import { l as locales } from './locales.store-629477c2.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-f4e207f9.js';
import { f as formatAmount, e as extras, h as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, a as getPrivateNote, t as toFloat, r as renderTime, b as formatName } from './utils-9ae6477f.js';
            ...
            this.booking.rooms.forEach(room => {
                ...
                if (cancellationPolicy) {
                    ...
                    brackets.push({
                        ...
                        code: '',
                        currency_id: 0,
                        due_on: hooks(room.from_date, 'YYYY-MM-DD').add(1, 'days').format('YYYY-MM-DD'),
                        due_on_formatted: '',
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: 'b0ea9c45ca572d54ce2edd16b9c3be67f0b91c7c' }, h("div", { key: '2afc0cfed752602b7e16490281ce08920f92a69d', class: 'd-flex align-items-center ' }, h("label", { key: 'b39c65b2d6403bb1db47a56a75a28736c94b7b0b', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: '545af0b79665834c4115f5936e2c0c96a19c7385', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: '8ec8ca38205611f10de1f100b6f991224f2abbe0', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: '6d3f4374708ece04f6bd80cb4920ae1795319549', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: '17e4024bffe029bb3d5bc8e0ef3d82e81b8ce92f', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: 'f786f97bc9ecfbd35f3bb51c0c4f2134063b4ad0', class: 'sr-only' }, "clear input"), h("svg", { key: '775e37daa0d26f31be995d0f907f5e6327dc5516', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '4771d2d94a20701bc1d6cb9c89629f0b568586ff', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: '5a5fdf469880fc2139ad3c0f011956e0e3c1491a' }, h("input", { key: '30d8d66077e5bdfb09740dfb0284631fcd0955a4', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '6bda909216148a6dba9c3a43085938f0b69f103b', class: "d-flex align-items-center" }, h("span", { key: '900064b4a7325b47756625a69b6a126f89cafacb' }, this.dates.from_date), ' ', h("svg", { key: '29a64e7991d74209bdfd9828073eb8f8fb2adc76', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '355aca0660ce17c3bfc38790b8206ba31f93a890', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '5710768097dde858f52fd40b091485c9b5bfe4cd' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: 'c5841031706e40769cfafe4d763b00ac55a29bd3', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: '55fdf7ca83674c469cfa116794a348e0e6567475' }, h("div", { key: 'a1279db57749c5b9eaa3eea583784f820ca65e77', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '05e5b64e0bd8c5bcd21409a7758ca5ceb207f9b5', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'a8da0b120e6c1a347664496c096005924b71fb9d', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'b28077067540573f5bd3ffcfbf84d4556d868022', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '7fb7dbec67cbb3851bd543141e86f299e41ced5d', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'f9bac595a3561efe6d169f4540a5004f9ffc00b7', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'fdb16248cf284c8bd52ce3c3ff615bbbadac30c3', name: "modal-title" })), h("div", { key: '095f512d91741443447a722fe4c0548299ccf55e', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '5ae44538ee722715dc5feb036bb80fa643ecfac9', name: "modal-body" })), h("div", { key: '7b49843d60ba67a863c2cfb7007b2a74fcca9794', class: "modal-footer" }, h("slot", { key: '1a68647546537093cf0171a96fd994dd06a5360d', name: "modal-footer" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '65f155a69b0d230e00a9205a3983a13b06d74b16', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '4203a331631a498c807f1cc9955c47857771eead', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'a935b4beb3c13bdefd37218a5617be777a53e16d', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'eb554255e1b7dd0a4e4c06952cabe48648d3be8f', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '7b8be76db3f211e1f0ba7c9bfa30e4312ea3f36b', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '6d3d8a359cbe81aef6e18f8357d943d598e780dd', class: `ir-alert-header` }, h("p", { key: '21769f53f1a28f81c3c60d59e36238cdad94171f' }, this.modalTitle))), h("div", { key: 'afa278a6fb143459ae5a1826cf5874cb51331d43', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'dc17aeb590472b76cca023729f07e08bfebf9117' }, this.modalBody)), h("div", { key: '5782b4a6dbeaf2985e5eb0b7c30dd9f6ef8e8457', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '1c30d21d02264ca499844adc566e33f44b9b41ba', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: '2a0bec6dc2daa0c0e906a22fab1d196837c8faa0', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: 'b793a848bbdeba4f61a948cda38c8fad0bb61c48', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (h("div", { key: 'e6a01e56988032972a6d864168cf4395ac655ab3', class: "mt-1" }, h("div", { key: '6f4875f689e1b92d2956df65087907b1ff150e02', class: "d-flex flex-column rounded payment-container" }, h("div", { key: '09444cdc1154ac579b6793198d5a88ff111d78a9', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '47f5d0aaca4421bc0a7d64acf35c08d1884159a2', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: 'e46b8605bd3177f6fcf84772c952c5f5d263b694', class: "font-size-large p-0 m-0" }, "Guest Folio"), h(HelpDocButton, { key: 'e28cd63ef6473dccb0e75750494edcc790d123e5', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), h("ir-button", { key: '1fb522402dd1516afd7a6dd426bae45ced2374a0', id: "add-payment", variant: "icon", icon_name: "square_plus", style: { '--icon-size': '1.5rem' }, onClickHandler: this.handleAddPayment })), h("div", { key: '9747909d9fbbabb4daf54371ead3b8cde0d4338b', class: "mt-1 card p-1 payments-container" }, this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'eea4c45410b3a48ff5d2a1317bceb34a419444e3' }, h("div", { key: 'f3e4ed10e037f9ddd0ea06d538a91fcb5c1bf637', class: "form-group mr-0" }, h("div", { key: '102ac42e1ec5db76cd088433b97e150de166e69d', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (h("div", { key: '8c1699595a8441a755ed105011578c2fe1ece9f9', class: `input-group-prepend col-3 p-0 text-dark border-none` }, h("label", { key: '5ca182aa656c68deb4f6444b37fbf7c7a204f840', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), h("div", { key: '28b01d4c1aa501d7f4e9e3dfccceb324b9c80b3c', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, h("button", { key: '5f901a80272de6c178891d491e1f45b3c9204adc', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : h("p", { class: "p-0 m-0 " }, locales.entries.Lcz_Select), h("svg", { key: '4655a8daa2f134e2a210a08b4ec9fccfdcb9216d', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '8dfa504fcdded4248c3b0d96b269a5c301af4051', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), h("p", { key: '063f2c593fcc81c1610b63de5305dc8d2d5e2b64', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (h("label", { key: 'cea4894585e5c6ebf26a8a61eccf7d8d98f66411', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), h("input", { key: 'ad389ab11c028971750cc6491d79cf663dc6d05e', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (h("div", { key: 'dbd008dfe9da6fda40a6da975e4bda7e9960b57e', class: "ir-dropdown-container" }, h("ir-combobox", { key: 'f5f5cfc1678765d13f3e3fbbd698f07d3d0d7227', onComboboxValueChange: e => {
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'b2423dc2f9af38bd5cb892620e470b5c85af083d', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: 'e884c698827d3dae13e8bca9405464d9c5c65cec', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (h("div", { key: '2483959ec93f84f0e0cd2c9392e7ba4cccea6dee', class: `input-group-prepend ${this.labelContainerClassname}` }, h("span", { key: 'b6d104c7aab40c470004de2ee0b5898fb73556c5', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: '5c4f64abb8db0a24a42690f1517425b81c634c1d', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: 'cbcc07dc43604e6579f147fa0d278c0ec7f2479d', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '0b107ac10136f5f55113f191ab010b09b76896fe' }, h("span", { key: '75187514360a01e4017a6731764329d30ced087b', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: '6e91053e359122285ae6ac6ed94edaadcf8e2e4d', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: 'cf860ef3fc23f04ac537f87b1f77cffc94f13573', class: "card" }, h("div", { key: '03d481f687a73a1890bdf80b28284e0e3cf79976', class: "p-1" }, h("p", { key: '3fc1c00dc3fff3f19a87a2d887bd9b7d8e839046' }, this.booking.property.name || ''), h("ir-label", { key: '0bda7c5eeeb4c61eec920a923045a29cedfcc39c', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: '62cd298840e0b584872d029325818d043ff20148', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: '4fece3409267c35d01659caef2c4effae650624b', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: 'f0d400c38cd031184c04e070bbdf89772c6322a8', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: '71a6c519da7ef967cd6ffcac154a93b03e8d85ce', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: 'bdd9061b9a4085a10eb939b2bb5a169aae33db3d', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: '00c81416a833bca4306631c2547ade6b2b4e3009', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: '771329223441122d50672ed26408253b23638f05', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: 'a3699da18ff910efa4cca7306785aa2aee052b68', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: 'c3d67a430b3645fa517088a357d047dd58e97b70', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: 'a8176d667ca823dcbd3146d0e31e57ca01b2b728', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: '4fb21321438929e5a8288ddb6d7a9e5d56be459e', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: 'ee697c501c9126a67ba973816b4136a7ab4c32c4', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: '6f0388f4183ee67840f42d7f48a84810c7d0b8df', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: 'b019fbc58a282a52ba82da0898d6189ccf48feb4', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: 'c653f122d9bd06ddd53989afc7f088f511465434', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: '4f39d4146500ad55326dbbdca38e81b8daffca8f', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: '834fc5abfedf8736d6f7e2a19f4d89adc7cacb0b', class: "d-flex align-items-center" }, h("svg", { key: '437ac56b5651ef63a1a09b00c80513f9256163ef', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '5f2000a899c83ddbc12c1e37b8b30224693b8865', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: 'd64a74fb7b9adba8c5b4f3d9923a3778c47115d3', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), h("div", { key: '7bdd3f75f8291f295f3378c8f41c0f9d812d725b', class: "d-flex align-items-center justify-content-between" }, h("ir-label", { key: 'cab579b722cdcd3d17fd84caa69fac857916d6b4', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("ir-button", { key: '63c8f528ac80f8ae590d17cc6e6c9b59b8552d29', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: 'cb14da3059abf100e1859e89976e7e294cbc7cf8', class: "p-1 d-flex m-0" }, h("ir-button", { key: 'fecfa96cf6371b5fa168ee2e9ce8f24aa70c6568', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '101778a136c61bea148c7e04f6dccf25b81ee9d7', class: "flex-fill m-0 " }, h("div", { key: '08f3176f920dec3f1b897941573085c6fc6c2d0f', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: 'a31efa705b00319448ebd1f9445a35aa839452de', class: "m-0 p-0" }, h("span", { key: 'ebe54d310d52a2146a532dc05e33bfb3ea7e4760', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '46dee310d9c4c4ced731a4d209c49b33a897edb3', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: 'ccd8a75bbf334fe701ccd41fa4ef95a9959a2089', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: 'dcfea091f0701b11607d63573a20aa9c4d57f571', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: 'e5b8d294f4629c73d0525a61a4619883367e3b7e', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: 'e7b368c79f574e939b2997422ee8f51e1aa39db6', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: '22e3b16e140e8029f9158677e21119869b77dedd', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: 'ef30eef7d18988a3b526f6ee8958792552e117c3', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: '3968a11df09a152661b6fd5e23219d9b7d345b03', message: this.room.unit.name, customSlot: true }, h("span", { key: 'ba8e7a4bff66dfdd40017a62db787cfaa3c2a617', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: 'e9ac536dea80afe9d18e4df42d44355bdb106142', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: '4f706128c2e5c7578e6a069ec86e252b2ba775e8', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: 'f9af73cb6e6dbffd62c2d5dc6514060e9715bdaa', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: 'f30e213737a74b019a7a34722ec53f323a56773d', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: '37a528948c6633fd38629456823c15d575e5ca4c', class: "m-0 p-0" }, "(", bed, ")")), h("div", { key: 'c7427917d35df9ac434debae2b39d2493966477c', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, h("p", { key: 'dfe2a1d908db3e1915844a7f1399a4e8a2419e6f', class: "m-0 p-0" }, "Expected departure time:"), h("ir-select", { key: '68fe914f982acf2027ae5c0cf737729ea715343e', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), h("div", { key: '0ddb9cff80b22e48b56dd354df5a1a177fb13552', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, h("div", { key: '994ffb5a3d8d0ddde80e8ffb0734ae7b7eeb7b59', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '1f397fb8c62bef2c9e178a611e551ad960a09ae4', class: " sm-padding-top" }, h("p", { key: '4b532f97523d27044c182e1bf30f6aec661bc74d', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: 'eb7fec24528ae93901370acbef1a598e2bd420eb', class: 'flex-fill' }, h("table", { key: '9402f793ebef4934f424209510d225247426df1b' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '18c3449498cbc9268e664ae72b817d34482c6875', class: '' }, h("th", { key: 'a32a74b191061d60665ff8f8a32d1c6587d720eb', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '1be11aecf99c958e86046fc29312d26f5cbbbe25', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: '1d3ccd3477d9c3f133a2e36fb146b4241d1115d5', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '5ff5ab3915c1d3c6d17dec424a64884044772f51', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: '92d00b6331201a9e6c0e0554646d0374056f5f60' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'f5581b3639754d28a6eda8048cf8f943c5aa2df4', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '97a207a2178cffa35dcf6afbe7ea4e95e571b38d', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '80c3f3cbf9bb76d2bb0ede3e99f7f8d4dc6b85a7' }, h("ir-label", { key: 'adac513013bff9225da5aa139945f422de2e607e', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: 'fd328eb3a8e073d10ab5dbbd26ddab0ae964df0d', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), h("ir-modal", { key: '01ebd69b0fa710b05ecd9d44b736f196e58272b3', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '2faf053d6d28da4ae74a58c0f903e97ddb6b57a8', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '8e29312a26d70717ab115c9d909635321b1f5366', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: 'b02101677c219dfd134a4232793489eda920e10b', class: 'sidebar-title' }, h("p", { key: 'da5ca53a8304b957259bb92ca6c8bf7afeb5cfe5', class: 'p-0 m-0' }, this.label), h("div", { key: '1888fc5fa82a9dc6270bba59c68bece931c3c31a', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '4149dc45d2de154e2bc88caf512580ee6ef57649', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '188b819230fe59dfb3e0625bf65a15e3159f6383', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '57caf975e8722075eabe562cc93cd5cf6c249f0a', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: 'b5c21497003024e935047147ec12eed23429d9a5', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (h(Host, { key: '2d019ba7d4a96d4bf0aae269f21dd0eb65aea80a' }, h("h4", { key: '383abbfd6ae17bf496ea8389bf866976a3b93248', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: '5054e049c99e5fd91bcb3f54fd5ac6c8c7329ef3', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '967910f1c04142538ba1dae4e0ad1a500ccda6e2', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '47dd5a5c1cb355403cd52fe554ab45e41d6960cb', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: '2ab0738a3c959a82f4dd007dce8e29a9be643894', class: 'title-body' }, h("slot", { key: '8b0fa6f10e29c34317f9e8a8f1cbf6eaaa2e09b4', name: "title-body" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
