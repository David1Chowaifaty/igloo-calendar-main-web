...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '24b5814f2d5c367a72415d8e80d7d1a75b746b75' }, h("div", { key: '759b451b266c86d10967003b068b94a1d5aa8c7a', class: 'd-flex align-items-center ' }, h("label", { key: '8ab8e7b03d9dd2396ed17acbd52cfb23142d6627', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: '00e8f6b6730dfcc95f35b293e4a9b8064798a24b', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: 'a74558cca3176dcbc7c236910d8c97c0a4189776', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: '02d7149a3e5221b50bd2478b6aa986442c7f3444', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: '0f4fe20f5797b03a5a057b42dd9c60f8d8ed2154', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: '5f2293af34b97abb7e85448daba437ca873ae243', class: 'sr-only' }, "clear input"), h("svg", { key: 'f54dee695c56e268e25b265049665a970ad26818', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '9a33c8358fc00bdc079cda09bc8a4c34c70f120a', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCommon = class {
    ...
    render() {
        return (h(Host, { key: '762cc60e66362293b5b9a6366095351ca9e9e668' }, h("slot", { key: '397d995cde59e7a38911896ba3d88f3f731aabf1' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (h("form", { key: '3e69f563059d6bc0e48e1a58d1f8b2d4cd1149f9', class: "dropdown m-0 p-0" }, h("ir-input-text", { key: 'bb9e563961d338505674c49cc7b97de8bfc68a58', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), h("div", { key: 'c0df1d6cf9b69835eb522051d64e1c374862c582', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (h(Fragment, { key: 'df6f76f8e2fa80a929ea63449b703d10ffc906da' }, h("button", { key: '2e7c9ce86952597e3f3eaf03d33e065b29a2e40f', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, h("img", { key: '1d71775f6c14946903c7dd62b0d410511a2a14f4', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), h("p", { key: 'bf72621a8a435627fee55b3af43399f660f8e323', class: "pl-1 m-0" }, this.propertyCountry.name)), h("div", { key: '4894f5b45bd2ed5d245a53b05797d87e86ee3c49', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && h("p", { key: 'a9a784520a0f2d9a1b36cf068d7b85b9c8d3cf6f', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (h("div", { key: 'fdcb100ec029ea20061ad46e6bbfa89b69684ae6', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && h("slot", { key: '1d3255f5dcba8efb3e29d7752972f854c9c579f1', name: "trigger" }), h("input", { key: '90d000ffe4654337d14ec0b9ef520a3e004a9a3b', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: 'b341f2c7bf9c50d2062b7aee56be19d4a26ff94e' }, h("input", { key: '92ed4bb1c768087f299bbb9fc51a21f03d80c4d5', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '858414785b2961c644fd4509876fefdc478e7e8a', class: "d-flex align-items-center" }, h("span", { key: '054272c0b5743d6cbdddb0b7f8a0d951199cced7' }, this.dates.from_date), ' ', h("svg", { key: '58ad937601dad98b43d0b351644f468fc5563a21', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '9ff565ea16bbc53d2167fd611b722eb4a735b086', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '9ae292f4282e46c20127afbfd4b69167c5a4f4e3' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '2f77ec9912dc6831fa79e2fc36020e246025854f', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: 'f028533704465abf3ae4b39ae8aae1a063ff0f0d' }, h("div", { key: 'b2f1814b0d5724bce36a1e45b4deb3091520cbfc', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '870cae3d4bb26c33074e38a3e6073cc57ae49cfe', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: '6d8a7bbbc343cd2fe48452ed2b233703a4da90a1', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '2e55cada8d44d98e5f7f4f07b89bd1d3739299d4', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: 'f7b1882ba582d543bd662fd511457dc5bd4e5751', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'bd08a5fae9f433d54c61ebdf5f03c6f3da8013ae', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '0b56010378a778fce233a3446ffa4cdc74c10609', name: "modal-title" })), h("div", { key: '16d7be3510603b4cdd78fa1a204174767dc2b239', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '1f2dadec6305184484d317917fb96478e12277f5', name: "modal-body" })), h("div", { key: '22a815ac2fa3e13d63b4e68a09c6ae71515f4a76', class: "modal-footer" }, h("slot", { key: 'bb87262affbadde5b1c9b1e2950af11ef76c4f86', name: "modal-footer" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (h(Host, { key: '20264fa49ef3fde325e3cc34ebbea77422951856', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? h("span", { innerHTML: this.html_content }) : h("slot", null)));
    }
    get el() { return getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: 'cb6128d6043bd41c6bdaa45fcdcabc39c6fbd0b9', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: 'f056e91892411d5c3c0aa559bef3b6627bdcb94f', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: 'baf7c617168c593672806dd8285ccfa204c266dc' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: '7808366463e330070edfef22ab837c0fd5908a70', class: "loadingScreenContainer" }, h("div", { key: '38704ddf9a793b1e4ebdb67b564e6c1e3a866d5c', class: "loaderContainer" }, h("span", { key: '5c05ffc5bbd3246bc6fea42c8854c4ebf441a046', class: "page-loader" })))), this.showModal && (h("ir-otp-modal", { key: '2be1527575ae44600f094ee05cf679cc178115e6', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '8efefb6f5e1f683401c50bf500d7a2a122385edc', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '639e7a7da0bf2c308e863bccfa8b685b990b18ad', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '13562a9bbda678d0643808c51268050b52e029f4', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'bbd65e20bd9e054a20502e7afd6f69db020f3388', class: `ir-alert-header` }, h("p", { key: 'd79be87858fe46ff3081c7112a6ec74309279085' }, this.modalTitle))), h("div", { key: '643345241811d9cb426c45a74755aef3d793cecd', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '6b2af187a1532cde8c314bedf95ad80ae6476478' }, this.modalBody)), h("div", { key: 'bed094fd0dc1c0f55d26d224e7650568b1514c56', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '6d970826486e547f54299bd6eae107b4c12e6c0c', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: 'db0bbe8ec900818035ddce130da0ca60504548fc', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: 'a20c83df4b5487904cc7abfd08fe93e1c0b8fe3d', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: '75e20ad890de9b40280ea3f69c38fad035d3ed89', class: "otp-input-container" }, h("div", { key: '82c16a183e42c0644557996db4321b7bad06788e', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4a1749af5b76c1e6f4ba45a80f21e37cbf4df670' }, h("div", { key: 'a7f41cb8c5a08af77170372f95661aca97c4bd4c', class: "form-group mr-0" }, h("div", { key: 'fa555e543b21812e56a1556357141317473dea64', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (h("div", { key: '79e1fc624809775576a9a7ba8415d5a344cdbbb3', class: `input-group-prepend col-3 p-0 text-dark border-none` }, h("label", { key: 'af7a11cf207b1bf9304a107f7fd17eae8ab0f575', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), h("div", { key: 'dca3bd77f31509de50a184ea8ee9ad2e26df5b1f', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, h("button", { key: 'ba0425d5f945134ec4ee686c3cd5890441347b6e', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : h("p", { class: "p-0 m-0 " }, locales.entries.Lcz_Select), h("svg", { key: '3dc84bae24cdd24efceb298a37e5ccbdbe5f91df', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '1317897527cbbcb35fbacd12507a949277d668c2', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), h("p", { key: '315bcb1023189464993258eee5e699487514d8af', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (h("label", { key: '6fcd415d76d9f629f1f62cff971eef46daede670', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), h("input", { key: 'afb7b7b6035d1e6fd07db354cb039a4c2d0a7a34', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (h("div", { key: '5090871c5929192f039238afc158b14d2ceec382', class: "ir-dropdown-container" }, h("ir-combobox", { key: 'c9ddc176cca1bd6f65c747258ffb464c6b334c98', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h("form", { key: 'd32dab60389d73746772205faed1c74482945cfa', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-title", { key: '52926b9e21b98de3245c79ee43b6f3c29acc49f2', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_Pickup, displayContext: "sidebar" }), h("section", { key: '05ad61c10637a71810889f77737f01c973dc32c8', class: 'px-1 sheet-body' }, h("ir-select", { key: '375edebd6ac82e55e9fedc06b1d8049dff96640e', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h("div", { key: '262be3d31efc3715bb3be07a577e23ffe29db8b8', class: "m-0 p-0", "data-testid": "pickup_body" }, h("div", { key: 'a70a81c9b49bf4a77557122cbc8c0c7de65aabf2', class: 'd-flex' }, h("div", { key: '25a83285eee38d433682ba8f3e552935226a93d4', class: "form-group  mr-1" }, h("div", { key: 'e7403d66a2117a959c106e7ed5d2d916cc5bb670', class: "input-group row m-0" }, h("div", { key: '97eeb6dfa991f61771f5762b85e5f97868619fe9', class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { key: '385d93f64db7bb7c940cd1cdc98dac310ad8ecd2', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { key: '2996020d5f4caba76f2f8b26b04e113c6e55236a', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, h("ir-date-picker", { key: 'ec15518d71b410bceacc1e2d34c58201066e2b14', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, h("input", { key: 'e6d763cbbbaaa286bd84487c6bbbf510d11d95c7', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), h("ir-input-text", { key: '1c7babc0540edcd040d3274d145ebefc7723e579', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), h("ir-input-text", { key: 'cc9f0c01c7f60315fb9a11d2abe9b23c5cace976', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), h("ir-select", { key: 'aced910f3cec24168d9a966f16fc52411b403bfb', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), h("div", { key: '7b1e5050aaa62298b8e73724541ebed79c8dc413', class: 'd-flex flex-column flex-md-row' }, h("ir-select", { key: 'edff06c7ce0e048fcdf9159e8ee8fdf59591e5f7', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), h("div", { key: '3394073e990329162847df7027f47d17930097b0', class: "price-input-container" }, h("ir-price-input", { key: 'e22bb1bc423f1f9701b5d458aaf245e8017a1717', readOnly: true, label: `${locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), h("div", { key: 'fcbc632358c99d1454bd8a4f94920c7e3171aebb', class: 'sheet-footer' }, h("ir-button", { key: 'bf6fb6baa5ac07e2301e36f8d0f9e2087f6cab44', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (h("ir-button", { key: 'a460aa6a5bd987e48ead19d56eca66b135f5ce2e', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: '4784adf0decc2eddedfec56b91eef4604069a1f4', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: '76f0b858d008481b184b2a254e7450d59cb1ca05', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (h("div", { key: 'c2165676c00cfa7254ca261535aab289dcb79c48', class: `input-group-prepend ${this.labelContainerClassname}` }, h("span", { key: 'c072a9ca0cbdd833ad413a99e848b0beaecd5b3f', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: 'd6eb4c1ffe17c2d3356f2289769c59b7c28bea8f', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: 'd2729628cb78d2b2e52eef8642455afa845fbd93', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '70eda6e2423d3cc6181a6c276f0721c68b06cf42' }, h("span", { key: '720d3ab534eb71ddee9bdae181c0571a726e0380', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: '7fc81c3b5c43e7c0a804499c445993ca8860168f', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: '6e39270272e54cf84ea8a6b1adbc5baf444c944b', class: "card" }, h("div", { key: 'b1630fa4761f37789ba446abc7a2069eec7eef1e', class: "p-1" }, h("p", { key: '3da7d69e4201f43ea66f72a13a02d38d1d8ee059' }, this.booking.property.name || ''), h("ir-label", { key: '4e1c16b48b7f81bfe51c3ed840c5e541b0062b6c', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: 'e8cef79cca96f87671f3047fb6acb2ededa86129', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: '78041ade71abdac6b5d9ebe7110e14232f5c47ad', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: '2007a93cc8b663635d6e7e702f8ad2cd0daeba86', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: '9e9305c73ddee31a703b569b573cb6fc0d2092cb', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: 'd997bac897a8b511bd46eebe76553dba26bdf8bd', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: 'c899b5e10c470250c97fc6e7644ce57061d17ce4', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: 'e36e4b32b8eb0bb32283c5e95bc603216967379f', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: '045b8cfe96926b1ae484ae590be33b32bf1baf5f', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: 'e416b6024781e0599f72bef37391585ac94abd8d', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: 'cd07ec1d7906be89fd8be1b4839185dd369ab8f3', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: 'eaf3d5475d8389374d817562f6abed08ceaf78f2', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: 'af02f4774b74089d61cb26349f46a97af97116d9', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: '8e30cf90902d13518c1c8c358bc3d33e856caa51', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: 'fd083faf287c7db5e9be27c778b1de6e7b35ac78', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: 'bb8c0fcc91a41daef81fa90d86726de9e395c750', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: 'eee49734a60949ee501711f6b96c15fc94b77a1a', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: 'ccae8957124eb50581f55c46de95562fc2426af4', class: "d-flex align-items-center" }, h("svg", { key: 'bb3ceca81849421ec1b4c5cac79e71dd861d24fe', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'af469982cb9fa8f136d45f164be236eb17ab318b', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: '1409164ed9208567cdd16fc8718ac3c51d3ab5a6', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), h("div", { key: 'ba14775844d248867199de3d451fc51af5634ccc', class: "d-flex align-items-center justify-content-between" }, h("ir-label", { key: '22ec5587ec44cdb82b452db86e6773877b8ad20b', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("ir-button", { key: 'faf63960ec3dc418f25a60937600847a6253dd30', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '818009a400175179b2491ea4110b20da03c8d661', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '9cfbaf0e8b8864e5e2844e466b2ecf057cd5881f', class: "input-group row m-0" }, label, h("select", { key: '3010d54804cc537f3a277cefe3e4878afe391585', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '96086d50ddd6016a10b5d9fac74a038dbab8bebb', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: 'ca999a7be196b633295eea6ab9c0067e4ec9dfff', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: 'dcbd6e5f3b80bc322ea65c7a171922089c244f53', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: 'cf1ab5286d50190736f3eb212efbeca615f65dcf', class: 'sidebar-title' }, h("p", { key: '51d0112130fc9257ed435bd440280dd3beacd7f9', class: 'p-0 m-0' }, this.label), h("div", { key: '69d9b9187b13301069ee316c8f4b7aed16f45297', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '3580bda1bac1ee07a7c48832b38f1fcbada0837c', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '4f83a9ab9e8e39fa21d03e71a3233ed627842149', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: 'f80461baa574d7f7131efba22e34b024a5eea28c', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '1b28df8046a31e4cbf8ea688d802fc8a3f1aa279', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: 'a0861df0f05294e34e53fef35ebcf7b28b84e66f' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (h(Host, { key: 'ef7da726c25c52dd97ccbc616162a675500c7056' }, h("h4", { key: '1c2bd88097f055f4940748d623ba5b11dcfb5b07', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: '6010d1a73041b8ece6c9bbd52364071d928ecce1', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '0c5ec207a7651dc2ef07aa05db11612aea1a3b5a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '1d81e1d357c675f309a60807b360cb4b32e61568', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: '2d4ad98c86d98dbd066cf2d828d36151ed637db4', class: 'title-body' }, h("slot", { key: '1a46c279fc6f3850c39f0aeed8963c703019db3a', name: "title-body" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
