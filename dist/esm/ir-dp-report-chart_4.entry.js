import { r as registerInstance, d as getElement, h, H as Host, c as createEvent } from './index-Kqbk9HdW.js';
import { C as Chart, r as registerables } from './chart-3KrsuFTS.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { o as onDpReportChange, d as dp_report, u as updateDpReportFilters, s as setDpReportTablePage, a as setDpReportTablePageSize } from './dp_report.store-DIK8vZuT.js';
import { f as formatAmount } from './utils-1xMAwYd7.js';
...
const IrDpReportTable = class {
    ...
    render() {
        ...
        return (h("div", { key: '44ca05249088d5fac7a2d6c819ffc76f85a0277f', class: "dp-report-table" }, h("div", { key: '8da2c5848ad0672f7fe0c5c1ed18eb306897c8d5', class: "table--container" }, h("table", { key: '1ecd4c227319978ce0b26275c945104a30283c99', class: "table data-table" }, h("thead", { key: '39ea31fd7a24621e7733fefba20227cef0fbfe2d' }, table.getHeaderGroups().map(headerGroup => (h("tr", { key: headerGroup.id }, headerGroup.headers.map(header => (h("th", { key: header.id, class: { 'cell--align-end': header.column.id === 'effect', 'cell--align-center': header.column.id === 'units' } }, flexRender(header.column.columnDef.header, header.getContext())))))))), h("tbody", { key: '8e75629bf495dd1eea12e56d32063d3a50c77fc9' }, dp_report.isLoading ? (h("tr", null, h("td", { colSpan: this.columns.length, class: "empty-row" }, h("ir-spinner", null)))) : table.getRowModel().rows.length === 0 ? (h("tr", null, h("td", { colSpan: this.columns.length, class: "empty-row" }, h("ir-empty-state", { message: "No dynamic pricing data for this date range." })))) : (table.getRowModel().rows.map(row => (h("tr", { key: row.id, class: "ir-table-row" }, row.getVisibleCells().map(cell => (h("td", { key: cell.id, class: { 'cell--align-end': cell.column.id === 'effect', 'cell--align-center': cell.column.id === 'units' } }, flexRender(cell.column.columnDef.cell, cell.getContext()))))))))))), h("ir-pagination", { key: 'f62b4b1f706aaac356fb0b9bd428418364566a9c', class: "dp-report-table__pagination", total: total, pages: pageCount, pageSize: pageSize, currentPage: currentPage, allowPageSizeChange: true, pageSizes: this.pageSizes, showing: { from: total ? startIndex + 1 : 0, to: Math.min(startIndex + pageSize, total) }, recordLabel: "bookings", onPageChange: this.handlePageChange, onPageSizeChange: this.handlePageSizeChange })));
    }
};
