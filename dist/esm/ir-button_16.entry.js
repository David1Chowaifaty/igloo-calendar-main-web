...
import { h as hooks, d as downloadFile } from './utils-816be0d7.js';
...
const IrCheckbox = class {
    ...
    render() {
        return (h(Host, { key: '7a4153a8cf86e0420b35d7834299ce8a92b75bb9' }, h("button", { key: '03d844322f1cd678d2cec8507ee95b4716f61922', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: '8ba6b88eb36b0322b2900e0e78578e760ab6b0b2', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '976629d2182bbfa9e9f94742a8284d9dcd9c0434', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (h("svg", { key: '05b8e19f047126af40b78d02ee9adf48884683b6', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'd722f8c40ece1c5e5070e9c0bd97f52d92895cfc', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), h("input", { key: '043d0ed84cc33a3950946f0690fd53ebc40653c5', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (h("label", { key: 'eed3218f855aac92c0991c801819b99b830221f5', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
...
const IrCommon = class {
    ...
    render() {
        return (h(Host, { key: '83437c3e5458fffa128593f911148bb3ccdc1824' }, h("slot", { key: 'a78cf616e25eaa7304968d26f474b275ae32da5b' })));
    }
    static get watchers() { return {
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '40207aeaee212680501958615e113b8b6df706c7' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: '58c463b194da18e28eeecbd56b42d79130dcd3e8', class: "loadingScreenContainer" }, h("div", { key: '46d51275799051002597073ddc9c13caf20eb239', class: "loaderContainer" }, h("span", { key: '6a4a347f89929e509387a46faeedd69f296e51cf', class: "page-loader" })))), this.showModal && (h("ir-otp-modal", { key: 'c4ac49d8ccc30ae04bf7cab75353a25d514d9cfc', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrRangePicker = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '6db3e3ecd002886da37898bf182eee6c01afa199' }, h("div", { key: '30f38e14fbe0e4659980ae3738d9469550350a7f', class: "form-control range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (h("div", { key: '8190fba9421909ed88130644e76c97f897140609', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, h("svg", { key: '51733fc72b25dc5127fa2e8c0a8047fecdfcd426', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, h("path", { key: '3f7d368d464ab910044bc4c1f129cb96c1689373', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), h("p", { key: '8321d325ba18f26ed4a655e6a1d5fc45f35e4c66', class: "m-0" }, h("slot", { key: '7e1f0da490da26946dc674f17f1449e052c816a7', name: "message" }, "Cleaned on")))), h("svg", { key: 'd1e71b7ed74193d46c3cc986a3b4f1697b05edc5', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, h("path", { key: 'e50ab0062c031eccceb1df61803cd7afd2cb566b', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), h("svg", { key: '5457be657674766a5b9feaaf433277f22bb6cb4b', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '36e6932d13e5365fc77f13533e545933744299e9', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, ((_a = this.fromDate) === null || _a === void 0 ? void 0 : _a.toDate()) || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrSalesFilters = class {
    ...
    render() {
        return (h("div", { key: 'c7d33b86376a9356f817fcd094fc9152600e5cd7', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, h("div", { key: '0b6200207020d59091667ca970ba63b5c524f891', class: "d-flex align-items-center justify-content-between sales-filters-header" }, h("div", { key: '8f12cd2134e07dc790f5507989571c1a3ac55933', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: '5427082023ec9b524e8dd023ad229a081c46873d', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'f413d86718add951c16fcbdf864f450af1399b8e', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: '5892834fe59bd86dcfcdf79185fb5f709ae6f3ce', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: 'd9b830a1c65882fc4a363c1ed78c0782b13b4bfa', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#salesFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "salesFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
            ...
            }, fromDate: this.dates.from, toDate: this.dates.to, maxDate: hooks().format('YYYY-MM-DD'), withOverlay: false }))), h("div", { key: 'bcd5d88c76ffe1cf2620e11fa309d3e42cd12398', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, h("label", { key: '52db038a82c447d5f90907289893a868a4dc8f7d', htmlFor: "compare-prev-year" }, "Compare with previous year"), h("ir-checkbox", { key: 'f8abef64ebb8aba4a7400fbd67051bda7113ae50', checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
export { IrButton as ir_button, IrCheckbox as ir_checkbox, IrCommon as ir_common, IrDatePicker as ir_date_picker, IrIcons as ir_icons, IrInterceptor as ir_interceptor, IrLoadingScreen as ir_loading_screen, IrOtp as ir_otp, IrOtpModal as ir_otp_modal, IrRangePicker as ir_range_picker, IrSalesByCountry as ir_sales_by_country, IrSalesFilters as ir_sales_filters, IrSalesTable as ir_sales_table, IrSelect as ir_select, IrSpinner as ir_spinner, IrToast as ir_toast };
