...
import { l as buildSplitIndex, c as calculateDaysBetweenDates, k as getPrivateNote, f as formatName } from './booking-2e52fb0c.js';
...
import { t as taxationModes } from './property.service-cc248a56.js';
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'eb152d3a2f750915352282f2eea660f2519d7be4' }, isValidBookingType && this.roomType.rateplans?.length > 0 && h("h5", { key: 'cd952e756171dc0273594aff62ff8f6e0f7d9ee7', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: 'd3421ab9ebe94c2e6cbb843ff40bef50e665a35d', label: "Edit Arrival Time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, h("wa-select", { key: 'b4e9f3d7b5de3e0d4668306dbc14bd0fdea5c12b', size: "small", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), h("div", { key: '7ce63fbbc1421c9863f2c5709bc89fc5df94b0a5', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '137c661fe6f4e57f21284e3f49ab3a256d14c295', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '2979d91b3b5a892e83a58c6101a0a5af6e5d6249', size: "medium", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales.entries.Lcz_Save))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (h("ir-drawer", { key: '592d83763ae16f9a37a616b940bb220120be6c32', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && h("ir-billing", { key: '204e69d512d0709f098a35c5f80f20f5a54e83ca', booking: this.booking })));
    }
};
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (h("wa-badge", { key: '8e68b622c8ec9632c666438e9e89e1c88b7a823c', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
