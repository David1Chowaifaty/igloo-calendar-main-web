...
import { C as CityLedgerService, m as mapClTxToFolioRow, b as buildPaymentTypes } from './utils-c917bf00.js';
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: 'ae5c33360f3318db915830f76e91b3a52eebab48' }, h("wa-popup", { key: '443423af079e0129d1e5c32de2e25b974e27050f', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: '05b106357e6e39e47807b8257889628533eb7976', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && h("slot", { key: '159824727740449b73fe060e842d7d4da42f0cd0', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '5beeccb4d192e3167fad397d60684d829077225b', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: 'aec234db0a7b0462006ade68b7ce3ab619add0a4', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: 'f92ae2d429cd8140cd177c99a2024eafc83fb5d2', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '7316711aec771c05a3155b08600c43a7af4e090b', name: "hint", slot: "hint" })), h("div", { key: 'ecb8d521d6ce0c10ba9f04b1005e4e5e62abbdc1', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: '1d6e71ddf9f50e5e7c1e004489c1edd72748e51e', onSlotchange: this.handleOptionsSlotChange })))));
    }
    static get watchers() { return {
...
const IrCityLedgerToolbar = class {
    ...
    render() {
        return (h(Host, { key: 'f3e47dde8f8c17b90f5e72b913ec1233a9a2031b' }, h("div", { key: 'cad41541680b3c26bb34a19c546546df944a2d55', class: "toolbar" }, this.accountOverview ? (h("div", { class: "toolbar__stats" }, h("div", { class: "toolbar__stat" }, h("span", { class: "toolbar__stat-label" }, "Net Balance"), h("span", { class: {
                'toolbar__stat-value': true,
                'toolbar__stat-value--negative': this.accountOverview.ACCOUNT_NET_BALANCE < 0,
            } }, this.accountOverview.ACCOUNT_NET_BALANCE < 0 ? '-' : '', formatAmount(this.currencySymbol, Math.abs(this.accountOverview.ACCOUNT_NET_BALANCE)))), h("div", { class: "toolbar__stats-sep" }), h("div", { class: "toolbar__stat" }, h("span", { class: "toolbar__stat-label" }, "Due Invoiced"), h("span", { class: "toolbar__stat-value" }, formatAmount(this.currencySymbol, this.accountOverview.TOTAL_DUE_INVOICED))), h("div", { class: "toolbar__stats-sep" }), h("div", { class: "toolbar__stat" }, h("span", { class: "toolbar__stat-label" }, "Uninvoiced"), h("span", { class: "toolbar__stat-value" }, formatAmount(this.currencySymbol, this.accountOverview.TOTAL_UNINVOICED))))) : (h("div", { class: "toolbar__stats-placeholder" })), h("div", { key: '6c756bf78694d37605118fd3686f6822c6ca1ec2', class: "toolbar__actions" }, h("ir-custom-button", { key: '001f5cdcadd90fb98ec41ee93f1b9690e7b9ce68', variant: "brand", onClickHandler: () => this.createInvoice.emit() }, "Create Invoice")))));
    }
    static get watchers() { return {
        "agentId": ["handleAgentIdChange"]
    }; }
...
const IrCityLedgerTransactionDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'b01729e5b914d84c81a5702ff2b5095dac16f818', open: this.open, style: {
            ...
            } })), h("div", { key: '478ebaed39d1a31b3f89d4cae1eda196183c35be', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: 'a79cffb07a039dfefd9539875f5276fa24db9fdf', appearance: "filled", size: "medium", variant: "neutral", class: "city-ledger-transaction-drawer__btn", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), h("ir-custom-button", { key: '9e8f2294cd01229d86a8ce24a32d188925bf5c0b', form: this.formId, size: "medium", type: "submit", variant: "brand", class: "city-ledger-transaction-drawer__btn", disabled: this.saveDisabled }, "Save"))));
    }
};
...
const IrClInvoiceCityTaxAmountCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: '555fd82e57d5ce6ad52f735ae111638491cd0060' }, this.cityTaxPercent > 0 ? formatAmount(this.currencySymbol, this.amount) : '');
    }
};
...
const IrClInvoiceCityTaxPctCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: 'c6943dd10a28866aa69296f7ac6938b737070c87' }, this.cityTaxPercent > 0 ? `${this.cityTaxPercent}%` : '');
    }
};
...
const IrClInvoiceDateCell = class {
    ...
    date;
    render() {
        return h(Host, { key: '695aa61c91360d5af4c0e853bc8c18c70ac59a00' }, hooks(this.date, 'YYYY-MM-DD').format('MMM DD, YYYY'));
    }
};
...
const IrClInvoiceDescriptionCell = class {
    ...
    description;
    render() {
        return (h(Host, { key: '490cdefe48fc8ff9b2ef1de24485df89e677a9cd' }, h("span", { key: '5f3e29b42ce36fe5b210c7240c6c18426801f0f1', class: "desc" }, this.description)));
    }
};
...
const IrClInvoiceNetPriceCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: '5fe726087ba67ef36f7113add82528df5fd4351b' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceTotalCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'e1f186fa1d1bca12e1792bbfd81bd06d2f29800a' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatAmountCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'c3b40ecaa2f24f8b41a02ddec20b1cd981810255' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClPaymentFields = class {
    ...
    render() {
        return (h(Fragment, { key: '6301c7bd54cf3dcbe91705be91595ef68abe9950' }, h("div", { key: 'f1689dd1d918ca3775f23343f48970e2670c0402', class: "payment-section" }, h("div", { key: 'd550ad0df8e55ec6b3eb21882411891e8e1c7501', class: "field" }, h("ir-validator", { key: 'f2a1dd54367acc73666596e7e87c0fe517921127', schema: paymentMethodCodeFieldSchema, value: this.paymentMethodCode, valueEvent: "change" }, h("wa-select", { key: '7188cef828548902f4a9efc47441a202b2f4f074', size: "small", label: "Payment method", placeholder: "Select method\u2026", value: this.paymentMethodCode, "onwa-show": e => this.stopPropagation(e), "onwa-hide": e => this.stopPropagation(e), onchange: e => {
                this.stopPropagation(e);
                this.handlePaymentMethodChange(e.target.value);
            } }, h("wa-option", { key: '579caf1ea702aa7c085c7851924c05b484c43329', value: "" }, "Select method\u2026"), this.paymentMethods.map(method => (h("wa-option", { key: method.CODE_NAME, label: method.CODE_VALUE_EN, value: method.CODE_NAME }, getEntryValue({ entry: method, language: this.language }))))))))));
    }
};
...
const IrDateSelect = class {
    ...
    render() {
        return (h(Host, { key: '7438e92ac1259faa7ceb3949a0819baf7a7dd555', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, h("wa-popup", { key: 'f60c3d06370530cd4895871dd70da4c59b311360', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, h("div", { key: '5dc269255c2bef9fc6855463cb6a8e559cd120cb', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, h("div", { key: '5ae8753c181134cf16ca5af706767d0337bfd504', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, h("slot", { key: 'e66337ef3fd030ba6b5969c3c75ff25edce14f13', name: "trigger" }, h("ir-input", { key: '90f63030044060a88c6f8887cbd6b07885fc4537', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && h("slot", { key: 'bbf83e5f5f5214bd1ea250b7a3073970d3f110bd', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: 'd4fb7c8dcb7cd5cffe38a251a73b10056f934b34', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: 'dc3e979b850c61dcab37a37962923ab782517552', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '775d647417cea616ac82ab6001924f59559a22c2', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '5cbc7ec88388a14e109c8bddab6b6f4e2e8f7917', name: "hint", slot: "hint" }))))), h("div", { key: '3c4b59e805648ab842cc436866bed5bb0022b7a1', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, h("ir-air-date-picker", { key: '0482bf5aa2bd7a8cf29c06eb99a118f25cb17ed5', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("slot", { key: '60bfa919a6e715536cc54b23f6aba12e8b4c1b56' })))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: '1d11347e8bd5a4fa5f36a86d3f1654080e905db3', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'ba55168aa722ffc4adf2c66f2b5c2cc544a57e7a', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'ba895e727c2b9a9df87fc1f9e0c7792ea3a2eae8', name: "label", slot: "label" }), h("slot", { key: 'a1a4890f8113e225508997488755c05708a5e351' }), this.slotState.get('footer') && h("slot", { key: '28719e1b1c2d6425ec3a9191cb57263f812554a2', name: "footer", slot: "footer" })));
    }
};
__decorate$2([
    OverflowRelease()
...
const IrHoldTransactionDialog = class {
    ...
    render() {
        ...
        return (h(Host, { key: '73502a418b3dbda6ccc0cc9f2487e1c8e749ce8d' }, h("ir-dialog", { key: 'c124f5daffb914d183174b48267bf4695e08e925', label: isHeld ? 'Revert Transaction' : 'Hold Transaction', ref: el => (this.dialogRef = el) }, h("div", { key: 'fd7cc59f89c09a1e3f12ce74eb4e49fc0a9ab249', class: "hold-dialog__body" }, isHeld ? (h("p", null, "Revert this transaction back to ", h("strong", null, "Unbilled"), " status? It will re-enter the billing queue.")) : (h("p", null, "Place this transaction on ", h("strong", null, "Hold"), "? It will be excluded from invoicing until released."))), h("div", { key: '3c761254b9823ee8a7cd558a2dedf7bcc787e4c4', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'a768cbb12d5509de5e7465f03d18c5e300de57d7', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: '94de7f8c9047823505a4b7225509f7e667e48686', size: "medium", loading: this.isLoading, onClickHandler: () => this.handleConfirm(), appearance: "accent", variant: "brand" }, "Confirm")))));
    }
};
...
const IrInputCell = class {
    ...
    render() {
        return (h("div", { key: '46bf134691571e4c18b2b07f6618d559d1bc55c8', onDblClick: () => {
                if (this.disabled) {
                    return;
                }
                if (!this.active) {
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '1ec2d96056115d9d2bc8c56e799e8c9bcf6f3794' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: 'a4ba73564cd809f8e1c26deceaa51d0e6dd4d7b7', class: "loadingScreenContainer" }, h("div", { key: 'cbc5e5fe56ca8b20f8565d67a04e135a7601ffc9', class: "loaderContainer" }, h("ir-spinner", { key: 'e57974ccfbed0c79f932cebe25ff8407c61e48aa' })))), this.showModal && (h("ir-otp-modal", { key: 'd849e49bc2e99ded9584ab2aff9c51aa5fbf0319', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: '201a26d5557daded07c3f6ae4b3cb4115259bb27', class: "otp-input-container" }, h("div", { key: 'ddda606ddb98baa4dbd8ac409dcc701da2ea633f', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: '2fdaad4e67c9e85731344e0b8b9c506e7f1bd254', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, h("div", { key: '0b504b83eaa0c31cb3931e35a562e47a03a0f1a0', slot: "header-actions", class: "ir-fullscreen-dialog__header-actions" }, h("slot", { key: '9a7d9642e1f22d886f6970be7ddacb7ea40a6429', name: "header-actions" }), !this.hideDefaultAction && (h(Fragment, { key: 'dccd5ebeb6c5c36482668697be9b40686c05f5ec' }, h("wa-tooltip", { key: '84374759307f6dc79fc5b2f12c7881b2b92918b1', for: this._id }, "Print PDF"), h("ir-custom-button", { key: '825a00596682a5a66e12da0009a8779fb42204b0', id: this._id, size: "medium", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, h("wa-icon", { key: '76bba023446691e62b6ba7baceea69a051737f41', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() }))))), h("slot", { key: '42511e740205400d2f9e47f8199b9bf063fe9606' })));
    }
};
...
const IrSpinner = class {
    ...
    render() {
        return (h(Host, { key: 'a4c52cf5e4c04a9e9d0e0068f9daf1d4b5f33ebc' }, h("wa-spinner", { key: 'd18ee73c31c92df00f93182b6c661f6a111d0599', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: 'e5c0d4fa810ebad6709f13808f85c35c31afc3df' }, h("slot", { key: '5044fae7f5b2be767670358dbe160144442807e1' }), !this.isValid && this.showErrorMessage && (h("span", { key: '0b8df133ba31d2a92d79c3d2a21f6a1b9495aec3', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
