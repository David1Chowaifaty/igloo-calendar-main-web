...
import { C as CityLedgerService, m as mapClTxToFolioRow, b as buildPaymentTypes } from './utils-88f5ff8b.js';
import { D as Debounce } from './debounce-542065c2.js';
import { f as formatAmount, g as getEntryValue } from './utils-dce64dc4.js';
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '488369b6032900f9196e4fccfcaea573ba018461' }, h("wa-popup", { key: '7476869cdfaa7e7431e2c2f51dd82a2eb74d8f28', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: '1bc85543d2945f740ff741b69dda600bab8a6616', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && h("slot", { key: 'e4eff103bb1a6211b9231053729e13e6414067f2', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: 'dad9d81d8e49b09c6af33a97695a54f3c67e8dc5', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '343f084306a751fae5bc2c935cd355b549d9199d', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: 'f7548cc91698ea119bc4ffeb1f923ed1332d592d', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '0a344acdb4c2ae4dbb019a5766ee02765c7af960', name: "hint", slot: "hint" })), h("div", { key: '80e3f31c03a4e2a049cacc5f31b5061b16a8c982', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: '8998b9b71a57613468e83be0c94dd793d57c5318', onSlotchange: this.handleOptionsSlotChange })))));
    }
    static get watchers() { return {
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (h(Host, { key: 'edc17972ddd91d84ee31f749ac95f96066a474b2', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, h("wa-option", { key: '70c567da088ac0421082c728d1c4ebca7af69b00', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, h("slot", { key: '768cc98873fd25e5a7eb693ae6f7ab856de791f9' }), h("slot", { key: '35ff059fb08ab1ad57431166efa6b87c1d63a319', name: "start", slot: "start" }), h("slot", { key: '2c94563c9f2e146c1db87b1aca7339b609a7eb4e', name: "end", slot: "end" }))));
    }
};
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (h(Host, { key: '44b056d3ff4edbbcdaa254d5353b6d7df793c005' }, h("div", { key: '51fe39db8d8e752d5eded49e39bbf164b90ab81f', class: "filters-bar" }, h("div", { key: '7b57e54a05ac1ac71f3f73c030d6cb35767dac72', class: "filters-bar__dates" }, h("ir-date-range-filter", { key: 'ba2a88aaf232954fd4fe87b0f6d2d296c0472851', maxDate: hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
...
const IrCityLedgerTransactionDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '0031e91ee9e9ff02b123a42e995d383ee657b3b5', open: this.open, style: {
            ...
            } })), h("div", { key: '1cb64ff9f1212bb36a3a1aa2d109a53ebd94a7a4', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: '4002e9e61f99377cfe5eed571a85ab1538e95e45', appearance: "filled", size: "medium", variant: "neutral", class: "city-ledger-transaction-drawer__btn", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), h("ir-custom-button", { key: '0664e99f4c3d759e4a2d51763871ac6b7c75bf36', form: this.formId, size: "medium", type: "submit", variant: "brand", class: "city-ledger-transaction-drawer__btn", disabled: this.saveDisabled }, "Save"))));
    }
};
...
const IrClFiscalDocumentTable = class {
    ...
    render() {
        return (h(Host, { key: 'e9887c626ceb897a68a32df687a417238ed7dc42' }, h("section", { key: '8f9d6e4c471045b09492617e72caff8fe9fb91f4', class: "invoice-items" }, h("table", { key: 'a2fbafb8d2ea9595f6a5c6c76c227e169d2dadc0', class: "cl-table" }, h("thead", { key: 'b5bc45ce55c23464494117fd9df14c3e7e3d9ba4' }, h("tr", { key: 'ac6e23807fa175afd65e75f941a89f81436f3ed3' }, h("th", { key: '6449d5cf08af086945f3588e686f172aea24c70d', class: "cl-th" }, "Date"), h("th", { key: '9499aaa3fa6d0d6e466192cbb71e79b00eb7b088', class: "cl-th", style: { width: '100%' } }, "Description"), h("th", { key: '3baba38ed5a879b5569ce9bb5dd03d1a3cf0939e', class: "cl-th cl-th--num" }, "Net Price"), h("th", { key: 'e0d1b6e9eadbaadaeb646fb8b8adb9ff09cfcf57', class: "cl-th" }, "VAT"), h("th", { key: '0d74368c81de741ea371304614fe12f44b465c9a', class: "cl-th cl-th--num" }, "VAT Amount"), h("th", { key: '32de5e06d33ae9353bc304edffc19dec9d4036ad', class: "cl-th" }, "City ", h("br", { key: '8cdf9a96665ff495f963e5a65b767c1ff41e607f' }), "Tax"), h("th", { key: 'e1a3ce30efada0ca2cf2bcc481dc106565d1fafe', class: "cl-th cl-th--num" }, "City Tax", h("br", { key: '31e7065ea9f5ec72726f185194bd7c9055869ed0' }), " Amount"), h("th", { key: '39ef123e3d8e0ce6bfd1f66258a9f81f12f6deb7', class: "cl-th cl-th--num" }, "Total"))), h("tbody", { key: '153ad61e97f453a5a43197711b1a7fdcc46270e3' }, this.transactions.length === 0 ? (h("tr", null, h("td", { class: "cl-td cl-td--empty", colSpan: 8 }, "No transactions found for this document."))) : (h(Fragment, null, groupData(this.transactions).map(item => this.renderTopLevelItem(item)), this.renderTotals())))))));
    }
};
...
const IrClInvoiceCityTaxAmountCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: '9cc9c4027387ce1f428d96d152544165b267d890' }, this.cityTaxPercent > 0 ? formatAmount(this.currencySymbol, this.amount) : '');
    }
};
...
const IrClInvoiceCityTaxPctCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: 'a1fdafa29c8978f4648a997ade881da8f3dd144b' }, this.cityTaxPercent > 0 ? `${this.cityTaxPercent}%` : '');
    }
};
...
const IrClInvoiceDateCell = class {
    ...
    date;
    render() {
        return h(Host, { key: 'ed03e7035518ec1ef7fc317577b58c2e0cedbd61' }, hooks(this.date, 'YYYY-MM-DD').format('MMM DD, YYYY'));
    }
};
...
const IrClInvoiceNetPriceCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'c3ff6c61a3d17b9e5301570c34905416dc50dfb0' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatAmountCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: '52e7a1d29b585038ffc4f3c5d662246efaea7ed6' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClPaymentFields = class {
    ...
    render() {
        return (h(Fragment, { key: '1278fa7d7ec57038e48116825fc537cebdaed85e' }, h("div", { key: '438adaadad23f34c8e1a4d580432c0b71c2c8a74', class: "payment-section" }, h("div", { key: 'dd573045c4a033b9651ef25140a7303d1671daef', class: "field" }, h("ir-validator", { key: '5b358ccc84d84ceae214d087c92234ceb0e1fc49', schema: paymentMethodCodeFieldSchema, value: this.paymentMethodCode, valueEvent: "change" }, h("wa-select", { key: 'a0bf764ff52dba9e38708ccc2a23686fee13989c', size: "small", label: "Payment method", placeholder: "Select method\u2026", value: this.paymentMethodCode, "onwa-show": e => this.stopPropagation(e), "onwa-hide": e => this.stopPropagation(e), onchange: e => {
                this.stopPropagation(e);
                this.handlePaymentMethodChange(e.target.value);
            } }, h("wa-option", { key: 'a3043f9d70f4602ff3c54bfa3d3514b8799c1d0f', value: "" }, "Select method\u2026"), this.paymentMethods.map(method => (h("wa-option", { key: method.CODE_NAME, label: method.CODE_VALUE_EN, value: method.CODE_NAME }, getEntryValue({ entry: method, language: this.language }))))))))));
    }
};
...
const IrDateSelect = class {
    ...
    render() {
        return (h(Host, { key: '256e16c9304dac37dde5a495efe79eb209080bd2', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, h("wa-popup", { key: '7c99b08a8e6488e56a975b473097c3943428aaf4', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, h("div", { key: 'a628de0fbd90867f4e1bf0fa3ba0e2bd6c2076db', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, h("div", { key: 'e07bbf43dc859267cb825983967755883e77a501', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, h("slot", { key: '4df431334e39950f62e54d88513e221e9fa5bf31', name: "trigger" }, h("ir-input", { key: 'a7423daf00ababfd75c78330affcfcebd060c292', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && h("slot", { key: 'fa599d6951e31735949adfa211f6826f79477a94', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: 'c9d3284ef6830e7e87fab85c231ea7f1638e98a8', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '5ca59c8e72d1719087622efa2433b764c7aba620', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '6ea9f42a54aa3565c7e63093565b8ff935835db5', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: 'ffc5bbcf2c4ba8076d0dad608091730197729513', name: "hint", slot: "hint" }))))), h("div", { key: 'ebbd70f22411925d738cca6f7837f50d1ac71932', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, h("ir-air-date-picker", { key: '0bcfd90d3d727201ddc5624b0ddd8ffe5016ab79', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("slot", { key: 'e5c727228da99836d6e0572b3ba1a8c5349c39d5' })))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: '504be70840dd342ee30c2af734f8dbcf73ff86c0', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'c26bc575dc416add9844bc28cefb979eae8f5eb0', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'b9ef894b2c811dfc86c2ba660dee8b53f9197ba7', name: "label", slot: "label" }), h("slot", { key: '5af75d90bca6d7f1a17f924ad5baf690194d09c7' }), this.slotState.get('footer') && h("slot", { key: '0f846af91dc56c4bb49873a57a281a177a6d6174', name: "footer", slot: "footer" })));
    }
};
__decorate$2([
    OverflowRelease()
...
const IrHoldTransactionDialog = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8004610b53aba74f6221937f211c4346587e231e' }, h("ir-dialog", { key: 'cc5ef7e3d9446a6c683ff987f0d9de47bbc260ca', label: isHeld ? 'Revert Transaction' : 'Hold Transaction', ref: el => (this.dialogRef = el) }, h("div", { key: '38493712274a5d4f0e8995310a64781387d7f064', class: "hold-dialog__body" }, isHeld ? (h("p", null, "Revert this transaction back to ", h("strong", null, "Unbilled"), " status? It will re-enter the billing queue.")) : (h("p", null, "Place this transaction on ", h("strong", null, "Hold"), "? It will be excluded from invoicing until released."))), h("div", { key: 'e3473def3aaa88eaabcc1549291f7df37b5692ad', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'f999a779ec4157435c695877c8a7a31c30b6bae8', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: '1d8732c1c2229e387d4e5526b6fddd0280dad6c8', size: "medium", loading: this.isLoading, onClickHandler: () => this.handleConfirm(), appearance: "accent", variant: "brand" }, "Confirm")))));
    }
};
...
const IrInputCell = class {
    ...
    render() {
        return (h("div", { key: '720dcbd3af7709439355fc0e76b82d9047cba654', onDblClick: () => {
                if (this.disabled) {
                    return;
                }
                if (!this.active) {
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '8411d0ab2a8395de5200e07f39732231e25cb670' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: '51a25438f94144da42e38b5b420bc94dd0ab848a', class: "loadingScreenContainer" }, h("div", { key: '79614d4f901726f112f332038850b175d2742347', class: "loaderContainer" }, h("ir-spinner", { key: '6d0ea26e3cc2ff33d6837337d9469c0809708e64' })))), this.showModal && (h("ir-otp-modal", { key: 'edd7324f840a2e8534cd498df1c7a28247665a1a', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    message = '';
    render() {
        return (h("div", { key: '65e9c0babd3378aaf867a1ca2f2b48e79af54e89', class: "loader__container", "data-testid": "loading-screen" }, h("wa-spinner", { key: 'f235291b182db9c8104245376103112b6b252d11', style: { fontSize: '2.5rem' } })));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: 'f8e920f1d6fbfdbf949cf23ebce90d5cf009e25b', class: "otp-input-container" }, h("div", { key: 'a2e7b54beda779b3931dc89265353e15ef2e48e6', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: 'a631215dc76a7c024b66582964ff5767c5c7e613', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, h("div", { key: '92b76cd218bac7139bd160e30d235a5603fc2c69', slot: "header-actions", class: "ir-fullscreen-dialog__header-actions" }, h("slot", { key: '3e90860421d95335f28735d415aef02039c4a6e5', name: "header-actions" }), !this.hideDefaultAction && (h(Fragment, { key: '7e5a77916be641337f06c0940e29cebb36e4c79b' }, h("wa-tooltip", { key: '3cfa324eb2fd3d8725d62c13a6ca897fb7bbda48', for: this._id }, "Print PDF"), h("ir-custom-button", { key: '3e697fc384d20ba34d295b0657eb810ac217ba56', id: this._id, size: "medium", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, h("wa-icon", { key: '090aec082ceb29967fbac54411a56f9d943ca961', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() }))))), h("slot", { key: '69d71525d366cd88b20b209c8641158c7adeba29' })));
    }
};
...
const IrSpinner = class {
    ...
    render() {
        return (h(Host, { key: 'd40ee85fc13c725a6340c59011424b486d97efb4' }, h("wa-spinner", { key: '9ecbccdd2dc9b0246726b79edba23c6c9584eac6', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: '24c3116af5ddd3325b5644acb05b72e91a4a5177' }, h("slot", { key: '95af7c325065e060c9bf3ea7579284c1b9931e15' }), !this.isValid && this.showErrorMessage && (h("span", { key: '7cd592bac839945ff5f204842aa65965757d6aa7', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
