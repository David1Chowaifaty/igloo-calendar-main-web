import { r as registerInstance, c as createEvent, h, F as Fragment } from './index-CaNXuIlM.js';
import { B as BookingService, r as resetBookingStore } from './booking.store-CuLSocTU.js';
...
const IglSpiltBookingForm = class {
    ...
    render() {
        return (h("form", { key: '3f3cb7bbd85ab2beadb712ae55fe21fa48f0d4c5', id: "split-booking-form", onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("div", { key: '5819c9990ed178f90f1f71fca5f35437a97fd517', class: "split-header" }, h("div", { key: 'f95395c0fdf20bdfbb1527e81eb1149d2ea20507', class: "split-header__summary" }, h("ir-date-view", { key: '5f76ce94dcaeeacd70838d5cbb475d767b907310', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), h("div", { key: 'df09766d9fc3a31ffae47aebb60623ac460c2b82', class: "split-header__tags" }, h("wa-tag", { key: 'c29ca7fcadbebeae1ceae77378ee1f60c3e030c6', size: "s", variant: "neutral" }, this.room.rateplan.short_name), this.room.rateplan.is_non_refundable && (h("wa-tag", { key: '2124384652d21c586d523b160bb5807d20ed1b70', size: "s", variant: "warning" }, locales.entries.Lcz_NonRefundable)))), h("div", { key: '511ccf0dedd9b366aa42235794eb4842b2196468', class: "split-header__controls" }, h("label", { key: 'e9c87188a170271e28ca20623f31d04a75a1693b', class: "split-header__label", htmlFor: "split-from-date" }, "Split from"), h("ir-date-picker", { key: 'b49abd29d79d318e8ad3f7480b1af3305342bec5', class: "split-header__date", "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true, onDateChanged: evt => {
                this.selectedDates = {
                    ...this.selectedDates,
                    from_date: evt.detail.start,
                };
            } }, h("wa-input", { key: 'd61bff4d68514403339aabfc8afc639b8b474d75', id: "split-from-date", slot: "trigger", size: "s", readonly: true, class: "date-trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null }, h("wa-icon", { key: '50a7a6e3c7d71fd559cac7a7439dee3802631e24', slot: "start", name: "calendar" }))), h("wa-button", { key: 'c191dcdeb73da74e0b870f00c0c14eb91dc82599', class: "split-header__check", size: "s", variant: "brand", loading: isRequestPending('/Check_Availability'), onClick: () => this.checkBookingAvailability() }, h("wa-icon", { key: '0ed1e78dfff76acdb81954d3bf27a33120263424', slot: "start", name: "magnifying-glass" }), "Check"))), this.errors?.roomtype_id && h("p", { key: '1d042f309aea13265bb7c20ad088cc02d5ba1ea0', class: "error-message" }, "Please select a room"), h("wa-radio-group", { key: '896009e2b701813267f8d56228de9b754247b4ae', class: "room-type-list", name: "unit", onchange: e => {
