import { r as registerInstance, c as createEvent, h, F as Fragment } from './index-DF2__fQU.js';
import { B as BookingService, r as resetBookingStore } from './booking.store-BDapCccM.js';
...
import { b as checkMealPlan } from './utils-Wjp6LFRm.js';
...
const IglSpiltBookingForm = class {
    ...
    render() {
        return (h("form", { key: 'c342e4ed38083de2fb72fb0c21aa2180f33ce05a', id: "split-booking-form", onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("div", { key: '0fc5b739ee10a90ecf71062715353198f5605841', class: "split-header" }, h("div", { key: '11f8987f7738777f4691b1494370aa42c3ab991e', class: "split-header__summary" }, h("ir-date-view", { key: '5faaad845e43c410ab3309b2b8bdf3e8b67ba143', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), h("div", { key: '024c689691473906685df09e8cc2598691c7cd5f', class: "split-header__tags" }, h("wa-tag", { key: 'aa969a1777d8413fd1479a8d50baebe38e408756', size: "s", variant: "neutral" }, this.room.rateplan.short_name), this.room.rateplan.is_non_refundable && (h("wa-tag", { key: '178c18685ba199ffe8765a316d3b5ef714044b8e', size: "s", variant: "warning" }, locales.entries.Lcz_NonRefundable)))), h("div", { key: '2e84d4441c4570ba718d8c8e005c12340282b89f', class: "split-header__controls" }, h("label", { key: 'd226568e38a755e8e017e992c4a36660d8befb94', class: "split-header__label", htmlFor: "split-from-date" }, "Split from"), h("ir-date-picker", { key: '62b01e98488e50797d5a9765c233013d69a4810f', class: "split-header__date", "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true, onDateChanged: evt => {
                this.selectedDates = {
                    ...this.selectedDates,
                    from_date: evt.detail.start,
                };
            } }, h("wa-input", { key: '88c8b6381ac11d35764a318fb5e4ca1bdf37b519', id: "split-from-date", slot: "trigger", size: "s", readonly: true, class: "date-trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null }, h("wa-icon", { key: '67d97a89a77d7e14caa19d64a128fcb8b66f63b6', slot: "start", name: "calendar" }))), h("wa-button", { key: 'ed9ecff940a9676d694ce0f4f1f821325f8c28ab', class: "split-header__check", size: "s", variant: "brand", loading: isRequestPending('/Check_Availability'), onClick: () => this.checkBookingAvailability() }, h("wa-icon", { key: '2e5d53b8c0fd28a3ce656bf7a00a0ea4915d2fea', slot: "start", name: "magnifying-glass" }), "Check"))), this.errors?.roomtype_id && h("p", { key: '9b21b5c950a27f1336d9baecb714b123a1abf89a', class: "error-message" }, "Please select a room"), h("wa-radio-group", { key: 'b052c0ae483e55c22c3f5f0dcc07838bb229cd56', class: "room-type-list", name: "unit", onchange: e => {
