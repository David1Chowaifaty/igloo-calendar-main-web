import { r as registerInstance, c as createEvent, h, F as Fragment } from './index-DrVkW3Kc.js';
import { B as BookingService, r as resetBookingStore } from './booking.store-CM0HHElq.js';
...
import { f as checkMealPlan } from './utils-CJFvKroT.js';
...
const IglSpiltBookingForm = class {
    ...
    render() {
        return (h("form", { key: 'c342e4ed38083de2fb72fb0c21aa2180f33ce05a', id: "split-booking-form", onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("div", { key: '0fc5b739ee10a90ecf71062715353198f5605841', class: "split-header" }, h("div", { key: '11f8987f7738777f4691b1494370aa42c3ab991e', class: "split-header__summary" }, h("ir-date-view", { key: '5faaad845e43c410ab3309b2b8bdf3e8b67ba143', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), h("div", { key: '024c689691473906685df09e8cc2598691c7cd5f', class: "split-header__tags" }, h("wa-tag", { key: 'b301ec96cc8d245ff7e0153567481c3acabea44b', size: "small", variant: "neutral" }, this.room.rateplan.short_name), this.room.rateplan.is_non_refundable && (h("wa-tag", { key: '004eb86f73733fec32c8fb253cfaa4c7e839344b', size: "small", variant: "warning" }, locales.entries.Lcz_NonRefundable)))), h("div", { key: '6eff4d80b1aa1baaae748ba96274230fdec005ac', class: "split-header__controls" }, h("label", { key: 'd07593a82d1082cd82252db92dbfbad4fde2f077', class: "split-header__label", htmlFor: "split-from-date" }, "Split from"), h("ir-date-picker", { key: '54564d7b4fb3b944f973fce3b1d0840d248ba192', class: "split-header__date", "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true, onDateChanged: evt => {
                this.selectedDates = {
                    ...this.selectedDates,
                    from_date: evt.detail.start,
                };
            } }, h("wa-input", { key: 'ec0b8a3b0d21c9c0afc480a31b8d6bd802a73cb4', id: "split-from-date", slot: "trigger", size: "small", readonly: true, class: "date-trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null }, h("wa-icon", { key: 'f1c4d18371cdcdc4e0cf59b6b175ff9deac0ed0a', slot: "start", name: "calendar" }))), h("wa-button", { key: 'c0ebe8c998c6ab30eccae4311958f88ce7f1c876', class: "split-header__check", size: "small", variant: "brand", loading: isRequestPending('/Check_Availability'), onClick: () => this.checkBookingAvailability() }, h("wa-icon", { key: '1c409f8028c6b8c6de92326c029ee371248cbf41', slot: "start", name: "magnifying-glass" }), "Check"))), this.errors?.roomtype_id && h("p", { key: '508c91d97e170e32f4202012f033cfa510ad2fef', class: "error-message" }, "Please select a room"), h("wa-radio-group", { key: 'e35a3f854ba339e176adc6c14c043f84ebc666eb', class: "room-type-list", name: "unit", onchange: e => {
