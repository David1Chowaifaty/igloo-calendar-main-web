...
const IglSpiltBookingForm = class {
    ...
    render() {
        return (h("form", { key: '3aa4c1cd7ffdd4be3edb16e0c7487ed9bfe24db8', id: "split-booking-form", onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("div", { key: '2c12aa4bcaf65dfa0f8f3f0cb30f8251f255edec', class: "split-header" }, h("div", { key: '1d4f44de14e4fd635cc5e0aa951cfca56849535c', class: "split-header__summary" }, h("ir-date-view", { key: '16f43a1d4d25518f37e541d5b4124af9685870d7', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), h("div", { key: '7c3a109586ca9a4965a24b7cc523696921caebe9', class: "split-header__tags" }, h("wa-tag", { key: '5dc91ac6e3b4e9e6f035e939340d689edad69250', size: "small", variant: "neutral" }, this.room.rateplan.short_name), this.room.rateplan.is_non_refundable && (h("wa-tag", { key: '527bb7d343168a97b67200c7d2c1adce5d31be85', size: "small", variant: "warning" }, locales.entries.Lcz_NonRefundable)))), h("div", { key: '61dfb090a6e342ee031070c6bc4ae7aa77dcd739', class: "split-header__controls" }, h("label", { key: 'b4636ca007702954600f4813a422bad8ca47e089', class: "split-header__label", htmlFor: "split-from-date" }, "Split from"), h("ir-date-picker", { key: 'cd70f2cdebd5c1b8118a2b74257f65918cc8c1a1', class: "split-header__date", "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true, onDateChanged: evt => {
                this.selectedDates = {
                    ...this.selectedDates,
                    from_date: evt.detail.start,
                };
            } }, h("wa-input", { key: 'f7226ff7a852260601efeaaee8212339a21f8540', id: "split-from-date", slot: "trigger", size: "small", readonly: true, class: "date-trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null }, h("wa-icon", { key: 'a67cfaf6e24bd15ca80064db31e00cf8a90300b6', slot: "start", name: "calendar" }))), h("wa-button", { key: '2b0a2c6db6428410f56d64ed2d8e1564da933543', class: "split-header__check", size: "small", variant: "brand", loading: isRequestPending('/Check_Availability'), onClick: () => this.checkBookingAvailability() }, h("wa-icon", { key: '355e4de699e2a3ba8faf531d9d647911fa89dd87', slot: "start", name: "magnifying-glass" }), "Check"))), this.errors?.roomtype_id && h("p", { key: 'b087e0a9acd085e4f040d1051c90bdb4d920054d', class: "error-message" }, "Please select a room"), h("wa-radio-group", { key: '77e70f7ea4cb9123dbc94ed12133df56d4543d78', class: "room-type-list", name: "unit", onchange: e => {
