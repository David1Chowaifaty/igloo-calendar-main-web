...
const IglSpiltBookingForm = class {
    ...
    render() {
        return (h("form", { key: 'fa51ad5e4fe16327753b318a6b6539e94401b999', id: "split-booking-form", onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("div", { key: '746b91b806bce99d1deab31c3a916dbdbcbb4713', class: "split-header" }, h("div", { key: '43024333154256d1ae1d951d8e890e79bc7f3f2f', class: "split-header__summary" }, h("ir-date-view", { key: '3a971571f999877457d207979f945ad65952ca07', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), h("div", { key: '3ac5e6fbd6eafacd91acc77800c20469d8a7f974', class: "split-header__tags" }, h("wa-tag", { key: 'aba4c561c072d128c6422a8aeca7dcee68c9bdee', size: "small", variant: "neutral" }, this.room.rateplan.short_name), this.room.rateplan.is_non_refundable && (h("wa-tag", { key: '492f3ac9cc0797b7b059059975e9ad3189a9c99a', size: "small", variant: "warning" }, locales.entries.Lcz_NonRefundable)))), h("div", { key: '8977e6d7b34f5f582a74d2d64f38e828bf5c78b8', class: "split-header__controls" }, h("label", { key: 'a437ea071d2dd831b75be5cc1e78698a6335cd23', class: "split-header__label", htmlFor: "split-from-date" }, "Split from"), h("ir-date-picker", { key: '1eda6bb0b325af6f0caf03da8814fb4b165192f9', class: "split-header__date", "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true, onDateChanged: evt => {
                this.selectedDates = {
                    ...this.selectedDates,
                    from_date: evt.detail.start,
                };
            } }, h("wa-input", { key: '7316bf4a2461bc89c7e54c5b960f6aacfc744ffa', id: "split-from-date", slot: "trigger", size: "small", readonly: true, class: "date-trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null }, h("wa-icon", { key: '3697ea4ca47a10b7568a648a2130f86ea5265ec3', slot: "start", name: "calendar" }))), h("wa-button", { key: 'a00db4f3ec633495918d9d000eef911f6bb0bc84', class: "split-header__check", size: "small", variant: "brand", loading: isRequestPending('/Check_Availability'), onClick: () => this.checkBookingAvailability() }, h("wa-icon", { key: '077dc01163ba8752a84943e7cbae9d43e779efc1', slot: "start", name: "magnifying-glass" }), "Check"))), this.errors?.roomtype_id && h("p", { key: '7995c23776a041d0951826f4026b88e17aa82ed1', class: "error-message" }, "Please select a room"), h("wa-radio-group", { key: '7acc7dab47db78c80105a84e77ade067fbad05a7', class: "room-type-list", name: "unit", onchange: e => {
