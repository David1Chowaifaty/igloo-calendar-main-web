...
import { a as arrivalsStore } from './arrivals.store-4ad2843a.js';
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e65463a5615383974a0f40e27e34b373b5c0a307' }, h("div", { key: 'dd2d1c511eb6a4c5654c8123746904c1f03f8dfe', class: "table--container" }, h("table", { key: 'b6e4ed13a2fbfa92740dbdacd966dcb82cd959a1', class: "table data-table" }, h("thead", { key: 'fd28416618d2f30a207f42e593603e80e91a3f30' }, h("tr", { key: '732378add3825f855634160874920a46c5a35dca' }, h("th", { key: '6a851621ba94252132386d81bba21c9ad76186ed' }, h("span", { key: '97e5a6debedf1de2eac262b670715194e1d8b59e', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: '1f6001e3b80f01edcb0b4844d8ea2f4e363b7772' }, h("div", { key: '2cdb448dc6f6084c56a25775e9efb9bcb0a13c2c' }, h("p", { key: 'f5699a3b7c0ef2884eef1344f5e6d540dd2a0efa' }, "Booked by /"), h("p", { key: '1faabdc618bd5abb2a57219f49b3fd038a88ed22' }, "Guest name"))), h("th", { key: 'c32f5c3b752dbe219d72132e0f42dff7073e6691' }, "Unit"), h("th", { key: '9ccf8682c01dca6b4bf4872278f2bf51a8b144a4' }, "Dates"), h("th", { key: '8f5caa4865fd888b1cc99ba261d3e9d611dd1e5b', class: "text-center" }, "Balance", h("div", { key: '525342f501abe34e6a199e121adebf87e8e45440', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: 'ac1b4d5aab1b3696174ad7dd441bce0ff55f28ea', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), h("th", { key: 'decf51b4575621250d60681c066b4f75300dce9e' }))), h("tbody", { key: '5f0eed4d34348b844738e37b7fce43e7abef7dc5' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (h("tr", { key: 'b1c961db256929230a0a85ece031c0c545e92d78' }, h("td", { key: '1f1c06adc30cb149ddac9ffc4866ed1aec5f2afa', colSpan: 6, class: "empty-row" }, h("ir-empty-state", { key: '26c8173945b7b3150f6b0f08fb5b97b8073aab49' }))))))), h("ir-pagination", { key: '5a1dc2b0dad2bd98b0bd7c99e05d51d009dbdbbb', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
