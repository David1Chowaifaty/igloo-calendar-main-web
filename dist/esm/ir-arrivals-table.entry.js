...
import { a as arrivalsStore } from './arrivals.store-53892e81.js';
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: '92e8a88409c33a9756c1a5a5b649cc8c3ecaec57' }, h("div", { key: 'a1b75394467dd4ecc9938add7701f44fe645d300', class: "table--container" }, h("table", { key: '1d71ec076d23409de0b4cc18644703b7705314db', class: "table data-table" }, h("thead", { key: '49fda30daa4b468d4e5d0400d7d6f9c710e8063b' }, h("tr", { key: '70630c400739ec6a8354213db8a2ddbab7dd4f03' }, h("th", { key: 'c1c2c8a033bbe4132bbd71f40e7d5135a16deff2' }, h("span", { key: '23e628b168a25ba740926e99a91af2baecadaf51', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: 'da8c57194408ef326b2ab7f109650dc28a1b698d' }, h("div", { key: '31dcda443b1775b617ceaed868a0cccb662595ff' }, h("p", { key: '7df18bfc36fa70ad710623d9a5ac3b2a9693303d' }, "Booked by /"), h("p", { key: '8c88ae030774a9ab5ea25961f09f3ee4fb1267f5' }, "Guest name"))), h("th", { key: '23b20f05c0e3cf2889c624856ee1bec5db6cd549' }, "Unit"), h("th", { key: '06217beb22b80bc001b3e78183edf07059c4e479' }, "Dates"), h("th", { key: '33491c2a0504ce0dc4d773bfadcd92b040e23488', class: "text-center" }, "Balance", h("div", { key: 'c547d51435f83418c65aeb09d4210d808b7cdf00', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: '8fea7f0af51f881ce1e188392496754b615dbba5', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), h("th", { key: 'b9028418f34e8e3ef78e5c957a1d7e8c890e240d' }))), h("tbody", { key: 'ac271374db8b7a6e7d934bc175ecc96463e423c4' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (h("tr", { key: 'b9e700672ae02d45f40df54573f75dd2de8d07c1' }, h("td", { key: '43106e1bad368429d58ca65928cef48ccd11303f', colSpan: 6, class: "empty-row" }, h("ir-empty-state", { key: 'fa268e1e34e455090c7f1bdabab20e86438b8748' }))))))), h("ir-pagination", { key: '42feaad0be34e1b55cb1eafc4b23f0ecacafa679', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
