...
import { a as arrivalsStore } from './arrivals.store-Dm348FaP.js';
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e508ff0f4fd3e69832d9b0f03fa30b146467f0d3' }, h("div", { key: 'b85d4b71bcdfcfddde51d2454d21be354381394e', class: "table--container" }, h("table", { key: 'd2b41811902d41209fe6f1eff61b6ae5fb4ac4c1', class: "table data-table" }, h("thead", { key: '6269cc4e46d231ee21eda0e347309887da23a87a' }, h("tr", { key: 'bd2c25dcec55102c953a38851e7a7800be0b8b0f' }, h("th", { key: 'c49603c5c15f9856db1256ad0e0fecc332147fe3' }, h("span", { key: 'b5d64635a7b4dbe504bfb51c2cbe1f88e073c1ca', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: 'd119864dff61ef1bcb35264f01b138e19ddb2576' }, h("div", { key: 'a097d8eaeef73d10b5b242bfef1104564856058f' }, h("p", { key: 'a8dacfbf3e0293794d24016198bae61d8635d6d6' }, "Booked by /"), h("p", { key: 'c4e016246290f1108354b53dc216a6bcacf3029e' }, "Guest name"))), h("th", { key: '0571dabff84f4adff8f610b12b771a04da5958ca' }, "Unit"), h("th", { key: 'cdcde6029e8879df14ec667ed59185c3d0dc8eae' }, "Dates"), h("th", { key: '387e4f0cffa158b6dda4fd0308d249bcd97c78a7', class: "text-center" }, "Balance", h("div", { key: 'ca3b851160ea2df9510e26848470d1af9dd53302', style: { width: 'fit-content', marginInline: 'auto' } }, h("ir-custom-button", { key: '258014bf235be5a4dc9fed95d9f1d0aa9a0d38bc', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "s", variant: "danger", appearance: "outlined" }, "Click to collect"))), h("th", { key: '060375eab4d1b2e0f6b60f75aae82abc2ae94e9e' }))), h("tbody", { key: 'cc726ce00414e2944bb29d43f3af200d088437a9' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (h("tr", { key: '906485b2fa11bda79a21c22c7e972f8130581111' }, h("td", { key: '135421327667177719dcedb109eaa41d5fe0644c', colSpan: 6, class: "empty-row" }, h("ir-empty-state", { key: '5be3eaf71bfdbc14ea9694d378b264a4096778c9' }))))))), h("ir-pagination", { key: 'd870661b115747850a0615e65c01f5a713854914', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: t('Lcz_Bookings', { fallback: 'Bookings' }), onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
