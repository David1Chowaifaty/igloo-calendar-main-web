...
import { a as arrivalsStore } from './arrivals.store-521d300a.js';
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: '641d452829dcc040021942224ceeeda949b58ca7' }, h("div", { key: '8137aa7c4316b8c52837c267a3e410cc0d15a894', class: "table--container" }, h("table", { key: 'fde39e6cf37268a4d7a570f83c4aae96c6097a97', class: "table data-table" }, h("thead", { key: '2653806a34078162159cf51204bd3c5ccc207f48' }, h("tr", { key: '4faad175f750fa84b792c8d7bda0b6e9bdcd934b' }, h("th", { key: 'a96484c0865eca1cffa589c1e04aed05f572a7a2' }, h("span", { key: '4ec8a39bdecfb8bd94cdac650ecf0c9a93749086', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: '3ebbd823a8f791490353916912d08e8322764a91' }, h("div", { key: '67a4acd80e521db6b98dd9f35dc1d01e84969859' }, h("p", { key: '7ed221f05365b50cf3ae57308b960f4a15550a13' }, "Booked by /"), h("p", { key: '67a07df461f8a78a1eb2a9df02e6e515968bfc84' }, "Guest name"))), h("th", { key: 'ab09198ee468450b1b134eb9881d0b9007c77e6c' }, "Unit"), h("th", { key: '95438f20809f06bc69acf7f1599d146cb6596ced' }, "Dates"), h("th", { key: '74eb8a0103b63098c036c7bf9dd08f66e7148f77', class: "text-center" }, "Balance", h("div", { key: '9bdd4e75d5f7827849859aea67af9017710bd62c', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: 'c83e7d4a48e3efc48ed901a3b3545a678a72a127', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), h("th", { key: 'c1d52f7274cb74f0d5324a415bb7154fb36cd978' }))), h("tbody", { key: 'f820ceb1ce516de925df6bc8bbea09f3be16297d' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (h("tr", { key: '12f81cb5b7ac4853820e5267ff4a52af19919796' }, h("td", { key: 'b283bf5c460c3043098c72d5658df252d088d037', colSpan: 6, class: "empty-row" }, h("ir-empty-state", { key: 'f4b8d4b460a374b38a383045e3492ad22dbe3122' }))))))), h("ir-pagination", { key: 'e91aef21f4c53b735fd6900ddc4691683a125087', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
