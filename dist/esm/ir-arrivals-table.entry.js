...
import { a as arrivalsStore } from './arrivals.store-aa8289c2.js';
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0ddd6ad56141afb0e28c9332721f1640f57b8e32' }, h("div", { key: 'f1e849a4faef632f1b7589ce7161599f8c147f86', class: "table--container" }, h("table", { key: 'b3726a852006c856f430aafed0725b7f0ae1cceb', class: "table data-table" }, h("thead", { key: 'ea5b9e4832c2bf1bc0cddb235cc5dc8165294a1f' }, h("tr", { key: 'f91e0a4850ab9a7d96126b8bdcea20db990d67f1' }, h("th", { key: 'beca77424c261b1bbe1b7cb72c7648c36bc48a2b' }, h("span", { key: '8eea915913d3e8f484f6e0dd353fbced00c30ec7', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: 'd2b2ea3626f7766fd7654c9427ea3acbcaa2400a' }, h("div", { key: '533cec2d802674e3faf96336f03077e6612059e7' }, h("p", { key: 'cdcf669647ccc81682aa9b9418ff1bc89d7b2fc1' }, "Booked by /"), h("p", { key: '7c8544519dd174195e287776bf411a3de5f559cf' }, "Guest name"))), h("th", { key: '6f4f2e96f1daec4c54a7c721c04082dc21607b43' }, "Unit"), h("th", { key: '93dd238b058665cb95c06c9b6af5d584bd46ab38' }, "Dates"), h("th", { key: '4b58dd0548e0700abf59d2fbfccf428e8a991264', class: "text-center" }, "Balance", h("div", { key: 'fbf1454fa2e15d437f3472a6eebbfd0bb4102ef1', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: 'e37a49491b6585718a7941eb81b1eaa5a738446b', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), h("th", { key: 'd244e4ad242e22170d69f33b82330eb45c49d43c' }))), h("tbody", { key: '4598c76db363d4193b181807184d6a7d32833146' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (h("tr", { key: '60089008929771ee68ff1dc5e7ed0c9d55fcaffc' }, h("td", { key: '1411d364930755140f1be047ff2e42691472a0f8', colSpan: 6, class: "empty-row" }, h("ir-empty-state", { key: '84ca11131f7f50b910f2911ead9b28173d2dac6c' }))))))), h("ir-pagination", { key: 'a7f690f269bed74805ebcfe9f9c3e27b919e92a3', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
