...
import { a as arrivalsStore } from './arrivals.store-fc26b424.js';
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8ab560645e489b13091f3aa6537e54471247561a' }, h("div", { key: 'b73377792c14bcf1bbed0210b5734866780da1bc', class: "table--container" }, h("table", { key: '1dce195ece8a4c243cae91c87b1d9cc8aa66ae3b', class: "table data-table" }, h("thead", { key: 'dabc2d250944ddc45914355dabcb7c3eac85bb7e' }, h("tr", { key: '791a76b868fdb9d74a068a0ed408d6829c3096d4' }, h("th", { key: 'b64ba8be16653d69e2b093071b568872c3438803' }, h("span", { key: 'cebefa3e38e679b8f542ec1a2be259a92066d9ab', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: 'd2a1997e92eb2828b8b13f71fed6429a255b3889' }, h("div", { key: '950a000fc67117e4578c83e740ff2595711ecba6' }, h("p", { key: '928f11c8a44cb53e800382b8eaa3902203965479' }, "Booked by /"), h("p", { key: 'f8ff38cd43c9bb5cd4787314457c5072529e09af' }, "Guest name"))), h("th", { key: 'c07584eaa224352c3230e1e08e192c8b2507988a' }, "Unit"), h("th", { key: 'b8aa52768792dab2a349f1f3964cb6f4ffacf98e' }, "Dates"), h("th", { key: 'bde754315193a0d157720c648b48cce54fdff677', class: "text-center" }, "Balance", h("div", { key: 'c2d1153d312ee3d77466acd11ee49e9d81c09e34', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: '0887d115c7c7dff4661c9b3c39e61c0461ab798d', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), h("th", { key: '73d2de95a4bcfbaf717a764af8016011a465de37' }))), h("tbody", { key: '560fb711efc8a53cf7530fe9613ca3ce3c5d09f3' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (h("tr", { key: '421c5b7b321b9b724273fc831da154bd3df708df' }, h("td", { key: '9b68513570a9118968d38eb98664141295b36a5a', colSpan: 6, class: "empty-row" }, h("ir-empty-state", { key: 'c36951a640bdd44858f49fa1c73db746771674d2' }))))))), h("ir-pagination", { key: '9cabde3e154674ba5ce45919c53ffcf820b254b8', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
