...
import { a as arrivalsStore } from './arrivals.store-884b207d.js';
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: '01d8af461e2af4d6c55d83c23f0347869b8be11f' }, h("div", { key: '1efe8e35d470beaadc3f0fa9a6be912cd84bf1eb', class: "table--container" }, h("table", { key: '8bed71027a3991daca5bc0a04f68eef099ed5d18', class: "table data-table" }, h("thead", { key: 'fcf5c10400cf1b1f575f0a7a55171dcc8e8fb82d' }, h("tr", { key: '08ef78714f0ce8ef705ed2cc697ef2ead8ddc426' }, h("th", { key: '1b93066637843c098aaece9ab0fcaec0bee677ad' }, h("span", { key: '4278dc73ad37ebb0e9e75bb9508db5466a45c447', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: '934016996d3a7d8eb29cf40d98af0cd92aa8e0e7' }, h("div", { key: '78cd25d147a10769f569ce977f01eb07f43261d9' }, h("p", { key: 'c4459bd66b1808f1e76254286e6cf56aa5954ae2' }, "Booked by /"), h("p", { key: '9ce054b3e869286ea1587cd9e615308cb337b87b' }, "Guest name"))), h("th", { key: 'f330c31fdd3316888bcc43dc6eeeffe8e1098095' }, "Unit"), h("th", { key: '65bf13a47db8c1d16825ab03facc60bb8433bb3e' }, "Dates"), h("th", { key: '693d975f56461df04b8f36a65040f59e5aebfbfa', class: "text-center" }, "Balance", h("div", { key: '521aef74cf2c1575ebbc9124c0b67a1a27902d66', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: 'c8b786f635be0fae6d04a5d0360aa4c6c70b6252', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), h("th", { key: '88aa03bec4d0aa24e3e5f961d43fffac6be37985' }))), h("tbody", { key: '91ae9f26ad39c928cc836c611e541306a2ec5fdb' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (h("tr", { key: '3d3e71fc17cbed8a24fb8d7d560cdebb12eb9d76' }, h("td", { key: 'f95c81aba679fc4de47d37fbdcd1d319bbbe0c96', colSpan: 6, class: "empty-row" }, h("ir-empty-state", { key: '8945fb4e62fc8290b38f1be7750ba71156b79f98' }))))))), h("ir-pagination", { key: 'fd1ebe89f43a1b142515136b76e0f128f5438b30', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
