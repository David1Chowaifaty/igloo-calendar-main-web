...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (h(Host, { key: '825a8b103eb53955cdb6cd5de724a77aa658bcfa' }, h("wa-radio-group", { key: '29f48b85302678c829ea34c0ac9e7dc1b3d40cd8', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "s" }, h("wa-radio", { key: 'a2ced91e2840c98dd31d96291e9311a4fa751064', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (h("wa-radio", { key: '0723187fb65346f3703b12341b0fdc73a741883f', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), h("ir-booking-company-dialog", { key: '00e5e3dba724fedc71b2581135286ed983eeb41f', onCompanyFormClosed: () => {
...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: '95bd3764e08092ba8b2ff8f9649020a8a63d38f9', open: this.open, onIrDialogHide: e => {
                ...
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), h("div", { key: '6c2caa04f5a451af4938b592627c5130d4cfdb3a', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '684f872747335a0e5ecb37b88bb19e8d6317f3b1', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: '218735e896ea2399a4828fd7b4fff42d1bc9a5d9', type: "submit", form: formId, loading: isRequestPending('/DoReservation'), size: "m", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (h("form", { key: '9e095167bbdc29d503c8e165f35b2779232bd063', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, h("ir-input", { key: '53c260cae19509e2ab8b7d53d44d853f575b402b', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), h("ir-input", { key: '04ff79fdafe04c250730805ac56c87c0cf9c9f6c', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (h("section", { key: '0ca3d2a35107102750b337e5969340127455a945', class: "ir-print-room" }, h("header", { key: 'f1037247836af8c2759d27ed436bbff4f20da071', class: "ir-print-room__header" }, h("p", { key: 'cb9ac568fa3f4f74bc1342bb538604249cd85c62', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && h("p", { key: '1d4fb61420898539dcf1d53070bc0cb56d590a97', class: "ir-print-room__unit" }, "(unit ", room.unit.name, ")"), h("p", { key: '8d43bc2e87564cadf2ac5aeb03a9684636d2bd76', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), h("div", { key: '9f8cd9782b2f53b6c0087ed18d015f61dff025b0', class: "ir-print-room__body" }, h("div", { key: '13dbb234eb4b8fb06d2dad83fad8443809ecf469', class: "ir-print-room__details" }, h("div", { key: 'b03fe95d6c4378d2afb7524be67a78db42ead40f', class: "ir-print-room__row" }, h("ir-printing-label", { key: '040bfcb914bf8f787ab7017cc7704c6efaa06f53', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), h("ir-printing-label", { key: 'b38360aae33c4fab9b05f58eab26dbe66d927913', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), h("div", { key: '78bc2b1430337555b9156a2a75fe4c223ec5d815', class: "ir-print-room__row" }, h("div", { key: '345676feca5078e559cca696c223f84756972e2a', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), h("span", { key: 'e5d4923b5338d51fb06318c75f22af0c45b4f805', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && h("p", { key: 'ca36ac69294eb373d9148c4f90d98f29d1e33456', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), h("ir-printing-label", { key: '399e0ead32d9d78eec12d2baaee6553079d5cdf3', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (h("div", { key: '645947f258070cd48f8133e4b200bd3e767e943c', class: "ir-print-room__policies" }, h("ir-printing-label", { key: '39658b04756576158bcb63dba8569376de057f1e', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), h("ir-printing-label", { key: 'd84a7ecb50044e39ba8b7c702c6ffb4dd2e3694d', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), h("aside", { key: 'ee7c2a4d402d70b93d0b6346a4a5aae5d05ac824', class: "ir-print-room__totals" }, h("ir-printing-label", { key: '5f3dde7f1b4427da1f4cb30a42901643c1b934ba', label: "Total:", content: formatAmount(currency, room?.total) }), this.renderTaxSection(), h("ir-printing-label", { key: '1bef319d441d689b86af59be3b097e54bd80bd6a', label: "Grand total:", content: formatAmount(currency, room?.gross_total) }), booking?.is_direct && h("ir-printing-label", { key: '86579c8dd7e35e25917a16d1ec2f13378fe40423', label: "Due upon booking:", content: formatAmount(currency, Number(room?.gross_guarantee)) }))), h("div", { key: '75cd845b6d5066d4828eae79764e5eb61fca6c9a', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (h("section", { key: '0d1e3b686dd3873c55f604f91344bc674cd94502', class: "ir-print-extra-services" }, h("h3", { key: 'b05f712681c39c8126a9bbf24c1cff2fc0ae63bb', class: "ir-print-extra-services__title" }, "Extra services"), h("div", { key: 'd6bffea3787d9bad3c1e8ea3a69d11aea12d5687', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
