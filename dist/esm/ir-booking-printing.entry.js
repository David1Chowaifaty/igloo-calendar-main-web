...
import { c as calculateDaysBetweenDates, a as _formatTime, b as _formatAmount } from './functions-242a246b.js';
...
const IrBookingPrinting = class {
    ...
    renderBookingDetails() {
        return (h(Fragment, null, h("p", { class: "booking-number" }, "Booking#", this.convertedBooking.booking_nbr), h("div", { class: 'reservation-details' }, h("p", { class: "booked_on_date" }, hooks(this.convertedBooking.booked_on.date, 'YYYY-MM-DD').format('DD-MMM-YYYY'), ' ', _formatTime(this.convertedBooking.booked_on.hour.toString(), this.convertedBooking.booked_on.minute.toString()), " |"), h("img", { src: this.convertedBooking.origin.Icon, alt: this.convertedBooking.origin.Label, class: "origin-icon" }))));
    }
