...
const IrDateSelect = class {
    ...
    render() {
        return (h(Host, { key: '0acf698d0697fa68fef41bf585e34a8d5bdeefab', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, h("wa-popup", { key: 'd56d6f5f85e45e1052123cab0b31f599633d14fd', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, h("div", { key: 'e060a5637941af0face6e71d5ea5df2468e27a96', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, h("div", { key: 'c4a13df44a220a513d9bb50d72845caffac4327d', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, h("slot", { key: '83e411e2bf3cff070328a0e905cfb3d54ee46f3f', name: "trigger" }, h("ir-input", { key: '065fc99289e3a773b80e43fbec21f0203425fe0f', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && h("slot", { key: '925bdd12c4b700a04a2104eb6d9570830494f7d3', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '8cf84084b6403f98272f7a5eb1a72d9603547746', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '01a9e26e51f5d44e4d39eaafcfec205173fdc06d', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '6ec1e0ee0a3318c57377a48faad362d972fd3f9e', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: 'ffbff23303ff313552b4204d59c99804dc2a2580', name: "hint", slot: "hint" }))))), h("div", { key: '53bb66f402bc7e531fa21f7e303fc417384be7b7', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, h("ir-air-date-picker", { key: 'e71965158a4ca00d113839f26842f6357842f03e', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("slot", { key: 'a3fdbbd7cbc229eeb5621b03b598f131d03fd738' })))));
    }
    static get watchers() { return {
        "aria-invalid": ["handleAriaInvalidChange"]
    }; }
