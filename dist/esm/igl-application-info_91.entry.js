...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory, Z as ZIEntrySchema } from './booking.service-cd705f45.js';
import { l as locales } from './locales.store-f4150353.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-8a36a1b2.js';
import { f as formatAmount, e as extras, h as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, b as buildSplitIndex, a as getPrivateNote, t as toFloat, i as canCheckout, r as renderTime, j as formatName } from './utils-1825b25c.js';
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (h("wa-badge", { key: '677d743082018bda82b5f7e1762f1380271449f0', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1de5744d9dc0bee29f2b1d3c5daf0836a568635d', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '7d1e590ecf1f374a93340055b1457878cd22e6a4', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-custom-input", { key: 'a83375fa669d745fcab5ddfd35878416378d83e5', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'ae2d67586d060e2f48c3b0584acfbf008f617eea', name: "start", slot: "start" }), h("slot", { key: '3d9861d2aba0315a66104f00dea06a4d50095056', name: "end", slot: "end" })), h("div", { key: '67e6fd774865d119ab3595f1476270425ffc279c', class: "picker-surface" }, h("div", { key: '7be84d43e150d2c64848ece2a7b01ea67589cf62', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: 'da3606334b333be37156fa72a6804390017f2b79', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '7f138be0fcc3eb5d853950fcf988bd2479913dd5', class: "d-flex align-items-center" }, h("span", { key: 'e1348d1d9dfdfbb9b87b59199628c98a5531c5af' }, this.dates.from_date), ' ', h("svg", { key: 'ba068785537675450a37fb060df8443f9c3d0acc', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '154e0ac2aba3965f9baed86cf9f9dd3a488ebd9f', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: 'f816d47468ace34dd4b1e8de3e18c6acaf6e7b33' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: 'b588e31184b49b68f8c32b1902fd03e33c5ddb1a', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (h("button", { key: '2ce10db0710f2e5a3307a3e67bc08533210777a8', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '9669ef0486ce3f7ec28e747d8488de7d7b7b5702', name: "icon" })));
    }
};
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: '97ab91e6194c10d3deaabd52e786e2c43a8ae86c', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, h("label", { key: 'f4777767ad6f69b246110bdcc0a2e035cf351793', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, h("div", { key: 'f17e8eb8bb8ec55a10b50ad9ea04d0bb989df66e', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, h("wa-dropdown", { key: '4cf4752091cc73860b1b7cf085b6c3fa16678d37', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, h("button", { key: '68910725596da004a7bd86182157c6dbe8ac2920', slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, h("div", { key: '45d59ba47d9c199596a2a29f893e8432a0abee22', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : h("span", null, "Select")), h("wa-icon", { key: '1ba85588a0833cfe447543c23ac05a47879bf2cb', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), h("span", { key: 'b43bae5543291c3b4ac58ba33b716d2129fc40db', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (h("wa-dropdown-item", { value: country.id.toString() }, h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), h("span", { class: "mobile-input__country-name" }, country.name), h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), h("input", { key: '0c471d5c7ceb05c35eef333cb473d09ea809cf24', ref: el => (this.inputRef = el), id: this.inputId, class: {
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (h("form", { key: 'ae4168bb6622b5673b21d1487e14009c2639557b', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, h("ir-custom-date-picker", { key: 'e920c8a7632a2e8630645fd57f8c2e20adb90ab8', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), h("ir-validator", { key: '8d51ec239f10cbb5759c807d3c8ba4d283b313b0', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, h("wa-select", { key: 'a7b76e8cc49b86d667fe4c71a78b559c622d2075', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, h("wa-option", { key: 'c25694c419afe91202efe823714bd8fea68be0ae', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (h("ir-validator", { key: '665096c5f29f784e90d974f763f72b1ba59f85ae', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, h("wa-select", { key: '371c059298c7350fad77dfa73a709a5b9a91d51d', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, h("wa-option", { key: '0b3454c43c821523bf95f3fa3552426738220260', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), h("ir-validator", { key: '0baa3289bcc9be8ffcdb05db4ea71c545e2ea048', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, h("ir-custom-input", { key: '7deaceddaca9afaa9f1c48d2377133d6a46cb027', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, h("span", { key: 'b23dba7894fe07aeaf12c9abd88e59af6d294ccf', slot: "start" }, calendar_data.currency.symbol))), h("ir-validator", { key: '408936904f2857ca98f377f92253be8350f6fd03', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, h("ir-custom-input", { key: '1ecfbb7bb4196de0dbbe26a7d9be83a578ca848a', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: 'dcfc4a6d56ba9da0748e4adcbe4c1e23b6b9da48' }, h("slot", { key: '40bf6b36c484785fde318440aa7b0aa649f5ace6' })));
    }
    static get watchers() { return {
...
export { IglApplicationInfo as igl_application_info, IglBlockDatesView as igl_block_dates_view, IglBookProperty as igl_book_property, IglBookPropertyFooter as igl_book_property_footer, IglBookPropertyHeader as igl_book_property_header, IglBookingForm as igl_booking_form, IglBookingOverviewPage as igl_booking_overview_page, IglDateRange as igl_date_range, IglPropertyBookedBy as igl_property_booked_by, IglRatePlan as igl_rate_plan, IglRoomType as igl_room_type, IrActionsCell as ir_actions_cell, IrApplicablePolicies as ir_applicable_policies, IrAutocomplete as ir_autocomplete, IrBalanceCell as ir_balance_cell, IrBilling as ir_billing, IrBillingDrawer as ir_billing_drawer, IrBookedByCell as ir_booked_by_cell, IrBookingBillingRecipient as ir_booking_billing_recipient, IrBookingCompanyDialog as ir_booking_company_dialog, IrBookingCompanyForm as ir_booking_company_form, IrBookingDetails as ir_booking_details, IrBookingExtraNote as ir_booking_extra_note, IrBookingGuarantee as ir_booking_guarantee, IrBookingHeader as ir_booking_header, IrBookingNumberCell as ir_booking_number_cell, IrBookingStatusTag as ir_booking_status_tag, IrButton as ir_button, IrCheckoutDialog as ir_checkout_dialog, IrCombobox as ir_combobox, IrCommon as ir_common, IrCountryPicker as ir_country_picker, IrCustomButton as ir_custom_button, IrCustomDatePicker as ir_custom_date_picker, IrCustomInput as ir_custom_input, IrDateRange as ir_date_range, IrDateView as ir_date_view, IrDatesCell as ir_dates_cell, IrDepartures as ir_departures, IrDeparturesFilter as ir_departures_filter, IrDeparturesTable as ir_departures_table, IrDialog as ir_dialog, IrDrawer as ir_drawer, IrEmptyState as ir_empty_state, IrEventsLog as ir_events_log, IrExtraService as ir_extra_service, IrExtraServiceConfig as ir_extra_service_config, IrExtraServiceConfigForm as ir_extra_service_config_form, IrExtraServices as ir_extra_services, IrGuestInfoDrawer as ir_guest_info_drawer, IrGuestInfoForm as ir_guest_info_form, IrGuestNameCell as ir_guest_name_cell, IrIcon as ir_icon, IrIcons as ir_icons, IrInputText as ir_input_text, IrInterceptor as ir_interceptor, IrInvoice as ir_invoice, IrInvoiceForm as ir_invoice_form, IrLabel as ir_label, IrLoadingScreen as ir_loading_screen, IrMobileInput as ir_mobile_input, IrOtp as ir_otp, IrOtpModal as ir_otp_modal, IrPagination as ir_pagination, IrPaymentDetails as ir_payment_details, IrPaymentFolio as ir_payment_folio, IrPaymentFolioForm as ir_payment_folio_form, IrPaymentItem as ir_payment_item, IrPaymentSummary as ir_payment_summary, IrPaymentsFolio as ir_payments_folio, IrPhoneInput as ir_phone_input, IrPicker as ir_picker, IrPickerItem as ir_picker_item, IrPickup as ir_pickup, IrPickupForm as ir_pickup_form, IrPickupView as ir_pickup_view, IrPmsLogs as ir_pms_logs, IrPopover as ir_popover, IrPriceInput as ir_price_input, IrReservationInformation as ir_reservation_information, IrRoom as ir_room, IrRoomGuests as ir_room_guests, IrRoomGuestsForm as ir_room_guests_form, IrSelect as ir_select, IrSpinner as ir_spinner, IrToast as ir_toast, IrTooltip as ir_tooltip, IrUnitCell as ir_unit_cell, IrUnitTag as ir_unit_tag, IrValidator as ir_validator, OtaLabel as ota_label };

//# sourceMappingURL=igl-application-info_91.entry.js.map