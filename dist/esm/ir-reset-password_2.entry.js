import { r as registerInstance, c as createEvent, d as getElement, h, F as Fragment } from './index-Nexq2OjX.js';
...
const IrResetPassword = class {
    ...
    render() {
        ...
        // }
        return (h("div", { key: '466ab21f00e047ed6e0b1978451b80a6972f9650', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, h(Fragment, { key: 'ebed15c22ddbb98592b1a8190021431e9cf24163' }, !insideSidebar && (h(Fragment, { key: 'c19476f4195693e0f0088e6b847e75b1dda50b73' }, h("ir-interceptor", { key: '596c5362ed42c89394c26610eb3678442fd67da2', suppressToastEndpoints: ['/Change_User_Pwd'] }), h("ir-toast", { key: '2d76ffa23593e375aa51b5dcae802bbf69eb1b66' }))), h("form", { key: '06e6fe682131ebd118528d330d98303a9189323b', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && h("ir-title", { key: '8a9f99f61c22179285dd1800a8e737e5b463d962', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), h("div", { key: '957ae4d76c65348a0c032e83beb8a6e8f7bcfd70', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, h("svg", { key: '29c3ed2a597adc0ce56916c02ace30c13dc8a004', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, h("path", { key: '86bd4af2a2a4f7fff8676a7b332a0e1c3cd6e860', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), h("div", { key: '0c78f101279139c8f8d9f71179f4f26235d20c06', class: "text-center mb-2" }, h("h4", { key: '5ef2257b4b3b8d436a3d77f7662d736646aa9555', class: "mb-1" }, locales?.entries?.Lcz_SetNewPassword), this.submitted ? (h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (h("section", { key: 'fad546b351608890bf5a647f19c8a739cccccc64' }, h("div", { key: 'f18548d3cb27a1fdcefcc568104446af0022a66b', class: 'mb-2 d-flex flex-column', style: { gap: '1rem' } }, h("div", { key: '24f593e3282bfc60c60a0d476e729ad1d30af8a8', class: "m-0 p-0" }, h("div", { key: '26a6131c74579c0c62e2645536e0e953bcdec1d0', class: 'position-relative' }, h("ir-validator", { key: '899a0d0574032218af33fd873b657e2b9d42f8e5', schema: this.ResetPasswordSchema.shape.password, value: this.password }, h("ir-input", { key: 'dfdfdae5c38d8d31dd5d35a7eb62257f34d6ffa6', type: "password", passwordToggle: true, "onText-change": e => (this.password = e.detail), onInputFocus: () => (this.showValidator = true), placeholder: locales.entries?.Lcz_NewPassword, value: this.password }))), this.showValidator && h("ir-password-validator", { key: '7e1899cae37830750599a966647b89a17f8111a2', class: "mb-1", password: this.password })), h("div", { key: 'bcb96e440e2e5a2ea71baf3161c0ee4e41f490f8', class: 'position-relative' }, h("ir-validator", { key: 'b3230e2a5283e3438a242defd1d4c4cc34084acc', schema: this.ResetPasswordSchema.shape.confirm_password, value: this.confirmPassword }, h("ir-input", { key: 'dd524b29033e681ffe2b75203903f797959cfbbe', type: "password", passwordToggle: true, "onText-change": e => (this.confirmPassword = e.detail), placeholder: locales.entries?.Lcz_ConfirmPassword, value: this.confirmPassword })))), !insideSidebar && (h("div", { key: '2a3d49590d6dff3e432779eae49fad46e05a00c3', class: "d-flex flex-column mt-2 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, h("ir-custom-button", { key: 'f24f0c3b4b4ada252cf9bcda6de751900563ab07',
            // btn_styles={'flex-fill'}
            onClickHandler: () => window.history.back(), class: "flex-fill",
            // text={locales.entries?.Lcz_Cancel}
            size: "m", appearance: "filled", variant: "neutral" }, locales.entries?.Lcz_Cancel), h("ir-custom-button", { key: '5ef27845638b9d262746413727d2441832ffcfc7',
            // btn_styles={'flex-fill'}
            class: "flex-fill", loading: this.isLoading, type: "submit", size: "m", variant: "brand" }, locales.entries?.Lcz_ChangePassword)))))), insideSidebar && (h("div", { key: 'b159e0067f32f932cd248a552a2459fa0e95b8f3', class: 'sheet-footer w-full' }, h("ir-custom-button", { key: '32dcec29f2aa2ad7a94f24d04deec596ddf12a5a', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", appearance: "filled", variant: "neutral", size: "m" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '4f34e1dbddd3b3c88019e38e69b414a2e6f56d6b', variant: "brand", loading: this.isLoading, class: "flex-fill", type: "submit", size: "m" }, locales.entries.Lcz_ChangePassword)))))));
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        return (h("form", { key: '92d97cba12ca8a19f4a2dbaf82b7ace4993d9126', id: this.formId,
            // class="sheet-container"
            onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, h("div", { key: '5609f3f5d3578f6a7b7945059e07f12309c1fde9', class: "d-flex flex-column", style: { gap: '1rem' } }, h("ir-validator", { key: '58c26dfdbbe440f7b0744783cb2f2b51c4b4b15a', asyncValidation: true, showErrorMessage: true, value: this.userInfo.email, schema: this.userSchema.shape.email }, h("ir-input", { key: '5b989a765e7d92f82f245c3882f10a6831282bef', maxlength: 40, "onText-change": e => this.updateUserField('email', e.detail), value: this.userInfo.email, label: locales.entries.Lcz_Email, "data-testid": "email", id: "user-email" })), h("ir-validator", { key: '82ee3a595989c9553e2f20e5aa1bbeb3d0035c9c', showErrorMessage: true, value: this.userInfo.mobile, schema: this.userSchema.shape.mobile }, h("ir-input", { key: '08396037898c4bbcd021f69c9b66ce395a2db424', "onText-change": e => this.updateUserField('mobile', e.detail), value: this.userInfo.mobile, label: locales.entries.Lcz_Mobile, "data-testid": "mobile", mask: this.mobileMask })), (this.user && this.user?.type?.toString() === this.superAdminId) || this.isPropertyAdmin ? null : (h("ir-validator", { value: this.userInfo.type?.toString(), schema: this.userSchema.shape.type }, h("wa-select", { "data-testId": "user_type",
            // error={this.errors?.type && !this.userInfo.type}
            disabled: this.disableFields, label: "Role", value: this.userInfo.type?.toString(), size: "s", defaultValue: this.userInfo.type?.toString(), placeholder: locales.entries.Lcz_Select, onchange: e => this.updateUserField('type', e.target.value) }, this.allowedUsersTypes.map(t => (h("wa-option", { value: t.code }, t.value)))))), this.user?.type?.toString() !== '5' && (h(Fragment, { key: 'b45bbe860411ad85696f609fbe3dc21030691363' }, h("input", { key: '236a429eea019344961128ef551830c735a16af8', type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { key: '2a767620baea58f1e5769de8d11776370d1e8f4c', asyncValidation: true, schema: this.userSchema.shape.username, value: this.userInfo.username }, h("ir-input", { key: '0c09e80fcfae63ecd4e2905daee027cb9cf7926d', "onText-change": e => this.updateUserField('username', e.detail), autocomplete: "off", maxlength: 40, value: this.userInfo.username, disabled: this.disableFields, label: locales.entries.Lcz_Username })))), !this.user ? (h(Fragment, null, h("input", { type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { value: this.userInfo.password, schema: this.userSchema.shape.password }, h("ir-input", { "data-testId": "password", label: locales.entries.Lcz_Password, value: this.userInfo.password, autocomplete: "off", passwordToggle: true, type: "password", id: "password", maxlength: 16, onInputFocus: () => (this.showPasswordValidation = true), "onInput-blur": () => {
        ...
        // ))
        )), this.user?.sign_ins?.length > 0 && (h("section", { key: 'c70323bca72b012d7c0ce935f463c5c23fb86552', class: "logins-history-section mt-2" }, h("div", { key: '91184ccb5879ad900214701345773d3a03237130', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: 'd0f5d8dc6e4f78a81df686159c44cd6d2f9f20cc', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: '166d547c15a808544462d4a99b91ed6b8562df96', btn_styles: 'pr-0', text: !this.showFullHistory ? locales.entries.Lcz_ViewAll : locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: 'a6355cec3e4fe9b913f3828e47f23207010bf778', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
        ...
        })))), h("ir-sidebar", { key: 'f73f16e98fcd00ca59c98ecad4b6f486f50c1322', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: '0aae195bf69aecc654322c69ace3616b7fae434c', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))));
