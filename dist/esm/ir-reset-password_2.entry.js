...
const IrUserFormPanel = class {
    ...
    render() {
        return (h("form", { key: '773ad0e24019a24d58279c88488ad0cb2438ed91', id: this.formId,
            // class="sheet-container"
            onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, h("div", { key: '5cdb1cf52af96be7085d3174f3125bc48a994db3', class: "d-flex flex-column", style: { gap: '1rem' } }, h("ir-validator", { key: 'c2548a28c09fb79a74bd36aa538091c9acaa9bfc', asyncValidation: true, showErrorMessage: true, value: this.userInfo.email, schema: this.userSchema.shape.email }, h("ir-input", { key: 'a7400db1dc218fc76b3bb6465688e533487280e4', maxlength: 40, "onText-change": e => this.updateUserField('email', e.detail), value: this.userInfo.email, label: t('Lcz_Email', { fallback: 'Email' }), "data-testid": "email", id: "user-email" })), h("ir-validator", { key: 'bf868529350c553d84b6d9f3361aaa577b5de2ad', showErrorMessage: true, value: this.userInfo.mobile, schema: this.userSchema.shape.mobile }, h("ir-input", { key: '0ee5c8385bdade7bd34fe2989c3b9ad1a65d5538', "onText-change": e => this.updateUserField('mobile', e.detail), value: this.userInfo.mobile, label: t('Lcz_Mobile'), "data-testid": "mobile", mask: this.mobileMask })), (this.user && this.user?.type?.toString() === this.superAdminId) || this.isPropertyAdmin ? null : (h("ir-validator", { value: this.userInfo.type?.toString(), schema: this.userSchema.shape.type }, h("wa-select", { "data-testId": "user_type",
            // error={this.errors?.type && !this.userInfo.type}
            disabled: this.disableFields, label: t('Lcz_Role', { fallback: 'Role' }), value: this.userInfo.type?.toString(), size: "s", defaultValue: this.userInfo.type?.toString(), placeholder: t('Lcz_Select', { fallback: 'Select' }), onchange: e => this.updateUserField('type', e.target.value) }, this.allowedUsersTypes.map(t => (h("wa-option", { value: t.code }, t.value)))))), this.user?.type?.toString() !== '5' && (h(Fragment, { key: '30c6eab3714e31a525c540342e63aba04bd681c0' }, h("input", { key: '5184043a87f1ae9b5980ec3007daf35db5267542', type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { key: '8b00582081641f43515d702630ed720e7f4b53f5', asyncValidation: true, schema: this.userSchema.shape.username, value: this.userInfo.username }, h("ir-input", { key: '680258b8fc8b8f53280d1c75f27445eb906911ef', "onText-change": e => this.updateUserField('username', e.detail), autocomplete: "off", maxlength: 40, value: this.userInfo.username, disabled: this.disableFields, label: t('Lcz_Username', { fallback: 'Username' }) })))), !this.user ? (h(Fragment, null, h("input", { type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { value: this.userInfo.password, schema: this.userSchema.shape.password }, h("ir-input", { "data-testId": "password", label: t('Lcz_Password', { fallback: 'Password' }), value: this.userInfo.password, autocomplete: "off", passwordToggle: true, type: "password", id: "password", maxlength: 16, onInputFocus: () => (this.showPasswordValidation = true), "onInput-blur": () => {
        ...
        // ))
        )), this.user?.sign_ins?.length > 0 && (h("section", { key: 'f4d171b9bc093a6c719cb4c70a62f1f3d355f26c', class: "logins-history-section mt-2" }, h("div", { key: '82545fad6e15012f0cb2a64a38ad69c1b9bb018c', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: 'b97cfe5c0a2b9bce782a026c234b88299cd16062', class: "logins-history-title m-0 p-0" }, t('Lcz_RecentSignins', { fallback: 'Recent sign-ins' })), this.user.sign_ins.length > 5 && (h("ir-button", { key: '0aa71a02fd06ef973fab1d158e1051b104c04568', btn_styles: 'ir-pe-0', text: !this.showFullHistory ? t('Lcz_ViewAll') : t('Lcz_ViewLess'), btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: 'd8e6bbcbb5b318b6814a9544309ccc77c534bdb5', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
        ...
        })))), h("ir-sidebar", { key: '868f21113ff288b321d4a7d24f845625e241576a', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: '8e87da52b80fcc447436927412cec752a0a8bff9', ticket: this.ApiClient.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))));
