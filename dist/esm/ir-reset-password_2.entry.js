import { r as registerInstance, c as createEvent, a as getElement, h, F as Fragment } from './index-DCCEVrU4.js';
...
const IrResetPassword = class {
    ...
    render() {
        ...
        // }
        return (h("div", { key: '9de911f9408908d5fd86e15eebf0819e26c8aa64', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, h(Fragment, { key: '8c3e0269996cd6843d182b889e05c741ddbfea3e' }, !insideSidebar && (h(Fragment, { key: 'f04dc486d8fc124578adbebd2675784fe8d6e049' }, h("ir-interceptor", { key: '695a0e50d22f234ed45a34c101dab9891e3f454e', suppressToastEndpoints: ['/Change_User_Pwd'] }), h("ir-toast", { key: 'f9afaee0323195d8b245e1d71e4241822970332b' }))), h("form", { key: 'a7b82af8f83e836fb97497a44c2ad4bf9deca7ee', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && h("ir-title", { key: 'f04b9bfcd7c2e3cfc6dd5dd2adcf5b2de8c1077e', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), h("div", { key: '95d703784587551ea6d0f0d635c21192ca0be04a', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, h("svg", { key: '4a4d9845006bb61f26f1b7e44ab356262f3226b6', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, h("path", { key: '7481701c6578f6e810d8f1a1cc3fb2f5ac79db52', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), h("div", { key: '7e6f3b2f0a7ca50dd92e3edd4eee11ba054d5ef6', class: "text-center mb-2" }, h("h4", { key: 'a9b26b35c2d333e27e6eea7669751d05bcd00b57', class: "mb-1" }, locales?.entries?.Lcz_SetNewPassword), this.submitted ? (h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (h("section", { key: '93fa2eb587894bb027710d587016018a476e5625' }, h("div", { key: '0a75e2122a78973eefeb2dbe3798d75a72c8739c', class: 'mb-2 d-flex flex-column', style: { gap: '1rem' } }, h("div", { key: '69f99c495c4833d43dfaa7163b63a0712cc46455', class: "m-0 p-0" }, h("div", { key: '5fd7a627d57de3ea7bb2ec161c0bee30296b225f', class: 'position-relative' }, h("ir-validator", { key: 'a04b27b0627a499690b9b1dbea654e53135da54d', schema: this.ResetPasswordSchema.shape.password, value: this.password }, h("ir-input", { key: '2140dc6b65b686abcdd3492ec4632d832e6e3362', type: "password", passwordToggle: true, "onText-change": e => (this.password = e.detail), onInputFocus: () => (this.showValidator = true), placeholder: locales.entries?.Lcz_NewPassword, value: this.password }))), this.showValidator && h("ir-password-validator", { key: '936720d5a2a75b363675da612e5b82277e12b66c', class: "mb-1", password: this.password })), h("div", { key: 'e959d836bd405a2a4103f169b1318e1fed4fe216', class: 'position-relative' }, h("ir-validator", { key: '99104a4ae63c36aee9ee33b4ed35de3fcc493d51', schema: this.ResetPasswordSchema.shape.confirm_password, value: this.confirmPassword }, h("ir-input", { key: 'e0f413e7fb990e3eeaa006fc0f8227c12b96a5c0', type: "password", passwordToggle: true, "onText-change": e => (this.confirmPassword = e.detail), placeholder: locales.entries?.Lcz_ConfirmPassword, value: this.confirmPassword })))), !insideSidebar && (h("div", { key: '4f189b5163c7ed12b66ece863570ae2e6b3bec79', class: "d-flex flex-column mt-2 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, h("ir-custom-button", { key: '2f0509f5e71a92b2620e21f8d6bc3487b16726c2',
            // btn_styles={'flex-fill'}
            onClickHandler: () => window.history.back(), class: "flex-fill",
            // text={locales.entries?.Lcz_Cancel}
            size: "m", appearance: "filled", variant: "neutral" }, locales.entries?.Lcz_Cancel), h("ir-custom-button", { key: '4bcc92f1323ddef23c09c64ec3c20d50a32dc8b1',
            // btn_styles={'flex-fill'}
            class: "flex-fill", loading: this.isLoading, type: "submit", size: "m", variant: "brand" }, locales.entries?.Lcz_ChangePassword)))))), insideSidebar && (h("div", { key: '722ecac83957e181a5c257be4bcfc5f4057f0aba', class: 'sheet-footer w-full' }, h("ir-custom-button", { key: '6b609f6c04af74ed354522e913e17b0ec5fa66e9', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", appearance: "filled", variant: "neutral", size: "m" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'c401282a0bc9ffcdb07544622d87d8098a3d78d8', variant: "brand", loading: this.isLoading, class: "flex-fill", type: "submit", size: "m" }, locales.entries.Lcz_ChangePassword)))))));
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        return (h("form", { key: '0e9944e32c9c8b97aca1440186621e54012921e6', id: this.formId,
            // class="sheet-container"
            onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, h("div", { key: 'ff9dd8b05c2704e513261fadc9154f65ac15468d', class: "d-flex flex-column", style: { gap: '1rem' } }, h("ir-validator", { key: '5643be740f5bd3d8dd9148366aa5bd98e4a49d1f', asyncValidation: true, showErrorMessage: true, value: this.userInfo.email, schema: this.userSchema.shape.email }, h("ir-input", { key: 'f8f361c05424a96b12211f01c4a57e3a2eea084d', maxlength: 40, "onText-change": e => this.updateUserField('email', e.detail), value: this.userInfo.email, label: locales.entries.Lcz_Email, "data-testid": "email", id: "user-email" })), h("ir-validator", { key: '59636ae0ea9830b928a41fb45d9d2238fcbb9130', showErrorMessage: true, value: this.userInfo.mobile, schema: this.userSchema.shape.mobile }, h("ir-input", { key: '3bff095abc83daa857950a4e62be9eadff912b98', "onText-change": e => this.updateUserField('mobile', e.detail), value: this.userInfo.mobile, label: locales.entries.Lcz_Mobile, "data-testid": "mobile", mask: this.mobileMask })), (this.user && this.user?.type?.toString() === this.superAdminId) || this.isPropertyAdmin ? null : (h("ir-validator", { value: this.userInfo.type?.toString(), schema: this.userSchema.shape.type }, h("wa-select", { "data-testId": "user_type",
            // error={this.errors?.type && !this.userInfo.type}
            disabled: this.disableFields, label: "Role", value: this.userInfo.type?.toString(), size: "s", defaultValue: this.userInfo.type?.toString(), placeholder: locales.entries.Lcz_Select, onchange: e => this.updateUserField('type', e.target.value) }, this.allowedUsersTypes.map(t => (h("wa-option", { value: t.code }, t.value)))))), this.user?.type?.toString() !== '5' && (h(Fragment, { key: '33c627e0ee05f4669d454795c846d8d8ed5a76c8' }, h("input", { key: '9f344534a2eb7552264550a82b0866f1e124232c', type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { key: '6dfe917a77249dd4c441e5bbc12868eba7cf5102', asyncValidation: true, schema: this.userSchema.shape.username, value: this.userInfo.username }, h("ir-input", { key: '2347a8e31753daa32a6b6bee2a2c4f6b53ee5013', "onText-change": e => this.updateUserField('username', e.detail), autocomplete: "off", maxlength: 40, value: this.userInfo.username, disabled: this.disableFields, label: locales.entries.Lcz_Username })))), !this.user ? (h(Fragment, null, h("input", { type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { value: this.userInfo.password, schema: this.userSchema.shape.password }, h("ir-input", { "data-testId": "password", label: locales.entries.Lcz_Password, value: this.userInfo.password, autocomplete: "off", passwordToggle: true, type: "password", id: "password", maxlength: 16, onInputFocus: () => (this.showPasswordValidation = true), "onInput-blur": () => {
        ...
        // ))
        )), this.user?.sign_ins?.length > 0 && (h("section", { key: '9ca1a97aa7796f3752414dec7f200b13c51d4540', class: "logins-history-section mt-2" }, h("div", { key: '61b2ced3db9125dfa88f3b0f098b41aae9a9d9ee', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: '2412a034a32be8d80d28c81aadcc9cb29b6d2ffe', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: 'f070a2da98fd87be3fb6360de44bbc1ff329e9d9', btn_styles: 'pr-0', text: !this.showFullHistory ? locales.entries.Lcz_ViewAll : locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: '5e1039b07eab8d07a80f404178d88f995218817f', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
        ...
        })))), h("ir-sidebar", { key: '7af81f24887d4de06db390e229630c82a8d626c6', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: '7bbd06acb39db78822275fa12d3d89a8c592ff7a', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))));
