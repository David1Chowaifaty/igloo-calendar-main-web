import { r as registerInstance, c as createEvent, d as getElement, h, F as Fragment } from './index-CaNXuIlM.js';
...
const IrResetPassword = class {
    ...
    render() {
        ...
        // }
        return (h("div", { key: '0bd547529198d2229fbd204431ac4b41a52c3c36', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, h(Fragment, { key: '9a36f9b5f6dd241725932bcc8816e623d6600e33' }, !insideSidebar && (h(Fragment, { key: 'dc47907dca08d130445f4a5edd1dd2de7df8683e' }, h("ir-interceptor", { key: '5490424c55222ebdee3bacf2c6a2a84f6763d96f', suppressToastEndpoints: ['/Change_User_Pwd'] }), h("ir-toast", { key: 'eaef1272ef65d3b0dcfcebc927cb6ec5227b9a0f' }))), h("form", { key: '1c13eee8fc1769b20dcfe2a5058d2ab32775b345', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && h("ir-title", { key: 'a71eaaf6966f2a062fdd2bc0dd2a6e50f8382e5e', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), h("div", { key: 'e4dc0ad7beaa38cefa726cb61290ca35a3543b42', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, h("svg", { key: '46f543db1ed9368e145baeb0137e5fb4adb64d88', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, h("path", { key: 'bc6e08a0cba99676fb32943742b6465995c42b30', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), h("div", { key: '681cc4f8fd8175f7f55cb52d5a02966d1c6332d7', class: "text-center mb-2" }, h("h4", { key: 'a52be0bda536c161ca2914c8549c275404bb8dcd', class: "mb-1" }, locales?.entries?.Lcz_SetNewPassword), this.submitted ? (h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (h("section", { key: '25eb43a277764c3a2038684df6b368dfd5d705f0' }, h("div", { key: '6766c065a94f8939c699e091d71308b5ed618229', class: 'mb-2 d-flex flex-column', style: { gap: '1rem' } }, h("div", { key: '9ac3200d9addded0641e133bd0f1626a01223b03', class: "m-0 p-0" }, h("div", { key: 'ea688fb8583124254900729d40b017713187dbb5', class: 'position-relative' }, h("ir-validator", { key: '29976ad1856d2afbdb31c4d60c19f9bb2743fcee', schema: this.ResetPasswordSchema.shape.password, value: this.password }, h("ir-input", { key: '05299b8fc71bc9fd0d77cdc80f82647cf62cb571', type: "password", passwordToggle: true, "onText-change": e => (this.password = e.detail), onInputFocus: () => (this.showValidator = true), placeholder: locales.entries?.Lcz_NewPassword, value: this.password }))), this.showValidator && h("ir-password-validator", { key: '1ed1ae176d698184fa3a92cb335417bd0b369de1', class: "mb-1", password: this.password })), h("div", { key: 'f8ce87e7be2378969aed39dc426a9bd474812774', class: 'position-relative' }, h("ir-validator", { key: '7b26a8be1602504e7c5c7202afc501a80ca33a1e', schema: this.ResetPasswordSchema.shape.confirm_password, value: this.confirmPassword }, h("ir-input", { key: '011bdc0874d30d9a6251c2e812dd20fc22641f7a', type: "password", passwordToggle: true, "onText-change": e => (this.confirmPassword = e.detail), placeholder: locales.entries?.Lcz_ConfirmPassword, value: this.confirmPassword })))), !insideSidebar && (h("div", { key: 'd77d710d613b982ef52914b96171a33ae56a71ce', class: "d-flex flex-column mt-2 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, h("ir-custom-button", { key: '42800685513304ee66a4a6a2d6255df6460a6157',
            // btn_styles={'flex-fill'}
            onClickHandler: () => window.history.back(), class: "flex-fill",
            // text={locales.entries?.Lcz_Cancel}
            size: "m", appearance: "filled", variant: "neutral" }, locales.entries?.Lcz_Cancel), h("ir-custom-button", { key: '8a7bdf7b06672cb6104967508cadc15c079100a7',
            // btn_styles={'flex-fill'}
            class: "flex-fill", loading: this.isLoading, type: "submit", size: "m", variant: "brand" }, locales.entries?.Lcz_ChangePassword)))))), insideSidebar && (h("div", { key: '975c70c7c405b83e2f6e9f365f657a9ecb25aaa4', class: 'sheet-footer w-full' }, h("ir-custom-button", { key: 'fd57bc93b4491556bd2ef66c93f18ff00bae4055', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", appearance: "filled", variant: "neutral", size: "m" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '3afb887e6d087cf0c4f6928003c68c381a6ca51a', variant: "brand", loading: this.isLoading, class: "flex-fill", type: "submit", size: "m" }, locales.entries.Lcz_ChangePassword)))))));
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        return (h("form", { key: '49af9ef8f51c63931f1c6a064d4d886f5f816f09', id: this.formId,
            // class="sheet-container"
            onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, h("div", { key: '71ae03d3b3c147a25ded1119f2f5d6488aeb2ead', class: "d-flex flex-column", style: { gap: '1rem' } }, h("ir-validator", { key: '4d9a1c14ae48d31a89d88c509ef59d1ca5d8aad9', asyncValidation: true, showErrorMessage: true, value: this.userInfo.email, schema: this.userSchema.shape.email }, h("ir-input", { key: 'e21404840c08abf496b5f7d0f4c5f0d10eeab3bc', maxlength: 40, "onText-change": e => this.updateUserField('email', e.detail), value: this.userInfo.email, label: locales.entries.Lcz_Email, "data-testid": "email", id: "user-email" })), h("ir-validator", { key: '72a626e09801b2142823a209410bdfa1bc238451', showErrorMessage: true, value: this.userInfo.mobile, schema: this.userSchema.shape.mobile }, h("ir-input", { key: '89a45880dee1cffd31a7c4acdef0db7adaa8497c', "onText-change": e => this.updateUserField('mobile', e.detail), value: this.userInfo.mobile, label: locales.entries.Lcz_Mobile, "data-testid": "mobile", mask: this.mobileMask })), (this.user && this.user?.type?.toString() === this.superAdminId) || this.isPropertyAdmin ? null : (h("ir-validator", { value: this.userInfo.type?.toString(), schema: this.userSchema.shape.type }, h("wa-select", { "data-testId": "user_type",
            // error={this.errors?.type && !this.userInfo.type}
            disabled: this.disableFields, label: "Role", value: this.userInfo.type?.toString(), size: "s", defaultValue: this.userInfo.type?.toString(), placeholder: locales.entries.Lcz_Select, onchange: e => this.updateUserField('type', e.target.value) }, this.allowedUsersTypes.map(t => (h("wa-option", { value: t.code }, t.value)))))), this.user?.type?.toString() !== '5' && (h(Fragment, { key: '9309963bdfe6c0c090e6861d7001b96c9242dfca' }, h("input", { key: '49d612a49f08363694b6b908c30a23a85da7f053', type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { key: '2165628f44661e904ddbae7310c5cf140fe1fa0f', asyncValidation: true, schema: this.userSchema.shape.username, value: this.userInfo.username }, h("ir-input", { key: 'abb331c5650a08eac786f3d7fb0cfd7710635cdb', "onText-change": e => this.updateUserField('username', e.detail), autocomplete: "off", maxlength: 40, value: this.userInfo.username, disabled: this.disableFields, label: locales.entries.Lcz_Username })))), !this.user ? (h(Fragment, null, h("input", { type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { value: this.userInfo.password, schema: this.userSchema.shape.password }, h("ir-input", { "data-testId": "password", label: locales.entries.Lcz_Password, value: this.userInfo.password, autocomplete: "off", passwordToggle: true, type: "password", id: "password", maxlength: 16, onInputFocus: () => (this.showPasswordValidation = true), "onInput-blur": () => {
        ...
        // ))
        )), this.user?.sign_ins?.length > 0 && (h("section", { key: '1cfa589ee1a50258d0e38399208bc9da4b5ffc5f', class: "logins-history-section mt-2" }, h("div", { key: 'b74043bcbabb837d5512f80eaf1968d790934963', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: '8e1e97fcd83cb71dd49b305030cdf10a28eda84b', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: '5b198deaf279495d32c1a5b9987e364a3f3b6794', btn_styles: 'pr-0', text: !this.showFullHistory ? locales.entries.Lcz_ViewAll : locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: 'cd518dcce915263327d8ea4b13e9c4f0d63cb4db', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
        ...
        })))), h("ir-sidebar", { key: '5a952f02e74192eb028d83503226c69284dd57dc', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: 'ba8d270863b277df887a01ab1d530a6dcf6cc470', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))));
