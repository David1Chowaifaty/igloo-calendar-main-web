...
const IrResetPassword = class {
    ...
    render() {
        ...
        // }
        return (h("div", { key: '5738e5e87556e8c5cbeb6117a418f681541cc392', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, h(Fragment, { key: '9a01fff9a7399cc3e37e56eaa594b0bbc04320e2' }, !insideSidebar && (h(Fragment, { key: '9917ec4a1c9d5c7894390dfb33a8c303e3a4c6e9' }, h("ir-interceptor", { key: '184103cf56667ca150d4e65ee5424900dd258af2', suppressToastEndpoints: ['/Change_User_Pwd'] }), h("ir-toast", { key: '34d29dc82076098a2f6c951e281fc3406ae7df12' }))), h("form", { key: 'c15668864c4cb8126321f44dc4c892ebe639312d', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && h("ir-title", { key: '68fe2b94fc8facf505c7d455c7e0e560d511ea52', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), h("div", { key: '4efb375f34d19322889765dbe7f84f63e6035985', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, h("svg", { key: '499d16ae740b3a59a1ab613d36d5509f0fcddad7', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, h("path", { key: '0ebdfc07e9ff734c9cb51825ba9a3e5d0bf76e9e', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), h("div", { key: '6f5357c807b95dc2ba0831cc2ee5b0c83836f815', class: "text-center mb-2" }, h("h4", { key: '6169932e7de1871f360fcce438cb9333ed78dab4', class: "mb-1" }, locales?.entries?.Lcz_SetNewPassword), this.submitted ? (h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (h("section", { key: '15c1b8065857c3d7c13ef48a67d7000a6d5d7478' }, h("div", { key: 'f3ac224b37b1d43fd16f22faf0ce3ac20f53b215', class: 'mb-2 d-flex flex-column', style: { gap: '1rem' } }, h("div", { key: '6309584759f6cb5d009ae0172f2d3a984034dcfe', class: "m-0 p-0" }, h("div", { key: '114efea633343f930ad23f41cfc95c4a55f8ab5e', class: 'position-relative' }, h("ir-validator", { key: '60035f05f132d4fb48c79f0e8a11bfc1c375ee6c', schema: this.ResetPasswordSchema.shape.password, value: this.password }, h("ir-input", { key: 'c9e492fa586047d38547330e33303b630d04e4d0', type: "password", passwordToggle: true, "onText-change": e => (this.password = e.detail), onInputFocus: () => (this.showValidator = true), placeholder: locales.entries?.Lcz_NewPassword, value: this.password }))), this.showValidator && h("ir-password-validator", { key: '5ed3e9599ae1874d23695ccce3c869a7d0edbcbd', class: "mb-1", password: this.password })), h("div", { key: 'f769b27febf91357cf63c4ba3b415bcfc11de064', class: 'position-relative' }, h("ir-validator", { key: 'da5b9da2a432a4e97429cd3e8458036bec273d43', schema: this.ResetPasswordSchema.shape.confirm_password, value: this.confirmPassword }, h("ir-input", { key: 'f78359a9b1a3d6ca8b3ebf9a8c6e7e7b7b8d269b', type: "password", passwordToggle: true, "onText-change": e => (this.confirmPassword = e.detail), placeholder: locales.entries?.Lcz_ConfirmPassword, value: this.confirmPassword })))), !insideSidebar && (h("div", { key: 'c36552ded56fd5c0a42b9365ae54640761acc099', class: "d-flex flex-column mt-2 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, h("ir-custom-button", { key: '772de5ae94417c3763961da66670cbb5d4cb56ea',
            // btn_styles={'flex-fill'}
            onClickHandler: () => window.history.back(), class: "flex-fill",
            // text={locales.entries?.Lcz_Cancel}
            size: "m", appearance: "filled", variant: "neutral" }, locales.entries?.Lcz_Cancel), h("ir-custom-button", { key: 'df35c9f5ecfd48faacfae749898fa41e1c8767ef',
            // btn_styles={'flex-fill'}
            class: "flex-fill", loading: this.isLoading, type: "submit", size: "m", variant: "brand" }, locales.entries?.Lcz_ChangePassword)))))), insideSidebar && (h("div", { key: '89540a062381c2ccc62b408b8aff4f0a12517aaf', class: 'sheet-footer w-full' }, h("ir-custom-button", { key: '64d6c671644d5ca6a96d64cb0c0bc98bda03a355', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", appearance: "filled", variant: "neutral", size: "m" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '6d7903ffcf2b1fc20caf940575916f3117d1cc52', variant: "brand", loading: this.isLoading, class: "flex-fill", type: "submit", size: "m" }, locales.entries.Lcz_ChangePassword)))))));
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        // ))
        )), this.user?.sign_ins?.length > 0 && (h("section", { key: 'd979ae083dd7aabb1876ed841f493aa188fdaa71', class: "logins-history-section mt-2" }, h("div", { key: '38bd2abbc6655793fa7282eb7a57a578770ae88f', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: 'a56ca49a79f8726d5b963443b6af75d3b3c70010', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: '444f2cf9bfb329c6292166443388b191581f3e3e', btn_styles: 'pr-0', text: !this.showFullHistory ? locales.entries.Lcz_ViewAll : locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: 'cc40be897b6c99d505dfa48a5ed5febaec72bfdd', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
        ...
        })))), h("ir-sidebar", { key: '61f4335cae359906494efbde811ec482d017e73c', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: '225decb1b30fa832ee32161525df4c1033cf6e51', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))));
