import { r as registerInstance, c as createEvent, a as getElement, h, F as Fragment } from './index-BvoylR5O.js';
...
const IrResetPassword = class {
    ...
    render() {
        ...
        // }
        return (h("div", { key: '9378853167ca871c2ee4931a8e25f09ec7dcad9c', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, h(Fragment, { key: '8cbb36f3a34c722919f3e023b2db3aa81d1370b7' }, !insideSidebar && (h(Fragment, { key: '235330b88bb546f11fa5720dbe829d2be41539cd' }, h("ir-interceptor", { key: 'faf45e5dc95c199ee6a107299f9be2feaf55333e', suppressToastEndpoints: ['/Change_User_Pwd'] }), h("ir-toast", { key: '0f89dc969e251090b3db93154a2c3dd3e9c61037' }))), h("form", { key: 'e916dcc34356567baabb4f174c2c95d621c17426', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && h("ir-title", { key: 'ed89f0044fa6a6d9be52533a9d3496be5269b38f', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), h("div", { key: '8e1e38b1ec7ae805ccb120dd2ccb517ffb054c5c', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, h("svg", { key: '44fde11faa93cbfcbc8a9a0b5598abadebb62b55', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, h("path", { key: '7b451d9b8ea7c116b23e2dc120b36171b2a64d61', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), h("div", { key: 'b30a2d70bf7684d830e33f93b66aeb8c1e2cbc42', class: "text-center mb-2" }, h("h4", { key: '7e0629b5cc1b8c40aa1f93df673fe877a21d3513', class: "mb-1" }, locales?.entries?.Lcz_SetNewPassword), this.submitted ? (h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (h("section", { key: 'b801590cce22b3374e75a05a1633be4d0ea7dc47' }, h("div", { key: '6d9b07df3c5991c142a695be10913e5f5e127de8', class: 'mb-2 d-flex flex-column', style: { gap: '1rem' } }, h("div", { key: 'bac940ff22d7dac532dc98089813b3818671c0de', class: "m-0 p-0" }, h("div", { key: 'ac8110c99a7e777022b00b0cb10ccbd43a8f7e68', class: 'position-relative' }, h("ir-validator", { key: '584717e3cd6d9242109b4b0bfd70413b7349c700', schema: this.ResetPasswordSchema.shape.password, value: this.password }, h("ir-input", { key: '334766cadf3074895260abe6ceda4456b4682d04', type: "password", passwordToggle: true, "onText-change": e => (this.password = e.detail), onInputFocus: () => (this.showValidator = true), placeholder: locales.entries?.Lcz_NewPassword, value: this.password }))), this.showValidator && h("ir-password-validator", { key: '94607cf4fb30e66c9a4ff74147179e3a41e1cd2b', class: "mb-1", password: this.password })), h("div", { key: 'a41578e491157dd3a96221bf1616a1fc532fa1dd', class: 'position-relative' }, h("ir-validator", { key: 'efc5fad6c9ba9ad0e37d49f57369061724f12785', schema: this.ResetPasswordSchema.shape.confirm_password, value: this.confirmPassword }, h("ir-input", { key: 'be813e50318d0caf823c707d36227d2ea2f16cd9', type: "password", passwordToggle: true, "onText-change": e => (this.confirmPassword = e.detail), placeholder: locales.entries?.Lcz_ConfirmPassword, value: this.confirmPassword })))), !insideSidebar && (h("div", { key: '1db410d7221a4882ad88bf7e815e0ec7edcb2a84', class: "d-flex flex-column mt-2 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, h("ir-custom-button", { key: '799acbc911a93ed4438f2208a4ed749e068a5f6b',
            // btn_styles={'flex-fill'}
            onClickHandler: () => window.history.back(), class: "flex-fill",
            // text={locales.entries?.Lcz_Cancel}
            size: "m", appearance: "filled", variant: "neutral" }, locales.entries?.Lcz_Cancel), h("ir-custom-button", { key: '1d31ec59883e318b3fad726e605891cb20bdcc25',
            // btn_styles={'flex-fill'}
            class: "flex-fill", loading: this.isLoading, type: "submit", size: "m", variant: "brand" }, locales.entries?.Lcz_ChangePassword)))))), insideSidebar && (h("div", { key: 'c0004957fc88dd4c40d7d0d03c6a0751a42d2b2d', class: 'sheet-footer w-full' }, h("ir-custom-button", { key: 'ea860ffd55ff16daf6a4516439b5291708d6c369', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", appearance: "filled", variant: "neutral", size: "m" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'e266920e3342b3af6c70165c07848ceb00fce014', variant: "brand", loading: this.isLoading, class: "flex-fill", type: "submit", size: "m" }, locales.entries.Lcz_ChangePassword)))))));
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        return (h("form", { key: '1b2d4b4b9a73f6dd7c02758656bba87623b83f8f', id: this.formId,
            // class="sheet-container"
            onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, h("div", { key: 'd3ef84454e685198259adbdc06d6b5b05973bb8e', class: "d-flex flex-column", style: { gap: '1rem' } }, h("ir-validator", { key: '1f6179321864ff5fb216c147a0a963648fb7ec99', asyncValidation: true, showErrorMessage: true, value: this.userInfo.email, schema: this.userSchema.shape.email }, h("ir-input", { key: 'f10b7aa7260ea3248d79948af2208da8f862b730', maxlength: 40, "onText-change": e => this.updateUserField('email', e.detail), value: this.userInfo.email, label: locales.entries.Lcz_Email, "data-testid": "email", id: "user-email" })), h("ir-validator", { key: '33ba64c0f4e6f84ce164c7aaaeb93a357c7c2cbe', showErrorMessage: true, value: this.userInfo.mobile, schema: this.userSchema.shape.mobile }, h("ir-input", { key: 'f86a6690e7cf453483555805a8c8130521bb75c3', "onText-change": e => this.updateUserField('mobile', e.detail), value: this.userInfo.mobile, label: locales.entries.Lcz_Mobile, "data-testid": "mobile", mask: this.mobileMask })), (this.user && this.user?.type?.toString() === this.superAdminId) || this.isPropertyAdmin ? null : (h("ir-validator", { value: this.userInfo.type?.toString(), schema: this.userSchema.shape.type }, h("wa-select", { "data-testId": "user_type",
            // error={this.errors?.type && !this.userInfo.type}
            disabled: this.disableFields, label: "Role", value: this.userInfo.type?.toString(), size: "s", defaultValue: this.userInfo.type?.toString(), placeholder: locales.entries.Lcz_Select, onchange: e => this.updateUserField('type', e.target.value) }, this.allowedUsersTypes.map(t => (h("wa-option", { value: t.code }, t.value)))))), this.user?.type?.toString() !== '5' && (h(Fragment, { key: 'a0c8d55fb054ba66a8fe47eae13a51d58c3623fb' }, h("input", { key: '01cae3e13df634bf8a967ebc8821b016ae8ca242', type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { key: '497d473fd1b3e4f7d47f1c64a1559021c5b83687', asyncValidation: true, schema: this.userSchema.shape.username, value: this.userInfo.username }, h("ir-input", { key: '1dbec6e8f495c8bbbd41f001dedeee1a08151b10', "onText-change": e => this.updateUserField('username', e.detail), autocomplete: "off", maxlength: 40, value: this.userInfo.username, disabled: this.disableFields, label: locales.entries.Lcz_Username })))), !this.user ? (h(Fragment, null, h("input", { type: "text", name: "dummy", style: { display: 'none' } }), h("ir-validator", { value: this.userInfo.password, schema: this.userSchema.shape.password }, h("ir-input", { "data-testId": "password", label: locales.entries.Lcz_Password, value: this.userInfo.password, autocomplete: "off", passwordToggle: true, type: "password", id: "password", maxlength: 16, onInputFocus: () => (this.showPasswordValidation = true), "onInput-blur": () => {
        ...
        // ))
        )), this.user?.sign_ins?.length > 0 && (h("section", { key: '9eb672ed49c8610c9eabd67c68a16bd7f41f094c', class: "logins-history-section mt-2" }, h("div", { key: '7589ffbe3946a4feb075c2ed95f38268e73e712e', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: '5b1d259f014edbdeff68a0bd0a77bf268572d9c5', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: 'e73dba1fd9570b0f90b70de8c6f51ccbe445dfce', btn_styles: 'pr-0', text: !this.showFullHistory ? locales.entries.Lcz_ViewAll : locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: 'eb90b3fd6f9bad3a2882fe29b80544e338854907', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
        ...
        })))), h("ir-sidebar", { key: '366687e078ffd3f47e842bf676ba0b310a998124', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: '0dbc37ea05631d7b2089dccaf9ea3be0cd3b4318', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))));
