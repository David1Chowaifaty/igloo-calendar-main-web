...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: '7b5ef705b9ddffebd49f06da60e22d5b9445088b' }, h("div", { key: '64bd11df76e59335850ca03b69fc09b2660a6ebe', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: '72159b0e6ede0e1f86e5ddf33dff9eebbe78db65', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: '65513dd8def0b92a2cbe471edacb0afe7936893a', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '187bf8a5514ddf6857f7b7997cfd9c2727dda2a6', class: "ir-accordion__trigger-content" }, h("slot", { key: '94c7759bf1a635160f003bb6441f36f847519d1a', name: "trigger" }))), h("div", { key: '0d30b6f83acad04115e47ac331d8d158b616073c', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: 'cab0a26dc3805d663c955b6edcda88db292790ab', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: '5e32d4cd61323fc8e5e762ee989caff87be2852a' }))))));
    }
