...
import { f as formatAmount } from './utils-f69a3563.js';
...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: '53470097a811032d75d27fc1307280f4a8f9873d' }, h("div", { key: '9820a6803aaef72e9ce14388ae580142c88ad1d9', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: '3f51d47bafb3fdbc23dd66eb3b4ab7dc5e5e0f85', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: '95f31f9c930559228a5b86db2dd2477f67909c58', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '0f03e6e21e591111a4e755923b53543b830af9e9', class: "ir-accordion__trigger-content" }, h("slot", { key: '0ac586896bddf3f7d7836e38b9ab749479ad79c0', name: "trigger" }))), h("div", { key: 'd459d7fee57890f34865897bc0fc4a8a86896c1b', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: '0cc0961738069e074f7318a5eb0a17220143c5ad', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: 'f505e94ea7185bc8d9ee8b7664116adabb43490a' }))))));
    }
