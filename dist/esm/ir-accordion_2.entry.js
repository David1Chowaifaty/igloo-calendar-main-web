...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1b2557c171e15e83e97bbd6a5598c4b9c8366d7c' }, h("div", { key: '9a5f56e1aab234676cc7af4083186663f7768bba', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: 'd2c51f44001f7ee2f196641c89d71d1c031f8cbc', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: '92503b9769ddb091c61e3431e90474fb0e81c91d', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '365eab57d6eaa632715d0a987c9b86f6a66e4335', class: "ir-accordion__trigger-content" }, h("slot", { key: 'e7b6f5c59d28d7fa4de67fbb871c5d8e851cd245', name: "trigger" }))), h("div", { key: 'a3c7e8b1bafa094b597bc18754045fa1c9332560', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: '045f78fa7c85a11d1122846a5df51c3ecace2af4', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: 'eb821f6877d27db08218db06d7bc886fbfe1fe1a' }))))));
    }
