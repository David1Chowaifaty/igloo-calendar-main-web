...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: '7e880fa10d3f86d16ed58712c80fb5cc7c18b2bf' }, h("div", { key: 'f53019809869d88b501bbc35030de293058e951a', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: '1c6fbd3cf1055d650d22440b0627bce19972018c', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: '03052efc7377d45e10362656e5687f38883d792a', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '5588e147f988b839ddbad207fe9ac68eb874f85c', class: "ir-accordion__trigger-content" }, h("slot", { key: '3ec19eaa1129e2c155697d460f1fc7fd442215e4', name: "trigger" }))), h("div", { key: 'c94973e4f82aed3f585ea64924d4d8eafb902bf5', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: '68eb6b84ceed3ab2b6c8841acb699466ed3303c7', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: 'f96ea5dddea653005b5a45cb83e2d2afca397d59' }))))));
    }
