import { r as registerInstance, c as createEvent, a as getElement, h, H as Host } from './index-BvoylR5O.js';
...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c2bbc3b6f22bc2dc58e64fdecaa0c67bfec58fc5' }, h("div", { key: '4e03a234e21def43c6c6cadf1f302ae44767b121', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: '1f048d75743f7521dd190581f20fc654406b7d4d', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: 'ba273c5381b67c7a319654221af673ccdce5d877', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: 'ae6a8fd8b54e5a8328f03644834990e79585714a', class: "ir-accordion__trigger-content" }, h("slot", { key: '2006f6f926768902d8da1e30da7cd15939eaa719', name: "trigger" }))), h("div", { key: '5c33dcf49880eb2ba58c56f67c66695a3e27202b', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: 'ff96df84e7282f18eebccbc9d74bb7726e0eee77', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: '7c3ac42cd02e8037e4c806541ea969e1045713d4' }))))));
    }
