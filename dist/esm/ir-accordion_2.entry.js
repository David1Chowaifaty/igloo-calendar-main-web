...
import { _ as _formatTime } from './functions-BWZAbX_T.js';
...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'a8040dd0b41b982892600039d16b92a50b2e442e' }, h("div", { key: 'f168c7f5e4a0e0fba9052344b049f94adbaa1669', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: 'c7591364d2427d74d2ff7cf2deef2bceb535da0b', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: '762db6dd941730c8292595ec97e228bc00736a1d', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '128e1b2d33950051a2467538dc0530c38f9a76f7', class: "ir-accordion__trigger-content" }, h("slot", { key: '14833a298c5387ba6058cc483bf4bf1c114a718f', name: "trigger" }))), h("div", { key: '7e42a87d2e93a5d33572fab02e1541f87af06347', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: '3aadbf866d7c311746cb0dede0f0828396406cf5', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: '34a338f62bc7d1fd03fba43d34cb47af69295803' }))))));
    }
...
const IrRevenueRowDetails = class {
    ...
    render() {
        return (h(Host, { key: '84aadf872c9c716d1218c40f289492f56b5d0c11' }, h("div", { key: '1bb14afe12e3454147b8778570a63308616d149a', class: "ir-revenue-row-detail" }, h("div", { key: '81e5268f8d102a7cc8b07d203bfceaf8fd179e10', class: "ir-revenue-row-detail__info" }, h("div", { key: '97a8eef5a5636df1c4cad00d52153ba660431fd0', class: "ir-revenue-row-detail__time" }, h("span", { key: 'ee626d5a426631531bdbb672516be220932a644e', class: "ir-revenue-row-detail__label" }, this.payment.date), h("span", { key: '5eedb81c85c8eb402e9ee1ffaf5b864a674da175', class: "ir-revenue-row-detail__value" }, _formatTime(this.payment.hour.toString(), this.payment.minute.toString())), h("div", { key: '30ef5ed709df70cd1f7295fea35348e169a76b9d', class: "ir-revenue-row-detail__amount" }, formatAmount(calendar_data.currency.symbol, this.payment.amount))), h("div", { key: '2761b0f3e9da4888929ed0d996e5b3e3779d8cc2', class: "ir-revenue-row-detail__meta" }, h("div", { key: '54d9017ab8b24621136da0c1f44277881ed7b2fd', class: "ir-revenue-row-detail__user" }, h("span", { key: '4aee8c5d51f7e2dc9b5e645fdae08dd4c9516d49', class: "ir-revenue-row-detail__label" }, "User:"), h("span", { key: 'b2ec63905bacb6c692db1b329597fce8b17c1bc7', class: "ir-revenue-row-detail__value" }, this.payment.user)), h("div", { key: '42d1f060caace1913541bf5bf1fced8b937a0b8d', class: "ir-revenue-row-detail__booking" }, h("ir-custom-button", { key: '09a38122b81c07bcbdd73045dc5e63fe4adbd376', link: true, style: { marginLeft: '1rem' }, onClickHandler: e => {
            ...
            } }, this.payment.bookingNbr)))), h("div", { key: '5a45e4038b392cc1a1dd0db24abce551882f0c39', class: "ir-revenue-row-detail__amount" }, formatAmount(calendar_data.currency.symbol, this.payment.amount)))));
    }
};
