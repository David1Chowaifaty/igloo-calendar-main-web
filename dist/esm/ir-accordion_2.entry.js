...
import { f as formatAmount } from './utils-b77baf9f.js';
...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6819a3a1354d39aaf80fb78f9334e9110102bf4f' }, h("div", { key: '64ed313103c89e7a3d7435884417b12f0091f37c', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: 'f135fb437a288cacca396cd0ba60eda529f93ae3', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: '5b59f248779effd1a96c213a89bd92a4b1741fbd', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: 'd734e8f9569ec3f33f2ff3a2945aa3a5a21cd20c', class: "ir-accordion__trigger-content" }, h("slot", { key: 'aaef7e95ec1376b3d6d6a58ae53ab8b8a73fc98a', name: "trigger" }))), h("div", { key: '2104ea18f02523acf20258b80e0b38c0edf1e031', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: '9c7a2659a28c1d99df0e273f0036346bb09a11b0', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: 'dd87ef2c946f7c16986031e5c5e098a87f93bdaf' }))))));
    }
