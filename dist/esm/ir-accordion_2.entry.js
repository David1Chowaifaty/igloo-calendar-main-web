...
const IrAccordion = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'fde3b4d5b8487b7e71ca10efe5ff6407b540b24f' }, h("div", { key: 'e2053a240e0e9fa26ccde1f472de134fcc833802', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: '83faca0b4511a82e08065382e733b80ff2762f42', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: 'f2676766a6b0dab82e26a9b5cc9d97755382bf98', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '867959cceb7f393842f0deb2aa8b07fda4a1d40d', class: "ir-accordion__trigger-content" }, h("slot", { key: '60d519bb0e5099cdafd233166eb9a18f75a4ebe0', name: "trigger" }))), h("div", { key: '4d1f4e3b03fcfbbeddb948304a4269ae21ccc08c', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: 'a921f24ded340a9718aa3d351e68bbb6cfe15c56', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: 'aba8508f629dd07a85a09beb3461b8c82efa278e' }))))));
    }
