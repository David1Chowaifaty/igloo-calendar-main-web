...
const IrMealReportFilters = class {
    ...
    render() {
        ...
        return (h("ir-filter-card", { key: 'b74f37108851b34ed99d75edffd1db242f75f72e' }, h("wa-radio-group", { key: 'c09991e03481ef75af7e2aa32a9e77afde6fadca', label: "Report type", size: "small", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, h("wa-radio", { key: 'f9374e57cdadbee7e9e6f71b020c9ab77d7b9771', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, "Guest list"), h("wa-radio", { key: '3a9be744559f3908fe57992547b85cafbe9ee1d9', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, "Meal count")), this.reportType === 'GUEST_LIST' ? (h("wa-radio-group", { label: "Stay date", size: "small", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            (mealTypes.length > 0 ? (h("wa-radio-group", { defaultValue: this.mealType, label: "Meal type", size: "small", orientation: "horizontal", value: this.mealType, style: { width: '100%' }, onchange: e => {
                ...
                } }, mealTypes.map(type => (h("wa-radio", { style: { flex: '1' }, appearance: "button", value: type.CODE_NAME }, type.CODE_VALUE_EN))))) : (h("div", { class: "ir-meal-report-filters__warning" }, "No meal types found."))), h("div", { key: '948a3f0fa3194c10bba4aea66ccfa0c69e689097', slot: "footer" }, h("ir-custom-button", { key: '8d280ceb6a2a5e009b589494c2e5927b19a64757', type: "button", size: "small", variant: "neutral", appearance: "filled", onClickHandler: (e) => {
                const ev = e.detail;
            ...
            } }, this.lcz.Lcz_Reset || 'Reset'), h("ir-custom-button", { key: 'd6ed86d781d01cbf86a6168b4410aec3d462c730', type: "button", size: "small", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
...
const IrMetricCard = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ed6c354e9e423c8a054784d0a1ad6bd089ef6f5e', role: this.clickable ? 'button' : null, tabindex: interactive ? '0' : null, "aria-label": this.clickable ? ariaLabel : null, "aria-busy": this.loading ? 'true' : null, onClick: interactive ? this.handleActivate : undefined, onKeyDown: interactive ? this.handleKeyDown : undefined }, h("div", { key: 'db7448c45c25c517676dde8e5ebcda70cf4ac51a', part: "base", class: "metric" }, (hasIcon || this.label) && (h("div", { key: 'a69a5b7711d63573620041d6fb2ea0242da063aa', part: "header", class: "metric__header" }, hasIcon && this.renderIcon(), h("span", { key: 'efb7341d377ed5c15ba3ed5c5c3b088b557f808f', part: "label", class: "metric__label" }, h("slot", { key: '619983bf7a8e9aeb0c14062d79bab4cc9b270dd0', name: "label" }, this.label)))), this.loading ? (h("div", { class: "metric__skeleton" }, h("span", { class: "metric__skeleton-bar metric__skeleton-bar--value" }), h("span", { class: "metric__skeleton-bar metric__skeleton-bar--caption" }))) : (h("div", { class: "metric__main" }, h("div", { part: "value", class: "metric__value" }, h("slot", { name: "value" }, this.value !== undefined && this.value !== null && h("span", { class: "metric__value-number" }, this.value), this.unit && (h("span", { part: "unit", class: "metric__unit" }, this.unit))), this.renderTrend()), this.caption && (h("p", { part: "caption", class: "metric__caption" }, this.caption)))), h("div", { key: '20732b53b4011b51c4697f01cd7bb8a35e4c2602', part: "body", class: "metric__body" }, h("slot", { key: '250399d5b7526f138b88b93711e75cccb56ef7a1' })), h("div", { key: '2341717fccc57a5432bb522b8274fcd7064ab492', part: "footer", class: "metric__footer" }, h("slot", { key: 'c241c875af05b2a4132a79a0a004b89814ec6d2e', name: "footer" })))));
    }
};
