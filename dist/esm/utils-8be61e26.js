...
function getDefaultData(cell, stayStatus) {
    ...
    return {
        ...
        TOTAL_PRICE: (_k = cell.booking.financial) === null || _k === void 0 ? void 0 : _k.gross_total_with_extras,
...
function transformNewBooking(data) {
    ...
    rooms.forEach(room => {
        ...
        bookings.push({
            ...
            TOTAL_PRICE: (_e = data.financial) === null || _e === void 0 ? void 0 : _e.gross_total_with_extras,
...
export { convertDMYToISO as A, computeEndDate as B, toFloat as C, renderTime as D, getDaysArray as E, convertDatePrice as F, formatDate as G, getMyBookings as H, convertDateToCustomFormat as I, convertDateToTime as J, checkUserAuthState as K, manageAnchorSession as L, sleep as M, downloadFile as N, calculateDaysBetweenDates as a, findCountry as b, calendar_dates as c, dateToFormattedString as d, extras as e, formatAmount as f, getReleaseHoursString as g, handleBodyOverflow as h, isBlockUnit as i, canCheckIn as j, compareTime as k, createDateWithOffsetAndHour as l, dateDifference as m, formatLegendColors as n, addCleaningTasks as o, formatName as p, getRoomStatus as q, cleanRoom as r, addRoomForCleaning as s, transformNewBooking as t, transformNewBLockedRooms as u, validateEmail as v, bookingStatus as w, getPrivateNote as x, getNextDay as y, addTwoMonthToDate as z };

//# sourceMappingURL=utils-8be61e26.js.map