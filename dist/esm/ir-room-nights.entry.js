...
import { B as BookingService, b as booking_store } from './booking.store-gBD68At4.js';
import { k as getDaysArray, l as convertDatePrice } from './utils-Ct-kEjIU.js';
...
const IrRoomNights = class {
    ...
    renderReadOnlyField(currency_symbol, day) {
        return h("p", { class: "col-9 ir-ms-1 m-0 p-0" }, `${currency_symbol}${Number(day.amount).toFixed(2)}`);
    }
