...
const IrDateView = class {
    ...
    render() {
        ...
        return (h(Host, { key: '97575fb15f0e78f0233ea34bb84ce54703c381d6' }, h("span", { key: '92b4a2d3db0f03c9b2dd0b698aded79e2dd1a0e9', part: "base" }, h("span", { key: '6b4037398ceda8926d11e4f22e7c09fdd830a7f4', part: "from-date" }, fromStr), h("span", { key: 'ef2e6f5567d4a9ee265c7d0e330bff367642d794', part: "separator", "aria-hidden": "true" }, h("svg", { key: '9a7b81adb38dd0fd324a2e2d43470a25fe2f0827', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: '72c1c544cdbb289eba8cfe57413ba958d58938e6', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: '7f92b7635a80f0dc5dde497ccf8d910c64d1771e', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: '12104e29f4fce9e92f1bf8bd373a5d196ed38b30', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
};
