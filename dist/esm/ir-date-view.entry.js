...
const IrDateView = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0ad9b666c3737c117ad173ca12254f3586fd04ec' }, h("span", { key: '684d9eaf18b9d096bf041f0b5eaf2cfeab829dc9', part: "base" }, h("span", { key: '2bf1cf4f2760f9b2a762d07b505677ba5631c930', part: "from-date" }, fromStr), h("span", { key: '8aee0c7348dc8e1b807199c6930004cde4c41c6d', part: "separator", "aria-hidden": "true" }, h("svg", { key: '88295223e99fb446df718c423116311f706c3f7d', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: '03d79aa8ef031b838e266d7138bac3ec209e8606', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: 'eba10e2b3c5218738e274d52a622bde6ff97be03', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: '7d047498bf77262437f71d2abce9df6b63267a43', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
};
