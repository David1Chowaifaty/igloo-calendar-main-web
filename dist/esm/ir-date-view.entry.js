...
import { c as calculateDaysBetweenDates } from './booking-78fff52e.js';
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '1ac1c9cacabc40db94d93e6571a6dc2f2c85b171', class: "d-flex align-items-center" }, h("span", { key: '21a208251a08a5ebf9c4674ba8e8b87ff3204f5e' }, this.dates.from_date), ' ', h("svg", { key: '8ecc976e9559330f20b789ead1cab3b279345131', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: 'db7888974b988e4ed57036c1e98566c88d907987', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '410484c2daa3acd6c185aebb27aee959169bf7fc' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
