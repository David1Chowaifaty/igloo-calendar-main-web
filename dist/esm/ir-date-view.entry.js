...
const IrDateView = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'af744708c504775b1951d316b029e83e87c0664b' }, h("span", { key: 'ce408f30d693e3b527750ebf0d64f22c71e96c07', part: "base" }, h("span", { key: '3601a7aad609cd1132188832f7eac78fd000f8d6', part: "from-date" }, fromStr), h("span", { key: '6f561099a5805cd2118d451148740f454fc6c209', part: "separator", "aria-hidden": "true" }, h("svg", { key: '8efd4e0860e73f4c929fa91478c3a082e720f39c', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: '2c32d104a886985148951d5ed45c3b099573d0fc', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: '3eecdccc4b506fb137411e084b65eccaed8690ef', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: '33b2cb3376ece3233553189974701a4e7818760a', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
};
