...
import { k as calculateDaysBetweenDates } from './booking-ikf9VeHu.js';
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: 'c578bc610c5b2c7c1b005be78afc07807d7951c8', class: "d-flex align-items-center" }, h("span", { key: 'c8c1324d07fcb516c5171b83027b974685f6374d' }, this.dates.from_date), ' ', h("svg", { key: '072981ab4e44372b15a67adde6a6a7ebab47804d', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '58435830467f5b11c3eaad09973a0f77d999f3d3', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '5a5a3cf11aedcb0f419a2f51b51be48da00feaaf' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '22aff9e4ef82bbbf7d08bb59232293fb53784c99', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
