...
const IrDateView = class {
    ...
    render() {
        ...
        return (h(Host, { key: '3e8fbd7d3b8fa535232e9328df042ab46358aedb' }, h("span", { key: '1debcccd040d0bd33b5696d3a03db64682171638', part: "base" }, h("span", { key: '77e7ac22a2bba460f139cff3ce68b7654745efe7', part: "from-date" }, fromStr), h("span", { key: '16abd4490c1b68ceff48ab5a8379d7150555d4f5', part: "separator", "aria-hidden": "true" }, h("svg", { key: '8ac2dfb854ee26946eb2524f96ccb215d31b2b28', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: '5670a29664d5481b56c50e09930338a362f9c5d2', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: '89687a3c71f00c523c13432816b037f7f14a9783', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: '2bfb0dd487f8bf0b4182881a4fd2335bb7fd5a06', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
};
