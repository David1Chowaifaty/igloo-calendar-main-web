...
const IrDateRangeFilter = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd92b5364808ba44c7e9531dda49a7087ef8afe31' }, this.label && (h("label", { key: 'baa6b0d482326e883b6d6553019ff2e7cc553d55', id: `${this.groupId}-label`, class: "drf-label", part: "label", htmlFor: `${this.groupId}-from-btn` }, this.label)), h("div", { key: '782fe6075ee9a282ee53978dc0f3860c7564a3ab', part: "container", class: "drf-container", role: "group", "aria-labelledby": `${this.groupId}-label` }, !this.label && (h("span", { key: '13f539392eeccc480f52e32063b882341c06a787', id: `${this.groupId}-label`, class: "sr-only" }, "Date range selector")), h("div", { key: '4402483dc861b0a649fd43d9abc804dedea8e8a8', part: "field field-from", class: "drf-field" }, h("button", { key: '8195a16bf42ffc3de90e0e9cb44f03ca6e08e724', id: `${this.groupId}-from-btn`, type: "button", part: "text-btn", class: `drf-text-btn${!fromLabel ? ' drf-text-btn--placeholder' : ''}`, onClick: () => this.fromDateSelectRef?.show(), "aria-haspopup": "dialog", "aria-label": fromLabel ? `Start date: ${fromLabel}` : 'Select start date' }, fromLabel ?? 'From'), fromLabel && this.withClear && (h("button", { key: '16de77f2e364b1fb8cc1c003b35ffb30d53b13c3', type: "button", part: "clear-btn", class: "drf-clear-btn", onClick: () => this.clearDate('from'), "aria-label": "Clear start date" }, h("wa-icon", { key: 'e9a9f2cb598415d2e136147cf0e839af1c0ea340', name: "xmark" }))), h("ir-date-select", { key: '002e32c5ba8263e290141414913db8dfc3984aea', ref: el => (this.fromDateSelectRef = el), exportparts: EXPORT_PARTS.from, date: this.dates.from?.format('YYYY-MM-DD') || null, placeholder: "From", minDate: this.minDate, maxDate: this.maxDate, emitEmptyDate: true, class: "drf-date-select", onDateChanged: evt => this.selectDate(evt.detail.start, 'from') }, h("button", { key: '7b9a30db7ed0f33c8e8518c3ee062e93e67299d8', slot: "trigger", type: "button", part: "cal-trigger", class: "drf-cal-trigger", "aria-label": "Open start date calendar" }, h("wa-icon", { key: '710f8a7630480ad2ab299281fc332fbcf0103d80', name: "calendar", variant: "regular" })), this.showQuickActions && (h("div", { key: '89c6886fa4f344154224f17323d0736f2ccae832', part: "quick-actions", class: "drf-quick-actions", role: "group", "aria-label": "Quick start date options" }, this.quickDates.map(action => (h("ir-custom-button", { type: "button", variant: "neutral", appearance: "outlined", disabled: this.dates?.to?.isSameOrBefore(action.getDate(), 'date'), "aria-label": `Set start date to ${action.label}`, onClickHandler: () => {
                this.selectDate(action.getDate(), 'from');
                this.fromDateSelectRef?.hide();
            } }, action.label))))))), h("span", { key: '6d6e2ee1a775c12d4730371572a90f5708c4a448', part: "divider", class: "drf-divider", "aria-hidden": "true" }), h("div", { key: '47d8f64b26794545b010cfe3456cf4e32edf46f0', part: "field field-to", class: "drf-field" }, h("button", { key: '642acb66aa5f9f5ad10a2fc304c3509fb0ac9238', type: "button", part: "text-btn", class: `drf-text-btn${!toLabel ? ' drf-text-btn--placeholder' : ''}`, onClick: () => this.toDateSelectRef?.show(), "aria-haspopup": "dialog", "aria-label": toLabel ? `End date: ${toLabel}` : 'Select end date' }, toLabel ?? 'To'), toLabel && this.withClear && (h("button", { key: 'd0dd7660dfd4ac438e1a6294dced86bbf37d4653', type: "button", part: "clear-btn", class: "drf-clear-btn", onClick: () => this.clearDate('to'), "aria-label": "Clear end date" }, h("wa-icon", { key: 'c043e3cf72350e910631da46234afa452ab02635', name: "xmark" }))), h("ir-date-select", { key: '8910eea412eb1b30d20fcbe6c8c5543ba7afddf5', ref: el => (this.toDateSelectRef = el), exportparts: EXPORT_PARTS.to, date: this.dates.to?.format('YYYY-MM-DD') || null, placeholder: "To", minDate: toMinDate, maxDate: this.maxDate, emitEmptyDate: true, class: "drf-date-select", onDateChanged: evt => this.selectDate(evt.detail.start, 'to') }, h("button", { key: '61160de5fd3913030dba7e2ae0d5faade0ef570a', slot: "trigger", type: "button", part: "cal-trigger", class: "drf-cal-trigger", "aria-label": "Open end date calendar" }, h("wa-icon", { key: '840d95c65d961a48ee619313afe96df39c284b89', name: "calendar", variant: "regular" })), this.showQuickActions && (h("div", { key: '5d3079e28303f8b5c8bc66269f3585421a6c6767', part: "quick-actions", class: "drf-quick-actions", role: "group", "aria-label": "Quick end date options" }, this.quickDates.map(action => (h("ir-custom-button", { type: "button", variant: "neutral", appearance: "outlined", "aria-label": `Set end date to ${action.label}`, disabled: this.quickDatesMode === 'range' ? false : this.dates?.from?.isSameOrAfter(action.getDate(), 'date'), onClickHandler: () => {
            ...
            } }, action.label))))))), h("span", { key: '399c263d0d4a16401143868b2a82cbe4c0f748f4', "aria-live": "polite", "aria-atomic": "true", class: "sr-only" }, this.liveMessage))));
    }
