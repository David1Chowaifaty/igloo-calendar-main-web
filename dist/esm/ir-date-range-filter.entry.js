...
const IrDateRangeFilter = class {
    ...
    defaultQuickDates() {
        const daysAgo = (n) => ({
            ...
            getDate: () => hooks().subtract(n, 'days'),
        });
        return [
            { label: t('Lcz_Today', { fallback: 'Today' }), getDate: () => hooks() },
            daysAgo(30),
            daysAgo(60),
            daysAgo(90),
            { label: t('Lcz_YearAgo', { fallback: '1 Year Ago', params: [1] }), getDate: () => hooks().subtract(1, 'year') },
        ];
    }
