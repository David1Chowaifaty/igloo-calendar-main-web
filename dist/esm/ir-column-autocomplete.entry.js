...
const IrColumnAutocomplete = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6e4c085f95341197c1e0db08c0d6979c8d2f4041' }, h("wa-popover", { key: '858903480d3e186f8ca25244afe616f12cbe5980', placement: "bottom", for: this.generatedTriggerId, class: "column-autocomplete__popover" }, h("div", { key: '8131c7a34748094b565f33507bf6490b97f89a7e', class: "column-autocomplete__input-container" }, h("wa-input", { key: 'b55657bcd600846432f811136672d702ad3ca16a', size: "s", value: this.query, placeholder: this.placeholder, oninput: this.onQueryInput })), h("div", { key: '4cb786f957083500b5366ec8c1b1d0c2d7bba3f5', class: "column-autocomplete__list" }, this.showSelectAll && (h("wa-checkbox", { key: '9bc2a26a7d0362b552eef363a3f4966b3afb8a50', checked: this.areAllFilteredSelected, indeterminate: this.areSomeFilteredSelected, onchange: this.onToggleAll }, this.selectAllLabel)), filteredOptions.length > 0 ? (filteredOptions.map(option => (h("wa-checkbox", { checked: this.selected.includes(option), onchange: event => this.onToggleOption(event, option) }, option)))) : (h("div", { class: "column-autocomplete__empty" }, this.emptyLabel)))), h("div", { key: '16a47e00704cfba54f2c6ba3ddf94ebdec953ad8', id: this.generatedTriggerId }, h("slot", { key: 'f3d14d3bc00572659666b2ded3a7da5951fd20f2', name: "trigger" }, h("wa-button", { key: '2f3abb241d2dcdeceba1b98570fe30c773b587ba', size: "s", variant: "neutral", appearance: "plain", class: "header-button" }, h("wa-icon", { key: 'fa46f5864bfc9d2c00152882acb5b568eb34f7a6', name: "filter" }))))));
    }
