...
import { R as RoomService } from './room.service-90a4ef46.js';
...
import { C as CONSTANTS, U as UserService } from './user.service-fc4453d9.js';
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '79a677e8c98d843802549e310f3595c5f30209c2', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '89d2fa353ed0fe218deb2daa541b5ead4c5fa4cf', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'b93f4ea7e51eb4d59d9e6c50e7ec930110f6f53b', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'e95255d1c1ecae77eefd2005293b981acf945556', class: `ir-alert-header` }, h("p", { key: '8dab087e9480aaa3305685785978528c2ec0de03' }, this.modalTitle))), h("div", { key: '22f8234dc53d0922fbd0082a556280f85884e1a7', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'ecebd3e6cff78b14fd52afa11a49abde996539c9' }, this.modalBody)), h("div", { key: '6ba960497980c578370f75b17b2a708b47876d08', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (h("ir-button", { key: '1cc693d845970c99d58a37e2f0c626385a2f701d', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (h("ir-button", { key: 'a4d8bce98f1839bd698800cba65ffea8d310d4d6', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: '1bd59f7d662ec640b7783df3d0bb0cf3a16f5fa3', class: "otp-input-container" }, h("div", { key: '2d93459c029bf6ba6833517532e88ec0cdab1d63', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPasswordValidator = class {
    ...
    render() {
        return (h("div", { key: 'cb1a64e894e2d41a49b9903caf8b85f95b08f139', class: "m-0 p-0" }, h("requirement-check", { key: '66240f2b40d01439d03eef1264f733570868ab1a', isValid: this.validLength, text: "Minimum 8 characters" }), h("requirement-check", { key: 'f39c14b4271e52200a896444dbac4f9487d40a28', isValid: this.hasUppercase, text: "At least one uppercase letter" }), h("requirement-check", { key: '1f0b15ea6b1fc9b03439038c424566f6c376ec0e', isValid: this.hasLowercase, text: "At least one lowercase letter" }), h("requirement-check", { key: 'd63d90ef34d3cb63ac2932865ff7aad49102efb4', isValid: this.hasDigit, text: "At least one digit" }), h("requirement-check", { key: 'c1f5a6d9b311130549a80746eca8a9bf9cc695f2', isValid: this.hasSpecialChar, text: "At least one special character" })));
    }
    static get watchers() { return {
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (h("div", { key: '5ab7efe43cbca38506ff391e7730135175ce2205', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, h("label", { key: '49773a0359896b503665baa40af3e2d3b5a6329d', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (h("div", { key: '93be277b8c3b87ca4e5a7bf346a5f8e14f710d46', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '3e3c95059bea3398dd5ff5ec4800d92c8920cb7d', class: "input-group row m-0" }, label, h("select", { key: '1a12b54c4fbe768474ba4bac298dd84ed73f31ee', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '803db2eff10d51fd8fc4a4234209578e4c7b571c', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '1f7dfb288128f20bafb506964ce295575f81124c', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '8e47202a43711105c7028bf3c43cd0c06916902e', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '857a34277a3bf97c325bfa14d338dd37d4a6f9e9', class: 'sidebar-title' }, h("p", { key: 'db61fe0c4e4316129d056eabe3414d67dce2fa53', class: 'p-0 m-0' }, this.label), h("div", { key: '11905e73de82db3cc61c79846d051513d4baffa9', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '0efcd5d666a32a0cdf9fbf8c046b71096f50d791', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'd9d23563dd4163c0cb2c08904a2f8de27b07a946', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: 'a4bf5a074982be121fd12fc62b52b779fd8553ff', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '2685b15e6dec81fcb3a59242634500f57c28f609', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '2ffeae54968f6df598d2b37161da4f05e89f1f68' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: 'b333f3f12f18f87e868a3d1b77f6f66d27e17816' });
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (h("form", { key: 'e4ad500123f24802d472f4545ffb55fa5c92d7bc', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, h("ir-title", { key: '89619eeaf0c0cb010a8b97c9d9e229b85894b286', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), h("section", { key: '4aa337f777d2e334e7e50ad04f2da6178581b305', class: "px-1 sheet-body" }, h("ir-input-text", { key: 'e0a84944a29fc1c9aa4aab1a4fd7474b01a7eaaa', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), h("ir-input-text", { key: 'c698bdbcfe43904cf88f4d49da5d88fa03bcd621', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: locales.entries.Lcz_Mobile, mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (h("div", { class: "mb-1" }, h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), firstOption: locales.entries.Lcz_Select, selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (h(Fragment, { key: '7ffdc162f3bd0b88234e3589a8f45df55756810a' }, h("input", { key: '3ca00a203ab7c243b87c620f1cb2e7a29809c18e', type: "text", name: "dummy", style: { display: 'none' } }), h("ir-input-text", { key: '1c57ee40da6dfb92a0309c2b597ef11326796bfb', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: locales.entries.Lcz_Username, disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username,
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, h("h4", { class: "m-0 p-0 logins-history-title" }, locales.entries.Lcz_Password), h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: locales.entries.Lcz_ChangePassword, btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (h("section", { key: '004056eee3cb25260d5fa929d00914f2246656e9', class: "logins-history-section mt-2" }, h("div", { key: '8d424927292d77751357fb2c0bcd77687282241c', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: 'e99804c39c880a1f0adfe44836444722d40d6b2d', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: 'e706bd313f302196e55d87aa5f2d0a9b74bc0b45', btn_styles: 'pr-0', text: !this.showFullHistory ? locales.entries.Lcz_ViewAll : locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: '201e3d973467c020180efd9c0cb0adb4b4ea3d04', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), h("ir-sidebar", { key: '706d1b4004b693bb87212578e9fe4ca15fecbd08', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: '963e23372fa76cc4b2f397e5aa08f5c9058f3775', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), h("div", { key: '4832f32ebaf9a255d6a46815156c274b4e7509bb', class: "sheet-footer" }, h("ir-button", { key: 'a9075243091d3853d3b9302594b830380bd11331', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: 'c6dbf699a25c4dec38cce7635493010124537d6c', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales.entries.Lcz_Save }))));
    }
};
...
const RequirementCheck = class {
    ...
    render() {
        return (h("div", { key: '8bbd565a7d02721eedd84ed04b51f007514e6aaf', class: { requirement: true, valid: this.isValid } }, h("ir-icons", { key: '8a0d0e5dda6b1c50fe924fb6121779a06ad3ec79', style: { '--icon-size': '0.875rem' }, name: this.isValid ? 'check' : 'xmark' }), h("span", { key: '47118e738dbd564f56907268f48802e35a1590b5' }, this.text)));
    }
};
