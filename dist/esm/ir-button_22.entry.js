...
import { i as interceptor_requests, a as isRequestPending } from './ir-interceptor.store-2beee824.js';
import { T as Token } from './Token-6c389e24.js';
import { R as RoomService } from './room.service-39d12a8c.js';
import { l as locales } from './locales.store-629477c2.js';
import { z, Z as ZodError, h as handleBodyOverflow } from './utils-1892bfa5.js';
import { A as AuthService } from './authenticate.service-b92cac55.js';
import { C as CONSTANTS, U as UserService } from './user.service-b91c2707.js';
...
import { B as BookingService } from './booking.service-3b4a88f7.js';
...
const IrSwitch = class {
    ...
    render() {
        return (h(Host, { key: '8465d1a51a4a9ceba8376421946ba42a415f5614' }, h("button", { key: 'c4cafdffe5a0bb54aa569bea6d79aa80f8d9112b', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, h("span", { key: '78adc202e4025d5221fa44f0c43852b4a1c15c75', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), h("input", { key: 'b039c9c32c2cf8955aa92be20c5300690baa333c', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (h("form", { key: 'e48c66c8cf8729f791926a6b210d43ad662ac80d', class: "sheet-container", onSubmit: async (e) => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, h("h4", { class: "m-0 p-0 logins-history-title" }, locales.entries.Lcz_Password), h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: locales.entries.Lcz_ChangePassword, btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (h("section", { key: 'dfffc7a66e8bdcaa7a9b15a3c0e7f69c529ab767', class: "logins-history-section mt-2" }, h("div", { key: 'd4aea5a2a041cbf11fda52a56fbbc878fa2d793b', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: '67ea974db12936f200db5114822bfa2ca8525d4e', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: 'a47ac024a9e705985b5ca038474a7bbef5c0228c', btn_styles: 'pr-0', text: !this.showFullHistory ? locales.entries.Lcz_ViewAll : locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: 'fb4829e41041ae2414fa858e0ee049015256423d', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), h("ir-sidebar", { key: '9b59385de3f41a6f2ecdc5c867e8f19ad4b175ba', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: 'd9aaeb3564c5a703229d5347916b49c75add7fa9', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), h("div", { key: '93114ca70cd6d7cefe14982d1bba4a714939832b', class: "sheet-footer" }, h("ir-button", { key: '09578a50deaf21e8851239f3d34dd4a1bed3d171', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: '08bc785f1b75930a358cf357ff9e3df3c9a0aa95', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6dce9b8e0f1acce13f5978b0402229ca68d72b14' }, h("section", { key: '2222c7be9f61fc47c3b0ef27fc7b596b9515568c', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, h("table", { key: '3ad9a9654d666abf76b6a050545d3b2384c4f2fd', class: "table" }, h("thead", { key: '68ba2217b724ace0d9cc13984e723f8e982d5fb9' }, h("tr", { key: '9c1f9e70bdcee9983574929552a46207f607ac4b' }, h("th", { key: '31856182f98ab623d2d99bfb2384e3462c385aed', class: "text-left" }, (_a = locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), h("th", { key: 'fd3ff90bd09012ffbe7a52eb1b1ad528554c01d2', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: 'c7c5944060cd648143389557d054d3f91168e0c9', class: "text-left" }, (_b = locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), h("th", { key: '19e509455a20153e550c542cb5883c4a5c45e7db', class: "text-left" }, locales.entries.Lcz_Role), h("th", { key: 'f00c283d598fc39b298b62325fd858e057f6b415', class: "text-left small", style: { fontWeight: 'bold' } }, h("p", { key: '4fda329884eb0e57895f8699d2f75841e76cd666', class: "m-0 p-0 " }, locales.entries.Lcz_CreatedAt), h("p", { key: '4a4ff9b7cf7286b28119a2c77ab21982ed67813c', class: "m-0 p-0" }, locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && h("th", { key: '32baf25457d131bfd2c83e6551ed4002cfc086e0' }, locales.entries.Lcz_Active), h("th", { key: 'fc325a3cec1a337f5852f5ae6cb303f78adc8cab', class: 'action-row' }, this.canCreate && (h("ir-icon", { key: '8a8269f3be37121ff5f998e89f648867d6b0263c', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, h("svg", { key: 'ae51e76ae16ad21fa32cee7b39913c25cd490eea', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: '4b9ec7329c4f6a0c3b0a7e185958575d1f5de29a', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), h("tbody", { key: 'dc9305443b48062ed4b1a534e70c6485e3dcbe22' }, this.users.map(user => {
            var _a;
        ...
        })))), h("ir-sidebar", { key: 'bef575eeea86986f991f46e3d221838b98861319', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), h("ir-modal", { key: 'c5a36f0f8081e7b832b9b5ddcb59ecf3330b1e33', autoClose: false, modalBody: this.modalType === 'delete'
...
export { IrButton as ir_button, IrCommon as ir_common, IrIcon as ir_icon, IrIcons as ir_icons, IrInputText as ir_input_text, IrInterceptor as ir_interceptor, IrLoadingScreen as ir_loading_screen, IrModal as ir_modal, IrOtp as ir_otp, IrOtpModal as ir_otp_modal, IrPasswordValidator as ir_password_validator, IrResetPassword as ir_reset_password, IrSelect as ir_select, IrSidebar as ir_sidebar, IrSpinner as ir_spinner, IrSwitch as ir_switch, IrTitle as ir_title, IrToast as ir_toast, IrUserFormPanel as ir_user_form_panel, IrUserManagement as ir_user_management, IrUserManagementTable as ir_user_management_table, RequirementCheck as requirement_check };

//# sourceMappingURL=ir-button_22.entry.js.map