...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (h("div", { key: 'a3faf8e7a7beda7456459c0437672ddebc09db89', class: "summary-row" }, h("ir-metric-card", { key: '1966681bcb2f45a9917acd5c5f27beec055ca599', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? totalNights - lastYearNights : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), h("ir-metric-card", { key: '0be1a7a81b36aa96c45463b3e5befc4ff954e772', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: formatAmount(currency, totalRevenue), trend: hasLastYear ? totalRevenue - lastYearRevenue : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${formatAmount(currency, lastYearRevenue)}` : undefined }), h("ir-metric-card", { key: '62e841855aff0c49135a27ce05779067f9f9aacb', class: "summary-metric", icon: "chart-bar", label: "Channels", value: (this.records?.length ?? 0).toString() })));
    }
};
