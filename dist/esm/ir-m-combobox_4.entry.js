...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (h("div", { key: '3841427f795e64d2ef341441d53b7d68eef3bc97', class: "summary-row" }, h("ir-metric-card", { key: '1eab4beaa0ef8567b318dea7c2e6f509b4a860ea', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? totalNights - lastYearNights : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), h("ir-metric-card", { key: 'be09ee2cd90cbe7ca6e84cca1a38aa6d0f16b09f', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: formatAmount(currency, totalRevenue), trend: hasLastYear ? totalRevenue - lastYearRevenue : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${formatAmount(currency, lastYearRevenue)}` : undefined }), h("ir-metric-card", { key: 'b3a6abdc5b5324b5a6135dad2ad37b928fb6571d', class: "summary-metric", icon: "chart-bar", label: "Channels", value: (this.records?.length ?? 0).toString() })));
    }
};
