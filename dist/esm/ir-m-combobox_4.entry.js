...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (h("div", { key: '8e18f44f05fcd1b9aeb8cf183145bc39b32eed32', class: "summary-row" }, h("ir-metric-card", { key: '0edcac3590b258a5a3c043a892da8547f34bc29d', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? calculateTrend(totalNights, lastYearNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), h("ir-metric-card", { key: '1dabc43fa6d66ec5c5742fd2ef86d2641d788097', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: formatAmount(currency, totalRevenue), trend: hasLastYear ? calculateTrend(totalRevenue, lastYearRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${formatAmount(currency, lastYearRevenue)}` : undefined }), h("ir-metric-card", { key: 'b4b3f215ab58d931b3ae93d9bdf16de435925166', class: "summary-metric", icon: "chart-bar", label: "Sources", value: (this.records?.length ?? 0).toString() })));
    }
};
