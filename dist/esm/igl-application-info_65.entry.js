...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory } from './booking.service-d0c711be.js';
import { l as locales } from './locales.store-53ec3957.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-20e9d53b.js';
import { f as formatAmount, h as hooks, e as extras, a as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, b as getPrivateNote, i as downloadFile, t as toFloat, r as renderTime, j as formatName } from './utils-0cab1b3d.js';
...
import { _ as _formatDate, a as _formatTime, b as _getDay } from './functions-fec54165.js';
...
const IrCheckbox = class {
    ...
    render() {
        return (h(Host, { key: '3ebd2934f603bf3eb31c38070f6390e0d8ec1b26' }, h("button", { key: '3fbd7883a13b1470a0e706edce5b4c73b086bff2', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: '923d0b5de398bc83b8de3a5fa64ff81b3848e627', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '649cc831c561a8d97b618cb354c8453704a264e5', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (h("svg", { key: '45ceeea0ecabdedb6642525abbd0de6494e8656a', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '8fbc1ef8a4a8b8ca5e70f30b62cf44ce5d51a02a', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), h("input", { key: '03fafb5aa913860e2ba09538e58d3d4d54a23d3d', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (h("label", { key: '71747887cd34780e7252509638d6c7efe72c3a0c', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '08ab09b7812e2cbb34a380520a1ee3ee46936e5d', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '2a682baf5b5bbeafa869009795d2156dbe6d0d23', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'df60233f513d18ea1db4434703c0ac60880edf05', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '5a71db597c6e1fe598d09756fb84ac2ba2f1ec9d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '4122681aa4baf425ea32dba38644382f326f3668', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '50cd70cd465e6a57035fc907b96dfd18174e5571', class: `ir-alert-header` }, h("p", { key: 'f8fc7fafa43d553ddbcaa2617c8ded1948be6b76' }, this.modalTitle))), h("div", { key: '1f7d9a0bd758eab13421f620cd99576503b79cdd', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '07a31be6de13b0fc3d9d1c8b9277e000d126ab10' }, this.modalBody)), h("div", { key: '2e503d3c5057cee454d9fa993e87dc60c1a051ab', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: 'dd386faa9f68a9b5f1310e5cc6a2088a7eb8b487', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (h("ir-button", { key: '5fa04ff1995e42305f9051a9f0c469b7937a270e', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: 'bcee53f8e44d0da6587a83c1f168f6231248e4c3', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: 'fddffac2cb06ba3ca770910645e22c0ebe9382da', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: 'e41ab0573273bc74d9ac50f1c5132a76b2f410c9', class: 'sidebar-title' }, h("p", { key: 'bcc26af08dadb5f062c84912c983baa887dde81f', class: 'p-0 m-0' }, this.label), h("div", { key: 'b8c8675c447431bb35f4c20ead8b0d0bbd8826ab', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: 'ac9feb1b85fb3798b0c04f26fa3500758e8cb689', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'f26f7481305c0b6800d9483c3349cd450515ca71', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '3255c49860961e56cf553a969a7258436a7cfac7', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: 'e4e6063eeda16858c9000598a3947821ede72861', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '301c78e9713e0ddee7cba0acc18c2a606af2dd5d' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
