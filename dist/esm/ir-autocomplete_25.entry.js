import { r as registerInstance, c as createEvent, a as getElement, h, H as Host, F as Fragment } from './index-CeHdrJeH.js';
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: '5b7055ba37f440bce27b2b927f4ba72703047e10', "onwa-hide": (e) => this.isOwnEvent(e) && this.handleWaHide(e), "onwa-show": (e) => this.isOwnEvent(e) && this.handleWaShow(e), "onwa-after-hide": (e) => this.isOwnEvent(e) && this.handleWaAfterHide(e), "onwa-after-show": (e) => this.isOwnEvent(e) && this.handleWaAfterShow(e), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'c05b336b68f5347968d6c9d3b477f685381e0119', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '16a52cf1ac6dd6ff4323131c2f254d015e7bbc66', name: "label", slot: "label" }), h("slot", { key: '8e38d1689da716d89a5499d13aa257cddfa7bb83' }), this.slotState.get('footer') && h("slot", { key: '17a90f56c7f2b3c88427a0bdbeb5dee9bd1d4c8a', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrSpinner = class {
    ...
    render() {
        return (h(Host, { key: 'c9a235619204452ed0e264482b452e545b92508b' }, h("wa-spinner", { key: '92d6dec21e52d30274558bdd396632efe9eeeeef', style: { 'fontSize': '2rem', '--track-width': '3px' } })));
    }
    static get watchers() { return {
        "size": [{
...
export { IrAutocomplete as ir_autocomplete, IrAutocompleteOption as ir_autocomplete_option, IrCommon as ir_common, IrCustomButton as ir_custom_button, IrDialog as ir_dialog, IrDrawer as ir_drawer, IrEmptyState as ir_empty_state, IrInput as ir_input, IrInterceptor as ir_interceptor, IrOtp as ir_otp, IrOtpModal as ir_otp_modal, IrPage as ir_page, IrSpinner as ir_spinner, IrToast as ir_toast, IrToastItem as ir_toast_item, IrToastProvider as ir_toast_provider, IrTranslationsEntriesPanel as ir_translations_entries_panel, IrTranslationsEntriesTable as ir_translations_entries_table, IrTranslationsEntryDrawer as ir_translations_entry_drawer, IrTranslationsEntryForm as ir_translations_entry_form, IrTranslationsManager as ir_translations_manager, IrTranslationsMoveDialog as ir_translations_move_dialog, IrTranslationsSettingsDialog as ir_translations_settings_dialog, IrTranslationsTableDialog as ir_translations_table_dialog, IrTranslationsTableForm as ir_translations_table_form };
