...
const IrUserManagementTable = class {
    ...
    render() {
        return (h(Host, { key: '95437377992327db5b9e1922fb5806f92cac0d11' }, h("section", { key: 'd1e6c3ab757546c37271e159b59096b1b228fb1d', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, h("table", { key: '7f026bcc76a9045125e940c2fd59e38e317b4d3f', class: "table" }, h("thead", { key: 'a1a04621893637ed8c7001b54fcfe972bc5016a7' }, h("tr", { key: '7e529bb32d86d89668c267666ee29a509f0723ed' }, h("th", { key: '9c150534b6092e3a8e5d55cba0ed88d970681cef', class: "text-left" }, locales.entries.Lcz_Username ?? 'Username'), h("th", { key: '0762876480db5bd41ed2cd0c19ee5631b32fa46b', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: '76992c68cb549693f6db4785754d80dd277f31a4', class: "text-left" }, locales.entries.Lcz_Mobile ?? 'Mobile'), h("th", { key: '42fc08653327ed5799a373568ad1ab0c3b89d585', class: "text-left" }, locales.entries.Lcz_Role), h("th", { key: '562a6da16a9155691b4353ef7fea38fcb8c00b6d', class: "text-left small", style: { fontWeight: 'bold' } }, h("p", { key: 'cfcdbf28ae73376436b8277e9912b0744bca2c75', class: "m-0 p-0 " }, locales.entries.Lcz_CreatedAt), h("p", { key: '992351ece5ad6e29d2a4184c8e67d1dba17cf75d', class: "m-0 p-0" }, locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && h("th", { key: '4a1bd5e938a394f918706787fc75ac5b5ac6cb7d' }, locales.entries.Lcz_Active), h("th", { key: 'a5e13c61cbb97e8f7610c0ae6f1d220b14b473cf', class: 'action-row' }, this.canCreate && (h("ir-icon", { key: '1585d4caa1ac6502c19ae1dc5368c5a69928300d', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, h("svg", { key: '1d22956cd7c4007e20b308bc1fc0c191f8901f39', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: '3dc57f1ca7a2d1cd578b94061184c7d7f8513dd7', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), h("tbody", { key: '05ecae086adde5bb7130d287a350218f8e0aa79f' }, this.users.map(user => {
        ...
        })))), h("ir-sidebar", { key: '92e126ac25571c1bdf95870c5e2512b1a46a9ada', open: this.currentTrigger !== null && this.currentTrigger?.type !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
                '--sidebar-width': this.currentTrigger ? (this.currentTrigger?.type === 'unassigned_units' ? 'max-content' : '40rem') : 'max-content',
            } }, this.renderCurrentTrigger()), h("ir-modal", { key: 'c4d1a1113fce333f496bbeb05a8bffc88c77a6ab', autoClose: false, modalBody: this.modalType === 'delete'
