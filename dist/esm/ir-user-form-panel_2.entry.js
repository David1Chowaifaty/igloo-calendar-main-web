...
const IrUserManagementTable = class {
    ...
    render() {
        return (h(Host, { key: '9d67143de2fac2fe47cde2ee5eef154d98db71d1' }, h("section", { key: '5f82258d6307cec64032fced9e64e5c572cb830c', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, h("table", { key: '02df97553a48a8fa237b03eca88f16e9bcefd2c8', class: "table" }, h("thead", { key: 'a9188ae8265cc14c5949fbbb2406290363174829' }, h("tr", { key: '131b9a4b235a744913308011aad0840031105f07' }, h("th", { key: '7010a9733912a4aeb7f2a4ba6a82180b333849d6', class: "text-left" }, locales.entries.Lcz_Username ?? 'Username'), h("th", { key: '9f7ef195fcec037322d8157428ac4c4adbc59a2a', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: '307486a5e895b8bcdcf53a374b918a11c113445f', class: "text-left" }, locales.entries.Lcz_Mobile ?? 'Mobile'), h("th", { key: 'ea6813dfa13a2d273c055bfc1350a86d04383769', class: "text-left" }, locales.entries.Lcz_Role), h("th", { key: '367a507fe9a3977cc31b910fddda41eba3499f8d', class: "text-left small", style: { fontWeight: 'bold' } }, h("p", { key: 'f40c340cf1ef4d2d3674dc1c4a441c7132e9d463', class: "m-0 p-0 " }, locales.entries.Lcz_CreatedAt), h("p", { key: 'f4381e80e89a0b1e814cac4e2a8eef97f7075162', class: "m-0 p-0" }, locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && h("th", { key: 'f54fe4f420042dad1e10d77b2ad1a01da947e8e7' }, locales.entries.Lcz_Active), h("th", { key: '2c8f499b98426f689e403642c10e306b5605daeb', class: 'action-row' }, this.canCreate && (h("ir-icon", { key: 'bbcbef0ed05aad96ed0adada257d52b49339169b', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, h("svg", { key: '4e7a2357d490e823d8495877a8cd009b9768eb5a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: '114b27fe15b525c69a487882493cc67b7d824d81', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), h("tbody", { key: '48ae87ed2dc13d4bab44252b0d45e1b800f1e133' }, this.users.map(user => {
        ...
        })))), h("ir-sidebar", { key: 'a95491e8c1b20dfdf86c04259ebc2242f3666ec2', open: this.currentTrigger !== null && this.currentTrigger?.type !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
                '--sidebar-width': this.currentTrigger ? (this.currentTrigger?.type === 'unassigned_units' ? 'max-content' : '40rem') : 'max-content',
            } }, this.renderCurrentTrigger()), h("ir-modal", { key: '41ae5e59e0706c38b1e427cd97225156085b66d9', autoClose: false, modalBody: this.modalType === 'delete'
