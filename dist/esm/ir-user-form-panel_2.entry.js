...
const IrUserFormPanel = class {
    ...
    render() {
        return (h("form", { key: '942c1e12b0ea76285c88d1026f9da3911daf7551', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, h("ir-title", { key: '6c6a2c806811ea08325250ee1db0da7d9dd39af7', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), h("section", { key: '934a6341d0bb6183a678dd434fffa7129ba1c01a', class: "px-1 sheet-body" }, h("ir-input-text", { key: '83b4d93aa2d6c2abdde43746265d01532a77714c', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: this.errors?.email, label: locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), h("ir-input-text", { key: 'c265d0648f4564fcf0fbc526cc073de3d3e1d9e7', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: this.errors?.mobile, asyncParse: true, autoValidate: this.user ? (this.userInfo?.mobile !== this.user.mobile ? true : false) : this.autoValidate, label: locales.entries.Lcz_Mobile, mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && this.user?.type?.toString() === this.superAdminId) || this.isPropertyAdmin ? null : (h("div", { class: "mb-1" }, h("ir-select", { testId: "user_type", error: this.errors?.type && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), firstOption: locales.entries.Lcz_Select, selectedValue: this.userInfo.type?.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), this.user?.type?.toString() !== '5' && (h(Fragment, { key: '796198903ebbe0f6cdd88d87750abeee5dac3653' }, h("input", { key: '03bbf96f394aa16550ad90d5adaa7b0fae874766', type: "text", name: "dummy", style: { display: 'none' } }), h("ir-input-text", { key: '6a5b04f928c9be11b5cd061996e511a5b2979a80', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: this.errors?.username, label: locales.entries.Lcz_Username, disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username,
        ...
        // ))
        ), this.user?.sign_ins?.length > 0 && (h("section", { key: '9671933428b8701e9cd65bbef64d742aac8668be', class: "logins-history-section mt-2" }, h("div", { key: '15259909e7137df59724f444f784820204f85ebf', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: '73485f9c5c38006cd4e56c34660710d80fc736ea', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: '0f0f6571b3dfa4e264e29b257129e1a15614748f', btn_styles: 'pr-0', text: !this.showFullHistory ? locales.entries.Lcz_ViewAll : locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: '97e705f8eb8c0e453f068c6767fa7b54cd921763', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
        ...
        })))), h("ir-sidebar", { key: '772c20db00f721f97b2db02150147eaf8a4521a0', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: 'f2082fa7c659f71acb5601119c327ffc81d50507', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), h("div", { key: 'cbb8d2f0b30783f052adcf2ba72558150a799796', class: "sheet-footer" }, h("ir-button", { key: '37c076176ab39b8528fd940287d511e88e65bc8e', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: '5a2763b526750460a54f4df2f8551ed12e944030', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        return (h(Host, { key: '33140823418ad668a10bf16efafa85da3af46985' }, h("section", { key: '5c67875eca4f8340bdebc238df35bbcb4292cd36', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, h("table", { key: '06f52b5ceedc209877bd1d8ca12701c0bd71543a', class: "table" }, h("thead", { key: '2b98f97a98a095249acd751bc08362a7a683755b' }, h("tr", { key: '2ed57515ec7804884a24578b080290250fa8a93c' }, h("th", { key: '2d0e79959411eaa586f06b77e82bb3f2d3c381af', class: "text-left" }, locales.entries.Lcz_Username ?? 'Username'), h("th", { key: '3e49475dfac917d3efbe36dfe9adecd2878390e4', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: '8d0e431b602cb39054d6b25bbb7260d672cfd60c', class: "text-left" }, locales.entries.Lcz_Mobile ?? 'Mobile'), h("th", { key: 'b4e493350a6fb0042b05eecf88d3353a9b1562b3', class: "text-left" }, locales.entries.Lcz_Role), h("th", { key: 'dfe7f22035646be7b9349683f3d54d319768cd28', class: "text-left small", style: { fontWeight: 'bold' } }, h("p", { key: 'dd92597926a7ad5290cff9e670d9bf49343c8a10', class: "m-0 p-0 " }, locales.entries.Lcz_CreatedAt), h("p", { key: 'dcf0f516d247e5f041fd256beb12399b5ff60034', class: "m-0 p-0" }, locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && h("th", { key: '26ae39a346584d7bc75588572c9a4ff53a8e061e' }, locales.entries.Lcz_Active), h("th", { key: '37c4866e24df35197e539a250269a6dc155329ef', class: 'action-row' }, this.canCreate && (h("ir-icon", { key: '57ea412c3e27b9268808df385682408942264ab2', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, h("svg", { key: '1c5358a08971badc937535b1d4cdf31c9a5498fe', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: 'a0f805218dbfe0d0d6321d69f9072b37e06442e6', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), h("tbody", { key: '9e1d9511e6b949c43c865e37666c0055a854fd74' }, this.users.map(user => {
        ...
        })))), h("ir-sidebar", { key: '76ad01f0bd092a6d1f33522c1fad3a651892cf58', open: this.currentTrigger !== null && this.currentTrigger?.type !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
                '--sidebar-width': this.currentTrigger ? (this.currentTrigger?.type === 'unassigned_units' ? 'max-content' : '40rem') : 'max-content',
            } }, this.renderCurrentTrigger()), h("ir-modal", { key: '0e593375423f8b663f6315965bb1e9daebaa4f49', autoClose: false, modalBody: this.modalType === 'delete'
