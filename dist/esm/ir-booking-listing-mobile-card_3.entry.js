...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-CvdZb-NI.js';
import { a as getPrivateNote } from './booking-CjSwSZrx.js';
import { l as locales } from './locales.store-ChFOK43k.js';
import { h as isPrivilegedUser, g as downloadFile } from './utils-Bso6iV7-.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8df795f438edcb15290d0f4bd18afadc8e4606e9' }, h("section", { key: 'e478ad6b9d65ce9fb6339cd06cd69e4084cbff7f', class: "d-flex align-items-center " }, h("div", { key: 'fc75cc09e81809476f8af52a45fee5fcc8b39ca8', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, h("div", { key: 'c3c2322c954d863b4fd982da43e2ad30a49d892e', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, h("h3", { key: 'b55d57eabcabba5744eeeb4bd56db1081d2215a6', class: "page-title" }, locales.entries?.Lcz_Bookings)), h("h3", { key: '0c648d9130fa8ac3550ef5174604edad38f3723f', class: "d-none d-md-block page-title" }, locales.entries?.Lcz_Bookings))), h("section", { key: '5008dc4f31419b4ca24024c17ac975963bbd67af', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '3c90947c7f26c5d25d7ae6d17ab5c1e01399b694', onchange: e => {
                updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing.userSelection.filter_type?.toString(), size: "s", defaultValue: booking_listing?.types[0]?.id?.toString() }, booking_listing?.types.map(b => (h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), h("ir-date-range-filter", { key: '8ebfb1e1f4a5d748c4284a6b90d22cc5bbb3ac7d', class: "filters-bar__date_picker", showQuickActions: false, fromDate: booking_listing.userSelection.from, toDate: booking_listing.userSelection.to, withClear: false, selectionMode: "auto", onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("wa-select", { key: 'e80973b16f3fd0301868149dd045eb7713f009f9', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: '1fc943eea45a23f2d2767d5ed3a7c55ce9fd7b7d', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: '381c510fb3d0c16163501d088ae03965334db0af', value: "" }, "All channels"), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: '46920531aacdbea8c27ea5346325a027d6f65367', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: '74f184f6d976b86792967cf4c6da17f33800cdde', class: "d-flex flex-fill align-items-end m-0" }, h("wa-tooltip", { key: '5d1f77358f0966da2b2d5ba76c8e98bc7a2be7b7', for: "search-btn" }, locales.entries?.Lcz_Search), h("ir-custom-button", { key: '506d3444cd97388bc54c95eef8d388dc83269a75', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, h("wa-icon", { key: 'ad82d3240eeafb2be27c86f97dfc7e98fdf7f0c9', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: 'f0d9a868f7e062e4cd08e4a46ec383ae3812c82e', for: "clear-btn" }, locales.entries?.Lcz_Erase), h("ir-custom-button", { key: '87e8b855ea74077f5b0a12b2be37848471e91b85', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: '3430494b4e3a2ab99e86f9410f19d95af15a1d5f', name: "eraser", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: '6b2044c349672c665cae22fb2fc7cbfead72710c', for: "excel-btn" }, locales.entries?.Lcz_ExportToExcel), h("ir-custom-button", { key: 'b9edf643f5877403f1b6bd85910a4b2a3ec71048', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: 'e6ece60fb670272a3f731020567d6295cb966328', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
