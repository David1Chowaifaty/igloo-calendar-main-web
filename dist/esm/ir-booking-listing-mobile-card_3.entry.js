...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-DqZXATLs.js';
import { a as getPrivateNote } from './booking-887zeuHr.js';
import { t } from './t-Bk78Wumj.js';
import { g as isPrivilegedUser, f as downloadFile } from './utils-Ddj2LxLs.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '95d8937478327baa4b29176e36c0482259118ee5' }, h("section", { key: '138591168f31e04538fbbaca781ca8b496c62d5b', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '268cf070a1b3fdcaaa306699972ecf88acc79c4d', onchange: e => {
            ...
            } }), h("wa-select", { key: 'e4a572cedc31ee7bb3d8f16a6c84981b67e6a690', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: '9d6a7752eae0d36d40025b7f91d93f0a26d8d3f6', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: 'ccc7142cb7a2c0b4472c46d9401010c7c34f937d', value: "" }, t('Lcz_AllChannels', { fallback: 'All channels' })), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: '3f01ce0f02f72ffb1cfb566214bb49914c3ea6a9', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: 'c11932bdaf05d51e90855240e808807c39924403', class: "d-flex flex-fill align-items-end m-0", style: { gap: '10px' } }, h("wa-tooltip", { key: '68b846b5a658bf5dbdc7d79eca8c11b11fb8e093', for: "search-btn" }, t('Lcz_Search', { fallback: 'Search' })), h("ir-custom-button", { key: '4d8391c4eb7e52b21bee857f0cb2d2c074745b7c', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "outlined" }, h("wa-icon", { key: '03e2ba62f5fa8b5acccc7d0e9f8ccf71d4b1ba05', name: "magnifying-glass" })), h("wa-tooltip", { key: 'f224802a967cfaa84fb20a1385487641c5f30323', for: "clear-btn" }, t('Lcz_Erase')), h("ir-custom-button", { key: '9226eaa3d484aefded9b346a7bb037b91918e260', id: "clear-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: '25938450ecdeb714ee6b5db504e69e05f469a8b4', name: "eraser" })), h("wa-tooltip", { key: '7cd4f3e4740ba689701d02bdb621df1e621ca3a6', for: "excel-btn" }, t('Lcz_ExportToExcel', { fallback: 'Export to excel' })), h("ir-custom-button", { key: '4d858ef16eb7f3519c71e10200734e08a8bc5136', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: 'b55ae41d4a10d67f926d037f6120c4e1019f3437', name: "file-excel", variant: "regular" }))))));
    }
};
