...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-SAbgMZWa.js';
import { a as getPrivateNote } from './booking-UjwC_BPb.js';
import { l as locales } from './locales.store-BOppy8do.js';
import { h as isPrivilegedUser, g as downloadFile } from './utils-Wjp6LFRm.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8712ef93c0702e4ebeb3ac7314146d6a2824e193' }, h("section", { key: 'f6ae9da64947f84ea1b54fc212b8d9f45092dcaf', class: "d-flex align-items-center " }, h("div", { key: 'b72fc48d67f07143358813a6329dc81896b7c192', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, h("div", { key: 'f76b05bcdf2c6a20589a3283a2fc4f2be5ee5667', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, h("h3", { key: 'c6bc67dbebcce43083439bbb704fc500a4e45f17', class: "page-title" }, locales.entries?.Lcz_Bookings)), h("h3", { key: '25e4c9bc5982405ea1a733dcd953deedb84fbe5f', class: "d-none d-md-block page-title" }, locales.entries?.Lcz_Bookings))), h("section", { key: 'ec579e31e25e9958c1341c444dd3c6cc5122173e', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '290817fdca531c282504026387ae3e6b1344fe87', onchange: e => {
            ...
            } }), h("wa-select", { key: '927182d417bd27bf588e7d8d0257b8811c6c33ad', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: 'd2a65170f8a0eb1d5161a0780ba0228a3e9110e6', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: 'bb0f6b79fae3cb0ad0b3a57f5f0b4d9552d32eb8', value: "" }, "All channels"), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: '56a91cb6c741bea9f7a58a25b934b814c2dcadf8', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: 'ae02041eb6f6a44ab57145e5c3d0bca38c771dc1', class: "d-flex flex-fill align-items-end m-0" }, h("wa-tooltip", { key: '8937c0f136cab849a300d6826ab2482ded9f0761', for: "search-btn" }, locales.entries?.Lcz_Search), h("ir-custom-button", { key: '97f901c98dfa901ccbb5cc851f122d73e775d6ea', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, h("wa-icon", { key: '65d365872a28477b72c0157551909dc923710106', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: '59053c291c8ccc705f55ad4d4c8e8dd36025d247', for: "clear-btn" }, locales.entries?.Lcz_Erase), h("ir-custom-button", { key: '6997ffac801728a2e4569c0437864a1580ddbcf3', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: '2ab3d703146bd532d9d4209e93f1da9ea8f0f0f7', name: "eraser", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: '4752c207b9a561b6af222c4202d8a12e5b771e5b', for: "excel-btn" }, locales.entries?.Lcz_ExportToExcel), h("ir-custom-button", { key: 'e514db0469c200d5ebcef0be7472f874367f566d', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: '16159bb073102b9a95a51e7214280f49b141bc81', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
