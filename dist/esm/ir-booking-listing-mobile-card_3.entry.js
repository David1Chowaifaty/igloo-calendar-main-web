...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-CXCZWwpY.js';
import { d as getPrivateNote } from './booking-DuWdYels.js';
import { t } from './t-Bk78Wumj.js';
import { k as isPrivilegedUser, j as downloadFile } from './utils-BtgW0txG.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8e14b75147b838e3fbabc6ab2da4ca5747e739e5' }, h("section", { key: 'ecb2c51e466b44c89b6a39c437cc5cd9ce69265e', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '78be7298efa63d37cdca245990244a40fbf1962e', onchange: e => {
                updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing.userSelection.filter_type?.toString(), size: "s", defaultValue: booking_listing?.types[0]?.id?.toString() }, booking_listing?.types.map(b => (h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), h("ir-date-range-filter", { key: 'e63dfb29580b0fd0391fc8a44db96259081a15f3', class: "filters-bar__date_picker", showQuickActions: false, fromDate: booking_listing.userSelection.from, toDate: booking_listing.userSelection.to, withClear: false, selectionMode: "auto", onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("wa-select", { key: 'edd356b79890c85bb0610d540f1afd41a285820d', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: '7bbabab0de0b9149eb50b06e9c54a8c7a820a633', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: '698a70d9a42dcdf156fa44b5b8dfea3323d77d62', value: "" }, t('Lcz_AllChannels', { fallback: 'All channels' })), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: '80c7bd712f8808de0ab1e8f0e83ebd96bb3ba7f5', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: 'ef60e1a5e7818e9bc37a0900a85d8e358297c11e', class: "d-flex flex-fill align-items-end m-0", style: { gap: '10px' } }, h("wa-tooltip", { key: 'c88d2d07e12a735ffdc0e8d741e2f85bc8a0d6d8', for: "search-btn" }, t('Lcz_Search', { fallback: 'Search' })), h("ir-custom-button", { key: '107b9be4523d9a6f715dc98899e274ec2e22466a', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "outlined" }, h("wa-icon", { key: 'afa34726094a44117a3b989694117352b580fc40', name: "magnifying-glass" })), h("wa-tooltip", { key: '1942ac113f9fdd66c532f7a20db10eaac516adaa', for: "clear-btn" }, t('Lcz_Erase')), h("ir-custom-button", { key: 'c7b84f82acce9f8e0070b183fdfd77f9cc96cadf', id: "clear-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: '21b0cc1480cdeb1a908bb68a71b11b7255834cff', name: "eraser" })), h("wa-tooltip", { key: 'f5841e2ae20672ab2d354ccccd41fb90a466712e', for: "excel-btn" }, t('Lcz_ExportToExcel', { fallback: 'Export to excel' })), h("ir-custom-button", { key: 'da059a7ab24ac7a54f56c539aa41a05607275231', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: '747bf08e8e5916442b27ec54fb8c0567ec9436e7', name: "file-excel", variant: "regular" }))))));
    }
};
