...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-c9623d3a.js';
import { k as getPrivateNote } from './booking-7c5ba50d.js';
import { l as locales } from './locales.store-cb784e95.js';
import { o as isPrivilegedUser, l as downloadFile } from './utils-fa3eb983.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '71054504657bcebcc0d3499f8489acf3df4da931' }, h("section", { key: 'e8c60618c5455ea6e50ed9f284688d3fc411b160', class: "d-flex align-items-center " }, h("div", { key: '1d8b662049d937cd927d9ccacb085f51bb113b18', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, h("div", { key: 'eaa3f548926b6e803b8620a9083fe42584897a53', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, h("h3", { key: '9b347d85b50b272b80d0323d0cbb4f3b321a6e2a', class: "page-title" }, locales.entries?.Lcz_Bookings)), h("h3", { key: '5485d016513a1b3f21446b30ec97d08c7a09018c', class: "d-none d-md-block page-title" }, locales.entries?.Lcz_Bookings))), h("section", { key: '2d3306df15b37b569675ee8bae797f9e93293acc', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '29dc195f4487e14c6b32d9784782c3cc41188ce6', onchange: e => {
            ...
            } }), h("wa-select", { key: '27b7ce89abf75112e2b73c34a69cc9149802f13f', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "small", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: '96e84789d5a1d6d6f356b656fd34716b7f4bba2d', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "small", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: '3933314b10aabacc65d522fcbd8528fc4be87592', value: "" }, "All channels"), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: '7b44142b4b33d4e8642f7172170a89af28fd032d', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "small", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: '9239ab4e8ee79bc6675a1f62682dd44d4c36c44f', class: "d-flex flex-fill align-items-end m-0" }, h("wa-tooltip", { key: 'cb68baf1a9d13339a6e2dec4e7888f5aafbfed94', for: "search-btn" }, locales.entries?.Lcz_Search), h("ir-custom-button", { key: 'c92969b32816ab3c7527fe2c15249daa98880f1a', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, h("wa-icon", { key: '48ba44ff5e78dc732f8d652f6b46359d761fd363', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: 'ca7ea3092e0d9f6da29f5c4768c368aac0ba1b94', for: "clear-btn" }, locales.entries?.Lcz_Erase), h("ir-custom-button", { key: 'df6e70a63a451a4129acd74ab0750fb6032435d7', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: '1ed04ad1073d8806c0c0d4eb07429cc257f417db', name: "eraser", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: '37869389f8da1662f789f9df822e8f11f7736f63', for: "excel-btn" }, locales.entries?.Lcz_ExportToExcel), h("ir-custom-button", { key: '00f3560e35960cf591c30d87087cf6036dc18c36', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: '12bc005f23c6131fbd889f6bf45e8c6003ee8cf1', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
