...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-2f8af3a4.js';
import { k as getPrivateNote } from './booking-60a231c5.js';
import { l as locales } from './locales.store-cb784e95.js';
import { n as isPrivilegedUser, b as downloadFile } from './utils-fb79c44c.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '75ecb913c96a81b34c6eb2f3ed9c720410d37742' }, h("section", { key: 'b2fbba7a2b37549381c0a68d6511c24244042bde', class: "d-flex align-items-center " }, h("div", { key: '103370aa3aacc8ef883390ceef8c3241e6eb3ba3', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, h("div", { key: 'cc195d38bf8e47181800976932ba4cc3330735c0', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, h("h3", { key: '3bfaaf8aa1d78076d4a8801c12c883e4cd149c6d', class: "page-title" }, locales.entries?.Lcz_Bookings)), h("h3", { key: 'f92de197b60370656e31e005e5b193a94fccacf1', class: "d-none d-md-block page-title" }, locales.entries?.Lcz_Bookings))), h("section", { key: '9cede8b5a40555c6872d434a08e222e63532bd5c', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '06d06cd94fb99c1bf1a8320d4e098d01552ed79b', onchange: e => {
                updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing.userSelection.filter_type?.toString(), size: "small", defaultValue: booking_listing?.types[0]?.id?.toString() }, booking_listing?.types.map(b => (h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), h("ir-range-picker", { key: '6a78490e034c406802361995e5804aa60a9d5582', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, allowNullDates: false, fromDate: hooks(booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: hooks(booking_listing.userSelection.to, 'YYYY-MM-DD') }), h("wa-select", { key: '2d4de3638381583731092f9683d4863d8ed6c78b', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "small", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: '813f57e0c1a2f153386744b2915d321ee4c618d2', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "small", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: '25189aa0acc2551c703bde29de72b911285436e2', value: "" }, "All channels"), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: 'd1112e292634b00062f3b11b9a03e935d5770aca', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "small", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: '0a5ffc5c94dc65713db50b0694fcd1c1f71d2abc', class: "d-flex flex-fill align-items-end m-0" }, h("wa-tooltip", { key: 'bd18f967e3a81da8900f66e93713d74b4ae1bf9f', for: "search-btn" }, locales.entries?.Lcz_Search), h("ir-custom-button", { key: 'd91d98c9d920bc662578868b211863a46566b77c', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, h("wa-icon", { key: '0c346a09cf0fe1c2f3a957b46a9ffb529d0e8f3b', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: '27392dff88a1738d0ab495847968a3cb5413925f', for: "clear-btn" }, locales.entries?.Lcz_Erase), h("ir-custom-button", { key: '315f2d4ccc56b3c5185cc67341cb434ceb1e50ba', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: '5b5328af80a1fde7518f2203e0d43c34a1a36742', name: "eraser", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: 'd2b5dcfc466a44227406132d79c10025af05ad16', for: "excel-btn" }, locales.entries?.Lcz_ExportToExcel), h("ir-custom-button", { key: '9c45bf1de447aa9de2f08d394d0dc477d9148f49', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: '0c31324bcd41660454f9769f27c1cc16123647b0', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
