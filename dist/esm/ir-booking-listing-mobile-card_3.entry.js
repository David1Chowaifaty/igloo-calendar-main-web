...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-CE33NFB6.js';
import { g as getPrivateNote } from './booking-SXprRnHy.js';
import { l as locales } from './locales.store-CPGnSUGJ.js';
import { i as isPrivilegedUser, e as downloadFile } from './utils-BeklM4gy.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4cc4fa07f837bad95585b6756d7c352abe555760' }, h("section", { key: 'ee5ead6dfefb4417bc54231c04701b505ca25232', class: "d-flex align-items-center " }, h("div", { key: '25f04e7d7d91d986b0ab75ffd478b72b8bf2d930', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, h("div", { key: '42d004380f6bfe97f8306cd9030ea231a3408957', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, h("h3", { key: '75d70c6bd0cc990f5610a3d8deb132251803e8ab', class: "page-title" }, locales.entries?.Lcz_Bookings)), h("h3", { key: 'bb39207454e1af33ffa726d4be3e243cc7242efc', class: "d-none d-md-block page-title" }, locales.entries?.Lcz_Bookings))), h("section", { key: 'a28853ca41cf973f48d19ac4004d2fe9c5f4cfa9', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '46d8c506e52ba32bab87f290194b4c858aecd435', onchange: e => {
                updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing.userSelection.filter_type?.toString(), size: "small", defaultValue: booking_listing?.types[0]?.id?.toString() }, booking_listing?.types.map(b => (h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), h("ir-date-range-filter", { key: 'd4d938905b607ee97cb267724b59152ae11e90ff', class: "filters-bar__date_picker", showQuickActions: false, fromDate: booking_listing.userSelection.from, toDate: booking_listing.userSelection.to, withClear: false, selectionMode: "auto", onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("wa-select", { key: '445039c1d9f72482b1ddc21e4f2fd5f3db67c243', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "small", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: '44f0e2847be275fe212e655a94cf74a31f14011e', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "small", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: 'd3a6c1f2ac3d8001961e8d0f9c7f6a626a540b63', value: "" }, "All channels"), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: 'ae093398ed0b2a06416126b4a2b730027e4b374d', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "small", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: '59b80cb679af9e0d504eb192102a357a7ae9fa7d', class: "d-flex flex-fill align-items-end m-0" }, h("wa-tooltip", { key: '1fb360c74a731c672629afcd1f2a8228d2f13476', for: "search-btn" }, locales.entries?.Lcz_Search), h("ir-custom-button", { key: '32b5c5de31516375585fec95d20c724f78b5e790', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, h("wa-icon", { key: '9393643514d41068d09a1fc078b7ab83e732e917', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: '349fa522965f41531472006deb8a099c622b3dd9', for: "clear-btn" }, locales.entries?.Lcz_Erase), h("ir-custom-button", { key: '40485d0579490b2c55510b787f32f2476e07568b', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: '52d847253121294105951a8e6813621262f4ac17', name: "eraser", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: '7ba385d67a29c134644f925192450b14eb57c7f8', for: "excel-btn" }, locales.entries?.Lcz_ExportToExcel), h("ir-custom-button", { key: '3c58139b1eba2cdef21f48c63587969873160473', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: '033812ccdef822df09b57f6706c85695ca92e078', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
