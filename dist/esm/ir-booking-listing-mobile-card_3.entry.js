...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-CkJrZzGw.js';
import { d as getPrivateNote } from './booking-BEyOqUXv.js';
import { l as locales } from './locales.store-ChFOK43k.js';
import { l as isPrivilegedUser, k as downloadFile } from './utils-DoV0ybBP.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '94386bce286cd2ae4ef5658b40c8dc9816be27f4' }, h("section", { key: '844a1ce2511048811b07601412a476290b29443a', class: "d-flex align-items-center " }, h("div", { key: '131ba152926ebe6d6461bd61398134aa7fb55da2', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, h("div", { key: 'b4be19f8b9da1759bce8f2826b0ce44f374246cd', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, h("h3", { key: '40a275b5c72fbf0d4f3857afbd228dde53d303ae', class: "page-title" }, locales.entries?.Lcz_Bookings)), h("h3", { key: '93ce81fca982b720c355295da29e435c642c3047', class: "d-none d-md-block page-title" }, locales.entries?.Lcz_Bookings))), h("section", { key: '8dd921f52c3076bba5a41b4f36a283cae1b9f79e', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '54c95f106f0fdcea183653ee124cf9010e0029c5', onchange: e => {
            ...
            } }), h("wa-select", { key: 'b86615924a39b13254c0fa7579a25d878546c6ad', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: '48fee4e290a4d1884edc5a20c218eecaae502496', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: '84d47f2562e2ecfb423d0dbee966d793979530ed', value: "" }, "All channels"), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: 'e5268d4c845f220675c1a447c2d4df9ec2d686e4', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: '8abf41cf361c334e80c2ca7f07e7ef491e47bf7f', class: "d-flex flex-fill align-items-end m-0" }, h("wa-tooltip", { key: '02c961dfb991c47ef6cc077055f7b3a9e5911f67', for: "search-btn" }, locales.entries?.Lcz_Search), h("ir-custom-button", { key: '7ec2d7a8facca49f0306459a5245b06985a8f539', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, h("wa-icon", { key: '2fa1badd5c440c44366fef28b7ae46277bd51832', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: 'dd278e52b39148970b0a1096a6ba17611937647b', for: "clear-btn" }, locales.entries?.Lcz_Erase), h("ir-custom-button", { key: 'd0dd9c8b19c42748e76dff90cfce3700de831703', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: 'bea4d33be2a3fd366354ed8743c6686c5cf29a49', name: "eraser", style: { fontSize: '1.2rem' } })), h("wa-tooltip", { key: 'd4f8e546a9b07594480ee41da419306107038097', for: "excel-btn" }, locales.entries?.Lcz_ExportToExcel), h("ir-custom-button", { key: '999b0ae60c6c8916b9c98f4d29bd16670da066c8', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: 'a6bc6e1a2d63a9ce6929f31b613e4d7056b6c10f', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
