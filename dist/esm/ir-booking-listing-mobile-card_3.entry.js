...
import { b as booking_listing, B as BookingListingService, u as updateUserSelection, i as initializeUserSelection } from './index-DWCaWagX.js';
import { e as getPrivateNote } from './booking-BJc14L4e.js';
import { t } from './t-Bk78Wumj.js';
import { n as isPrivilegedUser, j as downloadFile } from './utils-B69q7mr1.js';
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '82ab1ff96ece36b61907fc7f3d30ed61cf728554' }, h("section", { key: 'ea97f31ba43e75bb7705728a1ed431011ff9bc85', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: '58ba8951f0e44e82d6fb21b9a9c63e9b202221e8', onchange: e => {
                updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing.userSelection.filter_type?.toString(), size: "s", defaultValue: booking_listing?.types[0]?.id?.toString() }, booking_listing?.types.map(b => (h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), h("ir-date-range-filter", { key: 'd61ca862c98d9cfb655003a34717320ac45b9906', class: "filters-bar__date_picker", showQuickActions: false, fromDate: booking_listing.userSelection.from, toDate: booking_listing.userSelection.to, withClear: false, selectionMode: "auto", onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("wa-select", { key: 'efb5f718bb8be75f6ff7dd8ac28cfabd50a7b647', onchange: e => {
                updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing?.statuses[0]?.code }, booking_listing?.statuses.map(b => (h("wa-option", { key: b.code, value: b.code }, b.name)))), !isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (h("wa-select", { key: 'fac07d0a2e8cfb0de061f492d592dc9ce298f192', onchange: e => {
                updateUserSelection('channel', e.target.value);
            }, value: booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing.userSelection.channel }, h("wa-option", { key: '39b31ad15a7964c7fd48dcd9afa7407ca06346ae', value: "" }, t('Lcz_AllChannels', { fallback: 'All channels' })), booking_listing?.channels.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name))))), h("wa-select", { key: '197bd8599a8e8afa4665b7d24b50b21b012ec571', onchange: e => {
                updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing?.balance_filter[0]?.value }, booking_listing?.balance_filter.map(b => (h("wa-option", { key: b.value, value: b.value }, b.name)))), h("div", { key: '4c894513116549ec27f2af9c2bfb28dc57f43bb7', class: "d-flex flex-fill align-items-end m-0", style: { gap: '10px' } }, h("wa-tooltip", { key: '1638894439a9a51e05f7f6074d776d421539136e', for: "search-btn" }, t('Lcz_Search', { fallback: 'Search' })), h("ir-custom-button", { key: '5b6e1a73ccb8f8e37acffc727e7e29bd22f4ab50', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "outlined" }, h("wa-icon", { key: 'dd31f47e90fdc88b7152ed3cfe32cfa89b9012eb', name: "magnifying-glass" })), h("wa-tooltip", { key: '0f383f5bc28e8b6cd4ef3ce0e28166400f97d7da', for: "clear-btn" }, t('Lcz_Erase')), h("ir-custom-button", { key: 'e0d33c5f3281aa4b2039e0756067d8f3626fcf76', id: "clear-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleClearUserField() }, h("wa-icon", { key: '9df2c14031a0f96d6a84387f43c754201f7a05a5', name: "eraser" })), h("wa-tooltip", { key: 'ffa264a7c48c2d8b26c67c361d7ea8a51d340bff', for: "excel-btn" }, t('Lcz_ExportToExcel', { fallback: 'Export to excel' })), h("ir-custom-button", { key: '4d607e25e6cd6b488fcddf8e24a327524e4de02d', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleSearchClicked(true) }, h("wa-icon", { key: '77d04c33ea6febf03ce2ccf3a01bccc9b786f058', name: "file-excel", variant: "regular" }))))));
    }
};
