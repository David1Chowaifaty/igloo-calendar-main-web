import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement, H as Host } from './index-60982d00.js';
import { v as v4 } from './v4-964634d6.js';
import { l as locales } from './locales.store-629477c2.js';
import { H as HouseKeepingService, h as housekeeping_store, g as getDefaultProperties, u as updateHKStore } from './housekeeping.service-e63a6d61.js';
...
import { h as handleBodyOverflow } from './utils-cc0c2e69.js';
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '6babd153d84ed13b3516a1ac934519b224b6ae4b', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: 'c251d7fb1a1d571e061ef63b5257d8cc295a2582', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'de2142f7cff9cb03645aa4b9f621e0701a24d5f4', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '68ac9da6ea5c24dd602dd1c5c62d308af25d6984', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '5fd94bc27ff8dd140f5399e199d684a450b0dfd1', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '9ddcc42e0454b068f625f76270bf5acf8033975c', class: `ir-alert-header` }, h("p", { key: 'ced401775760db5307e89611979e941bb857d7c8' }, this.modalTitle))), h("div", { key: '994f2cb216aa6226ecb175b138c1eba894740fea', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'b8688af2379699a5c7dfa57ac7df2aa37dddfa46' }, this.modalBody)), h("div", { key: '3e2945161e153fecf28245aa2d9cd4045b7f38e1', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '7178b76150365494019ee8135fac59f3fa1e0256', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (h("ir-button", { key: '792ee500bf82189a0f583a099a4fd610ab9392d2', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '633db3be4318c7848a54ac302a5b2f735f85366c', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '93db506d0217ec3630f78656f81484123953881c', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '3a7bb2a52f8e5bcec8c2e74972406cff785a50c1', class: 'sidebar-title' }, h("p", { key: 'e88ea5ba743b42017c55b79fc0580a4802342c95', class: 'p-0 m-0' }, this.label), h("div", { key: 'beeafbdc8d790dedbea97bed37b9f72163e9ceb5', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '8dcd2851e74ed49f0c204d348c7b146ed5956416', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'a262851130f6ebd4e05d79e9d57c17de484ff079', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: 'b631905c65d36599b6a746bd44abd6a614da5da9', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '8d64307043db3f275ec974c61cb4ce705d6e182e', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '834b016aad493863380d2a5edc4d25b6e8714e97' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
export { IrButton as ir_button, IrCombobox as ir_combobox, IrCommon as ir_common, IrDeleteModal as ir_delete_modal, IrHkTeam as ir_hk_team, IrHkUnassignedUnits as ir_hk_unassigned_units, IrHkUser as ir_hk_user, IrHousekeeping as ir_housekeeping, IrIcon as ir_icon, IrIcons as ir_icons, IrInputText as ir_input_text, IrInterceptor as ir_interceptor, IrLoadingScreen as ir_loading_screen, IrModal as ir_modal, IrOtp as ir_otp, IrOtpModal as ir_otp_modal, IrPasswordValidator as ir_password_validator, IrPhoneInput as ir_phone_input, IrPopover as ir_popover, IrSelect as ir_select, IrSidebar as ir_sidebar, IrSpinner as ir_spinner, IrSwitch as ir_switch, IrTextArea as ir_textarea, IrTitle as ir_title, IrToast as ir_toast, RequirementCheck as requirement_check };

//# sourceMappingURL=ir-button_27.entry.js.map