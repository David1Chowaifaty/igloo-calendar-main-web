...
import { b as booking_store, B as BookingService, m as modifyBookingStore, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms } from './booking.service-729d0777.js';
import { e as extras, h as handleBodyOverflow, z as getReleaseHoursString, j as dateToFormattedString, f as formatAmount, g as getPrivateNote, I as toFloat, J as renderTime, n as formatName } from './utils-0f5c07aa.js';
...
import { c as calendar_data, i as isSingleUnit } from './calendar-data-5d531f99.js';
...
const IglBookProperty = class {
    ...
    render() {
        return (h(Host, { key: '25cb4a9b8a7fe415368182cd508db37fa3eb9f25', "data-testid": "book_property_sheet" }, h("div", { key: 'ce2b3d4caf2b19441f4a9c954f4c3b52cd5aa336', class: "background-overlay", onClick: () => this.closeWindow() }), h("div", { key: '165c77a239b99c4c81b01a710441d06f84ff5d3a', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, h("div", { key: '28e238361907faecff296c7ad09b72fd3422162f', class: "card position-sticky mb-0 shadow-none p-0 " }, h("div", { key: '02c6cba52a6072f6bdbbaab314a7aca4fc5d60db', class: "card-header-container mb-2" }, h("h3", { key: 'b9b53a936dc460aa9b19046fbb65aa3e121d0cfe', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), h("ir-icon", { key: 'deaf7cfa482e7d4b6d7fa77d072041c7efc394a4', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, h("svg", { key: '92f1016d221aac8fcf978cf3957a3b8b7ac6fb2d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '0cc641521706de8d274ea01def1f92d50096504a', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), h("div", { key: 'a432d516e17ae171dca6028f821fe9c3ff0d7749', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (h("igl-booking-overview-page", { key: 'bf270c98cdc305ab61ab48d230fbf22db2091131', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (h("igl-booking-form", { key: 'e341e849a4f53623bb1bb9f5c920190e4ad67aa6', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countries: this.countries, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IglBookingForm = class {
    ...
    render() {
        ...
        return (h(Host, { key: '771b26a577f4e7dbc84e6da561b6b41c1100f1f7' }, h("div", { key: '3e20dbda65f9a659c96d40a1c931e54ce91cb376', class: "d-flex flex-wrap" }, h("ir-date-view", { key: 'a06597a6f6fe0e670cd8487b45a52355d6e1814f', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (h("div", { key: 'b3f25f9138532527026e0d314167808076e89b14', class: "mt-1 mt-md-0 text-right" }, locales.entries.Lcz_TotalPrice, " ", h("span", { key: 'f6e08c440bb9f63100c5fef93c7fab05615496a1', class: "font-weight-bold font-medium-1" }, formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: '580bf2510dde231da1e890d1bb2b27771da25e61' }, h("div", { key: 'ccac75132013630df95c623fe1c2bf92552e9894', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '327a499d592d31f7d7d5310168ece997ada5afc4', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'bc5e4990f760ff27d44860ab1b8684d0e9b3486f', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '5f55da7da256db725a2a684ffbdf5670035faf45', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: 'fcb896e2950663a458a50901f94425f05383257d', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '7645849f4628870fb76c0de75f0466eba1a2768b', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'e5a7c01b8b97e379170ce692e3599f7eb4caf4b0', name: "modal-title" })), h("div", { key: '49be0b814c8dcbf9a937004322748f0b98883915', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'd92490a08847e9259645ea816aa35f29b2894fe9', name: "modal-body" })), h("div", { key: '0c18934639452cf64a4462088a777a14de817359', class: "modal-footer" }, h("slot", { key: '05d8614a52424539385d99d46e97124af43dab4d', name: "modal-footer" }))))));
    }
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '2fe7c903bbcfb34952433fa6a7687665f84b8bcd', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index) => (h(Fragment, null, h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index !== this.booking.extra_services.length - 1 && h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h("form", { key: '5427d417ca796be89bef84dfd917f1b459bb7d14', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-title", { key: 'ed96a9bee9cd87ce4701db7ae6e5a850caa9e98e', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_Pickup, displayContext: "sidebar" }), h("section", { key: '85395247c707919fb0e4aefc3a5c59a889901a2d', class: 'px-1 sheet-body' }, h("ir-select", { key: '9d2bea02d6f26ad53e22c6e3afba3705b0bcbe09', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h("div", { key: 'a360afb6dc02beec05aac767339df201cc78dde2', class: "m-0 p-0", "data-testid": "pickup_body" }, h("div", { key: '8e0871e333a37f7c63e4cffd23a0369310776c32', class: 'd-flex' }, h("div", { key: 'dfb7c4f8a1669ec0f0121e8774ad156a38dc486c', class: "form-group  mr-1" }, h("div", { key: '5ae1b6e884b0b79840f80eb2a57f49f2b738c695', class: "input-group row m-0" }, h("div", { key: '31241c7698709d38e7b5149f180a00c4f590ef42', class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { key: '751e7643c04c7d71d6ad0c61bc4e6a19fab5df6e', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { key: '8b2cb54a1c797280b10eca6799a4a54a486bf9fe', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, h("ir-date-picker", { key: '712f66c124de8c78b1ad01f8877268e48ea19f1e', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, h("input", { key: '1af51c1f05f3063113c952bd92db62ddb0274a42', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), h("ir-input-text", { key: '14ddd640cfee7499888601a8008ac96c921cf369', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), h("ir-input-text", { key: '1fb24a803e53d4198ce41905502f5cb55618c724', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), h("ir-select", { key: 'a2c8f2d18f8edd58996b7eaa09fe411322ae4be3', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), h("div", { key: 'e23aa4ab0d443a3ae023c3756df7dde265e606dc', class: 'd-flex flex-column flex-md-row' }, h("ir-select", { key: '8a0dbe578e4c7185e2a6e9734db1ca7b59717ed1', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), h("ir-input-text", { key: '317c6e4b26e47421977ade11cee05f92c6ecac9f', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" }))))), h("div", { key: 'bcef2d1f5080ff01ffb79fad2f7f565ec20945b6', class: 'sheet-footer' }, h("ir-button", { key: 'f2141ec16d9e0f425f5a8dd7cf7430b1a5fb6547', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, icon: "", text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (h("ir-button", { key: '1ba38e38d596cefccdaf73bd144a5ca3ff772892', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', icon: "", isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: 'd0eebbbb30327c94fadf14d21990b841f80fbf8c', class: "card" }, h("div", { key: 'f61097d060ea305add8f8381cca331995e637a20', class: "p-1" }, h("p", { key: '76af8dc25f8db70731e330a0529627249543ec1e' }, this.booking.property.name || ''), h("ir-label", { key: 'e9dd533ddcaafb39e217edad5a0cd41570170272', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: '2bc17bc043c030f714c6379d414908b42d836654', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: '0d330fed8cc32e14b94ccb23bf21134b8fd562a4', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: '0baed267783c9811bcb1825a24fc03d59080f9b8', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: 'b1ab7720e58a33624156051cf281b359eefee4cf', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: '3f7f4963cf07be2085fcc78646508c3dfad82f4b', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: 'eb3fe73614c245270c2ff3562c84aaec1d54a049', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: '12be095dc1fa584ff65eaffb809896d03ea61e51', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: '26f56f470a273c8b4411227adbb991c96898cf35', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: '0fe3f5b923d83b8d7415e8a6a42fbe1e1f7b7b1a', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: 'bddcf4d2adff44503c0a00c279907dfd123b663a', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: 'd7f208fd1db30d85bc40264379491f00bf36fb59', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: 'd1b02354781998b959b1d5958262458beb39be85', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: '78b28f4e722ca9c3b484cfa0780239c61722560a', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: 'c6067e4342e0cd5561c9c6cfc80be11932e8259b', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: '8f845474cda53256f006471ac019b76a665c6df4', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: 'bc16000c0fc89f766ebad71c354924bae52b3ab9', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: '1f9696598147c142a0967ca568497347150b232b', class: "d-flex align-items-center" }, h("svg", { key: '137a27895d9f55315068657d99c741202ffe931b', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '1fb94c3e4d514b2468d5eafa8c856dfd7c0bc64c', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: '6d73f15bc7c2f35971025b25c1d5e4eb5eafe793', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), h("div", { key: 'd09bdf5293d95db569d3ab0f5339406bd90b8b46', class: "d-flex align-items-center justify-content-between" }, h("ir-label", { key: '81d4b5daba1de4e3054c8f76616b497d2e7fc335', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("ir-button", { key: '9673c30a7c48307531acc2b9ee71972e9ff17b19', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: 'e539f41cb5f4e7be46649932d327d13f0a21623a', class: "p-1 d-flex m-0" }, h("ir-button", { key: 'bcfc81b927f92c915fb73dfb0bffeb877c3c6641', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '29f1504ac0db29967153569dd234e813aa6e0de6', class: "flex-fill m-0 " }, h("div", { key: 'b3c6ef3f218a804ec09d45529644a870c6b99063', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '0541211abeb87a787eaad0e3b7eef38de0debcb0', class: "m-0 p-0" }, h("span", { key: '12eefa6629504101acb75d2afd9e1ed8e1d4be2e', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '1fde4f6c2fd76dff9223cb6a09a89a2dc0f409c8', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: 'a47dbf8888103c7342cad6b1a45ce1bcd63c1aab', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: 'eb666ec5e4dbf6dc7cc09fdf5368f618cde02d1c', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '7f896aaf07c5e549e79f13cad5ddfc7aaf087acf', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: '48d853e008e1e7e938e33e4d499a78835b6050d8', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: 'af145e42655a5e42b97a8b1fd5dd79d7859dabce', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: '6e1b682c830b8f40e39c192450502a4cfafc6bcb', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: '44971c39e96b67e7aadb57b87d79c56a76e79f87', message: this.room.unit.name, customSlot: true }, h("span", { key: 'cc5fd37429cb50ad728c2439a2b8dd9316e8c2ea', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: 'ea08d6b931944cf6d72adba3e73a6a9dc66ebde9', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: '2bd9f83c4b9023898d268f47a7cecbde5a57edcc', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: '96081945e9c6054d193805e83bed1794b37a0e4b', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '214319878b4804d9c6c8c3bd90bc8976743a72ff', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))) : (h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), bed && h("p", { key: '9d06a6b7a3f232ec646bcab66f37afe8be8132ed', class: "m-0 p-0" }, "(", bed, ")")), h("div", { key: 'df3fee8c5569bc32657010ef8823e0c269cb8fc9', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, h("div", { key: '084d721601e4545c65b3fe32c1169ab60a199626', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '175b82a56e36b5d65a73feae63fd3886c37d878a', class: " sm-padding-top" }, h("p", { key: '8ed78455ea6234fa7d7e6360f7322b0d8a7011ad', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '8aa8245a96b10d919cf22ad7e6d4412bad489012', class: 'flex-fill' }, h("table", { key: '08493d8a53524f6c1cf50cfadc2eb05cdff44f77' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '8741800b3dd6f2a4c2fbbe0b4f900206d1d783e1', class: '' }, h("th", { key: '4e1154ad1e33e101c2e4db960a53a249cdfd2fbc', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '47c0a027f934646528fa0377150bf1f98fe4cd75', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: '7e763c8e6981137248764ded1607c7aa3cf86f40', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '817772f1105e705c1280217ac950afdea893187a', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: 'c2cb233fbdaa339f77a1ecb8dfbe0893a6435590' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'a4614a8b13031e7c2a349ef35353220ad7c2c666', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: 'b4b15b134d9a8646a25547db306fb5f8ab8da571', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '14993cbc5a68b5b7ad781f1a6166618a89287bdf' }, h("ir-label", { key: 'cdcb31e73a32711c7f28fe72d86357e260066dbd', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: 'f0859cd91bf135e36a20466c335cef44631a9fa8', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), h("ir-modal", { key: 'cc2799d57c2b483de6d9aca0ade5f32c42996d6b', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
