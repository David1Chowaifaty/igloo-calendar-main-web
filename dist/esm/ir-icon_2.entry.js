...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (h("button", { key: 'd91c47daf9ff5bb2377e1af91d1ef6ba4afc03f6', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '73b22435bce9c03a382cab94388e4106aeb8821a', name: "icon" })));
    }
};
