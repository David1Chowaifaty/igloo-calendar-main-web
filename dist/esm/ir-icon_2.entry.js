...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: 'cefc7c4db8a36e1d63645d99bc08161788bf9789', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: 'cf24e6ac82f3cb56d76b0a071b0cd735c38901d8', name: "icon" })));
    }
};
