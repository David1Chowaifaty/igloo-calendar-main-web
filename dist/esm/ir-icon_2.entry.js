...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '63099154fd45007b6ba37ef79abaecc126b9f0eb', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '03b30548d690b08a149149dd37d9494a1b7b6567', name: "icon" })));
    }
};
