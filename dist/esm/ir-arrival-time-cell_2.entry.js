...
const IrArrivalTimeCell = class {
    ...
    arrivalTimeLabel;
    render() {
        return (h(Host, { key: '3a7837fd3bc31c2d793e8718586e36a1d0c48e39' }, h("div", { key: '2545238bfde64854bdd8f74ee2c6efd11500196d', class: "arrival-time-cell__container" }, this.arrivalTimeLabel && h("span", { key: '0d1f941cd37cbee1b30979a43a8bf7ebf63bb66d', class: "arrival-time-cell__label" }, this.arrivalTimeLabel, ": "), h("p", { key: '5005d516da3641628e6d52e50745e772289f1f0c' }, this.arrival?.description))));
    }
};
...
const IrBookedOnCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: '98b3b654a58a52e201e0037b7f275a73155fccfd' }, this.label && h("p", { key: 'dd634f3571963b690986449424dae8a6e0077e86', class: "cell-label" }, this.label, ":"), h("p", { key: '7abaf7605231ca6cfee75d55a76f13480a7053dd', class: "booked-on-cell__date" }, hooks(date, 'YYYY-MM-DD').format('DD MMM YYYY')), this.showTime && h("p", { key: '03ab133c9e4ec8805c34ca1dd5b9ad1cb4e043bc', class: "booked-on-cell__time" }, _formatTime(hour.toString(), minute.toString()))));
    }
};
IrBookedOnCell.style = irBookedOnCellCss();

export { IrArrivalTimeCell as ir_arrival_time_cell, IrBookedOnCell as ir_booked_on_cell };
