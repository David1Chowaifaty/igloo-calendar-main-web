...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: 'b42d30972f6775d0e8bb8da94c5cec58f3d5d3ca', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '722857b331e903a4e1f488198f0bfc7da2bd4383', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '0ca3a50c90f1d866f9db7c76327a6d209234ad80', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'b892ff98d6123e03c52995b2a7bb766b25203eaf', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'd4a5b99e6cc76ccbeb0983dfd8e636f2e32fc737', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '5cf984976501b82061ffac5a935bb7c6c77e58dd', class: `ir-alert-header` }, h("p", { key: '2814da0c516d406944a377a351ae5d079afb2e5e' }, this.modalTitle))), h("div", { key: '731cd0fce31c70c8fa2afd937e0cb2d98dce1db8', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '14d75a930c45552bd9fbee63189017b65d0df51d' }, this.modalBody)), h("div", { key: 'ccd4a36d40be011a0cf8916d5bb481409da109c6', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (h("ir-button", { key: 'fa228b46dbfd4cbef581f5f880370f579a2f5b2e', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (h("ir-button", { key: '02ce648f5f6b3d16dbca9f62e9ec22e9906d0d95', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '213b70eb16a479b34e4290ff532375a2268f0aff', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '5b2f1eef9ff3b66ec2a0ac09b6c18a7f87a3a526', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: 'e52bfadd1ead913ccdcb1db946628b69d32128fd', class: 'sidebar-title' }, h("p", { key: '6993c36f64b15c853b40ee9ed8dd34426d56c25c', class: 'p-0 m-0' }, this.label), h("div", { key: '751b6694315ac87486d31782a32b581406a6b0ba', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: 'e93d208422d6ef3afdc3895c0d97c017d1a41133', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '11c652d9fff0a7fb41b5a57dd6441c5f438782a1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '255461e717d8e74018c55d8b6a8e2a249c042f90', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '64c1cc3db127cbaf98fd3e6deccfbd98bb46701b', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const RequirementCheck = class {
    ...
    render() {
        return (h("div", { key: '6617ee69d647e592784482ad6161c32eaadde8c6', class: { requirement: true, valid: this.isValid } }, h("ir-icons", { key: '998950644d2bd4253421ef9332eeacfbd7f4b6ab', style: { '--icon-size': '0.875rem' }, name: this.isValid ? 'check' : 'xmark' }), h("span", { key: '614da3b1d79ab3bcf82944d19ec6a4507ae772b3' }, this.text)));
    }
};
RequirementCheck.style = RequirementCheckStyle0;

export { IrButton as ir_button, IrCommon as ir_common, IrIcon as ir_icon, IrIcons as ir_icons, IrInputText as ir_input_text, IrInterceptor as ir_interceptor, IrLoadingScreen as ir_loading_screen, IrModal as ir_modal, IrPasswordValidator as ir_password_validator, IrResetPassword as ir_reset_password, IrSelect as ir_select, IrSidebar as ir_sidebar, IrSwitch as ir_switch, IrTitle as ir_title, IrToast as ir_toast, IrUserFormPanel as ir_user_form_panel, IrUserManagement as ir_user_management, IrUserManagementTable as ir_user_management_table, RequirementCheck as requirement_check };
