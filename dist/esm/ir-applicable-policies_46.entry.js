...
const IrBookingStatusTag = class {
    ...
    render() {
        return (h("wa-badge", { key: '1c82d42f97428d603e685ce0f09065f6c4549164', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: '2c1e239db0e19b3399a6e95bdc8d067776e34114', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (h("section", { key: 'bdcb19ba5dbaf359e30057764a6cecc08b19f167', class: "ir-print-extra-services" }, h("h3", { key: 'd9f0f1c28ee16694759bd2d9f740debf6e194778', class: "ir-print-extra-services__title" }, "Extra services"), h("div", { key: 'abd8855a09cefba4da3c66f1fa220ab0d5c9848c', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
