...
import { l as buildSplitIndex, c as calculateDaysBetweenDates, k as getPrivateNote, f as formatName } from './booking-03cc2d8d.js';
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (h("wa-badge", { key: 'df09244dcc654681e834815625be551bb4b00e49', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (h("ir-drawer", { key: 'f8a7addfbda985ae300c2480e78cdf2a783ac5f0', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (h("ir-guest-info-form", { key: 'c6245448602c718d11bcee6db5889cb5b8187165', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), h("div", { key: '9248095a4c9d58d0c14b58dd167d4f55fc6456dc', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '2cf98f0ca1765944f272d022d24329a3cce04797', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales.entries?.Lcz_Cancel || 'Cancel'), h("ir-custom-button", { key: 'c797c96ea2dad7b3082fa8fdc1d7397b72c825cf', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: isRequestPending('/Edit_Exposed_Guest') }, locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (h(Host, { key: '0c4d77b732e8fc14fbfa5a30469daa1afebdaaf9' }, h("ir-drawer", { key: '0885eeed126a829f1f94e5dd3eeac0cfd87e0c95', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, h("div", { key: 'f472a31277d85e774c4c913e5f1922b0926f41da', class: "d-flex align-items-center", slot: "header-actions" }, h("wa-switch", { key: '524e1dfa9d6add5d87fcd4657a39a026b9ceafb6', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (h("ir-invoice-form", { key: '3c8b6ceb4ea7ff8a0e09421a59b698a083d8714d', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), h("div", { key: '11044db7928695c39fb04edeb18e2a71e10520cb', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'd20357fd1e9c1471105962f710641e3fd01bbe66', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), h("ir-custom-button", { key: 'c3227c75ce844b3090fb54bdb078bcf59d896718', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), h("ir-preview-screen-dialog", { key: '3b9752514a4db3efd0a4a244b6405ac78545d3f5', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, h("ir-proforma-invoice-preview", { key: 'bb4b89cf272040e2a3739f8aee676226e21de09d', invoice: this.invoice, property: calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'b665eef1d2dcc87d50ab32bbceb75b35256afb49', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: 'fe87d9b5c4f0c28af1f88555a97df4cbe57c7021', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, !this.hideDefaultAction && (h(Fragment, { key: '43d03c82c1c075e9e8d88c5a85b5da3816127bfb' }, h("wa-tooltip", { key: '949efaadbfd284df3b4ddc4a48c51ca2243c3b62', for: this._id }, "Print PDF"), h("ir-custom-button", { key: '371b67efdd3f8fcec7c6e5aa18b14fc5da5346ea', id: this._id, size: "medium", slot: "header-actions", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, h("wa-icon", { key: '64e5d5fbe3af491089340e01d39b491ebc7b2fe4', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() })))), h("slot", { key: '1672fc7565f20de1b94533995a6a00b70b99224a' })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (h("section", { key: '2934715d305ab16ca894852488a2c5c88e9093a4', class: "ir-print-room" }, h("header", { key: '10696116a9b312d07aa90ac612e21b6d4f910841', class: "ir-print-room__header" }, h("p", { key: '3228dc364f81107b15dea13cd392c29bffc53129', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && h("p", { key: '22ce8f0b040da224a69bc35741114e1fe26e039d', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), h("p", { key: 'd1bc3ebb0c5c926cb34b856404197dd94085b6e2', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), h("div", { key: '6e229f1033c4b8d80ed7adcc7d73511f0f3075f1', class: "ir-print-room__body" }, h("div", { key: 'aeb9de8810ef53e5db61d0a0ff048016b6179109', class: "ir-print-room__details" }, h("div", { key: '5e323416fca405611b6f1656322a623740f9e6f0', class: "ir-print-room__row" }, h("ir-printing-label", { key: '06767c3d15d00d36ab2f75bdbc96d4980617ccd5', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), h("ir-printing-label", { key: '89112db8d993751e1c99327302dfae047a5762ab', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), h("div", { key: 'f511c666263c8c89116f501de233fed5b5853731', class: "ir-print-room__row" }, h("div", { key: 'f8dc940a209f9a43e1a9ac2faf28fc6c15600a1e', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), h("span", { key: 'bdfcd402b4ffb922d655adc720b7dc7e0bff11d8', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && h("p", { key: 'd4b2d4fda0fd1e30e6753d4982a64bf0466e1af5', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), h("ir-printing-label", { key: 'be8e3e0cce36c9aab89c858fc3db8d18a6a0963f', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (h("div", { key: 'cfb09d5f61875d4bb8cc6adbd0ff4912afba9ed2', class: "ir-print-room__policies" }, h("ir-printing-label", { key: '32abf406be81b66946302722b9ef82400f5bc69a', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), h("ir-printing-label", { key: 'fdf044fd2f3b792551f1e29bc7776d432f01df09', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), h("aside", { key: 'cc64df04f52cd97a7bdd55c139be26599c090e88', class: "ir-print-room__totals" }, h("ir-printing-label", { key: '2b4a9ffc4683fdfbac264b11e9e833163bac03a6', label: "Total:", content: formatAmount(currency, room?.total) }), this.renderTaxSection(), h("ir-printing-label", { key: '6d0aa27371fb79630a655e1b9625b684ee05e9f8', label: "Grand total:", content: formatAmount(currency, room?.gross_total) }), booking?.is_direct && h("ir-printing-label", { key: 'b27b9cd4437d4f628f52c99486b20234ae3ffcf8', label: "Due upon booking:", content: formatAmount(currency, Number(room?.gross_guarantee)) }))), h("div", { key: 'f8b67a64696312afbb6922961a8f84d9ad6216c1', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (h("section", { key: 'cfa18a4c091f748a892613fafb517b046c799570', class: "ir-print-extra-services" }, h("h3", { key: '8466f56adaea8182bcc03279340513dac5eb0c23', class: "ir-print-extra-services__title" }, "Extra services"), h("div", { key: 'e6ef941924660672aa24e9f36a43debd102bb7b9', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
...
const IrUnitTag = class {
    ...
    render() {
        return (h(Fragment, { key: 'd340f3915767df1f3b1995e11431676aac3ea558' }, this.showTooltip && h("wa-tooltip", { key: 'c93eed871f0da795c16e18c1599fe0d781b0c670', for: this._id }, this.unit), h("wa-tag", { key: '9dbe95c971df7e2642335461c45d31bd13a2fda1', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, h("span", { key: '93d73eb0cbffde12159f20bf6f584a373c6ffa9f', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
