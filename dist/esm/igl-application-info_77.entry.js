...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory, Z as ZIEntrySchema } from './booking.service-d5a4e046.js';
import { l as locales } from './locales.store-f4150353.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-8a36a1b2.js';
import { f as formatAmount, e as extras, h as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, b as buildSplitIndex, a as getPrivateNote, t as toFloat, r as renderTime, i as formatName } from './utils-27f20f34.js';
import { v as v4 } from './v4-964634d6.js';
import { h as hooks } from './moment-ab846cee.js';
import { i as isRequestPending, a as interceptor_requests } from './ir-interceptor.store-ebb6c559.js';
import { z, Z as ZodError, a as ZodIssueCode } from './index-ffb2925f.js';
...
import { M as MaskedRange, I as IMask } from './index-85fe8369.js';
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: 'd480caf3306472716f013bbf751a41497e15ffd6', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: '3eeb9ed8ddb77cfd8ff7cb6b536cba127ab3eb96', class: `d-flex mt-1  p-0 ${isAvailableToBook ? 'flex-column flex-lg-row align-items-lg-center justify-content-lg-between' : 'align-items-center justify-content-between'}` }, h("div", { key: 'fed1e9ae229d59254f5221ef5fa3b64a38f2255d', "data-testid": 'rp_name', class: "rateplan-name-container m-0 p-0  d-flex align-items-center", style: { gap: '0.5rem' } }, bookingType === 'BAR_BOOKING' ? (h("p", { class: "m-0 p-0" }, h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable")))) : (h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && h("ir-tooltip", { key: '72c4bc572f43460b89e639398671b77f24fb3bce', message: this.getTooltipMessages() })), isAvailableToBook ? (h("div", { class: "d-md-flex m-md-0  justify-content-md-end align-items-md-center flex-fill rateplan-container" }, h("div", { class: "flex-fill max-w-300 flex-grow-1" }, h("fieldset", { class: "position-relative flex-grow-1 w-100" }, h("select", { disabled: disableForm, "data-testid": "adult-child-offering", class: "form-control input-sm flex-grow-1 w-100", id: v4(), onChange: evt => this.handleDataChange('adult_child_offering', evt) }, formattedVariations?.map(variation => (h("option", { value: variation, selected: this.formatVariation(selectedVariation) === variation }, variation)))))), h("div", { class: "m-0 p-0 mt-1 mt-md-0 d-flex justify-content-between align-items-md-center ml-md-1" }, h("div", { class: "d-flex m-0 p-0 rate-total-night-view mt-0 flex-grow-1" }, h("ir-price-input", { testId: 'amount_input', disabled: disableForm, onTextChange: e => this.updateRateplanSelection({
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '33f539496e42e5affedf36bc10c6ddb10333ece7' }, h("div", { key: '45ec7b132d754c2a8ff7773fc88af52741ddd7b5', class: 'd-flex align-items-center ' }, h("label", { key: '188a6a77126d0da208dbdbf744fc345fd090a347', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: '150460e8f72a1ece1465e8c0c2bc207c4b1ec68c', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: '006a68559e22ae5026aa22cb269f1a5948d52ba2', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: '46beadb7b177b77c2e065213480401914acd52d8', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: '4e3a5da63382e3e4cbe6974b9d5494fd23ba48f8', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: '1a5e11e836b4f9297be576e88dfd4aed90014b08', class: 'sr-only' }, "clear input"), h("svg", { key: 'db57db59eb35450d8af8c2b0270c0b7a0f352683', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '5f0bbf7e8fbb90c6e5de0744349454fae6ca8bdd', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
};
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (h("wa-badge", { key: '9df4c862d17729534672988b5e950c1caaf8a761', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: '616a65012ad950f522138d3819a55bf3982f7fb9', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '870b3890d30e2c73da2bbccc38417a64cfc1a935', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-custom-input", { key: '4a166272c915d8b3211f94d7d64a87bdc12903b9', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, h("slot", { key: 'bbc5a32601099f43f5f27157f6793aa26b52f422', name: "start", slot: "start" }), h("slot", { key: '9c3cbb425754d8c3d73dd06220b730a3397e0e26', name: "end", slot: "end" })), h("div", { key: '4cb3f3e83fab5eddb21fa39c46bc2796b5e05375', class: "picker-surface" }, h("div", { key: 'c5c19a50146e2e484252aad94632ed23ca4de91f', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '797fe116080fdb98a6e61d2b103e6e2372ec212a', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: 'a17a051945e96202df7cf79ab51a8b1ee5334f90' }, h("input", { key: '042908e2d999fb3983b0a2e599059b53d4196963', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: 'ec1a11c3411b19fdc64f9fb89ad1847f6c666c0a', class: "d-flex align-items-center" }, h("span", { key: '4471a084c259b24a205fedb35cb86320ce39e751' }, this.dates.from_date), ' ', h("svg", { key: 'bb3d03d85d2a9eb737884bef6078ad6879975a94', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '05f4d7a5295602f3d84733a18250b0e3ae146d05', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: 'd27a4c39d7738a85c14e96e8eed0845d6db2cb3b' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '667a807a5f9b72e5d01ea0b46490865e2bedf32c', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: 'fddbf09c3cc3adb948152ebcf759b3de9d59c8b8', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss }, h("slot", { key: 'a4835e9ef30ff471a875c797e321d5d62b3a648a', name: "header-actions", slot: "header-actions" }), h("slot", { key: 'd71c80c46827293c9839bbbfc43f807f22fde16c', name: "label", slot: "label" }), h("slot", { key: '32c55528563430805f4244f57c1e0068a87f097a' }), h("slot", { key: '2a946293bcff76753654a753f9f72583e8e807f7', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'd75b1d41278d1d315ab00ac99f55bfab422e80a7', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales.entries.Lcz_ExtraServices }, this.open && (h("ir-extra-service-config-form", { key: 'fbb31fa0547b93bbc5557e71f2872f7a8c633a86', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), h("div", { key: 'ca023d8e7896620ff5703db99d3d5f2045f40dcc', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: '2974c32780d3d772b5ddd07eccca4dd8e772afe6', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '49995e4e4e3ab960ab33b5b45f55deac3253b7ef', type: "submit", loading: isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales.entries.Lcz_Save))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (h("ir-drawer", { key: '41b23624a25b5e6839f41313a18f160298f71c22', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (h("div", { class: 'loading-container' }, h("wa-spinner", { style: { fontSize: '2rem' } }))) : (h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), h("div", { key: '6e9e90a68494cba0d56b20de5502cd9803e62b15', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '6a5a07a336849d5a078be41dc18d22834de82520', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales.entries?.Lcz_Cancel || 'Cancel'), h("ir-custom-button", { key: '30e048e00a3ab40198fb5537cdbbb65bea59210d', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '0b7784ba8e06e07203e5853ec0078dd27814c0e7' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: 'c18e9de8598c907935646759f094d1a5a96a2471', class: "loadingScreenContainer" }, h("div", { key: '83960c92ec8cd7b734f5086d227e5de7dd2d1e70', class: "loaderContainer" }, h("ir-spinner", { key: 'd63382c9247f33ba2f653370ad6a88acfb18b655' })))), this.showModal && (h("ir-otp-modal", { key: '1628ea02785b88d9472b23682cf3ba30876d257e', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: 'ebfa6ad85c3ee0c3e1e7cd732e59538386d3c865', class: "otp-input-container" }, h("div", { key: '1ec6ffcfb868407ded393e2a824be41421fc3d20', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (h("ir-drawer", { key: '8131936c83e235734b2b00049df0ab937f197c72', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (h("ir-payment-folio-form", { key: '16fd87ee60889354f65f4dbb7de31df21111c145', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), h("div", { key: '6f2adfc84ce02ea4782bac91344e079732c22884', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, h("ir-custom-button", { key: '71185aed86b2c01b1e75b96d686d5d835a9eb72d', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), h("ir-custom-button", { key: '4d135a32afb330738889386d0cb1ff4c80d4100a', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (h("wa-card", { key: 'b3c4dc605e4317d861343f8598e5c260133694b7', class: " payments-container" }, h("div", { key: '17072a563282c97a40fdf61240a901749df31ba2', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '766a062722e0b0d677bcaf57003501e8544d166d', class: "font-size-large p-0 m-0" }, "Guest Folio"), h(HelpDocButton, { key: 'c13e8a823ac98759cf2310605797537396ea0ff0', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), h("wa-tooltip", { key: 'f503acad453a6cea73f9d004a9e534a013418a48', for: "create-payment" }, "Add Payment"), h("ir-custom-button", { key: '7a834b2abe85eeffcab9f041fa0884079facd62b', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, h("wa-icon", { key: '13c8b4e697eff23d1f79642017360770c0ec0e94', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b2921847833f3d4e2fb9bf1b603a2227a92ab9a7' }, h("wa-popup", { key: 'f7eb05ed4b1b9472eaff50f10bb9e001e4e5f1f9', flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, h("wa-input", { key: '562e6dbdd68ebf9ab0692eead94bc54054217145', slot: "anchor", class: "search-bar",
            // withClear
            size: this.size, value: this.query, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
            } }, this.loading && h("wa-spinner", { key: '1033ea1be35602c6329f56701532dc9c71706ebe', slot: "end" }), h("wa-icon", { key: '05a5c420f8d0330452d9ac965e2a8884bdb58e01', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), !this.loading && (h("div", { key: '0cd34893353cf4a1dfdd1dcc32e37390d634dd21', class: "menu", role: "presentation" }, h("p", { key: '68b39bf25b84db0c61a1b0fb8f34ed8cf9ec6c34', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), h("ul", { key: '3af6afab6183e12dd0c054a1506bb1da3f501650', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, h("slot", { key: 'd110336024ba60bcf4571848e8e6ac8796e04dc2', onSlotchange: this.handleSlotChange }), !hasResults && (h("li", { key: 'f363437f00ec137a5e554d8dde1f9a17ed003bdf', class: "empty-state", role: "presentation", id: this.emptyStateId }, h("wa-icon", { key: 'c572230095375127f3b9f1c1a9189a41d1e2d02a', name: "circle-info", "aria-hidden": "true" }), h("p", { key: 'f5490cc18df9fb00c9136700d447cd8eb26ddeb7' }, "No results found"))))))), h("span", { key: '1f4bfff92ff82b610ed44232fc2cd0f1708ad77d', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (h(Host, { key: '4e2fdb4c8824db346dd963d6fbd6fda763669ac5', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, h("button", { key: '9b643d87cd7382dcb683589bef5e2d97f4cc1cd5', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, h("wa-icon", { key: '964d9bbea9bb4738734b835197c0d1c5a13342fd', class: "picker-item__check", name: "check" }), h("div", { key: '1699bb93d76f418d7fc5a8de736444b1c553ea4f', class: "picker-item__content", part: "content" }, h("slot", { key: '714a136ec0a28d7d9c129e47bb144206a4ef3739' })))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (h("form", { key: '366f0b02f96432c4e2a01d1de2046fd592c42696', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-validator", { key: '1f9c627a8b863ef35501099ebfc16943053a0356', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '02f1611912cca4293afbdaebaed559af8ef5a900', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, h("wa-option", { key: '2a6c8976a6cfa476bdbcddc0f80002ddc2ce01ca', value: "" }, locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom).map(option => (h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (h("div", { key: '0a84c5636963a891f218efc46c1d9ef3ddcb3dd2', class: "pickup__container", "data-testid": "pickup_body" }, h("ir-validator", { key: 'd4987d0365a9a3c0ccbd75eb1a0d2bb04544ae16', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, h("ir-custom-date-picker", { key: '89e42d8aa94e6482b5e9bc5c93988d417cead52a', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales.entries.Lcz_ArrivalDate })), h("ir-validator", { key: '84a585abc1bc34315aa276e9558e7bbb232a62f2', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-custom-input", { key: '8ce8d5fbed14729783530cee180a4f15aa69d2ec', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales.entries.Lcz_Time })), h("ir-validator", { key: 'c878133ca64b2c05f220bb3f2fefeba70ffa0f39', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-custom-input", { key: '79dd0dc3fd39455a0ad720ca7923cba59ded87f7', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails })), h("ir-validator", { key: '6dc35506eb7a5929caa28c5dae2ee335bb860c36', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '049e429ffa0ba09e5674029e5e449339d46754ed', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), h("ir-validator", { key: '6b4ec5b3b48818fcd75935fd70196184a5c9dcd5', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: 'f54b9a88c0d8c0e31f7364cc453d667d1feb940b', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), h("ir-custom-input", { key: '9dd2ff7b6379bfccba659d4128db46582e552a36', mask: 'price', readonly: true, label: `${locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, h("span", { key: '4c8a569e1b59f370341f613c7b5a7bebf09c1066', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: '0ea722bb667eb255bc53cb581bfbf1373d90112c', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        return (h("fieldset", { key: '60e395a470a02f734711f18ce15e177ca66fc9ba', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (h("div", { key: '6d59c7fb72392186ca6dd5460ca3616a4bde9a1f', class: `input-group-prepend ${this.labelContainerClassname}` }, h("span", { key: '884b77409a54554823327110b49255d1ba47b844', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: '413f8aee566221c5b084143601af9491ff15fb4a', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: '61b013ef41c806bf939c23d6359aeac3e35da124', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: 'b07e5325e6632edc30cbf97059f05a8af3b28d19' }, h("span", { key: '27f89301478406db54bc3759fbf6ac96aac14cba', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: 'de0a8147742732654ee196e09bbb63a7741b9d3f', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (h("ir-drawer", { key: '3ecfaf1868a6e88c402194c8eec095ff0b1accb8', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (h("ir-room-guests-form", { key: '6631caef3e8cfac908897c7eeb60da8475cbb05a', sharedPersons: this.sharedPersons, roomName: this.roomName, countries: this.countries, totalGuests: this.totalGuests, identifier: this.identifier, bookingNumber: this.bookingNumber, checkIn: this.checkIn, language: this.language })), h("div", { key: '0c3789e56d935046048e8b89ca3e592a1ebd7c78', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '191f9705b513621c5d38da6018b0922177fdd420', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales?.entries?.Lcz_Cancel), h("ir-custom-button", { key: '29e55aa152e197a85b9d1b3bab008ba94d17f449', loading: isRequestPending('/Handle_Exposed_Room_Guests'), size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales?.entries?.Lcz_Save))));
    }
};
...
const IrRoomGuestsForm = class {
    ...
    render() {
        ...
        return (h("form", { id: `room-guests__${this.identifier}`, class: "sheet-container", style: { minWidth: '300px' }, onSubmit: e => {
            ...
            return (h(Fragment, null, idx === 1 && (h("div", { class: "d-flex mx-0 px-0" }, h("h5", { class: "mx-0 px-0 sharing_persons_heading" }, locales.entries.Lcz_PersonsSharingRoom), h("p", { class: "mx-0 px-0 sharing_persons_label" }, locales.entries.Lcz_PersonsSharingRoom))), h("div", { key: idx, class: "guest-grid" }, h("div", { class: "room-guest__section" }, h("label", { htmlFor: `first_name_${idx}`, class: "guest_label" }, "First name"), h("ir-validator", { class: "flex-grow-1", schema: ZSharedPerson.shape.first_name }, h("ir-custom-input", { "aria-invalid": String(!!this.error['first_name'] && !isRowValid), size: "small", id: `first_name_${idx}`, placeholder: "First name", "onText-change": e => this.updateGuestInfo(idx, { first_name: e.detail }), value: guest.first_name, maxlength: 40 }))), h("div", { class: "room-guest__section" }, h("label", { class: "guest_label" }, "Last name"), h("ir-validator", { class: "flex-grow-1", schema: ZSharedPerson.shape.last_name }, h("ir-custom-input", { "aria-invalid": String(!!this.error['last_name'] && !isRowValid), size: "small", id: `last_name_${idx}`, placeholder: "Last name", "onText-change": e => this.updateGuestInfo(idx, { first_name: e.detail }), value: guest.last_name, maxlength: 40 }))), h("div", { class: "room-guest__section" }, h("p", { class: "guest_label" }, locales.entries.Lcz_DOB), h("ir-validator", { class: "flex-grow-1", schema: ZSharedPerson.shape.dob }, h("ir-custom-input", { "aria-invalid": String(!!this.error['dob'] && !isRowValid), id: `dob_${idx}`, mask: dateMask, size: "small", placeholder: "", "onText-change": e => {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '7df813829cb49ff6ed29be54963acc193471a5e6', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '4b9546fe94f551500f170c75f0b480927a5ebf8e', class: "input-group row m-0" }, label, h("select", { key: 'a77cd42306482a018400dae87a0e0b599cfc2f5e', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'b87b6d5c2c78ea24a1119c27740a1f106826dd97', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return (h(Host, { key: '6c7c0a42081a8f67cbcfe489bb3ed8bc539232bc' }, h("wa-spinner", { key: 'ebdafd47e41f9678839ab9cf13b20f6caef942d2', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrUnitTag = class {
    ...
    render() {
        return (h(Fragment, { key: 'ac9639d2611166558f3a3d0b156c6a26542c9b3c' }, this.showTooltip && h("wa-tooltip", { key: '720833c02dc0fab6a74220bd2d3ee2b2a4fd9b65', for: this._id }, this.unit), h("wa-tag", { key: 'f3dc7582bd7c0dd32f8504eeca57f7695d6f4be0', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, h("span", { key: 'c039f95325a88f01f30c1d8fb2590fb52295703c', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: 'd9d5f104c800f9173df751709f0c987d2bf7a35a' }, h("slot", { key: '2d99a0acd06cc18341e3a58d2734e0ac8091257e' })));
    }
    static get watchers() { return {
