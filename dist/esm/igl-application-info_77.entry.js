...
import { b as booking_store, m as modifyBookingStore, B as BookingService, s as setBookingDraft, c as calculateTotalRooms, r as resetReserved, a as setBookingSelectOptions, d as resetBookingStore, e as reserveRooms, u as updateRoomParams, g as getVisibleInventory, Z as ZIEntrySchema } from './booking.service-ddf613bf.js';
import { l as locales } from './locales.store-f4150353.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-8a36a1b2.js';
import { f as formatAmount, e as extras, h as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, b as buildSplitIndex, a as getPrivateNote, t as toFloat, r as renderTime, i as formatName } from './utils-74b435e5.js';
...
import { A as AirDatepicker, d as default_1 } from './en-f7f65279.js';
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4169417fc20c275a4ec848b47db306105237a94b', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, h("div", { key: '207b15239dbc35ef209f87a9766fc9672854fc0e', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: '9a98e01b373d2f9c2ff0dc518ead31763fdcac34', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: '19a40e11dd6175c64d1b6f957502ac808a3035d6', class: "fd-application-info__details" }, h("div", { key: 'd8f0c5247e9aaef1fc9bf53b0618ab63f7ddce23', class: "fd-application-info__rateplan" }, h("p", { key: '4219b032bbeb8cc3f91aef7ffca547811ef45f87', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: '54a77c37d3c51cb3646014a301b8b764708d6ca7', class: "fd-application-info__non-refundable" }, "Non Refundable")), h("wa-tooltip", { key: '7495a4e3f811b5c58960bbc0e368d23a10edb071', for: `room_info_tooltip_${this.rateplanSelection.ratePlan.id}` }, h("span", { key: 'a98472c123acd291ea3a12d53d1a0040937050de', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: 'b868da4cffae0f2e024f756cb9ffccfd4f7392f0', name: "circle-info", id: `room_info_tooltip_${this.rateplanSelection.ratePlan.id}` })), h("p", { key: 'ee8e27d27227adbf4e57014951b8fcaa14a1419c', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("p", { key: '34d1cc0eccf750025578f72d9a2fdf5cb767874c', class: "fd-application-info__price p-0 m-0" }, h("span", { key: '14a2e09bab02db0e9e29754a0b43cd11de9448da', class: "ir-price" }, formatAmount(this.currency?.symbol, this.getAmount())), "/", locales.entries.Lcz_Stay)), h("div", { key: 'c2e8c4e357ab0460bdddce86d112914d12dde9fb', class: "fd-application-info__footer" }, h("div", { key: '1edaee6891e6e9d9787264d0a36cd3cd5f3d6538', class: "fd-application-info__rateplan" }, h("p", { key: 'eb08c2b96c53c5d660eee2e45301d35d1d236155', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("wa-tooltip", { key: 'ae09bc4ea94dc420e2fe8a56c844bfdae7aa8410', for: `room_info_tooltip_mobile_${this.rateplanSelection.ratePlan.id}` }, h("span", { key: 'a7d5fd5135b66b8b349f56f192b88568231aaecd', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '7ebd9cd2b4c9c991a626cb67d4926366fc68c778', name: "circle-info", id: `room_info_tooltip_mobile_${this.rateplanSelection.ratePlan.id}` })), h("p", { key: '99243be7972d50c8c5f2075c26f01195445f1abd', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("div", { key: 'b65efbe9800a3601ec6f37a7538cd1f287e3c857', class: "fd-application-info__form" }, h("ir-input", { key: '8068d93bc4b0f3d3eb0102a09a00111ad5bf57e5', class: "fd-application-info__input", "aria-invalid": String(Boolean(this.isButtonPressed && this.guestInfo?.first_name === '')), value: this.guestInfo?.first_name, defaultValue: this.guestInfo?.first_name, "data-testid": "guest_first_name", placeholder: locales.entries['Lcz_GuestFirstname'] ?? 'Guest first name', "onText-change": event => {
...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5f2bc36497176401550d17ca6ed584324b398246' }, h("div", { key: 'a5e4975eb449e0db85703765155d1b0a22a1e1cc', class: `m-0 p-0 mb-1` }, h("div", { key: '464722a11cc28beaa852a2ec3fd4b793a5bd102a', class: "text-left p-0" }, h("ir-date-view", { key: '4023f8f9cc4277363eb4abf9aaf9d6b81b86e5c0', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), h("div", { key: '554fe2e97198bc41443b1c5b776703bd472633fb', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, h("div", { key: 'fcf1ce823ff52e724524268230c6db3dfbbd147d', class: "mb-1 " }, h("label", { key: '6e0bb4b8de52ddd1e754ae01362147d6e63d200b', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales.entries.Lcz_Reason, ":"), h("div", { key: 'de22d73fd43e4618f13fb0f338ddc7963a025c7f', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, h("input", { key: 'f8f888c91d7786657a2323a7602e1b2980b91071', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), h("span", { key: 'd0244701a18577216aabb7bfbff0ae9f74b5d977', class: "align-middle out-of-service-label" }, locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (h("div", null, h("div", { class: "mb-1 d-flex  align-items-center" }, h("span", { class: "align-middle" }, locales.entries.Lcz_Or, " "), h("div", { class: "d-inline-flex col pr-0 align-middle" }, h("input", { class: "form-control", type: "text", placeholder: locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), h("div", { class: "mb-1 w-100 pr-0 " }, h("span", { class: "text-bold-700 font-medium-1" }, locales.entries.Lcz_AutomaticReleaseIn, ": "), h("div", { class: "d-inline-block" }, h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (h("div", { class: "d-inline-block releaseTime" }, h("em", null, locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '39e371b2107e21d5c597205415fc1f82f762ac26' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), h("div", { key: 'e2ec09ef725b96ddf9beac84a4d63aeb806aac7b', class: `fd-book-property__header-container` }, showSourceNode && this.getSourceNode(), h("igl-date-range", { key: 'ec9047bffb83d7b6c01eaf03ad9faa34b3d94c78', "data-testid": "date_picker", variant: "booking", dateLabel: locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange }), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: '7889fb83a912c3e620577032a376d3c309a6e9ed', class: "text-right message-label" }, calendar_data.tax_statement)));
    }
};
...
const IglBookingForm = class {
    ...
    render() {
        return (h("div", { key: '29bbb3d2a0a95e082fdcc75c6f58989a0a24df07', class: "d-flex flex-column h-100" }, h("div", { key: '770a47d94ffe0be0a66a814af893195f12a2b222', class: "d-flex flex-wrap" }, h("ir-date-view", { key: '4a4b150db09094ea66bc0cc664bd79ab7e77ddb4', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (h("div", { key: '97daebae96cc446d1e6d55d9708bd57c0796a30e', class: "mt-1 mt-md-0 text-right" }, locales.entries.Lcz_TotalPrice, " ", h("span", { key: 'a244f59a9bdd2b2bae89849044b38f12ca98a94b', class: "font-weight-bold font-medium-1" }, formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: '4f56deb6ac2ebd3d02908f04db3406982300d0ee', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: '4af60caab0fee78177ee202f2d94b57e353134a0', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, h("div", { key: '841409be592912df53fff3d42dcad06d8d74c292', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (h("p", null, h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable")))) : (h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (h(Fragment, { key: '2cc14e5e120af9ff64d6158fa673ea26dc4b1559' }, h("wa-tooltip", { key: 'e6ced321e02b4fe645c90db13990256492e4f0de', for: `rateplan-${this.ratePlan.id}` }, h("span", { key: '7f895890c65c5a4dea45c0d3ee9ae4ed25357fc5', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '6e44b77b62f2c68b4cce5fa04770744869e0b318', name: "circle-info", id: `rateplan-${this.ratePlan.id}` })))), isAvailableToBook ? (h("div", { class: "rateplan-container" }, h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (h("ir-drawer", { key: 'afce846a7e2f9cf41b47f31b1b8e3f59cdb07d76', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && h("ir-billing", { key: 'dfde1d7d5091ccf79c79e98f52895d242e90c43f', booking: this.booking })));
    }
};
...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: '29924ee05781e1f399b004f8d238fc9721f5d46f', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (h("ir-booking-company-form", { key: 'f02ef58a6799a2b97681ce346f428251d23203a4', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), h("div", { key: '6ac805dc8e6cb7584c49c448cb639d4908e0a7b3', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '90ec31f57c0001e7ff6c6918ff567c30f1154a24', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: 'e6ab7ded88f105e389d0651089158d7bc3f64d10', type: "submit", form: formId, loading: isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (h("ir-dialog", { key: '1ad49d3a85b330c4d846a6db47f083d260e1a3b5', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, h("wa-textarea", { key: 'c876eb865510f2ecbaa7b60861ee4f1fd732c396', size: "small", placeholder: locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), h("div", { key: '4cfded467181b590d9eb2ce40a17143fef714f71', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'a56d9ea86766694bab58f2d7f0436f824965a9d3', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'b5eaf7f9c4663441868e37cdc43d5dad8034ff7b', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales.entries.Lcz_Save))));
    }
};
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (h("wa-badge", { key: '922097674808ad8d51b56db5171c1102aef87c2e', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0fdef035afd988585dc2c863c80bc082174ad11a', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '64e06ef2d4e02e440d75f29b1f6cc63211f985b3', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: 'ef15ae0f638f04aaa494bc3bfb569aa2709120f7', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '4c8401f418a2f64fb8484cc5b50697edc7cda47b', name: "start", slot: "start" }), h("slot", { key: 'dbdb66c05908945a1831d3d18dec908178e3031f', name: "end", slot: "end" })), h("div", { key: 'bf76c39740fd2b83d20a2199484900d52031fad4', class: "picker-surface" }, h("div", { key: 'eb0293cbd2ac023ce6254c6b5b9ae0a96ac28bd7', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '9511b17baffa9753d3c57f933384ade7e67d962c', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '45f39f4c56d70dd358eb39de2baf2f5da3af3869', class: "d-flex align-items-center" }, h("span", { key: '16a48c0a3426c682c22295c4adea99d05c39fc64' }, this.dates.from_date), ' ', h("svg", { key: '9d77b4a3da8777be1016b84b526231fb2fc8218d', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '3f33b438459cc14f4f11cf79c523846967f2dd7f', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '49eb2634e47c83439dc92bed684876e554661bb6' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: 'a5e050f4c6129ad347efcbfac897f74f3d705120', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: '69fd57db345d237ad9e89db4c64e2d312a64b67a', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'b3374a4743daa04a476657dfd063961f35624601', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '501dfe83d9c9e4e3bf9ab5a997f207894446f38a', name: "label", slot: "label" }), h("slot", { key: '9b67d11c8f0e71570172a1081c0aca8483c289ad' }), this.slotState.get('footer') && h("slot", { key: 'd2cb9697a5caf2d4cadc2d0a8b3acea25958dbf7', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (h("form", { key: '42a2153e5896154c64cef2351f613c23b8409aeb', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, h("ir-validator", { key: 'edf1ad1441addc716acf762317d01f5463f2425b', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, h("wa-textarea", { key: '1ca465629dbe1be957ccd0092a827f34e9eb2dd8', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales.entries.Lcz_Description })), h("ir-validator", { key: '1e1392522df9b92e1f8ac6ec51c557f2678e2fed', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.start_date }, h("ir-custom-date-picker", { key: 'f4e8aa8fb45a7da246b49cd4e0f490f8ea9fbe3c', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), h("ir-custom-date-picker", { key: 'd1d2be386494d4ff688302595cfb3c3fa0dd0a19', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), h("ir-validator", { key: '9e6440524180765347614c5585ef54699f33cbc0', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, h("ir-input", { key: '9b07ef57cdcf7a21e44960c9c9e35fff5d7557d0', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales.entries.Lcz_Price }, h("span", { key: 'fd9c85f64cda92ba2f6f7c50f0089d80728aeff8', slot: "start" }, this.booking.currency.symbol))), h("ir-validator", { key: '19bbb35f78df9eb96e6315ac305d597e8e6489b4', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, h("ir-input", { key: 'c5f6527ee0fa0ab70bf3c6b61260fc0682cb3ac3', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales.entries.Lcz_Cost }, h("span", { key: 'f5372fb33efed00b2c543a88f60c87e4b54f811f', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: 'eeda11dfa1d8ae2c7c3607e923c9ad7fe8b3fdda' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: '4aba42f14d35eb7aec0c0c3155e58e8251bd2d41', class: "loadingScreenContainer" }, h("div", { key: '85968058a2d9b501f1f53ea2938b501a7d1b1a8c', class: "loaderContainer" }, h("ir-spinner", { key: '8e7b78a2dbbee21cb0cac9c989994a0f24b823d9' })))), this.showModal && (h("ir-otp-modal", { key: '5d8f2a691f701708d84554adcf338be14a15bcd9', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2619dfcf4cb0a13a3010e152236ff7d04fe9ed01' }, h("ir-drawer", { key: '5522d030e25ea7daa61ce71ef541e5b3c54f67df', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, h("div", { key: '425e3dcc18071c2ad8d6e011cbf1808c481ab8e3', class: "d-flex align-items-center", slot: "header-actions" }, h("wa-switch", { key: '26bb862eac2955eed4ad0cdc2afd5a8531e06223', onchange: e => {
                if (e.target.checked) {
            ...
            } }, "Pro-forma")), this.open && (h("ir-invoice-form", { key: '8c97426b9d24430cb57942672f9437a9b7514b4c', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), h("div", { key: '943b9003dbe721ab314dc2ef08654b3d747584e2', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '179d548c76f8e5d18c88120742a658125e9036f7', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), h("ir-custom-button", { key: '5e7c202dbf199b111c1989abcee368761ce81295', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), h("ir-preview-screen-dialog", { key: '8b77dfe9e9242ffb3bfe32004a8b84e40705decf', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, h("ir-proforma-invoice-preview", { key: '226753cb7a589d2d3c7d26495a0cc5f76bb957be', invoice: this.invoice, property: calendar_data.property, booking: this.booking })))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: '4e2a1596bd15e751bd0accdb97a780cf20c83748', class: "otp-input-container" }, h("div", { key: 'df0eb383d643464c42e9299014c96910ea241502', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (h("ir-drawer", { key: '571e39077adc0ef426f5a9e439f532aea27e13f3', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (h("ir-payment-folio-form", { key: 'e3254f1fe537dd6e8c374cdedb5dc4d97e74c162', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), h("div", { key: 'e49f57c8a96203984404eb83c53b544fa775c2b9', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, h("ir-custom-button", { key: '00dde7ae9a4644b599361d3690df74c7f4c783c3', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), h("ir-custom-button", { key: '5fea0e51a24a9637a19ee805172c69dd0774cfa6', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (h("wa-card", { key: '758c9dfaa2d148c32fe7d9afa528cf2953130563', class: " payments-container" }, h("div", { key: 'f92457e333886c1d228f2a45ba5a84a6a3498020', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '96bfad9b2065b7201548e183a9904f1ae00001c0', class: "font-size-large p-0 m-0" }, "Guest Folio"), h(HelpDocButton, { key: '2d74d6ca87cefaab51b7f64b7e89a1df8cf94605', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), h("wa-tooltip", { key: 'd60051e06348933d7e9cd44dd821c3868ffff3f1', for: "create-payment" }, "Add Payment"), h("ir-custom-button", { key: '64d78f103bc58c046d420be50e208627d1b48485', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, h("wa-icon", { key: '12410b37903aa6279fed2eb7f143d04d0ddedba2', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ba66c6cb1a057f864d08404452fbf986c39047de' }, h("wa-popup", { key: '30ad590f00ecdf0daf3b630eac9284605be641bf', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, h("wa-input", { key: '300eb2242c8ebdb625573fe53792635ca2883fc1', slot: "anchor", class: "search-bar", withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && h("wa-spinner", { key: 'a9c7b9526a6121f51cb670491c6bb43e5e4f719c', slot: "end" }), h("wa-icon", { key: 'f85dbbc7a9a07a46f99f11606fdb3f0df1dce9d9', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), h("div", { key: '5e73ec45311d29f1bc1aef5cad98575edd88c695', class: "menu", role: "presentation" }, h("p", { key: '151bd84d58320271a00c20bc7981372468f63c81', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), h("ul", { key: 'b1c574d073cb383fd00a9f63691e72ae262b88d1', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (h("li", { key: '3f3cbf61109abfab42b4ea3edd01f559f234e5e4', class: "loading-state", role: "presentation" }, h("wa-spinner", { key: '14e0318056db73e91514f426dc67b79084db5b0c' }), h("p", { key: 'e83539f3edc3ca5d949603eaadb0330d40ce938f' }, "Loading suggestions\u2026"))), h("slot", { key: 'c66725d680599a7eba86005ec58d427a98d83d3b', onSlotchange: this.handleSlotChange }), showEmptyState && (h("li", { key: 'ff84be6ea7d3e1c433b762960d3b613035578950', class: "empty-state", role: "presentation", id: this.emptyStateId }, h("wa-icon", { key: 'a57b4086b3b9914c601acef1425f517ae9f09fb0', name: "circle-info", "aria-hidden": "true" }), h("p", { key: '05536e9b1b597f47f45064aeaa7376ca6a29808e' }, "No results found")))))), h("span", { key: '8169efdec8bb418b1a1bbc70d77a22875557c512', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (h(Host, { key: '43ba22b3a7bbdd45f453d84dbe4f6688675be5cd', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, h("button", { key: '617317f3ea11a79488a5294ceb645a118031c7c4', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, h("wa-icon", { key: 'c12c9ea574da6a183bdf5ec9ad2838ff34da5433', class: "picker-item__check", name: "check" }), h("div", { key: '1c9d11a009cfdd4d31952c9687fc3caed2587f31', class: "picker-item__content", part: "content" }, h("slot", { key: '983bc7fd02522753b92803ad245ab9652d0c1304' })))));
    }
};
...
const IrPickup = class {
    ...
    _id = `pickup-form-${v4()}`;
    render() {
        return (h("ir-drawer", { key: 'efb4353ce87d015fee29e43071b24accc7ab9fc8', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (h("ir-pickup-form", { key: '9fefad979b9a5b764f0e7d7ba524b552fa50d007', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), h("div", { key: '112239cd3084154c15f0eb2840a2c475ea1b2628', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: 'a46ab5f861d5f836fdd731024d96f4540a921f1b', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales.entries.Lcz_Cancel), this.canSubmitPickup && (h("ir-custom-button", { key: '71c98c274d6e686a75d60e52115cee17749681d0', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (h("form", { key: '37b4c9775f4095bf333bf9d41bc18223dde6db30', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-validator", { key: 'c21230af61e222bbbf8ff0841672bbf84d7063db', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: 'c7892f07ec74cb9642f679ecd606c47bbed7a8ad', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, h("wa-option", { key: 'd97278c21a809ae00756c493b631e0e0de042756', value: "" }, locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom).map(option => (h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (h("div", { key: '56b34bcda57c40b1db43da65c3863e7f8743dce6', class: "pickup__container", "data-testid": "pickup_body" }, h("ir-validator", { key: 'b1b205cc148c5b7bca62344034c308bb7ed01ec8', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, h("ir-custom-date-picker", { key: 'c8bed91f9222586594478614070646c821ed0d89', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales.entries.Lcz_ArrivalDate })), h("ir-validator", { key: '729c06dd5da47e116f8cca71ea87ae8805c52e8b', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-input", { key: '293e443cc0809755acd71693683d5614ab724483', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales.entries.Lcz_Time })), h("ir-validator", { key: '2246fddb555bace62ac22557320f597d4b7ff338', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-input", { key: 'cf22df014ac96a1667c3ce48bd568481d9468777', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails })), h("ir-validator", { key: 'e03a3efd54349b41a7f78a275f884d53a4d13516', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '3b5c03d5205c6a73283a62c33394c6dc0776874f', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), h("ir-validator", { key: 'dcda88e34144dc69d80bb716763de9681bc41d29', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '109c80b04278e41198ef449d77c02545c0a8e826', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), h("ir-input", { key: '08bdf10055faaa877ec750415d955cdd5ad62664', mask: 'price', readonly: true, label: `${locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, h("span", { key: '43434f170279f0086583a9cacc47be1ac87909b9', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: '7bf6f594bd37afd6950c76d879837ddae5f050c1', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (h("section", { key: 'a26e040cb32dfe4af0168b2ce60eef7ae66c3df0', class: "ir-print-extra-services" }, h("h3", { key: 'a4fa867e6dc0298a3d6a394f3fb482ab796eb479', class: "ir-print-extra-services__title" }, "Extra services"), h("div", { key: '882ee29b73a0aa8b65bdaa0d53b519616b8f2f78', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("wa-card", { key: 'ebab26c14de00bc7eb967c9ac6c7dfdbb8903f0e' }, h("div", { key: 'c4209180bb6199d0c29875e66b7bcfc40322f5c0', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, h("p", { key: '4121ddfe4531b164f46339c0d80c6c0cdacb82cf', class: "reservation-information__property-name" }, this.booking.property.name || ''), h("ir-label", { key: '1dd3c11e52fda37c06e374331407cecd50f1d38b', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: '69f8230bbd8b45d3340d575a0ab811e5fafaaf32', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("div", { key: 'b71c75e155ae036d14c1cd985ec5c27530790b3f', class: "reservation-information__row" }, h("ir-label", { key: 'c8e6c1e33fa5398b719f00441ac95d37bbcee8ff', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (h("div", { key: 'f17be37c0589834373fc65111ab640edced8f99b', class: 'm-0 p-0 ', slot: "prefix" }, h("wa-tooltip", { key: '62f43052131248fee8164f2c18881588af44e7a5', for: "guests_nbr_confirmed_bookings" }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), h("div", { key: 'a818860285506a5ac80853d969bcc8f6c7a47898', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, h("span", { key: '43f0a1b4db6d4fa31c05651b17e6bf47a49117b1' }, " ", this.booking.guest.nbr_confirmed_bookings), h("wa-icon", { key: '3bc3c48f43d91a71a0e7a908b6366dd7b0ed6b28', name: "heart", style: { color: '#FB0AAD' } }))))), h("wa-tooltip", { key: 'c7499b1683651e9d4df6cf6213b16500d4b1f529', for: `edit_guest-details` }, "Edit guest details"), h("ir-custom-button", { key: '602af99e5875d7153e2fb561f84c502ff403a208', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, h("wa-icon", { key: '969fb9d0cfc3378dc219e672609feea4cb91739e', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), h("div", { key: '464d28a76222515b0a29218ab5fd83314cde2480', class: "reservation-information__row" }, h("ir-label", { key: '69a09d06d49e5e228f7a76f83d0ec405fe700deb', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), h("wa-tooltip", { key: '0e5b256cbf04cc3823fe88f368057dc49c4df33d', for: `edit_create-company-info` }, "Add company info"), h("ir-custom-button", { key: '9e58dd63f5bfe405495d7daa04cb27076d7d98b4', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, h("wa-icon", { key: '59ed7b5dce1089ce2b189c38ca5571a0e3ebaec9', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && h("ir-label", { key: 'dcdd40582df1685fac33045e8fba642763ff6d9a', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: '35e74a1e6f8bb88b82a7e9a8c3fa42718e6566a9', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: 'ee85dcf900523f4c7fadeafc9a29258fd3af8be9', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && h("ir-label", { key: 'e435924d9cb6572e8de0ed8af1da1b75306a6639', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: 'cbde4c70bf42c8220053f8f14537e9b5fb5a546c', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && h("ir-label", { key: 'be6729105e07cbecb72d2fb03828447fdef2d2ae', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && h("ir-label", { key: '27e4e19712f7ad98024a04f16b4138d843b85a85', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: 'e8fdf85d0ea706a516245650500dabe500b428e0', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: '66628c8b21468fe1568689b7bd8886d26b2d28cc', class: "d-flex align-items-center" }, h("svg", { key: 'cac184aa326310dd74d50e996048d920ac2efc36', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'fa1fc1ca365d98d6332336d1c6be602192350014', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: 'd1d883e0fd9d480ac31595669518c6e6e9631e12', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), h("div", { key: '814b6dbcc59e23a616f5c1e2c5adfa92a2bdad6a', class: "reservation-information__row" }, h("ir-label", { key: 'd3e93382c3694a47228cbae5d4737f8a2066fb5b', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("wa-tooltip", { key: 'be06f29fb55d146253e2b77838cff2888dbf671f', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), h("ir-custom-button", { key: '988a060791801eeed741dde270e2fe21661cc15e', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, h("wa-icon", { key: '71a3a671afb7d1d0e9ce6e198a85472301ffffa5', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), h("ir-booking-extra-note", { key: '7ce9affd6e350d9597229a89456809afa7181635', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), h("ir-booking-company-dialog", { key: '1f6734dc45def8eb9ef5688786fe53f281fb3c67', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (h("ir-drawer", { key: 'dc6fe7dce9e8884cbe1afaa1e67fdd51c2865f89', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (h("ir-room-guests-form", { key: '7e42f086ed96fa1791a3051fa59e41ead19d4d69', sharedPersons: this.sharedPersons, roomName: this.roomName, countries: this.countries, totalGuests: this.totalGuests, identifier: this.identifier, bookingNumber: this.bookingNumber, checkIn: this.checkIn, language: this.language })), h("div", { key: 'a1bad694d7d5801463c8cae9b9a67624f1e3e743', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'ed56fb7b7d33f7c420d167da8fa1596a2a583385', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales?.entries?.Lcz_Cancel ?? 'Save'), h("ir-custom-button", { key: '37317a53d018eb4d047e5767e140cd51cf09ec65', loading: isRequestPending('/Handle_Exposed_Room_Guests'), size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, this.checkIn ? locales.entries?.Lcz_CheckIn ?? 'Check in' : locales?.entries?.Lcz_Save ?? 'Save'))));
    }
};
...
const IrUnitTag = class {
    ...
    render() {
        return (h(Fragment, { key: '3d9f0fa350581ea728021081d92c2c0773c309a8' }, this.showTooltip && h("wa-tooltip", { key: '03b7d5e7915efbd22851b76fde0e84ebd29028f8', for: this._id }, this.unit), h("wa-tag", { key: '2d17bf881af8f4ac8dbfc78253fefa48d0fed3e3', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, h("span", { key: '7d1fd207002bd668ca78f3674c581d603c54152d', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: '11859f7b7839b959980a031a81f9ac60f176ac79' }, h("slot", { key: '4cd3bfe3a6c67e16e09dd68cd0878bc536abf187' })));
    }
    static get watchers() { return {
