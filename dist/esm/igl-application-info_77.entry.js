...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (h("ir-drawer", { key: '2ed7dbdf73370e7529fbb9e26a2aec6ac767bb99', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && h("ir-billing", { key: '1bbb56aa414e74998559adfecc73ff898b82340f', booking: this.booking })));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (h("form", { key: 'ca92116286b61777667593396b4d83ffbc1d4d21', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, h("ir-input", { key: '58403f2d5968b7cb82753370590ab824c657e5ae', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), h("ir-input", { key: '3696ce57e1b53505077659d1710cfede2ff29aef', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (h("wa-badge", { key: '7ac098cea4b19b6edd942cda211cc25a85c660b1', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd43e410eeaab2ac942328e7db871b3693be0ceef', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '92f4ebce8006a02b48c65a346a104a7e5410efc4', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '4ae387dd38d99501b1ef7dfe2b1dcd57f2341114', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '01a810a8e2f08a01ee5ee62fb0d443b43bcde2e0', name: "start", slot: "start" }), h("slot", { key: '2f1fe38dd84af1ba517fdd684b2ea8281d923871', name: "end", slot: "end" })), h("div", { key: '2846c4f6c4251414f022dc315e4a8ceac07d1129', class: "picker-surface" }, h("div", { key: '845e738794d666b07a7d0bd6bc8a6b6f8abeb252', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '62d81e64f6d496cd7cfc90d63a2e17779f4cccbb', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: 'fe31b7e433faeb9e0bb8e8fdf13faae4ffbb6d63', class: "d-flex align-items-center" }, h("span", { key: '10b46a702507826b019170776bc9fc0d696e8f09' }, this.dates.from_date), ' ', h("svg", { key: '6de56181d9bf89aefe18172a4cac1e8e480417a9', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '01c51758d4fbede44a804ae4fa4018cd18dccfc6', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '90906208ca27fddd356c4bb23fec5c668c056908' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: 'c1d44ed5feed5defff5a839193b0409124c27dbe', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: '5554c70888b023ddfb022868617c558b343b4308', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'c4658cbbdba597df68768802ad8df60ace1ca490', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '4e10be96fb67dc4b0b8e549d7b1728a4f8a6490f', name: "label", slot: "label" }), h("slot", { key: '6f619f54a37621e5b3f95af4017a85eb8b262850' }), this.slotState.get('footer') && h("slot", { key: 'd6463749b1f2afbaeac5d4eb90b135d426735733', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (h("ir-drawer", { key: '0a06410c0afacd63c6fa46ed075fe283b8df2992', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales.entries.Lcz_ExtraServices }, this.open && (h("ir-extra-service-config-form", { key: '8d2ce36d6d3bbca2d827fa95217fe009ec374baa', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), h("div", { key: '1d5e6b76fa20bc55763d68c7255a5012f9736023', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: 'e15a4f3cbb019963cb70fb7f417cac6a233c1b14', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '95dda3149ac06abd7dd8982d02a9b2552ecc6d47', type: "submit", loading: isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales.entries.Lcz_Save))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (h("ir-drawer", { key: 'c62808555b8853b84b077e72122398d1cfc40587', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (h("div", { class: 'loading-container' }, h("wa-spinner", { style: { fontSize: '2rem' } }))) : (h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), h("div", { key: 'e36c3abdd0970894a96de60d4f59d10d3b504934', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '6f1cf413fa645348b1bc9c801d4596e2e33eafe1', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales.entries?.Lcz_Cancel || 'Cancel'), h("ir-custom-button", { key: '2f2307b5f8d3d8d7110a9087ffeb499f3e4f0607', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '6732b0d161d2ab835dffac88ff58831eb637d0de' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: '8bca37460a17d1a1a7a6a547c02c9f85cf8d9ad6', class: "loadingScreenContainer" }, h("div", { key: '4e041dfacb7a4ce3fd9a56c125ce8b9e8a48f685', class: "loaderContainer" }, h("ir-spinner", { key: '158253a29fa33af4adbb260ecb7edf78b9048331' })))), this.showModal && (h("ir-otp-modal", { key: 'b69e75eb40f4d6ff2e23be522abc13dbabae52f8', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c9c8714526dee9bb96df72fbb845df5073cd2a35' }, h("ir-drawer", { key: '89a8767950f24239e09d160c6eafc6f4c6d49ad3', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, h("div", { key: '81128ee904d76c262fc81672e207dee4ec7c5618', class: "d-flex align-items-center", slot: "header-actions" }, h("wa-switch", { key: '427d8c00c9a2db4077fda844850658a7989c8f3c', onchange: e => {
                if (e.target.checked) {
            ...
            } }, "Pro-forma")), this.open && (h("ir-invoice-form", { key: 'ccc7edb39e0cfdb6478325c10b9dcead1545bfc5', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), h("div", { key: '48d9e8243240b91a13c325a090421198bf8a9bd7', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'dcb71e7da125a914179d83a412484c6bfffb79ff', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), h("ir-custom-button", { key: '96c66b8690d2cc0e298b697cc79f90cde9dcf782', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), h("ir-preview-screen-dialog", { key: 'ad269dba69a6d0cac77e5e9fbc8117a2574e3f38', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, h("ir-proforma-invoice-preview", { key: '3c6486c7cd2bfcc1b66a4a3a291c0d492be014bd', invoice: this.invoice, property: calendar_data.property, booking: this.booking })))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: '5e59ed4a4fd81b1407960d98ca0e7aa25bd85217', class: "otp-input-container" }, h("div", { key: '160fae6b326e982cc48d27cd3a6b1bf22c4dfeff', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (h("ir-drawer", { key: '0f3dc8e85fe5a58df8074cdda2f3b34197218049', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (h("ir-payment-folio-form", { key: 'd9b24844a481f6ab9b933e107bcccf871dd7b0e4', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), h("div", { key: '5e5efd2df5f64c50cfc83bde83bcbd34b6ec9296', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, h("ir-custom-button", { key: '32403c9ed43a1a78f7e8b6ad3002d26a992e93c2', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), h("ir-custom-button", { key: 'f6e8d6108ecbb6831454ad29ac3d697f89e80501', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'af866efe00b7f4d7b575f84ca311ad0be5e2585e' }, h("wa-popup", { key: '67125a33c2c2090b0b405563fc60d4df1048ec87', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, h("wa-input", { key: '16eee182fdc2edbb8440c908ae922dc64afb5e89', slot: "anchor", class: "search-bar", withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && h("wa-spinner", { key: '3c14527dbdf447168ba861d4569040516a14a56a', slot: "end" }), h("wa-icon", { key: 'e5419b02f52bf2644da15a01e148780f569db9d9', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), h("div", { key: '48de4d6a735a56c281bcb2f119670967f448bc78', class: "menu", role: "presentation" }, h("p", { key: '74b27ee811017b5b7aaea3853736b42609ea065e', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), h("ul", { key: '853c82925165157d2c3bb32ad5937be3823251d5', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (h("li", { key: '8c81479b0414f3e9343cb7ece1a2adbfb6f9e891', class: "loading-state", role: "presentation" }, h("wa-spinner", { key: 'b261033350b7cc12ff96f295ac4bf94895c46ca2' }), h("p", { key: 'aee9b98a913dcd3cf7ced726b1ce8a658b8294e8' }, "Loading suggestions\u2026"))), h("slot", { key: '5a6828e8a364c434a7fe86a4b7097610aa5b0ae7', onSlotchange: this.handleSlotChange }), showEmptyState && (h("li", { key: '5cd47fa113242406408fdb28b7d2a70cbc1012a0', class: "empty-state", role: "presentation", id: this.emptyStateId }, h("wa-icon", { key: 'f95d3e6d061ed15a8ae725b6295e5f43edef7cb6', name: "circle-info", "aria-hidden": "true" }), h("p", { key: 'a272af91247e183a2d88af41bea67f5ff130b667' }, "No results found")))))), h("span", { key: '6274b82d51caec3cc79d6337e74308cfd280a33f', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickup = class {
    ...
    _id = `pickup-form-${v4()}`;
    render() {
        return (h("ir-drawer", { key: 'fda499b2dd84e81a33216050feb8da1208267501', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (h("ir-pickup-form", { key: '3f9f24b7aa70107e7e888f74fdc8816886e1ec15', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), h("div", { key: 'aa2e5ab841b504463de04e61c268abb1841bd033', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: '43141f9371e5a179c6240360da7c8b12e36be0b4', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales.entries.Lcz_Cancel), this.canSubmitPickup && (h("ir-custom-button", { key: '6a54916a2b18a1147173e06ebf949ee61439187d', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales.entries.Lcz_Save)))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: '3c1288ba92c046cdaa75040b5a07e5c4bdfac0e7', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (h("section", { key: '0cff666ee4a76be6eff9788fa55df23665b00ae8', class: "ir-print-room" }, h("header", { key: 'f80e3eb877706871d8774e56d2ce7388dc2c5a2b', class: "ir-print-room__header" }, h("p", { key: '51ddb4f19b1cccc75de4101145a0f1c0eeec1718', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && h("p", { key: 'da32501daab77601bb7b0bd651f9653d78974a7d', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), h("p", { key: '7e12f7ae422c8fc20850d946afcfd4d373998d45', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), h("div", { key: '8f933ab7aa5147ab8e6a2c2dbb935a82f78cbccf', class: "ir-print-room__body" }, h("div", { key: '05cc97bdcf40a9daf890dc1bbc267404549faa8d', class: "ir-print-room__details" }, h("div", { key: 'cc93fc6766a01237af1bfebd4842c528835ade14', class: "ir-print-room__row" }, h("ir-printing-label", { key: '808024340d39691e9f943673bb1373abae0857df', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), h("ir-printing-label", { key: '3a5e47e4bbbe05425a490dd8b2592fca4f1974e8', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), h("div", { key: '61f4d995661d008fbb75e253c22127c0facc1279', class: "ir-print-room__row" }, h("div", { key: '0358114113cab74c36ff64c2c162dc6a7ea6a6d1', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), h("span", { key: 'bea8fb9daf826c4d739ad4989fe450e984295325', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && h("p", { key: '770d583c7450b57e16c5b1c04870fa6502922ab4', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), h("ir-printing-label", { key: 'fb5005540dd985b3ec9c65b6db5f7c3475c8d39e', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (h("div", { key: '530f1dc2f496fb21b4695fa228751b9cc11def44', class: "ir-print-room__policies" }, h("ir-printing-label", { key: 'ca6eb80f68d9b9c705bf40a5069e010d05924f6a', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), h("ir-printing-label", { key: '0b08b5a76e5a23ff961092b692790cdc06fb6158', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), h("aside", { key: 'c2b48453cb4afaf9774f8dd0c6a4ddadbb3a9cdc', class: "ir-print-room__totals" }, h("ir-printing-label", { key: 'c002f20303b95212a25f49cc99e452456094cec3', label: "Total:", content: formatAmount(currency, room?.total) }), this.renderTaxSection(), h("ir-printing-label", { key: 'dbda2ae6b219581e7db8877413a16218b3e085ae', label: "Grand total:", content: formatAmount(currency, room?.gross_total) }), booking?.is_direct && h("ir-printing-label", { key: '9a4cc97dc3b6edb016e4a9da64609444332e0e14', label: "Due upon booking:", content: formatAmount(currency, Number(room?.gross_guarantee)) }))), h("div", { key: '849aef08a4724d50e6a3f2475c7ff36d5ba6642d', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (h("section", { key: '44b7c7ae7f63bfcf009f0cda9e68ace66a40b756', class: "ir-print-extra-services" }, h("h3", { key: 'a1368e3d1278615d2799e02c5fac8838c029a999', class: "ir-print-extra-services__title" }, "Extra services"), h("div", { key: '92eaa4497469eacc04687510080a1e0c2dd4afb9', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '1a0cd5ded6d70d01a864d5e24b413d7c3aafbe7a' }, h("div", { key: '4d8fae6f6f043eb14437187ab85e4fe8bcbf4989', class: "booking-room__header-row" }, h("button", { key: 'e635147688e2d90cc20db2a4a51836a89c90ad06', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '32d54f61d24d816d8bdaa74ef70823b941a7bdc3', name: "chevron-right" })), h("div", { key: '4eb1ed51dd73d5fa42ae13f4bc1eee8a411586a6', style: { width: '100%', cursor: 'default' } }, h("div", { key: '8a9b4b1f582f47144ccb8ec09187957e9e2d9a2e',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, h("div", { key: '99ad224fbb77f2c0af3158420ca1e7feeb7f50ec', class: "booking-room__summary-row" }, h("p", { key: '2f4853c52f0fc1e56f547ee3bb0f84b5bb43b4a4', class: "booking-room__summary-text" }, h("span", { key: 'b3cbec5a8d570ba2b372a232f5813215a3828389', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: 'bb4c76a063c6c6dfa0f9c8fc5ae64d27c8a046bf', class: "booking-room__price-row" }, h("span", { key: '7de304d1b2ee93b61a0935cfe96c65c519af01c0', class: "booking-room__price" }, formatAmount(this.currency, this.room['gross_total'])), h("div", { key: '0c48f33e45b4c002e22671bede588f84d022d18b', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (h(Fragment, { key: '8e91b659322f7e170cd843731ff19ee55a30d35e' }, h("wa-tooltip", { key: '6dcd133d47cd92ad9780d23060145e8c527df0d7', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), h("ir-custom-button", { key: 'cc6c8e5462660f05e04fed4201a582f3afb3110f', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, h("wa-icon", { key: '3f3959b74c885174cd3417b348a87b449ca4fd67', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (h(Fragment, { key: 'cc4d5bd9a67962bc6fc96532ebedb37afc0c8b39' }, h("wa-tooltip", { key: '2da36e51792b9e9ca085cf40be93ff1236e9a2e3', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), h("ir-custom-button", { key: '28e4bf7e14df383599d354e004194dc96e10eadf', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, h("wa-icon", { key: 'db0ed3d326d67fb2d04a019cad3486d6d4e0c930', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), h("div", { key: '35854e5360335f825df19e8e2c5192926c705f3b', class: "booking-room__dates-row" }, h("ir-date-view", { key: 'f5f0fd1f5876b211de0e26a1f32103153ef5cfe6', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        h("ir-unit-tag", { key: '1df070bee858ae7e5395e2e8c388f136bc9c2dda', unit: this.room.unit.name })), this.hasCheckIn && (h("ir-custom-button", { key: 'e5934c0ce377304161d09c6bc54cebe59a4b61df', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales.entries.Lcz_CheckIn)), this.hasCheckOut && (h("ir-custom-button", { key: '31bdbd23f76239634a4bda431d9dcecc27c0e568', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales.entries.Lcz_CheckOut))), h("div", { key: 'd59ecbcded32d7f1879593abbff2598a3e9e1c5a', class: "booking-room__guest-row" }, h("p", { key: '5f53bcfd884ae8af43d7a6ac9712bd17c5882f86', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (
            ...
            //   ></ir-button>
            // </ir-tooltip>
            h(Fragment, null, h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: 'e1e4b4c2c0dc18496fdd05fb497524f6d8ce0b56', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (h("div", { key: 'd3b8d5af77e5f84304fdba192cca70e48848f805', class: "booking-room__departure-row" }, h("p", { key: '6472a4422dc628df67f90be246be84642d72f49d', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), h("wa-select", { key: '4df3888dc87c478be3605059772a38ccd9fa357b', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (h("div", { key: '7591f27f2479eef7e31df2f8572d3a73da131525', class: "booking-room__details-container" }, h("div", { key: '3fccc5da627d6c5e9a7ba21ed00c42fdedd71f1f', class: "booking-room__breakdown-row" }, h("div", { key: '661435add2a7216f1cdb81fa51ccb6460d702156', class: "booking-room__breakdown-label-wrapper" }, h("p", { key: 'ce3eb2425c536b30acef5e4d002880a35f550ce6', class: "booking-room__breakdown-label" }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: 'c08b87b71a84fafda2d21cb507958c6dbfbae2dd', class: "booking-room__breakdown-table" }, h("table", { key: 'a5848dd98f0565c7de3e7e1e007ccbfdd8ee19e6' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '865a3fbab3b8d23b0181dc1378d9a6d20976b49a', class: '' }, h("th", { key: '8b2a4455d92c37eff4b3b07ed1cecb89925f778c', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '541d4c8b5a08b643aba03f2296db796b362ac6f6', class: "booking-room__cell booking-room__cell--right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (h("th", { key: 'bc4a7aac77bb4608c9155446e9ebcf8a05867ecb', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (h(Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), h("ir-label", { key: 'bc282e97e58a59a5de0806558e577a3b2fa0c1d6', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: 'eb9bc909d448122105769cd0bd60bfcc24d3f954' }, this.room.rateplan.cancelation && (h("ir-label", { key: '160e5c8f10b16f772c1063c3b4e1c9e1f6ec0f37', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '69318c3be9973ebf4e9999c101d9a055a5ee82a7', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '23b604018e0591b35e2f64ccfdd2fd2f862df2b6' }, h("ir-label", { key: 'f320ea477320fe98c7ae03d147d2ab3222950388', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '07caaa23628abb119bdeda0d9933d60b646238fb', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), h("ir-dialog", { key: '3844664634324289c2d6d54409ca364b44d2f455', label: this.modalReason === 'delete' ? 'Alert' : locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, h("p", { key: '13ed6b1f6175f25ef4dcc220f1e87319425ea754' }, this.renderModalMessage()), h("div", { key: '24ec08833dcaeecdbb4a179a1e1ae6a6239beacc', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '091d1ed4293511e765b4558ad1a6b4867812d41b', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '54a481a195a93ac5c61a1d43281abaec7b41367a', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm))), h("ir-checkout-dialog", { key: 'b4b9caa6e281c28282f2858cb9e8f0ebdd4c777e', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), h("ir-invoice", { key: '5bcaf9e6b28d79cd6b21892ad5fada13921fac14', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (h("ir-drawer", { key: 'e6bf0756798a157e4214c01f7765bcf2d963acbf', style: {
...
const IrUnitTag = class {
    ...
    render() {
        return (h(Fragment, { key: 'b5f1a00b094924997cd17756adfc8112aca53487' }, this.showTooltip && h("wa-tooltip", { key: '1986c7809bb32f2e07ee0f6c67023fd875fa007b', for: this._id }, this.unit), h("wa-tag", { key: '86ec1950306d8c57c7db7faa1eb068159e82ce8a', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, h("span", { key: '5f89d40450e34107e623b36d3695da6024573743', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: '2fd7e1e8713fa50423b691973b4b8116e89dd548' }, h("slot", { key: '17ac0cc0d4dd856846fcc4ada66ad3bdfd875015' })));
    }
    static get watchers() { return {
