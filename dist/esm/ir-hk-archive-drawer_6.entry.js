...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '7fdb261f96e5aabe74f94febc9489cbd09282db3' }, shouldLoadMore() && h("ir-button", { key: '311e424d73875f0261f0ebee1efac8d8ae7cfb3f', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: 'e509287779379c051cb22e0ce2c30390298692a3', showing: {
                from: start,
                to: end,
