...
const IrTasksCard = class {
    ...
    render() {
        return (h("wa-card", { key: 'e095be8a83dd712fc684aa8102d9ce3519c2c159', class: "task-card" }, h("div", { key: 'f2d3ab23c47b14465df0602ca3e426e93de1f232', class: "task-card__body" }, h("div", { key: '5cbf48e3faa0f1473fef6e6df4056eb4f42f577b', class: "task-card__unit" }, h("span", { key: '3f46d1fabd1e3a95608475b09063c974e19c2f49', class: "task-card__unit-name" }, this.task.unit.name), h("div", { key: '5d907adc8bb026a716b7249e42d453bff3c67518', class: "task-card__meta" }, h("span", { key: '2d71ce28332689ccf1d63ee398b3a138a271d46d', class: "task-card__status" }, this.task.status.description), this.task.hint && h("span", { key: 'a3db0496c1f3cf968a12484e4360451154435e2d', class: "task-card__sep" }, "\u00B7"), this.task.hint && h("span", { key: '77c3dddbf7d051fcfd444482e01a3be88ba7c1b4', class: "task-card__hint" }, this.task.hint))), h("div", { key: '16066297f53c17e97a0afa0c8e7bbc37a1904c90', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (h("div", { key: '64a9801b3d9a6a3dd7f4b87319539e1a0b35abdd', class: "task-card__guests" }, this.guests.map(g => (h("div", { class: "task-card__guest" }, h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), h("span", { class: "task-card__guest-count" }, g.count)))))), h("div", { key: '9355a43e38f43dfc9afddf6a74ba03956fc11008', class: "task-card__assign" }, h("wa-select", { key: 'ec12429a6896c142e626c156381b60442da45728', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, h("wa-option", { key: 'a12d3e4654680636397971ba2e04eaa91e24e599', value: "0" }, locales.entries.Lcz_Unassigned), housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), h("div", { key: 'f3958ef5bc8eb86c4805381657080555d8bffdf1', class: "task-card__actions" }, this.isSkippable && (h("ir-custom-button", { key: '9d846e162f7d0730271e608de1d0d437652459fa', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (h("div", { key: '64b6b8b2c94a850140fd5e99b1251ad5aa452692', class: "task-card__clean-group" }, h("ir-custom-button", { key: '1f4b50c662ddcf5c13acc55260d39962772b47fe', variant: "brand", appearance: "filled", onClickHandler: () => {
                toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), h("ir-custom-button", { key: 'c720987639d887e63d482b57eaa82f74ec064148', variant: "brand", appearance: "accent", onClickHandler: () => {
                toggleTaskSelection(this.task);
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd270b7141504c1a79add1721c1e48eb9ec1bbbd4' }, shouldLoadMore() && h("ir-button", { key: '0aa16cdfd36be19220a4f01d7b412fc96941354e', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '8b78be81ca91358a73fe174dec0d1a074806add6', showing: {
                from: start,
                to: end,
