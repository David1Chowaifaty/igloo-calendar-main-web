...
import { d as calendar_dates } from './booking-cc29270d.js';
...
const IglBulkBlock = class {
    ...
    render() {
        return (h("form", { key: 'a6b1642d198922587aab8c1be78e78ad1fa4c4d0', id: this.formId, class: "igl-bulk-block__form", onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("wa-radio-group", { key: '76deb5e82e1e2cb4d7b1f59a9b0e7c15d08c9023', size: "small", label: "Block or unblock a unit", orientation: "horizontal", name: "action" }, h("wa-radio", { key: 'fd5fabae75bff59ddee6701c68689a3b8338888d', style: { flex: '1 1 0%' }, appearance: "button", value: "block" }, "Block"), h("wa-radio", { key: '73d0df76bf9de501ae7fd12141d1950ccde851e1', style: { flex: '1 1 0%' }, appearance: "button", value: "unblock" }, "Unblock")), h("div", { key: '75c8808b2928658e0540bc6b9f71382da3dc6e27' }, this.errors === 'rooms' && (h("p", { key: '4c4a6a24bcd8d0925f3ad71dd15eaf99c4964a64', class: "igl-bulk-block__error" }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("wa-radio-group", { key: '7804cea31aa3d5dc2ae0ea09abd2df70aa412a6e', name: "unit", ref: el => (this.unitSections = el), onchange: e => {
        ...
        }))), h("table", { key: '8e26b1278afec83f5c2af23aa53755ad14ca5840', class: "igl-bulk-block__dates-table", ref: el => (this.datesSections = el) }, h("thead", { key: '4ac204d50466390e63ed398419489c83dbd16cd9' }, h("tr", { key: 'ec5de7c5c611100c43d0e03ca4dbbefc376385d9' }, h("td", { key: '52dc0e390576b6a3196b855bcb5809cb53c9ff07', class: "igl-bulk-block__dates-header" }, locales.entries.Lcz_From), h("td", { key: '20b3b0625f020bb059685feecd529beb3a8340f1', class: "igl-bulk-block__dates-header" }, locales.entries.Lcz_ToExclusive), h("td", { key: 'd79c9958f2e147966624fede6df93360ad468fd2' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (h("ir-custom-button", { key: '54095afd756dc09940ec668043999a605473f864', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, h("wa-icon", { key: 'df74a241ef469a7689ec891ae3fcd3a48f8475fe', name: "plus", style: { fontSize: '1.2rem' } })))))), h("tbody", { key: 'b6b562da4a530f885de22cb32ae1cdee7ac2667f' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
