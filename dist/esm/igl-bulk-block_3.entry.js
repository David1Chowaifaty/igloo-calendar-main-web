...
const IglBulkBlock = class {
    ...
    render() {
        return (h("form", { key: 'd38dbd7c57d6058da56ec5bb10744e78881e6fb9', id: this.formId, class: "igl-bulk-block__form", onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("wa-radio-group", { key: 'ed85884407e2a01d33688a45294ee4566192b1df', size: "s", label: "Block or unblock a unit", orientation: "horizontal", name: "action" }, h("wa-radio", { key: '460ebac8ef9b1daaffaec2f86a02682a2f69e7c4', style: { flex: '1 1 0%' }, appearance: "button", value: "block" }, "Block"), h("wa-radio", { key: '39d403ab026ed8fe3c520a302f0f733f21a6702c', style: { flex: '1 1 0%' }, appearance: "button", value: "unblock" }, "Unblock")), h("div", { key: '6f80eb8349883fee8c6c163197d1f0b9509f75f6' }, this.errors === 'rooms' && (h("p", { key: 'f0ef58628547bcfedc53aa158b49d00ceefbd761', class: "igl-bulk-block__error" }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("wa-radio-group", { key: '86c3c6df95fa0a3efc0ba9da9df2f1c81b685517', name: "unit", ref: el => (this.unitSections = el), onchange: e => {
        ...
        }))), h("table", { key: '65451167ed5ad198152b2edfe86c3b99bca57837', class: "igl-bulk-block__dates-table", ref: el => (this.datesSections = el) }, h("thead", { key: '86145c84c348af2b29d5873fb5db99a85532090f' }, h("tr", { key: '13398519cdd472771eb1398ab2189e247671aba8' }, h("td", { key: 'b6a11a2e9843a892c24225f06c8eaf31ad4b40fd', class: "igl-bulk-block__dates-header" }, locales.entries.Lcz_From), h("td", { key: 'cd71357094e31e0406c992798550fdf05970c30a', class: "igl-bulk-block__dates-header" }, locales.entries.Lcz_ToExclusive), h("td", { key: 'a9a6508059789b3aaaf199cc8b8bc1e590305f06' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (h("ir-custom-button", { key: '5062eff370fe6d630ed850a48024f63a4dd91535', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, h("wa-icon", { key: '3d20e53a79f17458a7aaf36ec8bb0742edab0e79', name: "plus", style: { fontSize: '1.2rem' } })))))), h("tbody", { key: 'b30ee2e2fcb9e2590ff127c6c64d35918e1c2508' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
