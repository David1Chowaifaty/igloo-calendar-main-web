...
import { f as flexRender } from './useTable-D3LS_BXH.js';
...
const IrCollapsableRow = class {
    ...
    render() {
        return [
            h("tr", { key: '510067209c33c6f1bd5c96a7f771e6fbd9d2a810' }, this.row.getVisibleCells().map((cell, index) => (h("td", { key: cell.id, class: {
