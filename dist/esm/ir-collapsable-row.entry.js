...
import { f as flexRender } from './useTable-Ugfcn2KI.js';
...
const IrCollapsableRow = class {
    ...
    render() {
        return [
            h("tr", { key: 'c94d70ab10e6f9688c7cfcbdd46576330bb1fef1' }, this.row.getVisibleCells().map((cell, index) => (h("td", { key: cell.id, class: {
