...
const IrCollapsableRow = class {
    ...
    render() {
        return [
            h("tr", { key: 'a9eb2c058ebaedc2d843d6ca44183940729b9d9f' }, this.row.getVisibleCells().map((cell, index) => (h("td", { key: cell.id, class: {
