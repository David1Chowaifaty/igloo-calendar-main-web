...
import { n as getPrivateNote } from './booking-e062a4bf.js';
import { B as BookingListingService, b as booking_listing, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-34cae9b8.js';
import { l as locales } from './locales.store-cb784e95.js';
import { B as isPrivilegedUser, p as downloadFile } from './utils-646592bd.js';
...
const IrBookingListingTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: '68c17d4da7123360fbaf07c716da0711e00e6c53' }, h("div", { key: 'ae336e569f3207ff9071ab53a82c3a09e2d7b133', class: "table--container" }, h("table", { key: '37d1e8065375a3517ac73e38a33eed49f10e7926', class: "table data-table" }, h("thead", { key: '9a06842b26a14f17951698665aade9c59ebd0b77' }, h("tr", { key: '8522cc55403031bf6905daaf93f7a08ca1a69442' }, isPrivilegedUser(booking_listing.userSelection.userTypeCode) && h("th", { key: 'a3897a445b28f42e177e4c74b9e0d64aa09db606', class: "text-left" }, "Property"), h("th", { key: '1960dfa02eec8e0b10b352d705aabf35bbc7eb9d' }, h("span", { key: 'f97a3f8d495bd88d145abeed2009102669306afc', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: '3d71170b40a2e3199c442b52144f61afaf6d7115' }, "Booked on"), h("th", { key: '0dd25ac818b9e3e8c2c2d00d57ae2c31774532c5' }, h("div", { key: 'df2dd814df32bc261123069cc1d5fb4f75efb599' }, h("p", { key: 'fd65a40910d2a5a2b53631d272f96eca1e4888ba' }, "Booked by"))), h("th", { key: 'c3a2f8e0a91f0355c222d26ae3efecef14aa2cb4' }, "Dates"), h("th", { key: '2b40981eb39cb1458396ac5ce02e3600279bb876' }, "Services"), h("th", { key: '7706ce9fed05959c0a4463665ab478e5a19953fd', class: "text-center" }, h("p", { key: '4ad04d496b217f96928ee97f6f0d68c1fab9ad74' }, "Amount "), h("wa-tooltip", { key: 'adf63e7236f33f35a9bc0ee50fc9318b630c7d8f', for: "balance-info" }, "Booking balance click to settle."), h("div", { key: '4202c3272290592d3c365917adccb6d2431760f8', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: '9bc16e998308da815aed069cf6ae0f18331b9cac', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Balance"))), h("th", { key: '5d4289860c781a8739151dd7376d6e6999e6651b', class: "text-center" }, "Status"), h("th", { key: 'f6e3a5012416e05d5136d6800a91ee1e11b64d29' }))), h("tbody", { key: '88f90eaf112241c2add35a837e3b87afd5b63937' }, booking_listing.bookings.length === 0 && (h("tr", { key: '063452bea8465a2e43997cfa3ea6cfee1587d368' }, h("td", { key: 'dd0dd78bade4488586df3f46d72f4a9af1f9039d', colSpan: isPrivilegedUser(booking_listing.userSelection.userTypeCode) ? 9 : 8, class: "empty-row" }, "No bookings found"))), booking_listing.bookings?.map(booking => this.renderRow(booking))))), h("div", { key: '26d0273f1966bbf195ccfdf994d6776fb42fe679', class: "card--container" }, booking_listing.bookings.map(booking => {
            ...
            return (h("ir-booking-listing-mobile-card", { key: rowKey, booking: booking, totalPersons: totalPersons, lastManipulation: lastManipulation, extraServicesLabel: locales.entries.Lcz_ExtraServices, onIrBookingCardAction: event => {
        ...
        })), pagination.totalRecords > 0 && (h("ir-pagination", { key: '60dbd7ae34c8046df052acb27d7c5b0b61fc08d9', class: "data-table--pagination", showing: pagination.showing, total: pagination.totalRecords, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })), canLoadMore && (h("ir-custom-button", { key: '39b047c320fce782d0d4bb6dc1ee2dbaadf2788c', class: "booking-listing__load-more", variant: "brand", appearance: "outlined", loading: this.isLoadMoreLoading, disabled: this.isLoadMoreLoading, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.loadMoreBookings();
            } }, "Load more")), h("ir-dialog", { key: '12979df8b9c8f69862f6dd65986a220eb827c79c', label: "Delete", open: !!this.booking_nbr, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.booking_nbr = null;
            }, lightDismiss: false }, h("span", { key: '415544acc3e6889969ee6641899f2e3c0cb7a89c' }, locales.entries.Lcz_SureYouWantToDeleteBookingNbr + this.booking_nbr), h("div", { key: 'ec20acbb684e07611afb3d1f5365291a6bcde306', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '7d211ede07ad906f9c66dbc5e1dfa4cb5c7fa31b', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: 'f8029a364f10e9e7e8fe66a5bb24cb1b8a2339f3', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.deleteBooking();
