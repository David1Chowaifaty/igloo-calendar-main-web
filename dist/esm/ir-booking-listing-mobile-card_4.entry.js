...
import { n as getPrivateNote } from './booking-d5154791.js';
import { B as BookingListingService, b as booking_listing, u as updateUserSelection, i as initializeUserSelection } from './booking_listing.service-95312cda.js';
import { l as locales } from './locales.store-cb784e95.js';
import { N as isPrivilegedUser, p as downloadFile } from './utils-d0dadf41.js';
...
const IrBookingListingTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: '14b843440db3d173eecb5d49eb8598b4791c6886' }, h("div", { key: 'ef05d24f03aecf17086eadab12b13b4e4eb3a967', class: "table--container" }, h("table", { key: '1c0b896f9d17e1355d64ce4ccc3e4d2f49a8a391', class: "table data-table" }, h("thead", { key: '716348e7cc67cab5bf0d7d83e65e01c236c815a7' }, h("tr", { key: 'aa873ebef6eeaeac877d4bff8409cf677816e9ff' }, isPrivilegedUser(booking_listing.userSelection.userTypeCode) && h("th", { key: 'c6fb3f4e217a5d9b4569ffe3581cbd7f9732af90', class: "text-left" }, "Property"), h("th", { key: '4389fedf0b8b5e0720f21375e2f4afdb24829a6c' }, h("span", { key: 'e8aa38da944e1cd96c241d4594a5ec4354b69620', class: 'arrivals-table__departure__cell' }, "Booking#")), h("th", { key: 'a8be48a56360bac234acfef1231556c870a4939b' }, "Booked on"), h("th", { key: '9661f67496b8982517472819be6f712fa1f7411c' }, h("div", { key: 'cade52f12982c9b1193228a7f5d9a311a84051fc' }, h("p", { key: '3aa4827a1a8464128a2d207ae2cd579474c441bd' }, "Booked by"))), h("th", { key: '57586fdbd8f1fb22727e12d1ea13bded36688fbd' }, "Dates"), h("th", { key: '5fef5d816fefd0cf6dae1cda540a5bdc9175544b' }, "Services"), h("th", { key: 'af0cfad15e623423c9fda8292156ce8407fbbac5', class: "text-center" }, h("p", { key: '980e9cc66f36b804972f071be2348fdbbe38ecbf' }, "Amount "), h("wa-tooltip", { key: '408e8cf2dec54848a9f0b12714788427c767c39f', for: "balance-info" }, "Booking balance click to settle."), h("div", { key: '205e14511089f5c7b06a1a31784b0dc5ce0940ad', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, h("ir-custom-button", { key: '94ca66fb8b58d88440f9e12013380606e05cfd45', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Balance"))), h("th", { key: 'aef6d738ba184e2c62c2ed823971e22e008f2310', class: "text-center" }, "Status"), h("th", { key: '658afafd582847efeac9775d5c062a4c71a7de1d' }))), h("tbody", { key: '2d308590dbdd4a870035efa8ccf544959c58ff95' }, booking_listing.bookings.length === 0 && (h("tr", { key: 'd77959319a6145652173c5da557902818c97dcd7' }, h("td", { key: '8aa2a7251e193bfdd1666f9d0042e17f4fe31b70', colSpan: isPrivilegedUser(booking_listing.userSelection.userTypeCode) ? 9 : 8, class: "empty-row" }, "No bookings found"))), booking_listing.bookings?.map(booking => this.renderRow(booking))))), h("div", { key: '6a15ca9020892456acf8435427b968de45608729', class: "card--container" }, booking_listing.bookings.map(booking => {
            ...
            return (h("ir-booking-listing-mobile-card", { key: rowKey, booking: booking, totalPersons: totalPersons, lastManipulation: lastManipulation, extraServicesLabel: locales.entries.Lcz_ExtraServices, onIrBookingCardAction: event => {
        ...
        })), pagination.totalRecords > 0 && (h("ir-pagination", { key: '2034e1c22a937b1401d52719abaa8e3ef49e8c21', class: "data-table--pagination", showing: pagination.showing, total: pagination.totalRecords, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales.entries?.Lcz_Bookings ?? 'bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })), canLoadMore && (h("ir-custom-button", { key: '83f4cd26a48a10b1628b2d45c2bad47aee1ae08c', class: "booking-listing__load-more", variant: "brand", appearance: "outlined", loading: this.isLoadMoreLoading, disabled: this.isLoadMoreLoading, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.loadMoreBookings();
            } }, "Load more")), h("ir-dialog", { key: '201387b0afaa0ddda808786b6681cacf3246cf56', label: "Delete", open: !!this.booking_nbr, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.booking_nbr = null;
            }, lightDismiss: false }, h("span", { key: '844d632043e649c2a1445719a8a5a3d87347111e' }, locales.entries.Lcz_SureYouWantToDeleteBookingNbr + this.booking_nbr), h("div", { key: 'a0ccbefefa8c36ae7350f538ac85c17e4cc89973', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '8a980f6c88d52ce4e23a574facb6abf44571924f', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: 'e6d01b800b7316b95db9eebe7ad13fe26192612e', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.deleteBooking();
...
const IrListingHeader = class {
    ...
    render() {
        ...
        h("ir-booking-new-form", { key: '70376cac8873214ecf9c46fe71a68cfabe5963f5', propertyid: this.propertyId, language: this.language, ticket: booking_listing.token })))), h("section", { key: '71ef4bd42ffca53d60623043dd014f6a8445144d', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, h("span", { key: '4a6ea8ab7f0c0de155899c15bfeed21ec313e45d' }), h("h5", { key: 'c533fc036ee7aaa6dc45f26f107e8c8ff50792b9', class: "m-0 font-weight-bold" }, locales.entries?.Lcz_Or), h("span", { key: '332bd7cbd4bc5d0926aa3be2c2c0b20ba52a535b' })), h("section", { key: '27fd682abe768a7af62477c88718a19d42d32ef1', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, h("wa-select", { key: 'a3ac76cbafc4488726e99c1e288f5a4cf151f50f', onchange: e => {
            ...
            }, allowNullDates: false, fromDate: hooks(booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: hooks(booking_listing.userSelection.to, 'YYYY-MM-DD') }), h("wa-select", { key: '8f680f499ec1d64495c9a878babee2936a9ceecd', onchange: e => {
