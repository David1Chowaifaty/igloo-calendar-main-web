...
import { C as CityLedgerService, F as FD_TYPES, m as mapClTxToFolioRow, b as buildPaymentTypes } from './utils-4b305bfd.js';
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: 'b82e9cb46ce75c2e933e5a3583c0f09d00b71b2e' }, h("wa-popup", { key: 'fa0b7a56a6cfb87d88b7ab10e0b484964572fe82', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: 'c2bba0f08cd1111a95bb63214339f3ef0fb27d97', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && h("slot", { key: '6850cf7803b3735eab8a8618ccdd8587049f70d2', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '636aa07a6be0c548bd6508a699453c4e509276f7', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '89bc42464d6590e002ca82278ef7de772980b1b5', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: 'd40ca3ff8edaa21f84f14a13be37ecd96082faf1', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '887672f1564bdc15ecf40c5117c2300186de076e', name: "hint", slot: "hint" })), h("div", { key: '7797a4671bb7deec4d097b4d50c6da374c3837ca', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: '147d6a311493de9fa9be613ff1ad0de592f8a2b6', onSlotchange: this.handleOptionsSlotChange })))));
    }
    static get watchers() { return {
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (h(Host, { key: '972b0a96887cce9dfb915f6dc77c9ecd59d7f667', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, h("wa-option", { key: '34358493efc7f7c6c14a6f4c80f94501741543ae', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, h("slot", { key: 'a9fa4d12030408f5ed40dc217f71feb5905d5f8f' }), h("slot", { key: '5bcf5cb897867fbe2a9dbd787f8e80b1aad25f6a', name: "start", slot: "start" }), h("slot", { key: '69ee13d023a70d83f7abe7361a1048d7b27b799e', name: "end", slot: "end" }))));
    }
};
...
const IrClInvoiceCityTaxAmountCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: 'd027dd05395c6e5a9bcb61f1cef580795bf0226c' }, this.cityTaxPercent > 0 ? formatAmount(this.currencySymbol, this.amount) : '');
    }
};
...
const IrClInvoiceDateCell = class {
    ...
    date;
    render() {
        return h(Host, { key: '84961c1e3fb89350ae43a85f1b3b66206b1e4c1a' }, hooks(this.date, 'YYYY-MM-DD').format('MMM DD, YYYY'));
    }
};
...
const IrClInvoiceDialog = class {
    ...
    render() {
        return (h(Host, { key: '888956dc6cd1b563633a3506a0b20ecc7d05be6a' }, h("ir-dialog", { key: '36dfd5c09579a27a017236495aa36feead36f18d', label: "Create Invoice", ref: el => (this.dialogRef = el) }, h("div", { key: '0d08ca5602e50e4161b1b10a7d02b4ebd0c36b51', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (h("p", { class: "create-invoice-dialog__message" }, "Issue a draft invoice for booking #", this.bookingNbr, " to the agent?")) : (h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (h("wa-callout", { key: '75ee53e094f39a6b2a7e78f166060cde183fe03d', variant: "warning", class: "create-invoice-dialog__no-results" }, h("wa-icon", { key: 'd0573014b0a97f417d75745dcc8b877b324d5174', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && h("p", { key: 'a27b96c983ffb96d9138840998c22bed4a55bddf', class: "create-invoice-dialog__error" }, this.error)), h("div", { key: '6cd625c04e96e98e3b87d3dcb9da924f3a482ab8', slot: "footer", class: "create-invoice-dialog__footer" }, h("ir-custom-button", { key: '098c976b3430552fc0313d1ffc67dee0cec60022', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), h("ir-custom-button", { key: '37221f0951786005ea97c50eb4711f2e9bdfd854', size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, "Show draft")))));
    }
};
...
const IrClInvoiceNetPriceCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'b2fcbd3e6d2aa784c98b1d4f1599ce9a377ad4fc' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceTotalCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: '65c2a55a03c3d53a11a3f4949d674720590cfe04' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatAmountCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'd46496a58187c2c21fb386e3c1c6bee2bbb1846f' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatPctCell = class {
    ...
    vatPercent;
    render() {
        return h(Host, { key: 'b4cac03917ef530188d796147fd916b5a786611a' }, this.vatPercent, "%");
    }
};
...
const IrDateSelect = class {
    ...
    render() {
        return (h(Host, { key: 'd1ef731a12fc1f126bb0446fe73d3b564cf08652', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, h("wa-popup", { key: 'a94399a200b00b019fbace0fad551ba5632bacc9', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, h("div", { key: '75b597bc551379e5e25a1a443ef060e1f0cc07f9', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, h("div", { key: '40f4a2f82e73e179171258df4232aea33d845e52', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, h("slot", { key: '5dff5140ab5ab4b2108710af8385d7dbf301a0a9', name: "trigger" }, h("ir-input", { key: 'bb21f1d8c2ef56ec9695bde0d0aa96d4d9b8cf90', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && h("slot", { key: '181cf8159414b2ddbaa2eb6d2bb6a858f789b4a5', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: 'd30308b06a92c746e7d6dff00dfd9df6e97f5e11', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '6801da9267de7a91790d84a5cef0138cd657b1c7', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '74d2a0b10bd05d6df112b5cbdbdeef892584686b', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: 'b4f6cc945741be88873520008c684a1aa0f373a8', name: "hint", slot: "hint" }))))), h("div", { key: '47e807e5b8e797970885fb3f66c5c14ebeddf6b6', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, h("ir-air-date-picker", { key: 'ba9f3ea06ac7957ce3acafb13027c049b4926999', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("slot", { key: '3f938aa78b5f208f6ec8c39cedbe5bde0634a693' })))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: 'b484dc593c1530e0d29514b1e195efb1257e350d', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'e67a325a2128f102881053bcf1883037647fee9b', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '95c2c3272436c74b61245f2e3318430b2d028801', name: "label", slot: "label" }), h("slot", { key: 'ee296110b0eaaa87bd1e45b6b9c075e949bdac55' }), this.slotState.get('footer') && h("slot", { key: '9ce2c6da02b64ff32111e3fba7b8917fbde14a83', name: "footer", slot: "footer" })));
    }
};
__decorate$2([
    OverflowRelease()
...
const IrInputCell = class {
    ...
    render() {
        return (h("div", { key: '6c2bc02bba0a1fe83f6094384aa34e18ea344fcd', onDblClick: () => {
                if (this.disabled) {
                    return;
                }
                if (!this.active) {
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '76ba96693b55c10ea9b2853af1fbacf4ed296508' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: 'a52dd61ecaa405c28889594bc6c7ac8ba8adc809', class: "loadingScreenContainer" }, h("div", { key: '4a31038aa6f0938697664d21fd3ac359c8387118', class: "loaderContainer" }, h("ir-spinner", { key: '1b7d4c3a599cdd23aeb6fb19b852f92c12a0cd04' })))), this.showModal && (h("ir-otp-modal", { key: 'cb6d62122cc8486c70bad76b3b012e4f310b0225', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: '315598332e085b1f18c57d3bb797cb676f64979e', class: "otp-input-container" }, h("div", { key: 'c6b56a207bb937c78d864599b84c91fe3d827cac', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: 'e7cf3989fdd6aed4613c075828add359d16711a2', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, !this.hideDefaultAction && (h(Fragment, { key: '9201d5800bb5305806f5f63028a922f76a18d965' }, h("wa-tooltip", { key: '28499418a724e7f6b352caf44d5907d977e6521a', for: this._id }, "Print PDF"), h("ir-custom-button", { key: 'de2caf7ebfba0198a2ba713995608c7e838fefdc', id: this._id, size: "medium", slot: "header-actions", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, h("wa-icon", { key: 'ea2c94e88df73f0d9bd25c440bb05e23cb826ea7', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() })))), h("slot", { key: 'f0cb77bd7caf1137c08ca18f05c9bac488ec9cac' })));
    }
};
...
const IrSpinner = class {
    ...
    render() {
        return (h(Host, { key: '7af841059854c0223ac344fffab5722d6626bdeb' }, h("wa-spinner", { key: '7bb1105d65bf1d5b01641cc14facc50215f32ed4', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrToastAlert = class {
    ...
    render() {
        return (h("div", { key: 'f4a6b5bd9ee9f2a597afe6b57293ef6574314a0a', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, h("wa-callout", { key: '9fe28e6d9ba2b15686d5cf2d5f8acf1a5775eb2c', variant: this.calloutVariant }, this.getIcon(), h("div", { key: '8b2c92df360f869a7e2219c15a74830e3d9d87bc', class: "toast__body" }, this.label && h("h3", { key: '43252d0cefeffdda74be05d9ea48983b0d3bc79a', class: "toast__title" }, this.label), this.description && h("p", { key: 'a7f3556192deb205c2dd941dabc4c71d4df1185f', class: "toast__description" }, this.description)))));
    }
};
...
const IrToastProvider = class {
    ...
    render() {
        return (h("div", { key: '728cd536bb970709eb912a85d2a60ca15d83929e', ref: el => (this.popoverRef = el), popover: "manual", class: "toast-popover", onToggle: this.handlePopoverToggle }, h("div", { key: 'e66e47a15e8ba258b5980babbdceb3779bc75fa6', class: `toast-container ${this.getPositionClass()} ${this.rtl ? 'rtl' : ''}`, role: "region", "aria-label": "Notifications", "aria-live": "polite", dir: this.rtl ? 'rtl' : 'ltr' }, this.toasts.map(toast => (h("div", { class: "toast-item", key: toast.id }, h("ir-toast-alert", { toastId: toast.id, label: toast.title, description: toast.description, dismissible: toast.dismissible, actionLabel: toast.actionLabel, position: this.getAlertPosition(), variant: this.mapVariant(toast.type), leaving: toast.leaving, onIrToastDismiss: this.handleToastDismiss, onIrToastInteractionChange: this.handleInteractionChange })))))));
    }
};
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: '9fe82a0b8cefeaaed381ef3f769bd2fd1f4be6b3' }, h("slot", { key: 'a9ec10085cd7ad852ad497a4a2268beec2ee3916' }), !this.isValid && this.showErrorMessage && (h("span", { key: '0505aee3f45f94ed806e96c2d833d12c8c84f5fb', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
