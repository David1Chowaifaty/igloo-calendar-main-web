...
import { h as handleBodyOverflow } from './utils-66c94f69.js';
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '352d6586806a94e768d458bc6f2907aba8900025', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '8dda5aeb2ad2fa2baa757726e4ec168d1b8cca79', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '72f1dbd6e81928feea49f9a394491aefe27c258b', class: 'sidebar-title' }, h("p", { key: '5e758c0d6fd11f24054fc48c345f64f23108fc03', class: 'p-0 m-0' }, this.label), h("div", { key: '005bc7cfc0dbe3e68cbe329821dfc5091d2eef47', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '228ae396fb82b1d21ead0aae62a0375834fc898f', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'b58cee35546bc876608df16abb6bbdb12bd96845', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '30f8baed3ca29a5506f6dd7bed640fcbe972920a', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '99c3764faaa695aee5d8319e3d9120f327c3b5a1', name: "sidebar-body" })),
        ];
    }
