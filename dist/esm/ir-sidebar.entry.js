...
import { o as handleBodyOverflow } from './utils-3655fb87.js';
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: 'dfedc696d512243bbd5cf72dc5b029fbf876496f', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '5dc8a6e7e59e1c66148261057726d767af72b5cb', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '8e5497976e545f748859d9fd644447b62bf7dd7b', class: 'sidebar-title' }, h("p", { key: '471a3ea24ffd526be1632c41ad896442fb90186a', class: 'p-0 m-0' }, this.label), h("div", { key: 'f271bbf08bd1288e523feb6563187a3bfeb288a5', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '86483d6d256d943789ea34defda51b27fb868a49', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'ebe62b5899d558b828145135eafc1679a65ea5bc', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '9e7df6a59f8d479ed550cd31a910e352dfdbf765', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '4ec7211f08761291374ed5f39f5ec39565119c2a', name: "sidebar-body" })),
        ];
    }
