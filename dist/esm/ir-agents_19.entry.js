...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (h(Host, { key: '38fb771c6ee400d524a3ef7074d0db2462dd01cd', class: "p-1" }, h("ir-interceptor", { key: '4d41fd0bc136830a4ec941ccba5618cfac7ac97b', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), h("ir-toast", { key: '622e6a5500977965f696aabe755dcded6e9e1065' }), h("div", { key: 'a39b3f65e7f92cd4f3f7cfe59075fda7c61699d5', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, h("ir-input-text", { key: 'd6278280330accbf5076f13869af1b115fa6dc05', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), h("ir-button", { key: 'f91e4bcee6f06d504612a3ac985ada0821636475', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), h("p", { key: '8a8131f7afd0c8f338a846e15e66a3b69d3b293e' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
