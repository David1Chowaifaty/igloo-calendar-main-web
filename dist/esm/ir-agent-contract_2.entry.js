...
const IrAgentContract = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5f142f4675823a953a5b8008e4d4b6b32a7fb1f0', "data-testid": "agent-contract" }, !isTourOperator && (h("wa-card", { key: 'be29ffd0c92172fd7db5bb9e8f57eea767c5929f', appearance: "plain", class: "contract-card contract-card--identification", "data-testid": "agent-contract-identification-card" }, h("p", { key: '948fb9b5e90d16a58fada4100c50434bc7a3c540', slot: "header", class: "contract-card__title", "data-testid": "agent-contract-identification-title" }, "Agent Identification"), h("wa-radio-group", { key: '79975b0eb051ebd32e38b8f6969bf82e1e344b00', class: "identification-mode rate-mode", value: this.agent?.verification_mode, "data-testid": "agent-contract-verification-mode-group", onchange: e => {
            ...
            } })))))), h("wa-radio", { key: 'f4de3256846d57daa6f0adb2dc91c93f817ca2fb', value: "contract_reference", "data-testid": "agent-contract-rates-contract-reference-radio" }, h("div", { key: 'fa6968495f5eb4537f3e50b0796002c304e9ac12' }, h("div", { key: '945811b191088e88ad6dac97efbcac0bd3f45eaf', class: "radio-title" }, "Use contract-based rates"))), this.agent?.agent_rate_type_code?.code === '004' && (h("div", { key: '4d9783c4d3d0fc11357e515bc5ad320b3126b85e', class: "rates-extra", "data-testid": "agent-contract-rates-contract-reference-section" }, h("ir-validator", { key: '754570fa344067b7925b9abbb0aa0bd6ae2fecba', schema: libExports.z.string().nonempty(), value: this.agent?.contract_nbr, valueEvent: "text-change input input-change", "data-testid": "agent-contract-rates-contract-reference-validator" }, h("ir-input", { key: 'f0bac192e25f652ba819634fefa9e6f1d072371e', placeholder: "Enter contract reference", onKeyDown: e => {
                e.stopPropagation();
