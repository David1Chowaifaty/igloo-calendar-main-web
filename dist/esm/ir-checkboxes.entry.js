...
const IrCheckBoxes = class {
    ...
    render() {
        return (h("div", { key: 'bc13064ddeb75bb2bc52060c6e194f5da919022b' }, this.checkboxes.map((checkbox, index) => (h("ir-checkbox", { name: index.toString(), label: checkbox.text, value: checkbox.value, checked: checkbox.checked || false })))));
    }
};
