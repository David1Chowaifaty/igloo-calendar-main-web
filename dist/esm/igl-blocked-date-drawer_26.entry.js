import { r as registerInstance, c as createEvent, h, d as getElement, F as Fragment, H as Host } from './index-Kqbk9HdW.js';
import { B as BookingService, b as booking_store, r as resetBookingStore } from './booking.store-BGV8vZMB.js';
import { g as getReleaseHoursString, l as isBlockUnit, k as showToast, f as checkMealPlan, i as formatAmount, G as isWeekend, d as dateToFormattedString, r as getDaysArray, u as formatDate } from './utils-ChAbsVix.js';
import { n as buildSplitIndex, o as getSplitRole, c as calculateDaysBetweenDates, t as transformNewBooking, e as calendar_dates, a as compareTime, b as createDateWithOffsetAndHour } from './booking-B6GF2c8E.js';
...
import { h as handleUnAssignedDatesChange, g as getUnassignedDates } from './unassigned_dates.store-DG_DITx3.js';
import { H as HouseKeepingService } from './housekeeping.service-DAx753ac.js';
import { P as PropertyService, E as ExposedRectifierParamsSchema } from './index-CYVDe6Tu.js';
...
const IglCalHeaderDays = class {
    ...
    render() {
        return (h(Host, { key: '737292e17bec04dfc4b240bbc2e5e600c8c6072a' }, h("div", { key: '5558910372f2bafae484a623f8573931d326a77d', class: "stickyCell headersContainer" }, h("div", { key: '79613d212fe1ff26b0a3c5555470d6ce0276e43b', class: "monthsContainer" }, this.monthsInfo.map(monthInfo => (h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.days.map(dayInfo => {
            return (h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.isVacationRental && (h("div", { class: "preventPageScroll", onClick: () => this.handleBadgeClick(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? (h("button", { class: 'fd-header__badge-btn' }, h("wa-badge", { class: "fd-header__badge", variant: 'brand', appearance: 'accent', pill: true }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))) : (h("wa-badge", { variant: 'neutral', appearance: 'filled', pill: true }, ' ', this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr)))), h("div", { class: { dayTitle: true, weekend: isWeekend(dayInfo.value) } }, dayInfo.dayDisplayName), h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")));
        }))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b97df0e8a68ca855a3f310e9b63bd789eb81c5fd' }, h("div", { key: '589f44b8c0084f94f097587a3546b5bd5553888d', class: "tba-panel" }, h("div", { key: '165bdaade72e9df174ddb288f3e15c51be42ded6', class: "tba-panel__head" }, h("header", { key: '911e251dc6eefe2158d6eb04e5dc30729d32cd40', class: "tba-panel__header" }, h("h2", { key: '3c2a7ca624b0b972298e71ef24410c90af641e24', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: '47b180730b012dfdbe27aad9ab5388daf4f71a48', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: '6116a66f56141fbcfcb973051a1bc99a527ea308', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: '0c12299eac5aa42db1e8b763e9348d6dd083a74e', class: "tba-panel__toolbar" }, h("wa-select", { key: 'a86aa38528a1487e34b184bfe5367e3a38d8e841', size: "s", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: '0119fe30cc3540fb82a7510e8d77ad8ab431ce2a', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '0f27415d6b8f67365a9f5b7491335c698ef55890', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'a395b167d08dd8a5f5bef32085ef254ca8df4dd5', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'b3aa353c3fddb2d1a7697460a2599b91fd361283', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'af77807249d6e62f3a6abdcf4d37baa445b6922c', class: `ir-alert-header` }, h("p", { key: '9d7693b41875afbe82c819a9163e7bc92da6feb2' }, this.modalTitle))), h("div", { key: '024b3dab636e2484fc6afcee9c075728243b5503', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'e45d60726a2015b168c04e572c3ab8cbc9f40ecf' }, this.modalBody)), h("div", { key: 'a67458615cfaeb31aa2f3e19d9ade4781fdec531', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '95f80f4e78b3ba4d5536fa92dbe843dc36336d0b', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: 'c9326460d546ce769a79899fe14e1fed2f8474d0', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '4f96517c069809a52bddc7b73991d33b5abedc67', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (h("div", { key: '1fd8db7fefa09a5c03df4e9182f97177c61e4b56', class: "input-group" }, h("label", { key: '3de747a9da2891e67699955923bc537f77cf8e51', class: "check-container radio-container align-items-center m-0 py-0" }, h("span", { key: 'd6714f334cd2e634350a52581df8c0ac0beea17f' }, this.label), h("input", { key: '65cac110166786fa07ca97fd80be038306a85375', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), h("span", { key: '5fada6a04900ef67c5d14208216a2ab6b611c985', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
