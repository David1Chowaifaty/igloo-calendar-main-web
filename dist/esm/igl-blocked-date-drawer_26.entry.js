...
import { B as BookingService, b as booking_store, r as resetBookingStore } from './booking.store-BDuXJyyF.js';
import { g as getReleaseHoursString, i as isBlockUnit, h as showToast, B as checkMealPlan, C as isWeekend, A as convertDMYToISO, o as getDaysArray } from './utils-CNQuD3ma.js';
import { t } from './t-Bk78Wumj.js';
import { o as buildSplitIndex, p as getSplitRole, a as calculateDaysBetweenDates, t as transformNewBooking, c as calendar_dates, b as compareTime, d as createDateWithOffsetAndHour } from './booking-B87YrL6Q.js';
...
import { C as CELL_WIDTH, E as EVENT_HEIGHT, g as getEventTopWithinRow, c as computeEventHorizontalGeometry, t as toPhysicalLeft, R as ROOM_HEADER_WIDTH, s as snapEventLeft, a as getTotalGridWidth, d as getUnassignedUnitsCountForDate, i as isUnassignedUnitsDateLoading, e as getUnassignedUnitsDateKeys, r as replaceUnassignedUnitsRange, f as getUnassignedUnitsForDate, h as removeUnassignedRoom } from './calendar-grid-tGsKF-9d.js';
import { a as formatBookingNumber, f as formatAmount, c as formatNumber, b as formatCount, d as formatPercent } from './number-DpPJHVo2.js';
...
import { P as PropertyService, E as ExposedRectifierParamsSchema } from './index-CPTATQhU.js';
import { n as numberType, o as objectType, c as coerce, Z as ZodError } from './types-BWKgfE54.js';
...
import { b as groupIntoCategories } from './utils-ieh5T_fa.js';
...
function calendarScrollTarget(isoDate) {
    return hooks(isoDate, 'YYYY-MM-DD').subtract(1, 'day').valueOf();
}
const IglToBeAssigned = class {
    ...
    handleGotoDate(event) {
        this.selectDate(hooks(event.detail.data).format('YYYY-MM-DD'));
    }
