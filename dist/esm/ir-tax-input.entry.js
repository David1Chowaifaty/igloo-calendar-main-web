...
import { j as getEntryValue } from './utils-BeklM4gy.js';
...
const IrTaxInput = class {
    ...
    render() {
        return (h(Host, { key: 'd90a51e6bb0a886c77aca593d79e0419006865bc', class: "ir-tax-input" }, h("ir-validator", { key: 'a5ace51e454375bf350a1b265ad0d816b42d1722', form: "tax-service-categories__form", class: "ir-tax-input__percentage-wrapper", value: this.tax?.value ?? null, schema: this.isTaxInputDisabled ? libExports.z.number().nullable() : libExports.z.coerce.number().min(0).max(30) }, h("ir-input", { key: 'ec1c112d998b412feaf1453fffc7e51b8651ed49', disabled: this.isTaxInputDisabled, value: this.tax?.value?.toString() ?? '', mask: {
                min: 0,
                max: 30,
                mask: Number,
            }, onChange: () => {
