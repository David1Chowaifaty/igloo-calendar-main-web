...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateDaysBetweenDates, a as calculateTotalRooms, r as reserveRooms, d as resetBookingStore, u as updateRoomParams, g as getVisibleInventory, e as getPrivateNote, f as formatName } from './booking.service-4cc7ed9e.js';
import { l as locales } from './locales.store-a1e3db22.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-2333f282.js';
import { f as formatAmount, e as extras, g as getReleaseHoursString, d as dateToFormattedString, z, v as validateEmail, Z as ZodError, r as renderTime } from './utils-179d2c22.js';
...
const IrBookingHeader = class {
    ...
    render() {
        return (h("div", { key: 'f56130da5849749cdc9f9f233f8b61d81fd0ace4', class: "fluid-container px-1" }, h("div", { key: 'b832756342c6a4cb3da69e1b6186e0aaaba610a3', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, h("div", { key: 'f715739f9dc21e90a9d8c32901da9d3ab0a26de8', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, h("p", { key: '08e7800efa2029a00e95a397424d7bf63f35e442', class: "font-size-large m-0 p-0" }, `${locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), h("p", { key: 'dc75b7a968046479b8000051c534d29ea0ce23a6', class: "m-0 p-0" }, !this.booking.is_direct && h("span", { key: 'cc862d47bc9bd1d68b7e2284c7b68d5385a0ced2', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), h("div", { key: '56c5781316999bd5590e2d3864fbd9d39c0b7c1b', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, h("span", { key: 'b68c2715d71728c3f744497370e3f6042cabd910', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (h("div", { key: 'ab808332391818f68026c7b793899dd0f135be0f', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, h("ir-select", { key: 'a318a9e5453529abe027543e08c3886f6f2e7ae1', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), h("ir-button", { key: '6caa052ef9a307b259f6cb773b3095dd87024a0e', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), h("ir-button", { key: '2d2bfff5bcf7f97c23e92373282a61f8bdd5e826', size: "sm", btn_color: "outline", text: locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendar_data.is_pms_enabled && (h("ir-button", { key: 'ce94583d695e84c37b36968ede9e71563f53ceaa', size: "sm", btn_color: "outline", text: locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && h("ir-button", { key: 'dee6f5a411d74193ced2389f7af269aacbfa4e63', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && h("ir-button", { key: 'b304f6a124e438e4ffcc655213f4b097f1070865', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && h("ir-button", { key: 'c82e78305aaebca5043b3298d8bf4b4983bc9e11', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && h("ir-button", { key: 'a4df588f088d33c8ef18304c92d15979327131b6', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (h("ir-button", { key: 'a4910e136e1ae4abeca4f37fc78c5544a2861a40', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), h("ir-dialog", { key: 'be3b4bb8a541bf01c666ce29715023f0f943f75b', onOpenChange: e => {
                if (!e.detail) {
