...
const IrHkArchive = class {
    ...
    render() {
        return (h(Host, { key: 'a1984ed952f83d3d24e966bb8e3429dfc9ede1c1' }, h("ir-title", { key: '005ff3c7ea634244329031a2147b5dde4da8bb17', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: 'a86e20574e73d8a88bef4100f24c918d9c2a3ae3', class: "px-1" }, h("div", { key: '420e140b7c45c4447cf2744676ea5165594307b3', class: "d-flex" }, h("ir-select", { key: '4003e2c80ae0ed70232df6c73c9b94dd38f0b0a8', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("ir-select", { key: '98fbe1f569d6287b0a54fc2e2ae0fe0791f5eeff', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), h("div", { key: 'e23bf088dedfed47fd40edccd366b6603a8f0751', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: 'e413d970374620f3a728c431e2827d3f83d87221', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '14cc0b86e9aef4338d9b007729f06c0fd8400a5c', title: locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '64678ed05c7dba1dcc056934ee871370975d1d76', title: locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: '7bdc02c0a07db95714b5e22e508f7ab740e63a10' }, this.data?.length === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, this.data?.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: 'a2ee81ba3f764b5cc7482e3eb3807e79a46c5ef3', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: 'var(--ir-color-muted-background,#f2f3f8)',
            } }, this.selectedBooking && (h("ir-booking-details", { key: 'd03bdf4afe612fae8b5084de240cefd436e07034', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrRangePicker = class {
    ...
    render() {
        return (h(Host, { key: 'd0b613ef447cdceab13ce7d580d540fb7cf76c25', size: "s" }, h("div", { key: '7188afc99afbad8e28430c556f9bbe99c3d7728e', class: "range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (h("div", { key: '20812215933d328c932be681aa818a7ad1ce11cc', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, h("wa-icon", { key: 'f14323a8db7f859160190059dce92c72e8d7f2a9', name: "calendar" }), h("p", { key: 'fb15608654a75905c39dcccef64ea19fcaba53ca', class: "m-0" }, h("slot", { key: '358e4cf491164428b608be03d73e658b1de2829b', name: "message" }, "Cleaned on")))), h("svg", { key: 'c70bc0f717c0af3c333e367fa7ac10bf9da26add', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, h("path", { key: '537510dcce38c3f01cee2c7b407d68feb1f55188', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), h("svg", { key: 'ff0381cb05f010d55c7b659a3fa101f0639495d4', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '59a34bc5424b65c82b6f1f0699cf31491e06f20a', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, this.fromDate?.toDate() || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrTasksCard = class {
    ...
    render() {
        return (h("wa-card", { key: '83234608df9bae7002afcd757deb7e03b718e2a2', class: "task-card" }, h("div", { key: '78fede6152f1f93f18d12d807ce4f48221a8e914', class: "task-card__body" }, h("div", { key: '47a28515a4eb2bf12e697900bf7fdc8bf1b55c2b', class: "task-card__unit" }, h("span", { key: '410b3545e6361957efe1bda2a63ee2cc507d096c', class: "task-card__unit-name" }, this.task.unit.name), h("div", { key: '80602e18909fae8b16df505ea7882918972e4c62', class: "task-card__meta" }, h("span", { key: '57ab0102332403c82310e8ec3008ff8c6599ca54', class: "task-card__status" }, this.task.status.description), this.task.hint && h("span", { key: '626762c34d795b64cc7753373571f618800add2a', class: "task-card__sep" }, "\u00B7"), this.task.hint && h("span", { key: '19762ba9ac3b97cab1af7bdc7280989257ba2623', class: "task-card__hint" }, this.task.hint))), h("div", { key: '03255a288588fdaa0d71b03d19def55ab54fa155', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (h("div", { key: '3f96e15f8e7adae5e209d8741465bc24047f08da', class: "task-card__guests" }, this.guests.map(g => (h("div", { class: "task-card__guest" }, h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), h("span", { class: "task-card__guest-count" }, g.count)))))), h("div", { key: '4261293bce1e34f3c3698491d5f8921f94199a83', class: "task-card__assign" }, h("wa-select", { key: 'f7bbc180cab6b4e9e87c3b60d96da710bf985be3', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, h("wa-option", { key: '11ae192c2c09bf931b77c46a867a131b3c3e2889', value: "0" }, locales.entries.Lcz_Unassigned), housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), h("div", { key: '558e2301d1c4b7c5a8c7b68cbcd7ab78721649f2', class: "task-card__actions" }, this.isSkippable && (h("ir-custom-button", { key: '25c849f691a7b25cb6dcba40c3fd0618092ac071', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (h("div", { key: '068efd86fbbc50d0f0b57f883a9c1a6cf01f8518', class: "task-card__clean-group" }, h("ir-custom-button", { key: '290d19cbf1d5e4638c9398f2fae6016eb7255c02', variant: "brand", appearance: "filled", onClickHandler: () => {
                toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), h("ir-custom-button", { key: '2117031c89b626cc20d417b5ce679174e99ca397', variant: "brand", appearance: "accent", onClickHandler: () => {
                toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (h("wa-card", { key: '5fe8644287d0256cda7549a55285e9ef275ca5f4', class: `filters__card ${this.collapsed ? '--collapsed' : ''}` }, h("div", { key: '36bd763d494851ae3354506eb047cfeb801df8c7', class: "filters__header", slot: "header" }, h("div", { key: 'a26b491022b2ebd79dc3eea448f26ff6e5118b14', class: "filters__title-group" }, h("wa-icon", { key: 'dc27bb765c798add31c99c96e412f3ffb971584b', name: "filter", style: { fontSize: '1rem' } }), h("h4", { key: 'fe2e8d5b51d4a6757591d66d16380446b916de45', class: "filters__title" }, locales.entries.Lcz_Filters)), h("ir-custom-button", { key: '5b392844b0acd3f415387a29c101bfc83db726fc', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '569b0bf758d9af1d5c64ecd0c2928e6360377a4a', style: { fontSize: '1rem' }, name: !this.collapsed ? 'eye-slash' : 'eye' }))), h("div", { key: '2d56dee81eba8591b2551691dc0c53ecd35bbc0d', class: `filters__body${this.collapsed ? ' filters__body--collapsed' : ''}`, id: "hkTasksFiltersCollapse" }, h("fieldset", { key: '0fcd7a4d521d10a246cd30ac74d633ec96f78683' }, h("wa-select", { key: 'c5601e5c060f985f09467b15d81ee7d0611c53c5', label: locales.entries.Lcz_Period, size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: '1e12a9e47517b281982dc6bb251f473b0da495c9' }, h("wa-select", { key: 'e6c4811d2b2d1f4a62e52e5ead1b67fb19b81fda', label: locales.entries.Lcz_Housekeepers, size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, h("wa-option", { key: 'ace4ee1c91d76f696c5b936fb9cb46c75e92ca66', value: "000" }, locales.entries.Lcz_Allhousekeepers), housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), h("fieldset", { key: '81f1c651f94c136f77db2e7a41511da0fb944f63' }, h("wa-select", { key: 'e4b03e7d4879df7dc934dd284806ff86fb926e22', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.dusty_periods?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("fieldset", { key: 'fef30abeb808988b2099e0f3654faae96c319457' }, h("wa-select", { key: 'd6e1d161ed8f1222f5b386376c9d13987c98c42f', label: locales.entries['Lcz_HighlightCheck-insFrom'], size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("div", { key: '3f47bccedbdf7d07a6a4ce7b8e8ce69e8008ac3c', class: "filters__actions" }, h("ir-custom-button", { key: 'f3c9ff9dfd8da53fecbef4e79252bf884f4f794e', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales.entries.Lcz_Reset), h("ir-custom-button", { key: 'd31bf13325bd0b7254a2bd13d3f15341688eccc3', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales.entries.Lcz_Apply)))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: 'c5136f8d48cf677396fb443e4784657ea274dd9a' }, h("div", { key: '9f3ba83391a7b6621f099758345c1f15164d2974', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input", { key: '87580ac51ce4c6eb0df926bff8c4e66f3186791a', placeholder: "Search unit", class: "search-filter-input", value: hkTasksStore.searchField, "onText-change": e => updateSearchField(e.detail) }, h("wa-icon", { key: '106c1ee28a6fadee37fc4569fff6d9bf740f8510', name: "magnifying-glass", slot: "start" }))), h("div", { key: 'ae11bab1d9683817eaffe3668412f214ffd1e0d1', class: "action-buttons", style: { gap: '1rem' } }, h("ir-custom-button", { key: '468b7bd756cdc32b51019e59b8b66ad6d43a98a3', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, h("wa-icon", { key: '617dd810b4230c1d10e6848dee4f207b1826379a', slot: "end", name: "file-excel" }), locales.entries.Lcz_Export), h("ir-custom-button", { key: '86a13d8fde78a5fc788ad10d419332556a525e62', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, locales.entries.Lcz_Archives), h("wa-animation", { key: 'f49572cbf0bb6327276b1cf004bca0264e24d026', iterations: 1, id: "cleanInspectAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, h("ir-custom-button", { key: 'bcd46ad0d2f44a167d8d4437e97f5976a12e0a29', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), h("wa-animation", { key: '582e2387f4f215bf8c8da99874f59b8e061e5229', iterations: 1, id: "cleanAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, h("ir-custom-button", { key: '536e06f7bdc6f1ae589f08430dcf47759f7a0ea5', disabled: !(hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
