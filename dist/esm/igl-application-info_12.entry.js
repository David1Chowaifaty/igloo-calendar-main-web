...
import { b as booking_store, m as modifyBookingStore, B as BookingService, d as reserveRooms, r as resetReserved, u as updateRoomParams, g as getVisibleInventory } from './booking.service-7c726a5c.js';
import { l as locales } from './locales.store-629477c2.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-f4e207f9.js';
import { f as formatAmount, a as calculateDaysBetweenDates, K as validateEmail } from './utils-a6344a57.js';
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '01090d4e31c16943989434be2b0c2d8a27570b57' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), h("div", { key: '86d903308c73b3790a6a2a7e3a5e740c7ff73f8b', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, h("fieldset", { key: '8ea90ff13b652718b0dc7446a4cd13b7879826b3', class: "mt-lg-0 mr-1 " }, h("igl-date-range", { key: '73f21928f1a9aa08ab6e86ceb9bbe592af84cd26', "data-testid": "date_picker", variant: "booking", dateLabel: locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: '675fa74fa2991470a7172fc0969c69b63dc8c89c', class: "text-right mt-1 message-label" }, calendar_data.tax_statement)));
    }
};
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (h(Host, { key: '9c0c1958ea9d4689b520dc1bcab2f81280db7ebc' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && h("div", { key: '97cb390989cded78325850610b07091ee4bc3bef', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: 'f2ef24d630ba0a652942c5b972623ebc88e8917d', class: "d-flex align-items-center" }, h("span", { key: '0a215c2d1e31df552eda17967048f49ad66a0b5c' }, this.dates.from_date), ' ', h("svg", { key: 'c225888b1f14fb74d2a83883451238bbb42cb3d4', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '5ff0bbb671b3776507584404c4de5e0779409cc9', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: 'a484790352627f1adb28c11a1faaa2119df3b70f' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '478d4993dfc588765ac76db40797a512e3793c6e', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
