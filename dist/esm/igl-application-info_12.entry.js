...
import { b as booking_store, m as modifyBookingStore, B as BookingService, d as reserveRooms, r as resetReserved, u as updateRoomParams, g as getVisibleInventory } from './booking.service-13b43e3b.js';
import { l as locales } from './locales.store-629477c2.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-f4e207f9.js';
import { f as formatAmount, a as calculateDaysBetweenDates, K as validateEmail } from './utils-81ee5d46.js';
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f1b9538864eaf305091877101065f77cabd3befb' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), h("div", { key: 'c27387d5270cc6fb8bef74b1dc7b84e48bd60b0a', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, h("fieldset", { key: '765e82190065795be1ac3bcba5d52746c33e281d', class: "mt-lg-0 mr-1 " }, h("igl-date-range", { key: 'fc38414b6ec436f5ce25b265b994675b94a2152f', "data-testid": "date_picker", variant: "booking", dateLabel: locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: '8cdb3f2e4808fe9304d16da9e9b3d5b0e636f758', class: "text-right mt-1 message-label" }, calendar_data.tax_statement)));
    }
};
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (h(Host, { key: '11b3db3cc2e509309da85855800ed701433d68e7' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && h("div", { key: 'd084ffce91c1a580181566f8d379e47ce8a968b6', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '7a83d080375592ff42f67e7d93e57d32b75d33c6', class: "d-flex align-items-center" }, h("span", { key: '4cbb88cf67b411bd424f312a736a2f0763e0a749' }, this.dates.from_date), ' ', h("svg", { key: 'e7e7541228acf32c50e45367af1806a5e2cd6ba7', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '7a886c7fcd5469c481f93cd64e9148bbdd9d3f6b', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: 'a7e0fc1a7094d4043e9db274e82b534654a2350e' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '551440ce7feb94142be3cc106b368a46a6853e9d', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
