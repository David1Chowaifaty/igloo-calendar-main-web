...
const IglRoomType = class {
    ...
    render() {
        ...
        return (h(Host, { key: '3386faa38ac8247cc54941e1901bb3ed858f5012' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && h("div", { key: '8e95ab4a432d7c2a2bb28044abc7a224914680fc', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '3e03c276a31e20e45f52afd306834189c28c2323', class: "d-flex align-items-center" }, h("span", { key: '602ea90cf132f9f78299b8c72c1792d1f3d32f7d' }, this.dates.from_date), ' ', h("svg", { key: 'dddb5134f0dba6ac3242f7e140eef31996bacbe1', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: 'a12e44c6504b7952c6fdb137ca7c952752b13f87', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '91efd7a969e480927863c382f34a14b214251fc1' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '7b1c7be8c5e6b8882fd2c7557ff108ba72025bdd', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
