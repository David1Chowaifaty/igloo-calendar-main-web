...
import { b as booking_store, m as modifyBookingStore, B as BookingService, d as reserveRooms, r as resetReserved, u as updateRoomParams, g as getVisibleInventory } from './booking.service-1264d5c5.js';
import { l as locales } from './locales.store-53ec3957.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-a6093df2.js';
import { f as formatAmount, a as calculateDaysBetweenDates, K as validateEmail } from './utils-8efeec43.js';
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '04e3a377fd79db4046a4406b4cd3b8d412264e76' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), h("div", { key: 'f8f6cb42f6438ecc6b66c0425d7335b4f581132e', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, h("fieldset", { key: '14311e66b187b3565cff1c2d745cd5ffc7961279', class: "mt-lg-0 mr-1 " }, h("igl-date-range", { key: '77ea0fe047172a4ec78576802b9c27c89d6fdc4b', "data-testid": "date_picker", variant: "booking", dateLabel: locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: '43c71656e8ae8fae5598cf6d54c3406eb0f345f8', class: "text-right mt-1 message-label" }, calendar_data.tax_statement)));
    }
};
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '62178cca228068be4c4013becbaaf737100eace1', class: "d-flex align-items-center" }, h("span", { key: '6118954353ceb7c443180376f80bc030aa42fbfc' }, this.dates.from_date), ' ', h("svg", { key: 'ee61d174e8e1257669f2bd6a8b4eb0ecace1edc0', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '80555a1206dad27b4ee5ccafaa2672c8f0d9fd03', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: 'e5fb3f871b13947e7419510f4fa8919b9366c8ab' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: 'c2d8aed85f9203bf246028f6a7491077bbca476d', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
