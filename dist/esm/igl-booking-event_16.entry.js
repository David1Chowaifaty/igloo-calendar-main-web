...
import { B as BookingService, a as resetBookingStore } from './booking.service-cd705f45.js';
import { D as isBlockUnit, u as calendar_dates, c as calculateDaysBetweenDates, A as transformNewBooking, L as checkMealPlan, b as buildSplitIndex, M as getSplitRole, f as formatAmount, N as compareTime, O as createDateWithOffsetAndHour, P as isWeekend, d as dateToFormattedString, Q as getDaysArray, R as convertDatePrice, S as formatDate } from './utils-1825b25c.js';
import { h as hooks } from './moment-ab846cee.js';
import { E as EventsService, P as PropertyService } from './property.service-2ca12f16.js';
...
import { T as ToBeAssignedService } from './toBeAssigned.service-caf0de05.js';
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '7277f6262466ea8b72dca41a48886ad423534b7c', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, h("div", { key: '7cea756b0373f8aaecdd5af8c6834d8f23e50384', class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && h("wa-tooltip", { key: '47c43497ff66fab9bcca00aaa028ab13ff650786', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && h("wa-tooltip", { key: '3eca1364fc229d874bf775cdf590ce8ff6ee93ff', for: balance }, "Balance: ", formatAmount(calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (h("div", { key: '0197b83fdecf5c0b7dc220f4840bb3043f9e704c', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && h("div", { key: '2f16582be5e7cdd3ba7088e4f2c090c5473b2d3a', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), h("div", { key: '393639ef3e3f45615ac7a0ec6f3d10f567b33cfc', class: "bookingEventTitle", style: { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), h(Fragment, { key: 'a7bdcf856e820c2c7a391da171f9582a600ccbf8' }, h("div", { key: '8108f53b090f7238da075c9680d4a74204a15efe', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), h("div", { key: '470f8f2844165b45ead0c5e42e7ea8c17db75885', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (h("form", { key: 'd2b1cf0bd4b31b67d5873dc92cc09b150e34bf03', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("div", { key: 'a31d9ce9ce2f9eee794cea3c433666527992ea54', class: "sheet-body px-1" }, h("div", { key: '08268dcd20a051883e434833d8d4e6d2b4547da7', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, h("p", { key: 'c54cfcc3eea6751678a6a7e3d102c8252bd26a2d', class: "m-0 p-0" }, "Select the unit to"), h("ir-select", { key: '1f0689a8fd1612993ef0f94e92de99e901406621', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), h("div", { key: 'c7de6f89aef9ff8b2bf7cc55f8d9a15aeabd4a41' }, this.errors === 'rooms' && (h("p", { key: '850960c18e5c359ba37d102553a519eb84260703', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("ul", { key: 'ddde10b1f061152be683add2066d4b9e035fdf34', class: "room-type-list", ref: el => (this.unitSections = el) }, calendar_data.roomsInfo.map(roomType => {
        ...
        }))), h("table", { key: '63919ad06f19672d7f35c95ceb07add61c3e92e7', class: "mt-1", ref: el => (this.datesSections = el) }, h("thead", { key: 'b46bf2cc8d4065d0458c57707458dd3a795409aa' }, h("tr", { key: 'b5aa34c87104c34f809690abd629ac0c5ee5b0e6' }, h("th", { key: 'd989a4ced64f17cdc238b1b57f74794efdad37d0', class: "text-left" }, locales.entries.Lcz_From), h("th", { key: 'abd85346627b286f196740633fe624f7888c02f8', class: "text-left" }, locales.entries.Lcz_ToExclusive), h("td", { key: '3d31503a081c680ac07283c0aca58f8e5ab09d12' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (h("ir-button", { key: '14adc377a4a51bf5de48741ad7609d4af33a78ff', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), h("tbody", { key: 'c41fef76d23e477fa324abf9d4e3715d79a1225d' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), h("div", { key: 'df83f05e163840542eec16caafb9398239fda5c3', class: 'sheet-footer' }, h("ir-button", { key: '6794eb047e690e8a522e84a1a6b77ffccf1b694d', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: 'fa7546a1a61669fff080a3d91dff6567cd287fa4', isLoading: this.isLoading, text: locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (h("form", { key: '5562d4126780e80fe0150f5dc3140ce16767f84a', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("div", { key: 'eebdf60cfd616989173512444becbc3e5e6155c7', class: "sheet-body px-1" }, h("div", { key: '6989696850ae23fe20e5818d791b8eae78ddbd84', class: "text-muted text-left py-0 my-0" }, h("p", { key: 'a2e4772f1bd0e136d490b04d03dedd83c3863ef4' }, "Select the types to stop or open sales for all related rate plans")), h("div", { key: 'c4c6eb73d898f7d4595d8498d5963cba2b6e309c' }, this.errors === 'rooms' && (h("p", { key: '6789a3bf4fcbc7903e154915734d3ba91b09dfaf', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("table", { key: 'f2dbb912408acbad566a33407a26ea1b1b69d1c1', ref: el => (this.unitSections = el) }, h("thead", { key: '0833d47483d0f34fe63c956243e44e0e318af0f7' }, h("tr", { key: '0ee5a9d2f4c4a857e884469a9c898311674cb0e4' }, h("th", { key: '5243b5f97e67e762d4be9a62835a29d50d22087f', class: "sr-only" }, "choice"), h("th", { key: 'f09592e1cedbb81f2da2f4ca03e7313d1f275589', class: "sr-only" }, "room type"))), h("tbody", { key: '68d348fd2d44c07faf3a300cb318edcb5ec685a5' }, calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), h("p", { key: 'aed9d623987ba10b0ce84a38c47493fbbc562f35', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && h("p", { key: 'aff1ddb07fc1f0fb4a12294a688a11d1471aad82', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), h("ir-weekday-selector", { key: '65344765d42de10d7fbe9aea64b94b7cc3447b0d', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), h("table", { key: 'eeb88a7827428df6a7493c91626c0fd981e2f1a1', class: "mt-1", ref: el => (this.datesSections = el) }, h("thead", { key: '4addd7681b6b6e6b9f533353d3c80e191cdd7a2f' }, h("tr", { key: '48796539f10af43d5ed843440e26bdbbb9c52d5e' }, h("th", { key: 'f3220d70c9ae50a1373af7be6e636bf4ced7ebc6', class: "text-left" }, locales.entries.Lcz_From), h("th", { key: '904251a12cacbddf45617f42409fb5cfef318c5f', class: "text-left" }, locales.entries.Lcz_ToExclusive), h("td", { key: '2ecb811f88e257becb4dd2d86d77d4ae817a1fa2' }, this.dates.length !== this.maxDatesLength && (h("ir-button", { key: 'beed10435007e83f7ba0e4b59e115e96ea9fe195', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), h("tbody", { key: '5356139594d3045483e0ee607d35f621c3dbbf30' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate : this.minDate;
        ...
        })))), h("div", { key: 'e05da211e5bc95004e76711b045a8c5a396099b5', class: 'sheet-footer' }, h("ir-button", { key: 'c033d43d71a79301041c1f789404357c3d8b797c', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: '9613fee5f1e6b72afe1370c44047dc705d28445e', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (h(Host, { key: 'f178ed726d15da34c63e123783f0ab08279cde5d' }, h("div", { key: 'f47ef9a62eb18ec249e02d33232f6d8fd502318a', class: "bodyContainer" }, this.getRoomRows(), h("div", { key: 'f104114a74a2b9b3d627edea71ddf7f808688e28', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
...
const IglCalHeader = class {
    ...
    render() {
        return (h(Host, { key: 'a6a4e9ef339739dc5d159bfe2e3786dfc2b31b2e' }, h("div", { key: 'f9d52b8cdd4ccd52f68bbce36df304bd6deac937', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, h("div", { key: '8c8e713009264e2df39fbf980367d3278b81bb6b', class: "header__fd-actions" }, h("div", { key: '65c47206a6b3c00346c656bfc06e63b42e5d51bf', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (h("ir-button", { key: '1f4401db96f17dc4b593767a03aaea41a2f11e1d', variant: "icon", icon_name: "server", style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, "data-toggle": "tooltip", "data-placement": "bottom", title: locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), h("ir-date-picker", { key: 'dbbf8c752319c23657220d5f0b14acab72dbca0a', minDate: hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, h("ir-button", { key: 'aa94ba2e289ca826ffea1eb46670571d3f8278ee', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), h("ir-button", { key: '393b2bfd4307568b76c2991c594630e4b1aa7043', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, "data-toggle": "tooltip", "data-placement": "bottom", title: locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), h("ir-button", { key: '0830237744b67c1e731c357a60c175abfd2d0cd9', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), h("ir-button", { key: '542400b75e3b58f6d8241c5874e5f17cf82ede6f', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), h("div", { key: '681549c381a16d1c964fbeadd095f1d1b52e7e13', class: "searchContiner" }, h("ir-picker", { key: 'b7e90dc74aa2a47996edb6eda6e23c073a714d2c', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), h("div", { key: 'd00f83ec4c0bc5bad0f70331b7197941f0fe33de', class: "stickyCell headersContainer" }, h("div", { key: 'babfabb471caa327e8e016aa696f55ac66117b73', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglSplitBooking = class {
    ...
    render() {
        return (h("form", { key: '4e2a32eea55bdfd2a90e77159f50183adf80d5c9', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("ir-title", { key: '28b27ade2ccf1d185374f557907a91da2af59d7e', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), h("section", { key: '8f60c6ef971902c68f73e6c4a8c519d289d671fc', class: "px-1 sheet-body" }, h("div", { key: '49348203471ce491bea1c34b90453ba3937dac35', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, h("div", { key: 'dc1ed8e126cd7a11bcc4efa236fb468926a25c19' }, h("ir-date-view", { key: '00fad800dcf46b989658be646e6e05912e2710ca', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), h("p", { key: 'c91144d6c63820441e8fb2e3e4b3ece73f639238', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales.entries.Lcz_NonRefundable : '')), h("div", { key: 'fb1327ba65a4c1e22f2740c5d8dbbcaca0b1f5ea', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, h("span", { key: 'f7d5ba40c04316edc407089ebbfd3d7a276e418d' }, "From:"), h("ir-date-picker", { key: '29cfdd213dd9bfb398321e2b1c09795e647a862b', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, h("input", { key: '079804d42576881a168c75e6b0199454c4660bd0', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), h("ir-button", { key: '1c506902aa81f457b925b8e527bf7211c305a4f1', isLoading: isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && h("p", { key: '245730a13555d6ea7c3e375a42fd6c7720c217dd', class: "text-danger text-left mt-2" }, "Please select a room"), h("ul", { key: '9e0d8ec3ecb8320d1374fb08baac21d0cb27fcfb', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), h("div", { key: 'a31e0404f5394fe2b45816e398445f98fd07b6c9', class: 'sheet-footer' }, h("ir-button", { key: 'cef8222b8bab83e04a42d61afab2b292ddc8e1af', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: '643d8ee794cfd4b3be3a6538d46d2058c965af2a', isLoading: this.isLoading, text: locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (h(Host, { key: '7b5d9f9ae7599006b6aae5503ce92777b1e4447c' }, h("div", { key: '135ac55e3fac12fadf7d6d9e6af8ecec96487e8d', class: "sectionContainer" }, h("div", { key: 'f35ac1136c3c4fa2eaba3f7c9af9954e0ca3eaf3', class: "font-weight-bold mt-1 font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd91026873c9a0e23f0438e7e4e6b2e67483f3d11', style: { '--ir-popover-left': this.irPopoverLeft } }, h("p", { key: '5d57fcb6429d446c5eeda93a34756eb36b4e2e47', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, h("span", { key: '979828fea8c661845f3d22ed358c8c0f5fc11cc4', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (h("div", { key: '120805745293e163b7d79bf4fc45f24f4329e51c', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, h("slot", { key: '56333b73354a4253810aa26ccb3735abbdc47cd8', name: "end" }))))));
    }
};
