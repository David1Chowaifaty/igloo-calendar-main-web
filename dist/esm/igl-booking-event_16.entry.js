...
import { T as ToBeAssignedService } from './toBeAssigned.service-e7fa7c93.js';
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ca755d76e5fe4f6a9f805893348b85e6d189f62c', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, h("div", { key: '79a5a7f47b4158d7832981ea8a5c25f8eea3d797', class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && h("wa-tooltip", { key: 'a331c513a0372221a53a3dc96bbf743828d60de0', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && h("wa-tooltip", { key: 'c4d15458683951b6bd4b99bfd00f1ad510fcfbc1', for: balance }, "Balance: ", formatAmount(calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (h("div", { key: '2243191ce0721f8fffb77f0517c64c8c4ae6d7fd', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && h("div", { key: '9a6ad5508bee22525975823da45bef5c71ce1568', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), h("div", { key: 'f9f00b20c91905df105ed4ad2284178adaa84ed3', class: "bookingEventTitle", style: { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), h(Fragment, { key: '5c555eadf087588568562b4c11d75963ab20f5bc' }, h("div", { key: '2eeecfd7f408ef279afca2eb3fa04eca3538232e', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), h("div", { key: 'a56cbb65061033b20bb6995a910af49eeb88cbeb', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (h("form", { key: '866eeae1ac8a2118ef529811717238b3f4b78b2b', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("div", { key: '8d173cae5e1e5e4c8d4800dd1853c7b405c53b7d', class: "sheet-body px-1" }, h("div", { key: '70410bdcc10610bfb2924fee97ac83dfb47cb261', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, h("p", { key: 'ec4a8c9aa557d0623da2efd4b5994cfb8add5cb1', class: "m-0 p-0" }, "Select the unit to"), h("ir-select", { key: 'eec07c66ff6320bc92bae7cf38d019d01a8f713d', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), h("div", { key: '11275909ea81aca4a7b6314a58ca64c603317478' }, this.errors === 'rooms' && (h("p", { key: '4f6ff3f0666ebed7bd68460e5d83b370355c6cf8', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("ul", { key: '90cd465fab564f3d723af547380810385baf05ba', class: "room-type-list", ref: el => (this.unitSections = el) }, calendar_data.roomsInfo.map(roomType => {
        ...
        }))), h("table", { key: '15e254bdd0fcfcd225f0774afcee0e558969bae4', class: "mt-1", ref: el => (this.datesSections = el) }, h("thead", { key: 'c22762ba2c0411c7c65450c1b7d49ec97ae2b53b' }, h("tr", { key: '05a0adfcb79cac4d8b577f08f1b566169791e305' }, h("th", { key: '5d10c3f530132971e45c15769fffbcbc498bdcbc', class: "text-left" }, locales.entries.Lcz_From), h("th", { key: 'c429795660d9099d65d6de65c88e89d77414484f', class: "text-left" }, locales.entries.Lcz_ToExclusive), h("td", { key: 'c8b7df5cf1d6ebc946f8e4b6432eaa3c90e3ef55' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (h("ir-button", { key: 'f4423cd28e573912ffcce2f9cca516525a65fc8b', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), h("tbody", { key: '89fc39f68f37d4dd8d833b4b9f4ce092cf0f8b74' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), h("div", { key: 'a0c49d84d459de7df574042836aab30a4c86d70a', class: 'sheet-footer' }, h("ir-button", { key: '22c06d16041f1901c0801cfea7afa488e097f3af', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: 'eefad66b05c7a58aa078d556d5b09bb51901656e', isLoading: this.isLoading, text: locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (h("form", { key: '60d26f639e16ef4d71d6b7d62233810b514c5fd9', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("div", { key: '46d2008c3f94d6f2636df6a1891bc4325fa96ab3', class: "sheet-body px-1" }, h("div", { key: 'ab330351a9c95a5e93e9c437c2efb6c9f50a8401', class: "text-muted text-left py-0 my-0" }, h("p", { key: '31ea30f359576c59f6816cb91746246b04f81cc4' }, "Select the types to stop or open sales for all related rate plans")), h("div", { key: 'd1ae7f495bd93f2248a027a8bea7d304ddd11109' }, this.errors === 'rooms' && (h("p", { key: '1aa0e5842f5cc6458c76b401a74e9a0adb4f7251', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("table", { key: '4db9054ce3da32664cfc71351f9969fae3874730', ref: el => (this.unitSections = el) }, h("thead", { key: '5de268ec503d833a051bea58a664eae7f899c2bf' }, h("tr", { key: '44afd19edd8f90231ec5c124edc009aa8e8f247c' }, h("th", { key: '9a9ecd9c6b3eac03cefede6bec7d462c3c4f0157', class: "sr-only" }, "choice"), h("th", { key: 'f5f8d1da5c5d3760d0dc2f64e32606a287a051f8', class: "sr-only" }, "room type"))), h("tbody", { key: '18b5502563c74e44c0923aeefa2141c3a59d1da4' }, calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), h("p", { key: '97ad40d036c7885d1f166082decd86e0b497aa34', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && h("p", { key: '8e9dc864f26d6116d21608a0436fe63ea6c597a7', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), h("ir-weekday-selector", { key: 'a94903789407f5449f39bed21dacc8258cab0bf6', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), h("table", { key: '1307f8714c5b3c8f5455981a329d4333755c7b23', class: "mt-1", ref: el => (this.datesSections = el) }, h("thead", { key: '118a9cf3653031602c8ad7c0b5fbad05366078f7' }, h("tr", { key: '1a7f89631bdebd149b212407549e79ff35574056' }, h("th", { key: '87e93e0ced2166521b8059dc06e9c6ff7e5aaeee', class: "text-left" }, locales.entries.Lcz_From), h("th", { key: '3fc1aa8fa275a0fe603229beee73f2881781a089', class: "text-left" }, locales.entries.Lcz_ToExclusive), h("td", { key: 'f4625323427f625a00682c844e32b158764a0180' }, this.dates.length !== this.maxDatesLength && (h("ir-button", { key: 'b537552e8154496b9c144ce22caa4b47f70143b3', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), h("tbody", { key: 'b7c6223c1458a41c79a1662c92296338a55c6b58' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate : this.minDate;
        ...
        })))), h("div", { key: '548e1f8c189cff4dba85949d23b6a156557b92e8', class: 'sheet-footer' }, h("ir-button", { key: 'b077de9706fa2a54004ec35f4f7da874ce1e2912', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: 'e256bd4962dc1e267d7839533b45361c0b138f52', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (h(Host, { key: 'e5d0f6c5150b1e417c5221f5a0ffda0955fe829c' }, h("div", { key: 'd1ef4379cbaa9f5e05b243d369e16b25040dad10', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, h("div", { key: '98464a29bbe97ff2893cefd9a1a16dfa135c5266', class: "header__fd-actions" }, h("div", { key: '3e7b624e8475b40d0958d909354a26cf75ca8438', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (h("ir-button", { key: '3339ef71113cf181628edb892a3f71dd3ec1b428', variant: "icon", icon_name: "server", style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, "data-toggle": "tooltip", "data-placement": "bottom", title: locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), h("ir-date-picker", { key: '42b225fef3a8c9a15a765406c0d65fa3b3bec002', minDate: hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, h("ir-button", { key: 'e920248aa5e7d4036f337861a6c1b900519e4651', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), h("ir-button", { key: '3bf925715fc4a304da93e6cfecea5c14606cb3bb', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, "data-toggle": "tooltip", "data-placement": "bottom", title: locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), h("ir-button", { key: '13a90cc7c62d5e8b800aa7d76e386ca1a8541cc9', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), h("ir-button", { key: '2fab770678b770290d4f4f0cbfb8571d8cc4362f', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: { ...colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), h("div", { key: 'ef988a856e1d2e53ec9a75883ca671fb189f9be6', class: "searchContiner" }, h("ir-picker", { key: '863a96872068db2d22351912d134575f5eeb55b4', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), h("div", { key: '66e921ff3faa5171b1642cda97170ad4ffae5f01', class: "stickyCell headersContainer" }, h("div", { key: '652285925934aad90fcedb8271b1ba44d096f7ad', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        // ></ir-select>
        h("wa-select", { key: 'b231914b83b89b8ffb8186fd2cbcc15a5d4e8595', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, h("wa-option", { key: '925e0a97881ea1633ca60a772caa6c1773182f5f', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (h("wa-option", { key: option.value, value: option.value }, option.text)))))), h("div", { key: '0ebcc476e2890abf1bd8a29ae3914165228bddcb', class: "dialog-footer", slot: "footer" }, h("ir-custom-button", { key: '64ae7a4db9081cb6108d169b0f699af35615c143', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), h("ir-custom-button", { key: '313ccb7e975a87254a4df735bde6621ced527e2a', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (h(Host, { key: '031501bf76a724cd264772889b8d0b470bd031d0' }, h("div", { key: '82b22ac82223e7257185fbae4cb49a0948d628cb', class: "sectionContainer" }, h("div", { key: 'e5725cde0c37d695192e31ced2f28997bcca2d7a', class: "font-weight-bold mt-1 font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
