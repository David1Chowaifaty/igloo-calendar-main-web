...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (h("div", { key: '93b81647da42f60ebe39db0580e49b2d47e6812c', class: "fluid-container px-1" }, h("div", { key: 'f74940aca9d13f06e57d8b9a828f47e4a9a9ecab', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, h("div", { key: 'ff27ab05a2fef3f88892f8c04b7e48d05eac66d0', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, h("p", { key: 'd7ef1476b89f4627a3b02ed82bef3c0e80c33d1d', class: "font-size-large m-0 p-0" }, `${locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), h("p", { key: 'be794f695445826e3ee259441cb7ae7303a60331', class: "m-0 p-0" }, !this.booking.is_direct && h("span", { key: '958fa55421fba5df262bf25960ae5a207d484c11', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), h("div", { key: 'bcd6b679650464671016737fef3dcfb2dfca1f97', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, h("div", { key: '17098f2c9355300f11b67f3bceffe13d7a970b01', class: "d-flex flex-column align-items-center" }, h("span", { key: '944d5c51c09dc871ecb86915253696e1552f9eb7', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (h("ir-popover", { key: '0d2157e743f7dda8616b83737e43003c881c1939', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, h("p", { key: 'd0e78898a9d3513e8afdecbc55381c0459ce80ad', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, h("b", { key: 'd62cbeb0b59d3faa45c0c0ad6d49bed2ba7787ce' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (h("div", { key: '3bd8a679f6eb0e7215243bfff8dab7c888b383f2', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, h("ir-select", { key: '035b0933bb6118e8a6c5a728545add7ed316a2dd', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), h("ir-button", { key: '27b29f4b1c27f0d5fbca8b59d270f01e0bf45b48', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), h("ir-button", { key: '44f11cf3995f5e44197074ad53206f711dc0d907', size: "sm", btn_color: "outline", text: locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendar_data.is_pms_enabled && (h("ir-button", { key: 'ba34a7bbc54700e62fd05fa4ad5cc7cb973ef68d', size: "sm", btn_color: "outline", text: locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && h("ir-button", { key: '329063f571628858594bc08549d09f0fd4ac72cf', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && h("ir-button", { key: '641014ffeca5b8c7e8ef17bafc092c92f92e10e4', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && h("ir-button", { key: 'df0373dad5cb5883ce6ef2010e5148b547f1b0b9', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && h("ir-button", { key: 'e4a8db2ce72b3420c48e10136545541c549811e6', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && h("ir-button", { key: '74e2c6710af6de15767fcc448f8a6f5bcd367df1', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (h("ir-button", { key: 'dae673b6825ed411345cf1159012729a16c97074', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), h("ir-dialog", { key: '1fa7fc5d862913e1e78bf4839e49b5f82f7118aa', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), h("ir-modal", { key: '6661e56b2819d59484f3f1c3887599bb88e7dc6f', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales === null || locales === void 0 ? void 0 : locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales === null || locales === void 0 ? void 0 : locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales.entries.Lcz_OTA_Modification_Alter, isLoading: isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: 'c56f72f692e61e7ba1ab9f69bec10be75952d8bf' }, h("div", { key: '1a2a2db42254043b660a44cfdd4283781e385311', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '29e2e324a09f8ff683319344d079ddda74f723b0', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'd616ffb68fc4d94c03be6c604da2c6b8eb27d9a3', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'e3f265b6d9f1d36df6cd1e4853984b6cc17c2df5', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '19bdfb69ecaad5563c62df595f8d90eed228cf67', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '3f65c1c257b7adb4514feee436d66eacf501ba02', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'd3192a68612993e4f7af8e62ec869f1a49cfefb5', name: "modal-title" })), h("div", { key: '03de4ef2473bacb7c43bdcd69745122dad65c531', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'e9d63b68be8de5e61e10d4ef32776926918511af', name: "modal-body" })), h("div", { key: 'bc2c7bebe24e05a5e9661ff56a4bf8e19f3c1fca', class: "modal-footer" }, h("slot", { key: '62f088fb19165332c37cd3d373ff0a68991e4b02', name: "modal-footer" }))))));
    }
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (h("form", { key: '408eb8ffdc0b5ccefa7236d62943ff3751aa1f4c', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, h("ir-title", { key: 'f8273c7f986763b35f726411ef1fdc2ad36a2333', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), h("section", { key: '14d091d6ca6b65f9e875ca3a26da22b6f1848e1c', class: 'px-1 sheet-body' }, h("fieldset", { key: '04bbc00f0d3ae027c5c6bf6299ee8c4d53c4b2a0', class: "input-group mb-1 service-description" }, h("div", { key: '85fca4351f4496cf83ea7c896f8423475c6e37fe', class: "input-group-prepend" }, h("span", { key: 'b0eb4bb2e4092e7876d10ed51ebfaf2cababe938', class: "input-group-text" }, locales.entries.Lcz_Description)), h("textarea", { key: '8c2cb359ed00f4e336bf0857964d80d7efadd973', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), h("div", { key: '1e43d0341a30ed3e30fc156c5c3a4f78ae036ddf', class: 'row-group mb-1' }, h("div", { key: 'a40186e5d362abeba36418caea180d0b08205eb6', class: "input-group" }, h("div", { key: 'ee24697ea000cbf9747a3a50e1e35d05e2784749', class: "input-group-prepend" }, h("span", { key: '23eb2bc78526bbcc242a822a3f83fccaabd3718d', class: "input-group-text", id: "basic-addon1" }, locales.entries.Lcz_DatesOn)), h("div", { key: '280e711b197ec6978696e66a2841b8e01310acbb',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, h("div", { key: 'be1b144bf17aeb4780342ed93748b05d8b5189e7', class: "service-date-container" }, h("ir-date-picker", { key: '61ea1bc3ba8948ca4583ffcf155e68bb1881e2fd',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, h("input", { key: '87d23fc972502693be142f3792314223841e5bc8',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? _formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (h("div", { key: '23b7faa081533a59239bb513bb8018325dea7aec', class: "btn-container" }, h("ir-button", { key: 'fea42673466e2c3657fd7434337aa0e10cfca943', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), h("div", { key: '9b4dad7acc1999003775250270622737ec486ebe', class: "input-group" }, h("div", { key: '9c0159709b69a55e5d4159e0f99ea1b1bbe12a08', class: "input-group-prepend " }, h("span", { key: 'bf78b6a078682020770356297635c3ec4cacc483', class: "input-group-text until-prepend", id: "basic-addon1" }, locales.entries.Lcz_TillAndIncluding)), h("div", { key: '5e86d83e17eaeddd93a23faf635237216ea29ae5',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, h("div", { key: '17eb24fd1e92b4dfec2816d7c01dc08b0f4ebc40', class: "service-date-container" }, h("ir-date-picker", { key: '3e36ad6b0f7dfd3fecf60e0df67f34f2a83b0706',
            // onDatePickerFocus={() => {
            ...
            } }, h("input", { key: '0ed4b6c9216fd024eb71045677cd9b9f4b582cc9',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? _formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (h("div", { key: '5613fc6c42ebea65361b17d94fe0c50a6a5369ba', class: "btn-container" }, h("ir-button", { key: 'a896880f90c79fd398726e40fb86c4840e3df38c', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), h("div", { key: '8a718d5a6813f9cdbc4d2afed70a8aa8648b4e67', class: 'row-group' }, h("ir-price-input", { key: '2ac256f3b807c919958171f33f1260b1fb173e89', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), h("ir-price-input", { key: 'e41c8db2b199b2382f5915045700b37a07ab6374', autoValidate: false, label: locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), h("div", { key: '021143c0cfe7e3de7989e53aedb8f95720148d81', class: 'sheet-footer' }, h("ir-button", { key: '18c1165665aff498d10a53a0261176157f52ddcf', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: '58b632e10da4d431289759423640aff3556e859a', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: isRequestPending('/Do_Booking_Extra_Service'), text: locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '2da979e856a2ecfc00b578404d0404be47665651', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index) => (h(Fragment, null, h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index !== this.booking.extra_services.length - 1 && h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h("form", { key: 'f43c6ca14e6d3447e70ee9e89437ddab48a69968', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-title", { key: '8c5dfe2df61684269ee8cd3727bbecf9322c4a97', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_Pickup, displayContext: "sidebar" }), h("section", { key: '0ec75d7a8d0ddde4206dce2005f6033f5640f5a7', class: 'px-1 sheet-body' }, h("ir-select", { key: 'd87bc7c892f61d175f047f1841ecd9d188816ea9', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h("div", { key: '2d3461fd9035471dfd9ad61a8bfc1c4be68557cf', class: "m-0 p-0", "data-testid": "pickup_body" }, h("div", { key: 'bd1cb25dd6721d2382e6fa2d9650d800cf82ff76', class: 'd-flex' }, h("div", { key: 'c40d9df4edbdd2d07e4fa54b7707de8d64102f5e', class: "form-group  mr-1" }, h("div", { key: '4fb55ca589d632545364dd238ce7515aa945ed19', class: "input-group row m-0" }, h("div", { key: '26f87315a367d1d802fa0263fef57e6fc0295bbd', class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { key: 'bd32d27624fc92dc099819490d1a8d64c8e2676a', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { key: 'a33e59d3c9838112d907a5987e916416090da7a5', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, h("ir-date-picker", { key: '839681297096cd17abced68b6b626031d2172c0a', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, h("input", { key: '2d6e152741f3035d34af2ab1aa0fc1ef12322023', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), h("ir-input-text", { key: 'bc9b4ab629de2c5e08e35286dc48e76383441f45', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), h("ir-input-text", { key: '726126ea54084a1992f2f2cc65a0417d6ccf8a2c', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), h("ir-select", { key: 'fea37f7fa434fc369a32e2d757683bfca44de0bc', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), h("div", { key: '7ed58724bdc69c8c4ece9fb7be550047467783b6', class: 'd-flex flex-column flex-md-row' }, h("ir-select", { key: 'd8302015c4bd66a6c9c500367d280f618a48d943', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), h("div", { key: '3457cde06eaf822fe4451d8d3d5ea96c651ec316', class: "price-input-container" }, h("ir-price-input", { key: 'a0457d945da3dc7f079516babede814a8a4d466b', readOnly: true, label: `${locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), h("div", { key: '91a174c1b058fb05f457c485f25f52f634fd2fb6', class: 'sheet-footer' }, h("ir-button", { key: '0f8f09411dfc34f291f332409aaf67197fd284cb', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (h("ir-button", { key: '4c5feccf728015ec84171a868bf62b8beb668848', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'c3ead5d6a4a9f7ea1138051dc257c5a5b45e0362', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
