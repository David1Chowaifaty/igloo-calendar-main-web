...
import { b as booking_store, B as BookingService, m as modifyBookingStore, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms } from './booking.service-cdd7229f.js';
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (h("div", { key: '4ec646ea6d5409c35fad0f3063bb186e9d950944', class: "fluid-container px-1" }, h("div", { key: '13a436f2b5bd9079122a8a47f0373066a595f8c8', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, h("div", { key: '55d1f5803a8a3e088c177e144d5ba8f3fc3ad1f8', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, h("p", { key: '4f5582dcedd598b05a87d703c1232fa2a032b7a5', class: "font-size-large m-0 p-0" }, `${locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), h("p", { key: '8c0113a41a3df8c4f502434ab6769a2f24bc9601', class: "m-0 p-0" }, !this.booking.is_direct && h("span", { key: 'f73d456517ae95213350e4c87de989e395973e34', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), h("div", { key: 'e7f4cd0a2b044a067824e084c02c3f90ae30697b', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, h("div", { key: '8a213efd792a7e0534641cd25fc796094f52089f', class: "d-flex flex-column align-items-center" }, h("span", { key: '26ff9c9b301d1bb834ad71ceb910c7d87427b4b6', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (h("ir-popover", { key: '76bd8770012ccf818ca16ee71d2fb92edd0d2e22', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, h("p", { key: 'c09e02771aebc93d9d53553b0dc981f8fdcb83c3', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, h("b", { key: '9e795ed1bcf59f48933c9ffbd0f108d6f65b916c' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (h("div", { key: 'ebb7c1b28336e49842f762254e1286e787fbbaff', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, h("ir-select", { key: '755dbdd438966d91a6cde2b04294dfe61d94ccb1', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), h("ir-button", { key: 'c75f458cf8ed735d1209c559586dd23dbf897897', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), h("ir-button", { key: '6c4caf497c181572d1e0641234fe933f4fb1485c', size: "sm", btn_color: "outline", text: locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendar_data.is_pms_enabled && (h("ir-button", { key: 'd361d1703967f495d79c6165cf2cc31dca0187e7', size: "sm", btn_color: "outline", text: locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && h("ir-button", { key: '1cb547b2b05b670c7ac746f3bd89429ddd470b82', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && h("ir-button", { key: '8d50c50b57f59f3c1de076e7f557723259a4eddd', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && h("ir-button", { key: '79a5cb6d2fcdd36fd5a3874054bd799a3765899d', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && h("ir-button", { key: '4f9833e78371b789dfb28ddcf7b53dd8cfba38fa', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && h("ir-button", { key: '5605c92e1203f0d82fecfe748936fb32b884e944', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (h("ir-button", { key: '3a58694114812d84b5ba8ac4822cc071665e2cb4', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), h("ir-dialog", { key: '69e0eb9ca5baa3b5292ceabe7041e1c8369c1b80', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': '400px' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), h("ir-modal", { key: '1101c80cf3b88d4876a1dcc2e476cc835efae33a', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales === null || locales === void 0 ? void 0 : locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales === null || locales === void 0 ? void 0 : locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales.entries.Lcz_OTA_Modification_Alter, isLoading: isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: '532a1587e57850df7494fd4bae32daa06a8ff552' }, h("div", { key: '8dd6f70d60da4d57afd89431d1e939e851f71c2b', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: 'd2ca87efa31830d40dc6a7e509c4494f29b7d242', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: '2be81f5e4a778673ce000e3f3905c19c6fad6111', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '8c3cc5a6ac9f83fbcdafc62d4895f2b56e4f327f', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: 'e176fb9a60d8af7777c426d5fa818571d8d57760', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '66016b6265f4ee1bc97a3e7be79398fa00fae0df', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '11d3c699a429a8ddd70b839f34c0913982f2e670', name: "modal-title" })), h("div", { key: '1e4b1e4a4d45d6f20baef9a099692c4661a619d8', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'cca9ae34d5659a0a465f8fc2843d39c244d1d8fe', name: "modal-body" })), h("div", { key: '3e2c9799c44b76d2e3f897ce6fc2ec8100928144', class: "modal-footer" }, h("slot", { key: '56d53842472a1fc56cd6a4d07e6b1bd8969b1b92', name: "modal-footer" }))))));
    }
...
const IrExtraService = class {
    ...
    render() {
        return (h(Host, { key: '539220047d74309e7cb14d3458659a229a4ee973' }, h("div", { key: '0cffda1391445c0e765707d14585fc722f0bfa23', class: "p-1" }, h("div", { key: '8da67113db289f5c295c2798293f91a18edf99b6', class: 'extra-service-container' }, h("p", { key: '187a13cd5f96c7cb6200186e6746d11095d737ba', class: "extra-service-description" }, this.service.description), h("div", { key: '9718d85f34664bfab7a13f9e94d1428552a5ae8a', class: "extra-service-actions" }, this.service.price && h("p", { key: 'd67663d556c99a84280ddc27698657b953d4429f', class: "extra-service-price p-0 m-0 font-weight-bold" }, formatAmount(this.currencySymbol, this.service.price)), h("ir-button", { key: 'd04fb533eaceff3915dd6853018627e517eaa8c0', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), h("ir-button", { key: 'c62364fc0e64c9239ffd924077b317e4e9f8e533', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: colorVariants.danger }))), h("div", { key: 'd46806a11c19e52a052d7b8109e74d3942dac74e', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && h("p", { class: "extra-service-date-view" }, hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), h("ir-modal", { key: 'ba009335ef3a1be9b5099fd3c87e8ff1e943c5b9', autoClose: false, ref: el => (this.irModalRef = el), isLoading: isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales.entries.Lcz_Confirmation, modalBody: `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '663c0d44c2771340b6857134a7ef5beff2e42b1f', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index) => (h(Fragment, null, h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index !== this.booking.extra_services.length - 1 && h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'a48817ec7e93d05fbd25457c0ed4a0c9aee0cd85', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
