...
import { b as booking_store, B as BookingService, m as modifyBookingStore, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms } from './booking.service-7b2dde0b.js';
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: '8ac4ca981bdb10d9039bae4b1cd0cf3af59b3fca' }, h("div", { key: '566819eae84f9ffd6cb02f80e9c9063e7952e166', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '20e19f723f628e07a98e32130834bd39c4435e41', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: '92f8e331e43aa46e9d8f07d8894bdc8e318a8382', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '7b4210fc8bd42b906ea2121a1ddb7444654218a1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: 'b00f487aa4891cdda5b9c6b15488c536128253a4', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '6297a54ed1231939cde677527deacffe6d931c98', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '144457c95792c96efd1b453e4be77c26738f884b', name: "modal-title" })), h("div", { key: '771d661680b8577ca393bf213c66756982940050', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '8f663b5eaec53384513c6830dba316ca409e3d7e', name: "modal-body" })), h("div", { key: '6d16217a61029a70d045710847dc3c21132f0ac6', class: "modal-footer" }, h("slot", { key: '6628f3a057320969a46f921afb7e8ba65c63d27e', name: "modal-footer" }))))));
    }
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: '2b3cba7f86997e2346428a622ec0969f0debdf2a', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
