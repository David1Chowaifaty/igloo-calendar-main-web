...
import { b as booking_store, B as BookingService, m as modifyBookingStore, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms } from './booking.service-40ff259c.js';
import { e as extras, K as handleBodyOverflow, B as getReleaseHoursString, i as dateToFormattedString, f as formatAmount, g as getPrivateNote, L as toFloat, M as renderTime, n as formatName } from './utils-84f9df07.js';
...
const IglBookingForm = class {
    ...
    render() {
        return (h("div", { key: '3896db0806963cd11e4bdf8af16257c26fb38602', class: "d-flex flex-column h-100" }, h("div", { key: 'a7fbc13c04060d77091c8bbdd2aba9f3c39fca2d', class: "d-flex flex-wrap" }, h("ir-date-view", { key: '6b4fb69518ca66cabec55af037827e29260c2007', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (h("div", { key: '01e4122389cc929845f7d0f9663c389cbfa3edc5', class: "mt-1 mt-md-0 text-right" }, locales.entries.Lcz_TotalPrice, " ", h("span", { key: 'eb93ecc2263af84791d3c5c464b8d6442a71a83f', class: "font-weight-bold font-medium-1" }, formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (h("form", { key: 'e1eb4ec82f1c027c011f5ea278763e6d229dced0', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, h("ir-title", { key: '07192497f0268e6fa912578ace95e809a31e8846', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), h("div", { key: '1cfd39cdd9bcc0cce1a9ff88f407197b9e0c62e3', class: "sheet-body px-1" }, h("ir-textarea", { key: 'a2c1cec56ec69fc12016e699ff197569149d4455', placeholder: locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), h("div", { key: '95034fa9c2ce02cd4b7dcd1819b480448ccbb74d', class: 'sheet-footer' }, h("ir-button", { key: '7076d1b4e5a1f669a6903cf47119e0c7e85175c8', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: 'ec94381f23ab9c4753b1bbd05effe62ffe344c1d', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: 'b04c4de24f51e490b4f0de4e101a9b3568fa2fe1' }, h("div", { key: '16cab5db5eaefebb8a21a247838792d345dfc4fb', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: 'c075c598862d47ff4acde7ab5ce9c25b93374a96', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'a7f11e3838aabc916c9aa997627326bb7c7faf85', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'a398936fd721e1975fbbb0bfaf8bc4aaf885b926', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '6605226a190244e070e7a49be9af6088ade2eed8', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '52730bb318685218ed9e34009ec8e98640bbc96f', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '8616c7d617b2fb82dec8f090d28e40badade76ea', name: "modal-title" })), h("div", { key: '3f0ebf1ba140b2394ed3aed0aceed8877836694b', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'b02f6f2339c9a0accc1384addc4b77a6a7bdaaf8', name: "modal-body" })), h("div", { key: '38a0b44fb7c4af62809e11e6a4a52c565a69cf18', class: "modal-footer" }, h("slot", { key: 'c218293f2f000cc59d35a6709409ef0c17c327ff', name: "modal-footer" }))))));
    }
...
const IrExtraService = class {
    ...
    render() {
        return (h(Host, { key: '8be771b857d9d87d6e69282dc675d88d8274579a' }, h("div", { key: '114fecc13f1ac810095858952125017f4ad59d2e', class: "p-1" }, h("div", { key: 'c9dedb41831a67a4d2be8a11570ec2a52d4b7101', class: 'extra-service-container' }, h("p", { key: '79f3a16a57532f30728ed03b2c96061bf1e7d8c2', class: "extra-service-description" }, this.service.description), h("div", { key: '21a25ee652e440a968995b21d15008adbc565654', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (h("p", { key: 'e9fa98bbd48e25719aeb6e56ad56b01e7d57d465', class: "extra-service-price p-0 m-0 font-weight-bold" }, formatAmount(this.currencySymbol, this.service.price))), h("ir-button", { key: '699c548db957fdc7846d55e05b7eea408b04b1fd', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), h("ir-button", { key: '7af88d8a020377a50d7731801f7f9922d038f1ab', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: colorVariants.danger }))), h("div", { key: '2b2a37df19b8fba6b96ea0df824de4e7c90ceb51', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && h("p", { class: "extra-service-date-view" }, hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), h("ir-modal", { key: '0841e4312a0f3e8f30a09cc4150f7f8138ffaffd', autoClose: false, ref: el => (this.irModalRef = el), isLoading: isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales.entries.Lcz_Confirmation, modalBody: `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'd1f13710332782d597a3facf7c0a8c27a29340f4', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index) => (h(Fragment, null, h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index !== this.booking.extra_services.length - 1 && h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h("form", { key: '5d7efdf110f946fa48d7554e2a539212ce3d9f1c', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-title", { key: '3568e097e5ec8ea494c555041e598c2263280b02', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_Pickup, displayContext: "sidebar" }), h("section", { key: 'a4fa6403af6fc603f80e49819753b4935d1f3241', class: 'px-1 sheet-body' }, h("ir-select", { key: '38af30a412618426ed0112b7b34f5cc94004fcef', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h("div", { key: '215b454a4f4a5c87c856af5719bf97fbb0d4ceea', class: "m-0 p-0", "data-testid": "pickup_body" }, h("div", { key: 'e7abf2758a39f7f7f5384a9407f9c00118c68eb4', class: 'd-flex' }, h("div", { key: '9b37635969824a34eb92f0450d4dbe0cd9ec3d1f', class: "form-group  mr-1" }, h("div", { key: '9a2753deb65ff729d15baeb1ed4731002acfba3a', class: "input-group row m-0" }, h("div", { key: '23b783318407ff1afc9b28892cce52603f64c970', class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { key: '6875bdaf8a3c0c9e774032ef4e996e4a9a6d1ea1', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { key: 'cbf6e0993a0696b6629f4420dde456166248b98d', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, h("ir-date-picker", { key: 'd6a2863734dc30ad7bf0305d3b5e77031dabcaec', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, h("input", { key: '71cab65d698eda273d810064fde133080d2e03f0', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), h("ir-input-text", { key: '8e3cb71dec87e50d9d5ba36b2bc0eb8924a5ccc2', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), h("ir-input-text", { key: '5da5ace134954d093fde24d8f10342ac93968f6d', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), h("ir-select", { key: '233de994ac92ce98cf67e84214d8c5a8268fec68', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), h("div", { key: 'f51a3959b940dd1bdbed22c99095d1f8720a1a00', class: 'd-flex flex-column flex-md-row' }, h("ir-select", { key: '84f7f891dd7c644172320e494f3f555bd2fc5337', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), h("div", { key: '257fff9f7bb4b9f361dc54f1e392c2e84cbf0150', class: "price-input-container" }, h("ir-price-input", { key: 'caebcd67ab1bac8d845a391aa94670812a435068', readOnly: true, label: `${locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), h("div", { key: '19b15f417f0715a14567507dfc8900d3abe08300', class: 'sheet-footer' }, h("ir-button", { key: '06c1cb4539cb1704a91a1591aeaa427cd2d64e45', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (h("ir-button", { key: '30647c690087393cf2e8ecc435cb832372dd92d7', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'e73639b110c51c46dca9f9563c5e71f5dcfc61c8', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: '5ce0587b3455aa2fc3312166df3934753c069f6b', class: "card" }, h("div", { key: 'cee83dc8b575ac900c49bbb6ecd0f20b106a3885', class: "p-1" }, h("p", { key: '507d8720bf7567c5365e203c0f537331378b8ac8' }, this.booking.property.name || ''), h("ir-label", { key: 'a02ab62d0e9352042e1ea6f6503981faaf89fed2', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: 'a644b88f845307153b3c18eb208c64a8bfbc4d82', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: 'a29d801d8486a43304de7c8b7571ec025bb21a0f', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: '0fcb2013516aa81e19f1ce1b3de56fd1a1752d29', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: 'e09b27c048005b544fed227cd067e77019f4b047', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: 'e825e4f92b0228003537d3ba0fff127ca446a304', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: '46c7475bd1a237fe8a5c4f2ac4438c9b276edfe7', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: 'b3fb3018a9a5a194231321bcdf86ca9c17806860', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: 'eec91917d33dac016a05bc21ad619cc84d19712b', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: '69a87599117f0162ddd79a74a224950ab22cd6fb', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: '9984dabdfe52dc2b666bbbeb4c7940dfcef777f9', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: '0e7ed52588759d3d16e7845df75781a193019838', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: 'c3af637c1a423f2effabfebdf34bafd4e500f869', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: '4d43ebf804ef52b3982124cbbb52369fdcd9f60d', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: '5d1dd70d12c97dd8393531cc704d79c559dfdcab', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: '7ee2cf8728441b7dd335f83a75c20de36c9dee33', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key