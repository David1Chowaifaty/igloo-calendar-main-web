...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (h("div", { key: '3c3d87bac36d514f1a646bcc531f8181a2959ad3', class: "fluid-container px-1" }, h("div", { key: 'f9ec8af22a17c54bcabbeb0c898aea9be3e669a3', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, h("div", { key: '66cac96d4a3a93c2390af9b7fa36a57843bff369', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, h("p", { key: 'd3dd41876966054096719dc0957c0b994d8666f6', class: "font-size-large m-0 p-0" }, `${locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), h("p", { key: '61fc7183441149ffd3a8143f50dd3b84a6301f80', class: "m-0 p-0" }, !this.booking.is_direct && h("span", { key: '3154b2ca8eb27fa458ce80adce9dc62de5d1f3d1', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), h("div", { key: '40c8b010ef7d505a685736579bf869cd3ccf6601', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, h("div", { key: '2a00e6e71ed34246a133ea16b8f3bf80ee2bcc5c', class: "d-flex flex-column align-items-center" }, h("span", { key: 'e805a54a664f03cd25064bb15bdae9c6b3578e56', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (h("ir-popover", { key: '890284168c55e8ea40b309bcc40938438ee26de3', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, h("p", { key: '4e971132922d93124b9d92c43ac58f77b598bee4', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, h("b", { key: 'b57a3fda9a32191895b0fe7a9170b7060c1c2b10' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (h("div", { key: '74c3c0ca1f68362339139a605869950ede97ba24', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, h("ir-select", { key: '9cd8231974d9ee6529e83ddc3d8f53633939c3b5', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), h("ir-button", { key: '994867e657738df7a2a7a7272470697fb040133b', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), h("ir-button", { key: 'aef75d498e9a4008c71fc001ccbb3f2744160d6c', size: "sm", btn_color: "outline", text: locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendar_data.is_pms_enabled && (h("ir-button", { key: 'b49e678efdd72bc5dd598aa45c6aa9f57f81c6cd', size: "sm", btn_color: "outline", text: locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && h("ir-button", { key: '7c9620adf9076314d67eb8e7eab08e422125f948', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && h("ir-button", { key: '7c5dc56951c0442c5fa87cae27338e9dba9ef5f9', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && h("ir-button", { key: '4f695ad231b81123b24c9f64c1bc30894ccb2100', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && h("ir-button", { key: '652ab04e4c2f0433bd058d581793f9c3ec1aab1e', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && h("ir-button", { key: '35bacee2053efa67ea8b8236b3af745c6fc9c440', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (h("ir-button", { key: '3420792e92c346602b5f6544ff4683c76689a981', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), h("ir-dialog", { key: '8bbd4e709d09a2d2988696666823c0b618185f16', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), h("ir-modal", { key: 'c235f43ef868f60246f2ceea6194155b82413809', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales === null || locales === void 0 ? void 0 : locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales === null || locales === void 0 ? void 0 : locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales.entries.Lcz_OTA_Modification_Alter, isLoading: isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: '7367c6e74712a161ae4afe30fd60b485c2456448' }, h("div", { key: 'bf8e8028537f5dfc8d8bb723650cd44cd940e2e9', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '7412cce9ba0e25cff3c605a8deb5fecc41f2854d', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: '84267bb03675fb4d6dd9f8863a5dab0330cf4adc', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'd62a5a482bc171eaa10be9b61d4cdc347c91568c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '64ad55d0e14f2320b159aa10251281b951e71318', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '3b51140ecff9dc255dba9ec1300303aca8108731', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '07487607f7987aa8c2c69227cc7ca69601898d76', name: "modal-title" })), h("div", { key: '2108a8575332d39761abbb37c4c4bce1429a787c', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '9ac00dff185281003167f24b1bf35e59d4f3669a', name: "modal-body" })), h("div", { key: '58fe71b34715d1e5dcab57a472fd6eededcfdf16', class: "modal-footer" }, h("slot", { key: '2faccca96c46884ad9b9226948abecfcc5e48d5d', name: "modal-footer" }))))));
    }
...
const IrExtraService = class {
    ...
    render() {
        return (h(Host, { key: '04e69af6bca32153913fac83a93702f7187a6edd' }, h("div", { key: 'f77202a5aaded11932f46a71f4728c6784139de8', class: "p-1" }, h("div", { key: 'da6753626ada4e7720d750075e1bbc1a9a18d001', class: 'extra-service-container' }, h("p", { key: '819096419f7ec816b5edb5d3d1cce26ddd6ad28d', class: "extra-service-description" }, this.service.description), h("div", { key: '4e607bd8e84dd2e28f2c1c4b44bbdba9e83de3f8', class: "extra-service-actions" }, this.service.price && h("p", { key: '82890e887b15d8441df8852943906b70364f124e', class: "extra-service-price p-0 m-0 font-weight-bold" }, formatAmount(this.currencySymbol, this.service.price)), h("ir-button", { key: 'f5dab9393ec9afb6c04487b823c5a18202e195e9', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), h("ir-button", { key: '6f29fb06d57018fe946bda96e0a6b854c9877a48', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: colorVariants.danger }))), h("div", { key: 'bd667984daee5e8a67d3803364cbb55775f93c66', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && h("p", { class: "extra-service-date-view" }, hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), h("ir-modal", { key: 'a1ec7807e43deef94ac70a2ca27c7ad5a8bd200b', autoClose: false, ref: el => (this.irModalRef = el), isLoading: isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales.entries.Lcz_Confirmation, modalBody: `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '95ab56ac5ea7bf34ecf098a6b5236379852339d1', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index) => (h(Fragment, null, h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index !== this.booking.extra_services.length - 1 && h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: '064f7e9d42863b6989154054178b32bfe649e270', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: 'e15d17cd1ec922b781470a03915961aed7acfacc', class: "card" }, h("div", { key: 'bf08209974a4ceec689ea00507c8906bdfee5208', class: "p-1" }, h("p", { key: 'b716f0effad645b1585a71ae3de7b45c20d26eab' }, this.booking.property.name || ''), h("ir-label", { key: '272dad2262a0e1e576971d3f6507f433b8672575', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: '4e72251d0d806f32695fdd6954ffc264e7fcbb0d', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: '03765d916cb31a0fc123e23958800a8e8f2ec14b', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: '18f451e84e00398cba27df2e373b99de7b6ff4f2', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: '9228efc8fe844d184d70ac273942fec66ad5d236', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: 'df0a66c89bf1f86e2bcba0dfedddaa8eee7101a8', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: 'd474fb8e75c4b69bd9f329a99740f05ba42d3399', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: 'f3dfae4d2073911868d3a5e004fefd4be44eb190', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: '28fe49ab27b8f5cfa21fec23e4297bbffce7213d', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: '28a2bc6e4e12e113216f8757c3e60edfdb7bf8aa', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: 'a8a271bade196c51f7017fb7bdf841fe2dfeae1e', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: '4313376f758cf733309d43e8c151d8838fb8c4a7', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: 'ab13ddd72cdbde91ed741d438d75d762780d3dba', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: 'f240c9560ee93545bd4e44a09a99e73387d2caf5', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: '40737039628585fb5f61755a02e141bd89e09bee', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: '9e156e6332be385e20bc498a28519b28947b3cce', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: '18ceefbd60d0c9776d7b65bc1be5b16e67b8c7de', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: '96834b2ac03f4ea33c3eff1be0a55424d8d0feb6', class: "d-flex align-items-center" }, h("svg", { key: '9dcd9dfe92ebbdf1e7a24428133c9f11f3167aca', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '38ffdec63bf93fb885d11abd0ae8a7c2b4dac174', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: '300c011c5d0c6aabebb17c1f329b8bb9ef783d42', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), h("div", { key: 'be4bcc8dd3122486d1b9ebe57bda41e02ae529b3', class: "d-flex align-items-center justify-content-between" }, h("ir-label", { key: '37dbe5a1273b2421a7f4443e4fd64fe588d55b03', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("ir-button", { key: '7bdea5528a367baaf8b955448ec336b0e2fb36fd', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '6c9694c877b47f5e63ef8a500c78990c7f20ee2d', class: "p-1 d-flex m-0" }, h("ir-button", { key: '8cfd851a779da4cbafbb444ff3be647e4b68ca3f', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: 'c182ae14d896826e3a4df205825de81722c3748b', class: "flex-fill m-0 " }, h("div", { key: 'e34d8a3af41cb003c02f548b453b934f94580fb1', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '927bae0af761838f025072c6952afada2ad69207', class: "m-0 p-0" }, h("span", { key: '2da0ac3b49bb4ba4454e7d7a8f67fd2af2ebd64f', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: 'a39e69722c7eb857734244dc34261c9e8c90eaeb', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: '272f65390bd8608a275d3627e43c3948ce439ea5', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: '6a14dc3a66c8bdd345c223f14309f2a4884c2a6d', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: 'e208b973a9cc832e32f1aed308e44bd3e24d5b60', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: '935b6bb350d392a4e0677d469ad34a7dd432a743', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: 'fb025b08c4064c2608b356a31389c9519f4472fb', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: '7cd2cecfcd3e4c710f2bc9823859090fda0fab8e', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: 'a616bfdc02fee02f9f433dedf82b43eaccaada0b', message: this.room.unit.name, customSlot: true }, h("span", { key: '67aea0c1cd430b14e8625a6a0b82009648293adb', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: 'f952ed8438a4f96d0cbebbd5a16f516c07faa077', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: 'ebfb167547257948c7eff9bf8a11adf955623634', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: '286844ecdff20f46372cd4acc92c368652517ce9', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '176a4feb98ff14f0179a12100bff60889ede41d7', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: '7e63d54bbdcfc129b7e1afe964f190d30563a9ce', class: "m-0 p-0" }, "(", bed, ")")), h("div", { key: '9cca8ed1694417353e6afa282291557fb0bb0126', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, h("p", { key: 'fff7dc4b2d19e041571a847f8e61b1c02eb7b03d', class: "m-0 p-0" }, "Expected departure time:"), h("ir-select", { key: 'd9e01b68d30d8502271d83f1227e13e5dcf517ff', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), h("div", { key: '8f42acc91b9992921c7570a74e730f5263e6bf34', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, h("div", { key: 'fa5565fe0fe6d39c008a13bdf285e4b13f84c5c5', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '45f02757240cdec31df9ec5ece14096c56a458e4', class: " sm-padding-top" }, h("p", { key: '651959ba296b077cd79d2184813410f34fd3872e', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '1b0e50b2bb749ffce71d23c08dd5746bcab2baf4', class: 'flex-fill' }, h("table", { key: '63e436bf57293756925d6f9dafb3e2028943704e' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '81f4458f313b4217c969d6a0db71a3c869ba80fa', class: '' }, h("th", { key: 'd0b53960e96bef6616ced039b8f228a59710dbf7', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: 'a49c5fc60f4c66861376a03a686bfd25a4dd251d', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: '01b0db32e4da89f5533e85496231819bc3e09041', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '971376af571045b7f449b1e69325a6c57c5ba701', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: '1072af549f31c9fce4127e2e784ba7bf0661c96a' }, this.room.rateplan.cancelation && (h("ir-label", { key: '81d20ea57241f83b5c7062433e2e18ea468e10f9', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: 'da4816698f0df751654371e3eef6b3cc7df3bc3b', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '8c045f7e40365ee3aea8f821a2d9ef24be3b3cec' }, h("ir-label", { key: 'cece74e670e4a79bc0188e19e0ed9b74ec3942f0', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '580198f1380b0023adbd35724aceb078dbbaaded', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), h("ir-modal", { key: 'f1efe122e1d74c47fbf0e649dda71e824768feda', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
