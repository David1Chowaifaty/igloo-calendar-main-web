...
const IglBookingForm = class {
    ...
    render() {
        return (h("div", { key: '4ef15988268e754af817465bf78976ff48dbab2d', class: "d-flex flex-column h-100" }, h("div", { key: 'd337efafbd27d0ea6a3d8a256dd59f578edb89ea', class: "d-flex flex-wrap" }, h("ir-date-view", { key: 'a397c89e5d740bf333270ea39fa645cacf60c051', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (h("div", { key: '76fd0c09e76017a6fa60e4070ab6c891d59d550d', class: "mt-1 mt-md-0 text-right" }, locales.entries.Lcz_TotalPrice, " ", h("span", { key: '2e6a9f65a1465a62fdcfc186a3f51a8aeb59cace', class: "font-weight-bold font-medium-1" }, formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (h("div", { key: 'ddfb17f44ca360205e67b2356b8f439f643ed26d', class: "fluid-container px-1" }, h("div", { key: 'ba37d3e4954fd745ff53faacac1cf36150cc8936', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, h("div", { key: '40dbfe529e66fbb9e5744ed8843ad3fcf1848161', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, h("p", { key: '41a8f0cd0539b335f9f50c71ffb77f8350c2dedc', class: "font-size-large m-0 p-0" }, `${locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), h("p", { key: 'aaf3b948eb49b31060bad42a0a763e63ba1b1d47', class: "m-0 p-0" }, !this.booking.is_direct && h("span", { key: 'feaf401fb38990b691c6f9bc0c81c296e60dc5c7', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), h("div", { key: '3bf59975aebef560613a4ad55d5183ac58956410', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, h("div", { key: '123a4fe1873f81ff5d19b1d1b2f82b26829b6f96', class: "d-flex flex-column align-items-center" }, h("span", { key: '9c61304e1e324d073ed12b2c911c1131431522bd', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (h("ir-popover", { key: '92b6cbd6173947288fe29f41920cb19e93a71608', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, h("p", { key: '1c49b7c9d8aa066e6e46ecca8d3131e860d7b62a', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, h("b", { key: '2fef4a7e6c358ee33a29b7ce27542751851ea08a' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (h("div", { key: 'f2da170848ef0e7090fdfe149416838c9a1a1672', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, h("ir-select", { key: 'e9fc94d7a6ffe481a032532524d64c6aae59dc32', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), h("ir-button", { key: '58d701251e738c36e4918bd076c62d29aeb9dcfd', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), h("ir-button", { key: '40299c58d40339e615e3a1de9de58c630c16deec', size: "sm", btn_color: "outline", text: locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendar_data.is_pms_enabled && (h("ir-button", { key: '619bb60d4adfb56ae31277a88ad4802d822f7151', size: "sm", btn_color: "outline", text: locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && h("ir-button", { key: 'b5c8c0a056defb5f1462339c8cb2ad908316ed8b', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && h("ir-button", { key: '75c5e0a96f764aa92faad48bb766c3f80e3e89e4', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && h("ir-button", { key: '72afa137d482001d42dbc0128c725d25405b8eb2', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && h("ir-button", { key: 'e9c486732642c1a41fbae5595ff09fc4c41b2938', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && h("ir-button", { key: '01bbdde53c23133ed45daa5bed6f0dec4184d61a', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (h("ir-button", { key: '50e5349eab06e052e014de1bfccda456a907d2ba', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (h("form", { key: '4936e4f5772f065fad8280ebf6ea6e36726717bd', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, h("ir-title", { key: '5991883b8dc167efc84abe16ca6f2f70ceda3ec6', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), h("section", { key: 'e9ee6fe0e1a4caff19c9f67b0805302dba57075a', class: 'px-1 sheet-body' }, h("fieldset", { key: '3646701b36b7f7971e2baa91bee4d043c24d6ea2', class: "input-group mb-1 service-description" }, h("div", { key: '21c6b75d0437ee99a2d69a738e332da68766d02d', class: "input-group-prepend" }, h("span", { key: '491f1e07c17d194db0eef86d8da421a5558ac0ca', class: "input-group-text" }, locales.entries.Lcz_Description)), h("textarea", { key: '8a1fac331807b2d18aff477218595e5733d510af', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), h("div", { key: '38ae2dcc7b65dea28881ff2b6b2bfe084ce12fef', class: 'row-group mb-1' }, h("div", { key: '8b6b5e64dd2e3bc9d28699c267b6e8bf7f0dec98', class: "input-group" }, h("div", { key: '6308b7a2bf89f59a7a4962087ee84eb761d99593', class: "input-group-prepend" }, h("span", { key: '8d9e518ae9153599c02cecfb19c8dedb08471ab5', class: "input-group-text", id: "basic-addon1" }, locales.entries.Lcz_DatesOn)), h("div", { key: '0ef43bec6408024df4784b6cb6582a48c935a202',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, h("div", { key: 'aa116b3afc0469659e7c146832d0e74f1de46d8e', class: "service-date-container" }, h("ir-date-picker", { key: '1bde15781f6c6fa70e9e4d372cbea01ca6855620',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, h("input", { key: '55d63b1c98ee7a51c7fbf8575830ef58bafbe92d',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? _formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (h("div", { key: '20539898b88eeac642b997a3e084df70e0cd6826', class: "btn-container" }, h("ir-button", { key: '07324d0c532b6aec69d3805cc50885c554899bc3', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), h("div", { key: 'c0f51645a53d9c0eb3257bce5d50124e53a22e91', class: "input-group" }, h("div", { key: '60788a72cd6ce5e5f4e223f1b72adb7e0b1c5b08', class: "input-group-prepend " }, h("span", { key: '33cbb97244ba40f35196e007b0d22784d7c87427', class: "input-group-text until-prepend", id: "basic-addon1" }, locales.entries.Lcz_TillAndIncluding)), h("div", { key: 'dc6b38c533e6e2788acfbc3fbd1eeb3baa252c40',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, h("div", { key: '18596a002a81113affddd52fc8a0af6b99150497', class: "service-date-container" }, h("ir-date-picker", { key: '47226afc7fb38ed916b9aad4c24d0fd512e26663',
            // onDatePickerFocus={() => {
            ...
            } }, h("input", { key: 'b464c063f900df1d581b435f81d8c1293eccda52',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? _formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (h("div", { key: '3781d32fb6cc8d14bccdb02de5caf411e3f2a921', class: "btn-container" }, h("ir-button", { key: '5aa9f41421138e1275030be71bfa016a884e34bd', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), h("div", { key: '3ccfa2ed7b42ff15ad86f3b54f3c37391b4de106', class: 'row-group' }, h("ir-price-input", { key: '525e11eb64c13193fd1caa1a65a9631366ce152b', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), h("ir-price-input", { key: '363087cfb8f1c0d4de112d8e79b1e53e5ee7c3b5', autoValidate: false, label: locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), h("div", { key: '3f1bfe8ecbc731a423f3840a65234f4c33e7a707', class: 'sheet-footer' }, h("ir-button", { key: 'a4e89bfbd3fa765101d0fc4505cc8179dc5f1204', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: '46c1ae535ec2b5ada9259fef8bc66f0658208785', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: isRequestPending('/Do_Booking_Extra_Service'), text: locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: 'a0992bf559e95b11255a97793ac391cb35a5355f', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index) => (h(Fragment, null, h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index !== this.booking.extra_services.length - 1 && h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h("form", { key: '77c44d21f98b2bb777e4105dfde8f3d9f9b0067c', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-title", { key: '75d1e5709795c31e59c64841207fdd66c9b2e47f', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_Pickup, displayContext: "sidebar" }), h("section", { key: 'f67b8870a23b3265c4a03294b3009afdd4970122', class: 'px-1 sheet-body' }, h("ir-select", { key: 'ea454dcae266c17385834c0459435e1c927969d6', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h("div", { key: 'ef8742a46b827ccb08f58e8cfbb1572f158084ad', class: "m-0 p-0", "data-testid": "pickup_body" }, h("div", { key: 'cfce6dd7d6611ac69ee453bc760e2b471eb65bb1', class: 'd-flex' }, h("div", { key: 'f474badf6b32ab0e8175afe0ab5401bec1258a90', class: "form-group  mr-1" }, h("div", { key: '86f3ddf1a9b02a509c888fcd023e6e8c4c665cec', class: "input-group row m-0" }, h("div", { key: '1204317d9edd22cefe3f58db418b09202c19d4e6', class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { key: '8aed463e42f2eacf34011cd259a8d927b681a568', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { key: 'c06ffba0b605abaf9f865a97ba93a4b2ed724067', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, h("ir-date-picker", { key: '4f8a0cfd3b75afa036736b5b31ab5a556b938baf', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, h("input", { key: '1da2c7e175c2a19f45cd4aa12b6cde22a536454f', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), h("ir-input-text", { key: '1f5be0e8cad070e8bbcc8b44461211e37dd17367', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), h("ir-input-text", { key: 'f0402e9868c76e1d8a2332416bf2cbda99f37342', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), h("ir-select", { key: '1c819f084b5c0478bffe75928a55f60f7ab39fb4', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), h("div", { key: 'a3befd04b581f6ed8df83ddeb4b8837cb7755aa4', class: 'd-flex flex-column flex-md-row' }, h("ir-select", { key: '2716e7b9d9cb4eeb70a811de291aeebd85bdbcb8', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), h("div", { key: 'b50edf1ec6a230d3fc4cf69676c94d2a2e21bceb', class: "price-input-container" }, h("ir-price-input", { key: '6e7d397d4967a7a5cf37e58ebf58222c759bc450', readOnly: true, label: `${locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), h("div", { key: '0073aa119577ddfe5f0430ea6f50f891c6fc6288', class: 'sheet-footer' }, h("ir-button", { key: '1359d86b268191cff0f1d10a8cab7f157806dbcd', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (h("ir-button", { key: '4bc87f98d894f3ef5bf24851f1411555427e300b', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: 'c0ad806ba81d0f2aba1da466469fde1f2980c6b2', class: "card" }, h("div", { key: '102d327b39664054d4ba95676faf856dcfd55a44', class: "p-1" }, h("p", { key: '7e1bc0ac6115a1cce6e9e90e66577cbc803245e2' }, this.booking.property.name || ''), h("ir-label", { key: '66ce39bec7f8b437701e9685bd5519f64245d516', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: '09a7e79236e8a8975afd41dc146e6eb380ec8aa5', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: 'ca246f82250e2e116a81cce3a634a22efb24f090', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: '9c3d6d3568ea5def73b22d6e653ce2415f5d4ec2', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: '3877163dc0d2fa1be97eaec2eaca7eb266c38b30', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: '18fc8d85cff783bfd8aa0bfca504ffc75de9bbae', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: '5b1c0acd04dc035cccd49fdf72db27706bd8d051', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: 'f55390ed3706a1ae8612009a07add958cd3c3b2f', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: 'd8dfa2cea0a811f717b28f08602d0b7fbe633cc8', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: '333b2bc8fbb57a5ee12a5280b026bcd183225fa8', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: '5a93865ed32e616a839cc167f3f2791533f498eb', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: 'd97de25b96096c48553f485e0a676482b1289775', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: '3d10d3731bddf7f19444d9ff16a5c79cc17f013d', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: '961ca7a16747c91bed0da355049fb153dddb1cb5', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: '551958dabc27fd5f3f31b17908b8d60973c37e23', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: '4c86ceb4e03d1417e32e397bcb78d0d25668f180', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: 'a66f300aa2e6612576a1cfa3f7776fe8e991b663', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: '11e9b6905e6910f40a9c5c774fb7c5e5be6238bf', class: "d-flex align-items-center" }, h("svg", { key: 'fa4633b329157ea60100a38322bbc950efcc2c41', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'b7c99e73dd692150ea9ee08cd02d61f66b94ae7b', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: '581cf9bcf9d37a984a856e5c9606c4b40f303520', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), h("div", { key: '0229a8dd13e918197c157aadcee8313f3683f26b', class: "d-flex align-items-center justify-content-between" }, h("ir-label", { key: '823726e5be4915aaf40e2efcb5c6c25f99222947', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("ir-button", { key: '236df4d567a6c3d0e640d8a6aee875daa9927f0c', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '065e549196c3a5e8320fd62486b530671714a0d6', class: "p-1 d-flex m-0" }, h("ir-button", { key: 'f0b323dfd2ef0ffeea7f515d1aaaf5f215930aa7', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '9b928dca76365a73da153cadf87fc77344b7d9a1', class: "flex-fill m-0 " }, h("div", { key: '11407a2311ff1c14c4994a9a22bc403a5d30bee8', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '8223cbecf4e47169d712063a8963cb0031af341e', class: "m-0 p-0" }, h("span", { key: '762ed0e297c697b1d5f070db300bf46ceced5351', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '6b9dc584c410b419f59a0b0dea096f7c55c8b048', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: '78ce581217988d4a55e77b2f3601ecb058724c13', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: '3e4c2a21660a284876e2b0e449954bef92ca8917', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '90a34eba42b9be39251bc67faeba88364e8341bb', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: 'bac15122faca40a0ad751f67f5051f23505eafde', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: 'b24007cd138b417ed7ab90827ebcc89a24fb5765', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: '2a494d716e6757f222ee3aa758fab5927124a3c5', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: '884639023f9224be982484f3f1437481f737bdda', message: this.room.unit.name, customSlot: true }, h("span", { key: '4c224320a83af2d37cad3649166df2c0a4776c16', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: '97f2d92eb5dd84692bcd3f367998f349da6d4ded', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: 'ded5976dabd8753d54311839b9ac4d7cfb1cc664', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: '4f237c84cfdaf2c951a54ab3513ebe7547a251f5', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: 'e00acacca14d4af4c97f5d099a57151bcdd83c85', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: 'ad6c73889250cb503b0985732eebddb362722b33', class: "m-0 p-0" }, "(", bed, ")")), h("div", { key: 'bd8052fb8a09f90460225455b0af639d843aa686', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, h("p", { key: '49f6aeaec65f1a08627ae242502d82663ac36caa', class: "m-0 p-0" }, "Expected departure time:"), h("ir-select", { key: '4b87e266f05b27b8b132d3712c1271490ea39ce9', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), h("div", { key: '3955713ddddda69b273aa5405263c12b406f7823', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, h("div", { key: '7d84fd893c9a56dc4113aa6edb6d87b0c6d1d986', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: 'fcb451bae4a480353b59086a15238b05ea0c09d2', class: " sm-padding-top" }, h("p", { key: 'c0c500252e97d467abfb970824b2bb6c8c0eefcf', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '0e04dccdc6e00c4aeb884d26564ce9ef167ffaaa', class: 'flex-fill' }, h("table", { key: 'a4b323fa9df9df3fe3f332d0ea4dfc391e5bb82d' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '3904551da67c78bc9b5e45f7b2d4926d255345a0', class: '' }, h("th", { key: '16263c4f23853025f896383ae3981d03d7bd00d2', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '5cac9caedd9549f43080d04917f510b7d1b545dd', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: '8b5d3d666cebbaaa00e64daeecc7216397e20ede', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '273d4b678c6a274e6219a3597610a52c99ae0d27', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: '5d0fb91fe44ea019b06d6958d8f6218c66a750d8' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'b10a363045a26fcb70591a6daba34fffc2205863', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '0b3635d1a9034e555d92947a3faa694fa978f002', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '6274861e18a41f7917a28d32c788f343ca48441a' }, h("ir-label", { key: 'ce45a789f20b7e07a8bf28d7f32d29e8b176c7d0', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '7c834a9b6ef1e1943632999f72a91ecf0c35d6c6', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), h("ir-modal", { key: 'fd3f737f81770f56492f2f6571430653e148a304', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
