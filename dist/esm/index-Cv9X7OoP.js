...
import { C as ClTxTypeCode, a as FdStatus } from './enums-CcLtXwvz.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { s as stringType, e as enumType, o as objectType, n as numberType, b as booleanType, u as unionType, f as nullType, g as anyType, a as arrayType, d as ZodIssueCode } from './types-BG9uwIsj.js';
...
const RelEntitySchema = enumType(['TBL_BSAD', 'TBL_BSP', 'TBL_BSE']);
...
const FiscalDocumentSchema = objectType({
    ...
    ISSUE_HOUR: numberType().nullable().optional(),
    ISSUE_MINUTE: numberType().nullable().optional(),
...
const IssueManualCLTxParamsSchema = objectType({
    ...
    CREDIT: numberType(),
    CURRENCY_ID: numberType(),
    PAY_METHOD_CODE: stringType().optional().default(''),
...
const VoidReceiptByCreditReceiptParamsSchema = objectType({
    FD_ID: numberType(),
    VOID_DATE: stringType().optional().default(hooks().format('YYYY-MM-DD')),
    REASON: stringType().optional().default(''),
});
