...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateDaysBetweenDates, a as calculateTotalRooms, r as reserveRooms, d as resetBookingStore, t as transformNewBLockedRooms, u as updateRoomParams, g as getVisibleInventory, e as getPrivateNote, f as formatName } from './booking.service-24dea405.js';
import { l as locales } from './locales.store-a1e3db22.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-2333f282.js';
import { f as formatAmount, e as extras, g as getReleaseHoursString, d as dateToFormattedString, z, v as validateEmail, Z as ZodError, r as renderTime } from './utils-ea836f0e.js';
import { v as v4 } from './v4-964634d6.js';
import { h as hooks } from './moment-ab846cee.js';
import { E as EventsService } from './events.service-265b5b61.js';
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (h(Host, { key: '2d8a4ca514eb94475b353190a2d223fe5d1e4ba1', class: 'px-0' }, h("ir-title", { key: '1fa5b4df86d67483fb40758d0ea41e31344f63be', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), h("form", { key: '784e03ae85d6a610b58f52b783d63eea8f6f7b62', class: 'px-1', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, h("ir-textarea", { key: 'c4441119fb42db7ea5b42bedaf43216f3659db16', placeholder: locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) }), h("div", { key: '8bf793e26e62716bed2c1f9000484b995ba754b7', class: 'd-flex flex-column flex-sm-row mt-3' }, h("ir-button", { key: '731bdf3eee503106904fc94710ee5450509e116a', onClickHanlder: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: '4118db9d1a2b1e1f834751d71cf20d0af0e1637c', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
};
...
const IrCommon = class {
    ...
    render() {
        return (h(Host, { key: '8c32072600f888b8ccc5b82ed833a7ff470f7bb0' }, h("slot", { key: '49ea70c564dd23ec3e1ac870918c61e692d775d8' })));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (h(Host, { key: '614db844c29759380dea493a36cae4e5dd14891d' }, h("input", { key: '7fa3707ac706eb4c53f6f64fdb0256a43842e59a', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
    get element() { return getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '89e28d737169bf94ce74b0179f176e6e3ac91d1c', class: "d-flex align-items-center" }, h("span", { key: '38d8c8a203a7add75d4e6c0d5f1ec08f85a784e9' }, this.dates.from_date), ' ', h("svg", { key: 'dbd3b61b84ebd9371ad0a44bed92c3dd065d5726', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '6ca43742683f3f88283854dac877dca9076fe4ec', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '3b27b77727f28ec1c952e4e36734c480f7da13aa' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: 'fd736709d3100f08840ee9559573fe7ad8cd1f16', class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: 'cb22685adcd12ab91476eb02327561c14df4583a' }, h("div", { key: '7202f1bf3904aee4aeff489388f5b4174d69f4a4', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: 'eb433556cafd0003fb0f06ea7e72dc9983990a85', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: '94df4173c15ebba30253e826f8365f3231f33bd1', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'e3124d08ea7f1c0ada8d85d505c79b02741d5ec0', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '609c525af0917b04a2f014477044f4029cef855c', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'a6015bd18873afde76c9866f368c0a21a11ca97f', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'b598e3fe958db4a8cb0ee2bb0930776ac75f0849', name: "modal-title" })), h("div", { key: 'c7e36db0498efb8d1f6f538a8cd0f47af89fb5ee', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '01ffb4dfc4d0ac3b750fd41262265c614e63d1ed', name: "modal-body" })), h("div", { key: '4aafd9fcf95609449507966c312e57285ef59b8b', class: "modal-footer" }, h("slot", { key: '7957bfb47f65fd3be60d2f3295bbf228c102686e', name: "modal-footer" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (h(Host, { key: '72d2d7b779b78db5fe83f3da7a6d5f9fc3c674bd', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index) => (h(Fragment, null, h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index !== this.booking.extra_services.length - 1 && h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '7dd7b8bafc90545b0c720b416fcb763169f646ee', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '6ee11881f2fe31186239007288e1fe57fa2c6ea9', name: "icon" })));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (h(Host, { key: '684072b94a347ffb1b88db12a955f4d3869aa275' }, h("span", { key: '8e08fe7ada486c834ec0ae59a504dc0f219e20bb', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '8fafde665da9cf134545ba384a36db185773c9bb', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '51c3d23b523d1eae1127d02e86dacbc9331b8d48', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'a6597953d68647d782fa4abb9eca0de621aaeddd', class: `ir-alert-content p-2` }, h("div", { key: '7879526bc3e32ed88c2e97b66ad059113c95f2c4', class: `ir-alert-header align-items-center border-0 py-0 m-0 ` }), h("div", { key: '30b326c2de505fbcd43ad933ec09f8c3f0f4af55', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '01b746840d48dd3a63945f28b2e7c7f07a2143f2' }, this.modalBody)), h("div", { key: '9b990724e343a81028d6ffdf07fb33bcd0526167', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (h("ir-button", { key: 'fef5aac96761af04a7121edbe0b46fc77e72726f', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (h("ir-button", { key: '201cca0a27dee6b364d07cdf28bccc77b750786c', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (h(Host, { key: '8a92d38da9e0868a335de78b38bc9be726457a30', class: 'p-0' }, h("ir-title", { key: 'd89eb0afda9a459a6af4904bd414dfb06fd71e1b', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_Pickup, displayContext: "sidebar" }), h("section", { key: '07e6313a96ecda05c7fb327bf795189cac9b0839', class: 'px-1' }, h("ir-select", { key: 'f72faae22f78f7958b11e9f59c03a319307c5e00', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h(Fragment, { key: '98a599b66aa5a78e841dede42d2b8553e50b8360' }, h("div", { key: 'eeff91f597232f01c24c70ddd851c2f38f0947fd', class: 'd-flex' }, h("div", { key: 'ad50b223f70d5af4c94d4b77ce0376fd8a0d73b0', class: "form-group  mr-1" }, h("div", { key: '5f7e348859de1eaa9d74cb30dcb34f8ada6ad7a3', class: "input-group row m-0" }, h("div", { key: '9b095ffa841dd6d0a31c061be15136bafee5f8cd', class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { key: '90e923d42ea5b134106975a499b70a93ad7b5807', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { key: '05d7813def777dc2bd123aeaf25deca6fa1bcb78', class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, h("ir-date-picker", { key: 'ae4ea6aaa5f1756f4617616dd83b2a3cf7b03142', minDate: hooks().format('YYYY-MM-DD'), autoApply: true,
            // format="ddd, DD M YYYY"
            singleDatePicker: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start.format('YYYY-MM-DD'));
            } })))), h("div", { key: '9213b02d32deedee015a94c7baedb2ce67f9f5e8', class: "form-group" }, h("div", { key: 'adc14f6aa6e73313ad79b4c987d4df9954ae8601', class: "input-group  row m-0" }, h("div", { key: '00ac38368e8afc190aa7cc7613fdadff0c88de1d', class: `input-group-prepend col-4 col-sm-3 p-0 text-dark border-0` }, h("label", { key: 'e2323f3703a0239a31bfc604d9009b8d78499894', htmlFor: "pickup", class: `input-group-text flex-grow-1 text-dark border-theme` }, locales.entries.Lcz_Time)), h("input", { key: '6eb91f7bdf45624e7521cdb6426217123e5b4780', type: "text", value: this.pickupData.arrival_time, id: "pickup-time", class: `form-control col-8 col-sm-4 ${this.cause === 'arrival_time' && 'border-danger'}` })))), h("ir-input-text", { key: '3cb71a5816c311a09035934629362c00ccb764d7', value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", inputStyles: this.cause === 'flight_details' ? 'border-danger' : '' }), h("ir-select", { key: '085c6a567738ff81db83a7c10b305e2bb076f150', selectContainerStyle: "mb-1", selectStyles: this.cause === 'vehicle_type_code' ? 'border-danger' : '', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), h("div", { key: '209abfc6c1587ddde4474df5316463990d841ab5', class: 'd-flex flex-column flex-md-row' }, h("ir-select", { key: '6d003e303b91d8a5344ce2ea42e57dfd16cf2576', labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectStyles: this.cause === 'number_of_vehicles' ? 'border-danger' : '', selectedValue: this.pickupData.number_of_vehicles, labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), h("ir-input-text", { key: '3598635585ef72931f5c08f416eefd4b845ee2da', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" })))), h("div", { key: '30d19cbe06c04e03e899c9d1c57bec3639bd7011', class: 'd-flex flex-column flex-sm-row mt-3' }, h("ir-button", { key: '5c51981a1bba1c505d2e704daa9e8e0e5cef2173', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  ${this.defaultPickupData || this.pickupData.location !== -1 ? 'mr-sm-1' : ''}`, icon: "", text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (h("ir-button", { key: 'bfece872956ce3acf3cdf91ab8755a582371be7f', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", onClick: this.savePickup.bind(this) }))))));
    }
    get el() { return getElement(this); }
};
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: 'b69575facec09dfb067c962466ba710ab56eb4cb', class: "input-group price-input-group m-0 p-0" }, this.label && (h("div", { key: '8f01ca37ebe9031e07a400ae7d9dd071fa3b46f9', class: "input-group-prepend" }, h("span", { key: '8f9a7c4c1314300bd9f035192bbad7409d20fa5c', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: '8d68305642e374dc169381936ffd00d764664b79', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: '36d66dd50506e33d8c5d7dc5a98f37ed19d45ae0', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '060652211ac0b93692f835a58dcafa53ba8f4afb', class: `input-group-prepend` }, h("span", { key: '80f3684520e88d40f6209d1e9b05f5d965ec0713', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: '63b8c73c3f0ee83edee1c0e55f7128133dcba24c', disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '272b5c103880e6650de8ea02ea9a3709563b2f69', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '269dd035c154e8cdfcef306d0cfd8701f0e2fb16', class: "input-group row m-0" }, label, h("select", { key: '4d48f411810da2bde2fcda4255ae96ce3ffbbe39', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '6fb6d740ef66563b6516f76235334cfa54ff94d8', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '700acaf466d6489fc5db63d25e978d3bb85a024f', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '2d67433254be96aef12e1226b2f28d4d10cec9a8', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '8ed16ba56f4eb844dfa184903ca3a8b9a540d6f3', class: 'sidebar-title' }, h("p", { key: 'a593672aea1d0dfc2b25fd27319c3ef818e3df32', class: 'p-0 m-0' }, this.label), h("div", { key: '35b0734f1e366caedc293a494a9d1d9dc0a21d31', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '27ca280099ee5cdaf70adea292f53de99df57c55', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '54e454818f482fef0c931bdc500c3cf152f9dc76', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: 'da81b95c7a2370c48037322cc188e44aa66f18c6', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '3ad61d1dcf196a2005ecdc213a10b8401c3a31bd', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: 'a75b8eee69c334fb4b84b0bc25b4606098fa43ab' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (h(Host, { key: '388f0913c098445ce232d205c2f04d4e75c9961c' }, h("h4", { key: '63ab57c0146f3c17c74af871fba1929d87d73862', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: '1137acd8dfdaf2e1a4b7baaab3062758f5def4e9', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '669551000fa557dbacff2ab90901f5c4d3ceec58', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '21714ec2102d9f8a2ed6cf50c5e225751343767a', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: 'dbca321f63a8c69d143935b75ae1c49088f65889', class: 'title-body' }, h("slot", { key: '280d95e90df84cd8d3d0691388221c0aeeb1a5ad', name: "title-body" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: 'fe4b3fc85325ff666199240d7d1ddb1d46395103' });
    }
    get element() { return getElement(this); }
};
