...
import { t as transformNewBooking } from './booking-f2354caa.js';
import { i as isBlockUnit, h as hooks, t as findCountry, p as formatAmount } from './utils-c6413b11.js';
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f2d030d8ae673f322429d27c8468ebe733eea3b0', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, h("div", { key: '32529bef8b165626328ea850be93106e2d6b9797', class: `bookingEventBase  ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IrInteractiveTitle = class {
    ...
    render() {
        return (h(Host, { key: '6b3097cc8e1728ae2a03d18da53107b41ef84742', style: { '--ir-popover-left': this.irPopoverLeft } }, h("p", { key: '92fe84d36d578f66cb9613294e07d9a84baacf08', class: "popover-title", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, h("span", { key: '5fd5bcb25678951ebbeab9203ef5e7ad48a50524', ref: el => (this.croppedTitleEl = el), class: "croppedTitle" }, this.croppedTitle), this.hkStatus && (h("div", { key: '6a8dbd45b0228e18e00c601c9500ef327e47ce17', title: "This unit is dirty", class: `hk-dot` }, h("svg", { key: 'bc57450d4734f6adc9cd760a186cb6378865790a', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512" }, h("path", { key: '2dea4a8361300bdd81e77ba6789eb4bd592d3133',
            // fill="currentColor"
