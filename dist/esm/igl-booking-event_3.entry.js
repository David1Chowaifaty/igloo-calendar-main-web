...
import { t as transformNewBooking } from './booking-e490449d.js';
import { i as isBlockUnit, h as hooks, t as findCountry, p as formatAmount } from './utils-0ecaed12.js';
    ...
    render() {
        ...
        return (h(Host, { key: 'f2d030d8ae673f322429d27c8468ebe733eea3b0', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, h("div", { key: '32529bef8b165626328ea850be93106e2d6b9797', class: `bookingEventBase  ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, h("div", { key: '067a2ad748be3f1080fdd7f685b786002d60fdf3', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), (this.bookingEvent.is_direct || isBlockUnit(this.bookingEvent.STATUS_CODE)) && (h(Fragment, { key: '3a30a3e6751ad11ce76f1405f5b502ac2c28ce78' }, h("div", { key: '0704f435925af1296a3128d473d38fbf87d42dec', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), h("div", { key: '03c444e12529cd70b7c2902fd8477ca8625b90ca', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IrInteractiveTitle = class {
    ...
    render() {
        return (h(Host, { key: 'cc975a5b36c273e88f2a0c616352630c2f912da1', style: { '--ir-popover-left': this.irPopoverLeft } }, h("p", { key: '67d0c2f448fcdbe6829c4e55ca960d8b4420bd75', class: "popover-title", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, h("span", { key: '6883079172ce8645a8322a69e48062c5239ce853', ref: el => (this.croppedTitleEl = el), class: "croppedTitle" }, this.croppedTitle), this.hkStatus && (h("div", { key: '7f779f4103b887b6d36082d4130a5cf7a6828d8c', title: "This unit is dirty", class: `hk-dot` }, h("svg", { key: '65fbf4b7ceeb831002817d353ddf3278a9b42082', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512" }, h("path", { key: '266df4415d437368d5a4dc9eb3183bc54a8de88e',
            // fill="currentColor"
