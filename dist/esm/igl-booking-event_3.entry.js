...
import { B as BookingService, a as transformNewBooking } from './booking.service-c3924016.js';
import { i as isBlockUnit, q as findCountry } from './utils-f2863f4f.js';
import { h as hooks } from './moment-ab846cee.js';
import { E as EventsService } from './events.service-fab65136.js';
...
const IglBookingEventHover = class {
    ...
    render() {
        return (h(Host, { key: 'cab0c9c45915c63a038e879b3fbb12d81b198dd4' }, h("div", { key: '42090e26e97604fcb5f789760a7ec427be2fc26d', class: `pointerContainer ${this.bubbleInfoTop ? 'pointerContainerTop' : ''}` }, h("div", { key: 'a8675cafd8f886819c179423189d10d7ad9d4523', class: `bubblePointer ${this.bubbleInfoTop ? 'bubblePointTop' : 'bubblePointBottom'}` })), this.isBlockedDateEvent() ? this.getBlockedView() : null, this.isNewBooking() ? this.getNewBookingOptions() : null, !this.isBlockedDateEvent() && !this.isNewBooking() ? this.getInfoElement() : null));
    }
    get element() { return getElement(this); }
};
