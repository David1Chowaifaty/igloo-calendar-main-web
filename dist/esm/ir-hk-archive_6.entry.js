...
const IrHkArchive = class {
    ...
    render() {
        return (h(Host, { key: '27e62d4938586d6676f38bd9159ff56f6ded6df9' }, h("ir-title", { key: '66babfeb308069d590c1a5a90138771c22f72247', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '1c0f43c1a7900474acb648960c988f06a2f3c135', class: "px-1" }, h("div", { key: '2283411e226129aa47262d84d9ab39c676c03fb3', class: "d-flex" }, h("ir-select", { key: '0d2f9efa4b65a0d30f009f2755149b5f7d8313b7', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("ir-select", { key: '635e7378877da4954b8737bcf6da5b47581e7365', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '9d92ee45c62729740b95689242048210c11416e3', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: '8f4894b1bd157ed33de6d6eedfc5329371d9be66', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '9d0d273c13bdc0d945e6d99e2893ab0e1e4084b1', title: locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: 'a10253e0f924cd069252e0fa3bf5a5344c44cbf1', title: locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'baf2f227e004cc5006c54e900755ba6c30a05deb' }, this.data?.length === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, this.data?.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: 'f760b827237db1f5d10c2e1de89e68a47286b090', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (h("ir-booking-details", { key: '016b836089ee50f5cf6276c8a5b569521fa83a9e', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        return (h("div", { key: '58b04b1fef681549a209ccfab152271340da465b', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: 'b1e0bb9cac71ec1278f0c6e0a6beefda10812169', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '7795ff5907c0d8522a6efabbca279cc931971438', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: '0afbfb71af4a65fa8eea461589adfd25a74475ae', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '4c76c2a7da41be254eb40131a4b0ad89d6ce745b', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: '61050f633ef2443520c825a821efebbbdffa61c5', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '8a676659ef8a74df0bdb62332e132f37b5008329', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: 'd784d0839c2af8bbbd86980982c526a65fa5f13d', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: 'd794fc37ea80916f70c6c9c0647b2dcbd43ba88d', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: '92d653c6fccde1e6331b54aa8b93dbd65c1a8be6', class: "pt-1" }, h("p", { key: '8e853304be1e8406dc1f9ddbedb60094556ad85b', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: '23d0645d1ab0a1235ac38b06d8909847c374a8fa', testId: "period", selectedValue: this.filters?.cleaning_periods?.code, showFirstOption: false, data: housekeeping_store?.hk_criteria?.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: '79b896543f8ccc9e61fdb96d788d8fea779d44d6' }, h("p", { key: 'e4d4af145c49fe43c855632bc9d9f93ab1f3ebba', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: '679ae3b41ca305948a767e6b84e7fd9cac3e89f2', testId: "housekeepers", selectedValue: this.filters?.housekeepers, showFirstOption: false, data: [
            ...
            } }))), h("fieldset", { key: 'bf77d8a8b0d5edd15f53ba19f8fbdd0c32f16eed' }, h("p", { key: '94132c5ee748dea75d12845b3db6ee51af484231', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), h("ir-select", { key: '428a8e1f1ff65fe6193c8dd432c1c7fa5525ddb4', testId: "dusty_units", showFirstOption: false, selectedValue: this.filters?.dusty_units?.code, data: housekeeping_store.hk_criteria?.dusty_periods?.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), h("fieldset", { key: '426724dfc6d5252bb09eb4847c6bf11148a1fa1c', class: "mb-1" }, h("p", { key: 'c9d4445499c66a09871f8e47cc387d7e14c877ef', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: 'f9691dbdcf0827e5e758af316145d805a7e6fd96', testId: "highlight_check_ins", selectedValue: this.filters?.highlight_check_ins?.code, showFirstOption: false, onSelectChange: e => {
                this.updateFilter({ highlight_check_ins: { code: e.detail } });
            }, data: housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => ({
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '6b2effda9a312acc9401d1f570b11dd337bb3408', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: '379ba7d6304749b40db45feca3090c9d238e144e', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: 'ed1a25bfbb618edc58ec64744dc7438ea6a8f694', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: '0915cf9aed6d2cb95410090aaa242de4823aea31' }, h("div", { key: 'fe2cf7ac247839e69ab37a8985335e9faa70a2e5', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: 'e670aa2b1d9bcba979a836adbae005adc6160916', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: 'e018962fc4552d47d72a0c74acc6c8883633d1cd', name: "search", slot: "icon" }))), h("div", { key: 'ef7b7ad804fe1598c0b366a58c51b084c9316746', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: '3e6022bd4db6962680323f3b091f109d74030144', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: 'cb558602ecead15edb0747c86ac25c955c9aa1df', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), h("ir-button", { key: '9ac86255c75a69b203befe4dad31cf5a174c95f4', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
            }, btnStyle: { height: '100%' }, size: "sm", btn_disabled: !(hkTasksStore.selectedTasks.length > 0), text: 'Cleaned', ref: el => (this.btnRef = el) }), h("ir-button", { key: 'bf25057310b6536b1bce04e2ba1adfce1a0d21f1', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
