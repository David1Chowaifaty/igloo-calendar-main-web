...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (h(Host, { key: '75f3519e20878ac8eeb95765a23c408499e13e30' }, h("ir-title", { key: '8654740a24f127d83a14c5bc1b2b0e5b990b19a0', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '1e091ae4ece2cab1a0f80867f8de93abdb0563c7', class: "px-1" }, h("div", { key: '04c66fdf3c207e8119f17a81bf3b338b86a28889', class: "d-flex" }, h("ir-select", { key: 'd4047e9ef0921d2ae4e4b1718187feb50676e18b', class: "w-100", showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '65c0f4d7bf7249b76d4e17b74967318c5e8a9656', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: 'f9b3e5d6a68a797ad13b5a064220121b2511f22a', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: 'f44fb54b6d3961de349a2d2defb70c043defa51f', title: (_h = locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '22f0557cccce769ddb9b3e2c00a8790cd6c291f3', title: (_j = locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: '62fd87cedf9bb94342c768f22f85b0a3b20b87d7' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '16d2a911cadc6dd5ad17fd534585c60120b19800', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (h("ir-booking-details", { key: 'bfc18ec6c2688d662e9d5104e66e588b1bfbd354', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: '92ba9c27e02c84b2a3ee9778be92e0c2b78ae8d0', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: '9a2b151806b41d2b4b311a7234b6ab38c254dad2', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '7db6c3c0972f01fdc39c0ba36b4fe316cd53d8ec', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'f9469c1546d2982687d912d9e39ecfe358742676', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '6a7cef5a94ee0a66e14abc8a1f5ac191c8174cb4', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: '47c1f4c4de1e3ae02f167ba18bfddd7ca121f26a', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: 'd8dbd628c0dcf6d4fb1890917d0fb2b70fd13606', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: '7420caaa3c4abc518583aed6cff0ef0b5cb6f70d', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '5d7251c52ec376225b049f1ffdd8c1a1d464cc2e', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: '341a7ab8135c95b6fb35defdc3f7362cae295f1a', class: "pt-1" }, h("p", { key: '0213b4af10fa148ea940b42f8a4fec61c1487a59', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: 'c7ece8dd4a210d4b0830c7683edec8a41dc25163', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: 'c2acba2dbcaa96b3a59a93dc9a83ec06800b545d' }, h("p", { key: '16de0e9432fea3a1f688808b30ec35461a3e1d6f', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: '1c8c0fa0f42443cacbe1354c58ff523c145411b9', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, showFirstOption: false, data: [
            ...
            } }))), h("fieldset", { key: '0bb8738d41d297a76b8458a8d0c07495ca287a69' }, h("p", { key: '93fce8968661bbdaf97fc3a39ec14abb613bc4a9', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), h("ir-select", { key: '26d840623bd688ab3489c60500f0439f9b9b87f3', testId: "dusty_units", showFirstOption: false, selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.dusty_units) === null || _h === void 0 ? void 0 : _h.code, data: (_k = (_j = housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.dusty_periods) === null || _k === void 0 ? void 0 : _k.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), h("fieldset", { key: 'a4650676977409e60e7aad9a09936870843a60af', class: "mb-1" }, h("p", { key: '2eab1dd85695f847e3f53d90558e6bdd27cf3260', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: '1b8fc547ac6c5c244220a3ba0d861103048002c5', testId: "highlight_check_ins", selectedValue: (_m = (_l = this.filters) === null || _l === void 0 ? void 0 : _l.highlight_check_ins) === null || _m === void 0 ? void 0 : _m.code, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: 'bf7ebed380642a7e77226983813c349b5c4f2862', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: '3f737fc596479acc10c69e4cace034386ab03219', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: 'eb5aa252a7d8eb7ee8b4fea7701c34bcf3fadc5a', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: 'ba73ac573395ed10431984b726f93858a36174f8' }, h("div", { key: '657b0d32d8f20e1ee8540c585c8c4c7765c3020d', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: '4bbdfa24adb5212120f7330a26c7153eb7f9e5dd', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: 'f131e17627dfceed5792adfbff269bbd7ef2d2e3', name: "search", slot: "icon" }))), h("div", { key: '899c6247b58079d0c069cd89cd393265673d736c', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: '6398e9bda432ce0ace1bb972882f55da9503a8be', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: 'f27053d4efd6b95704358de2e94c8913fe5421fa', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), h("ir-button", { key: '49a8aaafa66a56ca4b758759af7c1be834394714', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
            }, btnStyle: { height: '100%' }, size: "sm", btn_disabled: !(hkTasksStore.selectedTasks.length > 0), text: 'Cleaned', ref: el => (this.btnRef = el) }), h("ir-button", { key: 'a2732bf9290d8d651b267f63e71b92f8ee115ac6', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '9964f513f599b16c5ae2749e1febca7ba8a25fa5' }, shouldLoadMore() && h("ir-button", { key: '442688eab28848e12c66dfbd160840d217f2ae35', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '6c68e01308f0a0564cdbfbde8f6ad4c807740a53', showing: {
                from: start,
                to: end,
