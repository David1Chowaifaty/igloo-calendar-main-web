...
import { E as downloadFile } from './booking-7c3fba5f.js';
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: 'd749a4ba5e5736bf236dd5fcf8ca45ca59574f0f' }, h("div", { key: '148110b0f9fe3cf95653b39d37c1d9985ae18bf5', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: '0eeb1d33a010504d77abb9b306a8acefac2ec94e', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: '4d9bc3bee7a227edaa255afec5f854d055ce82ad', name: "search", slot: "icon" }))), h("div", { key: '0055d76bbdae9b5f04ed10afaf16a60b1c8ae0fb', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: '7aff6e4095e6b4b6efae8fd0460b90bfe7c8bd23', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: 'e16b735f5640b5a1f45495c0812e40e264778dab', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), h("ir-button", { key: '4cbc672e45e38fafa33da19307abe2e65e2251bd', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
            }, btnStyle: { height: '100%' }, size: "sm", btn_disabled: !(hkTasksStore.selectedTasks.length > 0), text: 'Cleaned', ref: el => (this.btnRef = el) }), h("ir-button", { key: '283b2f5dde5270c9248b2aabbb8e0dff7d7dbe21', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4a7641722d28e56e7eaab34c583fb7c0da59d198' }, shouldLoadMore() && h("ir-button", { key: 'f2ca4963dbe7972857c21f60958fd1a9d5eafa0b', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '80897f7ad4d34b0c10f6cf89737b0f69e6402720', showing: {
                from: start,
                to: end,
