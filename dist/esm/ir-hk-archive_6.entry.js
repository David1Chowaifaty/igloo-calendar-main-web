...
const IrHkArchive = class {
    ...
    render() {
        return (h(Host, { key: '4f5e1292c90d2b6e6ef2650f827301ad4e566171' }, h("ir-title", { key: '0f5feb86b98fa80251aeab13df772a01d552c518', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '56a74344a431d3fa9c463340abd62157fd5901de', class: "px-1" }, h("div", { key: '55414860d1637cb7ebec0bf3617371bc11f7459e', class: "d-flex" }, h("ir-select", { key: '553d29fb4029c2d74bc39b90dac2b24b65795ed0', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("ir-select", { key: '28193bfb4bc32a0153851700d5b2ffede5f490c8', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '877799a864934b132c656490be62f952f17fb0ae', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: '94f6fe3ba0d30682db6c34d3996d7587e003d189', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '77e006257cb91358d90786f5e856f39375249f9b', title: locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '4d98a32db908cf6d49ac2bd7b2bd6151dc504d94', title: locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: '0924c39ff508d58357d613f157b4ecd66da96bf9' }, this.data?.length === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, this.data?.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '5f83c085b68ed96b9dbd1b29e01d7174109514f3', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: 'var(--ir-color-muted-background,#f2f3f8)',
            } }, this.selectedBooking && (h("ir-booking-details", { key: '89cbfacaaae2d0834c22ff5c3defab7e02ede478', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksCard = class {
    ...
    render() {
        return (h("wa-card", { key: '54e2bec8b13ece8dd809f8bdcccfa4cec225cabe', class: "task-card" }, h("div", { key: 'b65f36e95752bd816f2637757fc82b61f3988510', class: "task-card__body" }, h("div", { key: '38208de03ab6550082db39a7f7f6368bb50b8bd2', class: "task-card__unit" }, h("span", { key: '2592a0634378aedb3ec4f327ca748d9bdb2304d9', class: "task-card__unit-name" }, this.task.unit.name), h("div", { key: 'c0182a1cdbc7e3f2ab42e07d0cb088b76fb11949', class: "task-card__meta" }, h("span", { key: 'cbf7e9ac8673fd7d708b2b48a649a6fa80e9d106', class: "task-card__status" }, this.task.status.description), this.task.hint && h("span", { key: 'bd12a3494d27f907f1d96f378bc4468713e382e7', class: "task-card__sep" }, "\u00B7"), this.task.hint && h("span", { key: '3ba30a4d3157cb28d684c90c4f67ed3218439028', class: "task-card__hint" }, this.task.hint))), h("div", { key: '5493ef09c043208ef31c19b75d13ffc65db5316c', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (h("div", { key: '152d3703e1b63ec98981a196a77edc4750587117', class: "task-card__guests" }, this.guests.map(g => (h("div", { class: "task-card__guest" }, h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), h("span", { class: "task-card__guest-count" }, g.count)))))), h("div", { key: '149d62d627879736ccc12db5f2dec7d6f0a46d12', class: "task-card__assign" }, h("wa-select", { key: '2d36ec6b5b9fece34a6dd44bcd261a0dfa87f061', label: "Housekeeper", class: "task-card__hk-select", size: "small", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, h("wa-option", { key: 'd5aedd99dc46ff052ffe79c4337c1fd8b9d8284c', value: "0" }, locales.entries.Lcz_Unassigned), housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), h("div", { key: 'e9173da1d17be93cb1ddac909e37992ac348ec87', class: "task-card__actions" }, this.isSkippable && (h("ir-custom-button", { key: '3aa4c488c41face43d4d35643b65f59b82908fd7', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (h("div", { key: '801ef6b543c3b590809115017ff6f39583338474', class: "task-card__clean-group" }, h("ir-custom-button", { key: '892a91074454128e2df554ae30ef95c3ed3fc365', variant: "brand", appearance: "filled", onClickHandler: () => {
                toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), h("ir-custom-button", { key: 'bb26c9519ae1001a8b3ca4312ddc55b497a659e7', variant: "brand", appearance: "accent", onClickHandler: () => {
                toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (h("wa-card", { key: 'c0aba022ea30adf0e7f2588f50d07d66e7462a62', class: `filters__card ${this.collapsed ? '--collapsed' : ''}` }, h("div", { key: 'd07265bc772e78072fdaff428ae91e24f3722ce1', class: "filters__header", slot: "header" }, h("div", { key: 'a4a8ce1d391e846e18f6f2a82825bf873a58c927', class: "filters__title-group" }, h("wa-icon", { key: 'e0abf034f31f9575df5f700a8c15de17480dcea9', name: "filter", style: { fontSize: '1rem' } }), h("h4", { key: 'c98c891d7019e9380ba9cd3a9b41663905a4d60d', class: "filters__title" }, locales.entries.Lcz_Filters)), h("ir-custom-button", { key: '992cff15f5c7e40162a9dc236b1cdc29c6ab9d68', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '498eff9fc64bed25df73daf8d1235f145a6aa794', style: { fontSize: '1rem' }, name: !this.collapsed ? 'eye-slash' : 'eye' }))), h("div", { key: '64385cac183fd957bddb76337e09caee56f69f75', class: `filters__body${this.collapsed ? ' filters__body--collapsed' : ''}`, id: "hkTasksFiltersCollapse" }, h("fieldset", { key: 'bc0ae3baaea8f7ac31f5709363a40ed53348cb1d' }, h("wa-select", { key: '19ecea73d70a31ed7bc123c2ffed160fa4c728fa', label: locales.entries.Lcz_Period, size: "small", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: '555f2d9df484a1a7362f16912c851b66cc7c56fa' }, h("wa-select", { key: '8f4c00314b24088253bbc95fda6f2c7bba160ee0', label: locales.entries.Lcz_Housekeepers, size: "small", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, h("wa-option", { key: '3023903ed75eb6553e8b0cb0253f2e1a4db6b29f', value: "000" }, locales.entries.Lcz_Allhousekeepers), housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), h("fieldset", { key: '66d8f907b114ff79bb2e5577f012826e5ac536ac' }, h("wa-select", { key: 'cd1c278bdb95b337617c2fb211eafaf25dce88d6', label: "Include dusty units", size: "small", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.dusty_periods?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("fieldset", { key: '0b04ff1fb361c4af534dea0f2f57a93e02f53737' }, h("wa-select", { key: '39a8732213f485e9b26d40252ec85c2ff5c6e7e4', label: locales.entries['Lcz_HighlightCheck-insFrom'], size: "small", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("div", { key: '0b3a05478106729e21a38c3869b3963d76dd06e4', class: "filters__actions" }, h("ir-custom-button", { key: '5cb147bba0356ec4037ba5331735a67edec58148', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales.entries.Lcz_Reset), h("ir-custom-button", { key: '17d9ef3ce2a3e0341d44d74aecdcee02495c5f6e', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales.entries.Lcz_Apply)))));
    }
};
...
const IrTasksTable = class {
    ...
    render() {
        ...
        })))), h("div", { key: '3fb05450b8bc1ee7a0c59e0d81711b0f33060e19', class: "data-table--pagination " }, h("ir-tasks-table-pagination", { key: 'bed4e0a86a94b64702e8421d0f57b6d0099e01b2' }))), h("ir-dialog", { key: 'b2ed90474c42779e4ecab901a58d1a8643b99f3d', ref: el => (this.dialog = el), label: locales.entries.Lcz_Confirmation, lightDismiss: false }, h("span", { key: 'b4dd5803e2b43d16802682b61f6cab8f48be2d3e' }, locales.entries.Lcz_Assign, " ", h("strong", { key: 'f3f8487e8b0a90df3589233ea8c82c60d4edf964' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", h("strong", { key: 'e37b48ca96ab9ce7e13b3f5adf157b537b325ee2' }, pendingHkName), "?"), h("div", { key: '1119f9158c7e45a57c68167494919a2ebc3c6cc2', slot: "footer", class: "hk-dialog-footer" }, h("ir-custom-button", { key: 'f45fd7d2f61f1b317a0d3f27c794d70a9a4b9399', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'b309b27a6d88f5aa9f6e811659d4dc71314847d1', size: "medium", appearance: "accent", variant: "brand", loading: isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales.entries.Lcz_Confirm)))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f4120bf09d720ff24ead367e90aded62e20bfdc6' }, shouldLoadMore() && h("ir-button", { key: '86e85345a9bcb9cf3ec65d98b1ec91494a719c25', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '7dbb5e5cc846358aa914581f4e0ce947a70877be', showing: {
                from: start,
                to: end,
