...
import { N as downloadFile } from './utils-8be61e26.js';
...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (h(Host, { key: '139fdbcf1fa4d8b06358304c1389cd840b050c70' }, h("ir-title", { key: '4878ee0b6016dfda934d706b88d22f2fdcae039c', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: 'ee6f8fb8e2f1e13daa597bbdfcba02153402a8d6', class: "px-1" }, h("div", { key: '47bbc1542940edd93241c060becddb14d66ebb43', class: "d-flex" }, h("ir-select", { key: '9df8951770abd6761fef3e2252807a7e793c1114', class: "w-100", showFirstOption: false, data: [
            ...
            } }))), h("div", { key: 'f3a4ca318467eec53cac795d307dbf45edb869fd', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: 'efe53b5ea80bde6a50381ccde760ff1fe044d5d7', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '866f4ca8c38f8762757b48a843037a3c39e778e1', title: (_h = locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '354cf4c980cd4c6695e16b10a632bef432d9ec27', title: (_j = locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: '4548d766c80be61c518ec97b71872cecfb857f52' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '409d04d430142d1db5e6936e27c36f16da2ef75a', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (h("ir-booking-details", { key: '3f8ced0dc8c64ae1af1aa702ce5ddb1317b9f9d6', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: '9935bb9a1961063829e69b5489a5cd53d96fff10', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: 'df123c933d20489bbbf1f45e99d266624660bf54', class: "d-flex align-items-center justify-content-between" }, h("div", { key: 'aae014173db9bf2f6024cdcdb005e7c4acc20802', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'a4d032319f729e028f40c6d2baa55ca5e74b49b9', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '4601e802224fef569b2b86c9829e64f04168c32e', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'f1433fb112ae0f2e173ffa175730177128bab733', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '562a8e7aa456c0c42a023a0e798d1aa61ed3aa2d', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: 'b253dc98a57411bb97db9e4e09b58a7b262e6844', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '3a407e3cba025b05a3ebb384d55caa87b83859da', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'a567fc42555f086b46b5842a839462eef3bfee5f', class: "pt-1" }, h("p", { key: '6389a61b4f0c037d7f8fca2be528816fd269e034', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: 'e9b67e553ff8394d71b68b4a685b1953f913f958', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: 'db68a0f2c43ac2e8ba346ad1da654faf2b5798d2' }, h("p", { key: 'e46e3f696f90ee0c2080d7069a2d0a811a2536e7', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: '8507f08c599930a480ecfb238b4155e97b088bd1', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, showFirstOption: false, data: [
            ...
            } }))), h("fieldset", { key: '5f01ab789b250dc8bafe09ad835e1121d83003b0' }, h("p", { key: '8c4d10718f6e6b2524d92d5393bc286586ad651a', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), h("ir-select", { key: '7fdaa3901a91446ddb0f5916b0df25768339e5b4', testId: "dusty_units", showFirstOption: false, selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.dusty_units) === null || _h === void 0 ? void 0 : _h.code, data: (_k = (_j = housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.dusty_periods) === null || _k === void 0 ? void 0 : _k.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '5dc7afbee5752901cbb555f9cc4444f6df70a260', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: '955bca778b272c4a06c485cde02d418c6ac94018', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: 'a2e10c7adcace5cfb7bb96f2c9f7757b39685477', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '83411f9e580e80b11e07d030455e1f897665d8df' }, shouldLoadMore() && h("ir-button", { key: '47be9c22d9474c50739eec634de1ddcf47aead01', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: 'b4784c540f01d82a53df85def33b0f6f81ba165e', showing: {
                from: start,
                to: end,
