...
const IrTasksFilters = class {
    ...
    render() {
        return (h("div", { key: '5a34fb9a6d477a35a3219adee50c7727b6c78ecb', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: '914e24cc7ad52a89274ad70cc70f60469e041b99', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '6f8413055061959a041d70bfc516a2aa8d55e832', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: '0a87940307b45bf7c035e807bea50b2664321618', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '70ca1b02924ed16d69e6751a3ec72dd8a4517c07', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: '46c181f228d636d8628042487c8db3dc5d0fb58e', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: 'a0a681dc79c8449616c9043404f45b93bd83ce90', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: '67bbe6f04f7b6be9d363d5d6821cb3db8db1ad55', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '50160c09d521307ec5a3a22546de6e0a67dc4574', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: '47c573a2c3631e1f7bffc7e0435c5d1dc9b4dffe', class: "pt-1" }, h("p", { key: '398cd5348540c8a5e5643221c1d60feccccdbd15', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: '23d00855f369d146045409fdec094fdc92d3a42e', testId: "period", selectedValue: this.filters?.cleaning_periods?.code, showFirstOption: false, data: housekeeping_store?.hk_criteria?.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: 'ea9978620e745731ce37a4571c7508136a82ec89' }, h("p", { key: '8808f6c878c599b57be93fa87d19706e331fb1ef', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: 'e7a71dd5d33c210f218cbffde3b110a6acb9e2cd', testId: "housekeepers", selectedValue: this.filters?.housekeepers, showFirstOption: false, data: [
            ...
            } })), h("fieldset", { key: '66966f16b13363c44014b180b1c16f26a09e1b89', class: "mb-1" }, h("p", { key: 'a629d2e91227a8e42a8bfa793b0ce064fb335901', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: '13366f523d013f4ddadfd89714d1b1b32b8928f1', testId: "highlight_check_ins", selectedValue: this.filters?.highlight_check_ins?.code, showFirstOption: false, onSelectChange: e => {
                this.updateFilter({ highlight_check_ins: { code: e.detail } });
            }, data: housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => ({
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '64c218a46e836bd1f1be99349bb6b8f682e7bf8d', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: '95451c52ad49df4e64be11d019e7fe57f769349b', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: 'b42822486d7853de1658b78494b5cc74468886b4', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '31c654ce336f82cd9ee761cbabfe18b3c1ecda7c' }, shouldLoadMore() && h("ir-button", { key: 'b8124488f63caccba3ddbac55eecdf8c936d0e86', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: 'cbbd84489e59c8d83c8470204f99f496949fbc7b', showing: {
                from: start,
                to: end,
