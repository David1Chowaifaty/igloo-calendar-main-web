...
import { x as downloadFile } from './utils-1202e3cf.js';
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: 'c419bd2507af5a5f4eb66547f2eed530117d337e', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: 'bd93af5d89502f9f9f1a00cf5c348566b84e362a', class: "d-flex align-items-center justify-content-between" }, h("div", { key: 'be01e56a85065c75b5c29fd3484c43cfdaa47336', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'e46458af95a732310a52dcbeb0dfef3dabcb7afc', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '10beb9da58879454ab77a86852896388e767dbb2', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: '84692b399236431754a8a9e048da7ab6a7d75482', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: 'c49ada5bd570d0f6a455eeb53f68603d0991db59', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: '81b828dd8b3e4cdb44ed1bd47fb4b61e9457ecff', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: 'b19eb7e599e0d49efea1744c31df06f47013e980', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'bce4bdcee54608998ddd6d2eb5e0f977b5ceb495', class: "pt-1" }, h("p", { key: 'f9430264797ce97eb5d407c39db10bc7a0eb6978', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: '3f0dd2926c685f653d853ab8a3e10b6872e908ee', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: '4aec29891ed44c44d7ea582513f612017a88af53' }, h("p", { key: '7375ae09ce109648c7c8c544a4dbd3d01c79103a', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: 'b9c7438c82aa87dc16aac69b971b4f379975148e', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } })), h("fieldset", { key: 'fea2bf8ec8ded2e9251cf25103a2960c033d782a', class: "mb-1" }, h("p", { key: '4256e985476e20f7bc1908b7fdc82a5654936e24', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: '173d35421403d560c90c4f71bb77df82cb6e362c', testId: "highlight_check_ins", selectedValue: (_m = (_l = this.filters) === null || _l === void 0 ? void 0 : _l.highlight_check_ins) === null || _m === void 0 ? void 0 : _m.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '3b73db3a9f16011dfa1385a1bd35cfb6316ef12c', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: 'e81fb1794dfed0d06012b6ab05d42fc6ec75cac9', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: '1e8884c16e699fd20ceee0170d808f41544a6f14', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
