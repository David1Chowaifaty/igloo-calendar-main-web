import { r as registerInstance, h, F as Fragment, H as Host, c as createEvent, d as getElement } from './index-0Di74WDd.js';
import { H as HouseKeepingService, h as housekeeping_store } from './housekeeping.service-BnjPrkJD.js';
...
const IrHkArchive = class {
    ...
    render() {
        return (h(Host, { key: '8a1b371e57dafdb4b72e60d31f6abc464bd293df' }, h("ir-title", { key: 'e579bceb3eef2c940adf6057108d309b512348c8', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '6a88e83bc455ed062e2bceb361ad2a980ed332dc', class: "px-1" }, h("div", { key: 'b44d05235a1ad52fe807b012b39c39fc834459cb', class: "d-flex" }, h("ir-select", { key: '260c11ac27b5e10e4158e9d5a541df7819306a6b', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("ir-select", { key: 'c73f3acda0eaa675927301cf331aa5e64e48154e', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '48db68a84449ef53a188883335de6ea4f917039f', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: '1afa35568d45ad59abad9423a798d47709d6154f', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: 'b46b3c2f13c0b29831ebb1dc06337d1b2b753639', title: locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: 'bb01121d4e297881d880d38e1d650fa183c124c0', title: locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'f852cf341b83a3c39511cac09d4881314f6ff5d4' }, this.data?.length === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, this.data?.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: 'b429f4704e7d9882c60f98adab258cd39bb12bf5', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: 'var(--ir-color-muted-background,#f2f3f8)',
            } }, this.selectedBooking && (h("ir-booking-details", { key: 'a5844152c068041c51871588a879d59621a01a92', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        return (h("wa-card", { key: '209abf99bbf3e05fb534ca1dbcf8db2ab0f7990d', class: `filters__card ${this.collapsed ? '--collapsed' : ''}` }, h("div", { key: 'd189b5deee4435fa7853a4f58677795b89834fb9', class: "filters__header", slot: "header" }, h("div", { key: '604eca0ea8a33906c63b20a1afed8dd88a5179bc', class: "filters__title-group" }, h("wa-icon", { key: '4b55854787f778de2695061fd42d0fbc0ace5ddd', name: "filter", style: { fontSize: '1rem' } }), h("h4", { key: 'd12e0891c975e91731d6c5870f7a2e067fe984e0', class: "filters__title" }, locales.entries.Lcz_Filters)), h("ir-custom-button", { key: 'bbedc8be082907ff61d9792289f925fe6603039d', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '5a6bc5081558045e05657d4ad76feb734c36d324', style: { fontSize: '1rem' }, name: !this.collapsed ? 'eye-slash' : 'eye' }))), h("div", { key: '7d8899fa2b756e4fc619c656586b3f32ac3338ad', class: `filters__body${this.collapsed ? ' filters__body--collapsed' : ''}`, id: "hkTasksFiltersCollapse" }, h("fieldset", { key: '45d360117b07c068be0b10c6ea8740c02b480eba' }, h("wa-select", { key: 'c8cc20340f08256b9a8586fee5c5e82fda529bca', label: locales.entries.Lcz_Period, size: "small", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: 'ed4c4a831ccae8e1b72843dfbfc0f049124ef1f3' }, h("wa-select", { key: '0f880bb4a1f41f5e8eec5ef38dc5859a4107ac5f', label: locales.entries.Lcz_Housekeepers, size: "small", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, h("wa-option", { key: '0fe1ef59041848da3ccca3b30fa2543a54257886', value: "000" }, locales.entries.Lcz_Allhousekeepers), housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), h("fieldset", { key: 'c86bd75a3e7c4a3b12991406a8a7ee2e286bd007' }, h("wa-select", { key: '87e8d26f747bdaae53a87cd7a8e82acbbe69db50', label: "Include dusty units", size: "small", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.dusty_periods?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("fieldset", { key: '7a164bc1edcdfad65b13b5c2e163a4074abf8183' }, h("wa-select", { key: '5af588171bc701417bf0d338d0b1d2e878a568d3', label: locales.entries['Lcz_HighlightCheck-insFrom'], size: "small", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("div", { key: '52a56bb878b0af8087005a83ae521f9e881f7768', class: "filters__actions" }, h("ir-custom-button", { key: '5d4f07dce1ba43935dc491cf8b5bc5618c885637', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales.entries.Lcz_Reset), h("ir-custom-button", { key: '306abdd2c71aef31d198b5c9246aa46f9ddab31b', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales.entries.Lcz_Apply)))));
    }
};
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '47355058b114b702e049bff9ccc6d1b174da0ccc' }, shouldLoadMore() && h("ir-button", { key: 'd08c13919e8ba27aada0cd3fa0b9aa6b0ddb587a', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '0c4bff1292a3c57997b309838d2ced8ea199bf58', showing: {
                from: start,
                to: end,
