...
import { b as downloadFile } from './utils-e86d974d.js';
...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (h(Host, { key: '250d96d087db1af88baf9cb421a863e95a001fc8' }, h("ir-title", { key: '566638c123abd2c266553dd4319e19eba7dcf9a3', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: 'dc3d850cd60bbafed62d0030b78854078b159c17', class: "px-1" }, h("div", { key: '552843ced0b2a09b167a00b4f93252378730833e', class: "d-flex" }, h("ir-select", { key: '13facda2389c2e24a2aca19f1a1091b02d658412', class: "w-100", showFirstOption: false, data: [
            ...
            } }))), h("div", { key: 'e964b239abbae4559c18211cd4aa1eaa3a3ee301', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: 'd3d40318ea3597447b10331136515092e8573c6b', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '1513715c03fa8dbb2218c7f3360a41ba3673ec63', title: (_h = locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '55d6b1e5ccad4dc9811afc0af1d5fa9431d58137', title: (_j = locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'f358e6292d6b13ecf3c432ec31eacfb0b4de861f' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '3da2d9bf6db4bbb5f0aedd7b18502b4abbdccf21' }, shouldLoadMore() && h("ir-button", { key: 'f3069a382c0aa5550a0ba14efef097aa157dafbf', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: 'fea7eb16cb457827ddf6b88e953c62457a86700c', showing: {
                from: start,
                to: end,
