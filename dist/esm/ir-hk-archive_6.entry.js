import { r as registerInstance, h, F as Fragment, H as Host, c as createEvent, d as getElement } from './index-DF2__fQU.js';
import { H as HouseKeepingService, h as housekeeping_store } from './housekeeping.service-BGaNn4aW.js';
import { c as calendar_data } from './calendar-data-I5D6ZJ1U.js';
import { i as isRequestPending } from './ir-interceptor.store-DTVpqbBV.js';
import { l as locales } from './locales.store-BOppy8do.js';
import { g as downloadFile } from './utils-Wjp6LFRm.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { v as v4 } from './v4-DD3477fe.js';
import { t as toggleTaskSelection, h as hkTasksStore, u as updateSearchField, a as updateSorting, c as clearSelectedTasks, i as isAllTasksSelected, s as selectAllTasks, g as getCheckableTasks, b as updateTasks, d as getPaginatedTasks, e as getMobileTasks, f as updatePageSize, j as updateCurrentPage, k as shouldLoadMore, l as loadMoreTasks } from './hk-tasks.store-Cy7LAXr-.js';
...
const IrTasksFilters = class {
    ...
    render() {
        return (h("wa-card", { key: 'c0aba022ea30adf0e7f2588f50d07d66e7462a62', class: `filters__card ${this.collapsed ? '--collapsed' : ''}` }, h("div", { key: 'd07265bc772e78072fdaff428ae91e24f3722ce1', class: "filters__header", slot: "header" }, h("div", { key: 'a4a8ce1d391e846e18f6f2a82825bf873a58c927', class: "filters__title-group" }, h("wa-icon", { key: 'e0abf034f31f9575df5f700a8c15de17480dcea9', name: "filter", style: { fontSize: '1rem' } }), h("h4", { key: 'c98c891d7019e9380ba9cd3a9b41663905a4d60d', class: "filters__title" }, locales.entries.Lcz_Filters)), h("ir-custom-button", { key: '992cff15f5c7e40162a9dc236b1cdc29c6ab9d68', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '498eff9fc64bed25df73daf8d1235f145a6aa794', style: { fontSize: '1rem' }, name: !this.collapsed ? 'eye-slash' : 'eye' }))), h("div", { key: '64385cac183fd957bddb76337e09caee56f69f75', class: `filters__body${this.collapsed ? ' filters__body--collapsed' : ''}`, id: "hkTasksFiltersCollapse" }, h("fieldset", { key: 'bc0ae3baaea8f7ac31f5709363a40ed53348cb1d' }, h("wa-select", { key: '415ab5e2aebc425591c8fcc5f4aeac845ddfb5e2', label: locales.entries.Lcz_Period, size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: '797329f50db1bcd7da3e736782e0775dd94527c5' }, h("wa-select", { key: '95cd92325c172ccb71fc8dce2779bae1ef872fa9', label: locales.entries.Lcz_Housekeepers, size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, h("wa-option", { key: 'e55abbdd67552fee45c58418dedb4bfad42c0d95', value: "000" }, locales.entries.Lcz_Allhousekeepers), housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), h("fieldset", { key: '9bfdfc964807e904d346c0cc9d606c889261d592' }, h("wa-select", { key: '83ff409ad19d9ee3ad225d5e4fc506139be16576', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.dusty_periods?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("fieldset", { key: '84c5e73f1cb3fc990d661bfef9da28a161736677' }, h("wa-select", { key: '7641b48a7a29d00d6f74aa1595d27c4902e90497', label: locales.entries['Lcz_HighlightCheck-insFrom'], size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("div", { key: '87ac5ecf3e74e09f60b5623f0831a1134b51be18', class: "filters__actions" }, h("ir-custom-button", { key: 'c764b6b929025ce7c8f99c5c3646e7c0fa589dda', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales.entries.Lcz_Reset), h("ir-custom-button", { key: '965a4395598318a3b201d390dc6dd03454681b6a', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales.entries.Lcz_Apply)))));
    }
};
