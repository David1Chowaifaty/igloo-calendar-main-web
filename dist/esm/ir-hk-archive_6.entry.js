...
import { p as downloadFile } from './utils-78094d83.js';
...
const IrHkArchive = class {
    ...
    render() {
        return (h(Host, { key: 'fe04eeaccd2b4adbcc6fdc2abac21181a833432b' }, h("ir-title", { key: '343608a2022202c01c34acdb9c996d6f664aa046', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '971af39fe54685ae43ba09a0c19e139b176f3242', class: "px-1" }, h("div", { key: '57bd977dbfcab504f79b332131fb6babf1a9df37', class: "d-flex" }, h("ir-select", { key: 'b1cbb4b8c9c6fe388940801ecbbe2f65a1168757', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("ir-select", { key: '778abb421deb14fa440bd9bbeeb67812fdca59c4', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '20ecdfa7487072f17a04a54e89ea532149b7eeda', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: '099ac1ac1a115e64201271e188b155fc1f1c170a', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: 'feb9546b67d56ded81271b885c56af8d6de187ee', title: locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '655c65eab09b4038793f4c5c414702c115009789', title: locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: '6b98b9098f2b270da509f896586627cf18cefe1e' }, this.data?.length === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, this.data?.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '3ece520d2ac53cfecbb024813454e96b85f5f1c8', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (h("ir-booking-details", { key: 'b786c14eb74560b499a18bbc7d7a94e3822ed353', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: 'a7aadbf54a44f28e05cf90528b7dbf3f2097a81a' }, h("div", { key: '69476395d2ba871cd3c848fce617791967983cf4', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: 'b7d6e758ae93307100836e234573a727655e5699', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: 'f7ae394092b4b22c9598474e6f8a1291c6ee8b27', name: "search", slot: "icon" }))), h("div", { key: '76e7e501aa44119d14c5be221e42a6db75af8048', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: '82bd3f748d97b5065eb1dc797cea53cdcf3d8929', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: '5fc283f55cd01d96700fa3a6f73246fe3e831da1', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), h("ir-button", { key: 'd883d7c2eb9b05e4d523ec53e81b0626c301b8d0', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
            }, btnStyle: { height: '100%' }, size: "sm", btn_disabled: !(hkTasksStore.selectedTasks.length > 0), text: 'Cleaned', ref: el => (this.btnRef = el) }), h("ir-button", { key: 'e47d39d8599947eba8e475e752fde4f0f4ea2f3a', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
