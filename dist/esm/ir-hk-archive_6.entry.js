...
const IrHkArchive = class {
    ...
    render() {
        return (h(Host, { key: '4b148734e4876aee615bfaa987630920f20cfb22' }, h("ir-title", { key: '110fca81a48b301d41ff208d85c58b226a3b7387', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '0b794a38e7dc724b666c05e55fe18431dd5ce69d', class: "px-1" }, h("div", { key: 'f5ec27504f94bcd58f75aa842657911aff631512', class: "d-flex" }, h("ir-select", { key: '79ffe2049296e6fe6043d7033ebb3c193a691f1a', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("ir-select", { key: '703dd4d0ed7f43eff447a270ffe422eeea12e0b1', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '45008dd35c5106360310d7b3117b6a6fe886f465', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: '945cee77d7e1158ef6430fffd9df6e54617e97f3', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: 'a96952ad6162e8762218ecd9c053639c2ca3cd97', title: locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '1c4d533bb8aa55ade58f2a55db4f144d3af79101', title: locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'a35cfc2fd96661fc8ccff8bd9fa3938a81098262' }, this.data?.length === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, this.data?.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '4d9e64f571a9a568a5f47b854ff378ea39d1b82c', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (h("ir-booking-details", { key: '33f75d240ef160bc7916ddf5f858fbae1d3064eb', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        return (h("div", { key: '22db431928f9090929657967a5ab8f7cd145b596', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: '8f22223b51770934dbe15449efc8610d6aefc942', class: "d-flex align-items-center justify-content-between" }, h("div", { key: 'f840eaee95a1fae9951506b1ab94c8433d2a6c12', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'fd360a4b5cf3519f7648a0ae5d58b1765326a2a2', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'cc3a7c4ed9ad86d6dd935ad8b46609db09cc3558', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: '3b2bf2918116cbb99f0d37a4a6f41668121e491b', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '8e462a8fc86d0b48da7a23dfbee5e54b6959aa97', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: 'ed5167f30217adbedcd36e4d33566d6aadf55ea7', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '7e183a8b07fc6aa85e3c815518c1efd845ce42ae', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: '6f68537ee3fba935536d8535e5c2a5fe078427cb', class: "pt-1" }, h("p", { key: '6b793c36f22ed931ae7845def55b314b194e8477', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: '7201d1eef306d628ce6870f5a489545c868b174c', testId: "period", selectedValue: this.filters?.cleaning_periods?.code, showFirstOption: false, data: housekeeping_store?.hk_criteria?.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: 'bd9593809103ce94e8740459d226541c36627c5b' }, h("p", { key: '2dd295e33a83ee53c65c5820b4feebc23667364e', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: 'd29149e01431a7af4dbeff3b9d12688a1a30820a', testId: "housekeepers", selectedValue: this.filters?.housekeepers, showFirstOption: false, data: [
            ...
            } }))), h("fieldset", { key: '376c9d10f632664b776b726b67632f46dacea089' }, h("p", { key: 'e2b84ff57402699914fedf3b8228a4e6657216ab', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), h("ir-select", { key: '6db4e93f60e7fd29bbdb544efe63f41c5b68bb84', testId: "dusty_units", showFirstOption: false, selectedValue: this.filters?.dusty_units?.code, data: housekeeping_store.hk_criteria?.dusty_periods?.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), h("fieldset", { key: 'a1d5a0ca24698409483a187d2ca594fcd6db4be6', class: "mb-1" }, h("p", { key: 'ace876d08d77484506eb40366a9c88b2e43cec61', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: 'bd0462040cbce79240b43a72953b3e2a24a64473', testId: "highlight_check_ins", selectedValue: this.filters?.highlight_check_ins?.code, showFirstOption: false, onSelectChange: e => {
                this.updateFilter({ highlight_check_ins: { code: e.detail } });
            }, data: housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => ({
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '76b769a7fdd57b9eff6a84811c2a711afbbd5feb', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: '248c5e7b5927099dfddbca529fb7ddaa6fe4094a', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: '67da0e8113729435f09251e493a9291b8aa00cf5', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: 'c18ff0e4283cd7ad7593b04f41637c626828247c' }, h("div", { key: '3710cb319fe4b987c05dedc6c4682029b0eb34be', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: '0bfaf38d100e09bf2a74bcf96b47bd1e3b7eaed1', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: 'a65d5d7dfbfa8690e3e00a93c4fb530762f6218a', name: "search", slot: "icon" }))), h("div", { key: 'f2b804754b8a0c8781b5da5d9924ce68a33173c8', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: 'af44b8cfc0d5795e1df18ce90a8fbb54bdbbdd8f', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: '4bf7339b1ef91ece62f8ae5baebf170697317510', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), h("ir-button", { key: '65d198fbf87fd2a245c88ce36b5c0b6670f0e97c', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
            }, btnStyle: { height: '100%' }, size: "sm", btn_disabled: !(hkTasksStore.selectedTasks.length > 0), text: 'Cleaned', ref: el => (this.btnRef = el) }), h("ir-button", { key: '20c6474696f0f83afa0cb0070ab34aff95beee49', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b5bf38dfbfeba214a298979a5524fd35363a4593' }, shouldLoadMore() && h("ir-button", { key: '0b0dee4754f93682540a9239ba7b81042f8ec0f3', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: 'f6608bc6bac8f9719ce2e670fd687c610720d774', showing: {
                from: start,
                to: end,
