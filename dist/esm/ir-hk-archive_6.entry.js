...
import { h as hooks, i as downloadFile } from './utils-b77baf9f.js';
...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'cbfd37b7b74c342ab7ae228d198e41479f7923cd' }, h("ir-title", { key: '954e891fbf15eafb824cf04b6ee0bfb50a1356c5', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '96b2374da38b3d96220ab70d73476fbbc2dbd1c0', class: "px-1" }, h("div", { key: 'abfe97def8ed4d13bc2360a623f5450ab4dbb776', class: "d-flex" }, h("ir-select", { key: '51367d905b794df118b589295a9b9b67b0896a30', class: "w-100", showFirstOption: false, data: [
            ...
            } }))), h("div", { key: 'a869f20f74f4cae3a9526e447cfe070ca37b6175', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: 'b4500ebb33e887267acbf384473baf9b993abd9f', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '81293d784e1973f3cb00fe15616960e654bf6bb3', title: (_h = locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '7e91c36215b3513416536b34694426d0c6fddd25', title: (_j = locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'd03ae4be71c2d608bba4c0a420c4bfc769e3f540' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '2e569e4655d86b7375931b8b9fe57938ab804205', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (h("ir-booking-details", { key: 'ff5b5d7de78d545326212a337f70ced6e5d0dc28', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: '3fe109aab51e8b823d14716055c72bb51fe7f3c1', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: 'ea0a6a2cb51fb3594868b41244a77532280c59be', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '6399192d4b41ac9fdd68a5dc335bcd556ebd9dd6', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'ccf5b65968c4142ceeb1b955f55b26932a30c1e6', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'b6065698adb7ffd403f4438d000244664f6e9fdd', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'd5273a5f4e6fe1cf56fadf84102a82006f32e122', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '907d88242d0ea26ac8ae1716315ef5cd55b16395', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: '81db81baed4b0df0e117ed0497450a44c832aa71', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '1757470f5c27d3ec50bd14bf4e581d540def739a', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'd44c0bb68f0dde5824b6044c096b51e6cb2d0742', class: "pt-1" }, h("p", { key: 'c73c2c46b724fc448ea360b3526172ee08df4cde', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: '520b0ca497758785f7167da44dc30db17a2b286f', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: '38a064d507f2de48c3d383dc70d2892fe079b2d4' }, h("p", { key: '1cb7e6024f6b97a9031e438b73a883e4fcadf9e6', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: '9beaf9c0ae417e0a8b68296d80d4e2d0d5f6ab0e', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, showFirstOption: false, data: [
            ...
            } })), h("fieldset", { key: '47f44440a877851ac6032b591f03b2033178d206', class: "mb-1" }, h("p", { key: 'ad99c0c288e5b361c3376dca00fb7bc2f909f08c', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: 'b78f8886e10c16b6454551822952436f60ecd8e2', testId: "highlight_check_ins", selectedValue: (_m = (_l = this.filters) === null || _l === void 0 ? void 0 : _l.highlight_check_ins) === null || _m === void 0 ? void 0 : _m.code, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: 'e9ea082662a00c6fb66c291468f44986501b7755', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: 'f28509531252cfd02fa95c04af3cf6b45d275b46', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: '86050821f9cc9136b3e6367294488f31159f0165', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: '897ceac304252e90a770d9c75775d2eef65fc96c' }, h("div", { key: 'c70b2758c528c1d52cd8f32a36f13d5280c42c90', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: 'a68f097ae804b697707fc81055b516b1abb7fb8e', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: '5441b2a28119fff272725d2784f503c958a4ff3d', name: "search", slot: "icon" }))), h("div", { key: '182a5104c3b36c7732b08d0847bc4b077c9fd3b9', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: 'e83ee0d0da033d10963438e920ae5e3536c54f41', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: 'e65ce857ed00957f485cc70d6f893837565d6c53', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), h("ir-button", { key: '3126f5c25293626a972c185fcb67604249c7ac5d', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
            }, btnStyle: { height: '100%' }, size: "sm", btn_disabled: !(hkTasksStore.selectedTasks.length > 0), text: 'Cleaned', ref: el => (this.btnRef = el) }), h("ir-button", { key: '3e2e8a7b676b89bf6bd8962f67baebb1c05cc76e', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '403b4b1597eb36592bf0d658799cef9da75db232' }, shouldLoadMore() && h("ir-button", { key: '839b3c1cc18938806a8438d978ca44d931813adb', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: 'e96ffdd30c4f4f454492e22e0d799ab14cf2d608', showing: {
                from: start,
                to: end,
