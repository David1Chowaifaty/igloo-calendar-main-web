...
import { y as downloadFile } from './utils-a6ca6bbf.js';
import { h as hooks } from './moment-ab846cee.js';
import { v as v4 } from './v4-964634d6.js';
import { t as toggleTaskSelection, h as hkTasksStore, d as updateSearchField, e as updateSorting, c as clearSelectedTasks, i as isAllTasksSelected, f as selectAllTasks, g as getCheckableTasks, j as getPaginatedTasks, k as getMobileTasks, l as updateCurrentPage, m as updatePageSize, n as shouldLoadMore, o as loadMoreTasks } from './hk-tasks.store-3425d428.js';
...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'da5f2f3c440aa04606283ec68237f906e0b581a1' }, h("ir-title", { key: 'cc45ed9fdec55516b0c23de7bed4f569b5b0cbc2', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '9c251f6aad249a885faee9aec2f0080681570018', class: "px-1" }, h("div", { key: '1714afe1b99eb3eef174d8b09255ad076bbf05ae', class: "d-flex" }, h("ir-select", { key: '2f00090d9a94aad230ca753ad631aa44454872e2', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), h("div", { key: '30778786270f4666a4527e90cc4065e8265523ad', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: '0ae2f5921f320ce3f26538ade3f8c4fd1d1a2535', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: 'af07cdd428f66fa6dee1cb403b186695a4de7cef', title: (_h = locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '0741f22655f08b0c78b1c3d432f5bc2725bdcbeb', title: (_j = locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: '512a2b8d1152eafdf9cc370fd37b7263d77b926c' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: '895464bc6c01d33abe6c952c831a2356af9f6e0f' }, h("div", { key: 'd65a313ac165105cf69ebef18ce8e26aaad6f4d2', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: '34001001acabe7c1eb421bf4a6276b32038882af', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: 'e537af37d03fb25c529a8fe141991e177b9ddc0f', name: "search", slot: "icon" }))), h("div", { key: '4f28d0d83b28b3b39db0ef917526e424db7380c3', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: '1a33e7fd8b0747713d43f25aa8132c540300b673', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: '4028765353278ff1b928864d9c09e0b8a280a8c2', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
