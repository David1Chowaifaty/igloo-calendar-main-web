...
import { H as downloadFile } from './utils-5036fcd3.js';
...
const IrHkArchive = class {
    ...
    render() {
        return (h(Host, { key: 'b4825a3a316aa790f65cbe4693931d4a69a8b5d3' }, h("ir-title", { key: 'ed64aaa081eeb8fcc2d973f7be8814567f8d0ee9', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: 'bf06e75a0ac8646e0a39eaea7175d04b926c5773', class: "px-1" }, h("div", { key: '1a8d71cf50d2d78e73175554cb30c0b1e8961906', class: "d-flex" }, h("ir-select", { key: '7d26215c8522bd59cbc38af9da27175f7eace18b', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("ir-select", { key: 'dc9c98813790ca7135c8e5c731106859d2637eae', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '5a9b8b503e45217d2c57a91d0e52e74b4c89da69', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: '2ca473fea48f65478119a2347a3362b62258d915', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '7bd7ccac1ddba1cc2ad19067953e602c85b108a3', title: locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: 'b395748969b7ea47076d46f15ae98d96579ed638', title: locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'ee64f70766ff8060d0dc6a1d6361996c79d8cbdd' }, this.data?.length === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, this.data?.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '234d9c5b7de451fec494c603e5d3a3969b730b4a', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (h("ir-booking-details", { key: '4df6610aac39337bcf441a3379d89e89b3b7baed', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        return (h("div", { key: 'f50fef1e78a5c5fda5472bac78db4a83ff4554f3', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: 'ebec303a34b46a990d682e83b312b50249b88c42', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '2abc2e0336bc7ec8d9f06c8b7ad277027ca33520', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'f68c03cf0e8e72d6ed6da32ba32aa8b8f2b8fb8f', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '61b2d1cd2144c1f62a5637862b1916eebe142522', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'dce0a67a18f707413f01861a13fd6a4a2be40996', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '4e909836c6c7ce1366bd8f05871987ba1a8c13fc', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: '571d282fa3e834171914a9d3785af51e15076074', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '2df9c42675ff9a5a0ed5131fdc0c1318c1fbb74d', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: '669a7124ae04adfe16574b6c4fbdde92232c77e5', class: "pt-1" }, h("p", { key: '82f5b46fc967f5d3dd95216f49347f0faa98e81b', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: '0aa67e15e8d8ef247e29423e7f5b3b7f699e9369', testId: "period", selectedValue: this.filters?.cleaning_periods?.code, showFirstOption: false, data: housekeeping_store?.hk_criteria?.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: 'b19153bc903ad5a44d097dc387ea506a6c3646f8' }, h("p", { key: '8f2c3b69d035722ea5b1d2afda35e7405117eea2', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: '791901ea382aec34a149161437cd407a5ac66b3b', testId: "housekeepers", selectedValue: this.filters?.housekeepers, showFirstOption: false, data: [
            ...
            } }))), h("fieldset", { key: 'b7457cc3fb4838c0ad31b443b693fa030d628f56' }, h("p", { key: '223ea77bdef6ab252a5e6a1b5e34d63e31da3720', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), h("ir-select", { key: 'f622e07c654e7d1c64028a6f44c2c62459570db7', testId: "dusty_units", showFirstOption: false, selectedValue: this.filters?.dusty_units?.code, data: housekeeping_store.hk_criteria?.dusty_periods?.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), h("fieldset", { key: '000ca1ac1cd703c090055d679e5cf08aec978b5f', class: "mb-1" }, h("p", { key: 'd8e11b59ebf8dbd8021bd662f211f5934877836d', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: '1dffd11521d3a5957aad1545f41e35919f766def', testId: "highlight_check_ins", selectedValue: this.filters?.highlight_check_ins?.code, showFirstOption: false, onSelectChange: e => {
                this.updateFilter({ highlight_check_ins: { code: e.detail } });
            }, data: housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => ({
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '120ce92c13e70ea8634e7fa693f1e7170da927d0', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: 'de0cc7be67577a429516991562c7f186745d2ec0', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: 'a8afadc5ef028312fd99541dab3aa9adc3ad0a63', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: 'ee42fd5c77e1d3bf5c3d0f200b520a67f5cb0765' }, h("div", { key: '1e2181703efe993780b6d567d2d5047429dc59d3', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: 'f92f7715f36b37cc3b06d9dd119fb9d5bcab067a', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: '6f57416363bd1049c39669137d0ddb7ac48598d9', name: "search", slot: "icon" }))), h("div", { key: '0d30851134b472cc316222c76dea74101e0c7e87', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: '9542e536a5c9530952cb379fd78c6771c6ee9a94', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: '151f76347cde3532509ec59bf5a40cec72250645', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), h("ir-button", { key: '5271bfa8d930271e39360d4219a308fa58ee28ce', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
            }, btnStyle: { height: '100%' }, size: "sm", btn_disabled: !(hkTasksStore.selectedTasks.length > 0), text: 'Cleaned', ref: el => (this.btnRef = el) }), h("ir-button", { key: '898d100945d04adb455a43e1eebe397d957be150', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
