...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1f9458fcc615608fd6c9fafa8d7e79f1c5da9721' }, h("ir-title", { key: '403b946f6954aedd56dde62ef37d498b34ec8b33', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: 'ec3c986751ea378911cba67945bc5be3e1a93a17', class: "px-1" }, h("div", { key: '47b8ac29a27b46ce97f0d82ca3cbe6bf9b3bfd5f', class: "d-flex" }, h("ir-select", { key: 'df22778ca68ddb7cbf7d41510a2b8fbad9ea8370', class: "w-100", showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '8b238f75bb343089ac3be27d3f3592c27848a9ba', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: 'e26b901cf3ddb73bf15a673f624d1cfc563bf8c6', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '02179afa4e0a10f343148462081d2b7f79df8da4', title: (_h = locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: 'dd89fd1aedbf795a5bec6cd1b357341b9ac37fae', title: (_j = locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'b1ea13262936ca2235b8f2a3bddaa4c5469c47ac' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '0c0d27818c49c36badb32c2e657e28f949fe4920', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (h("ir-booking-details", { key: '5a2d58e5e9773dc5efdadfb13f71ffd18f263042', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: '43a9b6b0d3e9a94f970e624bc6fc126ae2bbabe2', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: '6348a525d13fecd2ffada06eb5545c1c2cae33df', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '2a8f6e50a13cbd4f2e77be844bbb3926638216bb', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: '6222a0afcca44f705e4f6430a3189ea0c1f85bcf', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'f12983b49a1cf6b75e1f2bc6cb7a7f4542a2a582', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: '153bc7263e915bda613bc59c174a48bf5bea7d8a', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '02506f307cf45d0d006299dd8b0245b2ed62edca', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: 'f1ccecb67bdafa162ee3218e72455d5cf804b50b', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '238f5c569840aafa960b3ccf2257c355ab5e9e73', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'e2363233ad46301edf7adaeb6cf69ce70001e6f3', class: "pt-1" }, h("p", { key: 'baa9865653c1cca12a0d494a372282989ad1ea35', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: '998be638bbb302cde4a6287e608f40289f66c859', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: '0c36130fcc18cd8d49787b47cf20b8c175e849d4' }, h("p", { key: '123e2b188b51c7d4065c73d978c911d54e91949a', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: '98b5ac13fa5cc5d4c2105585c61b72173f68d779', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, showFirstOption: false, data: [
            ...
            } }))), h("fieldset", { key: '88db773aaf28d22c2f553bb678be0f4d7adab4f2' }, h("p", { key: '8f23ddab9f93199d9067606ba8d00c8121b09cf5', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), h("ir-select", { key: 'ef4658c61d0ddf4e46d7f526a8f938c8e5427995', testId: "dusty_units", showFirstOption: false, selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.dusty_units) === null || _h === void 0 ? void 0 : _h.code, data: (_k = (_j = housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.dusty_periods) === null || _k === void 0 ? void 0 : _k.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: 'd852097e2981627e60687cf76b3b7d62e656cddc', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: 'd5c583dcb2a9721b24543f4ae7389cc17d0de4d7', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: '8f851e0eefc96c212a9d1cf9efda0b9523ea21cf', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: 'f04910b2fb9aff20d8f0c6d3f7134f35986f2705' }, h("div", { key: '2fefc91ef06ee8db19c1c6be59528811d20eef08', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input-text", { key: 'faa06095357acd4b907d452d7143fb0a723ef88d', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, h("ir-icons", { key: '0d756302abf2b64833ef57d870d700885bdb4d93', name: "search", slot: "icon" }))), h("div", { key: '9c14dd87ac67f069ac3d79f87d9df065c2e8a3c0', class: "action-buttons", style: { gap: '1rem' } }, h("ir-button", { key: '46ce7b5551214d1122583305cbb1e4be6fe6edcd', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), h("ir-button", { key: '23e218213e77158de74561342f08c835f2056b38', size: "sm", btn_color: "outline", text: locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), h("ir-button", { key: '161d9d8e3494f7c8c795e9d1031ea33227f38a57', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
            }, btnStyle: { height: '100%' }, size: "sm", btn_disabled: !(hkTasksStore.selectedTasks.length > 0), text: 'Cleaned', ref: el => (this.btnRef = el) }), h("ir-button", { key: '7b92635a45e7acea011ec3a6a2638359a789d504', class: "clean-button", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'a02c755a84c6b4c488bc81fafc0fe8ce9e73e305' }, shouldLoadMore() && h("ir-button", { key: '676d93b7b497ed72339b6125360e3ff53c0c3769', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: 'c2d4ed99fb39d1b87fde668765dbcd008fdee549', showing: {
                from: start,
                to: end,
