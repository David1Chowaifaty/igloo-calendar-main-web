...
const IrHkArchive = class {
    ...
    render() {
        return (h(Host, { key: '5d95265cce0a6199c8aff002c4bf31e74cb035a5' }, h("ir-title", { key: 'ff4d205ad0f119d9cc955953d57a6fefe6543ac1', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: 'e16125bb4c589c5b21a15e7e256dab631ab2d80e', class: "px-1" }, h("div", { key: '9b1a8d538176fb2bdc2fd5f748fcadd1691ce250', class: "d-flex" }, h("ir-select", { key: '4c2e8296abc5235f5433b5b3d07264f8256fd2c7', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("ir-select", { key: '38d4bc09ad948e0e0fd2f7615e4df75bcf5953ff', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '708e3705db39e2098ec037965d11ab94123db314', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: 'fb6a07577717156cd71cc058649d680357578fae', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: 'ea7857a2fc7af703b272bd3d8c88dc37a52b66c4', title: locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '65b96264796d0fad369cf7206bd1c250d547d57b', title: locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'c97f8bef7923d2a6a9b266ae66709cb44cfafbcb' }, this.data?.length === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, this.data?.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales.entries.Lcz_WasVacant))))))))))), h("ir-sidebar", { key: '7dbc7cd507a74874ef1eb5f472a67e2ce04afb49', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: 'var(--ir-color-muted-background,#f2f3f8)',
            } }, this.selectedBooking && (h("ir-booking-details", { key: '2b10fddbfec9e04b241afea4dc7ab392a40ee96e', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksCard = class {
    ...
    render() {
        return (h("wa-card", { key: '0f7304cd1ff31c514a2b3202dd6c1b592e6fe31b', class: "task-card" }, h("div", { key: '5d86e5870234fefa297d1ce41ea6171bf9fadb93', class: "task-card__body" }, h("div", { key: '5e1bb41d4614d85e02be199aee9179b72b3654fc', class: "task-card__unit" }, h("span", { key: '57d395657b6f56381b6478a067797e529b0bfb0e', class: "task-card__unit-name" }, this.task.unit.name), h("div", { key: '56576dfeff8872cf03a0a5c4c65273e7e6f9007d', class: "task-card__meta" }, h("span", { key: '97a74444c5a24d3801b91d05c24be0bd74f623d1', class: "task-card__status" }, this.task.status.description), this.task.hint && h("span", { key: 'fec022cd47f3aa887482c4c82c92cdced079a5d3', class: "task-card__sep" }, "\u00B7"), this.task.hint && h("span", { key: 'e29619d1a08c3e98a99fe8c5590776db856a6604', class: "task-card__hint" }, this.task.hint))), h("div", { key: '42f5287acad1485743906e8c1c1bb83d3ba850d9', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (h("div", { key: '9339d1051b60a7501133f2240a82af6655362a0b', class: "task-card__guests" }, this.guests.map(g => (h("div", { class: "task-card__guest" }, h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), h("span", { class: "task-card__guest-count" }, g.count)))))), h("div", { key: '88309bf35f0c89dea0492a90bfc015b97ab23ae4', class: "task-card__assign" }, h("wa-select", { key: 'c973d4c0b33b0e9a01c5f015a912056ab7a14d6a', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, h("wa-option", { key: '37a0e4f06a5a35847b6b6dff50733eef97ad8cb6', value: "0" }, locales.entries.Lcz_Unassigned), housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), h("div", { key: '427fcd1cb427687d568c43609c6f8e356d2f0bfe', class: "task-card__actions" }, this.isSkippable && (h("ir-custom-button", { key: 'ed933f1cc24fb72a8e0a9a665a80f1cd98fe4742', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (h("div", { key: 'cb3663c6b702c1432fdfafb2aac3153f5250c127', class: "task-card__clean-group" }, h("ir-custom-button", { key: 'ba1441ec0a9efbbb9739df9c78b0f8b92dc317a5', variant: "brand", appearance: "filled", onClickHandler: () => {
                toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), h("ir-custom-button", { key: '0aa3266c970e8ced563e5ffbbd6956ed22ebc937', variant: "brand", appearance: "accent", onClickHandler: () => {
                toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (h("wa-card", { key: 'f6f609dc1cc1a45c8b1d067b0b39d333ef080ccb', class: `filters__card ${this.collapsed ? '--collapsed' : ''}` }, h("div", { key: 'ec0d04fc84a627b5cba044d8c3358808bcf696cb', class: "filters__header", slot: "header" }, h("div", { key: 'be27c5e943476f03802135f34c2af1d543c25cf4', class: "filters__title-group" }, h("wa-icon", { key: '414075f5cbf0aa0bba2a6f065f9fc9819adb7537', name: "filter", style: { fontSize: '1rem' } }), h("h4", { key: '3d98210363750e8c488365dd7dcb5e03fb2ca26d', class: "filters__title" }, locales.entries.Lcz_Filters)), h("ir-custom-button", { key: 'a594c6b6768b6c5c5b419f3fcd50e737ae8985ae', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '1ec63ee6df2b0150ea32b7a5cbb4915eef7979b0', style: { fontSize: '1rem' }, name: !this.collapsed ? 'eye-slash' : 'eye' }))), h("div", { key: '178005223dbfa70b6c7ca54cd24a254a204d332e', class: `filters__body${this.collapsed ? ' filters__body--collapsed' : ''}`, id: "hkTasksFiltersCollapse" }, h("fieldset", { key: '2fdb5725cce9133e097b12e1e66e5c55f5af631e' }, h("wa-select", { key: '3c1bfb6cd0f7bdbb804d24666a353b8427a48401', label: locales.entries.Lcz_Period, size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (h("fieldset", { key: '208cc56b089e91b4db05edfae75cc79f3ea3a13b' }, h("wa-select", { key: '453ab984ec5bd3b4d515a8d0435b5f312cca0542', label: locales.entries.Lcz_Housekeepers, size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, h("wa-option", { key: '93b885f7e5a3dfc12dced97effd5fa05cfa36811', value: "000" }, locales.entries.Lcz_Allhousekeepers), housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), h("fieldset", { key: '521dde29587790ba66dedef3f099d40c75dfe461' }, h("wa-select", { key: '4d801c1efef518941de3e7c3ee69988e0d5f9796', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.dusty_periods?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("fieldset", { key: 'f62fe3b108dc78bcedbebd0648f33d796af59d21' }, h("wa-select", { key: '6b76d275922517fe57df2dff03ffd629ee9eb018', label: locales.entries['Lcz_HighlightCheck-insFrom'], size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (h("wa-option", { key: v.code, value: v.code }, v.description))))), h("div", { key: 'f854ba1152cbecd4f37b717bf5e9769e8114fb1b', class: "filters__actions" }, h("ir-custom-button", { key: 'd4caaf6b0d14b8cbc8c597164517cb521bd2eb7a', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales.entries.Lcz_Reset), h("ir-custom-button", { key: '2d04f22219e2e95b1a7c6b4005770e62c25e4e09', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales.entries.Lcz_Apply)))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (h(Host, { key: '96616de11d5acf48aa2494e9d1cf9aeeeab2f569' }, h("div", { key: '34818faf8602604b4a9fd77c70ea5441b9423136', class: "search-filter-container", style: { gap: '1rem' } }, h("ir-input", { key: '5518609614a915f8b569aaa77221bbaeeffbab19', placeholder: "Search unit", class: "search-filter-input", value: hkTasksStore.searchField, "onText-change": e => updateSearchField(e.detail) }, h("wa-icon", { key: '0e17f067c5bb82deb8715e62410991f0cece686c', name: "magnifying-glass", slot: "start" }))), h("div", { key: 'b4d0f5be45c2ffc2aefae1c0c2ccd64cf8cc65c6', class: "action-buttons", style: { gap: '1rem' } }, h("ir-custom-button", { key: 'b7b188212735728c1f88196bab6bbdf552201882', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, h("wa-icon", { key: 'a9bf600f9d284f10d9785a6c6401b7b0c038ee65', slot: "end", name: "file-excel" }), locales.entries.Lcz_Export), h("ir-custom-button", { key: 'c976fa1993ec29c9efab4f832c332a5488388868', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, locales.entries.Lcz_Archives), h("wa-animation", { key: '468d12e9c09ff75927c1c63c67e119696c856783', iterations: 1, id: "cleanInspectAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, h("ir-custom-button", { key: '79ae96f0d827bc56c6c58f30b83eb6e6cf3e90ec', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), h("wa-animation", { key: '55992710a8f84873eeae14b13fc8defadfa84f06', iterations: 1, id: "cleanAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, h("ir-custom-button", { key: '7c36469eccb88bce3dad9d447c8c8d9151de58fc', disabled: !(hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        })))), h("div", { key: 'efda949cf7f1edbcddde8e6068728ac062352caa', class: "data-table--pagination " }, h("ir-tasks-table-pagination", { key: 'e6201dae763918a6afa310e241412c64f0cf64d5' }))), h("ir-dialog", { key: 'c5764cc041f2efa4ab092aaf91b2620e2258c983', ref: el => (this.dialog = el), label: locales.entries.Lcz_Confirmation, lightDismiss: false }, h("span", { key: '09a0d26df94d3e09155957b4afcb7e2fd2fd35f3' }, locales.entries.Lcz_Assign, " ", h("strong", { key: '863b575a57056d76b611cc55befee620b3130791' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", h("strong", { key: '4aeea0401ec1e3648b8d30f25c66ea06556c0e83' }, pendingHkName), "?"), h("div", { key: '29045d513413812b83224f1d5cfafa4d51405676', slot: "footer", class: "hk-dialog-footer" }, h("ir-custom-button", { key: '07bbdb970bad7e05770fd902879819af6e92cec3', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'ff1e90eace28c64c5bee5633c0a2feca42db1aba', size: "m", appearance: "accent", variant: "brand", loading: isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales.entries.Lcz_Confirm)))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'd036ca06c34ae46d50ac08905d98025bbe2af13d' }, shouldLoadMore() && h("ir-button", { key: 'baf65bd358e5ec294b8a5371077e18318135d96f', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '7b69f4ad82b1481a8cebaf975c9cf5fafc027acd', showing: {
                from: start,
                to: end,
