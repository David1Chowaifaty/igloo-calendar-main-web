...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: '1d8b0a1fd1da758ce627bb9967cc01f95b09804a', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: 'e14e62e17dd3dfa1e5bfcef7ffd7a3383e8b6ec5', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '5c5bafd781f684305895a80b3cd6adf024b3be09', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'a653bdf98a2a94780a91b0fc997c96bf1cdd52fe', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'ec9a31abf01895a2cd6e85a48ac4713fa9c14a30', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'b8dc10fa23205472a33b9e2c5f17cfae852987c1', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: 'a30f2ffe4d1cd722ab3e0356bf2d85711c7d0773', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: '1b4e9bcfe41d6b7b16b385616fd2d679241d0a16', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: 'af3d36e3f4dcc272851755d550a56ced44903d2e', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: '167978e0fd3a85eddc413ccf8f9bb063dac7e699', class: "pt-1" }, h("p", { key: '4f36ca5c54cd3a111d246ddaeba5b96b790cd4a7', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: '4b2f632c75228ecacceb9b0acde94fcfe38e64ee', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: '8ad97775b12f002b7839bb8dc5d07fd9f0b749f4' }, h("p", { key: 'b014e57c8b37eead76d8f494cfce55ae7dfe0fb7', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: 'b624927d2fb648220009f32ccd6a8b72f0a0ca04', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } })), h("fieldset", { key: '2114c37e36204a685462ee64f3f49dacc048e0f6', class: "mb-1" }, h("p", { key: 'd673b9faa3db35707fe0beafb916ab074e4f5d12', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: '5a84f832077e1c8bc5fd1864e030f2c136563883', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '3b83cbe3f8d7d8b8f038efa20961d201e3f73d55', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: '7dbccb6bf59cb379f5a490b184116626bd51e15f', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: 'ffd57c990031e47af39bf2a658868fb5921e6c06', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8c1a1b77d5162e779a64d42b5ea321f29ab3a410' }, shouldLoadMore() && h("ir-button", { key: 'acf9c5e56a94c146173cd971d225de5e3fcf04d9', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '0f97f8b3cde90d3cfc65d1c0f04ae3a7669ce70a', showing: {
                from: start,
                to: end,
