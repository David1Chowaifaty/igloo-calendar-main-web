...
import { B as downloadFile } from './utils-763db862.js';
...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4ba5b9d7ad16b1967e16e76ed9ba0ab6dfb89c57' }, h("ir-title", { key: 'f8b7eff20ebe20bf98c68451a7758c77e8b084f1', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: 'b042632974e22107faeb1c3516c8f44dbc3924e6', class: "px-1" }, h("div", { key: '181b4500e96976bad4e22ccad7f0edb1c85fc0f4', class: "d-flex" }, h("ir-select", { key: 'b7f3c624d4cb8a5d744540a4a2bd166e869c5223', class: "w-100", showFirstOption: false, data: [
            ...
            } }))), h("div", { key: '24f6488c54cb6698ceedc85aac4b1f61f2cc8911', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: 'd7ac2094d5a87d9f5a4151417586f3a07d59467b', maxDate: hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '61d61fad8d1283aa3b61ddb2b6b82b17ac8988bb', title: (_h = locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '218bb4e0e7b054aa3ef76b58371709b317353015', title: (_j = locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'd4cbe7c79f6c3f8391e5b0a0944fbb06c7d73f80' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, locales.entries.Lcz_NoResultsFound)) : (h("table", { class: "mt-2 table" }, h("thead", null, h("th", { class: "pl-0" }, locales.entries.Lcz_Period), h("th", null, locales.entries.Lcz_Housekeeper), h("th", null, locales.entries.Lcz_Unit), h("th", null, locales.entries.Lcz_BookingNumber)), h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (h("tr", { key: d.id }, h("td", { class: "pl-0" }, d.date), h("td", null, d.house_keeper), h("td", null, h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", null, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: 'ff26946feb4e44bc273c28f13e57a97b94db11dc', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: '8c7b5d63f2c476d409791796f9604bccea9d7805', class: "d-flex align-items-center justify-content-between" }, h("div", { key: 'c843ee2ea3380cf4f0a1cf28b2161c6c214974aa', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: '59c8dc2ceea8c9d9f331313692f93a5a575b9e34', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '682b13c0bb7253a2012afffb5bf3d95366f9c42d', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: '0707c049cb0b3a1e2ba80f4bcdbf7c36a1184c0d', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: 'e7ececa28a0e0d3b91a054e84484dee055002c6e', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: 'c2eed769c5d32286586c520b55b6b5a597c73f3a', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '22fc356f1b581e1e1ed950a30def2009648d1300', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'b9ebb74876ccb931deb02d896834a5a8295ced93', class: "pt-1" }, h("p", { key: 'b44f93827bd4233c96d991b7b4a1d90376fea267', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Period), h("ir-select", { key: 'd028352e3cf909a27fbe9a56f657a2d586f76471', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: 'c56eb827f74534a844750af0350283754fa3c5d8' }, h("p", { key: '195da88e270250f4e0ea9824f45aff6ebca2f494', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: 'a6f2b24044bc565573d53044a8dbcc4b0085b7bc', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, showFirstOption: false, data: [
            ...
            } }))), h("fieldset", { key: 'c54e9ea0e0ab41be5eee2ef0f0c366b1c64bf05e' }, h("p", { key: 'ceca89d647221c02cc54347f59b20407fc881cdb', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), h("ir-select", { key: '2f4c051d10e794d26e7ce484e7cbef2b0b44a8bb', testId: "dusty_units", showFirstOption: false, selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.dusty_units) === null || _h === void 0 ? void 0 : _h.code, data: (_k = (_j = housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.dusty_periods) === null || _k === void 0 ? void 0 : _k.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), h("fieldset", { key: 'db865187edb750efcaeb7cc0bf8d76937ac3abc4', class: "mb-1" }, h("p", { key: '127ab11612efe6678e8d8c6ed82331797b349a75', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: '3f9294789f0fcbd5dbf0f4573a25dcd65c27f7df', testId: "highlight_check_ins", selectedValue: (_m = (_l = this.filters) === null || _l === void 0 ? void 0 : _l.highlight_check_ins) === null || _m === void 0 ? void 0 : _m.code, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: '764a6e0b1fa62cc65c147b17868707f521a60900', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: 'c5e32335cbd751d814f0af78a782d417acb09e55', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: 'ff6a05ca4113d3a34ce74f6b80b830f60d49b977', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e3cb1ee66f9b4594feeaa6bacce4af5826dfba41' }, shouldLoadMore() && h("ir-button", { key: '886b07a6042867a3a009f124792254d3df125591', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '3d2f7ee668b6ae9ed0d096f3cd2479506ea2b4b0', showing: {
                from: start,
                to: end,
