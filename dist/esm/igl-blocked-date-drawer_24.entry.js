import { r as registerInstance, c as createEvent, h, d as getElement, F as Fragment, H as Host } from './index-CaNXuIlM.js';
import { B as BookingService, b as booking_store, r as resetBookingStore } from './booking.store-BSXTA32t.js';
import { g as getReleaseHoursString, n as isBlockUnit, k as showToast, f as checkMealPlan, i as formatAmount, B as isWeekend, d as dateToFormattedString, r as getDaysArray, u as formatDate } from './utils-B2NKY4In.js';
import { f as buildSplitIndex, h as getSplitRole, c as calculateDaysBetweenDates, t as transformNewBooking, e as calendar_dates, a as compareTime, b as createDateWithOffsetAndHour } from './booking-BiUlDCdX.js';
...
import { h as handleUnAssignedDatesChange, g as getUnassignedDates } from './unassigned_dates.store-DOIBwaGz.js';
import { H as HouseKeepingService } from './housekeeping.service-2l2-GvU5.js';
import { P as PropertyService, E as ExposedRectifierParamsSchema } from './index-2-rjONyV.js';
...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'd4c35979969d440d106e773d775eec6ee19e3b20', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (h("igl-block-dates-view", { key: '91abf5ba4ee641e7af1fb0b9e2737192ec8c194a', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), h("div", { key: '6698a9123fce2a28ff449ffb8b3ee48bdeae3332', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '2cdd14e0c1a23ac59130408ffd3177bc1c178865', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), h("ir-custom-button", { key: '6b2ce4eedef6174cdef421933a8f7d980b1c4547', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c500772274ff279c00a1a8242d0a04bb186a981a', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, h("div", { key: 'c35ee3821ea120e48b00149680fb169990dcc29f', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), h("div", { key: '680855279dd06aaa54cda17beea1567b0a3c1dfd', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglCalFooter = class {
    ...
    render() {
        return (h(Host, { key: 'f3a01a1d5e010b2dd9b80dea2f629e3c3717d46c', class: "footerContainer" }, h("div", { key: '923632aef349d89eba396ed74004eacd11f35d8c', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, h("button", { key: '5ee89dac2d3d25aab654b6e5db946ef02859b751', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), h("span", { key: '7f4b49572a8a0131ad9213f12da3d1ff6ea93263' }, locales.entries.Lcz_Legend), h("span", { key: '93406855e7e29ff313d51b42bfb1816bf966afbe' }, "v1.59"))), this.calendarData.days.map(dayInfo => (h("div", { class: "footerCell align-items-center" }, h("div", { class: {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: '55b3255dbd12f4f0119f3fbbf24df19e6936347e', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), h("div", { key: '2103d3b3f5aeab94b9c2e099278e4a3fec50e45a', slot: "footer", class: "dialog-footer" }, h("ir-custom-button", { key: 'd6b2c6ddba1699868fda158305c883a445326a8c', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), h("ir-custom-button", { key: '219e92aa96426feed94799c3224fb61db83ddf0a', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2aa46e01b6c8f7c2fea7159cc1c61ab78086a77a' }, h("div", { key: '42d9564372d6136d2501388bccead77d0d4f39c6', class: "tba-panel" }, h("div", { key: '1c0597dce0a4831b727bc1cc1cb84e50b3d60252', class: "tba-panel__head" }, h("header", { key: 'e35ed7af52bb74bc7c7ab930942f0bac9f26135b', class: "tba-panel__header" }, h("h2", { key: 'a1f9c3ab243fb16fdc5073fdd8d502c0bff37b26', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: '0480b9d429d0e3a85ae2495e23410ebb997101d2', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: 'c06346952cc2d335d18139b46f8369af49ba62f8', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: 'b73470e43cb708a12eb350d3d3e411869c9cb14a', class: "tba-panel__toolbar" }, h("wa-select", { key: '945fbf7d2442532b06a432927e7938348a5a3d17', size: "s", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: '2956992fb4a7dc2373c7c8025b4497003fc6a7b7', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '1a93bb5acbed7053825d05d70f06dca0d335cdaa', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '5b107a88705e0dee51092a0d97eca5a23b06bcd8', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '0d42eabebbaa2ed0e15b8688d7a05d5ad2d3cf22', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '4eddf53ed577f6e88929ece929ed602b1d5df358', class: `ir-alert-header` }, h("p", { key: 'ff3a3323b619331df590bb86b3ec465243a6286c' }, this.modalTitle))), h("div", { key: '3e1199e462bb32cfa0883b929ad0f2256ac0ce3d', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '14417d06cff2d934ed70fe6fe99c684470e66abe' }, this.modalBody)), h("div", { key: 'bce4c6f9b632190d2b1c41e1645479890a7590b6', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '5626e78f57e0ba6a9839e23918b4e0b17c38e45e', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: '571184afd1ad9d8036635c82d5f782ed7993608e', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '9ec4091cba252874dceeb7f35297eea92e321b98', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (h("div", { key: 'e5f235d0d71844f2d2962a5c62f55f0f163f4cdb', class: "input-group" }, h("label", { key: '625fd5f1b1aeb2d9c095f96f5a954ef564ad6b16', class: "check-container radio-container align-items-center m-0 py-0" }, h("span", { key: 'aee258a56e0c4857b57d98cecc3975b6764803a7' }, this.label), h("input", { key: '1d870b05d42740dad115dd100a8b418814fe5d79', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), h("span", { key: '14b488e1df580104d51793e7bd63d2fb4dd3926f', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (h(Host, { key: '3e02dabded131d5813c8656c96fc33af02e9ab6d' }, h("form", { key: 'a03341e7705e0e959b70f82f2e75555174ffb29d', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, h("wa-callout", { key: '5cc3aa4fb6bfb91f492ac5b75856efa6e54eaa20', size: "s", appearance: "filled", variant: "warning" }, h("wa-icon", { key: 'aa551b24d36369aaee8e6799ceb9b961fe874606', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the selected room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), h("div", { key: 'a69d04698320820c1a730627af941e41581948a5', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && h("p", { key: '58fb747efef24026d304be541b712800f53e9aff', class: "text-danger m-0" }, "Please select at least one room type."), h("div", { key: '9167439ef85a6f279d2a742edb053894a14fea0c', class: "ir-rectifier__date-range" }, h("ir-validator", { key: '0df727bbe23c44e917e140af3813ecc54e5db07b', value: this.form.from ?? null, schema: ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, h("ir-date-select", { key: '3d8a8958cb3c402b1eafd4a130bfeaff533722ae', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), h("ir-validator", { key: 'c9ae649d40a9e3ac1eac1713219446a128fca153', value: this.form.to ?? null, schema: ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, h("ir-date-select", { key: '9aacf8a4da4f7406cb44715848d39791b30a3486', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
