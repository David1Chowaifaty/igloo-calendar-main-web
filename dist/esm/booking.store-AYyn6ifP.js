...
import { e as extras, q as convertDateToTime, r as convertDateToCustomFormat, b as dateToFormattedString } from './utils-CKFOUZvS.js';
import { g as getMyBookings, a as calculateDaysBetweenDates } from './booking-CwfPgjWM.js';
...
/* INVOICE TYPES */
const GetBookingInvoiceInfoPropsSchema = LanguageSchema.extend({
    booking_nbr: stringType().optional(),
});
...
const DoDayUseParamsSchema = LanguageSchema.extend({
