...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory } from './booking.service-f82069d7.js';
import { l as locales } from './locales.store-53ec3957.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-20e9d53b.js';
import { f as formatAmount, e as extras, h as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, a as getPrivateNote, b as downloadFile, t as toFloat, r as renderTime, i as formatName } from './utils-0dcc1bf1.js';
...
const IglBookingForm = class {
    ...
    render() {
        return (h("div", { key: '0e978fde39721ebee67e697a492fe20eb26a948e', class: "d-flex flex-column h-100" }, h("div", { key: 'd534816c178ab97aa4a15608072058b520c828e2', class: "d-flex flex-wrap" }, h("ir-date-view", { key: '66c6cb9fb2f8b8deedd00d69bdd662c668113e77', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (h("div", { key: 'fe4dbbb12e0d4a88dc6a49f79377dbbb588d3116', class: "mt-1 mt-md-0 text-right" }, locales.entries.Lcz_TotalPrice, " ", h("span", { key: '25a28d58ca85dd16d93d310d21e085975175dc68', class: "font-weight-bold font-medium-1" }, formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'be492e6c9a3fc35706815b98d6232e174efbddc4' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && h("div", { key: 'aea078d3673889f259f130ea037c4452daa4de55', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: 'd50341cb527e068998d7ba71315cf191e749b4fd' }, h("div", { key: '1515907cc1469896669ce87bce27cae52046a2d6', class: 'd-flex align-items-center ' }, h("label", { key: 'd858b59702183460afe8115d8eec1cd75dc68c92', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: 'e1056b5b56844bc5b5aae124efaf0befb7cd04c8', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: '0d2c0154132e158743acb3493c1a6d090dd7dfa9', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: 'ae36b3afb598ef08f8e491756ffb769e98febc48', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: '7412e2ce627603b3ca20fcaf8e5476e0d8e1adac', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: '5bced852afcdd894e6154a6f549cd63c9bbc82a9', class: 'sr-only' }, "clear input"), h("svg", { key: '4bbb63478459aea9f506f8accb24e2aacfc58ca2', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'ca11d611ab2d7f71a73611fc8719c35f74049170', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (h("form", { key: '0ae74f2d552331e118db7067d6f856886a2e52b1', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, h("ir-title", { key: 'cbdab6856fb65d9f8ce831015c8a4431b0f7c9ad', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), h("div", { key: 'e8c26ff8135b8805ccee241476a3ddebcba9c77f', class: "sheet-body px-1" }, h("ir-textarea", { key: '0dee26b3f24316e1e684ec31e48543e54f105878', placeholder: locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), h("div", { key: '33ebc99c11d63c021185936691d9c0c62d47d1df', class: 'sheet-footer' }, h("ir-button", { key: 'd955dc3d63d49b8185b614568c90bf06fff46549', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: '24934a9cf32b0e5d3ac00e2a2526429ef84d0e6c', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (h("div", { key: 'a0c45c32057ab5f7a63fb83ca0990472453a5274', class: "fluid-container px-1" }, h("div", { key: '61fdf246e918683a7d24d6aecd4bd9c120951222', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, h("div", { key: '7cbc9eba1f7254072c8876484c9ea69845493add', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, h("p", { key: '32d5da874b45e72faccb48c57ff2391ac7acde1b', class: "font-size-large m-0 p-0" }, `${locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), h("p", { key: '06028082b39731f051443495f8b7e4b837bb97d8', class: "m-0 p-0" }, !this.booking.is_direct && h("span", { key: 'c77813b4c2ceb3f7d42241371a1e396f91aa9f8c', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), h("div", { key: '71edb2b54b72e431f2b1fd179df0813e1277bd5f', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, h("span", { key: '924c88b593b1966313ade1f8c6b52f451a04c343', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales.entries.Lcz_CancellationRequested : this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (h("div", { key: 'b979a8ee25c1a79de815313b8bfa4c6addf20e35', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, h("ir-select", { key: 'd83a738c8552249105c43b06ffee25e13233b87d', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), h("ir-button", { key: 'b18059e687406e4c7609477c1059c1869dd86f56', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), h("ir-button", { key: '42086833e46dd205f768f9ce95aa796e6cb752d5', size: "sm", btn_color: "outline", text: locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendar_data.is_pms_enabled && (h("ir-button", { key: 'bf9eddab01050db051d59a4fe81445635f0dedb9', size: "sm", btn_color: "outline", text: locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && h("ir-button", { key: '361a8865807a6c6c83f859cf70b20f93bf435272', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && h("ir-button", { key: '9184da6ed3ca7fda75c30b814f64399e403eb3d9', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && h("ir-button", { key: 'f6a8f1900fab855ef5efc8959836cdf8c94171f0', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && h("ir-button", { key: 'f1cc96df64e042177d38e2d82664483daea5c73a', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && h("ir-button", { key: '9a0d3fd0111eb91ab4be7cbc575bcc392cfafa8f', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (h("ir-button", { key: '4a344743c90a3b3e696e78e7d8990badd9eb1121', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), h("ir-dialog", { key: 'e9c56b9ba9ba6cbe40078eb958c2459b8634a627', onOpenChange: e => {
                if (!e.detail) {
        ...
        return (h(Host, null, h("ir-interceptor", null), h("ir-toast", null), h("div", { class: "p-1 main-container" }, h("ir-listing-header", { propertyId: this.propertyid, p: this.p, language: this.language }), h("section", null, h("div", { class: "card p-1 flex-fill m-0 mt-2" }, h("table", { class: "table table-striped table-bordered no-footer dataTable" }, h("thead", null, h("tr", null, h("th", { scope: "col", class: "text-left" }, (_a = locales.entries) === null || _a === void 0 ? void 0 :
            ...
            _o.map(booking => {
                ...
                return (h("tr", { key: booking.booking_nbr }, h("td", { class: "text-left" }, h("ir-button", { btn_color: "link", btnStyle: { padding: '0', margin: '0' }, onClickHandler: () => (this.editBookingItem = { booking, cause: 'edit' }), text: booking.booking_nbr }), booking.channel_booking_nbr && h("p", { class: "p-0 m-0 text-center secondary-p" }, booking.channel_booking_nbr)), h("td", null, h("p", { class: "p-0 m-0 date-p" }, hooks(booking.booked_on.date, 'YYYY-MM-DD').format('DD-MMM-YYYY')), h("p", { class: "p-0 m-0 secondary-p" }, _formatTime(booking.booked_on.hour.toString(), booking.booked_on.minute.toString()))), h("td", null, h("div", { class: "h-100 d-flex align-items-center ", style: { width: 'max-content' } }, h("img", { class: "mr-2 logo", src: booking.origin.Icon, alt: booking.origin.Label }), h("div", { class: "text-left" }, h("div", { class: "d-flex align-items-center" }, h("div", { class: "booking_name m-0 p-0" }, h("ir-button", { btn_color: "link", onClickHandler: () => (this.editBookingItem = { booking, cause: 'guest' }), text: `${booking.guest.first_name} ${(_a = booking.guest.last_name) !== null && _a !== void 0 ? _a : ''}`, btnStyle: {
                    ...
                    ? '_'
                    : formatAmount(booking.currency.symbol, booking.financial.gross_cost))), h("td", null, h("p", { class: `m-0 badge ${confirmationBG} ct_ir_badge` }, booking.is_requested_to_cancel ? (_d = locales === null || locales === void 0 ? void 0 : locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_CancellationRequested : booking.status.description), booking.events && booking.events[0].type.toLowerCase() === 'modified' && (h("p", { class: "mx-0 p-0 small", style: { marginTop: '0.25rem', marginBottom: '0' } }, "Modified"))), h("td", null, h("div", { class: "d-flex justify-content-center align-items-center", style: { gap: '8px' } }, h("ir-button", { title: "Edit booking", variant: "icon", icon_name: "edit", onClickHandler: () => (this.editBookingItem = { booking, cause: 'edit' }) }), h("ir-button", { title: "Delete booking", style: { '--icon-button-color': '#ff4961', '--icon-button-hover-color': '#FF1635' }, variant: "icon", icon_name: "trash", onClickHandler: () => {
...
const IrCommon = class {
    ...
    render() {
        return (h(Host, { key: '79ddf253d95d759045359739e3f0fe883c4c58bd' }, h("slot", { key: 'd4e14a7dbbeedbdd351cf91008f71867e939a179' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (h("form", { key: 'a18a6053ec01854d1ad4a814d68b11e9cf52a853', class: "dropdown m-0 p-0" }, h("ir-input-text", { key: 'a65e9efec43a9b9117978f7434aec097620ca46c', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), h("div", { key: '662b3ebfa1352937a1d438261d04c7ff6d691cb4', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (h(Fragment, { key: 'd30a9e4372bcf4aeb56d28cd005bf5f671ae0758' }, h("button", { key: '420d3ba2aa2c664cebfa507bd39fc110ec772712', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, h("img", { key: 'f55df890826de37e5eeaa197339ef126fa681403', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), h("p", { key: '4db674e8aedefb661079a40d4630d82ca505b29a', class: "pl-1 m-0" }, this.propertyCountry.name)), h("div", { key: 'de3328a44fe3caa642617b847b899d38a3bc36a3', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && h("p", { key: 'eb533758d9805cfca5e77e207c3c040051d123a9', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: '6da0e37ca2d513c92e333fee72988bcfa86e18a4' }, h("input", { key: '52e3f7deb09fc3ceb9f7bdff22574b2709cbc4ae', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '05e2db0fc311ccae6618594eac4737e93b0dcc40', class: "d-flex align-items-center" }, h("span", { key: '2be1c7c56a6834adc1337174bab44548d07d12ce' }, this.dates.from_date), ' ', h("svg", { key: 'd2371aa31827bcefe6c7132a554d4cb412327f38', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: 'd0f02fdb5a6742dfe4ab759f82dac6b0e992c7b9', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '6cd43fbc953cc435064e49aa2642e7719f2624d9' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '5ac278c6dd0cdc990e11edbea1fb8b8c0e1e3fb3', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: '0d24a805f73563b86789c3dd9849949e29358700' }, h("div", { key: 'ed02982741a6b56a3298961a1f16659f13001a5d', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: 'e83cf12c138e433f5b92187a3f03b56b67216728', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'ec0a121f38453ede107a25f6ed80e98246a7b2eb', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '56761b6f3b6421cc5fce5c40543d96e43d50490c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '0c3c8fe8366e314b10f041daa11d85bc178dec04', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'fdce4cc5b6467ef770678e941b51bfd65167efdd', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '8eeffcc9bb9d0e9ed3760bfe918dc744c17eb655', name: "modal-title" })), h("div", { key: 'ea5579427593be25fdf9b209e8f67bf0abd2cdd1', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'd7e23ae036a9ea5c7f4d247eafadbddb075d6ba6', name: "modal-body" })), h("div", { key: 'f40cfe96e45f6030272840fe477fbdb79bee0bc2', class: "modal-footer" }, h("slot", { key: 'd56ff813732533438fb4429a59b5faeefab18e5e', name: "modal-footer" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrExtraService = class {
    ...
    render() {
        return (h(Host, { key: '4a7b2a85a3c4c801b39398145501639207cd4ea1' }, h("div", { key: '7e1e2ddb0b44f79de6028ae3d8363494fdffcd34', class: "p-1" }, h("div", { key: '1cb9bdd786e2388a2637a11cac449ef54c88c1c0', class: 'extra-service-container' }, h("p", { key: '0c5698c6daf9ca6261c67f1a90ab155592369cf0', class: "extra-service-description" }, this.service.description), h("div", { key: 'c285bc27f0cc13c44ba079d2b17fb6aa1d5cc90c', class: "extra-service-actions" }, this.service.price && h("p", { key: 'ca301d1635ba82c02e6b4c559cdc1c4e3275f2f3', class: "extra-service-price p-0 m-0 font-weight-bold" }, formatAmount(this.currencySymbol, this.service.price)), h("ir-button", { key: 'c835e42e05a747368cc78fa778948696cdd598a8', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), h("ir-button", { key: '4d64de2540726b46ddc2bd85f23d9718365a0acf', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: colorVariants.danger }))), h("div", { key: '6f6f8b02c328d3174118acff3ad4c64dd8763697', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && h("p", { class: "extra-service-date-view" }, hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), h("ir-modal", { key: 'd1cee51245cdb5bec16a6c4771b6a1d0951b9d4e', autoClose: false, ref: el => (this.irModalRef = el), isLoading: isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales.entries.Lcz_Confirmation, modalBody: `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (h("form", { key: '5cb73d6b900b6c64c1415d9c7d589d06cf37a6f2', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, h("ir-title", { key: '907da37271763b2c3e65693a553740f8c87a9e04', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), h("section", { key: '58336924523dbb259bc53a1976cb5c4d4217fc42', class: 'px-1 sheet-body' }, h("fieldset", { key: '89a1b5b55bc4ca7065a81b3d30d0e4394c02a665', class: "input-group mb-1 service-description" }, h("div", { key: '0b59c5edcd419a2945f59faecc88b3d334b25ba4', class: "input-group-prepend" }, h("span", { key: '3b0a6988f307ad4774db44a95cf70a84e9f86a65', class: "input-group-text" }, locales.entries.Lcz_Description)), h("textarea", { key: '7b7f52c9f494aa3f0602b37604308edecb0417a4', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), h("div", { key: '49097887e65f1050b79e3c59de0c9bfc5a29f037', class: 'row-group mb-1' }, h("div", { key: 'e54399b443b6bc9764358ffde12680e34e18c1fe', class: "input-group" }, h("div", { key: '2cdd8e855fb29316c24e2104a16c0972c22a216d', class: "input-group-prepend" }, h("span", { key: '57fbf78c21aa39b5fa63af5eeb0bb522f8e88a85', class: "input-group-text", id: "basic-addon1" }, locales.entries.Lcz_DatesOn)), h("div", { key: '75d561f31b25e86d01b5c0703981c49e313fe86f',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, h("div", { key: '20882adf2d225bff7f4408bb7d7ee583f5636299', class: "service-date-container" }, h("ir-date-picker", { key: 'f18719e4591b7feb74d73708321b70079ccd53df',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, h("input", { key: 'c269a5e3e3dfed88b48e5bba47aa5ab5a18afabd',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? _formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (h("div", { key: 'ac59e07aaa9873d17f8c4f72817c847f0575b56a', class: "btn-container" }, h("ir-button", { key: 'bec86b29c9e9ae7884df5228768eb4ccb8939363', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), h("div", { key: '221078590be91d96fb1504050273351d3ca60c41', class: "input-group" }, h("div", { key: '736e554e71daa0a82dc4bc1703da4a69bac47778', class: "input-group-prepend " }, h("span", { key: '166e93c608457a5e2c5f0efaa5be4b8812175a5d', class: "input-group-text until-prepend", id: "basic-addon1" }, locales.entries.Lcz_TillAndIncluding)), h("div", { key: '7b5676d163f0d085cf62d32e43aadc1dca44a160',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, h("div", { key: 'c384ffc7cb074478ecb2e3b675b4680658ec28f3', class: "service-date-container" }, h("ir-date-picker", { key: 'b6d30b75c0e993108d634c1f00e5db7cd4ac8529',
            // onDatePickerFocus={() => {
            ...
            } }, h("input", { key: '5657260f39c23730fcab7ad32953d9b8cd6c5ef6',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? _formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (h("div", { key: 'af4989d32f230404d0548399c0eb6388cd8de124', class: "btn-container" }, h("ir-button", { key: '45ac53988e74880e9e0c093f8a31153a747d58bd', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), h("div", { key: '2d862c5a7e4cfd3d736d064c57d5c50b73541ba7', class: 'row-group' }, h("ir-price-input", { key: '3480558d5760c5693dc8530bc9a8f45f816a07d1', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), h("ir-price-input", { key: '1363dda897810699fbd5d83b7da893cacd0a5d4c', autoValidate: false, label: locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), h("div", { key: '9c515bb8734002b18ce29577d38bfa41a5dc1e7d', class: 'sheet-footer' }, h("ir-button", { key: '6282c8445dc2baf0841bbc7902dbbd64c63acd6d', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: 'e3d244a7d5b9d19afb7f8820fe9ebbf46bdc9d78', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: isRequestPending('/Do_Booking_Extra_Service'), text: locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '10620bc182ca12e3ba45849b63a142fa53e27ae8', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '7d68f970b4eae763188412c91c7d855d16a407ae', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '53a4e1c9ad4d4250d9b34ba9dba1a2aa1a4fcf8d' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: '3716d6d31575e4e1cd783dda27772eed153fb330', class: "loadingScreenContainer" }, h("div", { key: '8dcbf7b01ad16668f0af24ddce7e58d8b2f6d232', class: "loaderContainer" }, h("span", { key: '0008da04e85b37ef11d6e3faad7eaa33eccdaf42', class: "page-loader" })))), this.showModal && (h("ir-otp-modal", { key: 'fb1b87efe6bc2af000cc332736e64029e61e72f4', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (h(Host, { key: '2a8a275060022886ebc33a401b3d07d5223b0703' }, h("span", { key: '9ec9585b8eb1e00ad7acf8e2b0c4954a6c8f6f23', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '4c1e16d6812182b8a29bfce0502184453af64671', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '4a425a3158c9025379eb158ada9bd38ce8ce6f85', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '18ed2681c0e9b4a56a998e14bab5db70cbbff16d', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'ba9ba9be4dcb72c292d771db82cf4f45c58dcb0e', class: `ir-alert-header` }, h("p", { key: 'b887a33de6698d4db82e6842f6491215100f4b9b' }, this.modalTitle))), h("div", { key: '67b2d5634d723ac65cbe9db0858d33a2cd44af27', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'fd3e6bd6fb10d15ab037a870fbd5398c3716c8b7' }, this.modalBody)), h("div", { key: 'b4727a8b318ef79122c095cd4f67d727e979810b', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: 'af55ccc9dabe4b8a393b8bb7712cf1557e3263f2', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (h("ir-button", { key: '3c946ed9f9dd47630946ef61ef01d3fb9f61cc4c', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: 'db96e8af1311d73407298fa8832c4d6a49b25ddd', class: "otp-input-container" }, h("div", { key: '12650b30c172d7680c9d9adcc1efdb54f709c805', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: 'bdc44b5bf262381d00b4a793aaab38338a7e609e' }, h("div", { key: '72a566303e0b1d4437f13f6fe55481c2c2dc4d29', class: "form-group mr-0" }, h("div", { key: 'b9dd1de7132518627ad83eb93ae2f9d4488ae370', class: "input-group row m-0 p-0 position-relative" }, this.label && (h("div", { key: '0ba4141cdd2d7499a77fddb14e747ee444f29939', class: `input-group-prepend col-3 p-0 text-dark border-none` }, h("label", { key: 'df998948027002512f07719f68a7a3c490126fab', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), h("div", { key: 'eb2d3607584b8e1caed1411b61ff3b997e2966c5', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, h("button", { key: 'ec3c51897faf9aa94cae608a2b4b8ddf21da1668', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : h("p", { class: "p-0 m-0 " }, locales.entries.Lcz_Select), h("svg", { key: 'f8adb06672e463dfecf7f2a6f34adfd828a9f943', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '3d30076701dd932a0b61b457a647a75c788351d6', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), h("p", { key: 'ee8ab7936c17b34043d1c9a521dc04b8df828c11', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), h("input", { key: 'f8e73c65c84f326572c0ef8eb8167956da4bfedb', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (h("div", { key: 'fdb61b2c39530c27f033bc489b3dd9897a09f0d7', class: "ir-dropdown-container" }, h("ir-combobox", { key: 'e56218e2277dde3df36395edfc8d3293eab7f3d3', onComboboxValueChange: e => {
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: 'dcb1bf744a5a2aa909273ca1807909a26bdc514d', class: "input-group price-input-group m-0 p-0" }, this.label && (h("div", { key: '61a5a0fe601573ae684b1e088d5cab52dd23abb5', class: "input-group-prepend" }, h("span", { key: 'a230f62f0b63d486845c5fd108696af193926b1b', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: '5344b46209b2fcdf6813ae9123a3aeaa7024d98a', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: '8d14a8b38a13ec762b965db5928b3c66cbe4dcde', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '826556d9cbeab41fe776b7f618edb4a29fa3bd7d', class: `input-group-prepend` }, h("span", { key: '3fee4f61daaa28365bcaefffd34e8b14fd778acf', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: 'c47c4da79711bb9a6342c0dfeaf5411e9f8a5d32', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: 'e982226dc68fa0176bda444dcef832f4b450d741', class: "card" }, h("div", { key: '48b2e15c69ab84407b44904f6474dfd8541ae387', class: "p-1" }, h("p", { key: '5dbf341953fb310dc14d4f98a0b8749100275c53' }, this.booking.property.name || ''), h("ir-label", { key: '9f6f3de9023fa05a5babf29c0ce16b4599ae0929', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: '9394288e1df9b8af902df11d0ee2732be17e7a4d', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: 'bda85afb8e4d54e9e90c0bbce53f5eebee35df2f', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: '0a0dfd09d5dac6e63d15c7bdbe3f10389fb71d97', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: '801d4198ac8e23fa401db1864047be4da6bc733b', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: 'ef1f09a093a8ae9f398301314e03f588dd347ca3', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: '6bad91b9401a40197d81ebf8bb3812b37d02ccc2', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: '2199cb239c12845dac0b2e09e4ad986231858df5', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: 'f66d5dad44c80c6d8f57df4fb20b6199953997b4', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: 'e1969ca0c87849dc506d22e40827f6fec2c8581e', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: '5c17b8e549dd6fd9a2da05423ddf57b7be6fe837', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: 'd5f23f9f1489fcd28688f9a7a915edf1bb5313cc', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: '13f4849a1fc3aac402b3cd776cf464acbc92e54a', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: '0d2e0cfed69d3d14cd7bf42a07f875b3f8989623', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: '3a43f9b140366938f5e1d4b2b37d5f3d3f1fcfdc', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: '781d07941a4d9fee0709d89d3165a3aa254a5b75', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: '20ad0b6ab164d399b38944282ad2f08698f4fed4', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: '0203c432caf68ebef6d5cfc2cd3dcbe4d1b6206a', class: "d-flex align-items-center" }, h("svg", { key: 'c21e8303806d8e5c595acd444723546de07ed010', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'c22f72d8aa344230dd9778115c066bcc2a175def', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: 'a3584afe734db81f194c049b31be4ac15061f901', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), h("div", { key: 'f06755b1a1ca6654e70ce18bf99e22623efbd94b', class: "d-flex align-items-center justify-content-between" }, h("ir-label", { key: '6ffc8fb08b5b3c4dce7d9f6d4aeb99b8ce47f099', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("ir-button", { key: 'be3fea89914c67813eedce7ca9626c5fee4137b4', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '180b9aaa6e8d9b1499f21467ecaf695a8f81b5e1', class: "p-1 d-flex m-0" }, h("ir-button", { key: '0aa33d6544502fd781cc72edebdd6e881cf30512', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '1c5cdbb0e6a5568db61d44fa323bd451475115eb', class: "flex-fill m-0 " }, h("div", { key: '8ee9dd4bc125af4bcb571503a9745ae2c1c88f38', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '2a426edc0a1ff047b7cde4acf52cccdb33fabb3d', class: "m-0 p-0" }, h("span", { key: '322acaf05ce9a88a7e66066aa4c35e0a7633eb7f', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '7c4b3f3b500baeb9f2595d91c515097f925c3666', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: 'eba430f133ca298188b7ff618c7e8ab72e2752e3', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: 'f758c7986a844d2afbd5fb0d209b32f99f0ac730', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '15aeca5e5292369acef3a94c7e4119d79c6c717f', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: 'f68d13c1fe21bdc44fe1db063c0e8bf71df6834a', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: '683ab391ca53b021591464b46a26a17b817ee547', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: '75f581024637617a0cc9f501f334e5c56912e7a5', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: '4ba71bc54cf9d67bcea02684df3973b5bf913ea5', message: this.room.unit.name, customSlot: true }, h("span", { key: '29cd974e87b35cbbe9484387546e990d4639d60b', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: '27b09c1070694eb045bab75ec191af8560d52225', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: '0ef45d7db46729af1ee19ba0f713075590426ffc', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: '7fd70efa0a033cc075e8ba7cc22f65a500d48612', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: 'ef3d558e35bddb8e1ba610366b09e46703f98109', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))) : (h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), bed && h("p", { key: 'eac551ff3acec7251e66566a9aeb51d0893d5cde', class: "m-0 p-0" }, "(", bed, ")")), h("div", { key: 'd1d5036ba4861887a5b1eac8c6eea1ac3bb015d3', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, h("div", { key: '109089d93c6f8274a1d18f6e79f52fb1d57a556b', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '35c5a125e4695f0bab244d37d75e1e2fb17744dd', class: " sm-padding-top" }, h("p", { key: '91879fb1771744c3e95a4239bbfb27bfcae4bca8', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '966b968eeffffa535882d1d764bdd550bc92b1ec', class: 'flex-fill' }, h("table", { key: '1a3fd90f032e994b95956eb2145f2bc3661bb70a' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '38785c2d2bcba4d934e33aa95cfa2c1726d06194', class: '' }, h("th", { key: 'dc11b6820f0d22ecab56fe71257678780a85ebf0', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: 'd948cf7c3e89cfa190409f5496a20b5134b58100', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: '4c0e06ea4c47ecdb8eeb2e285e12f5ca15ef0de9', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '45961c2ef44b85bab230624260995a56ebc7588b', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: 'a85d8163b87f7bd1a34065d522b1da6c433780a6' }, this.room.rateplan.cancelation && (h("ir-label", { key: '164dac737fdd7179001319dbf31835f71be465f7', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: 'ca5b96892c07da5333a158585c88d5c1b298755f', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '1839fac196e0c046b142a0c2d16976affa4af8bd' }, h("ir-label", { key: '12193f01f6b155ee236eaa611381fa97efa5d81a', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '8b583709ef1b68863d30953b361f807edf21157c', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), h("ir-modal", { key: '19f55a59078fe8a0dab04ed418d5caab000d855f', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '9c1de78967f1b36318d4af565376c81566b890a7', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'aeeabbe783f10a6e984f20c48a1774a76cb2d910', class: "input-group row m-0" }, label, h("select", { key: '0a438f246ddb4eece109d33677d4e84231138198', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '97f68ee73b592c31eac15dd978e9922dfc91c81a', value: '' }, this.firstOption), this.data.map(item => {
...
const IrTitle = class {
    ...
    render() {
        return (h(Host, { key: 'f1cd554570b106dbb7d984b3dd8ddc7d38f2ef7c' }, h("h4", { key: '0a997d727b7384a5a19a335322ebe24afffb9445', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: '2ffe200cc4cf2ae0fca2bb2189153bbe50584ec8', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '9af3b4cca8b8389accf4d90e4ef1a852c6626e66', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '5388e1ab45748e64e38d9f1bb2f346c3eac746ee', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: '2c534baebbfc30697dbd830a83b77dbd117484c9', class: 'title-body' }, h("slot", { key: '65b84ac18a0e498525a8402723170133243f7731', name: "title-body" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: 'dc34d403844284e4cb8189ec282bc1ef44f9e546' });
    }
    get element() { return getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'fff1857aa922389687acac455e97541c64b8d8b2', class: "m-0 p-0" }, h("span", { key: '46d0dfe8557a3fb3ddd896b01973b545c3cf3f9c', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (h("slot", { name: "tooltip-trigger" }))), this.open && (h("div", { key: '678cf890d72db02ec90d77fa981480e2b4f10a1d', class: "tooltip bottom show position-absolute", role: "tooltip" }, h("div", { key: 'd2b44394c707ea259bf449ff0e45d5a149805836', class: "tooltip-arrow" }), h("div", { key: '2dcfeb7573c9b70e1adec385c53def2b7235a436', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, h("span", { key: '2585e4de03b6de555d16a1d5818e98da58ec0d64', innerHTML: this.message }))))));
    }
};
