...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory } from './booking.service-a449c648.js';
import { l as locales } from './locales.store-53ec3957.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-5d531f99.js';
import { f as formatAmount, h as hooks, e as extras, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, a as getPrivateNote, b as downloadFile, r as renderTime, i as formatName } from './utils-9b1ecd52.js';
...
import { c as colorVariants, i as icons } from './icons-457fd9f9.js';
import { c as commonjsGlobal } from './_commonjsHelpers-1789f0cf.js';
import { _ as _formatDate, a as _formatTime, b as _getDay } from './functions-09b3b195.js';
...
const IglBookProperty = class {
    ...
    render() {
        return (h(Host, { key: '90b3733ea4c64938c267fdde4fd688e496e126f4', "data-testid": "book_property_sheet" }, h("div", { key: 'b51b2d02a8acb149d48fd69fab1cb80ef26a020d', class: "background-overlay", onClick: () => this.closeWindow() }), h("div", { key: '955579e54b25cf0756f0c8f9dc44439566fa8194', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, h("div", { key: 'ace5ca9b4148ff69c83ff1f6c259d4b0f5321f36', class: "card position-sticky mb-0 shadow-none p-0 " }, h("div", { key: '649325c6b8ab466e7e8e0b96befcc3c111154ce5', class: "card-header-container mb-2" }, h("h3", { key: 'd390e1532ca6f24bff528d7a2c87da6ed4ce28be', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), h("ir-icon", { key: 'aecbdcf37cacfa06e6f859d7ccdb41bd17b5a663', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, h("svg", { key: '8071cd1782a92b748b499a41315b869faeecfcc1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '2cb0ebc0a7804b85f1b20f09d07531c4be93b393', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), h("div", { key: '97495b2e375bca5a6631ffef06ec3169bba75241', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (h("igl-booking-overview-page", { key: '43713298b79d26a80d34001b3862653cfd7a9fd9', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (h("igl-booking-form", { key: '34bede8eebdd6d46700865fda0230992dcb736f8', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countries: this.countries, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: 'c4bdc6052c4c6edb96f1e695ba171b4ced49fed3', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: '673b2fbc202d2d65cae8784f5802171a9dcf77cd', class: `d-flex mt-1  p-0 ${isAvailableToBook ? 'flex-column flex-lg-row align-items-lg-center justify-content-lg-between' : 'align-items-center justify-content-between'}` }, h("div", { key: '7cebd3042a377a56544fad7a59a0d82af26742f4', "data-testid": 'rp_name', class: "rateplan-name-container m-0 p-0  d-flex align-items-center", style: { gap: '0.5rem' } }, bookingType === 'BAR_BOOKING' ? (h("p", { class: "m-0 p-0" }, h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable")))) : (h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && h("ir-tooltip", { key: 'eda401b08feb3c67ed0fe7905ff0f10a9b509ef3', message: this.getTooltipMessages() })), isAvailableToBook ? (h("div", { class: "d-md-flex m-md-0  justify-content-md-end align-items-md-center flex-fill rateplan-container" }, h("div", { class: "flex-fill max-w-300 flex-grow-1" }, h("fieldset", { class: "position-relative flex-grow-1 w-100" }, h("select", { disabled: disableForm, "data-testid": "adult-child-offering", class: "form-control input-sm flex-grow-1 w-100", id: v4(), onChange: evt => this.handleDataChange('adult_child_offering', evt) }, formattedVariations === null || formattedVariations === void 0 ? void 0 : formattedVariations.map(variation => (h("option", { value: variation, selected: this.formatVariation(selectedVariation) === variation }, variation)))))), h("div", { class: "m-0 p-0 mt-1 mt-md-0 d-flex justify-content-between align-items-md-center ml-md-1" }, h("div", { class: "d-flex m-0 p-0 rate-total-night-view mt-0 flex-grow-1" }, h("ir-price-input", { testId: 'amount_input', disabled: disableForm, onTextChange: e => this.updateRateplanSelection({
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: '518f1332258015b1a103facf9fd3ef7ccb7503c1', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: 'd6ab7cd508fae677a12f87eaabab4dd25c41e9a1', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '636466b681d2209b160f74043556c403943abfc2', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'd19ab7ab260427726b4e0745e683d0814a409396', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'f040e6ca632d1e57e31c8e6eb373bc7101685325', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'aedcb59356908a12db4976e28395a605130326c7', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '183f0ab4aa9374efc371fbab4288af5f374917e3', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: 'd7ef05b0b8c33d1e48f04a115c3c400ebec54562', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '3e64b7f1f85b26911644f0798b1e25bfeebcf9ff', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'a991e80dcc1ed474770edba0a24ab3cf000c7995', class: "pt-1" }, h("p", { key: '502177aa761ff2dace8ae143f6605798ed764b77', class: "m-0 p-0" }, locales.entries.Lcz_Period), h("ir-select", { key: '1363e112b37302acbb83039c38e0d81fdc26e0a7', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: 'e88d509a7470981de7449473b0b479df0b7cde00' }, h("p", { key: '3fa3b183544d58d536d6f68ef23494285fca8e1a', class: "m-0 p-0" }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: '39d016b8e287783761db35131e02cd88a6d4ab3a', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } })), h("fieldset", { key: 'ca8871b0ae76fb53103d9642268f5875cd5ddf7f', class: "mb-1" }, h("p", { key: '4fe21d01b86fca12621a9b85635a0fa1df3d6338', class: "m-0 p-0" }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: 'cdf1a426e808944f6ecb7b75057eab7b5d21654e', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: 'be2c50e7a993ca93f294aaea6ecb8e579c858b8b', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: '61ab19c7f9683255cdd73151b83966f2317701f6', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: '4a97034edd37f44d6a99b7a4fb0e700fa767dbf6', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'b49436d2ebec831d582b8347b5a7dce780bbb6ea', class: "m-0 p-0" }, h("span", { key: 'b10b26abf45126fd33205169c5431f55dcff32cf', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
