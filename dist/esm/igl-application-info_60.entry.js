import { r as registerInstance, h, H as Host, c as createEvent, F as Fragment, a as getElement } from './index-ChgcZQN7.js';
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetBookingStore, a as reserveRooms, u as updateRoomParams, g as getVisibleInventory } from './booking.service-C8_9RXYz.js';
import { l as locales } from './locales.store-km9kP7G7.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-iTCxBVE4.js';
import { f as formatAmount, h as hooks, e as extras, g as getReleaseHoursString, d as dateToFormattedString, l as calculateDaysBetweenDates, H as validateEmail, b as getPrivateNote, n as downloadFile, I as renderTime, z as formatName } from './utils-7qMAgUpz.js';
import { v as v4 } from './v4-DD3477fe.js';
import { i as isRequestPending, a as interceptor_requests } from './ir-interceptor.store-DiBJpwZo.js';
...
import { c as colorVariants, i as icons } from './icons-T2gByj1h.js';
import { g as getDefaultExportFromCjs } from './_commonjsHelpers-BFTU3MAI.js';
import { a as _formatDate, _ as _formatTime, b as _getDay } from './functions-DFJrGvby.js';
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f7c5ded8eca2dfffd456c0ee6b98c189434c7f46', class: 'my-2', "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, h("div", { key: 'c70fc9323f4f0dc379baccb843a6f8f34943b974', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: '81a51d67e379ccb2e0d304021c9f2d165652aafd', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: 'afa6b938f2a567a39c0105563fb9b126cc194754', class: "booking-details-container" }, h("div", { key: '2bc11a62771ac8198af44536866f8b373cb01c46', class: "booking-rateplan" }, h("p", { key: 'f6cb673ddf942b9dbb8f16197892315b479844ae', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: '9e6708fc32961ce796d5bd80ead2a69914306d5f', class: 'non-ref-span' }, "Non Refundable")), h("ir-tooltip", { key: '34c64fc8278a6a25e02f34bef3c6ce35db03a866', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: '1bffe85f638bc5379672fe6ff0a64e1fa8eadea6', class: "booking-variation", innerHTML: formattedVariation })), h("p", { key: '5a5aa68180cf25ee330a8f225283e20069ea1288', class: "booking-price" }, formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), h("div", { key: '25efa0f149be325180e1491b4cfa7557c9eff307', class: "booking-footer" }, h("div", { key: 'cba78c5385de6891bca1de11fbca0c365a0302a1', class: "booking-rateplan" }, h("p", { key: '209de3d41656f77975778d36a54fdd54cbdca523', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("ir-tooltip", { key: 'b2513841e8ccba4a3536b06cab259d1f7387fed6', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: 'f85510ebaa0ba4129d83aeda1790de2b3f182aab', class: "booking-variation", innerHTML: formattedVariation })), h("div", { key: '4240cbb549a026f69de3e6ab59ce64da7eb110fd', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, h("div", { key: '9813beae55cbb018b1663f6c8564a4937a841b0a', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, h("input", { key: 'beae0d894d04b078e225c80dcfdf17670cc59bd5', id: v4(), type: "text", "data-testid": "guest_first_name", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ first_name: name });
                if (booking_store.event_type.type === 'EDIT_BOOKING') {
                    modifyBookingStore('guest', Object.assign(Object.assign({}, booking_store.guest), { name }));
                }
            }, required: true, value: (_d = this.guestInfo) === null || _d === void 0 ? void 0 : _d.first_name })), h("div", { key: 'be3a21e99424de9a83d6c8ac1234d7d229f53bb6', class: "mr-md-1 flex-fill guest-info-container" }, h("input", { key: 'e9e68b5cc6e2c922bfd24b8f79fe8db11cfd8a35', id: v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_e = this.guestInfo) === null || _e === void 0 ? void 0 : _e.last_name) === '' && 'border-danger'}`, placeholder: (_f = locales.entries['Lcz_GuestLastname']) !== null && _f !== void 0 ? _f : 'Guest last name', name: "guestLastName", "data-testid": "guest_last_name", onInput: event => {
                const name = event.target.value;
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("div", { key: '583396e6ea338a3c4ecc24451fc9bbf7318ba54c', class: "mt-1 mt-md-0 d-flex align-items-center flex-fill" }, h("div", { key: '76cf13af00cdc05f6fb309c3455ff617d1c04b67', class: "mr-md-1 p-0 flex-fill preference-select-container" }, h("select", { key: '3275156816506f2125c35afc0fb039ce23390433', "data-testid": "unit", class: "form-control input-sm pr-0", id: v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, h("option", { key: 'f50f47e56613d64e0b1a7b4a0947396ee17b7748', value: "", selected: ((_h = this.guestInfo) === null || _h === void 0 ? void 0 : _h.unit) === '' }, locales.entries.Lcz_Assignunits), filteredRoomList === null || filteredRoomList === void 0 ? void 0 :
            filteredRoomList.map(room => {
                var _a;
                return (h("option", { value: room.id, selected: ((_a = this.guestInfo) === null || _a === void 0 ? void 0 : _a.unit) === room.id.toString() }, room.name));
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (h("div", { key: 'ec2d86d5639b423e0fc449a8cf9f9db46ca97006', class: "mt-1 mt-md-0 mr-md-1 flex-fill" }, h("select", { key: '2a92ff826d0e73b17164d0e104dca426f5a23cc5', "data-testid": "bed_configuration", class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, h("option", { key: '76c18a38c0de5f4a456bbf64be056441e28654d8', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), h("p", { key: 'eed4f7f432400d26026da47f108b50c0e5a3c94a', class: "rate_amount" }, formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: 'fa9654ae18542e6c83bef9be2a9f2441af0603f6', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, h("p", { key: '6024df59dfe62fdbdf746de939aa20e431da5bc3', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), h("div", { key: '48090d562aec17755c55defc0cf31415b2e19b77', class: "mr-1 flex-fill" }, h("select", { key: 'd38b73b6a4acc0704de1715aa35427dc1c3f7580', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, h("option", { key: 'd56249489e66f4bc24b3c7895d3ae8985eace983', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
...
const IglBookProperty = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.closeBookingWindow = createEvent(this, "closeBookingWindow");
        this.blockedCreated = createEvent(this, "blockedCreated");
        this.resetBookingEvt = createEvent(this, "resetBookingEvt");
        this.animateIrButton = createEvent(this, "animateIrButton");
...
const IglBookPropertyHeader = class {
    constructor(hostRef) {
        ...
        this.sourceDropDownChange = createEvent(this, "sourceDropDownChange");
        this.adultChild = createEvent(this, "adultChild");
...
const IglBookingForm = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'b006227d7799b892b3bb77beb01932dc377c44a1' }, h("div", { key: '52b4393b6381b33637b0e960bdeac72c0ffef0e8', class: "d-flex flex-wrap" }, h("ir-date-view", { key: '5e8ba63981ced2490f8ddea41aa2b8534cd26e15', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (h("div", { key: '7834026eafa418457dc77da4f5101eea53977384', class: "mt-1 mt-md-0 text-right" }, locales.entries.Lcz_TotalPrice, " ", h("span", { key: '63c7460a8ecd1266d491ada9af771734e97f59f2', class: "font-weight-bold font-medium-1" }, formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '70ce330836aa0c637e7b5ca10a1a45bbe5945967' }, h("div", { key: '847f4d27d6518018037fd289cdece58d2f30bf0c', class: 'd-flex align-items-center ' }, h("label", { key: '09342d46eae3a18f635ee04658700b65fd9f9591', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: 'eda6dc9a488686ff26e1f139d61c0f353fec9a6e', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: '89e73e0466e9b4bca7f0f1b5caaffc5ffe2d84c0', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: '6c4bc734a204f21f16f441297594e301d5948a93', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: '621efb692e6c4da1f45a5ba90799bcf55351e8d0', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: 'c33236911af62dd9cab48b9b68686c320571a55b', class: 'sr-only' }, "clear input"), h("svg", { key: '65ffa72a01ab9cbaabdccb7461be6ac10e684007', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'e833e872437e5c80c74c8ec4b66c6fe07d31bba4', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCheckbox = class {
    ...
    render() {
        return (h(Host, { key: '7a3e4c9d5fbea10663757fd3711a94fd628b6efc' }, h("button", { key: '1ce441f5e9d9cac5936d823942b7b57524ff24f5', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: 'b807ff00789e7cbd3145f1c9c0878246549fd5fd', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'd34b4bb847b1a6d971e0decaae5131ad21f40b39', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (h("svg", { key: 'e1384687a65747a3c6c5dbfa35dd65427d26ae03', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'cf09677e50c2f55f887be374e4a356c42f80e3e5', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), h("input", { key: '53dd803e878978834eaa603e0aee46005220c297', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && h("label", { key: '4fe42cfa61b3bdc8e9d68a44653d09f6ac2d72e1', htmlFor: this.checkboxId }, this.label)));
    }
    static get watchers() { return {
...
var localeEn = /*@__PURE__*/getDefaultExportFromCjs(enExports);
...
const IrDatePicker = class {
    constructor(hostRef) {
        ...
        this.datePickerFocus = createEvent(this, "datePickerFocus");
        this.datePickerBlur = createEvent(this, "datePickerBlur");
        /**
    ...
    render() {
        return (h("div", { key: '31162bfd9b9fb139ac002990bc319490946410cd', class: "ir-date-picker-trigger" }, this.customPicker && h("slot", { key: '673f6b63533a918d805d1ea0c800b691dbf1432d', name: "trigger" }), h("input", { key: 'af9ca00b0cfb27c520f71aa8674ead2e0c6686f8', type: "button", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: '87e012238947f745347949b09b2f3db94f3987b0' }, h("input", { key: 'c7b025f2578f48300c2881753c4ada05ae78711e', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return getElement(this); }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: 'f5d82fae802b43663e3e55838184f67538b845ed' }, h("div", { key: '3d6f1c556b22ce1071a3888483d5cde58e0565f3', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '144cf74e8417c70e9978c609838ce02a34e8c7c5', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: '5edad5fce2d5681ee2953be18e1ee47fa7717437', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'ed4bf0ae822c9bf41b281e9be9b8b91ef20049d1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '75952ac11ae8c8f3114f55f98412bb71510a7948', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'e61713f351cdb3cfc6cc2876401bb56e69a5c804', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'ac7a87ab42f69c2278c46affc11e70f226b59eed', name: "modal-title" })), h("div", { key: 'ba73a7778edfc11b5dcbf3590c19196697997772', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '9fa5ada2dbbf7933c61ca81f39e38d1254928754', name: "modal-body" })), h("div", { key: 'e89879a8e92345fc9b90aca60db4ca794f1b8904', class: "modal-footer" }, h("slot", { key: '9fc8842991dab55e299e8985dea29c1aeda4c42b', name: "modal-footer" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const irHkArchiveCss = ".sc-ir-hk-archive-h{display:block}.unit-name.sc-ir-hk-archive{max-width:100px;display:inline-block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}";
...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (h(Host, { key: '90a3031237c92558484715a5f2d671e24326cdba' }, h("ir-title", { key: 'db2fbd3931b58668896bcbeac83b1bbe84b1d463', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), h("section", { key: '96289e7d972be8ac93abe59de4af65944c172f39', class: "px-1" }, h("div", { key: 'd0a4041225468f44b7b7618d166282a1b738c246', class: "d-flex" }, h("ir-select", { key: '564ade08c38e5a27e4bfb8cf6cbb7edb85d330f6', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), h("div", { key: '0287c94c344e5aba163301d1ac79648ec92800e3', class: "d-flex mt-1 align-items-center" }, h("ir-range-picker", { key: '7945b7ca1a58429ccad952fd8ffbe6de0feb0ff2', class: "mr-1", fromDate: this.filters.from_date ? hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), h("ir-button", { key: '98705ebf593f9945630fa17229efd31168c57b31', title: (_h = locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), h("ir-button", { key: '49a1eb6ba7fe09f3796b50406835bf935340e5e9', title: (_j = locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (h(Fragment, { key: 'dfe1072e6dfa2b5c3c6f04718e5222ae5dc065fa' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !isRequestPending('/Get_Archived_HK_Tasks') ? (h("p", { class: 'text-center mt-2' }, "No Results Found")) : (h("table", { class: "mt-2" }, h("thead", null, h("th", { class: "sr-only" }, "period"), h("th", { class: "sr-only" }, "housekeeper name"), h("th", { class: "sr-only" }, "unit"), h("th", { class: "sr-only" }, "booking number")), h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (h("tr", { key: d.id }, h("td", { class: "pr-2" }, d.date), h("td", { class: "px-2" }, d.house_keeper), h("td", { class: "px-2" }, h("ir-tooltip", { message: d.unit, customSlot: true }, h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), h("td", { class: "px-2" }, d.booking_nbr ? (h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'f5fc0d7807027e87e98a13c25871ebfa0945efa6', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '25cf84280e2c14ca610a2b2690724ab0c46f4044', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '789dc23eccbb9e54703d192fd2a5233f571e587a', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'bbaf699c0033d81a228ca9ff329208714cbd042e', class: `ir-alert-header` }, h("p", { key: 'e21f7c92956bcf52d1b966c290bbeba524ff79d5' }, this.modalTitle))), h("div", { key: 'f9f0f36cf7ff34d8f08d2168fecff038a990037b', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'fd65783ac7679d9ad8abcb1348b7564ee7ec4fe0' }, this.modalBody)), h("div", { key: 'feb578490c67bf83eb9fbb852d8cc71b92986fad', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (h("ir-button", { key: '9cf07af66ab078b44adb1c2be556ce859bd8923e', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (h("ir-button", { key: '377ad693d3175c6ccb0481bfadade952f3e10af2', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPaymentDetails = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.resetBookingEvt = createEvent(this, "resetBookingEvt");
        this.resetExposedCancelationDueAmount = createEvent(this, "resetExposedCancelationDueAmount");
        this.toast = createEvent(this, "toast");
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: '6f690c398157af6f4e484b71b0775dc68c0b767b', class: "input-group price-input-group m-0 p-0" }, this.label && (h("div", { key: '5b1dc985cf88245e54baadd62bce14906332719a', class: "input-group-prepend" }, h("span", { key: '38fc659d2b2104b123a0dea77feeab81901a1b96', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: 'e24d965895b06489f87d94736964d2348502eced', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: 'f4c86edd119a2f60551685bb38bbfadf84ceaeab', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '0d360119381fa1c8d7adbdbb85a64fb731e555fd', class: `input-group-prepend` }, h("span", { key: 'f6594f34157feab2de2ee6727d4e0845d36dfa04', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: 'f89f6caa8742a89e4b9918b838d22b472b2a3cb9', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRoom = class {
    constructor(hostRef) {
        ...
        this.resetbooking = createEvent(this, "resetbooking");
        this.openSidebar = createEvent(this, "openSidebar");
        // Currency
        this.currency = 'USD';
        this.language = 'en';
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '30c04f448f2f1b40b34e5d058e0453a4830cbf0a', class: "p-1 d-flex m-0" }, h("ir-button", { key: 'b37bc76430caa73b62004c95598f3b3c6347cf7c', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '7c6519db455441a45ab935a2000376e9793dc5ad', class: "flex-fill m-0 " }, h("div", { key: '77b300cc0645c9b669e7fb9d93e0584f24e1f2c1', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '53dd8d7244ef1cb7870d4ba54d360ba9a733077f', class: "m-0 p-0" }, h("span", { key: 'f507e27862f61781a07b83eea00676f810f711df', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '19e82498c3a6380f7502612961f9f7bcc374cf7e', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: '999a29cefdf55d93c6102a986fa3d4369f3c219c', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: '2691aea7a80ecd6e1833a40b42d51b01ba69384e', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: 'a84f95a2e1a6f6a7867f7e36f4e8929adc885586', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: '12334cf87ab3263bbda5978702e8881c9dd14cf3', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: '89e8280726953559c5fb29d4585ef3afceb0acc8', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: 'a3bdb8596567f5945173850aa667a6ccec9d57bd', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: '4b7f0b1b7929ed1611be8a86e182a393ecf6c82a', message: this.room.unit.name, customSlot: true }, h("span", { key: '0e27340ecbdff8da64c0118960f56efce03b6477', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: '7b20f29020b5565f17b98c75539e24ad3be9a934', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: 'fc4e6911f54c1e3a8f029c6ef4865943b4d25ea7', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: '83f43a5b65861971e9bac9c73a5b8bae12ca03e9', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '603022fed2e51ae2ba080cd80b38639c20c0621f', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))) : (h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), bed && h("p", { key: 'b6cc9e9ff3b119bf36f33e69e7c9c95777dbd34a', class: "m-0 p-0" }, "(", bed, ")")), h("div", { key: '3c5b26df79a9375ed88ca924e4b776ed9e2fb524', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, h("div", { key: 'f9d2ab3296a7e06c72480fc3a4c1b1bb9a9caf08', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: 'b33ab5ea80e6e0c0de59e41d59b51f39ea930549', class: " sm-padding-top" }, h("p", { key: 'aea95401f539ce5e0a2105f53dbd195e82901731', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '0f2ed29bc507c3055f6c8e8cc56ed5a5c1d13b87', class: 'flex-fill' }, h("table", { key: 'adec0cb1a3e377a28cd7929218106f845b00246b' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: 'f67aaa5d27133040e9e8a8c53d1b1769b6d0776d', class: '' }, h("th", { key: '6841e1a6c5c3ef3d0925c418d5e13a4a8a0bde09', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '6a65d3a37efbfeac05762e106b3aedd582261b33', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: '36599544dcdf1279ea6a59401182db6e1817f65f', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '22ea344f5d5c6a1a109f46b6e5805389b902a62c', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: '03205fa980f7fcd449b97d17484d1e11f66e4f33' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'fd3052c8c4f5bbc8d8b4ecb2328ddaadf842ac1c', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '7e9a1d05f021f633f173977977796ec842ebcfa8', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '1460e174fffd7d2ec4574e60a876ec9747e8c17c' }, h("ir-label", { key: '5f65d7d8631c8c124ef4b0388c1cf5f81805e36c', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '2743e312e285bf0b8b630b5e80cb18368cd7ccbb', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), h("ir-modal", { key: 'be01110d4c531278205f2685711cca71fdf2a44e', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: 'b06e702da7ef2fbe122dd27124a7c12d3c54a3ef', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '70f6250ead7a5c927f6b2de55bcb972f34e65a19', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: 'aee3da129ede1e1804289c70d8b6ede1942dc746', class: 'sidebar-title' }, h("p", { key: 'a6738da19d1c22dbd766ab7c2c50358f2a15053b', class: 'p-0 m-0' }, this.label), h("div", { key: 'a148e987a0597ce77455ded18ad59afb56c3e963', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '47a4b1d84ba7718a99fd7b5a08821b3145301b4d', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'fc9103fa1d3b6061e83cf736f8c10749028ad3ed', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: 'e6d60f43f239552cc16ca6a921f1039269adb5c0', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '4d4aea8e6f2159618ffebdf581052b5fe205019f', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: 'b140ccd89afbe57d75745dedecc2ae8e05c0d0fb' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (h(Host, { key: '9487c802a411e9307ecc5fa52258364f0fe0b766' }, h("h4", { key: '3c590bd644a8bbb4ec26002017816f7090ee785c', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: '72b0d565c18b69cbb4fe4f66d0472300a3a059f8', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '9898f5926ec9903df3f1d8ea1414671603129748', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '013bbfad055cbb0e7ff46ca0d792e7b70bdc5870', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: '26335635bf54b38353bf1ac8c4e0227b59a57bc1', class: 'title-body' }, h("slot", { key: '5fc59b0e980cc770e19c3b13f18a02827fa70409', name: "title-body" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: '147f27d122dff64feb117215f36a4c1773e2d714' });
    }
    get element() { return getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'd7ba75702a996401892b837d8294d661dc383b41', class: "m-0 p-0" }, h("span", { key: '1dcd9214d32b2320d2605915622943f78cfd3928', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (h("slot", { name: "tooltip-trigger" }))), this.open && (h("div", { key: 'b83e876efb75d8d3790267a1d53e705618bd776b', class: "tooltip bottom show position-absolute", role: "tooltip" }, h("div", { key: 'ba404895aa8e16f3682c529d26bcb04732b53f63', class: "tooltip-arrow" }), h("div", { key: '6488b7de6fc0a5e65f9cdde7b6a377bac2d713e4', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, h("span", { key: 'f7e98f30c67032124263e77b32a3b3eae630465a', innerHTML: this.message }))))));
    }
};
...
export { IglApplicationInfo as igl_application_info, IglBlockDatesView as igl_block_dates_view, IglBookProperty as igl_book_property, IglBookPropertyFooter as igl_book_property_footer, IglBookPropertyHeader as igl_book_property_header, IglBookingForm as igl_booking_form, IglBookingOverviewPage as igl_booking_overview_page, IglDateRange as igl_date_range, IglPropertyBookedBy as igl_property_booked_by, IglRatePlan as igl_rate_plan, IglRoomType as igl_room_type, IrAutocomplete as ir_autocomplete, IrBookingDetails as ir_booking_details, IrBookingExtraNote as ir_booking_extra_note, IrBookingHeader as ir_booking_header, IrButton as ir_button, IrCheckbox as ir_checkbox, IrCombobox as ir_combobox, IrCommon as ir_common, IrCountryPicker as ir_country_picker, IrDatePicker as ir_date_picker, IrDateRange as ir_date_range, IrDateView as ir_date_view, IrDialog as ir_dialog, IrEventsLog as ir_events_log, IrExtraService as ir_extra_service, IrExtraServiceConfig as ir_extra_service_config, IrExtraServices as ir_extra_services, GuestInfo as ir_guest_info, IrHkArchive as ir_hk_archive, IrHkTasks as ir_hk_tasks, IrIcon as ir_icon, IrIcons as ir_icons, IrInputText as ir_input_text, IrInterceptor as ir_interceptor, IrLabel as ir_label, IrLoadingScreen as ir_loading_screen, IrModal as ir_modal, IrPaymentActions as ir_payment_actions, IrPaymentDetails as ir_payment_details, IrPhoneInput as ir_phone_input, IrPickup as ir_pickup, IrPickupView as ir_pickup_view, IrPmsLogs as ir_pms_logs, IrPriceInput as ir_price_input, IrRangePicker as ir_range_picker, IrReservationInformation as ir_reservation_information, IrRoom as ir_room, IrRoomGuests as ir_room_guests, IrSelect as ir_select, IrSidebar as ir_sidebar, IrSpinner as ir_spinner, IrTasksFilters as ir_tasks_filters, IrTasksHeader as ir_tasks_header, IrTasksTable as ir_tasks_table, IrTextArea as ir_textarea, IrTitle as ir_title, IrToast as ir_toast, IrTooltip as ir_tooltip, OtaLabel as ota_label };
//# sourceMappingURL=igl-application-info.igl-block-dates-view.igl-book-property.igl-book-property-footer.igl-book-property-header.igl-booking-form.igl-booking-overview-page.igl-date-range.igl-property-booked-by.igl-rate-plan.igl-room-type.ir-autocomplete.ir-booking-details.ir-booking-extra-note.ir-booking-header.ir-button.ir-checkbox.ir-combobox.ir-common.ir-country-picker.ir-date-picker.ir-date-range.ir-date-view.ir-dialog.ir-events-log.ir-extra-service.ir-extra-service-config.ir-extra-services.ir-guest-info.ir-hk-archive.ir-hk-tasks.ir-icon.ir-icons.ir-input-text.ir-interceptor.ir-label.ir-loading-screen.ir-modal.ir-payment-actions.ir-payment-details.ir-phone-input.ir-pickup.ir-pickup-view.ir-pms-logs.ir-price-input.ir-range-picker.ir-reservation-information.ir-room.ir-room-guests.ir-select.ir-sidebar.ir-spinner.ir-tasks-filters.ir-tasks-header.ir-tasks-table.ir-textarea.ir-title.ir-toast.ir-tooltip.ota-label.entry.js.map
