...
import { B as BookingService, b as booking_store, f as resetBookingStore } from './booking.store-ef9a5f54.js';
import { g as getReleaseHoursString, l as isBlockUnit, m as checkMealPlan, f as formatAmount, F as isWeekend, j as dateToFormattedString, q as getDaysArray, w as formatDate } from './utils-e8aa1a47.js';
import { b as buildSplitIndex, m as getSplitRole, c as calculateDaysBetweenDates, t as transformNewBooking, d as calendar_dates, n as compareTime, o as createDateWithOffsetAndHour } from './booking-185fbb59.js';
...
import { P as PropertyService, E as ExposedRectifierParamsSchema } from './property.service-ce147732.js';
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '840084123fa60608d4fdfe203968e07b133b7ce6', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'f4a6dfb6f960e4e3f1c969f4e6f29038556cc9b6', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '57973106def1acddab1b1ba50a19b73316692311', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '5615dc20542089cb073cedbbc6d4d9ce090d349e', class: `ir-alert-header` }, h("p", { key: '2e879696926d5ac59a3599e1bd9919bd6f9b8d58' }, this.modalTitle))), h("div", { key: 'f23ebca9bb9baf29b22f73c3cb8b974ebf622597', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '09c5a1b4e2cbcb2a2e8602fc850bffffaa7e6e41' }, this.modalBody)), h("div", { key: 'd312d08cc2553305b0d14680991ff0dbea308884', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '14b1fd98566c7cceeac953a4ba400ecb3ba79cae', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: 'bc1966b8b7e0937d2a8b900c5f49048ff5aa090c', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '93a7639fee54632bfac0c91a52768d1a10bbc403', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
