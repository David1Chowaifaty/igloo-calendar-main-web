...
import { B as BookingService, r as resetBookingStore } from './booking.service-d0257568.js';
import { p as getReleaseHoursString, i as isBlockUnit, w as checkMealPlan, f as formatAmount, x as isWeekend, d as dateToFormattedString, y as getDaysArray, z as convertDatePrice, A as formatDate } from './utils-10b07e46.js';
import { l as buildSplitIndex, m as getSplitRole, c as calculateDaysBetweenDates, t as transformNewBooking, a as calendar_dates, n as compareTime, o as createDateWithOffsetAndHour } from './booking-39d48b06.js';
...
import { P as PropertyService, E as ExposedRectifierParamsSchema } from './property.service-0105a844.js';
...
const IglLegend = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'bcffb2dd969769f13c5fc82c7823dc1b910abc38', class: "legendContainer text-left" }, h("div", { key: '55f684aacda6d68e16fb8d466a5c67ac9edb4cdd', class: "fd-legend__header" }, h("h2", { key: '6f5aef16f841badc9d7422db7404a5d56fdbe2fa', class: "fd-legend__title", id: "legend-title" }, locales.entries.Lcz_Legend), h("ir-custom-button", { key: '571a8335fb097e556fef71cdc973a093b7e56340', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, h("wa-icon", { key: '3d3f8608a9bb4c869522f894f321cbda7cc54aa5', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), h("section", { key: 'a2f3a18341d94b2f642dfb548b7abc3daa743d0a', class: "fd-legend__body" }, h("div", { key: '5fb531bbdb50cdda99445f27334142c0d967db98' }, legend.map(legendInfo => {
        ...
        }), h("div", { key: '7a5564d65ef1762ee2ceb3a0f95428c32a0b60f1', class: "fd-legend__row" }, h("div", { key: '5f85d879d1d5a35bfce782e6ddc230377a8bbb0b', class: 'fd-legend__shape' }, h("wa-icon", { key: '4c963216c433e09ec71c2ace21bd2e1dfb3d8b4a', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), h("p", { key: '3505c10ef8709474e1a8ad317806e40adc850544', class: "fd-legend__row-title" }, "Housekeeping reported issue")), h("wa-divider", { key: '4c707bffe203c78607667cd03c38be3336e3ea85' }), h("h5", { key: 'bfb47585626f14c1696aef01ce7e6ad276964f97', class: "fd-legend__section-title" }, "Use custom colors"), calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index) => {
        ...
        })), h("wa-divider", { key: '20245de92527c567a2f3e6166348eb28777ccd0d' }), h("div", { key: '61fcdd8c935ea2effbfaa30c712dd4be893abeb3' }, h("div", { key: '45ec18cefb4b49af980482806c43d47f4041aa36', class: "legendCalendar" }, h("div", { key: '38a13a8f310fbc42ca727c9eb45672c01056b8b8', class: "legendRow align-items-center" }, h("div", { key: '3501a0e52a6d7ec7ee17cbea7dcebf81334895b4', class: "legendCal br-t br-s br-bt" }, h("strong", { key: 'ff3f1dc62e8712854a559729e8670a77f927efb0' }, "MAR 2022")), h("div", { key: '207e62133cdbcd1e4e5cf9e294cf08aa5f6cd68c', class: "hyphenLegend" }, locales.entries.Lcz_MonthAndYear)), h("div", { key: '92d6973e9810a7cc0162c00dfe2cb1d555935778', class: "legendRow" }, h("div", { key: '653bc4e9b49b22c0cfa165d9dd75b4125ac23fe2', class: "legendCal headerCell align-items-center br-s" }, h("wa-badge", { key: '1932979744b9c7fc6feb5462d207db04427952ca', pill: true }, "3")), h("div", { key: 'd3269d710d23b1f3fc2c7734be351b2424d54f04', class: "hyphenLegend" }, h("div", { key: '3796a9ffba86663e89673f962a98c4483f05e22a' }, locales.entries.Lcz_UnassignedUnits))), h("div", { key: '6bad5e49dd0e5e65a55af4c9514866c1de6c8ecc', class: "legendRow" }, h("div", { key: 'cc2140e0742c7819147f55500b21afffcf6f5c6c', class: "legendCal dayTitle br-s" }, "Fri 18"), h("div", { key: 'b2407f8e7fc7fd430f5904683cd2124fb5066bc3', class: "hyphenLegend" }, locales.entries.Lcz_Date)), h("div", { key: 'dff8255450685b255b3396ca8c9b06401e615989', class: "legendRow" }, h("div", { key: '52675271b20addb319f2a315bd8855b488719511', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), h("div", { key: 'd61ac51c020a7931f362b075ba6103448a10257d', class: "hyphenLegend" }, locales.entries.Lcz_Occupancy)), h("div", { key: '220fbcdd5da893251e3d5a1b86b76007ba283b5b', class: "legendRow" }, h("div", { key: '273efd7d38a0b8a1c6c751ce8dfe906568c55001', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), h("div", { key: 'fe3debc4bbe93f494964107d9eb73acf1a80d08c', class: "hyphenLegend" }, locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '905e42b3eb0e7ee360dcb1aed2cac36c10e646bb', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'edd25f0336904030770f4c252f6b4ea5d412c6aa', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '0f0801a429dfeb312ddda44b92113edcfe13e9ad', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '9e2d78a9bde72308b6bb60bbded1d01599b2143b', class: `ir-alert-header` }, h("p", { key: '2a172bdb9152c7885d4d85bd71ff5da0e4022f45' }, this.modalTitle))), h("div", { key: '7bb97d93c002d2b565ae4c60843bfa45cd44d726', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '06da6d5f5734e259bdd6d5a7f24d019f72b0861c' }, this.modalBody)), h("div", { key: '4b0f3945392e223eb34fea2244a7ac9e7270a3ce', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '932d87474409d8cb2a91fe7ec2eaf5ed3780c9ed', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: '7b0f3d900f4d4dc76fe8f5e5daa7a5dbc47aae76', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: 'da6ba4cbc53e019630213624694076d2e58972b9', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
