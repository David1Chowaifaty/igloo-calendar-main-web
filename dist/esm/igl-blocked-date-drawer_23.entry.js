import { r as registerInstance, c as createEvent, h, d as getElement, F as Fragment, H as Host } from './index-JbQjGrUG.js';
import { B as BookingService, b as booking_store, r as resetBookingStore } from './booking.store-3Tubbm72.js';
import { g as getReleaseHoursString, n as isBlockUnit, k as showToast, f as checkMealPlan, i as formatAmount, B as isWeekend, d as dateToFormattedString, r as getDaysArray, u as formatDate } from './utils-AafVtJtY.js';
import { f as buildSplitIndex, h as getSplitRole, c as calculateDaysBetweenDates, t as transformNewBooking, e as calendar_dates, a as compareTime, b as createDateWithOffsetAndHour } from './booking-BamW7Ksy.js';
...
import { h as handleUnAssignedDatesChange, g as getUnassignedDates } from './unassigned_dates.store-CZ7KRsd2.js';
import { H as HouseKeepingService } from './housekeeping.service-C_PQyfkM.js';
import { P as PropertyService, E as ExposedRectifierParamsSchema } from './index-6po2_28m.js';
...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '3979e3dc6b92fb5e9cb7e7c1c37ccc41c31959dd', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (h("igl-block-dates-view", { key: '6abbf6957be6fa4acd1f5c863006ec3a80f3a98f', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), h("div", { key: '2b0390453f81e30d86038fa2bca41cbd61a6a07e', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'a3f44ee853962385f3f428f00d290aa7a0766375', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), h("ir-custom-button", { key: '82087bd131060d393f3ae21d031256f7904a61af', loading: this.isLoading, onClickHandler: () => {
...
const IglCalFooter = class {
    ...
    render() {
        return (h(Host, { key: '321fc2eb9c0eff545f6ca211510e68b2943b0017', class: "footerContainer" }, h("div", { key: 'afe0b7812689ade742e8483783de84152e9b26f1', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, h("button", { key: '027862087bfabe7999979aac39a9ebe8933bfe60', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), h("span", { key: '22665d6d0060c64f855cff298764b2caaaa7ab63' }, locales.entries.Lcz_Legend), h("span", { key: '4e020290d03b01678d916458fb19501048e19bfe' }, "v1.53"))), this.calendarData.days.map(dayInfo => (h("div", { class: "footerCell align-items-center" }, h("div", { class: {
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6ca91f9996cf148fbb2c119852823164efa43a12' }, h("div", { key: '87b5f8e5d299fece3eca6ebab29dd79ca5970fcb', class: "tba-panel" }, h("div", { key: '4b1e9fdbe686fd3a85948f42db396ec192e5dc8d', class: "tba-panel__head" }, h("header", { key: '6ccb2e65a56866ab2cb7ce1e1928b3630f0a7202', class: "tba-panel__header" }, h("h2", { key: 'c8e5b0b7bbe63dbbf996e2e58e9133a304f7afd5', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: 'e6c2b05b8b48766807a86a5bbb980db5901f5e5a', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: 'd0d9e45740bf51e37ecab626259a90dd14dd1819', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: '468ab278d766a5acf9902ca527e394e053237a39', class: "tba-panel__toolbar" }, h("wa-select", { key: '3e2092d1dcb50941e23e253f9bb1ca7ebb940156', size: "s", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: '592fe41f0fa4b49915547285d92a81ba538cece0', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '907b2ffc62f1e4434e118bfddbbb5ae8a6196955', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '0770e7fa43804217219f9a9c2773b44f6f35e1e5', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '6ea21cb262f64c3706792659338fd35c896e399c', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'cadb6deeb8ddb75029fa1012700c8151b03c84cc', class: `ir-alert-header` }, h("p", { key: '5451077f8ea125a79fd646d80fcc614dbe66504e' }, this.modalTitle))), h("div", { key: '40bb6a42f2e46837cb47a4dc8d152512986a30e0', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'd051b9fc20629886465e8d322d11e28f9767b87a' }, this.modalBody)), h("div", { key: '5d4eae13e72e7718ca7d2adc0083e04b5063a4c9', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '46f8b28a21ff4a09f79192eed3083ceb973bf619', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: '6be88308aa44ad9c82ad36410a74a0c9e2752526', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '3a4ab1b639a3379b12ec7271e7f9547ad0f3bb92', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (h("div", { key: '94cba3555b0055dedfef460a1a5d6a7f98c7fd17', class: "input-group" }, h("label", { key: '64a66113bc0eac15986008797981c15f8e94d47a', class: "check-container radio-container align-items-center m-0 py-0" }, h("span", { key: '7fde36a99a730843a4b784221cfd6ebe2b4da02e' }, this.label), h("input", { key: '483397f52c8a16b0ecb184535b32a949e505b98e', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), h("span", { key: 'c7b695193b0549a81f10098ae2005d105606fddb', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
