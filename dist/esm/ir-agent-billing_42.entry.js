import { r as registerInstance, h, H as Host, c as createEvent, a as getElement, F as Fragment } from './index-DCCEVrU4.js';
import { C as CityLedgerService } from './index-Cm0fSMxQ.js';
import { c as calendar_data, i as isSingleUnit } from './calendar-data-B7ocnCQe.js';
import { T as Token } from './Token-CkxFIO_J.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { i as formatAmount, g as getReleaseHoursString, H as toFloat, n as showToast, a as canCheckout, c as canCheckIn, R as ROOM_IN_OUT, o as getEntryValue, I as ExtraServiceSchema, j as downloadFile, J as renderTime, K as validateSharedPerson, Z as ZSharedPerson } from './utils-DK1ZYV0C.js';
import { l as locales } from './locales.store-DkjT6ou2.js';
import { B as BookingService, g as updateBookedByGuest, b as booking_store, s as setBookingDraft, e as setBookingSelectOptions, r as resetBookingStore, n as getReservedRooms, d as resetReserved, o as hasAtLeastOneRoomSelected } from './booking.service-B4SIj2Et.js';
import { i as isAgentMode, _ as _formatTime, a as _formatDate, b as _getDay } from './functions-81yL-Vms.js';
import { a as actionableClTypes, m as mapClTxToFolioRow } from './city-ledger.service-Bx9pFBTk.js';
import { a as axios } from './axios-B50ozOIF.js';
import { R as RoomService } from './room.service-BDr5_XRp.js';
...
import { n as buildSplitIndex, d as getPrivateNote, h as formatName } from './booking-C7XExJX4.js';
import { A as AgentsService } from './agents.service-CfKXQqnt.js';
import { r as realtimeService } from './realtime.service-BLk631kq.js';
import { I as IRBookingEditorService, R as RoomsGuestsSchema, B as BookedByGuestSchema } from './ir-booking-editor.service-DIShRvKY.js';
import { I as InvoiceableItemReason, F as FdTypes, H as HbPreference, C as ClTxTypeCode } from './enums-qHq9uYOV.js';
import { t as taxationModes } from './property.service-CTafgdb_.js';
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: '40800b182bb362e970a239d6b4f81a178d9c660e', label: "Edit Arrival Time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, h("wa-select", { key: '5168f2a01a7a2928d7e3529f3cf8db7373a19d6e', size: "s", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), h("div", { key: '0d5dc27ff4f173dfef0acc4fd6a5adc5dd6c3b6f', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '171402bfa4bcc69f95edb8ec8b2356a7ee1476ab', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'd5ac971299a4d3cfd4ddd95937ad977f278a79b3', size: "m", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales.entries.Lcz_Save))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (h("ir-drawer", { key: 'b15b6fb6deb116122893d53a60ef1d0e08dc60a0', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && h("ir-billing", { key: 'd55e595c8cb242e1fd48986e55c08a5e91dfe7de', isAllServicesAgentOwned: this.isAllServicesAgentOwned, booking: this.booking, agent: this.agent })));
    }
};
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'b1399c1db372fa0e251876bec3fea58a1e56471b', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (h("ir-booking-editor", { key: '820389c4de5130f3566955d57d9e717ff602fd7f', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), h("div", { key: '18b60ad42410771c3a3fa8204b0607a3f4272a36', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
        "ticket": [{
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (h("ir-dialog", { key: 'bea81109c0bdbb750983cb8acd9ced98f3437d6c', label: "Private Note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, h("wa-textarea", { key: '016a024e104b25e269277e46aafc5b05d5a83e38', size: "s", placeholder: locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), h("div", { key: 'a58b2ecb81cc74b2b934b6ca7dfd5cf8b82e9334', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '9bafd05c65c901aca67ab994145f9c092eeb9dc1', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'a4c6a0ff73d8ad625a3e7274a5c19095b96b0d91', size: "m", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales.entries.Lcz_Save))));
    }
};
...
const IrBookingPricingDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '1983990c7487cabdff51f5ab21f4814eacf479a1', open: this.open, label: this.drawerLabel, style: {
            ...
            } }, this.open && (h("ir-booking-pricing-form", { key: '503111301de63ced3927c83326ad9b17bc06500a', formId: this.formId, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.folioEntries, currencySymbol: this.currencySymbol, onPricingSaved: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } })), h("div", { key: 'f44110499eea845c3d923bae0e07fe4499270f77', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '44ad417bf1a9d3790f39474f062a7626c918d4a9', appearance: "filled", size: "m", variant: "neutral", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), h("ir-custom-button", { key: '1448963d3ffbc605a01def90d24476310f962a9f', form: this.formId, size: "m", type: "submit", variant: "brand", loading: this.saveDisabled, disabled: this.allItemsDisabled }, "Confirm"))));
    }
};
...
const IrBookingSourceEditorDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: 'c1ac73a916c75b300c35695b95b5a4028439bbc3', label: "Change Booking Source", onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, open: this.open }, this.open && (h("ir-booking-source-editor-form", { key: '8d8e8f19cc0070345a834a65b24c6e112409e747', booking: this.booking, onBookingSourceSaved: () => {
                this.closeDialog();
                setTimeout(() => this.resetBookingEvt.emit(null), 100);
            }, onLoadingChange: e => (this.isLoading = e.detail) })), h("div", { key: '8069b2b2e425c18268bffb9c5bf36fe044de5c95', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'e58c863a63a2a3c349fb69b8473d4a0575f3806c', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, "Cancel"), h("ir-custom-button", { key: 'fa22f0557aba8a5d937b2a3bb42db08aac094adb', type: "submit", form: `change-source-form-${this.booking?.booking_nbr}`, size: "m", appearance: "accent", variant: "brand", loading: this.isLoading }, "Save"))));
    }
};
...
const IrBookingSourceEditorForm = class {
    ...
    render() {
        ...
        return (h("form", { key: '36dbabda0851d2f49ef8f3f14171ba909ae2515b', id: `change-source-form-${this.booking?.booking_nbr}`, onSubmit: this.handleSubmit.bind(this) }, this.booking.agent === null && this.booking?.financial?.payments?.filter(p => !p.is_city_ledger)?.length > 0 && (h("wa-callout", { key: 'a5eebec837f59ebecee6dc906bf57cc7dfbc0b2d', size: "s", variant: "warning", style: { marginBottom: '1rem' } }, h("wa-icon", { key: 'cddf4a7706c31fd8ce7357b3d3cf03ce8fd7abb0', slot: "icon", name: "triangle-exclamation" }), "You have guest folio entries that may need to be removed and recreated in the agent folio.")), h("wa-select", { key: '977d6ec1fe8789b42237010f438751b5bca3e395', label: "New source", onchange: this.handleSelectChange.bind(this), size: "s", value: this.selectedSource?.id, defaultValue: this.selectedSource?.id }, calendar_data?.property?.allowed_booking_sources?.map(option => option.type === 'LABEL' ? (h("small", { key: option.id }, option.description)) : (h("wa-option", { key: option.id, value: option.id?.toString() }, option.description)))), isAssign && h("ir-booking-assign-items", { key: 'a28d391a448d13a3091825d0950af0c420417213', items: this.buildAssignableItems(), onBookingSelectionChange: e => (this.checkedItems = e.detail) })));
    }
    static get watchers() { return {
        "isLoading": [{
...
const IrClFiscalDocumentPreview = class {
    ...
    render() {
        return (h(Host, { key: 'de993893cf9f9951f6d2b276111ba4d9ecfd1a54' }, h("ir-preview-screen-dialog", { key: '7dc09f484b647fb96e296c997a94c8f77114088b', hideDefaultAction: true, open: this.request !== null, label: this.getDialogLabel(), action: "print", onOpenChanged: e => {
                if (!e.detail)
                    this.request = null;
            } }, h("div", { key: 'f487fb093c4cb38ec083bcb93611b8995750be5d', slot: "header-actions", class: "header-actions" }, this.request?.fdTypeCode === FdTypes.Draft && (h("ir-custom-button", { key: '91176d706103f8210e356e233b2d92e5f52ead07', onClickHandler: () => (this.showConvertDialog = true), variant: "brand", appearance: "accent" }, "Convert to invoice")), this.request?.url && (h("ir-custom-button", { key: '64159112bc088c22a8eab9ae0ef242acd18e466d', size: "m", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, h("wa-icon", { key: '8d43bae5986d37773f89abc79f315f2dc2fc5165', name: "download", style: { fontSize: '1.2rem' }, label: "Download PDF" })))), this.renderPreview()), h("ir-fd-confirm-dialog", { key: '19690fa67959c568cda474d05def72a038a7a875', open: this.showConvertDialog, action: "convert-to-invoice", docNumber: this.request?.documentNumber ?? 'this document', isConfirming: this.isConverting, onConfirmed: () => this.handleConvertConfirm(), onCancelled: () => (this.showConvertDialog = false) })));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1916d0710b2dc4b1f90d62ad4f2638c624ab14ef' }, h("div", { key: '0187b9cf13382b45e0c79a87ae632bfcf56abf3c', class: "es-row" }, h("div", { key: 'dfae20797a6b0bfef60f1595fcba0e2a0bf0326b', class: "es-content" }, h("p", { key: '112acf8ba1a54ec4809746d9b13d98b90532af17', class: "es-description" }, this.description), this.service.start_date ? (h("div", { class: "es-date" }, this.service.end_date ? (h("ir-date-view", { from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (h("span", null, hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))), statusTag)) : (statusTag)), h("div", { key: 'bdeba4048ea53b2ff858a56491ac261cb1e1a47a', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (h("div", { key: 'bad84d7039ab89886baaebdf9061ab09bbcbbc56', class: "es-pricing" }, h("p", { key: 'abdd421cd11aa989a2c0029766d723db79014c12', class: "es-price" }, formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && h("p", { key: '056cdbef750609c3e302f7ed5f68d543c4b66a4e', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), h("wa-dropdown", { key: '9e68dffd061bd54aad1709d3d1e898304d8fc511', "onwa-show": e => {
            ...
            } }, h("wa-button", { key: '4ef42c2382781318ad9171728f85dad265123951', class: "es-action-trigger", slot: "trigger", size: "s", appearance: "plain", id: `actions-room-${this.service.system_id}`, variant: "neutral" }, h("wa-icon", { key: '95acab19d1004f797d37e5240a20730553555fb8', class: "es-action-trigger-icon", label: "Actions", name: "ellipsis-vertical" })), h("wa-dropdown-item", { key: '50226732e7a24312e2d87bcfab04f1456d1b96a0', value: "edit" }, "Edit"), agentMode && h("wa-dropdown-item", { key: 'afe28107e6df89f32143ab518c1f322416d44f61', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), h("wa-dropdown-item", { key: '56c157be516c4d82f5d41ffcf235dafeb1c86a7b', value: "delete", variant: "danger" }, "Delete")))), h("ir-assignment-toggle-dialog", { key: 'c186db0d8d8a92724e636cfc7333a0ea0cd9428c', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, h("span", { key: '0caefeeaf75c331af54473d2b267ff00ff457c77', slot: "message" }, "Re-assign ", this.description, " ", h("br", { key: '583339f9abf17a1f149e838add04ddffd0765018' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", h("b", { key: '418d5ebfb4ad914dc6284f610c98b39594ecbcc2' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), h("ir-dialog", { key: 'cc6ba675209d72b4b6450cb6836d5378907a4f0e', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}`, h("div", { key: 'e481c80e7b3f0f875eae54963d33f8d3757481ae', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'ef4a06dd27a15129f09848dc4e1414e8c32dbac4', appearance: "filled", variant: "neutral", size: "m", "data-dialog": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '5932e192934bb53920b7ee281ebe8ee26d08048d', onClickHandler: () => this.deleteService(), loading: isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "m" }, locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'e0556a238b008008110cefbf707909ef3073b385', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales.entries.Lcz_ExtraServices }, this.open && (h("ir-extra-service-config-form", { key: 'fcd8e68c0c9e6ea5ee8f74defd9e77c0ae193f7c', language: this.language ?? 'en', svcCategories: this.svcCategories, onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, agent: this.agent, service: this.service })), h("div", { key: '550da388c3c9e387252ece116121e508e51116eb', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: '2291354ef26beec114c965190750610dc148f9b1', class: `flex-fill`, size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '24bb30c72be465fdd5788ca9ce245871d635807d', type: "submit", loading: isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "m", class: `flex-fill`, variant: "brand" }, locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (h("form", { key: '77d0d93a100bc867faf9dd514f104df957966d63', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (h("ir-validator", { key: '013f3ab8638e247b76c3217878760e26f0955472', value: this.s_service?.category, schema: ExtraServiceSchema.shape.category }, h("wa-select", { key: '36f93234d536e5da4efb343168088a34f06a76d1', size: "s", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), h("ir-validator", { key: '1dec7571317e5b268348508cb36cf5aaa2994e61', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, h("wa-textarea", { key: '558450dd76197c19fd12ce2d77c65b81ce496970', size: "s", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales.entries.Lcz_Description })), h("ir-validator", { key: 'd82ca1526ac50854f138daf21e1687f7aca314f9', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.start_date }, h("ir-date-select", { key: '9ce2391c2d1237c5d56cbbf57ee38388c3be236e', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), h("ir-date-select", { key: 'c01b246ea1ddcf0e567daac191914c25e0a79f71', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), h("ir-validator", { key: 'd80b27af6c565fa1407a0e49b297d8e40a5ff95d', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, h("ir-input", { key: '27a8d920e6c879f32e0f77cbb66c1ee9393b322a', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales.entries.Lcz_Price} (including tax)` }, h("span", { key: 'f4192fad5c24a02ed11e6548980e39e3e6d792c6', slot: "start" }, this.booking.currency.symbol))), h("ir-validator", { key: '7684c1b68dcc75a5c89563a9643344c8ab5710ed', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, h("ir-input", { key: '44a859380870cb249347a0ee8dab30f0377769eb', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales.entries.Lcz_Cost} (optional)` }, h("span", { key: 'b9da4dd6da730b2dd62e47234448e7731b136623', slot: "start" }, this.booking.currency.symbol))), isAgentMode(this.agent) && (h("ir-service-assignee-select", { key: 'f12a404b6b3c210d398ec05c8d090ffb8beab55b', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
        "service": [{
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (h("ir-drawer", { key: 'bd6e219323e163d1bccfa979c8f89578447fc4fe', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (h("ir-guest-info-form", { key: 'f6d84040926e334d1bdbfbdbdba9e97f698a6322', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), h("div", { key: '8097aa41001d1649d88fe7a46e36e5faa00b4f5b', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '9c0ef52a29d3a1599d922edc3e71d29640967c81', size: "m", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales.entries?.Lcz_Cancel || 'Cancel'), h("ir-custom-button", { key: '891d80303ac787ab44cad022f755821e4c322067', type: "submit", form: this._formId, size: "m", variant: "brand", loading: isRequestPending('/Edit_Exposed_Guest') }, locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (h("ir-drawer", { key: '6a2deee9502f67766c5f776ebcc8bcb13d4f37fa', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), h("div", { key: '22a3f1dd3a4cc7387cf1c5b33564d5e1a8ea6afd', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: '6cc421ed0d93708cf4582118f088eb006bde2af9', class: `flex-fill`, size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales.entries.Lcz_Cancel), this.canSubmitPickup && (h("ir-custom-button", { key: '7ebb1cac7b66a71de89adf21b2c1d27ae4de6238', type: "submit", loading: this.isLoading, form: this._id, size: "m", class: `flex-fill`, variant: "brand" }, locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (h("form", { key: 'bed0f64a835674556c3731758e45a0a9ffbf6646', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
            ...
            } }, h("ir-validator", { key: '9105e1ec5139afc93be1bdeaee4e5c77b11d08aa', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: 'b129623e64f09f1513ab501c23dc11ade6b42b6f', size: "s", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, h("wa-option", { key: '7775989683e092feee6f6e382d381644b7a0d867', value: "" }, locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom).map(option => (h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (h("div", { key: '2c9efec5aab3bad1bc4a348e67665909775270e7', class: "pickup__container", "data-testid": "pickup_body" }, h("ir-validator", { key: '94e0657d3225736169f871fa63acd61ad47fe61e', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, h("ir-date-select", { key: '40c178ed3ea29e4e4c887bcb8e8ed047f6d941ef', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales.entries.Lcz_ArrivalDate })), h("ir-validator", { key: '75bbb8124d42855425100ab67955313403821354', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-input", { key: '85ab3fd2f749bc8a75670a4f2499cf08f90291d0', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales.entries.Lcz_Time })), h("ir-validator", { key: 'b56941072d87f21e770c9a584d0d0bd394ac7e73', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-input", { key: '177526725149775e55329eedae11b371dc7f5342', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails })), h("ir-validator", { key: 'ff5f084272523c6e18d4d25eb62eac06d5a0e0db', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: 'c315c01d682f1dc67dcbb032dae7a36e84d0ae4e', size: "s", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), h("ir-validator", { key: 'd42894ac09178b72f0ecb65b7bf1dcc92ad493a8', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: 'ab69e38a5b17903fb68e2cfd3fcb6435d250cdf0', size: "s", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), h("ir-input", { key: 'a655a2d0a93c3cd67d88d8195ac511931fd937c2', mask: 'price', label: `${locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, h("span", { key: 'b9d21c7ff75199d31e7992acd0deeb720f5bbb71', slot: "start" }, this.pickupData.currency?.symbol)), isAgentMode(this.agent) && (h("ir-service-assignee-select", { key: '20acb3043db47fc1cc7e9fe7bf0a26e22e6eb544', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (h("ir-drawer", { key: '26c5a1d5ee530b01fcac8769937ad5397c2b3dd6', style: {
            ...
            } })), h("div", { key: '0657df80d9060a0192c1d62b4c0cf2041be8b263', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'a31a6d5a51098c1b65bd73da1155ead17bb69bdd', size: "m", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales?.entries?.Lcz_Cancel ?? 'Save'), h("ir-custom-button", { key: '248e1cde91d98fcaf2792d6a2b89c55881df029b', value: "save", loading: this.isLoading === 'save', size: "m", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (h("ir-custom-button", { key: 'b4841c82b95812b929f34ebfb89e54775b63ed38', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "m", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
