import { r as registerInstance, h, H as Host, c as createEvent, a as getElement, F as Fragment } from './index-BvoylR5O.js';
import { C as CityLedgerService } from './index-BPOK9fF7.js';
import { c as calendar_data, i as isSingleUnit } from './calendar-data-Cnv5ncgJ.js';
import { T as Token } from './Token-CkxFIO_J.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { i as formatAmount, g as getReleaseHoursString, G as toFloat, n as showToast, a as canCheckout, c as canCheckIn, R as ROOM_IN_OUT, o as getEntryValue, H as ExtraServiceSchema, j as downloadFile, I as renderTime, J as validateSharedPerson, Z as ZSharedPerson } from './utils-BDVP7IDp.js';
import { l as locales } from './locales.store-BZFQn8-s.js';
import { B as BookingService, g as updateBookedByGuest, b as booking_store, s as setBookingDraft, e as setBookingSelectOptions, r as resetBookingStore, n as getReservedRooms, d as resetReserved, o as hasAtLeastOneRoomSelected } from './booking.service-BY9sBcms.js';
import { i as isAgentMode, _ as _formatTime, a as _formatDate, b as _getDay } from './functions-81yL-Vms.js';
import { a as actionableClTypes, m as mapClTxToFolioRow } from './city-ledger.service-D00vg-ZI.js';
import { a as axios } from './axios-B50ozOIF.js';
import { R as RoomService } from './room.service-COwttt97.js';
...
import { f as buildSplitIndex, d as getPrivateNote, j as formatName } from './booking-ClyZOZZR.js';
import { A as AgentsService } from './agents.service-CfKXQqnt.js';
import { r as realtimeService } from './realtime.service-BLk631kq.js';
import { I as IRBookingEditorService, R as RoomsGuestsSchema, B as BookedByGuestSchema } from './ir-booking-editor.service-BlntBc0q.js';
import { I as InvoiceableItemReason, F as FdTypes, H as HbPreference, C as ClTxTypeCode } from './enums-Dv3168hx.js';
import { t as taxationModes } from './property.service-C2WesNVF.js';
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: '01663f2ee706abe6528e2c8c794742015167afd9', label: "Edit Arrival Time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, h("wa-select", { key: 'ba21fd85ba95f53f4d90679883930639f2471bc4', size: "s", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), h("div", { key: '08b1f61eb260bad16c89a74067d85af9278fa9cd', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '25dbc5545579665993950904fa21ddbae7bcbd5a', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '5c24848314d28986b609b5029b9bdd2b6e5286c7', size: "m", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales.entries.Lcz_Save))));
    }
};
...
const IrBookingCityLedger = class {
    ...
    renderRows() {
        ...
        return (h("div", { class: "folio-list" }, this.rows.map(row => {
            ...
            return (h("div", { key: row._rowId, class: "folio-row" }, h("div", { class: "folio-row__header" }, h("div", { class: "folio-row__meta" }, h("span", { class: "folio-row__date" }, hooks(row.serviceDate).format('MMM DD, YYYY'))), h("div", { class: "folio-row__right" }, h("span", { class: "folio-row__amount" }, row.debit !== null && h("span", { class: "is-debit" }, row.debit ? this.formatAmount(row.debit) : ''), row.credit !== null && h("span", { class: "is-credit" }, row.credit ? this.formatAmount(row.credit) : '')), showDropdown && (h("wa-dropdown", { "onwa-hide": e => {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                }, "onwa-select": e => {
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'c8cfeb40c05398474b68d34da0617811e4eab4c4', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (h("ir-booking-editor", { key: '9a3f0ca8b2bceb27597728ad4b59d9fea2dc1fff', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), h("div", { key: 'cad7c1379c14f57a00a1ec83b28d972bed1594e7', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
        "ticket": [{
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (h("ir-dialog", { key: '82c7a13ccb3e4323b1b67e0a852373587dea0876', label: "Private Note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, h("wa-textarea", { key: '5277e66bd47d5402b97720cb83dae07b13cda673', size: "s", placeholder: locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), h("div", { key: 'b1df5013f6ac12efa010a33f5d70155bb6a0f2e7', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'a456d33d817485de6b4dd27bacc0cf143939137e', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'ff3cec0ae16b90e9fe5d8087314ba317b78320f3', size: "m", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales.entries.Lcz_Save))));
    }
};
...
const IrBookingPricingDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '8db64f1ca693935f1059514bef50e3eb5c653dac', open: this.open, label: this.drawerLabel, style: {
            ...
            } }, this.open && (h("ir-booking-pricing-form", { key: 'a5f0496c0247849f0639ea3fb802d5dbd7293a24', formId: this.formId, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.folioEntries, currencySymbol: this.currencySymbol, onPricingSaved: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } })), h("div", { key: '5117c92678859790be9cbfbae7cdfe2c813fd6ef', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '90708abc49f19d3c07a29dff1971732a4d4d8827', appearance: "filled", size: "m", variant: "neutral", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), h("ir-custom-button", { key: '711936e8e50da1662392f8230abb1d5a3d361cda', form: this.formId, size: "m", type: "submit", variant: "brand", loading: this.saveDisabled, disabled: this.allItemsDisabled }, "Confirm"))));
    }
};
...
const IrBookingSourceEditorDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: '1f62c94da49ba5b84a95e9013af2122790ad11be', label: "Change Booking Source", onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, open: this.open }, this.open && (h("ir-booking-source-editor-form", { key: '387ac00324d1abf5e4ef3cd05056c03a09f8f396', booking: this.booking, onBookingSourceSaved: () => {
                this.closeDialog();
                setTimeout(() => this.resetBookingEvt.emit(null), 100);
            }, onLoadingChange: e => (this.isLoading = e.detail) })), h("div", { key: '433a8c1cf56e6c056e86c41cd55a52b3ae7ba616', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '4580efe46f43eddf09ff03e39dac0250ca43cf92', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, "Cancel"), h("ir-custom-button", { key: '97fe3812a8c6c4876272fae913c47e1e2f63acc2', type: "submit", form: `change-source-form-${this.booking?.booking_nbr}`, size: "m", appearance: "accent", variant: "brand", loading: this.isLoading }, "Save"))));
    }
};
...
const IrBookingSourceEditorForm = class {
    ...
    render() {
        ...
        return (h("form", { key: 'b5edc27bf3c157e2f28c68e75821598741d39609', id: `change-source-form-${this.booking?.booking_nbr}`, onSubmit: this.handleSubmit.bind(this) }, this.booking.agent === null && this.booking?.financial?.payments?.filter(p => !p.is_city_ledger)?.length > 0 && (h("wa-callout", { key: '2bf7138542229733d55c5d58f2931b2b7549785b', size: "s", variant: "warning", style: { marginBottom: '1rem' } }, h("wa-icon", { key: '2561308f04e38d6af14c4eb6b744d215f926d131', slot: "icon", name: "triangle-exclamation" }), "You have guest folio entries that may need to be removed and recreated in the agent folio.")), h("wa-select", { key: '2ccd0905464ade1186ca8468d8254cc35218df0a', label: "New source", onchange: this.handleSelectChange.bind(this), size: "s", value: this.selectedSource?.id, defaultValue: this.selectedSource?.id }, calendar_data?.property?.allowed_booking_sources?.map(option => option.type === 'LABEL' ? (h("small", { key: option.id }, option.description)) : (h("wa-option", { key: option.id, value: option.id?.toString() }, option.description)))), isAssign && h("ir-booking-assign-items", { key: '52fe7128b86b9ad4d8d092380ab93ce352f7a98c', items: this.buildAssignableItems(), onBookingSelectionChange: e => (this.checkedItems = e.detail) })));
    }
    static get watchers() { return {
        "isLoading": [{
...
const IrCityLedgerTransactionDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '6849fb0e81614f1d6a6de9c8d5465ff842c1e931', open: this.open, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                this.saveDisabled = e.detail;
            } })), h("div", { key: 'c5c2ed3cd5d2e52ef8919698578c128d4c0ec472', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: '9f9ce94e7d2a1fc00b81fcaa9db1ecac0c743d99', appearance: "filled", size: "m", variant: "neutral", class: "city-ledger-transaction-drawer__btn", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), h("ir-custom-button", { key: 'dc41fd18e32abcf9ee0c2d07862edf4da5dfded7', form: this.formId, size: "m", type: "submit", variant: "brand", class: "city-ledger-transaction-drawer__btn", disabled: this.saveDisabled }, "Save"))));
    }
};
...
const IrClFiscalDocumentPreview = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.documentConverted = createEvent(this, "documentConverted");
    }
    ticket;
    propertyId;
    request = null;
    ...
    render() {
        return (h(Host, { key: '9ca78249df6d20cb2a2c62e554e6296f6978a83a' }, h("ir-preview-screen-dialog", { key: '60e551c3eb30ab592db3622d81430c0a8f4e7783', hideDefaultAction: true, open: this.request !== null, label: this.getDialogLabel(), action: "print", onOpenChanged: e => {
                if (!e.detail)
                    this.request = null;
            } }, h("div", { key: 'a28fd39606b9c3d80b22edb0434fca68a569bb68', slot: "header-actions", class: "header-actions" }, this.request?.fdTypeCode === FdTypes.Draft && (h("ir-custom-button", { key: 'f9288fe58783636bcd2da18f6df97617c4a5bc9d', onClickHandler: () => (this.showConvertDialog = true), variant: "brand", appearance: "accent" }, "Convert to invoice")), this.request?.url && (h("ir-custom-button", { key: 'c64a029137be335bc19cce9f40772dc2e57675e3', size: "m", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, h("wa-icon", { key: '8bffcbbdf264ba953fbcdf4db4a7cc27b50a4bd6', name: "download", style: { fontSize: '1.2rem' }, label: "Download PDF" })))), this.renderPreview()), h("ir-fd-confirm-dialog", { key: 'f8649d6691398432508fb3b8b103a7dc81b6c366', open: this.showConvertDialog, action: "convert-to-invoice", docNumber: this.request?.documentNumber ?? 'this document', isConfirming: this.isConverting, onConfirmed: () => this.handleConvertConfirm(), onCancelled: () => (this.showConvertDialog = false) })));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (h(Host, { key: '6998d0c12a0632123f45d0c1dc70f3c88aa3e94f' }, h("div", { key: '69fff0d4b13e281b5e4a4597cf5c300fd50c58bc', class: "es-row" }, h("div", { key: '07a8e7e0ec6920ee6c90866a99ce9f216a9e6eb7', class: "es-content" }, h("p", { key: 'f169e8f00eeab2f22495fa3eabad6afcfceae5c9', class: "es-description" }, this.description), this.service.start_date ? (h("div", { class: "es-date" }, this.service.end_date ? (h("ir-date-view", { from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (h("span", null, hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))), statusTag)) : (statusTag)), h("div", { key: '1fe4c0bf879d16b2215382422524522decbd3580', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (h("div", { key: '4a32a23f5d0e146e5281707650d6f942c2a5a0af', class: "es-pricing" }, h("p", { key: '8d17126af7135081d7fc6b7537d671ed8d74b7be', class: "es-price" }, formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && h("p", { key: '09d2cd56a47fc396a2c64caff94821bc4d2efc61', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), h("wa-dropdown", { key: 'bb8b9f0f9fdd1a4ab75c882c54ffc622a6d515d7', "onwa-show": e => {
            ...
            } }, h("wa-button", { key: 'c9db50d7e2aedc178ea1415f0d70e4a5068bee1a', class: "es-action-trigger", slot: "trigger", size: "s", appearance: "plain", id: `actions-room-${this.service.system_id}`, variant: "neutral" }, h("wa-icon", { key: '7e0ea40d5afed67570536e1c9ef346b9da8aa226', class: "es-action-trigger-icon", label: "Actions", name: "ellipsis-vertical" })), h("wa-dropdown-item", { key: '549e9f1c9a14846b1df30278e0d7a692eb67243c', value: "edit" }, "Edit"), agentMode && h("wa-dropdown-item", { key: '4211e205414e9dcc0782c1e554b405ab7954d9a6', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), h("wa-dropdown-item", { key: '8729567ee185c5ba2218761446b3df1a195b79e7', value: "delete", variant: "danger" }, "Delete")))), h("ir-assignment-toggle-dialog", { key: 'a995116194f113f004e9987df73cb26ec66ebf94', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, h("span", { key: '4ee5034ef526e74343bbfdcdc4422fda63ac56eb', slot: "message" }, "Re-assign ", this.description, " ", h("br", { key: '38f57b9deaf6a6465d17e1cb31d18d5b18fc0b21' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", h("b", { key: 'acc6ff804564a3cc61a4dee8ebbe8df9c77ca556' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), h("ir-dialog", { key: '27693644916991e4c43224edddbd003a3334e35e', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}`, h("div", { key: 'e2e966ac8aa44fe683e3b26f0f8ffde3130ff9f1', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'f4c8887e8ebacd3ca0c30df00af7ca77adec2932', appearance: "filled", variant: "neutral", size: "m", "data-dialog": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'd76caaee9117dd69b81348efaf1a35db94007e77', onClickHandler: () => this.deleteService(), loading: isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "m" }, locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (h("form", { key: 'cf71dae7814dd35f9f4489296f3288f96e114249', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (h("ir-validator", { key: 'fa8645d005485bf617e91342cf563af0a5c78227', value: this.s_service?.category, schema: ExtraServiceSchema.shape.category }, h("wa-select", { key: 'd84680dd84ca7e8e1533aa5d8d6818da1baf7dbc', size: "s", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), h("ir-validator", { key: 'f7bdff098a903827faa07bf5701e686b6c83f4df', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, h("wa-textarea", { key: '1036a1882fd17bbdbf6255ee7518f3001189c359', size: "s", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales.entries.Lcz_Description })), h("ir-validator", { key: '802a0d6f797073a7ca610cbf25e2417443db09c7', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.start_date }, h("ir-date-select", { key: '0caedd8c0089a43d1967814c63490310d9058bca', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), h("ir-date-select", { key: '1cc33babd31105b130271f59662708ff60569e92', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), h("ir-validator", { key: 'd6bc60128d066d01a5c3aae9ff6a9fe9583d485a', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, h("ir-input", { key: 'dcc1b617fa0e18fa2a84bc6e1623c065efd8c6a1', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales.entries.Lcz_Price} (including tax)` }, h("span", { key: 'e4020e0446a8eda5b36421383b7272f6751d85a6', slot: "start" }, this.booking.currency.symbol))), h("ir-validator", { key: 'f58be532a533831d94ecec924bee0a86eebe385b', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, h("ir-input", { key: '99431b66dbb0beabcb6eb4f1d9e2a57553f41bb4', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales.entries.Lcz_Cost} (optional)` }, h("span", { key: '283b17d56c58aa5cd45fd3a51b787d086d800666', slot: "start" }, this.booking.currency.symbol))), isAgentMode(this.agent) && (h("ir-service-assignee-select", { key: '967d0a0a5e49b3f25ce9a5b8a289ee24f74a4f61', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
        "service": [{
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (h("ir-drawer", { key: '595777dff4ff65121937b4ed5f21491a37e99f27', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (h("ir-guest-info-form", { key: 'd57f3f423650a3642f142ff047d5064c21b6ae2f', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), h("div", { key: 'b2df9386fbe690477949a9963cbe72070f633797', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '370883476270595ddf44e437246ce7bca1b74aa9', size: "m", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales.entries?.Lcz_Cancel || 'Cancel'), h("ir-custom-button", { key: '432b2896d1f5b9cd7a6a49518652e31a4e47fadb', type: "submit", form: this._formId, size: "m", variant: "brand", loading: isRequestPending('/Edit_Exposed_Guest') }, locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrHbPreferenceDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: 'd208dbb10e197259037875193e658e5b4bdad912', open: this.open, label: "Meal Preference", ref: el => (this.dialogRef = el), onIrDialogHide: e => {
                e.preventDefault();
            ...
            } }, h("wa-radio-group", { key: 'cf1e7ae0ddf7585722991369a4e3971b2c361413', value: this.selectedValue ?? '', onchange: e => (this.selectedValue = e.target.value) }, h("wa-radio", { key: '12c5ab648d30a23465363492c064c405c90b9b81', value: HbPreference.Lunch }, "Lunch"), h("wa-radio", { key: '04b5c8283feb4a127c19bf27e1259db2f70d0eee', value: HbPreference.Dinner }, "Dinner")), h("div", { key: '96070db7d3e2b8d6fa03b60cafb84ea9e70c2d6a', slot: "footer", class: 'ir-dialog__footer' }, h("ir-custom-button", { key: '812d1bf4d44c1d96bfa706d27c9b4ff90cb3190d', size: "m", variant: "neutral", appearance: "filled", "data-dialog": "close" }, "Cancel"), h("ir-custom-button", { key: '578197783f2c1353443e803d4464df0daa13fc25', size: "m", variant: "brand", loading: this.isLoading, disabled: !this.selectedValue, onClickHandler: e => this.handleConfirm(e), appearance: "accent" }, "Confirm"))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (h("wa-card", { key: '22abd729415f24d262b52e18e91de89c2b843ff5', class: " payments-container" }, h("div", { key: 'bd8a77e5c155b46d43967812488dfc44497a3ba8', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: 'd26d9e805df63cb206c4ab6874dbcaf426f66e0a', class: "font-size-large p-0 m-0" }, "Guest Folio"), h(HelpDocButton, { key: 'e102e5a9c62204a09090cb303a55602061bf3ca4', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), !this.isAddPaymentDisabled && h("wa-tooltip", { key: '995a6925c16a958db94db0da02e0f8c495e1375f', for: "create-payment" }, "Add folio entry"), h("ir-custom-button", { key: 'd9a3fa0ed4c858d4cb66f051f501eddc38114c05', disabled: this.isAddPaymentDisabled, slot: "header-actions", id: "create-payment", size: "s", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, h("wa-icon", { key: '98c8da7c0b59f5bc9446df93acf4844382bde7b6', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (h("form", { key: '6643987be0a3ee06e8c1b969159ec1a0cc225b38', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-validator", { key: '5661122a54162329603f8d8bc6aa65b140590563', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '5a6cdb912259db5bd13c642a6ffe8121d5d8da47', size: "s", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, h("wa-option", { key: 'dfee6f8213441361f600fa5d964bee88f907618c', value: "" }, locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom).map(option => (h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (h("div", { key: 'da1fc6ce3d0de0b4515a2f564a5770c322fe08fb', class: "pickup__container", "data-testid": "pickup_body" }, h("ir-validator", { key: '71c1081146d797edddcd2d4564de0caf811b65c0', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, h("ir-date-select", { key: 'b494101e758ed2b1d841a5407401c9cf11a534a5', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales.entries.Lcz_ArrivalDate })), h("ir-validator", { key: 'ea66140a697615cc351840de3e8688eac8794f9a', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-input", { key: '35ec816c389a1576f71f09997bcb5cbc2aee4bd5', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales.entries.Lcz_Time })), h("ir-validator", { key: '936ce58c93ec0cdca544938028167cb44926e343', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-input", { key: '19202d8d2acc9bdd66394dead643e9104316a989', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails })), h("ir-validator", { key: '1589cc513c086d7987a6a3eacf406df5dd7ec927', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '6fbfe9c3ba175d0c402a67f018c7013b4195f4e6', size: "s", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), h("ir-validator", { key: '4e03d4ef3da06d3340dbd70dcb0dca68f34c2564', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '8bf52ffadac1a56c44d3df5cf65a5b27cb9fdfec', size: "s", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), h("ir-input", { key: '39618a52e03e09a57c7e8ae1d122ef6953c627dd', mask: 'price', label: `${locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, h("span", { key: '33bb0a0be6194d14c6648c6c0f42073e4f4a0236', slot: "start" }, this.pickupData.currency?.symbol)), isAgentMode(this.agent) && (h("ir-service-assignee-select", { key: 'dbf3227c81bf0234271c15f71e149607921f1599', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '40c53d2915bf899dc3b139fa228e7dea9a4973c4' }, h("div", { key: '237f19dad16f3f974d1a18c50d09e083ea484f1f', class: "booking-room__header-row" }, h("button", { key: '4dd09d6a9e8ced3caeef7ad9ae18112130b9aea4', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '712213a112d92e652e79bd50797b0dcc522c7508', name: "chevron-right" })), h("div", { key: 'e655f461ac095b6d8bcef30dcf9a98be11d7bc75', style: { width: '100%', cursor: 'default' } }, h("div", { key: '9bd167c77723b13a8e8a17214e25012063da1aca',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, h("div", { key: 'cf87639c0d5d37201a7f9666dbb0d09e0e8889bc', class: "booking-room__summary-row" }, h("p", { key: '228b226c67ddee22763e29fd2a7671cddb765a23', class: "booking-room__summary-text" }, h("span", { key: '80f117285b525f491fcdd13aa67f1dfa31db666d', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' ', this.isHalfBoard && (h("wa-button", { key: 'addfe4b965dcbfcb842a11260ba646758153c23d', size: "xs", class: "booking-room__meal-report-button", appearance: "filled", variant: this.room?.hb_preference ? 'brand' : 'warning', onClick: () => (this.isHbDialogOpen = true) }, this.room?.hb_preference === HbPreference.Lunch ? 'With lunch' : this.room?.hb_preference === HbPreference.Dinner ? 'With dinner' : 'Choose lunch or dinner'))), h("div", { key: '344741b63f572a5b8e3031768f79aa5b5031f4c4', class: "booking-room__price-row" }, h("span", { key: '94814982bdc0d4891805f19870cae3cadffad632', class: "booking-room__price" }, formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (h("div", { key: '9dab2baa23b0f2419c172c5d0425097391f0def0', class: "booking-room__actions" }, h("wa-dropdown", { key: 'b4d657ca249c928f07d01f025e8dd373f6f13340', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, h("ir-custom-button", { key: '40d07c5b858e4b1ee49fba41a68721f24b4dcc32', slot: "trigger", size: "s", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, h("wa-icon", { key: '224e2d8ae97ff95fecace25e40d24baaf8f95dcf', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && h("wa-dropdown-item", { key: 'ff64713342afedbb523c6c3a91c54fa31576fd0d', value: "edit" }, "Edit unit"), this.hasRoomEdit && h("wa-dropdown-item", { key: '020680ccd8d3bf46119d677f2c6d6be49f959b11', value: "edit-rates" }, "Edit nightly rates"), isAgentMode(this.agent) && this.hasRoomEdit && h("wa-dropdown-item", { key: 'c5d2e8f23950d0c0ca4cb70a212d768fe874563b', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (h("wa-dropdown-item", { key: 'f0abc66728492269e87d6d762b53c2de6a23331f', value: "delete", variant: "danger" }, "Delete"))))))), h("div", { key: '5d87534c47e233d1c6201a3bc42a096d0a35ca15', class: "booking-room__dates-row" }, h("ir-date-view", { key: '2436c22351179acd1b385e1f3c93237f24a7e6f5', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        h("ir-unit-tag", { key: 'c8a0b311a8133b46186e66c819734489ac3f9067', unit: this.room.unit.name })), this.hasCheckIn && (h("ir-custom-button", { key: 'ef7154e590fd027bace2ceb45e0b72d61e0a90b5', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales.entries.Lcz_CheckIn)), this.hasCheckOut && (h("ir-custom-button", { key: '2efe9e711e9fb874eb13cc0f0baa9c862ee830f2', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales.entries.Lcz_CheckOut))), h("div", { key: 'bfcd03a2382801b25a256603bc1f2e0a2384bfd4', class: "booking-room__guest-row" }, h("p", { key: '3be66b6f20440140346c12bb3194f87cec5015c6', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h(Fragment, null, h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: 'c03d64f87299a69bb33acf4c6cb09444f50f6e16', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (h("div", { key: 'd3657b17989802ab049205a123cbfc9d840423d8', class: "booking-room__departure-row" }, h("p", { key: 'c52509ee86efc685a7d0cd9e9de5028227c69b1f', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), h("wa-select", { key: '9f81c9de7caf1859390f4e0926bee41fbd6fbe3e', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "s", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (h("div", { key: '73651e265571d7b510d741f788140eeed931eb6a', class: "booking-room__details-container" }, h("div", { key: 'b60c068e658cc118f1ba3e1657527e3ef7eb0559', class: "booking-room__breakdown-row" }, h("div", { key: '877f08a36f9116544603eba95eb44f48bd601e92', class: "booking-room__breakdown-table" }, h("table", { key: 'b821bc53a6e7e58deb89864d51ae9bb92dd04acc' }, this.room.days.length > 0 &&
            (() => {
            ...
            })(), h("tr", { key: '17a42f629dfaa6cbee73e4862cfc04525aae4bf3', class: '' }, h("th", { key: 'e9ab7026dfbfc82faec8239d9d4b9892d4d50136', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '63f9c5288261f42a3c62f27c479311f759be9fd7', class: "booking-room__cell booking-room__cell--right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (h("th", { key: 'f42aa38259176bdf65003451b133d18e1e2be3e0', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (h(Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), h("ir-label", { key: 'e3882fc930e0e434b2738522e0c5d80e5e85c1b9', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: '0d1a984260d0f99b2de0326faf060afedb24ec9c' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'd060f2b3363c3539adfcff0e255799d6b5f76b93', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '787b44e4df0de2b7f23eb0b7daac9b6cd45207cb', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '8a6488be7d2c156129a0fd0aacc366ad3d40269e' }, h("ir-label", { key: '4fa802cfc0b04bd68b6bcbc6efc90b07f37b2d1b', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: 'd2279cc8d19095c1a857e2fa886bdf82b8f53d6c', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), h("ir-assignment-toggle-dialog", { key: '6bff5c7dc1b97b77b500dbebd8578bb73d981f61', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, h("span", { key: '54b6ef784388df468a24e409ac5f413336cc79c6', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', h("b", { key: '143ccb2fd3830f8cdfd390533ada9846294b6073' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), h("ir-dialog", { key: 'd99db72d833db3cafe031ccc57a6716147fa5e1b', label: this.modalReason === 'delete' ? 'Alert' : locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, h("p", { key: '62630cf29d5424f762b890935c892dadc77d15c6' }, this.renderModalMessage()), h("div", { key: '9750b0cf1b4d5d79424f4bb26805330dda10a086', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '85076eba16f09cd315923e08565c1bf93f124b5c', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'a43e4a44a6250c8dac10255d46f8583823dae865', size: "m", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm))), h("ir-checkout-dialog", { key: 'f669ffb2d2a603b6d6a4c594a7c2e1613c020fe5', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), h("ir-invoice", { key: '02f079508fd1e46da715dcf6dae7876d6d96e905', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, open: this.isOpen, booking: this.booking, roomIdentifier: this.room.identifier }), h("ir-booking-pricing-drawer", { key: '3e5135bd8e1fa5238a0913d730f0d40ef52f7bea', open: this.isPricingDrawerOpen, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.clTransactions, currencySymbol: this.booking?.currency?.symbol ?? '', onCloseDrawer: () => (this.isPricingDrawerOpen = false), onPricingSaved: () => {
                this.isPricingDrawerOpen = false;
                this.resetBookingEvt.emit(null);
            } }), h("ir-hb-preference-dialog", { key: '6abe39f752414f445cd2d1e32c4ac7f28aa92384', room: this.room, open: this.isHbDialogOpen, onHbPreferenceClose: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
