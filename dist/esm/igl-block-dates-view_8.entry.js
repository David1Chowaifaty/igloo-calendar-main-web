...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'faab7568e423cee3e885ac3c0284da4c1ca14102' }, h("div", { key: '4741c264172629af07cd0e2074f8707cbfa8dd66', class: "form-group mr-0" }, h("div", { key: 'a034e8c94f897c449017c14dd0ad79980dde9db2', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (h("div", { key: 'e708766719a6a8559b307183ec9641f11c6fea1a', class: `input-group-prepend col-3 p-0 text-dark border-none` }, h("label", { key: '916545a6596eba53a95d6d004ed9bb31c5385996', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), h("div", { key: 'b513840bc3f345d41be686c67ec991b8cb0f3694', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, h("button", { key: '613872268bc3f08d74cb4abdf69211711b2964a2', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : h("p", { class: "p-0 m-0 " }, locales.entries.Lcz_Select), h("svg", { key: '6f6e850298bfcb42eda9dc657a9db2aed76db6a2', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '7004f666583812afd35f59dba924463bb1994e53', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), h("p", { key: '403beb72a22033d9ae2d88d38880c52a32b3f37a', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (h("label", { key: '4754c6b82055ce5ec2658e69684cd7927a02b0a1', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), h("input", { key: 'b0258e2cb505007105148f5ba01f8cbd6d0c909a', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (h("div", { key: '6491be4241c74dc0d1e7a3b20d8422a2896881e2', class: "ir-dropdown-container" }, h("ir-combobox", { key: 'bfa615c9089e38053ea657fb6bc1fd67c08c117c', onComboboxValueChange: e => {
