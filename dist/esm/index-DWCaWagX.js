...
import { P as PropertyIdSchema, B as BookingNumberSchema, D as DateSchema } from './commonSchemas-DOpzu-TI.js';
import { o as objectType, s as stringType, b as booleanType, n as numberType, d as arrayType, u as unionType } from './types-BWKgfE54.js';
import { n as isPrivilegedUser, e as extras } from './utils-B69q7mr1.js';
import { a as axios } from './axios-B50ozOIF.js';

// ---------------------------------------------------------------------------
// Exposed bookings criteria (Get_Exposed_Bookings_Criteria)
// ---------------------------------------------------------------------------
const GetExposedBookingsCriteriaParamsSchema = objectType({
...
// ---------------------------------------------------------------------------
const ExposedBookingsParamsSchema = objectType({
    channel: stringType(),
