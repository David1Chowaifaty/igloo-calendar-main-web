...
import { C as ChannelService, o as onChannelChange, c as channels_data, t as testConnection, u as updateChannelSettings, s as selectChannel, a as addMapping, b as setMappedChannel } from './channel.service-CTVYh7B9.js';
...
const IrChannelMapping = class {
    ...
    renderMappingStatus(mappedField, id, isRoomType, roomTypeId) {
        ...
        return (h("div", { class: "ir-ps-2  flex-fill mapped_item" }, this.activeMapField === id ? (h("ir-combobox", { autoFocus: true, placeholder: locales.entries?.Lcz_NotMapped, data: this.availableRooms, onComboboxValueChange: e => {
    ...
    render() {
        return (h(Host, { key: '2e9c99b6fa1e9499fd70438b66a949a0d8739276', class: "py-md-2 px-md-2" }, h("div", { key: 'fa8c3816b8ba9dd494bce948347487e4058900d2', class: "d-flex p-0 m-0 w-100 justify-content-end" }, h("button", { key: 'b803942a159a1dd42be0cc733f169be5db6608bd', onClick: () => {
                setMappedChannel();
            }, class: "btn refresh-btn" }, locales.entries?.Lcz_Refresh)), h("section", { key: 'a1f82aec69a26638a52f6a7df389472a3a591e30', class: "w-100" }, h("div", { key: '23210beddac8a83f14551f0b19d0cacea205c01b', class: "pt-1 mapped_row" }, h("p", { key: '6e6014169ebf1507b9d0b18287c420ba2be13e89', class: "mapped_item channel_name" }, channels_data.selectedChannel?.name), h("svg", { key: 'de9c96f2969554070f30027e2af462b49aa76557', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'f3411be3c681ae02d7617f8c38ad03eb13337dc3', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), h("p", { key: 'ffb5f5871ec00d7f84aad53054622ea3d496216b', class: "ir-ps-2 mapped_item channel_name" }, "igloorooms")), h("div", { key: '117a03aa5bb52dbc62691ea885f2b228bafdbbe1' }, channels_data.selectedChannel?.property?.room_types?.map(room_type => {
...
const IrSwitch = class {
    ...
    render() {
        return (h(Host, { key: '932577ad093f395bf4e7f8ace82c9607d976fec9' }, h("button", { key: 'cbc1429a05db85f39051cae6291bb589087382f7', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, h("span", { key: '240869bb0a93da9a0c5aeeafb6fab7a80018ce13', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), h("input", { key: '2bfe91f8e9310d27c5621da4abf40f663473d123', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
