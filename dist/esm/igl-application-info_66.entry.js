...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory } from './booking.service-1822b612.js';
import { l as locales } from './locales.store-629477c2.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-f4e207f9.js';
import { f as formatAmount, h as hooks, e as extras, a as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, b as getPrivateNote, i as downloadFile, t as toFloat, r as renderTime, j as formatName } from './utils-fb24ee4e.js';
...
import { _ as _formatDate, a as _formatTime, b as _getDay } from './functions-2d1303f2.js';
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '72139606bbee5648ded1ae71f07595221bb57894', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '0c28a5c291a97c849a677727e47ab43f4904d9f1', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'd010b4f305e4549c84c0f5f078d2a47d3371dec7', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '7aa6d4ca03312b10f9a67baf444ea06ccd2912eb', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '613484ce7309bc97956d4d51268339ffbf16de61', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'ff94d0855a8ab7236d097c3b31717507048391cf', class: `ir-alert-header` }, h("p", { key: '200b87530844112cdb420524f91fc7a2e5a6eda7' }, this.modalTitle))), h("div", { key: 'f2496fda0e543d485bdc3e02fa7a1362fc380db2', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '01339f8fed4f377bb4a515d6f7852b1bec2a0479' }, this.modalBody)), h("div", { key: 'd4c1390a2cc87c79774243bf45f5ddb5c99a2ca0', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '81ed80dfaa54e4aadf16db8cb33968c1faf5c1f6', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (h("ir-button", { key: 'e01f4c908c9e5967bf6425d43779bf30d0275f27', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '7a755b71887f081ca10401b275176c06f0feffdd', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '9f42e29e921a653d82bec9734287f00341a55e57', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '3d00dcdb39ff87697fbca8726acaf6b46dbf4b7d', class: 'sidebar-title' }, h("p", { key: '5427539495beebf6611755cf20ab1deeeda08d81', class: 'p-0 m-0' }, this.label), h("div", { key: '51e17152b3d6f17ceac4f840cdaec49c688ea5a2', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '6da1b945cfe520c53aff9cf593738aacc0906a49', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '1ab2f70db209386c66ffa8aaf7cf61b3e8257465', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '42af0822e0a04eb4902c6c744e74d9b9db3e0971', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '25a222730c32448e23b9ef7050b6bdb40c6c27c5', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: 'db639ae3059862f6a46fb1afe15678f883a7c231' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
