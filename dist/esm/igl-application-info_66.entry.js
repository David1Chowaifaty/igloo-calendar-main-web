...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory } from './booking.service-8bb566e7.js';
import { l as locales } from './locales.store-629477c2.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-f4e207f9.js';
import { f as formatAmount, h as hooks, e as extras, a as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, b as getPrivateNote, i as downloadFile, t as toFloat, r as renderTime, j as formatName } from './utils-bdc99acb.js';
...
import { _ as _formatDate, a as _formatTime, b as _getDay } from './functions-5f11e68d.js';
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: 'c2eeebc089e5e0ba3a27fb9a3f02d39c1212e076', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '2307d7e523f934c4eb6dc134b1723dd15505263b', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'de3c489757aaf6f18960223a5eafddaa3a95990e', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'ddfc7d26f1a69faf235688800cac132620f5f620', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '09649f58428598f9c711c370133a3bb66874316b', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '6374ba67089c6f5373e1254625f1235cf30271e5', class: `ir-alert-header` }, h("p", { key: 'a01876046df6e58487732d2e34ff0e67a649fdf1' }, this.modalTitle))), h("div", { key: 'ee8c8e2ed16cc54d84fffed025fe867321d4a7fe', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'af9295ed348fcae6bbbb86239edf1607e18321f6' }, this.modalBody)), h("div", { key: 'd7f97167b3618f36c48be7e5b5c23e091913cf48', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '5a6525ac7136e185b1c8976692392040d9e4cb70', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (h("ir-button", { key: 'aae1c730a36254004f8830a1f849f9e46cc7572d', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '9d29595504d2215372d26c10d3a0ad0ed8dbe73b', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: 'cfa73698424b532dcb27b27e5da448c33d0e696c', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: 'c3c3b6f974179bd445e0e9101ac7d284b67d3879', class: 'sidebar-title' }, h("p", { key: '56815e45fe5791f7b8f19459713212c7b57fa9e6', class: 'p-0 m-0' }, this.label), h("div", { key: '5a7909196e2286436d6a621c79fba4771bb86b03', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '1f49c081695638fcf6aecbabf15aa653ec658765', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'a165fdc7cfea984a5a4b2afce30d0c295d7b7cac', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '6f0e2c94dd015fc1dd975ed5e079b34bc0d961fd', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '0c8623c01e55765221c1ac079a0254944a85aa37', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
