...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory } from './booking.service-877b9937.js';
import { l as locales } from './locales.store-629477c2.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-f4e207f9.js';
import { f as formatAmount, h as hooks, e as extras, a as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, b as getPrivateNote, i as downloadFile, t as toFloat, r as renderTime, j as formatName } from './utils-a91ab911.js';
...
import { _ as _formatDate, a as _formatTime, b as _getDay } from './functions-848bb52e.js';
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '695a90d92aa6556aae9652714b0b8732cb116c50' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), h("div", { key: '1ce084bc23ea81fdfab30821464f0174983ef554', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, h("fieldset", { key: 'c9db644e02214f928b2c0380389caec4c0aaaefc', class: "mt-lg-0 mr-1 " }, h("igl-date-range", { key: '525c549e648bfef79cb6085bda59a5ae6c9fbc15', "data-testid": "date_picker", variant: "booking", dateLabel: locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: '2d27320964cb30080b54c83ec75087f50efda3cf', class: "text-right mt-1 message-label" }, calendar_data.tax_statement)));
    }
};
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ca905d251fb2ee867a4492994cc8387cabe02b5a' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && h("div", { key: '35ab9f631a19b08dc87850550fdfbe63f8baee1f', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrCheckbox = class {
    ...
    render() {
        return (h(Host, { key: '417a5ad1bffd4b945ca8a65024a11f185f838b9d' }, h("button", { key: 'e4d1e3d8ed1536c559ea6f173a692cbc448ce31e', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: '31d33d63ed12fa1ebb06310e3d9d4b849fb97cbe', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '52a26f23a2d1d4a81d9757e3400e32c09bdc2b36', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (h("svg", { key: 'e6a9278cec914bc7be889b7f37d83b9a54da97b7', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'a53f8cd6204ea9b3fa50d34a4ea3cf8b41e9e7dc', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), h("input", { key: 'b830e8b1865b043270d6c5404eefea58298f45d1', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (h("label", { key: 'b3154801056b5f8891bf7c4497cc19497f76cafc', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '0f49dfa5be13fe450dc3608e1afe29a4dabf17bb', class: "d-flex align-items-center" }, h("span", { key: 'be94fe4ef0a5443e7501513649c8cc43375e5c10' }, this.dates.from_date), ' ', h("svg", { key: '9980873933ed30f602d7166cae0abcba9e6fc32f', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: 'bd0ec2f23fb9c7af0c9b2671a34508105fd6d847', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '902e907bc3a14735e8be46119f389d19d9cfa193' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '1233d493aac47f6eada9cbe8ac0c96fd43118b41', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: 'a22d5343a86cd14e91aec77261f816720ab6a9f9', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: 'fb38802fbf3ca5e42fa127aa826d653d32ddc941', name: "icon" })));
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '130d017c9fca5c59a03c61808de871eaa8563b06', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '662f84acaa803daf62e7e9b2d72f7631acb61216', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '1fe1a67f97f60ea38314b6bccba9388e98b6e8eb', class: 'sidebar-title' }, h("p", { key: '810220035c77dde07ab30e2d7cb94e6b814f0ba2', class: 'p-0 m-0' }, this.label), h("div", { key: 'a615b632acb14908043fa317b669470212f60690', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: 'b03a30dbc8c7b6d529a18e6da8663ea2b1064760', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '6030548624bf3fa667737cfce28ba746593734f1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '2674abd4e0473d109d3a1e9ada2db3ed9d46f0ae', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: 'deee5b421a6554e84de6cf2d203f56202f730bf9', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '58dd262fa33682afb3b555c2bd9bcfdd394989bd' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
