...
const LocaleEntryRowSchema = libExports.object({
    code: libExports.string(),
    description: libExports.string().nullable().default(''),
});
/** `My_Result` of `Get_Exposed_Language`. */
const ExposedLanguageResultSchema = libExports.object({
    entries: libExports.array(LocaleEntryRowSchema).nullable().default([]),
    direction: libExports.string().nullable().default('LTR'),
});
...
export { LocaleController as L, SCREEN_TABLES as S };
