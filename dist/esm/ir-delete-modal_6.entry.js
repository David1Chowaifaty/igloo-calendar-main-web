...
import { H as HouseKeepingService, h as housekeeping_store, g as getDefaultProperties } from './housekeeping.service-80dacb87.js';
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (h("div", { key: '0f6c6f91cf2d80152a36008e28b06cc3991d2179', class: "sheet-container" }, h("ir-title", { key: 'b1b0d18fe258fb2446c743ec448e4192e4d7164b', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '5fafc496a2ec7465cb3a862b489f48e0686bed35', class: "px-1 sheet-body" }, h("table", { key: '86899fc71567d3356d681ed56d268e7b9d6f0e82' }, h("thead", { key: '2e33a761be099b697114b0e64e8f8c8f2e68d3d5' }, h("th", { key: '7caa64f422657d35683c4c0a21b13ef254bde6ab', class: "sr-only" }, locales.entries.Lcz_RoomName), h("th", { key: 'f2e2de01668e15d32df17db9013051a9eb7d768f', class: "sr-only" }, locales.entries.Lcz_HousekeeperName), h("th", { key: 'eaef8794a60887527452f02760501c8f694bfd1e', class: "sr-only" }, locales.entries.Lcz_Actions)), h("tbody", { key: '7d8db1cffc16115bb669d0796cbde18bdb7c4998' }, this.renderRooms()))), h("div", { key: '1720211049a80505d92d68d77d7b46a469ec5dcb', class: "sheet-footer" }, h("ir-button", { key: '126dea5e20eb204ed1741b68e1e1998687bb122c', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: 'cfe4ba7d38ad6357f6d6dd007431f82584af4763', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (h("div", { key: 'e65d3a75b5f46f1a09f4e7be53c5d1f16bf1fa4f', class: "sheet-container" }, h("ir-title", { key: 'd8b2aa8f34df1361a00be7fad6143977dbb0822e', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales.entries.Lcz_EditHousekeeperProfile : locales.entries.Lcz_CreateHousekeeperProfile }), h("section", { key: '4208a4c97713892228fdb972044288bd9ee461dd', class: "px-1 sheet-body" }, h("ir-input-text", { key: 'd925d9a0e77b6bffbe9a0e2b96dadb5d5d96b876', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales.entries.Lcz_Name, placeholder: locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), h("ir-phone-input", { key: 'd5dccc25de0567ca6a4fcb0f76da8f27b57208d1', testId: "phone", placeholder: locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), h("div", { key: 'b23d5d821dbaed58d6f9ebb17ba9ce5d1827edd7', class: "mb-1" }, h("ir-textarea", { key: 'f1605bfba3b5943b9172c1ce7c84c794968d704c', testId: "note", variant: "prepend", maxLength: 250, label: locales.entries.Lcz_Note, placeholder: locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), h("ir-input-text", { key: 'd09e729e74cdc5ae7f53bc2701f4737370c745df', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales.entries.Lcz_Username, placeholder: locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), h("ir-input-text", { key: '2bda77f53eac56bd77938ccb0bf0cd76e8c36667', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && h("ir-password-validator", { key: 'b8f39786211bdc972b2c9c623fb3ef8fe840d0f4', password: this.userInfo.password })), h("div", { key: '2aa3aacd520ecf60afcb52949cfe826207dce216', class: "sheet-footer" }, h("ir-button", { key: '79da13aaacacee96d098db1bc963e6b7d29e919f', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: 'c48e5985633a8ccd825910dbb1593f781c1fa3d7', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales.entries.Lcz_Save }))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'd150b8157c2762a89aa2a3eaae1956a250a7459b', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
