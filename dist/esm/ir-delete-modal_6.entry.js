...
import { H as HouseKeepingService, h as housekeeping_store, g as getDefaultProperties } from './housekeeping.service-dcfa55d5.js';
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (h("div", { key: '6d6a762bd73d065d986f224af5bc629707a96eda', class: "sheet-container" }, h("ir-title", { key: 'e1bd177167fb13909719159cecf31dfd57344151', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '5ec2abd8a01799e4a912bf256dfd254769902fde', class: "px-1 sheet-body" }, h("table", { key: 'eff388ebf33ac726b1111128d38228243c1720d0' }, h("thead", { key: '37f626f483bdac01d28cd39d0b7c2756b5cf104b' }, h("th", { key: 'd86b062d1706257c68e5001b198bba95f51d31ce', class: "sr-only" }, locales.entries.Lcz_RoomName), h("th", { key: '2900aa7319dfd5049d69dfad051bf12fb0f89951', class: "sr-only" }, locales.entries.Lcz_HousekeeperName), h("th", { key: '4508641673b02698247cdb35a54e6b47f8fc6133', class: "sr-only" }, locales.entries.Lcz_Actions)), h("tbody", { key: '8cb50266ff12d054ae6f901f55a0b59cb1f256f7' }, this.renderRooms()))), h("div", { key: 'e75a0bc64f0cb674ec2e1b8b5a647b35f02e96c4', class: "sheet-footer" }, h("ir-button", { key: 'c78b7b9ff24f761d5bd568e01fb9fd0152805050', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: 'bf7a34d7833ecaa9ebabca854a2e8cf165e302fa', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (h("div", { key: 'd912ad8be08d05d6febdd8851374b7c354e1f310', class: "sheet-container" }, h("ir-title", { key: 'c0d450695426ee9e34fb03d3f94718ce628dc23e', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales.entries.Lcz_EditHousekeeperProfile : locales.entries.Lcz_CreateHousekeeperProfile }), h("section", { key: '3d5bb10ae9c83b8985c687ce89463a4af2f19376', class: "px-1 sheet-body" }, h("ir-input-text", { key: '544a17cb3af54ce178b8e4c4abc26eb183aceeda', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales.entries.Lcz_Name, placeholder: locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), h("ir-phone-input", { key: 'f03f4abbebee51ff146cf43ad40f6661b336c666', testId: "phone", placeholder: locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), h("div", { key: '9d17021dd015a07a1d67123f175fa4e1974adf89', class: "mb-1" }, h("ir-textarea", { key: '6bb32946649659ba35bee7a892ced8c264f166b9', testId: "note", variant: "prepend", maxLength: 250, label: locales.entries.Lcz_Note, placeholder: locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), h("ir-input-text", { key: 'bfa17ca0fc00cb9d4aed684cd713133ba3adf8be', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales.entries.Lcz_Username, placeholder: locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), h("ir-input-text", { key: '25246110872c5f180da5410fa206cee06add4506', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && h("ir-password-validator", { key: 'e4795989922f7668c0dcfbf0719f0e82f051d25e', password: this.userInfo.password })), h("div", { key: '12bc0d818122d223945fc4afc3d4b58416f7f97c', class: "sheet-footer" }, h("ir-button", { key: '26063a4555944b2fe79923cde1752ca7ec1c1498', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: 'd10ca97226768266548f24f0c4070233a569cfb1', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales.entries.Lcz_Save }))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'a3a8361b1dc7bf949554c672e5f5e7679c75cf9d', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
