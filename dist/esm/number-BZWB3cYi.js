import { t as toNumerals, r as resolveLocale, a as resolveNumberingScript, b as resolveNumberingSystem } from './ir-date-VwsP30iT.js';
...
function split({ locale, numberingSystem, ...intlOptions } = {}) {
    ...
    return [resolvedLocale, resolveNumberingScript(resolvedLocale, resolveNumberingSystem({ numberingSystem })), intlOptions];
}
/**
...
function formatBookingNumber(value, options) {
    ...
    return toNumerals(String(value), numbering);
}
/**
...
export { formatBookingNumber as a, formatPercent as b, formatNumber as c, formatCount as d, formatAmount as f };
