...
import { t as toSetupEntries, g as groupEntryTablesResult, D as DistinctSetupTablesResponseSchema, G as GetSetupEntryByCodeParamsSchema, E as EditSetupParamsSchema, a as EditSetupManyParamsSchema, Z as ZExposedLanguagesSchema, M as MissingSetupEntriesParamsSchema, b as MoveSetupEntryParamsSchema, c as ZSearchSetupByDescriptionParamsSchema } from './utils-el9-8HZ4.js';
import { S as SetupEntrySchema } from './IBooking-BEkHqAPo.js';
import { d as arrayType } from './types-BWKgfE54.js';
...
class SetupService {
    ...
    async getMissingSetupEntries(params) {
        ...
        return arrayType(SetupEntrySchema).parse(result ?? []);
    }
    /**
