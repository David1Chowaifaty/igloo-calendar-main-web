...
const IrBookingDetailsDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '50a2b4450f52397502de0e0c525613fc5fe2fc2c', onDrawerHide: this.handleClose, withoutHeader: true, open: this.open, style: {
