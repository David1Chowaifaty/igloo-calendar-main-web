import { r as registerInstance, h, H as Host, c as createEvent } from './index-BvoylR5O.js';
...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ea1b401627a034b048ec693e9477751ff5182d2a' }, h("wa-card", { key: '6c16682553c0adef60f725c78424a5a78a2b3cc8', class: "unbookable-rooms__filters-card", appearance: "outlined" }, h("div", { key: 'a7bdda0c963636358db4f20df7a0124b34d04767', slot: "header", class: "filters-card__header" }, h("wa-icon", { key: 'd2fb13faa4b3a6e9208f70fa3f043cc99e0e44d3', name: "filter" }), h("h4", { key: 'c0bf1bec7e79a3b33daed12ed1dcc557ddefcbad', class: "filters-card__title m-0" }, "Filters")), h("wa-select", { key: '6d23c15d5b25b6aa7977f2f75957df6308ef8908', label: "Look ahead", size: "s", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), h("ir-input", { key: 'a101a0f4caa11faaa7f4009394def5801bd3281f', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (h("wa-select", { key: 'cd72865f7c8ee1fd53f537344f8746ad53dd2274', label: "Country", size: "s", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, h("wa-option", { key: 'ece18037e0920b9ad690f9997987b7f5582b342a', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (h("wa-option", { value: id.toString() }, name))))), h("div", { key: 'ebdfd48167c81fa3905db4b6abf2098fca037354', class: "filter__actions" }, h("ir-custom-button", { key: '64e9eaeee8ccf0d415e2c35f92a6092d2e9ae8e0', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), h("ir-custom-button", { key: '231597e9e6313d7c0101726ca9bab51c5af9dc64', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save")))));
    }
};
