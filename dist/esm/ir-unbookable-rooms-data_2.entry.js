...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (h("ir-filter-card", { key: '445ba8bd8d4bb981d39721ad61c0abe86e65d1a0' }, h("wa-select", { key: 'd788e3a531be046c64dc34d0a312c9869492b1b3', label: "Look ahead", size: "s", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), h("ir-input", { key: '38559b732641f6284c36186e31130e77bdf92bef', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (h("wa-select", { key: '1768181cb27570c463a66f34db13b0bfa82aeb80', label: "Country", size: "s", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, h("wa-option", { key: '32e2b06ac61238ce141aec3d8bc47dd701eda0f2', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (h("wa-option", { value: id.toString() }, name))))), h("div", { key: 'c737f7b9ee26471e028b0ab49b2c4c48b535066e', slot: "footer" }, h("ir-custom-button", { key: 'ce94bc2f49b3ea3e6fabae8731ad38d94d51a8f7', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), h("ir-custom-button", { key: 'c3143d4ecd6185f680a8d97677ab7809df894edc', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save"))));
    }
};
