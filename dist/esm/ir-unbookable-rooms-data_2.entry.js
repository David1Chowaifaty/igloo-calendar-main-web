import { r as registerInstance, h, H as Host, c as createEvent } from './index-Kqbk9HdW.js';
...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (h("ir-filter-card", { key: '5573891d05b6f8c3c13e9e16c1e5130e3a8101cc' }, h("wa-select", { key: 'f8b49c2a3d96692213467f83f637177c7a1fa127', label: "Look ahead", size: "s", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), h("ir-input", { key: '5e8aa014ab0e99ac9593abba27c5bef5ad7d3dcb', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (h("wa-select", { key: '9bb0cfb6a526d9e3fb2cfbdf94b9985f2af503fa', label: "Country", size: "s", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, h("wa-option", { key: '960addb2fca765f4d6dd449c391f2b8a876e27d4', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (h("wa-option", { value: id.toString() }, name))))), h("div", { key: 'afa358a55a267e3acda3c5a0063a10f5bfcf6917', slot: "footer" }, h("ir-custom-button", { key: '61849729d4a226a741bac43b0080e049938233ce', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), h("ir-custom-button", { key: '027e6b1039904ef5510f2c95860a2ff9e4235a87', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save"))));
    }
};
