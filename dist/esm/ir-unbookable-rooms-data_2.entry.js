...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'af4870bac7aac8f4656912d3b16315d55a510ec4' }, h("wa-card", { key: 'd0be7196a04f8f5734c823abcf2879aa9dc92b6d', class: "unbookable-rooms__filters-card", appearance: "outlined" }, h("div", { key: '7a84b815310a7e11af1c70d1155ac8dfa01f0c1e', slot: "header", class: "filters-card__header" }, h("wa-icon", { key: '55e5e740f7fd3beb7df6288b2fb3da5ab3dd7377', name: "filter" }), h("h4", { key: '84fe3776c58237a8f60244c323cf6908f2292598', class: "filters-card__title m-0" }, "Filters")), h("wa-select", { key: 'e1e8c16b872c33d6ae5a2ec9fa611ff2aa577c0d', label: "Look ahead", size: "small", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), h("ir-input", { key: 'b9eae7f8e74437a955262ed38148ec245d0b4eda', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (h("wa-select", { key: 'd72251ddea9b8ff9bfd37036640621edfa95c8b3', label: "Country", size: "small", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, h("wa-option", { key: '61384e199313a98f0d600e8fc1f1c11588b7c037', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (h("wa-option", { value: id.toString() }, name))))), h("div", { key: '8babd7a99b6fcc4afbd77e64a6788ff6b5516f4f', class: "filter__actions" }, h("ir-custom-button", { key: 'e74d5c490016bacb614299b87caf4e35c8f6dbec', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), h("ir-custom-button", { key: '4a8a1c00d76c0d4b0671b5bd67ed7e54e33d3db6', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save")))));
    }
};
