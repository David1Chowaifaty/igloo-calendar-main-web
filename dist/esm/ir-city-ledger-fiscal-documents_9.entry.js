...
import { m as mapClTxToFolioRow, a as actionableClTypes, d as debitFdTypeCode } from './city-ledger.service-BBeYu1F8.js';
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (h("form", { key: '26c947ddb6b8078f3255a54bcf6a94a797c8d8b1', onSubmit: e => {
            ...
            } }, h("div", { key: '624677456467d85a7c34f5243e24f48823efc327', class: "filters-bar" }, h("ir-validator", { key: '519e65f358da10c0f2fc0806045f061edba2175b', value: this.dates?.from?.format('YYYY-MM-DD') || this.dates?.to?.format('YYYY-MM-DD'), schema: libExports.z.string().nonempty(), class: "filters-bar__dates" }, h("ir-date-range-filter", { key: '0da4ca3a025626967592a5c2c08670df15fd091b', maxDate: hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
