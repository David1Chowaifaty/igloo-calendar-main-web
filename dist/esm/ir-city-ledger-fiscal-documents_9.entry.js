...
import { C as CityLedgerService, F as FdTypes, a as ClTxTypeCode } from './index-e-OILKAT.js';
...
import { m as mapClTxToFolioRow, a as actionableClTypes, d as debitFdTypeCode } from './city-ledger.service-D_VLv4bj.js';
...
const IrCityLedgerFiscalDocuments = class {
    ...
    render() {
        return (h(Host, { key: '8742b144fb47508be80feb03216c23f2f0d7f782' }, h("section", { key: '11e726e730dbb52f2b83524c8e8ef74d001902f9', class: "fiscal-documents", "aria-label": "City ledger fiscal documents" }, h("ir-city-ledger-fiscal-documents-filters", { key: '8eca3ec25407fdd4754ff1483f0d43d3b92fdb88', filters: this.filters, onFiltersChange: event => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (h("form", { key: '37b8923ef520de944c856df9b366128af7418ca8', onSubmit: e => {
            ...
            } }, h("div", { key: '6e756c60d1fe2e0df09305b1ef2e13695dfe6596', class: "filters-bar" }, h("ir-validator", { key: '08a2f5543e9ee3b25035614f361e46928d07294d', value: this.dates?.from?.format('YYYY-MM-DD') || this.dates?.to?.format('YYYY-MM-DD'), schema: libExports.z.string().nonempty(), class: "filters-bar__dates" }, h("ir-date-range-filter", { key: 'c3ad715f581b5cc5693d4f0ce26b639810a01fdd', maxDate: hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (h(Host, { key: '9dbe32b50dcfc114a10ac70ed996385839962479' }, h("section", { key: 'd9836b69c6e43219aa8c0ae68439e583c38eccc8', class: "cl-statements", "aria-label": "City ledger statements" }, h("ir-city-ledger-statements-filter", { key: 'c72e58f271866a669ca391fe368e98f7c82e89f4', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
            ...
            } }, h("div", { key: 'a2dd34e3b483c420f4b764c5ced494c0eb7e3868', slot: "header-actions" }, this.pdfUrl && (h("ir-custom-button", { key: '638acbd25669ef666c02b5fca260605270ceec85', size: "m", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, h("wa-icon", { key: 'e2cbc2ce8560d40c6c7d1470f7ff75d50fb4243d', name: "download", label: "Download PDF" })))), this.printFilters &&
