...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '746fd829be48332014ed564f173ac1a931fde195' }, h("div", { key: 'd7bc9e54abec142341d31680d4f77139226b500d', class: 'd-flex align-items-center ' }, h("label", { key: '85b4c449aa43d6f8e08f4fa76f95a5a6d8af8c89', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: '82113f404b60e5100f3ed6eed8d8fb56ee251204', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: '391f2415e6e169e4279cf2c257af661c26315a29', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: '8a67aca08449e5cedd1ae54071ae194fa407026f', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: '168a20fb2dc506f412495837618ca3eaafbcb7cd', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: '2ced5ae5f614d263421f17e3e97d84cf898a9127', class: 'sr-only' }, "clear input"), h("svg", { key: '7c00d9189fac0b383eaf0351efb418e91da91543', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '2796126d861f96e3471991f06eadad8f8ca53bc2', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: '7a39f643a2d326837fca0dcdaadeb75c38891c81' }, h("input", { key: '3cb91b923b537cd7c5cb5f1a37ec39cd4f7e8bb1', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: 'cecd98e876eb782ca6adaf9d9093b14abf67534d' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTooltip = class {
    ...
    render() {
        return (h(Host, { key: 'a11a39ab42e112cffba55152fb7a48e1349489e1', class: "m-0 p-0" }, h("span", { key: '43e43f6400c0892402a22802392c8e86500af5f3', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (h("slot", { name: "tooltip-trigger" }))), this.open && (h("div", { key: '5d6598d30f2aac33ea637a0cc00b71600b1d091e', class: "tooltip bottom show position-absolute", role: "tooltip" }, h("div", { key: '1d63dc8d115c22e11ad0a7ea52ec1702d191058e', class: "tooltip-arrow" }), h("div", { key: '220212aa1e493ba447a73b6fbdbfb997dddafd02', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, h("span", { key: 'f85821928d550ee3a7bb15c6189747c5389d3870', innerHTML: this.message }))))));
    }
};
