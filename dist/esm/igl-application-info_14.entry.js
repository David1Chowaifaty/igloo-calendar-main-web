...
import { b as booking_store, m as modifyBookingStore, d as reserveRooms, r as resetReserved, u as updateRoomParams, e as getVisibleInventory } from './booking.store-910c3544.js';
import { l as locales } from './locales.store-53ec3957.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-26906e0c.js';
import { f as formatAmount, a as calculateDaysBetweenDates, z, G as validateEmail } from './utils-47ed7fdc.js';
import { V as VariationService } from './variation.service-6afda55f.js';
import { v as v4 } from './v4-964634d6.js';
import { B as BookingService } from './booking.service-79a5db52.js';
import { h as hooks } from './moment-ab846cee.js';
import { a as isRequestPending } from './ir-interceptor.store-e96f5930.js';
import { B as BookingService$1 } from './booking.service-79a5db522.js';
import './calendar-dates.store-10b2707b.js';
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5c722b7d31373181d37c5341c5e1d757c134cb6c', class: 'my-2', "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, h("div", { key: '3d944c11883ef58329c047a01e4cc8cccf5d55d8', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: '85f88245d65bef88f0006f0c13ad61096cee9abc', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: '39258cf2fe49b71887a94c49f4e63226af76ddcf', class: "booking-details-container" }, h("div", { key: '829b48931ff008051f3ca572e827a589e03c2c33', class: "booking-rateplan" }, h("p", { key: '771f7e91fe99e357ea0c3bb05a31df84e659c8d6', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: '5abf10b45f01f4d5e3e65152528b2b085665521f', class: 'non-ref-span' }, "Non Refundable")), h("ir-tooltip", { key: '584621ebb66125d490027f592ff29156c5948adf', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: '24c2117ee74356ada31a2fd80dcc436d25655d92', class: "booking-variation", innerHTML: formattedVariation })), h("p", { key: '5d74579c524e60d6ccdb510efb0f514db993731d', class: "booking-price" }, formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), h("div", { key: '1c1e9bb18c9c77c4eae6143635a23f5025996531', class: "booking-footer" }, h("div", { key: 'aea3b7431acfcc8140019e7d8eccda3f9259fc8b', class: "booking-rateplan" }, h("p", { key: 'dc06b0943b8dd6e8ca749592e7ce1ab98c244391', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("ir-tooltip", { key: 'aa85cdc6d41b7a676373670e262b879315a433ba', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: 'e2efb7dbae4d1627c9eb61f3687e9ff3807c17ae', class: "booking-variation", innerHTML: formattedVariation })), h("div", { key: '8ced5a8368caea236aa5f4649eee1876b63073cb', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, h("div", { key: '5ff583f6d1dc9d25f45244ba108ce556ec6a8113', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, h("input", { key: 'ba2292aaa4e310bb67c4602fe6d84d8594d8db48', id: v4(), type: "text", "data-testid": "guest_first_name", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ first_name: name });
                if (booking_store.event_type.type === 'EDIT_BOOKING') {
                    modifyBookingStore('guest', Object.assign(Object.assign({}, booking_store.guest), { name }));
                }
            }, required: true, value: (_d = this.guestInfo) === null || _d === void 0 ? void 0 : _d.first_name })), h("div", { key: 'd8ebd6dae887141a4d2b83f25f9b3f3edf73ee1a', class: "mr-md-1 flex-fill guest-info-container" }, h("input", { key: '21d433897915e988a6f6af0f3069493e31c2fece', id: v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_e = this.guestInfo) === null || _e === void 0 ? void 0 : _e.last_name) === '' && 'border-danger'}`, placeholder: (_f = locales.entries['Lcz_GuestLastname']) !== null && _f !== void 0 ? _f : 'Guest last name', name: "guestLastName", "data-testid": "guest_last_name", onInput: event => {
                const name = event.target.value;
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("div", { key: '8c34b7b49e987ce910e30b93c77b516e463e6e05', class: "mt-1 mt-md-0 d-flex align-items-center flex-fill" }, h("div", { key: '42e114a3757f79e36c34ccd79fee757fe3b277a3', class: "mr-md-1 p-0 flex-fill preference-select-container" }, h("select", { key: 'f4c59a5f2bc7afe705efc96e29294be22724c350', "data-testid": "unit", class: "form-control input-sm pr-0", id: v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, h("option", { key: '538bc6ea80e00a9f5a36de601161b79edd033dfe', value: "", selected: ((_h = this.guestInfo) === null || _h === void 0 ? void 0 : _h.unit) === '' }, locales.entries.Lcz_Assignunits), filteredRoomList === null || filteredRoomList === void 0 ? void 0 :
            filteredRoomList.map(room => {
                var _a;
                return (h("option", { value: room.id, selected: ((_a = this.guestInfo) === null || _a === void 0 ? void 0 : _a.unit) === room.id.toString() }, room.name));
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (h("div", { key: '293752dc4246ac53d69aced53c61e342936d086c', class: "mt-1 mt-md-0 mr-md-1 flex-fill" }, h("select", { key: 'b6cfe009062a081e4ce9af2d80d1ad0bec640086', "data-testid": "bed_configuration", class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, h("option", { key: '3457b2ee57bf8596c650dfc3bda3806d4ab2e9c8', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), h("p", { key: '05b2da2434b88db00a4770ac261f1dc3104e6dec', class: "rate_amount" }, formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: 'a97dbaf825724b44f8427ca514df0f4e9a868d4f', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, h("p", { key: '7421e7c52a07b7d8701407b3b1b2d24b49220e18', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), h("div", { key: 'bd91642023316a092363b411355756935a3e8c03', class: "mr-1 flex-fill" }, h("select", { key: '6f70355a28b52757e54e255e0bba6da03b68ce10', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, h("option", { key: '6fb83d4c4333de78b706a8148ecd0976d5cc8ccd', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'db7dea08ab58a1249e8dc78ae66a6b3bf2a5a30d' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), h("div", { key: '58f5746a4a800c492569f845d14f8f81ff4b5904', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, h("fieldset", { key: '28820513dc41c8c5adfe805e7057097f37a5594f', class: "mt-lg-0 mr-1 " }, h("igl-date-range", { key: '22ecb26cc57e1147cd7f97601915ab9d56b805e1', "data-testid": "date_picker", variant: "booking", dateLabel: locales.entries.Lcz_Dates, minDate: this.isEventType('PLUS_BOOKING') ? hooks().add(-1, 'months').startOf('month').format('YYYY-MM-DD') : this.minDate, disabled: this.isEventType('BAR_BOOKING') || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: '904385c6704a14ab7a8c5a589307e8de4f11b85b', class: "text-right mt-1 message-label" }, calendar_data.tax_statement)));
    }
};
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '0393360eef8d5d59a7656779fe8b0e20900ca0ea' }, h("div", { key: '3835fcb824d0a0e838db6d2f65da03b0d8f91c51', class: 'd-flex align-items-center ' }, h("label", { key: 'b6b07dd6801c807ef09f40791be91b5fa5d0406f', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: '86c3a84c931b37e631cde7a4096b0def2b425908', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: 'c24ccbaaa0012da5a782e71c3d37831b9fc1920d', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: 'a27305265bc1867b21cace36675aedc2d11e15fa', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: 'ac40b8ebf97e5db29e3e26d12a66b71b28e24323', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: '4d6bce23d89ea17315c8fe6dc7eb3500f75d8d09', class: 'sr-only' }, "clear input"), h("svg", { key: 'b124619c25e13cb5582e0c0974e580913a8ea1e3', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'e179cd4f16032e9af7308f29f1ac77378905a5b7', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: 'bf237b494f538124935ae2f0473bb40f6bd4b36b' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
