...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5d24b8302b77ab35fcf301f55af21a8d42a981dd' }, this.label && h("p", { key: 'c5ac3a2f8bd8f76c4f7f80993c0becb43d31fbb7', class: "cell-label" }, this.label, ":"), h("div", { key: '968a63823dae186c473e1ba2687dd0ae4fad6831', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: 'e007fd2c2be0bde11256e308c6188e0f63d21fff' }, h("wa-tooltip", { key: 'a972a8f51e476d5f939a62d482060b4912ca1fea', for: repeatGuestBadgeId }, `${t('Lcz_BookingsNbr')}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: '3a05940b4a1e345205c89dce827d6ca58f94c004', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: '43eefd46cc2e311d66202866999b386ab844aae3' }, this.totalPersons, t('Lcz_P', { fallback: 'P' }))), this.showPrivateNoteDot && h("span", { key: '7c0d9a4d17ca3566f4025a0d7582ba94ab009c3e', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: '3620a4bf59e17d420e1e16bf4de2c51cf82ca3eb', part: "contact", class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: 'cc95904bd6a17bb13022ebe66db91f39580ddbc5', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: '5645f3bef7211ac318e31257acb22f4dc94550a1', name: "phone" })), h("a", { key: '5390bb0b18b2490482e6ff92c7783bb578a1adff', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: '701f9d5cbc64bff2954b85899dd60aa7354ae403', name: "whatsapp", family: "brands" })))), h("div", { key: 'f9895314190f04930a1811da80b6eb9b634917d7', part: "loyalty", class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '020e006a841c367d4d875d321638a79461b44397' }, h("wa-tooltip", { key: '4cbf3291e761e32a40d622719d1dfb224054cfbe', for: loyaltyBadgeId }, t('Lcz_LoyaltyDiscountApplied')), h("wa-icon", { key: '10e5d936dcb8f82d32cebf83b6e5fdf75451a99a', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: '386fa04488b193d289cc93c49e3009067cfc4c4d' }, h("wa-tooltip", { key: '82d0db69917345b4cdcdf255705deeb4c0098fae', for: couponBadgeId }, t('Lcz_Coupon'), ": ", this.promoKey), h("wa-icon", { key: '83f9d0e2087b6a73ed8fc87db705a1f5ca5c6394', id: couponBadgeId, name: "ticket" }))))));
    }
};
...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (h(Host, { key: '33f0c0b1f47a13adac344ae61bdd3a832c125c77' }, this.channelBookingNumber && h("wa-tooltip", { key: 'a180370155ae0b29480e321a19dbd9c021dfaa94', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), h("img", { key: '05513b4c99fe9e489fb428a808e0145f6772222a', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), h("div", { key: 'd1b901b06d007caac7f5bb3132c6d6f25de5c757', part: "container", class: "booking-nbr-cell__container" }, h("div", { key: '8f18daed45d95355e6ec4a6ea33341991e348947', style: { width: 'fit-content' } }, h("button", { key: 'a9319270f3f516e511900bc213917a470505930f', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, formatBookingNumber(this.bookingNumber))), h("p", { key: '7a7050180b951ba56039cca0484eec53ac7700ef', part: "booking-reference", class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? formatBookingNumber(this.channelBookingNumber) : this.origin.Label))));
    }
};
