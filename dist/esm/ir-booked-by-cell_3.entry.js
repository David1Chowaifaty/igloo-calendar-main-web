...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5d24b8302b77ab35fcf301f55af21a8d42a981dd' }, this.label && h("p", { key: 'c5ac3a2f8bd8f76c4f7f80993c0becb43d31fbb7', class: "cell-label" }, this.label, ":"), h("div", { key: '968a63823dae186c473e1ba2687dd0ae4fad6831', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: 'e007fd2c2be0bde11256e308c6188e0f63d21fff' }, h("wa-tooltip", { key: 'a972a8f51e476d5f939a62d482060b4912ca1fea', for: repeatGuestBadgeId }, `${t('Lcz_BookingsNbr', { fallback: '%1 bookings' })}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: '65360f9e7d1d11b35f7fd3d4a716c71adb86d5e7', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: '5f38afd4dada3925743818dd902fbd129fa5aa86' }, this.totalPersons, t('Lcz_P', { fallback: 'P' }))), this.showPrivateNoteDot && h("span", { key: '77f4eb2083ec1eac7ed0a6cd206fa8bf46f4ee4e', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: 'a77d379f9773cd407c5a45148ed4d0f6784b7729', part: "contact", class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: 'e76576354480225f3c017d3e9d45cbb012f35e58', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: '8774e69130b4c7ee1a0d0a13c958d3e959758034', name: "phone" })), h("a", { key: '5cefb0f80e59e2988f2844045e69c4c8e08445c3', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: '216c7a527db20812f5a49e88abf41cc241a8b51b', name: "whatsapp", family: "brands" })))), h("div", { key: '1e35acdabca28e9fec346ffbc6d5eda7a50bcaaf', part: "loyalty", class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '9fd19d1d50b16bdcdea281955ae09d33b8efe26f' }, h("wa-tooltip", { key: 'e80e99bcaf25010a45cedc25112e002f7067b87c', for: loyaltyBadgeId }, t('Lcz_LoyaltyDiscountApplied', { fallback: 'Coupon: %1' })), h("wa-icon", { key: '0f1a0be8a50045eed6b262545e44ad91e88e6711', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: '8fd991018dbfa9a7e4bc1350580a9dca3b60f58d' }, h("wa-tooltip", { key: '64d831fc983f8168fb3bba4989207b1720fa0951', for: couponBadgeId }, t('Lcz_Coupon', { fallback: 'Coupon' }), ": ", this.promoKey), h("wa-icon", { key: '99fb88349d92442613c3357665b4ce06dcaa4a9d', id: couponBadgeId, name: "ticket" }))))));
    }
};
...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (h(Host, { key: '47e0044ebe672f4dcdb016ee6a427d010ddbcc1e' }, this.channelBookingNumber && h("wa-tooltip", { key: '37da259bebe88837ec869350eeb4ac3c59843548', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), h("img", { key: 'aa30e3317a855a8d369761acad334568356ef62b', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), h("div", { key: '7d1f6892e284b3cda3482fb7066b4f7709bc8ba1', part: "container", class: "booking-nbr-cell__container" }, h("div", { key: '0027a308c6bfe03392a2a35ada193aadfb39aeb1', style: { width: 'fit-content' } }, h("button", { key: '2675b92e6ed49d5740b3fe3e2df5c970d0159d2d', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, formatBookingNumber(this.bookingNumber))), h("p", { key: '5cfe9725ef1f415d0c95ca728279d7c8a051e461', part: "booking-reference", class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? formatBookingNumber(this.channelBookingNumber) : this.origin.Label))));
    }
};
