...
const IrDatesCell = class {
    ...
    render() {
        return (h(Host, { key: 'cf91158a3d8dc9188547a8c7b99e811527d2e4d7' }, h("div", { key: 'cc9a6a65f3ea0bfb8ec988b9e0d7e6cc38c9f144', part: "checkin-container", class: "date-cell__container" }, this.checkInLabel && h("span", { key: 'b591da6985b6e46eee9b411188a708f16646d019', class: "date-cell__label" }, this.checkInLabel, ": "), h("p", { key: 'fa2afd094816d1eec029afb69a5ec0b7c70c9484', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), this.showArrow && h("wa-icon", { key: 'dc0c7c01b9a1d3c1c494484f0bb7574fd8a993c0', class: "date-cell__arrow", name: "arrow-right" }), h("div", { key: '1afbce8d4adced36cede521d3d8c53a4602ba6af', part: "checkout-container", class: "date-cell__container" }, this.checkoutLabel && h("span", { key: '596278394f0d8003c039510e36c5bbf1c5c7444c', class: "date-cell__label" }, this.checkoutLabel, ": "), h("p", { key: '4e5779fb7e368c4e545612f54e73d5b35d6b0f8f', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
