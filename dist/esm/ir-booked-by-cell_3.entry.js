...
const IrDatesCell = class {
    ...
    render() {
        return (h(Host, { key: '0ab12dd59154f6c4382ff0952007a94c62173715' }, h("div", { key: '5eacf7aa86220c9ca8576f627ccc5f2eb5d93085', part: "checkin-container", class: "date-cell__container" }, this.checkInLabel && h("span", { key: '07a49b4e4d177aca07cd3428b7fdd5795c1c8abc', class: "date-cell__label" }, this.checkInLabel, ": "), h("p", { key: 'bfe928e6f6a3f23b66aa3c1c448804b4e4fc2f09', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), this.showArrow && h("wa-icon", { key: '73d5ce3ba89bef63b7fc9c99431e1eb124fa393f', class: "date-cell__arrow", name: "arrow-right" }), h("div", { key: 'd00e1b94102143c55a068787a7e88e6276f683e6', part: "checkout-container", class: "date-cell__container" }, this.checkoutLabel && h("span", { key: 'ed3f9c30a92dd0f7923886e43e07b4e359b58fb1', class: "date-cell__label" }, this.checkoutLabel, ": "), h("p", { key: '07ebdd3837d557d2fa60e2b81e1606812ee3828c', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
