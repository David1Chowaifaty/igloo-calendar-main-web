...
import { C as ChannelService } from './channel.service-daadceb9.js';
...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '0f96f2b7907f9996225b92511f674537a74c7df8', class: " d-flex flex-column h-100" }, h("nav", { key: '1cb0bea1a6c188ac0ce8777c0777e417a82f86b2', class: "position-sticky sticky-top pb-1 top-0 bg-white " }, h("div", { key: 'ce41832fe04bd3d4f831f2b17e65466de16dce9c', class: "d-flex align-items-center px-1 py-1  justify-content-between" }, h("h3", { key: '0b01930867f33d94c2190678727de18d8b262b6a', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), h("ir-icon", { key: 'dd1dec3a8104f421efd7078d84bc0fbb5a72e122', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '5c7f7e4798047a6701c72a285db8dfacdef0122a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '954ce5522a0f6d9e9057d426ceb4ad5e72f21ecf', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), h("ir-channel-header", { key: '2ca23de3f08a0199f7ff5a8ccb1ef21c1f0247ee', class: "mt-1 px-0", headerTitles: this.headerTitles })), h("section", { key: '3d691a9d38c30e5ffcf1c9d55ca0cb0e7d3bb6e3', class: "flex-fill tab-container px-1" }, this.renderTabScreen()), h("ir-button", { key: '64840244ae60cb2e63a5bb0bbf98504d6d6d41f9', isLoading: this.isLoading, onClickHandler: () => {
