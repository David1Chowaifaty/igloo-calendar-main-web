...
import { C as ChannelService } from './channel.service-1b60b2d6.js';
import { o as onChannelChange, c as channels_data } from './channel.store-33a3e470.js';
...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '7cea0e286ea2fa58eae6199938f9f8b32b52c4de', class: " d-flex flex-column h-100" }, h("nav", { key: 'd46ff16e9b823860fbd668f02072961fbb7da9d6', class: "position-sticky sticky-top pb-1 top-0 bg-white " }, h("div", { key: 'b39d070eea0ccb04852c89256bd61a5cc199a36e', class: "d-flex align-items-center px-1 py-1  justify-content-between" }, h("h3", { key: '97cbaf6a58bb3a6172ea3568cf9caa9e0255e234', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), h("ir-icon", { key: 'afcb3d2ab0b469e7cb81aff62a8c375ee642cb83', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: 'bc86b9e6e53cf8aafe62f2a98fd7eed732a289a9', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '1b021278e515dbcea5e61391f70b1fc73b45e54a', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), h("ir-channel-header", { key: 'a9893d37605c62db45e0752bd74cda7a66871a7e', class: "mt-1 px-0", headerTitles: this.headerTitles })), h("section", { key: '03d34ebe33816258874f144f97c26398374603b5', class: "flex-fill tab-container px-1" }, this.renderTabScreen()), h("ir-button", { key: 'e5b7c5d7ffe2e5d5180c427a487e00a9d8684d17', isLoading: this.isLoading, onClickHandler: () => {
