...
import { C as ChannelService } from './channel.service-4d6ac94b.js';
...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '30f9d0fd189a4ea48997dcf110a5fc09945420c6', class: " d-flex flex-column h-100" }, h("nav", { key: '04c0cf7c9b29b376abfddb37a06f7354e6391b09', class: "px-1 position-sticky sticky-top pb-1 top-0 bg-white" }, h("div", { key: 'fa8ed2ae08fb354a957909b3d900307218ee9714', class: "d-flex align-items-center  justify-content-between" }, h("h3", { key: '3d89bd4d769d96ee7283376ee93d6496c63f7f95', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), h("ir-icon", { key: 'd9d5f0f6f19aa70ab2fd7518f123a791e3809683', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: 'b590fea1b751bce765c39976b04b3ac3711b328d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '54f32e49a61a1672269da16709bb4e54a8fb685e', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), h("ir-channel-header", { key: 'ebb2626eeb49ca5bd8ee96e1dc0ca19765cc897a', class: "mt-1 px-0", headerTitles: this.headerTitles })), h("section", { key: '46426bcf46b5c95a268b2840c1ec1dd30c1b3bf5', class: "py-1 flex-fill tab-container px-1" }, this.renderTabScreen()), h("ir-button", { key: 'eb3552eeccf3bc695c74d7b7958163b886633e0c', isLoading: this.isLoading, onClickHanlder: () => this.saveConnectedChannel(), class: "px-1 py-1 top-border", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Save })));
    }
};
