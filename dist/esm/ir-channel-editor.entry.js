...
import { C as ChannelService } from './channel.service-7da1b8d2.js';
...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '16dddf7f469e15f9c7dace9002a9f9c2700119a7', class: " d-flex flex-column h-100" }, h("nav", { key: '35a047d6f8223ae4d6f1cff9327c683dfd9017a3', class: "position-sticky sticky-top pb-1 top-0 bg-white " }, h("div", { key: '5d3c5014acca591127513681f54065f2c700beb2', class: "d-flex align-items-center px-1 py-1  justify-content-between" }, h("h3", { key: '19568e19fed4471c25076c038d8a18cae3f11282', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), h("ir-icon", { key: '64f89dae2556fa20f130fbfcc114ca200e7aa67c', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: 'fee4d65957ad77e76ed54b79acfe38d69d3fe077', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '2aef460edce8f5d74ebd145dbf686e0c0a6baa85', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), h("ir-channel-header", { key: 'a9f50fad635e082872760eedd179b0211395c2f9', class: "mt-1 px-0", headerTitles: this.headerTitles })), h("section", { key: '3052e36f2bbcd867fb3e7091ee26144a0f5a1dd0', class: "flex-fill tab-container px-1" }, this.renderTabScreen()), h("ir-button", { key: '9a70645b895edb26eeb89fa4603212d67a47693d', isLoading: this.isLoading, onClickHandler: () => {
