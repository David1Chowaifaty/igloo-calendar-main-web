...
import { C as ChannelService } from './channel.service-94701279.js';
...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: 'fcc723cac3b4813af36a8dd3b7f12e24e2e6ace5', class: " d-flex flex-column h-100" }, h("nav", { key: 'd85cd41a35af29e932dfe4802c8cec3cb77658e0', class: "position-sticky sticky-top pb-1 top-0 bg-white " }, h("div", { key: 'd7d52031bbd8896accf5e8dcae110621621d9047', class: "d-flex align-items-center px-1 py-1  justify-content-between" }, h("h3", { key: '1c489407b72323ebaa85a0ed3636690aedd28701', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), h("ir-icon", { key: '964e8a8f7fb8bb5270554effeb01e019a1e86cda', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '47b866fe6d74a28f9da6845cd077356bfa51f250', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '5f164318a492de573223fb7db5c5efa6f4c9c179', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), h("ir-channel-header", { key: '2c007152f62ff8ae6732be8e120ccbda90f2fb2e', class: "mt-1 px-0", headerTitles: this.headerTitles })), h("section", { key: 'ab933e481471c9bf4ac18223fc5c0572c31433aa', class: "flex-fill tab-container px-1" }, this.renderTabScreen()), h("ir-button", { key: '2b4f0854e52a7077b91496a65d91b3cef69044be', isLoading: this.isLoading, onClickHanlder: () => {
