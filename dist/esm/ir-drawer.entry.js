...
const IrDrawer = class {
    ...
    render() {
        return (h("div", { key: 'f01ea3b51f99a6f48ed66e6278607d418664f941', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, h("div", { key: '4e67bcf841493ce8150dfb1fa03f18c9f12c02a2', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), h("div", { key: '5e73c99e4ef3d464e8144efa23a4d6ec48145723', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, h("div", { key: 'ab5308d1e6cb39ecbc31b890502be4e7cb043def', class: "app-drawer-header" }, h("slot", { key: '13a0591d000819cdeb5a96970c04161dff9f7933', name: "header" }, h("h2", { key: 'ed24a2d134916d247abd108f08c67523c8369329', id: "drawer-title" }, this.drawerTitle))), h("div", { key: '3c6a0d7cff74f03daaaf34f428cc60c12ff806bb', class: "app-drawer-body" }, h("slot", { key: 'fbcbe83751224b2098600acbe4fc7450fe9819b1' })), h("div", { key: '71b99481b4bbfd7373b9f4d74ecc6fe48fb62ecb', class: "app-drawer-footer" }, h("slot", { key: '1340f04fe7bd59709ca77ad1da0684b529f66136', name: "footer" })))));
    }
