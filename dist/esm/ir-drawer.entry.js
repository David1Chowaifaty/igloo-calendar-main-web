...
const IrDrawer = class {
    ...
    render() {
        return (h("div", { key: '2ca0286d850c428cc7b390bf5f7aa9ce3e64d375', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, h("div", { key: '50b73d4b21c79d5b3f2e63bf3186c69f3219f704', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), h("div", { key: '65d5948ca63e1d84fa10a611c4b978e6307d841a', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, h("div", { key: 'ee9f4a882c34f0529b5e7e47aaf9b6770b9397f1', class: "app-drawer-header" }, h("slot", { key: '0c5b6358b4c0580496abd6d8d4ea11dec503b3d6', name: "header" }, h("h2", { key: 'f3205473f883e1074fb9a5fdac276114f1e9faf4', id: "drawer-title" }, this.drawerTitle))), h("div", { key: 'd6b92a68886554a94255537bcb4b2deb94db49d4', class: "app-drawer-body" }, h("slot", { key: 'ed02289db38c10083ff77df9249d08ab1b1eb7ba' })), h("div", { key: '726ea57dc857e5b9e9be4f4da01e00384d906934', class: "app-drawer-footer" }, h("slot", { key: 'f4286fd8eca1e4f835764e7432fbe611fea90cc3', name: "footer" })))));
    }
