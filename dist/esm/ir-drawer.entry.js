...
const IrDrawer = class {
    ...
    render() {
        return (h("div", { key: 'ed89c4f99c0a0e365f3100a4468cd933722e2e2f', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, h("div", { key: '41de2ca8516f86cbfa5fff99ebf572a544936fb9', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), h("div", { key: '14155d39166cc32e922df770b9006884ceeec20b', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, h("div", { key: 'e4f3db25821a19a4f5046bde6da4a670e4cafb42', class: "app-drawer-header" }, h("slot", { key: '039cc466e9118dbd5b6cbacff984500c97f50cd9', name: "header" }, h("h2", { key: 'ca2338780d1f72e550692517e84908b096566af7', id: "drawer-title" }, this.drawerTitle))), h("div", { key: 'aaad5f8115080653430eb695aec9de5c79686916', class: "app-drawer-body" }, h("slot", { key: 'b29127acf99055fa79967b6a15c5dd5e823353b9' })), h("div", { key: '322cb2a24593667db0a1c37108eb2a7a587462db', class: "app-drawer-footer" }, h("slot", { key: '5ec829e37c416a57584564093af1f711e91fed1a', name: "footer" })))));
    }
