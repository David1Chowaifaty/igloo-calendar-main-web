...
const IrDrawer = class {
    ...
    render() {
        return (h("div", { key: '5aef1e9d24e42a46cc40e435ea750732ab777552', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, h("div", { key: '1978b45068bed1a423284954d2d12fd05fcbada6', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), h("div", { key: '9d946a5fa5e2b99f61d6c82f1b0ba681b6dcd853', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, h("div", { key: 'ac2256354899154ac074cb313f0d4ca9c7f8158d', class: "app-drawer-header" }, h("slot", { key: '88977bfbdffbdcf288222dd5c3b62dc4e39bfb00', name: "header" }, h("h2", { key: '345354ad700fe1bad87514b289224c95d6aaa0a4', id: "drawer-title" }, this.drawerTitle))), h("div", { key: '55046912c732400dd472f1ed6b4797ca6a793132', class: "app-drawer-body" }, h("slot", { key: 'cf9773bc391e1b1fc603ea32ae813bec4f44126e' })), h("div", { key: '97ed9f8d20e7b6ff0c769adfa60f3054d4f73c65', class: "app-drawer-footer" }, h("slot", { key: '3e884bd83c4b76fbcba33f19f86f3144b64a14c3', name: "footer" })))));
    }
