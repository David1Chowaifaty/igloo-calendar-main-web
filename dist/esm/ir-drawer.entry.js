...
const IrDrawer = class {
    ...
    render() {
        return (h("div", { key: 'ee9340006fb707f9fa36b795634b4a8ccb9cbfdc', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, h("div", { key: '2f1cedb09617421be406d969f2ad0640942699f1', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), h("div", { key: 'bcdba906fc5653183c839fa3bfebd1366f6c601f', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, h("div", { key: '439aad32303ad2cd57076c43d016f4b5b7077ad2', class: "app-drawer-header" }, h("slot", { key: '988735faf07264da91033dd208f6acce6ebf6ed0', name: "header" }, h("h2", { key: 'e78afeeb0f59fc3656a79adc1e5e6582fbd43e10', id: "drawer-title" }, this.drawerTitle))), h("div", { key: 'bec0039d01126bb7da3156016af0b2c276a84a09', class: "app-drawer-body" }, h("slot", { key: '8ba9f57b3a3e713b5999f4b7ffd882c8f6fe481b' })), h("div", { key: '9bfc7a2c4d3370d48223c183de19d899326b801c', class: "app-drawer-footer" }, h("slot", { key: '34f57fa98add36af3f58d4a775178e24e5db9978', name: "footer" })))));
    }
