...
const IrDrawer = class {
    ...
    render() {
        return (h("wa-drawer", { key: 'cc087e12410abc6e24ced316f32eb96c081c745b', id: this.el.id, "onwa-show": this.onDrawerShow, "onwa-hide": this.onDrawerHide, class: "ir__drawer", style: { '--size': 'var(--ir-drawer-width,40rem)' }, open: this.open, label: this.label, placement: this.placement, withoutHeader: this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotManager.hasSlot('header-actions') && h("slot", { key: '259a606eb59800488c894e25c1ae017b52b5ddbb', name: "header-actions", slot: "header-actions" }), this.slotManager.hasSlot('label') && h("slot", { key: '2028c36e918865601d5ed1d2907bf2f98b81608b', name: "label", slot: "label" }), h("slot", { key: 'c396def90ff9690f26993b23c50ce5155e702ff3' }), this.slotManager.hasSlot('footer') && h("slot", { key: 'a7ce297934117de01714775c81a67b3a1834c215', name: "footer", slot: "footer" })));
    }
};
__decorate([
    OverflowAdd()
