...
const IrDrawer = class {
    ...
    render() {
        return (h("div", { key: '2841f01640cf9697db1e1ac4dc4e4396022d3334', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, h("div", { key: 'ec7015ecc53ed90aa61c7f94f08552b2171f4b68', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), h("div", { key: '5484ea9233aa258af9aaa81a42ebde234be08685', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, h("div", { key: 'a4948ce2e46fabcdf21764194b4685fe33c068bf', class: "app-drawer-header" }, h("slot", { key: '8c2ea89baf1275e7c1133249109188e346ccbde8', name: "header" }, h("h2", { key: 'e1359254009258e18536f13c5cc1c546a281096b', id: "drawer-title" }, this.drawerTitle))), h("div", { key: 'ccba46a331f940e8b50b51a93f66b0e2c11aace3', class: "app-drawer-body" }, h("slot", { key: '6844895ce3d976d7b6d8e23ef8ebb4ebf095e776' })), h("div", { key: '06071f8e9a3256210f9283438ff840960e2c8398', class: "app-drawer-footer" }, h("slot", { key: 'c84068f4a8e09d84c81dd9bd26d6db97e4e4e701', name: "footer" })))));
    }
