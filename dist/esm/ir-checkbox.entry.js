...
const IrCheckbox = class {
    ...
    render() {
        return (h(Host, { key: '5a480b74d47ab1b3fc2956d036dc2881988cb0e0' }, h("button", { key: '3a8d4e1ce80e596b665218d4408a0989aa996ca6', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: 'ccf4013b17e358c96871808eafcd8630a47b11a9', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '4c8c7f9b22763216b55ccbc89fc2487734045877', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), h("input", { key: '5468a7846a08aadea6e7f80f490db4e3ca546574', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && h("label", { key: 'acea81110154e514ceb72f1afdc8ef17fbbc6ff2', htmlFor: this.checkboxId }, this.label)));
    }
