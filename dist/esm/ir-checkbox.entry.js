...
const IrCheckbox = class {
    ...
    render() {
        return (h(Host, { key: 'fe033505acb5c03faf87054f81ebe9f1400c2ad8' }, h("button", { key: 'bbc58db881c9f1f296715e4c03a6e0d3f2b7943f', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: '672dabd15781aa7608eb702274bd7ef045b69583', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '415f0f621421f8014b747ccaceff13bc2b6ee252', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), h("input", { key: '498f66ac134d9edc8b3bd54a65a01f10bb938f82', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && h("label", { key: 'a68442257c884356b62490ff05ec61df4a8baaaa', htmlFor: this.checkboxId }, this.label)));
    }
