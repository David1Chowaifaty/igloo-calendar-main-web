import { r as registerInstance, h, H as Host, F as Fragment } from './index-JbQjGrUG.js';
...
const IrClFiscalDocumentTable = class {
    ...
    render() {
        return (h(Host, { key: 'f839c6ea07ac91c15f8184241641dc5b6c193d6e' }, h("section", { key: 'f917fad45123783cdb45fc730b336e68eeb17cf4', class: "invoice-items" }, h("table", { key: '64272e359756e57806754347656453a0906c9ef3', class: "cl-table" }, h("thead", { key: '7c4f831e5f1c61d85b1a861e2fec4845bea184bb' }, h("tr", { key: '11bbf55bb526f8ba673e3f1e41450d8441175d0c' }, h("th", { key: '19016328dbe860fd2ddcf775e3e0e754f1d97326', class: "cl-th" }, "Date"), h("th", { key: 'a28dcb62d0a18fb08c95801fd2a96dff296050f6', class: "cl-th", style: { width: '100%' } }, "Description"), h("th", { key: 'afbf94cf472949b42967843561e1bb946320fcda', class: "cl-th cl-th--num" }, "Net Price"), h("th", { key: 'a8bbe66ef3b3bbab1148208c924495810134d7a0', class: "cl-th" }, "VAT"), h("th", { key: '5301652cce7ea49e01eede03b034103a7951198e', class: "cl-th cl-th--num" }, "VAT Amount"), this.showCityTax && (h("th", { key: '4604d5502d37cc226aa0490647b6a6e7124e3b3d', class: "cl-th" }, "City ", h("br", { key: 'dcb3d6ceaf0d70931d8ea6d922f989e9235d6b2c' }), "Tax")), this.showCityTax && (h("th", { key: '2f212d49df29e29f91809a61b2783cc01c28a9f8', class: "cl-th cl-th--num" }, "City Tax", h("br", { key: '2c680ff76a81de548521421975cbee2aecf56baa' }), " Amount")), h("th", { key: '9707c2a730f9d26929e6be81dd17ad04708b7491', class: "cl-th cl-th--num" }, "Total"))), h("tbody", { key: 'c766915f8e28c9c4d7d81b03f1a879fd7827e1e8' }, this.transactions.length === 0 ? (h("tr", null, h("td", { class: "cl-td cl-td--empty", colSpan: this.showCityTax ? 8 : 6 }, "No transactions found for this document."))) : (h(Fragment, null, groupData(this.transactions).map(item => this.renderTopLevelItem(item)), this.renderTotals())))))));
    }
};
...
const IrClInvoiceCityTaxAmountCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: '8bcd8908386642d8f25c90b8a07cdb390fc165ed' }, this.cityTaxPercent > 0 ? formatAmount(this.currencySymbol, this.amount) : '');
    }
};
...
const IrClInvoiceDateCell = class {
    ...
    date;
    render() {
        return h(Host, { key: 'cd0f6a83053f425161304e96ff9128c2a56d2357' }, hooks(this.date, 'YYYY-MM-DD').format('MMM DD, YYYY'));
    }
};
...
const IrClInvoiceNetPriceCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'a4965a5b760b281d29a46ca7942ae23675a26074' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatPctCell = class {
    ...
    vatPercent;
    render() {
        return h(Host, { key: '3640989eb8a16b647ef3ef782edb80b2601c5918' }, this.vatPercent, "%");
    }
};
