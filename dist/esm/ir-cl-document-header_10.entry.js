...
import { f as formatAmount } from './number-DegV2dS7.js';
...
const IrClFiscalDocumentTable = class {
    ...
    render() {
        return (h(Host, { key: 'bf9a07ea5bc213cebf454a7f066a9737d69e216f' }, h("section", { key: 'd518e7c76b2314f3939bb94a812b4ee8b77776bf', class: "invoice-items" }, h("table", { key: '52a98d52aecd965c741ac1f290f011cddbf4bdac', class: "cl-table" }, h("thead", { key: '21cb4bb527af78d839e3247b9da72ab1484b0ea7' }, h("tr", { key: 'b9f52526a0dfe8ff7e67b86a0c20af4b421262e0' }, h("th", { key: 'e7a051836edaa8c36e1ba721c66db6289103be67', class: "cl-th" }, t('Lcz_DateLabel', { fallback: 'Date' })), h("th", { key: '69581d5f6efb721577c7be5729e686a45a87687c', class: "cl-th", style: { width: '100%' } }, t('Lcz_Description', { fallback: 'Description' })), h("th", { key: 'a7fc8f905b52d7a4844c81a207d7ecba1cd5456b', class: "cl-th cl-th--num" }, t('Lcz_NetPriceLabel', { fallback: 'Net Price' })), h("th", { key: 'b1cc1f3176372ef22528fbd0f9562e5dd1fdef85', class: "cl-th" }, t('Lcz_Vat', { fallback: 'VAT' })), h("th", { key: '070fcb371e03d3ed36af2a08a97f18f4778a53f1', class: "cl-th cl-th--num" }, t('Lcz_VatAmountColumn', { fallback: 'VAT Amount' })), this.showCityTax && h("th", { key: 'b8001a297645b99229b4f0af0a373162fbf13b32', class: "cl-th" }, t('Lcz_CityTaxColumn', { fallback: 'City Tax' })), this.showCityTax && (h("th", { key: '04854fd7e54f318af7c22e28677dd9adf380664f', class: "cl-th cl-th--num" }, t('Lcz_CityTaxColumn', { fallback: 'City Tax' }), h("br", { key: 'd55275cc39b5bdf3dba1a963e9978765fde21598' }), " Amount")), h("th", { key: 'a3c90f50976c2ea333e40ce5e32497327cefa4ed', class: "cl-th cl-th--num" }, t('Lcz_Total', { fallback: 'Total' })))), h("tbody", { key: '85100946b8bfd7c1ea4824421d075a8bc55b0f34' }, this.transactions.length === 0 ? (h("tr", null, h("td", { class: "cl-td cl-td--empty", colSpan: this.showCityTax ? 8 : 6 }, t('Lcz_NoTransactionsForDocument', { fallback: 'No transactions found for this document.' })))) : (h(Fragment, null, groupData(this.transactions).map(item => this.renderTopLevelItem(item)), this.renderTotals())))))));
    }
};
...
const IrClInvoiceCityTaxAmountCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: 'ce844adb562a154bfe028cdb94f33d6b493e4756' }, this.cityTaxPercent > 0 ? formatAmount(this.currencySymbol, this.amount) : '');
    }
};
...
const IrClInvoiceCityTaxPctCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: '5b926718e377f9032166056bfc1a43dd7e372911' }, this.cityTaxPercent > 0 ? `${this.cityTaxPercent}%` : '');
    }
};
...
const IrClInvoiceDescriptionCell = class {
    ...
    description;
    render() {
        return (h(Host, { key: 'ba18bd1ec3bf5b1402a056d140643ce161035c30' }, h("span", { key: 'f0264be946014d0d170fe9726a7aa2fa41d128d6', class: "desc" }, this.description)));
    }
};
...
const IrClInvoiceNetPriceCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: '8209b51f7fbb7c0602427382d2d9b6ff2977b006' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceTotalCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: '9efe345aa4a85a9b07a982da707c2aba43b0f695' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatAmountCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: '46977dbde5f5549ac47f3159da38272a91b59e3e' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatPctCell = class {
    ...
    vatPercent;
    render() {
        return h(Host, { key: '252df1c4b7a59bb785f618709b642f9698ae32d5' }, this.vatPercent, "%");
    }
};
