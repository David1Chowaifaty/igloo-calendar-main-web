...
const IrClInvoiceDateCell = class {
    ...
    date;
    render() {
        return h(Host, { key: 'e312f6b1f222d2733c6fa0254708435ff06d8139' }, hooks(this.date, 'YYYY-MM-DD').format('MMM DD, YYYY'));
    }
};
...
const IrClInvoiceDescriptionCell = class {
    ...
    description;
    render() {
        return (h(Host, { key: '5e015c6b49e188cbf2081d81a795347540a352e2' }, h("span", { key: '0c7e613d96ee852e302551a885ceb59aed21b125', class: "desc" }, this.description)));
    }
};
...
const IrClInvoiceTotalCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'e1b3a1f11db9b019e924c5bf57335ec8045637c9' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatAmountCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: '014517465b5cc251ccc7d1cd5e662a859b03f8a4' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatPctCell = class {
    ...
    vatPercent;
    render() {
        return h(Host, { key: '6541ce4bba3ebc42190bace7b6a65acec1cab456' }, this.vatPercent, "%");
    }
};
