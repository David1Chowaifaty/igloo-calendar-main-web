import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement, H as Host } from './index-d2ec0a5d.js';
import { b as _formatDate, _ as _formatTime, a as _formatAmount, c as _getDay } from './functions-10a29c1f.js';
...
import { g as getPrivateNote } from './booking-bcc64520.js';
import { P as PaymentService } from './payment.service-bc122c95.js';
import { h as hooks } from './moment-ab846cee.js';
import { c as colorVariants$1 } from './icons-644a8fb4.js';
import { a as isRequestPending } from './ir-interceptor.store-713e7358.js';
import { r as renderTime } from './utils-ff429cce.js';
import { f as formatName } from './booking-5899a14e.js';
...
const IrPaymentDetails = class {
    ...
    _renderTableRow(item, rowMode = 'normal') {
        ...
        return (h(Fragment, null, h("tr", null, h("td", { class: 'border payments-height border-light border-bottom-0 text-center' }, rowMode === 'normal' ? (h("span", { class: "sm-padding-left" }, _formatDate(item.date))) : (h("ir-date-picker", { date: ((_a = this.itemToBeAdded) === null || _a === void 0 ? void 0 : _a.date) ? new Date(this.itemToBeAdded.date) : new Date(), minDate: hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), singleDatePicker: true, autoApply: true, onDateChanged: this.handleDateChange.bind(this) }))), h("td", { class: 'border payments-height border-light border-bottom-0 text-center ' }, rowMode === 'normal' ? (h("span", { class: "sm-padding-right" }, _formatAmount(item.amount, this.bookingDetails.currency.code))) : (h("input", { type: "text", class: "border-0 text-center form-control py-0 m-0 w-100", value: this.itemToBeAdded.amount, onBlur: e => {
            ...
            } })), h("ir-button", { variant: "icon", icon_name: "trash", style: colorVariants$1.danger, isLoading: ((_b = this.toBeDeletedItem) === null || _b === void 0 ? void 0 : _b.id) === (item === null || item === void 0 ? void 0 : item.id) && isRequestPending('/Cancel_Payment'), onClickHanlder: rowMode === 'add'
                ? () => {
                    this.newTableRow = false;
                    this.initializeItemToBeAdded();
                }
...
export { IrBookingDetails as ir_booking_details, IrBookingExtraNote as ir_booking_extra_note, IrDialog as ir_dialog, GuestInfo as ir_guest_info, IrLabel as ir_label, IrPaymentDetails as ir_payment_details, IrPickup as ir_pickup, IrPickupView as ir_pickup_view, IrRoom as ir_room, IrSpinner as ir_spinner };

//# sourceMappingURL=ir-booking-details_10.entry.js.map