...
import { P as PropertyService } from './property.service-9e9cdade.js';
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (h("div", { key: '3f20157e8a3188c219c9450435b83e215e85789d', class: "sheet-container" }, h("ir-title", { key: '3fc609ea32049a5b9eea24a8ebef3f1221e093d9', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: 'a2532b46ddc45f50c6f8e6c1b908d18a946d2fa0', class: "px-1 sheet-body" }, h("table", { key: 'abe6c3e707b2594bc0235ef4068638858dd638f0' }, h("thead", { key: '59c6560586c2013c504d2c686ae47a783e1ee1a8' }, h("th", { key: '1a98472718c835b32b4d90928efba67351b55248', class: "sr-only" }, locales.entries.Lcz_RoomName), h("th", { key: '1137c97d72aab412a7a5809952f68ce3fe96bc36', class: "sr-only" }, locales.entries.Lcz_HousekeeperName), h("th", { key: '0f537df2ab07c60da0b16c365a2dc8052c981f05', class: "sr-only" }, locales.entries.Lcz_Actions)), h("tbody", { key: '937d3b1f532e64f5b3f7dcd6fba74afb7ed1a158' }, this.renderRooms()))), h("div", { key: '9966bd1db34ab5c661646ead344bd04643fc93e0', class: "sheet-footer" }, h("ir-button", { key: '576e2bcbd3709aef57e31773421fa3f2b3fcadaf', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: '5573c5862fdf25005cdeffc174ae9957c4783ba0', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUnassignedUnitsDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'd4922534b9e66678095306dbba07197a30448109', label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}`, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeSideBar.emit(null);
            }, style: { '--ir-drawer-width': 'max-content' }, open: this.open }, this.open && h("ir-hk-unassigned-units-drawer-form", { key: 'a75bae4da75959d72f5e265b61532e10ee609d1c', formId: this.formId, user: this.user }), h("div", { key: '33bf2f04656e971b9d99a008be6737712c6a406c', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '29212982a5401508b189997ac187e46946d1e592', "data-drawer": "close", variant: "neutral", size: "medium", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: 'ab1c97355d062fd85f77cad2d7a770d2a7f89681', loading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), variant: "brand", type: "submit", form: this.formId, appearance: "accent", size: "medium" }, "Save"))));
    }
};
...
//# sourceMappingURL=ir-hk-delete-dialog_6.entry.js.map