import { r as registerInstance, c as createEvent, h, H as Host, F as Fragment, g as getElement } from './index-e7294bf2.js';
import { g as getCurrencySymbol, d as dateToFormattedString, a as getReleaseHoursString, h as hooks, r as renderTime } from './utils-4ade30ea.js';
import { l as locales, c as createStore } from './locales.store-ed047ebc.js';
import { c as calendar_data } from './calendar-data-46cc7189.js';
import { v as v4 } from './v4-964634d6.js';
import { B as BookingService, t as transformNewBLockedRooms, c as calculateDaysBetweenDates, f as formatName } from './booking.service-260bc9e7.js';
import { E as EventsService } from './events.service-9da51d72.js';
import { a as axios, T as Token } from './Token-919197e3.js';
import { R as RoomService } from './room.service-d7ff7893.js';
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (h(Host, { key: '64fb5261c86a260330c7582138de7d5c9791e4e6' }, h("div", { key: 'a89b9ad6d4333b98678d9a041bf1293aca1e917a', class: "text-left mt-1 " }, h("div", { key: 'a904832f886f4be254d752a24e6ed6e4e7b39813', class: " mb-1 " }, this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING' ? (h("span", { class: "h5 mr-1" }, this.guestInfo.roomCategoryName)) : null, h("span", { key: '98d808a885bbc4a2d62ad78ab9b8b3c0061ddaaf', class: " font-weight-bold" }, this.guestInfo.ratePlanName.replace(this.guestInfo.roomCategoryName + '/', ''), h("ir-tooltip", { key: '245e3e929d843f96d039e20c5cd53ca70ef6b00b', class: " mr-1", message: this.guestInfo.cancelation + this.guestInfo.guarantee })), h("span", { key: '00e97792d951fc79c0fee3f63c06054252cc6cc2' }, this.guestInfo.adult_child_offering)), h("div", { key: '85303a274ddd38429d66caafe04192b0eeb8eaab', class: "d-flex flex-column flex-md-row m-0 p-0 align-items-md-center aplicationInfoContainer " }, h("div", { key: '54d4ce05a3bb987c222110a2ef2a631e31c708d2', class: "mr-1 flex-fill guest-info-container" }, h("input", { key: 'e8d7c09d53b9a17aee52b47897d16d12cec8a35a', id: v4(), type: "email", class: `form-control ${this.isButtonPressed && this.guestData.guestName === '' && 'border-danger'}`, placeholder: locales.entries.Lcz_GuestFirstnameAndLastname, name: "guestName", onInput: event => this.handleGuestNameChange(event), required: true, value: this.guestData.guestName })), h("div", { key: '4cfec2b54636c51f801e75b230286fd707076514', class: 'mt-1 mt-md-0 d-flex align-items-center flex-fill' }, calendar_data.is_frontdesk_enabled && (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') ? (h("div", { class: "mr-1 p-0 flex-fill  preference-select-container" }, h("select", { class: `form-control  input-sm pr-0`, id: v4(), onChange: event => this.handleDataChange('roomId', event.target.value) }, h("option", { value: "", selected: this.guestData.roomId === '' }, locales.entries.Lcz_Assignunits), this.filterdRoomList.map(room => (h("option", { value: room.id, selected: +this.guestData.roomId === room.id }, room.name)))))) : null, this.guestData.is_bed_configuration_enabled && (h("div", { class: "mr-1 flex-fill" }, h("select", { class: `form-control input-sm ${this.isButtonPressed && (this.guestData.preference === '' || this.guestData.preference === 0) && 'border-danger'}`, id: v4(), onChange: event => this.handleDataChange('preference', event.target.value) }, h("option", { value: "", selected: this.guestData.preference === '' }, locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => (h("option", { value: +data.CODE_NAME, selected: this.guestData.preference === +data.CODE_NAME }, data.CODE_VALUE_EN)))))), h("div", { key: '71d59b3f36b4e51b41372b14133c844449bc42de', class: "" }, getCurrencySymbol(this.currency.code) + Number(this.userRate).toFixed(2), "/", locales.entries.Lcz_Stay))))));
    }
...
const { state: interceptor_requests, onChange: onCalendarDatesChange } = createStore(initialState$1);
...
const IrBookingListing = class {
    ...
    render() {
        ...
        return (h(Host, null, h("ir-interceptor", null), h("ir-toast", null), h("div", { class: "p-1 main-container" }, h("ir-listing-header", null), h("section", null, h("div", { class: "card p-1 flex-fill m-0 mt-2" }, h("table", { class: "table table-striped table-bordered no-footer dataTable" }, h("thead", null, h("tr", null, h("th", { scope: "col", class: "text-left" }, (_a = locales.entries) === null || _a === void 0 ? void 0 :
            _a.Lcz_Booking, "#"), h("th", { scope: "col" }, (_b = locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_BookedOn), h("th", { scope: "col" }, (_c = locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_GuestSource), h("th", { scope: "col" }, (_d = locales.entries) === null || _d === void 0 ? void 0 :
            _d.Lcz_Price, "/", h("span", { class: 'text-danger' }, locales.entries.Lcz_Balance)), h("th", { scope: "col" }, (_e = locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Services), h("th", { scope: "col", class: "in-out" }, (_f = locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_InOut), h("th", { scope: "col" }, (_g = locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Status), h("th", { scope: "col" }, h("p", { class: "sr-only" }, "actions")))), h("tbody", { class: "" }, (_h = booking_listing.bookings) === null || _h === void 0 ? void 0 : _h.map(booking => {
            var _a;
        ...
        }))), h("section", { class: 'd-flex flex-column flex-md-row align-items-center justify-content-between' }, h("p", { class: "m-0 mb-1 mb-md-0" }, this.renderItemRange()), h("div", { class: 'd-flex align-items-center buttons-container' }, h("ir-button", { size: "sm", btn_disabled: this.currentPage === 1, onClickHanlder: async () => {
                this.currentPage = 1;
...
const IrButton = class {
    ...
    render() {
        ...
        return (h("button", { key: '8287957d9cdc43024296053e2fa482d84b8617a1', id: this.btn_id, ref: el => (this.buttonEl = el), onClick: () => this.clickHanlder.emit(), class: `btn btn-${this.btn_color} ${this.btn_styles} d-flex align-items-center btn-${this.size} text-${this.textSize} ${blockClass}`, type: this.btn_type, disabled: this.btn_disabled }, h("span", { key: 'ecaff1533fd855d315b2f1697a1b0753a1e7a5b9', class: "button-icon", "data-state": this.isLoading ? 'loading' : '' }, h("slot", { key: '56fc05ad815efb813ccf52d9192649e02c1c91d4', name: "icon" })), this.text && h("span", { class: "button-text m-0" }, this.text), this.isLoading && h("div", { class: "loader m-0 p-0" })));
    }
};
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '79341c36cb9d1a18c7ddbe6f24f11134650709b4', class: "d-flex align-items-center" }, h("span", { key: '8b864b603e874ff38bd94ae8a0bb8e3ca7eff1f9' }, this.dates.from_date), ' ', h("svg", { key: '14626113834437d398175e467830e99aeaf5501a', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '0199bba3afedc1c9a76e869d58ca4c97d7e8ba0e', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '015abf43e9f373ce5bd8e971b925b4c881be9069' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'e11664c1b51283718f74189c0c0e0d34843b9412', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.closeModal();
                } }),
            h("div", { key: 'f8ccfc83a9462bff96bc316c0ba872a924c1971d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: '9743015c06c0e9a8ebe8a7b2d023010b03088556', class: `ir-alert-content p-2` }, h("div", { key: 'dbbe10726b98a4e8535ea7d4fdf42e4b5d7b6aa2', class: `ir-alert-header align-items-center border-0 py-0 m-0 ` }), h("div", { key: '9344ec61e673b99ea28f3a307f2950da066a5a91', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'd4913afa72ba11146592780f4c2aef77ec2670ef' }, this.modalBody)), h("div", { key: '65a51f92561ca711dfcd8138dc8599def822eb18', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && h("ir-button", { icon: '', btn_color: this.rightBtnColor, btn_block: true, text: this.rightBtnText, name: this.rightBtnText })))),
        ];
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (h(Host, { key: '63419e81095dcb7922ccd015a23b528918dec505', class: 'p-0' }, h("div", { key: 'f4d33e55a5c4064d9d7c41650547d4361aa14377', class: "position-sticky mb-0 shadow-none p-0" }, h("div", { key: '9d225bf66be4da6a63bcb7dd19a4629962bf2e48', class: "mt-2 custom-card-container pb-1 mb-3 px-1" }, h("h3", { key: 'f54267f32748860af36ef6a52ce15ae3821c2ad8', class: "card-title p-0  m-0 text-left font-medium-2" }, locales.entries.Lcz_Pickup), h("div", { key: '5e8078da854feac24cfb1d59af461dd8358a2432' }, h("ir-icon", { key: 'b03b6000aaf1185bdac30c651dffc454d2a9bbad', class: 'close m-0 p-0 ', onIconClickHandler: () => {
                this.closeModal.emit(null);
            } }, h("svg", { key: '9c6cf7e79a46902894b6758d6a832df142db9276', slot: "icon", xmlns: "http://www.w3.org/2000/svg", class: "m-0 p-0", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '854cab113dab28e6fed7fa020a7247aae0088f45', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("section", { key: 'c9cc60b5c8c7da420445557f59c305a0bbdaa7aa', class: 'px-1' }, h("ir-select", { key: 'bd6e0c27d65b2ace97ca848c38110d096fb4239d', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h(Fragment, null, h("div", { class: 'd-flex' }, h("div", { class: "form-group  mr-1" }, h("div", { class: "input-group row m-0" }, h("div", { class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, h("ir-date-picker", { minDate: hooks().format('YYYY-MM-DD'), autoApply: true,
...
const IrRoom = class {
    ...
    render() {
        return (h(Host, { key: '99a1656926e380edc6afad775e36e1969a2c2230', class: "p-1 d-flex m-0" }, h("ir-icon", { key: 'b55e9e50d439a84a7d208430378fc971021d8f72', id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "pointer mr-1", onClick: () => {
                this.collapsed = !this.collapsed;
            } }, !this.collapsed ? (h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, h("path", { fill: "#104064", d: "M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z" }))) : (h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "25", viewBox: "0 0 640 512", slot: "icon" }, h("path", { fill: "#104064", d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z" })))), h("div", { key: '9de60b826a544a0b33d85e0d00bc6a3abef8162e', class: "flex-fill m-0 " }, h("div", { key: 'a39cca235db27c26c4e23be7b3a96fd66b22fd97', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: 'fcc45accaf37b89566cfd432ab0805b06f4fb6fd', class: "m-0 p-0" }, h("strong", { key: '70c1642e7caf70f4507f347862eacc22f7c36198', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '1829c05284be8be7dad71b00d2acea7f9bf636c7', class: "d-flex m-0 p-0 align-items-center" }, h("span", { key: '19c6aa32ac3e83b0567b9690c8a4f3f7e4583c81', class: "p-0 m-0 ml-1 font-weight-bold" }, _formatAmount(this.item['gross_total'], this.currency)), this.hasRoomEdit && (h("ir-icon", { id: `roomEdit-${this.item.identifier}`, class: "pointer mx-1", onClick: this.handleEditClick.bind(this) }, h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", viewBox: "0 0 512 512" }, h("path", { fill: "#6b6f82", d: "M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" })))), this.hasRoomDelete && (h("ir-icon", { onClick: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, class: "pointer" }, h("svg", { slot: "icon", fill: "#ff2441", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "14.25", viewBox: "0 0 448 512" }, h("path", { d: "M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" })))))), h("div", { key: '5cd0876f3c7cca455b8e1bf1a2921f7d778a1fa2', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: 'a234543e983b1aa6ed0dd863f915ae7e7fa22841', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), calendar_data.is_frontdesk_enabled && this.item.unit && h("span", { class: "light-blue-bg mr-2 " }, this.item.unit.name), this.hasCheckIn && h("ir-button", { id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && h("ir-button", { id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), h("div", { key: 'c45f0622f37bcba483df1910c09da8c067dc5468' }, h("span", { key: '6244de1bab2a373ae084a8d98e6b964cdb36eaf2', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && h("span", null, " ", this.item.rateplan.selected_variation.adult_child_offering)), h("div", { key: '207de689340f483a7a0a6cf184bd38ca884afc5e', class: "collapse", id: `roomCollapse-${this.item.identifier.split(' ').join('')}` }, h("div", { key: '1f474991a17ef4d2dce0b1be1c555f4428c6cd72', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: 'a8b4bb1b6e01ac90e3ac80bf67cb4b58f77f56e5', class: " sm-padding-top" }, h("strong", { key: '544d692dd5f14a2b4e8a53c3db0582a2f6dc00c8', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), h("div", { key: 'd077f7b6f388b977569455dbd3948fd0afd9385a', class: 'flex-fill' }, h("table", { key: '3baa3b2a736e73ffccb1aefd5e8cadb4aefe7a42' }, this.item.days.length > 0 &&
            this.item.days.map(item => (h("tr", null, h("td", { class: 'pr-2 text-right' }, _getDay(item.date)), " ", h("td", { class: "text-right" }, _formatAmount(item.amount, this.currency))))), h("tr", { key: '9efaa5f13d01c9e4b5e4303a093143932c4132a5' }, h("th", { key: '7d956ef41eb6706903c8a992fe3512ddd5297b4b', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), h("th", { key: '21a7a9b3cb4d9c96d2510be1f09da5aaa64fbf1f', class: "text-right" }, _formatAmount(this.item.total, this.currency))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '9fda8ae37ce800ae08c28e4528023842c5c04ef2', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '2cd6407fcf94b0d7cef2c290fd9661e8c7e2366c', class: "input-group row m-0" }, label, h("select", { key: '052e2b423ff6e260ee312af4d766cfc7e5c668ce', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: 'c6180d04d1630465edeb57e3d0bcdf98683b8a23', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '152ce87d6f0444bbfc00f559d8aa6bf629596570', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("ir-icon", { class: "close", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), h("slot", { key: 'b13fdf1b40e5117a226bee354fd6179b002e52b1' })),
        ];
    }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return h(Host, { key: '690869c5616a177d70fb1497fb9a1110a5f37b6a' });
    }
    get element() { return getElement(this); }
};
