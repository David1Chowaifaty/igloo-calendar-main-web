import { r as registerInstance, c as createEvent, a as getElement, h, F as Fragment, H as Host } from './index-DCCEVrU4.js';
import { R as RoomService } from './room.service-BDr5_XRp.js';
import { B as BookingService } from './booking.service-B4SIj2Et.js';
import { A as formatLegendColors, d as dateToFormattedString, k as isBlockUnit, B as getNextDay, C as addTwoMonthToDate, D as computeEndDate, E as convertDMYToISO, n as showToast, l as isPrivilegedUser, j as downloadFile, F as groupEntryTablesResult, o as getEntryValue } from './utils-DK1ZYV0C.js';
...
import { e as calendar_dates, f as addCleaningTasks, h as formatName, i as getRoomStatus, j as cleanRoom, k as addRoomForCleaning, t as transformNewBooking, l as transformNewBLockedRooms, m as bookingStatus, d as getPrivateNote, c as calculateDaysBetweenDates } from './booking-C7XExJX4.js';
import { l as locales } from './locales.store-DkjT6ou2.js';
import { c as calendar_data } from './calendar-data-B7ocnCQe.js';
import { h as handleUnAssignedDatesChange, a as addUnassignedDates, r as removeUnassignedDates } from './unassigned_dates.store-BpbN7y-B.js';
import { T as Token } from './Token-CkxFIO_J.js';
import { v as v4 } from './v4-CK3_k8jD.js';
import { H as HouseKeepingService, h as housekeeping_store, u as updateHKStore } from './housekeeping.service-CImAsuWh.js';
import { A as AgentsService } from './agents.service-CfKXQqnt.js';
import { P as PropertyService } from './property.service-CTafgdb_.js';
import { c as setArrivalsPageSize, o as onArrivalsStoreChange, a as arrivalsStore, d as setArrivalsTotal, i as initializeArrivalsStore, e as setArrivalsPage } from './arrivals.store-mgJ4CkOb.js';
import { a as axios } from './axios-B50ozOIF.js';
import { B as BookingListingService, u as updateUserSelection, b as booking_listing, s as setPaginationPageSize, o as onBookingListingChange, a as updatePaginationFromSelection, c as updateUserSelections, d as setPaginationPage } from './booking_listing.service-CYhqQELH.js';
import { d as setChannelIdAndActiveState, u as updateChannelSettings, s as selectChannel, t as testConnection, C as ChannelService, r as resetStore, c as channels_data } from './channel.service-dfM2yKqv.js';
import { S as SystemService } from './system.service-DN8zRqj9.js';
import { o as onDeparturesStoreChange, d as departuresStore, b as setDepartureTotal, i as initializeDeparturesStore, c as setDeparturesPage, e as setDeparturesPageSize } from './departures.store-B1kbuvyi.js';
import { l as libExports } from './index-DeW5X45W.js';
import { m as setLoading, b as updateTasks, h as hkTasksStore, c as clearSelectedTasks, n as updateSelectedTasks } from './hk-tasks.store-zYGzF5yR.js';
import { P as PaymentOptionService, p as payment_option_store } from './payment-option.store-liuoW8An.js';
import { U as UserService } from './user.service-COmC2YqR.js';
...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (h(Host, { key: '6ff243ae8a109dae36aa196236edec73883f3bac', class: "p-1" }, h("ir-interceptor", { key: '9c45c18d34b7fead900630fe2bc6f50af3d79f58', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), h("ir-toast", { key: '6f25f63e00c4fed264d10b89635753ec74346d20' }), h("div", { key: '4254ce454d9fd77ef59c6c7f58696d1fcdb7c118', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, h("ir-input-text", { key: '7a5485da419f825fb318f805244853de9f98edb5', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), h("ir-button", { key: '21a0834a3a01d6dc161e47d89103c9889dd60e64', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), h("p", { key: '2405da85c6a78cec86594b47d93ffc953bb2b7e4' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
