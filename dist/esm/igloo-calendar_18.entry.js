import { r as registerInstance, c as createEvent, a as getElement, h, F as Fragment, H as Host } from './index-BvoylR5O.js';
import { R as RoomService } from './room.service-COwttt97.js';
import { B as BookingService } from './booking.service-BVIex3m4.js';
import { z as formatLegendColors, d as dateToFormattedString, j as isBlockUnit, A as getNextDay, B as addTwoMonthToDate, C as computeEndDate, D as convertDMYToISO, n as showToast, l as isPrivilegedUser, k as downloadFile, o as getEntryValue } from './utils-DE70XlzV.js';
...
import { e as calendar_dates, h as addCleaningTasks, i as formatName, j as getRoomStatus, k as cleanRoom, l as addRoomForCleaning, t as transformNewBooking, m as transformNewBLockedRooms, n as bookingStatus, d as getPrivateNote, c as calculateDaysBetweenDates } from './booking-DC883Q1P.js';
import { l as locales } from './locales.store-BZFQn8-s.js';
import { c as calendar_data } from './calendar-data-Cnv5ncgJ.js';
import { h as handleUnAssignedDatesChange, a as addUnassignedDates, r as removeUnassignedDates } from './unassigned_dates.store-BliGeNiK.js';
import { T as Token } from './Token-CkxFIO_J.js';
import { v as v4 } from './v4-CK3_k8jD.js';
import { H as HouseKeepingService, h as housekeeping_store, u as updateHKStore } from './housekeeping.service-B_BbcoWp.js';
import { A as AgentsService } from './agents.service-CfKXQqnt.js';
import { P as PropertyService } from './property.service-Cp0_LAzW.js';
import { c as setArrivalsPageSize, o as onArrivalsStoreChange, a as arrivalsStore, d as setArrivalsTotal, i as initializeArrivalsStore, e as setArrivalsPage } from './arrivals.store-DvOwQ2i1.js';
import { a as axios } from './axios-B50ozOIF.js';
import { B as BookingListingService, u as updateUserSelection, b as booking_listing, s as setPaginationPageSize, o as onBookingListingChange, a as updatePaginationFromSelection, c as updateUserSelections, d as setPaginationPage } from './booking_listing.service-BJzd6Iic.js';
import { d as setChannelIdAndActiveState, u as updateChannelSettings, s as selectChannel, t as testConnection, C as ChannelService, r as resetStore, c as channels_data } from './channel.service-D5hHe5-T.js';
import { S as SystemService } from './system.service-DN8zRqj9.js';
import { o as onDeparturesStoreChange, d as departuresStore, b as setDepartureTotal, i as initializeDeparturesStore, c as setDeparturesPage, e as setDeparturesPageSize } from './departures.store-B0CFc7OT.js';
import { l as libExports } from './index-DeW5X45W.js';
import { m as setLoading, b as updateTasks, h as hkTasksStore, c as clearSelectedTasks, n as updateSelectedTasks } from './hk-tasks.store-VyClvPHD.js';
import { P as PaymentOptionService, p as payment_option_store } from './payment-option.store-CHz9qNlp.js';
import { U as UserService } from './user.service-D7mvwfzC.js';
...
const IrMonthlyBookingsReport = class {
    ...
    render() {
        ...
        return (h("ir-page", { label: "Daily Occupancy" }, h("ir-custom-button", { variant: "neutral", appearance: "outlined", slot: "page-header", loading: this.isLoading === 'export' }, h("wa-icon", { name: "download", slot: "start" }), locales.entries?.Lcz_Export), h("section", { class: "report-layout" }, h("section", null, h("div", { class: "report-stats-row" }, h("ir-metric-card", { class: "report-metric", icon: this.stats?.Occupancy_Difference_From_Previous_Month < 0 ? 'arrow-trend-down' : 'arrow-trend-up', label: "Average Occupancy", value: this.stats.AverageOccupancy ? this.stats?.AverageOccupancy.toFixed(2) : null, unit: "%", trend: this.stats?.Occupancy_Difference_From_Previous_Month, trendLabel: "from last month", caption: this.stats?.Occupancy_Difference_From_Previous_Month != null && this.stats?.AverageOccupancy != null
                ...
                : undefined }), h("ir-metric-card", { class: "report-metric", icon: "hotel", label: "Total Units", value: this.stats?.TotalUnitsBooked ? this.stats?.TotalUnitsBooked.toString() : null, caption: "Booked" }), h("ir-metric-card", { class: "report-metric", icon: "user-group", label: "Total Guests", value: this.stats?.Total_Guests ? this.stats?.Total_Guests?.toString() : null, caption: "Stayed" }), h("ir-metric-card", { class: "report-metric", icon: "calendar", label: "Peak Days", value: this.stats?.PeakDays.length === 0 ? null : this.stats?.PeakDays?.map(pd => hooks(pd.Date, 'YYYY-MM-DD').format('D').concat('th')).join(' - '), caption: `${Math.max(...(this.stats.PeakDays?.map(pd => pd.OccupancyPercent) || []))}% occupancy` })), h("div", { class: "report-content-row" }, h("ir-monthly-bookings-report-filter", { isLoading: this.isLoading === 'filter', class: "filters-card", baseFilters: this.baseFilters }), h("wa-card", { class: "report-table-card" }, h("ir-monthly-bookings-report-table", { reports: this.reports })))))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
