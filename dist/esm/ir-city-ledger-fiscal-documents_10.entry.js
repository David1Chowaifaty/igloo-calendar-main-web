...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (h(Host, { key: '84169876365f9e25a8fa2ca70de6745e6e80e96c' }, h("div", { key: 'b46ddaf09abff108d5f93ffad414f7b090a9802e', class: "filters-bar" }, h("div", { key: '2479b46b9ded0ee5e3a8cdb3dc63dbd39709592d', class: "filters-bar__dates" }, h("ir-date-range-filter", { key: 'abbdbbaf6726341cc5789120a91eb9d7fc0c28ce', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), h("div", { key: '0582a519b3f317f9ce927da8367f8fb252e77ae7', class: "filters-bar__search-group" }, h("div", { key: 'cbf19670418d005cd42acdff4211af6290275add', class: "filters-bar__type-group" }, h("wa-select", { key: '30efc4f5276b9b636e76c5591ad2201cd427d424', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (h("wa-option", { value: option.value, key: option.value }, option.label)))), h("wa-switch", { key: '0bd3d8def928eb9421e38a7e4a546002f73fc1b5', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), h("wa-switch", { key: '50c2f926bcc609401afb6cfd8dd1a57152bf1397', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Proforma")), h("ir-input", { key: '40dec52c3422df46a380c788be9ce55f993ce168', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, h("wa-icon", { key: 'bf0002d7ba30c5d037ee6ed83c0d48cf828a3d8b', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), h("ir-custom-button", { key: '847da63801a7b186e3aeea661054833a8a22ff08', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit(this.filters) }, h("wa-icon", { key: '76f54cde429f77e531e8b9077ebea1afa6f8a45c', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
    Debounce(300)
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (h(Host, { key: 'aead943fc9a64766030afd948889125574ab0ca8' }, h("div", { key: '12fb6cb91349dbae8816e6ca93d4e4d167cd5192', class: "filters-bar" }, h("div", { key: 'a7ca492b5f65c13bf0cc232f7c3482c49fc9ba21', class: "filters-bar__dates" }, h("ir-date-range-filter", { key: '41bb75fcca668c291697465868489c4fc5bd1d10', maxDate: hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), h("div", { key: 'c8645ed005fb49b079aa8bcfccd42d11fea94330', class: "filters-bar__search-group" }, h("wa-select", { key: 'd7219945c376b7eb1b4bd7cd78e3a54a2206334a', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (h("wa-option", { value: s.value, label: s.label }, s.label)))), h("ir-input", { key: '9f6df1077752bde83740a20988d7684dc2a4a20b', class: "filters-bar__search-input", "onText-change": e => {
                ...
                status: this.statusFilter,
                search: '',
            }), value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, h("wa-icon", { key: '95546ccf3d2263afbcd30594587a91377d672308', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), h("ir-custom-button", { key: 'a0bffb53bcb7bdd09387969450c0ee9de0a61979', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit({
                fromDate: this.dates.from?.format('YYYY-MM-DD'),
                toDate: this.dates.to?.format('YYYY-MM-DD'),
                status: this.statusFilter,
                search: this.searchQuery,
            }) }, h("wa-icon", { key: '8cb5785b6f173553da4799511db9daa97ecc0bb9', name: "magnifying-glass" }))), h("div", { key: '7e7c470d6de51bbf2aec471c1a771fb94752a221', class: "filters-bar__actions" }, h("ir-custom-button", { key: 'e029a293851bf6f326c1f0e7a8fef048f1293b3e', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, h("wa-icon", { key: '0e6cf5a54c68fbe3a4f58928155c3aa9c9ad8f73', name: "download", slot: "start" }), h("span", { key: 'a513a3198454c27df89f411133a41276f9364d70' }, "Export")), h("ir-custom-button", { key: 'f1b37e794320698c55e137e324d88144c7fe44e9', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    Debounce(300)
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (h(Host, { key: '787287e4d78dd6cd0526763da786c7831e2dced9' }, h("section", { key: '3b472649b6b08070c4532cb327329e0001b88674', class: "cl-statements", "aria-label": "City ledger statements" }, h("ir-city-ledger-statements-filter", { key: 'a5f99284efbd2a48be4f22aa408c1d4e47fd27ec', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
                this.filters = e.detail;
            ...
            }, onPrintStatement: e => (this.printFilters = e.detail) }), h("ir-city-ledger-statements-table", { key: '046b4706831249c253b729311dbd750d717e42f2', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), h("ir-preview-screen-dialog", { key: 'd5b534471a1abd9f1d065f46c0409f8c5f3433b7', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, h("div", { key: 'e1a2c645c244be1d9547a3e66a3018174c801d50', slot: "header-actions" }, this.pdfUrl && (h("ir-custom-button", { key: '429ba3ec2b7b2095e0dc4548e68de2bf31dbff3c', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, h("wa-icon", { key: '6145a2c8ed94cc600869d0f89afb6b8928774c51', name: "download", label: "Download PDF" })))), this.printFilters &&
