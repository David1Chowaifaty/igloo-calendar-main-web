...
import { m as mapClTxToFolioRow, a as actionableClTypes } from './types-e5c0fa70.js';
import { c as calendar_data } from './calendar-data-b1f645da.js';
import { v as v4 } from './v4-964634d6.js';
import { f as formatAmount } from './utils-177fc6a4.js';
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (h(Host, { key: '6b2c6933dd02b8488e3fd1aabf17de6f66803e3a' }, h("div", { key: 'fee0adde6f53f03e99a82af460d4747a35c64589', class: "filters-bar" }, h("div", { key: 'caaa027296bb40e4165054096e84a8f385fc76f9', class: "filters-bar__dates" }, h("ir-date-range-filter", { key: 'c30453951a359d57040cd3e6fa9cf47757c622d4', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), h("div", { key: '29bd01d7095c21ec17729b4683f2c1d8a69ed9f1', class: "filters-bar__search-group" }, h("div", { key: '5b55c2ff5320c1ee97a56d25363be1f58956e40f', class: "filters-bar__type-group" }, h("wa-select", { key: '6eef58e6332a6f96030790e6888ea04c9f7b701f', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (h("wa-option", { value: option.value, key: option.value }, option.label)))), h("wa-switch", { key: 'de55e8c06e21d62e3a1b25b082c9f26eabde9aca', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), h("wa-switch", { key: '0a53c1956b6093f2edb8c0a5a6cd6534142c8345', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Pro forma")), h("ir-input", { key: 'e292091b7be0c893cfcdaa6617378bd73d43b4ee', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, h("wa-icon", { key: '940e0476e560db9b511c905951451f3ff19b396e', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), h("ir-custom-button", { key: '449f6c2603a1b69b8b2c915d5ab98278ecb3d2e2', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit(this.filters) }, h("wa-icon", { key: '4c281afa64ce43f411a3abcf179701118e383d69', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
    Debounce(300)
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (h(Host, { key: 'c63177ee2630e4301adb71a821da6abbe36088eb' }, h("div", { key: 'a0152910439223004f7d5c54247478e7ec96d7a2', class: "filters-bar" }, h("div", { key: '7fb12b62fbf9d1ddbe107c744eaf15f25c8ec99f', class: "filters-bar__dates" }, h("ir-date-range-filter", { key: 'd072cec212a79493911cdd1b474241f81aebe59e', maxDate: hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (h("wa-option", { value: s.value, label: s.label }, s.label)))), h("ir-input", { key: '7a3ee39900d0d7fcd90af1c74c2ab2c1be1b270e', class: "filters-bar__search-input", "onText-change": e => {
                this.searchQuery = e.detail;
                this.emitFiltersDebounced();
            }, value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, h("wa-icon", { key: 'a782a3d56ab8ff6e8537779357aa5e809f95832e', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), h("ir-custom-button", { key: '5c26ebbaa38818dfc3fbec3ca06ca8b687340a93', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit({
                fromDate: this.dates.from?.format('YYYY-MM-DD'),
                toDate: this.dates.to?.format('YYYY-MM-DD'),
                status: this.statusFilter,
                search: this.searchQuery,
            }) }, h("wa-icon", { key: '1a5d06eea5ae003a8278d9c7a05f159b5ba59374', name: "magnifying-glass" }))), h("div", { key: '209495d7d113b2a1345fe124e32f922bb670edda', class: "filters-bar__actions" }, h("ir-custom-button", { key: 'e098476a2f7fe0497b7ebf8c05b2864ac2ca692d', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, h("wa-icon", { key: 'dd03fb4d17f87da3f38d1e2c30fa2817523a3de2', name: "download", slot: "start" }), h("span", { key: 'a7c1be223af68a8947d3b2060cbb1c3a9f4d7a69' }, "Export")), h("ir-custom-button", { key: '62df033ff3098c66e214010ee77a38b3ed87ddd6', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    Debounce(300)
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (h(Host, { key: '1782044ba0ab33d43d788eef5de41675d8dabcdb' }, h("section", { key: 'c1c94454cf7e62d69a290a4dd37538a6b958d69a', class: "cl-statements", "aria-label": "City ledger statements" }, h("ir-city-ledger-statements-filter", { key: '5bad47c35e08287b72a411fd24fff1f0bbd06819', onFiltersChange: e => (this.filters = e.detail), onCreateStatement: e => {
                this.filters = e.detail;
                this.fetchStatement(e.detail);
            }, onPrintStatement: e => (this.printFilters = e.detail) }), h("ir-city-ledger-statements-table", { key: 'ec6efcc105ae2c19af3fdc0dca250ba3bc691c29', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), h("ir-preview-screen-dialog", { key: 'bff5b1bfdc46db0d8a31faa8e35315c459516bdd', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, h("div", { key: '3f563eddc2a9c453b5ec4c84b7530c4ba5133c74', slot: "header-actions" }, this.pdfUrl && (h("ir-custom-button", { key: '5fa86bd7f4a681f7e7ed03c2ec7d956ee50776b7', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, h("wa-icon", { key: '5dca77d61f45ac06beeb2b06150337e7f40670b6', name: "download", label: "Download PDF" })))), this.printFilters &&
