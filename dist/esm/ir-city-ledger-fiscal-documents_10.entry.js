...
import { C as CityLedgerService } from './index-707fd380.js';
import { F as FdTypes } from './enums-8474d88c.js';
import { h as hooks } from './moment-ab846cee.js';
import { D as Debounce } from './debounce-542065c2.js';
import { m as mapClTxToFolioRow, a as actionableClTypes } from './types-b3be155a.js';
import { c as calendar_data } from './calendar-data-b1f645da.js';
import { v as v4 } from './v4-964634d6.js';
import { f as formatAmount } from './utils-046c6412.js';
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (h(Host, { key: '533a347071439f2be31a887e6afb3961568c0f70' }, h("div", { key: '55baede3e7a45d4b44e2f2ec0c3972fed646aa38', class: "filters-bar" }, h("div", { key: '8b1b2b5375abf984b58fb5035cc6037c0ded4d2a', class: "filters-bar__dates" }, h("ir-date-range-filter", { key: '5f036e9bbf317cfa13c1e3f56a92d26920678065', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), h("div", { key: '167768d2de7674d6bac60233a4a2f64c0ecbf9de', class: "filters-bar__search-group" }, h("div", { key: '6a0ba82e63ef10d3e0aeae0de2ff4fd993e68871', class: "filters-bar__type-group" }, h("wa-select", { key: 'e2f99124d322458c1261decf230ef2c828df4a7e', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (h("wa-option", { value: option.value, key: option.value }, option.label)))), h("wa-switch", { key: '16305361cf04ebf76b13163787a6b3fa4b9da37c', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), h("wa-switch", { key: 'be734d27cbb1551cecc8fc5928af17de3d24694e', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Pro forma")), h("ir-input", { key: '2ec76f01a05d08763e6cd463868fa8bf29b089ff', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, h("wa-icon", { key: '09bfec0f4fdcf3aeb14eb3ff20c4b597d5f0b026', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), h("ir-custom-button", { key: 'cdea8e7eb6d5bcd5bbfc08cb59357851f65da6f9', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit(this.filters) }, h("wa-icon", { key: 'ac836947e73aa6dd175b3222931ef7bd29b83719', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
    Debounce(300)
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (h(Host, { key: '5aaadbd6e7e4f17f3c51b3855d6dec8bbf771b32' }, h("ir-city-ledger-folio-filters", { key: '77db8334a600c624cbe86ec99eb653913fefafdf', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), h("ir-dialog", { key: '31042b47239211279080e85b2a38aaa495fbbea7', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, h("p", { key: '69f785bba4fd779d5569a4dafa27d852e5d35bdf' }, "Are you sure you want to delete this entry? This action cannot be undone."), h("div", { key: 'e0f0bb5450ad923ad5a9a436c8b4b77e4da43151', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'c6d1a9620c35bc77454001ce5f4b176003af52d6', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), h("ir-custom-button", { key: '326f9d45d926d2040ba22f87410f7fa095222109', size: "medium", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), h("ir-city-ledger-transaction-drawer", { key: '2693b24a0468f9e5d8604902d20b6dbcd1488148', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (h(Host, { key: 'ffd4f5c083e249138138cdf50fc11940dfa069c5' }, h("section", { key: 'bf9e10d7ed2cca47b47894c8a7d03e6f2b155fd9', class: "cl-statements", "aria-label": "City ledger statements" }, h("ir-city-ledger-statements-filter", { key: 'a332fb2d0eb9bf2d97ff7c950fdc35a1aeb2b053', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
                this.filters = e.detail;
            ...
            }, onPrintStatement: e => (this.printFilters = e.detail) }), h("ir-city-ledger-statements-table", { key: 'eb3c05c64bae0949c6056c7d189e9ae968e74e07', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), h("ir-preview-screen-dialog", { key: '6af183daf99f00f6d0924f42eed74857dc6455e7', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, h("div", { key: '84a05237c9fc4d26e39d0a7f90cb9a1307f85a30', slot: "header-actions" }, this.pdfUrl && (h("ir-custom-button", { key: '49f69b41496fdae10f6fa431fbfbc9063108728f', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, h("wa-icon", { key: '3912da663ba9e8aa5060506e2865fc04be68bb8e', name: "download", label: "Download PDF" })))), this.printFilters &&
