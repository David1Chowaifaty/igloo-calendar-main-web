 ...
 */
function patchQuillForShadowDom(quill, host) {
...
const irTextEditorCss = () => `:host([size='xs']){font-size:var(--wa-font-size-xs)}:host([size='s']),:host([size='small']){font-size:var(--wa-font-size-s)}:host([size='m']),:host([size='medium']){font-size:var(--wa-font-size-m)}:host([size='l']),:host([size='large']){font-size:var(--wa-font-size-l)}:host([size='xl']){font-size:var(--wa-font-size-xl)}:host{display:flex;flex-direction:column}[part~='form-control']{display:contents}:is([part~='form-control-label'],[part~='label']):has(*:not(:empty)),:is([part~='form-control-label'],[part~='label']).has-label{display:inline-flex;color:var(--wa-form-control-label-color);font-weight:var(--wa-form-control-label-font-weight);line-height:var(--wa-form-control-label-line-height);margin-block-end:0.5em}:host([required]) :is([part~='form-control-label'],[part~='label'])::after{content:var(--wa-form-control-required-content);margin-inline-start:var(--wa-form-control-required-content-offset);color:var(--wa-form-control-required-content-color)}[part~='hint']{display:block;color:var(--wa-form-control-hint-color);font-weight:var(--wa-form-control-hint-font-weight);line-height:var(--wa-form-control-hint-line-height);margin-block-start:0.5em;font-size:var(--wa-font-size-smaller);&:not(.has-slotted,.has-hint){display:none}}:host{display:block;}.field{display:flex;flex-direction:column;}.editor-wrapper{display:flex;flex-direction:column;width:100%;height:var(--ir-editor-height, 300px);overflow:hidden;color:var(--wa-form-control-value-color);font-size:var(--wa-form-control-value-size);font-family:inherit;font-weight:var(--wa-form-control-value-font-weight);line-height:var(--wa-form-control-value-line-height);background-color:var(--wa-form-control-background-color);border-color:var(--wa-form-control-border-color);border-style:var(--wa-form-control-border-style);border-width:var(--wa-form-control-border-width);border-radius:var(--wa-form-control-border-radius);min-height:var(--wa-form-control-height);transition:background-color var(--wa-transition-normal),     border-color var(--wa-transition-normal),     outline-color var(--wa-transition-fast);transition-timing-function:var(--wa-transition-easing);outline:var(--wa-focus-ring-style) var(--wa-focus-ring-width) transparent;outline-offset:var(--wa-focus-ring-offset);cursor:text}:host([appearance='outlined']) .editor-wrapper{background-color:var(--wa-form-control-background-color);border-color:var(--wa-form-control-border-color)}:host([appearance='filled']) .editor-wrapper{background-color:var(--wa-color-neutral-fill-quiet);border-color:var(--wa-color-neutral-fill-quiet)}:host([appearance='filled-outlined']) .editor-wrapper{background-color:var(--wa-color-neutral-fill-quiet);border-color:var(--wa-color-neutral-fill-quiet);border-color:var(--wa-form-control-border-color)}:host([pill]) .editor-wrapper{border-radius:var(--wa-border-radius-pill)}.ql-container{font-size:inherit !important}.ql-editor{min-height:var(--wa-form-control-height) !important;scroll-padding-block:var(--wa-form-control-padding-block) !important;padding:calc(var(--wa-form-control-padding-block) - ((1lh - 1em) / 2)) var(--wa-form-control-padding-inline) !important;line-height:var(--wa-line-height-normal) !important}.editor-wrapper:focus-within{outline:var(--wa-focus-ring);outline-offset:var(--wa-focus-ring-offset);border-color:var(--wa-color-focus)}.editor-wrapper.error{border-color:var(--wa-color-danger-border-loud);outline-color:var(--wa-color-danger-border-loud)}.ql-toolbar{flex:0 0 auto;border:0 !important;padding-inline:var(--wa-form-control-padding-inline) !important;border-bottom:var(--wa-form-control-border-width, 1px) var(--wa-form-control-border-style, solid) var(--wa-form-control-border-color, #cacfe7) !important}.editor-container{flex:1 1 auto;min-height:0;border:0 !important}.ql-editor{height:100%;overflow-y:auto}`;
...
const quillRtlCss = () => `:dir(rtl) .ql-snow.ql-toolbar button,:dir(rtl) .ql-snow .ql-toolbar button,:dir(rtl) .ql-snow.ql-toolbar button svg,:dir(rtl) .ql-snow .ql-toolbar button svg,:dir(rtl) .ql-snow .ql-picker,:dir(rtl) .ql-snow .ql-color-picker .ql-picker-item{float:right}:dir(rtl) .ql-toolbar.ql-snow .ql-formats{margin-right:0;margin-left:15px}:dir(rtl) .ql-snow .ql-picker-label{padding-left:2px;padding-right:8px}:dir(rtl) .ql-snow .ql-picker:not(.ql-color-picker):not(.ql-icon-picker) svg{right:auto;left:0}:dir(rtl) .ql-snow .ql-color-picker .ql-picker-label svg,:dir(rtl) .ql-snow .ql-icon-picker .ql-picker-label svg{right:auto;left:4px}:dir(rtl) .ql-editor{text-align:right}:dir(rtl) .ql-editor ol,:dir(rtl) .ql-editor li{padding-left:0;padding-right:1.5em}:dir(rtl) .ql-editor li>.ql-ui:before{margin-left:0.3em;margin-right:-1.5em;text-align:left}:dir(rtl) .ql-snow .ql-editor blockquote{border-left:none;border-right:4px solid #ccc;padding-left:0;padding-right:16px}:dir(rtl) .ql-code-block-container .ql-ui{right:auto;left:5px}:dir(rtl) .ql-editor .ql-indent-1:not(.ql-direction-rtl){padding-left:0;padding-right:3em}:dir(rtl) .ql-editor li.ql-indent-1:not(.ql-direction-rtl){padding-left:0;padding-right:4.5em}:dir(rtl) .ql-editor .ql-indent-2:not(.ql-direction-rtl){padding-left:0;padding-right:6em}:dir(rtl) .ql-editor li.ql-indent-2:not(.ql-direction-rtl){padding-left:0;padding-right:7.5em}:dir(rtl) .ql-editor .ql-indent-3:not(.ql-direction-rtl){padding-left:0;padding-right:9em}:dir(rtl) .ql-editor li.ql-indent-3:not(.ql-direction-rtl){padding-left:0;padding-right:10.5em}:dir(rtl) .ql-editor .ql-indent-4:not(.ql-direction-rtl){padding-left:0;padding-right:12em}:dir(rtl) .ql-editor li.ql-indent-4:not(.ql-direction-rtl){padding-left:0;padding-right:13.5em}:dir(rtl) .ql-editor .ql-indent-5:not(.ql-direction-rtl){padding-left:0;padding-right:15em}:dir(rtl) .ql-editor li.ql-indent-5:not(.ql-direction-rtl){padding-left:0;padding-right:16.5em}:dir(rtl) .ql-editor .ql-indent-6:not(.ql-direction-rtl){padding-left:0;padding-right:18em}:dir(rtl) .ql-editor li.ql-indent-6:not(.ql-direction-rtl){padding-left:0;padding-right:19.5em}:dir(rtl) .ql-editor .ql-indent-7:not(.ql-direction-rtl){padding-left:0;padding-right:21em}:dir(rtl) .ql-editor li.ql-indent-7:not(.ql-direction-rtl){padding-left:0;padding-right:22.5em}:dir(rtl) .ql-editor .ql-indent-8:not(.ql-direction-rtl){padding-left:0;padding-right:24em}:dir(rtl) .ql-editor li.ql-indent-8:not(.ql-direction-rtl){padding-left:0;padding-right:25.5em}:dir(rtl) .ql-editor .ql-indent-9:not(.ql-direction-rtl){padding-left:0;padding-right:27em}:dir(rtl) .ql-editor li.ql-indent-9:not(.ql-direction-rtl){padding-left:0;padding-right:28.5em}:dir(rtl) .ql-snow .ql-tooltip::before{margin-right:0;margin-left:8px}:dir(rtl) .ql-snow .ql-tooltip a.ql-action::after{border-right:none;border-left:1px solid #ccc;margin-left:0;margin-right:16px;padding-right:0;padding-left:8px}:dir(rtl) .ql-snow .ql-tooltip a.ql-remove::before{margin-left:0;margin-right:8px}`;
...
const IrTextEditor = class {
    ...
    updateValidity() {
        ...
        if (this.required && !this.disabled && this.isEmpty) {
            this.internals.setValidity({ valueMissing: true }, t('Lcz_PleaseFillOutThisField', { fallback: 'Please fill out this field.' }), this.editor.root);
        }
        else {
...
IrTextEditor.style = irTextEditorCss() + (quillSnowCss() + quillRtlCss());
