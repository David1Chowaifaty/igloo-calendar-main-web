...
import { V as VariationService, B as BookingService, b as booking_store, n as updateRoomGuest, u as updateBookedByGuest, m as modifyBookingStore, e as reserveRooms, a as resetReserved, o as updateRoomParams } from './booking.service-9ae6a2f9.js';
...
import { c as calculateDaysBetweenDates } from './booking-63017f0b.js';
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: '9c556db647f6b4a8b5068f92ab582304cc487891', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: 'c53e539def610bbb5b39d75b41ab84f08868ccd1', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, h("div", { key: '91f2e3a27c23f55043283d36607d441ca8eaf300', "data-testid": 'rp_name', class: "rateplan-name-container" }, h("div", { key: 'da1a2b82f5b45a7218ef3b5b958744a41226b8b8' }, bookingType === 'BAR_BOOKING' ? (h(Fragment, null, h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))) : (h(Fragment, null, h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), ratePlan.custom_text && h("span", { key: '0b001658a85f89fd0c23982a841c70500fadaa35', class: "custom-text-span" }, ratePlan.custom_text)), isAvailableToBook && (h(Fragment, { key: '82ddc1764536664eed0d26f6f452148f06a4bd7f' }, h("wa-tooltip", { key: 'a3f97bddb38e03872e1950e87b48a5dfd760833c', for: `rateplan-${this.ratePlan.id}` }, h("span", { key: 'e47afbea971d70baad8aaec10e45f6874b46e3ae', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: 'd99f82b8ef91b32a4309204375d482b3b712018b', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (h(Fragment, { key: 'd5d352357af9f6ca5d2477d7c3526cc976afd62a' }, h("wa-tooltip", { key: '567d64606c51831c941327bcc3b26f409cc614b9', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), h("wa-icon", { key: 'a8da8c84e11cf5cf8f9406f8f7d5ca79fbabca22', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (h("div", { class: "rateplan-container" }, h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: '69f813a37d22638f465740686f261e9d5d9aa197', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, h("label", { key: '2ac35f0fcf9fa6c9674aabf5ca57e735ee80c1d0', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, h("div", { key: '7a9bb953e9214a7f2cc4dd0a74fb47faeefb0391', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, h("wa-dropdown", { key: '37e18fd33a25a28bae6ea10db5dc19123d43b8d8', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, h("button", { key: '52b79d8f7896cb7a39f4695c44ba1bd8bb6d79f7', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, h("div", { key: 'd91a51ebcdc274db79657ffb0b253605a78d0eae', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : h("span", null, "Select")), h("wa-icon", { key: 'eb671e599a714c38f7b208fc644ebbd2afb51b40', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), h("span", { key: 'ea676ec01292d6bba1383376e2aef30ec77fee6f', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (h("wa-dropdown-item", { value: country.id.toString() }, h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), h("span", { class: "mobile-input__country-name" }, country.name), h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), h("ir-input", { key: '1ef6c281ba41c266e152fc201ce0ab853d722b40', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && h("span", { key: 'f13a13510a5c6448c5d335b509f51299f813544e', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
