...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (h(Host, { key: '67277367962668f1fad27e110c9a4f11b0812fcd', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, h("div", { key: '94dd16ae75e2ef93560c486776e9425c5829e565', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: '4f589697356620fce1eead6eed1d211615d45675', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: '678c226b1d2b41e555df7cd22d579acd7765378d', class: "fd-application-info__details" }, h("div", { key: '8876b86d5ddd16f1bf08bbd1765cd322651a1690', class: "fd-application-info__rateplan" }, h("p", { key: '5b9a9abeb71bcd16cc82e074423d24e5cfd9168e', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: 'bec88b27e54fa59098ee84ab4ca2d3d3e20cef2e', class: "fd-application-info__non-refundable" }, "Non Refundable")), h("wa-tooltip", { key: '9134b57b45d68afa649fd3940c8f70a443f4b05d', for: this.tooltipId }, h("span", { key: '09273ff03a22b44e1235ff264cef2093180088fe', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: 'b5f48681d6f40c58933aa5d851900cd745c809f5', name: "circle-info", id: this.tooltipId })), h("p", { key: 'd9388881bbb14a189fd72815cc0a132b13eea1fa', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("p", { key: '8b6d8833a51eb8c591fa3ecefde2d8f72a769492', class: "fd-application-info__price" }, h("span", { key: '303716193df2d23e246b889cb756d5c188b995e3', class: "ir-price" }, formatAmount(this.currency?.symbol, this.amount), "/", locales.entries.Lcz_Stay), h("p", { key: '53508f93dcba4c8bec25f6a29ba2b94c7af034c7', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), h("div", { key: '7d43882558b884ff96634ba0edb3e5ac2588fed7', class: "fd-application-info__footer" }, h("div", { key: '6e2e196b7652baa60b037a93b188ad2f470fdf32', class: "fd-application-info__rateplan" }, h("p", { key: 'd5047c52e551638ba4ceab9477e5c4dbd3dd2b1b', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("wa-tooltip", { key: '544ae90e22bd9d04eab0bace43349bd6cafcca7c', for: `mobile-${this.tooltipId}` }, h("span", { key: '78975163b7f706658f6ef080e95a4f4c504a4f3c', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '2a1776e13d397b2eb4b40bcb479f513312ebd8cf', name: "circle-info", id: `mobile-${this.tooltipId}` })), h("p", { key: 'a1b36990dedbe47d68c923862b962dd3c48c476f', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("div", { key: '058baf631f384c7d47aa4a2ee66f96ae83aada25', class: "fd-application-info__form" }, h("ir-validator", { key: 'b7843258900ae93de52b72701dbd629a4ac1dbdf', value: this.guestInfo?.first_name, schema: GuestCredentials.shape.first_name }, h("ir-input", { key: '52bd6ff8959c9f979e84ec42d45e7fa7c4063563', class: "fd-application-info__input",
            ...
            } })), h("ir-validator", { key: '12a954ad32d613880997f3f436232ccf97a09b19', value: this.guestInfo?.last_name, schema: GuestCredentials.shape.last_name }, h("ir-input", { key: 'a32e9d4450df55b6caa711e512f2b980c95d4cbf', class: "fd-application-info__input", type: "text",
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("wa-select", { key: '3775b69f56d4599ee2b60044ac0aa0c2abb42bff', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales.entries.Lcz_Assignunits, "data-testid": "unit", value: this.guestInfo?.unit, defaultValue: this.guestInfo?.unit, onchange: event => this.updateGuest({
                unit: event.target.value,
            }) }, filteredRoomList.map(room => (h("wa-option", { value: room.id.toString(), selected: this.guestInfo?.unit === room.id.toString() }, room.name))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (h("ir-validator", { key: '4a1e5b337c7649ec5a7257ce6cd35f263070c8df', value: this.guestInfo?.bed_preference, schema: z.string().nonempty() }, h("wa-select", { key: '9db4df3e51b7e65a739253419965b3b2be0d8d74', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales.entries.Lcz_BedConfiguration, "data-testid": "bed_configuration", value: this.guestInfo?.bed_preference, defaultValue: this.guestInfo?.bed_preference,
            ...
            }) }, this.bedPreferenceType.map(data => (h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), h("p", { key: 'bf886bab71ce3210b38072c57ebe946c1145c695', class: "fd-application-info__price-inline" }, h("span", { key: 'da6304df5a47f9a6ec030f43d949fa504066d99e', class: "ir-price" }, formatAmount(this.currency?.symbol, this.amount), "/", locales.entries.Lcz_Stay), h("p", { key: 'ebbcdfcfa836872c502554d8cd624c4624d194db', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: 'bf12d26285df401363f812b7483453e78ee877a5', class: "fd-application-info__infant" }, h("p", { key: '802b677defa4174fca09fc4282877e460215b81c', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), h("wa-select", { key: 'cf0a33f11abcb93044d7ffc471b864edb75d9778', size: "small", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => {
                this.updateGuest({
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: 'a7228a6188c17c627c7715b69a17969f23064ab5', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: 'cef81127a4410f8c78c959206249cf9584948342', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, h("div", { key: 'e16439a7b18039e6a208e76c47d8e801bdd32f2c', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (h("p", null, h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable")))) : (h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (h(Fragment, { key: '83ab67f158c7a8baf7b2cb0d8d24106ca1c6ccff' }, h("wa-tooltip", { key: 'c30b0f28af22fa5573331ecf5372b7f345d30e93', for: `rateplan-${this.ratePlan.id}` }, h("span", { key: 'ebd93d0adfee6dde3d5efe0068721c3fe063974f', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '3e2b9150ce3ec2046268f2ed5b19dd987ed858ae', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (h(Fragment, { key: '9ae54354da86400407906d1f8e8b3facdd213045' }, h("wa-tooltip", { key: 'e262ca5e28c2121b43b555721ce501c6de1188cd', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), h("wa-icon", { key: '7a474c4813b55cf61d3b3de2489ee043f26c9ee5', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (h("div", { class: "rateplan-container" }, h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
(function (module, exports) {
(function (global, factory) {
   typeof commonjsRequire === 'function' ? factory(moment.exports) :
    ...
    render() {
        ...
        return (h("div", { key: '0fe0b8034de3ee891625ec888155b1f6a5273eb8', part: "base", class: "date-picker" }, this.displayedDaysArr.map((month, index) => (h("table", { part: "calendar", class: "calendar", role: "grid" }, h("thead", null, h("tr", { part: "calendar-header", class: "calendar-header" }, h("th", { colSpan: 7 }, h("div", { part: "month-navigation", class: "month-navigation" }, index === 0 && this.displayedDaysArr[0].month.clone().startOf('month').isAfter(this.minDate) && (h("button", { part: "nav-prev", name: "previous month", class: "navigation-buttons previous-month", type: "button", onClick: this.goToPreviousMonth.bind(this) }, h("p", { class: "sr-only" }, "previous month"), h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, h("path", { fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" })))), h("span", { part: "month-label", class: "month-year-label" }, month.month.locale(this.locale ?? 'en').format('MMMM YYYY')), index === 0 && (h("button", { part: "nav-next", name: "next month", class: "navigation-buttons button-next", type: "button", onClick: this.goToNextMonth.bind(this) }, h("p", { class: "sr-only" }, "next month"), h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, h("path", { d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), index === 1 && this.displayedDaysArr[1].month.clone().endOf('month').isBefore(this.maxDate) && (h("button", { part: "nav-next", name: "next month", class: "navigation-buttons button-next-main", type: "button", onClick: this.goToNextMonth.bind(this) }, h("p", { class: "sr-only" }, "next month"), h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, h("path", { fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" }))))))), h("tr", { part: "weekday-row", class: "weekday-header", role: "row" }, this.weekdays.map(weekday => (h("th", { part: "weekday", class: "weekday-name", key: weekday }, weekday.replace('.', '')))))), h("tbody", { part: "days-grid", class: "days-grid" }, month.days
            ...
            return (h("td", { part: "day-cell", class: "day-cell", key: day.format('YYYY-MM-DD'), role: "gridcell" }, day.isSame(month.month, 'month') && (h("button", { part: "day-button", disabled: isDayBeforeMinDate || isDayAfterMaxDate || (this.selectedDates.start && maxSpanDays && day.isAfter(maxSpanDays) && !this.selectedDates.end), onMouseEnter: () => this.handleMouseEnter(day), onMouseLeave: () => this.handleMouseLeave(), onClick: e => {
                ...
                } }, h("p", { class: `day ${day.isSame(moment$1(), 'day') ? 'current-date' : ''}` }, day.locale(this.locale).format('D')), this.showPrice && h("p", { class: "price" }, checkedDate?.withPrice.price ? '_' : checkedDate.withPrice.price)))));
        }))))))))));
    }
    static get watchers() { return {
        "locale": ["handleLocale"],
...
const IrDateRange = class {
    ...
    render() {
        ...
        return (h("wa-popup", { key: 'afb3a221ae5726bd3c02349ea999ce695b01398c', part: "popup", arrow: true, placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "igl-date-range__popup" }, h("div", { key: '7ded5b6b42e38df0976c0207abdad91707ca2b51', slot: "anchor", part: "anchor", class: "igl-date-range__trigger" }, h("div", { key: '1a32369c40e9dea8a79014b57b022b24a12c82c4', part: "combobox", class: "igl-date-range__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date range", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, h("ir-input", { key: 'd5ef99e566fae2ebe25f0328b26eddb0b65fa1a9', part: "input", disabled: this.disabled, class: "igl-date-range__input", readonly: true, value: this.formattedLabel, "aria-invalid": this.isInvalid, "aria-expanded": String(this.isActive), "aria-disabled": this.disabled ? 'true' : undefined }, h("wa-icon", { key: '3874a2ed2c719c29adec3f2278e978e12e4847c0', part: "calendar-icon", slot: "start", variant: "regular", name: "calendar" }), showNights && this.totalNights > 0 && (h("span", { key: '68c5c740feb7f1b93e5d7baf83aaf721ece53d38', part: "nights-badge", slot: "end", class: "igl-date-range__nights" }, this.totalNights, " ", this.totalNights > 1 ? locales.entries.Lcz_Nights : locales.entries.Lcz_Night))))), h("div", { key: '4f17d129149d71349dc415eea7d3a98fab51b0dd', part: "body", id: this.popupId, class: "igl-date-range__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date range selection dialog" }, h("ir-custom-date-range", { key: '5ef54098e15100ee2d08a91ef59d2f4484f1c004', part: "calendar", exportparts: "base: calendar-base, calendar, calendar-header, month-navigation, nav-prev, nav-next, month-label, weekday-row, weekday, days-grid, week-row, day-cell, day-button", style: { '--cal-button-size': '35px' }, fromDate: hooks(this.fromDate), toDate: hooks(this.toDate), minDate: this.minDate ? hooks(this.minDate) : undefined, maxDate: this.maxDate ? hooks(this.maxDate) : undefined, onDateChange: e => this.handleCustomDateChange(e) }))));
    }
    static get watchers() { return {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'a6bf266461e3ab1b0d64cadcbf367e97cdda04f1', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, h("label", { key: '91fc59cc40d52e96c47610d03373994f1dce3d81', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, h("div", { key: 'f827be32446800c8ab3f32898b029b53008a6c83', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, h("wa-dropdown", { key: '9ae24728076b7d3c52ab74d176eed65f8dbbe1d1', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, h("button", { key: '5bb6d98a3e7dc082f4eec72f4ba34153602fbaf2', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, h("div", { key: '3a08028b4ea12871caa67553662b2a64d9303bc1', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : h("span", null, "Select")), h("wa-icon", { key: '6cbeeddf23d4079dea17d3fe7eb9195b9545e10b', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), h("span", { key: '97dbb87f395df6b2b86e4706c4b68f7c511d1a62', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (h("wa-dropdown-item", { value: country.id.toString() }, h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), h("span", { class: "mobile-input__country-name" }, country.name), h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), h("ir-input", { key: '64802e81c116ffb1713963c8dfcd94a1c9fcfe51', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && h("span", { key: '57a5b3db6450301de5882f36667305eec1965198', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
...
export { IglApplicationInfo as igl_application_info, IglRatePlan as igl_rate_plan, IrCountryPicker as ir_country_picker, IrCustomDateRange as ir_custom_date_range, IrDateRange as ir_date_range, IrMobileInput as ir_mobile_input, IrServiceAssigneeSelect as ir_service_assignee_select };
