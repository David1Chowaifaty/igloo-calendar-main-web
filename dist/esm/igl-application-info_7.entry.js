...
import { V as VariationService, B as BookingService, b as booking_store, n as updateRoomGuest, u as updateBookedByGuest, m as modifyBookingStore, e as reserveRooms, a as resetReserved, o as updateRoomParams } from './booking.service-1d91dd42.js';
import { l as locales } from './locales.store-cb784e95.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-b1f645da.js';
import { f as formatAmount } from './utils-3655fb87.js';
import { G as GuestCredentials } from './types-f16787f2.js';
import { z } from './index-87419685.js';
import { v as v4 } from './v4-964634d6.js';
import { m as moment$1 } from './moment-with-locales-a8b02563.js';
import { a as commonjsGlobal, c as commonjsRequire } from './_commonjsHelpers-24671825.js';
import { C as ClickOutside } from './ClickOutside-e1255f85.js';
import { c as calculateDaysBetweenDates } from './booking-b2adb086.js';
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: 'f04fa00149fcf94859b2d2094941366641bbd201', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: '977f3f522b0b2b20337cfbc7e36862965a28a2df', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, h("div", { key: 'c196391f85c705a7c568abc15512d78a8b31ecba', "data-testid": 'rp_name', class: "rateplan-name-container" }, h("div", { key: 'e58c1f394d9a460466c15f7e439cb978aff1f20b' }, bookingType === 'BAR_BOOKING' ? (h(Fragment, null, h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))) : (h(Fragment, null, h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), ratePlan.custom_text && h("span", { key: 'b3614cb0c80d04b3a52a3322edcdc549a598520d', class: "custom-text-span" }, ratePlan.custom_text)), isAvailableToBook && (h(Fragment, { key: 'c2ada475ac96856962ca5a4f2746a08747404197' }, h("wa-tooltip", { key: 'b10bea22ac8fba0c2bb00bf85194154b8630001a', for: `rateplan-${this.ratePlan.id}` }, h("span", { key: '613b44687dbebea824a3908a1068e155c9212481', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: 'f16da0833bbdd59ec1b214d992e369f2875684f8', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (h(Fragment, { key: '69d3e9549190b80dc928fa9bd4c2ad7a70f4308f' }, h("wa-tooltip", { key: '262f679b8fde6d81f1fe384583aa22b5c1cca9a1', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), h("wa-icon", { key: '3618938a38efc11c80091fe59d87ccf18ec80ede', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (h("div", { class: "rateplan-container" }, h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5855647a8ea4bfc0aa4d9f84af4617bc5907c178', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, h("label", { key: '75d6292651b3b88d609499210032da7b67a5a0e9', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, h("div", { key: '27310c3329ae065d4cc0a382fbee4d2c6b98c558', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, h("wa-dropdown", { key: '833b104dc825c1fc5838925fb5ddc7f9c1035ae7', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, h("button", { key: '7ceb6e05a533471fd09b1ab7fb24aecf9267f991', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, h("div", { key: 'ec4b4e4c53328179d9eba6d60664556f567574c6', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : h("span", null, "Select")), h("wa-icon", { key: 'e1c5cef60ccdd1495209b4a656629c22bad5dd3c', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), h("span", { key: 'cb396f674339d5e44edfd86f5bd8aadf0573144d', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (h("wa-dropdown-item", { value: country.id.toString() }, h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), h("span", { class: "mobile-input__country-name" }, country.name), h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), h("ir-input", { key: 'dbe4abe26554a42025b94ab5953a1af7186eb7aa', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && h("span", { key: '73f6a0b491dce2a721785bacfb423d031b19b9f2', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
