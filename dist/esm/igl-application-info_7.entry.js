...
import { V as VariationService, B as BookingService, b as booking_store, n as updateRoomGuest, u as updateBookedByGuest, m as modifyBookingStore, e as reserveRooms, a as resetReserved, o as updateRoomParams } from './booking.service-3f74ffdc.js';
...
import { c as calculateDaysBetweenDates } from './booking-2623f6bb.js';
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: 'f04fa00149fcf94859b2d2094941366641bbd201', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: '977f3f522b0b2b20337cfbc7e36862965a28a2df', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, h("div", { key: 'c196391f85c705a7c568abc15512d78a8b31ecba', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (h("p", null, h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable")))) : (h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (h(Fragment, { key: '7cf531e79d39063f3762576f06e07cb2b59b94b5' }, h("wa-tooltip", { key: '62ed1df00ddd281a2ce7596cecb6604f03f0b2a9', for: `rateplan-${this.ratePlan.id}` }, h("span", { key: 'f4e37b31c4182d7f325515b7d2c77e87a648d161', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '4a51d7f5150c3842afff09e81ff3dc3a3dcc5e8a', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (h(Fragment, { key: 'ab25d146553f911684f2bce5ba6ac723d1d45ab6' }, h("wa-tooltip", { key: '2e14d836cb6ed448f4cd452b0186bf4b10da899a', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), h("wa-icon", { key: '20dc2dbd53c1759b5f89678ad96c55758a52f3a1', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (h("div", { class: "rateplan-container" }, h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
