...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: '139389817c0d5fb6ab586b9ec21fa9a1493b645f', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: 'd17e9f8996e4a408c0548a9936fb6777c2e23631', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, h("div", { key: '4e3571aa25f205f3e70c9bd6b71ddbe3ac1ace66', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (h("p", null, h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable")))) : (h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (h(Fragment, { key: '6923af72ace465e128625d214c88e0e3aaabd8a1' }, h("wa-tooltip", { key: '17751af63ff302e548250a7533f729af6659d7d8', for: `rateplan-${this.ratePlan.id}` }, h("span", { key: '3cdc5dae792b96f44a24b798fb32b5c526ef18af', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '5a9d55e7503cb501b13f65e7cd5f96056fc4d4b0', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (h(Fragment, { key: '024480175ed170f19bf8fb9a7af9038ed89ecacb' }, h("wa-tooltip", { key: 'd03a753ec897717d0a6a06b1e00f8f0239d287a7', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), h("wa-icon", { key: 'cd91c8915d5dceeae29d7ecee0d306a5f8453a4c', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (h("div", { class: "rateplan-container" }, h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1d8edff1b928ce07dada04ba1f812fe76a46f47d', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, h("label", { key: 'ab37cef373c20b68d69f6f5c280a311e738f683e', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, h("div", { key: '2c060110323a31ce23d28539e472789ac655e793', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, h("wa-dropdown", { key: '5bd81f013294c55dde81b2a9d55f9dff9055b850', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, h("button", { key: '4fc349dcd9547037f96feb8e3595d2ef290551e5', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, h("div", { key: 'f2187aa1d5ed15525a7531e67d9ae69748eb45bb', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : h("span", null, "Select")), h("wa-icon", { key: '16aeeff27847a0f91f65d29188f33373b42dc7e8', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), h("span", { key: 'a031ea0a6f3a874be65d095bab9b8af784d20bc6', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (h("wa-dropdown-item", { value: country.id.toString() }, h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), h("span", { class: "mobile-input__country-name" }, country.name), h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), h("ir-input", { key: 'f4bcca4b4b2fdf6e7835836a43998a9ca93e9d5a', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && h("span", { key: 'dfca32ac836e15b018b20e0cba22975af9032cc2', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
...
export { IglApplicationInfo as igl_application_info, IglDateRange as igl_date_range, IglRatePlan as igl_rate_plan, IrCountryPicker as ir_country_picker, IrCustomDateRange as ir_custom_date_range, IrMobileInput as ir_mobile_input, IrServiceAssigneeSelect as ir_service_assignee_select };
