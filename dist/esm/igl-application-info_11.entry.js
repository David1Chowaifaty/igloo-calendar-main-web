...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as reserveRooms, a as resetBookingStore, u as updateRoomParams, g as getVisibleInventory } from './booking.service-a71acac7.js';
...
import { o as formatAmount, e as extras, k as getReleaseHoursString, d as dateToFormattedString, z, v as validateEmail } from './utils-c9c02dbf.js';
import { v as v4 } from './v4-964634d6.js';
import { d as calculateDaysBetweenDates } from './booking-33c39a06.js';
...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ad8d35c2fa389bb73ddc131d9a6f4890273f4403' }, h("div", { key: '28bb1f72c5c95aba8462a18ffacbb69fc8e7a0e2', class: `m-0 p-0 mb-1` }, h("div", { key: '8472bd05e47b4bc2e65dfef9f3992cd4e13d4a83', class: "text-left p-0" }, h("ir-date-view", { key: '6cd2b50ba7d73de97b7b25c3617d1cfea7c1f64d', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), h("div", { key: '41ee7b852bed50f51f4f50f6545fec22b726ac98', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, h("div", { key: '167d5973e0ae3e475f181364a74b87b0ae738e21', class: "mb-1 " }, h("label", { key: 'b75cb24f7752d6fee0e9f2598cb9b0a212ef6885', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales.entries.Lcz_Reason, ":"), h("div", { key: '7dc316a5e77b179327c019b6ab56cf702f0ebec6', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, h("input", { key: '7a9023a75574c746190aa444c13051c0f8312c6d', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), h("span", { key: 'bd55b13d6281b251017d6bebf9db8a83678d5707', class: "align-middle out-of-service-label" }, locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (h("div", null, h("div", { class: "mb-1 d-flex  align-items-center" }, h("span", { class: "align-middle" }, locales.entries.Lcz_Or, " "), h("div", { class: "d-inline-flex col pr-0 align-middle" }, h("input", { class: "form-control", type: "text", placeholder: locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), h("div", { class: "mb-1 w-100 pr-0 " }, h("span", { class: "text-bold-700 font-medium-1" }, locales.entries.Lcz_AutomaticReleaseIn, ": "), h("div", { class: "d-inline-block" }, h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (h("div", { class: "d-inline-block releaseTime" }, h("em", null, locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'dda948823510f82f0c3a1ea73c8ac0ef69904c2a' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), h("div", { key: '0362772ffcd0457d6483af78d9f145768d9e9599', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, h("fieldset", { key: 'd4bbf105508bb6339853eaf4930e5d5b73ae9ce1', class: "mt-lg-0 mr-1 " }, h("igl-date-range", { key: 'd532743b6f546c1204a96b592c4b2487f97fb2f2', variant: "booking", dateLabel: locales.entries.Lcz_Dates, minDate: this.isEventType('PLUS_BOOKING') ? hooks().add(-1, 'months').startOf('month').format('YYYY-MM-DD') : this.minDate, disabled: this.isEventType('BAR_BOOKING') || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: 'f19cfa8527395ab6f64b85d9573a2c70f2114670', class: "text-right mt-1 message-label" }, calendar_data.tax_statement)));
    }
};
