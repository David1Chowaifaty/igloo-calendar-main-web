...
import { b as booking_store, m as modifyBookingStore, B as BookingService, d as reserveRooms, r as resetReserved, u as updateRoomParams, g as getVisibleInventory } from './booking.service-388387ed.js';
import { l as locales } from './locales.store-629477c2.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-f4e207f9.js';
import { j as formatAmount, k as calculateDaysBetweenDates, K as validateEmail } from './utils-cc0c2e69.js';
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'a3905b9ddac5db6e7376c20b558abf0075e91925', class: 'my-2', "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, h("div", { key: '9d0f6af19eba22728d6f1df7481dc05f516e1193', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: 'bd7a75cc9ee04b2d7112800d115ba9d729eccd4b', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: '50f94af41ee79a2f06dc9a37960af2b700c7e6be', class: "booking-details-container" }, h("div", { key: '6938793d8848a7d5693a244a3ed7297d31322ded', class: "booking-rateplan" }, h("p", { key: '7f9a273597edbc1506a2016aad831452bd746bd0', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: '058c0c03922842ef5de73c774246f66c7c6556cf', class: 'non-ref-span' }, "Non Refundable")), h("ir-tooltip", { key: '19b6e1d0db2df9682a2fbf1dcc60fa9f6ad93225', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: '6238e7c541837376d93fca4d897ea96d681f409c', class: "booking-variation", innerHTML: formattedVariation })), h("p", { key: '9aaf1f88a100c1f7097ad3bc99cafec9bea9a691', class: "booking-price" }, formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), h("div", { key: 'b35fbc318d877ccadf9f0f5a19afa78eed67b93c', class: "booking-footer" }, h("div", { key: 'c97f319717f23fb9a651026d1e7c6c77ee175894', class: "booking-rateplan" }, h("p", { key: '2384508a4c518f07145e1b284f6911d9a84bcfa1', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("ir-tooltip", { key: '93df9565a318632565d4edea93a3d1348f412299', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: 'a75576efdeca6b8930c15fe82924c9e1d07305b3', class: "booking-variation", innerHTML: formattedVariation })), h("div", { key: 'a3a537b4684c38f64d3911ef5ed098ae956ddafb', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, h("div", { key: '675fe343bf57595ed9a2156ce70479f8de565b64', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, h("input", { key: '826a2fc98c6846278ff6deb2d8ad703cefccb20f', id: v4(), type: "text", "data-testid": "guest_first_name", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ first_name: name });
                if (booking_store.event_type.type === 'EDIT_BOOKING') {
                    modifyBookingStore('guest', Object.assign(Object.assign({}, booking_store.guest), { name }));
                }
            }, required: true, value: (_d = this.guestInfo) === null || _d === void 0 ? void 0 : _d.first_name })), h("div", { key: 'bc2a1f545ff720857e1f76e578ae66c747b50076', class: "mr-md-1 flex-fill guest-info-container" }, h("input", { key: '9f847d6f92b05bdc97a97428a18376c0d89ab091', id: v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_e = this.guestInfo) === null || _e === void 0 ? void 0 : _e.last_name) === '' && 'border-danger'}`, placeholder: (_f = locales.entries['Lcz_GuestLastname']) !== null && _f !== void 0 ? _f : 'Guest last name', name: "guestLastName", "data-testid": "guest_last_name", onInput: event => {
                const name = event.target.value;
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("div", { key: '340f7097587cc709466451dd4fcecf08ef41e9fb', class: "mt-1 mt-md-0 d-flex align-items-center flex-fill" }, h("div", { key: '7b067478b406ebf533a968bacd435b5fb28b0345', class: "mr-md-1 p-0 flex-fill preference-select-container" }, h("select", { key: '6cfa3536d1789ed3dc3c2d8da39be0a5b2eee1cd', "data-testid": "unit", class: "form-control input-sm pr-0", id: v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, h("option", { key: '72eb64d39672231175f6136f54a942c345a82143', value: "", selected: ((_h = this.guestInfo) === null || _h === void 0 ? void 0 : _h.unit) === '' }, locales.entries.Lcz_Assignunits), filteredRoomList === null || filteredRoomList === void 0 ? void 0 :
            filteredRoomList.map(room => {
                var _a;
                return (h("option", { value: room.id, selected: ((_a = this.guestInfo) === null || _a === void 0 ? void 0 : _a.unit) === room.id.toString() }, room.name));
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (h("div", { key: '4e2bc5cc53826d38a76da6725d882a7bea78d74c', class: "mt-1 mt-md-0 mr-md-1 flex-fill" }, h("select", { key: 'a9c1bf7d796e524409d259f34947bb7fd4db7676', "data-testid": "bed_configuration", class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, h("option", { key: '8ad2803ad7c26c8aee70c37e2392b38c4cf130ac', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), h("p", { key: 'c42cfd90d4fa1c281ba55d4cd40759addf4bdc96', class: "rate_amount" }, formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: '31e750926b9effabe17f6ed88898880d11cf79a6', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, h("p", { key: '3a2a32cdd99af814eb27909a588ddfecbf45db69', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), h("div", { key: 'e3333532e56a35a1d8f0fe4e4ebc7969bb3226c1', class: "mr-1 flex-fill" }, h("select", { key: '304757ca3cbc516a31a43aa7a384944c95818870', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, h("option", { key: '18a1543138779ee2d1233fd940625b91c57360a6', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'dd5539357c17ebfc52231674d6fc2ac7b4480279' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), h("div", { key: 'e69828f17f0fcccfffa0cbcbed9c4b2429c6ad26', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, h("fieldset", { key: '27cbd81e89f58320ffe80fa7feb52850188d4706', class: "mt-lg-0 mr-1 " }, h("igl-date-range", { key: 'c6f74c2e3fbd7aae8e4be605eebffd89941f3822', "data-testid": "date_picker", variant: "booking", dateLabel: locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: '317d6a1e17d7a261d71c85e91d84ab2e78e70fb0', class: "text-right mt-1 message-label" }, calendar_data.tax_statement)));
    }
};
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: '49d3d532bd4c4ff2bb716ed81fa77a9a9b40ef37', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: 'f9f95f3c353329e27fc84ec1343de9a0706a59c4', class: `d-flex mt-1  p-0 ${isAvailableToBook ? 'flex-column flex-lg-row align-items-lg-center justify-content-lg-between' : 'align-items-center justify-content-between'}` }, h("div", { key: '57b12acc50c90c28405796e09ce028cc5948d9cd', "data-testid": 'rp_name', class: "rateplan-name-container m-0 p-0  d-flex align-items-center", style: { gap: '0.5rem' } }, bookingType === 'BAR_BOOKING' ? (h("p", { class: "m-0 p-0" }, h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable")))) : (h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && h("ir-tooltip", { key: '7c2736235042ab7946a424a06cf9174f80128a9e', message: this.getTooltipMessages() })), isAvailableToBook ? (h("div", { class: "d-md-flex m-md-0  justify-content-md-end align-items-md-center flex-fill rateplan-container" }, h("div", { class: "flex-fill max-w-300 flex-grow-1" }, h("fieldset", { class: "position-relative flex-grow-1 w-100" }, h("select", { disabled: disableForm, "data-testid": "adult-child-offering", class: "form-control input-sm flex-grow-1 w-100", id: v4(), onChange: evt => this.handleDataChange('adult_child_offering', evt) }, formattedVariations === null || formattedVariations === void 0 ? void 0 : formattedVariations.map(variation => (h("option", { value: variation, selected: this.formatVariation(selectedVariation) === variation }, variation)))))), h("div", { class: "m-0 p-0 mt-1 mt-md-0 d-flex justify-content-between align-items-md-center ml-md-1" }, h("div", { class: "d-flex m-0 p-0 rate-total-night-view mt-0 flex-grow-1" }, h("ir-price-input", { testId: 'amount_input', disabled: disableForm, onTextChange: e => this.updateRateplanSelection({
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (h(Host, { key: '706bc908dcbbaa9d3d52588c796f5a369ba8b0ad' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && h("div", { key: 'fb3c825bf71ca9cad3ce7acbcc223384c7e15be1', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '701b4226aba6f12a8107b6857f9c68aebaa272c8' }, h("div", { key: '829b94cded0b4e7df9260fd17e11399e729f3ecf', class: 'd-flex align-items-center ' }, h("label", { key: 'd6ab2c0a14901f5921811ff2c2c610830074d3c2', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: '8ac421ad1d7c72e626c34db6e2aa554de3e17b8a', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: 'f14985b15cb0ec856f1e6f0db30653d361b994a8', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: '2338b4f84b06dccd661f8b891509edbd0df5a241', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: 'a8fdb6adb675a1a51b4eff9b7c2cdf24caff582b', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: '1f21684e8a7f6fca22bc669aa4bcbf083702fd85', class: 'sr-only' }, "clear input"), h("svg", { key: '1d8c0336f6cb376b365eb560d59295883f7da7a3', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'bd956680db06ee5ebe78ce30419c50b3a27bd032', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (h("form", { key: '72adb515ebaa0e6aafd132cb00954334907d4783', class: "dropdown m-0 p-0" }, h("ir-input-text", { key: '6c27923102e4abec442a23c80367b1605e045c19', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), h("div", { key: '69b0b678442ac9b67acf2e7253f4f7c2a9e2b4d4', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (h(Fragment, { key: 'e88a61d6047cc2c4eec50f5b6bab2389b1c9bacf' }, h("button", { key: '3209e2173d35ace14069e5a3be83962ad2feadd5', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, h("img", { key: 'd793cb742c983b3d2814014e83fd8cb35039c828', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), h("p", { key: '8b478bc3a2c33c1733481fe63a8035585dcf9b0e', class: "pl-1 m-0" }, this.propertyCountry.name)), h("div", { key: '0dbb3e145b91b206b69d526d334ae102aef8dd3a', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && h("p", { key: '05a89a2e62e028529858e17ffca38c311e503363', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: 'f16330b346e24f95af3c368e165b82d2788458c1' }, h("input", { key: 'e2e3089cf0d4c78d9aeeebe0c6fbefaea5649c49', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
