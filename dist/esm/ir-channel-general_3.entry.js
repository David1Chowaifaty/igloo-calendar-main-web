import { r as registerInstance, h, H as Host, c as createEvent, g as getElement, F as Fragment } from './index-7f938890.js';
import { c as channels_data, t as testConnection, u as updateChannelSettings, a as selectChannel, b as addMapping, d as setMappedChannel } from './channel.store-8d08b57e.js';
...
const IrChannelHeader = class {
    ...
    render() {
        return (h(Host, { key: '98b3dde2cdb290764d5b1a2c633a3b3152361c66' }, h("ul", { key: '50c6528ba524d5986b87bf313f906ce677c269cc' }, this.headerTitles.map((title, index) => (h("li", { class: `tab ${title.disabled ? 'text-light' : ''}`, key: title.id, onClick: () => {
                if (!title.disabled)
                    this.handleTabSelection(index);
            }, "data-disabled": title.disabled, "data-state": this.selectedIndex === index ? 'selected' : '' }, title.name)))), h("span", { key: 'fa688b149a806124b977f3989bdfafea2644422a', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
...
const IrChannelMapping = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h(Host, { key: '1d9a7075ffcd639530235b0ee7f80453da31d553' }, h("div", { key: '2a75b128e4d2d3cc9410739704dc1b41fefd4032', class: "d-flex w-100 justify-content-end" }, h("button", { key: 'e789e3292486e390e805a2485ab2277378b70412', onClick: () => {
                setMappedChannel();
            }, class: "btn refresh-btn" }, (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Refresh)), h("table", { key: '834b0cd676ac19f1d406176901e8e5834d503049', class: "m-0 p-0 w-100" }, h("thead", { key: '0b2967ffdc1fcf5aa1d15bf355da7f73f29f30fa', class: 'py-1' }, h("tr", { key: 'da450edbfdf0836fcf4d4e7ea214740d32c2cd32', class: "py-1" }, h("th", { key: 'b28664b8b298be15274cb463030f5b9c25d5aba3', scope: "col", class: "py-1 pr-3" }, (_b = channels_data.selectedChannel) === null || _b === void 0 ? void 0 : _b.name), h("td", { key: 'e0c74f17759d04e262aa095b5415ab1a8230d627' }, h("svg", { key: '0a3719286bef047d41b5e774a74749c3df6804f3', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '9d9f30d5e5a681ebc48167bc514ca0d0ee320741', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" }))), h("th", { key: '163ffbb8787a05b071259c2ca95d1fd63ea97ca3', scope: "col", class: "px-2" }, "Igloorooms"))), h("tbody", { key: '1fa37271eff3f7f3369f10075ab5bf31ceddcf8d' }, (_e = (_d = (_c = channels_data.selectedChannel) === null || _c === void 0 ? void 0 : _c.property) === null || _d === void 0 ? void 0 : _d.room_types) === null || _e === void 0 ? void 0 : _e.map(room_type => {
