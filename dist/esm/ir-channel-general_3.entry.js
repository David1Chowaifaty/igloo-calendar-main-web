import { r as registerInstance, c as createEvent, h, H as Host, a as getElement, F as Fragment } from './index-cec96f7a.js';
import { c as channels_data, t as testConnection, u as updateChannelSettings, a as selectChannel, b as addMapping, d as setMappedChannel } from './channel.store-ab3f7a26.js';
...
const IrChannelHeader = class {
    ...
    render() {
        return (h(Host, { key: '4de501b404392ffb8b52cf8eea62c5024ece2e28' }, h("ul", { key: '68e9aa83adff475d3898ad87557e5a8b8a4de1db', class: "px-1" }, this.headerTitles.map((title, index) => (h("li", { class: `tab ${title.disabled ? 'text-light' : ''}`, key: title.id, onClick: () => {
                if (!title.disabled)
                    this.handleTabSelection(index);
            }, "data-disabled": title.disabled, "data-state": this.selectedIndex === index ? 'selected' : '' }, title.name)))), h("span", { key: 'f4a4ba407d27229eb1d840316c94cf6f0dac2514', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
...
const IrChannelMapping = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h(Host, { key: '94a8501c40552ff95da134e3aa7008e960c62405', class: "py-md-2 px-md-2" }, h("div", { key: '124b12bb88aef4bca08c2afbb84a8bcf96a9fff4', class: "d-flex p-0 m-0 w-100 justify-content-end" }, h("button", { key: '5f5fd97d0bee55e69930fae29b74e894262869b7', onClick: () => {
                setMappedChannel();
            }, class: "btn refresh-btn" }, (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Refresh)), h("section", { key: '4ba6c30d8245193aba77cb8a67c4df83c9f0d44e', class: "w-100" }, h("div", { key: 'cfca1227e7e7816951a870946d0092d161f2275d', class: "pt-1 mapped_row" }, h("p", { key: '416e6b1e8ab262880822dea88b4f3fddf3273f6e', class: "mapped_item channel_name" }, (_b = channels_data.selectedChannel) === null || _b === void 0 ? void 0 : _b.name), h("svg", { key: '55ef405c7b68ff1d0197d7e46a06e479ef0b9d25', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '94e414f3961f963925af6dfb9a5d963493eb5ba7', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), h("p", { key: 'd64ac22402b72f519f7dbac34028970dc5df2a28', class: "pl-2 mapped_item channel_name" }, "igloorooms")), h("div", { key: 'd333b7a0964c70ac62532f9cabb614f953729ef6' }, (_e = (_d = (_c = channels_data.selectedChannel) === null || _c === void 0 ? void 0 : _c.property) === null || _d === void 0 ? void 0 : _d.room_types) === null || _e === void 0 ? void 0 : _e.map(room_type => {
