...
const IrChannelMapping = class {
    ...
    render() {
        return (h(Host, { key: '383be413ef6030ed5ffe9557af0bcac6aa3b3c70', class: "py-md-2 px-md-2" }, h("div", { key: '3e30649fc0c55f6da8d02abf08b1dd27c6c183d2', class: "d-flex p-0 m-0 w-100 justify-content-end" }, h("button", { key: 'c56fdce604fe57278bb2ef9bead7688f1bef460e', onClick: () => {
                setMappedChannel();
            }, class: "btn refresh-btn" }, locales.entries?.Lcz_Refresh)), h("section", { key: 'adf274c3b7a0a21eabf42856aa830a3e297bff10', class: "w-100" }, h("div", { key: '9480fb1de6cd8e5be3c3780328f029e1309e9151', class: "pt-1 mapped_row" }, h("p", { key: '3bf5a87b5dbf8d0ce942e752fc7c84a50156d5b1', class: "mapped_item channel_name" }, channels_data.selectedChannel?.name), h("svg", { key: '09300de6cb8523767567ce5e27813b40946f2087', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'bae1279f86a3ed58eda1dbd8ea9727eda74cfc31', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), h("p", { key: '323b949a386b89b9b1742aeb0c044b4bfb8868f8', class: "pl-2 mapped_item channel_name" }, "igloorooms")), h("div", { key: '07c4fea855331c2fdbf6ef96df8d0975ba6237f2' }, channels_data.selectedChannel?.property?.room_types?.map(room_type => {
