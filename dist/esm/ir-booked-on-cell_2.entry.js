...
const IrStatusActivityCell = class {
    ...
    bookingNumber;
    render() {
        return (h(Host, { key: '5e7b3aa901b89c724c7f34bf718014c5d12cb30e' }, h("ir-booking-status-tag", { key: '5471839ceb1f0b4513732a19bfd8095e68f697dc', status: this.status, isRequestToCancel: this.isRequestToCancel }), this.showModifiedBadge && h("p", { key: 'eb484c5abf1c1fa5b2f8505341dd7e66a69483bd', class: "status-activity__modified" }, "Modified"), this.showManipulationBadge && (h(Fragment, { key: '17aca2193b27279e623adc511a815ad29cc010d7' }, h("wa-tooltip", { key: 'e5a8a62aa0a11d35d849eb6c3efd1cd65b47235e', for: `manipulation_badge_${this.bookingNumber}` }, `Modified by ${this.lastManipulation.user} at ${this.lastManipulation.date} ${this.lastManipulation.hour}:${this.lastManipulation.minute}`), h("p", { key: 'a5b83fc1236bf6f3537596ce2a095f454298aaf9', class: "status-activity__manipulation", id: `manipulation_badge_${this.bookingNumber}` }, "Modified")))));
    }
};
