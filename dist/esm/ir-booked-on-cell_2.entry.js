...
const IrBookedOnCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ec1991f7b97f4a39b33551ca52b5fd83ed6e9875' }, this.label && h("p", { key: '8325bc65692e04252bec54c4e3178738fa570741', class: "cell-label" }, this.label, ":"), h("p", { key: '5ec6c52ba3d82eebfd33a683c5a0e0360604e9c8', class: "booked-on-cell__date" }, hooks(date, 'YYYY-MM-DD').format('DD MMM YYYY')), h("p", { key: '541783f0cd4e9e767cc1bb50f83b3dc33450825e', class: "booked-on-cell__time" }, _formatTime(hour.toString(), minute.toString()))));
    }
};
