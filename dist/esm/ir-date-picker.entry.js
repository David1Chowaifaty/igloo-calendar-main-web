...
const IrDatePicker = class {
    ...
    render() {
        return (h("div", { key: '761d7ffed5d4068222ebd58aec0f7dc3c814f704', class: "ir-date-picker-trigger" }, this.customPicker && h("slot", { key: '72edf0afc88dfd3cca7cb5537fde9193c9efb917', name: "trigger" }), h("input", { key: '43920eee7385448cd5e51b69b8e98498389498f0', type: "button", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
