...
const IrDailyRevenue = class {
    constructor(hostRef) {
        ...
        this.language = '';
        this.ticket = '';
        this.date = hooks().format('YYYY-MM-DD');
        ...
        try {
            ...
            if (!isExportToExcel) {
                requests.push(this.propertyService.getDailyRevenueReport({
                    date: hooks(this.date, 'YYYY-MM-DD').add(-1, 'days').format('YYYY-MM-DD'),
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: 'a054874d552a0f68e076b0cf70ffcf3e8ac80be8', class: "d-flex align-items-center" }, h("span", { key: '02c005d68b7fab5d70a35584dc6d2c2e74460c55' }, this.dates.from_date), ' ', h("svg", { key: 'b28165f0758cc907bc9c56c6dcc1766cc2051705', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '4a4e10aebc7569fdcf3937ad87ad54565501f8fa', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '0c7df037112de6b3e37fce20748ff66543a6e74b' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: 'e16fd7ef4bb7502d30535d9757a6b9e0c5feb337', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '13bacbd74f68e9378c91a83730653c3b6f44b248', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '63ad49a4e1b1b884fec2fcbd7f772810cbdd0c05', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '67c34a98ff413bcae44211ded0cb1bfffa277fab', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '902c612b208c07559fe0a985cd06add72be0b5ff', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'f0c102a226e0f05e49db1eba28e8f57f7e4c3737', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'd8d7d90ded59625a5033c4499e1ebb763a7070f5', class: `ir-alert-header` }, h("p", { key: '8c1c3fd465df10b0f9a3675f5704aea85191ef12' }, this.modalTitle))), h("div", { key: '1514dcc03d2d88ddc78393c21338e985b6103dcf', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '38863aedbfce9c05c823660588a02c776810db35' }, this.modalBody)), h("div", { key: 'cf495be5423d0f41ae2135d5880596161ed9515b', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: 'f5e94e75ef44f87a1aa78d5fa86e4f41d04a9d33', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: '79dc8fd82e6cf52a5d7cbdf34a4c4d24f4a0a912', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '2e8b74225f2f1c20a87f9578371ed62c2ed49dae', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: 'a54f235d41d8101ed9cda0b86511599cbcab0979', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '39d3190545af8f68e1ab591ce21648bd52d92bc0', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '8109c74e08a4983b374e383b97f3dc4015c3f1d7', class: 'sidebar-title' }, h("p", { key: '0837a8b8944b3394a83a0af1cfbdb517ac9cf536', class: 'p-0 m-0' }, this.label), h("div", { key: '82458c04d36cc0bc9b9e521012f2bf0d59e7e085', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: 'ca408f0098993fde882551aca79806e3f6169988', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '149a6b26644935e043a933c4359e26e68ad40f05', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '047992c48eb5f7673d482e83e3f9a556fc9c9835', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: 'd829efbd895a68d84a42e5f0b46c3fbae731c1f1', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '6713ebd7833570658fab322fc28e986e5f4decea' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
