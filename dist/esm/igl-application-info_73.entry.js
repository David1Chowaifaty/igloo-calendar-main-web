...
const IglRoomType = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e17f7d383d5f1369de3d0b16b4145e2477a943d8' }, isValidBookingType && this.roomType.rateplans?.length > 0 && h("h5", { key: '4654bae8d6a250c39890d9e89fae663a4db2a5bc', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (h("ir-drawer", { key: '659775919af04ba55c053a43665d16824a64b2d2', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && h("ir-billing", { key: 'c72573d9ae0ea1dfd9c288d79506aaefe4ded8a6', booking: this.booking })));
    }
};
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (h("wa-badge", { key: '96860a2712edc402b21caecfb5f92d3f43d23987', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e9f668afb4b6fafad52ee291b64ddbc47b0aaf91', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, h("wa-popup", { key: '55438b487f198ffc0a206eccf747ae912ac095be', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, h("ir-input", { key: '4dfb9d3af81234cce0f56152426b5780340c5564', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, h("slot", { key: '43a0975970a59a5e7fd7fe4d6612c5156df353a7', name: "start", slot: "start" }), h("slot", { key: '2168b32cad0da08eb26b9ee1189b2a43bc2015bb', name: "end", slot: "end" })), h("div", { key: 'a5eb00f021bcdf333e142444b98ac639c1d98836', class: "picker-surface" }, h("div", { key: 'd62df4ab143d0db91799cf79a171705a0a982694', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), h("input", { key: '213e9a867e3cc4b81258378e8603bdeb2111ee71', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (h("button", { key: '3fc860863d13b7c92d8a81c6d8d32f40dfa83b00', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '1d9c00be5abc69a217d5044ba02570dab935b3be', name: "icon" })));
    }
};
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: '71745fa0e442271c65317caa35db4bbd07771dcf', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, h("label", { key: '4c753f46207426ede8da514d5a27501a799183c6', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, h("div", { key: '70c4140f6592297b060c5822ac3be0f7dc60ecbc', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, h("wa-dropdown", { key: '180963cb494578bb746c3d04534025d57237205a', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, h("button", { key: 'b21771ab3e961a9221f1acef2ed6549e8014626c', slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, h("div", { key: '164fa85d09c7a0a1f1691971c6c308c348025e0b', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : h("span", null, "Select")), h("wa-icon", { key: '611cd0ecd999056d0fcbfe2b5be58553299d001d', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), h("span", { key: '324e553496cafc09d6143028c773bec384336993', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (h("wa-dropdown-item", { value: country.id.toString() }, h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), h("span", { class: "mobile-input__country-name" }, country.name), h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), h("input", { key: '95aa21f41792ccd9fa91683fd0ad9f4379405de2', ref: el => (this.inputRef = el), id: this.inputId, class: {
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: '4d56c7a18939481b5ef2fa30a1894535f45b8f2e' }, h("slot", { key: '54ae2496a3b480805747259095bf89c3eac01571' })));
    }
    static get watchers() { return {
