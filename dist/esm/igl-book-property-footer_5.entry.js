...
import { B as BookingService, b as booking_store, s as setBookingDraft, m as modifyBookingStore, o as setBookedByGuestManualEditState } from './booking.service-f244486d.js';
import { z } from './index-1e1f097b.js';
import { f as formatAmount, D as validateEmail } from './utils-78094d83.js';
import { I as IMask } from './index-e2caf943.js';
import { B as BookingGuestSchema } from './types-4fa492e5.js';
import { v as v4 } from './v4-964634d6.js';
import './index-f100e9d2.js';
import './axios-aa1335b8.js';
import './booking-20271088.js';
...
const IglBookingOverviewPage = class {
    ...
    render() {
        return (h(Host, { key: 'ede53c96f098aafcd1eecacfd216b9bcccc83346' }, h("igl-book-property-header", { key: 'd55f688d9a689ad7ef5091a54962837b5acbfc23', wasBlockedUnit: this.wasBlockedUnit, bookedByInfoData: this.bookedByInfoData, defaultDaterange: this.defaultDaterange, dateRangeData: this.dateRangeData, minDate: this.setMinDate(),
            // minDate={this.isEventType('ADD_ROOM') || this.isEventType('SPLIT_BOOKING') ? this.bookedByInfoData.from_date || this.bookingData.FROM_DATE : undefined}
            splitBookingId: this.showSplitBookingOption, bookingData: this.bookingData, message: this.message, bookingDataDefaultDateRange: this.bookingData.defaultDateRange, showSplitBookingOption: this.showSplitBookingOption, adultChildConstraints: this.adultChildConstraints, splitBookings: this.getSplitBookings(), propertyId: this.propertyId }), h("div", { key: '48b916935883fb79949fc71368a1ba0c25f992d5', class: " text-left" }, isRequestPending('/Check_Availability') && this.isEventType('EDIT_BOOKING') ? (h("div", { class: "loading-container" }, h("div", { class: "loader" }))) : (h(Fragment, null, booking_store.roomTypes?.map(roomType => (h("igl-room-type", {
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (h(Host, { key: '54a2ce466f35cc55ea549a750168266a75cd636c' }, h("div", { key: '323015f6415a175b6887cc39bc4da80b610355f8', class: "text-left mt-3" }, h("div", { key: 'a87d2f7f8c0b109b70331d2f81ce1a934c832197', class: "d-flex", style: { alignItems: 'flex-end', gap: '0.5rem' } }, h("ir-picker", { key: '9b17869a6e4e6c35d9028d583457942679fe5e55', class: "bookedByEmailContainer m-0 p-0", label: locales.entries.Lcz_BookedBy, value: this.bookedByData.email, ref: el => (this.pickerRef = el), "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.email !== '' && validateEmail(this.bookedByData.email))), withClear: true, "onText-change": event => this.fetchGuests(event.detail), debounce: 300, "onInput-picker-blurred": e => {
        ...
        })), h("div", { key: '6f2c15baa2446ecc02a6e52e0ec51c7e92b2e600', style: { paddingBottom: '0.5rem' } }, h("wa-tooltip", { key: '284a003008ac27fe74bc63c495438b8c14b24f26', for: `main_guest-search-tooltip` }, "Leave empty if email is unavailable"), h("wa-icon", { key: 'a9c49b0b59f400084590732740828a1ff5e4c55c', name: "circle-info", id: `main_guest-search-tooltip` })))), h("div", { key: '2d851ae462bbe62c6a9054d9cb7c2a8c3909cbac', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, h("div", { key: '0e9446d26864243c29aa213d5d24e9afd763222a', class: "d-flex flex-column flex-md-row  justify-content-md-between ", style: { gap: '1rem' } }, h("div", { key: '18c428d6574758d92815c2d49ab2e990a18df9c4', class: "fd-property-booked-by__guest-form " }, h("ir-validator", { key: '9b4703fa5d8842f50d4612bbea64b639b08e6ce8', value: this.bookedByData.firstName, schema: BookingGuestSchema.shape.first_name }, h("ir-input", { key: '1350b74d61d47c990bf894ecb7e597b96f3d5d97', "onText-change": event => {
                this.updateGuest({ first_name: event.detail });
                this.handleDataChange('firstName', { target: { value: event.detail.trim() } });
            }, defaultValue: this.bookedByData.firstName, value: this.bookedByData.firstName, label: locales.entries.Lcz_FirstName, placeholder: locales.entries.Lcz_FirstName, required: true, name: "last_name_custom", autocomplete: "family-name" })), h("ir-validator", { key: '89db40da34af5655fe96b72eea1e264af33c79a5', value: this.bookedByData.lastName, schema: BookingGuestSchema.shape.last_name }, h("ir-input", { key: '7473ca9ded4707eddae83d7032ecd57ee2577d62', "onText-change": event => {
                this.updateGuest({ last_name: event.detail });
                this.handleDataChange('lastName', { target: { value: event.detail.trim() } });
            }, name: "first_name_custom", autocomplete: "given-name", defaultValue: this.bookedByData.lastName, value: this.bookedByData.lastName, label: locales.entries.Lcz_LastName, placeholder: locales.entries.Lcz_LastName, required: true })), h("ir-country-picker", { key: '8682a00b8f87c1e17d29cfd3dc1d7411ee69a931', label: locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) }), h("ir-mobile-input", { key: '3eb9cf8a6a17d09d1e2dba394212dacccdef628f', size: "small", "onMobile-input-change": e => {
            ...
            // required
            countryCode: this.countries.find(c => c.phone_prefix === this.bookedByData.isdCode)?.code, countries: this.countries }), h("wa-select", { key: '09510458fa71c4d7ee271e140ebb263d4e27834c', size: "small", label: locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", "aria-disabled": String(Boolean(this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '')), id: v4(), defaultValue: this.arrivalTimeList[0].CODE_NAME, value: this.bookedByData.selectedArrivalTime.code, onchange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (h("wa-option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))), h("div", { key: '019f5d7363c6515ba46b1ea048a331a29283d2f1', class: "p-0 flex-fill  ml-md-3 d-flex flex-column", style: { gap: '0.5rem' } }, h("wa-textarea", { key: 'd53e263df20d0b80143f0d8bf4a2ca5227fb0512', onchange: event => this.handleDataChange('message', event), size: "small", value: this.bookedByData.message, defaultValue: this.bookedByData.message, label: locales.entries.Lcz_AnyMessageForUs, rows: 4 }), this.paymentMethods.length > 1 && (h("wa-select", { key: '18e2ffb0d4ce01d3ce4ddd3364652b9dfa90124b', label: 'Payment Method', size: "small", value: booking_store?.selectedPaymentMethod?.code, onchange: e => modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (h("wa-option", { value: p.code }, p.description))))), booking_store.selectedPaymentMethod?.code === '001' && (h(Fragment, { key: '3082b74d778970b160e330a8aff2841c689bc139' }, h("ir-input", { key: 'b94bf35b95992aba6781bb535112c15f119045e4', value: this.bookedByData.cardNumber, defaultValue: this.bookedByData.cardNumber, "onText-change": e => this.handleCreditCardDataChange('cardNumber', e.detail.trim()), label: locales.entries.Lcz_CardNumber }), h("ir-input", { key: '5747d83aac43c80c8d413d3b61c3ad8ada5b20f3', value: this.bookedByData.cardHolderName, defaultValue: this.bookedByData.cardHolderName, "onText-change": e => this.handleCreditCardDataChange('cardHolderName', e.detail.trim()), label: locales.entries.Lcz_CardHolderName }), h("ir-input", { key: '3ffa0dd4307cbb3e3934302da543c47860394948', "onText-change": e => {
            ...
            }, label: locales.entries.Lcz_ExpiryDate }))), booking_store.selectedPaymentMethod?.code === '005' && (h("div", { key: '4c3147076a9c045ec7c098e4fc1eef06151c76c8', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, h("label", { key: '185690bbdf2f0c1af1bddd6f51935f73238db93b', class: "p-0 m-0 margin3" }), h("div", { key: '7b5a77bde2e0a7d7f774903742eb93880e88ad38', class: "p-0 m-0  controlContainer flex-fill" }, h("div", { key: '71a6070cdcd35e24a141e657b83eafecba8cd97b', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), h("wa-checkbox", { key: 'b78f1ec058ccc297f710dcb692684fcd71b669d9', checked: this.bookedByData.emailGuest, onchange: event => this.handleDataChange('emailGuest', event) }, locales.entries.Lcz_EmailTheGuest))))));
    }
};
