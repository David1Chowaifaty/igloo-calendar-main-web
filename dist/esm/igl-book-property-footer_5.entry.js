...
import { B as BookingService, b as booking_store, s as setBookingDraft, m as modifyBookingStore, f as setBookedByGuestManualEditState } from './booking.service-BVIex3m4.js';
import { l as libExports } from './index-DeW5X45W.js';
import { n as showToast, i as formatAmount, y as validateEmail } from './utils-DE70XlzV.js';
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (h(Host, { key: '8c0e06ecc17a1dc93112e60efb70951f9c39bae0' }, h("div", { key: '96f3fef9e3e6ff1f706d5d50cb076e6d28606414', class: "text-left mt-3" }, h("div", { key: '52e0d30590d555326b34d8d079445078a28bdc53', class: "d-flex", style: { alignItems: 'flex-end', gap: '0.5rem' } }, h("ir-picker", { key: 'c4ee33947250704266fcee14261e4919b76bea24', class: "bookedByEmailContainer m-0 p-0", label: locales.entries.Lcz_BookedBy, value: this.bookedByData.email, ref: el => (this.pickerRef = el), "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.email !== '' && validateEmail(this.bookedByData.email))), withClear: true, "onText-change": event => this.fetchGuests(event.detail), debounce: 300, "onInput-picker-blurred": e => {
            ...
            // required
            countryCode: this.countries.find(c => c.phone_prefix === this.bookedByData.isdCode)?.code, countries: this.countries }), h("wa-select", { key: 'ebc3c7dd50bd47b4b654cfd30a59eb28051a141a', size: "s", label: locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", "aria-disabled": String(Boolean(this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '')), id: v4(), defaultValue: this.arrivalTimeList[0].CODE_NAME, value: this.bookedByData.selectedArrivalTime.code, onchange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (h("wa-option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))), h("div", { key: '8e597e26141b00cfb4f2dcb1d535b08a4fffbc5b', class: "p-0 flex-fill  ml-md-3 d-flex flex-column", style: { gap: '0.5rem' } }, h("wa-textarea", { key: 'a7b0bbba04c3554ea84068257d0c6e3b59524b64', onchange: event => this.handleDataChange('message', event), size: "s", value: this.bookedByData.message, defaultValue: this.bookedByData.message, label: locales.entries.Lcz_AnyMessageForUs, rows: 4 }), this.paymentMethods.length > 1 && (h("wa-select", { key: '0b97c699cba4b3b73eec912cd6573c0a2cb3b4ce', label: 'Payment Method', size: "s", value: booking_store?.selectedPaymentMethod?.code, onchange: e => modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (h("wa-option", { value: p.code }, p.description))))), booking_store.selectedPaymentMethod?.code === '001' && (h(Fragment, { key: '849d505264c520e0dac8b6e01e54710af7c357e0' }, h("ir-input", { key: '60bea0aa14b6192c62096cd93c666297ae2492b4', value: this.bookedByData.cardNumber, defaultValue: this.bookedByData.cardNumber, "onText-change": e => this.handleCreditCardDataChange('cardNumber', e.detail.trim()), label: locales.entries.Lcz_CardNumber }), h("ir-input", { key: 'a279171ef6aea9d435204f06cabea9d95c540393', value: this.bookedByData.cardHolderName, defaultValue: this.bookedByData.cardHolderName, "onText-change": e => this.handleCreditCardDataChange('cardHolderName', e.detail.trim()), label: locales.entries.Lcz_CardHolderName }), h("ir-input", { key: '729ebf3b8d5965be4b68237122cab902617f7bee', "onText-change": e => {
            ...
            }, label: locales.entries.Lcz_ExpiryDate }))), booking_store.selectedPaymentMethod?.code === '005' && (h("div", { key: '1c8bea4d804aecaa15a75340bb784216c45763d0', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, h("label", { key: '15709d6bb670cbff5327453c622676696dffc51e', class: "p-0 m-0 margin3" }), h("div", { key: 'c7f0d26aa001f867e03c5fd1554b715478196407', class: "p-0 m-0  controlContainer flex-fill" }, h("div", { key: '5910f5f711993ec55b179cdf9298e6063b3d79ec', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), h("wa-checkbox", { key: '7f68dd2ddcae75fee2ef912305bc02993b16d3cd', checked: this.bookedByData.emailGuest, onchange: event => this.handleDataChange('emailGuest', event) }, locales.entries.Lcz_EmailTheGuest))))));
    }
};
