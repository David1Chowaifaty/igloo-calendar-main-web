...
import { B as BookingService, b as booking_store, s as setBookingDraft, m as modifyBookingStore, f as setBookedByGuestManualEditState } from './booking.store-DVDRSILK.js';
import { h as showToast, v as validateEmail } from './utils-B69q7mr1.js';
import { f as formatDate } from './ir-date-BngUhoPp.js';
import { a as formatBookingNumber, b as formatCount, f as formatAmount } from './number-DpPJHVo2.js';
import { n as numberType, s as stringType } from './types-BWKgfE54.js';
import './booking.dto-xX-uaIxb.js';
import './locales.store-CXJn6ls-.js';
import { I as IMask } from './index-BQB1ooJC.js';
import { B as BookingGuestSchema } from './types-e2CujCbR.js';
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (h(Host, { key: '1eba165fcafab6413bf12f7233617c34abebd8b4' }, h("div", { key: '752d54c83c703adc10016f1b16e8a1421c107357', class: "ir-text-start mt-3" }, h("div", { key: 'd0b57aa57c3bb31dcb31a4608e512ef0251f2123', class: "d-flex", style: { alignItems: 'flex-end', gap: '0.5rem' } }, h("ir-picker", { key: 'd77e53ecaab3f12a88672d7da48bd84113f9512b', class: "bookedByEmailContainer m-0 p-0", label: t('Lcz_BookedBy', { fallback: 'Booked by' }), value: this.bookedByData.email, ref: el => (this.pickerRef = el), "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.email !== '' && validateEmail(this.bookedByData.email))), withClear: true, "onText-change": event => this.fetchGuests(event.detail), debounce: 300, "onInput-picker-blurred": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
        ...
        })), h("div", { key: '42e72c681f7ee1a4bba9a17b2b54da2603d36da6', style: { paddingBottom: '0.5rem' } }, h("wa-tooltip", { key: 'ea8e858d462ea54131a8a58522c51a77c611a9f5', for: `main_guest-search-tooltip` }, t('Lcz_LeaveEmptyIfEmailUnavailable', { fallback: 'Leave empty if email is unavailable' })), h("wa-icon", { key: 'adb5b05033d4eac91e87ebb5b27f9e711105a5a6', name: "circle-info", id: `main_guest-search-tooltip` })))), h("div", { key: '99ea15d263ada9395095f058028082018c775f6d', class: "bookedDetailsForm ir-text-start mt-2 font-small-3 " }, h("div", { key: '8cafab5bb23ab1901707dd63aa00d58810086b6c', class: "d-flex flex-column flex-md-row  justify-content-md-between ", style: { gap: '1rem' } }, h("div", { key: '0ab6b828458031509329a244380076acebc9ffcc', class: "fd-property-booked-by__guest-form " }, h("ir-validator", { key: '780a8631fe22728ea0279a2860736879cf20d402', value: this.bookedByData.firstName, schema: BookingGuestSchema.shape.first_name }, h("ir-input", { key: 'c3b85ede223ba8025d5944aa748bf12067e74fb1', "onText-change": event => {
                this.updateGuest({ first_name: event.detail });
                this.handleDataChange('firstName', { target: { value: event.detail.trim() } });
            }, defaultValue: this.bookedByData.firstName, value: this.bookedByData.firstName, label: t('Lcz_FirstName', { fallback: 'First name' }), placeholder: t('Lcz_FirstName', { fallback: 'First name' }), required: true, name: "last_name_custom", autocomplete: "family-name" })), h("ir-validator", { key: 'e25fcd9e7002c03ab8ad4c8e3fc94fc5668b0cc4', value: this.bookedByData.lastName, schema: BookingGuestSchema.shape.last_name }, h("ir-input", { key: 'c357c19921781b65326dcb16f20a068dcefe3eef', "onText-change": event => {
                this.updateGuest({ last_name: event.detail });
                this.handleDataChange('lastName', { target: { value: event.detail.trim() } });
            }, name: "first_name_custom", autocomplete: "given-name", defaultValue: this.bookedByData.lastName, value: this.bookedByData.lastName, label: t('Lcz_LastName', { fallback: 'Last name' }), placeholder: t('Lcz_LastName', { fallback: 'Last name' }), required: true })), h("ir-country-picker", { key: 'ca55cde867d40ea4907306304e87d990e39dc43d', label: t('Lcz_Country', { fallback: 'Country' }), variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) }), h("ir-mobile-input", { key: '6e33ca8dec4157b395060060ac957d8b97a9191f', size: "s", "onMobile-input-change": e => {
            ...
            // required
            countryCode: this.countries.find(c => c.phone_prefix === this.bookedByData.isdCode)?.code, countries: this.countries }), h("wa-select", { key: '364b38d5f156b85d228c5fa22149ab53a5d04fb6', size: "s", label: t('Lcz_YourArrivalTime', { fallback: 'Your arrival time' }), "data-testid": "arrival_time", "aria-disabled": String(Boolean(this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '')), id: v4(), defaultValue: this.arrivalTimeList[0].CODE_NAME, value: this.bookedByData.selectedArrivalTime.code, onchange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (h("wa-option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, getSetupEntryLabel(time)))))), h("div", { key: '2ebcaed19dd9b61d02d566722c36b466bfef05e2', class: "p-0 flex-fill  ml-md-3 d-flex flex-column", style: { gap: '0.5rem' } }, h("wa-textarea", { key: '4c7723e733f9ba223ba9ab61e22a1cf2e8263300', onchange: event => this.handleDataChange('message', event), size: "s", value: this.bookedByData.message, defaultValue: this.bookedByData.message, label: t('Lcz_AnyMessageForUs', { fallback: 'Any message for us' }), rows: 4 }), this.paymentMethods.length > 1 && (h("wa-select", { key: 'c8d02dfb8c9b29cebb26ec3e1b71549ddd72a58b', label: t('Lcz_PaymentMethod', { fallback: 'Payment Method' }), size: "s", value: booking_store?.selectedPaymentMethod?.code, onchange: e => modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (h("wa-option", { value: p.code }, p.description))))), booking_store.selectedPaymentMethod?.code === '001' && (h(Fragment, { key: '0a980aa43ceb952be36cb2b3f290113d7fc2cc4a' }, h("ir-input", { key: 'cab722d7049f81f30ad1a17457bccf7123eb842c', value: this.bookedByData.cardNumber, defaultValue: this.bookedByData.cardNumber, "onText-change": e => this.handleCreditCardDataChange('cardNumber', e.detail.trim()), label: t('Lcz_CardNumber', { fallback: 'Card number' }) }), h("ir-input", { key: 'd8817e889c1b500c75b3c926ec358ea8fae0c5be', value: this.bookedByData.cardHolderName, defaultValue: this.bookedByData.cardHolderName, "onText-change": e => this.handleCreditCardDataChange('cardHolderName', e.detail.trim()), label: t('Lcz_CardHolderName', { fallback: 'Card holder name' }) }), h("ir-input", { key: '48be1d55f515197fd06518cbcd7f732eb74562e0', "onText-change": e => {
            ...
            }, label: t('Lcz_ExpiryDate', { fallback: 'Expiry date' }) }))), booking_store.selectedPaymentMethod?.code === '005' && (h("div", { key: '00bfedd57f2156fb16f0b21d92d2c5ddff1af47d', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, h("label", { key: '0ffa3e6c0c92b4646eb03c81b337059f3a054534', class: "p-0 m-0 margin3" }), h("div", { key: '8f912e5db0c3cfceb71e708b9402d4c998867d59', class: "p-0 m-0  controlContainer flex-fill" }, h("div", { key: 'e4ac24ca55beec43cc615a03d1885530d456a1d8', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), h("wa-checkbox", { key: '312564fda27fc559d5045b4bb954e318ee81bbce', checked: this.bookedByData.emailGuest, onchange: event => this.handleDataChange('emailGuest', event) }, t('Lcz_EmailTheGuest', { fallback: 'Email the guest' })))))));
    }
};
