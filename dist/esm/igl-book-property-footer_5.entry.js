...
import { B as BookingService, b as booking_store, s as setBookingDraft, m as modifyBookingStore, f as setBookedByGuestManualEditState } from './booking.store-BYhS8VIV.js';
import { l as libExports } from './index-DeW5X45W.js';
import { s as showToast, f as formatAmount, w as validateEmail } from './utils-1xMAwYd7.js';
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5ab6bf900a309b55783f212dd08e71782ab7e3c1' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), h("div", { key: 'e4bbf0ca493dbf8109fc216afba1c9214b11acc4', class: `fd-book-property__header-container` }, showSourceNode && this.getSourceNode(), h("ir-date-range", { key: '7167d0b2ca6534ad292bcd680dc67b818874f903', "data-testid": "date_picker", variant: "booking", dateLabel: locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange }), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints(), h("ir-custom-button", { key: '394e150fc7d56ef5a6ab8a61aa9f49095c1103f9', loading: isRequestPending('/Check_Availability'), variant: "brand", onClickHandler: () => this.handleButtonClicked() }, locales.entries.Lcz_Check)), h("p", { key: '67a4da3b912a41911ca37262c534cb21daae5edf', class: "text-right message-label" }, calendar_data.tax_statement)));
    }
};
...
const IglBookingOverviewPage = class {
    ...
    render() {
        return (h(Host, { key: 'b5261abbd4536ad4ef164ff77390cc405ac1ff34' }, h("igl-book-property-header", { key: 'a5d989669d0c42f35d070173f880555d46aecd1c', wasBlockedUnit: this.wasBlockedUnit, bookedByInfoData: this.bookedByInfoData, defaultDaterange: this.defaultDaterange, dateRangeData: this.dateRangeData, minDate: this.setMinDate(),
            // minDate={this.isEventType('ADD_ROOM') || this.isEventType('SPLIT_BOOKING') ? this.bookedByInfoData.from_date || this.bookingData.FROM_DATE : undefined}
            splitBookingId: this.showSplitBookingOption, bookingData: this.bookingData, message: this.message, bookingDataDefaultDateRange: this.bookingData.defaultDateRange, showSplitBookingOption: this.showSplitBookingOption, adultChildConstraints: this.adultChildConstraints, splitBookings: this.getSplitBookings(), propertyId: this.propertyId }), h("div", { key: '0b904769b5800df83fbc271511ded7acd5a4bf2f', class: " text-left" }, isRequestPending('/Check_Availability') && this.isEventType('EDIT_BOOKING') ? (h("div", { class: "loading-container" }, h("div", { class: "loader" }))) : (h(Fragment, null, booking_store.roomTypes?.map(roomType => (h("igl-room-type", {
