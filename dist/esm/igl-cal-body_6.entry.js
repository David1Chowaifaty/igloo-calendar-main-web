...
import { c as calendar_dates } from './booking-33c39a06.js';
import { l as locales } from './locales.store-95a78d6b.js';
import { T as ToBeAssignedService } from './toBeAssigned.service-67f2bd31.js';
import { d as dateToFormattedString, p as getDaysArray, q as convertDatePrice, r as formatDate } from './utils-c9c02dbf.js';
...
const IglCalHeader = class {
    ...
    render() {
        return (h(Host, { key: 'ecc210c2700b23da0e19a1eb8df4151d83e2859b' }, h("div", { key: '2c3c814f5d1b1dd13ec089c6a59946655e1e4ed0', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, h("div", { key: '280a70ee0a33e9904045783e7c8044a6edd7eec3', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (h("ir-button", { key: '0bc3a3955a0df872e81b7018b6e796e0c212270e', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), h("ir-date-picker", { key: '7ba6e63c7c721e738bfb4773c4096fd18c91ec87', minDate: hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
