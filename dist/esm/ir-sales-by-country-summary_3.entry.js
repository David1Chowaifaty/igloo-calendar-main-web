...
import { f as formatAmount, h as hooks } from './utils-b77baf9f.js';
...
const IrSalesByCountrySummary = class {
    ...
    render() {
        ...
        return (h("div", { key: '2e343a5abae25c2fdccf5364f17ac5728a30f9c5', class: "sales-by-country-summary__container" }, h("ir-stats-card", { key: 'edb078e2d7caca77133af8029d5eb13743743cd8', cardTitle: "Total Room Nights", icon: this.getIcon(totalRoomNights, lastYearTotalRoomNights), value: totalRoomNights.toString(), subtitle: lastYearTotalRoomNights ? `Last year ${lastYearTotalRoomNights}` : undefined }), h("ir-stats-card", { key: 'fa37ad816a1698e71ed7d273081f2bdccd7cedfd', icon: this.getIcon(totalGuests, lastYearTotalGuests), cardTitle: "Total Guests", value: totalGuests.toString(), subtitle: lastYearTotalGuests ? `Last year ${lastYearTotalGuests}` : undefined }), h("ir-stats-card", { key: '0f349aa10c66e40181e7b614d5843e05fd7cc7da', icon: this.getIcon(totalRevenue, lastYearTotalRevenue), cardTitle: "Total Revenue", value: formatAmount(calendar_data.currency.symbol, totalRevenue), subtitle: lastYearTotalRevenue ? `Last year ${formatAmount(calendar_data.currency.symbol, lastYearTotalRevenue)}` : undefined })));
    }
};
...
const IrSalesFilters = class {
    ...
    render() {
        ...
        return (h("div", { key: '0981a43eaad048e681eb13ec665f83594849d17b', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, h("div", { key: 'feba3611ea67db1539e482724c25169e14f86258', class: "d-flex align-items-center justify-content-between sales-filters-header" }, h("div", { key: 'b81eae0a3a28a95ed7f98ef2332112d1a87b0b50', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'a795aaa6cbccc116ab1f0a48fd6c242cd9af74a5', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'bf103e2f67b76d97f09795b4b6834bc58b2d9ab7', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'c6342a5d421ae289d80f6a888842ec935b50cbe3', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: '5b47921a41016840d08fa1f9f89de5741b0009fe', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#salesFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "salesFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
            ...
            }, fromDate: hooks(this.filters.FROM_DATE, 'YYYY-MM-DD'), toDate: hooks(this.filters.TO_DATE, 'YYYY-MM-DD'), maxDate: hooks().format('YYYY-MM-DD'), withOverlay: false }))), h("div", { key: 'cbcf0d4dd7db7c7b1cac8370f72f9040b2822852', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, h("label", { key: '606db9fbf229440c6440d5483ad9ccabbdb285f0', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), h("ir-checkbox", { key: '2bdeb17d3bf79253ae09b63c0af5a3ba846be06d', checked: (_b = this.filters) === null || _b === void 0 ? void 0 : _b.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
