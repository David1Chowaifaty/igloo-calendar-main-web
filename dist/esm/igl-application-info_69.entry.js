...
const IrCheckbox = class {
    ...
    render() {
        return (h(Host, { key: '874f856d55421481887afe0f55f082c5460fcf72' }, h("button", { key: 'b0454ad302d60bddf4b7c4c1765e85d64302dfbb', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: '19e3cd1b0525fe9e1b55481b5c902364b127a484', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'f3c0916ff6accf9d1f3f24eca94135e80fd3714f', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (h("svg", { key: 'c925ba4840793e595f6dcbbcbde80a804876b1cc', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'e9b2bc81c3a778f401d50e6d3c0747dda1021254', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), h("input", { key: '6a78783c5b821a3f5c52c2afe2286d7a9d3de588', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (h("label", { key: '40fc8d985f6c8fb795822e83dd2db6fce10965b8', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '8c51764440d7408bef1f286709b673089bcc4f6d', class: "d-flex align-items-center" }, h("span", { key: '8dc9e2a54cd180859e10e49b8f3f0efa398c1185' }, this.dates.from_date), ' ', h("svg", { key: '455fc71a83aa44e0e7b4aedeb989976213645b47', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: '4a090d2d790f8d65e170ec3f28d608117d3d3faa', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: '9a6971a18d0a6661b1f47bbb49c2ed0eb20e4bcb' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: 'a30ade344374ed4f166381dbaded2723698d280d', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: 'e8c263191dc7bbb0555b7ef8bf3223a8d64ea086', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '9377c8fb6d26c40ddd0662a851d1c85da89b512e', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'a433e530ac17b56df55e93e6bfe82e434eb61ca9', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '2ed314b1a5b02a052c1cb66a11f504a40257e9b1', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'bbf87ab50d16fd2cf9ff4463ce7c81442d306b37', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '70eddcd5a09e53160fa3da2ef04ea4d2a9984c1e', class: `ir-alert-header` }, h("p", { key: '9a6e4305cb292f6c1dd6be6187511b4a9479dd9c' }, this.modalTitle))), h("div", { key: '4e7f55d012a565b2f3771c7079268dba503cab15', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '57205af8645831be70a1db574f0dda8b71f70dc9' }, this.modalBody)), h("div", { key: '4650105dcb7c313dd0a9baa2c8b7d9faffa36019', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (h("ir-button", { key: '706ddc120406c624102414e7501a6f7acb4cb443', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (h("ir-button", { key: '56638b015af1548b1e28b53ca114c96542fe31e6', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '96a9a1df3be0ca01e733c058631737b3df103c5a' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
