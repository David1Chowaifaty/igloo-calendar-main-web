...
async function getMyBookings(months) {
    if (!(months === null || months === void 0 ? void 0 : months.length)) {
        return [];
    }
...
function assignBooking(physicalRoom, bookingsByPool, stayStatusLookup) {
    if (!(physicalRoom === null || physicalRoom === void 0 ? void 0 : physicalRoom.length)) {
        return;
    }
    for (const room of physicalRoom) {
        const calendarCells = (room === null || room === void 0 ? void 0 : room.calendar_cell) ? Object.values(room.calendar_cell) : [];
        for (const cell of calendarCells) {
            if ((cell === null || cell === void 0 ? void 0 : cell.Is_Available) === false) {
...
function addOrUpdateBooking(cell, bookingsByPool, stayStatusLookup) {
    if (!(cell === null || cell === void 0 ? void 0 : cell.POOL) || bookingsByPool.has(cell.POOL)) {
        return;
    }
...
export { isPrivilegedUser as A, downloadFile as B, getReleaseHoursString as C, dateDifference as D, buildSplitIndex as E, getSplitRole as F, checkMealPlan as G, compareTime as H, createDateWithOffsetAndHour as I, getDaysArray as J, convertDatePrice as K, formatDate as L, findCountry as M, canCheckIn as N, handleBodyOverflow as O, validateEmail as P, toFloat as Q, renderTime as R, calculateDaysBetweenDates as a, convertDateToCustomFormat as b, checkUserAuthState as c, convertDateToTime as d, extras as e, formatAmount as f, getMyBookings as g, dateToFormattedString as h, formatLegendColors as i, calendar_dates as j, addCleaningTasks as k, formatName as l, manageAnchorSession as m, getRoomStatus as n, cleanRoom as o, addRoomForCleaning as p, transformNewBLockedRooms as q, bookingStatus as r, sleep as s, transformNewBooking as t, getPrivateNote as u, isBlockUnit as v, getNextDay as w, addTwoMonthToDate as x, convertDMYToISO as y, computeEndDate as z };

//# sourceMappingURL=utils-763db862.js.map