...
import { C as ClTxTypeCode, a as FdStatus } from './enums-DjSFmz1B.js';
...
const RelEntitySchema = libExports.enum(['TBL_BSAD', 'TBL_BSP', 'TBL_BSE']);
...
const FiscalDocumentSchema = libExports.object({
    ...
    ISSUE_HOUR: libExports.number().nullable().optional(),
    ISSUE_MINUTE: libExports.number().nullable().optional(),
