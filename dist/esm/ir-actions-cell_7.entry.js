...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: '4b1a64a01012f5aade0a78831633eb16dd2f4ae1' }, this.label && h("p", { key: 'e29bcda37df40424c7ef26132eece4a14d52db5a', class: "cell-label" }, this.label, ":"), h("div", { key: 'ecc1c0c293a8b47a51f76226c4e64aa5bb6084ec', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: '80740fdfb5004d6a7cf35c0ccbea444ae686767c' }, h("wa-tooltip", { key: 'f9819a499221958fc4806c0f72d9c90bc340966f', for: repeatGuestBadgeId }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: 'dd62a574ea9b230dc73d4532a2ac46655b5b6348', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: 'bc93bf6290151711f3048ba71e48f7c139f0f42f' }, this.totalPersons, locales.entries.Lcz_P)), this.showPrivateNoteDot && h("span", { key: 'ae32db36a6b84308167d1080ce4a8f3fbfed1586', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: 'f2c0d76d55c4556f778f4a4938e1aecd1a2d691c', class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: '578e4389f69d04418958e817ed9f69f515e62493', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: 'a377897a460cf0187f5e94083e5a13307efac905', name: "phone" })), h("a", { key: 'bafebaf2dff4c53db9eccf5e5e8f83dc2a3d5182', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: 'eb9975428cabc9db677b0375e277560d9f15add2', name: "whatsapp", family: "brands" })))), h("div", { key: '12fb4ec539abd66324eff508a4ce20aab56fc941', class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '910d2325185e31156de6c804ac7364cc36c7f9fb' }, h("wa-tooltip", { key: '8ff51c8dfb677058a5ca6938fe486e38922cefc9', for: loyaltyBadgeId }, locales.entries.Lcz_LoyaltyDiscountApplied), h("wa-icon", { key: '020d43776e7939b48fd106a8e2ab98b304e8e7ee', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: 'd6751d8cc98f37b13fc6fa4ca585be09c27d6e4d' }, h("wa-tooltip", { key: 'f2e3f04869ef079dee0926ff163f43521d3611e1', for: couponBadgeId }, locales.entries.Lcz_Coupon, ": ", this.promoKey), h("wa-icon", { key: '840b1195c36037568bc9c2a47fc1fdbf3e556f2a', id: couponBadgeId, name: "ticket" }))))));
    }
};
