import { r as registerInstance, c as createEvent, h, H as Host, F as Fragment } from './index-DCCEVrU4.js';
...
const IrBalanceCell = class {
    ...
    render() {
        return (h(Host, { key: '4e3fa9fce308699224e7056aca30c190307bb4a5' }, this.label && h("p", { key: 'e15b4040e0244408ecc2e75f5bfed7871a278f60', class: "cell-label" }, this.label, ":"), this.removeBalance && this.financial.due_amount !== 0 ? null : (h("p", { class: "ir-price", style: { fontWeight: '400' } }, formatAmount(this.currencySymbol, this.removeBalance ? 0 : this.financial.gross_total))), h("div", { key: 'b6357fdc2ddd8029ebc06ba695e4137e169a9bbd', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e0c27169f56b88436c3ac87dba270501676abbac' }, this.label && h("p", { key: 'df227ed517356522d0f690ea6571795ddbf1f5fb', class: "cell-label" }, this.label, ":"), h("div", { key: 'f25fbd0eb223b01bd3fbeb379e61568cb77dd325', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: 'fdd6b12e5ec4846acfd18bd1e3e919e10c9a31cd' }, h("wa-tooltip", { key: '0e1e080e0b12a19e086cc7066937801e0290c317', for: repeatGuestBadgeId }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: 'ca11027371b7267514adc3f65c8c979d8cc2fd26', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: 'b8eeacf3d8783d2fc05e9624da7f0c428ba5e432' }, this.totalPersons, locales.entries.Lcz_P)), this.showPrivateNoteDot && h("span", { key: '0a39ede9675df30be34fa859c8ce717d22da65fa', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: 'd10f6dfc88c6787943d32f741fe7124da3d4467e', class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: '15f098a81a57e466084805edafa4050780600c4b', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: 'a04d2f3042c6710cf230eb31c341430d4b10c94e', name: "phone" })), h("a", { key: '1fa105116bd2b9194012828ee8b857c9a8a6326a', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: 'ffe7b550ba67ec079bc605348a49acaea90bf179', name: "whatsapp", family: "brands" })))), h("div", { key: '4ec40574c2a7a765528eefd71a4bb6687da71261', class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '7ed9143a9cc26d55ffe2c1879dd03a40529c9162' }, h("wa-tooltip", { key: '992df215bfe3151a6b822003b048f954ce6e7c6c', for: loyaltyBadgeId }, locales.entries.Lcz_LoyaltyDiscountApplied), h("wa-icon", { key: '4dff743d7b19a1b228f097057696774979836339', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: 'c6635cb703280362fe3654bd39cbd4f13ee3fb3e' }, h("wa-tooltip", { key: '6b0e2261a2061d8404f4fa63b75c2827a8cd8bf6', for: couponBadgeId }, locales.entries.Lcz_Coupon, ": ", this.promoKey), h("wa-icon", { key: '4592d218a22acdd2798c2202d7db0804e08a227b', id: couponBadgeId, name: "ticket" }))))));
    }
};
