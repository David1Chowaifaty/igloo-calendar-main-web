...
const IrBalanceCell = class {
    ...
    render() {
        return (h(Host, { key: '43ff5cc0d59c084dbea7aacdc7481b1be187dc18' }, this.label && h("p", { key: 'f45ba3795ca4ac748973a8e89686243c9d26b845', class: "cell-label" }, this.label, ":"), this.removeBalance && this.financial.due_amount !== 0 ? null : (h("p", { class: "ir-price", style: { fontWeight: '400' } }, formatAmount(this.currencySymbol, this.removeBalance ? 0 : this.financial.gross_total))), h("div", { key: 'fab9adaf4596f1b2b1ce3c00f219940bc65e0368', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1d5f3061d639a34301fbd23fcdd23dbe27b2740f' }, this.label && h("p", { key: 'b0a8fa2ea27967b38dad3cd1e0ff64497a58b7af', class: "cell-label" }, this.label, ":"), h("div", { key: '1c7e7f8ba0f674adc30325fd4262a7feffa11a8e', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: '4fd91c611d75133f5863cf75b05a640a88a565e1' }, h("wa-tooltip", { key: 'b1e3bb1a3b943b672fda1bfb82bef6f0b8b50f16', for: repeatGuestBadgeId }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: '4683fca174120ba6c16bc80fe89dc2568684b3f9', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: '8eb1128d54004adc857ab9ade11a5cbfed855820' }, this.totalPersons, locales.entries.Lcz_P)), this.showPrivateNoteDot && h("span", { key: '57bd2a0b5bc23571245c70484f4c219bebc0d850', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: 'b34b276cb629dd1abf5d721429e0a06d0a1bd09e', class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: '65e487eaadb329dd7cd6ff4d87a866daf995b424', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: '767ca3966429c5da111111de0e74d0f02a414ab8', name: "phone" })), h("a", { key: '35e19c17cafac31eecb2c7e3e230fc64106c5afc', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: 'b4600c74812ed6ab0f38dcdc542e5de440d12221', name: "whatsapp", family: "brands" })))), h("div", { key: '38a6376363f40211515c3f51732696a0d17cdc02', class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '7f0c4fd0a8ffbb769a47ee6c3fdcb8dc4f7d3983' }, h("wa-tooltip", { key: '637b14e9fe1b51c40a0c2fded74faedfa8e9fcb7', for: loyaltyBadgeId }, locales.entries.Lcz_LoyaltyDiscountApplied), h("wa-icon", { key: '1ecb98e965080646a83c97ccd198397ec285230d', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: 'bc1bf37bcd3a0e19ae2f55f1ce85a1fe72a4b319' }, h("wa-tooltip", { key: 'f488744f4d48cb7e157b9410bffe29a1b6e93bd3', for: couponBadgeId }, locales.entries.Lcz_Coupon, ": ", this.promoKey), h("wa-icon", { key: '8357093e404bb7e0f65921d646316ca21c8d548f', id: couponBadgeId, name: "ticket" }))))));
    }
};
