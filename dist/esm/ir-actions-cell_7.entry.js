...
const IrBalanceCell = class {
    ...
    render() {
        return (h(Host, { key: 'f9bf3669072e27374360e369dba1705f4625f03a' }, this.label && h("p", { key: 'b600db98bbd2d38d1ebbba87a9397883c655a194', class: "cell-label" }, this.label, ":"), this.removeBalance && this.financial.due_amount !== 0 ? null : (h("p", { class: "ir-price", style: { fontWeight: '400' } }, formatAmount(this.currencySymbol, this.removeBalance ? 0 : this.financial.gross_total))), h("div", { key: 'cdab0992de8274825266f90961fc5c031d162a2b', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: '2cb5cccc45796ae48a58e1ea3232bd4ac1409649' }, this.label && h("p", { key: '54b62502fc0421620b44da1c42d330fccaf5fb5b', class: "cell-label" }, this.label, ":"), h("div", { key: 'ce887f6b01511fa3f982ba020b064ff4161f80c9', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: '5c793744d764b276749efd63fb17a1f8231d6cf4' }, h("wa-tooltip", { key: 'cbf3237c4e84746064a839e9a9d3640474393fa8', for: repeatGuestBadgeId }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: '3bbcb0ce57e71bbadefd739929b932a4cc7a40f4', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: '10fdd740904cf94a8430bf0a46dec0488f8f1eea' }, this.totalPersons, locales.entries.Lcz_P)), this.showPrivateNoteDot && h("span", { key: 'bd94300c012df6660e56495d1b2898537050f7d7', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: '4605bbe03f30a39a040506e7e6f687b69597fd0b', class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: '320cd06f261cbf8cc3cf6fb9fa3af7e61b93faa5', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: 'aabb247df1b90d1a87a7621cf0f6051671cb9381', name: "phone" })), h("a", { key: '370f7425e20b255abead8110a51cccbad4999d85', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: 'f461590b02776fb47f2be804b9139f85e63da508', name: "whatsapp", family: "brands" })))), h("div", { key: 'ee20df0587b3daf5ac362c4d16e7f62472b8328e', class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: 'bcdc0659bf64e1e89b490a244aab8224ecbc249a' }, h("wa-tooltip", { key: 'aeb97ed4e670438976884e7387198124df2972a0', for: loyaltyBadgeId }, locales.entries.Lcz_LoyaltyDiscountApplied), h("wa-icon", { key: 'd0025398233a6abca0a3f0f271f5e0fd364af438', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: '237def4b547aed28266b9d674ac70c50ba5ccf53' }, h("wa-tooltip", { key: '43ed1e5c7e61292128adbc26b8785349ed043605', for: couponBadgeId }, locales.entries.Lcz_Coupon, ": ", this.promoKey), h("wa-icon", { key: '4c6e12b19d043bae0d12a84c57783304e94c6c99', id: couponBadgeId, name: "ticket" }))))));
    }
};
