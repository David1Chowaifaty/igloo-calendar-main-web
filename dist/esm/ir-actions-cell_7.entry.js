...
const IrBalanceCell = class {
    ...
    render() {
        return (h(Host, { key: 'd53e18d396346a7c649fd5c55c135d86a580049b' }, this.label && h("p", { key: '8ffda9a20b90da2c8c8da4ceb1b63e44b9b94b74', class: "cell-label" }, this.label, ":"), this.removeBalance && this.financial.due_amount !== 0 ? null : (h("p", { class: "ir-price", style: { fontWeight: '400' } }, formatAmount(this.currencySymbol, this.removeBalance ? 0 : this.financial.gross_total))), h("div", { key: '3084a3a9d47b6392b34b674e1c72c2a9aebb0b7d', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f93b07c8c69897fe5d3863dd2f49cc4ac92cad42' }, this.label && h("p", { key: '6355a09f3e6878963d227f678027cb60ceac906b', class: "cell-label" }, this.label, ":"), h("div", { key: '376841ab1858ceeef73665c8826681129794f987', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: 'eb91fbef5a9e48f827c7ff38bb99da7d4305c811' }, h("wa-tooltip", { key: '6af9fbbb7aca7109acef0b8c2d05e066a56cfa71', for: repeatGuestBadgeId }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: '149c8ad819df5f8fd888e0d107cb9cbceed98b3a', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: '8288205e652240faf807ceb6752f05511e4bf81f' }, this.totalPersons, locales.entries.Lcz_P)), this.showPrivateNoteDot && h("span", { key: 'de72b27853b07e8a29f57fec5b4739f5293eeabb', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: '0581ebf1e3ff0f7fe261503901b4a3264d785727', class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: '626d9652d665cfe10bf539b315645bfd8d012bdf', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: 'bdda47ed9ef790a4b0d9964d5b6ba7a501e4608a', name: "phone" })), h("a", { key: 'f02a7a2746051f55f405cc50b56b9d484c822bae', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: 'e3ca7c9007ff29f29e7a8fffeae8352b977cc1a3', name: "whatsapp", family: "brands" })))), h("div", { key: '3baf294ae5b8a0a7338c6c78f660111021949bc9', class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '8d2961d921237470c9dc3da4e260e10909d91bb1' }, h("wa-tooltip", { key: 'bac4d428eeb19ec242d4ec81e7dbddf10a6a3d3f', for: loyaltyBadgeId }, locales.entries.Lcz_LoyaltyDiscountApplied), h("wa-icon", { key: 'bc31f9898fcf44f0edb1a51c62b0c939739e40c2', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: 'f1d9d53783a6ee8365186f011b3d694e69c4ba6e' }, h("wa-tooltip", { key: '4ed0f20bd4ae30deaf7b02042ee4f1c30da446f0', for: couponBadgeId }, locales.entries.Lcz_Coupon, ": ", this.promoKey), h("wa-icon", { key: 'b158121322a279b56b5dda098ac25f5dab74a588', id: couponBadgeId, name: "ticket" }))))));
    }
};
