...
const IrBalanceCell = class {
    ...
    render() {
        return (h(Host, { key: 'b95edaf294106a1a80d8a5e8dd9f1e916882dba6' }, this.label && h("p", { key: '2bce8f2e0a1dc78fe2eca20f9f5d78454cf40519', class: "cell-label" }, this.label, ":"), this.removeBalance && this.financial.due_amount !== 0 ? null : (h("p", { class: "ir-price", style: { fontWeight: '400' } }, formatAmount(this.currencySymbol, this.removeBalance ? 0 : this.financial.gross_total))), h("div", { key: '8b87bcb706b2fae3c803fb111ca6c856a962b96f', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8d2607e328d4ab50d1baf050bf6ef3054d833c25' }, this.label && h("p", { key: 'a6d5c50cc8d7afb78dcab20edfd8a3d5cd80567f', class: "cell-label" }, this.label, ":"), h("div", { key: '1850dd72ea884b7d84a6063677016ef3dcb30b5b', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: '1d34b2a6045fc441fc19abb40e7949e8c66546f3' }, h("wa-tooltip", { key: 'd319732f189e8b42acd9b21ff93a00b1442c8504', for: repeatGuestBadgeId }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: 'a92e0eafbd3f5a74d84b80cdd85d33e56af18d8e', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: 'c1ffdc79f37839150835d4b998ffe1e8b6d8c66c' }, this.totalPersons, locales.entries.Lcz_P)), this.showPrivateNoteDot && h("span", { key: '37e2c828f626ee0dd5015ebe866dfceff997b089', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: '1659a30cec999105c34af506d38f2a8990d8cd71', class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: '046dbe9b3cd238ee934fee9c35bc6a0e7c3a6a50', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: 'f0db0f6fbe8567f54e3e93fe6845c8764e536f30', name: "phone" })), h("a", { key: '77b0a701ed86afc3222028e90159fbb93efc1f19', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: '13650721019c8d9774046c9f8cf8f8ceb308e952', name: "whatsapp", family: "brands" })))), h("div", { key: '20e1547a83445dc18a1747eb9c88baf2652297e5', class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '118286571dd454d0c417e9cff8c85adbb62dd32b' }, h("wa-tooltip", { key: 'c64da9547b8a338127e8e550efac14ee7d39d520', for: loyaltyBadgeId }, locales.entries.Lcz_LoyaltyDiscountApplied), h("wa-icon", { key: '8350433d148ecaa1e5ca603fe7fb641b19649c6d', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: '8557a9508982f3aac61b0390991d5eb337572cfa' }, h("wa-tooltip", { key: '9082e2f3067aeecb2bd1cf5135f15f103f4072c9', for: couponBadgeId }, locales.entries.Lcz_Coupon, ": ", this.promoKey), h("wa-icon", { key: 'a0243204d20dd6e90ba196a3b2a19b63ad39d87b', id: couponBadgeId, name: "ticket" }))))));
    }
};
