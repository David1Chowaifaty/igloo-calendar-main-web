...
import { b as booking_store, m as modifyBookingStore, B as BookingService, c as calculateTotalRooms, r as resetReserved, a as resetBookingStore, d as reserveRooms, u as updateRoomParams, g as getVisibleInventory, e as buildPaymentTypes } from './booking.service-8d94a810.js';
import { l as locales } from './locales.store-629477c2.js';
import { i as isSingleUnit, c as calendar_data } from './calendar-data-f4e207f9.js';
import { f as formatAmount, e as extras, h as handleBodyOverflow, g as getReleaseHoursString, d as dateToFormattedString, c as calculateDaysBetweenDates, v as validateEmail, a as getPrivateNote, t as toFloat, r as renderTime, b as formatName } from './utils-b9f810f7.js';
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: 'cdaef423944e34f6429383aed591b397981a0e15' }, h("div", { key: '8c142b84afc8ccca0c36ace0ca0064abd097e546', class: 'd-flex align-items-center ' }, h("label", { key: 'a1fd5a03bc5babb7444153c8441d4b0128503e4f', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: '40b41f63857c89fc2f3a2eccf37a63ec73c9b18a', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: '83328551036fd9099bd88db213c213a71248145e', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: '4d46b969419b3f7936b4dd9a062c2913a54e2174', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: 'f4c178970ceae8135805bc149286f9f3a9afba77', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: 'fc770c0584e8b978bed2567c4177636b007e459f', class: 'sr-only' }, "clear input"), h("svg", { key: '7982d1104e65b563ef9090b6d6bf667d3b5cfbdb', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: 'eada78d4599907573ceb8cb7719733f9e6c97b98', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (h("form", { key: '2a6723bbd943aa6b11c52db9318bfd2b456bb221', class: "dropdown m-0 p-0" }, h("ir-input-text", { key: '685b579cf0f6e2f4f0338be8818fd9cd09c55ee4', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), h("div", { key: '0afb9f5db262beb6502a8eed0b6c589f52b0bfd7', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (h(Fragment, { key: '81756c630bdcc4997a4cd4fca1be0be8a187f2f6' }, h("button", { key: 'e891a2e55627eb5a538aeb3689ae2c0cdafe7c3c', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, h("img", { key: 'd8a401bef8b1e19222f9dee1b6af689a537e6e32', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), h("p", { key: '6d6412e0893d783d64700ef18ff089a74d7a957e', class: "pl-1 m-0" }, this.propertyCountry.name)), h("div", { key: '2ccbb8f96db5576c948d7c5d47faa736e05b7fb8', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && h("p", { key: 'aab18bb5ae9e101079f0e65902b55ea33d2bde8c', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (h("div", { key: 'd8a97f8c1e4652025a5d2787014c00db82b7dd7d', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && h("slot", { key: '25c9430c6bf3c98873055a46a5e976597e82e164', name: "trigger" }), h("input", { key: '156e2647605d80822d6f63160bdc25ab9dbe2a11', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: '18c735e71bf2357fc8e9d125b931eb120a1515a9' }, h("div", { key: '7b8feaf53ba35789e6008158984ec725a95862b3', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '2855896b2ad7677bba7dc65bc3857f7c30611e36', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'f031589a05b82e03dc5bca1125108c69478c4cfc', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'efc1c3991597d3d565c29781e44234425e230caa', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: 'ccb4095c2a3bb842794df41fb5efeffa5d0596a8', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '1f6e9f9807b2b9a5ff9e9d8e23b79b34bde03d10', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'fbe9dcce094cef2f4fa08d8d77401389c97a9206', name: "modal-title" })), h("div", { key: '87dd3c50d2de96eb44a1dd2769915773b3d63fd3', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '4a9c7a02fdbbfa020abb3eabd27127c56d9b0647', name: "modal-body" })), h("div", { key: 'bd48ae35e91f5f49feef3df0f45665699104d4e9', class: "modal-footer" }, h("slot", { key: '8d120de66055d69260773eed00c648a1f1a3a4a8', name: "modal-footer" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (h(Host, { key: 'e032f0d4c008641117fcbb37d9a8f6809fd0a92d', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? h("span", { innerHTML: this.html_content }) : h("slot", null)));
    }
    get el() { return getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '51c597aad60a47fa5f289e5f62eb48ed941b85e0', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: '655ce5a3767612f8e89836e630965890fbd78859', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '5167153bffd6804fab56145ce0fc5b2d460c20d1', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'a9c4c59b5350d0e776344f33f084eea3eb17864d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'cea72690ca0277f886cd0c00a23b787a45a4ee87', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '8eb100a9d4607a64a77d634e4bdea9be766c94e0', class: `ir-alert-header` }, h("p", { key: '11ebb00afdabb72904f4e478da09014e73c6d027' }, this.modalTitle))), h("div", { key: 'd45c65aa5319cb1aa3504b2b22cb6ed5841c992b', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'f9518345ee1cadf286b4181f538afcd178816ce8' }, this.modalBody)), h("div", { key: '8a8122b73a696fe1bf1343d139dd681832a19f85', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '584a2cee732ce7db5e3dae3941e5e103831d3643', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: 'ac54a254e02985e6d9978c5e581b565c5b25bff7', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '4b41ce5b23c4d675c8a8bf59f98dea9fb331a299', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'bdc827920d9aae010f9199a24dfbfe1c0a2d89a6' }, h("div", { key: '3e3277901b35f21f44efe7c5eb89082280939410', class: "form-group mr-0" }, h("div", { key: 'e4ab38d454f84256f3fc20020b83114665d4c440', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (h("div", { key: 'd90c23407d59f5c108882205271b5578c1c4bb0b', class: `input-group-prepend col-3 p-0 text-dark border-none` }, h("label", { key: 'd21ecd5318dd36f5707311b0648ccf149ab2d192', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), h("div", { key: '7f444acbf501a0a3782ca719e5593695b946aeca', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, h("button", { key: '3f4241ac8c4cdfedff452c1e4b237ee54e53ace6', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : h("p", { class: "p-0 m-0 " }, locales.entries.Lcz_Select), h("svg", { key: '3b756574879fb44cbe768d44969ba15961b886b5', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '8e9b5ade76e1654eba0a1c554bee898b6943426f', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), h("p", { key: 'd3c6b14f2ba4eae82f3c9ecba61c32db5b90ee86', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (h("label", { key: '2c6a6ea50b016f5ffadcd88915d03a3d0573a065', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), h("input", { key: '683420e1804fb2cdeff7032ac94a6497b6c03cbd', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (h("div", { key: '38aa39add8439422aa05112cd83e563d1878ebf5', class: "ir-dropdown-container" }, h("ir-combobox", { key: '63e131c880e7fe5e8547584a6812f1b7644813a3', onComboboxValueChange: e => {
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: 'b35171424c23c6faa8a2ce08609fc41bfa04a237', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: 'cdeae0ad85d036d4a84b678fc7e2e57cab80a680', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (h("div", { key: '58c2e69c7440e21c6c4ccf6042cf13f15ee51408', class: `input-group-prepend ${this.labelContainerClassname}` }, h("span", { key: '3cb0439ded1efe7a5cb716e23839559682249f01', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: 'ee7c3fd5716485332755a01a974d4aa4a14e23c6', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: '51a495216d4567b0231eca61366b708fa61a049c', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '983157a06787d9c645f6f37c525605a85499f380' }, h("span", { key: '11bd6aac448b7cd430b61359b15a64245f7230d3', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: '55d3c3fa77b6c5a007c666a0214f4ff0eb87cea6', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: '92eac6fa6e93490faa787479a5091a6c19e80929', class: "card" }, h("div", { key: '3f26739bc1f05227782b0d35ce37deff5f8a6603', class: "p-1" }, h("p", { key: 'fdc6dc43689e77f30c89236036abde550455c351' }, this.booking.property.name || ''), h("ir-label", { key: 'be557697ade21da9e1ea0174cd226e594b97709b', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: '389f42f38c7f266aa2419741a41e48a10f161cb7', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: '2ec61d11dd45273b664d4d7f5658bc7c7148adde', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: '11a259895bfbdfaa77013cfc300b963e56913d4f', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: '0c33030c3c2db8773b5704a1793edde20b91c574', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: '3f1323a4b4e806dc310069bb952eccb48362a004', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: '2e3ea49585879f2717c7f05e5cdad41e05564496', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: '43c17bda2a64bf1c589acda108e0210400c6d9bd', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: 'fe0246a6ea96f1a223c534fdaa5ab2812ad802fb', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: 'afcdb3493cc6b02b673fc3dbacfea4011f3fa76b', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: 'b118152400a57a94963135e814429d92cdeab680', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: '0e2261b5958dae961dc1a1b18e87ac5b0dac1ffa', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: '5ea13fb444e851c8169cf27dd47fae8718752a6d', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: 'b3630fbf00343934660e5f6379466efcc6a02f2e', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: 'aa4ed8fe291379d4ec0cb61769874ddb04771cca', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: '73c2443c6e73b8bb8861565a9fc802e76da620e1', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: 'e876f51b39edc88e2195f285cfbf68f8dbd47089', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: '2bb13c01917cfb3e4dcbd60b1006f9eb1debf2fd', class: "d-flex align-items-center" }, h("svg", { key: '30db84122aaf443f90ca00775a2f616b4f4cce96', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: 'c9df765e3b640933cf9ad11d393d4761313b2e02', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: '4c8a50680fb4c37dfdeecc8a8da74bce09fcb7f7', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), h("div", { key: 'd6cac42a945972b0ad4ab7892e6e12e0e5f38d23', class: "d-flex align-items-center justify-content-between" }, h("ir-label", { key: '732df9777b6b271099c1cc8d676ae7f62025054b', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("ir-button", { key: 'fa3558e458a881e6110b828e9e0475cc84a27cfb', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '3c7cf9fb737ac02c451d28940180bc637add1b75', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'a080bb94cb81f4173cfab058e49d41aad495de44', class: "input-group row m-0" }, label, h("select", { key: 'd9c804c8f3dc6877de53a560765b9e7b83013d8b', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '7545892bd849e536cee929ee366b756712c7a8b0', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: '6e92dcbc0fb61a2d6e185ad107633e866cb7413c', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: 'a3b2ba9df9b58b56412f3187e86237570b7eaace', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '59c5e7f8aa3a16df29cabab6d010827276fe5529', class: 'sidebar-title' }, h("p", { key: '6785b35c63bf644ad0283edafbc95b3ff8de6b56', class: 'p-0 m-0' }, this.label), h("div", { key: 'aee2a6efd057d0bff7ad757a77a4c163db1c6755', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '28fbfb2c12a4f404f3d2e93a6ad66e6194a14258', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: 'c9b078dcb982ef2d6cca7bcf3c4455fd4dd7f21e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: 'e4522d74b6b3ad5eae0edc487dae5b56368e46e9', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '47598f78d92ec843021d9d7925e630aebde65b9a', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '4061ed7ed2299b387954c38887c6f25314976725' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
