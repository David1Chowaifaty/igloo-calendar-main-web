...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (h("form", { key: 'cddebc99f75eaa88978b46ed6e46acff4f53b987', class: 'sheet-container', onSubmit: async (e) => {
            ...
            } }, h("input", { key: '0d7b12fb8a5a52737846d4a69d58f328b2b379e5', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), h("div", { key: '5132d5362c57f6db65fd737bba10ec86d22c3254' }, h("ir-price-input", { key: 'ad1d88527fc099262619af2cf46bbd280983d03b', containerClassname: "row", labelContainerClassname: "col-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), h("div", { key: 'bf4b76c3e7ec10afc2023193047780388e4aff4d' }, h("ir-dropdown", { key: '0e34808154505ac8854c606191f6e222301a8f7c', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, onOptionChange: this.handleDropdownChange.bind(this) }, h("div", { key: '5e440a36eb736e8fbd869c0a6f50455b18ce9a27', slot: "trigger", class: 'input-group row m-0 ' }, h("div", { key: '8eb9bd23929543aef0dbb2ef85e7c13325fb0d0b', class: `input-group-prepend col-3 p-0 text-dark border-0` }, h("label", { key: 'a78205cdad559013d3df58d22550009d321c64fc', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), h("button", { key: 'b9daac00fddc2fb3b392f32a25fd67850a4253d4', type: "button", class: `form-control  d-flex align-items-center cursor-pointer ${((_p = this.errors) === null || _p === void 0 ? void 0 : _p.designation) && !((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.designation) ? 'border-danger' : ''}` }, ((_r = this.folioData) === null || _r === void 0 ? void 0 : _r.payment_type) ? h("span", null, (_s = this.folioData.payment_type) === null || _s === void 0 ? void 0 : _s.description) : h("span", null, "Select..."))), h("ir-dropdown-item", { key: '6f01cb9178334f1853187999513a1e85a5499359', value: "" }, "Select..."), this.renderDropdownItems())), h("div", { key: '6ef14f2d1ab8f821fecab101ad4d7101b769838f' }, h("ir-input-text", { key: 'aedc0dd346c3363ea9d500eb25a102f83b7fac65', value: (_t = this.folioData) === null || _t === void 0 ? void 0 : _t.reference, error: (_u = this.errors) === null || _u === void 0 ? void 0 : _u.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3 }))), h("div", { key: '6e0858ad8e76db19dbd68878f939ef34de7e15bc', class: 'sheet-footer' }, h("ir-button", { key: 'caeb403f14cce2f4fd08488044b4e2f109b5b0da', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), h("ir-button", { key: '0ff67ed286e524caa67e5a058baf61d785a3efea', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
