...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: 'c6ef1e5813ff393117dcb4fffcf3557b478de464' }, h("div", { key: '7235bed1d2ea85fd03221ed4be6aa69408ac6ca6', class: 'd-flex align-items-center ' }, h("label", { key: '054726758e7e12252559283d8e4f09805d737589', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, h("svg", { key: '4b0d5991a08a3fce2e42de1642c475d26f4af333', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, h("path", { key: 'f6fd8bff049a35a9402041c5e9ea0340cd7c0d29', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), h("input", { key: 'bd734a825271fed11c8711eddd2793f332788b49', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (h("button", { key: 'c6773ec48664c4b626feda03292d42231fb3452c', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, h("p", { key: '54b58ff4f8304a4609607a999ad156a388fabc8a', class: 'sr-only' }, "clear input"), h("svg", { key: 'a09d7016c8929525cff3d2ea5f777e24169ae2c0', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, h("path", { key: '0b18b06643a3ece16cfa1ff5d000336b220e0eb5', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (h("form", { key: 'f25aa293e2acdd1ac5975b7c456e139ae818c484', class: "dropdown m-0 p-0" }, h("ir-input-text", { key: '09de5291a87b35f090613877e798cb0adebbe393', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), h("div", { key: 'd6136ac0448b18e6b241afd7f368d60c5eb434e2', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (h(Fragment, { key: '90fcbc555eee52e69811c245a0adb38826c9bb45' }, h("button", { key: 'b37a2475cdeeabaf578924eae6784ec81a1c3af1', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, h("img", { key: 'c6dcdf4d47a253bfb37bdba32d9473733eb89821', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), h("p", { key: '60abba75aeea01fcf9660f471f36926c8eea53ae', class: "pl-1 m-0" }, this.propertyCountry.name)), h("div", { key: '26ffb7c1e52406679fe0c6571624b200fce6b02a', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && h("p", { key: '674e3573b1a66beba8f9bf669aaa30e161fc459d', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (h("div", { key: '9a78dc365c97ebc3cc5c62d74dc9a4318107eefa', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && h("slot", { key: '2cc7efe36d779418234df88d4b0d2ec790033d3c', name: "trigger" }), h("input", { key: '0c32912fff9d1cae4283afb46f960d8b493b08e5', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (h(Host, { key: '69d1535d245fbfefa8768f6f6272237fabce104b' }, h("input", { key: '698174ac5c1384b5871a1a2a92742321abf073c5', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (h(Host, { key: '84150891d06f3161ef1b40166ede9c075d8b2c0a', class: "d-flex align-items-center" }, h("span", { key: '41008cad19deda418ec32575eae44db7c46e6d75' }, this.dates.from_date), ' ', h("svg", { key: '53924989a32d6559ce7c829be6d8e16c9cb55892', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, h("path", { key: 'a4030e21362a14da758cd82a6925f5d8477cf8cd', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), h("span", { key: 'd227cc987899b26265c3dd9a5a937dc8f4c68cba' }, this.dates.to_date, ' ', this.showDateDifference && (h("span", { key: '5c87d1ca963a90a39caeeab2e24906737cad4460', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales.entries.Lcz_Nights}` : ` ${locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h(Host, { key: 'e8c811cd4ff3a8d4882e23c8476aa2264a9a050a' }, h("div", { key: '343383051b6f8916132d825a6ac594456811d3b0', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '38caa473f3d6029727318277b239eacb50385aa3', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'b479cb7794b3214520554329345249b2bf9ab529', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '151243b421f95ee22461dfd78a58f94b57a1e954', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '9c447894f44da16c460b5e67389e88bcedb20fc4', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '71da6e1dde2897e88b0f3ea5e8abcd8cf36ec537', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '821ca344f8347fbccd77fe812733fc6a5df207f7', name: "modal-title" })), h("div", { key: '57126b49ad762d396c98d8e2c25931258364b3fd', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'f85e2df47699bd3e41c3742247063612fc14cfc2', name: "modal-body" })), h("div", { key: '555d22942d5b5b03ee7446dbdcdfb7d77dc9a52c', class: "modal-footer" }, h("slot", { key: 'e69b23fab0f3c50b88b837dac94ae95094c0e39f', name: "modal-footer" }))))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (h(Host, { key: '7f3a76e5db69cbfaeddab37c4a8fdfc94adc6920', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? h("span", { innerHTML: this.html_content }) : h("slot", null)));
    }
    get el() { return getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: 'f341c8bc45c470e6f3edb41bba152ea2ef6db7ba', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: 'e875fcb4f4940f1117bb26e5c7263036314f3833', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '9ee5a6d5e89b283e3aa62114afdb1470405a6f83' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: '575e060039864de991d5a76850525c098a32aa4a', class: "loadingScreenContainer" }, h("div", { key: 'e914510cba49f745f8af3a97e96162cf3760dfec', class: "loaderContainer" }, h("span", { key: 'eb515bf22a48fd368aa3c03375a9dfd57c5e7e46', class: "page-loader" })))), this.showModal && (h("ir-otp-modal", { key: 'a4d9b5e95e3998a656ce577bf45905cfb7b8790b', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'fa2850901fde90d95cb8770ad274ef227e046834', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'd9b474f029bcada56e31d89e1291709539066871', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'ef95a8d2dab23ea20ac59efbaf1ff70e44e6d02a', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'ca20053dd4eac764145c3ee792ef28dc226d4dad', class: `ir-alert-header` }, h("p", { key: '0820cc1444f58001f2f58b777b94fc75543234c6' }, this.modalTitle))), h("div", { key: 'a20b9cba7776489e5b8be44499fe5bd34b621315', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '47ace60b97318f29ed8e8100bab2b88e803833c1' }, this.modalBody)), h("div", { key: '80c3a624c014f4ec598ac9e27714e4ee5ce34ae1', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: 'fb8b5b398464957894c4490539b093f01933787c', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: '92133d378341e9d45f1b73363bc7b5bb743ae8eb', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: 'bf4953f7acdfefb77b080b93628cbe13e3391562', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: 'd6569058a919a117493ea1c66d03810214f851b9', class: "otp-input-container" }, h("div", { key: 'ad1f3a03d7a87008a57729540053456b12938399', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (h("form", { key: 'cddebc99f75eaa88978b46ed6e46acff4f53b987', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, h("ir-title", { key: 'c68011576d06d59f4b1c127b83424a7cc42b7169', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: this.mode === 'edit' ? 'Edit Folio Entry' : 'New Folio Entry', displayContext: "sidebar" }), h("section", { key: '3e2809073eb77709ca0c86784f15c736cf3e35a2', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, h("div", { key: 'c729caf80da683285c3fc412edb5fe6b9fa130ee', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, h("div", { key: '5f8249ea60102abeb073dcca4ca8450e89f3cb2a', class: "form-group  mb-0 flex-grow-1" }, h("div", { key: 'e667ee091158c039e66a0b89e6564e2b4e050836', class: "input-group row m-0 flex-grow-1" }, h("div", { key: 'b1529b0108271c875c0d815eb5ec6a577034c9e5', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, h("label", { key: '7a0eb13bb4fc67a0b77978f211e18e605d8e4d83', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), h("div", { key: '1a4efaf775a5f5f9cb28fc779c935cd48d4dcbd4', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, h("style", { key: '925853719cddd2fdec3fc635bb8133e662cf2645' }, `.ir-date-picker-trigger{
                    width:100%;}`), h("ir-date-picker", { key: '481e2f2d3f5d4a40127900733f9f925ec76a80ff', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, maxDate: hooks().format('YYYY-MM-DD'), "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, h("input", { key: '2dd176106a4ee5d16aac306651ac3a7c2170b652', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), h("div", { key: '58240ab596f11ceaff615dfd22feb678a9fb60e5' }, h("ir-price-input", { key: '7b50813caca9db6d57a9206b0900e407244d3b97', containerClassname: "row", labelContainerClassname: "col-4 col-md-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), h("div", { key: '1c5ecd8dcd9f97df855005d3d3d8681abbfed496' }, h("ir-dropdown", { key: 'c121920b952af2cb562474639665e41518e65c0d', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, onOptionChange: this.handleDropdownChange.bind(this) }, h("div", { key: '745ea7587dc444a689263c218fa691764108d515', slot: "trigger", class: 'input-group row m-0 ' }, h("div", { key: '78ea84544a6707f77d8b64caf5d80584d91bc302', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, h("label", { key: '2afca90711a5b295aaecddd5026abb2d55fc448e', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), h("button", { key: '10c49427b5388219eeebabc699a0a7323445f39f', type: "button", class: `form-control  d-flex align-items-center cursor-pointer ${((_p = this.errors) === null || _p === void 0 ? void 0 : _p.designation) && !((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.designation) ? 'border-danger' : ''}` }, ((_r = this.folioData) === null || _r === void 0 ? void 0 : _r.payment_type) ? h("span", null, (_s = this.folioData.payment_type) === null || _s === void 0 ? void 0 : _s.description) : h("span", null, "Select..."))), h("ir-dropdown-item", { key: '712927a61fe1f54753baa95b1b621952daffcd99', value: "" }, "Select..."), this.renderDropdownItems())), h("div", { key: 'a0a7cc825d4434f628eeba61f6ee1e9c46712be1' }, h("ir-input-text", { key: 'edddd301625df41f9b1d95df2cfb2c98089f147c', value: (_t = this.folioData) === null || _t === void 0 ? void 0 : _t.reference, error: (_u = this.errors) === null || _u === void 0 ? void 0 : _u.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3, labelContainerClassname: 'col-4 col-md-3' }))), h("div", { key: '1cfa5b94532f05a1906272ab7ad45269ab424327', class: 'sheet-footer' }, h("ir-button", { key: 'f9789fcf98a546fab028a459f30cc4782455ac2c', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), h("ir-button", { key: '21bc156988f0968dff231ecce1b47df4c9a567bd', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (h(Host, { key: '6a251ce2b05af1a4f729d50dc579d7e29d4715e2', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (h("fieldset", { key: '230ef194ca4a66d4d0455b7ee4c045e6c2c71a72', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (h("div", { key: 'f03261d136d178bdd03888a878a3ec7a27a46dec', class: `input-group-prepend ${this.labelContainerClassname}` }, h("span", { key: '35657deb0d0a83551a3266059ac758321d69a571', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: '21af7d1de4598290b13b543929822bcbe6d7eb27', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: '90ed5cbca4282f03d766a5cd14c0d9c03c6fba78', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: '833cbb93990b540357da0404f678dfab16a98f6e' }, h("span", { key: 'a86ef8b22ffdb3b09b34a896621807cacb875cd8', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: '38da6b5fc4a24c8639565f20bda89ea6930837f5', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (h("div", { key: '85041b61d86fc61d7a7a38c9f64abb28ef198308', class: "card" }, h("div", { key: '18807a918a74f34c69cd6c4184f0844aa8b4c0e7', class: "p-1" }, h("p", { key: 'f33821cf53646fe75960361faa1fb9588ca9d050' }, this.booking.property.name || ''), h("ir-label", { key: '1f65bb5fa5f45006d1d63b3ba17c23249bb5fe94', labelText: `${locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), h("ir-label", { key: 'b9a687f57413841c030281b683d127e8a0a38f7d', renderContentAsHtml: true, labelText: `${locales.entries.Lcz_BookedOn}:`, content: `${_formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${_formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), h("ir-label", { key: '83d53e1d9aac54671a9cfcf350f58e77c46966f8', labelText: `${locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (h("div", { key: '1cdaa124e4b3e2f89037057ca25f52abb581ce8a', class: 'm-0 p-0', slot: "prefix" }, h("ir-tooltip", { key: '2b2f413b0e0c7f160be4be6584481c1c3750196b', message: `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, h("div", { key: 'b2b8c829f80c90a6cdbb64df04f22f48c2e22037', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, h("p", { key: '617ad7fd2ea113882803bee4e1321bd60deaa5a5', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), h("ir-icons", { key: 'b4fa57d7e5546b0af5ca762d485d536e389c655d', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), h("ir-button", { key: '03efe48088d747612cb39316d4e6bc91039a466b', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && h("ir-label", { key: '5a36168822674c97703a3bd22d0044699933f705', labelText: `${locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && h("ir-label", { key: 'dd48897be90a08b331ed43ea0804b62097fb7d57', labelText: `${locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && h("ir-label", { key: '14e7470475aa03a7a4857c91106d41693e4c8bb1', labelText: `${locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && h("ir-label", { key: '53d2fd2c4d00d09b3151d0364e7f19dd7ee4864f', labelText: `${locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (h("ir-label", { key: '4bce977e70ce6b618ccce71cbe604ae0e1fd8f41', labelText: `${locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && h("ir-label", { key: '6a45d8818d0620ea1fa34e89d0b935073de219ca', display: "inline", labelText: `${locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && h("ir-label", { key: '1c028c3f719592968ec753a139d5d52160751877', labelText: `${locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && h("ir-label", { key: 'ab55d8f12969083f5e04194e1762879c6b2ff486', labelText: `${locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (h("div", { key: '9b7f880b122ad2e579bbdad838dcae7b82c590a9', class: "d-flex align-items-center" }, h("svg", { key: '9641c607c326a543e18582d7e438d3e67094e8e8', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '1b4ca663ce446d29b2a534d41fa280b4ca5be4ab', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), h("p", { key: '5cb2740b1b60627610139616ae38a02b15f0d644', class: "m-0 p-0 ml-1" }, locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (h("ir-label", { labelText: `${locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (h("ota-label", { class: 'm-0 p-0', label: `${locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), h("div", { key: 'd45967c13004eeb0acde1b4c4726d2365a66cea1', class: "d-flex align-items-center justify-content-between" }, h("ir-label", { key: '846a47498fa11ee7da88c91c4753ff8d35567e63', labelText: `${locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), h("ir-button", { key: '0323e274e697487c1c1aed06b75e45d4fb3f2663', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '93a2e7c5def14bb987d49194e0769f71c8646a59', class: "p-1 d-flex m-0" }, h("ir-button", { key: '585e241ec7e14b6e17b228ab8ddb4fe15dd898d1', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: 'ab5aad30a3be4b892f2c16ebabafbe703597a554', class: "flex-fill m-0 " }, h("div", { key: '9de446ee522357cf688d56452f9c22af4d3777ae', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '3b57d36564adf831ed34758b846fe5dacf534ad5', class: "m-0 p-0" }, h("span", { key: '610e63ed4f84491a62ebbcd690165386681aeb4a', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '7143913109abbea17f4b3ab2178b24784d306135', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: '643fdfd66624e9fdc09cb87cb21d3dba822c22d5', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: 'fd63e9cdba2b7ba0b9b6952437cdf72ac74b1558', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '840936a81c2ba6f6882748ded922cda7c5a846ca', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: '221323f5ec21387b78b8c7b77cc19ed1fc004780', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: 'c801681ef65e2e7a5adcbe91674630187bd90a05', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: '3f63ae379cf875318eeb28d1625052d8aced9159', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: '3a246a6cc0ead0b0f9d590309c1232b133ada97d', message: this.room.unit.name, customSlot: true }, h("span", { key: '783bba81a90e989655d457c3d8c74f15a08165f3', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: 'b25621138c9e6baae7da2f6ccf1d349f14ab36af', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: 'dcd4bd742879916fa97ea2a5dd417223455cc0ba', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: '468e55c60ef561c5d95daa66df2f11dc9649c146', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '0d6bd1d67766ff8a6e4497b9fe11049003004603', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: '753d6ee7b66b3e4776cdd3ea8bd83b506b0a03b2', class: "m-0 p-0" }, "(", bed, ")")), h("div", { key: 'ba8cbd8f6c84b673fb69c5d91ac1cbf11e0ba0e3', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, h("p", { key: '3552f3cf3c08f85511d970a13ac236fd36f867be', class: "m-0 p-0" }, "Expected departure time:"), h("ir-select", { key: '6c54f9505607d2bffcd12d7e3d2d01511986116e', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), h("div", { key: 'e0845dbf7505327c1f1e1f97a7af029c21c6e4b8', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, h("div", { key: 'dde3986e96dc1bdfcdf6b844e228f1a43bb5d159', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '0e3af9fcca243330a74cc11a29178ae8439f5a29', class: " sm-padding-top" }, h("p", { key: 'e33c22fcc449fffbfd9b42ec8d9fad984fbd1237', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '30e72e3f314de2ec6af4f0c2d7e7b2f68f98f3cc', class: 'flex-fill' }, h("table", { key: 'b42a91afd284035d9c306c525e104e619fbd099c' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '234038abec5323fb68997d76a6969948069ae7c4', class: '' }, h("th", { key: 'f1a21fc2fd90fd96e465e9c49ba2cdb30cfa1436', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '8ee1e7dd1628714c095671414b9d2ca66735faac', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: '319129e76e4ee3b5a363e425911ee6a05ecc3648', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '3d7488164ae8b7476504cec1cd5cfcb8292f149c', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: '833240699a77ad00e9572ac3bab1d1fc1db7e5bf' }, this.room.rateplan.cancelation && (h("ir-label", { key: '7cca10f74aa30594a242e2990c58a1d3ff3812f1', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '841b2f8466314bd9ccb252b28bd2b24c3ffdca4d', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '5cd8e37a734a42ef165e398b9e43fb829e447fc9' }, h("ir-label", { key: 'edcaa41936ad6c5f6ee5f4db829aeb521423b340', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '02874240b26a7b10b361b668ada00e71ea6fa5c6', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), h("ir-modal", { key: '5ddde64f0f04fd554f6f29a8e9b22cd5201b8f6d', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '25cdff25a4281c8da865326d960c57203b26edeb', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '8489cb0d777ff5ec2afc8b1bc4a8b0018a1ec06f', class: "input-group row m-0" }, label, h("select", { key: 'c6539ec727fb0cd7521f0e218caa40daf7c21184', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '301fb41397a06deda7bdb75ae64297266f9cb33b', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            h("div", { key: 'e052046b60b74ce6eeb348845c327804c5655d20', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            h("div", { key: '268dede93fa16e7008f99f0ab4de983573fde8ce', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (h("div", { key: '0273dd7db5db6c9a68c2a6cd787dffc6c0852d04', class: 'sidebar-title' }, h("p", { key: 'ee7e64f2d4b7d805b56ac1b3000d137c45a1b9ce', class: 'p-0 m-0' }, this.label), h("div", { key: 'c12d56c210080777937f3c7906c5bd0371e603a7', class: 'p-0 m-0 sidebar-icon-container' }, h("ir-icon", { key: '288a89a72b78dccb480ec47fb5fcf08708055151', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, h("svg", { key: '47655bc69fcfff0582acddca5a710fc6592b5d04', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '4e40d7d273db696890829b58f5c53b280fabaa0c', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), h("slot", { key: '077ae37bcfbb05f0e42234ddbeee72c8fe41980e', name: "sidebar-body" })),
        ];
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '193e003b0b61d788378f2f931fe8b424c0ebf3c4' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (h(Host, { key: '75a93b80e770304e1599d08ca4793efa505a0e0b' }, h("h4", { key: 'a5f0ee63000e53f8cbfe23160f3f589cbaa2e372', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (h("ir-icon", { key: 'bd994de7b32306be120228dedbf1c11b3b7ae905', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '3c1538e518be31d308ab8ef0566abd3fec455724', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '5952d3570e3f9f374cd2161e7dc5762094b519da', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (h("div", { key: '846f960af192d47ffcd452dd0e855fdbd6429f73', class: 'title-body' }, h("slot", { key: 'a99ab1f571d07408827fa1fac69129321a9125b8', name: "title-body" })))));
    }
    get el() { return getElement(this); }
    static get watchers() { return {
