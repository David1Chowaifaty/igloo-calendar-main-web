...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (h("header", { key: '4e5518cc7bd8c9d615e3f5db96d418e4950f6a55', class: "tasks-header" }, h("div", { key: 'b0d4e1eb11cffd11d72559fa46fc00149846dfb7', class: "tasks-header__inner" }, h("div", { key: 'b2efe54f1b9fbe187a026bec0fe67c788636314d', class: "tasks-header__brand" }, h("img", { key: '1e567e5d78c344710ed0b5736c590e5da2a816aa', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), h("span", { key: '3f98d83c7e0cd50178c7efd58eb1bc71ca509d1a', class: "tasks-header__name" }, this.connectedHK.NAME)), h("div", { key: 'd252302bdba8b91d25c7a4ba4fc6bdecea6e8ea3', class: "tasks-header__actions" }, h("wa-select", { key: '49bd8deb8e5fe8ccef2f802709c9c75127befb87', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), h("ir-custom-button", { key: 'e65b23d80425d8cff9084b13cf3e7be3fcbe8466', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, h("wa-icon", { key: '9866e3c006c4afad83eb095ade5a91a67017f775', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
