...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (h("header", { key: '0c47446c57db00114729c0146ea8f94db3f16143', class: "tasks-header" }, h("div", { key: '00d78b73ec8098da7820fa0ad8639e5a39efd5c8', class: "tasks-header__inner" }, h("div", { key: '4d8528dc9b2438ca493327f031f572963140e1d9', class: "tasks-header__brand" }, h("img", { key: 'c358c94a4be5fa59ca7428665e4eff05f6c5ea3e', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), h("span", { key: '2a547b86093d004e1c0111cb3c4ed627e96418f8', class: "tasks-header__name" }, this.connectedHK.NAME)), h("div", { key: 'd5ea3f6e376a20a57851f9680edca02f89c5f4de', class: "tasks-header__actions" }, h("wa-select", { key: '1d197f255ae9fba073e963daf9455ec5faaa6a3c', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), h("ir-custom-button", { key: 'da3c4efa0048561bd4a9ea88936bad210b33bbeb', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, h("wa-icon", { key: '1398e70b97076e240b019a7621edebd6c34233ce', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
