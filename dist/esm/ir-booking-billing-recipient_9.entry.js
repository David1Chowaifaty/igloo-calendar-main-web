...
import { l as buildSplitIndex, c as calculateDaysBetweenDates } from './booking-41933335.js';
...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (h(Host, { key: '6368cdd1424715e18eb79e80f6695e5e364b6b60' }, h("wa-radio-group", { key: '1c1d88882045ecd887d25f83a0f181885474b85a', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, h("wa-radio", { key: '02d8235b900a6dcfb4fd7cdde1f0ee57ecad175e', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (h("wa-radio", { key: 'd098487f57dab0c369c50080f56c51591fe1084d', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), h("ir-booking-company-dialog", { key: '9961fe2b14d0f5fb1b0fc146d0b6c0d1efa16194', onCompanyFormClosed: () => {
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (h("form", { key: 'c2c0c8f8b95d7d300a931ae5d6ad8ec752b0295e', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, h("ir-input", { key: '97584ca4175e56a8e39fd63e01f97b43e50be4ae', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), h("ir-input", { key: '4d74f8584205d8e11a8006395f24568464062404', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (h("section", { key: '806d440e00db6ebb93a94bb5b71d910030966af0', class: "ir-print-extra-services" }, h("h3", { key: '651011fc187f176864907f7d9293a0bdb478a29d', class: "ir-print-extra-services__title" }, "Extra services"), h("div", { key: 'fc498f258c21c94cb8ef956c66707e7bfe57060c', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
