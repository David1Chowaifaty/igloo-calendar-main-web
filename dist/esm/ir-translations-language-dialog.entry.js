...
const IrTranslationsLanguageDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: 'ed57c80d69cfe8a12406f274c48f3764a1c7025e', label: "Languages", ref: el => (this.dialogRef = el), onIrDialogHide: () => this.closeDialog.emit() }, h("div", { key: '89aed76fccf61ab139c9df1b5dadaec2dac94672', class: "language-dialog__body" }, this.languages.length === 0 ? (h("ir-empty-state", { message: "No languages shown. Add one below." })) : (h("ul", { class: "language-dialog__list" }, this.languages.map(language => this.renderLanguageRow(language)))), h("div", { key: '2a3ae8506210947aeacc0f16422d8ae342a0a3f9', class: "language-dialog__add" }, availableLanguages.length === 0 ? (h("p", { class: "language-dialog__hint" }, "All exposed languages are shown.")) : (h(Fragment, null, h("h3", { class: "language-dialog__add-title" }, "Show a language"), h("div", { class: "language-dialog__add-row" }, h("wa-select", { label: "Language", size: "s", class: "language-dialog__select", value: this.pendingCode, onchange: (e) => (this.pendingCode = e.target.value) }, availableLanguages.map(language => (h("wa-option", { key: language.code, value: language.code }, language.name, " (", language.code.toUpperCase(), ")")))), h("ir-custom-button", { appearance: "filled", variant: "brand", disabled: !this.pendingCode, onClickHandler: this.handleAdd }, "Add")))))), h("div", { key: '49c0cc6ee4dae23d5533beb4f4acf9c307ab2c8e', slot: "footer", class: "language-dialog__footer" }, h("ir-custom-button", { key: '280cc3010eb9017661ab4581dd675b96371014b0', appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog.emit() }, "Done"))));
    }
