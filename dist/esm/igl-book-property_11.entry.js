...
import { d as dateToFormattedString, k as getReleaseHoursString, o as formatAmount, u as renderTime } from './utils-6e2dd91f.js';
import { t as transformNewBLockedRooms, g as getPrivateNote, f as formatName } from './booking-2b88fc10.js';
...
const IrSpinner = class {
    ...
    render() {
        return h(Host, { key: '5e8ea39009f06af4a71b9a4bb047197cc23a7132' });
    }
    get el() { return getElement(this); }
    static get watchers() { return {
...
const IrTextArea = class {
    ...
    disconnectedCallback() { }
    render() {
        return (h("div", { key: '884931e2f40b0f42e396764f383d863a837c57fb', class: 'form-group' }, h("label", { key: '378d303e68da3ded31e66b0fbad5d0b9262671a3' }, this.label), h("textarea", { key: '7bfa146049c4a4a111ad5b4abfac0f59af15ff0c', maxLength: this.maxLength, rows: this.rows, value: this.value, class: `form-control ${this.textareaClassname} ${this.error ? 'border-danger' : ''}`, placeholder: this.placeholder, onInput: e => this.textChange.emit(e.target.value) })));
    }
    static get watchers() { return {
...
export { IglBookProperty as igl_book_property, IrBookingExtraNote as ir_booking_extra_note, IrDialog as ir_dialog, GuestInfo as ir_guest_info, IrLabel as ir_label, IrPaymentDetails as ir_payment_details, IrPickup as ir_pickup, IrPickupView as ir_pickup_view, IrRoom as ir_room, IrSpinner as ir_spinner, IrTextArea as ir_textarea };

//# sourceMappingURL=igl-book-property_11.entry.js.map