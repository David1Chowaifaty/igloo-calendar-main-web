...
import { B as BookingService, d as resetBookingStore } from './booking.service-ca1d4bf1.js';
import { F as isBlockUnit, x as calendar_dates, c as calculateDaysBetweenDates, C as transformNewBooking, L as checkMealPlan, b as buildSplitIndex, M as getSplitRole, f as formatAmount, N as compareTime, O as createDateWithOffsetAndHour, P as isWeekend, d as dateToFormattedString, Q as getDaysArray, R as convertDatePrice, S as formatDate } from './utils-3047c015.js';
import { h as hooks } from './moment-ab846cee.js';
import { E as EventsService } from './events.service-3e86882a.js';
...
import { T as ToBeAssignedService } from './toBeAssigned.service-47d8a1f0.js';
import { h as handleUnAssignedDatesChange, g as getUnassignedDates } from './unassigned_dates.store-268b1dda.js';
import { P as PropertyService } from './property.service-194d6339.js';
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8b3a39d351a71db44773635f391cf9c542c1c777', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, h("div", { key: 'aec075457aa7816902d855982b2e443114dd2f78', class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && h("wa-tooltip", { key: '3d76783243f957a192ef8c3d58c395b8e978c8c4', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && h("wa-tooltip", { key: 'a11522018d271d356db7f2fca02ea0d9cbe03bd4', for: balance }, "Balance: ", formatAmount(calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (h("div", { key: 'f2661ecb2aed925e7aeca493fffe6277c26f8c69', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && h("div", { key: '72c4c95d609b0b77bf6fcb74ca93f78b4255aa3a', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), h("div", { key: '2a0b960661230a4d56b5a68463e0c5a7ef55b1af', class: "bookingEventTitle", style: { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), h(Fragment, { key: '5f3f1a3f90a46c3aa2bdd2ff7cfe5e479596e4b2' }, h("div", { key: '51521c233d11256fcc47c82be5985d6ed5c33348', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), h("div", { key: '6484840c60680a053fe1591daa57a8f4b3b66396', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (h("form", { key: '4af03846c259ad1f09ecda894ca093e9715718aa', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("div", { key: 'cf63b1cc36b2f6e772ac5226bc11bd299201b1a0', class: "sheet-body px-1" }, h("div", { key: '81444c97b98120ea68ddf625dd63cafc676d4c4f', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, h("p", { key: '10a2bf0d09cfcdc5251d8a49188a8e2de643f963', class: "m-0 p-0" }, "Select the unit to"), h("ir-select", { key: 'a35ec1a1a041e54984acc59361dce3764b62cdcc', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), h("div", { key: 'acc966037bd32f839e674de7551c7100bb49e38d' }, this.errors === 'rooms' && (h("p", { key: 'c012b4133d00e31cef52abcdaacac5e30521f63c', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("ul", { key: '355cbf10aa1f0247106edd966ef628bab4dd379e', class: "room-type-list", ref: el => (this.unitSections = el) }, calendar_data.roomsInfo.map(roomType => {
        ...
        }))), h("table", { key: 'fc26e937bf8770397c1ffdbdbf2886ff57417968', class: "mt-1", ref: el => (this.datesSections = el) }, h("thead", { key: '8604ad6d7090af6c9bcbfcfbb55617e6d5cdbf99' }, h("tr", { key: '7b9d34bf6a7add7fd631557eeff3f21dbcb64400' }, h("th", { key: 'e2f46f2574f967c94c8990318906af965b7bcb58', class: "text-left" }, locales.entries.Lcz_From), h("th", { key: '08546aca927101bce31cadabd3e38de319534301', class: "text-left" }, locales.entries.Lcz_ToExclusive), h("td", { key: '75aae070e37a141f7182306e8e19bc7c2eb3c2f8' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (h("ir-button", { key: '49870deeef7e97fe2f4b037d8eb4ceb20cc24216', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), h("tbody", { key: '47e3437f286091c17218c971d4aa52c6c796646a' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), h("div", { key: '68fe1535f40fd1df0ac0c1778c25774f9cd28d20', class: 'sheet-footer' }, h("ir-button", { key: '64c879313ac5f8f904612dd86ff7363d71aaf9a9', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: '5006708ac3d8e44521c5cef92f8c3ca5677e7b69', isLoading: this.isLoading, text: locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        return (h("div", { key: '3529749e792f2dd8bf9e3cf19bc6e1f942078480', class: 'bulk-operations-sheet-container' }, h("div", { key: '21bdeeadfbfe804770f3616a47c98b4b3aed3e13', class: "sheet-header d-flex align-items-center" }, h("ir-title", { key: 'bb6063f3ab5d3c7627ee5590e65b4f77a4455c6b', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), h("ir-tabs", { key: '24f8e9968ea4923c96fdd971b3026956376aaace', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), this.selectedTab?.id === 'stop-sale' ? (h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
...
const IglCalFooter = class {
    ...
    render() {
        return (h(Host, { key: '501f89d336ee15efe4eef99a3d7b8c9f9078b8e7', class: "footerContainer" }, h("div", { key: '44ca2aa6e427a0af9e4bf5839e77b74bed821df6', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, h("button", { key: '9bbe1b2f1cad4227e637af1ac8f917dab37b8b1d', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), h("span", { key: 'cf4c5d6a8a9babdd4a6aadee457221c95845e618' }, locales.entries.Lcz_Legend), h("span", { key: 'e26259ad7a740118ff2cfc4a59354f93f30f4f81' }, "v1.05"), h("ir-new-badge", { key: '9a36e117e32bbe83719365312e155567ebc73df3', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (h("div", { class: "footerCell align-items-center" }, h("div", { class: {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: 'efa3e248e996ab9954234c051b4a9f6328e446cd', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (h(Fragment, { key: '07faf0421cf2fdc540210f984531bd46c20b7c21' }, h("div", { key: 'dcc9a62aa56692ef8805b146e68e8e879a836ac4', class: "dialog-body" }, h("p", { key: 'cb904f286728352b9a39ef6913e0103a010cec97', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        h("wa-select", { key: '2b0800b8f27fed6dafbc091a41b781d7b74e1134', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, h("wa-option", { key: '449ab6c16698044e45ee92d27577745d575f16ea', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (h("wa-option", { key: option.value, value: option.value }, option.text)))))), h("div", { key: 'aa4dcbceb6c5e04be71f67e77a367a4e83248b27', class: "dialog-footer", slot: "footer" }, h("ir-custom-button", { key: '5fa811f9485bc9d3c9668521eff6398ab1b7bcab', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), h("ir-custom-button", { key: 'cc7874f70ba4d55f77a8658b6266373ea152f2fa', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (h(Host, { key: '894bfb053abb19791a9b16f82ceb9cf00d8f366a', style: { '--ir-popover-left': this.irPopoverLeft } }, h("p", { key: '5a286cb7bf98553f9e9398c88b31fd15eb08f3e8', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, h("span", { key: '7c33f29949681298749f57bc8b1fb8f1415cedc2', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (h("div", { key: '0f1ae81cffdc23d4b844b909615cfdaec96e2733', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, h("slot", { key: '5c0c25daedd2cc8f83b29c28185678aa0763bfc9', name: "end" }))))));
    }
};
...
const IrPriceInput = class {
    ...
    render() {
        return (h("fieldset", { key: '2dd546f608b42216942ccc6d1e1d26f2ef5f5909', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (h("div", { key: '3abb21ec6d5d6fb59e35cb285cfd957aa9872b7b', class: `input-group-prepend ${this.labelContainerClassname}` }, h("span", { key: 'b19c73a05c000738c3ac7cd71812155da4580d52', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, h("label", { key: '7aa05103ac29cfb637010736e34d71870088d407', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), h("div", { key: '22e2bc306873ab621a754f27cf566d2f94b36873', class: "position-relative has-icon-left rate-input-container" }, this.currency && (h("div", { key: 'ecf6ed42c425fbd18f2aa35bd68021bfadcc06c0' }, h("span", { key: 'c4427b7d42fb429d6a14b8937b3d9c5cb7dc16a1', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), h("input", { key: '6db48e68558015125b512ad4868f5d5a30f584c1', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
