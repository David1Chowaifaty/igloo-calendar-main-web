...
import { P as PropertyService } from './property.service-7ef2a08e.js';
import { c as calendar_data } from './calendar-data-b1f645da.js';
import { S as SystemService } from './system.service-4455d4dc.js';
import { C as CityLedgerService, F as FD_TYPES, m as mapClTxToFolioRow, b as buildPaymentTypes } from './utils-f1649df9.js';
import { f as formatAmount, g as getEntryValue } from './utils-fb79c44c.js';
...
const IrAutocomplete = class {
    ...
    render() {
        return (h(Host, { key: '629c46fb509509fb694ff9c5141ff01f8448c4cf' }, h("wa-popup", { key: '807c13f7d7a8f47d5117645defe80e6c60e5db02', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: 'f0d9290f22ad90bc152c822da15e75a37905e96b', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && h("slot", { key: '700591b9eb7ab6c892aea98915fdb44bf3ad931f', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '32e9475022dc85ca154c6fff269fae9405053ee4', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '654ada32561b2de47cc14c2dc95fbb63be5a81e9', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '0fb9130f0cb44605c35071efca1e12479036d8e7', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '5f25702844f78a06408c568489dd2b4c232a8f35', name: "hint", slot: "hint" })), h("div", { key: 'bf3a2f83e88386218274586c8a12ab289636a2a4', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: 'e98a10a4c2073ae129c43386a599e1894ed088b0', onSlotchange: this.handleOptionsSlotChange })))));
    }
    static get watchers() { return {
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (h(Host, { key: '207ec1b1ab00ef82108e96e865dbf4fa9da83552', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, h("wa-option", { key: 'c4e4d49506b35eebb24e642c9e96ca4454737052', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, h("slot", { key: 'db0872993ba944a15721d8555f986e4222029d5b' }), h("slot", { key: '1161a37c8dd387ccfd1ca4ad8a36702877b4d3c8', name: "start", slot: "start" }), h("slot", { key: '81de790e1733973b64916eb8bac504627beb2996', name: "end", slot: "end" }))));
    }
};
...
const IrClCreditNoteFields = class {
    ...
    render() {
        ...
        return (h(Fragment, { key: 'e615417f0861e545e766d00bb9716368877324d0' }, h("div", { key: 'c4229af69879e72e7edd02ca3448354f72838840', class: "field field--full-width" }, h("wa-radio-group", { key: '3928a8132efd5786664256561a08433a1b2a37d0', label: "Credit Note Type", orientation: "horizontal", size: "small", value: this.creditNoteMode, onchange: e => {
                const val = e.target.value;
                this.fieldChange.emit({
                    creditNoteMode: val,
                    invoiceId: val === 'goodwill' ? undefined : this.invoiceId,
                });
            } }, h("wa-radio", { key: '446a7db9f1f0fa757ed0a8c13b6d57fdbed34a9b', value: "cancel-invoice", appearance: "button", disabled: noInvoices || this.isFetchingFiscalDocs }, "Cancel invoice and unlock all items"), h("wa-radio", { key: 'a8b9a05ca2a015470051478b46c3d297fccd5851', value: "goodwill", appearance: "button" }, "Goodwill credit"))), this.creditNoteMode === 'cancel-invoice' && (h("div", { key: 'bd5bda400583826bb8a5a6f936ca09d1b2736b23', class: "field" }, h("ir-validator", { key: 'c85ed1049bf9f02217b3e17cb6af00308aa66d20', schema: invoiceIdRequiredFieldSchema, value: this.invoiceId ?? '', valueEvent: "change" }, h("wa-select", { key: '4add2f7c0616bdfcdeacc98b1fc97121a805e6b8', label: "Invoice", size: "small", required: true, value: this.invoiceId ?? '', onchange: event => {
                this.fieldChange.emit({ invoiceId: event.target.value || undefined });
            } }, h("wa-option", { key: '088139bd0d4644f677b6cdaff49b1a192a98edc1', value: "" }, "Select invoice"), this.fiscalDocuments.map(doc => (h("wa-option", { key: doc.FD_ID, value: String(doc.FD_ID) }, doc.DOC_NUMBER, " \u2014 ", doc.FD_TYPE_NAME)))))))));
    }
};
...
const IrClInvoiceCityTaxAmountCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: '3a02e78de65b3fc5fe2165388be2ca36522be713' }, this.cityTaxPercent > 0 ? formatAmount(this.currencySymbol, this.amount) : '');
    }
};
...
const IrClInvoiceCityTaxPctCell = class {
    ...
    cityTaxPercent;
    render() {
        return h(Host, { key: 'e0ca742fb8d868da9c7cebe6726236f07e4de64f' }, this.cityTaxPercent > 0 ? `${this.cityTaxPercent}%` : '');
    }
};
...
const IrClInvoiceDateCell = class {
    ...
    date;
    render() {
        return h(Host, { key: 'e6454c1f7b001f9828cfd0de59a3f5a9feddbb94' }, hooks(this.date, 'YYYY-MM-DD').format('MMM DD, YYYY'));
    }
};
...
const IrClInvoiceNetPriceCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'cf279c491a299263d22e25bcedea44a9280e80e1' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceTotalCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: 'b0c76a0028f2c92fbd772f77cb8d9b9b128e2267' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatAmountCell = class {
    ...
    amount;
    render() {
        return h(Host, { key: '9340d8351ee70588eef9c01fdc37dd5cd2da1306' }, formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClOpeningBalanceFields = class {
    ...
    fieldChange;
    render() {
        return (h("div", { key: '472e6eda9eefef095039ead0f8541e7833135f05', class: "field field--full-width" }, h("ir-validator", { key: '542132a78db20615b319007a93c167abf109a0c9', schema: entryTypeFieldSchema, value: this.entryType, valueEvent: "change" }, h("wa-radio-group", { key: '2ad259a3781320ffafeca25452e547e08a6cd344', label: "Entry Type", orientation: "horizontal", size: "small", value: this.entryType, onchange: event => {
                this.fieldChange.emit({ entryType: event.target.value });
            } }, h("wa-radio", { key: '42fb688e65dc9feb01000b71ba4f03ff1facdab6', value: "CR", appearance: "button", class: "entry-type --credit" }, "Credit"), h("wa-radio", { key: '50f993c8e5dae30d578122dd5752263a9bdd3802', value: "DB", appearance: "button", class: "entry-type --debit" }, "Debit")))));
    }
};
...
const IrDateSelect = class {
    ...
    render() {
        return (h(Host, { key: '797e1bcedd81d3d9a87b3024a5c88c979423a7b5', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, h("wa-popup", { key: '6678a566201c5c2144f80d8d5126ce47a1ea8393', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, h("div", { key: 'e3a36280dca6b051cf49fdee09c503b7a50bbe0a', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, h("div", { key: '4d6d56dec98c8dbfafaf24418c138a42635321c4', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, h("slot", { key: '8de3e1b9d3c99c9d458c6938e739a8e93183920b', name: "trigger" }, h("ir-input", { key: 'af22d5105d01f812a81869ef5ac67f91faadc750', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && h("slot", { key: 'fc6d93820f0bcafa2bf0f3402faa948142785aac', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '062d8c9180578e52e1f73de5110eaf96c60eb8ef', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '1cd65f8f57c82e7c16e2c9516ee9af8985162808', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: 'ed9a5396f59c39709b3d7976c68c31ef78480792', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: 'f8851cae56786324c2b2901e92fc33e0d5dce481', name: "hint", slot: "hint" }))))), h("div", { key: '0c4395771a28c2b2f19ff7e29c87e2e300797f97', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, h("ir-air-date-picker", { key: '269970959346616861bd7adbc6ee99bbc9bb25a5', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), h("slot", { key: '1c4fe12c596b689b03e380bd10bd75cb0a485290' })))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: '7e88d26cdc9e30d668a781598a149569a50b42d2', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'c6ed452738eafc625b214dfe83f12fe0929766b2', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '44b6a31212861192b0e34ca90f688216f9aa7079', name: "label", slot: "label" }), h("slot", { key: '40123ce2548bee50a0be4c157bd5903f5b2c3e68' }), this.slotState.get('footer') && h("slot", { key: '0059ac008c3fe67802893d0d370311d9898902b9', name: "footer", slot: "footer" })));
    }
};
__decorate$2([
    OverflowRelease()
...
const IrDrawer = class {
    ...
    render() {
        return (h("wa-drawer", { key: 'da0650f968cb9b20791e8769fa3de117a5e7fb97', id: this.el.id, "onwa-show": this.onDrawerShow, "onwa-hide": this.onDrawerHide, class: "ir__drawer", style: { '--size': 'var(--ir-drawer-width,40rem)' }, open: this.open, label: this.label, placement: this.placement, withoutHeader: this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotManager.hasSlot('header-actions') && h("slot", { key: 'a53f17693c61ce3776284168b0aacd2944ab4aa5', name: "header-actions", slot: "header-actions" }), this.slotManager.hasSlot('label') && h("slot", { key: '81fffd6dd8fc497e3bbf9bc867c6955574ecf73e', name: "label", slot: "label" }), h("slot", { key: '3f80abd1a4c87f5dfcb7c50da8cc54dab39182ac' }), this.slotManager.hasSlot('footer') && h("slot", { key: '906bf89d9fabec340b76098709a526c09b9cda7d', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowAdd()
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '7b941a2d5a95ead973b0dda097d5a6f0e65a405b' }, this.isLoading && !this.isPageLoadingStopped && (h("div", { key: '3a421537d371da9fa843b0e4a3d5f6be0fc22367', class: "loadingScreenContainer" }, h("div", { key: '4ce124f298a2c644084af3805dc408f02ccc058d', class: "loaderContainer" }, h("ir-spinner", { key: '2a62ee63a92119c133e8a29472dfda2e722ccf4d' })))), this.showModal && (h("ir-otp-modal", { key: '9af4a2938c9b485662fe486cc251fd8339c0fc3a', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    message = '';
    render() {
        return (h("div", { key: 'c7eda9b43d19c8d077e8866a2a6aa3de5fa99185', class: "loader__container", "data-testid": "loading-screen" }, h("wa-spinner", { key: '309e48858b47a40759020af3856436befcb9acd5', style: { fontSize: '2.5rem' } })));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: '78eded4fdfa95115fe2074718f7c3103f49a5eb3', class: "otp-input-container" }, h("div", { key: '604f6c66fd801dfafa703cca0c911eb7fd812632', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrSpinner = class {
    ...
    render() {
        return (h(Host, { key: '651cb61b30eb1fc91ac8d2ad0801c723839e1259' }, h("wa-spinner", { key: 'fc70808730ff858b96355effacef39e229cfef3b', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrToastAlert = class {
    ...
    render() {
        return (h("div", { key: 'cd66476418e7870e6ce2f7b9f3978132eb4e86b8', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, h("wa-callout", { key: 'f0caf7d1878e55e316283632c4f5c2d19aa285fe', variant: this.calloutVariant }, this.getIcon(), h("div", { key: '117c53c83ed4e22a6071402668394057924c89ab', class: "toast__body" }, this.label && h("h3", { key: '0ec6b97230e28be4d4220bcd915fcd6b064af11a', class: "toast__title" }, this.label), this.description && h("p", { key: 'e5cc392a3e62428ac6b4b7a2655d8a3fae6ebb22', class: "toast__description" }, this.description)))));
    }
};
...
const IrToastProvider = class {
    ...
    render() {
        return (h("div", { key: 'cf1bb69290c2a034551a24a799a16ef864153705', ref: el => (this.popoverRef = el), popover: "manual", class: "toast-popover", onToggle: this.handlePopoverToggle }, h("div", { key: 'ad3d3f75f8dedebbbb59184756ddde35f3e2d543', class: `toast-container ${this.getPositionClass()} ${this.rtl ? 'rtl' : ''}`, role: "region", "aria-label": "Notifications", "aria-live": "polite", dir: this.rtl ? 'rtl' : 'ltr' }, this.toasts.map(toast => (h("div", { class: "toast-item", key: toast.id }, h("ir-toast-alert", { toastId: toast.id, label: toast.title, description: toast.description, dismissible: toast.dismissible, actionLabel: toast.actionLabel, position: this.getAlertPosition(), variant: this.mapVariant(toast.type), leaving: toast.leaving, onIrToastDismiss: this.handleToastDismiss, onIrToastInteractionChange: this.handleInteractionChange })))))));
    }
};
...
const IrValidator = class {
    ...
    render() {
        return (h(Host, { key: 'e6e1b9517ab92260f66ad44b2a1e64b34b5ac42c' }, h("slot", { key: '2a483eff90713618cb2ef1dab3053ba2a4d14d18' }), !this.isValid && this.showErrorMessage && (h("span", { key: 'e792264b8ceabeb32bea53005fea13ae2eb6b527', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
