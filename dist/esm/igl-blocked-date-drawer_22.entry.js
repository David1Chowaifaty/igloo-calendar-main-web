import { r as registerInstance, c as createEvent, h, d as getElement, F as Fragment, H as Host } from './index-D7D7fhZS.js';
import { B as BookingService, b as booking_store, r as resetBookingStore } from './booking.store-CDncsUUD.js';
import { g as getReleaseHoursString, n as isBlockUnit, k as showToast, f as checkMealPlan, i as formatAmount, B as isWeekend, d as dateToFormattedString, r as getDaysArray, u as formatDate } from './utils-DvzWTdKJ.js';
import { f as buildSplitIndex, h as getSplitRole, c as calculateDaysBetweenDates, t as transformNewBooking, e as calendar_dates, a as compareTime, b as createDateWithOffsetAndHour } from './booking-C5iTFi9B.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { E as EventsService } from './events.service-B-oDAJpv.js';
...
import { P as PropertyService, E as ExposedRectifierParamsSchema } from './index-DS7OlEWP.js';
...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '40ebb9eac601c59aa08c87d8d1be96b3529a2142', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (h("igl-block-dates-view", { key: '73e05ba23e26d03ce7b69c46b88be08e30036429', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), h("div", { key: '5b6e1da956669e6acf174ab82b80bf874bba549e', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '125427db3716a3883de0fa81290c8523b029f7b9', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), h("ir-custom-button", { key: '5bf802f07b12f894a4bf69210ad284597e2951a9', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'c6d8fc8cff263275a4843b3944a59b0d21a3a1d3', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, h("div", { key: '09941071dc3d67ef354954a7693a63410ce3735f', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && h("wa-tooltip", { key: 'e6e6ec6fb235a61fb733be72facceaed19af942e', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && h("wa-tooltip", { key: '713832b08f584de373df1e920dd60428718137f9', for: balance }, "Balance: ", formatAmount(calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (h("div", { key: '6ecb9f1fb15b52ac2ae1c28ac6d627a92f775229', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && h("div", { key: 'd134fb576de63e19a61d430f530cdc3344978979', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), h("div", { key: '84d4fe23c6c6de0cc5b142a8990593c1e230cfa6', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), h(Fragment, { key: 'eff22cba622e6a36663e9f261e32d5e347ade552' }, h("div", { key: '50bd466956133a66b12fa67b8bacc09d82d3215f', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), h("div", { key: '3a124f391258a83dbee2b94092fa6666d60c2f14', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (h(Host, { key: '50f04bf6cf89c2085daa74e0d1eee6df37142b96' }, h("ir-drawer", { key: '84ddfc03e8af99ffd5bee226799e107ffc057f57', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (h("wa-tab-group", { key: '3bfa9ded3389f8f8fb68f6b958ffdbb3826b7c81', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (h("wa-tab", { panel: tab.id }, tab.label))), h("wa-tab-panel", { key: '8861e719a82ca3235350f0927d41e3793d28b3d3', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (h("igl-bulk-stop-sale", { key: '55895cdb698065df2188e44c711877ec5b52d5c7', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), h("wa-tab-panel", { key: '5d730bc7380a6b8d0e9ade87464e47979faa5d58', name: "block" }, this.selectedTab === 'block' && (h("igl-bulk-block", { key: '84b41486e868b38115a6770624b18b47f32c5d63', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), h("wa-tab-panel", { key: '083b8b6cdbe103431473259a191713ad8f0dfbd1', name: "rectifier" }, this.selectedTab === 'rectifier' && h("ir-rectifier", { key: 'd25d3ce04e519a294c0dbae7c1aa6edb88056da2', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), h("div", { key: '898d4020ac815fe92e1ad62eff863bab86640119', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '1144e73acfcab4a3b28977c7eb28cfaf26e551b8', size: "m", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), h("ir-custom-button", { key: '0ebdef61c2ac508174951120c4c891261bbc3cec', loading: this.isLoading, type: "submit", form: formId, size: "m", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (h(Host, { key: '8b45d8b4769592bd39f71752ec15e18d43f1ad43' }, h("div", { key: '1f88835a3f3a802147b8c9ceb70392964929fae9', class: "bodyContainer" }, this.getRoomRows(), h("div", { key: '7d50ccea081e47de4b05ede1f77350ac17de7bca', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), h("igl-housekeeping-dialog", { key: '8a3c109bd3e27a0e79b09df06a16bd466fbbd4e6', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), h("igl-hk-issues-dialog", { key: 'c928fbaf95a2f604c00800c446a2385f39de17cf', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (h(Host, { key: '1f1dbdff6178f88da5c426649ccd170106ef53db', class: "footerContainer" }, h("div", { key: '251f5773f9681d08284d8c8548e5651c6f1bed3a', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, h("button", { key: '7f18ebaff08a43bbca3709fc44c917b064528c1f', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), h("span", { key: '2576ae4267a947a68d50843e2ea5431cb5d428c6' }, locales.entries.Lcz_Legend), h("span", { key: '4e3f6fe2c7d0b291f94705cc2ff234731c643075' }, "v1.51"))), this.calendarData.days.map(dayInfo => (h("div", { class: "footerCell align-items-center" }, h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (h(Host, { key: 'b41ad8082a7b101ffecd50e1685a0c9b4b6b833b' }, h("div", { key: '9e87cc3375c80fcd2c84253b2f6fe60e1b46a26e', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, h("div", { key: 'ab0eb1e6dfb6ccbed05145baf91c08903b509b13', class: "header__fd-actions" }, h("div", { key: '0a4e8d048459539bcc0a6fb6ecdd419082b7850f', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (h(Fragment, { key: 'f2150ce2f7b206173834fdf80107ef04cfd81f73' }, h("wa-tooltip", { key: 'deb33712b9822ab0ca2225b3c431e50ea1d7ca66', for: "fd-unassigned-dates_btn" }, locales.entries.Lcz_UnassignedUnitsTooltip), h("ir-custom-button", { key: '9f4440aacbc3320c62297227adde93a6b7309e51', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, h("wa-icon", { key: 'fe96a7e6c893d38487de425c4dd706de3cab01ae', style: { fontSize: '1.5rem' }, name: "server", label: locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales.entries.Lcz_UnassignedUnitsTooltip })))), h("wa-tooltip", { key: '8c3d2b845f07399c6281aa61801d7f28c1a737fb', for: "fd-dates-navigation_btn" }, locales.entries.Lcz_Navigate), h("ir-date-select", { key: '8324250a085d5d14073c690042d8093a1039157b', minDate: hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, h("ir-custom-button", { key: 'b3aa003062e31d6596ed6da52cf7cbfe59627aaf', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, h("wa-icon", { key: '505c35b1f52d6166f87f95b2a1b74994a30ec3bb', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales.entries.Lcz_Navigate, "aria-label": locales.entries.Lcz_Navigate })), h("div", { key: '7fb41eddfa2654b840a1628c12fd2084440dc591', class: "fd-dates__actions" }, h("wa-divider", { key: 'ae20cfd28b75a0bfb0e89051d364710d7c67797b' }), h("ir-custom-button", { key: 'dbd9f22a29eddd78751973d891e7767c001f8c0e', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), h(Fragment, { key: 'bbe4d48d18963de44853236b83767048972889c7' }, h("wa-tooltip", { key: 'b8dac4cdf3e7069060cfa820a36f2ca9d30d8c5f', for: "fd-new-booking_btn" }, locales.entries.Lcz_CreateNewBooking), h("ir-custom-button", { key: '320b501e48d6d0c6959e544bfce17c83cc3b8c8a', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, h("wa-icon", { key: 'f34d3502c43eeb6d4c71da76129fe72be5c34529', style: { fontSize: '1.5rem' }, name: "plus", label: locales.entries.Lcz_CreateNewBooking, "aria-label": locales.entries.Lcz_CreateNewBooking }))), h(Fragment, { key: '5f3d196614d1aa509c143dba2436bdd98f6ed312' }, h("wa-tooltip", { key: '9c0cffffc94fe839a2e0908c9d4613568b7121d5', for: "fd-stop-open-sale_btn" }, locales.entries.Lcz_StopOpenSale), h("ir-custom-button", { key: 'ed30169e85c5029f27158f7a11df6441e2ae42a6', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, h("wa-icon", { key: 'c12de4bd4c5caf0b4d20b4e71098dc86c6935863', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales.entries.Lcz_StopOpenSale, "aria-label": locales.entries.Lcz_StopOpenSale })))), h("div", { key: '567a12801ae5f1e73a03e1bb039e9821c9778087', class: "searchContiner" }, h("ir-picker", { key: '68318b985aa79fbcc76c6784b4e2e2dbd6f30d4f', size: "s", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), h("div", { key: '5a37d98407587398d3e6cc172029c2a8ce422092', class: "stickyCell headersContainer" }, h("div", { key: '1322d8b6ec6fc22fa81162890d0ef6ae1361f37d', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: '95166022d08aa64d87e9b73a0c1575965ca796b5', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), h("div", { key: 'f8e5d442f8bda49f7d67d8caf575e7f0a7571775', slot: "footer", class: "dialog-footer" }, h("ir-custom-button", { key: 'b22895e7d66e92505f52ff2a5453c132f71ab1c1', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), h("ir-custom-button", { key: '9d053c7893f1e11116cb735293ff0d9cb8b57d4a', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '8f4005b6f4b605674fdbfbb240c2f81f9c4e9f7d', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (h("igl-rate-extender-form", { key: 'f1871a1d2be99002a793b17caba6642cf519f94b', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
            ...
            } })), h("div", { key: 'f6d2dd07046204cd48473249309532439baa3da4', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: 'f571ddbcd7cd75aeb573822d863bd8343f784d8a', size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), h("ir-custom-button", { key: '7d984d68909c59db19bd9d18a87748d5fd9995d2', loading: this.isLoading, disabled: !this.hasInventory, size: "m", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: 'd7f0bc6aec47c554ff222b7ebd56b77c8a6bf09c', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (h(Fragment, { key: '202edf25222fcc0cee4627b81f6febaa3713883d' }, h("div", { key: 'c9abb59dcd4928ad84974a1ece1f7987c857f276', class: "dialog-body" }, h("p", { key: '2dbb9c99c00f00d72a1a7638b5e8a9bffc16ef0c', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        h("wa-select", { key: 'b232c46e4488f3bdf9833ed4c84f8cff9fd4b911', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "s", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, h("wa-option", { key: '6fa2ee69133318cb36a32e4fbb26b564fb97b1d1', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (h("wa-option", { key: option.value, value: option.value }, option.text)))))), h("div", { key: '7a0f41780ddb0f6444de00276e5f32611177674c', class: "dialog-footer", slot: "footer" }, h("ir-custom-button", { key: 'c5b73ce46b3b4d5b27d7f085225b9e472b23ffac', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "m" }, "Cancel"), h("ir-custom-button", { key: '156f9ced1691e0fe5ac010801e7c81f76d92ad14', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "m", loading: isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IglSplitBooking = class {
    ...
    render() {
        return (h("form", { key: '649d2a535c17847a0d4aab11cbb3e9eadbda72e1', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("ir-title", { key: 'efd87bd880165b3e42bd8436fb1d2825f365433e', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), h("section", { key: '14b56c0bd34904e27d5df290df715465b5bf6bc7', class: "px-1 sheet-body" }, h("div", { key: '23ad1d0933d796d1924f5044f0428d2f36759543', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, h("div", { key: 'da09237b919fd143e1915336b6f961b3fb75b0c3' }, h("ir-date-view", { key: '5d0a1dcdfe871a3cf64b2481105e2dd9e4a61fa7', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), h("p", { key: '0b3e61a3bdbd02c812d91c33c92d8c2d41b4da70', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales.entries.Lcz_NonRefundable : '')), h("div", { key: '022beacc92e0c9dc47bd27af18e01a7672c8e99b', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, h("span", { key: 'bac727cb49e346a4614f3125315e868227070a43' }, "From:"), h("ir-date-picker", { key: '687a0364982baca2c863f76ee0294ff0e07be440', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
        ...
        }))), h("div", { key: '78e3487d1d333cc5417ffe4fffa4739f3e889eb0', class: 'sheet-footer' }, h("ir-button", { key: '380c247f5191e197c69963b1ca6325d3081b354f', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: '727cdfb5e9b8ddc85cf91c8f5ec4b40bd78938ae', isLoading: this.isLoading, text: locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (h(Host, { key: 'eca5a270a180dfd6b9057a521767dbebcec2dbce' }, h("div", { key: '431a3cafe8b06849c8eddaa601bf34bed858ebbf', class: "tba-category" }, h("h5", { key: '71fe8a6e3f44628e2e134d374c71bf4915be8ede', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0ed9e6d35910ad402307b46a660caec75865e0ab' }, h("div", { key: 'b1a0d07c6ac0b1abbe0d989b960e27ac89d31f10', class: "tba-panel" }, h("div", { key: '8515ed0d51ef8fdb7b45d69fbd37d654326b4548', class: "tba-panel__head" }, h("header", { key: '81ea7f53cbe5a8071104a7c04f6d527be1f3b0bf', class: "tba-panel__header" }, h("h2", { key: 'ccaee74392cf526928f9a424fde27c4accfc666c', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: '9f643c2ad5cd626247c690a432159124ca398a31', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: 'c9bb0f3ab4487220f3634f7aa9b361c8ff370faa', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: 'bc5013116386270cecb2cd65fa88d365bb9f92ad', class: "tba-panel__toolbar" }, h("wa-select", { key: 'b57019bb46a6cf7c0924dc43cbfb117320aaccb1', size: "s", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: '07439cf7639918131b90c168b244d647bd78a677', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (h(Host, { key: '72d915393cf68c9af1731fd0df24f8eddc92023c', style: { '--ir-popover-left': this.irPopoverLeft } }, h("p", { key: '579371f3b539b501e7405e9be3b212781ebe801b', class: "popover-title" }, title.length > this.cropSize && (h("wa-tooltip", { key: '7a36d554a8c546603fbb13ed4458b037a85c60b9', for: this.titleId, placement: "top" }, title)), h("span", { key: 'f226710db3e6a6f98f708fea47567aafa97bcbaa', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (h("div", { key: '0c00092954709285403a25a4c620afd9d927d70a', class: "hk-dot" }, h("slot", { key: '4023f698dbbac19eae3f4d6e957f09941b6f8b1c', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '5c6124ceecaea7adfba65a5048dccf8211608777', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '7e6bba8e82432ef9ea176137a9930e69221a8b18', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'f7a83974a6ef2455cc48d7a252f8410291bfae71', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '09f426d6f618a3115a2a2986003814b993ef9213', class: `ir-alert-header` }, h("p", { key: '4fd8f08ccc0b3ce401eb2b2e947f2d7398209c30' }, this.modalTitle))), h("div", { key: 'e991b050171e428e289ffa828b70c5c4838b13a3', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '6d228356894cfc91c610d19a4a2ceb2ab579451e' }, this.modalBody)), h("div", { key: 'c52892fc77483b4c5de7552cabe4a60609196100', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '7f3d404f96dc4d6ae7ce9b4444642b0b44d69421', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: 'a3a2aaa46bba292aeca02b00be03a8116d0272c1', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '292cdcb7f64ec74ef15094be83ce37a5bbaa4f98', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (h("div", { key: 'ec0ca26ca19cb620743e39a50cb05cc909175a46', class: "input-group" }, h("label", { key: 'b53909823110273c413180399b2aee98a4ab65ce', class: "check-container radio-container align-items-center m-0 py-0" }, h("span", { key: '923bd512ff0b87dc06044ae45d5be0ee7042f064' }, this.label), h("input", { key: '6ffb5e3fdfd75357464dd811f6b7a946b6c1825d', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), h("span", { key: '7da87f54f868ab413ef518a607c774a0c1ee7caa', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'e8d58200bc390aeed7da09513874f4e0e6f5b4ae', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && h("ir-reallocation-form", { key: '12c379e1ac62762504da670a1e951882ea49c77c', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), h("div", { key: '255fc4b55017f23dfb53b12a8f0d2b1750bc4a74', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'b32d4ef1e091a1acf47933daa42a52fb2f5dd659', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: 'c7711d160c3a08ea712df8671c644670983c4251', form: this._id, size: "m", loading: isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'bc92b466bb22951f0e43586d2a3128f15b0f1132' }, h("form", { key: 'deb9301caff98c242fb2fd844409787df995b418', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, h("wa-callout", { key: 'e4fc137e43becab9c12d21c994217ea5f2b01111', size: "s", appearance: "filled", variant: "warning" }, h("wa-icon", { key: 'ae751cddd275ad586d4b4d8a2394730f607d306b', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), h("div", { key: '5b79a8f758b5717bfea10dfb80af81d42a41c711', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && h("p", { key: '90cc9c0d16e2cc70ead37c1533050e04544fd373', class: "text-danger m-0" }, "Please select at least one room type."), h("div", { key: 'cf89302ecc48c1e102f66fd31ce38833845857d8', class: "ir-rectifier__date-range" }, h("ir-validator", { key: '351c6978694e3bb8811a0cce05dc5806ce91d1b1', value: this.form.from ?? null, schema: ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, h("ir-date-select", { key: '834179464d4205f65b13f932e77946c135514b0c', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), h("ir-validator", { key: '0d9e10e095d34814674aa249bd4d11a9924586b0', value: this.form.to ?? null, schema: ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, h("ir-date-select", { key: 'd3a4f7ec9ccf4d0435af2b2483ff209de3d10899', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
