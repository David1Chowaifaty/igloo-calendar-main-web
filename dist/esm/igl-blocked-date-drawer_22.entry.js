...
import { B as BookingService, b as booking_store, r as resetBookingStore } from './booking.store-DIvtT9hT.js';
...
import { E as EventsService } from './events.service-D9FhHME1.js';
...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'e57e3761f3fa0f65849b370a38b2d2933441c7cf', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (h("igl-block-dates-view", { key: '7d637ca9025549dd237aa16526d3e66ecbcf9cad', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), h("div", { key: 'c9a215391382dc8dcea7df240b9f4722e9d7b140', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'b8ee57ec48be17aa07fe3f57519161da86539675', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), h("ir-custom-button", { key: '36447bded6c2a8e269809edc4c3045fb35fc9df9', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (h(Host, { key: '880d34f7718dbdb55542f0148beff14264eb15c8', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, h("div", { key: '53748245eff86894fbfd4e4c4ba4e63e7462227a', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && h("wa-tooltip", { key: 'd8d94196c7779b87207959fe59ac86a60c639442', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && h("wa-tooltip", { key: '3673c65de3b33a8207a09b9ec710b45917e764ba', for: balance }, "Balance: ", formatAmount(calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (h("div", { key: 'a9354a00cde8193f445a58b77a61f9afdfac236d', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && h("div", { key: '1121352eb8ee871f608a904d89cf23467a337762', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), h("div", { key: '27c7b1b6096ed95e5c046e3d46a4baa8f621b07f', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), h(Fragment, { key: 'eacbe7c4603620de564ecbdcdacee9ccef42450c' }, h("div", { key: 'ec01e16c40883495158c0189f59fa59e863604f8', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), h("div", { key: '4eb7b000c4bae897b7af21aeb41cb18baac91824', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglCalBody = class {
    ...
    render() {
        return (h(Host, { key: '6011b7f4f695c997291fa22cf10c38a54eb81107' }, h("div", { key: '7e34b70a07eeec9544b8c9bcf1ab12b69d855d13', class: "bodyContainer" }, this.getRoomRows(), h("div", { key: '5287d2bb7aef56c406fe7e90b6993678d591f2bd', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), h("igl-housekeeping-dialog", { key: '9b4c894946473d242d565b6da0a34278066e0b28', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), h("igl-hk-issues-dialog", { key: 'bf426979af0be435756616534974b6556cbc50fd', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (h(Host, { key: '07788dad80462444ae7e3db17e8c8cb56925cd4b', class: "footerContainer" }, h("div", { key: '7c6d851c44427fb97e98349157c3828ebc23ebab', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, h("button", { key: '5ff0c42c555a2efd926e65691c34e04119b30021', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), h("span", { key: 'ac18436ba29221093bf983eb4e6c6e0854a3366d' }, locales.entries.Lcz_Legend), h("span", { key: '522414a281ed175ea3d0a3d0c5d505c91201046c' }, "v1.51"))), this.calendarData.days.map(dayInfo => (h("div", { class: "footerCell align-items-center" }, h("div", { class: {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: 'c793fb98e003c15a4d9c0efcc849c6556e60fff8', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), h("div", { key: '25d50b34738aa7a4ce70abd1d8dac0a68d9ca29b', slot: "footer", class: "dialog-footer" }, h("ir-custom-button", { key: '12e373e49fac5ef115034739237f050f0fc5d40c', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), h("ir-custom-button", { key: 'e214ac28e99ddbfbe304c0cba070a2d2931f7043', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: '0c235b6431370e024b1e22dfa92703775f97f0e3', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, h("p", { key: 'ac8c9ebc90b389369c692c910b32582aa916eb8b', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), h("div", { key: 'ad79174c6e427fd8f4cd0ec9f00471af44789c97', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '7d24a3810b7a97f845e142e627add178a7063ecf', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: '115ac9b53151ce64c38fc8976acdc04cbf968be2', value: "hk-toggle-clean-dirty", size: "m", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), h("ir-custom-button", { key: 'd1e7f119eb935571d071479eaa0f95865b259172', value: "hk-clean-inspect", size: "m", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f35408782a9d00b940e01c844bf2e4bcdaea3c98', class: "legendContainer text-left" }, h("div", { key: 'ff46092eeda6646d2d50ddbf169ef6ff47206de4', class: "fd-legend__header" }, h("h2", { key: 'f4f1e5e764f6dcd0d7600434b8dec52d59978ea1', class: "fd-legend__title", id: "legend-title" }, locales.entries.Lcz_Legend), h("ir-custom-button", { key: '5bd5a8b5907fcee6ce20bf9f94aad904f46ed2a1', size: "m", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, h("wa-icon", { key: '6b2666d331c1f8e8036305665cd5f6f67f8df235', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), h("section", { key: '44f28f901eefc7579537920c65face0ea87b72c8', class: "fd-legend__body" }, h("div", { key: 'd9fe6f0f7a6c2a8ad8c820774be00596b306d4be' }, legend.map(legendInfo => {
        ...
        }), h("div", { key: 'bdc1276721997f8d314ee2fb3048183fc9df3091', class: "fd-legend__row" }, h("div", { key: '942090e9aeac05cfbde56cb2d1d22ac7877f2c2b', class: 'fd-legend__shape' }, h("wa-icon", { key: '305f72a74bd0849031629533f6ba199370ddb5ee', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), h("p", { key: '6066653ab9e6504cd8026c6d3cfa3fb55fe477a1', class: "fd-legend__row-title" }, "Housekeeping reported issue")), h("wa-divider", { key: 'ed245312d8d45f149cb4f4932d42eb3d9b83f534' }), h("h5", { key: '2de989aa8ec068e7ffec53dd9df33cc9116ff6df', class: "fd-legend__section-title" }, "Use custom colors"), calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index) => {
        ...
        })), h("wa-divider", { key: '38967a2cada390d346741e3344f27da0c0c1aead' }), h("div", { key: 'f6265f36ebf1a972fd0fdf3288d513713750c507' }, h("div", { key: '6a6c046ea6236001286687d246dfd40490c48a58', class: "legendCalendar" }, h("div", { key: 'fb7aefe2449723d137c1436208f61ee030741ee1', class: "legendRow align-items-center" }, h("div", { key: '886877921065f62da17ac501ed7211289c77e5ec', class: "legendCal br-t br-s br-bt" }, h("strong", { key: '332e6f166eb60c6036b7aea3e216f04818a01f2b' }, "MAR 2022")), h("div", { key: '707b57017f01882fd9d25f1e7441893cc9b8d1f4', class: "hyphenLegend" }, locales.entries.Lcz_MonthAndYear)), h("div", { key: 'be0f6571d4b891eddf0c488c3b581ebf957ba939', class: "legendRow" }, h("div", { key: '45fda9e928ed6e529d523476f1ecec7b53ef390a', class: "legendCal headerCell align-items-center br-s" }, h("wa-badge", { key: '34c523c7f3e1f6c7e49eabd6b1431233c3402ca0', pill: true }, "3")), h("div", { key: 'da5dcd1a9f4d2c7bd6668ff0ef55fce085c56892', class: "hyphenLegend" }, h("div", { key: 'f41e902e058fec66f131ba352436da5621399ae0' }, locales.entries.Lcz_UnassignedUnits))), h("div", { key: 'ce498384469d83bf9107cdb80ad932791e817cd2', class: "legendRow" }, h("div", { key: '446fbed489bc990835a79527a3e3d6c0fa7a17d5', class: "legendCal dayTitle br-s" }, "Fri 18"), h("div", { key: 'a343411b34e890c1b754600809c610980b43ae32', class: "hyphenLegend" }, locales.entries.Lcz_Date)), h("div", { key: 'fceca9ef116afe778f98204e19a21b6124c1ab36', class: "legendRow" }, h("div", { key: 'f7634beb98f590517fc0c5b251528c9d04358861', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), h("div", { key: '4d51985475d031067ccc8fd62190a36c014fe395', class: "hyphenLegend" }, locales.entries.Lcz_Occupancy)), h("div", { key: 'e89c3a8c02ff565140590df5e5a7fb0784ef8316', class: "legendRow" }, h("div", { key: '70d06ffd3f9ac148ba3a25891dc114bb8bdfe152', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), h("div", { key: '1f9a9f396917267c5b1e69f830775d9988d74dc7', class: "hyphenLegend" }, locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglSplitBooking = class {
    ...
    render() {
        return (h("form", { key: 'eac17286b340a4496d7771dc5f9fcbbffc52c0de', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("ir-title", { key: '3b0cdb94f12cf30f9992637756614bfceca7fae5', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), h("section", { key: '3a78e3262940a459b042220e38be8193fc1ad88b', class: "px-1 sheet-body" }, h("div", { key: '2d8300d5a33aeb115784efed7dd5aceabcfebbea', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, h("div", { key: '900799f02ab5ec441ae70223b008e47e2daf418d' }, h("ir-date-view", { key: '0daeb4ccc447204756eadc1791d642056fcb0877', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), h("p", { key: 'dacf82b3a730dcfc9124ddd048703caa94c28030', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales.entries.Lcz_NonRefundable : '')), h("div", { key: 'd756fe5f96996acc2a4cdad94ec0e2247cc7607f', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, h("span", { key: '4c08effdef77a132e1e408636012ad36e5e3fa24' }, "From:"), h("ir-date-picker", { key: 'eb5fe39edccb910138a4a020e6f7d4c72dcfd1be', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, h("input", { key: '1c729e91b58afc69d6323d7dc67ae50a072fba9a', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), h("ir-button", { key: '8420c1fd12e2319054fce46cd51c4f6ad580aead', isLoading: isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && h("p", { key: 'b318deaa59c19723fee8924a09d2335dedb6b5fb', class: "text-danger text-left mt-2" }, "Please select a room"), h("ul", { key: '0d3d520cd92a6ca17f7f49c2fe39d886ed18fafb', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), h("div", { key: 'd556864659242f1b31e92aff09f33e34767613f6', class: 'sheet-footer' }, h("ir-button", { key: '0c1d1b8d64301119ee61904ef43295777f57e2ec', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: 'd07eaf87042bf943af0990b4042db78145dc8735', isLoading: this.isLoading, text: locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (h(Host, { key: '0b7c62979a896f369b6fdd0d5475c01a3764165f' }, h("div", { key: '2bf678de2df93aa9dbe311112e0f5ae3f18b77bb', class: "tba-category" }, h("h5", { key: 'c776d340589147984f8604a61e11a308c4d8c13c', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'ee43d18defc14166bdd8b0e884c49061e2e770e4' }, h("div", { key: '98f5ca461c32f82fcbfbcdfc7873831d1e4da031', class: "tba-panel" }, h("div", { key: '0c27b91537717e23ed56906b68276162baff07e9', class: "tba-panel__head" }, h("header", { key: '1526abad2161776cb8003799c3f6ac10578158b4', class: "tba-panel__header" }, h("h2", { key: 'e636bb8e3629d9fa560fcbb38cba0a250f4e5c86', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: 'b4c6e4be41f26249f174a2f32acc01124ad852a6', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: 'b04b3dcc34516ba71afacb2c311cd446e721a86a', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: '315cf5e601dd2e102d95ee11492bd3f82066f2ad', class: "tba-panel__toolbar" }, h("wa-select", { key: '949358802bffa45494f7d60ea95513a8c7c2d35e', size: "s", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: '0569d149c1b6ee3e738639cdb051469b94d782d5', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8a94c9e8eaac239f0963ba0e0afd6fe3d85dca40', style: { '--ir-popover-left': this.irPopoverLeft } }, h("p", { key: '9dbabede6a609ba4da505f516a41b1c0eea7a143', class: "popover-title" }, title.length > this.cropSize && (h("wa-tooltip", { key: 'cf467b97e1b347db9c30b9678ca8526a381d4bcd', for: this.titleId, placement: "top" }, title)), h("span", { key: '2817ff5db7f8ad2f2ce63f3bf0d28ca4e8b6821e', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (h("div", { key: '99725a4aacc9d2aa9030d03b3fafffdd11ad0811', class: "hk-dot" }, h("slot", { key: 'a27a288c302c40d73df22cf8e3eb33b2e61f034e', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: 'eaf61df71c50e5258b38b5507d513efbdcfa7dfa', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '6c7358606acbac4a07e861b97d3816f3e9368b63', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'bc2e2d6d1ea86fdc1c0d48a020b2425d9ad83060', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: 'ccc775055f67af084d3ef1e8c7069d2d68e9fb88', class: `ir-alert-header` }, h("p", { key: '27753740a802586eb8ebe8a6b9bdf309a6048de8' }, this.modalTitle))), h("div", { key: 'd3b4e8fbc935674ef46b159d3a264817e1bf7eec', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '3d1430d00e306dcab005c5007528888b0ea031c0' }, this.modalBody)), h("div", { key: 'ee9d3b9458b168db53fd317c4975c8e7a62e5e03', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '9f020792582808d892987d55622467dfcd19ab66', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: 'a60427f6b9062bd4bd89c780cd0e248b55c7d447', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '1482a83c8fd9b73fd1ec23ee9949ecdfcbd38077', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (h("div", { key: '9a343d25064eec4744cc5a0ad710cd94d4be1c1c', class: "input-group" }, h("label", { key: '422324aae90621cd44b82bdd7f406f4f0f47ee00', class: "check-container radio-container align-items-center m-0 py-0" }, h("span", { key: '485ac9330f69568481393a88ad203af6ee3c6a0b' }, this.label), h("input", { key: '9ed6b7ed1e61c8ea987a071fd88350cc5b9279e0', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), h("span", { key: '8f0b0d0203511839717fae0b1d63019b6ec2bbff', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '48e2cbbfe0edd684819feccccbb534c713c53506', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && h("ir-reallocation-form", { key: '0a6f12b3c38c224f363a43570c35394751958e7d', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), h("div", { key: 'c416389a7cb4fe8e957679ae463a184d966ba14e', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'efae61735d808f985e7bff61d8f7ad5a251a4455', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: '19cdb76f3061997fd3887563075a9563c3b699d4', form: this._id, size: "m", loading: isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (h(Host, { key: '151beed392cf8e9ea94b9eda794b69fd706f71b5' }, h("form", { key: '2c76e9ba4e20080e44d8722c9031f6e9f5ffb92e', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, h("wa-callout", { key: 'ac98752adb2e182ad2986879eea48edff9df6b98', size: "s", appearance: "filled", variant: "warning" }, h("wa-icon", { key: '5ccc96c809cc381cde193ad2ea90355fb91c9e3d', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), h("div", { key: '8b7301e9ce3c9c2cd036f6f686d2256a3058c3ee', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && h("p", { key: '0f0c2c35f440fe53faeb43499fc47d98921c06af', class: "text-danger m-0" }, "Please select at least one room type."), h("div", { key: '09b45e83ab355e426be390ed764b42c96a1cf7d9', class: "ir-rectifier__date-range" }, h("ir-validator", { key: '27849f5a8a01eaed8683e1d291680f011ede0adc', value: this.form.from ?? null, schema: ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, h("ir-date-select", { key: '86bc422e604d05f9accd7ecf0315e80e31efdeb2', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), h("ir-validator", { key: '292df5f14e5f6da30c49a5ae68d53dd921616e4c', value: this.form.to ?? null, schema: ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, h("ir-date-select", { key: '9de3499ddc4b60031c20da4c566be6457655092b', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (h(Host, { key: 'e3b043b327c13983d8ef744ec27da7b669752782' }, this.phase === 'spinner' ? h("wa-spinner", null) : h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
        "active": [{
                "onActiveChange": 0
