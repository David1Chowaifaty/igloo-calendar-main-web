import { r as registerInstance, c as createEvent, h, d as getElement, F as Fragment, H as Host } from './index-DrVkW3Kc.js';
import { B as BookingService, b as booking_store, r as resetBookingStore } from './booking.store-CM0HHElq.js';
import { g as getReleaseHoursString, j as isBlockUnit, n as showToast, f as checkMealPlan, i as formatAmount, F as isWeekend, d as dateToFormattedString, q as getDaysArray, t as formatDate } from './utils-CJFvKroT.js';
import { n as buildSplitIndex, o as getSplitRole, c as calculateDaysBetweenDates, t as transformNewBooking, e as calendar_dates, a as compareTime, b as createDateWithOffsetAndHour } from './booking-bxQ4mwxZ.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { E as EventsService } from './events.service-CNiGPVTg.js';
import { l as locales } from './locales.store-CcwAwmT9.js';
import { c as calendar_data } from './calendar-data-CmdqrXAh.js';
import { T as ToBeAssignedService } from './toBeAssigned.service-dCZMLzGO.js';
import { h as handleUnAssignedDatesChange, g as getUnassignedDates } from './unassigned_dates.store-r7pO2Ymi.js';
import { H as HouseKeepingService } from './housekeeping.service-DzS8whTZ.js';
import { P as PropertyService, E as ExposedRectifierParamsSchema } from './property.service-48IngD6W.js';
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: 'd3753554166bf666fbfbf61502d2034f82a234c2', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), h("div", { key: '834276de4a154e954b13a0460b489f9040b9bd6c', slot: "footer", class: "dialog-footer" }, h("ir-custom-button", { key: 'dabc798bc6fcac1a1e233e5e9db977962779f91e', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), h("ir-custom-button", { key: 'a8658c364d949608856273419eb581e16c855fa6', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        // ></ir-select>
        h("wa-select", { key: '17ca6aa0ca677b180f62fb6ff61d117f95a7f7ff', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, h("wa-option", { key: '206a922682ee7a533ef0701a729a364d5ab3cc2e', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (h("wa-option", { key: option.value, value: option.value }, option.text)))))), h("div", { key: 'ebf985e3507c965157f55a446a0edab1facd0afc', class: "dialog-footer", slot: "footer" }, h("ir-custom-button", { key: 'd984b5174834c5b2a9f5c2558b74e4d548a57572', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), h("ir-custom-button", { key: 'a482612e58c06c92c582508c22c114669c55fc64', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: '7d63b749a1fd67b08b4768936ad43e5cb47f7554', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
            ...
            } }, this.open && h("ir-reallocation-form", { key: '545d4dacd48144bd933677e8b79cd662701af360', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), h("div", { key: 'fd8db73250d96c97d9b1f64899d9604e409d90a7', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: 'b8762f43f2dc07db31b9e4f7f43e2ba3454c8a70', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: '4b72d0bd8450ea8a20a2942150bb64dac7cc8bbe', form: this._id, size: "medium", loading: isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'fdf30b4419765fd15e6be89debf05454b3c1ef52' }, h("form", { key: '9cb86a36f4b3c92df8e20e304fc64b61fec5b899', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, h("wa-callout", { key: '034d95370f14febc9f88f7f2dff33db788de0a11', size: "small", appearance: "filled", variant: "warning" }, h("wa-icon", { key: '619485ad364acdc0d21fe857a06196917c202332', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), h("div", { key: '1211ca67465cedfd3794e078f62debd9dca01237', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && h("p", { key: '2b7f747d2b3f948a5bde42daba9b4a887ce23223', class: "text-danger m-0" }, "Please select at least one room type."), h("div", { key: 'cb2daaf3ebebd467f900214f5191f5e1e71581a1', class: "ir-rectifier__date-range" }, h("ir-validator", { key: 'f0dd541eedaa0581f4f27fe6a6a5c405245e572f', value: this.form.from ?? null, schema: ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, h("ir-date-select", { key: '137393edeb1779cc890a29c397609133c01b52d2', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), h("ir-validator", { key: '4bebca6eb59ed19e0c12f15eec91e33f39f3e787', value: this.form.to ?? null, schema: ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, h("ir-date-select", { key: '27d086502e2cd1bbf9f3e8dc07362c01ae15274e', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
