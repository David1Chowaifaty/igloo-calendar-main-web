...
import { m as modifyBookingStore, a as reserveRooms, V as VariationService, b as booking_store } from './booking.service-B4SIj2Et.js';
import { e as extras } from './utils-DK1ZYV0C.js';
import { h as hooks } from './moment-Mki5YqAR.js';
import { c as calendar_data } from './calendar-data-B7ocnCQe.js';

const RoomsGuestsSchema = libExports.z.array(libExports.z
    .object({
...
const BookedByGuestSchema = libExports.z.object({
    firstName: libExports.z.string().nonempty(),
    lastName: libExports.z.string().nonempty(),
});
...
export { BookedByGuestSchema as B, IRBookingEditorService as I, RoomsGuestsSchema as R };
