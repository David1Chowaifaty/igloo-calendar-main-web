...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '8762416d3ae40da6bf4ef87e58e2b4b5edbf8cb4', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '8e799652c00ef205831378f27a294656dc34dc8a', class: "input-group row m-0" }, label, h("select", { key: '4e5805542b5b001a085b1032d8336c8e552da66f', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'b258d931c76ab32ff5fb8c02f84b3b8c0f7fbf89', value: '' }, this.firstOption), this.data.map(item => {
