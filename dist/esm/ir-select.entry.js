...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '12f4850605245591c99ffc7f07267449719ab991', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '3e534f1931ec9e76ca59f2865c823a200dc4ab4d', class: "input-group row m-0" }, label, h("select", { key: '0c2ee53b3b9dffdb37781a4ad6dc64ede5a43979', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '304f6b4778cbf5f621318f5707e5ca0b123b1b82', value: '' }, this.firstOption), this.data.map(item => {
