...
const IrSelect = class {
    ...
    render() {
        ...
        return (h("div", { key: '68f2bee3f0f779109f170fd788f80a831e3151ad', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '07de0ab97b29fedc81c9f5a894dcf80841e56fd1', class: "input-group row m-0" }, label, h("select", { key: '1b5de31cb5ff31aec6d2214667fd0f68017a3f85', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '5da4cfd752366247206a066c233675b0e836f7cf', value: '' }, this.firstOption), this.data.map(item => {
