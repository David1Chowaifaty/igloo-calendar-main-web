...
const IrExtraServicePriceInput = class {
    ...
    render() {
        return (h(Host, { key: '6af5e665c871eb49f95e0294ee5ab8e2b712c2c2', class: "ir-extra-service-price-input" }, h("ir-validator", { key: 'bbde887ee5eed64140faae3b50bbdf7f457a2a17', form: "extra-services-settings__form", class: "ir-extra-service-price-input__price-wrapper", value: this.price?.value ?? null, schema: libExports.z
                .number()
                .nullable()
