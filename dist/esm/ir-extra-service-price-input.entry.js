...
const IrExtraServicePriceInput = class {
    ...
    render() {
        return (h(Host, { key: 'fbcb240ba21f7927e69da918b866fa86dd447391', class: "ir-extra-service-price-input" }, h("ir-validator", { key: 'b08fa19e38a8791f8ed6f7c10d617a2e4eb5af53', form: "extra-services-settings__form", class: "ir-extra-service-price-input__price-wrapper", value: this.price?.value ?? null, schema: libExports.z
                .number()
                .nullable()
