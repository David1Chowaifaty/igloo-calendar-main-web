...
const IrExtraServicePriceInput = class {
    ...
    render() {
        return (h(Host, { key: '3c1f264dfe84e37b984ae78d0395f9cc72340588', class: "ir-extra-service-price-input" }, h("ir-validator", { key: 'fb876cafd6eaa37d0453b270ec850f6f6556f09d', form: "extra-services-settings__form", class: "ir-extra-service-price-input__price-wrapper", value: this.price?.value ?? null, schema: libExports.z
                .number()
                .nullable()
