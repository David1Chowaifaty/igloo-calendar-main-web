...
const IrExtraServicePriceInput = class {
    ...
    render() {
        return (h(Host, { key: 'bfb670759410f0efd9d93c3c332054fa6c6891c9', class: "ir-extra-service-price-input" }, h("ir-validator", { key: 'e22bfb2d9dee69809b1ebba91b0ec3b5339bb7a1', form: "extra-services-settings__form", class: "ir-extra-service-price-input__price-wrapper", value: this.price?.value ?? null, schema: libExports.z
                .number()
                .nullable()
