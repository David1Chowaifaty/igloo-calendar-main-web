...
const IrNotifications = class {
    ...
    // }
    render() {
        return (h(Host, { key: 'b8523e2df92a86b1968d2155da9e3756924e2fa5' }, h("div", { key: '4c862654a7b0934e242ff62d68c08134f51ad357', style: { position: 'relative' } }, h("wa-tooltip", { key: '963770714c7f377ddd6997838170daac30daaf6b', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (h("wa-badge", { key: '5f9258a05ad41aba307d317033d0d58bf2eaac44', pill: true, class: "header-notification-badge" }, this.notifications.length)), h("wa-animation", { key: 'f106777e0368a9d9b19a8123d462056312d0a7f4', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, h("ir-custom-button", { key: '0e76f65608932bd580d6d64105dfc1d6ab9e2365', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, h("wa-icon", { key: '9b31d7198f2bad0be58bb32dd9ca418dcc8bcac8', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.2rem' } })))), h("wa-popover", { key: '7be2a20f808b7617f6a6ef190b3ccad18317760a', class: "notification__popover", for: "notifications-button" }, h("p", { key: '6a598217f8f9a6ff6740b2e3ea7d96318aab43fe', class: "notification__popover-title" }, "Notifications"), this.notifications?.map(notification => (h("div", { class: "notification-item" }, h("div", { class: "notification-item__content" }, h("p", { class: "notification-item__title" }, notification.title), h("p", { class: "notification-item__time" }, this.getRelativeTimeFromParts(notification.date, notification.hour, notification.minute))), h("span", { class: "notification-item__unread-indicator" })))), this.notifications?.length === 0 && (h("ir-empty-state", { key: '4b0190733dda4531f29c192b47ec012efc4ddfaf', style: { width: '250px', height: '150px' } }, h("wa-icon", { key: '8683bacfb1be99ec230e85d90d675dfb5b43585b', slot: "icon", name: "inbox" }))))));
    }
