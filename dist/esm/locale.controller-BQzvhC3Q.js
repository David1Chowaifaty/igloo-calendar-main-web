...
import { E as ExposedLanguageResultSchema } from './types-CyZFzmvF.js';
...
const SCREEN_TABLES = {
    agents: ['_AGENTS'],
    arrivals: ['_FRONTDESK', '_BOOKING'],
    bookingDetails: ['_FINANCIALS', '_BOOKING', '_CALENDAR'],
