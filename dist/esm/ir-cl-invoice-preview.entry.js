...
import { C as ClFiscalDocumentService } from './cl-fiscal-document.service-Crs2oLJu.js';
import { t } from './t-CHjay2ar.js';
import './ApiClient-4jHvz1N4.js';
import './axios-B50ozOIF.js';
import './_commonjsHelpers-BFTU3MAI.js';
import './index-DPNJuxij.js';
...
const IrClInvoicePreview = class {
    ...
    async fetchData() {
        ...
        try {
            ...
            this.error = e?.message ?? t('Lcz_FailedToLoadInvoiceData', { fallback: 'Failed to load invoice data.' });
        }
        finally {
