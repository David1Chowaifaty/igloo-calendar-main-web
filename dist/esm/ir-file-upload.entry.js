...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (h(Host, { key: '69889c4d83b5a42adcacb6b53f9a97b9edc10633' }, hasLabel && (h("label", { key: '87e659172abcedd5235e2da8a395a3ef9d010cb1', part: "form-control-label label", class: "label", htmlFor: "file-input" }, h("slot", { key: '5c0e150014551e4b53deb1bd9d711c3101f9950a', name: "label" }, this.label))), h("div", { key: 'ce3f2d17cbcebb0b37f3f7cb0b06d46ff171b0bb', part: "base", class: "file-input" }, h("label", { key: 'a3eb7496966efde5623d786e83a73170091271f7', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, h("slot", { key: '249ead7a02b8d650a063230664febce9718cdb89', name: "dropzone" }, h("wa-icon", { key: 'bd87bea592becb1163ae8528fae1dd3137ee835d', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), h("span", { key: 'dffae0ed72af9fcbfe5dd1ac89f8bfa93a40e495', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), h("input", { key: '4887259d2b0550424d09af896ea396b7ca19a4a1', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (h("div", { key: '78bf9c439904d4f7fe8c2765a5b54b3602936ea5', id: "hint", part: "hint", class: "hint" }, h("slot", { key: '5f4ef40ab74eb6178f6f43523650c175ca36d13a', name: "hint" }, this.hint))), this.files.length > 0 && (h("ul", { key: '056ea7f86e4e1cbc0b07dfc63fd442f660549810', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index) => {
