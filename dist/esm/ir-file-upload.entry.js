...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (h(Host, { key: '8be48b36dc0ec4545c5c2605b607118f3d29ee84' }, hasLabel && (h("label", { key: 'eb86866770382581245541b902ec1f8c7b886f40', part: "form-control-label label", class: "label", htmlFor: "file-input" }, h("slot", { key: '4d61e1eb5c864a97cc15b4e75283816c3e1980c7', name: "label" }, this.label))), h("div", { key: '820cc9d028262e0299987c38f38afecf594467dc', part: "base", class: "file-input" }, h("label", { key: '8c56e276d1ffba1467074e34745a419858569e62', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, h("slot", { key: 'de182ef6645f14af9b5e34779ead600014a485c3', name: "dropzone" }, h("wa-icon", { key: '26874ee6deb578eaf18e8720a03020f74653a443', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), h("span", { key: '949579e531c787d05e2ab1f0891a4fa21909c09b', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), h("input", { key: '19c7224183b2ab93e90f9de5da1f03f53ab9aa4e', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (h("div", { key: '1eba1e9ba8edcc2100642a58e17216a1315a171f', id: "hint", part: "hint", class: "hint" }, h("slot", { key: '5ff93395a3ef989a9aab04e7c1e4e34af0a58592', name: "hint" }, this.hint))), this.files.length > 0 && (h("ul", { key: '698c80f64cad1aa6f3ef6be52d40dc1ec19425e1', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index) => {
