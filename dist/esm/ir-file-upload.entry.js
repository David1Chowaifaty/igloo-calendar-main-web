...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (h(Host, { key: '1a437651fc36d08340e80eb99ffc21fd10a8fcd6' }, hasLabel && (h("label", { key: '1ab2b6ea1d1cc996baed606310cdd5f8e7c2980e', part: "form-control-label label", class: "label", htmlFor: "file-input" }, h("slot", { key: '1dfc14693f4b70bee5cd6f90c8f8f01294714248', name: "label" }, this.label))), h("div", { key: 'ec4137d42d341dc0556ff1f776bd251f86f77d0f', part: "base", class: "file-input" }, h("label", { key: '02331a0407f084f9420b4a573d3fc1d6ff062ab1', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, h("slot", { key: 'cc7d8bf382dd9350f7f377588fd385fead16df5c', name: "dropzone" }, h("wa-icon", { key: '0d64c633ab21fbb4813f20292f5e734a1e8b48f4', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), h("span", { key: '057b8cb0bc85fe9fbfe9dcd3141da9972b098746', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), h("input", { key: 'b80421fd175c209afe663deb44c2448add4e74eb', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (h("div", { key: '370ee9c3f123804531ebda7fb47fbb05c501b220', id: "hint", part: "hint", class: "hint" }, h("slot", { key: '0186cfeb73eb3853a0ba320f8b9ccd55806de8bd', name: "hint" }, this.hint))), this.files.length > 0 && (h("ul", { key: '1831cce99fcc1dbe9be88eacb818416b5f0e1aa1', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index) => {
