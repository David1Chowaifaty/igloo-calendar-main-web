...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (h(Host, { key: '73d4e5b68e0622b3a05ea18e6cc49d80c058e719' }, hasLabel && (h("label", { key: 'c80a40a3afd4ca102014cd1d3f62364c03bd8ddf', part: "form-control-label label", class: "label", htmlFor: "file-input" }, h("slot", { key: 'c8f5bd4dd40aef1db40fab592fe97ccfbe367447', name: "label" }, this.label))), h("div", { key: '83dc3baa8c52f81a78490901660fbebb990e9d43', part: "base", class: "file-input" }, h("label", { key: '291e6cf77fc48aabf4c21154bcfb631b53e8a2eb', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, h("slot", { key: '84971b0da7e8a30fc901ee5b20bf2ed9382cdf3c', name: "dropzone" }, h("wa-icon", { key: '70dd361a866830c03814f000d8f84b9739848ba1', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), h("span", { key: '43d58d11387c46d3e73c6057a50dd25c58a2d68d', part: "dropzone-text", class: "dropzone-text" }, this.multiple
            ? t('Lcz_DropFilesHereOrClickToBrowse', { fallback: 'Drop files here or click to browse' })
            : t('Lcz_DropFileHereOrClickToBrowse', { fallback: 'Drop file here or click to browse' }))), h("input", { key: '14fa59755779d65f64af814a4ab55b097589c768', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (h("div", { key: '194f3da354b9a5a0093d439eba6b27bab9c20710', id: "hint", part: "hint", class: "hint" }, h("slot", { key: '9f0623887bdf0e25dadad0d8473f2ace7d5d813b', name: "hint" }, this.hint))), this.files.length > 0 && (h("ul", { key: '9347212d224b97358c0119e924308aa9ddf3a714', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index) => {
