...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (h(Host, { key: '95ccafa0088a890e316dab7c60b8ee83bcf571e9' }, hasLabel && (h("label", { key: '7b66a9861bec92d0b009405519a0d1cb601f4d44', part: "form-control-label label", class: "label", htmlFor: "file-input" }, h("slot", { key: '9b5f16fd9ff5494c900648f0795722a3448a3c43', name: "label" }, this.label))), h("div", { key: 'a0deefca596aeee24ec81a7e2d1c3ff319349957', part: "base", class: "file-input" }, h("label", { key: 'fa389ac0643427dac55124ad712cc448f0fa96b2', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, h("slot", { key: '629c1fab70734cd3077148ea7accbac2d568d80f', name: "dropzone" }, h("wa-icon", { key: '49e0b18bb783757ee82b4339edf9aae8e85f0728', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), h("span", { key: 'b5ed1655eac881c8b489d027d083b813eeae1554', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), h("input", { key: '6fd9dbd5d8a154ec4d5fe0ab61757a2c2c272499', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (h("div", { key: '89f2295ba30864773dd682c6e6d3fdaf68aa5402', id: "hint", part: "hint", class: "hint" }, h("slot", { key: 'd0168a214dced1246f7d65a682e17b79427177f1', name: "hint" }, this.hint))), this.files.length > 0 && (h("ul", { key: 'f0bb1538bce6a431c90289f55b6d3bf5a7354953', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index) => {
