...
const IrModal = class {
    ...
    render() {
        return [
            h("div", { key: '8f57a2f1fa057054951bb24671e5a1f17bed1e78', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: '44fc37096774d81353a3ece8de7b4e1ec973084f', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'fecb5fc26c9c4b419d0d914a1ee923e001b3cc00', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '42cba5716db4c8067a2a85187a4968f92e7dbbc1', class: `ir-alert-header` }, h("p", { key: '50bbda1a3b30fe0458612f2262c1f9cab298afb5' }, this.modalTitle))), h("div", { key: 'dea00d33c980e29ba0476581329415fa1cfa219a', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '7776b96165f44315462aa0854b81b3811354c6da' }, this.modalBody)), h("div", { key: '80f73526901273b3e8f20dc84063261a15c754ac', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (h("ir-button", { key: 'bfb056b26c7ea0102ef72c2bfe1f3916f5b282af', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (h("ir-button", { key: '75e33d9580a6c286699514e891ffb60d80f87462', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
export { IrButton as ir_button, IrCheckbox as ir_checkbox, IrCommon as ir_common, IrHkTasks as ir_hk_tasks, IrIcons as ir_icons, IrInterceptor as ir_interceptor, IrLoadingScreen as ir_loading_screen, IrModal as ir_modal, IrSelect as ir_select, IrTasksFilters as ir_tasks_filters, IrTasksHeader as ir_tasks_header, IrTasksTable as ir_tasks_table, IrToast as ir_toast };
