...
import { c as createStore, l as locales$1 } from './locales.store-b670e120.js';
...
function renderBlock003Date(date, hour, minute) {
    ...
    return `${locales$1.entries.Lcz_BlockedTill} ${hooks(dt).format('MMM DD, HH:mm')}`;
}
...
export { computeEndDate as A, ZodIssueCode as B, downloadFile as C, sleep as D, toFloat as E, renderTime as F, getDaysArray as G, convertDatePrice as H, formatDate as I, checkUserAuthState as J, manageAnchorSession as K, getMyBookings as L, convertDateToCustomFormat as M, convertDateToTime as N, ZodError as Z, handleBodyOverflow as a, calculateDaysBetweenDates as b, calendar_dates as c, dateToFormattedString as d, extras as e, formatAmount as f, getReleaseHoursString as g, hooks as h, isBlockUnit as i, findCountry as j, canCheckIn as k, compareTime as l, createDateWithOffsetAndHour as m, dateDifference as n, formatLegendColors as o, formatName as p, getRoomStatus as q, transformNewBLockedRooms as r, bookingStatus as s, transformNewBooking as t, getPrivateNote as u, validateEmail as v, getNextDay as w, addTwoMonthToDate as x, convertDMYToISO as y, z };

//# sourceMappingURL=utils-dfff1e63.js.map