...
import { a as OverflowRelease, O as OverflowAdd } from './OverflowLock-C918jXZs.js';
...
const IrDialog = class {
    ...
    render() {
        return (h("wa-dialog", { key: '09fb4008b3cab8c88ffc2f5d9396e8ee72a55645', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '7ae0671b6db5079fd2f53221290ba33ec865e55f', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'b4c7a5f55c2815380901118fafcc79022de0b741', name: "label", slot: "label" }), h("slot", { key: 'd69ba2ac2fb2f0b607e791acb9fbaebcaed46807' }), this.slotState.get('footer') && h("slot", { key: '323b31a3494f866774ce88fd5205512a83d2e38b', name: "footer", slot: "footer" })));
    }
};
__decorate([
    OverflowRelease()
