...
import { z, Z as ZodError, h as handleBodyOverflow } from './utils-47ed7fdc.js';
import { A as AuthService } from './authenticate.service-b92cac55.js';
import { C as CONSTANTS, U as UserService } from './user.service-90f1a789.js';
...
const IrIcon = class {
    ...
    render() {
        return (h("button", { key: '8f63fa1c5019766580b403b7194bb58b1851c34c', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, h("slot", { key: 'df1750649f37f4ec6706c3d0c14967664b934c3e', name: "icon" })));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (h(Host, { key: '70f8b1c8de54c0e4df76a6643e8a7447cee2fb85' }, h("span", { key: '93c5d2a961d7cc7bc5770aff2ead6f012c0a565a', class: "loader" })));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (h(Host, { key: 'daabb4b54b8feb94705778468acaf16287fcd15f', class: "otp-input-container" }, h("div", { key: '6f5ba14cea724f4e9def673983e533d1de759c82', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPasswordValidator = class {
    ...
    render() {
        return (h("div", { key: '16e72b9a29169527a33bf5d8f2763ce740faec92', class: "m-0 p-0" }, h("requirement-check", { key: '3ab3f1a1e9c505e5e5ce71a3348c127457ee176b', isValid: this.validLength, text: "Minimum 8 characters" }), h("requirement-check", { key: 'b1f998677d36385aefab9f388100b4549c849103', isValid: this.hasUppercase, text: "At least one uppercase letter" }), h("requirement-check", { key: '899690cdaac7b96d6531b1398ed90fb3460efa25', isValid: this.hasLowercase, text: "At least one lowercase letter" }), h("requirement-check", { key: '0773cf275de2d5e8ab2c14fc9d7e62710d313836', isValid: this.hasDigit, text: "At least one digit" }), h("requirement-check", { key: '1ab7540b053fdda15defb1faf2431752c4165613', isValid: this.hasSpecialChar, text: "At least one special character" })));
    }
    static get watchers() { return {
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (h("form", { key: '6eb21f4cc1ff56fc47c4361092629ce569a3a299', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, h("ir-title", { key: '74be88578f79ba1bc47e8fe393fa8a05081c6995', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), h("section", { key: '4693a5852cf666b38b6b4c754b9578bd0b5709e2', class: "px-1 sheet-body" }, h("ir-input-text", { key: '47842d61ed80248500a4247af253e13231978c88', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), h("ir-input-text", { key: '3092601a05f98ffd7ca3cf59995dbfd5caf543ad', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: "Mobile", mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (h("div", { class: "mb-1" }, h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), firstOption: 'Select...', selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (h(Fragment, { key: '84c545a3ae910da998731cd9e03b606358deb1fe' }, h("input", { key: 'efbce05faa01a39db243f808e7224ed0792b2c37', type: "text", name: "dummy", style: { display: 'none' } }), h("ir-input-text", { key: 'ebc1158e661c21a494992065c8029073a57c37fe', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: "Username", disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username, onInputBlur: this.handleBlur.bind(this), maxLength: 40, autoComplete: "off" }))), !this.user ? (h(Fragment, null, h("input", { type: "text", name: "dummy", style: { display: 'none' } }), h("ir-input-text", { testId: "password", autoValidate: this.user ? (!((_l = this.userInfo) === null || _l === void 0 ? void 0 : _l.password) ? false : true) : this.autoValidate, label: 'Password', value: this.userInfo.password, autoComplete: "off", type: "password", maxLength: 16, zod: this.userSchema.pick({ password: true }), wrapKey: "password", error: (_m = this.errors) === null || _m === void 0 ? void 0 : _m.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (h("section", { key: '33cda740aeae1fcbbeb82efd38189c924dfcb94e', class: "logins-history-section mt-2" }, h("div", { key: '649a5511a478d857200402632d07afa5aaf05f6f', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: 'b4c3696c917cf3aed6542e088185bf33dd597104', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: 'edead86751185ccb372f565b0e97e2ef3b224564', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: '4e243fc514bbef58b32685e8af2d15ee50e34d48', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), h("ir-sidebar", { key: '34488356a41e8b57d937d9cbfdf496534d44e2e4', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: '8a0b918305a4c76d8be8fb880541dbbafd696e51', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), h("div", { key: '6cdb44620ed3e84e7748c036230dc9f9479d8f8c', class: "sheet-footer" }, h("ir-button", { key: '14194f86fbea5ee1988f98a9bdc966a66c852925', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: 'bc2d67b276543305dd7a8f8b45f59736a0e7ae01', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'f119e8e9487700bdb781532ac276e351c0c53c19' }, h("section", { key: '427b562a1c06c58308f28bca02b6dea0067d24fe', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, h("table", { key: 'b2237ef18d8c500be3c15466392c4ea7daf058d3', class: "table" }, h("thead", { key: '65dd8c902d19337da35a1880747791afe2a36f7e' }, h("tr", { key: 'efafcb69609639d89d1bf98b44265a374f63e003' }, h("th", { key: '7ceecf0e1aaa2132164f598d433aa441f76e2e9b', class: "text-left" }, (_a = locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), h("th", { key: 'f5ad5cf72717bb24fb46a5b6ea36ae78e238fd1a', class: "text-left" }, locales.entries.Lcz_Email), h("th", { key: '5bfc279ece526baad47700445b4fb0f836855d5a', class: "text-left" }, (_b = locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), h("th", { key: '417e0fe514d980c46da049d21f3bdc4e42f1c241', class: "text-left" }, "Role"), h("th", { key: '8f4cf2fd2944a58799703ae682745a8dc24d117e', class: "text-left small", style: { fontWeight: 'bold' } }, h("p", { key: '1fcda7ac39a780b631328a6425757be3e5709757', class: "m-0 p-0 " }, "Created at"), h("p", { key: 'b2a8cff386d3dcda4df086bf1a48ee3e9c0e4cc9', class: "m-0 p-0" }, "Last signed in")), this.haveAdminPrivileges && h("th", { key: '7b52e204659b2043d4067b199c1e34ae86c56bc5' }, "Active"), h("th", { key: 'dd97a904fb8f1856ac6fb48a992dacb3a2c4682c', class: 'action-row' }, this.canCreate && (h("ir-icon", { key: '7dd1c1a68db2312aaa580eac32d43b6187064dd0', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, h("svg", { key: 'e17d131cb953b463817cbb1f0066bc78a31319f6', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: '6794379167515cf1c79854297e9bd63afeb0a43d', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), h("tbody", { key: '1a0cef5dea83835fc248c277bce2fa0d0e4b099f' }, this.users.map(user => {
            var _a;
        ...
        })))), h("ir-sidebar", { key: '7424db8c3248fba59bc1a857267a04d3438cf452', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
