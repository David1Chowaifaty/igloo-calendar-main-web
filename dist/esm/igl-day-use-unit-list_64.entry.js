...
import { E as ExtraServiceSchema, R as ROOM_IN_OUT, v as validateSharedPerson, Z as ZSharedPerson } from './booking.dto-FOZcMojD.js';
import { f as formatDate } from './ir-date-DFR8GVLZ.js';
import { f as formatAmount, a as formatBookingNumber, b as formatCount, c as formatNumber } from './number-DegV2dS7.js';
import { L as LocaleController, S as SCREEN_TABLES } from './locale.controller-DKzzcKD9.js';
import { i as isAgentMode, _ as _formatTime, a as _formatDate, b as _getDay } from './functions-D_076Gzf.js';
import './locales.store-CXJn6ls-.js';
import { a as actionableClTypes, m as mapClTxToFolioRow } from './city-ledger.service-qPrQl7Me.js';
...
import { S as SetupEntrySchema } from './IBooking-B-QQODPH.js';
import { t as toAccChargeRule, f as findAccTax, b as getTopLevelSvcCategories, g as groupSvcCategoriesByParent } from './svc-category.utils-g9PVvjZL.js';
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (h("ir-dialog", { key: '9298d0696770463c3933fb611ffaa0dfa40a801e', open: this.open, label: t('Lcz_ExpectedArrivalTime', { fallback: 'Expected Arrival Time' }), ref: el => (this.dialogRef = el), onIrDialogHide: e => {
                e.preventDefault();
            ...
            } }, h("div", { key: 'a9a42877e7cef9e7078c1ccc71bf487757f9275b', class: 'ir-time-dialog__body' }, h("div", { key: 'c39f7ca262afc44ed8ff8a0853666273b7328527', class: 'ir-time-dialog__current-unit' }, h("span", { key: 'f3152bc70f00e63039273291affc6a0939187cd1' }, this.room?.roomtype?.name), " ", h("span", { key: '32d201269aa33818a21136540fbb6001345c8c8e' }, this.room?.rateplan?.short_name), " ", h("ir-unit-tag", { key: '46117a686cfe5e09239084a64e242ba02d86c352', unit: this.room?.unit?.name })), h("wa-select", { key: 'bcf7a5198f942fa60a82dfe9b0cc9aa9ea90900b', size: "s", placeholder: t('Lcz_NotProvided', { fallback: 'Not provided' }), value: this.selectedValue ?? '', "onwa-after-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: this.selectedValue ?? '', onchange: e => (this.selectedValue = e.target.value) }, this.arrivalTime?.map(time => (h("wa-option", { key: time.CODE_NAME, value: time.CODE_NAME }, time[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? time[`CODE_VALUE_EN`], this.isEarlyCheckIn(time) ? t('Lcz_EarlyCheckInSuffix', { fallback: ' (Early check-in)' }) : '')))), this.selectedIsEarlyCheckIn && (h("div", { key: '25a3e709928c2602c41d93ee82b9681d129eb636', class: "ir-time-dialog__insight" }, h("div", { key: 'b49134f2cbf22cbf6b958762deeada0b95d1f773', class: "ir-time-dialog__insight-row" }, h("wa-icon", { key: '1acbd5e10a546d9795051d1a62a669fa7eca0f0c', class: "ir-time-dialog__insight-icon", name: "clock" }), h("div", { key: '1e6416562e78c46d25276fa0168d7cac07e95d7d', class: "ir-time-dialog__insight-copy" }, h("p", { key: '628a7e71d25be3a2f78009dce68d87d2bc3a748b', class: "ir-time-dialog__insight-title" }, t('Lcz_ChargeAsEarlyCheckInQuestion', { fallback: 'Would you like to charge it as an Early Check-in?' })), h("p", { key: 'c5838df56bed5431b8d7c0950105ba37048dbf6e', class: "ir-time-dialog__insight-subtitle" }, t('Lcz_AddedAsAccommodationExtraServiceHint', { fallback: 'This will be added as an accommodation extra service' })))), this.createExtraService && (h("div", { key: '15390964ce9de630dd6d016eb0b78b4af33915b5', class: "ir-time-dialog__insight-price" }, h("ir-validator", { key: '95814a768a6b5ff683f25d022e9dfc7defa8bbb6', value: this.extraServicePrice, schema: ExtraServiceSchema.shape.price }, h("ir-input", { key: '5b4e93d587bb56c72450487ea6fa3291d8896cbb', "onText-change": e => (this.extraServicePrice = Number(e.detail)), defaultValue: this.extraServicePrice?.toString(), value: this.extraServicePrice?.toString(), mask: 'price', withClear: true, type: "text" }, h("span", { key: '47dc05371178058702ea49c9d7dd9c686ec4fea1', slot: "start" }, this.currencySymbol)))))))), h("div", { key: '5f9c0c953bdda56bd94250841239b8b9f8c8d045', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '65aece8dc6fc03e7eed5fad40aa59637b4f677d3', size: "m", variant: "neutral", appearance: "filled", "data-dialog": "close" }, t('Lcz_Cancel', { fallback: 'Cancel' })), h("ir-custom-button", { key: '488c3f52af7a4bd4a0f1546a1b2077da056c8eec', size: "m", variant: "brand", loading: this.isLoading, disabled: !this.selectedValue, onClickHandler: e => this.handleConfirm(e), appearance: "accent" }, t('Lcz_Save', { fallback: 'Save' })))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (h("ir-drawer", { key: '1fd565f4b4b92922c7208ed3a0ccba210c6ae5f0', style: {
            ...
            }, open: this.open, label: t('Lcz_Billing', { fallback: 'Billing' }) }, this.open && h("ir-billing", { key: '21a6a4a7e35696c14e2833611411bfa4bbe57720', isAllServicesAgentOwned: this.isAllServicesAgentOwned, booking: this.booking, agent: this.agent })));
    }
};
...
const IrBookingDetailsDrawer = class {
    ...
    render() {
        return (h("ir-drawer", { key: 'ff4044ec08dd9bb170d61f79d12745612fef79d9', onDrawerHide: this.handleClose, withoutHeader: true, open: this.open, style: {
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        ...
        })))), this.selectedGroupCode && this.subCategories.length > 0 && (h("ir-validator", { key: '58e53ec7ed52b5ad3e4f9ab4716e39479c224c5b', value: this.s_service?.category?.code ?? null, schema: stringType({ required_error: t('Lcz_SubcategoryIsRequired', { fallback: 'Subcategory is required' }) })
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (h("form", { key: '310a40613f135ced19c84f15b09c964d5c1bfd69', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, h("ir-date-select", { key: 'bac6312df186c1851989fc2a267f15a3ba18120c', id: this.controlIds.date, label: t('Lcz_DateLabel', { fallback: 'Date' }), "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), h("ir-validator", { key: 'd92187d846a7f2d5c9c730357fca5b884bdad626', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, h("wa-select", { key: 'ad1c8216c2a3e5843466e44cee751bcb475efc8d', id: this.controlIds.transactionType, size: "s", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: t('Lcz_SelectPlaceholder', { fallback: 'Select...' }), label: t('Lcz_TransactionType', { fallback: 'Transaction Type' }), defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, h("wa-option", { key: 'f22cd821e05eaaf5a6885a3094cabdb5d41c38a8', value: "" }, t('Lcz_SelectPlaceholder', { fallback: 'Select...' })), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (h("ir-validator", { key: 'cde6de07625fb8304632b43cd029741061ba0b24', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, h("wa-select", { key: 'c6a5ad2c35e15d92ba06c53f0010217130ff97fb', id: this.controlIds.paymentMethod, size: "s", label: this.folioData.payment_type?.code === '001' ? t('Lcz_PaymentMethod', { fallback: 'Payment Method' }) : t('Lcz_RefundMethodLabel', { fallback: 'Refund method' }), "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, h("wa-option", { key: '43997fccd12da11aacc47cb616fcdc8e9c41e89c', value: "" }, t('Lcz_SelectPlaceholder', { fallback: 'Select...' })), this.paymentEntries?.methods?.map(pt => {
            return (h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), h("ir-validator", { key: '796c64b659d777c7bc2dce828f5ce9d71c5adb2f', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, h("ir-input", { key: 'f11f85fc961e09157dd5fd663cf7e34fa1f98420', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: t('Lcz_Amount', { fallback: 'Amount' }), mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, h("span", { key: 'be825d7ff9022bb97c6410a02b5e98bc1a7d4a67', slot: "start" }, calendar_data.currency.symbol))), h("ir-validator", { key: 'a33cf89474007c3ac392805883cbc4c0b601c100', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, h("ir-input", { key: '18512996bbc483dccfdd0363c92df417eb367611', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: t('Lcz_Reference', { fallback: 'Reference' }), maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
        "payment": [{
...
const IrPickup = class {
    ...
    _id = `pickup-form-${v4()}`;
    render() {
        return (h("ir-drawer", { key: '7e789fb9d79af14162fa95e275911161d8e7dc28', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (h("ir-pickup-form", { key: '9d61029f4764534ca236be27eb83ea7a1e655a2c', booking: this.booking, agent: this.agent, onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), h("div", { key: 'f39c24dfea2157930c14ef83e9af1dc11c14410c', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: '0ae6dc9af89bdcce08668a2382d18320b12c58cb', class: `flex-fill`, size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, t('Lcz_Cancel', { fallback: 'Cancel' })), this.canSubmitPickup && (h("ir-custom-button", { key: '8a400b75b5708f13a582c04c1531c0500393d763', type: "submit", loading: this.isLoading, form: this._id, size: "m", class: `flex-fill`, variant: "brand" }, t('Lcz_Save', { fallback: 'Save' }))))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (h("form", { key: '6c0dcf206e0b71077ce4d4d6569409ecb37a285f', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-validator", { key: '522dfd47c9ca2a976336798080bef2d7f44c8dca', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '98ff61850fc68b315747ca52dfe13676fae3ff6b', size: "s", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, h("wa-option", { key: '02aa57a216fc2b0a21a7e43b74e950d51af39189', value: "" }, t('Lcz_Pickup_NoThankYou')), this.pickupService.getAvailableLocations(t('Lcz_Pickup_YesFrom')).map(option => (h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (h("div", { key: '109bcdefec2a92fd053c9776fe6ea66371f6a89a', class: "pickup__container", "data-testid": "pickup_body" }, h("ir-validator", { key: 'a051347df40835eb49ea866345ccec8ba48b37e4', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, h("ir-date-select", { key: '910627a9b06c73b9422419883bd48bfc67f93640', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: t('Lcz_ArrivalDate') })), h("ir-validator", { key: '949109a3c00dcf922fcb56f44bd9111a5e30a90e', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-input", { key: '90b9bc8c9873455a4eb0aaea13ae1019d55bd390', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: t('Lcz_Time') })), h("ir-validator", { key: 'c5822c6ba6b6d6738e2630ac6badcc4ccc63cda9', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, h("ir-input", { key: 'eeb98a1893b2eb20ce307f2dea508d7653fb85b0', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: t('Lcz_FlightDetails') })), h("ir-validator", { key: '32d4e99e7c2fc2acc6397f660358f1a5fce8bb9d', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: '807bbc63fa27fda0e2bb87f9f0b2ce5e55591583', size: "s", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), h("ir-validator", { key: '9ca1d5abf177e8e97410c3735bb884494c8381e7', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, h("wa-select", { key: 'b2b3cc33b99869e81f36ec454c385a5059d6b006', size: "s", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: t('Lcz_NbrOfVehicles'), onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), h("ir-input", { key: '0bdfa90236b89f407be706fe751673c07d8f502d', mask: 'price', label: `${t('Lcz_DueUponBooking')}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, h("span", { key: '84bf25a6c62e97366740ef08ee42fd29cd9321fd', slot: "start" }, this.pickupData.currency?.symbol)), isAgentMode(this.agent) && (h("ir-service-assignee-select", { key: 'c52bf586ca687f5aa76685b41cb87cadb2772f03', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.assignee = e.detail;
            } }))))));
...
const IrRoom = class {
    ...
    render() {
        return (h(Host, { key: '6638f635dc3dc2d18c6cd5dba3983e91ddc67c1c' }, h("div", { key: '7ef0789ac1f472468d7614a40b30628eee0c067e', class: "booking-room__header-row" }, h("button", { key: 'fd73e6b9a5eb89e1a0e4f311c357f1788547b13f', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '687f56ea7ba82f30d7f6c4145ad0f16af4c41d36', class: "ir-flip-rtl", name: "chevron-right" })), h("div", { key: 'f24f91867114293029aff92d3dc95607478dc981', style: { width: '100%', cursor: 'default' } }, h("div", { key: 'cc28d24f4a426d153f6a209047c7c7a795ae932d',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, h("ir-room-header", { key: '92a628d52404b65e6571d9107037b0c182585baf', room: this.room, myRoomTypeFoodCat: this.myRoomTypeFoodCat, mealCodeName: this.mealCodeName, currency: this.currency, isEditable: this.isEditable, hasRoomEdit: this.hasRoomEdit, hasRoomDelete: this.hasRoomDelete, agent: this.agent, onAction: e => this.handleHeaderAction(e.detail), onOpenHbDialog: () => (this.isHbDialogOpen = true) }), h("ir-room-details", { key: 'e71ccfcae070e3f125549e1fb19b9896b4e54456', room: this.room, booking: this.booking, mainGuest: this.mainGuest, bedPreferences: this.bedPreferences, language: this.language, includeDepartureTime: this.includeDepartureTime, hasCheckIn: this.hasCheckIn, hasCheckOut: this.hasCheckOut, onCheckIn: () => this.handleCheckIn(), onCheckOut: () => (this.modalReason = 'checkout'), onViewGuests: () => this.showGuestModal(), onOpenArrivalDialog: () => (this.isArrivalDialogOpen = true), onOpenDepartureDialog: () => (this.isDepartureDialogOpen = true) })), !this.collapsed && h("ir-room-breakdown", { key: '96c6372f12eb88048fb657f1c92bd1de387fed75', room: this.room, booking: this.booking, currency: this.currency, clTransactions: this.clTransactions }))), h("ir-room-extra-services", { key: '41f18b2f8c5d493b8b1d4abf91ceb70f877da207', room: this.room, booking: this.booking, isEditable: this.isEditable, agent: this.agent, currency: this.currency, language: this.language, svcCategories: this.svcCategories, clTransactions: this.clTransactions, onRequestAddExtraService: () => this.handleAddExtraServiceToUnit() }), h("ir-assignment-toggle-dialog", { key: 'bf1135ca91db89741932024fb716378e593f7e08', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, h("span", { key: 'cf6c5dc346746e6d9b0d14e100ec0d41558f9137', slot: "message" }, t('Lcz_MoveToFolio', {
            ...
            params: [
        ...
        }))), h("ir-dialog", { key: 'c716cd2f9a9739b5494f424f9a3b558bc64d546d', label: this.modalReason === 'delete' ? t('Lcz_Alert', { fallback: 'Alert' }) : t('Lcz_Confirmation', { fallback: 'Confirmation' }), ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, h("p", { key: '1ad3a8879356bcd2e2637da14d29947d7ca434fb' }, this.renderModalMessage()), h("div", { key: '82680b906602c7beda31959599a18aeada62ecfc', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '4c49175715f58c8a5a4727fb2deb5c6996fd09a1', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, t('Lcz_Cancel', { fallback: 'Cancel' })), h("ir-custom-button", { key: '2268286f79323aaee8487e0cea2e3479d177fc08', size: "m", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? t('Lcz_Delete', { fallback: 'Delete' }) : t('Lcz_Confirm', { fallback: 'Confirm' })))), h("ir-checkout-dialog", { key: 'e3cef9584dadd667c596abc6f7974a3a35c15db7', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), h("ir-invoice", { key: '8e4554ab9096e6c6dc5e296a19f8822e458cec23', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, open: this.isOpen, booking: this.booking, roomIdentifier: this.room.identifier }), h("ir-booking-pricing-drawer", { key: '3d5e17277526e4e5e3f65395f95def92a50192ea', open: this.isPricingDrawerOpen, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.clTransactions, currencySymbol: this.booking?.currency?.symbol ?? '', onCloseDrawer: () => (this.isPricingDrawerOpen = false), onPricingSaved: () => {
                this.isPricingDrawerOpen = false;
                this.resetBookingEvt.emit(null);
            } }), h("ir-hb-preference-dialog", { key: '82207a4beed283fdbab6ca2cf5ff1729ba05c8dd', room: this.room, open: this.isHbDialogOpen, onHbPreferenceClose: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrRoomExtraServices = class {
    ...
    render() {
        ...
        const agentName = this.booking.agent?.name ?? t('Lcz_Agent', { fallback: 'Agent' });
        return (h("wa-card", { appearance: "filled", class: "booking-room__extra-services" }, h("div", { slot: "header", class: "booking-room__extra-services-header" }, h("span", { class: "booking-room__extra-services-label" }, h("span", { class: "booking-room__extra-services-title" }, total > 0 ? t('Lcz_Extras', { fallback: 'Extras' }) : t('Lcz_AddExtras', { fallback: 'Add Extras' })), total > 0 && h("span", { class: "booking-room__extra-services-count" }, formatNumber(total))), canAdd && (h(Fragment, null, h("wa-tooltip", { for: `add-extra-service-${this.room.identifier}` }, t('Lcz_AddExtraService', { fallback: 'Add extra service' })), h("ir-custom-button", { id: `add-extra-service-${this.room.identifier}`, class: "booking-room__extra-services-add", iconBtn: true, size: "s", appearance: "plain", variant: "brand", onClickHandler: () => this.requestAddExtraService.emit() }, h("wa-icon", { style: { fontSize: '0.9rem' }, label: t('Lcz_AddExtraService', { fallback: 'Add extra service' }), name: "plus" }))))), inAgentMode ? (h(Fragment, null, h("div", { class: "booking-room__extra-services-group booking-room__extra-services-group--agent" }, h("p", { class: "booking-room__extra-services-group-label booking-room__extra-services-group-label--agent" }, agentName, h("span", null, t('Lcz_Folio', { fallback: 'Folio' }))), agentServices.length === 0 ? (h("p", { class: "booking-room__extra-services-empty" }, t('Lcz_NoAgentServicesAdded', { fallback: 'No agent services added' }))) : (this.renderServiceGroup('agent', agentServices))), h("wa-divider", null), h("div", { class: "booking-room__extra-services-group booking-room__extra-services-group--guest" }, h("p", { class: "booking-room__extra-services-group-label" }, t('Lcz_Guest', { fallback: 'Guest' }), h("span", null, t('Lcz_Folio', { fallback: 'Folio' }))), guestServices.length === 0 ? (h("p", { class: "booking-room__extra-services-empty" }, t('Lcz_NoGuestServicesAdded', { fallback: 'No guest services added' }))) : (this.renderServiceGroup('guest', guestServices))))) : (this.renderServiceGroup('all', services))));
    }
};
