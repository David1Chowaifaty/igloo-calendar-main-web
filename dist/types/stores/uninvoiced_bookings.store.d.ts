import { ICriteriaChannel, ICriteriaStatuses, ICriteriaTypes, IExposedBookingsCriteria } from "../services/booking-listing/types";
...
export declare function setUninvoicedBookingsCriteria(criteria: Pick<IExposedBookingsCriteria, 'channels' | 'statuses' | 'types'>): void;
