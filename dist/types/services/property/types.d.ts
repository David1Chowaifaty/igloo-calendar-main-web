...
export declare const GetUnifiedFolioParamsSchema: z.ZodObject<{
    ...
    o_Total_Rows: z.ZodNullable<z.ZodNumber>;
    is_export_to_excel: z.ZodBoolean;
    Link_excel: z.ZodString;
}, "strip", z.ZodTypeAny, {
    property_id?: number;
    from_date?: string;
    to_date?: string;
...
export declare const UnifiedFolioTargetTypeSchema: z.ZodEnum<["AGENT", "GUEST"]>;
export type UnifiedFolioTargetType = z.infer<typeof UnifiedFolioTargetTypeSchema>;
export declare const UnifiedFolioRecordSchema: z.ZodObject<{
    TARGET_TYPE: z.ZodEnum<["AGENT", "GUEST"]>;
    ...
    GUEST_NAME: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    GUEST_EMAIL: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    BOOKING_ID: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    BOOKING_NUMBER: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    DOC_ID: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
