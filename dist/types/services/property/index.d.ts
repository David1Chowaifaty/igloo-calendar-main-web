...
export declare class PropertyService {
    ...
    getDayUseBookingsForCalendar(params: GetDayUseBookingsForCalendarParams): Promise<DayUseBookings[]>;
    calculateNetAmount(params: CalculateNetAmountParams): Promise<number>;
}
