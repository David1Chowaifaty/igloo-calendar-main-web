...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0621ad3d7504aef00b1fee6a136e2328ab43e31b', class: "otp-input-container" }, index.h("div", { key: 'deefe0dab40d70627e1b7f63c426d42003338f8a', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'cf1efbe84b638e9cbbacce711701478021281974' });
    }
