...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '19a5631c8acfe7efcc34a419ffc13b83f2a627dd', class: "otp-input-container" }, index.h("div", { key: 'b9835906a3310c430838a913f4f4e4efd50dc669', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'e5d7804096fac4efbca47dc3d30c6ad614a7fefb' });
    }
