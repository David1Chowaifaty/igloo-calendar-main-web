...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd40a028d240044a60fea38694ae8e7ad27bfbc76', class: 'px-0' }, index.h("ir-title", { key: '953f5461267a9a66e2a8cd56d77cfa0f5a89bb5b', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("form", { key: '1bf0ccd328e5f9186283b733541090919beef28a', class: 'px-1', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-textarea", { key: 'c5e9c4e6473713cb6e8b04b2f744a28b11ac225e', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) }), index.h("div", { key: '3df2b921a0e2471a941059af1703ca000e4fc52f', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '66574c98e52b2454ab07496d68f3a524d2e015e6', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'b2c19e249d3ddbcef599b59de32cd18b5a622c29', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (index.h("div", { key: '8462eefb8638b790fd78a987c7d9828e37de2431', class: "fluid-container px-1" }, index.h("div", { key: '83f5321344136bd2a342eedd0565d963ce1c72ce', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '213b9461d736031ae95e4fcd237a538f1b225d7a', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'd8a0812398d45ff7f3eba1a9c5df2cb4b52da146', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '6b7028ac4a655df63d6eab4828b0cb68d36df13e', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '2b5564ad7226032dea616be7282ee407c41f7859', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'd2d506aae386458dcc062b12f52ad8599e65201a', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: 'bd2a714f6269ec1881406255e764b5d9d98fd4c4', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '29f5d98a7e7037476eb477c31ae16ea05f6aeb6c', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: 'e58112ae395e506d6591f3895a73f45916175cee', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: 'a2325c1d69c0a7a9655ad9d64987e169683e4f7c', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '7a946044b171f7ceedc132500b954bffa2fc1294', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '2413095c947624932fb0eb18e5dd78bc6105776e', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '2086c95d985e592f516eb77c4bcc907a57dc1e30', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: 'f6c701f4380f14dff983950311403ecf263b95e4', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '3a476411b289e927a531d1cd85b3a22ca4dba60a', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '55eb167b725769ea2d3cc43abf8d06caa6ef990e', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '02c82fe82cb9d5db75cbd4988479e2da338d09f4', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '2fcfcabe975529a40e1e8cdfc2e533dfeac30363', onOpenChange: e => {
                if (!e.detail) {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4e1bb56b72f733e5ea3c3a44280a7ae367e2feb2' }, index.h("div", { key: 'aaf9f8e0c08f7c605b158a5273e1abb8b997667c', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '042ea6f09eac6c4d273fb81b280264a6f4e68df6', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '709ee6d560af905d165175d9db05924b2c3e45eb', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'a10df4b803842790e1544dd278602a4973a7850e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '224e7b3626512d9337a9d23e3aac25d621c546fb', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'f8afd10ba89b6b78f938c666463ebf297fc3a0b1', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '48cdf56e3a56c96150de066ab5a3d26444c4768a', name: "modal-title" })), index.h("div", { key: '6a2866ec44f3bc14511d24149e169a05ec22f395', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'fcc0afa1d8ae3498b3620679060ba07b0f6f49e8', name: "modal-body" })), index.h("div", { key: 'b2d543a838e8eedea1888e7c55832399b43d298e', class: "modal-footer" }, index.h("slot", { key: 'bbcc7c53ec623442ca87febb7266f6744961c099', name: "modal-footer" }))))));
    }
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '238347379ae76ea4ce5502e45a24e9801f088009', class: 'p-0' }, index.h("ir-title", { key: 'ccbe6ebaa6118157ca4b1eef8cfd361b7ea3ad2a', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: 'cfd508deaaa04ddb8182bcd891c0bf7b58709dd1', class: 'px-1' }, index.h("fieldset", { key: '0913a1cf084a22abd33a6579965158867d3263cf', class: "input-group mb-1 mt-3 service-description" }, index.h("div", { key: '1683c89cc8e3a485900c05ca0fca4d277d32339e', class: "input-group-prepend" }, index.h("span", { key: '7419624e74748a59a45cf60bd4f4a17d9d2d2835', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '85d77455358f6ff309ceb7074416d936ed5c832a', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '622da7a32032d481b41ff39dae09c6a27fd89a4e', class: 'row-group mb-1' }, index.h("div", { key: '2b55541beeef20907f0d040093516d46c2d9a363', class: "input-group" }, index.h("div", { key: '5fc1086c689d673220ddcba1f91c20746de799a0', class: "input-group-prepend" }, index.h("span", { key: 'a2f766393e99823b4e845935a46e9caaea726f1b', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '8e9e3c3ef98aa2a9b86a3ce7189800cd2abae8de', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '5534dbfe2d18886e42ad5e516c66c720effeb05e', class: "service-date-container" }, index.h("ir-date-picker", { key: 'c6310149b4b44809361f573fb1a3d1d61b3f52c7', emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: '844c79003eb27b259feb604aaf77081fa5f83307', slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: '9a0744c5fa1e72f77dc3f5e6a3cdd0171907e493', class: "btn-container" }, index.h("ir-button", { key: '4f146e7e04a85f56cf2735970e237a1daf0f82d5', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: 'bd3000f22c1fe37b1b022ccef0efb74c38d2408c', class: "input-group" }, index.h("div", { key: '928c40206a3484904f822d728dd1492a15ed7aa0', class: "input-group-prepend " }, index.h("span", { key: '7bc38542dfe583b3cbb5041902c1b9875e066ce9', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'babdaf308324a4c39e6d1322a81c01a82f99c319', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: 'a000544f5cfe87e93004eda85a0d87b757109d1b', class: "service-date-container" }, index.h("ir-date-picker", { key: '90a9e0575a2f6a894357f96956dfa1cd6c0c07d7', emitEmptyDate: true, date: (_f = this.s_service) === null || _f === void 0 ? void 0 : _f.end_date, minDate: (_h = (_g = this.s_service) === null || _g === void 0 ? void 0 : _g.start_date) !== null && _h !== void 0 ? _h : this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                var _a;
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: 'e3985b8435378c44e9b51d7a4e8853e25eda6103', slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: 'a9508ab68593439049d9c14c59ca46dbfd4cfff6', class: "btn-container" }, index.h("ir-button", { key: 'ba51e3700ebd50b61eb43989d6e5fd2c1dcd436b', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '8bf716b6924c34c1c8da011a4ef0660e6342eab0', class: 'row-group' }, index.h("ir-price-input", { key: '497d1e54cdce73cb15b4fd448241de468c6586d8', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '2838cf9739eb74609a66d4ca1a6a06cff9d36b36', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "cost-label", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" })), index.h("div", { key: '80cd8f1a381de635900a4ad7c15833da765c885d', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '631f4abfdb99ed6fc9b7a74f21a819c318fd901c', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill mr-sm-1`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'd6633d9eb4161e383364af0ae43dc1c8f7d9fd96', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.saveAmenity.bind(this) })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '9e3e6da12c06e1966e010dc4a633f1cdf322592e', class: 'p-0' }, index.h("ir-title", { key: '2700326406259f021d7782245cbed1053ac38700', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '94124c9411bb01ecac51d0201b5b8823962b86b2', class: 'px-1' }, index.h("ir-select", { key: '240bf69889cbf2e00f72fec12e3b0883edb7a24d', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h(index.Fragment, { key: 'f168179beed40fbfd9cef09f0ef7ca92247aa431' }, index.h("div", { key: 'dde20c5e5e35c3ac2056ab2d67a6b5ec20f1fa7f', class: 'd-flex' }, index.h("div", { key: '93dd3f3c1122c8b7f59dcdf7f3d73f57bc977b94', class: "form-group  mr-1" }, index.h("div", { key: '31f3b423def932e07ac2faea065671ab82dcb39e', class: "input-group row m-0" }, index.h("div", { key: '74324aae40ee244654322bb4ce29e2ef13a70931', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '18f918c7717bd7e3d0537b4b70ee8c42dc8fcffe', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'd89befaadc73824fafff887f793373326030121a', class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, index.h("ir-date-picker", { key: 'd741dcef1d3072974d1baff8619bd00ff434a8e0', date: this.pickupData.arrival_date, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, minDate: this.bookingDates.from, onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '88a022ac0241d2a0d160a3cb236a95e92031814c', type: "text", slot: "trigger", value: moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY'), class: "form-control input-sm text-center", style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' } }))))), index.h("div", { key: '683e13c7b369a84cac1badb29a5e8bac6082b048', class: "form-group" }, index.h("div", { key: '50a2c5468912abed7888e7a4875f05b48e343275', class: "input-group  row m-0" }, index.h("div", { key: '8a94c203634f5861387a525beb0e55c9d18b3ffc', class: `input-group-prepend col-4 col-sm-3 p-0 text-dark border-0` }, index.h("label", { key: 'f2cc0e59a5425001832d2e4bd62adb2fffb9436d', htmlFor: "pickup", class: `input-group-text flex-grow-1 text-dark border-theme` }, locales_store.locales.entries.Lcz_Time)), index.h("input", { key: 'cf81d3de37630f63c3a05ca6a90ea75967db513c', type: "text", value: this.pickupData.arrival_time, id: "pickup-time", class: `form-control col-8 col-sm-4 ${this.cause === 'arrival_time' && 'border-danger'}` })))), index.h("ir-input-text", { key: '67f18e61341e3a3c76620cffda7cb55985c213a5', value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", inputStyles: this.cause === 'flight_details' ? 'border-danger' : '' }), index.h("ir-select", { key: 'cc2a4efa8ae0e9b95e467226faaf2690b53c3fb2', selectContainerStyle: "mb-1", selectStyles: this.cause === 'vehicle_type_code' ? 'border-danger' : '', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '8168bfa5aacf57e43ba132b563bf9bd661be3713', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'a9ae5215a6891f007474c403260476e4d7b12246', labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectStyles: this.cause === 'number_of_vehicles' ? 'border-danger' : '', selectedValue: this.pickupData.number_of_vehicles, labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("ir-input-text", { key: '8512c53fc5298b0d878605d5f35f37bdae64cd30', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales_store.locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" })))), index.h("div", { key: '916603ad607b1210e0696a6bf024a481aae85ab6', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: 'e7560c2b778d3b41ce87465bf5ecc18a940c6972', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  ${this.defaultPickupData || this.pickupData.location !== -1 ? 'mr-sm-1' : ''}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'b40c9480f3b215363bfe978247a5a799316dfdf8', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.savePickup.bind(this) }))))));
    }
    get el() { return index.getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '2f6bf02f5475cb466aecc4a9d5750796e59e6088', class: "card" }, index.h("div", { key: '995a29822bda2785558be2ae407a781250000d6c', class: "p-1" }, index.h("p", { key: '0342a367523733d7d38418b27938edb20506205c' }, this.booking.property.name || ''), index.h("ir-label", { key: '5fc68e55e785ebfdf062cdd6d850b88544070a9e', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '33662fe38e6079d50b2db0ec223840acdc67c75f', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: 'fb13c251047d55709721255e517d92f492f2e8ef', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '6a302c0ba0ec5e526581fd8f94565b182ec7e062', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '33b5eb97e43fd94ae2c267b11617a7fbec007f5f', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '35def4f2da082ebce1f50a8b49ca95a80effb753', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '2ff2744ba290d1b812baa4197fa362b58a59df64', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '07d6731fc4fad5625880e5d348d632e20e3ad36d', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '040c1b6aec23908317cea90842cfb00bb4e653c1', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '65e5222d00f1e6d0f3d6bf3db6c06f36bdb542f1', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '5189f4f8ddac0679d71a42e723307cfa2cf487fe', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '0fed3d1494a9ff601747689e034ca0b591b12bde', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '38f3dec165ab096e1f380b9d09cdf959b6c64e47', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '4bd7b0a3763f3731e9bc30dd13dc2663882bb50e', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'fa28e0903feea030e4a471f5e6cda5ce0a680d09', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: 'd1645fd019c32d16b43c41a792085240905d2735', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'd02b9e2170cc76500ff7dacc1c934531ae969350', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'e50c00dfdc114cd2f1503fe8563dad12c930b938', class: "d-flex align-items-center" }, index.h("svg", { key: '31f2b4d11a8a4ba95e0243089b117127639a99f8', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '369f6246fc33bf1e687d6920e9cec171fbdcd13d', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '58ab95bb613302a06ff9377456feb04974150037', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '144b99dcbdd145aa7cef5259cf7af90ecbf7d843', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '6cb1598395ef19ec9604ba6a76865205a93be722', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: 'f73a0819c256f4dcae3a92531d6049147fd97f25', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
const IrRoom = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9e1c03b6f21a2a8dd06b14860b6450b7d1206cd6', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '7699abbb40e9b07b0e5c03564ed447122501460a', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'e40c4e44f37f73b4a7ea504ece2cc3dafecc58af', class: "flex-fill m-0 " }, index.h("div", { key: '8582a98fcba5925bd55b0f4332e5017114016668', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '75a8953c1ee6db11457c53e8b7db41a8d9b994d3', class: "m-0 p-0" }, index.h("span", { key: 'e388b8c1f73e338dd73b3a5ec372660d8f51068a', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.item.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'b0c42f769e018839eadcb8f818ba83ac34b435bd', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '09f033d5e4ffbb2c70ca9aee89dfbbb1c4f88886', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '959770da0d89ddba4fc7b08e2262071c20b71ab8', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'f1b12b9f04fd9f2816869b8dde479a8fabf9a197', variant: "icon", onClickHandler: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '40718312e87368a4bc99f6577d6a9280b3097eb7', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '739435bd95ca5591e20b6c744c9b0f4891a523b7', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: 'a534afbbeedac11eb519f5f7f9fdc626d3aff627', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: '70efc3c0f4890031532c2cd477ef475fc4089ea7', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !calendarData.isSingleUnit(this.item.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("div", { key: '0c72c0d3184438bdc5211ad53779d5cedf08d144', class: 'd-flex justify-content-end' }, index.h("span", { key: '2dcf8e30ce3492e484b5d6b5dfffcb62e9f7e597', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: '4e3bc82ff5026dc63377512fc391e35d603b617a' }, index.h("span", { key: '32e309f37f85add3a336425f82c6f3fe1f0c28a3', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && (index.h("span", { key: '8a9ef1236139bb10d13aef92e23e7954732cff23', class: "mr-1", innerHTML: this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy) }, ' ')), bed && index.h("span", { key: 'a7a8dd040b6e6215ff15493b8d7d9d8681dec83a' }, "(Preference: ", bed, ")")), index.h("div", { key: 'fdb2a115a19beae080b177af800542b22b11a0f9', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '515d16d6a6f28f0f73daed4a97a8a9f0a0d3ee79', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '6d1f5c40bb10d38ad62c15d933b5d8ebb0710d79', class: " sm-padding-top" }, index.h("p", { key: '45cd2a1a800b4441835e9ea40a6c8b2030b29fd8', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'e51540a7c6b05a8011cb7d99a3fb793f3715ca4e', class: 'flex-fill' }, index.h("table", { key: '431e1b3f7b9c534e74cbf41713e0a7e9c59fab3e' }, this.item.days.length > 0 &&
            ...
            }), index.h("tr", { key: '9b4a7d64dc0049f3fe9f981bec0d1b575a3135c3', class: '' }, index.h("th", { key: 'a2bcbc7384ed16ba2305d4c335d9d45bdffa60b9', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '6ade9e2d1bc67a9910fbc8d1b335925c6b56db5e', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && index.h("th", { key: '1736eeed0d3e4ec52ec4cac1d607159bf47e5ceb', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '9e705dbb0a7c1e229e5210e8cbfdbecbd50b3237', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.bookingEvent.is_direct && (index.h(index.Fragment, { key: '501e225c69ab92206a56e68a6f9349a005131d7a' }, this.item.rateplan.cancelation && (index.h("ir-label", { key: 'cfd203d3448eda9fc3adbc9b56ab226709a11ada', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.item.rateplan.cancelation || '', renderContentAsHtml: true })), this.item.rateplan.guarantee && (index.h("ir-label", { key: '14a39ce79e5825c858b6f59544069b1e8bc699ab', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.item.rateplan.guarantee || '', renderContentAsHtml: true })))), this.item.ota_meta && (index.h("div", { key: '1c5a0f12a3d9a797d9e9850e14063b9936874995' }, index.h("ir-label", { key: '1d7398dc18f9c5199726239a0bfed221980ec091', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.item.ota_meta.meal_plan }), index.h("ir-label", { key: '7f8f978f901b268a00fe8d46b2ce83967946d59d', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.item.ota_meta.policies }))))), index.h("ir-modal", { key: '17224fbd80ce9d20dd8e19d19126e7027fa8815c', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
//# sourceMappingURL=ir-booking-details_16.cjs.entry.js.map