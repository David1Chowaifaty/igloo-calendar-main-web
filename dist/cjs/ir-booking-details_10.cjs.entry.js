...
const payment_service = require('./payment.service-04d2e691.js');
...
const booking$1 = require('./booking-9b03b4af.js');
...
const IrBookingDetails = class {
    ...
    async openPrintingScreen(mode = 'print', version = 'new') {
        ...
        const { data } = await axios.axios.post(`Get_ShortLiving_Token?Ticket=${this.ticket}`);
    ...
    render() {
        ...
        return [
            ...
            index.h("div", { class: "fluid-container p-1 text-left mx-0" }, index.h("div", { class: "row m-0" }, index.h("div", { class: "col-12 p-0 mx-0 pr-lg-1 col-lg-6" }, index.h("div", { class: "card" }, index.h("div", { class: "p-1" }, index.h("p", null, this.bookingData.property.name || ''), index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_Source}:`, value: this.bookingData.origin.Label, image: { src: this.bookingData.origin.Icon, alt: this.bookingData.origin.Label } }), index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_BookedBy}:`, value: `${this.bookingData.guest.first_name} ${this.bookingData.guest.last_name}`, iconShown: true }), this.bookingData.guest.mobile && index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_Phone}:`, value: this.renderPhoneNumber() }), index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_Email}:`, value: this.bookingData.guest.email }), this.bookingData.guest.alternative_email && (index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_AlternativeEmail}:`, value: this.bookingData.guest.alternative_email })), ((_b = (_a = this.bookingData) === null || _a === void 0 ? void 0 : _a.guest) === null || _b === void 0 ? void 0 : _b.address) && index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_Address}:`, value: this.bookingData.guest.address }), this.userCountry && (index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_Country}:`, value: this.userCountry.name, country: true, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.bookingData.is_direct && index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_ArrivalTime}:`, value: this.bookingData.arrival.description }), this.bookingData.promo_key && index.h("ir-label", { label: `${this.defaultTexts.entries.Lcz_Coupon}:`, value: this.bookingData.promo_key }), this.bookingData.agent && index.h("ir-label", { label: `${(_c = this.defaultTexts.entries.Lcz_AgentCode) === null || _c === void 0 ? void 0 : _c.split(':')[0]}:`, value: this.bookingData.agent.name }), this.bookingData.is_in_loyalty_mode && !this.bookingData.promo_key && (index.h("div", { class: "d-flex align-items-center" }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { class: "m-0 p-0 ml-1" }, this.defaultTexts.entries.Lcz_LoyaltyDiscountApplied))), this.bookingData.is_direct ? (index.h("ir-label", { class: 'm-0 p-0', label: `${this.defaultTexts.entries.Lcz_Note}:`, value: this.bookingData.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${this.defaultTexts.entries.Lcz_Note}:`, remarks: this.bookingData.ota_notes, maxVisibleItems: (_d = this.bookingData.ota_notes) === null || _d === void 0 ? void 0 : _d.length })), index.h("div", { class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { label: `${locales_store.locales.entries.Lcz_PrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, value: booking.getPrivateNote(this.bookingData.extras), ignore_value: true }), index.h("ir-button", { variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHanlder: e => {
                ...
                return [
                    index.h("ir-room", { isEditable: this.bookingData.is_editable, defaultTexts: this.defaultTexts, legendData: this.calendarData.legendData, roomsInfo: this.calendarData.roomsInfo, myRoomTypeFoodCat: room.roomtype.name, mealCodeName: room.rateplan.name, currency: this.bookingData.currency.code, hasRoomEdit: this.hasRoomEdit && this.bookingData.status.code !== '003' && this.bookingData.is_direct, hasRoomDelete: this.hasRoomDelete && this.bookingData.status.code !== '003' && this.bookingData.is_direct, hasCheckIn: this.hasCheckIn, hasCheckOut: this.hasCheckOut, bookingEvent: this.bookingData, bookingIndex: index$1, ticket: this.ticket, onDeleteFinished: this.handleDeleteFinish.bind(this) }),
...
const IrPaymentDetails = class {
    ...
    render() {
        ...
        return [
            index.h("div", { class: "card m-0" }, index.h("div", { class: "p-1" }, this.bookingDetails.financial.gross_cost > 0 && this.bookingDetails.financial.gross_cost !== null && (index.h("div", { class: "mb-2 h4 total-cost-container" }, this.defaultTexts.entries.Lcz_TotalCost, ": ", index.h("span", null, functions._formatAmount(this.bookingDetails.financial.gross_cost, this.bookingDetails.currency.code)))), index.h("div", { class: " h4" }, this.defaultTexts.entries.Lcz_DueBalance, ":", ' ', index.h("span", { class: "danger font-weight-bold" }, functions._formatAmount(this.bookingDetails.financial.due_amount, this.bookingDetails.currency.code))), this.bookingGuarantee(), index.h("div", { class: "mt-2" }, index.h("div", null, ((_b = (_a = this.bookingDetails.financial) === null || _a === void 0 ? void 0 : _a.due_dates) === null || _b === void 0 ? void 0 : _b.length) > 0 && (index.h(index.Fragment, null, index.h("div", { class: "d-flex align-items-center" }, index.h("strong", { class: "mr-1" }, this.defaultTexts.entries.Lcz_PaymentDueDates), index.h("ir-button", { id: "drawer-icon", "data-toggle": "collapse", "data-target": `.roomName`, "aria-expanded": this.collapsedPayment ? 'true' : 'false', "aria-controls": "myCollapse", variant: "icon", icon_name: this.collapsedPayment ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
...
const IrRoom = class {
    ...
    handleEditClick() {
        ...
        this.editInitiated.emit({
            ...
            NAME: booking$1.formatName(this.item.guest.first_name, this.item.guest.last_name),
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '6b0fe61cf393fa91e28e644f4ffb0b9957020c9e', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '12ff78f144bbeea269ca4c9e83f494a8d15be4b4', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'c09ce9d1865417b88286b575637f14a14846d00e', class: "flex-fill m-0 " }, index.h("div", { key: '8d2f96ea2739e677374069c9091c22cfbb0925e8', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '8b5b213e66feb51695955a52209cde4480e54064', class: "m-0 p-0" }, index.h("strong", { key: 'd24a61a06dbdc116f4870524d9f1538d0fb31912', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '9f8589430b2665ca4836d0dd04d8dc4e8ea84134', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '433ba3e52d85653e3d4012e4a9202d6ff2ebfddb', class: "p-0 m-0 font-weight-bold" }, functions._formatAmount(this.item['gross_total'], this.currency)), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '23b248147a31fbdca347460e8e76c5ddc88e2630', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons$1.colorVariants.secondary, onClickHanlder: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '6149c5ff6e30f98adf0248009020f43df66f14d3', variant: "icon", onClickHanlder: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: icons$1.colorVariants.danger })))), index.h("div", { key: '992bc11a3ee87b0f2ef6880a270bc316b2481746', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '8b9d3b861911b37a0fe4cd3c35e75536fc6b6564', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: '5bdcbc455ed4146b6135670d61ffed09b94b6bda', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: '7c5e07c153c95c57cbecf39a8ca8da737965fe24', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), index.h("div", { key: '36ce446098693bfbe2d3e4094fc4b30159ec4825', class: 'd-flex justify-content-end' }, calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("span", { key: 'c344a7ded359e09a6980a677e93a1e7dd938b29e', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: '33dcb8ab473d5559f3d7111fdac61f1ef4d9a961' }, index.h("span", { key: '5691f1363d52d0a5de5a8487eb8529a6390569b3', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", { key: 'def0c8e1e72c8af9f543f05713ed587e7ae4cd75' }, " ", this.item.rateplan.selected_variation.adult_child_offering)), index.h("div", { key: 'f8ab047c6dadb07f5edab0cdfd5bb34452fb434c', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: 'eb107af5e0ab0f2aff064941b8dabbba80ca10b1', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'b20e23f39e4a78cf22ed6dd42201e563de5d4c7d', class: " sm-padding-top" }, index.h("strong", { key: '40f8920208dadd81202a97d7cfe125bc4f022905', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: '134c76e2edc1349326058cf7238e25c93cf29b68', class: 'flex-fill' }, index.h("table", { key: '9c22051b8eed88f94a7cf626fae88db3c9e7dda7' }, this.item.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'f54a52c9cff71ce7271e72e0812dbec697df480c', class: '' }, index.h("th", { key: '555a5695533ead967c2420bb1fa8444818bce326', class: "text-right pr-2 subtotal_row" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: '42071e46847e201b665ec25a635ba71c0305aa8c', class: "text-right subtotal_row" }, functions._formatAmount(this.item.total, this.currency)), this.item.gross_cost > 0 && this.item.gross_cost !== null && index.h("th", { key: 'b67c68a2f10be7cac247f74875679844a75821f9', class: "pl-2 text-right night-cost" }, functions._formatAmount(this.item.cost, this.currency))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
...
//# sourceMappingURL=ir-booking-details_10.cjs.entry.js.map