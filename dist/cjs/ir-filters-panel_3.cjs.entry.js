...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7d864a632c1b73d3c5efd245f756aec583531542', class: panelClasses }, index.h("div", { key: '51da8b86d0d800c32684b309ad47a64a8f52ff7d', class: cardClass }, index.h("div", { key: '633152f55b05eecdd598e54aed09f7529dddbc3a', class: headerClasses }, index.h("div", { key: 'ed05ce67e9a84c4d788132d3f6d1f1ca474e9dc6', class: "filters-panel__title-group" }, index.h("slot", { key: 'ff07842a65c05883e1a484a4ed0bf5bbeae771ba', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '2292c6989e4fc93f648045a5e981ee110094c64a', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '7fbdb266be8a72844ee6e4f954017d44b5672218', name: "header-title-extra" })), index.h("div", { key: 'c20e9e4d33f649ef03fe0372389d8d3ce45ffd81', class: "filters-panel__header-actions" }, index.h("slot", { key: '8dd58ae5e20610a49820a2afd94d87845b17da4c', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '45e956d87f069417b72d3acabc7d438a975aa25f', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: 'ab6994118fd23dab9f02e69e91d9281659c7ee63', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '0e71c242efa81190df59d00ebee3cd28c5eb2ec3' }), !this.hideDefaultActions && (index.h("div", { key: '4d32179f11b3808f267802b03f0c3601a1bdcaae', class: footerClasses }, index.h("slot", { key: '692e757c78ad243a79b570767147a5b9f9bb668c', name: "actions" }, index.h("ir-button", { key: '3db128691fe5b1c694d827455d47ab7a31cc7e51', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '3a414ba8a28e4da791b66c270b789748b018770e', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filters-panel", { key: '922a12e08588a0a291fcf8414499f0c39f273fa8', isApplyLoading: this.isLoading, onIrFilterApply: () => {
                this.applyFilters.emit(this.filters);
            }, onIrFilterReset: () => {
                this.filters = Object.assign({}, this.baseFilters);
                this.applyFilters.emit(this.filters);
            } }, index.h("fieldset", { key: '0c0bd80f92cbeb39cbf989620e80746b1feea415', class: "pt-1 filter-group" }, index.h("label", { key: 'ed40e62b3785788ef1f76158a53934a48e3912c1', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Rooms"), index.h("ir-select", { key: '536a40ce5f0b75eaa11be57b4e77842f41da8052', selectedValue: (_a = this.filters) === null || _a === void 0 ? void 0 : _a.BOOK_CASE, selectId: "rooms", showFirstOption: false, onSelectChange: e => this.updateFilter({
                BOOK_CASE: e.detail,
            }), data: [
                { text: 'Booked', value: '001' },
                { text: 'Stayed', value: '002' },
            ] })), this.allowedProperties.length > 1 && (index.h("fieldset", { key: 'afb562251012b9f7db697a8719d88287af8368f7', class: "filter-group" }, index.h("label", { key: '21a0e47a9459eb9081828c1483d9b677ce6b576e', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Properties"), index.h("ir-m-combobox", { key: '96e530672a9c983a04f2832f784b9966c69ebacd', defaultOption: ((_c = (_b = this.filters) === null || _b === void 0 ? void 0 : _b.LIST_AC_ID) === null || _c === void 0 ? void 0 : _c.length) === ((_d = this.allowedProperties) === null || _d === void 0 ? void 0 : _d.length) ? 'all' : (_f = (_e = this.filters) === null || _e === void 0 ? void 0 : _e.LIST_AC_ID[0]) === null || _f === void 0 ? void 0 : _f.toString(), onOptionChange: e => {
            ...
            ] }))), index.h("fieldset", { key: '48595a7b9906e067c1af780e912465380ae28d00', class: "filter-group" }, index.h("label", { key: 'd1c0742c41a9f072b0ea70aaecaa903f8da4000e', htmlFor: "period", class: "px-0 m-0", style: { paddingBottom: '0.25rem' } }, "Selected period"), index.h("div", { key: 'a232a75e0a400ec5287a7830653ae9aa6adb4059', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: '0d292e415aeb4adb14b477e41b8b758014ebac32', selectedValue: (_g = this.window) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => {
            ...
            ] }), index.h("p", { key: '5b88a9be1fad844e5a5d750a6340d9bba5308a75', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: '37c5a597d7d1d525eac67f7d0cbefab252ffd014', onDateRangeChanged: e => {
            ...
            }, fromDate: moment.hooks(this.filters.FROM_DATE, 'YYYY-MM-DD'), toDate: moment.hooks(this.filters.TO_DATE, 'YYYY-MM-DD'), maxDate: moment.hooks().format('YYYY-MM-DD'), withOverlay: false }))), index.h("div", { key: '433de8a628dc1848009b1f5b26a73719e93c0d1d', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: '412db2235e99ddc2176f6f6824d37d4f283a5d1d', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), index.h("ir-checkbox", { key: 'a0db391a9428824de0287b1de406a6975c5d6fcd', checked: (_h = this.filters) === null || _h === void 0 ? void 0 : _h.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrSalesByChannelTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'dc0a0be2117e165f9e3d766587eaacb406fa0368', class: "table-container h-100 p-1 m-0 mb-2 table-responsive" }, index.h("table", { key: 'f677e58a150bafa0524cf2f0c8b3da08172503b5', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'fe27bc82d8d4549db5b178d5b03ecbcc0586ce41', class: "table-header" }, index.h("tr", { key: '87f7d8ea35880cd9b66307913c9aade41ac907df' }, index.h("th", { key: 'b48ef7c4d54bd17e282c715e4d5d5ba684240f72', class: "text-left" }, "Channel"), index.h("th", { key: '78aaa82c433a38b05aea2878007723bc551bbb57', class: "text-center" }, "Room nights"), index.h("th", { key: '9024009dfd26c2c0597aa3b2d10256458cacbb9a', class: "text-right" }, "Room Revenue"), index.h("th", { key: 'c2944565fd2b7c198ee80dadbddac12746816139', class: `sales-by-channel-table__progress-col ${!isSingleProperty ? 'single' : ''}` }))), index.h("tbody", { key: '0dc051eb098bb97e73af8ea297bc83839ee199bb' }, this.records.length === 0 && (index.h("tr", { key: '5f112b274b6e9197cad10702630596d9e877e311' }, index.h("td", { key: '7d6cc20e618bc599a6826ca3e6d43e6f9d555636', colSpan: 5, style: { height: '300px' } }, "No data found."))), visibleRecords.map(record => {
        ...
        })), isSingleProperty && (index.h("tfoot", { key: '1146f2a9de983d6bbc1c1510a74cacdf6471eefd' }, index.h("tr", { key: '5c2a786cc6ad8263a918e89f74b385a5264f93dc', style: { fontSize: '12px' } }, index.h("td", { key: '9b2f29d456cbf4b15a9f4995502b68aecb075504', colSpan: 4 }, index.h("div", { key: 'ef176cbb0bc81e6f8b593587956b6b7b08d9c84d', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: 'ab5f1714348c885441df772ea8248df69b7d8e55', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '293d9fcfcd5cb217b2bcf34c94a10bc2b3b5ce4c', class: "legend bg-primary" }), index.h("p", { key: '732ebbd67dc2d082b4cae36fc88258ff84310f5d', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '2529ea3484f02ae05246b4a765ae211f7da6e7c0', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'a1cec30a1e040628b64e760e0b97de44838c2c3e', class: "legend secondary" }), index.h("p", { key: '8c8ecfa6610b60bd44bface2923222feaa139184', class: "p-0 m-0" }, "Previous year")))))))), this.visibleCount < this.records.length && (index.h("div", { key: 'ce78befcefacef82dba96da79f30ce188537da98', class: 'd-flex mx-auto' }, index.h("ir-button", { key: '0121bdbeea462792719bc0cb9355504a49f30a38', class: "mx-auto", size: "sm", text: "Load More", onClickHandler: this.handleLoadMore })))));
    }
    static get watchers() { return {
