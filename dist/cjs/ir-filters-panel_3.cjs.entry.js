...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1cd6c0891b17a2920366ae6487bb093e0948a60b', class: panelClasses }, index.h("div", { key: 'cde03898cb829a5b7e298079ea79000aca5af11e', class: cardClass }, index.h("div", { key: '3d867ee21eef5149ec44eabd21a234af484f4531', class: headerClasses }, index.h("div", { key: 'c93f671e6d689226dce23d9fb6a8af83782c7e47', class: "filters-panel__title-group" }, index.h("slot", { key: 'a7fad196bcfe52e7ff0879eae95cc40efcae4efe', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '39524e6328b5b2b864c0865c82f1df14688ea9ea', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '9705c50e1c04053b4eab2c97efb03204259bb416', name: "header-title-extra" })), index.h("div", { key: 'd0641d7b369feb4645dc170b3c0b89c329333b79', class: "filters-panel__header-actions" }, index.h("slot", { key: '4fcd23547a42776dc437d9d7fe54cbd2ed122e7d', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '887f9c3b6470c1b5716477c4d84d25bb4dcacbca', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: 'ac4bb79782ad285d18a1eefd396c60e14236fde3', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: 'c486e14de33b11704d463f51c3a3f6107bf153c8' }), !this.hideDefaultActions && (index.h("div", { key: '4b5197f6a48e05c50933d6c2530508f3597e83bc', class: footerClasses }, index.h("slot", { key: 'df397b4419815ff47faf7e0ec319519ba0ea9685', name: "actions" }, index.h("ir-button", { key: '0d4f291b0bda32e6aa038d33c80f5a78564248f8', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '9f16955c4162f62fc3f5bd629c7ad13eff3ebc34', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filters-panel", { key: '08785cddeec8147e5ae9cd0402d0c0dbdb03c1ee', isApplyLoading: this.isLoading, onIrFilterApply: () => {
                this.applyFilters.emit(this.filters);
            }, onIrFilterReset: () => {
                this.filters = Object.assign({}, this.baseFilters);
                this.applyFilters.emit(this.filters);
            } }, index.h("fieldset", { key: '4983f5739dcf19032dfd27c835cc3670a3fc1b5c', class: "pt-1 filter-group" }, index.h("label", { key: '42cc77b211d73a77895c4bea0e5ff16a2adbf5c3', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Rooms"), index.h("ir-select", { key: '657570362222f8fcf53c4f27b1ade4d1c4791f00', selectedValue: (_a = this.filters) === null || _a === void 0 ? void 0 : _a.BOOK_CASE, selectId: "rooms", showFirstOption: false, onSelectChange: e => this.updateFilter({
                BOOK_CASE: e.detail,
            }), data: [
                { text: 'Booked', value: '001' },
                { text: 'Stayed', value: '002' },
            ] })), this.allowedProperties.length > 1 && (index.h("fieldset", { key: 'cc37ef0fbee4b60b7a43f41ee1aa5a38b955cb6b', class: "filter-group" }, index.h("label", { key: '54571732294c3be8be50213bdc8fdf50b74e9473', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Properties"), index.h("ir-m-combobox", { key: '9e9d4e89b8d7764c2c187070b1ec4fb1c50f1b0a', defaultOption: ((_c = (_b = this.filters) === null || _b === void 0 ? void 0 : _b.LIST_AC_ID) === null || _c === void 0 ? void 0 : _c.length) === ((_d = this.allowedProperties) === null || _d === void 0 ? void 0 : _d.length) ? 'all' : (_f = (_e = this.filters) === null || _e === void 0 ? void 0 : _e.LIST_AC_ID[0]) === null || _f === void 0 ? void 0 : _f.toString(), onOptionChange: e => {
            ...
            ] }))), index.h("fieldset", { key: '67565307558e08ab906ef0fb5730aab0cec4c99f', class: "filter-group" }, index.h("label", { key: 'd6f47a3dd95f7c43a822a3136123d136b103f4a3', htmlFor: "period", class: "px-0 m-0", style: { paddingBottom: '0.25rem' } }, "Selected period"), index.h("div", { key: 'b5dc4c7249a6783957dcb0526fc98c3926c32d23', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: '3a9b4c8028b9271c15c0a8ab1b1d107d46b32762', selectedValue: (_g = this.window) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => {
            ...
            ] }), index.h("p", { key: 'c868d2074e154d3aab4113c00e3dd738e6741eb6', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: '5f5699f2de52a337dd33062c7d5a7694d3eff6c2', onDateRangeChanged: e => {
            ...
            }, fromDate: moment.hooks(this.filters.FROM_DATE, 'YYYY-MM-DD'), toDate: moment.hooks(this.filters.TO_DATE, 'YYYY-MM-DD'), maxDate: moment.hooks().format('YYYY-MM-DD'), withOverlay: false }))), index.h("div", { key: 'ca10d85ec39f1356e547f694818633baa0918a02', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: 'd5427d862a13f88a7ea522455b8c6f92b729d911', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), index.h("ir-checkbox", { key: 'd28bb0e11ac010fe18dc309a2cb43945d19e3d09', checked: (_h = this.filters) === null || _h === void 0 ? void 0 : _h.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrSalesByChannelTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '2f7519b9d689da66de904bccafc2beda6ce28f42', class: "table-container h-100 p-1 m-0 mb-2 table-responsive" }, index.h("table", { key: '976e64e57b270071d1d83895bb849949c5b6b4be', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '53d936cb3ec57701ef2596b60166d1489bbf53c6', class: "table-header" }, index.h("tr", { key: 'fecfe6780e7845f88a47c94e45d8ddf48e9d6f73' }, index.h("th", { key: 'd0c97a7923b56ab74af55972505355d74c892396', class: "text-left" }, "Channel"), index.h("th", { key: '2c90525c36f6bd58f9f2e2f39859204bed11b874', class: "text-center" }, "Room nights"), index.h("th", { key: '4d6ad36dd4640013e0e782c869d6fc2eeef910ce', class: "text-right" }, "Room Revenue"), index.h("th", { key: '58e187e6af3dedaa8b3e82a355818ee062b63835', class: `sales-by-channel-table__progress-col ${!isSingleProperty ? 'single' : ''}` }))), index.h("tbody", { key: '1cbe14d7ac48a805af58e4b35af8983586f6c502' }, this.records.length === 0 && (index.h("tr", { key: '0a85d4fb2ab800c3fe639362171c5d27d9634830' }, index.h("td", { key: '292d6fc0d2dfb75e4e04d0c87fae671d01a0f640', colSpan: 5, style: { height: '300px' } }, "No data found."))), visibleRecords.map(record => {
        ...
        })), isSingleProperty && (index.h("tfoot", { key: '7a0f24c7661f896a370302a4b97cc1867c40bc0d' }, index.h("tr", { key: '63025374f9416d74bbe97960c2bce8f513d57b37', style: { fontSize: '12px' } }, index.h("td", { key: 'bfdf0c7657d4da94be5629783b1462bc0b812ff7', colSpan: 4 }, index.h("div", { key: '4b4766566d5537f65b84a31ebb3e6a789723f5e5', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: '532d86531b9baa684e1a77e65f8ea15ad9613c12', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '3fcaee74910f869a79d4405add0f7abfc313d0ae', class: "legend bg-primary" }), index.h("p", { key: 'd850549eac47e92b30792681da3e5430ed280fb0', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '6d0a6421dce9c39f13253ece17401e78246b47d6', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '4aa9fd3b4cd501ce68de032a203d516449cffa59', class: "legend secondary" }), index.h("p", { key: 'f0b0ffac384fb2d195ff3a688855a5dd0b8fbfc1', class: "p-0 m-0" }, "Previous year")))))))), this.visibleCount < this.records.length && (index.h("div", { key: '8865f574b645196818ce8809cd014f7f434c8b2b', class: 'd-flex mx-auto' }, index.h("ir-button", { key: '6af9a9352d6f123df33a98c082caf58041a8c990', class: "mx-auto", size: "sm", text: "Load More", onClickHandler: this.handleLoadMore })))));
    }
    static get watchers() { return {
