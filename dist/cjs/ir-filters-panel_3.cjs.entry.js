...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '39b7970f8e17b98ffb6544aea9af0c864ba11a3d', class: panelClasses }, index.h("div", { key: '72c81a781f81fdaa444a58d10815da520473a3ce', class: cardClass }, index.h("div", { key: 'f59f0967542bf2b55f327f747241dc4fda1012bc', class: headerClasses }, index.h("div", { key: 'b4c6685c73bdc47893052b781ff48ee02f1cfd91', class: "filters-panel__title-group" }, index.h("slot", { key: '5ef7d6060bd6c98b79e29e5fbe017e15d660e270', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: 'db3aaae402637f3f7025b5dca5a2d3da78250256', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '9a181901a8b7d97a5981b3b375b0d549ae21d5b7', name: "header-title-extra" })), index.h("div", { key: 'be2db63be493249120191783497702867c6b1dc9', class: "filters-panel__header-actions" }, index.h("slot", { key: 'f4fac4c08ed0aa2c1c97c316b8da58412b51decd', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '0dde584f24e69b7c6cfc75829a59d1a58fc3e1f1', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '575dbcf06a35af4316685d4f8d0608e2f0e4d146', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: 'c0e2d160f73c8c1711965ab02a8afef27d135bbf' }), !this.hideDefaultActions && (index.h("div", { key: 'de273f2a8bb7e200d9b5248cfd89efc35bb35408', class: footerClasses }, index.h("slot", { key: 'b114c5e00b830c908e862795e98e8c94a74f5246', name: "actions" }, index.h("ir-button", { key: '35671c7099e8559720de11305e512b4664b4ba99', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: 'fb98e6fcc9ac85ff54a2e9abeef745a024e2cb5e', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filters-panel", { key: '171e142199e2676ce9655c0b794a3b7fc47e7bc1', isApplyLoading: this.isLoading, onIrFilterApply: () => {
                this.applyFilters.emit(this.filters);
            }, onIrFilterReset: () => {
                this.filters = { ...this.baseFilters };
                this.applyFilters.emit(this.filters);
            } }, index.h("fieldset", { key: '5f12b8350e9d2648f2c464a618045066a737998f', class: "pt-1 filter-group" }, index.h("label", { key: '259b5fc5308c971957b13b7b666e37f0c9bdfc5e', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Rooms"), index.h("ir-select", { key: '935bffa3e7fb2f04e1a6229c55f217cb3d0fc0ec', selectedValue: this.filters?.BOOK_CASE, selectId: "rooms", showFirstOption: false, onSelectChange: e => this.updateFilter({
                BOOK_CASE: e.detail,
            }), data: [
                { text: 'Booked', value: '001' },
                { text: 'Stayed', value: '002' },
            ] })), this.allowedProperties.length > 1 && (index.h("fieldset", { key: '68301157a37ba3d2515df9bb15a7e13532dd5c0f', class: "filter-group" }, index.h("label", { key: '250a4d274c558c2039d4f0fe0bcfe6d14d151ce1', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Properties"), index.h("ir-m-combobox", { key: '64302426b01d1c990e5e6af60533be2cd076be56', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] }))), index.h("fieldset", { key: '192e8e1fd723b69adb1608bbf497ab4051d7fab4', class: "filter-group" }, index.h("label", { key: '16aaefa6fb37c9bbd08ad2b6e74d7da04a6c7dc7', htmlFor: "period", class: "px-0 m-0", style: { paddingBottom: '0.25rem' } }, "Selected period"), index.h("div", { key: 'dd166346cdf6ddd383ee8119efafd7dba20149df', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: 'f8c89382a361e0b0859dc982f01d6dbe1bad1eda', selectedValue: this.window?.toString(), onSelectChange: e => {
            ...
            ] }), index.h("p", { key: 'c9169a8934525643408d0ebdffa4315a102399e8', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: '7fd5f51e9b38481dfedf54ed2785eca20b35e42b', onDateRangeChanged: e => {
            ...
            }, fromDate: moment.hooks(this.filters.FROM_DATE, 'YYYY-MM-DD'), toDate: moment.hooks(this.filters.TO_DATE, 'YYYY-MM-DD'), maxDate: moment.hooks().format('YYYY-MM-DD'), withOverlay: false }))), index.h("div", { key: '6e1cb1fb870bfe1ba65c78a4d2349f7576f6d8bf', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: 'a00ceacdff7b6c1a4d1805bab9f2b00504e4305c', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), index.h("ir-checkbox", { key: '542fc7fc140916f3dbdd6de63588bb9e4952fee4', checked: this.filters?.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrSalesByChannelTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ebcb420ed88b634515945f84adcae2e21bbf3180', class: "table-container h-100 p-1 m-0 mb-2 table-responsive" }, index.h("table", { key: '4de177926d0a4ba089ebab1dadcef8342f74b177', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '4eb3b8d5f43b3b6ca87d354297192d505106d58e', class: "table-header" }, index.h("tr", { key: '57e1a43f55cb62ed258a66ab47cdcb43fcd456af' }, index.h("th", { key: '95103bd921252a5ed0e4d152b2956cb8253a7f13', class: "text-left" }, "Channel"), index.h("th", { key: 'db78deb56136e7de17bdb61be84743074cbac3ea', class: "text-center" }, "Room nights"), index.h("th", { key: '3b50e6bbefd787aaf5454b11601f32b518cb26d0', class: "text-right" }, "Room Revenue"), index.h("th", { key: '7e197142c76d0a07110e3fb22b66b257bf1c6536', class: `sales-by-channel-table__progress-col ${!isSingleProperty ? 'single' : ''}` }))), index.h("tbody", { key: '2844b5aafd7098e5be3dca0e3ab043d3706b0202' }, this.records.length === 0 && (index.h("tr", { key: '96e93ea13aa9d50b6649f13a91c3193a13632935' }, index.h("td", { key: 'dc25e247a3e575588251f39885e09a9ae8d21131', colSpan: 5, style: { height: '300px' } }, "No data found."))), visibleRecords.map(record => {
        ...
        })), isSingleProperty && (index.h("tfoot", { key: '197d04ded30b453991b2406360ff9a08ecc80f44' }, index.h("tr", { key: 'a510121c34b84ad175cf582c63d502b7126c8e30', style: { fontSize: '12px' } }, index.h("td", { key: '38fa04c364a34ee7e8a3ebdb68ee5c0acb791049', colSpan: 4 }, index.h("div", { key: 'af54e6b63a088c7c47c7ffeca85c2d12939f8205', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: '265885accad09571d428c492abec526d0bb2a48b', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'c7202842a6d881c4157de90aba809acbe3e06958', class: "legend bg-primary" }), index.h("p", { key: 'b22fbec52c3a7eee5ea8a85aef28b86bb41872c9', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '33a3ca8f30d2995b11fe364e1ab3db22d204ea0c', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '1b4e1fa23860c843fbc74a199dc8cc830a76eb56', class: "legend secondary" }), index.h("p", { key: 'e00bb62431dffaf1fc910fea105f30ec2b9a962a', class: "p-0 m-0" }, "Previous year")))))))), this.visibleCount < this.records.length && (index.h("div", { key: '5cc164dc64e48b56de43438f355c2961870cb5c8', class: 'd-flex mx-auto' }, index.h("ir-button", { key: '2be6bf7fd6a448647274cc3b844bff204859985b', class: "mx-auto", size: "sm", text: "Load More", onClickHandler: this.handleLoadMore })))));
    }
    static get watchers() { return {
