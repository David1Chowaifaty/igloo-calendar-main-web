...
const IrSalesByChannelTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '14fb7b4fa14e4bc440c3598a5cea5210ebd379c5', class: "table-container h-100 p-1 m-0 mb-2 table-responsive" }, index.h("table", { key: '75f6111f50d99eee58cb7796cade6b5c78196d8e', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '5eb5e58a2ff2f3bdb57a393990b5ea94e1d2e127', class: "table-header" }, index.h("tr", { key: '168857f2439426ac31a48975f0509c4acd507dfd' }, index.h("th", { key: '202539c30962b60d76ca11b4e6c5f6c9580ed90c', class: "text-left" }, "Channel"), index.h("th", { key: '33de73bef6701f57a129d2abe60bc7d86b6575d6', class: "text-center" }, "Room nights"), index.h("th", { key: '5d732042af47869d0cbb06762804adb75005cdda', class: "text-right" }, "Room Revenue"), index.h("th", { key: 'ce78b9a4ed4f61189a5684fc13ff7d205f801b29', class: "" }))), index.h("tbody", { key: 'fa4c0447c19dc5bf8add5e199f6193edad882cb6' }, this.records.length === 0 && (index.h("tr", { key: '15f926c9b38d01d79a61d3bc3cb90cdaded7d460' }, index.h("td", { key: '87c81ce9ceaa0f79ddfbc3aec7807315b484d0cc', colSpan: 5, style: { height: '300px' } }, "No data found."))), visibleRecords.map(record => {
            var _a, _b, _c, _d, _e, _f, _g;
            const mainPercentage = `${parseFloat(record.PCT.toString()).toFixed(2)}%`;
            const secondaryPercentage = record.last_year ? `${parseFloat(record.last_year.PCT.toString()).toFixed(2)}%` : null;
            return (index.h("tr", { "data-testid": `record_row`, class: { 'task-table-row ir-table-row': true } }, index.h("td", { class: "text-left" }, index.h("div", { class: "d-flex flex-column", style: { gap: '0.25rem' } }, index.h("p", { class: `p-0 m-0 ${((_a = record.last_year) === null || _a === void 0 ? void 0 : _a.SOURCE) ? 'font-weight-bold' : ''}` }, record.SOURCE), ((_b = record.last_year) === null || _b === void 0 ? void 0 : _b.SOURCE) && (index.h("p", { class: "p-0 mx-0", style: { marginTop: '0.25rem', marginBottom: '0' } }, record.last_year.SOURCE)))), index.h("td", { class: "text-center" }, index.h("div", { class: "d-flex flex-column", style: { gap: '0.25rem' } }, index.h("p", { class: `p-0 m-0 ${((_c = record.last_year) === null || _c === void 0 ? void 0 : _c.NIGHTS) ? 'font-weight-bold' : ''}` }, record.NIGHTS), ((_d = record.last_year) === null || _d === void 0 ? void 0 : _d.NIGHTS) && (index.h("p", { class: "p-0 mx-0", style: { marginTop: '0.25rem', marginBottom: '0' } }, record.last_year.NIGHTS)))), index.h("td", { class: "text-right " }, index.h("div", { class: "d-flex flex-column", style: { gap: '0.25rem' } }, index.h("p", { class: `p-0 m-0 ${((_e = record.last_year) === null || _e === void 0 ? void 0 : _e.REVENUE) ? 'font-weight-bold' : ''}` }, utils.formatAmount(record.currency, record.REVENUE)), ((_f = record.last_year) === null || _f === void 0 ? void 0 : _f.REVENUE) && (index.h("p", { class: "p-0 mx-0", style: { marginTop: '0.25rem', marginBottom: '0' } }, utils.formatAmount(record.currency, record.last_year.REVENUE))))), index.h("td", null, isSingleProperty && (index.h("div", { class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("ir-progress-indicator", { percentage: mainPercentage }), ((_g = record.last_year) === null || _g === void 0 ? void 0 : _g.PCT) && index.h("ir-progress-indicator", { percentage: secondaryPercentage, color: "secondary" }))))));
        })), isSingleProperty && (index.h("tfoot", { key: 'ff13024b52f2bcedfe8e29634e1c59c45edd6178' }, index.h("tr", { key: '79ebf97dcbf4fff0e24bc9031c54fc9ae25678ed', style: { fontSize: '12px' } }, index.h("td", { key: '7135ad91af917bd051ebc35da8df7a2c1e4a334f', colSpan: 4 }, index.h("div", { key: '263389c56a6b3478650225ff3d877c021d16b5de', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: 'a1d49f542ec17ed979795fc85ea0dcc645f11ad3', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '515e1fb1df25ea68e369b678a144d592d5e49fec', class: "legend bg-primary" }), index.h("p", { key: '49568097e65e51383343823e0039b5b389b33079', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '7b0af87f03a628eadf7d82db24a9d8e6294931dd', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'afc42040d60afa6f34f895d2cdb7dd0adc9511ca', class: "legend secondary" }), index.h("p", { key: '6e3ebaf7ae317bbbefa47569dc39bd6e36c36808', class: "p-0 m-0" }, "Previous year")))))))), this.visibleCount < this.records.length && (index.h("div", { key: 'addb464c8e80f13a1897f0569af78cd26cbbe8b5', class: 'd-flex mx-auto' }, index.h("ir-button", { key: 'b3c517c307215fed95c94648603767267e43945b', class: "mx-auto", size: "sm", text: "Load More", onClickHandler: this.handleLoadMore })))));
    }
    static get watchers() { return {
