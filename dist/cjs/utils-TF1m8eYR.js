...
const ExtraServiceSchema = index.libExports.z.object({
    ...
    pr_id: index.libExports.z.number().nullable().optional().default(null),
    room_identifier: index.libExports.z.string().nullable().optional().default(null),
    ...
    from_time: index.libExports.z.string().optional().nullable().default(null),
    to_time: index.libExports.z.string().optional().nullable().default(null),
