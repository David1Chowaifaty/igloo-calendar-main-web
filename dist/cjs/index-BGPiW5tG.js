...
const RelEntitySchema = index.libExports.enum(['TBL_BSAD', 'TBL_BSP', 'TBL_BSE']);
...
const FiscalDocumentSchema = index.libExports.object({
    ...
    ISSUE_HOUR: index.libExports.number().nullable().optional(),
    ISSUE_MINUTE: index.libExports.number().nullable().optional(),
