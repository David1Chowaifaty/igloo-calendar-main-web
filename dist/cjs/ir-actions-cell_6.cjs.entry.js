...
const IrBalanceCell = class {
    ...
    payBookingBalance;
    render() {
        return (index.h(index.Host, { key: 'c70699cd91709024dade0850059ce452a47e95d9' }, this.label && index.h("p", { key: '0c47616aff3a412f64b6ae8dfd6f04136e22b436', class: "cell-label" }, this.label, ":"), index.h("p", { key: '677b381d10da2f0599ef9fb7851ec12b09eaf283', class: "ir-price" }, utils.formatAmount(this.currencySymbol, this.financial.gross_total)), index.h("div", { key: '7a5c4b50a12b1eadc8ae0a4f3cc194b59ea8f5a0', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '190ec5521714210852e71f9969a18b2b6777a87a' }, this.label && index.h("p", { key: 'd7a215d9a3a7031e3b1a3e807ed75459bafb3c85', class: "cell-label" }, this.label, ":"), index.h("div", { key: 'f80a312621c8ea69f0a28e26688e1f0c4b778721', class: "booked-by-source__container" }, this.clickableGuest ? (index.h("ir-custom-button", { size: "medium", onClickHandler: this.handleGuestClick.bind(this), variant: "brand", appearance: "plain", link: true }, guest)) : (index.h("p", null, guest)), this.showRepeatGuestBadge && (index.h(index.Fragment, { key: '28d2dd9f02a271b6da500dd60d02f2bb10dd8ac4' }, index.h("wa-tooltip", { key: '29fac333531d274c89f055d75d19c45a84ad7e6d', for: repeatGuestBadgeId }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), index.h("wa-icon", { key: '8bff621c2b986aa45ddd61c155a15bf53487841e', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (index.h("p", { key: '6a9f85aa3af9eaf81fbb2cfe88cc7a019c4000f1' }, this.totalPersons, locales_store.locales.entries.Lcz_P)), this.showPrivateNoteDot && index.h("span", { key: 'd0e576e70532f8e6a993a3cbaa5ff24b8ac048aa', class: "booked-by-source__private-note" })), index.h("div", { key: '7a9a84f06cdb414afe0754cc0861dfe78f330123', class: "booked-by-source__container" }, this.showLoyaltyIcon && (index.h(index.Fragment, { key: 'ed4c17fb540ab349ed51b533acacdb3906d2d8bf' }, index.h("wa-tooltip", { key: 'ad234d4e7dace3ca1815aa1e751da16b0e346643', for: loyaltyBadgeId }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied), index.h("wa-icon", { key: 'd4df0e952215d1509e4bbe12293fc7e6e39d3c21', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (index.h(index.Fragment, { key: 'b1d8c8f95368362c80bc34d6fec6b9608ad4e991' }, index.h("wa-tooltip", { key: '286044ad4c8a12dc88e0d30b406221ae49baac88', for: couponBadgeId }, locales_store.locales.entries.Lcz_Coupon, ": ", this.promoKey), index.h("wa-icon", { key: 'd6f7895d231de1934cebffb5af070908d6176f55', id: couponBadgeId, name: "ticket" }))))));
    }
};
...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (index.h(index.Host, { key: '769881c2c555644c8c5fa49f541bebf07cbfde4a' }, this.channelBookingNumber && index.h("wa-tooltip", { key: 'faaf34928c7a327b5a46ae7327a3c33abeeba704', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), index.h("img", { key: '905758220bc60c174a1db0a737b11e40ec9a2363', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), index.h("div", { key: '34f165f58d5852de11529bc6cffac207b3cde018', class: "booking-nbr-cell__container" }, index.h("div", { key: '4e95ab5b1922648c00529757f3509e7f77415d61', style: { width: 'fit-content' } }, index.h("ir-custom-button", { key: 'e620bbe10151c7192898e51d962b7560bef3db57', size: "medium", onClickHandler: () => this.openBookingDetails.emit(this.bookingNumber), link: true, variant: "brand", appearance: "plain" }, this.bookingNumber)), index.h("p", { key: '686f1757f631c3f4bad31208f25de07e09c63019', class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
};
...
const IrDatesCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6f336099b1d76e4cf1c49215a9914cff910d0f86' }, index.h("div", { key: 'b1475344276617697fcedbfe9cddea4f24560dee', class: "date-cell__container" }, this.checkInLabel && index.h("span", { key: 'cbfd868962184c8db091331b9aac9d730e4be111', class: "date-cell__label" }, this.checkInLabel, ": "), index.h("p", { key: '883e4711eb266b1cb47b9e31641b0d0e1193e564', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), index.h("div", { key: '66696dbbec53eff38c24b60c9017189a13734017', class: "date-cell__container" }, this.checkoutLabel && index.h("span", { key: '474e93d9708334803e1955996cddc65d4c8239f0', class: "date-cell__label" }, this.checkoutLabel, ": "), index.h("p", { key: '932deb062093fc2fbc8e5b280d19f365b6098153', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
...
const IrUnitCell = class {
    ...
    room;
    render() {
        return (index.h(index.Host, { key: 'f4b6ca579123c11016cf3ab4f558c69f6a10425b' }, index.h("p", { key: '13d68993202996bc13705ab99a1bd1b8f979937c' }, this.room.roomtype.name), this.room.unit && index.h("ir-unit-tag", { key: '81767a51736378c696b43a25a76e9c8a831cae79', unit: this.room.unit.name })));
    }
};
