...
const IrBalanceCell = class {
    ...
    payBookingBalance;
    render() {
        return (index.h(index.Host, { key: '8b5f677a645cafffd51cfa14d1ccd770c43e2f2b' }, this.label && index.h("p", { key: 'af0a2c0de1012f26b46eeb061835370d2674ab66', class: "cell-label" }, this.label, ":"), index.h("p", { key: 'f18854372f8035cb060202ff3a189dcf5a46068c', class: "ir-price" }, utils.formatAmount(this.currencySymbol, this.financial.gross_total)), index.h("div", { key: '8d413573712b2787812d12a3f644e55618c63230', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'af1dab1da484a2b6cdfabc462cecd32490fa8699' }, this.label && index.h("p", { key: '3c6a123f3d19f437b74216aab70908ae89e31a61', class: "cell-label" }, this.label, ":"), index.h("div", { key: '26edaaf9de231d978e7071a26bd8f790fbc4185f', class: "booked-by-source__container" }, this.clickableGuest ? (index.h("ir-custom-button", { size: "medium", onClickHandler: this.handleGuestClick.bind(this), variant: "brand", appearance: "plain", link: true }, guest)) : (index.h("p", null, guest)), this.showRepeatGuestBadge && (index.h(index.Fragment, { key: 'd7e877732b54b3349cfef60322ddf2b256ab12f1' }, index.h("wa-tooltip", { key: '5d31d76784a7bb9bb0621735ad3f1867be5813a8', for: repeatGuestBadgeId }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), index.h("wa-icon", { key: '3e03794fb3a9fa754cd908e677f352bb950fab9c', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (index.h("p", { key: '8070f1ba58444654e7158cc6133c495fecb8c1d4' }, this.totalPersons, locales_store.locales.entries.Lcz_P)), this.showPrivateNoteDot && index.h("span", { key: '658122b02ad6c40b2e067366e37fe233b31568bb', class: "booked-by-source__private-note" })), index.h("div", { key: '098adb60c41c02008e162340e7cba5e761ecb768', class: "booked-by-source__container" }, this.showLoyaltyIcon && (index.h(index.Fragment, { key: '59a7d08562a64cbc3df923bb0ee97598ac5d56a7' }, index.h("wa-tooltip", { key: 'c34bfc175ce1098fcc1f508d066e5849519d4217', for: loyaltyBadgeId }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied), index.h("wa-icon", { key: 'f087d85711a91891552aab1ae053776cc4751e97', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (index.h(index.Fragment, { key: 'fe0811bf8f4e786da55de498819ef54cd7339d01' }, index.h("wa-tooltip", { key: '63fef9778ad38a85b69f8c3f1df5d1e10e411a91', for: couponBadgeId }, locales_store.locales.entries.Lcz_Coupon, ": ", this.promoKey), index.h("wa-icon", { key: '29579544dadd6a32f38a17dbefe83142d95a4939', id: couponBadgeId, name: "ticket" }))))));
    }
};
...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (index.h(index.Host, { key: 'e1fddd8e8d2cbab7b62c68e28d0da7dfd950ef50' }, this.channelBookingNumber && index.h("wa-tooltip", { key: 'c550fd5874423a187f335f84f67bf16dc5f93fec', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), index.h("img", { key: '2f62669a61aaa59cf3b3c07bf199d3dd5937dfa7', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), index.h("div", { key: 'c98fddec076658178c83e9db36f06a1f7969feb0', class: "booking-nbr-cell__container" }, index.h("div", { key: '1fc02a0848323b7e4b4ca6dcccb4b1ffe0180ca2', style: { width: 'fit-content' } }, index.h("ir-custom-button", { key: '76da95771f77acdd4afa996596aceacac3e385d6', size: "medium", onClickHandler: () => this.openBookingDetails.emit(this.bookingNumber), link: true, variant: "brand", appearance: "plain" }, this.bookingNumber)), index.h("p", { key: '9af6a0b6c34f01fc09044c966b305e94b8855e85', class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
};
...
const IrDatesCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a6520c67444c20d60f40552138f5969fc264edd4' }, index.h("div", { key: '0f597901d891d95cf07293928cffaad0a2caaa76', class: "date-cell__container" }, this.checkInLabel && index.h("span", { key: '11eb2d886496f51b3ded85322322aecbb1c82efc', class: "date-cell__label" }, this.checkInLabel, ": "), index.h("p", { key: '10602e16332e70a261abb7d484c3e590bfd52b58', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), index.h("div", { key: 'b4dffed99552bf8329094aee31d06185ce90c84e', class: "date-cell__container" }, this.checkoutLabel && index.h("span", { key: 'f6167357f340a7c2e008f8d96cd5e9949944d67c', class: "date-cell__label" }, this.checkoutLabel, ": "), index.h("p", { key: '66531cbcb13e0d5872349cbd5904d5c3ae38c8d6', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
...
const IrUnitCell = class {
    ...
    room;
    render() {
        return (index.h(index.Host, { key: 'eb3a3a47a06adbd5a396d7085d562459f81240a6' }, index.h("p", { key: '23e4ffc52aa14d617006c0b0759ee0c42580be28' }, this.room.roomtype.name), this.room.unit && index.h("ir-unit-tag", { key: '92a3441ead8546f949e5ab52cef890423151b6b3', unit: this.room.unit.name })));
    }
};
