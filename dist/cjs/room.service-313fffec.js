...
class RoomService {
    ...
    async getExposedProperty(params) {
        ...
        try {
            ...
            calendarData.calendar_data.property = Object.assign(Object.assign({}, results), { calendar_extra: results.calendar_extra ? JSON.parse(results.calendar_extra) : null });
    ...
    generateColorForegrounds() {
        var _a;
        const data = {};
        if (!((_a = calendarData.calendar_data.property) === null || _a === void 0 ? void 0 : _a.calendar_legends)) {
            return;
        }
        ...
        calendarData.calendar_data.colorsForegrounds = Object.assign({}, data);
    }
    initializeBookingColors() {
        var _a;
        const calendarExtra = (_a = calendarData.calendar_data.property.calendar_extra) !== null && _a !== void 0 ? _a : { booking_colors: [] };
...
//# sourceMappingURL=room.service-313fffec.js.map