...
const housekeeping_service = require('./housekeeping.service-4435fc97.js');
...
const IrHkTasks = class {
    ...
    async init() {
        try {
            ...
            const requests = [
                this.houseKeepingService.getHkTasks({ property_id: this.property_id, from_date: utils.hooks().format('YYYY-MM-DD'), to_date: utils.hooks().add(2, 'days').format('YYYY-MM-DD') }),
    ...
    async fetchTasksWithFilters() {
        const tasks = await this.houseKeepingService.getHkTasks(Object.assign(Object.assign({}, this.filters), { property_id: this.property_id, from_date: utils.hooks().format('YYYY-MM-DD'), to_date: utils.hooks().add(2, 'days').format('YYYY-MM-DD') }));
        if (tasks) {
            this.updateTasks(tasks);
        }
    }
...
const IrLogin = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b399a7495fda19b4d40e2da89dc4df318d81ef3b' }, index.h("ir-interceptor", { key: '1cb3eb0615bf97ad2c25b1e2a236840cd8151990' }), index.h("ir-toast", { key: 'b400437d74361221571c1a6e53deeb9530c895bc' }), index.h("form", { key: '95880e9b827638946418bcdf1b12f4fd033f7b02', onSubmit: this.handleSignIn.bind(this), class: "card form-container px-2" }, index.h("img", { key: '7d6b07654fdac5d9891ad75d9666e867f4bbc073', class: "logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "Login to igloorooms extranet" }), index.h("div", { key: 'a87fc8cf626fb1032b0ff71b513ab37b9df2dfd4', class: "separator-container" }, index.h("div", { key: '6241e469e4c36657907f03c97dfaabe011575319', class: "separator" }), index.h("p", { key: '8bff6ad7b2b1e0a5fea6bd8e0b8f07b4379a28ce' }, "Sign in to manage your property"), index.h("div", { key: '4740b5bc3b5a5e245dcb7ac42485e64ea029cf96', class: "separator" })), index.h("ir-input-text", { key: '04a2645ef40675919f8fd9230d15b22d1fe8e980', value: this.username, onTextChange: e => (this.username = e.detail), variant: "icon", label: "", LabelAvailable: false, placeholder: "Username" }, index.h("ir-icons", { key: '58aaee7cbd75c0110c41cf5b8be488c5aab0b0a1', name: "user", slot: "icon" })), index.h("div", { key: 'd164ccc6ea95e2e58892318be41ce275b0243f88', class: 'position-relative' }, index.h("ir-input-text", { key: 'acb582f5130594732280f7e7cab1eed194734e04', value: this.password, onTextChange: e => (this.password = e.detail), variant: "icon", LabelAvailable: false, label: "", placeholder: "Password", type: this.showPassword ? 'text' : 'password' }, index.h("ir-icons", { key: '380af0a2cf2873e5ceb302646d8a45dd80235952', name: "key", slot: "icon" })), index.h("button", { key: 'c277711d6efc9c49b70ac50f3c0bc7b2e2a7bd2c', type: "button", class: "password_toggle", onClick: () => (this.showPassword = !this.showPassword) }, index.h("ir-icons", { key: 'da1f881ac684c794cc53c00b8f0f4c214f851c1d', name: !this.showPassword ? 'open_eye' : 'closed_eye' }))), index.h("ir-button", { key: 'f81be7bad3f022501edddae6f86847361e7c40de', isLoading: irInterceptor_store.isRequestPending('/Authenticate'), btn_type: "submit", iconPosition: "left", icon_name: "unlock", text: 'Login', size: "md", class: "login-btn" }), index.h("div", { key: 'ecc9a4d4847feee99f82f7b4f5d50f0edc78114f', class: "card-body text-center p-0 app_links" }, index.h("a", { key: '2a6ed523b120546bb2648252aebc1210389bdc4f', href: "https://apps.apple.com/lb/app/igloorooms/id1607846173", target: "_new" }, index.h("img", { key: '40c82210a4d4ac9b777182cc0adcf9c48cee6351', src: "https://x.igloorooms.com/assets/images/svg/AppStore_ios.svg", alt: "Install igloorooms iOS App" })), index.h("a", { key: 'd61f540339b936344b1cbbc3e37ae3629fa1820b', href: "https://play.google.com/store/apps/details?id=com.iglooroomsapp", target: "_new" }, index.h("img", { key: 'f1e1a625da530e51d1b30ca55bdbe9e4cfdefd59', src: "https://x.igloorooms.com/assets/images/svg/AppStore_android.svg", alt: "Install igloorooms Android App" }))), index.h("a", { key: '536fbe88725acccce8c902541cf76520d293c938', href: "https://info.igloorooms.com/signup", class: "btn btn-outline-danger btn-block btn-md mt-2", target: "_new" }, "New to igloorooms?"), index.h("p", { key: '35dd39602cde7aee816175593ce5329c48a021b9', class: 'font-small-3  my-1' }, "By logging in, you accept our", ' ', index.h("span", { key: '8dd15a9dc00f5ac1fc206be13c324bef89a6e547' }, index.h("a", { key: 'a2c90b0932d419bdfb594e1783003bf68bc5e5ec', href: "https://info.igloorooms.com/privacy/", target: "_new" }, "Privacy and Cookies Policies")), ' ', "Need help? support@igloorooms.com"))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'c5f09716b54d734df085a82e371b7ec61e397e62' }, index.h("div", { key: '0ce54c35d4fbb0d3ae0b890a943c80f354efe452', class: "form-group mr-0" }, index.h("div", { key: '654989e67c2ad129fd80fb96f7a71cd8ed774f79', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '7063dae5b7e70e909b043e5b3afe2970302402b2', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '4db9b63edc3297c42687f21c8a07e574129fa454', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '98f9a9f012c287f949a65f82fd04d7dc6b8a5d3e', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '4f783e3f23c28533c3363c8aeee5649dfefdc8b1', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '44bd25ccf11e1b4b40603fc3da5ff380b22a8e78', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'c38ad3e65a95514c18f61ef4b0bf0d8dc673d6d6', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'a16fb5f3f2edb9afc354b5666c7f945e8e3af4c3', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '9d1eb676a510c6eb3e17882895f3ea45bcc841ac', type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), ' ', this.isDropdownVisible && (index.h("div", { key: '9a735601e095df2ceeddf843a501b98efcbc8d57', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '1d61fc8c1b2a17d7fac98a97dc30864828f0d698', onComboboxValueChange: e => {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'be096134801a3984747e731147d0008ee1c61e59' }, index.h("button", { key: '35618b71c899322da4061e77ba20680ccd9f0e43', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: 'a1d84a22a9402af09c42ef0ad45fcfa5ca4a6e10', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: '8f9300c8b8378a133c820b98ea64751714204d18', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'c7a94ca8d1af8d32aab0bdacde444e38a34b30bf', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '4d5306b7b6b73b9601819a94054faa41393177a3', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'a708b6eee71a4178cab5a7d2cf994fc40489bdc0', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '566e92177b962205aa7d5b159e8454a28faa1812', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'ac99e073afe36e7e136781cd6db936fefad84274', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '2bb01b582d6cc5c97b3e21c5551b46a205881f4c', class: "m-0 p-0 flex-grow-1" }, "Filters")), index.h("ir-button", { key: '76203736d5fe74fe211e95781912320f8b7630ad', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
            ...
            } })), index.h("fieldset", { key: 'd5fcb433b3754b570f7a8ee9398e762b4c065f66' }, index.h("p", { key: 'da8ad1693cbefdfe06cff1cd0aa84b599e5d4d86', class: "m-0 p-0" }, "Dusty units"), index.h("ir-select", { key: '48a65049ca3ec0aef5eef7e30922e9a967ad676e', showFirstOption: false, LabelAvailable: false, data: [{ text: 'test', value: 'hello' }] })), index.h("fieldset", { key: 'c24f2e8680b3fac14fc7be124cf574687f0c4ba2', class: "mb-1" }, index.h("p", { key: '9b337af59d6ff19a3fb80f60640276d494aca790', class: "m-0 p-0" }, "Highlight check-ins"), index.h("ir-select", { key: 'dcc451b43530f488c027968416d7505dc24d99a6', selectedValue: (_o = (_m = this.filters) === null || _m === void 0 ? void 0 : _m.highlight_check_ins) === null || _o === void 0 ? void 0 : _o.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                this.updateFilter({ highlight_check_ins: { code: e.detail } });
            }, data: (_q = (_p = housekeeping_service.housekeeping_store.hk_criteria) === null || _p === void 0 ? void 0 : _p.highlight_checkin_options) === null || _q === void 0 ? void 0 : _q.map(v => ({
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '6583a7e84a1c4e054e6dd8d60842d6f0a1264f72', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '3515eb72421e3e3dd14466346adb475162445e5e', text: "Reset", size: "sm", btn_color: "outline", onClickHandler: e => this.applyFiltersEvt(e) }), index.h("ir-button", { key: '19f3b136d1d1dcbc43f13c97720c4e627118c63b', isLoading: this.isLoading, text: "Apply", size: "sm", onClickHandler: e => this.resetFilters(e) }))))));
    }
};
...
const IrTasksTable = class {
    ...
    render() {
        return (index.h("div", { key: '2ebfd1fc4dd35501a3afb245a7cfd5f45a998342', class: "card h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '48d16b58ad5b31110265c9145a88da26b8bed5f9', class: "table " }, index.h("thead", { key: 'e9f27524b631f9a81120965dc85b174a6c5c2c6e', class: "table-header" }, index.h("tr", { key: '05ab0bb301a5b3c616114a5025a1d7462a1512f9' }, index.h("th", { key: '35e220d1dcb83d2997b661d28c5e6d59b99c5cf4' }, index.h("ir-checkbox", { key: '393f59a742cb5a606aa3c41a9218f1bde0cbacdb', checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'ad4637d5cfc397ccc5e029c08caf60fcdd2934ac' }, "Period"), index.h("th", { key: '7ea5ff34a2a37b0df88ffe0554313c8d86e522fb' }, index.h("span", { key: '760bbed939e1d43d90bfed22fdf4856f875595a2' }, "Unit")), index.h("th", { key: '7432040778099ac247cb2df88cfbbd7bd78f7846', class: 'sortable', onClick: () => this.handleSort('status') }, index.h("div", { key: '160dc414f5e865facce1c9c716ec90b9fbd5fc27', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '978280c56768b40ead09601a6e5bfe2ba534a87f' }, "Status"), index.h("svg", { key: 'a1663a39a0afa58ceb322d763409068c32dce072', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '58b2abc865c65347be0e8e732a28719963a96d5d', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'd6a3e3195d66008edec68b1c217d9cb8681b0e8f', d: "M17 20V4" }), index.h("path", { key: 'fcdec9cadf8f9e66d4c4f567a9e06e9034fc894b', d: "m3 8 4-4 4 4" }), index.h("path", { key: '6d9777dda591ef38383b4e2f44a8f075a5b94c1c', d: "M7 4v16" })))), index.h("th", { key: 'd5a3cc35c9a0ec2bb5c66cf20308b12734549a58' }, "Hint"), index.h("th", { key: '22c76486783d4867f59764ccf7291b362a1bcf8c' }, "A"), index.h("th", { key: '833189c4e05483cc26c4fb8d5b6fcb574b4ac2b0' }, "C"), index.h("th", { key: '7fdb45cdde7a85a9c68f738183d203abc2ebb5b5' }, "I"), index.h("th", { key: '00703d4a32aded475d3427c894807fe5b1fa1998', style: { textAlign: 'start' }, class: 'sortable', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'af659426742561599fe60658618b5065f75bd898', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'ceb13eeec7d723df45bd41320aae48e9b7224811' }, "Housekeeper"), index.h("svg", { key: 'a39da7e8d4b609bf91b7ada23643c7c354046ea1', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'dc68d45f2b5db536af0691ac8cc776595ca49783', d: "m21 16-4 4-4-4" }), index.h("path", { key: '344803d6de72c0a4ea21240edcdc14666c09a88b', d: "M17 20V4" }), index.h("path", { key: '9b607e515c6a80a0c2cc1ec13462b7bc3bfa9870', d: "m3 8 4-4 4 4" }), index.h("path", { key: '7684ce6b3c08455e9b32ce7d4615f5c62a998224', d: "M7 4v16" })))))), index.h("tbody", { key: '8fb17875f9f57e19522bbc05de18bf0ef71641df' }, this.tasks.length === 0 && (index.h("tr", { key: 'ffe58a52565b5d16448111f5b033d471ab105a53' }, index.h("td", { key: '83afca000a7d7de937aa5bb10c92f9e3db14139e', colSpan: 9, class: "text-center" }, index.h("div", { key: 'e02d2bb3ea5770f8fe68586bbd979b02b23defc5', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '113fff3d56acb4f9a4419ea423887a25ee4447df' }, " No Tasks Found"))))), this.tasks.map(task => {
...
//# sourceMappingURL=igl-date-range_32.cjs.entry.js.map