...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '51f53c4fe39c873ba6b7a8e5c26670c776e6d19f' }, index.h("wa-select", { key: '3310675df8e36c737f7c5e1376427743137c4b45', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: '3bcf315d1f7836b938917091156f5cba1184ca0b', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '7d39cc27ade40eb825495fc711a658eefdf55af6', slot: "footer" }, index.h("ir-custom-button", { key: '355131dea5817a3b88c5525279ec5b359733d331', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: 'ef8150b1dda8354fc3890473667e2b44bb6e41a9', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: 'd73f83a34e073273373d9034979d5f3ae625f8bd', class: "daily-occupancy-table__card" }, index.h("div", { key: 'bd6d40aa95e54779aeeff55bb52de9534216b08c', class: 'table--container' }, index.h("table", { key: 'fff66161e1ec7894b694e025366dcaa3c5cc793f', class: "table data-table" }, index.h("thead", { key: 'd154e654a208d72193b50245ba55f0cacf961da2', class: "table-header" }, index.h("tr", { key: '14a6a3432f73957a5490497306ee147ee84a271a' }, index.h("th", { key: 'aca6ee7cc0f3b2269fe9880fe3b238f0e27e72df', class: "text-center" }, "Date"), index.h("th", { key: 'c8f2b1c1de1b1e9965b68e7d1b9a7e7846003f3b', class: "text-center" }, "Units booked"), index.h("th", { key: '2c28d497b5d50c45a6da5312c685755ad350ffb3', class: "text-center" }, "Total guests"), index.h("th", { key: 'acc00329c9f8ce33d10f6328915ec5e55e3d8c93', class: "text-right" }, index.h("ir-tooltip", { key: 'e224007c5b6f4dc18ea19397abc343179f35dd4b', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '7b5db194849c70c701567f170c7797a1b1b64ad1', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '568172aff1c5dd1fe9e9356669c2051e01ab89e8', class: "text-right" }, "Rooms revenue"), index.h("th", { key: '7d359a3a916f85095b6e6ceec8ada0b3e6ab7688' }, "Occupancy"))), index.h("tbody", { key: '3ad18da33c0061c125d42cdfb756ddae461b5c63' }, this.reports.length === 0 && (index.h("tr", { key: 'cf20b0ebc77f312094c2385c34bb2c3697ce083a' }, index.h("td", { key: '86d28847c7446355c01cd554d50ee1c2fc5993f9', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: 'f12b6c3fa25459b74d132f7d4975e3f7bf2e2936', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: 'd2ae9263e3902556ff8af6329332ffa8582566cf' }, index.h("tr", { key: '4e2d3de445129a9af31fe5c38c9ce8c33bbfcc6f' }, index.h("td", { key: 'a57fac4190a05e009daeb0b2deeb4d18231436ad', colSpan: 5 }), index.h("td", { key: '4e976b18e7285a8ac97c5502b805fc653e691b29', class: "legend-cell" }, index.h("div", { key: 'aef133b7ecf322d65616e17bd7838b2ccf201260', class: "legend-row" }, index.h("div", { key: '4f3e55df578b8d80e138000d5be918b342e66043', class: "legend-item" }, index.h("div", { key: '1966e724260edb8070e00404d09207b54212498e', class: "legend-dot legend-dot--current" }), index.h("p", { key: '797928573c723cf371e00ca47813f377ab3f3d2e' }, "Selected period")), index.h("div", { key: '909cc2da648eb8971ff2c6de48d4f484e38245a5', class: "legend-item" }, index.h("div", { key: '0f921317797fa2a7863dbe7cb1ad6ff2b693c108', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '8a4a6f3ca023e6ee8a3757c013dbb8a9f8c6af83' }, "Previous year"))))))))));
    }
};
