...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '67c800633ab783bad3035f4d89551da922b64234' }, index.h("wa-select", { key: '18716e6306bdc2b85fa4c8592879c18c8e65cf50', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: '8b9628483b14485b33d6441f61d33488341a6029', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '5f18340363083698106808428d98dab5baa58aec', slot: "footer" }, index.h("ir-custom-button", { key: '049bf13bb0b9e7b91a11fa312fa505a49b210cf0', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '49a3b9357bc0af7dc89d61e21e8292cd789a4913', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: 'd1de1c1354358d210c201e235c96b5384f9156c9', class: "daily-occupancy-table__card" }, index.h("div", { key: 'd516e358f6451b009d65e7eee3c21710be93a0ea', class: 'table--container' }, index.h("table", { key: 'f7ae8cb8a03f44d8e2243c91dcf6537e3e0af7a7', class: "table data-table" }, index.h("thead", { key: 'd5036a7622211005b60994ab140631a4c5e0eb6a', class: "table-header" }, index.h("tr", { key: 'c20f49196ffb7588807f5de66c6ed607e6188ce3' }, index.h("th", { key: '53ac51ba90e0018e2a9a90e6c9c768c96a1d0be3', class: "text-center" }, "Date"), index.h("th", { key: 'b6833d4f9c71754bb43b4d34e2b560b57b15300d', class: "text-center" }, "Units booked"), index.h("th", { key: '0d843f3560b75c974e7091ef4f1073df54076d2d', class: "text-center" }, "Adults"), index.h("th", { key: '3a2167bb5247887ca35c076ed01232614c687acc', class: "text-center" }, "Children"), index.h("th", { key: '4adda51454284db71d76b787bece3a847570d868', class: "text-right" }, index.h("ir-tooltip", { key: 'd8124f748ae1f59cd2d46b56f7358b3f1c261f07', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '346146ecdeda2c6bb73e3205cc2dae20a9728313', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '6ab4e5da825fc20968d337217b585afb4ebed906', class: "text-right" }, "Rooms revenue"), index.h("th", { key: 'fbec19960455e8fbca6c61d3cda4330d6d503cef' }, "Occupancy"))), index.h("tbody", { key: '9d961e62e47adce95ceb34c6df05e753181df117' }, this.reports.length === 0 && (index.h("tr", { key: '3af58bc16135f4acf69f8c464bac0832c3f9b593' }, index.h("td", { key: 'f26443076d01a892d993b1afbbcc931c3801de73', colSpan: 7, class: "empty-row" }, index.h("ir-empty-state", { key: 'c91b95489f5603c7df37eaba266ece3aca26d176', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: '0df0beee64441d20d3c09150749628b1da2a624a' }, index.h("tr", { key: '84c728bc995c33483061360450c3c7915dad3dfc' }, index.h("td", { key: 'acc4540d0c2e4a79dc690d69dcdeaab3886ee2fe', colSpan: 6 }), index.h("td", { key: 'e454481745615a699db7c922f037d47339c9a009', class: "legend-cell" }, index.h("div", { key: '786d17c60b01ef7f46d3ad3eaa348a9f22143d77', class: "legend-row" }, index.h("div", { key: '3c263ed06d91805287e2403b591c02504d26d597', class: "legend-item" }, index.h("div", { key: 'c89d0ed166c0be15c8611c602c830dd3157c603f', class: "legend-dot legend-dot--current" }), index.h("p", { key: '132a19f2b7f56e80a23503fe71a9b20fa8051d87' }, "Selected period")), index.h("div", { key: '0769ea74b8f90ada8e074ab62a31884e2fa8e0e7', class: "legend-item" }, index.h("div", { key: 'd27954f71e3cbb5c6b7d42b939de9ff1ec0fff30', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '099dccbd3701a72b88939d34bd8099fd96eaece5' }, "Previous year"))))))))));
    }
};
