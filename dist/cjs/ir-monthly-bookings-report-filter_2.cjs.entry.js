...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '23c83d55992c17a84d45cc239faf2bd01592d02c' }, index.h("wa-select", { key: '17139e4fed0ef4488274128ccd82b1d3d02779ea', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: 'a20a77ddfc92f87fc7347b4354596b71aff6c029', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '13b60245debe80e8252a0ee04978eba56e800406', slot: "footer" }, index.h("ir-custom-button", { key: '6265dd674999cbde6c786bd316628e3c42acff2e', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: 'ddfdf57e88c51c3877288846745f6c2503acb9a7', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: '6cf1dbc15537adf8a5c2d1d63f2664d53e72e9f7', class: "daily-occupancy-table__card" }, index.h("div", { key: 'b8f7d9c15e0ea1f089b5ccb26c2752d0492ea286', class: 'table--container' }, index.h("table", { key: 'a98adcfb4a9258d98657b33e609e8e14eecec015', class: "table data-table" }, index.h("thead", { key: '56248b492568fefac0290ba3c2754db3f1ae63c0', class: "table-header" }, index.h("tr", { key: '2bc0cfa142188e8ec4d0dd2cc25bd570b5ab8efa' }, index.h("th", { key: '45b8c3b8905f34433eb7fd3aae053b0b6e3a5ee7', class: "text-center" }, "Date"), index.h("th", { key: 'c738d93df616e9d71ce2316500e5b592183ffefa', class: "text-center" }, "Units booked"), index.h("th", { key: 'e74df1425949e47c1b68b0268ed66daf534ffe6d', class: "text-center" }, "Total guests"), index.h("th", { key: '01e6648886ba572379d0a81ae29bfeccecb0a3a3', class: "text-right" }, index.h("ir-tooltip", { key: '886e9920bc1f12c1632922e0983b6aa3c06733bd', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: 'a6dfea3b8a70c75d95985a3d6029e98a7ece04e5', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '9887904e324ca5763ef89ea75a9e2c77ca38b9af', class: "text-right" }, "Rooms revenue"), index.h("th", { key: 'f2165ad4d0d71beaacacb5383e0d0ef4afeb73ab' }, "Occupancy"))), index.h("tbody", { key: '2c637e45bfc2e66bb5637ebf5430ed2c7a1776f4' }, this.reports.length === 0 && (index.h("tr", { key: '665e0ca41b19c82920a2d8cc90abc3992303d398' }, index.h("td", { key: 'f0daa5a287324070c44146962ffe746d3c0d1464', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: 'f8b0262a139fd0953a414f60643eb4e1fc3ce94d', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: 'd79bdee864de9f512e6e80389de63f1b70f30bac' }, index.h("tr", { key: '9d3e95c641b74a596217410bf829b66014c368d2' }, index.h("td", { key: '0417775140c39269ba9ed3e2c09235d695d596c6', colSpan: 5 }), index.h("td", { key: '1b58be9c08ca490b73314e88eba8002ef08a6766', class: "legend-cell" }, index.h("div", { key: 'a73cadfd85a2af767c0478859a91b8cada6e7661', class: "legend-row" }, index.h("div", { key: 'a358139ccb28c1f0f9b0043c52598d5869229379', class: "legend-item" }, index.h("div", { key: '96b1d2cd09fca35a9051a91f30a1950d7d3039a3', class: "legend-dot legend-dot--current" }), index.h("p", { key: '82448542c02cdf635c756cb93c7fb5b495adb2a0' }, "Selected period")), index.h("div", { key: 'ac72c8ccf5b9f1e52570be488ebb1e3524c05669', class: "legend-item" }, index.h("div", { key: '4126472125a03ae455fd0bedffb186cbb17f0e41', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '9b98968b236e81dc0b4c447f26f07cff69645aea' }, "Previous year"))))))))));
    }
};
