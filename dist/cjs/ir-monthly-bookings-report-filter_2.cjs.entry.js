...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'ad77a7c2da860a8abedd21d2f3547b2023e50756' }, index.h("wa-select", { key: '1d7550e37e027085d6756001e6818a3ce6f4b49d', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: 'da9514b84769304ca739ebc3e77fef807000fa98', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: 'd10a3a36b94b233a7d31964394dbd0b0f1da2444', slot: "footer" }, index.h("ir-custom-button", { key: 'f58cf1eff5f6283611ab3459010fda5740330d2d', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '307a9b28a8fa65c96773aa1b60f8fafea4d7a6bf', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: '3aeb86f1e5b9817045ce8dfefbefdb97b2428c79', class: "daily-occupancy-table__card" }, index.h("div", { key: 'ad54b2cc950fbedd1edbd0672c158a82f3aeae64', class: 'table--container' }, index.h("table", { key: '97bccbe1059ce60909cd0835d969745ab2fc8cfe', class: "table data-table" }, index.h("thead", { key: 'ef88e20ac659a397c05b1243d0e3a55730e77696', class: "table-header" }, index.h("tr", { key: '6f46a2d6e331df6633fd08d1a9f671d760d4c236' }, index.h("th", { key: 'c7ff4f90b09a6edca865e2bd607dbeaa50ed2d09', class: "text-center" }, "Date"), index.h("th", { key: '9d9ae654b3f486a8e4059f7d4d5892d1c6b40d4e', class: "text-center" }, "Units booked"), index.h("th", { key: 'cf67bd95d8f60c6d22d0ceb4ec702a1091667000', class: "text-center" }, "Total guests"), index.h("th", { key: '8a72e9ffde5e8a37799ec72dfc6e41191de62615', class: "text-right" }, index.h("ir-tooltip", { key: 'cb1407c001077216b329f6d026c286c042328743', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '5d6cd75b82411f22de24414a73624a7eefeef638', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '5f030030391443c7a3113a444171f222bd752bbb', class: "text-right" }, "Rooms revenue"), index.h("th", { key: 'dffa4880e16f07e0d5e0d704f77b79828f156796' }, "Occupancy"))), index.h("tbody", { key: 'dfaf7c52aa9a5b29716bb3ad800cbba55014c416' }, this.reports.length === 0 && (index.h("tr", { key: '4e79e33d256da07ded9648f746f4b04e6bb4ecaa' }, index.h("td", { key: 'cb0bb404ab58f900780b9d9c9382de414a765725', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '4881127ff73635572da24385a18cbd0fe46dc9ab', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: 'a80e74dc7d5a21b6a5acb59a9edcb96b22636f1c' }, index.h("tr", { key: '7fc4a18eca12404264f32420500f7c798a0f8ba7' }, index.h("td", { key: '949907fc4be3eea3f9f32fc1ddc54fa300cd910b', colSpan: 5 }), index.h("td", { key: 'e30184af17428bbadd60fd949967f05ceee8bb53', class: "legend-cell" }, index.h("div", { key: 'ff17b8600f9618c8ed1e5cbd4bc93e39e75a5c8e', class: "legend-row" }, index.h("div", { key: '2d68773ae1352953aa419e59941bca4735a350ca', class: "legend-item" }, index.h("div", { key: '6e632a3a1de2b263a020a582f410ce7aad6612fe', class: "legend-dot legend-dot--current" }), index.h("p", { key: '472febc71b3d42de5fb86f8fb0f43a401085e42a' }, "Selected period")), index.h("div", { key: '907a91fed84128f7c24cbcbadac9e35c08947de1', class: "legend-item" }, index.h("div", { key: 'a267f9a82611408f2bfff4c302b857d424ca09cc', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '828f6196109aae2c2f4d982032e1cf99b17b89e1' }, "Previous year"))))))))));
    }
};
