...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'c59fd898b8c99dad18dca36135decbdac8ee053c' }, index.h("wa-select", { key: 'ec1f272bda1c886a1797235b4f189f225ff55a94', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: '7a68cdf19506d5682fac6a1cd09a1f6b630554f7', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: 'ed7fae9a71c24c3fb0f3300902d64c1b342e77d4', slot: "footer" }, index.h("ir-custom-button", { key: 'f895cbd1cd2dec78071ad74dcafbbd2513b22624', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '79cad223c1f9cd31dc12c5f73852572d2604e9be', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: '0320e3e945c69469fe4caaadc2a85e63cac922cf', class: "daily-occupancy-table__card" }, index.h("div", { key: '385d7689a7f382f641ac22459097f3200fad50b5', class: 'table--container' }, index.h("table", { key: '9caec3b5ae9aa263fd90191e42757b9ea60c8bc6', class: "table data-table" }, index.h("thead", { key: 'b29676593e431faeadb7f96e455212804f0552c0', class: "table-header" }, index.h("tr", { key: '738309e4e71813a61ef5a289f2ea80e53385be02' }, index.h("th", { key: 'fe490b45ed6067888e53851222deb8572346e7fd', class: "text-center" }, "Date"), index.h("th", { key: 'ad5cd8e5084f4dc8ecfc8d095eb75528feba338d', class: "text-center" }, "Units booked"), index.h("th", { key: '7b1adc70c2761c64d1ab6bf2553ccb9317cec606', class: "text-center" }, "Adults"), index.h("th", { key: 'e90e5875fd75b66ab69d77ffddcdf00ee42b906a', class: "text-center" }, "Children"), index.h("th", { key: '4c232318f5cce226f7a8c2dd99db6b4606cd8988', class: "ir-text-end" }, index.h("ir-tooltip", { key: 'b5d0b412bf5b485ff48f4cfdc2ba20675e67fa2c', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '2cc4fc0352941d120ee16e962bb29f52812b33a1', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '2dfbb9eb3d713b5eb30b1b37da043143ec3ec217', class: "ir-text-end" }, "Rooms revenue"), index.h("th", { key: '812448d76e76f899f971405b91d0ee251e40e918' }, "Occupancy"))), index.h("tbody", { key: '79feb7ec818b846bc77c923a4e7977d4ed2549a1' }, this.reports.length === 0 && (index.h("tr", { key: '2e6fa77104aa7ff0d73c08c4877e10796a0cb289' }, index.h("td", { key: '1cfedc4241efcc0f29f4a9a7fef28769bd8e1f0e', colSpan: 7, class: "empty-row" }, index.h("ir-empty-state", { key: '638f4cc5f326d55f0e78f73c0d5ed8dcf26312b1', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: '6fb6ac4224b673bdbf53da39bde41f7b9905eca9' }, index.h("tr", { key: '6a668ed4f272c9f32fc74695e5c389a4ec6d6e40' }, index.h("td", { key: '5696e143a241636f84922b80e7a6a11bc57894d5', colSpan: 6 }), index.h("td", { key: '4613036347b015afde7c5e8966d41d5364c7f255', class: "legend-cell" }, index.h("div", { key: 'b15ae18d84596b97f73ecd4afced8e6e77eda679', class: "legend-row" }, index.h("div", { key: 'f4bb21e8c6eb8d9d8055f4900ce5c06c504d0bd1', class: "legend-item" }, index.h("div", { key: 'a2d04f2be683b86bd43a3595c281b7e9b46658d4', class: "legend-dot legend-dot--current" }), index.h("p", { key: '9c25e3ddca95b5bf08ffc81465db27d3cd3c8183' }, "Selected period")), index.h("div", { key: '3f60bf5cca1798b642adf9172994b18d3a90f265', class: "legend-item" }, index.h("div", { key: '3139ef27996e94ec7fe709402d7ba575e0c6ffa9', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '88c748e6f28c7f7a1d5a0f9c58975dbc7e2ddc49' }, "Previous year"))))))))));
    }
};
