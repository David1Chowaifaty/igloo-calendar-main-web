...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '9af935b51a3d627b1169750776a2ea7501f13346' }, index.h("wa-select", { key: 'b5657ac89d778690b32637efd00f442c8f26cc67', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: 'cf098d653fe7fc2ed321b223b6eedf2aa1587255', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '28ef55fdceaf7eb9e318bb6dded21c101c7aec1f', slot: "footer" }, index.h("ir-custom-button", { key: '101007b0c73381b5c22dff2b43d644b0a00af896', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '152b27d91a817f55188f6b8744fae6d52c07bbe0', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("div", { key: 'ff1ac6ebd7b0e133e8658952e2d59313c822ffe8', class: 'table--container' }, index.h("table", { key: 'dad195f823f6171c64ddc5c6d971a8dbba21253f', class: "table" }, index.h("thead", { key: 'e03df7423e6511bd4891ecf96aa881f0c692b889', class: "table-header" }, index.h("tr", { key: 'ab71047bf98f5820c6854a985cd0bb099c3ea7e5' }, index.h("th", { key: '159b51d3a074f7f0f4f7eb9a0b5bbf2b6a5bc242', class: "text-center" }, "Date"), index.h("th", { key: '1b9915f1838a9f9ca357258089bbf061730396c4', class: "text-center" }, "Units booked"), index.h("th", { key: '2912d32589640794ed50b7f0e69cf80ef1ed0cac', class: "text-center" }, "Total guests"), index.h("th", { key: 'ab47fa41020721ea1babcefb9b316caa3bf13774', class: "text-right" }, index.h("ir-tooltip", { key: '62208421dfcba0714b444df2e0705f667249c9de', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: 'b687d9f321bf977d073bbb793f6bd4014bab40d5', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: 'c6dd9c74e3a1cbe3bbb7b19bb35e977edcba90a7', class: "text-right" }, "Rooms revenue"), index.h("th", { key: 'ddfdaf264960cdc373ded632d7be0c5c7d074d89' }, "Occupancy"))), index.h("tbody", { key: 'dc1760a262fcd449e30ef411b1e39da0309f06be' }, this.reports.length === 0 && (index.h("tr", { key: 'db5b64f747a0421d6bcd6510b89e522e58e35f32' }, index.h("td", { key: '13b6f150175fe3bdb94bea9e02034f7ab691c971', colSpan: 3, class: "empty-row" }, "No data found"))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: 'dc9ab72eaabec561084f197e86a32a9f20fe4641' }, index.h("tr", { key: '4de3bb7910f593abe8de48c541baf230544d599d' }, index.h("td", { key: 'd0dca3d1bce28f80498ec3ebc8cb24b2c81803a6', colSpan: 5 }), index.h("td", { key: 'a4d40067333d3d47e8a7e978a38dcae62ee812e4', class: "legend-cell" }, index.h("div", { key: '4d5361f35333c9a2c2538bc19f276a74cbfd0559', class: "legend-row" }, index.h("div", { key: '06e58e4c9cad4aeeebd0d2b8cf451a2978f4d5db', class: "legend-item" }, index.h("div", { key: 'f2065807c780caf8353e52621ab875c28addd19f', class: "legend-dot legend-dot--current" }), index.h("p", { key: '803c6b608928e2b06602d8ddb5259fbd7fa231ea' }, "Selected period")), index.h("div", { key: 'fc0ecdea10a4f3123566222f5f85bc8d2a4cb31b', class: "legend-item" }, index.h("div", { key: '9f69d59c5b0404ca3956982efa50678ad5c25fc9', class: "legend-dot legend-dot--previous" }), index.h("p", { key: 'bd00d35c521ff186c119646f9981e4bb8497559a' }, "Previous year")))))))));
    }
};
