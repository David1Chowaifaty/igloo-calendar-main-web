...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '6b455cae73cddf33a85e26ae79410a99c018edda' }, index.h("wa-select", { key: 'cbf684cb767b3c7d181fdca7d173fae827ea1099', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: 'ae0d2f546ca1dfe74fa0ad0e7d97991cb2bcde10', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: 'c4d9979510f59aaf7df2308cc2d9a4fd0f76aa6a', slot: "footer" }, index.h("ir-custom-button", { key: 'c56d60d77191108631acfb971e42c2cc9925dfd4', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '3c9a794f7fcb90da720374edb0066dcbcbf299c5', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("div", { key: 'dbe821eab095248d847148dea09666725b845941', class: 'table--container' }, index.h("table", { key: 'a61569877676ecb7ec0826070b4cd311d38a6e3b', class: "table" }, index.h("thead", { key: '993c42e8858a8d170b25e0e3f34f50ae1d195510', class: "table-header" }, index.h("tr", { key: 'f3e374f0265d4315721686376552507c88c4f0e1' }, index.h("th", { key: '5cca0a21d0927207fcc499c597e5ce5350de1bd8', class: "text-center" }, "Date"), index.h("th", { key: '9ec936e1068a619f5df1835e1a407b62aa86bae7', class: "text-center" }, "Units booked"), index.h("th", { key: 'aeab27f1652b98b03604a1159f9436325a68e0d1', class: "text-center" }, "Total guests"), index.h("th", { key: '30324d84ac8621381275ac85e99447cf73dff36d', class: "text-right" }, index.h("ir-tooltip", { key: 'e5dc48a8d99cfb8c8997ceb6d8a316a966ee89eb', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '5f00eade54cde075257f94ee2c643f1756922bd8', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: 'fbb6fe42778bd6042913eff79a0e59130a3c4909', class: "text-right" }, "Rooms revenue"), index.h("th", { key: '55ac01aa25cd1b281b5c3f2a6f4888f83fee5a00' }, "Occupancy"))), index.h("tbody", { key: 'e7b995125250c76ebcbc0e98a30ae54110c5647d' }, this.reports.length === 0 && (index.h("tr", { key: 'bff0fac196f3cad716b62a554bcd64d43c42667a' }, index.h("td", { key: 'c9caefecb825cdee208886992bf2f363d957d5d4', colSpan: 3, class: "empty-row" }, "No data found"))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: 'ea6ad4571349ca5f66cfbefd15914bb19895fbff' }, index.h("tr", { key: '628de7edfedabaaf58e05c65e2ae906b54152746' }, index.h("td", { key: '048e8fc47790e449bf6f6ff583220cfc9273b5e6', colSpan: 5 }), index.h("td", { key: '5c560b6162b9a5f605b9cc9b589b7dd4e1fd635c', class: "legend-cell" }, index.h("div", { key: '9cbe1264e35d4d7b9003a89d9636f94666cf5a0e', class: "legend-row" }, index.h("div", { key: 'a7b91a438000273ed79ebd3bd42571711cc9c749', class: "legend-item" }, index.h("div", { key: 'b50b0a7c5cda9c17041ec1feb7335b88b34b4ab8', class: "legend-dot legend-dot--current" }), index.h("p", { key: '47b2d8d60bb0b0c455278e114947d53d134a1520' }, "Selected period")), index.h("div", { key: 'c2a8469a4bcd4cfb385b9b93b11423d00b45f832', class: "legend-item" }, index.h("div", { key: 'f1029698c7542f04e64f54f99b6798e0a18ef2c8', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '132c0a53cd5e987a2be6cd431d47ba69ada9e211' }, "Previous year")))))))));
    }
};
