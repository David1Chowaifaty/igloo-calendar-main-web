...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '863e9cc3dd90cb94f975279b1d1723083bf730e6' }, index.h("wa-select", { key: '3e42e8d6c4182d6d2a7c5f3f88b0d1c273217f11', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: '5e84cf8b329b41d98bacfd7f21c9ef601cfe25af', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '621c1f6d55a4419c80d50502ae90716d2a8651a9', slot: "footer" }, index.h("ir-custom-button", { key: '736808373df33f1e2c89fbdb9a79531f394cfd43', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '1de4ae42ab455dd0392b1b19f3c8677158d61754', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: '8a9412aeb97fb82c01f00a7440077e24cee2b7dd', class: "daily-occupancy-table__card" }, index.h("div", { key: 'ae532603cb45303b301c902964c188a9e8897126', class: 'table--container' }, index.h("table", { key: '4bc5fca9fc82dccfbe776aed382124cc1e38e3f6', class: "table data-table" }, index.h("thead", { key: '7795982806ca79bf4d948cae07613091fca1619a', class: "table-header" }, index.h("tr", { key: '1818548132202d11ac35a640adc27683eed30ec2' }, index.h("th", { key: '3e6e99eb7c111057acccfe87587e5b114feda9ab', class: "text-center" }, "Date"), index.h("th", { key: 'f0344733ac346b16f92f26072542044f8406de6d', class: "text-center" }, "Units booked"), index.h("th", { key: '4308be1b85682c8b2e183805da2ebcfe86fd6283', class: "text-center" }, "Adults"), index.h("th", { key: 'c6cf6eaf06d0f892df720f9b4a23d788b6525979', class: "text-center" }, "Children"), index.h("th", { key: '4e97a831203952b0f96dc2dc9300f6c0fa2884a4', class: "text-right" }, index.h("ir-tooltip", { key: '815ffa3f04d50638ff03066d5e6081c69fdcc274', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '473833927c4b67bcfb5a3bbf2d81fd446e10d98b', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '5fea47c62f58394ab943997af41d33d07c28b7ba', class: "text-right" }, "Rooms revenue"), index.h("th", { key: '5bbb146bcb7a2a3eb3d9f2c3b80ba610aa611325' }, "Occupancy"))), index.h("tbody", { key: 'd566b67fb0c3cb10bc976d678b334cfbb9a6fec3' }, this.reports.length === 0 && (index.h("tr", { key: '4afbc65cac2d14476210ea461baf2f77efcc5c15' }, index.h("td", { key: '87bde552ce566135d9bb5c2df3d666bd26bfe54e', colSpan: 7, class: "empty-row" }, index.h("ir-empty-state", { key: 'ad70337b32f2cbd44b8324ffae7e21b5eaa1be7b', message: "No data found" })))), this.reports.map(report => {
