...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'f1f437d393a56bf199434e5af9ab57b427625045' }, index.h("wa-select", { key: '1e7f7a38cb666fb82ba9f045b3b6fe1f674c3770', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: 'fafb2977b3e53e209b6ab2921869d33ee35b8e65', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '9487e00cee5e5bdfa491d15d06a0a43c74ffc657', slot: "footer" }, index.h("ir-custom-button", { key: '40bfcb9cd19b9cade6feb7ee7f7bb496a6e92f6d', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '9dfc3c0f38d8810b142f9cee9d9fa80f9b7f2374', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: '8e3a00f3c7b1ed0c23959274ec73baff5594ec94', class: "daily-occupancy-table__card" }, index.h("div", { key: 'f6ebd68d8659c2e48d715729055efd534bde92ec', class: 'table--container' }, index.h("table", { key: 'b8b2cf3a3a7d6403663f1e9f42cdc99a925d3c60', class: "table data-table" }, index.h("thead", { key: 'ae655f4bcbc55407d4ea1a74c92f2de3b0dd7e8f', class: "table-header" }, index.h("tr", { key: '7b52210fac0977c01ac3c9656bb3c507fb93120b' }, index.h("th", { key: '467cbe93840f154136d6b024de84849bb5b415df', class: "text-center" }, "Date"), index.h("th", { key: '57e9796bdbf47c8f454353254c23337fc7eb3adf', class: "text-center" }, "Units booked"), index.h("th", { key: '9192168c6a41e84b043faac44b1e24718222e264', class: "text-center" }, "Total guests"), index.h("th", { key: '26e6326d131f60d23c976e0c9d483598bf70d90b', class: "text-right" }, index.h("ir-tooltip", { key: 'a5b0b251f50e691c3f05f2d789ef6d918be634ee', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: 'ffd6253be53d7d1f0c4d5f201bb349414a3b5d4b', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '45987b6f2a4bcb98aa3cc5ed107407030e255dfa', class: "text-right" }, "Rooms revenue"), index.h("th", { key: 'b008519a6298022ee6b7d574b2476ca5f19c0594' }, "Occupancy"))), index.h("tbody", { key: 'f9f947e537a3e327443f5d2b450da52b11f32e9e' }, this.reports.length === 0 && (index.h("tr", { key: '5abfcd27dae01d0c1a5cd23a572fb64c5b166b02' }, index.h("td", { key: '654c5cb38970988fff37787297ec450c003dca0a', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '61df976ac60880777807db187c273d4aa89df4d0', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: 'a3056fb96e6e91cea9293f32e9c3ca581181ed70' }, index.h("tr", { key: '3a94612c0d8df73e82bdef937809679f84936ed4' }, index.h("td", { key: '711807012d738359240c12318747cc51a5c8a739', colSpan: 5 }), index.h("td", { key: 'de871ac6144d3d480908b13e7032d6a15d1a7901', class: "legend-cell" }, index.h("div", { key: '954febecf7c5fcd4ba8fa3d59e2d462d815162a9', class: "legend-row" }, index.h("div", { key: '53df099da955a34c5fe3315346a47a56d47ede9a', class: "legend-item" }, index.h("div", { key: 'd24472a66f6f65e50e3890519c6310dbc5304cf9', class: "legend-dot legend-dot--current" }), index.h("p", { key: '28814c32b23f3f14a1c7e189e04ac60e5a6426ef' }, "Selected period")), index.h("div", { key: '3ab22fe1e18d587c75d4215dda07f39b724495ff', class: "legend-item" }, index.h("div", { key: '706e225c26e9a3b0944740c4f22d434c9ed24237', class: "legend-dot legend-dot--previous" }), index.h("p", { key: 'f13567dff1610b83999f36079cc7625a696c94ef' }, "Previous year"))))))))));
    }
};
