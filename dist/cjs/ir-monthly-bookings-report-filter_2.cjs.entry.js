...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '06540f792e1d7dc1cf40727a7575031e90871129' }, index.h("wa-select", { key: '589c3cd721def9962c0d7ee433f6c90495c29ff3', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: '202f5ed6d72b59818c2731e991ee404fe7cd64e2', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '7d6f6fd9ae2e59953fccc4c192323ba9a952f258', slot: "footer" }, index.h("ir-custom-button", { key: 'f8fd2f8fbace83863aa4e3f6c7ca718a1fec828b', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '11bdbdbdc2b2860e28f1cd1982577e5fc5ac46c0', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: '6d62e5cca1f0840c2d3d6ae9b593eaef48d7cd90', class: "daily-occupancy-table__card" }, index.h("div", { key: '3e40f5c3862dba19a164979704a10599b04bfc8f', class: 'table--container' }, index.h("table", { key: '33bdbf11981d57ba1ed1a8753284d9d4638b3938', class: "table data-table" }, index.h("thead", { key: '95b094ccb80cea77550a479dc37de303e706f213', class: "table-header" }, index.h("tr", { key: 'f4b806f30ef5e1c96bcd3e06ffa255f46c930f47' }, index.h("th", { key: '31e0d60bc234e116d83fa0d0b7cd15e1427d5c58', class: "text-center" }, "Date"), index.h("th", { key: '113c02eeca8e0f98762aa98bfd3b2c616e9933dd', class: "text-center" }, "Units booked"), index.h("th", { key: '72db3aa64c658734b07b2819f5dd873840721950', class: "text-center" }, "Total guests"), index.h("th", { key: 'f2579878b4e66f3f42419582542ff84f1af32d0f', class: "text-right" }, index.h("ir-tooltip", { key: '76d198010839d078a1bff10e0e69e0a4ff78274b', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '593179ac3eff4173e5e803bf2d6bd3eff91afd08', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: 'bcea13415ad0e0d33b2ed1bb7c2b480e50d6a809', class: "text-right" }, "Rooms revenue"), index.h("th", { key: '42f0548145b00ea9e4d86f4bacc6b925654f5536' }, "Occupancy"))), index.h("tbody", { key: '158bcf3be24e63f1bdd3bcd714e1e4f818721ef8' }, this.reports.length === 0 && (index.h("tr", { key: '24aa315e2bccf598ef8229368b56fc7d62e71e60' }, index.h("td", { key: '92d88bb4f954904c2323b18c761659188a1a4fb0', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '65008503e12106464ed15d6f2a8cc3e8687330c6', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: '3f55b555e56971bcc569c33779732c7df790eb56' }, index.h("tr", { key: '6d033abfed69f34e8cb49bd0c651fde5b979250a' }, index.h("td", { key: '61820b8d2cd53b6d8bbd5c17f84379a4b5e79582', colSpan: 5 }), index.h("td", { key: '0dbcff040e15d9dedcdcba115c577dbb06c1bc1e', class: "legend-cell" }, index.h("div", { key: '4e3e65cfdd251234d3cbe4be7d5da7beaf524e0a', class: "legend-row" }, index.h("div", { key: 'c1b9fe6a558c515523200ec0b4dcc0906fa4d5d9', class: "legend-item" }, index.h("div", { key: '3a34ff23ddd2594d170457262846526046c33b5b', class: "legend-dot legend-dot--current" }), index.h("p", { key: 'a953013ebf8af62416fa1b0cf48813124ab0cc19' }, "Selected period")), index.h("div", { key: '9e657b93957e0b59d406a4a38a8c26266a67e260', class: "legend-item" }, index.h("div", { key: 'c67dd4cacb8f4da0ee64e0af548d8204af872416', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '01ea9ca4982129a749b86d192c99a8d7d4304d2b' }, "Previous year"))))))))));
    }
};
