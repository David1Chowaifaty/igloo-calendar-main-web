...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '317ba3d687c2157dc6758a124fdd86a3e8009903' }, index.h("wa-select", { key: 'c63f16fc23f5d6aad0bba82ebf10cba8407878d2', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: '54e55bf9f5e6ba33e866631b33dc7152bf614b96', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '0a79a7da0abd77080e8cf6c13f1be5f4773b8e34', slot: "footer" }, index.h("ir-custom-button", { key: '74c91d6f9978fb25da0fb558a070af94d921d2a6', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: 'ede325562fbddbc6a5d069f7b4eb9f2db058b729', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: '2e0206382ba31efb53dd9f2a7dc043d9c5b734a2', class: "daily-occupancy-table__card" }, index.h("div", { key: 'fb52b398d237d510c3e0af265e139d448989c329', class: 'table--container' }, index.h("table", { key: 'f6bbc97c61f34ffad6fea04bacb42a1218827aab', class: "table data-table" }, index.h("thead", { key: '150d50f516c4842b28395a9ce65527515ac3533e', class: "table-header" }, index.h("tr", { key: '130e0c4b0e1b2c4d315648cc0337eb6867d1c7fe' }, index.h("th", { key: '22b75311333c15f1644479c64eb101f757f07105', class: "text-center" }, "Date"), index.h("th", { key: '0b3fad9ee360b0accc51a81ad04cf932b3e6d482', class: "text-center" }, "Units booked"), index.h("th", { key: '998a9fda0be37c4f29a2ba5323fcb6d26a3a2baa', class: "text-center" }, "Total guests"), index.h("th", { key: '7a91d30895f26ef003874005f803f5957fc79b4a', class: "text-right" }, index.h("ir-tooltip", { key: '61351bf62e989bf50c54128dfc5354ac8f516309', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '1a09cb4095a371ccda7786ad3bcaf6ca435b2a65', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '640a36e9138abab9bb892649cbf4c86adc502c8d', class: "text-right" }, "Rooms revenue"), index.h("th", { key: '9d55bc637ef146cef249e37a2c7d0463bf2be773' }, "Occupancy"))), index.h("tbody", { key: '90e1e15a2b8039b142e7aa6643aeafd910ac6035' }, this.reports.length === 0 && (index.h("tr", { key: '0376eea14e86668a648a0166e477d1d6f100465f' }, index.h("td", { key: '2b0b27171a759063e6ad9d1a1a550061358a5ccc', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '758491aebe3cda38419bcbe5e6ea2d24a675c00f', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: '767092302b4865aa92a480c843126c8b2ba564a5' }, index.h("tr", { key: '4d9d4fba41972bcd38c158ab8aea41d38e18b07a' }, index.h("td", { key: '57b5e88520a1c008a09608ef1319dde14aa630d1', colSpan: 5 }), index.h("td", { key: 'd83e0715c8ec8ad6254c4e145a5bfeacd92f7cb6', class: "legend-cell" }, index.h("div", { key: '112b3e58b8c112f7ea5ce9b3b7edead074647f0f', class: "legend-row" }, index.h("div", { key: '823b56711116c7208e4279077f5710682fda1a18', class: "legend-item" }, index.h("div", { key: '122f811625bb9a59ef0a5af6f0cb24c6ef431263', class: "legend-dot legend-dot--current" }), index.h("p", { key: 'e4e6f92b8a807724f8c20dcc6261919f5d55e7df' }, "Selected period")), index.h("div", { key: '3ae61a297d5c86a26b9e0807c3417e7c36c864f5', class: "legend-item" }, index.h("div", { key: '4c34306a05e147a292e1c6f2cf34fcac14e7dfbb', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '51db41c7305635b7ec4db51a3845eda75f476c19' }, "Previous year"))))))))));
    }
};
