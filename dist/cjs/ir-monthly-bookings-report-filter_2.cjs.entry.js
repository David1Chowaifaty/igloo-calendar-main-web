...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '34c702558565aa891d749bb6120850794b62947e' }, index.h("wa-select", { key: '3a9ebde17b1bc91aa6e155e6ba1b9a12373b4079', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: '7e1af5510a86bb1f855e1b1bcf68babd77183892', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: 'd31cadb5a4e0a9d1fdc2776d26104c0ebe9e51a8', slot: "footer" }, index.h("ir-custom-button", { key: '3d1417694294f6d1fcad5f7af8faf5859089e771', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '14b6e923694e9749657af8bf9eb5633b038de0e0', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: 'dbc3a7ec2701656642e401ba298bd4af04b5e7b0', class: "daily-occupancy-table__card" }, index.h("div", { key: 'd9306188aed6d252891fc6dcea3f94c5c2a66fe8', class: 'table--container' }, index.h("table", { key: 'db9fac112a47b80b1c470bfd63d4d3e38d9468b9', class: "table data-table" }, index.h("thead", { key: '2b9acc6c9cd0f7812345f1279211e887e654a000', class: "table-header" }, index.h("tr", { key: 'cc417ac4796d3be7470ff6ed7b0790c4c8a4aa5d' }, index.h("th", { key: 'fe80abcafb39eed690db1db13849f4802558ced7', class: "text-center" }, "Date"), index.h("th", { key: 'dd553ba9a91c3532f7a19b6d1d4b335f6d0fa405', class: "text-center" }, "Units booked"), index.h("th", { key: '7835bc5988f1152744019c6c4c5366f533709234', class: "text-center" }, "Total guests"), index.h("th", { key: '9615a599b023152f240b7dfc6253765c28a3f9be', class: "text-right" }, index.h("ir-tooltip", { key: 'c56ed091452cc94fd99a13df66ae812e6128fd46', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '4cee79a95b02b8adf94bbd6b3ab78744983d1834', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '42e73bac3a712882da14cc4d4d58f56dd022748f', class: "text-right" }, "Rooms revenue"), index.h("th", { key: '529919286e42859f31708447e89a10d96279bfcb' }, "Occupancy"))), index.h("tbody", { key: 'e0d6809761feb3f14e515fce4357e26e82f1d756' }, this.reports.length === 0 && (index.h("tr", { key: '27e0b5d09deccaabcf4a35c1e0f5c6164ae9ca77' }, index.h("td", { key: '42ae25047a2f50aa6ff1697a5a7eb6bf3d1c5bb7', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '223558461fa95f5c85f8cee5f0e44b4f7d2e537b', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: 'b258d2a3388471fb26364b1674e116e9b41fa3dd' }, index.h("tr", { key: '6556d80700296a2e52e21f8d1907b442d86e871e' }, index.h("td", { key: '7764487b1607400bbe5881a2766ec31ee07c90d0', colSpan: 5 }), index.h("td", { key: '4280c8d1d0f0b367356325f55b7689dbffa1c281', class: "legend-cell" }, index.h("div", { key: 'cef9e8feab937e9dee5ebab831077a6f4028396a', class: "legend-row" }, index.h("div", { key: '3311ab850c88cc7ba043588105cc8d5fa1a4239e', class: "legend-item" }, index.h("div", { key: '344bff305deff4aabb62937919fd646b998d027f', class: "legend-dot legend-dot--current" }), index.h("p", { key: '6339f9ad7e186c9bdda5087f88155e3a558e771d' }, "Selected period")), index.h("div", { key: '464fe1da2368ec1d7aa7b7d8b6489a319c6b479f', class: "legend-item" }, index.h("div", { key: '901de69f085f6125d927a696b4ffce1d24ffaf9f', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '0a7e4ccd2992d7276f8aad15a857fd74638fbd1b' }, "Previous year"))))))))));
    }
};
