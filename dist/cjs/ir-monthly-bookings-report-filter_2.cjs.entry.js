...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '6b47bab7d9906710156c730a17156cc46c06b466' }, index.h("wa-select", { key: 'e4b532a5e9d7376f47e7583469582963e9f97f97', label: "For", size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: 'a2714a532d2652b593726333f80b30b86fc269fd', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: 'cf193463602a0b62b602d3102a6f134f34fa4d15', slot: "footer" }, index.h("ir-custom-button", { key: '52ca48eaca7b8683bd9d89c7362404e5c102fdbe', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '1aa440791725f4fcb541542932ecf070e485854e', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: 'db6e4ab97ae567b5e90c065a3c9b463fb8aa86ef', class: "daily-occupancy-table__card" }, index.h("div", { key: '1b85d2e7113c0deb42d3d4017fd836f56f503316', class: 'table--container' }, index.h("table", { key: 'ae532603cb45303b301c902964c188a9e8897126', class: "table data-table" }, index.h("thead", { key: '49d274698b840d4172365dac135d71f08c0fe6ce', class: "table-header" }, index.h("tr", { key: '9e0c675a0dc4e3db74f9d3c32f6ede6bc6498305' }, index.h("th", { key: '49dac6c45c8e0baf83aa3235fbe290246b4f615d', class: "text-center" }, "Date"), index.h("th", { key: '4f186528294b07aede67b3ccdf6f8b60839d719f', class: "text-center" }, "Units booked"), index.h("th", { key: '763ef6d6ff2365a179671b2ccc11f156976d40cc', class: "text-center" }, "Adults"), index.h("th", { key: 'a203d704b96b13d63b14a6151bec90b1bb97a925', class: "text-center" }, "Children"), index.h("th", { key: 'b993fb86c57875bf489b5881a04cd0c50fa32794', class: "text-right" }, index.h("ir-tooltip", { key: '936e2af81221a3006dd2526172b152e5a04002a7', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '5124560e778f482137bb0daf5b69924de1d8d03e', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '3b6abcf41fb1fe8992aed2959219043ee1b8bfd0', class: "text-right" }, "Rooms revenue"), index.h("th", { key: '65b3f7832716aabc776e818f51d14d22b67f8512' }, "Occupancy"))), index.h("tbody", { key: '0c97692638aed053fcde1ef30a2e2eb0104c84de' }, this.reports.length === 0 && (index.h("tr", { key: 'b82d0a74d5817b70091c10d3ffeba6b9f13e87a1' }, index.h("td", { key: '5eb5f2b3bffbdfe65145b9026ee23dcc0534d3d6', colSpan: 7, class: "empty-row" }, index.h("ir-empty-state", { key: '105632caf8f59aad63cb5b133d107f4ebc063342', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: 'bb57413fff8c49b8755e1d117e9f578fee64405c' }, index.h("tr", { key: 'd5c41c9f0fb7024cdd524abc3a057a23f8bbb941' }, index.h("td", { key: 'e013e5efff2a521d04a08ac2d9c00e3a0a58cdc9', colSpan: 6 }), index.h("td", { key: '4987eb8133d09d075c0ad56fa9ebffff91bec3c3', class: "legend-cell" }, index.h("div", { key: 'fe6f62b4d3631dabab271a8eaf7aa70d54084554', class: "legend-row" }, index.h("div", { key: 'd165660f8993a33c9387f6857c6d58a33014a2cb', class: "legend-item" }, index.h("div", { key: '12829a740a049523b923ef26855ee2cc1bdf17dd', class: "legend-dot legend-dot--current" }), index.h("p", { key: 'e55b42f9bb0914e716e47d0140f6124b03db6493' }, "Selected period")), index.h("div", { key: 'c6ca9f30ab8f7d5906960e51541bacaeb3f59ed1', class: "legend-item" }, index.h("div", { key: '854a1fb200e99e0c8c26ea98e8901a97801e466f', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '166ee400d62ff41d1528fc529fd7b8a363426434' }, "Previous year"))))))))));
    }
};
