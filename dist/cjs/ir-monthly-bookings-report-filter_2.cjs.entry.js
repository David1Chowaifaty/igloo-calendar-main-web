...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: 'db6e4ab97ae567b5e90c065a3c9b463fb8aa86ef', class: "daily-occupancy-table__card" }, index.h("div", { key: '1b85d2e7113c0deb42d3d4017fd836f56f503316', class: 'table--container' }, index.h("table", { key: 'ae532603cb45303b301c902964c188a9e8897126', class: "table data-table" }, index.h("thead", { key: '49d274698b840d4172365dac135d71f08c0fe6ce', class: "table-header" }, index.h("tr", { key: '9e0c675a0dc4e3db74f9d3c32f6ede6bc6498305' }, index.h("th", { key: '49dac6c45c8e0baf83aa3235fbe290246b4f615d', class: "text-center" }, "Date"), index.h("th", { key: '4f186528294b07aede67b3ccdf6f8b60839d719f', class: "text-center" }, "Units booked"), index.h("th", { key: '763ef6d6ff2365a179671b2ccc11f156976d40cc', class: "text-center" }, "Total guests"), index.h("th", { key: 'afbc489117f5ed2f5f5921f46c3b69092f79d85f', class: "text-right" }, index.h("ir-tooltip", { key: '8a8d76fef130d20f23a7d34d4fc38b5b90f69a6b', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: '6cbfe3916d9128cdcd13622c7fb0a563176e297b', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: 'ade4131f44350bc1ff70f5d382717b105b06d255', class: "text-right" }, "Rooms revenue"), index.h("th", { key: 'c25ae59629bdab9738edb375961b06b067817f51' }, "Occupancy"))), index.h("tbody", { key: '4648df0eb8eb20e4b182e85af9830a83ab8ec311' }, this.reports.length === 0 && (index.h("tr", { key: '0ce39314e2a0b38c75099c9bcba9b6e2b74cc05c' }, index.h("td", { key: '6499f246eeda0ad5afeb9458afce90f30ff0118f', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: 'e9a65cf6e68a024b7fc211435481cae00915da13', message: "No data found" })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: '85946cd608f7a13aee7dcc6a53c447171fe10a94' }, index.h("tr", { key: '882af4b24733720b33d00f442aabdb45ba4c9164' }, index.h("td", { key: '8f0d1801433eebd41ce40e88ebe5d865878a3a32', colSpan: 5 }), index.h("td", { key: '4bdefd0ee95a72d44310cb6f6c411764eeb87310', class: "legend-cell" }, index.h("div", { key: '54296ab3de01399bd3007eca767203fafc506da1', class: "legend-row" }, index.h("div", { key: '06d634421308855fcf2453dd7acf58832ff70d37', class: "legend-item" }, index.h("div", { key: '879e81e688312c9865c88470874b0c78bf81c39e', class: "legend-dot legend-dot--current" }), index.h("p", { key: 'a79d241f6cc9b4d689365f3dc7e03820869b993e' }, "Selected period")), index.h("div", { key: '01b775030fd3a5ca368dddf1f56f95a758396d53', class: "legend-item" }, index.h("div", { key: '9baa7a204d2d6da0fc6de330ceb6fcc28a8eb80c', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '8964ffe9b94987671b58954f12f79ca489b35f16' }, "Previous year"))))))))));
    }
};
