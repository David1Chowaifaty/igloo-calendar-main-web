...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '90a5e7cf923c24cf9b78372a65fcfbdc9dac98c4' }, index.h("wa-select", { key: 'f3cbab86b2baa1698aee57877c5fc8b3a12c7fbf', label: t.t('Lcz_For', { fallback: 'For' }), size: "s", value: this.filters?.date?.description, defaultValue: this.filters?.date?.description, onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: this.dates.find(d => d.description === value) });
            } }, this.dates.map(d => (index.h("wa-option", { value: d.description }, d.description)))), index.h("wa-checkbox", { key: '05b95f3416f37ba02b50b2bb08cceb7cf78578b6', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, t.t('Lcz_CompareWithPreviousYear', { fallback: 'Compare with previous year' })), index.h("div", { key: 'e9f8e7dc2f9c11abeecae13ec26f87c43e30d3db', slot: "footer" }, index.h("ir-custom-button", { key: 'a8a908027537e15bc1f49951c79d6accd2e3b61f', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, t.t('Lcz_Reset', { fallback: 'Reset' })), index.h("ir-custom-button", { key: '543adb14d25dd249a0e50020c074c2b02dfd07a3', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, t.t('Lcz_Apply', { fallback: 'Apply' })))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    reports = [];
    render() {
        return (index.h("wa-card", { key: 'd7145fc8a05663943690c0414c30e6b9683282ff', class: "daily-occupancy-table__card" }, index.h("div", { key: '0db6ccdb3c1b1f3a8fae3d0eed68d38df9f5e980', class: 'table--container' }, index.h("table", { key: '4086236d65cbe74758d2cfbe24390edda1d08b1b', class: "table data-table" }, index.h("thead", { key: 'd9fc60edce575c71a70ba3875bc361c3937ec325', class: "table-header" }, index.h("tr", { key: 'fdf9758439d8810d95805f121c761f055ea9088f' }, index.h("th", { key: 'a38ff0164178057e2922c9a907cf554e714da7e6', class: "text-center" }, t.t('Lcz_DateLabel', { fallback: 'Date' })), index.h("th", { key: '6a53056d65197c46117b5f8bbeeda8149bffd171', class: "text-center" }, t.t('Lcz_UnitsBooked', { fallback: 'Units booked' })), index.h("th", { key: '43863b3d9a9bfb5d5f187b6d3096dce3062204c7', class: "text-center text-capitalize" }, t.t('Lcz_Adults', { fallback: 'adults' })), index.h("th", { key: '11b6fec6c2e6a061fc8b4053fc297dc09d2e0922', class: "text-center" }, t.t('Lcz_Children', { fallback: 'Children' })), index.h("th", { key: '7c3d649de60127eeb7231fd35b20387ba87b2937', class: "ir-text-end" }, index.h("ir-tooltip", { key: 'fc0a79c6ebc30e4f6b005ef7116be97be866954e', customSlot: true, message: t.t('Lcz_AverageDailyRate', { fallback: 'Average Daily Rate' }), alignment: "end" }, index.h("span", { key: '75f5c88d65961a13872b5c6eed4415a567f81a7c', slot: "tooltip-trigger" }, t.t('Lcz_Adr', { fallback: 'ADR' })))), index.h("th", { key: '7f660bfc0bfa4bad500d032a786a4246f88c5176', class: "ir-text-end" }, t.t('Lcz_RoomsRevenue', { fallback: 'Rooms revenue' })), index.h("th", { key: '4410918c3f48dcc6e96b2f46e73d87cf87aa20f3' }, t.t('Lcz_OccupancyHeader', { fallback: 'Occupancy' })))), index.h("tbody", { key: '0ecfa461bd282414bae2189a747573e2f52e1ec2' }, this.reports.length === 0 && (index.h("tr", { key: '0c48e22522a1c63b61425bcc8cb739327340d3d9' }, index.h("td", { key: 'c2d425cf9fb13992cde581b97cd0dac43b81bf51', colSpan: 7, class: "empty-row" }, index.h("ir-empty-state", { key: 'bf406a947df4e9bf1fc9c8fc5b09941a6b1eacd0', message: t.t('Lcz_NoDataFound', { fallback: 'No data found' }) })))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: '31f8b726b5d79e5e8d129b90fa4f20c008fb4f5b' }, index.h("tr", { key: 'ba1acc403f80ff3c838265e1f710f4948aa385f7' }, index.h("td", { key: '98a8596cb5d543440b4c14b692a98abd138a507a', colSpan: 6 }), index.h("td", { key: '672b65df031d07b3f7de86377d05d7fac5238fb0', class: "legend-cell" }, index.h("div", { key: '7d796055adbea811be8d73818ebabfcb3879edcf', class: "legend-row" }, index.h("div", { key: '0cc5f83583969bb484b2f798bbe14561ad6cd5a8', class: "legend-item" }, index.h("div", { key: '0ebc45e286bc41338a2697b8a0583c1d48944766', class: "legend-dot legend-dot--current" }), index.h("p", { key: 'f286ca36206cc8a2a5e7c5159014b405f3196e8c' }, t.t('Lcz_SelectedPeriod', { fallback: 'Selected period' }))), index.h("div", { key: '2525ab3a65d829054e0e89f29483360091d1e796', class: "legend-item" }, index.h("div", { key: 'b3dc2a1b98061016067b255bbfd8822cec91f310', class: "legend-dot legend-dot--previous" }), index.h("p", { key: '238e0f677334b4e7c3722bd9c17d49ef2c0cd230' }, t.t('Lcz_PreviousYear', { fallback: 'Previous year' })))))))))));
    }
};
