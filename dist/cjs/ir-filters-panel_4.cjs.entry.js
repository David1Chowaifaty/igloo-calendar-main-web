...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3581ddb588db792e6b114f756019ca1f61896300', class: panelClasses }, index.h("div", { key: 'e7c41d79ff0088c835face3037d78ac5e3121bfb', class: cardClass }, index.h("div", { key: '38c56bdab258ec043043c5be81ea2ed28a10d4c4', class: headerClasses }, index.h("div", { key: 'f52af0860cda04006ddeded716aa3c332659709a', class: "filters-panel__title-group" }, index.h("slot", { key: 'd7d3c1d8273cf5481b26aa1573abbc72cd7af129', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '332c31e9f9892d8bae2711d34d419e6a9b0df754', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: 'cf92820a4ea6c0135f2a27100530fac9817f15b3', name: "header-title-extra" })), index.h("div", { key: '6e9b628dc645da7c45badffc50b76eb98b9b9349', class: "filters-panel__header-actions" }, index.h("slot", { key: 'cfd165a12ae55f02ff1f955ca8785cdb4f0f48ae', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '1cc0c96efbffc26756bcfe9d8ff591c71c935279', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '28f3dad7770682fb3068603b5cfd5bd731ae3055', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '74f2d6696914f9980a632e4c39f5af0126c34a31' }), !this.hideDefaultActions && (index.h("div", { key: '7742923ec48ff049dab5e1fc74744ca3538ae7c2', class: footerClasses }, index.h("slot", { key: '4dddbeec4f5268c9372591387da50725a73261fa', name: "actions" }, index.h("ir-button", { key: '0d1ad68baeb97af9f61c485dd0aac8f4f4fa2d43', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: 'c790307b39c313244e222f43bcd518eb6adc8a86', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
...
const IrMCombobox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b92a8ebf7574a88d9c8188a5ecd111674b893059', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, index.h("div", { key: 'b6c98cb14039035b07743166c108220337f94825', class: "input-wrapper" }, index.h("span", { key: '1c6dfe552929ca4cfddad69d4d4183d82c666d97', class: "prefix-container", "aria-hidden": !this.hasPrefix }, index.h("slot", { key: 'a28e053aa5eba725cfe90a10773ef786ea7422f1', name: "prefix", ref: el => (this.prefixSlotRef = el) })), index.h("input", { key: 'e8ef9e220b90ac75d13c74eed6c9dd485048e0a3', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), index.h("span", { key: '31b13fa12d7fde899289878924c06b54c65ca846', class: "suffix-container", "aria-hidden": !this.hasSuffix }, index.h("slot", { key: '44ebf576ae8d3e5ac45fa8e5790dcad3b6efaae1', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), index.h("div", { key: 'caef9e17e52c2b1d9362cea6758aec15bad5ed79', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '7f8d0bccd6bfdfd6359a43e8c52d7fa7a1d67da5', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (index.h("slot", null)) : this.useSlot ? (index.h("slot", { name: "dropdown-content" })) : ([
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filters-panel", { key: 'f3e071fc7918c4bf60106c80676dfb5fba617b23', isApplyLoading: this.isLoading, onIrFilterApply: () => {
                this.applyFilters.emit(this.filters);
            }, onIrFilterReset: () => {
                this.filters = { ...this.baseFilters };
                this.applyFilters.emit(this.filters);
            } }, index.h("fieldset", { key: '877951e21c09b8efe849e36413454e131de82dbe', class: "pt-1 filter-group" }, index.h("label", { key: 'f1a75530e6c7ec40fc144c728e2c621abc5a73ba', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Rooms"), index.h("ir-select", { key: '0572670971a7a1a2406adeb739a4292862f44ba0', selectedValue: this.filters?.BOOK_CASE, selectId: "rooms", showFirstOption: false, onSelectChange: e => this.updateFilter({
                BOOK_CASE: e.detail,
            }), data: [
                { text: 'Booked', value: '001' },
                { text: 'Stayed', value: '002' },
            ] })), this.allowedProperties.length > 1 && (index.h("fieldset", { key: '1f2d2e7a9e0dd77f4b8c0b6230d9d36b9fc48fcf', class: "filter-group" }, index.h("label", { key: '83914b852642e55b0058f826b45e51a2e1a91d86', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Properties"), index.h("ir-m-combobox", { key: '510f17b52944e6e487cc7c5ba0185881a5c01c44', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] }))), index.h("fieldset", { key: '949b1c1ca58b859c28b34331ba86ad53c7323471', class: "filter-group" }, index.h("label", { key: 'f24f5f7d9b066e307fb95e1b16b56b7f371fa2d6', htmlFor: "period", class: "px-0 m-0", style: { paddingBottom: '0.25rem' } }, "Selected period"), index.h("div", { key: 'ab94917739a020123ee8f72e14e31304505f7935', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: 'da09f19118834d2063d9185aa0fb8518ef72f8a7', selectedValue: this.window?.toString(), onSelectChange: e => {
            ...
            ] }), index.h("p", { key: 'b567327395a45b79900b30d0f3ff2324d710b550', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: 'f4cebe77860f1e682f448335e8211668987b606c', onDateRangeChanged: e => {
            ...
            }, fromDate: moment.hooks(this.filters.FROM_DATE, 'YYYY-MM-DD'), toDate: moment.hooks(this.filters.TO_DATE, 'YYYY-MM-DD'), maxDate: moment.hooks().format('YYYY-MM-DD'), withOverlay: false }))), index.h("div", { key: '53c89a60f2c798a577dab41e9bb6383e119d8d34', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: '4f40665f6c793a7f772e773f30a7a0bc869f9d47', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), index.h("ir-checkbox", { key: '88662e0fcc5c57d6207e1d9cebcef0da9d741e49', checked: this.filters?.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const tableCss = ".sc-ir-sales-by-channel-table-h{--ir-cell-padding:0.5rem 1rem}.table--container.sc-ir-sales-by-channel-table{overflow-x:auto}.table--container.sc-ir-sales-by-channel-table,.data-table.sc-ir-sales-by-channel-table{height:100%}.ir-table-row.sc-ir-sales-by-channel-table td.sc-ir-sales-by-channel-table{padding:var(--ir-cell-padding) !important;text-align:left;z-index:2;background-color:var(--wa-color-surface-default);white-space:nowrap;color:var(--wa-color-text-normal);box-sizing:border-box;transition-duration:var(--wa-transition-fast)}.table.sc-ir-sales-by-channel-table td.sc-ir-sales-by-channel-table{border-top:0;border-bottom:1px solid var(--wa-color-neutral-border-quiet, #abaeb9);transition:color 0.15s ease-in-out,\n    background-color 0.15s ease-in-out,\n    border-color 0.15s ease-in-out,\n    box-shadow 0.15s ease-in-out}.table.sc-ir-sales-by-channel-table tbody.sc-ir-sales-by-channel-table tr.sc-ir-sales-by-channel-table:last-child>td.sc-ir-sales-by-channel-table{border-bottom:0 !important}.table.sc-ir-sales-by-channel-table thead.sc-ir-sales-by-channel-table th.sc-ir-sales-by-channel-table{border:none !important;background:color-mix(in oklab, var(--wa-color-neutral-fill-quiet, #f1f2f3) 60%, transparent);color:#374151;padding:0.5rem 1rem !important;text-align:left}.data-table.sc-ir-sales-by-channel-table thead.sc-ir-sales-by-channel-table th.sc-ir-sales-by-channel-table{box-sizing:border-box;background:var(--wa-color-surface-default) !important;padding-top:0.5rem !important;padding-bottom:0.5rem !important;border-bottom:var(--wa-border-style) var(--wa-border-width-s) var(--wa-color-neutral-border-normal) !important;color:var(--wa-color-text-normal)}.empty-row.sc-ir-sales-by-channel-table{height:50vh !important;text-align:center;color:var(--wa-color-gray-60)}.sortable.sc-ir-sales-by-channel-table,.ir-table-row.sc-ir-sales-by-channel-table{transition:color 0.15s ease-in-out,\n    background-color 0.15s ease-in-out,\n    border-color 0.15s ease-in-out,\n    box-shadow 0.15s ease-in-out}.sortable.sc-ir-sales-by-channel-table{text-transform:capitalize;cursor:pointer}.table.sc-ir-sales-by-channel-table thead.sc-ir-sales-by-channel-table th.sortable.sc-ir-sales-by-channel-table{transition-property:background, border, box-shadow, color;transition-duration:var(--wa-transition-fast);transition-timing-function:var(--wa-transition-easing)}.table.sc-ir-sales-by-channel-table thead.sc-ir-sales-by-channel-table th.sortable.sc-ir-sales-by-channel-table:hover{color:var(--wa-color-on-quiet, var(--wa-color-neutral-on-quiet));background-color:var(--wa-color-fill-quiet, var(--wa-color-neutral-fill-quiet)) !important}.table.sc-ir-sales-by-channel-table thead.sc-ir-sales-by-channel-table th.sortable.sc-ir-sales-by-channel-table:active{color:var(--wa-color-on-quiet, var(--wa-color-neutral-on-quiet));background-color:color-mix(in oklab, var(--wa-color-fill-quiet, var(--wa-color-neutral-fill-quiet)), var(--wa-color-mix-active)) !important}.sortable.sc-ir-sales-by-channel-table:active{color:#212529;background-color:#e2e8f0;border-color:#d3d9df}.sortable.sc-ir-sales-by-channel-table svg.sc-ir-sales-by-channel-table{color:var(--wa-color-brand-fill-loud)}.ir-table-row.sc-ir-sales-by-channel-table:hover td.sc-ir-sales-by-channel-table{background:var(--wa-color-neutral-fill-quiet, #f1f2f3) !important}.--clickable.ir-table-row.sc-ir-sales-by-channel-table:hover td.sc-ir-sales-by-channel-table{background-color:var(--wa-color-fill-quiet, var(--wa-color-neutral-fill-quiet)) !important}.--clickable.ir-table-row.sc-ir-sales-by-channel-table:active td.sc-ir-sales-by-channel-table{background-color:color-mix(in oklab, var(--wa-color-fill-quiet, var(--wa-color-neutral-fill-quiet)), var(--wa-color-mix-active)) !important}.selected.sc-ir-sales-by-channel-table td.sc-ir-sales-by-channel-table{background:var(--wa-color-brand-fill-quiet) !important;border-color:var(--wa-color-neutral-border-quiet) !important;color:var(--gray-dark) !important;transition:color 0.15s ease-in-out,\n    background-color 0.15s ease-in-out,\n    border-color 0.15s ease-in-out,\n    box-shadow 0.15s ease-in-out}.selected.ir-table-row.sc-ir-sales-by-channel-table:hover td.sc-ir-sales-by-channel-table{background-color:color-mix(in oklab, var(--wa-color-fill-normal, var(--wa-color-brand-fill-normal)), var(--wa-color-mix-hover)) !important}.selected.ir-table-row.sc-ir-sales-by-channel-table:active td.sc-ir-sales-by-channel-table{background-color:color-mix(in oklab, var(--wa-color-fill-normal, var(--wa-color-brand-fill-normal)), var(--wa-color-mix-active)) !important}.data-table.sc-ir-sales-by-channel-table .empty-row.sc-ir-sales-by-channel-table{height:50vh !important;text-align:center;color:var(--wa-color-gray-60)}.data-table--pagination.sc-ir-sales-by-channel-table{padding:0.5rem 1rem;background:var(--wa-color-surface-default);border-top:1px solid var(--wa-color-neutral-90)}.sticky-column.sc-ir-sales-by-channel-table{position:sticky !important;right:0;background-color:white}";
...
const IrSalesByChannelTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ba3a1c0c01e55c70ca9871af0c0eb1435b6e7997', class: "table-container h-100 p-1 m-0 mb-2 table-responsive" }, index.h("table", { key: '02803c1c440e0aaf2cc342a84785248e8d5187f6', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '8fb75e4e92bda3b9e2818037dc800009b142f79a', class: "table-header" }, index.h("tr", { key: '25e58e6da92fc35060553937a7a33afadcec1d68' }, index.h("th", { key: '266ae1340643e6c5fc97fc44b63eb192b350c63b', class: "text-left" }, "Channel"), index.h("th", { key: '61057a46de3af15303b0974684b7268128581e05', class: "text-center" }, "Room nights"), index.h("th", { key: 'f05e901a06922b3f9b102789b2d025ee9889b5a6', class: "text-right" }, "Room Revenue"), index.h("th", { key: '79ccccf3d1a4ba96438cbd445b429235d8725672', class: `sales-by-channel-table__progress-col ${!isSingleProperty ? 'single' : ''}` }))), index.h("tbody", { key: 'dc9af5d1f319281782836622ac61c3b053238024' }, this.records.length === 0 && (index.h("tr", { key: 'd7b9e42d3a4ab60ccac2e227bb8ae7079951d89f' }, index.h("td", { key: 'b9d0755da6846e291f805257eb63cdf5bec97ff4', colSpan: 5, style: { height: '300px' } }, "No data found."))), visibleRecords.map(record => {
        ...
        })), isSingleProperty && (index.h("tfoot", { key: 'b30aa9351214d144a9aefb5691ca6a16770ebe43' }, index.h("tr", { key: 'd0d84068d48ff3cd202b4992fc45fe65e279e9bf', style: { fontSize: '12px' } }, index.h("td", { key: '38c99f3d677cc54435c69bb11885f540fe62575f', colSpan: 4 }, index.h("div", { key: 'caf4a83c91ec162964a987e4211c0085d2d7f772', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: 'de478a2e36d619a4306223651e5dc987788e1823', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '20c474af7dca4b291d923b20e689d3708898fdd7', class: "legend bg-primary" }), index.h("p", { key: '87325ffe631bb5a49a97af50a4b9eeb49af48995', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '9024f9eb8db035350206de5a071bb83f28f9afcd', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'bfc9662770238d726401581b2e84db64f113c8ec', class: "legend secondary" }), index.h("p", { key: '5314cd7e1deef98aebd00c63744823977f87437e', class: "p-0 m-0" }, "Previous year")))))))), this.visibleCount < this.records.length && (index.h("div", { key: '095e6c1f6e51a4391dc65d48cedb8fbeb5395fd2', class: 'd-flex mx-auto' }, index.h("ir-button", { key: 'd86b0a4fc957ddbb765a932ca9c7ff4823f0e24e', class: "mx-auto", size: "sm", text: "Load More", onClickHandler: this.handleLoadMore })))));
    }
    static get watchers() { return {
