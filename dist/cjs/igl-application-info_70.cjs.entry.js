...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c7a1da6df9db177ade63d42204c9c746148155de' }, index.h("div", { key: '76198409316c016f386591e151ea2db27837a358', class: 'd-flex align-items-center ' }, index.h("label", { key: '155d4df61c6e079e9c30d83d19c05f6d030bb606', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'c4b6aa67599d18b71e7094f9312baecc98cac6d8', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '4ed05d04215abb3585a57e94c3705f172b36f981', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '094fa46f33f5bc68457d2aabe080520c3dc4a598', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '78bebe307605e1cc2a7ba2bc7682ee11b5536868', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '9431e72bd36b2bb155ba25b09f96fc12e531a526', class: 'sr-only' }, "clear input"), index.h("svg", { key: '322922558d4d10843a500dbc380d176df73c8f2f', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '554e071d0dd67bc4a91f8a16fc332fb755cb7749', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'cfce6be86a6b79c5f2d35b8f21bf9869979d8554', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '586d95e3692333026994825e92dacf11775a07ad', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: '98552f376de1eba28ecad4b8b04729d44ec342ad', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'bda35987952c0e58247ebe1bc243386c2b19c972' }, index.h("button", { key: '3590db996386b9a74948ffe985272ec8d7c582a7', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '33bb2719290060817ea5b61f684670fe4ce32c4f', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '49fe1f87caf12d71e97c694ac8354509df5fa2eb', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'fd35b2f447e43658959c4539f868d7282135f5f9', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '3f9189e53f7e1b780682e210356a122ec597e491', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const irDailyRevenueCss = ".sc-ir-daily-revenue-h{display:block}";
...
const IrDailyRevenue = class {
    constructor(hostRef) {
        ...
        this.language = '';
        this.ticket = '';
        this.date = moment.hooks().format('YYYY-MM-DD');
        ...
        try {
            ...
            if (!isExportToExcel) {
                requests.push(this.propertyService.getDailyRevenueReport({
                    date: moment.hooks(this.date, 'YYYY-MM-DD').add(-1, 'days').format('YYYY-MM-DD'),
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-toast", null), index.h("ir-interceptor", { handledEndpoints: ['/Get_Daily_Revenue_Report'] }), index.h("section", { class: "p-2 d-flex flex-column", style: { gap: '1rem' } }, index.h("div", { class: "d-flex align-items-center justify-content-between" }, index.h("h3", { class: "mb-1 mb-md-0" }, "Daily Revenue"), index.h("ir-button", { size: "sm", btn_color: "outline", isLoading: this.isLoading === 'export', text: (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Export, onClickHandler: async (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                await this.getPaymentReports(true);
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } })), index.h("ir-revenue-summary", { previousDateGroupedPayments: this.previousDateGroupedPayments, groupedPayments: this.groupedPayment, payTypesGroup: this.payTypeGroup }), index.h("ir-revenue-table", { date: this.date, payTypes: this.payTypes, payments: this.groupedPayment })), index.h("ir-sidebar", { sidebarStyles: {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '23dae687e51f9acf7c9759b4106f741cd112f9ad', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: 'db8f54d3c02bb95aee32debbfdf6064ec19d37d1', name: "trigger" }), index.h("input", { key: 'bf9dfc01d0728239b3fbdc5323387f88c8adc7d7', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '96d7f9c371dc48fc96e6146c0652d8268f25c0b4' }, index.h("input", { key: '4ba32a918d4468aef3bb102a3ce054018d1526ec', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a054874d552a0f68e076b0cf70ffcf3e8ac80be8', class: "d-flex align-items-center" }, index.h("span", { key: '02c005d68b7fab5d70a35584dc6d2c2e74460c55' }, this.dates.from_date), ' ', index.h("svg", { key: 'b28165f0758cc907bc9c56c6dcc1766cc2051705', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '4a4e10aebc7569fdcf3937ad87ad54565501f8fa', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '0c7df037112de6b3e37fce20748ff66543a6e74b' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'e16fd7ef4bb7502d30535d9757a6b9e0c5feb337', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b9ec33be096069048d9263f12cde7142b02b2d64' }, index.h("div", { key: 'a6b7afdc26395608c61e63f03ca45b16f622bdbb', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '4610ac2f831235f24babb0fe1aee84b5fea3ec36', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'bfdeb2c22862c18fd2cbde4531a2bc350ce6842c', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '3de9a72dba7d09ce1c6979b288f2af5dca8e4b75', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '15cfa8880e8d1d1e44a7412120f64d981ca486b9', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'f3926370e4f87f4da196f3cb52f217f978794916', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '79363fbaed089385309e6a95c92d69450f7c992f', name: "modal-title" })), index.h("div", { key: 'e1f3fa15693f07d07781e68f4728c3c057144d0a', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'e134d6647bf1d0b625ee77008a9fdb0d55a01676', name: "modal-body" })), index.h("div", { key: 'd90417454e9af51c67af0b4e97645cf0461cf238', class: "modal-footer" }, index.h("slot", { key: '9b0537a0369094618c83a77298a9fbe08047bd99', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd95a5d35fbf66e040cf56ac9fb7dca52b796a402', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '13bacbd74f68e9378c91a83730653c3b6f44b248', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '63ad49a4e1b1b884fec2fcbd7f772810cbdd0c05', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd4b080f30d80289458297085f48d0d8792e205e5' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '9c295239c6bd9a567d9a21ea1b1ba41629ce0ef7', class: "loadingScreenContainer" }, index.h("div", { key: '6e4fb05aa7cf742a5c768f464ad2f468b32cb98a', class: "loaderContainer" }, index.h("span", { key: '8c1a58f72143c751e8645ec9f074dc7aeb88dcd4', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '2723f565feeb7e8c59421e483b24473ca4d0fe47', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7383cfc04595aa59e6f5d8349f57ade2015df313' }, index.h("span", { key: 'f06fa38ebda5043a6a1a143bbb32db50f8ca3ff5', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '67c34a98ff413bcae44211ded0cb1bfffa277fab', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '902c612b208c07559fe0a985cd06add72be0b5ff', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'f0c102a226e0f05e49db1eba28e8f57f7e4c3737', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'd8d7d90ded59625a5033c4499e1ebb763a7070f5', class: `ir-alert-header` }, index.h("p", { key: '8c1c3fd465df10b0f9a3675f5704aea85191ef12' }, this.modalTitle))), index.h("div", { key: '1514dcc03d2d88ddc78393c21338e985b6103dcf', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '38863aedbfce9c05c823660588a02c776810db35' }, this.modalBody)), index.h("div", { key: 'cf495be5423d0f41ae2135d5880596161ed9515b', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: 'f5e94e75ef44f87a1aa78d5fa86e4f41d04a9d33', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '79dc8fd82e6cf52a5d7cbdf34a4c4d24f4a0a912', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '2e8b74225f2f1c20a87f9578371ed62c2ed49dae', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd0a10551f010f2705feba1cedd52f9c567d465fc', class: "otp-input-container" }, index.h("div", { key: '65316c1f5f8eb4c03a35118b995a0949336ed70e', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '30f7e4c7595436b22d6c134846ffd6082952ba2e' }, index.h("div", { key: '7bda15469ae8a21cb9bce680d86717e5e7c511a4', class: "form-group mr-0" }, index.h("div", { key: '7ecb95f954adb61b24fe31ecfbd487cf6f80f494', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: 'a7478461b0097961314f8b260bf5ee8ed72abd67', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '3665458754275a6876595a1dd39ff0ff4c9587c6', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: 'f65b35123e1d0bf8a27efc16427dd837988b261a', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: 'c2aa7e4b0c8a21fc03ff5f216f5897defcc50464', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '4edd0d100a5a5e9547ec46e04af45bcfc079df23', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '41b7cf6c3e250efa22d25e592985694404e6e9ca', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'ef0fa3d34613960102a0e992492f04ec0e5febfe', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: '60ab7f541821b8e1890901f3a2d22b409905ac59', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: 'd5ff515e443cbf8651c9df3ea338f2682568ea07', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: 'bf92a1857859c7c6654d0c34c3967496c20459c1', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '3aeeb5157916e697e08645054e11864748c98a3f', onComboboxValueChange: e => {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1fb3c10414314ca4bd8e682f0560b3745731ea7e', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: 'e7781ce2bedbdc8e2b28202e9f5bdae32bf6ab93', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '9c10d8c9a0eb3778267d48c96235df02efb3bc6f', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '788005ee043c0881a04fb2915ca17b8c5970975d', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'd5b8bb6e8afb5cb66af571eaf8fcc25331e02b7d', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '2dc3db921eb2a5765374e8a2af7d85ad37597e2d', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'f066a53d7b317bd17ada8f51fd94e527f4334700' }, index.h("span", { key: '344aac9134cd3e39d025f91654fd40f961650f74', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '87da94f8241484b8f909d51d3ea5aabf47829ca2', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd24d3a3d504e3b839a853c4fff7875f8fe063174' }, index.h("div", { key: '77d4f122d8005faac6a973ec6cb7281028e7e8c8', class: "ir-revenue-row", "data-open": isOpen ? 'true' : 'false' }, index.h("button", { key: 'bc3fc3ca479426565c58cbda3aff9745c213a4e7', type: "button", class: "ir-revenue-row__title", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onHeaderClick, onKeyDown: this.onHeaderKeyDown, disabled: this.isAnimating }, index.h("div", { key: '38e5152466ec440a6551c2ec009b350987148bf6', class: "ir-revenue-row__header-left" }, index.h("ir-icons", { key: '5d28eb097c9477f00a10f4a6f95746ac01c46970', name: "angle-down", class: `ir-revenue-row__toggle ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), index.h("p", { key: '3cb6dc3d87cbca72c6aa71e407b76c7665455d03', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("span", { key: '66f7a49658dda7c4858051e86d2d91f123d22402', class: "ir-revenue-row__badge", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: '357e4a5996c6905627bc8f8b45a3f78e8cba7e4a', class: "ir-revenue-row__total" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '79d1100d8407dcf996a80ea2e2ad82083d4b92af', class: "ir-revenue-row__details", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-label": `${this.groupName} transactions`, "aria-hidden": isOpen ? 'false' : 'true' }, index.h("div", { key: '65ea503d2e30a5211434b65e0352aa2cb5e39f08', class: "ir-revenue-row__details-inner", ref: el => (this.contentEl = el) }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
...
const IrRevenueRowDetails = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1ca09dad05bcac137b3840f63791f64ec6a00e01' }, index.h("div", { key: '0a973c0a1b23e8a6275ae6b6ec241a62ccee63b5', class: "ir-revenue-row-detail" }, index.h("div", { key: '2d0f11a410224807bd003a1ca48bc2e2fb6404d0', class: "ir-revenue-row-detail__time" }, index.h("span", { key: '86cc0bcfc87a2eb856ed137ab4a32f8a233b015f', class: "ir-revenue-row-detail__label" }, "Timestamp:"), index.h("span", { key: '622f31149e3d35ca9e26155ae8c98be6a4acb331', class: "ir-revenue-row-detail__value" }, functions._formatTime(this.payment.hour.toString(), this.payment.minute.toString()))), index.h("div", { key: 'c55c68bf85388d787746c95c0a8e540bbd99b992', class: "ir-revenue-row-detail__user" }, index.h("span", { key: '1e6c095c3fd2e03d0efa4e195daa8e3c55570285', class: "ir-revenue-row-detail__label" }, "User:"), index.h("span", { key: '4b212e47003209f0580053e714a227232a2c8f8e', class: "ir-revenue-row-detail__value" }, this.payment.user)), index.h("div", { key: '7651199deb62f9035305b27c0334e822a02f55ab', class: "ir-revenue-row-detail__booking" }, index.h("ir-button", { key: 'd5d37d74e42f7afc465005f963ba001151f46e1c', variant: "default", btn_color: "link", text: this.payment.bookingNbr, class: "ir-revenue-row-detail__booking-btn", size: "sm", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' } })), index.h("div", { key: '638d6e41956a7a8f258fef82f645a2d589fd9ea5', class: "ir-revenue-row-detail__amount" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, this.payment.amount)))));
    }
};
...
const IrRevenueSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '52c7f0138fd06b53dc58603d05770d69f0352dc6' }, index.h("ir-stats-card", { key: 'f98eee7aa45f4488300c095e769e8d578124ce81', icon: this.getTrendIcon(paymentsTotal, previousDatePaymentsTotal), value: utils.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal), cardTitle: "Payments", subtitle: `Previous day payments ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDatePaymentsTotal)}` }), index.h("ir-stats-card", { key: 'bf3119e1e7e1d6d8a81ca9bd89ca2dcca2ead5cb', value: "123$", class: "refunds-card", icon: this.getTrendIcon(refundAmount, previousDateRefundAmount), cardTitle: "Refunds", subtitle: `Previous day refunds ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDateRefundAmount)}` }, index.h("p", { key: '73c524244b3b7d293dc11d79e5d91b2d651156c4', class: "p-0 m-0 text-danger", slot: "value" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, refundAmount))), index.h("ir-stats-card", { key: '1205083bb2b51aff8f55facf0d0ae2fd9583027b', icon: this.getTrendIcon(totalAmount, previousDateTotalAmount), value: utils.formatAmount(calendarData.calendar_data.currency.symbol, totalAmount), cardTitle: "Total", subtitle: `Previous day total ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDateTotalAmount)}` })));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        return (index.h("div", { key: '1ced62b0f82ade0b7d3d1fca1631061dc24e97ce', class: "card p-1 revenue-table__table" }, index.h("div", { key: 'fd82cf5c88446a00f8e5d158c674dda6f7b1885b', class: 'revenue-table__title-section' }, index.h("p", { key: '365207bcc83a6e323e17074a9ead908395c3e6bb', class: "m-0 p-0" }, "Payment transactions"), index.h("div", { key: '556414eecada046f7c45f566ac864d0c1d209c35', class: "" }, index.h("ir-date-picker", { key: '7eb1aae967771251a416f16dc75478a06d343cda', "data-testid": "pickup_date", date: this.date, class: "w-100", emitEmptyDate: true, maxDate: moment.hooks().format('YYYY-MM-DD'), onDateChanged: evt => {
                var _a;
                evt.stopImmediatePropagation();
                evt.stopPropagation();
                this.fetchNewReports.emit((_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("div", { key: 'd2463d1217ea9ad7e371e67b5915a340e0b7cd17', slot: "trigger", class: "revenue-table__date-picker" }, index.h("div", { key: 'd361ca2264a0c40d17de779e1638faace705f0de', class: "revenue-table__date-picker-icon" }, index.h("ir-icons", { key: '33ea455c5261b16fa37a250779190d7d111eff94', name: "calendar", style: { '--icon-size': '1rem' } })), index.h("input", { key: '57a8f1af3356956f64bce243172357a32c624f05', type: "text", value: this === null || this === void 0 ? void 0 : this.date, class: `revenue-table__date-picker-input form-control w-100 input-sm  text-center`, style: { width: '100%' } }))))), this.payments.size > 0 ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), Array.from(this.payments.entries()).map(([key, p]) => {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f155234606cf23fc0cdc94423eda3e1fee276cde', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'cfe4b800474fbb98d3752811d786eb1004b07035', class: "input-group row m-0" }, label, index.h("select", { key: '98cdda20d80d76f914a98e5f89ae78d84644fb7f', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '4f3b65641387fa7b24d5aabf104b18aa14a4e568', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'a54f235d41d8101ed9cda0b86511599cbcab0979', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '39d3190545af8f68e1ab591ce21648bd52d92bc0', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '8109c74e08a4983b374e383b97f3dc4015c3f1d7', class: 'sidebar-title' }, index.h("p", { key: '0837a8b8944b3394a83a0af1cfbdb517ac9cf536', class: 'p-0 m-0' }, this.label), index.h("div", { key: '82458c04d36cc0bc9b9e521012f2bf0d59e7e085', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'ca408f0098993fde882551aca79806e3f6169988', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '149a6b26644935e043a933c4359e26e68ad40f05', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '047992c48eb5f7673d482e83e3f9a556fc9c9835', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: 'd829efbd895a68d84a42e5f0b46c3fbae731c1f1', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '6713ebd7833570658fab322fc28e986e5f4decea' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b457195639b8d35d8639e0b03d29ae23b02df0cc' }, index.h("h4", { key: '944d8cd8da6538f4ee61e853b0396e74640712ed', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '683bc7838c111004814981a53f2686a714e47771', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '0083bd9981e321b90c9bcb766b4adb44744a54fa', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '6bf315c2c8e99dd25d32e837d4d4e799e312a301', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'eb2f75ee4ec31c791a311c323eaa706a18779115', class: 'title-body' }, index.h("slot", { key: 'd4c76ead0f5f45161c2f773fead3c93e4a80e7e2', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_70.cjs.entry.js.map