...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '8c7d6bc61651f5b970678d44b2bbb117e9e39c72', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'd333e3dc125990db9b10606fe1bdb98401989eae', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: 'eb36cb659d3a4cf4bfbe80381ec25855326df85b', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'd4bac3302878bac1f8c6033b10654c9d2c4d557d' }, index.h("button", { key: '3003cfaac578b9d8944dc0a7c9f33347b12396bc', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '331a0886e79d1d4b51e190992de637cce9042477', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '191aa423b10d3515fd6e317b019894f70a82f0fd', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'cd20fa9d862053794a8f079aaef5edc6387fa386', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '732789060d0fe9aed473d6b77c152c550d1629ec', class: "dropdown-item-text" }, "Invalid Country"))));
    }
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'd151e477ed5adef3b81f5b8af7a6a1b9337d7e9d' }, index.h("div", { key: '044c427f160119997dd471e4854d8bf11825d92e', class: "form-group mr-0" }, index.h("div", { key: '2c7de9a206e25535cd3ea90b359ac534f082a107', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '1f200eac49907baff799e8a7c0ec97773a8558d1', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '7d852c5c6a08d4d4715d77db1d56b23d07116eda', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: 'dd7026249acb45026249e36ae80815fb480c5139', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '3adac1604b094c8d23846f6488ccd2322f7cd7b1', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '4a2e23554a76f9ad20adbac4ffb59a9fc1266042', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '31ff90ce8dcc5c1b15f69927baf360f7ff34630c', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '39c1ccfdd867e6d52152b08a642092ea1a363030', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '96f762e7262ead9e400eea4bfce95b1aefc321e3', type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), ' ', this.isDropdownVisible && (index.h("div", { key: '83c8f5004e1315b648842e15b33f928067909433', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: 'f9526f8c3ab30285aeb00552e57522199653e4a7', onComboboxValueChange: e => {
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '46a84a24abdfbc26d2bf7bbe616f59a24e3f338b', class: "m-0 p-0" }, index.h("span", { key: '1bdd1df693382cd144d578c0c0333bc045bbb5be', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '02f610c913b01b04e517ca70593853ea2f45397a', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '2723e3018b3a6ccec184c1d03e901a60a3c23c15', class: "tooltip-arrow" }), index.h("div", { key: '483e7f30e9dd64df86973fa7607462d46447a54c', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: 'c89b68b249ea90bd63b937cb9046058b3d1b7a5a', innerHTML: this.message }))))));
    }
};
