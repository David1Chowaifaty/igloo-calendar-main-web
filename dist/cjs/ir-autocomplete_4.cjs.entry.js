...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '01c6f2c0b9e82689347cc3d030f7ad976f2efd15', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '5e97ecfaea88d0db6c08f7f86948f5ac68132d6e', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: '29e1171fbee28a2525e58e57197e5c743bd1d58d', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '4e32549d29265412eafc0cb7f7a3479836175d30' }, index.h("button", { key: '30b39b4dbbb6f8009a9adcc85abe5d510ce6c705', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'a12642aa4aa57d171e9b94de48f0d774bc7ae9a3', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '751d664be7045c859b75518ca8699057db0dc65b', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '124001de1247f300f26ce166bf1efdca069c43e4', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '67659d28dbffd89475a676db39124ac2e594a618', class: "dropdown-item-text" }, "Invalid Country"))));
    }
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'aaad9613f6e61bdcc7def78476cdf9ba01c81d62' }, index.h("div", { key: '482f83e5c9e07a15eea7887035977eb93fa967b8', class: "form-group mr-0" }, index.h("div", { key: '6805eb1ae68d647c1e3c17a8497823d404483edc', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '6d29b765ea571afe0ead7a050d42a7e254a02dd4', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'cbc12b70d6c8aaa4b02b160937cc0f6b369557f7', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '8943d26b1e99e69647ef1f49d5e84b543e9c9ea8', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: 'fd0fc707f811a3da22e8e9657c19e8d1dafb2740', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'be0ce5a93ac29e34eff81d5f83f32e6a90b35c5d', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'e391e0b7a79de2fd9f31a9fb63181d5d6dc66a10', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '868f6b2e476e4f49b0be020e1eb8a54c88ed4e70', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: 'b5c831c8eca49026750b07d6647b1a9440a9a74b', type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), ' ', this.isDropdownVisible && (index.h("div", { key: '98df36249e1b1a10860cea8a5502ee0ff09450b0', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: 'cee1f3c8f271bb211a92a3592f3d4b194a6e2d98', onComboboxValueChange: e => {
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '20a79e2794276e21b215bf9246d6a5ba083dea08', class: "m-0 p-0" }, index.h("span", { key: 'd03858ffb6da09f73d62ff9056c57d169cd96eff', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '2c3148e15b629e4d9d34d579f93e41d8e2fea344', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '522cd398e4162cf73557a76c472b74b7b0b88d68', class: "tooltip-arrow" }), index.h("div", { key: '15a734c5a8d21d9cbfab0e9e84076fcee10a01cb', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '6b7415339935aefed929f1d64db3ba0f20ad2a8e', innerHTML: this.message }))))));
    }
};
