...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'd07093a9b78e958f4dd5a07b8322158a64c31820', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '7c897fac87955a20b47d59ef6aa16287a170f365', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: '4ac65b5f92886744738aa8a158fc12da4072bf03', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'd8a0a4d28f9105c72a482ac876363f4a6832e9ff' }, index.h("button", { key: '54e8b691749a589719cd66c818dba51e660e9c23', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '3d4616de798d572d5563cbd00ea2cb083f0d9d18', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: 'bf17f2359a765c04ae9c71d340fd62f1f91f9e61', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'a181762a9c9c6fce0fa4fc7cc85b27a2065222ec', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '0033f9dea97d12d7a81e0d677275fbd4d217996c', class: "dropdown-item-text" }, "Invalid Country"))));
    }
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'f34f91bd1519b79a02cd1459742bfb486bf05b00' }, index.h("div", { key: '4998a55219d17eedc9c7aa54f1997996b846a3f6', class: "form-group mr-0" }, index.h("div", { key: '61c907ee7244e682b55cad9d27dd392c27c70bbe', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '9d6b9c0eed851b5abbefd9f5352e5f4eec6d4752', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '5fbb69898034d1719f378b534e9726c13b4c55bf', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '1577cb2c09c5e043e51770f796fda907db836953', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '9f9a997fea7dc15975f38e9f528f04e4cd101f3f', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '4acd12cbf5100bf09613633caab44d3ee996b3e9', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'a6edf0a9f7eecee2264bcb79bb2ddba4131230fd', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '0b03005ce609880bc4903d632c966708646f0ac3', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: 'cf4b4e45d9f5bd96e0d03a4c59f2f02f9a791e9c', type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), ' ', this.isDropdownVisible && (index.h("div", { key: '8a05784549e0b8cd9eb33e584e6e9d389f35e6c5', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '88ade0448c50eb529dd839d43ce3931c6be8f1e8', onComboboxValueChange: e => {
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'baf9a0edd13496b0c4556b0757d358a025ea411f', class: "m-0 p-0" }, index.h("span", { key: 'eee068dce3c0f81742228160017aa85e0ff8fef1', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: 'c845481eee9edf87e62d6764f27ae6e9e333aa8f', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '0b0388c66c580d87c43c48bac9d01aecf52f51fe', class: "tooltip-arrow" }), index.h("div", { key: '72f8edf44bf4f9c2d8254d755fd69c6bd567aad9', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '99bf1913a97b0a415db0006a44ef8d322d5524ce', innerHTML: this.message }))))));
    }
};
