...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '41d0bb5bd2444f222655dc4d7d1103ff21e118dc', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: 'ef3f808cbee26ef8f8dba4ec1275b55138c0804a', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: 'fcea9da7d04d9cf8ca90bef94bb70fae7ce11593', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'b542e6b9f27bf68f082c3523d5a0b53b11da4f4c', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '4cb24dc3d4bd81729c5c0583d864a8523cfe8f8d', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: '19eb5a2e533a4e5496d8e515cfa98fb763376358', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-input", { key: '004212138494eda86ac80860992d651180766bcd', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-input", { key: '0d96008f4f72af25b3905fec8b572edb1540635c', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: 'ac59dd3ad0afb2a324dde58d51db49d08dc47b92', class: "ir-print-room" }, index.h("header", { key: 'e9fb00bb636a8e7cf6150117ca8f1e6ddd4a8666', class: "ir-print-room__header" }, index.h("p", { key: 'f06bc28945708a97f6cda158073f20f31d7aaae5', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: 'cc2597e8a7542d39ceef2f1eb0eba0d1f9e5e470', class: "ir-print-room__unit" }, "(unit ", room.unit.name, ")"), index.h("p", { key: 'c6f5d9301c62d4cfa16cddb1892a2caa5fb0edb9', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: 'fc6a4845578f6013b10fdd986137a1889a0b87f4', class: "ir-print-room__body" }, index.h("div", { key: '37ad02b48fdb13e8cc013a5ece189e7e35619e4e', class: "ir-print-room__details" }, index.h("div", { key: 'f8dd78d330d965d98c64e764f4eb3d4f1f37f7ec', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: 'ce6c0b2bff0bab54e42dad3ef864c10eea24b337', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: '6f6df6962e2f65832a48c4b1dc4dc77a200887a4', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: 'd84c7ed4ea0e37642dab3cb7552ce8b4a0e5a3d6', class: "ir-print-room__row" }, index.h("div", { key: '09d735110f81d2ddd735ecc2030e349b0599263c', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: '32b1eb843a67dd9006d269768ed08c1e4ca96ce2', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: '5a4ca49e95b7bee774d2ba822580902895e6275a', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: '87b4e75af2ed31c91bd2c010fe5f27a09d3e9a42', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: '689ca78bdca26f30213be50b555a6b8422a7e303', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: 'faeaab606531425d08415147bcb37b135cda3fb1', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: '53bafb09082d03ea36235149973d4a219830065f', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: 'd795dad5bd3495f2d67e18ffe6540ad2c1dcd3fc', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: '09dedce498ccc37c9dffa6b46af188484c435447', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: 'b282dc6feabaf23474060162c8e417392f63b996', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: 'fcd1a7fa5a53c13bd9adc32cbecc50ba87af2fbb', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: '1f126682d299843c8f4cb5ed4905c2bb9094cbbb', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: 'd7bc6fa33cb067f17a0f6088fea432ba4ab600e4', class: "ir-print-extra-services" }, index.h("h3", { key: 'c927dfd75f8b2cbba4d69530a14224a34b52b3e6', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: '48cad020acc76b937739b60f6394aa4d7a92bfac', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
