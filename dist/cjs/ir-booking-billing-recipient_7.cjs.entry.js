...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: 'da2bef6c81d6aff19fac40ad700be53ffedc5313', class: "ir-print-room" }, index.h("header", { key: 'a4743c7a4ef4ec3c1a5c379432bd44ed1651c4c2', class: "ir-print-room__header" }, index.h("p", { key: 'ee7dc91bf20b3622d02e024cfa5c90b31f0c6b62', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: '77e3041e3b2cac6480eeb0685afeb78d70f06a25', class: "ir-print-room__unit" }, "(unit ", room.unit.name, ")"), index.h("p", { key: '99141fa08e00ebf5c46e22988fc68bddd2bfd46d', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: 'ce3f653f21aa07e2fa5ffaa7b47e737b65bd4537', class: "ir-print-room__body" }, index.h("div", { key: 'a3c2adf2cc39a4c661af1abed3a89948a5ab8cf6', class: "ir-print-room__details" }, index.h("div", { key: '0320b6991871fb48db479ce89fb84a3b6121bf95', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: '70efaac445898dafd53194ef20123bded2165e45', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: 'd7bae84c5a78afbfb2efd2170ec4e2c564f90352', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '070569e649b4047032bac09a485deffdd5f25919', class: "ir-print-room__row" }, index.h("div", { key: '873e5ad1641c3dce2d3d99bbc55374768fecfc01', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: 'f21dca64e23fe364709dc2aa9d1356e28f701333', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: '7811da1d08d88ef8677c1ca110a545f6e259c466', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: '2c01d82f6a1630882536e7ae47f3963630186864', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: 'd8b910df7bc246dbc2c8e8d23bce5ec1a525a0e8', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: '2823c5bbc997d3579b92a248447fb833aeb18243', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: '8802d73bcb82086dd0b403715738f61c0b541b25', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: '37896e910d60b0cefc654c20a480e6b3efd642a2', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: '843a161a3987cd6cade43526d99de64d25c21e53', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: 'efc679abea7b3f4172559dff5d69d3a6ddb539c7', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: 'f6944e569404d1512439126f755be6b9b546fdf9', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: 'eb52d4fe3e0c0ef9478b4b428001d8c24d1b4c78', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: '6bc041b48736ba7426df3ce459be5d69b1e71d8b', class: "ir-print-extra-services" }, index.h("h3", { key: '46eac765f522adfc0a4be1dc31d1cbc2b66b646d', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: 'e0657a39c2ed97168216881f7456aca87ec2d231', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
