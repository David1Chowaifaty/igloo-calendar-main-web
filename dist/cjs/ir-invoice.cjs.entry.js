...
const IrInvoice = class {
    ...
    renderRooms() {
        ...
        if (!hasSplitGroups) {
            ...
            return groupRooms.map(room => (index.h("div", { class: "ir-invoice__service", key: room.identifier }, index.h("wa-checkbox", { class: "ir-invoice__checkbox", checked: true }, index.h("div", { class: 'ir-invoice__room-checkbox-container' }, index.h("b", null, room.roomtype.name), index.h("span", null, room.rateplan.short_name), index.h("span", { class: "ir-invoice__checkbox-price" }, utils.formatAmount('$US', room.gross_total)))))
            // {this.renderRoomItem(room, indexById.get(room.identifier) ?? idx)}
            // {idx < groupRooms.length - 1 ? <wa-divider></wa-divider> : null}
            ));
        }
        return groups.map(group => (index.h("div", { class: "ir-invoice__service", key: group.order }, index.h("wa-checkbox", { class: "ir-invoice__checkbox group", checked: true }, index.h("div", { class: 'ir-invoice__room-checkbox-container group' }, group.rooms.map(room => {
            return (index.h("div", { class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("b", null, room.roomtype.name), index.h("span", null, room.rateplan.short_name), index.h("span", { class: "ir-invoice__checkbox-price" }, utils.formatAmount('$US', room.gross_total))));
        }))))));
    }
    render() {
        return (index.h(index.Host, { key: '678e009501fec6747c01ee0a4a7f6d6c9d7ceed7' }, index.h("ir-drawer", { key: '45c42ff8a45326486783321b53bb848ac5d43026', label: "Invoice", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("form", { key: '5c9b94860c8121a23db8aaadadaa098f454331b2', ref: el => (this.invoiceFormRef = el), class: "ir-invoice__container" }, index.h("ir-custom-date-picker", { key: '2ed42905cf4d0cccf82d34d888420921c216cd78', label: "Date", date: moment.hooks().format('YYYY-MM-DD'), minDate: this.getMinDate(), maxDate: this.getMaxDate() }), index.h("ir-booking-billing-recipient", { key: '65ae41ec0d5d0298cf254eff0f6b3361cff270a3', onRecipientChange: e => (this.selectedRecipient = e.detail), booking: this.booking }), index.h("div", { key: '21d3928333189bb78b5d56e56e20e9ba6f2da35e', class: 'ir-invoice__services' }, index.h("p", { key: '9f68ebd963e49723ee462c6468a3d0aa477a90a0', class: "ir-invoice__form-control-label" }, "Choose what to invoice"), index.h("div", { key: '0d397f83776854c40bef9ce22fd8f2e51a260c1d', class: "ir-invoice__services-container" }, this.renderRooms(), this.booking.pickup_info && (index.h("div", { key: '006b4077bd25aa5fd1a5f58513bb1a1fdf589a9d', class: "ir-invoice__service" }, index.h("wa-checkbox", { key: '26faf09ac4dcf3109763d8ca4246fb47deab709c', class: "ir-invoice__checkbox" }, index.h("div", { key: '214ef837404fbe85fbd61c2e5c875f5f82bdbf0d' }, "Pickup")))), this.booking.extra_services?.map(extra_service => (index.h("div", { key: extra_service.system_id, class: "ir-invoice__service" }, index.h("wa-checkbox", { class: "ir-invoice__checkbox" }, index.h("div", null)))))))), index.h("div", { key: '9e2cb975151aa015d069cc712873bfa475761133', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '538ffa5bed5a4de71488df3ea8f85effa9d0c2e8', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: 'ba769d5e22f91cacf6633fd63cc9317c572561fa', onClickHandler: () => {
                this.handleConfirmInvoice(true);
            }, size: "medium", class: "w-100 flex-fill", appearance: "outlined", variant: "brand" }, "Pro-forma invoice"), index.h("ir-custom-button", { key: 'c512c70b0d2e638093fd0285f0aade54191381f0', onClickHandler: () => {
...
//# sourceMappingURL=ir-invoice.cjs.entry.js.map