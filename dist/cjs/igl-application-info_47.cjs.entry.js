...
const booking_service = require('./booking.service-f264d05b.js');
const locales_store = require('./locales.store-4301bbe8.js');
const calendarData = require('./calendar-data-fbe7f62b.js');
const utils = require('./utils-452a00ec.js');
const v4 = require('./v4-9b297151.js');
const moment = require('./moment-1780b03a.js');
const events_service = require('./events.service-989ad9cd.js');
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'be1a094738ccb90bc73f09d795365bb9f72e8b9f' }, index.h("div", { key: '3ac70d39520624acc2f927e883ce46e145eb859e', class: "text-left mt-3" }, index.h("div", { key: 'd155c6ef4f0f44b387c5f0a48f5df9bce603c73e', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: 'bc90aa160a61fec315b4bd2bf21cb5aa4548af11', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: '52e238c1856707f36507588995dfc3bfea9be6e8', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: 'e571eda7d411d8a5748513eb5c03b0ac5ae29db5', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: 'b17b1358693cf8bfd892358aa0e7587639363896', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: '7dc0065fe9b7f4ade5b2a17fb3fb5828c8f7f866', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: 'e61495fe3992d375148cf1cd4df9d9c3f9c7dcd6', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: 'edbad157a65a4dd403079467e426468d38178e3e', class: "p-0 flex-fill " }, index.h("div", { key: '9137adbe85557ff44851f5d8389040f8871414ed', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: '09e3e13c699af6df434ebc7abecdb8687322f6bf', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: '83c3234fe7d62945a80f8e2144216534096667f7', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: 'a40017f688b3c8f4a6fbea9af77095e56d04319b', class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => this.handleDataChange('firstName', event), required: true }))), index.h("div", { key: 'cc3bc98836960e75ec51078cb85b4f83ae663fc2', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'ec8b95539038cc0b5baf3131761022e1b6671e37', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '525619cf98bff62c786a40fd7e7bcb2cff146a27', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '1d1383e37e9c59063a41b9f74ebc58266f0b0688', class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: 'f7e40a8f92e4ff1ec255ebd0c62c9d6a60eb65a3', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '5eaa0ef2ee2eda07c7eb45f8cc05a5a81ed5607e', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("div", { key: '1e223cbfe79e4c2282cd1c8fae5350916a4a9444', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '68489c2b6a3799bba7cc9b2ceda7f8b076d00cfe', class: `form-control input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('countryId', event) }, index.h("option", { key: '47b8b6f580478b6bd53f4bf7ec18db654b484367', value: "", selected: this.bookedByData.countryId === '' }, locales_store.locales.entries.Lcz_Select), this.countryNodeList.map(countryNode => (index.h("option", { value: countryNode.id, selected: this.bookedByData.countryId === countryNode.id }, countryNode.name)))))), index.h("div", { key: 'bad3e6f66827aaae15910cd7d7b9ee0e8fa69090', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'c0b1d1c9494ec1e4e5ca694f419347b22f6e6796', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: '35e7bdd7eb3019a3fd58d5f31ce27144f5f8cd14', class: "p-0 m-0  d-flex  controlContainer flex-fill" }, index.h("div", { key: '0571bfc3af21edb5ac09fbc301eaff16c6dd8fd2', class: " p-0 m-0" }, index.h("select", { key: 'db5536be1b61ada5d897a310c3134604836f7d61', class: `form-control input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('isdCode', event) }, index.h("option", { key: '1e92a8ed9f58f464d3a788281accbe6acfbd5086', value: "", selected: this.bookedByData.isdCode === '' }, locales_store.locales.entries.Lcz_Isd), this.countryNodeList.map(country => (index.h("option", { value: country.id, selected: this.bookedByData.isdCode === country.id.toString() }, country.phone_prefix))))), index.h("div", { key: '0f6bfbb7ac6fd6366dd73437daf28108aff8e541', class: "flex-fill p-0 m-0" }, index.h("input", { key: '8de661de5dbecf18ebb5da446b5bd265b03013fc', class: `form-control
                     
                      `, type: "tel", placeholder: locales_store.locales.entries.Lcz_ContactNumber, id: v4.v4(), value: this.bookedByData.contactNumber, onInput: event => this.handleNumberInput('contactNumber', event) })))), index.h("div", { key: '31a2f6edb790f129f353a20b0e042553de1e0bde', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'afc3be81e603cf67f64fd8cf61ca6d8dcf9031be', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: '197b0c550bd4c77537225d0ee121fe1ea4b56237', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: 'd84ce8303e50cd332c71ccac37d74f53142038a1', class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: 'af07bd68e7058d0bfcdc70fba982372fd5a4ca42', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: 'a143f33eb0762a17b7811b50e2aaec13407311f2', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '4c8303f93da93677686cd0b0066cc26c123ebf58', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: 'd3d758dc5d9cecede11355e4e37c246920c368b1', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: 'e89808a66a4ac4977693aa4e64e83ede8128685b', id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, { key: '951b5d6a02a2c2b5939689dc5a67c0f7befd3c20' }, index.h("div", { key: '5ba20c2cd5e509dfb59bf1864fb8ab77f6d2253c', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '0adef2d586fde51a00a3adb85617a6c7c5dd0510', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: 'd13eb8261ad566924ff44bf3c9269432f545084f', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '3c8791a36a1a43fb6a4978d28f892cac2ce819f1', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: '97cc179094e9559d0a93e10f8f9e22d4a4b3f7d5', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '848cb25efccedf20ba049257e7b3c4f30be52573', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: '40ee095190a04a45ebf61f9e23b8feac74eb3b85', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'ad39b015366755c42efd9f87d2b0b37f5257a4ba', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: 'd392129b6304a40777808f71d2bdfb6542ad32e5', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'c10a4af003659ce0e28dbf86739835909876fb9c', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: '39f01eb62c6b35c965603c19e8f313ee85ac6f6d', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: 'e0971c21b88bda42764ead54a5a3d29cf993fe26', class: "p-0 m-0" }, index.h("select", { key: '9ab57b2e893c6e947b0e7da8c6af7e35499f7139', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: 'dddf9cd50f0653e35291f5c833d9e6a97994e99c', class: "p-0 m-0 ml-1" }, index.h("select", { key: '85191599b32015a52a08293dbaa88cdda0256e63', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: '11d4171b00e1382eeaa8dae89741cd9501d6c063', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: 'bd48abfb81493d870a766d1f698d98ac92bab015', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: '69ac5588a5b0468653e0d7123ad04c13e777d7e1', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: 'ad9b577a682efe121835b27cff7a73ebbceb1c1e', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '140849329a01ee73b57bf7bbc7d688cba6565245' }, index.h("div", { key: 'c2c2480b64404e803f26d3fbe562ea70fb72327c', class: 'd-flex align-items-center ' }, index.h("label", { key: 'a902c303dd9a3d92b9ef6185442748da91a655eb', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'd8e07cff1755bee5b7c15f867a436bc1788137d2', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'e9f9a15ae48a19060c7bac31741d09984054251a', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '67f78c568912bd8c8469723cd69d9e27675e921d', required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "off", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'd8a181726dd1c355dec4ac19955f44e4b9efd0ec', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'f800726cb0a44b180be04e877a544a27ddb290ce', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'dba0cb9a12e2a87093236c7136a5baee7170ec52', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'c412d29584c62fd8b26eb94a0853785e6e0e2c4f', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingListing = class {
    ...
    isSingleUnit(id) {
        ...
        const roomtype = calendarData.calendar_data.roomsInfo.find(r => r.id === id);
        if (!roomtype) {
        ...
        return (index.h(index.Host, null, index.h("ir-interceptor", null), index.h("ir-toast", null), index.h("div", { class: "p-1 main-container" }, index.h("ir-listing-header", { propertyId: this.propertyid, p: this.p, language: this.language }), index.h("section", null, index.h("div", { class: "card p-1 flex-fill m-0 mt-2" }, index.h("table", { class: "table table-striped table-bordered no-footer dataTable" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 :
            ...
            _o.map(booking => {
                ...
                return (index.h("tr", { key: booking.booking_nbr }, index.h("td", { class: "text-left" }, index.h("button", { onClick: () => (this.editBookingItem = { booking, cause: 'edit' }), class: "booking_number" }, booking.booking_nbr)), index.h("td", null, index.h("p", { class: "p-0 m-0 date-p" }, moment.hooks(booking.booked_on.date, 'YYYY-MM-DD').format('DD-MMM-YYYY')), index.h("p", { class: "p-0 m-0 secondary-p" }, functions._formatTime(booking.booked_on.hour.toString(), booking.booked_on.minute.toString()))), index.h("td", null, index.h("div", { class: "h-100 d-flex align-items-center " }, index.h("img", { class: "mr-2 logo", src: booking.origin.Icon, alt: booking.origin.Label }), index.h("div", { class: "text-left" }, index.h("p", { class: "p-0 m-0 booking_name" }, booking.guest.first_name, " ", (_a = booking.guest.last_name) !== null && _a !== void 0 ? _a : '', " ", booking.occupancy.adult_nbr, locales_store.locales.entries.Lcz_P, " ", booking_service.getPrivateNote(booking.extras) && index.h("span", { class: "yellow_dot" })), index.h("div", { class: 'd-flex align-items-center booking-label-gap' }, index.h("p", { class: "p-0 m-0 secondary-p" }, booking.origin.Label), booking.is_in_loyalty_mode && !booking.promo_key && (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("title", null, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied), index.h("path", { fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" }))), booking.promo_key && (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", "stroke-width": "1.5", stroke: "currentColor", height: 18, width: 18 }, index.h("title", null, locales_store.locales.entries.Lcz_Coupon + ':' + booking.promo_key), index.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", d: "M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3M3.375 5.25c-.621 0-1.125.504-1.125 1.125v3.026a2.999 2.999 0 0 1 0 5.198v3.026c0 .621.504 1.125 1.125 1.125h17.25c.621 0 1.125-.504 1.125-1.125v-3.026a2.999 2.999 0 0 1 0-5.198V6.375c0-.621-.504-1.125-1.125-1.125H3.375Z" })))), booking.agent && index.h("p", { class: "m-0 secondary-p" }, locales_store.locales.entries.Lcz_AgentCode.replace('%1', booking.agent.name))))), index.h("td", null, index.h("ul", null, booking.rooms.map(room => {
                    ...
                    ? '_'
                    : utils.formatAmount(booking.currency.symbol, booking.financial.gross_cost))), index.h("td", null, index.h("p", { class: `m-0 badge ${confirmationBG} ct_ir_badge` }, booking.status.description)), index.h("td", null, index.h("div", { class: "d-flex justify-content-center align-items-center", style: { gap: '8px' } }, index.h("ir-button", { title: "Edit booking", variant: "icon", icon_name: "edit", onClickHanlder: () => (this.editBookingItem = { booking, cause: 'edit' }) }), index.h("ir-button", { title: "Delete booking", style: { '--icon-button-color': '#ff4961', '--icon-button-hover-color': '#FF1635' }, variant: "icon", icon_name: "trash", onClickHanlder: () => {
            ...
            }, icon_name: "angles_left", style: { '--icon-size': '0.875rem' } }), index.h("ir-button", { size: "sm", btn_disabled: this.currentPage === 1, onClickHanlder: async () => {
                ...
                this.currentPage = this.currentPage + 1;
                await this.updateData();
            }, icon_name: "angle_right", style: { '--icon-size': '0.875rem' } }), index.h("ir-button", { size: "sm", btn_disabled: this.currentPage === this.totalPages, onClickHanlder: async () => {
...
const IrExtraServiceConfig = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (index.h(index.Host, { key: '013af59563d228bfa670198338d29a5b8aaf4a16', class: 'p-0' }, index.h("ir-title", { key: '4eb9d7915f53658f48ca3e89fbeb744a91d00fea', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: 'Extra Services', displayContext: "sidebar" }), index.h("section", { key: 'd5650a90e595f244b4871c1c5b18132817903676', class: 'px-1' }, index.h("fieldset", { key: '63b52ab35bb001bebd3f4f9a28a38704a4e95b1d', class: "input-group mb-1 mt-3 service-description" }, index.h("div", { key: '64e4e2dad320fd36d0109466d63242ec4b4307e2', class: "input-group-prepend" }, index.h("span", { key: 'b9fbb92c35830ab3889d801554e0dbe801b87169', class: "input-group-text" }, "Description")), index.h("textarea", { key: '3d52a1b0f356aa36a989cbbb128c2eb506c39ead', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '4af2b4c9dafea0a29cd59ee8f083df89a7a78060', class: 'row-group mb-1' }, index.h("div", { key: '1852c008b6bc90ec8bb1a993aff02d809ab64170', class: "input-group mb-1 mb-sm-0" }, index.h("div", { key: '5c5cfe10bc6a578b8c1573cb7f9e1ebd7f000640', class: "input-group-prepend" }, index.h("span", { key: 'b841f6ff416c0b737b36d05a4a1d9b66ebc50a8e', class: "input-group-text", id: "basic-addon1" }, "Dates on")), index.h("div", { key: 'bb865f15438980670aa491fca0d2850ba30e7b73', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("ir-date-picker", { key: '143550406e2780a5a85d68dcefaca6c9a5458fab', date: ((_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date) ? new Date((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) : new Date(this.booking.from_date), class: "hidden-date-picker", autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start.format('YYYY-MM-DD') }) }))), index.h("div", { key: '104ddc34d5027b9a0fa118b578e882cf294718a1', class: "input-group mb-1 mb-sm-0 " }, index.h("div", { key: '05557356ec08e41be6523a5c5aa77794a1b8c572', class: "input-group-prepend " }, index.h("span", { key: '0d0a4598533103f604df21d5223558a4ebc90292', class: "input-group-text until-prepend", id: "basic-addon1" }, "and until")), index.h("div", { key: '631d613cfee081f9a68f54f9f0b4354d7e84b9d3', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("ir-date-picker", { key: '53486f960f9ac5e1be5076bbc1b7baadaa7d0a62', date: ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.end_date) ? new Date((_f = this.s_service) === null || _f === void 0 ? void 0 : _f.end_date) : new Date(this.booking.to_date), class: "hidden-date-picker", autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                this.updateService({ end_date: e.detail.start.format('YYYY-MM-DD') });
            } })))), index.h("div", { key: 'bf5e8d9504abf1e9449c8dc6de50d04cc6f56a18', class: 'row-group' }, index.h("div", { key: '03b9203853aeb9763df246deca43e00940452c15', class: "input-group price-input-group  mb-1 mb-sm-0" }, index.h("div", { key: '8f9bc32c2aeba3f0e0100cfc0f1d5826f121a0d6', class: "input-group-prepend" }, index.h("span", { key: 'bb65607d600eb1016da3ee79d23b2b14b001721f', class: "input-group-text" }, "Price")), index.h("span", { key: 'fd7ffb92fb3243098a0ad53fc384542701c3a283', class: "currency-ph", "data-state": this.error && this.s_service.price === null ? 'error' : '' }, this.booking.currency.symbol), index.h("input", { key: 'fa9801c4eb904119c8e5cae443ca0951195c1f8d', class: `form-control price-input ${this.error && this.s_service.price === null ? 'is-invalid' : ''}`, onInput: e => this.updateService({ price: parseFloat(e.target.value) }), onBlur: e => {
                const input = e.target;
                const formattedValue = parseFloat(input.value).toFixed(2);
                input.value = formattedValue;
                this.updateService({ price: parseFloat(formattedValue) });
            }, type: "number", step: "0.01", "aria-label": "Price", "aria-describedby": "amenity price", value: (_g = this.s_service) === null || _g === void 0 ? void 0 : _g.price })), index.h("div", { key: '5e819bf7299642768f672c0fc08e462e4d4731ce', class: "input-group cost-input-group  mb-1 mb-sm-0" }, index.h("div", { key: '3ca56c9e657f47aace2c546fdaa6fbd8770fa186', class: "input-group-prepend " }, index.h("span", { key: '4a8e81932b7acb401dc99d1987c197eca2d062df', class: "input-group-text cost-input-placeholder" }, "Cost")), index.h("span", { key: '1e79d83052b76da985d3053c99904dbd86431bef', class: "currency-ph" }, this.booking.currency.symbol), index.h("input", { key: '2c431691e61c101a1fd468fa093eeb3275bc9664', type: "number", onInput: e => this.updateService({ cost: parseFloat(e.target.value) }), onBlur: e => {
                const input = e.target;
                const formattedValue = parseFloat(input.value).toFixed(2);
                input.value = formattedValue;
                this.updateService({ cost: parseFloat(formattedValue) });
            }, step: '0.01', class: "form-control cost-input", "aria-label": "Cost", "aria-describedby": "amenity cost", value: (_h = this.s_service) === null || _h === void 0 ? void 0 : _h.cost }))), index.h("div", { key: 'd0a2fbd3d2b1d6272f867a8356f78eca7c669cf7', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '30e959894b436c4bdad3f209eebbb9161b139e34', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill mr-sm-1`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '9456f29604a70b38c862ce376a69b3e2ba18ec15', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.saveAmenity.bind(this) })))));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8384e4fec5a6eac3836a8f166caf2b36a21c5c78' }, index.h("a", { key: '5abfb63f2a8db8725082232c511f062879332351', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '01e8493ddf3947881642b0bbb689077fc0650079', class: "sr-only" }, "download url")), index.h("section", { key: 'a225979c2d073acf94b20169bd2846ce6690475f', class: "d-flex align-items-center " }, index.h("div", { key: '23132ac870da1d0ac889e5f4705be78bf79dfe82', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '3a2107d2318141b2cc78ac8db6215adb57e91f49', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '34271b636fdbfc5f737dcabbf1e2fac0882725c0', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'fcb949d11bb6d6835e573d43b75d819789b193f4' }, index.h("igl-book-property-container", { key: '7d3156d44e3aa171ce3d1d3728dc3abb18388ef0', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '1520097bf72bb37e9b25fe12758a0c452cbd1c62', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: 'f499b68d2ba4bceeede2f9bdc5bc4c6ac08acac0', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: 'd48883d4c9bfdf9354a66e5576a8eda3ffe289b1', onSubmit: e => {
                ...
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'cf5f4f9633b65b4f43071ab9fb168e1363a5bf73', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
