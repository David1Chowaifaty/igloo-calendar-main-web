...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: 'e3d3e4843f1ffcf36caca24fbf8546386fe2beb5' }, index.h("ir-interceptor", { key: '5ff7ad3e14a0ccd28bce289661d8f884b71eabfa' }), index.h("ir-toast", { key: '8edca9faf84af5aba39a5f1e51237585a4fa2ff5' }), index.h("main", { key: 'fb8a99fc84405a1f80614c16ed3a3837159b9ee1', class: "ir-page__container" }, index.h("header", { key: 'baa9cb82729566c3c7053ba7ac2c667c797abfcb', class: "tax-page__header" }, index.h("slot", { key: '006959ba0e50bb6bd932f04bbbab6fa2446835f2', name: "heading" }, index.h("div", { key: '400f222cf9e3d2bbd39facf28143476275a2bd58', class: "tax-page__heading" }, index.h("h3", { key: 'fe55a8f18b1d2e2d98f3c5bdb0e8cc8473a9c4f9', class: "page-title" }, this.label), this.description && index.h("p", { key: 'e571d569aafb469db72d984789908f512feb2a99', class: "tax-page__subtitle" }, this.description))), index.h("slot", { key: '51a6c8d7aec97699064158da5d8e55f105788a7b', name: "page-header" })), index.h("slot", { key: 'cffcb18686c7f2e90da362c4aff8c53c53a8d00d' }))));
    }
};
