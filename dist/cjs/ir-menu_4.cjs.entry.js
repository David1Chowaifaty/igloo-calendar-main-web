...
const IrMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '608d1a53e0fb676a62123072a01f76f9a31c5b93' }, index.h("slot", { key: '1ab19acbdc489e68f1d1be2626b202c9c9165a7f', onSlotchange: this.handleSlotChange })));
    }
...
const IrMenuDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'd54d02dbe8896f499bfaeb11ddfee978abb907c4', class: "menu__drawer", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, style: { '--ir-drawer-width': '25rem' }, placement: "start" }, index.h("slot", { key: 'beddf29c5f448e5f986d8fd924775d34c74da096', name: "label", slot: "label" }), index.h("slot", { key: 'f01544b5cdb04f261a93f1207d77f174637a23de' }), index.h("slot", { key: '0495508118da0d9ec2807d441e937d773d036d79', name: "footer", slot: "footer" })));
    }
};
...
const IrMenuGroup = class {
    ...
    render() {
        return (index.h("wa-details", { key: '547b47a6561e69e6277e5f3a2fe2af4ca374edb3', class: "menu-group__details", open: this.open, appearance: "plain", name: this.groupName, "onwa-hide": this.handleHide, "onwa-show": this.handleShow }, index.h("slot", { key: '0e889b0f36665757b16d7b5ad9267b5de1166ef6', slot: "summary", name: "summary" }), index.h("slot", { key: '899269775981fb458d629d92c9755be3d2e9ba92' })));
    }
};
...
const IrMenuItem = class {
    ...
    render() {
        ...
        const content = (index.h(index.Fragment, { key: '27f7383009ff9ba04d5f8f79dd5b0d5d7894a754' }, index.h("span", { key: '69135772aa1ab44dca8395e42d2fb3824147af56', class: "menu-item__icon" }, index.h("slot", { key: 'b40acdf68996d7bc3be6f8d767a2bc0e11642d65', name: "icon" })), index.h("span", { key: 'de1bafb7b1b75cb20b2d7b86fdf949b7fddefdd1', class: "menu-item__label" }, index.h("slot", { key: '8266d366835fa624810c7f400b7a7d977cf2e16e' })), this.badge ? (index.h("wa-badge", { variant: "danger", class: "menu-item__badge", appearance: "accent" }, this.badge)) : null));
        return (index.h(index.Host, { key: 'e520a57ce6b20a8f52c653a7e3e4dad1c503b406' }, this.href ? (index.h("a", { class: contentClass, href: this.href, "aria-current": this.selected ? 'page' : undefined }, content)) : (index.h("div", { class: contentClass }, content))));
    }
};
