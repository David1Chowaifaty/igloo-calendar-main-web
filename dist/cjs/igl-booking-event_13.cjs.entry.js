...
const toBeAssigned_service = require('./toBeAssigned.service-c26fbd42.js');
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '46300b5373399acb1256696a6ef1cedb7642a4c6', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: '787514d7b1bfc998064f6b83568fdc0b5b9a886f', class: `bookingEventBase  ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: 'f0fdbd1478b1851c36f3eaf1b6ce329930578786', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'f7ad5dbe769762a096da9e97c1db8a76355a1ba5' }, index.h("div", { key: 'b7d00b36b223701e25f941a718fc1ddfdfbe8b0c', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'ac43e3baff46eaa16eb64c01bdc5a830485cf106', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const iglBulkBlockCss = ".sc-igl-bulk-block-h{display:flex;flex-direction:column;flex:1 1 0%;height:100%}.bulk-sheet-container.sc-igl-bulk-block{display:flex;flex-direction:column;flex:1;min-height:0;gap:1rem}.animated-container.sc-igl-bulk-block{transition:all 0.5s ease}.physical-room.sc-igl-bulk-block{margin-left:1rem !important}.physical-room.sc-igl-bulk-block>td.sc-igl-bulk-block:last-child{padding-left:1rem}.room-type-list.sc-igl-bulk-block{padding:0;margin:0}";
...
const IglBulkBlock = class {
    ...
    render() {
        ...
        // ];
        return (index.h("form", { key: '1de5f6b67a67b106b87e2433effda23a0e817104', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '600a30a571ce1e07e516a25c9ac4ca954571535a', class: "sheet-body px-1" }, index.h("div", { key: '73beda86531fc2c243baa11f660499dd1f084cd4', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '2365848458673c375453e6f1e46ea0d04f2851ff' }, "Select the unit to block or unblock.")), index.h("div", { key: 'bb7d0b3ca43d660a4c5ccb0a54b2d0048a06372a' }, this.errors === 'rooms' && (index.h("p", { key: '6b840c57864f452b98676e46d0ccc558256f7b69', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("ul", { key: '534cdd168e7e7c104b6e491209fa715b7f5864fa', class: "room-type-list", ref: el => (this.unitSections = el) }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
            ...
            return (index.h(index.Fragment, null, index.h("li", { key: `roomTypeRow-${roomType.id}`, class: `room-type-row pb-1` }, index.h("div", { class: 'd-flex choice-row' }, index.h("span", { class: "pl-1 text-left room-type-name" }, roomType.name))), roomType.physicalrooms.map((room, j) => {
                var _a;
        ...
        }))), index.h("table", { key: '9553a3481e860c8daee9d2cfc16c7d93e1980274', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '978e767176d3dbf8d26c4879c854ae468f727506' }, index.h("tr", { key: '5f564d01c2f22f64494a805d0e0f19cf575d4d83' }, index.h("th", { key: '2a15f5e054bd8c13dbaee0a8e8315702920aae07', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '19f7c16638ddf0c0c1a4b1b167cff3f45bc4f7d2', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'b5dd6fb69be6db91f2131de04b882984abaa8e00' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '248f59638ab5664acf5db6669638c7f75a33afaa', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '5351e59bb17c7eec5b0d16da90819e89cdd45c36' }, this.dates.map((d, i) => {
        ...
        })))), index.h("div", { key: '2c2e235746371fa32788e6a5f4e942ab392d0499', class: 'sheet-footer' }, index.h("ir-button", { key: '1c456b1b269137bcbb2a9d5e4744f5b34cebfd33', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '43143cada6aaa4b128fd828584c20dbfce7a22e1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '6a98550e9dbbe4c7ed1a25a43f57365551f44cf4', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '71b99bbcc3db39e4ad4a025db464ba06be6cd92c', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'c1d99ad2b3a3264a49869e04d88009a5e0131067', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: '86d7c2e976d6173ff2e1a49d12efcaefeb688d2f', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), ((_a = this.selectedTab) === null || _a === void 0 ? void 0 : _a.id) === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '6fd0d80b00f1f534adcc6f18cbfa22b82116f178', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '02ee8deeeca0ac5242b564ef8b0972789cc0e006', class: "sheet-body px-1" }, index.h("div", { key: '113443cff0f5553450caa1db0ddbf25057efd67c', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '4145d69d71d59cc3b27a14e4a38e136cb6f8c2e4' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: '211cdcae9f758fe8182ce650c3a5b5f36e6fe448' }, this.errors === 'rooms' && (index.h("p", { key: '269da3dd969c2cbab8c30aad6d3ba4357d2a3a1d', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: 'f0985398a5d10514da7ab1b5bb9ad429af4e8469', ref: el => (this.unitSections = el) }, index.h("thead", { key: '86f3199bd58a5635b620fafb0f0e061a45e83218' }, index.h("tr", { key: '0b84484c052804bb8648bd715d7211f63025336e' }, index.h("th", { key: '6aa15bf9d440bdefa906e01cc12037b222723949', class: "sr-only" }, "choice"), index.h("th", { key: '054bee6c4d19e3661c1c2166124bec1880b678c3', class: "sr-only" }, "room type"))), index.h("tbody", { key: 'b6ca28f47f26a10cb46a67574a19c77b700b646f' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
            const row_style = i === calendarData.calendar_data.roomsInfo.length - 1 ? '' : 'pb-1';
        ...
        })))), index.h("p", { key: 'df775793741a0d053f77c4ea893c67ba0ba1f5ea', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '346cbefd3e07ab80c3d2b7bf7ea76fa9462678d7', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: 'd4db88e5815f2b32b09e6b02a0ffabd9a9148c93', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '2a447348dffb493bfa37c571d427ca457e9a069e', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '92bfa98b7181f6487768f8d15ddba61e999339e0' }, index.h("tr", { key: '4ba2f941fa1f36fef656d2f8cd7bfd56b8feb452' }, index.h("th", { key: 'dc21c01864d8ae040fc5e3b9293941e36998d1c3', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '21cd5c3cc2afe3f84b5562b9c335746733bc7313', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '103541554713db2a78672c675c1bce551e6f8a28' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '2424c436c283cf3b624ecb242f60afbd3e648aa1', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '3c2c9fb9062096fb1aa2887477d46c110760e2bb' }, this.dates.map((d, i) => {
            var _a, _b, _c, _d, _e, _f, _g;
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: '0f9fe81a7019b36ab9c4479d4fac8fc5584857ef', class: 'sheet-footer' }, index.h("ir-button", { key: '5cd68503e27d48dd6e27e2a5217df0917a4699c1', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '11b1a2160d5a66a3e696febcd188636014109a19', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    getRoomsByCategory(roomCategory) {
        ...
        return (_a = this.getCategoryRooms(roomCategory)) === null || _a === void 0 ? void 0 : _a.map(room => {
            ...
            return (index.h("div", { class: "roomRow" }, index.h("div", { class: `cellData room text-left align-items-center roomHeaderCell  roomTitle ${this.getTotalPhysicalRooms(roomCategory) <= 1 ? 'pl10' : ''} ${'room_' + this.getRoomId(room)}`, "data-room-name": name, "data-hk-enabled": String(calendarData.calendar_data.housekeeping_enabled), "data-room": this.getRoomId(room), onClick: () => {
                ...
                }, style: room.hk_status === '003' && { '--dot-color': '#ededed' }, hkStatus: calendarData.calendar_data.housekeeping_enabled && room.hk_status !== '001', popoverTitle: name })), this.getGeneralRoomDayColumns(this.getRoomId(room), roomCategory, name)));
        });
    }
    getRoomRows() {
        var _a;
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: 'd70627cdf537ce57c74ebacf3c5cfd66251d2374' }, index.h("div", { key: 'e952ab96113fc0c684dd024d4868ec7b8fb608eb', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '2af1cd37bd78308f5565ce844ef95de91815f754', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7c93e37e8cc0d7abde9f5add16eff5e2118330d3', class: "footerContainer" }, index.h("div", { key: '63f589d761412574323643bdf2554bad0882efb5', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: 'd34df420b91f38c5f1f42f82b25d718f009ca93b', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: '8413772b452309a52392a502a8204781b2ac11cc', class: "la la-square" }), index.h("u", { key: '4c0c39339794d957d2df4d41752609c509eb5d49' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: 'a2302e5d606aff2ba3dd6ed0b2e740542af7d94f' }, " - v1.0125"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5cd800e84679800b77536ab1ddd0f4163d8e51fa' }, index.h("div", { key: '9a367208f78485ea9dc08c432945a13bca8d97e6', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '482de78b1e71632ca48f51e62cccc6e682fe647d', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '0f0d773848e0bde7d37edecaaa049a51b282b9ad', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: '37467a614f2905642c952e3f6bf2f65dffbb2715', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: '7bf6455ac9e9cd3cb7d5e8654893728533282da5', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: '8d4164f661bf2986f9ba5817c69226c7d42a93c1', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: 'b4fe403bb97d0573e838d1bf573035d4b8154915', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: '9e7e33d875fa234f8e1484e3255a9d4938b6eaa4', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: 'f51998b2e36b7cf42404b0e099c42b5c3b5e10af', class: "row justify-content-around no-gutters searchContiner" }, index.h("ir-m-combobox", { key: '3a361524c727a9542e16e855b27ea265cf8a4740', placeholder: locales_store.locales.entries.Lcz_FindUnit, options: this.roomsList.map(r => ({
                label: r.name,
                value: r.id,
            })), onOptionChange: e => {
                this.handleScrollToRoom(e.detail.value);
            } }))), index.h("div", { key: 'df47ebb1514bf7b630428c3798091ad78db371ea', class: "stickyCell headersContainer" }, index.h("div", { key: 'a6b7a1ed065aa0e16d0fa3a780f97b35acaa0612', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
    static get watchers() { return {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c74b3430fd623b4baf65b06fd1b04557bbe0adfe', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '2267bdf927dbc9ca0bce05695620e7106ee8d5b5', class: 'w-full' }, index.h("div", { key: '14a405d7ebd91f1ee016a79cde1f59afb81eed17', class: 'w-full' }, index.h("div", { key: '0e419208323bf2f0adfb9c33e9772ddc5c838f84', class: "stickyHeader pt-1 " }, index.h("p", { key: '6e36821518ac21a39353dc6b7d680f0a7099710e', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: 'a4d9b271e281025a81e907c130a7ada1baab470c', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '4263f710bd4dd9762a2d75d413c63d9c29930e9a', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '01663fed09eaacd685ba29546b1fe5b6d39d080a', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: 'b1f623144165d41d535c7445ccea40ce75e64dce' })), index.h("div", { key: '57cc7a82b704e455ebc8cd2a29e000273a7c16ce', class: "mt-2 pl-1" }, index.h("table", { key: 'a730e4dc78bdddcf547b4d4d915f2abb2ace5e5d' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: 'ae5c585e66ec32f0b354260e71b56d28c9b90438' }), index.h("div", { key: 'b026c9e59ebfbd461bdf11d3cd009949d4a5526e', class: "mt-2" }, index.h("div", { key: '6693fbfba1b947939b306ed8496e96b51970409a', class: "legendCalendar" }, index.h("div", { key: '3eed3828e6b1b6012d130fa9f206bb80711f9eb3', class: "legendRow align-items-center" }, index.h("div", { key: 'e95ced941da00c8de445b57f0eb8239384021ebc', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '043a0812fea2a20551606a99a5058d16b5db3ad1' }, "MAR 2022")), index.h("div", { key: '17cbefb5a116d53256314eab0671e94180215ba5', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'a579b97fb77b20e01b07f690f71433f92ee05e21', class: "legendRow" }, index.h("div", { key: 'dd476b5b18aa093533288385c3ffbc5a21cbe364', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'cbe430914d48c06d6768145b6eb6dfaa5f6960f6', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '8b956214160e994242fa278fd25c2995fe677550', class: "highphenLegend" }, index.h("div", { key: '1743e0e5797bad237f969f3e9b36885f1e7ec2ff' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '80fb5f39af93edc4ce7f27ecf906363076eb18fe', class: "legendRow" }, index.h("div", { key: 'c65565112d324969f25315791e902093e2efcfab', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '3cffa4c1f716917b31c6c435d26e57d68740a139', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'fdc5ce2aec2c5a316c86fa7d491e647f4d1bf758', class: "legendRow" }, index.h("div", { key: '91953c8937228582066b1f5f1bb2d3e0a17d97e4', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '457ed078c456fde5b42e6f700bb9b5586a01e6a2', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'd10ae963a39d19e48ddcb283413c3ee46ea85f09', class: "legendRow" }, index.h("div", { key: 'a5a421f57bd1a9a47c11f360cbbd7dd09e6c8311', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '8bbe76b1838ac3a4e2ee4716e381ef17bcc59f1c', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0fc4249f23d8c64b75af50dfca1c5aff4f7503d4', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'c04ba51adb26ef5328f942acbb2264bda4e48482', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '68a953b536264d1ca7f0ef73405fcfba44a989d1', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: 'b65605732aab825bebafc8f83edbe4133de86c62', title: "This unit is dirty", class: "hk-dot", style: { flexShrink: '0' } }, index.h("svg", { key: 'e48b508aa4ea6097e2bbee34ae6b292df210011c', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512", style: { display: 'block' } }, index.h("path", { key: 'b65acd2c667e5260dc84471a1ea86e4ac3e0346f', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
...
const IrTabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '711657ebcd30b82212663dc8e3396465db1fd340', role: "tablist", "aria-label": this.ariaLabel, "aria-orientation": "horizontal" }, this.tabs.map(tab => {
            var _a, _b, _c;
        ...
        }), index.h("span", { key: '47c73e46ef8b486faa56b5fbf9c80095876d07a2', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
    get el() { return index.getElement(this); }
};
