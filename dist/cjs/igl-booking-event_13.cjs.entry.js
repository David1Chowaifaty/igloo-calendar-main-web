...
const events_service = require('./events.service-a0fe0d90.js');
...
const IglBulkBlock = class {
    ...
    render() {
        ...
        }))), index.h("table", { key: '32a7a7b7a6aea3b7caf1a8c94c582cdc0225cc7c', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '5a9f8fd8051fb6e73f1e2f57a245f272ff2df907' }, index.h("tr", { key: 'cc7cb7a3b8dfa1771ba7500ad5735e42ed1e42e7' }, index.h("th", { key: '0f3eb9ecfd8a3297de93733f7ab0d54eb4629d43', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: 'cac82350671eefacb532d4969ea265eb43ca554e', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '7f0ae11dff8eb0c6145f88e1ced80ab5eeef529f' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: '63d2fcf19005b6695eed0b57f482669c59316e28', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: 'be8e600f7ee241302a5f84bd156091f2c24eb42e' }, this.dates.map((d, i) => {
        ...
        })))), index.h("div", { key: '5542cc4606497a19ecf10ee812ed4486a22b49ba', class: 'sheet-footer' }, index.h("ir-button", { key: 'c592270be4d4ebe1459e450881592ad55b8b8697', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'd4541666fc276e8714db8daaa3e4142373d3f9fa', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '02bbe105ff4f2ae24af0e93239e8cb367bd9f12a', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '4c4ac9dd9e756dc7a632b0b77e44c2f5affcaedf', class: "sheet-body px-1" }, index.h("div", { key: '423d2294b15e35429792f4c47cd410be847b6574', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '0d67efc55be277dff6a94acb144d92465c2c3034' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: 'c29d472943d3598763b3fdc5b1b3d3d907530252' }, this.errors === 'rooms' && (index.h("p", { key: '0ace8a547ad3f0f5725cdfea282f88bfe27688f8', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: 'f4836e23577c238d4b13fbea74ce57de03b0979e', ref: el => (this.unitSections = el) }, index.h("thead", { key: '084eebb60e67532dcc5e11d3098cd8e5281d8250' }, index.h("tr", { key: '7749bcd9adc366ced54a408caacc1fbd5b760fc6' }, index.h("th", { key: 'b38a5cb702a3f6e6935fb2baca4727ea906edf61', class: "sr-only" }, "choice"), index.h("th", { key: '4dd73e4549da38ee9ef19f75fc7e08db182c6492', class: "sr-only" }, "room type"))), index.h("tbody", { key: 'a9c1fd42cd7ae09904da2325f94011835348cf71' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '04a321b4b472a7af2048e583ff93eac8557c3db0', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '7f93ad5ae468c58c38c579cad35286e2e5ccad54', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: '6910a5f1fc296f78f58cc3ffb412c9db3d493d02', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: 'fee6eea6f706348e18a4eb6f898d1e576bf33db9', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'e0077baa7c4da3f68b6f16373794ab4b5f1f8e0e' }, index.h("tr", { key: 'fd591f3816acc39f1153f95835406023ef19dde7' }, index.h("th", { key: 'db4634d7b1056d3221c24731e46af53618f9c1e3', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '90fa5084000502f578aaaacb8969387112e7aa3a', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '2e7917a821352855ced7e1d8a29f1ee9b0c9ba36' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '1d97e590a650e64b89ad7da366dfc52adacd5f4a', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '486a244e06d0478bd299b981bab6620afa897109' }, this.dates.map((d, i) => {
            var _a, _b, _c, _d, _e, _f, _g;
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: '87ea4af002c1700c03e882a85e50e08f2a0852ae', class: 'sheet-footer' }, index.h("ir-button", { key: '948366f755f5cfa8795885b1e1e367571f370777', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '6055a95e6ca6525bb32799e9aabb9c3c6421d732', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: 'f1834dd40588e330cfda50b25f557abb527b99c9' }, index.h("div", { key: '6a099f08982bbd844ed156395ea0da3db5a58931', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'a0bfccbd4d8a0d68547bf2a9bb6a2ed99884142f', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9d54551ee0bec1c0d760f18e34cf4cfe0f4fe376', class: "footerContainer" }, index.h("div", { key: '7bfd3edd305bf35781ef3c70d4d919a6e95cf7e8', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: '4976388153e00ecd77c87e381f3f054bada27c3c', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: '2c67965e70eb6935c539bb652531e2ca928d3aba', class: "la la-square" }), index.h("u", { key: '9cd355bce26704df3cfd693df49abc33ee473995' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '4f8372389a49baaee1479bc0ceb727f8694b0fca' }, " - v1.0125"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'af8e81cacf1556eb7e2221173dafeca793dff5e0' }, index.h("div", { key: '758f1a8e372e2c91becce484855686845675061d', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '5ad9a3c91397aae5a524d0456cdabac31bd87f30', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '6a9b94d846282b87d1036a2f46ab0559671a8503', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: '1e5de8de02517fc92da6e21c6d72dd0c6faa5251', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: '77b643716335ecc159956404ce474c3351245818', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: '6a4a2cc70a769765168517d8a58d57bb81bfd0ac', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: '253ac5374a6ec8b8965026c5330b9bd0dfeca7b8', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: 'e6b711db3a9c5f534b1e19bcfccc80a4fa5bcb17', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: '707bac2c11a03992d479249fe814642c2e5b0074', class: "row justify-content-around no-gutters searchContiner" }, index.h("ir-m-combobox", { key: 'a776093ebdcbe21383a22bb9b2d609798f921cea', placeholder: locales_store.locales.entries.Lcz_FindUnit, options: this.roomsList.map(r => ({
                label: r.name,
                value: r.id,
            })), onOptionChange: e => {
                this.handleScrollToRoom(e.detail.value);
            } }))), index.h("div", { key: '949b60190c6fc9aa537b5386cac7bd59a73f9671', class: "stickyCell headersContainer" }, index.h("div", { key: 'f21e2abd70d9a7f54d0dfd365cfb28a28bc2e7b5', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
    static get watchers() { return {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '634a144d0a5580a75c14b56237b90e5ac9843bef', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '3736132bf7232eef8451b050eba23ff4c728c0d3', class: 'w-full' }, index.h("div", { key: '442f4e7b996991670d4515da17ec481435f35bfb', class: 'w-full' }, index.h("div", { key: '66939d01e547b1efb943ccd19bfc9ba7ca3d114e', class: "stickyHeader pt-1 " }, index.h("p", { key: 'eb79c743cd67ea32a2800542663603c30e415a3a', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: 'a108278bc10b8f08d4a90647846087ab14d483d1', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: 'e8a6f85a920274550ddbef6e385d5f57f4ad44f7', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'b156e0b05962aef40416a89505b757dbcf9d8edd', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '1cf672abd16eb14c0c422a1db35d3907bec56001' })), index.h("div", { key: '6bfe3d972081835dac3dafb70ca29b6f640e225b', class: "mt-2 pl-1" }, index.h("table", { key: '39204dba23fcea9ed540cea348f188e5b62b42bb' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: '39997dea254afeacd3f129c6d1f89bc9d92a246f' }), index.h("div", { key: 'dc184c6254f1b5707cd238c51fe87a392cce90cd', class: "mt-2" }, index.h("div", { key: 'c41233feec7649ef2aabab262d077a483388945d', class: "legendCalendar" }, index.h("div", { key: '4a35a6116e000f5b223c565f4c0a10b2a98c9750', class: "legendRow align-items-center" }, index.h("div", { key: '13333fdff20a5c46c8119c7cf76e39237a65d1c9', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '20eae65119ef67767f3e9512c42d8afdc8b5a9df' }, "MAR 2022")), index.h("div", { key: 'aaefce1df33a31cf3581ca1ca12fb9dc50aabd74', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '242cfdf169b3267b9064dde1480a94b4d6f622ee', class: "legendRow" }, index.h("div", { key: 'b606fd723b961bec15964df6484162be677a9bc2', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'c615cf58783218be436588bfac1f2de2be32c74a', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: 'f6093b4c48b7316ddee2322acd9c45d29e0f001a', class: "highphenLegend" }, index.h("div", { key: '17255b9bb2a07704087486393ff8b20a4d80ba2d' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '0f2f03a1c10ab14ee4f78455359d2e96fdf92903', class: "legendRow" }, index.h("div", { key: '2a1d2a82a95b5094dc525a030ac2ad122ca59309', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '331182ce4d3022598c8587f2ea6dc779c0b2a6ff', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '7b961e4b7945e711f1debbab4ccb44f8ea4dacf7', class: "legendRow" }, index.h("div", { key: '60f1afd3bb68e0137d48948ef5838883d78ce7a9', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'deee58533f714f0ccbbab5435ecfb49e2f5115bd', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '0784423c3984114a308333b54b9c9f9e58cb1fd1', class: "legendRow" }, index.h("div", { key: 'bc3161ae34e0954a2dba71517eaa7e38b8f44be2', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '60b119a455576f175a62139f3af69c95866ff68c', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6552c4d7ae0fed8abb269fe092d214cb44485bc8', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '412ff4f345287af61375d6cd6a740db9938aae81', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '05f064bba444da002a40687ea9e69f9d288bcb49', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: '030fa20c701726a672b32fed180801bea3eb0969', title: "This unit is dirty", class: "hk-dot", style: { flexShrink: '0' } }, index.h("svg", { key: '2f2f21437db74027f9e82135f3af0807ff920d46', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512", style: { display: 'block' } }, index.h("path", { key: '432e2a9aee9bf5e77e2007ee8ebf5e42c78ba2ad', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
