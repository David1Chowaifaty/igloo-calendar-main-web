...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '311c9df43de54853d806c54ae114b1c49cad004d', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: 'b19d4b4e16d1d274e6adbc23aa439c7573f58904', class: `bookingEventBase  ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: '3c588522ec7c4823aff6c484120ab18598eea086', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '2c1dc349a2147ff6608f57d22f741712a4293e57' }, index.h("div", { key: '8eca6865af55ab689cf51cc43f695494bb76a0e9', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'f4b93daf32afd280629352c0593f51126ea9b420', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        ...
        }))), index.h("table", { key: 'c5dfdfb3125075af08cddf074ed8e73268ecd803', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'ce204ce1076b7fe78f0cbf459359f1e70c9e69a5' }, index.h("tr", { key: 'e15cdbf62f004694165e87bfb37e5c16dcceb328' }, index.h("th", { key: '5dcace0284e43ba00c779987a3f338d6ba2e4ee8', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '7acf97f94e707d2ee053de1ad9eff451fe55fca7', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '7ea5673b6ec092d2f313dbcb4a662e6cce6ed966' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: '7b129f0cf951ea9015bc541a4167fee9ea9fe501', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: 'fd82c7ff62ae377a0e8b14fd48e1c919b196052f' }, this.dates.map((d, i) => {
        ...
        })))), index.h("div", { key: '548e2c2c6707430093dca71cdba8b5d3c30dcb10', class: 'sheet-footer' }, index.h("ir-button", { key: '776fd40777dc7ded925f74948217df3a6af0c53d', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '337025222e26c43809b7d1ec69c2eddde8c6f911', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: 'a042ae63bfd96d3d42bd1bfc89f898ce3c4a8e06', class: 'bulk-operations-sheet-container' }, index.h("div", { key: 'a8f4395270efcef1a10f6f72d609782f374a93d8', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '26a94dd90feb5e1df0a64630152d3bd68d8042f4', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: '59ff9d12ea4eb70bbe2d12b2c94c612ab7b5ab23', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), ((_a = this.selectedTab) === null || _a === void 0 ? void 0 : _a.id) === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: 'bddfc1a59a3513ef456afaeb73328edefa180e76', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '767763380b7c044efac4405242321e1a55c214f7', class: "sheet-body px-1" }, index.h("div", { key: 'f18002773cfe4739efabc2eb69f95baba5cd6cd4', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: 'df00320c697c947b042120c41b5ceaa16f4389c6' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: '45b5ba68f3cc5fe9d657dd3a0d203340d16f0a73' }, this.errors === 'rooms' && (index.h("p", { key: '12dc7c0957e9505cfdcaf0e9b80e23ca1db1b31e', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: '9ad2edc9cd7cbd59c4301738ecbbf367adc2949d', ref: el => (this.unitSections = el) }, index.h("thead", { key: 'c41234f0f678ea7866caa9dd93de25dfb38b84c7' }, index.h("tr", { key: '9f3e1031a32a650b217970d8625bebdc8768984e' }, index.h("th", { key: '94cfb18516a4d09ac21f27877bfc27a981b1c827', class: "sr-only" }, "choice"), index.h("th", { key: '9ab2093d3827ed745dcdf2214a49cbb80d148765', class: "sr-only" }, "room type"))), index.h("tbody", { key: '11d0783c211243d979ab50faed4b4b63f02582dc' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: 'aeeb872af25e94a85e92b7e6ca0a369824b0d1e5', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: 'b2b27f05150c6feabb5ecfd17a715ab0c927b24a', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: 'cf7b882ed8194c06b394a21018a7afe7ed1286af', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '18baad3ef670b5b637fade8f3a0c234322498cd1', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '98d43bda066db007b65e435d7d3659becc4bbc7c' }, index.h("tr", { key: '40d2c821264e95f102714eb1257e36a8f7cff42b' }, index.h("th", { key: '2683f2c7137dbce45e389fcfaee8375dc6af06b4', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: 'd475be77cf8697d2cf3e74a83c2c2c130685f0d2', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '6136ab272d22602a114a5b450e5dc24028862691' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: 'cad5025336388e5ded1663d8d2fdefd51dce8c21', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '005f3c655393b35f41b6bd9dbdecd3d1f49c8cfd' }, this.dates.map((d, i) => {
            var _a, _b, _c, _d, _e, _f, _g;
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: '6883a121997a234cbf3c91e958adf58a80844417', class: 'sheet-footer' }, index.h("ir-button", { key: '9eca0933d4f9f26cb41bd73fe91f7d2e172a6642', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '412aec1d9e8da1ad9a7ff7f44cc492b6e2e5e435', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '2693bb03e5be9add86d41cb72252ca1fcf6b5a5a' }, index.h("div", { key: '30fca4feeee33c9a7454cc3474d6d9957ad8401c', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'a21bd401c5de0d0249dbbf460fdc9b3e4a3b22ec', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f34f33edecc7417ca79eb772ee3a9359167c7962', class: "footerContainer" }, index.h("div", { key: '9c466094129caf11c8f112c7ac9df42ad2372ace', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: '127623d51ce6fac5a1ed1bf5eb0466b4b70ff86f', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: '9e0d00a1cf363bad0ed792d977716725599a6bd7', class: "la la-square" }), index.h("u", { key: 'd76d97e55a41b4a8c478cfb8f33f4d4e036b63f5' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '23552d70607fb27fe800ae2e3294c4142cbd1490' }, " - v1.0128"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3facce618e0e81c87f653f78bb636bcd2846703c' }, index.h("div", { key: '1d5771f05042a433418b31c1bc3f96fae2c1079e', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '6d50a0c1f8735641b1810f800de0d282338a2bd6', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '2f05ab40dff467faf52e5166abd82c1f3f2d2582', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: '927a4af5da3bb756e07d6cd52dee47de253fad4c', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: '804d0fcf599848889a32709a1560ab798de64288', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: '2262cab25df8deb9a8f95490aeb5e99f987bfd4e', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: 'b7b6ba6ba4eb74ebb128d7f667a6ae0c1410d925', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: 'e0e41c980ffe2baafdd80c3b840ff196c83d8217', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: '8e6ae0d54b1b6d620d8caa98cf96811d249ed0b5', class: "row justify-content-around no-gutters searchContiner" }, index.h("ir-m-combobox", { key: '385961b437d4ef87ce95cc6497abd4e18db5d4c5', placeholder: locales_store.locales.entries.Lcz_FindUnit, options: this.roomsList.map(r => ({
                label: r.name,
                value: r.id,
            })), onOptionChange: e => {
                this.handleScrollToRoom(e.detail.value);
            } }))), index.h("div", { key: '39178a3641bd84a805a8951e09b60ab5ee36a34b', class: "stickyCell headersContainer" }, index.h("div", { key: 'c97142a28c20b8dc8b8a1024010e96dc6a276f71', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
    static get watchers() { return {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f87ac5a5846a2937b740e7161545f6df2aa4ba82', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '80a10120a60a81979866fca59946d03c4151975f', class: 'w-full' }, index.h("div", { key: 'f285217b7ca45cdd1d30c433e5582099a4281999', class: 'w-full' }, index.h("div", { key: '5105c2d091e919c090da6f2cfe9e873f50b68971', class: "stickyHeader pt-1 " }, index.h("p", { key: '25dc9dd523b68ee62b5971fb6b7e94e96cf67aaa', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '8638690eaa4dd6cba210766a2c8029cb46987991', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: 'b854d96eddfd334d5ccaa051000ea90d0a3a287c', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '506a45064bd7c7ac24b16ad365dde461e69b4a33', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: 'a0b1627779aa98080777b817a3930d750904afc9' })), index.h("div", { key: '3e03d969d788293f3cc599fa4e4a6e171c791ec0', class: "mt-2 pl-1" }, index.h("table", { key: '22877924bcfe117ac0767be1a00e679b215d1bd3' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: '12f73da038ae46c6d1efa2d4c15225f69a0a0b86' }), index.h("div", { key: 'b99bbb42239818531096bbadb6a74938f5186c75', class: "mt-2" }, index.h("div", { key: 'ddc3ddac7428d18933fb90d1f267287a5d561353', class: "legendCalendar" }, index.h("div", { key: '9900a0978716d4701842b8fbcf879ebc84779104', class: "legendRow align-items-center" }, index.h("div", { key: '13c66d533a72421d68168280b84ef288e57ec7fd', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '7359fac430b6a3daa9b5bee08ff8ae84d182cf91' }, "MAR 2022")), index.h("div", { key: 'f0e1f902d209cb736659e6be2a4fb567942bf109', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'ed378c95978f6f209fb929a7a556d2e7a29208b6', class: "legendRow" }, index.h("div", { key: 'eb33ef53270da68ae11500351aef05a3465c211a', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'a20f9635da1182dbbcefe934f4919c5af72a8df0', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: 'a754c981ab7383398a8315021f198f62afcbe669', class: "highphenLegend" }, index.h("div", { key: '04882cde450a7108086da8eea9e550c5be034c67' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'b7278c2bd7c60556fc7c89e9fdf4c85c4c9eeff3', class: "legendRow" }, index.h("div", { key: '2c5f5b3c5a39fd77567da0f8d22c5abe7744f87a', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '6ae127678fb575ecc06a654c7f7750283f2749af', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'e1422da9d866cd1df53040528ec35949adb96a9f', class: "legendRow" }, index.h("div", { key: '3e305db164cb187bb056dad8cf13f437fde0b7cf', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '457fd0c89f6a73d5b01a2ce660e560f308cead63', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '94a2814d61c64558b1851ed15ac53fa12d8f62c5', class: "legendRow" }, index.h("div", { key: '7a6e598ce9a55641be88fa68f3893bbdc9545b13', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '8f7b7e2f649aedd1f2c8f56d8b43841a4c48da1e', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'e768ee38924b1aaf636d515cf168e2c9777f49d1' }, index.h("div", { key: '4a94a5a50f1af5065575c744d9b033650ed35bfa', class: "sectionContainer" }, index.h("div", { key: 'b6adcfca780a155e3ba81b1eeb32e45973817955', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c743319030db1918260de4468b0b4acac78d8485', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'ed44aad386cb30c3eb338bee3eefb4ab9f3f535c', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '2a5c5bedcf395ea41fcffaca270fbdfa8cd96829', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: 'ccec953a611fdecd4039daf658291018119c1858', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, index.h("svg", { key: 'dec96d24bd2717d30fd28002ceeacbb4cc511a01', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512", style: { display: 'block' } }, index.h("path", { key: '100835373b0b5f7a0f97ed1a1a5b8b737de374b6', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
