...
const events_service = require('./events.service-7b180fc5.js');
...
const toBeAssigned_service = require('./toBeAssigned.service-70312814.js');
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '09bbbb8c073c50b2c947be0393ef938aa0a44d74', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: '91405d88fa22bb5c88df4e65cca26618169ba861', class: `bookingEventBase  ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: '885c94c53acb7eee31a7f9b377e4ec9d46e299e4', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'b1e9e8c9f35e355a774c1c7b9e9c3dc790ac429f' }, index.h("div", { key: 'e42b309a35eeebf56b00bb2eec1d8c82130b91a1', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'f00ff15c52644cd2193cc5f9fcf468daa5be8614', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: 'f2d23bfe0a2b0cf49bd80ae4143bc8879522bf4a', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '2c2b14f486250ff94228538257622d7a9e18a33b', class: "sheet-body px-1" }, index.h("div", { key: '445357464d24da8a610711ab4e11bbffaf7780e4', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, index.h("p", { key: 'c10cdf9710d246fdaea8998f8bef79894d4370e0', class: "m-0 p-0" }, "Select the unit to"), index.h("ir-select", { key: '7c162abb4603dfe8bd41f99fbf7a476f89ced32f', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), index.h("div", { key: '7fde6df46a95437f7998450e980063d0797428d3' }, this.errors === 'rooms' && (index.h("p", { key: '8017d0f40d0c8bec4b4b77ebafa8e0dc82e6b8a3', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("ul", { key: '32289fe302594bf665772d8354c4362cbb9fcaca', class: "room-type-list", ref: el => (this.unitSections = el) }, calendarData.calendar_data.roomsInfo.map(roomType => {
        ...
        }))), index.h("table", { key: '1acbaf5dd8b6fec9b4f047549df0268eaccfd8af', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '9edd11010d7e22fc55129ef5afa4155a70f754c0' }, index.h("tr", { key: 'b4c12b130d32fb5a982e876afa7a1f09e85f6e85' }, index.h("th", { key: 'bd2e6f46476df568d3dfb9b32db871c01b71948c', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: 'e479fa0aee56667c73d205bd49ed98ed21b10cb5', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'f0efcc9fa94ab7fd433125412cd1bed526cf4c2f' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: 'c733dca5e68d60c567181573929311b713be3884', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: 'b3e4a3f75eba35fefaa70c140ccb5625c57df1b4' }, this.dates.map((d, i) => {
        ...
        })))), index.h("div", { key: '4e31cc0d2958f2a23ab072722b073ab0ce8de033', class: 'sheet-footer' }, index.h("ir-button", { key: 'c60754145ad42d8f79f942894c019b676e229d98', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'fab533d7d025cec9cc263bae0518c6f8d2ddc65e', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '20e5ecc7206be02d5950b9536da9b94a0f6b4428', class: 'bulk-operations-sheet-container' }, index.h("div", { key: 'dd1525a19f77f0ab7b98e402e4bfb143ca9c5bc5', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '301924de1774d939861d575b961c32a41c869ee7', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: '62e27c80e8f0e7e9a19542d4672162036bd580e0', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), ((_a = this.selectedTab) === null || _a === void 0 ? void 0 : _a.id) === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '36a565286dbc732e6ba77fed42fc91a08e4d01bb', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '7d1a50ae1f03443a8636bf00d1366a349be88b2d', class: "sheet-body px-1" }, index.h("div", { key: '32e0752ba312030d4d574f1c07fc9e6f0d329258', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: 'f341465a9c5d0fdaf425c8dfef62c033b72562e0' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: '304965871988fcdd6c00e9554d1e96fcfcdac3b3' }, this.errors === 'rooms' && (index.h("p", { key: '9979ca9bace172ae494bd6bd8da0db0f955f2674', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: '11e6d36da5eb5be6a3a1e8366ccafdf62e58808a', ref: el => (this.unitSections = el) }, index.h("thead", { key: 'd65b0d24027c3f7c961a50747a908f12a939f804' }, index.h("tr", { key: 'd503881dc67f9fb49c05e7cd21a6801c581b0394' }, index.h("th", { key: '8051e22d02a3015618e17ce086b2c88547fbb2d2', class: "sr-only" }, "choice"), index.h("th", { key: 'afd9255556436a065a6f4b104526e4b09b5b381c', class: "sr-only" }, "room type"))), index.h("tbody", { key: '444f4cec673031aedb188bfc8a9c7b35ce2dbda8' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '766e146867c89ed51e245c3687560ba36910967a', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '2d771ecf886316f0a2ff052d000e098c9193e43d', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: '17021693e4b1c854f43b3957f0dcb2b0f259b153', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '44f06bf9dcc1b97c9845aa7a6ebe1e48c8cb85f9', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '66fbac054427e937cdbd904b2162d5c8e7877937' }, index.h("tr", { key: '07cd5cbd24d4f87dc1446ffaec56d90ca7d6510f' }, index.h("th", { key: '8096ceef8ace0ab068e5840c734ad6b15332e81a', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: 'b1c1accae900711dad434b64ab38d1b450ae5aec', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '1f100450199addbba57cf940c5e4040102dd817c' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: 'e8b97b051ae6e2db88be7199f791f691bedd504b', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '70638710bca908f8d3fa41e28b2eb20b01682e88' }, this.dates.map((d, i) => {
            var _a, _b, _c, _d, _e, _f, _g;
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: '8e49b2788d62b88b48aeb1a86855d111f234c7bd', class: 'sheet-footer' }, index.h("ir-button", { key: 'c84959f9dbde520d66430e59e7dc2e6fa765c59d', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'b6fa3d99a00424e6ba922691777fa03086de913b', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '2b4b9938e2c02e385a82f9ae6f852da5a52b51ba' }, index.h("div", { key: '8aef92cd74745bcac839593f403067816888dfb7', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '1c235ad8b1a4c2c53a2c6333e400f7be9b13ee35', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '325cb7586f9d5173a5550870f6b22741c4548a7e', class: "footerContainer" }, index.h("div", { key: 'e16bc9533c384a3c74182dd16c7c7aa4a3de8ef4', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: '1ed9d27285b3522fde617e962b316c7b7dde78ea', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: '17f05c75405ed9c273f9b871872a96dae5eba8cd', class: "la la-square" }), index.h("u", { key: '311a32a3500436f4c49358cfbd6843f2c1ccfcf0' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '484ce3c2dfac116a3d94d5cc410631ad219b2f0f' }, " - v1.0131"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b9ecdf7ffb246abd4fa44d18783a9ed998f8c010' }, index.h("div", { key: '3d4ee8c6f764eca682d949a96f1846d0d532e04a', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '6eb29e0db8037acba88c67819b4ca7da0509cf2c', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '124f7677ff604432e34732e8ced141755ff5757d', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: '949be502e387a2c26b8db0626fbf4f0fc6bf6f8f', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: '111dfa594389ef0d5bfb4b61276796625657eebf', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: '07a25c974634f338fc4666dfbcbf64ade667dfbc', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: '4da27369993652f9a1994f04cd384bd93a6f3de2', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: '273a510341aeb19e7e174ecf2e47a5ee043ec299', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: '0f39a9404ef967ae9b10018be087e451aabae7db', class: "row justify-content-around no-gutters searchContiner" }, index.h("ir-m-combobox", { key: 'a9a9e7bc0df8936d33bf312b9cf6a1f05e9cd61c', placeholder: locales_store.locales.entries.Lcz_FindUnit, options: this.roomsList.map(r => ({
                label: r.name,
                value: r.id,
            })), onOptionChange: e => {
                this.handleScrollToRoom(e.detail.value);
            } }))), index.h("div", { key: 'ee2f769cacec1ecf3811ae044af14fcfa6ed6848', class: "stickyCell headersContainer" }, index.h("div", { key: 'ae0f626063427637fc802838da72c843a6038757', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
    static get watchers() { return {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '73c01488a22db5b6d7907b39bd29fd889f789ff3', class: "legendContainer pr-1 text-left" }, index.h("div", { key: 'a7f2e17edb7ca0012e8a74fa984282565ec82f8c', class: 'w-full' }, index.h("div", { key: '1bb439049095e064dbee8f4167d46ec930b32791', class: 'w-full' }, index.h("div", { key: 'c8bf0c072aaeb3072ee0f51386b2e7438ee1fc45', class: "stickyHeader pt-1 " }, index.h("p", { key: 'c9886f892843b271213a000b951640dc6dddee6f', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '1a50ec68851ab06e63cf6c0ef3484c215492f9b6', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '84815a1fc5b7f7aa203312327172ec0e0c2e0245', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '5c83f08905650a81e95d1bc7e4e22d0d141b2b19', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '9a5ff289a9e7faa3d1354ca8522833415fcdb517' })), index.h("div", { key: '134a7e2bb7cdbb811290c144a2de9b6c8fc57e4e', class: "mt-2 pl-1" }, index.h("table", { key: '0a9a56a1bc9a1176e892245aa79eb441ebb3c006' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: 'd4c001bd96b743f5a45f66779da0e3b903690a7c' }), index.h("div", { key: '94c10fb8c1cbbce024ddd48a87ae8d139cbd9bb1', class: "mt-2" }, index.h("div", { key: 'b134a2d2cd45a8dab406d5cb44bf76af2460d497', class: "legendCalendar" }, index.h("div", { key: '6277c2a2d800e4404b566c445b7bb05aa35a6a97', class: "legendRow align-items-center" }, index.h("div", { key: '214b9aeb28fda1e66837ab7b03f75e5efd19c83c', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '3899421cd306031afd2152438c2eb5fa4f499cee' }, "MAR 2022")), index.h("div", { key: 'ead4fdb1eec7cf82911e3ba6375819781417d65f', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '9b303e4a6f22098988e645216a9144bcc11391f4', class: "legendRow" }, index.h("div", { key: 'de40e3982012f7c1a853000a1b903e28e0742ec6', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'e0fb0c5a1f48c9774d41c0e594856f8f43a1c283', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '11976c2b26a78a331989426fcff99904ee1e7c77', class: "highphenLegend" }, index.h("div", { key: '173eb31b56eb2364ce231b75b38422323dad9c9a' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'ec63efaf62c4befd0b6ec4b9a3f834c8d80519be', class: "legendRow" }, index.h("div", { key: 'e49fe9bec86a5309a956dc776c08d2dd2bfa7b8f', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'a90622e8c40e7fa88f606763f90389f6fd7e88a6', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'aba6d30ca3dada5965cb09af80aef7fdbe90c7d7', class: "legendRow" }, index.h("div", { key: '5cbb39cf7d572acf636bc8b5a42c2608550aabab', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '1f79a9e71b6786dfa516c638992108ba0885c961', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '236bc58e136137fd3f75aaf24978400a82b8ec31', class: "legendRow" }, index.h("div", { key: '12734c20bce8d86624f5516fee1678b36b4e0e62', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'b85b15e55ca2068138f75c1950e79f9956934549', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '0e0cfef2bd6f867b9a9a1f63215cde5562b75be5' }, index.h("div", { key: 'f0eaaae3a6396dc7b53b97f0487d4c95f5f9c0e8', class: "sectionContainer" }, index.h("div", { key: 'bbe392a7be1fd9741298ce1f5b99d4f83d62addc', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c94288c38ad6f223af5ec319364bcd4e8674efe8', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '0d8c5d2431c9e0fd819ec80fc870befd3ec40aba', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: 'f9951438cbfc26a8cfbec3eece39290e8ec8d49e', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: '95606c47b31c66c38d157909e110c513ff0a7796', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, index.h("slot", { key: 'c41c4a31c965887a454a783e4736662b4485cd7a', name: "end" }))))));
    }
...
const IrTabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd7b3df6ee6fa37b4929b853f8eb2f72595ac592f', role: "tablist", "aria-label": this.ariaLabel, "aria-orientation": "horizontal" }, this.tabs.map(tab => {
            var _a, _b, _c;
        ...
        }), index.h("span", { key: 'c2e532e4c0905f409006be402d5082ed450412fb', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
    get el() { return index.getElement(this); }
};
