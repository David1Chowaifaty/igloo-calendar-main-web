...
const booking_service = require('./booking.service-6916e481.js');
const utils = require('./utils-4cd7648c.js');
const events_service = require('./events.service-da255809.js');
...
const toBeAssigned_service = require('./toBeAssigned.service-b306d813.js');
...
const IglBookingEvent = class {
    ...
    async fetchAndAssignBookingData() {
        try {
            ...
            this.bookingEvent = Object.assign(Object.assign(Object.assign({}, otherBookingData), this.bookingEvent), { channel_booking_nbr, booking: data, DEPARTURE_TIME: otherBookingData.DEPARTURE_TIME, PHONE: otherBookingData.PHONE, PHONE_PREFIX: otherBookingData.PHONE_PREFIX, PRIVATE_NOTE: otherBookingData.PRIVATE_NOTE });
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd63dbec4702367dc7b171d1ad2acaf688eaf4433', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: '8d865576f8b07f45651b8d9c6cea40918f378749', class: `bookingEventBase  ${!this.isNewEvent() && utils.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: '1ea65fd266d1e28e7398205bdd9655c541ab276d', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'bfdb03d77ff1f009cb8b8009ec343ef113ed5c04' }, index.h("div", { key: '4145d6b6e5f7df1435ce47ca55b5599462a20fef', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && utils.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && utils.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'e8e18519ef008595fade3ed5f6353ce2f57c73a8', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && utils.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: 'e1d1bcbdac3b1f9f6021f99cb8c0894e87b1aeb5', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '6edbb6b29def8663b27ff030ccc37ac62ec6df04', class: "sheet-body px-1" }, index.h("div", { key: '19ed5e8d8b717fb288e84b62eaba6ca4d1398904', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, index.h("p", { key: 'c1cefbd8e9eef767eb1b8c1b0a89338a58decadc', class: "m-0 p-0" }, "Select the unit to"), index.h("ir-select", { key: '002e4db90c9d8d66f1e69292c5a36758ce98c063', LabelAvailable: false, showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), index.h("div", { key: 'd4b98e78cef98969fdbf80e19a1e941de87c1011' }, this.errors === 'rooms' && (index.h("p", { key: '0c7aebced6a6067e5fb4f68f117a3ee644f18488', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("ul", { key: '4d33c94193445af0c88787baa6fab104599e7416', class: "room-type-list", ref: el => (this.unitSections = el) }, calendarData.calendar_data.roomsInfo.map(roomType => {
        ...
        }))), index.h("table", { key: 'a8d1ca3a48360c9f7400aaadc2fb5aabcd6418f8', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'dac526bebfd897147395b736ef8bd16dbd50a08d' }, index.h("tr", { key: '8fe64ac2ca4da532a19f35b2d5901d2384237576' }, index.h("th", { key: '62431109960c3db2e5691d4b022d017ffffc9e0c', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '7a9f0ba82849509760d68e14ed61751fc8564d0e', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'f0fb26659e43fb38988e8208e58951ce7ad6a39e' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: '2a5f3577ba63f8a371a07b772645696671b5b8f2', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: 'daad0daeda89f5a0aeebfe60a7b3b9e5da034203' }, this.dates.map((d, i) => {
            ...
            return (index.h("tr", { key: `date_${i}` }, index.h("td", { class: "pr-1 pb-1" }, index.h("ir-date-picker", { ref: el => {
                ...
                }, maxDate: d.from ? utils.hooks(d.from).add(3, 'months').format('YYYY-MM-DD') : undefined, onDatePickerFocus: e => {
                    var _a, _b, _c, _d;
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    const index = this.dates.findIndex(d => !d.from || !d.to);
        ...
        })))), index.h("div", { key: '0d4fcd1cfc8b1661975a9813620ba7a90487ce2f', class: 'sheet-footer' }, index.h("ir-button", { key: 'e73049505b75b5d49f1533467c9a4a49bc39cf75', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'b19f3108c81f3cfdbd10f1711d7443df4b89fea1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        var _a;
        return (index.h("div", { key: '7e8832b8d060e3585bf8eb41a2f52943440be0e6', class: 'bulk-operations-sheet-container' }, index.h("div", { key: 'df9b415eec955a2682b7a02df51edf631d407938', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'a785cb876365083bc7e572771205a120462c2c90', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: '5d15fddff6680d7e62a5f74d173cb650e256109c', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), ((_a = this.selectedTab) === null || _a === void 0 ? void 0 : _a.id) === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: 'f6339d3b67008007d7d6b88849b613cb3fb2385b', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '39f22a42d12e522e72d4bbdf78aa6966f67692e7', class: "sheet-body px-1" }, index.h("div", { key: '38259e8fd5f8006b0e8456448a9cc248605781fb', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: 'f6af74204f1d40b62498ee5af34745ef136893c4' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: '03a245bceaf4e9794e81b4f0de02764528f55b42' }, this.errors === 'rooms' && (index.h("p", { key: '62c8b1bdcd68e73ddb97ecc66f75bdb5adc305ca', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: '96aa65aac27a9466bcbd2126948153444d964999', ref: el => (this.unitSections = el) }, index.h("thead", { key: 'be08d09a97d1d81a811b7d3d0ab27ff8146b1d91' }, index.h("tr", { key: 'b59a966e62d4ca0e55485eed68205aeb7211087a' }, index.h("th", { key: 'b16c294022ff7256d00098ef7c05a46477d7d441', class: "sr-only" }, "choice"), index.h("th", { key: 'b887e864c09979e619f00d09bedf760f8c623a3f', class: "sr-only" }, "room type"))), index.h("tbody", { key: 'dbebbc3a80f66de376778c86290190366492721f' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '6b98746b1ea3f0a7cae10219d73c2b753090d66a', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '380bb11628bcad2ed5eaefed6a4deb4ea319f739', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: '92497c4d30a9e726bd45fcfec18f48aedaad5aee', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '31330487cc0a64698780192b6704732da1f10d3d', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '1854259cee96ed5029dda1a6cc5f2a7170b63ba1' }, index.h("tr", { key: 'fadc853f3325ccac48677b4636be48c22c913b7b' }, index.h("th", { key: 'effbbbcd56d60da410a62b3b92cc9cc1dc4440a9', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: 'ca710ea2e50cd1f1afc5864d0c86a91a965a45d0', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '584cc6cb70bae330b100273e27ca67249fb91ae1' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '36422b95d230d5c33e0a5f1efb98f2a41e06a017', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '3a78a9e42305d48cf9d3c47fee921d52a761a40a' }, this.dates.map((d, i) => {
            var _a, _b, _c, _d, _e, _f, _g;
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
...
const IglCalBody = class {
    ...
    getGeneralRoomDayColumns(roomId, roomCategory, roomName) {
        return this.calendarData.days.map(dayInfo => {
            ...
            const shouldBeCleaned = ((_a = calendarData.calendar_data.cleaning_frequency) === null || _a === void 0 ? void 0 : _a.code) === '001' ? false : cleaningDates === null || cleaningDates === void 0 ? void 0 : cleaningDates.has(dayInfo.value);
    ...
    getRoomsByCategory(roomCategory) {
        ...
        return (_a = this.getCategoryRooms(roomCategory)) === null || _a === void 0 ? void 0 : _a.map(room => {
            ...
            return (index.h("div", { class: "roomRow" }, index.h("div", { class: `cellData room text-left align-items-center roomHeaderCell  roomTitle ${this.getTotalPhysicalRooms(roomCategory) <= 1 ? 'pl10' : ''} ${'room_' + this.getRoomId(room)}`, "data-room-name": name, "data-hk-enabled": String(calendarData.calendar_data.housekeeping_enabled), "data-room": this.getRoomId(room), onClick: () => {
                ...
                }, style: room.hk_status === '003' && { '--dot-color': '#ededed' }, hkStatus: calendarData.calendar_data.housekeeping_enabled && room.hk_status !== '001', broomTooltip: room.hk_status === '002' ? 'This unit is dirty' : undefined, popoverTitle: name })), this.getGeneralRoomDayColumns(this.getRoomId(room), roomCategory, name)));
        });
    }
    getRoomRows() {
        var _a;
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '5c6ae813cc690ce8fb89dc8f16c54488acd4af94' }, index.h("div", { key: '15a10e3ea21a196da83a92fba1b3f7b8130442c1', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '84db06233f929faeca21c3863316ed577b54d81c', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
    ...
    renderModalBody() {
        ...
        return (index.h("p", null, "Update unit ", (_a = this.selectedRoom) === null || _a === void 0 ? void 0 :
            _a.name, " to ", index.h("b", null, ((_b = this.selectedRoom) === null || _b === void 0 ? void 0 : _b.hk_status) === '002' ? 'Clean' : 'Dirty', "?"))
        // <ir-select
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd7eb6ae36c5af34c1569e927663cc7bb67dcd38a', class: "footerContainer" }, index.h("div", { key: 'a8c110feb45a7c26b9caa24113a5d096333b6f7e', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: '05a5aa353575e536b413c6f61cfeaba0eebc9730', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: 'bdc6a71c0182f38ac046b73b086a6f6316b7fcba', class: "la la-square" }), index.h("u", { key: '2aa75973e72f5d4da1559f8d932b05664a155a1c' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '3591a84b45aaf89be6e664843d7362d28e5d531f' }, " - v1.0128"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5d84018b0beac67edfdbe2484d47137b53c155be' }, index.h("div", { key: '1ff0310e29341768b4dec7784a557fc3fa8b0f2c', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'aa10503a18e1c642b4752cf76bde76f54661fcba', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '7efbb70e49d002de0ae200c5c4018fd4311ce149', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: '05c6abb9df419450ae673b8bc423cc03d46ea6b5', minDate: utils.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: '0832d3c3223abc0fde06a9ccb9b4cd3740bec20c', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: 'f171202ae3b90f9f2151dd74ac7e3fa3d4034212', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: '29570f03c9c41e7670a60bdba2378b2ff72ba1d4', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: '14c84fe3bf9bbf45c22463d2a5754d7de0b98f8d', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: '9fb42e1bb7f9f590f52316718e86e871fda9c671', class: "row justify-content-around no-gutters searchContiner" }, index.h("ir-m-combobox", { key: '8560f0aa32de57acb13e24d7e5a5b0cf77576a4d', placeholder: locales_store.locales.entries.Lcz_FindUnit, options: this.roomsList.map(r => ({
                label: r.name,
                value: r.id,
            })), onOptionChange: e => {
                this.handleScrollToRoom(e.detail.value);
            } }))), index.h("div", { key: '2558cbd702b0128512875c231894e4b3fa5c4281', class: "stickyCell headersContainer" }, index.h("div", { key: '39836c606f9ca77f61fdd092406f48d1634452ce', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
    static get watchers() { return {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '585508ea346488f4cb4b9a3a8db0e2bd0a1592e7', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '9581010b25d36a6edc46eb291f84705bd8a0698a', class: 'w-full' }, index.h("div", { key: '4167fd624f229b1abbc1af885bc6d2b9238e26d6', class: 'w-full' }, index.h("div", { key: '42077c0bc360030902f0fdd8c172647d74a3a693', class: "stickyHeader pt-1 " }, index.h("p", { key: 'f81901f8277997cf4a6c4a96dd27b19f2ffe4963', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: 'c99a21d1afb2d6c6e0f8559066895eb3f59dfaf2', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '0b277c257f72ec5d4372425eafa467f055230660', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '737224edd2c12f98e68244f9dff82a4751871f01', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '21f106b2e55c4db0b0cebf7925dff98c17441378' })), index.h("div", { key: 'f704b3f31f652183d5dc8affd1f5decaa7f14c67', class: "mt-2 pl-1" }, index.h("table", { key: '3bc115f57c9e354c824376c6dc68a623451f2a37' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: 'b81aa20b6ee07afe80ba37972b21960d94015b3b' }), index.h("div", { key: '0b9812af67ca589e00d945f035298a1a4162ce5a', class: "mt-2" }, index.h("div", { key: 'c5d6d5431299a1d5f386118446ef7bcdd05a5772', class: "legendCalendar" }, index.h("div", { key: 'bc92d0f3f4bff27228578f08dcf225faa40af87f', class: "legendRow align-items-center" }, index.h("div", { key: 'fff85482ced3544c53a32cf0a29fd7b244cddf31', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'fe6273f14b4918e6e0afd349a610d44d7f7292fa' }, "MAR 2022")), index.h("div", { key: 'c7a51a480db799528813f1151d500496a42cec9f', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '32b604e490598169836a4403da519d82588e097c', class: "legendRow" }, index.h("div", { key: '5dba4679aca4b40cfafe27c4f93b88a805f60272', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'cd23b24341de049c0677dc60646e92f68520346d', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '1c53a1448f8963d6c2f71d4d2d596191df22d276', class: "highphenLegend" }, index.h("div", { key: '0dba99ff11ceb30dd008cc5777f8e17e1917158c' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'd4c9cd7d8a4d47546b5157bd7f1dcb6e43a1e1d2', class: "legendRow" }, index.h("div", { key: '3783ad4e105c226f12397d821485c5c00d0719af', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '6018412d2eca3ca21e0f226dec4df312f3781605', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'eeb7915631734e91ffc40444ba572a72675c0805', class: "legendRow" }, index.h("div", { key: '7b1e9e34bff61996e8f6c5710fa02ea0d400a97f', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '8f08b4e26689eaf6235737fd16c55ebfb6f2b5c3', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '0cee58e472baa80b81bbe038989456e1c9cd9e11', class: "legendRow" }, index.h("div", { key: 'd4a271d7187c431a28ab07832d45fa5533798c1d', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '792b8876ce2edef63e65d4f002db19540b2d40a6', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '1431d6635af0d82bb41ca639be4626fda467bbff' }, index.h("div", { key: '2976fa93f6706edc851a62a31611e4543c11c3b8', class: "sectionContainer" }, index.h("div", { key: '988c5fe920ad286a1430886f32970b0ae2fafce8', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1d213f6cee22f77467ab4fad4004814031c68a98', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'bcf2896cece001c381db91b5e596e999373b23cd', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '3bd86ce77b0641b518f15bdeb982bdb64f8b44a3', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: '8128809e8b17178bd549c06cba1b88bb32040485', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, index.h("svg", { key: '9f89ef21bac3b08ca23c3d963da513b6d909c34d', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512", style: { display: 'block' } }, index.h("path", { key: '1e7ea3196221233e86edea0077dd225b4bd7f19f', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
...
const IrTabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '488cb5f6f4c416774a418f7034b498a6ca814e76', role: "tablist", "aria-label": this.ariaLabel, "aria-orientation": "horizontal" }, this.tabs.map(tab => {
            var _a, _b, _c;
        ...
        }), index.h("span", { key: '11a26dd4424cda4cd0024ee616231d91c2462d64', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
    get el() { return index.getElement(this); }
};
...
//# sourceMappingURL=igl-booking-event_13.cjs.entry.js.map