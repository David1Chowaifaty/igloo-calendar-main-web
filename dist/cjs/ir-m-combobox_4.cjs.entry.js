...
const IrMCombobox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ba7cd3ff80c8934d55970ff6c5677d227b47bf4c', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, index.h("div", { key: '7d9eb88deb823d970ee3c48645ccfdca88c5e0bc', class: "input-wrapper" }, index.h("span", { key: '7d265504f6500342d9d913943376c9f8fd07b185', class: "prefix-container", "aria-hidden": !this.hasPrefix }, index.h("slot", { key: '86dd7af70b0faa6cf68877cbe659d6a4047a87b9', name: "prefix", ref: el => (this.prefixSlotRef = el) })), index.h("input", { key: 'a0e157cbe0ec45880bad5518c8c4b732756b1a2f', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), index.h("span", { key: 'd3efe3e042a6cf3081ad0e5da7ec53db33ef795f', class: "suffix-container", "aria-hidden": !this.hasSuffix }, index.h("slot", { key: '01903009b0dd4726c112510b4698a6ea1eaa015d', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), index.h("div", { key: '4e29be3d5e9d255f8f9848f06f15d3c45ab13bf8', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: 'cfb86df6498ff4dc214c9d39618d690c3e5bce56', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (index.h("slot", null)) : this.useSlot ? (index.h("slot", { name: "dropdown-content" })) : ([
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'b29064ec3f08d9cebae1cdef9e78de6d8252b8e1' }, index.h("wa-radio-group", { key: '6f929a7c4e4b63c073968d15d6c53e500e7d0107', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: '52d407844a1948a41360c5830dd9f49bda64697c', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: 'abbb6dac1a6cde8684a3ada51c6dd0442967fdda', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), this.allowedProperties.length > 1 && (index.h("ir-m-combobox", { key: '25056fac04d229a529005c39235ea4882af82e83', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] })), index.h("wa-select", { key: 'f967bc17e11204e0a49f8e20bd6d9aa4707ca2ca', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: 'f9d777eb7bdd72e5abe499a468babcd77eba1a49', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '63deb6bffdd884ba2e27e8a271fd445f2086fe03', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: '4237c150004619c573a2d58223082b0ae4b4725b', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: 'f6b94ca70e8021cc6955cba219ecd8f20c3d877a', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: '29291ad2b133d34157a5d7d930616b3a2e03fef0', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '035be2477e05597fce9052fce75163ca6accdb81', value: "365" }, "For the past 365 days")), index.h("div", { key: 'ace6ba9a6cdc8f95e4729ed83738ec25efe2178d', class: "or-divider" }, index.h("span", { key: '8057523f7ea215a5e9193d212d5174fcc029edb0', class: "or-divider__line" }), index.h("span", { key: 'dc30310c15b690e85211ce2f204865700d946725', class: "or-divider__text" }, "Or"), index.h("span", { key: 'c7437c4439a6b6c65b4be495efcfa28fe1dda949', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '394b24566f3e493ce327a52382b6d7d4445d8ceb', label: 'Date range', fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", quickDates: this.quickDates, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: '1810fe980d8e9ab2f43aec046c69754aa0e48959', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: 'e13a7f3971f44bebd0d6d771727a1ec373050a80', slot: "footer" }, index.h("ir-custom-button", { key: '4632f23a0ec096a76834a4348c958b0bc3529ae7', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '6315620db88ddeddfccd1f501525ef242fadc25f', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '81a9777a668d24e8c2d15bb0bb9d167a971a6ca5', class: "summary-row" }, index.h("ir-metric-card", { key: '2c528f325cc5d28ccffe53b5a90000dc35aee452', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? utils.calculateTrend(totalNights, lastYearNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), index.h("ir-metric-card", { key: 'aba55b5a9f1d7c82b2bd6b6943976148fa2ef524', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: number.formatAmount(currency, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${number.formatAmount(currency, lastYearRevenue)}` : undefined }), index.h("ir-metric-card", { key: '056d45177b78e88cb28a07e3c8e1556c4bc98644', class: "summary-metric", icon: "chart-bar", label: "Sources", value: (this.records?.length ?? 0).toString() })));
    }
};
