...
const IrMCombobox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6ecd1e59b9a9a42d838ab898b28bcf1ad454afdf', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, index.h("div", { key: '849cc381404204a0527b60cbe9d212e327611f89', class: "input-wrapper" }, index.h("span", { key: '1d6d66927347e8f586dfea907b8b082d487f7d66', class: "prefix-container", "aria-hidden": !this.hasPrefix }, index.h("slot", { key: '3bc21bf5c143653a90a5205f3440be8864f79fe6', name: "prefix", ref: el => (this.prefixSlotRef = el) })), index.h("input", { key: '63c07a91b7ecae7ef3b2a04ab375a64c7086211f', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), index.h("span", { key: '3ef6716f3e8e76c8cf5995e9d2b995f9d95c762f', class: "suffix-container", "aria-hidden": !this.hasSuffix }, index.h("slot", { key: '46e8e69470346f280c2ed06f8787a04094af70f9', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), index.h("div", { key: 'f4ecc37c4ec168ed5f548dc8cf56156f4e778158', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: 'ec651867763198eac2a387a353e102f2aa7b0bc8', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (index.h("slot", null)) : this.useSlot ? (index.h("slot", { name: "dropdown-content" })) : ([
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '6dd71539016887433a1fa4b42213de8ece8ac38c' }, index.h("wa-radio-group", { key: '59b22a827395fda89f6121f428ace9cc3ca73eb2', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: 'b6b78f1d4f9c3e634ef41ca19419efcfa9111969', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: 'c1d6185ad611b6a7ac39c65841e63f2c9233a1e2', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), this.allowedProperties.length > 1 && (index.h("ir-m-combobox", { key: '429709c7a4eb7fc4332e09b026ec017f6dec5204', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] })), index.h("wa-select", { key: 'b7e8f140f9daba870b5be2b00617551f69321983', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: '8a5bcfb9e3483e633a1df897711c9f1c19ea65ca', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '15224d7c981238050029d129111d6b6bc278c638', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: 'b9e8159e9cff3d537e1b3dad6501d6b3774657b3', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: '2b334441114b56b67c12ae9b29fdcef0b60ac0b3', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: 'dd4f02a39ec2f12bfaf0362e223f415a5f6908d8', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '9dad22dcd8e253708496a73a12dec480b4c5a5e3', value: "365" }, "For the past 365 days")), index.h("div", { key: '3683e162181b4a0fb7ea3e64b878491a649b2b65', class: "or-divider" }, index.h("span", { key: '7ec4b83d1f850e59fae77022ee1a89d6a5e655c9', class: "or-divider__line" }), index.h("span", { key: '709d69aa91258acda720667bff644c31b09031f6', class: "or-divider__text" }, "Or"), index.h("span", { key: 'dcbf0ea4ad92245fb79cd8ce4dfe665536a45c4f', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '3c49592884dd83818f4664b4de4f964b242e3558', label: 'Date range', fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", quickDates: this.quickDates, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: '9ef943d4772d5508eb74de4a0d3822a43bcb8442', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: 'f989289850fda9fd02732051af680f8d6c22dea5', slot: "footer" }, index.h("ir-custom-button", { key: '7d3744c7debd1bf03593216ba79ff469a8cfce90', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '7687ece6460b95b93a5008787574c6ff0a7539fe', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a8e4baec04bb9ac77729cbd385870ac9e5d92efa', class: "summary-row" }, index.h("ir-metric-card", { key: '0a420b22a13623735f00a35f1b6c9107fb0cd111', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? utils.calculateTrend(totalNights, lastYearNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), index.h("ir-metric-card", { key: 'a9a085e62133aef2d72f10a810fdb94be8cb5222', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(currency, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(currency, lastYearRevenue)}` : undefined }), index.h("ir-metric-card", { key: '417de1391a717e6120d3ff8b7bc0cdcb3dd2ca84', class: "summary-metric", icon: "chart-bar", label: "Sources", value: (this.records?.length ?? 0).toString() })));
    }
};
