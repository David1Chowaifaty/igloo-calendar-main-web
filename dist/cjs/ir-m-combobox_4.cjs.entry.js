...
const IrMCombobox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5f7ab5fd6b7aa7804587df1f92a7e43e2fae0d38', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, index.h("div", { key: '060eb989ac71c9997910e757079c30f84dddf8b9', class: "input-wrapper" }, index.h("span", { key: 'e2576a61f49e442a70f5476a85d40c2e0ad89b0a', class: "prefix-container", "aria-hidden": !this.hasPrefix }, index.h("slot", { key: 'f68cc2e8b503905af49f90bbd280b5f16eebdd5c', name: "prefix", ref: el => (this.prefixSlotRef = el) })), index.h("input", { key: 'af3f285d6edfaed09cc732419f02dec11cde6399', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), index.h("span", { key: 'dc08affe316bfd28b5514548080d6ade29493369', class: "suffix-container", "aria-hidden": !this.hasSuffix }, index.h("slot", { key: 'd344da9883b9b1d2fc6a9126f0c3bcd1672edc56', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), index.h("div", { key: 'b4111528233a29d92ba6d09affef9e662e24aa88', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '362666b24b72dd1738c32356412eb2cbf428a344', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (index.h("slot", null)) : this.useSlot ? (index.h("slot", { name: "dropdown-content" })) : ([
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'b1108f663e3dc47b0958b170ec74cf05c6bbc9a4' }, index.h("wa-radio-group", { key: 'd32947df44609b3f2b6ca103b26a05be2b9406c9', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: '41a96d609263309c90d3c9a74239069bebc106cd', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: 'a98ac7e96a6e25dfef89b37cc14f77c50f28f34e', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), this.allowedProperties.length > 1 && (index.h("ir-m-combobox", { key: 'f4f832a8ae8231b7f09374bea99775f86260e359', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] })), index.h("wa-select", { key: 'ec3ae0fdfc2c126226a27d41abbedfdd8021f07d', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: '29015d4b57e7d5faf39b83a334c78fe7fba57e2e', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '9d9e181f40e6f7fd58ca0aae587a92504c899efe', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: '3133d01bf34a2b937aeaeabd74b05b2d32e06fba', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: '9b8cd0d7a4188756b0a579b750c45c136dba733e', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: 'f6a8370e4416269668f3aea37d240314de45d91c', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '877c79ae12f29535cb83952c82611007de463796', value: "365" }, "For the past 365 days")), index.h("div", { key: 'c43b6b1bf48ca9b4f90ac3a46c4b68eea43a44b6', class: "or-divider" }, index.h("span", { key: '3477e2eb1e5952565cfff241a3daeb2b8e266ac1', class: "or-divider__line" }), index.h("span", { key: 'fbaa888e6d3afc93f0fe82fadb0880a2675bb0b5', class: "or-divider__text" }, "Or"), index.h("span", { key: 'c15131dc7825b43a4a28c760bdda54f290d31950', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '5c6a77e702930bbf7f15d02fafd4bfb424b005e4', label: 'Date range', fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", quickDates: this.quickDates, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: '045b1321ec73b9be3e41bc58a5462f9f5a313f15', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '030770d67313f838106cab2b9db51f18b1f3f61f', slot: "footer" }, index.h("ir-custom-button", { key: 'aeb86b805900e9beed21adef48658e1eead0d841', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '65fdf34d8fe9a765b245de80f832845f7c2d8599', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '656f6a7996fcca9bb730005286989e8bf8e63077', class: "summary-row" }, index.h("ir-metric-card", { key: 'bd00e211f0046f02e0e28c206d0c3cf542dfc474', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? utils.calculateTrend(totalNights, lastYearNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), index.h("ir-metric-card", { key: '9241375c8fb9de9947f66e2b1b075bdb0d6b5bed', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(currency, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(currency, lastYearRevenue)}` : undefined }), index.h("ir-metric-card", { key: 'b616e179a714dc36cf2e18ab3a11bde718530dda', class: "summary-metric", icon: "chart-bar", label: "Sources", value: (this.records?.length ?? 0).toString() })));
    }
};
