...
const IrSalesByChannelFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'ff8c9865f9b90110de8ab8539751212cf3a55c38' }, index.h("wa-radio-group", { key: '4663dd315e9560cbf1e9277565f0639e2e764ae8', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: 'a031e0c4ba1a687d5951f71f9ab05ef9c78f395d', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: 'dd3ec82f0ddbafaf76a26e5b149d63ff23f97819', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), this.allowedProperties.length > 1 && (index.h("ir-m-combobox", { key: '775fbbf7d8b936b075a5a3df3b3b0aefc57c9137', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] })), index.h("wa-select", { key: '85357f64bb406509e2a17cf2058e4d0f459a3684', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: '27ffe7d0ad8426cc5da36ea6147d88189ca521d3', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '98c3146e959dc49a6f0d8a9ff969d701e6ff9bb8', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: '63a0af166138769e19ffd4dbef30bd345f75d1d7', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: '9c4021094f731f21c23e466eccde796a8041342a', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: '35d9edbb00d2995d7d0b3333b09bd0ce53ab858b', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: 'f7f7943ebce87ecbed6aa74c15a8b2acbfdf158b', value: "365" }, "For the past 365 days")), index.h("div", { key: 'f3d847b545cc8d98ea9f0ce85ca41362007cff02', class: "or-divider" }, index.h("span", { key: 'a1a85ed78284d82755f1e6ccc7df928080aa8d8f', class: "or-divider__line" }), index.h("span", { key: 'f6952b28577dc0994c914d89b73722962d1025ac', class: "or-divider__text" }, "Or"), index.h("span", { key: '58fc49e236c5e88fa734289da833f6f80d824946', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: 'bbc1d65924f4c67726694b6be86e759d34c456e8', label: 'Date range', fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", quickDates: this.quickDates, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: 'ea41ba7e8a5c62fb81c6f24c353514f75d6857a3', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '72e844a2365a9c536e11cccdd94de365446b97a5', slot: "footer" }, index.h("ir-custom-button", { key: '5511d49b27a6aa6372e0072f49b5d4e573f669b1', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '7ef7556d17df58cd2e602da5cf28546b34f283ac', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e55fcd2d38c7a7a74ce483fc029ffca69dabd02b', class: "summary-row" }, index.h("ir-metric-card", { key: '6b39852e993f58fcecbd8838fc93b337200ff06e', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? totalNights - lastYearNights : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), index.h("ir-metric-card", { key: '1a272513b63c81635cac39241e97e504cac5f056', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(currency, totalRevenue), trend: hasLastYear ? totalRevenue - lastYearRevenue : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(currency, lastYearRevenue)}` : undefined }), index.h("ir-metric-card", { key: '0d1e6fb629b493bb88e4075708a6a3bdfddcf24a', class: "summary-metric", icon: "chart-bar", label: "Channels", value: (this.records?.length ?? 0).toString() })));
    }
};
