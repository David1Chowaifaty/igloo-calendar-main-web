...
const IrMCombobox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ea9c9df9cb9a30e564a546121ecb740b1ce6db52', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, index.h("div", { key: '64755c4f0d78dad10c7d689c6b6888852d504246', class: "input-wrapper" }, index.h("span", { key: '4fada573dc9cac23b76cf054e184b098c88176e7', class: "prefix-container", "aria-hidden": !this.hasPrefix }, index.h("slot", { key: 'dbd5226de326f68490a07fc651b28c7f1163f4a2', name: "prefix", ref: el => (this.prefixSlotRef = el) })), index.h("input", { key: 'bdca32bc27100ad7ad7eb562c751c482503cfe6c', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), index.h("span", { key: 'a95e8d81ef7ce36fbdf401f78ef11511e2c567ff', class: "suffix-container", "aria-hidden": !this.hasSuffix }, index.h("slot", { key: '1094c1a42b5049a5c37d64a07ad095b625f3d3ab', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), index.h("div", { key: 'de4ce959c9eacde3c9add440944e3d9981502a09', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '9a1bbeb6ea5d6a20ebe5f28a7633a7d38da88fb6', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (index.h("slot", null)) : this.useSlot ? (index.h("slot", { name: "dropdown-content" })) : ([
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '51295edbbf2b57af5619077da37638059a292abb' }, index.h("wa-radio-group", { key: 'db76e7780a45ff034a69be0951c20782c46c88a0', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: '97cafa0b77c597db6083baaf11b50bae54fc4959', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: '6bd6a583262c8180f737b2a4b07fa6e7a4d6876e', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), this.allowedProperties.length > 1 && (index.h("ir-m-combobox", { key: '9c5dabb25715e56df4d45a852ee266d012b6ae7f', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] })), index.h("wa-select", { key: '3b28c524bf0265ee752f116982a48e8bb0ce1504', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: 'a6b21512047651b298689ce9251a5ff51144bb92', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: 'bcbfafec6a5edcba0fea0af3f76994bf1b6b4886', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: 'cf650e60223a152caf34089d05e79ec12e225b5f', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: '6518c3cac86d93154bde7dd8f8699ef5f439ab76', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: '0356d421ab7ee0f9a73b185cddc580069897ac9c', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '025336eb77883c68e4ed780f9fd1b36e7cdcb29b', value: "365" }, "For the past 365 days")), index.h("div", { key: 'ff6d2786a1775cf57e12dcf78bfe0297c1e8a81b', class: "or-divider" }, index.h("span", { key: '0bf0913dc7431a780ad124eb0ccb9252b34a8fe8', class: "or-divider__line" }), index.h("span", { key: '14f669e45118f0f2d380718ee44029b9457e6ba1', class: "or-divider__text" }, "Or"), index.h("span", { key: 'ca1ee55ac0cb5161e083949820fd3382a0bfcf01', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: 'e86bd85700cb548860c5d8388a57ef31520063e1', label: 'Date range', fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", quickDates: this.quickDates, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: '4e3a08004e82b9b57f3eaadf880c02df6a32220c', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '6e044813358a6d6c73a1148b54e0cb9b48b90684', slot: "footer" }, index.h("ir-custom-button", { key: 'dc09bde1cd668682051d7d34256e3b3cd5a5d662', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '37e75e42ff31a958af62887742acfba4c4e1d589', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '9eaf1c72a37d6fd6e388898392383318224a0eca', class: "summary-row" }, index.h("ir-metric-card", { key: 'c1528ac5cc632b5aaa54f731864676a3483e8fa7', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? utils.calculateTrend(totalNights, lastYearNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), index.h("ir-metric-card", { key: '442b295b1f1e2783daa5b5c35d289e1632c6530e', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(currency, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(currency, lastYearRevenue)}` : undefined }), index.h("ir-metric-card", { key: 'b2564c0f2d48b52aa67e0de8e3b28fa7fe732d71', class: "summary-metric", icon: "chart-bar", label: "Sources", value: (this.records?.length ?? 0).toString() })));
    }
};
