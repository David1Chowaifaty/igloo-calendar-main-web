...
const IrMCombobox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c409bc2edbfe38be9f291d0023cf093f891ca292', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, index.h("div", { key: '8221ac0ca48d5cc684d802a6f0849357e5c7815d', class: "input-wrapper" }, index.h("span", { key: 'ed143e76dfc61ea0d45fe57efe4ba7f740f5ef95', class: "prefix-container", "aria-hidden": !this.hasPrefix }, index.h("slot", { key: 'a4cd21718a268fea7689d4acade7e8b3be874a5d', name: "prefix", ref: el => (this.prefixSlotRef = el) })), index.h("input", { key: '27c2c98024b54f36dee9176a333b740249f86d37', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), index.h("span", { key: 'e0e8a9da0e5d6298e99dde93efde0c7e8e2d0a42', class: "suffix-container", "aria-hidden": !this.hasSuffix }, index.h("slot", { key: 'e425d7e871c36e7878e33a35bb1aa65ba956d04b', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), index.h("div", { key: 'e5c95dd1063f0a14d8067ece7864e9a7c3dee3bc', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '1bd64a07bb23e1a01d345a2550294a733689bdee', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (index.h("slot", null)) : this.useSlot ? (index.h("slot", { name: "dropdown-content" })) : ([
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '628e2158f808131e07a3f5f9421f71041abd1ad1' }, index.h("wa-radio-group", { key: 'a0449b6d39d5f80ab5737a3a12c80849ffbc0bb2', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: '335cabb18929161a32d0b97e95214b2e9d2c61d5', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: 'ac71839257ea9c73ec1e61af4daabc60d45f2506', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), this.allowedProperties.length > 1 && (index.h("ir-m-combobox", { key: 'b152f794508ac6e61b6f65c885014b9ad5878f73', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] })), index.h("wa-select", { key: 'e5b616211a080e5f144bf6c4683fd367fc09794f', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: 'c99b87150a7f854f073a838d05504bce4a1b8488', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: 'f747f0767aea9fe25482c0bb0efa73b95a7a5e10', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: 'e5bb7794c38108434604cd4e8abca0915d4bec71', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: 'e04c7ea581f63dc7a3d567d10e84df48b00496c7', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: '81e1c32a70ae52411b23bb9dcc9b500871cb80f1', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '4e5939749d9152a16db3af24b42702821e2ecd5e', value: "365" }, "For the past 365 days")), index.h("div", { key: 'ad762544784c74512b11d542786a44bf93cbcbab', class: "or-divider" }, index.h("span", { key: 'b42979c1d423f03fc962d2f14c800f585d3392ae', class: "or-divider__line" }), index.h("span", { key: '84a0c69bea589f84b29a3acc36897fc00d0d9ebe', class: "or-divider__text" }, "Or"), index.h("span", { key: '1c3b174c330295697499cbba2b748115a4b853c7', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: 'fcb18021d4245a5faee7dc2782976fea15fb95ee', label: 'Date range', fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", quickDates: this.quickDates, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: 'a175d70e7c1550077eda002a23edad0a0206d7ed', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '714a330eaa3f60bec73217f3b4b7f4af78166ee6', slot: "footer" }, index.h("ir-custom-button", { key: '194b4ff8677129eadad102e9f1e72021f6ca7ec3', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '6eac9ebb62ef375b7380d147ec97359f416018a8', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ae5e9a0e26be732d4d0899965d696e2497d3f9d5', class: "summary-row" }, index.h("ir-metric-card", { key: '2b03db714679cebc7672e6176faf05e9a5b54e32', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? utils.calculateTrend(totalNights, lastYearNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), index.h("ir-metric-card", { key: 'eaffe065a42e5c0169911ea9b535252d59e494b3', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(currency, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(currency, lastYearRevenue)}` : undefined }), index.h("ir-metric-card", { key: 'f93e2e56626349c792c16612825b35e86f3d87c5', class: "summary-metric", icon: "chart-bar", label: "Sources", value: (this.records?.length ?? 0).toString() })));
    }
};
