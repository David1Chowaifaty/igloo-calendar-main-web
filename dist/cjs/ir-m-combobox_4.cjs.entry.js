...
const IrSalesByChannelFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'a0c1a17c5a3a4fab8c369527ce89a5c1534dc644' }, index.h("wa-radio-group", { key: 'aa34a9f59b10cd069ee6ea22d4a34028d4833d10', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: 'f7740ffea258c6ad92a7672c0b393b3c2556c5a7', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: '14feaf6b957a5bf78cb94cdf49097cd461e3e3ac', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), this.allowedProperties.length > 1 && (index.h("ir-m-combobox", { key: '8f03735b996753ec95b03a9fdd0f1bc920ce3537', defaultOption: this.filters?.LIST_AC_ID?.length === this.allowedProperties?.length ? 'all' : this.filters?.LIST_AC_ID[0]?.toString(), onOptionChange: e => {
            ...
            ] })), index.h("wa-select", { key: '84bc60f169ef0d88e90d2924979dace7f5d3fa48', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: 'f92bd916bf5b866ac00a2c9a012ce67ad60068e2', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '52ff61601d61df8dbd557a9dea2e462e97b948c0', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: 'a06d35075dabb8e1b6b86520beca9896f72aff83', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: '86ed6f870676c3aa8ceaf002e337a13f052387b6', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: '0402bbe1140e0b8172ebc46b489cc9422fa78346', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: 'fd5d20ead393eac1effc78bc86c79c26a5ffe7df', value: "365" }, "For the past 365 days")), index.h("div", { key: '5566501bb993c78ba38f32a5347424e0fc55adc8', class: "or-divider" }, index.h("span", { key: 'ba3b045c3649ed991b4163fb33ba5ed1cba2dcd7', class: "or-divider__line" }), index.h("span", { key: 'c23dff8f395ff1496a1bb833506d479722aa65c5', class: "or-divider__text" }, "Or"), index.h("span", { key: '74a3eba8a1b88ec430cdd84e25c26598c64f3df4', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '3826a968f3efb939f86508f5b0dac984723c38ec', label: 'Date range', fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", quickDates: this.quickDates, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: '653c212ad158fa1476e3e9d4a8f07383d44ad3d2', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '6434df76387e13cdbae1f9be544ecd2a4a82b959', slot: "footer" }, index.h("ir-custom-button", { key: '807d87449acdbf1d0c6e758b37a34e15a227ceff', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '2976a880fefd615b4def5c0804bb802e07c76b87', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
...
const IrSalesByChannelSummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3d4581eae4e5fb53acc88f87fd86b6e07c6ac4f7', class: "summary-row" }, index.h("ir-metric-card", { key: '106aa6290db36c3612c5a3112e75e2283823d542', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalNights.toString(), trend: hasLastYear ? utils.calculateTrend(totalNights, lastYearNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearNights}` : undefined }), index.h("ir-metric-card", { key: '78c90e011d89ab9c9c06b60e7ac4447e88999076', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(currency, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(currency, lastYearRevenue)}` : undefined }), index.h("ir-metric-card", { key: 'b2c80e2c76c918dfc4e5c16320c4b7ee669a80d2', class: "summary-metric", icon: "chart-bar", label: "Sources", value: (this.records?.length ?? 0).toString() })));
    }
};
