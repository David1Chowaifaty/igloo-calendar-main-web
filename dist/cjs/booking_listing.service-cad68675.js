...
function initializeUserSelection() {
    ...
    booking_listing.userSelection = Object.assign(Object.assign({}, booking_listing.userSelection), { channel: '', booking_status: booking_listing.statuses[0].code, filter_type: booking_listing.types[0].id, book_nbr: '', name: '', from: moment.hooks().add(-7, 'days').format('YYYY-MM-DD'), to: moment.hooks().format('YYYY-MM-DD'), start_row: 0, end_row: 20 });
}
...
//# sourceMappingURL=booking_listing.service-cad68675.js.map