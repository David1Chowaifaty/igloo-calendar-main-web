...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cb1f906a865625a83d35468b03d9dea75b957358' }, index.h("div", { key: '187a737cc5d491063dd277a9cd673776661abefe', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: '4a83202c36b2d9b6880031e27d335c101839ade7', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: 'a16afacab6bb566e7f417a0bc59489945f617f4b', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '6080c013d9d10433e1ec7d3317a6addad170a789', class: "card-header-container mb-2" }, index.h("h3", { key: '3fb0c1981d477cef1c45b95e1246fef3b45af89c', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '1cc6f034ada78a8db3f7fd6644fe4db75ddb8fbf', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '0412f8e57aea742cbebf58beb8c5dcc48c52c20a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '9e95e68a707438567e96ae8c23f6d86773eff526', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: 'ded09d57c4577079a730fca8e20be1b918e9049a', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: '34094c441a0eed9e2ef0ed81f22c2811b5447ffc', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index.h("igl-booking-form", { key: '595972091d383c8f8387a226305c1b4f158eed79', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countryNodeList: this.countryNodeList, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c98a6a567efa401723a32352950593cf924a88b6' }, index.h("div", { key: '535fb7481361704b5911b2d3976adfaa73d3629f', class: "text-left mt-3" }, index.h("div", { key: '57b5e2fae1d04037da20ebc3a0faa6c24d9e629c', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: '109f300098f1e00ca2f55ec36eb8cf9913d1d8b0', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: '8587b9b813c34cb25ae932f0b18cc4c98242df72', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: 'f5de93867b109ebb4bc920d0f10051eb2c005227', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: 'ca8cecb67f1c0b46d8e741c44259f96e477b322b', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: '730e17334f8e6a94aebf60f975d7dfda2a2deba4', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '3508f4b1e76920770e1638bd58ba06733b4a3e54', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: 'e5a5c03e7755bf8b8ba78c7f4c3537d6584dac4b', class: "p-0 flex-fill " }, index.h("div", { key: 'c0d07d8bfa1c360e3afe045663c8b35d43f51fae', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: '5588e25ffdbbaa846ef7481063e9edfd1e017ad0', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: 'cc92e671873ce04c211fda649f8b026d8a9e60b1', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: '0f35c078b4e5b7c4d0708ea0b9138757893f0267', class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => {
                this.updateGuest({ first_name: event.target.value });
                this.handleDataChange('firstName', event);
            }, required: true }))), index.h("div", { key: '8486e9c76712e224e174e020f606aa46170027cc', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '1c1f481d68a6270f9a8d18d189cce96b04e2d248', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '6609c59d0b0fff98239865c2c100b810e55b82c9', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '6fb20bd47048ead03a2e47d5cd6b6a52db32fba7', class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: 'd638353637300d56ad5e84a9336ec85f232cfd01', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '71e087c8b0d7c8eaaf0cc5d70b560478d72ee03e', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("ir-country-picker", { key: '9442a88e7e4e3c307cda3a7ec59d8088c437a2d5', class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countryNodeList, country: this.countryNodeList.find(c => c.id === this.bookedByData.countryId) })), index.h("div", { key: '1295932464af306ba3a45074e034eda54a66e723', class: "form-group p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '3f6202001ca1a5cd97d652bc61a6724dd383fe98', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: 'a1764ab4d9ffc9d4d73f21cac5a3215d90b1a586', class: "p-0 m-0 controlContainer flex-fill" }, index.h("ir-phone-input", { key: '1e8d82888e252344c299fec8cd6c50bdf32cde1f', language: this.language,
            ...
            } }))), index.h("div", { key: '2f2ba367cb2b7fb5a1afbb18f50c13f5b9f4f401', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '6835ffc8a3feea422035ac88e4417581f1bc4212', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: 'c89377d0849cdf4950561fb2cfce581d053af658', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: 'd200bc196dc4a7b0248cf550123ed3c2b7cefd17', class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: 'c5157fbacb0ca3a595507eca59bfd954a26bf5d0', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: '1881fb954cf5867bacdeb394439a7fa6caed9faa', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '8a16a387429c68b73ac56a2bcd68f328963e6d2b', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: '8563ea5f5adc256858edbcbe4a77c8c6d86f1e16', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: 'b4cfa159f5e0a8719693526abe05c785da4a0da1', id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, { key: 'cd48c0c55be2aa59338f5032b3f74ed45b9701d2' }, index.h("div", { key: '2917976c234b14c53eabed9d6ff8ea2f07b18616', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '28ceb9553ace7a3ff6694fb614dd61e411974dd8', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: 'db898fa3b376b99a0c34601394186e97546b8444', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '72217991c16b3a77aeaecacfc7d463cc6645547a', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: 'bb8acfcf0c3b30f6249dce2d13b4349501d4d6c0', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'f5e7dbf14758c0a659bae310e4e1f41a1f70ff39', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: '651913becc9ca760d7ec0e65b738d4bbf7fb03ad', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'cf8f2c1d1b967c947b6c5fe5cd7bcae89fcd1052', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: '44042ef4c106668330965281ea5e842fe0e22ea2', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'ac2fb5f155bb1160260d1d09196398f1d8407ad1', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: 'e600f8e4dee73cf33a42f247966c67f64862bff7', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: '353159b2b927733d16d36e73e67ebef59fec406a', class: "p-0 m-0" }, index.h("select", { key: '109d920163ec468b0dbeac3752ed8bfbc1bd89a1', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: '5d209ba2afb3940e8c0f00c619b83eb87f48ea87', class: "p-0 m-0 ml-1" }, index.h("select", { key: '576275a58f1ca54dcf3f18fd78325d35d9346c46', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: 'ecbf76e22e88f3e1a07bb30940967ba643f7a1b0', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: 'e9d21a4e684deeadd01fa0e736e638c6b169ab2f', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: '65e3f3119950427e7676ea3fd0a2db5e43cd2014', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: '2ea55a7e7790d1f070494a1c4a9383f98ed093ec', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '92b18a83b83ad90a30fe625a91dbe1d0537e61f5' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && index.h("div", { key: '756cde89e1d154cfcebb9306a67aeaed659fb1ac', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '140849329a01ee73b57bf7bbc7d688cba6565245' }, index.h("div", { key: 'c2c2480b64404e803f26d3fbe562ea70fb72327c', class: 'd-flex align-items-center ' }, index.h("label", { key: 'a902c303dd9a3d92b9ef6185442748da91a655eb', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'd8e07cff1755bee5b7c15f867a436bc1788137d2', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'e9f9a15ae48a19060c7bac31741d09984054251a', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'fd16e167b3bc2446213923e306ca3da62b483da4', required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '51d1d8b09be3ce61e6211143561ac43d2a40b0a2', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '2ec4ea1f86a5468665415a6ca20f28a89f6d6178', class: 'sr-only' }, "clear input"), index.h("svg", { key: '44d13e2b4f26903b17023fc31763fae27c9eff6a', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'ac2a23b802539c1494a1c16347d74d33183656d2', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e127074aa50875fdc7744984d63ca5b9ecb9be43', class: 'px-0' }, index.h("ir-title", { key: 'ccb12f62f5df76528ef7895773490ae2bf250507', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("form", { key: '6be2e6bc57fadf5cfa6f047b9b6f0c1e5e65adb2', class: 'px-1', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-textarea", { key: '171264807b8edee776feea68f06ef176b0063700', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) }), index.h("div", { key: 'a808072b4c70e2775abc1f7ee85fe83c99e465cc', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '45e498dbce276710b9cd35cbd6a0e3e1d4ca35ad', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'e969047fdf534a00da12698d82abf4923ddba661', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (index.h("div", { key: '6c437991043486b10a1e2594fe973fb348dfa540', class: "fluid-container p-1" }, index.h("div", { key: '136e2e792e9791fb7d0d887bd555e145a43bc796', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '709d74928dbcc86086c1eacb1507eaee841e6675', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: '19af73cc1b95c04f7918b11991f6b09c4cb4e284', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: 'db2bbd0fabb232068731ba4775beeab1fbe72513', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '8ddf6b38e8218f2af15d5c5f370b975a0a079515', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'dc9274e9418dcb352c2a8298b7238938b2e7e09f', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: 'e7b4c9c8aa6c605fcb7a70cf17afc4b09e947817', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '60c0334c6d3978e1a64e7649907697d9769afb80', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: '8a17987e41a124d2f6790c1842186f811b49afd3', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: 'aa91c7f78cfff2300fdf6ddc923f292c7eb48c32', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '84fe750fee385f13c624646747e5f3a32f36b8e9', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '3d4435886df1fbe6ee123cd4be384a5a63c42e2e', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: 'f552ce1e1abc0f7c380bd4dba769f7322b425378', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: 'e71a4f9bd31360a5dd7cac36670b9fe118eb41c9', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '61adfd97992237e6a47756abbdf1d91b3e82a854', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '824c9df64ca01bebae74314f1de36dc4609f87b1', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '657acc0fa3fadc6ba0e827fc6e98a79c07283972', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '4c92da01ed7c777f93d7d24ac2b4a9909da4ed5f', onOpenChange: e => {
                if (!e.detail) {
...
const IrButton = class {
    ...
    render() {
        ...
        return (index.h("button", { id: this.btn_id, ref: el => (this.buttonEl = el), onClick: () => this.clickHandler.emit(), class: `btn btn-${this.btn_color} ${this.btn_styles} ir-button-class  btn-${this.size} text-${this.textSize} ${blockClass}`, type: this.btn_type, disabled: this.btn_disabled || this.isLoading }, this.icon_name && this.iconPosition === 'left' && index.h("ir-icons", { name: this.icon_name, style: this.icon_style }), this.text && this.renderContentAsHtml ? index.h("span", { class: "button-text m-0", innerHTML: this.text }) : index.h("span", { class: "button-text m-0" }, this.text), this.isLoading ? index.h("div", { class: "btn_loader m-0 p-0" }) : this.iconPosition === 'right' && index.h("ir-icons", { style: this.icon_style, name: this.icon_name })));
    }
};
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '987f8c240bd35bbfc7bcb16223be0e95890fa8f1', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '48d88729cc986672be562b18d83fd4f163b70703', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: '178505aa935c9cfb8b7d5a8eaf31cc55a5b81720', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'fbc02748672c46e5e85f3a4890b02f547283e0da' }, index.h("button", { key: '6d0eba2d0838c026d364a1812759e6342603c056', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'd9f355ca1924f5c0a8d5f471c9b63fdfafc118e5', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '89f59c5908cac3d3c2b441a6a368d8de914dfd9d', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'f9f7dd3747f4de31e3f504c463b7ce82b6ce4666', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '148d96f4b38a34e29fde589f5c6b35117c03caef', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a2522a6938b9c8b97cff8aa93ac7a743124a1bbf' }, index.h("input", { key: '5d96397aa2676c857011b1d78fd1ba5c060e02b0', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bad56961c0ecbfe1a992f1bbe1954b4ac7bf8a3e', class: "d-flex align-items-center" }, index.h("span", { key: 'b2df47d248883b1f1b3e045527d9056c115c4055' }, this.dates.from_date), ' ', index.h("svg", { key: '26e887407fa53d3663fa71eb88b9428ad74b10c1', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'd9152eb2b88bbdf704870ff6d4877ee013220993', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '6b01a1bcefc231f89c10263b8ee2b53f8c7cec6b' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '2e88f72655522a200a1997c7d87b41391731e7a3', class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '661889786e1ca6ce705eeba1d791a6af916d35e5' }, index.h("div", { key: '335ca9c5410f6e5b29d382037b28f71a9ece52e5', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '169c81ff4a9e3449fdd3807534cb5dcf7f8d678c', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '4112cd9a6fdc58c7028a430831e1ccd3f146ef69', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '2e2e141cfe5c4ed26689893353bda3eb85b1e5f4', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '2b4c09e651e34361bdd6b287f638d622bea74723', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '57ba52900856a965ba9e2c4601273ec66091390b', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '0185481dd7d0aef5d7a0b2ef3e984debed8c8e08', name: "modal-title" })), index.h("div", { key: '1e5c90699e26e03ca84531eeee4058d59628bc00', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'fde33c40c20a8a265286fe20d5a06761d276b9ea', name: "modal-body" })), index.h("div", { key: '9822aafbd830177435f6d172aebc8caf4c911a71', class: "modal-footer" }, index.h("slot", { key: 'fb6ed36e90dab51fffee8fac2cc2714043200aeb', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '46520f1758b75147b0dad767768c8aca7a05022f' }, index.h("div", { key: 'dfdf3fa59ee831a7c6fac7896b19934271a6bd56', class: "p-1" }, index.h("div", { key: '5ecbe67bdcc1d56e9dbedcd8e8f83c3acb58dc44', class: 'extra-service-container' }, index.h("p", { key: '6a34416c31a489488f5df059206f1fc73efb44d6', class: "extra-service-description" }, this.service.description), index.h("div", { key: '0e7e67ebfe04550a8514bede32bc1c08d5c17212', class: "extra-service-actions" }, this.service.price && index.h("p", { key: '668a0b06d29ad18c9bcc72222d5b1605de244e5a', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price)), index.h("ir-button", { key: 'd82803f8f9b4071aa87dbfdf7c721ad26c0be1c6', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: 'ed6ad635ce54992efcc4f1d39e4e4dc915633777', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: icons.colorVariants.danger }))), index.h("div", { key: '58d3cf3c4f90a7093bf3c5658ef35e8e02bf359d', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: 'd23c6529b89f86cc806b80e434c21e4ee6a5f9f2', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const ZIdInfo = utils.z.object({
    type: utils.z.object({
        code: utils.z.string().min(3),
        description: utils.z.string(),
    }),
    number: utils.z.string().min(2),
});
const ZSharedPerson = utils.z.object({
    id: utils.z.number(),
    full_name: utils.z.string().min(2),
    country_id: utils.z.coerce.number().min(0),
    dob: utils.z.coerce.date().transform(date => moment.hooks(date).format('YYYY-MM-DD')),
    id_info: ZIdInfo,
});
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7971d90556e296196b49c54770fc0d4888b7ea46', class: 'p-0' }, index.h("ir-title", { key: '4c18d7989bb9d6ca5631a137bbed9b15a389c8a3', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '0f199439ee0cf187e4255e9c6dd2fbd111ff5d3b', class: 'px-1' }, index.h("fieldset", { key: 'edc46420c33d74598718d808e84cb61879f6b16e', class: "input-group mb-1 mt-3 service-description" }, index.h("div", { key: 'e3c8f0f6762a258cd7cde0f34d72f578196a72f9', class: "input-group-prepend" }, index.h("span", { key: 'ff5b30376b74daac10af1d9735ff0ce006678eaa', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '0fb31ec0436d554f57d5edcef00a6739551fd079', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '60f000cc7969664d57ce6a4fa5259057255574e4', class: 'row-group mb-1' }, index.h("div", { key: 'ebd71ecce35cec80b9b0097e72df44ec4aadc076', class: "input-group" }, index.h("div", { key: '25e7d9c0360530aa5ed3778e5fb937de7c08271f', class: "input-group-prepend" }, index.h("span", { key: '095e517e669962eb4b28b962ba6f8a243fa3bcee', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: 'a7acc6cf2b8c002f8402438f07982555a4ad5956', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '6caf8be96f21485b0e47aecb34f24eea2e693266', class: "service-date-container" }, index.h("ir-date-picker", { key: '0abc3d9604af8dd54e770061ce84e417e1060747', date: ((_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date) ? new Date((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) : new Date(this.booking.from_date), class: `hidden-date-picker ${!((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) ? 'hidden-date s' : ''}`, autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start.format('YYYY-MM-DD') }) }), ((_f = this.s_service) === null || _f === void 0 ? void 0 : _f.start_date) && (index.h("div", { key: '8a7d455c64e0f8720a223317623f3d37b63f63c4', class: "btn-container" }, index.h("ir-button", { key: '309e12e630e2f70ad175cdc7acdb5e0bff8a1b8b', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '2934cd32db91a20813bdca498ac698b0788e381d', class: "input-group" }, index.h("div", { key: 'a0b4f602cec66e91d0a225327ba3d57f474df7b2', class: "input-group-prepend " }, index.h("span", { key: 'f9343949a02c2c75187ebbb4300706f0150eea17', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: '2e15e9a7f2e60caf33c609a23b476bd7c8fc92d5', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '6cef47e3b9a01efe93668b3a303b93eada5c829c', class: "service-date-container" }, index.h("ir-date-picker", { key: '0aca02483c6e18a8c4663c1f8abccefe004df009', date: ((_g = this.s_service) === null || _g === void 0 ? void 0 : _g.end_date) ? new Date((_h = this.s_service) === null || _h === void 0 ? void 0 : _h.end_date) : new Date(this.booking.to_date), class: `hidden-date-picker ${!((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? 'hidden-dates' : ''}`, autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start.format('YYYY-MM-DD') });
            } }), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '5a56730984f849a5f96288f6b57834eff5b35a4d', class: "btn-container" }, index.h("ir-button", { key: 'cbe555509b7b6edd8c1c187d9b5cf41d764d478b', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '5439a4ffdb578b3479ea0122ce6f7f0a1e611bf8', class: 'row-group' }, index.h("ir-price-input", { key: '58b9b95ef459a13021a4e50f77f67f5beb695df1', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: 'e8d2bb1ffa195136f0d2c77f1b425a4078e4f1ba', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "cost-label", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" })), index.h("div", { key: 'ff20ae4c217a35d9b576ef55d67dd34976f41aec', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: 'ba5a65345f87414246fb011d471df1f425a0dd5a', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill mr-sm-1`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'a667fc67ffaf1dd4f66f1430dd825956329f593c', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.saveAmenity.bind(this) })))));
    }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '93ccff02a6f339b8da6734f47074951ffee47bd9', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '94e52c587296e5145eb83e19724b2b478bade529', name: "icon" })));
    }
};
...
const IrInputText = class {
    ...
    render() {
        if (this.variant === 'icon') {
            return (index.h("fieldset", { class: "position-relative has-icon-left input-container" }, index.h("label", { htmlFor: this.id, class: "input-group-prepend bg-white m-0" }, index.h("span", { "data-disabled": this.disabled, "data-state": this.inputFocused ? 'focus' : '', class: `input-group-text icon-container bg-white ${(this.error || this.isError) && 'danger-border'}`, id: "basic-addon1" }, index.h("slot", { name: "icon" }))), index.h("input", { ref: el => (this.inputRef = el), type: this.type, onFocus: e => {
                    this.inputFocused = true;
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3be6a854e8ae903930ae99b50151c5aab86da801' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: 'bf172b777a80de711ba028c180fdc784f20d8fef', class: "loadingScreenContainer" }, index.h("div", { key: 'bac328fe76e41f2a2147e9c7d58e0f2ca0ee072d', class: "loaderContainer" }, index.h("span", { key: 'a57c0310d6f69dc0ac17a64b4f9c0ce8d0825ace', class: "page-loader" }))))));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bf5455220e81220bac71f139a87852b2fd90c197' }, index.h("a", { key: '0256610ac333ff02f2cc0c9230a16b494452bfc9', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '8cc39a3d24e33f482e7285df6c1cf1f40fd5a6bd', class: "sr-only" }, "download url")), index.h("section", { key: 'f02aee2027cae3ea3993649a4152c32199ccbb0e', class: "d-flex align-items-center " }, index.h("div", { key: '64c53042ecbb2f189e3a21fa9d53527e2a603ec9', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '82424c2167ba07c9ad9b62fc5e7a3fdf8c2ac553', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '07ccbd196ee57b378d6e5359e137ec53b56ce23c', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'f3909803d374165b01d8ba14d46c8b2cb8a8062e' }, index.h("igl-book-property-container", { key: '5c08d90cbf40ac81db8501456ef990b8b5ec5395', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '6350c6d8e33b29bb5003810c9d55f4cc7d79a85f', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: 'dae4f5f297e387a6559468f25ce3e420dfbfd596', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '506fe3ef2c1c10ef5b2b2f9067430c8f9f32a3af', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: 'a4f7fdaed9dc4f8400e0373d50fabe02b90c2ae1', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: 'bff16849422ccc520072ed11dd10a92dc40c1d69', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'f2c4042b0b88b6407adbdb18759e42c7fd2eacb7', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: 'bee572db5f007d71de0f5cf1672b50ea34eddc4e', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: '6c4228123fd9991e5e83bc75c7e0528f9078c17b', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: '18c428b67bff96ec402e0db7c602cf24a9ceb1c7', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: 'd6b7d94add40e7d53eb87970e2d4b1c635b1d1a1', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: '66d2b8379515f48fe913ffce8422ee3a2d5f1aa6', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: 'ecf06957bfb0bc884025ee3476111c57e8208be8' }), index.h("h5", { key: '582a42f18d15d492af35fc74f3523af0e205293d', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: 'd1c9d568fa83070ee54ff0c4e82ab3f4670fefd1' })), index.h("section", { key: 'a5115d4558255203c93b4ce3771622fcf558197e', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: '0d673ae5609a2701715cf24cab6b3760a9c455f8', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("div", { key: 'b5c4dc2d7d2ade22e255327f4e31c01ff1ab6bfc', class: 'booking-dates-container' }, index.h("span", { key: '876a0424ac7cd070e6f752d7818ca9e5cf1c2a90' }, index.h("svg", { key: 'b81c07dc67b28e9d447bf9ceac86a5595ee3f6ff', xmlns: "http://www.w3.org/2000/svg", viewBox: '0 0 448 512', style: { height: '14px', width: '14px' } }, index.h("path", { key: '89746f344a13328ece053493ca008ca44497eafd', fill: "currentColor", d: 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z' }))), index.h("div", { key: '1f62258034dd314eebfb6217f32daabae12eb2b2', class: "date-picker-wrapper", "data-option": "from-date" }, index.h("p", { key: 'a4a1d7a7d07b1ab7f3bcfd18c6d62342516b04bb', class: "date-display", title: "from date" }, moment.hooks(new Date(booking_listing.userSelection.from)).format('MMM DD, yyyy')), index.h("ir-date-picker", { key: '5c0a3dcd1d5c3cb0ba3cb22eb049e4bd86f3d7f0', date: new Date(booking_listing.userSelection.from), class: "hidden-date-picker", autoApply: true, singleDatePicker: true, minDate: "2000-01-01", onDateChanged: this.handleFromDateChange.bind(this) })), index.h("span", { key: '03b997cb8dd02201bc45db44e89f9026641d5b17' }, index.h("svg", { key: '70801e59ad8934c7bb037ade523185bf5042cf2d', xmlns: "http://www.w3.org/2000/svg", class: "arrow-icon", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'cceefb7a3904ed733eabd3b121750e967e580fdb', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("div", { key: '1dd59b6ca0ffd52ca5b5022598bfc569415dcf9e', "data-option": "to-date", class: "date-picker-wrapper" }, index.h("p", { key: '0f04b445ec05d7fbbf428c33ac424601368a3868', class: "date-display", title: "to date" }, moment.hooks(new Date(booking_listing.userSelection.to)).format('MMM DD, YYYY')), index.h("ir-date-picker", { key: '3399b2cc874cba9f92b82108519111e4568e8f3a', date: new Date(booking_listing.userSelection.to), class: "hidden-date-picker", ref: el => (this.toDateRef = el), autoApply: true, singleDatePicker: true, minDate: booking_listing.userSelection.from, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }))), index.h("ir-select", { key: '5f34f00e673c84caae6b4ee3780db2e62ae98e6d', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'ee4d72945fd923cb130f9e68b554ea3782794f1f', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: '7dab661005ad03f82f8a6f524754a88ec6cd16cf', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: 'e3c22a302db497b28ae497c3ca719b43c9d7eb66', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: 'a24e8ecf97ee555dd292f4e6ab9fb0b5f5fe0117', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: '141f8cdf513646e60b378106f70e8cc34de8968c', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4057b32c19a271dec113dde7e5abd0507fed667e' }, index.h("span", { key: 'dd0beeba49aaefcb8177c20b1aa5c42a405eefb4', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '529321b5859057bc954145cfb298d08628d9b9b1', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '7ae7916f8821427797ebd7e85a700744200c8967', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '34a12454e80b47147c1b773ea2da8c3c9993516b', class: `ir-alert-content p-2` }, index.h("div", { key: 'bb07b6473df3156919159cde9306ef3a1a27f697', class: `ir-alert-header align-items-center border-0 py-0 m-0 ` }), index.h("div", { key: '43b7ff33a68c92da1eb62be3c5b7c9b94c1ac7cd', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '69a3d052aa15496bf08a5f6e35602f46ab32ae4e' }, this.modalBody)), index.h("div", { key: '4b2aeaae027883492acb3191b281f69726560f66', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: '2a962ba2226106a53bb06bd1f064a42a794bf76b', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '3ae92d267f9eacba29d775ecc53192bacc2487d1', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'fe89975d889f9ccb6aa83c0e8da595fadbc9d8d4' }, index.h("div", { key: '696b6d790865ad97390d1723065aa82f02ee7acf', class: "form-group mr-0" }, index.h("div", { key: '0f823217b1e657c1b3a349702d857c09cc0133b4', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: 'a578d8ee415880630212830ec9f7d18b36df299e', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'b975cb312ec7056d8f3fed904598835fe3f29bf1', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: 'e4924da3a8453c608ab279eeb568b9925261d0f0', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '72eb04c6b05f86063e772aa3114a45a8388d5d19', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'e458628b5a8e9a7ffe0a40d0252f2136e7382aa4', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '14347ee32d11e6d8a44d31250e4f9aace6e604f6', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '2a8bbc3f7a24123d2bef6f8201539c0c8f9a4bc8', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: 'fd66fbf94a809a4163521ccf8a6dc635ef94d0fb', type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), ' ', this.isDropdownVisible && (index.h("div", { key: '46be933c64d211a219dfe55a36eca83961224a6f', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: 'e551ba70e7c8e29bb0523fd1bb162121228fdcfa', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '03088aeedc9520c454caf9535dfe713e0dcede30', class: 'p-0' }, index.h("ir-title", { key: '294259ff7a99ef1be595b70741b5dbf941590e1d', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: 'c4c93ecadf2da31f9c16ba3dc9f0bf542a0ecea9', class: 'px-1' }, index.h("ir-select", { key: 'bf701ef2bcf409841169ce8277161abdc67b670d', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h(index.Fragment, { key: '9e3bc6630364c1fba7df9f0f85034b6ed457dc86' }, index.h("div", { key: 'f4862f46a294150f6330773045c9bd4b714383e3', class: 'd-flex' }, index.h("div", { key: '74cad65b8d115cacd17665126b874255cfa1b5e3', class: "form-group  mr-1" }, index.h("div", { key: '9744d3c1d8bd3a8decb682fd71f32796af76a480', class: "input-group row m-0" }, index.h("div", { key: '3af602a361b99c9b3be8ffe0cf0ff5cc12f20849', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'bfb8b7eb246fca8f97e74c0ce2a40a1ca921e5cd', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'b0ee3f9344eedcac9ab92a467f7dd5c41697b9a3', class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, index.h("ir-date-picker", { key: '9cce5524ad2aeacfabdd5f05c94057a65c3d5259', minDate: moment.hooks().format('YYYY-MM-DD'), autoApply: true,
            // format="ddd, DD M YYYY"
            singleDatePicker: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start.format('YYYY-MM-DD'));
            } })))), index.h("div", { key: 'c6c60184488e58405cb1dd0b4400b85043735018', class: "form-group" }, index.h("div", { key: '839ff5dfb92c227bc55b9dee55bcffcfe7f26e8e', class: "input-group  row m-0" }, index.h("div", { key: '49230b5ad09984fc79da17fe731e3d5fb260172a', class: `input-group-prepend col-4 col-sm-3 p-0 text-dark border-0` }, index.h("label", { key: '73a76e0fbc7c81d83fbbda01c1ad3614c48c1619', htmlFor: "pickup", class: `input-group-text flex-grow-1 text-dark border-theme` }, locales_store.locales.entries.Lcz_Time)), index.h("input", { key: '6ad8d3b7ebe00e3ac8bda8041221dc87fe6fe504', type: "text", value: this.pickupData.arrival_time, id: "pickup-time", class: `form-control col-8 col-sm-4 ${this.cause === 'arrival_time' && 'border-danger'}` })))), index.h("ir-input-text", { key: '3d944cf462b6ea003b8a582934e624237a43764b', value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", inputStyles: this.cause === 'flight_details' ? 'border-danger' : '' }), index.h("ir-select", { key: '8b5a91d53cf5113e53789a9f87006d1e90de2104', selectContainerStyle: "mb-1", selectStyles: this.cause === 'vehicle_type_code' ? 'border-danger' : '', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '1d011d08c5b4276a76f0d71793846ae44809de9a', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '42cb78494bce66aa99f487e44292c42c681270bb', labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectStyles: this.cause === 'number_of_vehicles' ? 'border-danger' : '', selectedValue: this.pickupData.number_of_vehicles, labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("ir-input-text", { key: 'c3ba905640be7e0ffaf10064720e834a81b06a10', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales_store.locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" })))), index.h("div", { key: '28e8e9e0708e3249d9c5404738f0a90382224cf6', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '0856cde6ea3e9e9482bc7a7c1a5a1336f9f80993', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  ${this.defaultPickupData || this.pickupData.location !== -1 ? 'mr-sm-1' : ''}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'd002428791ec9fa097eaa7961e1a35273b70f7dc', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.savePickup.bind(this) }))))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '6e5a4d3f29e183670e978b710bc6401ac9ccc9cd', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: '32999477d04042f317461e7922e3b6d71ca6d3ef', class: "input-group-prepend" }, index.h("span", { key: 'bb40af9305e576d4b2aa5f6e72c69c9b4c15ff7a', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '51dedf1aba5ad5bac58259448e46c14cbfdeddf2', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'c389861dfb800dc974bd52da66f1d9fe4366d11c', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '139eb55a349a246f9d31e9a7ea28f1fc53d403e2', class: `input-group-prepend` }, index.h("span", { key: 'c988d35b5dcaef525e301da93f50371a06c50320', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'd123909b5d79bd4a1347f4424b1daccbad977988', disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5af1592fe734311d0ae8307ebf07d7c3e96aadfa', class: "card" }, index.h("div", { key: 'af0b9916c460d70501b3bd31234239165ae064e1', class: "p-1" }, index.h("p", { key: '2ea112e27242563a875893a97b68aacf8b4d867f' }, this.booking.property.name || ''), index.h("ir-label", { key: 'cd3b4e6a23178a32c004316b6148cb77514734c6', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '452e9a6f5f85d40c9b1f3445f71458b9111881b9', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '57541a247f1fa834997ed02a8ea4bd57a5e2c710', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '91d4ebfca2bee6a6e7bf4b60d81dacf7e081f597', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'c2dc4685da9b680ef8519debf76604b1b882cc0a', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'ea078cb89ad82ab7fde972d61a30e5f97102f73d', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '03bb9c4a17dd44638d5d5f3e10414477999c24bf', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '91ddc337d5bdac4232dbd74eb939a5d80edd85d1', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '5100964faf921655ee5fbd89227fccb943c7e2db', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'b5a83778d11a0f8555cd81f3896b4f011c156a04', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '5ba2c227054a58d886b10317ee50978890d59500', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '1536d71a6c32214715ffa8fa64e990212fb4314e', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '3c07482d0ce535513e94c4852a180590cf03aa6b', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'ece0d8363cd311da4efe703a6d68d551331004c2', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '8bdfb583d42606cedba5470fe85307c70374f52a', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '4f57357c94f118cbd6943aa1e7aca466f8b757cd', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '221718fcab1ab58d11b21861f784e25da70ee518', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'bf99e613a5163e029df7a4c7c8cd2e6905e77cb0', class: "d-flex align-items-center" }, index.h("svg", { key: 'ac91ee3fa419226016c49d29a9ba72c022f77d59', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'e0be4393b88982d0a68765bba5dac34d22cc869a', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '9ac96cca63d3564a8775213b2851ba6c37d63c4f', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'dbe890d15c6a88614fc835f13b395becdf5b7e31', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '7598404a9b69b0a94f1e499cb84caa36fb846ac3', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '0aa1f82f6594140e50fcec75f5f6c76f627994b4', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
const IrRoom = class {
    ...
    handleEditClick() {
        ...
        this.editInitiated.emit({
            ...
            NAME: booking_service.formatName(this.room.guest.first_name, this.room.guest.last_name),
            EMAIL: this.booking.guest.email,
            PHONE: this.booking.guest.mobile,
            REFERENCE_TYPE: '',
            FROM_DATE: this.booking.from_date,
            TO_DATE: this.booking.to_date,
            TITLE: `${locales_store.locales.entries.Lcz_EditBookingFor} ${(_b = (_a = this.room) === null || _a === void 0 ? void 0 : _a.roomtype) === null || _b === void 0 ? void 0 : _b.name} ${((_d = (_c = this.room) === null || _c === void 0 ? void 0 : _c.unit) === null || _d === void 0 ? void 0 : _d.name) || ''}`,
            defaultDateRange: {
...
`;
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '148b656915ad0f32a902aa7743c8ad8b08835353', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'aa7cdef8188669d8d7d6d6ddac9ccf8bdd708f8f', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '3c7ece86a5d4cbba819b58dd0c850a0ce1191935', class: "flex-fill m-0 " }, index.h("div", { key: '5e4c029f3d226df2cda69c713c9374223c191f14', class: "d-flex align-rooms-start justify-content-between sm-mb-1" }, index.h("p", { key: '6735699414498dbae79e96041a498ddc543e518a', class: "m-0 p-0" }, index.h("span", { key: '9d2518a2ef8995276b1678e76d707748e9779c62', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '1a6917c86c1933ae047d710090dc75628de9e520', class: "d-flex m-0 p-0 align-rooms-center room_actions_btns" }, index.h("span", { key: '5472f7d22d5516fdc365fcc358d701c717f708cb', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '547be31d4fbaace882e60d915db34f878226aee2', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'abfd4ac5a0fe24aefdca51b533068db60c311e5c', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '4a46d7790bfe6bc9ac2d7bee5af3573b2902823d', class: "d-flex align-rooms-center sm-mb-1" }, index.h("ir-date-view", { key: '6cee0e47d6969f1c34788ca66b866351cec18e4f', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: 'e7909027ec01ae79913ab1b334b69b0e73fdcaa5', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: 'fce798a974af94a4e59fc3f3ae508453caf697ae', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '8de380e07ce805bcb71eeae84aaba276213bf4bf', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: 'd9c7ddf84ee24f151e9838bb1cc322b5c7eba4fa', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: 'e99a0775adf16ae0b8767157a8405478ac4626f7', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: 'c5be6f2469a0f594807395706a896e8dd645e0e3', class: 'd-flex align-items-center' }, index.h("span", { key: '61783965baa258ede15cc9eb51eb6979d328fed5', class: "mr-1" }, `${this.room.guest.first_name || ''} ${this.room.guest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-button", { btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btn_styles: "room_guest_name", text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) })) : (index.h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), this.room.bed_preference && index.h("span", { key: 'f452112f786af251c6bb8d4395e71dd7f74d0b72' }, "(", this.getBedName(), ")")), index.h("div", { key: 'b1296ddc9c4db6fbe33a82aefd7b5919c292fdea', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '9acd422add84826ed2f82b4b03960935380bbfc2', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'e15dc20654e72f69ab470696c4893d7110e0603e', class: " sm-padding-top" }, index.h("p", { key: 'e340e25498af2e83a45865fd348580777d01671f', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'fd007e0b2adeadd4a01cd20af43bf60908853ff7', class: 'flex-fill' }, index.h("table", { key: '91c2690e7464d37db4a9cca12569f1210677861e' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'f0d0e5d0ee144799ed1259cf79f3b613d7ddc008', class: '' }, index.h("th", { key: '64b4dd39e1cad43dabfde914ccc64ed45aa2f037', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'b802cfc50d1f68e5970868d51809b8e42667c0d4', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'a63e8938d0f30aaa8bdfee4d3c4771d6c5bdf857', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), this.booking.is_direct && (index.h(index.Fragment, { key: '8348ab6bce11faefb96a20125a56da8296e89f56' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'ea12c2359a29c9f776555637233dc797de96826a', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'cf5fdd934c04040f8022898ed1690cf0f16687d9', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))))), index.h("ir-modal", { key: 'e1ab9bdd6c72521fa86b49c16b7f53a715ee1047', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        let className = 'form-control';
        let label = (index.h("div", { key: '6e496ca832f125eb9876ec4495b74003789edfbf', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '813ba99577cbef2412530a31eb2896eab497891b', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: 'c992064972738f09d0cfa00719e3db7e5ad2636d', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'd3f50f3c084fea4a5118a4617f671412b4902c26', class: "input-group row m-0" }, label, index.h("select", { key: 'ed9123ca73d80193c5d4b164015c4ca11418752d', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '0372d5b2133cd3eebecb2a9e70a83b59ffa68829', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '4182a0595abf729c52d816ee68da832475b9a2ee', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: 'e06173c2c3c27a5f28b2b20b1b3bbd46c8b26d65', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '2b00f9e6de1dac61796659102e936fa49d4571db', class: 'sidebar-title' }, index.h("p", { key: '507161d78b907d1bb38e337a14918bd61a93fc73', class: 'p-0 m-0' }, this.label), index.h("div", { key: '3013b802f3aa42e7da186aefbe8a3c6178f6a1bb', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'd1096aff47063965e796eb1a7a44b615b4d26985', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '9998bf29034eee7a76a7eea23bea21fee1476758', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '42535afbbb5e54024d4e262c656cab98f3e15e04', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '09487a382c878965b980ee9eeeb544c2c421263f', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '451da8644d41d8531a56fbfe61b9bbdec588c176' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3221d80239c3854b46af31007ca974500e7c3f43' }, index.h("h4", { key: 'd557c35c494d19ee154a1709ad35232c35692191', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '32bfea0609bdd1832bcca33d400f64c1acbc94c8', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'b514f7ce24774b42b75e8842f722392a68bc3e5e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '79ac4cee0e86afe4c825f6e5e25c42a6dcd90d21', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'dc5ff03111f2b8ef9c0543526aab7c971baef5ce', class: 'title-body' }, index.h("slot", { key: '8873a5f0b7f127bab031e68c6e2182fbf9ea6de0', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '6ebe3a97397818e2e8ca5b5846599f33deff216a' });
    }
    get element() { return index.getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9252173e03e551764e825a55d9610c4a1e5fbe45', class: "m-0 p-0" }, index.h("span", { key: '91799653a64d4f61b2fda97a403bb774f9799318', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '1cbb43c8aa3b59d2c0b856d31eaefca97be37725', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '738e2cbd3a38d23cb0ceb3e1db033b28d32b52a8', class: "tooltip-arrow" }), index.h("div", { key: 'eae3ebe9945a536d37ec890fec8361f6051560ef', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '44eb742c0e758fd958a63856d98c4ab9e853cfee', innerHTML: this.message }))))));
    }
};
...
//# sourceMappingURL=igl-application-info_56.cjs.entry.js.map