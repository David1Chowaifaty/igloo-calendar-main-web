...
const IrOtaService = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'eb6515ba850a0c9d9e425293d16c9747aa0298b6', class: "p-1" }, index.h("div", { key: '0c0db31783028a7a5dbc96b52bdff7334acc8843', class: "m-0 p-0 d-flex align-items-center justify-content-between" }, index.h("p", { key: '50582f645763d9b996aa570d248f0834412f82c6', class: "m-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("b", { key: '203aa024f440f6e5bf3613ced32adf27d6714a4d' }, this.service.name), index.h("span", { key: 'd84d9405cf4453de3007ea6db84a4a0a7804611e', class: "p-0 m-0" }, (_b = (_a = this.service) === null || _a === void 0 ? void 0 : _a.persons) === null || _b === void 0 ? void 0 :
            _b.toString(), " ", this.service.persons > 1 ? 'persons' : 'person'), index.h("span", { key: 'e323248d21a739d4ae9c777396f7cd9cecf1ea30', class: "p-0 m-0" }, (_d = (_c = this.service) === null || _c === void 0 ? void 0 : _c.nights) === null || _d === void 0 ? void 0 :
