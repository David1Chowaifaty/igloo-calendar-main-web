...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd7f62351d5d287fa8d965d8b8586f40b83dad471' }, index.h("div", { key: 'a823cd8e0bd15f223b272e2b7869d409a1300122', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '73479d179ada4de13a80dd79b31ffa094d6126de', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '974965a0b53ad12bee0ec22c1c12e64b8c67fc71', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '897918ed31d2106670dae49530325b9e81cfd1a4', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'cf25a4650d64281cbfb24824687363e7f6d83be1', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'eb1c740c4d640d4b0c8795b1f6f08dcd214520c6', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '00d83a91200ce7e1a354658c5c02d1070ee4eef2', name: "modal-title" })), index.h("div", { key: '9d191e4a7667bf565f8db31b2aee20d58380f435', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'cc40971536259558de80f3c1edf89099b4d4fb77', name: "modal-body" })), index.h("div", { key: '43fd71f99e1fb656d90e3920d86d4d6d9dd42ba6', class: "modal-footer" }, index.h("slot", { key: 'bd19c622d85e58542e5b39221949006cce2cd34e', name: "modal-footer" }))))));
    }
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e0b78f112d3a4a024abda8d2689c9c713540f9c9', class: 'p-0' }, index.h("ir-title", { key: 'e06068e62f52749574777c8d726d68490d006af9', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '51010ab409467da20edc9ec6c88d8144070b26a6', class: 'px-1' }, index.h("fieldset", { key: '0112c0295e91fb56f7c7eb06fb73900e3f9f8978', class: "input-group mb-1 mt-3 service-description" }, index.h("div", { key: '568bbac4d3966d8f7217cc5d4befb415d87d9053', class: "input-group-prepend" }, index.h("span", { key: '0767470d43c8f9838063a5074c48a58c0bc1da98', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '6c39a48e7d0d9091f785f92fb994056eb5c57aff', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '88bfcd0a16750d0d2d20b5bd1c0935e32c87e8d2', class: 'row-group mb-1' }, index.h("div", { key: '2ff3efb455b6869ee0a41b924e584f8a9337f2f5', class: "input-group" }, index.h("div", { key: 'ddb0b26de7f29a7d6dbcfcf6b1ae0b5e392942b6', class: "input-group-prepend" }, index.h("span", { key: '6b216f77acca7f7c00f9867d2760cbc762f322cf', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: 'd721037f283ef79fff9e7dada6a15e5f2124c7d4', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: 'defef45218e29013aed6b22048f075a0a403bcb2', class: "service-date-container" }, index.h("ir-date-picker", { key: '11eb8aa4b4e46a2ba73a46b923f67cd4c98525dc', emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: 'ed2564d9e7a73d03632be120c92262b2b16aa4d4', slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: '94723cc303047adb214e6c9a9c1259d0498b8773', class: "btn-container" }, index.h("ir-button", { key: '0b12b24100fd60be1337615f8fbaeb002483cfe9', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '0198ae67d95e9d241446632e1e66f29c95a58a40', class: "input-group" }, index.h("div", { key: 'fd76163d036d530a22ebb6bb7e6208277b731d2f', class: "input-group-prepend " }, index.h("span", { key: '8123602650abf9014bbf2b0d443f52f15feea259', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'f31064b0c438df6094d91d37ca617611442a44ff', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '2920cb780d84b03f4abfa98fe10750cf0aad1b64', class: "service-date-container" }, index.h("ir-date-picker", { key: 'a8474e5072e313b66f5cba9332ad8998925a3d3b', emitEmptyDate: true, date: (_f = this.s_service) === null || _f === void 0 ? void 0 : _f.end_date, minDate: (_h = (_g = this.s_service) === null || _g === void 0 ? void 0 : _g.start_date) !== null && _h !== void 0 ? _h : this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                var _a;
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '8b5f405eaf0a82c332673c1fd75f7ce0fd4592f6', slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: 'e2660b96076304c92f5e8249662ef2259d81be91', class: "btn-container" }, index.h("ir-button", { key: '02483194bf9c9e86c0b9898b70b17ac835c6e1a9', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: 'af800ca27649b2886b7d50203849ac8a9f00877b', class: 'row-group' }, index.h("ir-price-input", { key: '7480547d3052022be2df8dc5754a1116be78f967', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '0e345f0acafc579dfc563bf712826307f5b0ea90', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "cost-label", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" })), index.h("div", { key: '9b861d16d4d20ae1a64821767112570471b15e7a', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '315edb3b6eead2860a43769a8e88237636a59ee0', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill mr-sm-1`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'c07a0a5fe91296fc7a1c8ce9e6072ca56e3ff073', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.saveAmenity.bind(this) })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'fd3c82929ab1d4aab1488fcf37a66e18cfae3a4a', class: 'p-0' }, index.h("ir-title", { key: 'e11f2fcec6f88540ed7a4649a8c85c5451ea591a', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '53a264e6f004121ca465b5424afa071cf95c1ac7', class: 'px-1' }, index.h("ir-select", { key: 'acca973156d288dff28f5c416134634e5f9c317f', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h(index.Fragment, { key: 'dfecf4661245044a3369f2a2ad8a21e715ada68e' }, index.h("div", { key: 'cedfeb2819f7c048d5d4cd91a8ab4174563219a8', class: 'd-flex' }, index.h("div", { key: '4aee04bf7e9bee8cc7a5bc430ffae5f8a2154334', class: "form-group  mr-1" }, index.h("div", { key: '74a7db306043bd4c8ed6956076ad2bdb3655142f', class: "input-group row m-0" }, index.h("div", { key: '905c12f334a5ed122732de957dbd72b624840647', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '786c10db6e1822f7a95ea7e827112b72fc7e97f2', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'e4532246a94ce817ada5b37351091c0b0a10dc76', class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, index.h("ir-date-picker", { key: '761379c51f7dbe7ff3ad0a876337dd4b352f7152', date: this.pickupData.arrival_date, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, minDate: this.bookingDates.from, onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: 'd74f57dd672da8c42c9525d7a6c869613184c0bf', type: "text", slot: "trigger", value: moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY'), class: "form-control input-sm text-center", style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' } }))))), index.h("div", { key: '137245bed46ee0ccdba298940454f5eabab1a47b', class: "form-group" }, index.h("div", { key: '8f4d162a82b796a69c55cec09f3bc781d8aa0681', class: "input-group  row m-0" }, index.h("div", { key: '059ea0d72905badeb4d471f362d9e4d4513b089e', class: `input-group-prepend col-4 col-sm-3 p-0 text-dark border-0` }, index.h("label", { key: '74c98fc313c3ba4d6999abed3c6295eb3e11050d', htmlFor: "pickup", class: `input-group-text flex-grow-1 text-dark border-theme` }, locales_store.locales.entries.Lcz_Time)), index.h("input", { key: 'f7bbffdb1fc6fed54892ed8589ee8eabdd264289', type: "text", value: this.pickupData.arrival_time, id: "pickup-time", class: `form-control col-8 col-sm-4 ${this.cause === 'arrival_time' && 'border-danger'}` })))), index.h("ir-input-text", { key: 'd882dbd134c20fbf4ab80766b5ea5c2bc33f9f65', value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", inputStyles: this.cause === 'flight_details' ? 'border-danger' : '' }), index.h("ir-select", { key: '854dc8fc39869252b0380c7ecaaedabc6f77f6b4', selectContainerStyle: "mb-1", selectStyles: this.cause === 'vehicle_type_code' ? 'border-danger' : '', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '017cf2f6023100f10d66d12aaa9ee2dee0b88f02', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '7ce0828a09f3e7f8b82a232e90eeee09fc4d9a69', labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectStyles: this.cause === 'number_of_vehicles' ? 'border-danger' : '', selectedValue: this.pickupData.number_of_vehicles, labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("ir-input-text", { key: 'f201bf6d344f617f3da422be5e8b9bb03b1ce530', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales_store.locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" })))), index.h("div", { key: '8e02abe224bd062879036c2ccbc99798aef35ef2', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: 'a6d5f6eb55f625a190dd39cd3313c49b8eb33bcb', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  ${this.defaultPickupData || this.pickupData.location !== -1 ? 'mr-sm-1' : ''}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'ff1af5af59e77fa7dab7cdcebe606b0c44fedee5', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.savePickup.bind(this) }))))));
    }
    get el() { return index.getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '85a04227b7bf5ccdfcf0ffc5305451dfebb17a36', class: "card" }, index.h("div", { key: 'af41931938e13a37f6d3175086b87adc5ccd5a10', class: "p-1" }, index.h("p", { key: '201cdcf2399af8babb8714567de9dbbfd2fb5976' }, this.booking.property.name || ''), index.h("ir-label", { key: '9f85b8f1dd43b4a0d6534beb7351ef509c66dc0b', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'a626a42ee5c4ccc3902505dc2b70d3a874241ef0', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '4fbfd7ad90f4bb1162a70ebcecf8e7fca0edded0', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: 'ec5ef4d6a63efb9a299c57c4c6dcb26f7cc9755b', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'd83acc6f9259c3f460d921899140828da9fb3537', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '0564d9af05baba97a4626bc595102f7f8af2c059', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: 'd3c65af635308c8f98d64d56f673759ed60ac417', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'e68faf1358add6e22b22a676fdfc73996e9b5a78', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '12cc4a6124695a77ee1157c824360ecd1d1920c6', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'cdec08e73a13f9d79c70e55d48ef6c41456a9b8f', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'c68f3d30f67de4ef90b486706b641eb061720436', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '90c4e2ec52d744fc534150ed38af614d66b45fb6', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: 'ea53c700e933790b1b08044dfcce26aaaad0bc90', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '4fab35879eaafa487e680b479e84b418af290043', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'a8ac87fdef0350a98028bbe837834546a0de0a91', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '1e7bcf43c7f6b4935da427bd93966b3cc5ca6ee6', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '436caea21b75a2668b7fc3d0c3d2b3a85d69f578', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'bcb432bed257e611d09a5fdb38a2f7d6be5e26b5', class: "d-flex align-items-center" }, index.h("svg", { key: 'c3d4859703b754f1030b4fc5b3a7f3701a42d3e3', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '9cf6f7263914bc36a163f5754b49f9f5522cbd05', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '31572afa88797decdb9ec8f810e97683ec457254', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'a530eb42abe1b8eac44d7340b1d67e9e6f828e90', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '365e735c554ad3f34c0634185ab98ed3ffcb0ced', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '69c6844b5b4f2b4422dba088e872d74eb6470432', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '731666752caf93b7167fee795cfe67017e3a92a1', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '43d41223ecde0405b2544bb3585550aef711287d', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'd09b99ea010f8b173588ffbd244943200399226a', class: "flex-fill m-0 " }, index.h("div", { key: '9b1ca5c551369624097dfad865d3b1ec72deb7b2', class: "d-flex align-rooms-start justify-content-between sm-mb-1" }, index.h("p", { key: '5fce21cafeeeeca8a46065114a703e1517e21b85', class: "m-0 p-0" }, index.h("span", { key: '9c3039d497bf8f0c03c9f12c471e36d1d28adfca', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'eb605c9738df7837b4a4f82cb4732b39b4550a37', class: "d-flex m-0 p-0 align-rooms-center room_actions_btns" }, index.h("span", { key: '089b31fa5a3512844ea521c8d2de0c0ce9863eb2', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'ce1ec258dbc2187eb547c1e9121c121d4f9b28a4', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'ae758613f6f84930ed0bcaf996452f21cfacbc18', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '8f879548cc85f6f68fe082fb172b8f90e64f286b', class: "d-flex align-rooms-center sm-mb-1" }, index.h("ir-date-view", { key: 'b6d666f6c2175ffa65908a6708012d000077bc16', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '40097f0e0650591c9c72aa118955ed0968b9447a', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '690ecf076c67a98a59fc8a03bfb27189ae25c7a8', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'fc7b4968ade654c664c0648986ef07521dcae228', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '16437c96192167a129cea6590e692e2467e08566', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '92589b6288217c9a5757d255935affc99a9ae476', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: 'ea83048d8854c797414c663f3dea8d9f9942ee16', class: 'd-flex align-items-center', style: { gap: '1rem' } }, index.h("span", { key: '8d23a191fed6c714852cc7ca703593ce8c7d5ce1' }, `${this.room.guest.first_name || ''} ${this.room.guest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-button", { btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0' }, text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) })) : (index.h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), bed && index.h("span", { key: '32a8e094517cb9fdb01ca066e79d83a9e989ac20' }, "(Preference: ", bed, ")")), index.h("div", { key: '42da4d14ace77a70a2e48ab59af5ea446dda2a12', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: 'cf8e2a5b59bdc5868990ff62004a2974a9262182', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '782110a1bf34700935abb25fb4be8a7f0f5e18ec', class: " sm-padding-top" }, index.h("p", { key: '04a77bb25244129e4ee2903c447e88ac421ac1ff', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '71a94641f203e387609603fc4283c12c8d0e7ac6', class: 'flex-fill' }, index.h("table", { key: '7873bf31e52745b8f9217c3b7ae6441e78d64a98' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '3707687f1c94efdabcff0aaf05773d4b5c4ddf95', class: '' }, index.h("th", { key: 'a9a627ba3607c3c1fe1898ada0a75f1ce034fe93', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'c664a17b99a584561512fd0e7685e0aa80eac31f', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'd90e6a26c5f1a0d2e6eeb2f0d19b79169c356666', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '7cbc87429733218a0ebf5d9bb31832d09419d13d', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '1ca7d53342082614e8f094bac176e8ac97d8f549' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'bff62ac949d8061a0f695153171667fb91f84c23', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'c7e73da84dc1b6518bd09e90702b6ade5463c7da', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '5535bfd30da0cc3242c25e2a258de1717fcb2e10' }, index.h("ir-label", { key: 'e1ac7bbc411f8823fbe277d0a1a68695602a6beb', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'bfdca833ddad62d9c52c824d542393943909d898', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: 'e2fc08520221918993997589857e072136c7795c', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
