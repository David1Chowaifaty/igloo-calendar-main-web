...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'adde60fc3614dde4365b4ac2665c95e1da90b414' }, index.h("div", { key: 'f0bea21174d8c540a0a765320598e78e43bbee86', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '9d433996b83801f5aa084bbfa6bc94d03fb2288d', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'afae50cb08d2f994d4b499fd8739afe6e15cf576', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'f03cc644d7503b5bff2b37db89c2a64666bfe836', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '843511bf5d1a84c679aa49ebdd6546754988ebdd', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '544b06a29731153625eb01d6acf63af537b793c8', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '3f351039e2c61e0956f728bdbd29ade811ccc7ad', name: "modal-title" })), index.h("div", { key: 'c5dab689a1f78e75015abee4f3e98d857cd4d3df', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '167c56d996d0a711c478f66a2b143959ca790811', name: "modal-body" })), index.h("div", { key: '32819c5ab3fc19da9e03f0a76a9415a097f8f017', class: "modal-footer" }, index.h("slot", { key: '1c5a99806e1f8b1e59669a1d4a54f26a6e81a846', name: "modal-footer" }))))));
    }
...
const IrPickup = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '71b4947185f9c8e27b4e07c256fa1b1e4799f421', class: 'p-0' }, index.h("ir-title", { key: '4765181c9556450e364357c426fd8bef203a190e', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '72743728f8b2e7b82079a5e435fae8a3c384b93f', class: 'px-1' }, index.h("ir-select", { key: '12d16b7899344d823089255dc09962e1ea7444fd', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '7c99e5d404926ac0a4af65bfc70cee104ce35e4a', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '9f056d0540f85cfc386cef1da96840da880d181f', class: 'd-flex' }, index.h("div", { key: 'ac05deffe5567e6653273e825488a70ee5ebe0dc', class: "form-group  mr-1" }, index.h("div", { key: '291e1845c9bc165e3d204ae8072564ddc2da0c44', class: "input-group row m-0" }, index.h("div", { key: '9c33a25ca097a954964c5df32f66584710d24be4', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'd3baadf77bb0d0b534e8704eaf4077b7e10bd656', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'ddebf0dd06e47f8ea4a04ea7d2d795887590a3cd', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '4edce48f18f3a10a8f65b96a08bdcae3ed99d824', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": this.cause === 'arrival_date' && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '654a11674b81226563b40ec028f47fbba3c285b3', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${this.cause === 'arrival_date' && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '2a4686fe35846d3221d4b333401d7347393a94da',
