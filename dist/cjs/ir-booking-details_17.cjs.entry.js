...
const booking_service = require('./booking.service-8a328e54.js');
...
const booking = require('./booking-0f7a50a4.js');
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1defc45c744bc8b370e5cc5db0ca5519df5e1cd3', class: 'px-0' }, index.h("ir-title", { key: 'c26a6497ec317fded8d265acc0254db82cf97512', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("form", { key: 'c2fa6aca28dfeb671129e15061c6ec673151cd79', class: 'px-1', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-textarea", { key: 'd39a49bffc5a40955c8b0bc2b6695174e30dbe32', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) }), index.h("div", { key: 'c323384502e8f2af9672287d1cdbea8698068b68', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '962bf088324704fb66c2b3c8aa32fa818bb0bc01', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '1d9a7b797816b131261f0c0a723a63ad4ee46827', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (index.h("div", { key: '7e420777f46d3950268d72f6af594ca8dc3e38d7', class: "fluid-container px-1" }, index.h("div", { key: 'fe4a7c60180294e7cc44e8073bfc892319484ba9', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '313c4832c4264a1186fdd33b42f149d613aab0ec', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: '88b9b373414a6d4b8a49c9a57ba5fed1cd4ad670', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: 'dccbdd4fb8b15c4dffad9603b6fbc1f2f46dd6f3', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '997f81412a9d95c333d408407f480f62b9324b56', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '5fc3b218b07beec4e18666e6d5dc89c876596624', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: 'b8c4d4c0a8b536ce4abf386a0f56fc662f097756', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '89c6fe5764f1e14e480c718353dd0218c12b4367', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: '9bd6c31ccf07aaa88415f651506ef55f5bb991ec', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '32b9c15192115bd58ecbbad8bf67209d923d3bc3', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: 'a4581617452245003b61418f3839742ea058f998', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '81013233d4534e60861882903b3e6a33d8bcc1b2', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '40eab89aecea7356729b47482f17789a6fbe1500', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '123ff475c032b747241c864a4087670f8993ce08', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '738092db0f501fd9ca95efb48acd129e3dc11964', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '4ecb9243d3f3d2a7c6214de386a509b27380793f', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '365d92d1ad1f0054a3ea550460ef168e0c972d8e', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '091c1dad022e01506c2193cebcee87bcde395df6', onOpenChange: e => {
                if (!e.detail) {
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3f79671811e51823e9bc3c3fb32aaddde3ab798b', class: 'p-0' }, index.h("ir-title", { key: '453c35acc59be7857d4ad139949831f022dcafcd', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '4b2b12dca006ab4e2db3c2dffe6e1a04f84e9db2', class: 'px-1' }, index.h("fieldset", { key: '4ff9d244c60abd0d10ef4ab7299a8e0e22af7dd8', class: "input-group mb-1 mt-3 service-description" }, index.h("div", { key: '897d7a14f7752a7bac3128abfa30c8a25d862aa5', class: "input-group-prepend" }, index.h("span", { key: 'f87cb983dc43afec09f052facde73ada2e7e8562', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '4c96445d3e0f407384649273b324ab88fe9219f8', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '7f8a11847439c23e19020b1c34ce2f9c6a15bb6e', class: 'row-group mb-1' }, index.h("div", { key: '79a69e4522d84057e533579bd1eeed650dc62b4c', class: "input-group" }, index.h("div", { key: 'e80c425ad3103e98e7e968c9f13fc8fd680cf794', class: "input-group-prepend" }, index.h("span", { key: 'cd25f0c5edb4c3eff4b69591d10eb25fdff76af8', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '5ec6a3a035a858fb303688d4b82bd49179cf04ac', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: 'ce8957fd24687e6dc24751fdf4d01928bca7f134', class: "service-date-container" }, index.h("ir-date-picker", { key: '5204e7fb1a9d6d486c807111ee1a6530e978fac9', date: ((_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date) ? new Date((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) : new Date(this.booking.from_date), class: `hidden-date-picker ${!((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) ? 'hidden-date s' : ''}`, autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start.format('YYYY-MM-DD') }) }), ((_f = this.s_service) === null || _f === void 0 ? void 0 : _f.start_date) && (index.h("div", { key: 'b400d9a293885d3a7664c9530481ae04dac0f368', class: "btn-container" }, index.h("ir-button", { key: 'ae9191397469b1b37c22cb667cc4d50d24ec1923', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: 'ddcfd52b7597a4c1961bfca060de05859a0ac006', class: "input-group" }, index.h("div", { key: '3acebfff0175eb35bd7a89533528b749889eb6c4', class: "input-group-prepend " }, index.h("span", { key: 'b13c9234d68d8e9c5d3d797eb01a4f8d4479788c', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'cff0397d673ea9d10ce97c27f24f676bb1d8b974', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '2718bb3e71ca09844667406323edcd4e5ab24119', class: "service-date-container" }, index.h("ir-date-picker", { key: 'd3ecea6886378c3f3d154f47d84c36ca71a1d4cc', date: ((_g = this.s_service) === null || _g === void 0 ? void 0 : _g.end_date) ? new Date((_h = this.s_service) === null || _h === void 0 ? void 0 : _h.end_date) : new Date(this.booking.to_date), class: `hidden-date-picker ${!((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? 'hidden-dates' : ''}`, autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start.format('YYYY-MM-DD') });
            } }), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '407ffaa31516fcd22a8c9b4ece1aeb18d26a02cc', class: "btn-container" }, index.h("ir-button", { key: '03231ee5d7c188a421904d6f1b577defe6a935fe', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: 'bf8b74254487d2e0dfc59c4b058dc024a8203d9a', class: 'row-group' }, index.h("ir-price-input", { key: '8b44b90e09e6de7b4321cf85610c7fd302e6eb75', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '93b6d28be1a3b99688780b0f9a4898d60142ff73', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "cost-label", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" })), index.h("div", { key: '321fe0de56ba448a5624e19fd7b5c816ee90e46d', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: 'a839f5f822887b3ad84f3064f8cedcba3d9166d0', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill mr-sm-1`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '94316a7f80c06c19f54740ad0450a733cd90e3c6', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.saveAmenity.bind(this) })))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'fceaf5a00751b9ec31fa055565d639ceaf2a829a', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cbd08b33c43237f3f07531e0ff24ed6617dc7582', class: 'p-0' }, index.h("ir-title", { key: 'a2be55b001c5dfaf289f9668b697419c54c75d2f', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '1b4e000294da863f9cb8e2b24397d15c97412f52', class: 'px-1' }, index.h("ir-select", { key: '872cc29024bd724e3519f05cbb28a57d3abc33f3', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h(index.Fragment, { key: '9ccf89b30047536e71a3070cfbce57af9b9b34cd' }, index.h("div", { key: '074da0bf06125e97b6f8395eb72d8940e7a5e4e3', class: 'd-flex' }, index.h("div", { key: 'b1b1bdbfee88c4fd0b068cb6d89ef6b98c20189c', class: "form-group  mr-1" }, index.h("div", { key: '55eb9d1d7fce699091755fa156738819d2ecc26a', class: "input-group row m-0" }, index.h("div", { key: '81a24269b5591e2d7c39b442cd562c3c7ca4406e', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'b3b2811ad2cdb1407d09376ea2171366dcc28102', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '5750fd637eda278ddf14f412ccc3e25526854764', class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, index.h("ir-date-picker", { key: '73f658246913ea4cc136933658320c0f84c94b15', minDate: moment.hooks().format('YYYY-MM-DD'), autoApply: true,
            ...
            } })))), index.h("div", { key: 'f029d9c670285860c78a7af18d367750f09ccd63', class: "form-group" }, index.h("div", { key: '7b7ac8921b3e1c55322643f331c30b1f7f1e4c36', class: "input-group  row m-0" }, index.h("div", { key: 'd1ce8452c5e7d2b0cd61731d13939e0c680d7bda', class: `input-group-prepend col-4 col-sm-3 p-0 text-dark border-0` }, index.h("label", { key: 'a623a18ab54ba0982b2a12a78d8930523d8a9e84', htmlFor: "pickup", class: `input-group-text flex-grow-1 text-dark border-theme` }, locales_store.locales.entries.Lcz_Time)), index.h("input", { key: 'ef6e3b2ea14dc010085c967a5cd8e7e808a8c2a7', type: "text", value: this.pickupData.arrival_time, id: "pickup-time", class: `form-control col-8 col-sm-4 ${this.cause === 'arrival_time' && 'border-danger'}` })))), index.h("ir-input-text", { key: '30a612be24b27cb0d5eccd7f3340031e94340960', value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", inputStyles: this.cause === 'flight_details' ? 'border-danger' : '' }), index.h("ir-select", { key: '763abd3df4465117b18a4657db5272fc5a788c9d', selectContainerStyle: "mb-1", selectStyles: this.cause === 'vehicle_type_code' ? 'border-danger' : '', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '7e49e9e97fd311b0473212f1feb1d1df8207d1c2', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '956c1812069687a824098f02aa7915ae8c7e2c81', labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectStyles: this.cause === 'number_of_vehicles' ? 'border-danger' : '', selectedValue: this.pickupData.number_of_vehicles, labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("ir-input-text", { key: 'b912336092beff9923af23e9342970d5be12d6f1', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales_store.locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" })))), index.h("div", { key: 'ba5eb3e2134ee99858df263171ecf9a3bbfaba20', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '84cd25ea5b1e8cb4d1fbc277552e137a732d1c4b', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  ${this.defaultPickupData || this.pickupData.location !== -1 ? 'mr-sm-1' : ''}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'b313f3fdd553fe38eb4ae54372b19d7d45d7a409', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.savePickup.bind(this) }))))));
    }
    get el() { return index.getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '416bf3e28899d580a735b94dca15d1fec188c64a', class: "card" }, index.h("div", { key: 'fe7a329f2e717c0deed6f0dbe999a6ea21ca971c', class: "p-1" }, index.h("p", { key: 'eb7eae49358a83840a6f33cc7d21212430e3ce2c' }, this.booking.property.name || ''), index.h("ir-label", { key: 'c131a9e900c32d9b5b7b23e403c1c4e3f288d4bf', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '70d26d042b6555ff12af8be76ec44bd83573e008', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '24c565050a11ab7d4ff12852223f211b9b74cb00', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: 'b3bcd66084388daf893bc3e453a75acf04802adc', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '924b457c8da934676760c4a6436ded80520f8297', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '69d4e44d93e61f83f494e76d45bf593045252b43', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '4a68c4cd866242b07942719cf4088b76fdc33525', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'a18785ae507efdb9c79b01f3dcb5766a6cf6d57a', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: 'd28b26a3290fdc18ee4d4f772f3caa89590c9ace', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'bd80c3dcb19cd3f5c6dbf0d24b1497c1e64e712d', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '5cfc5b28dadc3ced532d99c40d719dbdb117eb3b', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '91d533d732c36ca5ad24b81c77e1604abb643177', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: 'cc6f63bf29ac5d7ff160eae5a5e23cc25e6800db', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '09e80774929d9080746a3935426e0ed710e4b531', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'e94e37b2a717e60d668ebde2bac257fecfb482a6', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '3966aa58f9ac55b1cbe161562946142c510d363e', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'b6351fb9838ef8215a2cd27193c89b806d326b55', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'c0eac38d5358bed7000f64f6013ff02c995a6798', class: "d-flex align-items-center" }, index.h("svg", { key: 'c5ee31364177476994bee1f1b13c04eeaf22b9c6', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '3df1e9bb74a53b80c24afed99dbe5615b0bedd38', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'f453e3abe92dbd60e8f507b334c6a001e5b1beef', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '3d29cb103d6e9cfe1484aabd70c02e12cd803f5a', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: 'b7825d73df3185564830b81eed9b3943a3f5171b', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: 'cbd74bc71e43d979c13e8fff20712bc61a0b0571', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        var _a, _b, _c, _d;
        return (index.h(index.Host, { key: 'df6912a44f6220e4235aa0cc4855021424d62997', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'dd520d34512f457e1d6720c6a6bb83808035ba65', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '94ddc29b7f6203a3936162882fbe38976947e353', class: "flex-fill m-0 " }, index.h("div", { key: '712d79d3700b9ad0fe696ee9bdd84026d8dededa', class: "d-flex align-rooms-start justify-content-between sm-mb-1" }, index.h("p", { key: '81c41e4a8493ee42de99f6f08c40ecefdb0316a4', class: "m-0 p-0" }, index.h("span", { key: '06ad433f61775ac75c88e51da45f53cd09648bbd', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'c39125001655f305084f3d06117973504a411e5e', class: "d-flex m-0 p-0 align-rooms-center room_actions_btns" }, index.h("span", { key: 'f010d7ed20b005c3b7077cfeb8f9c1d2a159d019', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '1d30a0e6536e0e31307ec32133b5d9b5a9bce2d2', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'af05dd89effb41417ba6c4fe04a6ecb11b3bb2f6', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '70f76497d8128b664ce8df9d00e1416a90c372fe', class: "d-flex align-rooms-center sm-mb-1" }, index.h("ir-date-view", { key: '386925c1b66514058f546ef2d0fa6aeb8b1ef677', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '3bfb54a323c19ab1431e584023c66505de126b5d', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: 'e541ceae082e23abed64710a46f1b85de8f118e4', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'c466d6db143fb272414d9f35f19374f2b7c9fa59', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '2e89ddcfc444b8970f50589a53413ec6c4e791dd', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '0bacb8c6df26469caa0c89d2b34c388fac358b4a', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: 'd8a004f1bfeff043298ad1b67017a7feaa1bab68', class: 'd-flex align-items-center' }, index.h("span", { key: '2d5fa431c08308af2f6e5add0ca0e4be4a53adb7', class: "mr-1" }, `${((_b = this.mainGuest) === null || _b === void 0 ? void 0 : _b.first_name) || ''} ${((_c = this.mainGuest) === null || _c === void 0 ? void 0 : _c.last_name) || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-button", { btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btn_styles: "room_guest_name", text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) })) : (index.h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), this.room.bed_preference && index.h("span", { key: '682d185cdddd70e8625379d2465fed78090670c5' }, "(", this.getBedName(), ")")), index.h("div", { key: '78bdeb5d27bfda957271066d2d3049dc0ad5da14', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: 'cd89c618d3fede1606f10e8c3742686a1019dbd6', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '712068d8602043749249b3b997ba38eb87f3a7ca', class: " sm-padding-top" }, index.h("p", { key: 'b8e8467fd844ed4a0056abb5c67d9b40fcabd16c', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'ca51b090eef5475a60dbef912eb808cb01d5fe10', class: 'flex-fill' }, index.h("table", { key: '054ec0129b70bf22af129ba3bcaa2298d1eb9585' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '8f3cfbd592ce27e5fe259cf39d0595478c36f42e', class: '' }, index.h("th", { key: 'c31cac396127e1352ebf6926b29de80514b6e504', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'f5eadda87ef911bd7a3eb2f58fbce61311f44d98', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: '49431ea624f0b9e67ad90559c62bb8969b44ca53', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), this.booking.is_direct && (index.h(index.Fragment, { key: 'f256a5f79de6f43ace048421862d873d71b1db6a' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'fb885cdc0dfd5336b1f5281c012618113a973338', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '60051e97fb7cae8be31665bf350c77331c25868f', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))))), index.h("ir-modal", { key: '767a4304dd1510ca0edd20638ed59ba8c4b9101d', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
