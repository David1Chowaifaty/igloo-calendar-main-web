...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a281a659ea53924d408b032bed3aa519dc2f646c' }, index.h("div", { key: '78e09e1f30862c85b7f2b72d9c52a477b81585ef', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'a59a54fc9957a3ee5229ec42c67448d3ca05c042', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '32165ac171f4fb48e307261fcaeb793ab0b03c26', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '562ccc96d62361aff052cf88481fae7b436f377d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '3d1d51eb68706a9c30e79381be1352c4d25bfc87', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'a3633aa73016cb048181fd01dfeb7725e2dc0288', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '3baed566665da40923539604780d77b2c014f754', name: "modal-title" })), index.h("div", { key: 'b3fce31ad5f104d2bd3c6053d754a30006687f74', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'd77d76dd9cb65b2d6c6bb9c76311a7879cf47a89', name: "modal-body" })), index.h("div", { key: '51bbae46c01aef13bbbf6f0e7c0bddb535590ff8', class: "modal-footer" }, index.h("slot", { key: 'aa0374593c03dc5ca7686ab4844c46127d591941', name: "modal-footer" }))))));
    }
...
const IrPickup = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '2d0403a22e760d8165bc302f044147fdd1da0950', class: 'p-0' }, index.h("ir-title", { key: '5ef1d8da6c394d3d12711f15eac4404ca753ecde', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: 'd4759c637874c8d3be8a1444dbd031f1269a0910', class: 'px-1' }, index.h("ir-select", { key: 'b4b012c93a6b9579bd6db10f1b03bab833348c79', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h(index.Fragment, { key: 'ac1a6448c5282b815dbcb79d74b7ce727953b8e5' }, index.h("div", { key: '5a9c52bdd4626e1534df3224091e4cfc83e8d190', class: 'd-flex' }, index.h("div", { key: '618718896190fb607fc624dea2130d58593a7e89', class: "form-group  mr-1" }, index.h("div", { key: '83b5c85430c7df3bcbf4db861567cbd1617a4870', class: "input-group row m-0" }, index.h("div", { key: 'd671455e0feb38a9700dfdf78413afd4190f3ba1', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '07530de7f745d0d14ffadd6c208f2d1bdfb5f357', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '81fd21d2beb4fe40f31677c1b35a6d21eec48a0d', class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, index.h("ir-date-picker", { key: '7b6b11fd9eaff2bb626d2b31e544395a16cf600a', date: this.pickupData.arrival_date, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, minDate: utils.hooks().format('YYYY-MM-DD'),
            // customPicker={false}
            // autoApply
            ...
            } }, index.h("input", { key: 'c145d560db9c65d36285818403d1563ed7d83d54', type: "text", slot: "trigger", value: utils.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY'), class: "form-control input-sm text-center", style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' } }))))), index.h("div", { key: 'ba17b52024a8fc478149863b48d7d2e5bfea4fdc', class: "form-group" }, index.h("div", { key: 'af2cce615401e45877670e6741810fd8e7f7946d', class: "input-group  row m-0" }, index.h("div", { key: '4bb48ec8a280e6c8f3f6ac1e1efeadabd4f9217c', class: `input-group-prepend col-4 col-sm-3 p-0 text-dark border-0` }, index.h("label", { key: '6d14ac53e2cc14d43cb814da33c7d3717b64b853', htmlFor: "pickup", class: `input-group-text flex-grow-1 text-dark border-theme` }, locales_store.locales.entries.Lcz_Time)), index.h("input", { key: 'ead5d7f55242ac1a0be91332ebf911583c944303', type: "text", value: this.pickupData.arrival_time, id: "pickup-time", class: `form-control col-8 col-sm-4 ${this.cause === 'arrival_time' && 'border-danger'}` })))), index.h("ir-input-text", { key: 'fd66c6e7afe413bf9208ffcb218e2367c8e7f8d7', value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", inputStyles: this.cause === 'flight_details' ? 'border-danger' : '' }), index.h("ir-select", { key: '99cd9a305e3e44fc59e7e328ff17f3f0a4c3c08a', selectContainerStyle: "mb-1", selectStyles: this.cause === 'vehicle_type_code' ? 'border-danger' : '', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'cddb6c4158f1c542ffad7ce07badf9e5802b7e6b', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'c3a8c6423055bb69d83a49f5f9d95d59377ea18f', labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectStyles: this.cause === 'number_of_vehicles' ? 'border-danger' : '', selectedValue: this.pickupData.number_of_vehicles, labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("ir-input-text", { key: 'b70be23eef7ead740bf005fd5872a0c2c6af7c30', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales_store.locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" })))), index.h("div", { key: 'f42f6a454fe6c7ab6326318fa6d637443a0a3b81', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '8886a428b4051c0faf07ac4f201304a34d70e286', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  ${this.defaultPickupData || this.pickupData.location !== -1 ? 'mr-sm-1' : ''}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'f7d2772458c8ece44b55a15516599997caf938f3', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.savePickup.bind(this) }))))));
    }
    get el() { return index.getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '133fb2daa01b9c3973dfa5ee0fac6c4f8af34ec7', class: "card" }, index.h("div", { key: '1761488eebac0e7891afdd9b63568ba8250ab6d7', class: "p-1" }, index.h("p", { key: '7c122de0a074b622eef7dc7bbbff066a5f784ff2' }, this.booking.property.name || ''), index.h("ir-label", { key: '74c3268c8184651689125689ead50a4a342abf7d', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '4766f158323bfa5633505b14bc8f3554eec7be14', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '74c028d0adb2212eced5de7da29e3b67639a785b', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: 'c40102fad856e8a0934e80c7a72b4adcfcc95ec0', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '91ef072827218893366a424c9491b86b6046f00a', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '6f01167bafc8bee7ca86cb792589e52137bf3499', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: 'dffbd3868983d45940cada50748f74ca0305ff84', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '73c416f7fafe52d345d4321940e441b8e8f9c878', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '6223734cd030be099f072d9d4d629ce236a55a45', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '2c7bd9281313d9981a18987e0a07538c59620fc9', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '0497ff7252e8ee31c2a108a3cc8a0d1b4c398778', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'e8eda55c9a53690fc9b3e91a48a72a9af4cd3d9d', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '1e2c8c96f8a320c6f6aa37b8ed3c999ea4b6ae71', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '6e6a71072e6eee2a0da684c0728f6d7e648e2a36', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '2e5e84d51c934c8b7f3a7fed3aac5dd57332fc00', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '4d8fd7fe2179dc3c610c367a0036ac0ea63e55da', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'c7bdc958f667754595b7730c4fecfd0f41a5baa2', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'c7e238b18774de2d52e7e8baf1e51b4f411c855f', class: "d-flex align-items-center" }, index.h("svg", { key: 'f5edbc1bdd2f4cc0943ef0913e54cb73d4e11920', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'c71c78ec7f8653fb84a58d7086b91e82edc8afb9', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'ed2c090bb79cfae33e09666499c0153878f0124e', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'c2fcda7d763697cb28d880a8f8420c35345a59c4', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: 'b55b087d2f23b92641b8d734fde6e1f9b214071f', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '7f59da2879e44018c83b90f033048826ca71397e', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        var _a, _b, _c, _d;
        return (index.h(index.Host, { key: '98e723bad75da5367db19a9f5a1c38128282e874', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '739a27992ec8fd788b8acdaafffb071162c03061', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '0d6d6afbd24432751d3808bcdb71ff9dc271a07b', class: "flex-fill m-0 " }, index.h("div", { key: 'ff67241691210cec166d6e72952226acf94c0d10', class: "d-flex align-rooms-start justify-content-between sm-mb-1" }, index.h("p", { key: '0cca58757a55f0f7ea601c09d37de121f984e16d', class: "m-0 p-0" }, index.h("span", { key: 'a87ca01b0dbf49bc212c3cd7a634acc5847bb6bd', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'cb13e089585ce3f26bca140d80dc5d015dc99d2d', class: "d-flex m-0 p-0 align-rooms-center room_actions_btns" }, index.h("span", { key: '4afe7d066e38fb2d01047baa95d39216c7ee6e85', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'dc0ea0ba1df1bf19a4330b36bee93d3ade5e0a1a', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '6c82931e1577418d4b60d8ea0ae5bf2dfe784170', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '9f7550f87d173bc010422223a90b928674800ef4', class: "d-flex align-rooms-center sm-mb-1" }, index.h("ir-date-view", { key: 'adab00d3b48aae4fec813845ad5ea64b7b5718e0', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '9f0bfd9e3f66cb717c381e1fffd3454b8ebebb0c', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '3c95d8cc93784f5b9852af916138b628def2ce97', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'f82d7bef5781eb9200117afe40c06b069c1b431a', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: 'b1acf26e6d245cd81674a88cde3f82145c82eae3', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '7b051a6b895cbf23a24a21fcaced882ac41cc85d', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '0b244ef29c3bce26cc2b24d75680dd443783cdd0', class: 'd-flex align-items-center' }, index.h("span", { key: 'bb509ee75e40b48a2a3c77fc5c58491b0b19ca46', class: "mr-1" }, `${((_b = this.mainGuest) === null || _b === void 0 ? void 0 : _b.first_name) || ''} ${((_c = this.mainGuest) === null || _c === void 0 ? void 0 : _c.last_name) || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-button", { btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btn_styles: "room_guest_name", text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) })) : (index.h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), this.room.bed_preference && index.h("span", { key: '6284b11274ecd835cce38f4d0ed2163274cb6b43' }, "(", this.getBedName(), ")")), index.h("div", { key: '474f1a87aa50541880d4c1774c89df665c1c125a', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: '503dfce346b12e718a1040e24a1f20ff9efe6cd4', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '2f2e3eef2a4357eebddf75f103284cbcdb9d51f1', class: " sm-padding-top" }, index.h("p", { key: '7d055302418f9974e9f3f375ce611603baf59da1', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '987d85d8692dbe31550356854c1185275a09bffb', class: 'flex-fill' }, index.h("table", { key: 'fcd67ac9d5e9aeb73fe9005eac26b3b433eb96ec' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '996646c47d63f8eb69a65569ba8681797e3f0865', class: '' }, index.h("th", { key: '8db575e1ff9888a27ba49662c8046d2f5d9fc95d', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '805fc4efc6aa4a503d58a97f6fa44783bc7dfa4b', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'e661c0b1f6817d38625707162a62136f62779e8e', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), this.booking.is_direct && (index.h(index.Fragment, { key: 'a6ed9957cb94902d4f281a5c766dc18a80abaa88' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'e5e1c4a049430c586c099ba4e97887d5e894c32e', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '7b7668be6aaabdaa5c41c5e24402a12c2d02cbd7', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))))), index.h("ir-modal", { key: '8eaf20ee805196ec1b01c7752149292147a5f3d3', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
