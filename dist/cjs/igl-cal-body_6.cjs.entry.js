...
const toBeAssigned_service = require('./toBeAssigned.service-50dd8cfd.js');
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '178733e2f7648a2e5f7692c58e5898e9cff8a8a2', class: "footerContainer" }, index.h("div", { key: '736bdf25b566dbc7b773a203f9e01e13182240b8', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: 'c093f37a2be3a0bb315062533b71d0b7af47bd46', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: '2e72d84d898ea69b38bd6cd03fa616cdb860b2b3', class: "la la-square" }), index.h("u", { key: '900ac489e6f098a6f7d310f172a40164f4d3a6ef' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '7bdb3c4a38084a496c1df16d66c961bf2c467e0d' }, " - v16"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4b18691dde3992c38a93f4f6cb56362c9cda33b4' }, index.h("div", { key: '725cd3a8b0380e11f2ee240bb9281a34b148e085', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'c497c8c9f0466d4075cc90fad2fa2c74977696e2', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "caledarBtns", onClick: () => this.handleOptionEvent('showAssigned'), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", class: "svg-icon" }, index.h("path", { fill: "#6b6f82", d: "M448 160H320V128H448v32zM48 64C21.5 64 0 85.5 0 112v64c0 26.5 21.5 48 48 48H464c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48H48zM448 352v32H192V352H448zM48 288c-26.5 0-48 21.5-48 48v64c0 26.5 21.5 48 48 48H464c26.5 0 48-21.5 48-48V336c0-26.5-21.5-48-48-48H48z" })))), index.h("div", { key: '47ff519b76e73f4bf387c31c17223247126caee8', class: "caledarBtns", onClick: () => this.handleOptionEvent('calendar'), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Navigate }, index.h("svg", { key: 'a74ee92d5520a631d73b2d3af7ff9ce0e77221eb', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", class: 'svg-icon' }, index.h("path", { key: '378f270bf232b73e74a55055a5a631f2c0cfb466', fill: "#6b6f82", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), index.h("ir-date-picker", { key: '6c038c62f3cd01e780c842e620edfbc969233308', minDate: utils.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), autoApply: true, singleDatePicker: true, onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, class: "datePickerHidden" })), index.h("div", { key: 'b6f677baf6d72293cb86aae0bddc1e66ed4bd4d8', class: "caledarBtns", onClick: () => this.handleOptionEvent('gotoToday'), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today }, index.h("svg", { key: 'cfbca7678f7025dbca7b6246961b1ef2b6b38729', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", class: "svg-icon" }, index.h("path", { key: 'bcac5258c80ba56792064d47eb3fc0c6af0fc677', fill: "#6b6f82", d: "M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" }))), index.h("div", { key: 'a76b5452bf5976799a40ea343c314b5c49d24c72', class: "caledarBtns", onClick: () => this.handleOptionEvent('add', this.getNewBookingModel()), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_CreateNewBooking }, index.h("svg", { key: 'df33a5106b558132ee13c2f573aa547b2b518c25', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", class: "svg-icon" }, index.h("path", { key: '6be8239908fe65006eecd7cf66175fa777520a28', fill: "#6b6f82", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))), index.h("div", { key: '52a57091046eb2bc9ba9af770ea481c6954fb8a2', class: "row justify-content-around no-gutters searchContiner" }, index.h("fieldset", { key: 'fbf34190c52fe4dd501dbf3077d8c4ec7d0d0d12', class: `form-group position-relative ${this.searchValue != '' ? 'show' : ''}` }, index.h("input", { key: '447b92387198ee66e631e2ed3dd0885dc093d359', type: "text", class: "form-control form-control-sm input-sm", id: "iconLeft7", value: this.searchValue, placeholder: locales_store.locales.entries.Lcz_FindUnit, onInput: event => this.handleFilterRooms(event) }), this.searchValue !== '' ? (index.h("div", { class: "form-control-position pointer", onClick: () => this.handleClearSearch(), "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Clear Selection" }, index.h("i", { class: "la la-close font-small-4" }))) : null, this.searchList.length ? (index.h("div", { class: "position-absolute searchListContainer dropdown-menu dropdown-menu-left min-width-full" }, this.searchList.map(room => (index.h("div", { class: "searchListItem1 dropdown-item px-1 text-left pointer", onClick: () => this.handleScrollToRoom(room.id) }, room.name))))) : null))), index.h("div", { key: '9770cd22d366494ee30d80f8f57db52480201551', class: "stickyCell headersContainer" }, index.h("div", { key: '931d649970740f12815ed4d26fd01914203f6851', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 70 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '03c6388fb05feb12ed4231f0397b384d40f7fbf1', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '296f50a891a18a1b26513f5e7768f01021927481', class: 'w-full' }, index.h("div", { key: 'd9902c78c380a58611827b70d15a61edd59a79f0', class: 'w-full' }, index.h("div", { key: 'e4ff8dcd48f9b89201553b6090bc1c1182cdcaf4', class: "stickyHeader pt-1 " }, index.h("p", { key: '31237556aeac24946d42e27d24fced250b5b75df', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '63070b998141d30e611aacb783004e8423052ff1', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '9fb10f55a1885e8dce15e444becedae0931198d8', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '7023bfae94f15e484e49d15380ea19d714edaec1', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: 'ab708dcf3bc15c0385332d0ca324a7039ee697f6' })), index.h("div", { key: '040fcd2a1ef8564317ad5d2839cfe1b0351756f4', class: "mt-2 pl-1" }, this.legendData.map(legendInfo => (index.h("div", { class: "legendRow " }, index.h("div", { class: `legend_${legendInfo.design} mr-1`, style: { backgroundColor: legendInfo.color } }), index.h("span", { class: "font-small-3" }, legendInfo.name))))), index.h("hr", { key: 'b2cbbbe5f7975b504a3130616fd89fede10b9598' }), index.h("div", { key: '4878ae7fb62b228f3cc72284fd2c2ced21a62d3f', class: "mt-2" }, index.h("div", { key: 'ae4d1eb4e1624544f893243920082605c4e4b7d8', class: "legendCalendar" }, index.h("div", { key: 'ab322917954d1f71c9f47716b020c1608da77540', class: "legendRow align-items-center" }, index.h("div", { key: '41db285503591adc33fb389b17c09430c62f275e', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '19918594fdb715a35356fa0890641b376d9ca8a9' }, "MAR 2022")), index.h("div", { key: '825af840b94aeb3d644b7f75ac773344a8d8ff3b', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '8bc876a9e63346ed734d1e8271a7668f867cb2de', class: "legendRow" }, index.h("div", { key: '2943ea3f0878bcd8202e028ab8e4495c3d6753b0', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'd35d769ad56e87072befab02c5e4da31dc5d9a50', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '6c143daab2bae4c4cfec846d8cf26e7e3bc10e52', class: "highphenLegend" }, index.h("div", { key: '9e2cd25e661e843dc50dae8b4d5b2bbc1ce17052' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '27b35827e251a2aa8585b0c36d1034b34b4bd1ec', class: "legendRow" }, index.h("div", { key: 'ab11c17088c22ea86de99262477adaa99b87fb21', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '9959481e5d1f5d89e90caac5b3d71b007b568b73', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'c47b1060f1038e57a2e9ce27dcf0a57736b9491b', class: "legendRow" }, index.h("div", { key: '6206ca62c9f6afbbb904acbf7eaa4b0c603fabe6', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'e016d2c232e6a0466b8734afa6db081627a3a74f', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '1cf8b8680d3ed599044effc195243273148f3d32', class: "legendRow" }, index.h("div", { key: '182a1f8cf5acc4bb307f125ddb8a6f2d21800a23', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'f339a5838483c6530f898925f71366542fe4beb2', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
