...
const toBeAssigned_service = require('./toBeAssigned.service-90c0a2ba.js');
...
const booking_service = require('./booking.service-ecef2d8c.js');
...
const IglCalBody = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e201cf91fb2f0b51a00705d8068082dd562ef084' }, index.h("div", { key: '0db536f1ca3d22e610841bf03c7800985cdf1790', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '5de73be925c2307d2e30bd592d1aa80fe3d8846e', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => (index.h("igl-booking-event", { language: this.language, is_vacation_rental: this.calendarData.is_vacation_rental, countryNodeList: this.countryNodeList, currency: this.currency, "data-component-id": bookingEvent.ID, bookingEvent: bookingEvent, allBookingEvents: this.getBookingData() })))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ecc210c2700b23da0e19a1eb8df4151d83e2859b' }, index.h("div", { key: '2c3c814f5d1b1dd13ec089c6a59946655e1e4ed0', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '280a70ee0a33e9904045783e7c8044a6edd7eec3', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '0bc3a3955a0df872e81b7018b6e796e0c212270e', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: '7ba6e63c7c721e738bfb4773c4096fd18c91ec87', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
