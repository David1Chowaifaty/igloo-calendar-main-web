...
const toBeAssigned_service = require('./toBeAssigned.service-5fc24712.js');
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd5de73127a595e42ec87166408841bc25f7c0f69', class: "footerContainer" }, index.h("div", { key: '7032a2997ac0933084517f2456cbc6d026e096f3', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: 'a77ed7e8ad6cdc0e1634fcebf6f24f754827e140', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: 'b5bed3a2f460acab1c1d7bed282ed245fd513fdc', class: "la la-square" }), index.h("u", { key: '1c39bd446bbc7d7080cb709ff89866676f6394f3' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '0b1603e1e144b8e5881775aab2b1637c1154d0a1' }, " - v93"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ac15a260afe88a456a880107af2cd98596d2f4f' }, index.h("div", { key: '4684166d89085535812e51aa25e673c54e22b172', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '5721900b224caadfc914d5e54265e3c974a43c48', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '443e57fa42f74d91f6e4eb74f9bef2647ebebf15', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHanlder: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-button", { key: 'f87ab4855c5db9077981487d200ab4abd6803c9f', btn_styles: "caledarBtns", class: 'date_btn', variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Navigate, onClickHanlder: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true }, index.h("ir-date-picker", { key: '6caf1177c6d48c660f7dd945f00103454072c3c9', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), autoApply: true, singleDatePicker: true, onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, class: "datePickerHidden" })), index.h("ir-button", { key: '3e8347913af9a41a757ad98a080d301e0dc428e0', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHanlder: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: '9b9690b8ef0b4e0ac58279674ee30d092ebdfac8', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHanlder: () => this.handleOptionEvent('add', this.getNewBookingModel()) })), index.h("div", { key: 'c211bc47c40ac529b669ee83b48aa1b00d5faceb', class: "row justify-content-around no-gutters searchContiner" }, index.h("fieldset", { key: '3d99cf01813084bee7fa29815a5d20640145ae5e', class: `form-group position-relative ${this.searchValue != '' ? 'show' : ''}` }, index.h("input", { key: '13d8cd38ce920cba9b2e5e903821674c8698748d', type: "text", class: "form-control form-control-sm input-sm", id: "iconLeft7", value: this.searchValue, placeholder: locales_store.locales.entries.Lcz_FindUnit, onInput: event => this.handleFilterRooms(event) }), this.searchValue !== '' ? (index.h("div", { class: "form-control-position pointer", onClick: () => this.handleClearSearch(), "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Clear Selection" }, index.h("i", { class: "la la-close font-small-4" }))) : null, this.searchList.length ? (index.h("div", { class: "position-absolute searchListContainer dropdown-menu dropdown-menu-left min-width-full" }, this.searchList.map(room => (index.h("div", { class: "searchListItem1 dropdown-item px-1 text-left pointer", onClick: () => this.handleScrollToRoom(room.id) }, room.name))))) : null))), index.h("div", { key: '6404d663f49faf2e3608f7abc5b741bf788e51cb', class: "stickyCell headersContainer" }, index.h("div", { key: '515339a3eea16d9719197fa3ac9d3c1786d040e9', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
