...
const booking_service = require('./booking.service-c124b3ce.js');
const locales_store = require('./locales.store-4301bbe8.js');
const toBeAssigned_service = require('./toBeAssigned.service-ccc4bbe6.js');
...
const IglCalBody = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3be004284cd76f677ae4b688fb1f0077eab3a547' }, index.h("div", { key: '132fa043058ae62718f699fb109cc5bf60acef2e', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'feb4e8f31d0e789a725fb067c00015a6d37d6ef7', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => (index.h("igl-booking-event", { language: this.language, is_vacation_rental: this.calendarData.is_vacation_rental, countryNodeList: this.countryNodeList, currency: this.currency, "data-component-id": bookingEvent.ID, bookingEvent: bookingEvent, allBookingEvents: this.getBookingData() })))))));
    }
};
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '46860340c544f1af363f306d89bb59f5349e49c6', class: "footerContainer" }, index.h("div", { key: 'eadc965038760babfdd6cb79738cf764c6e827ba', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: 'b1c689e2a57854a862f49bd725b66533387e4d45', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: '8fc4ddb6c1a0d65701dd6502caf40776039c72fa', class: "la la-square" }), index.h("u", { key: 'a74c0f74c5e62a60947112f6fd9e5ce811628576' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: 'ca640c569a0b9987abc255b4c82ceb928b3bd5f8' }, " - v99.15"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd4f5a5f776f9f2157fa52127819787126784c1ed' }, index.h("div", { key: 'd889af968abfb2265642e8aa632be10bd086837f', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'b7133416a0915d335490278b9dec57cbab1f2158', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '59229389966618e7941ffd6ee971ab4189114640', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-button", { key: '57ba0ee6a87a8e7257169aa935bedfd0488f4f61', btn_styles: "caledarBtns", class: 'date_btn', variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Navigate, onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true }, index.h("ir-date-picker", { key: '2946abc0acd475f07c00c82486eff0ad8a02ad15', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), autoApply: true, singleDatePicker: true, onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, class: "datePickerHidden" })), index.h("ir-button", { key: 'eba799e906c3fe9516fdce32c6b747582155d0d3', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: '4fca42012079726733157d97288a1f04a91a5923', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) })), index.h("div", { key: '6500535e0bca986679f2fe195b2aee664489cbff', class: "row justify-content-around no-gutters searchContiner" }, index.h("fieldset", { key: '12dced826cf365ffd104084dd9a722b56a17cf17', class: `form-group position-relative ${this.searchValue != '' ? 'show' : ''}` }, index.h("input", { key: '1416e01f3118a78fae50ebc998930d2d1115e92c', type: "text", class: "form-control form-control-sm input-sm", id: "iconLeft7", value: this.searchValue, placeholder: locales_store.locales.entries.Lcz_FindUnit, onInput: event => this.handleFilterRooms(event) }), this.searchValue !== '' ? (index.h("div", { class: "form-control-position pointer", onClick: () => this.handleClearSearch(), "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Clear Selection" }, index.h("i", { class: "la la-close font-small-4" }))) : null, this.searchList.length ? (index.h("div", { class: "position-absolute searchListContainer dropdown-menu dropdown-menu-left min-width-full" }, this.searchList.map(room => (index.h("div", { class: "searchListItem1 dropdown-item px-1 text-left pointer", onClick: () => this.handleScrollToRoom(room.id) }, room.name))))) : null))), index.h("div", { key: '9504e79ce0622625d3f388346a05fad4278662ee', class: "stickyCell headersContainer" }, index.h("div", { key: '9d75a96c9ffa4c110762bee55d6e5ff9a9698a39', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cd1ce037d45cfa2621c52bf3530266d462b19bab', class: "legendContainer pr-1 text-left" }, index.h("div", { key: 'cbcf33535ddeaab4bfa26d4f859fb4417647c37a', class: 'w-full' }, index.h("div", { key: '9444092aa3e9c9efa0f97edc2f85c7f54c063c88', class: 'w-full' }, index.h("div", { key: 'f13eb8c439ba64731af58d23dad4e70ecf0b3003', class: "stickyHeader pt-1 " }, index.h("p", { key: 'f31e11aa43cefd8ba00345b02c2bb9536c990c14', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '5e71fef2e9725fea8480b1c72455739032c43666', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: 'dcdb5ffdeee2466f3cb5efe001df409366f99b69', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '5099c2dad4cdfb001780591c9f3d99367d125667', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: 'aa6e6a8c2e643ee3902503194a5f0ada5b052468' })), index.h("div", { key: '823c4bf38acf5557c8ffab5ce311c6aba5e4bfa7', class: "mt-2 pl-1" }, this.legendData.map(legendInfo => (index.h("div", { class: "legendRow " }, index.h("div", { class: `legend_${legendInfo.design} mr-1`, style: { backgroundColor: legendInfo.color } }), index.h("span", { class: "font-small-3" }, legendInfo.name))))), index.h("hr", { key: 'a59d39e146c3a50b13902ff7ca9c906774cf6004' }), index.h("div", { key: '0f5d9b45ace3b886a3d513b7b5dcab851cce6069', class: "mt-2" }, index.h("div", { key: '0cc83a943e07eafa4fe0cbbbffc0f409c3551063', class: "legendCalendar" }, index.h("div", { key: 'b2c3d84094efec784361c18c25c3bf548a8f81f2', class: "legendRow align-items-center" }, index.h("div", { key: '1a63340d81abd4896ee134520be4d4954502969a', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'c1947700837ac9d4130a6d33413c1f3767192c1a' }, "MAR 2022")), index.h("div", { key: '23be3f08cdb8bb17619b75e789d5082a78f2dbf8', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '6de24cd9d3a59b742f04426c18373008811cef39', class: "legendRow" }, index.h("div", { key: '75a19f789a270beea39cc8b5e1c49351436b6f68', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: '47b04988084194cb6fb45c11beb5381ea5a5ae47', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '42754444adad17cc9692c3d6df6caf1a3e9aabd6', class: "highphenLegend" }, index.h("div", { key: 'fb2dc0dde56d598e83ee5a76146c508a58888407' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '83624b5fcd30adfacde9d21a10f147a22e58867e', class: "legendRow" }, index.h("div", { key: 'e24303aad5a2e5861d2ebb45ac39201e7a09a564', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'b0d8cd58610dd9763c1d9e8993ea1f4eebc0fbc3', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'd802e33f9848eaab658093501a9e15c07e9f9747', class: "legendRow" }, index.h("div", { key: 'b725ad06a2a414c4a590826dfe68a7bc0d28522c', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '2ec005b55f7ffa5b439c9c4b5b60438fad5a0a05', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '104e7a17b7b9baf6a90821901a86ea7867a44c30', class: "legendRow" }, index.h("div", { key: 'ad3e7a2de4d5ebcff6e8a212a78c3c57de8af8a9', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '29fc955c1fe2776ef29e2d4e93ad20e3be184392', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
