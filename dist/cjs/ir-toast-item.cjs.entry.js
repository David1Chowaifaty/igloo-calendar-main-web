...
const IrToastItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '69ceead0a5b8d7b4e197215cd5bcea9315926279', style: { '--accent-color': `var(--wa-color-${this.variant}-fill-loud)` } }, index.h("div", { key: 'cfcf04b5fca00eb4c0f5dbe71c558cdb1ad1be60', class: 'toast-item', onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave }, index.h("div", { key: '30bc284fe69d4265f1af3f80098a53394e1c5aa5', part: "accent", class: "accent" }), index.h("div", { key: '4912a43db2ea1d40d7fbd65fc0a6cf1d937f1dea', part: "icon", class: "icon" }, index.h("slot", { key: '267c7a7b942b8df74e4b37fe7916972ec51a95d7', name: "icon" })), index.h("div", { key: 'a05ed05a84ed589214a14d9de8811fc0348c7b23', part: "content", class: "content" }, index.h("slot", { key: 'c87a05d7ab90dc194885f73bc8429b9b2fe84d93' })), index.h("button", { key: 'a43fdba882aa53c7ae56ef801ddd3119ea87d6b8', part: "close-button", class: "close-button", type: "button", "aria-label": "Close", onClick: this.handleClose }, index.h("wa-progress-ring", { key: 'c59d183521e93edf31e5654971bc341113b97041', part: "progress-ring", exportparts: "\n              base:progress-ring__base,\n              label:progress-ring__label,\n              track:progress-ring__track,\n              indicator:progress-ring__indicator\n            ", value: this.progress }, index.h("wa-icon", { key: 'e0fc53403f06eb3e4cb03fd264a5e85a6651aaa9', part: "close-icon", exportparts: "svg:close-icon__svg", name: "xmark", library: "system", variant: "solid", "aria-hidden": "true" }))))));
    }
};
