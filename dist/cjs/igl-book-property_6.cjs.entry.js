...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '1b73682a2f562aa53c988869323c0e655628c732' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), index$1.h("div", { key: 'afec1a23b8281281392c99ce3997675e1adaafcc', class: `fd-book-property__header-container` }, showSourceNode && this.getSourceNode(), index$1.h("igl-date-range", { key: '07278a34f8e8865fd4456a9142b58101d5a4075d', "data-testid": "date_picker", variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange }), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints(), index$1.h("ir-custom-button", { key: 'efaa2c7a7562a1b78b3b635b42e51b9990c0a661', loading: irInterceptor_store.isRequestPending('/Check_Availability'), variant: "brand", onClickHandler: () => this.handleButtonClicked() }, locales_store.locales.entries.Lcz_Check)), index$1.h("p", { key: 'b35046f935132e98d4e6368d8c8c0f9099451515', class: "text-right message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingForm = class {
    ...
    render() {
        return (index$1.h("form", { key: 'cd1e8e0c9df0ac776b90873975286b85d20cadd0', class: "d-flex flex-column h-100", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
            } }, index$1.h("div", { key: 'a19cc3ac1f63f17ca6d748cb281826aa9eb24d04', class: "d-flex flex-wrap" }, index$1.h("ir-date-view", { key: '9ad3fcaac8ab05e8c544e7b6189f4848e7b1074a', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index$1.h("div", { key: '169ecd6e0d8f8c83f7cd8f1295f70e24e5b5babb', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index$1.h("span", { key: '858166579d584a1f0771f213ff459b131b5d1cb9', class: "font-weight-bold font-medium-1" }, booking.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'fcdad996f336d638bec16736caf5648df0a99979' }, index$1.h("div", { key: '734d7baac0bafe320b89e36f2857815c29e850a0', class: "text-left mt-3" }, index$1.h("div", { key: '9eb7e0811d9441a3804f4aa41957d30cc3af807c', class: "d-flex", style: { alignItems: 'flex-end', gap: '0.5rem' } }, index$1.h("ir-picker", { key: '615059746d28869bb513e5fff00fa4e73ece82d7', class: "bookedByEmailContainer m-0 p-0", label: locales_store.locales.entries.Lcz_BookedBy, value: this.bookedByData.email, ref: el => (this.pickerRef = el), "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.email !== '' && booking.validateEmail(this.bookedByData.email))), withClear: true, "onText-change": event => this.fetchGuests(event.detail), debounce: 300, "onInput-picker-blurred": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
        ...
        })), index$1.h("div", { key: '02732e39091b463b87cb9c327b6902a329a68729', style: { paddingBottom: '0.5rem' } }, index$1.h("wa-tooltip", { key: '091ab4367d0bc84f455cae3d00d9af77ab1cabe1', for: `main_guest-search-tooltip` }, "Leave empty if email is unavailable"), index$1.h("wa-icon", { key: '331280d096ee093bbf4873cc2bf8f27b30a76954', name: "circle-info", id: `main_guest-search-tooltip` })))), index$1.h("div", { key: '5c9bc704f9fa73cf2dce8a43bc7627a24979bb93', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index$1.h("div", { key: '4b4f75cecf62ece573ada8be873f05a10d188201', class: "d-flex flex-column flex-md-row  justify-content-md-between ", style: { gap: '1rem' } }, index$1.h("div", { key: '4c9c0f11cee81e7d7987583914f5a4e986d5c327', class: "fd-property-booked-by__guest-form " }, index$1.h("ir-validator", { key: '8ddeee99589e15bc7b1ca96a3ef650242d421b56', value: this.bookedByData.firstName, schema: index.BookingGuestSchema.shape.first_name }, index$1.h("ir-input", { key: '1435d1137db1cc3686cd65c29121c521a176e699', "onText-change": event => {
                this.updateGuest({ first_name: event.detail });
                this.handleDataChange('firstName', { target: { value: event.detail.trim() } });
            }, defaultValue: this.bookedByData.firstName, value: this.bookedByData.firstName, label: locales_store.locales.entries.Lcz_FirstName, placeholder: locales_store.locales.entries.Lcz_FirstName, required: true, name: "last_name_custom", autocomplete: "family-name" })), index$1.h("ir-validator", { key: '600913c4b8fe80ea8f30e90dddb8956e2e71fba9', value: this.bookedByData.lastName, schema: index.BookingGuestSchema.shape.last_name }, index$1.h("ir-input", { key: '80da6af55aaa2a817861c3dce66b24c8a0bb6477', "onText-change": event => {
                this.updateGuest({ last_name: event.detail });
                this.handleDataChange('lastName', { target: { value: event.detail.trim() } });
            }, name: "first_name_custom", autocomplete: "given-name", defaultValue: this.bookedByData.lastName, value: this.bookedByData.lastName, label: locales_store.locales.entries.Lcz_LastName, placeholder: locales_store.locales.entries.Lcz_LastName, required: true })), index$1.h("ir-country-picker", { key: 'bffa2947747c32566031bd8a5400a93d397c7564', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) }), index$1.h("ir-mobile-input", { key: '038a2454bc6321a9ec0ce9a341418bd8ed69f95c', size: "small", "onMobile-input-change": e => {
            ...
            // required
            countryCode: this.countries.find(c => c.phone_prefix === this.bookedByData.isdCode)?.code, countries: this.countries }), index$1.h("wa-select", { key: '230daefb74438452eaf00ec7b8b688db22074d51', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", "aria-disabled": String(Boolean(this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '')), id: v4.v4(), defaultValue: this.arrivalTimeList[0].CODE_NAME, value: this.bookedByData.selectedArrivalTime.code, onchange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index$1.h("wa-option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))), index$1.h("div", { key: 'd40539969b1d8dfdfea09eba47b09e0cbb199750', class: "p-0 flex-fill  ml-md-3 d-flex flex-column", style: { gap: '0.5rem' } }, index$1.h("wa-textarea", { key: 'cc8e1d1ba939f332341055661e3eb7082af42d00', onchange: event => this.handleDataChange('message', event), size: "small", value: this.bookedByData.message, defaultValue: this.bookedByData.message, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 4 }), this.paymentMethods.length > 1 && (index$1.h("wa-select", { key: 'b5631dfe2f5d44c325a3d5a07f4905a5c42a84e8', label: 'Payment Method', size: "small", value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index$1.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index$1.h(index$1.Fragment, { key: '345800f8ad4d3485154c1229c44953c90780b848' }, index$1.h("ir-input", { key: '8a524826ad185cd31ec13512b18db2d35ae87642', value: this.bookedByData.cardNumber, defaultValue: this.bookedByData.cardNumber, "onText-change": e => this.handleCreditCardDataChange('cardNumber', e.detail.trim()), label: locales_store.locales.entries.Lcz_CardNumber }), index$1.h("ir-input", { key: '3edec98fff6d99ff87dc37dff59c6f3be13feeab', value: this.bookedByData.cardHolderName, defaultValue: this.bookedByData.cardHolderName, "onText-change": e => this.handleCreditCardDataChange('cardHolderName', e.detail.trim()), label: locales_store.locales.entries.Lcz_CardHolderName }), index$1.h("ir-input", { key: '15a1d91ab39b49bba9c3a6ec2d567c130850b5ff', "onText-change": e => {
            ...
            }, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index$1.h("div", { key: '6c6ad7aacfd7811f7ad8bfd3ecc59507585b4b97', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index$1.h("label", { key: 'ff96b85561f457fbd55851ea175d3e7bc608acb9', class: "p-0 m-0 margin3" }), index$1.h("div", { key: '4ccd0ee48e07c15a56fdc245745f9b9b706bdd24', class: "p-0 m-0  controlContainer flex-fill" }, index$1.h("div", { key: 'fcdf77605ac14d868d16c1a6a612ee0c1e9b4af9', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), index$1.h("wa-checkbox", { key: '5ba31fd3321d238aa48f5cb8a1905da5ef476474', checked: this.bookedByData.emailGuest, onchange: event => this.handleDataChange('emailGuest', event) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
