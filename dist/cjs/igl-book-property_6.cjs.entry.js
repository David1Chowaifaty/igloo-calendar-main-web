    ...
    generateDailyRates(rate_plan, i) {
        ...
        if (rate_plan.guest[i].infant_nbr > 0 && !rate_plan.is_amount_modified) {
            if (!this.variationService) {
                this.variationService = new index.VariationService();
            }
...
const IglBookProperty = class {
    constructor(hostRef) {
        ...
        this.closeBookingWindow = index$1.createEvent(this, "closeBookingWindow", 7);
        this.blockedCreated = index$1.createEvent(this, "blockedCreated", 7);
        this.resetBookingEvt = index$1.createEvent(this, "resetBookingEvt", 7);
        this.animateIrButton = index$1.createEvent(this, "animateIrButton", 7);
        this.animateIrSelect = index$1.createEvent(this, "animateIrSelect", 7);
    ...
    componentDidLoad() {
        ...
        booking.handleBodyOverflow(true);
    }
            ...
            for (const rateplanId in roomtype) {
                ...
                if (rateplan.reserved > 0) {
                    for (const guest of rateplan.guest) {
                        index.RoomGuestSchema.parse({ ...guest, requires_bed_preference: rateplan.roomtype.is_bed_configuration_enabled });
                    }
                }
            }
        }
    ...
    async closeWindow() {
        ...
        booking.handleBodyOverflow(false);
    ...
    getPageBlockDatesView() {
        return (index$1.h(index$1.Fragment, null, index$1.h("igl-block-dates-view", { fromDate: this.defaultData.FROM_DATE, toDate: this.defaultData.TO_DATE, entryDate: this.defaultData.ENTRY_DATE, onDataUpdateEvent: event => this.handleBlockDateUpdate(event) })));
    }
    ...
    async handleBlockDate(auto_close = true) {
        const props = this.wasBlockedUnit
            ...
            : (() => {
                ...
                return {
                    from_date: booking.dateToFormattedString(this.defaultData.defaultDateRange.fromDate),
                    to_date: booking.dateToFormattedString(this.defaultData.defaultDateRange.toDate),
    ...
    async bookUser(check_in) {
        ...
        try {
            ...
            if (!this.isEventType('EDIT_BOOKING') && !this.isEventType('ADD_ROOM')) {
                index.BookingGuestSchema.parse({ first_name: this.bookedByInfoData?.firstName, last_name: this.bookedByInfoData?.lastName });
            }
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '24c311b7bf6e3a285b00031d03244bce040434c1', "data-testid": "book_property_sheet h-100" }, index$1.h("div", { key: 'cc75c55354031de7b73db31f6501b427d1e1c3ed', class: "background-overlay", onClick: () => this.closeWindow() }), index$1.h("div", { key: '434fb779fcfb637411afafcce6086b3405b0868d', class: 'sideWindow sheet-container ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, irInterceptor_store.isRequestPending('/Get_Setup_Entries_By_TBL_NAME_MULTI') ? (index$1.h("div", { class: 'loading-container' }, index$1.h("ir-spinner", null))) : (index$1.h(index$1.Fragment, null, index$1.h("div", { class: "sheet-header" }, index$1.h("div", { class: "card-header-container" }, index$1.h("h2", { class: "fd-book-property__title" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index$1.h("ir-custom-button", { appearance: "plain", variant: "neutral", size: "medium", onClickHandler: () => this.closeWindow() }, index$1.h("wa-icon", { name: "xmark", library: "system", variant: "solid", label: "Close", "aria-label": "Close" })))), index$1.h("div", { class: "px-2 sheet-body" }, this.getCurrentPage('page_one') && (index$1.h("igl-booking-overview-page", { wasBlockedUnit: this.wasBlockedUnit, initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index$1.h("igl-booking-form", { currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countries: this.countries, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null), this.getCurrentPage('page_block_date') ? (index$1.h("div", { class: "sheet-footer" }, index$1.h("ir-button", { text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: "flex-fill", onClick: () => this.closeWindow() }), index$1.h("ir-button", { text: locales_store.locales.entries.Lcz_Blockdates, isLoading: irInterceptor_store.isRequestPending('/Block_Exposed_Unit'), class: "flex-fill", onClick: () => this.handleBlockDate() }))) : (index$1.h("igl-book-property-footer", { page: this.page, dateRangeData: this.dateRangeData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), isLoading: this.isLoading, class: 'sheet-footer', eventType: this.bookingData.event_type })))))));
    }
};
...
const IglBookPropertyFooter = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.buttonClicked = index$1.createEvent(this, "buttonClicked", 7);
    }
    eventType;
    page;
    ...
    isLoading, appearance, variant, value, form, }) {
        return (index$1.h("div", { class: this.shouldRenderTwoButtons() ? ` ${this.editNext(label)}` : 'flex-fill' }, index$1.h("ir-custom-button", { type: type, form: form, size: 'medium', loading: isLoading, appearance: appearance, variant: variant, disabled: disabled, onClickHandler: () => {
    ...
    render() {
        if (this.page === 'page_one') {
            return (index$1.h(index$1.Host, null, this.isEventType('EDIT_BOOKING') ? (index$1.h(index$1.Fragment, null, this.renderButton({ value: 'cancel', label: locales_store.locales.entries.Lcz_Cancel, appearance: 'filled', variant: 'neutral' }), this.shouldRenderTwoButtons() &&
                this.renderButton({
                    value: 'next',
                    ...
                    variant: 'brand',
                    appearance: 'accent',
                }))) : (index$1.h(index$1.Fragment, null, this.renderButton({ value: 'cancel', label: locales_store.locales.entries.Lcz_Cancel, appearance: 'filled', variant: 'neutral' }), this.shouldRenderTwoButtons() &&
        ...
        return (index$1.h(index$1.Fragment, null, this.isEditOrAddRoomEvent ? (index$1.h(index$1.Fragment, null, this.renderButton({ value: 'back', icon_position: 'left', label: locales_store.locales.entries.Lcz_Back, icon_name: 'angles_left', appearance: 'filled', variant: 'neutral' }), this.renderButton({ value: 'save', label: locales_store.locales.entries.Lcz_Save, isLoading: this.isLoading === 'save', variant: 'brand', appearance: 'accent' }))) : (index$1.h(index$1.Fragment, null, this.renderButton({ value: 'back', icon_position: 'left', label: locales_store.locales.entries.Lcz_Back, icon_name: 'angles_left', appearance: 'filled', variant: 'neutral' }), this.renderButton({
            value: 'book',
            type: 'submit',
...
const IglBookPropertyHeader = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.splitBookingDropDownChange = index$1.createEvent(this, "splitBookingDropDownChange", 7);
        this.checkClicked = index$1.createEvent(this, "checkClicked", 7);
        this.buttonClicked = index$1.createEvent(this, "buttonClicked", 7);
        this.toast = index$1.createEvent(this, "toast", 7);
        this.spiltBookingSelected = index$1.createEvent(this, "spiltBookingSelected", 7);
        this.animateIrSelect = index$1.createEvent(this, "animateIrSelect", 7);
    }
    splitBookingId = '';
    bookingData = '';
    ...
    getSplitBookingList() {
        return (index$1.h("ir-picker", { mode: "select-async", class: "sourceContainer", debounce: 300, "onText-change": e => {
            ...
            return (index$1.h("ir-picker-item", { value: b.booking_nbr?.toString(), label: label }, label));
        })));
    }
    getSourceNode() {
        const { sources } = booking_service.booking_store.selects;
        return (index$1.h("wa-select", { size: "small", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_service.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_service.booking_store.bookingDraft.source?.id, id: "xSmallSelect", "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onchange: evt => {
            ...
            if (option.type === 'LABEL') {
                return index$1.h("small", null, option.description);
            }
            return index$1.h("wa-option", { value: option.id?.toString() }, option.description);
        })));
    }
    getAdultChildConstraints() {
        const { adults, children } = booking_service.booking_store.bookingDraft.occupancy;
        return (index$1.h(index$1.Fragment, null, index$1.h("ir-validator", { value: adults, schema: index$2.z.number().min(1), autovalidate: this.autoValidate }, index$1.h("wa-select", { class: "fd-book-property__adults-select", "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onchange: e => {
                booking_service.setBookingDraft({
            ...
            }, value: adults?.toString(), defaultValue: adults?.toString(), placeholder: locales_store.locales.entries.Lcz_AdultsCaption, size: "small" }, Array.from(Array(this.adultChildConstraints.adult_max_nbr), (_, i) => i + 1).map(option => (index$1.h("wa-option", { value: option?.toString() }, option))))), this.adultChildConstraints.child_max_nbr > 0 && (index$1.h("wa-select", { class: "fd-book-property__children-select", "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }), defaultValue: children?.toString(), value: children?.toString(), placeholder: this.renderChildCaption(), size: "small" }, Array.from(Array(this.adultChildConstraints.child_max_nbr), (_, i) => i + 1).map(option => (index$1.h("wa-option", { value: option?.toString() }, option)))))));
    }
    renderChildCaption() {
    ...
    getMaxDate() {
        if (!this.bookingData?.block_exposed_unit_props) {
            if (this.isEventType('PLUS_BOOKING')) {
                return moment.hooks().add(60, 'days').format('YYYY-MM-DD');
            }
            return undefined;
        }
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '41a9f4c5a2f0bfbf92c4375c4153155e8ba2831c' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), index$1.h("div", { key: '030dfc1e34957b753f171bb63f7211b6068e78c6', class: `fd-book-property__header-container` }, showSourceNode && this.getSourceNode(), index$1.h("igl-date-range", { key: '1dc1a2caa8d426a466a474af296c3afe604954ef', "data-testid": "date_picker", variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange }), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints(), index$1.h("ir-custom-button", { key: '466aa16b0f93872a3cfb6397bc4e287ef6626a2b', loading: irInterceptor_store.isRequestPending('/Check_Availability'), variant: "brand", onClickHandler: () => this.handleButtonClicked() }, locales_store.locales.entries.Lcz_Check)), index$1.h("p", { key: '9bf5ac272969b7c4a41712c89a198a2a52cf0adf', class: "text-right message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingForm = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.dataUpdateEvent = index$1.createEvent(this, "dataUpdateEvent", 7);
        this.buttonClicked = index$1.createEvent(this, "buttonClicked", 7);
    }
    showPaymentDetails;
    currency;
    ...
    render() {
        return (index$1.h("form", { key: '8cc104004a7206bb763f94a54db6829608a6998e', class: "d-flex flex-column h-100", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
            } }, index$1.h("div", { key: 'b10e362e17df212b7447884a601bf10fb331651d', class: "d-flex flex-wrap" }, index$1.h("ir-date-view", { key: 'acbd9f1b10ef88af3b4b3fb3b3f121bde96c50e7', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index$1.h("div", { key: '17e4882d20f67a8cdd56d5f49e6fe7212d282853', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index$1.h("span", { key: '0a71bfe70afec4e420719a1b6553fb39d3d29dc9', class: "font-weight-bold font-medium-1" }, booking.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
            return [...new Array(rp.reserved)].map((_, i) => (index$1.h("igl-application-info", { totalNights: Number(this.dateRangeData.dateDifference), bedPreferenceType: this.bedPreferenceType, currency: this.currency, guestInfo: rp.guest ? rp.guest[i] : null, bookingType: this.bookingData.event_type, rateplanSelection: rp, key: `${rp.ratePlan.id}_${i}`, roomIndex: i, baseData: this.bookingData.event_type === 'EDIT_BOOKING'
                    ? {
                        roomtypeId: this.bookingData.currentRoomType.roomtype.id,
                        unit: this.bookingData.currentRoomType.unit,
                    }
                    : undefined })));
        })), this.isEditOrAddRoomEvent || this.showSplitBookingOption ? null : (index$1.h("igl-property-booked-by", { propertyId: this.propertyId, countries: this.countries, language: this.language, showPaymentDetails: this.showPaymentDetails, defaultData: this.bookedByInfoData, onDataUpdateEvent: event => {
...
const IglBookingOverviewPage = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.roomsDataUpdate = index$1.createEvent(this, "roomsDataUpdate", 7);
    }
    bookingData;
    propertyId;
    message;
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'c63fc4314dd0c6dda2429a872471c1fb23bba0fa' }, index$1.h("igl-book-property-header", { key: '83cb268cdd8e80a4a47b05c6f2e85f8065292b84', wasBlockedUnit: this.wasBlockedUnit, bookedByInfoData: this.bookedByInfoData, defaultDaterange: this.defaultDaterange, dateRangeData: this.dateRangeData, minDate: this.setMinDate(),
            // minDate={this.isEventType('ADD_ROOM') || this.isEventType('SPLIT_BOOKING') ? this.bookedByInfoData.from_date || this.bookingData.FROM_DATE : undefined}
            splitBookingId: this.showSplitBookingOption, bookingData: this.bookingData, message: this.message, bookingDataDefaultDateRange: this.bookingData.defaultDateRange, showSplitBookingOption: this.showSplitBookingOption, adultChildConstraints: this.adultChildConstraints, splitBookings: this.getSplitBookings(), propertyId: this.propertyId }), index$1.h("div", { key: '718f2deafd4db3a32d7385d684f9f2a1a38919ae', class: " text-left" }, irInterceptor_store.isRequestPending('/Check_Availability') && this.isEventType('EDIT_BOOKING') ? (index$1.h("div", { class: "loading-container" }, index$1.h("div", { class: "loader" }))) : (index$1.h(index$1.Fragment, null, booking_service.booking_store.roomTypes?.map(roomType => (index$1.h("igl-room-type", {
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'cc13a58361aec0abc26b2e3b151d7014af36e01b' }, index$1.h("div", { key: '91da243748795d253457c89ca3b9717e5810ffa0', class: "text-left mt-3" }, index$1.h("div", { key: 'f09a76c65463d62530d1b8a76c2964fb91c79f32', class: "d-flex", style: { alignItems: 'flex-end', gap: '0.5rem' } }, index$1.h("ir-picker", { key: '7c9447c09d9a4ebc8d5518876a42c75f70eff481', class: "bookedByEmailContainer m-0 p-0", label: locales_store.locales.entries.Lcz_BookedBy, value: this.bookedByData.email, ref: el => (this.pickerRef = el), "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.email !== '' && booking.validateEmail(this.bookedByData.email))), withClear: true, "onText-change": event => this.fetchGuests(event.detail), debounce: 300, "onInput-picker-blurred": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            ...
            return (index$1.h("ir-picker-item", { label: label, value: guest.id?.toString(), key: guest.id }, label));
        })), index$1.h("div", { key: '5ada7c35e69a32b2954b200b070a097a1f264296', style: { paddingBottom: '0.5rem' } }, index$1.h("wa-tooltip", { key: '277ff7075477b2c029f5a7927d519e5f8c6f5074', for: `main_guest-search-tooltip` }, "Leave empty if email is unavailable"), index$1.h("wa-icon", { key: 'd3096e254ad7257bc88fbee0fd722232b7db35e0', name: "circle-info", id: `main_guest-search-tooltip` })))), index$1.h("div", { key: '5200e2ecd266f946054cd0439d17599b81739b3b', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index$1.h("div", { key: '28f5d9c31bfee9c6cb578549b26c4abe5fa5cb5e', class: "d-flex flex-column flex-md-row  justify-content-md-between ", style: { gap: '1rem' } }, index$1.h("div", { key: 'a4b925c519bec9dbfaa2bfda28ce0f55ffd62e05', class: "fd-property-booked-by__guest-form " }, index$1.h("ir-validator", { key: 'b4acf438f515409665e1fdc41d16cc54523b4c35', value: this.bookedByData.firstName, schema: index.BookingGuestSchema.shape.first_name }, index$1.h("ir-input", { key: 'c26aeb912cc776c5f98088c370b9a96cfb018e6e', "onText-change": event => {
                this.updateGuest({ first_name: event.detail });
                this.handleDataChange('firstName', { target: { value: event.detail.trim() } });
            }, defaultValue: this.bookedByData.firstName, value: this.bookedByData.firstName, label: locales_store.locales.entries.Lcz_FirstName, placeholder: locales_store.locales.entries.Lcz_FirstName, required: true, name: "last_name_custom", autocomplete: "family-name" })), index$1.h("ir-validator", { key: 'c83c2c832069dea807c5ada6c5826cae961ae06b', value: this.bookedByData.lastName, schema: index.BookingGuestSchema.shape.last_name }, index$1.h("ir-input", { key: '7331f6ad2a1349c8fae93db9c1aafb6aaaa4cd96', "onText-change": event => {
                this.updateGuest({ last_name: event.detail });
                this.handleDataChange('lastName', { target: { value: event.detail.trim() } });
            }, name: "first_name_custom", autocomplete: "given-name", defaultValue: this.bookedByData.lastName, value: this.bookedByData.lastName, label: locales_store.locales.entries.Lcz_LastName, placeholder: locales_store.locales.entries.Lcz_LastName, required: true })), index$1.h("ir-country-picker", { key: 'e892eb4eb49e6d7f75b8410a212759c2caa77ff1', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) }), index$1.h("ir-mobile-input", { key: '8500c75d92cce9c31fb06e3cdcb42f362d397c71', size: "small", "onMobile-input-change": e => {
            ...
            // required
            countryCode: this.countries.find(c => c.phone_prefix === this.bookedByData.isdCode)?.code, countries: this.countries }), index$1.h("wa-select", { key: 'a7fb00114ae684ce3ebf38c532d128d881c72790', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", "aria-disabled": String(Boolean(this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '')), id: v4.v4(), defaultValue: this.arrivalTimeList[0].CODE_NAME, value: this.bookedByData.selectedArrivalTime.code, onchange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index$1.h("wa-option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))), index$1.h("div", { key: 'e6a20c4f5bd8ff570883999079656f692edb7905', class: "p-0 flex-fill  ml-md-3 d-flex flex-column", style: { gap: '0.5rem' } }, index$1.h("wa-textarea", { key: 'fa8ec8aa8d18d634f90b33725b00bdc6f5df18c2', onchange: event => this.handleDataChange('message', event), size: "small", value: this.bookedByData.message, defaultValue: this.bookedByData.message, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 4 }), this.paymentMethods.length > 1 && (index$1.h("wa-select", { key: '53d2740c566c0b5c5de853668293bf80a3cdf3ac', label: 'Payment Method', size: "small", value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index$1.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index$1.h(index$1.Fragment, { key: '7784f006b2204f1ac19f48d31ea2a8cae4fce538' }, index$1.h("ir-input", { key: 'aa06618b465c3eb3679371cfbae2eadfbbed4937', value: this.bookedByData.cardNumber, defaultValue: this.bookedByData.cardNumber, "onText-change": e => this.handleCreditCardDataChange('cardNumber', e.detail.trim()), label: locales_store.locales.entries.Lcz_CardNumber }), index$1.h("ir-input", { key: '5d9a818521edfc783cecba18692542c5712326b5', value: this.bookedByData.cardHolderName, defaultValue: this.bookedByData.cardHolderName, "onText-change": e => this.handleCreditCardDataChange('cardHolderName', e.detail.trim()), label: locales_store.locales.entries.Lcz_CardHolderName }), index$1.h("ir-input", { key: '1260b1789613b213ec81e1a4452ff0d70fcadbd4', "onText-change": e => {
            ...
            }, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index$1.h("div", { key: '2a9075fda53fd0d0965d9d4e7eea7e01ae66b589', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index$1.h("label", { key: '20f8ca6f90cf8e7cdeffe4ab819f96a64678cfe6', class: "p-0 m-0 margin3" }), index$1.h("div", { key: 'b90b53f9503bfce12ba67b2eb00b5d4273e662f3', class: "p-0 m-0  controlContainer flex-fill" }, index$1.h("div", { key: '3a681c49ae00406ae1062051c664da49f314e6f8', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), index$1.h("wa-checkbox", { key: 'f8654f067a83a8fb4857cc386f0c3b9b1e533158', checked: this.bookedByData.emailGuest, onchange: event => this.handleDataChange('emailGuest', event) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
...
//# sourceMappingURL=igl-book-property_6.cjs.entry.js.map