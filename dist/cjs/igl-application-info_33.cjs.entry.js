...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("form", { key: 'e5d07af961e7d40c960561f9d85e3c492f1d0a4e', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-title", { key: '0da0c91aee955e00ccb9ea8a49510afca92de0ee', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("div", { key: 'aecdcdcc14a75d4bb4c30212d854a55b1227acfc', class: "sheet-body px-1" }, index.h("ir-textarea", { key: '6fd973ea31167d9a1ced6b2aa5a7cef5dd636c71', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), index.h("div", { key: '2c98aa894a463d7d77a77f25756427354dbfe3f4', class: 'sheet-footer' }, index.h("ir-button", { key: 'b35a85d27074d220ab7c21655e6481ace9010d62', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'a84babb21e83c33f95b04362dedf23084b26809d', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a4028447a7f37539349ddd265b8193092294bf21', class: "fluid-container px-1" }, index.h("div", { key: 'fd61e65819d19ef113a38ef3ea7cf2a006af5e1c', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: 'feb9e31fa20741b45f230159f4d23c34d8313504', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: '65cefb131403caf3ab516ac8d78b6facf315a6a0', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '005a4761d677218d8f6e8d63e511bd82fb5b3273', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '52c4e5d4f9575e1348e156eea1df4c884f75e8cc', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '7bc5c33a17b9366407e0a91c6ffc95f53cb854b5', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '808d000f4f4045cadba07e03f1ad4044d2f9ca92', class: "d-flex flex-column align-items-center" }, index.h("span", { key: 'd8e090ee9ed864837bef09b3f412c59ecd4cfff0', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (index.h("ir-popover", { key: 'da6b95cbdc18ebab84710dd767eb0b5e7974f7dc', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: '9d93ecfa329e53dc1b85f85492f7ea7a4f366f04', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '26398b0b80da91613ffad326b0d2df16cb69219e' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '1bf5055a73c87b809fc4ad224d209ac9285ce241', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: '5d6e5e92b2969f243182c6648c3c27fca583281c', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '37c1b0e28421c0e4da198a2e2afe286004021121', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '7a4629519c86dde026fec8f23eae0216a60bc7a4', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '71caf4b169a72fe9d544876d79f579f37046f7a3', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '4478361d01213c807bf85dfbf68e167673c410b8', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '3ac59d9e5b977496c49f1ae244c45e29947fcc81', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: 'c503f17982ce336daaab27f6190417ad16fdbdeb', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '566d8304f0c1cb04b91fa26258b92d1f8008a208', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '72f34ad5fb5feb981090449684511f548049cf02', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '4ef79bd0edd9b7f60246146d24c4ab68610eba37', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: 'd3c7195ede2e70fc63fbc4f4a8ea3a7e3e1c2f05', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-modal", { key: '4b2495645764b004aadee17a7aa10ecb575e76a5', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales_store.locales.entries.Lcz_OTA_Modification_Alter, isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8c9e890a165bd82bd200fa418df400db7ab57924' }, index.h("dialog", { key: 'f2cd6446cfc09c2934f627161ef3285913b58fac', ref: el => (this.dialogEl = el), class: "dialog", role: "dialog", "aria-modal": "true", "aria-labelledby": labelledBy, "aria-describedby": describedBy }, index.h("div", { key: '36499ec862c53ad7cb4290c73664d22260146ddf', class: "dialog__content", role: "document" }, index.h("header", { key: 'ded3f793ec54679ec0c26ec97290b923003b6487', class: "dialog__header", id: labelledBy }, index.h("slot", { key: '3bdcbbd1c4ebf66de0fe72b6d08062ab9c37bf85', name: "modal-title", onSlotchange: this.onTitleSlotChange }), index.h("button", { key: 'eedef8bb46caf8d1aea0d06530504957db0a4ffd', type: "button", class: "dialog__close-button", onClick: this.onCloseButtonClick, "aria-label": "Close dialog" }, index.h("slot", { key: 'c5f4e53e6e8975fce0b452d4f678b633d1c7a65e', name: "close-icon" }, index.h("svg", { key: '8a3ebab9d2c3d59100de911a75b08f67a5bafa74', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18, "aria-hidden": "true", focusable: "false" }, index.h("path", { key: 'b1e4b54641c7ba476fce9189a6336b36183d48a4', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("section", { key: '3e24aff29a96ad0cb07f7ba769edb65aa7256e2e', class: "dialog__body", id: describedBy }, index.h("slot", { key: '36965856da300bfd457c063cae8b65054a9abbf4', name: "modal-body", onSlotchange: this.onBodySlotChange })), index.h("footer", { key: 'c5ffe8fe50d1fe55bd23e195ea485a0420d5df51', class: "dialog__footer" }, index.h("slot", { key: 'a1efabe10a4c08e23fd027877cb9fdb0c9453b3f', name: "modal-footer" }))))));
    }
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a64681de1caa9ed02048b91f234a66b6e5f01cb3', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '36e952da1186ff05a3531da6fe6528786a02f84f' }, index.h("div", { key: '205afa704f6e4b1b4f5b190c5df1d881955fb5f0', class: "p-1" }, index.h("div", { key: '6f8d6a6760a4ac996a03cb12587bee88de1eeb04', class: 'extra-service-container' }, index.h("p", { key: 'e15cd0ea93dcda671e79c84986089ec077fc793c', class: "extra-service-description" }, this.service.description), index.h("div", { key: 'ac14737749822048a201589165df3f33e2bc6540', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: '0e17299c0073c902f0c29312317f98ba4d81332c', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("ir-button", { key: 'c74ec2b53e0a3a13e5d803aed988dbaec0c949cc', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: '3a31bbf412d9ad402b0821ad2d535cfa35949063', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: icons.colorVariants.danger }))), index.h("div", { key: '559600086b061595b3dc11c900028db652aab154', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: 'ec5414e8edc5385325d8a7ff8900caf958d6ad51', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '3362c4d8befe14e37e67a1c238e6398f42a7b25b', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: 'bb266a88b9d335cc4820c2e82f7b5262164cacc1', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '5a635083487888f10ce3ca9a5f014d64c2b9ab0a', class: 'px-1 sheet-body' }, index.h("fieldset", { key: 'cafa71dc4f2c4c35bd789d483880efa98cbb5e40', class: "input-group mb-1 service-description" }, index.h("div", { key: '548e77df0ee8320754a49ac31d9cd912f57a0ff6', class: "input-group-prepend" }, index.h("span", { key: '1e7d269e7c464c782b7a3a65c8ebc2d9a96aa805', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '36a807fe405f7668e1ac0415803ac9af624c207e', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '7d4318f65fd4c3c3e7d8c91bee5cea6c55ef90f3', class: 'row-group mb-1' }, index.h("div", { key: '1ba4c0855563408bfc70ac97a3dba171da4f8ee6', class: "input-group" }, index.h("div", { key: '3f9c9ca1806f8fafb70146fd4ed9cc7c0268ef3d', class: "input-group-prepend" }, index.h("span", { key: '3e1a8f2a4d15bb6dfc834df16e48e81b034f6702', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '079e2fea681660ecfef782a55344f9891184951f',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '7770c74b0ed91717b9e9aae182d500a4df509e48', class: "service-date-container" }, index.h("ir-date-picker", { key: 'af4afc84e3345a852df3b6ad8a2f2350af235139',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: 'e7da66a9266f67a9bd8a28554bf7c670f8d9cb4f',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: 'd8832261ad8fe8c53057c2f28e2444d5822e5f26', class: "btn-container" }, index.h("ir-button", { key: 'f2af93b6b53e1b5ed5665b39c314d762424dac53', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '01dffa85f109d63c48be011d8d65aa305e2f23dd', class: "input-group" }, index.h("div", { key: '7cc37ab4912eb724f790c5c1fac49f0020f76fe1', class: "input-group-prepend " }, index.h("span", { key: '27aa18290701271cbad9e7c3293e55f23fc7c86c', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'a2b198c28f279a0e83c0b6cf48e0db2564546f84',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '17f99c159e7a71b4d2d7db8ff84ebc444c8922dd', class: "service-date-container" }, index.h("ir-date-picker", { key: 'f9a44c5aa0003f8fd8bd45d863d5ea2c51a1c873',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: '7adc89ba6f50863027e9d0b4827105edebd1bc29',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '7d90be3c86239cdb553dcfede7e72e51de3c9cba', class: "btn-container" }, index.h("ir-button", { key: 'efaceb653039ed320004799e1f684dd2c6a9ff53', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '7cce23be70134a24833f9af2aa507b44d8f26f4a', class: 'row-group' }, index.h("ir-price-input", { key: 'f13e1974f932a0f35df6060722feb0be105a5df6', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: 'a85ed39eef337d99a04c15bd2314bc7c0591d44f', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: 'b2532397fc50f1155d4978154f502c99df7309ed', class: 'sheet-footer' }, index.h("ir-button", { key: 'e93f2d06038e7868a2980797f6636685491d2fd0', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'ddcdfb3b75c75cfcd3c3f355c054d374b1fcbcd2', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'f40884ae756ee33dec916e99f104a1e6581bb265', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: 'cfe0387d78be97832c75963e44e33529a4f428c9', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: this.mode === 'edit' ? 'Edit Folio Entry' : 'New Folio Entry', displayContext: "sidebar" }), index.h("section", { key: 'c86458c4b0789c26bceb3b85cfcd66d361dffa81', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: '73ca30a899d884dfcd3a6d09de7e5eb927816335', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: '9cef0e985725a89ea68219970ab029250f269b09', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: '6b7f60a2821a84a279c8f1089a83ef16659f9995', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: '64f3711f78919f296d06937f850c9e92d935acc4', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: '702875a8e61b86596ea624bd0496d41ba25c3e58', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: '210375f148d0f3f426462f0df5c064d8c3de1e68', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: '9c134b045b46dc3571b7c4b4e4dd79c1b2dfe172' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: '9db2bf8957502c1f7d125e1ec29df73be9c06bfd', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, maxDate: moment.hooks().format('YYYY-MM-DD'), "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '71b3174a7729f4c75c38f492fb1508c1a00e841f', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: 'f33d4da51512d71d5ec8f934e00c645e20590448' }, index.h("ir-dropdown", { key: '0ca034d414005bbb9a0a9f8735034d85eb54ca95', value: (_j = (_h = this.folioData) === null || _h === void 0 ? void 0 : _h.payment_type) === null || _j === void 0 ? void 0 : _j.code, disabled: this.mode === 'payment-action', onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: 'a6c212a8da36317301faa91d02aad64d68c57f67', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '37623d01e63245133239addfe5ef6a90274a854d', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: 'bf7729d16cfe258915232ba83f197ff96cde2c8d', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: '7af752b7119d86ed8ac8f08ed3a7ffd586b40fd1', type: "button", disabled: this.mode === 'payment-action', class: `form-control  d-flex align-items-center cursor-pointer ${((_k = this.errors) === null || _k === void 0 ? void 0 : _k.payment_type) && !((_m = (_l = this.folioData) === null || _l === void 0 ? void 0 : _l.payment_type) === null || _m === void 0 ? void 0 : _m.code) ? 'border-danger' : ''}` }, ((_o = this.folioData) === null || _o === void 0 ? void 0 : _o.payment_type) ? index.h("span", null, (_p = this.folioData.payment_type) === null || _p === void 0 ? void 0 : _p.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '2cb31eb525689404c544c0b3c6f8e2e678771bea', value: "" }, "Select..."), this.renderDropdownItems())), global_variables.PAYMENT_TYPES_WITH_METHOD.includes((_r = (_q = this.folioData) === null || _q === void 0 ? void 0 : _q.payment_type) === null || _r === void 0 ? void 0 : _r.code) && (index.h("div", { key: 'f37145e31c684eccc5d3ac36add676a0e126bcb5' }, index.h("ir-dropdown", { key: '8860e301f2163db3856de1d79b7e80dd2a3eee0f', value: (_t = (_s = this.folioData) === null || _s === void 0 ? void 0 : _s.payment_method) === null || _t === void 0 ? void 0 : _t.code, onOptionChange: this.handlePaymentMethodDropdownChange.bind(this) }, index.h("button", { key: 'e58e98bf1245b3e076849c958cf23b088d373ba4', slot: "trigger", type: "button", class: `form-control d-flex align-items-center cursor-pointer ${((_u = this.errors) === null || _u === void 0 ? void 0 : _u.payment_method) && !((_w = (_v = this.folioData) === null || _v === void 0 ? void 0 : _v.payment_method) === null || _w === void 0 ? void 0 : _w.code) ? 'border-danger' : ''}` }, ((_x = this.folioData) === null || _x === void 0 ? void 0 : _x.payment_method) ? (index.h("span", null, (_y = this.folioData.payment_method) === null || _y === void 0 ? void 0 : _y.description)) : (index.h("span", null, "Select ", ((_0 = (_z = this.folioData) === null || _z === void 0 ? void 0 : _z.payment_type) === null || _0 === void 0 ? void 0 : _0.code) === '001' ? 'payment' : 'refund', " method..."))), index.h("ir-dropdown-item", { key: '933ddf081d8c66ca244d4caf6d52e9fe9931a793', value: "" }, "Select ", ((_1 = this.folioData.payment_type) === null || _1 === void 0 ? void 0 : _1.code) === '001' ? 'payment' : 'refund', " method..."), (_3 = (_2 = this.paymentEntries) === null || _2 === void 0 ? void 0 : _2.methods) === null || _3 === void 0 ? void 0 :
            _3.map(pt => {
                return (index.h("ir-dropdown-item", { value: pt.CODE_NAME, class: "dropdown-item-payment" }, index.h("span", null, pt.CODE_VALUE_EN)));
            })))), index.h("div", { key: '93d48e4c3583ba2325230bc76f7275db062e03f4' }, index.h("ir-price-input", { key: 'b691cb26af662f11d036745031a954e910a86aec', containerClassname: "row", labelContainerClassname: "col-4 col-md-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_4 = this.errors) === null || _4 === void 0 ? void 0 : _4.amount) && !((_5 = this.folioData) === null || _5 === void 0 ? void 0 : _5.amount), value: (_7 = (_6 = this.folioData) === null || _6 === void 0 ? void 0 : _6.amount) === null || _7 === void 0 ? void 0 : _7.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: '8fcbba7978c829e541ce4a9c689695bc25ca4212' }, index.h("ir-input-text", { key: '164568ee59585699982305ad6491b2b5a467dab4', value: (_8 = this.folioData) === null || _8 === void 0 ? void 0 : _8.reference, error: (_9 = this.errors) === null || _9 === void 0 ? void 0 : _9.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3, labelContainerClassname: 'col-4 col-md-3' }))), index.h("div", { key: '9eec15b16bd957a91da04ea94dd65f0cb6d03b3b', class: 'sheet-footer' }, index.h("ir-button", { key: 'e62344641cf855a87461f77d5b647657c2561c35', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: 'd66611638b87449377e720f45083137ccdd641a6', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f14355cf2dc0a450ff358a2ffbb40447c9370251', class: "payment-item__payment-item" }, index.h("div", { key: 'e67a171cd81998f3a87ee6df91553d1d4d8d90cb', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '402a3b3c4bbfdadcced05afce0c44c629a0f6014', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '04cc09aba81b8e824a05c786fc147a5067b3b8b9', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '77c58921a82379b8fdcc134a2b479fb7e493f955', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'e2c7ce298811f79b68fe23541f212ef81c715e11', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '9c49e2fd4a5eef3efe2dafbfb34481c5d03c8fb3', class: "payment-item__payment-reference" }, (_d = this.payment) === null || _d === void 0 ? void 0 : _d.reference)), index.h("div", { key: '72b37423c8bb74f66e45b890fdc9dafc4d8b35e7', class: "payment-item__payment-toolbar" }, index.h("p", { key: '850c7e18f93e95a035a27f2e10c04f70525c7830', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '6fa990450391433ecf42f6666f618cc44ed8fea1', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '767cb15872a631d5b88e5a5823419590c568ef81', class: "payment-item__payment-actions" }, index.h("div", { key: 'f1d7b83a8cb4ba317353ff5380fd23404eaf4227', class: "d-flex align-items-center" }, index.h("ir-popover", { key: 'aa1ee523b5e4767f3187885aaace44eb92889142', trigger: "hover", content: `User: ${this.payment.time_stamp.user}` }, index.h("ir-button", { key: 'b650d7adfb8caaf2c57a208a727dfe10ca8a20ab', variant: "icon", style: { 'color': icons.colorVariants.secondary['--icon-button-color'], '--icon-size': '1.1rem' }, icon_name: "user" }))), index.h("ir-button", { key: '6511152004da5abb02af4111144e8ee6cf3fac89', class: "payment-item__action-button", variant: "icon", onClickHandler: () => {
                this.editPayment.emit(this.payment);
            }, icon_name: "edit", style: icons.colorVariants.secondary }), index.h("ir-button", { key: '6350e6aace9723d440f1089800f76d00fe798bd6', class: "payment-item__action-button", onClickHandler: () => {
                this.deletePayment.emit(this.payment);
            }, variant: "icon", style: icons.colorVariants.danger, icon_name: "trash" }))), this.payment.reference && index.h("p", { key: '995711139af04f74b386a0c33c4465fcdc2fe747', class: "payment-item__payment-reference" }, (_e = this.payment) === null || _e === void 0 ? void 0 : _e.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: 'f7c68209a510c67eb97f28200b9bea21102444aa', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '8e7415851f986eb87953a1a5b0cb1d2ea783aadd', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '94f97fca594bdd42c5971e01fbd52a2bb8ef70c5' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: 'ff43179a881bea8258cbe145160eaa8b90c41f44', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '261ca114009459578ef1e88139c6b89176e00700' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '66e9b5e9db82b05caa437f8040a0526102e4591e', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: 'dc093eb9b946b99745409402a282a797a6d1a5b1', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '136c5fbacaac4b20a82b1352f8bac91ee056b7c3' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '3899e9b67403142fa2a371d1ede647bd4ad5ee1c' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("div", { key: 'b6738d0956f6b7a1e7caffbcc3b31e2f6154394e', class: "mt-1" }, index.h("div", { key: 'b17323e25a520fa480228831f364f3ccf68ed592', class: "d-flex flex-column rounded payment-container" }, index.h("div", { key: '51bad2e192a6817c563153239f3f8bb240f1fa09', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: '59af5991c2820a04ca052a76f360af67e80803ac', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'd9cf623bcb19232550fa22372dd221e1aaae8cc7', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '3ae7c6c9173312f5cae39e886bcd2b7c76bcb19e', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("ir-button", { key: '1f47cbfef19eeddb3a211b188632aa0d27bb85de', id: "add-payment", variant: "icon", icon_name: "square_plus", style: { '--icon-size': '1.5rem' }, onClickHandler: this.handleAddPayment })), index.h("div", { key: 'ff4561e9f7adece2ec21cd8df04db292d98d1749', class: "mt-1 card p-1 payments-container" }, this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '59c03f89c7f80e55a9549d9705c608dba1698690', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '084af4c6bbb2a7855aa9eaa8827374ae8644288c', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '54a2a11313b73e847146cc3f70004e0f378a3c24', class: 'px-1 sheet-body' }, index.h("ir-select", { key: 'e52b201b6e85deb85a67617762e737fdfd45acfd', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: 'a8c665ad7f7c827172dd0fec2d7bdc643e5daf8b', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '58b2a14bdf6e923d4fdbf81ae7722e978c52286a', class: 'd-flex' }, index.h("div", { key: 'c352055c1501bde417c443b847e82a5ef23ea103', class: "form-group  mr-1" }, index.h("div", { key: 'f0ccb813d77dbd1234bb202574ba356bf84e3162', class: "input-group row m-0" }, index.h("div", { key: 'ff2d864aab02ded55de6672c338361defa9a337e', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '7adc960bdf5ec6229fafe97e9732ef1ce2e8ac81', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '2f5a77bef7975f3bb364bca3251e3e3b8cd57a18', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '22bc1f3982062b2a0dd68c8313d4285df9696ee5', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '58d50f8cd2486699d9373a99028dcacb7ee9df42', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: 'dcc1b301f3f3720d217ea8dc4263804da970ec2d', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: 'a837c00aa70bb761f62a74ea111ce6ccb071426d', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: 'a452ad0e84e058deac3117dc15b963ef048328b5', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '7487d1b9c92f5fcd7b8b54c72833e1e6df8c2616', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'f74be95becc3599735ce37b9443e6248846cdb15', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '1ed45676b6c8992b170991a312a59fabdfa32b5a', class: "price-input-container" }, index.h("ir-price-input", { key: 'c8c684cf83dcc9707cb36dd18f85c7d5f0e47f5b', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: 'aac0a45eb1ceb416e4b0704ebd10393076b263d3', class: 'sheet-footer' }, index.h("ir-button", { key: 'e857540cb05e0b7551d678f9880ae4c9b48dc7bc', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'c366bed7d5afe774666b41ac4e0b3c51ba5e9963', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '07ac2f78e7d5b151f53885c06275e1eb7574e658', class: "card" }, index.h("div", { key: '1fa6bae9e00889d180a5b7198cfa28b6ccce13ca', class: "p-1" }, index.h("p", { key: '14d63ac38a8fa65374f5069613d770d3167a1ece' }, this.booking.property.name || ''), index.h("ir-label", { key: 'a1c74885ac1b3ab6f3ca4ed2c5c01f618deb2192', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '2fc94b1f57f20c5fc054ad69aa4201e2c056b263', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '984523424cd1c3c372f797bc533caae65e72d943', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '40c7e66c314834363501de6f182a3602de4f2617', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'd6850e5bc4a31d3696a22291547fdc4368f242ad', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '0006d7c53bf9499808d7099d3da75e88ff0d0ced', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '0cf3c1501ec08d1bb74095d5bf67a53eb2c0b274', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '577d5a0fb793ba946689c7bf85faec61aabcecfc', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '1adca33a494c4a15cc11d865adf82b2cae03a1be', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '4147fb2f9f7c6fb87719930dae9aa0a69aa9542f', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '52a7ec835c277ca98fcaab6c28a175d17df6bac7', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'f4c9de62e2350d61a0d1b2b9f8edd761d1c495ff', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '8bc5955bd24ae80cf333bbd4d45054441b9076ec', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '36e753f901af1241262c252864600f97a665954d', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '3e4b59758677f7a416cb0eae3e427b3fab81a2b5', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '107de6632e2068de398865e5c9c704a8219f72f8', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '853784df9f6cde30a22b99515623992f4be36b5f', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '9f1b78dd5d65973066c2bbbc00eb5dffd0961083', class: "d-flex align-items-center" }, index.h("svg", { key: '140b68bbfab15b3a82bd6baa781e52c65688c219', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'baae797cafd585c744713857c4aabd8961604a05', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'f6934dde27086158d31c63e05226e3babc7b7f91', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '0a39ae317ff4850710e4117be8424a83ef789c14', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '7e421a18a777604f2f3f4a0097bb077abf1316cc', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '9e1462be2cd271d1b1735019e3c3a8f3300975ca', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1d6c4ba57e4728e2161677523d4bfa4d6eda733b', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '27f4ad0137740fda63aee5819ffeb92a91d367a8', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '6341a299124a56d0be5d409d19022be810dca92d', class: "flex-fill m-0 " }, index.h("div", { key: '8b0d3b521a64da08e89f5e4ee67f71869721525d', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: 'f1230a595b180e769fd37812c11e0548bd348eaf', class: "m-0 p-0" }, index.h("span", { key: '8cceb6e15aa89fe96886c8705fa5db1c0409476e', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '452562d5b456ee0e7c2681a33de1d8d82b5de8fa', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '91b52500225a64f235e247b3e04a0f0a783a4b1e', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '380d24ad432aa616ac02eaa77fe4c7940f32f181', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'cdf07d0bbc8ae359d0c72bd0e7da57d8048f9462', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '1588c7c271a5820f88aa0f5613b4d36e1818f11b', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '6eb838abc06b760e281fd03cb51b537c37bea725', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: 'a4ea706974c060b1e013989ba8bdec6fe35bd0a4', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '4db7cc9032f4b9071c61c1fa63233fa88dbf913c', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'f04e553ded277c940d1f48e6c1288fe6975b6c11', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '3c5b97182a4cecb2542b66068768de2e25f3c37d', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '38f926f4a9245337f4a5735b801ab5127109fb87', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '6f8590b9c902b55df0c9140024886bad77a6590b', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '6012b45a27ec1eff51e0a05ecb70b877d3cec78c', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: 'eaf4ca94d1812f8dfd41346f93fab06fd2e69b1c', class: "m-0 p-0" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '76cf3a9cc5064e799ff69c639db15e66017adfa1', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: '6f1e9b115828fbc255775fcfe59113a5f98613d9', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: '223806b53c272aaa8a16b8e6e7704b531744a820', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, onSelectChange: e => {
            ...
            }) }))), index.h("div", { key: '3f84ec9c0e91b3740d96962a0318d03de00de5ec', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: '9ab639e5f14a72a019202135599cdc9ba40332da', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '90ba978fbe4ee17d16b8c03f82ce9c20f7c6360b', class: " sm-padding-top" }, index.h("p", { key: '4baf3d6681dbdb1c3166f877bb1dd465f3aea63f', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '8fba992d7e9bb8439d5147fc983ab7781852e1b1', class: 'flex-fill' }, index.h("table", { key: 'c4b2700152404805c3b60f3d1485ae518689da91' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '385b090569e432abda8501ab7eeabea8304fa223', class: '' }, index.h("th", { key: '581c1cc45e15a99fe50bb38a30b7915c6131b79b', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'cd2119154ce4a21dfa399d147e37d496653a2216', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'cce65347060e430d20c36131a30e2b02f55a4468', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: 'd910c723df1ec59b8602a3e5486394b34865cc36', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'a056bf961baef73f19dc1b10a8819d6f74bc3e04' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '5b04dba1efb6b15628cf4a82670cb2e6905bf37d', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '774c462f980c06e6a0e63616d93d4999913895e6', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '28db4ac999f4b5b7eedf1983d2fd6cbf43508e9c' }, index.h("ir-label", { key: '09f990cae675db1fa7a7637c4d2b81bdabaa97e0', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '7983dd5ca7a4e27a431f2fb108691655def78acd', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: 'cc09a76dda30f82b2e51df3c59db09863bc2b234', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
