...
const IrListingModal = class {
    ...
    renderTitle() {
        if (this.editBooking.cause === 'payment') {
            ...
            return locales_store.locales.entries.Lcz_SureYouWantToDeleteBookingNbr + this.editBooking?.booking.booking_nbr;
        }
    }
...
//# sourceMappingURL=ir-listing-modal.cjs.entry.js.map