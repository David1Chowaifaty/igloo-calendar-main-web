...
var cityLedger_service = require('./city-ledger.service-C_FtOfuR.js');
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'faefe70ef6b1cc27eaf323b52cd089873590fd66' }, index.h("ir-city-ledger-folio-filters", { key: '6e6275ce628c173bb8492975567190d3acefb869', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), index.h("ir-dialog", { key: '5eccaa16392b6bbf8b3a60c4c195fe428b931cbd', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, index.h("p", { key: '834125802d26d7d57583cb983f78fbe709b64163' }, "Are you sure you want to delete this entry? This action cannot be undone."), index.h("div", { key: '63f76dd278938816848919bfb7fcf98cb0ce6122', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'e0104e1f6e8fdfec59e61a30cbae2afe38035a85', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), index.h("ir-custom-button", { key: '541a92f7496aa08026ae2a9572312c9ffd830ed9', size: "m", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), index.h("ir-city-ledger-transaction-drawer", { key: '595b82811854d675c5a3f3c677edbc796f7e4557', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerStatementsFilter = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '8a69b5eb3ca80cd052688ce5ad6fac1b0b536f4b', onSubmit: e => {
                e.preventDefault();
                if (canCreate)
                    this.createStatement.emit({ fromDate: this.fromDate, toDate: this.toDate });
            } }, index.h("div", { key: '33050a3874493d909d9f5d4e1df1ecade97a34a5', class: "stmt-filters" }, index.h("ir-validator", { key: '7d125d6541c59a77318a30894f88332e2bbe5762', schema: index$2.libExports.z.object({
                fromDate: index$2.libExports.z.string().nonempty(),
                toDate: index$2.libExports.z.string().nonempty(),
            }), value: {
                fromDate: this.fromDate,
                toDate: this.toDate,
            }, class: "stmt-filters__left" }, index.h("ir-date-range-filter", { key: 'eae74dc4126d89fd1846c6010cc6bce3015a2ce2', selectionMode: "auto", class: "stmt-filters__date-picker", maxDate: moment.hooks().format('YYYY-MM-DD'), fromDate: this.fromDate, toDate: this.toDate, onDatesChanged: e => {
            ...
            } })), index.h("div", { key: '59f02f886a014ceb970df2a481ce5c3474e681b5', class: "stmt-filters__right" }, index.h("ir-custom-button", { key: '3442214a7c71a4e9657947c0aba6390e8256dfaa', variant: "brand", type: "submit" }, "Create Statement"), index.h("ir-custom-button", { key: '2f62ba2f57580f64c3c56f6583a46a72e32d09c9', variant: "brand", appearance: "outlined", disabled: !canCreate, onClickHandler: () => {
                if (canCreate) {
