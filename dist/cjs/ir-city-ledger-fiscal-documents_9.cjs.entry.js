...
var index$1 = require('./index-CYDL_u-H.js');
...
var cityLedger_service = require('./city-ledger.service-CiB8kHOD.js');
...
const IrCityLedgerFiscalDocuments = class {
    ...
    render() {
        return (index.h(index.Host, { key: '65e9ba4a9f2f270a7654bc833fc1ad7335e30cc8' }, index.h("section", { key: 'f59d1eacce0b286e03b8ed96af12215d55a44bc0', class: "fiscal-documents", "aria-label": "City ledger fiscal documents" }, index.h("ir-city-ledger-fiscal-documents-filters", { key: '18d9901294fafcb2184526c49f9088139a1412a0', filters: this.filters, onFiltersChange: event => {
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: '51a59467353bb4fb88ebdc262e920dbb51ee3519', onSubmit: e => {
                e.preventDefault();
                this.applyFilters.emit(this.filters);
            } }, index.h("div", { key: 'd38b19b845ef4797e18775dc1a466863bd2d3afc', class: "filters-bar" }, index.h("ir-validator", { key: '9fc392a46a74522a5f8b68c2e04801e546a80da3', value: this.filters?.fromDate || this.filters?.toDate, schema: index$2.libExports.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: 'a98a4dc3538ca2c5e9719a5d6507976428b32f4c', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: '76733ee762288afe9c4878e6686a1c097a0ce7dd', class: "filters-bar__search-group" }, index.h("div", { key: '4c317b0a26f3953c1e366393f60bb9d049d1ddcb', class: "filters-bar__type-group" }, index.h("wa-select", { key: '6370e6c1f77a5616bc9e2d79cc4f404e6676cbe7', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: 'b7f4a0ca1c35a172a7ed0d2c8c95e202411d3084', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), index.h("wa-switch", { key: '9b8cdca96d245f509316d69cb56dcbf01ff71ed0', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Proforma")), index.h("ir-input", { key: 'd7f90d4a104060438de9fa254dd8929448d45762', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: 'bf524fe854d3e11cceff843110b03e90f45baaae', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '63ee05f0be385513e9d3a179ca2f3a88ad8cf108', variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: '1fedd867d4a4f93feb6ec9c06eb05cb4f99b58a0', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4d095298d8ea4ac0bb6544ef3c3f1e32b901bed1' }, index.h("ir-city-ledger-folio-filters", { key: 'c5b478f2c791bb5503b3cafa98a3fb6bbcec37dc', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), index.h("ir-dialog", { key: '482be5658a0b231d3a8c2ce3ce5a7bf0a303a9de', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, index.h("p", { key: '220494da59c3c3aae784106247a4da2badc1d899' }, "Are you sure you want to delete this entry? This action cannot be undone."), index.h("div", { key: 'ab3b25f257b2ec57ba70092a68f8e93c9b68d63a', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '91244be4b33a61088c7dddae86a18e2dbf46b2cd', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), index.h("ir-custom-button", { key: '0bdc27ff79900012ffa4ebf56181f8ce24e0ecaa', size: "m", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), index.h("ir-city-ledger-transaction-drawer", { key: 'ac6343665d6e7ad6699861a0e983e796d9b22392', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h("form", { key: '33e94bbdedbc783b5f160456eec8f3ddceffa3e0', onSubmit: e => {
                e.preventDefault();
            ...
            } }, index.h("div", { key: '722a2935935e07d49657fd471efbcdcf4282fec5', class: "filters-bar" }, index.h("ir-validator", { key: 'ccf18cdee8ccefdbc24a9f59c5a5501b9652cebd', value: this.dates?.from?.format('YYYY-MM-DD') || this.dates?.to?.format('YYYY-MM-DD'), schema: index$2.libExports.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '796d2860d7eb17750790fcc784141fbe10a122d4', maxDate: moment.hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), index.h("div", { key: 'bc1b9e32a59625d8d360b33df5767943dedb445c', class: "filters-bar__search-group" }, index.h("wa-select", { key: '354107342bde0b8e9a04f24c0ff5e5b74ea10887', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "s", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: '6024152ac5b546fa764bc4d258234a917f71bc3c', class: "filters-bar__search-input", "onText-change": e => {
                ...
                status: this.statusFilter,
                search: '',
            }), value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: 'af8f7bfc57a1ba3d1a83a8bdbe699c4954e66c26', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'ceb16fdfe9bc966ea70f6df24cecc8cc21fa92ab', variant: "neutral", type: "submit", appearance: "outlined" }, index.h("wa-icon", { key: 'de5a6e5283a825eeda2116450609c4b59e2d1863', name: "magnifying-glass" }))), index.h("div", { key: 'a451d77691a4c7fe4b58f3360ba0cb6dced87509', class: "filters-bar__actions" }, index.h("ir-custom-button", { key: 'c4655840dc287535e1aee46af80c9c0437460320', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, index.h("wa-icon", { key: '56f06143362369897d5755f0d3559b8182bf4500', name: "download", slot: "start" }), index.h("span", { key: 'dfdb068dffc084cea07f6b0b4b86b389598b88df' }, "Export")), index.h("ir-custom-button", { key: '723d803ee782b581d2bf6ae8dbe3691b7dcddfab', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    debounce.Debounce(300)
...
const IrCityLedgerFolioTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, hasUnbilledSelected && (index.h("div", { class: "folio-table__invoice-bar" }, index.h("span", { class: "folio-table__invoice-bar-text" }, index.h("wa-icon", { name: "file-invoice", style: { marginRight: '0.375rem' } }), this.selectedUnbilledRows.length, " unbilled item", this.selectedUnbilledRows.length !== 1 ? 's' : '', " selected"), index.h("ir-custom-button", { size: "s", variant: "brand", onClickHandler: () => this.generateInvoice.emit(this.selectedUnbilledRows) }, index.h("wa-icon", { slot: "start", name: "file-invoice-dollar" }), "Generate Invoice"), index.h("ir-custom-button", { size: "s", variant: "neutral", appearance: "outlined", onClickHandler: () => (this.selectedRowIds = new Set()) }, "Clear Selection"))), index.h("div", { class: "table--container" }, index.h("table", { class: "table data-table" }, this.renderTableHead(table), index.h("tbody", null, !this.hideBalanceInfo && this.renderStartingBalanceRow(), this.renderDataRows(table), !this.hideBalanceInfo && this.renderEndingBalanceRow()))), index.h("ir-pagination", { class: "data-table--pagination", total: total, pages: pageCount, pageSize: this.pageSize, currentPage: this.pageIndex + 1, allowPageSizeChange: true, showing: { from: showingFrom, to: showingTo }, pageSizes: this.pageSizes, recordLabel: '', onPageChange: (event) => {
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: '39ddd6de4304799249f6451f8f163ad8410def28' }, index.h("section", { key: '1a64d422b56120a044b1929032fbef8035c33743', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: 'a6bdbe22385e250352e5ae0cdb2ba6a9e0f72a8d', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
                this.filters = e.detail;
            ...
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: 'f284b036666f991be4ab2dd832f74d14886ae543', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), index.h("ir-preview-screen-dialog", { key: '00604bde264fd29526810873b0da13c03d565fed', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: '76be6ba78d2dc39d9fb79822be39bbe68eb837b0', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: '3504a9cab30bc0a510dba3793b87e083b6d21b6b', size: "m", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '1529e76472d4355c4ea52273171b3cd0c28f3d91', name: "download", label: "Download PDF" })))), this.printFilters &&
...
const IrCityLedgerStatementsFilter = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '1f29602de9a30dd258b2c16b5b741439ef8e72b7', onSubmit: e => {
                e.preventDefault();
                if (canCreate)
                    this.createStatement.emit({ fromDate: this.fromDate, toDate: this.toDate });
            } }, index.h("div", { key: '770a661466bfbb2f753470de099fd1bd709456eb', class: "stmt-filters" }, index.h("ir-validator", { key: 'faedbe6e93ddbfa80fb67a65b8b53d2feee54842', schema: index$2.libExports.z.object({
                fromDate: index$2.libExports.z.string().nonempty(),
                toDate: index$2.libExports.z.string().nonempty(),
            }), value: {
                fromDate: this.fromDate,
                toDate: this.toDate,
            }, class: "stmt-filters__left" }, index.h("ir-date-range-filter", { key: '3d93097f767d4c2ba421deb2202e52f1d1aa4a6e', selectionMode: "auto", class: "stmt-filters__date-picker", maxDate: moment.hooks().format('YYYY-MM-DD'), fromDate: this.fromDate, toDate: this.toDate, onDatesChanged: e => {
            ...
            } })), index.h("div", { key: '93f097f2f0cf00c06ffb0be1ffa927ce799ba922', class: "stmt-filters__right" }, index.h("ir-custom-button", { key: 'a5d86efb5196460489fdeccd30d1aa2fb5796b2a', variant: "brand", type: "submit" }, "Create Statement"), index.h("ir-custom-button", { key: 'd7a59a7658279afb840c0c3c617ee6b25adf56a7', variant: "brand", appearance: "outlined", disabled: !canCreate, onClickHandler: () => {
                if (canCreate) {
