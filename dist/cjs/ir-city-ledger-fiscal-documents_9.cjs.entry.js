...
const cityLedger_service = require('./city-ledger.service-c07ebbdf.js');
...
const IrCityLedgerFiscalDocuments = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2b05b7addb41419b5c8e6de8448c00105951156d' }, index.h("section", { key: '0d3970e8afd2895a18e1c5a928ce216a7ced76e0', class: "fiscal-documents", "aria-label": "City ledger fiscal documents" }, index.h("ir-city-ledger-fiscal-documents-filters", { key: '5d1f4216f6500974443b7f8d4d60eae678d22561', filters: this.filters, onFiltersChange: event => {
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: 'e667908aa0e65b55b77df17acc1b73ac9bed58a9', onSubmit: e => {
                e.preventDefault();
                this.applyFilters.emit(this.filters);
            } }, index.h("div", { key: '5ca35de9ae960bfd9ed8cb78b0a8566ead366bc4', class: "filters-bar" }, index.h("ir-validator", { key: 'a07fce54411ad56b9051f0ae1e874526f41a67b3', value: this.filters?.fromDate || this.filters?.toDate, schema: index$2.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '71a0d79ee876434286fbfc17d59c49d128a82a09', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: '2178d5e2f8e233b0ce0299a3a4c790bf637f9a34', class: "filters-bar__search-group" }, index.h("div", { key: '364dede984ab42e2f334d7ec5ec566147f8966d3', class: "filters-bar__type-group" }, index.h("wa-select", { key: '5fa16b5458ac6dba78fd3f319e11759e7e55d8ea', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: '4f05e07127cbf99263ddf7cb04cb287018995902', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), index.h("wa-switch", { key: '539eccdd5e578c33f4df9d58a99a0f6a830e9951', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Proforma")), index.h("ir-input", { key: '0d0ef8a699f82339d468e4d8c26fdef86de3e18b', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: '395fab58425f12df542f1702b624c06c1063443f', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '938e6155397cd1309b03aa7d322f8be3873e26e2', variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: 'e9e031756fb009424ccb6aff4a42cf6098dfddb2', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bb9477309aabfb32c464b4a1db255d439b068b63' }, index.h("ir-city-ledger-folio-filters", { key: '2fba10d6fc892b1001217f4c5e48e5116f1cad34', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), index.h("ir-dialog", { key: '999072844697c7766c9f16749f97cc6b9aa4549d', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, index.h("p", { key: '5ff8e2a0453a8187edebf1de03c1cc5264ddca43' }, "Are you sure you want to delete this entry? This action cannot be undone."), index.h("div", { key: 'b159229eee4cce745d55b4955c8516bc7fe31ef8', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '14862d2de6273c239bbc5cf24a702ed4d831affe', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), index.h("ir-custom-button", { key: '8c1cf509a2ab64c2e642b9155984fc245bd98b54', size: "medium", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), index.h("ir-city-ledger-transaction-drawer", { key: '6d672f0b22531be7f693dc6e3d821f83b9338deb', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h("form", { key: '61e590720bbb3356cceefd8989fc57ff0e40a641', onSubmit: e => {
                e.preventDefault();
                ...
                this.emitFilters();
            } })), index.h("div", { key: '41f0b681de76c85e39bfccfdcb7257621b2dd92f', class: "filters-bar__search-group" }, index.h("wa-select", { key: '8bed4068f0bf85b41703c125b9e310ba895ebbea', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: '680d534fa971bf92043c8873941340d715b97ef5', class: "filters-bar__search-input", "onText-change": e => {
                ...
                status: this.statusFilter,
                search: '',
            }), value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: '733db4e7b6680d08e3ba8694fb9df8a2015619da', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'b594a3bc27d5c533a64687ce9520565a58add83d', variant: "neutral", type: "submit", appearance: "outlined" }, index.h("wa-icon", { key: '6ea9ce056684c35b9dfa87a2047edfaeecc38611', name: "magnifying-glass" }))), index.h("div", { key: 'e07e2b757b9946b86020b4e8fa425495905b62d4', class: "filters-bar__actions" }, index.h("ir-custom-button", { key: '0df1175bb1a27d180dfe0b224cae25b13be0cd58', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, index.h("wa-icon", { key: '9189858a4e9b70561868fbebad78407b54326213', name: "download", slot: "start" }), index.h("span", { key: '16fcd1c98e5a03e3a5569c29d6d63cd70f3843b3' }, "Export")), index.h("ir-custom-button", { key: '5f36d40381f6a7aaf1c1c4483844e0927f67da58', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    debounce.Debounce(300)
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: '728d6efdbe7d48661bb2fcc9dfd82b53dbf76840' }, index.h("section", { key: '3d207feb1c9df82da9533b931ed6ef08d2ab6f09', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: '139dd9e37860800f4653042d643ed2abaecf1878', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
                this.filters = e.detail;
            ...
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: '47edb642fc804ae86c65227796f70a0e43af3cbb', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), index.h("ir-preview-screen-dialog", { key: '88b88904910cb7f2fceeed16922198e5a7cd01c2', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: '48f2acf2900406a11e33c2780465318f65d8e137', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: '6d7fdefaf3464574f06f622b83e07bb8b03bee22', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: 'b147320d4b1b2ec431f16d56e589ca62039dce96', name: "download", label: "Download PDF" })))), this.printFilters &&
...
const IrCityLedgerStatementsFilter = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '8e6dab2700624131c28608c77434b54af728b0e9', onSubmit: e => {
                e.preventDefault();
                if (canCreate)
                    this.createStatement.emit({ fromDate: this.fromDate, toDate: this.toDate });
            } }, index.h("div", { key: '80dd6e63f4790e00dab0550d23b62d104deb460f', class: "stmt-filters" }, index.h("ir-validator", { key: 'b9750f6fe5fc2f5e6d2f73009bec33bae4db28ca', schema: index$2.z.object({
                fromDate: index$2.z.string().nonempty(),
                toDate: index$2.z.string().nonempty(),
            }), value: {
                fromDate: this.fromDate,
                toDate: this.toDate,
            }, class: "stmt-filters__left" }, index.h("ir-date-range-filter", { key: '8b50812910c2cc9bcf32ab6482ca7bb9d103e272', class: "stmt-filters__date-picker", maxDate: moment.hooks().format('YYYY-MM-DD'), fromDate: this.fromDate, toDate: this.toDate, onDatesChanged: e => {
            ...
            } })), index.h("div", { key: '9498cb0d2922d215a00357da61f81a50e53781b9', class: "stmt-filters__right" }, index.h("ir-custom-button", { key: 'f04ce51ab8b532a8842f9b465265f18cd42b060a', variant: "brand", type: "submit" }, "Create Statement"), index.h("ir-custom-button", { key: '4b9b882b4382277ff1b766a83cdfe9a8e330c2d2', variant: "brand", appearance: "outlined", disabled: !canCreate, onClickHandler: () => {
                if (canCreate) {
