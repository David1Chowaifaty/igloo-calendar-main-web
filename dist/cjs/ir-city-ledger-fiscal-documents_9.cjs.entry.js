...
var index$1 = require('./index-Bz_RxYiw.js');
...
var cityLedger_service = require('./city-ledger.service-DO3GSBd2.js');
...
const IrCityLedgerFiscalDocuments = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6f6b1c5653e77c202011680601c97fb279d00bf9' }, index.h("section", { key: 'b5b4218d024b4aca328928afd8290fcd2ba79604', class: "fiscal-documents", "aria-label": "City ledger fiscal documents" }, index.h("ir-city-ledger-fiscal-documents-filters", { key: '56d4d23f7afebd96ef2ced9d25e99c2d4787df85', filters: this.filters, onFiltersChange: event => {
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: '596f11ad2f05bcc92f5f764fce55bc0a5febceb6', onSubmit: e => {
                e.preventDefault();
                this.applyFilters.emit(this.filters);
            } }, index.h("div", { key: 'd8e36d29452a45a5fad2eb2691e1c703518b83eb', class: "filters-bar" }, index.h("ir-validator", { key: 'efd4fe789dedde20c7c354217a31a04f21aa9eb2', value: this.filters?.fromDate || this.filters?.toDate, schema: index$2.libExports.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '612275d7f88d85eb3b45997346e60274492035da', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: '997a29de28a66f61371453097d4090706dd0f526', class: "filters-bar__search-group" }, index.h("div", { key: 'c27f6badcc556c9d439a2d97b486f0afa33f985d', class: "filters-bar__type-group" }, index.h("wa-select", { key: 'b9bd08744224659f792c505482bd4ad7cdb1e7e5', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: 'e03fa2ea233cafcbc74e1e8e08e6ea95a275a3f2', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), index.h("wa-switch", { key: '6b42f3100bb348fe6857be50b55361f690ffd4cc', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Proforma")), index.h("ir-input", { key: 'c1c64bcb6f2d20f03348b3bc4311d23daf210cb7', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: 'f3c0c5c1a0e2f7f476e33237af14033dfa159f84', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'fd2fa27bd4351c48031be1677b89d6c40ce2529e', variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: '68a3894e708cea828208928e3952b79b18dd68c6', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '20a7a8b2fa338c393fedb2ee17cfef93158c7f2f' }, index.h("ir-city-ledger-folio-filters", { key: '6bfe4fbde3f8b306a9ff8d434913c208f1f28ec9', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), index.h("ir-dialog", { key: '672f9b91f955c6c90e6ccaed86226e99141aed21', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, index.h("p", { key: 'a12bd210dc20a43c4a4e3a824f7aca76a2e29e2f' }, "Are you sure you want to delete this entry? This action cannot be undone."), index.h("div", { key: 'accf692012cb3b6f33db5a33015dc1d15e31475b', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'baa3529ada54abc923b7afbedebe1b841ad1af1a', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), index.h("ir-custom-button", { key: 'aaf38d016f3a04354965186a5eb67bbd01a988f1', size: "m", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), index.h("ir-city-ledger-transaction-drawer", { key: '0beaa74fe997effa7a626600169f8288d656127c', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h("form", { key: 'c560dc9e92db40cf8f0649cada6006575df7d488', onSubmit: e => {
                e.preventDefault();
            ...
            } }, index.h("div", { key: '28d6b12e9277dbb91327ab0c5291a015e47674a5', class: "filters-bar" }, index.h("ir-validator", { key: '3cd03c2d1ce13834dede00f43ee25b87aa14f541', value: this.dates?.from?.format('YYYY-MM-DD') || this.dates?.to?.format('YYYY-MM-DD'), schema: index$2.libExports.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: 'f5af7bb5af3eb389ce09941708e116e553a2c964', maxDate: moment.hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), index.h("div", { key: 'f2e62f6933f1dfd703f82c2e3058950aebf6696a', class: "filters-bar__search-group" }, index.h("wa-select", { key: '8f93879f9a96961bfa7d466cb8692cf42b6d577f', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "s", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: 'df66cc50790ddb034d3d262afb88a44525757c93', class: "filters-bar__search-input", "onText-change": e => {
                ...
                status: this.statusFilter,
                search: '',
            }), value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: 'bbaffe5e8f2852831301b867b0bf4d3f12a5d9fc', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '05ede61ebbdc6549fbf20d0ff9711f09c8e4528e', variant: "neutral", type: "submit", appearance: "outlined" }, index.h("wa-icon", { key: '5a5477170969b9dd6be79e90f25ce25a301bd371', name: "magnifying-glass" }))), index.h("div", { key: '443c2512bcbb2ef68dff6a2e54295d94e5d8557f', class: "filters-bar__actions" }, index.h("ir-custom-button", { key: '867da16debcf97f8f6b7d1f87599944824ee052f', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, index.h("wa-icon", { key: '38cb41b9ec00950ddb9011718efa83d06026c768', name: "download", slot: "start" }), index.h("span", { key: '1b7def08a64c65920e3967bd5e738cfd71284b63' }, "Export")), index.h("ir-custom-button", { key: 'e4b1f3a56e39815d61c908a6e4aa1dd1c1e63e72', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    debounce.Debounce(300)
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: '08ece72f60c13f4b0a3d1b6d69fb423c78410cf5' }, index.h("section", { key: 'c06c623e4fa54eb99fb03c7a29fa2f31c00a11bb', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: '5a322707a00caa1bed16788d8b786a6709136f1b', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
                this.filters = e.detail;
            ...
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: 'f0e794599ec40cb1f2ee8354f91a33b2b6a9736f', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), index.h("ir-preview-screen-dialog", { key: '8aceb38b7af50b9f574154ff7dfa7f48801fcc0b', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: '0a6850732692bb992282c8083982a136d4e64d50', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: '8a32cc2e20d2704dd1e99ec9fd41704b6f81855e', size: "m", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: 'e10080843ca86e998eeda703799127b49c714b54', name: "download", label: "Download PDF" })))), this.printFilters &&
