...
const IrPaymentDetails = class {
    ...
    render() {
        ...
        return [
            index.h("div", { class: "card m-0" }, index.h("div", { class: "p-1" }, this.bookingDetails.cost > 0 && this.bookingDetails.cost !== null && (index.h("div", { class: "mb-2 h4" }, "Total cost: ", index.h("span", null, _formatAmount(this.bookingDetails.cost, this.bookingDetails.currency.code)))), index.h("div", { class: "mb-2 h4" }, this.defaultTexts.entries.Lcz_DueBalance, ":", ' ', index.h("span", { class: "danger font-weight-bold" }, _formatAmount(this.bookingDetails.financial.due_amount, this.bookingDetails.currency.code))), this.bookingGuarantee(), index.h("div", { class: "mt-2" }, index.h("div", null, ((_b = (_a = this.bookingDetails.financial) === null || _a === void 0 ? void 0 : _a.due_dates) === null || _b === void 0 ? void 0 : _b.length) > 0 && (index.h(index.Fragment, null, index.h("div", { class: "d-flex align-items-center" }, index.h("strong", { class: "mr-1" }, this.defaultTexts.entries.Lcz_PaymentDueDates), index.h("ir-icon", { id: "drawer-icon", "data-toggle": "collapse", "data-target": `.roomName`, "aria-expanded": "false", "aria-controls": "myCollapse", class: "sm-padding-right pointer", onClick: () => {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '93d25016a5c21a22262d37ffeb2e0f12d2ab3931', class: "p-1 d-flex m-0" }, index.h("ir-icon", { key: '832811ae22c50c1ce7d8c9fb5e75037cb6a99bd1', id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "pointer mr-1", onClick: () => {
            ...
            this.item.days.map(item => {
                return (index.h("tr", null, index.h("td", { class: 'pr-2 text-right' }, _getDay(item.date)), index.h("td", { class: "text-right" }, _formatAmount(item.amount, this.currency)), item.cost > 0 && item.cost !== null && index.h("td", { class: "pl-2 text-right night-cost" }, _formatAmount(item.cost, this.currency))));
            }), index.h("tr", { key: '5dc049ff4130ce70cb0f2391185d9e03d19fb5a6' }, index.h("th", { key: '01b6a78cd9397cf8a1e46219707225b67fcd86a5', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: '496ec099f63373d414937b07d4d1ea0db10d1b18', class: "text-right" }, _formatAmount(this.item.total, this.currency))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("div", { key: 'ea728dc3460c5a408d927bdc0790c0270c24b6cb', class: "sm-mb-1", innerHTML: this.item.rateplan.cancelation || '' }), index.h("div", { key: '8370523f0410d3153a559a019abb0b0e33eea9a3', class: "sm-mb-1", innerHTML: this.item.rateplan.guarantee || '' }), index.h("ir-label", { key: '7bac9893eefda8da15de50b51151ffb5c9bd77e8', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), index.h("ir-modal", { key: '042bf8370106322c4c35935a151014c1a885bfe0', onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
