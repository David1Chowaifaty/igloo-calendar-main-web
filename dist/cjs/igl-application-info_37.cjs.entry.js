...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ef70d87205438731676adfeeabdec14f93e16f80' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), index.h("div", { key: '319def6bb0048641695657a9d7ee0e697be8711d', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, index.h("fieldset", { key: 'c3922a5afea60237f067fe696590680b10f3f673', class: "mt-lg-0  " }, index.h("igl-date-range", { key: '317e0fb4044c1412ee0b175fb65528199428e288', dateLabel: locales_store.locales.entries.Lcz_Dates, minDate: this.isEventType('PLUS_BOOKING') ? moment.hooks().add(-1, 'months').startOf('month').format('YYYY-MM-DD') : this.minDate, disabled: this.isEventType('BAR_BOOKING') || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: 'b296c2182995c5ae370bb59d5ecefbc99ac15e72', class: "text-right mt-1 message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8085bb09b1fc3ff8a252c851de668a0a8c265c27' }, index.h("div", { key: '5ae75829001ae3a3cb8221bdb7d66ae35299e2ab', class: "text-left mt-3" }, index.h("div", { key: '211d29f71a49622b72ac3672c45ae0594b9cdd31', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: 'ad5d423298ae2ba302035b2c4616c0d5276e67bc', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: '4953b4ae4797ccfaec8b242fa2684ada226b65dd', class: "bookedByEmailContainer mt-1 mt-md-0" }, index.h("ir-autocomplete", { key: '9f660add26e6886487f8f74f7ba823b33105f0b2', danger_border: this.isButtonPressed && this.bookedByData.email === '', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "email", value: this.bookedByData.email, required: true, placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent() })))), index.h("div", { key: '96f981f3ec5aff9d19b4cf9b72731a9a1f373081', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '36669d31d7c1d0816f00ba18449f736c6f606e11', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: '10614368b9411fb19ebfa4e75d4f2948c9d730d0', class: "p-0 flex-fill " }, index.h("div", { key: 'def32dbd94e6382931c12985299b42e91e26678e', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: '0c6cba219a25c5ca293a21c6af24b931807ac4f0', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: 'a702ae5bf8c78980b5736b50073668185a2c31ad', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: '6e8b0fb02027e902630cde0ff8e592a947f3dfc8', class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => this.handleDataChange('firstName', event), required: true }))), index.h("div", { key: 'de065e9dd0b4cc9c62f59270b292b8f3bd04fdb7', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'c2f5c450016aa34fbe2ab2b10866f75e14b8a50b', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '74e54a7d6b4c53d7ad0b1ae707c8e2a527026605', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '2585817b549f732b968416c1f340802133426821', class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: 'ed11939b4eea912b4f08c1c3ad5b77bb8065783f', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '6343c442f0beee8880324c8225bd54a8c89300bb', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("div", { key: '3cb9a473da355de2d0da4cad5b8e213a59f1da7e', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '76937cf03c21a4b48bfdc38d92f0b180c30218cd', class: `form-control input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('countryId', event) }, index.h("option", { key: '2db0b0ad990e22db472d838b6a0a8d407ec87a18', value: "", selected: this.bookedByData.countryId === '' }, locales_store.locales.entries.Lcz_Select), this.countryNodeList.map(countryNode => (index.h("option", { value: countryNode.id, selected: this.bookedByData.countryId === countryNode.id }, countryNode.name)))))), index.h("div", { key: 'bb39f612710c0fd97d0f1902621c8362cd7bddd7', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'e94f7f4bef407c35a5930404a9bfa2eea66b83a3', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: 'dd523b0524c21460530f77d750c5ad8711612333', class: "p-0 m-0  d-flex  controlContainer flex-fill" }, index.h("div", { key: '9bd064dba20a6710f29e30d83ab1352abcd6f05b', class: " p-0 m-0" }, index.h("select", { key: 'eab088a6dbde4d9e55055628e086452417fb78f9', class: `form-control input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('isdCode', event) }, index.h("option", { key: 'bfead3711bd89bec23b76fd5dbd90e2a7b2813ba', value: "", selected: this.bookedByData.isdCode === '' }, locales_store.locales.entries.Lcz_Isd), this.countryNodeList.map(country => (index.h("option", { value: country.id, selected: this.bookedByData.isdCode === country.id.toString() }, country.phone_prefix))))), index.h("div", { key: '92c12e3e3ae775c073694a3bf100d588d58c7881', class: "flex-fill p-0 m-0" }, index.h("input", { key: '26c60dcd6ca8136630df5766f293234867fdf34e', class: `form-control
                     
                      `, type: "tel", placeholder: locales_store.locales.entries.Lcz_ContactNumber, id: v4.v4(), value: this.bookedByData.contactNumber, onInput: event => this.handleNumberInput('contactNumber', event) })))), index.h("div", { key: 'd7ea90fab261cf05b819cb2cbce29db575527e44', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '7626601aeeec639f673e94aa8ddd35002ce8f8f9', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: '9f27ee3c1edc8bb703146ce1d55cde904cc929d6', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '6880f056df9b51bf6bef70781194e7298f9f9ae2', class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: '1e6a08c00b3580a5369b20458f37b4f22f58eedc', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: 'a951122c71aad518650922e52362762ab2b3fcf8', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: 'ce5af7bf620146e5281cb06d15e049240dfcaf57', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: '10a785ad9a665b716cbfc1cfbbf3321232fc0cc4', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: '2cb0b7519c0b8faa4df8fc937de7e1e4595591d6', id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, null, index.h("div", { class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { class: "p-0 m-0" }, index.h("select", { class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { class: "p-0 m-0 ml-1" }, index.h("select", { class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: '0dacca385aaffd18734bf24ff936dc8cc50ba8bb', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: '16a7f51e5403d266d8ea5156a5bd6535acca0fd4', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: 'a103bb926e7917f34c6f57184cc9ce7113f50a48', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: '6501ba9abe408a2759990545ba80ae666be34ab6', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IrButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: 'c6ef3fc5a18150bc4a99da7d92a0d7b7ab6487db', id: this.btn_id, ref: el => (this.buttonEl = el), onClick: () => this.clickHanlder.emit(), class: `btn btn-${this.btn_color} ${this.btn_styles} d-flex align-items-center btn-${this.size} text-${this.textSize} ${blockClass}`, type: this.btn_type, disabled: this.btn_disabled }, index.h("span", { key: '111d46d6384dfc37293c3f5b4d1b8f0f73728073', class: "button-icon", "data-state": this.isLoading ? 'loading' : '' }, index.h("slot", { key: '279a656c5fb83bef6e10a1bba34860c749153d9d', name: "icon" })), this.text && index.h("span", { class: "button-text m-0" }, this.text), this.isLoading && index.h("div", { class: "loader m-0 p-0" })));
    }
};
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e0d0c7672955ce2f7caa3940058d43b0a3a4ef7a' }, index.h("slot", { key: '469221bcfafd2492471d1ebbc5b8e40aa681a5ce' })));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: '606a4868dd410be7615653390ebf2f426b066479' }, index.h("input", { key: 'e3ed1676d54e157e8e6fde76ac9e209ce2cc3b7f', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
};
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '73da39a88b8f59d70936a3535ee4589c37951c41', class: "d-flex align-items-center" }, index.h("span", { key: 'ddca3b951ab087d0c89600ea4f39134b97c7f3a2' }, this.dates.from_date), ' ', index.h("svg", { key: 'dbf6c9c2d876f8103a2ced0c8ef5485091ab247e', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '36f041d460d196812cb436185f7f2f95ff1648ae', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'f18f24c2315938dab740cef733fdf6f832f56117' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6694d5e3c8426db74e76ad459ac531c58b43eb1b' }, index.h("a", { key: 'ab31ab78b213f79829ce96d72a9606dd4bf770c5', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: 'bcb97016b71aa5d27f1d4e3619506c6ae4aaafa6', class: "sr-only" }, "download url")), index.h("section", { key: '1a405ab409d9c61c1469cda6e9e5e63700e48f58', class: "d-flex align-items-center " }, index.h("div", { key: '84e491089823ed1f787a08bed441aa51bf5da134', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '2461226c82b48c2b80a3b37c1b18c576192e4be6', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '602edc85d0cac182c6eaea897a6fa0bd9a60af25', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '35f823c49b498e3863060760241560a9a1e3d1b2' }, booking_listing.token && (index.h("igl-book-property-container", { withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, baseurl: this.baseurl, ticket: booking_listing.token }, index.h("button", { slot: "trigger", class: 'new-booking-btn' }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("h3", { key: '89e31e7d8aa1b7bb27c089bc200ea5494b679cb4', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: 'ab3986dbcdeb128b4a377cf02f119076e4070a0c', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: 'ffd4d8d47f4886400a066b9a306519fe28d5010f', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: 'e2f2c400308939fb5a57a8f4aced79665edf729e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '97ca1b977c0219d7804e818874bc27ea35d92a7d', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '3058ef82bcf70693dd8ef668349182027834e41e', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: '83724e32ed4b29cc2cfb9171788b97d9636cff40', class: "d-none d-md-block" }, booking_listing.token && (index.h("igl-book-property-container", { withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, baseurl: this.baseurl, ticket: booking_listing.token }, index.h("button", { slot: "trigger", class: 'new-booking-btn' }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("section", { key: '7253adaa200ac31f1a91d6aa56b886e68d0115cd', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '3c9369d6181001f6eca9e59125df6dc054d3add7' }), index.h("h5", { key: '9319e6ce3166c7d975da689f53a22e7f373bf8b3', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '40746c1f1d5b0488353e4010431d1758b39ad6b4' })), index.h("section", { key: '0303335b78f4abe3905732735a71a268ef268d43', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: '413dbcaab5ac318ff789b964c75048658e6d28c1', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("igl-date-range", { key: '9979f1af47897d45b97a0c0e1150d16a83c472d1', class: "flex-sm-wrap", minDate: "2000-01-01", withDateDifference: false, defaultData: {
                fromDate: booking_listing.userSelection.from,
                toDate: booking_listing.userSelection.to,
            } }), index.h("ir-select", { key: 'e7be4ac88d6208d393dd4229363c108a0fe711f8', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: '86bbe9d66e4b7b1df6ccc413932234793816e6b7', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: '89a6a15b634c0509d3601ea12973b6a6db4e69a3', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-icon", { key: '940b481b904e6bcfb364de94634bed1bd149a4ad', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, onIconClickHandler: () => this.handleSearchClicked(false) }, index.h("svg", { key: '9a54e89d6ed4a31f3161ba33a17eba07cb30cfee', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { key: '4ecb313df06c031eaa6c2214724d0dd6705a1bcb', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("ir-icon", { key: 'b00349d8da47407e9c01d948337acae4f9733d67', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, onIconClickHandler: () => this.handleClearUserField() }, index.h("svg", { key: '9476e7cedec0cb5a23e78ed3ac0fa30fd2bef4a8', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { key: '02473b4c2104a327858a1f2793f719851bbf5f24', fill: "currentColor", d: "M290.7 57.4L57.4 290.7c-25 25-25 65.5 0 90.5l80 80c12 12 28.3 18.7 45.3 18.7H288h9.4H512c17.7 0 32-14.3 32-32s-14.3-32-32-32H387.9L518.6 285.3c25-25 25-65.5 0-90.5L381.3 57.4c-25-25-65.5-25-90.5 0zM297.4 416H288l-105.4 0-80-80L227.3 211.3 364.7 348.7 297.4 416z" }))), index.h("ir-icon", { key: 'c8b27b5ef26d7abd42eb50da17022de8e1293aaf', onIconClickHandler: () => this.handleSearchClicked(true), title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel }, index.h("svg", { key: '07ac9accbd7c88981891fb2a738433eb6d8fe018', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "15", viewBox: "0 0 384 512" }, index.h("path", { key: '5b44babc76370a4bf3b1ca6acef19a2029b85877', fill: "currentColor", d: "M48 448V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm90.9 233.3c-8.1-10.5-23.2-12.3-33.7-4.2s-12.3 23.2-4.2 33.7L161.6 320l-44.5 57.3c-8.1 10.5-6.3 25.5 4.2 33.7s25.5 6.3 33.7-4.2L192 359.1l37.1 47.6c8.1 10.5 23.2 12.3 33.7 4.2s12.3-23.2 4.2-33.7L222.4 320l44.5-57.3c8.1-10.5 6.3-25.5-4.2-33.7s-25.5-6.3-33.7 4.2L192 280.9l-37.1-47.6z" })))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '4914bb67a184f183b16052d55d1014514cb0958f', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    this.closeModal();
                } }),
            index.h("div", { key: '2bd8dca9f922fdb2c317c8c7c6b39f62ae9d8db5', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '104ce6ce884e57d49122f87978704c16ed32356a', class: `ir-alert-content p-2` }, index.h("div", { key: '1283121b9d958dd3854704399bf7b0c5782f7978', class: `ir-alert-header align-items-center border-0 py-0 m-0 ` }), index.h("div", { key: 'acb317326636def16e21b7dc5f1233f605a75c0b', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '7e0f43fcc6b0923ef6fa6f83dba9520b2775855e' }, this.modalBody)), index.h("div", { key: '2444d9c5346a81b07e5dbdf465ad80c446a3798e', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && index.h("ir-button", { icon: '', btn_color: this.rightBtnColor, btn_block: true, text: this.rightBtnText, name: this.rightBtnText })))),
        ];
    }
};
...
const IrPaymentDetails = class {
    ...
    render() {
        ...
        return [
            index.h("div", { class: "card m-0" }, index.h("div", { class: "p-1" }, this.bookingDetails.cost > 0 && this.bookingDetails.cost !== null && (index.h("div", { class: "mb-2 h4 total-cost-container" }, "Total cost: ", index.h("span", null, _formatAmount(this.bookingDetails.cost, this.bookingDetails.currency.code)))), index.h("div", { class: "mb-2 h4" }, this.defaultTexts.entries.Lcz_DueBalance, ":", ' ', index.h("span", { class: "danger font-weight-bold" }, _formatAmount(this.bookingDetails.financial.due_amount, this.bookingDetails.currency.code))), this.bookingGuarantee(), index.h("div", { class: "mt-2" }, index.h("div", null, ((_b = (_a = this.bookingDetails.financial) === null || _a === void 0 ? void 0 : _a.due_dates) === null || _b === void 0 ? void 0 : _b.length) > 0 && (index.h(index.Fragment, null, index.h("div", { class: "d-flex align-items-center" }, index.h("strong", { class: "mr-1" }, this.defaultTexts.entries.Lcz_PaymentDueDates), index.h("ir-icon", { id: "drawer-icon", "data-toggle": "collapse", "data-target": `.roomName`, "aria-expanded": "false", "aria-controls": "myCollapse", class: "sm-padding-right pointer", onClick: () => {
...
const IrRoom = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '93d25016a5c21a22262d37ffeb2e0f12d2ab3931', class: "p-1 d-flex m-0" }, index.h("ir-icon", { key: '832811ae22c50c1ce7d8c9fb5e75037cb6a99bd1', id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "pointer mr-1", onClick: () => {
                this.collapsed = !this.collapsed;
            } }, !this.collapsed ? (index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { fill: "#104064", d: "M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "25", viewBox: "0 0 640 512", slot: "icon" }, index.h("path", { fill: "#104064", d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z" })))), index.h("div", { key: '046d8940d79aeb5d53aacb5ff1c7a7d304bdf81c', class: "flex-fill m-0 " }, index.h("div", { key: 'c0e510ed73f2859ca199b090db2c470b24328b03', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '1a079b1050a68b68b565608cf95bdf87e22baff6', class: "m-0 p-0" }, index.h("strong", { key: '690115a34f114b8c95aadb8b7b7718d6184edf88', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '091b6deff1d78775da21da4c3a8162cbf21a87c7', class: "d-flex m-0 p-0 align-items-center" }, index.h("span", { key: '36f6bc341e5f49e8a3b11e1349fa8937e9d6d0eb', class: "p-0 m-0 ml-1 font-weight-bold" }, _formatAmount(this.item['gross_total'], this.currency)), this.hasRoomEdit && (index.h("ir-icon", { id: `roomEdit-${this.item.identifier}`, class: "pointer mx-1", onClick: this.handleEditClick.bind(this) }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" })))), this.hasRoomDelete && (index.h("ir-icon", { onClick: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, class: "pointer" }, index.h("svg", { slot: "icon", fill: "#ff2441", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "14.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" })))))), index.h("div", { key: '1f00e351b81364f469e8c21b38cb007cbf2f2f8e', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: 'fdce0d79619efb38adbede63c7b8b7d595581999', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && index.h("span", { class: "light-blue-bg mr-2 " }, this.item.unit.name), this.hasCheckIn && index.h("ir-button", { id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), index.h("div", { key: '07134ecea0d4808ee4e502949913b0b43cd3856a' }, index.h("span", { key: '5b58ece347ab9d1ee207f13222b5a929d893f31c', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", null, " ", this.item.rateplan.selected_variation.adult_child_offering)), index.h("div", { key: 'cf10cde8913813398a2b3a42ce961c5862ee6399', class: "collapse", id: `roomCollapse-${this.item.identifier.split(' ').join('')}` }, index.h("div", { key: 'a6672aa6490c79437eb8cde946b9198300aec48e', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '3216008fc19caf567541b39c10a6e1620004baaf', class: " sm-padding-top" }, index.h("strong", { key: '2baf7a61f22ed7555c908cd93538b5af716c4ca5', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: '7a99a64b5850a2d29afdf0a51d820be654d37f79', class: 'flex-fill' }, index.h("table", { key: 'ae5243585f95068ea45219ea83d61f891bde9993' }, this.item.days.length > 0 &&
            this.item.days.map(item => {
                return (index.h("tr", null, index.h("td", { class: 'pr-2 text-right' }, _getDay(item.date)), index.h("td", { class: "text-right" }, _formatAmount(item.amount, this.currency)), item.cost > 0 && item.cost !== null && index.h("td", { class: "pl-2 text-left night-cost" }, _formatAmount(item.cost, this.currency))));
            }), index.h("tr", { key: 'c2213ea780f9a9d7f4000b255c22c0406cc3521b' }, index.h("th", { key: 'd2ff69f32a49aba4d3fb37d4e4b87842e83f9480', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: '1490df6fff68ba16ab506158afc3ed755c7d26d0', class: "text-right" }, _formatAmount(this.item.total, this.currency)), this.item.cost > 0 && this.item.cost !== null && index.h("td", { class: "pl-2 text-left night-cost" }, _formatAmount(this.item.cost, this.currency))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("div", { key: 'ae4f0116244021748bf4e8efdc4842feb48db33a', class: "sm-mb-1", innerHTML: this.item.rateplan.cancelation || '' }), index.h("div", { key: 'c0261b3f63c5c36b2141284a2f4d425318a2a9c3', class: "sm-mb-1", innerHTML: this.item.rateplan.guarantee || '' }), index.h("ir-label", { key: 'e6b2feb940292c7b899bcf033cb967e5dd473f89', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), index.h("ir-modal", { key: '8b07e8ce0429666dab15e69272fda451ee8c6fb8', onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '019cd52f797a5e1a65dd7e6a0cf9419295c54c47', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '299cbd5051a9473736dd352a40e45938f726a3a0', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("ir-icon", { class: "close", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("slot", { key: '8ffd996f6f1123528ae3d6fbebaf149c5cb22786', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_37.cjs.entry.js.map