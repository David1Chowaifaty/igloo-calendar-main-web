...
const events_service = require('./events.service-f8ea3d66.js');
const moment = require('./moment-1780b03a.js');
const toBeAssigned_service = require('./toBeAssigned.service-44a7d6a2.js');
...
const arrivals_store = require('./arrivals.store-c97db3c5.js');
...
const user_service = require('./user.service-a65d8844.js');
...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b6d84f1546674c81061d781a9d9788f5adbdbd1c', class: "p-1" }, index.h("ir-interceptor", { key: 'fb4cd13d59718954af23fdd7961eeb473447c974', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), index.h("ir-toast", { key: '81688cc77090c3a012b770aafd08049a4eb3acee' }), index.h("div", { key: '30e49f5ff0344d599f60d4ce646c7d1bd22b1b58', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, index.h("ir-input-text", { key: '6c011066fc16f3c1f11199bfb66ec8cb7b22198d', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), index.h("ir-button", { key: '893a00994bef139d429e50f19ca5b2928c4a35f9', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), index.h("p", { key: '5f5657270963ec776a6d38e1f0d6b91978fdcb28' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": ["handleTicketChange"]
    }; }
