...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'd89e74d04c47680409f55b92641b9fb2533e7cb3', open: this.open, onIrDialogHide: e => {
                ...
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: '3311aa5b79eac35dc2e7aa11e92ff247492fa73e', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '6064dff0643024720ebdba6632c133a6ee838e14', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '72752b08ac32a6f716ab10ee86ff9125c00001d2', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '18c975feea7b2ef85bd90ea07eaa301635cdc53b', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, index.h("div", { key: '19fac0c5a42b8885adb57c47cbb0279dd8d57727', slot: "header-actions", class: "ir-fullscreen-dialog__header-actions" }, index.h("slot", { key: '8cce3d66d67120b5b88739787a9110e6e13c4dd7', name: "header-actions" }), !this.hideDefaultAction && (index.h(index.Fragment, { key: 'd0bff5f910f85f5f59cfca4776a7e8a2c8be99f6' }, index.h("wa-tooltip", { key: 'b02405ab288d8be9e8f1b93b2b926ae399ce9972', for: this._id }, "Print PDF"), index.h("ir-custom-button", { key: 'cb648066da9d52d2392502e96ddb083c6c3b64ff', id: this._id, size: "medium", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'dca8d6b1bf3618f80783a241909683ae59d5d684', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() }))))), index.h("slot", { key: '1c1b18c15ef0c24cb3c4c92f1836c5ac73396fa8' })));
    }
};
