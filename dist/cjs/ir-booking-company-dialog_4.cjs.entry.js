...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '938f311e993fb0a8bddb26afb75b48303cd280c4', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: 'b50a1767d21d494aadcb7899dd6ffcae75ec7021', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: '9f6278d3da8e403c6e01d58b64a6bf3b499aa569', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '920404c77480b917692c0a445aea250bfb4751a8', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '7a3eac67f26fb83b7952d21b370f713340157834', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: '32395fd89b4d16b37471ad3ddf92cc565a93d5e2', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-input", { key: '42079e0c1e131b7ce24f38a1e277372d395d1d34', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-input", { key: 'fa2323f231db8b166b5da832a72a2e608d190c69', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '56c4d4c39d7f48522774ee09c683b4c38b88f513', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, index.h("div", { key: '6123987e8b54aa4fba1674a04d7991d28700f6d5', slot: "header-actions", class: "ir-fullscreen-dialog__header-actions" }, index.h("slot", { key: 'b5d4323e729c17705bf7f42486a2f5020c2c30ef', name: "header-actions" }), !this.hideDefaultAction && (index.h(index.Fragment, { key: '06be09a7b716ebd55ec7f831c7bb9355506b52c6' }, index.h("wa-tooltip", { key: '5e767f73ed4eb36f3785ac5681bbdd0d80334fcc', for: this._id }, "Print PDF"), index.h("ir-custom-button", { key: '39150d493cdc1589c4940060025d2bec125b7e6e', id: this._id, size: "medium", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'fd9b323801428cf3e4b7bdb2c9fce7c2165ba951', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() }))))), index.h("slot", { key: '730ed2d8e8e364e293216494ea8b9b0beede969c' })));
    }
};
...
//# sourceMappingURL=ir-booking-company-dialog_4.cjs.entry.js.map