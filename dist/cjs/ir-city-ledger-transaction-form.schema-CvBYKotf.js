...
const RoomsGuestsSchema = index.libExports.z.array(index.libExports.z
    .object({
...
const BookedByGuestSchema = index.libExports.z.object({
    firstName: index.libExports.z.string().nonempty(),
    lastName: index.libExports.z.string().nonempty(),
});
const dayUseTimeSchema = index.libExports.z
    .string()
    .trim()
    .regex(/^([01]\d|2[0-3]):[0-5]\d$/, 'Enter a valid time');
const DayUseHoursSchema = index.libExports.z.object({
