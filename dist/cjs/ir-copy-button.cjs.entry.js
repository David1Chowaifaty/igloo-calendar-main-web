...
const IrCopyButton = class {
    ...
    get tooltipMessage() {
        switch (this.currentState) {
            case 'loading':
                return t.t('Lcz_Copying', { fallback: 'Copying...' });
            case 'success':
                return t.t('Lcz_CopiedToClipboard', { fallback: 'Copied to clipboard' });
            case 'failed':
                return t.t('Lcz_CopyFailed', { fallback: 'Copy failed' });
            default:
                return t.t('Lcz_CopyToClipboard', { fallback: 'Copy to clipboard' });
        }
    }
