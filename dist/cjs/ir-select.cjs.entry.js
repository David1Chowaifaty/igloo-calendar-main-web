...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1bd369bf94e5a7ca46c5c2804255a88f35e909ce', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '5ba2e155b3dc046694e76e71a5339cfdc3e66954', class: "input-group row m-0" }, label, index.h("select", { key: '632bc9d873a2163557dca0d00c6c7921bb68ff4a', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'c9939927a757e14bdf16d27742daf3c8a14768df', value: '' }, this.firstOption), this.data.map(item => {
