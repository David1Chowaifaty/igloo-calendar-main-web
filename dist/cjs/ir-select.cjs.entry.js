...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '420e14bb0d8a7dbbd9776947b8a664b4235368ba', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'bad7095bb22f6a705a0903fcfe40aab87c65b192', class: "input-group row m-0" }, label, index.h("select", { key: '3273c1f1167c4d4d10d465672cc9531aacdc0eab', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '9b5d48c5ef801cd2b0a7613319ce0c45a988ea70', value: '' }, this.firstOption), this.data.map(item => {
