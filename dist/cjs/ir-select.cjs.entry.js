...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '179c34f87375faece97904be98c92256da3fa9cd', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '442a0313f6351eaa3dba495f215f478028a12f96', class: "input-group row m-0" }, label, index.h("select", { key: '2c2838b626e4ec659e3f7408663733b888d10d51', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '754d970f3df2f0f9f43b0fcbb701c943653643fc', value: '' }, this.firstOption), this.data.map(item => {
