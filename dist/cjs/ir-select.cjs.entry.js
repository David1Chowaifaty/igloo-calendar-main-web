...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '24301df3b6e51d8a05c9a1cd18a4a34c51e66273', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'a6c45269f2c7cb61d2cb005f782ab8f2e292ecae', class: "input-group row m-0" }, label, index.h("select", { key: '587d9fc7db55b9ceb43b516541145a69f459e8f7', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '8325da8f7e89b955c0178642b53d32bffd43a4fa', value: '' }, this.firstOption), this.data.map(item => {
