...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '926233e418618d39f5f17a844a73347ebcf563d9', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '02cd05f6fc06ffd0fcccc4acebd8934369453f13', class: "input-group row m-0" }, label, index.h("select", { key: '41dd40926d203c999cf8e144163849cf63a87a66', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'b2bb20e2024841f4af644bf9254d50b210b61d36', value: '' }, this.firstOption), this.data.map(item => {
