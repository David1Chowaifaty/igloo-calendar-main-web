...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5dd47bae67784288eb5857e650c03761cbcbcca6', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'cedce7beeae5fd457f21386a7caa4728db226aeb', class: "input-group row m-0" }, label, index.h("select", { key: '80e7291680d114f1d2c74e69eb37d8c9fe5d0d4c', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'd6fd740c2fa9db047a5d067ee28ab1d4a8399239', value: '' }, this.firstOption), this.data.map(item => {
