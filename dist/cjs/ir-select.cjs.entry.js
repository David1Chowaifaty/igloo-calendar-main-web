...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'c5c918ef7d03df90801edbdb12af130c30947990', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'd4fb0ef528cf8f60a268cc5e6481feb69d4b8043', class: "input-group row m-0" }, label, index.h("select", { key: '3eb6982dccd79811aba37a490e736cc94ad76441', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '2ee910b044b6705eb8feb5e93af9333391ebbbed', value: '' }, this.firstOption || t.t('Lcz_Select', { fallback: 'Select' })), this.data.map(item => {
