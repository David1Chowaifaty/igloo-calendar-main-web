...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ae693e73668c8f59908cac5b993a88c93b2e5482', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '9831d61f25e27e826274a8999648be9ad4c935f3', class: "input-group row m-0" }, label, index.h("select", { key: 'c27ada691216e45e926fed2be4f18fe9fc888ebf', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '967c345ee4469adefbb761f81fa84ff2cf9e9097', value: '' }, this.firstOption), this.data.map(item => {
