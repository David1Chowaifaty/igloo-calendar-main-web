...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '87504e5a9921dca5ecfcc1ca809c8f54cdc4ad0b', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '2aab319712bb46be5ff8e428feea1a6a512ff2b7', class: "input-group row m-0" }, label, index.h("select", { key: '21b364a75f260696a1228f85b647fd37db888b72', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '10bd8f45e946bb788662d92b3b2bccb6ec7d3353', value: '' }, this.firstOption), this.data.map(item => {
