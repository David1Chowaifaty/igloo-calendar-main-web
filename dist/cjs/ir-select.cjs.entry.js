...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a2e873a8c9ddb63f93861ad7d80fff5688d9ffc8', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'fa5389441b6ce5a9a16b87d3d4a6ed66c12ff8af', class: "input-group row m-0" }, label, index.h("select", { key: 'f76960b9b3426d6bd85db40426d6a33eed67050a', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '75a350c1e45385a4cdc0d876f530e3085874aa93', value: '' }, this.firstOption || t.t('Lcz_Select', { fallback: 'Select' })), this.data.map(item => {
