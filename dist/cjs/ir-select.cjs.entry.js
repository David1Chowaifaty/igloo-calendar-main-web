...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '6ef3f2b317a3a50b1f1921a76fa8dba7f4e3e371', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '55ca5ac9ef177d5eacc23a59fe0e6d31a21eeba7', class: "input-group row m-0" }, label, index.h("select", { key: '408b9062bc5a03db922489d639138e6ac93f3d52', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'e525082f27ba03de88d01cae84a1c7b5806fc0e4', value: '' }, this.firstOption), this.data.map(item => {
