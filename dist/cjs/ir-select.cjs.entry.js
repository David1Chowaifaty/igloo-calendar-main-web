...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '61d074e18127beba6af0100708b5aa8b697a7362', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'c4584487cc47892e8a2f33f857f730597f902664', class: "input-group row m-0" }, label, index.h("select", { key: '9263d0b200714d0a7ff8035b5a09730bf53065f1', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '3185981b44ae059fa67e6b95cb0a15ea3b0737ad', value: '' }, this.firstOption), this.data.map(item => {
