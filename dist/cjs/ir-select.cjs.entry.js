...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '592c92b98b2940f531da36af86de594eabc0f6e3', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '1df4a4f6571ff44f1c69e730ecd81983b13a235b', class: "input-group row m-0" }, label, index.h("select", { key: 'dd32ee1f0ef1b54843cd5d703328c0a2c822b92b', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'b3fd13fb9fcc7dd77e7d1ab7d6fea4aff76ef72c', value: '' }, this.firstOption), this.data.map(item => {
