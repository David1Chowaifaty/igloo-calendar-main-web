...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '8de516ac9e206072cc947cc0b06e962c98d28fb5', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '4ad87747860f02846e2fbdbde55e2bde9931378b', class: "input-group row m-0" }, label, index.h("select", { key: 'c062e175e20c2f0469505e07ba14d7add0494df7', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '06a77c2ffe78ec5ecb5fbbd7a002cbf0ae5b9659', value: '' }, this.firstOption), this.data.map(item => {
