...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5725e12a9930f86ae788ab624ff41b98b1e4a746', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '0190599fe22f8546a4ea5f39ec0a928343ffc752', class: "input-group row m-0" }, label, index.h("select", { key: '5f8e8f2a29025c23393f92fd367b615db7b20da4', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '935abd97b2f67ec327f718a6e68bfe4b5fbc989a', value: '' }, this.firstOption), this.data.map(item => {
