...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '08cccad01b896c272731da05361a29f85d59f77f', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'b3382995761dc6ecabf3384bfbbb7af5277c617b', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '0f9b7840a096fab07eeeef33750c196a1bb3f264', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'eaa2228f2cf836c4a0c4aef36750b8261fffc89d', class: "input-group row m-0" }, label, index.h("select", { key: '78cdf9f4a1404a916241f66acf17e406887066d8', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '2cc3f239024d90202f4a1d8217c8b847c64ce9a2', value: '' }, this.firstOption), this.data.map(item => {
