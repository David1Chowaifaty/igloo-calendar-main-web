...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1d7f4bcbd310acd35dcf9a76d68e3818db262e69', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '6c8ac9ff1aba5bcbf4f82b1ee9e96fa2768b7b78', class: "input-group row m-0" }, label, index.h("select", { key: '655fd9cd34a621cf48594ecd0bb24108e839bc43', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '6f9fdf027d16c0f0609c370eeff36501fc549a6d', value: '' }, this.firstOption), this.data.map(item => {
