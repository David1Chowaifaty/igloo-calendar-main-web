...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7653565e658fbd2daef5d040623a7d70ffdf9c6d', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '1ef70e24347d8bd08aa15372beb5b4954d06f330', class: "input-group row m-0" }, label, index.h("select", { key: '04c91003a4ab93c779ed62c0db2482c76d023613', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '149db97323728ac17af60f41cf4d861ecb732af8', value: '' }, this.firstOption), this.data.map(item => {
