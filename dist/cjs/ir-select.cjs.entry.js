...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f86b46676d9364ef41b10fd8ab351185131faa57', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '8a38b4089faf4430ddc590dda9600cca151e8dcc', class: "input-group row m-0" }, label, index.h("select", { key: '28a9182b3e013b254242fa0b436f1d83aa9a8b72', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ca22cba283fde2b4c44070fbf8f2ee3748304577', value: '' }, this.firstOption), this.data.map(item => {
