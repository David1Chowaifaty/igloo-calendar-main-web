...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '90f91853ed2bd9ae3d5b2d00c7bc14a5ed5e0c66', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'df7fc9ac9d307e7260e008cca2dd70d41c48ac02', class: "input-group row m-0" }, label, index.h("select", { key: '88c20c79aa0165427dda24cca70afb76c5e0aa27', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'be000774a2b42b9c3f5c8df0e1a1af92422ddfde', value: '' }, this.firstOption), this.data.map(item => {
