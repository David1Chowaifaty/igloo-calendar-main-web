...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7d18c03ceb5a2a1147d29f7e78b5e4310dd0a8fe', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '005798973e739050be0a6497c08605dc4ca8d90c', class: "input-group row m-0" }, label, index.h("select", { key: '4cd7257e476ce57a0df90be20bf9d2f8fcc65cd1', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ca6667d2f387ce54167fdee66197d4004b7a5556', value: '' }, this.firstOption), this.data.map(item => {
