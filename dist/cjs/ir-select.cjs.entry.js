...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e47f902f2921c2917f5d2f9edbb3859bba58beef', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '8a74fe1f3b2a4cf85be8147cf9bb303681373e7d', class: "input-group row m-0" }, label, index.h("select", { key: '60768b7704292a0bf9846b12068175e6ce7144ec', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'd40ae7763770f5a64325bf7c1f7ccdbc72cb6c42', value: '' }, this.firstOption), this.data.map(item => {
