...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e5d7d4a6847f2aeb661336fafed2ccff06d55590', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '8cc9c586ad7e2e3ab3bab8b54afe353a8bfe8410', class: "input-group row m-0" }, label, index.h("select", { key: '11bb55de705b57e3f09eb52a755eac8b44fbc6b1', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'a16a964ae79e13fbfe37132d09d43d99b88820b0', value: '' }, this.firstOption), this.data.map(item => {
