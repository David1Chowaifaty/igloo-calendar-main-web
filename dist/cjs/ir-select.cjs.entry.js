...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'efb60320ed8135a9d198f2fd6a8330c1ee408f14', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '419b4e3c357dacbba40d8b0298840c54ee175d46', class: "input-group row m-0" }, label, index.h("select", { key: '59a1a7723ba7073ae6dd82ee44df55fc024fc972', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'a64297706b1115f8a6eea2179879bf438fa7aa5e', value: '' }, this.firstOption), this.data.map(item => {
