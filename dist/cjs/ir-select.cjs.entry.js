...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '8dda2f3d25fee9def8403303521c63d020af9ffe', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '6caa63c8d3a6b6f9320f2af1c1422cd63bf9a8ac', class: "input-group row m-0" }, label, index.h("select", { key: 'c10c2cacfe32ea259ec2292519d2bffa494399cf', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '6608a278d2e4f6c4c4e0d6a3bcb5719d04ec406b', value: '' }, this.firstOption), this.data.map(item => {
