...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '91efbc0a8ac14bdab2f30e544e1240ba1a9bb52c', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'e006d67f637e9f5c2a2d7bafb861e282a37243cb', class: "input-group row m-0" }, label, index.h("select", { key: '71c25e96fae8301db1689e676eca8bf792d5a510', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '5fd52db19fc15f956e951d45873375124353ea9e', value: '' }, this.firstOption), this.data.map(item => {
