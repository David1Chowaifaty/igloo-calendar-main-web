...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '822fda1187d2b67a830d8ceaac122ef82b5d392e', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '1a7d4fead6fcb2c771c7c2417aebf9c7af784718', class: "input-group row m-0" }, label, index.h("select", { key: '168c13a24bfb962be101545f6ce7a14c96912f56', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '7d8eed786ce3e2d6fb9e60400bba2a5ff19a269a', value: '' }, this.firstOption), this.data.map(item => {
