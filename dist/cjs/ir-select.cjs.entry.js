...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '729eba0baaa03ea0966e2792f2d038c12f67e961', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'fccbdc4f60c0fc07345d31acd3cbdf5b39bd59ae', class: "input-group row m-0" }, label, index.h("select", { key: '84caee75f3e431ecdababbfea46036b9b645d46a', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '169f4cf1b717462d63f5a4c06ad7d396fa4bd997', value: '' }, this.firstOption), this.data.map(item => {
