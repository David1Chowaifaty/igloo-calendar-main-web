...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a17be5adb5e6305948cf8d61860d5c99deac0989', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'c51c1f9df3437edde34d344c0d519fa29ec19d90', class: "input-group row m-0" }, label, index.h("select", { key: '820bb517404117784becb77b5ef039eb2cccf711', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ca20ac83817509cdd4fc79b52c1451cb155e04f4', value: '' }, this.firstOption), this.data.map(item => {
