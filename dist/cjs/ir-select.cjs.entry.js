...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'c92ca43b38c60c4b6c9eba0f2682993b777d4eb7', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '7b9dcd828fde4666e410e24efd47b93434dc9c17', class: "input-group row m-0" }, label, index.h("select", { key: '8498244eacc8b11f5c396a750c8e904ce3cd2f7a', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '458f865b2bde82e25f242394a985fdfaf01f054b', value: '' }, this.firstOption), this.data.map(item => {
