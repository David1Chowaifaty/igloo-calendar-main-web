...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'bce976e4592b4a1455be60d2399c33393836dbd0', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'da82b9862640e137558784697dd11432a745af8c', class: "input-group row m-0" }, label, index.h("select", { key: '28a58fd77bd6cd3dec867cd779f5caf1ecf33245', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '6abcafc9e8389633d0a6e3eee5ece45d401178f6', value: '' }, this.firstOption), this.data.map(item => {
