...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1aebd06a9a6413e96b2f2321c9a4ac2e5671db5c', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '7209db9b93221074f11c0240c6205e415fe5eb0c', class: "input-group row m-0" }, label, index.h("select", { key: 'd051217fb522b0b9bd3c5b7b3188b24a9c1aa6ef', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '568b2afe0037239d059110e26ed36fe7e9336a62', value: '' }, this.firstOption), this.data.map(item => {
