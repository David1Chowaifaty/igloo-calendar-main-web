...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0410f3484af162fb12b5e597b395ec116277a623', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '0062cf48211236665b457c9db3e34f06c945438e', class: "input-group row m-0" }, label, index.h("select", { key: 'ee2f847b99ecf033b630b12e22007e69b31ccb35', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ac4c0f4681f06625969eed6f89767c09dfbb98f7', value: '' }, this.firstOption), this.data.map(item => {
