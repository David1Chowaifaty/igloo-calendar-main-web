...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a27555925f3f027494cd890615ec6638eab761ac', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '7e32221508fcdc47b4e189b7b21d61fc6803bc89', class: "input-group row m-0" }, label, index.h("select", { key: '741644bfec67a7ba7f94365700a6970cebe7af47', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '497feaa65ae3f633284aeb6b25b1aa738a6dc634', value: '' }, this.firstOption), this.data.map(item => {
