...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '35809658eb2074115fd9850843bb1cb5d8a2563e', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'a6bb70e3369eaa0045e06f18cff5718066eeb013', class: "input-group row m-0" }, label, index.h("select", { key: '80829d108d1902609ac03b4bb284f167193a1d79', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ad6ef15b2dab07c54f4b5c20b58159ab900b4247', value: '' }, this.firstOption), this.data.map(item => {
