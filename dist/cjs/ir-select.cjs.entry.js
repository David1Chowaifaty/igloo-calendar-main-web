...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '76a90023b1ee74bd7ff59c7a426fb9d5352bb0b0', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '3d84c0e891b1943b535ca01dfa1adb8b1c6c15c5', class: "input-group row m-0" }, label, index.h("select", { key: '423d4a7c89ffdb3ba7ebaea44747f33df92003fe', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '5d524ceffba07d67c0d40162602cad737017da2a', value: '' }, this.firstOption), this.data.map(item => {
