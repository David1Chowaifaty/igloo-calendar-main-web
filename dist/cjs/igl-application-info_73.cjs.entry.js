...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bba6e3ef0de667f5b343ecc7ca5e2181536646f9', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: 'e49e5e9410189e0c053dd67eac899090148062f3', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '3703614481f7d4f1fff959c036eeaedd02edc451', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: 'fd2eaa9edcdc85dd6efcf0a5ddc57597703c8165', class: "fd-application-info__details" }, index.h("div", { key: '10652d506d23fe8a16becc4a99957f6a5ba5a385', class: "fd-application-info__rateplan" }, index.h("p", { key: 'e6f3f9f76282330410ee5f6bb74b5265555bc7fc', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '4f8cc3335d77b25e7c9bb62fc93e2081284bea63', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: '3d4b259caa33b726b90d0d9239117d83e9edc08e', for: `room_info_tooltip_${this.rateplanSelection.ratePlan.id}` }, index.h("span", { key: '276df92764cd28866832af1cd617ea3915f310ba', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '4e4a0dcd4d51c76f5757da52393bd44ca0e7fb2b', name: "circle-info", id: `room_info_tooltip_${this.rateplanSelection.ratePlan.id}` })), index.h("p", { key: 'a2742ff9a8095a5120a14d27d2deedec64beb915', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: '84a525d20b4f734e54abb7613ceec4aacb0ba841', class: "fd-application-info__price p-0 m-0" }, index.h("span", { key: '8b44edc5d780f6f2adeac3584b5dc437307d50e0', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.getAmount())), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: '7596d818ea570592d28fc6a7624e1b796107c346', class: "fd-application-info__footer" }, index.h("div", { key: 'ef03c8f3cbe9013dca3e8127a1786b963870f387', class: "fd-application-info__rateplan" }, index.h("p", { key: '4a2e7b635d8fd31f5d11fa92331e855b93d78b84', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: '9df6f75cf68b702e92a9c9b8fb969bf80a961542', for: `room_info_tooltip_mobile_${this.rateplanSelection.ratePlan.id}` }, index.h("span", { key: 'ad9b4b7605088b100a563c59c10701529edaecb8', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'b8b7c5d097115d7d3c479bc9162c8b7eaa67f79b', name: "circle-info", id: `room_info_tooltip_mobile_${this.rateplanSelection.ratePlan.id}` })), index.h("p", { key: '2dca3970438a830a665a83c4e76a6dcfa1b714d4', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: '51b40f040834b3389d18091e43a2522f6a09ccb1', class: "fd-application-info__form" }, index.h("ir-input", { key: 'df01252c78bc15a6937305e28ec8a715f591a028', class: "fd-application-info__input", "aria-invalid": String(Boolean(this.isButtonPressed && this.guestInfo?.first_name === '')), value: this.guestInfo?.first_name, defaultValue: this.guestInfo?.first_name, "data-testid": "guest_first_name", placeholder: locales_store.locales.entries['Lcz_GuestFirstname'] ?? 'Guest first name', "onText-change": event => {
            ...
            } }), index.h("ir-input", { key: '82821525b28eef32560e99f86e28473f37e75479', class: "fd-application-info__input", type: "text", "aria-invalid": String(Boolean(this.isButtonPressed && this.guestInfo?.last_name === '')), value: this.guestInfo?.last_name, defaultValue: this.guestInfo?.last_name, "data-testid": "guest_last_name", placeholder: locales_store.locales.entries['Lcz_GuestLastname'] ?? 'Guest last name', "onText-change": event => {
                const name = event.detail;
...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '533b5dfb225628e59bd9fb943f245423b738b7ce' }, index.h("div", { key: '008ca795bd9effa19975e17cd93a55098a958a17', class: `m-0 p-0 mb-1` }, index.h("div", { key: 'f669e605643c95f630d30974397dfdb56653ea5d', class: "text-left p-0" }, index.h("ir-date-view", { key: '307d484aa5ddd0f5e9c36715b732537d5ef8c47b', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), index.h("div", { key: '7e66ccc62a445dab418376c4fab2d534b12735c5', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { key: '19bb8a475c58c1543577d596d284276065e3681b', class: "mb-1 " }, index.h("label", { key: '6687faa9553546c14977be4340926973e01ae677', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales_store.locales.entries.Lcz_Reason, ":"), index.h("div", { key: '6d9b0181a71ea891b08306fde905b860f9422339', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { key: 'f13e5bde7087209a8ff907dce8d4649959eda6aa', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { key: '06a58bd41864f479fb57da19df00bf71fc448895', class: "align-middle out-of-service-label" }, locales_store.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, locales_store.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: locales_store.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, locales_store.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, locales_store.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6a35f14148031cfabb3c52344c3590f8261abcbc', "data-testid": "book_property_sheet h-100" }, index.h("div", { key: 'b7d80b588a3738b0b63c348f9a1a6aab1a188c2c', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: '2c85dc0c23fc78cf7c9cb28678419848bd98df90', class: 'sideWindow sheet-container ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, irInterceptor_store.isRequestPending('/Get_Setup_Entries_By_TBL_NAME_MULTI') ? (index.h("div", { class: 'loading-container' }, index.h("ir-spinner", null))) : (index.h(index.Fragment, null, index.h("div", { class: "sheet-header" }, index.h("div", { class: "card-header-container" }, index.h("h3", { class: "text-left font-medium-2 px-2" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: 'aa5c4119d8ab509d26d2432b683e229c73dc911c', class: "d-flex flex-column h-100" }, index.h("div", { key: '026cd60d99870efce6c617cac60c4c55661b57f5', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: '8cbb0fd97f37fb49f1187e78dac6d39110939d3f', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: '4ecc287ab9453b638e911e1529077b2024ee573c', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: 'e94320ee3c7509f5b0a82fdb679c2fa3ccd3a6c9', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglDateRange = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'accf2f45167fba8d7d3795b18c1ded2cd4ca829f', size: this.size }, index.h("div", { key: '9f1e4a253495e256ac1e691d9e81dafbc351a6de', class: `date-range-shell ${this.disabled ? 'disabled' : ''} ${this.variant === 'booking' ? 'picker' : ''}` }, index.h("ir-date-range", { key: 'c284c81d0acdc5435ce080703d65b78aa6778f6d', maxDate: this.maxDate, class: 'date-range-input', disabled: this.disabled, fromDate: this.fromDate, toDate: this.toDate, minDate: this.minDate, autoApply: true, "data-state": this.disabled ? 'disabled' : 'active', onDateChanged: evt => {
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'af52b99885c637dace739a851265c088ff775769' }, index.h("div", { key: '1c92ea318d85888d818f570c8f9932132c7ce827', class: "text-left mt-3" }, index.h("div", { key: '69c9f2cc78af031313cbbf911d9a07ad36b20d38', class: "d-flex", style: { alignItems: 'flex-end', gap: '0.5rem' } }, index.h("ir-picker", { key: '0f623ec2f6bfa31da66a494e4e810c59bb90e54a', class: "bookedByEmailContainer m-0 p-0", label: locales_store.locales.entries.Lcz_BookedBy, value: this.bookedByData.email, "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email))), withClear: true, "onText-change": event => this.fetchGuests(event.detail), debounce: 300, "onCombobox-clear": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.clearEvent();
        ...
        })), index.h("div", { key: '0eba97f10f24da01b2b9505e8e71de970aaa4914', style: { paddingBottom: '0.5rem' } }, index.h("wa-tooltip", { key: '04cdfb5d5b73df4fe755b0f7a0f88bc5115e39b4', for: `main_guest-search-tooltip` }, "Leave empty if email is unavailable"), index.h("wa-icon", { key: 'de362f710f027451bfc2c52c8d85aae5dc8595bf', name: "circle-info", id: `main_guest-search-tooltip` })))), index.h("div", { key: '138463bfe7953a1160967c28c5fdc575eb4b6942', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: 'c3f8ecb3533ff20faef1be1775049413be09b1f5', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: '348f04817933ce84f6f6f251418831e07fbb90c1', class: "flex-fill fd-property-booked-by__guest-form " }, index.h("ir-input", { key: '1767897a495dd0ce549f9beb61b476b4bf5272a7', "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.firstName === '')), "onText-change": event => {
                this.updateGuest({ first_name: event.detail });
                this.handleDataChange('firstName', { target: { value: event.detail } });
            }, defaultValue: this.bookedByData.firstName, value: this.bookedByData.firstName, label: locales_store.locales.entries.Lcz_FirstName, placeholder: locales_store.locales.entries.Lcz_FirstName, required: true }), index.h("ir-input", { key: '6af59584716f6b2c965f406bbdc20293407469b4', "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.lastName === '')), "onText-change": event => {
                this.updateGuest({ last_name: event.detail });
                this.handleDataChange('lastName', { target: { value: event.detail } });
            }, defaultValue: this.bookedByData.lastName, value: this.bookedByData.lastName, label: locales_store.locales.entries.Lcz_LastName, placeholder: locales_store.locales.entries.Lcz_LastName, required: true }), index.h("ir-country-picker", { key: '8b79317b0f4fdcf74975bdb0b4f45d28d3c090ba', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) }), index.h("ir-mobile-input", { key: '53047f99299393e4b4d0eb4b7df8b93640162284', size: "small", "onMobile-input-change": e => {
                this.handleDataChange('contactNumber', { target: { value: e.detail.formattedValue } });
            }, "onMobile-input-country-change": e => this.handleDataChange('isdCode', { target: { value: e.detail.phone_prefix } }), value: this.bookedByData.contactNumber, required: true, countryCode: this.countries.find(c => c.phone_prefix === this.bookedByData.isdCode)?.code, countries: this.countries }), index.h("wa-select", { key: 'a02d5deb75f13547aeb345fc5474b07ec3f13706', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", "aria-disabled": String(Boolean(this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '')), id: v4.v4(), defaultValue: this.arrivalTimeList[0].CODE_NAME, value: this.bookedByData.selectedArrivalTime.code, onchange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("div", { key: '314446fd6b70a48e515acc6cb4abb6e0aa518289', class: "p-0 flex-fill  ml-md-3 d-flex flex-column", style: { gap: '0.5rem' } }, index.h("wa-textarea", { key: '7ae9e722ad62112ac26d294b785ac7ec233c407d', onchange: event => this.handleDataChange('message', event), size: "small", value: this.bookedByData.message, defaultValue: this.bookedByData.message, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 4 }), this.paymentMethods.length > 1 && (index.h("wa-select", { key: 'd2ec169b1954c0d217c12292602ddd2d17591865', label: 'Payment Method', size: "small", value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: 'e01be876b7b5db64e76cc3e4709ec1b4317a874e' }, index.h("ir-input", { key: 'c7311cd176296905a988f101202ff4c9c29e40b0', value: this.bookedByData.cardNumber, defaultValue: this.bookedByData.cardNumber, "onText-change": e => this.handleCreditCardDataChange('cardNumber', e.detail), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: '512826969ca53c82b7c0026d09df22f823690dcc', value: this.bookedByData.cardHolderName, defaultValue: this.bookedByData.cardHolderName, "onText-change": e => this.handleCreditCardDataChange('cardHolderName', e.detail), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: 'c316578d92d24338fdc06326f35c7b77dc59d14c', "onText-change": e => {
            ...
            }, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h("div", { key: '5853841d3a569e38d1f453209b060c4dc26e78b4', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '5accb4bf60003913a2a8d88284c77c05b1aed544', class: "p-0 m-0 margin3" }), index.h("div", { key: '4a8cee14cb3c9ad2afa0bf5b2fe6c73878c86505', class: "p-0 m-0  controlContainer flex-fill" }, index.h("div", { key: '7cda2933d7dc36e66a5405df86555d0d16f2d0df', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), index.h("wa-checkbox", { key: '6ccbbdde74cdd4fe9a8617a30dcc27fba2f722ac', checked: this.bookedByData.emailGuest, onchange: event => this.handleDataChange('emailGuest', event) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '434b7987f795969b0e5ac098dea19a014b621347', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: 'fcc293adf2fd945df6893394e8797e2af70cee78', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: 'e7bf6223f670015e79b1c4cf5f9ebb08a3b1cc1c', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (index.h("p", null, index.h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable")))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (index.h(index.Fragment, { key: 'd066286b54e463c21d3d483d35c03cbcadc1b155' }, index.h("wa-tooltip", { key: 'c2d3201eea5411b1a6812a9e88d54c1cf8707ffe', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: 'c657e140101200ba29beb17103b1e7c31ab27281', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'b418799061151a6cc5abadd8749650139f3406b7', name: "circle-info", id: `rateplan-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e17f7d383d5f1369de3d0b16b4145e2477a943d8' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("h5", { key: '4654bae8d6a250c39890d9e89fae663a4db2a5bc', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '659775919af04ba55c053a43665d16824a64b2d2', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: 'c72573d9ae0ea1dfd9c288d79506aaefe4ded8a6', booking: this.booking })));
    }
};
...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1f42773342c290a553fdde6d984cc723e03453f4' }, index.h("wa-radio-group", { key: '1661f0206768b2d7308030f37bb0621bccef3c21', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, index.h("wa-radio", { key: 'a73d5bc881cc322d8297745f86769abacc3cfc90', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (index.h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, index.h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), index.h("wa-radio", { key: '89e455141e6bc7e0884d3d5f61109fef8c63d469', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Company')), index.h("ir-booking-company-dialog", { key: '57c9f3c81d7095f17a9c5ef81d9352965d5a3e28', onCompanyFormClosed: () => {
...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '8c9fa815ec929c8007de2124c2ddd0c05e2ae942', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: '878c04116f0affc0350ab24cf17d2a959adea104', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: '32beeb08c1f2315673b41e66517f6be0e8fec448', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'f4740864f7881425d24198439b6e9fd185a60c5c', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '68e3dec9f973e3b39e92dbba218dd2418459afbd', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: '28e1669fcb243488fba52edecd7e49754a9871d9', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-input", { key: 'a324e5270c51d1f0036fd48be595fc11afd8fd86', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-input", { key: '04c2b201164ec5c6d758fd51671193c4286cfe6f', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '3aadf368227732ff76e92da8be037a6553bb3ba3', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '463c912658f887352d0b368ea366f9e433a30e84', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '3f0b5fd0a632dfb5c6657097eed1b7eef367186d', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '8355a0e05dc6153b9dbb37a92c32e43c94063763', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '040cbf01285fc876611fc5fd3db314e14894602a', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ccd910b9f499ab5ec81783b9b67135156ae91406', class: "fluid-container px-1" }, index.h("div", { key: '2a1c875a97071fe50b63a00e4b0649b27940a6ff', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: 'da26a661b43dde97a1d83f447791b6628686b79a', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("div", { key: 'f28084dc7fb72f4887102611981e6928dca01983', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("p", { key: '0b0f17db29bdbd1350cc77de6a8fa0f43ced5502', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("wa-dropdown", { key: 'ef0155a64c15ff9949f57aa955695262ee09c21a', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                this.bookingStatus = e.detail.item.value;
                this.modalEl.openModal();
            } }, index.h("ir-custom-button", { key: '5beb0489b8856df50ce2d230d92196f3c07dc9f4', slot: "trigger",
            // onClickHandler={() => {
            ...
            appearance: 'outlined', size: "small", variant: "brand" }, index.h("ir-booking-status-tag", { key: '37dcf66adc9b0f8f8743b7f623a3a56cbe6b3163', slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", { key: '7c2ec43a1c5b59ad6970640e3a737dc4abf216a4' }, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))), index.h("p", { key: '3cfd96eead2949fce14f6bd37a5a58e358f3b8ec', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '15bbecaa50f7e279f178bf105aa9ee793fb8ca8b', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'eb6b40b3aec9b5b403e2d78ac175df64db608919', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '4d6a4362b09f71694ab5eec633c18c0778066ebe', class: "d-flex flex-column align-items-center" }, lastManipulation && (index.h("ir-popover", { key: 'b0a1c15dd5038daa7a232259e8ed67ced4ad237f', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: '5955c11c32646c92444fd1c2d3bc4ad01ab4745c', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: 'b8ef5cc752e42c1e3e02be3ac8912cb1ffe48dc9' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'ff5c89134e84571c236f9a4120dde370e96eaeeb', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } })), index.h("ir-custom-button", { key: '9bd2b1a1bf07e28fcb561e1974a7090d46f49255', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), index.h("ir-custom-button", { key: '99346b64c54e83b792018b80097387c52af170a0', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS"), this.hasReceipt && (index.h(index.Fragment, { key: 'f3261fdcee1b121e71280e6e32ddf4a3d261212d' }, index.h("ir-custom-button", { key: 'b3c13ae9d9ded773cbd577150151d9222207214b', id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '0548f35663b6c76e98f69b7ba1af935e488732f0' }, index.h("wa-tooltip", { key: 'a105006f747f584d6bcac7af62eb011d9bf5d2c3', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: 'e9e14297af8b6585e7c6968b16af3850a6b586cf', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '4b6d71bed4c611230debe80ea5957b27e6bf1aa8', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: 'a541ba98c2837d2b886390512ccc5634bdfc02c5' }, index.h("wa-tooltip", { key: 'd416bd9b758ded939f8c0e03dd9c13f2734bb641', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: 'b4ddffc98ae30403b449ffde4b074fd323c5c8ee', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '908a14f3144be6c626077ee193e9e83a8d2b72b7', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '1b38d4b4952afbf4843deacb7637cdec06105169' }, index.h("wa-tooltip", { key: '646a75775cc574672de3993336ae1206fb749401', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '98b2a105edc2478285d7e8cf213c637af8758874', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '179dcc4cb74ef267d32ae6148af121ddf4a15d41', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: '491b77a34887515543fbdc37eb1c419e3e9ab509' }, index.h("wa-tooltip", { key: 'f2722f710097715f973c54f5ec86785d4f399a26', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '92048ccb3c754dea44fe0ee5decaa9ee88863d24', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'f02e1472211c9e94a656d4128356dbfe2148361c', name: "list", style: { fontSize: '1.65rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '37a7bd5f430815b7ecd0d9a86c01dd1385e7eee5', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '2075a1d7ed9dec88fa821faa8a84e6c203adbb8d', name: "xmark", style: { fontSize: '1.65rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: 'c66ab5384c086b7e9c8b08948abce3263d2764f4', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: 'e1ff397d7e0efcb66d7706793957501d3b93ccd3', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '464c40c67b9a88fbc33cf07793c998883aaf6b7e' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: '669f4f86bb72b946d1cf39c0dff89056be7dca16', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: 'b2dcc66685588aa717a9ed53c0537fff81650a74', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '17c6dcf9950b50dd8777e2fc2dae1fa3b1831fc4', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '96860a2712edc402b21caecfb5f92d3f43d23987', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e9f668afb4b6fafad52ee291b64ddbc47b0aaf91', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: '55438b487f198ffc0a206eccf747ae912ac095be', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-input", { key: '4dfb9d3af81234cce0f56152426b5780340c5564', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: '43a0975970a59a5e7fd7fe4d6612c5156df353a7', name: "start", slot: "start" }), index.h("slot", { key: '2168b32cad0da08eb26b9ee1189b2a43bc2015bb', name: "end", slot: "end" })), index.h("div", { key: 'a5eb00f021bcdf333e142444b98ac639c1d98836', class: "picker-surface" }, index.h("div", { key: 'd62df4ab143d0db91799cf79a171705a0a982694', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: '213e9a867e3cc4b81258378e8603bdeb2111ee71', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bfb157fe8e83fcf6d05f3c5f76ad67591630b49f' }, index.h("input", { key: 'b1ce242f2fbc01dfee90b528c53a13bca89cff60', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '462664ea535bb5495de47525ef1ef9e56c156cd6', class: "d-flex align-items-center" }, index.h("span", { key: '3afcb94038f895dfd4d4f84931e4a6f876a980a6' }, this.dates.from_date), ' ', index.h("svg", { key: 'e9dc6e076a43d15ff172121f884ad30a26119b60', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '1309432777b1f03889366acf8453197c63a0daa7', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '5aecf61ce88a3249fc55114acaf081017b3bb7c0' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'ba5d1404867f8d85bf40f078597744cf893e2a31', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '256b552e1608551451787ae061743558aa13d5ac', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss }, index.h("slot", { key: 'add2f3d0a6b759a93c43bd688cf2602a6909ba52', name: "header-actions", slot: "header-actions" }), index.h("slot", { key: 'a7b4d66eff2c8b1a8f505a806fbaa876c96d8734', name: "label", slot: "label" }), index.h("slot", { key: '6258f90d02d7cf6f9181ee389c1609c006c6c197' }), index.h("slot", { key: 'ff785f98810cbc8438f08a2c8c8275cc8986bc93', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrDrawer = class {
    ...
    render() {
        return (index.h("wa-drawer", { key: '371f260a3c17c4db84115a8f585e5dc63a664126', "onwa-show": this.onDrawerShow, "onwa-hide": this.onDrawerHide, class: "ir__drawer", style: { '--size': 'var(--ir-drawer-width,40rem)' }, open: this.open, label: this.label, placement: this.placement, withoutHeader: this.withoutHeader, lightDismiss: this.lightDismiss }, index.h("slot", { key: '3c900614ef2eb914edde28fb12e69d77c0459f22', slot: "label", name: "label" }), index.h("slot", { key: '16e1703b7fa102148ec84f0296ff508dbc329144', slot: "header-actions", name: "header-actions" }), index.h("slot", { key: '78117aab2cb0c367beb49d73d6442796a36e5bda' }), index.h("slot", { key: '72f2cee6ba4f5a7380543d9fda6b7c2f2d640867', slot: "footer", name: "footer" })));
    }
};
__decorate([
    OverflowAdd()
...
const IrEmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9a1b942b93530bf303d460e49e855f06f57d5595' }, index.h("slot", { key: '840f849f9d1eab4745d567bce6cb7a6d9b84ac9f', name: "icon" }, index.h("wa-icon", { key: 'eb7a01377e4768fade0eba3f094f2c0d470f85fc', name: "ban", style: { transform: 'rotate(90deg)', fontSize: '2rem' } })), index.h("p", { key: '3ded84a621fe54d5767019c4dd63f793e0a29f56', part: "message", class: "message" }, "No records found"), index.h("slot", { key: '7588c29df7262d3096002d38814adefd1cdefff3' })));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1c51e445077fb07055b8ffba1e3f3a8557227bca' }, index.h("div", { key: 'aecbf742e5572496e33ab624d8286c25361a87a4' }, index.h("div", { key: '770b18af60b5b6d113ba7379b7263dea98f5e6a9', class: 'extra-service-container' }, index.h("p", { key: '1e7aa0d9133af987dc314ee987fc41a040831762', class: "extra-service-description" }, this.service.description), index.h("div", { key: '6dcca82cc212114f1a4fe0c31e0adda6796ada57', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: 'a22a47867da52afbb81e568991b1381f05632d08', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: '834771e437091a1f14f88735777d58d29fe536ca', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '1dbc7d6e3487171269723f5c035f2f3295688189', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: '4ecb15e554282e1754474b030a01f2c0a7402d70', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'effdedf0791dd3d972bbcee45dbd14719446832a', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: 'ba313fbc11a8d977c72faecebc583a5d197be29d', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: '3198c23d727242b99c0ae8193cbfac7bd359d659', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: '3cd241da1f0db9a941146ecc533857976390235a', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: 'c5e9e938b442bc36b0f88bc9411c0a59d3cd83cd', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: 'd946a535ddec4154848b605214bc2dee41edb90a', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'aee1d312794db4267dede1e4990e6ab42bd854d7', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c5caa69e0eab2bb11880b1fa3978512cd9536ae5', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '034919f68e6d8deffc00efe6122537e37763ea85', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '61834150a4db97e2831fc29366e08e9f2b7ed7cf', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '73a95ebbdfe54eefd795d12adf4693cc0131a0f3', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: '94fab3ab17f9e6334abbd803d53cae51af3fabe9', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '5a63b66f005595a6a764686e7c7ab79500ca2b9a', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '0c89c7efd143a5519984796eee0c6be59c902cf5', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '1fdc27901bcae1b3cd1d470cb10069fd607760dc', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: 'a3d355e341b26a35cb5a133b54083ae8d39a4924', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: 'b78daaf7a446b4937d5d994b128fd53fa9cb96ef', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-custom-date-picker", { key: 'f34e458dd72ce49f132a7b23244582dd5e9c9f21', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) }), index.h("ir-custom-date-picker", { key: '62fd151c5bd7a4985591d4758e5609303cdac845', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: '4ae492f6bed79dfeac0c8a7411640ee16fbceede', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-input", { key: '47d53a3f57933095d07baf7b13de4be8537a08e5', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: 'ae1975ce8083e9b422e1824df694bdb3308978ea', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '6fd9880b590fab23b399d61ff7c0b8a5bbf3972d', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '201e59acc6e98a88e8775b58db83e117f44584fa', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: 'b0177abdfb36d6680d9e18b732b842528ce8de06', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: '5cfe6357f160ae767179e3e8427e73e1977632c1' }, index.h("wa-card", { key: '5839cbdccefda272aeb50795743a37607af4bca6' }, index.h("p", { key: '2eff6df672b2a6972ffc9679efc5a7957ff883b9', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: 'ed45783509f2b434326fe49561c4b5ffedbbc725', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: '1dba162268d18a3e7b257cb63cd1e848c3d130a5', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'b223df1af262afd7940d29174e4db85705a8adee', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && (index.h("div", { key: '953732be6633ca4a90e9c0c528c5032aa071667a', class: "text-center p-1" }, index.h("p", { key: '6901b1df790e527932383becf3b1387f8f831b98', class: "text-muted" }, "No extra service recorded yet"))), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'e56aa87c57bd591ef2c2c8fe08813133af273db8', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (index.h("div", { class: 'loading-container' }, index.h("wa-spinner", { style: { fontSize: '2rem' } }))) : (index.h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), index.h("div", { key: '8ea1a0f020d77c0abdc6b760ae5d79c72e18e189', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '305ef65ed693b642c6ef0e391c9a1c311eb3fae3', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '366c6ca7fbf3d6ef178131121a939fdb02b98442', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrGuestInfoForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '24b91bf6fad6ffed919defdeb9ae2a867e5c62d4' }, index.h("ir-validator", { key: 'f1f852227078576116bde1c1e6a2cc33e317bfea', schema: guestInfoFormSchema.shape.first_name, value: this.guest?.first_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '8350f9da403b70fd0207519d52c92a8bf600e44e', id: 'firstName', value: this.guest?.first_name, required: true, "onText-change": e => this.handleInputChange({ first_name: e.detail }), label: locales_store.locales.entries?.Lcz_FirstName })), index.h("ir-validator", { key: '053c8210edd0cb9f219e1d86fa66cd4ab852409a', schema: guestInfoFormSchema.shape.last_name, value: this.guest?.last_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '0ca0cec167fb1cc07171b8f76ec0c6edc094ea7e', value: this.guest?.last_name, required: true, id: "lastName", "onText-change": e => this.handleInputChange({ last_name: e.detail }), label: locales_store.locales.entries?.Lcz_LastName })), index.h("ir-validator", { key: '6e348c4b05af2fc858937e73360936f69eac375d', schema: guestInfoFormSchema.shape.email, value: this.guest?.email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '3fe3825294f8cacf0bf240e1dd31384f6bf0b026', label: locales_store.locales.entries?.Lcz_Email, id: "email", value: this.guest?.email, required: true, "onText-change": e => this.handleInputChange({ email: e.detail }) })), index.h("ir-validator", { key: 'c1ae8bc9a45df0c5e8f7deccfe3a2efef7df1b07', schema: guestInfoFormSchema.shape.alternative_email, value: this.guest?.alternative_email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '01a72919bf15efac6582fe31f66c23bcf034a2cd', label: locales_store.locales.entries?.Lcz_AlternativeEmail, id: "altEmail", value: this.guest?.alternative_email, "onText-change": e => this.handleInputChange({ alternative_email: e.detail }) })), index.h("ir-validator", { key: '33d4cfa5fc94cae3ea775a07aa8b9b9f64d87bff', schema: guestInfoFormSchema.shape.country_id, value: this.guest?.country_id ?? undefined, autovalidate: this.autoValidate, valueEvent: "countryChange" }, index.h("ir-country-picker", { key: 'd6a0e0e6078a2d43217fae2657f9075e98085741', size: "small", variant: "modern", country: this.countries.find(c => c.id === this.guest?.country_id), label: locales_store.locales.entries?.Lcz_Country, onCountryChange: e => this.handleInputChange({ country_id: e.detail.id }), countries: this.countries })), index.h("ir-validator", { key: 'bbc20202f7fec8d8e718811fc6f143e0934c8553', schema: guestInfoFormSchema.shape.mobile, value: this.guest?.mobile ?? '', autovalidate: this.autoValidate, valueEvent: "mobile-input-change" }, index.h("ir-mobile-input", { key: 'f41ba23bb5ad6d37ab9e97db9ba38cc28515a46a', size: "small", "onMobile-input-change": e => {
                this.handleInputChange({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => this.handleInputChange({ country_phone_prefix: e.detail.phone_prefix }), value: this.guest?.mobile ?? '', required: true, countryCode: this.countries.find(c => c.phone_prefix === this.guest?.country_phone_prefix)?.code, countries: this.countries })), index.h("ir-validator", { key: '1d31a4db529d34287d1d8a6ffdda0904e1b23d39', schema: guestInfoFormSchema.shape.notes, value: this.guest?.notes ?? '', autovalidate: this.autoValidate, valueEvent: "wa-change change input", blurEvent: "wa-blur blur" }, index.h("wa-textarea", { key: 'd49ac8333681160a736c2e1eadaa82dc61e419fc', size: "small", onchange: e => this.handleInputChange({ notes: e.target.value }), value: this.guest?.notes ?? '', label: locales_store.locales.entries?.Lcz_PrivateNote }))));
    }
};
...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (index.h("button", { key: '3fc860863d13b7c92d8a81c6d8d32f40dfa83b00', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '1d9c00be5abc69a217d5044ba02570dab935b3be', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b29d8ad053f7831c2e094af373efe6b5c38f7db' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'c07971b369d5fed770b0d4d5646368e871aab7a3', class: "loadingScreenContainer" }, index.h("div", { key: '41dd49a62d5af554cee3ad7a73a98cce9c69ab52', class: "loaderContainer" }, index.h("ir-spinner", { key: '3ffcbeee2012c32377a252b7bb39d6f252c62ba1' })))), this.showModal && (index.h("ir-otp-modal", { key: '33c8c565611ee31173418a6c629ffaefd0a67975', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '64d22584c1b8e5f9efcc66e0cf289659704296bf' }, index.h("ir-drawer", { key: '1cad82c18a6ea3760353cedd09e453ffac13e4b6', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '6d4c2487d85c4136d5e77e75c680c718657b7ce1', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'e6a0a09f08283671d01f94e8743770dde58057e6', onchange: e => {
                if (e.target.checked) {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: '63d4bc15cafcb2324cddbdd1b9cefaf87c514a5c', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '9efc377e86451bbfa1822de9d1c14eceed03ea5e', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '35d6a95d380dbec42c029123b45aa79a5cafe48b', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '4ec2b1054031bb62a151a7363bc03ccbbbc8946e', loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IrInvoiceForm = class {
    ...
    renderPickup() {
        ...
        return (index.h("div", { class: "ir-invoice__service" }, index.h("wa-checkbox", { disabled: isDisabled, size: "small", onchange: e => {
            ...
            }, defaultChecked: isSelected, checked: isSelected, class: "ir-invoice__checkbox" }, index.h("div", { class: "ir-invoice__room-checkbox-container" }, index.h("span", null, "Pickup"), this.getDateView(this.booking.pickup_info.date, null), index.h("span", { class: "ir-invoice__checkbox-price" }, utils.formatAmount(this.booking.currency.symbol, this.booking.pickup_info.selected_option.amount))))));
    }
    render() {
        if (this.isLoading) {
            return (index.h("div", { class: "drawer__loader-container" }, index.h("ir-spinner", null)));
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '71745fa0e442271c65317caa35db4bbd07771dcf', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: '4c753f46207426ede8da514d5a27501a799183c6', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: '70c4140f6592297b060c5822ac3be0f7dc60ecbc', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '180963cb494578bb746c3d04534025d57237205a', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: 'b21771ab3e961a9221f1acef2ed6549e8014626c', slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: '164fa85d09c7a0a1f1691971c6c308c348025e0b', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: '611cd0ecd999056d0fcbfe2b5be58553299d001d', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: '324e553496cafc09d6143028c773bec384336993', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("input", { key: '95aa21f41792ccd9fa91683fd0ad9f4379405de2', ref: el => (this.inputRef = el), id: this.inputId, class: {
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0f89793a04fc90397569ef66d3a9daa8de711a6f', class: "otp-input-container" }, index.h("div", { key: '67ce6c8996fd3bed5218e755e9214908d32bcfd4', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '7dcb0ced47a1a3a28f7eabd424719ffb54c9bebc', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '475e81415ba577b2b53a79f2b39d1fdb8e678ac2', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: '35d6674cee7f646366ba8dae6cbaa121f97d0986', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: 'd1aade0f0c110b84f035152ecd118c0faa1e86c5', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '17c2c563e29c2670754852689502a755a8b53957', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: 'a38868956de614a9034f7614f80a0c8f254171ff', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '8608c5f211d14e0ea500f4200d1a8d919beebac6', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: 'a687ccb3c544c84347228c20c705591f8e93abcf', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'ca777a2e01f712504b4481c3dc0f2db2fbc50bb3', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'ecde55ee1abcf3ea7d757dbd0a432cb16ebd4687', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: 'a30267735d54a775d3001245b70f206a2f1a2562', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'cfaef92dc8c0a59fe35c86395dfb83834828e986', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'fff242241209c00616c364f17367923551cc30f6', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: 'e3835a7a6288b552fabacfd466f6028739056a98', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '53112ba8b100420cf1998d9b510cfeb32639d044', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: 'a60f542cefa72a90ff4279474739723624d8827e', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '8d004af30c5ba9be463dc43f7298f2ce307bfec1', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '94fc3fedf2bc7c79aef341b79394250363787fa3', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '473786ce667e9ffa68b65aa88c109fc313f1193b', class: "payment-item__payment-item" }, index.h("div", { key: '919a0d8d4b205ecf9a888c298d4cc6644c77b8ad', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '91ff98f7d31544e658ed0dc8f25eb011429d7185', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '1ec4e09b209a69ea3206dc45582874081af06c5e', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '8f27b437885e7098676a241b682488698d2a77ab', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '8c137446f6fb832a4f9f5777b9c501d94945afb6', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '798554d976609a31167359270c99d55393f18c5c', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '11286e01ff2b5f3905b4adc92cd145293d8eba0f', class: "payment-item__payment-toolbar" }, index.h("p", { key: '077c37623ab2ee3eedbbdb969879da79a89e5282', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '11ac1c0f5c6732ab5d0efa9380b8a4774404f56d', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: 'b6df9d5a90628c5d3db6873a475eff022e0e6cee', class: "payment-item__payment-actions" }, index.h("div", { key: '4ba6de133b896cfae6fb978c0bf2a3a72fe1774a', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '9e65451bfb6f54078132b180bad80156dd5b9bb5', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: 'efc9683fd78c4d94e940b9327b9d1524fcb0fe30', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'e49c6cb030b38cd3921faf7852e4c9d2a156597e', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: '9c683ca5211f9374b0197f82c67980ea4af0bd05', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: '6b1176c386ec798011ad9cc8db8ee81261f03403', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: 'f020f2d20550da025215f63544255aeef4fbbcb8', value: "receipt" }, index.h("wa-icon", { key: '2b6dfe6c9ced81fa58e54f572e8e572942b7fb1f', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: 'cf1194c13c3be93e3ad253292b376d02ef8780af', value: "edit" }, index.h("wa-icon", { key: 'f491e6dbc0be0fdeaf7962203fa97231f6f30be8', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: '97223b59dac2d0fb466e0abfb0d8135e7a749325', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '082d7f92889b2a8f632b53af144432052d181573', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: 'eb7a32472336e4949738b46805e6d5023be7ed30', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '792e5d87efa9c9fe23fddf19c3c070de924fa1d6', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: 'b380c6281924f28a4383ae63d92a86de099650bf', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '7579a23b3214d87facf4069885a77d5e8063d94e' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '3ef12266b829a1e33bc4a8e1c41f3cf1db5244c6', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '1039d406375fa4b5e3abd2a9e8d830052991b4e7' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '1d97785d9a0f18e9d43eb23353be4f8611adc0fc', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '29ca2cb186c7632a0a766f01b0003bb6eea8ce1c', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '5e645c2f2bed8cd2a6412c0bedb042005a63488a' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '882929be759a17c841cd21ef102f6846321639f3' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '5ab1ef331d3627818c89811afe9749204ff508dc', class: " payments-container" }, index.h("div", { key: 'fb173d5f54c0149199fc127d37354171a266d68e', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'c03924f019303fc0aa9f273061fdc1b50a91abaa', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '6298ac2302e95e4496c46729472e0af37b031e8b', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: 'e5123b24394854235a3dddcbb398378fb5ffbb12', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '1c6908c5894c7f13320014892f73d8825d4b4068', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '94921b687a3fc1b9b0bed1426f392a33268f1544', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '90faaefa3a2030ab777518910fe20811d1eac771' }, index.h("wa-popup", { key: '9570ef8e57acadf4be60f3c05488441cbbd0d928', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '2e2386e9b55708fdd252836a921c2957e8b39371', slot: "anchor", class: "search-bar", withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: '11597a749cf33c9d09c44439a3eee3861ac99a8d', slot: "end" }), index.h("wa-icon", { key: 'e39e254b85d58bfeda288273d1a56e7dafd1d90f', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), index.h("div", { key: '58465c8369946122b99095ee52e25374a1ef4b30', class: "menu", role: "presentation" }, index.h("p", { key: 'eb5d7104952c286bf06dc194a70aa2496a5e4cbc', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: '4532998f41ee11709b7cf916fdc999355cce7e05', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: 'b26317688d974c399990612f7663c6f0a240cbb7', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: 'dd6a23922e95c86788713ff767487ccf5ecc42f0' }), index.h("p", { key: '0c4896267a803e54f1b1cce3e8518b683d3f18ff' }, "Loading suggestions\u2026"))), index.h("slot", { key: 'ddd8a74d2233fce12f2ca65b0faf451aa37561a3', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: 'dbe2baa7b850fbcd1437a22b50cde70dfd7db6d8', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: 'd1ec99b78ea2e34566631c534b2c53ce2aaed245', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '9ec21ff25e348ac1e8437f874a14462708d3e065' }, "No results found")))))), index.h("span", { key: 'cb19ef7404a495d7ac702cfaabcf0ffd8a605239', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '9122a388ebce695a864d906a00a9cfba72c119f2', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'c6abdb9d8832bb4e57494fe2e360ea15b30e7d97', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '1c2deb659d14f074cd9622337b6488d1c41e4f98', class: "picker-item__check", name: "check" }), index.h("div", { key: 'f4f092ae504d808a7ad9ce25118638d7f4d3cf0f', class: "picker-item__content", part: "content" }, index.h("slot", { key: 'e7c910ac6bf626dbe03874fe7c4c5fd8d5499e81' })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'f0fa2e55313ecd3befb321ba8de5a7384ba8f6fb', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '5e2dc6902e1447a1f61917acf0ce1b85efd8fec4', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: 'e1676569c29bead267776f242e2a6dce91e0a2f0', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'ac02a5da91a53ae4a8b1cf82b27f682f14314212', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: 'e07ea41e57460db8ece7ef7c6448988936dd0f5a', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '09a5105408a56318c1bbca765f054e0055e877c7', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: 'a8a4849edd8891b1e8b6e86799e3d51956613018', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'dc783dd417f148d2c7d8a1143e900f75801a91e2', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: 'c27e38269df97193e1989e0dd5fde52e1c8ca2a7', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: '7828f08f432b9e9de1928d5316f0e4029a217cbe', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '6bb2e2b4bd55042f6e162891e0447b304774598c', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: '926227bbc908afcdf5664bb6ea4725ee8297ca04', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '6604db63e89bc95a0ad2a8f594dc823ce645a7a1', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: 'a3d5d0117a2a7504f262c6b18d07b72df9a87d2b', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: 'c46a9374eb78dc91b2eed48498b27465cd1fde56', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '10b7b8e2612b463bd14d2e447cf14ac1f9e96e72', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: '728a184ab0dcd8701e83154886aa0d8a7ee6e076', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'be02bb96a4892a0273aaf77dc408ab8d863c1d2f', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'ed51f7a1d3692c0f01ee2374abe50db14c0de617', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '2a05f98fa50dff2ca312ba6de22b62a1dcf2043f', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: '08213878f1c0840b8291b9b070a0f63d84b02f2c', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: 'abd1152343acdd6ff4f26875c46737ce19d23835', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e6ca18912924fcc37e6191f9d2113e4a28211399', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'bfee9362e4a4bbac5a9bf221e8d8fd23e25f0a5b' }, index.h("div", { key: '472d3b448207186e5283bc060b688222ec64939d', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '5d59e39ae79fe244b9105773db67fbc6fdd81e5f', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '48b895b0645fc5aa3afc287856fdc412e10c011d', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '8847e319fdb2815d423131ecd15a16fd5004e290', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: 'dd1b432ca0674b23b41af42e561444f523b418bb', class: "reservation-information__row" }, index.h("ir-label", { key: 'f1d661d7280d4486e4e596ac9c5505aba9e20255', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: 'd27fa81449e216dce40c108c0e68f855e25693da', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '7243a8238f0b46e0bfb5907f668fb172392047f3', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '8662cad390c51d26f09a9b1a69b7fd69e95fc602', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '79d2b87ea190aa4bfe49422553dbf7be5ab7d186' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '754b4616ac69f176920e3d740e68513a92d9ce43', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: 'a1642283a59f8f3bfecafa126c6ff7f8ee07654d', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '62002ff7aeb78b5738c113290d8de33158da33e1', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '00fe6d903e2c7cae5dcb2ef921ec9c5135e125e9', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: '39eb35767fb9c30fa75ee34749c8a7f9be4b9ff1', class: "reservation-information__row" }, index.h("ir-label", { key: 'e4889cd8891f8d1f19676e5364aaedc2c41eebe4', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '3472f595e5807ea2c0d80b1bf3fbd1fe9c05b669', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '17363cd867f38ae04505aceb0ed171fd40d925a3', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'd9a8066e49e8b40054303629ecda88e74d74e133', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: 'd00fc6c126119c48bca75216dd078230a34d14e7', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'd1b6b37073800cc57ff66f7cee7c839b58f9b87f', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '6b5afe1b54e795ba59800ee147f31c85c9da6546', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '8455bd952125015883ef236c03a05c28c1a298c8', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'ab035681dc14e41294104b1a095d2f8a8ecd95b5', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '1e6df0435bd32fa125641dc36eb769caf06daf38', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && index.h("ir-label", { key: 'eb1032feaf9c0e52be3a39632bb3526b8bf49ebc', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'f5dcd49bd9d6485f7f26995810cd43cfbf42289a', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'd5b02927228a355ee051289e51a27ea7b45d021c', class: "d-flex align-items-center" }, index.h("svg", { key: '8425ebaa10c5f528ed3c71bbf02750333b8385e7', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'c1192d9c79de20413777795a757ccf800f26424a', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '8a15d554ab6e8d55f9ba5459f8dd00a5f5beeccf', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '0723b5fbee72419103f8211320e20d635306007e', class: "reservation-information__row" }, index.h("ir-label", { key: 'cd5201817ae5e5ea69cf62b716bd7b38128e89ca', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: 'f266d3bf69e5428018ca302ca29f00485edb6f87', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '06ef8aaff9a49b87a67d072afaab06ada93a3f18', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '6b9bd82440c18d3b86d5c41bc2010f588fae649c', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: 'bb3108568b0ad7fbfe5fb28d40dabdeb53cff4ea', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: 'b5e55c98eb8c51093989ea8564a9385184bcfcf8', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c9ad1724c8107aa1c06b378349f9457fb2f64979' }, index.h("div", { key: 'c4bd25aa5aed491dc89e2386fa45f1020bfd94ae', class: "booking-room__header-row" }, index.h("button", { key: '71a6f3c8e0d62dae209b2b57f633328d5350654d', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'deb3207fbf837b4e530a07a5d91aea1c761ef450', name: "chevron-right" })), index.h("div", { key: '9a79c90f17d2457a964df642ae59888f23689b32', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'aecf195d3c15d07b15926699fa9cab079b0a0021',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'd08f4b4ebe5e516f4a4cdfff45f20ad4a95661c7', class: "booking-room__summary-row" }, index.h("p", { key: 'b755ef0a9da56f2cd2e3bee17fd6b7ee3e4d9846', class: "booking-room__summary-text" }, index.h("span", { key: '5b9bad89531efedcba601efbe5bd63137ddee979', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'eacd6da9e361dbfcf46f7bddba022fdf950002c7', class: "booking-room__price-row" }, index.h("span", { key: 'ee7740f1ed37665d7e9bc2fb7e33d6b01585bb23', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: '92bb8e81e415a2a6330fd117f7f899e6bd98b208', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: 'd490e19272f2681e490d1572d21ef33aab0d7a1b' }, index.h("wa-tooltip", { key: '0c3d8f2bb924b9a5d44ae117749083de8bc2fa92', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: 'e9269c89854f5c5fa2aa72db0adafa3818867c7c', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'e8485498cc9264a9af14f364dbb8e734898c3516', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: '29898df2e58bedc85adfc4704cd8219d7ccb7b3f' }, index.h("wa-tooltip", { key: '63cbeeb9c3bf6a4dc5a0d8d6156e49e2634e6c30', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: 'dc53b1a7bc85c33e5b72dc61cf6f3ea0de221d8d', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'bf127096a446e5f6b16605cc142b8b6c214e59b7', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: '91c451c038eb54adc4b62659cec509251eb8e611', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: 'ad0ebc1774551a6b86346f2e42e94e202d2c6357', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        index.h("ir-unit-tag", { key: '35e696134b0ba878144ac3b7689d1cae62b7b202', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '17212d6385456c1858a27a6b13ea2a2e62800d2a', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: 'e8adeb55232fc858218248452701b72c5035bfe2', appearance: "outlined", variant: "brand", onClickHandler: () => {
            ...
            //   ></ir-button>
            // </ir-tooltip>
            index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: 'e773b398e1818c1a3400e57d0c16075d932b893c', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '4d1c296e3c4afc4173b65c371d09ff1eee4289b9', class: "booking-room__departure-row" }, index.h("p", { key: '7f25f45de8b760096f667fbe6f830ecd9a62b4e0', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: 'e5aa8dc3a3781180915cc3ba9dd25d731c031ad7', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: '78d470af762134867a6f6ab83338185a6d783b93', class: "booking-room__details-container" }, index.h("div", { key: '7139236725bab3f8679cb9adbea484960d559edb', class: "booking-room__breakdown-row" }, index.h("div", { key: '1150426d0ee47c8d3ca2583d2bdc8af637d2805d', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: '4db71d2dfb8dfe3a8a5944307cd38080cc388014', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '51ae1b7190b0e2cd57c92477732a2783f96c3234', class: "booking-room__breakdown-table" }, index.h("table", { key: '7b0bdb9afe1d53e5672d5047ccffe14e3fa225cc' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '40cfc2ed958f212c7ed33e59b5f9a21c56b117b4', class: '' }, index.h("th", { key: '68d9e0f87e3b137043a9247e66d9619b70775bc6', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'a1a34f21f23ad10c4027fee0fd66e81d9865d570', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '516d5b62106244be3bac700cc5162f169cd0ec18', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: 'a110fca39be8201dc5c8d32d44835c3b2ea41601', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '62ce20321d4f684be58486426de888404a50056a' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '408e88688e81f4998bcfdcc0f883125a0f54de54', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '4d0ada6e7673ebb6b36092454c4846fc57776937', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '1b59c31cbbfcf7d762171fca08f2cc2118ad29bc' }, index.h("ir-label", { key: '414ba32a725ebdc726aeb7071008b061ec97bc53', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'b838f13520b79801b58eb33ef4e3c45fd81a8e63', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: 'd39d32a182ae21e95611ce52f87801fafc10cfb7', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '792c2676bb915d3aa5337a2bf01e0cb8c128340c' }, this.renderModalMessage()), index.h("div", { key: '32904dd3806f077fa7421338822e3b80c8326005', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c98e2489fe5daf4c713f0ea5e082c4f5d337cb98', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '49299e2eeb29074d7b6503562231298c42350b22', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '6aa02767117d5128464cde7e87478ec856e69bee', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '3919d6f84b1bbed6f0329d708a6bc29bd41039f3', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (index.h("ir-drawer", { key: '0b126d99cde9858f0c846c7d1d80586c541ab83c', style: {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8b31f411724d4741fc451e749dc400e31f168595' }, index.h("wa-spinner", { key: 'da21d0a609c811d51e813656ae0c56e0750717d9', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'f08be15d2a53e4bc68582854443275d892f0d84e' }, this.showTooltip && index.h("wa-tooltip", { key: '306a6a1cc61dec357a88e5dd0ac16335deea9bde', for: this._id }, this.unit), index.h("wa-tag", { key: '8fe41f7cfff7b02e5c18c39d69e4f6e2667cfbc1', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '0920f5d135cc0ca4f0b76da8b5fa63d028c31ea2', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4d56c7a18939481b5ef2fa30a1894535f45b8f2e' }, index.h("slot", { key: '54ae2496a3b480805747259095bf89c3eac01571' })));
    }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_73.cjs.entry.js.map