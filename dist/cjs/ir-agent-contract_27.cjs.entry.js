...
const ExposedAgentsPropsSchema = utils.z.object({
    property_id: utils.z.coerce.number(),
});
const CodeDescriptionSchema = utils.z.object({
    code: utils.z.string(),
    description: utils.z.string().nullable().optional(),
});
...
const AgentBaseSchema = utils.z.object({
    address: utils.z.string(),
    agent_rate_type_code: AgentRateTypeCodeSchema,
    agent_type_code: AgentTypeCodeSchema.required(),
    city: utils.z.string(),
    code: utils.z.string().trim().min(5).max(10).or(utils.z.literal('')).nullable(),
    contact_name: utils.z.string(),
    contract_nbr: utils.z.any(),
    country_id: utils.z.coerce.number().nullable(),
    currency_id: utils.z.any(),
    due_balance: utils.z.any(),
    email: utils.z.string().email().nonempty(),
    email_copied_upon_booking: utils.z.string().email().nullable(),
    id: utils.z.number().default(-1),
    is_active: utils.z.boolean(),
    is_send_guest_confirmation_email: utils.z.boolean(),
    name: utils.z.string().nonempty(),
    notes: utils.z.string(),
    payment_mode: PaymentModeSchema,
    phone: utils.z.string(),
    property_id: utils.z.any(),
    provided_discount: utils.z.any().default(null),
    question: utils.z.string().nullable(),
    sort_order: utils.z.any(),
    tax_nbr: utils.z.string(),
    reference: utils.z.string().nullable().optional(),
    verification_mode: utils.z.string().nullable().default(null),
});
...
const IrAgentEditorDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '266c33e99fd3a76f2fb9420e428efafb943fc241', "data-testid": "agent-editor-drawer" }, index.h("ir-drawer", { key: 'cf3f5c27e6a39feb418d7585b88c56bd8b4a6787', class: "agent__drawer", style: { '--ir-drawer-width': '80rem' }, label: isEditMode ? 'Edit Agent' : 'New Agent', open: this.open, "data-testid": "agent-editor-drawer-container", onDrawerHide: e => this.handleDrawerClose(e) }, this.open && (
...
const IrAgentProfile = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd847bd790857c8ad66a9b3df54b5a90eff00ecfd', "data-testid": "agent-profile" }, index.h("wa-card", { key: '26e19b066f256a23fc7d86de1cfb94e6c4015acb', appearance: "plain", class: "agent-card --business-info", "data-testid": "agent-profile-business-card" }, index.h("p", { key: 'c7e59dfdbc6ad430da72fb7e78b275d4f5383b4c', slot: "header", "data-testid": "agent-profile-business-title" }, "Business Information"), index.h("div", { key: '0050a608fb19015f1ade019258aa5a2b3d93db2f', class: "agent-form-group" }, index.h("ir-validator", { key: '1d21f3e4e25208c50d9913e9d089b675857b114a', schema: AgentBaseSchema?.shape?.agent_type_code, value: agent?.agent_type_code, valueEvent: "change", "data-testid": "agent-profile-agent-type-validator" }, index.h("wa-select", { key: '2605f164159c977c53f92238b3d0c60516551d31', size: "small", placeholder: "Select agent type ...", value: agent?.agent_type_code?.code, defaultValue: agent?.agent_type_code?.code, "data-testid": "agent-profile-agent-type-select", onchange: e => {
                ...
                this.updateField(payload);
            } }, this.setupEntries.agent_type.map(agent => (index.h("wa-option", { key: agent.CODE_NAME, value: agent.CODE_NAME, "data-testid": `agent-profile-agent-type-option-${agent.CODE_NAME}` }, agent.CODE_VALUE_EN))))), index.h("ir-validator", { key: 'd58b869bc73612f2124aa534ac9ab0d881435185', schema: AgentBaseSchema.shape.name, value: agent?.name, valueEvent: "text-change input input-change", "data-testid": "agent-profile-business-name-validator" }, index.h("ir-input", { key: 'c077afd59a537d04306b0c9c31486c2f3b1fa904', autocomplete: "none", placeholder: "Business name", value: agent?.name, "data-testid": "agent-profile-business-name-input", "onText-change": (e) => this.updateField({ name: e.detail }) })), index.h("ir-validator", { key: '794b51d45fd37f19f59fb8eec9fe8cb7f882b5fb', schema: AgentBaseSchema.shape.tax_nbr, value: agent?.tax_nbr, valueEvent: "text-change input input-change", "data-testid": "agent-profile-tax-number-validator" }, index.h("ir-input", { key: 'd2fe71fc6514636a07e81830e5165c970ad38d3b', placeholder: "Tax number", value: agent?.tax_nbr, "data-testid": "agent-profile-tax-number-input", "onText-change": (e) => this.updateField({ tax_nbr: e.detail }) })), index.h("ir-validator", { key: '99fa5a4a7259595ac54665e24d9b21912cefeeef', schema: AgentBaseSchema.shape.reference, value: agent?.reference, valueEvent: "text-change input input-change", "data-testid": "agent-profile-reference-validator" }, index.h("ir-input", { key: '9956e83e269a5f1c06583792e529f11ae2e019ce', mask: {
                mask: /^[A-Z0-9]{0,10}$/,
                prepare: (value) => value.toUpperCase(),
            }, placeholder: "Reference code (optional)", value: agent?.reference, "data-testid": "agent-profile-reference-input", "onText-change": (e) => this.updateField({ reference: e.detail }) })))), index.h("wa-card", { key: '0562d7e960ae3cb32f70f08934e3f192589f020b', appearance: "plain", class: "agent-card", "data-testid": "agent-profile-billing-card" }, index.h("p", { key: 'b8c225a2ea5cf33d70b886290d44158070a609a5', slot: "header", "data-testid": "agent-profile-billing-title" }, "Billing Address"), index.h("div", { key: '341c1a7a08f897d9f19e2d18e7d33add738c2c39', class: "agent-form-group" }, index.h("ir-validator", { key: '8e1c11e31495e84063675f6f718099693da2ca00', schema: AgentBaseSchema.shape.country_id, value: agent?.country_id, valueEvent: "text-change input input-change", "data-testid": "agent-profile-country-validator" }, index.h("ir-country-picker", { key: 'b42a8447f7261f7627e5a7738b75a5ac41013aec', placeholder: "Country", country: this.countries.find(c => agent?.country_id?.toString() === c.id?.toString()), countries: this.countries, variant: "modern", "data-testid": "agent-profile-country-picker", onCountryChange: event => this.updateField({ country_id: event.detail.id }) })), index.h("ir-validator", { key: '4ee34e5801b4237d0a79e0167d59a48e8bacdde0', schema: AgentBaseSchema.shape.city, value: agent?.city, valueEvent: "text-change input input-change", "data-testid": "agent-profile-city-validator" }, index.h("ir-input", { key: 'cf884afac898c602073e53bbbb7fdc6593d48919', placeholder: "City", value: agent?.city, "data-testid": "agent-profile-city-input", "onText-change": (e) => this.updateField({ city: e.detail }) })), index.h("ir-validator", { key: '80757378a36643f82129de2526ae5c49e12d5b9a', schema: AgentBaseSchema.shape.address, value: agent?.address, valueEvent: "text-change input input-change", "data-testid": "agent-profile-address-validator" }, index.h("ir-input", { key: 'c343a8fff1a537a710b16b976bee1e8c2cdc5519', placeholder: "Address", value: agent?.address, "data-testid": "agent-profile-address-input", "onText-change": (e) => this.updateField({ address: e.detail }) })))), index.h("wa-card", { key: 'cb868adc3ec1f1d15261b629322f2ad38692eab2', appearance: "plain", class: "agent-card", "data-testid": "agent-profile-contact-card" }, index.h("p", { key: '4b9b1918ea9250a620ebf240aff7352e24078179', slot: "header", "data-testid": "agent-profile-contact-title" }, "Contact Information"), index.h("div", { key: '62cbb83c0ab1a615ce78997722052fd6396f4cf1', class: "agent-form-group" }, index.h("ir-validator", { key: 'bed9f4c5fa67136300a1ae70426e231a9e394242', schema: AgentBaseSchema.shape.contact_name, value: agent?.contact_name, "data-testid": "agent-profile-contact-name-validator" }, index.h("ir-input", { key: '197b1536b13d8510ec44165c4621a33ff0e2d9f6', placeholder: "Name", value: agent?.contact_name, "data-testid": "agent-profile-contact-name-input", "onText-change": (e) => this.updateField({ contact_name: e.detail }) })), index.h("ir-validator", { key: '392a2817f856f5d8eca6dfbdfb075f14e5841fdc', schema: AgentBaseSchema.shape.phone, value: agent?.phone, "data-testid": "agent-profile-phone-validator" }, index.h("ir-input", { key: 'd6622a1687e38848df0a7a75767f5e07fc82b800', placeholder: "Phone", value: agent?.phone, "data-testid": "agent-profile-phone-input", "onText-change": (e) => this.updateField({ phone: e.detail }) }, phone_prefix && (index.h("span", { key: 'ad02a26bbb6d6838d8975f9e0a843ee34bdef736', slot: "start", "data-testid": "agent-profile-phone-prefix" }, phone_prefix)))), index.h("ir-validator", { key: '5fd344af77c5efbc95b8acda6c86120cbf1df641', schema: AgentBaseSchema.shape.email, value: agent?.email, "data-testid": "agent-profile-email-validator" }, index.h("ir-input", { key: '9e706ac0e34e2d2ff58d5e060529ec2f865003f2', placeholder: "Email", value: agent?.email, "data-testid": "agent-profile-email-input", "onText-change": (e) => this.updateField({ email: e.detail ?? null }) })), index.h("ir-validator", { key: 'a06f4faa96d632877a326bad93ea849207e1b3b5', schema: AgentBaseSchema.shape.email_copied_upon_booking, value: agent?.email_copied_upon_booking, "data-testid": "agent-profile-email-bcc-validator" }, index.h("ir-input", { key: '778a86383ff0dbd29cb38657d34580dcf3732cc0', placeholder: "Email BCCed on booking notifications",
            // hint="Additional email address to receive booking notifications"
            value: agent?.email_copied_upon_booking, "data-testid": "agent-profile-email-bcc-input", "onText-change": (e) => this.updateField({ email_copied_upon_booking: e.detail }) })), index.h("ir-validator", { key: '728996fcae309b60df36beb10636695e91a636cd', schema: AgentBaseSchema.shape.notes, value: agent?.notes, valueEvent: "input change", "data-testid": "agent-profile-notes-validator" }, index.h("wa-textarea", { key: '27340f6ce9ab4609d53f767415bf3045be5426c4', placeholder: "Note", size: "small", value: agent?.notes, defaultValue: agent?.notes, "data-testid": "agent-profile-notes-textarea", onchange: e => this.updateField({ notes: e.target.value }) }))))));
    }
};
...
const IrAgentsTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9d16c90490ebc97298c3c222f7dba9501c8288c7' }, index.h("div", { key: 'c17cdb83c1315a15b2c53f9737d7edb7eaef9d57', class: "table--container" }, index.h("table", { key: '748ad0d8bf4ef70e3a4e23b1454be64340ab33ee', class: "table data-table" }, index.h("thead", { key: '7a5b1df7fe2c899d26fa5a4d46d03db2444b0c3a' }, index.h("tr", { key: '3db38b6b7ee5752a5331e91304734cbbb5c66cca' }, index.h("th", { key: 'a71b9429efc976c8d5e6c5f6b6a4068fa378ae3f', class: "agents-table__header" }, "Name"), index.h("th", { key: '841fc6e88254b2d21111731482fa7c440e10504d', class: "agents-table__header" }, "Type"), index.h("th", { key: '1ce4fbbcafac9dd5cb41d5b2dca43e26d4ed86ac', class: "agents-table__header" }, "Email"), index.h("th", { key: 'c13714203d264504144307b176551b8a95f2aa64', class: "agents-table__header" }, "Phone"), index.h("th", { key: 'c5974654ee2941335fd303c3ebf437357ceb578a', class: "agents-table__header" }, "Active"), index.h("th", { key: 'a1d750b0fa9c184b77468f7bda7ecaa89b4a33a3', class: "agents-table__header agents-table__action-header" }))), index.h("tbody", { key: 'c12f08f4d4b797ef4179c3687e5c4a87593143cc' }, this.agents.map(agent => {
        ...
        }), this.agents?.length === 0 && (index.h("tr", { key: 'bc732c90b14b6fc39677242b4285202ce79d0fa9', class: "empty-row" }, index.h("td", { key: 'ce3a2dea8af9b8b3cc4d5057a00eab2f2cdcd180', colSpan: 6 }, index.h("ir-empty-state", { key: '9cf11b3edf6cdcb34185b44c49c6dd87f2f939b0' })))))))));
    }
};
...
const IrInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '172e8a58d8fc714d799bd01b1a46c91272dbc22e' }, index.h("wa-input", { key: '5afe20c42fcae91bb5fa9fa61a85c18fdb1a3582', type: this.type, name: this.name, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, oninput: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotState.get('label') && index.h("slot", { key: 'ddcbf267be6da83f16a80891838681411965f290', name: "label", slot: "label" }), this.slotState.get('start') && index.h("slot", { key: 'ed077d354a6772a2970e86eb122a187fad4575a0', name: "start", slot: "start" }), this.slotState.get('end') && index.h("slot", { key: 'eb3a4cec72e55f0eee858acc74d6f65cdf25bf43', name: "end", slot: "end" }), this.slotState.get('clear-icon') && index.h("slot", { key: '0dc899203abd0b1a59851e8a8702d7b92baf1667', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && index.h("slot", { key: '9f04ba3e77e1fb3f5368b5d27e0cfddcf7ce874c', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && index.h("slot", { key: '3cc1681449aecc928da3fd2cf99337c8aae545a4', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && index.h("slot", { key: '51c699ed18fc5685e64cf64bc6164f9645295ad3', name: "hint", slot: "hint" }))));
    }
...
const IrOtpModal = class {
    ...
    tokenService = new Token.Token();
    otpVerificationSchema = utils.z.object({ email: utils.z.string().nonempty(), requestUrl: utils.z.string().nonempty(), otp: utils.z.string().length(this.otpLength) });
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '66acc03df9baf5798a263c54e18b3f133528024f' }, index.h("wa-popup", { key: 'a93f64c0098418b8410ee649bdd28305caf8e883', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: 'be3f343d5538ef29d6b70100465ce743db1a1689', slot: "anchor", class: "search-bar", "aria-invalid": this.isValid, withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, onblur: () => this.inputPickerBlurred.emit(), autocomplete: "nope", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: '79c53a1c2c7dff46c18c2e8538da2abce5c33b32', slot: "end" }), index.h("wa-icon", { key: 'f8708b64515ae3c9a3c9ce1259107a7b216e1ce4', slot: "start", name: "magnifying-glass", "aria-hidden": "true" }), index.h("slot", { key: '89abbe0393622565794c75a7abcfdbcfec0a09c7', name: "end", slot: "end" })), index.h("div", { key: '87d06213fb2a16cb961b25a515be7f4468e58f05', class: "menu", role: "presentation" }, index.h("p", { key: '0571b8f6123a51cf2be63981df35ee811cb4d496', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: 'f0595a7198fdf24a0f2e77ac3de276a5e366b410', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: 'cec09e908ac459974858353b8addc31c46ae55d2', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: 'b40013bebb92f02d83accfe1e240f72733a2eeb9' }), index.h("p", { key: 'cc15420ce9ae3cacab01a40e700d4ff1546d11d4' }, "Loading suggestions\u2026"))), index.h("slot", { key: '02e9d2618f63cb156d8f886f1708284ab59aacc3', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: '2fbbcab552cd8fb667d01822eae56f07e65fd8fd', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: '0128184cb61743a33aed4aa9d00567efc0426f5d', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '0b19e07ee9beacbaea974db2001dc46f34a0c206' }, "No results found")))))), index.h("span", { key: '348d9d4672ef66b504da5a1ea19593fcd2e84860', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrToastAlert = class {
    ...
    render() {
        return (index.h("div", { key: 'a192b346990a4079e00448eaa6e2980ead20c6c8', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, index.h("wa-callout", { key: 'dd80154a7eb239a892a32b65e71ca5b8cd2a3932', variant: this.calloutVariant }, this.getIcon(), index.h("div", { key: '23b8514744611b166076003d717ee211b9c98073', class: "toast__body" }, this.label && index.h("h3", { key: '454360247817969858137d24e4e768be5576ac67', class: "toast__title" }, this.label), this.description && index.h("p", { key: '82662a640ab448c14fc662745afcb617b05d0a93', class: "toast__description" }, this.description)))));
    }
};
...
const IrToastProvider = class {
    ...
    render() {
        return (index.h("div", { key: '0be14e9f705658433924bdfab3a9c344bc679056', ref: el => (this.popoverRef = el), popover: "manual", class: "toast-popover", onToggle: this.handlePopoverToggle }, index.h("div", { key: 'dc1d1f288d13b2dc93ed011816b9f09c2f64d3e7', class: `toast-container ${this.getPositionClass()} ${this.rtl ? 'rtl' : ''}`, role: "region", "aria-label": "Notifications", "aria-live": "polite", dir: this.rtl ? 'rtl' : 'ltr' }, this.toasts.map(toast => (index.h("div", { class: "toast-item", key: toast.id }, index.h("ir-toast-alert", { toastId: toast.id, label: toast.title, description: toast.description, dismissible: toast.dismissible, actionLabel: toast.actionLabel, position: this.getAlertPosition(), variant: this.mapVariant(toast.type), leaving: toast.leaving, onIrToastDismiss: this.handleToastDismiss, onIrToastInteractionChange: this.handleInteractionChange })))))));
    }
};
...
//# sourceMappingURL=ir-agent-contract_27.cjs.entry.js.map