...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6d33128065ff098fcb7f61b8d9a9b50a6b4e293b' }, index.h("wa-radio-group", { key: '1a42bbcffb5683a860223318f6cf68fd4898ffab', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, index.h("wa-radio", { key: 'ccc6432b2b922da929edd587e19bc4f2e10329eb', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (index.h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, index.h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), index.h("wa-radio", { key: 'f4ff933c87ee7f141f2c15c0812be11846a22a38', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name')), index.h("ir-booking-company-dialog", { key: '45c9f2bd937b0971cb8e03b44c0316f6cc2c2771', onCompanyFormClosed: () => {
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '16dd8a80a1cf23338a524c40e09934576242d94f', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (index.h("ir-booking-editor", { key: '9832806c85319acd04c19ec436ce0b8fc21e3f78', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), index.h("div", { key: 'f5af43e275fe962692a14d8da482bfcfa8516257', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
...
const IrBookingEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '9fc94f01401b654e7df2e82cabd0c2c7443cc79e', class: "booking-editor__guest-form", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                this.doReservation.emit(submitter?.value);
            } }, index.h("div", { key: 'cb02858236ee06d03a3024fbd88bd81d35def074', class: "booking-editor__header" }, index.h("ir-date-view", { key: '574fdbc8e0ffbcfa9bec4b970c95769ae0b0ca61', class: "booking-editor__dates mr-1 flex-fill font-weight-bold font-medium-1", from_date: dates.checkIn, to_date: dates.checkOut, dateOption: "DD MMM YYYY" }), this.totalRooms > 1 && (index.h("div", { key: 'bed597907a604372a6088bbf7c9c6ef689942aa2', class: "booking-editor__total mt-1 mt-md-0 text-right" }, index.h("span", { key: 'c566882fe0317764b2ce1d80ed0ed129d7588e4c', class: "booking-editor__total-label" }, locales_store.locales.entries.Lcz_TotalPrice), ' ', index.h("span", { key: '53ccab7184db045abdcf70730d44c612f038f47b', class: "booking-editor__total-amount font-weight-bold font-medium-1" }, utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.totalCost))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
        ...
        })), ['BAR_BOOKING', 'PLUS_BOOKING'].includes(this.mode) && (index.h("section", { key: '15c14f77330f10f175724fdc87c202778568d2d6', class: 'mt-2' }, index.h("div", { key: '4e07a3b7ba1a2d1214b21e0373869da5a9d20ce3', class: "booking-editor__booked-by booking-editor__booked-by-header" }, index.h("h4", { key: '142f08fad63836ef9b52102be09e4c16d5cab008', class: "booking-editor__heading booking-editor__booked-by-title" }, "Booked by"), index.h("ir-picker", { key: '7714a4e961d7f77010bf0067c13a3404869281c0', class: "booking-editor__booked-by-picker", appearance: "filled",
        ...
        })), booking_service.booking_store.bookedByGuest.id !== -1 && (index.h("ir-custom-button", { key: '191141dbfe27f4e98b04d63f4da929aeff91ca9d', onClickHandler: () => {
                booking_service.updateBookedByGuest(booking_service.bookedByGuestBaseData);
                this.pickerEl.clearInput();
            }, variant: "brand" }, "Clear user"))), index.h("ir-booking-editor-guest-form", { key: '1b85e7525108f73dec833154d330c5f7b301b6f0' })))));
    }
};
...
const IrBookingEditorGuestForm = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '85bc00f2f9c3708317b4ca2d9d2e2a0691bf820d' }, index.h("section", { key: '6c7732c9ee15b76babad7c17e773fb7bc8ba6c59', class: "booking-editor__form-control" }, index.h("ir-input", { key: '74eb8b02c2aec6b2841118fb76dc7eb2f7272e50', label: "Email address", "onText-change": e => booking_service.updateBookedByGuest({ email: e.detail }), type: "email", value: bookedByGuest.email, defaultValue: bookedByGuest.email, placeholder: "Email (leave empty if not available)" }), index.h("div", { key: '40dfdf9b0d1f55e7cb014d2c647830867b3123e4', class: "booking-editor__guest-name-group", id: "booking-editor-guest-name-group" }, index.h("ir-validator", { key: '866794b543cfdfe5ff85ff3c28c3ff5e990d97f6', class: "booking-editor__guest-input-validator", value: bookedByGuest.firstName, schema: BookedByGuestSchema.shape.firstName }, index.h("ir-input", { key: '00728a289bfaea558de36a7fe8a4c64ce25a3f95', id: "booking-editor-guest-first-name", class: "booking-editor__guest-input --first-name",
            // label="Name"
            value: bookedByGuest.firstName, defaultValue: bookedByGuest.firstName, placeholder: "First name", autocomplete: "off", "onText-change": e => booking_service.updateBookedByGuest({ firstName: e.detail }) }, index.h("p", { key: '7a8d012df824e800ac1cf220ace0898173bdbd53', style: { margin: '0', marginBottom: '0.5rem' }, slot: "label" }, index.h("span", { key: '1d53dc5dbd2d24c5da963bf4c677a24d6b5fd0bf', class: "booking-editor__guest-input-label --first-name-pc-label" }, "Name"), index.h("span", { key: '651779135825f040e9180193c5a69d9e671b6bd3', class: "booking-editor__guest-input-label --first-name-mobile-label" }, "First name")))), index.h("ir-validator", { key: 'c8b839084f6903b157550225ca8f4ddc383cdf8c', class: "booking-editor__guest-input-validator", value: bookedByGuest.lastName, schema: BookedByGuestSchema.shape.lastName }, index.h("ir-input", { key: 'df4dac8d02639d049e30ea5fbdcc72f503e282b6', id: "booking-editor-guest-last-name", class: "booking-editor__guest-input --last-name", label: "Last name", "onText-change": e => booking_service.updateBookedByGuest({ lastName: e.detail }), value: bookedByGuest.lastName, defaultValue: bookedByGuest.lastName, placeholder: "Last name", autocomplete: "off" }))), index.h("ir-input", { key: '893b9b94cffc36169180931304a0cafbca6d386e', label: "Company name", placeholder: "Company name", value: bookedByGuest.company, defaultValue: bookedByGuest.company, "onText-change": e => booking_service.updateBookedByGuest({ company: e.detail }) }), index.h("ir-country-picker", { key: 'cd42aa9d53fbef8c5d9a7dd63d5dded9b3498b62', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.updateCountry(e), countries: selects.countries, country: selects.countries.find(c => c.id.toString() === bookedByGuest.countryId?.toString()) }), index.h("ir-mobile-input", { key: 'd0fe92c41c98d632c955d6358f211e65fb8cdec6', size: "small", "onMobile-input-change": e => {
                booking_service.updateBookedByGuest({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => booking_service.updateBookedByGuest({ phone_prefix: e.detail.phone_prefix }), value: bookedByGuest.mobile, countryCode: selects.countries.find(c => c.phone_prefix === bookedByGuest.phone_prefix)?.code, countries: selects.countries }), index.h("wa-select", { key: '3c30b7765d3189483cc0b7a07839a25bec3a18f6', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", id: v4.v4(), defaultValue: selects.arrivalTime[0].CODE_NAME, value: bookedByGuest.selectedArrivalTime, onchange: event => booking_service.updateBookedByGuest({ selectedArrivalTime: event.target.value }) }, selects.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: bookedByGuest.selectedArrivalTime === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("section", { key: '31b69481fa48842e5a230eb23d5518ca1297e647', class: 'booking-editor__form-control' }, index.h("wa-textarea", { key: 'c242781d4ee08ef6f58d76a78aa068567863a7c8', onchange: event => booking_service.updateBookedByGuest({ note: event.target.value }), size: "small", value: bookedByGuest.note, defaultValue: bookedByGuest.note, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 3 }), this.paymentMethods.length > 1 && (index.h("wa-select", { key: 'f6b6a3a1ff22f5de130582f1a0ef15592ec3d6a1', label: 'Payment Method', size: "small", defaultValue: booking_service.booking_store?.selectedPaymentMethod?.code ?? this.paymentMethods[0].code, value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: 'e2ca098089ecf0d985a56404463bc6f984d74352' }, index.h("ir-input", { key: '3f978d0def111d239dce249ea1085440683d47b7', value: bookedByGuest.cardNumber, defaultValue: bookedByGuest.cardNumber, "onText-change": e => booking_service.updateBookedByGuest({ cardNumber: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: '4a0f526a4f06a5e3d0cc8ea691dfb5b270b299ec', value: bookedByGuest.cardHolderName, defaultValue: bookedByGuest.cardHolderName, "onText-change": e => booking_service.updateBookedByGuest({ cardHolderName: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: 'b90b521a72b3f4220a5dee57c56be0620d32252f', "onText-change": e => {
                const [month, year] = e.detail.split('/');
                booking_service.updateBookedByGuest({
                    expiryMonth: month,
                    expiryYear: year,
                });
            }, value: this.expiryDate, mask: this.expiryDateMask, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h(index.Fragment, { key: 'a06656a3522b2da15b8f4f08476ad1f1a1042e8a' }, index.h("style", { key: '97a306283cff7e28275f5d544bc51a612ba7d85d' }, `p{
              margin:0;
              padding:0}`), index.h("div", { key: 'c19ea164582bb8d1b4f4679d39f5f7dbd09831b8', class: "booking-editor__payment-info-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description }))), index.h("wa-checkbox", { key: '2f699b314f5d6bbf2f7ad25a4f13ffbf6ab7564c', defaultChecked: bookedByGuest.emailGuest, checked: bookedByGuest.emailGuest, onchange: event => booking_service.updateBookedByGuest({ emailGuest: event.target.checked }) }, locales_store.locales.entries.Lcz_EmailTheGuest))));
    }
};
...
const IrBookingEditorHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4f0e343b85259d5bbf214a51a4ab569c1165964b' }, index.h("form", { key: '6d1400217692604be49e5a45b99cc7cc93b3723a', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (index.h("ir-validator", { key: '76a6b5820641b30d7fabe15f6b236e2ac08f96f9', value: booking_service.booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, index.h("ir-picker", { key: 'dc42c7205990d27fabbe4e2d7d7677436dfc9953', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales_store.locales.entries.Lcz_Tobooking}#`,
        ...
        })))), index.h("div", { key: '4e85f6fc92bf13a6cd51c3133a481c87adaeec6d', class: "booking-editor-header__container" }, !this.bookingEditorService.isEventType(['EDIT_BOOKING', 'ADD_ROOM', 'SPLIT_BOOKING']) && (index.h("wa-select", { key: '5b1a9320975f8a425d32ddacf096046070e723de', size: "small", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_service.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_service.booking_store.bookingDraft.source?.id, "onwa-hide": this.stopEvent.bind(this), onchange: this.handleSourceChange.bind(this) }, sources.map(option => (option.type === 'LABEL' ? index.h("small", null, option.description) : index.h("wa-option", { value: option.id?.toString() }, option.description))))), index.h("ir-validator", { key: '8882c2bee2ed77e1a62c76b1c3d17d7a0525f433', class: "booking-editor__date-validator", showErrorMessage: true, value: booking_service.booking_store.bookingDraft.dates, schema: this.datesSchema, style: { position: 'relative' } }, index.h("igl-date-range", { key: '2224f1a00efa87879951ae32824a5306750588d1', defaultData: {
                fromDate: checkIn?.format('YYYY-MM-DD') ?? '',
                toDate: checkOut?.format('YYYY-MM-DD') ?? '',
            }, variant: "booking", withDateDifference: true, minDate: this.minDate, maxDate: this.maxDate, onDateRangeChange: this.handleDateRangeChange.bind(this) })), !this.bookingEditorService.isEventType('EDIT_BOOKING') && (index.h(index.Fragment, { key: 'cdeb21ad9d1780499dd4d538cc2433f0dca9a7df' }, index.h("ir-validator", { key: '33d769a03fa7fbd044f162a951204f524b2aec31', value: adults, schema: this.adultsSchema }, index.h("wa-select", { key: 'ce3036fdb5e0487fc1784281499474584a26e972', class: "booking-editor-header__adults-select", size: "small", placeholder: locales_store.locales.entries.Lcz_AdultsCaption, value: adults?.toString(), defaultValue: adults?.toString(), "onwa-hide": this.stopEvent.bind(this), onchange: this.handleAdultsChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.adult_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))), calendarData.calendar_data.property.adult_child_constraints.child_max_nbr > 0 && (index.h("wa-select", { key: '11bf350bfbb6a4fd1a7d654e30063c484057ff2c', class: "booking-editor-header__children-select", size: "small", placeholder: this.childrenSelectPlaceholder, value: children?.toString(), defaultValue: children?.toString(), "onwa-hide": this.stopEvent.bind(this), onchange: this.handleChildrenChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.child_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))))), index.h("ir-custom-button", { key: '21122362657324dd98f6d10375a27f2465053ee1', loading: irInterceptor_store.isRequestPending('/Check_Availability'), type: "submit", variant: "brand" }, "Check")), booking_service.booking_store.roomTypes?.length > 0 && (index.h("wa-callout", { key: '247dc878bf865ff41ea8e600c9deea155cdeb930', size: "small", variant: "neutral", appearance: "filled", class: "booking-editor-header__tax_statement" }, calendarData.calendar_data.tax_statement)))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"],
        "mode": ["handleModeChange"]
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '2bd99a62bf49972b02682c0eaf8aeba54155a259', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const ZSharedPerson = index$1.z.object({
    ...
    first_name: index$1.z
        ...
        .optional(),
    // .nullable(),
    last_name: index$1.z.string().optional(),
    // .union([
    //   z.string().min(2), // if provided and non-empty, must have min length 2
    //   z.literal(''), // or it can be empty string
    // ])
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: 'b6720906c316f07debcf9a7eb894c55720187cea', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '06396be091662549774ba0346d8714e6425b2f87', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: 'fc26a0525591861f86a7c05b216b4c8b1d6de0e7' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '36a8ea89d3b3fa08dd139ddf9ade30d1645c2166', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '7d55655b23ff9cca50e5f9dc0d3dde1f68c4d24b' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: 'c4c18b697ac9d21f8682eaa8061aaba3b460c16a', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '1f0a40468adf10b50dfa731eb266b5c38b27d8b9', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '975c594884cbf72c7f9c07c549cad79565989280' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: 'a42ee6a6c785148f71b55b910736048e1f7d3e9a' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3018cafbfdbd088659e554b4c540997123aaebeb', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: '8672d89a37a1121d82b89505ca21f8eb2a398a37', class: "ir-print-room" }, index.h("header", { key: '7df4b851de5abca173c38d68331ea3aad1161864', class: "ir-print-room__header" }, index.h("p", { key: 'c49c90d402af36b5134dd99cfd98b6315a1c0f88', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: 'f7965eb27bcf8fcfaead6cc14ea2432c2f505e94', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), index.h("p", { key: 'fff88535d3a38b0018138629680d8541404beb10', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: 'f9c3cf949cd809e70ad73bf769c0e4626effe361', class: "ir-print-room__body" }, index.h("div", { key: 'eb7fdae4d607999512a5070becb2233201af772f', class: "ir-print-room__details" }, index.h("div", { key: '41dc9715d775a126d0427d2c45d0dc333d610784', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: 'c8954f07434d453a6ae82d2976467eb7a73617fb', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: '5d57c0bf60374bd199a9b1746fb797b768d9d5ef', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '17be50a76bfd70aecca15fee5d062be7acb9fbdf', class: "ir-print-room__row" }, index.h("div", { key: 'f4cc205667b4668247e6490ad91292ce24d16f34', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: '40b3395b135788729b22669e5eff4b2e69264f0b', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: '3ac3299a466f8481b5d57959ac11be34a428bede', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: '5c63f758e1cac72e6399dc767928fddd33e71f33', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: '314d39725dc1338e4705bd23be60c04ec3373f92', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: 'adafea37e1d4cf334570dd1408a505b1e6fc285b', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: 'e3e3f52ea3f3035ad144583d41519340e43fb9b2', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: '4e8e72fae12da2d20fc1e15d1941d9fe76ba0ee8', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: 'b064158684578b676e6b5191bc1b8aacefd215b6', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: 'd36e89457a06a3d6f72f94ecaafefcbbe604b6a7', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: '25d78a8227ec872091c6f29fc2b5678cbe5cce5f', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: 'd7d79892c200be11072d7170d924c31bf4cfe497', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: 'ceade754268be0aa377734201e42d8bcfd7e2f66', class: "ir-print-extra-services" }, index.h("h3", { key: 'e73b5ef4ed7557d889151af1e048abfd7f5cc721', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: '6f8035ff3d23a590df7eec788b6fdde54c4e093c', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
...
`;
    ...
    render() {
        ...
        index.h("ir-unit-tag", { key: '345d655ba673e5ed4651a75fb4e002c5702e2858', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: 'bb97cfb70231b2483d8ab49bbf84de53851ec4cd', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: 'fad186a6a67a91539a8f38bfbabde34c810c3aa7', appearance: "outlined", variant: "brand", onClickHandler: () => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: 'af9f728334742755dadd1e64eba28aa8aa6dc1cd', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '3e36b54ab616cad8c4d6160bdfa33a5b996e60bc' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '41f2ce564f774d343b334cc90319a9fba2014491', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'a44413b6c7af045cd734e1e89255d6c086c70115', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '0aba4a382a0c9719ea885d01991db2efcc35ebf5' }, index.h("ir-label", { key: '83343146d66be74594f8810d13785263e3606b27', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'ecae0471e812c1cd07007ebc75601b1a025bbee8', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: 'e8569bed31d20a59f70035808597156df7380b19', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '0e7c318fe8e1a014ebcfd1e7ef5af957ac3103c8' }, this.renderModalMessage()), index.h("div", { key: '4786e09531a1e87aa11207fc0efe7a38162f2f0b', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '203c0913c9a00063bc67bc0da9619988679a0de7', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'fe3d27bab0e8358a83d36da0adb1e0faef2c6880', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: 'a9c2d00f784a78431d4cbcb25b3668ec09a43207', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '4dbb132665ee014ad6211d1fa797c2437cf1e19c', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'd5ae278633f59693ea26d22350693d4b3db575ae' }, this.showTooltip && index.h("wa-tooltip", { key: 'f12887c4df0accbd06eb19ad6bd1903609760d9d', for: this._id }, this.unit), index.h("wa-tag", { key: 'ee25c74b757d35874f7c075572fa4c8f76a0a93f', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '6de33c8a9809e2dca727bb13efdfb5fbbd08f851', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
//# sourceMappingURL=ir-applicable-policies_46.cjs.entry.js.map