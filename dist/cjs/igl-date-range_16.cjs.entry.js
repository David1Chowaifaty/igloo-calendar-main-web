...
const IrHkTasks = class {
    ...
    render() {
        ...
        })))))), this.selectedRoom && (index.h("ir-modal", { leftBtnText: locales_store.locales.entries.Lcz_No, rightBtnText: locales_store.locales.entries.Lcz_Yes, onConfirmModal: this.handleConfirm.bind(this), onCancelModal: () => (this.selectedRoom = null), modalBody: `Is ${this.selectedRoom.unit.name} cleaned?` })), index.h("ir-sidebar", { open: this.archiveOpened, showCloseButton: false, onIrSidebarToggle: () => (this.archiveOpened = false) }, this.archiveOpened && index.h("ir-hk-archive", { slot: "sidebar-body" }))));
    }
...
//# sourceMappingURL=igl-date-range_16.cjs.entry.js.map