...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '03d1bfea8e30ca6a86083e3d2f446dd80be9c677' }, index.h("slot", { key: '022c32577b2feb0be6573e94d4555000e85d7216' })));
    }
...
const IrMCombobox = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.irChange = index.createEvent(this, "irChange", 7);
        this.irInput = index.createEvent(this, "irInput", 7);
        this.irFocus = index.createEvent(this, "irFocus", 7);
        this.irBlur = index.createEvent(this, "irBlur", 7);
        this.type = 'select';
        this.label = '';
        this.placeholder = '';
        this.options = [];
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ae60fb815292975a7cc9ee6ffb19cd01e2cf4b8a' }, this.label && (index.h("label", { key: '945bf90e3385714e6e3489be8c73bcdaca5882c6', id: this.labelId, class: "combo-label" }, this.label)), this.type === 'multiselect' && this.selectedOptions.length > 0 && (index.h("ul", { key: '58d0c9cf223ec839b6cef0c96b772746cd6932ec', class: "selected-options" }, this.selectedOptions.map(option => (index.h("li", { key: option.value }, index.h("button", { type: "button", class: "remove-option", onClick: () => this.removeSelectedOption(option), "aria-label": `Remove ${option.label}` }, option.label)))))), index.h("div", { key: 'c02cb1f863bb61e2cde3773ada4f821d96a2c322', class: `combo ${this.isOpen ? 'open' : ''}` }, this.type === 'select' ? (index.h("div", { id: this.comboboxId, class: "combo-input", role: "combobox", "aria-expanded": this.isOpen.toString(), "aria-haspopup": "listbox", "aria-controls": this.listboxId, "aria-labelledby": this.label ? this.labelId : undefined, tabindex: this.disabled ? -1 : 0, onClick: () => this.toggleCombobox(), onFocus: () => this.handleInputFocus(), onBlur: () => this.handleInputBlur() }, this.inputValue || this.placeholder)) : (index.h("input", { id: this.comboboxId, class: "combo-input", type: "text", role: "combobox", "aria-expanded": this.isOpen.toString(), "aria-haspopup": "listbox", "aria-controls": this.listboxId, "aria-labelledby": this.label ? this.labelId : undefined, value: this.inputValue, placeholder: this.placeholder, disabled: this.disabled, readonly: this.readonly, onInput: (e) => this.handleInputChange(e), onFocus: () => this.handleInputFocus(), onBlur: () => this.handleInputBlur() })), this.isOpen && (index.h("div", { key: '9b18cffa2b6a546755fae64a09e61a09690e2e4f', class: "combo-menu", role: "listbox", id: this.listboxId }, filteredOptions.map((option, index$1) => (index.h("div", { key: option.value, class: `combo-option ${index$1 === this.activeOptionIndex ? 'option-current' : ''} ${this.type === 'multiselect' && this.selectedOptions.some(selected => selected.value === option.value)
                ? 'option-selected'
                : ''}`, role: "option", "aria-selected": this.type === 'multiselect'
                ? this.selectedOptions.some(selected => selected.value === option.value).toString()
                : (this.inputValue === option.label).toString(), onClick: () => this.selectOption(option) }, option.label))), filteredOptions.length === 0 && (index.h("div", { key: '5245bdc7f8b4588873f1562a2c0d068b9b92c40e', class: "combo-option" }, "No options available")))))));
    }
...
const IrTestCmp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8ff5f8ef17ae84cd6fa7ced627aaf1612086e967', class: "card p-4" }, index.h("ir-m-combobox", { key: 'bf1550b4cbe3a6d5c1e9782ccbc2b21f1e27b3c1' })));
    }
};
