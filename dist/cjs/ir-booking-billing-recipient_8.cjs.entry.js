...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '1e19de17859af699ccbb58baba74d402bc2e19f5', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: '5e3c817f7d11970040ea1fc8f0b76a876cd2a66a', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: '5fb611e146ed6510119d3ed1f06aed094efc2eb8', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'f3abd101f601504dcb7dd63f7097b39febcb434a', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'edbe0408b33efabcfb680b8da3997c1744c96789', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: '4c6dd2d53d5047f95b7daf6780a89d441c97db78', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-input", { key: 'af8e2fcba4c7aba18ff79bf06d5ffa84a3dab5b2', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-input", { key: '52da18772afc0d44fa2c31f7dfd9499ceffbef7e', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: '22ed060f94e17ad9772102d00329d3087e0b868f', class: "ir-print-room" }, index.h("header", { key: '30a5891f886bdbb3d338ca2da12d8438c717525b', class: "ir-print-room__header" }, index.h("p", { key: 'a2fbaa9c67e95186e6a0d9013072a7b019e657fa', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: 'c662c23c81382ce58b7c3eea004523c0e7c02fe7', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), index.h("p", { key: 'fa8af02ed096e0e7c69f69d8c99c47971d085a97', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: 'dd1ae3e5d737bf9cc1feb89610d14af2e12712af', class: "ir-print-room__body" }, index.h("div", { key: '0d4b585ebb74e2394aab0b8748badd15eb2f792a', class: "ir-print-room__details" }, index.h("div", { key: '26c53b506884562c424daf6eb91840e4326f6bb8', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: 'a90679c8dadfb4c6d33dd0e291628de033f7a87a', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: 'cf71e2b56b6908298fe853436c396f3820e352da', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: 'e2320c65782bc5d3607cff4b8b82bccc84107502', class: "ir-print-room__row" }, index.h("div", { key: 'a8f9cdccfd8228690f3d2fcc6a8bc93be40dd8de', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: 'e666ae4ad619c89eaae9992f4fd3380ba78a6fe7', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: 'c4d031f187da39cb95a32264d8de23f9db581614', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: '2bf60ffd2401a2079ca7c8be977fce4a11efaf33', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: 'f677afd33c7b3ec44faf11b586e2345982ad6d20', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: 'a6dd5d3395b79a02a69ace649c2121dc916d6360', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: '9c603de1d3ef1779a097b5f41ef245e7e431b3be', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: 'd11a1790df1d85610e5ae636db4748149d70ef74', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: '1800d24964f331c98e9eb9dcf5c52217b20ccb15', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: 'd984935bfbf2bd5ce591d7294e76eb3a1744a1b6', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: '9682c0ec8881401b1b0fd95a0a5f66c4b9603945', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: '9ccb2124d745c62061a1ee30ca866600afa2b712', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: '232326273b336c00db73e6fc9b831dd398a6d642', class: "ir-print-extra-services" }, index.h("h3", { key: 'f8af8327819d16f821e4ee906a0f947618b46b1d', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: '44b7f0f79236ceb9af04b759d717e96d9b26076f', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
