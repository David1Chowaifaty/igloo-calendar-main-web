...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (index.h(index.Host, { key: '825a8b103eb53955cdb6cd5de724a77aa658bcfa' }, index.h("wa-radio-group", { key: '29f48b85302678c829ea34c0ac9e7dc1b3d40cd8', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "s" }, index.h("wa-radio", { key: 'a2ced91e2840c98dd31d96291e9311a4fa751064', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (index.h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, index.h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (index.h("wa-radio", { key: '0723187fb65346f3703b12341b0fdc73a741883f', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), index.h("ir-booking-company-dialog", { key: '00e5e3dba724fedc71b2581135286ed983eeb41f', onCompanyFormClosed: () => {
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '9d6c60248a0206aab065ff0e802677e328e59033', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, index.h("div", { key: 'af33e41b68a6356d4e6f0b148df55d3530e5de86', slot: "header-actions", class: "ir-fullscreen-dialog__header-actions" }, index.h("slot", { key: '44ba0bf54c73218c13ae3f2539eb7f7bc86e47e9', name: "header-actions" }), !this.hideDefaultAction && (index.h(index.Fragment, { key: '30f8d8427315352191b2dbcf011e4ff916e8ce22' }, index.h("wa-tooltip", { key: 'b01e1eff09c5ae2b573d75d2dd4367741caf6249', for: this._id }, "Print PDF"), index.h("ir-custom-button", { key: '9268b6d8073bd4490486ab6f853da1164607eb51', id: this._id, size: "m", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'd96ad547e95ab844551d9f40c089e81fadbcd47c', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() }))))), index.h("slot", { key: 'b94223691cbfd5e9a0f9275fa68a49720cdd81d8' })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: '0ca3d2a35107102750b337e5969340127455a945', class: "ir-print-room" }, index.h("header", { key: 'f1037247836af8c2759d27ed436bbff4f20da071', class: "ir-print-room__header" }, index.h("p", { key: 'cb9ac568fa3f4f74bc1342bb538604249cd85c62', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: '1d4fb61420898539dcf1d53070bc0cb56d590a97', class: "ir-print-room__unit" }, "(unit ", room.unit.name, ")"), index.h("p", { key: '8d43bc2e87564cadf2ac5aeb03a9684636d2bd76', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: '9f8cd9782b2f53b6c0087ed18d015f61dff025b0', class: "ir-print-room__body" }, index.h("div", { key: '13dbb234eb4b8fb06d2dad83fad8443809ecf469', class: "ir-print-room__details" }, index.h("div", { key: 'b03fe95d6c4378d2afb7524be67a78db42ead40f', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: '040bfcb914bf8f787ab7017cc7704c6efaa06f53', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: 'b38360aae33c4fab9b05f58eab26dbe66d927913', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '78bc2b1430337555b9156a2a75fe4c223ec5d815', class: "ir-print-room__row" }, index.h("div", { key: '345676feca5078e559cca696c223f84756972e2a', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: 'e5d4923b5338d51fb06318c75f22af0c45b4f805', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: 'ca36ac69294eb373d9148c4f90d98f29d1e33456', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: '399e0ead32d9d78eec12d2baaee6553079d5cdf3', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: '645947f258070cd48f8133e4b200bd3e767e943c', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: '39658b04756576158bcb63dba8569376de057f1e', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: 'd84a7ecb50044e39ba8b7c702c6ffb4dd2e3694d', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: 'ee7c2a4d402d70b93d0b6346a4a5aae5d05ac824', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: '5f3dde7f1b4427da1f4cb30a42901643c1b934ba', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: '1bef319d441d689b86af59be3b097e54bd80bd6a', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: '86579c8dd7e35e25917a16d1ec2f13378fe40423', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: '75cd845b6d5066d4828eae79764e5eb61fca6c9a', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: '0d1e3b686dd3873c55f604f91344bc674cd94502', class: "ir-print-extra-services" }, index.h("h3", { key: 'b05f712681c39c8126a9bbf24c1cff2fc0ae63bb', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: 'd6bffea3787d9bad3c1e8ea3a69d11aea12d5687', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
