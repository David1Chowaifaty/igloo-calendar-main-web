...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7a4153a8cf86e0420b35d7834299ce8a92b75bb9' }, index.h("button", { key: '03d844322f1cd678d2cec8507ee95b4716f61922', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '8ba6b88eb36b0322b2900e0e78578e760ab6b0b2', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '976629d2182bbfa9e9f94742a8284d9dcd9c0434', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: '05b8e19f047126af40b78d02ee9adf48884683b6', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'd722f8c40ece1c5e5070e9c0bd97f52d92895cfc', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '043d0ed84cc33a3950946f0690fd53ebc40653c5', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: 'eed3218f855aac92c0991c801819b99b830221f5', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '21adf090efa939ed29c334eeb766264789d6262d', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '9b1d2cdfee5260d35f70bdcfe73255c8401de2da', name: "trigger" }), index.h("input", { key: '4ec7937e0c45360aeec6dba45e6b4b7e8db49e86', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
...
const IrRangePicker = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '6db3e3ecd002886da37898bf182eee6c01afa199' }, index.h("div", { key: '30f38e14fbe0e4659980ae3738d9469550350a7f', class: "form-control range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: '8190fba9421909ed88130644e76c97f897140609', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("svg", { key: '51733fc72b25dc5127fa2e8c0a8047fecdfcd426', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '3f7d368d464ab910044bc4c1f129cb96c1689373', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), index.h("p", { key: '8321d325ba18f26ed4a655e6a1d5fc45f35e4c66', class: "m-0" }, index.h("slot", { key: '7e1f0da490da26946dc674f17f1449e052c816a7', name: "message" }, "Cleaned on")))), index.h("svg", { key: 'd1e71b7ed74193d46c3cc986a3b4f1697b05edc5', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: 'e50ab0062c031eccceb1df61803cd7afd2cb566b', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: '5457be657674766a5b9feaaf433277f22bb6cb4b', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '36e6932d13e5365fc77f13533e545933744299e9', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, ((_a = this.fromDate) === null || _a === void 0 ? void 0 : _a.toDate()) || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrSalesByCountry = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-toast", null), index.h("ir-interceptor", null), index.h("section", { class: "p-2 d-flex flex-column", style: { gap: '1rem' } }, index.h("div", { class: "d-flex align-items-center justify-content-between" }, index.h("h3", { class: "mb-1 mb-md-0" }, "Sales by Country"), index.h("ir-button", { size: "sm", btn_color: "outline", isLoading: this.isLoading === 'export', text: locales_store.locales.entries.Lcz_Export, onClickHandler: async (e) => {
            ...
            }, baseFilters: this.baseFilters }), index.h("ir-sales-table", { class: "card mb-0", records: this.salesData })))));
    }
    static get watchers() { return {
...
const IrSalesFilters = class {
    ...
    render() {
        return (index.h("div", { key: 'c7d33b86376a9356f817fcd094fc9152600e5cd7', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: '0b6200207020d59091667ca970ba63b5c524f891', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: '8f12cd2134e07dc790f5507989571c1a3ac55933', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '5427082023ec9b524e8dd023ad229a081c46873d', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'f413d86718add951c16fcbdf864f450af1399b8e', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '5892834fe59bd86dcfcdf79185fb5f709ae6f3ce', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: 'd9b830a1c65882fc4a363c1ed78c0782b13b4bfa', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#salesFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "salesFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'b82d24dcaf0ee7acfbe2370b0e9faff0a3ee07f5', class: "m-0 p-0 collapse filters-section", id: "salesFiltersCollapse" }, index.h("div", { key: '6f734a50197037d0422b2cf41ce1c87fba7726df', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '6100db8d5eecd8b8e9cd58222f3ffec241297dbb', class: "pt-1 filter-group" }, index.h("label", { key: '0e0fcf6137234028ba161ce86bbb13022fe0c0d4', htmlFor: "rooms", class: "m-0 p-0" }, "Rooms"), index.h("ir-select", { key: '2037f60fa9e75c08184a22fe410b0439df90dec1', select_id: "rooms", LabelAvailable: false, showFirstOption: false, onSelectChange: e => this.updateFilter({
                BOOK_CASE: e.detail,
            }), data: [
                { text: 'Booked', value: '001' },
                { text: 'Stayed', value: '002' },
            ] })), index.h("fieldset", { key: 'cdd4e42b2aae8e7d96aa32797a48424527a1b09b', class: "pt-1 filter-group" }, index.h("label", { key: '8f0f38bc79a11c8dbf5f184587fb67cd0916f5da', htmlFor: "period", class: "p-0 m-0" }, "Selected Period"), index.h("div", { key: 'd581312a6213bbb6d1a92479f1fbe13570ffa09c', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: '6f0beced9e14396f31041a43f227216c62ae8e0a', onSelectChange: e => {
            ...
            ] }), index.h("p", { key: 'ab524a20f3f543a45c61b4096d7377f520838879', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: '2031305d23e36bcb6de94a9b94f9031e3cafdfbc', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, fromDate: this.dates.from, toDate: this.dates.to, maxDate: utils.hooks().format('YYYY-MM-DD'), withOverlay: false }))), index.h("div", { key: 'bcd5d88c76ffe1cf2620e11fa309d3e42cd12398', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: '52db038a82c447d5f90907289893a868a4dc8f7d', htmlFor: "compare-prev-year" }, "Compare with previous year"), index.h("ir-checkbox", { key: 'f8abef64ebb8aba4a7400fbd67051bda7113ae50', checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.detail });
            } })), index.h("div", { key: 'd5a1bd45046c49407a55043e04a57f4a1f85dfe6', class: "d-flex align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: 'a9db4064201c88ba76655c0317f9977654acdbaf', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: 'f11faca34e1139f8f129ed896fb3739a57b6c09d', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrSalesTable = class {
    ...
    render() {
        return (index.h("div", { key: '28c232486dc2e2068db25f7a9d671cd75de67bd6', class: "table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: 'f4a4855113f980a0ff7e92a90e92483d0164dc51', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '505f54675f6bb9a57be9a6423532b7e5718a68cb', class: "table-header" }, index.h("tr", { key: '696767a835d1ad0bff90d1720bd816544359d016' }, index.h("th", { key: '34710003a5aaf483e4f5eb59c6e3409aa31f8865', class: "text-left" }, "Country"), index.h("th", { key: 'fc1edcaac631834a21837d391da90f503eed55c5', class: "" }, "Room nights"), index.h("th", { key: 'cc39fecf99429d7cd75c53113db2043e65179b8e', class: "" }))), index.h("tbody", { key: 'b446fffc9597a63f5f95cbe7dc3e33fb0977c3a1' }, this.records.length === 0 && (index.h("tr", { key: '5ba84be71965048b3c0d9f02056ccd6553b549db' }, index.h("td", { key: '62e1dfdc3413d57c41139a3cc03cbc7a1ce392ce', colSpan: 4, style: { height: '300px' } }, "No data found."))), this.records.map(record => {
        ...
        })), index.h("tfoot", { key: 'd2c9407388716ecd14974ebcb21c72e13f3928e6' }, index.h("tr", { key: '78ccdc7aab73e2ab9db4d5d067f8875c6599442d', style: { fontSize: '12px' } }, index.h("td", { key: '3e5969c9c87995d71388d13f3557884a613b7afa', colSpan: 2 }), index.h("td", { key: '1cdd403424f57656f889275bbde28198520fc9b4', style: { width: '250px' } }, index.h("div", { key: '3aafc35cb3228b4660d5024fa2280db4ca16700f', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem' } }, index.h("div", { key: '16e8a67dbe19370c83efc56832651c5b2918fe6d', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'de901c0ed923c5afdfe08c5595e753c438e55f65', class: "legend bg-primary" }), index.h("p", { key: '4f84548dda9df58f54261a0350b6c588006d710f', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: 'c980235734b464b063b23ad9ec439c82d0a8f385', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '66d824b28f1e5ffa0eb69d5e7ca407802dc58655', class: "legend secondary" }), index.h("p", { key: '5c5e53a984dfe04495318e0292cc133ef0ef26de', class: "p-0 m-0" }, "Previous year")))))))));
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '9c1de78967f1b36318d4af565376c81566b890a7', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'aeeabbe783f10a6e984f20c48a1774a76cb2d910', class: "input-group row m-0" }, label, index.h("select", { key: '0a438f246ddb4eece109d33677d4e84231138198', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '97f68ee73b592c31eac15dd978e9922dfc91c81a', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '5e3215914132f42a8d778fd8779c4cc28bb015f9' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'dc34d403844284e4cb8189ec282bc1ef44f9e546' });
    }
