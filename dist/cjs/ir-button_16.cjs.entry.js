...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c32addff4607d9f82cccc95670835ace10575615' }, index.h("button", { key: 'b49ff5d9deb72c8e184eee50dba2bf77f4178094', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '69556231ab54d4e3f88da0da2296a138415cd036', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '1e64e1f34e76c3bf014e46f41c5e4b9e16e0098f', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: 'b5a3ef810aeeb0eb9aef92e120d6c50fdce5e1d0', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'adab88e37692d2d8198416e99c8ce295c137ec7e', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '54fa1ac914ca5f49eecb596ce4934b5373565337', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: 'a0de47033096bb54106ea19ed30c27f1d2b80976', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6fc88c7331ad4efcf233b133c074bc3e43ae1982' }, index.h("slot", { key: '297907a8c4100df70cc84b36a2aa780e7de3020d' })));
    }
    static get watchers() { return {
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0d26f3a423be1b53dbbd1f247a994cb3da14fc7f' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'd8acf1ed86ff5378c9df9cdcaad2c5a2adccc1f7', class: "loadingScreenContainer" }, index.h("div", { key: 'a4f32f33efb9af5dbb9c63dfd7488976aa74155e', class: "loaderContainer" }, index.h("span", { key: 'c910686008bfc631d73b8b24da27dd8bedc488d4', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: 'b64f60a84971128c1aededb28aa54a68236a9d26', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f1c983e735cae3ff1b4325dee8783e1deb5a49ac' }, index.h("span", { key: '1522d3c81575345d858a917ff5cd1553cbabe4ea', class: "loader" })));
    }
};
...
const IrMonthlyBookingsReport = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-toast", null), index.h("ir-interceptor", null), index.h("section", { class: "p-2 d-flex flex-column", style: { gap: '1rem' } }, index.h("div", { class: "d-flex align-items-center justify-content-between" }, index.h("h3", { class: "mb-1 mb-md-0" }, "Daily Occupancy"), index.h("ir-button", { size: "sm", btn_color: "outline", isLoading: this.isLoading === 'export', text: (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Export, onClickHandler: async (e) => {
            ...
            icon: 'calendar',
            title: 'Peak Days',
            value: ((_h = this.stats) === null || _h === void 0 ? void 0 : _h.PeakDays.length) === 0 ? null : (_k = (_j = this.stats) === null || _j === void 0 ? void 0 : _j.PeakDays) === null || _k === void 0 ? void 0 : _k.map(pd => moment.hooks(pd.Date, 'YYYY-MM-DD').format('D').concat('th')).join(' - '),
...
const IrMonthlyBookingsReportFilter = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '75e88d73572b746557ef99bb5ff5ee47510e19af', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: '918cd3ba93aeae0aef840f37b80ecc2b8806d363', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: '095675eca080a0891f682c0283e29e458cc3aa03', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'b212fc3f6c42da29152bc38fab6a6c84d1a0cd58', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '0a0943d7db90054b26380171c07a47bfc2b97c96', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '9f4ad6678cccbb700c0c4759e248fff5f187baf3', class: "m-0 p-0 flex-grow-1" }, ((_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Filters) || 'Filters'))), index.h("div", { key: '2d0f401ac23a11490abb0523ba2cb7730309f03f', class: "m-0 p-0 collapse filters-section", id: "salesFiltersCollapse" }, index.h("fieldset", { key: '8197dd02d8e29a223285d5d4c667c99c5e88af7f', class: "pt-1 filter-group" }, index.h("label", { key: 'c6859da1fc928f6cf89610b30b3e0a01fa42ace0', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "For"), index.h("ir-select", { key: 'bd6b2e15cff530d7db57d70449d92e6d72045687', showFirstOption: false, selectedValue: (_c = (_b = this.filters) === null || _b === void 0 ? void 0 : _b.date) === null || _c === void 0 ? void 0 : _c.description, onSelectChange: e => {
                this.updateFilter({ date: this.dates.find(d => d.description === e.detail) });
            }, LabelAvailable: false, data: this.dates.map(d => ({
                text: d.description,
                value: d.description,
            })) })), index.h("div", { key: '520878894919c508565c366d0045b01f3272f67c', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: '25ca20323e94fd5270b0ccf4173d7ffb1f83d6ae', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), index.h("ir-checkbox", { key: 'a9c4ae5db7da1f70c73cdf1bb12dea3ab059c5ef', checked: (_d = this.filters) === null || _d === void 0 ? void 0 : _d.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.detail });
            } })), index.h("div", { key: '4d282935bb0aca0affd0c6740dc823c8fb11713c', class: "d-flex align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: '577796a45fe75e7e079efde2a0c1a349859204cf', btn_type: "button", "data-testid": "reset", text: (_f = (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Reset) !== null && _f !== void 0 ? _f : 'Reset', size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: 'b8cc21d775818ff7f19d8f61414532000ff1a963', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: (_h = (_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Apply) !== null && _h !== void 0 ? _h : 'Apply', size: "sm", onClickHandler: e => this.applyFiltersEvt(e) })))));
    }
};
...
const IrMonthlyBookingsReportTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '19a2f0917db0e727629a8be5f037e9325f44c941', class: 'card p-1  table-container table-responsive' }, index.h("table", { key: '2ca5b2ac503e9d9475a605cccfaffbe8c2a09b43', class: "table" }, index.h("thead", { key: '1be7a210db90cbad9448451843b5851e71308ab6', class: "table-header" }, index.h("tr", { key: 'c1a686f51d5b2398b69db12dcd4832cdc702e241' }, index.h("th", { key: '3c554d9e1cf50a13f0f3b4127da53ee91dc98295', class: "text-center" }, "Date"), index.h("th", { key: 'c3640a8c3647c69d714bf535f12a7845f799b339', class: "text-center" }, "Units booked"), index.h("th", { key: '600f4314898a36c0baf30033ef59274dc84872d9', class: "text-center" }, "Total guests"), index.h("th", { key: '1b44da257d1db52d96276d862971c05c1fa61733', class: "text-right" }, index.h("ir-tooltip", { key: '80bd0e979cf34bf95bfb8efc15649495841dc1d3', customSlot: true, message: "Average Daily Rate", alignment: "end" }, index.h("span", { key: 'c618d47c494a2449957dc8b08c47a39c0a5e6f1c', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '848415db4bcd5871574a59af4a7cab4c08a93e2b', class: "text-right" }, "Rooms revenue"), index.h("th", { key: '9d6a2a04e07a41d9b7f1d57b3687103680265701', class: "" }, "Occupancy"))), index.h("tbody", { key: '85dea415bf253fdc09b94f9b456c3b65aed635c9' }, this.reports.length === 0 && (index.h("tr", { key: 'f89129e4878174d7d523e8bf24077b9333ac7d42' }, index.h("td", { key: '8e53c3c5bc20c900a4b50172fb73c58cee5d093c', colSpan: 3, class: 'text-center', style: { height: '30vh' } }, "No data found"))), this.reports.map(report => {
        ...
        })), index.h("tfoot", { key: '41e928364b871c37518329ac17efeeb4e871767c' }, index.h("tr", { key: '7040af861c965e8198502d70bb11d8d6ae5f00e8' }, index.h("td", { key: 'ccb1ce10ed8d502f77113fdfe4b8b58ecf88a0d5', colSpan: 5 }), index.h("td", { key: 'b92c6872b0d2f136f39375c1b5bc7dc718498056', colSpan: 1, class: "text-right", style: { whiteSpace: 'nowrap' } }, index.h("div", { key: '14dbb34aaa33a5198b831d025bf7c27ba6f288c2', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: '6682ec7594efed2a85db2323508b9a9c546d03c0', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '6b8ed88391d6fcd2f71d1108ccb519806c32a756', class: "legend bg-primary" }), index.h("p", { key: '30c515d9e5cb15f008e4f6377e5be92dc413de4e', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: 'cf884301783d66b85591bcc86cea2d78bd6db25f', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'fd170a6a9b0629b6ac1bbb7fba9f62496653594b', class: "legend secondary" }), index.h("p", { key: 'a984872ff233c1b8a3eafdd85eef739edfa32ad0', class: "p-0 m-0" }, "Previous year")))))))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '157366b4cdf3337a416a5ee7653f92280b8e0f5d', class: "otp-input-container" }, index.h("div", { key: '2569ded2aa21419fa521dd7a62f773d20407548e', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrProgressIndicator = class {
    ...
    render() {
        return (index.h(index.Host, { key: '05225daa6470948a221bcf74ad9dbcf5260299ec', class: "progress-main" }, index.h("span", { key: '2e0f09126b074420242ad8e0ae3459a520c40397', class: "progress-totle" }, this.percentage), index.h("div", { key: '581caf8e6c0151a998a0952bf85e072c0ff5902c', class: "progress-line" }, index.h("div", { key: '649f279a3f9b84d063c1115daa814e9f0533070e', class: `progress ${this.color === 'primary' ? 'bg-primary' : 'secondary-progress'} mb-0`, style: { width: this.percentage } }))));
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '65b60a49927f3627bbaaaa88f62ec8cc6fd4a5a7', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'aece2d462ac32401d1c0c6666da360f4def40d31', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '646b46d2df4b5fdd637967b72feb0ffc08b401fb', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'eabdc0497883d613791ef9ebf4253e0fdd1f216e', class: "input-group row m-0" }, label, index.h("select", { key: '98044c7e75fd781cbdbfc1a2d99b70341ec107ba', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'e762b6dbd8cb76d7db0136d28787ca6c146648b3', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'aa925c4b49ec63e4bfeed91b6a2285db308ff953' });
    }
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '4c2295a4a38fc556e7141c0c6bd1ea2f8bf19bfd' });
    }
