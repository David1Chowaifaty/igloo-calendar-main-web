...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5026f8314d1cd77373ec984855767ecb8eebe9bf' }, index.h("button", { key: '964ff8103018e3bb9e480736bd4385ac6b4012b6', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '333aac595abf70c762c78a60e75c1b8d5e153466', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'e2edc9b9784a77529bc249d5c1721a87e07ab662', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: '922af8556982a80313b2d6bb72f4ac30e7ab95ae', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '71bf13f0140755ba3014830106f98fe35d129124', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: 'b918e6f65a7ee9a739f09d32ec2a82ae19927f1b', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: 'dd2aedfa2ed991d918c92f4863d1ee252743fd37', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
...
const IrMonthlyBookingsReportTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '55f21a8424b4b337cc7273739c6aa9b2500a5ba2', class: 'card p-1  table-container table-responsive' }, index.h("table", { key: 'e9663469ad8b70eaeaf1734c7e54c8d6757753c7', class: "table" }, index.h("thead", { key: '2f82a4a6c13dc2bc4f66cc044f9ea5cf1ab78f4a', class: "table-header" }, index.h("tr", { key: 'b9ebfb0ffd41013de13ef3bd927bbc874db28597' }, index.h("th", { key: '37e5c79cf3cb4df4a3ed6c68d6db4574a5d1bf57', class: "text-center" }, "Date"), index.h("th", { key: '6dfd9ceb98da3e6f421f28384945e38083fa4cb4', class: "text-center" }, "Units booked"), index.h("th", { key: 'c155e67dcc812ce8188bb25a554651f11e2b4602', class: "text-center" }, "Total guests"), index.h("th", { key: 'a81095f680c8ed5302451a3959f96aef2d7c32a2', class: "text-right" }, index.h("ir-tooltip", { key: '5b6e8c1312c49ff8f7974de8226ada4cdeec4a2f', customSlot: true, message: "Average Daily Revenue" }, index.h("span", { key: 'de4d63e5dbc4f559472471686c58eabd66a24242', slot: "tooltip-trigger" }, "ADR"))), index.h("th", { key: '1a014d0070f2a4e8305af45fa73654579d865cf8', class: "text-right" }, "Rooms revenue"), index.h("th", { key: 'ad3fed704fd4ba3d4541427734b5e3c1ecd4e2e0', class: "" }, "Occupancy"))), index.h("tbody", { key: 'c6759347718e64ec4ef312510b9d6d1466635bb1' }, this.reports.length === 0 && (index.h("tr", { key: '572d6e0d51d6f50136a0b653e841e836e12a4bd4' }, index.h("td", { key: 'c220112df2c5ad2593f3b1430f07483d013dace0', colSpan: 3, class: 'text-center', style: { height: '30vh' } }, "No data found"))), this.reports.map(report => {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
        ...
        })), index.h("tfoot", { key: 'b40e5ab6e44128f7fc9d20c15713189ca13340fe' }, index.h("tr", { key: '01bbf1d44bedffa7631436efa9c0ad93bde4ddb9' }, index.h("td", { key: 'ca38d7b969b370c7da22c6cb841cf040ee97ce38', colSpan: 5 }), index.h("td", { key: 'f47d7851ab38e7bbd02cfe2f12a9bdab7fbcfe52', colSpan: 1, class: "text-right", style: { whiteSpace: 'nowrap' } }, index.h("div", { key: '27dd258d8b30d66fcd2c4155831d348f48d24e71', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: '48608659967b777ccb0027157fb0dc47dcb8181f', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '5ad79bb3678534ac208c7a362898c66e97a3a0db', class: "legend bg-primary" }), index.h("p", { key: '4dcf0e24fbc26197ff982a66a09fd2d3a9d68cd1', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '10eb04ad1ab50d5aa80b6042d8c0d140aa2ca207', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '93516ced98bed36e7ef0ea23638354609fefaa8a', class: "legend secondary" }), index.h("p", { key: '513f01ddb375d719328141800f51a3c17d9ff808', class: "p-0 m-0" }, "Previous year")))))))));
    }
};
...
const IrProgressIndicator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd2b2130fb1c1b375c064ac966562c687a92cb3f4', class: "progress-main" }, index.h("span", { key: '1210105fabfb147b48bbdeb7d66ba911affc7424', class: "progress-totle" }, this.percentage), index.h("div", { key: 'bdd2e7c39019121efc64a462677317a008f4e402', class: "progress-line" }, index.h("div", { key: '3c134fefa110045cf3322ce174b4eaab0988ffc8', class: `progress ${this.color === 'primary' ? 'bg-primary' : 'secondary-progress'} mb-0`, style: { width: this.percentage } }))));
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'aa694685124c263d8d51272cf5bcbbb8f887939e', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '558663e8f7ab6232cb8ff4639caa950addda5fed', class: "input-group row m-0" }, label, index.h("select", { key: '3348e8e98f8010b8a11ebcee1dad63d9f0222532', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '8ab912217b94f680aa3438f4b287afba918ad683', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '91a529683cf934f3d466e98662ae266b1d9ef10a' });
    }
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'c77755246af2151d4b9bb96359cd97d8c99b965c' });
    }
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7866491fe55dfbff8eb6c498b5afb96610ce3819', class: "m-0 p-0" }, index.h("span", { key: 'e776dff2ba831a74315fd3f52f1796681fa0820f', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: 'a997d2e2efd13e7bbc156c8f0db28ab9e5334ab5', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '50563b42d7073d82a95ca977caf97967e6a63535', class: "tooltip-arrow" }), index.h("div", { key: 'ffdfa13b5a9b4da70f335a84be2542750c259747', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '807030f7e71e554767bb6328f6f6930b6862a6f7', innerHTML: this.message }))))));
    }
};
