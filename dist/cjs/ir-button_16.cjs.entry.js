...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6ffe2160b0ea5721275dfcc0d217104a4d48e0ba' }, index.h("button", { key: '1e50db541fd85e3a656cd6ad54d0901499bd3efb', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'd13c78ff814b3d1644e84e2b367596b745529ea6', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '852200b38c90891d4f2d19f3298bc99459f0fba5', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: '4a68a7c2a5151b7850d64be7175f4c4b504c4f40', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '064687d64f8982537d1f4dd86c6f0333506cd3c8', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '61bb90909393cf496bd71debccee2cf913bb1413', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: '982e572feea083158d28025d184b3aa260ec788b', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '40207aeaee212680501958615e113b8b6df706c7' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '58c463b194da18e28eeecbd56b42d79130dcd3e8', class: "loadingScreenContainer" }, index.h("div", { key: '46d51275799051002597073ddc9c13caf20eb239', class: "loaderContainer" }, index.h("span", { key: '6a4a347f89929e509387a46faeedd69f296e51cf', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: 'c4ac49d8ccc30ae04bf7cab75353a25d514d9cfc', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c35987ca9c9be7d9b55179257ef81a4a3bc11c52' }, index.h("span", { key: '655f2f5e9d4ea647e72e1cd95024bc59f9c90f2b', class: "loader" })));
    }
};
...
const IrRangePicker = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'c3a2094f12ab6d1d7e5cfd0fe6f470d653187588' }, index.h("div", { key: '9d89cbfd4ea9d8f194f9f973625bee14d0a17a57', class: "form-control range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: '837d2df59085b3a8fb6a6232046260120b1897d1', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("svg", { key: '25ea292c4da71a3e815af0cd5948360e6254b603', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: 'eac65c0a65280f70613d3ffe41fb16e90d144915', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), index.h("p", { key: '0c22be23d95b8e9401bf2b1ea003fedff2c9fb89', class: "m-0" }, index.h("slot", { key: '6ea940e1d118cb04f623f2026a2ceadc2438312d', name: "message" }, "Cleaned on")))), index.h("svg", { key: '8ea4cb79e15a1a76df81ce60f520149104982605', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '228c5e0cd4ec67bf892308c4411c64b00cf5667d', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: '179a3701b9d7cc5a963dcc17951797993452480e', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'e2ef21a14286d1bb784291b1234bb37f4bf3ab7d', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, ((_a = this.fromDate) === null || _a === void 0 ? void 0 : _a.toDate()) || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrSalesFilters = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: '7f0a54376314d9afee9d9c39a9af80f14bbec639', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: '7ffae4ec8dee14d030b8e16cee390e925b689e24', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: '2d4d79ed2a64e97305f81d11e509a4398ee6cc0b', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'b83fc2af3677de789bdcb879d892caa301a0a827', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '492663c6235efa3b563e1561a61981967ba1f637', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '8ac4a228c23f946fedea06be6c056fe20369c166', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '0c1a1302d9897163d3dbc9e37cbb691c9aee26e7', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#salesFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "salesFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '394121aacf2f4661643be27785a0582e4e8cf77f', class: "m-0 p-0 collapse filters-section", id: "salesFiltersCollapse" }, index.h("div", { key: 'febd0b365bc0463cf69f6d682b581a2b7c5f4806', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'b9acafe82edaf633caba920ba8126187de8e5eb9', class: "pt-1 filter-group" }, index.h("label", { key: 'ba0afb8b2059ac7e9bbd904689a6c48f6ad0a9f4', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Rooms"), index.h("ir-select", { key: '84448254a5809d359fe79d15f18a7c673b829215', selectedValue: (_a = this.filters) === null || _a === void 0 ? void 0 : _a.BOOK_CASE, select_id: "rooms", LabelAvailable: false, showFirstOption: false, onSelectChange: e => this.updateFilter({
                BOOK_CASE: e.detail,
            }), data: [
                { text: 'Booked', value: '001' },
                { text: 'Stayed', value: '002' },
            ] })), index.h("fieldset", { key: '05784601df9daf4dc165d5bd3b8bac60ea69278a', class: "pt-1 filter-group" }, index.h("label", { key: '10bd4daa618b0181ebea5f3fc1e9ca6c3e98d343', htmlFor: "period", class: "px-0 m-0", style: { paddingBottom: '0.25rem' } }, "Selected period"), index.h("div", { key: '100223fb6e32466d272927d69aad1eebcc4aafbc', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: 'dbd3d47dc72b60c64d5e05a0a7f0e76a208fe0b4', selectedValue: this.window, onSelectChange: e => {
            ...
            ] }), index.h("p", { key: 'c2e33ed051050c75f85bbb59d7d14afe6cb890db', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: '382109d2aff3d115513104945fbf2cd42787b2c3', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, fromDate: utils.hooks(this.filters.FROM_DATE, 'YYYY-MM-DD'), toDate: utils.hooks(this.filters.TO_DATE, 'YYYY-MM-DD'), maxDate: utils.hooks().format('YYYY-MM-DD'), withOverlay: false }))), index.h("div", { key: 'da3dd25598628eb2a2f9dcbc879309d57ed907f9', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: '8892153f9bd36b9834f52119f0b6c2206455fb8b', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), index.h("ir-checkbox", { key: '0cee8529bb15a6aca1f05140b220f14d549a805e', checked: (_b = this.filters) === null || _b === void 0 ? void 0 : _b.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.detail });
            } })), index.h("div", { key: '500d945436b629c94a73c53efd384a1346f1e8e6', class: "d-flex align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: 'a245bb52e472d66282d3065f5f69b9e0771e7be2', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: 'df6658d301235e4bd5b413cd62a20e44d7d77153', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrSalesTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'd7c6e599e912f0a8dc87f245bfca4590b0be24c1', class: "table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: 'd6c10d12984680099d023302e32d02bcfb3720eb', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '579c376050cf086e07f1c2f199baf7e59f3d6739', class: "table-header" }, index.h("tr", { key: 'c133da7ae61f1a9fd93c1fb4559cc99b09ea4e8b' }, index.h("th", { key: '48407f19c8e8d2fa571ec7d0a60664cdacdbdfea', class: "text-left" }, "Country"), index.h("th", { key: '701cb704f6c6e8ef2ca28b4cff4c958be26119bd', class: "text-center" }, "Room nights"), index.h("th", { key: '9f6005cbd256e2dcfd212159e8f5c21aaf597910', class: "text-right" }, "Revenue"), index.h("th", { key: '1bf05a79c1e456fe6281c1b4eb8374bbc21d3d04', class: "" }))), index.h("tbody", { key: 'd6cec62e8862ec0095089b9ef65642f4ff4a97a4' }, this.records.length === 0 && (index.h("tr", { key: '62879c9066bc017ed86665b151cc4f4bb3c5a463' }, index.h("td", { key: 'c84df114c5ee7c62989134fb951772b4d858928a', colSpan: 4, style: { height: '300px' } }, "No data found."))), visibleRecords.map(record => {
        ...
        })), index.h("tfoot", { key: 'dff0d8a1993eaec38da8a9f0f4ca5f964fe34511' }, index.h("tr", { key: '200bf2dc0ec2b915886c522dda432c2b267c5127', style: { fontSize: '12px' } }, index.h("td", { key: 'b91d1b414f6ba905468c1d2eddd96fd5c757529f', colSpan: 3 }), index.h("td", { key: 'c3463301406c23af170f4bf5f9c9cebdfb7cd971', style: { width: '250px' } }, index.h("div", { key: '711851d447c004bf75d1acfc4dc4aa40b08dbb76', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem' } }, index.h("div", { key: 'ce3728aa52c5e8027bd42d94a123b00193ba8533', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '73bb92d702a427818fe1dce42517ed940f0175f3', class: "legend bg-primary" }), index.h("p", { key: '812656361e27a2a58d69b95947fe91d7c621330e', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '371d8dffcc45c55d379297e28897701f5631318c', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'd777bf91faa5ec2cbb31ab49db8fe6b1ade42e92', class: "legend secondary" }), index.h("p", { key: '37a985614326493c37a75763a64883f0e8a44af8', class: "p-0 m-0" }, "Previous year"))))))), this.visibleCount < this.records.length && (index.h("div", { key: '18a3fb2ca5bb18b8dd9398b6894f9a0c175b0a61', class: "d-flex justify-content-center my-2" }, index.h("ir-button", { key: '6a5595fdd4fb651903a9ef7222fddfd640f0eebd', size: "sm", text: "Load More", onClickHandler: this.handleLoadMore })))));
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a68c0fbaa476d60ebfcbd620dc47766204e0cee2', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '57d202b2c790e5a42a4b524811fb291eaf346503', class: "input-group row m-0" }, label, index.h("select", { key: '7af19bae4c4a785d75ed5401dff8e6453795e14c', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ac2ed916e46349fc55608433e1699b140f9d632d', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'af0c040b9ac23bc8da76e85ebb5fcba49268e5e4' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '51f05dff2287a83addac4c4a7c44b47d3ade0aca' });
    }
...
//# sourceMappingURL=ir-button_16.cjs.entry.js.map