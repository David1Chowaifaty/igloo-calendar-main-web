...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2a0923c5cd1d2784857c1ed4d6c078805a6abd46' }, index.h("div", { key: '5fffb1ebf7e7fb3d6a643f1476b18d102de7e0c9', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'd8ec3ad13b90721cefcb64e0c1dad191e8cbd52e', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: 'a37d6ef94b435a0eda562a2dad30abfcf9158d78', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: '0cc05d40ccbc1e47969e265d41f2a62ab02a1df5', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalHeader = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: '24cbacab8975ab58d49c8dc2b76fe3e2c203aca5' }, index.h("div", { key: '76079becf4b213888223c18901d19a345da5ed30', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '27308c70eebff71a903cdceb6bae4d32e37974ac', class: "header__fd-actions" }, index.h("div", { key: '047def8e605fded4d30ee0eb155b9426f0852cfe', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: '2eb02b86745479dd86ca7802b04750ece9f4da15' }, index.h("wa-tooltip", { key: '4f4a5ce58a8bdc26ed15ff2b6fb8d746dec557c2', trigger: "hover", for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '08163458588fa30e128689f501b4c0fa69c461db', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '68b00c3724f76524662aa42f23f872022cddb16c', style: { fontSize: '1.3rem' }, name: "list-ol", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), !this.calendarData.is_vacation_rental && this.dayUseBookings?.length > 0 && (index.h(index.Fragment, { key: '2da96ac14e8544d29bf198630704fe0a51abfba5' }, index.h("wa-tooltip", { key: '55a32886210ceccc82b456960b4af5f85471e5a4', trigger: "hover", for: "fd-day-use-bookings_btn" }, 'Day use bookings'), index.h("ir-custom-button", { key: '6b6f7ce03ac28d66b8723f9e48b8fef69a7973f7', id: "fd-day-use-bookings_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showDayUseBookings') }, index.h("wa-icon", { key: 'dbb049cd78675c35b4510974885bd236bb7adc17', style: { fontSize: '1.3rem' }, name: "sun", label: 'Day use', "aria-label": 'Day use' })))), index.h("wa-tooltip", { key: '014e6ec2d61f3495840022af57c19057ec66b14e', trigger: "hover", for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '5cd1034250b60451f595dd8e421104a9e42fcffe', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: 'eeea454c6752f2e2c2f7dc4619d6f7fcb30bfc99', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '97b3705a9a5f4c980ccd4d6d42c2fa8411e785d4', style: { fontSize: '1.3rem' }, name: "calendar-days", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '0d4d5ad72881e6cb2aee555e6bb9dc1bffb6e2ea', class: "fd-dates__actions" }, index.h("wa-divider", { key: '8f13ef81a0c57bfdb98d34c820240e2dbc5f387e' }), index.h("ir-custom-button", { key: '1444f6fa14f065068c07277ff14dc05a75736740', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), index.h("wa-tooltip", { key: 'dfc50b6e4598c8f298d5b94a8cf9279f56c1f575', trigger: "hover", for: "fd-rectifier" }, "Rectify or open availability"), index.h("ir-custom-button", { key: '85a08c0f63d06c8252a2bd1b58fe34b4d472f2c4', id: "fd-rectifier", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('rectify') }, index.h("wa-icon", { key: 'c53ac4e7c983c37df0de870c8a78854c57c44769', style: { fontSize: '1.3rem' }, name: "circle-check", variant: "regular", label: 'Rectify or open availability', "aria-label": 'Rectify or open availability' })), index.h(index.Fragment, { key: '57d928fa449aa197b298f9f1b0eb128a7203dee6' }, index.h("wa-tooltip", { key: '5c5350f1876205273974c0c7c34464c33d7521e8', trigger: "hover", for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: '786cdb12458bdac0420fc8a95529bbf4ec985702', id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: '7d697ee26bae15babf24a19b344b1eb2c548572d',
            // variant="regular"
            style: { fontSize: '1.3rem' }, name: "xmarks-lines", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), this.roomsList.length >= 20 && (index.h("div", { key: '634a88615237d63ffefa8e7dc3f1934866ffa721', class: "searchContiner" }, index.h("ir-picker", { key: 'e38d50dce5789eb0397dedb36594ade112170204', size: "s", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name)))))))), index.h("div", { key: 'bb8423fc40d54c779ee00bca9e2388194094e43f', class: "stickyCell headersContainer" }, index.h("div", { key: '3be39ab7038298d3daef0425daa8710bd7e429de', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglDayUseBookings = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '81ee5ce958a46cb10abab30bce29530c26091ffa' }, index.h("div", { key: '386c2b0541a4c9e5194e56c06b3b6c458d38356e', class: "dub-panel" }, index.h("div", { key: 'c8dac5b33b4e060c573c788373fb1fe07718f28a', class: "dub-panel__head" }, index.h("header", { key: '07e95fc8ac2c763d8050def20f49c08513a081ea', class: "dub-panel__header" }, index.h("h2", { key: '1d2a37306bc80c57728a8d762b6ba9489edb17cb', class: "dub-panel__title", id: "day-use-bookings-title" }, "Day Use Bookings"), index.h("ir-custom-button", { key: '029b5967f5fc99081c28cc61de7d4bbd392ddd27', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: 'd87e10e6aba3baa361589cb493c13db7ded6772d', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: '662849902f734a15f385d24bf98fa98d17c7f99a', class: "dub-panel__toolbar" }, index.h("wa-select", { key: '3b14ae2ea450205734025a4c0b138878474e8b7a', size: "s", "aria-label": "Date", value: this.selectedDate, defaultValue: this.selectedDate, onchange: evt => (this.selectedDate = evt.target.value) }, this.orderedDates.map(date => (index.h("wa-option", { value: date }, moment.hooks(date, 'YYYY-MM-DD').format('ddd, DD MMM YYYY')))))))), index.h("div", { key: 'c02e745d51719c61566961467b615b7dd7e844f7', class: "dub-panel__body" }, isEmpty ? (index.h("ir-empty-state", { message: "No day-use bookings for this date." })) : (Array.from(grouped.entries()).map(([roomTypeId, roomTypeBookings]) => this.renderCategory(roomTypeId, roomTypeBookings)))))));
    }
    static get watchers() { return {
        "dayUseBookings": [{
                "handleDayUseBookingsChange": 0
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6d81777ccf840b02f9cf874f5e9be180cc89b0b6', class: "legendContainer text-left" }, index.h("div", { key: '33d54f200851d7caf9d6c1fed2e2caf1900bf1d3', class: "fd-legend__header" }, index.h("h2", { key: '2ac50cccf85c3b67a092901ece7460fbe745777e', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '6ebb05fcf296636c07ad0e7d754122b7bde9bd1b', size: "m", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '5287c0c28f18129841bf23e3d23051f1671b97b5', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '05e1c24175ea18ca71aaaf29af79936ecd4fe988', class: "fd-legend__body" }, index.h("div", { key: '1fa22cb30983e3bbbf935be6e66b04268280e704' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '97b6ffc5d9af800840423348a82e593035542339', class: "fd-legend__row" }, index.h("div", { key: '441f1e227a9e04eeae23c739625d5df1b6aa48a9', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '06de11795e178fc7f5acb31400e6d019b3033174', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '149c1e19751c11ddc473ee4231dfcf5d15ebc914', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("div", { key: '93e8122e20152e52dd2cac095d9e608c8b861417', class: "fd-legend__row" }, index.h("div", { key: '26d6451b6b4e62cdd0ee2b594338ebf4c9481522', class: 'fd-legend__shape' }, index.h("div", { key: '350aa15a7218d639a7c6c6bf9212f43fa677c123', class: 'legend_rectangle', style: { background: 'var(--wa-color-success-fill-loud)', opacity: '0.6' } })), index.h("p", { key: '9799d5357e6065e40bf3ef599167504e4ade9c82', class: "fd-legend__row-title --day-use" }, index.h("span", { key: '109e6054d2fbf48110dc38bae59dbbada86eb07d' }, "Day use"), index.h("div", { key: '7e11d1eaafcb82822c1b17264517b88b82adbb1f', class: 'legend_rectangle', style: { background: 'var(--wa-color-brand-fill-loud)', opacity: '0.6' } }), index.h("div", { key: '5f684af804b51119893665d2ef45b402361b2968', class: 'legend_rectangle', style: { background: 'rgb(160, 160, 160)', opacity: '0.6' } }))), index.h("wa-divider", { key: 'f5a5457c1ed7f6c2ea48d6478383bde611627af9' }), index.h("h5", { key: '706f829096e4293a070d53d1ff968e5a3139bea4', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: 'bdb1fe23817b09fe06cc3681e0c5cf36f5edc132' }), index.h("div", { key: '76908ec2fb9a81bc3489d452212480f60b3fcc06' }, index.h("div", { key: 'ede3ebdbe6832fcd1a51ff491d9cb3ed7418dba2', class: "legendCalendar" }, index.h("div", { key: 'd398ca67909c78ce23cc1d9d68e1d29bd5a7a61c', class: "legendRow align-items-center" }, index.h("div", { key: '42e192f31c7c3d04f9b88eb3712060d1642417dc', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '08e57e1a34612728d5b1838db9b60ff7ade30639' }, "MAR 2022")), index.h("div", { key: 'ed61882895e52930c9dc558c08cbca28f6c483c1', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '636881609b21d612b0c4b5f7edb8bf784afe1b9b', class: "legendRow" }, index.h("div", { key: 'bde815163ad2bce907f676950a6f260a15d21dd9', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '6dbf44bca98f4695f6eafb267828090e17712878', pill: true }, "3")), index.h("div", { key: 'a33009b78f297648c3d82851df833035b3b452ea', class: "hyphenLegend" }, index.h("div", { key: '048458247a8c5e9d00935a62c51a02c7ba705bb4' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'db0873adc1a44ff68a5b53ebef7cfc07e04039d5', class: "legendRow" }, index.h("div", { key: '87b10ec6bbd1e13747356e42a8d181dd2f01ad09', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'e7f7c00c409a704481ff561112e6c93580c8284c', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '89149a57f8fd2895dfef0ece2f5d3a7837ff0e39', class: "legendRow" }, index.h("div", { key: '65dae8165d9677c7f0aade1678acbd2f48fab573', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'b68a4d4c3dd71eccd7ea2178ec85571073f95008', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '25b540a26d06b4be14555518d1605bc48fd1e5a4', class: "legendRow" }, index.h("div", { key: '316a86ca2a46d6e39e014c278fe2e591a18233be', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '4aba2fbb1661825a3c64ede62a7f5cf17a6b5712', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'fbbd4d0f723b382e8a3ebc5180e078eacf76b970', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: '1d2b02f1bdf59c1705df6481e00a5b6a921bcfef', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            ...
            } })), index.h("div", { key: '637590d0ab2a00c1eb6aedf747b7f67c59a9b3df', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'd8a78d161687276d6151080242df4b700e54d5a8', size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'de274858999b216ed350e9d94cdc7d7629053cdf', loading: this.isLoading, disabled: !this.hasInventory, size: "m", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '65ad5213b7bdffeb638eeb86aac3523c276d00a7', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '691078d85c13d00500f6af9d939047a2c3bf8a94' }, index.h("div", { key: 'f30ec00430538d863fcd84a5e4ffff34c44dea32', class: "dialog-body" }, index.h("p", { key: '3eb8a8e73b5c8455102f9a6ee69298880846dd82', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: 'a43f6b3d76e2da12f0ba051ad75f162a3bca1dc4', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "s", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: 'b90e34cd5f9b9172409fc2b57ff998624c647b78', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'd5e435880472e9f27d1158f1885e3b85a3ae74cd', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: 'cf8cb162c7e4ca4292ebffab993db94502f452fa', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "m" }, "Cancel"), index.h("ir-custom-button", { key: '33741579be93c4d6328b75362efddf491a53de82', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '50945ea9bbb4313664222e8ebd0a4460f04e7d74', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: 'b9e768c8abf5baaaeae4d7dc66073cebd16b3248', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: 'e4c3eb7b21e147749987bc9d75c308e85d56b870', class: "px-1 sheet-body" }, index.h("div", { key: '4c8d4e9f130702196e43cde9d9b2b4fcdef6ec04', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '616b011d470957c5cfc9b6910cc967cc551d2b26' }, index.h("ir-date-view", { key: '6169c155f10888a795095a4c1f842a01e9550a43', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '561b25a48ef0a0cdf71fb0c1cc1c41e8b9ecacb6', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '48875c52c67278b45e8d50459d6a43e869bc8d23', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'df9b32f653580da391094f4ff9114def113aa879' }, "From:"), index.h("ir-date-picker", { key: '6af4513cff67ecff00263660d5c2f79e17f9a55e', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: 'da36f1acfed1ee80f6f808af81c589f31d3138ee', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: 'b2bb8d8c11097b118164bedb143d2acf5ef3155b', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '43b57752c97babe1d8a7e2986c420352159e422d', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '3c29745bb96bc8019a25b315453ddd2059cafd04', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '6ff9db4435f0e5eb4db6905bdef2389207f9f087', class: 'sheet-footer' }, index.h("ir-button", { key: '7e64d7482e18592245860472cb17eb926aba0ff2', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '527248a32ecfb840936f279f4b6a952083807f79', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '98cdd97f0e8be299e77bbb0ab51649bd56f28bd9' }, index.h("div", { key: '96ab60678b1de61c02eb14dfd9e36c4584682c2b', class: "tba-category" }, index.h("h5", { key: '97a2646b2e450e1b636b80ce71af8b3fb6fe1475', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2aa46e01b6c8f7c2fea7159cc1c61ab78086a77a' }, index.h("div", { key: '42d9564372d6136d2501388bccead77d0d4f39c6', class: "tba-panel" }, index.h("div", { key: '1c0597dce0a4831b727bc1cc1cb84e50b3d60252', class: "tba-panel__head" }, index.h("header", { key: 'e35ed7af52bb74bc7c7ab930942f0bac9f26135b', class: "tba-panel__header" }, index.h("h2", { key: 'a1f9c3ab243fb16fdc5073fdd8d502c0bff37b26', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: '0480b9d429d0e3a85ae2495e23410ebb997101d2', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: 'c06346952cc2d335d18139b46f8369af49ba62f8', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: 'b73470e43cb708a12eb350d3d3e411869c9cb14a', class: "tba-panel__toolbar" }, index.h("wa-select", { key: '945fbf7d2442532b06a432927e7938348a5a3d17', size: "s", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: '2956992fb4a7dc2373c7c8025b4497003fc6a7b7', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5a5f267d1708d8db460c58dba1fbeba8e53a7825', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '3985bdc4ac05bb7b821902838c1c8d6037ee067f', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: '268a2678201f55bd3a4210f1b60b1b1fd3fd4ee0', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '15ba78cf74872e150f24e0ad541535157b3eb20a', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: '621f3b63e8e5f632a78e3043e83d9634a74355f0', class: "hk-dot" }, index.h("slot", { key: '1a1b9b9d3e0ab5407c166c9869efc852bd28f18a', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '1a93bb5acbed7053825d05d70f06dca0d335cdaa', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '5b107a88705e0dee51092a0d97eca5a23b06bcd8', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '0d42eabebbaa2ed0e15b8688d7a05d5ad2d3cf22', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '4eddf53ed577f6e88929ece929ed602b1d5df358', class: `ir-alert-header` }, index.h("p", { key: 'ff3a3323b619331df590bb86b3ec465243a6286c' }, this.modalTitle))), index.h("div", { key: '3e1199e462bb32cfa0883b929ad0f2256ac0ce3d', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '14417d06cff2d934ed70fe6fe99c684470e66abe' }, this.modalBody)), index.h("div", { key: 'bce4c6f9b632190d2b1c41e1645479890a7590b6', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '5626e78f57e0ba6a9839e23918b4e0b17c38e45e', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '571184afd1ad9d8036635c82d5f782ed7993608e', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '9ec4091cba252874dceeb7f35297eea92e321b98', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: 'e5f235d0d71844f2d2962a5c62f55f0f163f4cdb', class: "input-group" }, index.h("label", { key: '625fd5f1b1aeb2d9c095f96f5a954ef564ad6b16', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: 'aee258a56e0c4857b57d98cecc3975b6764803a7' }, this.label), index.h("input", { key: '1d870b05d42740dad115dd100a8b418814fe5d79', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '14b488e1df580104d51793e7bd63d2fb4dd3926f', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'a8d7094d9a6ceb6b94778ebfe927d25d50f84d03', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '499f7ab4247cdd77f83cde74b72551a16413e358', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: 'a7681d4f60b0741b7555efdbbb29eb50f155f106', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '37b13529bb3a219d9640d47f58a70451dd8d1e5c', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'e5c8115cb69b9c011444093bc45ded5ff7848e69', form: this._id, size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3e02dabded131d5813c8656c96fc33af02e9ab6d' }, index.h("form", { key: 'a03341e7705e0e959b70f82f2e75555174ffb29d', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '5cc3aa4fb6bfb91f492ac5b75856efa6e54eaa20', size: "s", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: 'aa551b24d36369aaee8e6799ceb9b961fe874606', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the selected room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'a69d04698320820c1a730627af941e41581948a5', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '58fb747efef24026d304be541b712800f53e9aff', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '9167439ef85a6f279d2a742edb053894a14fea0c', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '0df727bbe23c44e917e140af3813ecc54e5db07b', value: this.form.from ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '3d8a8958cb3c402b1eafd4a130bfeaff533722ae', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: 'c9ae649d40a9e3ac1eac1713219446a128fca153', value: this.form.to ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '9aacf8a4da4f7406cb44715848d39791b30a3486', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrRectifierDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0a4dd3bec87b46f9e405d2f47f354427bd68f81f' }, index.h("ir-drawer", { key: 'ec4675f1b96fe5ec814a04f99350ea0cf6168319', onDrawerHide: this.handleDrawerClose.bind(this), label: "Rectify/Extend Availability", open: this.open, class: "rectifier__drawer" }, this.open && index.h("ir-rectifier", { key: '23e12e2dc5fcf80cbb6f156b05327ca6ac8165d6', formId: this.formId, onCloseDrawer: this.handleDrawerClose.bind(this), onLoadingChanged: this.handleLoadingChange.bind(this) }), index.h("div", { key: 'd44c5471ebbf064b2c05e5de630e823a2236a56a', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '93cddfab15eb0a4986b9a63aa68e7c73bc5e0864', size: "m", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '252b40ef46cbddc27a8ec75e93c986b5ab4f7214', loading: this.isLoading, type: "submit", form: this.formId, size: "m", variant: "brand" }, "Confirm")))));
    }
};
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8ce095d10f8306cd19ee11902593339a18c2459f' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
        "active": [{
                "onActiveChange": 0
