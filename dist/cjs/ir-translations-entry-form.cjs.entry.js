...
const IrTranslationsEntryForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'b7ce7ce74c3ce70b0d90bd331d2a59593dff37e4', id: this.formId, class: "entry-form__body", onSubmit: this.handleSubmit, novalidate: true }, index.h("ir-input", { key: '52679b3e03495dde20da65b41d002ba35670f711', label: "Key", readonly: this.isEditing, autocomplete: "off", mask: {
                mask: '{Lcz_}TEXT',
                eager: true,
                blocks: {
                    TEXT: {
            ...
            }, spellcheck: false, class: "entry-form__key-input", value: this.key, placeholder: "e.g. Lcz_BookingConfirmed", "onText-change": e => this.handleKeyChange(e.detail), ref: el => (this.keyInputRef = el) }, index.h("wa-copy-button", { key: 'a2ed221b2f258ad8613638d6d79225371edb6919', value: this.key ?? '', slot: "end" })), this.isDuplicateKey && (index.h("p", { key: '88e75f3bc30b572e47e19adebfad31bf12f755e1', class: "entry-form__error", role: "alert" }, "This key already exists in this table.")), index.h("div", { key: '815c1bce9540f0df17f6c570cd1309816a501ade', class: "entry-form__section" }, index.h("div", { key: 'b10303fdae3407b002b643be42967c5e9a48565a', class: "entry-form__section-header" }, index.h("h3", { key: '1e33d312dad77f6279689aa18428bfaa14481b87', class: "entry-form__section-title" }, "Translations"), index.h("span", { key: '26179478710cc1c8c9685809c7cf9e3d8940cb38', class: "entry-form__section-meta" }, translated, " of ", total, " filled")), this.targetLanguages.length > 0 && (index.h("div", { key: 'c7bf716f6900a9265ee850d79e79cf42193187bc', class: "entry-form__ai-actions" }, index.h("ir-custom-button", { key: 'f964fd153d3a309911ad00ca94e15ff8c287ad7c', size: "s", appearance: "outlined", variant: "neutral", disabled: !this.canCopyPrompt, onClickHandler: this.handleCopyPrompt }, index.h("wa-icon", { key: '0212b50fdb5f827dd1d5ff9094f193b883edec15', name: "copy", slot: "start", "aria-hidden": "true" }), "Copy AI prompt"), index.h("ir-custom-button", { key: '6f8a4877a7d1524e54531f856638d0aef656e628', size: "s", appearance: "outlined", variant: "neutral", disabled: !this.canPasteTranslations, onClickHandler: this.handlePasteTranslations }, index.h("wa-icon", { key: '1a04936045a47e8a1ed34d1fb5bf12fccbd9a633', name: "clipboard", slot: "start", "aria-hidden": "true" }), "Paste AI translations"))), total === 0 ? (index.h("ir-empty-state", { message: "No languages configured yet. Add one from Manage languages first." })) : (index.h("div", { class: "entry-form__fields" }, this.languages.map(language => (index.h("div", { class: "entry-form__field", key: language.code, dir: language.code === 'ar' ? 'rtl' : 'ltr' }, index.h("wa-textarea", { class: "entry-form__value-input", id: language.code, size: "s", rows: 2, resize: "auto", value: this.values[language.code] ?? '', placeholder: "Enter translation\u2026", oninput: (e) => (this.values = { ...this.values, [language.code]: e.target.value }) }, index.h("span", { slot: "label", class: "entry-form__field-label" }, language.name, index.h("span", { class: "entry-form__field-code" }, language.code.toUpperCase()), language.isSource && index.h("span", { class: "entry-form__field-source" }, "Source"))), index.h("wa-copy-button", { class: "entry-form__value-copy", value: this.values[language.code] ?? '' })))))))));
    }
};
