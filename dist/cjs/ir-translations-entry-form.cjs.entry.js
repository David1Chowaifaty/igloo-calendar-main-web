...
const IrTranslationsEntryForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '50bda771bcbe1383d7b21e1d52b4810a6a867fb5', id: this.formId, class: "entry-form__body", onSubmit: this.handleSubmit, novalidate: true }, index.h("ir-input", { key: '82d34da23a0ad4beadaef41f018bcf3d29918caa', label: "Key", readonly: this.isEditing, autocomplete: "off", mask: {
                mask: '{Lcz_}TEXT',
                eager: true,
                blocks: {
                    TEXT: {
            ...
            }, spellcheck: false, class: "entry-form__key-input", value: this.key, placeholder: "e.g. Lcz_BookingConfirmed", "onText-change": e => this.handleKeyChange(e.detail), ref: el => (this.keyInputRef = el) }, index.h("wa-copy-button", { key: '264cb8f4bae7ac169c7ff146156f61043b3daeb5', value: this.key ?? '', slot: "end" })), this.isDuplicateKey && (index.h("p", { key: 'ee95f708b2912e8c2774ddbf4a7a6b8882869df4', class: "entry-form__error", role: "alert" }, "This key already exists in this table.")), index.h("div", { key: '94e5b7e0d82405724265837b985697d10a474f83', class: "entry-form__section" }, index.h("div", { key: '8842771167952f53b170842397c2dceb5d46cab0', class: "entry-form__section-header" }, index.h("h3", { key: 'd5c45b7262b31ac4ef8500d23b2163f8879832db', class: "entry-form__section-title" }, "Translations"), index.h("span", { key: '78c04c1c9dcd4994b3508d56de210db166aa94a8', class: "entry-form__section-meta" }, translated, " of ", total, " filled")), this.targetLanguages.length > 0 && (index.h("div", { key: 'd3aa2f882aeb381319fb1f27861660cb9e740cb8', class: "entry-form__ai-actions" }, index.h("ir-custom-button", { key: 'ab8b9d25110e95819d73ab164f2c526c88f45e4c', size: "s", appearance: "outlined", variant: "neutral", disabled: !this.canCopyPrompt, onClickHandler: this.handleCopyPrompt }, index.h("wa-icon", { key: 'a1ec7beed239e9beb0906e1f17a40063ef065d6f', name: "copy", slot: "start", "aria-hidden": "true" }), "Copy AI prompt"), index.h("ir-custom-button", { key: '06b46db0ed92aef3763c81e8abab50984d504eed', size: "s", appearance: "outlined", variant: "neutral", disabled: !this.canPasteTranslations, onClickHandler: this.handlePasteTranslations }, index.h("wa-icon", { key: '4764e8e5bd7b20f1dc1b2378b25f677271ab5354', name: "clipboard", slot: "start", "aria-hidden": "true" }), "Paste AI translations"))), total === 0 ? (index.h("ir-empty-state", { message: "No languages configured yet. Add one from Manage languages first." })) : (index.h("div", { class: "entry-form__fields" }, this.languages.map(language => (index.h("div", { class: "entry-form__field", key: language.code, dir: language.code === 'ar' ? 'rtl' : 'ltr' }, index.h("wa-textarea", { class: "entry-form__value-input", id: language.code, size: "s", rows: 2, resize: "auto", value: this.values[language.code] ?? '', placeholder: "Enter translation\u2026", oninput: (e) => (this.values = { ...this.values, [language.code]: e.target.value }) }, index.h("span", { slot: "label", class: "entry-form__field-label" }, language.name, index.h("span", { class: "entry-form__field-code" }, language.code.toUpperCase()), language.isSource && index.h("span", { class: "entry-form__field-source" }, "Source"))), index.h("wa-copy-button", { class: "entry-form__value-copy", value: this.values[language.code] ?? '' })))))))));
    }
};
