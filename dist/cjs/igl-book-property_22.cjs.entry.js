...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2deddc832fa71c717566b085f724012e06e7421e' }, index.h("div", { key: '861493b087923051a0d017e36912b9d4cca37be1', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '780a3d1ce6a8270254558ba58a026653af6f0ce3', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'be2c494c2a858cbaddf1c28d6f8a44e67768c8a6', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '92ca5c9904eade79cd9ec7c881d6e5ac8a3567cf', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '1e0f4dabbe1c0e64d106c24dcf8799a4b6232395', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'fcb300ebf57a61faf86e43ed387f7361d7e85db4', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '8ab19180e2a3aa785bb931f78a79d8754daa9bc5', name: "modal-title" })), index.h("div", { key: '0ecba269d9e4ae08023b9d0657404601646f5be3', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '013b42b7d2bf87921739c3e2aae3339001230cd1', name: "modal-body" })), index.h("div", { key: 'a88fcb27cead96f5dd44fbe5f3caa30d514d73ba', class: "modal-footer" }, index.h("slot", { key: 'eae377c2edd28db5feba4ae415ceaf90438dafbe', name: "modal-footer" }))))));
    }
