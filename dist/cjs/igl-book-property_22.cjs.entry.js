...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6ba1c87cf296c4eb72bed0ecdfd103dc53bf62eb' }, index.h("div", { key: '13c05a59fb260e75558b488e197fe79741b68793', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'd86b5cf0cc9d67f0965d9fcd2667496246640dc1', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '0fe41ddefaffe1e6f159faabded4a89a94d04298', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '024257aaaebc172c735074cc49304bf90273e252', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'efffd203f223506a6446b0bd56b6cba590c6945d', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '1e707b727043d772a8cc5e465eaa407f067848be', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '4b693f583ed7147341bf0be4cffced04865a0313', name: "modal-title" })), index.h("div", { key: '91962bc2445322424ed3138f4279c1415177dc76', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '77b5fab536c582241a0b399740d325690ce3e89e', name: "modal-body" })), index.h("div", { key: '9c626a5035265f9de781a1af5279f38a2888a6d2', class: "modal-footer" }, index.h("slot", { key: '554b160a6c1b97e230ebe636f5efeccaded4fd2f', name: "modal-footer" }))))));
    }
