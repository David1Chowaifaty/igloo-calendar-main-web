...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1a2748c589b1226385884aa2e74324e77be4d8da' }, index.h("div", { key: '5fedf0b57d46c44cf27af40e7d0041a2f69257d8', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '49bf50092c672b8a9abab784fba452f47f2356e2', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '55acd9e2223385437e69cdf4c7f8dd92243f866c', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'f742ea4bd79087065ef2f01ebfaa6accbbf3b361', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'b92275bf9d56a8975c7b37bdb04e3021a7734e2d', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '37f2b9f07f741b753e268746f2969a9cb50c67eb', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '42752e9c0e411a588270e72470cc32e3015d3051', name: "modal-title" })), index.h("div", { key: '747f08dbddfddb27263332494b93d948e9b0227b', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '36a7a3e5e593ebd5557cbc18bf122dd4b2a08059', name: "modal-body" })), index.h("div", { key: '38ad767acecc3762c37b36a671f5858bfbcee881', class: "modal-footer" }, index.h("slot", { key: 'c01028d91d4ece7ee4f8de15166d6bb66e77c873', name: "modal-footer" }))))));
    }
