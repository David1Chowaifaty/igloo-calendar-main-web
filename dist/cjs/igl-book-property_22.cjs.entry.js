...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'db5820f61a3f722234541d2391466bc681b83a15' }, index.h("div", { key: 'a02c14fbee34e6b29dab65ca04034ed8d23809a1', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '41483d0192bb8c24c4b57309faf50e8c05eab017', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '9f6c8fe52d3b277ebe7e23b0f43f5b93bb6f4112', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'd63c30847d762f3ae06ad57b9886ace77e7c7b94', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'dbbb855b71e737aa71856cbd1ab1ca3b2993a175', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'f7532871436d1b6c302442c1855d7345f3e4c7ae', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '35a84e1a1cb244ec0c255ef2b207fa12d0deee88', name: "modal-title" })), index.h("div", { key: '7c9c8165fb31488b179208bb3a976cd6e2e75eeb', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '78f78ec1d18683558715b426f74dbb9cf4bac43c', name: "modal-body" })), index.h("div", { key: '2a9588472e43ff9b8e1a919ead8e6fc2ae8ae56d', class: "modal-footer" }, index.h("slot", { key: '761b02b1602e83392f272ddf04233228ab7386ce', name: "modal-footer" }))))));
    }
