...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd12555a1022809ea12d49f63ccd052b0c039ff03' }, index.h("div", { key: '3bfc23a77c1fa57fbedbf7f50b247b7c19d3ac76', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'd9fe848e3fcff021845d390b9f0026b1ea1af3ee', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '1a66d86d7272279542b32db7ecf740d05570ef76', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '550d7c8ec4f5542844f619d0339afed9a26a20af', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'e11ff810d47005b9488794da319c01566881f5ed', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '62ed190c65792740958e46d2cf960f69e2b645b8', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '129c817f781c1b79851cb541e0cea70bbc92b932', name: "modal-title" })), index.h("div", { key: 'b2af2928f570bf67a5e2713fdedbe43462c5f00b', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '8ba7796388c7b7407b81f0bb009c2d530fa34023', name: "modal-body" })), index.h("div", { key: '46349c3903190cbf119fad0ce8c6465cee1aeefc', class: "modal-footer" }, index.h("slot", { key: 'b9b44d12deaf4141a448e5c22d4917b5eac71cdc', name: "modal-footer" }))))));
    }
