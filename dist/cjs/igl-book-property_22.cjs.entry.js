...
const IglBookProperty = class {
    ...
    async componentWillLoad() {
        console.log('<==>roomtypes<==>', booking_store.booking_store === null || booking_store.booking_store === void 0 ? void 0 : booking_store.booking_store.roomTypes);
    ...
    async checkBookingAvailability() {
        booking_store.resetBookingStore();
...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: 'c25ad3074bdab1d651b309c85a100d6b9e35d767', class: "d-flex flex-column h-100" }, index.h("div", { key: 'c8fd2327e00aba7911c8d59ccf623cbf1b7ff6b4', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: '4a26dfd2c1c2be7ee12e70fff433978c3dc0211d', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: 'b53ab8b27ae01822b2d5f17d8a1fb7bc83296207', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '87baa0fe1c18d920426bf797231923e66a284ba2', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglBookingOverviewPage = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'fd5abe6f4d338e78a4f00e0d343c9af951e2aba2' }, index.h("igl-book-property-header", { key: 'd25ea2db4bf0a4c5519780ec68a40da52d51edcb', bookedByInfoData: this.bookedByInfoData, defaultDaterange: this.defaultDaterange, dateRangeData: this.dateRangeData, minDate: this.setMinDate(),
            // minDate={this.isEventType('ADD_ROOM') || this.isEventType('SPLIT_BOOKING') ? this.bookedByInfoData.from_date || this.bookingData.FROM_DATE : undefined}
            adultChildCount: this.adultChildCount, splitBookingId: this.showSplitBookingOption, bookingData: this.bookingData, sourceOptions: this.sourceOptions, message: this.message, bookingDataDefaultDateRange: this.bookingData.defaultDateRange, showSplitBookingOption: this.showSplitBookingOption, adultChildConstraints: this.adultChildConstraints, splitBookings: this.getSplitBookings(), propertyId: this.propertyId }), index.h("div", { key: '3dde5a2cd52daab91956cdc1edbceb771f75d600', class: " text-left" }, irInterceptor_store.isRequestPending('/Check_Availability') && this.isEventType('EDIT_BOOKING') ? (index.h("div", { class: "loading-container" }, index.h("div", { class: "loader" }))) : (index.h(index.Fragment, null, (_a = booking_store.booking_store.roomTypes) === null || _a === void 0 ? void 0 : _a.map(roomType => (index.h("igl-room-type", { initialRoomIds: this.initialRoomIds, isBookDisabled: Object.keys(this.bookedByInfoData).length <= 1, key: `room-type-${roomType.id}`, currency: this.currency, ratePricingMode: this.ratePricingMode, dateDifference: this.dateRangeData.dateDifference, bookingType: this.bookingData.event_type, roomType: roomType, class: "mt-2 mb-1 p-0", "data-testid": `room_type_${roomType.id}`, id: roomType.id.toString(), roomInfoId: this.selectedRooms.has(`c_${roomType.id}`) ? roomType.id : null, onDataUpdateEvent: evt => this.roomsDataUpdate.emit(evt.detail) }))))))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (index.h("div", { key: 'db46dcde47aa7727886df916328cca743025606a', class: "fluid-container px-1" }, index.h("div", { key: '69ced504ca75bdc534c1c4c802f8a8a592de3f1e', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '1b5705f2cd6c26f5f24107ae269ecf3aa5ff42a3', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'ee5fcb7e53316265c7a281ca017b80effbc1213b', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: 'e0a8483158079aeb74b74de493842010fd7480eb', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'fe10d4bc857f8c9cfecbdaa52e599e4cb6631cd3', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '9ab3c934298756d0a6910a6e7150110514e464e4', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: 'd2744883b05e30bad0baf26c3c37e05cb3c9e5ff', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '709190d5f07fe3cb90edf76723f0fd6d891c90b7', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: '3fcd9c8a03a192fff374ddebfac9ea45263b297d', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '0c35ac80db99a7caa44d47a9b290e7c564c67cd4', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '0008ebbcac67ae4b9e38cc666d0de052f6e94a81', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: 'bf2d6898bffe832a6ece08862beeae3d53bd71b2', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '85ff73d082cac57ab07abed738730117a7e151d0', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '1875b055e5bc2d2eefa79a8e2a16c6dbd5656209', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '7861d17211ddc169cf309cf1e44ae0fb15a7be7c', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '59be5de496dcbecc7a3031c4e5db8460c87461e8', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '0d91da76de7194db152ee825e5f8d66bb74802f3', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: 'cc01a855f1d372d291ac98beb20d27f5b8d542c8', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: 'e5f7a273cab86b414740fedbe97e907772e5b59c', onOpenChange: e => {
                if (!e.detail) {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a1bd36d9737706fc56598c7cbc2cadf81e81542e' }, index.h("div", { key: '907709af1b3a6b0a3fd897a7383b86749578ebf0', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '04e305f215594df8ff2c3dca2058a2a13c9a3877', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'b68590d6a26dad49746ea5076f22fb5e9717eee8', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'cd210384e2c1d8ded76f49faa58f31106b816053', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '171adce9915a76cbc803c134328ae918d146ed68', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '4b39a4385c28a999db3eafef96ede2625de56cae', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'b1becc21cdb6862abbfe6643dca17636eda55ba3', name: "modal-title" })), index.h("div", { key: 'e2db3263c63c89f802adbc9d130079623d04f989', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '45e70a70dfadebf5e5bfa6e1cdb5825c55914363', name: "modal-body" })), index.h("div", { key: '0787de3fc3b50329c6502fa39b49af9d7b9be8d6', class: "modal-footer" }, index.h("slot", { key: 'fb5ffe6d402a3f6adc6d9bda9238e26e72dd4a41', name: "modal-footer" }))))));
    }
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '4029f28cccdc13dad21cce94f79162d3dd22f535', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '3a0a63d0dc842620f07c5b87d78914722c7f30d9', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: 'fe8bdc7c6db273e63af5d2f9ddfa414bc2434b56', class: 'px-1 sheet-body' }, index.h("fieldset", { key: 'd41cd58aec267b3e97c359716e6697b88f4cf649', class: "input-group mb-1 service-description" }, index.h("div", { key: '44c11af16a567d06789c48b5428e0558ce91eb91', class: "input-group-prepend" }, index.h("span", { key: '27dde100ae0484dbe9ee50780f22b70500b93b41', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '08893e6c20c23e4126f90cb9fb1244b7893908b2', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: 'e60cc043c504acb21b5e1555ec4db86a48d28d5f', class: 'row-group mb-1' }, index.h("div", { key: '140fd40ff9ea0cf85bea2fcd8e60fcbec54c545f', class: "input-group" }, index.h("div", { key: 'cc63757ffea2940d9b07f4011e97e226a6384c30', class: "input-group-prepend" }, index.h("span", { key: '5cea6a15b39d643e8bf1211185bd9d1ccfc7eb6b', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: 'd7003f61530d52b00dd499ccc8a9bd7cb601aaaa',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: 'c6b3b9412c9e0cefc067f93af7f9a4a9562a2bbd', class: "service-date-container" }, index.h("ir-date-picker", { key: '48a03cc6d170cf036661f120100276ce466540f7',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: 'af96afbf1d03c7cf3fbeb7a6275be313d0353437',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: '6bf0bf888598b014c2f39cbc3d53afe1fa900710', class: "btn-container" }, index.h("ir-button", { key: '6c069619d3c065601b726178bdcd9faf544fe9aa', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: 'df9665858c9b5f2cf98ebe9ebf0b6d734599099d', class: "input-group" }, index.h("div", { key: '5f233cda437aa6c271b6bb2df6d5d84458362dc5', class: "input-group-prepend " }, index.h("span", { key: '5355ce7c54223ec3fcfd8b39b43791ae044b2866', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'cca398cbb650c3b9c37084729cac7b0b510010ff',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: 'f55bcd5b831348b8a60f33c9d0343709efed63eb', class: "service-date-container" }, index.h("ir-date-picker", { key: '6c44529b64111542acbf3c061521f47561be8ba0',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: '202b837f0233a3983ae6266142414c1e16aaad12',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '5ba06f36318651e8c0cf75990787523cfd79f029', class: "btn-container" }, index.h("ir-button", { key: 'fed97379bfad9021a00122a6f31c86fb5b5f9edd', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '5cd0c12124c420486e1e30cf224b36c67d23a8f4', class: 'row-group' }, index.h("ir-price-input", { key: '0647702093e105548bfe0537c58991d99540c4a3', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '6288c8c5bb2bc11061ff5516b57a2850940d4c0e', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: '387039cd43c24bca148a2eae52abe95ed5231894', class: 'sheet-footer' }, index.h("ir-button", { key: '37621ac0ea579ef9a4819232b9e535d1f320b620', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'd1bbf519f426ebdb36c15d4d4a68d6080473e265', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', icon: "", btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: 'db5f7d18668a9067f400c4f70d72ecb83961458c', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '4f7513932b422a6b958a5bc3df8ce1431a3446db', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '1f2214ab260304801e71d837ae441109fe1da873', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '6ca1ccd5d58dee0eff0978dfb7b45f00f9a439b3', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: 'ac698dade539e362512b80d0205a21457232d9a1', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '05ce6e3d06d364218dd870100d1f6b130d4a7ac9', class: 'd-flex' }, index.h("div", { key: '198febaf65b11383416c72c597dafcf30416c3b9', class: "form-group  mr-1" }, index.h("div", { key: '4e1025dcfc39d32bb0a7c9ff527d41c17c71312d', class: "input-group row m-0" }, index.h("div", { key: 'd684bd3b8e74925606fb88bc0999d528a58624c7', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '27556f876266e9acda80de5605ed1bd87fe13c0f', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '33b8df9fc9deed3513b89f995838df0f4c59e607', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '8b8eb85c7faed548d833ae9027e8e1ffd538ce0f', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '252ccc3929a1ae6f612cdff8ad0212200453fa40', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '75734a3ef60f50433e4513a38534d0721d1a96da', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: 'ad383391207d5af816a8a0a305b2b3891c8aee05', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '181db496329f9892edab3ca16f0c883dceb86a3f', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'bf459c8fc1efe7870b500548324fecd374e0f334', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '7561946421c0059d0428a5101373ab3d598f3b7d', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '15505447d5d698d034465b04d674f926f4dcb97d', class: "price-input-container" }, index.h("ir-price-input", { key: '64f4f5350986d00c359e489a692938d6bf410cce', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '3afc6075c6ff974d79c386ee4579fe3c92ec846e', class: 'sheet-footer' }, index.h("ir-button", { key: 'fd8cc6bdb69460b6eb5865a7eda1ed6e8d65b36c', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '26b8e0af2d29c5900b4aef736a4889a6cc91a74b', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'cdb44bc467c314e85eea3c76fbdaae251b0f1914', class: "card" }, index.h("div", { key: 'af20b0265daed84221e9f4ee0149555178b4f3ae', class: "p-1" }, index.h("p", { key: 'eea82926fad9b14f65aed38a02454ac3370b6afb' }, this.booking.property.name || ''), index.h("ir-label", { key: 'ca65c9fc68159e0c5e4263381bcc96de3ac775ce', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '5cfdf7ea31fc7e280683fd396827163eac0e35e0', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '80b557fe48c5e50be1bc8a553f40bc5ff0796749', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '0dfe2ac57db8d8b5f877264361b209822341897f', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'c614f19407371f25a0291a02faaee5b09a9ee6b1', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'dc10e1f8423638d5efbf8bea8ce6381f54f62488', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '8681d84c13bac6454cec16a304b348a8618c192c', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '325b06c61c763e7fc9e30f64d7d7e09fbb36fb1b', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '46b5dd9f69abf179a06435bc9e2e51854d34e1ea', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'f6617e857e04b22ab1d158a0e6c3d243123a2a39', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'aee0d158933cda6f4d2181e55b39d644595a54d6', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '102c043b7cac5f5d1a63e55e474c56ccfe1b781d', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '703925c58fc62a936f901a0d5bfa5710ad45110e', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '462d43930cf456d1a3a2e8a1ca8fb3a0029a71af', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'db184a83df20e7405db8e8f93055ed42cf0e1de8', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: 'bdbd1af959521536a159481375c9dacfa6d8258f', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'f14ad3ddfcd8a1e94c15d861e951d09cb593f327', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '453b32e3883c300c5cd9dfe143f94fb229d7979c', class: "d-flex align-items-center" }, index.h("svg", { key: '6466fa562b53d75668a865c2156e8ac6727a74e4', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '4b4af8c022ce05cf4687ad70c5e877b4df6c6a73', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '82e98914e214cd9d9a09fd9d7fbb56821faab3a1', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '4cdce481da6af06773ce49c7429109be301af29f', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: 'c3decd2b3dfe2f12d46f3edf6168d070996b41d6', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: 'ae47ba1e102778e24a07c264bf8be22f2dfa59b0', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a6756c0e7ed4664405136ff8f08ed6552685f691', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '044feaa557d707d4713ea05c9769aa6de38f2b72', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '07af337b85460f73ac5f040f8c7b607718e4727f', class: "flex-fill m-0 " }, index.h("div", { key: '4eeb66d9c32fd440e15388491c7ab4ca67d515b2', class: "d-flex align-items-start justify-content-between sm-mb-1 flex-fill", style: { gap: '0.5rem' } }, index.h("p", { key: '3a40e6f43a5d5804ceaf64c3697d0abd631aa469', class: "m-0 p-0  room-name" }, index.h("span", { key: 'c4630d4fe724d87f5e8906a8cd5647d061907144', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', index.h("span", { key: '94534c557c1b5ccbdac1e642cdee114391dd4d68' }, this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' ')), index.h("div", { key: '4caf0e12633fd70550b9bec974134356bff86ba3', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '1424fecdff6a54f143337ff9b8cf46e33e5af37a', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'c1c518dace8fdf8a065264fde2f57fc59e126af1', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '48e7c4284dde830b32a69a97d7ae00a62246b924', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'bbce6f2644eaef31906e1f60517fd84762476571', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '6e01136980960a8d3b09c1595cabc272c5d13a9f', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '07b33829309cd34e787f494eb7c7cb86e3caf752', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: 'ea45d0ddae12766ccf30599bcf5816b052357054', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'e8677133caa9afc672c79be74457cf6143238fb2', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: 'a4e876ae9cfe8c48544ace64631d7367692e8f5f', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '288bc4ab5f37a7c5e2a898229a8ca41c4f709326', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '7e80ea067f229120ea7552fb0754ed5398a94246', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '98ead559f041492da5ddf0f237b96de5d5cdc5e6', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), bed && index.h("p", { key: '50217cf7854e779818231ed28327aa7fb392d201', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: 'f9b1b2eef824bd536ec6d3be952283daf397e362', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: 'd78fccd10318a371b85795732e892848ec8c413a', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '92fc10abb8489b4c5f61dfbd557cb82ecd772db4', class: " sm-padding-top" }, index.h("p", { key: '39f55f609ff8a11b77fcbe45edebf6df0deb25ab', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '7248a37c89e3ce67397f404e3426abb9549f4a58', class: 'flex-fill' }, index.h("table", { key: '6cc2b46728931cce82415aaaab545e77bdc1e6d8' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'c3948a2c1d44875fb327cfa277e51ccb4e170de0', class: '' }, index.h("th", { key: '034ff51e381289bed41adc3fec37d98d8b346354', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '4ac767263902a8d0704d692074b9e853b4fa8794', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'a2df9fafa4256c9e243a5789c6997823cbf9eee1', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: 'bbdd7748e36d45ad8384c1d5f646b298a305affb', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'e675cb4559522234bbce5397225d975ee199eee4' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '8d31e8b4ed588b0858b060e051f5a2a89080f167', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '9258529cf94c4550943abc2bdd433fdc6823e71b', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '5836e86e6c229579d2ec8c587738d7d862027bfc' }, index.h("ir-label", { key: '8ea4d19f97a61d9efbcd161825bd79c8b283b80f', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'd1f3231899c1422193f06bfb0c003f53cac553b2', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '57ec12c04564943451f0115ae69a4194398ee07b', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
//# sourceMappingURL=igl-book-property_22.cjs.entry.js.map