...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '30e177c6b559710f6dac272d3fec840775f7fa3c' }, index.h("div", { key: '0e480600666d49795a4a707bd6f22ed2efadb5a4', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '04b2a2179978588a3293761c060b108b7b8de4df', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '98c70f82501cb5db6df3032ff968514e40686581', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '12af2368b6c5e1b8f6699deeaf97f5c4b226871d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '2f11e723bbc4e7f007ce2cc1b85f366e376d5abb', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'fecda3ca5a3320e87f79184ac029cfde140f6641', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '48451779dd19f8c3907fabb0971a1000f44c6e70', name: "modal-title" })), index.h("div", { key: '78342b4591a20f7fd40569fc66dba53e9e543698', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'b77b18d260064c74522624ff9d9783bceadd253f', name: "modal-body" })), index.h("div", { key: 'b65fb39341cf1dac2a1599f7157eaa933bfda73f', class: "modal-footer" }, index.h("slot", { key: '36f133207c9a0189f74abf69aa9a70e0b2c30715', name: "modal-footer" }))))));
    }
