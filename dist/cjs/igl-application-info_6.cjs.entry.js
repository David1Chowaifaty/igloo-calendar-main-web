...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c438ba75af1c675baf69605eb6137bebeb96093b', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '9180927bd6a4509adc3a65ede482595dd1c2b715', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '35fcf78243e505f5d4d7d05cdc8fabc0b9bbd7e5', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '70430c82d75c0b46fc732fcf03e20414ebd50d72', class: "fd-application-info__details" }, index.h("div", { key: '35214bccaeca24349dec61d2b1651927c4a0cad7', class: "fd-application-info__rateplan" }, index.h("p", { key: '82b10a2c669a85804e62fbd7040f02e37d2e52df', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '3672b22162d5c2c0b0eb36a7a9d3a86fe88d2d4a', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: 'cc822b1c8ec25c40fba45488bf7ccbb5791eab0e', for: this.tooltipId }, index.h("span", { key: '6c0deaa3cdfe83a35d6b17c46d523acaa0655fe1', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '539e0e61174d5364ac5d787fde01d2a00bad0fb0', name: "circle-info", id: this.tooltipId })), index.h("p", { key: '70a34d4855e1947d73e4dea9733147d429bfcb4e', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: '915ff94b7e7703ee0e5f489bce3d50134facfd59', class: "fd-application-info__price" }, index.h("span", { key: 'e7333ed2949bc4932019923d5a1aff7635788e1c', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: '3202c515ff71b441790803654b9e093a01eb684e', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), index.h("div", { key: 'fc152ca26742137dca0c67a21a97a6249610948f', class: "fd-application-info__footer" }, index.h("div", { key: '1c33b7050a1dd5d2359a9fafdb8a90880fc2377f', class: "fd-application-info__rateplan" }, index.h("p", { key: 'c607b69703fb08b8aa143ea33bded76ec76a0ae6', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: '3856e44f5530f76108317512b7ffeef87728b198', for: `mobile-${this.tooltipId}` }, index.h("span", { key: 'a0a8fa159d391b72402f6c79de4b43862e3f66c0', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'b5a7f519b7f83235b405f32c9e38152034c5de43', name: "circle-info", id: `mobile-${this.tooltipId}` })), index.h("p", { key: '4d4d18db71a50f7e5e35d295deb961a03d0f05b0', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: 'eeeac4bb4548d609464b10b1e7fc2b127d5e4e9f', class: "fd-application-info__form" }, index.h("ir-validator", { key: 'bfb415c156431b45214bf4b21f12de213cbeb20c', value: this.guestInfo?.first_name, schema: types.GuestCredentials.shape.first_name }, index.h("ir-input", { key: 'e195705696267cb47711882c10141a1468ec7a90', class: "fd-application-info__input",
            ...
            } })), index.h("ir-validator", { key: 'ab56864050def18152efee6336046d8b241242e7', value: this.guestInfo?.last_name, schema: types.GuestCredentials.shape.last_name }, index.h("ir-input", { key: '26b9af874e7f4d042ca5f222ca130cb49e91b183', class: "fd-application-info__input", type: "text",
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("wa-select", { key: 'f87cbb3abb3385a07348fd18a8df378605a7646c', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_Assignunits, "data-testid": "unit", value: this.guestInfo?.unit, defaultValue: this.guestInfo?.unit, onchange: event => this.updateGuest({
                unit: event.target.value,
            }) }, filteredRoomList.map(room => (index.h("wa-option", { value: room.id.toString(), selected: this.guestInfo?.unit === room.id.toString() }, room.name))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("ir-validator", { key: '395cda52373bf45b8e52cef6bf5cc1613e4989d3', value: this.guestInfo?.bed_preference, schema: index$1.z.string().nonempty() }, index.h("wa-select", { key: 'e602a1968a115a7c6d91c66cb4d0d247801dec85', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_BedConfiguration, "data-testid": "bed_configuration", value: this.guestInfo?.bed_preference, defaultValue: this.guestInfo?.bed_preference,
            ...
            }) }, this.bedPreferenceType.map(data => (index.h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("p", { key: '58921258c59c7db4159da6212c1c4eb26c4498de', class: "fd-application-info__price-inline" }, index.h("span", { key: 'b344a9d9b258b761acaa77edee268771926168b9', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: 'f5ba8d3101d251a393c1e3929b3f3c352f6da3df', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: '91954aaab0f92ed4daaa8740d0986fc36f789ed4', class: "fd-application-info__infant" }, index.h("p", { key: '5b74cde15f24ad706e8fd0c86da80244a991f77d', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), index.h("wa-select", { key: '62638cf6682ee42bd7e5bf1c611e2a41be3a6ac2', size: "small", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales_store.locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => {
                this.updateGuest({
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '6b1a96d1abf228c4da4a0194e9d3f8d720b6f0d3', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: '3cfa30fa10a31b72254441e5ae75db22ce87b3d4', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: '44858bfe49811899d87bd112822f0836b957f9d8', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (index.h("p", null, index.h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable")))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (index.h(index.Fragment, { key: 'c837493ad925a0017277b6ef68a27c04b1742e37' }, index.h("wa-tooltip", { key: 'ebfab08b063c7e4570bf5957813739a09bbb6da5', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: '4860ebc8c498db9e6c721efd9eb4dbb892113711', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '3e748ec8238e7cb65589c1f34960eb962d99e9ac', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (index.h(index.Fragment, { key: '7a354df5661df0b98014a1f24862a072ddd33058' }, index.h("wa-tooltip", { key: 'af2d3f7c1ab91fca194b02f6503414034506adac', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), index.h("wa-icon", { key: 'a7daf8d8b5b6c8155d439f5fa6f70cde0191c914', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '23224445937dc68acd9c05a9349295e181c3db73', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: 'f448371a4d6258d86c2fda8096188dc540bc8c10', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: 'a0588291eff9af0d554e698ad974e0bc733e9320', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '101cdadc827eda6cd9323482ffedbbb6e99de2ef', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '8ec7c36696b734837454c1af68d6c6ddca90cbb9', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: '24071aee6ec217281f5d8300f92c349005971339', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: '8c0b17077be62963f645c086b4a070d67ff99e75', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: '7e7c1e1590b7efbc4c3c3029551972541e509dce', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("ir-input", { key: '74959efebe5ae5380f478cff83e41cd9dc6874d2', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && index.h("span", { key: '0d5b49c15c6f63450d92fbb4277b6030a62e41fa', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (index.h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: 'e7fec026b1a1f922a2be45955ba049f37aba2376' }, index.h("wa-radio-group", { key: 'c7625a8c4f8c993f70e89ca81c125cc36dd7e32a', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: '82852389a818dec2ac96633ccacad164ec3038d8', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: '0b46d3bd3486a1f1c32b02dfb3488eeb1a991568', value: "guest", appearance: "button" }, "Guest"))));
    }
};
...
//# sourceMappingURL=igl-application-info_6.cjs.entry.js.map