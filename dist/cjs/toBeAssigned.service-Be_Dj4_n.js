...
class ToBeAssignedService {
    ...
    async assignUnit(props) {
        try {
            const { data } = await axios.axios.post(`/Assign_Exposed_Room`, Object.assign(Object.assign({}, props), { extras: booking.extras }));
            if (data.ExceptionMsg !== '') {
                throw new Error(data.ExceptionMsg);
            }
            console.log(data);
...
//# sourceMappingURL=toBeAssigned.service-Be_Dj4_n.js.map
