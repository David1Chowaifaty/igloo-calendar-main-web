...
const IrPagination = class {
    ...
    render() {
        ...
        return (index.h("div", { class: {
            ...
            }, role: "navigation", "aria-label": "Pagination Navigation" }, this.showTotalRecords && (index.h("p", { class: "pagination-info", "aria-live": "polite" }, this.renderItemRange())), index.h("div", { class: "buttons-container" }, this.allowPageSizeChange && this.pageSizes && (index.h("wa-select", { value: String(this.pageSize), class: "pagination__current-page-select", onchange: e => this.handlePageSizeChange(+e.target.value), "aria-label": `Current page ${this.currentPage} of ${this.pages}`, disabled: this.disabled, size: "s", defaultValue: String(this.pageSize) }, this.pageSizes.map(size => (index.h("wa-option", { value: size.toString(), key: `page-size-${this.recordLabel}-${size}` }, size))))), this.pages > 1 && (index.h(index.Fragment, null, index.h("ir-custom-button", { onClickHandler: () => this.handlePageChange(this.currentPage - 1, 'previous'), variant: "neutral", appearance: "plain", disabled: isFirstPage || this.disabled, "aria-label": "Go to previous page" }, index.h("wa-icon", { class: "ir-flip-rtl", name: "angle-left", label: "Go to previous page" })), index.h("wa-select", { value: this.currentPage?.toString(), class: "pagination__current-page-select", onchange: e => this.handlePageChange(+e.target.value, 'direct'), "aria-label": `Current page ${this.currentPage} of ${this.pages}`, disabled: this.disabled, size: "s", defaultValue: this.currentPage ? this.currentPage?.toString() : '1' }, Array.from(Array(this.pages), (_, i) => i + 1).map(i => (index.h("wa-option", { value: i.toString(), key: `${this.recordLabel}-${i}` }, i)))), index.h("ir-custom-button", { "aria-label": "Go to next page", onClickHandler: () => this.handlePageChange(this.currentPage + 1, 'next'), disabled: isLastPage || this.disabled, variant: "neutral", appearance: "plain" }, index.h("wa-icon", { class: "ir-flip-rtl", name: "angle-right", label: "Go to next page" })))))));
    }
