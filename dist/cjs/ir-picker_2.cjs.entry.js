...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'd96483d89798eba8d2848afc413574e2cf4ed1ee', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '448ce2110f44585b15c335ba5494ac510951c9ea', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '53d1d2239987126a89076c0c757b4e0bc2a4ea5f', class: "picker-item__check", name: "check" }), index.h("div", { key: '5ec2eebbee6f0259015b513b5f448e0fb7229f98', class: "picker-item__content", part: "content" }, index.h("slot", { key: '96dbf90d1e29deff5e22fe1c7b6e9ebce625ab5a' })))));
    }
};
