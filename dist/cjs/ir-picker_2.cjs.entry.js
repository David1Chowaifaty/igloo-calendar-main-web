...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '1c673bff4a9d26a561811795cd1a9c22ebb24008', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'ac4857d19b4d3fa522097d38b04eccb14b1acd3c', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '9ead9d3b43921ce7e154f07e7875b0b75f97822e', class: "picker-item__check", name: "check" }), index.h("div", { key: 'df97399e5eecf46edef6328e9afa30dabb144e95', class: "picker-item__content", part: "content" }, index.h("slot", { key: '912b62082a435a9318bdee84801afbec7a423f0e' })))));
    }
};
