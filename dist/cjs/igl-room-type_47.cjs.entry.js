...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: 'f053d3702ba94b5fb3feff60254a8fa5f65dc39e', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '32554e141e596fa94d93be5c7273828cb5395b16', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: '475821ca4f36941b780fa033125b2435487106f4', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '939eeeb0c57daa1c22c2320522c327015b15b0e5', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '62417d27daf1266d16761392bfd45e5b1864b206', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '128365fce6e90f1e5104ad034bb1d577bde169e3', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c42569278e205fc69deb3e43d71db1b8a90d6844' }, index.h("ir-drawer", { key: '3fdfee4b7e8b3eb3ed57c7aacf2f51f354ffea39', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '4979de1672c4abcfd466506abd1f091db1193683', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: '5f7c16a558d0de89bf3d41f9a96a92e9f124d0cc', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro forma")), this.open && (index.h("ir-invoice-form", { key: 'aff574713b36be9f2937f44bab4330e506c88b39', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'a78abe4a8d4064eb9c2f138d3ab4c2986b54bf5e', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '3b9acefa95c7e4f973f73c9e6bb750178ee23961', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '783c56b464ba5a7d3fd7f386cad3ad8f90ce9dee', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '09b8299a073f09d1f2f91d419ae5a94b87a4f400', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: '8626ad5888d68c28f80196f4531b8cce64f7c10e', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '865ce5eafe8525e7159b47048d426e883e23308c', class: " payments-container" }, index.h("div", { key: 'ae25eeccc4166a94bdfa7efdc0bcb6de684b628a', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'a5eb2a36b23329bedb7efdf7b82e3de27170f5ad', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '18ca432460bf5b743ca44fab9f827d4a87a4dda5', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), !this.isAddPaymentDisabled && index.h("wa-tooltip", { key: '0411cc193093efe7f790988d460dd977c37ec825', for: "create-payment" }, "Add folio entry"), index.h("ir-custom-button", { key: 'fecad944e6f97026efa8ec90e1fd6a52358c567d', disabled: this.isAddPaymentDisabled, slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '35ac5713862d41693fd45d9c1731e2e2a99fc191', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
`;
    ...
    render() {
        ...
        index.h("ir-unit-tag", { key: '7942f1e39d31e1d9a7313ab9fb27f83bc33e6bae', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '6bc9d7d84be30636d0abc0d916111c5be3046793', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '58f0b73a4a855fe46468925fa7d2557e50fe005e', appearance: "outlined", variant: "brand", onClickHandler: () => {
            ...
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: 'ea262a93a5d1bd14ffd6bba47f60fca7a5b75473', class: "booking-room__details-container" }, index.h("div", { key: 'eb40024129e16abe4ba91847ae8521fdd00ed939', class: "booking-room__breakdown-row" }, index.h("div", { key: '6b8811288bbecea9138417571b71d06e5335fa5e', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: '51814f6e13855d3144221f4afaa7850ba63bd7a2', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '671cfb47180a9afe68af9758fdc2dac88dc7d80f', class: "booking-room__breakdown-table" }, index.h("table", { key: '38c83ffd9a4f1530749e76a5dd145c78ad52be80' }, this.room.days.length > 0 &&
            (() => {
            ...
            })(), index.h("tr", { key: '016c0a0be92a370bc24e8bed87576c5261d214cd', class: '' }, index.h("th", { key: 'ae00ddc165dd38514953968bcdcf748d7ba089b9', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'a08b761f4eb5b59358fa50710b82745ded09524d', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '082f8f9dac9a6c8986f6740c59bbad4ecf945534', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '35165714eb4fc8ccc470fbc22c83b9220601ad5e', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '0f1e6ddab715f44b05a322d83cafc7ac1202e3f3' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'd49e78c2b51a8ebfecba6c6c65ac05d2dc94673f', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'bf92d78c8eb3a289394274e34ffdd80f80536e69', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '33ae8d0f3834408388166e6fb7ce62d0df72006b' }, index.h("ir-label", { key: 'a133135139f9aab1147da2ecb15f3c8f09b4042d', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '8affd7d4f50824001ff4b888742d82998e3146f3', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-assignment-toggle-dialog", { key: '4207240467c3879e708d0f86b357fc240a18bcab', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, index.h("span", { key: 'a894067f0b656aa899b43e87865283649e4b1e18', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', index.h("b", { key: '2e8942099ee0faa0824d2db6b9e274a22b89769a' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), index.h("ir-dialog", { key: '4d4529a0e8a9af9fd6eb4132e51c6002b38ce9e6', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '6f53f52477d0b9ae6e970b994d8202c9c8bc5474' }, this.renderModalMessage()), index.h("div", { key: '09988279f395d6c69e04ddc103a20b08d831a5c8', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'af462b66fb5f6db1e919047c8ec937a38dcaf52d', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'b017412419b9aee69df9f883998cd6fd791d82e9', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '87ed521221738ea4bb53d957164de7f518013056', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '989f188b6a7d19f865198b01201d3110c594be30', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
