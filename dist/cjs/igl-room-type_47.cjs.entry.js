...
const booking_service = require('./booking.service-020673c4.js');
...
const utils$1 = require('./utils-66cedfc1.js');
...
const IrBookingCityLedger = class {
    ...
    renderRows() {
        ...
        return (index.h("div", { class: "folio-list" }, this.rows.map(row => (index.h("div", { key: row._rowId, class: "folio-row" }, index.h("div", { class: "folio-row__header" }, index.h("div", { class: "folio-row__meta" }, index.h("wa-tag", { size: "small", variant: row.status.variant }, row.status.label, row.status.id === 'billed' && index.h("wa-icon", { name: "lock" })), index.h("span", { class: "folio-row__date" }, moment.hooks(row.serviceDate).format('MMM DD, YYYY'))), index.h("div", { class: "folio-row__right" }, index.h("span", { class: "folio-row__amount" }, row.debit !== null && index.h("span", { class: "is-debit" }, row.debit ? this.formatAmount(row.debit) : ''), row.credit !== null && index.h("span", { class: "is-credit" }, row.credit ? this.formatAmount(row.credit) : '')), row.status.id !== 'billed' && row._raw.CATEGORY === null && utils$1.actionableClTypes.has(row._raw.CL_TX_TYPE_CODE) && (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: 'a36e6fc54aacc81d556ff1158d4d68a3c058c701', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCheckoutDialog = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, { key: '4ee908144dcf392db806e80177d47f2b56629cbe' }, index.h("ir-dialog", { key: '8bab33db98dd0801fdf9972ffa7a2f8dd5f0f6bd', open: this.open, label: isEarly ? 'Early Check-Out' : 'Check-Out', style: { '--ir-dialog-width': isEarly ? 'min(36rem, calc(100vw - 2rem))' : 'fit-content' }, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.buttons.clear();
                this.checkoutDialogClosed.emit({ reason: 'cancel' });
            } }, this.isLoading === 'page' ? (index.h("div", { class: "dialog__loader-container" }, index.h("ir-spinner", null))) : (index.h(index.Fragment, null, this.renderDueAmountWarning(), this.renderMissingClWarning(), this.isEarlyCheckout ? (this.renderEarlyCheckoutContent()) : (index.h("p", { style: { width: 'calc(31rem - var(--spacing))' } }, "Are you sure you want to check out unit ", this.room?.unit?.name, "?")))), index.h("div", { key: 'bd9a34e86aeeb973f3ff1740ebad20656eedb0b5', slot: "footer", class: "ir-dialog__footer" }, index.h(index.Fragment, { key: 'a575c784eecf7f1d1eeb4d9ab05acdf4caee1fff' }, index.h("ir-custom-button", { key: '988bb632044c2c70f1042f04115ee68b88d457da', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Cancel'), this.buttons.has('checkout') && (index.h("ir-custom-button", { key: '84b4b3369290137000c315a51794b7581be0adf2', size: "medium", onClickHandler: e => this.checkoutRoom({ e, source: 'checkout' }), variant: 'brand', loading: this.isLoading === 'checkout' }, isEarly ? 'Confirm Early Check-Out' : 'Checkout')), this.buttons.has('checkout_without_invoice') && (index.h("ir-custom-button", { key: '51ed1b7194c411c983ffa06f807d8d35ceb4782a', loading: this.isLoading === 'skipCheckout', size: "medium", onClickHandler: e => this.checkoutRoom({ e, source: 'skipCheckout' }), variant: 'brand', appearance: this.buttons.has('invoice_checkout') ? 'outlined' : 'accent' }, "Checkout without invoice")), this.buttons.has('invoice_checkout') && (index.h("ir-custom-button", { key: '783ad97ceea5ecaca57e454f4f7f8b3036e146c1', size: "medium", loading: this.isLoading === 'checkout&invoice', onClickHandler: e => {
                this.checkoutRoom({ e, source: 'checkout&invoice' });
            }, variant: 'brand', appearance: 'accent' }, "Check out & invoice guest"))))), hasDue && this.paymentEntries && (index.h("ir-payment-folio", { key: '9ba36adfaf77fd1d64e587ffbccc3da53ead8d17', ref: el => (this.paymentFolioRef = el), booking: this.booking, bookingNumber: this.booking.booking_nbr, paymentEntries: this.paymentEntries, mode: 'payment-action', payment: this.duePayment }))));
    }
    static get watchers() { return {
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '287fe511dfb2e5eac03e5a603363df4ad9509dde' }, index.h("div", { key: 'ddb5573f05e88c4da440954a7f74838ba24b0b22', class: "es-row" }, index.h("div", { key: '5d7cfd9eb7d44d08fbb369ab89579ad3ee7b9a27', class: "es-content" }, index.h("p", { key: '723222e1cf2ae90364f5be7d0df8e8675a64b487', class: "es-description" }, this.description), this.service.start_date && (index.h("div", { key: '7f55ca385b06fcc31e552ff7df936636235af97c', class: "es-date" }, this.service.end_date ? (index.h("ir-date-view", { from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (index.h("span", null, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY')))))), index.h("div", { key: '07c2f8bafeb75f94981b90d4a2f6929575065138', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (index.h("div", { key: 'db40e2eeb132106b4a946dc0935f94fb3768197d', class: "es-pricing" }, index.h("p", { key: '4593c7d2dfbdc02a9ea4134b1b8cdae4cdb9ec11', class: "es-price" }, utils.formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && index.h("p", { key: 'aad8f807e037270d21310c84bcb479a357d4f2ae', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), index.h("wa-dropdown", { key: 'e757f7195207bdd09e04ec2df3e3701288e868ec', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: 'c7006afdbc4d9cf18de19cd4c781422c89d6cd0d', slot: "trigger", size: "small", appearance: "plain", id: `actions-room-${this.service.system_id}`, iconBtn: true, variant: "neutral" }, index.h("wa-icon", { key: 'c1d4d5bc26ffdf2825d63acc57a30d17958881e2', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), index.h("wa-dropdown-item", { key: '98949be93d3cd497c5695b8744e17605a3175163', value: "edit" }, "Edit"), agentMode && index.h("wa-dropdown-item", { key: '43e84e69d0a352f095332f8f2abe2c51b5fb48ca', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), index.h("wa-dropdown-item", { key: 'd43cfe1b67840eacaa1408d1587b33b2bb5de78e', value: "delete", variant: "danger" }, "Delete")))), index.h("ir-assignment-toggle-dialog", { key: '1aacf71c89dbd215074e344569172bf504b96ad2', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, index.h("span", { key: '4216291440586a9201839ad93958cfa718b725c7', slot: "message" }, "Re-assign ", this.description, " ", index.h("br", { key: '951dc56a7a5697c89085dd35feaf7b749c8593fe' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", index.h("b", { key: 'ac2e56ab5c3b04e5431ba4f91fe56895d2ef0a24' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), index.h("ir-dialog", { key: 'cab532cc1487fdab6750ace89e8f4424b059f105', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: '4b0c4f80963279583fc19d036384c996950f1f5c', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '8a59fe2e1454f8f806c2d1e471c6339cde79ccae', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '652936b7c80c6f03926af054811bd2aaad6872b3', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'fee3d047c94ba34ab884c0c04f25703e77528227', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '00d8becfcbc92ee290730b96bfa53392e677944d', language: this.language ?? 'en', svcCategories: this.svcCategories, onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, agent: this.agent, service: this.service })), index.h("div", { key: '9f5230db05845d7f6b09fb8d5c7031d455e315ba', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'eb7a129e8ef7b9336f6e0f0c394655e5c2297f07', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'd2ed1d09b0e51457eb36144a4ac4dd836c2f74e8', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '3e47dc98ef9be1837a4cba3fc5df2b59d8daf38a', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (index.h("ir-validator", { key: 'c9b6b8b6879fa670696c53c0b9fda57c0bd8e85d', value: this.s_service?.category, schema: utils.ExtraServiceSchema.shape.category }, index.h("wa-select", { key: '53b9fe0b9d969acdf7453b2e3c6f07fa14a39201', size: "small", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), index.h("ir-validator", { key: 'd19bef728d314f46975be4b8f9a767ac83edd4ea', id: "amenity description-validator", schema: utils.ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '61788176add7395a0f5c08d36559cbc4abc3180a', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: 'c2374b219c003cb1c9637167f84216e4faf769bf', value: this.s_service?.start_date ?? null, schema: utils.ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: '27119c056a13b18d06823ead749efcaabeac5e0a', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: '07673a69ea5b6be92036435c4eee80bf74a7403a', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: '8e6cc95463df1cf6eb821cb09c8417e33029a4d4', value: this.s_service?.price ?? null, schema: utils.ExtraServiceSchema.shape.price }, index.h("ir-input", { key: 'b149d7e830e5d1755ee99fbfde5b238804b4610f', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales_store.locales.entries.Lcz_Price} (including tax)` }, index.h("span", { key: '53150c7107a52a4fa15d60e23d322634f93a1906', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: 'aa5b34a3051d4a9989b792a9c7f90414397e40cc', value: this.s_service?.cost ?? null, schema: utils.ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '9f4b92ceac813ade9f9aebec3eda410e231624dc', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales_store.locales.entries.Lcz_Cost} (optional)` }, index.h("span", { key: '56d5ff422e606ccbec9ca0b236369bbea0dcc23c', slot: "start" }, this.booking.currency.symbol))), functions.isAgentMode(this.agent) && (index.h("ir-service-assignee-select", { key: '87a1b841f89fc809f2dbb9917b74f7cea617172b', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    renderServiceList(services) {
        return services.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { language: this.language, svcCategories: this.svcCategories, booking: this.booking, bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service, agent: this.agent }), index$1 !== services.length - 1 && index.h("wa-divider", null))));
    }
    render() {
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '7880897119ae29727bdc85e137c0b716483fcb3d', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: '3b860043a0f25c491a3338d4ab125f7d485807e2', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: 'b95a2fc9e709174b881a9afd4e00297bf96ca9c4', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'e8e29e24a985f229149ca1c529e094528f256924', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: 'b4f4213b2b5a32794a03f9d980b3eb3fca1fd1d3', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4f311e451e39d61a6b33d6ec93cdccca16ac5a28' }, index.h("ir-drawer", { key: 'd7da5563b79058caf16d2ccb62f6b1d9c14321f0', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '36f47fb7d682d92900d4c2da71901b32d130b38b', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'aaaa6dcfadaff5bbcef4ef85ec9c9235eb6aa295', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro forma")), this.open && (index.h("ir-invoice-form", { key: '50fc4caa1af5124f70b3874ee4978a0964df077c', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '92d25a9251e5f77884625ed70525fb4708f18db1', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '17e5aa0aabe57200d469c5a4bf5734d1c7e8e7cd', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: 'b10f58acec246ce7fad5f7183b349756e7c0a0f4', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '09ae164b9bc9f5f8130b439fc72b57ea7a6ca701', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: 'ac0f9f4c905ec3e63e70f8cc8682818fb3810293', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'e1f0e9e486b5c61e5edb3afec45886a09b945967', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: 'c35dd750ddd06242dd03588b4ec562cb85205237', booking: this.booking, formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: '85eeaa334140a7340e6b5c83c76fd07aedeab2c2', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '8bcc730653f3386fdc5d6bc882f16c1c13957b41', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '58c7d8857ed2b7c8a45d9240aab667a7352a392b', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: '571a9445e73e50a23f3f6aee1333ad991686edc3', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '2f052909e1d74590f268e2dbb4bdc62413b4b0d1', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '67c8c4c2bc6cc7123b6f6dc6b45dcaf393d0b61d', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '91d795b187dfaf737ecd2d088302939761e9a419', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'df2f322c5f9ed759fea40713c4d9fe7ea0131bb5', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: '898ccadcee9d4dc6c42d59d0a309aaca434326f5', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'f02095fe12030179c81863ecd0fc198c08f7dd67', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'ad801976822fc980f9ef33692034e90384950c57', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: 'bc62433b9a29259369ea849f8db470b11523b062', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '110b52e18fad6e5ff2c4753c28699156915ed10a', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: 'c7e5d5c9b78311e0b6887ec146167496fb9b1b75', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '611ae5af1809241d13eabde23e9a7f053038fafd', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'dd681d6440dd798a62946e30d44d99988716f856', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4aaafaf2b28fe9a6b42a53b56def03662246ede1', class: "payment-item__payment-item" }, index.h("div", { key: 'defe49434cbc1d351cca11689b673a7344d1fd04', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '026d59c8320baab911371b38d639162c5dc36b99', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '141b8d89838f4c7ce675bc3ff6cf1a40ac036ac5', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '9b9f9c7c58675b51b554aa6ebce7ac4b24148617', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '5b782465932caf39684ab3bfa79644d6f1ee41a3', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '3fe5268861a628e626949fd40440c46e0a1851e5', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: 'd42bd44d8be83d5d7d58088cc7c7618bcd30edc1', class: "payment-item__payment-toolbar" }, index.h("p", { key: '0494a42831e0a9dfa9ac5dca5c99d1ce2f66a506', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '27144591c5b2a90bc01f319b184a3b9b7f1f4f57', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: 'fa0835cfb7920bbde5686232b784a10322547bad', class: "payment-item__payment-actions" }, index.h("div", { key: 'c7c8ef4bb230fe486603e66598a4c22cf754b9d0', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: 'b129ffeaac1af2be0d6487235a089161d87474b3', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '8d6503ae9a90b4d38e3740c051afe34e42d34c2f', name: "user", id: this._id }), index.h("wa-dropdown", { key: '9d19c2141c3ac874becd4d8f563077b1fad71df5', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: '833244855173fa5deca467adcb3ebdade3249a14', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: '25e6af20763b0ce4c16f4ff57a931fd9edce216d', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: 'b22be026ff7b46c2d60ff36dee23752280a0a44b', value: "receipt" }, "Print Receipt")), index.h("wa-dropdown-item", { key: '1f80407e4a53b8ba892400d52a0cd9b25adb0dd2', value: "edit" }, "Edit"), index.h("wa-dropdown-item", { key: 'e99fc1c6947e18cc2df461cb1dba6fcb6afe2091', value: "delete", variant: "danger" }, "Delete"))))), this.payment.reference && index.h("p", { key: 'd9fbaa60129f8dfd4337f47db6ffb6392e2af44a', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: 'b1e72a6092610ac04eeda42015cc8baf8d341feb', class: " payments-container" }, index.h("div", { key: 'c13f42609fab06bbff51661384ba8d402fba7138', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'bf2bd54e8f259f9c5710838148adcb45bf189f10', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '7938dc0d69d7b7141a165202164baf9e68302be0', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), !this.isAddPaymentDisabled && index.h("wa-tooltip", { key: '27568d7ac8a31f511cf6857dfef1909b52c3a074', for: "create-payment" }, "Add folio entry"), index.h("ir-custom-button", { key: 'c0ef940d15f031ee266466343c3d998543775f3a', disabled: this.isAddPaymentDisabled, slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '4d596c69324efcac9a24b46664890eb2461d22a7', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'bbce61b3de17d17e7ab1d2bfde37d8146da3e64e', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '5c6322d9b64b372fbec7ddc3ac644c120167ac21', booking: this.booking, agent: this.agent, onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: 'cf71542477b624fc3ff30a8a07b4905c3b52f2c3', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '07daa76958a3a1bff77e0425f42efae8d1abd6c4', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: 'f3d99758a6cd8e7512850b98380dc3953827e7a8', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: 'a68093de67a8e7a8977541aa423e7b5fdba32686', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '22127f1f33f098fadce3cb3dd6fd15e3bfde0007', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '228979fbf362c78a1b4a6f4f628566c8ba8839d8', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: 'b2ea14cec40ec44341227e597f1e12e2d681ed5c', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: 'fd5920d29b15f81d2f67480d30d89e59146deb0e', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: 'c3b1e8a997cff59d9ce1316cf9c510cfa5c34c17', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: 'cf3cd01aef6db582ba54efdecfa1590030152e78', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '1339e005d8c46dca70424fcdfebf685a55f68fd7', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: 'd8eba74ea73bed144645aa332a769eef4e017be3', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '0718ea110943d7b82996f1661fb6d0200e8b95f2', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '99a7bbdc43c50e0b8abb7f8a7adda5f1ac23b31b', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: '0319e9056d3e3d8abdd0c60ec4e6421cf018a668', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'cdab420ebfb47145cb6d59a7fae19bd06c367c5d', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'd3857c5298c568ece816c1a092492a076c65eb31', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '588445f2d271ea20a8d069559e2e110222ebf1d3', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: '9a9850d69a81dd9dbbd25b07df6af796b149c1f8', mask: 'price', label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, index.h("span", { key: 'e7c68d960ae848a567c7c0924cea4ba24f468f50', slot: "start" }, this.pickupData.currency?.symbol)), functions.isAgentMode(this.agent) && (index.h("ir-service-assignee-select", { key: '8831c101de576aef95854437b0b01f54a319df1b', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.assignee = e.detail;
            } }))))));
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '33ec59f3f4b4f7d5e0080ff0bfcdd159e85e998a' }, index.h("div", { key: '04308502ce01e0c6519aff9f5e2db6cce1708c77', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: 'ab35c493d75d6c0b783c58220f229ba1e424b41d', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '522defee9b39dfcdaf50322b673480b063e8d3c6', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '2f265da3698f754c654449f6d31c580452c38f02', class: "reservation-information__row" }, index.h("ir-label", { key: '2f803b18cb138ed2360aa64d8f1567ec4a600a54', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: 'd057d2baf755ee9c8b8ae7ea347be21f853fd4e2', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '5357e1695db278b3cbcce0600c0b632cd180f54f', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: 'fec3e59c75bc399cd475c2f2d3632d814d2abbfc', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '3ae3ce37fad246f76ff202116ed7a7b16d99b868' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: 'c1b79cbd8575c30930fe198eb5b2efb65641b816', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '807e85dc620292c361aac9a4526dc1eb65a411b6', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '94295228ddff0993ae76577384b60a0665b8f718', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '0408472aaf6588e5166c6b1ecb247073cbeffdfc', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), !this.booking.agent && (index.h("div", { key: 'e72854bb79caf725361c7cfeb1f48b19ef497875', class: "reservation-information__row" }, index.h("ir-label", { key: '1f407bcf5814df2ac8077887a8204c3613af0a08', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '382416a8764ddfdb7d1cc9ed272312bc3f49b9ae', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '7c4e3916d5625fe93f362d80bd547df785fce175', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'a87f46ef249630ac67b9581db4f98d1cb7936eb9', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } })))), this.booking.guest.mobile && index.h("ir-label", { key: 'e03030c503f9e8d7a8c1d205b7fb5a425f7fe3f8', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '244db48defaab94209f92ecdb8b42418669a9d94', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'f68ec9ba2ec6ddea98b110d36cee6c259699801e', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '2e9ce7f4230b3ace7bc92c0ff75d530e6dce2e31', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '5b5eb2d838882e3ee755cd0881121974942a15df', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: 'a84f392e62586be1d9f6cdcfe656c0d7950374ae', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && (index.h("div", { key: '90ed65e7d575a420b2af0d12eb23af5a875753d5', class: "reservation-information__row" }, index.h("ir-label", { key: '47e1d6c86a5887fad32cc98306dd0de506181112', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, display: "flex", content: this.booking.arrival.description }), index.h("wa-tooltip", { key: '39abffbd0a3227a33026b90f342af15829f98123', for: `edit_arrival_time` }, "Edit arrival time"), index.h("ir-custom-button", { key: 'b8b43fad2f4555b32cc22287e24471bee9888f54', iconBtn: true, id: `edit_arrival_time`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irArrivalTimeDialogRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '640cd8906583062d4f9bc1961cc744a5b20306b2', name: "edit", label: "Edit arrival time", style: { fontSize: '1rem' } })))), this.booking.promo_key && index.h("ir-label", { key: 'e557ae68e83b87a1a8aeb20d1c8080db35bb90f6', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'a8e70e663f01f731f91e175c78950a695ee18c94', class: "d-flex align-items-center" }, index.h("svg", { key: '0deb3b4ce3413cd913fb6fd8837e4f8ca10b1832', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '16f2fd291c5c188a2b649581ce933f57135094ef', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'eb54e2d450fbfb6a7fda8dad30c4c332391d36d8', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '393e5bbd7f3229bae431c851c064c965ad1e4c5a', class: "reservation-information__row" }, index.h("ir-label", { key: '3938e3273a679a0204416dbd130d9a7c54f8452e', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: 'f8f5728e8a90c3100b8bf057da746225807ad4a1', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '06b7a5625c790c6dcdec540fd9a96ce9a3406493', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'c210bc0e05a6d2d2d450329d889e2e453d3b7eeb', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '2b3a5e44f9d29100085b00e51fc03f1833040fd1', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: '911297b7faa0b257e9804e6f82da5e11e28f1786', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) })), index.h("ir-arrival-time-dialog", { key: '322067d3cf602aa3c927c653a0584ec027d0027a', booking: this.booking, arrivalTime: this.arrivalTime, ref: el => (this.irArrivalTimeDialogRef = el) })));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd0650a68b9da386b5a74d1d97ae7a3e1bbb6d389' }, index.h("div", { key: 'f6aa25496f3db9a4f0ce1c9554dce3f6195a064c', class: "booking-room__header-row" }, index.h("button", { key: 'c46eabab5fb9df9008b3c81b0c0362b973824773', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '9752f1e4ab429bed686e20cb4a2ce1dc217358ad', name: "chevron-right" })), index.h("div", { key: 'cb2e1e2057b510b0658946c1332f147ca9b57f4c', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '9e39029254d4d7cad71d4672ea78f76fce6b09b3',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'c406efaa61aba97908f894e12e169bdb7e4a66bf', class: "booking-room__summary-row" }, index.h("p", { key: '18840aabd6c2f1bd047dd5020973154b7101a02e', class: "booking-room__summary-text" }, index.h("span", { key: '95c941b7ecd994cd4ec86dc58e294eb1bee82764', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '6de5e57a76f5f8d7ac1cbc873cade4a7b7f313f6', class: "booking-room__price-row" }, index.h("span", { key: '2864b3c153b41069f5ed92b7e2bd27f9bfdca11d', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (index.h("div", { key: '386dc9166da951ac9c406e07fa293ad58f0ae5fa', class: "booking-room__actions" }, index.h("wa-dropdown", { key: '0b48b108ced50097bf9a2cc8c806e181c228f636', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: 'd071a544e8ff7b404556c0b139542af5a2a3ed03', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, index.h("wa-icon", { key: '233f04ac8cd0073635640b38b49133e0bed0d654', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && index.h("wa-dropdown-item", { key: 'db87757858bf827b6c177f4f480a00e1000cf7b4', value: "edit" }, "Edit"), functions.isAgentMode(this.agent) && index.h("wa-dropdown-item", { key: '736dbbd98ac26d74e2325557c23e9dbcc9928f92', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (index.h("wa-dropdown-item", { key: 'c0db2b445305eca4772636d282a1d4ef6ff29358', value: "delete", variant: "danger" }, "Delete"))))))), index.h("div", { key: '814fb02a2df8dff2bf408fa4ace0c64ce325b02c', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: '879bfd453dfab118651f5c0c1084a78d80f45853', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: 'df9fc4d33c1fa180c698efcafb0151fb2b516e7a', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: 'fe409defdcbf6cfc63b34f32c698ff34074a6bae', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '8aa5b31afedcc0627aae4e0f52e7d9b6fef4f278', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: 'aa16b2ae2cbdab98808d6a4b5af7c84e746ad394', class: "booking-room__guest-row" }, index.h("p", { key: '323af5a255b78c86faa65be845ee2da90b74a696', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '3562f7493084a13ba19f96c7ccfb685d1c0da7a0', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '58a1c3028625729c3d008fbd761a5d6dc72e3944', class: "booking-room__departure-row" }, index.h("p", { key: '23fb18b98d86a3022d64b4c32871eecaf6af2295', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: '9eb9f26e1de611e2654ff298be7dfdd126372863', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: '854b1bdd1a07a7c2f5712b8fd5a9a48e5b4b5460', class: "booking-room__details-container" }, index.h("div", { key: '0708c620e22cbb37068690af4918739988eca65e', class: "booking-room__breakdown-row" }, index.h("div", { key: 'd2387bf4facaeabc788a3faa2e4a1caf9f0345de', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: 'eebc26a15739a48c1032358ad44bbfbdb68beaf3', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'cc120f502cc2ab1a8d82fab4949cdce3e2d11d0c', class: "booking-room__breakdown-table" }, index.h("table", { key: '00abc85022493df60c3c7509fff9faba61a5fb36' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '959fb9a533d9d0877d33ab4c37660450e21fe3bd', class: '' }, index.h("th", { key: '14706fed272f78cd5263739609f43cf162988738', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '95823e7a86875fe8dba01c05e7f58b0d42fcd1aa', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '58f11df36861c702a0ab365d050b165ba62a26cc', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: 'c4945da95394155315df85df7d633d992c2a8d51', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '374cb519db8b88089225677d9f369e0f7906d0b9' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '8dc936fa4296070bf84f18c996cc8106c50fd806', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '174a83e0ca9d3b488136ddc6aebff3d11afe7c5e', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: 'cc093a11e2560d42198eb0ec1b9a743495a64d9c' }, index.h("ir-label", { key: '7e86a674bd64cd4b16ef2ec91cabfa7cb7334f3a', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'b73c4cc863cc008a90b13bc614827d3ddf17720a', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-assignment-toggle-dialog", { key: '858c6c867f747deeeccf564ab7ef108759e49340', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, index.h("span", { key: '84a49949316051196836a7279ff2a8952b44f272', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', index.h("b", { key: '0e9bbe3e7a40ddb40edcdbf11d15a7ff3c24735c' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), index.h("ir-dialog", { key: '8a1ac85747ad32ddb091a575f79ba40cf9058216', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: 'b4fe3d697fe6f0a2c5a05d84097957cdbb3aae41' }, this.renderModalMessage()), index.h("div", { key: '57102c5564a62a6ab6650e4bb3e5b9cf02fee067', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '309c9b6679ec31a909252f3ca190dc2bd78e6335', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'e3e6951eb2d92d7232d390fc378739c8839ddc3c', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '91cce687d965d620d68ec059121e0917a8c5f908', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '3acc565a93c21809d35d09852e39a41d00506c74', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: 'fb5e0f48e48fbfb540d9a5acb9606882e1ce8442', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-room-guests-form", { key: '8a14e1afa5dded38e0e63ff5e91bcbf210413770', sharedPersons: this.sharedPersons, roomName: this.roomName, countries: this.countries, totalGuests: this.totalGuests, identifier: this.identifier, bookingNumber: this.bookingNumber, checkIn: this.checkIn, language: this.language, onLoadingChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            } })), index.h("div", { key: '91f5514ea3c39c1fa8d31a2f33a1ce80ce9811a1', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '248d88b89d1cdca0c5b573fd598ead59579c7846', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: '140a48e905d8af1e22c6b2368d76a3adc9077bc5', value: "save", loading: this.isLoading === 'save', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: 'b4154c379be3adac176c54012d3765cfdf14a0bf', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
