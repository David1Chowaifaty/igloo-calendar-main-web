...
const utils$1 = require('./utils-894ab133.js');
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd64c79fcb914930445d0e8326d53b39ccd976587' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("h5", { key: '429ce7d1d4d09ce5ee0b0c10ab114f822b25b0e6', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '667b6a6f31d487d878bd41892bb917d003d5d72a', label: "Edit Arrival Time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-select", { key: 'fda684fc3a9ec2c43a1fee1d67165cd1c3019f5e', size: "small", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), index.h("div", { key: 'bc387a9991b47800f84da61bc40662539a0ec0ef', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'e15ffc90bfcdc4227e190b429d3148b5f7e20f63', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '28b745c54c07e96ea9430b7305419a5655b66f8a', size: "medium", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrAssignmentToggleDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '94523b9464f0a593771b4fbbdbf80c1d6950b4f6' }, index.h("ir-dialog", { key: '2956b6ccf9d09e61c6c7976e376f67e5e07e48d9', label: this.label, lightDismiss: false, ref: el => (this.dialogRef = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            } }, index.h("p", { key: 'a63a00a1d5ffe7006d8a0ec350b382e23837bbb5', class: "assignment-toggle-dialog__message" }, index.h("slot", { key: 'aa14f2acc9783ba154e4a10914e745d9d7235351', name: "message" }, this.message)), index.h("div", { key: '008fced9e428d2aca4daf47ce3f16efb8f7fade0', slot: "footer", class: "assignment-toggle-dialog__footer" }, index.h("ir-custom-button", { key: 'b8131e2de46b570a85bbaddda2f11e81b7f070b6', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close", disabled: this.loading }, this.cancelLabel), index.h("ir-custom-button", { key: '61b3f5e960514004f20f6a8f63ae11af51215312', variant: "brand", size: "medium", loading: this.loading, onClickHandler: () => this.confirmToggle.emit() }, this.confirmLabel)))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: 'f9b2491c4794c41139be4369f92010f0c39932e0', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: '311198e3c2a875b91adbb867f6376a3302df0d1e', booking: this.booking })));
    }
};
...
const IrBookingAssignItems = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4a4f530aa83683c54b2fe4987952be6b9320a697', size: "small" }, index.h("div", { key: '59577d4b92caf22d895c7a10ddbba81bc94bc2d0', class: "assign-container" }, index.h("p", { key: 'dd7a9b12ab40438708e7d049018ab51ccfbb54ba', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (index.h("div", { key: 'ea8948a743e11f79960b11e6d1f0d4cfab5c3c83', class: "assign-section" }, index.h("p", { key: '48d81dffda4f27e27bf2d0d9b614a729d20e5bea', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (index.h("div", { key: '8283e32e4b535db47e830b58e6a851e9619e8102', class: "assign-section" }, index.h("p", { key: 'f1a0751fb7ec660e29ac1bc375d87611db4a6fae', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (index.h("div", { key: 'b1f4363c4ecfdf2cf373979fe78872670c5954c6', class: "assign-section" }, index.h("p", { key: 'a3695bdaf64fc430fd7cb611d65cead55e58d646', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
};
...
const IrBookingCityLedger = class {
    ...
    renderTable() {
        ...
        return (index.h("div", { class: "table--container booking-city-ledger__table-wrap" }, index.h("table", { class: "table data-table" }, index.h("thead", null, index.h("tr", null, index.h("th", null, "Status"), index.h("th", null, "Date"), index.h("th", null, "Description"), index.h("th", { class: "text-right" }, "Debit"), index.h("th", { class: "text-right" }, "Credit"))), index.h("tbody", null, this.folioRows.map(row => (index.h("tr", { key: row._rowId, class: "ir-table-row" }, index.h("td", null, index.h("wa-tag", { size: "small", variant: row.status.variant }, row.status.label, row.status.id === 'billed' && index.h("wa-icon", { name: "lock" }))), index.h("td", { class: "booking-city-ledger__cell-date" }, moment.hooks(row.serviceDate).format('MMM DD, YYYY')), index.h("td", null, row.description || '—'), index.h("td", { class: "text-right" }, row.debit ? this.formatAmount(row.debit) : '—'), index.h("td", { class: "text-right" }, row.credit ? this.formatAmount(row.credit) : '—'))))))));
    }
    render() {
        if (!this.booking?.agent) {
            return index.h(index.Host, null);
        }
        return (index.h(index.Host, null, index.h("wa-card", { class: "booking-city-ledger__card" }, index.h("div", { slot: "header", class: "booking-city-ledger__header-title" }, index.h("p", { class: "font-size-large p-0 m-0" }, " City Ledger")), index.h("wa-tooltip", { for: "booking-city-ledger-add-btn" }, "Add folio entry"), index.h("ir-custom-button", { slot: "header-actions", id: "booking-city-ledger-add-btn", size: "small", variant: "neutral", appearance: "plain", onClickHandler: () => (this.drawerOpen = true) }, index.h("wa-icon", { name: "plus", style: { fontSize: '1rem' } })), this.isLoading ? (index.h("div", { class: "booking-city-ledger__spinner-wrap" }, index.h("ir-spinner", null))) : this.error ? (index.h("p", { class: "booking-city-ledger__error" }, this.error)) : (this.renderTable())), index.h("ir-city-ledger-transaction-drawer", { open: this.drawerOpen, drawerLabel: "New Folio Entry", agentId: this.booking.agent.id, currencySymbol: this.currencySymbol, serviceCategoryOptions: this.serviceCategoryOptions, bookingOptions: this.bookingOptions, onCloseDrawer: () => (this.drawerOpen = false), onTransactionSaved: async () => {
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '57194f672c89565e69b9f07f03a25da3a0490b60', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (index.h("ir-booking-editor", { key: 'b5e092ff3a457aa57887ba2ab43433a2a8c73cd2', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), index.h("div", { key: 'c1c26fc6303b3038f314b84ac6f545ed1425c8f7', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
...
const IrBookingEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '46886970a835a2e35eb0fe5e4960293a17d58fa5', class: "booking-editor__guest-form", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                this.doReservation.emit(submitter?.value);
            } }, index.h("div", { key: 'e37e0f41a2ee16cdb416b1fdb6ed3910565d2847', class: "booking-editor__header" }, index.h("ir-date-view", { key: 'e690871e3b3a293ffc815155a1fea357486891da', class: "booking-editor__dates mr-1 flex-fill font-weight-bold font-medium-1", from_date: dates.checkIn, to_date: dates.checkOut, dateOption: "DD MMM YYYY" }), this.totalRooms > 1 && (index.h("div", { key: '36e73a6f4d76c87f1234950ef326ea6b918225a4', class: "booking-editor__total mt-1 mt-md-0 text-right" }, index.h("span", { key: '36c908a51fbd6153c2b1b8c980bf41f8420e72c4', class: "booking-editor__total-label" }, locales_store.locales.entries.Lcz_TotalPrice), ' ', index.h("span", { key: '0243664d7e19a7a6d635dd56ad85651ca35c9dc0', class: "booking-editor__total-amount font-weight-bold font-medium-1" }, utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.totalCost))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
            ...
            }, variant: "brand" }, "Clear user"))))), index.h("ir-booking-editor-guest-form", { key: '3cc0ec3cacd8b72836a0e10030165b5d15e090dd' }))), this.bookingEditorService.isEventType(['SPLIT_BOOKING', 'ADD_ROOM']) && functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '757ebc4ee792d33696df6dfdd52f8818611d4bf3', style: { maxWidth: '500px' }, agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrBookingEditorGuestForm = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '68e00dde610f18d7c9c4744e322b849375dfeb0c' }, index.h("section", { key: '2dc99d948b900ff3934cf7966d424a624eec0b7c', class: "booking-editor__form-control" }, index.h("ir-input", { key: '231bbd97fe1eef1ff9ae1ba369a5c613f7e61100', label: "Email address", "onText-change": e => booking_service.updateBookedByGuest({ email: e.detail }), mask: 'email', value: bookedByGuest.email, defaultValue: bookedByGuest.email, placeholder: "Email (leave empty if not available)" }), index.h("div", { key: '83c571c285a9b09f864f85fa24fcaf9f0cdb4d54', class: "booking-editor__guest-name-group", id: "booking-editor-guest-name-group" }, index.h("ir-validator", { key: 'ea0f8c211751a787971c261e16523d1c9e149511', class: "booking-editor__guest-input-validator", value: bookedByGuest.firstName, schema: BookedByGuestSchema.shape.firstName }, index.h("ir-input", { key: 'c8c4605c796e3d7eed6a71d4482a3eeda82a134b', id: "booking-editor-guest-first-name", class: "booking-editor__guest-input --first-name",
            // label="Name"
            value: bookedByGuest.firstName, defaultValue: bookedByGuest.firstName, placeholder: "First name", autocomplete: "off", "onText-change": e => booking_service.updateBookedByGuest({ firstName: e.detail }) }, index.h("p", { key: '014ac0dc5ba306d347f5bc397f46d105fa293984', style: { margin: '0', marginBottom: '0.5rem' }, slot: "label" }, index.h("span", { key: 'a00a1808f923e99936e1b0bc167df57c0c7b7fe2', class: "booking-editor__guest-input-label --first-name-pc-label" }, "Name"), index.h("span", { key: 'e021ae85619a8ccc100a1fc99c4fc70dadc7e59e', class: "booking-editor__guest-input-label --first-name-mobile-label" }, "First name")))), index.h("ir-validator", { key: '524b365bf12580c02f11a7316affd8187e5adf14', class: "booking-editor__guest-input-validator", value: bookedByGuest.lastName, schema: BookedByGuestSchema.shape.lastName }, index.h("ir-input", { key: 'a973528868d4070a34b83d3a2cdaaa486554cea9', id: "booking-editor-guest-last-name", class: "booking-editor__guest-input --last-name", label: "Last name", "onText-change": e => booking_service.updateBookedByGuest({ lastName: e.detail }), value: bookedByGuest.lastName, defaultValue: bookedByGuest.lastName, placeholder: "Last name", autocomplete: "off" }))), booking_service.booking_store.bookingDraft.agent ? (index.h("ir-input", { label: "Booking code", placeholder: "", value: bookedByGuest.bookingCode, defaultValue: bookedByGuest.bookingCode, "onText-change": e => booking_service.updateBookedByGuest({ bookingCode: e.detail }) })) : (index.h("ir-input", { label: "Company name", placeholder: "Company name", value: bookedByGuest.company, defaultValue: bookedByGuest.company, "onText-change": e => booking_service.updateBookedByGuest({ company: e.detail }) })), index.h("ir-country-picker", { key: '10c1a1f18048f8ed5b1c2aa6c406826b2e793025', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.updateCountry(e), countries: selects.countries, country: selects.countries.find(c => c.id.toString() === bookedByGuest.countryId?.toString()) }), index.h("ir-mobile-input", { key: '93af02d77bfc79bcdec769f776ba0d86a7b9f5d5', size: "small", "onMobile-input-change": e => {
                booking_service.updateBookedByGuest({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => booking_service.updateBookedByGuest({ phone_prefix: e.detail.phone_prefix }), value: bookedByGuest.mobile, countryCode: selects.countries.find(c => c.phone_prefix === bookedByGuest.phone_prefix)?.code, countries: selects.countries }), index.h("wa-select", { key: '6ace74dbd0949c89aa0fabec31ec98ce5d3b6a18', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", id: v4.v4(), defaultValue: selects.arrivalTime[0].CODE_NAME, value: bookedByGuest.selectedArrivalTime, onchange: event => booking_service.updateBookedByGuest({ selectedArrivalTime: event.target.value }) }, selects.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: bookedByGuest.selectedArrivalTime === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("section", { key: 'f7bd1a6aefa2beb82bb5ee70c369af7c4ff56edd', class: 'booking-editor__form-control' }, index.h("wa-textarea", { key: 'b8bf75f084fb50b41b34e6c3b0764bbc72b8c8a7', onchange: event => booking_service.updateBookedByGuest({ note: event.target.value }), size: "small", value: bookedByGuest.note, defaultValue: bookedByGuest.note, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 3 }), (!agent || agent?.payment_mode?.code === '002') && (index.h(index.Fragment, { key: '221aa7f57fca768f8dcc157e056a95ec22a82a22' }, this.paymentMethods.length > 1 && (index.h("wa-select", { key: 'dadf293e68408834af8ecb2bcc13deb05cad7a0d', label: 'Payment Method', size: "small", defaultValue: booking_service.booking_store?.selectedPaymentMethod?.code ?? this.paymentMethods[0].code, value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: '43b02eb088c7182e565b2d4d9132536d97d16bf0' }, index.h("ir-input", { key: '741e6079aa657035c06710e58ea2203a44e7afed', value: bookedByGuest.cardNumber, defaultValue: bookedByGuest.cardNumber, "onText-change": e => booking_service.updateBookedByGuest({ cardNumber: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: 'e79c28352f8c639c79eb8fe59e449a1b11971fad', value: bookedByGuest.cardHolderName, defaultValue: bookedByGuest.cardHolderName, "onText-change": e => booking_service.updateBookedByGuest({ cardHolderName: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: '704a8a4546ed450c59a75db1dc71b634b905aa22', "onText-change": e => {
                const [month, year] = e.detail.split('/');
                booking_service.updateBookedByGuest({
                    expiryMonth: month,
                    expiryYear: year,
                });
            }, value: this.expiryDate, mask: this.expiryDateMask, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h(index.Fragment, { key: '5ca541c86fa30f633a63c7840b23d8efdfab4885' }, index.h("style", { key: 'b202be7d6b22b8af5263ce71409f1f84b8529866' }, `p{
              margin:0;
              padding:0}`), index.h("div", { key: 'b7a08105e16dc0970fe787698be083de859987c9', class: "booking-editor__payment-info-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description }))), index.h("wa-checkbox", { key: 'e19eb1edbb30fbdd4a98b04312c46efdb2e0f565', defaultChecked: bookedByGuest.emailGuest, checked: bookedByGuest.emailGuest, onchange: event => booking_service.updateBookedByGuest({ emailGuest: event.target.checked }) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
...
const IrBookingEditorHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'eeb6f6d802903e3be6526bfe1909e62fafd32830' }, index.h("form", { key: '488cf295f2e26d83d32c3f014815c01bd69649c2', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (index.h("ir-validator", { key: '7c0be1eb54b2ef3b7529560f07eb17c1dd147667', value: booking_service.booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, index.h("ir-picker", { key: '8f3b28b32b6cd96e7d8d064ebec574a6bda82ff8', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales_store.locales.entries.Lcz_Tobooking}#`,
        ...
        })))), index.h("div", { key: '741899995194035d430acc8145d89d13156b3fef', class: "booking-editor-header__container" }, !this.bookingEditorService.isEventType(['EDIT_BOOKING', 'ADD_ROOM', 'SPLIT_BOOKING']) && (index.h("wa-select", { key: 'ab3f89e7cdaa5ee94a91101aeebe228aec09ef27', size: "small", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_service.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_service.booking_store.bookingDraft.source?.id, "onwa-hide": this.stopEvent.bind(this), onchange: this.handleSourceChange.bind(this) }, sources.map(option => (option.type === 'LABEL' ? index.h("small", null, option.description) : index.h("wa-option", { value: option.id?.toString() }, option.description))))), index.h("ir-validator", { key: '56a93a5184273098f141beb0ba28eea39c87118a', class: "booking-editor__date-validator", showErrorMessage: true, value: booking_service.booking_store.bookingDraft.dates, schema: this.datesSchema, style: { position: 'relative' } }, index.h("igl-date-range", { key: 'ac23f9082f6626a387489f379309b1c02111a296', class: "booking-editor__date-range", defaultData: {
                fromDate: checkIn?.format('YYYY-MM-DD') ?? '',
                toDate: checkOut?.format('YYYY-MM-DD') ?? '',
            }, variant: "booking", withDateDifference: true, minDate: this.minDate, maxDate: this.maxDate, onDateRangeChange: this.handleDateRangeChange.bind(this) })), !this.bookingEditorService.isEventType('EDIT_BOOKING') && (index.h(index.Fragment, { key: 'ee6545f759c5eb0374f1e2fa80a3ab78801f8b99' }, index.h("ir-validator", { key: '8bac048b1714a2e1a043dd70b8d18d8a64477081', value: adults, schema: this.adultsSchema }, index.h("wa-select", { key: '77063b7da731c15bcc3aad64fbc8a7bd55dc4b77', class: "booking-editor-header__adults-select", size: "small", placeholder: locales_store.locales.entries.Lcz_AdultsCaption, value: adults?.toString(), defaultValue: adults?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleAdultsChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.adult_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))), calendarData.calendar_data.property.adult_child_constraints.child_max_nbr > 0 && (index.h("wa-select", { key: '4e7c733ef1c7551ccf95e40e782f1b2c8d104737', class: "booking-editor-header__children-select", size: "small", placeholder: this.childrenSelectPlaceholder, value: children?.toString(), defaultValue: children?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleChildrenChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.child_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))))), index.h("ir-custom-button", { key: '30082b3440164d7c07a6b8cff36008be21d94edd', loading: this.isLoading, type: "submit", variant: "brand" }, "Check")), booking_service.booking_store.roomTypes?.length > 0 && !this.isLoading && (index.h("wa-callout", { key: '619bf8548c672bfc3bb9788f57168567d0aa1e71', size: "small", variant: "neutral", appearance: "filled", class: "booking-editor-header__tax_statement" }, calendarData.calendar_data.tax_statement)))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"],
        "mode": ["handleModeChange"]
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '387002e9d9ba5c072323daa1e6dc4a9bcc923f11', label: "Private Note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '3d691080f12b004f33a4a92b6711beeff1bdeb6d', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '9190503e98d677c1481b951c897f0349492a7724', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c311b08b0114bed6184040a33a6dd49a206186a1', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '963f92c78bb362b2e7ba94fab411a735d52561bf', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '15732e29400251bc3e881330707535a57d4566b2', class: "booking-header" }, index.h("div", { key: 'f3e886c8986c8c932d20962c49dff0a526e2c017', class: "booking-header__row" }, index.h("div", { key: '5b46ec235438a6cc033fd02e5ecbd7cb8b9bd27e', class: "booking-header__info" }, index.h("div", { key: '1f9c3aab7cbeacac00a0a7f43c9fa8bfcfd3ad93', class: "booking-header__title" }, index.h("div", { key: '9f471c3d6e5b52ae06cfbf6c0f16c8f493b9e550', class: "booking-header__label-container" }, this.hasMenu && (index.h(index.Fragment, { key: '9f8d40859e9fcd4e563b0398001a4de91ccbe39f' }, index.h("wa-tooltip", { key: 'a6b1ee3f0ac2e7d2879425d00d5212c206eca39f', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: 'c8c37a4d4694a8c75d1216ece585fe841e8a6142', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '28c4ea8c1bdad5b1cbc8c7645b6f7eec7737ae1e', name: "arrow-left", style: { fontSize: '1.2rem' }, label: "Go back" })))), index.h("wa-avatar", { key: '76a512f94485a6ec21ee57657630a7b7f7ebd5c3', shape: "circle", initials: this.initials, image: this.avatarImage, loading: "lazy" }), index.h("div", { key: 'c5489f3608b187f44265c57ce180f695598cd235', class: "booking-header__identity" }, index.h("div", { key: '7d15aa474cc4bdab018037ca4fd7a64224443d48', class: 'booking-header__label' }, index.h("h4", { key: 'dd0791673f994a3b658833c95c01df4392fc795f', class: "booking-header__label-number" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`)), index.h("div", { key: '6ed440a1ecfa4247491f5e86eebd8a2fb1471225', class: "booking-header__meta" }, index.h("p", { key: '510a64bff138f471192b4fcabad9b20fedcc09a5', class: "booking-header__channel-number" }, this.booking?.agent ? (index.h("span", null, "Agent:", ' ', index.h("p", { class: 'truncate p-0 m-0', style: { maxWidth: '100px', display: 'inline-flex' } }, this.booking.agent.name))) : (this.booking.origin.Label)), !this.booking.is_direct && index.h("p", { key: '8aec4f74df79db0558f02a2722c10fbc8288929b', class: "booking-header__channel-number" }, this.booking.channel_booking_nbr), index.h("ir-custom-button", { key: '1c5e6f4b0b7f9d9bb591b894c479d9496cd5bd07', link: true, onClickHandler: () => this.bookingSourceEditor.openDialog() }, "Change source"), lastManipulation && (index.h(index.Fragment, { key: 'f85c058d76825f47076b1ea22e1dda6dd9cbba8d' }, index.h("p", { key: '4f9bfc0598d993b75f47dd9eaa7f801cfbdcdb0e', id: `booking-${this.booking.booking_nbr}-modified`, class: "booking-header__modified" }, "Modified"), index.h("wa-tooltip", { key: '13541309b6968a313682becfd2d0e7bd3069f60d', for: `booking-${this.booking.booking_nbr}-modified` }, index.h("div", { key: 'b0ae7ab57adfd18e1a1213382265c107249c8d03' }, index.h("p", { key: '62c00da3d30bec24f526df47b166cd8edd1899f6', class: "m-0" }, "Modified by ", lastManipulation?.user, " at ", lastManipulation?.date, " ", lastManipulation?.hour, ":", lastManipulation?.minute, "."), index.h("p", { key: 'b32507784fbe982d721b151ce15c4defb6c7af0b', class: "m-0" }, this.alertMessage)))))))))), index.h("div", { key: '2795983dfe70ebb5abda3370ac691bdf4669b061', class: "booking-header__actions" }, index.h("div", { key: 'c8391bb4b190afc7e4851d67b58fcc47f962c353' }, this.booking.allowed_actions.length > 0 && this.booking.is_editable ? (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            appearance: 'outlined', size: "small", variant: "brand", class: "booking-header__status-trigger" }, index.h("ir-booking-status-tag", { slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", null, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))) : (index.h("ir-booking-status-tag", { status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }))), functions.isAgentMode(this.booking) && (index.h(index.Fragment, { key: '53ca9f1505e05bef3bb0e2ebdcde57cd7769975c' }, index.h("ir-custom-button", { key: 'fee73a93152939231026fc1d395c7a66ef9558b0', onClickHandler: e => {
            ...
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "warning" }, "Force city ledger"), index.h("ir-custom-button", { key: '1eab5a8feeb6e10edeafa6cdd26019c9b721b658', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.invoiceDialogRef.openModal();
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Invoice to agent"))), index.h("ir-custom-button", { key: '394ef1c285420822bb71c4a5489d94c6c98ceb8a', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Logs"), showPms && (index.h("ir-custom-button", { key: '23feda2b85585e387c438e410f160a019abdda64', class: "booking-header__stretched-btn", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: '39472a3321b8c94c4a9ffa1f8655c5ac43366feb' }, index.h("ir-custom-button", { key: '945bb2098487c27a5a7a3aaaf2d5c61e2ac0aa09', class: "booking-header__stretched-btn", id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '7deb81d28197a62601e9a9b45f14a11fd5c8f7f4' }, index.h("wa-tooltip", { key: 'ee7832585d00875cdb4efe6dff0d004283bcb8aa', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: 'b94e82bc5e898604ec6a112efb33a3c2204c2af4', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'b68a17a8d99ef841d712bbb9a1eaaf95ed1d0783', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: 'c451d1930d4b4007dc441149521031febe76a4dc' }, index.h("wa-tooltip", { key: 'c6d6842d377dcfbd3cc85e1e9fb6e8c21bdaf82b', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '15bdda32506047e1cb2e29bb1ba31a450c3e3064', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '2a304dd029e881ff7bc8f0d809a592086ae445d6', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: 'e6dac23b21ec4a729f41a6a7f0d312869d367bf9' }, index.h("wa-tooltip", { key: '2ca38e2bc5d7ab4081beabbb82553d855c8c778e', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: 'aea3256716b452927fdda52c2a28ff1c938bc29e', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '280bb9184ab56341076e3579a0a5eb043ce74765', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '1f1c90fcc91342ef2dbd9576387936a60cb310dd', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'cd882eb326625b2866851cece1f99a8f073634bb', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: 'bcc5d60ba164f2c79af89a4b72b6a66c52799c5c', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '4ce4e5b4c2291d5f91e250e7fb628ed42edd24ee', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '4b8a0f7a40fed25df131d566624eeb58b2eb1e62' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: '3523017acb7dd4153156d0f59ccb4e5dc7b0a6d2', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '2a83119c63c23afc2be338ccc63a89f5df34b4d9', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '28f38f5cf71790e5ff73a4c48096cbfeb878eefb', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
            }, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status') }, locales_store.locales?.entries?.Lcz_Confirm))), index.h("ir-booking-source-editor-dialog", { key: 'ee453d3e883d72c971de2f15949ae67217a127ee', booking: this.booking, ref: el => (this.bookingSourceEditor = el) }), index.h("ir-cl-invoice-dialog", { key: '09e4ccd95da37e749d5b9a61f75ec47533b8c66e', mode: "booking", agentId: this.booking.agent?.id, bookingNbr: +this.booking.booking_nbr, startDate: this.booking.from_date, endDate: this.booking.to_date, currencyId: calendarData.calendar_data.property.currency.id, ref: el => (this.invoiceDialogRef = el) })));
    }
};
...
const IrBookingSourceEditorDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '7d23d5125aa8b426ee6f7ccf17fddf55a8e25328', label: "Change Booking Source", onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, open: this.open }, this.open && (index.h("ir-booking-source-editor-form", { key: '78cb500248c60a7f3e69a6a7642bcd4b0f882ee9', booking: this.booking, onBookingSourceSaved: () => {
                this.closeDialog();
                setTimeout(() => this.resetBookingEvt.emit(null), 100);
            }, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'bb1e49d83b86ed62fea3baee4e27a8d20572baed', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '828de0a5e7b49ffe1d9799bbdfd44090803fdb43', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '7a3d8eecb1f2a52b77ff321609c3104a2025f51c', type: "submit", form: `change-source-form-${this.booking?.booking_nbr}`, size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading }, "Save"))));
    }
};
...
const IrBookingSourceEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '023083251994574a2ed995fb8cde909efcef5910', id: `change-source-form-${this.booking?.booking_nbr}`, onSubmit: this.handleSubmit.bind(this) }, index.h("wa-select", { key: '1eda65d4aeddf736f6b74c88a39af26137b4a6b3', label: "New source", onchange: this.handleSelectChange.bind(this), size: "small", value: this.selectedSource?.id, defaultValue: this.selectedSource?.id }, calendarData.calendar_data?.property?.allowed_booking_sources?.map(option => option.type === 'LABEL' ? (index.h("small", { key: option.id }, option.description)) : (index.h("wa-option", { key: option.id, value: option.id?.toString() }, option.description)))), isAssign && index.h("ir-booking-assign-items", { key: '90163b28bea1bf3023187a76825c85896f0af065', items: this.buildAssignableItems(), onBookingSelectionChange: e => (this.checkedItems = e.detail) })));
    }
    static get watchers() { return {
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '6870ec815738221e0f3dff51ad86c6f980ff4892', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f84c0a8f812e7970f0b9a7d6757c6d67a15c5836' }, index.h("div", { key: 'ce2ebede908b88d868edef2221eb7671fa86d3aa' }, index.h("div", { key: 'ff316db2f1fecfd728ad4a419b5b1188124bf700', class: 'extra-service-container' }, index.h("p", { key: '6a25a8a957253ed257ab1bfb0b80426899cdb984', class: "extra-service-description" }, this.description), index.h("div", { key: 'c7be8d734f5c17a49b7fd48b07e5443a2491327f', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: '4c551645cf984c44186f1151e6aa44dcaa01408b', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("wa-dropdown", { key: 'b5e0617d37c9835572b89cdf3a0597fe57f5dfce', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: '12bb2bbd1c20ce371463ae42e1e2088a229219d6', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.service.system_id}`, iconBtn: true, style: { marginBottom: '4px' }, variant: "neutral" }, index.h("wa-icon", { key: '0fc48f7e4f8f984d199c6f1d4e4bb8f718667e99', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), index.h("wa-dropdown-item", { key: '8f206cfdbe8ff5646dff793f42df9843cf33be65', value: "edit" }, "Edit"), agentMode && index.h("wa-dropdown-item", { key: 'abd2f3cc5981aa402cb8d9d0ed72d0fbad41000f', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), index.h("wa-dropdown-item", { key: 'bcc70709c79056e73e0f87b4bc8e216c15878781', value: "delete", variant: "danger" }, "Delete")))), index.h("div", { key: '01f118a54d5334e401c2323c7c1c35a64354d86f', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-assignment-toggle-dialog", { key: '846404eeb5377573304f4892e6527d613c96a048', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, index.h("span", { key: 'cc2190dcf617e7e390f2781cbdff75996f929627', slot: "message" }, "Re-assign ", this.description, " ", index.h("br", { key: '9e258d5b210b19204be24b314283450a8948353c' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", index.h("b", { key: '50c4a2eca6b399000a39eb68c18ad4152345efc3' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), index.h("ir-dialog", { key: 'fac2461fa275f6418785ef14d16d9a16b190a9fc', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'a90141df0ed34cbea03f591ad45ce68dcf1d3fdb', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'e7cd7f68bfdcf6003d5468d1bf78e6ab945e58be', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '4391abbe089cc7a9eb15c650f30d81c857fdd33c', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '978423f341c606696319ea94de194e62336371fe', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '83d0d80ddf01f8372e426f2c2f56e9cdb002467b', language: this.language ?? 'en', svcCategories: this.svcCategories, onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: '8871a8bb9a5aac1d2ba6efa2106f0770afc1cf2d', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'd9df47d3b04373e2e622aac27c96b199dfd9bd54', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '272262ae1766b55cfccb600e78c9d03b74328ef5', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: 'df05229a74f52a432129be2b31a8768fd6f42426', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (index.h("ir-validator", { key: '237e7a2d22ab5a814e99ea2768dc600c3c586b8e', value: this.s_service?.category, schema: utils.ExtraServiceSchema.shape.category }, index.h("wa-select", { key: '9574ab738c02a834fbe30b82eeb73f9c5c092f7c', size: "small", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), index.h("ir-validator", { key: '8612d944ef4030ed2883d0b03321ebb6f0a5efaf', id: "amenity description-validator", schema: utils.ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '8c5dcb947e679041fefd34eeaa70e7d579945d72', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: '41bfab7b4f2ec8a73db554ff26c90aa6da1a75c3', value: this.s_service?.start_date ?? null, schema: utils.ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: 'b598d67859438ea9e7ea5bcdd7f717fb77c32060', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: '3a65c02eb314e8fc79b3f52803151c6561ad5a0a', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'ad046c969ecf48c522a2fcf9ac63debc8e551b72', value: this.s_service?.price ?? null, schema: utils.ExtraServiceSchema.shape.price }, index.h("ir-input", { key: '526e61fa7e5add302bc690c8decca8eda0d64fe4', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales_store.locales.entries.Lcz_Price} (including tax)` }, index.h("span", { key: '19c290f91070dfbee1fc86ab197a8c0d59708063', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: 'a8c4306f11b53b910c302a42b581bd18f7e733d0', value: this.s_service?.cost ?? null, schema: utils.ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '25128b1096e74d84fa3e122a950ff88fb6c1e9fe', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales_store.locales.entries.Lcz_Cost} (optional)` }, index.h("span", { key: '95f5ac06d614d5464684d66785a89e62298b0c9f', slot: "start" }, this.booking.currency.symbol))), functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '14b6a53840ee029d473d6f778821eedcd2b76f08', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'a965d1ca83d71724be9e239a58eda8624980dfb6', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: '1f4d1aafd5b6783da7351252dff573d882fa1a4d', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '9d93c1c9ac9691a5925090d627c8e60456e8ea20', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'fe57d0313ee8d076db61ecf2bc103110b9964d33', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: 'be5880c0cdcc7f3151e4240a1ace262d7d65b0d2', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '884d2e41c9350d769e1578a25577c806c2724370' }, index.h("ir-drawer", { key: 'bd43254e3f701311ded1e804fe1ae695bd080112', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: 'dc99e431df48714848a16aa7484faebfb00022a8', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'daa239591b61fc6276c3ad5393987efd32f1822a', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: '54ab18630c900ad2da58c371e93c0098863bae75', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '2731fcef26e3e1f67ce98fe01fe274efc3d07b0b', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '4c0df8f4aecdae25c41f068b42f67c229094ec12', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '1c53c9f286a78eacd1801d38d95a3775e91213f7', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: 'feff28d67619ad4f5c4e3c109fe14bb3bc5d2a63', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: '9ac6d7419eaa145439e233ab51d3e9abd9ba0daf', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentDetails = class {
    ...
    render() {
        ...
        return [
            ...
            index.h("ir-booking-city-ledger", { booking: this.booking, language: this.language, currencySymbol: calendarData.calendar_data?.property?.currency?.symbol, svcCategories: this.svcCategories }),
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '3d23217a1e06f2e6b93dcb021679d8c5df1aa482', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '49b81f217cd572e7938276f11136406b3efb37a2', booking: this.booking, formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'ced15ded00b61691eafafb650582e6cd6f26f5bf', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '87e2adfc8d64a0c6fbe84c56750d769a753bece5', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: 'f97989c113aaef4c28b553a9bd5f6262d795cbba', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: 'be4f6d75b288a6ae4f05cee0ed352530497054d5', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: 'b24d54210b24c99d3e6d32fcae1c4d3ebb78c9df', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: 'f3f08a062ba1728388b35dc9d041c646b4351b84', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'dfee551700437388e8cd78b28a274caccff24622', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '55a5a9f2b67867825b1c4e2f69aee50d25d0cb5e', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: 'ee6aa7e1c8a45db9656df32f5e30f18ced38a930', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '72117e8c5e2eaffacf9f70c12e202f7549fdbdda', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '2ce5a44833e4f264bd7d8901c88ee2d584a3a639', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: 'dd6b821b2689d976b1ddf823e9116dc5f17ffb80', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '06bc04e721742c704c62977a9785bb987e4728ba', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: 'a676e689e6bc379be650960d5b7d845cb92acc70', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '9919f4f754f9ccddc728f457207a6744642392b0', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '5825beee03f2135a73adec0d2157c560ad52ad6f', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) })), functions.isAgentMode(this.booking) && this.hasUnassignedItems() && index.h("ir-service-assignee-select", { key: 'ef317ae51a3ac8ff73efc8dcdf7e52505a456aec', agent: this.booking.agent })));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '61e736ef12979842be950d8ed2641967b7e3b3fe', class: "payment-item__payment-item" }, index.h("div", { key: 'aacd7d7df99f1507cf09d53f9c7028afa2ea0b71', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: 'e002e3842f2cec612d25b3e6dabe322d72c12da7', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: 'a13ae3088516f9481d986203378ed22154981187', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '1767c44af3168052d47c1a47859d1209ea047f80', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'd93a9a0afff2de701dbaf7479050a93aaed59b08', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '97c11cca106a70c5a79d70e45bb67a33cbd8295d', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: 'ed3263b2cf2c27d07a712fba13ad310252590b7e', class: "payment-item__payment-toolbar" }, index.h("p", { key: 'fd79f6a4b08bf49c4d229af38d8ea872b8f4ea55', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'bb48ff8118e65ed0e584da1f0dbb09edf1ec906a', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: 'cf4b9eeab540b9951d804f9b1619ef49c7dfc160', class: "payment-item__payment-actions" }, index.h("div", { key: 'c0ddd1bfe4767f22e8ee0e7f448967e0ffce5405', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: 'a50999dbee92c35ef35989d250d95b8c5a86213f', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: 'a328980cca7b8fbfe973a56ee2008bac942bfddf', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'e22995d2b80535fc1ef82844eaec809223ba35ae', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: '427ed53d0b2df0fbb7bd486cf4ace70dc8f3786f', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'd2931025ca71bee3d6e92d71fa1a628dd86989a7', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: '7d48f4b4ecee5beba1d8e1da8d0ea04643b1a73d', value: "receipt" }, index.h("wa-icon", { key: 'ad112c0c88fc5dd8426bb11a4ba255decca8debf', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: 'd70f287d9e02fec8db5cda773dab286388d1db95', value: "edit" }, index.h("wa-icon", { key: 'ad270d25ae97a3f770b0fdf0b53af55e34731008', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: 'd0e3a49a58cef6d2087ff84c7e659a716e4d5b92', value: "delete", variant: "danger" }, index.h("wa-icon", { key: 'b1f0810cab63e4858c9c8dbd29d4f5ac6ee54e0c', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: '4ebb56799e13a60bb00479b1c508a326fe7a816d', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '535b467cc800080b29b0678e240328348a703482', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '203c988eeefa60176fb67f1b66cee2373b54e5d1', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '1c5fa96af2b3620a22f61638896aa40498a8323d' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '29a79ae2d2baa01a2215757cab9198ed80c135e4', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '8a5b03ebe59eee47e08ca629d57ad0fed21fcc4d' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '412acb8c0f7acc2a6bb76211054fc1ba506d981f', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '0ba13917c748a617ad00c7fcf04350ecce31c10f', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '9e996d6e3a599888f41f6a00991c3b09e114ab98' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: 'a9093e5cebadb0ee38121aa52634a78a38cdf552' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '80db111485bd30a203917ae5949489985e636beb', class: " payments-container" }, index.h("div", { key: '35b345100799a20778dde72b2d9646765c99dc00', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '43e90a812722f2ac2483a7fe896cb51f9f1f0bef', class: "font-size-large p-0 m-0" }, "Folio"), index.h(HelpDocButton, { key: 'd78340a254512e07ca9fcfc7f3c28eea061cbe49', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: 'b136f644b73a34b4e6f2d0f547addb64d67f2104', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '5024554ded8f6e3b9d3363112d5e04b537e6d570', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '5d843458301b941276974dd1490d9381210c6ff9', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'a4996b82abe437b1e5967bc7b605681dd8fd9a0a', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '78c87bd161777e99ba05aecc37a964221fd7d5f6', booking: this.booking, onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '8b162f256102619fb67e704b0b358f7a1f19d049', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'a3f1e0969a7dc175087f913afc6b4709b9a3b335', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: 'a7284c46cdda97796ab2f86e1af661b40095614f', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: 'efacc1b2861d8da299be771cc3ca2b66217687e9', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '21a621f34b13996a173e9645fc785e9c8cae6ba1', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '563ba7e19ee974f12f53d7a1792977718569b6f8', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '61e93a05d9203c8fd3393550b5a9f01c6b411606', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: 'ae23f74dec121bb17b97ecf8f56b8f62d25b7d59', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '373f6bcfdc67d4f61539471fe0e31548471cf78e', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: '6e7742ffe839d92a93e72d6cd044d27cb40ce9ce', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: 'ec70d4af836002f518ed3fc08d995d7bfdfc16ef', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '48f57c4f1baee803c48c5e1d44797e4febd2f2fe', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '4a94200db0ef4604a4d76eda5cd834fffe7826da', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '621c7316caddad20d125f25d56329759f5bfc164', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'b6b1f92f99daa9509832e6ccf6ae3c0ab7127dff', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'c88a4bbae88163bc7d7af6338c448d2ca2a37623', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: '87294ca24172c24821693fe4d80de3320959b014', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '4528bf49fecfa9fe2aea01e23bea779b5ed9e903', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: 'f3b43cf8b82a05274f0ea860521f1ed34d567863', mask: 'price', label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, index.h("span", { key: '937d83433a0c0f2f4d5cfb1086dfc30b4e25d18e', slot: "start" }, this.pickupData.currency?.symbol)), functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '3f0131b1b2653ef1841048810bda87ae14ed5909', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.assignee = e.detail;
            } }))))));
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '96229e47fa571fea5c91f58bc335b19f9192e9f1' }, index.h("div", { key: 'dae7fbdc8f34fa83c7af45241e22e86f596792ca', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: 'd843dc9bb6c421b899a67da81702bfdcba6b393b', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '62c155d43e0524e52a68036b00041cd9d2d71185', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '565fee8d5ea808ba730886f1fe66dba0f240746b', class: "reservation-information__row" }, index.h("ir-label", { key: '00b6b5620d79acafa78ee4478ab8239a97c6d265', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: '5e273aead8c0daaf46afdce1800882ac7a14bf1e', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '84ad6c179a81e0730da61034e31cd2955a56c993', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: 'a4832ef6021605e88900af0e5f070aa14214be93', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: 'ef06ad982e08872ea3767eba4000bd2c5704feff' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '8b9895993d2a36d9b5a243bc0ca999361f9f8843', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '3e8ce9cc60df3950560e5269e2915034dac9b0f6', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '5db1a324b11ff7ce39346a5828152f786293565e', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '261ec7bc86257cdbc516dd077dae66f3a47565ac', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), !this.booking.agent && (index.h("div", { key: '70fcb291184574534211fc1816d5145743d266b5', class: "reservation-information__row" }, index.h("ir-label", { key: '89b6dff255046ef729e0e0e832c4c8e9217eeaaa', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '957054a9ffb54008e316756a20e51b706cb99c0c', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '7683fbf11fdce70165c78c573d6344bcd977a5c8', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'ff5981327a36809808b46037c447be908446102f', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } })))), this.booking.guest.mobile && index.h("ir-label", { key: 'bf2f3bbd4368432f9affbd274badb0ca0158da1a', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '9769b7c34ccc964379cfb1060252e9ca09ae56e1', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '951fb6628660a747ce78bfdb3d6807d85ac99b44', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '19078bbc108bd9b38be164b80524a6e3cc3923e8', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'a4b609fe8446dbb8f5000157b9cf5c5c8dbfa59a', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '12ca5b9b3a06b4190898b0ea5b846ea42ebf2d96', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && (index.h("div", { key: '515cd7e9b4d6b68939269f4b99b17eadcfd25403', class: "reservation-information__row" }, index.h("ir-label", { key: '685fe2928da0f46ab6c3eb7fb823d1f5d500dada', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, display: "flex", content: this.booking.arrival.description }), index.h("wa-tooltip", { key: '49c69180907965f72a1809326e260b9a2b68f758', for: `edit_arrival_time` }, "Edit arrival time"), index.h("ir-custom-button", { key: '063e628b92199023243f8521100daffa9d8c8a98', iconBtn: true, id: `edit_arrival_time`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irArrivalTimeDialogRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '75e1284447d4036fd686dd978b20833590b04116', name: "edit", label: "Edit arrival time", style: { fontSize: '1rem' } })))), this.booking.promo_key && index.h("ir-label", { key: 'bd43dce9113d12d5e55d0c24944308b253ecf235', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '99f56f9aa413070a6f19ef574ebd945e7469e885', class: "d-flex align-items-center" }, index.h("svg", { key: '4a1b9a5a4f44217cd13aa9f1d18e67236b08044d', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '6750c30590b682560a4e54c83b0a46ac1a14d202', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'df99c836c1c1b931b2272255dabfa643ce0fba27', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '1e643dffe0797ef44a3d1319d06d193be156eb25', class: "reservation-information__row" }, index.h("ir-label", { key: 'ce9ae80d2830a24a1e572c5d85ea5abc8be7a259', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: 'b6bdd3bd18ebad3f23d44078b6c96832a8bbbdc9', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '33141a99ff26d4c77fd588279ae5863fc9a10146', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '1f14488d3d90c22127b189846cbcbae477dc07ae', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: 'a1752a6be8acf540195b918dcc150557e48f118a', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: '4008a5d3dd683c68720589e5b7c98e852a4f94b7', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) })), index.h("ir-arrival-time-dialog", { key: '0ab6604154774f268d98e758edaba6790577dd8b', booking: this.booking, arrivalTime: this.arrivalTime, ref: el => (this.irArrivalTimeDialogRef = el) })));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b0d136eee7e9121075d8b24a7381855e8436642c' }, index.h("div", { key: '71b26b7e5e13d4151d04eec1551abeba0e73ea80', class: "booking-room__header-row" }, index.h("button", { key: '36f48ec2d08f2e53cf4ed51ab85420bca129fce1', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'a43521ba69938d12fd5dc932e98ee84c4ac71478', name: "chevron-right" })), index.h("div", { key: '475db70fb27983883dd75edd135027e879048b9c', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '2d0f5f9ab044e284c3bcc450725d6c73198e569a',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '3c00b267114c9632d5fe8bbd91b91a87fe588d04', class: "booking-room__summary-row" }, index.h("p", { key: 'bca9816aa87e36b34e25f197af506f9b76ba8a3d', class: "booking-room__summary-text" }, index.h("span", { key: 'df19f41220505c42266ff34e7c4a558762404f6b', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'e65f969271a1dffabf76b3f2365ff78c184c0244', class: "booking-room__price-row" }, index.h("span", { key: 'bb06e22aefb3675f998a431c43225e2900f7612d', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (index.h("div", { key: 'd16c5f35e90f55e9db33758a98214f12f5dc05f4', class: "booking-room__actions" }, index.h("wa-dropdown", { key: '187a7a30ee5d757dad24ab5d64470fa6d06d0ed0', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: 'ab6b1f6b041ec13664a4d3752165385fec118dda', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, index.h("wa-icon", { key: '83fc4238629d70d22e46ba34a4d1173aae941343', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && index.h("wa-dropdown-item", { key: '5760679aa6976c9ea85c2f80c6c217c8e6af22c8', value: "edit" }, "Edit"), functions.isAgentMode(this.booking) && index.h("wa-dropdown-item", { key: 'c933eda9ae8be388babf32dc52a4d6a873e70a47', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (index.h("wa-dropdown-item", { key: 'bc8a0cac9592b47f453eb5a2ccdd14b27d97e658', value: "delete", variant: "danger" }, "Delete"))))))), index.h("div", { key: 'c52d5bdbb764ad28a3bd173e9db28b4fc3014be3', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: 'f5ae5c43b59229681dc33b3677c1a992ab33e466', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: 'a8489ddfeb3f49d604fca1451d58576058ab1e2c', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: 'e2f61ca77c9a1eb65de1595a39c619ce82508fe8', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: 'f8498678ed6df2d1674ed70d909975f901dc1316', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: 'd2f0320085ec5b58d9dd83a61420c7f65d352c56', class: "booking-room__guest-row" }, index.h("p", { key: 'ea32d6f36af1169d363bc78e66f1e7c2fd0decef', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '7a97a066933679bf07d262ad9ac23c577acca0c7', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: 'edaca66b9b810c9447c3722574b7152738b6e737', class: "booking-room__departure-row" }, index.h("p", { key: 'f0d932911c9d82a8e9edacf08d05d1b9fc5ba74f', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: '40dace58d20acf9be42fe0bfad273ef2b0c3496e', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: '59de3fb92053c5b68c4904f955a7fc3505ee056f', class: "booking-room__details-container" }, index.h("div", { key: '14272a9bf9d9c42326d5fd28833886c83ffd92c1', class: "booking-room__breakdown-row" }, index.h("div", { key: '126b2028f50e40723bdd17683f7117a341190d0a', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: 'cbe812cafaba97091a4bd6c76b4020a6977f9ab7', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '0333b195a974198b1f199ac1b2bba2f72ed780cc', class: "booking-room__breakdown-table" }, index.h("table", { key: 'b8fe700961730bf27f071b75a940eb97efba7df8' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'd3dfbe4cd8124d92c4ae507f93b605e0598db926', class: '' }, index.h("th", { key: '2f2d0f3d43071d7232ada8a26b7dbe24f829fc39', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'ba9e419ad4d75b8fb77fe21eb5b9c400ada7839b', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '9b4e5f8421fb655b8d3d25527581eafd156d547e', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: 'cf062777bfdfb0ecdb14903bb4020c2676b4e9e2', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'ee0314eeced10d7682822cfe1fdea40942b0b615' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '30de4467dd87eb48db680958edf03aa1da20803d', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '591fcb54ce955bab8a87af1cc6fad31905ac276d', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '4c39024a6bd75496d6eaf07de333b17b9c0d8a0a' }, index.h("ir-label", { key: '3bb63b96004968c1d6b8e71c7075752c765b827f', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'df6a2a092b3ad4141bb8d24ebea8dcb6cc053952', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-assignment-toggle-dialog", { key: '0794d4e699c3d8945932783c69b52f1b6208912c', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, index.h("span", { key: '1955951c8712d64a1cd1ae1223c063cfb20d21fc', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', index.h("b", { key: 'db4f43d0ee3b012116ce3ae4658648da9d1773e3' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), index.h("ir-dialog", { key: '96f9d3e86c489267c806313346a4872b37f44c5c', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '1848bbbbdcb098c3aaf3c66612082ec412e77fc0' }, this.renderModalMessage()), index.h("div", { key: 'b3c81509c68973d7de618afb9a66f2bef5bad2b4', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '1032b54b813e9a144bf3ee57eb5e4447961523d1', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'b20c90ece63fc7c4d65ce69d95dcc365c351f187', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: 'c23c09af3e061c29a3b2a65fe5db9a145db56617', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '8404fa36acdeedf8f9ecf4a8bfbf4a408850e653', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: '67189f9b8de80ca78b90a4b78febc0ab4c4df2c6', style: {
            ...
            } })), index.h("div", { key: 'e3042409497a3eff52945557c353960bd3a28394', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '4bacb328fb517a8c3cbd97943920fba7f6ee8b9f', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: 'f2eccdcc879f6860939a259a3ff35cb265f7adea', value: "save", loading: this.isLoading === 'save', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: '1049a2159da0cb3359134240dfed75309fd9992e', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
