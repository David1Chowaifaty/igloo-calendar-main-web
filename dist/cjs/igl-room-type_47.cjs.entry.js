...
const utils$1 = require('./utils-a558c471.js');
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cf2bff2462da8412636ee8974b755e439255c6ab' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("h5", { key: '14f30a282a18129c928f50f8b826fb9c9482a1e5', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '8a11e43a1c1db4c6caff980f95c1cdf0020463ee', label: "Edit Arrival Time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-select", { key: '83d3cea91ccaa57227cef605748a6153c23008c1', size: "small", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), index.h("div", { key: 'f9eae96e2e537270a31e35523fc755f894f8d146', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '3c6c7f610874adc8fdf0b9cab7f682979b2f7387', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '661db7e9254ce9ecacb0859521fdba8983c99f07', size: "medium", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrAssignmentToggleDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'defab566d434309931e10365e985acdbfd12ee59' }, index.h("ir-dialog", { key: '1af0491ab49a51f81557b37d8568464fa787777b', label: this.label, lightDismiss: false, ref: el => (this.dialogRef = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            } }, index.h("p", { key: '372927ee7beab834f04dd09d8854e051bb5f48b1', class: "assignment-toggle-dialog__message" }, index.h("slot", { key: '93523191a5bfb57cf07437a0baf2075391370397', name: "message" }, this.message)), index.h("div", { key: '8450ae58bdd5df410b669646c690c65784677fe4', slot: "footer", class: "assignment-toggle-dialog__footer" }, index.h("ir-custom-button", { key: '07957afe2aa6123098d410a77c58ce070959f1c5', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close", disabled: this.loading }, this.cancelLabel), index.h("ir-custom-button", { key: '652dc35b199e088eca671fd4314398c4171b17e1', variant: "brand", size: "medium", loading: this.loading, onClickHandler: () => this.confirmToggle.emit() }, this.confirmLabel)))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: 'c6306cde658197e4f4ae3a11daf337d56376a3c4', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: '7324b430dbda3da28bdb5c6da1e00cf9ac7fad27', booking: this.booking })));
    }
};
...
const IrBookingAssignItems = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5a1712748699ee21130dd711374939db1a541daf', size: "small" }, index.h("div", { key: '4ede319e9dfbef25422fd23f4768381f89204200', class: "assign-container" }, index.h("p", { key: '3fbb808e799e77a400c23558e84215cb022c43ae', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (index.h("div", { key: '40de85fe3df1554474babb293a464980b524cd68', class: "assign-section" }, index.h("p", { key: '3a13246992ede71939f134136ae5d90edffb6544', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (index.h("div", { key: '1e47ed9cf642bb154dbb57a367015af4582c0ec9', class: "assign-section" }, index.h("p", { key: '08bc525d0cf2bc3b0335fea884b14c6e79232a8f', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (index.h("div", { key: '1641e8ea89a0ef360c6fbefb1bd91cdfc3031679', class: "assign-section" }, index.h("p", { key: 'a9df0aaf9656e374666cecb5c5cf4fb920cbc58b', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
};
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '09dd755239849af1d3a1225c30f5dbb8208df1f5', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (index.h("ir-booking-editor", { key: '10f97004ad0ce7ec1aebbf6d22d7c532dccacba4', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), index.h("div", { key: '9a41188ceb17b6fb7ca9747d6d5b28c4bc556984', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
...
const IrBookingEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'ea0f53319575e20fa6d54d3179e9278fc66c5ce6', class: "booking-editor__guest-form", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                this.doReservation.emit(submitter?.value);
            } }, index.h("div", { key: 'c536b9e6adc7c48eb446fe2fc619e5f187a8c3ea', class: "booking-editor__header" }, index.h("ir-date-view", { key: '6d03dcbfaecafc8d64c3efab722ff81b407f21f5', class: "booking-editor__dates mr-1 flex-fill font-weight-bold font-medium-1", from_date: dates.checkIn, to_date: dates.checkOut, dateOption: "DD MMM YYYY" }), this.totalRooms > 1 && (index.h("div", { key: 'd48072350aa429382ce729d38d098f5acca4a89a', class: "booking-editor__total mt-1 mt-md-0 text-right" }, index.h("span", { key: 'cc71a86af459e824796f2397c1e4c6dfeffa124d', class: "booking-editor__total-label" }, locales_store.locales.entries.Lcz_TotalPrice), ' ', index.h("span", { key: '4dda6baffd571f9c7a7ffb902215d1c8f3e54358', class: "booking-editor__total-amount font-weight-bold font-medium-1" }, utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.totalCost))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
            ...
            }, variant: "brand" }, "Clear user"))))), index.h("ir-booking-editor-guest-form", { key: '626c88a57f811d16a719621848ad2b7eb7aee2ea' }))), this.bookingEditorService.isEventType(['SPLIT_BOOKING', 'ADD_ROOM']) && functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '7824dbc5e881837acdc56f573f5be785d92d38b1', style: { maxWidth: '500px' }, agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrBookingEditorGuestForm = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2cd6575579e74749e747b2f4af16ddf5d33bd0f8' }, index.h("section", { key: '24bdc0d6877c47b0c67c0098ef8127c175d6153a', class: "booking-editor__form-control" }, index.h("ir-input", { key: '45340733bc190cabab01a1bfcc8bf45bab8d8446', label: "Email address", "onText-change": e => booking_service.updateBookedByGuest({ email: e.detail }), mask: 'email', value: bookedByGuest.email, defaultValue: bookedByGuest.email, placeholder: "Email (leave empty if not available)" }), index.h("div", { key: 'ca5c1059e838a4d68b6909453dab13d5ce29e6c0', class: "booking-editor__guest-name-group", id: "booking-editor-guest-name-group" }, index.h("ir-validator", { key: '9114bc079d78b65c84dc7a72dec0a9f56935d191', class: "booking-editor__guest-input-validator", value: bookedByGuest.firstName, schema: BookedByGuestSchema.shape.firstName }, index.h("ir-input", { key: 'c78db6e52c3b606c4090887340cea513d6a0cf4d', id: "booking-editor-guest-first-name", class: "booking-editor__guest-input --first-name",
            // label="Name"
            value: bookedByGuest.firstName, defaultValue: bookedByGuest.firstName, placeholder: "First name", autocomplete: "off", "onText-change": e => booking_service.updateBookedByGuest({ firstName: e.detail }) }, index.h("p", { key: '797ff3fd9db258789726741bdb82d6a16dea1328', style: { margin: '0', marginBottom: '0.5rem' }, slot: "label" }, index.h("span", { key: 'cb7c4e5a4a43161f027713aed21241a662c570bc', class: "booking-editor__guest-input-label --first-name-pc-label" }, "Name"), index.h("span", { key: 'adbfe8c141e90b36df36973c7ab50673ec7045bd', class: "booking-editor__guest-input-label --first-name-mobile-label" }, "First name")))), index.h("ir-validator", { key: 'c5f33bc69830ccc98f9385d0ff373eca13aeabcb', class: "booking-editor__guest-input-validator", value: bookedByGuest.lastName, schema: BookedByGuestSchema.shape.lastName }, index.h("ir-input", { key: 'a476291f7a890df123d0c68fa633666750a915ff', id: "booking-editor-guest-last-name", class: "booking-editor__guest-input --last-name", label: "Last name", "onText-change": e => booking_service.updateBookedByGuest({ lastName: e.detail }), value: bookedByGuest.lastName, defaultValue: bookedByGuest.lastName, placeholder: "Last name", autocomplete: "off" }))), booking_service.booking_store.bookingDraft.agent ? (index.h("ir-input", { label: "Booking code", placeholder: "", value: bookedByGuest.bookingCode, defaultValue: bookedByGuest.bookingCode, "onText-change": e => booking_service.updateBookedByGuest({ bookingCode: e.detail }) })) : (index.h("ir-input", { label: "Company name", placeholder: "Company name", value: bookedByGuest.company, defaultValue: bookedByGuest.company, "onText-change": e => booking_service.updateBookedByGuest({ company: e.detail }) })), index.h("ir-country-picker", { key: '7b9fae5b2669ac82e27fe8eccbeb61e5284b0199', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.updateCountry(e), countries: selects.countries, country: selects.countries.find(c => c.id.toString() === bookedByGuest.countryId?.toString()) }), index.h("ir-mobile-input", { key: '75dad719cfe62ce1a4a5163eef9d903a08efe1a3', size: "small", "onMobile-input-change": e => {
                booking_service.updateBookedByGuest({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => booking_service.updateBookedByGuest({ phone_prefix: e.detail.phone_prefix }), value: bookedByGuest.mobile, countryCode: selects.countries.find(c => c.phone_prefix === bookedByGuest.phone_prefix)?.code, countries: selects.countries }), index.h("wa-select", { key: '6da19711ff9ca025d786ea8ddf9e005b841b98d8', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", id: v4.v4(), defaultValue: selects.arrivalTime[0].CODE_NAME, value: bookedByGuest.selectedArrivalTime, onchange: event => booking_service.updateBookedByGuest({ selectedArrivalTime: event.target.value }) }, selects.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: bookedByGuest.selectedArrivalTime === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("section", { key: '30521fcde0b401f97e9a1aac5954ea6d5beb4730', class: 'booking-editor__form-control' }, index.h("wa-textarea", { key: '8fc3c470c81ea5ef41911a739ad8b0a21bc415f3', onchange: event => booking_service.updateBookedByGuest({ note: event.target.value }), size: "small", value: bookedByGuest.note, defaultValue: bookedByGuest.note, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 3 }), (!agent || agent?.payment_mode?.code === '002') && (index.h(index.Fragment, { key: 'ea72ecf86caa15041e79c57426eaef0d2a9f7b5f' }, this.paymentMethods.length > 1 && (index.h("wa-select", { key: 'c47c2561a16a9ffed30e4cb4c9f14bb6e43bab71', label: 'Payment Method', size: "small", defaultValue: booking_service.booking_store?.selectedPaymentMethod?.code ?? this.paymentMethods[0].code, value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: 'ff763d8fa5a97c70225beb9c7089dfc613d773f4' }, index.h("ir-input", { key: 'fb662ec6e99936b2693f814a71fc2e964ee8e08b', value: bookedByGuest.cardNumber, defaultValue: bookedByGuest.cardNumber, "onText-change": e => booking_service.updateBookedByGuest({ cardNumber: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: '19f23adebcd2df0e42122d4ebf5f1e252055065c', value: bookedByGuest.cardHolderName, defaultValue: bookedByGuest.cardHolderName, "onText-change": e => booking_service.updateBookedByGuest({ cardHolderName: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: '43421cd4fbed396e182a5a2264764acd418f6b23', "onText-change": e => {
                const [month, year] = e.detail.split('/');
                booking_service.updateBookedByGuest({
                    expiryMonth: month,
                    expiryYear: year,
                });
            }, value: this.expiryDate, mask: this.expiryDateMask, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h(index.Fragment, { key: '453c4a1e7540864a235d982c1ddcb73c1a787381' }, index.h("style", { key: '7018945c52889526ab4a26a14c9af5642cb6f495' }, `p{
              margin:0;
              padding:0}`), index.h("div", { key: '8ec796e2828ba6c571b2e69bcf88ae3f8f5ed688', class: "booking-editor__payment-info-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description }))), index.h("wa-checkbox", { key: 'a42f393efaddab46bff6136452557a8c79b0ccdc', defaultChecked: bookedByGuest.emailGuest, checked: bookedByGuest.emailGuest, onchange: event => booking_service.updateBookedByGuest({ emailGuest: event.target.checked }) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
...
const IrBookingEditorHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd411c89141f8eea123c7e6f803e28acff45a77a9' }, index.h("form", { key: 'f2b272e8ba646c41ea6912f6430bc683e4b6c183', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (index.h("ir-validator", { key: 'e2f22f0e222954a9a5c692424d0c1d41d5d6b79f', value: booking_service.booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, index.h("ir-picker", { key: '74f031c5a4ae79dfd6842baedc6f65b8ab9e25be', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales_store.locales.entries.Lcz_Tobooking}#`,
        ...
        })))), index.h("div", { key: 'e179f874c40362bcc0d9c7912f77fcad3a9fe8b6', class: "booking-editor-header__container" }, !this.bookingEditorService.isEventType(['EDIT_BOOKING', 'ADD_ROOM', 'SPLIT_BOOKING']) && (index.h("wa-select", { key: 'dd63b2782b28fcf31e7cb5890d86bac128354da1', size: "small", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_service.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_service.booking_store.bookingDraft.source?.id, "onwa-hide": this.stopEvent.bind(this), onchange: this.handleSourceChange.bind(this) }, sources.map(option => (option.type === 'LABEL' ? index.h("small", null, option.description) : index.h("wa-option", { value: option.id?.toString() }, option.description))))), index.h("ir-validator", { key: 'c8d2eefdb881a3904f02e2fb31e7db4838d24d80', class: "booking-editor__date-validator", showErrorMessage: true, value: booking_service.booking_store.bookingDraft.dates, schema: this.datesSchema, style: { position: 'relative' } }, index.h("ir-date-range", { key: '2eccde3ab1bca02eb1a215146b79142de06f9a13', class: "booking-editor__date-range", defaultData: {
                fromDate: checkIn?.format('YYYY-MM-DD') ?? '',
                toDate: checkOut?.format('YYYY-MM-DD') ?? '',
            }, variant: "booking", withDateDifference: true, minDate: this.minDate, maxDate: this.maxDate, onDateRangeChange: this.handleDateRangeChange.bind(this) })), !this.bookingEditorService.isEventType('EDIT_BOOKING') && (index.h(index.Fragment, { key: '5af09979bf200c2b3d70a98fd0df4f69320a0a4b' }, index.h("ir-validator", { key: '16c2aad35bdc0b7ba121bfafd1c347a56f782f6d', value: adults, schema: this.adultsSchema }, index.h("wa-select", { key: '18ca7467ff40ac29964bee5f4cf13efc4b382d1a', class: "booking-editor-header__adults-select", size: "small", placeholder: locales_store.locales.entries.Lcz_AdultsCaption, value: adults?.toString(), defaultValue: adults?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleAdultsChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.adult_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))), calendarData.calendar_data.property.adult_child_constraints.child_max_nbr > 0 && (index.h("wa-select", { key: '5671d592ac9d90544cc47f7473306e6470d3c65b', class: "booking-editor-header__children-select", size: "small", placeholder: this.childrenSelectPlaceholder, value: children?.toString(), defaultValue: children?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleChildrenChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.child_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))))), index.h("ir-custom-button", { key: '67ebddb77a09b5a1ddd4c565095b889ebf696e4e', loading: this.isLoading, type: "submit", variant: "brand" }, "Check")), booking_service.booking_store.roomTypes?.length > 0 && !this.isLoading && (index.h("wa-callout", { key: '083b3d3853bcdbf948411280efcf3a56bfab734b', size: "small", variant: "neutral", appearance: "filled", class: "booking-editor-header__tax_statement" }, calendarData.calendar_data.tax_statement)))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"],
        "mode": ["handleModeChange"]
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '44740d4a71045b8970fe0c6c9edb1545fd7af3c9', label: "Private Note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '1abd53364ab4fa7f560b0babc0de8aa4f5be7b30', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: 'd5d98f5d00faa6d396a972acfd43b08ac539fef3', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '4c711ff3532863106577c072b1229768cbaf5545', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '262e8d7b993eeb4e4715d56526f8a2a54f1007e4', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'edd079b4f2b8000bd8d5d4de6d5d78e945f0fa5b', class: "booking-header" }, index.h("div", { key: '663e14efb34bb372e5e674c4256b1ff3d5d0f319', class: "booking-header__row" }, index.h("div", { key: '3d37438222867502a8233ea1980e6798c76d844e', class: "booking-header__info" }, index.h("div", { key: '8abafb09b0f4f5c9281b45435b708838aacabee6', class: "booking-header__title" }, index.h("div", { key: '38cfff1e8024a03f343c76f0df46422a1312f3d1', class: "booking-header__label-container" }, this.hasMenu && (index.h(index.Fragment, { key: '1a0869cc686c4a40bc702fb30ff0797884896bec' }, index.h("wa-tooltip", { key: '1810e34519f6cad8370c8942b98f9d4e73b98a2a', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: 'c4ee3ff580e1eea344346e9c70c92ae423c08f0d', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'd1f035e5f587468f5338fd35b469b3ff9cb863df', name: "arrow-left", style: { fontSize: '1.2rem' }, label: "Go back" })))), index.h("wa-avatar", { key: '31d9241c7773c0984054bbed25e9d44ff8872c69', shape: "circle", initials: this.initials, image: this.avatarImage, loading: "lazy" }), index.h("div", { key: '6bf5a249c9b520ecde3540fd60ba0027d7baef34', class: "booking-header__identity" }, index.h("div", { key: '0d391d5c76165f1017065f9e9c94566c2345a495', class: 'booking-header__label' }, index.h("h4", { key: '1b0a14985fd953e40af55366fc1efc656c9f5581', class: "booking-header__label-number" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`)), index.h("div", { key: '9ca7cf64da5207522e43634d72b0aa42e4eba0f4', class: "booking-header__meta" }, index.h("p", { key: '4f8a7d4dbaec12cbf7ce0081c7d55a4cf3954d14', class: "booking-header__channel-number" }, this.booking?.agent ? (index.h("span", null, "Agent:", ' ', index.h("p", { class: 'truncate p-0 m-0', style: { maxWidth: '100px', display: 'inline-flex' } }, this.booking.agent.name))) : (this.booking.origin.Label)), !this.booking.is_direct && index.h("p", { key: 'af00e73712c0da344499ae148c0b7f03c6ecca63', class: "booking-header__channel-number" }, this.booking.channel_booking_nbr), index.h("ir-custom-button", { key: '6c0e6c61c7c9ad544512e3481cbfdff766987765', link: true, onClickHandler: () => this.bookingSourceEditor.openDialog() }, "Change source"), lastManipulation && (index.h(index.Fragment, { key: '237634c93c8ba1c2027131f01be2738b28340bbf' }, index.h("p", { key: '4f5db5512616dee357e9e2eeee04555e517f8ebc', id: `booking-${this.booking.booking_nbr}-modified`, class: "booking-header__modified" }, "Modified"), index.h("wa-tooltip", { key: '78f2b821ee5b3522385d7126522c24644de0010d', for: `booking-${this.booking.booking_nbr}-modified` }, index.h("div", { key: '3c9d9b35d78d432e887386a28adaa402a797d0fc' }, index.h("p", { key: 'e2d59cd8b9f5e5daf62728da9edee28c365daf6d', class: "m-0" }, "Modified by ", lastManipulation?.user, " at ", lastManipulation?.date, " ", lastManipulation?.hour, ":", lastManipulation?.minute, "."), index.h("p", { key: 'c5ca3c59c18575fb589a13b0d2d3fd48a676d7cc', class: "m-0" }, this.alertMessage)))))))))), index.h("div", { key: '65c85794447d29806745e5212c3062b81a767066', class: "booking-header__actions" }, index.h("div", { key: '66157885a4d9120df50121ef3ac657c28fbc9c71' }, this.booking.allowed_actions.length > 0 && this.booking.is_editable ? (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            appearance: 'outlined', size: "small", variant: "brand", class: "booking-header__status-trigger" }, index.h("ir-booking-status-tag", { slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", null, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))) : (index.h("ir-booking-status-tag", { status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }))), functions.isAgentMode(this.booking) && (index.h(index.Fragment, { key: '1c4324cf2f2add90c66a5ad87d3f74157dc80e21' }, index.h("ir-custom-button", { key: '36235d1041d9bdbcfe9f28ae0554950b13524c67', onClickHandler: e => {
            ...
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "warning" }, "Force city ledger"), index.h("ir-custom-button", { key: '5b67ed85f6641b43f8050b6533dd5df8e54c3686', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.invoiceDialogRef.openModal();
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Invoice to agent"))), index.h("ir-custom-button", { key: '131b3a51d80eb111b1f048748b5e58eadb02aea3', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Logs"), showPms && (index.h("ir-custom-button", { key: '555c7185c7bfa0bcd499db0facd6293456734b63', class: "booking-header__stretched-btn", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: '4712dd80e79b047a3e1f6c1d294d6bee097dbd58' }, index.h("ir-custom-button", { key: 'e92d8e852b03fd169e0bab477e9b66f509da3e47', class: "booking-header__stretched-btn", id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '853a05691a0e0b80c887f1baef9ea0f74888108d' }, index.h("wa-tooltip", { key: '1880d72615304bd1a234a293de03daedb9ed0871', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '50b219c67fc0c0742ebaff08c9957d4aa0f7cb34', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '88262957c0f28f76d5d1d583253fb6218775f0fc', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '39ddc4c686ff6829ada472b9aca0830c85464313' }, index.h("wa-tooltip", { key: '5379fffb8df72dc2852c81e33d91dbf75f68fd75', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '80b5df28822a22b4f0d0c6a022c2f2e8d4db1ee2', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '60f28c534d21527aea13c6259313e47e58969bfd', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: 'b971ce37063c338d99043ee523cef26f41db26bd' }, index.h("wa-tooltip", { key: 'db3c22dfaf604ef436abdafadcc750ef95c53325', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '8e192e460c81f2810ce482f378dbcafe50a360e7', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '17d718fe645cde411f5af91cbc2857534c1e9d39', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: 'e1e1009889495771b7933f32616d39eee28dd59f', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '1dcd1035a57619da5f752d18fc4404ea24bce554', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '0e0fb2647e56b30326e30553bdb51655a36a5221', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '5315886f6d66a831663d352bd72c52e6811afcab', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: 'ef1ba29a91e6a3e2d340af46a446b46f9fc5227b' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'afdfd58652c5346d5ec0d179b0aa363e719f630f', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: 'c1b8f589593018ce53d3400f98ac3b8667b531ac', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: 'c70e864aa551213db0cfa2440ed08bbc4b8e6bc3', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
            }, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status') }, locales_store.locales?.entries?.Lcz_Confirm))), index.h("ir-booking-source-editor-dialog", { key: '2610d9c9e9ed0ff7106c8018514d60cf57ebb94f', booking: this.booking, ref: el => (this.bookingSourceEditor = el) }), index.h("ir-cl-invoice-dialog", { key: 'd26b811752137955b4413e8203c8f698a8235976', mode: "booking", agentId: this.booking.agent?.id, bookingNbr: +this.booking.booking_nbr, startDate: this.booking.from_date, endDate: this.booking.to_date, currencyId: calendarData.calendar_data.property.currency.id, ref: el => (this.invoiceDialogRef = el) })));
    }
};
...
const IrBookingSourceEditorDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '7e49ab9575d615fce538df455d7365dc51fc8d5e', label: "Change Booking Source", onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, open: this.open }, this.open && (index.h("ir-booking-source-editor-form", { key: 'd8625b047ee881e4fc514c68a991e22fe6334f09', booking: this.booking, onBookingSourceSaved: () => {
                this.closeDialog();
                setTimeout(() => this.resetBookingEvt.emit(null), 100);
            }, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'ad42f875268272e85cbf1fce888185646cda9856', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c2635cb2e5b0328528484e90be0237ac664904d8', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: 'b5047a8ff6facce7030fbd9c63addff01473f170', type: "submit", form: `change-source-form-${this.booking?.booking_nbr}`, size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading }, "Save"))));
    }
};
...
const IrBookingSourceEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'c173365b3e9d63826dfe8f73e49f3c88e10dfcdc', id: `change-source-form-${this.booking?.booking_nbr}`, onSubmit: this.handleSubmit.bind(this) }, index.h("wa-select", { key: 'a3291ca8b2dab6b28a376a8a63e60f5ca0a70a64', label: "New source", onchange: this.handleSelectChange.bind(this), size: "small", value: this.selectedSource?.id, defaultValue: this.selectedSource?.id }, calendarData.calendar_data?.property?.allowed_booking_sources?.map(option => option.type === 'LABEL' ? (index.h("small", { key: option.id }, option.description)) : (index.h("wa-option", { key: option.id, value: option.id?.toString() }, option.description)))), isAssign && index.h("ir-booking-assign-items", { key: '0209cb30050b5b41d7c7fb7a18cad41dda0c1d5c', items: this.buildAssignableItems(), onBookingSelectionChange: e => (this.checkedItems = e.detail) })));
    }
    static get watchers() { return {
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: 'e70d6bcbed7798c156d64dd2610a73ebe18459de', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ca4c07c0d5ad314244a99c625b2682fd1e438d12' }, index.h("div", { key: '4ea08cd0749e24821ee36a330652e89ecc79b702' }, index.h("div", { key: 'eced57ff2ef65839d57f903e4dffb588df04e42a', class: 'extra-service-container' }, index.h("p", { key: '1f10c11787efa65aeec34a1a38ab16c292a7ccea', class: "extra-service-description" }, this.description), index.h("div", { key: 'bfc7c9924503889c52fd363f18af323ddad3b10c', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: '34ad4132e9b19d21d92e1c7ec5add00d05cd92bb', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("wa-dropdown", { key: '5aa15e6b923fb1e99f17db2ab0be3e0d252d0945', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: '7ebe36c1996428d267c06b1b1502dff072bb6cd8', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.service.system_id}`, iconBtn: true, style: { marginBottom: '4px' }, variant: "neutral" }, index.h("wa-icon", { key: '0cba46390863dd95ef95fbb2b0904cab2d652836', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), index.h("wa-dropdown-item", { key: '6c41300f94ad89d6fd695afbca200e4181d36d49', value: "edit" }, "Edit"), agentMode && index.h("wa-dropdown-item", { key: '6316cb9cd4567736cb0f129500579c1b684bd74d', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), index.h("wa-dropdown-item", { key: '37d5249044aa7987ae8e2a9b87c25bb5468e20ac', value: "delete", variant: "danger" }, "Delete")))), index.h("div", { key: 'ad0545cf1b7e779ab6c55d93fa79502b65f2b321', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-assignment-toggle-dialog", { key: '1c7e3712ba4f20551cf3c6993ce03817b2b50b20', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, index.h("span", { key: 'a40783b30dbbf25bd67b3b447cf3b56c545ce0e4', slot: "message" }, "Re-assign ", this.description, " ", index.h("br", { key: '4fce3fa4970e97bd9ab9cca7ceb20354390d0858' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", index.h("b", { key: '8e5a2abb25fa0b59907b0c17b835b6ddc953faba' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), index.h("ir-dialog", { key: '5f3d2c5dc8b80b447a95d832be42e8d71d56c5a7', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'ccd04aa6d583c4eed9749186de0a606ba6e130f3', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'f1e7c344aadceac30235889d6f7949bed39f9b05', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '11f72ffaacf8bcbe0ceff9c6808574f328751765', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '3ee2e73ca2cf593fa457ba0b0bb094a689346e90', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '7730438d6041fd6015af6b9f330f82cb700081ad', language: this.language ?? 'en', svcCategories: this.svcCategories, onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: 'fe82564d47fdac80e3db8071750932aec1b7de45', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'e11cb2ae7ad277657de0e9e69fea0335a4aa605f', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '8e0d2c9ef6707705eafe89a22ba3234365875676', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '36cc47eadd64d3dd801d989174878477c1cee7e8', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (index.h("ir-validator", { key: 'ca013c1b23b6a450211f58525644b7cea03eb8c7', value: this.s_service?.category, schema: utils.ExtraServiceSchema.shape.category }, index.h("wa-select", { key: 'd0acaa849e0f05728ba8828160b6d5962ec1b3f0', size: "small", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), index.h("ir-validator", { key: '2e91531a02ffe2de3a21f0302aa6fed87d98960a', id: "amenity description-validator", schema: utils.ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '6364d546ec83a4c3b5fbfd06b8b71fd11288ca84', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: '7c952a0e14b593752da4e7ca5a052cdfd9a2936f', value: this.s_service?.start_date ?? null, schema: utils.ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: '82eadac1b0cb341ac871b0586fa23619d16fbc22', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: 'c92a49de9d61b23e56536e42442659ecf389e9fc', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: '196794afb597f064623020b97e7b860899108be8', value: this.s_service?.price ?? null, schema: utils.ExtraServiceSchema.shape.price }, index.h("ir-input", { key: '3eca6333445ebc2b74d09d3ea13ab11bc9cdc759', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales_store.locales.entries.Lcz_Price} (including tax)` }, index.h("span", { key: 'd477ae4bd71838f236126cc0a6c0b623e39e8965', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '9956cc6fb88aab06cfe99766f59f8cc9983da0bf', value: this.s_service?.cost ?? null, schema: utils.ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '4da5064a5078b0666acdc83d7eb9e784cf6ec96e', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales_store.locales.entries.Lcz_Cost} (optional)` }, index.h("span", { key: 'ac00daf009f7c86d230f1dfe5041bea35a75f1f2', slot: "start" }, this.booking.currency.symbol))), functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '03c05d316d72e595a6a283f30780c20c247a9cf3', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '7b0e8b1cd7edb28409e59b4fa243b50329c7f50f', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: '3b36ff9002c92459c24f21df450d52d0431c3458', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '0254f0b898cfb133cceccaf69cb1eb56bc274b8f', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'e0dff81c7f10dab963b7f1183b2c1b7f1648bdf7', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '9b32e54bf3198e1cf5977854ab8361a2a9eea36b', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b255b294faab21f77698328e01dd9b214f26ee1a' }, index.h("ir-drawer", { key: 'eb0c69d6592bb811eb04e37485b39061c3c514ed', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '1206dff34f8d773b5165311e13e0179d88dab849', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: '7d0e7dd5867aef2006d9e81a1b6996248c63e455', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: '456ac92b22b4a764623f337d6d5d4b3ff682d2e2', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '5f419b22d5dfc7d0537120259620c7ff670cef94', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'f75ecc9a9260efc57a9f71f7c9734e04a15afc0b', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '5aa451dc34e3c05b8f66888e9e1d5e849179527b', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '6c2c61deb9072d8adf1c3a89dacd8e660c28c738', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: '4290361d47fdcceae92a70d3ba23fca0a8d61987', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '6d2f150f63ceefba1ace9cd953c03472f97981f2', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '3cd35c4b145d491e16ae880bd784719cc33d2ea8', booking: this.booking, formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'beed33de67e2afbf0c9be163f50e1e2713beb92d', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: 'd7ec06ccd0a493d969eeba89f0b301b85e51031f', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '2e35753292ae3491d7e986717eeea6343c65a2be', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: '5a1aed51b855afc94745b1b9754b0d771de0095b', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '22bb31aa5100b313316ab6d9161237611724a133', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: 'd49e4458d79959eceb2a44e63c5d935cfa5ce1a9', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '7d8ba8242ad493348958c28a66b585c0d438ddfd', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '3ad79168f992e441adf01cb3d6d80eaeab2821bd', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: 'f76866c72d2cc58b37b9799b3b8fd5e8f3071b22', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'b4307665bb3d7b51beed8284b7e3f346c3924b5d', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '1b5481a7e250908310a02d97e30866474db666ce', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: 'a54f9aa354bed0a6df74b879753da314fb50870d', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'ff15234787bb5e8150c5e8be3bdff097e7780a27', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '744578c152e64f4e1b50d544fdb31e8ffef0dc6b', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '5b867c59f67df4403be0de25ba665555f6ef8534', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '64566c56fd1aa4aefc371a9594256360066ce881', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) })), functions.isAgentMode(this.booking) && this.hasUnassignedItems() && index.h("ir-service-assignee-select", { key: '5a24cfb52ac80f11fbc5bb27e9393d12d0b34e73', agent: this.booking.agent })));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '6384c7f927e0509e780d26aeb515a37c6af544a6', class: "payment-item__payment-item" }, index.h("div", { key: 'f7a3e6775d60d17bb656856ed9f0e4ab7110f96c', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: 'd9e1ff18f62922305b90ae4eebad210faabaa68e', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '98348e310dae3954bc77b44ed73941faccf52d5a', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: 'e886036998acbbfa45cee103afba625d220cfddc', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '3570694a032e6b0d108c63ea7c10c8c8bb236d3d', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '2f5446c549a59a2abf226389752680a599d57dde', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '0516f22edf25b769d462517d3a23a26886a1629a', class: "payment-item__payment-toolbar" }, index.h("p", { key: '5c11a8e82afdd9631c7f08fd4b6c10b1147e9f13', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'f6776993d9c1a26f042fbfbeb57d97b6e9cb8ca2', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: 'cb1b2d477a7ea14a1d382b8622cf623c3b604015', class: "payment-item__payment-actions" }, index.h("div", { key: '6eaf0016f5b4bd8947a2bf1cef19f84b4718dfe3', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '535f8d50cbc8d5961da918d1fe153747873c694d', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '9b8fda56f33b09582f8a254b0f4f7f34031dec39', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'b6f93ea95e870c654542fc1ef3b3126d62ddfbc2', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: 'c6ac990cc2d3208f02c70f4620d4897a1e4a7f94', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: '48fe89d43b0055f7d132cabdbab998fe3cbe54c1', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: 'f32bf246a121d9022e5e2525ab9e4e4597ccac98', value: "receipt" }, index.h("wa-icon", { key: '5bac021cb1a54af60efcb993ede38a931cae302f', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: 'e64aa93140c13d3d2fa8dd25c021647a5df44281', value: "edit" }, index.h("wa-icon", { key: '35d9c04caf9388dbcee56c39810a2a4fe10c6672', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: 'd4d21bd231a66db343e7ab8a4a7a86c0b347ce02', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '2d132598aef8b27763a4b393eb52c058fd32bffc', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: '24599a35a23efc55ab0b5958d9ba3044500f2e65', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: 'cfd4f6f794560cde56c1a35ddc82c9284c42f8af', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '03253a6ec8b43c61ed67f8a1e0ba30932b346e27', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '8a6d6b61863f60be69cafa77ec1906d9eee1c6ce' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: 'b591edbbbe44d20ad3626cba883c2ac64026be19', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'ecdc75cec58423da37400dd71aa44c8ff5bdc914' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: 'f408dd4675b9aab67547d7156b9ee903a193fe17', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '617947b171fc46d2d219d3f6a9d7fa1f140a0ca5', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'a5af6d2a31e385c1360a1b7765baa7902d3ed855' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: 'ff3fd8dc612ead97af405e1bfeeeff097851821d' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '06c62a15466faf784d81cc9683a095e7c086061f', class: " payments-container" }, index.h("div", { key: '398ddf67f81c84a98edcb402beead18e20f51e94', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'e346ba468b7edcacc0c1d1052e130ab5921466ab', class: "font-size-large p-0 m-0" }, this.booking?.agent ? 'Guest Folio' : 'Folio'), index.h(HelpDocButton, { key: 'f271c8067a148802826c9cea8effbc7f274c6ef9', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: 'c72e2692a14ab782d4434d90c6571e08fd880d98', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '853c204926c184edc06339dbbf74ee04add1c08c', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '02b08c6539032ea6a7b49d3252b5a85a4a28d73e', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'a6dda5ae717b71210e33f1a4ce1d250ae5c4a18d', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '69fea5d4b6a428958da94d91c12d89e26640e148', booking: this.booking, onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '70d819aa12cdb7e490c82f20a1c9cbfdb7c7e7c0', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'd331e74700f06e9ac14b26959a39ef540208bf1a', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '00f8b19c583eaf7104c3e3bd0544886853e25ce4', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '558a5c19e73f4638d4d74d49b2c433f9e7db8150', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: 'ed6c030a3f2dee4572cfc5009d64350a77dcf26d', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '486532d9a9f78805370ec7ac760cafaaac944a80', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '3d1aa14ecb32ad3eba21a0cc1b34f70909ea9fbe', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: 'a631f0034a06954e1b415ec363a4b376b5c60119', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '8b994238b8210d71279edd30714452a111b1d6b1', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: 'ef21f5e24887f3d1c29776965ab38a9673fcf4a1', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '28d5c757e218d82ee041dd9ece728ee58456804f', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '78679ba6c65e1eb9bde19d33c38e334739a493e3', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '79bf2f7a02eef15fa398d66a8739a9e25c8751d9', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: 'f24ed4830eae0b6e707cbe6dc14856b10776903d', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'a376fb532a3703c9163d335dcfa685397fcf790c', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'b6e0eb800ed0b61460f7f9f81a4f72c80b25ea6c', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'a5fa6537edb6bded99db7da58e470d3c3687edbc', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '0156ac49c06082a956c0db5d181df7e8b32c26ad', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: '067c3fde7454c4d66cc3d2d8427080807aa27696', mask: 'price', label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, index.h("span", { key: '84e49d271d021e60cea857153f562469f176546b', slot: "start" }, this.pickupData.currency?.symbol)), functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '9e48bfc53a8234a7b42c5dcc12743bea56b53c13', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.assignee = e.detail;
            } }))))));
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '0f274c330b58bf4d794bdfb3b64c82b842de5212' }, index.h("div", { key: '0fd03d4638ab0c09ca83dd6855808f30b5117082', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: 'f19edfacc44fae8ca0efd511bbef21f3fe3fa5d2', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: 'a52c8958fd62c7d842b46c4f6ef040b4d9c43e0a', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: 'cb7b7b398146cf483222fcda27abbc6ed41e0d34', class: "reservation-information__row" }, index.h("ir-label", { key: '059d5ed29ba4a348a4fbbebd6dcae2b40d195400', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: 'a69fb2352b800847b7124be5511a101f9937d34e', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: 'ef5fd34494378025f5bb16ff0bdc3484cf1fbaa7', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '0e0426a706ebb998aa945201987d04ebb64501f4', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '5857eb885dd464501075d8ce9a1d2957900bd2ce' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '0ede306b4428c565123af42a7c7d4ccdafca5446', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '4a8adc52c014a4a196674dc9fa752f6c037bc580', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: 'b35e7b6b0c1aee95ab04f4fc8d28ff4566f1dfc3', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'a2c03a59235ec0dd4fb84b61d2b517ebcbbc5e7c', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), !this.booking.agent && (index.h("div", { key: '2ef8355f5cefe490416e3ffc6a411ad759703a5d', class: "reservation-information__row" }, index.h("ir-label", { key: '28f4afb25fe1ac92037e4fa389856b719803ea81', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '227ca512a4ae86021ede2eab82324749a0994a63', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '2c4f0ed8dec218cecb24556da7a002212e8ab5c5', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'e2a39835335ff582010e6614ace17a031efb91b0', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } })))), this.booking.guest.mobile && index.h("ir-label", { key: '92debd70eafeb087bcf375256108a7e55df73eb1', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '792f157060532f83580f0f9ee272bb89749f07ff', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '8d4f15f24e5fd4b21b1f1aa7483f27a7dc166c0e', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '5646c7a689ed6b72132e910caf60a3ace614ad31', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '9a80d7abce00c71f54f2c312d1d66d8913ef5a4c', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '4482c39da8af5dea837671a49e6c5d353309f7c3', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && (index.h("div", { key: '8a0024c5e993069015e2eb0dde6fe5528072d3e7', class: "reservation-information__row" }, index.h("ir-label", { key: '9bf8ac78e821175a6a688e04111fcb90c1f8d97e', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, display: "flex", content: this.booking.arrival.description }), index.h("wa-tooltip", { key: '40678e644da3fd8c5ebec8a1f9dfb4765f55d7b3', for: `edit_arrival_time` }, "Edit arrival time"), index.h("ir-custom-button", { key: '7e8d1626a51ccb37d24d9899e9289d0a9825856c', iconBtn: true, id: `edit_arrival_time`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irArrivalTimeDialogRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'b9dd90e0ba3b1b9c3167ac5fe04b6553487d195c', name: "edit", label: "Edit arrival time", style: { fontSize: '1rem' } })))), this.booking.promo_key && index.h("ir-label", { key: '6fc7dbed3bb890cc826623d813cc152f561e69ee', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '808f909dd5ab06978400f8a2c0f6974c20c06b4a', class: "d-flex align-items-center" }, index.h("svg", { key: '79903a7a3609cccd889b4cb644bef93b186685cb', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '55c3e01216c865105b45b66cdc8def53aa3aae7e', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '5b6cd4bf4bac330b03c5e8d3b34fbaa4b47d305e', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '79323efa43b9b964593dd735fdac24192a58a44e', class: "reservation-information__row" }, index.h("ir-label", { key: 'a6b14657784b8d12eb54c69ac54f0195282f0a30', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: '5bf8a37558688b4f12d58100a2c080bc2a8eda5b', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: 'ec7eb7e95a5ee01dd2cc4403eefaefd9ca90e9fd', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'fa19c8348c524384a98bd1472aa682a1d8042d8b', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '1877fdd3eb871971bdff51f35dec497d79792210', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: '34ff6de09c37edb6afb00661f26fdca254566589', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) })), index.h("ir-arrival-time-dialog", { key: '234ec06d540f48b0c238756764ed7db54936bab7', booking: this.booking, arrivalTime: this.arrivalTime, ref: el => (this.irArrivalTimeDialogRef = el) })));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6f35d41d6d9c437a1607883d84efbebe44605337' }, index.h("div", { key: '676f48e10b6704caf001de549555db1e47875aeb', class: "booking-room__header-row" }, index.h("button", { key: '46d2e2b4ed9789cc596c2f6f1a3628ffde707e92', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '7ce02fa3fd617ad6f7f02967fd6f71e0c5c1a35a', name: "chevron-right" })), index.h("div", { key: '18077fcde5fe374425ebd17a81beed58fe684dac', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '21302548fefb4c7a7c65c5fb347703ee949b08e4',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '644ea64d664cfbdf55598f893bea275731689e8d', class: "booking-room__summary-row" }, index.h("p", { key: '5c30957d58f1bc334828535a0b96a1ad2614ac5e', class: "booking-room__summary-text" }, index.h("span", { key: '8875a0d5a51a10761ab865eab6d9bbfafe1f385a', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '144cec33d2c4a8d3ce0b0d57642a46fba4dd14bb', class: "booking-room__price-row" }, index.h("span", { key: '4083cc34bfe119d006c321ddec0b49fa2b11baaf', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (index.h("div", { key: '2bc68cecb66235a4b1f22a0249003a56bea20e85', class: "booking-room__actions" }, index.h("wa-dropdown", { key: 'd1c89a8fe803ba1ce0e7e7ee4053f78d67df3232', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: 'd21181682c019789bc15e06f3fa1cbc8c7720145', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, index.h("wa-icon", { key: '3c393946f455445e6f497be5fe1776e6ed5e2b5e', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && index.h("wa-dropdown-item", { key: '538da0bc2d3a680fc28c5fd98866ed651fbcd65f', value: "edit" }, "Edit"), functions.isAgentMode(this.booking) && index.h("wa-dropdown-item", { key: 'e4cbb41d05e27d163c50075571cce4846314957f', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (index.h("wa-dropdown-item", { key: '52ca57c6721b9342de7112c81c4afc2d640ae87b', value: "delete", variant: "danger" }, "Delete"))))))), index.h("div", { key: 'c4262a7f04017969cc48da1e9f3e1bbfa38df22d', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: 'bceea5673005baf34636db8848f7f7bea8d93c04', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: '37837d778d218629b616a88ffe92254574840d50', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '81565f82a2c594f1cef3cddd152cc8427f70b822', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: 'ce10af9a5a326601f92ca74d22697921b4b5b597', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: 'c929813fbb8199183ce2c8ed3f08233c733702e5', class: "booking-room__guest-row" }, index.h("p", { key: '5ae8aea9c6f683d95912f1a6c431c59ec26e5529', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: 'd8e2aa12cad31c4f4b9b8eb10945f9a0f8b2c93d', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '623adb0f20545323572108a7a70cbf0aa7a07daa', class: "booking-room__departure-row" }, index.h("p", { key: '3df6618805863da20ae595777fa2bedc412d8a4d', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: 'ce2de7a51ca72a64964bc2445280c1007b262cab', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: 'fcf4ec3ce707c1bbbc14c51c4522b36917ff590f', class: "booking-room__details-container" }, index.h("div", { key: 'c0033f7fe0825738a0bdbd2c05e5317be0d8d5f6', class: "booking-room__breakdown-row" }, index.h("div", { key: '8be7868cc11256c2f087f24a5d41942616d0fcac', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: '75d08bf0bed2d5efb8d2ea6f5547960b445800ab', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '06ee827677cb8cebebb014fdebb9410a7219388e', class: "booking-room__breakdown-table" }, index.h("table", { key: '0918277ea71f4ca0834e7bef59cdaa5aee906bd5' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'b48345aec29e4aef672eb87f445499b711ad92fe', class: '' }, index.h("th", { key: 'f601a839f0bd95c22f8d3b6d3762fd581bbbd372', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '5ab5ffe3322e207bf374eb6958dcad8c76169f1e', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '956cff4b25a4c471fdf86d5479a83829a1bc4ccf', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '818319d709fe4be88b620db5573b5587b2a945f8', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'f8f267b1f97778497da50f2dd4eafa6ba222f6c3' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '49f76f4967c577ac7f5036a995c36c99b8c00262', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'e89aa382714df7c6546ef4cb5fbfbf99c8461bf7', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: 'fbf3a29411392052b6963b355058c515ad13100c' }, index.h("ir-label", { key: 'b7593cfe768603c35e538f4a7e3fd2f1994e275f', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'cbddcb64b821123c746471744d738b048ebb5697', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-assignment-toggle-dialog", { key: '97b8143d34c8406805880b9b0aebdca9fc7691ea', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, index.h("span", { key: 'a850e824ada99e56da5b98de380bfe15e10fb128', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', index.h("b", { key: 'fad7eb859a930fa454eec9f41984132cc5a93361' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), index.h("ir-dialog", { key: '0133c16fbe0e71c0d1ef43226414b6e967f9a21f', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: 'b2ffb56538ff192fd527e5d4403cfa34c81c4e42' }, this.renderModalMessage()), index.h("div", { key: 'fa5bff41da9a66f2b7bd34c80104ccf6429f12ed', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '7cefba85e09c03deac8b99341a08844f099374ee', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '16b7a826b6f12948dc1c9872af430dedca76fcb8', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '1bed23679aea0becc1e64a2d1670bc86e3612481', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: 'ce1baf2af78cca585faeb809ebb260c8ac9bf4f6', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: '1763327e66fa5ee2dce0a4700a7d928e71729bac', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-room-guests-form", { key: 'e9999a7082e0be08b18e021ee48cc50fb8b1b105', sharedPersons: this.sharedPersons, roomName: this.roomName, countries: this.countries, totalGuests: this.totalGuests, identifier: this.identifier, bookingNumber: this.bookingNumber, checkIn: this.checkIn, language: this.language, onLoadingChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            } })), index.h("div", { key: '45ab7969a96d17f304b342d553dfb56786cdf208', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'b32056f7fc42be5f6f11146d5b7cc1a9c21ab827', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: '8d9054e496feb57561828b7ba8e1683605191aea', value: "save", loading: this.isLoading === 'save', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: 'edf2316f3f3ece006b0555062b9e0bb7175d340d', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
