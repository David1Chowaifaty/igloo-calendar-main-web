...
const utils$1 = require('./utils-4f830388.js');
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6eb7ef44b577114f0eb738aee5e882e841576f2b' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("h5", { key: 'a7b0d3083f68cd67b88c03a96a9d6e715f962630', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '02fbf4b59d50a6b6fb694d61bf49883092df7e9d', label: "Edit Arrival Time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-select", { key: 'c910c0c32670f107f7486efb1151d5318ca4c239', size: "small", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), index.h("div", { key: '220372d8af4e2a2538aaf826b2ca23394f9269f5', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'ac64565bfbdf00f51dc8894feef2e1c0b68048b3', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '8b4abc268a6fd15acce0471377ca842c4d504176', size: "medium", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrAssignmentToggleDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd644d668bca2ecd490d03e4fc1a3938420b9fa03' }, index.h("ir-dialog", { key: '962453f36e7b2570e51d87cccfbeef278e455745', label: this.label, lightDismiss: false, ref: el => (this.dialogRef = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            } }, index.h("p", { key: 'b51dbf79fcc3b3b2627ae0d93be15a6418ce9d0d', class: "assignment-toggle-dialog__message" }, index.h("slot", { key: '7e25da6c9a3678cb28731eaba86a4363585bfd71', name: "message" }, this.message)), index.h("div", { key: 'c465dd2ef4182b6eaa9d599008cde7d43069fbb1', slot: "footer", class: "assignment-toggle-dialog__footer" }, index.h("ir-custom-button", { key: '3580f175abd9bf649a6ff04b4049f28184151163', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close", disabled: this.loading }, this.cancelLabel), index.h("ir-custom-button", { key: '765a30daa718faa61857f30fac21d8999c4961f9', variant: "brand", size: "medium", loading: this.loading, onClickHandler: () => this.confirmToggle.emit() }, this.confirmLabel)))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '112c9ffd1f129faa108d489e3d48fa988eb9ef8e', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: 'f3900d941a0c2c9154f491e6184ed3100a78a234', booking: this.booking })));
    }
};
...
const IrBookingAssignItems = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9096e920ad76c381167139c090597120592cee07', size: "small" }, index.h("div", { key: 'bfc231a113fa3c34605723e56c87b59958992362', class: "assign-container" }, index.h("p", { key: '77423ceae157db36fd5fa9f5c4bdb790ceb33cad', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (index.h("div", { key: '405c30e330564ff4e94965885dd191a69fdab997', class: "assign-section" }, index.h("p", { key: 'ae175382b1a9136820529b3b17a1953aa9fc8ebd', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (index.h("div", { key: '914d6dcc85e5d90693e4099fbfaead84208366d2', class: "assign-section" }, index.h("p", { key: 'eaaaefe4722daea2a6a6b958e157a2eb99ace13a', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (index.h("div", { key: '7e22edc8098a891d5383e38a3472442aacdef0a3', class: "assign-section" }, index.h("p", { key: 'c56f587366e297d03eedc2f291fe6efaedf5e28a', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
};
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'e1fb6699a304a9942697efa8bc6df4d943b11874', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (index.h("ir-booking-editor", { key: 'd55f983eb9702eb5c51833af83e168136a8a0473', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), index.h("div", { key: '97466226834c8c559f760eb438eb41bce12e8e2b', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
...
const IrBookingEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '77b109746937ac46427c5285f87c84e073635718', class: "booking-editor__guest-form", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                this.doReservation.emit(submitter?.value);
            } }, index.h("div", { key: 'a5f58230eded0a6134a44b1cc27508be82f0d8b1', class: "booking-editor__header" }, index.h("ir-date-view", { key: 'c6c0dee963501cc997fdb35ad6ca21d13cc92aa5', class: "booking-editor__dates mr-1 flex-fill font-weight-bold font-medium-1", from_date: dates.checkIn, to_date: dates.checkOut, dateOption: "DD MMM YYYY" }), this.totalRooms > 1 && (index.h("div", { key: 'e2d6303b6219538ab0d958eb25c6acbc23545829', class: "booking-editor__total mt-1 mt-md-0 text-right" }, index.h("span", { key: '17eb3bb5151c7b29c09ee327c74b5d0622783a17', class: "booking-editor__total-label" }, locales_store.locales.entries.Lcz_TotalPrice), ' ', index.h("span", { key: 'bf99fd8d975c3e20801945e3681d0f09e09519e9', class: "booking-editor__total-amount font-weight-bold font-medium-1" }, utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.totalCost))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
        ...
        })), this.bookingEditorService.isEventType(['BAR_BOOKING', 'PLUS_BOOKING']) && (index.h("section", { key: '93b7ecca0debf9985175b1490ba6e707bfcd291b', class: 'mt-2' }, index.h("div", { key: 'cde491e9babc4741d34b5b23515f1831db1defc4', class: "booking-editor__booked-by booking-editor__booked-by-header" }, index.h("h4", { key: 'b77fa3c46e3e0b0afb27c9a15d031fb288f5db5b', class: "booking-editor__heading booking-editor__booked-by-title" }, "Booked by"), booking_service.booking_store.bookingDraft?.agent ? (index.h("span", null, booking_service.booking_store.bookingDraft?.agent.name)) : (index.h(index.Fragment, null, index.h("ir-picker", { class: "booking-editor__booked-by-picker", appearance: "filled",
            ...
            }, variant: "brand" }, "Clear user"))))), index.h("ir-booking-editor-guest-form", { key: '1b5c0cc7d2ff5769cd2f8ad142cd2886e0b8028d' }))), this.bookingEditorService.isEventType(['SPLIT_BOOKING', 'ADD_ROOM']) && functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: 'd641e7e2929fd8c1c85ea85f04cd2c899fbc5278', style: { maxWidth: '500px' }, agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrBookingEditorGuestForm = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '580a32fe4d8ce5b97d98589d24cb53bcdc6c8c5c' }, index.h("section", { key: 'b8702d7d91ae09d17d815e687e023dae58521eb7', class: "booking-editor__form-control" }, index.h("ir-input", { key: 'bb91cb040b8e74211f0eef33facd62a396b4ce9b', label: "Email address", "onText-change": e => booking_service.updateBookedByGuest({ email: e.detail }), mask: 'email', value: bookedByGuest.email, defaultValue: bookedByGuest.email, placeholder: "Email (leave empty if not available)" }), index.h("div", { key: '46cbc7122fbc53efb2603aa97a30ce40bcc29482', class: "booking-editor__guest-name-group", id: "booking-editor-guest-name-group" }, index.h("ir-validator", { key: 'e62394e699d0147d933d401cc711d6d75846ec88', class: "booking-editor__guest-input-validator", value: bookedByGuest.firstName, schema: BookedByGuestSchema.shape.firstName }, index.h("ir-input", { key: '699387b2b5be5c7dfb7809faa484ce0c4f06de56', id: "booking-editor-guest-first-name", class: "booking-editor__guest-input --first-name",
            // label="Name"
            value: bookedByGuest.firstName, defaultValue: bookedByGuest.firstName, placeholder: "First name", autocomplete: "off", "onText-change": e => booking_service.updateBookedByGuest({ firstName: e.detail }) }, index.h("p", { key: 'eca8f04f3579cc48fe272777fe6ee4cfaf7710b3', style: { margin: '0', marginBottom: '0.5rem' }, slot: "label" }, index.h("span", { key: 'df54006fea01016c3d59f4df0f91209295af14e7', class: "booking-editor__guest-input-label --first-name-pc-label" }, "Name"), index.h("span", { key: '75b38d82a80692a4f9e30ff1b782dcee58d69dc6', class: "booking-editor__guest-input-label --first-name-mobile-label" }, "First name")))), index.h("ir-validator", { key: 'fd7514770695735445e7cd024864ac27e2749130', class: "booking-editor__guest-input-validator", value: bookedByGuest.lastName, schema: BookedByGuestSchema.shape.lastName }, index.h("ir-input", { key: 'b162cb163b9a3b4df6b379c201cb5a2f9f9ba065', id: "booking-editor-guest-last-name", class: "booking-editor__guest-input --last-name", label: "Last name", "onText-change": e => booking_service.updateBookedByGuest({ lastName: e.detail }), value: bookedByGuest.lastName, defaultValue: bookedByGuest.lastName, placeholder: "Last name", autocomplete: "off" }))), booking_service.booking_store.bookingDraft.agent ? (index.h("ir-input", { label: "Booking code", placeholder: "", value: bookedByGuest.bookingCode, defaultValue: bookedByGuest.bookingCode, "onText-change": e => booking_service.updateBookedByGuest({ bookingCode: e.detail }) })) : (index.h("ir-input", { label: "Company name", placeholder: "Company name", value: bookedByGuest.company, defaultValue: bookedByGuest.company, "onText-change": e => booking_service.updateBookedByGuest({ company: e.detail }) })), index.h("ir-country-picker", { key: '9464881663f6ee8c875c6d8e292358eb5dd2ef26', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.updateCountry(e), countries: selects.countries, country: selects.countries.find(c => c.id.toString() === bookedByGuest.countryId?.toString()) }), index.h("ir-mobile-input", { key: '360512e538fc397c5393ac44e548cd696420c56e', size: "small", "onMobile-input-change": e => {
                booking_service.updateBookedByGuest({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => booking_service.updateBookedByGuest({ phone_prefix: e.detail.phone_prefix }), value: bookedByGuest.mobile, countryCode: selects.countries.find(c => c.phone_prefix === bookedByGuest.phone_prefix)?.code, countries: selects.countries }), index.h("wa-select", { key: '50090006e0629f653a0b934a19eedcee78efa8df', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", id: v4.v4(), defaultValue: selects.arrivalTime[0].CODE_NAME, value: bookedByGuest.selectedArrivalTime, onchange: event => booking_service.updateBookedByGuest({ selectedArrivalTime: event.target.value }) }, selects.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: bookedByGuest.selectedArrivalTime === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("section", { key: '7eb4c74ba1f8d97cbd97ad64874e2941b8293f2d', class: 'booking-editor__form-control' }, index.h("wa-textarea", { key: '2d50eb2d6c276b71202883cc6201ea5fd067f513', onchange: event => booking_service.updateBookedByGuest({ note: event.target.value }), size: "small", value: bookedByGuest.note, defaultValue: bookedByGuest.note, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 3 }), (!agent || agent?.payment_mode?.code === '002') && (index.h(index.Fragment, { key: 'f88e726f1d40d7fe87c768d0620966f812e90398' }, this.paymentMethods.length > 1 && (index.h("wa-select", { key: '146ac2e962873cda4fba2072e51a808e21a6f248', label: 'Payment Method', size: "small", defaultValue: booking_service.booking_store?.selectedPaymentMethod?.code ?? this.paymentMethods[0].code, value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: 'e344ddb7db1bd3e35987f10a7498619c273ef774' }, index.h("ir-input", { key: '099a73802d41cffb8569de6ad97c0474c5ba8758', value: bookedByGuest.cardNumber, defaultValue: bookedByGuest.cardNumber, "onText-change": e => booking_service.updateBookedByGuest({ cardNumber: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: '71df4270d16eae705a8f1155fe3e1f438b4ed7cf', value: bookedByGuest.cardHolderName, defaultValue: bookedByGuest.cardHolderName, "onText-change": e => booking_service.updateBookedByGuest({ cardHolderName: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: '3513b7c3f972eb65cb0cd3f190a6fcc2e520d54f', "onText-change": e => {
                const [month, year] = e.detail.split('/');
                booking_service.updateBookedByGuest({
                    expiryMonth: month,
                    expiryYear: year,
                });
            }, value: this.expiryDate, mask: this.expiryDateMask, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h(index.Fragment, { key: 'a23412d69b9a9239d362c16426931707ad56ad69' }, index.h("style", { key: '1bf957a4da153eeefaa07eebc67e0a88fcbc6d52' }, `p{
              margin:0;
              padding:0}`), index.h("div", { key: '52ec76d328c2d0bd7b31aab4a8a3a4ceb8ded581', class: "booking-editor__payment-info-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description }))), index.h("wa-checkbox", { key: '86d9654cc1b051c16892a075cb3109388b700091', defaultChecked: bookedByGuest.emailGuest, checked: bookedByGuest.emailGuest, onchange: event => booking_service.updateBookedByGuest({ emailGuest: event.target.checked }) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
...
const IrBookingEditorHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'df10ccecd7f51de65511360b16f0543fd0d76760' }, index.h("form", { key: 'cdd84627e770e516e6ea80fbb57f69b2dd3a79d4', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (index.h("ir-validator", { key: '89dda4f841a9b859ba9a44685e3271bde9437fdb', value: booking_service.booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, index.h("ir-picker", { key: 'c1fcd06b7b30ce606345ea75ff46e879a5fd89ac', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales_store.locales.entries.Lcz_Tobooking}#`,
        ...
        })))), index.h("div", { key: '05a14188a99637aee6a38f5fd37689a589ad5cae', class: "booking-editor-header__container" }, !this.bookingEditorService.isEventType(['EDIT_BOOKING', 'ADD_ROOM', 'SPLIT_BOOKING']) && (index.h("wa-select", { key: 'ad6072bdba469702523aa355fa98cb471e503103', size: "small", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_service.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_service.booking_store.bookingDraft.source?.id, "onwa-hide": this.stopEvent.bind(this), onchange: this.handleSourceChange.bind(this) }, sources.map(option => (option.type === 'LABEL' ? index.h("small", null, option.description) : index.h("wa-option", { value: option.id?.toString() }, option.description))))), index.h("ir-validator", { key: 'a797d8ebee3e5f972fece75053145987e9419a24', class: "booking-editor__date-validator", showErrorMessage: true, value: booking_service.booking_store.bookingDraft.dates, schema: this.datesSchema, style: { position: 'relative' } }, index.h("ir-date-range", { key: 'eaa0ba4bfc675ef24bef5c3bd1fe91b56a0d96d8', class: "booking-editor__date-range", defaultData: {
                fromDate: checkIn?.format('YYYY-MM-DD') ?? '',
                toDate: checkOut?.format('YYYY-MM-DD') ?? '',
            }, variant: "booking", withDateDifference: true, minDate: this.minDate, maxDate: this.maxDate, onDateRangeChange: this.handleDateRangeChange.bind(this) })), !this.bookingEditorService.isEventType('EDIT_BOOKING') && (index.h(index.Fragment, { key: '7c675e3f60d94c556880dfe2c77da7c06cbd1f13' }, index.h("ir-validator", { key: 'cf0938331cd87abef85830c5097e534e7faed346', value: adults, schema: this.adultsSchema }, index.h("wa-select", { key: 'b3d0285543bacf9d858b45e13e0333253c9574b4', class: "booking-editor-header__adults-select", size: "small", placeholder: locales_store.locales.entries.Lcz_AdultsCaption, value: adults?.toString(), defaultValue: adults?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleAdultsChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.adult_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))), calendarData.calendar_data.property.adult_child_constraints.child_max_nbr > 0 && (index.h("wa-select", { key: 'f60c3479d52bb5ebc1c50c06ac5b425ad88d364b', class: "booking-editor-header__children-select", size: "small", placeholder: this.childrenSelectPlaceholder, value: children?.toString(), defaultValue: children?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleChildrenChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.child_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))))), index.h("ir-custom-button", { key: '69acafada1cbf76cdbadd319e1fe65aaffc429a1', loading: this.isLoading, type: "submit", variant: "brand" }, "Check")), booking_service.booking_store.roomTypes?.length > 0 && !this.isLoading && (index.h("wa-callout", { key: '4d5fc4c5dea2a0af7e6967425cbd8e12ef8ca15c', size: "small", variant: "neutral", appearance: "filled", class: "booking-editor-header__tax_statement" }, calendarData.calendar_data.tax_statement)))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"],
        "mode": ["handleModeChange"]
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'd1fe3fbbf3a2352bcc50dd3343007350d6647ae8', label: "Private Note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '90db4ef615f42045f18067e49f61dcb6e58574a2', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '09ff4140c6acf766aa668c26172f45da324f8de3', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'd9a62bcc53ff6c0b16ebde1597259ee3158bbaef', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '806c3aa927183de2390b76d4825c4da6f5256b5c', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '358815f0e889ce3b8fb564b8dbbe8b626c57ca57', class: "booking-header" }, index.h("div", { key: '5da188b7f9e8df000ea6468490314b93b91a89c8', class: "booking-header__row" }, index.h("div", { key: '4bbe7b5a6a08d0aa28c212aa79294ce6a3366abe', class: "booking-header__info" }, index.h("div", { key: 'd44cd7f381b36caa2ed537d9460b4aa7b60f7d7a', class: "booking-header__title" }, index.h("div", { key: '3957cb8abe72bd34718a1ae8a7974c6b99e61c2a', class: "booking-header__label-container" }, this.hasMenu && (index.h(index.Fragment, { key: 'd7885ac4842a52a79d6605ce6b7d52eff296a6d6' }, index.h("wa-tooltip", { key: '8652f37af3520eb1e083e37faeebba8acfa1d74f', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '64cbebcd4afe12fc75cfdeb2c77d1889097bf186', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '6e5da7e603789e6528b7119a99b6cbcc2f70091a', name: "arrow-left", style: { fontSize: '1.2rem' }, label: "Go back" })))), index.h("wa-avatar", { key: '74b84f53496b04794702d53f84de894497cb2831', shape: "circle", initials: this.initials, image: this.avatarImage, loading: "lazy" }), index.h("div", { key: '4b98633c158bef381e339502999bfc27cc8eceaa', class: "booking-header__identity" }, index.h("div", { key: '0d9abeb7263b4f518620694fc6a3f881b0bc75fb', class: 'booking-header__label' }, index.h("h4", { key: '9be4d43a40d5da9118568667770d6bd1e59fdb04', class: "booking-header__label-number" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`)), index.h("div", { key: '3db2f7055baf4bb8da2949343effdec049a69de1', class: "booking-header__meta" }, index.h("p", { key: '758e9506418f6705c6fb4bfa094be7ab4a91b5f7', class: "booking-header__channel-number" }, this.booking?.agent ? (index.h("span", null, "Agent:", ' ', index.h("p", { class: 'truncate p-0 m-0', style: { maxWidth: '100px', display: 'inline-flex' } }, this.booking.agent.name))) : (this.booking.origin.Label)), !this.booking.is_direct && index.h("p", { key: '09b2feea4f85ce34f24f6494659713c4f0344203', class: "booking-header__channel-number" }, this.booking.channel_booking_nbr), index.h("ir-custom-button", { key: '2dd3b97cb3807c534b29cd1db6c67f7ff7e695f7', link: true, onClickHandler: () => this.bookingSourceEditor.openDialog() }, "Change source"), lastManipulation && (index.h(index.Fragment, { key: 'd4ac71b8af4b82a9de04274a69c2a792daee25c6' }, index.h("p", { key: '83ccc00a34c65e4f78cea9e727490c5407d79f78', id: `booking-${this.booking.booking_nbr}-modified`, class: "booking-header__modified" }, "Modified"), index.h("wa-tooltip", { key: 'd5f75deeaea2526f8f1f2633246f357cda0172da', for: `booking-${this.booking.booking_nbr}-modified` }, index.h("div", { key: 'c0f79be9604ede2313d3760ca4940b8773a47349' }, index.h("p", { key: '8382d5bdc49021ceb83ed06cfabb7af618b6dde6', class: "m-0" }, "Modified by ", lastManipulation?.user, " at ", lastManipulation?.date, " ", lastManipulation?.hour, ":", lastManipulation?.minute, "."), index.h("p", { key: '80be21be600628685f03780c1367cd2d164b72ec', class: "m-0" }, this.alertMessage)))))))))), index.h("div", { key: 'a02688d9fa3323e5d86cb78a46136a56e1bd2847', class: "booking-header__actions" }, index.h("div", { key: '213f542fbd32088d5796d47f79f09e1e7729cf3d' }, this.booking.allowed_actions.length > 0 && this.booking.is_editable ? (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            appearance: 'outlined', size: "small", variant: "brand", class: "booking-header__status-trigger" }, index.h("ir-booking-status-tag", { slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", null, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))) : (index.h("ir-booking-status-tag", { status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }))), functions.isAgentMode(this.booking) && (index.h(index.Fragment, { key: 'cd1891b3f9a8c0ac5acf4eff05df48dc51607c5c' }, index.h("ir-custom-button", { key: '343b553fceba67cd49168e18a17b73788b1aecca', onClickHandler: e => {
            ...
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "warning" }, "Force city ledger"), index.h("ir-custom-button", { key: '0dda77e7b895eb57b86c4c2e2b9df8ad0b2cb6cb', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.invoiceDialogRef.openModal();
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Invoice to agent"))), index.h("ir-custom-button", { key: 'b7f12c508ed74f8e76bf435927c11c37275223cf', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Logs"), showPms && (index.h("ir-custom-button", { key: '9489ac3f5164e21da732dadf97df340175173654', class: "booking-header__stretched-btn", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: 'bde76448a312fcdf550d70e5e28c2d0bd0f23fa0' }, index.h("ir-custom-button", { key: '20d56cdb20e992dcdaae92b5697a341dcead6288', class: "booking-header__stretched-btn", id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '73a15c889bd8a9568315337c4884a20a2ed04cc7' }, index.h("wa-tooltip", { key: '81e1bde9915a7e85515f49c164dab2f03c05570e', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '254cee9e64aa12528abd31ec7191c82e22f55132', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '4c87037c98afd963f3718e1689a6fad01486f01a', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '05c7ee84ab3883d13fbb5b55af109bd982acd48e' }, index.h("wa-tooltip", { key: '71ca0016723c696baad0da6d00df535c35c115ee', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '8702dedde84f12aeb171e67986b66250ed696448', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'b6870a9f4dc96df65b0505ebdfdf754c777485a8', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '32a49f4a2401fa89ba09816dba51a44a884383fd' }, index.h("wa-tooltip", { key: 'ab25a520cf0f6af4d8ae41c38f220be12991a84e', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '5c2456991bb3b77cc4cb1f96966e17e7c5dd7dbc', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'dc5c51401567b386b9986ca9ab38a022abdac7d0', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '17e2114f869a84761f413adebfef74adebb231e6', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '4e59d863c5936589ddda2ea3a42f3b5cd60d9874', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: 'df11d5b6845aba68aca0b0c60effd1fe0353a48b', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '18d4e4018e96a85182ea033a4768b3c54c581ff0', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '38231b6e22d840fc88159528979134afe2538db1' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'e91d387efc4b712d277d2de83df1e9f56a4a8849', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: 'd32938ad4f8068fc2f7307ea765ea7dd59463b6a', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: 'f8cbebaa559420d2503dfd8dfda9aa354d1c8362', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
            }, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status') }, locales_store.locales?.entries?.Lcz_Confirm))), index.h("ir-booking-source-editor-dialog", { key: 'd1b07a2bb4baed42569c2e4f096b29e86904522a', booking: this.booking, ref: el => (this.bookingSourceEditor = el) }), index.h("ir-cl-invoice-dialog", { key: '5c1704a0fd927fab22b0bfa012fbd455fe597b8d', mode: "booking", agentId: this.booking.agent?.id, bookingNbr: +this.booking.booking_nbr, startDate: this.booking.from_date, endDate: this.booking.to_date, currencyId: calendarData.calendar_data.property.currency.id, ref: el => (this.invoiceDialogRef = el) })));
    }
};
...
const IrBookingSourceEditorDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'ea2c1201c9f52c792063a2fbb08d55cd05a82923', label: "Change Booking Source", onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, open: this.open }, this.open && (index.h("ir-booking-source-editor-form", { key: '3d1d3ce4c0981a988c8e36f789ef779f9ef67396', booking: this.booking, onBookingSourceSaved: () => {
                this.closeDialog();
                setTimeout(() => this.resetBookingEvt.emit(null), 100);
            }, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'e0f7ec5c9c21c843c707f6b179b428fe93ecb682', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '86669585bf107b06dac7fff02f29b4f2ad0ecb49', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: 'd78bb53424bf23de723590bf53e9d792f4a938d8', type: "submit", form: `change-source-form-${this.booking?.booking_nbr}`, size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading }, "Save"))));
    }
};
...
const IrBookingSourceEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '4361fec45168cfa8feaf62b0dd3a0224874dc175', id: `change-source-form-${this.booking?.booking_nbr}`, onSubmit: this.handleSubmit.bind(this) }, index.h("wa-select", { key: '52b0c1ea6b393cda64130dc991cfa8ab76e67ac6', label: "New source", onchange: this.handleSelectChange.bind(this), size: "small", value: this.selectedSource?.id, defaultValue: this.selectedSource?.id }, calendarData.calendar_data?.property?.allowed_booking_sources?.map(option => option.type === 'LABEL' ? (index.h("small", { key: option.id }, option.description)) : (index.h("wa-option", { key: option.id, value: option.id?.toString() }, option.description)))), isAssign && index.h("ir-booking-assign-items", { key: '9ca95cfea06e4c3253fe233c1e94c27ec93e6ccb', items: this.buildAssignableItems(), onBookingSelectionChange: e => (this.checkedItems = e.detail) })));
    }
    static get watchers() { return {
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '5d0c0e30c125d97ec916222031af9ca9d5300638', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '22d8dfbeabc0334dcf904ecbbcf4b9a6562841bf' }, index.h("div", { key: '0508073859cabae7e78d0001929d3770bb3673cf' }, index.h("div", { key: '82ef334fd335f013187dcc74370b303e1b8a211a', class: 'extra-service-container' }, index.h("p", { key: 'ddc7f03789eb71e100f769a0d0a27aa28b5629e4', class: "extra-service-description" }, this.description), index.h("div", { key: 'e1b1268ca5eae01c99bf181153011068e7be894f', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: '3cc261fec3cf01d9ac6289c8f70a95431800c47b', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("wa-dropdown", { key: 'be8878001e2af1bee663a9ee6965b5928ada038a', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: '3247cbed44c68c6ad77598ef48b6bfc3d98cff59', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.service.system_id}`, iconBtn: true, style: { marginBottom: '4px' }, variant: "neutral" }, index.h("wa-icon", { key: 'c34d865a12b99cf4f525f80d6131896df548bd73', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), index.h("wa-dropdown-item", { key: 'a6411e1058ee7a1efaeb0c3e283ef2c7f2724e08', value: "edit" }, "Edit"), agentMode && index.h("wa-dropdown-item", { key: 'e6d155c043be5dba22025d65deb6755a17d6e2fb', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), index.h("wa-dropdown-item", { key: '1dfad6f810bd00e8a8ff3ca758f39717425eccf1', value: "delete", variant: "danger" }, "Delete")))), index.h("div", { key: 'b2534fb79a7f7c548ce52ec0bbcf177bec62be63', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-assignment-toggle-dialog", { key: 'b6fad68e6399d8e41edb9c76869d3d38627cdd96', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, index.h("span", { key: '73c80935bb52495288af5d23281716d99d479a58', slot: "message" }, "Re-assign ", this.description, " ", index.h("br", { key: 'ec738c14297ba95cf42e341735bd1467474ca69b' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", index.h("b", { key: '53cd147f53ad40b36c0b7780be8c088c1a5b16af' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), index.h("ir-dialog", { key: '23ade3f9e4b507387c6c0110f52075072358aba9', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'd8c28d9cfdeaa433959ec67336ef66ac7aab3589', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '64d4ba2ce031500538b2b3a76dc040fa30da4a2f', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '36041da7125a4c571023ab2cce76e4b29fbbcf03', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'c52ac1132f040494f1679f110057b429e01de4ab', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '1e449231e4894bf7a09ddb593d752292643ed84c', language: this.language ?? 'en', svcCategories: this.svcCategories, onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: '324b0373c3772acb2d140e67222f92a7740e0ae0', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '767696b42fb65e76f99e06ad5f652628bfb41c17', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '0f7f84e77ef019607b65fbe1dfc0f64a1e968f4e', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '07a45403b974b9bc4a2af07c381ca1b8184f1956', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (index.h("ir-validator", { key: '218dc73e50b0d5050a4a4951a62c8daf9ab3a3d9', value: this.s_service?.category, schema: utils.ExtraServiceSchema.shape.category }, index.h("wa-select", { key: '9aa8808bb91a223f6a9756a14323375d28bf3c7e', size: "small", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), index.h("ir-validator", { key: 'f978cad41bd95780b6938ba611dbd12c791a0fbe', id: "amenity description-validator", schema: utils.ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: 'ea15061481621d6942f16487524d36073201b9b1', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: 'df72cb1021d461b3626d45f5e07451dab018a836', value: this.s_service?.start_date ?? null, schema: utils.ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: '62b21a47aff9f666521eecbc65f88f6e9ce080fb', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: '311e8a91c6d5c857081040999ef779ebbc3db5e3', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'fbbe9d1ed057e1f846980656424b740aa032fe98', value: this.s_service?.price ?? null, schema: utils.ExtraServiceSchema.shape.price }, index.h("ir-input", { key: '690a21002d84fd737316bb27cc5d4d602c9dee12', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales_store.locales.entries.Lcz_Price} (including tax)` }, index.h("span", { key: '6eebcf91417c2113d6922e6adba955141698a435', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: 'a2151becb25e0137420bb5abb6f78afbae595446', value: this.s_service?.cost ?? null, schema: utils.ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: 'd3dbd2ec3a199414a0a72a1d3841e818ba071518', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales_store.locales.entries.Lcz_Cost} (optional)` }, index.h("span", { key: 'b4443317365aa320d8dadbe98b3634843cbab1e2', slot: "start" }, this.booking.currency.symbol))), functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '284f1df4db79b1322a2cb0c73a61d6969b1b5c97', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '3295d0d30fe9da1d942ca479212d4a0e384885ca', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: '86058fec4a01c624fda2a0f0ee72e2c73854f1c3', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '62530ec6618cdc2d35b2c6f5b3bb0a876317cbd4', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '6b982c7c446f99b43d109627d13890c7b0f8215b', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: 'e00dde1f314c8115eccaec488e333e7f77892f17', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '584f3216a70503e242fc63b29b9b78c9f9ceb0a7' }, index.h("ir-drawer", { key: '890a3926852ae3faf468ff262cd551001f136308', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '998c45d9aafe4c4c2c7fda43723063e8ee968776', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'ccdf45753d7abfcde67b38bb3ff65304fb45312b', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: '16beb3b1bdeef8baea99c6ce7d349e656e539db6', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'fb8e84b575e3e681c1838d75e0cf9c1e5a8316d5', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '0dc951ff72543fcd06588e78bb5e2000097cf3c5', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: 'eeb16bd9e59f31d65a5081bc251990271ce1932d', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '833f734bd8b37a2a5ac5c14dd3ce403a413b8a35', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: 'edfed6ec8bbcf498630e15f4de7202455683929e', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '8c387d384313d161b3a8a3afd8a25bc77fd7fa1c', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '8abcde016dfd0b6ca1ba6bd638fb45794b73692d', booking: this.booking, formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'b05c8456fa3832b7b9118973aea76ae8453a94a2', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '1cbcdef487ba9d1d49f7ee07bcc7e0c04a5b23d4', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '50d20d314bce7f8d0dec488fc073ea64273cd804', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: 'ff0e5bec27afe63f0e51ffe3ae93fed797e6b09c', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: 'eef807e42a2c1d1fe0e98feb6dd5f88004e234db', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '1148a4667119f134f8d4610a95d5e1b882d001af', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '9e824d685dfa008098b2e44c86ec7eb1383d18ef', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '1d3fcfecf07d68ebdf15af1f28e8435d7026a400', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: 'c574ef3104ab11c3712375a1606fd5a507df4a51', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '1216b6400d90adf9b38db66ef70d1dc57c9485c5', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '4c9ad3e57cd624a9b61bde026d52ea2be9f6521d', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '6bf7998a1926d1b6e6c388eee6051b331687e059', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '3f8f8741e278d826eeac93104a0d79f3d44e1f55', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '8df6e937150e29593062bc28caf4fcf3df8a2ca6', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '2dc2f7728b9643863ca9c1ef5181c0110ace27d5', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '450a2d8da48408e3511437345a9d1640d8dd8080', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) })), functions.isAgentMode(this.booking) && this.hasUnassignedItems() && index.h("ir-service-assignee-select", { key: 'dd7dd388042ad224f534d279a6cebbeac4e5da47', agent: this.booking.agent })));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7c0188f3c2612e587b3e06baa8c44bdf96a02cc6', class: "payment-item__payment-item" }, index.h("div", { key: '37e820c7a513101feb762c85598f0820a78ac58d', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: 'c0910b8222c0cf91557190da2c1554d749cabb54', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: 'f5eca17e5d383e7712979fc7320b7681390cbfa9', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: 'e457fa3c2c342ade1781c37be92ddf5f7714f224', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '3e5aec4624f0f63f173098dabd6ec2a2b94d8f1b', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '02f3c917afb1180fc429c4960a23b0635086b25a', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: 'ad774167a9d3a580516ec8fcbb1f59218ddbfcc3', class: "payment-item__payment-toolbar" }, index.h("p", { key: '9b9e262061e9a5e491bc9c2385264f359d184a3d', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '757967d72a7b15dca0e5f6645d2dc06d13a322c6', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: 'af92ce344964b1079f4a10fcf930d64c65bc0e91', class: "payment-item__payment-actions" }, index.h("div", { key: '9188df419d7498b8a6ae4f10e26fcfb825a7b4ff', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '3947666de3215c17983ea61d92457223b5c6444f', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '4b754bd26cf1476d0941d61da4e52a19850713b9', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'd0bee2d575e27dc7731bbc4c78b3f68b439db42d', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: '959511e66e9fed9bbaf6116aa2cbeeb2457b185c', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'a95590c7fc956c04961340e360f3380730f25ce8', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: '22f25cb5ee90a88952a402edfe6410328b99dfe7', value: "receipt" }, index.h("wa-icon", { key: 'e758fbcbf406d484f4bdb8c682760a1a90b0fe7f', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: '99337606369c66f3b6b4dec275a6cdb1ab97e90c', value: "edit" }, index.h("wa-icon", { key: 'cf198acf35aa961dd2ce9edb84d27cdd7a2b0e60', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: 'b894ddbfc432167827ba46a203d9afcd2308af7e', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '26a46cf3e96d1af942ed68fea57297dbe0ecef7a', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: '64d7cd95aa9a174915bc19fb722ab16422cc7290', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '966e75a267757f1947f8baaae4bad3aa7784bd83', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '926354519dc5b29395bda5dd455be44c0c1b535f', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: 'e3e77b116442be1eaab0dbfca628c3fffb6c97e6' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '8bd681523173c2d69d85b1318affa96b9202349d', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '44de646929370ed94b6ad7b8ed9c0620408a0e5e' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '511249e8e5a9c3dfdd6d22087010e4c1363fdac9', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: 'db475d69d3ce660af86b1aa3316bf77dcf6d164c', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '88fc0329559dff3756b463e4665a730257fd49c2' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '400b8dac888b1bffc678f7d21c98e7a20e3d6b5b' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: 'c5faf771ea83ba5dcdfc4cd03ec86b0c89e47a14', class: " payments-container" }, index.h("div", { key: 'eecac6c6e04389ae8524530433da24ff846b6e66', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '7b4fb0f8202a02f0788995404a635d2f62320242', class: "font-size-large p-0 m-0" }, this.booking?.agent ? 'Guest Folio' : 'Folio'), index.h(HelpDocButton, { key: '24f3945aa5fd30d51dd8188329642d2600b81146', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: '60b306f0af552603df84fb6170a5446f0bc060b3', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: 'c464c4c5e71873ddcef311dbf70ab2c6545b499e', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '87e5822a564885decaf042f46a1f162e1a2abda3', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '7a57c96192c97fd057c897b5c7d3ff8ba4d91fef', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '8e1709a74eba4c7293b5190b27a4f5e8756226bd', booking: this.booking, onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '12e088d9e0bd7e0a262203e23df1ef1c7060fa1b', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '298e5c8b873df50e219a6e363340e0bc5fdfc49a', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '4b618fdcfd34b2e636dd6837837070604d1bd5c0', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '1389c54e4dcad249f230f53ca79316f15c545c85', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '52a1578cf7d499c9493d7c91c912ab1be8bd47c1', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '79d895ac096ed818c567d29bb94cc48a9fffc420', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '8c82780287747172361075b7760bb6d411e7a728', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: '8fa5adf9da258a393171aadce6761fb94521966c', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '3426de3390f7f9e359db28bf9558c88b59d5767e', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: '0b528f4f84c1b1560f602eee8f82907cb07ecc75', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '7bdf74822540ea4d7ebc11c6ae84cb5ee39763c2', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '548c04133a29e18c1ed7d9a03bdeca77fe341bd8', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '88e717d16513aec8d6e75b10a40b5c54d448c93b', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '8086fa88cab0f3e8dfb1326b606db744ac239a1c', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: '43b306ae26a238eadc2de9a33e34915472742768', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '2a0aa9fd54280d0d9205ec5cacccdf7e57c36aad', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: '49bb289f380283f6c18030cf554d527f87f3f2be', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '10e2280e564bddbd459db8165a9a259e1a8af511', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: '7cfd6a4b5822db08f66811494a3825a2cf6c7c61', mask: 'price', label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, index.h("span", { key: '14a176fc8a8e88097d3c5aa8ee5e64d914ecf371', slot: "start" }, this.pickupData.currency?.symbol)), functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '89ebf23fa88e4cc3150e31b40787ca787288e920', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.assignee = e.detail;
            } }))))));
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8884b40f54e4dc6faccabae036a343f477178352' }, index.h("div", { key: '7d34e7f7d8c234cc7ea05cff85c6d8952b2c3b34', class: "booking-room__header-row" }, index.h("button", { key: '731b07fe455aba2ed4b8982c6dbd0dbd9ef400a0', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '25b8e097abd923258ea09aa5b2562968fb2df5bd', name: "chevron-right" })), index.h("div", { key: '278952b9146ca2a8c99401a0e565560878f04c25', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'c2ace732af8014712ff601a1e7c99d94c32f8b63',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '50a51ae7805c7bcc633b001a88fc12b5f890261b', class: "booking-room__summary-row" }, index.h("p", { key: '863da2540fb8af132483acc62e84cbc77216665d', class: "booking-room__summary-text" }, index.h("span", { key: 'c75f7e66bbaa6ac1b6a4d42c267c5228a18369dc', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'b36c48b98c34750cf5de3d38f80430ab52fcca75', class: "booking-room__price-row" }, index.h("span", { key: 'b4d1457f50921df006a33eca9ab20a1856ad2d88', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (index.h("div", { key: '392ae13a2a2c7d45ede48bfd4e076e7c32fc6551', class: "booking-room__actions" }, index.h("wa-dropdown", { key: '20d8ba2bf8debbca119934edc837c1544b057dd6', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: '049b1eff83d0f211d09b2b13541f15ba74eaad00', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, index.h("wa-icon", { key: '0dd521c0f37dc90438735b4f909a5dd69f97e330', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && index.h("wa-dropdown-item", { key: '46cd2a120b611a77a538c17b53cef37d0fa55bf8', value: "edit" }, "Edit"), functions.isAgentMode(this.booking) && index.h("wa-dropdown-item", { key: 'c29a5563b1075197f18c80c72795c4bdf75a424b', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (index.h("wa-dropdown-item", { key: '017b21c6f17cbc6a90cefba5f471a151d9d2995b', value: "delete", variant: "danger" }, "Delete"))))))), index.h("div", { key: '95ab1ec7328ccbdd12a0f8f2d6c7674d0fb43d94', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: '8b916f1a854af0ba49c49376a07f846693c95d1e', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: 'f3db798f28667c67780395105fe102a939b07f7b', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: 'aebe190c42439a00a92c71fd60f9fa1f54892e40', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '7320b60498687bf038916ed4bdf1d0db7489d1f3', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: '30afce291920a64369d1a1cf2de74aa58f0adf1d', class: "booking-room__guest-row" }, index.h("p", { key: 'b23fb6eb9b1e554c8b9f51cca779610cacb9e160', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '01227f3ed198a6bdaaab19076f6032e875a73253', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '633148382472bfa930f78349cea96a1ba5c34bf3', class: "booking-room__departure-row" }, index.h("p", { key: 'cff0395c4abe393af8e59b120b811b3e92f30d7b', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: 'bc35325bd65564a91ba7e9e81a76c17805c5d43f', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: '7b9832b15b8ee08e39f6b721cdd7d3099c1bdddf', class: "booking-room__details-container" }, index.h("div", { key: '94af81f6d3c1d286fe78a8b10a7b31288dd12f5a', class: "booking-room__breakdown-row" }, index.h("div", { key: '109b4cff17292b5d251a8c70d68f0328cfdebbd6', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: '2c38633e04f181d253951802a17eaa0e1647055c', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'bd5f8d92787e5058488e28269514cfc25b20f24d', class: "booking-room__breakdown-table" }, index.h("table", { key: 'eed118ff6b92dfaee01b1dd02c612d9c32d5ba18' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '4634dec10759343e5d73e0c853675e8dc36837e8', class: '' }, index.h("th", { key: '932f6e7bb8d3a579b4e55e982e7b7c5e76289f86', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'a290a84f39428b359845a867f998df98e64f8713', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '025bcf20720d9743cee1b675b7c06c45b6711d43', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: 'b39f41886dae399041a3192d9407622777172a85', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '9319889568c1d7ca0bf4805d154c4a4db52784c6' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'e1462a1f2e3d20f07371787446242035f8b02a43', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'b78cad6dd08ffb1991143971efac5b4db66d6047', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '861cf65f74d02a96d895d0d4269ee218b652a3db' }, index.h("ir-label", { key: '1abdfec03604ffbb141bd1c4a0fbb9249ad53048', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '2d0cd5f4a3a6ef5acccbc322229ddb09b472bd58', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-assignment-toggle-dialog", { key: '40cebe63838608e75c6ffbe9ec1cedd6c7db3891', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, index.h("span", { key: 'd986fa2cca6cd8d45a14656ef3cec556ff35b4ef', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', index.h("b", { key: '6a413a7b0b1618776dff521ddd488a5ffbdc9846' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), index.h("ir-dialog", { key: '8b76737cee1272eb73d7ce0b53c701cd32bc6b5e', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '50d6c368ae90f710f6a13d1930c280a7e99c6c59' }, this.renderModalMessage()), index.h("div", { key: '11a5211e06cb173d7c435a5a0904696a42b7fbda', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '8edd1868cdc764726b764457aa696139a11463db', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'cea958821a6b8cd004fafff3797b34b4589240f1', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '4811f2f0ff7e36aae721cbf5f1eecdd3767e13e7', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '62ca8ce5a4472b4eaa70324a477e8b352c1b3c23', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: '53b523626c528b8fb6e03bf9d3f0645b633e3493', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-room-guests-form", { key: '6e2b7fa0bc9db793cf68ad1572a86a16f2ececac', sharedPersons: this.sharedPersons, roomName: this.roomName, countries: this.countries, totalGuests: this.totalGuests, identifier: this.identifier, bookingNumber: this.bookingNumber, checkIn: this.checkIn, language: this.language, onLoadingChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            } })), index.h("div", { key: '7c424f35a0b8b8ee630dd787d6d663de2096d7af', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '96a55173b112ffc65af253f0a5c1f87b73395a9a', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: '2d2a86641639ccc2418c5033ca1c2fad216b1bbc', value: "save", loading: this.isLoading === 'save', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: '5f2d7f32f1c4894c5a04aec22691fda03d2c4d76', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
