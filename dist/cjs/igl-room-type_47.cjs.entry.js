...
const utils$1 = require('./utils-8eb2a48f.js');
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '701c1182084e861b661c39e170491927adfbe645', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCheckoutDialog = class {
    ...
    setupButtons() {
        const toBeInvoiced = this.invoiceInfo.invoiceable_items.filter(item => ![index$1.InvoiceableItemReason.AlreadyInvoiced, index$1.InvoiceableItemReason.PickupCancellationPolicy, index$1.InvoiceableItemReason.NotCheckedOutYet].includes(item?.reason?.code));
    ...
    render() {
        ...
        return (index.h(index.Fragment, { key: '9c7664d72e3152e84ed33fe218db773420c6f42d' }, index.h("ir-dialog", { key: 'fae804ac02788075c40e3341b36a0208d00714f3', open: this.open, label: isEarly ? 'Early Check-Out' : 'Check-Out', style: { '--ir-dialog-width': isEarly ? 'min(36rem, calc(100vw - 2rem))' : 'fit-content' }, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.buttons.clear();
                this.checkoutDialogClosed.emit({ reason: 'cancel' });
            } }, this.isLoading === 'page' ? (index.h("div", { class: "dialog__loader-container" }, index.h("ir-spinner", null))) : (index.h(index.Fragment, null, this.renderDueAmountWarning(), this.renderMissingClWarning(), this.renderSameDayWarning(), this.isEarlyCheckout ? (this.renderEarlyCheckoutContent()) : (index.h("p", { style: { width: 'calc(31rem - var(--spacing))' } }, "Are you sure you want to check out unit ", this.room?.unit?.name, "?")))), index.h("div", { key: '9c69f14a239acc2b5ab32b7d23aadbde6a0016f8', slot: "footer", class: "ir-dialog__footer" }, index.h(index.Fragment, { key: '2f5dd705c64e3832087870cf03e63fc53c0f2925' }, index.h("ir-custom-button", { key: '9dadf634fa5e94c2270d819e4e733360a65e4584', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Cancel'), this.buttons.has('checkout') && (index.h("ir-custom-button", { key: '2000fb231df67a0358bd211e15749125247abe99', size: "medium", onClickHandler: e => this.checkoutRoom({ e, source: 'checkout' }), variant: 'brand', loading: this.isLoading === 'checkout' }, isEarly ? 'Confirm early check-out' : 'Checkout')), this.buttons.has('checkout_without_invoice') && (index.h("ir-custom-button", { key: '49fe7f1dede951450ef6cdf177a0b67920e81a8e', loading: this.isLoading === 'skipCheckout', size: "medium", onClickHandler: e => this.checkoutRoom({ e, source: 'skipCheckout' }), variant: 'brand', appearance: this.buttons.has('invoice_checkout') ? 'outlined' : 'accent' }, "Checkout without invoice")), this.buttons.has('invoice_checkout') && (index.h("ir-custom-button", { key: '4e6acbccf7612376d0a0051f4dcc5dc63af0ea49', size: "medium", loading: this.isLoading === 'checkout&invoice', onClickHandler: e => {
                this.checkoutRoom({ e, source: 'checkout&invoice' });
            }, variant: 'brand', appearance: 'accent' }, "Check out & invoice guest"))))), hasDue && this.paymentEntries && (index.h("ir-payment-folio", { key: '9ffa5fa7ba95352a267fef1e26b7bc6c82218918', ref: el => (this.paymentFolioRef = el), booking: this.booking, bookingNumber: this.booking.booking_nbr, paymentEntries: this.paymentEntries, mode: 'payment-action', payment: this.duePayment }))));
    }
    static get watchers() { return {
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6c177d738b2b81de1e007c094ece89352bd50145' }, index.h("div", { key: '5928b5d6640476919c7cb5cdebc57c6d33e227da', class: "es-row" }, index.h("div", { key: 'bc6f8e5c2a5321dcfa5592e52eadc506386ccdc4', class: "es-content" }, index.h("p", { key: '694449ef3028ca9b70cecd78b9a61bf028ad2018', class: "es-description" }, this.description), this.service.start_date ? (index.h("div", { class: "es-date" }, this.service.end_date ? (index.h("ir-date-view", { from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (index.h("span", null, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))), statusTag)) : (statusTag)), index.h("div", { key: '697b1b72f6c334e23972556a548f403d0da4798b', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (index.h("div", { key: '32cade8a8d938836847c6f1dc6d2976b51444d57', class: "es-pricing" }, index.h("p", { key: '64f2bdb26653ec51e909f03d32d7b013888f6359', class: "es-price" }, utils.formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && index.h("p", { key: '309c4064f9f8932b31d6ab5adb90af3895cab048', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), index.h("wa-dropdown", { key: 'd867271d5b9b74a5525e7762cf184094317f0f96', "onwa-show": e => {
            ...
            } }, index.h("wa-button", { key: '9c9d0b7a44b4a670ad06d094638ebb794e3b99ad', class: "es-action-trigger", slot: "trigger", size: "small", appearance: "plain", id: `actions-room-${this.service.system_id}`, variant: "neutral" }, index.h("wa-icon", { key: '0e8bde74c99c660d0ee76a8cb23af7db5539a72f', class: "es-action-trigger-icon", label: "Actions", name: "ellipsis-vertical" })), index.h("wa-dropdown-item", { key: '6f49594f4a765eff62aff22568bcff9d231d32fd', value: "edit" }, "Edit"), agentMode && index.h("wa-dropdown-item", { key: '38621f3599ae28e355c0e53b6a1f26a1d55468af', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), index.h("wa-dropdown-item", { key: '0b8db1a10fd606d54a273366494cd4a4d4135669', value: "delete", variant: "danger" }, "Delete")))), index.h("ir-assignment-toggle-dialog", { key: 'c9d424b709fc555de8bfa6d0d2406e46aa6b4ec7', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, index.h("span", { key: '035766f6a260898bff94610d2f71d42e40ee9f8d', slot: "message" }, "Re-assign ", this.description, " ", index.h("br", { key: '4f76f835e9243f86a3e69b2b349310605464a592' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", index.h("b", { key: 'd05c9efe26d2a0b3959328707975f867e60085d6' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), index.h("ir-dialog", { key: '2bf70a8ae601fc1364f9e2acaac9dd9d2737cf7b', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: '6b81ce7b98bd2e894624a2e23f955a5a8b894355', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'f749206483fb0eee387367df571db242d560b2a6', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '1414f12bbaebc672b2c0b8cd14355ae877ebbb69', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'fea7ea473cdf13679a216f6f91f34361a2c83160', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: '7327aaaa565ef6b8af6e5b23f614aa7d7e1c1d13', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '04a739bd4493aa7d1f3d0be9b1db442fda370199', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '111fcfa38f8ffae2c85be117c7c3d50b775c6eac', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '3a962eea26c14c6c908b1fd2884d7bac3a08f84b', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '046fda4d846564c6d094e8770225a417d45a5ac6' }, index.h("ir-drawer", { key: 'e6e46166f9e9b89dc4538b0efcffd31e78c3a41f', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '32a3bd1dc7ee1e43fd2f1a5a771d8ee7e21c7312', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: '8c6bf7e3fec4b01ccd9f5219b0c39d9634bfbc63', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro forma")), this.open && (index.h("ir-invoice-form", { key: '472f408f37ce9cf3f9efd391f620d4fc680edccf', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '93a0d0968ffc010f85e4cd8fa316ab5f0922124b', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'ab68f8ebf9a2779a4232c80ddec9afc127739f98', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: 'bf6fc0a498ae52109defdc2ff8f1ccca084f2cde', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '6f28208ddea9c69df57ea5241a579ac85aae1e2b', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: 'c139b687e2dc83f5a9eff62820be9f9912f1ec0f', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'c58647937b3bbbc460149afec73ef5d8e786f3e4', class: "payment-item__payment-item" }, index.h("div", { key: '3f023f63728654a98fd808c902efcdaa542f957b', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '3832ad1b5d1c7ba5907a5142fa2db2a82b232c3f', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '5a05494abd955f4959099b0df43a135bedab2920', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '27770a1ec32241171f5a90fb16c335e087bb418d', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'e9ca44b5c43f7c3549ee30ef90bb386353e41a11', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '5967b0aa00f9e46374bb5e845d842318663660ec', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: 'ddf70da7774c092b5aff660a8a0dddff130b1d17', class: "payment-item__payment-toolbar" }, index.h("p", { key: 'f328c9c9a3b44d2c0d58d260cbd21951dd126406', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'c7b12ee342e63ef191493291451d8b800859cb18', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '5775997c1deb947d2c39b543c408804aad70fdb8', class: "payment-item__payment-actions" }, index.h("div", { key: '9ef279bb905ec1262f8fadf61674ca620880ef42', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '527951fb979ff7416cafd78e89e4a23b16c404f8', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: 'e6d630a817333274e0f34ec591fcf5695d866522', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'e3bd83e89e9c5165b264a7bda7f50faf963ae919', "onwa-hide": e => {
            ...
            } }, index.h("wa-button", { key: '95d66be7dc5ff0400dedd95e69de7c0215169f26', size: "small", class: "payment-item__action-trigger", slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'aa06fb092de938c50e707994047a1a5c966428e1', name: "ellipsis-vertical", class: "payment-item__action-trigger-icon" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: 'ec5ec23a27f141c7007a6e62fb5765b1c5dc042a', value: "receipt" }, "Print Receipt")), index.h("wa-dropdown-item", { key: 'e022801771040d6eacf7e4bbfbfbfef6ccb9485b', value: "edit" }, "Edit"), index.h("wa-dropdown-item", { key: '77ab18b271a680e32a6d45d721ffbe8a5070ad82', value: "delete", variant: "danger" }, "Delete"))))), this.payment.reference && index.h("p", { key: '8318383ab73d4bffa9ed12a51ad233087f674f53', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    agent;
    clTransactions = [];
    allowedClOps = new Set([index$1.ClTxTypeCode.Adjustment, index$1.ClTxTypeCode.StandardChargeDebit, index$1.ClTxTypeCode.CancellationPenalty, index$1.ClTxTypeCode.Discount]);
    shouldShowTotalCost() {
