...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '202775b8cf898ef0b3dd0428252bb76a57130073', label: "Edit arrival time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-select", { key: 'e404b064dfc32e92703a0ca3bb4cf7fbf63accbd', size: "small", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), index.h("div", { key: 'a6cdea9befb45fc81aec843ae8996b7fa0b69c41', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '2f6877119b3f84a108a9f78a089961bb47e695cc', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'abd4f138a35f602b30d54cfd5f83b6a7a762f40c', size: "medium", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '55e3d29c598c6f5efe166d52a3c49442481d6255', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: '7b56647f64a3ac15cd1521f9c934d700231669ca', booking: this.booking })));
    }
};
...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f1a0bb6669b0778a06aba651e9a2a64907886899' }, index.h("wa-radio-group", { key: '4163e0e0adbf76b9ebdd46953d63c55e77d4774b', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, index.h("wa-radio", { key: '95cc1b5e162bbea7ff4445c5bbcc086459afb1ec', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (index.h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, index.h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), index.h("wa-radio", { key: '6745e742262ec0d9db3f103496301064f089a7ca', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name')), index.h("ir-booking-company-dialog", { key: '0d11779a41bfa057947d9bbd78c71088a556cbb8', onCompanyFormClosed: () => {
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '3247ff74c951ee545db0452c8becd3abda641d6f', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: 'ad53ea538eb665a47543633bbb3187c2b0bb2934', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '9fae70c7119a6b55947ad9e3b18aa27ed9c8f0a8', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'f87284216e10de435ef79b454a23490b933936eb', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'dc9c8895f0adb67f0e4704aa3c7a9090a80f1ed5', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'dc4ed242b423ef811c5e5ef250495d6594f63686', class: "booking-header" }, index.h("div", { key: '0e42d4f6898ba95a02298e23b6217df0b3d1c081', class: "booking-header__row" }, index.h("div", { key: '228145196e7f50798a465c09db40a1e2ef4defd0', class: "booking-header__info" }, index.h("div", { key: '4d381f751a41a1033cc6606322592892fa2ab67f', class: "booking-header__title" }, index.h("div", { key: '96fc92150596353f56a34e26d4a24d19db0b6cca', class: "booking-header__label-container" }, this.hasMenu && (index.h(index.Fragment, { key: 'e09ee90606365071b194754112bb12abb2b76bb9' }, index.h("wa-tooltip", { key: 'b5981823e818cc6a503af3fe55e102d28bcb5ed8', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: 'e280fccecd34847e98c1c48dee7971d7d66ba0af', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '28455bcabb15c56ae36a886950408fe855fb98c9', name: "arrow-left", style: { fontSize: '1.2rem' }, label: "Go back" })))), index.h("div", { key: '850eac5cd0b3b035d01f6ae7f0480574b9cfad9b', class: 'booking-header__label' }, index.h("h4", { key: 'bb88937c2adc0915e24ffac4a1fdd369e272edf0', class: "booking-header__label-number" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("div", { key: 'd0abb570cb798ca6127c9577b7334dd40fb21cef', class: "booking-header__meta" }, !this.booking.is_direct && index.h("p", { key: '22154894402765b834af5ecabfa71a6ac14e525f', class: "booking-header__channel-number" }, this.booking.channel_booking_nbr), lastManipulation && (index.h(index.Fragment, { key: '96aee18b92e90ee8eea12ebbb345ec863c6c07e3' }, index.h("p", { key: '94bc54043ba55e8b75a23c0bad16cd9e925ce237', id: `booking-${this.booking.booking_nbr}-modified`, class: "booking-header__modified" }, "Modified"), index.h("wa-tooltip", { key: '56f5469c9b6370957c65b27c356825a819934242', for: `booking-${this.booking.booking_nbr}-modified` }, index.h("div", { key: 'c1fda7e21272ae9c60507472c71afc63b9c242d3' }, index.h("p", { key: '161ae2c5ecfac956503dc641190fe330f29e95ee', class: "m-0" }, "Modified by ", lastManipulation?.user, " at ", lastManipulation?.date, " ", lastManipulation?.hour, ":", lastManipulation?.minute, "."), index.h("p", { key: '28667fa181f9f17c5184605964fd09cf79eecf19', class: "m-0" }, this.alertMessage)))))))), index.h("div", { key: '248e5d1dd3f5e31f584c29ec6ccb75b410892fd3' }, this.booking.allowed_actions.length > 0 && this.booking.is_editable ? (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            appearance: 'outlined', size: "small", variant: "brand", class: "booking-header__status-trigger" }, index.h("ir-booking-status-tag", { slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", null, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))) : (index.h("ir-booking-status-tag", { status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }))))), index.h("div", { key: '5d8a4a06dce5ec05750be5071f3671093baca2e4', class: "booking-header__actions" }, index.h("ir-custom-button", { key: 'fee2b513bcfe370720560e32013fd9fa9487469d', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Events log"), showPms && (index.h("ir-custom-button", { key: '4ca149b0b422f45ccfb300299cd10c46d225d15f', class: "booking-header__stretched-btn", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: 'cfbc91a3377a0602bcdb68a82ef803116eaa8ed9' }, index.h("ir-custom-button", { key: '0cc59ee6824146924085e61076367da67996c438', class: "booking-header__stretched-btn", id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '3e5f5d7a60cea02c5371b8dbe31e0a75867cb15d' }, index.h("wa-tooltip", { key: '69e479ac828eae409674d9ae36bd51283856ac2a', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '4711c7020b740185be9c392e72452c0139cbae93', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'c1f9347e026613bb39b499875cc57ba120b2e4fe', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '4687af2af906dd4727013be9375701136ee90616' }, index.h("wa-tooltip", { key: '82551cadb3b41eb0fa273d387ba3b240bceb8bf9', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '072ee36f5454a32f98ee88facc9fc84ded083b7f', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '52609ff1e8f2e6cfbcd83f3ea9978616da1a71af', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '1b729e34d7c098e913935a7cd9c5c194929217e0' }, index.h("wa-tooltip", { key: '0a2e404788515ef04b5a97b7c94b2c44c131022e', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '20207c80e7862b2d49b9e11f1478787627c69bbd', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '29a44660a29f21818f06375ac605f737b9f47bfa', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: 'eb589ff1131726a0394a57809722e52697d8eaca', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '78faebeceea6c4fdc6a53e65a7f66bbaa4e83901', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: 'd41bed23059a4d3b4543f43d021bc05ed3d17e6a', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: 'f7453b1946780f6643d092c49d0921acabd97e34', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '510a04e4e25fb984091eb6505b013a75a4f26acb' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'c2fb0dd54674427de2d6158b4136003b4ffd6ded', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '722bbee7b0f994dd7f1e8551d41aef06c616ca06', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: 'a9484e8630c4fd15f6c11a86d65642a12524c326', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '4dc4790f6f03a0fcff0c613eec9b103c7c0c28ab', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '08ff484f10180b5e58383dd5e01f44ca34e8aa68' }, index.h("div", { key: 'b10300273f531268abe0a344708e5d7d4c83a77c' }, index.h("div", { key: '39a6d2c7cb1a53ad5e35385e9381dad659b534b1', class: 'extra-service-container' }, index.h("p", { key: '34d4438c59ff9aef9caf494b30bbdc1ea1b3fc10', class: "extra-service-description" }, this.service.description), index.h("div", { key: '67eb6175b2efc35f965ce44623e8f96a7beb006a', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: 'adc9986e508bccc41dff9de29a329ed35da6959a', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: '8134afa255d194fbf82a3756d61b05a6c6240b8b', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '9d89b5e932b6aed654906c8d273609f88d53c453', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: '688ae6d55111828d52dc7dc6dde1d9101206e2bf', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'a3eae3f729e270817fd0f7e35326b9da9038e53e', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: '75b92ab09a08c89a2977597268b3ad807de4fb6c', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: '049199af0fa89399d344638fbb40d5508a77afa3', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: '163300fd19c31e9fee5570955d2d30cdab29a088', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: 'ec6fd6f86c93cc74e0f0b9fd24345979863d13fc', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: '0e3af9adf4ff4cc46a1a182189f89c9deb7f86c0', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'c477e3a0affe9e1161a806d3e9f19890ebbc1ba5', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '0c1237e282327862bfe3bf65bf104661594d84c0', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'e0e0d15f1b1b600f5796dda8c7e2c147cc9f5278', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '3994644b91d21a1de1737b994a5e9ec79b05940f', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '565150fe50af9b61444a239cf1c48e88fc87afcb', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: '3424f202e1c533ee3b1d390b2164b1395ddccbde', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '7d15c0ca934982f26af90a79a503c6abe1a430e2', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '4ceb602671ccde35532b15fae040de0a55240dca', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '586f0b351ea04d5f3f4fbedbadbb62a245eb3d0b', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: '3effb54f19361ee434b021c45468f8bb5dc72a37', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '14f8e8dcfd9108b4ecd42d9a302fbf392a76d9d6', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: 'a755cdc13537b9bba3593c5351998e327b6e09f5', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: '239764c1d5993b6e4ee377185e7a8e3eaf969eec', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: '91afafedfae32a7892eced498c4e90752602ca74', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: '6c1ebfaf5e026af29a43346013029704d78c27a0', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-input", { key: '44a4ee8883821bae86c76d9ff8f34db138a76d22', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: 'c7fda2cf7baf1da483447f21045ca9b6329476b9', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '72c61f75c1f06b7954d7706b8e83860d30b68009', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '574c98b2a362c95c8d232a88826bfd6ccaa2a566', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: 'ed06a02f4757061801d9af4769ab678651ceedb0', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: 'fcb06860a6f43be49d876422ea756eb5049e57ed' }, index.h("wa-card", { key: 'd6ccde71ed6b5a320aae39b53b9dcbc354f76509' }, index.h("p", { key: 'bf7bd7a6123dadc2d9a748aa7b8891da6834f827', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: '43027507d553f410fafd428a5432d3e9b3fdf35e', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: '06d315e074adbda5b953f032aa91b62baabd30ca', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '9a249c450528d063ad5f623795c30438d5ed0236', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && index.h("ir-empty-state", { key: '2880ea9952ed299ba1d523fbfbb9203a4abcb85e' }), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '92aff901289cc74e5863d83eb3e3d4d0a9cebf9a', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: 'aacdd04e9492f1d122ad83406b5d0a6ce9f0d9e7', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '17d3ae54f3d22c458c2e4cb080f72b47a4035a2e', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '587138b904196904ffd74ba530d2122e697254af', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: 'c10dd42f821d21235d72fee0b45e915f0ea1599e', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7fdd77edec62ac4a5f26946739726104fb89d269' }, index.h("ir-drawer", { key: '119198fb270e270f201ac4010ec107bf5ea475b9', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: 'a1f6effed386b8a5e097f646be28fcd9d8d695b2', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'eb2537abf8ead084d0b0895e38f9847187876ca6', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: 'bcf869dd9c04a54d0703ae8ee104ce3378c77b39', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '6c7ab5ab084717f1f8130069a4af0fd3124f4de1', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a945cb6e71d44467bd4f8ed0f6f7ae0f5de8d2fb', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '90832d778ed5d49833bd82c70045f359920c5c3c', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '8e3d6fd4af0f794dba24d5fa6729b91cbc550026', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: 'a699d1138c8c1436a04603973ecbbc5aad36c7fe', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'ab4de9702c58ad88ca1907ac23b77dfede2bfbe9', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '8073d888476ae246329e835d273a653a13dd74c6', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: '32a067c6f92d987cbaf1d1f3fda29bf87a504206', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '9d2708eca382fd9aa2c7771917dabea40b498a8f', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: 'c8de677c596163e8ccc85a888aeedb108957b3ab', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: '5ccf1affa2d6a5587ff723c8a5c77eb71acd5896', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '83c950a4c6c64dddd75b9234f400648941df916f', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '44e8421d6ba8cdc539f0e2c4ec80bcbedc92f046', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '1770416f1ef8a7ddddf1b0b1d812481111fd8455', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'acc9b6159bddf0905b3a990fd76cf678b9680be0', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: '636b577738e19eef83dbf5016cd95a2ce7dedf31', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '3dc39a11d102304043d9677720d43e2c88967fc1', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '6cbe9159f6e014e1336a0f9e1a3f6b3f55d9462b', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '6d0e062d5851f34e0cc8c22746d82abe741775b7', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'f3abc58c6a5b414c8cefe37607b9a1eb5616c132', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '171a8fd173589722fa54cc1f560e3a2148b8498c', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: 'e7065daed236880d95d666a43b09fd4dd6a6f526', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'b09af0fe8f9f922c7e950e87309a801a7a05ce5f', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4f5387c3dc9ec7e58237dc5514970aa569714ccb', class: "payment-item__payment-item" }, index.h("div", { key: '79285570dc9d4500ef728b7362ec367863db35ed', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '0f9d3231aa210f2701289a30b6adafc7b5e7b9cc', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '585a7f5fac53b31cfabdf047377e77d98835481a', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '8fb6708b2174a2515f2eb2d4f09ae82e10b20f23', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'cd23101a3830d1c77b49b295105263d379cdc11e', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '379957c05a6bab51dc7a08b7ac2373a83cdc12f5', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '3b7625a509dd588ebb0613d19597aa312114bf32', class: "payment-item__payment-toolbar" }, index.h("p", { key: '6a9d1f4e97b920691164c4a2f845678e72fa368b', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'df2157eaea95d589dc55be42a6965a16a1511db9', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '996ac5b61bf1933dbf73b888c1167d6e89c23f5c', class: "payment-item__payment-actions" }, index.h("div", { key: 'd16f04ee5aa33fed25eb84af9880effa060cf746', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '70ef1f861e64a48e6c8cde070758cc7360c2cdc3', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '50e99ae66bd0b6b26cc23820da3e1ace5c1429cd', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'eedbdbdeb65328b29383e908a9116c4c89d3f17a', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: '1384bb71c372c61812b07b0d5eb4bc33d589ac17', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'ebf879bf071871887b8612d4e6030277a9b00436', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: '9caa2bb3545727ee159ac986ab293af2ff5ab885', value: "receipt" }, index.h("wa-icon", { key: '888fdb1344a51593d37ca7ae1ea98a7c433f1e8a', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: '3b2c63fd820c318b09773dd5f6da1ca98f44564b', value: "edit" }, index.h("wa-icon", { key: '8e29afedc7d27a3149db04bbe887d0d2af4141f2', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: 'dda9ae68eb8eaa313be246d9fd81e7c3075c030b', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '91a81fc6fd966de79f88b14831abaa17a935c718', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: 'e468be5fe7f5c83d2300c8e443c0c5e4495e3b91', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '069a7109f44f8f11b74cf65067bf7dd463093506', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: 'a21c05a81368b82f9f4e2a705fcd72741e314305', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '2410d99dfbaf171ed594b9200ed70b26a14a855c' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: 'ee7b0d6e3fbcda275053ffcbdf5e5dccb30226d5', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '780eb9bb05505483eaf08ebb9ba54a0bfd510bc2' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '7cb142399a84392f3e8a6e3ce0a3bf5c023821b0', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '09360f726b2b62bb5bd20f108b0c7c0ae671664e', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '11c0ba4bce4942ff05ecb5437397dccbb4b50a17' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: 'dc90bf739a3b1314bca6216e5c513e9af1e1486a' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '83abf98d3ff7b061c9992c90e5b6b48905d97ded', class: " payments-container" }, index.h("div", { key: 'c0559facb1885cf723d99286c76954a6668f3cdc', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'de130d1932450b34c3f40329fef9e4ad007662cb', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: 'b72586b1b815e844bb3d9a5d9e405fb73796cac2', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: '7523a13efd7486b9bf221369f9ead6095508f921', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '120b15b9bdd634e31818bdd5981f521eeb4f0048', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '960c2a74b8fff41836424763fbdf7ca0bb45fb0d', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'f74c35ed89f2878b9da32e31a9a487b3492eb554', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '4793e284ec9f1bf30b0a772f389daee98eefb1b6', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '8dfce10b3630c10d966080bc024a75a9898cf80c', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '07c4b0d5d1bb854810af7297a8b9f03f3481c198', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: 'c1c40215f0f98cbd6cfb12bdebf1ae4bcf82269a', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: 'a74b325262650e41fbfd03741f041d462ef163b2', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '0d31057007ea6acc7108bf2c5ccb4296fce8cfc6', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'ba7587fb1effd069ca9c5bc8bafb92ebcc00d038', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '7034e19d648eb75ed05392759b0ace1d58a3549e', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: 'f53aa633c113b3d4ee6540230dccce116114f130', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: 'feedfbc3e125e92eb34d58336cbcdbd84f844591', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: 'a6dc3d2455681f65b018aaa7fd27a1c7118da6ec', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '2509378b3ef2c5e3eb4b302983a0ebe6cd9e7669', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '0fb56b363f202225035c05d690c877cec5918fdd', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: 'aab775b1e25cd615e5a899bab6f4267d5efe9ce8', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '4ec6566de892c451950bc4d8ec44bccbebf8cd4c', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: '1656ceed696a5eed8f33cb3d8886fad152b54988', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '4349df4870731eaa463dbf653206711d761cb1ec', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'd4c6ef7373b5ed9a69411c9a7897d11585f0e8db', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '38e770639dd549c2d33f56acaea8b3722520433e', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: '91d0543272629dd0adb4032b45840a8001e531ef', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: '4f72bbbd3ff694d1dd0962eafed8b0cc561814d8', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '22c77a665735e4db4eaff64ed4457f473d7f4681', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, !this.hideDefaultAction && (index.h(index.Fragment, { key: '0ad2debccfe242298f1e79080758d4b144dff58d' }, index.h("wa-tooltip", { key: '44a715264bf619574a02ddb4d13b1f353f36c47d', for: this._id }, "Print PDF"), index.h("ir-custom-button", { key: '6f5e09cc9338afaff900e75e8b33cd103d9623fb', id: this._id, size: "medium", slot: "header-actions", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'f7f559a03af32d16d51dae8ae885db7737a87ab3', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() })))), index.h("slot", { key: '3a76f9cd1b4a8b1be2459df19500a1142a3dde57' })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: 'e6aac19464992ea3ebf29a8ef7b890740f29528b', class: "ir-print-room" }, index.h("header", { key: '196a32df51ebd9b7e29122dc9cd0b76fa738cae6', class: "ir-print-room__header" }, index.h("p", { key: 'ab7579f85733f9a3a90d0327b0a524fb5f358bbe', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: '05d34bd158a11548b880964417a26ae5ce1e933e', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), index.h("p", { key: '256eb0e70cc0bef82f4328bc0cd4068ead60b037', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: 'df2a73c842ab8f126a935f0f92f5f8616d1cbe3a', class: "ir-print-room__body" }, index.h("div", { key: '267eb3ff907b5aa38625b50699634c4db485dbed', class: "ir-print-room__details" }, index.h("div", { key: 'ee3712f34545b78b72b1a96f58a7e4b2f9523eaa', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: 'e0161fedcb51433425a58a706910ac87e7bb9dbd', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: '7b4d3193274a0a00cd8243339b7f65171d22c582', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '2f8231bd96a3e96493a1b007f9ab20d84579604c', class: "ir-print-room__row" }, index.h("div", { key: '04f5d12b912d2c04c845ac2082d0291573befcb5', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: 'bc96ea15e9c51dbb116f641b930245bd5ba6ee31', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: '0cf18ee285dc5f2aeffe2656193559bf734d65e9', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: 'd5fa32dd4242dd0dd5392244f83a18819b04dc2e', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: '71cb422e36f8f8054a2a4722afd65916b2e715fe', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: '7ba3dd6fdc93bdadabeac982fa681a3256b7ab07', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: 'e926c648d0f59f275dcba03db65cbacc821348ec', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: '23a1a45f2e488fd8176aebdb772691dd2388a6fa', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: '301edee40d3e46499195688b42fa72d3d2ff4027', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: 'adba5a58cb60aa4fcb7914b76bb1327350a08d3f', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: 'f95b924fa42596b2bd69cb6047921d70b387c8ef', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: '1160425bfb5cd0791d78cb9a2e09fbfc935fe4cc', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: '8f12a4481e8778e82b69ec4f95e306f357b0bfdf', class: "ir-print-extra-services" }, index.h("h3", { key: 'b5c35f7cf36d57e27f62c25ad6dca8ca9e8a5042', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: 'eaa548f429b24edb2105344ffd1aa0d67beb6153', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '7a699487409c1d7b144cd7f0e3921209cd4d3ff4' }, index.h("div", { key: 'f689222b528ff380d4933a2d72711fed49e3af79', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: 'dce0ec637bd394c231ec106c22743f86da99e484', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '08a53eb65b535ddce3ad056413fb2fe50643637a', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '173850be9721c3ac9cf0ba8b3be06f1d0025bb28', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '044f26068baeca048b7960f233e23384e6affd19', class: "reservation-information__row" }, index.h("ir-label", { key: '6b05f3b3879e8744516dc36316d76dd685f9e529', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: '352aa070a0a524e560bf196b7a8708e4783fa35a', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '6928eb2c0afd7080d99f69e0c3114bdcc7ac9452', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '3dfd17c9b9d0745c7e1f18a46b2f5264f4573f08', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '63dc7bc06ba38b177751131ec936002360fb07be' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: 'f47c35971acb25ee937789d6fe7c19f59382eae5', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '4f1c4506973d0a45ce975379e35405826171ae19', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '2698d2ea2f3837ca1143880f2465552c58e23381', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'bf834f2add73830b7f3cd7a55ca274f69b41df0f', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: '4973061be600faca66c5052c4810b2f6450c3b0f', class: "reservation-information__row" }, index.h("ir-label", { key: 'd32a7f8329778da52e062557da2223ec71f8ba9a', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: 'e6bdf5bf658335a49c3707643f9feed66f1a01d1', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '4ba335450add7185912c39f9c7d9b5e58cf5beda', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'de4c05fba2d1312a5182830c51860dbe70b6c212', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: '1edf25db8b9ed42a8212c98572d12bac65e8f3ba', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'aa2622cb88a60bd3b8c3e087802f70bb13583716', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '50f1b9fffeee086dd17c09c44733e1654055818b', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: 'bbca12c620c4415e0c2a5b2a2561ee31f20bc50d', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '0e6ae6bace5c2ae547032109e8515d83c8cc3059', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '8983ab94daad1713d56b6baf73dd21af17e58d59', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && (index.h("div", { key: '16fd6869d82265079e20ea0c5303d85bc973b140', class: "reservation-information__row" }, index.h("ir-label", { key: '7981ffd013dd288abf22adccf9625b99d4ea93fd', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, display: "flex", content: this.booking.arrival.description }), index.h("wa-tooltip", { key: '6e512f801c3a16aabd77304012b2399d2d8cccb8', for: `edit_arrival_time` }, "Edit arrival time"), index.h("ir-custom-button", { key: 'a1c1c02f307b880c4f09e44f0b4123649e1527b2', iconBtn: true, id: `edit_arrival_time`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irArrivalTimeDialogRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '8cab1d331de32ebe9c40e1d2ad71b9782c37d4d0', name: "edit", label: "Edit arrival time", style: { fontSize: '1rem' } })))), this.booking.promo_key && index.h("ir-label", { key: '1b9e2bd954c1641717b7ef165b95cce0f0e3f50a', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '67b5092f375d16c9bfe24bca34999da529144a5d', class: "d-flex align-items-center" }, index.h("svg", { key: '17bd02861a22d8c36b7a2863a50a5139e1af78f5', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'b5f486f421b1aef0470eef262206e74e8c164bc3', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'df3279db6a3349adc07e43dceb69e7c664fe0749', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '7c35e83b03f8177965004d85860431c5edc1ed28', class: "reservation-information__row" }, index.h("ir-label", { key: '51c62177a1ca8d831bc952aa9582f1c297db6226', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: 'da88f640dd3933ca5c50d3b9823add352794387f', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '1e3a4e08cdaf84ab7a2b03098a89647a4561ddbd', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '0d7b433bdff9da09c0449bf379f4960829e3adde', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '9f39bfcda4183f7a1c70b2b95d80f1527ea1dd60', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: 'd8436ec75b0b092e3f392a44614c5fa121c1bc21', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) })), index.h("ir-arrival-time-dialog", { key: 'b26e40393dc99d90b83257c1cb8375d6e50803c0', booking: this.booking, arrivalTime: this.arrivalTime, ref: el => (this.irArrivalTimeDialogRef = el) })));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f71fdff61d08c2b020e9b6e800407d655e5a37ca' }, index.h("div", { key: 'c42a0e00de27b72a39dd7e9727e71da3deb692db', class: "booking-room__header-row" }, index.h("button", { key: '8fde271bad6cb7033b18824c9da0e5464c5fbc57', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'da4237a291108ebf03c95a57a1341afac1fdfe4f', name: "chevron-right" })), index.h("div", { key: '5a168af85e018ce5c62ec061a3ce16f406abb8e3', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '710f4e87b1bb54bb00564197f40f724acdd31cd1',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '035c29ff960a9cca91d9698be01e5f0e9ba121a4', class: "booking-room__summary-row" }, index.h("p", { key: 'c5606f61855d3f306a4ab86cf907f0b37f7f6be1', class: "booking-room__summary-text" }, index.h("span", { key: '4358f16ff927997ce42c107097fea4ed66306894', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'd8114c27b5753b768dcf44a5ead7f2b319442821', class: "booking-room__price-row" }, index.h("span", { key: 'dc64bff4d6f4ff49d463eaefb7ac06fe5088db77', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: 'e57d5c304d0e048bef18d3011f0ebbc2373f3d71', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: 'a72e5ca84a2831ccbf4097099b9ef1820da2d9a0' }, index.h("wa-tooltip", { key: '67397aeff50cb362d4464571e01d8864fcb0270e', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: '7750f167b77d5ecd25a59ce3d13e3edcb9f918bd', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '08ce40558b25366a1ff202d959dc1f642b87eea7', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: '3173bbe3f5a0dcb57fa749709585604309edc4c1' }, index.h("wa-tooltip", { key: 'a9bbe8f9675460819333f7ebcd0ffd22d121da52', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: '97c5c168f809ef5dc6af39b93c84e648410af1c5', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '8bae895a9209d018cf713218eed303817d0f93c4', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: '19362f45440136f584440d7f200a16d1bb3eb42e', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: 'a21b296794cbddf9cd0ff2a0e56555f7a7fed82a', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: '49929dce0f013c9d0fe297751c8a72e6633ca6cb', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: 'beb5d9ba8254188807c945696f18f39207861c86', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '1d6695b2257d67ba359b86a14ec08a13e2f3aefe', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: 'b9f1417d885d4c80feb345db6334326e6ed4d6b6', class: "booking-room__guest-row" }, index.h("p", { key: '0ca2d30eed3c0448c96b431a04c9f817f338dd5e', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '70285e49115e63e943c6ca5342b605f67af00883', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '249023be7b954d8a636e40158d4b99af3c437a5c', class: "booking-room__departure-row" }, index.h("p", { key: '984e0789d3f65d844e9f1e8932ddf0fc500df502', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: '36801d84445edc3187f6d10726fcd85595743f61', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: '03609559de6290b490d78f93d5eede0d335b007c', class: "booking-room__details-container" }, index.h("div", { key: '0904fd5b6ca788a509c8147f3b2d2fab658ce8de', class: "booking-room__breakdown-row" }, index.h("div", { key: 'd7c6772620e93c08f91df401b3063593736113f5', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: 'f8a4cb97b85b788c7963110f7d457ecec31674be', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '197df02282eb6fca8be6bb5c8e53bfebe49e0564', class: "booking-room__breakdown-table" }, index.h("table", { key: '9e7fd551129588ef38fbd331f97f7fc627bb05ab' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '7ea3f71726ad53031b1f3886d3a5feb72c3a233e', class: '' }, index.h("th", { key: '4dcc31365e1f4450970d5c1e215823a2e96fd8c7', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '82aed8d3deede976a5b4a8faf33eb3cfd967ad84', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '83c8bf35427693a51d599b1a4047cdc755dfaa28', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '6169a038c9eb10bcc36d6050841828a42051b61a', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'df4b4e6a6bf7f9dfd71c1e93ac61e2fcef83a99f' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'ccf490b7b76384be40a2f62ff4a30337df41cda9', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'cffe3821c4ffb040ef0b1ebbe4a9e928e6d1375a', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: 'bf3b7fd182bcc180a674eab3d8aa44bb15288490' }, index.h("ir-label", { key: '055e2efbca674c15b45f58f52b79de6c368a89fe', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'caec372cf1db4defcf213417c3c8e473d9f9f5b2', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: '9b2b4f02b500fb39cf083811f5d02808bf78ab75', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '53ca9a4226c01415c51e095d54c0ea8deed8d910' }, this.renderModalMessage()), index.h("div", { key: '299ba6761aa5c9f79878ae596e8c97ed9d81f92c', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '3b70b0c4fa1f1eac5ca2212d054dec0364d24201', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '818b29f92066982442093bf6d2e3b61b99b38c13', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: 'c63d18f23b16aebcee027fecfe417097e02e949f', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '0ca855c4df8ba35ad80018286dd57fcaef8ef6cf', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: '5ef0d6955caecfa6f060c9f3e70a000ae6a0ce7d', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-room-guests-form", { key: '7e17e11306485f71cccf3e7beee1431c34afa140', sharedPersons: this.sharedPersons, roomName: this.roomName, countries: this.countries, totalGuests: this.totalGuests, identifier: this.identifier, bookingNumber: this.bookingNumber, checkIn: this.checkIn, language: this.language, onLoadingChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            } })), index.h("div", { key: '3ba91aa8c453ca0f26d2bfe57564b397a4a036d5', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'efaddbda6ce4be0fe8777d009374d1903dac798b', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: '16f28c219387718d9615de5503a2e5f2bf83fb4b', value: "save", loading: this.isLoading === 'save', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: '5d69ef5246cc1d55a510ded90a810f24b8f7bc86', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '2b6971a75614eb0508150f227e6d36da522c7985' }, this.showTooltip && index.h("wa-tooltip", { key: '979513b134858c2d11cd7fbe20c74a0a892027a9', for: this._id }, this.unit), index.h("wa-tag", { key: '228bc7759555a07727f971d0d25964d9eb58ef8f', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: 'd2b96b45606f452c926c88e7b7a4acf0ca3f7de4', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
