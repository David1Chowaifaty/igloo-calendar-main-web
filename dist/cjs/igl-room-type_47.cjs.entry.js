...
const index$1 = require('./index-a6d03221.js');
...
const utils$1 = require('./utils-4025a18b.js');
...
const IrAgentBilling = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3b1c974bad469f76c43a3176c17b8162a2ff8a63' }, index.h("div", { key: '16afad274c4491573df024dc9ca7b35aed1210b4', class: "billing__container" }, index.h("div", { key: 'd5638ab2905415fd61999cfd3cd4323df7dba9a2', class: "billing__section-title-row" }, index.h("h4", { key: '9ef1c8c5b0d0a499978de9e4547a00da2c4f95a4', class: "billing__section-title" }, "Issued documents")), index.h("ir-city-ledger-fiscal-documents-table", { key: 'fad801cc7e86011e02c5e51290e5d931678af0b4', class: 'agent-billing__table', rows: this.fiscalDocuments, isLoading: this.isLoading, hasFetched: this.hasFetched, agentId: this.booking?.agent?.id ?? null, currencySymbol: calendarData.calendar_data.property?.currency?.symbol ?? '$', fromDate: this.booking?.from_date ?? null, toDate: this.booking?.to_date ?? null, hasDates: true, ticket: this.tokenService.getToken(), propertyId: calendarData.calendar_data.property?.id, onFetchRequested: () => this.fetchFiscalDocuments() }))));
    }
    ...
    render() {
        if (this.isAgentMode) {
            return (index.h(index.Host, null, index.h("wa-tab-group", { activation: "manual", "onwa-tab-show": e => {
                ...
                }, active: this.currentTab }, index.h("wa-tab", { panel: "guest" }, "Guest"), index.h("wa-tab", { panel: "agent" }, "Agent"), index.h("wa-tab-panel", { name: "guest" }, this.currentTab === 'guest' && index.h("ir-guest-billing", { booking: this.booking })), index.h("wa-tab-panel", { name: "agent" }, this.currentTab === 'agent' && index.h("ir-agent-billing", { booking: this.booking })))));
        }
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '801a6a9f10b368743767874843d92a70b6bf4d60', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: 'e4cb76a8526ee537e326f39ba609cadd58e60e44', booking: this.booking, agent: this.agent })));
    }
};
...
const IrBookingAssignItems = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '562258078f4f5f3f15001936f70297ed3c38bd0c', size: "small" }, index.h("div", { key: '2b1dd6e19c84108ee0db23218582869176f3786e', class: "assign-container" }, index.h("p", { key: '4259f582d27f5d4c91bce482989ef30c471554af', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (index.h("div", { key: 'de0c0286fd799119a4482baf60b7eb57ee9b902f', class: "assign-section" }, index.h("p", { key: '93b1f0d88581cc2d6dc9254faf63915facf9455e', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (index.h("div", { key: 'c37a3417701d495d7f425638e620f6ab221f64e3', class: "assign-section" }, index.h("p", { key: '2e6ba94f8f179fbba470db49f263cad34572b79c', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (index.h("div", { key: '74648447387426c3c0d29ea8ec8188051847f164', class: "assign-section" }, index.h("p", { key: '133c708474fe00ca6d7e9bc77a6d49b92d9ae86b', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
};
...
const IrBookingCityLedger = class {
    ...
    renderTable() {
        ...
        return (index.h("div", { class: "table--container booking-city-ledger__table-wrap" }, index.h("table", { class: "table data-table" }, index.h("thead", null, index.h("tr", null, index.h("th", null, "Status"), index.h("th", null, "Date"), index.h("th", null, "Description"), index.h("th", { class: "text-right" }, "Amount"), index.h("th", null))), index.h("tbody", null, this.folioRows.map(row => (index.h("tr", { key: row._rowId, class: "ir-table-row" }, index.h("td", null, index.h("wa-tag", { size: "small", variant: row.status.variant }, row.status.label, row.status.id === 'billed' && index.h("wa-icon", { name: "lock" }))), index.h("td", { class: "booking-city-ledger__cell-date" }, moment.hooks(row.serviceDate).format('MMM DD, YYYY')), index.h("td", { style: { width: '100%' } }, row.description || '—'), index.h("td", { class: "text-right " }, row.debit !== null && index.h("span", { class: 'is-debit' }, row.debit ? this.formatAmount(row.debit) : ''), row.credit !== null && index.h("span", { class: 'is-credit' }, row.credit ? this.formatAmount(row.credit) : '')), index.h("td", null, row.status.id !== 'billed' && row._raw.CATEGORY === null && utils$1.actionableClTypes.has(row._raw.CL_TX_TYPE_CODE) && (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
...
const IrBookingDetails = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, !this.is_from_front_desk && (index.h(index.Fragment, null, index.h("ir-toast", { style: { height: '0' } }), index.h("ir-interceptor", { style: { height: '0' } }))), index.h("ir-booking-header", { booking: this.booking, hasCloseButton: this.hasCloseButton, hasDelete: this.hasDelete, hasMenu: this.hasMenu, hasPrint: this.hasPrint, agent: this.agent, hasReceipt: calendarData.calendar_data.property.is_frontdesk_enabled, hasEmail: ['001', '002'].includes(this.booking?.status?.code) }), index.h("div", { class: "booking-details__booking-info" }, index.h("div", { class: "booking-details__info-column" }, index.h("ir-reservation-information", { arrivalTime: this.arrivalTime, countries: this.countries, booking: this.booking }), index.h("ir-booking-rooms", { booking: this.booking, agent: this.agent, propertyId: this.property_id, language: this.language, departureTime: this.departureTime, bedPreference: this.bedPreference, legendData: this.calendarData.legendData, roomsInfo: this.calendarData.roomsInfo, hasRoomAdd: this.hasRoomAdd, hasRoomEdit: this.hasRoomEdit, hasRoomDelete: this.hasRoomDelete, splitIndex: this.splitIndex, onRoomDeleteFinished: this.handleDeleteFinish }), index.h("ir-pickup-view", { booking: this.booking, agent: this.agent }), index.h("section", null, index.h("ir-extra-services", { language: this.language, svcCategories: this.svcCategories, booking: this.booking, agent: this.agent }))), index.h("ir-payment-details", { class: "booking-details__info-column", propertyId: this.property_id, paymentEntries: this.paymentEntries, paymentActions: this.paymentActions, booking: this.booking, agent: this.agent, svcCategories: this.svcCategories, isAllServicesAgentOwned: this.isAllServicesAgentOwned() })), index.h("ir-dialog", { label: "Send Email", onIrDialogHide: e => {
                ...
                e.stopPropagation();
                this.sidebarState = null;
            }, booking: this.booking, agent: this.agent }), index.h("ir-guest-info-drawer", { onGuestInfoDrawerClosed: () => {
                this.sidebarState = null;
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'ee0301fd9e42db5ca048bebfb2bebdf8343a24bf', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (index.h("ir-booking-editor", { key: '48fbca64b7d33203cf1da7a63510a7d4ab2524a0', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), index.h("div", { key: 'c5d238f500943a1d626d176ae6216ab9d1d3faba', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
...
const IrBookingEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'b2443f34ea8bbfe48fb2449fe2d04f68c4e69358', class: "booking-editor__guest-form", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                this.doReservation.emit(submitter?.value);
            } }, index.h("div", { key: 'dd30de34787727c2443ca81c95bbdc4681ae4a22', class: "booking-editor__header" }, index.h("ir-date-view", { key: 'b1b58319d984e55db850886406b40dabdf821d18', class: "booking-editor__dates mr-1 flex-fill font-weight-bold font-medium-1", from_date: dates.checkIn, to_date: dates.checkOut, dateOption: "DD MMM YYYY" }), this.totalRooms > 1 && (index.h("div", { key: '6ff17e99d9327c85d0384ecb14849ea74f9b1de2', class: "booking-editor__total mt-1 mt-md-0 text-right" }, index.h("span", { key: 'cc67e289dfd50ca05e78722ee8c8a3c67dab44f4', class: "booking-editor__total-label" }, locales_store.locales.entries.Lcz_TotalPrice), ' ', index.h("span", { key: '3c5f44c967a0d223ebbfeb1e9ae3c1e7f3271497', class: "booking-editor__total-amount font-weight-bold font-medium-1" }, utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.totalCost))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
        ...
        })), this.bookingEditorService.isEventType(['BAR_BOOKING', 'PLUS_BOOKING']) && (index.h("section", { key: '1cb1106a6514177fc1bad24fb6b88e4fb9d732ff', class: 'mt-2' }, index.h("div", { key: 'fd4e48a94432227f58519bc6b33ade964445566d', class: "booking-editor__booked-by booking-editor__booked-by-header" }, index.h("h4", { key: '98d223b6f4d97dff2d1dfdb3dfd340eb0a33d69c', class: "booking-editor__heading booking-editor__booked-by-title" }, "Booked by"), booking_service.booking_store.bookingDraft?.agent ? (index.h("span", null, booking_service.booking_store.bookingDraft?.agent.name)) : (index.h(index.Fragment, null, index.h("ir-picker", { class: "booking-editor__booked-by-picker", appearance: "filled",
            ...
            }, variant: "brand" }, "Clear user"))))), index.h("ir-booking-editor-guest-form", { key: 'b27b4f430074541e056034488585e457923d60c8' }))), this.bookingEditorService.isEventType(['SPLIT_BOOKING', 'ADD_ROOM']) && functions.isAgentMode(this.resolvedAgent) && (index.h("ir-service-assignee-select", { key: '55dd736c216111a169146f836f4b4bebc673fe0d', style: { maxWidth: '500px' }, agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrBookingEditorGuestForm = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '168f6106863575417e86449d5638059a4dee81b2' }, index.h("section", { key: '15d3d0b1a57fbe2ad04a03ca64b6e673ef07ed80', class: "booking-editor__form-control" }, index.h("ir-input", { key: '9095a84a6430a626639925a93cc8ca89d9b04bc3', label: "Email address", "onText-change": e => booking_service.updateBookedByGuest({ email: e.detail }), mask: 'email', value: bookedByGuest.email, defaultValue: bookedByGuest.email, placeholder: "Email (leave empty if not available)" }), index.h("div", { key: '4c584d75aa207f09ed79e826a69ea7669741a073', class: "booking-editor__guest-name-group", id: "booking-editor-guest-name-group" }, index.h("ir-validator", { key: '9cf5a3fd7b323a7d97e09b44b13365bd2e81e5f9', class: "booking-editor__guest-input-validator", value: bookedByGuest.firstName, schema: BookedByGuestSchema.shape.firstName }, index.h("ir-input", { key: 'a303cff23f4523b4f1446e2881eaa7907467695d', id: "booking-editor-guest-first-name", class: "booking-editor__guest-input --first-name",
            // label="Name"
            value: bookedByGuest.firstName, defaultValue: bookedByGuest.firstName, placeholder: "First name", autocomplete: "off", "onText-change": e => booking_service.updateBookedByGuest({ firstName: e.detail }) }, index.h("p", { key: '2d79aa960e3ecee895b6d55b4d34f2464cb2d78a', style: { margin: '0', marginBottom: '0.5rem' }, slot: "label" }, index.h("span", { key: 'f252fdbf8db6b86fb27fecde064981fae1e1f3b6', class: "booking-editor__guest-input-label --first-name-pc-label" }, "Name"), index.h("span", { key: 'b3b8ba775b89cdce98ca14928e05724a6294f595', class: "booking-editor__guest-input-label --first-name-mobile-label" }, "First name")))), index.h("ir-validator", { key: '4c642d9eeec1074d6e06dcb001a4117cee5ea0bb', class: "booking-editor__guest-input-validator", value: bookedByGuest.lastName, schema: BookedByGuestSchema.shape.lastName }, index.h("ir-input", { key: '807d99728e97dac6259ff3fb1b9e295d3fd3f669', id: "booking-editor-guest-last-name", class: "booking-editor__guest-input --last-name", label: "Last name", "onText-change": e => booking_service.updateBookedByGuest({ lastName: e.detail }), value: bookedByGuest.lastName, defaultValue: bookedByGuest.lastName, placeholder: "Last name", autocomplete: "off" }))), booking_service.booking_store.bookingDraft.agent ? (index.h("ir-input", { label: "Booking code", placeholder: "", value: bookedByGuest.bookingCode, defaultValue: bookedByGuest.bookingCode, "onText-change": e => booking_service.updateBookedByGuest({ bookingCode: e.detail }) })) : (index.h("ir-input", { label: "Company name", placeholder: "Company name", value: bookedByGuest.company, defaultValue: bookedByGuest.company, "onText-change": e => booking_service.updateBookedByGuest({ company: e.detail }) })), index.h("ir-country-picker", { key: 'e15719a2d1df48b6469ae033392af57ec6aee0f6', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.updateCountry(e), countries: selects.countries, country: selects.countries.find(c => c.id.toString() === bookedByGuest.countryId?.toString()) }), index.h("ir-mobile-input", { key: 'ecb947651783ccaea82837591eb4361c1e74b985', size: "small", "onMobile-input-change": e => {
                booking_service.updateBookedByGuest({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => booking_service.updateBookedByGuest({ phone_prefix: e.detail.phone_prefix }), value: bookedByGuest.mobile, countryCode: selects.countries.find(c => c.phone_prefix === bookedByGuest.phone_prefix)?.code, countries: selects.countries }), index.h("wa-select", { key: 'a8cb49be106a3d3ebf031e6820d8ee69ed3ce32d', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", id: v4.v4(), defaultValue: selects.arrivalTime[0].CODE_NAME, value: bookedByGuest.selectedArrivalTime, onchange: event => booking_service.updateBookedByGuest({ selectedArrivalTime: event.target.value }) }, selects.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: bookedByGuest.selectedArrivalTime === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("section", { key: '1643c6205cde4a5bef66b86d4dde2f87ed2976ea', class: 'booking-editor__form-control' }, index.h("wa-textarea", { key: '66fb421e04781119c239747fa86fb8e94f9fdcc3', onchange: event => booking_service.updateBookedByGuest({ note: event.target.value }), size: "small", value: bookedByGuest.note, defaultValue: bookedByGuest.note, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 3 }), (!agent || agent?.payment_mode?.code === '002') && (index.h(index.Fragment, { key: '3eb0ca9ced57214b670fd4f0c62c217bf914b82d' }, this.paymentMethods.length > 1 && (index.h("wa-select", { key: 'f850422f3953f2711cd714034733d5b65720733d', label: 'Payment Method', size: "small", defaultValue: booking_service.booking_store?.selectedPaymentMethod?.code ?? this.paymentMethods[0].code, value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: 'f097d4e8d2f039057c6971daa39f24f71e8dfaa4' }, index.h("ir-input", { key: '5e9acd2100f2fb837924c6befdbe446487b11b9e', value: bookedByGuest.cardNumber, defaultValue: bookedByGuest.cardNumber, "onText-change": e => booking_service.updateBookedByGuest({ cardNumber: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: 'd41e834c7d3934d4c6a83b93353acf36550522d9', value: bookedByGuest.cardHolderName, defaultValue: bookedByGuest.cardHolderName, "onText-change": e => booking_service.updateBookedByGuest({ cardHolderName: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: 'd73c77c7d556891e290f95b4b5293330307d01f6', "onText-change": e => {
                const [month, year] = e.detail.split('/');
                booking_service.updateBookedByGuest({
                    expiryMonth: month,
                    expiryYear: year,
                });
            }, value: this.expiryDate, mask: this.expiryDateMask, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h(index.Fragment, { key: 'c4d77dee0983fac3dd6e066dd8cb51230761811c' }, index.h("style", { key: 'a4f1fe8fb3798aa5e678218201e6ce8420a5aed6' }, `p{
              margin:0;
              padding:0}`), index.h("div", { key: 'f7a8b25a94fc2b0ef8042261f4f0deaa3ca2d261', class: "booking-editor__payment-info-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description }))), index.h("wa-checkbox", { key: '9bc1a45b95aa792060ccba903edabdf2246743c2', defaultChecked: bookedByGuest.emailGuest, checked: bookedByGuest.emailGuest, onchange: event => booking_service.updateBookedByGuest({ emailGuest: event.target.checked }) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
...
const IrBookingEditorHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cc14f4e6c10443415d0839bcbe280c76e7c87f3d' }, index.h("form", { key: 'ecf58e83fe56837c76e083509049826931c89114', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (index.h("ir-validator", { key: 'ebd681441061f39451b64d4e17d71534eca959b7', value: booking_service.booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, index.h("ir-picker", { key: 'f838e7ed0cb9161a4630a59d715624f8cc0761de', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales_store.locales.entries.Lcz_Tobooking}#`,
        ...
        })))), index.h("div", { key: '2ce11600b09dbbb1b2313bf859da5302f869d7e4', class: "booking-editor-header__container" }, !this.bookingEditorService.isEventType(['EDIT_BOOKING', 'ADD_ROOM', 'SPLIT_BOOKING']) && (index.h("wa-select", { key: '1914f64a6d3ccd7bcadbc7b4ce10160336ccaac3', size: "small", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_service.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_service.booking_store.bookingDraft.source?.id, "onwa-hide": this.stopEvent.bind(this), onchange: this.handleSourceChange.bind(this) }, sources.map(option => (option.type === 'LABEL' ? index.h("small", null, option.description) : index.h("wa-option", { value: option.id?.toString() }, option.description))))), index.h("ir-validator", { key: '0f90148a8a6a04883f63b759501abd981dba986d', class: "booking-editor__date-validator", showErrorMessage: true, value: booking_service.booking_store.bookingDraft.dates, schema: this.datesSchema, style: { position: 'relative' } }, index.h("ir-date-range", { key: 'b4f86b2e90c541fb30d7a1f615a3d6164296801d', class: "booking-editor__date-range", defaultData: {
                fromDate: checkIn?.format('YYYY-MM-DD') ?? '',
                toDate: checkOut?.format('YYYY-MM-DD') ?? '',
            }, variant: "booking", withDateDifference: true, minDate: this.minDate, maxDate: this.maxDate, onDateRangeChange: this.handleDateRangeChange.bind(this) })), !this.bookingEditorService.isEventType('EDIT_BOOKING') && (index.h(index.Fragment, { key: '12f770dfdd7b41e6a2c0f2a97124050fbe8c2fec' }, index.h("ir-validator", { key: '6bbdb5fa71c70d7bd092f545b6d57301e8ec314e', value: adults, schema: this.adultsSchema }, index.h("wa-select", { key: '166dab866678ff268c6fec4598db832d20f87e89', class: "booking-editor-header__adults-select", size: "small", placeholder: locales_store.locales.entries.Lcz_AdultsCaption, value: adults?.toString(), defaultValue: adults?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleAdultsChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.adult_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))), calendarData.calendar_data.property.adult_child_constraints.child_max_nbr > 0 && (index.h("wa-select", { key: '4fc817e0f4f0f127538f0b04b607d48336684141', class: "booking-editor-header__children-select", size: "small", placeholder: this.childrenSelectPlaceholder, value: children?.toString(), defaultValue: children?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleChildrenChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.child_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))))), index.h("ir-custom-button", { key: '4c2f7414a20eecd3c1dde04d3e0635a34e1d1db2', loading: this.isLoading, type: "submit", variant: "brand" }, "Check")), booking_service.booking_store.roomTypes?.length > 0 && !this.isLoading && (index.h("wa-callout", { key: 'ec7dada476e1d663c8c0240307135a24cdd224bd', size: "small", variant: "neutral", appearance: "filled", class: "booking-editor-header__tax_statement" }, calendarData.calendar_data.tax_statement)))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"],
        "mode": ["handleModeChange"]
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1e07ecaaa984ebd6450e1ac6cc422c1390488a00', class: "booking-header" }, index.h("div", { key: 'c52f922e309484402ce598b4a95147ccbadf5013', class: "booking-header__row" }, index.h("div", { key: 'ad3b27b35dafbe181cdffd9002dbca519d61d7b1', class: "booking-header__info" }, index.h("div", { key: 'bb054fd50896287d83196c1ec11cae29dcfcf981', class: "booking-header__title" }, index.h("div", { key: '1094ee77f2d2292a4ac7c2fb35741e9269320d70', class: "booking-header__label-container" }, this.hasMenu && (index.h(index.Fragment, { key: 'bc283a69cec0f3ae0b9c0dc95e82eb90af5f5f0c' }, index.h("wa-tooltip", { key: '93dd231423dedc67144330dc3b5fad7c41e2b9c9', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: 'b915b9fa4b6e5527e61a8f42016b40163cb0dcb5', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '4704d09c020be05b9c409722448b385d6c08155c', name: "arrow-left", style: { fontSize: '1.2rem' }, label: "Go back" })))), index.h("wa-avatar", { key: '6403d7758588ee8fea6b27de4223d74595466ec7', shape: "circle", initials: this.initials, image: this.avatarImage, loading: "lazy" }), index.h("div", { key: '110ace5fd549994f758edc66a16f7d9ee3ac6b60', class: "booking-header__identity" }, index.h("div", { key: '15dfcb69c67f42a9edc9630435b2151a2b901936', class: 'booking-header__label' }, index.h("h4", { key: '1d2b28fe49f81818d6693e6c19c9dea5058233ff', class: "booking-header__label-number" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`)), index.h("div", { key: 'e0ccfacb00929455d7e59cb22954461edf69a37d', class: "booking-header__meta" }, index.h("p", { key: '22f56d14cf702861a9797fcf4fa059fc2cf4b8f8', class: "booking-header__channel-number" }, this.booking?.agent ? (index.h("span", null, "Agent:", ' ', index.h("p", { class: 'truncate p-0 m-0', style: { maxWidth: '150px', display: 'inline-flex' } }, this.agent.name, " ", this.agent.reference))) : (this.booking.origin.Label)), !this.booking.is_direct && index.h("p", { key: '392871c8f54df4394d0b173770400d4ec7649d85', class: "booking-header__channel-number" }, this.booking.channel_booking_nbr), index.h("ir-custom-button", { key: 'b70ceec7c148c0ec461c9334841a690c2ad7f6c5', link: true, onClickHandler: () => this.bookingSourceEditor.openDialog() }, "Change source"), lastManipulation && (index.h(index.Fragment, { key: '7527a77611cbd692831504bcc0d9aaea4ed15bdf' }, index.h("p", { key: 'f3ef0a071673cae2ec38f6c98ab2076c58f38fb1', id: `booking-${this.booking.booking_nbr}-modified`, class: "booking-header__modified" }, "Modified"), index.h("wa-tooltip", { key: 'fe3141967b731642242411e02c9ae0c868c15ac1', for: `booking-${this.booking.booking_nbr}-modified` }, index.h("div", { key: '1028e37c0d67fa26d1452789a6b87faac2a45428' }, index.h("p", { key: '3c2dcc7b9a6490656304a3085389b5770210e8d3', class: "m-0" }, "Modified by ", lastManipulation?.user, " at ", lastManipulation?.date, " ", lastManipulation?.hour, ":", lastManipulation?.minute, "."), index.h("p", { key: '77989ba2c3886b9ec4638290d7ba8f6b17ffacb2', class: "m-0" }, this.alertMessage)))))))))), index.h("div", { key: 'a764f89ca6fee0703b4582e298d42bc4aae2ba6e', class: "booking-header__actions" }, index.h("div", { key: '9682961fb1970a0faf509b1c2388e6ee23f47726' }, this.booking.allowed_actions.length > 0 && this.booking.is_editable ? (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            appearance: 'outlined', size: "small", variant: "brand", class: "booking-header__status-trigger" }, index.h("ir-booking-status-tag", { slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", null, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))) : (index.h("ir-booking-status-tag", { status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }))), functions.isAgentMode(this.agent) && (index.h(index.Fragment, { key: 'acf4ed524efd469cf5c649854ffe7f592f3b569d' }, index.h("ir-custom-button", { key: 'e1378a286320c0ba9db0b08be1203f8b817f6dbf', onClickHandler: e => {
            ...
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "warning" }, "Force city ledger"), index.h("ir-custom-button", { key: 'a096e04515aec35939fa4ebf857a30ca611b6289', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.invoiceDialogRef.openModal();
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Invoice to agent"))), index.h("ir-custom-button", { key: '7df879d9a35b8ef1022e6c118fbe905884969762', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Logs"), showPms && (index.h("ir-custom-button", { key: '0db7e66cde6ae90cdff5f81ff86a8c8abcbdc851', class: "booking-header__stretched-btn", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: '4c60331c01d49726c8a97d7d91a5bdf7158b5c0d' }, index.h("ir-custom-button", { key: '689d0fb01fce6855c63dc8707992fa2270023933', class: "booking-header__stretched-btn", id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '0e636caf0891d64af981e54845c94f00af0a7169' }, index.h("wa-tooltip", { key: '2766a19bf4bd2247d212ee5a84989b82f5f4bd12', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: 'cd3de0e9ed8ce646ed255cb4229f9dfe9b1f9acc', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '650bc01d4a5e87404fe3986a7dab2b12571c938d', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: 'd0f0385733089d626f252b0e6655bf533edb6061' }, index.h("wa-tooltip", { key: '21d73b2c006a47eea0b8b597294bbe59b52843f3', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '349eef7acc0832b66dc1fc0cff913425990673e7', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'ea9edcce9505329b31445f51ae38da433804b1aa', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '2544004794e1b7c6d1d3e79e9818fdffd9204445' }, index.h("wa-tooltip", { key: '5c3f16bc3620058ac2d26a73d4d38e4b21f4ce98', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '7dbfe49ae91f8f29d043c1b7612e07d0e077c475', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '20c9b31af1d3e2c2da100036cfacc3e7ef7c530b', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '0ab167caa4c0e18f6f881d550e437052f3dafae4', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'e43606648ae5a78cf05dcdc14abdf142fe0f00b3', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '272533ae486e19b37410f34162f37b5cd339a0be', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '00b09592e91331904ddc50e671f1381fdac46e89', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '185fc0536814d81f9cf1084a94dae7df10a32697' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: '0ca4067d121f74f717bb486632202e62309b43d9', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '82afff35fe22a12672adf3f47048704cbecbfe79', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '796107a5abae9995817dd80f0710b0dedf102396', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
            }, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status') }, locales_store.locales?.entries?.Lcz_Confirm))), index.h("ir-booking-source-editor-dialog", { key: '3f04388ab63fc37d2d039d8b1daaa45e63b58f41', booking: this.booking, ref: el => (this.bookingSourceEditor = el) }), index.h("ir-cl-invoice-dialog", { key: '7daafa30e8bb453b0202e9ff8a6301c373ec2789', mode: "booking", agentId: this.booking.agent?.id, bookingNbr: +this.booking.booking_nbr, startDate: this.booking.from_date, endDate: this.booking.to_date, currencyId: calendarData.calendar_data.property.currency.id, ref: el => (this.invoiceDialogRef = el) })));
    }
};
...
const IrBookingSourceEditorDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'e7713f3998be569ffb489f25ea10eb7d57107727', label: "Change Booking Source", onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, open: this.open }, this.open && (index.h("ir-booking-source-editor-form", { key: 'e2b8b8934721614a1a8ebfe80d1458e7ca189457', booking: this.booking, onBookingSourceSaved: () => {
                this.closeDialog();
                setTimeout(() => this.resetBookingEvt.emit(null), 100);
            }, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'a7df0bd76d2d064026e1f8c3bf73d0db813d86e5', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '73a1c8472a3c5c11c7c8ab7afcf66597ea330230', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: 'c52676f25f4b064a699d3f1148ba2b933ac54c2d', type: "submit", form: `change-source-form-${this.booking?.booking_nbr}`, size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading }, "Save"))));
    }
};
...
const IrBookingSourceEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '25be13123bdb202ee0bf139d6fbf8f92d1a72a5b', id: `change-source-form-${this.booking?.booking_nbr}`, onSubmit: this.handleSubmit.bind(this) }, index.h("wa-select", { key: '4597a079e7b92b214e3df8f1021b966af0b41ef1', label: "New source", onchange: this.handleSelectChange.bind(this), size: "small", value: this.selectedSource?.id, defaultValue: this.selectedSource?.id }, calendarData.calendar_data?.property?.allowed_booking_sources?.map(option => option.type === 'LABEL' ? (index.h("small", { key: option.id }, option.description)) : (index.h("wa-option", { key: option.id, value: option.id?.toString() }, option.description)))), isAssign && index.h("ir-booking-assign-items", { key: '1d810d61bd964acdd5684eb42cee5452df94a703', items: this.buildAssignableItems(), onBookingSelectionChange: e => (this.checkedItems = e.detail) })));
    }
    static get watchers() { return {
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '9018a7e7de24f55be651cc5fd18afd0f66310c1c', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCheckoutDialog = class {
    ...
    detectEarlyCheckout() {
        ...
        this.isEarlyCheckout = today.isBefore(toDate, 'day');
    ...
    renderEarlyCheckoutContent() {
        ...
        const total = this.remainingTotal;
        return (index.h("div", { class: "early-checkout" }, index.h("wa-callout", { class: "ec-summary", size: "small", appearance: "filled", variant: "neutral" }, index.h("div", { class: "ec-summary__row" }, index.h("span", { class: "ec-summary__label" }, "Unit"), index.h("span", { class: "ec-summary__value" }, unitName)), index.h("div", { class: "ec-summary__row" }, index.h("span", { class: "ec-summary__label" }, "Original departure"), index.h("span", { class: "ec-summary__value" }, moment.hooks(this.room.to_date, 'YYYY-MM-DD').format('ddd, MMM D, YYYY'))), index.h("div", { class: "ec-summary__row" }, index.h("span", { class: "ec-summary__label" }, "Checking out"), index.h("span", { class: "ec-summary__value" }, moment.hooks().format('ddd, MMM D, YYYY'))), index.h("div", { class: "ec-summary__row" }, index.h("span", { class: "ec-summary__label" }, "Nights reclaimed"), index.h("span", { class: "ec-summary__value ec-summary__value--accent" }, remainingCount, " ", remainingCount === 1 ? 'night' : 'nights'))), index.h("div", { class: "ec-section" }, index.h("p", { class: "ec-section__title" }, "Reclaimed Nights"), index.h("div", { class: "ec-nights" }, this.remainingDays.map(day => (index.h("div", { key: day.date, class: "ec-nights__row" }, index.h("span", { class: "ec-nights__date" }, moment.hooks(day.date, 'YYYY-MM-DD').format('ddd, MMM D')), index.h("span", { class: "ec-nights__amount" }, this.formatAmount(day.amount))))), index.h("div", { class: "ec-nights__subtotal" }, index.h("span", null, "Subtotal"), index.h("span", null, this.formatAmount(total))))), index.h("div", { class: "ec-section" }, index.h("ir-input", { label: "Cancellation Penalty", mask: "price", value: this.initialPenaltyStr, defaultValue: this.initialPenaltyStr, min: 0, max: total, hint: "Pre-filled from reclaimed nights. Modify to apply a discount or waive entirely.", "onText-change": (e) => {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'abcf548b7a7ab1e0e39a30598c2907f25e416804', open: this.open, label: isEarly ? 'Early Check-Out' : 'Check-Out', style: { '--ir-dialog-width': isEarly ? 'min(36rem, calc(100vw - 2rem))' : 'fit-content' }, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.buttons.clear();
                this.checkoutDialogClosed.emit({ reason: 'cancel' });
            } }, this.isLoading === 'page' ? (index.h("div", { class: "dialog__loader-container" }, index.h("ir-spinner", null))) : this.isEarlyCheckout ? (this.renderEarlyCheckoutContent()) : (index.h("p", { style: { width: 'calc(31rem - var(--spacing))' } }, "Are you sure you want to check out unit ", this.room?.unit?.name, "?")), index.h("div", { key: 'bb5ee016ea27a61687d4a6e70ea93310f8b404c4', slot: "footer", class: "ir-dialog__footer" }, index.h(index.Fragment, { key: 'd86441502c943f37a11d5e9b9d01b580bb377fa9' }, index.h("ir-custom-button", { key: '6f0cc9621e261c04ceb564636f8aea9f886c84e7', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Cancel'), this.buttons.has('checkout') && (index.h("ir-custom-button", { key: '7237fecf3d8d9d547df80bc69242520b7da4ad55', size: "medium", onClickHandler: e => this.checkoutRoom({ e, source: 'checkout' }), variant: 'brand', loading: this.isLoading === 'checkout' }, isEarly ? 'Confirm Early Check-Out' : 'Checkout')), this.buttons.has('checkout_without_invoice') && (index.h("ir-custom-button", { key: 'f65f55f5e08e2a67252ec8bf383942865acff4b8', loading: this.isLoading === 'skipCheckout', size: "medium", onClickHandler: e => this.checkoutRoom({ e, source: 'skipCheckout' }), variant: 'brand', appearance: this.buttons.has('invoice_checkout') ? 'outlined' : 'accent' }, "Checkout without invoice")), this.buttons.has('invoice_checkout') && (index.h("ir-custom-button", { key: '20c10de7a5a637bd4558da30b1392ebb74de1b83', size: "medium", loading: this.isLoading === 'checkout&invoice', onClickHandler: e => {
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '99ef4dabf5872a7eb98a79138b377b6e7b545341' }, index.h("div", { key: 'f1411423b55a9d597f65471122a8c61608ba1eff' }, index.h("div", { key: '4e9f7fb7ea292e5cfa3abfd8038ba0b850e53077', class: 'extra-service-container' }, index.h("p", { key: '765a7947098ace94db71c8a973b9d66972ead4df', class: "extra-service-description" }, this.description), index.h("div", { key: 'f3f0352615aa4387fe89678ad645fe98608ff45f', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: '0fe44bb536dadb9deaeb23e72e1e7dbdab9bebec', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("wa-dropdown", { key: 'f0402a4c3a0c289311a4357e3d007d201679407b', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: 'c57954bce5a6053399f128fea52e8c54bd92e743', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.service.system_id}`, iconBtn: true, style: { marginBottom: '4px' }, variant: "neutral" }, index.h("wa-icon", { key: '24a9d4a4b2319c83e29aa7c1d254950c9b49bada', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), index.h("wa-dropdown-item", { key: '36bbfaf1b9bb4b872d5fc9e7325f345498dd3a36', value: "edit" }, "Edit"), agentMode && index.h("wa-dropdown-item", { key: '1945f0e3ef287587f2be0965e7bba19a2d16be6e', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), index.h("wa-dropdown-item", { key: '408728098f25e3ee3b0e14375ec8b01e3569185d', value: "delete", variant: "danger" }, "Delete")))), index.h("div", { key: '14d9973d7932da6da2a52d25fac6fbd53a6b2c6b', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-assignment-toggle-dialog", { key: '8445d855822b2458728c449580802c3b80eec731', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, index.h("span", { key: '5581c3c79bade6004339c018176863a0c8d98d9e', slot: "message" }, "Re-assign ", this.description, " ", index.h("br", { key: '6d7d56d1a78a4e6314b25f5aa10455dadc48e943' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", index.h("b", { key: '737c1b0d72e62d28263e64e8136a93cd81c68348' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), index.h("ir-dialog", { key: '332ce339f0ea032ed7ae83aaaf22a8d45b441704', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: '790154a9a1fb5f19b72e1fe0b7bbda2581c0e209', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'aee44647f4b260f010ca1ab70bb9351b5b242c89', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '34e4505acd566047c16834775645f2c39d3d6bf3', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '80ba341bbf23875b2bbc327d85802ed52ce6ff83', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '176de8bb6cdf0dded8fe247b6259552cc86bbecc', language: this.language ?? 'en', svcCategories: this.svcCategories, onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, agent: this.agent, service: this.service })), index.h("div", { key: '14cb85b6a044304cab48e54dba54f78be492e23c', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '29b1ecb8015967f077f60345dc894ad5ff5418f2', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '896b67ef310398947b28b5859fdbecff8d9e539d', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: 'e052c2c7b9a14cd64628d6aed0071a54a77ef0b0', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (index.h("ir-validator", { key: 'cb7d0ecbd878e905cf424f10a1b807ae2aab5b13', value: this.s_service?.category, schema: utils.ExtraServiceSchema.shape.category }, index.h("wa-select", { key: 'ee549ec8322b69327bb1d2ee05975ebdc4ec0ccf', size: "small", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), index.h("ir-validator", { key: '27f67f44f1c5a8e727e8e928c392d895d053652e', id: "amenity description-validator", schema: utils.ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '06f953db8ccfdfd85bfd4ab9dc4717b49320ee4a', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: '217d136910516c86d463766c036c0277a7f95875', value: this.s_service?.start_date ?? null, schema: utils.ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: '64afc84584a6f6eab3f90fe459cd380e52ddf5e0', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: 'd16d78d175f3cc1de36546c15d77b3a3f8a8169a', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'e648dfe76db177e11572b11b9f3466cbcd34df6b', value: this.s_service?.price ?? null, schema: utils.ExtraServiceSchema.shape.price }, index.h("ir-input", { key: 'a301fa294830fd71a84ae0eff2dd4255d7453510', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales_store.locales.entries.Lcz_Price} (including tax)` }, index.h("span", { key: '1d85c53bae7d92e40d69c75e212f34870fc3a418', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '7e92445bdfadd4772ba6883c41f66af178b07cda', value: this.s_service?.cost ?? null, schema: utils.ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '8b7deeefc8fd45cfea4f1029c4730b7630afa132', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales_store.locales.entries.Lcz_Cost} (optional)` }, index.h("span", { key: '63d822b3c0b72dfbd0bcea3c2a866007d235f9bc', slot: "start" }, this.booking.currency.symbol))), functions.isAgentMode(this.resolvedAgent) && (index.h("ir-service-assignee-select", { key: '03199fff481dd2f0c018c05c51ced5c7e2ba9303', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
...
const IrGuestBilling = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: "billing__container" }, index.h("section", null, index.h("div", { class: "billing__section-title-row" }, index.h("h4", { class: "billing__section-title" }, "Issued documents"), index.h("ir-custom-button", { variant: "brand", id: this._id, onClickHandler: e => {
                ...
                e.stopPropagation();
                this.isOpen = 'invoice';
            } }, "Issue invoice")), index.h("div", { class: "table-container" }, index.h("table", { class: "table data-table" }, index.h("thead", null, index.h("tr", null, index.h("th", null, "Date"), index.h("th", null, "Number"), index.h("th", { class: "billing__price-col" }, "Amount"), index.h("th", null))), index.h("tbody", null, this.invoices?.map(invoice => {
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '8d94a1794ddba471f5981210e01f038d1a1b6ad8', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: '0937e0ffcdc280ceab5a939a502189b0e09715d0', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: 'ac1a7d101b6b9231f33049cd764fa42e366be7c3', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'd6b5a4f84c8fb0a9f3b09fffc137faf0932f0b55', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '678f6ab45665f29bf53220d441bd98d7d6d7dfcb', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '48bd77a7ba2ab14e9c265f10a95e66cdba949f24' }, index.h("ir-drawer", { key: '4eb3f4e4f4d8a292bb8f48545950038f7e008692', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: 'f12fbd682940b72535dedb9a61a009d756c1ac3d', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'e3c7caf2af061043d52462c4205e8cd1a0f4a1e6', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: '1629043c7824a3b071c822e090c982dedbbb77fc', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'a47fe1695f0b4c64d6e3383e6ba3f773af3f44b2', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '86865c548086d1e82c3eb6e37f0baa04eb499d7d', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: 'f1dc0c0f36cf78041b5518e01d4e1284c8d33a49', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '3a7844a15ba0f917d3cb76971d467e9ebb57484d', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: 'a5446f568b5ed1ec942b6a52a15bb3267c2e7dce', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'd777e8013cdfb1aa54b80b1f2569de7c87017138', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '056ce1cea922d234067eb9863fc0b7460ea89683', booking: this.booking, formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'b0c6fec7f315df00da1eaf766f8f6138e349b433', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: 'c9c8a57a01e1b18fd96ded812cfbbd89b9c627f9', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: 'f1eec2865b9c5afb43fa03a8f2f774b4c99d0d0b', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: 'd1ae72302294e9e89d9f00b8dc7957ebb4e493bd', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '851f0a58db20d170e665c19866c55bc51d947682', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '16a67db8c9909527b29cf19e8727aeaf08b6cdb9', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '9ae0040c6296a5fe9c3d7c28dc52ce174158b2d6', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'bbfe4cf849737a52c7734927cc3f3a55381b3803', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: '3bd41e4379e49e476b52966bec492a200cf116f5', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '251dbc130c9737ececcb0a1b1cb7db1946254811', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '288d54a8d4bbe11afe084b752fac20f3932ac0f2', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '4486ca299575cf4a371001a67ad8f92113f601e4', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'b4c218fe98928dbf17694fb7dfe8169f9dbb6645', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '896e8ae5d65c7314e04177619b40c50a1b88fb03', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '56fa057c2a3445a7ae3c711c97aff18072a4ae21', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'dcbfe1c79199ca376013b2fd5c2c61eb9b3aad21', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '44c867c35e0baf2ae5e06ecb3f2b2c67e4bfb897', class: "payment-item__payment-item" }, index.h("div", { key: 'd17521cf3595a046535f182876e375de0522157e', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '18c0f6c495d0ea340dbdb3d28195b0ac5c3eb116', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: 'bfb05225fd9f241d0becbfb2c857cdade39f5277', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: 'cb7e4443ae54908bb8e77cf1910293f325a91e1f', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'c96248a8fb0318af136e9191f33fdfec93976f7f', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '10621f40bd3166b93512a9a3eca0f6954e9dab4f', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: 'aafa891ea166a8e5bec583d5594b713603800b73', class: "payment-item__payment-toolbar" }, index.h("p", { key: 'a06f1f52d7c27d6c03184710caddbe88194f4f9c', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'd45fc8c97471dda2b50e0490d1c9e91e6ed4fd44', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '7e775ba173440e20a49f7c78ade2813325cb98de', class: "payment-item__payment-actions" }, index.h("div", { key: '8a13475ec73fb8db9847fa7f27ead557d500487a', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '2af18c7db862ba97089fe2bfe6ae252371e0d5b3', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '0b8a8ac4fe2baa36076ef8a1740a00e918aa392b', name: "user", id: this._id }), index.h("wa-dropdown", { key: '82b4de1891c20091be8b01e0ff8fa76ef5eed8dc', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: 'd982ffa86c2a67c8451e32cbc4948f04b08ce841', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: '18502163deced6bc1b5aecb21b37ef75ecb1ee6e', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: 'a6dbd966d96755018f48aa4f6c1af4033b33b48a', value: "receipt" }, index.h("wa-icon", { key: '025a479813b911bd51ce6a03f1e13bc8299f4f24', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: 'af91e757a419027aad03c3c5c3b738251c1cc4f6', value: "edit" }, index.h("wa-icon", { key: '7a75ea1eda796569d54d6e820091239e8aa386bb', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: 'fd045ef4b56125751182cadb46cef832f6038009', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '6953a6518ba320098661160242ebb6452839a768', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: 'c679239dd79ffdc3e18fcdc0ad699557cb6c23cb', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: 'f736ed5e2f726ae0d99208b64ddc8fc5613fc703', class: " payments-container" }, index.h("div", { key: '1c535c65bb239337a21c95005371bcb1e96cdcef', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '36636046f18fcc7061101080083764a649796eb6', class: "font-size-large p-0 m-0" }, this.booking?.agent ? 'Guest Folio' : 'Folio'), index.h(HelpDocButton, { key: 'ce91cb492fcf3b49a4eb2a9d28a973e0185ddc65', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: '2d52adb34fadd43c305420c486cc50bb568261d0', for: "create-payment" }, "New Folio Entry"), index.h("ir-custom-button", { key: 'bd4ac70ee30d905ef10eb9d26162aa38f91e1981', disabled: this.isAddPaymentDisabled, slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '7337e487583094fef2b07058736c7dc884f084ad', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'f593970c3dba86863d9f7cd8fa206e1e91573e4e', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: 'a1407660fdd6bbaef2d12c4051d6ced5ecca31ee', booking: this.booking, agent: this.agent, onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '8c8352f543a1843c4588bc5b540f8fc2ed216b2a', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'ae89ae2d37885db8a6e8464ba4784f0bab94b078', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '9cee898a5e47d7f39a48b0bc9f1acc2a6ace2400', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '58c52f4944ba39f2bd4982b5359d3492a0f40c68', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: 'ea48a4f11286068f28786966c3ab2fd4fdbf2730', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '3eb1148400dfd470beeae5c0e578635533342525', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '32232634000574b3b7e5d104a582915543652907', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: 'a97c0473bd3b513395bf7a736357d4d4e0a09da1', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '88a82bacf971462885ecda867ba31796dc386601', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: 'e84f6102231831359ae75d4835ce3c22a7d14c1f', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: 'bd3bc554dbee0122a8e33a89f9055bbf747cb221', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '0380c55a144ba19777691ad9ced2ff0aa8bfed42', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: 'fa585570834ca881d7718277ae934c204584e00f', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '4b8073c4495f327307d65e6214195d0d3de7b0f3', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'f648af3f4e8fea0a96b5eeb98467960363334ad4', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '3cb4ecc018132977d52c5c0b63d852dc0e5d73df', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'd0cd2d364b78b7c5213d9417ba35f0a1dca40cad', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'af72c5fb6a098ba69638645eab99170dbb943aee', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: 'a6c4a253165df580af30afaf78a11c195a24de22', mask: 'price', label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, index.h("span", { key: '34a71334d9c4c338e04704125a84666b918cc77f', slot: "start" }, this.pickupData.currency?.symbol)), functions.isAgentMode(this.resolvedAgent) && (index.h("ir-service-assignee-select", { key: 'b9bfe8fffd9375d7099a3d00266d0a0e78f114be', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.assignee = e.detail;
            } }))))));
...
const IrPickupView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("wa-card", null, index.h("p", { slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_Pickup), index.h("wa-tooltip", { for: "pickup" }, this.booking.pickup_info ? 'Edit' : 'Add', " pickup"), index.h("ir-custom-button", { slot: "header-actions", id: "pickup", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { name: "edit", style: { fontSize: '1rem' } })), this.booking.pickup_info ? (index.h(index.Fragment, null, functions.isAgentMode(this.resolvedAgent) && (index.h("p", { class: `service-group__label ${functions.isAgentMode(this.resolvedAgent) ? (this.booking?.pickup_info?.agent ? '--agent' : '') : ''}` }, index.h("span", null, "Bill to"), this.booking.pickup_info.agent ? this.booking.pickup_info.agent.name : 'Guest')), index.h("div", { class: `pickup-info${functions.isAgentMode(this.resolvedAgent) ? (this.booking.pickup_info.agent ? ' service-group service-group--agent' : ' service-group service-group--guest') : ''}` }, index.h("div", { class: "pickup-info__summary" }, index.h("div", null, index.h("p", { class: "pickup-info__datetime" }, moment.hooks(this.booking.pickup_info.date, 'YYYY-MM-DD').format('MMM DD, YYYY'), this.booking.pickup_info.hour && this.booking.pickup_info.minute && (index.h("span", null, " \u2022 ", functions._formatTime(this.booking.pickup_info.hour.toString(), this.booking.pickup_info.minute.toString()))))), index.h("p", { class: "pickup-info__due" }, index.h("strong", null, this.booking.pickup_info.currency.symbol, this.booking.pickup_info.total))), index.h("div", { class: "pickup-info__details" }, index.h("ir-label", { display: "inline", labelText: `${locales_store.locales.entries.Lcz_FlightDetails}:`, content: this.booking.pickup_info.details }), index.h("p", { class: "pickup-info__line" }, index.h("span", { class: "pickup-info__label" }, "Vehicle:"), index.h("span", null, this.booking.pickup_info.selected_option.vehicle.description)), index.h("p", { class: "pickup-info__line" }, index.h("span", { class: "pickup-info__label" }, locales_store.locales.entries.Lcz_NbrOfVehicles, ":"), index.h("strong", null, this.booking.pickup_info.nbr_of_units))), index.h("p", { class: "pickup-info__note" }, calendarData.calendar_data.pickup_service.pickup_instruction.description, calendarData.calendar_data.pickup_service.pickup_cancelation_prepayment.description)))) : (index.h("ir-empty-state", null)))));
    }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '70a5aab87d6a0d3ddc9812d93371ece7b5cf46b1' }, index.h("div", { key: '7eebaa4fcf95bceb6c7263c3772c152d776a7028', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: 'dd38b9294be53051678127d9e95d722c76766796', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '5ce8b08bfcc8037cb040a9eab587571252a610d1', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '1a45cead6c02033ce4f760b4cd3bbfa69258d778', class: "reservation-information__row" }, index.h("ir-label", { key: '8e95231343b59e06fac20e754180e94e97eb1551', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: '7782a381b45ae816175b1ebd097113acc3ecea15', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '56d84b57a082c59d48c2c8a112497542f53e43fb', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '7c1699de1ee6ae65c01dd60f7225043bbb2bfb8d', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '37aea50b869197cd1fa893a42176c208947decea' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: 'bbd745f6f55d3aeea20e41b830d26a5caf8e4e21', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '61552621d34aa8000410882b46a4854dae580d5c', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '6e6f0afe8368bd76094ff6ba67bb8305c64ff80c', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '835fb5134d25ec9261288c582d3c7d683b70aad4', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), !this.booking.agent && (index.h("div", { key: '604b4b90db4814bc0ab2f298d8bc5e2602d7b2ec', class: "reservation-information__row" }, index.h("ir-label", { key: '5f49afb7861cbc257c95f84a307b61d65333b6e0', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '1356c546a08f393f190b8a88d77eee58f31b96e7', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '8be194ef7339be9c206f813a37c76e9dae9cdc29', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '5a6f5ef1d4cc497d3090921d3ab60f78d57f1bf5', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } })))), this.booking.guest.mobile && index.h("ir-label", { key: '013ff3b57a19c07b75fa73262bc26d564af648a0', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '78cfdac53fa2aa39ab35eb88b89ccb975da15893', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '75ffef2cf429754b1b3842c39cbc3bc3191aac1a', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '0fb97c4bf10fa3ec07a4f9f12511497cc37cc43e', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '1e5b4a059790c889e62fc2a0278296320ef663bf', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '26f2b62eea5a78d4abe01a8d0e65963a60d2e6c0', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && (index.h("div", { key: 'f84e8ebbce4fb7bc3f2c70d54dbc5ff6f4549ed1', class: "reservation-information__row" }, index.h("ir-label", { key: '6148efd71435ea671ea45f667ae627915f408095', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, display: "flex", content: this.booking.arrival.description }), index.h("wa-tooltip", { key: '2c932640c11147630e001f3b18e9768c89dcb46c', for: `edit_arrival_time` }, "Edit arrival time"), index.h("ir-custom-button", { key: '509c76d13a82446c0a2582ef35b2ccca2502a51b', iconBtn: true, id: `edit_arrival_time`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irArrivalTimeDialogRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '90d46b0bbd0b12c571e0a843cbc885a3edfb64b3', name: "edit", label: "Edit arrival time", style: { fontSize: '1rem' } })))), this.booking.promo_key && index.h("ir-label", { key: 'cb133e9466ac71f29f432d0e3caa528d11bced8a', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '14f2cfc0e6e5ae56ae8a30dcc1f74399a6c37f8b', class: "d-flex align-items-center" }, index.h("svg", { key: '13328b8b9dc17e4064c3688b7b14d26c5f892ec2', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'a65d15e883ede2c7f33ce09a70fb3075df9e74be', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'ea798af3c23cb75623b088df46811ff27a9af5fd', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: 'aaf7c7e5117ec2b15c29a7ae0a541e6b64d09e71', class: "reservation-information__row" }, index.h("ir-label", { key: 'e4383488266e9a166296b3deb8a7cf2c95b2bd90', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: '4dcd2f7b83e3e94a84ef44c73bfd898d0c38afa5', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: 'c427418df9793785b291262489644aac5a19040e', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'ca041ee72ed715563a570197e6e8a676d3b5c5e3', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '2277dfdf6bc6991a7c404f8f19961c34a164a838', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: '144b16eee17f55fb328a4a0ee3e680aad4563b4c', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) })), index.h("ir-arrival-time-dialog", { key: '5084bced3111913c921ff904f6e4145327bf72c1', booking: this.booking, arrivalTime: this.arrivalTime, ref: el => (this.irArrivalTimeDialogRef = el) })));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '071e8bb423b79424d6829a1b781b1eb35f2246ea' }, index.h("div", { key: '6bc6254468d969f87b4bf6c13a3b9039928a9b4c', class: "booking-room__header-row" }, index.h("button", { key: '494c07dda41d8f606b82b3d26e1b1debe7540d08', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '99e297ac34b3bce02f02219c18773abfed65c65a', name: "chevron-right" })), index.h("div", { key: 'e880ebd866fad5ccf8fdddc0ea664aa771181ee5', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '0aa7d2f1c9b923917fbc971e0d208933567b2307',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '3af1c93c186dcb6593b6abc65d2e045e5a7fed97', class: "booking-room__summary-row" }, index.h("p", { key: '8f0005b2cfae2c2da93964cc2da132ea3a644b69', class: "booking-room__summary-text" }, index.h("span", { key: 'bf7549428c1c976d8aec25ef8d020c14d2289f48', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'c13f4bcef17b028f6b46c16cc95d604dcf1f7789', class: "booking-room__price-row" }, index.h("span", { key: '55090d8eea560974ddae1b1804a6daf86db8956c', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (index.h("div", { key: '323dfd16549c9b6559901ce0a145cf7e0a1ddc21', class: "booking-room__actions" }, index.h("wa-dropdown", { key: '4d75d82a4ea3d257590b1780201486e56f50865a', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: '88253f1d870550c2c35ecf7bc4a92d45e9c3cc23', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, index.h("wa-icon", { key: 'd6f0129bbcd1f49d1b4185fba4287b4b46ca908d', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && index.h("wa-dropdown-item", { key: '9d5e214a1569d51195e2b2aa27944d7edb6c11f2', value: "edit" }, "Edit"), functions.isAgentMode(this.agent) && index.h("wa-dropdown-item", { key: '49ec67ff0a4f7b14a5162b267a4e89ae4ae51afc', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (index.h("wa-dropdown-item", { key: '0b37a7b7471725915b2421e9192f78916222d67e', value: "delete", variant: "danger" }, "Delete"))))))), index.h("div", { key: '4fb747c8da591e462d5c49952feed67b6b4d1fa6', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: '937344aa69493d21d66e807db55a868e6eb9a087', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: 'b3ca82e3be1aacea7ef260a02deb535e7287cde6', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: 'b51f95446c4028b3f94cafe54923f4d537e6ad01', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: 'bdc146e07dce56c78e64c6e7cfa066c3af0c50d4', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: 'db9f0445335e5d4b034f398a18ebcd7f756cddc7', class: "booking-room__guest-row" }, index.h("p", { key: '3afc1cac86d8972f97774d707597d2e9d9be95fd', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '70c172bc6a5ec42a231337049d4dd80344fa6d23', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '1381ca9abb6d6e34406e0397da408b17ba1b8cdd', class: "booking-room__departure-row" }, index.h("p", { key: '1daaea4b4ac5b7650a413383d2bd0357b202ee1e', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: '854f728da41d915100bba2d6deabc5f8a051766e', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: '6f1cdb9cae9a7fc7db79834e8a473999e51f5439', class: "booking-room__details-container" }, index.h("div", { key: '967fc86efc70b3f6e847f0bae2401c120cd4660d', class: "booking-room__breakdown-row" }, index.h("div", { key: '77bb80e6973c097c9b44ae83d300262978c06573', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: '3219976f05209e8ea2ca7b09ac30de2ffbeb48df', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '5e16485a6f62463f4a4f6cd33ef2be6e4de45d2c', class: "booking-room__breakdown-table" }, index.h("table", { key: 'aa81f351a4c2c7437cf2ead32a6282818dcf85dd' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'eee638fffc15e1861d49de1c24d6535e5baab67b', class: '' }, index.h("th", { key: '50ae6f109df45bb06c960de770b4a0622bdcba28', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '2f35c98133870cc2e8540c25919bd6636c584c93', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '3b5d47edaa3f7a2a47c767ecdbfde2dcf277b124', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '399e7e1fc592b1edcb6092dc1c121e627adeacf2', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'c8c57d333f7c32c38587b03fde08a28640c24982' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'c1fbca660bb713f26721797d4cd6421519aae874', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'a2b8b6c19f6e34c75e5459d35ca6aad888ffdbf9', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '8461d995e9c2b8d3a3084df4742043a14e96fb27' }, index.h("ir-label", { key: '3ede17318a34728d27e86634553917fc49f1d188', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '6ef9ecece91fa05f1ffdd2e65493e0502a9489f2', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-assignment-toggle-dialog", { key: '6e6089ddb8d4e6edc12ad3d93b350d714822c168', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, index.h("span", { key: '2ca69154b64966db7b6d730295a531574cff117b', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', index.h("b", { key: 'f415a0b544d8a0992e9e083f9acb24a5f02d1ec6' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), index.h("ir-dialog", { key: '2b0419ba8687c5baf3e101dcd4ec671ab2dcd153', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '0ed019fad8898c387d211f7a03504c8fa1e75be7' }, this.renderModalMessage()), index.h("div", { key: 'd596ec2b2d8090f3666aade2b04c4fc92a27b3fe', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'ea09156228a3dbf9bc4061e64b827d2ce077a929', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'abffa488526f89b0ef11cbd4853ee8579077e493', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '507207c5ea527fc7de627a27e390f73f9f466e23', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: 'f330b024d603236dd553a2e250496186592e0e2f', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: 'f7437344b92c5467432ecff0a3999ba7b2604936', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-room-guests-form", { key: 'ec4f3b742d178524ae76ddeed124a88285fa3843', sharedPersons: this.sharedPersons, roomName: this.roomName, countries: this.countries, totalGuests: this.totalGuests, identifier: this.identifier, bookingNumber: this.bookingNumber, checkIn: this.checkIn, language: this.language, onLoadingChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            } })), index.h("div", { key: 'dd26b6dc9f8742608198d92955ac794a21529c13', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'd651310b38b6299b5c3e6dffdd03c249dc0368b4', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: 'fd21359bf0561e9af13dd2090e5a89833f5825aa', value: "save", loading: this.isLoading === 'save', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: '2517f79870be1eba744439a43e01a79563977a61', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
