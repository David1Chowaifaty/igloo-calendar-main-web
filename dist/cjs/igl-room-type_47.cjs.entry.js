...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5f15f71b18a96eef0fcd465b3b16e72b51e9103c', class: "booking-header" }, index.h("div", { key: 'e19d94dde3a875a2b86c94a1649b3f361e9c4f17', class: "booking-header__row" }, index.h("div", { key: '213631eebce20cbee116cc2a5ee3cebf58468827', class: "booking-header__info" }, index.h("div", { key: 'db81edf24e48716aa4dbbc97732dd71150529410', class: "booking-header__title" }, index.h("div", { key: 'b945523ff99e94ac28d3c7610ec1574fd9a3c46a', class: "booking-header__label-container" }, this.hasMenu && (index.h(index.Fragment, { key: '968edcb1761cd7834d5e54054673a6dd3c8d3721' }, index.h("wa-tooltip", { key: '8a0b88c480edc5199a3c509c62045fc373c34af1', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '9a531c1b2f398c5c6712e9c729490a1957ed2991', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '18072ba598a07ed68612776faddc677921337dd0', name: "arrow-left", style: { fontSize: '1.2rem' }, label: "Go back" })))), index.h("div", { key: 'ccd3e335e9cbb0dcb44402745a1fb89decaac415', class: 'booking-header__label' }, index.h("h4", { key: 'd4b80de7448e13996a7043cb1c6eeaf8fe38fe3a', class: "booking-header__label-number" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("div", { key: '36062e582469104325579a40695fb42aa31b7a80', class: "booking-header__meta" }, !this.booking.is_direct && index.h("p", { key: 'd6336e84a46555c0b28050d179d58592088372ee', class: "booking-header__channel-number" }, this.booking.channel_booking_nbr), lastManipulation && (index.h(index.Fragment, { key: '1542b7139ee71a0e824feddd38d5309793e334f6' }, index.h("p", { key: '6714d5cf3a49b975659a1e288090e3765edd5df8', id: `booking-${this.booking.booking_nbr}-modified`, class: "booking-header__modified" }, "Modified"), index.h("wa-tooltip", { key: 'b83c0a4fa8334acbd1cc83ef13ccf8d87f899660', for: `booking-${this.booking.booking_nbr}-modified` }, index.h("div", { key: '795e65324f6c0d9490135d7bc47bcc5ffbdfe4b2' }, index.h("p", { key: 'c6ff62bddf8f44eb76ddec5987c8fc11b85fb3e5', class: "m-0" }, "Modified by ", lastManipulation?.user, " at ", lastManipulation?.date, " ", lastManipulation?.hour, ":", lastManipulation?.minute, "."), index.h("p", { key: '6c1369b91298039127c97eda7b2c484df74e5057', class: "m-0" }, this.alertMessage)))))))), index.h("div", { key: '3e09966d8cf1d281ac1c5c7a39f2a5365c54f120' }, this.booking.allowed_actions.length > 0 && this.booking.is_editable ? (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            appearance: 'outlined', size: "small", variant: "brand", class: "booking-header__status-trigger" }, index.h("ir-booking-status-tag", { slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", null, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))) : (index.h("ir-booking-status-tag", { status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }))))), index.h("div", { key: '462df11c2104255b9d1c12ded3ee96a5953da95a', class: "booking-header__actions" }, index.h("ir-custom-button", { key: '0456339248a5e118fc45b550e18457e8cf79ea7f', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Events log"), showPms && (index.h("ir-custom-button", { key: '1c29c6eb52f17d66bebe3236f8f3c8cbb4cc8ced', class: "booking-header__stretched-btn", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: 'cb57b30aafa9bee948cae67709be078fb760b80f' }, index.h("ir-custom-button", { key: '8c7715f1064b7ccffc0d618122cd897e9696ca69', class: "booking-header__stretched-btn", id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '60769918b74f61fdf4501e9b0ab761f96c97ba45' }, index.h("wa-tooltip", { key: '620268036eb9f20d9a412f1987d6e99636a841d7', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '5439aaa4a1052b165bb6b80ee7d28880eab8b748', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '2380095f9c6956b2a162f8b055653fff48d77b48', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '4909bef7a96d3f8d927b6c9410de371bc2147518' }, index.h("wa-tooltip", { key: '38ee1d3226b280656f4ef30205fff824013c0f4d', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '2484181816aaeaa1161513e49d009375d8d42bde', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'c062a22a68c99a3b8fac5d8e4f6dbbe3b2028e1d', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '2ee07e31ad3ccb7feecbe7df42c88ef9f350155f' }, index.h("wa-tooltip", { key: 'fd878c96115567e1c426899cf9364a3588af864e', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '2665d7cea881b0d4875d6b70848a8573acda1d62', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '8cb5facd1609db876f9f54943af0161bc68971d5', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '392424e57a9d2beb255c4ae9952ed07650242066', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'c29c41e588a712b2f61355a5dd41c5637e12e06e', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: 'db3cf7dc2083cc84536ee09bedde1b26e0a88f44', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: 'bf61f680653b75c7a58ac31f6b8369c6f9ec9fb5', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '6bdf963614d2aa3dc8652c3129d65664b1a9a329' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: '7f95b81f3f2c92009d094cbd23e7b41bde2331c8', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '3cd0d380beba2d0ec432f50881f3df0714053098', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '64f19d45f44a1202922a737c9936ef9deeac66be', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
