...
const IrAgentEditorDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5809c15392a498e8fd8056530ca4fde1e72fa9bb', "data-testid": "agent-editor-drawer" }, index.h("ir-drawer", { key: '906b069b6cc248d3fa9e6ec85b7fe377acbcf940', class: "agent__drawer", style: { '--ir-drawer-width': '60rem' }, label: isEditMode ? 'Edit Agent' : 'New Agent', open: this.open, "data-testid": "agent-editor-drawer-container", onDrawerHide: e => this.handleDrawerClose(e) }, this.open && (
        ...
        //   </wa-tab-panel>
        // </wa-tab-group>
        index.h("ir-agent-editor-form", { key: '2bde88e9162d5f95bf770ad055f2c9c513c2c39b', onCloseDrawer: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.agentEditorClose.emit();
            }, onLoadingChanged: e => {
            ...
            }, setupEntries: this.setupEntries, countries: this.countries, agent: this.agent, formId: this.baseId, "data-testid": "agent-editor-form" })), index.h("div", { key: '09c46c473d395d5b9c0e02ff11f199e7ca8a116f', slot: "footer", class: "ir__drawer-footer", "data-testid": "agent-editor-drawer-footer" }, index.h("ir-custom-button", { key: '0128e42563df7a8346330225a461cbfc07be46db', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", "data-testid": "agent-editor-cancel-button" }, "Cancel"), index.h("ir-custom-button", { key: '2f042aefb69b45955c6120b85557e633a867daa2', loading: this.loading === (this.agent?.id === -1 ? 'save&close' : 'save'), type: "submit", form: this.baseId, size: "medium", value: this.agent?.id === -1 ? 'save&close' : 'save', appearance: this.agent?.id === -1 ? 'accent' : 'outlined', variant: "brand", "data-testid": "agent-editor-save-button" }, "Save"), this.agent?.id !== -1 && (index.h("ir-custom-button", { key: '1a0d3d2132140e0b25e6af7e6f731c5680944373', loading: this.loading === 'save&close', type: "submit", form: this.baseId, size: "medium", value: "save&close", appearance: "accent", variant: "brand", "data-testid": "agent-editor-save-button" }, "Save & Close"))))));
    }
};
...
const IrAgentEditorForm = class {
    ...
    render() {
        return (index.h("form", { key: '9ce1bd5a822ae693cf21444be14798c8289a2f86', autoComplete: this.formId,
            // autoComplete="off"
            id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveOrEditAgent(utils.getFormSubmitter(e));
            }, class: "agent-editor__content" }, index.h("ir-agent-profile", { key: '029e29bee941d0771d646a863e5db4ad52c2cb2e', setupEntries: this.setupEntries, countries: this.countries, class: 'agent-editor__profile', agent: this.agent }), index.h("ir-agent-contract", { key: 'e32b2a34c4473e79fd49b38b5f913942042f6372', setupEntries: this.setupEntries, class: 'agent-editor__contract', agent: this.agent })));
    }
};
...
const IrAgentsTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0df8c4375b16d51cf5eb6833231583f0b6e08e88' }, index.h("div", { key: 'dd8e34690247d897c037ffe0e7632402d104e697', class: "table--container" }, index.h("table", { key: '7c0a163bd1ffa0d8427e080653110ae3c990a81d', class: "table" }, index.h("thead", { key: '9a94495776f3f622cb1717433e3da307757d700a' }, index.h("tr", { key: '8efdb24882023988658e5b860b3a6ce03e78a138' }, index.h("th", { key: '86055945b66cefd2f4391fa1af468d37ffcf7907', class: "agents-table__header" }, "Name"), index.h("th", { key: '2a1dafa0db4a10eb3224f298eabc8ff70b5f6f84', class: "agents-table__header" }, "Type"), index.h("th", { key: '1f46b2e11a9f18b787bee5f98bdfb99d44534e73', class: "agents-table__header" }, "Email"), index.h("th", { key: '37625fd8660c967d8ea7181a93425e9faee78b5d', class: "agents-table__header" }, "Phone"), index.h("th", { key: '011f9c4f41311a5dfed1a75247490a4ce5fa8e93', class: "agents-table__header" }, "Active"), index.h("th", { key: '3f1391557c6f670b91aa89a7751ea20378d7af14', class: "agents-table__header " }, index.h("div", { key: 'e3f9a258bbe7d80e43759206ad8e249a80cda107', class: "agents-table__action" }, index.h("wa-tooltip", { key: '8ae258f6f7f54986caa02e6870a52861d1dda48e', for: "create-agent-button" }, "New Agent"), index.h("ir-custom-button", { key: 'e261c0c30b53c97732fad5a661cb880c041257d3', onClickHandler: this.createAgent, variant: "neutral", appearance: "plain", id: "create-agent-button", "data-testid": "create-agent-button" }, index.h("wa-icon", { key: '3f792982d956bbb51bb7db38e49658801d1ff607', name: "plus", style: { fontSize: '1.2rem' }, label: "New Agent" })))))), index.h("tbody", { key: 'f7d31e2c717a146f35c4d73243a1ad393198775a' }, this.agents.map(agent => {
        ...
        }), this.agents?.length === 0 && (index.h("tr", { key: '2176ea126698b2e6fb4f14eeb5d65d12691a7d21', class: "empty-row" }, index.h("td", { key: 'eb1d4478edd556bc2f29072b039a3c7dd802de31', colSpan: 6 }, index.h("ir-empty-state", { key: 'a5ca01547fc50f4d3d7dd1321968d6fd5e9ed195' })))))))));
    }
};
