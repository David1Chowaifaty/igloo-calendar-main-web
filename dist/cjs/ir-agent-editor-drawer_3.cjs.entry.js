...
const IrAgentEditorForm = class {
    ...
    render() {
        return (index.h("form", { key: 'bf80fec23be5072d9eb2e4d02395b2f0591e9021', autoComplete: this.formId,
            // autoComplete="off"
            id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveOrEditAgent(utils.getFormSubmitter(e));
            }, class: "agent-editor__content" }, index.h("ir-agent-profile", { key: '1172867049a3f5af2c8187da7065040dabddd47e', setupEntries: this.setupEntries, countries: this.countries, class: 'agent-editor__profile', agent: this.agent }), index.h("ir-agent-contract", { key: '1c210dd89757ed3201c672251591b8ef125ff3e0', setupEntries: this.setupEntries, class: 'agent-editor__contract', agent: this.agent })));
    }
};
...
const IrAgentsTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '49ce1f81c953f051161930d793babe4114a87059' }, index.h("div", { key: 'af9d1929edf6a72c82eded1cc05a5812c126e208', class: "table--container" }, index.h("table", { key: 'b422f393e7d26aee6c9102d825a5288f899102d7', class: "table" }, index.h("thead", { key: '5897eff87d9713d904ee4dbdb6786c1df848a7cc' }, index.h("tr", { key: '2bffc417b211697a69fd496fcc8396cca1ccf868' }, index.h("th", { key: 'a681f40c535751d241009afd2ea05f155954f54c', class: "agents-table__header" }, "Name"), index.h("th", { key: '336f92f4949b38eef6444479af385b4526948d46', class: "agents-table__header" }, "Type"), index.h("th", { key: '8be4292fcc829bacdc662aa73a348730865c0b51', class: "agents-table__header" }, "Email"), index.h("th", { key: '73fe74018f2a9e515898304c561a349f0db6e3e1', class: "agents-table__header" }, "Phone"), index.h("th", { key: '130f8f9159c856340746952baff1a7f6e0fcf41a', class: "agents-table__header" }, "Active"), index.h("th", { key: '46b446efb9ffbe644f80fc607b5235569a983788', class: "agents-table__header " }, index.h("div", { key: '0c84b7a938277807aba74b806d5dc13d5ebeefe4', class: "agents-table__action" }, index.h("wa-tooltip", { key: 'eb043adf20bd75c0fee21cb58294d64b50f5c5cc', for: "create-agent-button" }, "New Agent"), index.h("ir-custom-button", { key: '928cd45e84fbbec25d5c86168d8614b02400f61f', onClickHandler: this.createAgent, variant: "neutral", appearance: "plain", id: "create-agent-button", "data-testid": "create-agent-button" }, index.h("wa-icon", { key: '55613498b5ad2abded86f314e6a4dbe8df401a92', name: "plus", style: { fontSize: '1.2rem' }, label: "New Agent" })))))), index.h("tbody", { key: 'c7f7b6ab8b71450af1bd08bf556c959e910d33de' }, this.agents.map(agent => {
        ...
        }), this.agents?.length === 0 && (index.h("tr", { key: '8fc1762f345d529bdbe9562b0779814e6b2f36a0', class: "empty-row" }, index.h("td", { key: '9bf597bd0375c9eb935fe890e5d983230211d362', colSpan: 6 }, index.h("ir-empty-state", { key: 'ace76b39ea9b363714af9f3c4740628ad870763d' })))))))));
    }
};
