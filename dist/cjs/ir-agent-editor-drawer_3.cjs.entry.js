...
const IrAgentEditorDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '690fbc7e569d4d006740042ced37eb23e1cff179', "data-testid": "agent-editor-drawer" }, index.h("ir-drawer", { key: '99787820989b65d22e8dc86a77fd581143099125', class: "agent__drawer", style: { '--ir-drawer-width': '60rem' }, label: isEditMode ? 'Edit Agent' : 'New Agent', open: this.open, "data-testid": "agent-editor-drawer-container", onDrawerHide: e => this.handleDrawerClose(e) }, this.open && (
        ...
        //   </wa-tab-panel>
        // </wa-tab-group>
        index.h("ir-agent-editor-form", { key: '80d4f6b81321ed52bfef463bae144d23a068ea9c', onCloseDrawer: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.agentEditorClose.emit();
            }, onLoadingChanged: e => {
            ...
            }, setupEntries: this.setupEntries, countries: this.countries, agent: this.agent, formId: this.baseId, "data-testid": "agent-editor-form" })), index.h("div", { key: '8c6203415c17d6223aac2755ecde8433d571a94c', slot: "footer", class: "ir__drawer-footer", "data-testid": "agent-editor-drawer-footer" }, index.h("ir-custom-button", { key: '026cc10cf0a6f9478247744638d67a0c2e579efe', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", "data-testid": "agent-editor-cancel-button" }, "Cancel"), index.h("ir-custom-button", { key: '04c29d2ac6bdef7f9ce31b1db2bc30bc3981cb10', loading: this.loading === (this.agent?.id === -1 ? 'save&close' : 'save'), type: "submit", form: this.baseId, size: "medium", value: this.agent?.id === -1 ? 'save&close' : 'save', appearance: this.agent?.id === -1 ? 'accent' : 'outlined', variant: "brand", "data-testid": "agent-editor-save-button" }, "Save"), this.agent?.id !== -1 && (index.h("ir-custom-button", { key: 'fe3b510e96c83d5f881d741434b491fbd580e3b3', loading: this.loading === 'save&close', type: "submit", form: this.baseId, size: "medium", value: "save&close", appearance: "accent", variant: "brand", "data-testid": "agent-editor-save-button" }, "Save & Close"))))));
    }
};
...
const IrAgentEditorForm = class {
    ...
    render() {
        return (index.h("form", { key: '86ae3bd51b6b85ffdd5fc60f54d10f11f8a7e05d', autoComplete: this.formId,
            // autoComplete="off"
            id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveOrEditAgent(utils.getFormSubmitter(e));
            }, class: "agent-editor__content" }, index.h("ir-agent-profile", { key: 'e24d7dc44bba5cf2b9842686ef2f9c585d08e8b1', setupEntries: this.setupEntries, countries: this.countries, class: 'agent-editor__profile', agent: this.agent }), index.h("ir-agent-contract", { key: 'f3dd88aedb13cf9b577f4dbf2241252f8f06330d', setupEntries: this.setupEntries, class: 'agent-editor__contract', agent: this.agent })));
    }
};
...
const IrAgentsTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1854f6074a5815b75b061c9068d299dc81bbbfb9' }, index.h("div", { key: '4ac4e60c709a358cff6c217a476faa5522dde83a', class: "table--container" }, index.h("table", { key: '080ad5f53b878aca9cf0767a1ac7960ef1ca23c8', class: "table" }, index.h("thead", { key: '12646c1c0e5bf418b4cda7c81d964ed8103f2acf' }, index.h("tr", { key: '8abb86a333044e96fa3aa36cb314d37a3115ef42' }, index.h("th", { key: '7fb0b85897f8ce2be4330b0df83d23ef10bf5ee4', class: "agents-table__header" }, "Name"), index.h("th", { key: '7229961c632057997783bde309ce6b37d48c7852', class: "agents-table__header" }, "Type"), index.h("th", { key: 'de6da55f9dc1ab38ffce6693f5f4d51f5b9a448d', class: "agents-table__header" }, "Email"), index.h("th", { key: 'f71763d7a96cb6b3a26d07a18bff10bb1e3d1fea', class: "agents-table__header" }, "Phone"), index.h("th", { key: 'e73e683b1abe5a3a29edfeb17eec8b9776229de7', class: "agents-table__header" }, "Active"), index.h("th", { key: 'a7c713d40db34340fca3586e411cba7c733d0afe', class: "agents-table__header " }, index.h("div", { key: 'feb13d745d54596847f0ed588dcf331094483b95', class: "agents-table__action" }, index.h("wa-tooltip", { key: 'ca97ab5ca5584597ab6f630e63d7f5f16161ecbb', for: "create-agent-button" }, "New Agent"), index.h("ir-custom-button", { key: '943628303d60b753703877eaade00c5a451eef3f', onClickHandler: this.createAgent, variant: "neutral", appearance: "plain", id: "create-agent-button", "data-testid": "create-agent-button" }, index.h("wa-icon", { key: 'd0313ce55d3b910a066a941944fc1b7d1d27ecc1', name: "plus", style: { fontSize: '1.2rem' }, label: "New Agent" })))))), index.h("tbody", { key: '609530ccc7acfa9184949faa426ea4cc0c40c328' }, this.agents.map(agent => {
        ...
        }), this.agents?.length === 0 && (index.h("tr", { key: 'd4c3422b006cfb179ebbcfa15fc6b28c699f2c83', class: "empty-row" }, index.h("td", { key: 'a90835bab301be51028f30bc32a804797f102e50', colSpan: 6 }, index.h("ir-empty-state", { key: 'bf9f610c819c39f533c2e1279f42860b01bd825d' })))))))));
    }
};
