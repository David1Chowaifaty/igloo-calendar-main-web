...
const IrAgentEditorDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2f3e73a67c6183a449261829acdec2006d20e780', "data-testid": "agent-editor-drawer" }, index.h("ir-drawer", { key: 'ffaa870278ced3fad472b9dd4a85b3e3e3f7d396', class: "agent__drawer", style: { '--ir-drawer-width': '60rem' }, label: isEditMode ? 'Edit Agent' : 'New Agent', open: this.open, "data-testid": "agent-editor-drawer-container", onDrawerHide: e => this.handleDrawerClose(e) }, this.open && (
        ...
        //   </wa-tab-panel>
        // </wa-tab-group>
        index.h("ir-agent-editor-form", { key: '25333af67d76f7a03a8afbb17ef134586b01f828', onCloseDrawer: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.agentEditorClose.emit();
            }, onLoadingChanged: e => {
            ...
            }, setupEntries: this.setupEntries, countries: this.countries, agent: this.agent, formId: this.baseId, "data-testid": "agent-editor-form" })), index.h("div", { key: '916ac21cd266552c3a174e4ef1a6b9a21c2810e4', slot: "footer", class: "ir__drawer-footer", "data-testid": "agent-editor-drawer-footer" }, index.h("ir-custom-button", { key: 'f43aa55201de2208a09e43b6e49b47149a7f616e', size: "m", "data-drawer": "close", appearance: "filled", variant: "neutral", "data-testid": "agent-editor-cancel-button" }, "Cancel"), index.h("ir-custom-button", { key: '8d12312137ed2241ffaea304ae7b3290244a3ae4', loading: this.loading === (this.agent?.id === -1 ? 'save&close' : 'save'), type: "submit", form: this.baseId, size: "m", value: this.agent?.id === -1 ? 'save&close' : 'save', appearance: this.agent?.id === -1 ? 'accent' : 'outlined', variant: "brand", "data-testid": "agent-editor-save-button" }, "Save"), this.agent?.id !== -1 && (index.h("ir-custom-button", { key: '91bf2016577e5cc8ba2bded5cbdaae5ccb0bd253', loading: this.loading === 'save&close', type: "submit", form: this.baseId, size: "m", value: "save&close", appearance: "accent", variant: "brand", "data-testid": "agent-editor-save-button" }, "Save & Close"))))));
    }
};
...
const IrAgentEditorForm = class {
    ...
    render() {
        return (index.h("form", { key: 'e955fa6b86d11d543c9959d2d9038ec267c38936', autoComplete: this.formId,
            // autoComplete="off"
            id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveOrEditAgent(utils.getFormSubmitter(e));
            }, class: "agent-editor__content" }, index.h("ir-agent-profile", { key: '35f4ded6d0f482651169a7129f91dc243ccf9301', setupEntries: this.setupEntries, countries: this.countries, class: 'agent-editor__profile', agent: this.agent }), index.h("ir-agent-contract", { key: 'b224b4ca8d6cd61e76f45ca413db2e083037ce35', setupEntries: this.setupEntries, class: 'agent-editor__contract', agent: this.agent })));
    }
};
...
const IrAgentsTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b4b29aa80f8f5bcbc42d0139a7130362c1394473' }, index.h("div", { key: '171af1e136da3d3135c87def6061956dd19fff6d', class: "table--container" }, index.h("table", { key: '518756db433171cca3502ba55156077ec98abe52', class: "table" }, index.h("thead", { key: 'bb50299925c2cdd320d79c17a30cfc5baa3cd449' }, index.h("tr", { key: '549555751ca2c42e459677e2b82339b14fc2921e' }, index.h("th", { key: 'dcfc2509f70eacc0b22be612db7393954377bdbf', class: "agents-table__header" }, "Name"), index.h("th", { key: '5af9fd42573023d957e2f808d731201f9b9d7a38', class: "agents-table__header" }, "Type"), index.h("th", { key: 'b9ecb3a5012d6c8a885dc9940ecd023fd09d2a23', class: "agents-table__header" }, "Email"), index.h("th", { key: 'b532cd19a582aaf0b54615d5cdb82dec277b2aa3', class: "agents-table__header" }, "Phone"), index.h("th", { key: '5ba4a37a6b36a5e9a9789a3dcbb3de9ce39d4e3d', class: "agents-table__header" }, "Active"), index.h("th", { key: '53dffc80d1141e212f68a3cba09c5b071353cc23', class: "agents-table__header " }, index.h("div", { key: '15b2dcc4405c687c2ed7a8587024731f963eae93', class: "agents-table__action" }, index.h("wa-tooltip", { key: '325180f96862285fb9efb1f4d21aac7088ddc154', for: "create-agent-button" }, "New Agent"), index.h("ir-custom-button", { key: '1449351731b880292e5ed1cc2abb24cdfb15ca48', onClickHandler: this.createAgent, variant: "neutral", appearance: "plain", id: "create-agent-button", "data-testid": "create-agent-button" }, index.h("wa-icon", { key: '1b414e8d8421162a12bdac2d9c91a2368a3211d7', name: "plus", style: { fontSize: '1.2rem' }, label: "New Agent" })))))), index.h("tbody", { key: 'b019ca04905e4f429e6e08cfb13cfa8bd91dc0a3' }, this.agents.map(agent => {
        ...
        }), this.agents?.length === 0 && (index.h("tr", { key: '374e63530a8e10301a160a2d0dac88b84647f0dc', class: "empty-row" }, index.h("td", { key: 'b5855c0860b4b8a83c9cf80c2b7590d0a7167ad1', colSpan: 6 }, index.h("ir-empty-state", { key: '94ff1a088322e5c1754ea1356199839d5dcbb446' })))))))));
    }
};
