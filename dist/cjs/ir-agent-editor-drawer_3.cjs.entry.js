...
const IrAgentEditorDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b7c5f26a8225d9b92cc2c77ed61442bfb5c10f02', "data-testid": "agent-editor-drawer" }, index.h("ir-drawer", { key: '622a5f30c3d41325c4e69a7db82de467da8b8830', class: "agent__drawer", style: { '--ir-drawer-width': '60rem' }, label: isEditMode ? 'Edit Agent' : 'New Agent', open: this.open, "data-testid": "agent-editor-drawer-container", onDrawerHide: e => this.handleDrawerClose(e) }, this.open && (
        ...
        //   </wa-tab-panel>
        // </wa-tab-group>
        index.h("ir-agent-editor-form", { key: '28b62ae9ae3ab4081df2423a0012ccfff9d07f2d', onCloseDrawer: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.agentEditorClose.emit();
            }, onLoadingChanged: e => {
            ...
            }, setupEntries: this.setupEntries, countries: this.countries, agent: this.agent, formId: this.baseId, "data-testid": "agent-editor-form" })), index.h("div", { key: '4c8eb33428add4b816b8756fc5c4ae7385ff9a39', slot: "footer", class: "ir__drawer-footer", "data-testid": "agent-editor-drawer-footer" }, index.h("ir-custom-button", { key: 'b6d24490db7c1bf43fb3e58167a5a687a6c70178', size: "m", "data-drawer": "close", appearance: "filled", variant: "neutral", "data-testid": "agent-editor-cancel-button" }, "Cancel"), index.h("ir-custom-button", { key: '1711024a9832f1e2be8b5dc87b502dd4c0c35a65', loading: this.loading === (this.agent?.id === -1 ? 'save&close' : 'save'), type: "submit", form: this.baseId, size: "m", value: this.agent?.id === -1 ? 'save&close' : 'save', appearance: this.agent?.id === -1 ? 'accent' : 'outlined', variant: "brand", "data-testid": "agent-editor-save-button" }, "Save"), this.agent?.id !== -1 && (index.h("ir-custom-button", { key: '21cfe471646e016c1f57652d1068b25edf604c36', loading: this.loading === 'save&close', type: "submit", form: this.baseId, size: "m", value: "save&close", appearance: "accent", variant: "brand", "data-testid": "agent-editor-save-button" }, "Save & Close"))))));
    }
};
...
const IrAgentEditorForm = class {
    ...
    render() {
        return (index.h("form", { key: 'c4ebca705c1061e235e5cb26e359df8da63313a7', autoComplete: this.formId,
            // autoComplete="off"
            id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveOrEditAgent(utils.getFormSubmitter(e));
            }, class: "agent-editor__content" }, index.h("ir-agent-profile", { key: '33a605bb8f22d343a8f8d928ffd222edf1d31d13', setupEntries: this.setupEntries, countries: this.countries, class: 'agent-editor__profile', agent: this.agent }), index.h("ir-agent-contract", { key: 'db7c9e9d18cdf7d0d60801c41611ec7d48442fbe', setupEntries: this.setupEntries, class: 'agent-editor__contract', agent: this.agent })));
    }
};
...
const IrAgentsTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6757b7810d74ccd3493021b73c4cea574e04929b' }, index.h("div", { key: '24a12efc41f68ca56a79539ce966670ffb383d8c', class: "table--container" }, index.h("table", { key: '98c95a9867e57d3d0884b16f51def8189fcd1fc3', class: "table" }, index.h("thead", { key: 'c7794ca875857879d637c87edd675cf44b0a731f' }, index.h("tr", { key: '833e394dd3c685bdc17ea05084c321bff2871400' }, index.h("th", { key: '783c6e3e7cbfc99cf6ccdbc57e9c6320642b5993', class: "agents-table__header" }, "Name"), index.h("th", { key: '04193eec4086c5372b3070aa53a550728248b6c4', class: "agents-table__header" }, "Type"), index.h("th", { key: 'fcdd369ff054829419bfb98d0149080f69516018', class: "agents-table__header" }, "Email"), index.h("th", { key: '472ec4339e02c4660ec96aa5de99a37d938a3779', class: "agents-table__header" }, "Phone"), index.h("th", { key: 'adbcec97ed12af2831ac059297ba84b552df93f4', class: "agents-table__header" }, "Active"), index.h("th", { key: '8535bd82705937c07322e768814dbf07eabf4c6a', class: "agents-table__header " }, index.h("div", { key: 'b59d61e68c84f7b18bb95d5152352aabbbe0301b', class: "agents-table__action" }, index.h("wa-tooltip", { key: 'a861b9548c161cf3c5e71655723219fa12ccaa45', for: "create-agent-button" }, "New Agent"), index.h("ir-custom-button", { key: '74f4c1b2abb2ddcaa685c44740f6582b37c228ec', onClickHandler: this.createAgent, variant: "neutral", appearance: "plain", id: "create-agent-button", "data-testid": "create-agent-button" }, index.h("wa-icon", { key: 'b2953f6f243dbc992a99dca5821ae9415ede9ce6', name: "plus", style: { fontSize: '1.2rem' }, label: "New Agent" })))))), index.h("tbody", { key: 'e8bd82740e77d239f5d3181ee8edc7c0398edfc3' }, this.agents.map(agent => {
        ...
        }), this.agents?.length === 0 && (index.h("tr", { key: '2628c871d7c4ca4d981c3dedb31e36c2344c0c85', class: "empty-row" }, index.h("td", { key: '67e8777c4fc9ef8d877333c879090f042e400feb', colSpan: 6 }, index.h("ir-empty-state", { key: '8dc25c3cc9eeb81d5460a210f6b62c37e2284949' })))))))));
    }
};
