...
const IrAgentEditorDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b7b639017d276a3868c732438a998c4d17a5bc01', "data-testid": "agent-editor-drawer" }, index.h("ir-drawer", { key: '2165913b77aae917adabdcbd9d5a6980a9ad7482', class: "agent__drawer", style: { '--ir-drawer-width': '60rem' }, label: isEditMode ? 'Edit Agent' : 'New Agent', open: this.open, "data-testid": "agent-editor-drawer-container", onDrawerHide: e => this.handleDrawerClose(e) }, this.open && (
        ...
        //   </wa-tab-panel>
        // </wa-tab-group>
        index.h("ir-agent-editor-form", { key: '5474569e3e88598743b2bae367111dbe4adac1b8', onCloseDrawer: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.agentEditorClose.emit();
            }, onLoadingChanged: e => {
            ...
            }, setupEntries: this.setupEntries, countries: this.countries, agent: this.agent, formId: this.baseId, "data-testid": "agent-editor-form" })), index.h("div", { key: 'b9a4e1c848828aa59f16caa60e3b3ed0bd0afc24', slot: "footer", class: "ir__drawer-footer", "data-testid": "agent-editor-drawer-footer" }, index.h("ir-custom-button", { key: '88567f1e6ca87308f1d957f71eccdb9ed1a77588', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", "data-testid": "agent-editor-cancel-button" }, "Cancel"), index.h("ir-custom-button", { key: 'ac81e3d6adbff2adf7962f8d855bac9c2b28ec92', loading: this.loading === (this.agent?.id === -1 ? 'save&close' : 'save'), type: "submit", form: this.baseId, size: "medium", value: this.agent?.id === -1 ? 'save&close' : 'save', appearance: this.agent?.id === -1 ? 'accent' : 'outlined', variant: "brand", "data-testid": "agent-editor-save-button" }, "Save"), this.agent?.id !== -1 && (index.h("ir-custom-button", { key: '740b69f4397ddad432d54ac161acd817416e875f', loading: this.loading === 'save&close', type: "submit", form: this.baseId, size: "medium", value: "save&close", appearance: "accent", variant: "brand", "data-testid": "agent-editor-save-button" }, "Save & Close"))))));
    }
};
...
const IrAgentEditorForm = class {
    ...
    render() {
        return (index.h("form", { key: 'cc0b0352ad635336e9c306868983d2e1e3edc9ca', autoComplete: this.formId,
            // autoComplete="off"
            id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveOrEditAgent(utils.getFormSubmitter(e));
            }, class: "agent-editor__content" }, index.h("ir-agent-profile", { key: '118b3a2cd5bebe7eb6bd99e1c0d769a6c2f14d1b', setupEntries: this.setupEntries, countries: this.countries, class: 'agent-editor__profile', agent: this.agent }), index.h("ir-agent-contract", { key: '50c1a4112ac5b5f1512b1c934d18a3b8180113e8', setupEntries: this.setupEntries, class: 'agent-editor__contract', agent: this.agent })));
    }
};
...
const IrAgentsTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '13ab1d9b96a7d5cd90d7603531aefea3933dd0a6' }, index.h("div", { key: 'c144115fe62c9f83125370ca511b25a6e2dacd0c', class: "table--container" }, index.h("table", { key: '356ef3980961d6ca43d3b0ee0d941ffb5b49c875', class: "table" }, index.h("thead", { key: '2ad424355c69d263039b62bed8bbada5595ebcf2' }, index.h("tr", { key: 'e382b6a927f86219cf0ecb01a608bf74f7a9418b' }, index.h("th", { key: '384b218dda940048e865097db8ba0b379f1900b0', class: "agents-table__header" }, "Name"), index.h("th", { key: '14e0eabe393c49e17a049692d9d4e01e89e26b5e', class: "agents-table__header" }, "Type"), index.h("th", { key: 'e2a0f30b5d84b0c1dc003c9015df607c27171c5c', class: "agents-table__header" }, "Email"), index.h("th", { key: '286f6bf1609d681441643106ccde63a2ffd39afb', class: "agents-table__header" }, "Phone"), index.h("th", { key: '4c345d15afa54db048bd20c74ada2316b5faa9ca', class: "agents-table__header" }, "Active"), index.h("th", { key: '2265eb3ca2a92154d25d0f074659f38204e2ee22', class: "agents-table__header " }, index.h("div", { key: 'a76e7647b775ceefa08583493332bf0965b4727c', class: "agents-table__action" }, index.h("wa-tooltip", { key: 'c4739354b6a56bd446f602f7e9038213951a3e12', for: "create-agent-button" }, "New Agent"), index.h("ir-custom-button", { key: '570add08b316998ff34950c898711b6c66f91279', onClickHandler: this.createAgent, variant: "neutral", appearance: "plain", id: "create-agent-button", "data-testid": "create-agent-button" }, index.h("wa-icon", { key: '2c05bcfff9aecadcf3a87bd00cb09ffc3eaf413c', name: "plus", style: { fontSize: '1.2rem' }, label: "New Agent" })))))), index.h("tbody", { key: '9489f9b5fd35ea2b5119f3b32a7cd92df8947bc2' }, this.agents.map(agent => {
        ...
        }), this.agents?.length === 0 && (index.h("tr", { key: 'a1d4bed1b1ea249343392ce9007b5d291dad6134', class: "empty-row" }, index.h("td", { key: '6e9d304688159fbbc59f4476ffa8c5b45f3566dc', colSpan: 6 }, index.h("ir-empty-state", { key: 'ea2f9beba671616fb3eea71e47fd28c14afe008c' })))))))));
    }
};
