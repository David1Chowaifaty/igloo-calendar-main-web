...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1914579981f7bd0480bc55844a080102de232006' }, index.h("ir-title", { key: 'b85b99286a913ac8c730f4a96644e7ef1d2666dc', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '65e2031bf13e2c9eda0a05c355755db54c8f683b', class: "px-1" }, index.h("table", { key: 'd0b35526b26ab7c8b40a86a6be3ba05d1059a9e8' }, index.h("thead", { key: '0a51c63d4d429e8609334ec4b5de5863f8d5242e' }, index.h("th", { key: '30bb325529f074cdae8dda001446f6a46a920c4b', class: "sr-only" }, "room name"), index.h("th", { key: '48c93af889ae162559b1eda5fb9146fe54ced884', class: "sr-only" }, "housekeeper name"), index.h("th", { key: 'e185026fa93f7196742ef5b0e64aa087a5074ece', class: "sr-only" }, "actions")), index.h("tbody", { key: 'ef509c0f197ba44e1240769ea6a01b03940430cd' }, this.renderRooms())), index.h("div", { key: 'b698bd0cb06745e5e72ac5db6beee1db009d2b05', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, index.h("ir-button", { key: '85b360eafb394458ef33eb0ff424e593c35d690f', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), index.h("ir-button", { key: '92fe0ad11981dd2746689b11bb329d4c2a315452', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8f458081d2a9c897945ce17cc5ecc2c010b3677c' }, index.h("ir-title", { key: '904a852abf166a080a9a258635d1b3ab6613568b', class: "px-1", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '9daa44dc55390ee398534303ef0fd80fa6a98bb5', class: "px-1" }, index.h("ir-input-text", { key: 'f6f85ec219666bb7af0a5df6b83e5de343963955', error: ((_b = (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.length) > 0, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this) }), index.h("ir-phone-input", { key: '619aba99806270026107718c0ee53cfeeb95946e', placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_d = (_c = this.errors) === null || _c === void 0 ? void 0 : _c.mobile) === null || _d === void 0 ? void 0 : _d.length) > 0, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_e = this.user) === null || _e === void 0 ? void 0 : _e.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
            ...
            } }), index.h("ir-input-text", { key: '7c45b57a37f1d16d54b5da3e26127ea6ad154f79', disabled: this.user !== null, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '3d2bb3df66348c66935b87b3c7fb3f9e4cbe44ea', label: locales_store.locales.entries.Lcz_Password, placeholder: locales_store.locales.entries.Lcz_MinimumCharacter, value: this.userInfo.password, type: "password", error: ((_g = (_f = this.errors) === null || _f === void 0 ? void 0 : _f.password) === null || _g === void 0 ? void 0 : _g.length) > 0, onTextChange: e => this.updateUserField('password', e.detail) }), index.h("ir-input-text", { key: 'fbf124fa9f838e2924e1b34edc41aa8414c7eb47', label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) }), index.h("div", { key: 'f4442ee6c12662d06c2e90a65a26bcb0efef2a72', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, index.h("ir-button", { key: '3b1e5ef88637af953333963f7d8790c6e52db33b', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'd4da39c46461597f76f78cf32f9505a0e8d250dc', isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: locales_store.locales.entries.Lcz_Save })))));
    }
};
