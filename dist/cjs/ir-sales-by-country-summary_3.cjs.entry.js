...
const IrSalesByCountrySummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '2c5acc65d0bff753ef6b154f2273ee27833a3875', class: "summary-row" }, index.h("ir-metric-card", { key: '2f072575691920adf5dc4805e10748a8dac861d9', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalRoomNights?.toString(), trend: hasLastYear ? utils.calculateTrend(totalRoomNights, lastYearTotalRoomNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalRoomNights}` : undefined }), index.h("ir-metric-card", { key: '0906cf94a507b49c83c5aeefbc693a11edc850be', class: "summary-metric", icon: "user-group", label: "Total Guests", value: totalGuests?.toString(), trend: hasLastYear ? utils.calculateTrend(totalGuests, lastYearTotalGuests) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalGuests}` : undefined }), index.h("ir-metric-card", { key: 'f7fea836f48f27f712d064fc37993a930d9159ad', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(calendarData.calendar_data.currency.symbol, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearTotalRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(calendarData.calendar_data.currency.symbol, lastYearTotalRevenue)}` : undefined })));
    }
};
...
const IrSalesFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'f850060469f60c6be4340e2c12bb69b3d8df18c2' }, index.h("wa-radio-group", { key: '1c42088d9204c26bd00c94b47f49c81c02d23637', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: '71c91d808e4ac13f1252d60237eb7207a425538e', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: '031d0928496415c90932010038621f1a3d4b4212', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), index.h("wa-select", { key: 'a11c26a50a3425a746a17df2b08f3a51a01a2011', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: 'b2785937241cb95ce7b048c2ecd26def34886a86', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: 'b1d0a6fd560bec3144e6e533bb1e6629d97b17e8', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: 'd7ece016687ac66dc155597d600224c42d749d2a', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: '26e7c27310d06205ba101e15e29e9ba2a67e423e', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: '5131ac203cec3ecd41be416cc062b47bf33e0f4c', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '7d755ce83eef186989297ce6afb0f2ba9dfe8d83', value: "365" }, "For the past 365 days")), index.h("div", { key: 'abb1f77fd645654cd63b84d838128967e459771f', class: "or-divider" }, index.h("span", { key: 'ab85b24bff62de8a78a35445858c57e1f03eacae', class: "or-divider__line" }), index.h("span", { key: '835b3adb6dfcf58c72b73820b19a99ff2e68815b', class: "or-divider__text" }, "Or"), index.h("span", { key: '7097a6593815f6f3c123ea6367c2594a52cb35ab', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: 'c5e30f187bf5a919793cef509a08e737c5ba904d', label: "Date range", fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", showQuickActions: false, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: '59b717df70c6d27868b78167475f1d145cde18be', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '7c3ced02737d9865f00372f3e52a1bdb973223c4', slot: "footer" }, index.h("ir-custom-button", { key: '92a6d5f840383208f9f56d5ce7a4eaaaa629bbe1', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: 'ee4d9a704e2822ee3f6edbf1b91fe04de5892492', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
