...
const IrSalesByCountrySummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3552a1a6c8b964a3fa6159380170e45fb8a6da5c', class: "summary-row" }, index.h("ir-metric-card", { key: '5aacef4d5f04224e699a2b616458c99994286eda', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalRoomNights?.toString(), trend: hasLastYear ? utils.calculateTrend(totalRoomNights, lastYearTotalRoomNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalRoomNights}` : undefined }), index.h("ir-metric-card", { key: 'cf55d086002e765e28013bc5a184aef922dbf5a1', class: "summary-metric", icon: "user-group", label: "Total Guests", value: totalGuests?.toString(), trend: hasLastYear ? utils.calculateTrend(totalGuests, lastYearTotalGuests) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalGuests}` : undefined }), index.h("ir-metric-card", { key: 'be34f458d2fbb460d836e4851505e938374fc6d8', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(calendarData.calendar_data.currency.symbol, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearTotalRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(calendarData.calendar_data.currency.symbol, lastYearTotalRevenue)}` : undefined })));
    }
};
...
const IrSalesFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '99bccdaf255326236931b1ae0b2dd733fa8a7813' }, index.h("wa-radio-group", { key: '1a0fd416729faa20c7d5d6edb5269b757af8f8d3', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: '9d59d71cbd42f68cbbedca657e8e92e41d477b9c', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: '57707c6d070cdb241c7f738aff064857493a739b', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), index.h("wa-select", { key: '554b9e4331d32ff1be482136cf9479d197285dc7', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: '729e07246606ba34036637b4b9e812541a0a2d72', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '4a37474319303b9429f33d75b462cb17147ed97e', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: 'f5e84e05300425a616263988d51cc535e17283dc', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: 'e4c4b1b753fda4f09f9862917ef4e4270f85263e', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: 'f1662a294fe9f5d03aec87acaa46e5ca83a01be0', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '7cc80d7ba8d2614f5f88eba57b0cc60f1b417dac', value: "365" }, "For the past 365 days")), index.h("div", { key: '3894d440e0aeefcc0854fc4b5537db689a50aac0', class: "or-divider" }, index.h("span", { key: '8e488a914ce4f288d272c012d96ab82aaacf6736', class: "or-divider__line" }), index.h("span", { key: 'da20a95e8b3838a890b52eaf4176f960b9c1572d', class: "or-divider__text" }, "Or"), index.h("span", { key: '79f838753ae9ac56d12b2844fe77b253c29921ab', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '0327e22f3003a1db832461bdcb30a77f9510406a', label: "Date range", fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", showQuickActions: false, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: '2f70152455ba4b6fe8cfd412741b2e7cb4007ca1', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: 'c9e139e3929a8092db623a3e506ea66e57e20e6e', slot: "footer" }, index.h("ir-custom-button", { key: '02718defc5e296c183927ac7cd4dd3a05ea52a59', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '5825665e46a1595dc7a032207183dd5d4846691e', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
