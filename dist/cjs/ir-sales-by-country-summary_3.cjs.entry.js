...
const IrSalesByCountrySummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '36330b9f8eb44cfdbd37ef4231c23c4a798cfa54', class: "summary-row" }, index.h("ir-metric-card", { key: '0a6bcfb037d569134a249376b8658aed43d39402', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalRoomNights?.toString(), trend: hasLastYear ? utils.calculateTrend(totalRoomNights, lastYearTotalRoomNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalRoomNights}` : undefined }), index.h("ir-metric-card", { key: 'e115e6e6016050eb5101943305da29725f8c55d2', class: "summary-metric", icon: "user-group", label: "Total Guests", value: totalGuests?.toString(), trend: hasLastYear ? utils.calculateTrend(totalGuests, lastYearTotalGuests) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalGuests}` : undefined }), index.h("ir-metric-card", { key: '06749746e8b20c803d663d56147d66456d71cf51', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(calendarData.calendar_data.currency.symbol, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearTotalRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(calendarData.calendar_data.currency.symbol, lastYearTotalRevenue)}` : undefined })));
    }
};
...
const IrSalesFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'fd3788e5c7fd0827377947d3d5a64a9630dfe36d' }, index.h("wa-radio-group", { key: '416d77edf999892a8757b63b12e707d81ff31492', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: '6389949f5b63ec9de43fa41a049ccf269070b8f9', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: '9c333328f020dcea085b19cce8b09267a4a6755b', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), index.h("wa-select", { key: '315e058fd94c640c2098acc6da854bb6c961a90b', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: '9bcb476bc45ccbc9fb59d6acf4edaf734c96e409', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '3fc9c416bca0d0470b4ffe81efcfb8ea09c73b0b', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: '6d1b04a736d004db849c02622bc0a941f74bdbae', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: 'de443e1332b4dc177a9a537f83176a1198f49069', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: '3f77acb419d802e4b6b98b03c592dec6e39fd555', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '8a9d1e78569028d45e9087fd6926898feb366376', value: "365" }, "For the past 365 days")), index.h("div", { key: '53fa6e1737b9497cedf9f901f4bcf8eeff2d3eda', class: "or-divider" }, index.h("span", { key: 'ba41d107de5fd662c59bd896fbd9414354f8a078', class: "or-divider__line" }), index.h("span", { key: 'de77b1f0bcecad48ef728661b739f7991ee81c0c', class: "or-divider__text" }, "Or"), index.h("span", { key: '53c154237975d75eeb4869a545adfd0133e38b2a', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: 'c75131ee647dc6afdcd6480affd3b007b8d6c3f3', label: "Date range", fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", showQuickActions: false, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: 'cddf6f973b92c2239df2c09d4c7b795dcca42097', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '0af9237536648a06b7cd5bf6195ea9cb0ff0cfa5', slot: "footer" }, index.h("ir-custom-button", { key: 'dd7ecaf21bf317fa17b36c5039fcc963b7792b61', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: 'bc44b53390cc81d2c369b94787d58b441126e813', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
