...
const IrSalesByCountrySummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0dd13bb2fca76a320f033164b8d31d8fb802c9f1', class: "summary-row" }, index.h("ir-metric-card", { key: 'efb57aea0096f4b5d03961203695cb522161a3f5', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalRoomNights?.toString(), trend: hasLastYear ? utils.calculateTrend(totalRoomNights, lastYearTotalRoomNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalRoomNights}` : undefined }), index.h("ir-metric-card", { key: '1fd1e527990d3bb318c62869c5690c1f379c3666', class: "summary-metric", icon: "user-group", label: "Total Guests", value: totalGuests?.toString(), trend: hasLastYear ? utils.calculateTrend(totalGuests, lastYearTotalGuests) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalGuests}` : undefined }), index.h("ir-metric-card", { key: 'f3a98b7562c3f4e445dd32c825fd8b44dc880ec5', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(calendarData.calendar_data.currency.symbol, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearTotalRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(calendarData.calendar_data.currency.symbol, lastYearTotalRevenue)}` : undefined })));
    }
};
...
const IrSalesFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'd13fda09bc710becc12d47991345bd60d1b27ddc' }, index.h("wa-radio-group", { key: 'bea62ef26180e8e90a9b427634800439bb17e01e', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: 'c6db994a087044215d1006e944278ddd6206486c', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: 'f11a88910cc5fa03f5536ef633256ca63d29c707', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), index.h("wa-select", { key: '05eeca45590e950f774e7bf3f4d3f27260616a68', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: '48c11f782dcea7e9290b02b24a13b491bed5a62f', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '6a72fbce3914e698a547f421d109601ab460a9d4', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: '7d02c67cb7625383954da033106f33bc31d50e63', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: 'd482f13de6c6e639d40227bf1e07095a909320d0', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: '04b441768d3eab104eecc24472b9a5a15efb6705', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '776d443074ba16b6f1bf9a46d675184cb5e1bc7b', value: "365" }, "For the past 365 days")), index.h("div", { key: '0c4a6b55d8e42777c44608c2c6c27c3d684d9007', class: "or-divider" }, index.h("span", { key: '9b16f1957cc3e8639ab8303658b5ab39eb90297f', class: "or-divider__line" }), index.h("span", { key: 'a2fd3a1adbbf968f07f669eddc562c94797c8ed6', class: "or-divider__text" }, "Or"), index.h("span", { key: '09f1dc3b7d0d720d3d9619d69de68079843602a3', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '2862a1248a9ad6f5c3d4ada34b71773ce22e05e7', label: "Date range", fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", showQuickActions: false, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: 'c3b634703e01897583f2caaac0c28438f3fa84bb', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '9d28735de80771d75a1ab91def5124671b3252c4', slot: "footer" }, index.h("ir-custom-button", { key: '4ddbe56f892d632848e29b266a6cbcf2e1f8d1ad', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '44a9454efb17cc8cb586c2890043072690d08dfc', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
