...
const IrSalesByCountrySummary = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7721a96bdb28d843fbf6ea2845b891d343384161', class: "summary-row" }, index.h("ir-metric-card", { key: '4a48a384c330cfda2e722e27840c6f7fae557bb7', class: "summary-metric", icon: "moon", label: "Total Room Nights", value: totalRoomNights?.toString(), trend: hasLastYear ? utils.calculateTrend(totalRoomNights, lastYearTotalRoomNights) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalRoomNights}` : undefined }), index.h("ir-metric-card", { key: 'd42712181c85d950404aad12d088393e38a44cef', class: "summary-metric", icon: "user-group", label: "Total Guests", value: totalGuests?.toString(), trend: hasLastYear ? utils.calculateTrend(totalGuests, lastYearTotalGuests) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${lastYearTotalGuests}` : undefined }), index.h("ir-metric-card", { key: '8b1dd37fa1b3b8616b764e6f172e612f0fa9a330', class: "summary-metric", icon: "money-bill", label: "Total Revenue", value: utils.formatAmount(calendarData.calendar_data.currency.symbol, totalRevenue), trend: hasLastYear ? utils.calculateTrend(totalRevenue, lastYearTotalRevenue) : undefined, trendLabel: "vs last year", caption: hasLastYear ? `Last year: ${utils.formatAmount(calendarData.calendar_data.currency.symbol, lastYearTotalRevenue)}` : undefined })));
    }
};
...
const IrSalesFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '4405b68254585481f50ecf897feea3c1c77c72a0' }, index.h("wa-radio-group", { key: '87a6478c65d31587be0cb50e2f197a202e5f4043', label: "Rooms", orientation: "horizontal", size: "s", style: { width: '100%' }, value: this.filters?.BOOK_CASE, onchange: (e) => {
                this.updateFilter({ BOOK_CASE: e.target.value });
            } }, index.h("wa-radio", { key: '64ef8b778cd6fcc192c1ac4acdb3cab5ab5b4f78', style: { flex: '1 1 0%' }, appearance: "button", value: "001" }, "Booked"), index.h("wa-radio", { key: '412abb3e49772403650b65b965f0dab45d4f0dc6', style: { flex: '1 1 0%' }, appearance: "button", value: "002" }, "Stayed")), index.h("wa-select", { key: 'b408556e7ca6c321802f9d6426eac060157b561d', label: "Selected period", size: "s", value: this.window, defaultValue: this.window, onchange: (e) => {
                ...
                this.window = val;
            } }, index.h("wa-option", { key: '597f1bbc9558aa6c4a2ac6e5a57a967f617da8db', value: "7" }, "For the past 7 days"), index.h("wa-option", { key: '49014e6c60f326eeda09506b80a7fb71c2e16c5e', value: "14" }, "For the past 14 days"), index.h("wa-option", { key: '7fd06bbe45d0312c726142af7b79999040702822', value: "30" }, "For the past 30 days"), index.h("wa-option", { key: '20da504d58af035b68866b09aa4d63053e5ac50e', value: "60" }, "For the past 60 days"), index.h("wa-option", { key: 'd33e3bcbab63cd1be7bef4b68c83ce9cf4bab187', value: "90" }, "For the past 90 days"), index.h("wa-option", { key: '7d252e695195990032d69e827d6f175e58a88276', value: "365" }, "For the past 365 days")), index.h("div", { key: '05fa63a4134c60cf772ff9bedad364239185a502', class: "or-divider" }, index.h("span", { key: 'c98c83c8005ea65ad03e077dfdaa96900a11881e', class: "or-divider__line" }), index.h("span", { key: '476350d2155c1a0b2a6f04e2f93320ee9934838b', class: "or-divider__text" }, "Or"), index.h("span", { key: '936cfaec776772d41e416f0a5e484650f706ec64', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '678dd530cdb2aead35ce934be0070cd97ea5bd9a', label: "Date range", fromDate: this.filters?.FROM_DATE, toDate: this.filters?.TO_DATE, maxDate: moment.hooks().format('YYYY-MM-DD'), selectionMode: "auto", showQuickActions: false, withClear: false, onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ FROM_DATE: from, TO_DATE: to });
                this.window = '';
            } }), index.h("wa-checkbox", { key: '6cb84ad8fad56ab9012f230e1d2cd7882267eb8f', checked: this.filters?.include_previous_year, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({ include_previous_year: e.target.checked });
            } }, "Compare with previous year"), index.h("div", { key: '644a440574dc58fcc0358597cbc625bba3f9f493', slot: "footer" }, index.h("ir-custom-button", { key: 'd0b46577c56f017130fb4beb64580ac6e293dea2', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '3911db911edf2d7d3a6cc20121de1a2871ec48da', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
};
