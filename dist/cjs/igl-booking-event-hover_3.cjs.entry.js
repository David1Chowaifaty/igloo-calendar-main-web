...
require('./booking.service-3793345f.js');
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6cd04f0caa343f6d5c05bf8e7f66d9b6a77a1f86', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
};
