...
require('./booking.service-4b732a09.js');
...
const IglBookingEventHover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0fced44157ad624caf0f20895afbbb7dea663596' }, this.isBlockedDateEvent() ? this.getBlockedView() : null, this.isNewBooking() ? this.getNewBookingOptions() : null, !this.isBlockedDateEvent() && !this.isNewBooking() ? this.getInfoElement() : null));
    }
...
const IrDropdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: '69b008c93e09a8eac407ff6ad12b0fe99da43440', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '7194b6d039ff3801ae1e5b22a60fb10219d92016', onClick: () => {
                if (this.disabled)
                    return;
                if (this.isOpen) {
                    this.closeDropdown();
            ...
            }, "aria-disabled": String(this.disabled), class: `dropdown-trigger ${this.disabled ? 'disabled' : ''}`, onKeyDown: this.handleKeyDown, tabindex: "0" }, index.h("slot", { key: '0b9fc4f6a807879b7a47433df40579b667e50199', name: "trigger" }), this.caret && (index.h("div", { key: '30176516898a796311668e2521ceaca9b6b91891', class: `caret-icon ${this.disabled ? 'disabled' : ''}` }, index.h("ir-icons", { key: 'a33d259758912ad5c1c2fe372ca807eb82a39563', name: !this.isOpen ? 'angle-down' : 'angle-up' })))), index.h("div", { key: 'e788ce74628fd03d6b6050f64181d21d0d9d708c', class: "dropdown-menu", role: "listbox", "aria-expanded": this.isOpen.toString() }, index.h("slot", { key: '5abaaa2d0b6262dd6b6a8c64d6e5dab35e139f7d' }))));
    }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ff21c37dad89de910fef2e515a4461ffbc2a6ee6', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
};
