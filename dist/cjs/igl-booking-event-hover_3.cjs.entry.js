...
require('./booking.service-7907eeef.js');
...
const IglBookingEventHover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4d76a19747c6276120367c06e6177f53936f3e2f' }, this.isBlockedDateEvent() ? this.getBlockedView() : null, this.isNewBooking() ? this.getNewBookingOptions() : null, !this.isBlockedDateEvent() && !this.isNewBooking() ? this.getInfoElement() : null));
    }
...
const IrDropdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: '851de9e9f60723326736ff166e89458c094c53f2', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '2347094652374add6acdaeded8dee7b7093ced0e', onClick: () => {
                if (this.disabled)
                    return;
                if (this.isOpen) {
                    this.closeDropdown();
            ...
            }, "aria-disabled": String(this.disabled), class: `dropdown-trigger ${this.disabled ? 'disabled' : ''}`, onKeyDown: this.handleKeyDown, tabindex: "0" }, index.h("slot", { key: '37e445a7488b13cc667da53c3b986fd9f8f6718b', name: "trigger" }), this.caret && (index.h("div", { key: '40879bfe38375d17cc33d33c02c468bb381c2815', class: `caret-icon ${this.disabled ? 'disabled' : ''}` }, index.h("ir-icons", { key: '161d8a7870d28d8f99c4778d1be5e7074a5ba84c', name: !this.isOpen ? 'angle-down' : 'angle-up' })))), index.h("div", { key: 'ba319e63af0e2a4030010fb86f10332c25801856', class: "dropdown-menu", role: "listbox", "aria-expanded": this.isOpen.toString() }, index.h("slot", { key: '6917cf4ce97adcad74ae3b71861d7854ad46a2a3' }))));
    }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2ffa013c31a65552643028eae3d7e468f60e29d3', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
};
