...
const IglBookingEventHover = class {
    ...
    canCheckOut() {
        ...
        if (this.bookingEvent.ROOM_INFO?.in_out?.code === '000' &&
            ...
            booking_service.compareTime(now.toDate(), booking_service.createDateWithOffsetAndHour(calendarData.calendar_data.checkin_checkout_hours?.offset, calendarData.calendar_data.checkin_checkout_hours?.hour))) {
            return true;
        }
        return false;
    }
    ...
    render() {
        return (index.h(index.Host, { key: '2dd36c4229f0a4d34d352e66b52b9ac73c0e8e88' }, this.isBlockedDateEvent() ? this.getBlockedView() : null, this.isNewBooking() ? this.getNewBookingOptions() : null, !this.isBlockedDateEvent() && !this.isNewBooking() ? this.getInfoElement() : null));
    }
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '08cbb0cccf6e43f0d627d3933d6de2f089aeedb2', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
};
