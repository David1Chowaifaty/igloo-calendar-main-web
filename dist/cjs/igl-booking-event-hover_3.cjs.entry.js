...
require('./booking.service-DIp1LHir.js');
...
const IglBookingEventHover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '937985da62d42b12ca8700d8856dfa35e05e973d' }, this.isBlockedDateEvent() ? this.getBlockedView() : null, this.isNewBooking() ? this.getNewBookingOptions() : null, !this.isBlockedDateEvent() && !this.isNewBooking() ? this.getInfoElement() : null));
    }
...
const IrDropdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: '239941592ceb2fd7ec5dd5d868faacac4bcb9762', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '4ead221b5db786810cb9d9a898aaa6858058eec4', onClick: () => {
                if (this.disabled)
                    return;
                if (this.isOpen) {
                    this.closeDropdown();
            ...
            }, "aria-disabled": String(this.disabled), class: `dropdown-trigger ${this.disabled ? 'disabled' : ''}`, onKeyDown: this.handleKeyDown, tabindex: "0" }, index.h("slot", { key: '291ef9e03a85bd36030e35d5ff614cb305c89239', name: "trigger" }), this.caret && (index.h("div", { key: 'c8006124ac11297458911fc3bdec5eb27b1d1690', class: `caret-icon ${this.disabled ? 'disabled' : ''}` }, index.h("ir-icons", { key: 'a66daa31e4b913a35cc0f9f0cd3601149a1349d2', name: !this.isOpen ? 'angle-down' : 'angle-up' })))), index.h("div", { key: '53aa35bbf64120996c901850e40124f831e19351', class: "dropdown-menu", role: "listbox", "aria-expanded": this.isOpen.toString() }, index.h("slot", { key: 'baf2a0e24ea3820af5ce2f56101bbb2307cd2f95' }))));
    }
    static get watchers() { return {
        "value": [{
                "handleValueChange": 0
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ba5783ae1d72249e5d980e98418e2dae62ac2028', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
};
