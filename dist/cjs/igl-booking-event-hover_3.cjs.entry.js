...
require('./booking.service-Bi0zXviu.js');
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c151a65f351891333dd361df91908a3e61ccd947', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
};
