...
var events_service = require('./events.service-CVn_guV3.js');
var locales_store = require('./locales.store-BMTss6fG.js');
var calendarData = require('./calendar-data-UPPAEVR_.js');
var calendarGrid = require('./calendar-grid-KUdfzrmf.js');
...
var toBeAssigned_service = require('./toBeAssigned.service-UJLF6FKj.js');
...
const IglCalHeader = class {
    ...
    componentWillLoad() {
        try {
            ...
            if (!this.calendarData.is_vacation_rental) {
                calendarGrid.handleUnAssignedDatesChange('unassigned_dates', newValue => {
    ...
    render() {
        return (index.h(index.Host, { key: 'afa8a4c44fcd4ac830c9591e86b412371b3dbc0e', dir: direction.isRtlDirection(locales_store.locales.direction) ? 'rtl' : 'ltr' }, index.h("igl-cal-header-toolbar", { key: '045ed6cf4286ecb893a01d896abd5faca02a29cf', isVacationRental: this.calendarData.is_vacation_rental, showDayUseButton: !this.calendarData.is_vacation_rental && this.dayUseBookings?.length > 0, minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), roomsList: this.roomsList, onActionSelected: this.handleToolbarAction, onRoomSelected: this.handleRoomSelected }), index.h("igl-cal-header-days", { key: 'b23e4430dc6a70f3cf211be6fd27071ce72a1e78', isVacationRental: this.calendarData.is_vacation_rental, today: this.today, highlightedDate: this.highlightedDate, monthsInfo: this.calendarData.monthsInfo, days: this.calendarData.days, unassignedRoomsNumber: { ...this.unassignedRoomsNumber }, onDayBadgeClicked: this.handleDayBadgeClicked })));
    }
    static get watchers() { return {
        "unassignedDates": [{
...
const IglCalHeaderDays = class {
    ...
    render() {
        return (index.h(index.Host, { key: '950d892c04c08560e5511946f263229b04795bc8' }, index.h("div", { key: '1f4eee79a11aeaecd6226f4c97ffbd02cd3ba9c8', class: "stickyCell headersContainer" }, index.h("div", { key: '03ceb8c17a292a5b9f8aff92f9220ecf82875921', class: "monthsContainer" }, this.monthsInfo.map(monthInfo => {
            ...
            return (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.isVacationRental && (index.h("div", { class: "preventPageScroll", onClick: () => this.handleBadgeClick(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? (index.h("button", { class: 'fd-header__badge-btn' }, index.h("wa-badge", { class: "fd-header__badge", variant: 'brand', appearance: 'accent', pill: true }, number.formatCount(this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr)))) : (index.h("wa-badge", { variant: 'neutral', appearance: 'filled', pill: true }, ' ', number.formatCount(this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))))), index.h("div", { class: { dayTitle: true, weekend: utils.isWeekend(dayInfo.value) } }, irDate.formatDate(dayInfo.value, 'ddd D')), index.h("div", { class: "dayCapacityPercent" }, number.formatPercent(dayInfo.occupancy))));
        }))));
    }
};
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'decac3958524e53338c076d884b649ae5a5b06f1', ref: el => (this.dialogRef = el), label: `${multiple ? t.t('Lcz_ReportedIssues', { fallback: 'Reported Issues' }) : t.t('Lcz_ReportedIssue', { fallback: 'Reported Issue' })}${unitSuffix}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderBody(), index.h("div", { key: 'aac15118c53750ffe09ff888b508cfe45b79bd35', slot: "footer", class: "footer" }, multiple && selectedCount > 0 && index.h("span", { key: 'c840e5435c2f11b7e30dafc5a8dc1f2756e14158', class: "footer__hint" }, t.t('Lcz_SelectedItemsCount', { params: [selectedCount], fallback: `${selectedCount} selected` })), index.h("ir-custom-button", { key: '9bec0660942d6180c4fe15e998ac9c28519a07b9', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, t.t('Lcz_Close', { fallback: 'Close' })), index.h("ir-custom-button", { key: '938569232d22e3b218df840540d91fa005d5741c', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, multiple
            ? selectedCount
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '97901a085be391b50704e365a2b5294df9650700', ref: el => (this.dialogRef = el), open: this.open, label: t.t('Lcz_HousekeepingUpdate', { fallback: 'Housekeeping Update' }), onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: '47a2ac19a93ee0ad70c3d719f483f3fe3d4fee4d', style: { margin: '0' } }, this.selectedRoom?.name, " ", t.t('Lcz_UnitCurrentlyMarkedAs', { fallback: 'is currently marked as' }), " ", this.getStatusLabel(), "."), index.h("div", { key: 'cc8b3f2ff6a024c2d44c9c848ab0eded7927ff50', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '10b60bb697a72914841e9ffa06da1da5a3a06cbf', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, t.t('Lcz_Cancel', { fallback: 'Cancel' })), index.h("ir-custom-button", { key: '33e22b966cb1fa0bedf5ecfcdd3d701e5594b343', value: "hk-toggle-clean-dirty", size: "m", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: '4cb5fb3d99ca5f9ddfb9e7580aae1f17163aa3dd', value: "hk-clean-inspect", size: "m", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '484522b6ee7f6c586346f05787eef789106abbbf' }, index.h("div", { key: 'e672c36c5c3fd7e82919fef5e3f838b543956161', class: "tba-category" }, index.h("h5", { key: '046b8be972fe47e6b8f5961e3ad989faaaeebbe2', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    componentWillLoad() {
        this.reArrangeData();
        this.loadingMessage = t.t('Lcz_FetchingUnAssignedUnits');
    }
    ...
    async reArrangeData() {
        try {
            ...
            this.unassignedDates = calendarGrid.getUnassignedDates();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0c76d9abbf88bd859bdba8ad647931977524983c' }, index.h("div", { key: '049d332959ced500be320bb72933c28530d4baf2', class: "tba-panel" }, index.h("div", { key: 'f5ddcd5062d978f32fbdf0dc70c261a4418d278e', class: "tba-panel__head" }, index.h("header", { key: 'fa60f29340605cb7b4cf3cf292da7c8967013f45', class: "tba-panel__header" }, index.h("h2", { key: 'b1a868ebfe3fdb1fc93b3e86ded1eab1a722c407', class: "tba-panel__title", id: "to-be-assigned-title" }, t.t('Lcz_Assignments')), index.h("ir-custom-button", { key: '39e76ac75feff3fe9c96d7f222b2193f02b2fc5a', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: '0761e3e6175c015be6669a0b8b9bbc8fdf9c11f3', name: "xmark", variant: "solid", label: t.t('Lcz_Close', { fallback: 'Close' }), "aria-label": t.t('Lcz_Close', { fallback: 'Close' }), role: "img" }))), hasDates && (index.h("div", { key: '7d3d652631fdfbf7ad4ded13386d93d3814fdb41', class: "tba-panel__toolbar" }, index.h("wa-select", { key: 'dae3317659162d89626314f36fca21dc37fda1ea', size: "s", "aria-label": t.t('Lcz_Assignments'), value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: 'd2cac4b25b22cd43cb9f85d410dd5d91aeb58f22', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, t.t('Lcz_AllBookingsAreAssigned'))) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, t.t('Lcz_AllAssignForThisDay')))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '70cc04c831c69e998ed8b34688b43551f89f51d5', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'a1387f6574ff94274e7f66f5cc36264621b5faca', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: '85bb9fdbce9a3a8a2beefbd54094db8bb7c3f57c', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '890f2d00ec503338b3ceaf5d47f06685e0ab95c8', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: '5910f4e0d273ad783376a7c313e3fce99607d052', class: "hk-dot" }, index.h("slot", { key: '155a3ce4fb63eb3a34a462595ce1e3dcab1de1b9', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '5ed6bebaa4745b8379cf8bb1c1a2f79fd8617577', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'de00672e8fb93e7fac4f347bae89479e976d5c86', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '23b82277e24aae8b84de55ab2a9421550d9c8ee6', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '265380c4f5bf9c9537f8457607293c9a46c717e5', class: `ir-alert-header` }, index.h("p", { key: '95d9544c31710edbf3d994faf5d54a58eb5814cc' }, this.resolvedModalTitle))), index.h("div", { key: 'b133c66c554d96980d8f6acb1ffdfecf792d86e5', class: "modal-body ir-text-start p-0 mb-2" }, index.h("div", { key: '85fb4ee787d35f8be49eeb6053e3e7db7309f4f1' }, this.resolvedModalBody)), index.h("div", { key: '1a00ffad7f9523ad2364f711744f23cf11fa901b', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: '92fcf6c7e523f9f839ac01cac2c8a406c7b175a1', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.resolvedLeftBtnText, name: this.resolvedLeftBtnText })), this.middleBtnActive && (index.h("ir-button", { key: '518ac4b1e0457254c1522179f46c3602a085f711', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.resolvedMiddleBtnText, isLoading: this.isMiddleButtonLoading, name: this.resolvedMiddleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '6491318ff7c7526c2951dd912f88c5c55d933c93', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.resolvedRightBtnText, name: this.resolvedRightBtnText }))))),
        ];
    }
};
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '4f7b26d2152ee3335507fa244a3e8019aa3e2887', label: t.t('Lcz_ReassignUnit', { fallback: 'Reassign Unit' }), open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '8ce4de82bd8e2c011fab60123ef6fb6c05f507f0', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '13647386e3fc1c20891518d21254426225f3d06d', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '40bb7fd6f65cd6024ad50ec7ac1c78bd028f6439', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, t.t('Lcz_Cancel', { fallback: 'Cancel' })), index.h("ir-custom-button", { key: '500dc2c830e0f69ecd3cf5944f9d20f86ea7aac4', form: this._id, size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, t.t('Lcz_Confirm', { fallback: 'Confirm' })))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '551dabb845136e6aea01565e1d161b3190ad895e' }, index.h("form", { key: '5f62c75e1e04b3f7ce2432b0ac5f6e82e9c1fbf1', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: 'ccc31f05ba7b57908ef0d4493e91029accaf4cc6', size: "s", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '4b7393e753505b09adc27e94e458a92c5652ec08', slot: "icon", name: "triangle-exclamation" }), t.t('Lcz_RectifierCalloutExplanation', {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '3423e579d9eb3d7efa9e6182df2dad550c9cb1a3', class: "text-danger m-0" }, t.t('Lcz_PleaseSelectAtLeastOneRoomType', { fallback: 'Please select at least one room type.' })), index.h("div", { key: 'c71cc045e9d74bed4ecebb69555d8b72fb4c72a4', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '5148bffbeeb7fa5646e80f1523a4e77944f3eefe', value: this.form.from ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '737ba468b9515caacd3e666f4f20953b55a844ed', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: t.t('Lcz_DateFrom', { fallback: 'Date from' }), emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '80fc202878deed74148e7617ce479a880ec23c43', value: this.form.to ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: 'f526da319bd062c628ee2700200b0f74cd5aec84', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: t.t('Lcz_ToInclusive', { fallback: 'To (inclusive)' }), emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrRectifierDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '22c6c61075a8256a693f4820819e396f039ae7bc' }, index.h("ir-drawer", { key: '59d4b7400c5fd09d62f8dc9de97f6e9a5ba34ecd', onDrawerHide: this.handleDrawerClose.bind(this), label: t.t('Lcz_RectifyExtendAvailability', { fallback: 'Rectify/Extend Availability' }), open: this.open, class: "rectifier__drawer" }, this.open && index.h("ir-rectifier", { key: 'b543c07342ff1f4aa172bc73d4513743e3b10b3f', formId: this.formId, onCloseDrawer: this.handleDrawerClose.bind(this), onLoadingChanged: this.handleLoadingChange.bind(this) }), index.h("div", { key: '60a357fb77b10d4a68bd2dd8141211f713d2ab52', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '09f180ea29bb82b46c806fb1a55ac6098d8f7067', size: "m", variant: "neutral", appearance: "filled", "data-drawer": "close" }, t.t('Lcz_Cancel', { fallback: 'Cancel' })), index.h("ir-custom-button", { key: '93459078a6049572154d589f6433312e87e3a48c', loading: this.isLoading, type: "submit", form: this.formId, size: "m", variant: "brand" }, t.t('Lcz_Confirm', { fallback: 'Confirm' }))))));
    }
};
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1b43a7b05111021fcaf850fad7bd31c82751406e' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
        "active": [{
                "onActiveChange": 0
