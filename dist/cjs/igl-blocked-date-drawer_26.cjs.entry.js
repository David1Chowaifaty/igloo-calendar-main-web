...
var booking_store = require('./booking.store-COjvQTyf.js');
var utils = require('./utils-Dyzu_J0b.js');
var booking = require('./booking-DjbQf7Zj.js');
var moment = require('./moment-CdViwxPQ.js');
var events_service = require('./events.service-DnD_fVk-.js');
...
var toBeAssigned_service = require('./toBeAssigned.service-gVZcTkXy.js');
var unassigned_dates_store = require('./unassigned_dates.store-0ACp20f1.js');
var housekeeping_service = require('./housekeeping.service-vLRy-cll.js');
var index$1 = require('./index-tBc3L2-B.js');
...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'd4c35979969d440d106e773d775eec6ee19e3b20', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: '91abf5ba4ee641e7af1fb0b9e2737192ec8c194a', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: '6698a9123fce2a28ff449ffb8b3ee48bdeae3332', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '2cdd14e0c1a23ac59130408ffd3177bc1c178865', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '6b2ce4eedef6174cdef421933a8f7d980b1c4547', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c500772274ff279c00a1a8242d0a04bb186a981a', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: 'c35ee3821ea120e48b00149680fb169990dcc29f', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: 'ed073acd2fb6d31076c23e11702874c9adda5fa2', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '5ec178ccbdea888a0f9bc61b973b4e7617883c63', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '324232f9daaebc6ae81e42b06286786d25e66b8f', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '5cffe2e863020c95e08957ee7350749e5212a4fb', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: 'e83272b6485c09fdbe2fc2e28c0d69bd652612b5', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '665f081e8a2fc29d9f812a8d9a6c92fbdaec63c0' }, index.h("div", { key: 'd8066444220565d24ef01f9c8f6ff556d5f8f14a', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '680855279dd06aaa54cda17beea1567b0a3c1dfd', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglCalBody = class {
        ...
        if (!this.isScrollViewDragging && selectedDay.currentDate >= this.currentDate.getTime()) {
            ...
            if (this.selectedRooms.hasOwnProperty(refKey)) {
                ...
                if (this.hasBookingConflictBetween(roomId, startValue, endValue)) {
                    this.cancelSelectionWithConflictToast(locales_store.locales.entries.Lcz_BookingBetweenSelectedDates ?? 'Selection cancelled. A booking already exists within the selected dates.');
                    return;
                }
                if (this.hasBlockedConflictBetween(roomId, startValue, endValue)) {
                    this.cancelSelectionWithConflictToast(locales_store.locales.entries.Lcz_BlockedDatesBetweenSelectedDates ?? 'Selection cancelled. These dates are blocked.');
                    return;
                }
                if (this.hasUnavailableCellBetween(roomId, startValue, endValue)) {
                    this.cancelSelectionWithConflictToast(locales_store.locales.entries.Lcz_UnavailableDatesBetweenSelectedDates ?? 'Selection cancelled. These dates are not available.');
                    return;
                }
                if (this.hasDayUseBookingBetween(roomId, startValue, endValue)) {
                    this.cancelSelectionWithConflictToast(locales_store.locales.entries.Lcz_DayUseBookingBetweenSelectedDates ?? 'Selection cancelled. A day-use booking already exists within the selected dates.');
                    return;
                }
                this.selectedRooms[refKey] = { ...selectedDay, roomId };
    ...
    openDayUseBookingDetails(dayUseBooking) {
        this.showBookingPopup.emit({
            ...
            data: {
                ...
                TITLE: `${locales_store.locales.entries.Lcz_EditBookingFor ?? 'Edit Booking For'} ${''}`,
            },
        });
    }
    /**
    ...
    render() {
        return (index.h(index.Host, { key: '98bea917be7debf3e555277567de1b960713c94a' }, index.h("div", { key: '6ea818f4a4645df76117548d9966088ec6543d54', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'faec85de154ab9e5b0e7da589039d33ef9f26c18', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: '6db740d25dd7fb5a7f19f6b98ceeb15c90b77894', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: 'a17f73ce7d74a85dde39c7dc9fe00ce7dffa2491', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f3a01a1d5e010b2dd9b80dea2f629e3c3717d46c', class: "footerContainer" }, index.h("div", { key: '923632aef349d89eba396ed74004eacd11f35d8c', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '5ee89dac2d3d25aab654b6e5db946ef02859b751', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '7f4b49572a8a0131ad9213f12da3d1ff6ea93263' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '93406855e7e29ff313d51b42bfb1816bf966afbe' }, "v1.59"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4897508473130a9202003cfb285d7f2e64a691e3' }, index.h("igl-cal-header-toolbar", { key: '47de8d46dda045123e37be3fe18c9e051b91b4bc', isVacationRental: this.calendarData.is_vacation_rental, showDayUseButton: !this.calendarData.is_vacation_rental && this.dayUseBookings?.length > 0, minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), roomsList: this.roomsList, onActionSelected: this.handleToolbarAction, onRoomSelected: this.handleRoomSelected }), index.h("igl-cal-header-days", { key: '16d1390492b18ff1d8538ec51404e045366417e0', isVacationRental: this.calendarData.is_vacation_rental, today: this.today, highlightedDate: this.highlightedDate, monthsInfo: this.calendarData.monthsInfo, days: this.calendarData.days, unassignedRoomsNumber: { ...this.unassignedRoomsNumber }, onDayBadgeClicked: this.handleDayBadgeClicked })));
    }
    static get watchers() { return {
        "unassignedDates": [{
...
const IglCalHeaderDays = class {
    ...
    render() {
        return (index.h(index.Host, { key: '737292e17bec04dfc4b240bbc2e5e600c8c6072a' }, index.h("div", { key: '5558910372f2bafae484a623f8573931d326a77d', class: "stickyCell headersContainer" }, index.h("div", { key: '79613d212fe1ff26b0a3c5555470d6ce0276e43b', class: "monthsContainer" }, this.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.days.map(dayInfo => {
            return (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.isVacationRental && (index.h("div", { class: "preventPageScroll", onClick: () => this.handleBadgeClick(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? (index.h("button", { class: 'fd-header__badge-btn' }, index.h("wa-badge", { class: "fd-header__badge", variant: 'brand', appearance: 'accent', pill: true }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))) : (index.h("wa-badge", { variant: 'neutral', appearance: 'filled', pill: true }, ' ', this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr)))), index.h("div", { class: { dayTitle: true, weekend: utils.isWeekend(dayInfo.value) } }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")));
        }))));
    }
};
IglCalHeaderDays.style = iglCalHeaderDaysCss();

const iglCalHeaderToolbarCss = () => `.stickyCell.sc-igl-cal-header-toolbar{display:-ms-inline-grid;display:-moz-inline-grid;display:inline-grid;position:-webkit-sticky;position:sticky;top:0px;height:82px;display:inline-block;vertical-align:top;z-index:2}.topLeftCell.sc-igl-cal-header-toolbar{border-inline-end:1px solid var(--wa-color-surface-border)}.topLeftCell.sc-igl-cal-header-toolbar{left:0px;z-index:3;width:170px;background-color:var(--wa-color-surface-default);display:-ms-inline-grid;display:-moz-inline-grid;display:inline-grid}.btn.sc-igl-cal-header-toolbar{pointer-events:auto}.header__fd-actions.sc-igl-cal-header-toolbar{color:var(--wa-color-text-normal);border-inline-end:1px solid var(--wa-color-surface-border)}.header__fd-actions.sc-igl-cal-header-toolbar{display:flex;width:170px;box-sizing:border-box;gap:0.875rem;color:var(--wa-color-text-normal);flex-direction:column}.searchContiner.sc-igl-cal-header-toolbar{padding-left:10px;padding-right:10px}`;
...
const IglCalHeaderToolbar = class {
    ...
    render() {
        return (index.h(index.Host, { key: '829347c448dba5812f333cee3de3aea0c5a2e030' }, index.h("div", { key: '2295443293e57dbe1145d62871f7e7bfac445218', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'a959733cf51b327c1c4258796fdc0f2ff02eee78', class: "header__fd-actions" }, index.h("div", { key: '04bc8c3dded2300f2b499530ca20f82a3679ccfd', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.isVacationRental && (index.h(index.Fragment, { key: '7f91be908023bbecd0a1e463119906a05d841c9a' }, index.h("wa-tooltip", { key: '9f9405118e960c1ac2a9c61288f74ba558759701', trigger: "hover", for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: 'b9b620063fdfc4dbb4853b7032bce5cb0c170e6e', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleAction('showAssigned') }, index.h("wa-icon", { key: '5ebf1752c367aaa6f3e19719e226544d72e99dbf', style: { fontSize: '1.3rem' }, name: "list-ol", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), this.showDayUseButton && (index.h(index.Fragment, { key: '2cb3156bb792348ac9af5301b150ebb06934ca95' }, index.h("wa-tooltip", { key: 'b911487a4979b604bdf4817307aeae05447c8761', trigger: "hover", for: "fd-day-use-bookings_btn" }, 'Day use bookings'), index.h("ir-custom-button", { key: 'ff2bccfe97412fcd298c742a84055ba47fa0f776', id: "fd-day-use-bookings_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleAction('showDayUseBookings') }, index.h("wa-icon", { key: 'e1ed2ff28a6bf1611ffedca3f73a9640e05ea741', style: { fontSize: '1.3rem' }, name: "sun", label: 'Day use', "aria-label": 'Day use' })))), index.h("wa-tooltip", { key: 'f8e0380d8e6eb6dc978946ec877812108d070d92', trigger: "hover", for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '6d99ba321e23449da9cad3a326720c3d955c8473', minDate: this.minDate, onDateChanged: evt => this.handleDateSelect(evt), ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: '71194a2b0954498f845d56862394ad81cfec2d8c', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleAction('calendar') }, index.h("wa-icon", { key: 'f78b90594d4233d0706ed187eb6290c93990b38b', style: { fontSize: '1.3rem' }, name: "calendar-days", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '069b26cfd4aa426d7a4d4819d760b036370862f0', class: "fd-dates__actions" }, index.h("wa-divider", { key: '20366c09c7a5212e9c6ce13c71af40348495cca3' }), index.h("ir-custom-button", { key: '5d173e3e3d1a7b074d1114af13b22b2b4e847f7f', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleAction('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), index.h("wa-tooltip", { key: '45cf34f1893fc3f9a8ec43401cbdb16538653742', trigger: "hover", for: "fd-rectifier" }, "Rectify or open availability"), index.h("ir-custom-button", { key: '50b0baf1b1ee106a6c8782507d387222f5ffcad3', id: "fd-rectifier", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleAction('rectify') }, index.h("wa-icon", { key: '7d7d6751a8d781cb380ea760c663ca019dc07ca1', style: { fontSize: '1.3rem' }, name: "circle-check", variant: "regular", label: 'Rectify or open availability', "aria-label": 'Rectify or open availability' })), index.h(index.Fragment, { key: '5c610b76ef4dfc4a4aaa173aaf18929a04e9b49b' }, index.h("wa-tooltip", { key: '919a56098c755285a7f37f70901e6d090b5539df', trigger: "hover", for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: 'cf3df75090e409e38a50c8c7e71aeb4d04d5aed4', id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleAction('bulk') }, index.h("wa-icon", { key: '8b073d741eb9f498a65d9b6fa19d57580e90bd3e', style: { fontSize: '1.3rem' }, name: "xmarks-lines", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), this.roomsList.length >= 20 && (index.h("div", { key: 'a7b42a6fbb85ed613918028bcc73e34d1fd848a8', class: "searchContiner" }, index.h("ir-picker", { key: '566cd53871f82776420d1c5226a8a3cc2bc28c2a', size: "s", "onCombobox-select": e => {
...
const IglDayUseBookings = class {
    ...
    openBookingDetails(booking) {
        this.showBookingPopup.emit({
            ...
            data: {
                ...
                event_type: 'EDIT_BOOKING',
                TITLE: `${locales_store.locales.entries.Lcz_EditBookingFor ?? 'Edit Booking For'} ${this.getGuestName(booking)}`,
            },
        });
    }
    ...
    renderStayMovements(booking, movements) {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: "dub-booking__movements", id: movementsId }, isTurnover && (index.h("span", { class: "dub-movement dub-movement--turnover" }, index.h("wa-icon", { name: "rotate", class: "dub-movement__icon" }), "Turnover")), movements.map(movement => (index.h("span", { class: `dub-movement dub-movement--${movement.kind}`, key: `${movementsId}-${movement.kind}` }, index.h("wa-icon", { name: MOVEMENT_DISPLAY[movement.kind].icon, class: "dub-movement__icon" }), MOVEMENT_DISPLAY[movement.kind].label, movement.time && index.h("span", { class: "dub-movement__time" }, movement.time))))), index.h("wa-tooltip", { for: movementsId, placement: "top" }, index.h("span", { class: "dub-movement-tip" }, movements.map(movement => (index.h("span", { class: "dub-movement-tip__line", key: `${movementsId}-tip-${movement.kind}` }, index.h("span", { class: "dub-movement-tip__label" }, MOVEMENT_DISPLAY[movement.kind].label), index.h("span", null, "#", movement.bookingNumber, movement.guestName ? ` \u00b7 ${movement.guestName}` : ''), movement.time && (index.h("span", { class: "dub-movement-tip__time" }, movement.time, movement.isStandard ? ' (standard)' : '')))))))));
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '95db306ffafedc6fd6dd3b84158cac5ac1eadce9' }, index.h("div", { key: '398f9333603a5280f4828087efae7b086b30015a', class: "dub-panel" }, index.h("div", { key: '18e8e202b11d0d7b7fb1e4f32852077696a602dc', class: "dub-panel__head" }, index.h("header", { key: '98326e816589559271c8f8d2dbbb310bf8e30af5', class: "dub-panel__header" }, index.h("h2", { key: '572599ed3726135032f2fbab8bc5cd7a73c2653a', class: "dub-panel__title", id: "day-use-bookings-title" }, "Day Use Bookings"), index.h("ir-custom-button", { key: 'aeb873de3cab70bd68d391187a965c9aaafa624a', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: 'f262e06d54fc23e9e6722270a94a6031d5fc66c7', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: 'bdf2159478210af5254a94a0ca1b0eeb2e4656be', class: "dub-panel__toolbar" }, index.h("wa-select", { key: '61fdd80487f642175173a28703e670d22953d8b2', size: "s", "aria-label": "Date", value: this.selectedDate, defaultValue: this.selectedDate, onchange: evt => (this.selectedDate = evt.target.value) }, this.orderedDates.map(date => (index.h("wa-option", { value: date }, moment.hooks(date, 'YYYY-MM-DD').format('ddd, DD MMM YYYY')))))))), index.h("div", { key: 'cabdaef001852923e58ddb4b6e33cde253cb140c', class: "dub-panel__body" }, isEmpty ? (index.h("ir-empty-state", { message: "No day-use bookings for this date." })) : (Array.from(grouped.entries()).map(([roomTypeId, roomTypeBookings]) => this.renderCategory(roomTypeId, roomTypeBookings)))))));
    }
    static get watchers() { return {
        "dayUseBookings": [{
                "handleDayUseBookingsChange": 0
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '55b3255dbd12f4f0119f3fbbf24df19e6936347e', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '2103d3b3f5aeab94b9c2e099278e4a3fec50e45a', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: 'd6b2c6ddba1699868fda158305c883a445326a8c', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: '219e92aa96426feed94799c3224fb61db83ddf0a', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '7491d5552cff07838202007944aebe811fff9d58', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: 'bbdf499561a64ad1f0a87d01638a14a973ea8d78', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: '20713e71ecc083e904a94196e504277512c78a1f', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '15fb474f181624ff3a4bd65a17d487e8ef9f71a5', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '0b70f9f7adb984ac36c76fec9c22a2e4bebe4beb', value: "hk-toggle-clean-dirty", size: "m", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: 'a7b2e317c47adc8b15a8409747d42319dddb9af5', value: "hk-clean-inspect", size: "m", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '17422b81fc3bb20466b156e37aae26d67ba8e9fe', class: "legendContainer text-left" }, index.h("div", { key: '9826d0e9d98210941db04324bc721d4b0617bb74', class: "fd-legend__header" }, index.h("h2", { key: '4492f8b5fdcf053f13f874932b0d50288221cb3c', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '6e65c84c5dfe3b67f65a9c20670c2dffc7770d26', size: "m", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'f974675e1d2efff82188bf6d140e444fe6ca946f', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '8c6a47da6671e972a31b1b4472630b28070aa89d', class: "fd-legend__body" }, index.h("div", { key: '249d4e36535b0d57089337a0bc21884e71e9f52c' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '8f096a2969b93a6266b29ee88e924456e6e55582', class: "fd-legend__row" }, index.h("div", { key: 'f75bd80939b5881abbfa9c57ec56a1d447c9786e', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '7ea1f8a62bf44fd9094024dea6cd7546377d5dde', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: 'b659c51448e747994d711cd02b78fc127897bdc9', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("div", { key: '07a23d89207813bdd4eb8d5cc005d0d08fdc2922', class: "fd-legend__row" }, index.h("div", { key: '41b40c9a717cd9e9c7c6f3b7546bdee2bb4232a7', class: 'fd-legend__shape' }, index.h("div", { key: 'b73a34e7fcfa7a26d4c456088eb3ab12530c45e6', class: 'legend_rectangle', style: { background: 'var(--wa-color-success-fill-loud)', opacity: '0.6' } })), index.h("p", { key: 'b174a4fb077cac5c660eb3c5ec4ab6ca4748c671', class: "fd-legend__row-title --day-use" }, index.h("span", { key: '82418d7ac2b8d1a30f4f9d08fc3ac0f5cce9b296' }, "Day use"), index.h("div", { key: 'a493207360099491b8dc0cd79e0699eb28b40ae1', class: 'legend_rectangle', style: { background: 'var(--wa-color-brand-fill-loud)', opacity: '0.6' } }), index.h("div", { key: '6f8bcb7aac47dbd9101dd3f894b00a02c3ee2547', class: 'legend_rectangle', style: { background: 'rgb(160, 160, 160)', opacity: '0.6' } }))), index.h("wa-divider", { key: '043f539d5eccde3a7774f6e8f283fd030eb3ca4d' }), index.h("h5", { key: 'f95d82a949f8d953d1f62b47c57c4f2cfdd5afe3', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
            const previewClass = `legend_${legendInfo.design}`;
            return (index.h("div", { key: `legend_${index$1}`, class: "fd-legend__row" }, index.h("div", { class: 'fd-legend__shape' }, index.h("div", { class: previewClass, style: { backgroundColor: legendInfo.color } })), index.h("wa-input", { autocomplete: "off", class: "legendTextarea border-0 m-0 p-0", value: legendInfo.name, size: "s", placeholder: "Reason for this color", onchange: event => {
        ...
        })), index.h("wa-divider", { key: 'e6a7fba27ec5f0718bf44157117ec693a858f384' }), index.h("div", { key: 'cc48f69571a3450b27cf70081d6c0361ed27b7a4' }, index.h("div", { key: '41356e10c4348a877c51a7a06dc4cf1aa6052ef2', class: "legendCalendar" }, index.h("div", { key: 'dbfe40cba14572aab7b20a98e3a393a9c72cc072', class: "legendRow align-items-center" }, index.h("div", { key: 'a4529c23a82ce29c98505627c9bbe999bcfa3f6b', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '5f4047b26c7f8e7cbd24c22c776728df6699afc8' }, "MAR 2022")), index.h("div", { key: 'fddfe680833bccc4cb1d10e93e7a772d27a3b3d0', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'a29dc7aec9a85889d131dac5ef8ac27de22f07a0', class: "legendRow" }, index.h("div", { key: 'b9f3f09d2f25d2aaff8e01645b4a6d999ed965f5', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '347b0c3ddbb70d1b3012dab00e6ff81638aa8981', pill: true }, "3")), index.h("div", { key: 'a85a4f5542dbcde515021348effd410a4f314f25', class: "hyphenLegend" }, index.h("div", { key: '6c1cf57857991b744b452e60860e5a1ea4c592e3' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '2865128df934037962640ef9a39dc1a4a1a777e9', class: "legendRow" }, index.h("div", { key: '992526b974be1d7e12cac248b528ac896c8eb3bf', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '74f9b604f301fc6b17cbcbb6fb8aa23b2c5b517e', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '32dcf29800665ebbd71e90629ff6176126dc239f', class: "legendRow" }, index.h("div", { key: '1213968b5270992cff4612eddedd92f6aa19b245', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '5a313aea6e6b9c9163dbc3d465c4424df27c6574', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '12ac7f6524ddc740151b1f077b7c545f4993224a', class: "legendRow" }, index.h("div", { key: '4bc9dc0501abf118c0f058d0e24cc651cd0ce3fd', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '3c5046e4e9eef7080700655f481d1efc02fde3ac', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '962a598c209ae8e58a256f85ae71a7ab70e73ebe', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: 'f88ee6fa502f60c73780662faee72ea160a33f82', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
            ...
            } })), index.h("div", { key: '8a5f0dd01800e5e41d6e93f65343590361da7b16', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'f3efa1e1ce7a28484d78faae907f01f5e5076dce', size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '918a50821ad673b0e7d2e59c2493ad744b5ee360', loading: this.isLoading, disabled: !this.hasInventory, size: "m", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'acd62dc0a739e06778a9d04546b64b0892e18d70', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '2a2ebc3a9300a56fdf16bbe536e9bc3bf8ab7f02' }, index.h("div", { key: '01a6a7e68ae8751dbaf21b6e48217ecdb63db650', class: "dialog-body" }, index.h("p", { key: 'c4e2e3ce5d32be11ade5bd6b78c53cc97a889fe0', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: 'ce5dd5809b2b86bae8f75947d18fdb5974044703', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "s", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: 'b949ebc6593c6ae6587570277473b0d6247b2c95', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'eea4155c3973e3d168f0673d9604ec53c5bbec29', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '4ae718b97a200e0fdfe9bd2364ae6459efce1c30', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "m" }, "Cancel"), index.h("ir-custom-button", { key: '04c73284fd4a61010db9b47040d43bd13fdb2796', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '5201bfb1b1f24a2d26924881266ef846d22a2541', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '1d175a23a7eb1e7696a99b5e7518d361de46b2ba', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '44e9831dce3bcef999ce5b28948fa6305bfdee73', class: "px-1 sheet-body" }, index.h("div", { key: 'e650cd5248028f630ae7a8a52f4fa6b3b7d5093e', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '88201a67fc1bfb84c21012917f6a3f54f874f5a1' }, index.h("ir-date-view", { key: '9018e6648490eaba339d7282e5dae33d20309aa9', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: 'fa3d7ce84ad6dc69281b38f64000b052b9a4b60e', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '9fd207a3b8a0d1c258ebe72087d3174e7bf6a40c', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: '4fe380218d3dc9e437b8cc1e63cbb9c312bb4cb6' }, "From:"), index.h("ir-date-picker", { key: 'dea7b0593858c2a4293fb08711bbf1af795abc85', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '79735f5a85f678aa38f3373b299e83b3d8c1fc13', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: 'b4520d34d36c0db7da41a7da8106f7fbf5f0d2f4', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: 'f1fea04fe1a3bae742fb41c3a154a99f747a64d1', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '83ba0e1bd58d3745b28f6ee37a892c1c2832cb98', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '2b2e7ad0896aafa8b2a28814a7c490b4e84c8cd5', class: 'sheet-footer' }, index.h("ir-button", { key: '9999bcdcb3b03c39fbebf90bc0bf9a31f683888c', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '934cb8d3ee67bfe12c0eda869805a0fc7ee9c0e5', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e25d304dc60f17901d3a7ae7235bd69a2f4d0426' }, index.h("div", { key: 'c5703b8279228e19ab7e020660075ad21d4da438', class: "tba-category" }, index.h("h5", { key: '6edc80d59a7fee31f262b4f1d54b89392dad9548', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b97df0e8a68ca855a3f310e9b63bd789eb81c5fd' }, index.h("div", { key: '589f44b8c0084f94f097587a3546b5bd5553888d', class: "tba-panel" }, index.h("div", { key: '165bdaade72e9df174ddb288f3e15c51be42ded6', class: "tba-panel__head" }, index.h("header", { key: '911e251dc6eefe2158d6eb04e5dc30729d32cd40', class: "tba-panel__header" }, index.h("h2", { key: '3c2a7ca624b0b972298e71ef24410c90af641e24', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: '47b180730b012dfdbe27aad9ab5388daf4f71a48', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: '6116a66f56141fbcfcb973051a1bc99a527ea308', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: '0c12299eac5aa42db1e8b763e9348d6dd083a74e', class: "tba-panel__toolbar" }, index.h("wa-select", { key: 'a86aa38528a1487e34b184bfe5367e3a38d8e841', size: "s", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: '0119fe30cc3540fb82a7510e8d77ad8ab431ce2a', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '737ee667c42cd49078d740164629c48252db3a42', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'ddc656a64a38f3ce4634c4b301728dd7334fc235', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: '622061d0e5ae4b5c16c68e4efe7f274e6ffcbacb', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '43091ea964709e34548da529e53d0644c12b8936', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: 'a8506643296d7e30de6c6d135a44d94be0adad07', class: "hk-dot" }, index.h("slot", { key: '6cbae72f1db67ee144804373cfa0d63207d1163e', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '0f27415d6b8f67365a9f5b7491335c698ef55890', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'a395b167d08dd8a5f5bef32085ef254ca8df4dd5', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'b3aa353c3fddb2d1a7697460a2599b91fd361283', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'af77807249d6e62f3a6abdcf4d37baa445b6922c', class: `ir-alert-header` }, index.h("p", { key: '9d7693b41875afbe82c819a9163e7bc92da6feb2' }, this.modalTitle))), index.h("div", { key: '024b3dab636e2484fc6afcee9c075728243b5503', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'e45d60726a2015b168c04e572c3ab8cbc9f40ecf' }, this.modalBody)), index.h("div", { key: 'a67458615cfaeb31aa2f3e19d9ade4781fdec531', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '95f80f4e78b3ba4d5536fa92dbe843dc36336d0b', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: 'c9326460d546ce769a79899fe14e1fed2f8474d0', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '4f96517c069809a52bddc7b73991d33b5abedc67', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '1fd8db7fefa09a5c03df4e9182f97177c61e4b56', class: "input-group" }, index.h("label", { key: '3de747a9da2891e67699955923bc537f77cf8e51', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: 'd6714f334cd2e634350a52581df8c0ac0beea17f' }, this.label), index.h("input", { key: '65cac110166786fa07ca97fd80be038306a85375', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '5fada6a04900ef67c5d14208216a2ab6b611c985', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '6c4969494f2a2d60ab275b127ab0e945b7129ed1', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '7221e2a71c7e6fb39213288a5b26ab833ec47f30', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: 'f3e9a5e8c372eb8220603e4a8539a47209d6ef1a', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '7611006eef99c45354aa95bd17008734fe0e285b', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'ba7ea05f3046fcea182410a45032dd46b228be8d', form: this._id, size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    async handleSubmit() {
        ...
        try {
            ...
            const result = index$1.ExposedRectifierParamsSchema.safeParse({
                ...this.form,
                property_id: propertyId,
            });
            if (!result.success) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '752ba5999da46d01b9285b3a38c23b6d90d5a145' }, index.h("form", { key: 'a7ec5800d0ccca2a41b229254b889d778a6ee737', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: 'c496ee866fa00fad7c70acf12e2f4852f9d01bd4', size: "s", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '89b0970eb3d6cff164709ba9da4c75f5b0347c2d', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the selected room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'e3941e85e415904510a72d0dea68edc5e32aa5b7', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '854b5b7cd2deb62564fd57f315c5bda6766c00da', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '8f655c9c34804b51ab1bb0c95b02e4a23871b0e6', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: 'da63325c8b8384ee82031e4303c71bf81418d483', value: this.form.from ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '2bd9cc26bdd106524e8b0bdc38bbd1989705cd1b', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '60ff8a53318b7018a0cb16914002a8764ae45c06', value: this.form.to ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: 'b964e901659ddc4a99db896f8f4aefdfacf01c27', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrRectifierDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7e682b5934238b96b8f715a8d51d004ac1d8e3f3' }, index.h("ir-drawer", { key: '7e72c2602dd0827edd7f5c1d4a4edfdde4e3f1ec', onDrawerHide: this.handleDrawerClose.bind(this), label: "Rectify/Extend Availability", open: this.open, class: "rectifier__drawer" }, this.open && index.h("ir-rectifier", { key: 'f4df920ddfe39f7d600e3d710a3cd32de2025743', formId: this.formId, onCloseDrawer: this.handleDrawerClose.bind(this), onLoadingChanged: this.handleLoadingChange.bind(this) }), index.h("div", { key: '89c8189982f984e3b7586cc8b9baf8d6788e4679', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'cea0f4eb72f0aa36a57921a044999f67191cf50a', size: "m", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '5bfa4804fdeb9550e94ec4dde892f311cf57c354', loading: this.isLoading, type: "submit", form: this.formId, size: "m", variant: "brand" }, "Confirm")))));
    }
};
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7d890372c49314734f1e0339c12b2b588d6627d5' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
        "active": [{
                "onActiveChange": 0
