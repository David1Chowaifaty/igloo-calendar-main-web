...
const IrInput = class {
    ...
    // ─────────────────────────────────────────────────────────────
    render() {
        return (index$1.h(index$1.Host, { key: '39468054f80f4b1278815201e05c2fb9cbad0592' }, this.label && (index$1.h("label", { key: '387274e8e5240c15d520a5ce377ac2d8656b21bd', class: "input-label", htmlFor: this.id, part: "label", "data-active": String(Boolean(this.value) || this.inputFocused) }, index$1.h("slot", { key: '95951ddcbdedb0d3b89610a13f8d27218ef734b7', name: "label" }, this.label, " ", this.required && index$1.h("span", { key: 'ae854f24d208d4044e9cd52d1636dbb8a4e1b625', style: { color: 'red' } }, "*")))), index$1.h("div", { key: 'eed0545d3e3a32c5a44724910b2432cf2ea9e115', class: "input-wrapper", part: "wrapper" }, index$1.h("div", { key: 'a0573caf40029906c261bd91cb509fe8de6b8aef', role: "group", class: "input-prefix", part: "prefix", "aria-hidden": String(this.prefixHidden) }, index$1.h("slot", { key: 'e3766a979278906ff7af1277f170533cab8f5a3a', name: "prefix" })), index$1.h("input", { key: '089007e3abe67d3a7da6b542c8c8cc45612fc3d5', disabled: this.disabled, readonly: this.readonly, class: "input-field", maxLength: this.maxLength, type: this._type, ref: el => (this.inputRef = el), id: this.id, placeholder: this.placeholder, required: this.required, value: this._mask ? this._mask.value : this.value, onFocus: this.handleInputFocus.bind(this), onBlur: this.handleInputBlur.bind(this), onInput: this.onInput, "aria-label": this.label || this.placeholder || 'Input field' }), index$1.h("div", { key: 'b43d2c0f08a2b5a166fa2a6137e8a0a332a6b4a6', class: "input-suffix", role: "group", part: "suffix", "aria-hidden": String(this.suffixHidden) }, index$1.h("slot", { key: '929ac7a1c158e19ab5d170da9228f8520355b3a9', name: "suffix" }), this.clearable && this.value && (index$1.h("button", { key: '9b6bd2bd7b4690d0cad5c4f3e3ed97cef38948cf', type: "button", class: "clear-button", "aria-label": "Clear input", title: "Clear input", part: "clear-button", onClick: this.clearValue }, index$1.h("svg", { key: '80424935492b44abf1053c3f5e817cfd25b04c9e', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640" }, index$1.h("path", { key: 'fa5dda2a893b9482b48ab254b343e83c18e7e706', d: "M183.1 137.4C170.6 124.9 150.3 124.9 137.8 137.4C125.3 149.9 125.3 170.2 137.8 182.7L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7L320.5 365.3L457.9 502.6C470.4 515.1 490.7 515.1 503.2 502.6C515.7 490.1 515.7 469.8 503.2 457.3L365.8 320L503.1 182.6C515.6 170.1 515.6 149.8 503.1 137.3C490.6 124.8 470.3 124.8 457.8 137.3L320.5 274.7L183.1 137.4z" })))), this.type === 'password' && !this.disabled && (index$1.h("button", { key: 'e63026533e3220f44d133dbf060b7975912def59', type: "button", class: "visibility-button", "aria-label": "Toggle password visibility", title: "Toggle password visibility", part: "visibility-button", "aria-pressed": String(this._type === 'text'), onClick: this.toggleVisibility }, this._type === 'text' ? (
