...
const index = require('./index-e9a28e3e.js');
...
const IrInput = class {
    constructor(hostRef) {
        ...
        this.textChange = index$1.createEvent(this, "text-change", 7);
        this.inputBlur = index$1.createEvent(this, "input-blur", 7);
        this.inputFocus = index$1.createEvent(this, "inputFocus", 7);
    ...
    async initializeMask() {
        ...
        if (!nativeInput)
            return;
        this._mask = index.IMask(nativeInput, maskOpts);
        if (this.value) {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'aff3b61e4bf978bcd38a8974a695c0eac36c9527' }, index$1.h("wa-input", { key: '5d1a69aa7b8e9833c8f4bffbc5d6a09726028ecf', part: "wa-input", type: this.type, name: this.name, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, oninput: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotState.get('label') && index$1.h("slot", { key: 'ce777c35c7f960966e978e216c9d9aa0f2ea0be2', name: "label", slot: "label" }), this.slotState.get('start') && index$1.h("slot", { key: '68b77e386bdee3e93718804ff759ed1f6e7dc88a', name: "start", slot: "start" }), this.slotState.get('end') && index$1.h("slot", { key: 'cad232169912c4292e135d39d774388f3cfab662', name: "end", slot: "end" }), this.slotState.get('clear-icon') && index$1.h("slot", { key: '0270463426d42c5a5276a66c42cafa2cd085ef4e', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && index$1.h("slot", { key: 'b30ec3edb12cdcebb7bd279abae7d6253e4f4028', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && index$1.h("slot", { key: '949ccad591dbec0e2b429665b0595fd0bf2d5848', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && index$1.h("slot", { key: 'caccfb2b754de2500a77f78088739a01a3fb22fe', name: "hint", slot: "hint" }))));
    }
