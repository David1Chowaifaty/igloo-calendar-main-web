...
var index = require('./index-BquCITYD.js');
...
const IrInput = class {
    constructor(hostRef) {
        ...
        this.textChange = index$1.createEvent(this, "text-change");
        this.inputBlur = index$1.createEvent(this, "input-blur");
        this.inputFocus = index$1.createEvent(this, "inputFocus");
        this.inputCleared = index$1.createEvent(this, "inputCleared");
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: 'df8547f5b689ee6b48466ff2d83bbb79939d0bed' }, index$1.h("wa-input", { key: '4a0c5190e7b607cf42d2d78006be919d8692f9ce', part: "wa-input", type: this.type, name: this.name, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, oninput: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotState.get('label') && index$1.h("slot", { key: '70a98f7f87e791f2fb2cc33b5052d5fdbb4c9201', name: "label", slot: "label" }), this.slotState.get('start') && index$1.h("slot", { key: 'bec627cb50175091b94e152bef2e1ae91eeefa69', name: "start", slot: "start" }), this.slotState.get('end') && index$1.h("slot", { key: 'de1f6b15576d4978750a36aa1f6bf1803ac83eed', name: "end", slot: "end" }), this.slotState.get('clear-icon') && index$1.h("slot", { key: 'fa0fed198e1a883473e0ca985ba63670a2a0bcd6', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && index$1.h("slot", { key: '1428b3e24361bb4b6cee2b99ffc976df6b4ffd3a', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && index$1.h("slot", { key: '03ee384359e0dc17234b6b548d583da0c4024f69', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && index$1.h("slot", { key: 'd3025627cc08b057351294cac36e6c50ba541a88', name: "hint", slot: "hint" }))));
    }
