...
const index = require('./index-316f57ca.js');
const moment = require('./moment-1780b03a.js');
const v4 = require('./v4-9b297151.js');

const masks = {
    price: {
        mask: index.MaskedNumber,
        scale: 2,
        radix: '.',
        mapToRadix: [','],
        normalizeZeros: true,
...
const IrInput = class {
    constructor(hostRef) {
        ...
        this.inputChange = index$1.createEvent(this, "input-change", 7);
        this.cleared = index$1.createEvent(this, "cleared", 7);
        this.inputFocus = index$1.createEvent(this, "input-focus", 7);
        this.inputBlur = index$1.createEvent(this, "input-blur", 7);
    }
    ...
    // ─────────────────────────────────────────────────────────────
    componentWillLoad() {
        this.id = this.el.id || `input-${v4.v4()}`;
    ...
    initializeMask() {
        ...
        if (!maskOpts)
            return;
        this._mask = index.IMask(this.inputRef, maskOpts);
        if (this.value) {
    ...
    // ─────────────────────────────────────────────────────────────
    render() {
        return (index$1.h(index$1.Host, { key: '9b530bea994c85963d3278c714e811cc76137688' }, this.label && (index$1.h("label", { key: 'c573b5f672de7e520bc1c26ceddbee539340433d', class: "input-label", htmlFor: this.id, part: "label", "data-active": String(Boolean(this.value) || this.inputFocused) }, index$1.h("slot", { key: 'e04221c01a692157e70edfbdd0225aaaf1943f37', name: "label" }, this.label, " ", this.required && index$1.h("span", { key: '013b3f95202617f80e476a26fb1923cfd30b29a6', style: { color: 'red' } }, "*")))), index$1.h("div", { key: 'b6c405b81e8ad0d21ef314143a0b1d743d9d7f7c', class: "input-wrapper", part: "wrapper" }, index$1.h("div", { key: '66d73f1f266837a6398534a4baa786adf6580a81', role: "group", class: "input-prefix", part: "prefix", "aria-hidden": String(this.prefixHidden) }, index$1.h("slot", { key: 'b4cb1bf21300931a650cc2433c6523e8ca74f5df', name: "prefix" })), index$1.h("input", { key: '79dafae0b0dabcc33a163f71a7e9b3560ef6c148', disabled: this.disabled, readonly: this.readonly, class: "input-field", maxLength: this.maxLength, type: this._type, ref: el => (this.inputRef = el), id: this.id, placeholder: this.placeholder, required: this.required, value: this._mask ? this._mask.value : this.value, onFocus: this.handleInputFocus.bind(this), onBlur: this.handleInputBlur.bind(this), onInput: this.onInput, "aria-label": this.label || this.placeholder || 'Input field' }), index$1.h("div", { key: '32b4f340e890b852ef45f01cb481204633b9060a', class: "input-suffix", role: "group", part: "suffix", "aria-hidden": String(this.suffixHidden) }, index$1.h("slot", { key: 'bc69b5c66a964855ae24e9daed311f88d55c4342', name: "suffix" }), this.clearable && this.value && (index$1.h("button", { key: 'ee7782d091037310cc7957c8ac2bd74615af3c3f', type: "button", class: "clear-button", "aria-label": "Clear input", title: "Clear input", part: "clear-button", onClick: this.clearValue }, index$1.h("svg", { key: '48d1c82dd60f16546c9ffa7765f2bc94e00c5e3a', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640" }, index$1.h("path", { key: '3134fdff6d3f9788622d051236ca16a8e76cf981', d: "M183.1 137.4C170.6 124.9 150.3 124.9 137.8 137.4C125.3 149.9 125.3 170.2 137.8 182.7L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7L320.5 365.3L457.9 502.6C470.4 515.1 490.7 515.1 503.2 502.6C515.7 490.1 515.7 469.8 503.2 457.3L365.8 320L503.1 182.6C515.6 170.1 515.6 149.8 503.1 137.3C490.6 124.8 470.3 124.8 457.8 137.3L320.5 274.7L183.1 137.4z" })))), this.type === 'password' && !this.disabled && (index$1.h("button", { key: '452a488cd9da28d67f10a8fc21db6c2be460fdf6', type: "button", class: "visibility-button", "aria-label": "Toggle password visibility", title: "Toggle password visibility", part: "visibility-button", "aria-pressed": String(this._type === 'text'), onClick: this.toggleVisibility }, this._type === 'text' ? (
        /* eye-closed (password visible → click to hide) */
        index$1.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 24, width: 24 }, index$1.h("path", { fill: "currentColor", d: "M73 39.1C63.6 29.7 48.4 29.7 39.1 39.1C29.8 48.5 29.7 63.7 39 73.1L567 601.1C576.4 610.5 591.6 610.5 600.9 601.1C610.2 591.7 610.3 576.5 600.9 567.2L504.5 470.8C507.2 468.4 509.9 466 512.5 463.6C559.3 420.1 590.6 368.2 605.5 332.5C608.8 324.6 608.8 315.8 605.5 307.9C590.6 272.2 559.3 220.2 512.5 176.8C465.4 133.1 400.7 96.2 319.9 96.2C263.1 96.2 214.3 114.4 173.9 140.4L73 39.1zM236.5 202.7C260 185.9 288.9 176 320 176C399.5 176 464 240.5 464 320C464 351.1 454.1 379.9 437.3 403.5L402.6 368.8C415.3 347.4 419.6 321.1 412.7 295.1C399 243.9 346.3 213.5 295.1 227.2C286.5 229.5 278.4 232.9 271.1 237.2L236.4 202.5zM357.3 459.1C345.4 462.3 332.9 464 320 464C240.5 464 176 399.5 176 320C176 307.1 177.7 294.6 180.9 282.7L101.4 203.2C68.8 240 46.4 279 34.5 307.7C31.2 315.6 31.2 324.4 34.5 332.3C49.4 368 80.7 420 127.5 463.4C174.6 507.1 239.3 544 320.1 544C357.4 544 391.3 536.1 421.6 523.4L357.4 459.2z" }))) : (
        /* eye-open (password hidden → click to show) */
        index$1.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: 24, width: 24, viewBox: "0 0 640 640" }, index$1.h("path", { fill: "currentColor", d: "M320 96C239.2 96 174.5 132.8 127.4 176.6C80.6 220.1 49.3 272 34.4 307.7C31.1 315.6 31.1 324.4 34.4 332.3C49.3 368 80.6 420 127.4 463.4C174.5 507.1 239.2 544 320 544C400.8 544 465.5 507.2 512.6 463.4C559.4 419.9 590.7 368 605.6 332.3C608.9 324.4 608.9 315.6 605.6 307.7C590.7 272 559.4 220 512.6 176.6C465.5 132.9 400.8 96 320 96zM176 320C176 240.5 240.5 176 320 176C399.5 176 464 240.5 464 320C464 399.5 399.5 464 320 464C240.5 464 176 399.5 176 320zM320 256C320 291.3 291.3 320 256 320C244.5 320 233.7 317 224.3 311.6C223.3 322.5 224.2 333.7 227.2 344.8C240.9 396 293.6 426.4 344.8 412.7C396 399 426.4 346.3 412.7 295.1C400.5 249.4 357.2 220.3 311.6 224.3C316.9 233.6 320 244.4 320 256z" })))))))));
    }
...
IrInput.style = IrInputStyle0 + IrInputStyle1;
