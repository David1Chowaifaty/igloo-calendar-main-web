...
const IrHkArchive = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4792b3b6caa067f834fb33908decfb5ef15c8c28' }, index.h("ir-title", { key: 'd34260af8fac195e0b85cf14a0431dfb6c8720c7', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '6c0fc84df089d627b44628678db1033f4dc09ab0', class: "px-1" }, index.h("div", { key: '82412234ff77b1db8ad2a04c1aeef3cddf5c2660', class: "d-flex" }, index.h("ir-select", { key: '22397384c3a11063d4709f61580497773f6427c8', class: "w-100", showFirstOption: false, data: [
            ...
            } }), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("ir-select", { key: '5133ad58994f4467a9d4f27eb3b08f5493afb8d5', class: "ml-1 w-100", selectedValue: this.filters?.filtered_by_hkm?.length === housekeeping_service.housekeeping_store.hk_criteria.housekeepers.length ? '000' : this.filters?.filtered_by_hkm[0]?.toString(), showFirstOption: false, data: [
            ...
            } }))), index.h("div", { key: 'ed4c4964e42ba036fc8d3aecc3b09c6abecc94d9', class: "d-flex mt-1 align-items-center" }, index.h("ir-range-picker", { key: '3287375ea3864b6c8f774c7d0b0f2b94355772de', maxDate: moment.hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? moment.hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? moment.hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), index.h("ir-button", { key: '5d7ea844dbdd3d31345a2d8b30a3fae1cef1b22e', title: locales_store.locales.entries?.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), index.h("ir-button", { key: '825b78dd6dec34930b8a1da7bb29e3c929675372', title: locales_store.locales.entries?.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (index.h(index.Fragment, { key: '0449d4f08be7f07360b12448a31972a6898553be' }, this.data?.length === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("p", { class: 'text-center mt-2' }, locales_store.locales.entries.Lcz_NoResultsFound)) : (index.h("table", { class: "mt-2 table" }, index.h("thead", null, index.h("th", { class: "pl-0" }, locales_store.locales.entries.Lcz_Period), index.h("th", null, locales_store.locales.entries.Lcz_Housekeeper), index.h("th", null, locales_store.locales.entries.Lcz_Unit), index.h("th", null, locales_store.locales.entries.Lcz_BookingNumber)), index.h("tbody", null, this.data?.map(d => (index.h("tr", { key: d.id }, index.h("td", { class: "pl-0" }, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales_store.locales.entries.Lcz_WasVacant))))))))))), index.h("ir-sidebar", { key: 'cab7a0b2f229db93adb7dad5073b11eb022bed3e', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: 'var(--ir-color-muted-background,#f2f3f8)',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: '1c3970a259a62802ed33ca78d44d739ec893b1aa', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: this.selectedBooking?.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrRangePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b91f4328162fc7576a0763dc23b8947e07170cb7', size: "s" }, index.h("div", { key: '9bbadcf0c8a6ef211dd49c633b91b93966ba9129', class: "range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: '8356d2e63a94e07e476c19af4f62e4ee07ca25a8', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("wa-icon", { key: 'ee7f101e84cd1d7ebd9bf46b8915b7c7d0ffe149', name: "calendar" }), index.h("p", { key: '23038f50bfce8a0f11371f54d4ee8190917aca9f', class: "m-0" }, index.h("slot", { key: '665659011a80241acea45228d417483f3cb056f1', name: "message" }, "Cleaned on")))), index.h("svg", { key: '204ca7a8b12147774040352ed6b1beb909f6505c', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '54ce178181c9387742a55320290abdb8cfcd1251', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: '192dd3b8a77eee055f4db85f99cac22bb394366b', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'd089b06bea1edc428501710ecb906d7164b92cd2', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, this.fromDate?.toDate() || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrTasksCard = class {
    ...
    render() {
        return (index.h("wa-card", { key: '80200d29768ac2625ca1a22b7d21a75e81bbfaf0', class: "task-card" }, index.h("div", { key: 'd69e3959d96ed6ee072baebd244d17d1a6802098', class: "task-card__body" }, index.h("div", { key: 'fc7dcf3898e4066eb58fa66deabfcb8e99b1dbd3', class: "task-card__unit" }, index.h("span", { key: '9f32d3ba867042a9e55887d0d5e8d7afcdf41995', class: "task-card__unit-name" }, this.task.unit.name), index.h("div", { key: '600732264dcf1a96331b8ee6eb19a230925f17a4', class: "task-card__meta" }, index.h("span", { key: 'bbe8bcd7d839eda7f542d76f5534d427866c7070', class: "task-card__status" }, this.task.status.description), this.task.hint && index.h("span", { key: '18d157c7bb56a0e6966298d4f0ea72b6a3be1051', class: "task-card__sep" }, "\u00B7"), this.task.hint && index.h("span", { key: '64a6835c5ffd09be63e4b0a889a1bed10ec91940', class: "task-card__hint" }, this.task.hint))), index.h("div", { key: 'd23f464195de00c9364640c0c490563462b8f266', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (index.h("div", { key: '0df406fb1e46d407ae46a128b69d0b748dceb9da', class: "task-card__guests" }, this.guests.map(g => (index.h("div", { class: "task-card__guest" }, index.h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), index.h("span", { class: "task-card__guest-count" }, g.count)))))), index.h("div", { key: 'f9fc6fa5574f46e8feeebc43f8695d25a22200dd', class: "task-card__assign" }, index.h("wa-select", { key: '98cdc2a28256d3f0f4cefa837b0272a49b516c61', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, index.h("wa-option", { key: 'b5a67a2873fcd7fe04efd8f4f7e902e1b8078671', value: "0" }, locales_store.locales.entries.Lcz_Unassigned), housekeeping_service.housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (index.h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), index.h("div", { key: 'c1898658780f9a54f259604fa5ba7b479c52a361', class: "task-card__actions" }, this.isSkippable && (index.h("ir-custom-button", { key: '649ed8399424d00d4ffb5e841129015c69d31e0b', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (index.h("div", { key: 'fa98b59900ac2f9ab6b40b9b21c164849341e656', class: "task-card__clean-group" }, index.h("ir-custom-button", { key: 'f53ee4f93aaa72dab610f0099db944e75216ffef', variant: "brand", appearance: "filled", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), index.h("ir-custom-button", { key: '5b2add9dd549568491e9461f52cd3525915d901e', variant: "brand", appearance: "accent", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (index.h("wa-card", { key: '33f651ab144056bb1bf0681d99ee553c128afa15', class: `filters__card ${this.collapsed ? '--collapsed' : ''}` }, index.h("div", { key: 'b604b03414d6fcaf379caaef6be3b67adbb156d1', class: "filters__header", slot: "header" }, index.h("div", { key: 'ca74a39d8910816ee60d1f9081fd761f790b028a', class: "filters__title-group" }, index.h("wa-icon", { key: '580822f10cc14a71d9be085a1b3ec13786338c6a', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: 'dec8c4ff1b2a71416f9f522b1958b8083aaa7efc', class: "filters__title" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-custom-button", { key: '37c627eb45df923e7db4319c84c6ea82b0e65e29', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'ff40828ecb9c92044d2560e5ec183c43abd16f66', style: { fontSize: '1rem' }, name: !this.collapsed ? 'eye-slash' : 'eye' }))), index.h("div", { key: 'deb1a6bf9120765fdeba87a57a134020d9b0e725', class: `filters__body${this.collapsed ? ' filters__body--collapsed' : ''}`, id: "hkTasksFiltersCollapse" }, index.h("fieldset", { key: 'ad63a91d922cb91baf36784d3599ad6bfbf7b04e' }, index.h("wa-select", { key: 'e131c4b654e5a2829b0a7b0d08b8e8534e275995', label: locales_store.locales.entries.Lcz_Period, size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_service.housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("fieldset", { key: 'a9f6cb2635a32d067bab4e4db19b2772b07f4f25' }, index.h("wa-select", { key: '99037c7c26cf41673adc028c1610faf6c7f8c73b', label: locales_store.locales.entries.Lcz_Housekeepers, size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, index.h("wa-option", { key: '1487832776e2c775dac6001d6a82901facbbd47f', value: "000" }, locales_store.locales.entries.Lcz_Allhousekeepers), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), index.h("fieldset", { key: '0fd04f9342a5c50f29c5d54d8138e3cd34480097' }, index.h("wa-select", { key: '4c4e8e0964625c7d6aa4e5b52ca0d5e2035a818a', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.dusty_periods?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("fieldset", { key: 'ce538efbb94c6fab41fb48d1d78f2c5d6305e6d3' }, index.h("wa-select", { key: 'b7dee6ed567e1773c53c73008740ac040183e460', label: locales_store.locales.entries['Lcz_HighlightCheck-insFrom'], size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("div", { key: 'c2087d42d59be4fb41d092e80d9b4ce74795f409', class: "filters__actions" }, index.h("ir-custom-button", { key: 'a339bff09ec33a764c091d9f18a7a5145e6cac11', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries.Lcz_Reset), index.h("ir-custom-button", { key: 'c05e459bb0981b169e4a70133af1e2537d58aaed', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries.Lcz_Apply)))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9007db7e3d1fe94247811cc966a837bdd9de770b' }, index.h("div", { key: '804d6164d31d9b0502095d0b9a93f6bb9d06473d', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input", { key: '146cba8005495ec4901579bfe2daa154be26dc32', placeholder: "Search unit", class: "search-filter-input", value: hkTasks_store.hkTasksStore.searchField, "onText-change": e => hkTasks_store.updateSearchField(e.detail) }, index.h("wa-icon", { key: 'c2247c6bec95bc1d96d62b733c3e8b55b48fd942', name: "magnifying-glass", slot: "start" }))), index.h("div", { key: 'c7490f232dbd22b9eb679ae3e68a1b73ff3d4af0', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-custom-button", { key: '4cc73b217a73a0315e8a5451594685210f168a25', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, index.h("wa-icon", { key: 'b5754a471873ab52fbe37238dcd7779f08900ef8', slot: "end", name: "file-excel" }), locales_store.locales.entries.Lcz_Export), index.h("ir-custom-button", { key: '05473dea9244992759b8a3766b4811414de67478', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, locales_store.locales.entries.Lcz_Archives), index.h("wa-animation", { key: '0e573bd14ef43bf54c000e3b2f7579f95b5f00c3', iterations: 1, id: "cleanInspectAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: 'e22487e0c98c9684245630a04a1c27260d84292a', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), index.h("wa-animation", { key: 'f9fe756c01cabd349d41c4ca5e458f41b2d482f7', iterations: 1, id: "cleanAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: '7aa7b344657b67b687cd9516f15c296c9f966369', disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '42e0ad47bb5c5d1e0b6b1a9bf5f608211b775ee2' }, index.h("section", { key: '443a4394fa5cfe943e72b4740188f15b3489f698', class: "mobile-tasks-container" }, index.h("wa-card", { key: 'fa78d6da4ffc66d0e2a3029ba598b6cc31607c99' }, index.h("ir-tasks-header", { key: '0ad7ce5f64320a9eb5f8099bb298cfbcd95476c7' })), mobileTasks?.length === 0 && index.h("p", { key: '7f1a93fc57f5ddeadc0da46915e137d08e28a4ac', class: "empty-msg" }, locales_store.locales.entries.Lcz_NoTasksFound), (() => {
            const groups = [];
        ...
        })(), index.h("ir-tasks-table-pagination", { key: 'dffd95bf075187f0a88ce05c2bf7cd0a6a3fb917' })), index.h("wa-card", { key: '77bf06f5eb002f98e43a9ba0ccef6067d6526de8', class: "table-container" }, index.h("ir-tasks-header", { key: 'd64dede58312018825c33a521ca6ede69baa4c75' }), index.h("div", { key: '96e7cf74515ec3388f8b10bf9a443b5a12569ef1', class: "table--container" }, index.h("table", { key: 'e48bff63b25be4f042b95ee28c5160a849e41623', class: "table data-table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'ed93a67f58bac3db81f2df7197a0a8d67b3f5f46', class: "table-header" }, index.h("tr", { key: 'f58252dcd7c6d5289da4d938e164b48b8139df91' }, index.h("th", { key: '119848a1b6b531609f7f5cda74397e28f6fb5ca8', class: 'task-row' }, index.h("wa-checkbox", { key: 'a2ff4f7c041ebc0b15d5d1fef566fffc14b4d8a3', indeterminate: hkTasks_store.hkTasksStore.selectedTasks.length > 0 && hkTasks_store.hkTasksStore.selectedTasks.length < hkTasks_store.getCheckableTasks().length, checked: this.allSelected, defaultChecked: this.allSelected, onchange: () => this.toggleSelectAll() })), index.h("th", { key: '7a7ddf72f195c8bb44fd367a50649d3531c4b47e', class: "" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: 'aff05d09ae608787a85e0e95190649c5250f6e06', class: "" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: 'a3e239c3d953719de9cc4f6a176674d3dae3cc5e', class: "sortable", onClick: () => this.handleSort('status') }, index.h("div", { key: 'fc1233b2a68ceb2f448e860f9a904b7a9a19d2e5', class: "th-sort-inner" }, index.h("span", { key: 'dcafa93dbc1c2f7020bc20eb03041bed80a43759' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: 'd06ba513f57fb2d1ec1c3fff75f7ab027eaeffaa', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '9dccf5de01fe77956d2811c84726010c6ebbbe87', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'a2ed9d69019fd476d82e65701d3b4452996bc725', d: "M17 20V4" }), index.h("path", { key: '3edf2e90e21234ca9c57fb09011d2d12c80b47f5', d: "m3 8 4-4 4 4" }), index.h("path", { key: '3a1fb46dccfc1a0faa8f8317739370104ba4a188', d: "M7 4v16" })))), index.h("th", { key: 'ba7fca40a568023bd3b89c0029d899d39b1b5866', class: " text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '96ceb8d3375e4f05c95cd7811751b28898f96693', class: " text-left" }, "Tasks"), index.h("th", { key: 'c32abbf7c468fa97a1fd22bef970bed3216c5849', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: '5e54efeec67cce509fd9676263e2c8ccf449e980', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '979c21aa96c44b9c3ff8640d70b0707a00533ca1', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: '02ab437f44d578c9f0bda31b97a09b126144dc3a', class: "sortable", onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'ea7771d8662a5959130752812883579b3447c7e1', class: "th-sort-inner" }, index.h("span", { key: 'a010bac98d0ec97ffcbd49e7e7ee6b6bfa6ea6a4' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: 'd0616d271d0da0d77f36dcb28274dff08fdb44e5', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '1cd10f9e4363c34559c91b4a2cf8bb1861b9ee06', d: "m21 16-4 4-4-4" }), index.h("path", { key: '65ad1d1d5a0b5350865c06682cb53f8263d30702', d: "M17 20V4" }), index.h("path", { key: 'c2e2ae809bb876f01e4b84b6589bd667891327b3', d: "m3 8 4-4 4 4" }), index.h("path", { key: '9dcd4666ddf612a25698a41185cf534aa23c7cab', d: "M7 4v16" }))))), index.h("th", { key: 'db559ce300b107d1b9a9d1e4310bf7f4df139ed2' }))), index.h("tbody", { key: 'ab954e7d35841f6409ab196afb37a3bda06d9684' }, tasks.length === 0 && (index.h("tr", { key: 'dfc16ed66622607d65dcc154ab11a848abad01e4', class: "ir-table-row" }, index.h("td", { key: 'c8121b9d88edecaa1a0b1df098005e39495d8587', colSpan: 9 }, index.h("div", { key: '4fa815f368c08b8e8bb3b2772f17beee2d2c00c7', class: "table-empty-state" }, index.h("span", { key: '19d04949d78e6954545edb14411761517fcff5c0' }, locales_store.locales.entries.Lcz_NoTasksFound))))), tasks?.map(task => {
        ...
        })))), index.h("div", { key: '87d1b710b7f7cebbcf11329da401cae86269b617', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: 'cf63adbf15f3dddf57a830d4b5fd976318ca5cb0' }))), index.h("ir-dialog", { key: 'c7f088c680eca654c282d571d32eaeada01b00e3', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: '1b4d117e97045a00bf27439036cd344ee9eb313b' }, locales_store.locales.entries.Lcz_Assign, " ", index.h("strong", { key: 'a110f450ae8694ddfb405e04d7bd8cf1525ee907' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: '6e6050f4c4aac1bb21802cba5305ab452b059836' }, pendingHkName), "?"), index.h("div", { key: '1736e0326b6709fc7122aa8dab89d790540f96b3', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: 'f9e3f7926fd194ca9962e1e4f9d9a7c9bdaba77e', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '3774605de5452241cd07b806f7a389904a40d24d', size: "m", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales_store.locales.entries.Lcz_Confirm)))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '864ca8bf6d9488ec30d3b4a3168a7d2b08853849' }, hkTasks_store.shouldLoadMore() && index.h("ir-button", { key: '156ff142c9a183155faeee2188de3220aadc6ba5', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => hkTasks_store.loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: '2b92be4b77b26a53bba247e6a80609e08d5ba1b8', showing: {
                from: start,
                to: end,
