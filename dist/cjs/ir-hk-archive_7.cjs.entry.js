...
const IrTasksCard = class {
    ...
    render() {
        return (index.h("wa-card", { key: '83234608df9bae7002afcd757deb7e03b718e2a2', class: "task-card" }, index.h("div", { key: '78fede6152f1f93f18d12d807ce4f48221a8e914', class: "task-card__body" }, index.h("div", { key: '47a28515a4eb2bf12e697900bf7fdc8bf1b55c2b', class: "task-card__unit" }, index.h("span", { key: '410b3545e6361957efe1bda2a63ee2cc507d096c', class: "task-card__unit-name" }, this.task.unit.name), index.h("div", { key: '80602e18909fae8b16df505ea7882918972e4c62', class: "task-card__meta" }, index.h("span", { key: '57ab0102332403c82310e8ec3008ff8c6599ca54', class: "task-card__status" }, this.task.status.description), this.task.hint && index.h("span", { key: '626762c34d795b64cc7753373571f618800add2a', class: "task-card__sep" }, "\u00B7"), this.task.hint && index.h("span", { key: '19762ba9ac3b97cab1af7bdc7280989257ba2623', class: "task-card__hint" }, this.task.hint))), index.h("div", { key: '03255a288588fdaa0d71b03d19def55ab54fa155', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (index.h("div", { key: '3f96e15f8e7adae5e209d8741465bc24047f08da', class: "task-card__guests" }, this.guests.map(g => (index.h("div", { class: "task-card__guest" }, index.h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), index.h("span", { class: "task-card__guest-count" }, g.count)))))), index.h("div", { key: '4261293bce1e34f3c3698491d5f8921f94199a83', class: "task-card__assign" }, index.h("wa-select", { key: 'f7bbc180cab6b4e9e87c3b60d96da710bf985be3', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, index.h("wa-option", { key: '11ae192c2c09bf931b77c46a867a131b3c3e2889', value: "0" }, locales_store.locales.entries.Lcz_Unassigned), housekeeping_service.housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (index.h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), index.h("div", { key: '558e2301d1c4b7c5a8c7b68cbcd7ab78721649f2', class: "task-card__actions" }, this.isSkippable && (index.h("ir-custom-button", { key: '25c849f691a7b25cb6dcba40c3fd0618092ac071', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (index.h("div", { key: '068efd86fbbc50d0f0b57f883a9c1a6cf01f8518', class: "task-card__clean-group" }, index.h("ir-custom-button", { key: '290d19cbf1d5e4638c9398f2fae6016eb7255c02', variant: "brand", appearance: "filled", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), index.h("ir-custom-button", { key: '2117031c89b626cc20d417b5ce679174e99ca397', variant: "brand", appearance: "accent", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (index.h("wa-card", { key: '5fe8644287d0256cda7549a55285e9ef275ca5f4', class: `filters__card ${this.collapsed ? '--collapsed' : ''}` }, index.h("div", { key: '36bd763d494851ae3354506eb047cfeb801df8c7', class: "filters__header", slot: "header" }, index.h("div", { key: 'a26b491022b2ebd79dc3eea448f26ff6e5118b14', class: "filters__title-group" }, index.h("wa-icon", { key: 'dc27bb765c798add31c99c96e412f3ffb971584b', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: 'fe2e8d5b51d4a6757591d66d16380446b916de45', class: "filters__title" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-custom-button", { key: '5b392844b0acd3f415387a29c101bfc83db726fc', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '569b0bf758d9af1d5c64ecd0c2928e6360377a4a', style: { fontSize: '1rem' }, name: !this.collapsed ? 'eye-slash' : 'eye' }))), index.h("div", { key: '2d56dee81eba8591b2551691dc0c53ecd35bbc0d', class: `filters__body${this.collapsed ? ' filters__body--collapsed' : ''}`, id: "hkTasksFiltersCollapse" }, index.h("fieldset", { key: '0fcd7a4d521d10a246cd30ac74d633ec96f78683' }, index.h("wa-select", { key: 'c5601e5c060f985f09467b15d81ee7d0611c53c5', label: locales_store.locales.entries.Lcz_Period, size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_service.housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("fieldset", { key: '1e12a9e47517b281982dc6bb251f473b0da495c9' }, index.h("wa-select", { key: 'e6c4811d2b2d1f4a62e52e5ead1b67fb19b81fda', label: locales_store.locales.entries.Lcz_Housekeepers, size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, index.h("wa-option", { key: 'ace4ee1c91d76f696c5b936fb9cb46c75e92ca66', value: "000" }, locales_store.locales.entries.Lcz_Allhousekeepers), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), index.h("fieldset", { key: '81f1c651f94c136f77db2e7a41511da0fb944f63' }, index.h("wa-select", { key: 'e4b03e7d4879df7dc934dd284806ff86fb926e22', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.dusty_periods?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("fieldset", { key: 'fef30abeb808988b2099e0f3654faae96c319457' }, index.h("wa-select", { key: 'd6e1d161ed8f1222f5b386376c9d13987c98c42f', label: locales_store.locales.entries['Lcz_HighlightCheck-insFrom'], size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("div", { key: '3f47bccedbdf7d07a6a4ce7b8e8ce69e8008ac3c', class: "filters__actions" }, index.h("ir-custom-button", { key: 'f3c9ff9dfd8da53fecbef4e79252bf884f4f794e', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries.Lcz_Reset), index.h("ir-custom-button", { key: 'd31bf13325bd0b7254a2bd13d3f15341688eccc3', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries.Lcz_Apply)))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c5136f8d48cf677396fb443e4784657ea274dd9a' }, index.h("div", { key: '9f3ba83391a7b6621f099758345c1f15164d2974', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input", { key: '87580ac51ce4c6eb0df926bff8c4e66f3186791a', placeholder: "Search unit", class: "search-filter-input", value: hkTasks_store.hkTasksStore.searchField, "onText-change": e => hkTasks_store.updateSearchField(e.detail) }, index.h("wa-icon", { key: '106c1ee28a6fadee37fc4569fff6d9bf740f8510', name: "magnifying-glass", slot: "start" }))), index.h("div", { key: 'ae11bab1d9683817eaffe3668412f214ffd1e0d1', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-custom-button", { key: '468b7bd756cdc32b51019e59b8b66ad6d43a98a3', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, index.h("wa-icon", { key: '617dd810b4230c1d10e6848dee4f207b1826379a', slot: "end", name: "file-excel" }), locales_store.locales.entries.Lcz_Export), index.h("ir-custom-button", { key: '86a13d8fde78a5fc788ad10d419332556a525e62', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, locales_store.locales.entries.Lcz_Archives), index.h("wa-animation", { key: 'f49572cbf0bb6327276b1cf004bca0264e24d026', iterations: 1, id: "cleanInspectAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: 'bcd46ad0d2f44a167d8d4437e97f5976a12e0a29', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), index.h("wa-animation", { key: '582e2387f4f215bf8c8da99874f59b8e061e5229', iterations: 1, id: "cleanAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: '536e06f7bdc6f1ae589f08430dcf47759f7a0ea5', disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '01c7603824f247ede5eebbe7f31584e4bf129fcd' }, index.h("section", { key: '68df6174df12821068d15b01115a4f2192568bb1', class: "mobile-tasks-container" }, index.h("wa-card", { key: 'f31109f1991ea70abcda47b17d3a33c16928aada' }, index.h("ir-tasks-header", { key: 'eb865930e37c6c053c8216a0d3786f5a84e89c05' })), mobileTasks?.length === 0 && index.h("p", { key: 'd5eab349fbee2e5dde0b0661b44e6f5b58a9af6e', class: "empty-msg" }, locales_store.locales.entries.Lcz_NoTasksFound), (() => {
            const groups = [];
        ...
        })(), index.h("ir-tasks-table-pagination", { key: '231012661c44705d3436d86a63b452e721a386e0' })), index.h("wa-card", { key: '9ae2506bf1da9779d3f99ca34e0b7dad53b559af', class: "table-container" }, index.h("ir-tasks-header", { key: 'e60480ce74e5c81f11e1fb7f3fd5aeadd7278a21' }), index.h("div", { key: '7e456af31eccfab69c03ee96f1683b21b3abc3fd', class: "table--container" }, index.h("table", { key: 'bb4bb8f34f127c1beb1c49b12d9fa036d3060131', class: "table data-table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'de22ee9dffc923b394fb57d1bd8e5ff63b0ee78d', class: "table-header" }, index.h("tr", { key: '7f7831e5554b91d24a1c3d0ea1dcf8c28fd06b69' }, index.h("th", { key: '872a1005c65e6c242244b5525eca863801628f41', class: 'task-row' }, index.h("wa-checkbox", { key: '38c9338309649a7aefc1346fb74ac0ff9f0d2f95', indeterminate: hkTasks_store.hkTasksStore.selectedTasks.length > 0 && hkTasks_store.hkTasksStore.selectedTasks.length < hkTasks_store.getCheckableTasks().length, checked: this.allSelected, defaultChecked: this.allSelected, onchange: () => this.toggleSelectAll() })), index.h("th", { key: '825209e01ec16900e8462e02ea6fac0661f1e032', class: "" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '25b66f158e67b0a7bc028ac9e00e6e339a64782a', class: "" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '6c4b7581f1172e1d77a46d45140bc1912631720e', class: "sortable", onClick: () => this.handleSort('status') }, index.h("div", { key: '9e95639515ee874fb341bb55690fd74c6c60f03c', class: "th-sort-inner" }, index.h("span", { key: '8dfb394df61d6eecefc002eb2ef25a2c4e0ff65f' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: 'ae3dbfbf0a64887fe1d6ec5e5d552a1f5b2c7a81', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'f702bf6974e3c143775c38125fc037a896edc506', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'cb40d4fa686624e1d2ec84ad123e26f95441a052', d: "M17 20V4" }), index.h("path", { key: '7439804d955175d1fdd78964e995948d50456d5f', d: "m3 8 4-4 4 4" }), index.h("path", { key: '0282e3e95d1f469cbdf97aec290295ae825448f9', d: "M7 4v16" })))), index.h("th", { key: '3d14f2c749599c7b4bcfc7de1f791ee97e59cfcf', class: " text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: 'f4804f31e82bb7b6192778449637a470ef511358', class: " text-left" }, "Tasks"), index.h("th", { key: 'ea8935eba2e2734079916a2c1fa32ddffd25d29e', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: '5b97b0071fa864a019bc77ea779cbdf2c5fad43f', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '3dc12f116e4661082042ea6b58d329075cf996a7', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: 'f2f93b30c8b13a4597440a5ef27854b5fead396f', class: "sortable", onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'e16ef80484d53c6cb7937fc95d32e4d7c3f91d3c', class: "th-sort-inner" }, index.h("span", { key: '70b1e9d9698f2083d0b547f3b31667adef58e4c7' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: 'e7fe5bae3a764abc77d7ffd61c2c630721d340b3', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '62f9986845b807262a85b26bbbc8225829daed89', d: "m21 16-4 4-4-4" }), index.h("path", { key: '2607f7525bb326051678ec363730b4a7d9c2e132', d: "M17 20V4" }), index.h("path", { key: 'f0a16782f937fc9317fb1937b90cc649a804c2ac', d: "m3 8 4-4 4 4" }), index.h("path", { key: '1c4b16e485318593be455514b1eda64cadd32480', d: "M7 4v16" }))))), index.h("th", { key: 'cd86e3b7cb2f89026ef2d08ada54d72c99990f52' }))), index.h("tbody", { key: 'b0ffcd4d779f27bf36f973dcb53fb81187919be9' }, tasks.length === 0 && (index.h("tr", { key: '62b9c829c779f89f1abea72728eeae9bf6d57cbd', class: "ir-table-row" }, index.h("td", { key: '38d8896d17589c22c803be28d76aa62c2036483e', colSpan: 9 }, index.h("div", { key: 'bf20bac47e08cda73ccd96cf9f545f1991dbb489', class: "table-empty-state" }, index.h("span", { key: 'c561aee1b599e942bc3960d9015d902697bcc161' }, locales_store.locales.entries.Lcz_NoTasksFound))))), tasks?.map(task => {
        ...
        })))), index.h("div", { key: '1cd8e3c38b7cfd3ddc93a4392a9e7e17b6797fa3', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: 'b56d1691f4bd31c0ddf2133ec76d3ac1e5f077d9' }))), index.h("ir-dialog", { key: 'cc3112e75f12cc0d97702722f86a5edff581ed6b', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: '0230c94c199326f28dd44cc294b89567fb28defb' }, locales_store.locales.entries.Lcz_Assign, " ", index.h("strong", { key: '15111c5e5719e8f67e99b085d14283ef6ccd8bf8' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: '95d87715717e5d86d660194c1743fe39a1ccb715' }, pendingHkName), "?"), index.h("div", { key: '566ddf4899e6e614d1c017f9d331fad1d3f833a4', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: 'c60e5aaf0fe22c15ca3ea9d53fe2535a6fe8e8b1', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'aee0441d25e2062428925a1be48416960a43ceff', size: "m", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales_store.locales.entries.Lcz_Confirm)))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '97b689adaa4089198c415dd819be6583f4ded4a2' }, hkTasks_store.shouldLoadMore() && index.h("ir-button", { key: '7e1db2156659ff8e424785d09f498e44a943bdc0', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => hkTasks_store.loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: '4c6d31b489428cae34f6348dc00eec676fbdf20e', showing: {
                from: start,
                to: end,
