...
const IrHkArchiveDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cdc38dbd16f6650907f111f313d3f7d2c31d06cf' }, index.h("ir-drawer", { key: 'b6c0fae20bbf2554f42fa936d948d85869761a4b', open: this.open, label: "Cleaning Archives (90 days)", class: "hk_archive__drawer", onDrawerHide: () => this.drawerClosed.emit() }, index.h("div", { key: 'd33b845ea18531acaf70d2f369d578111d29cd7c', class: "archive-content" }, index.h("div", { key: '2e43714a0a76b1d9bcaed94c1ffe8aa9d8845e16', class: "filters" }, index.h("div", { key: 'c94bc006c766d0d7d95421aa4378038c708253dc', class: "filters-row" }, index.h("wa-select", { key: '5593959c209a3ecb143b21cb4972ac21276251c5', size: "s", placeholder: "All units", onchange: (e) => {
                const val = e.target.value;
                this.updateFilters({ filtered_by_unit: val === '000' ? [] : [Number(val)] });
            }, defaultValue: '000' }, index.h("wa-option", { key: 'c2e2788ca6eb43ea95afe8546e15686670fd2625', value: "000" }, "All units"), this.units
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { value: v.id.toString() }, v.name)))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("wa-select", { key: '47837de8f21097c6c60b27d97d6f943fcf19c434', size: "s", defaultValue: '000', placeholder: "All housekeepers", onchange: (e) => {
                const val = e.target.value;
                this.updateFilters({ filtered_by_hkm: val === '000' ? [] : [Number(val)] });
            } }, index.h("wa-option", { key: '92d3a4d4b3ef9ea04f66f7526d23b8d590042edf', value: "000" }, "All housekeepers"), housekeeping_service.housekeeping_store.hk_criteria.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { value: v.id.toString() }, v.name)))))), index.h("div", { key: '9c8a9ab62f2e61cf89532adaf873bf4970f9efc8', class: "filters-row" }, index.h("ir-date-range-filter", { key: '171208c345c470cef909793642796798581d2b55', withClear: false, selectionMode: "auto", maxDate: this.maxSelectableDate, minDate: this.minSelectableDate, fromDate: this.filters.from_date, toDate: this.filters.to_date, onDatesChanged: e => this.updateFilters({ from_date: e.detail.from, to_date: e.detail.to }) }), index.h("div", { key: 'fbfbfdd3b0358262c6b69cac12f2a2323a87ab11', class: "filter-actions" }, index.h("ir-custom-button", { key: '5862f156343978f7d346ca3d7dc239159aa39042', variant: "neutral", appearance: "outlined", loading: this.isLoading === 'search', onClickHandler: () => this.searchArchive() }, locales_store.locales.entries?.Lcz_Search ?? 'Search'), index.h("ir-custom-button", { key: 'cf19541d364b8ca010a5fb1a3010e4f3579b1926', variant: "neutral", appearance: "outlined", loading: this.isLoading === 'excel', onClickHandler: () => this.exportArchive() }, index.h("wa-icon", { key: '0f2aa24b46ba498607e4081f602ca9469e7e1fb9', name: "download", slot: "start" }), locales_store.locales.entries?.Lcz_ExportToExcel ?? 'Export')))), this.fetchedData && (index.h("div", { key: '9c78c1b5780332d8e3e247e576adb16b8d7e0245', class: "results" }, this.data?.length === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("ir-empty-state", { message: locales_store.locales.entries?.Lcz_NoResultsFound ?? 'No results found' })) : (index.h("div", { class: "table-wrapper" }, index.h("table", { class: "table data-table" }, index.h("thead", null, index.h("tr", null, index.h("th", null, locales_store.locales.entries?.Lcz_Period ?? 'Period'), index.h("th", null, locales_store.locales.entries?.Lcz_Housekeeper ?? 'Housekeeper'), index.h("th", null, locales_store.locales.entries?.Lcz_Unit ?? 'Unit'), index.h("th", null, locales_store.locales.entries?.Lcz_BookingNumber ?? 'Booking #'))), index.h("tbody", null, this.data?.map(d => (index.h("tr", { key: d.id, class: "ir-table-row" }, index.h("td", null, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: "unit-name" }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-custom-button", { link: true, onClickHandler: () => (this.selectedBooking = d.booking_nbr) }, d.booking_nbr.toString())) : (locales_store.locales.entries?.Lcz_WasVacant))))))))))))), index.h("ir-booking-details-drawer", { key: 'f2d6b6c41f5f1051233e319e126fda53879badd2', open: !!this.selectedBooking, propertyId: Number(this.propertyId), bookingNumber: this.selectedBooking?.toString(), ticket: this.ticket, language: this.language, onBookingDetailsDrawerClosed: () => (this.selectedBooking = null) })));
    }
};
...
const IrTasksCard = class {
    ...
    render() {
        return (index.h("wa-card", { key: '8833cf78631b098d1c443c26860d00b37dd8ef0a', class: "task-card" }, index.h("div", { key: 'ee6b9a643d88a2c8ecd597846fef27660dd59e16', class: "task-card__body" }, index.h("div", { key: 'd50966cb9a46682b730091341945bebb86e62c9a', class: "task-card__unit" }, index.h("span", { key: '9c2d3fa18dd5bdfec3d025468887ba9140b8367c', class: "task-card__unit-name" }, this.task.unit.name), index.h("div", { key: 'f9b9aac06893ecc244551199a7420a418fa69f35', class: "task-card__meta" }, index.h("span", { key: 'c41fe090d01a06f22bf76e2790075f6c1c188b48', class: "task-card__status" }, this.task.status.description), this.task.hint && index.h("span", { key: 'eb8ae0a9bd41919ab2dc6ebd29f588078ea99fb6', class: "task-card__sep" }, "\u00B7"), this.task.hint && index.h("span", { key: 'ff04b77c5ae5c8b69c91d31da3a83a1d182ca67c', class: "task-card__hint" }, this.task.hint))), index.h("div", { key: '0f388f93ee309b38b805a951f25e511699d94fd3', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (index.h("div", { key: '9749437ecf5e600bf2fd1de6f397d656bfdb5a93', class: "task-card__guests" }, this.guests.map(g => (index.h("div", { class: "task-card__guest" }, index.h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), index.h("span", { class: "task-card__guest-count" }, g.count)))))), index.h("div", { key: 'ae4071de67261b7187e6b83410676548b4cf416c', class: "task-card__assign" }, index.h("wa-select", { key: '77793c160f9db4909b54fa9f53fd35acb9518131', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, index.h("wa-option", { key: 'b3cac545629ec0162cd1a399a2fcbac8098da569', value: "0" }, locales_store.locales.entries.Lcz_Unassigned), housekeeping_service.housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (index.h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), index.h("div", { key: '3cecd1b1706d4d58ad8d3c610c7d26ab2c7c9f58', class: "task-card__actions" }, this.isSkippable && (index.h("ir-custom-button", { key: 'f831ba5d3933bfa4be395f83f87233794a0f1234', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (index.h("div", { key: '60e2ffd66d383dbe16e63de9556c8c8d424a6d05', class: "task-card__clean-group" }, index.h("ir-custom-button", { key: '8ccfba493a9637d8b75c4f3094c6879ea3009907', variant: "brand", appearance: "filled", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), index.h("ir-custom-button", { key: '67d42680c2282d1bbc7042a00db50c9204af7bc4', variant: "brand", appearance: "accent", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'a27a69504629744d6aa2df78c6ed1b6b2010556a' }, index.h("fieldset", { key: '189f6dee59e0bf99b26caf71c94d25da16f67b7a' }, index.h("wa-select", { key: '3c0f39293d2e6cf014a175d8cb3515c528de75e6', label: locales_store.locales.entries.Lcz_Period, size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_service.housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("fieldset", { key: '2051c543c25ec946842194636a96c10f70325b61' }, index.h("wa-select", { key: 'd227ceba6df27a1183dff7242e25b8a63d32e100', label: locales_store.locales.entries.Lcz_Housekeepers, size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, index.h("wa-option", { key: '0a058976a8c71c382a494f800e1fe9e6f77534d9', value: "000" }, locales_store.locales.entries.Lcz_Allhousekeepers), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), index.h("fieldset", { key: '1d1fce78a15da83e94ec5c2c00aa6a2d28cc44b3' }, index.h("wa-select", { key: '823eef71ffbd5842a082ee89a925d991ed3521fe', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.dusty_periods?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("fieldset", { key: '87e899e11006bace3507070e481897516fe49303' }, index.h("wa-select", { key: 'afb32bcfd34240599a8954526c21ef1bec4c6f09', label: locales_store.locales.entries['Lcz_HighlightCheck-insFrom'], size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("div", { key: '67c9da09c42683e71055eddc31222295989651f4', slot: "footer" }, index.h("ir-custom-button", { key: '7f5208ee6bbea464d93cd01799cf024599832baa', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries.Lcz_Reset), index.h("ir-custom-button", { key: '2fe0c58ba579a2f7c0139d120409018ec9b89175', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries.Lcz_Apply))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '34c59e4dc39a476719b875805d04d2f2630dc928' }, index.h("div", { key: '480863256b379232e85511bf2d1ffa5b4d87ac5c', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input", { key: '0719f50f693c3c7ef23d9924b7ac09307f7b3323', placeholder: "Search unit", class: "search-filter-input", value: hkTasks_store.hkTasksStore.searchField, "onText-change": e => hkTasks_store.updateSearchField(e.detail) }, index.h("wa-icon", { key: 'c11ba405a5f58a472403b70fe495a125cd1b32d1', name: "magnifying-glass", slot: "start" }))), index.h("div", { key: 'c8636b2b7713339ade452961b6f1534ca5f893ea', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-custom-button", { key: '13b25a9a1949743b96835a42487d8f0f8f7d4ccf', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, index.h("wa-icon", { key: '98dae79686e1991ca876ddab43a6f4ed9db9af62', slot: "start", name: "download" }), locales_store.locales.entries.Lcz_Export), index.h("ir-custom-button", { key: '0e1c5ff28671a5b4905bcbeb52a59f361f4d5fcf', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, locales_store.locales.entries.Lcz_Archives), index.h("wa-animation", { key: 'f0dd9103c779a081f644a2779c0211e80c8ebda7', iterations: 1, id: "cleanInspectAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: '25c0d498d320d66f0e99c78af0fd83546afbe9fd', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), index.h("wa-animation", { key: 'c8183f27eea2588629c500dba9c27bb0b61448d5', iterations: 1, id: "cleanAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: 'ecbe4c9c345e1f9ab6bd6726ef62efe6afdd8e4e', disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f5ba340b72ebd85ec783a16196af97475358c1d9' }, index.h("section", { key: '694a7c5cb63a3c9d07853586362f1d411c7379d8', class: "mobile-tasks-container" }, index.h("wa-card", { key: '899a155bddca521df2eae679e10ddbd305fefd10' }, index.h("ir-tasks-header", { key: 'b9074939da200a1d3077104bb7683f02529a6062' })), mobileTasks?.length === 0 && index.h("p", { key: '3c8123c6a4641c0adc245ee59fe6f8df690e8c53', class: "empty-msg" }, locales_store.locales.entries.Lcz_NoTasksFound), (() => {
            const groups = [];
        ...
        })(), index.h("ir-tasks-table-pagination", { key: 'cbdd9694f99d9f1436dd6915bef1e866f741beea' })), index.h("wa-card", { key: '189f41dc85b9f9d18dae9ec573e06b93222aaf3b', class: "table-container" }, index.h("ir-tasks-header", { key: 'ddd22c5808c65a514085ea45ff4ba131fe41eab7', class: "tasks__header" }), index.h("div", { key: 'd00891286a6171f542321ba8f0ce57afba557877', class: "table--container" }, index.h("table", { key: 'bd59de41846364bf0b676a9b599f8816caa5de0a', class: "table data-table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '5cc81b0e834d414bb8a5ec689f81ac1ad8337891', class: "table-header" }, index.h("tr", { key: '0926345d4adee6939526722c7affe0403435f1e1' }, index.h("th", { key: 'c53f3359e9ed2b07c996d54c5ba2fdcb69dbd334', class: 'task-row' }, index.h("wa-checkbox", { key: '9453094ac8df92a9ae49e7613c60085930863d1d', indeterminate: hkTasks_store.hkTasksStore.selectedTasks.length > 0 && hkTasks_store.hkTasksStore.selectedTasks.length < hkTasks_store.getCheckableTasks().length, checked: this.allSelected, defaultChecked: this.allSelected, onchange: () => this.toggleSelectAll() })), index.h("th", { key: '4e6f4768b8cfa9ff06cc1de361f4032958a174aa', class: "" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '466413c21684f077a6c859720cc835987e574bb9', class: "" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '156096ede54d2b840a0ea434b262ffba35ed4de5', class: "sortable", onClick: () => this.handleSort('status') }, index.h("div", { key: '4faaa413e6d535195591b5aa5a0379730af48e4e', class: "th-sort-inner" }, index.h("span", { key: '99a32bfc284fe29b34e0c3e6630f9abb1f408cc2' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '4b447595065c43bbbb938c5e06fd9c10edc2ffc0', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'a8843586914835148eef23f58908ebe103998c4c', d: "m21 16-4 4-4-4" }), index.h("path", { key: '93bc09d4cd813f9b469c49249e480d23f1d46779', d: "M17 20V4" }), index.h("path", { key: '7a058c26884d360cd489a643cb03ef18570d27da', d: "m3 8 4-4 4 4" }), index.h("path", { key: '09a7c739515b0f6b2c2cc1cebbf73e2eccf2f936', d: "M7 4v16" })))), index.h("th", { key: 'c216a1eb93ce3e68501e53ba2960d0338db63c2b', class: " text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '6836e94a47a8a1375896695b7ab48790e437929e', class: " text-left" }, "Tasks"), index.h("th", { key: 'fe30945fbbdbc00df0787a5b2320139b841ad5d8', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: 'c51d75c6e8c312dde9aed1870e16dca3f0a0f3b1', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '98927adcec10bc62c9f768a9892d1d919042cea0', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: 'e2dc43b8e00247ce267f750b9a5c18278fdde19d', class: "sortable", onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '3e6dd1e154b59ff5f2ca0899ecea32cc37f68854', class: "th-sort-inner" }, index.h("span", { key: '6567fb8389c5a79e943fa6072b02e4be22a685d1' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '51c3cd0ce52eb8da6ec12216b6057210ea884129', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '81f962fe9aaa103e06cd1fd8e6109be71f28af03', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'f8e83c78e2787c83c1083b3f8474fe1b916a90af', d: "M17 20V4" }), index.h("path", { key: '7e08bbc74bc08c52fb76ffbf824c11d619dce2ad', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'b7b67589be0d42f33ce1eca6e86a666748701b15', d: "M7 4v16" }))))), index.h("th", { key: '881160b25ec04b851662ee214d268ab6e5a9010f' }))), index.h("tbody", { key: '4e0431d8a4a09e769a4b70242b913abbdd54cad0' }, tasks.length === 0 && (index.h("tr", { key: '737127a5bde7c7f5e71741058fec76a8f858326d', class: "ir-table-row" }, index.h("td", { key: 'cd1bd37b2f037de21cf2620b1472f028f95a62ca', colSpan: 9 }, index.h("div", { key: '202503eb02167d6007b06fba0188a81f24dfe28f', class: "table-empty-state" }, index.h("span", { key: '6ab32ec218c5ed9856f482f476c10e99fe16bef9' }, locales_store.locales.entries.Lcz_NoTasksFound))))), tasks?.map(task => {
        ...
        })))), index.h("div", { key: '9c0b49a6439137800767ef95746551fa3a86233c', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: 'e297bb42c58a60c1da2e85c2e659e3117877e769' }))), index.h("ir-dialog", { key: '622ec1708980416f769c641a0d0c117e30f2b7f6', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: 'd851c686549a83db2f78d599b95d2ad26b14cc35' }, locales_store.locales.entries.Lcz_Assign, " ", index.h("strong", { key: 'fcc70f5f443ac76e172ff36f3b507a8b59a2426e' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: 'cd30ea6a7f31172d20e269803e4f4f6a7582dfa9' }, pendingHkName), "?"), index.h("div", { key: 'a0e76c8645293d517d123a7426de006518309657', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: 'e7e558097d774202c240df1a1d1de6ab8dc4faf2', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'abc8ac52a4f419b1a085c00a5648ffeaedde2896', size: "m", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales_store.locales.entries.Lcz_Confirm)))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2b056bb0d9204930fe83b8e48d299a881ab45606' }, hkTasks_store.shouldLoadMore() && index.h("ir-button", { key: '404742b6fadb6ae54e37a68056dec76c8c7229b7', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => hkTasks_store.loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: 'aee28291a6ea0d01672c6af5814ca2c9d386e687', showing: {
                from: start,
                to: end,
