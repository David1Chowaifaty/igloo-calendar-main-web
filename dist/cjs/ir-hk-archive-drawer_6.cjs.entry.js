...
const IrTasksTable = class {
    ...
    render() {
        ...
        })))), index.h("div", { key: 'b8804a22126b50eda45663c2ccb099fe1d8066c6', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: '5b5050b71c2f490f0381e42c28719d2e3ad7489b' }))), index.h("ir-dialog", { key: '135437677e2f8645d507950195165aec76f3303b', ref: el => (this.dialog = el), label: t.t('Lcz_Confirmation', { fallback: 'Confirmation' }), lightDismiss: false }, index.h("span", { key: 'b95596bfdaf2ff3b4717b63d452e1249dc402e28' }, t.t('Lcz_Assign', { fallback: 'Assign' }), " ", index.h("strong", { key: 'a91b3dfbba77ea37d0e80143ad7e4b7f97068ff9' }, this.pendingChange?.task?.unit?.name), ' ', index.h("span", { key: 'd1fb2a014054204c395a4df82984b9aa771d4b6e', class: "hk-dialog__connector" }, t.t('Lcz_To', { fallback: 'To' })), " ", index.h("strong", { key: 'b886c4c821098ce5fb44872c60a494fc0d24b942' }, pendingHkName), "?"), index.h("div", { key: '08566b97fee72db0bef5556e6f1805e80b17d8db', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: '0ec578601999aa23d41720057484caade13cabc6', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
