...
const IrHkArchiveDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a4fe90c2915170d2f7fa1bba1624bd39b3129dd7' }, index.h("ir-drawer", { key: '6cecdf0a5de8ce5389d04c625ae38056d4352735', open: this.open, label: "Cleaning Archives (90 days)", class: "hk_archive__drawer", onDrawerHide: () => this.drawerClosed.emit() }, index.h("div", { key: '8118de3d08bff16b6866efdd3dc439188440a09a', class: "archive-content" }, index.h("div", { key: 'e72b06c8a923b6984398b84970b6d2e0e3741946', class: "filters" }, index.h("div", { key: '7dea6545158a1266672adc0829cc882ea2dd181b', class: "filters-row" }, index.h("wa-select", { key: '2d2d35ee08dbd4b2ecc876e881db42a43cd9a757', size: "s", placeholder: "All units", onchange: (e) => {
                const val = e.target.value;
                this.updateFilters({ filtered_by_unit: val === '000' ? [] : [Number(val)] });
            }, defaultValue: '000' }, index.h("wa-option", { key: '9ca780521654df132faf1fadceda3ca2ab2bb93f', value: "000" }, "All units"), this.units
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { value: v.id.toString() }, v.name)))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("wa-select", { key: 'c356a7b9b1ec768fa1e12314fa5d02f74b1ec709', size: "s", defaultValue: '000', placeholder: "All housekeepers", onchange: (e) => {
                const val = e.target.value;
                this.updateFilters({ filtered_by_hkm: val === '000' ? [] : [Number(val)] });
            } }, index.h("wa-option", { key: '72306508c2324559431079e200864bdf1e287120', value: "000" }, "All housekeepers"), housekeeping_service.housekeeping_store.hk_criteria.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { value: v.id.toString() }, v.name)))))), index.h("div", { key: '1d70ce484392be6559ce1379848d1e151d88a703', class: "filters-row" }, index.h("ir-date-range-filter", { key: '95a2590f6c1a2af223bc55c68132ef7dd8762958', withClear: false, selectionMode: "auto", maxDate: this.maxSelectableDate, minDate: this.minSelectableDate, fromDate: this.filters.from_date, toDate: this.filters.to_date, onDatesChanged: e => this.updateFilters({ from_date: e.detail.from, to_date: e.detail.to }) }), index.h("div", { key: 'e988652ffb3225d51a68a56986781311f55a1220', class: "filter-actions" }, index.h("ir-custom-button", { key: '2596b19f4674c571f1dd418b2d37a543e30b6573', variant: "neutral", appearance: "outlined", loading: this.isLoading === 'search', onClickHandler: () => this.searchArchive() }, locales_store.locales.entries?.Lcz_Search ?? 'Search'), index.h("ir-custom-button", { key: '70866e5e2ac55316e457662efbd59b54c9ea13f7', variant: "neutral", appearance: "outlined", loading: this.isLoading === 'excel', onClickHandler: () => this.exportArchive() }, index.h("wa-icon", { key: 'ad3fce72a9bb61b5f616af0729ccbc63b5245064', name: "download", slot: "start" }), locales_store.locales.entries?.Lcz_ExportToExcel ?? 'Export')))), this.fetchedData && (index.h("div", { key: '40cf44b637ecb5061ebf99be3347ea0d050e469f', class: "results" }, this.data?.length === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("ir-empty-state", { message: locales_store.locales.entries?.Lcz_NoResultsFound ?? 'No results found' })) : (index.h("div", { class: "table-wrapper" }, index.h("table", { class: "table data-table" }, index.h("thead", null, index.h("tr", null, index.h("th", null, locales_store.locales.entries?.Lcz_Period ?? 'Period'), index.h("th", null, locales_store.locales.entries?.Lcz_Housekeeper ?? 'Housekeeper'), index.h("th", null, locales_store.locales.entries?.Lcz_Unit ?? 'Unit'), index.h("th", null, locales_store.locales.entries?.Lcz_BookingNumber ?? 'Booking #'))), index.h("tbody", null, this.data?.map(d => (index.h("tr", { key: d.id, class: "ir-table-row" }, index.h("td", null, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: "unit-name" }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-custom-button", { link: true, onClickHandler: () => (this.selectedBooking = d.booking_nbr) }, d.booking_nbr.toString())) : (locales_store.locales.entries?.Lcz_WasVacant))))))))))))), index.h("ir-booking-details-drawer", { key: '764bb90ec649c19cf22fd5c0342925a94b7baf40', open: !!this.selectedBooking, propertyId: Number(this.propertyId), bookingNumber: this.selectedBooking?.toString(), ticket: this.ticket, language: this.language, onBookingDetailsDrawerClosed: () => (this.selectedBooking = null) })));
    }
};
...
const IrTasksCard = class {
    ...
    render() {
        return (index.h("wa-card", { key: 'b384ed0e6dd8dcbd8d60445ec167eaef546bd215', class: "task-card" }, index.h("div", { key: '3464c11cd245b52787fc85d0ec6f5578f6ef68a5', class: "task-card__body" }, index.h("div", { key: 'fee875c1526b092f840333551d5f20e2f490dd24', class: "task-card__unit" }, index.h("span", { key: '22ed36e5fdbd7b57da2a5c5cf4e12a6922213f79', class: "task-card__unit-name" }, this.task.unit.name), index.h("div", { key: '3e35218a88d27241673e732d5672a5436a1030bd', class: "task-card__meta" }, index.h("span", { key: '39574eaa498d8b0388884434751f5b1bd7d7911f', class: "task-card__status" }, this.task.status.description), this.task.hint && index.h("span", { key: '241235edb1e3bfeb02b9832f27a751c9c4c14705', class: "task-card__sep" }, "\u00B7"), this.task.hint && index.h("span", { key: 'b0122c18b9c779b8890551bb08c56ac85abd10db', class: "task-card__hint" }, this.task.hint))), index.h("div", { key: '9f0090ae04c78eac8121bf7dc750e79638bae785', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (index.h("div", { key: '5ffd09dd977f90417ddd5428647627bb2aad18dc', class: "task-card__guests" }, this.guests.map(g => (index.h("div", { class: "task-card__guest" }, index.h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), index.h("span", { class: "task-card__guest-count" }, g.count)))))), index.h("div", { key: '87b4bd6de7db5884cae0c527889a06368f01f86b', class: "task-card__assign" }, index.h("wa-select", { key: 'bc8a6e4e16b68ed872a363378454967f1499962c', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, index.h("wa-option", { key: '3242bd695f19bef1ca7b7117763c060b9415df0e', value: "0" }, locales_store.locales.entries.Lcz_Unassigned), housekeeping_service.housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (index.h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), index.h("div", { key: '754b6a26eba721d87015a363f3ce85ef328d1008', class: "task-card__actions" }, this.isSkippable && (index.h("ir-custom-button", { key: '4d7f85e99373295ae9e2902ffe32338837b58f4c', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (index.h("div", { key: 'bab8f3887d7464422478dc9a7e231f42e093056b', class: "task-card__clean-group" }, index.h("ir-custom-button", { key: 'c478a08f84713fdf3da86ae437ad5259bdc4aeec', variant: "brand", appearance: "filled", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), index.h("ir-custom-button", { key: '73c28a2c051b18857c63d0a1ac29268e80fb3638', variant: "brand", appearance: "accent", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'b3ae1b118b80debb0c6c03f84696015cc724721c' }, index.h("fieldset", { key: 'b0320b4778f0556b726b618a6dee3065ab2dcaf6' }, index.h("wa-select", { key: '327cdcad203af6d468ed7dab5e09eca983816a20', label: locales_store.locales.entries.Lcz_Period, size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_service.housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("fieldset", { key: '29f253c5e676a31cc996513a192bffc633db6a91' }, index.h("wa-select", { key: 'a0f2519ad1d4fd506d5467da65d9a0dfe8741b30', label: locales_store.locales.entries.Lcz_Housekeepers, size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, index.h("wa-option", { key: '1bc6198d7d8b2c623bc25a36683f6c572523418a', value: "000" }, locales_store.locales.entries.Lcz_Allhousekeepers), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), index.h("fieldset", { key: '24e88a3c3ad756892ce9d8fa68ecf673f4668796' }, index.h("wa-select", { key: '4074b7e1ea57015dd64f4c03a059480652e67424', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.dusty_periods?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("fieldset", { key: '0a52a22d9697a581fb32e3e89ff7b81cec459e02' }, index.h("wa-select", { key: '48a04ed5bdb273b4d52a146bbd266077c32950f9', label: locales_store.locales.entries['Lcz_HighlightCheck-insFrom'], size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("div", { key: '87789a5a4fe851760541c904d665d1ca8e7fc305', slot: "footer" }, index.h("ir-custom-button", { key: 'fa85b975f0718fc612b6d44ebf8d2d5d8628c0bd', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries.Lcz_Reset), index.h("ir-custom-button", { key: '30b1cd04be49c8c390320599b791bf7fd1c9f51d', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries.Lcz_Apply))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c41b216958c625a9fa3d797ce8f40c3343d2749d' }, index.h("div", { key: '3f86bf5672e09556219407b8db34b9e5c80c6fd2', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input", { key: 'd3fffb4963fe9391ebcfc33f77cc90af454eb684', placeholder: "Search unit", class: "search-filter-input", value: hkTasks_store.hkTasksStore.searchField, "onText-change": e => hkTasks_store.updateSearchField(e.detail) }, index.h("wa-icon", { key: '25185ddfe2fd7def6d74010e0c5167418a424a10', name: "magnifying-glass", slot: "start" }))), index.h("div", { key: '812892d0d1e5822b67a18f43cc9aeb62c23dbe7e', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-custom-button", { key: 'daf9a9d6f36eeefade24c363d0af5102c3ad611c', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, index.h("wa-icon", { key: '6eac9e639e9cb5a7c5f40effcd2add0e646aea52', slot: "start", name: "download" }), locales_store.locales.entries.Lcz_Export), index.h("ir-custom-button", { key: '9a0c5f82335796d6f6050535c1849dc0cb0e0111', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, locales_store.locales.entries.Lcz_Archives), index.h("wa-animation", { key: '607e3fb6319cdf24faa1b4d91fe16279733696f8', iterations: 1, id: "cleanInspectAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: 'fe97f6caf0e36407d02099df7ef50ee7d35c370d', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), index.h("wa-animation", { key: 'd2189cea327e42dcdc342271ed614acd9e0f2f6b', iterations: 1, id: "cleanAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: 'f59bffae4b7b09f3060c9d9a6a0cc81d26b3eb7a', disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '22df63833e3a84144da2021bc0eedc8a099db356' }, index.h("section", { key: 'a17f49c19dc234457d604ee608bd4a464068ecf7', class: "mobile-tasks-container" }, index.h("wa-card", { key: '38d76e817125e7a0ecdbd7de3dadaea8c9239831' }, index.h("ir-tasks-header", { key: 'f0700b516b47c4f96bcce7087507117d26651a91' })), mobileTasks?.length === 0 && index.h("p", { key: 'c6b0f893fb48727e2f11cb8dc2bd08e40f25ce7f', class: "empty-msg" }, locales_store.locales.entries.Lcz_NoTasksFound), (() => {
            const groups = [];
        ...
        })(), index.h("ir-tasks-table-pagination", { key: '5157ba48775735b7e2612e2ce8e7bd810221839b' })), index.h("wa-card", { key: '30d8b2375f9c82eb33541fdf7a097962fae461a8', class: "table-container" }, index.h("ir-tasks-header", { key: '9d48df942a727a31db3b10c10e968fb1dcc0159d', class: "tasks__header" }), index.h("div", { key: '6a106f28a6bff93e907ad1e3d248e24160ee9dc3', class: "table--container" }, index.h("table", { key: '4f0e7a1cd2ad0e9d12c42eb44c94da361a3e6c36', class: "table data-table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '5b71dc8068d6bc0587e2da28879367286d6c8456', class: "table-header" }, index.h("tr", { key: 'f835809524a938e62bb3bbd2746c132fda94ad21' }, index.h("th", { key: '52b7d1b5df20119effd9f391831d84c4685128d6', class: 'task-row' }, index.h("wa-checkbox", { key: '0b2fe3471e11a64fe2cf1b74e76d24a891e657cf', indeterminate: hkTasks_store.hkTasksStore.selectedTasks.length > 0 && hkTasks_store.hkTasksStore.selectedTasks.length < hkTasks_store.getCheckableTasks().length, checked: this.allSelected, defaultChecked: this.allSelected, onchange: () => this.toggleSelectAll() })), index.h("th", { key: 'e5bdf4258850a4bd9c661053ac62df057e8956bb', class: "" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '1c426268f99cc43269055047a0d1ed62d0cd202e', class: "" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '5c71eaa66bdf9bc9ef892b692b6d74a89702c014', class: "sortable", onClick: () => this.handleSort('status') }, index.h("div", { key: '6104deae65fe5ae9c6f4dc2e2e24e2b0c0d9f79d', class: "th-sort-inner" }, index.h("span", { key: 'e9ee5e63e9e7918ff8e50de2f80863569587964f' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '7dcf492405ba842930bc05a6f7fe72bff11131cf', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'b110de9378504453cd0de06f484f3c7573246ed3', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'ea3ed55630805b95069ca6557ad25aa1eff8dbb0', d: "M17 20V4" }), index.h("path", { key: '68dc158298c84eabbb7a9be501f1e6288c9c8491', d: "m3 8 4-4 4 4" }), index.h("path", { key: '7ec4a23470519e108644257fa75ab0dd52b6ac9b', d: "M7 4v16" })))), index.h("th", { key: 'db53567af9995daf90ae9bbc4fc08798a03ae757', class: " text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '3c2d876476cf45b46babd69b57b8c0bedcdc048b', class: " text-left" }, "Tasks"), index.h("th", { key: '9e081dbc869597193b67bf1a5b862fba492b7177', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: 'c2d1ce365e79574539e16a60699b94b87137fdfe', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '3450e441437348bc2c9f6cbb7d2ec44122d8cacc', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: '3aae8faa582140a8e32ba8573badbbc8d7f354f3', class: "sortable", onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '3355d0ad25288205b76b0fee6314a636fc9cfb08', class: "th-sort-inner" }, index.h("span", { key: '731d1c60db0df31884a0685c95ddaa745657cc86' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: 'a4ca8a87d9ce7e78e36106516718daa0442e7a4a', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'b62c4a119424cb629be034f506d66c1ea8397305', d: "m21 16-4 4-4-4" }), index.h("path", { key: '7f530f2d8d5707c1a799759994e20e14700e69af', d: "M17 20V4" }), index.h("path", { key: 'c551d1a38baf10b8490f33dfe154e3e374c5d736', d: "m3 8 4-4 4 4" }), index.h("path", { key: '6b964e47d9b04ef06492b409f45e65b8fb33d96d', d: "M7 4v16" }))))), index.h("th", { key: '110477eef3726804aec564f8fa9094fac59b1d8f' }))), index.h("tbody", { key: '4e28904e6d741a31f0eca6aa3abc7e00d86da94f' }, tasks.length === 0 && (index.h("tr", { key: '8faa74bbdb065fbea0d3dfa1164f74ec82167f66', class: "ir-table-row" }, index.h("td", { key: 'b2ce1ec91fdc8a629e26bb13d49e71f2bcb7c182', colSpan: 9 }, index.h("div", { key: 'f9848863955b42e1717c4be68a1323d646381138', class: "table-empty-state" }, index.h("span", { key: '4d7cbc59853db514c08c199e11729c7abd04b7bc' }, locales_store.locales.entries.Lcz_NoTasksFound))))), tasks?.map(task => {
        ...
        })))), index.h("div", { key: '12a421bf7a6d8964e698e61ce211d8b536410356', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: 'a156c8778330290e2e0589c55d3d0eaa3f22caa6' }))), index.h("ir-dialog", { key: '94c6e2764a2fddcef04237c6345a0ee69d2a8a75', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: 'b70a62b68371c5f0ebeed72d3e517453fb48eec6' }, locales_store.locales.entries.Lcz_Assign, " ", index.h("strong", { key: '6e27e0a5ceb0e970e8aa5b084e55a462846d6c78' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: '05198a889ea2a94bde4f200ff9b800a211946898' }, pendingHkName), "?"), index.h("div", { key: '254ab1e8ccdd5312f242337b0d391a577ae35de6', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: '39903bddde488b0c26b9daad1653f2cce64649e9', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '3d0fe417c186bc3aa236f041213f215f2af02d7c', size: "m", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales_store.locales.entries.Lcz_Confirm)))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6e6b896b40556378f3f03132e8d08c5ac1e870e0' }, hkTasks_store.shouldLoadMore() && index.h("ir-button", { key: 'cee7f230b3309e1f38a733a94e7cbca43c67da4c', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => hkTasks_store.loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: 'd87cba5bc32b42b7f18c65f401c60196a26da3b7', showing: {
                from: start,
                to: end,
