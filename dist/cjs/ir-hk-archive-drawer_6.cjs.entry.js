...
const IrHkArchiveDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4e2d16da694278144d51950ac1324b013d805982' }, index.h("ir-drawer", { key: '9024bdfde37bee200da7bf1647acff6f977df4c5', open: this.open, label: "Cleaning Archives (90 days)", class: "hk_archive__drawer", onDrawerHide: () => this.drawerClosed.emit() }, index.h("div", { key: '9129cca475ffa13daa8f515911f0c7875f177900', class: "archive-content" }, index.h("div", { key: '26969f715099eb37691fea85bdc280a89e5e07b1', class: "filters" }, index.h("div", { key: 'f1f5e0b716da15eb5763ee8acb72cca04276d57e', class: "filters-row" }, index.h("wa-select", { key: '74bdd9dbb72471fdca5d16958fdba4add6d516cf', size: "s", placeholder: "All units", onchange: (e) => {
                const val = e.target.value;
                this.updateFilters({ filtered_by_unit: val === '000' ? [] : [Number(val)] });
            }, defaultValue: '000' }, index.h("wa-option", { key: '3e19b5bc3636f1cc56278ea4a4fc6d692e68d4aa', value: "000" }, "All units"), this.units
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { value: v.id.toString() }, v.name)))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("wa-select", { key: '8807804057882de4ad6a69f2ed3d3141d8a61154', size: "s", defaultValue: '000', placeholder: "All housekeepers", onchange: (e) => {
                const val = e.target.value;
                this.updateFilters({ filtered_by_hkm: val === '000' ? [] : [Number(val)] });
            } }, index.h("wa-option", { key: '5f06370a8b57c5e70b9db865b19dd6c8374cffed', value: "000" }, "All housekeepers"), housekeeping_service.housekeeping_store.hk_criteria.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { value: v.id.toString() }, v.name)))))), index.h("div", { key: '1b595f20f65cbe8d4f72d8bf8a3151c986bcbff6', class: "filters-row" }, index.h("ir-date-range-filter", { key: 'e86d97698f7ad1b108882c526ce36569ed8789ce', withClear: false, selectionMode: "auto", maxDate: this.maxSelectableDate, minDate: this.minSelectableDate, fromDate: this.filters.from_date, toDate: this.filters.to_date, onDatesChanged: e => this.updateFilters({ from_date: e.detail.from, to_date: e.detail.to }) }), index.h("div", { key: '87836507ed51ef0d06c7f7e8c0547e06c4529ae0', class: "filter-actions" }, index.h("ir-custom-button", { key: '21dec1b382357040ef648aefd6ec432ae4b8af39', variant: "neutral", appearance: "outlined", loading: this.isLoading === 'search', onClickHandler: () => this.searchArchive() }, t.t('Lcz_Search', { fallback: 'Search' })), index.h("ir-custom-button", { key: '1c09105c73a4ceeb5d57fb698f5feb4ed976aa78', variant: "neutral", appearance: "outlined", loading: this.isLoading === 'excel', onClickHandler: () => this.exportArchive() }, index.h("wa-icon", { key: 'fd03c629feef813fc8d359b996285da92606e3e7', name: "download", slot: "start" }), t.t('Lcz_ExportToExcel', { fallback: 'Export' }))))), this.fetchedData && (index.h("div", { key: '2b3d2d3aee25a838e2648aeb53325dd6d0e1d78e', class: "results" }, this.data?.length === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("ir-empty-state", { message: t.t('Lcz_NoResultsFound', { fallback: 'No results found' }) })) : (index.h("div", { class: "table-wrapper" }, index.h("table", { class: "table data-table" }, index.h("thead", null, index.h("tr", null, index.h("th", null, t.t('Lcz_Period', { fallback: 'Period' })), index.h("th", null, t.t('Lcz_Housekeeper', { fallback: 'Housekeeper' })), index.h("th", null, t.t('Lcz_Unit', { fallback: 'Unit' })), index.h("th", null, t.t('Lcz_BookingNumber', { fallback: 'Booking #' })))), index.h("tbody", null, this.data?.map(d => (index.h("tr", { key: d.id, class: "ir-table-row" }, index.h("td", null, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: "unit-name" }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-custom-button", { link: true, onClickHandler: () => (this.selectedBooking = d.booking_nbr) }, d.booking_nbr.toString())) : (t.t('Lcz_WasVacant')))))))))))))), index.h("ir-booking-details-drawer", { key: '356e26bf922e1336b71842b0fe1815d91488885c', open: !!this.selectedBooking, propertyId: Number(this.propertyId), bookingNumber: this.selectedBooking?.toString(), ticket: this.ticket, language: this.language, onBookingDetailsDrawerClosed: () => (this.selectedBooking = null) })));
    }
};
...
const IrTasksCard = class {
    ...
    render() {
        return (index.h("wa-card", { key: '09b3a401d9e1b7d2f81fec2375328f51f47c6106', class: "task-card" }, index.h("div", { key: '3be0dc63661efa5dacf5a4c738ecdaa5140b3c56', class: "task-card__body" }, index.h("div", { key: 'b40c0c8055aca989d15269ae6ffe0ac06453bb7e', class: "task-card__unit" }, index.h("span", { key: 'd65124dd1a7750828b372065d1bd09b4ed6f935d', class: "task-card__unit-name" }, this.task.unit.name), index.h("div", { key: '8842369df6f0381f72aa489c02b86afaca00b2f1', class: "task-card__meta" }, index.h("span", { key: 'b7fdc70bf8d11d6294ec7f27fed789a7bb95c7c9', class: "task-card__status" }, this.task.status.description), this.task.hint && index.h("span", { key: 'b2728dd9d395a063bdc9089426867424b2483934', class: "task-card__sep" }, "\u00B7"), this.task.hint && index.h("span", { key: 'c9c3f991673d34a3081139e38c3589dc3c4aabd6', class: "task-card__hint" }, this.task.hint))), index.h("div", { key: 'c2c2eb4144a1d0958cf84c0f15855ffc76c8604a', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (index.h("div", { key: 'de381ff05960033fff4775c7403eca7ec4db1827', class: "task-card__guests" }, this.guests.map(g => (index.h("div", { class: "task-card__guest" }, index.h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), index.h("span", { class: "task-card__guest-count" }, g.count)))))), index.h("div", { key: '405c95f064a5257dc40586a260986a3d500f3b59', class: "task-card__assign" }, index.h("wa-select", { key: '2988ddddc586151a022390c2571e4dfda2ad53f7', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, index.h("wa-option", { key: 'd4e73fe6768ef00a6a928e7bc9321d8071fda37b', value: "0" }, t.t('Lcz_Unassigned')), housekeeping_service.housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (index.h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), index.h("div", { key: 'ff966b3cc369661a16a13f5cba219bc13729d455', class: "task-card__actions" }, this.isSkippable && (index.h("ir-custom-button", { key: '2e2e54113b26cb6acd88d0016c199c018fbcb04d', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (index.h("div", { key: 'afd4547b1b2bb0220d9696c51470ba00698f31ff', class: "task-card__clean-group" }, index.h("ir-custom-button", { key: 'f5a643b9c583e00b4550c81f09446d8db2d9b6b3', variant: "brand", appearance: "filled", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), index.h("ir-custom-button", { key: 'cc99906e3bcc983c8d0144177b48a5cfcfd165ff', variant: "brand", appearance: "accent", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '7eb02b8da50f1d230777e1dee8367ea4a19719c7' }, index.h("fieldset", { key: '5938b7a38dfe75706809db1c525f25434fcb8768' }, index.h("wa-select", { key: '0a6ec0f25a5260d94fe090237c6559a6a9019965', label: t.t('Lcz_Period'), size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_service.housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("fieldset", { key: 'cba06f11b3cd5d23c53bbefd12b7cc196d8a3601' }, index.h("wa-select", { key: '0ae4382e56a518950028798249782f2b751ac84a', label: t.t('Lcz_Housekeepers'), size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, index.h("wa-option", { key: '3bda053d2e3a27bd6fa98bda670d91d8a7ed13d5', value: "000" }, t.t('Lcz_Allhousekeepers')), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), index.h("fieldset", { key: '2416df88a7a80a59b4690ffd09cd8a95f9bc2cc8' }, index.h("wa-select", { key: 'd62bfe9f90bcc3285b1ffbf31dd3e80dc00a618d', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.dusty_periods?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("fieldset", { key: 'a8ac47bf44bea52f37560ea341076134de9dc125' }, index.h("wa-select", { key: '67fe4348df1666a0b1bb8ab6692e42f5d19209bf', label: t.t('Lcz_HighlightCheck-insFrom'), size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("div", { key: 'fb8d8c4fb88ac25d4531e73e62067c6371169771', slot: "footer" }, index.h("ir-custom-button", { key: '24652c5c06933fea8e651c2843ab0beadc337ca3', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, t.t('Lcz_Reset')), index.h("ir-custom-button", { key: '2715ab091b9b986875395e37612d1ce3094c17fd', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, t.t('Lcz_Apply')))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '95a9d6a989210710b2a3b2b6f19532b44ce853c5' }, index.h("div", { key: '7801f7bc7c1c87c4ed4b297c5f40e9fec8d7aa08', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input", { key: 'f0ad358736f26a1d3c9292e8e4042c8483875703', placeholder: "Search unit", class: "search-filter-input", value: hkTasks_store.hkTasksStore.searchField, "onText-change": e => hkTasks_store.updateSearchField(e.detail) }, index.h("wa-icon", { key: 'a46ad31cae44ac448cb1e8cceaad2147a84f4ac0', name: "magnifying-glass", slot: "start" }))), index.h("div", { key: 'e35b38332ed8134493ab37778143b00c734f82f9', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-custom-button", { key: '0ef41ca2e24a250f9304848691ad18b1acb07da5', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, index.h("wa-icon", { key: 'a496e8f98c3a09ea78263e58b959a28a37248410', slot: "start", name: "download" }), t.t('Lcz_Export')), index.h("ir-custom-button", { key: 'a3564115e4726941afff6ee814cc9d556c7db414', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, t.t('Lcz_Archives')), index.h("wa-animation", { key: 'd8e0a83089f7dfb03343e9bbe483db552c49a52b', iterations: 1, id: "cleanInspectAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: 'bc55ca67b50515f8a68dd442a61b27e00c22f1a6', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), index.h("wa-animation", { key: 'acc26f647148b94f3cf9c1ac95940fa15aa53137', iterations: 1, id: "cleanAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: '91306ecf4c2c6a69430f328e4f86e41f86f9f48a', disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    getHousekeeperName(hkmId) {
        if (!hkmId) {
            return t.t('Lcz_Unassigned');
        }
        return housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers?.find(h => h.id === hkmId)?.name ?? t.t('Lcz_Unassigned');
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'afac57181cc9ee79c63eba356b089da21c72ad6f' }, index.h("section", { key: '6857aab8b336646936ddf28661e357da34fc04fd', class: "mobile-tasks-container" }, index.h("wa-card", { key: '47c6b776dea591436249aa8d8a3615f1682588db' }, index.h("ir-tasks-header", { key: '053e970709bf5ffac1ecda7de7423c857d316846' })), mobileTasks?.length === 0 && index.h("p", { key: 'a7198b4c8a08e18ee699c391d5ec47c8567416a7', class: "empty-msg" }, t.t('Lcz_NoTasksFound')), (() => {
            const groups = [];
        ...
        })(), index.h("ir-tasks-table-pagination", { key: '93c026e9fb5defd12e25a349695f257d12dc66d2' })), index.h("wa-card", { key: '6b869c6f3aecb84fe28cb0e3059120986cfae7d3', class: "table-container" }, index.h("ir-tasks-header", { key: '4ba2dde545ae61f2ff975b1078833902aa28fed0', class: "tasks__header" }), index.h("div", { key: '22581408139996c58acbbadd82a0ff64f5b9a59b', class: "table--container" }, index.h("table", { key: '27393473b39670ee6f43979e38d6334765875939', class: "table data-table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '23c9fc581ebd290eaf26a9f0c1b9d9cb83b8519d', class: "table-header" }, index.h("tr", { key: '0a4448b33abfb254d41a541e8280ded1dc98c196' }, index.h("th", { key: '9e6ae86a139ee461d724752fd749f74521d26480', class: 'task-row' }, index.h("wa-checkbox", { key: 'f1626299b1384b78447c7336f6a0bce4f1d8a10e', indeterminate: hkTasks_store.hkTasksStore.selectedTasks.length > 0 && hkTasks_store.hkTasksStore.selectedTasks.length < hkTasks_store.getCheckableTasks().length, checked: this.allSelected, defaultChecked: this.allSelected, onchange: () => this.toggleSelectAll() })), index.h("th", { key: '9bb45926c6dee864e746371bbd51388385544a3d', class: "" }, t.t('Lcz_Period')), index.h("th", { key: '336f492aca0010bc2665aa400678f53ede4f0888', class: "" }, this.tasks.length > 1 && this.tasks.length + ' ', t.t('Lcz_Unit')), index.h("th", { key: '698a0c76853e7098142b82009d490b3ae3005425', class: "sortable", onClick: () => this.handleSort('status') }, index.h("div", { key: '4cae0b774ed13c35a714ba4542b0d3bd447c7773', class: "th-sort-inner" }, index.h("span", { key: '870a0f6b9ea40faf7cffa54c91b8500e21242ed3' }, t.t('Lcz_Status')), index.h("svg", { key: '3e453554eab12dd72c7e6e8c934689cda3a2cfd5', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'a184b5bb2ac7256123ce01b06674b282dec08bc1', d: "m21 16-4 4-4-4" }), index.h("path", { key: '0ca8a9fb279f160e71d66c52fb2dce96475dfb08', d: "M17 20V4" }), index.h("path", { key: '718d4740c38b399d402606e7d95513ea56f87c53', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'e94db8b9040083e609f2c44165ac4fee63777525', d: "M7 4v16" })))), index.h("th", { key: '93a6eb9d4fc155e5e968783f8116d50a7663c0a5', class: " ir-text-start" }, t.t('Lcz_Hint')), index.h("th", { key: 'ca923e1ec4f9cc1159838bbfe7db63de70250662', class: " ir-text-start" }, "Tasks"), index.h("th", { key: '2362a1627d6ff4e61f1adf049cc2cdad9be6c851', class: "ir-text-start" }, t.t('Lcz_A'), "d"), index.h("th", { key: '939fa4511c98dc4cd46c99eb5c1715344069c3ee', class: "ir-text-start" }, t.t('Lcz_C'), "h"), index.h("th", { key: '192cb7ade9cbfba240c9b7b3033799c00dc157a6', class: "ir-text-start" }, t.t('Lcz_I'), "n"), haveManyHousekeepers && (index.h("th", { key: '5ddbcbd81b546c292b7ae2f0555fe1b76ccad86a', class: "sortable", onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '096881c282f5d3efeaa7a83a99f54b16912a6212', class: "th-sort-inner" }, index.h("span", { key: '44fdf58fab4b125e4da6adfb0cf4bed0071d5035' }, t.t('Lcz_Housekeeper')), index.h("svg", { key: 'df352e0bc3ebc5c77c1d5ff152170490be489ba7', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'a1b7a2512444ee9287c588d68bc90d32ddb3b2fc', d: "m21 16-4 4-4-4" }), index.h("path", { key: '83ffbd68c2cd5a9ddf21b12032bdaa1f4b6fe014', d: "M17 20V4" }), index.h("path", { key: '5f7f30397c91868e2f2d6bffb2cd905c703e85be', d: "m3 8 4-4 4 4" }), index.h("path", { key: '60c497fadafd9399ccc3776e95e9a398d3d2c9aa', d: "M7 4v16" }))))), index.h("th", { key: '5f633630cbf30b84321e9636a8dcb45c9f5edf36' }))), index.h("tbody", { key: 'f4ebd1e52bbe4c2d814a0e8687d97f3d16dea29b' }, tasks.length === 0 && (index.h("tr", { key: '193979c75e239489a14f9aedf75479ac945fc74b', class: "ir-table-row" }, index.h("td", { key: 'ee69f08ea6ec158018f18ddf21c3b69315ebfbd6', colSpan: 9 }, index.h("div", { key: '5d14ea17e3bcddda0ee80be3427864228676affb', class: "table-empty-state" }, index.h("span", { key: '8a1a00d5fe2a8f44ba8f9596908dfa91eb447632' }, t.t('Lcz_NoTasksFound')))))), tasks?.map((task, taskIndex) => {
            ...
            return (index.h("tr", { "data-date": task.date, "data-testid": `hk_task_row`, "data-assigned": task.housekeeper ? 'true' : 'false', style: isCheckable && { cursor: 'pointer' }, onClick: () => {
                ...
                } }, index.h("wa-option", { value: "0" }, t.t('Lcz_Unassigned')), housekeepers
        ...
        })))), index.h("div", { key: '9edf937b3f44f936169bcd446cf17e8e8af05e0f', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: 'dd25593e918c6af544d11b05c3581989eb7a4f60' }))), index.h("ir-dialog", { key: 'e9df72b41379cb19526013243226860a0433e876', ref: el => (this.dialog = el), label: t.t('Lcz_Confirmation'), lightDismiss: false }, index.h("span", { key: 'f1254e0cb1f4cfa5a9e69512240f89927761f271' }, t.t('Lcz_Assign'), " ", index.h("strong", { key: '5bc7d25b379f5b812ddf6a86feb1c7ca7b36af9a' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: 'bc542b2a63d7a5fcc6f583610806fec1ea363239' }, pendingHkName), "?"), index.h("div", { key: '117c802005bbbbf93d1146b2356e07158ad31bbc', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: '1a230e4b8f15730350a9e380bf31ea7a3ffda348', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, t.t('Lcz_Cancel')), index.h("ir-custom-button", { key: 'ca3c864ed535b39d6ef66e60baecf96ac19d0927', size: "m", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, t.t('Lcz_Confirm'))))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b06716a39c05287ca493c005bc5d6f222687e7a8' }, hkTasks_store.shouldLoadMore() && index.h("ir-button", { key: '3da686162e8e1203b2f5540afb32fbfc06de63a7', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => hkTasks_store.loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: '7bb2dc80876afdde586ef1982efb07b946b8d18b', showing: {
                from: start,
                to: end,
