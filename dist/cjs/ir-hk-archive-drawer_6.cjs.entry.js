...
var hkTasks_store = require('./hk-tasks.store-CJWZl_r2.js');
...
const IrHkArchiveDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a483dce72ada8bc66dd4869683803b98e1fc646d' }, index.h("ir-drawer", { key: 'eba075a8535341a2062b9850a0dff1e7d2acc402', open: this.open, label: "Cleaning Archives (90 days)", class: "hk_archive__drawer", onDrawerHide: () => this.drawerClosed.emit() }, index.h("div", { key: '4930dc89eb2031d410dbac89633fb4e005485571', class: "archive-content" }, index.h("div", { key: '0bcefcf2b38eb19bea53a4751e7ab82898b3f119', class: "filters" }, index.h("div", { key: 'd3680268733cd7121bb11acfe5f9842183aac5c3', class: "filters-row" }, index.h("wa-select", { key: '64dea26c91e6c4cf3704624266ff6f75cace91fb', size: "s", placeholder: "All units", onchange: (e) => {
                const val = e.target.value;
                this.updateFilters({ filtered_by_unit: val === '000' ? [] : [Number(val)] });
            }, defaultValue: '000' }, index.h("wa-option", { key: '7096ff435cd5ac723615d78e0c5cd7bbfdd58655', value: "000" }, "All units"), this.units
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { value: v.id.toString() }, v.name)))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("wa-select", { key: '3d897bebee573de0e35d84e973171c1df1ac816b', size: "s", defaultValue: '000', placeholder: "All housekeepers", onchange: (e) => {
                const val = e.target.value;
                this.updateFilters({ filtered_by_hkm: val === '000' ? [] : [Number(val)] });
            } }, index.h("wa-option", { key: '7ebc4fdea65ba6795c43628b671f7c92dda04d27', value: "000" }, "All housekeepers"), housekeeping_service.housekeeping_store.hk_criteria.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { value: v.id.toString() }, v.name)))))), index.h("div", { key: 'e4f1059b00a6a3bf3ebc22ca0e9b6d257de4c86f', class: "filters-row" }, index.h("ir-date-range-filter", { key: 'fd34628d1d00d6e356c22ebeaa8428fea744f727', withClear: false, selectionMode: "auto", maxDate: this.maxSelectableDate, minDate: this.minSelectableDate, fromDate: this.filters.from_date, toDate: this.filters.to_date, onDatesChanged: e => this.updateFilters({ from_date: e.detail.from, to_date: e.detail.to }) }), index.h("div", { key: 'b91c2318a7b0c7d485f01e5e54f5020afe67e30b', class: "filter-actions" }, index.h("ir-custom-button", { key: 'f0a8f114d816b015f06b591d2ed4a51111965c77', variant: "neutral", appearance: "outlined", loading: this.isLoading === 'search', onClickHandler: () => this.searchArchive() }, locales_store.locales.entries?.Lcz_Search ?? 'Search'), index.h("ir-custom-button", { key: '75116cab989946bd2a95be1306a9d4946cbbee49', variant: "neutral", appearance: "outlined", loading: this.isLoading === 'excel', onClickHandler: () => this.exportArchive() }, index.h("wa-icon", { key: '80ae889454618a0b339ad88575eb227435a8db4b', name: "download", slot: "start" }), locales_store.locales.entries?.Lcz_ExportToExcel ?? 'Export')))), this.fetchedData && (index.h("div", { key: '0694f18cde3351da7a41e40c5c9d11beae7a3ab1', class: "results" }, this.data?.length === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("ir-empty-state", { message: locales_store.locales.entries?.Lcz_NoResultsFound ?? 'No results found' })) : (index.h("div", { class: "table-wrapper" }, index.h("table", { class: "table data-table" }, index.h("thead", null, index.h("tr", null, index.h("th", null, locales_store.locales.entries?.Lcz_Period ?? 'Period'), index.h("th", null, locales_store.locales.entries?.Lcz_Housekeeper ?? 'Housekeeper'), index.h("th", null, locales_store.locales.entries?.Lcz_Unit ?? 'Unit'), index.h("th", null, locales_store.locales.entries?.Lcz_BookingNumber ?? 'Booking #'))), index.h("tbody", null, this.data?.map(d => (index.h("tr", { key: d.id, class: "ir-table-row" }, index.h("td", null, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: "unit-name" }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-custom-button", { link: true, onClickHandler: () => (this.selectedBooking = d.booking_nbr) }, d.booking_nbr.toString())) : (locales_store.locales.entries?.Lcz_WasVacant))))))))))))), index.h("ir-booking-details-drawer", { key: 'c8431f9fef1dee4b5a7a623217e87d08368e2ff4', open: !!this.selectedBooking, propertyId: Number(this.propertyId), bookingNumber: this.selectedBooking?.toString(), ticket: this.ticket, language: this.language, onBookingDetailsDrawerClosed: () => (this.selectedBooking = null) })));
    }
};
...
const IrTasksCard = class {
    ...
    render() {
        return (index.h("wa-card", { key: '5252dfbc23e0278461202fd778734cfc55f5457c', class: "task-card" }, index.h("div", { key: 'b5d871c73fdcdf7fc945ffaa0ebcb3baf7d599af', class: "task-card__body" }, index.h("div", { key: '7b6726cd2c6d7ecba0e0392053144e0bfd33eec1', class: "task-card__unit" }, index.h("span", { key: 'cee2978c0f7831e2b517d1f56abaf883d186c387', class: "task-card__unit-name" }, this.task.unit.name), index.h("div", { key: '1a0de91d29b7160dea898b2bf0349f5ca4756a00', class: "task-card__meta" }, index.h("span", { key: '3dd954404adfd5ff20b8b32ae7bf5764c4de3947', class: "task-card__status" }, this.task.status.description), this.task.hint && index.h("span", { key: '85933405e5d2d1b67087ba4051cad217d7ad1c8f', class: "task-card__sep" }, "\u00B7"), this.task.hint && index.h("span", { key: 'ba35e782d9792c813c7172e7102acafd3ef24601', class: "task-card__hint" }, this.task.hint))), index.h("div", { key: 'e27a0f26747404dfea8ca3255c7e4fd0c9b5bc79', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (index.h("div", { key: '973d85eacd0e0de8818cfe8799d1a67092428916', class: "task-card__guests" }, this.guests.map(g => (index.h("div", { class: "task-card__guest" }, index.h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), index.h("span", { class: "task-card__guest-count" }, g.count)))))), index.h("div", { key: '1fff2027719fa7f6d0698ea0de7cd1bccd9fe18b', class: "task-card__assign" }, index.h("wa-select", { key: '3c3e7ef79291d06151e200c2641d098f365a8d88', label: "Housekeeper", class: "task-card__hk-select", size: "s", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, index.h("wa-option", { key: '5bb2c85123cb7adfee8045eccaa11b2455e8de4c', value: "0" }, locales_store.locales.entries.Lcz_Unassigned), housekeeping_service.housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (index.h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), index.h("div", { key: '35818f8a5eb3f2cff12999805186d733f080fb4d', class: "task-card__actions" }, this.isSkippable && (index.h("ir-custom-button", { key: 'eee89eef3c4e69abc2df673f748aa0a6640e5eb1', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (index.h("div", { key: '9e4246bbc877e1f808a2e7d992dba3755a3b31b0', class: "task-card__clean-group" }, index.h("ir-custom-button", { key: '385a8e31c2696f22947e5e7073f1d77f397dfb3e', variant: "brand", appearance: "filled", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), index.h("ir-custom-button", { key: '8d419fd1b0bfd341efb5d405b573ccb86fe49bf6', variant: "brand", appearance: "accent", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
...
const IrTasksFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '8ee87e5a4f3caaf3d93e2a44ac006c379e1032b8' }, index.h("fieldset", { key: '38c558aa5b29aa513abc86be0f5bd87179257211' }, index.h("wa-select", { key: '6a09c6907b04179ab79b07809c472352341287aa', label: locales_store.locales.entries.Lcz_Period, size: "s", "data-testid": "period", value: this.filters?.cleaning_periods?.code, defaultValue: this.filters?.cleaning_periods?.code, onchange: e => this.updateFilter({ cleaning_periods: { code: e.target.value } }) }, housekeeping_service.housekeeping_store?.hk_criteria?.cleaning_periods.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers.length > 1 && (index.h("fieldset", { key: '9eff7b212a84d4c323f937d7c93d9a7ce6179acd' }, index.h("wa-select", { key: '66ac050357db19e82aeab3da61422e9892c1b437', label: locales_store.locales.entries.Lcz_Housekeepers, size: "s", "data-testid": "housekeepers", value: this.filters?.housekeepers, defaultValue: this.filters?.housekeepers, onchange: e => this.updateFilter({ housekeepers: e.target.value }) }, index.h("wa-option", { key: 'e71dcd4760d5b5cbd7e78912268fd4c05f460afc', value: "000" }, locales_store.locales.entries.Lcz_Allhousekeepers), housekeeping_service.housekeeping_store?.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.toLowerCase().localeCompare(b.name.toLowerCase()))
            .map(v => (index.h("wa-option", { key: v.id, value: v.id.toString() }, v.name)))))), index.h("fieldset", { key: 'c1d298a04756bc36e06fc83f80f4e295d677eeac' }, index.h("wa-select", { key: '6dcdfc1b2376ca464dfbea4a32b0be07bd1330fe', label: "Include dusty units", size: "s", "data-testid": "dusty_units", value: this.filters?.dusty_units?.code, defaultValue: this.filters?.dusty_units?.code, onchange: e => this.updateFilter({ dusty_units: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.dusty_periods?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("fieldset", { key: 'c2591fb09a995a25e4a5d1c552a0e52d86fda3b5' }, index.h("wa-select", { key: '0583b3c154308967f66264bfd2488eef8be4cbbd', label: locales_store.locales.entries['Lcz_HighlightCheck-insFrom'], size: "s", "data-testid": "highlight_check_ins", value: this.filters?.highlight_check_ins?.code, defaultValue: this.filters?.highlight_check_ins?.code, onchange: e => this.updateFilter({ highlight_check_ins: { code: e.target.value } }) }, housekeeping_service.housekeeping_store.hk_criteria?.highlight_checkin_options?.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description))))), index.h("div", { key: '9cb73d1f9aa1077f8afc80ff066e93743dff5b8c', slot: "footer" }, index.h("ir-custom-button", { key: 'dcc43a5c2e7036f27f6d90ea7118cca3e498d14c', variant: "neutral", appearance: "filled", "data-testid": "reset", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries.Lcz_Reset), index.h("ir-custom-button", { key: 'c9ebbe2dd8858e2bd833717d794cc7dceb53ab47', variant: "brand", "data-testid": "apply", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries.Lcz_Apply))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'de336a6f1ed1d30d343e7453862b94aa076850cb' }, index.h("div", { key: '2780970236e1fe75e102df06c70aa075a6a7c5ca', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input", { key: '151ba29e85b84e0e22869618db6dbf20a453f13d', placeholder: "Search unit", class: "search-filter-input", value: hkTasks_store.hkTasksStore.searchField, "onText-change": e => hkTasks_store.updateSearchField(e.detail) }, index.h("wa-icon", { key: '39b675b5af7f197a6319c4b3bb770fba4527f043', name: "magnifying-glass", slot: "start" }))), index.h("div", { key: 'a64394e668701eef1b2353c898180782d0eedcac', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-custom-button", { key: '54868f44fea6e92f2ad37f313193bd0d214c426c', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, index.h("wa-icon", { key: 'f4cbdb916dcdf5c6ec7620773ea36a92b0db7a52', slot: "start", name: "download" }), locales_store.locales.entries.Lcz_Export), index.h("ir-custom-button", { key: '8a855ac56dc87e3e2a5d6a487b09a882b776f5a1', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, locales_store.locales.entries.Lcz_Archives), index.h("wa-animation", { key: '862a5d59b9fdbc839396694ba077de7f487dd042', iterations: 1, id: "cleanInspectAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: 'a9494dec434a391fd39c913a402694838173fbea', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), index.h("wa-animation", { key: 'eaade7be0f4722ae240a226ec69ceaf2906d4ad5', iterations: 1, id: "cleanAnimation", class: "clean-button", name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: 'fd99e7a6c9a1847523fd55d805bdd96788ecda99', disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0c6ecc4755774d99f7f6c36232ff8db07a4f2ea1' }, index.h("section", { key: 'd8ccbac01360a67ac3c043ccb3c16699b8325a1c', class: "mobile-tasks-container" }, index.h("wa-card", { key: '3561a03da4293a52d12f60e08695bfc5ab858e84' }, index.h("ir-tasks-header", { key: 'c8361ba7fcfea5b2cd60289f178cfb97e34bef81' })), mobileTasks?.length === 0 && index.h("p", { key: 'aeb4b54fc51ab2e25dbfcda41170b9ae2f6f2c9e', class: "empty-msg" }, locales_store.locales.entries.Lcz_NoTasksFound), (() => {
            const groups = [];
        ...
        })(), index.h("ir-tasks-table-pagination", { key: 'e1ae33d68d4d64b8e1f3e97a5b4ffc43bd8b735e' })), index.h("wa-card", { key: 'e25c654bbf1f2f2093e9e83148a4a877218c7c10', class: "table-container" }, index.h("ir-tasks-header", { key: 'b0cb6d1f5e571e60fc9d32ed5a4d38202e329106', class: "tasks__header" }), index.h("div", { key: 'd48668b01866c5c379e118894671435ce3ffe07b', class: "table--container" }, index.h("table", { key: '62a92cf1050434c564c8b85d2f5bb5dcf3116d45', class: "table data-table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '9f971859639ab5fcba100abcc894a45ffc39122e', class: "table-header" }, index.h("tr", { key: 'f48f65ab90b3d63c07d3a021779c8c0d904ffa35' }, index.h("th", { key: '70de7ee2c0b74706046b6d87d829b08dbb482786', class: 'task-row' }, index.h("wa-checkbox", { key: '3bfe325a253718603367f0db630bb18e9c489c5d', indeterminate: hkTasks_store.hkTasksStore.selectedTasks.length > 0 && hkTasks_store.hkTasksStore.selectedTasks.length < hkTasks_store.getCheckableTasks().length, checked: this.allSelected, defaultChecked: this.allSelected, onchange: () => this.toggleSelectAll() })), index.h("th", { key: 'e3c2dc453a84b714b10f1c9213114ba389459026', class: "" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '4b56690a07ef0749ca9ea3b437a2e45f972b3df1', class: "" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '2bde83c398d35392fe03ac95e5307f26d6fb1d9e', class: "sortable", onClick: () => this.handleSort('status') }, index.h("div", { key: 'ab045a5b2628fe3813cb31fc2d8f915f5d4a3d2f', class: "th-sort-inner" }, index.h("span", { key: '05cec7ac77bfc6a7df55303058b5fb6d342d1440' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '6ccd83f70abe939f2977fd75a1c5c17657a2b541', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '0a31bf6d88f810987a87a9fc3374b8e38492b90c', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'a6ee21facc1b282307ab7be522524fe0f4fcdd9b', d: "M17 20V4" }), index.h("path", { key: '36b01a355521a83ba1fecd7045d58a3fa2d1284e', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'b5a4717c45b6071964a3c261b96a4b94b38f1be4', d: "M7 4v16" })))), index.h("th", { key: 'f4850af4894bb2768b3cc0d60e6a92a3e3383417', class: " text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '748b57cceb788226bf6a540bcaa56745f708edb1', class: " text-left" }, "Tasks"), index.h("th", { key: '2d883c4a83e0ee6f1a3803d2c6526be3298fa92b', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: '3994ec0180709a11f352ddfe671736a154612fd5', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '774977c71aaf9cd9c606dd3403d826c85f207605', class: "text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: 'd5dacb12903e84dfb394941cd89da5db218b56b8', class: "sortable", onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'c5d884df5d49e1ac47c284d5577dde4cff044c31', class: "th-sort-inner" }, index.h("span", { key: 'df3507e6524c4abbe10beec05a87ce582f842f5f' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: 'f7b1ef7af7cad42d051de0b33c6fc05d32f912c0', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '37f84b2a075f6957273ed9c6f15860edab1c6fe7', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'd05cc26344fab7450d3d9da3cdd7ec57965a0394', d: "M17 20V4" }), index.h("path", { key: 'd36570cdd64791ad1e4f29bc8d06d891502e89ec', d: "m3 8 4-4 4 4" }), index.h("path", { key: '5e35716d6d0417f49f547d806775141297ffc7e3', d: "M7 4v16" }))))), index.h("th", { key: 'c04863d38d688516d544e841fbe7481913fca094' }))), index.h("tbody", { key: '29476cd9319448a4eb173228c793e239fd8751ad' }, tasks.length === 0 && (index.h("tr", { key: 'a84c58a58127c5668f7f9e7d3e0e586a1399de65', class: "ir-table-row" }, index.h("td", { key: '07e40c45e650ec76b47ecd85531dae210ae1b15b', colSpan: 9 }, index.h("div", { key: '1def5c23b07a19a56c8af09fc11259110b2452ec', class: "table-empty-state" }, index.h("span", { key: '4bbc1f3da03509788e2e610946e88d94c1d57ef3' }, locales_store.locales.entries.Lcz_NoTasksFound))))), tasks?.map((task, taskIndex) => {
        ...
        })))), index.h("div", { key: '8de27544547be71601e9fcb35ef8f7089a39c5ea', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: '0275158bf55dc19f38bc8209064c83f552ae39c7' }))), index.h("ir-dialog", { key: '7159363c9718f655496c0e691511488d60dfd1b3', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: '23df9df5dcf9937f407eca2afad5aa5641515b7d' }, locales_store.locales.entries.Lcz_Assign, " ", index.h("strong", { key: '7bf5a422dedce96aa54ffb17324104c4c77dd5a6' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: 'e22b58baf957b6380bbcc38a38c93f5ec0c17e12' }, pendingHkName), "?"), index.h("div", { key: '15cb01a83ffd8ca2c516bc6688a697fb2aedcd3c', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: '37245fa8c708f2749492fa33e819e02ed646a849', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '5a7fb78979343b42198af1f3353a45c5cff33cac', size: "m", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales_store.locales.entries.Lcz_Confirm)))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c407afc0e5b9aa22e07d37db868f548278374dd3' }, hkTasks_store.shouldLoadMore() && index.h("ir-button", { key: '513ba9ed8fdd20298255cec7ce7d5e080aeb7a5f', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => hkTasks_store.loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: 'c75d34f3c561d4d1e04a5f4eb17a8b5f21b0ee71', showing: {
                from: start,
                to: end,
