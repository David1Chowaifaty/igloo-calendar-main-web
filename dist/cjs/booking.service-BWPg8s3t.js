...
class BookingService {
    ...
    async doReservation(body) {
        const { data } = await axios.axios.post(`/DoReservation`, Object.assign(Object.assign({}, body), { extras: body.extras ? body.extras : booking.extras }));
        if (data.ExceptionMsg !== '') {
            throw new Error(data.ExceptionMsg);
        }
...
//# sourceMappingURL=booking.service-BWPg8s3t.js.map
