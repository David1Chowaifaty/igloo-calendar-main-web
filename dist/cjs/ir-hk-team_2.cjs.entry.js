...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1530453c1cb5e7ce46128d139eff9bd75a8cd346', class: "card p-1" }, index.h("section", { key: '0cb423b77b395d24d3b945a61e6a62b252456383' }, index.h("ir-title", { key: '489adaa445743b338bf539de459e61886ee232ee', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: '9ecc9abc6827d36002ba9c8c819d3447a50cd15f', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: '8ad78c385baf07a4ec4b43e049f60fecda2a29c7', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: 'f40b7d3ff12d52ed60138f85e3338cd060b7cb41', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: '5b94eb2be1b1e265d2681494d104595c1c7351dc' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: '1a210137276cfb37865c904e113b544dbd96aec4', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: '37fa3ab9682f2cdbdd52b518e3173340813dda85', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: 'bdbb861fee0dd8252efecfc876188bbd918cff16', class: "table-container" }, index.h("table", { key: 'd8cabf104c463094bd76f8813225211c4fabc1fd', class: "table" }, index.h("thead", { key: 'e779f33104180358ce21088950687caa7dc2a76f' }, index.h("tr", { key: 'd66825b468d84c0ade4d1bd26c2c04e168abee82' }, index.h("th", { key: 'cbbe5692103e6d0e81f864705747188fa8832dad', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: 'c4eaf46840efd5d5ea05437065730979a863f66b' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: 'a35667c350d9326cacaae05b7feda4302427b4ec' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: '4850ef337b8fec835b1bb6d3cbe0678b3fa7b305' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: '210c6e213b6071d1e4e7ad53f1cfb4e47bdd3a88' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: '7be84c45ed691bb03fed805cd7991355165fd198', class: "text-center" }, index.h("ir-icon", { key: '494e30c4e4572c3972f7d0a2d10683099243ad92', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '6b295724d3a580e91b334c257a5258d5007a5965', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '6e1bd575ac5a9e9ba653acae5c008422f615e7ef', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: '41934effbb6c70361a2b47500fd0328cb14cfb56' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'e473a3063175a3bfb34fa7fb6ec6f4c6fdae9954', class: "card p-1" }, index.h("ir-title", { key: '5b9497c0e087c3c823fa2704b7d1aff0ac4eb74a', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: 'dc3b57987a7f909b43f74e76c53d2c3623fde81e', class: "table-container" }, index.h("table", { key: 'e52a9a1314f6307dc2983baf149ca9a6304d63be' }, index.h("thead", { key: '22fb973fd102d5d084ae525ef2b233d33a236787' }, index.h("tr", { key: '4d5281ccbbe3c4d69266cf367b68d2fc2820e813' }, index.h("th", { key: '48501c1430d8592d779cebf62b5748b0e416d150' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: '8f9bc1db825dc8f23060258bcd3f411bb599b3e4', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: '26f146631bb627e7a12ef719ec7fe9f1a724536b' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: 'a9957cfc88c764a857b2fda22120f4e567bd211f' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
