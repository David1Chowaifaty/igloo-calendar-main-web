...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1a2ff899bfcf83cc61b44c3ee9ec302c8e711087', class: "card p-1" }, index.h("section", { key: '33a281d53f7209dc2dd7a4b27f48e0be95f3b148' }, index.h("ir-title", { key: '81c08c6637e9581fdc660b5c0dda21eaecaa49f3', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: '618427426c9eed6b11c53964fb9b1320aee79aba', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: '3eb750612cd52d5543d3ebb49f7f555af7888fb3', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: 'b2be43c5d228080ab5a9f45a993d92e91ce7a6ed', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: '8817eb4ed2ef8e0c80eb9c8f6831cc81547821f2' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: 'eca3765e9423d0f9d59a022b6031fc83c489b587', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: '3999c201a98ca12c246f7fb0cbba1de40d16cde1', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: 'edfffa8d94928c288d351d0cfece27170fc562f8', class: "table-container" }, index.h("table", { key: '019dc6b6aaa6021a6b8cd433f158ec41fab57b42', class: "table" }, index.h("thead", { key: '48f0b80f34c0124098ad75647365b0fe997b7cb5' }, index.h("tr", { key: '7cccf9e3d74c25812bfe03d51bdc55da7ca6c909' }, index.h("th", { key: '9bc233eacd15efbe1785f300aa7b41211b6ca7b2', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: 'd1177c7bea340a9a5c506272730814a7677b2abb' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '91d5a7d1c248dcb6b81d93f89c32381a300df801' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: '65156c931ce5935ad86f875ce78bb67e517616a8' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: 'b12d3262bc7b44fcaf6b42cfabe003c87e26dafd' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: 'a65f2342415a3b494df0dabe89c709b4543ee3a9', class: "text-center" }, index.h("ir-icon", { key: '87698525d6a0c3fb4759b333e7404de28401a660', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '08c11d89b9172848de62eab690f3229d994ea1f0', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '7988e28a75e1aac63e4e3ec1e66cedb862acf79d', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: 'a001e1b6a1185a86fdf6d3789bb5223aa9534f75' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '98439766c3d0ed83669507f745467baf49f24f64', class: "card p-1" }, index.h("ir-title", { key: '7d082d9c117bceede1219d585bcb3a49ca876e0a', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: '7454a6354cc6b405d4936799a2a4611bcb5b79fa', class: "table-container" }, index.h("table", { key: 'b6bbc1578b6e8bb784daf49fe10ed27862cb1dd7' }, index.h("thead", { key: '9a015aaeb4aeda580d4de571748265491f20815e' }, index.h("tr", { key: '3bcf77e02ba6e3729c9a1d6752e14a853630839c' }, index.h("th", { key: '82877ef610be7d4f8029b9a9f94f1760664da2fb' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: '3ae2a30217a13b2a903e98c4ca88489d6ed87014', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: 'ae0a9aed78de1010bd518e9a3e944aa529df300b' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: '9aa8f95aa6ef5f194f5602d648a8224ec00cb6b3' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
