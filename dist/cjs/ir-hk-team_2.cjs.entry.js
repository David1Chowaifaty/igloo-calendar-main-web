...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2f17dda84d170b8d2be6d98c2355415c9bc2a7c0', class: "card p-1" }, index.h("section", { key: '3fad6120b9b9a74781b44e84c6b1e145f8fd024a' }, index.h("ir-title", { key: 'cd02a32671646ae897418876a55b639480877f3d', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: '281763b5c418aefc2571b3aa3c3b9351b47c9d5f', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: 'bb3a629206bbb29a749b9d06a5754185d650e0b4', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: '1c6bcb1e61c621c60cb648ef17ff98473fcc3b53', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: '9b3beebef61687455381997a83b6392a794e10c5' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: 'd81412bfca52d058862320f20b1e6e28fb480b20', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: 'a7f63312e5a750d4ba114fa9b19b56ff518740bb', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: '9299ee4c8c1780122aa6e75564a1b69ddfb77672', class: "table-container" }, index.h("table", { key: '773bbe0e13c76ac6d8143d9189a1572ef2c32d06', class: "table" }, index.h("thead", { key: '276b65efd0545401abb7acd8ebde706af9d93af5' }, index.h("tr", { key: 'bdaee9260735bda846089dc6a93e652e88abfa89' }, index.h("th", { key: '46809e7e3310b707bb715609716d9547267a8722', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: 'e137e864f576e646590697e18d47a571d011b735' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '2c837817ba37a5515dc54eb401fef7f288fdd773' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: 'd5d52cae2d112d6f8d2a54c753f05f5d2cf140b8' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: '0d11b1c76c8288166279f4512c800098347936be' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: '7e40cff6098bef8cc13254a54b56cd9cee873843', class: "text-center" }, index.h("ir-icon", { key: '1fd63f7892d702347174b1375cb350172ba57385', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '4d4457bf276cd0205449650a3d592c897153a1fc', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'd5f9be65d0cdbfa1aa7e61fc89077dd527e4a85e', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: 'd04b7beb146b757dc0ab560a07ed43360bb969e6' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '934a1963fcfcdebe2d9977caa0c37faebbd8f235', class: "card p-1" }, index.h("ir-title", { key: 'bffe85122df9000434bccb1bacccedc848e2c050', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: '33632326a53741150331bf3b819a5ab37bd2bd71', class: "table-container" }, index.h("table", { key: '4422ca879a2578a52ad308a56a65a681960a61ac' }, index.h("thead", { key: 'a566b412cf1b086c28d4642638e7acec4eb85d3a' }, index.h("tr", { key: 'b5b5b218e1a2358b4ea436b7b00535fc92da52f2' }, index.h("th", { key: '9d092454edbef335f2056552736e96d77b3703f8' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: '094c0bfc77e5719221d44ac88b79adaf511c7c44', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: 'd39a75ad4a53f809062df6352e12a4b16683e2d1' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: 'b8c1226d85a6499c5499f8adf5189fdc2630aa59' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
