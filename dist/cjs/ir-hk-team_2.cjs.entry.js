...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b8965b02d79cfbff5bfa5e6eb110ee36e4d2e17c', class: "card p-1" }, index.h("section", { key: '67d22c7ac94d63319601e30ab6c715f2d70c348e' }, index.h("ir-title", { key: '989a003f8e36bdd4663bca51ebf43ac396ee6859', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: '39f7769dfb3d204dc119252d3183d55b87c17dc6', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: '4e02d5f33f44d6de0aed5b27c1ddddd521833fca', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: 'b424a795cd226495482dd82cc95b335f52a8c118', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: 'c3fa9523194b060459b804e8008b41de358e7bb2' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: 'cbce21fc05991391b5fafa4982f8671ebc8dc7d6', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: '0fb49e3a952ea108c1457be29404604f6033dfaa', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: '3485dc7caa8563d22d9daf1927453dc56a99deea', class: "table-container" }, index.h("table", { key: '8b141995b02ab00f30462368c75e82fbe573cce5', class: "table" }, index.h("thead", { key: '400efbebdeea0dbdcff91c0e533d8cc1e2c33356' }, index.h("tr", { key: '831a1705de914ad8d9d57bbbf1594f5df3f6b1f7' }, index.h("th", { key: 'bc3d64edb3bb3027d9cc7c264b5604bc017171c6', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: 'cb8e73026c87949286bed7e8ea93aad4189accbd' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '17f0b757dfbd9be66533794f158e0f73a985cbc2' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: '96d78324974e64bcb0fa836ab9760c0599850741' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: '6b951a6c8ce0dd8d0f90ef1bdac74eea47127e6b' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: '0183885ecbe86f71e21f6b4b771d3790c01c9f2a', class: "text-center" }, index.h("ir-icon", { key: 'ff9d6005ba51762076b238de40e2331a8d99e7ff', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '022289a5eba27ac50012e0a6200760d48f0b4eac', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '8bcdb9755e53fa302b18fd98e5da439114831939', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: '30876a1582f56334d06b5943e52cae07ebf8caf1' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '5586962a5898a10e3e28f440f5a7953f30418c73', class: "card p-1" }, index.h("ir-title", { key: '78d19dce427b5b9cd93dd4ec333f39f19cd4fa12', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: 'dc4902a2bce6837000b86cd7eedb747ac4280bea', class: "table-container" }, index.h("table", { key: 'ba4f5aa3c371eb888a124275ea4448e1149e380c' }, index.h("thead", { key: 'f161dc525863fd0928a6933560866763635ce3b8' }, index.h("tr", { key: 'fb7f432f31c03b019576290e0d3ca26e22d16e07' }, index.h("th", { key: 'aad3afcb7a43d1ccca572f5fbc484044dc29eecf' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: 'e0a342e477893a28d31e4c562f53bff8e25d0566', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: 'badcff5a98029b035bf7c786e3faac32a82bba88' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: '85c95d054d00835afb373fe4e18d89d4584ebdf6' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
