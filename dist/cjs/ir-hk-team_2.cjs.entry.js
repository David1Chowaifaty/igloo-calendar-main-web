...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '20f238995ef76cf927bdca06656e62e9a5ca4f52', class: "card p-1" }, index.h("section", { key: 'b30b2d7fe28a3d3e267feee67d8d1481edf77401' }, index.h("ir-title", { key: '2a1cc9d14da9c38a0c22505f7cd7659cab5afdef', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: '167384b49e691cbccb2f4cefe21d9cf6680eeef3', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: '78cb14667d8ae3c6ff30723ce6597d42567d0856', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: '2e775ab0ee40b297d1cb1890ab272eb89dffcabd', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: 'a100e860b523040a36f659c89571f9cfac9d67e0' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: '837d20d5979095c7497e2e7afc72bf4b7851e18e', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: 'cf94f97ddeb570aecf7401544afdccd6e7183975', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: '9a433768c7310593ad5cb2e44db0fee3ad36a271', class: "table-container" }, index.h("table", { key: '02082449259cc8daf913a4e0b92082562b116057', class: "table" }, index.h("thead", { key: '946449b3d869657baedb864f7f3d06df3726b837' }, index.h("tr", { key: 'e6f5e8c9ecd2904105cd50f8f5c5e8e5ad255ed8' }, index.h("th", { key: '40ecb53ccd9eda4933714eba24c3c97e6c761425', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: '1381014c53b3287898d28bd5aa4bf944e7cb2d90' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '2f26fb4a68deac434b7d34f2d5aa3761d1e6d4dc' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: 'a952aff69d455f6abad78fe6a2e62586fedf66a6' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: 'be3e157af164343162d6c68e2d0c3cacc61b4333' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: '402f6e812102082635ed29278541cab35d435393', class: "text-center" }, index.h("ir-icon", { key: 'dfc5cb2e82d97e51d019ae9e12948ece48b8af37', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: 'a9f458abc47e22fa45674d6a21cdf96dcbcd44df', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'd24db53e75a82f0ee46dd4d98399b2cf7ef3abe0', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: 'd5f0d603c9359836761eb8b53efed8d031053bb7' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '5590b539c34d86c3a9e34d1d07a5b77807b15b6b', class: "card p-1" }, index.h("ir-title", { key: 'a73685fba5ab4deb8130cf4b3dac9f0556065022', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: 'e1a9c684b839017f7f78b82ff9d94b1d2a1b590f', class: "table-container" }, index.h("table", { key: '2e6692a6ba2526ee9bf3022256642a3348d02437' }, index.h("thead", { key: '759d64ea0103bf3ca7d3488281d27c76bdcd8071' }, index.h("tr", { key: '4e8c317d4fcda980edda6c9180d2678c5c633720' }, index.h("th", { key: 'e63e7c1724b26b93a88e29bf71268fcccf9e9f79' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: '45be06aa0ea7be78648900c2296936e101292a03', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: '16091a7836165b2b89c7006f9a60bd41859a1033' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: 'e7ad06c7cec2ac9b700f0006dc15acebee539a7b' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
