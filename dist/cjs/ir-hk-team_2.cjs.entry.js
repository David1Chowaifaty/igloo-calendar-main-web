...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '681ad9bf4f09edd1abbedc7104180ce3a2858a99', class: "card p-1" }, index.h("section", { key: 'af592f1dfb1e8d6d43d3f43e9668c5d871e22971' }, index.h("ir-title", { key: 'd456ea293d372fefef81f7ffec1124a83f794c63', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: 'a96e46c629ec8bb619898523a22b0b7779970e8e', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: '39765f186500bf33701b6b00bbf849ac1da0a503', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: '4f6014e4791e749e4f66b0ba5515567119ebecf9', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: '1054edbb4dac880ef1d18f200808b4a3b7085ce7' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: '9c41a1bf19a70c1a88134828fcd12a845abba265', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: 'c5172c6dd7889af9eaae11625096e8b55f3b44b0', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: 'f1a378c919879082933331c86e9f4193fed606f5', class: "table-container" }, index.h("table", { key: '69bb0efceadb1aa574628dac43d3f3970ba4bd89', class: "table" }, index.h("thead", { key: '698656b22a43744cc542391e45650af6a2c4112d' }, index.h("tr", { key: '94375c2ed2a941060712b3e17e605eb734ba19d1' }, index.h("th", { key: 'c63c9b5d3b52ee15592a8c0dc36fa7c6bf78f3c4', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: '48bcbfe603f007c8e8e70b341aade95183f2eccc' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '7f4f95a26ca369b6cd6532458d27d79daed6b742' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: 'a3db28a48c3830bfdf7971b46f648d5b779af20d' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: '324777c57ba90ab25590becdeea55157960fccab' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: 'c4fc795deae30b9b084cf078ef809895df77a090', class: "text-center" }, index.h("ir-icon", { key: '4e895cde79db8b8f5bcab1a05115b901f5e6b367', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '89099f50e8f1e5af46235e259327ffbd6d085d6b', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '1f4a8c22c80792d90a6184998a0ebdfad3ce0787', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: '058b4288695600bf8d056aef4eabca94d060272d' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'e1a8b0a59acb031930893923d1e93ec56aa9381e', class: "card p-1" }, index.h("ir-title", { key: '03eae880e429633d2289ff5de53df7fae63aec7c', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: '7589026c83f07fec878efb357aa2e24428967cf9', class: "table-container" }, index.h("table", { key: '54906800707e18670e930167664a0c751748ea12' }, index.h("thead", { key: 'd14274126509c83b90a26289c4e0359b4e82f908' }, index.h("tr", { key: '1f3424a25273cf6b0187f8294739e1e210f69380' }, index.h("th", { key: '560d6c8617f9d3bdf37d00060cb99acf56a8b255' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: '9fa067c08a282197a85248f189541327521cb18b', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: '95226155760aa5dfa251071c5da7b744c549fe7a' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: '03826d87067cd77c33c21f3bedcda54301fed846' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
