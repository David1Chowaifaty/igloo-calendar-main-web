...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '915d126b199047af53aebe1275e75e662eaa4a38', class: "card p-1" }, index.h("section", { key: '9632049670b3df59ddbdaf8f1fdb42501bd0aaf6' }, index.h("ir-title", { key: 'd977037ef6cf3edcfbac6c18bad646d52dc895ea', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: '953b7a8f07efc37a660f23b61913cf96d01bbcc7', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: '41740adeec1f20231d115ced375e57258aee01fc', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: 'e74f4717439736793563d64f9b947725d7681ac1', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: 'c4af1d3d3a8c743e360bb82c26ffaa1b46c4fe7b' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: 'a9890939cdb9ea6d99ee7bc67d3764cf97014407', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: 'adf0bd1c73bf95f4e8b90d5e93df60e548f266b5', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: 'f31ed255eddf9305094ecc50ee8156725768cd5f', class: "table-container" }, index.h("table", { key: '0bfd861d127f165112847d36c1fc92bb4c4c7791', class: "table" }, index.h("thead", { key: '63b439b2d984ede8fa0c2630bd14c6492d876fa4' }, index.h("tr", { key: '8f3754d82d867cde5fe67f005e9f0228accfd2e8' }, index.h("th", { key: '40d0bdd886cbbdd5b4c80942db17b971b52127cf', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: '3ab7a13098930b7a809147ec05d0a9871e0138cb' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '647d42329dbdd6da20450eb532ea2aafaf93d55c' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: '85ee9cbbee7bb990b5dee4677f787b1451affc55' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: '7a9702b4fceb772a231642db1569b3b6ae9ff965' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: '60133214c3ceeab59df49e28eb6cbfa26dce18e3', class: "text-center" }, index.h("ir-icon", { key: '8328153016c88b099648b3ed3cbc0dc5fc973022', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '523d2c901733a1dd91446bc4eca9fc38a2bd7c2a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '57f3c049ea4bdd01c8e5b36022ae38e8fcf5ea48', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: 'a1613434593e5d775b8eff40aa9a7d7a331016d6' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '8741528966c75c6b61aafccd4dfeadfdea2f9021', class: "card p-1" }, index.h("ir-title", { key: '67f2ac3b234cd7d0260f3b318389f06ef2a4e6d2', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: '114cd99744fc719933458391e6774fada8af8062', class: "table-container" }, index.h("table", { key: 'b109d8ec4bfa7c52cd078b9a7ca4484d36301346' }, index.h("thead", { key: '5627410d54a9c85cfe5ac771c84d300770b73c44' }, index.h("tr", { key: 'd3541ca30b79b6badf77dbe1d773cc5911593c55' }, index.h("th", { key: 'e4748d4361c30bea18baae7ac665cf315dd524e3' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: '20bfe420dd75c1702998575c98bb64ee1374f58c', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: '1ec288579388e3e68689b38828b7ce59a61e97d7' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: '71998aef239520be326fb4377701705111fbdefe' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
