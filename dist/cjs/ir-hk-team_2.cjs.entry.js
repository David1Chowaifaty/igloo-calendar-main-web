...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7fef9da4b456f888e45227a830ed5d18df895845', class: "card p-1" }, index.h("section", { key: '119c46cab120dd7b8de86d105302fa37296e72a2' }, index.h("ir-title", { key: '06b2a3931e1f28f3aced42370d6a7a767c86838a', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: '3f04e78a6a5fa4336992de6ccd58787d03c0b8b3', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: 'a016604be8d3f0fc535fa85feaae3647549ce86e', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: '20e62ace8c4e9a3b10da56860cc784ad91dfa5d7', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: 'ed437e0480b55e46c7307e40849f496fbadf2ba4' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: '619597ae4bce5bfe8f2f646ab6dff6b3c3929e6b', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: 'd0e8dfaca6452b9d0acea46b9fc890a3fda6ff8f', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: '8243cf33a787e93c22b35b5c769ba7dc8b3a702f', class: "table-container" }, index.h("table", { key: '87b060206b371d083101cf956eb90da4f0d59197', class: "table" }, index.h("thead", { key: '1be5e6544e25d1dadadba0a2750ea15a39b9b849' }, index.h("tr", { key: 'c9749ff7fe7cb153d0604ae156cf6956a6448469' }, index.h("th", { key: '78c5497e2edfa1f2c4d2ece129d67227ec2ea537', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: '063cb4a5cf1256c7fd6e6ff9d5db1dbad69f8391' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '74626aba194c6e3d2744695f6c4db5f559009d95' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: 'dc56aa56dbaf911cac8e9fda6bb1434b61c72547' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: '842d4dc1ba5966908d55ab3af36e88dac1790ae1' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: '7dc744853c85d155c126577d754e31e2aa5a5bd8', class: "text-center" }, index.h("ir-icon", { key: '1728b5c1efcb49547431c96efbda8f5637d23fa9', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: 'de51d1e53d72521ddab0f5b2437436f9b70d41bf', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '6043748e7f5417d791ca603dc39b19a240eba172', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: 'b7ef03759b2c21d655abb33f7c7e6f98419cd241' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '8b1f1bc42e800b667be63bf1579eb17d8fb4e0a9', class: "card p-1" }, index.h("ir-title", { key: '0c9a5ea7a60225f4518f2469d9cf1aa6ba470d3d', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: 'c575e2b186a4c9349354fb79aeb77a45eb4203ef', class: "table-container" }, index.h("table", { key: 'aeb1dbaab5c29a75f78eafb02918a83853dd6504' }, index.h("thead", { key: '882e1237e0b22d44f388957ed517153d0eb0f567' }, index.h("tr", { key: '6bef3bdd16b511f994549cdf61ead4fb602162e5' }, index.h("th", { key: 'b43e95d58c1e9c3ef0479dee7b5fc253d4d277e4' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: 'c0ecf3f241938852d48221b1c2959813325d7d97', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: '155fb7bc9f4c29abf7ac84e6b056309736426a7f' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: '9b0b1a084c5dbeaeeeb97743d86fd900d81e2130' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
