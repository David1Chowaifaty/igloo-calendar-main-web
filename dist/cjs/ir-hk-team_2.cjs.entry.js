...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '12c079f3a3a265f72d5dbf08e815756dfc3fab6e', class: "card p-1" }, index.h("section", { key: '3d6dab7d69317bf8032558fc9caa98519d50f3f8' }, index.h("ir-title", { key: 'da8e46a2aea12a4b85221248e89c11a277a0d2fe', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: 'c9bc817aa6b97782d8b3d096b3bca9bda5d1d476', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: '611534cc0d4c0c7bfc2e78503aebfe4dea9c097a', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: 'd7e0b9fe9e9e175291b34772f98e95db5924d262', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: '1e79eb987f0f3a763439bd640e9fe5ce71087af3', class: "font-semibold" }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: '91f33bb372851d0f71ba9257c6d2686d99b01aa9', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: '57efa038f015cdd3b69fba856ca6a5041e425933', class: "table-container" }, index.h("table", { key: '65f177c3fd51a7226a4a5e54913a7abd81fad9aa', class: "table" }, index.h("thead", { key: 'b8210debe996511da053a847818c3296285aa84f' }, index.h("tr", { key: '9b96599492e713808dff5b6b2c0e3209929050b2' }, index.h("th", { key: '0b5ef9c52e1f8e29cfa309c943a1b64a5dbf56b5' }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: '7fe786ce6d743a7658ce65c8af8f73eefddabe50' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '3c0d5c3a1ee35da05b51764061f4841f39332022' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: '786eb9fd5d29ef493a4ab8218521736113cba576' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: 'cc0c5a6270d9b5b380bdf6e9703461dbd43bbaa8' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: '597319f99e2054e829e52d9f63cbc8a94fd30092', class: "text-center" }, index.h("ir-icon", { key: '853d3bb57e251699d578685653e8aab9c05a08d7', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '3f032322ee08000ea64fba9c0b9e5c9e461afef4', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '81f91bbfca9a1d3131af1d5bdc945d655f765799', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: '0e546abc9021f7927e7ec1e342895cf397366439' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", null, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '1ff63bdcd0104f9c7525ca1c88e0663fd0fb2acc', class: "card p-1" }, index.h("ir-title", { key: '21ae2f8d1c20304c16a9bd5e113d63ff85029b89', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: '1ca955e97136b55757440bda59472e7d7e6bd4b2', class: "table-container" }, index.h("table", { key: 'd4f83f73797d60ec76f86dd04faab2f6da9f8b70' }, index.h("thead", { key: '40a5d106f062bb1ed64bd9b1ae7b4e380e711312' }, index.h("tr", { key: 'e512fdc6b2629421c975d8cb86080bc8f5f82016' }, index.h("th", { key: 'dd981b64be3d09a3d869ac5310002d21a8396ca2' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: '7c74697a46c5921cbb3f24eb8de976fd515560f8', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: 'c3792666bd90c07b5e85829f8ef49c884bb96b54' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: 'b0dca67681ceb2f3a4e0566ea88d038ae24212d2' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
