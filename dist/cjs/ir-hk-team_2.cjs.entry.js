...
const IrHkTeam = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b192ee9dfd25656f72f090546176f6a321a8414c', class: "card p-1" }, index.h("section", { key: '323b81ac9142597718a45cbf2601818b79cc4aec' }, index.h("ir-title", { key: 'b234f6c755095fa7ad50077aa292d45e12addb75', label: locales_store.locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, index.h("div", { key: '1487347ab60c144faaa3542acb267095aa734261', slot: "title-body", class: "assignments-container gap-16 m-0" }, index.h("p", { key: '5614cbc112a0e94420a53189feaf1ac911842e45', class: "font-weight-bold m-0 p-0" }, total, " ", locales_store.locales.entries.Lcz_TotalUnits), index.h("p", { key: '7a4689b0bc1848e5b3ff8b71906ff6c1f7a6cb21', class: 'm-0 p-0' }, assigned, " ", index.h("span", { key: 'bbc478fb39d03f63400803aa9a254839cdc659aa' }, locales_store.locales.entries.Lcz_Assigned)), un_assigned > 0 && (index.h("button", { key: '99cc5c4ed464dd605285479e9a8b2d4b2dbceeea', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales_store.locales.entries.Lcz_Unassigned)))), index.h("p", { key: '467012beca03c976b4141de61e55182d36ef287f', class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_AsAnOption)), index.h("section", { key: '2f1124d8ebcd6daee976ac5bcaca00b9cd5c61e7', class: "table-container" }, index.h("table", { key: 'd1c161dcccb6dc47c8fd318d9120896a5d7f842d', class: "table" }, index.h("thead", { key: 'd5bee410a9297c9792a34a9dc5132e2eb163b91d' }, index.h("tr", { key: 'ac61ae36ef42794bf8753045f9ce1c52f2d243cb' }, index.h("th", { key: 'b8a73b568a5383bef3a2781640e610cb484af5f6', class: "text-left" }, locales_store.locales.entries.Lcz_Name), index.h("th", { key: 'd911329106d096854b4f9694e5442a903d92c244' }, locales_store.locales.entries.Lcz_Mobile), index.h("th", { key: '565c8f6208dd640f72b2f5c5811cecfaa0bafdd5' }, locales_store.locales.entries.Lcz_Username), index.h("th", { key: 'ef1382fad675d056b00e215b73e2d8dbe92fac42' }, locales_store.locales.entries.Lcz_Note), index.h("th", { key: 'd29fa70f79e7f40713b4212fd1cbd45f40099382' }, locales_store.locales.entries.Lcz_UnitsAssigned), index.h("th", { key: '6ca764a6e896f7b8b1d65af30392d6b7f44cdc38', class: "text-center" }, index.h("ir-icon", { key: '89b73f98e4d429b28e5d90f10357538778372d4f', title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '2d2087780835a58801d58727b1b6e3fd58da03eb', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'a84f41831e85216bc25b656bb6a7b0f55a0d83c1', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: '7d9519c2410cf49762217ee4eb835b1259b9567c' }, housekeeping_service.housekeeping_store.hk_criteria.housekeepers.map(hk => (index.h("tr", { key: hk.id }, index.h("td", { class: "text-left" }, hk.name), index.h("td", null, hk.phone_prefix, " ", hk.mobile), index.h("td", null, hk.username), index.h("td", null, hk.note), index.h("td", null, this.renderAssignedUnits(hk)), index.h("td", { class: "text-center" }, index.h("div", { class: "icons-container" }, index.h("ir-icon", { title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
...
const IrUnitStatus = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '91c335420e6b05b3b2b797bbfd00b7d44a9e211e', class: "card p-1" }, index.h("ir-title", { key: '49f8796c8d756a6bc2e125d849ccb0610666b5c7', label: locales_store.locales.entries.Lcz_RoomOrUnitStatus }), index.h("div", { key: '321d54a6b38572d81af67ebd43a222c11bdcdac5', class: "table-container" }, index.h("table", { key: 'bd262204ae8a821cc7cf05fc1155eeb123c57d2e' }, index.h("thead", { key: '097b6cc316f9e8667680d97e4c3bfe1bec67bcbd' }, index.h("tr", { key: '77c0f2611b41691253395a4d536ea895e2ccb49f' }, index.h("th", { key: '1c221829118dbb80b6cfd22fed3a0715b97ba6ad' }, locales_store.locales.entries.Lcz_Status), index.h("th", { key: '3947ef1bacba4f1ca0c72e5a4f9b43b40df38f33', class: 'text-center' }, locales_store.locales.entries.Lcz_Code), index.h("th", { key: 'a0c218c9acb3c548b14d559d1b87584858ee5d0c' }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { key: '25e83aa1741ae40e8dbd670f6ab144a5c5559ffe' }, (_a = housekeeping_service.housekeeping_store.hk_criteria.statuses) === null || _a === void 0 ? void 0 : _a.map(status => {
            var _a;
