...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4d7457d9bceecbd3ca8149ccd39550642aae3904' }, index.h("slot", { key: '09c3dcc59f270ae50e0ce13815e61805bb88d214' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: 'bb70e512b8da1d59c8e442b377d94702ea91cb91', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
