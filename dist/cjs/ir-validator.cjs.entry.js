...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ec5622631385857989b352ac430701100647538b' }, index.h("slot", { key: '00279fd28f5aaa9c61e110626d83231ed4765d7a' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: '1cfbc5ef031be1bfa8f70bf745637ec0a7dddedd', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
