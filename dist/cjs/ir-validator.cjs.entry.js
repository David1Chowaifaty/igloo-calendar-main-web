...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8afd4a73fed38934beef94d565a9647c5639463e' }, index.h("slot", { key: '9c3050c736a54bdd38c7898f211829b7ef2419ea' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: '1a3697eea3cf0034ef6d451699933dc79eb52894', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
