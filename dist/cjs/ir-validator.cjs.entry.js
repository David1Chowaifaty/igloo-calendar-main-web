...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f37941e4bd6a02895a55a383578d8227766a161f' }, index.h("slot", { key: '76790eed1ec593d079cb839782fb7b124309b01f' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: '7d650f20cc47fdca591f84b97d16958353580443', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
