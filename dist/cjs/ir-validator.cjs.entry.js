...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b4f8f1040025e8648f904e39da6090268a371af7' }, index.h("slot", { key: '3aa01d222523cd83e78354b7c8058619b3176942' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: 'b5b06ed6ae1379d95a64d25708c6ee0cf296ea2a', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
