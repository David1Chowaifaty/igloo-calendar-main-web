...
const IrFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: '4f42ca85cc5fca7e948fcd1db8c2783c2ee8b57d', onSubmit: e => {
            ...
            } })), index.h("div", { key: 'a7549dc369b5f14e556c88ad098cfdc1a99e033f', class: "filters-bar__search-group" }, index.h("div", { key: '56daafe565b7bb3dfa27b0e3bf4620c5af04b440', class: "filters-bar__type-group" }, index.h("wa-select", { key: '79e38e3e4e038ee2662afbdef4b89625b1816ddf', class: "filters-bar__status-select", value: this.draft.type, defaultValue: this.draft.type, onchange: e => this.updateDraft({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-select", { key: '55eab9ad0aceb8ec5bf9bc2a3640105668e406a1', class: "filters-bar__status-select", value: this.draft.folioType, defaultValue: this.draft.folioType, onchange: e => this.handleFolioTypeChange(e.target.value), size: "s", placeholder: "Folios" }, this.folioOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label))))), this.draft.folioType === 'agent' && (index.h("ir-autocomplete", { key: '9fdcf55826b4267578c152227672d335dd19ffbb', class: "filters-bar__folio-select", size: "s", placeholder: "Select agent", withExpandIcon: true, value: this.draft.agentId ? (this.agents.find(a => a.id === this.draft.agentId)?.name ?? '') : ALL_AGENTS_LABEL, "onText-change": (e) => {
                this.agentSearch = e.detail ?? '';
            }, "onCombobox-change": (e) => {
                this.agentSearch = '';
                const value = e.detail;
                this.updateDraft({ agentId: value && value !== ALL_AGENTS_VALUE ? Number(value) : null });
            } }, index.h("ir-autocomplete-option", { key: 'bb6f5f99ccc3382bdac2e2e6011eeb7f2bde70a1', label: ALL_AGENTS_LABEL, value: ALL_AGENTS_VALUE }, ALL_AGENTS_LABEL), this.filteredAgents.map(agent => (index.h("ir-autocomplete-option", { key: agent.id, label: agent.name, value: String(agent.id) }, agent.name))))), this.draft.folioType === 'guest' && (index.h("ir-picker", { key: 'd0ae16db4073556b7b328a9ed1476cc0f97e752c', class: "filters-bar__folio-select", size: "s", placeholder: "Customer email or name", withClear: true, mode: "select-async", debounce: 500, loading: irInterceptor_store.isRequestPending('/Fetch_Exposed_Guests'), "onText-change": event => this.fetchGuests(event.detail), "onCombobox-select": this.handleGuestSelect.bind(this), "onCombobox-clear": () => {
        ...
        }))), index.h("div", { key: 'e220a9e82816f1d873fb8b91f87716250891d38a', class: `filters-bar__search-actions${this.draft.folioType === 'guest' ? ' filters-bar__search-actions--wide' : ''}` }, index.h("div", { key: 'dbe3a5d94a53228ee9f0176c730b6f177065a612', class: "filters-bar__search-combo" }, index.h("ir-input", { key: 'c8833e85ccb548f7d3e1525cebb7909af3d614f1', class: `filters-bar__search-input${this.draft.folioType === 'guest' ? ' filters-bar__combo-input' : ''}`, placeholder: this.searchPlaceholder, value: this.draft.docNumber, "onText-change": e => {
            ...
            } }, index.h("wa-icon", { key: 'fc004ad632257cbc31477c46f38a256cfbf28f6d', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), this.draft.folioType === 'guest' && (index.h("wa-select", { key: '5549457087c459963f7428774d123de2d53e6361', class: "filters-bar__combo-select", size: "s", value: this.draft.searchBy, defaultValue: this.draft.searchBy, onchange: e => this.updateDraft({ searchBy: e.target.value }) }, index.h("wa-option", { key: 'fb89861b087bf15c10621a8a6fefcc3dbe8191be', value: "doc_nbr" }, "Document number"), index.h("wa-option", { key: 'ce78e8bfcaec8ad2ae59b4bafe841a3db92e217a', value: "booking_nbr" }, "Booking number")))), index.h("wa-tooltip", { key: 'bfb658386ee1990dc0a496f7a19effbd9fbd1841', for: "search-btn" }, "Search"), index.h("ir-custom-button", { key: 'b5de48cd38d3805647c4a3b56697c55aee90b6cb', id: "search-btn", loading: this.loading === 'search', class: "filters-bar__search-submit", value: "search", variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: 'c7255c8025cda6273def78878c8d40bd3a6ffe82', name: "magnifying-glass" })), index.h("wa-tooltip", { key: 'ef17a5b21fed937e1160ad69f238d59bb638bab1', for: "excel-btn" }, 'Export to excel'), index.h("ir-custom-button", { key: 'dbbcbcb993185715e2378cb4b098370f37efa84b', disabled: !(this.draft?.fromDate || this.draft?.toDate), id: "excel-btn", variant: "neutral", loading: this.loading === 'export', appearance: "outlined", type: "submit", value: "export" }, index.h("wa-icon", { key: '8c08e4aae53eee082e07de9a4d9b9f2339e6e281', name: "file-excel", variant: "regular" })))))));
    }
