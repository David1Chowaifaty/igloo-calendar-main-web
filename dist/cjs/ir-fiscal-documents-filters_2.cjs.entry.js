...
const IrFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: '160e4af940662a84c60a6a37f545143721caed7a', onSubmit: e => {
                e.preventDefault();
                this.applyFilters.emit(this.filters);
            } }, index.h("div", { key: '77fdd76255c36baed956917c458d4020e28e41f9', class: "filters-bar" }, index.h("ir-validator", { key: '8377e93b115f93121bc9b6fad59d3defd4c51e94', value: this.filters?.fromDate || this.filters?.toDate, schema: index$2.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '0963c6c844beefee7cbdc5bfe2970488f8d47cd9', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: '77aa40a1dc1ed083283735fdd2929d3670593ae9', class: "filters-bar__search-group" }, index.h("div", { key: '87cfbde728d41520d0165f4f52587d84bc0d3887', class: "filters-bar__type-group" }, index.h("wa-select", { key: 'a697b58e5fdbc23c08041feb0c2349e7d2e8b7a9', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-select", { key: '507b26380eaa52ad8ceb956066640146a7a78c65', class: "filters-bar__status-select", value: this.filters.folioType, defaultValue: this.filters.folioType, onchange: e => this.handleFolioTypeChange(e.target.value), size: "small", placeholder: "Folios" }, this.folioOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: '6d6a971210f1285933ba6a3eb2267806f84d960a', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes")), this.filters.folioType === 'agent' && (index.h("ir-autocomplete", { key: '7ba524278d844415e9523717ddb907bbdc00d3a2', class: "filters-bar__folio-select", size: "small", placeholder: "Select agent", value: this.filters.agentId ? (this.agents.find(a => a.id === this.filters.agentId)?.name ?? '') : ALL_AGENTS_LABEL, "onText-change": (e) => {
                this.agentSearch = e.detail ?? '';
            }, "onCombobox-change": (e) => {
                this.agentSearch = '';
                this.updateFilters({ agentId: e.detail && e.detail !== ALL_AGENTS_VALUE ? Number(e.detail) : null });
            } }, index.h("ir-autocomplete-option", { key: 'dbfe90de2a089b58e133fb701e072eecf46ec553', label: ALL_AGENTS_LABEL, value: ALL_AGENTS_VALUE }, ALL_AGENTS_LABEL), this.filteredAgents.map(agent => (index.h("ir-autocomplete-option", { key: agent.id, label: agent.name, value: String(agent.id) }, agent.name))))), this.filters.folioType === 'guest' && (index.h("ir-picker", { key: '0626462555a79871c470cd5bb8f676e670a7115d', class: "filters-bar__folio-select", size: "small", placeholder: "Search customer by email or name", withClear: true, mode: "select-async", debounce: 500, loading: irInterceptor_store.isRequestPending('/Fetch_Exposed_Guests'), "onText-change": event => this.fetchGuests(event.detail), "onCombobox-select": this.handleGuestSelect.bind(this), "onCombobox-clear": () => this.updateFilters({ guestId: null }) }, this.guests?.map(guest => {
            const label = `${guest.email} - ${guest.first_name} ${guest.last_name}`;
            return (index.h("ir-picker-item", { label: label, value: guest.id?.toString(), key: guest.id }, label));
        }))), index.h("div", { key: 'c703219cb94bc67dd3b86cfeb1bee51cfdf1abe3', class: "filters-bar__search-actions" }, index.h("ir-input", { key: '18883bc02d52eb160b956e1ad05729e26233d2e8', class: "filters-bar__search-input", placeholder: this.searchPlaceholder, value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: 'ecee230257aa0b10651147a22bffc00616b46901', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '73f8cb3de93c5c92f268a0985640555158c16c45', class: "filters-bar__search-submit", variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: 'bda5a339ab73d6d682e14fd4ba35258ed2118311', name: "magnifying-glass" })))))));
    }
...
IrFiscalDocumentsTable.style = IrFiscalDocumentsTableStyle0;

exports.ir_fiscal_documents_filters = IrFiscalDocumentsFilters;
exports.ir_fiscal_documents_table = IrFiscalDocumentsTable;

//# sourceMappingURL=ir-fiscal-documents-filters_2.cjs.entry.js.map