...
const IrFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: '6da36c4a8bb05425da733d9a9cbec75d94eb1d9f', onSubmit: e => {
            ...
            } })), index.h("div", { key: '5fd8098be02fd527a778d130e8a17a0271f7d3aa', class: "filters-bar__search-group" }, index.h("div", { key: '20042e71f92533e8a3f2c010cebb929a4307e93a', class: "filters-bar__type-group" }, index.h("wa-select", { key: 'bb9541f8968286ce2f8a4013f8bb225b15efcb92', class: "filters-bar__status-select", value: this.draft.type, defaultValue: this.draft.type, onchange: e => this.updateDraft({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-select", { key: '61f23ff32b608dba064a5f5b85cd4324828daa6c', class: "filters-bar__status-select", value: this.draft.folioType, defaultValue: this.draft.folioType, onchange: e => this.handleFolioTypeChange(e.target.value), size: "s", placeholder: "Folios" }, this.folioOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label))))), this.draft.folioType === 'agent' && (index.h("ir-autocomplete", { key: 'f507fc815f4495a407bc281f4b58308c27b6469e', class: "filters-bar__folio-select", size: "s", placeholder: "Select agent", withExpandIcon: true, value: this.draft.agentId ? (this.agents.find(a => a.id === this.draft.agentId)?.name ?? '') : ALL_AGENTS_LABEL, "onText-change": (e) => {
                this.agentSearch = e.detail ?? '';
            }, "onCombobox-change": (e) => {
                this.agentSearch = '';
                const value = e.detail;
                this.updateDraft({ agentId: value && value !== ALL_AGENTS_VALUE ? Number(value) : null });
            } }, index.h("ir-autocomplete-option", { key: 'a4f770984176b4fd721c7b23524000567088dde5', label: ALL_AGENTS_LABEL, value: ALL_AGENTS_VALUE }, ALL_AGENTS_LABEL), this.filteredAgents.map(agent => (index.h("ir-autocomplete-option", { key: agent.id, label: agent.name, value: String(agent.id) }, agent.name))))), this.draft.folioType === 'guest' && (index.h("ir-picker", { key: '8f368bd9a57816023d74e17c4574dbb01e943a68', class: "filters-bar__folio-select", size: "s", placeholder: "Customer email or name", withClear: true, mode: "select-async", debounce: 500, loading: irInterceptor_store.isRequestPending('/Fetch_Exposed_Guests'), "onText-change": event => this.fetchGuests(event.detail), "onCombobox-select": this.handleGuestSelect.bind(this), "onCombobox-clear": () => {
        ...
        }))), index.h("div", { key: '56c17a466efaf8aac1dfed56fd2fc05430644a82', class: `filters-bar__search-actions${this.draft.folioType === 'guest' ? ' filters-bar__search-actions--wide' : ''}` }, index.h("div", { key: 'bd2d1df8e2248c55bfb3a2c4450cf51fb32dfce3', class: "filters-bar__search-combo" }, index.h("ir-input", { key: '824e5054bc222dd20c981632f5d3935db2e9c6e3', class: `filters-bar__search-input${this.draft.folioType === 'guest' ? ' filters-bar__combo-input' : ''}`, placeholder: this.searchPlaceholder, value: this.draft.docNumber, "onText-change": e => {
            ...
            } }, index.h("wa-icon", { key: '5baaa25def31fcac3c9c65999b90f8ab6f72b29b', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), this.draft.folioType === 'guest' && (index.h("wa-select", { key: '587d9afe96499df3164ae066b4d46f831d85da3b', class: "filters-bar__combo-select", size: "s", value: this.draft.searchBy, defaultValue: this.draft.searchBy, onchange: e => this.updateDraft({ searchBy: e.target.value }) }, index.h("wa-option", { key: 'c9b2656f391c8750ef688be0b5ac4386d11d4ff6', value: "doc_nbr" }, "Document number"), index.h("wa-option", { key: '24e46d8cb612d3a5dd9532789818a80b6f1dc343', value: "booking_nbr" }, "Booking number")))), index.h("wa-tooltip", { key: 'b81f1466397ff45ab9d3cea65bda69fae346a0a9', for: "search-btn" }, "Search"), index.h("ir-custom-button", { key: '61c7596c23f4756f76d01243e877d4bc40aa12e4', id: "search-btn", loading: this.loading === 'search', class: "filters-bar__search-submit", value: "search", variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: '9f130e6b0efe5e48761be878d5513bde8eeff29e', name: "magnifying-glass" })), index.h("wa-tooltip", { key: '472c6eb40eab72c97983e4d2cf7ebb6545e6cae1', for: "excel-btn" }, 'Export to excel'), index.h("ir-custom-button", { key: '4db3fda632466aa46f236828621d102bccdab390', disabled: !(this.draft?.fromDate || this.draft?.toDate), id: "excel-btn", variant: "neutral", loading: this.loading === 'export', appearance: "outlined", type: "submit", value: "export" }, index.h("wa-icon", { key: 'b77412b4b47bc7bad477f997dd05b628daf95d09', name: "file-excel", variant: "regular" })))))));
    }
