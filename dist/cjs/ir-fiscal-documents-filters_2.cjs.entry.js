...
const IrFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: '72cbc1dbe8c5d94c2bbea11cac59072793aa6122', onSubmit: e => {
            ...
            } })), index.h("div", { key: '0068b54e1d688b989f68e936c1b4acada4b9e72b', class: "filters-bar__search-group" }, index.h("div", { key: 'c6452684ed28220e5ca76b7646c5d8ab715e40cb', class: "filters-bar__type-group" }, index.h("wa-select", { key: '9695d9a109fac028094c204f52a7dcb7853b3cd0', class: "filters-bar__status-select", value: this.draft.type, defaultValue: this.draft.type, onchange: e => this.updateDraft({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-select", { key: 'bf20dc1cc05b67ed3589d97a91a23b1f1186ba10', class: "filters-bar__status-select", value: this.draft.folioType, defaultValue: this.draft.folioType, onchange: e => this.handleFolioTypeChange(e.target.value), size: "s", placeholder: "Folios" }, this.folioOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label))))), this.draft.folioType === 'agent' && (index.h("ir-autocomplete", { key: '8a953636ff602757d424e4184efed8c7f41069c6', class: "filters-bar__folio-select", size: "s", placeholder: "Select agent", withExpandIcon: true, value: this.draft.agentId ? (this.agents.find(a => a.id === this.draft.agentId)?.name ?? '') : ALL_AGENTS_LABEL, "onText-change": (e) => {
                this.agentSearch = e.detail ?? '';
            }, "onCombobox-change": (e) => {
                this.agentSearch = '';
                const value = e.detail;
                this.updateDraft({ agentId: value && value !== ALL_AGENTS_VALUE ? Number(value) : null });
            } }, index.h("ir-autocomplete-option", { key: '99ec986302ef6d7839fb5f1d7bc15cd53bff03d9', label: ALL_AGENTS_LABEL, value: ALL_AGENTS_VALUE }, ALL_AGENTS_LABEL), this.filteredAgents.map(agent => (index.h("ir-autocomplete-option", { key: agent.id, label: agent.name, value: String(agent.id) }, agent.name))))), this.draft.folioType === 'guest' && (index.h("ir-picker", { key: '0395a288df579c1ca00e846f860f2d62557e9212', class: "filters-bar__folio-select", size: "s", placeholder: "Customer email or name", withClear: true, mode: "select-async", debounce: 500, loading: irInterceptor_store.isRequestPending('/Fetch_Exposed_Guests'), "onText-change": event => this.fetchGuests(event.detail), "onCombobox-select": this.handleGuestSelect.bind(this), "onCombobox-clear": () => {
        ...
        }))), index.h("div", { key: 'aff4c64fdd3c30fe8c60c7901c777ea1a11a8a4c', class: `filters-bar__search-actions${this.draft.folioType === 'guest' ? ' filters-bar__search-actions--wide' : ''}` }, index.h("div", { key: '6d9bd8ea887cc4d6e0aceb1d004879b07fd147cb', class: "filters-bar__search-combo" }, index.h("ir-input", { key: '7e3112ab164bf094dfdd1900907bd040de8dc323', class: `filters-bar__search-input${this.draft.folioType === 'guest' ? ' filters-bar__combo-input' : ''}`, placeholder: this.searchPlaceholder, value: this.draft.docNumber, "onText-change": e => {
            ...
            } }, index.h("wa-icon", { key: '1057d986a8d0e7a9f2613c6b6deb3a523633b5ab', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), this.draft.folioType === 'guest' && (index.h("wa-select", { key: '5f3c372babb41a759f959a5a12dca7afca343c2a', class: "filters-bar__combo-select", size: "s", value: this.draft.searchBy, defaultValue: this.draft.searchBy, onchange: e => this.updateDraft({ searchBy: e.target.value }) }, index.h("wa-option", { key: '5da05ee3482014159a7cd5fe1ab351ad0a8f6bf1', value: "doc_nbr" }, "Document number"), index.h("wa-option", { key: 'f7dce5e8b9947035b8957e9bca656e463b9e72dd', value: "booking_nbr" }, "Booking number")))), index.h("wa-tooltip", { key: 'b633cd2a94abb485fc25c4efb1b121f51cb0afb2', for: "search-btn" }, "Search"), index.h("ir-custom-button", { key: '01bdfb09ac30c5d952714d77d31880d129519263', id: "search-btn", loading: this.loading === 'search', class: "filters-bar__search-submit", value: "search", variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: '3e9551956a6c412f60141ac0029540a307f41f19', name: "magnifying-glass" })), index.h("wa-tooltip", { key: 'a71001054c367e899adab5537f802657b58c44fa', for: "excel-btn" }, 'Export to excel'), index.h("ir-custom-button", { key: '5c2acacd4cda0e94c585ba74f6cb296d9603f719', disabled: !(this.draft?.fromDate || this.draft?.toDate), id: "excel-btn", variant: "neutral", loading: this.loading === 'export', appearance: "outlined", type: "submit", value: "export" }, index.h("wa-icon", { key: '8ced4c24907c182a55df70d9319a9557323f21e7', name: "file-excel", variant: "regular" })))))));
    }
