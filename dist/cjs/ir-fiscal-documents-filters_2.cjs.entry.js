...
const IrFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: '201b83e21f962f79430c1eff7acd8ec728ab1b51', onSubmit: e => {
            ...
            } }, index.h("div", { key: '8313c56c6e3329bd6a0c0a14649b6b2c6139fcc1', class: "filters-bar" }, index.h("ir-validator", { key: '9e5ade661f548f4bbba7616ca7b0a40a2bc866bf', value: this.filters?.fromDate || this.filters?.toDate, schema: index$2.libExports.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '80c4d579803eaab4a7680f9e04693ae97b5c4bd6', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: 'bb022415015306e804552a7ec171a8b4acd78a16', class: "filters-bar__search-group" }, index.h("div", { key: 'a98f0ecd83641c6ee87dfbcb8988f90d45e8cad7', class: "filters-bar__type-group" }, index.h("wa-select", { key: '3f8ad743212ddbe7d19a79ce1e7f63c194db4a44', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-select", { key: 'bd0fbaf5c2f19a8f0727f6a6e218189d6f8133eb', class: "filters-bar__status-select", value: this.filters.folioType, defaultValue: this.filters.folioType, onchange: e => this.handleFolioTypeChange(e.target.value), size: "s", placeholder: "Folios" }, this.folioOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: 'a7b51abd42faba7454b6f14b21a95772bfc1d173', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes")), this.filters.folioType === 'agent' && (index.h("ir-autocomplete", { key: 'c280bbb8a7f62f7712be6da5e01710ab71095052', class: "filters-bar__folio-select", size: "s", placeholder: "Select agent", value: this.filters.agentId ? (this.agents.find(a => a.id === this.filters.agentId)?.name ?? '') : ALL_AGENTS_LABEL, "onText-change": (e) => {
                this.agentSearch = e.detail ?? '';
            }, "onCombobox-change": (e) => {
                this.agentSearch = '';
                this.updateFilters({ agentId: e.detail && e.detail !== ALL_AGENTS_VALUE ? Number(e.detail) : null });
            } }, index.h("ir-autocomplete-option", { key: '03bec0d24d5a16d290fe9885530b528cc4241155', label: ALL_AGENTS_LABEL, value: ALL_AGENTS_VALUE }, ALL_AGENTS_LABEL), this.filteredAgents.map(agent => (index.h("ir-autocomplete-option", { key: agent.id, label: agent.name, value: String(agent.id) }, agent.name))))), this.filters.folioType === 'guest' && (index.h("ir-picker", { key: '470e9a5e1b6f367c01f718d15a088eda8051061f', class: "filters-bar__folio-select", size: "s", placeholder: "Search customer by email or name", withClear: true, mode: "select-async", debounce: 500, loading: irInterceptor_store.isRequestPending('/Fetch_Exposed_Guests'), "onText-change": event => this.fetchGuests(event.detail), "onCombobox-select": this.handleGuestSelect.bind(this), "onCombobox-clear": () => this.updateFilters({ guestId: null }) }, this.guests?.map(guest => {
            const label = `${guest.email} - ${guest.first_name} ${guest.last_name}`;
            return (index.h("ir-picker-item", { label: label, value: guest.id?.toString(), key: guest.id }, label));
        }))), index.h("div", { key: '01894d81cd758e3a0fc86ce0499a85fdfcb390fd', class: "filters-bar__search-actions" }, index.h("ir-input", { key: 'd6ef81ab282cdc5664539be0d7178bbb7651cca9', class: "filters-bar__search-input", placeholder: this.searchPlaceholder, value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: 'f197df3e88d8beea7b52b49ece11cde40bb3559a', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'a4b2f44dfb187cfd5d53970583f96d10b13c00c5', class: "filters-bar__search-submit", variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: '0c057a62da9bc040873720a8785ba5b60ba8327c', name: "magnifying-glass" })))))));
    }
