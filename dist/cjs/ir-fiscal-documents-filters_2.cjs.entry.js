...
const IrFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: 'e7dfdf1b2c986e46b58e4e31ea61a3816655c86f', onSubmit: e => {
            ...
            } })), index.h("div", { key: 'b385a9cc9ec566fae44a319fde2cfdeed69cbbb8', class: "filters-bar__search-group" }, index.h("div", { key: '7740c47fb4c316def02b5ab8190e4f5602bbd033', class: "filters-bar__type-group" }, index.h("wa-select", { key: '34d3785ad7ca40b9457eec631a05adb63e7c8c7a', class: "filters-bar__status-select", value: this.draft.type, defaultValue: this.draft.type, onchange: e => this.updateDraft({ type: e.target.value }), size: "s", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-select", { key: '8b126de2e8c6e3066771b51b7722ce2196c9ebb7', class: "filters-bar__status-select", value: this.draft.folioType, defaultValue: this.draft.folioType, onchange: e => this.handleFolioTypeChange(e.target.value), size: "s", placeholder: "Folios" }, this.folioOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label))))), this.draft.folioType === 'agent' && (index.h("ir-autocomplete", { key: '90b0a8cb32067acddf135248023e487179ee0956', class: "filters-bar__folio-select", size: "s", placeholder: "Select agent", withExpandIcon: true, value: this.draft.agentId ? (this.agents.find(a => a.id === this.draft.agentId)?.name ?? '') : ALL_AGENTS_LABEL, "onText-change": (e) => {
                this.agentSearch = e.detail ?? '';
            }, "onCombobox-change": (e) => {
                this.agentSearch = '';
                const value = e.detail;
                this.updateDraft({ agentId: value && value !== ALL_AGENTS_VALUE ? Number(value) : null });
            } }, index.h("ir-autocomplete-option", { key: '30052c372e5a6fb2d94fc19311ec9fa4df9cfd0e', label: ALL_AGENTS_LABEL, value: ALL_AGENTS_VALUE }, ALL_AGENTS_LABEL), this.filteredAgents.map(agent => (index.h("ir-autocomplete-option", { key: agent.id, label: agent.name, value: String(agent.id) }, agent.name))))), this.draft.folioType === 'guest' && (index.h("ir-picker", { key: '243dc17977e476f1b6ce1b587fe3318be2e8c593', class: "filters-bar__folio-select", size: "s", placeholder: "Customer email or name", withClear: true, mode: "select-async", debounce: 500, loading: irInterceptor_store.isRequestPending('/Fetch_Exposed_Guests'), "onText-change": event => this.fetchGuests(event.detail), "onCombobox-select": this.handleGuestSelect.bind(this), "onCombobox-clear": () => {
        ...
        }))), index.h("div", { key: 'f0e43a5f16cdb09a360aaf7c87a07518a0e5d32f', class: `filters-bar__search-actions${this.draft.folioType === 'guest' ? ' filters-bar__search-actions--wide' : ''}` }, index.h("div", { key: '680668dc9a7f7d22894f46e884e654caa5998897', class: "filters-bar__search-combo" }, index.h("ir-input", { key: 'd6c754d207e82157b5f50dcfb9ba5ee6aa3d428d', class: `filters-bar__search-input${this.draft.folioType === 'guest' ? ' filters-bar__combo-input' : ''}`, placeholder: this.searchPlaceholder, value: this.draft.docNumber, "onText-change": e => {
            ...
            } }, index.h("wa-icon", { key: 'ba7b894d2c22f2a368df427e372010b1cdf98013', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), this.draft.folioType === 'guest' && (index.h("wa-select", { key: '32360a255b2ed6bb1c8ea751e5d7d4b4515c308c', class: "filters-bar__combo-select", size: "s", value: this.draft.searchBy, defaultValue: this.draft.searchBy, onchange: e => this.updateDraft({ searchBy: e.target.value }) }, index.h("wa-option", { key: 'f1154f0e342674b29e137b0bb25b8c9780572b2b', value: "doc_nbr" }, "Document number"), index.h("wa-option", { key: 'cbb6ac7553191966eb53fa352a0654c3396416a3', value: "booking_nbr" }, "Booking number")))), index.h("wa-tooltip", { key: 'd064b28d425e607f0660652fb52ba1160b27497e', for: "search-btn" }, "Search"), index.h("ir-custom-button", { key: 'ed21b209fd8b4b249d6e6cf56d7e8991ac2f9cac', id: "search-btn", loading: this.loading === 'search', class: "filters-bar__search-submit", value: "search", variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: '290bb9b2702356c6118f42713615c9c3eb202f34', name: "magnifying-glass" })), index.h("wa-tooltip", { key: 'a621c937dd79c82edd611a0f8810cde94bbbb5c6', for: "excel-btn" }, 'Export to excel'), index.h("ir-custom-button", { key: 'dd012876fbdc9a52399d49089383bc71cc745167', disabled: !(this.draft?.fromDate || this.draft?.toDate), id: "excel-btn", variant: "neutral", loading: this.loading === 'export', appearance: "outlined", type: "submit", value: "export" }, index.h("wa-icon", { key: 'e88a52ba6363f770d7bfbf6347e5e0221275fca4', name: "file-excel", variant: "regular" })))))));
    }
