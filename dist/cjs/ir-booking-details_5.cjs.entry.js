...
const IrRoom = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ba7dec5886463b36df5da3439740e057bf559aad', class: "p-1 d-flex m-0" }, index.h("ir-icon", { key: 'd908bd6ca6ce61fb85609cc68e02521247197e75', id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "pointer mr-1", onClick: () => {
                this.collapsed = !this.collapsed;
            } }, !this.collapsed ? (index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { fill: "#104064", d: "M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "25", viewBox: "0 0 640 512", slot: "icon" }, index.h("path", { fill: "#104064", d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z" })))), index.h("div", { key: '8d954cf8894738efdd170025dfaa86e246b9aa3a', class: "flex-fill m-0 " }, index.h("div", { key: '35bbc39e29c3b17d3e63614d7fa93981ce7bab09', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '8e45bef666bd6d8f7f6a10f9cc1c35c9c8636af2', class: "m-0 p-0" }, index.h("strong", { key: '226ef81a8915d8f0373f1f61b2d17d5fdcd6066b', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'c927e015d93e751f7afe4defe3ceb065527887ab', class: "d-flex m-0 p-0 align-items-center" }, index.h("span", { key: '37e28685f4a32f36c3c31e9198c9921eed4ccc61', class: "p-0 m-0 ml-1 font-weight-bold" }, functions._formatAmount(this.item['gross_total'], this.currency)), this.hasRoomEdit && (index.h("ir-icon", { id: `roomEdit-${this.item.identifier}`, class: "pointer mx-1", onClick: this.handleEditClick.bind(this) }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" })))), this.hasRoomDelete && (index.h("ir-icon", { onClick: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, class: "pointer" }, index.h("svg", { slot: "icon", fill: "#ff2441", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "14.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" })))))), index.h("div", { key: '80747f62f1e0a2a8c5d9e66db297adaff7ab84c9', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '0566790ab530071c153c3a8511acb7b19091cc2c', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && index.h("span", { class: "light-blue-bg mr-2 " }, this.item.unit.name), this.hasCheckIn && index.h("ir-button", { id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), index.h("div", { key: '9f1367a00d7e38c045caba01f2955b93321af713' }, index.h("span", { key: 'ca84a5a1ddfdcfc1b3f3746a99edf7f0fb579a1f', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", null, " ", this.item.rateplan.selected_variation.adult_child_offering)), index.h("div", { key: '2b6755506e93844e66c7e6dd1ba388935e09adf5', class: "collapse", id: `roomCollapse-${this.item.identifier.split(' ').join('')}` }, index.h("div", { key: 'ca16fe6412cae3510978e60b9de302714650b780', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '75fa3621a7c3266dd1c09bd274be5ddb8f02bbd4', class: " sm-padding-top" }, index.h("strong", { key: '64f791b30eea6cd1d1dc0a76eb8cb962265ea6e1', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: '8c2c942cfd16b7713920c10f02d64886833e33c9', class: 'flex-fill' }, index.h("table", { key: '26b0a931b017d7d1f1b09acadeebf4fa51bb3324' }, this.item.days.length > 0 &&
            this.item.days.map(item => (index.h("tr", null, index.h("td", { class: 'pr-2 text-right' }, functions._getDay(item.date)), " ", index.h("td", { class: "text-right" }, functions._formatAmount(item.amount, this.currency))))), index.h("tr", { key: 'b44b91fa2af98ed50790cf1f5fe15cb3690cfd7a' }, index.h("th", { key: '7cb346b3e1be6fde033753ae88d60950772621a9', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: '5234d7f9be8c131f4e9d8f87449de916c166d869', class: "text-right" }, functions._formatAmount(this.item.total, this.currency))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("div", { key: '63cc2b24f3e1b75f44d0585b384470d938eefd6b', class: "sm-mb-1", innerHTML: this.item.rateplan.cancelation || '' }), index.h("div", { key: '302d74c2596fc624c999f6a37aee22044a8aca68', class: "sm-mb-1", innerHTML: this.item.rateplan.guarantee || '' }), index.h("ir-label", { key: '64a8bdd892adefce6681f6b7726633d3ccb4088d', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), index.h("ir-modal", { key: '566a3797cddb3005765ec749ed50467fd9e5c8a7', onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
