...
class BookingListingService {
    ...
    async getExposedBookings(params) {
        const { data } = await axios.axios.post(`/Get_Exposed_Bookings`, Object.assign(Object.assign({}, params), { extras: booking.extras }));
        const result = data.My_Result;
...
//# sourceMappingURL=booking_listing.service-C-UuELM1.js.map
