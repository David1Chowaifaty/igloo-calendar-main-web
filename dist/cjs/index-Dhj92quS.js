...
const PropertyIdSchema = index.libExports.z.number().int();
const BookingNumberSchema = index.libExports.z.string();
...
const FetchUnBookableRoomsSchema = index.libExports.z.object({
    property_ids: index.libExports.z.array(PropertyIdSchema),
