...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'fec28def73ae3bc4c750d34c639868a926e46f91', class: " d-flex flex-column h-100" }, index.h("nav", { key: '1b80a3814f75e926495636c5a48ad0efd65c1195', class: "px-1 position-sticky sticky-top py-1 top-0 bg-white" }, index.h("div", { key: 'd99c36fbb285615f33cad8f00d44b37a5ec79cf5', class: "d-flex align-items-center  justify-content-between" }, index.h("h3", { key: '783589147e07984cfd07cdb0a1e21488fb9a8518', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), index.h("ir-icon", { key: '839d5b987bfd4b48f26ee4e716912189851bef4c', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '354d6c58ab44b98dee0e6251c4326f2fbb1f1250', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'df5a409321d83b066fbaec2205d556cecb0903dc', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("ir-channel-header", { key: '57d73675a5e9c86dc392ae59c48e694480254b13', class: "mt-1 px-0", headerTitles: this.headerTitles })), index.h("section", { key: '2347eb71b52d85dda9be5bba06fdcf349f11bbd6', class: "py-1 flex-fill tab-container px-1" }, this.renderTabScreen()), index.h("ir-button", { key: '75859bf485557c681b58572960a4c64c2dd8d2f7', isLoading: this.isLoading, onClickHanlder: () => this.saveConnectedChannel(), class: "px-1 py-1 top-border", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save })));
    }
};
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ce0dcba32fd82540b580dfb79e20e1b64f1be031' }, index.h("button", { key: '5ce930d1166a5b59a6cf1340bcfcb66722a678c6', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: '8e3a44b6067dda46e8dd9b6d38c33d17a64444e4', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: 'ad0990061461c0a46ede13ccdfe98a1481d2f967', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
