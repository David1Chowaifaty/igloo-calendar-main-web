...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '929ee121718a4acdddcdeab9eba270985b82f8ef', class: " d-flex flex-column h-100" }, index.h("nav", { key: '23f51c1d0c53490578801bc9858603a0a5b53ac1', class: "px-1 position-sticky sticky-top py-1 top-0 bg-white" }, index.h("div", { key: '00d67cdfbf5d8ec86dd5c420dd19135a4da32990', class: "d-flex align-items-center  justify-content-between" }, index.h("h3", { key: '2fabec88f33e92a49934d0ef587fe69a34ae911c', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), index.h("ir-icon", { key: 'b472ee55f0d9f2d866f36569a4697535719d61d8', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '723df2920e7e3aec0d67c400eee02249b27b2a3c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'de2ef9e24f31b573d58f02aa2c1a83f4f5d226c5', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("ir-channel-header", { key: '1a43dd0ff7853a6a5d8e6ee1ff4ea411f98c2f57', class: "mt-1 px-0", headerTitles: this.headerTitles })), index.h("section", { key: '7606fbc311447b61e83b7b41e99409932254e3df', class: "py-1 flex-fill tab-container px-1" }, this.renderTabScreen()), index.h("ir-button", { key: 'fc8fd37a66c87de0a11f94de5c0bfc23ea43efd3', isLoading: this.isLoading, onClickHanlder: () => this.saveConnectedChannel(), class: "px-1 py-1 top-border", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save })));
    }
};
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8b28f4e273af883fff8cbff804eec693d727bdae' }, index.h("button", { key: '17129bd50f999e17773eb1aabed5773e77d22da2', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: '4d7f05d3b520728aa6b90c13c17bf9d8b113c1b6', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: 'a7df211ea6121d5ab17b044612c2898e6202ded7', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
