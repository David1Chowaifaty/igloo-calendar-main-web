...
const IrSecureTasks = class {
    ...
    render() {
        ...
        return (index.h("div", { class: 'ir-page__container' }, index.h("section", { class: "secure-header" }, index.h("div", { class: "secure-header__top" }, index.h("form", { class: "secure-header__aname", onSubmit: e => {
                e.preventDefault();
                if (this.inputValue) {
