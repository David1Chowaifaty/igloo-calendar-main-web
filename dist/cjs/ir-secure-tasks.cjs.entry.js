...
const IrSecureTasks = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "main__container" }, index.h("header", { class: "secure-header" }, index.h("div", { class: "secure-header__topbar" }, index.h("div", { class: "secure-header__brand" }, index.h("div", { class: "secure-header__brand-icon" }, index.h("img", { src: "https://x.igloorooms.com/app-assets/images/portrait/small/avatar-s-19.png", alt: "" })), index.h("span", { class: "secure-header__brand-name" }, "IglooRooms")), index.h("div", { class: "secure-header__controls" }, calendarData.calendar_data?.property && (index.h(index.Fragment, null, index.h("ir-booking-new-form", { ticket: this.token.getToken(), propertyid: calendarData.calendar_data?.property?.id?.toString(), language: "en" }, index.h("ir-custom-button", { slot: "trigger", id: "add-booking-btn", size: "s", appearance: "plain", variant: "brand" }, index.h("wa-icon", { name: "plus", style: { fontSize: '1.2rem' } }))), index.h("div", { class: "secure-header__sep", role: "separator" }))), index.h("form", { class: "secure-header__aname-form", onSubmit: e => {
                e.preventDefault();
                if (this.inputValue) {
                    const url = new URL(window.location.href);
    ...
    renderPage() {
        switch (this.currentPage) {
            ...
            case 'extra-services':
                return index.h("ir-extra-services-settings", { p: this.p, propertyid: this.propertyid, language: "en", ticket: this.token.getToken() });
            ...
            case 'uninvoiced-bookings':
                return index.h("ir-uninvoiced-bookings", { p: this.p, propertyid: this.propertyid, language: "en", ticket: this.token.getToken() });
            default:
                return null;
        }
    }
