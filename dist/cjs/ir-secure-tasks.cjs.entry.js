...
const IrSecureTasks = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "main__container" }, index.h("header", { class: "secure-header" }, index.h("div", { class: "secure-header__topbar" }, index.h("div", { class: "secure-header__brand" }, index.h("div", { class: "secure-header__brand-icon" }, index.h("img", { src: "https://x.igloorooms.com/app-assets/images/portrait/small/avatar-s-19.png", alt: "" })), index.h("span", { class: "secure-header__brand-name" }, "IglooRooms")), index.h("div", { class: "secure-header__controls" }, index.h("form", { class: "secure-header__aname-form", onSubmit: e => {
                ...
                this.logout();
            } }, index.h("ir-input", { class: "secure-header__aname-input", size: "small", pill: true, value: this.inputValue, placeholder: "Property", "aria-label": "Property AName", "onText-change": e => (this.inputValue = e.detail) }, index.h("wa-icon", { slot: "start", name: "building", "aria-hidden": "true" }), index.h("button", { slot: "end", class: "secure-header__aname-save", type: "submit", "aria-label": "Save property" }, index.h("wa-icon", { name: "arrow-right" })))), index.h("div", { class: "secure-header__sep", role: "separator" }), index.h("wa-tooltip", { for: "secure-logout-btn", placement: "bottom" }, "Sign out"), index.h("wa-button", { id: "secure-logout-btn", size: "small", appearance: "plain", variant: "neutral", pill: true, "aria-label": "Sign out", onClick: () => this.logout() }, index.h("wa-icon", { name: "arrow-right-from-bracket" })))), index.h("nav", { class: "secure-header__tabbar", "aria-label": "Secure screens navigation" }, index.h("wa-button", { class: `secure-header__scroll-btn${this.canScrollLeft ? '' : ' secure-header__scroll-btn--hidden'}`, size: "small", appearance: "plain", variant: "neutral", pill: true, "aria-label": "Scroll tabs left", tabIndex: -1, onClick: () => this.scrollTabs('left') }, index.h("wa-icon", { name: "chevron-left" })), index.h("div", { class: "secure-tabs-track", ref: el => {
