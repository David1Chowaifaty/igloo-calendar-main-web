...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '576223fa8a797d0aa6c1a3151bb7f07c87f8e70e' }, index.h("a", { key: '302f2cbc7a2052d35b7c10005a61178ff66a72cf', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '46c92ed9a62020d45d74f8f0bb59c483ae4a7c81', class: "sr-only" }, "download url")), index.h("section", { key: 'c6762bb4c34cc1e70d94982cc3fd95e911a62c1a', class: "d-flex align-items-center " }, index.h("div", { key: 'b4d7a2fec1222863faf65addb343c63690a9ca11', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'cf55d02ccc1b994b0566e56c0d088f9092cab63d', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'd5decb11659501921d2c3d455cf247161d0083cd', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'b40caedc84d45a5d440f5fe4ccca96bc9e78afed' }, index.h("igl-book-property-container", { key: 'bb810bdd8eb43522303473026bc7c2fbda98bf2d', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: '16d577eba423f4146c51d39cba17722600a2cd19', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: 'f601bb5935a33de072eff1badded69b5d5ebda58', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '490df705182b39afcbba556d9593b84cc3937430', onSubmit: e => {
            ...
            } }))), index.h("ir-select", { key: 'f772c7ca3f266f1e71cd94321e4964cc5862dd38', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'c80a27b726649c606733d99fff3a75554f24c46e', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
