...
const IrListingHeader = class {
    ...
    async handleSearchClicked(is_to_export) {
        ...
        if (booking_listing_service.booking_listing.download_url) {
            booking.downloadFile(booking_listing_service.booking_listing.download_url);
        }
    }
