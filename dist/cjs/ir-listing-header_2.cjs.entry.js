...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '95509e9c1e34724f2f9591e275524acfbbd44c39' }, index.h("a", { key: '3dd11310463d39d12364f75c4ab1be25fc4892c5', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '0b4c842f4e727203ae27fa58f293b9ed487aa707', class: "sr-only" }, "download url")), index.h("section", { key: 'cd45a15961f90dc8f1c843cf44f8a4f650c327a2', class: "d-flex align-items-center " }, index.h("div", { key: 'aec8d15a29b4ccaa8ab247a8effb47b9e5d0bcb4', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'ad71b095f3af789350308f071291b7395a80a94f', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'ea7113404da48a3e1ad536ed00d8d24ebee55426', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '92f9360b36728b55a562d1fa496c0a2321107edc' }, booking_listing_service.booking_listing.token && (index.h("igl-book-property-container", { withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, baseurl: this.baseurl, ticket: booking_listing_service.booking_listing.token }, index.h("button", { slot: "trigger", class: 'new-booking-btn' }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("h3", { key: '3ae23157f383f6f6b7979a12cb41e80478612477', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: 'a45357b8fff17af49321b9dce9e8998d7a441d36', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '44469ef63c4ed0d73b04fe13d812151e1b3d9ff7', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '54cbaf7694362d0e31348af78822bc78062bde0a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'fd74ab0b80dda0d502fb212d12c5f17c45cfd003', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '053da777fdfc2be3a68f5a8decaa475f04ab0878', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: 'aa742fbf22979cc7d60a6e68ccd35d083de34fa9', class: "d-none d-md-block" }, booking_listing_service.booking_listing.token && (index.h("igl-book-property-container", { withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, baseurl: this.baseurl, ticket: booking_listing_service.booking_listing.token }, index.h("button", { slot: "trigger", class: 'new-booking-btn' }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("section", { key: 'a9974b502fc5e5aa85a9f96ee9506abf416a6dca', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '696b19afc2f769e85f825067c6ad28fb7f4e824a' }), index.h("h5", { key: '481f96f582bc549eb3722ff0d242472ed9f7fcbd', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '8f8bc824b8d324ed98b9066c61b9b519d2aa9de6' })), index.h("section", { key: '526ed8499d1d0d48fbccf4269773eec445758d33', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: 'd60bea05f8285d6a31e0f83e0f667fe01c2ac5fe', onSelectChange: e => booking_listing_service.updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("igl-date-range", { key: '1c9a7b778b5a92594b7e53642a90434c214a0ed2', class: "flex-sm-wrap", minDate: "2000-01-01", withDateDifference: false, defaultData: {
            ...
            } }), index.h("ir-select", { key: '1aa473dfc33a274b52f5796e35dea3581cfc61c5', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: '552ce0e8b72d864bf5dd19c43f876ebf30a94941', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: '20d0b7541d05436405fe3275fa47f2f70d41c62e', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-icon", { key: '452f860aeefc5037dbce97ba5ac3853f0248c2ae', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, onIconClickHandler: () => this.handleSearchClicked(false) }, index.h("svg", { key: '306b07ae803c7b4ed9c568f091f360d1d600786c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { key: '7610373afcca951d0ac082fd09c51dea3d6cc03a', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("ir-icon", { key: 'b5a41002adc8b288dd1dee65c247659c9cdc2ea8', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, onIconClickHandler: () => this.handleClearUserField() }, index.h("svg", { key: '3f5623457056789ae8dbbe4d3a8139aec36c6f3f', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { key: 'a200f3e311458b5c2a1bff1a3e435fce9b629be4', fill: "currentColor", d: "M290.7 57.4L57.4 290.7c-25 25-25 65.5 0 90.5l80 80c12 12 28.3 18.7 45.3 18.7H288h9.4H512c17.7 0 32-14.3 32-32s-14.3-32-32-32H387.9L518.6 285.3c25-25 25-65.5 0-90.5L381.3 57.4c-25-25-65.5-25-90.5 0zM297.4 416H288l-105.4 0-80-80L227.3 211.3 364.7 348.7 297.4 416z" }))), index.h("ir-icon", { key: '8414335dd6fa4de54d18239bab93feba485e96c7', onIconClickHandler: () => this.handleSearchClicked(true), title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel }, index.h("svg", { key: '6c691785b14e378698eaaee177d9b40ace746da6', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "15", viewBox: "0 0 384 512" }, index.h("path", { key: '70d92ad36a22022d5f9eb3d4e66ad7ff9afe3ae0', fill: "currentColor", d: "M48 448V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm90.9 233.3c-8.1-10.5-23.2-12.3-33.7-4.2s-12.3 23.2-4.2 33.7L161.6 320l-44.5 57.3c-8.1 10.5-6.3 25.5 4.2 33.7s25.5 6.3 33.7-4.2L192 359.1l37.1 47.6c8.1 10.5 23.2 12.3 33.7 4.2s12.3-23.2 4.2-33.7L222.4 320l44.5-57.3c8.1-10.5 6.3-25.5-4.2-33.7s-25.5-6.3-33.7 4.2L192 280.9l-37.1-47.6z" })))))));
    }
};
