...
const booking_listing_service = require('./booking_listing.service-71ea1e1a.js');
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1e4994401afb95115885dabd29840cd6c683425a' }, index.h("a", { key: '38b3cbf254bdaea9d86ca0a963ca497122307fa7', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '77b7e016330343ba2cd85cd29798f2d1b01b6e88', class: "sr-only" }, "download url")), index.h("section", { key: 'd72c9ffcafb75b52a3f80c6138236458cfe5458f', class: "d-flex align-items-center " }, index.h("div", { key: '61be66963551382bdc1d46f498013e74d7899577', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '4294db6d1b4e3a5d24321aae7074c216801c1f0e', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'f7356f2ea3cf51ade46212bca5313ac0dbcabc63', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '5173f49562a68819e213fb1a9695ee20a417faf3' }, index.h("igl-book-property-container", { key: 'c531f6868a01b9c74378deb09eee9190495cda97', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: '40e4b939fdcae050fc537a476ba3951c9551bf49', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: 'bc0776f39ba5c2fecb82cf1b85fff33ce2d87469', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '23e61cd3689fe063831d720d5f90635b931cf91c', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '296e65ba83c2b8756d1f40f975136683b0e9464b', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: 'ecb0d450e1ee5fe72dee3310718d555c382c10fb', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '1d55b83051e7effd89e07c718f6aabead4ea7183', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: 'cbeb7bfc444e5262205956c6cec87a980f7a70ca', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: '23d69582f6bf3baaaadd5e4ea859848b2f0496e8', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: 'c39578ef11759ba19d3ee4a75a7a4344ce2b2220', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: 'cd6b52e3e1428beb71c1444275974a4ed0ab4837', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: '9672659fa0e46dc3e9d3ac446021b35485e5cca9', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '320e9a6247706a29b454913037723573c3266efa' }), index.h("h5", { key: 'e0467db1e989afa0677578c6d0f7d1df28c31db8', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '468b2b338cd3a40e3a4fb47cdfa17dd7937aa105' })), index.h("section", { key: '802e91f0096979b1d86cb4486006231deea585bd', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: '53eef355cc5cce0564cdc88ff1759475dc1badad', onSelectChange: e => booking_listing_service.updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("div", { key: 'd6de1602265cbb99843c187d973de12d5250edc6', class: 'booking-dates-container' }, index.h("span", { key: '6c2598a98ed36155113bddba6dde1768c1109841' }, index.h("svg", { key: '35626a44285371262cc940dc7bd941046e978c7c', xmlns: "http://www.w3.org/2000/svg", viewBox: '0 0 448 512', style: { height: '14px', width: '14px' } }, index.h("path", { key: '06f5c544adbefd9d4610fa3188c669eda1a739d7', fill: "currentColor", d: 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z' }))), index.h("ir-date-picker", { key: '8808764f46701f38845857b3d3bf55c3362ecbb3', id: "fromDate", class: "date-picker-wrapper", date: new Date(booking_listing_service.booking_listing.userSelection.from), minDate: "2000-01-01", onDateChanged: e => this.handleFromDateChange(e) }, index.h("p", { key: '4ca409c70a29f3d85eec1b616d377221a9022306', slot: "trigger", class: "m-0 p-0 date-display" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.from)).format('MMM DD, yyyy'))), index.h("span", { key: '072e040cbc4f695341d1abc555758456b7af9aaf' }, index.h("svg", { key: '702724692eb9bd507b7f3d31533b47a31e896ece', xmlns: "http://www.w3.org/2000/svg", class: "arrow-icon", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '7abb9c46451280dacbb1e690b5fb45998802aba2', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("ir-date-picker", { key: '54f44d912572b321428d68eb9f3a14d896bd0572', id: "toDate", forceDestroyOnUpdate: true, class: "date-picker-wrapper", date: new Date(booking_listing_service.booking_listing.userSelection.to), ref: el => (this.toDateRef = el), minDate: new Date(booking_listing_service.booking_listing.userSelection.from), maxDate: moment.hooks().add(1, 'years').endOf('year').toDate(), onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }, index.h("p", { key: '5ec2e3780f7ffea5021c22fcdb5a7827919755fd', slot: "trigger", class: "m-0 p-0 date-display" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.to)).format('MMM DD, YYYY')))), index.h("ir-select", { key: '62aa58b6f61e4e05a7dc983f870bec09ccaaa015', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'a4c661102ce4c82a84be78fe6a1a3831683a4cb7', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: '77abe729f834a443b01f710d4f8fcb459c0c8716', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: 'ce6f1077c4b126bb73cd2038862a8c6353ed4468', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: 'be0c1fcb193f2bd938a6963e44292818ef82ce4d', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: '11170e0efebada17d1eae799bec4110186d7fdc4', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
