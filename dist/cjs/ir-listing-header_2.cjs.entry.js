...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cca80e555ecee6ecdecf1890056bb38910b74595' }, index.h("a", { key: 'eefe08388b636fe2c620fe95699ef45bd74742df', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '5092be3a04203683b7e8adda8fe2fefbc2dd64dd', class: "sr-only" }, "download url")), index.h("section", { key: '3ba247fde8dd7b8d97c76fc47b5bb7cf8125207c', class: "d-flex align-items-center " }, index.h("div", { key: '4c7e20193a925d9eadec8f1a23fb7afa37aa6303', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'c085bc6f5648ebfe42923ce07750bc2769fd5877', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'd51bcdd63171404fae4f37cb50310e6ded756271', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '76225f2b8671f6a206907fca7b24947abfc0e488' }, index.h("igl-book-property-container", { key: '8d430a10fb80bfde0f312ead40f90e5d7dc7988e', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: 'c95d1f8e47318382a98832a9d088c6840bde33b9', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '9ed9938cd06020a1a867b9d4dc760de4b6a5901b', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '18db5b3f06b19ce9f78a2979c6198befb230b101', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: 'd48e02947de38cd8a566b5ac9e52400977762536', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '51249fd937f748c697177061bfbda2d221f188da', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'd0a1df508b84e04710a38587a5b533453c513c0f', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '9a40291902d125360e514b9b821e96dc61a02c9a', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: 'ea68da0e9a01426d232e3fb3441ec393e6a04bda', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: '19fd8562f26afe983f072d10758900a384ca50dc', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: 'b72ddfeaa8ba2ed18eb94793abf0dc2885aae3c0', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: '0306b86f2e3cd97bd36e79da7b85323375bcafea', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '4aa70743dfbffd9704e7bcf4a0c9fbac1a23ad56' }), index.h("h5", { key: 'f9001ad8209e12b6237e04c3a19932625e09ecd3', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '2f774ac14d16ee0238d6ac4c5f3b96cb5cc190de' })), index.h("section", { key: '8fd7bb700c4cef6d3827d487eea0dbbe98ca6cb0', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: '5b361df47eee5849889137a77fbf1089bae2677e', onSelectChange: e => booking_listing_service.updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("div", { key: 'ed1563d300da05c731fb9b49f93bc5f29bfd17ec', class: 'booking-dates-container' }, index.h("span", { key: '7e2047cf2d3255f6bbb8f77f1b92d698dad2e8c6' }, index.h("svg", { key: '551864e4369b09fdc280fd03486b11e19060395d', xmlns: "http://www.w3.org/2000/svg", viewBox: '0 0 448 512', style: { height: '14px', width: '14px' } }, index.h("path", { key: 'add72cefddac1291aa6a92b967bd7aaca8034cd2', fill: "currentColor", d: 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z' }))), index.h("div", { key: 'aa61dc835bea2fac1d578e7b4bfd726ba0605e8b', class: "date-picker-wrapper", "data-option": "from-date" }, index.h("p", { key: 'fb2e242cb785bed5f8f54512903436026f5d5439', class: "date-display", title: "from date" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.from)).format('MMM DD, yyyy')), index.h("ir-date-picker", { key: 'b06936985fdb6ad9fd7f2998a40e4614fd0705a6', date: new Date(booking_listing_service.booking_listing.userSelection.from), class: "hidden-date-picker", autoApply: true, singleDatePicker: true, minDate: "2000-01-01", onDateChanged: this.handleFromDateChange.bind(this) })), index.h("span", { key: '1b1c75ff15d2c73cd27c785f4b88a3b8d39dc89c' }, index.h("svg", { key: 'a6375c602d91c242ba960309654bcdd8d835e4f5', xmlns: "http://www.w3.org/2000/svg", class: "arrow-icon", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '6d802670c60f03b3e5e13fc906ac8f84674c3f69', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("div", { key: 'd6b4df3616d18b9161c447ead71ccbd8b452ff63', "data-option": "to-date", class: "date-picker-wrapper" }, index.h("p", { key: 'f77a68fe8eafffbbc4103047bd1a65a4c12538c0', class: "date-display", title: "to date" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.to)).format('MMM DD, YYYY')), index.h("ir-date-picker", { key: '8581a5c34cf5d1f0a6565c630907acb7ab722bee', date: new Date(booking_listing_service.booking_listing.userSelection.to), class: "hidden-date-picker", ref: el => (this.toDateRef = el), autoApply: true, singleDatePicker: true, minDate: booking_listing_service.booking_listing.userSelection.from, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }))), index.h("ir-select", { key: 'aa6bb2a6e26840ea8a8d4a9370a4995df120a242', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: '081468f0f1a2e0ab4fc468ed5f7e4526caca45ed', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: '028219815a607b236daee0fc70ed2aa571e9bdd6', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: '6447dbcfbfafc85b9e3333ff963985572eba5916', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHanlder: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: 'ae1db2ae84dea4fad12a0d366acd9041bc24a6f5', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHanlder: () => this.handleClearUserField() }), index.h("ir-button", { key: '7a7ba0f06da92ce85efc2aaa59f36dd91ed1eb6c', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHanlder: () => this.handleSearchClicked(true) })))));
    }
};
