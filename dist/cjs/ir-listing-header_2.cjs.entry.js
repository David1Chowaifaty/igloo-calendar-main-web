...
const booking_listing_service = require('./booking_listing.service-9b3eb4d6.js');
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '588e1e22e0216c6018307a8f8acaec58cfb2a4d6' }, index.h("a", { key: 'bd08289dc1cf190b70dd5fd79d191ee1b4f2b5f9', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '3f093883de7b9d10cd1efc31bb6adecce730c86d', class: "sr-only" }, "download url")), index.h("section", { key: 'cef2eadcf7eef3832d4c68fcdecf973eff720e50', class: "d-flex align-items-center " }, index.h("div", { key: 'cffed2db288af39f19cc4f3d328331a9ae37f4ba', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '5057e3f0cacd7225ea8df363946d12b97d2303c8', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '7722349c4b3b60367b034f581aae93070d225d6a', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '32f86ebf3f3b150a49d7802d5821615ba7db2b3b' }, index.h("igl-book-property-container", { key: '3f27104e14f72ed30247c70585833ad0c5136ea6', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: '553521690014a3becc2b83648d964cd491db559f', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '08013a7c087a5ad517aceadce0783e085bd5efc2', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: 'e98ca82831dcbedeebad20b9ccf64c08da991ac6', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '6c97e0c7a7093de9078f043601cf3f989ce06c96', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '9655fac1cb4bc0b8172ac2e3bc9343307b699d3e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'c37577ac1ba74e6070c4f8cfd39ec697ddc09d26', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: 'a5ba5b7c9006f8fbcb02f454abb372e158f1b451', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: '0a69dad442f5b2a7729d04b290f2a64b952f345e', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: 'ebab421f6252936293705209c7973a696ee31c19', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: 'ef0cc2baef5709a8e2ed73f38a4c477c4cc31eba', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: '4ca8dff1279e1a1dd682815546d0f8819c9e4eb2', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '489c5b14311d5f5cf929859cda1b884e44f64276' }), index.h("h5", { key: 'b2064f1fef6509c22047b0ec0e873d7d34e48b80', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '06a6404c670452f056a9e0e9446162c7b30a4df7' })), index.h("section", { key: 'd51bfa146110b2acb6382248bed2adc03907dc50', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: '4d5ecee81ef5ed8d09b6e0b45e5b7cb49432515b', onSelectChange: e => booking_listing_service.updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("div", { key: 'd0643da89e81ea49d3375cb16e4b9e7b767f37df', class: 'booking-dates-container' }, index.h("span", { key: '24deae3a91c7f476efdb5698a7ae78b375248bba' }, index.h("svg", { key: '670c47b541978e54c14f6ce8db5233c2954acee4', xmlns: "http://www.w3.org/2000/svg", viewBox: '0 0 448 512', style: { height: '14px', width: '14px' } }, index.h("path", { key: 'ff089672587c8107c2c5d72ea4fd07a207cec9e6', fill: "currentColor", d: 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z' }))), index.h("div", { key: '49f5676febafc63a9c152f402dbe57fb00840013', class: "date-picker-wrapper", "data-option": "from-date" }, index.h("p", { key: '7da37c92f61a5e51b7df67313e0eb977e9916b20', class: "date-display", title: "from date" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.from)).format('MMM DD, yyyy')), index.h("ir-date-picker", { key: 'c023f81374d6978ae221219620f2a50e8764064a', date: new Date(booking_listing_service.booking_listing.userSelection.from), class: "hidden-date-picker", autoApply: true, singleDatePicker: true, minDate: "2000-01-01", onDateChanged: this.handleFromDateChange.bind(this) })), index.h("span", { key: '448aeab676682330ed2dd850c2019408cd6bf412' }, index.h("svg", { key: '59279c26e196bf2a3a1d83da13dcc702ab1f0030', xmlns: "http://www.w3.org/2000/svg", class: "arrow-icon", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'a492aa9f638035fc022db2cf497cdb69c77c545b', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("div", { key: 'bee0d5b397ebcc9fff2b1363d58cd7b48db9321e', "data-option": "to-date", class: "date-picker-wrapper" }, index.h("p", { key: '88348875a4450a912bdf15edea65728ac790741a', class: "date-display", title: "to date" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.to)).format('MMM DD, YYYY')), index.h("ir-date-picker", { key: '0d1806494a68ca6a11307b1696bb70c4616a0c82', date: new Date(booking_listing_service.booking_listing.userSelection.to), class: "hidden-date-picker", ref: el => (this.toDateRef = el), autoApply: true, singleDatePicker: true, minDate: booking_listing_service.booking_listing.userSelection.from, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }))), index.h("ir-select", { key: '0b920f4f17961911a481ae77a17b0780ad82eca0', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'e5a8eeb5ef279bf6b36d0e0b7045379307394835', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: '3619c7134538ac975b3380270c05f09f08a80e14', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: 'b2fee75f9694553926c5666cebb666a79c6ad44b', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHanlder: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: '670e5d0902aa7ae3f56288ac5fa8c728ec0684de', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHanlder: () => this.handleClearUserField() }), index.h("ir-button", { key: 'ca96d6433ba6df9b6501bfd352c6f0ee8f25970e', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHanlder: () => this.handleSearchClicked(true) })))));
    }
};
