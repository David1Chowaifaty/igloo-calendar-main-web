...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '22a3da35b5a89b9c68efb254ddec250c054b01b8' }, index.h("a", { key: '3eb7c07fa57f8cbc6bc16bd89b20466db0deea9b', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: 'c0de48d5abe833d4760f29a1c9122e5228134c5a', class: "sr-only" }, "download url")), index.h("section", { key: '9254e5982277f5590135a5b4a2ec7dc1ca09cc7b', class: "d-flex align-items-center " }, index.h("div", { key: '1108675c380a25388e1697b17b35315839b7ee4e', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'f2692f92569b687cd9eb0c356c5e70f8ff8a9278', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '7d51936eb0dee05dd4949b0f277640d8ff1132e5', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '813a3fb8e7303876004425cb9ba814c3456c4f96' }, index.h("igl-book-property-container", { key: '2041a2919434109363dccfb4e42e06f168d74f54', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: '6f04e1b0102d489e9be958164ad1dcdb3e7b2a15', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '3e0db4124d0dc899614072134e34cc177c7a7b46', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '06138ec296f104b52d1e6232daeaf46fbfc088dc', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: 'be28c01596ec34f4778e20a74929c482e27ece08', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '0588860f1e5f000ac3e717c53cb887d6c7186083', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'bfd6ebb95961b89a437fce144abec295523d7743', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '6200d02e9386aa1ec23ca27375a649345df092eb', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: '0f0ca3cf415bfc6369ec3d352524c6a3aef85297', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: 'b07f5fac78c3b8b02a4bcafa47b0af686f1808d5', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: 'b10ce3cada0445813617216378cfcec08ac080ab', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: '12036ff1e76a8b8f0795a77a07ae4e41787c3896', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '493cd95e5a2821ac0a513d593da554ad8ca24644' }), index.h("h5", { key: '34f5758099c69b67bfc645315d2adf256330de7c', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '1aa015a9f5603030f258feb7be4be11493c35dac' })), index.h("section", { key: '42bd21f4bdefd7278860cc2fe6b860072e5d6293', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: '66f73a5551684dfaf8482e76c93b86e7d3d78b79', onSelectChange: e => booking_listing_service.updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("div", { key: '0008e6c0a8097fc135953255c6f7f5c78f2ac201', class: 'booking-dates-container' }, index.h("span", { key: '5d98ebc1ae2f5dcbff5f0d7f14e7776ee6425790' }, index.h("svg", { key: 'b863a2a02bd1848a7364b455bf7519144efa9e2f', xmlns: "http://www.w3.org/2000/svg", viewBox: '0 0 448 512', style: { height: '14px', width: '14px' } }, index.h("path", { key: 'ad0f9aa694ebf76629e3248aa468e19f3a2e5b47', fill: "currentColor", d: 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z' }))), index.h("ir-date-picker", { key: 'c57b49d8729aa0db671ef68e82847d5ca208a4b1', id: "fromDate", class: "date-picker-wrapper", date: new Date(booking_listing_service.booking_listing.userSelection.from), minDate: "2000-01-01", onDateChanged: e => this.handleFromDateChange(e) }, index.h("p", { key: 'e9d409333ab5b8fa85b7dc57e13f5c1529499aa3', slot: "trigger", class: "m-0 p-0 date-display" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.from)).format('MMM DD, yyyy'))), index.h("span", { key: 'eff414a0a8dbb0bf7f8febf5aa121dd50989aa97' }, index.h("svg", { key: 'fb40e2913f931504fe8de249431bd5bdbb1a95f0', xmlns: "http://www.w3.org/2000/svg", class: "arrow-icon", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '0078c83d6adaa73441a3286ede8f13b2bb87e61b', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("ir-date-picker", { key: 'b3945cfc5f6d7a717c06c2c68c512188ce5cb35e', id: "toDate", forceDestroyOnUpdate: true, class: "date-picker-wrapper", date: new Date(booking_listing_service.booking_listing.userSelection.to), ref: el => (this.toDateRef = el), minDate: new Date(booking_listing_service.booking_listing.userSelection.from), maxDate: moment.hooks().add(1, 'years').endOf('year').toDate(), onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
