...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2f3cc8fabfe8329c81790b2afe5c18cdde9c9ad2' }, index.h("a", { key: 'c022519b6936f82a7cbe1b29cf3e412da6807dc7', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: 'ee2fa0a874fe5230fb647e95afbb213a7a259634', class: "sr-only" }, "download url")), index.h("section", { key: '62daac58e1044713672d2043e95659d7cf6bb803', class: "d-flex align-items-center " }, index.h("div", { key: '542c2819a7b3d6b659422090665251f38f0ce503', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'f25dc503e889f1677853a8cec9749a0a393fae01', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'd13544d679c1463ed9a28bd6325865df22d9f0dc', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'e0c5afdc0a9d2a251e3d38e1f51f7154c7d10df2' }, booking_listing_service.booking_listing.token && (index.h("igl-book-property-container", { key: '4a8d63e959488e7683e8714ab46204d3290e3eea', withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, baseurl: this.baseurl, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: 'c14f8ead3cc968c86e7d53a532a9c7742e173b17', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "plus" }))))), index.h("h3", { key: '516963410ed93a766bc1a8459c8af86faf08f5d4', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: 'f04ff3ace5dd54ca165ad8e9d28ddfff1d4c8db6', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '6da9ecacc3b65aa256f2365ba5019d0a37de63cc', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: 'c3da146c401386603f2b890e5611a9e0eaa45b1f', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'ac3f994ee20a7ea3dc9a6689ce53684968c5514f', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: 'a157a0ad7dd4293357eaab8e53c69a500233aec4', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: '121ca280fbb66b9874ebcb79c10349a6cf056d2b', class: "d-none d-md-block" }, booking_listing_service.booking_listing.token && (index.h("igl-book-property-container", { key: '4f55a2d66fed3f7d8d814c0716bd91b3c713737f', withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, baseurl: this.baseurl, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: '81fc5d13f99ad417a62474d808bc60cd900502b2', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "plus" }))))), index.h("section", { key: '67917e13486b27d8c3253ac95502a82592b230b6', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '718d145e7c38b85e907423a83ff79391221951b7' }), index.h("h5", { key: 'dae728d8d3a593ea615909110f4905510a9e8ae0', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '2bbec3bceaa5cde755d46cfbd536ef2361bd3074' })), index.h("section", { key: 'd9bda783795468eb512ba6f79baddffd4df6e7c5', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: 'db23b0ec3d50cb11717f641b2c971022bd5a3da9', onSelectChange: e => booking_listing_service.updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("igl-date-range", { key: 'bac8dc054d8e3e8f1b2a9da8c2c1bd5e4f030bac', class: "flex-sm-wrap", minDate: "2000-01-01", withDateDifference: false, defaultData: {
            ...
            } }), index.h("ir-select", { key: '8f8e36cd258ae5eb3e3809d90926850fb7066320', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: '634ef2548f2b90d05032012f753cccd166009e97', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: '1a3320b9533b4ff9c095b13994cb90ea504bbf89', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: 'b0d68b746c418b247ed5d2c6b468f89c022ba168', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHanlder: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: '477adc9aedaf9e0623181670352ef71ef16cc6ad', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHanlder: () => this.handleClearUserField() }), index.h("ir-button", { key: '5be797bb2a86fffeda28d3ccba69bb528040b7f9', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHanlder: () => this.handleSearchClicked(true) })))));
    }
};
