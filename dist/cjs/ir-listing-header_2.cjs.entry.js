...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f9e76c745756c43093e8d7938a4834e4724b69e1' }, index.h("a", { key: '8d1eb2d60d224016dafc4c886f6633a4757554ca', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '5f14ec3b3fd3a013e7e1098b6264a8606ebf4b34', class: "sr-only" }, "download url")), index.h("section", { key: 'b31bdca85b0270cd425d8ff6e5adc79bd53d07fb', class: "d-flex align-items-center " }, index.h("div", { key: 'b6b166ca0d803db7a6c5643e4a01441361290649', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '9861d472e409de44ec758a8a4489a29fa4dd1aa0', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '4764aa23dd746fb6efa19c248d80b4f33645a5d7', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '8791aadb551715d94edda2409abaecdc631eea33' }, index.h("igl-book-property-container", { key: 'b45851c43576cab6e85f6ffe8e0ed55e9da20fad', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: '6f83f57cf1af8daf88aed51a9328a4024915ab4a', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: 'bb42fbe02d492b6607b3fca693d72c83d6923060', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '2618d94efb993e884f03911ab0cb1afb6dcae99e', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '9a23d195e36a47c5ccde537a070f6fbda5273bdc', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '73ae10173ddf7757ed6c3a0c6500161c88284643', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '028c02b1fca67cdf2d1c6ebedef97f24e701cd02', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: 'c722e419362f666b82a7b033cdcd8e8aa8978f02', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: 'b39a1afe0e615e602baa31bfe7e8d65f5d17bd62', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: 'd4f292666dafaa5735d13851107997f311d5c61e', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: '2f85cc446f8264cc60069746b1936d8fef21d797', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: 'ada8ff03e464b2834983073eb806d45f1d6d46ee', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '8768c9a8e65ec8d3320b2b50a9d9cafa33e1c522' }), index.h("h5", { key: '10eb0b09097cbb94fe46cc2cfd52101c878a7174', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '415094958d4f7a468c49dd018f7af35205fb542c' })), index.h("section", { key: '70c7430baf3c4efdfea87d5e2f8c50883bdc1ee8', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: '95656777381111664f4f2478e692d39bf16ad761', onSelectChange: e => booking_listing_service.updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("div", { key: 'c9c4bf9ea270a15862e8f1013bdc22cf854a5491', class: 'booking-dates-container' }, index.h("span", { key: 'bd2b5f1f0e042c989611a5ec0df94ec097d37696' }, index.h("svg", { key: '9061a7f0a3cce4dd3f5f2354b504acdfb9337ee0', xmlns: "http://www.w3.org/2000/svg", viewBox: '0 0 448 512', style: { height: '14px', width: '14px' } }, index.h("path", { key: 'ae7c6435637f1a1e1408200c14ffa7073103ed81', fill: "currentColor", d: 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z' }))), index.h("ir-date-picker", { key: '93523f8a07246df3505883744a95725fbd2a4ef3', id: "fromDate", class: "date-picker-wrapper", date: new Date(booking_listing_service.booking_listing.userSelection.from), minDate: "2000-01-01", onDateChanged: e => this.handleFromDateChange(e) }, index.h("p", { key: 'b0d16ca4e6a726f2605cff4779ea8aab7ef34947', slot: "trigger", class: "m-0 p-0 date-display" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.from)).format('MMM DD, yyyy'))), index.h("span", { key: '5b4553952fe24065ec49e62095f453ab91a78399' }, index.h("svg", { key: 'e2b432979bc7878504ee3d4fbcb16c44471aaa4e', xmlns: "http://www.w3.org/2000/svg", class: "arrow-icon", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '8309f8ff1e8ccc5f1cd33ce04bf145b08ca0fbf0', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("ir-date-picker", { key: 'dcbcae69e2764b02babd5fbddb3254adcaa792c1', id: "toDate", forceDestroyOnUpdate: true, class: "date-picker-wrapper", date: new Date(booking_listing_service.booking_listing.userSelection.to), ref: el => (this.toDateRef = el), minDate: new Date(booking_listing_service.booking_listing.userSelection.from), maxDate: moment.hooks().add(1, 'years').endOf('year').toDate(), onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }, index.h("p", { key: '2a5941695fd6c224d325d9cefb04adee7ff6794d', slot: "trigger", class: "m-0 p-0 date-display" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.to)).format('MMM DD, YYYY')))), index.h("ir-select", { key: '288262fde9104c8089b0cd2fb94cfe6fe125f01c', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: '9dad6155643ba8f887215236a481dd7584de65fd', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: 'f6877a2ad5b72591a2d4a6d00ad9992a055b0df3', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: '89b9dbce490956209b38b48a13f7c41584665534', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: '71670cdaa8094206ee3b406757a1165338d99e19', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: 'd114ed7055cd6bc11af43b3696a6ea634e0fa09b', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
