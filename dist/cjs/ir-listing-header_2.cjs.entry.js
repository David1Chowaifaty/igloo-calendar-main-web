...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd23d06e4116941db431c934cdc293f991fd66baf' }, index.h("a", { key: 'a21783d55f1df1048917d5532d0d2ca1bbd44c7d', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '27b4b69046e530dee640ba804e04771c12921ec0', class: "sr-only" }, "download url")), index.h("section", { key: '69309020b011df51ed4d869bcfb3ae7dd0a05ca6', class: "d-flex align-items-center " }, index.h("div", { key: 'a53c5ae8afed76e906a406675a846297038c9cd0', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'c14abceed2b450a5ea4afe7a90169381561e0ce6', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '7dc62ead1e3d5f81b97294c20ce03160a0bdb224', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'a30dda66ee2672eaf6024c909c8630f7ea631da6' }, index.h("igl-book-property-container", { key: '1a538a61b39ab94cdce8ba9f3e3d6da0304faab8', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: '6f126b2068091cfd8e8183358e2a8844ba984a25', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '0c689c2cf194becc2c792af05fed73a5f59aea4a', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: 'f3efddb94f71c9c81b039490cb50defe704a0146', onSubmit: e => {
            ...
            } }, index.h("p", { key: 'efadc5845647af2a8800ee66896476cd9bafd2df', slot: "trigger", class: "m-0 p-0 date-display" }, moment.hooks(new Date(booking_listing_service.booking_listing.userSelection.to)).format('MMM DD, YYYY')))), index.h("ir-select", { key: '29d7fc64f5a01f3672bc0ad3cfab3c10fc753c1f', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'ce04d375ca0a89856d789f8947ed14e5a326df19', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
