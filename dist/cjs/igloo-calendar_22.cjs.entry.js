...
var arrivals_store = require('./arrivals.store-D9U13tdu.js');
var axios = require('./axios-EresIryl.js');
var booking_listing_service = require('./booking_listing.service-Cu3w0vY4.js');
...
var svcCategory_utils = require('./svc-category.utils-DzASf3tX.js');
...
var paymentOption_store = require('./payment-option.store-DRQpQ66l.js');
var index$3 = require('./index-D7Tp-eLT.js');
...
const IglooCalendar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1de32b30f50d04e06d16a47031c7b38d94216977' }, index.h("ir-toast", { key: 'f69b5d199c7c8084a104b6ee06b1aa92d42c81b4' }), index.h("ir-interceptor", { key: '47a94eaf4f38aaf3e7ada3960d001dfef9fdd957' }), index.h("div", { key: '08f18be6921a4002768e286c018cac8672668bb9', id: "iglooCalendar", class: { 'igl-calendar': true, 'showToBeAssigned': this.showToBeAssigned, 'showLegend': this.showLegend, 'showDayUseBookings': this.showDayUseBookings } }, this.shouldRenderCalendarView() ? (index.h(index.Fragment, { "data-testid": "ir-calendar" }, this.showToBeAssigned && (index.h("igl-to-be-assigned", { unassignedDatesProp: this.unassignedDates, to_date: this.to_date, from_date: this.from_date, propertyid: this.property_id, class: "tobeAssignedContainer", calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) })), this.showLegend && index.h("igl-legend", { class: "legendContainer", legendData: this.calendarData.legendData, onOptionEvent: evt => this.onOptionSelect(evt) }), this.showDayUseBookings && (index.h("igl-day-use-bookings", { class: "dayUseBookingsContainer", calendarData: this.calendarData, dayUseBookings: this.dayUseBookings, onOptionEvent: evt => this.onOptionSelect(evt) })), index.h("div", { class: "calendarScrollContainer", onMouseDown: event => this.dragScrollContent(event), onScroll: () => this.calendarScrolling() }, index.h("div", { id: "calendarContainer" }, index.h("igl-cal-header", { unassignedDates: this.unassignedDates, to_date: this.to_date, propertyid: this.property_id, today: this.today, calendarData: this.calendarData, highlightedDate: this.highlightedDate, onOptionEvent: evt => this.onOptionSelect(evt), dayUseBookings: this.dayUseBookings }), index.h("igl-cal-body", { propertyId: this.property_id, language: this.language, countries: this.countries, currency: this.calendarData.currency, today: this.today, highlightedDate: this.highlightedDate, isScrollViewDragging: this.scrollViewDragging, calendarData: this.calendarData, dayUseBookings: this.dayUseBookings }), index.h("igl-cal-footer", { isLegendOpen: this.showLegend, highlightedDate: this.highlightedDate, today: this.today, calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) }))))) : (index.h("ir-loading-screen", { message: "Preparing Calendar Data" }))), index.h("ir-sidebar", { key: 'ba43b292cb2c9cf60dc4515ceaa83b46e6f6c0e7', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: this.isSidebarOpen, showCloseButton: false, sidebarStyles: {
            ...
            }, checkOut: this.bookingItem?.TO_DATE, dayUse: this.bookingItem?.dayUse === true }), index.h("igl-bulk-operations-drawer", { key: '5c39cd518c2ead48dd39157756d2ade8d8a00762', property_id: this.property_id, onCloseDrawer: () => (this.calendarSidebarState = null), open: this.calendarSidebarState?.type === 'bulk-blocks' }), index.h("ir-rectifier-drawer", { key: 'c522d21348ee636d82d83cea20cfc0dbf420119e', onCloseDrawer: () => (this.calendarSidebarState = null), open: this.calendarSidebarState?.type === 'rectifier' }), index.h("igl-blocked-date-drawer", { key: 'f0415fefba00d7b2026cfd063b18a764160259d6', onBlockedDateDrawerClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingItem = null;
...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4a36af43ca007cef22875d9d40020d5c3f8e94a5', class: "p-1" }, index.h("ir-interceptor", { key: '9fcf8c8ef458a7f492491fba67b2412dffcaf10c', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), index.h("ir-toast", { key: 'd220fc5d695121261fda798e874801302a9b9ad9' }), index.h("div", { key: 'de50840a622e5261e836276513b8618a98cefefe', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, index.h("ir-input-text", { key: 'f296e7a4fcce5bf3329b43b78f5b9e4a9e8dad35', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), index.h("ir-button", { key: 'e2adf32b49af6b808886561de62209b34a92d52b', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), index.h("p", { key: '152f039982cc9ebaca1a50183d5b6ca734fd9f43' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
...
const IrExtraServicesSettings = class {
    ...
    formatAccChargeRule(rule) {
        if (rule.mode === index$1.taxationModes.NOT_APPLICABLE)
            return 'Not Applicable';
        return `${rule.value ?? 0}% ${rule.mode === index$1.taxationModes.INCLUSIVE ? 'Inclusive' : 'Exclusive'}`;
    }
    ...
    buildInitialRules() {
        ...
        this.categories.forEach(c => {
            ...
            rules.set(c.CODE_NAME, { mode: index$1.taxationModes.INCLUSIVE, value: defaultPrice !== undefined ? Number(defaultPrice) : null });
        });
        return rules;
    }
    ...
    buildPayload() {
        ...
        const inclusiveEntry = (this.setupEntries?.vat_included ?? []).find(v => v.CODE_NAME === index$1.taxationModes.INCLUSIVE);
        const tax_categories = this.categories.map(category => {
            ...
            return {
                ...
                taxation_mode: { code: index$1.taxationModes.INCLUSIVE, description: inclusiveEntry?.CODE_VALUE_EN ?? 'Inclusive' },
                pct: vat.mode === index$1.taxationModes.NOT_APPLICABLE ? 0 : (vat.value ?? 0),
    ...
    render() {
        ...
        return (index.h("ir-page", { label: "Extra Services", description: "Define pricing and options for the extra services offered on this property.", "data-testid": "ir-extra-services-settings" }, index.h("ir-custom-button", { slot: "page-header", loading: this.isSaving, type: "submit", form: "extra-services-settings__form", style: { width: '100px' }, variant: "brand" }, "Save"), index.h("form", { id: "extra-services-settings__form", onSubmit: e => this.handleSubmit(e), class: "extra-services-settings__groups" }, this.serviceGroups.length === 0 && (index.h("ir-empty-state", { message: "No extra-service groups are set up yet. Add a service category whose CODE_NAME is referenced by other categories' NOTES to group them here." })), this.serviceGroups.map(group => (index.h("wa-card", { appearance: "plain", class: "extra-services-settings__card" }, index.h("div", { slot: "header", class: "extra-services-settings__header" }, index.h("span", null, group.label), index.h("span", { class: "extra-services-settings__tax-chip" }, index.h("span", { class: "extra-services-settings__tax-chip-label" }, "VAT"), index.h("span", null, this.formatAccChargeRule(this.vatSummary)))), index.h("div", { class: "extra-services-grid" }, group.categories.map((category, idx) => {
            ...
            return [
                idx > 0 && (index.h("div", { class: "extra-services-grid__divider" }, index.h("wa-divider", null))),
                index.h("div", { class: "extra-services-grid__row" }, index.h("div", { class: "extra-services-grid__name" }, index.h("p", { class: "extra-services-grid__title" }, utils.getEntryValue({ entry: category, language: this.language }))), index.h("div", { class: "extra-services-grid__controls" }, index.h("div", { class: "extra-services-grid__cell" }, index.h("ir-extra-service-price-input", { autoValidate: this.autoValidate, onPriceChange: e => this.handlePriceRuleChange(category.CODE_NAME, e.detail), chargeRule: rule })), index.h("div", { class: "extra-services-grid__cell" }, isDayUse && (index.h("wa-switch", { checked: this.dayUseBlockNight, defaultChecked: this.dayUseBlockNight, onchange: e => (this.dayUseBlockNight = e.target.checked) }, "Block night"))))),
            ];
        }))))))));
    }
    static get watchers() { return {
