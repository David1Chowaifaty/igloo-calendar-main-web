...
const { state: calendarPreference} = index.createStore(initialState);
...
var momentHijri = /*@__PURE__*/_commonjsHelpers.getDefaultExportFromCjs(momentHijriExports);
...
function toDate(value) {
    ...
    else if (moment$2.hooks.isMoment(value)) {
        return value.isValid() ? value.toDate() : null;
    }
    const iso = moment$2.hooks(value, moment$2.hooks.ISO_8601, true);
    if (iso.isValid())
        return iso.toDate();
    const loose = moment$2.hooks(value);
...
function resolveLocale(options) {
    return options?.locale ?? locales_store.locales.language ?? languageObserver.LanguageObserver.getLang() ?? 'en';
}
...
exports.CalendarPreferenceController = CalendarPreferenceController;
exports.calendarPreference = calendarPreference;
...
exports.resolveNumberingScript = resolveNumberingScript;
exports.resolveNumberingSystem = resolveNumberingSystem;
exports.toApiDate = toApiDate;
exports.toDate = toDate;
exports.toNumerals = toNumerals;
