...
const booking_service = require('./booking.service-d841052d.js');
const user_service = require('./user.service-19b59a87.js');
    ...
    async init() {
        ...
        try {
            ...
            const tasksResult = await this.houseKeepingService.getHkTasks({
                ...
                housekeepers: (_a = housekeeping_service.housekeeping_store.hk_criteria.housekeepers) === null || _a === void 0 ? void 0 : _a.map(h => ({ id: h.id })),
                cleaning_frequency: (_d = ((_b = calendarData.calendar_data.cleaning_frequency) !== null && _b !== void 0 ? _b : (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_frequencies[0])) === null || _d === void 0 ? void 0 : _d.code,
                dusty_window: (_f = (_e = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _e === void 0 ? void 0 : _e.dusty_periods[0]) === null || _f === void 0 ? void 0 : _f.code,
                highlight_window: (_h = (_g = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _g === void 0 ? void 0 : _g.highlight_checkin_options[0]) === null || _h === void 0 ? void 0 : _h.code,
            });
            // updateTaskList();
