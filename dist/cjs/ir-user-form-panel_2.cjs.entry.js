...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '77881dd644310d5f33634844c41ef9536d86f69e', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: 'fe6be2df5cc1fc7e872c7349902684a40ddabdb2', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: '2406f0aee06824257c6e7768172d5ef2e8792b0d', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '94f26c1e201c1fb5cf55e07771b4bfbceb29dcbf', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), index.h("ir-input-text", { key: '13568ed9a9d0ca7be249bdf4ff272c6bfe4c21bf', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: locales_store.locales.entries.Lcz_Mobile, mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (index.h(index.Fragment, { key: '7cb9321ba837e6c9af208b07432baac1cdc1a630' }, index.h("input", { key: '7416601a835901e43361472481b02280b3f4980c', type: "text", name: "dummy", style: { display: 'none' } }), index.h("ir-input-text", { key: 'b95bb0eab17cfddcf43316af1f36d07d110f15bd', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: locales_store.locales.entries.Lcz_Username, disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username,
            ...
            return (index.h("li", { class: "login-entry", key: s.date + '_' + i }, index.h("div", { class: "login-meta" }, index.h("p", { class: "login-datetime" }, utils.hooks(s.date, 'YYYY-MM-DD').format('DD-MMM-YYYY'), " ", functions._formatTime((_a = s.hour) === null || _a === void 0 ? void 0 : _a.toString(), (_b = s.minute) === null || _b === void 0 ? void 0 : _b.toString()), " |"), index.h("p", { class: "login-location" }, index.h("span", { class: "login-ip" }, locales_store.locales.entries.Lcz_IP, ": ", s.ip), ' ', "\u00A0|\u00A0", index.h("span", { class: "login-country" }, locales_store.locales.entries.Lcz_Location, ": ", s.country), ' ', "\u00A0|\u00A0", index.h("span", { class: "login-os" }, "OS: ", (_c = ua.os.name) !== null && _c !== void 0 ? _c : 'N/A', " ", ua.os.version)))));
                ...
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: 'db21053c7562ee4f0c0cdae01058f6bea2d0f9aa', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '44b402e533eebb2d5d48bd29297bc9376c88fc71', class: "sheet-footer" }, index.h("ir-button", { key: 'd628e8d7b914e34102f3b981dc9f588d9822f5f1', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '73a1d4f79c49e37a09017e04a20999271d996e3f', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c661f91e18a2de6c2cef477ae25059ab86a51b7b' }, index.h("section", { key: '767cf30a6367f5a0d9e0360326ad69608883c572', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: 'c0c7d246f64126ed8c4c91fe4b6a786b35485b7a', class: "table" }, index.h("thead", { key: 'ee6841c2fa9e183f9a339697fd7d8321eade86d7' }, index.h("tr", { key: 'fefebbc978f6377e26d1ce11b1ec02a66562b924' }, index.h("th", { key: '2fdf72a63389d826deef76a58b25a317cd2d79f7', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '6beb6c6a47ff2ac9f28363e0f76df2a28fba6fe9', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: '5c031a48f4bbcd8f665b5fb3fcfacdae92952b38', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: 'd474318ea058bc46749fa3b305347b337f14a5e0', class: "text-left" }, locales_store.locales.entries.Lcz_Role), index.h("th", { key: '9a1e332589fe5e254b3ef6539df64043d047e6b9', class: "text-left small", style: { fontWeight: 'bold' } }, index.h("p", { key: '78f263e6d19d453392335d04e74d582f2f8c7527', class: "m-0 p-0 " }, locales_store.locales.entries.Lcz_CreatedAt), index.h("p", { key: 'cbec785010ec2c56e070f0c319a136b38f4db3b4', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && index.h("th", { key: '199cf756b57ee2f5e62d9e86c602d6ac392e2f22' }, locales_store.locales.entries.Lcz_Active), index.h("th", { key: '03c09bf37bb0b3ab7dfb63f967ccad2d25bf66fa', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '2e0427e6621eab9e6c7412ee27756ea5b36f7765', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, index.h("svg", { key: '68b22c50e41e77063e707962b0b06d1f9fc0ff34', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'b089ebfad924f71956916f38ba3c7414e0dfb164', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: 'ae82b914eef8d96eb90fd1ae68872de5241c9f33' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: '45cd5f75404f7c48ea8cdfe572b09c387fd91545', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: '16956c3d5ed89a09f59509d55989758e0d83c12e', autoClose: false, modalBody: this.modalType === 'delete'
