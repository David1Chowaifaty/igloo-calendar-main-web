...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '47d6f1f8c7d733f59519dd19bf4371cd380294e8', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: '757146b81ed84c8f774212e46ffb50b0aa3af755', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: '7a190efe7d99ce4b1d16e911505059d7771f8f9b', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '669441cc47078f78dea0182e5224071bc825c3ee', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), index.h("ir-input-text", { key: '65f5826e7136a54ef51a5a5d31e637b380e875ba', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: locales_store.locales.entries.Lcz_Mobile, mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (index.h(index.Fragment, { key: '8fa6acfec0ecd9583be333ef4ddf3374fdb9f49c' }, index.h("input", { key: 'ee838896e1145c16711626b49dd52e77ee237241', type: "text", name: "dummy", style: { display: 'none' } }), index.h("ir-input-text", { key: 'cb91327dd46dc14af1878ce38718c0fae10d6ed1', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: locales_store.locales.entries.Lcz_Username, disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username,
            ...
            return (index.h("li", { class: "login-entry", key: s.date + '_' + i }, index.h("div", { class: "login-meta" }, index.h("p", { class: "login-datetime" }, moment.hooks(s.date, 'YYYY-MM-DD').format('DD-MMM-YYYY'), " ", functions._formatTime((_a = s.hour) === null || _a === void 0 ? void 0 : _a.toString(), (_b = s.minute) === null || _b === void 0 ? void 0 : _b.toString()), " |"), index.h("p", { class: "login-location" }, index.h("span", { class: "login-ip" }, locales_store.locales.entries.Lcz_IP, ": ", s.ip), ' ', "\u00A0|\u00A0", index.h("span", { class: "login-country" }, locales_store.locales.entries.Lcz_Location, ": ", s.country), ' ', "\u00A0|\u00A0", index.h("span", { class: "login-os" }, "OS: ", (_c = ua.os.name) !== null && _c !== void 0 ? _c : 'N/A', " ", ua.os.version)))));
                ...
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: 'c756e75c0998fac9ee6f9a4726555854a806a97f', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: 'bc7437e1a85d7a2afeba9feffa9d32512ccc7499', class: "sheet-footer" }, index.h("ir-button", { key: 'cf3b82ee618af7d031562f7b701fdb374084583a', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'f96b069307dad5ae4a6897da8c3eb2f8bc16ea12', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4e51b2c27b56e66ee28cd3710743c7278e4fb8af' }, index.h("section", { key: 'e4e651a3dce3eee7cf9595e7fb45ee6bb0bb8285', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: 'f9bc1961f623a1c66810d223d79f1c10578e0bca', class: "table" }, index.h("thead", { key: '01b4f22ac09aa8ef3a54c94eedb5fc593fbca08b' }, index.h("tr", { key: '05950e56f98565fffb37e7066658e406d5cf248b' }, index.h("th", { key: 'a91d92715d4c1d0206141f08ac132f291eef0fc4', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '6ab74c975fe549366ad996c8a3d4cc06fab6a6d1', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: 'f2aaabbcdfe15872fb5dcc8fa1d7fc5149ffde44', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '0ca08a210b7bbd52d6dcceacca138800babbd160', class: "text-left" }, locales_store.locales.entries.Lcz_Role), index.h("th", { key: 'c4bac591a6d16433fb0393323391a9fded1be054', class: "text-left small", style: { fontWeight: 'bold' } }, index.h("p", { key: 'd890cfca39ee7210211cc08b32d1c0f9387e2152', class: "m-0 p-0 " }, locales_store.locales.entries.Lcz_CreatedAt), index.h("p", { key: 'd61a31b4bcde2b0763dd2091654a4c3ab2ebcb98', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && index.h("th", { key: 'dab9cde23c46b82fa5bc769dc5a1f3f11b86407e' }, locales_store.locales.entries.Lcz_Active), index.h("th", { key: '1c4b6111d6ac575c041acd41e6bedac936e569f1', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '621f4c887d30903cf746b03cd8240cc4f0630804', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, index.h("svg", { key: '6cd4ecedf5aceed86900eefa918ff1925ea5eee5', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '397c7eadce2ea8309603cfa68f83ab1f02f02f34', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: 'f83716cc25dbb0e686c22a988104b562805d90a8' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: '202dadf0b7b2e5aa96a4010aef62e0950eb47c3c', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: '0f117ccb396596a8710d049128eeba1f7e4d0910', autoClose: false, modalBody: this.modalType === 'delete'
