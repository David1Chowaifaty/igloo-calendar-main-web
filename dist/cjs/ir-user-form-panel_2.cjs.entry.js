...
const user_service = require('./user.service-51592263.js');
...
const IrUserFormPanel = class {
    ...
    async createOrUpdateUser() {
        ...
        try {
            ...
            console.log('toValidateUserInfo', Object.assign(Object.assign({}, toValidateUserInfo), { mobile: (_d = (_c = (_b = (_a = toValidateUserInfo.mobile) === null || _a === void 0 ? void 0 : _a.split(' ')) === null || _b === void 0 ? void 0 : _b.join('')) === null || _c === void 0 ? void 0 : _c.replace(calendarData.calendar_data.country.phone_prefix, '')) !== null && _d !== void 0 ? _d : '' }));
            await this.userSchema.parseAsync(Object.assign(Object.assign({}, toValidateUserInfo), { mobile: (_h = (_g = (_f = (_e = toValidateUserInfo.mobile) === null || _e === void 0 ? void 0 : _e.split(' ')) === null || _f === void 0 ? void 0 : _f.join('')) === null || _g === void 0 ? void 0 : _g.replace(calendarData.calendar_data.country.phone_prefix, '')) !== null && _h !== void 0 ? _h : '' }));
            if (this.errors) {
                this.errors = null;
            }
    ...
    render() {
        ...
        return (index.h("form", { key: 'de2704a792d2bf9fcca53a21b1e43651a888022e', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: '78872eb3c3f4085d2fcbff5e5611ac7792644326', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: 'c545c76879358e814d9aadd5552c3cf085e4f67b', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '7c65b39513469d78c5bafe96e8ab6f8b4ae3edf2', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), index.h("ir-input-text", { key: '23d0f8a067c5065e8a75da0bc64140ca4c7ea5c7', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: locales_store.locales.entries.Lcz_Mobile, mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (index.h(index.Fragment, { key: '973856d7d676a6ef4a7d8bc8128de722740c7465' }, index.h("input", { key: 'c721cbee1633e80ad95ca820328df79f561e76a6', type: "text", name: "dummy", style: { display: 'none' } }), index.h("ir-input-text", { key: '9ec98d6c091973e344d2987c591442b68b0ca349', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: locales_store.locales.entries.Lcz_Username, disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username,
        ...
        // ))
        ), ((_p = (_o = this.user) === null || _o === void 0 ? void 0 : _o.sign_ins) === null || _p === void 0 ? void 0 : _p.length) > 0 && (index.h("section", { key: '19b152b9fce80b7fab770eb6dcc162d533617e59', class: "logins-history-section mt-2" }, index.h("div", { key: '06ec7f1f5cc70fc1c9043b51b842ef1afac82c9c', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '994ff2fa1c9689fd5b8206c0a21c86f3d07d4c13', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: '7f6dde61b670ebbc1dec80888a09a28bd0041a28', btn_styles: 'pr-0', text: !this.showFullHistory ? locales_store.locales.entries.Lcz_ViewAll : locales_store.locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: 'b539923c8a6273aecc52adcb54d0bea98acaa547', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: '746541ecb66d388f7a93ba2b16f2baa0f0cb4f75', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: 'a3a890a11034c1bfd88f99cc1a4e63af50764dc3', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '7d630973146f0d572b48cf28b7890779c5ab3219', class: "sheet-footer" }, index.h("ir-button", { key: 'fdab9adb4a222f8445646a66d41bf9636e0ed2d7', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '1ebd1cd4f22f4f0c352d1e0bf18032046e7fc328', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e6a1cccd7a8c2208678d81949e65b6af97cf3a63' }, index.h("section", { key: '3ecb83756cb7e2bdbd519fb9d00826af15815007', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '8d6fdeaae20a32a6a49e0b0f1f1aefedd8bf9997', class: "table" }, index.h("thead", { key: 'b7599964603658449983102ea1514fe20c8403ad' }, index.h("tr", { key: 'ec4c9a5ca2406d8b058a85f85631d36af236793b' }, index.h("th", { key: '6c401c50ea3f3e52f20d0b55d92cdfb5e4be658a', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '4fb55d1e71a50eeaadb7d544d03bdda31e1e7e46', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: 'd06fe48f5da4386a5138642d77dd5a245975cfa9', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '9a26fb82cdf3a0750de46c63031c4a1e3e145aa8', class: "text-left" }, locales_store.locales.entries.Lcz_Role), index.h("th", { key: '15c082f472312d7037de60a71b3c8129f3119586', class: "text-left small", style: { fontWeight: 'bold' } }, index.h("p", { key: 'a78e1900805e3b2a61a4974aa59555a9872a94bd', class: "m-0 p-0 " }, locales_store.locales.entries.Lcz_CreatedAt), index.h("p", { key: '7edc1b3c7d15b179899b9168ad279b5a8debbe1b', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && index.h("th", { key: '9b08f4758e3e5c74f72951356438bb677ddec04e' }, locales_store.locales.entries.Lcz_Active), index.h("th", { key: 'c4ff0e01e0d20d9c0fbc5e2680db3498d074fd72', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '7567cfe8086bd8ff67bb1fa09b4fbf3e6b9b1804', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, index.h("svg", { key: 'cf60cdd36536c453660c502a76f4a89fd43049c7', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '025e34a7cfba491a88dc10bb6d281124036bb242', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: 'f23567c2199dceefd32285f304657b7305208b52' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: 'ac0f874dae293b61b59d220ec4db7158f8c5eb7d', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: 'ee4b8cf84b2be4f4ef2a1fe1e800c2a06ab10e9e', autoClose: false, modalBody: this.modalType === 'delete'
