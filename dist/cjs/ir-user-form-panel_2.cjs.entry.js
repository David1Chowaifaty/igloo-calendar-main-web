...
const user_service = require('./user.service-70ca2d42.js');
...
const IrUserFormPanel = class {
    constructor(hostRef) {
        ...
        this.userSchema = index$1.z.object({
            mobile: index$1.z.string().min(4).max(20),
    ...
    render() {
        ...
        return (index.h("form", { key: '870ee444d62ffaa56317482bca889a82a60c6873', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: 'fd7e036be27c62caeee20d726022f16b95613ba0', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: '2d5abac7fa00c95ef91373a1d51463c1064109ac', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '1bc88656b53bced9bb2c37413f1ac406a0908af7', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), index.h("ir-input-text", { key: '247dd414caaa1feaff215e8812f792c03a2ccf69', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: locales_store.locales.entries.Lcz_Mobile, mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (index.h(index.Fragment, { key: '72107a1ef5d5a3d86940a19529dfc914c87facb2' }, index.h("input", { key: '2c80e1bc46d7987fd79d71c20471d2623ab616ab', type: "text", name: "dummy", style: { display: 'none' } }), index.h("ir-input-text", { key: '6bbbc344bbc0641b77908ca74430f92ddb5fa129', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: locales_store.locales.entries.Lcz_Username, disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username,
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, locales_store.locales.entries.Lcz_Password), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: locales_store.locales.entries.Lcz_ChangePassword, btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: 'c004179cf820c4166be86d77d2d14cecb95ae940', class: "logins-history-section mt-2" }, index.h("div", { key: '28a53b189c3d788c150edc7d20f37eacde60291a', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: 'e7a1b2bfc7d0aa1c37c8ac76742c90ab20851bcb', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: 'fcc6a6d3605ec4e85e85bedf2fed2df2ae7b9940', btn_styles: 'pr-0', text: !this.showFullHistory ? locales_store.locales.entries.Lcz_ViewAll : locales_store.locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: 'ee2f426f656695e5902e3a06cfd370cb173b7dff', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: 'b9b07b19f5cf8fb19c551a1e0c4c1383ff1e340d', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '2540714a44716690dc6ada15f59f75b77bde23bc', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: 'c892aed8976b9e72a2503bdb75a85c5cc5ae1c39', class: "sheet-footer" }, index.h("ir-button", { key: '3c211181008fb1b73644266f1b736553e23a9ae9', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '7e1f5f4c4a3d5b274650ac014d4de26e35f90f49', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4e100bddb2f0621d3e2751d1dacee5239f0e1f6e' }, index.h("section", { key: 'a47bf548847aa9b4598dc578b2d12eb843436ea3', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '023fd3dfb8dadf55c4258a326240b776e4c8b1ea', class: "table" }, index.h("thead", { key: 'ec64f5976f1508d98c66879c54dd23010b42cc55' }, index.h("tr", { key: 'c8d49229128e294d94215d6e494f2e63245ad86a' }, index.h("th", { key: '2876cd82c92b13bec54ac859a8d800917506a068', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '478d8d91acc05a0cb7c1e899d5e38a7b8e589100', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: '4ed41635f43935a4a45c388d50c156ca9717d7b4', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '2210fc91bdc7d59111894c6ee677dedb1702605e', class: "text-left" }, locales_store.locales.entries.Lcz_Role), index.h("th", { key: '21597398acd5ba97a50c6ca5902ae686aa174384', class: "text-left small", style: { fontWeight: 'bold' } }, index.h("p", { key: '7a70081155eec88f008864499e1db3aa86ff8488', class: "m-0 p-0 " }, locales_store.locales.entries.Lcz_CreatedAt), index.h("p", { key: '08ad01e5eec0bf7dbee78f9b03087957fc82b388', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && index.h("th", { key: 'e4e09bea87e373d4a5be8cb547ec1fe2fc074256' }, locales_store.locales.entries.Lcz_Active), index.h("th", { key: 'c413d5cf426e1ac87cb88a5c5430be7165e342c4', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '45c4b0751b01844fffaca4788140a4419632fd6f', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, index.h("svg", { key: 'fa745ee9db948fd9d46cdf590b2aacf0dcf5e856', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '6f36b45e85cb0d32919ca74948b9ee57197026f8', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: 'ae172123e6c84daf1f30392747c9c7bee2fb445d' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: '776d2de8c6046926b69826383ec708a31bb61501', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: 'f302e2d23c018b9283630c7f4595943f6ef9ca0a', autoClose: false, modalBody: this.modalType === 'delete'
