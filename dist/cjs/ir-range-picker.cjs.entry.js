...
const IrRangePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: '62de0e88b67145c9743c51a464e64e45e52f5f28', size: "s" }, index.h("div", { key: '5a1b4a50f409bda259eb696cdab4f27c9945a310', class: "range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: '7e8b32fe9cc6781ce8dd64b92e9af4d6bfb40861', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("wa-icon", { key: 'd6937bd352921abd2d6219c5123ad02df0a2de92', name: "calendar" }), index.h("p", { key: '692600ee80e75b1925fb4758b81d98d87d49eb54', class: "m-0" }, index.h("slot", { key: 'ef7fd01710a16f707bf82a85ee6bd1169a187de0', name: "message" }, "Cleaned on")))), index.h("svg", { key: '9671f064af2735176cdc69ad060ec23bdeb3bb4c', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '0d9f782de30875125f4986e544416f37990e891f', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: '7452c3ca25b19314b9161a72d5e3ceed75a1fecd', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '679458ceef3b8b32c990f586483115c56cada707', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, this.fromDate?.toDate() || this.minSelectableDate, el => (this.toDatePicker = el), {
