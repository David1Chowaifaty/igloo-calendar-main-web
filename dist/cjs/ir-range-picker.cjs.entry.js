...
const IrRangePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd1d3caa64990e3335220bd61fddce882ae60247b', size: "small" }, index.h("div", { key: 'cb690d693fa1cec7ee74910b9d06f1d097b44ae6', class: "range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: '5395ff35d94699e4c437dbd3c223b7721d1c5202', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("wa-icon", { key: '47ebbf16daeb863b5d8094760cf51b908ec8bd36', name: "calendar" }), index.h("p", { key: 'c52ab40beb1d9227918e7758a05c39c50378d57e', class: "m-0" }, index.h("slot", { key: '45d851a9d93e51dc8e69abf5477218e2a955b506', name: "message" }, "Cleaned on")))), index.h("svg", { key: '5ca41a56e75f3def91ab905dfaa435d2d2707c39', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: 'e17811fac59242bd0863fbd9419e561bf2ff1698', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: '4a89757528d4013be2c3f5a65c372abbf2eb1dbc', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'df2f8be732d80ef7027328b4a48aca78b670b50b', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, this.fromDate?.toDate() || this.minSelectableDate, el => (this.toDatePicker = el), {
