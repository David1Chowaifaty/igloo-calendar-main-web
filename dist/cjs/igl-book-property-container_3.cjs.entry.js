...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd5779201077da1cf552c7f3dfca315bcb08dc7ee' }, index.h("section", { key: '7988420897ec0425516e24305ad0510800a84505', class: "d-flex align-items-center " }, index.h("div", { key: 'cbaecb92ed8e77e1e85f5a516427132ec569564c', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '435bf5dde100037bfb9121d7dc64f052f99f560e', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '46b6d6b911e062f57f6ba94987932a0508c716d3', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'a9c08109aa169268197a4e8db26246cc4102d761' }, index.h("igl-book-property-container", { key: 'c14fcd0bbef6937e393b77223dad846c79b9ae9c', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: 'f57f7946733217c22644180cad1705b69d0c124a', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '9f181f2d2d59ae29e419cbaa7023911b6c96646b', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '6d7b1f646c9dec11ef67dc13bc8e97bd6b50a0b3', onSubmit: e => {
            ...
            }, allowNullDates: false, fromDate: moment.hooks(booking_listing_service.booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: moment.hooks(booking_listing_service.booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("ir-select", { key: 'c644da504a016954e9348a822fe0175d516cb011', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), selectId: "booking_status" }), index.h("ir-select", { key: 'aea8cba2285b44344f65637f246856196f60c5ca', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), selectId: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("ir-select", { key: '9094b25e19219ee66b92c7186f5b2f3ae5c989b3', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.balance_filter, onSelectChange: e => booking_listing_service.updateUserSelection('balance_filter', e.detail), data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.balance_filter.map(b => ({
                value: b.value,
                text: b.name,
