...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd76446d5087cc6b13ca10979d86b373ecb8f8d11' }, index.h("section", { key: 'e4fcb0ee2a31e555fa6c5529152191b409cfe264', class: "d-flex align-items-center " }, index.h("div", { key: 'e57f3d00dceaed78b9e029a2698c62f786c71c73', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '178cff315a15c653f85c700ebcc84706a723f6a1', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '3a05098c1d70c7c12d05686ffa2c8e395db21553', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'b3ccb3229b0f731726cd60224d364eb54bdc5e9e' }, index.h("igl-book-property-container", { key: 'a639e3b0b5e1b525bbc02d7635dccf9205acfaa4', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing_service.booking_listing.token }, index.h("ir-button", { key: 'b0c1f2d4956c543549b770680dc108948f0d1ad7', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '7f62e669d07066ab790dabd415931ac6bcdc0623', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '2c54e689b5bee8b31815bac6b856daecf9459494', onSubmit: e => {
            ...
            }, allowNullDates: false, fromDate: moment.hooks(booking_listing_service.booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: moment.hooks(booking_listing_service.booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("ir-select", { key: '78fe4183da5b15b3667520d33d3319d6a29d26ac', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.booking_status, onSelectChange: e => booking_listing_service.updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), selectId: "booking_status" }), index.h("ir-select", { key: 'c2d69117f4637da92d0050cfbea5a3abb16ccb23', class: "flex-sm-wrap", selectedValue: booking_listing_service.booking_listing.userSelection.channel, onSelectChange: e => booking_listing_service.updateUserSelection('channel', e.detail), data: booking_listing_service.booking_listing === null || booking_listing_service.booking_listing === void 0 ? void 0 : booking_listing_service.booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
