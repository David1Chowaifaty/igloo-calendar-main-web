...
function transformNewBooking(data) {
    ...
    rooms.forEach(room => {
        ...
        const bookingToDate = moment.hooks(room.to_date, 'YYYY-MM-DD').isAfter(moment.hooks(calendar_dates.toDate, 'YYYY-MM-DD')) ? room.to_date : calendar_dates.toDate;
...
//# sourceMappingURL=booking-9bb0b166.js.map