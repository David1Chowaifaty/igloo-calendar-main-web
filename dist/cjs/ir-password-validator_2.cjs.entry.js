...
const RequirementCheck = class {
    ...
    render() {
        return (index.h("div", { key: '1bdb48fb0df356b4911c2b9b30ff4a43678b2f92', class: { requirement: true, valid: this.isValid } }, index.h("ir-icons", { key: 'd79f3715c3966f824bc53d4b33f60ca4874018f5', style: { '--icon-size': '0.875rem' }, name: this.isValid ? 'check' : 'xmark' }), index.h("span", { key: 'e8269a42d9059632c558f4250f0332cf7a444678' }, this.text)));
    }
};
