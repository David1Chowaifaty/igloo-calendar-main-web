...
const RequirementCheck = class {
    ...
    text = '';
    render() {
        return (index.h("div", { key: '8f0a56cea42eb095343b4d6b543f8b561b11e0b1', class: { requirement: true, valid: this.isValid } }, index.h("ir-icons", { key: '79b3ddac50b5640f27840a184745e7ef3995ee79', style: { '--icon-size': '0.875rem' }, name: this.isValid ? 'check' : 'xmark' }), index.h("span", { key: '8ee9a018b22a61c032c4012dad11bb089d7b6ac2' }, this.text)));
    }
};
