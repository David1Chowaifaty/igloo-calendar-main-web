...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c8a779bd4b4ed43e888014b8db89f41b39167a37', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '5f3dfe2a23b618f9d93fab904d6864417d159111', class: "popover-title", onMouseLeave: this.handleMouseLeave, onMouseEnter: this.handleMouseEnter }, this.popoverTitle), this.showPopover && this.isHovered && (index.h("div", { key: 'bd4c29d3cae3566099d8002755262ecdb35e6455', "data-state": "show", class: "popover-container" }, this.popoverTitle))));
    }
