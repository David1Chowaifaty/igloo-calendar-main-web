...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4fd9b81cc0b585e238403f30a8d89961345942d6', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '607121e76259102ec87aa2b54d16d5b45e80f502', class: "popover-title", onMouseLeave: this.handleMouseLeave, onMouseEnter: this.handleMouseEnter }, this.popoverTitle), this.showPopover && this.isHovered && (index.h("div", { key: '9df5cddb3d90dd1ca2f9986dadd734d060de7e7f', "data-state": "show", class: "popover-container" }, this.popoverTitle))));
    }
