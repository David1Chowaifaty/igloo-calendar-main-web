...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5bb42026e04b1da64d2f7b29060463181beb5960', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '55f9320235e5261e9b5716548000e6989819265a', class: "popover-title", onMouseLeave: this.handleMouseLeave, onMouseEnter: this.handleMouseEnter }, this.popoverTitle), this.showPopover && this.isHovered && (index.h("div", { key: '1390fe10443342a3dc7bddc1924b429f1c670e84', "data-state": "show", class: "popover-container" }, this.popoverTitle))));
    }
