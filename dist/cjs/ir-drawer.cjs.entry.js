...
const IrDrawer = class {
    ...
    render() {
        return (index.h("wa-drawer", { key: '331452f261602e41ed8c368220585190b51e2024', id: this.el.id, "onwa-show": this.onDrawerShow, "onwa-hide": this.onDrawerHide, class: "ir__drawer", style: { '--size': 'var(--ir-drawer-width,40rem)' }, open: this.open, label: this.label, placement: this.placement, withoutHeader: this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotManager.hasSlot('header-actions') && index.h("slot", { key: 'aa27a22f10aa29f044c835d6ee6f6f36cf5dcf27', name: "header-actions", slot: "header-actions" }), this.slotManager.hasSlot('label') && index.h("slot", { key: '67cc3f5b5a5fce3d069859e254f98cb9496d3c2b', name: "label", slot: "label" }), index.h("slot", { key: '0c4851d82560dd335e4168a16c530aee78aa966a' }), this.slotManager.hasSlot('footer') && index.h("slot", { key: 'd0bfa98d05a3747473fc719edf3d916adec0af3c', name: "footer", slot: "footer" })));
    }
};
__decorate([
