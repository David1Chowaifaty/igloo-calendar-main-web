...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'd6ca31a2ceceae4ecb00906e76000505563a07b1', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'ee2384237455e7cffa79c57b48dd478c5c33aa48', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '17bb119b068b6e8e0ba5a9f45caba0cbda796012', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: 'b6c955627c650dd410b823bc3c00d7f74e724afe', class: "app-drawer-header" }, index.h("slot", { key: 'b746a52c940367003fd369d34acec2b512b31db2', name: "header" }, index.h("h2", { key: '085a725d619f529af583392c1abf3601a93cee86', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '8fb2e583eee65e9a040fe565d53ed242c0af1b77', class: "app-drawer-body" }, index.h("slot", { key: '3f4e1a3a2a3fbcc5e61811e6107fb8150bf044b9' })), index.h("div", { key: 'be247810d1dcbb049a69279377d09011ff3f04f4', class: "app-drawer-footer" }, index.h("slot", { key: 'bb2299410f245d07a83ff3acc7a57d100fc38721', name: "footer" })))));
    }
