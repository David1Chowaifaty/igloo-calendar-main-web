...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '8f4afc82fbb0099e93e4b7f1391bd44281fccc7d', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '43d2ca90073fc5bdc9d992a18ba5621b9fbff907', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'bb52647b02553ec295b7e7409c25683d91805fe5', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '5a86613d7d5a3f694871ec7f182c456f461b267b', class: "app-drawer-header" }, index.h("slot", { key: '410932cf617316d2f50702ab4890de0709f41700', name: "header" }, index.h("h2", { key: '00a660842e69831f8c8931f088f48d8b4f28e6ac', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '3c0ebc839985e518fd602ba6b9788222d540a545', class: "app-drawer-body" }, index.h("slot", { key: '79dbaa998c2657f0c3bfce1ab47f1f790ed4ee45' })), index.h("div", { key: 'a6d52196f59822c58b5993b33ee7b302fb64c7a3', class: "app-drawer-footer" }, index.h("slot", { key: 'd51445f17ccb9018c0cc7e980840723d1dbc71bd', name: "footer" })))));
    }
