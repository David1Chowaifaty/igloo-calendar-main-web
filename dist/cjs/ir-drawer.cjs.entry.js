...
const IrDrawer = class {
    constructor(hostRef) {
        ...
        this.drawerChange = index.createEvent(this, "drawerChange");
        this.drawerCloseRequested = index.createEvent(this, "drawerCloseRequested");
    ...
    render() {
        return (index.h("div", { key: '36125a8d73d0691b58728ab004d3c273932f34b9', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'd6550f45af2e752bfa6d23a219e4ca9468fec778', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'db31610cabeebedc1d8f6cff2e4467227c131a1d', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: 'a96a8493725d78148b3c79b730fc39e51859635b', class: "app-drawer-header" }, index.h("slot", { key: '4e03da5feb1883f6d43483fa40136148372f0a7c', name: "header" }, index.h("h2", { key: '5d20e621eaf4299f4710b49faab38103e9b026ac', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '54af734239add147d354d8523a02c0775204ba77', class: "app-drawer-body" }, index.h("slot", { key: 'c716ccdbffe2849fc71bba96eda3bf7dc76e720e' })), index.h("div", { key: '7937364e84788ae907b6f77e254f9c57f4b9fd64', class: "app-drawer-footer" }, index.h("slot", { key: '84fff7d0fded1cdd167870f75615456a7d87c140', name: "footer" })))));
    }
...
//# sourceMappingURL=ir-drawer.entry.cjs.js.map
