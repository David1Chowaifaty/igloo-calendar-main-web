...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'd41910efa025a46995aff547608ee4cf1621afcc', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '8f4b3164e1d8de6cec8d539eb8523191a86a2c6f', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '96e7b416be847f0d512e1ebf638c3e3df60bd1fb', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '7980b71bf9a5bd4a9cd366f1eb40ccbdab1e038e', class: "app-drawer-header" }, index.h("slot", { key: '56c3332162be4b51d17b51de27ab7f6d27a125b9', name: "header" }, index.h("h2", { key: '1cf523154a81309dd4fd83e3e6d6c7b8f952120d', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '80e904cf49dc41774aa404e56b99239a3f8515b7', class: "app-drawer-body" }, index.h("slot", { key: 'b7136b6519e1a0a54c2629ba94ffcdd165ec4e72' })), index.h("div", { key: '77e4ee1f9ddd2ae35aebab0c009859d9e89329cd', class: "app-drawer-footer" }, index.h("slot", { key: '936cfb41a42f9d75d367cf2b7b7966d5e9e2bdf6', name: "footer" })))));
    }
