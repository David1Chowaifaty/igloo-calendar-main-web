...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '6d75cca18c9925adeff174e34469ecf31d0f115f', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'b74301bb0f25a4f09d4ca37a0c94fbd186691a78', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'dcc2b25e26254d019e9a7b651ee4758ddd5c342f', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '20caa81d8cb4bc302820ebb8e5308af679de800c', class: "app-drawer-header" }, index.h("slot", { key: 'c25cd1aea11815882f3512744bffce0fb15d9b03', name: "header" }, index.h("h2", { key: 'f4bd549f1d7a17fc4f2d99281ae0d692704f08b2', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: 'b3a341ea1341beeec6d1a03c88e374568c35a6d3', class: "app-drawer-body" }, index.h("slot", { key: '63173c1f292e47e9f7426f7a6d86769df73881b9' })), index.h("div", { key: 'd1d4de4252ba5be6b9506a06d55563fb2f1fc6fc', class: "app-drawer-footer" }, index.h("slot", { key: 'ff400a7efac7122320e8cfb052013fbeb42905d5', name: "footer" })))));
    }
