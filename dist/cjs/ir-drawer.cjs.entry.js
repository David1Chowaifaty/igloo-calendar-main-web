...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'e1f9ab52b5ff9024d30c488017c0834db26f5969', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'cfcfb801ed534bb45d6360c40c5365048bedade0', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '53e68588dc860e1e111fc2a16645cba12990fc7e', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '4de6db3d292414f344f56c6e4435d9ce2158563d', class: "app-drawer-header" }, index.h("slot", { key: '10a6f9d2d2ba616ed5d13ec6bd821228963b3f94', name: "header" }, index.h("h2", { key: '0e5cb4c864c89d9e45530b8368b5da5d3cf0c807', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '6f5c37a0af69b055ab04a90c95a5127fbde5ede0', class: "app-drawer-body" }, index.h("slot", { key: '4681d61d74c5258c081471ccd402fc5477728d2a' })), index.h("div", { key: '47b79974ec15e0e303ce075fc994f0ac8283170e', class: "app-drawer-footer" }, index.h("slot", { key: 'd0a4ca09b23ee0a801e1a4896d71d2f950866a8b', name: "footer" })))));
    }
