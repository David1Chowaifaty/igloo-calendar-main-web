...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'a7a4dc3dcf311876754ccaf231d5b254b2a71325', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'b3f50ff3500ea7ad4b34d3a377a3c93fd8b25583', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '1ccbce62337204930dc177f9db7f3481b871b922', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '39ed90a4e694f97999c1c3d86aaf1e95396723b9', class: "app-drawer-header" }, index.h("slot", { key: '13ce2b06260c0d09bcf3af435f231db6a7021e74', name: "header" }, index.h("h2", { key: '9b1abff8a85a6b9ba1d3f83b84a8cfa341471d62', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '2016d93d60737ea0e4a05040473b36d3d2a6744e', class: "app-drawer-body" }, index.h("slot", { key: '9d26f9a63f31d6ff9b659dc62fb5045e64ae80d6' })), index.h("div", { key: 'fe55b7fef7669a9c25c3693a2ac8ae752bc9a465', class: "app-drawer-footer" }, index.h("slot", { key: '543e3ec1e64a6735a0b681df270897d14afbccb3', name: "footer" })))));
    }
