...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '77fa4241155f54a436d0e550d8bad4f5efd2eb40', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'cfa82aaf1057c9af55afdc121b4bec654cb18167', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '4c317d7c657aa4845246e28b7b6b9bf6bf26378e', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '5fb34af808b89b9124234481a7888ba1bbdd683f', class: "app-drawer-header" }, index.h("slot", { key: '7b95b39726a763821963b7c01216ca9febc2aa12', name: "header" }, index.h("h2", { key: '49ad46863d81e9a24b649376280fd9f78e5ded46', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '9422a61e072958781146f65be20c0726f552321b', class: "app-drawer-body" }, index.h("slot", { key: 'a33a5afda6b93113d0da008b6bb4332292134962' })), index.h("div", { key: 'baed5e0cb8fb0459ff6acd1bd50817cb6e3c0355', class: "app-drawer-footer" }, index.h("slot", { key: 'b7b500f30f88121cb07f0c9e7f8c5b6633fbed09', name: "footer" })))));
    }
