...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '7b06351e95a738a4ce9174921d8c3113c8225ce5', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'd220ef018c74ade18bd1ac5a42be37aa3d935acc', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'c9ad137c816240ae3472725fead40528303fe1fc', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '50156c322d5ca7a1c62c3a65af74abdde82c991f', class: "app-drawer-header" }, index.h("slot", { key: '07bd51dbcdf3177059d03071aa6e8b123751ee8c', name: "header" }, index.h("h2", { key: '043eb64c35f7ebfc7e61128a37fe4ef56e456f1d', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '06d557859a021c686b17efd7dbb19d4285f63bd5', class: "app-drawer-body" }, index.h("slot", { key: '2ae66bba90b956d208673257985e2fc3135e1fec' })), index.h("div", { key: '7c58d8398b33055bfed160291a0eee47c7d2aba8', class: "app-drawer-footer" }, index.h("slot", { key: 'a4b293091c799976d4083ca54fb36f5abf907f1a', name: "footer" })))));
    }
