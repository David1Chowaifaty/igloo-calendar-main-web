...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'e4fa8ca6f0c4d3156845f6d2cb0a73eac8b3efcb', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '4538daa72e14293e54b98bc92c7b3f16b26b2889', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '41533720c8021dd4adf76bb6528ca5f92f8f12e9', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: 'd837e7496475fbb8196b55a0e92f65ec1df5fb9f', class: "app-drawer-header" }, index.h("slot", { key: 'c846866543958df9cdf89848bfcc43b43f3b8ffd', name: "header" }, index.h("h2", { key: 'caf5bfae7e53d0b269262e47ee18429aaa54757b', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '8f7298e973476704c9c5af2799c9c26e3c4e561d', class: "app-drawer-body" }, index.h("slot", { key: 'a4dd4218581b6f0e40431f10ca7f6bcd7ae42e06' })), index.h("div", { key: '1205914f95e6d4ae74b9f7dca658584a70f704ad', class: "app-drawer-footer" }, index.h("slot", { key: 'd6ee6d406bde06d8b133db18654ccaed5a12110b', name: "footer" })))));
    }
