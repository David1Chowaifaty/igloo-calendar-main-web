...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'e155e84c44f8755ad2cc78f1ae672f6da1bdf000', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '8162f70985559e1f100c6e38dcae0091fee62307', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '3142488bb676b70cfb6b27b12682c5e1a88edcc5', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: 'a02beea96fb6c07295997157940bf906eec65e45', class: "app-drawer-header" }, index.h("slot", { key: 'b5dac8bab39197b7d4ff8eb89a9c8848420c9226', name: "header" }, index.h("h2", { key: '32a6b9df7ff34e788f32156c33fddc01dbf13f55', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: 'b07ce18835158ce976505cb5957698a7b7a24ce2', class: "app-drawer-body" }, index.h("slot", { key: 'b037d5100b1ae9f487e58225dd5e94dc1e2d8f6b' })), index.h("div", { key: '9f4dad9a998e7e599f2b7a12496c6df23d0d8816', class: "app-drawer-footer" }, index.h("slot", { key: 'bece8342354444d8b543b145bc8ba2d2d2554510', name: "footer" })))));
    }
