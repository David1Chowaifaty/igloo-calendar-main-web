...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '7bffd4ced0d0a0e028441ea7ff811eed9b234838', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '66b2d2b9329d0ad10daecf5ff6f404f8a6cef509', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '8136374e36e10d41c79d2b8e034478fd95782e3a', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: 'dc355c626ccafcc073b074e56fd14b1519143566', class: "app-drawer-header" }, index.h("slot", { key: 'e8a593e768bcbd2f9ba8843db756553d246ec82c', name: "header" }, index.h("h2", { key: '9f81136f0188c8f50a3db6378f3c4579058091b0', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '85786cf9b3cd40d17bc70f8d9bededb27d59e504', class: "app-drawer-body" }, index.h("slot", { key: '06e5b2e6e41e143f4a100e377d2f18324506c3fe' })), index.h("div", { key: 'fa5cf28b302b379bd0f8fb668b99d03364007b81', class: "app-drawer-footer" }, index.h("slot", { key: '13ec4551e0424b91cdba9a5f954ef33e5fd03c29', name: "footer" })))));
    }
