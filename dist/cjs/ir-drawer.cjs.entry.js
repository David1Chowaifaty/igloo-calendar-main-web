...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '68dfdd655a5f2fb5544a6069729de125e688f0eb', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '63e139f26950a09901e21f2b3b76ca23e185a508', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '0e456fdf7380e9fa6cf7f500df97c0168416eaed', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '88d7ddee1d2dee483468968802f33e9df7471ddf', class: "app-drawer-header" }, index.h("slot", { key: '6a78e87e5c9958a302c21f18aa87bf6abcec10cb', name: "header" }, index.h("h2", { key: 'ad69b9b95312d1a6aa6d71c214728a6977a6b8ff', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '0ca0214deed96044348cbeeb1626f019766d1e23', class: "app-drawer-body" }, index.h("slot", { key: 'f9505b35ce47b5f7fe5211c03dde40a17f049cc2' })), index.h("div", { key: '77c9de62b4dd08d01cefef75a2daa1702dd881c9', class: "app-drawer-footer" }, index.h("slot", { key: '8261fd48eed415418facfbdcf33e80278de7359d', name: "footer" })))));
    }
