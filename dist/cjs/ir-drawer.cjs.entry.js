...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'e5befd021469a822d7663cebf46458938e52fafc', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '5e437cd0fca91a6d98fb63339f6b214b49ad440a', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'f45bc219ebc8450cb6178e11578e542ad2c7b851', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '2c7af3525c15cf032255694e20793198365b43bb', class: "app-drawer-header" }, index.h("slot", { key: 'f4b0c373a81b2a6a2f7b8cbeb18f67503b25061b', name: "header" }, index.h("h2", { key: '2d7f8198dad1beab916143d80dcfaa7baca5985f', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '006de2ac2438446ec0da08b0f7b35620cb4a2e0e', class: "app-drawer-body" }, index.h("slot", { key: '3bb33375095ae9fad6bfce9191576e661d082748' })), index.h("div", { key: '057dfc36d1867d83966f5e2d82cf7302c9e5416d', class: "app-drawer-footer" }, index.h("slot", { key: '5f5cd8b1a1afaf3b4cf30e10e236dc6168d49f7f', name: "footer" })))));
    }
