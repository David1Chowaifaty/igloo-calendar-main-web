...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '9e93b6e2dd75d89d74d579f114c25a2606e3ef62', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'b6751c4fc967ec71f76a3d38cfc12ee6a14577a0', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'e7b4dbce6df8b3cdf32454e3cdaf8c27173e91ab', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '1553d8e99cab5a8bf0a31021a7b0bba705ac5699', class: "app-drawer-header" }, index.h("slot", { key: 'deb5ef5f1f9fb60c43ce212d63400e0554251bd2', name: "header" }, index.h("h2", { key: '82c47ff928e8c6dff29167b44393d1324cb4d09f', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '3f76db443111d6dae39a8af44edc9e15b5de28bc', class: "app-drawer-body" }, index.h("slot", { key: '50c6aa7099ee0b4cd4e11a413f8cf088c90395b3' })), index.h("div", { key: '49a58c984ce13bfe5c99711180303dd92ea587d4', class: "app-drawer-footer" }, index.h("slot", { key: '75cdbe4eb3ddc35bd0b174a7da6ff440c7d7bf40', name: "footer" })))));
    }
