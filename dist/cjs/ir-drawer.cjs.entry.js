...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '235b45572b551dbfedf346b6e15c15947e108eab', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '17f8ccb74f8cc2e80587dd3fa27250ed74f0cead', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'ab4cb2eab5e960674143d1028bc1c6c054015c50', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '6d9ba8b95af2a6e83df71d0914e1e4fcd796669e', class: "app-drawer-header" }, index.h("slot", { key: '343abf584975ecc7be3e74e926331e825eac4721', name: "header" }, index.h("h2", { key: '9c687c4c4bf87fbf893debfef7ecebad96885034', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: 'e3a7a7567b9205cf26b2e5334eaeca3da497598d', class: "app-drawer-body" }, index.h("slot", { key: '8fe51213ea609cfec34179a346b54648868c7829' })), index.h("div", { key: '1c3b9dc73e2caf2718417e64cff0f12b5927f051', class: "app-drawer-footer" }, index.h("slot", { key: 'fb9fe7cc5e8ed854b52cd4593143f5e96778c66c', name: "footer" })))));
    }
