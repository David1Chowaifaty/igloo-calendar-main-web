...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '4b71a6532420c1614e1aedec6fec05bed680d9e4', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '0ad109b273b0548215954063e87716b0916e62e0', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'aece75d1656766cebdba78e1c37884408e515f8b', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '14b096d334328ed4bf16e7c5434ab9515c12d13a', class: "app-drawer-header" }, index.h("slot", { key: 'd48743eeed2e6731091dc399ab986ebf1a82c63b', name: "header" }, index.h("h2", { key: 'ed7b37d307ac719da93d1ba915725c43abff32a9', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: 'e1292c685dd2c25873cfef1e6c0a46a6dfa3e058', class: "app-drawer-body" }, index.h("slot", { key: '66db6bb3de30535202d1395b5a92aa5f6f86cc04' })), index.h("div", { key: 'b391fe8d8caf3ecdcafb128bed965533290c6c1f', class: "app-drawer-footer" }, index.h("slot", { key: '341af02d0547b3c1fd9f5babd87d549f981ded6a', name: "footer" })))));
    }
