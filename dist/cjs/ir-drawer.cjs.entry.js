...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '6fa0daa661cdf09c53d287a8dfe83776fd99e8a0', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'edbccf8a860b0311dce554740837f2f2348c34df', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'c22163bddd6cca0c322cec03354bcf2015b234af', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '6e0e94a49dbc04e1273f8b7195d2a1e715463afc', class: "app-drawer-header" }, index.h("slot", { key: '299aff5ccff4aee017e327db86b00042932ead1f', name: "header" }, index.h("h2", { key: '7d45f987709dbae68412f9b8e2c03c2eccfd8e34', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: 'a938cd1d3770073e0e0af6caa0769d16f657536b', class: "app-drawer-body" }, index.h("slot", { key: '1e2d1f93c528f6136823afd9dc0bdf6686c0345b' })), index.h("div", { key: '595f01c93cfa26175a4e218cd0e5aa89140fa90c', class: "app-drawer-footer" }, index.h("slot", { key: 'aa85b8cf97c5abe61d2d75298201f63b5cd2f39f', name: "footer" })))));
    }
