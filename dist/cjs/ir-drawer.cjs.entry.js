...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '855db4409fb38e7372411888cceb327e8bd07221', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: 'ba31fe92e2aaf8d4d1ce3d098f7cc8d8b53926a2', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'ab9fb99bccfc35051063d9eeacd059a623108d96', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '25ed806d99107138fda95abf1044d723da03f8ce', class: "app-drawer-header" }, index.h("slot", { key: '6d76240988ada6190afcecd96641de096fd51bf5', name: "header" }, index.h("h2", { key: 'de070e53770ac798e7f82bc6a61fbe27583d46b7', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: 'e9ee819a21293db9613564dc1da71040cf29fce4', class: "app-drawer-body" }, index.h("slot", { key: 'bfeef7dd9191336df02c053437a1e30eeb2133aa' })), index.h("div", { key: 'ed637e8be64a20a8c68703db9dbbefff3d8dc1fa', class: "app-drawer-footer" }, index.h("slot", { key: '55b86a3844b9cdcfb899486a60aa62dc82a863cd', name: "footer" })))));
    }
