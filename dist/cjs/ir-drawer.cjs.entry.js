...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '279eb6768cabb31c439e86a60f4eb42306920915', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '8bea035165802addcd18fb9ae76b25a80970f6f9', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '9dc66f1e5150f9e1fbb1c404ddc416d37dee2f99', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '3b7d119939a3f70a8117ee73f40f012b535b247a', class: "app-drawer-header" }, index.h("slot", { key: 'cc65ae1b283860ed7c6640c5acc58c6b92585853', name: "header" }, index.h("h2", { key: 'b13c8b691eba6e52c51428f156ed5342a707ad7b', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: 'f48cb64df0c636392727bd18ab7b77317d5a0f2c', class: "app-drawer-body" }, index.h("slot", { key: 'd6eed2c6345512245c7a538a0b6ef328198bc83f' })), index.h("div", { key: 'd3a7c82c539ef5afcf59e4c8f0f3cf5346392d1f', class: "app-drawer-footer" }, index.h("slot", { key: 'b0eb54eb8e3021cb280b493a6ae08c772d739bc4', name: "footer" })))));
    }
