...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'b954aeba2b57d3ca1ba7643ed5a0fa6cfea608f8', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '5486a689e8b61db5ecaa4924b1b011bede85b786', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'e61d2faab1289bed0e6e8096f6a390df362773bc', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '1965d28b1d82ab9d731208e2fc88ddefe000cb2b', class: "app-drawer-header" }, index.h("slot", { key: '9cb3fff1f2f68da37437b6a843f6aee0f0e26007', name: "header" }, index.h("h2", { key: 'b0d6ef74d48fb89c7fbc2ff94bf237be9b1a745f', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '60aff3c01587c5a15300188d2e02fd69a3e3f34d', class: "app-drawer-body" }, index.h("slot", { key: '26e536920892be9afe209eac446c9a6866afbcc4' })), index.h("div", { key: 'b19fad1bf743ec64af104871e91c392587ce40aa', class: "app-drawer-footer" }, index.h("slot", { key: 'd50059917dc7e3f13c2217ac3d67170c46d4d372', name: "footer" })))));
    }
