...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '85ee237519df0e0e20e4c5563f8ca96e5c7accc3', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '1da000577bdbfa988b8f6d2e9d1c2957e8b9027d', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '2bfe723edeef881bb2cbc65a946b5d5c466a908f', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '844cf2135f7b522dde55cdd6f61898f1764bdea3', class: "app-drawer-header" }, index.h("slot", { key: 'd4d33eae6330d5ba9cec4b928351605ae861e542', name: "header" }, index.h("h2", { key: 'bc0ebca9c33c8a55ef29c69b9e1e457e12e3a625', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '64398175ce248699ab21052f2103f8df0bac4cf8', class: "app-drawer-body" }, index.h("slot", { key: '7b82e74290806cb3f18a452a567e57dd18a29796' })), index.h("div", { key: '104c8fe5f7f239c09d0c8dcd2b3089528bd2b709', class: "app-drawer-footer" }, index.h("slot", { key: '29417e2e24164009e6d2e6238a1b5d64ac6af205', name: "footer" })))));
    }
