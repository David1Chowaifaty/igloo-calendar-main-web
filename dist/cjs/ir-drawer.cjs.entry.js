...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '67c92ea68f135db9d054e06f79477a4fd23dae08', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '224364258b46b915b4a12ee597b38b317f6e4477', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '6fd506b07700f5db3b86f049fc20db8fbcb8d1b1', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '51f1c5052bf853e7f19bb6f35aa260c433606238', class: "app-drawer-header" }, index.h("slot", { key: 'd67aa86e3452ea1f1fb914ce743df6db4f240756', name: "header" }, index.h("h2", { key: 'a4d9dc3727bbcf54f9e8c1ac977bb59b1b723d2f', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '989a576ccfe3e5d7c193844f501dc405320d56c8', class: "app-drawer-body" }, index.h("slot", { key: 'ae6d643098a90312dbf825240506d8b684b5da96' })), index.h("div", { key: '54fe5f3f065166c9a48e1d7ebd31aa1ea8fb2385', class: "app-drawer-footer" }, index.h("slot", { key: '91ad6d9bdc8865008dff6c713b7db883002837dc', name: "footer" })))));
    }
