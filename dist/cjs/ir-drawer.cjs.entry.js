...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: '9fb85a2092baf81ad24b2eeb4a36e358ad860d51', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '9a187dc4dbe0dde056b0db077ac1eb2ada3e7a4a', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: '9626874e45ddd5103df3e830eb35222ede52cf79', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: '0dfca719699d15f46db71eb2358e9cba999955ab', class: "app-drawer-header" }, index.h("slot", { key: '8fd6eebf6b183cf60a52568abd778936bed552de', name: "header" }, index.h("h2", { key: '6d06427e7ceffd461ddde88e5df0522d2bc8c824', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: 'db504b705a434a04e645e5c5f83f40e0ecd5132d', class: "app-drawer-body" }, index.h("slot", { key: '0e6717eebef2f1b6cf190e3575694f741e2f8680' })), index.h("div", { key: '2db39c297d865743195db28e2aa90e4002cd112f', class: "app-drawer-footer" }, index.h("slot", { key: '28f5916a59d7dd09ea033dd21de9aa096c2d0069', name: "footer" })))));
    }
