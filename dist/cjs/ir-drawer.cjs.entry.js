...
const IrDrawer = class {
    ...
    render() {
        return (index.h("div", { key: 'ba623ace972da234587b4a9d40df88d4f4242174', class: { 'app-drawer': true, 'app-drawer--open': this.showDrawer }, "aria-hidden": !this.showDrawer }, index.h("div", { key: '6595eb0654c9d1cf9ebc370ff1cafa3658151389', class: "app-drawer-overlay", onClick: () => this.closeDrawer(), "aria-hidden": !this.showDrawer, tabindex: this.showDrawer ? '0' : '-1' }), index.h("div", { key: 'f6ad26413c00bc87e1739fb271c1c0bf8a05820b', class: `app-drawer-content app-drawer-content--${this.placement}`, role: "dialog", "aria-modal": "true", "aria-labelledby": "drawer-title" }, index.h("div", { key: 'a4fb4b4d999bc1ee55ae74d1f233c275a61166d3', class: "app-drawer-header" }, index.h("slot", { key: 'd8333755a51100f58992ab432516415d122faf64', name: "header" }, index.h("h2", { key: '427cf3d45671d6c55dfb5dfe60006dafd86b7c0d', id: "drawer-title" }, this.drawerTitle))), index.h("div", { key: '3ecf6bec1d13874bb613059f086f5a667be016f9', class: "app-drawer-body" }, index.h("slot", { key: '16c7abed24987587298a0b9361b2cf9ae0bb8703' })), index.h("div", { key: '7e2af3572c03e07907e8c46ad9c537c75464dfeb', class: "app-drawer-footer" }, index.h("slot", { key: '7bce35d2e594df542a678af53dbe9ddec87ab0eb', name: "footer" })))));
    }
