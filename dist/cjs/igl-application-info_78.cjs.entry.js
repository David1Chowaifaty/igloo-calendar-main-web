...
const IglDateRange = class {
    ...
    renderDateSummary(showNights) {
        const fromDateDisplay = moment.hooks(this.fromDate).format('MMM DD, YYYY');
        const toDateDisplay = moment.hooks(this.toDate).format('MMM DD, YYYY');
        ...
        return (index.h("div", { class: {
            ...
            } }, index.h("wa-icon", { variant: "regular", name: "calendar" }), index.h("span", { class: "date-range-date" }, fromDateDisplay), index.h("wa-icon", { name: "arrow-right" }), index.h("span", { class: "date-range-date" }, toDateDisplay), shouldRenderNights && (index.h("span", { class: "date-range-nights" }, this.totalNights + (this.totalNights > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    render() {
        const showNights = this.variant === 'booking' && this.withDateDifference;
        return (index.h(index.Host, { key: '0bebafba8d7aa998122d7af59c3324809f221114', size: this.size }, index.h("div", { key: 'b060dc3cf93adfe1166e85a9a62444b0ddd8cffe', class: `date-range-shell ${this.disabled ? 'disabled' : ''} ${this.variant === 'booking' ? 'picker' : ''}` }, index.h("ir-date-range", { key: '3a3f18d202b80537d71442d1ebc408e7e085e87b', maxDate: this.maxDate, class: 'date-range-input', disabled: this.disabled, fromDate: this.fromDate, toDate: this.toDate, minDate: this.minDate, autoApply: true, "data-state": this.disabled ? 'disabled' : 'active', onDateChanged: evt => {
...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a3e23c56889ddf64a7348593c02e8e3f62ec233b' }, index.h("wa-radio-group", { key: '5cf8552dd9a3c8ccc72a9d226fc5a0216b2f29d9', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, index.h("wa-radio", { key: '0a4bc45009df4ce144b571acd253d913317f5cff', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (index.h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, index.h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), index.h("wa-radio", { key: 'dc34788d44255845f9d3c7816957f5ebc6f260eb', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Company')), index.h("ir-booking-company-dialog", { key: '7682dfaf293ab5b8d93a0d8b3dc1323ff97a443a', onCompanyFormClosed: () => {
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '04622450839f0d5b381ee6f991d9985c661dbae3', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '02f9882bc57ef6738880b4f3c6a122e231de099d', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: 'd6ce5282066791c606f3f88a29067b0cf81bc9dd', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-input", { key: '921dcb80f219a4c9048482583610ab3073b0d093', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: '2a23222f1130f4ebb846e9bac90e09fe8d480b13', name: "start", slot: "start" }), index.h("slot", { key: '05c9db3726d8caebeb19fe6bfc1e10a346104bf4', name: "end", slot: "end" })), index.h("div", { key: '95731bada7a6b753e3bf23bac8ff6164c8af5b1b', class: "picker-surface" }, index.h("div", { key: '5eeeedca720ba40848ab561ff99c7afc8824b128', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: '6c88b3103d8dd9132e1b48a0a44d78a135c0ab0b', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9815647e30b2de7cb3a7cef49114d33eb5152a91' }, index.h("input", { key: '6b18bc8f4f03b906aeb068221d50f20dbfe1599b', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '6b1fe59ecb342ce385be67f6db621b4d2b4cd040', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '9bfb9c653e041dc0454ad21430fe34b17e7ec80b', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '9a7ccc75f56c7bc9c86c69e84dff9aad1e3d59ac', name: "label", slot: "label" }), index.h("slot", { key: 'e647c74bcb7f76759db92fbfe8554915794ddf6f' }), this.slotState.get('footer') && index.h("slot", { key: 'ba01f2066a1a7b79815ff675448d01dc5f5fb201', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '1c4d3b088ae9cc44fed33cac64ecccefc8612c0d', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'fa0d64e546fb969313c498e5531ddce223488dff', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'a45c3a8a3f534b3cdb5e35518c0bdc34a3232734', class: "picker-item__check", name: "check" }), index.h("div", { key: '1a350a6cd5c83f3a4ae346704710bf29f3cc7ecb', class: "picker-item__content", part: "content" }, index.h("slot", { key: '27148a59e0b83164130d9cee8dee17f151ee1c03' })))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3cbdcc81954b6a878db91002ae5ba729873ffd79', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'f6a3cf3bce6bd3f52fb16727084072933cb97101', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, !this.hideDefaultAction && (index.h("ir-custom-button", { key: 'fd84a753207e98e35258c41c645a65c18dab78e6', size: "medium", slot: "header-actions", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick, disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'b9171722a304636db6888ba448180c51f43944f8', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() }))), index.h("slot", { key: '4dfa774218229b3aacb38287b5e0977e8d9596d9' })));
    }
};
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7d706742edccaad93d9c3de0e420f07a2caf01ef' }, index.h("wa-spinner", { key: 'bbbc1322613045ec89eb25de085c1f629790c61d', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'abce64e81d4c3d884aabe4bd6b42af8e96060c1e' }, index.h("slot", { key: 'ad307291bbd7e8f00d2faac0ac8d3d7868cd8914' })));
    }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_78.cjs.entry.js.map