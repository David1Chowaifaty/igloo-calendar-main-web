...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ab07205580ddaced3ab0c33fb63f7696bfb44d13' }, index.h("button", { key: 'b6f0a3cf0ac32767d0adc2b64b9d6e8b2f0c47f2', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'fc60dcb34e922ba1d25ba404b4afd8462e2bfc6a', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '9106ced01050dd357387f1be719608e44a8e0310', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: 'b64ea17f87dddb6e6fdb2773764f5ae7a9832155', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: 'c0df10007e9c6c15fb5891435ba494b8fdd4fc79', htmlFor: this.checkboxId }, this.label)));
    }
