...
const IrCheckBox = class {
    ...
    render() {
        return (index.h("label", { key: 'a462396ddbd339304627e3371f99731644c51f99', class: `check-container ${this.labelPosition}` }, this.labelPosition === 'before' && index.h("span", null, this.label), index.h("input", { key: 'f209d09e9c82646fb093bcd8351b9859c0e935a8', type: "checkbox", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, onInput: this.handleInputChange }), index.h("span", { key: 'd7b3f7df759245142122b8a6588f4411147ea43d', class: "checkmark" }), this.labelPosition === 'after' && index.h("span", null, this.label)));
    }
};
