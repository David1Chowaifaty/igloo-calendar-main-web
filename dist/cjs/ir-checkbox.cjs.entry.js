...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd76666ca84d3bd307f5ffe42a85b93284ca018b4' }, index.h("button", { key: 'a22944c4dbe6c50af1818d0493808458ebcafc3a', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '479fb6a2f4286576643c8f9bea188ade217021f7', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '9e71849a093718f7b1f21e2f2e0878aed4aefb83', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: '2ea64e6bfba94643162a2c609de011eb9535285d', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: '2ce259e5a7562f254948a3c9341b0f65530919a8', htmlFor: this.checkboxId }, this.label)));
    }
