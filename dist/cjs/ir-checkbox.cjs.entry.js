...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0be954a1e54e05fb1e4d4ed8f2963e0671c5af7f' }, index.h("button", { key: '564d2e0a14d6cee4b47be2a1ce092a4af6415e87', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '7df2cf3605b93998a8a17edeabfa5844c3494fb1', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '066951c35ee0eed0c1b6031e9a694b21ae94671f', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: 'ead77ad67f2ddbd493fa6cb54563b8495dd85605', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: '1c03b61a5666b4ec504da5b65d834938600f6871', htmlFor: this.checkboxId }, this.label)));
    }
