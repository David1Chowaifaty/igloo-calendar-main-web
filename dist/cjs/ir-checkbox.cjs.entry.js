...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd967ee1d0101a840c1e3e6a2ccfc0ed71caafdea' }, index.h("button", { key: '05658ad74a001fff0ef1d6f24a7d985bc1adbfde', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '8cb8746f174e95d5ce51a6e4aaaaea65b40216cf', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '3789f5bee1d17440b73b1f4c091804b0c69f6bf0', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: '7bee79b85b2287fcaebcd28bb98fc70f50ff7b06', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: '01c406f83e8e765f6b132e169de3e0314be4e9af', htmlFor: this.checkboxId }, this.label)));
    }
