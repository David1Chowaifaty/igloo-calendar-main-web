...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7aff7fceb092406558d291fa1b7415bb06533ed9' }, index.h("button", { key: '075463bb264eba3ffdd64a38c85a2e03c91e029f', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '533de7ad682c6ed56d7b00ee6d2c3cd5a46fe628', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '134a07012d820fd475c3a686501111dab7eb9897', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: '724b5234eef015976692bf9bd3af35b0724970a7', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: '4654ea791bf73af33ae0d268f4c6ebd58d9b8b7e', htmlFor: this.checkboxId }, this.label)));
    }
