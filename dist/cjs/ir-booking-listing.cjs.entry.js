    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-interceptor", null), index.h("ir-toast", null), index.h("div", { class: "p-1 main-container" }, index.h("ir-listing-header", { propertyId: this.propertyid, p: this.p, language: this.language }), index.h("section", null, index.h("div", { class: "card p-1 flex-fill m-0 mt-2" }, index.h("table", { class: "table table-striped table-bordered no-footer dataTable" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 :
            ...
            _o.map(booking$1 => {
                ...
                }), booking$1.extra_services && index.h("li", null, locales_store.locales.entries.Lcz_ExtraServices))), index.h("td", null, index.h("p", { class: "p-0 m-0 date-p" }, moment.hooks(booking$1.from_date, 'YYYY-MM-DD').format('DD-MMM-YYYY')), index.h("p", { class: "p-0 m-0 date-p" }, moment.hooks(booking$1.to_date, 'YYYY-MM-DD').format('DD-MMM-YYYY'))), index.h("td", null, index.h("p", { class: "p-0 m-0" }, booking.formatAmount(booking$1.currency.symbol, (_c = (_b = booking$1.financial) === null || _b === void 0 ? void 0 : _b.gross_total) !== null && _c !== void 0 ? _c : 0)), booking$1.financial.due_amount > 0 && (index.h("buuton", { onClick: () => {
                        this.editBookingItem = { booking: booking$1, cause: 'payment' };
                        this.openModal();
                    }, class: "btn p-0 m-0 due-btn" }, booking.formatAmount(booking$1.currency.symbol, booking$1.financial.due_amount)))), this.showCost && (index.h("td", null, booking$1.financial.gross_cost !== null && booking$1.financial.gross_cost === 0
                    ? '_'
                    : booking.formatAmount(booking$1.currency.symbol, booking$1.financial.gross_cost))), index.h("td", null, index.h("p", { class: `m-0 badge ${confirmationBG} ct_ir_badge` }, booking$1.status.description)), index.h("td", null, index.h("div", { class: "d-flex justify-content-center align-items-center", style: { gap: '8px' } }, index.h("ir-button", { title: "Edit booking", variant: "icon", icon_name: "edit", onClickHandler: () => (this.editBookingItem = { booking: booking$1, cause: 'edit' }) }), index.h("ir-button", { title: "Delete booking", style: { '--icon-button-color': '#ff4961', '--icon-button-hover-color': '#FF1635' }, variant: "icon", icon_name: "trash", onClickHandler: () => {
