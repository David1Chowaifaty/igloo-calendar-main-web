...
const booking_service = require('./booking.service-cffb4120.js');
const room_service = require('./room.service-79250dca.js');
...
const IglBookPropertyContainer = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7a8f07fb99c7bacc98aec1edd9b40dbb70001ede' }, index.h("ir-toast", { key: '5d5305f9a51ca109d060c60d7f58e36a42e608df' }), index.h("ir-interceptor", { key: 'f26fef91aa119ab958d3a120f7222399c5d2c07f' }), index.h("div", { key: 'ae38267441056e0ff806703ee760db69633dbaa3', class: "book-container", onClick: this.handleTriggerClicked.bind(this) }, index.h("slot", { key: '6b2c8e70ba1f7e0a4443d3a983882718749508dc', name: "trigger" })), this.bookingItem && (index.h("igl-book-property", { allowedBookingSources: this.calendarData.allowed_booking_sources, adultChildConstraints: this.calendarData.adult_child_constraints, showPaymentDetails: this.showPaymentDetails, countryNodeList: this.countryNodeList, currency: this.calendarData.currency, language: this.language, propertyid: this.propertyid, bookingData: this.bookingItem, onResetBookingData: (e) => {
