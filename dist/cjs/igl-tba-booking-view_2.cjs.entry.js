...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7a934098e3221e87a7a3e0824daa359bd1858df1' }, index.h("div", { key: '9b4483a7943e51eaba64de49abed93a97ea144bf', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: '9cbe08be8f86b110d9e9ce7343d3af107f281fac', class: `guestTitle ${this.highlightSection ? 'selectedOrder' : ''} pointer font-small-3`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, `Book# ${this.eventData.BOOKING_NUMBER} - ${this.eventData.NAME}`), index.h("div", { key: '6c2c1733dbb035341a4ce50de1dc5e3d60bb56c4', class: "row m-0 p-0 actionsContainer" }, index.h("div", { key: '1e1ac9d3d4760aaf2e88849830b03e66541883fa', class: "d-inline-block p-0 selectContainer" }, index.h("select", { key: '2b4e0a20871dc8a22b7e57c108d0126c15dadc47', class: "form-control input-sm", id: v4.v4(), onChange: evt => this.onSelectRoom(evt) }, index.h("option", { key: '6b2f6435e7e5fd4a6985ff8194c714e2aa018340', value: "", selected: this.selectedRoom == -1 }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name))))), this.highlightSection ? (index.h("div", { class: "d-inline-block text-right buttonsContainer" }, index.h("button", { type: "button", class: "btn btn-secondary btn-sm", onClick: evt => this.handleCloseAssignment(evt) }, "X"), index.h("button", { type: "button", class: "btn btn-primary btn-sm", onClick: evt => this.handleAssignUnit(evt), disabled: this.selectedRoom === -1 }, locales_store.locales.entries.Lcz_Assign))) : null), index.h("hr", { key: '7410c020011806d0b5b363b41b9c02b81d3092c3' }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '364c57e3a0c1081af7a27d5cf6be1b795175ad2f' }, index.h("div", { key: '2a40bee24b97becd71702edae661ef94acf07d99', class: "sectionContainer" }, index.h("div", { key: 'f19176d1b4b8dacb57f50f48c73b0610c3f3ab5b', class: "font-weight-bold mt-1 font-small-3" }, this.categoriesData[this.categoryId].name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
