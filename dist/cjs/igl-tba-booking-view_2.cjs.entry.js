...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2c103cf2c3c7ced09b4f4a73f065f1872b7288a2' }, index.h("div", { key: '3c7cb622636892b2aa6c1e688d4d0343133549b1', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: '299651e5fdb5628a203b8e86262f2de633829b09', class: `guestTitle ${this.highlightSection ? 'selectedOrder' : ''} pointer font-small-3`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, `Book# ${this.eventData.BOOKING_NUMBER} - ${this.eventData.NAME}`), index.h("div", { key: 'e451a3ddf963d72cb8d060c4ae304eabd362aefa', class: "row m-0 p-0 actionsContainer" }, index.h("select", { key: '48bef6325a6f17fe1a2ed8763d4397d300f241a0', class: "form-control input-sm room-select flex-grow-1", id: v4.v4(), onChange: evt => this.onSelectRoom(evt) }, index.h("option", { key: '9c650f67c94a88ef8a2d0c9fba91a2b3836d8f3c', value: "", selected: this.selectedRoom == -1 }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (index.h("div", { class: "buttonsContainer bg-red" }, index.h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, index.h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, index.h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), index.h("div", { key: 'cad44a9960cdd96ef7f2767ff0e814fadc8d1111', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, index.h("ir-button", { key: 'f2325b5536ab3823e3c8e21c2cf604d2484aeb5c', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (index.h("ir-button", { key: 'ffcbfb304c3df00ec3906dffe6701d8f4cc14c6b', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), index.h("hr", { key: '49e098cea9ec40296399ebc58f095b35f38dbd72' }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '6d7644cc1b86754316c943695e2703c26913860c' }, index.h("div", { key: '91e60fc7dcb4bbc9ece285979f87d33d55e22510', class: "sectionContainer" }, index.h("div", { key: '568c15054e8ad866f1bc00d44fd8e1ac9c90e609', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
