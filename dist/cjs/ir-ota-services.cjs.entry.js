...
const IrOtaServices = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: "font-size-large d-flex justify-content-between align-items-center mb-1" }, index.h("p", { class: 'font-size-large p-0 m-0 ' }, t.t('Lcz_ChannelServices', { fallback: 'Channel Services' }))), index.h("div", { class: "card" }, this.services?.map((service, idx) => (index.h(index.Fragment, null, index.h("ir-ota-service", { service: service }), idx !== this.services.length - 1 && index.h("hr", { class: "ir-me-2 ir-ms-2 my-0 p-0" })))))));
    }
};
