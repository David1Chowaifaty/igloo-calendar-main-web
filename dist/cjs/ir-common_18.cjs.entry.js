...
const IrPropertySwitcher = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b9994bb627cabffc2b5a737c7f60f92173217d18' }, this.displayMode === 'read-only' && this.renderReadOnly(), this.displayMode === 'dropdown' && (index.h("ir-select", { key: 'ee6f9edac1c2ce2ededd709f7eaa8e0d8ca12526', showFirstOption: false, selectedValue: this.selectedProperty?.PROPERTY_ID?.toString() ?? '', data: this.linkedProperties.map(property => ({
                value: property.PROPERTY_ID?.toString(),
                text: `${property.PROPERTY_NAME} ${property.COUNTRY_NAME}`,
            })), onSelectChange: this.handleDropdownSelect })), this.displayMode === 'dialog' && (index.h("div", { key: 'f7d6c256bf2d8c1c490f922333f960b5a3d783b8' }, this.trigger(), index.h("ir-dialog", { key: '22c29fdcbd644cd647b94d49ed15a367307ae621', onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, withoutHeader: true, open: this.open, label: "Find property", class: "property-switcher__dialog" }, this.open && (index.h("ir-property-switcher-dialog-content", { key: '68f5b87461f5331760c19c4afb0975f174e1a989', open: this.open, selectedPropertyId: this.selectedProperty?.PROPERTY_ID, properties: this.linkedProperties, onPropertySelected: this.handlePropertySelected })))))));
    }
    static get watchers() { return {
        "ticket": ["handleTicketChange"]
    }; }
