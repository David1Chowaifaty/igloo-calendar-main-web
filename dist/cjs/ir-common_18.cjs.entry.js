...
const IrPropertySwitcher = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2c6bb2d45054cd7b79b48d8163f4a245290098fa' }, this.displayMode === 'read-only' && this.renderReadOnly(), this.displayMode === 'dropdown' && (index.h("ir-select", { key: '8f44fd3d5ecaeb60e0c4b2beb108587021da5e1a', showFirstOption: false, selectedValue: this.selectedProperty?.PROPERTY_ID?.toString() ?? '', data: this.linkedProperties.map(p => ({
                value: p.PROPERTY_ID?.toString(),
                text: `${p.PROPERTY_NAME} ${p.COUNTRY_NAME}`,
            })), onSelectChange: this.handleDropdownSelect })), this.displayMode === 'dialog' && (index.h("div", { key: 'e20cb517dadc78a17dd0644e1f1a947a24ca2e3a' }, this.trigger(), index.h("ir-dialog", { key: 'b9391ba45bc8afdca3013e338f81fd65c73b12a0', withoutHeader: true, open: this.open, label: "Find property", class: "property-switcher__dialog", onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            } }, this.open && (index.h("ir-property-switcher-dialog-content", { key: '6b74212240464cd33041c3880ca948939a4e50d9', open: this.open, selectedPropertyId: this.selectedProperty?.PROPERTY_ID, properties: this.linkedProperties, onPropertySelected: this.handlePropertySelected })))))));
    }
    static get watchers() { return {
        "ticket": ["handleTicketChange"]
    }; }
