...
var booking_service = require('./booking.service-BWPg8s3t.js');
...
const IglBookProperty = class {
    ...
    async handleBlockDate(auto_close = true) {
        const props = this.wasBlockedUnit
            ...
            : (() => {
                const releaseData = booking.getReleaseHoursString(+this.blockDatesData.RELEASE_AFTER_HOURS);
                return Object.assign({ from_date: booking.dateToFormattedString(this.defaultData.defaultDateRange.fromDate), to_date: booking.dateToFormattedString(this.defaultData.defaultDateRange.toDate), NOTES: this.blockDatesData.OPTIONAL_REASON || '', pr_id: this.defaultData.PR_ID.toString(), STAY_STATUS_CODE: this.blockDatesData.OUT_OF_SERVICE ? '004' : this.blockDatesData.RELEASE_AFTER_HOURS === 0 ? '002' : '003', DESCRIPTION: this.blockDatesData.RELEASE_AFTER_HOURS || '' }, releaseData);
            })();
...
const IglPropertyBookedBy = class {
    ...
    handleComboboxChange(e) {
        ...
        if (key === 'blur') {
            if (index$1.libExports.z.string().email().safeParse(data).success) {
...
//# sourceMappingURL=igl-application-info.igl-block-dates-view.igl-book-property.igl-book-property-footer.igl-book-property-header.igl-booking-form.igl-booking-overview-page.igl-property-booked-by.igl-rate-plan.igl-room-type.entry.cjs.js.map
