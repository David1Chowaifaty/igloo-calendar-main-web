...
var ClickOutside = require('./ClickOutside-DTizBZcU.js');
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bf3d8645141be3195220086a27355937fc518c1a', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '868d0f84812221a33563b5c114a2b8df2922dc4f', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '0a616fc476385a5486243492e3e2014a0c32dd2f', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: 'd45fae8a95a85ea926b38fd82a255098419da09a', class: "fd-application-info__details" }, index.h("div", { key: 'd14ecceec32bc8cba4a37477331864773ae8b875', class: "fd-application-info__rateplan" }, index.h("p", { key: '75e45bf69bf8109f8e7eeb2555a15324e6485bbd', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: 'c64cfff7cf0597e6c1488f13c97f874b7907db24', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: 'bbd065b62c83ec0386fb840aa160437e91217096', for: this.tooltipId }, index.h("span", { key: '06be4d247ec7a648509e5165c10dd9f4241b6abb', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '9f6e3aead1207abbf5eb39f11ae44163d65e4299', name: "circle-info", id: this.tooltipId })), index.h("p", { key: '7081ac492745b5f50da337400134f7fa1b80015d', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: '76c271a45c91f7ebf6c6bd8f6aeb88a400d0ed98', class: "fd-application-info__price" }, index.h("span", { key: '2da4993cc38fec400df0bd55f400cbc243e8c506', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: '4bd02ec115a4750b77201f3fbe47f4c202b40de8', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), index.h("div", { key: '191e4743b265d2117016f78be682a66fc45cd7dd', class: "fd-application-info__footer" }, index.h("div", { key: 'cb064599cb2c70bb615d21516d42ac5f09a29099', class: "fd-application-info__rateplan" }, index.h("p", { key: '53cb865beea50fe78a972ef145cb19ffed7b89dd', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: '7a1a9b42e32b28fe72102149e5682c54d4e43ecc', for: `mobile-${this.tooltipId}` }, index.h("span", { key: '1fbe9c1116e91bb3add869bbb14fbfdd4f27441b', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'fdbd4383e5e7efdff00ecbe75e372020ab46e023', name: "circle-info", id: `mobile-${this.tooltipId}` })), index.h("p", { key: '1e225814f6d9c5bf57055a033be9c3d68ad88393', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: '795c4944ffced2a3945bfb98a26106d0d3f17d54', class: "fd-application-info__form" }, index.h("ir-validator", { key: '4823ba9574920fb9f8a4a8794be84448f62564fb', value: this.guestInfo?.first_name, schema: types.GuestCredentials.shape.first_name }, index.h("ir-input", { key: '60cda3eb2c906deb74708cb7b4895ecbc382df9b', class: "fd-application-info__input",
            ...
            } })), index.h("ir-validator", { key: '388a7226680c6fb90f9e50852fb6aee8a218d5ca', value: this.guestInfo?.last_name, schema: types.GuestCredentials.shape.last_name }, index.h("ir-input", { key: '0c717228849740d22f4d27ed98563df555dc92ac', class: "fd-application-info__input", type: "text",
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("wa-select", { key: '4299e32e3c16555ce8c0c820e4b1d852e8d94d67', "with-clear": true, size: "s", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_Assignunits, "data-testid": "unit", value: this.guestInfo?.unit, defaultValue: this.guestInfo?.unit, onchange: event => this.updateGuest({
                unit: event.target.value,
            }) }, filteredRoomList.map(room => (index.h("wa-option", { value: room.id.toString(), selected: this.guestInfo?.unit === room.id.toString() }, room.name))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("ir-validator", { key: '51b401c52e3430c67d88147d6f5d0b4d8e269927', value: this.guestInfo?.bed_preference, schema: index$1.libExports.z.string().nonempty() }, index.h("wa-select", { key: '9cf180631b3a5ca9adfa00c80f8f0fd0c42101be', "with-clear": true, size: "s", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_BedConfiguration, "data-testid": "bed_configuration", value: this.guestInfo?.bed_preference, defaultValue: this.guestInfo?.bed_preference,
            ...
            }) }, this.bedPreferenceType.map(data => (index.h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("p", { key: 'c038f3add05c75238ff5b3ceed8a528a9ea99407', class: "fd-application-info__price-inline" }, index.h("span", { key: '5f3781501d1e25f6d1b13af550dc012900cfbd65', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: '0eddb1c3a3b7375f7005c1d46356734f4ccb4dab', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), this.rateplanSelection.selected_variation?.child_nbr > 0 && (index.h("div", { key: 'a0e6ae1610acc01faa688119ff863cb2df59fc91', class: "fd-application-info__infant" }, index.h("p", { key: 'e9fa9335d3aed96d996147ca002edc7d9e02c77c', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), index.h("wa-select", { key: 'ddb6a99bd217d7d0e8716177917e41eb0d7dedc5', size: "s", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales_store.locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => {
                this.updateGuest({
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '1574d8c2df70985658c73005f84a821c14ade6c5', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: 'af69c8d854cb498f4eae4ea8f8b31a06cc52f2b6', class: `rate-plan ${visibleInventory.reserved === 1 && bookingType === 'EDIT_BOOKING' ? '--current' : ''} ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: 'b8ce0d636c6412c2dbd44430f56492e86c9d4a9e', "data-testid": 'rp_name', class: "rateplan-name-container" }, index.h("div", { key: '131c8402f0db0271c0017914fe8b7fdd5e55d82b' }, bookingType === 'BAR_BOOKING' ? (index.h(index.Fragment, null, index.h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))) : (index.h(index.Fragment, null, index.h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), ratePlan.custom_text && index.h("span", { key: '5f527d8291d095d898420689f710f23d8d3e53c5', class: "custom-text-span" }, ratePlan.custom_text)), isAvailableToBook && (index.h(index.Fragment, { key: '93166e1c1a4a40235e9c0c56e429fabf1d88c5f1' }, index.h("wa-tooltip", { key: '8e21114e904d66a911d6bc889426da4d27dab8b3', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: '16ac91ed6245adc3f931fb16a456e34ff527e6a1', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '76e37e7b991b159734d806e447f0cb0daa51a83f', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (index.h(index.Fragment, { key: '1173f04c6afa9c34bc692810717b0c2ada9d4042' }, index.h("wa-tooltip", { key: '09465ec6f4efca40437f4847b4e23dfeb762cbad', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), index.h("wa-icon", { key: '6d3752c2d70a32acd766ed915422712da764efe4', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "s", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
		    ...
		    function loadLocale(name) {
		        ...
		        if (
		            ...
		            try {
		                ...
		                aliasedRequire = momentWithLocales.commonjsRequire;
...
function requireAr () {
	...
	(function (module, exports) {
(function (global, factory) {
		   typeof momentWithLocales.commonjsRequire === 'function' ? factory(requireMoment()) :
...
function getAbbreviatedWeekdays(locale) {
    let weekdays = [];
    for (let i = 0; i < 7; i++) {
        const weekday = momentWithLocales.moment().locale(locale).day(i).format('ddd');
...
const IrCustomDateRange = class {
    ...
    minDate = momentWithLocales.moment().add(-24, 'years');
    /** The latest selectable date. Defaults to 24 years in the future. */
    maxDate = momentWithLocales.moment().add(24, 'years');
    /**
     ...
     */
    locale = 'en';
    selectedDates = { start: momentWithLocales.moment(), end: momentWithLocales.moment() };
    displayedDaysArr = [];
    hoveredDate = null;
    weekdays = [];
    /**
    ...
    componentWillLoad() {
        ...
        const currentMonth = this.fromDate ? this.fromDate.clone() : momentWithLocales.moment();
    ...
    handleLocale(newValue, oldLocale) {
        if (newValue !== oldLocale) {
            momentWithLocales.moment.locale(newValue);
    ...
    handleFromDateChange(newValue, oldValue) {
        if (!(newValue ?? momentWithLocales.moment()).isSame(oldValue ?? momentWithLocales.moment(), 'days')) {
    ...
    getMonthDays(month) {
        const startDate = momentWithLocales.moment(month).startOf('month').startOf('week');
        const endDate = momentWithLocales.moment(month).endOf('month').endOf('week');
        const days = [];
    ...
    isDaySelected(day) {
        ...
        const start = this.selectedDates.start ? this.selectedDates.start.clone() : momentWithLocales.moment();
    ...
    render() {
        ...
        return (index.h("div", { key: '024c7651b5f296a10e046b187ee9a08c40c9ffe2', part: "base", class: "date-picker" }, this.displayedDaysArr.map((month, index$1) => (index.h("table", { part: "calendar", class: "calendar", role: "grid" }, index.h("thead", null, index.h("tr", { part: "calendar-header", class: "calendar-header" }, index.h("th", { colSpan: 7 }, index.h("div", { part: "month-navigation", class: "month-navigation" }, index$1 === 0 && this.displayedDaysArr[0].month.clone().startOf('month').isAfter(this.minDate) && (index.h("button", { part: "nav-prev", name: "previous month", class: "navigation-buttons previous-month", type: "button", onClick: this.goToPreviousMonth.bind(this) }, index.h("p", { class: "sr-only" }, "previous month"), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, index.h("path", { fill: "currentColor", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z" })))), index.h("span", { part: "month-label", class: "month-year-label" }, month.month.locale(this.locale ?? 'en').format('MMMM YYYY')), index$1 === 0 && (index.h("button", { part: "nav-next", name: "next month", class: "navigation-buttons button-next", type: "button", onClick: this.goToNextMonth.bind(this) }, index.h("p", { class: "sr-only" }, "next month"), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, index.h("path", { d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" })))), index$1 === 1 && this.displayedDaysArr[1].month.clone().endOf('month').isBefore(this.maxDate) && (index.h("button", { part: "nav-next", name: "next month", class: "navigation-buttons button-next-main", type: "button", onClick: this.goToNextMonth.bind(this) }, index.h("p", { class: "sr-only" }, "next month"), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "16", width: "25.6", viewBox: "0 0 320 512" }, index.h("path", { fill: "currentColor", d: "M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z" }))))))), index.h("tr", { part: "weekday-row", class: "weekday-header", role: "row" }, this.weekdays.map(weekday => (index.h("th", { part: "weekday", class: "weekday-name", key: weekday }, weekday.replace('.', '')))))), index.h("tbody", { part: "days-grid", class: "days-grid" }, month.days
            .reduce((acc, day, i) => {
            ...
            return (index.h("td", { part: "day-cell", class: "day-cell", key: day.format('YYYY-MM-DD'), role: "gridcell" }, day.isSame(month.month, 'month') && (index.h("button", { part: "day-button", disabled: isDayBeforeMinDate || isDayAfterMaxDate || (this.selectedDates.start && maxSpanDays && day.isAfter(maxSpanDays) && !this.selectedDates.end), onMouseEnter: () => this.handleMouseEnter(day), onMouseLeave: () => this.handleMouseLeave(), onClick: e => {
                ...
                } }, index.h("p", { class: `day ${day.isSame(momentWithLocales.moment(), 'day') ? 'current-date' : ''}` }, day.locale(this.locale).format('D')), this.showPrice && index.h("p", { class: "price" }, checkedDate?.withPrice.price ? '_' : checkedDate.withPrice.price)))));
        }))))))))));
    }
    static get watchers() { return {
        "locale": [{
...
const IrDateRange = class {
    ...
    fromDate = moment$2.hooks().toDate();
    /** Currently selected check-out date. */
    toDate = moment$2.hooks().add(1, 'day').toDate();
    ...
    calculateTotalNights() {
        this.totalNights = booking.calculateDaysBetweenDates(moment$2.hooks(this.fromDate).format('YYYY-MM-DD'), moment$2.hooks(this.toDate).format('YYYY-MM-DD'));
    }
    ...
    handleCustomDateChange(evt) {
        ...
        this.toDate = end;
        this.calculateTotalNights();
        const startMoment = moment$2.hooks(start);
        const endMoment = moment$2.hooks(end);
    ...
    get formattedLabel() {
        const from = moment$2.hooks(this.fromDate).format('MMM DD, YYYY');
        const to = moment$2.hooks(this.toDate).format('MMM DD, YYYY');
        return `${from} → ${to}`;
    }
    render() {
        const showNights = this.variant === 'booking' && this.withDateDifference;
        return (index.h("wa-popup", { key: 'cf39fe876e741610c64289bc9849131491e14f1f', part: "popup", arrow: true, placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "igl-date-range__popup" }, index.h("div", { key: 'e72160d5451fd2935a67bb3f61e87bd17f77ea98', slot: "anchor", part: "anchor", class: "igl-date-range__trigger" }, index.h("div", { key: 'ffcefa9d12e0f2c53186f3a36d452a4bb9d0fb55', part: "combobox", class: "igl-date-range__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date range", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("ir-input", { key: 'ca06e45c6930ed0fba61df4b1ae99bbd4a225838', part: "input", disabled: this.disabled, class: "igl-date-range__input", readonly: true, value: this.formattedLabel, "aria-invalid": this.isInvalid, "aria-expanded": String(this.isActive), "aria-disabled": this.disabled ? 'true' : undefined }, index.h("wa-icon", { key: '97eff5519f280aec4756c3f77e136067053a2f46', part: "calendar-icon", slot: "start", variant: "regular", name: "calendar" }), showNights && this.totalNights > 0 && (index.h("span", { key: 'b90eb9f930cc3aa92a26a0bf37087aa3e843ab11', part: "nights-badge", slot: "end", class: "igl-date-range__nights" }, this.totalNights, " ", this.totalNights > 1 ? locales_store.locales.entries.Lcz_Nights : locales_store.locales.entries.Lcz_Night))))), index.h("div", { key: '52e23c1c5ff945604453b9b0e58051b80d89909a', part: "body", id: this.popupId, class: "igl-date-range__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date range selection dialog" }, index.h("ir-custom-date-range", { key: '86dae68ee7bc591ef986580788a348c3befe4d9b', part: "calendar", exportparts: "base: calendar-base, calendar, calendar-header, month-navigation, nav-prev, nav-next, month-label, weekday-row, weekday, days-grid, week-row, day-cell, day-button", style: { '--cal-button-size': '35px' }, fromDate: moment$2.hooks(this.fromDate), toDate: moment$2.hooks(this.toDate), minDate: this.minDate ? moment$2.hooks(this.minDate) : undefined, maxDate: this.maxDate ? moment$2.hooks(this.maxDate) : undefined, onDateChange: e => this.handleCustomDateChange(e) }))));
    }
    static get watchers() { return {
        "defaultData": [{
                "handleDataChange": 0
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'eed3323aa3759627d9f45a95f3508d12b646f622', size: 's', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: '5ff455ee154aa0b754d883b17ced1137bc37dd55', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: 'a4740548a84ee818de8b683b13a8547a74f6a0b2', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: 'f7c501ea3ba8bfd1efb5208e916dbc1dc6f20175', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '8a23667bc07ba41d6772fa013a5e0b32ae6527cd', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: '1da5015fcbc73a02d9bee078fc1d57883a091d75', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: 'cddf8ba2c27f30adeaa6c7cbe217de032b9f6ec1', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: 'bf4f3de3b970f67b5b2b9c53b2a8ba9a2852ceba', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("ir-input", { key: '985b94e4127674db689509a1fdb591e3ea9c5665', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && index.h("span", { key: 'e4aa4ce05b76af2503e7d6fb68bfeb1dd9254aa5', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (index.h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
        "countryCode": [{
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9111cf8639da28be3ea7f05c9eb199270b0e1a94' }, index.h("wa-popup", { key: '38a0014ea9cefa0b07092735f11066cab4c09528', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '21676b1a895fda4640a84a92250ce47f731c6ed1', slot: "anchor", class: "search-bar", "aria-invalid": this.isValid, withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, onblur: () => this.inputPickerBlurred.emit(), autocomplete: "nope", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: '5ee4762d1f39da108b149405ee5d84a6a91a656d', slot: "end" }), index.h("wa-icon", { key: '52a8c6cdca48f83738311c7e630a9fbaf0940b5b', slot: "start", name: "magnifying-glass", "aria-hidden": "true" }), index.h("slot", { key: '2c6f1c268267b5329c0a8abc2f057df85a1f50b0', name: "end", slot: "end" })), index.h("div", { key: '73ebcfc005478978ad738d0ba645dc26dc0fa915', class: "menu", role: "presentation" }, index.h("p", { key: '8fad89470467a583602fc54c4d8a6c62ce0c77a4', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: 'd746ec13b2cdcc6c6dbf55fab65924b04cc50657', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: 'd59820ce90089fba5e82e2f586d1cbf94b3f5084', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: 'd750df6e39c5583ef7b78d0e42822b38b674bd3d' }), index.h("p", { key: 'e8ac0df48a64ca466c8d40e2c737c15b2d22e324' }, "Loading suggestions\u2026"))), index.h("slot", { key: '70cfabeb21bd52c4fb3a664d71914ecb2d17daae', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: '037820eea56d6ff1712ae65917533bf50cd80f92', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: 'b9ad7cb78486771dc7dc3d09832ffda2fe6bc2c1', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: 'b08f3a23a3497ddafdce41050f0d83d40ff14c37' }, "No results found")))))), index.h("span", { key: '5bfb219f4b3fa2029dd6dfa8cccae1f2c0c41112', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '639342749087110decbee379f81da0f3153c1c79', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'f8f2a7d12bb61eb9a698b87ec8ad9832fcc95d1c', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'e53711901155f0914bea8716e5b9454115babaff', class: "picker-item__check", name: "check" }), index.h("div", { key: 'f08415aceb97cc63126aa2a6ada4619acb91e00f', class: "picker-item__content", part: "content" }, index.h("slot", { key: '5b460355ef56c062ef1f73d0f4bfa04a210fd139' })))));
    }
};
...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: '7d1b11c2e6c95574b7d03a81ed9d5143b11727c3' }, index.h("wa-radio-group", { key: '2f700bd14b64ffe4a71af32e4a67bb747ea4d3da', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "s", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: '62b4b22aa9b72bc08f725a60f1056d2b3a10506f', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: 'd094a81bde64e0ad551dc2ed00689b438ee893ef', value: "guest", appearance: "button" }, "Guest"))));
    }
};
