...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '724d64a6da6dc27e973decfc64554a1643507850', class: 'my-2' }, index.h("div", { key: '7a1178298bb416a332bbf0690591e6d59b8a8fe0', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '55a9c74b437ab7131ba7abcd82e14dd873287c44', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '250be3f0f1a54928df41ff129e83ab37f7558887', class: "booking-details-container" }, index.h("div", { key: 'cc06e6b5d9c1b5f07c0ac31119196d851ebde36f', class: "booking-rateplan" }, index.h("p", { key: '25d49b9c68fe7e6166b6fa351522ce76f37f4e0d', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '7035933b3767564371fcbec32eea8803d8685eaf', class: 'non-ref-span' }, "Non Refundable")), index.h("ir-tooltip", { key: '86bd6aae27b55c8353d0fdec869895491b89de87', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: '40a4ca7225d25d80452b28d920ab1c98f684b93a', class: "booking-variation", innerHTML: formattedVariation })), index.h("p", { key: '4da53b25af568723f579219b3043c3d7dee9af23', class: "booking-price" }, utils.formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: '83ebec750c4cfc41580c698ee39fc60945b4d738', class: "booking-footer" }, index.h("div", { key: 'e064cbc3c46114f16a89e96a4f09787bc7ef8536', class: "booking-rateplan" }, index.h("p", { key: 'd9e56a4e77fd3f9d62338496c148d4869977530a', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("ir-tooltip", { key: '2571571b8e63314bddd39e2999819d3034913848', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: '64f87e604ac8764f9a757135f49b1e1b0ce9ce74', class: "booking-variation", innerHTML: formattedVariation })), index.h("div", { key: 'bac305e6dcbaa04387eedaf64684886b1845df7a', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, index.h("div", { key: 'f577755e653dbec6aa14c025d363f7ff85ba87e2', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, index.h("input", { key: '911758dad935be831e4dbaa5a44f385da8a3cac2', id: v4.v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales_store.locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
            ...
            }, required: true, value: (_d = this.guestInfo) === null || _d === void 0 ? void 0 : _d.first_name })), index.h("div", { key: 'd46a97dc01bd831ca1d2d542e6612040c6098b6c', class: "mr-md-1 flex-fill guest-info-container" }, index.h("input", { key: '540adddcd70e04ed4fa1b53e5d87812bd967eded', id: v4.v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_e = this.guestInfo) === null || _e === void 0 ? void 0 : _e.last_name) === '' && 'border-danger'}`, placeholder: (_f = locales_store.locales.entries['Lcz_GuestLastname']) !== null && _f !== void 0 ? _f : 'Guest last name', name: "guestLastName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ last_name: name });
                if (booking_service.booking_store.event_type.type === 'EDIT_BOOKING') {
                    booking_service.modifyBookingStore('guest', Object.assign(Object.assign({}, booking_service.booking_store.guest), { name }));
                }
            }, required: true, value: (_g = this.guestInfo) === null || _g === void 0 ? void 0 : _g.last_name })), index.h("div", { key: '61c3a0f345603774e3fd5d2c627b242df13fdb73', class: "my-1 my-md-0 d-flex align-items-center flex-fill" }, calendarData.calendar_data.is_frontdesk_enabled &&
            !calendarData.isSingleUnit(this.rateplanSelection.roomtype.id) &&
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("div", { key: '4070fe25555301259c2a5274796652ffa0e7521c', class: "mr-md-1 p-0 flex-fill preference-select-container" }, index.h("select", { key: '37fde5921c0cd8d325f0064a62dbb954e09996ac', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, index.h("option", { key: '077b1d2f2c5382d7163366ae6c209ad1626738f5', value: "", selected: ((_h = this.guestInfo) === null || _h === void 0 ? void 0 : _h.unit) === '' }, locales_store.locales.entries.Lcz_Assignunits), filteredRoomList === null || filteredRoomList === void 0 ? void 0 :
            ...
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("div", { key: 'e9b886d6746cbfac456437ccc4242988b90d1feb', class: "mr-md-1 flex-fill" }, index.h("select", { key: 'a84c08b1ea13dcabe6fc3bd81d290f0f1a409ad7', class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, index.h("option", { key: '69d7d7a40f06b7fa27e6f5ac98ce563c1c3edffb', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales_store.locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), index.h("p", { key: '391647c127e4c1f1e09567071d63fa2c1ab1232f', class: "rate_amount" }, utils.formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: '3443a9cdcb37f67686eecbb3d8bbfd64ca71e2f3', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, index.h("p", { key: '036d7b74f23ee1a71c286cee57100ac5bbd103bd', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), index.h("div", { key: '1d1a665415f36419236c0abee85f52bf9c6bed6e', class: "mr-1 flex-fill" }, index.h("select", { key: '1cff2d9ce60a247186725ef75eb8850b2455f8ab', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4.v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, index.h("option", { key: '413daddee406126d3bcf4eed39446dffbe6358f2', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales_store.locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '79d6fe64a539852193d2b3263f2ba3108f5182a0' }, index.h("div", { key: 'abedca637d853a05e00bf0e45bca52d8ad13281a', class: `m-0 p-0 mb-1` }, index.h("div", { key: 'deef0e7ba2e9bc87b670d13aa085c6b0f0bca9a4', class: "text-left p-0" }, index.h("ir-date-view", { key: 'a836824d9a9060e53e3815e55f2483f0aee1e2be', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), index.h("div", { key: '59c23634a134abd8ca5af3ca2ec62ee14142f2e9', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { key: '708537f3aa05a085039d4cf190f4047f177814ee', class: "mb-1 " }, index.h("label", { key: '9f2c4192e9cc5491b1091da528c418ef1f3b176a', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales_store.locales.entries.Lcz_Reason, ":"), index.h("div", { key: '29071fd37ac7aae0ad6c51c0d02550586b3e3a63', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { key: 'eb455c4d53182f84d1cb7f7a5a66fe49db69fdbe', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { key: 'f65ba30ae5da4d778cf98fc5310753419711545b', class: "align-middle out-of-service-label" }, locales_store.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, locales_store.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: locales_store.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, locales_store.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, locales_store.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0842ec1c20192c1877fd2deb3d902a83f0a4e1e5' }, index.h("div", { key: '70d3e5f135dabf75aa1bf43cf4f71e7f5d15ffc0', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: 'f77014d7122b5e0309bbd578f0c9631afa1aad05', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: '6f511f571fa06fc1057c826ff851b0f92745803a', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: 'd385fadfae90e9925bcacb277ad9578545695525', class: "card-header-container mb-2" }, index.h("h3", { key: 'c783c1b51809fdb1369e89c98e25d11bf5ad6f5f', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '42c57ffd29500b5d059ef27f2265e04379e38b58', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: 'ee2629b7aebce85c35ee22ee56b9d35714376c6f', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '768d72fec718e13414d6d3951208e0cf29bea58f', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: 'ff9da1c2fe8a12fac31607b6db10dbf8e307bcfc', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: '840b9dc337547f5336a3a7cef2203f9bc37433a9', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index.h("igl-booking-form", { key: 'd5a348cdedf8005d67df880d649dcfe970cf0f64', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countryNodeList: this.countryNodeList, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '42089364999b89ae8bc088acbdde9fd5897c37d5' }, index.h("div", { key: '979c4eefe565527a21873544fcdbadc5b06a0804', class: "text-left mt-3" }, index.h("div", { key: 'a65f93ea0e964a1cb0c29088562f0512be3e3a19', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: '962c8a8dfd8041c6dc35633bbe6cbe77a5c57d6d', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: '7f2cec9e6bd2a78da9b1fd29d1954a52f3ef5b58', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: 'b2706cdd9ffe07e1c45f14754034aabad60b7f34', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: 'b8bf2817894fdbe828ef47942c80d60a30023373', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: 'fb7a14736c1935b70b40494b98e6f2efc864758f', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '3778a553444f4442d4f50ba82c12499c3ae4581a', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: 'f7b69c4f8fbd5c34b4ea164e22ad47ef6d0cceb0', class: "p-0 flex-fill " }, index.h("div", { key: '676b2bd7e977142e3659c88b547507c3af13993b', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: '3a59a8aca488e47adaf25ce58610faa074f8c901', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: '0a0b47ec618e5ddb3ceccfa8c246ac8bb8b89a3f', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: '406488c0004457bbf101fed14f7eebbd76b20b70', class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => {
                this.updateGuest({ first_name: event.target.value });
                this.handleDataChange('firstName', event);
            }, required: true }))), index.h("div", { key: '3753d21ea4f6c03ff09a4fdeac814c2dfd6d5bf0', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '5262a89093c8c66a6924b62e656520d51bc4e824', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '6f6604d89f56bb9a316e575e3db822bdb7f828e3', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '18287fb09f1810924d2b1e5a4956b0f71f51b79c', class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: '189dfe0593dfb7b72681a12b9ba98ed75b70b4f2', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'b60531e4cf22ef90f140cd0cde341095ba7bb165', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("ir-country-picker", { key: '90c46206f372ec294e120abdc980d5480abd1d18', class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countryNodeList, country: this.countryNodeList.find(c => c.id === this.bookedByData.countryId) })), index.h("div", { key: '850a6706d562c9c6cc1176e450bb78737c6c9d21', class: "form-group p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '3d1145e8e0c75bcb449b373f1f51193e1a152d0e', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: '5dc58ab83b96b2125e821c41e1e30528e7815781', class: "p-0 m-0 controlContainer flex-fill" }, index.h("ir-phone-input", { key: 'dc3cb8ec310af4ccf16a8783ed09ce5ab16acf1b', language: this.language,
            ...
            } }))), index.h("div", { key: '9f8a5999aae3ff57d8748cbc75ea7f9a5ecba4de', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '1483f16a8bb49b912c1ccdaff84f24129229c363', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: 'eb42990b09a02b1a007f3d2a4bfc170c4a261269', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '0be47dd3517a28ce10a55cbf8edfec3c3b733f85', class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: 'a11ac6916b319fb63e4e90c7fd399620bf5e3578', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: '09c1b51a13dad8b0ccba8af64e1af0c46453947c', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '508dcb1e20319b32a637b7208c6e5f5fee10392e', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: 'f67ed9b5eae1c43175bc002e36818848bbad7da3', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: 'ecbe8bc1f06836bb5b4696d60b4e351c148fc2a3', id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, { key: '704c9be6e938a1c204c9736acbe5c2497546e7ad' }, index.h("div", { key: 'e8213ca3bfd9759bcc9cb3459ddce095a44f274e', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '973d4a0ba61711cb5dc30be61a5d8b2cc9f615a2', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: '3f49f1a1b0b4fd4a86c6ecfb69468cca589c9849', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '3377ef366d87048c4e3c695778f73fdb0a7f9da5', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: 'c88af9b367943580e47419033a06ded2a4587a7b', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'e0d9dfb94eafcb1cb109701149c17b2f48d8ae88', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: '1ec9ef2c322f77d586718a6ee0b870896a8656cc', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'ed986fc404cdabcd9f422e9ffc769a2a7e5bd740', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: '5fc77d846a89abe7a3c0654f3680a6c0638e1929', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '5b2fca676d6738fb30983cced9e0e6b9a422d474', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: '13cb63af66930c00eab03ad326453706fd09e48d', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: 'be575dbba7d789cf2a13c934eaf6577b016299c4', class: "p-0 m-0" }, index.h("select", { key: '8c2909fd0733d8b0d959f2f3450882004005b408', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: '5e366d1dbe1a683acc5c4f643a1e055e17940f8f', class: "p-0 m-0 ml-1" }, index.h("select", { key: 'e13a0315a4d2c4b1adb95a857707c6be028c9e17', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: 'e527f3ea3a012f7ec15bab8feebead11ef2a3298', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: '9e5c171098303a755bce2ae29135586e1bbe714c', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: '8a91f51bb8a3ebccd57fec6003664cba9d1bafd1', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: '495e255f201f9cb9bcbadbf2b4926133c27897d7', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '290a957ec29a1599c8005b6331789a7f01c47feb' }, index.h("div", { key: '50ea9d1c19792207bb23a5444fc0b5bae923eb89', class: `d-flex m-0 p-0 ${isAvailableToBook ? 'flex-column flex-lg-row align-items-lg-center justify-content-lg-between' : 'align-items-center justify-content-between'}` }, index.h("div", { key: '9a57308a98b50dd5070a044c249911a878ccf08b', class: "rateplan-name-container d-flex align-items-center", style: { gap: '0.5rem' } }, bookingType === 'BAR_BOOKING' ? (index.h(index.Fragment, null, index.h("span", { class: "font-weight-bold" }, ratePlan.name.split('/')[0]), index.h("span", null, "/", ratePlan.name.split('/')[1]))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && index.h("ir-tooltip", { key: 'c7c2ebf253e6f7d6dbb758c68dd95f37f5cdb55b', message: this.getTooltipMessages() })), isAvailableToBook ? (index.h("div", { class: "d-md-flex justify-content-md-end align-items-md-center flex-fill rateplan-container" }, index.h("div", { class: "mt-1 mt-md-0 flex-fill max-w-300" }, index.h("fieldset", { class: "position-relative" }, index.h("select", { disabled: disableForm, class: "form-control input-sm", id: v4.v4(), onChange: evt => this.handleDataChange('adult_child_offering', evt) }, formattedVariations === null || formattedVariations === void 0 ? void 0 : formattedVariations.map(variation => (index.h("option", { value: variation, selected: this.formatVariation(selectedVariation) === variation }, variation)))))), index.h("div", { class: "m-0 p-0 mt-1 mt-md-0 d-flex justify-content-between align-items-md-center ml-md-1" }, index.h("div", { class: "d-flex m-0 p-0 rate-total-night-view mt-0 flex-grow-1" }, index.h("ir-price-input", { disabled: disableForm, onTextChange: e => this.updateRateplanSelection({
                is_amount_modified: true,
                rp_amount: Number(e.detail),
            }), "aria-label": `${(_c = (_b = this.visibleInventory) === null || _b === void 0 ? void 0 : _b.roomtype) === null || _c === void 0 ? void 0 : _c.name} ${this.ratePlan.short_name}'s rate`, "aria-describedby": `${this.ratePlan.short_name}'s rate`, class: "ir-br-input-none w-100 flex-grow-1", currency: currency.symbol, value: this.renderRate(), placeholder: locales_store.locales.entries.Lcz_Rate || 'Rate' }), index.h("fieldset", { class: "position-relative m-0 total-nights-container p-0" }, index.h("select", { disabled: disableForm, class: "form-control input-sm m-0 nightBorder rounded-0 py-0", id: v4.v4(), onChange: evt => this.updateRateplanSelection({
                view_mode: evt.target.value,
            }) }, ratePricingMode.map(data => (index.h("option", { value: data.CODE_NAME, selected: (visibleInventory === null || visibleInventory === void 0 ? void 0 : visibleInventory.view_mode) === data.CODE_NAME }, data.CODE_VALUE_EN)))))), (bookingType === 'PLUS_BOOKING' || bookingType === 'ADD_ROOM') && (index.h("div", { class: "flex-fill mt-lg-0 ml-1 m-0 mt-md-0 p-0" }, index.h("fieldset", { class: "position-relative" }, index.h("select", { disabled: visibleInventory.visibleInventory === 0, class: "form-control input-sm", id: v4.v4(), onChange: evt => this.handleDataChange('totalRooms', evt) }, Array.from({ length: (visibleInventory.visibleInventory || 0) + 1 }, (_, i) => i).map(i => (index.h("option", { value: i, selected: visibleInventory.reserved === i }, i)))))))), bookingType === 'EDIT_BOOKING' && (index.h(index.Fragment, null, index.h("div", { class: "m-0 p-0 ml-md-1 mt-md-0 d-none d-md-block" }, index.h("fieldset", { class: "position-relative" }, index.h("input", { disabled: disableForm, type: "radio", name: "ratePlanGroup", value: "1", onChange: () => {
                this.resetReserved();
                booking_service.reserveRooms({
                    roomTypeId: this.roomTypeId,
                    ratePlanId: this.ratePlan.id,
