...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'de3ad58cf19c044d4ab625bafb9fdc7358e02c65', class: 'my-2' }, index.h("div", { key: '843605ce31c137ba63b680bbf46ed65a133250aa', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: 'b0b7810cebc4ca688c06f41555e424280b2847ad', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '49e8c42ff012447d0a4acf90e1aa610209873f08', class: "booking-details-container" }, index.h("div", { key: '5a3c9cec27295cf06591ba62ed6a8a1788397025', class: "booking-rateplan" }, index.h("p", { key: 'dedb50801d6d4759db21040ce246052f9a8872d6', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: 'ba54c1d20c184fc656ccc1d15de673e02bf9888e', class: 'non-ref-span' }, "Non Refundable")), index.h("ir-tooltip", { key: '2e3e4ddb83c98ed4995da8bdb3bed16f04db6757', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: '5ae3f90362eab29114535541c9d50d9275e9ffe6', class: "booking-variation", innerHTML: formattedVariation })), index.h("p", { key: 'e6aa17678242ca4d1491c84c7931fe41ee812268', class: "booking-price" }, utils.formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: 'b2ed1865d234ad2d3b5fd86e75b2ad9ca0c0eaa0', class: "booking-footer" }, index.h("div", { key: '2e28b388c011a74a8573333cb9c786997ba9af5a', class: "booking-rateplan" }, index.h("p", { key: 'f1bc77975a1a1de1f03cd11cae446588cd08c36d', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("ir-tooltip", { key: 'a37fe425c4e1d7feda4e3173980bcdb2025281c0', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: 'cdfb4890f539a18ffb58b4dc65bb9274d78dac6a', class: "booking-variation", innerHTML: formattedVariation })), index.h("div", { key: '9070ade64e1d3fc2024f6edaec092c10649e3585', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, index.h("div", { key: '972f8c89ba9878f34144ce89c5802a1e4523fd90', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, index.h("input", { key: '633469f05360eed8c4efcd6f4cfb1eea4950a286', id: v4.v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales_store.locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
            ...
            }, required: true, value: (_d = this.guestInfo) === null || _d === void 0 ? void 0 : _d.first_name })), index.h("div", { key: '672f306bb5e6ebacd72f017f90dd2eb1f39054fc', class: "mr-md-1 flex-fill guest-info-container" }, index.h("input", { key: 'aa91be585a3f7f71b7d76f13c3dcaef2d5675dc4', id: v4.v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_e = this.guestInfo) === null || _e === void 0 ? void 0 : _e.last_name) === '' && 'border-danger'}`, placeholder: (_f = locales_store.locales.entries['Lcz_GuestLastname']) !== null && _f !== void 0 ? _f : 'Guest last name', name: "guestLastName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ last_name: name });
                if (booking_service.booking_store.event_type.type === 'EDIT_BOOKING') {
                    booking_service.modifyBookingStore('guest', Object.assign(Object.assign({}, booking_service.booking_store.guest), { name }));
                }
            }, required: true, value: (_g = this.guestInfo) === null || _g === void 0 ? void 0 : _g.last_name })), index.h("div", { key: 'd4534dbcf8397658c46f1c2b1517e1acd4629062', class: "my-1 my-md-0 d-flex align-items-center flex-fill" }, calendarData.calendar_data.is_frontdesk_enabled &&
            !calendarData.isSingleUnit(this.rateplanSelection.roomtype.id) &&
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("div", { key: '44e3381aae7cbe691c2d58496d9cf04050a2c7e9', class: "mr-md-1 p-0 flex-fill preference-select-container" }, index.h("select", { key: '12de122826d0db2feead2aa580ead73827fb7e5e', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, index.h("option", { key: '285edf363a93db43951dea565f04cbb791cfd3ce', value: "", selected: ((_h = this.guestInfo) === null || _h === void 0 ? void 0 : _h.unit) === '' }, locales_store.locales.entries.Lcz_Assignunits), filteredRoomList === null || filteredRoomList === void 0 ? void 0 :
            ...
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("div", { key: 'd2da097f3d11c3ade56d197878c531ccce2df56e', class: "mr-md-1 flex-fill" }, index.h("select", { key: '476226bec316b5ab689502ebe3a1129a7e3fa794', class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, index.h("option", { key: 'cb42f142540e810ffa45bc734cf6d9ed4de774bf', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales_store.locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), index.h("p", { key: '82fcaa0b35ab4d68716f60792b950463eefbf366', class: "rate_amount" }, utils.formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: '3d562a88efe6f7054e6500e7afd74931d55b3f59', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, index.h("p", { key: '00a6fc36ebd92ba76c3c3d17083339f1643df88d', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), index.h("div", { key: '072aaad246651888f88fcfeb17556eefc34f605e', class: "mr-1 flex-fill" }, index.h("select", { key: '952cc737cc8b8c53b474728721c6513f562a4458', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4.v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, index.h("option", { key: '7534e2f305cc480119248b63ea73afe04bfd4d7e', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales_store.locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd8c080766a650608988561097a9531ea89c129a9' }, index.h("div", { key: 'a7a8573aa86772385b4b92330c5f3b09030f93e0', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: 'db0164a92577da4d04107dea68cc845d118735aa', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: 'd6d8f4564db3102ddd7b4dab848c00a7e6b61b9f', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '396e70c5d4bdf34398eeb9c20bab3707aec2df00', class: "card-header-container mb-2" }, index.h("h3", { key: 'c8a778239accbee0d2abc396cef63ebb80905915', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '02696a45835b388f24edaa6cf6cc63d8d6ef0d57', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '1fc53d95d1737a80cdb8dfda90ad7201aa6ab2e3', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '714651eb4834948dc8c71415c74770e39059e266', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: '2c6c7e456760d872eee02e8b5f1e9e1375c4f5e2', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: '29d65a6796d3ab6140cd5329b0225508c304f3ea', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index.h("igl-booking-form", { key: 'a1b01d88e0a546cb20f61c711d6499c0da89796d', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countries: this.countries, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7154c9553051c42d6f6c867ca9aa789843407aae' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), index.h("div", { key: 'd926925b9ab185443566347b1f2165a4652dbb14', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, index.h("fieldset", { key: '114a56b4fa9f76713426c1df29473dff5f026e9e', class: "mt-lg-0 mr-1 " }, index.h("igl-date-range", { key: '28ce6e2b302e4befe7c5e8dac434ee8a7f17f697', variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, minDate: this.isEventType('PLUS_BOOKING') ? moment.hooks().add(-1, 'months').startOf('month').format('YYYY-MM-DD') : this.minDate, disabled: this.isEventType('BAR_BOOKING') || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: 'cfe350f0f6d40af22b70cf3ba3165053617d0f6c', class: "text-right mt-1 message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dbcb2886c6205445c06421f5efd507c627ac395c' }, index.h("div", { key: 'be496477079a9f3e693409be7995db6d7cd9ccd0', class: "text-left mt-3" }, index.h("div", { key: '733c122de9464f20a51e0ccb7666349b090052f1', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: 'c0ed8d8d216e556a89444a3b16a99a3670ff67d4', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: '4b4bd722d9d4a98a366fa41dffc76fba398ed118', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: '9e160d597fb0c2644946682dc92d5551e465c740', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: 'fe45b3598b607ec18a5ce7ca71fa3cbc0b16cfee', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: 'dc93b5e50bf48f8ffd190c2d99075ab8f4affa9c', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '2772ddad8b57388a41ae9fe039277c9e4fc78431', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: '854fe7f6e7f49f87ec2f6c5104f0933e59867d9f', class: "p-0 flex-fill " }, index.h("div", { key: '97675923d37f14ec4fc6ff6de165d33caefc646d', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: '8f33e98c879b4d33c93e7ffee8f1e3d087d6cd9c', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: '2cd534bfa1ddb1289e4d1949393897db591c56ed', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: 'cbe8172f12c348ee910fdd681296649a47095ea9', class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => {
                this.updateGuest({ first_name: event.target.value });
                this.handleDataChange('firstName', event);
            }, required: true }))), index.h("div", { key: '1c5b84adc99fe0bb8a6493dd5f7154f6204fb12f', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '17588c61d7271104c1919d527d20b117c74f1bdb', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '90543688b880afb302c60c35335fde56f4d01615', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '0aacc8629268f2de4c60293d0363bdbaeb338e66', class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: 'b80a319a2e36cfa0a6840394b113afc712d7f6c0', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '0aed7977afd31953fba9e624a0fa982c81e409c4', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("ir-country-picker", { key: '5e3dddb58e042b019a9d0cedc87aa67c07e66582', class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) })), index.h("div", { key: '9bc1d9ab876adf1756d211563bef6df6bb4642e6', class: "form-group p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '9ec72e62d73df24107d6782d43048d4e57197824', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: '6174c88d7aa88dab586a72069cc19c366e7f6e47', class: "p-0 m-0 controlContainer flex-fill" }, index.h("ir-phone-input", { key: 'c5af8487ff71fd18b866dd1de24658daa6243797', language: this.language,
            ...
            } }))), index.h("div", { key: '4f83e255f5ca5ec1cca2e32a068e2c0e80b8aee4', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'a4ddbde1849692ed18849dec6638dcb74860b06b', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: '9d528083902fb96dd24bcbfcfed4ebe5f2845890', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '59a010cdce142213758e12fdae9f127a611a163e', class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: '8188e07d887116ef9032d4d68729d9f7691867c3', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: '285ff68531e1cfe2e5eaa7bcff1ebd222e502d37', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '117e0e11193143bebe9e4ef1b80229293cf17313', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: 'da0b2c8dbd8d345d9acdcd35281509d7e80a29ff', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: '3b6015bc7b173eabf5d77726a28b336a4faca765', id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, { key: 'a08d28f356f12250ddaf87bd7a92828a4f13b9cd' }, index.h("div", { key: '3f21bdcf93d4c83abc500b4e3b1a3857b1e06e06', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'c6eed30ad7d8596165471d1d7315e44686e12663', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: '82c7d550111b200f5ac6f7b4b8aceb10517faba0', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '6c0814c6c5ec91348d223e5cf408dd4475b56b66', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: '188bb20c0179c41f588794c60b8efac3583bac37', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '9a6180711389639da43e20026181505d1953b753', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: 'a75eaf1f6adf4984c6299c1175542c3bf95adb03', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '680d5763816af499822ccc1f2fbc127c7591347e', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: 'f019ac44d7601cfc501c5e7c404dcba804ab8178', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'ae3017fafaf9b673e7316ed4090641a8f360acb9', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: '85911b9fe0146fbbe147f7c5bdb2dc8827f26bad', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: 'e7b0890577c6c38d94f6dd4ee217f68b957d6f56', class: "p-0 m-0" }, index.h("select", { key: '29dde2c8a8388a802a660fe966bbab9855bd5dcb', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: 'f80b647b414e03422b780f7ae6b74bea869e9ea2', class: "p-0 m-0 ml-1" }, index.h("select", { key: '15d46867d8058690c6885fab690d16a05a97554e', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: '6e59747846c718ccaa8310ca6ebcac85697251f8', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: '1337d30cde959863f7a72b93eeba42b1d5fbfcb0', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: '79efbe0cb9820935f63e69ea4231d6aac9232dfd', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: 'f2ac27f5f7ae1e65771b6659f7c6f46498e45cd3', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
