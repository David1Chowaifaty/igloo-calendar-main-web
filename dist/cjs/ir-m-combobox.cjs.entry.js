...
const IrMCombobox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ca4fef4ef2aa1f65617927cbda620f8d9c3df275', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, index.h("div", { key: 'ae6e64ab1f266aab6a711cfd75f35172a2faf194', class: "input-wrapper" }, index.h("span", { key: '9f85c376bdf8f221b92f6d2a96088eb319fe725f', class: "prefix-container", "aria-hidden": !this.hasPrefix }, index.h("slot", { key: 'eea5f5b48037fc97e5d4aa4f2f049e2d34efe579', name: "prefix", ref: el => (this.prefixSlotRef = el) })), index.h("input", { key: 'bfc3222385a1621ad20fd9333d27c59382138fb4', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), index.h("span", { key: '0359524797f4810ea6dc993a13495682b6d1e983', class: "suffix-container", "aria-hidden": !this.hasSuffix }, index.h("slot", { key: '31ae470fb7edda781c919b5da5830b6122fb5fe0', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), index.h("div", { key: 'b440b7a3c5ec218f837f7146b7b173a8d5afc3d6', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '7c45eee29abfac7b8451365ed1351c5ba1cc6903', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (index.h("slot", null)) : this.useSlot ? (index.h("slot", { name: "dropdown-content" })) : ([
