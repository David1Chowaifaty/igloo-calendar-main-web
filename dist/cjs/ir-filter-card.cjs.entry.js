...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '45df59e840620c9cd8f2071bb9d02e6ae4d2f506', class: expanded ? '' : 'filters__card__collapsed' }, index.h("div", { key: 'bbc3a0687c123e4ca8e9d91750147f329729aad6', part: "header", class: "filters__header", slot: "header" }, index.h("div", { key: '37fcab9e74f54a7546662d663c8e810fe9e5ab67', class: "filters__title-group" }, index.h("wa-icon", { key: '0d28a455b31e4888715919891f96977e274a9514', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: '3a8f918c3cc4657f1f03399db56f9b747d676715', class: "filters__title" }, "Filter")), !this.isDesktop && (index.h("ir-custom-button", { key: '9628a8ef6e0384949b42f84db37d6c232563d38a', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'a5bc4dfed0e1aa4298683e63f3f484440f33d18b', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), index.h("div", { key: '91b719d15acdbe63fba5b8b8c53536d7d26e8ba5', part: "filter-body", class: 'filters__body' }, index.h("slot", { key: '6d2c5330a69838f08fddd9914491ec0d817ee3b8' })), index.h("div", { key: 'f34399e1c2243b4280a83b8ff1ad25725071513c', part: "footer", class: 'filters__actions' }, index.h("slot", { key: '344aeddb423a6f83959558a262afd200ca983a03', name: "footer" }))));
    }
};
