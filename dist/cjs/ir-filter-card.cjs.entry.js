...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'a7a7157e233474c26bbea1583501d64090d08b3f', class: expanded ? '' : 'filters__card__collapsed' }, index.h("div", { key: 'e6e09c4af10017d88d727b15472559ba53222fb3', part: "header", class: "filters__header", slot: "header" }, index.h("div", { key: '1bcc08e752c7407e16e8abde04884a4e99ad08e5', class: "filters__title-group" }, index.h("wa-icon", { key: '49ba2d97f5d520c718d505b4ca0b861323fcce80', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: 'fc7fc52870efdd17994dc8e28fd33299ecb5b9dc', class: "filters__title" }, "Filter")), !this.isDesktop && (index.h("ir-custom-button", { key: 'f7c446ed354dfb5cd52889eb40eed1d2ceb4c11c', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '45834d28ac693b69da02cbc283062f6b5254af41', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), index.h("div", { key: '73b26742b2f711275dcd6c2978d6011bed9ec739', part: "filter-body", class: 'filters__body' }, index.h("slot", { key: '8b25487ecb0646298f006fce567dce9aa170321b' })), index.h("div", { key: '1ff80f9caf563a5436029044fa7de34dfba4f8c8', part: "footer", class: 'filters__actions' }, index.h("slot", { key: '384b1a0e11ce532325c394e2e986c52a08678c68', name: "footer" }))));
    }
};
