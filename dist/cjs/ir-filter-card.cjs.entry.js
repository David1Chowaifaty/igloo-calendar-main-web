...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '114031bdef24e8ef64b5944653d7823875fc3ff0', class: expanded ? '' : 'filters__card__collapsed' }, index.h("div", { key: 'a749cbe97058348287e9c415be99bfde598465f4', part: "header", class: "filters__header", slot: "header" }, index.h("div", { key: '5a55b8f248b574180f594d744175909fb33bf94b', class: "filters__title-group" }, index.h("wa-icon", { key: '78a8dcaaa59fb11357e2d5dd6bda00c3a2fd1861', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: 'c36c41f5ef0891571b742a7ec40783836604b1bf', class: "filters__title" }, "Filter")), !this.isDesktop && (index.h("ir-custom-button", { key: '70ba680508e55621fd7cdb42a1076dd4422a70e2', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '48c96f83c3a28362690af8933422d810d1ce7892', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), index.h("div", { key: 'e6a2ecf8664845734169af0299655cc1ef31a797', part: "filter-body", class: 'filters__body' }, index.h("slot", { key: '0c3c4a460efc9a6f48cd901ba8b97e13ada243ab' })), index.h("div", { key: '0e577d14fb014f0bcbc2d6985d986625c2d85db9', part: "footer", class: 'filters__actions' }, index.h("slot", { key: '8f5d1acb9d418d20352ed1deacede845973c69ab', name: "footer" }))));
    }
};
