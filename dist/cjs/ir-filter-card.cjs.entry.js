...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'b484c5caaeb0830bb4d2ea405ed44678c3d2ebd7', class: expanded ? '' : 'filters__card__collapsed' }, index.h("div", { key: '487d3c5c0d489a2a8b98b0f2a1369bbab40d5f00', part: "header", class: "filters__header", slot: "header" }, index.h("div", { key: 'b07c17e4d7e1eb59defef969e2d6250da8b8b17c', class: "filters__title-group" }, index.h("wa-icon", { key: 'f7c003d378e7978654a47ff97ba2bb473d96e307', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: 'cf59aca269c88c0b7857b9302662e56a63c7d9cd', class: "filters__title" }, t.t('Lcz_Filter', { fallback: 'Filter' }))), !this.isDesktop && (index.h("ir-custom-button", { key: 'e133f97b2f9f60c23a6a6b53029597a59ff02da0', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '7f8bce83aeb00f6891c3fcd6926bc3d99c5fd54a', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), index.h("div", { key: '24bb14c748f5c095fda90c598fd2decd23776670', part: "filter-body", class: 'filters__body' }, index.h("slot", { key: '63e8ad002eb8cf9d606385616727df8b544dd2f5' })), index.h("div", { key: '9f6b0dbdf3258c1bbda4229cbc8091be97a54709', part: "footer", class: 'filters__actions' }, index.h("slot", { key: '900dfdc9ea3086be1576f07fd692a82444fec5f1', name: "footer" }))));
    }
};
