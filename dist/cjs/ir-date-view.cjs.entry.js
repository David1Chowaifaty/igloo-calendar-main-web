...
const IrDateView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '867b86a21539c3e9471aabddc2d638958f9df70e' }, index.h("span", { key: '79eb75bf20a9e7af07ff7ad1280b818c64690014', part: "base" }, index.h("span", { key: 'b576d2a9e8789c52d012bebc433bf7b735643b20', part: "from-date" }, fromStr), index.h("span", { key: 'a4a981abd985b1f56514dc858b1b837a170be9ec', part: "separator", "aria-hidden": "true" }, index.h("svg", { key: '7d7ebf986a129a0422d0fc440d37151e9b266281', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, index.h("path", { key: '8b1a2b17745a0b54b481988a3da629ab1c49e4f1', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("span", { key: 'be2234fc9474d8e9521ffd8bb95b5c642a61c2b0', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (index.h("span", { key: '55705b6e62f031fdb503fc0abc1811d82967cc99', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
};
