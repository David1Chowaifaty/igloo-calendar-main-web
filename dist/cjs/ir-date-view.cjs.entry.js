...
const IrDateView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0a9f6ae457bc0774b300fe245efdb90fa582f2c0' }, index.h("span", { key: 'd925a9bcb43a2bb6c5eeb79a6e45ffe46b0ff8fa', part: "base" }, index.h("span", { key: '95455250a8139e9dd10924a10e30dd2ec31d5841', part: "from-date" }, fromStr), index.h("span", { key: '9a5ea4a659dcef2225d8fb7a5db162d10df15116', part: "separator", "aria-hidden": "true" }, index.h("svg", { key: '9d0a361716583787968ca1595eca4c822aa7cb50', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, index.h("path", { key: 'f1a0fb296cc33a9585a4df56f5a0cfe19ae4ab53', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("span", { key: '63d958c5bce6cd3985e93b5bea137ceee66197a8', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (index.h("span", { key: 'b66e9930ec100ecb19f445df8724ff7b5c8602fb', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
};
