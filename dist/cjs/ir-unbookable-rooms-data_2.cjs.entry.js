...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: 'd89b59b2401864e73992682934320a4377253a49' }, index.h("wa-select", { key: 'ccd5873cb7c967ccad7686a9b49914a3a94b07ab', label: "Look ahead", size: "s", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (index.h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), index.h("ir-input", { key: 'f74bb9b6f0fa1793676ed1c9d805ae6c10727b7c', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (index.h("wa-select", { key: '5d39023f1ec5f6cdd36113bbd37064a23ce1f9a1', label: "Country", size: "s", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, index.h("wa-option", { key: 'ba5d134458a0f4669d51ddb92101da6f7c4c324b', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (index.h("wa-option", { value: id.toString() }, name))))), index.h("div", { key: '8fbd2b162877f1a14b059d61ada334d8bf2ce1ec', slot: "footer" }, index.h("ir-custom-button", { key: 'fce4f886e6da34d02c014606393ad73ab302ded1', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), index.h("ir-custom-button", { key: 'd469f924546c1677beaa60098971eca1738c9022', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save"))));
    }
};
