...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: '3dc51b1b5df5bae7dc624c6d635f0375e0c4db0e' }, index.h("wa-select", { key: '143bc4d1ace21cab502367e754e4ef104d36a397', label: "Look ahead", size: "s", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (index.h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), index.h("ir-input", { key: 'a9f47c074a4dbce93e6cd996d59b7306fe92db62', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (index.h("wa-select", { key: '3f2bc1f7fcf448f3e28f20a2c95da744879afa5b', label: "Country", size: "s", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, index.h("wa-option", { key: '78718b80943eefbf04025021174f56b991d3af36', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (index.h("wa-option", { value: id.toString() }, name))))), index.h("div", { key: '4ad77457af234b5df418aee209f0b2ab3aba419c', slot: "footer" }, index.h("ir-custom-button", { key: '0bfd8b25474b6631f076accb5661abfd3939ca2d', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), index.h("ir-custom-button", { key: 'b41f90cb2bdddd23367aa2391f4ef13f7bf45f24', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save"))));
    }
};
