...
const IrUnbookableRoomsData = class {
    ...
    propertyNameFilter = '';
    todayFormatted = irDate.formatDate(moment.hooks(), 'MMM DD');
    ...
    getEndDateFormatted() {
        return irDate.formatDate(moment.hooks().add(this.progressFilters.period_to_check, 'months'), 'MMM DD');
    }
...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: 'ea788248c048d8ae13dda3e022ef56756bae9bb9' }, index.h("wa-select", { key: '162df8a117ce8bce54074af87c70f3d8bba8b077', label: "Look ahead", size: "s", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (index.h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), index.h("ir-input", { key: 'c7e0c078313ebea1531f88663a8da3fcfcf6a252', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (index.h("wa-select", { key: '758e5ec81dc44a89019eb2004ca0f2b9c10f9365', label: "Country", size: "s", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, index.h("wa-option", { key: 'f32e078c49757b96c24523a7cc748f96c0c16a19', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (index.h("wa-option", { value: id.toString() }, name))))), index.h("div", { key: 'c2a648459e9c46bc16d8b9e6d50cdacf45366efc', slot: "footer" }, index.h("ir-custom-button", { key: '6f3c25502f55f2719f4e7586f0b78260077f0114', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), index.h("ir-custom-button", { key: 'd159dab646bf9643af9ea4efe15860673c25f7e1', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save"))));
    }
};
