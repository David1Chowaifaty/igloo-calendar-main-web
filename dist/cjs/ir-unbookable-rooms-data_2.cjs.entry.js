...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: '0540f775dbf460d8d1e6d32aee6ec3cbcde989c9' }, index.h("wa-select", { key: '71e6904320bf5c33961afe17a3d8d25bfae8efdb', label: "Look ahead", size: "s", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (index.h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), index.h("ir-input", { key: 'df0e65a71b1393d6e78f333743249e161934990e', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (index.h("wa-select", { key: 'e5e10ca177f24fdba711b3607d233ba6ac7b83bd', label: "Country", size: "s", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, index.h("wa-option", { key: 'a00ab621e6124a1d17c9bc638dba7f1945a2eb3a', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (index.h("wa-option", { value: id.toString() }, name))))), index.h("div", { key: 'd5ff8926da349078c527244d40336a68fe49762c', slot: "footer" }, index.h("ir-custom-button", { key: 'd2e2e303433fa8470206931ab08ade1410d3c782', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), index.h("ir-custom-button", { key: 'a7cca5655911517448b1bed0bf883a5c518ab63c', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save"))));
    }
};
