...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: 'a537a8e280dbed6443f1dd69a237d0f18d430664' }, index.h("wa-select", { key: 'e25ad95879104b76209a43a5c454de3b6eb79d95', label: "Look ahead", size: "s", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (index.h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), index.h("ir-input", { key: '89f38ed87b4fa502234eff2398c3fba2fc76fc9d', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (index.h("wa-select", { key: '435a87b9e0d9f94bf1eb53c8537c40bb1a206c23', label: "Country", size: "s", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, index.h("wa-option", { key: '7d65b58d0e4bac2f407c680e75ee275750031bc5', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (index.h("wa-option", { value: id.toString() }, name))))), index.h("div", { key: '32d6e797084a8d40ed045ae8be01666c7dd64b42', slot: "footer" }, index.h("ir-custom-button", { key: '89a54e4c2adc517a1e3d8f1bc44e553135de551e', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), index.h("ir-custom-button", { key: '05003876d0d41411479b28884b027375923bed6a', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save"))));
    }
};
