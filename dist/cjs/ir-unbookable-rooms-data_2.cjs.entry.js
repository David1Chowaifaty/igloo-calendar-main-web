...
const IrUnbookableRoomsFilters = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c8874c871a6f67298bcd17a14c7ae4a5ed6f2574' }, index.h("wa-card", { key: 'e9fe50894b13474b04c95ffb98becbdc96a177c0', class: "unbookable-rooms__filters-card", appearance: "outlined" }, index.h("div", { key: 'bd9d850208221ebe8a71635a6a9d11fd44f23686', slot: "header", class: "filters-card__header" }, index.h("wa-icon", { key: '231a19d7e045ff9aa2c0011faba28441daf0ed5f', name: "filter" }), index.h("h4", { key: 'a7142db88f257fdd18439e788090b6e2634c3006', class: "filters-card__title m-0" }, "Filters")), index.h("wa-select", { key: '602b6697281eb37052c9634df43639e4277f0e95', label: "Look ahead", size: "small", value: this.filters.period_to_check?.toString(), defaultValue: this.filters.period_to_check?.toString(), onchange: e => {
                this.handlePeriodChange(e.target.value);
            } }, Array.from({ length: 5 }, (_, i) => i + 2).map(value => (index.h("wa-option", { value: value.toString() }, value, " month", value > 1 ? 's' : '')))), index.h("ir-input", { key: 'ec320f364cb44bde2c7dfce4efe3f633b1310889', type: "number", label: "Minimum consecutive nights", min: "7", hint: "Period where room types are closed for booking.", max: "60", value: this.filters.consecutive_period?.toString(), "onText-change": e => {
                this.handleConsecutiveChange(e.detail);
            } }), this.mode === 'mpo' && sortedCountries.length > 1 && (index.h("wa-select", { key: '62c76e9191792bca5ba30926a955fdeed5bb3556', label: "Country", size: "small", value: this.filters.country?.toString(), defaultValue: "all", onchange: e => {
                this.handleCountryChange(e.target.value);
            } }, index.h("wa-option", { key: 'e14bd1f0cf7fbfd97559e50ad95a0131e69e34f6', value: "all" }, "Show all"), sortedCountries.map(([id, name]) => (index.h("wa-option", { value: id.toString() }, name))))), index.h("div", { key: '779056b6156d1aa9d6d1163109772404a5329e8a', class: "filter__actions" }, index.h("ir-custom-button", { key: '7833306dfae1b0fc386689c97f01c5f3d390a6e8', onClickHandler: () => this.filtersReset.emit(), variant: "neutral", appearance: "filled" }, "Reset"), index.h("ir-custom-button", { key: '8f7460e56a3c29b48b1b7b07fc00200a143a849d', loading: this.isLoading, onClickHandler: () => this.filtersSave.emit(), variant: "brand" }, "Save")))));
    }
};
