...
const IrNotifications = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: '5a8abaf0cf655e1e3be39d44dd57860f6de761b2' }, index.h("div", { key: '51f61eb639907e18763a0d51509192a2f6762468', style: { position: 'relative' } }, index.h("wa-tooltip", { key: '4a7a627d10d7dd4adf1a008d3490658829baf68f', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (index.h("wa-badge", { key: '0f4f57b1a049c9326813196e5e78c0f444432570', pill: true, class: "header-notification-badge" }, this.notifications.length)), index.h("wa-animation", { key: '732f9bc8e9603e7b216df98c9734a5090765da12', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, index.h("ir-custom-button", { key: '00621d2032ad0fe0da5ccf6ae14a98a80866720a', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, index.h("wa-icon", { key: '07906d9b96f77c19d8a81a79e79619998b732e63', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.2rem' } })))), index.h("wa-popover", { key: 'c9c267df837683f9c27531d39d5f7170715a7b95', class: "notification__popover", for: "notifications-button" }, index.h("p", { key: 'b44dc30fc5f9efbf166c21ecbb2ba189ebf7cfca', class: "notification__popover-title" }, "Notifications"), this.notifications?.map(notification => (index.h("div", { class: "notification-item" }, index.h("div", { class: "notification-item__content" }, index.h("p", { class: "notification-item__title" }, notification.title), index.h("p", { class: "notification-item__time" }, this.getRelativeTimeFromParts(notification.date, notification.hour, notification.minute))), index.h("span", { class: "notification-item__unread-indicator" })))), this.notifications?.length === 0 && (index.h("ir-empty-state", { key: 'ea6a4db571dd3e7d90bb9005f34834e963b72edd', style: { width: '250px', height: '150px' } }, index.h("wa-icon", { key: '1badee06ff8f5c681d06b79e51b99d3665f632cc', slot: "icon", name: "inbox" }))))));
    }
