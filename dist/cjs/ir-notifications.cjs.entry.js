...
const IrNotifications = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: 'b73bc6ebe3403e0df518d50a5d626def9bf13585' }, index.h("div", { key: '0ffa6639db1a0f19bb3293c987d23e78143dad79', style: { position: 'relative' } }, index.h("wa-tooltip", { key: '6155bd42080e97e9b402c325f0012798aeaf8ec1', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (index.h("wa-badge", { key: '15fa94cba87f30a87b372cb42f940736d0114a24', pill: true, class: "header-notification-badge" }, this.notifications.length)), index.h("wa-animation", { key: 'fa2ad28162bee2f0a5e96d26552b2bc34eeb0d2b', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, index.h("ir-custom-button", { key: 'f126b679e29b428e9522526dc554221aa2466275', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, index.h("wa-icon", { key: '5c2ef9e9c7a80c0a19bf19cf8508284f1f3b5c15', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.2rem' } })))), index.h("wa-popover", { key: 'da51b7d3fd43e6a6cf9cde43be4f78d53b58c1f6', class: "notification__popover", for: "notifications-button" }, index.h("p", { key: '46622fec7705fc8df7eddc6432e774d2c502829e', class: "notification__popover-title" }, "Notifications"), this.notifications?.map(notification => (index.h("div", { class: "notification-item" }, index.h("div", { class: "notification-item__content" }, index.h("p", { class: "notification-item__title" }, notification.title), index.h("p", { class: "notification-item__time" }, this.getRelativeTimeFromParts(notification.date, notification.hour, notification.minute))), index.h("span", { class: "notification-item__unread-indicator" })))), this.notifications?.length === 0 && (index.h("ir-empty-state", { key: 'e58e4973838df176314ece91946c2b4c734a0d21', style: { width: '250px', height: '150px' } }, index.h("wa-icon", { key: 'edbf342c55c62508436c18543e232c28579c739e', slot: "icon", name: "inbox" }))))));
    }
