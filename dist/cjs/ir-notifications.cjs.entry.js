...
const IrNotifications = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: 'ac94c97470b16915132ca1da0b823c331afe9a2e' }, index.h("div", { key: '72588999d10945460dca45376a191b23defbe1d7', style: { position: 'relative' } }, index.h("wa-tooltip", { key: '416b5d25757471c29237d10f8d2dc3c493b4b206', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (index.h("wa-badge", { key: '0fd3868cd428bc0a1d990b10ba966113732f72bd', pill: true, class: "header-notification-badge" }, this.notifications.length)), index.h("wa-animation", { key: '2e487975930c0b33a2e4f6a02de4b6630a1e41e8', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, index.h("ir-custom-button", { key: '043c80f42fd4105ddda91d6e5c8f6144c7fa6d71', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, index.h("wa-icon", { key: 'f070ff39ae6547b3590491b20f9d3ec0ec57d182', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.2rem' } })))), index.h("wa-popover", { key: 'f1f905bb883f334ccc2376437ab6eb60d9aeccf2', class: "notification__popover", for: "notifications-button" }, index.h("p", { key: 'be21a192e187d510b6ef7eb9e143813c00652857', class: "notification__popover-title" }, "Notifications"), this.notifications?.map(notification => (index.h("div", { class: "notification-item" }, index.h("div", { class: "notification-item__content" }, index.h("p", { class: "notification-item__title" }, notification.title), index.h("p", { class: "notification-item__time" }, this.getRelativeTimeFromParts(notification.date, notification.hour, notification.minute))), index.h("span", { class: "notification-item__unread-indicator" })))), this.notifications?.length === 0 && (index.h("ir-empty-state", { key: '1674815d5c8e3c933956a3ab7a5a3fdaa220a752', style: { width: '250px', height: '150px' } }, index.h("wa-icon", { key: '13c7b80d14ba6883e16adc7b0cf0cee686f13209', slot: "icon", name: "inbox" }))))));
    }
