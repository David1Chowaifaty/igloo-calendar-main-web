...
const IrNotifications = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: 'cd3436e402d6b25d8f32d403db82dbc64da3c8fa' }, index.h("div", { key: 'f04e2039ff4db399865586df338927a59abdf15c', style: { position: 'relative' } }, index.h("wa-tooltip", { key: '16b0cd1b456c22450b09f7c9ced5b9f38affc78a', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (index.h("wa-badge", { key: 'fdb6900087679d135591247bcda0edc93722ed4c', pill: true, class: "header-notification-badge" }, this.notifications.length)), index.h("wa-animation", { key: 'c72d1cd033b47919770b050ed8be0994c2231651', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, index.h("ir-custom-button", { key: 'e5447bf570ab2c2af02515fe097e9e1b5a6f83ba', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, index.h("wa-icon", { key: 'dc2fa3cb5d56f4d2a6fb8ba074ab006ada63ab73', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.2rem' } })))), index.h("wa-popover", { key: 'e348c48c54dad22f4476be7336f11dccb97aedfa', class: "notification__popover", for: "notifications-button" }, index.h("p", { key: '790a06707e5a6bca030d0935ef5df57eb70c6394', class: "notification__popover-title" }, "Notifications"), this.notifications?.map(notification => (index.h("div", { class: "notification-item" }, index.h("div", { class: "notification-item__content" }, index.h("p", { class: "notification-item__title" }, notification.title), index.h("p", { class: "notification-item__time" }, this.getRelativeTimeFromParts(notification.date, notification.hour, notification.minute))), index.h("span", { class: "notification-item__unread-indicator" })))), this.notifications?.length === 0 && (index.h("ir-empty-state", { key: 'a651fada1f0996c9b863ca0fe20d04d62dcb87d2', style: { width: '250px', height: '150px' } }, index.h("wa-icon", { key: '821815d491bdccc1f41f3988021df1619452abe7', slot: "icon", name: "inbox" }))))));
    }
