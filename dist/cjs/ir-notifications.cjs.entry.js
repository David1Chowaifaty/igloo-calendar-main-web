...
const IrNotifications = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: 'b436c49e8200ca5ae259842ed7ae121d9fcd7f65' }, index.h("div", { key: '5a8793f6f8260519bc7d0cfd098468c52b208a89', style: { position: 'relative' } }, index.h("wa-tooltip", { key: '0655a88669c081a115d8a5c7a23853e5a401775c', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (index.h("wa-badge", { key: 'be5a30d5144aafdb64e77a6e3918c064b8ff391e', pill: true, class: "header-notification-badge" }, this.notifications.length)), index.h("wa-animation", { key: '97f5460ff6f50740fc15779a552ebd4f59dc1767', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, index.h("ir-custom-button", { key: 'd3cadb1cf073335faed2bd41796d74a045dcff0c', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, index.h("wa-icon", { key: '53db4b17f81686a0483d56fffc147b4226e624eb', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.2rem' } })))), index.h("wa-popover", { key: 'bd2631ca623a2df00d66b468cd7c935d4031d524', class: "notification__popover", for: "notifications-button" }, index.h("p", { key: 'bac9806be6db2cdca8443a0914c3fd8113866c5f', class: "notification__popover-title" }, "Notifications"), this.notifications?.map(notification => (index.h("div", { class: "notification-item" }, index.h("div", { class: "notification-item__content" }, index.h("p", { class: "notification-item__title" }, notification.title), index.h("p", { class: "notification-item__time" }, this.getRelativeTimeFromParts(notification.date, notification.hour, notification.minute))), index.h("span", { class: "notification-item__unread-indicator" })))), this.notifications?.length === 0 && (index.h("ir-empty-state", { key: 'e0b626425863833434f699eca1d57622e47bcb7b', style: { width: '250px', height: '150px' } }, index.h("wa-icon", { key: 'fae46265dc7a9df35cad91f724e1218a2384128c', slot: "icon", name: "inbox" }))))));
    }
