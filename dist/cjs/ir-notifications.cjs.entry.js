...
const IrNotifications = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: 'a64e377ede4fda1d565a62610db08aef77dcd732' }, index.h("div", { key: '00ba26c08d088279fa5bb0ec4a3c3f3e479d2795', style: { position: 'relative' } }, index.h("wa-tooltip", { key: '0fb88e32671b17d2339c667247902bba802dbfaa', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (index.h("wa-badge", { key: 'f64e73471f7fa7c4509964234194de78a6a160af', pill: true, class: "header-notification-badge" }, this.notifications.length)), index.h("wa-animation", { key: 'bc76c0f00db05350843ab0569ae23451bd19f48b', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, index.h("ir-custom-button", { key: '5040935fe1c1e3e1b2b480f77c009d62ca2db122', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, index.h("wa-icon", { key: 'eb3ca46231c2c6b2cfd524d2714fb661c3be80b6', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.2rem' } })))), index.h("wa-popover", { key: 'bff2a25dc88839bd9a8c72052f78f3a9d2532bd3', class: "notification__popover", for: "notifications-button" }, index.h("p", { key: 'a441f059562c212f397b12e7776163adbac86410', class: "notification__popover-title" }, "Notifications"), this.notifications?.map(notification => (index.h("div", { class: "notification-item" }, index.h("div", { class: "notification-item__content" }, index.h("p", { class: "notification-item__title" }, notification.title), index.h("p", { class: "notification-item__time" }, this.getRelativeTimeFromParts(notification.date, notification.hour, notification.minute))), index.h("span", { class: "notification-item__unread-indicator" })))), this.notifications?.length === 0 && (index.h("ir-empty-state", { key: 'ed326fea7cb5a9301d405dde206f986194997ce5', style: { width: '250px', height: '150px' } }, index.h("wa-icon", { key: '66d963deb419454b3f4616b46e5ed66c7fd59528', slot: "icon", name: "inbox" }))))));
    }
