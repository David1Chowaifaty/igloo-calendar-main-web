...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'abe1dea2ada46fe591bc7d43c9598bde7a306185' }, index.h("div", { key: '713604136c82fe536de59ef6771f636500954f1f', class: `m-0 p-0 mb-1` }, index.h("div", { key: '99bbd86331f69481e03c092f2aa31a721e491e40', class: "text-left p-0" }, index.h("ir-date-view", { key: '36f52052ef7b9a57fa4e4888350f04258e461fe9', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), index.h("div", { key: 'ea1063b1dbbd887e2913866ad330b8851ce5d49c', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { key: 'cca3d01e62af3e61752a9ed15388d07952aceaef', class: "mb-1 " }, index.h("label", { key: 'eee9ff75bafaa1857adce4e9dca02df2fbf5f221', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales_store.locales.entries.Lcz_Reason, ":"), index.h("div", { key: '5aeb1771559e7ae39132e98d220966fc58dc08ad', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { key: '81816af7872b5fdd48763e1595b7617a60ed76b8', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { key: '77d40ea3247071596c2bfe96a43948b49bca0f33', class: "align-middle out-of-service-label" }, locales_store.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, locales_store.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: locales_store.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, locales_store.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, locales_store.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4b003dc630be78b876920ef35da2f3fd073fd284' }, index.h("div", { key: 'bd9c8183587e4612ba94b7090b7160c425b5fdd3', class: "text-left mt-3" }, index.h("div", { key: 'cc6dbfb087450820c446dd281a0345ef858bc612', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: '2b8a7fd05e1cc94fa31841853122091414dfc01e', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: 'abae37b0a92434091363c4f749880e1eae2313f1', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: '1a657e8132ecd7777e7efe2a4cf281229b107445', testId: 'main_guest_email', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: '649633908baa0273bcb7eb154178238fa39ff8e2', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: '6067fe9c6c6180351cd1149690774bd64b38a1c6', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '5b79e055714fc9677d02a515f8d80fbce21453c1', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: '796ec2b3826e0ce3eed04fa1c913688d61b02fe6', class: "p-0 flex-fill " }, index.h("div", { key: 'c507eb5c39e2b36697cf0376068a56354ec55e15', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: 'feec1232ed9f62a920131d3ff48b331958577762', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: '617ed5384b05be1550fa3e3ebc350e039d9ec4b4', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: '829db9f627a728bb62a06bec790317eef5d917a1', "data-testid": "main_guest_first_name", class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => {
                this.updateGuest({ first_name: event.target.value });
                this.handleDataChange('firstName', event);
            }, required: true }))), index.h("div", { key: 'b3840db638f5d0faf44cf4be4e813147f5ae65eb', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '93bdcd1400f5d31602107ffc361fe4a0f9d7afcc', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: 'e12b9c1cc36da9fd1c95a982387ff4873b63b24e', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '06e9204cd75393e4ec4d37ae7ec06f4af0cccc83', "data-testid": "main_guest_last_name", class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: '27f4f742c104e3731217a90931c70e488ac0464b', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'a950b5a521087c5f20fb167ae8912bc8e8649eac', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("ir-country-picker", { key: '39b26c8ea6b5f26b11f928804f94224ccf0382db', testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) })), index.h("div", { key: '43a82ad117ce55d906835770e7745bb31da9d6d4', class: "form-group p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '5b6421a115e1c772b1f6231761799985693920e2', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: '16325ab5e957877631a5a699e63c6de965bac8ce', class: "p-0 m-0 controlContainer flex-fill" }, index.h("ir-phone-input", { key: '82140ce2d6ed66567c9acb08f8e36ad7451ede8f', testId: "main_guest_phone", language: this.language,
            ...
            } }))), index.h("div", { key: 'c0fd81f4140c94b442e0d7bcc11eceaeca31ad30', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'a16cf321c1aec5614c7781a5a692c7b3e1255a36', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: 'da628c93924fa3cc2ce5d2047b7b11dca911303d', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '652ccd2b6e3b2959de9f6202fc6f3e7440bb6f8e', "data-testid": "arrival_time", class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: '9d2f4df4f3ed7a5de94c3fe6f8a32f8ea41746d5', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: '83b7f65be00092dea5402092390ec9f8671987d4', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '42681637f09758cc8a816fe0436d0ce5a7b9554d', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: '9ef75666206b9cc0a740d190dfa3a4d4aa64b3bb', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: 'bf4c0ee272f97887ed5d6ea9f4510d7b041a36a0', "data-testid": "note", id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.paymentMethods.length > 1 && (index.h("div", { key: 'e4995883d7561425503b4455c16b8c6b92e94072', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'c1fe719d79c25ad5ad1f2be8095a0d772ff4f5ff', class: "p-0 m-0 margin3" }, "Payment Method"), index.h("div", { key: '5e1503186f25a058ff2191bef17435822379fbd0', class: "p-0 m-0  controlContainer flex-fill" }, index.h("ir-select", { key: '9a1ce2038aa363389d654b467a7a73d2cf0ede0e', showFirstOption: false, selectedValue: booking_service.booking_store?.selectedPaymentMethod?.code, data: this.paymentMethods.map(p => ({
                text: p.description,
                value: p.code,
            })), onSelectChange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.detail,
            }) })))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: '43a6711bde9369bdfc5f861f87ded0ec47c680ae' }, index.h("div", { key: 'fe5ab29c0800141ef86b1ea896017134ff8926fd', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'eb7c961b2bdd7a1ed5102d60ac02146b0cdf7fa8', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: 'dadfd0d219397da58fe8a974620c2929055f4ec7', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'c5fd286c122dfc17e89255385b4bb280e3c38463', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: 'c801d593dc36205ca28af4cf5d85bc4b3762c9a9', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '0ce132d85a2473fcefe357c0b541bd5226e92eab', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: 'b8d0cb066d3680cb2b071fa0545b44cf38ece069', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'ddeb7a18a89af583e4748618c4f53075150bcf13', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: 'fe731ff89b714cf4845ae64144c5086681fd4567', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '728392bd07c579104bd445e3902e41b750374173', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: '6297aa1608b734b50678839d81a1dda4c5115cb4', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: 'b4c56ae9dd9ebf007ada537ab3ff257656522c3a', class: "p-0 m-0" }, index.h("select", { key: 'df466821f5dad374d9b610917874ed3a18bdc5cc', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: '911df24cd66f37b0a702ed90f0667fa828739c53', class: "p-0 m-0 ml-1" }, index.h("select", { key: '11c56635187f58c0206bbb10edc67734f5bf35e9', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h("div", { key: 'b6bd06cdc0f4bc94f9a4e05cf7930e83f7e03dfb', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'a81f28dbe71143a9b772164fe4e7fd670223cc7b', class: "p-0 m-0 margin3" }), index.h("div", { key: '3b755bd4135634c3e40ba2ac3f2c8e6751f73f45', class: "p-0 m-0  controlContainer flex-fill" }, index.h("div", { key: '9803269881b850318db68f4907e848c4eb9c9623', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), index.h("div", { key: '2a92a53880b167d4aab870c4e4276e7a8a9cfae3', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: '6c45524dc11f4b7a86af2b50c39955b6c5e72915', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: 'a915ef4722d9ec319fed8916788f592ffc0d2673', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: 'c0cec19046aeec53829fed9901b6825aa8a23e67', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'eed730d8034f9ae9e1e155b48308f9d1b72bb91d' }, index.h("div", { key: '1e9280667cb01d31352051928af95cd5fc0794a4', class: 'd-flex align-items-center ' }, index.h("label", { key: '42ee0aac690edd96fd7122073fc00fe779051e97', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'f16fa77de6366533a208990a9f8d9ab7473e938e', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'a15e5c703a04849b61b5029ffe6503b8c1cc8437', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'b7b7478279e50636d53666364e2dd57c8830f4d9', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'b4fa89b7ed6fb82f273d856d5ca6199828eeb78d', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '63b7391cc275b4c0bd7ee1cc494d8476b54822b1', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'c7251afa21d07b9207b3576af3f00f43d4610bbc', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'c8af3060c33c81b8a3da101c05e06649229704a8', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'a0b531f9090f1741f6da322e959b253b9ccc4b0b', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.open = false;
                this.companyFormClosed.emit();
            }, label: "Company", id: "dialog-overview" }, index.h("div", { key: '32133da79cd9d5ce4c4b2efed30cf15945af34fe', class: "d-flex  flex-column", style: { gap: '1rem' } }, index.h("ir-custom-input", { key: 'e79684349433ac5567ed3e370b559f7485d56882', "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-custom-input", { key: '64b89c3ce970d5a68e65366e5b867ec84a98ceca', "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })), index.h("div", { key: 'b166262ca6348279981f22c5e4f95911767a7cfb', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '684a3417929954ba949c901dda4a631bbb2ec59e', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'fc3f43b7032997f5d8364b349820f970a7065bab', loading: this.isLoading, size: "medium", variant: "brand", onClickHandler: () => this.saveCompany() }, "Save"))));
    }
};
...
const IrBookingDetails = class {
    ...
    render() {
        ...
        return [
            ...
            index.h("ir-invoice", { open: this.sidebarState === 'invoice', onInvoiceClose: e => {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    this.sidebarState = null;
                }, booking: this.booking }),
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '170fa1fbffec3c7414abab3a7ab2d8c8c8180859', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '536fc1c46a5ba17cdeb2ba694b32e486b8dcb8fe', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: 'cdbf70c72997b05b3f66fa80b8ef58f8b1149e41', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'b461a2fac8eb31d100c1979c7df999ced57f1ca0', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'a057bdd0434244e8f92fd537cfe796047bd1518a', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0d31cfced3e10e3c9296e74de3da0bd0f85dce62', class: "fluid-container px-1" }, index.h("div", { key: 'beee0303afe5de6164bead0edce74385b08e670c', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: 'e7404e737d4ceec7b5a315943f2a38146703adfc', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'caa28cade2d55bb9dfd234f4695d810cdf681e91', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '39c69f82014019a8d19604d41daefc1ba5177a28', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '030ac8af890c0c7964fc67177d953460ce75aa4e', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'a8100a836a316e1e4dd92f1e96afbe26cea9dce7', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '80fe68fe0ba22f5649171b45a6c27216b91b724c', class: "d-flex flex-column align-items-center" }, index.h("ir-booking-status-tag", { key: 'e127da340314bb48f416ef33ef3de377852c1bb6', status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), lastManipulation && (index.h("ir-popover", { key: 'e8eb9b0e51446550fd5513f87c6b42d6828dbcce', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: '1d58d4c86ff46a1d113225e008e1ad3a4e36c081', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '2ec2505c3dbbdf5503bde0c0e67388fb43d88302' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '66a1f8137499912ad53d43f90036934606da76a4', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("wa-select", { key: '23dcb5a1a7cdae14b3e1bc18d83d00bd03244487', onchange: e => {
                this.bookingStatus = e.target.value;
            }, style: { width: '120px' }, size: "small", placeholder: "Select...", value: this.bookingStatus ?? '' }, index.h("wa-option", { key: '4dd7f297f8089ce25ca2308a17ee7914f1eac6f4', value: "" }, "Select..."), this.booking.allowed_actions.map(option => (index.h("wa-option", { value: option.code }, option.description)))), index.h("ir-custom-button", { key: '0db301916fd02c35b704c969f776f1618582f128', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), appearance: 'accent', size: "small", variant: "brand" }, "Update"))), index.h("ir-custom-button", { key: '37448c1b6c42ee121fb7d15bfba828143f0d2420', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), index.h("ir-custom-button", { key: '8f4d2ba6c141d9977266f14b639760342cb8a51b', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS"), this.hasReceipt && (index.h(index.Fragment, { key: 'dfbcde2a388c655d99a59af033ccd6c817a63c7d' }, index.h("wa-tooltip", { key: 'a99094158038316893b2188aa4357f3c67e6c342', for: "invoice" }, "Print invoice"), index.h("ir-custom-button", { key: '4796f3d9288a712b2f9ee7a55b403ff7a8b45bdc', id: "invoice", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '93542e3dca20c02e9c9ba9660b67ba32f29edea0', name: "file-invoice", label: "invoice", style: { fontSize: '1.65rem' } })))), this.hasPrint && (index.h(index.Fragment, { key: '27b3e0c55ee904ac81ed8c7299cec725a83db20f' }, index.h("wa-tooltip", { key: '331b88ee1d4c0490f62e8f5b04feb9db8ac3c8b1', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: 'f6b2b0cf420a192a65449807b3045a984122dab8', id: "print", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'd9d8924b4251a5a144479e062287da7ae0dc4447', label: "Print", name: "print", style: { fontSize: '1.65rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '351b7cbc93bf161243b056514ddc924f05ea9269' }, index.h("wa-tooltip", { key: '87edcddc0a1c1e9fc67c55cc869d1baf6de84c9b', for: "email" }, "Email this booking"), index.h("ir-custom-button", { key: '3708b4c5ac2c4b3c7c10e8982f45ba54f8fa1857', id: "email", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'e40fdce74b40c25780e8fea65a5f3f40a60f50a6', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: 'a71e13f137f5954fa14318f54f01600799abe419' }, index.h("wa-tooltip", { key: 'b7c945c8333d389b68c2c58f493f7ec5cd6a0183', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '8c7aabed3dd378d5e076bbb8473dd3da58a217c8', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '94b0e31e81ef0b97578b9160d567a716df04988f', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: 'db1048a787d951ddc277d8597615c08230ed9586' }, index.h("wa-tooltip", { key: '086992e87fd35a694488d3cc0bb834b5367775bb', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: 'b6de9290251e6bf367ae7f81bf3e0ed757f22886', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'e80ed6fc2425dc0e04625e8309b3abf8c5f3df7b', name: "list", style: { fontSize: '1.65rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '87e2f4d0c66b5c19aca9a7220ca63ebba06f0920', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '1a778b2b55edcb849a24ed3f82b187a58805efcd', name: "xmark", style: { fontSize: '1.65rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: 'db1688abba2f2e3cf9a57f06f50eecb54234cd19', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '15cf0ae3afc8ad46233a9aafa2e2ccdf37b93388', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            } }, index.h("p", { key: 'a134717fc1e2a4ccfc94a28a9e73db7aedba6f7f' }, locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: '517698011ab48875ecd33226833e4dec79d38eed', class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '68cfd348f9c4f2fff7a3db2e3a9bf92dbb85e3ec', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: 'c0f5033e29174308e69e052e2925eee86b7b8e4b', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '2c4519904450250f27944496b49da8620e151866', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2fd022d7c9876b759a8de6d5d20a35c42e3f9ff8', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: 'b350c772f8d522819066db1d1763d4ae05e25dd7', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-custom-input", { key: 'b3d3fe05e336c7a8bc78f03d72c38cb44bac54f3', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: '2696289a21512da7638450e0dc034c7397e51f67', name: "start", slot: "start" }), index.h("slot", { key: '5a7b94790685d451b69d2ab97e498b3389c1576f', name: "end", slot: "end" })), index.h("div", { key: '119e931642e1dd343db0c22274c9b63a8cc7f7bf', class: "picker-surface" }, index.h("div", { key: 'a010756208ac523f06a86051f43b17f214ca8d59', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: 'f4da92421519de2fb5e417a77d15962a9cd44839', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '171a07ffd37a1fbd88ce962c8520dc3561771b6b' }, index.h("input", { key: '83ad28ec7268ed86d9a805b73435ceabfacc2f9c', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2d6d7ae95c72d5cbb4b74644b3627336f9a0a5be', class: "d-flex align-items-center" }, index.h("span", { key: 'a51a85e6e5a89f71c3b85d4f2a301b69edacc2b9' }, this.dates.from_date), ' ', index.h("svg", { key: 'cadde6bdc2cc4f5e63c58263277c34842a2a757d', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'd33fecc69d2485e0041ea80bc5f5715abcef5400', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '363ab9fd0a2841ae8f5aa45d19a7b5631f5cd45e' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'fa41fbf49e3ab1711405e767d79ff632239bb147', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '370723fd8176b4d8a5437387953aea85e5d6b362', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss }, index.h("slot", { key: '1c2f536d82ae0dbabf4aad52d0d67cdc7f6b0b7c', name: "header-actions", slot: "header-actions" }), index.h("slot", { key: '2d48c67fe7d6595439773a4d56efa029ca536704', name: "label", slot: "label" }), index.h("slot", { key: '3ff9c3cec08c155690d7066370d4fb54c05a7a4b' }), index.h("slot", { key: 'a37b51e18da13dfd72aa97e1d61d3a43a776b226', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '614d2ae9c09b39270a288fbe9757350123c18e82' }, index.h("div", { key: '8298c9f7b70b8c7984e410ec2cf889bcbf5a3b34' }, index.h("div", { key: '78d44a8ae9985d6170bcdaae0b55c54f44901050', class: 'extra-service-container' }, index.h("p", { key: 'ea0027a8a47a6e2a2b06d8d229d37d7fa1084b9d', class: "extra-service-description" }, this.service.description), index.h("div", { key: '88a69226be8558ff3af536f9e85b9bf8deec4b6a', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: '972758936e07b704bbd44680f12d3bc5a11c0522', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: '78b51def9957ea71cff0ccaf257259a66c31f245', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '3ac05eb0808b6acfd458e3dd9dc64b1a9b160e1a', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: '00cc65205b993d521d8e4fc9cf70c990acbdde7c', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'ed0a5d45b83a109432081e28f1273be096b9c8f7', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: '56ee03c269cd1b5317f5ccbd24c11f1a74a0f2ff', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: 'f735cf0794cc99730317652efc098371d5ee2daf', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: '3b554d9b407adb947cfd203235c31981d45de7ec', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: 'd6496b80b81b4ff1cf4f018098720fa22d20c8d3', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: '06dde955435bd903ac507c1d7d69fa1a630e27bf', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: '4c4af8cc8e99e93e230c59778edb9034473a9e92', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '98c5944a95dd1d768778aad05dc2b8c5e41f9184', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'd9e45ad0ace5ff87611a9d128ae1d8dc90ad44c1', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'bb71b95e1183583563ba4a10a1d6daaa40fceed4', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '3349394810de31c785a8d649eaf2ee1352edfc6c', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: 'f1e22c5963603000426e1424b196893dc2a7a0db', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '2fa49b201a01c2e2146dbe6c247c5d34584db986', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '1159b78247e31c5fd175d1a6169c8131b7e797c6', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '8dc633c250120edd5027eebbd86a3e4551dbb77a', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: '07fa3978fb07fa9d20d3503181e24a30b1089674', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '637dd0f0faf07c949fdbdf706dacf18982340744', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-custom-date-picker", { key: '39970fdfe8f2dad184be75a245dc7ddc41ac5cbd', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) }), index.h("ir-custom-date-picker", { key: 'c9b9e4f6557494b50c42d4b7746e2cf4fae6f778', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: '8d33a8f4a67053b875667a8d6b253cfe944a2277', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-custom-input", { key: '7323c979bc37e36dec5cbb37f427b2d8dca7250b', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: 'ba20b4ce6cca89bc4102084e8941efb8dba8dd26', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '24fd84c76e8d43028d0d7ab3abd1f328848d3610', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-custom-input", { key: 'aaa4341b0bd487b05dd469a9d685feff03db17e9', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: '4aab1185cae6b92f554ad1bc74d07573e4f8a6dc', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: 'fd66134085b032bcde32f474609c29b11347dd00' }, index.h("wa-card", { key: '431644dc2863c90b482b260082870e08252b258c' }, index.h("p", { key: '25801653388e389785eeb0a39c6231af89c666d2', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: '20422cbe02fda4dec2cd103a9c6dad47a2b49d87', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: 'a614467c9d90c221747d1ff1e4b2ef25014fa05f', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '63422deae473ba1364b9957015fe8f7ba9369bed', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && (index.h("div", { key: 'baff8fa8c61938a6f7908cf6b52da1a136d0c28e', class: "text-center p-1" }, index.h("p", { key: '8865e112a965104882f2b37c761029adb8775bd5', class: "text-muted" }, "No extra service recorded yet"))), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'da26fe2b8c6c65e047bee08710464898b59547fe', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (index.h("div", { class: 'loading-container' }, index.h("wa-spinner", { style: { fontSize: '2rem' } }))) : (index.h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), index.h("div", { key: '7db7a97672ac4262ec81b5e90855854d9f6f50d1', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '261b427e0e0cb9cbe9fdb3c7f8c6feb2cad838cb', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '5cb9d166fa0222cc2a446e500117a897f31138b5', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrGuestInfoForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '87e2a9f7947ae1dfc7d2da3c3831504d54bcaa58' }, index.h("ir-validator", { key: '516b6730a7900e645bf28f27bd19528a87b5a670', schema: guestInfoFormSchema.shape.first_name, value: this.guest?.first_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '259352da688ca404d6bbb22a99cb3ed761cb2646', id: 'firstName', value: this.guest?.first_name, required: true, "onText-change": e => this.handleInputChange({ first_name: e.detail }), label: locales_store.locales.entries?.Lcz_FirstName })), index.h("ir-validator", { key: 'f8beec9403c0247b247d29de059d5506bd57b199', schema: guestInfoFormSchema.shape.last_name, value: this.guest?.last_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '27e9f811f0514f2794f95e594c16bb0ca3653433', value: this.guest?.last_name, required: true, id: "lastName", "onText-change": e => this.handleInputChange({ last_name: e.detail }), label: locales_store.locales.entries?.Lcz_LastName })), index.h("ir-validator", { key: '4a20221a1a1e361eb27e87aa2409846abc02e118', schema: guestInfoFormSchema.shape.email, value: this.guest?.email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '78cd087ef6b84ad495d6443e4d6f6d2b4c9358fb', label: locales_store.locales.entries?.Lcz_Email, id: "email", value: this.guest?.email, required: true, "onText-change": e => this.handleInputChange({ email: e.detail }) })), index.h("ir-validator", { key: 'f2ee9bab5fefa2c8cbba3ebfbfc41870494947c9', schema: guestInfoFormSchema.shape.alternative_email, value: this.guest?.alternative_email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '2fcc21b6e15dd49e4cc06c50639b92ff9d98304a', label: locales_store.locales.entries?.Lcz_AlternativeEmail, id: "altEmail", value: this.guest?.alternative_email, "onText-change": e => this.handleInputChange({ alternative_email: e.detail }) })), index.h("ir-validator", { key: '08aa384f362db773d15e97eeeee663bf127dcd43', schema: guestInfoFormSchema.shape.country_id, value: this.guest?.country_id ?? undefined, autovalidate: this.autoValidate, valueEvent: "countryChange" }, index.h("ir-country-picker", { key: '37898640a0912bf9beb87fcec23bf538da620d72', size: "small", variant: "modern", country: this.countries.find(c => c.id === this.guest?.country_id), label: locales_store.locales.entries?.Lcz_Country, onCountryChange: e => this.handleInputChange({ country_id: e.detail.id }), countries: this.countries })), index.h("ir-validator", { key: 'cb1facbacf438e2e060b62ecaf8bf15bd23ccb2d', schema: guestInfoFormSchema.shape.mobile, value: this.guest?.mobile ?? '', autovalidate: this.autoValidate, valueEvent: "mobile-input-change" }, index.h("ir-mobile-input", { key: '9ae4181ffd76e92541a36943e65e0c5f0e90f94a', size: "small", "onMobile-input-change": e => {
                this.handleInputChange({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => this.handleInputChange({ country_phone_prefix: e.detail.phone_prefix }), value: this.guest?.mobile ?? '', required: true, countryCode: this.countries.find(c => c.phone_prefix === this.guest?.country_phone_prefix)?.code, countries: this.countries })), index.h("ir-validator", { key: '1c305592e04398593ad2c4bc0aa2f134db967bdd', schema: guestInfoFormSchema.shape.notes, value: this.guest?.notes ?? '', autovalidate: this.autoValidate, valueEvent: "wa-change change input", blurEvent: "wa-blur blur" }, index.h("wa-textarea", { key: '8a9d67a965e0058cc238d51fb8cae028ee495a70', size: "small", onchange: e => this.handleInputChange({ notes: e.target.value }), value: this.guest?.notes ?? '', label: locales_store.locales.entries?.Lcz_PrivateNote }))));
    }
};
...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (index.h("button", { key: '214bd9c7d97492f00755bfbe2a3900f9d9a1fe1a', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '58b4bf419331068eebf42562999fc6c1ff95d041', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ea05132721226635f6a9313d0c06a588f51e1dd4' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'db8ab2807a4082a5a3bf5c8560802b62e89fb7fd', class: "loadingScreenContainer" }, index.h("div", { key: '25781e0d91738fd30db65b90588fc8e628d5c14f', class: "loaderContainer" }, index.h("ir-spinner", { key: '937bb97f61acc7a3ba626fd4748f499e3f153936' })))), this.showModal && (index.h("ir-otp-modal", { key: 'ae0fbb78fd4dab39cb21ac1f57240a225073f32a', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b91bbc5742c74dd3dc506cb5d15776cf0207d1e' }, index.h("ir-drawer", { key: '7aa6721d22adb65a98f7f8167a099aff9c993682', label: "Invoice", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            } }, this.open && (index.h("ir-invoice-form", { key: '1005498efd2a9628df66a94c8d14dee77419ac22', for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, mode: this.mode, formId: this._id })), index.h("div", { key: '24e33c3cfdda2aba5d0737acd745fd83d9d6125b', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'cff8c7f45aeb9b9d33bdb9cc7d02934a8e493f63', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '80815cb68f7dfa232706f59f72770188726c95c6', value: "pro-forma", type: "submit", size: "medium", class: "w-100 flex-fill", appearance: "outlined", variant: "brand", form: this._id }, "Pro-forma invoice"), index.h("ir-custom-button", { key: 'dfa954fde2ddc920d82aae5bb293ba3280d785e3', type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand" }, "Confirm invoice")))));
    }
};
...
const IrInvoiceForm = class {
    ...
    render() {
        ...
        return (index.h("form", { id: this.formId, onSubmit: e => {
                e.preventDefault();
            ...
            }, class: "ir-invoice__container" }, index.h("ir-custom-date-picker", { label: "Date", date: moment.hooks().format('YYYY-MM-DD'), minDate: this.getMinDate(), maxDate: this.getMaxDate() }), index.h("ir-booking-billing-recipient", { onRecipientChange: e => (this.selectedRecipient = e.detail), booking: this.booking }), index.h("div", { class: 'ir-invoice__services' }, index.h("p", { class: "ir-invoice__form-control-label" }, "Choose what to invoice"), index.h("div", { class: "ir-invoice__services-container" }, this.renderRooms(), this.booking.pickup_info && (index.h("div", { class: "ir-invoice__service" }, index.h("wa-checkbox", { class: "ir-invoice__checkbox" }, index.h("div", null, "Pickup")))), this.booking.extra_services?.map(extra_service => (index.h("div", { key: extra_service.system_id, class: "ir-invoice__service" }, index.h("wa-checkbox", { class: "ir-invoice__checkbox" }, index.h("div", null)))))))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f09bcc67239f69100bdde1ba3f29aef304f6f861', class: "otp-input-container" }, index.h("div", { key: 'ead7675d481bd62b93c1a6d3092c9571e8c52372', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '26c3dbb28840e68dd835d030b7e7c8530a2ce9b1', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: 'c3c892100f0d54cd374303698da8102f97787d86', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'ba9d3552dac9d61abd3682aec6b8551ef6017907', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: 'bd265b7ccd76d35774a43bda7ca2da64d74990bf', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '77952e94c8aa2f10b3b15e2f304eca726a9d9216', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    syncPaymentTypes() {
        ...
        const mappedTypes = booking_service.buildPaymentTypes(this.paymentEntries);
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: '21941ef0c7d2512f4255c44457a1460e2386b41d', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '34e4411a6f5a9abd127a2bedbcc5ca304099ef9d', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '2fc5987ccb9a4da3b23a163550cdcec4bd372a67', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '8137fe6d31a52e3b77dc562b0ba5c651c86cb08d', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'e1d6129f383dfec5cf40f7266994c5834ae0a26b', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: 'e5fe7eea72bd930da3e88e31fda68cf1902017ad', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '70afce4396dcf78727e77599a2ca5b259d110680', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '64d6d4df9817497f190af8cf0c52d563ca09c4dc', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '01aab8e531782919b1b49eec9167695af0571e76', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-custom-input", { key: 'da027977981b905994290a387c63f16b55b3f840', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '4ab425bbc708afe4112125d50426f6541499ad01', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '38a5f272d39779152eb292372ea77a443e65abf6', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-custom-input", { key: '7f5b9ee992f5c637ace0a552bf7e327af5ae6238', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '680b5806472224ef21b26b1be409d6a0ba0a0635', class: "payment-item__payment-item" }, index.h("div", { key: 'aff1813e29fe3cbd141d0005b0f9c115b8484e71', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: 'c6a9f0d2e2b77d9c41c5617232d90b6da29c193f', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '195132f153218e8e7fe2c68871cebc27d0896ae6', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '3ec05d6a60792103b3e4756f54e25306ba20ee3c', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '49883eaa4c4af338ea035402488d17b82b76a1c7', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '8d0973db2ebbeb49de117146b32c3dcb1c049711', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: 'be8ce8e0936530b7d74656e614f128acf1ad4763', class: "payment-item__payment-toolbar" }, index.h("p", { key: '61e5af72f7c4d38fe1938df7003eacc13bc7247c', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '5ba319cd8cf00f5793d0e3a916bea276d0081b5f', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '0c082abcc34909fefeccbba0aa5a807a75f4cc51', class: "payment-item__payment-actions" }, index.h("div", { key: '9194b2116fa139810293b1804f440580cda68295', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '4a06b5c7b4d2719e4f73c2e7f3a4335e2462dbd0', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '524a5b51306f0a252c70dfd5707bde06c55e68cf', name: "user", id: this._id }), index.h("wa-dropdown", { key: '16bae63621c06359f996bfe2c3d78f9ff4a0563e', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            } }, index.h("ir-custom-button", { key: 'd2606a135f555fca5f431015a1a4e3d84178a58a', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'a202d72e33056ea876e35c7a36668c58f2d8b5e5', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: '7faa85647744ffa87eeab4db81f59df26005c501', value: "receipt" }, index.h("wa-icon", { key: '136ce5df193316c9f1abe55a161a019c26a3c84e', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: '2513c5dd21ca6482cc26d81d06450d229738cdd4', value: "edit" }, index.h("wa-icon", { key: '58941d21793acb37cc875271759f5775d33ca29c', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: '6ec81984ea2b3d2f550aa7b0ae785acf8e6a7138', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '593c7eb130db327c77659c2674b015b340864584', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: '46085969885c82f21e599f6fd41096ae5fdfa7cb', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '1242db09de160aa061adc6d2fefd695aee5462d7', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '2bc0bc212ea85ac01c46830b22fff7de7f220f0c', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: 'f641d31963fb3d32bd0835c4463efe414749b0aa' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '0d751f83a55f47ce89b6d2bac29547063be36a6e', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '37f2352c7c09ea2366881649ed627bccad5b6462' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '6bbc36df59f9ae65c15e868051e8c6f0b6928b70', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: 'fc647a27413264e14b70ab171f5537e7eeeb1560', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'e5d58f89706fedb849297d1e51c2e0a478231d44' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '3e29108a741d549c0f50ce78eca3f3d605e92699' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: 'c9634a8f516ec19b79e1c99d1c926fe633fd4cda', class: " payments-container" }, index.h("div", { key: '7033c9d5ef8e265f56ffbe13dffebcae92d871f9', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '56ce5bee399131f7a263e227b10b6552e6903b57', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '60201801805cb8f397617a864cca55e130c08ae4', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: '0125a33c7f599665d0f90f02ef1e64849be0c596', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '6ba9d537c6c6ff63f39cfbde8cf7cc63291063e2', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: 'bf7860a13fafdd194c92bcd9fbc276fc95eea415', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b2921847833f3d4e2fb9bf1b603a2227a92ab9a7' }, index.h("wa-popup", { key: 'dc0cd1a63c62ca868c89d62499f7e18ace5caa2e', "flip-fallback-strategy": "best-fit", shift: true, "shift-padding": 10, "auto-size": "vertical", "auto-size-padding": 10, flip: true, active: this.isOpen }, index.h("wa-input", { key: 'f43924e7810d7c1e8b3f2642ae485af2671af6ce', slot: "anchor", class: "search-bar",
            // withClear
            size: this.size, value: this.query, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
            } }, this.loading && index.h("wa-spinner", { key: '95c1b819ed413cf33a05ac130e43644ede7331b6', slot: "end" }), index.h("wa-icon", { key: '93be03f9d4bc8667d60ddc51c4ab326ac168d0db', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), !this.loading && (index.h("div", { key: '003c00c87bc246864cc8b48deff57e695055909a', class: "menu", role: "presentation" }, index.h("p", { key: '5fd886206968d0605c99f1c4df4769be5b562e86', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: '89a25451c96c13fc9257dffbb3f9ed411baf2160', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, index.h("slot", { key: '5c60e825f29f78b572f4b71064f9869e71e73410', onSlotchange: this.handleSlotChange }), !hasResults && (index.h("li", { key: '151112224d049bbe4c531514ccb3449bfbaf2d89', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: 'a703da3dc43c3c83ad4462ed9f0f9814998bf9d2', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '05ff7482d24e90b1b7f85c68374275c28cb586b3' }, "No results found"))))))), index.h("span", { key: 'd057dd366258724dc18d3c085837ae7dae569943', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '83d234cdbbce40c664b879faed91ae12812dbe2f', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '9e86b45c6adb88880c5e83ee9736043b4f96ff32', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '45fdf1e546e5c9381bcb3fad9f67ea60ce883f69', class: "picker-item__check", name: "check" }), index.h("div", { key: 'e9dfca7165353161067085aed0254ab09afa3164', class: "picker-item__content", part: "content" }, index.h("slot", { key: '7cab727825d0f34319e336a58e030bed100537a5' })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '7e1c3330203ca5fb12e4cee957d907debaaa47c2', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: 'ac363f2308e15fe5aa3d42fc46e3d07fe002a243', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: 'ee647455e88f94eff3a68641538cd521dd142db7', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'b0b645a937237c8f64db4eb18dced5ec0d1e3bf3', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '0fa1b794643fc44dfb4b59a4f098d7051f81f9d0', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '9ebd41eec7acf8206de0a5665b6cbdd59ae1f4a3', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '444d71403224d33de117c650d2dfe802f35a4d23', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '71d865dba3f8b0a552cafe5088aaff4a0e9724d0', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '9ad0d6192dbcbbcede26c36e49456f659f02bfe4', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: '866f319754530a3d0d60b27bd17b2740c5d18c59', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '8c41857c9e9604925fe5132e56bd4370790c76e3', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: '64777e6af6d0dbd2d27f2c8c9a7eafde1b743f98', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '298618026f0ca605027ff7c7878875b85195e4cc', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: 'b94c90eb661adacdce5fe3d382ed11bd9de53453', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '7054bcdb3da7bfdef3dc5da389bc32e49121353c', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '9c6544ec2352b2334fd6b708ae001bf717fb0255', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'ecd73273e84c38ad92f73f6412660c7d6537041e', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '7481641be7c8be4917a9693dbe5d706f020b6ca3', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: '23dd7f4274d7a2a200fb04cc14f55da7b8e6153b', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '0230d73fd9a83e9f3d66234191238985ddd613d7', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-custom-input", { key: 'dc8cafbf40fbf846ea6a26470f5eb3dea3fa6284', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: 'c345fa4c9989bb50ad33877ca2db9a2b68f62ed8', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b19f1c585b89019236dd2c7bf82aa0688c3404c', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: '3ae98b1a4d3bc63f001a99cac260b14d49711663', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '054d70c1640420547971ac7cc981edf176ba6985', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '97388d476a2cbd67411bc56447161da64950c2e6', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '03c175f07343150b03cea19c5eb4fb1659e5e464', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'c4cfbfe00e49a4d32d3d009af02e5bb216bb33ff', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '54b93f3d80afd2052ff568e9fb807544858c97ed' }, index.h("span", { key: 'a3fdc399e46056f5debb0f0fd64c146ce73ef0d8', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'd26fff0f06dcfb4edd5f9f6a2ad6075d6dc7e1cb', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'f43e4ff7d6da268e2d2e89e61fbd4cc8995bafdc' }, index.h("div", { key: 'b55cc33413d9fdecb85e8fd05b60a1f3ce3ff69d', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '87c584306d1ef9fc377ebdea9636a83a09f3c0e3', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: 'bc1cd6f1824e48fcdfc719659cce88359d24c4a8', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'a9ab9a9e137ddc15d7c287f84e683e8624cf0440', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '64be8e264cb57bc5110bc8524cca757232522e87', class: "reservation-information__row" }, index.h("ir-label", { key: '71a37788b4efa39af960f363c59cb5f4bb777fae', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: '415cf95fdb7831c0718bd13f95e7c78e20418987', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: 'bc4fe6703baff0c0f92af3238d84ea9381cde469', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '33d6fe2f20b0d8dff271771be6dda320fae07b93', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '32937ba3622afc90a726e342ac52ee306bfdbedd' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '8e8edbc1ddd5faa36be8bbde3b438091541f98bd', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: 'e94ff61f9aaa99e1db9e29695c0b494436fd33a0', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '0fe4a877a84bb7e9720ca844276201c59340a00e', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '279df10cd5974a3f15a21d80ee772a3a51311827', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: '05bf31be539ecbf0daeb599a86a62fd365efaf4d', class: "reservation-information__row" }, index.h("ir-label", { key: '68d722a4d17f6b067ea340fd98b29d672ab38dbd', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: 'fed1eeb5112a0f2f731dd3a6cb559673619edc4f', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '04d50e88e00c648cb6718df786bf3f28685c7f3a', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '6120a1b5d3bb0066427d66f6828c79910c62e2ae', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: '2f73ff474444f3a9590d5b3608e66eb70043783d', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '702e6bdaf3c9af4462e22becc98513626e4ae487', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '590058bf70a4eb6d481eb33ad870478bf1e64f8b', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: 'c9c36063aa5f1ab91749cedb670607e5acd723f8', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'd40f0f0d19aa38e292579519795395935ddd677b', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '025f19cf02812f6f83c74b4979253d7fa4cc3b7f', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && index.h("ir-label", { key: 'f1a9f5a82e45670b9902fd67b1c8bcabb3f72dc5', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'd5015fff3d6b16ea6b4c3a5f0eb9bd1cb35ddf4f', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '63f37709644a2572c9a0eacea1219ede12dd84d4', class: "d-flex align-items-center" }, index.h("svg", { key: '8e1f1daa307a5b83b02b2e509dda30f44c7defc0', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'd89c891a669e57e853a8d81a3149df0c0f98ba39', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '93942c3f395ae3d535be3fbdd7877c68abbe8775', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: 'e415209361935e9664ac7ad96aa388c5f5edf389', class: "reservation-information__row" }, index.h("ir-label", { key: 'ac062e9412da7f1f1d319ffa8388f0d9854cea14', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: '48ebb03db091965df810df34fd9d8a62b83da340', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: 'c8dbd00ed90bd443ba4816ec0cd3dc142962c584', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '9ed0b3a030e87ea9a1f7d64a9dcac2ad569ed3b5', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: 'ee40ab89c509619d04eaee6b2aae9ef76b3f9cf3', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-form", { key: '2835373af69d96f6fb9c5b9101b782a37c3f885a', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cfa5348194910fd3d2838cc33bd7bed4ba047f39' }, index.h("div", { key: '913249ca4e07bb0c105c9efc31fd0c9be8e5df46', class: "d-flex m-0", style: { gap: 'var(--spacing)' } }, index.h("button", { key: 'a163dd5665ec4000a70b82d9c9394dcf3ca074be', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '08d9bfcda9a649dacc67d75e897f7f70fedbb8a3', name: "chevron-right" })), index.h("div", { key: '8954b3613cfa82e5ccd55fb98f426f73099a055d', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'fed6948a1ea2cf6a287be6cc7ace0e6c86f2b772',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '91364ec7bae886008e20d21a2dbf4026e2374d71', class: "d-flex align-items-center justify-content-between" }, index.h("p", { key: '938274361fb981748275857054f142cad98b32bc', class: "m-0 p-0" }, index.h("span", { key: 'f64ca717af62b61ea108f01e0539aefeb4a07eee', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '38e7b7f3195fd8f9c4f64adf2183e82dc3cf0ddd', class: "booking-room__price-row" }, index.h("span", { key: '932146edf5cb81e13e7d3ea6a5089fe24aaa8852', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: '43418e8d798cd60b6902d893f83ef548c4aa4f34', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: '58c2949e247c6c4e2371c778b0dc72fa817c4746' }, index.h("wa-tooltip", { key: '2bb53a1a492310cf9754b6eb2dad7cc482dad116', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: '2ea60edbc57b1dfa2351c85ee8d33cf900cbdd06', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'b9f52bcdf1a8772558a1060d9337162bf68ef729', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: 'c5299358049b6147deaee323bf493937db102d12' }, index.h("wa-tooltip", { key: '5d2578029564dcb035fd115e2fdf7902899678d0', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: '82053d1339bb401a51c9e0964eaf801a3df0aeb2', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'd71f1f4bca7732feb543dcc68df5d5499cc20dda', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: '8fa4631d725a728a2abcb3199cd2f6c2f8782814', class: "d-flex align-items-center" }, index.h("ir-date-view", { key: '8bb4516a29e745eb0936c8da5f23548ad6bb850b', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: 'c3ab2ee34a082d3bb8803dedaadae9e759418171', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '86a115251dea86b1cbe18fe18e3d3c33571b5122', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: 'f38e24c2f2faf2e57eaa3e3f62f88b0a5636d753', appearance: "outlined", variant: "brand", onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: 'a882627f8934321e45a0f448c2138a77b0d11f1f', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '9dafc192aa27be265023952fecd370cfb584897b', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (
            ...
            }), index.h("tr", { key: '29971d359f8877e122834ad5a5447ceb796d4199', class: '' }, index.h("th", { key: '3f094b6b52912d6400cc784320a01834d0450773', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '60c6ceeea2993b1b030d6d9edcd739e149e28aeb', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'd94c6c01ee496f70f008bd5ae2cbe4ec6d6647a6', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '607afb680784646c10c2132fc7c9084025d1abcc', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '314103f5b2204cf155b3976e7924b72c1cee175f' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '36f4c3d43973c345ae905a0be661ce4654408044', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '7a0597956cd28d8219c98461b518640d32329d8f', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '7e180df535d898f2b938f516bf13a20934e54092' }, index.h("ir-label", { key: 'd83c3f76c36bb8a220facde02e105d2ef043949d', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '7fd6fa013ed7f87c311dd1de46f098bece04142f', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: '3bf652ad068362f2b0fa26525598bcad0fcc6890', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: 'b062bc0b6183c2d798a53bad95430a00f8c42bc5' }, this.renderModalMessage()), index.h("div", { key: 'c27bd74ee63bd97bdcecc6ccff297253524e1538', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'ac4aee66db3cb2239098fc66f366f290ff293d82', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '9257777f9da88c9fcba5a5b94a9f0f110cfad352', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm)))));
    }
    showGuestModal() {
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
        this.openSidebar.emit({
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (index.h("ir-drawer", { key: 'de38dc87f7e89706a90612bc82643efd3ff5e2ce', style: {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'fa7ddd5a447053e80b3e20fe105a5ec09e60827b', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'd37cd997c834a43515bd0f01bf9470c19d30961f', class: "input-group row m-0" }, label, index.h("select", { key: '3382b46478c7b9d87fb058864ecea37f78dddbe8', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ea3dae5a75bab95d12eb86a3bfef73dbed12a341', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ba28f3b2470ec743b4061f868612a33932919cd1' }, index.h("wa-spinner", { key: '44ba2f23fd55668c2f9a1c498aa8276396c0306e', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '93e689a4c0bebc7af29486863f7ce1eb84fcd33c' }, this.showTooltip && index.h("wa-tooltip", { key: '23644b036b3075275df1fdca6ec37b37d0e058cc', for: this._id }, this.unit), index.h("wa-tag", { key: 'e278e011bb5fbfbe8dcdc27514bc0859f1ee5c84', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '00bc9e5da9bb2f5c3066dc815bc47ac4a653d5f9', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b855d83ceb3f4cbe2a8081354fb35dd373c16685' }, index.h("slot", { key: 'bfb5c77aae607a098fa51dcc5cfdfaebd6ed76df' })));
    }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_74.cjs.entry.js.map