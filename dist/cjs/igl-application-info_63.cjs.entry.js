...
const booking_service = require('./booking.service-6e9e4975.js');
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ee3f96638f98eab67cf11b88cdb28185ff66833c' }, index.h("div", { key: '34275894316510d863cc008ebca96ec5080d75fb', class: 'd-flex align-items-center ' }, index.h("label", { key: '9675c562d1a7216e5bc7a7ef67f1ce2366611bb0', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'feefc79dbdaae516789e3a4559598248623517bf', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '86b40299e4aea600c4db98ab06cfdc03a30c4934', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '661b048b4c564ea7462cdba2a1e37896602f6bc5', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'd8215aa6a2dff1d0230e502f44cde26cf34b589c', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '0d75eea8f4cbf9e91b3835810cdd5ac8187df778', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'a6b789e462d4c40ad9822ceb714daf48648c03f3', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '553d65171643f5605517266df58ba984ae09123b', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'ea17e73641afff4ce3152bd4c1d14659d271b7bc', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '5dd7c3a86a29c7f0e63366f7fa1f6c2ff0329ef1', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: 'f7985d3f75b3463a3f03fa867d158c5c174c0bb8', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'e8f14d73b7ed5e5a5221a11c02e8a22018eee84c' }, index.h("button", { key: 'a0126b8b29f79e8ec7ddfd9cb38615514fde1a3c', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'a4663482ec9a1ca85cddbf58b603123f8faaffd1', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '4498c47f9a791ccec6d8ce439476095a69ffeaee', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '2af23a052d286d8df75f05b2ec70491327582420', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '5743840945447017e6b02a22cc574ceb3721d4e9', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '23eaa50c210898c7ad4697525c00439c8480be9b', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: 'b81c81aa9d2a6ed5cf3c3b9519ec9437bded7d20', name: "trigger" }), index.h("input", { key: 'd881dda003fe72a84770b7bc3f5547daa53d80ce', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c0707b22acb5e5147b3b92fc0a8018cf6252cccf' }, index.h("input", { key: 'cc7205b2f0f00cc39a3888875e842d0a06e3370d', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a4a1a8348ce01080ef7fef31ee596cd65fde4c23' }, index.h("div", { key: '172c30030edb206333cde3a5fbcecf7f54409616', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'b4ee137f84087a5611dbf0c24b66716e0241c243', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '11bacb944eeb9d28753527070a0bb9cf02c1dc82', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'f486aadc5df3ea4bbe1846ea6593bee6a2318918', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'd5980285faf44bcc68e3a7c0937e50b67d54784e', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'cc6b2a6fce8fd5774623130198765cad1574124e', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '0539f28bccf23164476b0be6bd9e221699c07088', name: "modal-title" })), index.h("div", { key: 'af9520012f4240861664fb819713b5dd933b6a51', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'e5691534d06c256938348fa55760138a226166ab', name: "modal-body" })), index.h("div", { key: '47a3640a56acf72ecaf3b7a5037e44a618bb03f7', class: "modal-footer" }, index.h("slot", { key: 'df50abfa814d9b08c08df4313e66a91d126d654b', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2a0b0fd42f9ea6362d7812a5318db60bed0e2941', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '4b131c27dbcb35e946bdf2760bc40feb47bc8fd8', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'f37985ccac2437cf428a9bcb8356b943a57b2802', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fe3ac16436d40d9a6f20929386fffa7c022caf5f' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '7d1c3fd762eb4fca07f1e06e4937ada97d4895c0', class: "loadingScreenContainer" }, index.h("div", { key: '5bc97c7369746bbf3adac9782afbfa9c1e6e82f9', class: "loaderContainer" }, index.h("span", { key: '3599993c495dc101872d90fd6c4034a32bc94112', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '51996f919000908680cbd35f95059db8866d18c6', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '0b623d37fc8fc150542e7fd360ee2c550c7bcf1a', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '007fad2de55d1d24ff06cf324b8c630c902a84ef', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'c9fa2357606f567fedcf89f53165eb5b901609b2', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '2cf6a440b46bc4e9faf8b9809a06a5d061f80749', class: `ir-alert-header` }, index.h("p", { key: '242ba7e377fe5336d97e7a1b1f2a07cd318e7bda' }, this.modalTitle))), index.h("div", { key: '653c14bb05cc4d87429ee23ccf5c859a4e091464', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '25abea07753454353ce02027d34ba56cd860a4e9' }, this.modalBody)), index.h("div", { key: '93862329a09fd795fdc736a4a4acca60e17faa10', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: 'fede0a4681983b4b451c66b817aac41b35f1ea9f', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '89937be0b881759b4e460c93393217cd17a71e12', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '2f775b1ce05c2f47bc7a2c219cf1824f19728d8c', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a8a28f58a8f21aafd60853209086875f020b23c6', class: "otp-input-container" }, index.h("div", { key: '1bf4cf25529a52879f87c99dd23a6f65bb416f7c', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentDetails = class {
    ...
    render() {
        ...
        return [
            index.h("div", { class: "card p-1" }, index.h("ir-payment-summary", { totalCost: financial.gross_cost, balance: financial.due_amount, collected: this.booking.financial.collected, currency: currency }), index.h("ir-booking-guarantee", { booking: this.booking, bookingService: this.bookingService }), this.shouldShowPaymentActions() && index.h("ir-payment-actions", { paymentAction: this.paymentActions, booking: this.booking }), this.shouldShowRefundButton() && (index.h("div", { class: "d-flex" }, index.h("ir-button", { btn_color: "outline", text: `Refund ${utils.formatAmount(currency.symbol, financial.due_amount * -1)}`, size: "sm", onClickHandler: () => {
                    this.handleAddPayment({ type: 'refund', amount: financial.due_amount * -1 });
                } }))), this.cancellationAmount > 0 && (index.h("div", { class: "d-flex" }, index.h("ir-button", { btn_color: "outline", text: `Cancellation penalty ${utils.formatAmount(currency.symbol, this.cancellationAmount)}`, size: "sm", onClickHandler: () => {
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6435082876d826683e39d74bea9ac27674f35eea' }, index.h("div", { key: '72fc699840e1cc9e3c93a9b9afbba257ecfd414e', class: "form-group mr-0" }, index.h("div", { key: '7825136a94c2fa6c7fff5ac796c9fb534f4da01a', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: '2dcb8f65a9b7924655b1cedfbb6ef28ac5c40e54', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '92ee87ab1f9abb08c1112f3d67a131644e2a8c1e', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: '7060770effb13becb415d750d14f2fa87b69d001', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '4ee6f313becc67f1ea4289fec4f54fe8387a4c16', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '63f757d4955cc93d2ff0fdc0f8c92fc0db694db0', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '90460cf74ed9a953e5f265911068bf27ee386876', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '4d975044d4a02ac212df1635fef68c732d934caf', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: '84a38a5e394acdbb2f20c426acc150e646883d0c', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: 'ca9a3b8572368ebaa12493d9a1baff3f9fc4a17a', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: '65770ec653f78cee5ef4122cbddc3afff68be8cc', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '92f0a3b58ad85edf1ab10be0d48a80b417ecb7ca', onComboboxValueChange: e => {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9984a2bd4912843ae52c85953b2762ef05104086', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '33f8fafe42ed62a8fea5a772da5cd968a617f86f', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '814aa5d6059e95806086fa0624080ae6d2ee5c8a', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '0fbfa965cc8ed2f81cd2c6e068f2a67545470d97', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '39bed25457e58c15ad465cc69eff51d2c06f7ba2', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '52844fd4f70ddcff485bb426a912902077411cf8', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '471f3f18846834c316f2a5113689031ecd22f04b' }, index.h("span", { key: '81aa34597c66ed328594800107203e5f4f9ed468', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'c1ac1279bcd3f3052f1637fee86f8d3d4212de63', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'd2b5a9d908a1de1f2f79793b5608b722140691b7', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '560716e234d5fd23ce0223d9435491945b8b324b', class: "input-group row m-0" }, label, index.h("select", { key: '8c268ed140278ce7f735860411473e85104f763c', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '3ccff27442bdee5cf015fcaca4019f6d2f68de8d', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '9478d0d630d0f6f2cd3c418c82f2e1d6b79a4cb3', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '210aee3e16a722f8fbbfc15a086ccfcba8957ddd', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '76d11e68f8c7fbadad53051b690b8f5f3db6a1d9', class: 'sidebar-title' }, index.h("p", { key: '00b545122b210681707a2b97aa39494d1d0a2494', class: 'p-0 m-0' }, this.label), index.h("div", { key: '6bcbe952ec89a8303149a6093bbff81be3564db9', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'a71c116129bee701dff58ce7384e6f350f66f892', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'd50b78dd1248f937a2a0f0d95f35bd8148ef976d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '2548e4c5092cb37f78d8743c3ba62e00c9b52531', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '948bccfc18abbde7419f5c2146b751a220ce3461', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '2ae2c84a8d1733c3b7c883bc4c1da5fc14c7f900' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ae26c081f43aec51466b97f21d192aa793ef086f' }, index.h("h4", { key: 'dbbd77636be8f979302ac5b61acdcb0c5209893b', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '18eb7da4086483152cd49b88464f142f0e958c3a', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'fe074d4af62bf1b58b2a670d481bbcc1c2bbf078', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'd8b606cf600c54d48cd4e273a46b0c11c7db3221', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'eeb26cdb47789cc3e1c6ec6be8bebed74d45efee', class: 'title-body' }, index.h("slot", { key: 'c98c0004e56fd4e4fe8cb31bdb6e3fc7c211a6a4', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
