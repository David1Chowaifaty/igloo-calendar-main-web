...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '8b1b70724924d2f926f936d0f41e758d5398db64', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: 'd7b31eee0c47dcc5124f144fa5cff21eb52af485', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: 'Payment Folio', displayContext: "sidebar" }), index.h("section", { key: 'f2a7dd0a7e216dddb5eb907d4ebdefd40ebc2b15', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: '8440df7595bbeeac033e5d1cda611f615bdfb76b', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: '6023a1ba70562d4cca46a15fb39d81e64c839f3b', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: '218f2bd6da831744ab871e0da65bf0d50bd062df', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: 'a02516fde3a6327ee74cb85fe27ec443288f5294', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '072bea6faa908ae2ba78e8b8a8c7fc4e088262f0', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: 'cf7853c3c39d11bd04abedde5d075edcfb165b9e', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: 'ce80881d29652c559b6e1d0f8d30e987af69f616' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: '9da10c0771db63475e6ded6d0b521935aea2a516', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '70f1323e72a3ddfcfcc120bdb17e4e36c1af6af5', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: 'da5e74d40f7e2ef5421ed24dd9511d5e4962010d' }, index.h("style", { key: 'c00f50dccab81e89ad187c786fa65f0bc62982de' }, `.price-label{
              width:133px !important;
              }`), index.h("ir-price-input", { key: '27ccd4cfb3fcfdbb399a91baef23f54136bbe126', autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'price-label', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: 'd87f3d74f713b1c15450eb90af5e2fdf060dfdd1' }, index.h("ir-dropdown", { key: 'c716562e57c3cc4a8dc439b47bb12de0e11f69da', value: (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.designation, onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: '59012b30844179f69083b28a36a976394d08609f', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '9ecc188b4dbb1488b1a53482700513cbea9346ab', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '6176ffc0bfc6ca1965e0f567e45837613d5b1258', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: '677c94c29141e5c992b03eb7deff2a8b08d09936', type: "button", class: `form-control  d-flex align-items-center cursor-pointer ${((_o = this.errors) === null || _o === void 0 ? void 0 : _o.designation) && !((_p = this.folioData) === null || _p === void 0 ? void 0 : _p.designation) ? 'border-danger' : ''}` }, ((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.payment_type) ? index.h("span", null, (_r = this.folioData.payment_type) === null || _r === void 0 ? void 0 : _r.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '07a7769d71299d17a824fb0a4ecba96c34df4737', value: "" }, "Select..."), this.paymentTypes.map(pt => (index.h("ir-dropdown-item", { value: pt.CODE_NAME, class: "dropdown-item-payment" }, index.h("span", null, pt.CODE_VALUE_EN), index.h("span", { class: `payment-type-badge ${pt.NOTES === 'CR' ? 'credit-badge' : 'debit-badge'}` }, pt.NOTES === 'CR' ? 'credit' : 'debit')))))), index.h("div", { key: '5c08a17ddf11921fe0e848fc81c76038ebf3a3b7' }, index.h("ir-input-text", { key: 'b56258a7b357a538f6e78cc63b977935c0a7ed4e', value: (_s = this.folioData) === null || _s === void 0 ? void 0 : _s.reference, error: (_t = this.errors) === null || _t === void 0 ? void 0 : _t.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3 }))), index.h("div", { key: '6eeec8eb2fba54f9be31d836052abc416540e4ec', class: 'sheet-footer' }, index.h("ir-button", { key: 'f19fb1da0461665459b7a01b6c91516ed5db6a71', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '243a4aa54bad6104c6c8fbe23f4f4fc2502b946e', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
