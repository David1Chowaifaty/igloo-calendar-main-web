...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'e07020333f03393c8472ea37d2d03892345e70dd', class: 'sheet-container', onSubmit: async (e) => {
            ...
            } }, index.h("input", { key: 'd3d17db1cc9a0999bc9f0a29268a0457fbbd6387', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: '20a501a630c7bb0f1840f48702d4c07fea2041cb' }, index.h("style", { key: '7be16d04532a7ced673fe9d8452067e1b362c522' }, `.price-label{
              width:133px !important;
              }`), index.h("ir-price-input", { key: 'a765580a5d226540d2cd1abd8e0a4ca736811d7c', autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'price-label', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: 'a08d436a361776727d45f1685fc4c38d63f06688' }, index.h("ir-dropdown", { key: 'bb26edc7f74180b8dce24f573190bf7415da1f58', value: (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.designation, onOptionChange: e => {
                this.updateFolioData({ designation: e.detail.toString() });
            } }, index.h("div", { key: '1c726c25f3bf48cf4189a49d30c5abaa67bf421b', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: 'a98bc87a635dbde8f66a0cfe08d0ff3022a19a91', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '1473f04b1c5400eb59f17c3f5b8f5df195104ecf', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: '655053cc95da8feebd7e0680cfee1ac64373cf9e', type: "button", class: `form-control d-flex align-items-center cursor-pointer ${((_o = this.errors) === null || _o === void 0 ? void 0 : _o.designation) && !((_p = this.folioData) === null || _p === void 0 ? void 0 : _p.designation) ? 'border-danger' : ''}` }, ((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.designation) ? index.h("span", null, (_r = this.paymentTypes.find(pt => pt.CODE_NAME === this.folioData.designation)) === null || _r === void 0 ? void 0 : _r.CODE_VALUE_EN) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '0d4e8abd81610f48df615d81c538d7300d18a02e', value: "" }, "Select..."), this.paymentTypes.map(pt => (index.h("ir-dropdown-item", { value: pt.CODE_NAME, class: "dropdown-item-payment" }, index.h("span", null, pt.CODE_VALUE_EN), index.h("span", { class: `payment-type-badge ${pt.NOTES === 'CR' ? 'credit-badge' : 'debit-badge'}` }, pt.NOTES === 'CR' ? 'credit' : 'debit')))))), index.h("div", { key: 'cd170b74897634d7e4af58cbcd05280e25dc92ff' }, index.h("ir-input-text", { key: 'afa8df964104cb1278dc49c2b3c1f59536bbf0e4', error: (_s = this.errors) === null || _s === void 0 ? void 0 : _s.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", inputContainerStyle: {
                margin: '0',
            }, labelWidth: 3 }))), index.h("div", { key: 'a751701ddebcbbc9802583255b67ab0a660fe55b', class: 'sheet-footer' }, index.h("ir-button", { key: '65102a6eb428e3555bb3b6571d341633925c8e9e', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '4902518d3a231be25b6ba0d8058a8d5d5b7a704b', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
...
const IrPaymentsFolio = class {
    ...
    renderPaymentItem(payment, index$1) {
        return [
            index.h("ir-payment-item", { key: payment.id, payment: payment, onDeletePayment: e => this.handleDeletePayment(e.detail), onEditPayment: e => this.handleEditPayment(e.detail) }),
    ...
    render() {
        return (index.h("div", { key: 'abf79b3b39b6e5da0b77c1cf85aed93a8767e71c', class: "mt-1" }, index.h("div", { key: 'a2070d9cdf4502cdfe720dc915470b9099ea2d7a', class: "d-flex flex-column rounded payment-container" }, index.h("div", { key: 'efc17c70da5f8be4c6cb3c30152451fe714b38d7', class: "d-flex align-items-center justify-content-between" }, index.h("p", { key: '0a85ac79b23ea6513ba9a2ab388e3e7504f18d13', class: "font-size-large p-0 m-0" }, "Payment folio"), index.h("ir-button", { key: 'edc098d24289840fcb3b0084da57f7ee0451da11', id: "add-payment", variant: "icon", icon_name: "square_plus", style: { '--icon-size': '1.5rem' }, onClickHandler: this.handleAddPayment })), index.h("div", { key: '905e4441b9df5385ab6f55f619f6be91c547487c', class: "mt-1 card p-1 payments-container" }, this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()))));
    }
};
