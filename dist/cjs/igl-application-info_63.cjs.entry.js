...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'cddebc99f75eaa88978b46ed6e46acff4f53b987', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: 'c68011576d06d59f4b1c127b83424a7cc42b7169', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: this.mode === 'edit' ? 'Edit Folio Entry' : 'New Folio Entry', displayContext: "sidebar" }), index.h("section", { key: '3e2809073eb77709ca0c86784f15c736cf3e35a2', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: 'c729caf80da683285c3fc412edb5fe6b9fa130ee', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: '5f8249ea60102abeb073dcca4ca8450e89f3cb2a', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: 'e667ee091158c039e66a0b89e6564e2b4e050836', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: 'b1529b0108271c875c0d815eb5ec6a577034c9e5', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: '7a0eb13bb4fc67a0b77978f211e18e605d8e4d83', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: '1a4efaf775a5f5f9cb28fc779c935cd48d4dcbd4', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: '925853719cddd2fdec3fc635bb8133e662cf2645' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: '481e2f2d3f5d4a40127900733f9f925ec76a80ff', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, maxDate: moment.hooks().format('YYYY-MM-DD'), "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '2dd176106a4ee5d16aac306651ac3a7c2170b652', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: '58240ab596f11ceaff615dfd22feb678a9fb60e5' }, index.h("ir-price-input", { key: '7b50813caca9db6d57a9206b0900e407244d3b97', containerClassname: "row", labelContainerClassname: "col-4 col-md-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: '1c5ecd8dcd9f97df855005d3d3d8681abbfed496' }, index.h("ir-dropdown", { key: 'c121920b952af2cb562474639665e41518e65c0d', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: '745ea7587dc444a689263c218fa691764108d515', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '78ea84544a6707f77d8b64caf5d80584d91bc302', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: '2afca90711a5b295aaecddd5026abb2d55fc448e', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: '10c49427b5388219eeebabc699a0a7323445f39f', type: "button", class: `form-control  d-flex align-items-center cursor-pointer ${((_p = this.errors) === null || _p === void 0 ? void 0 : _p.designation) && !((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.designation) ? 'border-danger' : ''}` }, ((_r = this.folioData) === null || _r === void 0 ? void 0 : _r.payment_type) ? index.h("span", null, (_s = this.folioData.payment_type) === null || _s === void 0 ? void 0 : _s.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '712927a61fe1f54753baa95b1b621952daffcd99', value: "" }, "Select..."), this.renderDropdownItems())), index.h("div", { key: 'a0a7cc825d4434f628eeba61f6ee1e9c46712be1' }, index.h("ir-input-text", { key: 'edddd301625df41f9b1d95df2cfb2c98089f147c', value: (_t = this.folioData) === null || _t === void 0 ? void 0 : _t.reference, error: (_u = this.errors) === null || _u === void 0 ? void 0 : _u.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3, labelContainerClassname: 'col-4 col-md-3' }))), index.h("div", { key: '1cfa5b94532f05a1906272ab7ad45269ab424327', class: 'sheet-footer' }, index.h("ir-button", { key: 'f9789fcf98a546fab028a459f30cc4782455ac2c', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '21bc156988f0968dff231ecce1b47df4c9a567bd', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
