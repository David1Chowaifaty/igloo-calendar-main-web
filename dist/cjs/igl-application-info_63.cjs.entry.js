...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cdaef423944e34f6429383aed591b397981a0e15' }, index.h("div", { key: '8c142b84afc8ccca0c36ace0ca0064abd097e546', class: 'd-flex align-items-center ' }, index.h("label", { key: 'a1fd5a03bc5babb7444153c8441d4b0128503e4f', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '40b41f63857c89fc2f3a2eccf37a63ec73c9b18a', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '83328551036fd9099bd88db213c213a71248145e', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '4d46b969419b3f7936b4dd9a062c2913a54e2174', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'f4c178970ceae8135805bc149286f9f3a9afba77', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'fc770c0584e8b978bed2567c4177636b007e459f', class: 'sr-only' }, "clear input"), index.h("svg", { key: '7982d1104e65b563ef9090b6d6bf667d3b5cfbdb', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'eada78d4599907573ceb8cb7719733f9e6c97b98', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '01b38ef675e5ad3935ad991c55045b9850abf439' }, index.h("slot", { key: '9f904ee44a3a2fe4dd3669b44625a693f8fe0fc7' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '2a6723bbd943aa6b11c52db9318bfd2b456bb221', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '685b579cf0f6e2f4f0338be8818fd9cd09c55ee4', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: '0afb9f5db262beb6502a8eed0b6c589f52b0bfd7', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '81756c630bdcc4997a4cd4fca1be0be8a187f2f6' }, index.h("button", { key: 'e891a2e55627eb5a538aeb3689ae2c0cdafe7c3c', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'd8a401bef8b1e19222f9dee1b6af689a537e6e32', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '6d6412e0893d783d64700ef18ff089a74d7a957e', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '2ccbb8f96db5576c948d7c5d47faa736e05b7fb8', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: 'aab18bb5ae9e101079f0e65902b55ea33d2bde8c', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'd8a97f8c1e4652025a5d2787014c00db82b7dd7d', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '25c9430c6bf3c98873055a46a5e976597e82e164', name: "trigger" }), index.h("input", { key: '156e2647605d80822d6f63160bdc25ab9dbe2a11', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f38b254ac98cce7d73d4dfa1c06f38ac7a4a9d31' }, index.h("input", { key: 'ce7a6328fee9b8c87f593bc9a93db62897ea6941', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '57399a42f5cd34a79e0b8650c6483c5aa20e453d', class: "d-flex align-items-center" }, index.h("span", { key: '610893bc1d4862b7562f998de8d135bb6f6eac2d' }, this.dates.from_date), ' ', index.h("svg", { key: 'e5af6e1769dacccdf2854cc3c5262036d3fd55c7', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '8118ea1f172bb80467a9287376baa41263cf4bb0', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'a73ac6ff0611ce369103451ba484973ee3aba535' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '6b44646b5be03e020bc3f1c7bc869d5259077ba3', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '18c735e71bf2357fc8e9d125b931eb120a1515a9' }, index.h("div", { key: '7b8feaf53ba35789e6008158984ec725a95862b3', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '2855896b2ad7677bba7dc65bc3857f7c30611e36', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'f031589a05b82e03dc5bca1125108c69478c4cfc', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'efc1c3991597d3d565c29781e44234425e230caa', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'ccb4095c2a3bb842794df41fb5efeffa5d0596a8', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '1f6e9f9807b2b9a5ff9e9d8e23b79b34bde03d10', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'fbe9dcce094cef2f4fa08d8d77401389c97a9206', name: "modal-title" })), index.h("div", { key: '87dd3c50d2de96eb44a1dd2769915773b3d63fd3', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '4a9c7a02fdbbfa020abb3eabd27127c56d9b0647', name: "modal-body" })), index.h("div", { key: 'bd48ae35e91f5f49feef3df0f45665699104d4e9', class: "modal-footer" }, index.h("slot", { key: '8d120de66055d69260773eed00c648a1f1a3a4a8', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e032f0d4c008641117fcbb37d9a8f6809fd0a92d', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '51c597aad60a47fa5f289e5f62eb48ed941b85e0', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '655ce5a3767612f8e89836e630965890fbd78859', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b71ccf31915d714a8d47c34fda91f95faf984fe0' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '381999bd8c5285c82675ab96393e5d5837b61000', class: "loadingScreenContainer" }, index.h("div", { key: 'de9ddc2c69616bf8b856a0c030699f89aa0dc5d7', class: "loaderContainer" }, index.h("span", { key: '5f906040119d5765b1d38b5f68a665655332c337', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '969da0afe6770bffc015d784f2a57a2155a2008b', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '5167153bffd6804fab56145ce0fc5b2d460c20d1', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'a9c4c59b5350d0e776344f33f084eea3eb17864d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'cea72690ca0277f886cd0c00a23b787a45a4ee87', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '8eb100a9d4607a64a77d634e4bdea9be766c94e0', class: `ir-alert-header` }, index.h("p", { key: '11ebb00afdabb72904f4e478da09014e73c6d027' }, this.modalTitle))), index.h("div", { key: 'd45c65aa5319cb1aa3504b2b22cb6ed5841c992b', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'f9518345ee1cadf286b4181f538afcd178816ce8' }, this.modalBody)), index.h("div", { key: '8a8122b73a696fe1bf1343d139dd681832a19f85', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '584a2cee732ce7db5e3dae3941e5e103831d3643', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: 'ac54a254e02985e6d9978c5e581b565c5b25bff7', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '4b41ce5b23c4d675c8a8bf59f98dea9fb331a299', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3726dd88a3226fcab33007dc7e0b27da13817031', class: "otp-input-container" }, index.h("div", { key: 'b1fd63fd68a87762fb268dc22eb746797f3ba200', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentDetails = class {
    ...
    handlePaymentGeneration(e) {
        ...
        this.openSidebar.emit({
            type: 'payment-folio',
            payload: {
                payment: Object.assign(Object.assign({}, value), { date: moment.hooks(value.due_on, 'M/D/YYYY h:mm:ss A').format('YYYY-MM-DD'), id: -1, amount: value.amount, payment_type: paymentType
                        ? {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        //   </div>
        // </div>
        index.h("div", { key: 'ef49ef3ec25ab7fe065dd4272859a28c687699de', class: "payment-item__payment-item" }, index.h("div", { key: 'e0a50f803e04c59fdc2bcc6e722393ed434b883e', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '3213807247c5cddf3eb69023ce83b0a492cbc905', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '4d8e2f771c3a6ee5304be94068ef67a7646deced', class: "payment-item__payment-date" }, this.payment.date), index.h("p", { key: '5c1a76e1b88321dadd737acff9e94977486cd778', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.payment_type.code === '012' ? this.payment.amount * -1 : this.payment.amount)), index.h("p", { key: '11eb2c639ac121cdca9b8a8b1583436ed994baf5', class: "payment-item__payment-description" }, index.h("b", { key: 'f3e473c054eb9459bef9eb6b22eab3b05ab135d8' }, (_a = this.payment.payment_type.description) !== null && _a !== void 0 ? _a : this.payment.designation))), this.payment.reference && index.h("p", { key: '5b7afd273cd84e8d5e192c7d3449d58805fc7723', class: "payment-item__payment-reference" }, (_b = this.payment) === null || _b === void 0 ? void 0 : _b.reference)), index.h("div", { key: '40d7e9601d0f3e269dede735d6f63a5baa3b4d75', class: "payment-item__payment-toolbar" }, index.h("p", { key: '987c3d003417d1c8785296ce41f8ff524f879a88', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.payment_type.code === '012' ? this.payment.amount * -1 : this.payment.amount)), index.h("p", { key: '02393758d4d52fac8555b5cd188b03fcca1995bb', class: "payment-item__payment-description" }, index.h("b", { key: '5f95d873aeff278d1d13b8d12ea8a54b29e353f5' }, (_c = this.payment.payment_type.description) !== null && _c !== void 0 ? _c : this.payment.designation)), index.h("div", { key: '33defcba94fd34966174fb3daca9bc50378e153e', class: "payment-item__payment-actions" }, index.h("ir-button", { key: 'f5d6338c97b4c7dc9a8f7135d16dd29d259ded6c', class: "payment-item__action-button", variant: "icon", onClickHandler: () => {
                this.editPayment.emit(this.payment);
            }, icon_name: "edit", style: icons.colorVariants.secondary }), index.h("ir-button", { key: 'b28b7b7a44e426f8253cca811e5ed86e02e4c5c7', class: "payment-item__action-button", onClickHandler: () => {
                this.deletePayment.emit(this.payment);
            }, variant: "icon", style: icons.colorVariants.danger, icon_name: "trash" }))), this.payment.reference && index.h("p", { key: 'bd5102ec0f21239c45c93da7cc0715381c05df12', class: "payment-item__payment-reference" }, (_d = this.payment) === null || _d === void 0 ? void 0 : _d.reference)));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bdc827920d9aae010f9199a24dfbfe1c0a2d89a6' }, index.h("div", { key: '3e3277901b35f21f44efe7c5eb89082280939410', class: "form-group mr-0" }, index.h("div", { key: 'e4ab38d454f84256f3fc20020b83114665d4c440', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: 'd90c23407d59f5c108882205271b5578c1c4bb0b', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'd21ecd5318dd36f5707311b0648ccf149ab2d192', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: '7f444acbf501a0a3782ca719e5593695b946aeca', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '3f4241ac8c4cdfedff452c1e4b237ee54e53ace6', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '3b756574879fb44cbe768d44969ba15961b886b5', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '8e9b5ade76e1654eba0a1c554bee898b6943426f', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'd3c6b14f2ba4eae82f3c9ecba61c32db5b90ee86', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: '2c6a6ea50b016f5ffadcd88915d03a3d0573a065', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: '683420e1804fb2cdeff7032ac94a6497b6c03cbd', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: '38aa39add8439422aa05112cd83e563d1878ebf5', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '63e131c880e7fe5e8547584a6812f1b7644813a3', onComboboxValueChange: e => {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b35171424c23c6faa8a2ce08609fc41bfa04a237', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: 'cdeae0ad85d036d4a84b678fc7e2e57cab80a680', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '58c2e69c7440e21c6c4ccf6042cf13f15ee51408', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '3cb0439ded1efe7a5cb716e23839559682249f01', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'ee7c3fd5716485332755a01a974d4aa4a14e23c6', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '51a495216d4567b0231eca61366b708fa61a049c', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '983157a06787d9c645f6f37c525605a85499f380' }, index.h("span", { key: '11bd6aac448b7cd430b61359b15a64245f7230d3', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '55d3c3fa77b6c5a007c666a0214f4ff0eb87cea6', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3c7cf9fb737ac02c451d28940180bc637add1b75', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'a080bb94cb81f4173cfab058e49d41aad495de44', class: "input-group row m-0" }, label, index.h("select", { key: 'd9c804c8f3dc6877de53a560765b9e7b83013d8b', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '7545892bd849e536cee929ee366b756712c7a8b0', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '6e92dcbc0fb61a2d6e185ad107633e866cb7413c', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: 'a3b2ba9df9b58b56412f3187e86237570b7eaace', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '59c5e7f8aa3a16df29cabab6d010827276fe5529', class: 'sidebar-title' }, index.h("p", { key: '6785b35c63bf644ad0283edafbc95b3ff8de6b56', class: 'p-0 m-0' }, this.label), index.h("div", { key: 'aee2a6efd057d0bff7ad757a77a4c163db1c6755', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '28fbfb2c12a4f404f3d2e93a6ad66e6194a14258', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'c9b078dcb982ef2d6cca7bcf3c4455fd4dd7f21e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'e4522d74b6b3ad5eae0edc487dae5b56368e46e9', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '47598f78d92ec843021d9d7925e630aebde65b9a', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '4061ed7ed2299b387954c38887c6f25314976725' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fa933612c0db2fa1e5d76a60351da21b55e799b2' }, index.h("h4", { key: '4fd9749af2e5b91e72ec087172938fd85073e56e', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '2c3ad70f9998d289b62140e4d00001759629199b', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '3cfec563242014651f11bb081a573852facaf720', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '0d4d5d7c45d9670fa7a9ebd5992dd72c9f231116', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '67c462c68e0d25211788f6ba925e46edc4bcb397', class: 'title-body' }, index.h("slot", { key: 'b169485ab3572132377b9ac70dd1ade9c5405bc2', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
