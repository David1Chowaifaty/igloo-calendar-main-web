...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'f5cd46af1ee8ffaea3ede8497bc30b8c858b188b', class: 'sheet-container', onSubmit: async (e) => {
              ...
              }`), index.h("ir-price-input", { key: 'ba7665f4f0e4d172c57bedc9f3e44ac055f5dd59', autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'price-label', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: 'dc5c00b266bdf93346ac8d945ade8fa273c1e3fc' }, index.h("ir-dropdown", { key: 'afa41f25a6cc21879fdb498534da1f9f3d03765d', value: (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.designation, onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: '0963d5e072c1e47f7ed5d2cc765b53b547c0dd50', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '5ca9d8c99aaa4c14583e9647fa41db278c52345b', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '1e7c1417fec8f8cd214f3934f7feda25281473b1', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: 'f310fc1529aab91fc9f85750eea12a231c883b8a', type: "button", class: `form-control  d-flex align-items-center cursor-pointer ${((_o = this.errors) === null || _o === void 0 ? void 0 : _o.designation) && !((_p = this.folioData) === null || _p === void 0 ? void 0 : _p.designation) ? 'border-danger' : ''}` }, ((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.payment_type) ? index.h("span", null, (_r = this.folioData.payment_type) === null || _r === void 0 ? void 0 : _r.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '64e3cee03932f016c5aa6e0f6e07c52b2acc91b8', value: "" }, "Select..."), this.paymentTypes.map(pt => (index.h("ir-dropdown-item", { value: pt.CODE_NAME, class: "dropdown-item-payment" }, index.h("span", null, pt.CODE_VALUE_EN), index.h("span", { class: `payment-type-badge ${pt.NOTES === 'CR' ? 'credit-badge' : 'debit-badge'}` }, pt.NOTES === 'CR' ? 'credit' : 'debit')))))), index.h("div", { key: '984d0b60ddc32979d7026cb9a30b214b12d68627' }, index.h("ir-input-text", { key: 'c0816ae76222d884cee2bf38dad26f9a60c926ca', value: (_s = this.folioData) === null || _s === void 0 ? void 0 : _s.reference, error: (_t = this.errors) === null || _t === void 0 ? void 0 : _t.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3 }))), index.h("div", { key: 'e7909bbdc39c93fe940f4a0706766c2a7bf0d909', class: 'sheet-footer' }, index.h("ir-button", { key: '616b218c926ea047b14d3f92e54cce1013718648', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: 'aa3f274d025b783701ac979a6ab97466ed228913', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
