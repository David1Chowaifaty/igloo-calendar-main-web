...
const IrDropdown = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bbdc5a9dfcf4ab2f38a5e8232fc57f7db92c8ec5', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: 'a961cfe175d0bf879859f919b880ba73feb07757', onClick: () => {
                this.isOpen = !this.isOpen;
            }, class: "position-relative", onKeyDown: this.handleKeyDown }, index.h("slot", { key: '0bbb8a695f15daee3224e9ee2007bfcd16b8de75', name: "trigger" }), index.h("div", { key: '8ee8c6cac635d983a2adfa6b7c48591aa2fac7fd', class: "caret-icon" }, index.h("ir-icons", { key: 'c1bd87914dd22041b86624c155489dcf7ecbc2d6', name: !this.isOpen ? 'angle-down' : 'angle-up' }))), index.h("div", { key: '039a93750a8aa2ff1e6b3150c0c427d884d694d2', ref: el => (this.dropdownRef = el), class: "dropdown-menu" }, index.h("slot", { key: '809d03941b6bdf44f9e75d9e2643d85d3c5542d1' }))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8d2177f48f88c595f81060e7046ca05e6b04adb3', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true }, onClick: this.handleClick }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'e07020333f03393c8472ea37d2d03892345e70dd', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: 'ef7f6ac1035f12ca896e24793498311c83f65206', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: 'Payment Folio', displayContext: "sidebar" }), index.h("section", { key: 'efb4362bd74a65c5f345754c1c3c20dde34237bd', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: 'caf6e7aee3322be298a4a75c8e34a946a06bcd41', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: '239afc69fb8f04bcd786ab374a976fe519b297ad', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: '534974946f9e55b6b5744d24aca85fbdd0ef5147', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: 'de7ebbd04e3d6e378d58c20f1778c56aef46c0ce', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '569dae4e64cdd7c2a35ec7a838d15ec776fa40bd', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: 'fa4b9668dda9eb4d9aff941092ce60d4be66fb0d', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: 'e85e700bd6c0b7aa47516c560850776171c454c2' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: 'b3d290ef80440bbe901fcade8dcdfed84363e882', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '31cc834945f39a4c17e14294c01459d1b939d643', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: '38611eb80b529bfbeaeccb62e7e6278424956b3a' }, index.h("style", { key: 'a8525df1ec64c6fdcc16d83cbc8a1a2b1cf87425' }, `.price-label{
              width:133px !important;
              }`), index.h("ir-price-input", { key: 'cadf59dc00b24b3a9974adf2df0846935db91db3', autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'price-label', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: 'c70eb107517081b891fdc07cba6112d73d4a0830' }, index.h("ir-dropdown", { key: '28574a09868b9c25a182f0e0e147c6c17c5c2972', value: (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.designation, onOptionChange: e => {
                this.updateFolioData({ designation: e.detail.toString() });
            } }, index.h("div", { key: '47f46d8730e29164c52809c61fc71088282a6c23', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: 'f969f369be03de737291c2489030400cc74d6c84', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '683fb08171be4d947b272b358e7e9e217a9415af', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: '12b07baa2f7f7659562d9b610f8385e7b9c96216', type: "button", class: `form-control d-flex align-items-center cursor-pointer ${((_o = this.errors) === null || _o === void 0 ? void 0 : _o.designation) && !((_p = this.folioData) === null || _p === void 0 ? void 0 : _p.designation) ? 'border-danger' : ''}` }, ((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.designation) ? index.h("span", null, (_r = this.paymentTypes.find(pt => pt.CODE_NAME === this.folioData.designation)) === null || _r === void 0 ? void 0 : _r.CODE_VALUE_EN) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: 'c2d922b78cc238e290b00594eea13219b1d351e1', value: "" }, "Select..."), this.paymentTypes.map(pt => (index.h("ir-dropdown-item", { value: pt.CODE_NAME, class: "dropdown-item-payment" }, index.h("span", null, pt.CODE_VALUE_EN), index.h("span", { class: `payment-type-badge ${pt.NOTES === 'CR' ? 'credit-badge' : 'debit-badge'}` }, pt.NOTES === 'CR' ? 'credit' : 'debit')))))), index.h("div", { key: 'ea9423e312b4e000446d33b85c76da09e0f95328' }, index.h("ir-input-text", { key: '221697a34f0c2326aa1ef761c51ef79d3ffe51c1', value: (_s = this.folioData) === null || _s === void 0 ? void 0 : _s.reference, error: (_t = this.errors) === null || _t === void 0 ? void 0 : _t.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3 }))), index.h("div", { key: '6dbb9d635b2abe05f690721b1144b7478d1630b4', class: 'sheet-footer' }, index.h("ir-button", { key: 'a2ec6c6ef4d2f7c2a4a8b7c3c140b11a5ca04c9e', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '92224d6866f79adcab5f7ce67c1eaada406df414', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4f072da6791a8cc8cad97ef599a20d2632fad0fa', class: "payment-item", part: "base" }, index.h("div", { key: 'ad394493e2bd87169bed846d6dd9c34273977214', class: "payment-body", part: "payment-body" }, index.h("div", { key: '4e82bbfbc32c9413043439754af040eb62c7f9dc', class: "payment-fields", part: "payment-fields" }, index.h("p", { key: '97158df97eb3cf7897ea654472d5a884f03a5fd4', class: "text-muted" }, this.payment.date), index.h("p", { key: '22060ff41b222a29573103f79e32625e1c4557e1' }, index.h("b", { key: 'dcbfcd689adb0bb7573b17380d608b290ccb83f5' }, this.payment.designation))), this.payment.reference && index.h("p", { key: 'c6820ccdba1fea75cf207fdf216c9767ef74cee8', class: "payment-reference text-muted" }, (_a = this.payment) === null || _a === void 0 ? void 0 : _a.reference)), index.h("div", { key: '1f18a326e78dae6b6d62edbe06035563ab8725c5', class: "payment-toolbar", part: "payment-toolbar" }, index.h("p", { key: '686d273eb3c3cc5e26c1fbce613da9e6d1a01a0f', class: `payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, isCredit ? '+' : '-', this.payment.currency.symbol, " ", this.payment.amount), index.h("div", { key: 'ba41aea838746074940ea98356a9b395e21342b8', class: "payment-actions" }, index.h("ir-button", { key: '9b386c6efc2159b9b86838026017f48e1153a50f', class: "action-button", variant: "icon", onClickHandler: () => {
                this.editPayment.emit(this.payment);
            }, icon_name: "edit", style: icons.colorVariants.secondary }), index.h("ir-button", { key: '5ab51d32489d703d52c6192c0750632849693616', class: "action-button", onClickHandler: () => {
