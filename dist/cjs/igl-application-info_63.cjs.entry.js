...
const IrPaymentAction = class {
    ...
    render() {
        return (index.h("div", { key: '839f008a4c22d467f8aea77fd6987dc3c940f32d', class: `action-container ${this.paymentAction.type}` }, index.h("div", { key: 'e57672d411c0712c2342cd89a955ef31bb9c4b52', class: 'action-row' }, this.paymentAction.type === 'overdue' && this.paymentAction.amount > 0 && (index.h("div", { key: '14ac954dd09e1728d39c5234e3b0a58abf348503', class: 'overdue_action' }, index.h("svg", { key: '172ccefba9b6313b820dda31767e1bef7326a1c8', height: 16, width: 16, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, index.h("path", { key: '9f0db78644ead8f9a44eee58fc288733b12926c4', fill: "currentColor", d: "M256 32c14.2 0 27.3 7.5 34.5 19.8l216 368c7.3 12.4 7.3 27.7 .2 40.1S486.3 480 472 480L40 480c-14.3 0-27.6-7.7-34.7-20.1s-7-27.8 .2-40.1l216-368C228.7 39.5 241.8 32 256 32zm0 128c-13.3 0-24 10.7-24 24l0 112c0 13.3 10.7 24 24 24s24-10.7 24-24l0-112c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), index.h("span", { key: 'dba095f4ba93a57db36e9c6f4de7d77800fd775f', class: "alert-message" }, "Overdue"))), this.paymentAction.type === 'future' && this.paymentAction.amount > 0 && (index.h("div", { key: 'd812e621db9b92c44335c394ed25e8036f70b23d', class: 'future_action ' }, index.h("svg", { key: 'ed099aff14b2fbd065980890be6a620c73cf9cd5', xmlns: "http://www.w3.org/2000/svg", height: 16, width: 16, viewBox: "0 0 512 512" }, index.h("path", { key: '379ba2ead3b2e3803c9e41d0f91117dde5f79db9', fill: "currentColor", d: "M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" })), index.h("span", { key: 'f2dd949aa72f9a25ae0ac40c34ee5744f3f6e831', class: "alert-message" }, moment.hooks(new Date(this.paymentAction.due_on)).isSame(new Date()) ? 'Today' : 'Future'))), index.h("div", { key: '37b1985c71331e16fff6c3da105d714d7a776333', class: "payment-meta" }, index.h("p", { key: '164e3b1a90acad4ac1e1796f580b1cf4222fb7bf', class: 'amount_action' }, utils.formatAmount(this.paymentAction.currency.symbol, this.paymentAction.amount)), index.h("p", { key: 'd59a92b659811204c60990de9dd022f4fff00fa3', class: 'date_action' }, moment.hooks(new Date(this.paymentAction.due_on)).format('ddd, MMM DD YYYY')))), this.paymentAction.amount > 0 && (index.h("div", { key: '84feae25c7426f9c5ea102c52d47b6a8cb535588', style: { width: 'fit-content' } }, index.h("ir-button", { key: '066fac11ae395d293dff23c3190f4a549aeb1d16', btn_color: "dark", text: 'Pay', size: "sm", onClickHandler: () => this.generatePayment.emit(this.paymentAction) })))));
    }
};
...
const IrPaymentActions = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: 'my-1 d-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { class: 'font-size-large p-0 m-0 ' }, "Payment Actions"), index.h("span", { class: "beta" }, "Beta")), index.h("div", { class: "payment-actions-container" }, (_b = [...this.paymentAction, Object.assign(Object.assign({}, this.paymentAction[0]), { type: 'future' })]) === null || _b === void 0 ? void 0 : _b.map((pa, index$1) => (index.h("ir-payment-action", { key: pa.due_on + index$1, paymentAction: pa }))))));
    }
};
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'cddebc99f75eaa88978b46ed6e46acff4f53b987', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: 'c68011576d06d59f4b1c127b83424a7cc42b7169', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: this.mode === 'edit' ? 'Edit Folio Entry' : 'New Folio Entry', displayContext: "sidebar" }), index.h("section", { key: '3e2809073eb77709ca0c86784f15c736cf3e35a2', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: 'c729caf80da683285c3fc412edb5fe6b9fa130ee', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: '5f8249ea60102abeb073dcca4ca8450e89f3cb2a', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: 'e667ee091158c039e66a0b89e6564e2b4e050836', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: '7cf63550b9753fc87840bbe8f237cb602b9e7e0f', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '6302e10f3164881f9b81aef43e5cc4da3afffde8', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: '0352d9f28dcac31efd4bb092964fd84f8a798859', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: '5c9b5c7eaed89bdf8bff81c73d3452001c25da4d' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: '5c22589d608442d7828430fee1456fe1850ae7fb', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, maxDate: moment.hooks().format('YYYY-MM-DD'), "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '0d7b12fb8a5a52737846d4a69d58f328b2b379e5', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: '5132d5362c57f6db65fd737bba10ec86d22c3254' }, index.h("style", { key: '5b8c86215be582f70b36f9fc609bc7e3bc640f3e' }, `
                .price-label {
              ...
              `), index.h("ir-price-input", { key: 'd6aa04f773408b3e5f07d845ca0a10549ef2c904', minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'price-label', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: '72643939008bfb945f340445cdff5d1373c44a3c' }, index.h("ir-dropdown", { key: 'beddb7773ea77189451d3b675a4a659ec549fa8e', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: 'f8dd76441534dd3e38fee1677dd5e0b5b212e3ce', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '7d1ab51a7dc05d560a71dcae92c3d8fd4dcab738', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '1b5f10202a72fe686cfee80f90ff8bdcc6a07e79', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: '2ebfd81e1ffc8c4dda81b649d0183afee480cd09', type: "button", class: `form-control  d-flex align-items-center cursor-pointer ${((_p = this.errors) === null || _p === void 0 ? void 0 : _p.designation) && !((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.designation) ? 'border-danger' : ''}` }, ((_r = this.folioData) === null || _r === void 0 ? void 0 : _r.payment_type) ? index.h("span", null, (_s = this.folioData.payment_type) === null || _s === void 0 ? void 0 : _s.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '2f000fba5dd7f129d864dfe71ed1c3282d9d9d01', value: "" }, "Select..."), this.renderDropdownItems())), index.h("div", { key: 'a2a8a9d0881da7d3ef446010b0c211d41d331bc8' }, index.h("ir-input-text", { key: 'ba4644e49dcf17c4bcbd4d21b2acc82c9daf6177', value: (_t = this.folioData) === null || _t === void 0 ? void 0 : _t.reference, error: (_u = this.errors) === null || _u === void 0 ? void 0 : _u.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3 }))), index.h("div", { key: 'c525332ea3b0df30448a338db5b184ae3667c44d', class: 'sheet-footer' }, index.h("ir-button", { key: '00f63c0fa37d98b5d485187d857a9bb75efc0fe7', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '35102755252171ecf521b6601645b555a760450d', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
