...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '0fc47cc36545a64e9c7f8cbe52df2eab200f1333', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: '88410836bb82a53b78c0ce9b06a6f7047ed711d0', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: 'Payment Folio', displayContext: "sidebar" }), index.h("section", { key: '173bac1fc37a7d91c297a6a6f25d7515adf71544', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: '0a7d2805397470b481c054d58f9108627b4a1b3f', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: 'ebeb5514a045892d7ee8693dc3a2463c4dac0db3', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: 'cb607a5d78ece879d8506b184d8e46fc8283e8f4', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: 'dd26fc280154042f6a75f66c62fe526a7d5a4d4a', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: '6945f5a613e52d4e65fa9cac13f8ae2db6840342', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: '56a37cda6befb73699171da8689934c3b71bea8b', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: '903f4b8b68a06e2e2145cf650dd9136383dd9e77' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: 'e08e0619cd29f080c9efb1302136669562bf5a89', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '444159157d6ea3984997f0b857f8cd1c5ffc0721', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: '6f4fa38a576cd8edf6bb97f4abcd003a8c987c95' }, index.h("style", { key: 'c5e82eb4c5d264374305bb36a267bc2dbfb6d8df' }, `.price-label{
              width:133px !important;
              }`), index.h("ir-price-input", { key: '84d07995c04b9273eba557e0706851abae53190a', autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'price-label', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: '9216198122e3ca8048144bc0c32b023ad5a562d7' }, index.h("ir-dropdown", { key: '0ffd80aa12929c68f83377fc992044df1a7212b2', value: (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.designation, onOptionChange: e => {
            ...
            } }, index.h("div", { key: 'c0b0269c0e964dc9dd7383fdd8c1aa7c969fac99', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '33f8c3e4ebb9741ebec7742c1303677829dff5d7', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: 'b16d82df21103c95ab8fb2d343eb917f3491e26c', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: 'e70ec356fabe6f2cca82381a4ffae744fdeb4442', type: "button", class: `form-control  d-flex align-items-center cursor-pointer ${((_o = this.errors) === null || _o === void 0 ? void 0 : _o.designation) && !((_p = this.folioData) === null || _p === void 0 ? void 0 : _p.designation) ? 'border-danger' : ''}` }, ((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.payment_type) ? index.h("span", null, this.payment.payment_type.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: 'a7638b9c78beb8cd4cece40a43a273abb1aee476', value: "" }, "Select..."), this.paymentTypes.map(pt => (index.h("ir-dropdown-item", { value: pt.CODE_NAME, class: "dropdown-item-payment" }, index.h("span", null, pt.CODE_VALUE_EN), index.h("span", { class: `payment-type-badge ${pt.NOTES === 'CR' ? 'credit-badge' : 'debit-badge'}` }, pt.NOTES === 'CR' ? 'credit' : 'debit')))))), index.h("div", { key: 'f957f45747b699b09148a796c02de744c0ccf034' }, index.h("ir-input-text", { key: '288901dd8ce1bcf45db7e3909c9a191e4d4ac973', value: (_r = this.folioData) === null || _r === void 0 ? void 0 : _r.reference, error: (_s = this.errors) === null || _s === void 0 ? void 0 : _s.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3 }))), index.h("div", { key: '38526844f83dd55cf394406a0ea7f7de1c098beb', class: 'sheet-footer' }, index.h("ir-button", { key: '4bee994095e449161c4eb6be399113746f8deb0d', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: 'a06e59726fcb7eeda47aede665980689efcf57a3', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
