...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c6ef1e5813ff393117dcb4fffcf3557b478de464' }, index.h("div", { key: '7235bed1d2ea85fd03221ed4be6aa69408ac6ca6', class: 'd-flex align-items-center ' }, index.h("label", { key: '054726758e7e12252559283d8e4f09805d737589', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '4b0d5991a08a3fce2e42de1642c475d26f4af333', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'f6fd8bff049a35a9402041c5e9ea0340cd7c0d29', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'bd734a825271fed11c8711eddd2793f332788b49', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'c6773ec48664c4b626feda03292d42231fb3452c', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '54b58ff4f8304a4609607a999ad156a388fabc8a', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'a09d7016c8929525cff3d2ea5f777e24169ae2c0', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '0b18b06643a3ece16cfa1ff5d000336b220e0eb5', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f872e9d90dffbe36fb93546adc6295aa084f06b8' }, index.h("slot", { key: '27d60202ba86b379be06ec031674f0fb5abdee6f' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'f25aa293e2acdd1ac5975b7c456e139ae818c484', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '09de5291a87b35f090613877e798cb0adebbe393', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: 'd6136ac0448b18e6b241afd7f368d60c5eb434e2', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '90fcbc555eee52e69811c245a0adb38826c9bb45' }, index.h("button", { key: 'b37a2475cdeeabaf578924eae6784ec81a1c3af1', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'c6dcdf4d47a253bfb37bdba32d9473733eb89821', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '60abba75aeea01fcf9660f471f36926c8eea53ae', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '26ffb7c1e52406679fe0c6571624b200fce6b02a', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '674e3573b1a66beba8f9bf669aaa30e161fc459d', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '9a78dc365c97ebc3cc5c62d74dc9a4318107eefa', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '2cc7efe36d779418234df88d4b0d2ec790033d3c', name: "trigger" }), index.h("input", { key: '0c32912fff9d1cae4283afb46f960d8b493b08e5', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '69d1535d245fbfefa8768f6f6272237fabce104b' }, index.h("input", { key: '698174ac5c1384b5871a1a2a92742321abf073c5', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '84150891d06f3161ef1b40166ede9c075d8b2c0a', class: "d-flex align-items-center" }, index.h("span", { key: '41008cad19deda418ec32575eae44db7c46e6d75' }, this.dates.from_date), ' ', index.h("svg", { key: '53924989a32d6559ce7c829be6d8e16c9cb55892', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'a4030e21362a14da758cd82a6925f5d8477cf8cd', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'd227cc987899b26265c3dd9a5a937dc8f4c68cba' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '5c87d1ca963a90a39caeeab2e24906737cad4460', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e8c811cd4ff3a8d4882e23c8476aa2264a9a050a' }, index.h("div", { key: '343383051b6f8916132d825a6ac594456811d3b0', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '38caa473f3d6029727318277b239eacb50385aa3', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'b479cb7794b3214520554329345249b2bf9ab529', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '151243b421f95ee22461dfd78a58f94b57a1e954', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '9c447894f44da16c460b5e67389e88bcedb20fc4', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '71da6e1dde2897e88b0f3ea5e8abcd8cf36ec537', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '821ca344f8347fbccd77fe812733fc6a5df207f7', name: "modal-title" })), index.h("div", { key: '57126b49ad762d396c98d8e2c25931258364b3fd', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'f85e2df47699bd3e41c3742247063612fc14cfc2', name: "modal-body" })), index.h("div", { key: '555d22942d5b5b03ee7446dbdcdfb7d77dc9a52c', class: "modal-footer" }, index.h("slot", { key: 'e69b23fab0f3c50b88b837dac94ae95094c0e39f', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7f3a76e5db69cbfaeddab37c4a8fdfc94adc6920', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'f341c8bc45c470e6f3edb41bba152ea2ef6db7ba', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'e875fcb4f4940f1117bb26e5c7263036314f3833', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9ee5a6d5e89b283e3aa62114afdb1470405a6f83' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '575e060039864de991d5a76850525c098a32aa4a', class: "loadingScreenContainer" }, index.h("div", { key: 'e914510cba49f745f8af3a97e96162cf3760dfec', class: "loaderContainer" }, index.h("span", { key: 'eb515bf22a48fd368aa3c03375a9dfd57c5e7e46', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: 'a4d9b5e95e3998a656ce577bf45905cfb7b8790b', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'fa2850901fde90d95cb8770ad274ef227e046834', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'd9b474f029bcada56e31d89e1291709539066871', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'ef95a8d2dab23ea20ac59efbaf1ff70e44e6d02a', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'ca20053dd4eac764145c3ee792ef28dc226d4dad', class: `ir-alert-header` }, index.h("p", { key: '0820cc1444f58001f2f58b777b94fc75543234c6' }, this.modalTitle))), index.h("div", { key: 'a20b9cba7776489e5b8be44499fe5bd34b621315', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '47ace60b97318f29ed8e8100bab2b88e803833c1' }, this.modalBody)), index.h("div", { key: '80c3a624c014f4ec598ac9e27714e4ee5ce34ae1', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: 'fb8b5b398464957894c4490539b093f01933787c', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '92133d378341e9d45f1b73363bc7b5bb743ae8eb', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'bf4953f7acdfefb77b080b93628cbe13e3391562', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd6569058a919a117493ea1c66d03810214f851b9', class: "otp-input-container" }, index.h("div", { key: 'ad1f3a03d7a87008a57729540053456b12938399', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'cddebc99f75eaa88978b46ed6e46acff4f53b987', class: 'sheet-container', onSubmit: async (e) => {
            ...
            } }, index.h("input", { key: '0d7b12fb8a5a52737846d4a69d58f328b2b379e5', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: '5132d5362c57f6db65fd737bba10ec86d22c3254' }, index.h("ir-price-input", { key: 'ad1d88527fc099262619af2cf46bbd280983d03b', containerClassname: "row", labelContainerClassname: "col-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: 'bf4b76c3e7ec10afc2023193047780388e4aff4d' }, index.h("ir-dropdown", { key: '0e34808154505ac8854c606191f6e222301a8f7c', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: '5e440a36eb736e8fbd869c0a6f50455b18ce9a27', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '8eb9bd23929543aef0dbb2ef85e7c13325fb0d0b', class: `input-group-prepend col-3 p-0 text-dark border-0` }, index.h("label", { key: 'a78205cdad559013d3df58d22550009d321c64fc', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: 'b9daac00fddc2fb3b392f32a25fd67850a4253d4', type: "button", class: `form-control  d-flex align-items-center cursor-pointer ${((_p = this.errors) === null || _p === void 0 ? void 0 : _p.designation) && !((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.designation) ? 'border-danger' : ''}` }, ((_r = this.folioData) === null || _r === void 0 ? void 0 : _r.payment_type) ? index.h("span", null, (_s = this.folioData.payment_type) === null || _s === void 0 ? void 0 : _s.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '6f01cb9178334f1853187999513a1e85a5499359', value: "" }, "Select..."), this.renderDropdownItems())), index.h("div", { key: '6ef14f2d1ab8f821fecab101ad4d7101b769838f' }, index.h("ir-input-text", { key: 'aedc0dd346c3363ea9d500eb25a102f83b7fac65', value: (_t = this.folioData) === null || _t === void 0 ? void 0 : _t.reference, error: (_u = this.errors) === null || _u === void 0 ? void 0 : _u.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3 }))), index.h("div", { key: '6e0858ad8e76db19dbd68878f939ef34de7e15bc', class: 'sheet-footer' }, index.h("ir-button", { key: 'caeb403f14cce2f4fd08488044b4e2f109b5b0da', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '0ff67ed286e524caa67e5a058baf61d785a3efea', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3b965a546ce8be99483253264deb130c6305ac3c', class: "payment-item", part: "base" }, index.h("div", { key: '05252ccfa3469945583c01054dc0a4c7dcdf6505', class: "payment-body", part: "payment-body" }, index.h("div", { key: 'a98ded496c7e6ee8bbf3e323b9d4008fd20ee559', class: "payment-fields", part: "payment-fields" }, index.h("p", { key: 'ae9f53e065b8173648d3a447c53d264e3c3c4b23', class: "text-muted" }, this.payment.date), index.h("p", { key: 'ee3f1f863cee227fbd9f713a6fdf9d5415597596' }, index.h("b", { key: '5ad2d0a9db4aab8477fc2ff940942b98e9707ecd' }, (_a = this.payment.payment_type.description) !== null && _a !== void 0 ? _a : this.payment.designation))), this.payment.reference && index.h("p", { key: 'b3af6e0b092e823dcc5e79d487c4b4c389fcc5a5', class: "payment-reference text-muted" }, (_b = this.payment) === null || _b === void 0 ? void 0 : _b.reference)), index.h("div", { key: '96f265e9665ff78dc3246007d8d3ef8c7106d75b', class: "payment-toolbar", part: "payment-toolbar" }, index.h("p", { key: 'a4f8b1a6eef9f0c60cd4b3d1257b72d3dc5b6211', class: `payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.payment_type.code === '012' ? this.payment.amount * -1 : this.payment.amount)), index.h("div", { key: 'd41b9a6e5602e534ec031d9d983103edb7a4ab51', class: "payment-actions" }, index.h("ir-button", { key: '6ff655eb59849949aea0347f5ceec34086c521d1', class: "action-button", variant: "icon", onClickHandler: () => {
                this.editPayment.emit(this.payment);
            }, icon_name: "edit", style: icons.colorVariants.secondary }), index.h("ir-button", { key: '15567ccd47646f5304fff4b97ff0efa68cb14350', class: "action-button", onClickHandler: () => {
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '2848d6ecc1d2b9d9501e78c493ba0e9b8b8b2382', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: 'c66acc647873b5f62fc4e2d2e9834e58e7a73ee3', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '5ec1818f2b9ff12409e69e4b7aaaa6ed5a139a40' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: 'bfde6db2ba1bfb63d3c437b94a0ad729cdacc618', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'e310c90f6dac05ecdd8f7db5a7dde71dafcc48a9' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '68703a8fd0fb5a97fd39f11627a594f57c818e3d', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), index.h("div", { key: 'ce468405b6a487e6edb1430f90e1fe3e102c4ac0', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'cbb5480129b31cdfb990ffc24eee676356f35e85' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '6ed706febf530bf05820154be8d575712661244c' }, utils.formatAmount(this.currency.symbol, this.collected)))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("div", { key: '8f3ec405e0a27a7c3dff427fc3e1d3e6871f55be', class: "mt-1" }, index.h("div", { key: 'e72bcc88445c3521d6b04907018b1d195577427d', class: "d-flex flex-column rounded payment-container" }, index.h("div", { key: '6ff337c17c33414b200f8f31f2a4eab294054d5b', class: "d-flex align-items-center justify-content-between" }, index.h("p", { key: '7773992e68e985c09913754d3803b4a869af5ff5', class: "font-size-large p-0 m-0" }, "Payment Folio"), index.h("ir-button", { key: '4acc2f0c3dc3718e27257a11dacb1822f60078c0', id: "add-payment", variant: "icon", icon_name: "square_plus", style: { '--icon-size': '1.5rem' }, onClickHandler: this.handleAddPayment })), index.h("div", { key: 'b35de2443ccd9960adc8f3475f483c9aeb89ff8b', class: "mt-1 card p-1 payments-container" }, this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'af89b46e2ee6019a7eeb050e910fb01f11755990' }, index.h("div", { key: '2cbc3312e982eb763689630a048ddaa5142b4f48', class: "form-group mr-0" }, index.h("div", { key: 'bcef19639551362c20ed9d5633d058e4d41d8aea', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: '8bce79c282b975a0bc40ebc49a66a21d55886855', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'a6e5492ef55a018e230b1a91fc858ccc8a816ecd', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: '7421f0d2e3e30754a56747c712cb88b25e11986a', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '350f05023a5c64b9e06ccdeb2bd0629961211cf7', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'fd1c2a313dd4d8bc46e47602967cc7b5c7214694', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '3f5ad1729a6e0f13f6846043b4c4aae4d99ed60c', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '36776984b2e19ab67060a46a9e24dfa48b8d6602', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: '51804f80afa9d5d5faad3bd5576cfe49ee72ffe9', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: 'c815eb00279d7dd30329b262f54c86d6116d9a23', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: '89d52688f75b78197238ddb845fea6a4f511cde7', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '974895d903243edc5d51acf27ef80722168668e8', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '1f4bc973dd23898bc1e1dae0adcae73d9efc250e', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: 'c53be85407e276a18659cb0580c0d1b348261f0f', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '7f5e1ec3e25978f4088be7bf6277e927b5534828', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '9ab94bf25b2b9b89d87d2740ec872925a6c648e6', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '7f3466b023acc94c7f2c4bdf1ece29fcf19864af', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '328a9d1d81d4f67751844a8b1b9dcb17f16557c2', class: 'd-flex' }, index.h("div", { key: '482a211d6fd5172b7cf23c59ee637db394e5672c', class: "form-group  mr-1" }, index.h("div", { key: '3b658898c5aa0c1a8da2dea59b6889482a52b783', class: "input-group row m-0" }, index.h("div", { key: '6f30e3b26fcaeff0e8282efe317eeff74beb6f27', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'fc8375485d67d4f62699a7b43708372330cad9aa', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '5a2fa2fa928109ba8e885191a667d12eba0b85f9', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: 'b62204c9fe86a4d1842f611d8838313fbf33442c', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: 'dccc4e10dc0a1b2a916d7f2291212aaaf5fb36f0', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '2bac7c9405b79c914cf0c85759543e9d4d8e5aa6', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '7541f1812368d485db6712a9f6c5c65571e4e21e', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '133ec8c3d54989727a96b53241e0edaf3b4c1dee', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '1f6f603fe854afa05a6a2a5eb11062d1f8201acb', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '57277f5c429513a50859c0bd3e257be6f7b61f0a', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: 'be537269ba7b618147b9436f14c0481167b4653d', class: "price-input-container" }, index.h("ir-price-input", { key: '713590dd1aaf58053fff9aa88f38a5cbf4a7c8a8', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '212a35bfbfacf41ef9a67834069045e7a2c0b89a', class: 'sheet-footer' }, index.h("ir-button", { key: 'e49f1f9094e5356d0365b00ba1980977318d21df', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '928ead4bf526e478eb0e246d164917d56e85a0a7', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6a251ce2b05af1a4f729d50dc579d7e29d4715e2', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '230ef194ca4a66d4d0455b7ee4c045e6c2c71a72', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: 'f03261d136d178bdd03888a878a3ec7a27a46dec', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '35657deb0d0a83551a3266059ac758321d69a571', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '21af7d1de4598290b13b543929822bcbe6d7eb27', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '90ed5cbca4282f03d766a5cd14c0d9c03c6fba78', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '833cbb93990b540357da0404f678dfab16a98f6e' }, index.h("span", { key: 'a86ef8b22ffdb3b09b34a896621807cacb875cd8', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '38da6b5fc4a24c8639565f20bda89ea6930837f5', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '85041b61d86fc61d7a7a38c9f64abb28ef198308', class: "card" }, index.h("div", { key: '18807a918a74f34c69cd6c4184f0844aa8b4c0e7', class: "p-1" }, index.h("p", { key: 'f33821cf53646fe75960361faa1fb9588ca9d050' }, this.booking.property.name || ''), index.h("ir-label", { key: '1f65bb5fa5f45006d1d63b3ba17c23249bb5fe94', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'b9a687f57413841c030281b683d127e8a0a38f7d', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '83d53e1d9aac54671a9cfcf350f58e77c46966f8', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '1cdaa124e4b3e2f89037057ca25f52abb581ce8a', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '2b2f413b0e0c7f160be4be6584481c1c3750196b', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'b2b8c829f80c90a6cdbb64df04f22f48c2e22037', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '617ad7fd2ea113882803bee4e1321bd60deaa5a5', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'b4fa57d7e5546b0af5ca762d485d536e389c655d', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '03efe48088d747612cb39316d4e6bc91039a466b', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '5a36168822674c97703a3bd22d0044699933f705', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'dd48897be90a08b331ed43ea0804b62097fb7d57', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '14e7470475aa03a7a4857c91106d41693e4c8bb1', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '53d2fd2c4d00d09b3151d0364e7f19dd7ee4864f', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '4bce977e70ce6b618ccce71cbe604ae0e1fd8f41', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '6a45d8818d0620ea1fa34e89d0b935073de219ca', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '1c028c3f719592968ec753a139d5d52160751877', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'ab55d8f12969083f5e04194e1762879c6b2ff486', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '9b7f880b122ad2e579bbdad838dcae7b82c590a9', class: "d-flex align-items-center" }, index.h("svg", { key: '9641c607c326a543e18582d7e438d3e67094e8e8', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '1b4ca663ce446d29b2a534d41fa280b4ca5be4ab', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '5cb2740b1b60627610139616ae38a02b15f0d644', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'd45967c13004eeb0acde1b4c4726d2365a66cea1', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '846a47498fa11ee7da88c91c4753ff8d35567e63', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '0323e274e697487c1c1aed06b75e45d4fb3f2663', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '93a2e7c5def14bb987d49194e0769f71c8646a59', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '585e241ec7e14b6e17b228ab8ddb4fe15dd898d1', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'ab5aad30a3be4b892f2c16ebabafbe703597a554', class: "flex-fill m-0 " }, index.h("div", { key: '9de446ee522357cf688d56452f9c22af4d3777ae', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '3b57d36564adf831ed34758b846fe5dacf534ad5', class: "m-0 p-0" }, index.h("span", { key: '610e63ed4f84491a62ebbcd690165386681aeb4a', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '7143913109abbea17f4b3ab2178b24784d306135', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '643fdfd66624e9fdc09cb87cb21d3dba822c22d5', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'fd63e9cdba2b7ba0b9b6952437cdf72ac74b1558', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '840936a81c2ba6f6882748ded922cda7c5a846ca', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '221323f5ec21387b78b8c7b77cc19ed1fc004780', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: 'c801681ef65e2e7a5adcbe91674630187bd90a05', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '3f63ae379cf875318eeb28d1625052d8aced9159', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '3a246a6cc0ead0b0f9d590309c1232b133ada97d', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '783bba81a90e989655d457c3d8c74f15a08165f3', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: 'b25621138c9e6baae7da2f6ccf1d349f14ab36af', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: 'dcd4bd742879916fa97ea2a5dd417223455cc0ba', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '468e55c60ef561c5d95daa66df2f11dc9649c146', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '0d6bd1d67766ff8a6e4497b9fe11049003004603', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '753d6ee7b66b3e4776cdd3ea8bd83b506b0a03b2', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: 'ba8cbd8f6c84b673fb69c5d91ac1cbf11e0ba0e3', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: '3552f3cf3c08f85511d970a13ac236fd36f867be', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: '6c54f9505607d2bffcd12d7e3d2d01511986116e', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: 'e0845dbf7505327c1f1e1f97a7af029c21c6e4b8', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: 'dde3986e96dc1bdfcdf6b844e228f1a43bb5d159', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '0e3af9fcca243330a74cc11a29178ae8439f5a29', class: " sm-padding-top" }, index.h("p", { key: 'e33c22fcc449fffbfd9b42ec8d9fad984fbd1237', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '30e72e3f314de2ec6af4f0c2d7e7b2f68f98f3cc', class: 'flex-fill' }, index.h("table", { key: 'b42a91afd284035d9c306c525e104e619fbd099c' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '234038abec5323fb68997d76a6969948069ae7c4', class: '' }, index.h("th", { key: 'f1a21fc2fd90fd96e465e9c49ba2cdb30cfa1436', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '8ee1e7dd1628714c095671414b9d2ca66735faac', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: '319129e76e4ee3b5a363e425911ee6a05ecc3648', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '3d7488164ae8b7476504cec1cd5cfcb8292f149c', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '833240699a77ad00e9572ac3bab1d1fc1db7e5bf' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '7cca10f74aa30594a242e2990c58a1d3ff3812f1', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '841b2f8466314bd9ccb252b28bd2b24c3ffdca4d', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '5cd8e37a734a42ef165e398b9e43fb829e447fc9' }, index.h("ir-label", { key: 'edcaa41936ad6c5f6ee5f4db829aeb521423b340', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '02874240b26a7b10b361b668ada00e71ea6fa5c6', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '5ddde64f0f04fd554f6f29a8e9b22cd5201b8f6d', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '25cdff25a4281c8da865326d960c57203b26edeb', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '8489cb0d777ff5ec2afc8b1bc4a8b0018a1ec06f', class: "input-group row m-0" }, label, index.h("select", { key: 'c6539ec727fb0cd7521f0e218caa40daf7c21184', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '301fb41397a06deda7bdb75ae64297266f9cb33b', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'e052046b60b74ce6eeb348845c327804c5655d20', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '268dede93fa16e7008f99f0ab4de983573fde8ce', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '0273dd7db5db6c9a68c2a6cd787dffc6c0852d04', class: 'sidebar-title' }, index.h("p", { key: 'ee7e64f2d4b7d805b56ac1b3000d137c45a1b9ce', class: 'p-0 m-0' }, this.label), index.h("div", { key: 'c12d56c210080777937f3c7906c5bd0371e603a7', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '288a89a72b78dccb480ec47fb5fcf08708055151', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '47655bc69fcfff0582acddca5a710fc6592b5d04', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '4e40d7d273db696890829b58f5c53b280fabaa0c', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '077ae37bcfbb05f0e42234ddbeee72c8fe41980e', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '193e003b0b61d788378f2f931fe8b424c0ebf3c4' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '75a93b80e770304e1599d08ca4793efa505a0e0b' }, index.h("h4", { key: 'a5f0ee63000e53f8cbfe23160f3f589cbaa2e372', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'bd994de7b32306be120228dedbf1c11b3b7ae905', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '3c1538e518be31d308ab8ef0566abd3fec455724', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '5952d3570e3f9f374cd2161e7dc5762094b519da', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '846f960af192d47ffcd452dd0e855fdbd6429f73', class: 'title-body' }, index.h("slot", { key: 'a99ab1f571d07408827fa1fac69129321a9125b8', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
