...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3ecadc52a20cb8c614e7891e3ca3ef5ee34ebee3', class: 'px-0' }, index.h("ir-title", { key: '6c402e3fef0ed3d0b1a869169f65ad067125b5d6', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("form", { key: 'f269b808cb87acaacfd8e831937c5ece1872fd09', class: 'px-1', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-textarea", { key: '655aa9f57a6ee8506140941f5348ece96029f6b1', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) }), index.h("div", { key: '54d987c69f17f2a71290eff8b0a98893ba4c451f', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '1704455f9b6c110cee40f3c14c5412d53bf647d5', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '0cf19c8d068eebc8bf4fe97451c9a58677423ac1', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (index.h("div", { key: '92114ea1b8ea2a652a2f9fd9115ad4af6e85f76c', class: "fluid-container p-1" }, index.h("div", { key: 'a6c857788aabd74f0e8b93092d84d09acf193f45', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: 'c4d9c66be5994088345208157bca4e432a81e1c5', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'fb73dd80b90cbb4fb6c8b2d35cb63f1f826ff3cf', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '825163ff7daf9950bcfc347563520aec8de37047', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '0d862885e8d34f7bf9a17fc4e0d44e9cf84472f1', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '5758a7a7ddd1ea6141811fae65e7dd7d295dd8a7', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: '7da6a8825b8b79e5b7ec936c0ea223ec77e23082', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '1790845bfaa58392a19755be2c597565aff1ce65', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: 'f60a0a520d0e777d2f473aacad95e0db2066fcb5', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 " }), index.h("ir-button", { key: 'e9f77ceee830be6b32e0b38c53eb11e0c0365b4c', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '1a8e88c5073dd4966abf26287f8dab26763d8bf3', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '01e52e9fd2d023c497a44ff5f1f19cf1a53e4bf5', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: 'd48700823ce94c03a4eb7c29caa62265d0fa82fd', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: 'ef9c7a758f5d1c8140452440d844b7dba5bf0791', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: 'fa4e5333900f6a6f307ee33b91569d2b25133895', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: 'ce3d779125540da2d5619a05df412b6063c09022', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: 'd2d034589a666bcd12425b1f8a9ebb6c35666e5b', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: 'c4265b614bca6b2e06426abed209b974cbac1e59', onOpenChange: e => {
                if (!e.detail) {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: '812422e1ba9c71e91e3713e153baed5c1246c939' }, index.h("input", { key: 'cfcb86b4ff83e01b9a243b2e402b2330cbac850b', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3ea0b8d1c3516095cc8ce9e1de3636c77ccd21bb', class: "d-flex align-items-center" }, index.h("span", { key: '9f35ab934c053a77eaee02fa2da4c98fc42e33c0' }, this.dates.from_date), ' ', index.h("svg", { key: '3391d01b6bce701e4556f9b645335844d4ebeb6c', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '8b2e81ae1867857a2a2c59acb1fbeb8e635a5396', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'b0ee10b5ec4faadb9960dc154517ad2b86f89ff2' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '8b574ade34eb15a3e2352a39e8d3e30873dad8d3', class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd2ae10789f9d7867e2336553f62c27937b6a8865' }, index.h("div", { key: '9aa5f9f45267d11f6fbda57a6a1a40bb565c31e5', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'cba048266e2aad16324730832224f6ed490e6e37', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '52126a8c007abfce46633922e1191fdb14879232', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'd581ae2b82b64774dfc1f306bd7145d98c643aef', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'ba8cb223dfe9ca4e5102cd4f37a87383cf8028d5', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '3fb8529a57fe80bcaae7c14a8be5063456f265d2', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'e2503896d6c382f1a44186a56ba53ac71e591e8c', name: "modal-title" })), index.h("div", { key: 'f4042d9d2853af5a0d83e36bacc37ecbe13b9b7a', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '726a93e567f92d906502486ca8e7f68593e8d206', name: "modal-body" })), index.h("div", { key: 'a68683da4fc5f63321c76f48176e2709e713b48d', class: "modal-footer" }, index.h("slot", { key: '74f0c250abb7b5080f02bfdd7a72910aed698e6a', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '33bc676a0460e4c3ebc282045d3f613d84c1b9a5' }, index.h("div", { key: '2d529b02cbff21f06636082b20d1d40c55ce08a9', class: "p-1" }, index.h("div", { key: 'cf83047db89087409fa795cf9fb7eb7a98459cb1', class: 'extra-service-container' }, index.h("p", { key: '432d493ae97e17304cd2b7041db3c209bfc9173a', class: "extra-service-description" }, this.service.description), index.h("div", { key: '27b442b4c6cd8539aad05ab5a5eb3cf0e9c10c0a', class: "extra-service-actions" }, this.service.price && index.h("p", { key: '53cd2f5582370a15b394c284d122ca7f5536c2d2', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price)), index.h("ir-button", { key: '429e112d2dd9a27363fc43fe4be8b0a65c64f8d4', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: 'f42f6e61edfa0df937a388fcc4c72e8d72f0cc0c', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: icons.colorVariants.danger }))), index.h("div", { key: '75953dfff76b089319b6d6529038142ef2c18d9a', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: 'e6454a26817639612fa354e931ab82cb6f822be7', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b7c53a58fb9b4e5dd5697869ffdbadbd3f01b8a6', class: 'p-0' }, index.h("ir-title", { key: '09867431a99ca27cc1768f76cb87936bf0cef673', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '366ca1044ce95aad86ec959663816d471b633264', class: 'px-1' }, index.h("fieldset", { key: '224d14f04201c66182fe8386cc7cd0cff6f92b1c', class: "input-group mb-1 mt-3 service-description" }, index.h("div", { key: '358bbf259e44405e5f8db8e4372f8433db938fe7', class: "input-group-prepend" }, index.h("span", { key: '70ed373ab5bb2daac2666ffaeb5075b71a093d3f', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '4c9b1a3af52742291cbaf169a3f4d3c7fc57a160', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: 'ef57a70305fc1409899b4015c2575542ed0972d0', class: 'row-group mb-1' }, index.h("div", { key: '0c021227b294d7cad1c87955f506b9603eb5de84', class: "input-group" }, index.h("div", { key: '2105d3d52a05e5af942a0e9660940714e6e3bd50', class: "input-group-prepend" }, index.h("span", { key: 'e76323c07a5a85fabfc7a9df4d6e4047654fda77', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: 'c35c6c053477d42af3a24aabb47599b26458cd74', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '26db6c3483762df89ce7f25ef89dc302d0774657', class: "service-date-container" }, index.h("ir-date-picker", { key: '142b957a719fc88a6733e798277ade72c4b9bdab', date: ((_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date) ? new Date((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) : new Date(this.booking.from_date), class: `hidden-date-picker ${!((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) ? 'hidden-date s' : ''}`, autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start.format('YYYY-MM-DD') }) }), ((_f = this.s_service) === null || _f === void 0 ? void 0 : _f.start_date) && (index.h("div", { key: 'b9e32827aeaaf1086f5a9bdcf413bfc40b830643', class: "btn-container" }, index.h("ir-button", { key: '016d179a8c3a3ec38ab1a78a987decccd2c246bf', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '15f764bfb4497989ff8efd8d825085b5dc6c8926', class: "input-group" }, index.h("div", { key: '483b00646a42bd66713962facfab17f5d60c6278', class: "input-group-prepend " }, index.h("span", { key: 'c5581b5dfea71045c2c329795c70b7e92dbea504', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'd3a5779831d5278b1ea488ca47462edcd779c143', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: 'f2c8e26f7129bcb09230cf3b0e55fbb095e750e1', class: "service-date-container" }, index.h("ir-date-picker", { key: '5a115b1e68240f4161441917abdac5c329af2fb0', date: ((_g = this.s_service) === null || _g === void 0 ? void 0 : _g.end_date) ? new Date((_h = this.s_service) === null || _h === void 0 ? void 0 : _h.end_date) : new Date(this.booking.to_date), class: `hidden-date-picker ${!((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? 'hidden-dates' : ''}`, autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start.format('YYYY-MM-DD') });
            } }), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '0292c9af40db9b481735dfaa8f54a20ca7bd2f9f', class: "btn-container" }, index.h("ir-button", { key: '92ace825fa49c4a13d73647a871d450200647abb', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: 'e7286513ea8943991c2c93275f43d8189dcdb304', class: 'row-group' }, index.h("ir-price-input", { key: 'c3701c1d2342ddb61bc94cbebc7e076b3c595399', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '821378219adaa40d64649b960f45a20dd3d7014e', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "cost-label", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" })), index.h("div", { key: 'befe3c0ebb91ad470f6f48bc64ac457a1a8d5af0', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: 'c8ef1f2d3713e46ed0c222f43c09846cda422a1e', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill mr-sm-1`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'd6f099c40430cef12ac0404d3e8598a88901e1f5', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.saveAmenity.bind(this) })))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '41b72d064a253e169f638df6707f18f653765d6b', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '467faf68756102f3f275528b51e31d4cae5a3836', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'e158c53b0f286f12a14f6bdd833d733803a3c6d1', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '791521df038501a259a59fc6e763759a992e1060' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: '249466036b8b8886c5251539ecaf8d93cf702319', class: "loadingScreenContainer" }, index.h("div", { key: '7244d11dff5f6651b202a623e5f5dc87867449e1', class: "loaderContainer" }, index.h("span", { key: '2ab07e4e266ac97f6f8332fb1b0a57ca63cc6422', class: "page-loader" }))))));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '576223fa8a797d0aa6c1a3151bb7f07c87f8e70e' }, index.h("a", { key: '302f2cbc7a2052d35b7c10005a61178ff66a72cf', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '46c92ed9a62020d45d74f8f0bb59c483ae4a7c81', class: "sr-only" }, "download url")), index.h("section", { key: 'c6762bb4c34cc1e70d94982cc3fd95e911a62c1a', class: "d-flex align-items-center " }, index.h("div", { key: 'b4d7a2fec1222863faf65addb343c63690a9ca11', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'cf55d02ccc1b994b0566e56c0d088f9092cab63d', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'd5decb11659501921d2c3d455cf247161d0083cd', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'b40caedc84d45a5d440f5fe4ccca96bc9e78afed' }, index.h("igl-book-property-container", { key: 'bb810bdd8eb43522303473026bc7c2fbda98bf2d', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '16d577eba423f4146c51d39cba17722600a2cd19', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: 'f601bb5935a33de072eff1badded69b5d5ebda58', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '490df705182b39afcbba556d9593b84cc3937430', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: 'f64e494d117bf669f1828deda16ae597d2d17414', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '743a85b51fa9b16b1f8c979f2f7f7fc1f2dc09bf', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '7c4bf89c892205b995fccb23328623b7a54976ea', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '3d6ec59534980a47185c345889a29b43a426dbc7', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: 'dae48e8f1c42bc0ec19558e974c5e15a1a22bcdd', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: 'eebd0a2f6739517367bf0f3f9fa30bdccfabcae4', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: 'd8b0e1d50d232ad685fa0fd680679f03f9db3e5c', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: '55bccf50874a8ca2558442be026bddb29bbf2c79', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '021f4ff7242f4b28205ba7379154ce3921cb2afb' }), index.h("h5", { key: '5ff2baaf31a1cdbdb32cb35416fbcb06818def1a', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '9acf2f651fa7256cca2e63541fd96b1f7af64ded' })), index.h("section", { key: '9ed2c4d1fe6405ccb3d2d4121525e6ff0724140a', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: 'aa2abfe9a46bdf30ff9bbf6204c782f9281036fa', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("div", { key: '426582f0288a3fe406e7a87c9443c1e2477a4adf', class: 'booking-dates-container' }, index.h("span", { key: '6a8f6939b73f6234ea6752daa99fe6121b8f9408' }, index.h("svg", { key: '6bd8abfba30dac537c66bb8b92e2d8221e9c5635', xmlns: "http://www.w3.org/2000/svg", viewBox: '0 0 448 512', style: { height: '14px', width: '14px' } }, index.h("path", { key: '80626ecbd620bfa9327221bf9898b835b5d17fe4', fill: "currentColor", d: 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z' }))), index.h("div", { key: '874b59383f1a0dc215931752585f67ad6d7e7266', class: "date-picker-wrapper", "data-option": "from-date" }, index.h("p", { key: '4cf36a51ad4fe7a595a142c90db71aae979677c3', class: "date-display", title: "from date" }, moment.hooks(new Date(booking_listing.userSelection.from)).format('MMM DD, yyyy')), index.h("ir-date-picker", { key: 'ab068f0dc481f359793bd0c9f4787991dac25c18', date: new Date(booking_listing.userSelection.from), class: "hidden-date-picker", autoApply: true, singleDatePicker: true, minDate: "2000-01-01", onDateChanged: this.handleFromDateChange.bind(this) })), index.h("span", { key: '5ea9c203e7f2041932a0d0a10983fcc7dc3d53c4' }, index.h("svg", { key: '2ddc7507e10cca0b2550ea18112676563542cb7b', xmlns: "http://www.w3.org/2000/svg", class: "arrow-icon", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '9b265a8168e500a96d4e7a94632b32e081b7159c', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("div", { key: 'a7c618600b5518b102ffca8067101e00f5f7313b', "data-option": "to-date", class: "date-picker-wrapper" }, index.h("p", { key: '53a11cb6ebb15cd11ac84206bebfd4f78f67194e', class: "date-display", title: "to date" }, moment.hooks(new Date(booking_listing.userSelection.to)).format('MMM DD, YYYY')), index.h("ir-date-picker", { key: '0bbd0d5e63317023b1acd6d5e794a0fa29dc0525', date: new Date(booking_listing.userSelection.to), class: "hidden-date-picker", ref: el => (this.toDateRef = el), autoApply: true, singleDatePicker: true, minDate: booking_listing.userSelection.from, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }))), index.h("ir-select", { key: 'f772c7ca3f266f1e71cd94321e4964cc5862dd38', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'c80a27b726649c606733d99fff3a75554f24c46e', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: 'f01a0dc7edb542c3f4ec3e7d97350138e4554b9a', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: '79b7dbd48eba3df5e714412582d6363169f5a185', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: 'c90290e3c79b7ca5b6a64665ddd36766a450afd6', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: '6529a19a39cfa7612939b187aeae33281e83526a', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ee17ad95d708a12e525f6a356bd3878adf735462' }, index.h("span", { key: 'ecd2907c940636dae85dfb40e16e8f0ebbd0f291', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '7171e3f55802a509f076c2e90b66323ae5a39dfe', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '38dcf6c18e69127153b6d2dc6c3adca119722656', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '99ed898bcda4fd9b8cc7dac4ad18063926782812', class: `ir-alert-content p-2` }, index.h("div", { key: '3e9d27e104eee568438132448aed3ff6337e1b4b', class: `ir-alert-header align-items-center border-0 py-0 m-0 ` }), index.h("div", { key: 'e6d6a19d7c54cc7e4d701cc9b196565a7fa1c489', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'aa87fc76d9769fe6d2b7f691514bd77fa93069f0' }, this.modalBody)), index.h("div", { key: '6d0d14a59180149145d517ad3d4c49662988d252', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: '8c4cec1bdf182b589827f67a59198f6e8ad72576', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '17d056c8d3d2c3534e097cb1deb04d9e8429a19c', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b56d5c66215a955b245d08902218ea947e713578', class: 'p-0' }, index.h("ir-title", { key: '6cc16d2ae48dba84e1067d6bdf409d43d01f7eca', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '4061c1595a918b9ba4dc2f248047a92ae4ced3c8', class: 'px-1' }, index.h("ir-select", { key: '57e088ddb0b8b3f8a352e0fdd2314444130ed3a8', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h(index.Fragment, { key: 'b3307d64d6a6364c6296ae1a90b91b3ad37a0e70' }, index.h("div", { key: 'f40dbcd442eb5d8cd20af497bd69189e33d4aa40', class: 'd-flex' }, index.h("div", { key: '05d6b7656042ac73d05bdc8b6d6ddef18803dcf4', class: "form-group  mr-1" }, index.h("div", { key: 'f8e6e56eea12b0580212043ed2087f6bf7b8d59f', class: "input-group row m-0" }, index.h("div", { key: '7ba1ca2a11150506241085852057722f82a7896e', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '5e5651a0fbf89892db8801798481f192a37104a7', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '44339fe6b8457c417de9a64168eec518053a0f03', class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, index.h("ir-date-picker", { key: '004f2fc08d43aae526f7518b115927c0dc352639', minDate: moment.hooks().format('YYYY-MM-DD'), autoApply: true,
            // format="ddd, DD M YYYY"
            singleDatePicker: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start.format('YYYY-MM-DD'));
            } })))), index.h("div", { key: 'f6817cb5f8aa339d65f1cd3f0e7ddc8eb70ec239', class: "form-group" }, index.h("div", { key: 'd28fba3dc670e4e6359ffae64dc12b18420fc15f', class: "input-group  row m-0" }, index.h("div", { key: '02305939464891eca73d6ec0e52e2d1a2d12a52d', class: `input-group-prepend col-4 col-sm-3 p-0 text-dark border-0` }, index.h("label", { key: '158a4d25991d3ed84406ad522c5e3ffd9b6c8896', htmlFor: "pickup", class: `input-group-text flex-grow-1 text-dark border-theme` }, locales_store.locales.entries.Lcz_Time)), index.h("input", { key: '39bafd39fa95d4f97e66a91b1eeb8d95598914ad', type: "text", value: this.pickupData.arrival_time, id: "pickup-time", class: `form-control col-8 col-sm-4 ${this.cause === 'arrival_time' && 'border-danger'}` })))), index.h("ir-input-text", { key: 'ed9fe4d6b8baaf9ae6f301b4fe3c4c938f660fa0', value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", inputStyles: this.cause === 'flight_details' ? 'border-danger' : '' }), index.h("ir-select", { key: 'dfbe5f10994554b382fa836c16137ae037612218', selectContainerStyle: "mb-1", selectStyles: this.cause === 'vehicle_type_code' ? 'border-danger' : '', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '97d97a5ea8c35fc27403eeea839046aeee78f529', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '09e86d2eaf8b9afb0962a5b4c7b9e29d53e8b58f', labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectStyles: this.cause === 'number_of_vehicles' ? 'border-danger' : '', selectedValue: this.pickupData.number_of_vehicles, labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("ir-input-text", { key: 'f24b12fb97681cad1040614b7ef001fb073b2027', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales_store.locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" })))), index.h("div", { key: '6a54505d3972161553f3f26e5883a1c5c9d9b88c', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '517184f86d89554217c6b661453cfb5ddc16f514', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  ${this.defaultPickupData || this.pickupData.location !== -1 ? 'mr-sm-1' : ''}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '7605c13dea1ca2658f176dca8b37835eb987c762', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.savePickup.bind(this) }))))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '8fb6de41677d85b67889d08a351f97ee7dd67a89', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: '6f9f5b8db155ec9bb382396d2a606c3b7f7680e5', class: "input-group-prepend" }, index.h("span", { key: '298b2cb9dafb27ab8c344b1366c61ff72d168d43', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'e4ac9cf28eeefc791fe4c3b955b321a88bf77946', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'e1b9845bcd410866e2a419848125d7e2b0cc0cac', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '8a9db3430c0db244c3afe59f1e23cd6042940416', class: `input-group-prepend` }, index.h("span", { key: 'e81efd2c01b64ad73258bff12caa12d2f94a4b8e', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '99c61fac2c6997fd3aec0240fce61ed60b5806e1', disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7f371f51f1c15303c59752dc7e76d8efda70d58e', class: "card" }, index.h("div", { key: 'aebb9feb8616b60a5dcdbb3e641b5d45529308f2', class: "p-1" }, index.h("p", { key: '6964aabe2abc32f719b63c22eb5fe882ec3e54b3' }, this.booking.property.name || ''), index.h("ir-label", { key: '04e0a38a353035883d115dde82a07893dec36498', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '261ace177d9d207698d4c04d22a72eaa0f6563a0', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '4ff2afbaeed8da7e1d79400546f7821f70cf9670', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 0 && (index.h("div", { key: '9075035cdcee53770b9532c9b459af7e3f562d27', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '14a06890f5077ea22702e1b977ba04c38e8aecff', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'be9cddf5e678722d2ca6bc4bdb47d0765aa92e77', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '187fc0205abb44a511674fca294e24ab2c3ffb9e', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'ff2c2fe9348885d658698fe507ec2ccc25be052f', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '3eb0bb32e935acd820f28202131b311118e27e47', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'db45d0ce6fbdecb4296446d65cb8e8ed167ee9cc', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), index.h("ir-label", { key: '30d796e7cb50d3531c62d7cf339aa517707eee0a', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '32004b26b567fa8f45146da5fb698537edcf6525', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: 'f90bb871a149ed7091142b66807ddb34d38e5b22', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'afcc7503587694f8cda0e5e3597e4a27ebc30a6f', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '356196ff75032873232ab16270d1db352457269b', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '2d362cef7e24fa0d1d31aad85ad99c12dd6729dc', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'aef4d88e455b06290fc484c6ee8c8a654b67c581', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'bf83e314a46db2eb774feb94964842d57086beae', class: "d-flex align-items-center" }, index.h("svg", { key: '9b545e3b518672d43a5b568a38be229576050485', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '866a249f374a496805b9493ef78b897ee3038bc6', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'bb9020f8c57be87585badf93cf77b649f943fb52', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_Note}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_Note}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'ad13127f804b70de15678d6eb0849bb975913f06', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '1b2491c8b98ad20a4c1a62569b93be258089ff4c', labelText: `${locales_store.locales.entries.Lcz_PrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: 'c5b9e348130e4371f78b63585711af9bc1d55920', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
const IrRoom = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '97cf2fbe4f2063ae0987bd842fb706265c43175d', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '95e2f15b57330807911ee3aeaee12fcbec42c15e', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '81dc9e07db2dc8c3c592c4b5489ab40cefa52bbd', class: "flex-fill m-0 " }, index.h("div", { key: 'f37966ffb914f41c539b64f2a460d3ca78e20aa4', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '9e727448b20092822a60958a30a5d2630bad310e', class: "m-0 p-0" }, index.h("span", { key: 'f580bed05eafbe6f14881d058a8c9a61609dd7c6', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.item.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '5b366179af95c01358c519e1c3489ad64a02a607', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '40781326d36e0cd1635aaa09eee9dbacbfafc11c', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '79f2ca179a5914528cc5ed7ed6cffd5759cae4a4', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '4b9f53ea08f27cd81e69071b1bec02543847a783', variant: "icon", onClickHandler: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '5f899c3c4a70df916fd73243ef2390bedb6afae6', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '1e9a4bddfe4030f5c78e57a69b282acb639d3492', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: '28319088f734edc7ebf3850eebf40f4cef040208', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: 'd074bd3fa3a120cb07a37e274257ca4bb56ba481', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !calendarData.isSingleUnit(this.item.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("div", { key: 'c4a46bce81b0fbcf860338ded9d8e94ecd6e003f', class: 'd-flex justify-content-end' }, index.h("span", { key: '97c958a8de59fde871d7c777213b8299120e4b77', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: 'b17db41d14333c57e30918370437eba6f2a789d5' }, index.h("span", { key: 'ea30804b53343240c62ccbf407dc7efa0440ba54', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", { key: 'a5b7f13dec4b53c211d621ff276aaa38fc8ce3ec', innerHTML: this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy) }, " ")), index.h("div", { key: '136aacce4b4ccc7486cf00e6366ef5edca178a5b', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: 'f603a98d5899e4c27bb660133484244d6544555a', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'baa080d74de94ec40d631be32f0db2959ce858b1', class: " sm-padding-top" }, index.h("p", { key: '871a4f11a70da52431f438facea973fe8001c51a', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '34ba8d7704b6c8d169325289231a49ea2f28e2cc', class: 'flex-fill' }, index.h("table", { key: 'e456b696d85d998c2032c4839366d52e7345efb5' }, this.item.days.length > 0 &&
            ...
            }), index.h("tr", { key: '341ca8f60aeb12cf3703cc2c87925ec351b629af', class: '' }, index.h("th", { key: '9303bdd3ce02e1d025702a1daf7b208de2e1d539', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '4dbbed3cacc1e7a93ea7f7bc9af41ff28cf35fb1', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && index.h("th", { key: '2d91801acbf004199e19c8afed0991aa48fe8520', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), this.item.rateplan.cancelation && (index.h("ir-label", { key: 'ff937453481df50bf918940dca2e6a2d87024ecd', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, content: this.item.rateplan.cancelation || '', renderContentAsHtml: true })), this.item.rateplan.guarantee && index.h("ir-label", { key: 'ece6d9b79dc7a0b6d0f83c705e96864c43c1ed57', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, content: this.item.rateplan.guarantee || '', renderContentAsHtml: true }), this.bookingEvent.is_direct && index.h("ir-label", { key: 'a5405ad63fb717f8158522ee2ae587d46ff699fd', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, content: this.mealCodeName }))), index.h("ir-modal", { key: 'c3ead3808faf65f194106ac583d8892b4d1999eb', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSelect = class {
    ...
    render() {
        let className = 'form-control';
        let label = (index.h("div", { key: '96d50baad46ee6687fea9bf27e785fb2aaffd019', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'f79c8be343949dc4095df78d7bec8622dc612cd8', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '23ae7fe7515bcba111076440c0cddd205cf5d6ec', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '5fc35b71e61a60939f1a4899ad071edf99ad1b66', class: "input-group row m-0" }, label, index.h("select", { key: '8e0d3a3ddd363e567120acd8daeef6e4eb99ca18', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'fc5ff220dfa873550443312151d1500964ebb12f', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '248bb6c340420fdaf645a9d01f72bc8f5c535643', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '4fcc149416451cfc0731012c70768ad4f7cf01f9', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'f250dffe915de655762a3d44adf12e9380e48bc0', class: 'sidebar-title' }, index.h("p", { key: '1de302fcd98f166d574973c9b06b037224310f7c', class: 'p-0 m-0' }, this.label), index.h("div", { key: '9b29c15cb85b165729b55f55006e58cf36026cd8', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'd8e1b3d35643af855e9d18ee42091330dfa20507', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'c9906ebb44fd1b6e9d3642be754e60f9daf3b0f3', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '93b0e565a86e9804489ba51f921d4976209df7bd', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: 'd147a260a0bc1428f5de24bb6231b2cee19f73db', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'fb02b2cfb00ab0e0878cb73cb856083532ba3544' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTextArea = class {
    ...
    render() {
        if (this.variant === 'prepend') {
            return (index.h("fieldset", { class: "input-group" }, index.h("div", { class: `input-group-prepend col-${this.labelWidth} pl-0` }, index.h("span", { class: "input-group-text" }, this.label)), index.h("textarea", { value: this.value, class: `form-control`, style: { height: '7rem' }, maxLength: this.maxLength, onChange: e => this.textChange.emit(e.target.value), "aria-label": this.label })));
        }
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3c5dd5817cb6c63c6d115aa1d41d9b83b8acdbb1' }, index.h("h4", { key: '1fafd9b914e489c3b29da1552af8d152d331ca7c', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '66540e2fcc746a4e269a2b4c3eab57f9a679e005', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '2db8d6738ac141fdc2936e2bee5bf560048d3e1c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '71c37934e0d93c56d31cc55a3f61aabaee3c00ab', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '59cc5fb6cf6468a4dba5cad0fb9260ecc52fef61', class: 'title-body' }, index.h("slot", { key: '4e7a9b8121b6061d0270e27f1200c64c4719ad2b', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'b8037345bdc57d4f9ee45bdbc8b68b5283745f6c' });
    }
    get element() { return index.getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '42d288990cc44ed44cc6f6600da9c92f6967b1a8', class: "m-0 p-0" }, index.h("span", { key: '60fb761887f1f49ba5c7eed15d65bec08c04258b', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '6cf92316c0fc74e99e65813dacd052c0ffb03547', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '1a675d41d4df2d69dc10ca2d112cf76ea68119c1', class: "tooltip-arrow" }), index.h("div", { key: '38cfeff681b9b9a6566bcb0d38a3f44478ed3208', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: 'fa1c690bba45598d12ceae6b3b13c9c2dd54d56e', innerHTML: this.message }))))));
    }
};
