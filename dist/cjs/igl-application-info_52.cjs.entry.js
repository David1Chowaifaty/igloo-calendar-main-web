...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '168afe2a0adb70cc27d653229452e6db41677a44', class: 'my-2', "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: 'b95937c56820be7ff104e1d5a8718dced090c877', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '80188fdd737e41c8bc9dec8b07cc316e0d00cfcf', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: 'd678d8b12b9b3d41632a4aba6ce35778904d7dd8', class: "booking-details-container" }, index.h("div", { key: 'fab97f6a7b6372bc7e6011347227b04ef487361f', class: "booking-rateplan" }, index.h("p", { key: '8cc4a78e9eb767c3ddc434f92ca8e29068ace5ab', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '5a65c330b94313578546dfb2d4e8c1a32472469f', class: 'non-ref-span' }, "Non Refundable")), index.h("ir-tooltip", { key: 'b364758f2d538b682677f5332c9518576f05c87e', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: '43d8836e67e5d0259c004beef00da123f9db7c27', class: "booking-variation", innerHTML: formattedVariation })), index.h("p", { key: '726d546747acfc31af57b90befb0d524fca8e763', class: "booking-price" }, utils.formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: '20aeb38d70d9514342d5ec133f50f5c2f7039d4e', class: "booking-footer" }, index.h("div", { key: 'de1ceddf8c72c803f6c078516e6f4a016190e5cd', class: "booking-rateplan" }, index.h("p", { key: '60c0787c8d207a7165fb3553a917cc662dfb6117', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("ir-tooltip", { key: '5e71a0494c289d60e482f303a8c4ba49a377464a', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: 'b8100153ee35934d38a95d36270cce0b02e3cbef', class: "booking-variation", innerHTML: formattedVariation })), index.h("div", { key: '6fc7a5d53631cde0f079940275d5ded9656eec95', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, index.h("div", { key: 'ae6ebdee013fc75985e4a95319e562d9cc4c1c04', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, index.h("input", { key: '2fc53029b71742aa4bb5140759d6d5a9efd3a4b4', id: v4.v4(), type: "text", "data-testid": "guest_first_name", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales_store.locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
            ...
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("div", { key: '57f1c8a1840fe3a76616d5a46760568bed3fb8fb', class: "mt-1 mt-md-0 mr-md-1 flex-fill" }, index.h("select", { key: '79bd56803fe9714ef03cc754347f199754af720c', "data-testid": "bed_configuration", class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, index.h("option", { key: 'ac1fa21c8e52aa4a31d2b75d1ec75e9e35fc4eeb', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales_store.locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), index.h("p", { key: '6b1a173fcb5336cc22d5a31c17b4d53c4263797f', class: "rate_amount" }, utils.formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: 'a499fc98e7aa817c29d016af208aca2ee3d61293', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, index.h("p", { key: '67822e22849c0bba03bc73aa9a4e89969fd445ee', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), index.h("div", { key: '290aae074c9f5cb0aec8cb794ba7c0b7c8136b58', class: "mr-1 flex-fill" }, index.h("select", { key: '900177bd371f4a870ee754f5dade89aca8a97e93', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4.v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, index.h("option", { key: 'd8a2b050279a019995224b9b73b352ef1aa326c8', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales_store.locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7d1f03890edf8778e3c953284b39f28912334896', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'bc6029ab01ffb7c6619a1bfff56aa52786571826', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
