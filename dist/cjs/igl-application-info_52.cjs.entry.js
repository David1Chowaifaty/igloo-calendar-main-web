...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0234a53b3fb171a983bb57cab1f7afd2f99df846', class: 'my-2', "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '45b3d01b6bf92726875755e163e6581d9a690f98', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '0f3fb8f85b8c6d343df6d80275a61acfd962c3f6', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '0f2d07d9309d6959b2bde3efdf28e0f33bbc6451', class: "booking-details-container" }, index.h("div", { key: '61d099631abf7e9fc5859bcfde4260022f717eb0', class: "booking-rateplan" }, index.h("p", { key: 'd0739e5c7f63eb99fbdb5830406d4963663dbc3a', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: 'd1259e1e53eb28b353566966fb98804deec6adf1', class: 'non-ref-span' }, "Non Refundable")), index.h("ir-tooltip", { key: '679ea2fb9bc98bba37df7d259978556a547675b6', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: 'fa5287ac254857a40999752d20d4408ca6b9c66c', class: "booking-variation", innerHTML: formattedVariation })), index.h("p", { key: '2c5d9b9796cb945968b0cac6548ee9f86a34ecab', class: "booking-price" }, utils.formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: '159a1275948f448f9a63a555db20ae5746e35a42', class: "booking-footer" }, index.h("div", { key: '4451b3725522fcf5acc902f5123eaea72e68a150', class: "booking-rateplan" }, index.h("p", { key: '815ffac3c61e4299873944412903911dc92c84e7', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("ir-tooltip", { key: 'd6321774db2704cf20f85f2b39145a8384815945', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: '2af97176cc26b54d574d674a929bc0cebd19fc05', class: "booking-variation", innerHTML: formattedVariation })), index.h("div", { key: '7406e2f9acd30f01f7eb9d0540f0bae3b5a9eef2', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, index.h("div", { key: 'faa304d9a94519b80dcb92465894fc3cf91a8b2d', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, index.h("input", { key: '599889df5e6ba7d42a86d604b1e4e20ed29d0726', id: v4.v4(), type: "text", "data-testid": "guest_first_name", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales_store.locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("div", { key: '87b4e56c62b55a8cbcd76fabd2c394b74c19894f', class: "mt-1 mt-md-0 d-flex align-items-center flex-fill" }, index.h("div", { key: '38aec0bcf266a2167f75178b0b2e1719e97dcd4c', class: "mr-md-1 p-0 flex-fill preference-select-container" }, index.h("select", { key: 'ae756938c5ce0e4d07759b6f057fad2843af14a9', "data-testid": "unit", class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, index.h("option", { key: '67716637c3e22dcd285dacc588e33693c98dfb52', value: "", selected: ((_h = this.guestInfo) === null || _h === void 0 ? void 0 : _h.unit) === '' }, locales_store.locales.entries.Lcz_Assignunits), filteredRoomList === null || filteredRoomList === void 0 ? void 0 :
            ...
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("div", { key: 'd3a07dfd2cb21480bec202b6c7db5a9a005dd4e7', class: "mt-1 mt-md-0 mr-md-1 flex-fill" }, index.h("select", { key: '38c4e2244c6c136c8f1d256d6e0a2f72fc91a33b', "data-testid": "bed_configuration", class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, index.h("option", { key: '770ff61ac6c383e658327677a3cb1ddfb5c8a22c', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales_store.locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), index.h("p", { key: '4067f4f8ab446f673d150a104c993299d91031f7', class: "rate_amount" }, utils.formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: 'a1d102f420685a850f778841202ce35461139312', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, index.h("p", { key: 'bd0925388ac0b06a7325ce1f31a28611ab6391f6', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), index.h("div", { key: '3829742f1bd0c4a5fdf4e15a366f96780bfc3680', class: "mr-1 flex-fill" }, index.h("select", { key: 'bcd72d4bd91c44f1ff0f0d76bb1bcf7f998bea91', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4.v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, index.h("option", { key: '88d018089dee5dbb636e75749086bc6ab15bf8e9', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales_store.locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f48073fd5bfb65ac88a92d3a9a157fa3c9a4a5d3' }, index.h("div", { key: 'b889ef0fc47bb2733e7d97a7525ba7b4f5f4703c', class: `m-0 p-0 mb-1` }, index.h("div", { key: 'bf684bc298a384c7abdde3e85aaff3662b1b9d97', class: "text-left p-0" }, index.h("ir-date-view", { key: '859f0b0fdcdee5e0b85158b7b2e4a7820df15b8c', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), index.h("div", { key: '641128318a5017c2588709d394acc75a1b2eeb23', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { key: 'd9312e193afba76eb9499e6163632b7fe7005f3a', class: "mb-1 " }, index.h("label", { key: '2b821a15d57a344babf7f40982e641054f737a83', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales_store.locales.entries.Lcz_Reason, ":"), index.h("div", { key: 'c4b1b11bc73e2f5876ba511077741669a67bdc6d', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { key: '375612dc8889a2631fa7717817d31d2d3f8cae40', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { key: 'ebfe98fbd213541a20eee4592883d617d71f05ed', class: "align-middle out-of-service-label" }, locales_store.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, locales_store.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: locales_store.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, locales_store.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, locales_store.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c87253fdf3966e0515c96c224c08cef0497eb4ea' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), index.h("div", { key: '4d52db9509a6f3964682a3c9699525f0fce459d2', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, index.h("fieldset", { key: '3e1214e46b24cf99485e065f9a6cfcd56e28fd61', class: "mt-lg-0 mr-1 " }, index.h("igl-date-range", { key: 'b58927c5ccfbbdbc142c4ed8757004bf325359b5', "data-testid": "date_picker", variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, minDate: this.isEventType('PLUS_BOOKING') ? moment.hooks().add(-1, 'months').startOf('month').format('YYYY-MM-DD') : this.minDate, disabled: this.isEventType('BAR_BOOKING') || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: '0fa8206fc5e192d8562881ab0bf483d7aa807005', class: "text-right mt-1 message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: 'c1424c9a2ab4461b0190a6970f6e6f70d9cae311', class: "d-flex flex-column h-100" }, index.h("div", { key: '96342b89093269fea66e8032735bce65d6fca5cf', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: '9e931fc1009ba67da643068651a1266c84b4e5e3', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: '09dafb1d505171575fd21571dfd82e447c1264f0', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '6c5a93a44e0e7489132296c414a43a8f4f5c3544', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '72462607df256e6fa92f7e917ef5f6401bcb0171' }, index.h("div", { key: '21e00d05bb2d91ab28262faaa3c054f01dcb8823', class: "text-left mt-3" }, index.h("div", { key: '6e6655120702fc7598d295cffe7a00a70fe5e273', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: 'ad2ca9d2e7589314187a8a81e61766ba6bc69e1c', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: '7e3bab8c8384bdd8f7a7f168c7587151f9f882b6', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: '6c142b36076770f4d1f3f1a9ed00bcd98617867a', testId: 'main_guest_email', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: '374a77f84a599d0d6c65fb886b69d2a87ffa375f', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: '6680ca4d7ef279c3c67927ab84602b49a49b1a81', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: 'e7d4202a819c980f4e1626a5d308674b80a8e738', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: '22caac69eb21e93234b186cede235621a9025a29', class: "p-0 flex-fill " }, index.h("div", { key: 'b8e8826b51888eac4d4396c414e8cd9763718ad4', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: '9f06b59e2bf71020e31a0adac429527532358de9', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: 'e8918330568dcef1e2d43d0a545c31e34df516ab', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: 'bdc9651044b9fa4793e2b18cb13e5b18f05a6275', "data-testid": "main_guest_first_name", class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => {
                this.updateGuest({ first_name: event.target.value });
                this.handleDataChange('firstName', event);
            }, required: true }))), index.h("div", { key: '45f67bec2d364bffc00d8e435c478f57562360b6', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'e90deb70b52a95bfce911971fa69f5b7fb89df6c', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '4bff826ad024552106d4823cd01a0bf015279755', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'dd587a1a3edcce6f6a210de6cd79e8b28cab8a82', "data-testid": "main_guest_last_name", class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: '0ddd79637f9e3dbb3735111613dc45c43822334c', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '2b5f1efdc660c68603fcb090d74a3f48cbbe7055', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("ir-country-picker", { key: 'bfd634a55db367ec1e449fc6bb8e20c22fefb921', testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) })), index.h("div", { key: '1e7c6412764901388089a0dca34c08af61ca54a3', class: "form-group p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '9a32df03f96621f8517f05cb06d8d9cccc497e62', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: '708bb395ef1fac907ebd8fb08a469416489e28d2', class: "p-0 m-0 controlContainer flex-fill" }, index.h("ir-phone-input", { key: '29532b7ff1c513ca09b83eabb6b94bf149040534', testId: "main_guest_phone", language: this.language,
            ...
            } }))), index.h("div", { key: '2af97e8cef0a7c2c8e51f82daff5163c03144247', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '5a3ee6d4bc60cc391a764ded876bdd366b796c08', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: 'c3fdf6e2005a47595729473c21d1a76f92ff64d5', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '54a5879d86a2a195652fdb700fdd3aa8d3e1083f', "data-testid": "arrival_time", class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: '1637f194f7d877621f5f18041d8345ef55757921', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: '7ae2b0e4f8add3f0cc07a99040a36ef12701f483', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '0b6dfe98f180fde5ba6de43c7297e23b12bb5578', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: 'ce5bc2e58fbd330129507dcff163c50ad80f0c9a', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: '9c697c9ef7cf993f73736dd9ed34efa42c96df43', "data-testid": "note", id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, { key: '8c6fccacde7a476cd088f882d8426027a30c79f4' }, index.h("div", { key: 'b06999315eaa47ba2efb52c7331c0be09cfcc97a', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '1b0846664ff951d29550ba638f72cc0621efc2e3', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: '4f269c178da6fc9f8d89ffdc0761c6bb2e59d99d', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '1817bc0f139b68a7d4dd5adfe143d123432673a1', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: '74c6779df83335a6c3c77b73ea365fd0f7455847', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '5d7ce5b66f2fde888700f90f5ea1cfb7f965dde9', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: '9cacbe89c54ee41c69bea4f438aa7184754f71d9', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '864740860832985cc7032931d932ea938b2ac9a5', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: '1f53b12ef4d032cf914821ad9ec09db9240af60c', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '49f380a4a46713b6c4a83bda51e113c230fe713e', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: '32fe9d1b3845e5b424832806d570d2f9ad4d0fd1', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: '0d75b6ca4f18d466a93970075cec142ae91b992a', class: "p-0 m-0" }, index.h("select", { key: '1efdb2fe7e76710db630734d7061d391b2551fef', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: 'addc2a381b75c1c68a0aad3306df315ef617e0cc', class: "p-0 m-0 ml-1" }, index.h("select", { key: 'cf1f12a55a1e31aa81d4f352c168df4e1d424151', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: 'efc886393e95c7fde374dddc56b468201a3397b6', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: '8a18e4f409541002e3b54e965c043ed73166c0c7', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: 'b7b685c22beb1e78c4ec2203bf508316cb46e627', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: 'c6e4f92fcd2ca8fe9e19d7eac3e508c762a9ccf2', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4a38bfe8ff3647405325f8f610f70d3c871ad93a' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && index.h("div", { key: '7346c07f5f6db619489ea01a7e223c3b6666d0dc', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '588014094c2501e1967d7abd705768ffe968fb83' }, index.h("div", { key: '25036a5b9e1f69d8a8462f005c9f1a6461376f1b', class: 'd-flex align-items-center ' }, index.h("label", { key: 'dd8fc9c167efc21512c7ca077dd009f796ea12a0', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'c20f51e3d5636cb27c31c72310fa2604043d33d5', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'c205968421a5137a4b2e72d6170d737d64a51288', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'f574623231d8f668ab39528e89ae9923c82559a3', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '4a58bdaccdb51014ae4cd0da01537abb640cf05e', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'c57af81cfa59a2bc00ab97c7daeb8a0e99f58127', class: 'sr-only' }, "clear input"), index.h("svg", { key: '5dad84117e584247f19427158d11dd6e8ab0f4ad', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'e1a6acf30202838f25abbf084bb08520f92bf61f', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("form", { key: '09f8817976d550e9f62b3ee586c70874af2208ec', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-title", { key: '9fc820f52196a86546a69f5638be43fbe6fb7d62', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("div", { key: '4fa014dea94508316869d2b1a631fec5d50e6f82', class: "sheet-body px-1" }, index.h("ir-textarea", { key: '8911c79cad5882c53f9c01d172be0d2467dae8c8', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), index.h("div", { key: 'fa50862601b53821429e028124eb06dac7ec000a', class: 'sheet-footer' }, index.h("ir-button", { key: 'fe00d1ce05cd669c2fa1a01267020809ff07ca2f', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '5faae0d569334d8a879f23da30c908b72085b1e9', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (index.h("div", { key: '7eff4b88f9bae75eb900d999d0bd22148a2a7e90', class: "fluid-container px-1" }, index.h("div", { key: '83744dca78e639d0bf9d3373c1588f57676ac0e9', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '249812d0602306b67897cdf379a61491e83ce565', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'a60927048afafcf55cd92f25aaaf2997ef5a3559', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: 'c9f2405ce200573ab8e9d14492f945e6cebe85f9', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'b6060fa7427c21c5385ae8097103ff67be809e5a', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '82cfbedefb7d124bd287fa463bf75962896c4742', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: '35603986cf2d0faff8f4a9be4b281bc5beb24c3c', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'cc7d917711ff69140e104f5c010ed93203e79a79', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: 'e4ae6c5e907b01493adc6cb191c71b48c7544f3f', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: 'e56e0736cd412ef5e91e9f67d3042f4e5d11d9b4', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '4b31ea50c7775f500ec9a5bf77b4b483b212ad7b', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '6098a9821488c5171aea1d4c85916ab56015d9dd', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '86dcae430aa7d43aca15dcea47d99b834c6b2707', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '87a1d0dc468e0df251d07687c4bffb2ff1b85c9d', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '3ba4d8b8041a7f06fda292b65fe3f751cfb66490', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: 'cc5544067e797bb1ca862d4b46b8113fb3b46f99', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '1a3b689579a2978589f3bf115e59153db1eaae23', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: 'ef6ca36d9fd2dbb686b9b5ec4f7c327834bf6479', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '366d8f05f0a2a6744ad0d27c3e3fdc9b6383e5da', onOpenChange: e => {
                if (!e.detail) {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '3f21c94cb300fd05c681871220be3013b01421af', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'd412dd0b47d2f20c7fc46a9186b70c2348883b5a', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: '1060b46c451591f54a925fd8b97b0f0cda5b5f96', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '0ccc5fd9b80c4eeffa7986e95fe697cc5707c1d3' }, index.h("button", { key: '301121e2e529d360ff2b328d716b01e0b2832a26', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '80d7a9e0ba48a7a017689506635fe9b0a7f7de48', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '4e02a7d20448c2a7b4532e2f1f045ff8389e6ad3', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '7933950f4e48bdf6095ff07fd617ea2e91468f5a', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '79778e2d398b318590bdb6ed26d061e8315849a9', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '3526939dec095c2d422552f6a747b76c0ff5d10c', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: '1706a46344b9b566a3ecc9c63ff8a443dba4aac0', name: "trigger" }), index.h("input", { key: '5b56b5501bb632365c66d7623e552e18bca785bd', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '689e4ade98392b20ba5b7eac8b0b54b5af150d82' }, index.h("input", { key: '8adab777a1f15345c5a42e63f000d9c2ec3f5c9b', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9da1175261155caaa9d7972817e804153902cb30', class: "d-flex align-items-center" }, index.h("span", { key: '6606e181cbb532b3e796d5af74ec3dca7078b276' }, this.dates.from_date), ' ', index.h("svg", { key: '7bc5921e45b84060f9510fccdb726fe251769ef2', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'b1ff6bd0dc11309794edac0ca4afbb62537abab5', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '0449ac04005f0f12b216d5e2a013a9d497ab6a8b' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '007f3e4797d8ebb28ff78d4a5a70ea8e3ca9d86e', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c9ccee840d524824e4ee53d23253565d62f4c72a' }, index.h("div", { key: 'd3adcb896518de734727c3b06f275959e72fec3b', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'f07645a7c7af5d1186c8bf778fd1776bae2fe664', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '9ea50dc12bf36ff9c72bc72c08dba206a6a026b7', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'd86c9ba48796401265631dabb9c1d1d4173e5c44', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '0abc5bad2bc37cff704fb64c756bd151f3da08a0', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '3aadc4cc1b59329c94a071436f58e7e289661763', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '318e889dc5f6159bac2e3038a165d2dd1f87ee63', name: "modal-title" })), index.h("div", { key: 'f22de12e05b34587508624ded4944227e2e37e10', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '5b16be7499801c5147a22c391fb7619ba9a7b86f', name: "modal-body" })), index.h("div", { key: '4ac6a8e7431bf280f6c15aedcda1cdd1edf0678a', class: "modal-footer" }, index.h("slot", { key: '2922ea19d98f00cd5b0945d2b937ae23715048bd', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '18013284c0e1a82849bd730d13cce17e80df2f66' }, index.h("div", { key: '8d42f391a314db459c582932962e7671779b5bcb', class: "p-1" }, index.h("div", { key: '80d4ec648f5c7fc5838afb2c27bf6130e68d7e0d', class: 'extra-service-container' }, index.h("p", { key: 'ffe2eb0f5992e06d526148f6b98d26513fdc756f', class: "extra-service-description" }, this.service.description), index.h("div", { key: '2c1618f0de2da7420d14e2e99d01c1a9f198b88f', class: "extra-service-actions" }, this.service.price && index.h("p", { key: '90009fe9600ef1f69ad89f2eaa7e4bcfeb7a2f8f', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price)), index.h("ir-button", { key: '0906f86600b8312c4569f6683170d191b8e8b160', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: '82b8575f97cf19d258a3cdcad2e9bcdfc5998d79', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: icons.colorVariants.danger }))), index.h("div", { key: '12b2657084ede7772cc315f707b39d6c250adf12', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: '7ccb03fb629f72eef23f54c2330c6aa9ff7e77df', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '3763e1ef885be23aa2472ddb6df1c246f0a1b0bd', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '44f924c210abe792121d34e5136e2bd1977b0ef0', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '7e25e84a8ca1201397c509cb510ad546e1a957a6', class: 'px-1 sheet-body' }, index.h("fieldset", { key: 'f12bf0e20055d12eb677c9fbf08789b45ac8882a', class: "input-group mb-1 service-description" }, index.h("div", { key: 'f0e0a370d940553a76324a4ec106a9e374efedad', class: "input-group-prepend" }, index.h("span", { key: '4291200e5fe91e1f4eb2d49e4040a8843aac0f58', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '5f166c21f44d8cd9338cec7b48fc118d7560a8fc', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: 'c3ef99ab00bf27dd14ab94b3bd971c6f53ebc10f', class: 'row-group mb-1' }, index.h("div", { key: '1ea30aa569ae56c7350adbc8f4e20fca693f6b0e', class: "input-group" }, index.h("div", { key: 'f01491fd80eadb664bc68e4af5d09ece2b6b0b0d', class: "input-group-prepend" }, index.h("span", { key: 'd935aa93ba14a10a550d19b63251689137ef55a8', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '76f22704a2e42401055f5420e5b8e6646c22c6f2',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '2d6bb684766ffca92892f61d1f1c23b60096968e', class: "service-date-container" }, index.h("ir-date-picker", { key: '5b33b802a745d4ee2f48d0420628cf94eedc9180',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: '6b4b6b5b2d4db8e68f6ade8fca899daf49ffa07b',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: 'be1446ca0182aa46f613fbc8e1285bb46a281b24', class: "btn-container" }, index.h("ir-button", { key: 'ba0d9372798288bc625d602506cc5c823015b34d', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '107e8f3eab4debe5435cbde8a0ee7d26fb828d91', class: "input-group" }, index.h("div", { key: '9c8c88986e42dbeb90826748fcd953531b31575b', class: "input-group-prepend " }, index.h("span", { key: '18a27ac268ea41069c41e83e2142ee6dad92cf9c', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: '79b0f89bfa4ed7b8c3d0333d8479f9c7cc33a50d',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: 'd96fa1bdd9b3cabe3781e63e09a97122622daf5b', class: "service-date-container" }, index.h("ir-date-picker", { key: 'c3b94121e96cfcbc5d0dcfdd129c77b733b35ba6',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: 'f4a4b43435163a0475aa1fce95bbe85c631bd45d',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: 'aacb1696ed62dcbd201479e86836b163ad05596c', class: "btn-container" }, index.h("ir-button", { key: '4571a33987f1713df9f3b230d7bb9f99b24832b5', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '6c7919513074c264eb0f08242cf44bb373e36eaf', class: 'row-group' }, index.h("ir-price-input", { key: 'd7c8bfb78596bdd50e722dd6c20b4232b141ab7d', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '3570733a776e20f10218050167430f55daf9b862', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: 'b3e11de5a1a9ee30744094a6aa4d3cbdbc45aa36', class: 'sheet-footer' }, index.h("ir-button", { key: 'afdcbdf9326046b545af105baca21d03c7449d0e', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '07d9e479bc55e8d3d82dc7ba57315ab560c0a677', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', icon: "", btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '7edb26aaaee65d08fa99ac9b98335e0ac998962e', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '5dab1c14f1935140c98bb8c2c0bb502dec5779e9' }, index.h("div", { key: '9ff2a8a7b1e0a54f6d9b1e7d153dc9425342d783', class: "form-group mr-0" }, index.h("div", { key: 'a6331856a03bc4998445fe8810c78f086a461413', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: 'bb4a31e5869e7fdd5eaf2e93d415a0cb227d19b2', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'e475a3cbe553ef0cac1c66b94067b566018c95b4', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '3d8ce0e62718ed8872431035ba2c6435437aaa8c', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '4b4a2e869db02823401b0634a4edcdd5acacc252', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '9063ab53c3140f880069b4cc177a40d1e8b10629', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'ee6cf5fcffd0dcd2bbb5a7081ab28a59ec73b285', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '7fa45f400112bdc086c777ac98fea3ced2286e51', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '48b4e092c10e72773f42b2b12967dac5f36a7987', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: '09fec252caa1b89bc44095f5b74397b3d8c09842', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '0a5a2a14b837195f2762ac4a9dc77223f8e58daa', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '97697449292499ca32ba24c0f2c83bf3ae66cce5', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '1e880bd27196104af95bf9b2d6a542e243b9dedd', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: 'dbd22a17041a41319576260b44dc58158abad505', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '774086d24bd9e77911a08de93fb364715cb10936', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: 'd9bc72bae7d67679d5ad7c4ad77f6eb8f065bcd7', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: 'c8c846ca2e50988937aaf89a4677d5ccf0cb1b83', class: 'd-flex' }, index.h("div", { key: 'c08ae334e0125339b25b3acf502bcd7a698b25e1', class: "form-group  mr-1" }, index.h("div", { key: 'c5807712489c2210659afa5c11abaf872cf3b80d', class: "input-group row m-0" }, index.h("div", { key: '1db6eb2443827e38e7ce85061272246a5c75dfe0', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '6ac52fa9ccf82001d6bd36795ef7f8f33285c88e', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'b5f35301db9603d3c218c54f2d083845ed5d5b01', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '5bd983eb3b7dc6bf3eb8afcb9e1d2c42325a049d', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: 'e1a9d34420d22eab6d772535cff2a18f0b7ceaaa', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '04f2da164a115d12c5a0108bc3886b28da89db43', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '94138ec4273dfe65846ba389813d0faf7aed3a43', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '88095fa3cc3283f59ba8e730f32f74bda1aa28ff', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'befeff642a1a16e3d2124097f0e96f0022ee5a51', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '44d6302549c451a1babb743c377f0e5fc384c37a', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '6c1e8b8c2f33f024f982a66b42fc90f696c204db', class: "price-input-container" }, index.h("ir-price-input", { key: 'ad6aed04066bf8488c1afe165f16edede57f6953', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '7a2639a035734a121e641123545f095b8d5e751d', class: 'sheet-footer' }, index.h("ir-button", { key: '447296a25e0d0a7cf282eb0ab3097b3a3bf8e882', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'c011bdcf4fe5707d5254671d60c2e10b11827ad8', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: 'bb726ab3b8cd44f5b68ed053660af619cd5d1dc2', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: '8eeb2e1d0c08d422e8126fe993639defae8d85ff', class: "input-group-prepend" }, index.h("span", { key: 'ae3e2aefe52adab1534ba417d22af7464c4fd958', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '41459a37211b2cb2bfc1c72e79caef9275111012', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '4cb38fb0f19af2c4ac4724853b25006d16f0d6f4', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'aeb0875622599375283a1cffad0fb29aa22b0f65', class: `input-group-prepend` }, index.h("span", { key: '21d7006d663620acae00063889525b9e17aba4a0', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'f994db18a28b3db2b2f902fb322cc1b08c510b16', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '079eba95b28d53170822518e6053ac9019f10282', class: "card" }, index.h("div", { key: 'e9f780d7c024e4edbe2ed39f2acecc4372e37f9d', class: "p-1" }, index.h("p", { key: '21c0bfa63104323fdb91cbeae9bd22cb6af7a8fb' }, this.booking.property.name || ''), index.h("ir-label", { key: '2a6ea5750d6cfaccd17ec8abd88d7e356a81a5e9', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '5e04a29f8286a8f55f63cf30239b8f1bfc1fefe4', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '43d5aa4fbb2cf63d8c29a4ddba686e27edd8fe59', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '5cc26eb071b8e788cff63406cf904ba9d5b984a6', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '6ab265409676d96ce6fc2367db29b6fdbe3d94cb', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'eb780756dbcea9740dce529065922b9f52a95d62', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '20c6961172408e923be0cf3f70dae08e3adfa0af', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '24306c27eb05c4acfe345b0667fa97a2958f4846', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: 'de2999f58a810186b55157b91de3f10e9e107f17', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '2efb282ce009a23ae4423a78a6c17763e1c7f6f9', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'c85f8d108a70e5bb5d4f33f6f4bfc0f40be65833', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'ebcc29ea35d433ec014720d461788862b5fe2466', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '5924727321f9521ec9264d8ca1fca0f8b1838673', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'c9834ee95f8886c7d00da3ce66a581183f718f33', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'b4fc6e0a6736d9c3663c27371d623a74ece64ab2', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '40dcbf00e9e638698e6d3313c06e4921b196009e', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'fa5f6ab555f1fe841a59bff98766c1a2a590ecbb', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '371ff440ff069053aacda821288a0def0b651707', class: "d-flex align-items-center" }, index.h("svg", { key: '940ff187710304b4eafe04203c1e4654c79e3554', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'ed5e4eaf8fec1f1d1a34906e8592866109eef1a2', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '6b3b6d5fe54ce30359945caead5e380bdf6dae9c', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'a30f497c788ca13c2ee70715fc8e2deebef81e7c', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: 'd0ba1558f6467725c2b56b51a0b7ecb7f292a313', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: 'c8ee510947abd03f34eea444e65c49aef572a8e0', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
IrReservationInformation.style = IrReservationInformationStyle0;

const irRoomCss = ".light-blue-bg.sc-ir-room{background:#acecff;padding:0.1rem 0.3rem;border-radius:5px;display:block;max-width:100px;box-sizing:border-box;display:inline-block;overflow:hidden;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;cursor:default}.room_statements.sc-ir-room{display:block;width:100%}.room_statements.sc-ir-room{display:block;width:100%}.room_statements.sc-ir-room span.sc-ir-room{display:inline;white-space:normal;line-height:1.5;word-break:break-word}.room_statements.sc-ir-room b.sc-ir-room{display:inline;margin-right:5px}.payment-container.sc-ir-room{position:absolute;right:1rem;height:fit-content}.sc-ir-room-h{position:relative}.sm-mr.sc-ir-room{margin-right:3px}.subtotal_row.sc-ir-room{padding-top:8px;font-weight:600}.room_actions_btns.sc-ir-room{gap:0.5rem}.night-cost.sc-ir-room{color:#7cbebe}.room-name.sc-ir-room{max-width:60%}.room_actions_btns.sc-ir-room{flex:1 1 0%;display:flex;justify-content:flex-end}.mx-0-5.sc-ir-room{margin-left:2px !important;margin-right:2px !important}.tax-width.sc-ir-room{font-size:10px}.sm-mb-1.sc-ir-room{margin-bottom:5px !important}.sm-mt-1.sc-ir-room{margin-top:5px !important}.mx-01.sc-ir-room{--m:5px;margin-right:var(--m) !important;margin-left:var(--m) !important}";
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9d6df5e3769f179ec0ff072a3b271203a76aff1d', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '4b2acdc03dd07058db065e373553f1e490e64792', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'ec0262d2b9bb5adedb3a00c168c5e74ffb5810dd', class: "flex-fill m-0 " }, index.h("div", { key: 'c4285955b9743f6518083a10095e9187c0ed0b71', class: "d-flex align-items-start justify-content-between sm-mb-1 flex-fill" }, index.h("p", { key: 'd86c5132c1539e0f6ec575ec3766ec1125b024bc', class: "m-0 p-0  room-name" }, index.h("span", { key: '24bb8dab41fce1f43c05b4bc64d909120761b457', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', index.h("span", { key: 'a9f22a3a6873bdc1465cc1ab1af2e07027e7363d' }, this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' ')), index.h("div", { key: 'd25ae109824c4de42a8e754d8b3c5226db7eb1bc', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'd9b62647f4785207700d67a06ff20eedabc60b20', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'e5e58bca5a5a873c35546c32538dc0e0330ef430', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '686831de255159a2625fdab5bc2c23062365c94f', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'bac54c78626a7057e1437eb20ba39ab682692094', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '66a4dc8851a0e2e9862abbe7ce4336ad40e37e5c', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '0315da75f4e29eaad3bbe8d274df2770dd4011a5', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: 'e414b138a292fdc7b2c1d8a0d6d992879827ad18', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'cb7fd285051477dfa5839c01c3230bb2639b5b42', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: 'b3fcd7c506e2fc5a9036b9e370c971edcbfdc999', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '4572b7bf01de61039aa7cc2e2fb6b199070896e8', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: 'f97a72ee746ebefc6de6c106481197461c2ed034', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '176b394de514adfc05e61e77d7e1ade17e50a7f3', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), bed && index.h("p", { key: 'bff26404637923b18713e4664fd84165ab0cd788', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: 'b02d679d45ffde1b1478f0811715d3faededf851', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '8850badbb67800cf1064b37de151493e349a174e', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '9066bd300c3e8fbfbb394a5b41773c6646f3b4cc', class: " sm-padding-top" }, index.h("p", { key: 'c8d5aa783ebb9e78f3c467cbb34d7b109157bd3b', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '865e17b2c33e6a68b36c9ef4dbbe5ad99c5a3deb', class: 'flex-fill' }, index.h("table", { key: '896fe64b8c820c629ac96ac97ef02660d2495c95' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'b9e24dbc236cbc1882c0a200264b461b59116224', class: '' }, index.h("th", { key: 'a3d4aef1dc39971affdede382cad86776077d609', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'dc5c3978666715f39fab16ffc908407c640159df', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: '7960cfd20d71e20ae6a0641ae4f0c77721aa312d', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: 'b3908df2cc58327435dba012e00e53b992bade64', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'ff55c77a5b4823c38677a4c5f7733fe2a280fa54' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '2d8861a3e19703886b384b2c50a2a39b475ca442', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'b5e0a248e1ca3063631bc4597d226b1749ceb9b3', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '5ac3833c2664175ccc9ed5da0f5f576e11e05c15' }, index.h("ir-label", { key: '7a33b84886db401c97598ab635681901f50cfe27', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'e8ceb2e7af8c4d543481da03d82043862558d55e', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '76f631a1b64462d5d41a5b43e494be9c3fa90803', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '4026784b96c64b06fe9d0a3e8debb678182f35c4' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '25c8e83203bda93b79e5ea56cb2c2e26b8ce3567', class: "m-0 p-0" }, index.h("span", { key: '703367806922c0a02547978cc6af88493c468db3', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: 'aae651819101cc35c044c1f478739a9e43ae527d', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '1fd4424664febe298860d93d6e332fff9b69996a', class: "tooltip-arrow" }), index.h("div", { key: '9db15891bfbddf76133299ef5b6b15928dbc68fa', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: 'a3237d40f45265091d2c311371aa1474332790c8', innerHTML: this.message }))))));
    }
};
...
//# sourceMappingURL=igl-application-info_52.cjs.entry.js.map