...
const IrPickup = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '587f95c68ffee347b6ae1385f05ef21fe93b7b42', class: 'p-0' }, index.h("ir-title", { key: 'c65a333db6dac68bf01d342f27d29aadbe762993', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: 'ec306fc10ed53b72d4beefbb0f0d32aee4ba813f', class: 'px-1' }, index.h("ir-select", { key: '098d56bd56a3e482170000df83bd66380fac647e', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: 'cd5663bdd9a1ffbca82bbf830c4c3727e09e0107', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '0be91d6c588dabbff79d5aac468cad6e141e7664', class: 'd-flex' }, index.h("div", { key: '55a35599dd5c7690bba079a3f0382b79a28ec603', class: "form-group  mr-1" }, index.h("div", { key: 'a186091b1c9f6c0ac3198c078f84b838ec209d97', class: "input-group row m-0" }, index.h("div", { key: 'd1b64fbb3d0ab5c444e80eb55310743b33fc070d', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'bd21e905c4f8b5504a69bff30a24a998bfc7a2ff', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'f45d7aa34355a2a1d4a389b5d8dc6781e277e11b', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: 'e7d7be78e41a50a2bd445fd423dbac1bb83d403e', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": this.cause === 'arrival_date' && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: 'd68c6948a062393408087f8286e123bc62ba8d72', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${this.cause === 'arrival_date' && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '560f784fc1ea38297c2e1c1615dc0068f201d144', autoValidate: this.autoValidate,
