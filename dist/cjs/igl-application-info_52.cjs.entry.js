...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ea6d6c5c97e7cc0b8cb12047edb0b23b8b94d31', class: 'px-0' }, index.h("ir-title", { key: '57df9587bee35bee1fee048e13bba6500a16655f', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("form", { key: '922a63f7ef7577f1a7d23ee5c7db8aed6b0f0c3f', class: 'px-1', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-textarea", { key: 'cfa327cba6c099d502d77a5c109c5e438f937c25', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) }), index.h("div", { key: '484cb8aeeeca21a2aeda751f869d63bbb1a83ac0', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '2df0226fc17a3d7659f43d5c13eb1b557be9dca7', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '074be9aa5da9de68b01c7a18e17d74da130c2d6a', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
        return (index.h(index.Host, { key: '32518e7e44e463b5f10ecbf6640941b801391f32', class: 'p-0' }, index.h("ir-title", { key: 'bda39b92c50a23a19e81345460a6be5c7a05e781', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '79967aaa10f86bedc154c82f27a26e4529833370', class: 'px-1' }, index.h("fieldset", { key: 'ca2ec14d4451d77f078f407a8003d060d53a8367', class: "input-group mb-1 mt-3 service-description" }, index.h("div", { key: '17d5dae12157d74b824e010dd97aa291574f8883', class: "input-group-prepend" }, index.h("span", { key: 'ab148456a69d247900f41d5b3679efe22306fed1', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '6bd0ce8d55ccf9e0cb9ba3be0636250baebd2d81', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: 'f916d44ecbdb6ed558a2d90df6daffd1c0cbf63a', class: 'row-group mb-1' }, index.h("div", { key: 'a2057ce59ed0654928a35c3879d4669816947ffe', class: "input-group" }, index.h("div", { key: '516c0c09c6348e89b0782f59a928438a3192a55f', class: "input-group-prepend" }, index.h("span", { key: '89f4a579c11e00c7e854e74a23c47d732cf139e4', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '08045e3323ed7f7de1db71b3a9fc4a21cd012c56', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: 'e047f9cd54090645cf44d13391905a90438b7734', class: "service-date-container" }, index.h("ir-date-picker", { key: 'aff82ae280cf21e53861a85aff0db7946b059f47', date: ((_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date) ? new Date((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) : new Date(this.booking.from_date), class: `hidden-date-picker ${!((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) ? 'hidden-dates' : ''}`, autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start.format('YYYY-MM-DD') }) }), ((_f = this.s_service) === null || _f === void 0 ? void 0 : _f.start_date) && (index.h("div", { key: '76abb5e3ee6d0a665794dd7e82acc5ce2561e076', class: "btn-container" }, index.h("ir-button", { key: 'f2b5fb14d59a8440fc4d63d9ed144de7276038fa', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '89fbdfab8d6ba1cd1755cf801e070c2d7a67c26d', class: "input-group" }, index.h("div", { key: 'fe87b714fa7057db925a840cace98f39b9ba1546', class: "input-group-prepend " }, index.h("span", { key: '8acdb86550e35c0ae77ab9b1a2719178036856d4', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'cf6fb2a7d7414d5009e2dd4238d2e5b1d95c0a0d', class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '444bad5cffa5adb9def1e14fbf0caed23fae72fe', class: "service-date-container" }, index.h("ir-date-picker", { key: '7c1eb139b0d3f8fd3650959a404dd0627ba68c46', date: ((_g = this.s_service) === null || _g === void 0 ? void 0 : _g.end_date) ? new Date((_h = this.s_service) === null || _h === void 0 ? void 0 : _h.end_date) : new Date(this.booking.to_date), class: `hidden-date-picker ${!((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? 'hidden-dates' : ''}`, autoApply: true, singleDatePicker: true, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start.format('YYYY-MM-DD') });
            } }), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: 'c693c8b495550fa1022441b98ba67f982fd3f5ae', class: "btn-container" }, index.h("ir-button", { key: '6217561defdea1dc58fc225f5b9f847c9978285d', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '8d37ddf87530b3f2cf02143cabecd3083336374e', class: 'row-group' }, index.h("ir-price-input", { key: '9343b4772787fc92017fbd076a3ce61a25eae40b', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: 'c35b4a1e3d84089e1f6a0c373a59304e3275871a', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "cost-label", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" })), index.h("div", { key: '6b931b8422908c7a4aa3bdc1cd6368216633bf3c', class: 'd-flex flex-column flex-sm-row mt-3' }, index.h("ir-button", { key: '223938171638a40c5bca4663c473891ea881ae26', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill mr-sm-1`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'a15e44b2f131dc7c79f1d8f51b4b8e8fc777c15c', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", onClick: this.saveAmenity.bind(this) })))));
    }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5cd3d5bda30b1851f00c9d4465edabdad71d0d5a', class: "card" }, index.h("div", { key: 'f3f4a8b78141990bc5a3af9c448b9914ba23f3aa', class: "p-1" }, index.h("p", { key: '921c1ec4065b2d1bd61e5feb04a792bbe291f274' }, this.booking.property.name || ''), index.h("ir-label", { key: '435dc59d00cb1fb5dea821e8d8add212c5e58a49', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'ac333dffd3e42cea788b39f65bc11f34d6a25fcb', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '6c6c3dd5be452a2f170e4f44b4df18d0ca9e1191', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 0 && (index.h("div", { key: '449f862c9e6ab2820a28d0e5ba24db9c2545f251', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'c1fb5460a67e60aa4249a9701ad658d06f2b1c97', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'a52984b02beffd70884c79c5da7f9d8d2e91023e', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: 'a2fce42d33d302307bf1ec23417f433dfd0eda0f', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'c500fa3d855ff04655357a3aae9f0b394326df26', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '768a78fd98fba53561c4a96196fa9c8ae2ac2cca', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '0501440268c5c1a79468ef3acaf013666380ad4d', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), index.h("ir-label", { key: '6d02b5f92f0d84db08477463d4293f464c191edb', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'e4950815daa7227ddfc0ccc625156ef9b59450ae', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '62bdd13cda185bf910e2af3a8a22cdbe42163765', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '14717b7a8929bed307847d6b445602544d3fc889', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '8d462fe050e0c65db47e2bdffd263766fae17c21', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '3a673063cd1d06a7eca4811685e3efbca75160e0', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '6bb65462a478988351254d907709284a480876b8', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'd71d395f0be86fe950c4e96c0e9a3376ed55e15c', class: "d-flex align-items-center" }, index.h("svg", { key: '400f30c9c3b3a16a7bdefb6eb5e004cd355b53b2', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'b454686751132bd09527c74e2c08a995dcfd42cc', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'b10e69b372dfc87e2f47b12f410f85f9c1416407', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_Note}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_Note}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '9c2f92ab107e41404a79a954c2b8bbae18e0e94b', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: 'c22177f0f24feff7b2a4a23115e29a36ed53febb', labelText: `${locales_store.locales.entries.Lcz_PrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '972d66f08118f7e499c8396177f7e6d79f2813e7', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
const IrRoom = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '00c21cd7648067403d139db95a16550394febcab', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '0fbf3ced05ce6ce0bc4529a712c8ca2bfe707d0a', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'e68864e506f778bc781396baa5b852131c9c71bf', class: "flex-fill m-0 " }, index.h("div", { key: '8cd9a54d16e8f06f9f869cf585aa254eda0cc37d', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '00dbb69397a38f4c1fc46dfc212441edfac900ad', class: "m-0 p-0" }, index.h("span", { key: '45a89cc3bfda1cd78eba242771390c4ea301cf89', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.item.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'fa3ec252f1dd8485d7b81a40bd15958766db22db', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '417b12d4aa433a13ace2f07547b6b748e1b96b34', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'eb7afba89d7b3fef5e18a596f5dd9e3f81a9afed', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '834a054fca74aa23a5c27d95fdaa28acaf2c8717', variant: "icon", onClickHandler: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '4c59224047620ab2dc82bb42ec194e3383d4e51e', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '41f1f77e1af3137437b25ca94544b4a04f51f9d8', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: 'e53147bfebcbeaa9fc6a68345d675e58a197923a', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: 'cf18ba454a839f9fc1e8c1f4e0e95f6fbb3b37fd', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !calendarData.isSingleUnit(this.item.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("div", { key: 'fb5b55720caf823ebcd398819b71d687bb26ec5d', class: 'd-flex justify-content-end' }, index.h("span", { key: 'f2b337fe70a14eeb4111f4be9d2f7af8e621a5e4', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: '78698db5fc1a61d8fc2e728e7264b9e5f254b23c' }, index.h("span", { key: 'c1f5c0c2628da0ea28658959314db181d3ac4476', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", { key: 'f99a8ea30febb376b5daeaed0ea02fafbfcac445', innerHTML: this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy) }, " ")), index.h("div", { key: '8714932f980b5a7ce1a042bab5b1babe27acbba8', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '6c3ad52d0cbb820b6d4449087fd294590299645b', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'ef5b7a9f4ee3385c0dcc20fc4c34219da3124e3f', class: " sm-padding-top" }, index.h("p", { key: 'ba8c9940b62e5825ab4ba9bf09e0354154eeb203', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'b8c41755d915f183339860b47aab96a34afca4b2', class: 'flex-fill' }, index.h("table", { key: '0bb6b43006361461b3d0d2f594217154bb1fea1f' }, this.item.days.length > 0 &&
            ...
            }), index.h("tr", { key: '3244c264de213bbca1c42addc7ff74341beaed41', class: '' }, index.h("th", { key: '6e5bed02e028d29012d9c2157a551a1e61eb86ab', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '37e265f29184f05eb485034045b605d29e7d0976', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && index.h("th", { key: '77920e70b6ced588a491cd361d36c35ce851cfe2', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), this.item.rateplan.cancelation && (index.h("ir-label", { key: '832593872fa2dedb045290c0eb0dddb0c9bf85c6', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, content: this.item.rateplan.cancelation || '', renderContentAsHtml: true })), this.item.rateplan.guarantee && index.h("ir-label", { key: '37675b4988017f73393221a3e1ab333295d95901', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, content: this.item.rateplan.guarantee || '', renderContentAsHtml: true }), this.bookingEvent.is_direct && index.h("ir-label", { key: '54e2884487df0076294b3c0313a6b2bffa627539', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, content: this.mealCodeName }))), index.h("ir-modal", { key: '63f45cf4eff6fdaf2bed9438023ac9c6c840d38c', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
