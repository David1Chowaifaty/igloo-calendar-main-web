...
const booking_service = require('./booking.service-b4bef20c.js');
...
const booking_service$1 = require('./booking.service-5d479918.js');
...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ce8ac191938c11f60c04b9faff196c45f187e2f', "data-testid": "book_property_sheet" }, index.h("div", { key: '9834c1880767e7014f6424c3bea8f4f9a2e19db7', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: '44e15d04ca8f61156ce9802269a4f66f2f5f2fdd', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: '8766a6f65dd2b78f7b7b9aaf47b27473154cc409', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '0d0bc078544d534867edc09d11430816af4bba08', class: "card-header-container mb-2" }, index.h("h3", { key: 'e6dc60ea8787c106f2761018fdd769b2d19d4c1b', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '3adfce0e3e069735fbd9779b599dc757b8d31656', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: 'f723174667a4d0c8d0c899e37bdaa25d62a27a4b', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '4d03ec2f0c8aebed5062ad88f8a9ff8538498358', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: 'c9bb9606908b72750af3da1cbcca48f66cbea9f0', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: '60e4ab295560d27f417b4f9cd8e648b2a3856aed', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index.h("igl-booking-form", { key: 'c59c18ab8c8843c0b6778bc0cfd338bab32d8723', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countries: this.countries, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
