...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '803ac898efbad5fa02b53474f072f4d5c87ca73e', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '5b003f54250dfcbd1f86cb00b600a53c80331b13', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '79a677e8c98d843802549e310f3595c5f30209c2', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '89d2fa353ed0fe218deb2daa541b5ead4c5fa4cf', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'b93f4ea7e51eb4d59d9e6c50e7ec930110f6f53b', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'e95255d1c1ecae77eefd2005293b981acf945556', class: `ir-alert-header` }, index.h("p", { key: '8dab087e9480aaa3305685785978528c2ec0de03' }, this.modalTitle))), index.h("div", { key: '22f8234dc53d0922fbd0082a556280f85884e1a7', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'ecebd3e6cff78b14fd52afa11a49abde996539c9' }, this.modalBody)), index.h("div", { key: '6ba960497980c578370f75b17b2a708b47876d08', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: '1cc693d845970c99d58a37e2f0c626385a2f701d', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'a4d8bce98f1839bd698800cba65ffea8d310d4d6', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1bd59f7d662ec640b7783df3d0bb0cf3a16f5fa3', class: "otp-input-container" }, index.h("div", { key: '2d93459c029bf6ba6833517532e88ec0cdab1d63', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrResetPassword = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ec6215a4436033cbe801237901ebddf918e7b3c7', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, !insideSidebar && (index.h(index.Fragment, { key: 'a9c3d0489a4bf11a4a1911964fee5209c29c8d05' }, index.h("ir-interceptor", { key: 'cd22a73f54913101ae1aeed0b2e761a77ce7c48e', suppressToastEndpoints: ['/Change_User_Pwd'] }), index.h("ir-toast", { key: 'c59fd31246adee2e9a212aefd94d0b315b354d28' }))), index.h("form", { key: '25b2381cd7ae511b484f7a09b9a66d2d09a82de4', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && index.h("ir-title", { key: 'd6d37ee589e5d3b55a7cd434c5c1f44cb0ebd1f4', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), index.h("div", { key: 'd6372fb4ab5f5353f70227dfb920efc72c355e3c', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, index.h("svg", { key: '0f96d4552a7175ff1f794c91f31700ae8c75591e', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, index.h("path", { key: 'b678e320e2b5fb736eb2d3d75deb695b2fb8fcba', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), index.h("div", { key: '829e1a7c9c4505ba4d8ff34946461cc483e67c7d', class: "text-center mb-2" }, index.h("h4", { key: '1fd07837c19c521dda123301742d651b9d3d123e', class: "mb-1" }, locales_store.locales.entries.Lcz_SetNewPassword), this.submitted ? (index.h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (index.h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (index.h("section", { key: 'ce7428af6a8c604f739120cde4de278307d6bd51' }, index.h("div", { key: 'da8739f47135a2f1037a65c53376337b4208066d', class: 'mb-2' }, index.h("div", { key: 'cd1638dca851e544647ff48f07c4193cf6b4191b', class: "m-0 p-0" }, index.h("div", { key: '1076862610be25d946a949f808bbcbdd16bc67ce', class: 'position-relative' }, index.h("ir-input-text", { key: '919cd890814ae4a0cabcf0fd8bf3dc804634b242', error: (_a = this.error) === null || _a === void 0 ? void 0 : _a.password, autoValidate: this.autoValidate, value: this.password, onTextChange: e => (this.password = e.detail), label: "", class: "m-0 p-0", inputStyles: 'm-0', zod: this.ResetPasswordSchema.pick({ password: true }), wrapKey: "password", placeholder: locales_store.locales.entries.Lcz_NewPassword, onInputFocus: () => (this.showValidator = true), type: 'password' })), this.showValidator && index.h("ir-password-validator", { key: '807f983bd2da1e433c39f5792a49de0841b51d7d', class: "mb-1", password: this.password })), index.h("div", { key: '2c91b4a476e3d565bd743a98ed26928cb3db2f1a', class: 'position-relative' }, index.h("ir-input-text", { key: 'baacdfd15b517389fea4f95cf5dd84a7fec3a75c', error: (_b = this.error) === null || _b === void 0 ? void 0 : _b.confirm_password, autoValidate: this.autoValidate, zod: this.ResetPasswordSchema.pick({ confirm_password: true }), wrapKey: "confirm_password", value: this.confirmPassword, onTextChange: e => (this.confirmPassword = e.detail), label: "", placeholder: locales_store.locales.entries.Lcz_ConfirmPassword, type: 'password' }))), !insideSidebar && (index.h("div", { key: 'f3f258f434b836b68dbb6ddb66deb64af5803516', class: "d-flex flex-column mt-2 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, index.h("ir-button", { key: '81e609867f1ea185eec9505b79b92182f9ef0e02', btn_styles: 'flex-fill', onClickHandler: () => window.history.back(), class: "flex-fill", text: locales_store.locales.entries.Lcz_Cancel, size: "md", btn_color: "secondary" }), index.h("ir-button", { key: '2ec1e0cd015d1bd40850178ceb726e96c1722cde', btn_styles: 'flex-fill', class: "flex-fill", isLoading: this.isLoading, btn_type: "submit", text: locales_store.locales.entries.Lcz_ChangePassword, size: "md" })))))), insideSidebar && (index.h("div", { key: '6d808092e531bcf0fa3ebe5d0f041886602c9ce0', class: 'sheet-footer w-full' }, index.h("ir-button", { key: 'acd08b088e7aab1a980eec799e16dfa2e81d32ff', text: locales_store.locales.entries.Lcz_Cancel, onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_color: "secondary", btn_styles: "w-100 justify-content-center align-items-center", size: "md" }), index.h("ir-button", { key: '4a666466d42ccf0b45063e16cc04366deb2fef77', isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_ChangePassword, size: "md" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "ticket": ["handleTicketChange"]
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '5ab7efe43cbca38506ff391e7730135175ce2205', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '49773a0359896b503665baa40af3e2d3b5a6329d', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '93be277b8c3b87ca4e5a7bf346a5f8e14f710d46', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '3e3c95059bea3398dd5ff5ec4800d92c8920cb7d', class: "input-group row m-0" }, label, index.h("select", { key: '1a12b54c4fbe768474ba4bac298dd84ed73f31ee', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '803db2eff10d51fd8fc4a4234209578e4c7b571c', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '1f7dfb288128f20bafb506964ce295575f81124c', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '8e47202a43711105c7028bf3c43cd0c06916902e', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '857a34277a3bf97c325bfa14d338dd37d4a6f9e9', class: 'sidebar-title' }, index.h("p", { key: 'db61fe0c4e4316129d056eabe3414d67dce2fa53', class: 'p-0 m-0' }, this.label), index.h("div", { key: '11905e73de82db3cc61c79846d051513d4baffa9', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '0efcd5d666a32a0cdf9fbf8c046b71096f50d791', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'd9d23563dd4163c0cb2c08904a2f8de27b07a946', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'a4bf5a074982be121fd12fc62b52b779fd8553ff', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '2685b15e6dec81fcb3a59242634500f57c28f609', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '2ffeae54968f6df598d2b37161da4f05e89f1f68' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '42d12a6782497eedeec46c00076d72c757914cad' }, index.h("button", { key: '03fe0af7ce985512fd31c57d8da33ce34f9abd13', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: 'd7b4a5ab6f9faff6ce9cd43f3475152ed9a715ea', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: '8a4088a6c5ceb9e5308f6f92d9f37ba737d3203c', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '73f2883c9d54bfd2db13389c309a41fc18dfa3a9' }, index.h("h4", { key: '8e609166b9779b4eda5e713c54e82ddf91e8c2d6', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '57cc956597be478dcdacd9e8ac7f57b463212a09', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'd1b6e7b6f582d214b85e40f24055eaeac9694c6c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '476e5353b86a7d30f44eff516a9fd39fc19b121b', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '7de28461ee90d6f97fedae27c23ba312c4c9483f', class: 'title-body' }, index.h("slot", { key: 'b244b15edd631a0b392f8dc0bd10ee7d65e313fb', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'b333f3f12f18f87e868a3d1b77f6f66d27e17816' });
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'e4ad500123f24802d472f4545ffb55fa5c92d7bc', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: '89619eeaf0c0cb010a8b97c9d9e229b85894b286', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: '4aa337f777d2e334e7e50ad04f2da6178581b305', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'e0a84944a29fc1c9aa4aab1a4fd7474b01a7eaaa', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), index.h("ir-input-text", { key: 'c698bdbcfe43904cf88f4d49da5d88fa03bcd621', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: locales_store.locales.entries.Lcz_Mobile, mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (index.h(index.Fragment, { key: '7ffdc162f3bd0b88234e3589a8f45df55756810a' }, index.h("input", { key: '3ca00a203ab7c243b87c620f1cb2e7a29809c18e', type: "text", name: "dummy", style: { display: 'none' } }), index.h("ir-input-text", { key: '1c57ee40da6dfb92a0309c2b597ef11326796bfb', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: locales_store.locales.entries.Lcz_Username, disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username,
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, locales_store.locales.entries.Lcz_Password), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: locales_store.locales.entries.Lcz_ChangePassword, btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: '004056eee3cb25260d5fa929d00914f2246656e9', class: "logins-history-section mt-2" }, index.h("div", { key: '8d424927292d77751357fb2c0bcd77687282241c', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: 'e99804c39c880a1f0adfe44836444722d40d6b2d', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: 'e706bd313f302196e55d87aa5f2d0a9b74bc0b45', btn_styles: 'pr-0', text: !this.showFullHistory ? locales_store.locales.entries.Lcz_ViewAll : locales_store.locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: '201e3d973467c020180efd9c0cb0adb4b4ea3d04', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: '706d1b4004b693bb87212578e9fe4ca15fecbd08', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '963e23372fa76cc4b2f397e5aa08f5c9058f3775', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '4832f32ebaf9a255d6a46815156c274b4e7509bb', class: "sheet-footer" }, index.h("ir-button", { key: 'a9075243091d3853d3b9302594b830380bd11331', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'c6dbf699a25c4dec38cce7635493010124537d6c', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fa7ec5c2a97244c7c4f5747fa639f68301833f23' }, index.h("section", { key: '2c9ac99da572542ff0f5b83841f9ac48e42837cd', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '9e1954479f56be68e62286db36fe703ef19f0c90', class: "table" }, index.h("thead", { key: '9b2c826d1744842de0eb1918ac11d80e24e4c223' }, index.h("tr", { key: 'e3937ebc44690c0ac5c287a502bcbdf47e6d3544' }, index.h("th", { key: '02033e3e7d14b2528b2318efd1461af8e17615e8', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '2643f6fe6aec7ddd404a58d8028b72c4394f1531', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: '74d89c3833a8511645b42c91636c2103c4a2c816', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '4f8a8a4e3070669b81c911c16d2aca9da99aba54', class: "text-left" }, locales_store.locales.entries.Lcz_Role), index.h("th", { key: '381dd4f3a3e2ef26050e467791369d5086e0dd75', class: "text-left small", style: { fontWeight: 'bold' } }, index.h("p", { key: '0c420c8d46300c72426eba39dffb69784b12e9d6', class: "m-0 p-0 " }, locales_store.locales.entries.Lcz_CreatedAt), index.h("p", { key: 'cea18f65be791b1dfaaf34e3f5a5ac309d7ba202', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_LastSignedIn)), this.haveAdminPrivileges && index.h("th", { key: 'fc581ea2abb70c45452d6bed8b4a69b270616929' }, locales_store.locales.entries.Lcz_Active), index.h("th", { key: '490b22074a3c7a4f36bced129e974c3b587db741', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '18191a6b5933d0c0d85f13486f6bd437b858b9a2', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateUser, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    mode: 'create',
                    user: null,
                });
            } }, index.h("svg", { key: '90feabacc8fdcf8e2624325b1e632c7137b0eaa7', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '08b99e34dfbe67869229c3d74078767acdc610fa', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: '5b9ca5778235a82f94536832b6c0fc24cd3ce585' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: 'b763aa58e74f53b21a6813016905cdf48d3c128c', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: '352cfe239b5fc03fd098720d88cf1fe7b19d904e', autoClose: false, modalBody: this.modalType === 'delete'
...
const RequirementCheck = class {
    ...
    render() {
        return (index.h("div", { key: '8bbd565a7d02721eedd84ed04b51f007514e6aaf', class: { requirement: true, valid: this.isValid } }, index.h("ir-icons", { key: '8a0d0e5dda6b1c50fe924fb6121779a06ad3ec79', style: { '--icon-size': '0.875rem' }, name: this.isValid ? 'check' : 'xmark' }), index.h("span", { key: '47118e738dbd564f56907268f48802e35a1590b5' }, this.text)));
    }
};
