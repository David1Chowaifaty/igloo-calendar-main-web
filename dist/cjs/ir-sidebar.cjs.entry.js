...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '398b0dfe8e4faf9208f4dcc0d80e1597738115b1', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '8ba5e2bf6dcc2d517acf89131935d6161c6aeeb8', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'ce550495566256e07e697f104682555f73e8a6a4', class: 'sidebar-title' }, index.h("p", { key: '65923efb41aa85b1fd5325ffce8760d4125f519f', class: 'p-0 m-0' }, this.label), index.h("div", { key: '82c9b2d2f470804059e602f61c346ed3dc07c52b', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'f20fff465284bbbdf474bb8fbabe852742fbc6b2', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '76a0da9e748b1d38a7b68d1d28fea7714ee55e49', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '8805eea2bf634cd647dac79abe1d180a5979bfb2', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '8358bd78038606e36858a6046fd565741645ebd5', name: "sidebar-body" })),
        ];
    }
