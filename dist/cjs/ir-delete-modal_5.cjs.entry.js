...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'efd0322dffb1a572214e14f1654a685bc9a9e754', class: "sheet-container" }, index.h("ir-title", { key: 'cbb34c5010b06d085efb0cc30fded1d6c3c7b7b1', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '1753899a3f3ca93a0b1ea72f26b75f0ed943fb53', class: "px-1 sheet-body" }, index.h("table", { key: 'dd30bd41f9b7b88e2d1b15a74165a8466bc0f0f2' }, index.h("thead", { key: 'd600381fb5d27797518ef8d4602520860ca55f56' }, index.h("th", { key: 'd4aac66be7a414f4db639c88ab8933de5aaecef2', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '6c7caf632696e146d580dfe75d901aed0d8dbc00', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '53f82808e336391118ec803693e65aa03d55d9ff', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: 'e003fc55d0b4c7bed8ffda883e4a85082b8f69bc' }, this.renderRooms()))), index.h("div", { key: '98a098692ff38e235945ef67bbdf440de35f1b18', class: "sheet-footer" }, index.h("ir-button", { key: 'b007ecdbd9e40c4d378587fa90bc6c4f183a8a9e', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '46f82451c9a20ce7be8c32eb2e7b01abbc5f789d', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '33537e4fd9f9faede352593ee2f462d6664efb04', class: "sheet-container" }, index.h("ir-title", { key: '13f5d2ea2b67799b63db353e58904c1c417ef91b', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '51ca16f56d289856d1bdf667dc05603c637b0297', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'c81e4f628ddc762fee784ad0919ea52fb2f52b43', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '33801a01cb680047b4d08f4985af409787dcdd18', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile) && !((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile), language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_d = this.user) === null || _d === void 0 ? void 0 : _d.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'f7bbf81ccfd66dacf74e067a9dfe5e35029230a4', class: "mb-1" }, index.h("ir-textarea", { key: '7802ef8047312764b0706b93ffc05ecc9bbd46b4', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: 'ac4f7401bfd84ea2270e7037fb97fe405a9c89a6', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.username, asyncParse: true, autoValidate: this.user ? (((_f = this.userInfo) === null || _f === void 0 ? void 0 : _f.username) !== this.user.username ? true : false) : this.autoValidate, errorMessage: ((_g = this.errors) === null || _g === void 0 ? void 0 : _g.username) && ((_j = (_h = this.userInfo) === null || _h === void 0 ? void 0 : _h.username) === null || _j === void 0 ? void 0 : _j.length) >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '07d7bdc5fe3c5f9136f82a70c7e32694616c9265', testId: "password", autoValidate: this.user ? (!((_k = this.userInfo) === null || _k === void 0 ? void 0 : _k.password) ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: (_l = this.errors) === null || _l === void 0 ? void 0 : _l.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '70ac3f5d6872c916aa0b022d858356af6b24ce32', password: this.userInfo.password })), index.h("div", { key: '1c249b91aa5d5670bf0864c63b65066eb19ba010', class: "sheet-footer" }, index.h("ir-button", { key: '4ee7fc297328a852465377567f6583be7603acf1', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '77b6b92b9e342debe83729b1e2c30e268b31d59c', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '78916246bbd46054e56af94a8d3ef6ddd9a7ed88', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
