...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'b4c446e42b7323e19b49a01cefbe219c4fe4e304', class: "sheet-container" }, index.h("ir-title", { key: 'f1e30519dbdabc8b7778ccc09ea82a8803a97a48', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '23a72878bd7a2772437c9902ce8685c6a61d12fb', class: "px-1 sheet-body" }, index.h("table", { key: '6664732b73098d26d9c7393c643910d1c3821f58' }, index.h("thead", { key: '6ca5c31f0ba809d08962e7f9d844216628235397' }, index.h("th", { key: '11655a88eae7f225344261b321a757edc197e68d', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'c5dcb69afef0987dfad486abfcfd6766918b8034', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'b49a40976f961b27c2ff44252e30bf65fe6f41bd', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '67d84965043deb24ea6157c74221951ca51d8a1a' }, this.renderRooms()))), index.h("div", { key: '0877e77edba3b57ad73782a20238dde3b48ccad7', class: "sheet-footer" }, index.h("ir-button", { key: 'd87275999d174692986cbb9180709d8054877fe0', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '99cd589649d929af80841c31f2de31a7fecccf3e', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'dd0f0f74fd5e6413e31994c94de7f42c6b5ad72b', class: "sheet-container" }, index.h("ir-title", { key: 'dd790ac413fcd00fb2f61d88b286e0c51c0607f7', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'c42f63060d5a11dbb716db33ce0455c0cc65ca45', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'f640cc9a809278ec6fad83ac6c6cfc5d7bf92da7', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '0a8c5e472a9044e2de02238e9af547b79a4bb88e', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile) && !((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile), language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_d = this.user) === null || _d === void 0 ? void 0 : _d.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'a65231aa11942feb7180c0ae4e64bbc6bc787b6b', class: "mb-1" }, index.h("ir-textarea", { key: '8e642e4398c0e5a1553451e817c0f7e47aa845c6', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '54a935dfa5db7946443a14add9f3823d7d2756de', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.username, asyncParse: true, autoValidate: this.user ? (((_f = this.userInfo) === null || _f === void 0 ? void 0 : _f.username) !== this.user.username ? true : false) : this.autoValidate, errorMessage: ((_g = this.errors) === null || _g === void 0 ? void 0 : _g.username) && ((_j = (_h = this.userInfo) === null || _h === void 0 ? void 0 : _h.username) === null || _j === void 0 ? void 0 : _j.length) >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'a67129e76cec765d3b01dee9d8af822725cd62d9', testId: "password", autoValidate: this.user ? (!((_k = this.userInfo) === null || _k === void 0 ? void 0 : _k.password) ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: (_l = this.errors) === null || _l === void 0 ? void 0 : _l.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '1252bb2dad96773c205d31b2997e8d5f849e3320', password: this.userInfo.password })), index.h("div", { key: 'b84458edd716c83158f47e00c0e5389911da3e0c', class: "sheet-footer" }, index.h("ir-button", { key: '39800b1b8efc45615cb4924c2a982537170a5462', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '8d6e087f32cf30189b8251ff2f374296beb19a2a', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0d6950cc98977d42e7a3f77c157d9a5c6aa1e10e', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
