...
const IrHkOperationsCard = class {
    ...
    render() {
        return (index.h(index.Host, { key: '494885bfbd716ba192158bf51496634109bafe3b' }, index.h("wa-card", { key: '60da0b826618df69d9913ec2f965cf2c0bb77799', class: "" }, index.h("div", { key: '95ee483f91e809411b46683bacd0231e090b095b', slot: "header" }, index.h("span", { key: 'ffc36a39968b6067b775db14fac26c757da1c570', class: "ops-header__title" }, "Operations Settings")), index.h("div", { key: '8236c80508fe502a9a01ac1725dd6de20f9ba7ee', class: "ops-settings" }, index.h("div", { key: 'badc2070847e90045a35f1f4c6d0389540ff5590', class: "ops-setting-item" }, index.h("div", { key: 'b49473b91cdec84d82b5885036a4a8c386c2bad3', class: "ops-setting-item__info" }, index.h("span", { key: '70c585772ad10c29aa3959906a33a64cca278cc5', class: "ops-setting-item__title" }, "Automatic Check-in & Check-out"), index.h("span", { key: '8cb5629361cc1e5a7fc2142f9092463111141127', class: "ops-setting-item__subtitle" }, "Process guests automatically based on property rules")), index.h("div", { key: '5d1603e330137ac70f44ba0dafb5816554bcd868', class: "ops-setting-item__controls" }, index.h("wa-select", { key: 'f2b49343675b280382d949adc6a0740065b67462', size: "small", style: { minWidth: '260px' }, value: calendarData.calendar_data.is_automatic_check_in_out ? 'auto' : 'manual', defaultValue: calendarData.calendar_data.is_automatic_check_in_out ? 'auto' : 'manual', onchange: (e) => this.saveAutomaticCheckInCheckout(e) }, index.h("wa-option", { key: '1b104d840ab2af28060225361fcfdc2c136125cc', value: "auto" }, locales_store.locales.entries.Lcz_YesAsPerPropertyPolicy), index.h("wa-option", { key: '2e9fa5126a6fee312e241f821f5e1489503643a7', value: "manual" }, locales_store.locales.entries.Lcz_NoIWillDoItManually))))), index.h("div", { key: 'b2813039cd8711bb48878bf60de2a26190f15b03', class: "ops-tasks__header" }, index.h("p", { key: '30f5422eefb885f1b901728d81c358716df853dc', class: "ops-tasks__title" }, "Recurring Tasks"), index.h("p", { key: 'eaf45111ad349a274796b0af3f363d6bf7362c6d', class: "ops-tasks__subtitle" }, "Define your housekeeping tasks and frequency")), index.h("div", { key: 'af9551d67c40602a49b93b27042197f0391ba411', class: "ops-tasks__list" }, index.h("div", { key: '3479e0c41672cd2dabc5c8553147692e3cbb8fe2', class: "ops-task-row ops-task-row--locked" }, index.h("wa-badge", { key: '26ada73cbe154d2c1eaf075263b6fae8d078b960', variant: "danger", appearance: "filled" }, "CL"), index.h("span", { key: '29337ad72beb2910272574eac87e359ce543237b', class: "ops-task-locked-label" }, "Cleaning"), index.h("wa-select", { key: 'e57737e9aa14d466f0d9917f71ddd2bcdf41da6e', class: "ops-task-select", size: "small", value: this.selectedCleaningFrequency, defaultValue: this.selectedCleaningFrequency, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedCleaningFrequency = e.target.value;
                this.dialog.openModal();
            } }, housekeeping_service.housekeeping_store?.hk_criteria?.cleaning_frequencies.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description)))), index.h("span", { key: 'c5ee32ea471b0d7c457dd30fedc38d49312ea668' })), this.hkTasks.map((task, i) => (index.h("div", { key: i, class: "ops-task-row" }, index.h("wa-badge", { variant: i === 0 ? 'success' : 'brand', appearance: "filled" }, "T", i + 1), index.h("ir-input", { class: "ops-task-input", size: "small", placeholder: i === 0 ? 'Change sheets, ...' : 'Amenities refill, ...', maxlength: 30, value: task.name, onChange: (e) => {
                ...
                this.hkTasks = updated;
                this.saveHkTasks();
            } })))))), index.h("ir-dialog", { key: '264b78286fcbc478bdb98e5c9636a19e56fa678d', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: '701e7e47d0348caeba61bf840ecb861d28833b3b' }, "This action will reschedule all cleaning tasks. Do you want to continue?"), index.h("div", { key: '19ce11d535d928907d920efa3ced9ab26a73f571', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '0d3c74381e7b34613fa523a2cd29da7006b13464', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => {
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '2b002cc62f43f8f1fdc39e9d8e9339a8e238ea98', class: "sheet-container" }, index.h("ir-title", { key: 'a4e5e27fedbd4b6f1a858cb8e4995d3778c987ac', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '7aa04e4c5539b29989fd59bbc9a500d4b6ce5283', class: "px-1 sheet-body" }, index.h("table", { key: '8b0622dd943fbb7e0e0233f698ddb9a856712918' }, index.h("thead", { key: '745c715af239d8706f5a42010a268a0a46721381' }, index.h("th", { key: 'ecde4d9995b7567d77dfcb5a50e12bb1ec316125', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'b0715f1eb02bddadf5ea9088be26bfa28de0f989', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'c4b873bfde9542c692a1b8d4c2d95471719a7c5b', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '7516aa9847072b01260a3d060b5f4121abce7409' }, this.renderRooms()))), index.h("div", { key: '52439ae493aaab89530e1c55b133b56b89623c65', class: "sheet-footer" }, index.h("ir-button", { key: '73a7b840ad1b43051f3f76443bb64e0c82fcea87', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '2fe1c9e0b09f0d1d26be07332b8e17c81aa55a8a', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUnassignedUnitsDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '050701e79690d8e0026f7f0701055d4adc2f1e46', label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}`, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeSideBar.emit(null);
            }, style: { '--ir-drawer-width': 'max-content' }, open: this.open }, this.open && index.h("ir-hk-unassigned-units-drawer-form", { key: '7d82bcff093af1b6b684fe733dcd247883150d2f', formId: this.formId, user: this.user }), index.h("div", { key: '78d1f4dedcf7b0baf4abb40013af3ec768a314ea', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '4e8812e033b415ec56a110becdf3168e6e8b5c3e', "data-drawer": "close", variant: "neutral", size: "medium", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '9eaecefde72c35ed23c28450c603994522381f9b', loading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), variant: "brand", type: "submit", form: this.formId, appearance: "accent", size: "medium" }, "Save"))));
    }
};
...
const IrHkUserDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '0040d6401d892f6b769621262bb4cc8af4793022', open: this.open, onDrawerHide: () => {
                this.closeSideBar.emit(null);
            }, label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }, this.open && (index.h("ir-hk-user-drawer-form", { key: 'eba9c11593baf659e71e8020dc98164de7e7825b', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            }, isEdit: this.isEdit, user: this.user, formId: this.formId })), index.h("div", { key: '85aebbd2f3bf2f50c5e14877bfc5253493895669', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '36829699dc9e403f653f03dc1d26eae0eeff95a1', "data-drawer": "close", variant: "neutral", size: "medium", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'e161125fe4f73f59512a8f2c5d5f539074594a6c', loading: this.isLoading, variant: "brand", type: "submit", form: this.formId, appearance: "accent", size: "medium" }, "Save"))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7337182d990ac1f6de70375ad2f37758ef053215', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
