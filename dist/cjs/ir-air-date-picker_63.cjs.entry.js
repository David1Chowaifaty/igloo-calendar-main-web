...
const utils = require('./utils-4f830388.js');
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b82e9cb46ce75c2e933e5a3583c0f09d00b71b2e' }, index.h("wa-popup", { key: 'fa0b7a56a6cfb87d88b7ab10e0b484964572fe82', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: 'c2bba0f08cd1111a95bb63214339f3ef0fb27d97', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && index.h("slot", { key: '6850cf7803b3735eab8a8618ccdd8587049f70d2', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '636aa07a6be0c548bd6508a699453c4e509276f7', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '89bc42464d6590e002ca82278ef7de772980b1b5', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: 'd40ca3ff8edaa21f84f14a13be37ecd96082faf1', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '887672f1564bdc15ecf40c5117c2300186de076e', name: "hint", slot: "hint" })), index.h("div", { key: '7797a4671bb7deec4d097b4d50c6da374c3837ca', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: '147d6a311493de9fa9be613ff1ad0de592f8a2b6', onSlotchange: this.handleOptionsSlotChange })))));
    }
    static get watchers() { return {
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '972b0a96887cce9dfb915f6dc77c9ecd59d7f667', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '34358493efc7f7c6c14a6f4c80f94501741543ae', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: 'a9fa4d12030408f5ed40dc217f71feb5905d5f8f' }), index.h("slot", { key: '5bcf5cb897867fbe2a9dbd787f8e80b1aad25f6a', name: "start", slot: "start" }), index.h("slot", { key: '69ee13d023a70d83f7abe7361a1048d7b27b799e', name: "end", slot: "end" }))));
    }
};
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("section", { key: '1b0d659f3d9ad1a9452b9d53ccc067a17b60ace8', class: "fiscal-filters", "aria-label": "Fiscal document filters" }, index.h("div", { key: '54210c1c40d07447fb71a83a391fe73e6434b1bd', class: "fiscal-filters__left" }, index.h("ir-date-range-filter", { key: '507089a1103150cec6f1b414c547f4543fe524fb', maxDate: today.format('YYYY-MM-DD'), class: "fiscal-filters__dates", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) }), index.h("wa-select", { key: 'dabc690c4806442d0de976cb7da8a7e4c98da19c', value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Status" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("ir-input", { key: '8ae426e0da3aba3f9fbeea2009423a0f2f7bfd9f', placeholder: "Search", class: "fiscal-filters__search" }, index.h("wa-icon", { key: 'e174ebca1a79623e8ee3adbe21224ce67184a87b', name: "magnifying-glass", slot: "start" })), index.h("wa-switch", { key: 'c6809f3d30be608f4e5aaaa7136f660a87c8f46b', id: "tax-switch", checked: this.filters.taxableOnly, onchange: event => this.updateFilters({ taxableOnly: event.target.checked }) }, "Taxes"), index.h("ir-custom-button", { key: 'b64e8ad08ce0431a1b11f3678d6aa63431c726c1', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit(this.filters) }, index.h("wa-icon", { key: '4237e5aff03153fe10e4dd6eefbb561fb359c52f', name: "magnifying-glass" })))));
    }
};
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6bb2cc06286ebb64c261f8287b147fb3936029de' }, index.h("ir-city-ledger-folio-filters", { key: '2ff948f31761e0aa7d56bcee3d299b3545db97a6', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
                ...
                this.pageIndex = 0;
                await this.fetchFolioData();
            }, onGenerateInvoice: e => console.log('Generate invoice for', e.detail) }), index.h("ir-city-ledger-transaction-drawer", { key: 'bde7b4afcf09ba7ddb1128785c37c9e77a7fc699', open: this.isTransactionOpen, taxOptions: this.taxOptions, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, onTransactionSaved: () => {
                this.fetchFolioData();
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ccaefc77af4f7bf6a46e3aaa53b8b87bca31fbd1' }, index.h("div", { key: '0448a0ecacfe0f6d6ef897ee2f4ff8914b2b2c9d', class: "filters-bar" }, index.h("div", { key: 'c2df70e8be2ccf7ee1a9f81c8c5e4f6bf8eceacc', class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '8ce3798fbd5f3c1515b7db14cd5a5aa90e492de4', maxDate: moment.hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), index.h("div", { key: 'b76f0f173477c5fd9ac78e8bf1ff02b1ee071f5a', class: "filters-bar__search-group" }, index.h("wa-select", { key: '46468d3be241b594ba7e7e63f544dc7db32314bc', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: 'c4c63faf948673f98e8e5b0cadcb4411a769a5de', class: "filters-bar__search-input", "onText-change": e => {
                this.searchQuery = e.detail;
                this.emitFiltersDebounced();
            }, value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: '6ed2040127079ed00022451bbd690add78fe5de0', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'af41593730565490658a8d7a44d8ab989baf7fc8', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit({
                fromDate: this.dates.from?.format('YYYY-MM-DD'),
                toDate: this.dates.to?.format('YYYY-MM-DD'),
                status: this.statusFilter,
                search: this.searchQuery,
            }) }, index.h("wa-icon", { key: 'ca7655588c54c34659d0b2c955e5841dfac2f342', name: "magnifying-glass" }))), index.h("div", { key: 'f97cd824b61797f69be615b5c11d899c8cfcf917', class: "filters-bar__actions" }, index.h("wa-dropdown", { key: '8ee72c6562bcb071f48ff081cc202325baee871b' }, index.h("ir-custom-button", { key: '1fa7eae8c87f2c2ef3f7cb8595a50925b6de4f9f', slot: "trigger", appearance: "outlined", withCaret: true }, index.h("wa-icon", { key: '5e5b000297a40a79a315ce56a5558bdd5f7e4185', name: "download", slot: "start" }), index.h("span", { key: 'dc1e7155d63b91c90c71050faf1d928d1a5b6d6e' }, "Export")), index.h("wa-dropdown-item", { key: 'be3cfb9ca2a461595e42a5f81bce7b7fa7f5604c', value: "csv" }, index.h("wa-icon", { key: '613b9e7ca6f37a122a03cbc99c41cd8ef5a2816c', slot: "icon", name: "file-csv" }), "Export as CSV"), index.h("wa-dropdown-item", { key: '5033dc4bff7ba117a1fc241f7497204eee45070c', value: "pdf" }, index.h("wa-icon", { key: 'ab8a2a69ff528ec971c993b8839c49dc5694f56b', slot: "icon", name: "file-pdf" }), "Export as PDF"), index.h("wa-divider", { key: 'd08ec315710d06bb4c5f8c5d2f3069a8f2ac213d' }), index.h("wa-dropdown-item", { key: '74b895dc00b68b3df0f598b9949c89e7c595bb44', value: "print" }, index.h("wa-icon", { key: '535f64d17f88c449e5fc20c05e846d9742348697', slot: "icon", name: "print" }), "Print Folio")), index.h("ir-custom-button", { key: '36624f8172f5067093a8d25102fb4577fb6e6364', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate$4([
...
const IrCityLedgerStatements = class {
    ...
    async fetchStatement(filters) {
        ...
        try {
            ...
            this.rows = (result?.My_Rows ?? []).map(r => ({ ...utils.mapClTxToFolioRow(r.Cl_tx), _rowId: v4.v4() }));
        }
        catch (err) {
    ...
    render() {
        const currencyId = calendarData.calendar_data?.property?.currency?.id;
        return (index.h(index.Host, { key: '23904979507be3f03de7e5cf321a67683e019df1' }, index.h("section", { key: '8c303f29a4dc1f0dc6df149e8584b7a375c4531f', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: '2131dad6e8c8e97c0bcb5d93ddb56b10a35600c5', onFiltersChange: e => (this.filters = e.detail), onCreateStatement: e => {
                this.filters = e.detail;
                this.fetchStatement(e.detail);
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: '805a314d7c075277cf9c79430b3569d95e9b9c16', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate })), index.h("ir-preview-screen-dialog", { key: 'ec3927175071faef9798ae940a845158ba6636d1', open: this.printFilters !== null, label: this.getPrintLabel(), action: "print", onOpenChanged: e => {
                if (!e.detail)
                    this.printFilters = null;
            } }, this.printFilters && this.agentId && currencyId && (index.h("ir-cl-statement-preview", { key: 'f462722b3cd1b11374592fa45e6013a56b743486', ticket: this.ticket, propertyId: this.propertyId, agentId: this.agentId, agentName: this.agentName, fromDate: this.printFilters.fromDate, toDate: this.printFilters.toDate, currencyId: currencyId })))));
    }
    static get watchers() { return {
        "agentId": ["handleAgentIdChange"]
    }; }
...
const IrCityLedgerStatementsTable = class {
    ...
    renderMoney(value, row) {
        ...
        return index.h("span", null, utils$1.formatAmount(this.getSymbol(row), value));
    }
    get columns() {
        return [
            this.columnHelper.accessor('serviceDate', {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: "table--container" }, index.h("table", { class: "table data-table" }, index.h("thead", null, table.getHeaderGroups().map(headerGroup => (index.h("tr", { key: headerGroup.id }, headerGroup.headers.map(header => (index.h("th", { key: header.id, class: { 'cell--align-end': NUMERIC_COLS.has(header.column.id) } }, useTable.flexRender(header.column.columnDef.header, header.getContext())))))))), index.h("tbody", null, this.renderStartingBalanceRow(), table.getRowModel().rows.length === 0 ? (index.h("tr", null, index.h("td", { class: "empty-row", colSpan: colCount }, "No transactions in this period."))) : (table.getRowModel().rows.map(row => (index.h("tr", { key: row.id, class: "ir-table-row" }, row.getVisibleCells().map(cell => (index.h("td", { key: cell.id, class: {
...
const IrCityLedgerTransactionDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'b868126486611c6e0b4bbeea1789eefcc5685275', open: this.open, style: {
            ...
            } })), index.h("div", { key: 'aca08057b65f55e1530155eb0a3f8f786cab7835', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'e6284d41601181bec82b6dc4e3eedf70f3270bbd', appearance: "filled", size: "medium", variant: "neutral", class: "city-ledger-transaction-drawer__btn", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), index.h("ir-custom-button", { key: 'df7d55f7e7aca35d5335b1daf825608c565d6ea5', form: this.formId, size: "medium", type: "submit", variant: "brand", class: "city-ledger-transaction-drawer__btn", disabled: this.saveDisabled }, "Save"))));
    }
};
...
const IrClAdjustmentFields = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'd4ce87df7d2cf456a04f8c6c74c50a42fa5cc762' }, index.h("div", { key: '9b6ade1f94d800e3790eb610f03212afc11d2db1', class: "field field--full-width" }, index.h("ir-validator", { key: '9d1030103614f7fb330f3c9ce4790423c9753d15', schema: entryTypeFieldSchema, value: this.entryType, valueEvent: "change" }, index.h("wa-radio-group", { key: 'f568becf6de5891dffee8fe4346735442a4572ab', label: "Entry Type", orientation: "horizontal", size: "small", value: this.entryType, onchange: event => {
                this.fieldChange.emit({ entryType: event.target.value });
            } }, index.h("wa-radio", { key: 'c19c7c44dfba6b95ca68754ea37f94271b3a53dc', value: "CR", appearance: "button", class: "entry-type --credit" }, "Credit"), index.h("wa-radio", { key: 'f2ed18ab97dca526c15d4738e9a4da14f829029c', value: "DB", appearance: "button", class: "entry-type --debit" }, "Debit")))), index.h("div", { key: '993079f30e6f0fbdd9ea5b13d9e04312be0cb968', class: "field" }, index.h("ir-validator", { key: 'a9167a3c9a9f0e8c0e271acb7a51838ccfbc7506', schema: linkTypeFieldSchema, value: this.linkType, valueEvent: "change" }, index.h("wa-select", { key: '76058d80051e987908ba9072e250715b2a9f075b', label: "Link Type", size: "small", value: this.linkType, onchange: event => {
                const linkType = event.target.value;
                this.fieldChange.emit({
                    linkType,
                    linkedId: linkType === 'NONE' ? undefined : this.linkedId,
                });
            } }, LINK_TYPES.map(lt => (index.h("wa-option", { key: lt, value: lt }, lt)))))), this.linkType !== 'NONE' && (index.h("div", { key: '4d287ddeb254bf4460eece384bd253071b8bacd2', class: "field" }, index.h("wa-select", { key: 'fe01bb348c16acff04f3b1ae7b3967090839a47b', label: "Linked Record", size: "small", value: this.linkedId ?? '', onchange: event => {
                this.fieldChange.emit({ linkedId: event.target.value || undefined });
            } }, index.h("wa-option", { key: 'ae8929c618add20739a1e257b2b94c4104039c11', value: "" }, "No linked record"), this.linkedIdOptions.map(option => (index.h("wa-option", { key: option.id, value: option.id }, option.label))))))));
    }
};
...
const IrClCreditNoteFields = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, { key: '72711c9bd4144fe10e9e0367c8f4eb175615421f' }, index.h("div", { key: '4434c7dd3317442356187d0d9272bf38728a270d', class: "field field--full-width" }, index.h("wa-radio-group", { key: 'daa5eb00120780529151aafadc56658a3f4064e5', label: "Credit Note Type", orientation: "horizontal", size: "small", value: this.creditNoteMode, onchange: e => {
                const val = e.target.value;
                this.fieldChange.emit({
                    creditNoteMode: val,
                    invoiceId: val === 'goodwill' ? undefined : this.invoiceId,
                });
            } }, index.h("wa-radio", { key: '17c5157226fbaca7b2e92faf19807728d394d5e5', value: "cancel-invoice", appearance: "button", disabled: noInvoices || this.isFetchingFiscalDocs }, "Cancel invoice and unlock all items"), index.h("wa-radio", { key: 'b7100dc0fa954bd3a575cfe9dbfbd4abbf7d0f84', value: "goodwill", appearance: "button" }, "Goodwill credit"))), this.creditNoteMode === 'cancel-invoice' && (index.h("div", { key: '49d5dc22bd347bea5d14619db6f7f9f07f16aad1', class: "field" }, index.h("ir-validator", { key: 'cb38f15a3a68fb8856f00d0d17491d07d5cdec07', schema: invoiceIdRequiredFieldSchema, value: this.invoiceId ?? '', valueEvent: "change" }, index.h("wa-select", { key: '5ac3cd7df271ea4686712c3a9bb18487849d7f4b', label: "Invoice", size: "small", required: true, value: this.invoiceId ?? '', onchange: event => {
                this.fieldChange.emit({ invoiceId: event.target.value || undefined });
            } }, index.h("wa-option", { key: '02a3e7800ad91ce7ba270c1de6f46fbddbf37be0', value: "" }, "Select invoice"), this.fiscalDocuments.map(doc => (index.h("wa-option", { key: doc.FD_ID, value: String(doc.FD_ID) }, doc.DOC_NUMBER, " \u2014 ", doc.FD_TYPE_NAME)))))))));
    }
};
...
const IrClDocumentHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0381e41fa915a9986b9c97a43efa88761728ed9f' }, index.h("header", { key: 'd7ced218aec7a4a170795bf4ec15ea1e597c6a11', class: "invoice__header" }, index.h("h3", { key: '98a29824d95d9557455912b710a06c31c8614101', class: "invoice__title" }, this.documentTitle), index.h("section", { key: '6e6054479f48e68ae8e2d3190312beb21f04543d', class: "invoice__layout" }, index.h("div", { key: '0f302b836a5b03790f746d5b1e6695865503e4a0', class: "invoice__column invoice__column--details" }, index.h("div", { key: 'c619e6f6aff4ec48094fe95adde373b412d1491f', class: "invoice__details" }, this.documentNumber && (index.h("div", { key: '10b561f70165eb1c44b7de653c3f71ee1a7b4da1', class: "invoice__meta-row" }, index.h("span", { key: 'd6f7b8f423dede117d5026ea5308407cbf1836b9', class: "invoice__meta-label" }, "Document #"), index.h("span", { key: '8ddb17d3a652f3ce27f1339e81e6fa717f528e22', class: "invoice__meta-value" }, this.documentNumber))), index.h("div", { key: '4bd10b7eb5018790e408db383e4950efa4968c33', class: "invoice__meta-row" }, index.h("span", { key: 'cc1809e6ecc729eb8db79e6f5942c7e030611f93', class: "invoice__meta-label" }, "Date"), index.h("span", { key: '96886bbd013b76ef4f7d125dc2497769d3736647', class: "invoice__meta-value" }, moment.hooks().format(DATE_DISPLAY$1)))), this.agentName && (index.h("section", { key: 'a15a2eaf5c22bdc0dff8b7f98b976610536b6f7f', class: "bill-to-section", "aria-label": "Bill to" }, index.h("h4", { key: '978aa299140d91825b0f76997b7158cf013d40c2', class: "section-heading" }, "Bill To"), index.h("div", { key: '3f00494652f1ab582112335e3a1fd2ff792a3437', class: "bill-to" }, index.h("p", { key: '435311e9a5f20199ec33928f1fe4ceda412df665', class: "bill-to__name" }, this.agentName))))), index.h("div", { key: '38ab4839a7eca199bc6f21cc590010988cae8388', class: "invoice__column invoice__column--property" }, index.h("div", { key: '56a616728b37774be0936451d953a317cd4ddae1', class: "property-overview", "aria-label": "Property overview" }, logo && index.h("img", { key: 'd7cb06aa659219a9f8e996af85ae585d406c5d54', src: logo, alt: p?.name, class: "property-logo" }), index.h("div", { key: 'e45d5fb32067a605e99c7fbb0b261580b408539c', class: "property-overview__text" }, index.h("p", { key: 'a61ad8b0bf343eb14fdbc876c8ff488e06c98dc5', class: "property-overview__name" }, p?.name), propertyLocation && index.h("p", { key: '5ebe62dbe9fcc85f0b05b7536b0b76c27fec69cc', class: "property-overview__location" }, propertyLocation), p?.address && index.h("p", { key: '1b7942e1aa75a4041763e71090349597d7f8a343', class: "property-overview__location" }, p.address), p?.phone && index.h("p", { key: '2adbeb69420da07784f91bb1aa3430126a4d7187', class: "property-overview__location" }, p.phone), this.primaryContact?.email && index.h("p", { key: '5c918206a14706cba7a881e6430cc46678de5370', class: "property-overview__location" }, this.primaryContact.email), p?.tax_nbr && index.h("p", { key: '91e7c671c24708d54f87739598c8fb2a0c952695', class: "property-overview__location" }, "Tax Reg: ", p.tax_nbr))))))));
    }
};
...
const IrClFiscalDocumentPreview = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6cec4e3747f3086d86fea7e9f97a5fdfbbb144c3' }, index.h("ir-preview-screen-dialog", { key: '42bcfd54b496893da7fe274fbdac6766c8020e7d', open: this.request !== null, label: this.getDialogLabel(), action: "print", onOpenChanged: e => {
                if (!e.detail)
                    this.request = null;
            } }, this.renderPreview())));
    }
...
const IrClFiscalDocumentTable = class {
    ...
    renderTotals() {
        const t = this.totals;
        return (index.h("tr", null, index.h("td", { class: "invoice-items__td" }), index.h("td", { class: "invoice-items__td invoice-items__td--num" }), index.h("td", { class: "invoice-items__td invoice-items__td--num-primary" }, index.h("span", { style: { fontSize: '1rem' } }, this.renderMoney(t.net)), " ", index.h("br", null), "Net Price"), index.h("td", { class: "invoice-items__td invoice-items__td--num" }), index.h("td", { style: { paddingTop: '1rem' }, class: "invoice-items__td invoice-items__td--num invoice-items__td--num-primary" }, index.h("span", { style: { fontSize: '1rem' } }, this.renderMoney(t.tax)), index.h("br", null), "Taxes"), index.h("td", { class: "invoice-items__td invoice-items__td--num" }), index.h("td", { class: "invoice-items__td invoice-items__td--num" }), index.h("td", { class: "invoice-items__td invoice-items__td--num-primary" }, index.h("span", { style: { fontSize: '1rem' } }, this.renderMoney(t.total)), index.h("br", null), "Total")));
    }
    render() {
        return (index.h(index.Host, { key: '3feaea9e6a2228544de10fe2ced7d4201c20ab32' }, index.h("section", { key: '8d829b2c0e93bb0fac0bfe97d4ef8353eaf64d31', class: "invoice-items" }, index.h("table", { key: 'b694734c7858c566179cc37042f6fe7bf1737098', class: "invoice-items__table" }, index.h("thead", { key: '3e7d8edd5efab002570b7a07867bfc70083e2a7a' }, index.h("tr", { key: '99d608a2f0f37277cd4abcf0732cdcad073cf8e1' }, index.h("th", { key: '168562e1558971708b71db9b4b8fad440419a3ba', class: "invoice-items__th invoice-items__th--nowrap" }, "Date"), index.h("th", { key: '8d70c339e41d5b1c6b807f929eb2e1030fd4f052', class: "invoice-items__th", style: { width: '100%' } }, "Description"), index.h("th", { key: 'ffeaee21c86abce1efebe87f342f60d3dd55ff2e', class: "invoice-items__th invoice-items__th--num-primary invoice-items__th--nowrap" }, "Net Price"), index.h("th", { key: '58140de68c83aaffa664fd7133fc25fa662c6295', class: "invoice-items__th invoice-items__th--nowrap" }, "VAT"), index.h("th", { key: 'ca75f195cca1dc67d170b0eac92daa5458b00f5b', class: "invoice-items__th invoice-items__th--num invoice-items__th--nowrap" }, "VAT Amount"), index.h("th", { key: '3f9871f243d679acd22897c8e3f00b288b02b6b4', class: "invoice-items__th invoice-items__th--nowrap" }, "City", index.h("br", { key: 'ab44c80cefb87776b580e668b08fe05e6b7d31a6' }), " Tax"), index.h("th", { key: '7cbcc9b4926ea8b77d25700b00b2e1c9ceb4027b', class: "invoice-items__th invoice-items__th--num invoice-items__th--nowrap" }, "City Tax", index.h("br", { key: 'ce474cf6cdeb71ae7722e82a1d919e01b26fa196' }), " Amount"), index.h("th", { key: '60446e5a80d3a66cb1bc469563ddcfe90b6c7a85', class: "invoice-items__th invoice-items__th--num-primary invoice-items__th--nowrap" }, "Total"))), index.h("tbody", { key: 'c92855035e265738d334d4f6c4a82b550497d82f' }, this.transactions.length === 0 ? (index.h("tr", null, index.h("td", { class: "invoice-items__empty", colSpan: 8 }, "No transactions found for this document."))) : (index.h(index.Fragment, null, groupData(this.transactions).map(item => this.renderTopLevelItem(item)), this.renderTotals())))))));
    }
};
...
const IrClInvoiceCityTaxAmountCell = class {
    ...
    cityTaxPercent;
    render() {
        return index.h(index.Host, { key: 'd027dd05395c6e5a9bcb61f1cef580795bf0226c' }, this.cityTaxPercent > 0 ? utils$1.formatAmount(this.currencySymbol, this.amount) : '');
    }
};
...
const IrClInvoiceCityTaxPctCell = class {
    ...
    cityTaxPercent;
    render() {
        return index.h(index.Host, { key: 'a641b38b4c0be0148d66650040c8c281afd17b51' }, this.cityTaxPercent > 0 ? `${this.cityTaxPercent}%` : '');
    }
};
...
const IrClInvoiceDateCell = class {
    ...
    date;
    render() {
        return index.h(index.Host, { key: '84961c1e3fb89350ae43a85f1b3b66206b1e4c1a' }, moment.hooks(this.date, 'YYYY-MM-DD').format('MMM DD, YYYY'));
    }
};
...
const IrClInvoiceDescriptionCell = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '9ef77b59bf5d6779cee7d406be992144bec3aa96' }, index.h("span", { key: '521ab6e25041ca57f141d8a4a279b91956561efe', class: "desc" }, this.description)));
    }
};
...
const IrClInvoiceDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '888956dc6cd1b563633a3506a0b20ecc7d05be6a' }, index.h("ir-dialog", { key: '36dfd5c09579a27a017236495aa36feead36f18d', label: "Create Invoice", ref: el => (this.dialogRef = el) }, index.h("div", { key: '0d08ca5602e50e4161b1b10a7d02b4ebd0c36b51', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (index.h("p", { class: "create-invoice-dialog__message" }, "Issue a draft invoice for booking #", this.bookingNbr, " to the agent?")) : (index.h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (index.h("wa-callout", { key: '75ee53e094f39a6b2a7e78f166060cde183fe03d', variant: "warning", class: "create-invoice-dialog__no-results" }, index.h("wa-icon", { key: 'd0573014b0a97f417d75745dcc8b877b324d5174', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && index.h("p", { key: 'a27b96c983ffb96d9138840998c22bed4a55bddf', class: "create-invoice-dialog__error" }, this.error)), index.h("div", { key: '6cd625c04e96e98e3b87d3dcb9da924f3a482ab8', slot: "footer", class: "create-invoice-dialog__footer" }, index.h("ir-custom-button", { key: '098c976b3430552fc0313d1ffc67dee0cec60022', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), index.h("ir-custom-button", { key: '37221f0951786005ea97c50eb4711f2e9bdfd854', size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, "Show draft")))));
    }
};
...
const IrClInvoiceNetPriceCell = class {
    ...
    amount;
    render() {
        return index.h(index.Host, { key: 'b2fcbd3e6d2aa784c98b1d4f1599ce9a377ad4fc' }, utils$1.formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceTotalCell = class {
    ...
    amount;
    render() {
        return index.h(index.Host, { key: '65c2a55a03c3d53a11a3f4949d674720590cfe04' }, utils$1.formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatAmountCell = class {
    ...
    amount;
    render() {
        return index.h(index.Host, { key: 'd46496a58187c2c21fb386e3c1c6bee2bbb1846f' }, utils$1.formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatPctCell = class {
    ...
    vatPercent;
    render() {
        return index.h(index.Host, { key: 'b4cac03917ef530188d796147fd916b5a786611a' }, this.vatPercent, "%");
    }
};
...
const IrClOpeningBalanceFields = class {
    ...
    fieldChange;
    render() {
        return (index.h("div", { key: '121125299be4e01c9e6b5b6f19e2c5aa20ff6887', class: "field field--full-width" }, index.h("ir-validator", { key: 'ea4a8c2389e4516aac65ec8244e2d72b51fb2d37', schema: entryTypeFieldSchema, value: this.entryType, valueEvent: "change" }, index.h("wa-radio-group", { key: 'edc9a102a30bc2d6a4806b3a570d5377359cea09', label: "Entry Type", orientation: "horizontal", size: "small", value: this.entryType, onchange: event => {
                this.fieldChange.emit({ entryType: event.target.value });
            } }, index.h("wa-radio", { key: 'ea5ea12800c982ad72f0c1b60c2e4024b36ffcf7', value: "CR", appearance: "button", class: "entry-type --credit" }, "Credit"), index.h("wa-radio", { key: 'f4b9bf9a25ce792b1ee45b9b9b49453627de290e', value: "DB", appearance: "button", class: "entry-type --debit" }, "Debit")))));
    }
};
...
const IrClPaymentFields = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '5cc29584daee0f94c6a72ed0b15871582e48ae5a' }, index.h("div", { key: '606972f60bb17ba8c81a8156a0eed010fb48232c', class: "payment-section" }, index.h("div", { key: '7a1ba12ca3011213bd8a3f7d8aa7c15b1267b763', class: "field" }, index.h("ir-validator", { key: 'a7635cd190b4a07c261d0a7fe9e1edea39b9d61c', schema: paymentMethodCodeFieldSchema, value: this.paymentMethodCode, valueEvent: "change" }, index.h("wa-select", { key: '7e1ec3a2ac0b5f3fede95009c8d3e63218108eee', size: "small", label: "Payment method", placeholder: "Select method\u2026", value: this.paymentMethodCode, "onwa-show": e => this.stopPropagation(e), "onwa-hide": e => this.stopPropagation(e), onchange: e => {
                this.stopPropagation(e);
                this.handlePaymentMethodChange(e.target.value);
            } }, index.h("wa-option", { key: 'ddb9d5721a9bf5e5967bd012866e150c9aedf374', value: "" }, "Select method\u2026"), this.paymentMethods.map(method => (index.h("wa-option", { key: method.CODE_NAME, label: method.CODE_VALUE_EN, value: method.CODE_NAME }, utils$1.getEntryValue({ entry: method, language: this.language }))))))))));
    }
};
...
const IrClStatementPreview = class {
    ...
    render() {
        ...
        const currency = this.property?.currency?.symbol ?? '$';
        const fmt = (v) => (v != null ? utils$1.formatAmount(currency, v) : '—');
        return (index.h(index.Host, null, index.h("div", { class: "document" }, index.h("ir-cl-document-header", { style: { marginBottom: '1.75rem' }, property: this.property, agentName: this.agentName, documentType: "statement" }), index.h("table", { class: "stmt-table" }, index.h("thead", null, index.h("tr", null, index.h("th", { class: "stmt-th stmt-th--date" }, "Date"), index.h("th", { class: "stmt-th" }, "Description"), index.h("th", { class: "stmt-th" }, "Document #"), index.h("th", { class: "stmt-th stmt-th--num" }, "Debit"), index.h("th", { class: "stmt-th stmt-th--num" }, "Credit"), index.h("th", { class: "stmt-th stmt-th--num" }, "Balance"))), index.h("tbody", null, index.h("tr", { class: "stmt-row stmt-row--balance" }, index.h("td", { class: "stmt-td", colSpan: 3 }, "Opening Balance \u2014 ", moment.hooks(this.fromDate).format(DATE_DISPLAY)), index.h("td", { class: "stmt-td" }), index.h("td", { class: "stmt-td" }), index.h("td", { class: "stmt-td stmt-td--num stmt-td--bold" }, fmt(STARTING_BALANCE))), My_Rows?.map(row => {
            const tx = row?.Cl_tx;
            if (!tx)
                return null;
            return (index.h("tr", { class: "stmt-row" }, index.h("td", { class: "stmt-td stmt-td--date" }, tx.SERVICE_DATE ? moment.hooks(tx.SERVICE_DATE).format(DATE_DISPLAY) : '—'), index.h("td", { class: "stmt-td" }, tx.DESCRIPTION || '—'), index.h("td", { class: "stmt-td stmt-td--doc" }, row.DOC_NUMBER || '—'), index.h("td", { class: "stmt-td stmt-td--num" }, tx.DEBIT ? fmt(tx.DEBIT) : '—'), index.h("td", { class: "stmt-td stmt-td--num" }, tx.CREDIT ? fmt(tx.CREDIT) : '—'), index.h("td", { class: "stmt-td stmt-td--num" }, fmt(row.RUNNING_BALANCE))));
        }), index.h("tr", { class: "stmt-row stmt-row--balance" }, index.h("td", { class: "stmt-td", colSpan: 3 }, "Closing Balance \u2014 ", moment.hooks(this.toDate).format(DATE_DISPLAY)), index.h("td", { class: "stmt-td" }), index.h("td", { class: "stmt-td" }), index.h("td", { class: "stmt-td stmt-td--num stmt-td--bold" }, fmt(ENDING_BALANCE))))))));
    }
};
...
const IrDateSelect = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd1ef731a12fc1f126bb0446fe73d3b564cf08652', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, index.h("wa-popup", { key: 'a94399a200b00b019fbace0fad551ba5632bacc9', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, index.h("div", { key: '75b597bc551379e5e25a1a443ef060e1f0cc07f9', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, index.h("div", { key: '40f4a2f82e73e179171258df4232aea33d845e52', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("slot", { key: '5dff5140ab5ab4b2108710af8385d7dbf301a0a9', name: "trigger" }, index.h("ir-input", { key: 'bb21f1d8c2ef56ec9695bde0d0aa96d4d9b8cf90', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && index.h("slot", { key: '181cf8159414b2ddbaa2eb6d2bb6a858f789b4a5', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: 'd30308b06a92c746e7d6dff00dfd9df6e97f5e11', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '6801da9267de7a91790d84a5cef0138cd657b1c7', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: '74d2a0b10bd05d6df112b5cbdbdeef892584686b', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: 'b4f6cc945741be88873520008c684a1aa0f373a8', name: "hint", slot: "hint" }))))), index.h("div", { key: '47e807e5b8e797970885fb3f66c5c14ebeddf6b6', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, index.h("ir-air-date-picker", { key: 'ba9f3ea06ac7957ce3acafb13027c049b4926999', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), index.h("slot", { key: '3f938aa78b5f208f6ec8c39cedbe5bde0634a693' })))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: 'b484dc593c1530e0d29514b1e195efb1257e350d', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: 'e67a325a2128f102881053bcf1883037647fee9b', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '95c2c3272436c74b61245f2e3318430b2d028801', name: "label", slot: "label" }), index.h("slot", { key: 'ee296110b0eaaa87bd1e45b6b9c075e949bdac55' }), this.slotState.get('footer') && index.h("slot", { key: '9ce2c6da02b64ff32111e3fba7b8917fbde14a83', name: "footer", slot: "footer" })));
    }
};
__decorate$2([
    OverflowRelease()
...
const IrEmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: '499165bfa8718d86d8580ceb28d45fc99adbd566' }, index.h("slot", { key: '384560da58dee6cdd8875e882eef8a9f37d75a6e', name: "icon" }, index.h("div", { key: '72d05b34ecf14e7e1077e85e30ab510e28e46358', class: 'icon_container' }, index.h("wa-icon", { key: 'e8d7e1160d4cfc1563e477df67dc4d03709c9086', name: "ban", style: { transform: 'rotate(90deg)' } }))), index.h("p", { key: 'd35e898413a8bf6290922a1e54a662520e121ed3', part: "message", class: "message" }, this.message), index.h("slot", { key: '88c48c8a89cc4dfe568a859468e84103447d5fcd' })));
    }
};
...
const IrHoldTransactionDialog = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e6dd2760f2bc2b6eb1225374c7661e9ba05735c8' }, index.h("ir-dialog", { key: '07f5606128a623b7633db422fb928ffb458a624c', label: isHeld ? 'Revert Transaction' : 'Hold Transaction', ref: el => (this.dialogRef = el) }, index.h("div", { key: '7eb82f67a20003114bfbe7885e937dad43c27664', class: "hold-dialog__body" }, isHeld ? (index.h("p", null, "Revert this transaction back to ", index.h("strong", null, "Unbilled"), " status? It will re-enter the billing queue.")) : (index.h("p", null, "Place this transaction on ", index.h("strong", null, "Hold"), "? It will be excluded from invoicing until released."))), index.h("div", { key: '7800418ebeaaa14602d0d9a9918bb0fd8a7e6d57', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '886b59ec0cb8d87ca206c48aa628773ba6a6d4a9', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '19f8a2c5f053dfb39b8313fefc7b2fbade56bebd', size: "medium", loading: this.isLoading, onClickHandler: () => this.handleConfirm(), appearance: "accent", variant: "brand" }, "Confirm")))));
    }
};
...
const IrInputCell = class {
    ...
    render() {
        return (index.h("div", { key: '6c2bc02bba0a1fe83f6094384aa34e18ea344fcd', onDblClick: () => {
                if (this.disabled) {
                    return;
                }
                if (!this.active) {
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '76ba96693b55c10ea9b2853af1fbacf4ed296508' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'a52dd61ecaa405c28889594bc6c7ac8ba8adc809', class: "loadingScreenContainer" }, index.h("div", { key: '4a31038aa6f0938697664d21fd3ac359c8387118', class: "loaderContainer" }, index.h("ir-spinner", { key: '1b7d4c3a599cdd23aeb6fb19b852f92c12a0cd04' })))), this.showModal && (index.h("ir-otp-modal", { key: 'cb6d62122cc8486c70bad76b3b012e4f310b0225', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    message = '';
    render() {
        return (index.h("div", { key: '1c296cb80a42ab6a5355f5a86f7502fdca90dce6', class: "loader__container", "data-testid": "loading-screen" }, index.h("wa-spinner", { key: '4a76ea7b0c04816de6acbd6aa8c7c900edbf2e7e', style: { fontSize: '2.5rem' } })));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '315598332e085b1f18c57d3bb797cb676f64979e', class: "otp-input-container" }, index.h("div", { key: 'c6b56a207bb937c78d864599b84c91fe3d827cac', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '8ba878e35d7331169b0e493caeb5addf4460b98c' }, index.h("ir-interceptor", { key: '952adf54385145ba4f760a4aea2810ecf35a373d' }), index.h("ir-toast", { key: 'b82ddc19f3ff0783634709a663fbcbf76630e592' }), index.h("main", { key: '548f19ea0d21a18721c06d85530a4f9592402fa5', class: "ir-page__container" }, index.h("header", { key: '1ba86c34ed0e450eebf8e906851a906882ece951', class: "tax-page__header" }, index.h("slot", { key: '28d88288414a7bdd0615d8d8d6b42d9d64179c3e', name: "heading" }, index.h("div", { key: '86fa7744e382c9c8301ea43aaafeffd97592386a', class: "tax-page__heading" }, index.h("h3", { key: '9f81106da13a51452e051713b90bf3b025828682', class: "page-title" }, this.label), this.description && index.h("p", { key: 'f30e861035df70594a5a73ab266e1efc25493913', class: "tax-page__subtitle" }, this.description))), index.h("slot", { key: '39fe7a13579f0861bc3fe46d61f326336a20e096', name: "page-header" })), index.h("slot", { key: '3550b90d40c8be6dacb144eded8469947c0d7b15' }))));
    }
};
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'e7cf3989fdd6aed4613c075828add359d16711a2', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, !this.hideDefaultAction && (index.h(index.Fragment, { key: '9201d5800bb5305806f5f63028a922f76a18d965' }, index.h("wa-tooltip", { key: '28499418a724e7f6b352caf44d5907d977e6521a', for: this._id }, "Print PDF"), index.h("ir-custom-button", { key: 'de2caf7ebfba0198a2ba713995608c7e838fefdc', id: this._id, size: "medium", slot: "header-actions", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'ea2c94e88df73f0d9bd25c440bb05e23cb826ea7', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() })))), index.h("slot", { key: 'f0cb77bd7caf1137c08ca18f05c9bac488ec9cac' })));
    }
};
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7af841059854c0223ac344fffab5722d6626bdeb' }, index.h("wa-spinner", { key: '7bb1105d65bf1d5b01641cc14facc50215f32ed4', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrToastAlert = class {
    ...
    render() {
        return (index.h("div", { key: 'f4a6b5bd9ee9f2a597afe6b57293ef6574314a0a', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, index.h("wa-callout", { key: '9fe28e6d9ba2b15686d5cf2d5f8acf1a5775eb2c', variant: this.calloutVariant }, this.getIcon(), index.h("div", { key: '8b2c92df360f869a7e2219c15a74830e3d9d87bc', class: "toast__body" }, this.label && index.h("h3", { key: '43252d0cefeffdda74be05d9ea48983b0d3bc79a', class: "toast__title" }, this.label), this.description && index.h("p", { key: 'a7f3556192deb205c2dd941dabc4c71d4df1185f', class: "toast__description" }, this.description)))));
    }
};
...
const IrToastProvider = class {
    ...
    render() {
        return (index.h("div", { key: '728cd536bb970709eb912a85d2a60ca15d83929e', ref: el => (this.popoverRef = el), popover: "manual", class: "toast-popover", onToggle: this.handlePopoverToggle }, index.h("div", { key: 'e66e47a15e8ba258b5980babbdceb3779bc75fa6', class: `toast-container ${this.getPositionClass()} ${this.rtl ? 'rtl' : ''}`, role: "region", "aria-label": "Notifications", "aria-live": "polite", dir: this.rtl ? 'rtl' : 'ltr' }, this.toasts.map(toast => (index.h("div", { class: "toast-item", key: toast.id }, index.h("ir-toast-alert", { toastId: toast.id, label: toast.title, description: toast.description, dismissible: toast.dismissible, actionLabel: toast.actionLabel, position: this.getAlertPosition(), variant: this.mapVariant(toast.type), leaving: toast.leaving, onIrToastDismiss: this.handleToastDismiss, onIrToastInteractionChange: this.handleInteractionChange })))))));
    }
};
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9fe82a0b8cefeaaed381ef3f769bd2fd1f4be6b3' }, index.h("slot", { key: 'a9ec10085cd7ad852ad497a4a2268beec2ee3916' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: '0505aee3f45f94ed806e96c2d833d12c8c84f5fb', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
...
//# sourceMappingURL=ir-air-date-picker_63.cjs.entry.js.map