...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '0aad8dc93088c8a3833d5a50a9c11261dcf6a87e', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '865bbb5fc7976bfbe0869cc97abdfd68d47a80db', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '21d365d003861841ca88d6da30528e249df82657', onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (this.isLoading) {
                    return;
            ...
            }, class: "px-1 mb-0", label: "Bulk Open / Stop Sale", displayContext: "sidebar" })), index.h("div", { key: '4cd4d70bf4d0aeb2a1f9c22b3f130fbd5b39ca61', class: "sheet-body px-1" }, index.h("div", { key: '7a48ab5d5f87a17451205a3c0479cb0a59e8569a', class: "text-muted text-left py-0 my-0" }, calendarData.calendar_data.is_vacation_rental ? (index.h("p", null, "Select the listings that you want to open or stop sale.")) : (index.h("p", null, "Select the unit(s) that you want to open or stop sale. ", index.h("span", { class: "text-warning" }, "This operation might require several minutes.")))), index.h("div", { key: 'dd9582d1e0ab88964b013d453677763b69c9a055' }, this.errors === 'rooms' && (index.h("p", { key: 'be21c147a312f2e13d99d4704427bf7e1b4d4e59', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, "Please select at least one ", calendarData.calendar_data.is_vacation_rental ? 'listing' : 'unit')), index.h("table", { key: '38cd5a7a9cd70749063e303057540933cdcb02b2', ref: el => (this.unitSections = el) }, index.h("thead", { key: 'e8b20bf5bb16e96248c989ee7bda1698ff6fff18' }, index.h("tr", { key: '2eb9a601bc77e091e2cfc280471d24e55b9e97ee' }, index.h("th", { key: '8805f06253aa76ac1f440e8fe05b3b92ad15fc2a', class: "sr-only" }, "choice"), index.h("th", { key: '0e15041190c781f51c480b4c8601ad09052c8e46', class: "sr-only" }, "room type"))), index.h("tbody", { key: '273898ad8a0780740d45f258f3077269773f9166' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '339824aae6ed456d7a8a7fce7c3df5f97c4bf8f8', class: "text-left mt-2 text-muted" }, "Select days to open or stop sale"), this.errors === 'weekdays' && index.h("p", { key: '2ff476a4548c3dfa65e68fae4a11f206d4f730e6', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("div", { key: 'c6344ae67d040e0fd99bc96556039224d2d3df58', ref: el => (this.weekdaysSections = el), class: "my-1 d-flex align-items-center", style: { gap: '1.5rem' } }, this.weekdays.map(w => (index.h("ir-checkbox", { checked: this.selectedWeekdays.has(w.value), onCheckChange: e => this.toggleWeekDays({ checked: e.detail, weekDay: w.value }), label: w.label, labelClass: "m-0 p-0", class: "days-checkbox" })))), index.h("p", { key: '7ce62c7d940be85928799e97c719a5a819c088f2', class: "text-left mt-2 text-muted" }, "Add date range(s) to open or stop sale"), index.h("table", { key: '8e0b27789bf6c5e5d73632ce495e437b8ce44c17', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'b8fc24f477f6e4189ca2f8513d3247308c089f0a' }, index.h("tr", { key: '2941fff690e3f18b744e204b0c1cb4b991b1711c' }, index.h("th", { key: 'b3cd47c95ef26f263973c8e921c207dab53a67fb', class: "text-left" }, "From"), index.h("th", { key: 'd97ec6899cfe5e079051e37f512a00a68eb582b0', class: "text-left" }, "to (inclusive)"), index.h("td", { key: 'bd567f1d93ea1105f9876dcd3dbb6c66f9819a0d' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '7f71fb72ddb1e17eebbcfaca04ef331e9e30f0d7', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '1d3eb1e7bc474d34b723b94a4bb0ee5a161ee405' }, this.dates.map((d, i) => {
            var _a, _b, _c, _d, _e, _f, _g;
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: 'd653dfbc9e5add81e77b4bee27ffb579aaae15a8', class: 'sheet-footer' }, index.h("ir-button", { key: '1aedab8b2ea6a29cf47d71b0bee17cabcdc28bf2', text: "Cancel", btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'bef6dbdb0576593b865a10cd14cddb729806b8ae', isLoading: this.isLoading, text: "Save", btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '94b8ff2ad868e2ce33e46022590e0603da707ec7' }, index.h("div", { key: '53bb1b0da28a0796573829eb67677ba4f528f05f', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '724f839ac055c4fd19e36552aa7081578adbcd4b', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '96c79d8051f61106da3da8a8c101d497a7899f49', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '0d525247cf46f0873454a5700712170a9c24de67', class: 'w-full' }, index.h("div", { key: '5bb234cd871afcd689149f5e72dd1fbb8c5bce5b', class: 'w-full' }, index.h("div", { key: '4ebbf92d46c85e1e0072df34c6de7aa8d4409fd8', class: "stickyHeader pt-1 " }, index.h("p", { key: '448fdc60f91d5f9870cd5d7a194b34bdea8f3bf9', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: 'b0c551f75ec3f3a462fb546a4038df99585fa23c', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '3d751b38fb8a0bb742a9c0a4d301b7163d3fb07f', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'fc40ed39b1f0434367487099f6440831021ecfc4', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '944b6d5c297d0123d3084377392cc8c8a5ff8c0d' })), index.h("div", { key: '0bdf3b642a4ec3e5d8489a0a3bc61a762a8fbd62', class: "mt-2 pl-1" }, index.h("table", { key: '3bad2be7b8679a1f0ace5119e9a42376420d98a1' }, this.legendData.map((legendInfo, i) => (index.h("tr", { key: `legend_${i}`, class: "legendRow " }, index.h("td", null, index.h("div", { class: `legend_${legendInfo.design}`, style: { backgroundColor: legendInfo.color } })), index.h("td", null, index.h("span", { class: "font-small-3" }, legendInfo.name))))), index.h("tr", { key: 'c97e58e3a6fb9b5b43bb26af09a3e8aa8c36cbfb', class: "legendRow" }, index.h("td", { key: 'cb805f90095875636dd572add86b2b6409ec50cf' }, index.h("div", { key: 'c35ab53a751177755e4722f1b62100dd52f7fa44', class: "legend_cell mr-2" })), index.h("td", { key: '231682f5ac6a0ca1c3061255bad13c4a9e9d8afb' }, index.h("span", { key: 'aae9a607d3cf78ee1d44ea298b3b212448abe85c', class: "font-small-3" }, "No availability or stop sale"))))), index.h("hr", { key: '4a0b6312cbccfcb371c324322c22ebfed39fff11' }), index.h("div", { key: '2730fe8a12414bb76eb9abeb9ef180a455292442', class: "mt-2" }, index.h("div", { key: 'a565d95e04f227308f37cceb873ee1095e8b2ae9', class: "legendCalendar" }, index.h("div", { key: 'cafa5a0179961327c1c32b73f6f2689a82a6e15c', class: "legendRow align-items-center" }, index.h("div", { key: 'a38d33e517555a38c617fee35deecbce3ac79613', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '5c9670104c339d0d950ff3f4f39c7244dc5b4167' }, "MAR 2022")), index.h("div", { key: '914aa37d9e6d9fbf544a1ddfd16237dec31873d5', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '56683d169cd5618b024e70d58ae65090d4142365', class: "legendRow" }, index.h("div", { key: '4a13338a3fe9697ae8a89e97fa600da1278e8b91', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'a91d73363ecfda71a14e31a6d4e19df5b857b0b6', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: 'ab41a007e7ba684dbf1f8a70fb8bb81f2d171808', class: "highphenLegend" }, index.h("div", { key: '80dffd0bf35cc24cbd843336e5d8768bdbabcb5a' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '6c93b94b89f57e28228f704e24e5cc06562c1621', class: "legendRow" }, index.h("div", { key: 'c7a20d730af9362f4f9941d5f7388f09e43b712b', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '3ce4047e47114bf9e9731301d83fb68db32ec7ea', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '933f7170b1758e60683b572c2fbf44368f940650', class: "legendRow" }, index.h("div", { key: 'ca08298ce5d9d16f0a8f8e7395863a3e66627ceb', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '0bd3588f196b47651285b47511c3583051591797', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'edf8a3a8cba698863b1c59b911f49c35acd39768', class: "legendRow" }, index.h("div", { key: 'eb077b44837a94a5ca6898784efe835cc7146974', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '3099575f593ec0b6c7a3628f9d09610cf0d5aafc', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a0757dcf33d9a63883f22e78d3b6fc2608addf4b' }, index.h("div", { key: 'ced3fdd6d64ea1df31630d37f2464a2e35c776ce', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: 'bcccaf3d4039ea42dcc16702cc4c59051009a6ef', class: `guestTitle ${this.highlightSection ? 'selectedOrder' : ''} pointer font-small-3`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, `Book# ${this.eventData.BOOKING_NUMBER} - ${this.eventData.NAME}`), index.h("div", { key: '494e0613fcd404fe09bc45b948720983d903dc98', class: "row m-0 p-0 actionsContainer" }, index.h("select", { key: '955c1cfd12133cb4d66abbdef189471485c956c3', class: "form-control input-sm room-select flex-grow-1", id: v4.v4(), onChange: evt => this.onSelectRoom(evt) }, index.h("option", { key: '9cbfa900545eacb52a8106f82267291d5a34ee9d', value: "", selected: this.selectedRoom == -1 }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (index.h("div", { class: "buttonsContainer bg-red" }, index.h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, index.h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, index.h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), index.h("div", { key: '6dd9c72a04dbc198fabd0f9bec96f0c7b6a69928', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, index.h("ir-button", { key: '094b5d079ed0aaee8c927ec834751655a2bd4528', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (index.h("ir-button", { key: '1f35e3461a7681999d110d5b3a44de0e3635e71b', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), index.h("hr", { key: '5f36eafdeaba60e91c63082218d1e24decdeb00c' }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '84c00fa056bf30a90daf6119ef20cc063d505eae' }, index.h("div", { key: 'e2ed1dcb320fd760576d8d1bc9846da08b05e81a', class: "sectionContainer" }, index.h("div", { key: 'e4cd994fdf3827f8142cce19049f2048f9e6e7d0', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '34d20a022857328930b2d1d00363f86fdc0591eb' }, index.h("div", { key: '09160e2a589cf7f50fbc0774b6065273e0bbf9c7', class: 'd-flex align-items-center ' }, index.h("label", { key: '15f21ce1fa56fb7c442cfc2f5c63f364e93f89d8', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '3b9fdb40243bbf2ccd80c11982ef78e9df72843d', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '91498e6fd15f23e89821c0cd3627cafb88f6f530', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'c72a1ee268c3ac774449a8e621622db68e6dddff', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'cc7d5d621f98fee791df3840137b88c9339d28ff', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '853c472b27602ef4005ffce627c9340b2146b6a1', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'e709ee32a75777bef7340ef03f24c9c0562eb21c', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'f5b643165cfee6c4f3d9c5f79aab1a15efcea7dd', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("form", { key: '8757a9b14433f8f0437db73943e852d0c6e9982e', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-title", { key: '2a9518b13d8384801128ceb034c9831f56f81197', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("div", { key: 'd764895b338320b9101057551bd3e987a26dc44d', class: "sheet-body px-1" }, index.h("ir-textarea", { key: 'e79b1d2c840fc0618bfff1989c71f949b9bce9a2', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), index.h("div", { key: 'd99a1651a32c28494810d713846458784560ef0a', class: 'sheet-footer' }, index.h("ir-button", { key: '4dd35b6b3966a83deb7e10bc94d2a46bced935ab', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '1600db9413faedb69d48ab1225f3ada127b19478', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        return (index.h("div", { key: '9523d8c1675a2389596138ed440451a196080668', class: "fluid-container px-1" }, index.h("div", { key: 'ddfb652636ab8aac0399d0a7b726ac434ec6d4e8', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: 'ee7c3481772f7a1c257ed389cfd51da00da8cf6e', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'b406a34b3f24c9aa63de856593adf3e3277ab153', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '1b1b7142e0913db5b31fc0c79e1a381f23edc36d', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'cf05f485695300b8e6c4f6cf9c7c19499acbe446', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'da4a089943fce4a6b9bbf5a845818cee22275715', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: '1b3cdeec1009745aa55fb6c13f0a4fd68f1dab13', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.status.code]}` }, this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'f33f728ba924d731b37ac1e0235fc9e65e7f264d', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: 'b5cf0d6b81598451327796f0c92d5ecf4f22eef5', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '67dbcebd4577a788bd68a95fc82efc81bb5d2dd8', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '94ea0be44d087e3c5463bf83e3c37d746a7c25ac', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '23b7f37e782ce5d11ef59d97838c9e49a72bc2a3', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '4a63f453c4ba5406b58f4f742dc482e366274f33', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '4e966b7e86d403923597c1283df17d117f7932bb', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '5625d9fbe587518cb9c2bd4922b030e290dc7ca7', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '6ba0926cdc0b158aafa40aae1cd616a3c6d6b662', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '5f683c8a59bdf01a8f50296d8908a4d4bd4ad92d', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: 'cf5de5f1ab3f7c8e2c5dc9d811c5f8d29c498420', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '71b358e38fbd9ecfa61ca36577b312e5fbf996e2', onOpenChange: e => {
                if (!e.detail) {
...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '874f856d55421481887afe0f55f082c5460fcf72' }, index.h("button", { key: 'b0454ad302d60bddf4b7c4c1765e85d64302dfbb', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '19e3cd1b0525fe9e1b55481b5c902364b127a484', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'f3c0916ff6accf9d1f3f24eca94135e80fd3714f', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: 'c925ba4840793e595f6dcbbcbde80a804876b1cc', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'e9b2bc81c3a778f401d50e6d3c0747dda1021254', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '6a78783c5b821a3f5c52c2afe2286d7a9d3de588', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: '40fc8d985f6c8fb795822e83dd2db6fce10965b8', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
    static get watchers() { return {
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '718fe572c1ea0234fb1fe76d3fb66042d3c9bd06' }, index.h("slot", { key: 'e1743f9ab6a108cb2ab635027c9ea0286accb8b0' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '2389643a5ecdaa9e4ef3f9de2acfbb1754afc434', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '10776555f2ae78334f52d881856144877d914f63', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: 'b8cf761f8e9c61e1c0a1b6f0c4898f52e4e314b1', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '0d09be62679b9533d82c1ab67f6f75219306aac1' }, index.h("button", { key: 'dca03dacb159c44ffab72336541bc97e8851f5f5', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '22c09878f572c74919b5fab3ebf6476a98b0e9c9', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '47d5bf334f13e1aedbc5fe66756311c45b94884b', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '9f644a9af814dd41d1c60f847b47b3b5d8c5b25c', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: 'b084ef6454eb478a110f6f416e648d7bbb23ab01', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '7697e5bcd6477d3829bd3de5cf6964965f9bbe68', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: 'd829c0fc741fbafa064c67c71105697ae2aa5615', name: "trigger" }), index.h("input", { key: 'af455f57ff002a0eaa1904125793a0c91e3dff55', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '27527b0ca0789ffd843ba2475fe90bd83ab666dc' }, index.h("input", { key: '0a2a5435eda35b1be68387fb35ea63916c7d8274', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8c51764440d7408bef1f286709b673089bcc4f6d', class: "d-flex align-items-center" }, index.h("span", { key: '8dc9e2a54cd180859e10e49b8f3f0efa398c1185' }, this.dates.from_date), ' ', index.h("svg", { key: '455fc71a83aa44e0e7b4aedeb989976213645b47', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '4a090d2d790f8d65e170ec3f28d608117d3d3faa', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '9a6971a18d0a6661b1f47bbb49c2ed0eb20e4bcb' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'a30ade344374ed4f166381dbaded2723698d280d', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd2477aa7d5ca80516986f632ba2f91535f6fa462' }, index.h("div", { key: 'dffb710f72d6450e5b083974a87e778ed70afff7', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '70e415d66013bb00089ae13f301c4816e4c644bd', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'd56b99d1be35339136f93ba378cd242c12e75e6f', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '319b27ad2fe96991074a5c2084af4b536d3fc4dd', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'd002ed5f70486b4f648cf8fdd734b8f24361b441', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '6fc81d6ef4412000f2188104e86559828936b410', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'c1ab5f1d5e60664f30d859c407662574ddc4f40b', name: "modal-title" })), index.h("div", { key: 'de84b92041799f926ab2ac2a5f1f3c0fb209043a', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'a2af33157f1ad2f92e651825a4b5b7423e9192fd', name: "modal-body" })), index.h("div", { key: 'b60c655bf813c19eb514149d1729d8225314ee27', class: "modal-footer" }, index.h("slot", { key: '7d878aa4798940cdf90160de2a334e662cb68127', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9a8210e3a1c5a2655c8621e102ba9aed7fffb17e' }, index.h("div", { key: '2a59543355678f6e6e18f7fa04dd622b31a0a0c6', class: "p-1" }, index.h("div", { key: '894402cbf30b695f13cd5d6af2680e70c57f9f26', class: 'extra-service-container' }, index.h("p", { key: '45f21a8b2deec696a6519303afa4bfc01fa6438f', class: "extra-service-description" }, this.service.description), index.h("div", { key: '34af66f16862d976d1e73cf45cd879b08dec421a', class: "extra-service-actions" }, this.service.price && index.h("p", { key: 'ed504254136f7aa84fbb5f7bfb82fe2e40020f16', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price)), index.h("ir-button", { key: '68b378bbe6aceb32a5844c54b7bad5fb27648f68', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: '8b4dc9fa04c5820ed83a46717548779429d4dfbf', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: colorVariants.danger }))), index.h("div", { key: 'f089b275de5526c6c289286dc88bbb2d5fa44c64', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: 'ffeb9455260d980e519a0caf46dbd00e1fc3da9d', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'aba31aedceb2d79084344519e17995ab3c2c533b', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '498828bfef2753327b2214b0d9e233534d5d000b', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: 'c6bacf0edc9f065384fecb665019d9467d6e60db', class: 'px-1 sheet-body' }, index.h("fieldset", { key: '791456dacc4c81fa2a4580ea2f5f082b850a24d5', class: "input-group mb-1 service-description" }, index.h("div", { key: '58c3aef935754b898b6de3bdecc13baf521919bf', class: "input-group-prepend" }, index.h("span", { key: '1ff1b4315221a9e709b1acd6cd52be75dcd0f78e', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '7926c2b6f0c12e98001b005b80636da4aaf3d917', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '6a219311c620d2deac6fe6d22d4b8f50a3debe28', class: 'row-group mb-1' }, index.h("div", { key: '80185c56d870f3a49906c08b67cc84f21ed80a11', class: "input-group" }, index.h("div", { key: '3412fc8384fb6bfcc54f9a8010ca57b24177054d', class: "input-group-prepend" }, index.h("span", { key: 'c35cacc3c6ae00bf8e0a0591243dbe6d35181e72', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '2ec30db465ed566bba4c994af387fddc20fa8edb',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: 'b9d8cdf437a1f55cc7c94466715e6af4a56bb72a', class: "service-date-container" }, index.h("ir-date-picker", { key: 'fced377ee9c9aa5b59644f4a00213c4c4226a102',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: 'ebb28e12e359f5d6a710c5f8be4dfede6dafbbf9',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: '090976c5ef5b6c28caee7c5ed785b66bf90fe0ef', class: "btn-container" }, index.h("ir-button", { key: '0d25a27741e73e02050987aa628e2834bdadc5e5', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '47ff7288604e4276b13efd5f404505b9f95c9aee', class: "input-group" }, index.h("div", { key: '46abc23eab46f38a2e12a7d26546158f82a7f290', class: "input-group-prepend " }, index.h("span", { key: '71d7b6b22694205171e6c71a441c0aeca4c6ddf8', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'bcdb4a9a99ff120c4a9cc4d889d678bf4f79fe1e',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: 'b641f97857c1a1dfa3f1646477fc7d8c74ff7cd5', class: "service-date-container" }, index.h("ir-date-picker", { key: '6afcd4bcbe317760eb224b31ee8514771570cffc',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: '8788648b99ad06ad9ee14dde247faf226f4b6c68',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '20b173f3d042f9fbbdc2bae2a79495574ed0e10d', class: "btn-container" }, index.h("ir-button", { key: '46ae96f90bae97c7b79af727ef15e1b3b3a392af', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '5929ccc6846a9bd440abdf565b9cef3df38d8b73', class: 'row-group' }, index.h("ir-price-input", { key: '5e776e8636bc439bd63a3db37e96474d1d7b2fea', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '8a0385f2273c4630dfdd8a4f113af814a1d1a991', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: 'acf5918b5657df8db7a0760d2a73fe036cb52f82', class: 'sheet-footer' }, index.h("ir-button", { key: 'ad8e3d7f1b6488dcf242366a268607185f04a213', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '67e0b30d95ee0001122c2dea78e9a25c9ed5e89f', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', icon: "", btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'e53441914e6951c26dd69d9f59a2274c3db2a6a3', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'e8c263191dc7bbb0555b7ef8bf3223a8d64ea086', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '9377c8fb6d26c40ddd0662a851d1c85da89b512e', name: "icon" })));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3fa74addb5fb20350c5980bdb11614ce8c5c3ccc', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'b7dc6a02fc3eec61b403a7139d18798f8616a3a7', class: "popover-title", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, index.h("span", { key: 'daad9a3ca50fe7f05f2940dbf3cc414fa4350568', ref: el => (this.croppedTitleEl = el), class: "croppedTitle" }, this.croppedTitle), this.hkStatus && (index.h("div", { key: 'f6ede4eb9a41673c7392a792cce70378b686bed2', title: "This unit is dirty", class: `hk-dot` }, index.h("svg", { key: 'a032b09b5ae6e14809d5232be2aa2577b2e77a6a', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512" }, index.h("path", { key: 'e3ff9719975341c90b54f96f63effd144d3c6a3e', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
    get el() { return index.getElement(this); }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '22d73d4dfd54fc9ac48f25157d737beb4ca21e45' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'f5125c7bbdf59fac647c911d34c04fccd6480e8d', class: "loadingScreenContainer" }, index.h("div", { key: 'b96b5505633c52f1458ed51077bb0b01a4fedfe0', class: "loaderContainer" }, index.h("span", { key: '987471bf21d2f63db21e88815dff256be31a3a00', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '97350120d67068608b617693ddce9ab11e90896a', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b82c459839abebdcd722bf92d8719b919db465ec' }, index.h("span", { key: '47908c061cf99c28918a21cd2147274b28ad4075', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'a433e530ac17b56df55e93e6bfe82e434eb61ca9', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '2ed314b1a5b02a052c1cb66a11f504a40257e9b1', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'bbf87ab50d16fd2cf9ff4463ce7c81442d306b37', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '70eddcd5a09e53160fa3da2ef04ea4d2a9984c1e', class: `ir-alert-header` }, index.h("p", { key: '9a6e4305cb292f6c1dd6be6187511b4a9479dd9c' }, this.modalTitle))), index.h("div", { key: '4e7f55d012a565b2f3771c7079268dba503cab15', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '57205af8645831be70a1db574f0dda8b71f70dc9' }, this.modalBody)), index.h("div", { key: '4650105dcb7c313dd0a9baa2c8b7d9faffa36019', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: '706ddc120406c624102414e7501a6f7acb4cb443', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '56638b015af1548b1e28b53ca114c96542fe31e6', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '72fded0c2e6098b0c5582ea4b0db3855a3e1740a', class: "otp-input-container" }, index.h("div", { key: '4cc31d0d7b6b1495d4ddd90f14fa9c5f3249e4bd', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '730ca84244bfe3e3c3d031b79f5587abd3f3e36f' }, index.h("div", { key: '530d7c731c89780356dc6b86362c1a181ca0f88a', class: "form-group mr-0" }, index.h("div", { key: 'fce85c4901c0bd6b7f03c9bcffe292fff18aa950', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '4ade54e3b2e3f1a158cb7a9feb606974f175fefe', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '086642697cc0582a663fa06a2d9f3c7bd851cd86', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '7131652b58cac839e3b6292e58317b101cbfd6b4', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: 'd5a29449019adbfb672b22b45c53d8a1789192c1', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '8fe77381684561e88a8b516994e6fe666ccdeccf', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '5e7b664668d8739b53507d067babaf66f0b6f3c3', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'e7856848a5ba4ca43b25d9a16f7fb4722d1b38dd', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: 'e0c7d2abcec3d5bc046118e712376ef610979472', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: '2dd42d8460865aa90b38e2cbeb8a751c12e06a8a', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '055d3d9222a1e3947b530e09892cf79b846da72b', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: 'aea66175644c32c7fda3a4447f08fbefc9a68e5c', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: 'a49dd4840935d61909434e7ec5b99672e49b46a6', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: 'f996a231b1ccc8368d499a49cf74dffdd231ba05', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '53cbacf1b70bf18ff66bf3d9d4f4bb15390fb5f0', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '59b7332f78001a375f7e23b1165cea8d59fc1d8f', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '81e3aeaae1b02a008ab7d699f3a6decdec09f20d', class: 'd-flex' }, index.h("div", { key: 'e5da712babcb507ec396dcd0c8e786171ed99aa7', class: "form-group  mr-1" }, index.h("div", { key: '10f7c451cb5c866228c9dfeee91adfd822e0807b', class: "input-group row m-0" }, index.h("div", { key: '02fff78d481a8e5d2925c5a461ef634291c2578a', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'c896249fdd390759ca15de341c50ecc1eefa0f44', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'd84399da1433e5662b82acd94d37fd712c775f92', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: 'bb28fcc895e1655fa27d4163ec019e73730686e2', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '072528e49015045533397c6c0ec2629066d0385b', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '4f31fca953ab04916cb749f9a2eba80b62a433f3', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: 'b281d4cd74ad07b27276bf73806ac26aeba36009', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '4d521cac4b982d0d8ab02e6e3500e640fa353d64', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'd025393da7529032f0aadeee3c2bf3c0e9024e2c', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '804b6aefc57ddb6351e65166a84c11e631dd71c9', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '6e905540c7385ef3fd9ef163eed3b41c2c96ac60', class: "price-input-container" }, index.h("ir-price-input", { key: 'b2b89b0efba9662e618232ecb395c4ca8cfd9bd9', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: 'bb643c03754de0caf7b65401d1e992aa1a5dbc72', class: 'sheet-footer' }, index.h("ir-button", { key: '255efdf9878fb60d80a12c37fc504cb9d2201864', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, icon: "", text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'adc8a01e2b9abb38ce400ab3bfef5d1c9367f75e', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', icon: "", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f68765af87a171f6992c3fe620f80a6f16fc9f87', class: "card" }, index.h("div", { key: 'ded165d505934598c6dcbd7c847cecdd4c313b3d', class: "p-1" }, index.h("p", { key: '32340dd9c58ea77ec0951643e05df9933cf553ed' }, this.booking.property.name || ''), index.h("ir-label", { key: '85d40372a26d3297317a8bcf8943a0e7e7786c79', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '1f88750cf674a1179988fcc06cef145471da7434', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '4f741d1a88b1033d235b2df9e1ff2cc99e5d82f7', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '91f5f5715acdc67c4238c6783f39574fd0681750', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'df2eedfc3693ebf85d0709c6535fc18830b45909', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '95d9d5515c30174e77b9e88dfd407a36703a2abb', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '4687e5f446edb494a606e3019d9c66a4146690f7', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '78e21b902248817b0c8b67d6a1952617adc27226', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '873a59d79934913a6513a46f136b51ac490b77a4', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '19b99972d69f0a99de49a67e6b6336fb3c3feaab', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '2ffb0aa9ff1f6531d5c28d53fd4381562cac0eae', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'c0ab3284cf00cc38ac1aee1c82ebdaf70cb843c0', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '26e8ff4564b31196ac1974a0a1b59f74990a601f', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'db07a6830cd1aa86a7ff19e517ba04a190f76a84', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '76d3d34f000aa42bbd8349b627062a86e95e56ed', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: 'e5b973bc712100f2e2c64da70f48c62dffa754f2', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '02edfead1cc7a94cd8273e0ed30d4a4883635af6', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'f47f4b038cfcdafaf4a92626c8621cdda10aa032', class: "d-flex align-items-center" }, index.h("svg", { key: 'c96732962a27d5075f9170db3a1800494e118b75', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '9ed31b5b2f5c385fd550c8f7a578170e8edade54', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'fba0589722f0c9453b283c8ee24b1a1666203aa4', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '72483e54851768f8e3ccb0565aefe430c4d26b7a', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '89ab8cad7611eb98fe9b38b78db0222de0ddb418', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '954744e8ecb7611f49445328f50cc53c4750f1cc', variant: "icon", icon_name: "edit", style: colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
const IrRoom = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4867a3da95d70868003d7a1326928d427e46013b', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '1d52e3a481db85b3bb52cf2e405fa1c08b2c883c', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '1489051aa96d78dec9f93a4e129cbe2f310c4486', class: "flex-fill m-0 " }, index.h("div", { key: '6930913d3df8cc324ae108e499b6f12c7c279ebb', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '840fcfd24c8b6c0f115cce9075dd82488985db1d', class: "m-0 p-0" }, index.h("span", { key: '797a6b03e323c95e147d9653178abdc8440dcf22', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.item.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '6276020b5f540551eed799edd7c66dd9734e2923', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '14dfae6b8624959bab328b85d92c59a1af05dc07', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '07af744b6cabf2ff71b1efd29649335754768c89', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'bf9df57b8a0426b8b7e1423e1e00114d9ba810d5', variant: "icon", onClickHandler: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: colorVariants.danger })))), index.h("div", { key: '71ac8854adf81a0f7dd26272a2881df1acb40662', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '8b2469618aea84b666247b7a9321db727d552654', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: '4774400a3a06b29c4ee4681108b55380fd832a12', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: 'dd50ccbc0e944d48596220ebb947d16b29890332', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !calendarData.isSingleUnit(this.item.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("div", { key: 'a0f3a362478a61b3f7256338202b1191caee50e4', class: 'd-flex justify-content-end' }, index.h("span", { key: '2169bb78de93a6e8077180d05b60e165ac81ca69', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: 'c662fc19b4a3e2892a074ec7add322fc4604e464', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: 'a1a2203bcc05106c4932c0c7c126925541e10679' }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", { key: 'd80bcf03e2296eb48a31ad4ee7685b1f4f07aa1c', innerHTML: this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy) }, " "), bed && index.h("span", { key: '825070d0af4234aa8f045537772e51efe4f2284d' }, "(", bed, ")")), index.h("div", { key: '8a68b6e4c0c2c83cf6f43f23da5c47988980a467', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '784a1413a7aa41401cf3cc6f9742eacab6d0e8d8', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '255dcfa36b6274f737c5740df925498081bbd55d', class: " sm-padding-top" }, index.h("p", { key: '0365b3eb9efefb4ac5fcc17152a42f6cddd77659', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '7db5f3b95388ce684ddc019081902824abf7ca05', class: 'flex-fill' }, index.h("table", { key: 'b2c36c57651f0702f23c5ad02dd83541fc1ca638' }, this.item.days.length > 0 &&
            ...
            }), index.h("tr", { key: '82dcad1f2f506bc25608780819c9020778102604', class: '' }, index.h("th", { key: '8552a029f76fadc55ed6bf0791df7dd2f9153ede', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '9f93cabbb9ffc0d9d00e4f9a3087e789a24c9a51', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && index.h("th", { key: '338ac69931b3b1dfd2b178170a3b2442f3dfe9ca', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.item.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '613de84441476b8b9632646b94088ef8b2751b13', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '2997b36f90d39b352ce23dfc97a980ac97a55e5b' }, this.item.rateplan.cancelation && (index.h("ir-label", { key: '9fe731d970c16e001b8b3de50ea5eb5ac58dafbe', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.item.rateplan.cancelation || '', renderContentAsHtml: true })), this.item.rateplan.guarantee && (index.h("ir-label", { key: 'a0c1de9747fb274989831bf08c67981d15528745', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.item.rateplan.guarantee || '', renderContentAsHtml: true })))), this.item.ota_meta && (index.h("div", { key: '3da7fe9f1751265af9552f4baed084ec48178f93' }, index.h("ir-label", { key: '762e30e7325ad3f6ade430000e26121a39848153', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.item.ota_meta.meal_plan }), index.h("ir-label", { key: '9ace0bac373a8556cdfd38e1cf1bf50eb1788069', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.item.ota_meta.policies }))))), index.h("ir-modal", { key: '3e9435357061d692487c9a2cd34c04ec3f85d246', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: 'b12db83d6b782498a7acb3afae7f1d485ac907b6', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'bf578a5a1600622840b6f275d671a25ef6e89767', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: 'c9eaea3f21c3333f562bbe564d636b3c686974f2', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'a0cc8c4ceac4eada7b8a2ee6573bcd80a452b900', class: "input-group row m-0" }, label, index.h("select", { key: '1882a8c49bf03cb19615a20d723d3eb1b136aaf1', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '620ab678d8f2a4d36e0458d9854deb980319cc7c', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'd40eb811de3cc89b2e7af46c8e32115f67800e14', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: 'fd219536fadf832a4567e7888a7a52dc5feb0b11', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '60cf8349e4f86c5dbeceb862e214c5b6459083cb', class: 'sidebar-title' }, index.h("p", { key: 'af7838b785452ce7984d24f78422a4168af17484', class: 'p-0 m-0' }, this.label), index.h("div", { key: '6552a3a4e1fa805a4dc7a5d35e80224b47074acc', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'f779e4cde0ad9079bef5c2fe9c0b5cca3674a492', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '13c7f59c138f2f085f652c07dba8a59d9577578d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '02ddc872844e55810129731772a08e44070afcfc', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '7228de06f27791cba8cf4462fb01173795f7ca0b', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '96a9a1df3be0ca01e733c058631737b3df103c5a' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '597754d08aeaac9355967dbcb9dc3822ad874dae' }, index.h("h4", { key: 'cd510ffd22c404b36f397891c5a363cb49035753', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '444105de76a6ca93496a7480499591d569dfed67', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '84b6bf6049ead0a0a938d0ef7388522f7948e96a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'b45a1e48a70cf63247a871d2a7bfb11f96cbcbf0', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '72e81b3b9b25e706e74129fb354265844f1926a2', class: 'title-body' }, index.h("slot", { key: 'fcaab260e756b9717dfc7927f552962774ca8083', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'cf5f34afbd64d375906ff1b4da2b41e1f3614cd5' });
    }
    get element() { return index.getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f29e5e13d1bd152cae8c8e86c82fae36c3d1d532', class: "m-0 p-0" }, index.h("span", { key: '214dd6c2a4475218738b42e3c81ff4fb42db35d4', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '156348958ccfdb09614f2f97437c565b28a6996b', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'b97eb547e06d84b7ab159dc42eb97a9dad401ea5', class: "tooltip-arrow" }), index.h("div", { key: 'abf15d6689c1a2c49731350c34e7f6cd215d2bf6', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '5bdbd176ba5c019df3300ccdfbfd009f5ff14477', innerHTML: this.message }))))));
    }
};
