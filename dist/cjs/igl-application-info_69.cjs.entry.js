...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a9582b4757fb37f6f08ba41fe00fc867161ac48d' }, index.h("div", { key: '3622e3dade5eb123dcb68c331b0ac25a3e9d3560', class: 'd-flex align-items-center ' }, index.h("label", { key: '435e335f71ca92b6c8abf450de6366493f8490aa', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '1fa0a26017eb0bef5c87ba24bbb71ada939331ae', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '2da443d4a7dba643f99c5947ab1913c143451a7d', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '4f4db244697f7128b996a3e920932c29a1ebf97c', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '3040e9ac03beef6c29608b7b9e94ac5529a5eda0', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'dd31a3b3201c5186f61da9125444d30d48d41e53', class: 'sr-only' }, "clear input"), index.h("svg", { key: '36a1bae12a2dd1f5b5f5ac685a7920dd1c696805', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '7d08d97ba9bfa3fc254436345ff452609aa88805', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingDetails = class {
    ...
    renderSidebarContent() {
        ...
        switch (this.sidebarState) {
            ...
            case 'payment-folio':
                return (index.h("ir-payment-folio", { bookingNumber: this.booking.booking_nbr, paymentTypes: this.paymentTypes, slot: "sidebar-body", payment: this.sidebarPayload.payment, mode: this.sidebarPayload.mode, onCloseModal: handleClose }));
            default:
                return null;
        }
    }
...
function initializeUserSelection() {
    ...
    booking_listing.userSelection = Object.assign(Object.assign({}, booking_listing.userSelection), { channel: '', booking_status: booking_listing.statuses[0].code, filter_type: booking_listing.types[0].id, book_nbr: '', name: '', from: utils.hooks().add(-7, 'days').format('YYYY-MM-DD'), to: utils.hooks().format('YYYY-MM-DD'), start_row: 0, end_row: booking_listing.rowCount, balance_filter: booking_listing.balance_filter[0].value });
}
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ed43117ba979063b0bcfbe62b0fbbb0d76731f45' }, index.h("slot", { key: '72d043bd3b1cc56bfc65ce4389a0c97912f6e8ca' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '130ef3307e7211e16134e88938e1fe85d5a05b54', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '5d88a35f1b4620a1e853d374fff86f2319cf258f', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: '53d7b639a1e8ee004450f9c22450d68ae8936b9a', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '0553b70bf9923bcf2a420dc28c306668cd13ef09' }, index.h("button", { key: 'd94687496218233030fd6ad21af73e192c1771f9', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '7d1488a887c489a201ed2e68083abaa5ccc53903', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: 'a59415d09cd1ac07cf5701f555f83af4d85189d7', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '2073a59d17d3138dafca0f8388ed0e1eaaea38ef', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '73240dbbb640a4025639d8c7922e0fa53e933f51', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'a82f42de74fd3a8fce896e5dd17c7b7abc96374f', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '94c98cd3319df926dd782e83cc342d6633b45c38', name: "trigger" }), index.h("input", { key: 'cdabebcccee1a24af5480376328bc14667283c77', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f1c5849d33dc5d9dba2bcbd9ba50019c5a8197c2' }, index.h("input", { key: 'fd9b88cff13a474656ce41680d9db3910ed8f71f', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '04f6d6865a70137124110a9fe5f51ed285c455e1', class: "d-flex align-items-center" }, index.h("span", { key: 'f0999d7a8059236a31eb2222985f53abaa9cb121' }, this.dates.from_date), ' ', index.h("svg", { key: 'f3c7253630e43e8f8b32c403cc4f5038cf2048e8', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '486a0c4ee2bb17f96f63a4697fa327b7d2a126db', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'ecfe95ce537ba4fe97a2b2718526650a84d13582' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'af7bacac9347c3085a5e99319d1ea451f84f99e9', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9900c913e4258481663af5d2071bb769dbc0beb3' }, index.h("div", { key: 'c0e907e6d69872846e211f655d543b04931b7896', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '696cf79e95e661668ec3b7240dd5b74423e2dac4', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'd7754e4a62d9ec02e36d855c8d9320b1ed977e73', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'badc067faf56f4a909d42eb26cadeba514d7f509', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '8cca44580a771a8110f6ebbe41d360cc60f69c57', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '1327fb017e71e9fdd9eef713955e75f7f5022d6c', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'e0a4da5ed873a630ae92b839093cea67d17a311a', name: "modal-title" })), index.h("div", { key: 'bdcce5b3a3a15b98fe903a5a5c41bfdaf72f9485', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '52a38edf626c63fd95980a0212bd3eba417d3620', name: "modal-body" })), index.h("div", { key: '47e32aa98488719273630373295070f92d2c70d5', class: "modal-footer" }, index.h("slot", { key: 'bab559ea3b8228496998a6cae0d810db6c80c32f', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ddc4e49651187296a424b2762cb357ca3a37595b', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'b3092d8d851ae0fad69d233b1c8e8576def61cab', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '1e8b834d03b5fec4872e7b8aed82ce0683efcd35', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5bf0884e0f9ff6a6e76dfad47e294f0fa6f2e838' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '183a74bf81b44fea8fb24980694370af900ca8bf', class: "loadingScreenContainer" }, index.h("div", { key: '8a80d758bb93beac0c635d19bf730e6f678e066a', class: "loaderContainer" }, index.h("span", { key: '734f0626780453b0e20e9fd88ca488fb7a1c4da6', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '4ca1073a1d77da3a6019b5503fb0359e9834968b', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '91f863aa605a1ee6547d96fd84899e3ca92eb023' }, index.h("section", { key: '2d67116ecaa163026803a6dc6dacaf6fc1d1116f', class: "d-flex align-items-center " }, index.h("div", { key: '9e4cc66c4af95a96b982bb2bc6baed2b860d041d', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'b3434cabdda8655561e121ae4bac0988af0922ea', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '20191d3c900c534f50f53cb5f464d9f31154414d', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '5bae0cdc9ee78e0b82f01b80e547488c59ff2a91' }, index.h("igl-book-property-container", { key: '1353a55b90060e46f8b0d7675c4c417a4a010ada', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '92064a9597aa47fece96c9fd0cf80347d8e0530a', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '2a4719fa3ae08a3c17837feea933363f7a03c702', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '3c92e994fc83423aa0aed21f4e0c46366b7678d3', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: 'a2e587fcb2fba86bf62a745b6d53aa5249c13d2d', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '36e18f4811e30adca1ef908db425032e632a497e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'cfe6eb298e7703bf5ce696d894160139eb0222bb', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: 'c5254e19b4110f6a4ccf6ebe2ffedda4d33156ed', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: 'ba12621eb3a3a06e47008ce77c24e2dbdf775cf6', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: '27ebf22f1e1fd829b73d921bf9545a6c65a5bb81', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '4ac691d0cdfabae35c26279dcea3f1a5ea97f153', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: '5ac909fc1536eda7492a0d5f7be6c03da4d5cdce', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '63dea36a7431873146e69dc8ee0cb0e91ae790ca' }), index.h("h5", { key: '75eab6f9065e7ae98f319d1e6437f50b4737583e', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '530548fc007560d0c303a62f57dc0d52835523b5' })), index.h("section", { key: '7cad6160cb4f086a6e32a26a52abd52b16b0ba5e', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: 'a6660b709e3360ec91e0c420d4105b8cc1d2dad1', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.filter_type, selectId: "dateTo" }), index.h("ir-range-picker", { key: '90ae0846bc9b6967150fed8f4c66202198f16a00', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { fromDate, toDate } = e.detail;
                let to_date = toDate.format('YYYY-MM-DD');
                if (toDate.isSame(utils.hooks(booking_listing.userSelection.to, 'YYYY-MM-DD'), 'days') ||
                    toDate.isBefore(utils.hooks(booking_listing.userSelection.from, 'YYYY-MM-DD'), 'days')) {
            ...
            }, allowNullDates: false, fromDate: utils.hooks(booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: utils.hooks(booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("ir-select", { key: '54b16df9293b168ddf5998aa303032899dc2b153', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), selectId: "booking_status" }), index.h("ir-select", { key: 'ab9e06fdf12d5a3f63ed312ddf980462d691142b', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), selectId: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("ir-select", { key: 'd522a071bff2e1a0237e26ff588919452823a4fd', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.balance_filter, onSelectChange: e => updateUserSelection('balance_filter', e.detail), data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.balance_filter.map(b => ({
                value: b.value,
                text: b.name,
            })), showFirstOption: false, selectId: "balance_filter" }), index.h("div", { key: 'a965e7ad6a92247e497df80e50e3b478a49ca225', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: 'dbbf0c712a5851e43ee1118f21baf511e0793ea0', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: 'b4bbfd4adf12d39450e54d766cfe3b5d74f3914d', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: 'cb25cd518f1f80b11c7519aab909d557cf12ffca', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5296c5ce6ed5ea0b0f1642a8c57842f35e3db1d3' }, index.h("span", { key: 'e4ce12766dbbb9247d20ec861aefcb156006ba08', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '350087b8ad585e87eaaf6cbacbf4c7181dba7513', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'f715af9c50c6233a6a584619ef9ed5cbcc951c4c', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '86822b60ee02c95fcaab62247fc019d8bddedf2d', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '0079ae168b5c8134b47602dfd3eba6ec0e1944b1', class: `ir-alert-header` }, index.h("p", { key: 'b9a9d46eee6c46dd2b94a06649756b8199511f34' }, this.modalTitle))), index.h("div", { key: '43433c82c19e25d21053016df4664457b2ba7bfa', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '499fa1db6d8144c39117d94dd0d35b95a79f4bb2' }, this.modalBody)), index.h("div", { key: '8b461c61fb2ec1b2865107cac1ca3aaaca842f28', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '83e16ebe742777cf8e78fe2e1cf0427a2106785d', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '5092192a7a7ae3c6e5d46fe26e1d2632025fd59b', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'bdd8a6bb122b31a1bbad4ea86cc42aecd21b517e', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c4a8db3e9e7b71b95d7bd660b1ca9ab17ac2227e', class: "otp-input-container" }, index.h("div", { key: '5347ce2ec8421b094d80b8f10cc9fc19e1cccbbb', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentAction = class {
    ...
    render() {
        return (index.h("div", { key: 'fd203b12f5d252e1894c282904bd209f87ed822d', class: `action-container ${this.paymentAction.type.toLowerCase()}` }, index.h("div", { key: 'e685660195cf0de71c5876bfd570dc8dd26a23bd', class: 'action-row' }, this.paymentAction.type.toLowerCase() === 'overdue' && this.paymentAction.amount > 0 && (index.h("div", { key: '2f4196a5de47856fed705351253c58cc7649c23a', class: 'overdue_action' }, index.h("svg", { key: '446858022dfcaf0b4773f7e13ffe232d3ca3b008', height: 16, width: 16, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, index.h("path", { key: '3f3bb4e03be58e75ce6db802ed1b98cb4638f5f8', fill: "currentColor", d: "M256 32c14.2 0 27.3 7.5 34.5 19.8l216 368c7.3 12.4 7.3 27.7 .2 40.1S486.3 480 472 480L40 480c-14.3 0-27.6-7.7-34.7-20.1s-7-27.8 .2-40.1l216-368C228.7 39.5 241.8 32 256 32zm0 128c-13.3 0-24 10.7-24 24l0 112c0 13.3 10.7 24 24 24s24-10.7 24-24l0-112c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), index.h("span", { key: 'cdeab32ddf22d0b1319629c06a51e76f55419106', class: "alert-message" }, "Overdue"))), this.paymentAction.type.toLowerCase() === 'future' && this.paymentAction.amount > 0 && (index.h("div", { key: '6e0d7e107ad408af5baebdc47874c3b8a89b5c0f', class: 'future_action ' }, index.h("svg", { key: '0ac2881334260e7cd17528d2142cd112730c33c6', xmlns: "http://www.w3.org/2000/svg", height: 16, width: 16, viewBox: "0 0 512 512" }, index.h("path", { key: 'fc0203b1defeeee8bbaa82b8147049789caf7f7b', fill: "currentColor", d: "M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" })), index.h("span", { key: '84bdb35eebdd5bd8bdf40900e2e5bbd09e3be9df', class: "alert-message" }, utils.hooks(new Date(this.paymentAction.due_on)).isSame(new Date()) ? 'Today' : 'Future'))), index.h("div", { key: '6def694a4cd0612062f0f2370a1bac19e9a7197e', class: "meta-grid" }, index.h("div", { key: 'ea5ec48db1aa3dd2d09a0a6055b977a09fd39f0d', class: "payment-meta" }, index.h("p", { key: '024c07c207b4dcacaf1b51fccbedd2eb7f3bf020', class: "amount_action" }, utils.formatAmount(this.paymentAction.currency.symbol, this.paymentAction.amount)), index.h("p", { key: 'afb9c254462d5d2d64976ef8f4b73e5bdac0e970', class: "date_action" }, utils.hooks(new Date(this.paymentAction.due_on)).format('ddd, MMM DD YYYY'))))), this.paymentAction.amount > 0 && (index.h("div", { key: '7fc00428e0d53983c1aee7465acabdb973703614', style: { width: 'fit-content' } }, index.h("ir-button", { key: '37fef75a0bf165322ccd24b6824540c53bfb9460', btn_color: "dark", text: 'Pay', size: "sm", onClickHandler: () => this.generatePayment.emit(this.paymentAction) })))));
    }
};
...
const IrPaymentDetails = class {
    ...
    render() {
        ...
        return [
            index.h("div", { class: "card p-1" }, index.h("ir-payment-summary", { totalCost: financial.gross_cost, balance: financial.due_amount, collected: this.bookingDetails.financial.collected, currency: currency }), index.h("ir-booking-guarantee", { booking: this.bookingDetails, bookingService: this.bookingService }), this.shouldShowPaymentActions() && index.h("ir-payment-actions", { paymentAction: this.paymentActions, booking: this.bookingDetails })),
            index.h("ir-payments-folio", { paymentTypes: this.paymentTypes, payments: financial.payments || [], onAddPayment: this.handleAddPayment, onEditPayment: e => this.handleEditPayment(e.detail), onDeletePayment: e => this.handleDeletePayment(e.detail) }),
...
const IrPaymentFolio = class {
    ...
    componentWillLoad() {
        this.folioSchema = index$1.z.object({
            date: index$1.z
                ...
                return date.isValid() && !date.isAfter(utils.hooks(), 'dates');
    ...
    render() {
        ...
        return (index.h("form", { key: '705a0629410f540dbeeb60533e3e84390abe71de', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: 'd9b7f80f073653c5d95f1d635c8049981a207d14', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: this.mode === 'edit' ? 'Edit Folio Entry' : 'New Folio Entry', displayContext: "sidebar" }), index.h("section", { key: '0c57bb5169acfb77f21a64f09f62fad0bc55e39b', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: '0179e606a4e21c7286e2ebe702d50361221093ef', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: '9459816c08b7d3a76438e887824a993c8be51cf9', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: '930b847a6cab9943f0a7bc63332516b877dfd1e5', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: '780ad9fff1e21105ac28b1c6e0ab2d329efe3e19', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: 'd1063e08312a3d9926b2d6ddceb0ecd7ccf464cc', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: '58f7122ace4ab23dd2939fb3b93cc8d061ba8cd3', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: 'ee67540597d7bc6bb764c68b0f938e09639a8629' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: '5cf131929611954ccb7527ee448b9c5a0c772f5e', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, maxDate: utils.hooks().format('YYYY-MM-DD'), "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: 'a213e5fb62c8da83516dddc0bec99360f463ae5a', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? utils.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: 'c926f9284e3a76fc0568296dae619aa4307f5924' }, index.h("ir-price-input", { key: '2c064c5ca6bd8b7d2a7038f13385438c0fe16be3', containerClassname: "row", labelContainerClassname: "col-4 col-md-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: '9c453112756614f556a2ba2818df5945f4ae9654' }, index.h("ir-dropdown", { key: '66871e51cb084088a253a7c2cc2477a027e38ccf', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, disabled: ((_p = this.payment.payment_type) === null || _p === void 0 ? void 0 : _p.code) !== '001' && this.mode === 'payment-action', onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: '34b7bccb85364cd916e5f9ad305e454840112f47', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '27f88300f1c2f8617ff250a40e822cc36b4cf819', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: 'c6123fc3dac41d11d6012b508df2da7244528223', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: 'd46cd4b43700ea4dd600e06ae2cd80982792ecad', type: "button", disabled: ((_q = this.payment.payment_type) === null || _q === void 0 ? void 0 : _q.code) !== '001' && this.mode === 'payment-action', class: `form-control  d-flex align-items-center cursor-pointer ${((_r = this.errors) === null || _r === void 0 ? void 0 : _r.designation) && !((_s = this.folioData) === null || _s === void 0 ? void 0 : _s.designation) ? 'border-danger' : ''}` }, ((_t = this.folioData) === null || _t === void 0 ? void 0 : _t.payment_type) ? index.h("span", null, (_u = this.folioData.payment_type) === null || _u === void 0 ? void 0 : _u.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '86c146a89d6e1012057a88b4ced8b42f1c1db7da', value: "" }, "Select..."), this.renderDropdownItems())), index.h("div", { key: '1feb3476505942139cddf98f3fefcf3c1ee330d6' }, index.h("ir-input-text", { key: 'f84d5088fb11cd3d09a62b0568fcfedc80bb50cf', value: (_v = this.folioData) === null || _v === void 0 ? void 0 : _v.reference, error: (_w = this.errors) === null || _w === void 0 ? void 0 : _w.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3, labelContainerClassname: 'col-4 col-md-3' }))), index.h("div", { key: 'e3a9d32afdbdbe691cce2390649d6b8337329506', class: 'sheet-footer' }, index.h("ir-button", { key: '2522b1b53cae72417fc5f6ba6a03903db0da8fe9', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '19a6ccf0501617c6cfe71124ca968d01bbf56257', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ee98488eadd5b44d57a3112d22698dd125ec96a1', class: "payment-item", part: "base" }, index.h("div", { key: '1a1ca120a0f1cdd9f1932c7c3967c85c51120ba6', class: "payment-body", part: "payment-body" }, index.h("div", { key: '8a2e828294f926826e01b6993d464f7cbea00e70', class: "payment-fields", part: "payment-fields" }, index.h("p", { key: '153d91c2bd5865747cb6d4c9d70a67140a0f98be', class: "text-muted" }, this.payment.date), index.h("p", { key: 'a439a3092cadc35e6b89a546ccb3b837786d62d2' }, index.h("b", { key: 'e020bac3967784993d60c167729ff43fe1ade52f' }, (_a = this.payment.payment_type.description) !== null && _a !== void 0 ? _a : this.payment.designation))), this.payment.reference && index.h("p", { key: '8a3a180f0a08c4b9bc5b7c48d983b4f238bfd4b4', class: "payment-reference text-muted" }, (_b = this.payment) === null || _b === void 0 ? void 0 : _b.reference)), index.h("div", { key: '566ac324886f65f2c8096b59dd7347eb5925f7fa', class: "payment-toolbar", part: "payment-toolbar" }, index.h("p", { key: '508430c3c97d7ba3277813916b0ee8472a7bbe0a', class: `payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.payment_type.code === '012' ? this.payment.amount * -1 : this.payment.amount)), index.h("div", { key: '05ff19b4f403ee0a315db9ef2d59aff65af2a4a2', class: "payment-actions" }, index.h("ir-button", { key: '78e20f5a1ce5d984de2d259a1bdbc2035c76eab1', class: "action-button", variant: "icon", onClickHandler: () => {
                this.editPayment.emit(this.payment);
            }, icon_name: "edit", style: icons.colorVariants.secondary }), index.h("ir-button", { key: '4664daafc6a5999968562f469d3c4b71331bc824', class: "action-button", onClickHandler: () => {
                this.deletePayment.emit(this.payment);
            }, variant: "icon", style: icons.colorVariants.danger, icon_name: "trash" })))));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: 'ba8cf439e47e10373d2b46df452a9160942fa1c5', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: 'c6318b6b3e8238cf7bade44efc6110a05f829857', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '3112481603e78ee744ff6ca2366c2ff465831ce3' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '9609f879469bd08a7365244a3caab6822488572f', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '77283a3286b5c5cdac666fe6ba35841529dae4c4' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: 'bcdd8ce1d99eaa8b15b0e857f033e684f2dda250', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), index.h("div", { key: '6175b69bc608742eea88aade61ee078bf425d980', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'cac3e33669872dd774d7a00d9ca15c458a2d559f' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '69e74f8e6c4fa4c33fbab7639edde09983034951' }, utils.formatAmount(this.currency.symbol, this.collected)))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("div", { key: '621d2bf00f54f9b61f82a07aa753ecbeec8aa5f1', class: "mt-1" }, index.h("div", { key: '55dcaccae0fd3cb56790aa0899e33e11d56e737e', class: "d-flex flex-column rounded payment-container" }, index.h("div", { key: '8c975bca26b83da4341c399b51ea66bfd3929ec0', class: "d-flex align-items-center justify-content-between" }, index.h("p", { key: '7c49458388d7b18e667608d5e5c640627e130939', class: "font-size-large p-0 m-0" }, "Payment Folio"), index.h("ir-button", { key: 'b9d814a95ee9f8579a5f8689851312792693f17b', id: "add-payment", variant: "icon", icon_name: "square_plus", style: { '--icon-size': '1.5rem' }, onClickHandler: this.handleAddPayment })), index.h("div", { key: '25e5c0e8ba9264c7b44966311d16a47bd5c2f436', class: "mt-1 card p-1 payments-container" }, this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '23c1c8676f912872e014736d2b04db40a88dbb81' }, index.h("div", { key: '18bbeffc9a488360f80833ef5ad90bccd92e6aad', class: "form-group mr-0" }, index.h("div", { key: '8cddb1902e580d64b86794678e651821f92f745b', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: 'a5fd3c54eaa39c5478e749ef86ca53596d260d66', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '59393d09f3cacca8a67da75d72882b2e4b589f54', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: '940ee15a4427b4e1c594b45538835c03144ad3e7', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '9448e249e084595291bb9c8b8c07b19d4cd5a78f', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '875b806a36d42b558e67f76dac95648098b8eaed', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '55b76c299cdd2ef4eda62ada403e5bfcc0e1dda4', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'f1e3c2b17da3eff245f9899368c057bbcebed9bb', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: '6f9503a871f47b5fa8aa4755ebedb52e8c2ed5df', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: 'aa398b3e31c50d769242f642814c803fc88a7320', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: '3d21446e9f783657eda35de317d12cb24703db21', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '473a0d6d5946acd9418c8055dd9cff0352343038', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: 'e950fc5defea42c1bcf845099c37c4fbde60b0b9', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: 'b9ce0f027d93e428e601c0a068d6f56fb734b91a', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: 'ebc6259a6d5a82142cffeac651166dc9f3835f28', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '1f7d0c31158622defb6ae569b63374d251cec368', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '54b4b472275f4fdfac8e73678f47346f0fe0f640', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '81f20456e5ce0847146afa4b01d9095a628237d3', class: 'd-flex' }, index.h("div", { key: '7d7a57617c8cbd300ae6f870fce95b78092e3d9a', class: "form-group  mr-1" }, index.h("div", { key: '8ee80f80f5ccc414acd5c40b17e3077bff2eb66d', class: "input-group row m-0" }, index.h("div", { key: '6516df597d8f373a4f9ece6c89f3ff63779ae429', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'd8187d97ff087d777a11b4537e9b05a9f6c4d401', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'e3a38c367982e7ed782d725a88bcded04e61b534', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: 'feb775644bcb77dc491a9baab4f6d79810e190f3', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '3dbed681c24dca72aa61fe6407a848fe85f5b497', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? utils.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '445dbf1e03f29a145514ae4c00ac90cf89594015', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: 'bed2037fdb24ca12598e3d8a49d2fc09b0626c68', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: 'e37ddf817b5619ec754ef31c8f85a0a050bc2863', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '8e1acf405134b4d90a217af6038bfaa8b63dfbee', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'b9c94123a454ee8fb086f7f8b01148daaa4781fa', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '2f81fc9d0d46ee90179b1bba8aa3864b1e8a4994', class: "price-input-container" }, index.h("ir-price-input", { key: '57a5bbfc65776da9430c4663e15b2cc3daa3fb48', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: 'f21959ce34ca028a85fc780d2b69bbe094e635c3', class: 'sheet-footer' }, index.h("ir-button", { key: 'bfacb1b35aa7e4b0f41a66182bba8a30af8a6e7b', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '12df334ade7f07f4e7fc8a8150491f5c2b1d1605', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd042f02d76765a3221fcece86475131490ab4bbc', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '2b208ae8ac5e250fb171716645e00d9af8a35445', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '88d395e227ef6cea005590070b767889e8675af6', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: 'dc5c3ce9f2dadabdcb03d3c75271fbf62f0a7558', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '16adf3b300754407528ceae4223d1d4f94940845', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '88e0560612ba940906744bd4369f06e7ff7cee85', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '362f577dea4fc07467976e8cf924bcb4016c6f9b' }, index.h("span", { key: '7ac94c080b0db34e5b950ff3c1b2776a33c5e896', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '8742a20f19e35f03e7f918c27db92c725002c1f8', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRangePicker = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '8aad2fdd825a03a64ba2b1fc3bb10d9eb7acb12a' }, index.h("div", { key: '664f5e75272a5201f3cd468532c0a91924321c42', class: "form-control range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: 'c8253871100b5162ab9b356ba689b5341d20960b', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("svg", { key: '335cfe58d886b590159a7d113938a4aed6d0aaeb', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '302d65c0d905f8c8759d5739c32ecc2cbb5fdb10', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), index.h("p", { key: '648ce23d794e3a725b9d0b6ba156aae6adbb4bc9', class: "m-0" }, index.h("slot", { key: 'fe62e69a6de7c7d3522be8c4798042f9b0a561c6', name: "message" }, "Cleaned on")))), index.h("svg", { key: '3bd109a5426edc0df7e742ef1563b6ae12081106', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: 'ea503e45de2ea87c57c0c2de986a803d8a21739e', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: '3638b16f6ed1c3d943b99295fb4daaa275d2324d', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '933c05726cd15c3c3dd242820bc3c8956bf33088', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, ((_a = this.fromDate) === null || _a === void 0 ? void 0 : _a.toDate()) || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '41e0763ec869d0a817879eaff4caa00f0641940c', class: "card" }, index.h("div", { key: 'cd0e1477b5ad997d9432201553d99aa3cf58f59c', class: "p-1" }, index.h("p", { key: '6b535159b3f67dabafd8dd6e5a32bd2e676172ab' }, this.booking.property.name || ''), index.h("ir-label", { key: 'c0e51097274e2fd66e5e3bac4e726306ca65fcfe', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '93afb585f6697c039350bce42afffb65a4540cb7', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: 'c8c01ae98f26d19c1036e16b2d2df283649c80d1', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '67bc595285f717702e55eb5c6d79ebe229a65294', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'f02b1749372f9cd273daccb3288a04acc7e00080', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'ce291d26d62ba5724e4f68098708a1e08a866cac', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '25b1b21a2839170014d2bdfe340c4d6af45a4bef', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '4fe2bf793aabb7ab375573b48e5b6f5836f40112', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '784b3999632c7e2e76c974bb1770bd8c7a20fd91', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '0dca257713c88697c0cb6387ddc12f98537d9e0b', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'a96a3e9bf3b6ce61805cdf1613fb0f648c6b731e', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'b90f22226d6df4e4ffa7dfe53180ee90468af6b5', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: 'd571a684d5ffa7f0bc808912d042acb1f10ea545', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'c0de620d5dcead36150e4c20b10c78ba2c0df260', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '545b0aedae8ef77ecccf2837d3c09972de8377fe', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: 'e312c809ac955860924671f5c4d0f916f9527daf', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '0492d2b03fb521a1e4c5af73ccb37c470874f1cf', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '9cbe76f504cb122359b018a59d62fb57c61f44d2', class: "d-flex align-items-center" }, index.h("svg", { key: '255e2e1e4b5d2fc5eaf0fba70903466f06508b58', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '29564c0aa6298d5cf0bc91f665a8b448338147fe', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '4aa66623e3bd39be17851dd5f3d48c8cbb4c2c0b', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'b5469a45409a1ca6222f3b26594f35992182d224', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '71e1e3968d53553987f03783894cf36be8baafea', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '80d44257ae976193291923dcc431424448d0ce57', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2072714e63bf3b8128e1f1a1c3ac1b26f846dfec', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '6ae010d17616a9406e3d6e8f670a87acc3d388f8', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '02352443e790b3ec5cab5f35d7d936645264c4f8', class: "flex-fill m-0 " }, index.h("div", { key: '9b13426d54142cd97ccdbaf928546dacc843c7f6', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: 'c01559b3b51f7d976452661bbc17cfe4c634e929', class: "m-0 p-0" }, index.h("span", { key: '47dda81cce4bf9900b864e517aa5ba2cf714899d', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'c197ad7adb5e021357e54495b084962d2cea5dca', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'c6bec42df9089b779514ea3eb478bc601b12ae4a', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '7c66f6db610a58fcc976f0f9f838fdc49a2ecdb2', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'f0369a3badb051592539bf4994e406565a1297d3', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'ccd2856adbb9e9f7405b8965cdf318d3d953fc66', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '7ac6c910de5dc59afa4a2be04367d354fae54bac', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: 'f3091fa3064073a5e1e3fb33c8b1fc1f08ac085b', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '08c2fc8b01ccb3c23d44d6a6aa63c51ea434e8a1', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'e231e6316d02679353d651e98693a03664fcb62e', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: 'ed56fe97bcd5d96de9ccc5d6e951fff2440e85ec', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: 'd1a36eff80334dee5e62eb07b73741c835828786', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '8e51cede6f0505ae57f88c8920200e742b5c50f2', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'e9090adf9f0c1142c75f55e7caffadd9691c9a23', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: 'ecd52044d98ccfaeeaba8bec5ffe73988e481835', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '9f0e18662e5019c49a4d7bc997a84dbcf81c9f76', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: 'c297d5bf2b1927987aa8da6275229c17d782f7c5', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: 'be80b8e186acb42af0849b8f3dba0f0416f7e705', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: '65229bf042f66f478252f20e955dc6c4b6dd84ec', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: 'ba77c56feaf025b3d39d337c6aef7eec82ae1443', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '9f2b9f6d7834dd5e3ee04b41c4610eb120e7a4be', class: " sm-padding-top" }, index.h("p", { key: 'aaffbe640f3c770867d23dc8cb33fbe7e9b37b50', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '2e769a5d12720820308d937e19d30e4da17d1cbd', class: 'flex-fill' }, index.h("table", { key: 'eb09d307f9243ce1d9da57fbe8d880558b6ae011' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '9e94ba071c71f5f763ba313e8cf1a9523dc9c2b8', class: '' }, index.h("th", { key: '4b8fee97b19a43474d92b018785f3fc9b941fe39', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '378c8b236978a846cd69fe7b883c615a174f7acb', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'f43e27a3578fa0d9d48680eb98aa06b0ddd6ef94', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '2f85d1e0efe826a7810abd620885c0c83c8604db', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '37443d9b679e072ffaf04020c22112282a8489e5' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'b17ce77f74a0d6dc691386532dfffa861cae4f0d', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '7d07b995553b2d09da7befd933146c49478b1ecd', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '8049c8cfc780f684c99a3ae2facc7fcd6790e8cc' }, index.h("ir-label", { key: '9f9111b81632c5b4f045c563789565f98087a573', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '083ed555a63deff80f9169e4b9c6432d24530796', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '2e62ff74d8f0dc3098121347f6f9a00fdbbfafe2', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b34f90ba80d6aa2f6f6e6982193ebf66f0c6ae76', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '0088d044be458a5939b848bcb9ce104cb59add03', class: "input-group row m-0" }, label, index.h("select", { key: 'ff91e917d440e790ca40199dfe4bdf6065bb70b9', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '256a6f980231d805fc7f8b88bc487ff556389463', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '08cfbfbf81b77859ab0a4211932eb670edc6b471', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: 'e697caee9a4bb41c1f3b9c462639c83f5bee0417', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'de0f97c5833aa262c7b2736ab0b3e6752c99c83d', class: 'sidebar-title' }, index.h("p", { key: '1a9bed1dfb1496bc7a790158605af9c27b9885b9', class: 'p-0 m-0' }, this.label), index.h("div", { key: 'ebf628f996135d5f2f063b7c379af142e4b05731', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '112ddc7afddd552ba839f0eb3fdc060f573e5405', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'fd81e1ec4993c2a9f3a76b2c4cec9aca73db2e1c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '3db6f0582ce6113e4cd28262570c3d65b722daf7', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '8248f93b15477b248faf8eed7b5844872790efa4', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '5a12dc9a14d4bed98c0eb122d5245ef0fb27eb60' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '66eb8603c82b4747ef9b96087699771a65b26139' }, index.h("h4", { key: '1ee3edcc58a66d3bd8bdbf91758487ff81fb9ed4', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '655a544876fb2657c8b7692b15f2b097e9d2ec2b', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '80144b90a29c4fb7391b7145b546bfea1638ea43', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'cba9321c53a1df229d299c5b826494e4d25ac633', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'da856f9a7ced9f4643760408945f98b2cf318b72', class: 'title-body' }, index.h("slot", { key: 'cac45cf6bbaecbba194010fa18cacff12ea58eae', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
