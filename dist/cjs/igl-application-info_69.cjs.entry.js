...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '0aad8dc93088c8a3833d5a50a9c11261dcf6a87e', class: 'bulk-sheet-container', onSubmit: e => {
            ...
            }, class: "px-1 mb-0", label: "Bulk Open / Stop Sale", displayContext: "sidebar" })), index.h("div", { key: '4cd4d70bf4d0aeb2a1f9c22b3f130fbd5b39ca61', class: "sheet-body px-1" }, index.h("div", { key: '7a48ab5d5f87a17451205a3c0479cb0a59e8569a', class: "text-muted text-left py-0 my-0" }, calendarData.calendar_data.is_vacation_rental ? index.h("p", null, "Select the listings that you want to open or stop sale.") : index.h("p", null, "Select the unit(s) that you want to open or stop sale.")), index.h("div", { key: '6aca715a28f4a10e2adda704a0236e07baa2c1b6' }, this.errors === 'rooms' && (index.h("p", { key: 'f3201b7758b10cf9367d9e1d6bb3811a3f0b321f', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, "Please select at least one ", calendarData.calendar_data.is_vacation_rental ? 'listing' : 'unit')), index.h("table", { key: 'e1b52e42f19135b0dfe573a574c90ad2da60c55e', ref: el => (this.unitSections = el) }, index.h("thead", { key: 'fcd3b80573810d32a3b22f4eabe00976fa5b3aaa' }, index.h("tr", { key: '5479843344bc8836463cd397751acc2b85265224' }, index.h("th", { key: 'e515190070a2df72bdcb4bc7244b97265e6c46ae', class: "sr-only" }, "choice"), index.h("th", { key: 'c640b5d39fe2de833ddd3558b8aea2f3cde12074', class: "sr-only" }, "room type"))), index.h("tbody", { key: 'c02a967719c2ca4835f5c865c5bea5108cda47c8' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '12ecd13ce28ef2f04e763e43a96f4ee94d91b5a8', class: "text-left mt-2 text-muted" }, "Select days to open or stop sale"), this.errors === 'weekdays' && index.h("p", { key: 'bd866434d124cc35fd705744e38ad29768f10e4c', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("div", { key: '60ec7ebee855a80eb897b43aee405616175799bd', ref: el => (this.weekdaysSections = el), class: "my-1 d-flex align-items-center", style: { gap: '1.5rem' } }, this.weekdays.map(w => (index.h("ir-checkbox", { checked: this.selectedWeekdays.has(w.value), onCheckChange: e => this.toggleWeekDays({ checked: e.detail, weekDay: w.value }), label: w.label, labelClass: "m-0 p-0", class: "days-checkbox" })))), index.h("p", { key: '6189481240695a8bb8918d90fbd68d3f953fa18f', class: "text-left mt-2 text-muted" }, "Add date range(s) to open or stop sale"), index.h("table", { key: '7eb0ac32e418c26506bf2afb1185454905f481ba', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '67841f899b8b37d6082a965944716fb4ba2fb948' }, index.h("tr", { key: '48d20d45722717b75342b626c7e9455dd1de51db' }, index.h("th", { key: '300f8edfef5d48e0b029b665a74b2d0386a490d1', class: "text-left" }, "From"), index.h("th", { key: '3114998e34e8cfbc0c2667cc675ab5642b86d380', class: "text-left" }, "to (inclusive)"), index.h("td", { key: '98ba7e2d35ab09eac011fb8cf26e907de793122c' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '07f18f9508d16654152503f4247ed8069527097a', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '9821c9332166ecbeabd12b368f09abb061b02fcf' }, this.dates.map((d, i) => {
            var _a, _b, _c, _d, _e, _f, _g;
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: '3982f21d7931474c61c578a1756e328fde401dfa', class: 'sheet-footer' }, index.h("ir-button", { key: '944c8c4094e68898579858f8d775bcb90b00b98d', text: "Cancel", btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '3bef04a80b7ec32a2b6e37f8864515d17465e0c2', isLoading: this.isLoading, text: "Save", btn_type: "submit", class: "flex-fill" }))));
    }
};
