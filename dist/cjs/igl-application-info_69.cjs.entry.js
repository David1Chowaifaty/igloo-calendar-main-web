...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c9390c0485a8091625b00aff63caa283e980185a', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: '537e8961ca2578a7845cb700d4fcf8deda5858fd', class: `bookingEventBase  ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: '140caafec02b50bb0a18ca85f00f557676694ce8', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), (this.bookingEvent.is_direct || utils.isBlockUnit(this.bookingEvent.STATUS_CODE)) && (index.h(index.Fragment, { key: 'b923a1a29e062051a7308852bd26c92ef75c5014' }, index.h("div", { key: '0349c31f0fe40f2771e8bfb81ff1f917e91a7395', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '4c9370dd2b21795e78109385b98daeeec0156ad4', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: 'b83eda322e257d0e0b7eb5ac531ae568e734e231', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'e01e2a3a77699eaf3230a5b15a89559dfbdd59ae', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'b0432eb539125d39e01c50befad2fe815a3abdb9', onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (this.isLoading) {
                    return;
            ...
            }, class: "px-1 mb-0", label: "Bulk Open / Stop Sale", displayContext: "sidebar" })), index.h("div", { key: '8459af50c3ac4aafd92e5ac4b27b5e27faf7651b', class: "sheet-body px-1" }, index.h("div", { key: 'de5ffd9f63c82a496a791941adef5f47de606db4', class: "text-muted text-left py-0 my-0" }, calendarData.calendar_data.is_vacation_rental ? index.h("p", null, "Select the listings that you want to open or stop sale.") : index.h("p", null, "Select the unit(s) that you want to open or stop sale.")), index.h("div", { key: 'ae718024c90903de8d3edda69bb736187f18203f' }, this.errors === 'rooms' && (index.h("p", { key: '07a065894faf9b2d78b8d64947401bb9f67f4d39', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, "Please select at least one ", calendarData.calendar_data.is_vacation_rental ? 'listing' : 'unit')), index.h("table", { key: '6c702c466560eb9b8c7b01d7c9a7fa162c334ce6', ref: el => (this.unitSections = el) }, index.h("thead", { key: '6cc8f1a9669e4f1b37566fa2c75be79e251418e8' }, index.h("tr", { key: 'ece8224a6e7cae6694d7c38f0a0a9142e6b9cd69' }, index.h("th", { key: 'ada5031cb6e5d18231bcba10812e82fef03a31a1', class: "sr-only" }, "choice"), index.h("th", { key: '7a2075a02d8d9f053891e7b52fe179fe67113562', class: "sr-only" }, "room type"))), index.h("tbody", { key: '7b1ff3882615b33aa9447cc742e5f8a9ff5d22c7' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: 'de6473932eca55ead17f0da50c2433a89551cd72', class: "text-left mt-2 text-muted" }, "Select days to open or stop sale"), this.errors === 'weekdays' && index.h("p", { key: 'f246562ab4cd18056d355b7f40f654b64e7263e6', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("div", { key: 'e5c39ac37375424a9828bbb9d035f7d9edd62edc', ref: el => (this.weekdaysSections = el), class: "my-1 d-flex align-items-center", style: { gap: '1.5rem' } }, this.weekdays.map(w => (index.h("ir-checkbox", { checked: this.selectedWeekdays.has(w.value), onCheckChange: e => this.toggleWeekDays({ checked: e.detail, weekDay: w.value }), label: w.label, labelClass: "m-0 p-0", class: "days-checkbox" })))), index.h("p", { key: 'a3edc9ef08bf8974f596437fdc3ce9fcf340edaf', class: "text-left mt-2 text-muted" }, "Add date range(s) to open or stop sale"), index.h("table", { key: '0033f629d28eba615f056724ab94dd115e3ee4e7', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '18373fffb8ddd129d811dff331df768af763b030' }, index.h("tr", { key: '45322bcc0930fd890c0afed8a23d2bbb702f359d' }, index.h("th", { key: '6911368c876feb8e95f39846e0cf2a84fd600548', class: "text-left" }, "From"), index.h("th", { key: 'de8897552a418cee095b0d90d4709ee0dfada4fd', class: "text-left" }, "to (inclusive)"), index.h("td", { key: '05e52731ba17dee5fb16e239a93113c6c938eb18' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: 'b0c2bb56f72c2cd585eaa01eee745bf1351891cf', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '1a3f3684ea29a090a0c7b7ac70beb62a5e43042a' }, this.dates.map((d, i) => {
            var _a, _b, _c, _d, _e, _f, _g;
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
...
const IglCalBody = class {
    ...
    getGeneralRoomDayColumns(roomId, roomCategory, roomName, index$1) {
        ...
        return this.calendarData.days.map(dayInfo => {
            ...
            const isDisabled = !dayInfo.rate[index$1].is_available_to_book;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8647e9315fc4ed90d4061160fc78a33ed093facf' }, index.h("div", { key: 'c8966a6fe8136809d47ba7d8356a8a7b73812c8c', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '5d34daba8cc5095c676e77e52ef0fa5037a7ea1b', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglooCalendar = class {
    ...
    render() {
        ...
        // }
        return (index.h(index.Host, { key: 'c38dbc46a34cbe2b795099b7ef701253e0f42121' }, index.h("ir-toast", { key: '0a679b2b8a5c0ab13592e5afdbf61447b99bb0db' }), index.h("ir-interceptor", { key: 'ffa08ee8f64774f8c6f09d502234f13295cd9598' }), index.h("div", { key: 'e90492c3d4d114bf5b1cffe641a0218f9cfe1061', id: "iglooCalendar", class: { 'igl-calendar': true, 'showToBeAssigned': this.showToBeAssigned, 'showLegend': this.showLegend } }, this.shouldRenderCalendarView() ? (index.h(index.Fragment, { "data-testid": "ir-calendar" }, this.showToBeAssigned && (index.h("igl-to-be-assigned", { unassignedDatesProp: this.unassignedDates, to_date: this.to_date, from_date: this.from_date, propertyid: this.property_id, class: "tobeAssignedContainer", calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) })), this.showLegend && index.h("igl-legends", { class: "legendContainer", legendData: this.calendarData.legendData, onOptionEvent: evt => this.onOptionSelect(evt) }), index.h("div", { class: "calendarScrollContainer", onMouseDown: event => this.dragScrollContent(event), onScroll: () => this.calendarScrolling() }, index.h("div", { id: "calendarContainer" }, index.h("igl-cal-header", { unassignedDates: this.unassignedDates, to_date: this.to_date, propertyid: this.property_id, today: this.today, calendarData: this.calendarData, highlightedDate: this.highlightedDate, onOptionEvent: evt => this.onOptionSelect(evt) }), index.h("igl-cal-body", { propertyId: this.property_id, language: this.language, countries: this.countries, currency: this.calendarData.currency, today: this.today, highlightedDate: this.highlightedDate, isScrollViewDragging: this.scrollViewDragging, calendarData: this.calendarData }), index.h("igl-cal-footer", { highlightedDate: this.highlightedDate, today: this.today, calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) }))))) : (index.h("ir-loading-screen", { message: "Preparing Calendar Data" }))), this.bookingItem && (index.h("igl-book-property", { key: '4d145e1518a65a7af110f1a11eae85c9848e805b', allowedBookingSources: this.calendarData.allowedBookingSources, adultChildConstraints: this.calendarData.adultChildConstraints, showPaymentDetails: this.showPaymentDetails, countries: this.countries, currency: this.calendarData.currency, language: this.language, propertyid: this.property_id, bookingData: this.bookingItem, onCloseBookingWindow: () => this.handleCloseBookingWindow() })), index.h("ir-sidebar", { key: '5f90d1aaa80142339e8b24a034db42bd464ef607', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.calendarSidebarState || this.roomNightsData !== null || (this.editBookingItem && this.editBookingItem.event_type === 'EDIT_BOOKING'), showCloseButton: false, sidebarStyles: {
