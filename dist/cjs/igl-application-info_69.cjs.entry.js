...
const IrBookingDetails = class {
    ...
    renderSidebarContent() {
        ...
        switch (this.sidebarState) {
            ...
            case 'payment-folio':
                return (index.h("ir-payment-folio", { paymentTypesGroups: this.paymentTypesGroups, bookingNumber: this.booking.booking_nbr, paymentTypes: this.paymentTypes, slot: "sidebar-body", payment: this.sidebarPayload.payment, mode: this.sidebarPayload.mode, onCloseModal: handleClose }));
            default:
                return null;
        }
    }
...
const IrBookingListing = class {
    ...
    async initializeApp() {
        try {
            ...
            const groupedEntries = booking_service.buildPaymentTypes(pay_type, pay_type_group);
...
const IrPaymentAction = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a0c1de8da0c96b0ba1d03e19901366a26245baf8', class: `action-container ${isFutureAction ? 'future' : 'overdue'}` }, index.h("div", { key: '596590dcef716f23b191f8f13e71cdc8f8144ed4', class: 'action-row' }, !isFutureAction && this.paymentAction.amount > 0 && (index.h("div", { key: '99102ba8075a13c93e23eed3d0ea5bc0f35cdf3f', class: 'overdue_action' }, index.h("svg", { key: '0d3b9c698123cd6cadb820530cdfc0ed7e6ac98c', height: 16, width: 16, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, index.h("path", { key: 'ab5bc560b9ed8e9bf8b20921cdb6a7656447cf59', fill: "currentColor", d: "M256 32c14.2 0 27.3 7.5 34.5 19.8l216 368c7.3 12.4 7.3 27.7 .2 40.1S486.3 480 472 480L40 480c-14.3 0-27.6-7.7-34.7-20.1s-7-27.8 .2-40.1l216-368C228.7 39.5 241.8 32 256 32zm0 128c-13.3 0-24 10.7-24 24l0 112c0 13.3 10.7 24 24 24s24-10.7 24-24l0-112c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), index.h("span", { key: '5df6a580b7b3fe226e1fb360f47c2d1e737d917a', class: "alert-message" }, paymentActionType))), paymentActionType === 'future' && this.paymentAction.amount > 0 && (index.h("div", { key: '01c02708e15972edffc7b3a0391942e25e871c1e', class: 'future_action ' }, index.h("svg", { key: '18c37d9c9e471aaed46c933e378bd2ded2124439', xmlns: "http://www.w3.org/2000/svg", height: 16, width: 16, viewBox: "0 0 512 512" }, index.h("path", { key: '28fd10c930b92f65838fb786a690b06b89b90c41', fill: "currentColor", d: "M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" })), index.h("span", { key: '09f07d2f6778539846cd73ba73375452b1101492', class: "alert-message" }, utils.hooks(new Date(this.paymentAction.due_on)).isSame(new Date()) ? 'Today' : 'Future'))), index.h("div", { key: 'feecf26885a68601b2ca11aa65379b53f2efd0e7', class: "meta-grid" }, index.h("div", { key: '306f2ea818953fb5a337f239fc0830dccd4f1d11', class: "payment-meta" }, index.h("p", { key: 'e9bbadf3146d2895a0b8be97d07876b465c98712', class: "amount_action" }, utils.formatAmount(this.paymentAction.currency.symbol, this.paymentAction.amount)), index.h("p", { key: '49e821b638f813e5eedb52aafe06fca1b877c0b5', class: "date_action" }, utils.hooks(new Date(this.paymentAction.due_on)).format('ddd, MMM DD YYYY'))))), this.paymentAction.amount > 0 && (index.h("div", { key: '4068166e066e8e6c71125507143862c8dd8084e9', style: { width: 'fit-content' } }, index.h("ir-button", { key: 'a6de1edbf17a67aeae727a027d60e2823f6061fa', btn_color: "dark", text: 'Pay', size: "sm", onClickHandler: () => this.generatePayment.emit(this.paymentAction) })))));
    }
};
...
const IrPaymentFolio = class {
    ...
    async getPaymentTypes() {
        var _a;
        const rec = booking_service.buildPaymentTypes(this.paymentTypes, this.paymentTypesGroups);
    ...
    render() {
        ...
        return (index.h("form", { key: '359cbcddb20d6756ca751582578c5387c74ebbda', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: '37538d01329ad7363d40000dc827b83fe2193a1f', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: this.mode === 'edit' ? 'Edit Folio Entry' : 'New Folio Entry', displayContext: "sidebar" }), index.h("section", { key: 'dcaa8747a2704b691cc540e011cdc00e5c82b94b', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: '079ee771e9215c17a60b07d347208d44f49cd4d1', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: 'e43d37582ed97e9eb6cc80f31093131afedc2014', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: 'fdf5072682be01a3edef080f55f6f089d80691ef', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: '2ae5cfbc97f5e109365ece0c0670b9cf438aa14a', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: 'bbcfb9adf3a8d5b6b3cc3c39f06411fa9f2c0675', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: '7f49eb936d6d5e00e63fa62f51ab43fda2581c02', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: 'dba49e24dd889b17aca937c9d4733f5557962faf' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: '1579c1f7d938b2b1bcd271c78a67993506768a24', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, maxDate: utils.hooks().format('YYYY-MM-DD'), "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '9195a91060bae0d4daf58bb33b1bc22e42c49526', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? utils.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: 'e8f24f36b1e9ca232bd228ff7d8411a52ebd0ab3' }, index.h("ir-price-input", { key: '81fa62821b3a5b8b71fd60bcc17184bce6f0b3e2', containerClassname: "row", labelContainerClassname: "col-4 col-md-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: '94f1fb35a48b48a302b053d8cf4c72863d43ce53' }, index.h("ir-dropdown", { key: 'fa4083ccb7895bf32c49ebc17b1e90684688b9e1', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, disabled: ((_p = this.payment.payment_type) === null || _p === void 0 ? void 0 : _p.code) !== '001' && this.mode === 'payment-action', onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: '3c5a58ab4c7653baf623205ddb6aa36427f19f0b', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '11303f3355639485f91ea84379b23384ec7e9c09', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: '6b9ebaef986999dcdbb7fe93348c6bdf90382f12', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: '25569d42e66a5267f925a05728d755e943e98a86', type: "button", disabled: ((_q = this.payment.payment_type) === null || _q === void 0 ? void 0 : _q.code) !== '001' && this.mode === 'payment-action', class: `form-control  d-flex align-items-center cursor-pointer ${((_r = this.errors) === null || _r === void 0 ? void 0 : _r.designation) && !((_s = this.folioData) === null || _s === void 0 ? void 0 : _s.designation) ? 'border-danger' : ''}` }, ((_t = this.folioData) === null || _t === void 0 ? void 0 : _t.payment_type) ? index.h("span", null, (_u = this.folioData.payment_type) === null || _u === void 0 ? void 0 : _u.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '4fa682986194d7a3f83a265e2249e05507bcf7e7', value: "" }, "Select..."), this.renderDropdownItems())), index.h("div", { key: '60ee1af9136cb76958e43783cea0d4047f9b749d' }, index.h("ir-input-text", { key: '189e00f52d74664711a259389089c8af296df2e2', value: (_v = this.folioData) === null || _v === void 0 ? void 0 : _v.reference, error: (_w = this.errors) === null || _w === void 0 ? void 0 : _w.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3, labelContainerClassname: 'col-4 col-md-3' }))), index.h("div", { key: '87b82601a632333bab9d1cec1fb163d97c55cb12', class: 'sheet-footer' }, index.h("ir-button", { key: 'ba6a29fb1b38ac32c28ac5ef632732a6b8ea90f5', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '68c76271ae503e298f37a09f58fb5974b4d39467', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
