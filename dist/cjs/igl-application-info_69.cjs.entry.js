...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'be687bc40b95e79206f858089287af97c0bed119' }, index.h("div", { key: '067d122ef95d9bc6ff436cf0c7d178ccc6a7accb', class: 'd-flex align-items-center ' }, index.h("label", { key: '6b55126522665b0ffb8aa8e3784d6c0a0eceb280', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '82b4c94e34de8893c650baf8bc9a69d09a9b3239', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '70eb7a913982ee15781669b82a604c6ef99b4c85', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '16dfb57837d04a2cd00f261f25bc58ddc4dddf6d', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '2fabb893ec45041f3a021ec2d4226309f16d0e5f', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '0bdb6592307360b8732a9e7c9efe4e030ed49848', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'b6a724fe58e04fd10e1cc85101bbfb6984e0c7b2', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'b26d2f62e5ac91e56fa7c57f86cb213603c38f65', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c3c576c1f37fc52017d86932cfa5ce08c59d5e90' }, index.h("slot", { key: '37a29df62c26b1913b38a95e66add2b0187e5b6d' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '92d5d054af9fffe892c12243e83d665ecfb892cc', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'd10c9b1049ae3cdd69917e77bc4d7b23e089678c', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: '0ea3c8071ccf32c34e2f5b36d62774473a34ee46', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '0a327358058668b6f658d9001125e8f33b831048' }, index.h("button", { key: 'f9c5b362d1b372e848cfb82131389c8e6fccda08', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '2ea2cdd87c1769c70f3e48c18e146ec3d37109c0', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '7681ad1209db0eb9511bebb7a4bf57955e1cc36e', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '46d5535914f49229e72876d2e04532803402b581', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: 'fd51bc573b5680217557c139665f82f573ac394e', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '52d4e0f7fb4684579f7a2e3c325d3ad231c24099', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '425421278d44b31c9013dbd0f356f17454cda84a', name: "trigger" }), index.h("input", { key: 'e368a5445120b3025b89d26075067ee4739630cd', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bbeca6690be8c30becf46c0e24daba17786604b3' }, index.h("input", { key: '5973480460d575772819f503c91458cd54ae9cc6', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6dd5a48db851ea5add9ed168f275d243b98236d1', class: "d-flex align-items-center" }, index.h("span", { key: '45fb8b3420a6d2845cac73467bb9145408ec33ca' }, this.dates.from_date), ' ', index.h("svg", { key: '087aea17e006ad7113c808f888b07c0c619f63b8', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'dfec2cfe08e0026f2b7009f598f9378b1b66f880', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'cba74888902b01db0baf66e55eb2a5d45068c713' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'cca55acb81e94db1d99686dbd9a822a797b8c8fb', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '532dc60b6334ea6f7cf3353c4f8e11d7aac7820c' }, index.h("div", { key: '83fc14376c0bd6edad36f1fb73d23ed0ab46b2bd', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '7fc5bbe621c8e9b87785dcf0666d6434461a38e6', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '51daea59fde3489929f0e85002c04b1b5bcbcb16', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '723f482d7e000eb70c7175f783ebf07068ffbdec', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'c339b3f15dcd4e25cb89ebafebaea89d05f6eca2', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'c68332c15acab9f78a865bb0275d02b5916a5851', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'ff4178300f484e38a8e971bc873c3f31d3afce9e', name: "modal-title" })), index.h("div", { key: '58073f557293c0cb585891f58305104f74adbaaa', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'c802862673e42b004f5cacb6093208dc05aa29ab', name: "modal-body" })), index.h("div", { key: 'a31c2ba743383614fb0fa4156ef8c218d3a1ee67', class: "modal-footer" }, index.h("slot", { key: '6e56e8599a844163c7f49d3e8506ba1de008f4dc', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0561de7c9eaf4cbb16b7c568c623f25152ea8208', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'e7c77120d6e0f6a2546124da3d3826745cd3a400', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '9e567b59a2217fee40342d5857e9b60360852d6f', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3c3b12cc57452edbb2279351dceadbf3a7827e20' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'f403bb5dffcb7616ae67b335b61a46f1b5a264e3', class: "loadingScreenContainer" }, index.h("div", { key: 'f1faaf95796e8039418d5a38b5cc7a55189dca2e', class: "loaderContainer" }, index.h("span", { key: 'cbbc0b3f7ef530e559c4e5a0215fe13d05ac7b72', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '35d767f487ec119c9d9da918cbc622f88614b662', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2147674a79cefb4878fc921322fef7751012eb0c' }, index.h("section", { key: '5acddf2732b117d47c20e0fb830c3335414cbf64', class: "d-flex align-items-center " }, index.h("div", { key: 'd4ab50b9487a130eeeaa5821ab0e5245af725dd6', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'e41d4c00db236898b4fd16e8491ffb1c2e8dc840', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'd676f519a03312411a2b6fb76fa4becebd0f631c', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '4f2f790439e4df26f3b89e36e1c4db908b7d0f9d' }, index.h("igl-book-property-container", { key: '3195dc3de9e6a8c4097209baaf8f1547ad2837f9', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '940b201ce8ae400183f687aa9fb35a7afd4861f1', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: 'be5b88a24645c10e4b7f2ccd15e25c7e93183ffd', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '5cedacea47e1f169a2e74b4983591fba6248f34e', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '6221cf84885cc129feddff12239f806bd0705b8d', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: 'fbfa421d4185404eb056c9993f0553f5f6b199d3', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '98137851ed265bfe6ae053ce423537f6b632e130', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '58e2c63a842ca48bba362307e2c156f02ceffcd4', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: '59abe7ae2dfd0364be59831d486ee21ca5ac0e7f', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: '88ff73e95d04ee25a7f9d7aac6bebf5bc24b7079', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: 'dc271e0aa32b12f407ce6aa2eedfc7706d7c759e', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: '3180edb69033571500d6b9009dab8adf3e8effec', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: 'b29f8f20f56117a38bee7d5bf09cbbc0bb133325' }), index.h("h5", { key: 'ca7d63b9fe5a919273e3567f795901c8c9008b66', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: '4edb6530919fdf89ffad0134c2f276fd943a176c' })), index.h("section", { key: '9522f8a811c0b877844dec8d374fb51f51d9f262', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: 'f5e7279cac2ca209e14e69e50a0e048547f5de2a', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.filter_type, selectId: "dateTo" }), index.h("ir-range-picker", { key: '80acaeb1513cf8f25397c41c5186d95f330454cb', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, allowNullDates: false, fromDate: utils.hooks(booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: utils.hooks(booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("ir-select", { key: '14f92854b282332386337cf1293f26d08348dd86', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), selectId: "booking_status" }), index.h("ir-select", { key: '529231bbc65bea608b852ffd38a9977cc0bd268b', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), selectId: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("ir-select", { key: 'd821c83ee82939025f16c950776099d67b4923f2', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.balance_filter, onSelectChange: e => updateUserSelection('balance_filter', e.detail), data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.balance_filter.map(b => ({
                value: b.value,
                text: b.name,
            })), showFirstOption: false, selectId: "balance_filter" }), index.h("div", { key: 'b13079f5d9d32635231de6c3e4c52056b95c12f5', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: '6d251d48d19ea1cee8258d90ca463d7bc07d3f2f', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: 'f68820817e9ff9b86720fd718b67150f0367b78d', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: '4de44c9aad8e3ff682b30b07d143a3cba65fc89a', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '80a44ee85405b2632ccce87f31ace7b3b765dd03' }, index.h("span", { key: 'b490e27a60e80505c5cb1dc8797e6d3af0607cbc', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '841e28616ca2486e2efa301066b805370d937688', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '31974c32a205418c22889807468268b11f69e59a', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'f2d79aed303a880147b269e76753e4759b03a0fa', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '628a39f33c96c96e612a7834b2470722e94ce7d3', class: `ir-alert-header` }, index.h("p", { key: 'e904986ca858035c5a8e718e8fb4d2966254c60a' }, this.modalTitle))), index.h("div", { key: '1025ad3c328e2b62a98d427aeac62c42814e9fce', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'd8f2538e1248ab2a5b135dabcea0d658c51923b4' }, this.modalBody)), index.h("div", { key: '3879c1f7244a2824d8b1db2a6eb6e4dcb33b6ab4', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '9bc9e4b16d139dcdab62d2f39feda52c2c55496a', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: 'dd81719b2a26e0126fc78972e9da81f07621de37', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '297af21866ee1e6b8d88ac3efee60973a2d7008c', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8d5bf0006bf475cf6a5b9c047ddd69af244f986d', class: "otp-input-container" }, index.h("div", { key: '08e27aea00ac368297a9e7bc69829b2b923c4abd', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentAction = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a0c1de8da0c96b0ba1d03e19901366a26245baf8', class: `action-container ${isFutureAction ? 'future' : 'overdue'}` }, index.h("div", { key: '596590dcef716f23b191f8f13e71cdc8f8144ed4', class: 'action-row' }, !isFutureAction && (index.h("div", { key: '4fa7b061fc8444d2ec94d3d17c6f049755ac8d2c', class: 'overdue_action' }, index.h("svg", { key: '06156c7f0a9ef6cc890bff665caf742803184caf', height: 16, width: 16, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512" }, index.h("path", { key: '41f1fe45c1ffb9bce8c8bcbfa5a0c20ccf600342', fill: "currentColor", d: "M256 32c14.2 0 27.3 7.5 34.5 19.8l216 368c7.3 12.4 7.3 27.7 .2 40.1S486.3 480 472 480L40 480c-14.3 0-27.6-7.7-34.7-20.1s-7-27.8 .2-40.1l216-368C228.7 39.5 241.8 32 256 32zm0 128c-13.3 0-24 10.7-24 24l0 112c0 13.3 10.7 24 24 24s24-10.7 24-24l0-112c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" })), index.h("span", { key: '82126fb4e4a5d33a2da8d1d60de23d9521b6343f', class: "alert-message" }, paymentActionType))), paymentActionType === 'future' && this.paymentAction.amount > 0 && (index.h("div", { key: 'b3c43d1245c39a302601ca1bd906b9d2c9cdba3b', class: 'future_action ' }, index.h("svg", { key: '478944ba35ad9df65ab1760948ed03ac45384136', xmlns: "http://www.w3.org/2000/svg", height: 16, width: 16, viewBox: "0 0 512 512" }, index.h("path", { key: '49600735567142c3eca4cd5a1122364a32d392b0', fill: "currentColor", d: "M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" })), index.h("span", { key: 'd181b5c72fe65e48e1fd866a9e1a032ed59ec1ec', class: "alert-message" }, utils.hooks(new Date(this.paymentAction.due_on)).isSame(new Date()) ? 'Today' : 'Future'))), index.h("div", { key: '710698a3d329b2676406f8cc525e62b3626aa8fc', class: "meta-grid" }, index.h("div", { key: 'c1a7f4ce2bd44d5c9090e18c968393bcbb818db4', class: "payment-meta" }, index.h("p", { key: '59aa2698dce216918690c25a8767df7e54cefea0', class: "amount_action" }, utils.formatAmount(this.paymentAction.currency.symbol, this.paymentAction.amount)), index.h("p", { key: '6e815eafef093d3e5ff7603ecb1a8604f94fc419', class: "date_action" }, utils.hooks(new Date(this.paymentAction.due_on)).format('ddd, MMM DD YYYY'))))), index.h("div", { key: '12c261a6ad92f6df2f6f354506b7632649cd58ff', style: { width: 'fit-content' } }, index.h("ir-button", { key: '479215e1b9695892f500fae6d0bcdaaa54600ca7', btn_color: "dark", text: 'Pay', size: "sm", onClickHandler: () => this.generatePayment.emit(this.paymentAction) }))));
    }
};
...
const IrPaymentDetails = class {
    ...
    handlePaymentGeneration(e) {
        ...
        this.openSidebar.emit({
            type: 'payment-folio',
            payload: {
                payment: Object.assign(Object.assign({}, value), { date: utils.hooks().format('YYYY-MM-DD'), id: -1, amount: value.amount, payment_type: paymentType
                        ? {
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '2a8187232925f8b7be05a5d4c83701abcf27dac4', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                this.savePayment();
            } }, index.h("ir-title", { key: '92fef2faa274657a0074ebd4ad6fac4c2f62f720', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: this.mode === 'edit' ? 'Edit Folio Entry' : 'New Folio Entry', displayContext: "sidebar" }), index.h("section", { key: '112e4ed8720629d140992b968dd620552faa78f6', class: 'px-1 sheet-body d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: '4c945b8c692f638d45deb09af009b58bc73e2021', class: 'd-flex w-fill', style: { gap: '0.5rem' } }, index.h("div", { key: 'f38b5fb806b2b2d6d346e1ea3eff9974b59f0052', class: "form-group  mb-0 flex-grow-1" }, index.h("div", { key: '1e1f6b27ce91fa6d76a52120c0e873aed05a3c77', class: "input-group row m-0 flex-grow-1" }, index.h("div", { key: 'b3eee69e897bc52904d1d68c8995b969f98c873b', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: '7fbc7d39b3dee408e6c364e00fe95654b1eb8614', class: `input-group-text flex-grow-1 text-dark border-theme ` }, "Date")), index.h("div", { key: '29a341c6f1fa1254f10e6131e58ee66b8da0146f', class: "form-control  form-control-md col-10 flex-grow-1 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("style", { key: 'ea035d76ff516b1090ceff85159b820e168d3d2b' }, `.ir-date-picker-trigger{
                    width:100%;}`), index.h("ir-date-picker", { key: '81d8bf5dc04ad2c7a9374a2a4fd562c3e5b5b1be', "data-testid": "pickup_date", date: (_a = this.folioData) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, maxDate: utils.hooks().format('YYYY-MM-DD'), "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.date) && !((_c = this.folioData) === null || _c === void 0 ? void 0 : _c.date) ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updateFolioData({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: 'dd9652b2b802aae27573855b3e5b01a8cfc267ee', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? utils.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: 'a5dc2a3e812d896d805ed7bba1b163666f6fb268' }, index.h("ir-price-input", { key: 'd660d9a7c33fac2a5695470532c5418db78ffa20', containerClassname: "row", labelContainerClassname: "col-4 col-md-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: 'e34b0067245388db1d9e31cf1510b7e3d079cc07' }, index.h("ir-dropdown", { key: '327379f38b2657d7b6fe46a79097f732d9ac0e51', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, disabled: ((_p = this.payment.payment_type) === null || _p === void 0 ? void 0 : _p.code) !== '001' && this.mode === 'payment-action', onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: '6b2c28631618121d8323c317af777552133032c2', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: '6d4fb964b368f2d6f96246a4c493ac7e09233b97', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: 'b045229e9e50cb4bb4665185279f8397e9bed1d6', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: 'eb5c06f1d7c43a85a940534148833a74f0f2035d', type: "button", disabled: ((_q = this.payment.payment_type) === null || _q === void 0 ? void 0 : _q.code) !== '001' && this.mode === 'payment-action', class: `form-control  d-flex align-items-center cursor-pointer ${((_r = this.errors) === null || _r === void 0 ? void 0 : _r.designation) && !((_s = this.folioData) === null || _s === void 0 ? void 0 : _s.designation) ? 'border-danger' : ''}` }, ((_t = this.folioData) === null || _t === void 0 ? void 0 : _t.payment_type) ? index.h("span", null, (_u = this.folioData.payment_type) === null || _u === void 0 ? void 0 : _u.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: 'd8660579f05776e7e60080be5920bdd7b5a9fece', value: "" }, "Select..."), this.renderDropdownItems())), index.h("div", { key: '7f9f5ab7178e8acba7035b75b405a4ae50783da2' }, index.h("ir-input-text", { key: '0fa31134e58e80cc826add4baa65f08f8fe50744', value: (_v = this.folioData) === null || _v === void 0 ? void 0 : _v.reference, error: (_w = this.errors) === null || _w === void 0 ? void 0 : _w.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3, labelContainerClassname: 'col-4 col-md-3' }))), index.h("div", { key: '9462a08e75bfd69770c700b1cce1ef3aab9a6e79', class: 'sheet-footer' }, index.h("ir-button", { key: 'ee88fc7781c1ea7367e6d3e65997d9d997fff9a4', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '3966efadcc73a1c243511ba5a9634b7f5a1aa003', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7fdb2148668b464d9006909940120adbe5056c80', class: "payment-item__payment-item" }, index.h("div", { key: '9b18f14a63a8287d7bc305e4cd44872c7f618597', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '05c67b021b5b5d1d10096aa4a461bc6682657cf8', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: 'efdeae11a9592ec01105911943f3d6b98243b93b', class: "payment-item__payment-date" }, this.payment.date), index.h("p", { key: 'a559bdf42084594d12b2b93475c8ab5893bde3be', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '9a44153e42e63200c6c739a69124c3384c4ac529', class: "payment-item__payment-description" }, index.h("b", { key: 'de95bfa7e82bec3ddbd2dd58d848f55d00060707' }, (_a = this.payment.payment_type.description) !== null && _a !== void 0 ? _a : this.payment.designation))), this.payment.reference && index.h("p", { key: 'ecd0429e0654b1b88191e1ef6b3fbdae62bd4e75', class: "payment-item__payment-reference" }, (_b = this.payment) === null || _b === void 0 ? void 0 : _b.reference)), index.h("div", { key: '4ee7d42ce70ba128236a45c7862caed80ce4b715', class: "payment-item__payment-toolbar" }, index.h("p", { key: '4339848d45f0368cd0f964c22762bd69af6a6282', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '1b5ef3f2d14e3ce9656ae353890e860b46c50820', class: "payment-item__payment-description" }, index.h("b", { key: '98c821811535957e33fb8f513c9707bf81c038df' }, (_c = this.payment.payment_type.description) !== null && _c !== void 0 ? _c : this.payment.designation)), index.h("div", { key: '82e0acb526ee0b2adba983f325b5d48cb0210c75', class: "payment-item__payment-actions" }, index.h("ir-button", { key: '6c71e7cb40f94d42b5f1f5a11295c4da8d20e6a4', class: "payment-item__action-button", variant: "icon", onClickHandler: () => {
                this.editPayment.emit(this.payment);
            }, icon_name: "edit", style: icons.colorVariants.secondary }), index.h("ir-button", { key: '80f1d309b7c013c364d6603bcdbcd663c93a0926', class: "payment-item__action-button", onClickHandler: () => {
                this.deletePayment.emit(this.payment);
            }, variant: "icon", style: icons.colorVariants.danger, icon_name: "trash" }))), this.payment.reference && index.h("p", { key: '4dfc422173b60ea11b578dae6277f092b7f460ff', class: "payment-item__payment-reference" }, (_d = this.payment) === null || _d === void 0 ? void 0 : _d.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '0db7213420cd4bdcb26ca8735cf010104d09326c', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: 'c08de0c61f23c7e72bd6205b1d19ae60756b4b4a', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '07cc1c5edf8d6a11d7fe75a7a2df158d52699357' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '33ffb7106478aa641bef6dca170bdf63920ec7d7', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '1df5186dd2f90d9bd93793e7d7af7a05848318c5' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '2a0158f7fee29e20e2c0d5c8f8d21c60e40c76c4', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), index.h("div", { key: '501319c3de850f9b447c2fb2ac0bc5564de97347', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '8b1a9714c71eab98bd15ef0529a6fd64b28580eb' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: 'c68c261db825c5d9db09e5ee1aaf01f60eb1823b' }, utils.formatAmount(this.currency.symbol, this.collected)))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("div", { key: '5de39847ba10b5f6f71c3c878422a753e27e7bc6', class: "mt-1" }, index.h("div", { key: 'cead0e15b39c3fdcb70cc5f340b3a56a227b087f', class: "d-flex flex-column rounded payment-container" }, index.h("div", { key: 'dd8582187346cb63f7081406c8a9f859ded1fbb0', class: "d-flex align-items-center justify-content-between" }, index.h("p", { key: '06aa5207487feeea895b23a7adddaa5397fae06e', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h("ir-button", { key: '09c0edb8b81ab526461ebd8254775e91a342659c', id: "add-payment", variant: "icon", icon_name: "square_plus", style: { '--icon-size': '1.5rem' }, onClickHandler: this.handleAddPayment })), index.h("div", { key: 'd264f7bb0d68be53a551b3554cd60122ae458349', class: "mt-1 card p-1 payments-container" }, this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1398dbcc8939973dff7f6b7960f70ef49a557550' }, index.h("div", { key: '3eb0eb31deda892f771fe0e0202bfa5a999eca21', class: "form-group mr-0" }, index.h("div", { key: '78ae33e325acc861f6a9f32569105b5eae1003fe', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: '90661f3c4847beb4cf3ce142c88cb8ad506a9ca5', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'e124eb05b7a8a7cd98bbe397cbed93f1744bc97e', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: '44073d438c0c3688de3afafb2c5cabd8d6479a50', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '6f1e875dc6ffcdab5984ce44799fd782f16a359d', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '842091c308703c40bf1ee9c5c3e85c9f6035a5d9', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '1c3d85fd5eacddaa908e56b10a409d3ef87e396a', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '1a49c13ae1d191c4a4b1b851d245f1a54a4e2a93', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: '5babc41d2b0f1ede3e60316b846b90f35329d256', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: 'fe6056dc15647119135c015f4c470c8a6c8930f1', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: 'fee57e519fe28ae3f99a86ba01d5e757c365f71f', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: 'be555c645d1441abdb9db0c2fcf98b4fb0e7dc84', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '85631b5e7603358aa308a6a0bb0d6734659737b3', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '80511acbf177d11584a9aa4a028672465e65a720', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '15790f00c2f0cedd2d54f1bca733aeb971f0d4cb', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '772c1d9e0b66b30c4de5588c41665cba1f3eb0f2', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '6ab57c70989a2f9fd61204edc6e1dcd53ec0d467', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: 'c6f1792f6c79fd60c4734ea1a9bf0dccb42bd570', class: 'd-flex' }, index.h("div", { key: '867dfb42aa449711f17d0c0ad1e4687e5d08a877', class: "form-group  mr-1" }, index.h("div", { key: 'ecbfab1c8b044a42003eea84ffcb841fe8462de9', class: "input-group row m-0" }, index.h("div", { key: '8933609e91d9b40e37a22de8e2267e261125c606', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '7b2c15e75bdcd495bd3ff37927c4f564d808f464', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'f5b539ded301f0307390e6dd9d7015403179e9e3', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '110965ff499d1fa7aba62fb7838f8f2a708a4745', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: 'f792fccf58f635550792f13935c9424e7eb977cb', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? utils.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '44ffd7d2dbee47f331ad6892dd2a6b947269c6ce', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '82b7333b9df5cc29fdeed37b30ccdb5d6452f39b', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: 'b5d6258c7f231bf138b5abc8338b39ed041a54dc', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '61b16f17ea000920b0f7f089b5f4c80e17d872c8', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'b8fe820334423e3899422b04b0a85155627bd65d', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '77d91b73caa9466cb0cea6f64657ce4eaafb942b', class: "price-input-container" }, index.h("ir-price-input", { key: 'd714cfe4bd31cb7176081e1fd48e39a950a5c503', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '2881d80f0f97f2077c0bb801f4915a623f3a9733', class: 'sheet-footer' }, index.h("ir-button", { key: 'cccd89b867d16b5f3ad317bfedbfd83a6fc20d56', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '6234d96cb10ff0ef6885b4ac61bf3498ada30227', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fa9fb3188673d8b4af134d9dab37b01314d36bf4', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '7c57464608a7300aa9930db2389da67999e6c14a', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '495ba8cca220933144811f51c5e20bb3e72465e1', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '7125ca72848349363bb3ecc731acaf48d6477144', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '141fc39d68b452098c0e74ddd65aba9cf1965177', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'eaa593866a722216e6920ef2e3eb3b5993faf2a0', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'd134ceaf26e7920ee0a64c50c33136eaf56b8f57' }, index.h("span", { key: 'ffc0dc4916792aade16b190c60266a377ea7b400', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '26f3f9498e99249c193454d8ebdd1167330f3d99', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRangePicker = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'd62f8a7861db176b9bf26cb4104b941150571dc4' }, index.h("div", { key: '1a37321c00593dcfb034123b20a0fe74ce0bda51', class: "form-control range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: '88d6586fe628656eaa9b2a8ff6cde0b79e44f626', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("svg", { key: '9a44847dae3ac4371477f506c3fb18b2f3ba3799', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: 'b9785c0412126f4c71ec2bf604cdcd1ac1b606d6', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), index.h("p", { key: '4bc0afc83be6368cb593a099bbcc66d0cad9fc56', class: "m-0" }, index.h("slot", { key: 'fc153736bee400581b22e13c49d4bddbc258b462', name: "message" }, "Cleaned on")))), index.h("svg", { key: 'b0b45d07278b9c3b044c0730ae65c390504203f3', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '6120425fc8e075c30eb4953309326e5bb157ff40', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: '790407292442258bc5b770e2ee83a0e60a7973d9', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '7856f1901aa83e85cd11249347fdb7812f6605c7', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, ((_a = this.fromDate) === null || _a === void 0 ? void 0 : _a.toDate()) || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '92eac6fa6e93490faa787479a5091a6c19e80929', class: "card" }, index.h("div", { key: '3f26739bc1f05227782b0d35ce37deff5f8a6603', class: "p-1" }, index.h("p", { key: 'fdc6dc43689e77f30c89236036abde550455c351' }, this.booking.property.name || ''), index.h("ir-label", { key: 'be557697ade21da9e1ea0174cd226e594b97709b', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '389f42f38c7f266aa2419741a41e48a10f161cb7', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '2ec61d11dd45273b664d4d7f5658bc7c7148adde', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '11a259895bfbdfaa77013cfc300b963e56913d4f', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '0c33030c3c2db8773b5704a1793edde20b91c574', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '3f1323a4b4e806dc310069bb952eccb48362a004', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '2e3ea49585879f2717c7f05e5cdad41e05564496', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '43c17bda2a64bf1c589acda108e0210400c6d9bd', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: 'fe0246a6ea96f1a223c534fdaa5ab2812ad802fb', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'afcdb3493cc6b02b673fc3dbacfea4011f3fa76b', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'b118152400a57a94963135e814429d92cdeab680', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '0e2261b5958dae961dc1a1b18e87ac5b0dac1ffa', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '5ea13fb444e851c8169cf27dd47fae8718752a6d', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'b3630fbf00343934660e5f6379466efcc6a02f2e', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'aa4ed8fe291379d4ec0cb61769874ddb04771cca', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '73c2443c6e73b8bb8861565a9fc802e76da620e1', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'e876f51b39edc88e2195f285cfbf68f8dbd47089', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '2bb13c01917cfb3e4dcbd60b1006f9eb1debf2fd', class: "d-flex align-items-center" }, index.h("svg", { key: '30db84122aaf443f90ca00775a2f616b4f4cce96', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'c9df765e3b640933cf9ad11d393d4761313b2e02', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '4c8a50680fb4c37dfdeecc8a8da74bce09fcb7f7', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'd6cac42a945972b0ad4ab7892e6e12e0e5f38d23', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '732df9777b6b271099c1cc8d676ae7f62025054b', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: 'fa3558e458a881e6110b828e9e0475cc84a27cfb', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5a761c15b06b83a8fdff91650badd21a180ba8f7', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'cf810ee2c56f52634407ef6af6470d15b66895b4', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '6a95425efc5d2f774c885bd168533a97d570ab76', class: "flex-fill m-0 " }, index.h("div", { key: '308c74d5f9c960a1f3c143e6a9d17ccd91c1cda4', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: 'ace9af8afa70929f4237abde4a02d27d5d39ffc0', class: "m-0 p-0" }, index.h("span", { key: '2077fa5cb129922bde60e83d6636b0bea49d9ded', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'c673a03861ae04b0b198ac1ad8012a3a6df40782', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'adcba2d1c0e914fb5839f298b5794f65d1869bc4', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '3eb67b471f2380d928a797e104e30bd18a31412b', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '8227f90a1b74a191f638cc2f0bc0871e931705f2', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'cac639a537b396a57524d224ae7ba3c71da78d97', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: 'a692392b2bd1e5913f6fec679c0abc2f704f9b09', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: 'f19005592ecdf0fe1fecfa06e534b17384ed55e4', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '9031af3c72e239c52272a21d3bf46d58f48d8095', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'e2aa0cb4dd81912d76241acc0522bb12fbfc253e', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '07e7226046188848f46d0e2211034ecb90eca9ee', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '4ebd170e3c92dc5b784c53aea53779e7f0ad2a6c', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '50eb92b5a571492b5866bb096c509e0419483830', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'e0dde1b3be1deea7b88552b676591d45add57879', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '24c3bbaef386fcb14e1578c4765908f1d1a7a2ed', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '6909e22f456a7a2ab5b668a78d5568ae87500234', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: '33e248772cdfed1aecf81e1a88bd842900c03df2', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: 'c8e83a62b9f88159f7c6caf4851a6f3e4ba6e207', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: '5c5c1ada9f82810bdd5f808bf751adc9a7626975', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: '7c06637a9a879d29c50323671a0b2a4a8a589873', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'cd7b4bb94905f1ec41e44d2afbed53a5fd54f62a', class: " sm-padding-top" }, index.h("p", { key: 'fc553a9c1a758898af21a8fa385706b14416efb4', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '733d1ac83a2f54b1b56fa21bbdd551b98a703d46', class: 'flex-fill' }, index.h("table", { key: '48f4a4c3db790e7833c69c138c8e578df41cc27f' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'a6806939a1c08d96ca1b3d2bfb4c45230673bd6b', class: '' }, index.h("th", { key: '84bf11a624f5f4612d749d290699d21e6ec36ef7', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '7b2567d4b95a1129544dac4d8ab9dabeb123a94e', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'bba670e1803c4f46e141ad54d06ce8f9f000051a', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '8cf5ecf3452f5dd29cc575b3636114794793f960', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '150cbad6349617142beb128a7b84e0e33a74bad1' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'e754ddc9d8085af5c6ab27776d02ded8c5f2c118', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'dc8dd28c0cb725f26d97e774492b1c9462d71556', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '209000196075c661ae0cefdcb1396bb7a8c82c0f' }, index.h("ir-label", { key: '7a57369d6ffe2c85438f36d28be47b117ffcc598', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'da42cfc05e070708299cc24354d38ce8f675b421', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '427fdf4c7d49d068f666a1a1145aeca2ba80374a', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'af5c544a8c3f7b80fc5b8be8b2c672624044e7b6', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '857eec2e4fea2f250426dde855c6423423b8f778', class: "input-group row m-0" }, label, index.h("select", { key: '85fb218c78138ec48cad26fabb0030ab125c16b5', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '8e9d019d8ce91920a99ac90a1fc9e0f1cbd41d97', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'f7f54f50644d14dbb219a56e1ff2314561f51dea', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '9f9d053de42b8bf4826b1efab616dc982026d327', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '865262a1c270f1b93754ffa74946b5703e784fb3', class: 'sidebar-title' }, index.h("p", { key: '5827311360348768625bff5fb59ea3ecb94a705c', class: 'p-0 m-0' }, this.label), index.h("div", { key: '6cf4f30528b2ef3c4beb306015cfa5a5169fb4e5', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '5e555fec065c2fa097c3da1b8c71bf8bc87085b0', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '00375534c5dfa64c59461b5d36b3d503844fc742', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'c9b10bd70eeb3ba2fbc2e8f4cca5b323b4eb0b31', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: 'a460d831f061877d312d5bb42405288cdd3d2488', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'c2b6b00b99d34fb9bd4cc55f0156f2e87afa7553' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cc3d9e428448fc867c604596d67b7b5e6501f72c' }, index.h("h4", { key: '9ef7ea978cb38ed6a7b2a652e795560dc7482dc2', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'c2f71439d6eb3d3fad541c2cc9be1502aeafab87', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '0ed1bdecd347375195cbfd7ff535f48398d4d51a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'ef05d7da4c004e39797b37d7feee494910bd3c50', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '551be56ade61dc9760f7ad1f5023d1c1ac9586bf', class: 'title-body' }, index.h("slot", { key: '8ff875b3c9d86f7f1ed9eef09df27cd5ef1bb9d0', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
