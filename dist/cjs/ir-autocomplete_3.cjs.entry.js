...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3460598fda895bb8ece832ccbbe854472b1f734c' }, index.h("div", { key: '67fc440325a391e3e19045a27e29e7c9c23f22c6', class: 'd-flex align-items-center ' }, index.h("label", { key: '667df22ef8f110a56a28aa68fab442da96966358', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'fc17961d17b718ac9832c11c7b773cddb4038107', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '3ea21e576733dc3a1d1dd6b7c76a654b87304f3f', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '050432ee60fb77e4570b89f8d78a9eada9e65738', required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '3f99f17dcb57f2b847f4af50c41807ac92c3e25d', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'e037c1eaf482a371162bd5200761c97ffc759a89', class: 'sr-only' }, "clear input"), index.h("svg", { key: '6941dbd572db1e2b8117f857ce8146c8411a8950', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '5fca25883ee9b487df378a5107cd27b017ffbfd0', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '7c4578abd6e25983923ca791fd765fdc77bdf3c1', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'e1ad37f2a090dcb76ad1836c874d5342eee23f27', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: 'b45efdfc5b8a42db93e9dc74042235de11df22a4', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '15e066d8af04660c4c6d3b60b5aec54d38552815' }, index.h("button", { key: 'a0a8740d4c89f23e61d50f7a3f0af6a49e70ab4e', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '5e675f41806c905562ac526b4544ac1e6bc53356', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: 'f9fd564d904173629ba7372ed9e5fec19fb44cc6', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'f9d8e260d9085900bbeedd21aa0d00002637fff2', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '87ac990167b87b16f25d9e5e9bfbaf749543a23a', class: "dropdown-item-text" }, "Invalid Country"))));
    }
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '32b1f8b73559c72243b6452d36cddbac9906392f', class: "m-0 p-0" }, index.h("span", { key: '8796418727a58a2a75f3013fd1957b58a9f0a6a3', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '5b51c90fb1158870c4a024b57c5216d10e154599', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '30db9d9bcd6bd0590bd57422753671ad31c2538f', class: "tooltip-arrow" }), index.h("div", { key: '1b7804704cb18e09ec1f7139db17e4c5cdcdecde', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: 'fd3168fcba101b202a165b4301643d4d0e705439', innerHTML: this.message }))))));
    }
};
