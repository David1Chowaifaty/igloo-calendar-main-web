...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6dc1a6befc292073946e0f2b7ad3004ee05b49a6' }, index.h("div", { key: '0e4cff319fb613477031eb10f8d4845abf04e2de', class: 'd-flex align-items-center ' }, index.h("label", { key: '1f4fb3b69ca7c6a8568fcadca5fef0f0de223310', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '22c26f9273ae16d5d387291237cdc30d353a316f', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '22f4238fe6b10ac486520d9ce02dbd21d1f7f062', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '7ac34d00a932611a26895ffebc4a65b93caf29f8', required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '463a58014b5b1bd93b10631ecf0d44366ab19e87', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'c576311e1e3d41790483eff9c795e18945310c6b', class: 'sr-only' }, "clear input"), index.h("svg", { key: '6f034bcc77c7077914e64fbb85d42ac4c12b9a90', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '8429735d10a1b46a751e5a769fb8a442f40ab5f5', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '2a3fc259e7261e5f5f4e204964fc4c15630dbdcd', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '4b171513d8cec644f5f1b446b9df065d058a0acc', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: '3d37aea49e71eb88b46b5d7d77c0f39841219e0b', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '68f799c887561b1e31ec3caee3bc0f127f0d4c9a' }, index.h("button", { key: 'b39c1dbd5ea5efd8653eaf1765b68efcf42193d7', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'ca26c43c36caec9d30567526792d6f87d43f0032', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '73407e42021896a69e428bc3d0fb9e138fe06644', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '4fe04d44018af5a526b0d14d1eea9254870dbb7d', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '16e9994a9cc4b3e7970add4c65bfe1bb67c6c52b', class: "dropdown-item-text" }, "Invalid Country"))));
    }
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'afa64e4086ba33d45931097148f39cd325436c77', class: "m-0 p-0" }, index.h("span", { key: 'e39f176bd77255e13fd70364a795b2d9aaa2c616', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '6d77b9ae72132fe69f0d1949ecf53c24a92e2264', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'e0ab01c9861e1c0d58b5e1561355b6f32ef1f236', class: "tooltip-arrow" }), index.h("div", { key: 'fa8fad2bd3fc71fd75eaf5067ec52d510dba4efe', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '529b9848f8ebb9ca33ed5a30cd6b95e7c1bf4639', innerHTML: this.message }))))));
    }
};
