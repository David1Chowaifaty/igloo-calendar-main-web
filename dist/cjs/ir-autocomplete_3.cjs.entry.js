...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6be977b3e3b0b2f758476472843e54e93f2471c1' }, index.h("div", { key: 'fef69482d31df976969731837061d8b635b36a7d', class: 'd-flex align-items-center ' }, index.h("label", { key: 'b2761a953fd2d434dac696fc87857e6bad725495', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'df2a3426a34f15aa92adcc45ee47111e08e09f44', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '5c9aff7c0388ea72c6177457a993d21ddf5188c1', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'd6580c1430fb86c3e48200b500b3ea69883b3ca3', required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '3d38fb5db4399eaef226c246106284900c28d846', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '059638faa1d11c7e5438a60d7634896d994e0d83', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'fb9129b9fb9f99e182ef80a6fc7db27a8d5c263d', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '72ac39cf7a03c6bd6bb5bbbdf78b073c6e4c7099', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'be37ee7bde4a67329ef13d0b1dcf2ba4318ac806', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '9cf67e556de030882d9fa496e60ffd676b9729f1', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: '26b06e9f764cf310b7d80c82eaf79e2c46b4dbb5', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'a635a034a25c7e6ede059ba9c01995f3a4752630' }, index.h("button", { key: '1e4bc695eb54ba52a0f7c8fbbc859e880c9c0da3', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '8808d588432a673d78fc7ecfc9f107335697dc80', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '2594bc5ca8d6aa4bd523eb1d7e8580c4c4f2e311', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'bd491f584c86c659e2cefb6b248d6fdacd45f608', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: 'b339104da54c474e13afb526bde386df9d1efa11', class: "dropdown-item-text" }, "Invalid Country"))));
    }
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '872b036e08c56c608bf2ea520b1aab4b392d3a72', class: "m-0 p-0" }, index.h("span", { key: '05f8a99be1c99d8d7c6c05a1b14552a26148cf88', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '19e239ffa1c970571cd2803928b38272d270b920', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'e17498aa71de420f87c99a2b78339cf9a7627afa', class: "tooltip-arrow" }), index.h("div", { key: '2fba9b3b9150c883af6abaefbf5f0f5c26859218', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '615163e9e2e5b9d4959dd59f445c8af81a3dd165', innerHTML: this.message }))))));
    }
};
