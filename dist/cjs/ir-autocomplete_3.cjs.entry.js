...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1c599a08bd8f7169389a496cfaaa240424004ac4' }, index.h("div", { key: 'b6207d340b00a8f8610935bb5da661d9d41ec20b', class: 'd-flex align-items-center ' }, index.h("label", { key: '0b3e9751f4bd6f15d6727bad6acb859ca4a5fd84', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'ec0ef87ebae4fb7371fa5e1e5977c876dedcef80', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'c9a1933852e416099a17af719012d2ce53290eaa', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '4c9ca3ef69e204fe3d53b5039273e263b4d54ecf', required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'b249b90fae816f3526a1ccb73d86ee0a128604de', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '02aa75c5e3fba7da27973680362efef3129f63bc', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'c293f4c66f75978328863e7cdabc56d6076fa42c', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '364b0380dec935ae7bd285d9a1f8272f42896da3', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'aa0217b2e49cc9a00f70738ce7521bed0fed46f6', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '7a23543c3afe951886b243ec69fce20d4bff82b8', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: 'd381b5553bcea78326a02d05e95f837b97c62ac3', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'cb5b9f4f8dba42e716defd775f09f43c9d85cf5a' }, index.h("button", { key: '1c237791ca448b0a663b4e699b2bebbae09c6504', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '1597d9d353db99238cffdc980b2edd74be11f204', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: 'bbeb15ecc63e15a7937991ad94c597c1f7d5f560', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'd057800844adcfea86b7026bde4a985d4834e4e5', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '8cccbabbad3050fe25734bbcad233a7ee4b0fc69', class: "dropdown-item-text" }, "Invalid Country"))));
    }
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '08f4e1c8edf82caefe7a69e2339b076174b14e3c', class: "m-0 p-0" }, index.h("span", { key: '179dfb8941566088695dfc4f9ce77e4366e1a732', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '2ff75026e22addd97ca22a9e6c3304cf101146ad', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '3e95cdbe62c0e144de40d7b0b5493544ee295813', class: "tooltip-arrow" }), index.h("div", { key: '792b89c1f0ab9c90ddacc4d1f52b09d35d5915ed', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '43f3bd5b8cd95e3c000b589966900fa5b377ad9f', innerHTML: this.message }))))));
    }
};
