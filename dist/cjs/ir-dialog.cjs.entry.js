...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '8f64a4aba8681adf340fdc4eed686517e5b4e070', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '98e26b5dcc7f92033d94553782221b262fa2e4fe', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '1cb6799b449097fc374d19b802494b7eb924e59f', name: "label", slot: "label" }), index.h("slot", { key: '714cf851b9996477d2e6d69c9737a97522b15db2' }), this.slotState.get('footer') && index.h("slot", { key: 'a45091be0f7274cc5666a57802c38c5167fdaea2', name: "footer", slot: "footer" })));
    }
};
__decorate([
