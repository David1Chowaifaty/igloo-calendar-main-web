...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: 'cf4a35ba7cdb605f0666e95c069d8045bb42c958', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '2ae2cfaf2a7c48d23bd319c4a5e79874ae59346c', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '11be27e8b08760b46b7bbba6dfde255247ca6a87', name: "label", slot: "label" }), index.h("slot", { key: '9bc92e7f5c11faa23c02a3e3b78a281640fe6ae9' }), this.slotState.get('footer') && index.h("slot", { key: '05466c17f8fb81ea11f1828c202cb759d3fef576', name: "footer", slot: "footer" })));
    }
};
__decorate([
