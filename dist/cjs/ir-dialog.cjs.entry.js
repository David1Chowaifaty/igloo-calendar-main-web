...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '882e2cb597eecb202a55eb505761cfcb000f0afd', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: 'fe89fc90288e31fad1c57e2cda02d8332558bb3d', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: 'cda0fbc265a1e447fa7181251fd36b2656812604', name: "label", slot: "label" }), index.h("slot", { key: '87cb8b48d8f8e82aafccb0bc6fc312db8502923e' }), this.slotState.get('footer') && index.h("slot", { key: '7a37cf6c0acc1545a80bb27c23f329d66d2035e9', name: "footer", slot: "footer" })));
    }
};
__decorate([
