...
const IrTaxInput = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '28698516bffdd414599c9bcf3d4418e2365cd7b8', class: "ir-tax-input" }, index$1.h("ir-validator", { key: '970dbb8745200bd17dcac62f69080e71f9ac5e7f', form: "tax-service-categories__form", class: "ir-tax-input__percentage-wrapper", value: this.tax?.value ?? 40, schema: this.isTaxInputDisabled ? index.z.number().nullable() : index.z.coerce.number().min(0).max(30) }, index$1.h("ir-input", { key: '25dd52f8a63f44f9afdcfcc216c2ec323e62bc4d', disabled: this.isTaxInputDisabled, value: this.tax?.value?.toString() ?? '', mask: {
                min: 0,
                max: 30,
                mask: Number,
            }, onChange: () => {
            ...
            } }, index$1.h("span", { key: '38c3f64cfe8731404cac04358c6305be24ca9389', slot: "end", class: "ir-tax-input__percentage-symbol" }, "%"))), index$1.h("ir-validator", { key: '109082cccf03487a485255dd6ee55d5fb07a29f7', form: "tax-service-categories__form", class: "ir-tax-input__select-wrapper", schema: taxSetupSchema, value: this.tax?.mode || '' }, index$1.h("wa-select", { key: 'd336cdcfaf6c28d53d5de66fabc370d5783eb41e', part: "select", class: "ir-tax-input__select", size: "small", value: this.tax?.mode, defaultValue: this.tax?.mode, onchange: e => {
