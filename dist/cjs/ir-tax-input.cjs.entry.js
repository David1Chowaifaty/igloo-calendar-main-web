...
const IrTaxInput = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '4cfc3df5936d9a30f4fbfc1ef56dd6ae36c56515', class: "ir-tax-input" }, index$1.h("ir-validator", { key: 'b12ea50e3d78b612c69faf9ff7633185e8b4e2be', form: "tax-service-categories__form", class: "ir-tax-input__percentage-wrapper", value: this.tax?.value ?? 40, schema: this.isTaxInputDisabled ? index.z.number().nullable() : index.z.coerce.number().min(0).max(30) }, index$1.h("ir-input", { key: 'a69dfdda0d1017fa992f89a6f7389139b7af87c4', disabled: this.isTaxInputDisabled, value: this.tax?.value?.toString() ?? '', mask: {
                min: 0,
                max: 30,
                mask: Number,
            }, onChange: () => {
            ...
            } }, index$1.h("span", { key: '401455cbd4d6b94b32e4a776f27a846189e3d8df', slot: "end", class: "ir-tax-input__percentage-symbol" }, "%"))), index$1.h("ir-validator", { key: '6130c705a557f472811fbf5c8f85e3c48d10d513', form: "tax-service-categories__form", class: "ir-tax-input__select-wrapper", schema: taxSetupSchema, value: this.tax?.mode || '' }, index$1.h("wa-select", { key: 'e0455ee8e32c21eb0e2378fd9775a1ce7f586745', part: "select", class: "ir-tax-input__select", size: "small", value: this.tax?.mode, defaultValue: this.tax?.mode, onchange: e => {
