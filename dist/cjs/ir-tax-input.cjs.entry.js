...
const IrTaxInput = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: '13136b242312cdb6d16f6c1716c6da6de4931039', class: "ir-tax-input" }, index$1.h("ir-validator", { key: '955d923b120e697a68c5de823793a3606d215234', form: "tax-service-categories__form", class: "ir-tax-input__percentage-wrapper", value: this.tax?.value ?? null, schema: this.isTaxInputDisabled ? index.z.number().nullable() : index.z.coerce.number().min(0).max(30) }, index$1.h("ir-input", { key: '9566fdb42f889783c0879f3861063fbaa6c5369a', disabled: this.isTaxInputDisabled, value: this.tax?.value?.toString() ?? '', mask: {
                min: 0,
                max: 30,
                mask: Number,
            }, onChange: () => {
