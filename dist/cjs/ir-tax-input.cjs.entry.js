...
const IrTaxInput = class {
    ...
    render() {
        return (index$1.h(index$1.Host, { key: 'f941c7b213520ff24ba7cff73e156a772c7dfe09', class: "ir-tax-input" }, index$1.h("ir-validator", { key: 'a727949f22d2e89b6cda8f3fc0e1f17173a5d012', form: "tax-service-categories__form", class: "ir-tax-input__percentage-wrapper", value: this.tax?.value ?? null, schema: this.isTaxInputDisabled ? index.libExports.z.number().nullable() : index.libExports.z.coerce.number().min(0).max(30) }, index$1.h("ir-input", { key: 'e12ee9810d78a948fc997167642c3809eab1fc62', disabled: this.isTaxInputDisabled, value: this.tax?.value?.toString() ?? '', mask: {
                min: 0,
                max: 30,
                mask: Number,
            }, onChange: () => {
            ...
            } }, index$1.h("span", { key: '145c399fbcd738e2e25538c7175def3e001ac4a3', slot: "end", class: "ir-tax-input__percentage-symbol" }, "%"))), index$1.h("ir-validator", { key: 'a42d4d518b5e2ec1a607e974aff1f3503f52788e', form: "tax-service-categories__form", class: "ir-tax-input__select-wrapper", schema: taxSetupSchema, value: this.tax?.mode || '' }, index$1.h("wa-select", { key: '9a93f9fbba6eb23c7f0e628eb2d963d7a1ce7c90', part: "select", class: "ir-tax-input__select", size: "s", value: this.tax?.mode, defaultValue: this.tax?.mode, onchange: e => {
