...
const channel_service = require('./channel.service-bab68c97.js');
const channel_store = require('./channel.store-577c2108.js');
...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'f05588c730666a315a2847049decc9b55f6df515', class: " d-flex flex-column h-100" }, index.h("nav", { key: '4b5fc168c75ad6b1ee32406516b9e69a287b31fd', class: "position-sticky sticky-top pb-1 top-0 bg-white " }, index.h("div", { key: 'a381e77c5c3a010efdc6f7de08e58c5acbdfd8b2', class: "d-flex align-items-center px-1 py-1  justify-content-between" }, index.h("h3", { key: 'fff441b621e564f6c4d77b0c2eca2c83fce9a014', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), index.h("ir-icon", { key: '320aa960a57685dbed6577bb7ddff1433b2e2ab6', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '56ee08491b53ce6e4bceee7cac551c9cfc44c1ce', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'f42b969f329d580bb57c4ef767c2a75a7b51fd41', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("ir-channel-header", { key: '8aa965b696744e8d0724a1f9167fc6a8912024e9', class: "mt-1 px-0", headerTitles: this.headerTitles })), index.h("section", { key: 'c973629d616e8bce2a2cfdc9a47eeef0645c0bcb', class: "flex-fill tab-container px-1" }, this.renderTabScreen()), index.h("ir-button", { key: '58273c2ce3aecc078b6a6f69a09331fa6a6c5cf7', isLoading: this.isLoading, onClickHandler: () => {
