...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '8fafdfb6f3b3d70d0c3cf182709b905acc31744f', class: " d-flex flex-column h-100" }, index.h("nav", { key: '6bde2d6eae42c26b8c675a5e3cee63c98d007aca', class: "px-1 position-sticky sticky-top py-1 top-0 bg-white" }, index.h("div", { key: '2317d733974de200132639eb121db54183f85e73', class: "d-flex align-items-center  justify-content-between" }, index.h("h3", { key: '4c259670cbfb796238508fcc3050b913994e0034', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), index.h("ir-icon", { key: '5053d4b54f9d5cd8d0034ba249f0dea0fb6dfd9d', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'd88cb248699e7c4695571dfc44e42410544abd94', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '4d41e70be4e3da93ebdd98007aba1ee8e0f2e47a', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("ir-channel-header", { key: '3234d47e02b328e41f6a78cc5d9d26df0396582d', class: "mt-1 px-0", headerTitles: this.headerTitles })), index.h("section", { key: 'f018997556d555f366603d0e6286faad5f16dcb9', class: "py-1 flex-fill tab-container px-1" }, this.renderTabScreen()), index.h("ir-button", { key: '246a558c4f094d5d48a5b7224ce4e2167107b0f7', isLoading: this.isLoading, onClickHanlder: () => this.saveConnectedChannel(), class: "px-1 py-1 top-border", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save })));
    }
};
