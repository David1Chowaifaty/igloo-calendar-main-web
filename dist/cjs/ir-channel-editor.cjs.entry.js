...
const channel_service = require('./channel.service-4cf524cc.js');
const channel_store = require('./channel.store-bd91b3a2.js');
...
const IrChannelEditor = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '9b082116235e743ac50ec987e22edf8dfaa8a33e', class: " d-flex flex-column h-100" }, index.h("nav", { key: '392c687fb6dfdec8770099b54cb8ad8054fd0b3d', class: "position-sticky sticky-top pb-1 top-0 bg-white " }, index.h("div", { key: '3c15cfef205278bae533c20eb648d68589175790', class: "d-flex align-items-center px-1 py-1  justify-content-between" }, index.h("h3", { key: 'c501ab1f57add3037ec86f49183cec04aa7f02bc', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), index.h("ir-icon", { key: '870d871f72e61c5c2224f241e762fa3ec887d130', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '27b6b6cddeda848abcbf14955b734be5f6117efa', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'cccaee7d2f47aead5b82f02afc70b6d6a3649700', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("ir-channel-header", { key: 'b312368581293c053867494030699fafeb50bdd5', class: "mt-1 px-0", headerTitles: this.headerTitles })), index.h("section", { key: '4ba57681217ea203696941630226261464160a60', class: "flex-fill tab-container px-1" }, this.renderTabScreen()), index.h("ir-button", { key: 'ecc6238e165f8eff90861f7392f9fd6e7b9af88a', isLoading: this.isLoading, onClickHandler: () => {
