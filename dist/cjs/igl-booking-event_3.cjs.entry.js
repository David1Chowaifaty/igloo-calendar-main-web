...
const IglBookingEventHover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'df986f94aad1a3f344b4cdccd496ebd4b5a8a81a' }, index.h("div", { key: 'f5258a8f115e98b613805403d4d9e563dd4bf476', class: `pointerContainer ${this.bubbleInfoTop ? 'pointerContainerTop' : ''}` }, index.h("div", { key: 'fee359ab465823832df8e890eb1f910b1bef5cf9', class: `bubblePointer ${this.bubbleInfoTop ? 'bubblePointTop' : 'bubblePointBottom'}` })), this.isBlockedDateEvent() ? this.getBlockedView() : null, this.isNewBooking() ? this.getNewBookingOptions() : null, !this.isBlockedDateEvent() && !this.isNewBooking() ? this.getInfoElement() : null));
    }
    get element() { return index.getElement(this); }
};
