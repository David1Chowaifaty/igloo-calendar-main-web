...
const events_service = require('./events.service-7c4ef0f3.js');
...
const IrInteractiveTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c6109878b25af26fea47dee2e0fab20b8d450018', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '7c1f46e9675d969ab86d1861569f23ec9d1b8095', class: "popover-title", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, index.h("span", { key: '9fd55abb4ce5f058bc09c9177460570cdafb625c', ref: el => (this.croppedTitleEl = el), class: "croppedTitle" }, this.croppedTitle), this.hkStatus && (index.h("div", { key: 'e8c0a60f62711c2712d5971b48f3a98fa142473f', title: "This unit is dirty", class: `hk-dot` }, index.h("svg", { key: '999c3e22a3ffe4fcbf170baa16db6257e418d1b7', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512" }, index.h("path", { key: '3dabfd8639ec69616ce2c8fa37f4676a3f772e40',
            // fill="currentColor"
