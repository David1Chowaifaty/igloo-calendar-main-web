...
const tableCss = ".ir-table-row.sc-ir-user-management-table td.sc-ir-user-management-table{padding:0.5rem 1rem !important;text-align:left;z-index:2;background-color:white;white-space:nowrap;width:max-content;max-width:max-content}.ir-table-row.sc-ir-user-management-table td.sc-ir-user-management-table:last-child{width:100%}.table.sc-ir-user-management-table td.sc-ir-user-management-table{border-top:0;border-bottom:1px solid #e3ebf3;transition:color 0.15s ease-in-out, background-color 0.15s ease-in-out, border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out}.table.sc-ir-user-management-table thead.sc-ir-user-management-table th.sc-ir-user-management-table{border:none !important;background:#f3f4f6;background:#f8fafc;color:#374151;padding:0.5rem 1rem !important;text-align:left}.selected.sc-ir-user-management-table td.sc-ir-user-management-table{background:#e3f3fa !important}.selected.sc-ir-user-management-table td.sc-ir-user-management-table{color:var(--gray-dark) !important;transition:color 0.15s ease-in-out, background-color 0.15s ease-in-out, border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out}.sortable.sc-ir-user-management-table{text-transform:capitalize;transition:color 0.15s ease-in-out, background-color 0.15s ease-in-out, border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out}.sortable.sc-ir-user-management-table:hover{color:#212529;background-color:#e2e8f0 !important;border-color:#dae0e5;cursor:pointer}.sortable.sc-ir-user-management-table:active{color:#212529;background-color:#e2e8f0;border-color:#d3d9df}.sortable.sc-ir-user-management-table svg.sc-ir-user-management-table{color:var(--blue)}";
...
const IrUserManagementTable = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: 'f9a676efe3bf2645ff0406532df8a18dd4172411' }, index.h("section", { key: '691caa9e2c5e87721872f1ffd576d84accd036df', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '6fcffde8fefee307726f0ea382af7b43696c150f', class: "table" }, index.h("thead", { key: '244d8d8564d1af850b69bf1c690b79768584cee3' }, index.h("tr", { key: '33052f44ba9cf7b2aabf95729b421a1b08c51bbc' }, index.h("th", { key: '21111ca5026a8a89c35e171c0aea1a37c037710f', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: 'c16e26645f349413b9ad92aef5630a076aa64e82', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: 'be636068df333b25f9acf55c3a463979225cc080', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '5f21eeeb069486d7a1c028bb843519805a284f5c', class: "text-left" }, "Role"), index.h("th", { key: '1cdd74fe4cd9572bdcf1a4bf131d882cc2926006', class: "text-left" }, "Last signed in"), index.h("th", { key: '8c82289148743fab2fb515b0bb451a8d07655964', class: "text-left" }, "Created at"), index.h("th", { key: '78275ba35cd845cb04bbdd1fba8cec726989d67b' }, "Active"), index.h("th", { key: '74d33f01bdfdde3d29ce36a002d77356fb298135' }, index.h("ir-icon", { key: '89b59562ecbbb74f004c7a0d93ebd2bec5c80999', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '1c96e8850300e892a4a1f82fad81835f66afffc6', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '77db4abf2b3c0140ff152b3d5ddbcb92f45380db', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("tbody", { key: '81ebe8012e2a7458fa9cb3987f2d114a2ddb44e1' }, this.users.map((user, i) => (index.h("tr", { key: user.id, class: "ir-table-row" }, index.h("td", { class: "text-left" }, user.username), index.h("td", { class: "text-left w-100" }, user.email), index.h("td", { class: "text-left" }, user.phone_prefix, " ", user.mobile), index.h("td", { class: "text-left" }, user.role), index.h("td", { class: "text-left" }, moment.hooks(user.last_signed_in, 'YYYY-MM-DD').format('MMM, DD YYYY')), index.h("td", { class: "text-left" }, moment.hooks(user.created_at, 'YYYY-MM-DD').format('MMM, DD YYYY')), index.h("td", null, i > 0 && index.h("ir-switch", { onCheckChange: e => this.handleUserActiveChange(e, user), checked: user.is_active })), index.h("td", { class: "" }, index.h("div", { class: "icons-container d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("ir-icon", { "data-testid": "edit", title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: true,
                    user,
            ...
            } }, index.h("svg", { slot: "icon", fill: "#ff2441", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "14.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" })))))))))))), index.h("ir-sidebar", { key: '0b4036a2d0567c98a4e6ac7013b4cc26b1462061', showCloseButton: false, open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), style: {
...
//# sourceMappingURL=ir-user-management-table.cjs.entry.js.map