...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a181160169d41086cbf8e76fe45705e6284e5401' }, index.h("section", { key: 'f3b46420e235aad6cb5b51435d535e7e44e50dc1', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '1b42e6c61e16e7dfb6dcadb490499291f9a6e35b', class: "table" }, index.h("thead", { key: 'cf172c92f4f356fe5ddb739d28df45527425cd2d' }, index.h("tr", { key: '9e6a394cb93c749bc4441b4a5ac89fb6192eea1d' }, index.h("th", { key: 'db58ad86403ceab24327f3fd3f970047e17b31d5', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '2a8ea8142803a70c73a5834068b531723983a519', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: 'cbe81f78a7b1cc208d23b8288bccb5efa6563888', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '44ff057d02fc70eb1e2205be4d5d16b2f8f1d07c', class: "text-left" }, "Role"), index.h("th", { key: '8fc8f5e75bee77c69928ec74aaaf2b7a284b0b93', class: "text-left" }, "Last signed in"), index.h("th", { key: '4838ecd6d59096ec31cb30d0d7cdb076606b837d', class: "text-left" }, "Created at"), index.h("th", { key: '394b8266edad800814b2186cfc79a585469eb15d' }, "Active"), index.h("th", { key: 'f88e37364d446f5a8f489f907c3e9df2dc981824' }, index.h("ir-icon", { key: '4858dddc6318c3c76b5e2ef556a9f7a02bb29d75', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
            ...
            } }, index.h("svg", { slot: "icon", fill: "#ff2441", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "14.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" })))))))))))), index.h("ir-sidebar", { key: '38efa052f74566e3bcf505ae9738a35afcff7842', showCloseButton: false, open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), style: {
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: '0fce92bd19ed8d04e79470cfdf59dc4a3237e450', autoClose: false, modalBody: `Are you sure you want to delete ${(_e = this.user) === null || _e === void 0 ? void 0 : _e.username}?`, rightBtnColor: "danger", rightBtnText: locales_store.locales.entries.Lcz_Delete, onConfirmModal: this.removeUser.bind(this), ref: el => (this.modalRef = el) })));
    }
    async removeUser(e) {
        try {
            e.stopImmediatePropagation();
