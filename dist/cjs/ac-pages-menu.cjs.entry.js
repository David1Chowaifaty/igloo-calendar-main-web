            ...
            if (page.subMenus) {
                return (index.h("li", { key: id, id: id, onMouseEnter: e => {
                    ...
                    return (index.h("li", { key: menuId, id: menuId, class: `navigation-item ${submenu.className ?? ''}` }, index.h("a", { onClick: e => {
                            this.linkClicked.emit(e);
                        }, class: "dropdown-item menu-icon-container", href: submenu.href }, index.h("div", { class: "menu-icon-container ir-me-auto" }, submenu.icon && this.Icon({ name: submenu.icon }), index.h("span", null, submenu.label)), submenu.isNew && (index.h("span", { id: submenu.badgeId, class: "new-badge" }, "new")))));
                }))));
            }
