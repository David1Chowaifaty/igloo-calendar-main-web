...
const IrPropertySwitcherDialogContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f20b37561c52d510ee0c628a7f4a9085e1d71d55' }, index.h("ir-input", { key: 'bdc22c58817e338caf18644fdba4d676d9807d0d', autoFocus: true, ref: el => (this.inputRef = el), placeholder: "Find property", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), index.h("div", { key: '648cf6ba9f99fed59696bdb150f9b8d49cf6a49b', tabIndex: -1, class: "property-switcher__results" }, this.isLoading && this.renderStatus('Loading properties...'), !this.isLoading && this.error && this.renderStatus(this.error), !this.isLoading && !this.error && this.filteredProperties.length === 0 && this.renderStatus('No properties found'), !this.isLoading &&
            !this.error &&
