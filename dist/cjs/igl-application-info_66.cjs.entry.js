...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6d8bf5ec1f22eb128cf22c09b176e4f4282b702f', class: "flex-fill" }, index.h("section", { key: '14183b73f94faeb8909af7b647c394f518424583', class: "mobile-tasks-container flex-fill" }, index.h("div", { key: 'f4c4f2fb4ae3a2993c9657fbc58547fe409d561d', class: "card p-1 m-0" }, index.h("ir-tasks-header", { key: '45203b36d4bc7cfaf42df24a213f01659208653e' })), (mobileTasks === null || mobileTasks === void 0 ? void 0 : mobileTasks.length) === 0 && index.h("p", { key: '6c671b3bb8527f4e09cdb1f80d4c1c76234f6c50', class: "mx-auto" }, locales_store.locales.entries.Lcz_NoTasksFound), mobileTasks.map(task => {
            const isCheckable = this.isCheckable(task);
            const isSkippable = this.isSkippable(task);
            return index.h("ir-tasks-card", { task: task, isSkippable: isSkippable, key: task.id, isCheckable: isCheckable });
        }), index.h("ir-tasks-table-pagination", { key: '4de6d401c89b6292aa59fe2e6916cfd935a2be5e' })), index.h("div", { key: '034aa4974e59070f9ed67653bc95873ba904b970', class: "card table-container flex-fill p-1 m-0" }, index.h("ir-tasks-header", { key: 'ea77c48932a8875e171094343d130e2ddf26671c' }), index.h("div", { key: '81eb7744f2b8755acfb13457b88654758bdb3093', class: 'table-responsive mb-auto' }, index.h("table", { key: 'df300a881d6704ffdde7690a38a42313e9c318e9', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'c0730254628e4c3c05f78467fe6fb68312db3cfe', class: "table-header" }, index.h("tr", { key: '85126655bbebcd80515231ec99dcc4e9f1bc0461' }, index.h("th", { key: 'a08224dba7fbe9da9ba7e7f2c8d1b148420671b0', class: 'task-row' }, index.h("ir-checkbox", { key: '775c8aa1fa8172b5c60f9a782165fa61ce3cf479', indeterminate: hkTasksStore.selectedTasks.length > 0 && hkTasksStore.selectedTasks.length < getCheckableTasks().length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'a27e999a092dc928348102fc0efde55325a189c1', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '36045983e347c7a1f24c70b021ab57c89575ae70', class: "extra-padding" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '101aff17daf7fbb55249fd67985726e91d0648fb', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'eef1c91455756e09f7ddec2845d1f18373275e15', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '05f5c2202200949af43094dec9f2ff70104bf7b3' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '4c440e12b3a33bfff1fb90904f56b4eadffd9b64', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'f15fb21af34d5d06763fe3d1cba93e1b6abd1ef8', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'c0a51687f3e4a022ddb7dda34ea4fa298c85e2b2', d: "M17 20V4" }), index.h("path", { key: '331d87bf63c5f2a69ca026a1b9917403ddcf9ece', d: "m3 8 4-4 4 4" }), index.h("path", { key: '48f6cec557b0c8d1ef04fe9d1848d8b8dfc26dbc', d: "M7 4v16" })))), index.h("th", { key: '087f7cb3e6253842d24a8707a8a91f0e2ccf84c7', class: "extra-padding text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '92571b4fe235ececfb3bd7e2e3c855355d0e0928', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: '1bc9e02788b23f0b3025fdc6611dd6f11bafa699', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '5a1add8e717565431015ca6fc9c238c6da2d50ae', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: 'c1dd595aa684896f0f5b06a4538ca66e1d1e8147', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '9db372a4ec4c713c853bd142f4a28453ce56e551', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'f66b8ed1c922f9ba850373f4839a39c4b9640490' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '6aa07437d5487e63faf0b4c9bb46998edeea745a', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '24cc25e73cb78af05f1b758a18bee67c36bf8367', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'f3f3c141c2615105448177ef9de0c6943fc6459f', d: "M17 20V4" }), index.h("path", { key: '591134a6685f048883833c1306f56e782cc2de00', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'b58157ddfcb68816b6ffc01555dca0ca3014221c', d: "M7 4v16" }))))), index.h("th", { key: 'a8f9237ebfe636b49de829334303931264b20f2c' }))), index.h("tbody", { key: '397ace2cc7bd1e0cd6d396e247eee4cabd3e843e' }, tasks.length === 0 && (index.h("tr", { key: '68caca31c7a153a60bd167061f78d278009546eb', class: "ir-table-row" }, index.h("td", { key: '4596fc6c852e51648ef8057baa9bd961a7361428', colSpan: 9, class: "text-left" }, index.h("div", { key: 'a85343fec4a93fe178f0fbe9166d518fb9a1bb24', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '3c390c28dfa0b93970968cb82dc43c3e1d87744e' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), tasks === null || tasks === void 0 ? void 0 :
            tasks.map(task => {
                var _a;
            ...
            })))), index.h("div", { key: 'ac421fdbf28cac8fb461ac8591426a7ef802a22b', class: "mt-auto" }, index.h("ir-tasks-table-pagination", { key: '0f7db642db7d062eb7dc482494bef96ff3da9b8a' })))));
    }
    static get watchers() { return {
