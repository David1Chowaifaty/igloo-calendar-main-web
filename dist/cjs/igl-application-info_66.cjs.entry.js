...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b6c70f3caf35803cb8f6b87e155596eca0e4cc2e' }, index.h("div", { key: '6098411fe6ff7a03875e18c40119dd4cdd7dc68a', class: 'd-flex align-items-center ' }, index.h("label", { key: '35be1791a8b68713b33423dc728924a7d192e2b3', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '4da7c64e050e6cd9eaff716ecb896bc34b5e90b0', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'cb59f14fbd3635e33ef7a5d6219cff2995ed88cf', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '2304917c0501b891d0e8407996e96a67245074b7', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '85bbbdba8ea10f33c37fd60546115a1b08167ba8', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'a92efff4bee6fca448e489f65c15b8b39606b922', class: 'sr-only' }, "clear input"), index.h("svg", { key: '26255de93c9b0ff1a3c826f6560824a23be1547f', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '090f081cd7b183f750f937b8b6b8d551bad1c8c4', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6f7447ba224ef2e29c44460198c747f735ae8d0d' }, index.h("button", { key: 'ef8be9b9d695b9f8c32786f732099bff55e423a1', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '95d0937a8a9badcec91def0246a59b7482aa8301', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '157fcb9bf0095c4f9708328527008adfd232acfd', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: '4acefb44323822354562fa8390db17d33e4b8acc', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '00351a56e3516d25770554e544f723501092dc78', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '9bfde767fbd34bdad7df847c68d621bbc4a65759', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: '7243fc4e123ae06b3651ffdff4ec5c69792cb448', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '532e947f21f211c48aa420cdfd385e920550f9b6', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '527d75ffda959f5ef8b8cfd615330c3b5e996831', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: 'b474aa70d2ead51e1e1be95709dbee71fd9ca795', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '0adf944c62cf440762733ecc232007cf44bacbe8' }, index.h("button", { key: '72c1fe8bd0c48750fcd450b4b97e4ea125188b80', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '15949099089f06b2b8143a21e95d27e641ffd385', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '6f0e5f5001401f0663d10579121b0866ffffa08a', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '6974beb83b9a716caedc3772d5ab29d11914e783', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '7e6e147350cd60f99172829ff48a0f4fdecaf4e9', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '018cf30435a7331c2465b6d527366bf5f6bdfefc', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '98d7ae9916a3b5fd242113e98c8e49332dca846c', name: "trigger" }), index.h("input", { key: '3c154e2f310c1f1ec7daa781e51dba5f47b09bdd', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3d99e363bc3ff2fc852ee3561a856d181530bddc' }, index.h("input", { key: '208f8fbfe6eab8ccedfac76956e847cf6d80714e', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5c3d9827837bf0546006b4fcfe65fa4b81cf81a6' }, index.h("div", { key: '6536087d36472e000efe747854c3a2b2d6128714', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '9ba098708f1ca441198acb42989fbaf3fd915270', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'e62e8090bee9550a130fb9a80198058693d1698c', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'd7f9f5882d78bd5ba19eee79343c3a916138f641', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '1b2cd2e088174518ffb9b1e2f5ef4dad8c79afe6', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'fc037da8e0899898aeec66bd2e0b5d3ca55c0251', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '0efba8415ac4256d091eb9f03765747e23a5efd6', name: "modal-title" })), index.h("div", { key: '86e6c97e0622099a44d741140e13e31c51038026', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '0256b1aaf33dc25b468b5474d2057ef293272f36', name: "modal-body" })), index.h("div", { key: '28d3d44844995f7b6220336bfe9c0687a5805878', class: "modal-footer" }, index.h("slot", { key: '0249c35ec4ff7e85eeac24da9389ac788a14edd0', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrHkArchive = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        return (index.h(index.Host, { key: 'bd46bc41a5910bfd66ad1bce8c62a825fbc91027' }, index.h("ir-title", { key: '42a825237619d7ce00f7e26e7c3c8618970412e5', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: 'faa188297ef5608ec3824a6c2cf0fcad3c957bed', class: "px-1" }, index.h("div", { key: '62d4800b7a1c0bd1a8c8d2a6e13070acd1c47ec2', class: "d-flex" }, index.h("ir-select", { key: '62ee77f7ece967364b8ea1344c718ea13431c4a8', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'b28153de923cc0109cc34eb3b74e0bfb6114f72c', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'b0861ca38b0f0f5b1a8152db40543d5578be119e', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '6a3ed2d858cb959c5e4a9035677f5cc06e504c34', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '4b25e74875ede6c66b80c3adae5bfeb9ad97c2a9', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'b8d6cf409a473e0a72c784272852ee44472d2548', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '24ad72f60b0c91a49ee53ab1dcaed723d27ab51a', class: `ir-alert-header` }, index.h("p", { key: 'e08bb4db4822645816d25f2d76777986f7873468' }, this.modalTitle))), index.h("div", { key: '6b23243b4438f7f7c37fb1a7adaf00f40819e768', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '082a72f4047d5a7afeceb695f86215d1b6a9f4d9' }, this.modalBody)), index.h("div", { key: '027b009341da3928c6f4bdf3450ddc985acd66f4', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '9f557040c2d1b763ae4ec9fc533b679c9e77e23b', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (index.h("ir-button", { key: '722e84d3b819ee45abe8f7f7649fb503198fbb5e', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7956ad05f6bbf700e2b1e12fbfe4713b5796f9c9', class: "otp-input-container" }, index.h("div", { key: 'debb683399dff7dd2cd83ac03d5fd0ad9cfbdb32', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '6b7ea34da5d39607ddbea1ab09de77ffde9f0a29' }, index.h("div", { key: '4b952f1b54f0f11c83a69761ed74a3eb6f856907', class: "form-group mr-0" }, index.h("div", { key: 'fc9d2703049596e5caa30faa23fec418d39081be', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '5465e9413dcf8195dcf78e3750d32d22e1615962', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '2d75b09cfd712fa42050adbc732cd620dcb22929', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '6aff123257652a0686d63b57782d0943d4582988', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '57839fab0499c710fc4c9c13c8a8eb0b44a12d89', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'a70e02bb856690722f04aa168ef2678803695ea6', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '91c9f8580e87388a240414bcbabda9120b2f486b', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '9524dfa36bc8e28e4dbfacfbccb4ae0d3b08c468', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '4346a25c08fd259c28799cfde35ae36ef2f45340', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: 'aaa0aa58abe66fa03b2e29653043b7b71db94526', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '307c49c78d287ce6771bca16f22fd5cfde6a47db', onComboboxValueChange: e => {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '74c399a309598f3de58f4cb664d5dcddaf22bb2d', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '23798009d74c2f0721ca011cb349e05c7597c0f2', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: 'db782fb56a76f63b925072d16c46ebea8eeed8c9', class: "input-group-prepend" }, index.h("span", { key: '116a03fa25effc3a271e22e247be0069f235cd67', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '820a1b3882ceec98dfc7614bb819b8c7d36e37fe', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '77e56c61a6362d365f35494fb8e3c517c54d5a26', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'ee8fd1f50b487fda5bd12a9b073abdd2f24edbd4', class: `input-group-prepend` }, index.h("span", { key: '25fb7186902bae22c8671bd9fe900a115f8fed16', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '6b01039d2ff00b0f6d7c74cfae3dc7a1af8a82cf', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd655dd078e0f3c87a5affc60f0c23f9b6cb865cd', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'fe74c893f0f63fc8e4af4580bd53443c0d540fdb', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '60cff08330021d1e0283c34d5602fda45c035532', class: "flex-fill m-0 " }, index.h("div", { key: 'a04ec1b5af31d4429e1cd2ac2eec2376ca9f94f0', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '000bec796c909a403605a9bcb40cea604195c221', class: "m-0 p-0" }, index.h("span", { key: 'be1a4eff36fef8071d6e9d864cdef3006dd6b232', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'aa01c961b528478321209d071b15b031f5f7b5b7', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'fb677eb10ce25a2d7af5f4b99ab85feda7f47871', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '52fff26a54db568aa8741f77e779b2fed6b9c3ac', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '1c253404d46bf98ce9e79ac87d2ba8fa3b13ae2c', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'c29f4ef107036f0b4c8a6ade1f8e9817a33d44cd', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: 'eeba23012e5b56f474c2273b59af65bb2a56e0b2', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: 'fe9fcdfad645f28815f7cf8085b7be27e5ebe179', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '4433342b73874e18de686ec04c423c25079e6075', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '73ad4aa440d653e771f0ed6cb98dabd3cfcdafee', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: 'fac3167924ff6f12efed8f733a2adbe537757c4c', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '470d0954e913179386c3017c6116ddfb2059c858', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '7bec1b60f81199d8498dff4d2aff1fc60d073271', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '62c67ebcc0152738ce42348c7d5659ad754a6e8d', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), bed && index.h("p", { key: 'f08df89e2cb2f3949fcef437b0dc39ad3a5b7329', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '1108411ab998a28b8fe5d6091f24469951481d2c', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '42477cf92f1aba37481f9ff13adc0d7db52cbc83', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'b40ec0065dc95862022535b7a66706362d70d3fd', class: " sm-padding-top" }, index.h("p", { key: 'f2b73c2244c56e78bb5bf864d9bebc4abd04a18c', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '3cb8b0ac31f0c737221c358062ed4484b5fab8a3', class: 'flex-fill' }, index.h("table", { key: '23ca8145e19afd4de5a8a3eef5e50b1baa5c55a7' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'a8dbaefc9c0cf154ac15c2f15d0c025c86dce3cf', class: '' }, index.h("th", { key: 'ef07e197d25078d1694e375b7dc91762ab78f042', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '60710a5f01356f54041230d7c61be07693038e24', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'bdbd1df49852196b6ef990bf3e53f81749f25c7a', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: 'dcd8a45cdc0b3ec61818330c9c108665fd3070c7', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '69820638dc2b5ed6ae83d030ede2138c63528168' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '172978c95bc1f89a4325778bbe09417d0e14343b', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'c225a8f6d3c0c3a573bd04a76b7de9937ddde518', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '991610478ac5d002196c48fe43120696b93de1f3' }, index.h("ir-label", { key: '019828fc9ef2c47e9c1e30a40fd27e87fce45c4b', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '9ee07b01b864c18cbc693a2e439c42fa3bc85f5e', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '940a7a7e9e0ee2c447287279b5cdd1c90bdd216a', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '45877a7ccf4e8018f5a80422edc965f77dc4bfc7', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '35223104d2a014cc854f7cecfad4b675294716f7', class: "input-group row m-0" }, label, index.h("select", { key: '6993b2a8cf2d257c025fb220a4c45f165423892e', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '464c1465cd2b47867161a2d6eb2269bec3ed453f', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '1182820cbf2acd12c83d2d945dca0e895ae9fc9a', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '7bcab9d2b4f8746317f9d24d65e3e54213699b74', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '89b10dce5db1725bb7d0ee860725a205b3bd9aa5', class: 'sidebar-title' }, index.h("p", { key: '107504d98645bb8b6d300a9d546daa664fa09203', class: 'p-0 m-0' }, this.label), index.h("div", { key: '5d60dc045ba841ad5f5e7d411d78c5cb435ed4c1', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '90ade0b1ab368e6f8b8d516d15ed93aa047261b5', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'a69e5930f2858c24085346639782aec12dc4e28d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '2b2917ffaa2548eca7a21bcc3e30fe8f506cd099', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '035cf80e8f7a2b197255a80e1e15bcc323112cd9', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '8983784aebaf52a67ae7eb3be2feb5f9ef2e5c43' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTasksCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '76411317af9948b797b97275f71805f50255697d', class: "card p-1 flex-fill m-0", style: { gap: '0.5rem' } }, index.h("div", { key: '9de5ce9c9c09965c254277c7ef40459e3f71dc6c', class: "d-flex align items-center p-0 m-0 justify-content-between", style: { gap: '0.5rem' } }, index.h("div", { key: '51439001b7eae6a8f9c6d1ca9905c26fe02166b4', class: "d-flex align items-center p-0 m-0", style: { gap: '0.5rem' } }, index.h("p", { key: '993adf06d3920cfa92d8d45bc81ea223fc513ce4', class: "m-0 p-0" }, this.task.formatted_date), index.h("span", { key: '230058b9731cca6c74d6a887b557b202f2c8e9be' }, "-"), index.h("p", { key: 'dc3e975e16dc6985169277f9e2af449d46afe814', class: "m-0 p-0" }, "Unit ", index.h("b", { key: 'ab6a4c8c356feb7a2fd7a5d6fd216a0aca5caf4f' }, this.task.unit.name)))), index.h("p", { key: '85b02321f779c2991788578ee4ddb9969d9819bc', class: "m-0 p-0" }, this.task.status.description, " ", index.h("span", { key: 'cbd5c9b9216e5ee9f36aa0512602d7117a37491a', style: { marginLeft: '0.5rem' } }, this.task.hint)), index.h("p", { key: '162d7bbf994e426176702383a189f1faa29380c6', class: "m-0 p-0 d-flex align-items-center mb-1", style: { gap: '1rem' } }, index.h("span", { key: 'ea089b0cb73d84f018b2cf7b64f1d8a6ce6e5a93', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: '2f7e59f53ef4df142957c3b784845a8a7ea0227c', width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512" }, index.h("path", { key: '57ed4db0d2f629268aeed6f4570d8ac1d0e6b028', fill: "currentColor", d: "M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z" })), index.h("span", { key: '78ede2798b55803c68c88d80be0450572935cf37' }, index.h("b", { key: 'a3779477f507cd07d415a63593efcca58eddadc7' }, this.task.adult), " Adults")), index.h("span", { key: '51c650dbc7dcd50b6489b2d23f92bc8e52b754a6', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: '5ef5e9e03fb672332f0de3d9d02e76be5bfd1f8f', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 320 512" }, index.h("path", { key: '9f31395a077c07dec34e0ff0f465be38ecfff51e', fill: "currentColor", d: "M96 64a64 64 0 1 1 128 0A64 64 0 1 1 96 64zm48 320l0 96c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-192.2L59.1 321c-9.4 15-29.2 19.4-44.1 10S-4.5 301.9 4.9 287l39.9-63.3C69.7 184 113.2 160 160 160s90.3 24 115.2 63.6L315.1 287c9.4 15 4.9 34.7-10 44.1s-34.7 4.9-44.1-10L240 287.8 240 480c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-96-32 0z" })), index.h("span", { key: '01da822efdb0e184a994f3ad41f5614f75a0ceca' }, index.h("b", { key: 'ab3704aeacd291da6e25232c65d2790e8d3a80e4' }, this.task.child), " Children")), index.h("span", { key: '42a6064ddf19c2655d141015bf42f6208a917be9', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: 'e1b17e3ccf4bbef416e5df3bd9aed42ae5d0c424', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-baby-icon lucide-baby" }, index.h("path", { key: '1fafd22c356b90056bea2b7be1389e98ee4ba87f', d: "M10 16c.5.3 1.2.5 2 .5s1.5-.2 2-.5" }), index.h("path", { key: '984749a9fc9a23ed4ab9754d6991a6e57a49ddd7', d: "M15 12h.01" }), index.h("path", { key: '7929bedf54c9b19f6f69d94fa79633da9703cb6a', d: "M19.38 6.813A9 9 0 0 1 20.8 10.2a2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3.5 1.1 3.5 2.5s-.9 2.5-2 2.5c-.8 0-1.5-.4-1.5-1" }), index.h("path", { key: 'd26fb007ef75bb1a4d10128081fd75f766f0ceaa', d: "M9 12h.01" })), index.h("span", { key: '2b4973f91a118c6f236b6f0e6182853d0e7157a5' }, index.h("b", { key: '1036e2051ac466402fb498c0023fc514060294c5' }, this.task.infant), " Infants"))), this.isCheckable && (index.h("div", { key: '0fe4d1e2f79e11aa2aeaec51b122619d8a5ffda9' }, index.h("ir-button", { key: 'bc599c6c989d38ed33db1e5d385d2d8cff1a3069', onClickHandler: () => {
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4a9fa7faa0e97a4e20769b4a73dd31e7d39e44c8', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: 'e1b40addbe71d9cbc46e4b3df7a66a77fd8cd70c', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: '8f7937251eb667166ce590e5c283a86308a27e58', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '13381ce7a9da0ce7b916bb4583bf84c61de2d5c4', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'b4b55c6c3b05b61aa194200f81726ef4e47e1249', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'f4a0d2aff3d006bb3fc32702f5bc3cc55c68fb2e', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '2b9093e4eed418097bcc456035e1c1e3790f6174', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '2fa5bddf165b14599345311287ac18ad34f13663', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: 'a77790bf984f4e42c1d6d51e4013789ff499ef0d', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '1abf0d5da87b347ffb6483d54c6bbafd474d87b5', class: "pt-1" }, index.h("p", { key: '7092676ac06b5edf6a275645d040480cc1baa81e', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales_store.locales.entries.Lcz_Period), index.h("ir-select", { key: 'c1fce38089954dd1840713968aefdb2c53e9dfb1', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: '8cba1b675bfe4691185274f5f29f0582a4878574' }, index.h("p", { key: '8108d284fb8a8e8b530c74f42ec103627b8c0843', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales_store.locales.entries.Lcz_Housekeepers), index.h("ir-select", { key: '4c77da6e952db4454ae1b236898b4a905b273d5b', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } }))), index.h("fieldset", { key: 'd7535f424a689f86f196e6f3f56c977b19bfd888' }, index.h("p", { key: 'e4be0322a8ea808ea7d49d9ee620b9f686012b81', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales_store.locales.entries.Lcz_CleaningFrequency), index.h("ir-select", { key: '045275de4f731bfd84ee111ebbe3a487851350f8', testId: "cleaning_frequency", selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: 'd9d5c63d575fb049a2b60d91c546adcd3154e905' }, index.h("p", { key: 'ee80a536b99e19884093bd17534f7935e36c3ca9', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), index.h("ir-select", { key: '0ee3290604af9b54bc03951f9a4abe33c060a3da', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.dusty_units) === null || _l === void 0 ? void 0 : _l.code, data: (_o = (_m = housekeeping_service.housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.dusty_periods) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), index.h("fieldset", { key: 'ed4a369c0bd469335bfff33b46dc891001ea7dd2', class: "mb-1" }, index.h("p", { key: 'cc7dee0793a87d3ddea722ae6026d32e5181dcc1', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales_store.locales.entries['Lcz_HighlightCheck-insFrom']), index.h("ir-select", { key: '939f5b18e0f7d7fe404e482bf94cef9f4dadfb02', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '725ca63b6139bfdde2d1a9b185933bc204c0da06', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: 'b75ae27b43c6e3a5079eca0cf6e5e7a4c7d0429d', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '7aa7b47ea0e71da2bc38814eba5172fcb635eb57', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8faaa663ed8052157373a4a7bc22eb04d32206da' }, index.h("div", { key: '04c5470859d5261d3cac9e15603a42c260d542bc', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input-text", { key: '1ed265a702d102e80c3e4d61984778948ed5c01f', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, index.h("ir-icons", { key: 'ceca710900fb5981f3af313834eaeca10c3df2dd', name: "search", slot: "icon" }))), index.h("div", { key: '466193ef6c350618f786552ccfef3a893b7219d3', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-button", { key: 'e4b4131d3bcb316f744fb1226959dcb2414850d6', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: 'c1f2b72f4f3bdfed2fb5c8e58da0afc34dca2825', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: '05f6543f44f70b5b9e39fd8b23317b3b8562cac1', class: "d-none d-md-flex", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '50eba5bb823bb65d36620eb61c3fa220b1f416e4' }, index.h("h4", { key: '158b0bc3d5e52f6a5c5cc4c3d1cc1f4fd03cb56d', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'f4b72554747e1df9498ff900ec952bea7850a75c', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'd7f134b20a76d243be87130e748e058f2ef432dd', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'f988bbdcd0f7c87e380d93a936a6f80d84633eed', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '19633f08bd620e7c3031129d4b37635710b33b6f', class: 'title-body' }, index.h("slot", { key: 'a49a55b81a0770ddea18f5ce9132640b03b23d30', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '7ff935bd4650b9107133232d5c29d5b310990251' });
    }
    get element() { return index.getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '4bfa87baa8e2b280d1b0e680b194182f1f78ef6b', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'f821f2f3f42109f72564984a40b075210a8e0772', class: "tooltip-arrow" }), index.h("div", { key: 'bd5dc3eb19b67d0d96fae8d2a88703ce68d1d4f6', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: 'd8da8ea4eda0c6dc762c5a913fef40e66e283b88', innerHTML: this.message }))))));
    }
};
