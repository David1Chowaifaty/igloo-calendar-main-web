...
const IrBookingListingTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7db9a4d4fc58757a6df2539c03a45c058eea95ea' }, index.h("div", { key: '3a13346a5b4c27975a6c36f6d68b901ab9de7566', class: "table--container" }, index.h("table", { key: '3f20cbbaeda58a7987fddf565c929e990a419db9', class: "table data-table" }, index.h("thead", { key: 'e4c1ba7894a3fb17cc4efaf1a796d0663edfc17f' }, index.h("tr", { key: '083d7a58b162cb5c313e697fff2a7c55d441836b' }, utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && index.h("th", { key: '2475816044b00051447687d138c3b558f9fc6de5', class: "ir-text-start" }, t.t('Lcz_Property', { fallback: 'Property' })), index.h("th", { key: 'f787dd4bdb6fa0cabef969a77f0205caff49456c' }, index.h("span", { key: '1c581c25c7fe04a19f962073d78484cee8486252', class: 'arrivals-table__departure__cell' }, t.t('Lcz_BookingHash', { fallback: 'Booking#' }))), index.h("th", { key: 'eaf4ec2c1693180cc5795ff1da81dcc08adffc04' }, t.t('Lcz_BookedOn', { fallback: 'Booked on' })), index.h("th", { key: '63fab365f3443e36b62470b6cf303fef8b6d89aa' }, index.h("div", { key: 'e3b03bdfce1037ba7b93436946d8f76660b69153' }, index.h("p", { key: 'c2bf5a355850b59cb154fe963c130485b95a473f' }, t.t('Lcz_BookedBy', { fallback: 'Booked by' })))), index.h("th", { key: '5403b9f81f38da107df14704b6751236cba6e23a' }, t.t('Lcz_Dates', { fallback: 'Dates' })), booking_listing_service.booking_listing.userSelection?.filter_type === '2' && index.h("th", { key: '3dd0afa69bc723ab5a972c9d9ea76ac96757d414' }, t.t('Lcz_ArrivalTime', { fallback: 'Arrival time' })), index.h("th", { key: '4c74beb35c66334a472015c0551a843a4f8dbbdf' }, t.t('Lcz_Services', { fallback: 'Services' })), index.h("th", { key: '3695b9eb671d5e7be4a96206d9ba2363219e3388', class: "text-center" }, index.h("p", { key: '3ba584bf616b5d5ec5d7eed861f91ccd4a4be50e' }, t.t('Lcz_Amount', { fallback: 'Amount' }), " "), index.h("wa-tooltip", { key: '8804f66e0f308a340fa0aa1fae65b407d6196991', for: "balance-info" }, t.t('Lcz_BookingBalanceClickToSettle', { fallback: 'Booking balance click to settle.' })), index.h("div", { key: 'f237b8d0d8a290cf4fb05d3181c371faca4a7e7d', style: { width: 'fit-content', marginInline: 'auto' } }, index.h("ir-custom-button", { key: '8b98677ac22d66cfb98a819f94cff24dd60a2e29', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "s", variant: "danger", appearance: "outlined" }, t.t('Lcz_GuestBalance', { fallback: 'Guest Balance' })))), index.h("th", { key: '3b2dd77380cd243660dd701fe6728492a8edf016', class: "text-center" }, t.t('Lcz_Status', { fallback: 'Status' })), index.h("th", { key: '329f0a64aebcec25727c8b6dc2bc9f13c4b047a8' }))), index.h("tbody", { key: '9a27ab5d1cb63fc77085e41cd898e0b4baebc96c' }, booking_listing_service.booking_listing.bookings.length === 0 && (index.h("tr", { key: '242859366b816fa601d386612d241ff4d4c91fa6' }, index.h("td", { key: 'd9e1ffaa2e698dc2efcebd5228f71d3db12eb536', colSpan: utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) ? 9 : 8, class: "empty-row" }, t.t('Lcz_NoBookingsFound', { fallback: 'No bookings found' })))), booking_listing_service.booking_listing.bookings?.map(booking => this.renderRow(booking))))), index.h("div", { key: 'aa0d125bfd382cd1808d9fbb469d23a43dead0a6', class: "card--container" }, booking_listing_service.booking_listing.bookings.map(booking => {
            ...
            return (index.h("ir-booking-listing-mobile-card", { key: rowKey, booking: booking, totalPersons: totalPersons, lastManipulation: lastManipulation, extraServicesLabel: t.t('Lcz_ExtraServices'), onIrBookingCardAction: event => {
        ...
        })), pagination.totalRecords > 0 && (index.h("ir-pagination", { key: '6ea91cf56013422da33efcbbeaa31e60a956075f', class: "data-table--pagination", showing: pagination.showing, total: pagination.totalRecords, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: t.t('Lcz_Bookings', { fallback: 'bookings' }), onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })), canLoadMore && (index.h("ir-custom-button", { key: '666bb80c42e1d6148f6602b57a23151d031c00d0', class: "booking-listing__load-more", variant: "brand", appearance: "outlined", loading: this.isLoadMoreLoading, disabled: this.isLoadMoreLoading, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.loadMoreBookings();
            } }, t.t('Lcz_LoadMore', { fallback: 'Load more' }))), index.h("ir-dialog", { key: '60d4bad109e3f73eb806f664bd8f2d0735b9d1c5', label: t.t('Lcz_Delete', { fallback: 'Delete' }), open: !!this.booking_nbr, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.booking_nbr = null;
            }, lightDismiss: false }, index.h("span", { key: '3ca432f4d68238bbda695448d842ab65e7c3c9bf' }, t.t('Lcz_SureYouWantToDeleteBookingNbr') + number.formatBookingNumber(this.booking_nbr)), index.h("div", { key: '92429a9b84aaf4004f163edcec8cb48c35415b43', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'a8c9cdf3b926c3787b286d39467938d757afdef0', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, t.t('Lcz_Cancel', { fallback: 'Cancel' })), index.h("ir-custom-button", { key: '10f1be577aa92505cafb504954685c26c36924f9', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.deleteBooking();
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '95d8937478327baa4b29176e36c0482259118ee5' }, index.h("section", { key: '138591168f31e04538fbbaca781ca8b496c62d5b', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("wa-select", { key: '268cf070a1b3fdcaaa306699972ecf88acc79c4d', onchange: e => {
            ...
            } }), index.h("wa-select", { key: 'e4a572cedc31ee7bb3d8f16a6c84981b67e6a690', onchange: e => {
                booking_listing_service.updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing_service.booking_listing?.statuses[0]?.code }, booking_listing_service.booking_listing?.statuses.map(b => (index.h("wa-option", { key: b.code, value: b.code }, b.name)))), !utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && (index.h("wa-select", { key: '9d6a7752eae0d36d40025b7f91d93f0a26d8d3f6', onchange: e => {
                booking_listing_service.updateUserSelection('channel', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing_service.booking_listing.userSelection.channel }, index.h("wa-option", { key: 'ccc7142cb7a2c0b4472c46d9401010c7c34f937d', value: "" }, t.t('Lcz_AllChannels', { fallback: 'All channels' })), booking_listing_service.booking_listing?.channels.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name))))), index.h("wa-select", { key: '3f01ce0f02f72ffb1cfb566214bb49914c3ea6a9', onchange: e => {
                booking_listing_service.updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing_service.booking_listing?.balance_filter[0]?.value }, booking_listing_service.booking_listing?.balance_filter.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name)))), index.h("div", { key: 'c11932bdaf05d51e90855240e808807c39924403', class: "d-flex flex-fill align-items-end m-0", style: { gap: '10px' } }, index.h("wa-tooltip", { key: '68b846b5a658bf5dbdc7d79eca8c11b11fb8e093', for: "search-btn" }, t.t('Lcz_Search', { fallback: 'Search' })), index.h("ir-custom-button", { key: '4d8391c4eb7e52b21bee857f0cb2d2c074745b7c', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: '03e2ba62f5fa8b5acccc7d0e9f8ccf71d4b1ba05', name: "magnifying-glass" })), index.h("wa-tooltip", { key: 'f224802a967cfaa84fb20a1385487641c5f30323', for: "clear-btn" }, t.t('Lcz_Erase')), index.h("ir-custom-button", { key: '9226eaa3d484aefded9b346a7bb037b91918e260', id: "clear-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleClearUserField() }, index.h("wa-icon", { key: '25938450ecdeb714ee6b5db504e69e05f469a8b4', name: "eraser" })), index.h("wa-tooltip", { key: '7cd4f3e4740ba689701d02bdb621df1e621ca3a6', for: "excel-btn" }, t.t('Lcz_ExportToExcel', { fallback: 'Export to excel' })), index.h("ir-custom-button", { key: '4d858ef16eb7f3519c71e10200734e08a8bc5136', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleSearchClicked(true) }, index.h("wa-icon", { key: 'b55ae41d4a10d67f926d037f6120c4e1019f3437', name: "file-excel", variant: "regular" }))))));
    }
};
