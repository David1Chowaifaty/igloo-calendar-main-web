...
const IrBookingListingTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bb33f0e489f229304e5f8321b496e84f853f5f7c' }, index.h("div", { key: 'b6fb746cde682ca0d61aa6ca7f4e1287fa46befa', class: "table--container" }, index.h("table", { key: 'b33b136f11588aa32e6b53c2797dd547d870ff78', class: "table data-table" }, index.h("thead", { key: 'ef7d045f2ed492a01a5f40032617175bf0ed1974' }, index.h("tr", { key: '12b0f8d2d2e375078cfbe080ce4c4df1965a48e9' }, utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && index.h("th", { key: 'a71e3184009d36aeebee2e253aad61fedd2c2bfb', class: "ir-text-start" }, "Property"), index.h("th", { key: '36238536afd99250c307da69775556beaeb12bc9' }, index.h("span", { key: '50d57a32d9714cbf9b3cfbe11d91fa508708d2ec', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: '4aef0e3bc56189e6824cd55b4e8fea5d11254c0d' }, "Booked on"), index.h("th", { key: '2fc3624d3f5f7c15db729e7969b84aca5c9f2e0a' }, index.h("div", { key: '491e1cb97976f8c0739e8a07a527882a4bb7d8c2' }, index.h("p", { key: 'b83ef18db403d30df7d3cf4ecd281dde06a8a4fd' }, "Booked by"))), index.h("th", { key: 'f75670826c097031fc66635e0075ce5c036bd2b3' }, "Dates"), booking_listing_service.booking_listing.userSelection?.filter_type === '2' && index.h("th", { key: '48ac4f3df39b4a60abed9b6ceeabc76b31ab7d60' }, "Arrival time"), index.h("th", { key: '18ec61e6ca8a39a01c3ce2d9689ecf07b88ef877' }, "Services"), index.h("th", { key: '5efad7b250177ec24daf7fea7a57270bbe81f8ac', class: "text-center" }, index.h("p", { key: '641335fd8e831b30e9faf61a8e3ff4601c0b7f9c' }, "Amount "), index.h("wa-tooltip", { key: '0d5216fbe7cd4daa670e6174cc1f7da04181629a', for: "balance-info" }, "Booking balance click to settle."), index.h("div", { key: '3039262f2a6865b4ec6ec24ef694733b06c764cc', style: { width: 'fit-content', marginInline: 'auto' } }, index.h("ir-custom-button", { key: 'f206cd08890f3c66d0c5e62d8a0ea295b9814588', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "s", variant: "danger", appearance: "outlined" }, "Guest Balance"))), index.h("th", { key: '660a35a060d093eff8df216f6d3e545e635dc47e', class: "text-center" }, "Status"), index.h("th", { key: '5affe387934ecbb83cc35505bbf71059f343ae74' }))), index.h("tbody", { key: '293ff9dd51320ff145fbcf5edfa4d335d6134534' }, booking_listing_service.booking_listing.bookings.length === 0 && (index.h("tr", { key: '95c7d9b3e877b1c79848d735a81c87cbe88d1530' }, index.h("td", { key: '4037c1ec49f57d8d91fd55af8660d430720c581e', colSpan: utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) ? 9 : 8, class: "empty-row" }, "No bookings found"))), booking_listing_service.booking_listing.bookings?.map(booking => this.renderRow(booking))))), index.h("div", { key: 'e6963447607b961697325d3411127129049cde74', class: "card--container" }, booking_listing_service.booking_listing.bookings.map(booking => {
            ...
            return (index.h("ir-booking-listing-mobile-card", { key: rowKey, booking: booking, totalPersons: totalPersons, lastManipulation: lastManipulation, extraServicesLabel: locales_store.locales.entries.Lcz_ExtraServices, onIrBookingCardAction: event => {
        ...
        })), pagination.totalRecords > 0 && (index.h("ir-pagination", { key: 'e9eb5c2860085f0d5b1b51ab38d093f669a368f7', class: "data-table--pagination", showing: pagination.showing, total: pagination.totalRecords, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })), canLoadMore && (index.h("ir-custom-button", { key: '9a68300e4b508bbbe5c729633cc026daac523962', class: "booking-listing__load-more", variant: "brand", appearance: "outlined", loading: this.isLoadMoreLoading, disabled: this.isLoadMoreLoading, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.loadMoreBookings();
            } }, "Load more")), index.h("ir-dialog", { key: '302ee8621499ec93d35b871a189ff11e0d8b23ff', label: "Delete", open: !!this.booking_nbr, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.booking_nbr = null;
            }, lightDismiss: false }, index.h("span", { key: 'e7000a70ddcf89b6cac0a39e8cdf6a04d6ad8237' }, locales_store.locales.entries.Lcz_SureYouWantToDeleteBookingNbr + number.formatBookingNumber(this.booking_nbr)), index.h("div", { key: 'fb0f706506898601754cc3fb590e0fbdc7549f09', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '08e3b5fda2dca3b6eb249decdce3ee6f7c7cd8fb', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '16a077633458dd7cbd109a1b1f327215fe8f906a', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.deleteBooking();
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '05997e9235202958383c2fd6718b985c63087b2d' }, index.h("section", { key: '2f221cecc34fe9e95037ed8cff7a43b80923207b', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("wa-select", { key: '3026dae39c14a24c993ad164995a8853b8cbd2c5', onchange: e => {
                booking_listing_service.updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.filter_type?.toString(), size: "s", defaultValue: booking_listing_service.booking_listing?.types[0]?.id?.toString() }, booking_listing_service.booking_listing?.types.map(b => (index.h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), index.h("ir-date-range-filter", { key: '9e920dde15aaa4f7e77f9d1581c58e22be7797aa', class: "filters-bar__date_picker", showQuickActions: false, fromDate: booking_listing_service.booking_listing.userSelection.from, toDate: booking_listing_service.booking_listing.userSelection.to, withClear: false, selectionMode: "auto", onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), index.h("wa-select", { key: '1c4483313ddd3fecc82e4acdd5cf5ee641597b0f', onchange: e => {
                booking_listing_service.updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing_service.booking_listing?.statuses[0]?.code }, booking_listing_service.booking_listing?.statuses.map(b => (index.h("wa-option", { key: b.code, value: b.code }, b.name)))), !utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && (index.h("wa-select", { key: '0397afc3acdb991b301d99a8b23fd34fc4d7cb98', onchange: e => {
                booking_listing_service.updateUserSelection('channel', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing_service.booking_listing.userSelection.channel }, index.h("wa-option", { key: 'b0cab6f8b0796a06d53c40c82012ce2ab4598e89', value: "" }, "All channels"), booking_listing_service.booking_listing?.channels.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name))))), index.h("wa-select", { key: 'e68ea80e59302e5e6e800ae3fedc3e60e557859b', onchange: e => {
                booking_listing_service.updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing_service.booking_listing?.balance_filter[0]?.value }, booking_listing_service.booking_listing?.balance_filter.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name)))), index.h("div", { key: '9cf99c3b84f52381d4c2ef966cfc64af9997d477', class: "d-flex flex-fill align-items-end m-0", style: { gap: '10px' } }, index.h("wa-tooltip", { key: '041623c4e9205a695e12e547f9e1c4d8bcceb30f', for: "search-btn" }, locales_store.locales.entries?.Lcz_Search), index.h("ir-custom-button", { key: '6b8f5f2c29182c8fe9b4fbb3254305998031711a', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: '2cb208f51a1ad181f463885664afbe85395cb777', name: "magnifying-glass" })), index.h("wa-tooltip", { key: 'cf18904ea7e6d6ca0dea5c1275a0a0f7bd6495a5', for: "clear-btn" }, locales_store.locales.entries?.Lcz_Erase), index.h("ir-custom-button", { key: '7e0396836ba3ab23518eff81b4912b2792eb8632', id: "clear-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleClearUserField() }, index.h("wa-icon", { key: '3e4aa46e5aac5e8b3cedfcfba73c32f3a2f2eedb', name: "eraser" })), index.h("wa-tooltip", { key: 'b847588b77f31c7ff3da072afc001ad63b0c36c8', for: "excel-btn" }, locales_store.locales.entries?.Lcz_ExportToExcel), index.h("ir-custom-button", { key: '3be569a78451bb7f6f7f1152c86f7c78f93adcee', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleSearchClicked(true) }, index.h("wa-icon", { key: 'cece25ab34841e4179dcc42c7ad71ad604e4b2bc', name: "file-excel", variant: "regular" }))))));
    }
};
