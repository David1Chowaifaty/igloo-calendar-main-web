...
const IrBookingListingTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ae6f241918ca210cdeefc0801445555c151c44fe' }, index.h("div", { key: 'd2724894d591fcdb037ca736129e9222468b07b1', class: "table--container" }, index.h("table", { key: '3eb66869360d1a1d915b2217611f2af0451b43f7', class: "table data-table" }, index.h("thead", { key: 'f0300df83b8bf2dd01b38d1c3bad0bd2f1ad9528' }, index.h("tr", { key: '1bc78833e1c05c2ae7cd86f3e7b518f0dbcdcc9a' }, utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && index.h("th", { key: '8295336f1fd52bee2536ae686c3e3426b50e5321', class: "ir-text-start" }, t.t('Lcz_Property', { fallback: 'Property' })), index.h("th", { key: '7cbd3d15c18b952c681141c712b6b1e557007f93' }, index.h("span", { key: '0b602d7c45e157d79a6c09d913076dc891b32463', class: 'arrivals-table__departure__cell' }, t.t('Lcz_BookingHash', { fallback: 'Booking#' }))), index.h("th", { key: '20bc22e22cfd88db350604f96eae50fe95f03ca5' }, t.t('Lcz_BookedOn', { fallback: 'Booked on' })), index.h("th", { key: 'b676c7d1939be2de7187a522e7088d19bc846e26' }, index.h("div", { key: '83c916696f182b0a06438a4573711e9482ef0586' }, index.h("p", { key: '3e1acec34e7d2251b51785b1c11a192d8697235e' }, t.t('Lcz_BookedBy', { fallback: 'Booked by' })))), index.h("th", { key: '22d992ad2d63ac8a846e29a5e1a90f4f272df72a' }, t.t('Lcz_Dates', { fallback: 'Dates' })), booking_listing_service.booking_listing.userSelection?.filter_type === '2' && index.h("th", { key: '3df73dd832962da0ca0a651a1102f025b742b963' }, t.t('Lcz_ArrivalTime', { fallback: 'Arrival time' })), index.h("th", { key: 'd57fbbaad5ca31015756a23435089728e3033c66' }, t.t('Lcz_Services', { fallback: 'Services' })), index.h("th", { key: '3152bac086e3db22cb40adcc9065f44d42202c10', class: "text-center" }, index.h("p", { key: '24bf79fa9042d2b6cb5892b05bf1d33a004eafca' }, t.t('Lcz_Amount', { fallback: 'Amount' }), " "), index.h("wa-tooltip", { key: 'b926fff0afe3a82d88c2ae6284046d720efa5269', for: "balance-info" }, t.t('Lcz_BookingBalanceClickToSettle', { fallback: 'Booking balance click to settle.' })), index.h("div", { key: 'd654cdd1837cb77a5d0896148f0f8086a8de572e', style: { width: 'fit-content', marginInline: 'auto' } }, index.h("ir-custom-button", { key: '51d0411aef3fa976d3bd9f3d321602fbc8873244', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "s", variant: "danger", appearance: "outlined" }, t.t('Lcz_GuestBalance', { fallback: 'Guest Balance' })))), index.h("th", { key: '69c4c760a0eebef7fd80ef610a4fbcb5af013776', class: "text-center" }, t.t('Lcz_Status', { fallback: 'Status' })), index.h("th", { key: 'c5b53f0238bac24d57a0fa29c54964900680555d' }))), index.h("tbody", { key: '19e54ce0d36406b674f2af02d87273bb1579b631' }, booking_listing_service.booking_listing.bookings.length === 0 && (index.h("tr", { key: 'c8dfe9feddd90d67c7c021b5752ad8e3ddf14178' }, index.h("td", { key: '4d75d13b3256e728b19d3a2cbf51c946ba1336b8', colSpan: utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) ? 9 : 8, class: "empty-row" }, t.t('Lcz_NoBookingsFound', { fallback: 'No bookings found' })))), booking_listing_service.booking_listing.bookings?.map(booking => this.renderRow(booking))))), index.h("div", { key: '4e039fbf729132bfc316b50d565a2e06f266907c', class: "card--container" }, booking_listing_service.booking_listing.bookings.map(booking => {
            ...
            return (index.h("ir-booking-listing-mobile-card", { key: rowKey, booking: booking, totalPersons: totalPersons, lastManipulation: lastManipulation, extraServicesLabel: t.t('Lcz_ExtraServices'), onIrBookingCardAction: event => {
        ...
        })), pagination.totalRecords > 0 && (index.h("ir-pagination", { key: 'd5eb7b2f3f81ab0f3cbb8b2d79484c3a5781f934', class: "data-table--pagination", showing: pagination.showing, total: pagination.totalRecords, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: t.t('Lcz_Bookings', { fallback: 'bookings' }), onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })), canLoadMore && (index.h("ir-custom-button", { key: '35485b87301db7f2fe9147aee7795acccccbd0d6', class: "booking-listing__load-more", variant: "brand", appearance: "outlined", loading: this.isLoadMoreLoading, disabled: this.isLoadMoreLoading, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.loadMoreBookings();
            } }, t.t('Lcz_LoadMore', { fallback: 'Load more' }))), index.h("ir-dialog", { key: '2fc132dffa637fad7565e3ec759c947656ac4434', label: t.t('Lcz_Delete', { fallback: 'Delete' }), open: !!this.booking_nbr, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.booking_nbr = null;
            }, lightDismiss: false }, index.h("span", { key: '81eeeaf0d595915b1ed8e1d2df486cdad12ed959' }, t.t('Lcz_SureYouWantToDeleteBookingNbr') + number.formatBookingNumber(this.booking_nbr)), index.h("div", { key: 'dcb635624690d0b86eabd7c9ef8f0a23ec9b7031', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '8a0ea67158e60aea5b7799e249a9b88057a25730', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, t.t('Lcz_Cancel', { fallback: 'Cancel' })), index.h("ir-custom-button", { key: '501d279f446fcab546485f82279399f2908f8f11', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.deleteBooking();
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8e14b75147b838e3fbabc6ab2da4ca5747e739e5' }, index.h("section", { key: 'ecb2c51e466b44c89b6a39c437cc5cd9ce69265e', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("wa-select", { key: '78be7298efa63d37cdca245990244a40fbf1962e', onchange: e => {
                booking_listing_service.updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.filter_type?.toString(), size: "s", defaultValue: booking_listing_service.booking_listing?.types[0]?.id?.toString() }, booking_listing_service.booking_listing?.types.map(b => (index.h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), index.h("ir-date-range-filter", { key: 'e63dfb29580b0fd0391fc8a44db96259081a15f3', class: "filters-bar__date_picker", showQuickActions: false, fromDate: booking_listing_service.booking_listing.userSelection.from, toDate: booking_listing_service.booking_listing.userSelection.to, withClear: false, selectionMode: "auto", onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), index.h("wa-select", { key: 'edd356b79890c85bb0610d540f1afd41a285820d', onchange: e => {
                booking_listing_service.updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.booking_status, size: "s", defaultValue: booking_listing_service.booking_listing?.statuses[0]?.code }, booking_listing_service.booking_listing?.statuses.map(b => (index.h("wa-option", { key: b.code, value: b.code }, b.name)))), !utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && (index.h("wa-select", { key: '7bbabab0de0b9149eb50b06e9c54a8c7a820a633', onchange: e => {
                booking_listing_service.updateUserSelection('channel', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.channel, size: "s", defaultValue: booking_listing_service.booking_listing.userSelection.channel }, index.h("wa-option", { key: '698a70d9a42dcdf156fa44b5b8dfea3323d77d62', value: "" }, t.t('Lcz_AllChannels', { fallback: 'All channels' })), booking_listing_service.booking_listing?.channels.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name))))), index.h("wa-select", { key: '80c7bd712f8808de0ab1e8f0e83ebd96bb3ba7f5', onchange: e => {
                booking_listing_service.updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.balance_filter, size: "s", defaultValue: booking_listing_service.booking_listing?.balance_filter[0]?.value }, booking_listing_service.booking_listing?.balance_filter.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name)))), index.h("div", { key: 'ef60e1a5e7818e9bc37a0900a85d8e358297c11e', class: "d-flex flex-fill align-items-end m-0", style: { gap: '10px' } }, index.h("wa-tooltip", { key: 'c88d2d07e12a735ffdc0e8d741e2f85bc8a0d6d8', for: "search-btn" }, t.t('Lcz_Search', { fallback: 'Search' })), index.h("ir-custom-button", { key: '107b9be4523d9a6f715dc98899e274ec2e22466a', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: 'afa34726094a44117a3b989694117352b580fc40', name: "magnifying-glass" })), index.h("wa-tooltip", { key: '1942ac113f9fdd66c532f7a20db10eaac516adaa', for: "clear-btn" }, t.t('Lcz_Erase')), index.h("ir-custom-button", { key: 'c7b84f82acce9f8e0070b183fdfd77f9cc96cadf', id: "clear-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleClearUserField() }, index.h("wa-icon", { key: '21b0cc1480cdeb1a908bb68a71b11b7255834cff', name: "eraser" })), index.h("wa-tooltip", { key: 'f5841e2ae20672ab2d354ccccd41fb90a466712e', for: "excel-btn" }, t.t('Lcz_ExportToExcel', { fallback: 'Export to excel' })), index.h("ir-custom-button", { key: 'da059a7ab24ac7a54f56c539aa41a05607275231', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "outlined", onClickHandler: () => this.handleSearchClicked(true) }, index.h("wa-icon", { key: '747bf08e8e5916442b27ec54fb8c0567ec9436e7', name: "file-excel", variant: "regular" }))))));
    }
};
