...
const IrTranslationsLanguageDialog = class {
    ...
    renderLanguageRow(language) {
        ...
        return (index.h("li", { key: language.code, class: "language-dialog__item" }, index.h("span", { class: "language-dialog__code" }, language.code.toUpperCase()), index.h("span", { class: "language-dialog__name" }, language.name, isSource && index.h("span", { class: "language-dialog__source-tag" }, t.t('Lcz_Source', { fallback: 'Source' }))), index.h("span", { class: "language-dialog__coverage" }, index.h("wa-progress-bar", { class: "language-dialog__bar", value: percent, label: `${language.name} coverage` }), index.h("span", { class: "language-dialog__percent" }, percent, "%")), index.h("wa-dropdown", { "onwa-select": (e) => {
