...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '74e3dc83c6ad075648864c6f39ff56fd5dc6c5d1' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: '6f23df79ce9babe1930e9df083c5fc5e4bf4551e', class: "loadingScreenContainer" }, index.h("div", { key: '570ca4a1dfa32cc2348779afaa5f5de4c8146b4e', class: "loaderContainer" }, index.h("span", { key: 'ded1a5e97e39ff9d44db2dcf43aceee30a004943', class: "page-loader" }))))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '88f0d895c79ba95fb9ecdbbc7650c42408e1bde2' }, index.h("span", { key: '485a63938ed7a37dc9ffbd2bd6cb53d8e4bef018', class: "loader" })));
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: 'f9d86238c099c8fec2e4563954a9c7e825b948e7', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '272227600d65f5387c5fb2f9b75580e93e6dfe77', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '9f0deaf7e5c14e1516f4b50c3744a615fe9641d0', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'b4d296da2229ad3f422999a8500d12411c91493b', class: "input-group row m-0" }, label, index.h("select", { key: '10c58cd90142d2ea097229efb042c9f73a9af6b3', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'c214c46535ef56310404ec08bfad6883e5415f6c', value: '' }, this.firstOption), this.data.map(item => {
...
const IrTasksFilters = class {
    ...
    render() {
        return (index.h("div", { key: '2c31b03353036e4aa30008a3a37d6acf087b875a', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '8a7678cdad716463fac5065d433c5b4f24202ec3', class: "d-flex align-items-center", style: { gap: '0.5rem', cursor: 'pointer' } }, index.h("svg", { key: '2e20f9d27334c3ec96125cf073219eb0b8e9a1d1', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'cd00877ec206cb44f3da0d989b9174e19ecae49e', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '6bcb90269e24429e70d284120311713461ea78e0', class: "m-0 p-0 flex-grow-1", onClick: () => (this.collapsed = !this.collapsed), "data-toggle": "collapse", "data-target": `#hkTasksFiltersCollapse`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse" }, "Filters")), index.h("div", { key: 'eaefd8c321f9602b21202199eacc932a274a6227', class: "m-0 p-0 ", id: "hkTasksFiltersCollapse" }, index.h("div", { key: 'd0d3a3864c38143b88a7da13b749786165f5a4c3', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'd7db2d061a182ad0109915115ba26291c1983c2b', class: "pt-1" }, index.h("p", { key: 'c719768ce320b53cdf7172e1909d832b9c3edcd7', class: "m-0 p-0" }, "Period"), index.h("ir-select", { key: 'ece0dd60cf95d97889fd580bbdc9bb0593248939', LabelAvailable: false, showFirstOption: false, data: [
                ...
                text: v.value,
                value: v.code,
            })) })), index.h("fieldset", { key: 'd0711b1afa7be70b1f9235db1c3c7d9aa42ca150' }, index.h("p", { key: '4e8c81fe1a9183794e64b563db22d6275589c085', class: "m-0 p-0" }, "Housekeepers"), index.h("ir-select", { key: 'fea9ee149cf6e00bf3a9c045df6ac7f90ad74344', LabelAvailable: false, showFirstOption: false, data: this.generateDaysFilter().map(v => ({
                text: v.value,
                value: v.code,
            })) })), index.h("fieldset", { key: 'e51773d133c92b08595d73fa11cf1753c51d976e' }, index.h("p", { key: '275154a182e1f96b31edf82d4cd43e87cb832f4a', class: "m-0 p-0" }, "Cleaning frequency"), index.h("ir-select", { key: '6d223d4d73b43f33b352de045b98527b497a39b8', LabelAvailable: false, showFirstOption: false, data: this.generateDaysFilter().map(v => ({
                text: v.value,
                value: v.code,
            })) })), index.h("fieldset", { key: '40244d8d90881d317f5f942a401f310f776ca12c' }, index.h("p", { key: '857ccb631d2cb8240c62a5e03c95a014219c6625', class: "m-0 p-0" }, "Dusty units"), index.h("ir-select", { key: 'ad0bfaea41781a1a650c73b924e7647504a799d0', showFirstOption: false, LabelAvailable: false, data: [{ text: 'test', value: 'hello' }] })), index.h("fieldset", { key: '72cc3fd3c40665988e5d4fc5a5e469517608c7ea', class: "mb-1" }, index.h("p", { key: 'c8a2e9e07c364bc7fc9a28eda6e134ed4a40bafc', class: "m-0 p-0" }, "Highlight check-ins"), index.h("ir-select", { key: '68578a08ba097590be7dbfb441279959a60b656b', LabelAvailable: false, showFirstOption: false, data: this.generateCheckinsDaysFilter().map(v => ({
                text: v.value,
                value: v.code,
            })) })), index.h("div", { key: '3d54d81e859428e0071604b85b9713f2603f99ef', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '01f44f6d41fce7b36f03143d96fab152f463defa', text: "Reset", size: "sm", btn_color: "outline" }), index.h("ir-button", { key: '2cb13b694628250cbea5cb6f1af4c99a44a9274a', text: "Apply", size: "sm" }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '669f31d694a11893484edc4ead47828809ac7893', class: "d-flex align-items-center justify-content-between" }, index.h("h4", { key: '3f8dfbb460ba7d59b0d4f8badec36465418e9d56' }, "Housekeeping Tasks"), index.h("div", { key: 'c12d4882bcc3e7ef44e19b717a157f293d3b50e4', class: "d-flex align-items-center", style: { gap: '1rem' } }, index.h("ir-button", { key: '47e9c4e91f5754346a901dfec8b5892ce3b1b81a', size: "sm", btn_color: "outline", text: "Export" }), index.h("ir-button", { key: '25c43df1b09b0d96b5fc3ccc5dab1e0b33ac8b39', size: "sm", btn_disabled: !this.isCleanedEnabled, text: "Cleaned", ref: el => (this.btnRef = el) }))));
    }
};
...
const IrTasksTable = class {
    ...
    render() {
        return (index.h("div", { key: '945b114a2ebc7a7c7820cd601dac115861be97b2', class: "card h-100 p-1 m-0 table-responsive" }, index.h("table", { key: 'abfa8cc06ed8983d9cc67b8d97b55a61550567bf', class: "table " }, index.h("thead", { key: '093000b25ea111ac80453e2a990ee65f54f534e5' }, index.h("tr", { key: '2b27b7261e1bc63f81e0861399dfcfbdeb1effde' }, index.h("th", { key: '298fe720fbd074492c425eae36c5d97cffbb6e35' }, index.h("ir-checkbox", { key: '652336fdd11da7e539cc800a769d159625e18519', checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '28299004cc0f57f9175c9e2f579656ce1f762dad' }, "Period"), index.h("th", { key: 'a1295c525dc9fba0114cfce9dd6032c53bfb1336', style: { cursor: 'pointer' }, onClick: () => this.handleSort('unit') }, "Unit"), index.h("th", { key: '55391c151e7f47cea1c34f6618224aa519f20a9e', style: { cursor: 'pointer' }, onClick: () => this.handleSort('status') }, "Status"), index.h("th", { key: '573f54c870d00a5dca189d7b78e0a3c42d4a1986' }, "Hint"), index.h("th", { key: 'e5f7ff551429e835a6b54232132a84413b644ce3' }, "A"), index.h("th", { key: 'abba8a0529079a3d62fc204f1199e7ea0c70f073' }, "C"), index.h("th", { key: '0494efbd76e93fd9dcd8f66f9ef5a84781e8754a' }, "I"), index.h("th", { key: '265df50810321146fbeb3536499518f859ebc586', style: { cursor: 'pointer', textAlign: 'start' }, onClick: () => this.handleSort('housekeeper') }, "Housekeeper"))), index.h("tbody", { key: '22cb826bb0567da5fd0edc1d3c4e733f1db33c2d' }, this.tasks.map(task => {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'da60e49610a4d8058cdf88ebbb6d5790703138cb' });
    }
