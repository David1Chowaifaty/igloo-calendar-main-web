...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '33f539496e42e5affedf36bc10c6ddb10333ece7' }, index.h("div", { key: '45ec7b132d754c2a8ff7773fc88af52741ddd7b5', class: 'd-flex align-items-center ' }, index.h("label", { key: '188a6a77126d0da208dbdbf744fc345fd090a347', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '150460e8f72a1ece1465e8c0c2bc207c4b1ec68c', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '006a68559e22ae5026aa22cb269f1a5948d52ba2', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '46beadb7b177b77c2e065213480401914acd52d8', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '4e3a5da63382e3e4cbe6974b9d5494fd23ba48f8', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '1a5e11e836b4f9297be576e88dfd4aed90014b08', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'db57db59eb35450d8af8c2b0270c0b7a0f352683', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '5f0bbf7e8fbb90c6e5de0744349454fae6ca8bdd', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
};
    ...
    render() {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: "billing__container" }, index.h("section", null, index.h("div", { class: "billing__section-title-row" }, index.h("h4", { class: "billing__section-title" }, "Issued documents"), index.h("ir-custom-button", { variant: "brand", onClickHandler: e => {
            ...
            : moment.hooks(invoice.credit_note.date, 'YYYY-MM-DD').format('MMM DD, YYYY'))), index.h("div", { class: "billing__card-detail" }, index.h("p", { class: "billing__card-detail-label --amount" }, "Amount"), index.h("p", { class: "billing__card-detail-value" }, utils.formatAmount(invoice.currency.symbol, invoice.total_amount ?? 0)))), invoice.status.code === 'VALID' && (index.h("div", { slot: "footer", class: "billing__card-footer" }, index.h("ir-custom-button", { onClickHandler: () => {
                this.selectedInvoice = invoice.nbr;
            }, variant: "danger", appearance: "outlined", class: "billing__card-void-btn" }, "Void with credit note"))))))), this.invoiceInfo.invoices?.length === 0 && (index.h("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', flexDirection: 'column', color: 'var(--wa-color-neutral-60)' } }, index.h("wa-icon", { name: "ban", style: { transform: 'rotate(90deg)', fontSize: '2rem' } }), index.h("p", null, "No records found"))))), index.h("ir-invoice", { invoiceInfo: this.invoiceInfo, onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = null;
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '63cb2d56134b9a3474d963fb5a591f0eb86dd042', class: "fluid-container px-1" }, index.h("div", { key: '91c21c2db24e01a3b0511789feac8a32490a347e', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: '1385e912353061bc4e91692a7dff506b3ddaed47', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("div", { key: '537026103b1c98447a409c5394f3401937481c5f', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("p", { key: '8f107a4f6d633ec2b0f097ad9e16ecd111c5b5a6', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("wa-dropdown", { key: 'fbe2a4d33fa9a19d669791365650f0f211117b96', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                this.bookingStatus = e.detail.item.value;
                this.modalEl.openModal();
            } }, index.h("ir-custom-button", { key: '335d398363ee2cf24cf347d8a121da34236d60ba', slot: "trigger",
            // onClickHandler={() => {
            ...
            appearance: 'outlined', size: "small", variant: "brand" }, index.h("ir-booking-status-tag", { key: '23fc6e33e1165b2b2031ea9e8fda2f0d79f29d69', slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", { key: '6c0d30751d0ca3233c0af4180246e8bf418256eb' }, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))), index.h("p", { key: '25b49bacb211c18c76cd26038be7a0c27799cafb', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'c682522e400ec2491247d2c300dbd0ec2efb506d', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'fac1509b9eb573218e2af7c5cfef42ad59d7aee4', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '3544ef05465cf1da3c9a94626d3b72f5db82da59', class: "d-flex flex-column align-items-center" }, lastManipulation && (index.h("ir-popover", { key: '8db61ce3ba106eae97c0524f9e9060c7da53ead9', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'd73327688008080f1db4bfe7d4632164ae7798e1', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '10a80a969e213a55385e1ee10c40c8eee0da3d03' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '3195281e4c2a67eb6ddab2c38cc343dc29de76e2', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } })), index.h("ir-custom-button", { key: '7fc65e37e606c8a75c34d194b554de09063408e7', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), index.h("ir-custom-button", { key: '56be71aec6f7acf29ee8087df3d7b8bec10bd0aa', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS"), this.hasReceipt && (index.h(index.Fragment, { key: '5660f5fc555da678423d83ffd293e798142d98c4' }, index.h("ir-custom-button", { key: 'f68f6e3a55cb302a9af80f4a06f98ff7d310bdbe', id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: 'c08d32b807fd4baa871f6c9520a1d6ee8c1760fd' }, index.h("wa-tooltip", { key: '87ab880f3b96f4441a6c3be17f5ce99620017f16', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '9245a5028752142c0f343064015bf3e19525afe5', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '5e713991f8b248cab5f650d84b24929b1f0840ae', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '90966ffd0643da388fb018246fd15a8fda6ee31d' }, index.h("wa-tooltip", { key: 'ca6951e8471eb6fecdecc70b5b998855260ff54a', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '43d09a11d4cc6408a27009a014860ffff7423ed0', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '21123ef30829e7ab870e22c1c40ed3d32a25aaef', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '59bafd9d652a341972eb93762eed05842ad54c8b' }, index.h("wa-tooltip", { key: 'be8d687a83c830e1504ea09a42b28610bea6ab81', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '2126fd365a9fb62b1fcd0211b80f7b35119d5fc1', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '80284873229c7acda389aa52fd57de10d498ab54', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: '00b7ce4acaf8f790e2a8e4b1609ecf589a225301' }, index.h("wa-tooltip", { key: '0a14022a1d8bc1296634265e3205dcee262f8508', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '8b1e02818e6547409c346f75b0296d7245637490', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '2f4c192dd5882abb355beb24fb8178234b813570', name: "list", style: { fontSize: '1.65rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: 'e08729033e675941b3895d6ce221ad3457697cf3', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'e05a410321d915c47f5be8d15c54aa58f79d5bad', name: "xmark", style: { fontSize: '1.65rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: 'b9c3dafe79b50b2a9483e12aeb094aecdb869e35', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: 'd7375c5440524d952251e6de2c4e732bd469f0ad', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '6e6ef23acb67d0ce5876813f2014c5349c4da052' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: '7e3409d0904ea5262aa56abe24c9703607616ff4', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '6747fce5c76dd43e89de6de5eef66bb8c6226b37', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '4ba6d677829de2398e0975a56bfd7bbeb12b4031', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '9df4c862d17729534672988b5e950c1caaf8a761', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCheckoutDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'a9d3702f001eb7db6eccdc7fcb7dcc115c9c2f97', open: this.open, label: "Alert", style: { '--ir-dialog-width': 'fit-content' }, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.checkoutDialogClosed.emit();
            } }, this.isLoading === 'page' ? (index.h("div", { class: "dialog__loader-container" }, index.h("ir-spinner", null))) : (index.h("p", null, "Are you sure you want to Check Out this unit?")), index.h("div", { key: 'f898f3d8da17946c3b8cc5854053a9a04af4c961', slot: "footer", class: "ir-dialog__footer" }, index.h(index.Fragment, { key: 'fcc7a1c9d41bcf11bdebe2990102aca19ad0a321' }, index.h("ir-custom-button", { key: '8881385fc2d6f961ebe5a29c5387c5b3811b62eb', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), this.buttons.has('checkout') && (index.h("ir-custom-button", { key: '532179338b98d2165eba052a7073694b417bc9b5', size: "medium",
            // loading={this.isLoading}
            onClickHandler: e => this.checkoutRoom({ e, source: 'checkout' }), variant: 'brand', loading: this.isLoading === 'checkout' }, "Checkout")), this.buttons.has('checkout_without_invoice') && (index.h("ir-custom-button", { key: '0ee3759a7862e38b92294fbda27cdf725ee24f81', loading: this.isLoading === 'skipCheckout', size: "medium",
            // loading={this.isLoading}
            onClickHandler: e => this.checkoutRoom({ e, source: 'skipCheckout' }), variant: 'brand', appearance: this.buttons.has('invoice_checkout') ? 'outlined' : 'accent' }, "Checkout without invoice")), this.buttons.has('invoice_checkout') && (index.h("ir-custom-button", { key: 'c721cbbd7fbd56cbe67f1c502f0238b8936a22c4', size: "medium", loading: this.isLoading === 'checkout&invoice', onClickHandler: e => {
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '616a65012ad950f522138d3819a55bf3982f7fb9', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: '870b3890d30e2c73da2bbccc38417a64cfc1a935', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-custom-input", { key: '4a166272c915d8b3211f94d7d64a87bdc12903b9', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: 'bbc5a32601099f43f5f27157f6793aa26b52f422', name: "start", slot: "start" }), index.h("slot", { key: '9c3cbb425754d8c3d73dd06220b730a3397e0e26', name: "end", slot: "end" })), index.h("div", { key: '4cb3f3e83fab5eddb21fa39c46bc2796b5e05375', class: "picker-surface" }, index.h("div", { key: 'c5c19a50146e2e484252aad94632ed23ca4de91f', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: '797fe116080fdb98a6e61d2b103e6e2372ec212a', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a17a051945e96202df7cf79ab51a8b1ee5334f90' }, index.h("input", { key: '042908e2d999fb3983b0a2e599059b53d4196963', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ec1a11c3411b19fdc64f9fb89ad1847f6c666c0a', class: "d-flex align-items-center" }, index.h("span", { key: '4471a084c259b24a205fedb35cb86320ce39e751' }, this.dates.from_date), ' ', index.h("svg", { key: 'bb3d03d85d2a9eb737884bef6078ad6879975a94', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '05f4d7a5295602f3d84733a18250b0e3ae146d05', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'd27a4c39d7738a85c14e96e8eed0845d6db2cb3b' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '667a807a5f9b72e5d01ea0b46490865e2bedf32c', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: 'fddbf09c3cc3adb948152ebcf759b3de9d59c8b8', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss }, index.h("slot", { key: 'a4835e9ef30ff471a875c797e321d5d62b3a648a', name: "header-actions", slot: "header-actions" }), index.h("slot", { key: 'd71c80c46827293c9839bbbfc43f807f22fde16c', name: "label", slot: "label" }), index.h("slot", { key: '32c55528563430805f4244f57c1e0068a87f097a' }), index.h("slot", { key: '2a946293bcff76753654a753f9f72583e8e807f7', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'de36df8599f9d885f6f7cb95ea61be1d1447b208' }, index.h("div", { key: 'af27224f968c80ff3d2b800356443712c43b8960' }, index.h("div", { key: '3f3ca7b1dcd18c65397440f4cb1f9fe53e41c16b', class: 'extra-service-container' }, index.h("p", { key: '3f43a51478117e4d252a383c18cd52098d11255e', class: "extra-service-description" }, this.service.description), index.h("div", { key: '86778329d8fa44ba96fc0cc3c9b548b35ef45612', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: 'c4328f06478498e885d2f436b6fa6926db669aec', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: 'f3eff2ed2a6bfd9213c6be29448f191fb4e658c6', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '6d5a7b100ff05440c3a0b734cd5698248cd308a7', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: 'f205b6033f669abaf0152c00839dea3a3f25d10e', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'cd7d4415801ec9ef427fac47398d9ba1ccbdb899', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: '489a0ef9aefaf8119bf56af3282a954b540e9703', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: 'e4df032b318fd38539537dcf03646e913603e2ee', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: 'b8ef092572fc50a45a4ffc480b3a58e8459d1364', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: '8c5b5a121f89bb508160b9f3751d204135bceb53', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: 'b44cda14481e95f41fc236b3018b29e6fae48989', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'b03caf804ebd15cf5a565e495516c959f786281b', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '74cfdb98f8872bd2812b46517ba358e759c7f036', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '02197e31728c585533c509725665ebf48a8a0ded', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'd75b1d41278d1d315ab00ac99f55bfab422e80a7', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: 'fbb31fa0547b93bbc5557e71f2872f7a8c633a86', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: 'ca023d8e7896620ff5703db99d3d5f2045f40dcc', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '2974c32780d3d772b5ddd07eccca4dd8e772afe6', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '49995e4e4e3ab960ab33b5b45f55deac3253b7ef', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '3bf745c3f38d2306fe9ed07349e1ff18a7923499', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: 'da72daafcc8e7b820611683fddc21a6472747c4f', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: 'c0e525a92bf2f16dcbadcdd2dba6a431b9ac70b4', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-custom-date-picker", { key: '5ba349d5e0e28458c57760b402d5079e64b2796e', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) }), index.h("ir-custom-date-picker", { key: '99b3baac69bd975cb414642cb62087a236465313', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'e338f7440f4a5b0efdbb20c5300b178f3ee950b2', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-custom-input", { key: 'e7212af6d67c9847d3f172c0fd95b53b9d7e2fa1', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: '5bf70d882a1165c8d260512a2ead6cf022877792', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: 'fb713e271023fcf41906a79f5fe478b587b098e2', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-custom-input", { key: '25148f3449966f0a7078d4dfa63dcbac2c11b393', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: '0fc423e8bd967c8f6ff6aa7bc55cb245b7d14d3a', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: 'f6a7862f418c9a245c05acac5eacd78ede305fc3' }, index.h("wa-card", { key: '7758d382c0a148189cc7e080bd4bb163f1dfd7fe' }, index.h("p", { key: '5e5160bd8ea6b761548efe04ed9ad49c1d0c2bbe', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: 'b122b140eb65ed58af9ae11876a3ab392bc61697', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: '26b24f09db47784cc1670f285860554df3ec670e', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '299e02f40e5c2ab1b4899c98e638a86188149bad', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && (index.h("div", { key: '834825c0dba9eac899932f10fa102410989cd831', class: "text-center p-1" }, index.h("p", { key: '420291b678801ae5163d3db8b556f2f0c2fb0ee8', class: "text-muted" }, "No extra service recorded yet"))), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '41b23624a25b5e6839f41313a18f160298f71c22', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (index.h("div", { class: 'loading-container' }, index.h("wa-spinner", { style: { fontSize: '2rem' } }))) : (index.h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), index.h("div", { key: '6e9e90a68494cba0d56b20de5502cd9803e62b15', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '6a5a07a336849d5a078be41dc18d22834de82520', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '30e048e00a3ab40198fb5537cdbbb65bea59210d', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrGuestInfoForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ab7ee7a664708708619ca432be0acf7eaf3e7e0' }, index.h("ir-validator", { key: '4130620e0676cd89d0bf33bf3704599cbc799126', schema: guestInfoFormSchema.shape.first_name, value: this.guest?.first_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '3ec35dbbbcbddbd795aca73972a7078b07716813', id: 'firstName', value: this.guest?.first_name, required: true, "onText-change": e => this.handleInputChange({ first_name: e.detail }), label: locales_store.locales.entries?.Lcz_FirstName })), index.h("ir-validator", { key: '79f5a616ae6227a0c39006c02738022340a79bb5', schema: guestInfoFormSchema.shape.last_name, value: this.guest?.last_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '49109143a1849e87439c4b738b635acf42498c1e', value: this.guest?.last_name, required: true, id: "lastName", "onText-change": e => this.handleInputChange({ last_name: e.detail }), label: locales_store.locales.entries?.Lcz_LastName })), index.h("ir-validator", { key: 'dc15e5d7c5018c178d1fa86c7fde5de0f80c3dee', schema: guestInfoFormSchema.shape.email, value: this.guest?.email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '985f4537f65985a4b4f983cceab369891185e3ff', label: locales_store.locales.entries?.Lcz_Email, id: "email", value: this.guest?.email, required: true, "onText-change": e => this.handleInputChange({ email: e.detail }) })), index.h("ir-validator", { key: 'e5b3f19db4b0e9da52b26dac7d900236217e748d', schema: guestInfoFormSchema.shape.alternative_email, value: this.guest?.alternative_email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: 'e0d8ddd8c625f112463b87f80985818b3989d1b9', label: locales_store.locales.entries?.Lcz_AlternativeEmail, id: "altEmail", value: this.guest?.alternative_email, "onText-change": e => this.handleInputChange({ alternative_email: e.detail }) })), index.h("ir-validator", { key: '34ec91810b0ff1a7097a2c2a46f7fb48ad343c81', schema: guestInfoFormSchema.shape.country_id, value: this.guest?.country_id ?? undefined, autovalidate: this.autoValidate, valueEvent: "countryChange" }, index.h("ir-country-picker", { key: 'f2b5df7a180ab8474fa14f4e12559aa09c4039da', size: "small", variant: "modern", country: this.countries.find(c => c.id === this.guest?.country_id), label: locales_store.locales.entries?.Lcz_Country, onCountryChange: e => this.handleInputChange({ country_id: e.detail.id }), countries: this.countries })), index.h("ir-validator", { key: 'b5b9a8af7f9ec14c356a385e8fabb6bfd0768589', schema: guestInfoFormSchema.shape.mobile, value: this.guest?.mobile ?? '', autovalidate: this.autoValidate, valueEvent: "mobile-input-change" }, index.h("ir-mobile-input", { key: '3374651ba505fe6bedb1df2de916e753ba4ebdb9', size: "small", "onMobile-input-change": e => {
                this.handleInputChange({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => this.handleInputChange({ country_phone_prefix: e.detail.phone_prefix }), value: this.guest?.mobile ?? '', required: true, countryCode: this.countries.find(c => c.phone_prefix === this.guest?.country_phone_prefix)?.code, countries: this.countries })), index.h("ir-validator", { key: '85063d0acdb72e76e90a899d32895fdb30b90299', schema: guestInfoFormSchema.shape.notes, value: this.guest?.notes ?? '', autovalidate: this.autoValidate, valueEvent: "wa-change change input", blurEvent: "wa-blur blur" }, index.h("wa-textarea", { key: '57bbad26892077d1899a6d2eb839575bd9006714', size: "small", onchange: e => this.handleInputChange({ notes: e.target.value }), value: this.guest?.notes ?? '', label: locales_store.locales.entries?.Lcz_PrivateNote }))));
    }
};
...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (index.h("button", { key: '18a5f0e743b8ea7abaa488134afc7518797bc7e8', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'af74637ff98de65171904661d4b68b86e11fb897', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b7784ba8e06e07203e5853ec0078dd27814c0e7' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'c18e9de8598c907935646759f094d1a5a96a2471', class: "loadingScreenContainer" }, index.h("div", { key: '83960c92ec8cd7b734f5086d227e5de7dd2d1e70', class: "loaderContainer" }, index.h("ir-spinner", { key: 'd63382c9247f33ba2f653370ad6a88acfb18b655' })))), this.showModal && (index.h("ir-otp-modal", { key: '1628ea02785b88d9472b23682cf3ba30876d257e', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '58a5061aeed9a3d8e8aa7da0b169de9fd452090a' }, index.h("ir-drawer", { key: 'd92f3d9264a6363f4e4a483836b21ae48d0e6cc5', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '5007e14f56b774fb9e1a76937e1a5577ee005d2f', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'f597b4ed984f58d045b72f6e2b012ce6f3693c57', onchange: e => {
                if (e.target.checked) {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: 'afa28e3bf03bed3e0caf7a55f1e1b6d71e7f6e89', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'c7d9511150949abcd089eb5c0df96d6e29bee5c1', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'ed0690671fdb86c59c6d612a3efb76fd211624ec', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '396d68ac9932e35a2682f26640ad5f7ec8a39c41', loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ebfa6ad85c3ee0c3e1e7cd732e59538386d3c865', class: "otp-input-container" }, index.h("div", { key: '1ec6ffcfb868407ded393e2a824be41421fc3d20', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '8131936c83e235734b2b00049df0ab937f197c72', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '16fd87ee60889354f65f4dbb7de31df21111c145', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: '6f2adfc84ce02ea4782bac91344e079732c22884', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '71185aed86b2c01b1e75b96d686d5d835a9eb72d', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '4d135a32afb330738889386d0cb1ff4c80d4100a', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: '2ac2af9914f0490739062ce559075834150a96dd', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: 'a553169b297e6b8ca75a5ca321a7d7fa9bdd33a1', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: 'ad93785d1a8c148fd4286843ec12d94f47af444a', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '4ef5d94974c41bbe8747eb2e1511cc6ac20517e9', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '2f812e6f2e388baf6ede4a3882d895f41ac566b2', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: '4abd628b6639b1917a09f5697f0946edd24dd383', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '7d0712e75e699480c8b7206b8569017efc200ce7', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'ec1235b00cd785970549ee4135441c13fcabadc0', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: 'caac40d43f218073edba269b8ec2491e7bf8a935', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-custom-input", { key: '0ef0eb0876a10d17971d46abdd2e5d4e0de4261c', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '17d41068d5aa16946af32174516d3606c78ad2ae', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '10828fc138c4e5cbcf2e086c27afed1a5f5de6e3', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-custom-input", { key: '6f18e9666f1695dc3611d572996902cacdbfb650', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '67c7e9e378825d41514bf64b47701fba8d0c3abf', class: "payment-item__payment-item" }, index.h("div", { key: 'ce7abf04496cf02420770ae16fd335e3d01aaf58', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '355816dcaeb1d0dbe8eabf572460e2acfec92d44', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '4b20b3a2ab883659937394fb5f5c4be87be3ad7b', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '9a7fe96aed59c98e7edb406ff8569dd89ef908c7', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '2d148c46c8730794222ce010d97597ae2f8736cd', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '1df1d8291add07abf9961ef2eb94715b78b748a3', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: 'de7b40d9d84542a648ac1b9388f5e817caba5e0a', class: "payment-item__payment-toolbar" }, index.h("p", { key: '75d4b4f09c03398e47235ca7d6d9f95a88000525', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'e192aa06e0f0d3d76a2d5fe0c1c312fec8803a7d', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: 'db4f36cc7a5bb2288eac19f1d67a0f7cf0653d9b', class: "payment-item__payment-actions" }, index.h("div", { key: '1f8ed94ca4a33a182eea6c345f57cf352da775d6', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '9868e4e9cf2c12f20fd90f741292f3dcd85ad00d', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '19354466330e9ed0df65ad6c50d9f619b454409f', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'e1441e76d70c3dbbd562d8104ad1a8a23ba2f717', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: 'f61a9edee08b167bdef40e14f80e6b355431b356', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'a9cdd8a9aa5306eb50a3350c8a6156ba698c2f3d', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: 'cf747cc0129461288034b94549095564c0f930f4', value: "receipt" }, index.h("wa-icon", { key: '5b5bf7d8b6c8e54e76281fce5919939778a8b8ce', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: 'd963e1d4ca4ab7588e5a7311e152c51b2412b75f', value: "edit" }, index.h("wa-icon", { key: '22394f570f9665ed08e2c4aa2307cf0b87fa1763', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: '696187c43fdd4cab41ce7e0d883833dbf92bb5f7', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '04617d3bd4d6d529ecec17e782448f2c5d1b3523', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: 'f1543b401434c4e164e8224c552fa3a1792b2041', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '1c5920955f14d6bf0d0dfc5c4269d77fabd01f48', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '24562dda2aa04575e92db40ac5cb5dd6df9f4a7b', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '22dbde9a3680367fb851cd1a0cd81d02e4a952b1' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: 'c06e422af99a60d4f3754debe7be2eb2ac4449b4', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '95699ee0e40cd057a59f6e3ba721d72148a19a39' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '1e39ca450abee6975e07541ffbe81e5eb275dab2', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: 'bf2b02ec41e6186b5241f24ec93749c811e22f53', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'ea6da1c3c10c8cee254bfaf53177ded4b993b1fe' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '7d6c011bb95987b85188a7dfcd97c237cb65f749' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: 'b3c4dc605e4317d861343f8598e5c260133694b7', class: " payments-container" }, index.h("div", { key: '17072a563282c97a40fdf61240a901749df31ba2', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '766a062722e0b0d677bcaf57003501e8544d166d', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: 'c13e8a823ac98759cf2310605797537396ea0ff0', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: 'f503acad453a6cea73f9d004a9e534a013418a48', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '7a834b2abe85eeffcab9f041fa0884079facd62b', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '13c8b4e697eff23d1f79642017360770c0ec0e94', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '4e2fdb4c8824db346dd963d6fbd6fda763669ac5', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '9b643d87cd7382dcb683589bef5e2d97f4cc1cd5', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '964d9bbea9bb4738734b835197c0d1c5a13342fd', class: "picker-item__check", name: "check" }), index.h("div", { key: '1699bb93d76f418d7fc5a8de736444b1c553ea4f', class: "picker-item__content", part: "content" }, index.h("slot", { key: '714a136ec0a28d7d9c129e47bb144206a4ef3739' })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '46e685d7efb72fd8bac7b541cbc98491f189cacc', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: 'f93cca63eac319bd84ce6004a7f95664cc538a40', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: 'fa7366af87dbe4181556cb93d3479ab8bbc0d88e', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '5ba6da750d93079c76e1dbf99faa511a580a730a', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '651601074aa5e15554b015948ae270ad7f878a94', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '366f0b02f96432c4e2a01d1de2046fd592c42696', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '1f9c627a8b863ef35501099ebfc16943053a0356', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '02f1611912cca4293afbdaebaed559af8ef5a900', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '2a6c8976a6cfa476bdbcddc0f80002ddc2ce01ca', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: '0a84c5636963a891f218efc46c1d9ef3ddcb3dd2', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: 'd4987d0365a9a3c0ccbd75eb1a0d2bb04544ae16', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: '89e42d8aa94e6482b5e9bc5c93988d417cead52a', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '84a585abc1bc34315aa276e9558e7bbb232a62f2', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '8ce8d5fbed14729783530cee180a4f15aa69d2ec', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: 'c878133ca64b2c05f220bb3f2fefeba70ffa0f39', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '79dd0dc3fd39455a0ad720ca7923cba59ded87f7', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: '6dc35506eb7a5929caa28c5dae2ee335bb860c36', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '049e429ffa0ba09e5674029e5e449339d46754ed', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: '6b4ec5b3b48818fcd75935fd70196184a5c9dcd5', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'f54b9a88c0d8c0e31f7364cc453d667d1feb940b', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-custom-input", { key: '9dd2ff7b6379bfccba659d4128db46582e552a36', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: '4c8a569e1b59f370341f613c7b5a7bebf09c1066', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ea722bb667eb255bc53cb581bfbf1373d90112c', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: '60e395a470a02f734711f18ce15e177ca66fc9ba', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '6d59c7fb72392186ca6dd5460ca3616a4bde9a1f', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '884b77409a54554823327110b49255d1ba47b844', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '413f8aee566221c5b084143601af9491ff15fb4a', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '61b013ef41c806bf939c23d6359aeac3e35da124', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'b07e5325e6632edc30cbf97059f05a8af3b28d19' }, index.h("span", { key: '27f89301478406db54bc3759fbf6ac96aac14cba', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'de0a8147742732654ee196e09bbb63a7741b9d3f', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '89c1d31af161a8a5b38d15a0441db0bd3c6f15fb' }, index.h("div", { key: '155e70c0828fbc8d7f626d1be5716b23f27edafb', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '440d060b959ad8ee90430edf47dce15529d3ddd5', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: 'fa5463cacd23d37812840ac6379011199d20ebfd', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '8fd90d3879145390c41692693012ee1cdc8a3ac8', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '4dd71605d6bad5e47ddc827dee30f84e1a91e2f2', class: "reservation-information__row" }, index.h("ir-label", { key: 'e265d5fe81931b8037864c53aab79d34ea9f1e45', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: 'd6ed01a2fee83ed99f1b4d6dccde219fa7019813', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '22f7206a764db902e5a46d6f40acd4b37e481852', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '5ec452899c95b068c97be4e11a3db194754a245c', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '52cb7837b8c6f301bbf121be1bffcfd28a28a82d' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: 'a5b96cb341321d8347437d72cc7ac5908aefed7a', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '3f7c8d625fde0fc8855f6b8a169a5a9707061cb9', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '62eb1142008b4f924d2a193a1035f77d05319d43', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '76156d709d8c888ba47081f6d4fcf7ee824c308b', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: 'd25717e75fa9b7f7e206473296ce50072faca074', class: "reservation-information__row" }, index.h("ir-label", { key: 'ba965e0111d2cf03e4ce10a4edec3948eb215c01', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '7c0a3fec84e18d487ba8642c3fe9058db2943057', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '096e15c8852e2273e77ce6e6e43829f142ebaee5', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '185937a289fa461c2f08b4de8c3082beaac05b13', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: '0edee3ef7383568dcc8ac1ba8cdd8911a7d38a38', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '592709736c9074d26305c08635875c0feb6ad3f5', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '088bb476f3b22400d3caaf459d30ab8772d32ff3', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '30b6e663e096236566cd164e92f6184e01e8e6ed', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'f2db72f4b7b78f071498dc37aacc5dfefd209978', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '491a2825a18c516651ea3f48b7170d70dd223802', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && index.h("ir-label", { key: 'f4aa38741030565de3a9700aa283947c68ecfd6d', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'a6e34eab9f899119344150135bdabb385ce52f8b', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'd5425db46f9e4ca2f70dcc85973bba4ca487d293', class: "d-flex align-items-center" }, index.h("svg", { key: '7145f4f7f9525669410d4ae16c852c922cbded02', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '03d79f05e5693ea54d545c5f1377d6fd985b715f', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '6869d906b7b333230d936337d232737f49cc52f8', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: 'e1352944246b43a12c52ce3f896e963805b97dbf', class: "reservation-information__row" }, index.h("ir-label", { key: '4953dfc6f651850b2f87137e5cd413f74ae92c98', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: 'a0b4bc170b88981e25895edfa35b287bdb1d3eb6', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '5b5c3393d31699bd592de188e523b7f4cf4869ad', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'b3dbae457ee3507b1e7592144eedd7278cc7f4d5', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '3ca4183e7647072cbac6c8702830bc98257e7d5a', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-form", { key: '44595853849b32c8d4932a87f4c0072f19489d97', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e2c9f2e97e1839f28b3d822354c63730188967c1' }, index.h("div", { key: '6d000a54c34d1a1749259be15a79f352343cfc02', class: "booking-room__header-row" }, index.h("button", { key: 'cc904036c85ef01ee7506c72d901d58a64bb5192', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'fdd13dc4ab96f623fa03cbe21e154a2a5e27e31e', name: "chevron-right" })), index.h("div", { key: '93370f28c24a6e0bf593620deb123b18d6604e17', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'ab643ecf503cc0c0739c6754da699ac042b96b65',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '07560d024e2e065bbcd5d8f702546f09d31eddd2', class: "booking-room__summary-row" }, index.h("p", { key: 'b0ab2c2eb6e668a3a950e3382b26af63d07d8a34', class: "booking-room__summary-text" }, index.h("span", { key: '4bef3c5609ace70fc3f00dc32c03bdeddd9c1165', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '1e44c7a4b4bfe8211123694a990a48ed41ebb425', class: "booking-room__price-row" }, index.h("span", { key: '749edee947857628de986e7c07f51085e559685e', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: '99fa6e8d3d25936dfc75e295ff849e255d4d43f9', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: '24b9e153288e67bfb1fedc9c6f6b734cff011d81' }, index.h("wa-tooltip", { key: '941de223525867a2c0e54edb3e590682eaa794f2', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: 'ae8c78f2d63f353c8629834e8abb9942ee0272f8', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '3a30430f9c8548c77d08736fb820b6fe212e1f77', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: 'a0a8e2e7484e5d58404a503e9b691c0fba0c290a' }, index.h("wa-tooltip", { key: 'afba449588e72eb143ae32d5c7d9bfb06e5fdcba', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: '7b3528ad4a8ed61ff76fc82d12493bd174a0864f', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'c425eedc94158a027438f4d938086e7949499e2a', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: 'da70894fd7e6693a6409f1c971f2e363184095c5', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: '1f26afabe2619db01aad9328cc2cfe33c2c70a28', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: '9f69454df70235df4e21753733bdbf663a6947e4', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '4def09f37dcddf68b43f59b4286ee56326983409', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '837e73e3cb7caeb6bb51db3102e3b183c02481b1', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: '1a57aa41faf07cab0c7f5df3e019bdc43d6d7283', class: "booking-room__guest-row" }, index.h("p", { key: 'a2dd0f7c7939bb485b33ac50dacf66eff89e9f5c', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (
            ...
            //   ></ir-button>
            // </ir-tooltip>
            index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '08a0a874be687775d2b6d3aeca1d84b146025852', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: 'd54d5c1cc441748c22d483db013a2f35919b90cc', class: "booking-room__departure-row" }, index.h("p", { key: 'c602749858f2fee6fafad859000bf4d011eef43a', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: '7f88620354855e712b2bf55263aa6c850467dc8e', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: 'cd6214a57d2fc70e5835da9b1d7b5e9d7bc5a270', class: "booking-room__details-container" }, index.h("div", { key: '768584a000e04909edbb5f7811eba961fd3779d7', class: "booking-room__breakdown-row" }, index.h("div", { key: 'b8056c9cd23bfc03ea413b86b08b210afc655ad1', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: '1c6826b22fd75a5d3c5dd801b398acfdcc1b8e99', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '58fe63e24a65aeeeabe93cf316c64daa4bcb36b5', class: "booking-room__breakdown-table" }, index.h("table", { key: '9160b96caf825d545cc964845f20e228b4d83d14' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'e074ed3b03ba38e3de8aff122f86f18974d0ece9', class: '' }, index.h("th", { key: '34d46831ac11f6068258067cac27abec4f8b22fe', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '1bc03a9a5e00bb5d98f7cc2dd9c586000a966cdd', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '29d2ff8db73155d0ee2f6ee78e4548598a34f298', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '30b6a259b60fe9acb9faa1d53d74cd9ccde49bcf', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '6c4ee689952c38e97b2d9cce46c050998fadc835' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'cf4d35acf44fa41626d2bee5b14210b6cec87ff9', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '20a62a61042608e17b09e4d13c955ae4dddb5048', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '1496c7d33e5ff024c93069ddcb0854c514ceffa9' }, index.h("ir-label", { key: '6bb8e1937afd1fc456ceabff14f8dd9e38533b57', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '0b8ac2aa9e3311819079357cc245735954d9fe67', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: 'aa3543abe67f963ad9eec9e5acf8e4c1f5dd3e3f', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '68aa88b464ce4ff332eec16c3fcebfd335f6a155' }, this.renderModalMessage()), index.h("div", { key: 'fd282661636f103b8c1f2cc16ec5862e375a8c28', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '4d1a62f6e1b55c421420cdabe651071fbdcbd9b1', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '9eb471fa299e992db69ef68480a0651002cda631', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '712601281cb3c481606fb56a266c973c52ef6f80', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '47a58ab6665eca6b955904a2ae646159e3bd3b42', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (index.h("ir-drawer", { key: '3ecfaf1868a6e88c402194c8eec095ff0b1accb8', style: {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7df813829cb49ff6ed29be54963acc193471a5e6', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '4b9546fe94f551500f170c75f0b480927a5ebf8e', class: "input-group row m-0" }, label, index.h("select", { key: 'a77cd42306482a018400dae87a0e0b599cfc2f5e', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'b87b6d5c2c78ea24a1119c27740a1f106826dd97', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6c7c0a42081a8f67cbcfe489bb3ed8bc539232bc' }, index.h("wa-spinner", { key: 'ebdafd47e41f9678839ab9cf13b20f6caef942d2', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'ac9639d2611166558f3a3d0b156c6a26542c9b3c' }, this.showTooltip && index.h("wa-tooltip", { key: '720833c02dc0fab6a74220bd2d3ee2b2a4fd9b65', for: this._id }, this.unit), index.h("wa-tag", { key: 'f3dc7582bd7c0dd32f8504eeca57f7695d6f4be0', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: 'c039f95325a88f01f30c1d8fb2590fb52295703c', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd9d5f104c800f9173df751709f0c987d2bf7a35a' }, index.h("slot", { key: '2d99a0acd06cc18341e3a58d2734e0ac8091257e' })));
    }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_77.cjs.entry.js.map