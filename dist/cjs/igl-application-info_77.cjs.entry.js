...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '7100bd9e32681581926c98b1e7bf5280294d3065', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: '13b8fb658402588d093cac43512c5bfbd58c7563', booking: this.booking })));
    }
};
...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (index.h(index.Host, { key: '823f6ef7ea2b1d82bc47b784368506ff45cb1228' }, index.h("wa-radio-group", { key: '403fbbee96f153c8a9232d49891c3e7c41879507', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, index.h("wa-radio", { key: '4855a116c9ca376c684963eaf8eac5ee4540bcb1', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (index.h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, index.h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), index.h("wa-radio", { key: '75b9a19a9e6a458cb7cf485ff5767453ba2be985', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name')), index.h("ir-booking-company-dialog", { key: 'b06c40fde55674c5695e92cf340a1193fd1910a5', onCompanyFormClosed: () => {
...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '70718eefddaa01a72552ff603c9b376883e0256d', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: 'daf1459a5d90809db39653253f8542bbd5cb49b1', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: 'bbcff659c4d15d38e156b81dc8a799407d165dbd', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c2f62d8437daa91b3b51c60ab9e3b9c478336856', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '8f5b3fc96f4605bc071527d1df0f367dc4f8212d', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: '35aeae8ea0c40265667d705ec17c2c64a7e7e9c4', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-input", { key: '4f6c387f9abd0bc8137234453448f39d767b94d9', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-input", { key: '928fb93a93b1a751534f0868f9624886e3bea8c4', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '2f19e16a92de9ecbbfbe878aa0fb794a25c6fb03', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '6ab0c1b6886a30e1f6cda0b1ccfed1a1110f973f', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: 'c3096e08f2f41d33b51af5e8679978b0a3e161c8', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'be6c4af6a210777b3689cf67e2eadd18513dd06b', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '790dc8a6c8d4bc459794ca74534f8431455d0d16', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1afa45edd24fbdfb566cd0090365dfaf1601db82', class: "fluid-container px-1" }, index.h("div", { key: '3e04578a7b35c3baf1d511b477667614c262377b', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: 'bf303c2819608ffb2eb8e9d1ca8bdfe0b718f949', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("div", { key: '17f55277ea05201e4f178d2fda115f25f8935417', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("p", { key: 'c67e55f6c4159593b9e35ca2014dc9fc76abf280', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("wa-dropdown", { key: '70dce247bf3bafc6134dffff6ac99da2ff1c0139', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                this.bookingStatus = e.detail.item.value;
                this.modalEl.openModal();
            } }, index.h("ir-custom-button", { key: '6e1b3fb62e9c5fef0d58662d73d22b5c148d4310', slot: "trigger",
            // onClickHandler={() => {
            ...
            appearance: 'outlined', size: "small", variant: "brand" }, index.h("ir-booking-status-tag", { key: 'b58a3cd9c5d041dd7ff6d36e0e256c816a093516', slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", { key: 'de28e8e0f553393bcab6d11ff63ef72c2354cc5a' }, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))), index.h("p", { key: '5ee4b819ce66469acf0d46544ef771d24935591f', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '09983a20c6f30a5c2c0b2f9e96da979a8288e2dc', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '4eb8e8dafef59d12090729c2da82e1bd18cc2191', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '0f748edabba2049a6652ecd761ef36d2735401c6', class: "d-flex flex-column align-items-center" }, lastManipulation && (index.h("ir-popover", { key: '933a6bdb710fb1fc63452f27ce74ca48bf98554b', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: '2aec7edcce4af760f131b302b43a3d4d45dedb9b', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: 'f076e2f169d8a657efd0f81d640fe712fddb23bb' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '4a6980b52dd29bec4bd6441e9dcbcf49d7dd920f', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } })), index.h("ir-custom-button", { key: 'ee3fd31a00169734978595c42d9dadbb675e1fb5', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), showPms && (index.h("ir-custom-button", { key: '007a0c988f7106b27d86f6010002bc31d6b119ab', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: 'fc3958a295612a21c13165ba90a2687e9a440033' }, index.h("ir-custom-button", { key: '9957f6543096e4bf5e07efda678f18cc73b0eee8', id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '2bafe9d72f8421432fdb2ec3881c24f719dc9edf' }, index.h("wa-tooltip", { key: 'c7eb35d2a9bf6c9452553dfe9f89e7b7990bc90a', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: 'f045c3c20286b6db8db037e2aa2ebad87833358f', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'a58d8cf5826438d344ddf7b17e01b895d7703c99', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: 'f829f15c1ce450a1d44aa854881ac13f4d15457b' }, index.h("wa-tooltip", { key: 'b736e4b1b451a7b9e672ead3427ebe8aada8eb54', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '5387f96f6b73c79526cca3b7b4c6eb340a18fe8e', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '02d25c617947c81a42028f3a55d1172f2ef1515b', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '11f9bb7ec66ab78a964e52d315ef3e558492b6c1' }, index.h("wa-tooltip", { key: 'e8ecb19268c6289ba7ca98e6adff3784a05406a9', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '80a26322c05352d36ef375ff18b1fa7b7701bdae', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '8283e95f0fb33cb6efdec1c20a9b58ccba75accf', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: 'dd1035d87100c161d35847219c4d4fcae8582df8' }, index.h("wa-tooltip", { key: '98c36279441416394fb29012813f81afb9c16ba7', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '41f4bebf7124aa36f2e51898b7f77f6abebd8119', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'e57737acbf3e4393e5455005e3c6da079613890b', name: "list", style: { fontSize: '1.65rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: 'fe324c712554b682e2245613e342e5f40674a49e', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '8af030dfc02a24ca7a079e09ca84c0cf70261949', name: "xmark", style: { fontSize: '1.65rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '14c1b1bfe99dfea342baac4d0c0d086be1c16280', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: 'cb6950faaa177ecfed216e887d1a9db0a0541b66', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: 'f655bcdbae9602a8bbec9e19d43c19c87c46ce0b' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: '13ac591575f549789f54fbafd58c9647534c5502', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: 'd36686d057228f68fd2d3b1fd8c8e13d707d3afe', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '5d96c6cbc87da4bc26e3aae9b061264eeae5799f', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: '742be7aee3dcd215884b1f85ac6f6f8589c44a51' }, index.h("wa-card", { key: '34bb0bf51640a0e1e33d7255487bc064440d1a39' }, index.h("p", { key: '611b757654213c592475c948c353d3bc70fbdfce', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: 'cff42dd99e0e418f6d5b9ab4ef990fe7d4b1b0e2', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: 'bc2fce2917ef82705bd7bfb9f57c4ce2b8961419', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '3f116f4d1110c1743d31e736c5f2612c3893f6ed', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && index.h("ir-empty-state", { key: '544b058420d651f9eabc58c1124b619105a3ff05' }), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: 'ee72bb7c22b51bfa97a1ddf2f8294e7b157a5aaf', class: " payments-container" }, index.h("div", { key: 'abcb2a22d477042919f4e2cf0a14c5adc3e3ac76', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '50973698c8860db6af457fa2713b1059d78da19e', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '1e3474116e446e0062b0531b402811c2fb30f210', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: '37cc57e18f6fc0e393b86616cde4d38255c3f5b4', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '0f11f4fba60f1ab189a66841304951a40069d9e2', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: 'c953e7f9401da3ea65a946ea7b524937dc9f779b', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
