...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f649eb2617754f2ec1600d83754a703ae9bd21a2' }, index.h("div", { key: '6d10c77915e268b90e396eecc21495e248975d1b', class: "block-dates" }, index.h("ir-date-view", { key: 'f18f2806b6b8b313dfc08d8aa85fc4254698e9d9', format: 'weekday-medium', from_date: this.fromDate, to_date: this.toDate, showDateDifference: false }), index.h("wa-radio-group", { key: '2f4fc7f0cc29b7faa99b7eb62216c230218db68f', class: "block-dates__mode", size: "m", orientation: "vertical", value: OUT_OF_SERVICE ? 'oos' : 'auto', onchange: evt => this.handleModeChange(evt) }, index.h("span", { key: '7ebfc6b3e0b77bcff325bc1c645543b0707c767b', slot: "label", class: "block-dates__label" }, t.t('Lcz_Reason', { fallback: 'Reason' })), index.h("wa-radio", { key: '37b3c58ae1eb4d815de0d88d4d61a3d67daa5ca3', value: "auto" }, t.t('Lcz_AutomaticReleaseIn', { fallback: 'Automatic release in' })), !OUT_OF_SERVICE && (index.h("div", { key: '9565a70b6915bfc07759ff7be690a7ea0fca093d', class: "block-dates__fields" }, index.h("wa-select", { key: 'c66bd7e6f87530ff6527fe6df4c28bd8dd54a563', class: "block-dates__select", size: "s", value: releaseValue, defaultValue: releaseValue, onchange: evt => this.handleReleaseAfterChange(evt) }, index.h("wa-icon", { key: '762c70d064fcdfb1a0aecda5c6134676663100d7', slot: "start", name: "clock", label: t.t('Lcz_AutomaticReleaseIn', { fallback: 'Automatic release in' }) }), releaseHours > 0 && (index.h("span", { key: '5112d37f038b6fac9fde69c09fd23199c36c6d45', slot: "end", class: "block-dates__release-on" }, t.t('Lcz_On', { fallback: 'On' }), " ", this.getReleaseHoursString())), this.releaseList.map(releaseItem => (index.h("wa-option", { value: String(Number(releaseItem.CODE_NAME) || 0) }, utils.getSetupEntryLabel(releaseItem))))), index.h("wa-input", { key: '5c0e85e01bbf57c2b2dbd953c2166081b7c7af0f', class: "block-dates__reason", size: "s", placeholder: t.t('Lcz_OptionalReason', { fallback: 'Optional reason' }), value: OPTIONAL_REASON, oninput: event => this.handleOptionalReason(event) }, index.h("wa-icon", { key: '5edb58058030f89f8aa3209f1ba1faa245395f5f', slot: "start", name: "comment", label: t.t('Lcz_OptionalReason', { fallback: 'Optional reason' }) })))), index.h("wa-radio", { key: '9eb7c8237d62b8aa1a353dec162a45d0e08fc419', value: "oos" }, t.t('Lcz_OutOfservice', { fallback: 'Out of service' }))))));
    }
};
