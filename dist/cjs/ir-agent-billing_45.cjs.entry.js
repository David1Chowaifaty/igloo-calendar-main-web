...
var irCityLedgerTransactionForm_schema = require('./ir-city-ledger-transaction-form.schema-CqYWwrKP.js');
var index$3 = require('./index-BRDqlm7_.js');
...
const IrApplicablePolicies = class {
    ...
    applicablePoliciesService = new ApplicablePoliciesService(new booking_store.BookingService());
    componentWillLoad() {
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'c00a9ae0475971e3962eb35694c58e7533c2e7f2', label: "Edit Arrival Time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-select", { key: 'c7cc87590da254300ac0de5da839dbae60752c61', size: "s", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), index.h("div", { key: '5e4d95c3060ae3f25202c306c1bc6ade54a229bd', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '2559e310d11408ec0b4dcbcc891215ebf0ff0894', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '9f303bced349427d13bb019ae782034cd8b0dc4d', size: "m", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '8b018c3b0ec43ccacc3b94c0d03d79c5ed0772b0', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: '3cd773412197c0eecbd5e88b74a6d11fb7fd63eb', isAllServicesAgentOwned: this.isAllServicesAgentOwned, booking: this.booking, agent: this.agent })));
    }
};
...
const IrBookingAssignItems = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '679a68ec73f149756c5e585a67388e33e53d5f8b', size: "s" }, index.h("div", { key: '9d8a14b499ce959018476d50bf1d1b81c3ffaa71', class: "assign-container" }, index.h("p", { key: '32feb5ab624df18b794b515ee0faa447dc4dbf66', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (index.h("div", { key: '8b8c02d0e673a4ade459f2de81c024a2c66a729f', class: "assign-section" }, index.h("p", { key: 'e02bacabd935179a1bdf5c0ea1dbd6ce6e6ffb7d', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (index.h("div", { key: '8eb2f730360fd8256eb6c0fad8d277cf8f8c2b92', class: "assign-section" }, index.h("p", { key: '1526830410cbc997a13465dc964dc15aa695f24b', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (index.h("div", { key: 'df9a04ebe5d6a96d09199eb9cf8e0ab2ae361e39', class: "assign-section" }, index.h("p", { key: '78387d810926b95eb6d00e059cd1db1fcd13068c', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
};
...
const IrBookingDetailsDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'fe88ffb5baa8dcd13a16e743c9b02cd9cc697f1c', onDrawerHide: this.handleClose, withoutHeader: true, open: this.open, style: {
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'c089df35951cb80757fdd313cff3c9a767dd4a3a', label: "Private Note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '03492085972f70da5be63371f20c621af102e897', size: "s", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '65e7bf46db6348df8329c43c6978ab75d27ef0f5', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'd69adfbd80950cc02bd36ca4f1b3a9a8ecc3f902', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'ee4f3b65e5d01809cccae67e94a917c97b338f4c', size: "m", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ce8c5c0afb61a0df4dfc30186d9c691610ca9900', class: "booking-header" }, index.h("div", { key: '7e1863caef684933627b4d248812af5acf024d41', class: "booking-header__row" }, index.h("div", { key: '0b02f6d14387f7eecce529853c8e3a3c2b9dfb4b', class: "booking-header__info" }, index.h("div", { key: '931644d902281f4036ba1cd76855f6ec2fd5df58', class: "booking-header__title" }, index.h("div", { key: 'ec5ff97b827d81b358e17e8379543eab3ce288f7', class: "booking-header__label-container" }, this.hasMenu && (index.h(index.Fragment, { key: '28b389f4aae38ae2f01ad14b02970df5db0e21e4' }, index.h("wa-tooltip", { key: '0dcae58796eb0c682c405e666a600bb03846e57f', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '135f380ecb069288adde94ce9298de3fe6a08c7d', id: "menu", variant: "neutral", size: "s", appearance: "plain" }, index.h("wa-icon", { key: '6ebfecb55c8bc36bd272b22a48934f82703be361', name: "arrow-left", style: { fontSize: '1.2rem' }, label: "Go back" })))), index.h("wa-avatar", { key: 'bf3f6639437ca17d7d399f8e4fce20ffd283ab45', shape: "circle", class: "booking-header__avatar", initials: this.initials, image: this.avatarImage, loading: "lazy" }), index.h("div", { key: '5a0a4ae05233c856c7cbeb6378d23eb28edd68df', class: "booking-header__identity" }, index.h("div", { key: '53825fa061cb13f2a97636eaec308bae1e6d57bd', class: 'booking-header__label' }, index.h("h4", { key: 'c3e560949de18b26b3694af4bf46c0dc2669f5cf', class: "booking-header__label-number" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`)), index.h("div", { key: 'a94282d9e97a74d0445d68988261fab9fdc0e9ae', class: "booking-header__meta" }, !this.booking.is_direct && index.h("p", { key: '1e07ff2b6f4eb8ec28f87d576a4212185d85fa1f', class: "booking-header__channel-number --primary" }, this.booking.channel_booking_nbr), this.booking.agent_booking_nbr && index.h("p", { key: '384a40a0f626cb8138154f5b88fe159470d14b21', class: "booking-header__channel-number --primary" }, this.booking.agent_booking_nbr), index.h("p", { key: '6eb358b726d044d46dea6093ae1c6e765626c70a', class: "booking-header__channel-number" }, this.booking?.agent ? (index.h("span", null, "Agent:", ' ', index.h("p", { class: 'truncate p-0 m-0', style: { maxWidth: '150px', display: 'inline-flex' } }, this.agent.name, ' ', index.h("i", { style: { paddingLeft: '0.5rem' }, class: 'truncate' }, this.agent.reference)))) : (this.booking.origin.Label)), this.canChangeSource && (index.h("ir-custom-button", { key: '7081bf4e7186b0affe9eea360f7e6b21f923ea3c', link: true, onClickHandler: () => this.bookingSourceEditor.openDialog() }, "Change source")), lastManipulation && (index.h(index.Fragment, { key: 'df4aa987ad1f1cb88c664857e371353d7a78c60b' }, index.h("p", { key: '2e83627f4da3e6c646b14d6a7741158ac4cf67ce', id: `booking-${this.booking.booking_nbr}-modified`, class: "booking-header__modified" }, "Modified"), index.h("wa-tooltip", { key: 'bee6dd2ca4b10813248ad10042d0e41b9095a8a5', for: `booking-${this.booking.booking_nbr}-modified` }, index.h("div", { key: 'ef40ac30edf747f954b1487288c69eacbf643e05' }, index.h("p", { key: 'd41622455103d9aab18d5c4b7d8f3ef2764c9f00', class: "m-0" }, "Modified by ", lastManipulation?.user, " at ", lastManipulation?.date, " ", lastManipulation?.hour, ":", lastManipulation?.minute, "."), index.h("p", { key: '7f374e8ef64409c075ba9726fd2dd58dbb37ef44', class: "m-0" }, this.alertMessage)))))))))), index.h("div", { key: 'be314b346d84a182b6991c551f90b5187683cd9c', class: "booking-header__actions" }, index.h("div", { key: 'a576e95bd046990686af824e53523354d0efd81e' }, this.booking.allowed_actions.length > 0 && this.booking.is_editable ? (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            appearance: 'outlined', size: "s", variant: "brand", class: "booking-header__status-trigger" }, index.h("ir-booking-status-tag", { slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", null, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))) : (index.h("ir-booking-status-tag", { status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }))), functions.isAgentMode(this.agent) && (index.h(index.Fragment, { key: 'e89c73368d59bef5cc6e626075efdcb6c2f3d0ce' })), index.h("ir-custom-button", { key: 'daa8d857a2cccc4cba4e7966839850f53b298e3b', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "s", variant: "brand" }, "Logs"), showPms && (index.h("ir-custom-button", { key: 'e47aabf5e50677f3b916431481be8f52abd3d9b9', class: "booking-header__stretched-btn", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "s", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: '135bc4a4ada2922fc18b59f8c708c253dfed8e16' }, index.h("ir-custom-button", { key: '6b407bb4dac588fd440057d3381fd396342d3ce5', class: "booking-header__stretched-btn", id: "invoice", variant: "brand", size: "s", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '24336e2f8d8b70d0ee6097af4038ac65eed34123' }, index.h("wa-tooltip", { key: '1b14d2d21fcb36578ad04a5cff761329b26aaa06', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: 'd655453f89310b8c05a21f38ecdba022748c32d8', id: "print", variant: "brand", size: "s", appearance: "outlined" }, index.h("wa-icon", { key: '6e0dd0b75fb80481103e4d06316098761c74d1ba', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: 'ed6cb9248d040fc3d38b35ae3001107a1709c914' }, index.h("wa-tooltip", { key: '0f5137a2424f509f80226819f3003f1a6cac9c0a', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '8e47e8a0b6800cb626f484bd0bdc996e630bc545', id: "email", variant: "brand", size: "s", appearance: "outlined" }, index.h("wa-icon", { key: '02e76d6b75930be251eee68f4e95d228c1941f10', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '19caba4627dd6e0431aca95c4f0b10a76c95cfde' }, index.h("wa-tooltip", { key: '817bb72e728443566290ccf9eaf8186170e73da6', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: 'f2c374016f2426257d4ecc1b35a373654d83c6f5', id: "book-delete", variant: "danger", size: "s", appearance: "plain" }, index.h("wa-icon", { key: 'af6b4c30801d6f38dcd591de31de1592c8e1961b', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: 'dcd77c98ec59c564955c2ec5943489685bfcc598', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "s", appearance: "plain" }, index.h("wa-icon", { key: 'a454c282ec04ed692754ec29355c91ec976df35b', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '1fece5291cb65a549ad83e08298ef71b275bdb80', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: 'a8e70d7bb40b6a0b22d803c99c2163f7f16fc86b', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '4e3478d28f41f9bd1412b997f1547c6edc185941' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'bd6be83d4219885e0d9d8b73a874adaaa18d3264', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '8d6de36d51753ee274c9bc4a63075969c0bbcaf6', "data-dialog": "close", size: "m", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: 'b50bd65f0b52e0e79c7e0aa4d7d3b1db70a2c8a3', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
            }, size: "m", variant: "brand", loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status') }, locales_store.locales?.entries?.Lcz_Confirm))), index.h("ir-booking-source-editor-dialog", { key: '9ff7bab6d3a13ce282f41c29d22b95c458f15f0a', booking: this.booking, ref: el => (this.bookingSourceEditor = el) })));
    }
};
...
const IrBookingPricingDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '51dcb713ecc7b02bb14831200b0a169a62cc13c9', open: this.open, label: this.drawerLabel, style: {
            ...
            } }, this.open && (index.h("ir-booking-pricing-form", { key: '2af8b4d3eb9fc3e8a4699f54c82feb280087596d', formId: this.formId, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.folioEntries, currencySymbol: this.currencySymbol, onPricingSaved: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } })), index.h("div", { key: 'a52a77b2817f788fd038138977e173dbb67c2c55', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '1b1e78078da09f63e3641efb118901ff3b7e3dc0', appearance: "filled", size: "m", variant: "neutral", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), index.h("ir-custom-button", { key: '99b562efc874b3b31031579975fb8d43d37c3f3f', form: this.formId, size: "m", type: "submit", variant: "brand", loading: this.saveDisabled, disabled: this.allItemsDisabled }, "Confirm"))));
    }
};
...
const nightAmountSchema = index$2.libExports.z.coerce.number({ invalid_type_error: 'Required' }).min(0, 'Minimum is 0');
...
const IrBookingSourceEditorDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'd3a78e4cca685b2cdb26146d5ff2a4b7d3d92b82', label: "Change Booking Source", onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, open: this.open }, this.open && (index.h("ir-booking-source-editor-form", { key: 'ca7d6ad8062e4850f8e3d988b65354e559f1e136', booking: this.booking, onBookingSourceSaved: () => {
                this.closeDialog();
                setTimeout(() => this.resetBookingEvt.emit(null), 100);
            }, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'bd97d6cf484dd5076473ddcfc3c312212914412e', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '495e48234f16e0bd242605b0ae8f6facc67b5b29', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: 'af8fc469f529fe539360ed558f61d3f055eae0fc', type: "submit", form: `change-source-form-${this.booking?.booking_nbr}`, size: "m", appearance: "accent", variant: "brand", loading: this.isLoading }, "Save"))));
    }
};
...
const IrBookingSourceEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '0543a0934bda1ade342cd612653bc1c80d5c0168', id: `change-source-form-${this.booking?.booking_nbr}`, onSubmit: this.handleSubmit.bind(this) }, this.booking.agent === null && this.booking?.financial?.payments?.filter(p => !p.is_city_ledger)?.length > 0 && (index.h("wa-callout", { key: '8ebd58660b5871c4ea98b6871aa1c9e6b1803f31', size: "s", variant: "warning", style: { marginBottom: '1rem' } }, index.h("wa-icon", { key: 'ed75b939ceefd14778ed712ebde1b57935e915af', slot: "icon", name: "triangle-exclamation" }), "You have guest folio entries that may need to be removed and recreated in the agent folio.")), index.h("wa-select", { key: '8de763836bdbec98e15deaab5195623159a4306f', label: "New source", onchange: this.handleSelectChange.bind(this), size: "s", value: this.selectedSource?.id, defaultValue: this.selectedSource?.id }, calendarData.calendar_data?.property?.allowed_booking_sources?.map(option => option.type === 'LABEL' ? (index.h("small", { key: option.id }, option.description)) : (index.h("wa-option", { key: option.id, value: option.id?.toString() }, option.description)))), isAssign && index.h("ir-booking-assign-items", { key: '30e8629eb3aa743c6720488d7ace4a35e3c792ad', items: this.buildAssignableItems(), onBookingSelectionChange: e => (this.checkedItems = e.detail) })));
    }
    static get watchers() { return {
        "isLoading": [{
...
const IrCheckoutDialog = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, { key: 'fd5eb1ab335624270cfef01bc28c1432d674925a' }, index.h("ir-dialog", { key: '950569d8bd28b06733bab88e3e785488a171dcfb', open: this.open, label: isEarly ? 'Early Check-Out' : 'Check-Out', style: { '--ir-dialog-width': isEarly ? 'min(36rem, calc(100vw - 2rem))' : 'fit-content' }, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.buttons.clear();
            ...
            } }, "Prepare guest invoice after checkout"))))), index.h("div", { key: '853acb2df8ddf5320c59dd414aee8494cfe96140', slot: "footer", class: "ir-dialog__footer" }, index.h(index.Fragment, { key: '0941d5128e3d42eb060271dde9f74ab5e2804b87' }, index.h("ir-custom-button", { key: '46b4bff8051edde15f6f11416fb1f52260f6e2cd', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Cancel'), index.h("ir-custom-button", { key: 'eebd145bf0cef2259634e064e2b028903d2e894b', size: "m", onClickHandler: e => this.checkoutRoom({ e, source: 'checkout' }), variant: 'brand', loading: this.isLoading === 'checkout' }, isEarly ? 'Confirm early check-out' : 'Check out')))), hasDue && this.paymentEntries && (index.h("ir-payment-folio", { key: '6a779901eb4f693627d7543c34a9b9da3e996fc5', ref: el => (this.paymentFolioRef = el), booking: this.booking, bookingNumber: this.booking.booking_nbr, paymentEntries: this.paymentEntries, mode: 'payment-action', payment: this.duePayment }))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IrCityLedgerTransactionDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'e225bd8fc1a9ca65541b7f6df9153eb3c94fdaab', open: this.open, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                this.saveDisabled = e.detail;
            } })), index.h("div", { key: '5b6ba2b6f60dea7d06ea7d2dd5da47e8f82eabd0', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'ea77ec7ea82ff072e145f62e9c62af0e5b8bd09f', appearance: "filled", size: "m", variant: "neutral", class: "city-ledger-transaction-drawer__btn", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), index.h("ir-custom-button", { key: '2b462e83a12178fce2bbbedbf33452755da3ae21', form: this.formId, size: "m", type: "submit", variant: "brand", class: "city-ledger-transaction-drawer__btn", disabled: this.saveDisabled }, "Save"))));
    }
};
...
const IrCityLedgerTransactionForm = class {
    ...
    async fetchPaymentEntries() {
        try {
            ...
            this.paymentTypeGroups = irCityLedgerTransactionForm_schema.buildPaymentTypes(this.paymentEntries);
        }
        catch (error) {
...
const IrClInvoiceDialog = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0540f604781640d30aa2f84b243fd8259a90e6df' }, index.h("ir-dialog", { key: 'c23cda20907ae6fac65b5c9198af8e0af86d4ebd', label: "Create Invoice", ref: el => (this.dialogRef = el) }, this.booking && (index.h("div", { key: 'd3a770385d9d13c9f1ae0476b8002e627e707f2a', slot: "header-actions", class: 'cl-invoice-dialog__header-actions' }, index.h("wa-switch", { key: '627bf734d3fb7f2a8b3249e393bac546cbcc1b21', checked: this.isProforma, disabled: this.mode === 'booking' && !this.allRoomsCheckedOut, onchange: e => (this.isProforma = e.target.checked) }, "Proforma"))), index.h("div", { key: '8c423aa5d0ac0334fe0969fd7deef8a626bbf036', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (!this.allRoomsCheckedOut ? (index.h("wa-callout", { size: "s", variant: "warning" }, index.h("wa-icon", { slot: "icon", name: "triangle-exclamation" }), "Only a proforma invoice can be generated at this time because ", units?.length > 1 ? 'units' : 'unit', " ", index.h("b", null, units?.join(', ')), ".", ' ', units?.length > 1 ? 'are' : 'is', " still in-house.")) : (index.h("p", { class: "create-invoice-dialog__message" }, this.isProforma
            ? `Generate a proforma for Booking #${this.booking?.booking_nbr}?`
            : `Issue a draft invoice for Booking #${this.booking?.booking_nbr} to the agent?`))) : (index.h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (index.h("wa-callout", { key: '376f52200c16366057e614b2396b22a8a857e070', variant: "warning", class: "create-invoice-dialog__no-results" }, index.h("wa-icon", { key: 'f8690dd5f4b71098ccc9fb78a3b9002d525d7066', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && index.h("p", { key: '407c95ba86a369fe21c5ba128e5d2bcb95f3d6e5', class: "create-invoice-dialog__error" }, this.error)), index.h("div", { key: 'bf970cb19dbb34882b4e6d1e9ca942134d309a7a', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '6931ab0db9e9dfde114d1ace780df0699cf3a03d', size: "m", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), index.h("ir-custom-button", { key: '2ef4421986f939902faf93d52027a510ebf99f14', size: "m", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, this.isProforma ? 'Confirm' : 'Show draft')))));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6bf3cd32075e19e47f7f732db76d6b9773a1c0a0' }, index.h("div", { key: 'cb276c9767cd900c354af9c4b2131748c00cf5e4', class: "es-row" }, index.h("div", { key: '5a1505616ada6f03524ebf9ae808410f2d93a82a', class: "es-content" }, index.h("p", { key: '4b114bf2d06b76098107b7b5fc0fdfe3626b5d37', class: "es-description" }, this.description), this.service.start_date ? (index.h("div", { class: "es-date" }, this.service.end_date ? (index.h("ir-date-view", { from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (index.h("span", null, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))), statusTag)) : (statusTag)), index.h("div", { key: '9358e2c8021cc70cb89d5e349f80a51b42a057b2', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (index.h("div", { key: 'bcefdd218246810f65b30c639d9036bfc1243f48', class: "es-pricing" }, index.h("p", { key: '0c9da9fa1a838ea79469d59311fd1fe9a3c0ac6c', class: "es-price" }, utils.formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && index.h("p", { key: '454d951bd4657e9d02697bdec1c3908c81cd793d', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), index.h("wa-dropdown", { key: '3c55f944c556b4326f7fb09430e649a453e83a4e', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("wa-button", { key: 'd6d1aeb755cd75773b513678551215d915dd0ebf', class: "es-action-trigger", slot: "trigger", size: "s", appearance: "plain", id: `actions-room-${this.service.system_id}`, variant: "neutral" }, index.h("wa-icon", { key: 'f0a966707b52781828d1c387e35758cc5820c42d', class: "es-action-trigger-icon", label: "Actions", name: "ellipsis-vertical" })), index.h("wa-dropdown-item", { key: 'fee816ce3f9e2d2a70b2f5e358ff74f4fc790802', value: "edit" }, "Edit"), agentMode && index.h("wa-dropdown-item", { key: 'd2e537b667e1ec6febc9acf817fd39b6d94e55cc', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), index.h("wa-dropdown-item", { key: '3e0daf8d47c24aad3a45501b54453b11f7b9f595', value: "delete", variant: "danger" }, "Delete")))), index.h("ir-assignment-toggle-dialog", { key: '7c4cba16945bf27fed6cfeb752f85e34e961fdf2', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, index.h("span", { key: '0b2d7fe8ba62765e976eda3e3c786d71dcf9d8a2', slot: "message" }, "Re-assign ", this.description, " ", index.h("br", { key: 'a8a483a62212e9c74b250c34f81631e19ed6f14f' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", index.h("b", { key: '6f65c87c8f7b368a5d7dfbc4ba0d188ae1db1f0c' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), index.h("ir-dialog", { key: '0987278c38c67ca23276e0e24c22b8af5e5d571c', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'a2d753191b15be9252943015512a4333d8261789', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c9b8972b4ef5b12baf0d2ed18eee6eb58a297fd1', appearance: "filled", variant: "neutral", size: "m", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'bb7d9ebfaff410b463d13cc8e235a7c8d50b1d48', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "m" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'a5a0c0565ba4f9194363435414ca3707e66dfb22', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: 'a80add7e062ad311e8be8c1f56588e973dab11a5', language: this.language ?? 'en', svcCategories: this.svcCategories, onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, agent: this.agent, service: this.service })), index.h("div", { key: '865db4dee72b64835a3b3fb456b2988a9fc4a213', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '326fbda1ae0f4a7cb2b77d260e2dce4211681200', class: `flex-fill`, size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '82d53297033f789ecda8948c861c7f34c7ebdd86', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "m", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '2618063243a6fa73c153d698c0914a2e9d28a1fd', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (index.h("ir-validator", { key: 'c4c8a89499dbee757d1e4f90763d0e4a38817d93', value: this.s_service?.category, schema: utils.ExtraServiceSchema.shape.category }, index.h("wa-select", { key: '258f9eb959ec17077098f5359e4dbb6b59e070b5', size: "s", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), index.h("ir-validator", { key: 'fa4cb317fbcd86984774a554f37f44f37e288c8c', id: "amenity description-validator", schema: utils.ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '5554c2a0b6d9c67b101dc1dc34d902f4f2042aec', size: "s", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: '445eab3090334f22ebedf74a1169700b3ae8dec4', value: this.s_service?.start_date ?? null, schema: utils.ExtraServiceSchema.shape.start_date }, index.h("ir-date-select", { key: '5057ccff3bc71711bd167a6f4ffaf6e8177ab76e', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-date-select", { key: '61934727df25e5a38d72834d977242a693bdf583', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'c6024d25538f99cb726c245dcadf1ef5f3c91edd', value: this.s_service?.price ?? null, schema: utils.ExtraServiceSchema.shape.price }, index.h("ir-input", { key: '873499302c97d235a93fb51a68c77c0f03545f82', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales_store.locales.entries.Lcz_Price} (including tax)` }, index.h("span", { key: '3d7bf1c23c64af7ef5d8a591ab99be0bd8f95d00', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '635eac3f39756bc53ceab63e51a6b8cdca02b5d1', value: this.s_service?.cost ?? null, schema: utils.ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '230894d29acf9201e8474236fd72b64a6f241cea', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales_store.locales.entries.Lcz_Cost} (optional)` }, index.h("span", { key: '2de1eadfb1609227e9627e674d76d4348da119c0', slot: "start" }, this.booking.currency.symbol))), functions.isAgentMode(this.agent) && (index.h("ir-service-assignee-select", { key: '6d393f8465ab5f7e72dfcd7fe9129f3ad1763aa0', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
        "service": [{
...
const IrGuestBilling = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: "billing__container" }, index.h("section", null, index.h("div", { class: "billing__section-title-row" }, index.h("h4", { class: "billing__section-title" }, "Issued documents"), index.h("ir-custom-button", { variant: "brand", id: this._id, onClickHandler: e => {
            ...
            return (index.h("tr", { class: "ir-table-row", key: row.DOC_NUMBER }, index.h("td", null, row.DOC_DATE ? moment.hooks(row.DOC_DATE, 'YYYY-MM-DD').format('MMM DD, YYYY') : '—'), index.h("td", { class: "billing__doc-number-col" }, index.h("wa-button", { onClick: () => this.printInvoice({ row }), variant: "brand", appearance: "plain", class: "billing__invoice-nbr" }, row.DOC_NUMBER)), index.h("td", null, (row.FD_TYPE_CODE && this.fdTypeLabels[row.FD_TYPE_CODE]) || row.FD_TYPE_CODE || '—'), index.h("td", { class: "billing__price-col" }, index.h("span", { class: "ir-price", style: { fontWeight: '400' } }, this.renderMoney(row.DEBIT))), index.h("td", { class: "billing__price-col" }, index.h("span", { class: "ir-price", style: { fontWeight: '400' } }, this.renderMoney(row.CREDIT))), index.h("td", null, index.h("div", { class: "billing__actions-row" }, index.h("wa-dropdown", { "onwa-hide": e => {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                }, "onwa-select": async (e) => {
                    switch (e.detail.item.value) {
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '73e0ecf81d47b894b6896b5e0cb22f6dbee32490', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: 'd2c88afa05de38d5cac63d864a1d3eed596d9540', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '3242285d33d0b4b00c75681d8244f845c2d6e9ae', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'abc8208bf23a0faea9341643a02c81b9ece92e1d', size: "m", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: 'a1445e5e4d26efcedc22f7afffaa3d528cb2ad3c', type: "submit", form: this._formId, size: "m", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrHbPreferenceDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'b2b0774fc20d86cf9db20ff6e2b9454880f8d9da', open: this.open, label: "Half Board 2nd Meal Preference", ref: el => (this.dialogRef = el), onIrDialogHide: e => {
                e.preventDefault();
            ...
            } }, index.h("wa-radio-group", { key: '34c3e1ef8fe05810c307d7f24a543b83f6095fb1', value: this.selectedValue ?? '', onchange: e => (this.selectedValue = e.target.value) }, index.h("wa-radio", { key: 'a0e72f548f01e6ae963122359a6a02729d52f50b', value: enums.HbPreference.Lunch }, "Lunch"), index.h("wa-radio", { key: 'f4d62edd1b6b590b6f3090572ee5b39988499139', value: enums.HbPreference.Dinner }, "Dinner")), index.h("div", { key: '0ecd4c2805dfad57ce102d6b4187f676f32e128b', slot: "footer", class: 'ir-dialog__footer' }, index.h("ir-custom-button", { key: '450efbfd56716956f237e42c38db651360dce0c7', size: "m", variant: "neutral", appearance: "filled", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'fe354e937841f2d368defe1379de8541db432a2a', size: "m", variant: "brand", loading: this.isLoading, disabled: !this.selectedValue, onClickHandler: e => this.handleConfirm(e), appearance: "accent" }, "Confirm"))));
    }
};
...
const IrPaymentAnalytics = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f099d435192ada4ff1a89ac6984faf1f8c872701' }, index.h("wa-tooltip", { key: '281d69bb2c38fb009f9973db2d98b03800ec1ee4', for: `dp-effect-callout-${this.booking?.booking_nbr}` }, "The dynamic pricing effect is calculated at the time the booking is created and remains fixed thereafter, serving as an indicator of the additional profit generated or of the incentive price reduction."), index.h("wa-callout", { key: 'ffb0a81a9c9c043e718d143510085928c40c185a', id: `dp-effect-callout-${this.booking?.booking_nbr}`, class: `dp-effect-callout --${tone}`, variant: calloutVariant, size: "small" }, index.h("wa-icon", { key: '65bdd564eb42b0b4c685b41352767852d486157a', class: "dp-effect-icon", slot: "icon", name: "wand-magic-sparkles" }), index.h("div", { key: '6baffb4dba961e609e485ad12d10b8674c1826c4', class: "booking-dp-effect" }, index.h("p", { key: 'e20bea12bae51f94646cbbe93a73cba7ffc01529', class: "booking-dp-effect__label" }, "Dynamic pricing ", calendarData.isOptimReadOnly() ? 'lost profit' : 'effect'), index.h("p", { key: '89ad7e72bedfc74c613c43c89fa8d4578f0ffa26', class: `booking-dp-effect__value --${tone}` }, index.h("span", { key: '54555f85b2576e1ee7a0479cc0279119c4eda782' }, utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.displayedValue)), index.h("wa-icon", { key: '853a0a301f98ee717ae4e367077d19c99d35b083', class: "booking-dp-effect__trend-icon", name: trendIcon }))))));
    }
    static get watchers() { return {
        "booking": [{
                "onBookingChange": 0
...
const IrPaymentDetails = class {
    ...
    async handleIssueReceipt(detail) {
        ...
        if (receipt_nbr || credit_receipt_nbr) {
            this.guestDocumentPreview.emit({
                documentNumber: payment_type?.code === enums.PayTypes.Payment ? receipt_nbr : payment_type?.code === enums.PayTypes.CreditReceipt ? credit_receipt_nbr : null,
                fdTypeCode: payment_type?.code === enums.PayTypes.Payment ? enums.FdTypes.Receipt : enums.FdTypes.CreditReceipt,
                bookingNumber: this.booking.booking_nbr,
            });
            return;
        }
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '9aaeac17c85970692656f798d84bca6c5993bb27', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: 'a228a970dc5ec81de7e30bde647f83b8778a816a', booking: this.booking, formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'bf26d7490032a996b6a0886ccca8aaf86afdcb05', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '88287856f6dfd5c2b04a171330e3273c0278cfa1', class: "flex-fill", size: "m", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '58de077c8cbe9db5549e7f03497b05991e505327', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "m", type: "submit", value: "save",
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        const canEditOrDelete = ![enums.PayTypes.Payment, enums.PayTypes.CreditReceipt].includes(this.payment.payment_type?.code);
        const canPrint = [enums.PayTypes.Payment, enums.PayTypes.CreditReceipt].includes(this.payment.payment_type.code);
        return (index.h("div", { key: 'a2276d6ef5192a8452cae7337a0fbd9fa6f71a35', class: "payment-item__payment-item" }, index.h("div", { key: 'fbdcbc2fa119af4595fd45dabd1373970ba8ab07', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '207bcdce8fd10360d03b55f7c79d20261e9ab970', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '574bd7dc2c7176099b62b8805427f9a7f59929ff', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '7a6684705afc629f3b123a9ce629cd46d505726d', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '3fcff488763efbdad4392f0ab69c0b55bd99a8bf', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '423701d52efc968193927cde91378ae148e6e39e', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: 'aeb7216d4a3c4fa9f95c6b731782e29129926d43', class: "payment-item__payment-toolbar" }, index.h("p", { key: 'f93eb944cc946dd7230f7baa7c4e54fcad305db7', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '736da14b9fc0b5cae69590ad63d72a527c60aa3c', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '3ada7f4a8a5861b6378c136cb9ab251c8f245d53', class: "payment-item__payment-actions" }, index.h("div", { key: '2483bd63671696a962a06696e30327ebb161b5fc', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '6aacfb63731d1667fc666b1bde6a2155ed335a54', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: 'ba36a56ffd4054f089c26a6281cb4dfece13b946', name: "user", id: this._id }), index.h("wa-dropdown", { key: '1bef89e6ea7d92b0f89bb35e85ade4eaf670740c', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("wa-button", { key: '9c61a7ac2d1da55a0cf781528cab517fb871c3b2', size: "s", class: "payment-item__action-trigger", slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: '999a08e3db1f1b26874626919036e5efe882ad10', name: "ellipsis-vertical", class: "payment-item__action-trigger-icon" })), canEditOrDelete && (index.h("wa-dropdown-item", { key: '341cee76f0a2cd2392dc0c1f90140a3b57c91ff6', value: "edit" }, "Edit")), canPrint && (index.h("wa-dropdown-item", { key: '3a4742deffbadde27f2d26b09a690d96e7b8d6ea', value: "receipt" }, "Print Receipt")), canEditOrDelete && index.h("wa-divider", { key: 'a980dc53da460430efa470e19eb4452a25f547ff' }), this.payment?.payment_type?.code === '001' && this.payment.payment_status?.code === enums.PayStatus.Normal && (index.h("wa-dropdown-item", { key: 'fa296bfe36e7909ad44c2c93a86975bcdf792a83', variant: "danger", value: "void-receipt" }, "Void with credit receipt")), canEditOrDelete && (index.h("wa-dropdown-item", { key: 'a045d48780ec7d6ee19d51a7320890d5d65c9a4e', value: "delete", variant: "danger" }, "Delete")))))), this.payment.reference && index.h("p", { key: '2a1f259b390a7e364f045e01f80928444f881821', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '52cbd53ae76f9d6386b5cdc60f4b6acde3463279', class: " payments-container" }, index.h("div", { key: 'd4efbe3d47c411aba6334a0700d71558d8934c56', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '8a90a3ae13f04f47a34729d76ae2135b00bd2a03', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '2ea26dc859ff1b314b618633fe9747b1837f8163', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), !this.isAddPaymentDisabled && index.h("wa-tooltip", { key: 'fa4b6fa696cd5be9e6b1216da9b52114bc4ea2d4', for: "create-payment" }, "Add folio entry"), index.h("ir-custom-button", { key: '53fe784621966a0e6c5b6dbc4e913414ca63cd4a', disabled: this.isAddPaymentDisabled, slot: "header-actions", id: "create-payment", size: "s", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '69cf7fbc966bdf38e6f102b0d137e03ccb4fb717', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '4aed465b20461eb8197eb455d94c34e00e0cc33e', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: 'b532b7d001fb3407524f3f4e4e025881e35f43d9', booking: this.booking, agent: this.agent, onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: 'ade298d708d1563c710ec3aa23c48b90f5890226', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '439ba8a75a664129c8574c3310dcd309e95ae8f1', class: `flex-fill`, size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '65fef1cddd7cb8bd65c1032b05322105a7f3ed61', type: "submit", loading: this.isLoading, form: this._id, size: "m", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: 'b3c27ea296506b94491b36da6eb6544ca9f1f0c2', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: 'f5f29b13b847f60a8d02c6a863a66c7b5e787a92', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'd223e5dde37d610cb7ad23788940abc8a993121e', size: "s", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '9e416aae031840ade4fc8457fa19f85391cc068f', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: 'b937ee6a4ff602848fc04ce779564f183e2a5206', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: 'b3d91794398fa41b1014ee01ba581123eb172f2e', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-date-select", { key: '8fac25dde777b41645d0a948924eebdcbf694ad7', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '94d29e3612c1a5ba933bd4ffa17049856969dfff', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '9c2a0587edc816e76ad5b7ada3520285e8d57f3e', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '63e631ecfe3ca97b68692aa03ffc01b218c19be8', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: 'e4476b98121f0e071d0ce6ce33d4a393a037a9a5', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'd9b3b0c0bd674e0a7048f74577a44c5a085e722d', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'b07d834631a8a253f9fd7ca22705c3ac42c8f1d4', size: "s", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'c91497948db7e312b7e82f692305adbd6ce6ee4c', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'bf7f51abf4c6bc9067996f04df36c7c8df8234ce', size: "s", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: '7b3d1e9028b10b05cd21ec47b3481c8bf4d4dabb', mask: 'price', label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, index.h("span", { key: 'f531aaf1b4f3068e3cb13fdec2bfa4daa1c8c45d', slot: "start" }, this.pickupData.currency?.symbol)), functions.isAgentMode(this.agent) && (index.h("ir-service-assignee-select", { key: '910f752e55d6704e5b500eff90447aaef0a88e0a', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'c139ff2e82163fa7a390c778af93965b3f575137' }, index.h("div", { key: '061df15a9197e0ac8f3b5804f1b335899cdcf075', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '9685d62093f8a012994648d91ee48d3a62167344', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '0c36d3654f1556c61ec2ca61c7212fccb3485b52', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '991bf9695de8c63d6fda47fe884315686604c4e5', class: "reservation-information__row" }, index.h("ir-label", { key: 'e5a5d554c5cbfd7c3d32035e650523022299a12a', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: '53bb742f86de8849733c5873f6ceaeb18ae0cb31', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '0ca645af19d4e39883c1c764421e74ccf954acf9', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: 'ce27384979e11e05ab7839269e6501c40d803200', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '117dde016db38c238eaf7f1be0dadb7bd79e0fcd' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '7724e412b98b8ba8e9e6de17cb7190a90ae9b5f3', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '144c06ff80c6d523ad882407e739378f68d5cb12', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '332107d52ed58985d45fce52e6efaa3a54b7a1f8', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '50a8360834dab7bd9732ec77f9b95d83c28ca6c8', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), !this.booking.agent && (index.h("div", { key: 'c7a4728241a36bf46b461ec7cd2d87cd52f98fd4', class: "reservation-information__row" }, index.h("ir-label", { key: 'd493ba190b3c8b7a310fc13f1245032307d46860', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '273e11a6e6e82ae01ea7dfb0b440174986e5b8b9', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: 'a0e60717d10a27ebdff8ccc1d90d7c48bcd5eb27', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '32feabcb0b66b985fdcfac56f90db5cea96d723b', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } })))), this.booking.guest.mobile && index.h("ir-label", { key: '1272a35fa4c49e6cfea5921e3f18862758137855', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '316f01448fbadae0f43052812254c857338e9563', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'fa639cd28b056457e9253df1355aaeb0cb4a390b', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: 'dfa316c073056760910fd61e92e2407a2a88aa84', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'e2bc45e9e1659d34f679c489787e0ce45f0802e1', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '03bfb1fa749a6ca4afb0a1b85ff3d47b0dc9483e', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && (index.h("div", { key: '5b5cf7aee5bd20c250dbd5bbe56ea0c47e5b3d68', class: "reservation-information__row" }, index.h("ir-label", { key: '1be3031c08a8decc139ff2ad03257e1ace19cfa5', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, display: "flex", content: this.booking.arrival.description }), index.h("wa-tooltip", { key: '9063741484dccceffb9393be360848fcce3092a3', for: `edit_arrival_time` }, "Edit arrival time"), index.h("ir-custom-button", { key: 'f6b8dc950e699298cf4598d6a8cbf1dbb43900b6', iconBtn: true, id: `edit_arrival_time`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irArrivalTimeDialogRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '36fd479609c4dd8dadfa4a2ba63efe794bf63b11', name: "edit", label: "Edit arrival time", style: { fontSize: '1rem' } })))), this.booking.promo_key && index.h("ir-label", { key: '626e8502abf9b9ff31cf4beee0251055710c9b3d', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '3560535bec9c9e5d3f2cb7b86954ecc8b19ca8f3', class: "d-flex align-items-center" }, index.h("svg", { key: 'b63f801a75f9ce91f5f9279cbdcd031b16d168b0', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'a89bc662079882a2e25912273bd0dc02b5f7105f', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'c7ffb71667f4e33c461c8f3048a193a3d48caf94', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0 reservation-information__channel-notes', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '87acd8ff0e0525955bc20dc655cd48665f696c61', class: "reservation-information__row" }, index.h("ir-label", { key: '26dbc7c90314a39e0c037c78ac5d85f3b76bb226', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: '07724d1ebf4b3a85f7f10aecdef78bbac347a3ac', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '8c4bfc174a9635b07120c9470e745b1f6a37087a', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '8329488fadb19bf4a068213f2c76c82cf3a56554', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: 'd0f2d144d8acceb2def44d32dc2d7b2fa501a3bc', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: 'd5fdf8fee017e66995e38a744e26bc83b26df09c', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) })), index.h("ir-arrival-time-dialog", { key: 'c78dd72184ec4c836d0c068ba20db861208eadd2', booking: this.booking, arrivalTime: this.arrivalTime, ref: el => (this.irArrivalTimeDialogRef = el) })));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '735f63f8280cef02ea6b8bd6430498dbe7897b9e' }, index.h("div", { key: '3d54b84489ca9ea5703112c27bc656703d1a60b6', class: "booking-room__header-row" }, index.h("button", { key: '9f4398b7b9e5a47f3a6b69b76a671a3255722817', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'f5701929684831ccb750c91c02fd62f86c2172a0', name: "chevron-right" })), index.h("div", { key: 'ce8e1f0ce0af63d47238c7e53bd4c78973b6d805', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '2c9bac2b48808fab53cf198c7e9fae2ff30c59f2',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '8038f28e8a64ea4cfa850476eb4e82b3722ffbb5', class: "booking-room__summary-row" }, index.h("p", { key: '00b487e35e9d34a1f954d4d7d341fc7cdc7d6bc9', class: "booking-room__summary-text" }, index.h("span", { key: '1d26b91ba1cf1a7175f5a8cab8c20887739a520d', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' ', this.isHalfBoard && (index.h("wa-button", { key: '9f1baaa8e0034f066b3ebb181847b099a27ca85d', size: "xs", class: "booking-room__meal-report-button", appearance: "filled", variant: this.room?.hb_preference ? 'brand' : 'warning', onClick: () => (this.isHbDialogOpen = true) }, this.room?.hb_preference === enums.HbPreference.Lunch ? 'With lunch' : this.room?.hb_preference === enums.HbPreference.Dinner ? 'With dinner' : 'Choose lunch or dinner'))), index.h("div", { key: '00cf2e8d0bc58e006ef7e2b4c9df62799bc700e1', class: "booking-room__price-row" }, index.h("span", { key: 'd18fc7f145834dcfbc53e192b787f56dde5e8952', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (index.h("div", { key: '3ebe0e5bbfca80ffac202a9712bf7b22a2fa6980', class: "booking-room__actions" }, index.h("wa-dropdown", { key: '2183d59450711917dffd454ff625597689a0b0e3', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: 'c97c8719cb8ed0f4994e01b8636fa65e9c85558b', slot: "trigger", size: "s", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, index.h("wa-icon", { key: '61d73f40c8e90c06b3ae522c2aea600f9efb68a8', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && index.h("wa-dropdown-item", { key: '71341b558ca60932aee15560478878d54dd9ece9', value: "edit" }, "Edit unit"), this.hasRoomEdit && index.h("wa-dropdown-item", { key: '4f653b6e81d2cce5a53ebdbe175569e8fcd2b97f', value: "edit-rates" }, "Edit nightly rates"), functions.isAgentMode(this.agent) && this.hasRoomEdit && index.h("wa-dropdown-item", { key: 'f58ce0664f4c650a10a2566616155aebcdca6767', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (index.h("wa-dropdown-item", { key: '83a3382ea755f3f5cc84c602337d65d7f42c8fee', value: "delete", variant: "danger" }, "Delete"))))))), index.h("div", { key: '1fcbf122840690ffd2e6483fe31db3eb07fdec6f', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: '134ca4567a8a2d4c9798b31ad01bf8ab7e1c8263', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: 'bd3d73e524665d44bb5fc4bef907cfab10e0b69b', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '8b8b876a0187c213902e6d3ac0d179583ba94063', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '2dc3087f6cc57f774e7933c0fbd8033d6988eed8', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: 'c7014976db6155cf1b7433d9ad388745ad5a3bea', class: "booking-room__guest-row" }, index.h("p", { key: 'd31b6edc8b74fcb9a6ecd58c5835e85969af3bda', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '01c33b662bfbcf77eb7736a17a1e29f1ae62786b', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: 'f46c3e49001e8137419d87b2fa444ebe0d22da0f', class: "booking-room__departure-row" }, index.h("p", { key: '8c09fc9d8ce12da2c2eb9f5cd7cccf1447269b26', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: 'af542aabc5d21450b56c48be564a219e31857a2e', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "s", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: 'f2a198ac342ccbb4d7a075b2122fe03c4da92e12', class: "booking-room__details-container" }, index.h("div", { key: '507d327946efce624e6e967140654ff7bc83c5f9', class: "booking-room__breakdown-row" }, index.h("div", { key: 'bd67e3030dfd1afe3c46f278fc8faadb6dfb7ee5', class: "booking-room__breakdown-table" }, index.h("table", { key: '41a0da58f5e25e94ed42e7d796a2a53fb7a3754c' }, this.room.days.length > 0 &&
            (() => {
                const acmTxByDate = this.acmTxByDate;
            ...
            })(), index.h("tr", { key: '3c19f6f40dc5c96f5c24381c1c944bed8307ba38', class: '' }, index.h("th", { key: 'f374847134e7bb45467a822ffe4034a101967d79', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '7eceebd310be3e4c0e5c16d1cfd556be5e33f5ca', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '949d6fe862b510041838fc7b45046754db4ba040', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: 'a218664c688df769a5868ac11a4b1773efde2bd5', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '350ce337b579f96ffc80b9cc91f14a87a76d596f' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '50900ebc0215df435dd0d58e52e2932a920cd5a6', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'd2fd769a669f2b7b238b1420d8023e7428340450', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '9609407307191b2749c06e3ee3ea360e6504a37b' }, index.h("ir-label", { key: 'abc118b1484d221be02ca9bb56b12a249ea0844a', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '2575e0fdc8f1bc2ebb29b2a8c4d8a886b35ea688', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-assignment-toggle-dialog", { key: 'e117d5d83a808ba021dc94c446e322009e7cb131', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, index.h("span", { key: '5b6e0e4dd99fff204064347748a84bfe2b2b7722', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', index.h("b", { key: '96091a05bfd4129a16bfbfe80f378d44b9a5b96f' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), index.h("ir-dialog", { key: 'ffb47c2b1856d85c1328e9b2a35bbe47dbd807a9', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '5b9073dd164d0b8400780cb97e5dc94cd768e39f' }, this.renderModalMessage()), index.h("div", { key: '1942dcc606fde89456b4dbe2ca3bef776e84ba9e', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '441c2e79f37b6fcf7b61b85d9cb185869ad4df2d', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '5766ee550b7052db0287ff4c352e26657eac582e', size: "m", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '04a29a0958b4ff8397850b3f9054b7d1384892ab', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: 'b96a0761fd32be4cc15bcb3f42f9f75f44a0fc43', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, open: this.isOpen, booking: this.booking, roomIdentifier: this.room.identifier }), index.h("ir-booking-pricing-drawer", { key: 'c0aa2a91f86735598798dfeeabd999c039e7be72', open: this.isPricingDrawerOpen, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.clTransactions, currencySymbol: this.booking?.currency?.symbol ?? '', onCloseDrawer: () => (this.isPricingDrawerOpen = false), onPricingSaved: () => {
                this.isPricingDrawerOpen = false;
                this.resetBookingEvt.emit(null);
            } }), index.h("ir-hb-preference-dialog", { key: 'bf9386eb8f8727483129ca083e358c10008ec0f5', room: this.room, open: this.isHbDialogOpen, onHbPreferenceClose: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: 'ae91616f13af5604fedf03003e39d9caf1d448d1', style: {
            ...
            } })), index.h("div", { key: '4e67388a29d2b682c3b32879f771a18888939feb', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'feff972678302d8eb75ac32c7648a5ed3ed281b5', size: "m", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: '94e66fbbe9a09d0bc52c8149fcc4a86e47a6b279', value: "save", loading: this.isLoading === 'save', size: "m", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: '5a3a49dffb5d4f4b1e1ad3278e94497b5386ec13', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "m", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
