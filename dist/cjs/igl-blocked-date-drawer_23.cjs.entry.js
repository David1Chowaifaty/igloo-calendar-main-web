...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'b1db45f031ccd045404ca53872f6ca6e61a98c4b', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: 'e29688cba62f0e5d0877d4d608ad68e0dc304b48', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: '295c1891fdd2e1692431f88ba377d635205ac221', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '98ea1efd7dd81cc868e4c9a726dd1ec77bd6c622', "data-drawer": "close", size: "medium", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '5e69fc04291a9d5cbb45d278712821861db7f5ec', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '315e37d996cd1487941db006490f707f090938b2', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '1fad11cff5cc4f322f1cb9107f47cbcfd60b54f7', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: 'd1768155a6e25ddd351eabd4c25aaed46f86aac8', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '9298e2faf5132964a5b5ab382727c5c5b93d01e0', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '4301bda073eff1c9fdbd0328bb8096bdd3d2c88a', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: 'b665c4d17fd314aefe4f81d1638a1fc98114c8c7', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '9fc13c94230b81f17becd66647f75e13b8d34120', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '86098e83017a58794529b7c7e17a15fd997051d2' }, index.h("div", { key: 'b5923094083e8225c21c45b7d66f9840c1eb0b98', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'f89a80c5b60da889019172177420b7f8ed6b5c97', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b844c0bec4cead452f0c594e75b92ecc4130732d' }, index.h("ir-drawer", { key: 'd75ad42b075dce222eba93f94df3e7d91f3111fb', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: '915993cf7a24bef8dc556b4d990f492827204b34', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: 'bafde1157d539584a6e6a58514e3701534f245d8', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: 'ef36a888cd1d7500141aa2a94ee050fe920dd3ab', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '91658bb6498f79e2ebd95fb2f292f2f852259084', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: '0d965e6c0e2b0943d65f7c6b6a212456b9e1a00d', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: 'd49ace7d193e60149c8f5848c3c9c0f43f700780', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: '132a96437cdba5899448a83e8fd9de14e9687bae', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: 'bca1e03f8cd633828eaed3450565680e95fee0f6', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'bcba4b2cdf1ac9148dc7ee61af705a5b1017d279', size: "medium", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '0d4efb278079ef3d5a4473a57211f4a84c722b6d', loading: this.isLoading, type: "submit", form: formId, size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    getUnitsByRoomtype(roomType) {
        console.log(calendarData.calendar_data.unitIssues);
        const hasRoomWithTodayCheckin = this.categoryHasRoomWithTodayCheckin(roomType);
        ...
        return this.getRoomtypeUnits(roomType)?.map(room => {
            ...
            return (index.h("div", { class: "roomRow", "data-room-has-today-checkin": String(roomHasTodayCheckin) }, index.h("div", { class: `cellData room text-left align-items-center roomHeaderCell  roomTitle ${this.getTotalPhysicalRooms(roomType) <= 1 ? 'pl10' : ''} ${'room_' + roomId}`, "data-room-name": name, "data-hk-enabled": String(calendarData.calendar_data.housekeeping_enabled), "data-room": roomId, "data-room-has-today-checkin": String(roomHasTodayCheckin), "data-category-has-today-checkin": String(hasRoomWithTodayCheckin), onClick: () => {
                    ...
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    this.issue = calendarData.calendar_data.unitIssues.get(Number(room.id));
    ...
    render() {
        return (index.h(index.Host, { key: '335e06208dfab0da709bb540dfff62951e02857e' }, index.h("div", { key: 'd777633cea8ddcd13c93bab1e9d4e7147c5fca74', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'fc8a6f857cebd018b598aae078693d7f0a299d17', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: 'f664a6a32b0749d4d11d3bfbf5dc44e274dedaae', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: '2a68d724d349e98e8dafff098048785f679c1c94', open: this.issue !== null, issue: this.issue, propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issue = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f0d1a2e2acc005830704e832fd6177de641d0a39', class: "footerContainer" }, index.h("div", { key: '97d74cbbfc8e0c8aed67bdf1a2cc0cbab67f4197', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '09bcdd7043ea164eca1e0416a10c055107111b47', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '6a18b68f96c3adeb2a864afa4ec2df2118b1230b' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: 'ad3b23913e77d2cf71e8c7a1f17e8c1f6e44f489' }, "v1.4"), index.h("ir-new-badge", { key: 'f783fb2c74a75c4ab826192aeeb4331b1c8f2d4c', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a6457b1a005f204dfbee2587534c6568d2094fdd' }, index.h("div", { key: 'ec5a6551eb9b7e3fc58eec487763e91d02010ffa', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '80aba0663d5d94c213e0dfb7b8161374f4679dc6', class: "header__fd-actions" }, index.h("div", { key: 'db58932348939170c31fe83a4d3fadb52c304046', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: '4bf9074418391ec0d955a7e243c5f436cb936bfd' }, index.h("wa-tooltip", { key: '7978490f57cb87d23ae729561931a54d5f7a00bf', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '33b870c5220c3cc316870b2716d0f1d7361bf92d', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '25a49859c3f9c71effc1c499dc1d3fa7338460f8', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: '509c244eb2feb14a128e70283c5548f6fcb05f61', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '1b3b414ad9cfd25ab7f3f52e35a278f0b527ead8', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: 'fdb2f80a7679431366dad2bde9d11f5148eb47a9', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '79c3555a0b7f28939e76fe83042cd3ce221a0f07', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '48cfb9abcb2e4c3c6725edc7faddd1dc8e87daf7', class: "fd-dates__actions" }, index.h("wa-divider", { key: 'a6ad2bd0216e92d63d039b8468a9638d85fed3eb' }), index.h("ir-custom-button", { key: '7a21c5a12c6ebbc7c3be9b19ff06f295170e7a30', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.closeDatePicker();
            } }, "Today"))), index.h(index.Fragment, { key: '6268c9e75ad745f807e01a2b7736b4da24aeabc9' }, index.h("wa-tooltip", { key: '15618003360cb2c8053bbbfba1ea9aad0e3ee53d', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: '6752b91579a4cc8b85f149061c6f9a0d3ce6193f', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: '77de7e559570c5ecddc65b9c5e14a2d9a4580d8e', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '1c66d70cbfad3bed2adeeab3a72af064c4e5e558' }, index.h("wa-tooltip", { key: 'c7b7722fbb3780818d85900cf3a00b174f0ea406', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: 'd7cea71667cffb0c7583e6195f0d52482592f433', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'df962b034ff40a4d84bda9c09b78fd96cd324012', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: '7ca5ebd0fd28efdc43692ff88ab303b0f5c6a966', class: "searchContiner" }, index.h("ir-picker", { key: 'c372e9b49c80fb6138190aed75a1f5cdacc833d6', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: '1b2c6d8ad6a3cf172465d87155cc3825745f9c1c', class: "stickyCell headersContainer" }, index.h("div", { key: 'f04494fa88382fe1d41dcdff269052dda78be801', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    renderContent() {
        if (!this.issue || !this.open)
            return null;
        return (index.h("div", { class: "detail-body" }, index.h("div", { class: "meta-row" }, index.h("span", { class: "meta-item" }, index.h("wa-icon", { name: "door-open" }), index.h("span", { class: "meta-value" }, this.issue.unit.name)), index.h("span", { class: "meta-divider" }), index.h("span", { class: "meta-item" }, index.h("wa-icon", { name: "user" }), index.h("span", { class: "meta-value" }, this.issue.housekeeper_name)), index.h("span", { class: "meta-divider" }), index.h("span", { class: "meta-item" }, index.h("wa-icon", { name: "calendar-days" }), index.h("span", { class: "meta-value" }, moment.hooks(this.issue.date).format('MMM D, YYYY')))), index.h("wa-callout", { variant: "warning", size: "small" }, index.h("strong", null, "Reported Issue"), index.h("p", { class: "description-text" }, this.issue.description || 'No description provided.')), this.error && (index.h("div", { class: "error-banner", role: "alert" }, index.h("wa-icon", { name: "circle-exclamation" }), this.error))));
    }
    render() {
        return (index.h("ir-dialog", { key: '84cad1ba34cc6a918fd51bcedfcbca772721e9f4', ref: el => (this.dialogRef = el), label: `Issue #${this.issue?.id}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '8dc5c714519e3257af5dc114962b9daf01f78aa1', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: '01313028be4070155cfde7ef2a8d48fe0e51abd7', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: 'f350253218172eee7ce9268857602c3de25b8c8d', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: this.isResolving || !this.issue, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '18777855b0dee29757f43563445ade84f80154aa', class: "legendContainer text-left" }, index.h("div", { key: 'f63778555cc79a984a1f3f74a959ca7157b8fe9a', class: "fd-legend__header" }, index.h("h2", { key: '2dc342928cfcab069165b12a056d8d3b5b39e55e', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '5eece4676ec64da659cb1e404c840b13093b7aa1', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '1e81cd86ebe5e079458348fb473d0c3636cab110', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '667b3e89d58f2677fc6d8943e7ab026c863ad220', class: "fd-legend__body" }, index.h("div", { key: '3ef7c6fe69ed1e96d869cf6313c7472e8071523d' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '66d51a180b77056a4b6709482d4270511d8ad460', class: "fd-legend__row" }, index.h("div", { key: '3d092a70af2fdeffad76c885f7c2a837d754cfb5', class: 'fd-legend__shape' }, index.h("wa-icon", { key: 'd068ccfdc9b7b3a9e6c12d584e95ba9adac65089', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: 'a963b08f0dc32f5c47e38a3cbf38d5900106adf2', class: "fd-legend__row-title" }, "Issue with unit")), index.h("wa-divider", { key: 'fc9f97fff4d5cba9121ae34190e1c4daf7b207b5' }), index.h("h5", { key: '3dbce22d43edb88ad3cf5ba27fee151ff94cfc5f', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: '1052c29f0f22763833faba17bdeb29324a501975' }), index.h("div", { key: '8a910fa5e7694e288f0c9febe561e8fcfdb37b46' }, index.h("div", { key: '9664f0379a6f3854194bb9949e562f800be11632', class: "legendCalendar" }, index.h("div", { key: '1c5fddc72a469ae10b48e099fa1e6a88a0e71867', class: "legendRow align-items-center" }, index.h("div", { key: '823793e8e2368280cdf163494bd363244ddb9451', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'cf38bde9cb2bc9e63289e68224a212d7f6dc1828' }, "MAR 2022")), index.h("div", { key: 'e71afa812b2be301dbb3a3a6b32856d2a0490dce', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'e94de8fab430dfeb20b09fb8ecf72a6476d2a0d8', class: "legendRow" }, index.h("div", { key: 'bfa3ff2495c28558dc9753b687496a128d3b498c', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '8c51014086111de09b3b5ca46b23cebbf1a68135', pill: true }, "3")), index.h("div", { key: '35475ccfde17fb6aff1760f54faf067bdffcb712', class: "hyphenLegend" }, index.h("div", { key: '21c24fdc371a361335809330afcce7b47677f4e0' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'daa8b70832e0388940224bf298516cc70a2e89c1', class: "legendRow" }, index.h("div", { key: 'd52034c1b66579daf5ffea2e9ed1ea1e77a8443c', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'd6b9e7ae6837505e79ff2ee67dc7c52b865a3c84', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'c3f0523f819154d26d9f1bc92b127a1019f42cb1', class: "legendRow" }, index.h("div", { key: '3db5801a53b40316876da2fa182031c0f32ce243', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '3406884d3f7896adc582b80c99019370b7d533e8', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '9b7ed4d8834ed60d4abc6bdd059241eb9a980c39', class: "legendRow" }, index.h("div", { key: '63ebed30e28007f7055503a0eb754acc995728a9', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'f4eef0468d6920ae411446494e25b41aa72634df', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'f331a2b37546da3e3453f454d05a3c345cb98a0e', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: 'ba99fb2825daf0b2cbe7f50c50aa45e69f5edd5b' }, index.h("div", { key: '05385f6fa7f4e9280412f380972e5dc010ed70cc', class: "dialog-body" }, index.h("p", { key: '013cec40bef46199413571095eb1b3cefea8663f', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '09484fb8bed43ae0176807c10218f74e8167a207', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '5b5ee7345bd28579f23f69143ddd31f143a54cf4', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '025d0d9848c064d681d179882f53a34f8fb1c1b2', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '4d075be96883a39b873f764d7597b903fc097240', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: 'aee76de42d5f2f4c425760daadce68ebe87c50a5', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: 'e8bc748e6e6fe6db24dafb4e349ad7149085fc45', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '19daf0fa284bb803b6efb7a7cae657b2f9aa68a3', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '535f508cd173a29a82a611657ef6e9ae492fa2c2', class: "px-1 sheet-body" }, index.h("div", { key: '7d006a6bfd8a298ed44c8e37ee45aff3dd2e5675', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'b3f4aabf54f906634333fc56f2c1558051ff642d' }, index.h("ir-date-view", { key: '133a31ec1f1e61dc59d44e02c80728751985dafb', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '157a6c73a1497d20269a9eb4cdb914ac94907df8', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '7a256e79d649411258c76da7de5f3162ff458d61', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: '39f0848d4a92739d140a7874db0b8ed1607748be' }, "From:"), index.h("ir-date-picker", { key: '661575cfdf35671ca97b102e1115415baee724c3', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '1d66384a7e9fd9e81434b1a18e292bf462774dfa', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '83cf4985542697c3106908a8e6ea49da57d705dc', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '52ce96302ace685ca0f652ed7597aefc3c24405e', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: 'db1316f39e998d8d347670b2d2149a59b1c98b78', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '4ec205c85cae95d1fefe6c4db97bd1f3945298fb', class: 'sheet-footer' }, index.h("ir-button", { key: '9c3fa843ed8003ad72d9d16cab71c02330a3bada', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '22c94820fbdcf38b8b382ceb3196a5b580b845e3', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8b5dfc3c50e0f9803a33b700a34387f5515917c0' }, index.h("div", { key: '659c75b9040cfa42917dc4481ff55f32fa8bd12a', class: "sectionContainer" }, index.h("div", { key: 'dae1176ce4cf7541bf044ce60d506e65773a64ba', class: "font-weight-bold font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '034b37cdc6af708b02be5968d9a2fc3362c21145', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '4c4f07dc843fac60ea6d1a6c350d04977c5384ba', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: 'afd6f40694c0668b4a56ca8a2e9b659911a58db1', for: this.titleId, placement: "top" }, title)), index.h("span", { key: 'f0c62eb9c11e7fe2a4d717ff3cbcb0a182a96841', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: '8642ad96ae126881ca4ccf0f1ceee7633faacc32', class: "hk-dot" }, index.h("slot", { key: '3e57239b84f647cc8b42a1d8d25178ec00106233', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '8a036ed744b2f5e5581262cd0efdc4ec3ffdc7fa', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '3e02b99916436cd65bbfd4f22bbcce94e7621cb1', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '36417e5ade21aa44e1917eab7ff0634e795fabc5', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '0a62f21c0566b56dd530c5532591b181f6dac731', class: `ir-alert-header` }, index.h("p", { key: 'f192ef4c99e069506fa44638dd60baad728a4f49' }, this.modalTitle))), index.h("div", { key: '17aa0a1663288bc7d2dc9f7bb9803be47de452fb', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'd54b6f5a36ee8ec3a5c528587001ed96a4896e44' }, this.modalBody)), index.h("div", { key: '6d6fc23ab49cdbe0f770268819b4800d0674b1f5', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: 'd325dcf5b8b5873ff5d7ca844ddd2970b67a44d3', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '52d03ca38883bf1b3b25cd570b239fd8ece48a03', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '2f7e8f214eb5db11fbb8cc9fa12f0955c17b829b', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'aa4998260cac431f105aa8378f7184c5e7a3d93b' }, index.h("span", { key: '36bef889eecf451dded33ae41cb99ab327a29199', class: "new-badge" }, "new")));
    }
};
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: 'e81dc0c4fad5d9709eb8267e1c985166589ad730', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '03edd03473cfed57fe27ab021417b9c97b1d7b68', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: 'add4d3a4b4bc562ebdddc28d10f5bed7311c0478', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '0d688b7598e003b2a7f0e74da936789a2200dd68', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'bade88e2638bca54a320863437168347b258e6ba', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'b82212492fab210224c5c531f3bf43559b5a4379' }, index.h("span", { key: 'f0649a70806eacdc160e9f03b08028574d7f44af', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'faafef2d6d34dce75f0e13bb0b2683be54f2b474', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '102d177a92f766a713bdd169c7a75396eb9e14af', class: "input-group" }, index.h("label", { key: '12ae77feba683c23dfd2d4d1c78573d776d93b3d', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '8265521163ae06d74d8052dcce761dd3be64d81f' }, this.label), index.h("input", { key: '564d43984ce4ef6d68f367a41a1219d72673daa6', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '8d9c5a2c7a942c4122e3c0e7e75ceb80afa2aa6f', class: "checkmark" }))));
    }
    static get watchers() { return {
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '1370b9e0051c3082394a733eec4e24560d9a730f', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '681634673b382d4dc98d22d30f587e67b1cdace8', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: 'c1b4b4d70c4f22eb43d68358d304083903221fff', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '0cb7f23b2b18ec5e70b5d1d6224e4835bc102847', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '28741ba120d6e0b980ac7adbbb1f0bf6d8abcb5c', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bc45b32d56accf0c757c76b064b1672678ca8e81' }, index.h("form", { key: '1df5998b1530a3a3a6080f07d7e651eaa7cd525e', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '969625e54c2d05e38e3edec5babcee1e71fbb4eb', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '8f736fa1cd477d21ef2e6f3fadab2f8886992f17', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'd3b8c7b1d4f119c67d2b7ee069243a8b0b7939e8', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: 'dff1995b0fd3f1a0eaee1fbf704d3cf629ac5743', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '339b5c40a28e6598047276628f9ff055dd31b800', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '1acee8fa90a6cac3d1e1666950fc7fbaa1a64e4b', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: 'd1e152fc8264ceea0bebd6cd09186457ffd1ea1f', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '8ebbcc2315756e2a3e5bcf45ad3746eab865c925', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: '94984a0921ff3fd05295f137b05628965bc9a697', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fdd76aec292df2412d43e6798bb5ad0dac6dcd26' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
