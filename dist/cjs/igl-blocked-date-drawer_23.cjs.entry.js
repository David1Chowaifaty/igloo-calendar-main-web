...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'cad26760a40251bfadeaae5fdb21ec234cce340b', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: '563454c7a96dc3a7fa6d626654fb01bd0975be2e', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: 'd9866e0b8f6710abf2b98cdc69ae0abee3629a75', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '1b45f3e45df83a2e321b0e97a1ba133bc044e828', "data-drawer": "close", size: "medium", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '6087ccc23f56588a8106d1792290e636d714ee84', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ef74042ec05cb47deab94ed6f1d7d1974122634b', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '0890c12493d8ff60e1ed56a95e3fd3bd2b1bf9c1', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: 'bdd62c5cb976759534b434206f963cdc0d2b2176', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: 'fe7b70adba371df40296ce8e254b0e0cc43c21c2', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: 'e8ddc24bfa1b3d966f0c6945e8175e4556577e0d', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '64b8f33227448bfb82b3306c9fabe1b83106a50b', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '6ed4c394b693436b0e3a6882529443eaaeb395eb', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'f9c7e24a75f789a6e83212df901dcb989e5ed47b' }, index.h("div", { key: '8c0a4db69873d8d7245507008e1aa2d001e28bb6', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'f37b51c1ca52942086ddaa42836f4f81415608d1', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'abe60c49c6d9c59f987153b1cc87d0dd3896fb6b' }, index.h("ir-drawer", { key: 'ec627934ff9ec1ed34fd8a62f68d48573ec7a37e', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: '21c4686a608c92b440465574f8022e9356a972b4', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: '781b5d9c4053ff55aa0e43372025c4c0f3d6eb29', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: 'ef9389108fe5b092f77419959ee5cbcd0009575a', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: 'c7d60aecc9e1a9712a5dd884ab0533a04e0fc98d', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: '91ad752ded8692661a7168c77c4fdfc21df553c3', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '94c793bd312d6cc3a7cfc362f280304d1333443f', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: '4b051379fc808369d17617fe701aaf7f56a01e30', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: 'b71267f4bd3724c915f26bd34ff2c9f78e71ebb4', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a0babbcf1cb06d3177aeea8290517341aa5ed3d7', size: "medium", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '7ab924a800e07352134bbf43ad2920073258e46b', loading: this.isLoading, type: "submit", form: formId, size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c48f341e7ad9f97d1edba2c88e2ada5872c51824' }, index.h("div", { key: 'b98549f7811b2e1a30f42a5e0985685339282eb8', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'd8f75d6abcb08de3bbd5425599f7b683f5639cdc', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: 'abb805f494480af1f1d9a5948f7ab738bdcb72a7', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: 'b336d3ff9445065a7e45099ce8abe70ad806da20', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5907018557e7cc2f46ee2979eb4c7b2f6df61a86', class: "footerContainer" }, index.h("div", { key: 'f2aee1141c32ff4b72de56733d73015e50dc2dcf', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: 'e3faeb162470e4b1ab3ad6c648c1dfac62ba63e3', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '1bf82d9857d5a754009faa260426697c78a4d2b7' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '35481f0aa08fcf3156bb6bf23501b7da1b9a80c0' }, "v1.4"), index.h("ir-new-badge", { key: '143d4657129612c60c8c156c42a7e97b5f9dfed8', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ef4448ac4a80be59bcdc1781cec491e2634d1620' }, index.h("div", { key: 'db46745590da2b0a38934bc03c9d7518b634b83a', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'a914b057658dff1af9c032fceb924b41c8966203', class: "header__fd-actions" }, index.h("div", { key: 'e91a855bfd6edca3ecc8c539203ef94b59c13008', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: 'b90c7d7e8bb0a4e0eee26cdfc6d1b29d3a59dad7' }, index.h("wa-tooltip", { key: 'f6e963031cc27854080bc8ae4d63cca388c63df2', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: 'dfe4963bda05c536045fb5269a84ab1ed184204a', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: 'eafcc2d9309ee66935f7400c75e50309dce8e806', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: 'f70db1fe0ac1d942c24dbb3a0ef63fd7f87a16ed', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '07e7e3b4ab54e9f8189c07375f382edb975c65d6', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: 'f82ebe2a2dc878769ab3252f0f100306a52115ca', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: 'fb7ac59bc28b8f1f10361ea5600969318c7a7e42', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '4407d692e7f60b4630f6f554c16e64007f15df97', class: "fd-dates__actions" }, index.h("wa-divider", { key: 'd595f8514f44832ad78868902ab2eae21aac35aa' }), index.h("ir-custom-button", { key: '0ffac80e81d620897247e916641b8aa340515792', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), index.h(index.Fragment, { key: '0207aeda641f4d6185fd2d4eb457d74db702a30a' }, index.h("wa-tooltip", { key: '6246d08a81271bdb4dd282bb24455765591d9354', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: '26e6f7578b76e1d7d2b1ee8424ac9d85b58d9847', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: '6b31ec4da1b932b639bcb4e070e01fa9e923fc2d', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: 'c093ba29c35fe6dbd4349155beabc15972521245' }, index.h("wa-tooltip", { key: 'e33d6888a0a9bedbc55effc9269a3ae2bc33ff2f', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: '1f2aae0bd3582be91052dd6113458c13857cf59b', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'e264ff22096e51066f612b651ea988e10342150c', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: 'e60996747598a9a0f811644b35f46b579808e3b2', class: "searchContiner" }, index.h("ir-picker", { key: 'cb631b94a429d657d62385517f55713a3dadd6b3', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: '6a58d89fee2a8657cc6dae21b6fcd753a4bb31c9', class: "stickyCell headersContainer" }, index.h("div", { key: '6c5b4756f23d4b0f23868f70e4b8644f4b76539b', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '659541c222fd74d8916f03efeb77ff814e5ec9c2', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: 'c3fb81fc0bee4864bb5f3a68ac7a0bc64b078a65', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: '5f856ce8811aeeaba34a6424eb41b144bab4c5d0', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: '97ac7526f5ba0b527cba8821dbe205351e3cbb6a', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '54b76b72ff670c594a51b7babc3cbb2947eab662', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: 'a5bb72689b34f1873aad869ec65e8b58f33c20d6', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: 'dbf51c3d0384c21bc72f9240a9932392a4e68c9b', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '9568409760ab553bad72f329bf29d4baa187e77e', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '0827ce170ef4d4ad837cd36b891a975d8002bb65', value: "hk-toggle-clean-dirty", size: "medium", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: 'b61bf629ad69d1229d124d302317bcdb1db46103', value: "hk-clean-inspect", size: "medium", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '194d511668f490b8e2653a1ad770aa637652ac97', class: "legendContainer text-left" }, index.h("div", { key: 'fcfe62572691f3d1b65fc505aec387595113ba73', class: "fd-legend__header" }, index.h("h2", { key: '8d46752d9221521f1db4167a2f0c83bd8ba54f58', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '98655cfafba3315c6f3d580a5a031ee61af9d71c', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '4da3e9b8b50e5bc110fa1555d3c61e0dac16c357', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '15852546125ee40a3a53142995ee4d16ae9f3859', class: "fd-legend__body" }, index.h("div", { key: 'e2c50e782d0cd316e259ff9bdbdc352f72fbe551' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '858d33a133d44d4be833be8c6c22b62c74f0392b', class: "fd-legend__row" }, index.h("div", { key: '9d71d35adbba501b32a513ce87aadbb9e156b7a0', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '8559201f9d1a0ecebcb245ceb032bbccb2d682a0', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '4db86d21e9fc91e8ab770df854f840df58e9090b', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: '67596504d19308039c5bf9fc6db21ae8d879c746' }), index.h("h5", { key: 'baef1fce4b4d1534a7d1595e637718e131e87565', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: 'ab48b36feb6d6def35640a423a2dd2c86243ae34' }), index.h("div", { key: '1abd576ae18371554c3263986ea5506c95af5c22' }, index.h("div", { key: 'ada7b5d21c20a3badc063001d4bdf150a21dba40', class: "legendCalendar" }, index.h("div", { key: '650b15507589e433600271de1447ce7e8a92982f', class: "legendRow align-items-center" }, index.h("div", { key: '86f0dc9dde209c0297ad4a9a1342aa054b727b1b', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'd3d64b4ad89a01fb0c84e2b8e0f28d08f6d4dec3' }, "MAR 2022")), index.h("div", { key: '1f9866abd0ebeb3536b5ea5ad56d5821e641f015', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'd937a44c9979d05310a9d78b6734efd9440f868a', class: "legendRow" }, index.h("div", { key: 'f473f732695b3b5a1c5a946272fb1a3aa9e01f4a', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: 'cac4a73caab7b4692f580e4ec59721c3b6fe95db', pill: true }, "3")), index.h("div", { key: 'c0c2db03298f80b34336fbd6b2d20d4eec0ab539', class: "hyphenLegend" }, index.h("div", { key: '3a67220c311fd2b7cc789473f7a79960e76a3207' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'd29fb57340d5cf08d29d56ef0df04d06503607c7', class: "legendRow" }, index.h("div", { key: '2bd4798010f4fe7316c0feb621e45b92b49906d4', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '8e3ac0025b45b864702471e9d16315352ed2b272', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'c00b00fd292174743940c1abdc95cc2a2c33faba', class: "legendRow" }, index.h("div", { key: 'fee01f96cf638af006dbcb7fee900b1ecb5cd3d8', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '252dcf802a4eb31e8c128b3a5ab6730d36b217e3', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '0026ee6a4a316debd592a7013273e043a5d9953a', class: "legendRow" }, index.h("div", { key: '1405276c8091a4fc5aafbe3a7ee37774265d0cd5', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'aea7501e38399c63a02274e3b6236a3dda22b894', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '296cc9cd814c0edaeda0696b3ce57a1fe9a9a4d1', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: 'b1a6dec09a747202f34757a955f6e51dc9049ee6', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
            ...
            } })), index.h("div", { key: 'ef7ac702de2c60893271edccd5d56af5fe2b8b3e', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '19ffcf69066079c647e8600a874417689e000b48', size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'd739f0f8511ec0bd613b78aa4ffde5a12ca30af5', loading: this.isLoading, disabled: !this.hasInventory, size: "medium", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '51dfb0c8ed5ea09990df2353efa054c8f8190c11', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: 'c5a3e37d789613599d8751e8e2b589354de1aebb' }, index.h("div", { key: 'b9589577a39a95209d77f657fd12d569da612aa9', class: "dialog-body" }, index.h("p", { key: '90d3922952672f1cc339bf68c38b1953228e5fc3', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '898b2471375473f0113bd73bcc2fc6aef98d1a3d', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '3e072b02a1093acfe4fca2c1056042219ea16695', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'bf9099752968699016c1349344cf8722e67dcd98', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '1c5d7fa48ed69906dc8b5a266350bca19135b1d0', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: '55e82b2e4523ed385b0fa6fc8a940be9c5b09ed2', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: 'f8f1a65b268c8806bd80f90d8a2403e46cdb1162', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '09129331fb7c6b35868f7c2ecf14a4b43dd8dd14', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '06208e8b6e1abd61c513253e361e104e9ca11096', class: "px-1 sheet-body" }, index.h("div", { key: 'da844d4112cd055e93e7cbaa4a681420c9a43e4e', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'b80bca7bfbc113c21d7ad1778fc7fff9bd26f7ab' }, index.h("ir-date-view", { key: '4dbc30b7ec706ffdf018097bc27dbd09f6097944', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '9b83beafdd509baf125f420a4cb87f50ccbe07bf', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '0a070e53ccb83bb33fb30e995eb5e3d3428facf1', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'e92e5b9ed152aa66ba5be7c6036aea058a3aa2a8' }, "From:"), index.h("ir-date-picker", { key: 'ea67119ef9f001bb9e01579b32b6118bbb6e8c0f', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: 'b29dc64b1d6e5fc32e0dfbd40ccb0fec0b4073a4', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '419bb34e474bcd1c97fddd68e3cd64d45b437597', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: 'cb951f478047cb411dfa06608561505d44146c50', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: 'd86d4325337e93662b8cabcdb5e93dc890f911f9', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: 'ef0722c75e4f14de4a171dd6b78b4e3d297902c0', class: 'sheet-footer' }, index.h("ir-button", { key: '7f667d76ea5e50b641c1f105ff76f49d11038c38', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'e91d44effc80ef96771a8edadb484c109d9e2858', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c3bb683dc17ecfcbe7ed8bbaa6233882fb4844dc' }, index.h("div", { key: 'b3d45921d06812bca9ccb00542ed21ec5f630e61', class: "tba-category" }, index.h("h5", { key: '0be16d49fd16aa1450a862d4e9aed9182241f5b8', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3576a25daf06721f844766f99645351c1f34cfa4' }, index.h("div", { key: 'ad03987590cbfb21518aa595d298598c130247e2', class: "tba-panel" }, index.h("div", { key: '387f23d2a50efdd2ef6560fabe29487af1685fa7', class: "tba-panel__head" }, index.h("header", { key: '0c1290d373b34d680d4049f7fd47bd15099b0792', class: "tba-panel__header" }, index.h("h2", { key: '7ce68bb53f0d0ba55ae0ac6ee898ebdbfdf79e09', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: '1cf96f156744e30df5ae8e7ddb81945591f0ca6e', size: "medium", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: '468dc2ba504361869ae5320b3fe9bb5ea214aec1', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: '6af619cc633ffc28bfdbcc70fa23d8bb45f16255', class: "tba-panel__toolbar" }, index.h("wa-select", { key: '728e5f1678f564406649203a55e5e79fe060e1fc', size: "small", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: 'ad2039409b1c82bca606e3652ea3358b2aec23bb', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c09ae3b7fa736fe5c902ce4896265f8220b0cb69' }, index.h("span", { key: '829432786d287c8ea8eefb1dab05a4c5af3d4fd5', class: "new-badge" }, "new")));
    }
};
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '26bf4040910763c8f30491b18af88fc0b96419ba', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '528be92e8a15be74d2fbe65846a29c4f0d3ae028', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '4c6edd527862fa8a6ec651ce9c68ec4adf56e833', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '1767a0e6b395a10b613c4d403c271e7e4ccf6426', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '936a268e6e5dd55fe645912d93afeec4860c84f4', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f1cb95c3a89b674cfe89d434ded4df0083f6e3c3' }, index.h("form", { key: 'eb76b4a0a5e5ee22e8ad74bf0ae58835a3fe9ced', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '8f406e10c97527aa4ba1905e36c43179c995d68c', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '7e7f961fab0b80f1db8cacb919a2f10d8114ad4e', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'ca8335a422e3c973bbe4ce885fc874c52b36044f', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '576b6d8ca37ebf7acbd60d08dfce27d4b3901cdb', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '1053db18e7dc1d296665783a5936f9ad0569a00f', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '1d28a4941d14b948689302cb05d9ae26d1eee992', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '5d2c951107c511f6ba117aba4e9f8ed788947910', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '65f0ff03f9e7cb9146078d1aab95032dd014d8fb', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: 'a079b7d498fa24e175f58d96bccda5be64c5136f', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
