...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'eee80da7d56ba5e73d2aca00626955e1157e21d3', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: '50e732659c846cbe8bbf9676f52495f6e0524bd5', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: 'c3087868880e738c5062d40190eccd6ac32bbd41', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '4ad4775e437ea1e7d783478c17a8d2ab229704f4', "data-drawer": "close", size: "medium", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: 'd6f5e79cace7a22ad4b1d8a60fc671295a3bf73d', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8edf2a9f38181efb711d54dc8af26e2fd0df691c', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: 'ff2f8598ce2b04a16f72a95a6342e8b3cc8ff4d6', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '15b09f51d8882902893f853bd832460eb18e3f71', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: 'e5df6bbf80dabff019c3a16ee4eb9a2bbe053757', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '9f398ac04fee797927987fb1296a3c9d70deb80c', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '51630cdd560ec71df86d7afa9d9de19718ade077', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '9a1a2901caabaecbc6cc14e801b5ffe0094cbc11', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '9b4ba4d685c56c388a90ad7f0ccca41554e9a998' }, index.h("div", { key: 'd902302f1368b00b1b732c8eee9c8481688e4bb4', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '9a4fab222be953a2687d9c3d8597d4685fbd642e', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0371ac74f71ec01532038596050108ee6a6f7919' }, index.h("ir-drawer", { key: '4d287bc27f1b6f6d73f52af912d50078c69c1d9a', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: 'dd0cc881a95eefa5b31fde1cd72b3f36705df12d', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: 'b6bb08cc087e2bedd58b6c393c0cb7053a8cc4cf', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: '06991572bef498ba533d2f17e0bef9bf140b21d8', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '26b89331d8d458471916fd4665da120e0fc010fc', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: 'f762175c3580c5180f9c1d8b30ca66874a88d087', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '49c49c76bd3053ddab3047f3374abf79b0ee3cc0', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: 'da3ebf24a339af79442e339135e18b854ad0aba3', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: 'b70d6dfb6d56e376e37d377212d9cbafbd0c48af', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '7a725d1b5b7c20063e1d129e98eef214bb91deb8', size: "medium", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'ca6a511515af33ba8ce62ddce0562d733cf5862e', loading: this.isLoading, type: "submit", form: formId, size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '128f391c8914c9b685d95fdcdd5de47aca783ae9' }, index.h("div", { key: '1122077a93ae46fb9b0f2578b8c7624235a0e7a4', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '1538fc5cbb97ac61cc1e527abec90711edd2fe52', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: 'fd1d593bcf2e4baf9ac95702848a110bc09b1114', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: 'fa14aed94b78e751277fbe8253dabdd939cd52ad', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ffda07f9bf60d74d24cca6cc5bfcec19e3a833e6' }, index.h("div", { key: '1fa53fe032708ec96636ec9e4c1770b6c38528fb', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '6329fdc44edaf0f5cf0e524d6125f1706b3aef21', class: "header__fd-actions" }, index.h("div", { key: '3cc02c9c0a5077f5aff0c45d96371035a3ce06fc', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: 'd30097aac5f44af28a16f2259c5bcfd5d71df6fc' }, index.h("wa-tooltip", { key: 'bccfffa13b4d8660f95060f94628fbe9a000e522', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '299b72e31ed4d61cb6d57cf075e8e2252451b9db', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '50fc74d2f745ff40fc9683e00352e0cfb4fd3dbe', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: '3566786700ba77ecb64595b85669fad75093685d', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '358a51b1ecccc6b09fc18cdfc71b6b22648b0e92', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: '6da43e75f3417a59ee9c967ed878ca218c11fc17', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '9eea630dea3ba2f69f248c77998ffa365cdf54e9', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: 'f39cdec87015bc6c753ae5bdef9561b396805307', class: "fd-dates__actions" }, index.h("wa-divider", { key: 'b061c12144d1a244d1c2f4f8b7a648ff919f2e4c' }), index.h("ir-custom-button", { key: 'be509036c6310ec3b0290aa0657c277d3ef81566', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.closeDatePicker();
            } }, "Today"))), index.h(index.Fragment, { key: '836bf62c398fd692ef39f06714ea141cb90c2c3f' }, index.h("wa-tooltip", { key: '8135700c8be3f0139e8fa7ae8502e3c9bd0ceac6', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: '6ceaa76decf52c38695fd6da6311971c01dfa1e6', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: '37498252f1bdc6ff669e4c5a39f694038a39c26d', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '04805c35beafee68142bfd2d0b86cea5fafad2de' }, index.h("wa-tooltip", { key: '445a92649530b1c02a605afb6366bdd19e048b15', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: '8dfce0f30b67282e425b33444455e892b0bc676c', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: '2882350438c3c93f7bd544d2fffc2fd5f80d9c84', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: '942667daea7af30d6ffa59ebbc242ceb86717ca2', class: "searchContiner" }, index.h("ir-picker", { key: '39f0392eaab5882a8ab225832f559aff282a77b5', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: 'cb8a3997e3145a77f483f4fd9cc2662a80b7cf70', class: "stickyCell headersContainer" }, index.h("div", { key: '8d144207b21539244929f928453a0e0c718eb1d3', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'bf8b86ba9c244bedd67eeda6607f314fe963de59', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '2b0f659fec2ead46ec954767eeef635f8e066f68', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: '99cce41416cdd61673877c5824472241cb125013', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: '4dafb13301afaf609829d8991d8f76c8068d9b6d', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '559bf0f660826f4a0e8f0de24130d888907f55b5', class: "legendContainer text-left" }, index.h("div", { key: 'f96ee0285716a11e611a825283ff8df53a465690', class: "fd-legend__header" }, index.h("h2", { key: 'af41378e6e21c86428f776359d4900f88133691a', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: 'ae0ba4584cb710b5a8249c938441bf13edac6d32', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'eb9b5eea8867444c599ec78395d2f7a5d062b264', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '0fe212a5ff09ed63f3b54ffacc7f37ce71c158bc', class: "fd-legend__body" }, index.h("div", { key: 'a1eccc87732d7befc9b21fef6a463404190fbf89' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: 'c8fd37ab16f93b0e67533627bdf5b5610e6efcaf', class: "fd-legend__row" }, index.h("div", { key: 'ec918eccf1441fc5728ba48d0b179e592fc46c5b', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '70ec4f55a9dbe81b2313ecb8f0dba74db54e3908', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '47c48d542d245c1c7939562f5f126305ed074b10', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: '41576e0f9669eb23c4f53ca6e6ed805c97d47051' }), index.h("h5", { key: 'ab25b02bdd717f4cf7b88b6b17aaaeb805a70493', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: 'be9b406fa6c860dde9a1a3d2a26815c99210b191' }), index.h("div", { key: 'ebf85c27f9b278c262cde5af5cd98f94b5e9be44' }, index.h("div", { key: 'd7057c43d50d97bc0406070e040a358aba04cae7', class: "legendCalendar" }, index.h("div", { key: '294d17c7ed57f3d6b553a32a5a703e1bb8a83d0d', class: "legendRow align-items-center" }, index.h("div", { key: 'b4a548a41faa53f122a927f3f3be7fa14e7f78f9', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'e6de352b00c389ba4b2a26449e42cee10de300b1' }, "MAR 2022")), index.h("div", { key: 'f71989e9a4d70c217fa9cf1948784157897cde05', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'b07a4a8503266bb24aee108c0e0b36900224f67f', class: "legendRow" }, index.h("div", { key: 'a11dcc963a4edab710fbd8e2600dd0397f56bf01', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '3bd751697c19ddcf9810df104f7954a73a542529', pill: true }, "3")), index.h("div", { key: '2ae1b13594a7df71316a80b84230550395b0e04e', class: "hyphenLegend" }, index.h("div", { key: 'fdce441f5ebba97d2f74d9fd5b18cfb4d85fb00a' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'de6f7d1fb0d52aab9406875e7023accac64348ef', class: "legendRow" }, index.h("div", { key: '6afee815257bb293680c96f7f77d32ef47349950', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '9b2163ffc6a0c4d6ef6962f779de4feb66f77b46', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'c26ec3eae8aa4a638259c8bd4059c1a550ebbc0f', class: "legendRow" }, index.h("div", { key: '964661c2a27cbb86890ea857cf912f5fa32b5753', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'e33410e398f6c1b78789032b9a7fad77d6d795d0', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '56186f387cdcf6f17b1c511b5d299efc74146fe8', class: "legendRow" }, index.h("div", { key: 'b0d862d9c217084692ef83c6cdbdc4eef9b51b82', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '1efcd07656a02b72d29eb7303da438b098a9e007', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'c34466608706dbe0da6884108038b67283cec2a8', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '8b141c9870a782892e803158d0a76821c1ec52c5' }, index.h("div", { key: '47c1f10fe63b8d79b08a561542b5efc7c5292ec2', class: "dialog-body" }, index.h("p", { key: '2ecb8b33f99a774b6a9e0d26e45abe44b9de3f11', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '67f18f1174ef2b84f0e8fec0f1735cb2f459aaa9', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: 'c09715657f1c4c4ea12eafed76939eacf8361189', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'faee4150b466269e05bf02584789bcd37c730e8d', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '7baa89b5d86914c45a7633c7f491961ac4263fc2', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: 'cf68e6f9c679baa1a70f22c9dd46a8ed2fbddf3f', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '1003d6c6882a368d94e4b9c029ce8ed0bb6e5c98', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '1f7cea8c6994e309178c20f1c2a33c1592034f00', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '421bd5de7c7e1ab1a8aedeedcb2ca018c80e0e44', class: "px-1 sheet-body" }, index.h("div", { key: 'c292aeccaf734fd805619033f6526142ec283c8c', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '2d0f6c2a4fcc9ccf6a542094179f4419da5cbaac' }, index.h("ir-date-view", { key: '87d1cddf3885f4d60711588d498c15df39958307', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '286a00a3a57f2b00ffb9dba72710de2f5273a397', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: 'ed95fbe3ee0933542b6b6c06356af3bd810dc0a5', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: '9a37ec4c500ba9aa8d7e4c7ecd9c9e1cf50a6405' }, "From:"), index.h("ir-date-picker", { key: 'a3f4024229330d30e8d4b37f34b354e5073a4024', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '35d20589141d9118065d387cf39673d7dd35f336', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '822d51ee544edae4f9ea320dcd5565b9b6abbf27', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '02659fff26cf8d52b50ebee1a309893191f874fe', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: 'efdb059c90c034db42ddad6e6a446325239180e5', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '2a7c55b2ae9fc26d2574da53913df8f0d93a2995', class: 'sheet-footer' }, index.h("ir-button", { key: 'ba3a6c5557582cc7666de0f2a39323f04957a6b0', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '89c7c3aeb12b199eeb4d74c2878ad1b168d8aeeb', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '020574ff95356ece1f5c437f217196942deb6493' }, index.h("div", { key: 'c893644bf122b3c3588fd65d85a327472af24cf6', class: "sectionContainer" }, index.h("div", { key: '5b605e980c94e74013ac3c3ea41ddf76f97f1f26', class: "font-weight-bold font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8fc3aa860c8f5697ec5840a3df567178b556398e', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'a5887b0f1aaf11da48c3fe645cf892d9cb8839ba', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: 'faa341f85d41018223c9c0982c8c3aa0106be648', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '0baf95762845f237266b070db59b2af7e420001e', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: '350937a78c108dae4f3cd93880bf3877a9051932', class: "hk-dot" }, index.h("slot", { key: '65bb211673e4094d6ffa5224c88175bec7871b27', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '87691ea2f28047715d52f7affbe2861657009a6e', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '778ca394a656583c6a6cfc486ad32a7df8960e23', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '789af05d88da3fbc2acd9adb585f6926776fd186', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '1e9b7d3eba75df23107cfe2b0ae75400e77a57ee', class: `ir-alert-header` }, index.h("p", { key: '755eb7d492bc4c8f57123ee39529378b073e8b88' }, this.modalTitle))), index.h("div", { key: 'f1446cb1317ca5f5ff91de113175a2f4a39702cf', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'aae93474a771e1d0a045ffcb611a2a8a460a0345' }, this.modalBody)), index.h("div", { key: '02bd3d6bb952a2c8627e70483cdb13c56270b95c', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '39bdf14d008ba27e286ddcfc620c56c8a4d38bdd', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '70aff3be9f3ad9c9b7030159f2291b8805fd4b40', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '664e6d98e16294ce2a9b62f95888a6ec106bd03e', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4a2a3441fcdcd402efb682c1d9001bff73dc4068' }, index.h("span", { key: 'f0dfb296b46fa4ad9024ee2fb2457cc4688df61d', class: "new-badge" }, "new")));
    }
};
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: 'c6a6cfedfff8b3ea64b0a265fc844dde9e5fdcfb', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '86cce590be960e480f51f1c68b56f5bce35f6e69', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: 'ab8e2580c4b0305f3dd47017ee3fed049ca49119', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '0edf3f94556d673c1a673e73b04dce014bcd570b', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '437edcaf8d4ddeda36c5179b40fc89f4f97cb0d5', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '698fe7b42328e7387d061755a27cc50799ea27a1' }, index.h("span", { key: '323b60db43b564480896b2aec2a8ec1b0b13320b', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '54b5587da0cd049a86ce5b68a6741d7a19969334', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: 'd9a767a7bd4952ed76f2d5a36ac0929d256f7195', class: "input-group" }, index.h("label", { key: '43175c3ceed9f7ac3f8da80c571d24b57bd4ecd6', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '82f2809677da2fad509dd4f1ea8302271f3c3442' }, this.label), index.h("input", { key: 'a8323820d975ce41a938260c554f6eef44b23b2a', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '794dee3b402d0623eb6d991910d1ed3a30b42740', class: "checkmark" }))));
    }
    static get watchers() { return {
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '5e01c3c5ccc40337dabb87bc046dfb62a15accdd', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: 'f3979a689ebc0fd757a92900968ede41d6fadcff', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: 'aabc45e4ee86f0711a3a67996f03fd9442e37812', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '01e9df0eca8d2a90ae3bd9f016aa5501d9c1329b', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'e5ee76b2cbf7b0ac59a88ae8e4580eb012d99db9', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c8bfbbc98c957a18b9fc325279206087114e1b46' }, index.h("form", { key: '3461cef40ec5e2a49df03982745b08639b88d158', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '2d4740d8cd7576231c0e16600885375b43195604', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '21ec69aef2d2efd1d8cd073dcd090bca16bb8f45', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: '03534f877dea1527f08fb3ea3715465f81be2ab3', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: 'ddd209cdd8fbdbcd9dc53a3e60052895c5a94315', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: 'c6ff0bde2e9297de382e7110995f55bbe27085f4', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '14347b8be8d66faa1688c3104cc4e898fd8fc9fa', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: '727a563ad35649d569f22b7bbe9be71fb2425d3b', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: 'c6848df09c2fdb5ceabdc669b8ca2aa77e3f0f1c', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: '988c4a4142cfbe75ce1782012968a153b0132121', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4e7cdf248cad317937b00a8461f4b53d3a877e6a' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
