...
const events_service = require('./events.service-de60890a.js');
...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '9c82d19109249c04604dead8911bafbaf2c57cc4', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: 'a4d4ec4ff4c8145d5fe2d1ab178113a7326b93e3', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: 'e4def737f666998f0396b632d873bb3465ad431b', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'b6170f9d47c1492d9108149a111d017b44130e51', "data-drawer": "close", size: "medium", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: 'c46f1508d99e7db69c2d941c2089a4ba6dc89c98', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c8820c6df11abb9c674f594055477b122320aa56', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: 'a319aa3aa33f05a5542c03828679227aea2cc28b', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '71295c8eb2f48c53dc4e1a18d8a8fca549e9e2bd', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '46f4c5fe896288656bd1bbea761714989ef12e63', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '52e653c68784065351f5aee726b297688740f8bf', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: 'b63c6fc41d0c4f5a353fed958ca89c240dfc22eb', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '4a4e3d21776b34917557a3d897ca486f6555038e', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '10b9d2de42d04d906a76236aae02107b690fd200' }, index.h("div", { key: '65d5b0516e2c90e5a7dbcca4fe78fc1ea9c6719c', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '81330c65ee15adafe4e2919f184f86054e007890', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2094cd0c10921f8e1b5656d59d9e3e8d6e2e6015' }, index.h("ir-drawer", { key: '1115236366a1250ce1e7e19287fa4cba2334da5c', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: '736ebc216597f8de982e50dd2b24df249cf9d71f', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: 'c902f72a3a74c0f31d9ff5647597ae8c06ad4c6b', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: 'eb42a725631042aa0c03832320567a522fa92ca9', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: 'abf8168e1a216cf9981a84428b0c310215ecb2b8', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: '0d4e1c1bfb38da1932ffd6d7613e6dc1ac0b8bd1', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '481ae003179d574b955ab34fa31185f18b2731b4', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: '5f316e40a23e6cfecd9b4d32f844a639819c3467', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: 'f8a5b009fa2fa3b70e2f8fade802d44eeec5fd64', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a20c328096b47ffdf966acea40ab5dcb619a87bc', size: "medium", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '51dfafda1a8d816cb0fbec040c6d3f61e9aab3df', loading: this.isLoading, type: "submit", form: formId, size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '35e3cdbd20054629f34791f4f7d2e58330ec30c4' }, index.h("div", { key: '03c692894308922c2f8fc75bf84bb78eb0db2b66', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'eb5dcdc321aa765c65ab26bd0ee8f214f9de1332', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: 'ff5402c089cda8ee2b2fff43c97ffc5d9b29befd', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: '3e949f84fffed7f2aa091a3b7cdd3b0b974b837e', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8c0cb603327f6190ac9770beb437a244528591ea', class: "footerContainer" }, index.h("div", { key: 'a22f068b64b076db384ebb1d6a65ef441449051d', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '7babe06a18c8e204b5366dba48a8daeca94c418a', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '27b8933777bda5db1dd6b26d9bd09539cc4c0cf4' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '59a5072938b9dda83f80c57c771afb141f9a57ca' }, "v1.4"), index.h("ir-new-badge", { key: 'f2e430ea5f21c69c5ce47288b7f8cc06eba0df0a', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f91843fcc3b32ce0780f02602105681a9a50fe78' }, index.h("div", { key: '21fd232385c34f16afd8c85d90e1d5cd9d931949', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'bc8087bac2461308f7a559c4dc2846351f3c1f50', class: "header__fd-actions" }, index.h("div", { key: '235b0d5b4e5efec38bfd5f175b4aaad0d19b2148', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: 'eaacb7c8da450d91298246fdfe51ef7b610385b6' }, index.h("wa-tooltip", { key: 'f5d8eca7672cba321fd743b9007d2c4320959378', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: 'dc376a0a69160030535134a83556319ca001e040', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '69cddba054c3027c7bfc097585b1360ea2a591cc', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: '9f447edcb2d528c2d76b86667e347571dd1bc1dd', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: 'a1a0f12300c20aa76be23def61628f4275068d37', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: '0a4f568b40dc3c0daa7aa06cb803d65becd38ec2', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '5f3f35c8c744119799c75697c37a886da1ca29a1', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: 'd16245a882dd9a3f142f977533e6c1ce857ad481', class: "fd-dates__actions" }, index.h("wa-divider", { key: '5d16362baac042acafc600d8b78c5fbfecadfd9b' }), index.h("ir-custom-button", { key: 'e33eaa26c190036ea9b2fab85d46fe796e6e7407', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.closeDatePicker();
            } }, "Today"))), index.h(index.Fragment, { key: 'd5d11372357b492d015c4b01a18faa7eeff8bb7d' }, index.h("wa-tooltip", { key: 'e161d11467669d305328ba544fba07439eb50ac3', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: '4a41c3f894651ae3c93d259c6c7cd4a8bf555100', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'cc4abdb1130b631e42733b1aba21af23e6d1469a', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '7e78032b8a5355096d8d66bdc45302f482c1c473' }, index.h("wa-tooltip", { key: 'c6b8ae194cb97d9494cff82d8cd5b138df69ee2c', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: '78b6f38b4c4a9d1d060fab6f45bfd9036e18e3f1', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'eb09e26022f32226a03b1e44c9d7423a464329bb', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: '82041a84f2418ffabcc4ed3294e6d4b836cc6c0a', class: "searchContiner" }, index.h("ir-picker", { key: 'b6c0702d538067b0426c8b13dbbda5ba4ec7192f', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: '3c016c0c74c5c29bf49bbb586374e102156d6400', class: "stickyCell headersContainer" }, index.h("div", { key: '1744d062eb5f5f8d8953d9623e8b540ca559df25', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '184311c49442843d5baedb41d13c9e9c10519cd3', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '289c2b9176ca258a2c4cb40a18572b5367f5d27c', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: '6f370d08401a78a022f01b6247ceb6cb104fbd3f', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: '03d6342d2f8ce6ba93ad30d3c889fc8c9c6c4b84', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '05b58ae11de6b2849a8b5898d80f3d499d4593c3', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: '3ca3fd04afcbea67e39d74c9d32563a5f7d36efa', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: '33b87213e17d76a250e7fe83d5258c5c71763cd1', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '39c86dfcdce9e279f01210d37d6fed0bac6c1c80', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '49a5bd1dff534d11e45aea083b1c0fff745cfa13', value: "hk-toggle-clean-dirty", size: "medium", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: 'e50b206d29dce9570cd2933f7bb7279abe86e22a', value: "hk-clean-inspect", size: "medium", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '92ff8dfc5baffe6163ca0776f3ab0809565b35a0', class: "legendContainer text-left" }, index.h("div", { key: '4dbdddf63c31aaf9f00aa4ccdb8ddbf5eef2e6d2', class: "fd-legend__header" }, index.h("h2", { key: '1bf5ff096d5bd431dae5d3dcf410f628b6201a5f', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '9c1e7b186d44d8164e7b5c7edd7ead6882df407f', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '225836bb53526f8d3a451573b06d5333729c07e9', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '3757b6c1bc5319610d24e659bfee10ec4bd42e09', class: "fd-legend__body" }, index.h("div", { key: '85071776c718cee00ec6d264b68cc017dacceceb' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '08f16c6898c48c1be49122faa20c98c4a8dc3be1', class: "fd-legend__row" }, index.h("div", { key: 'eb9c2f95bfd95f3edd107d4a74f808e1eeba1d83', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '4afaa8e17fa8aa4197df31428501098eae7dc7ef', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: 'c2d7ca8e94490bdc440cd7c907ef4cc6438a7943', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: 'a757231b91f7dd574449a369018d1b1084b29290' }), index.h("h5", { key: 'e60b643de0a278209b5c1b7efd613958f96b71d4', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: 'b2fcd5f8e4907217484a70dba559d68da2994d52' }), index.h("div", { key: '55e8787f4714e192dc554119027fd1e71e23848f' }, index.h("div", { key: 'b29ad0811d1a5d8d807b1a576cc95fc92c5d854f', class: "legendCalendar" }, index.h("div", { key: 'ae754e3b504c5513976af984b2645d1384e79ea4', class: "legendRow align-items-center" }, index.h("div", { key: 'c6bede690069fdc2ba0645f026ee30d47cd38283', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '71c5e556813bfaf812759e6b1e89c5d00c4a12f7' }, "MAR 2022")), index.h("div", { key: '798f8b55ef1da50f2d089aac2fe6ee40ab363e4b', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '5646e665c92a9a19c079f09c0329797e62c7129e', class: "legendRow" }, index.h("div", { key: '08edff0becc25fe6d10b9cb2c1f45e7e9b1bb549', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: 'd32d3087ebb11fb7dcb809a4b0586558e5df06b6', pill: true }, "3")), index.h("div", { key: 'd97e5daaad2da624e93964351868ec06644fa72d', class: "hyphenLegend" }, index.h("div", { key: '5a8a44941eddbfe16b0861ef14e74669ef321e9a' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '6773c8b8f5b0870d8aa8d9d81aeac49c3459c56b', class: "legendRow" }, index.h("div", { key: 'b56b1dddcf7d653896e703597c4373ac3704ae63', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'f7809695f763791141696541ee35809def83d992', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'a9b0335a2d17fe19f1e34ae166f12e0c6c055a36', class: "legendRow" }, index.h("div", { key: '6d828b7e4e4bd72314429476efc84490c0edf5d5', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '853ee6d61ab47cd8c1207913d1c9d141c922e58a', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'ea4a8b2ee035972c86cf3201366cfc8dc8edbd14', class: "legendRow" }, index.h("div", { key: '16348d00b8fb958fe666a38ce630a561bad2c679', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '4a830328389c5eccb5b9b5e77ab9cdf77dd6f20d', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '3d79d8ae8ab2a192181830683372a3e141a332e6', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: 'b8269d4b670bfeaea63f5753f48e231c9db9c03a', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            ...
            } })), index.h("div", { key: '3ea3ee20c6b4838ab8f61136808c5a14bdc44fdd', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '9af22fc9af898f8b8e92ce078ef4a4bd313ad1e1', size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'd93f48aae7a8d95427693b4f32f28c648e6edb53', loading: this.isLoading, size: "medium", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '41c8568053b28b359b9da90ed1dcbac548f1604f', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '35fcad97871c40f871c7908dfacde5077cf0200d' }, index.h("div", { key: '61323bd1e2ba3a191a507c1de39a8660ed46a35e', class: "dialog-body" }, index.h("p", { key: 'b8a224f9c010d1744ec570969416c96bfe2300a1', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '43f2ff7c241823d33e246ff1cd2983fdccef88a8', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '84928695d3a4bb5a6afba057a899a29c4cb2a7cd', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'f37ede8b8b66cd4df6a23c30f64590da5081e032', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: 'a4cd56447fe8ad85c878428f01de10efed110820', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: '45218d508ad86dc1d1e4291a8e159698013dc916', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '07cf313b4d5b05583f377dedb46b81375a4625d9', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '920454d0da5522e8615f973ba3113daf1e32705a', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: 'fb592bece176bd51e15ff4e9eddf682b60cc99ac', class: "px-1 sheet-body" }, index.h("div", { key: '31300a332658719d959d31e513b2925f036c0280', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '61113af6d40c5f9d2f073cb3bfcfe3adf85d8778' }, index.h("ir-date-view", { key: '27066880b8b0f5b517f001eb770ac2d6de52f215', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '65f26d1846bc5564aa19e4210ff5cf712027964b', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '1f72906ee2b54f3c1f5efa6ca329474d3bccfc4a', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: '2480bf9785c4ae514a600ccaeee3ae64320f6467' }, "From:"), index.h("ir-date-picker", { key: '4442db5a79f65f20c2551545857181b3f3ec79df', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '8a6bbafccb5f472ecaa8028710f0cdbd244ed446', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: 'e53ce912e935fa1991c6fd40f43f25c6621954a9', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '5c6cbda1ec9067f7b5998bfde870535d8dfdc171', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '35c9df27d994fb34311176415a17365513f4d29e', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '54182fcb0732b3d59d782318516b06a1e7b639d5', class: 'sheet-footer' }, index.h("ir-button", { key: '2aad28dd2d6537837747aeeb4dea7e59251a394b', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '602ee3db409a5d6fef778312fc72814a8a32f609', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b0ca27ecf3f4d5a2c51c6d69b2150d7f0430d2b' }, index.h("div", { key: 'ef8b5d52e91f878168ae3a9cc538702daa1f0d20', class: "sectionContainer" }, index.h("div", { key: '67c19ba1738f8ec30d36b51083628bc3433752b1', class: "font-weight-bold font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'df778432a825d0b128146e52cddb8d13b3ba8dc3', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'f5752d676f5cf3deeca102fd22df816b49c4b0d5', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: '0f521177f81e508907c4f28e4e15263a7bbfdba8', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '448200a23b276cf080ec864c3754b42892bdad97', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: '589ae9bdda56200ea8e8a1ec32b2c9c825b8265a', class: "hk-dot" }, index.h("slot", { key: '757282d19b32f111f2388f397eb9bbc8131a5172', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'c6bf08da58280579ce4b53815fb28ae61127a37b', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '6b6cb09ea1bfc45772d436855ff0997e5b6eb8bd', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '0c7ae32d7101e2d1e60db7e417d43faad8f0dc9d', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'ec7a86f6cbe1b450f90dc90b03661c2396bacf3e', class: `ir-alert-header` }, index.h("p", { key: 'b9fb398539a33f571370e1550b47566564fd07d4' }, this.modalTitle))), index.h("div", { key: 'dcda8d2aec1ab828574624d4892a1aaec47b8c6b', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '22246b657db50ffce4608f35775f9332f4971ba9' }, this.modalBody)), index.h("div", { key: '085dce2bdaeaede84eb96aea41840db20f88dc79', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '0e4b89efb1d183391034b18185eb5889af793526', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '1a3cc1c425db686a991ddc1ea2ef6570bfa65f28', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '73263cdc2093fae0ccd1765ef18d91990f95ed02', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fce75e004ec0082a8aded812b030904c493e482e' }, index.h("span", { key: 'c6ed1e2a575b0baf7b0cdc49270cab9ab60100cd', class: "new-badge" }, "new")));
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '9ccf64db8e40a1288558b714db1e39269e77eb8a', class: "input-group" }, index.h("label", { key: 'f02937eb57c7106f5bc40e4d80123d355589c272', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '024360358832275c5ee521b0c2fd7fe481ef4283' }, this.label), index.h("input", { key: 'ea15d68f9820007b65e256404a974f21ea429065', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: 'f4bc13d15cbebcca325407dc3ebd92170a4ae47e', class: "checkmark" }))));
    }
    static get watchers() { return {
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '88f2da99588d77510a5fec8e755027b8f63ef6fb', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: 'bd667c01d61e163ae5439a42a435f749c172733c', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: 'c43ad299e94b3d8f60d9de8f3a2e139e53f6311b', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a431c558f77e2af3ee1a0042883c34ed73e714c9', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'cc605bfc848ff5f41714cf61d25c989fadae4b84', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '848b8aac665d054471079d412fce23d0a180d7d5' }, index.h("form", { key: 'ae088212e35477fbafd44b13096f2153fe43761b', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: 'fe48b6a04f84715ada0d824b55c9158328a8c2de', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '22d541ded6eeb17dd413fe7b17fd085b9bcb6138', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'ceebb55957fb5afdfc99a47d2621f5a702b7d7cd', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '8403913fa4fa286f2ea9d2e61a6b78dc753e9ddb', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '58be8c8571dcb6dc646ac25bb73cf3ef78aba52d', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '04863ef70528786f37a5a48c03c1e41b3802b5e2', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: 'fb86a1d6222622afe477a582171a12ee2c170c24', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '578d58a8d64b0fae83ac00c9e06dcf7d9f7d1310', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: 'c2c9bbae90369c0b8a437199ca5d10c9b4fb4617', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '29583a3547447db577617333a11673ef32d814b6' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
