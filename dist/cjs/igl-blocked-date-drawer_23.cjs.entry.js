...
const events_service = require('./events.service-58fc13c6.js');
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fce7ef3c830a91df2611e05d072203651f129e32', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '9fe4d738c87cbe5a5ed6eea886a113da64591335', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '2409838603b5adcdd34a708484bb52416bd449f5', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '6fbc14bf82f784f65c846dbcaac4a129cf0e71ea', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: 'b8392fb1ce96460deaae342d3ca51a508c577238', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '09d982e0a20d5a3e5840bfe17adaa4c83f3b10b6', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '70a993df08c4175e914088d3f4d8bfa850fe216b', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '9096fc305dddea521732d07ffeab0b8c67736d1e' }, index.h("div", { key: '0f4e5619e63234a42452ffd27ef1bba0c2db1ea9', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '5c8f639a3d58be064a2dde069c24a7896a94e18e', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cd2e5f3a60259117ad19a10152124d14d6d200ed' }, index.h("ir-drawer", { key: '70b1b867abffd6635d397b72d3862fc9b16f9f8b', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: '3b20f468b45e210ffe553fc2b3d5322ed0042e1f', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: 'd982c48ea303babb4baf98c48397c6dab99a4eaf', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: '2c8b4a833844689d387539c2c8815c000b5bbea0', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '449fe1c898dd038c629d252697714a7e1a993514', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: 'a4bd34df6845a787be10036b04f2af4fa6571fe9', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '6c72de8395848c662557f1ab9aac2b22ef85b1d5', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: '2e06a3211e20bef7bd6d1a05c6af8185592178bf', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: '8633bb19de41ed773c8d1d15f0227d7e8574a8a2', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '6d2b7d2f79a9f399cfbc5cac74f7d89486b33164', size: "medium", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '71b379deba17145ee4a480f0caf49abbd7c80883', loading: this.isLoading, type: "submit", form: formId, size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f67412e0f90b1d56c93fb61755cf95e0c330587b' }, index.h("div", { key: 'eb0cb63905894e0eb1c823a2e20dd18a345389a5', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '14e13082649333d6162a2463a0272802fab4c419', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: 'a86ab68f5d30a22414f7fbeefafdca0cc818450f', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: '5b1cf97111c36f285fc892e4f151e36d22df8838', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '24d119e080ee9992b0b0ed3d613fc37a6eefe9fa', class: "footerContainer" }, index.h("div", { key: '8f9a416eead5eb4e031245fc2d78f6daa241ba4a', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '3a709258733cbea29ae9c12924fa5b4cc9117877', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '8813ad368d70581e6868898c3d46c1b061d25802' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '1a928a88eef31127ae68f1a8d3dfb714d1af1068' }, "v1.4"), index.h("ir-new-badge", { key: '12d61939c5f837a7ff7a9621e7fc241461fad41b', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '32b27acf9eb88c21dcd543e57e96a804eea35e4e' }, index.h("div", { key: '492f0568c448934d431f98340c24d555ad677b63', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '08b5d92d5c07a257950db8e87364dec6077e49cd', class: "header__fd-actions" }, index.h("div", { key: 'c28c98ce5f65b468db4b1f2554f2d480e9b933e8', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: '1d9ca104973bdac2ce6345848a8d5b31a7d84e4b' }, index.h("wa-tooltip", { key: '7c4f3c9c96a534914d3a89156039f043e0bc5de0', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '6be38b4a24a25780e14416e5f466aaf22cf7ec0c', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '42cca0caeb2df603fdb54335d2c1d078c3984e47', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: '345d473398ba869614f6df85935bd8632ea7544b', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '8a1928514e8411d9672545f2b1e4d0aeb4b518b4', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: '50f867d485426f024fe30a395e45bcf8b2354855', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: 'c22cb02349ba072749090de514d10c896a3a4bfa', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '3d698e7814cdcbeebd162311901baf0d082f6af2', class: "fd-dates__actions" }, index.h("wa-divider", { key: '24c13450444e2bf0e1cb7344f9b1906edec5ad7e' }), index.h("ir-custom-button", { key: '510ca821fbf31137a7fc0eaed43ce6a061bc1fdd', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.closeDatePicker();
            } }, "Today"))), index.h(index.Fragment, { key: 'db4c97baab5900ac7044e852902e3957e51e019b' }, index.h("wa-tooltip", { key: '29d846667136b83abe33347380a176956c3d38b4', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: 'd536b5cedb7697d07e55eab66c2018bb5deb26a0', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'daa2762d8a59ad917f174d3279806a12ad7b5d73', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '58e3bdc237e069a22a1e0469d9d3f903b2290c9a' }, index.h("wa-tooltip", { key: '4c052df8819000d90295cf4d4de2b753b7e38545', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: '803817165c85e994ec12b15134120d2745de1ef2', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'e4e70f40684e2119f3a5f813138208ef2cc2cfb6', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: '5143b50b61b590cdddec571db355218d2b8316d0', class: "searchContiner" }, index.h("ir-picker", { key: '2d7a40232d19b79ccc319aac6c10c064533c0ed9', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: 'a4c25e665ccaec1dc5c6087eafb062265987567b', class: "stickyCell headersContainer" }, index.h("div", { key: 'e30a90c127256c4b809c852127508d3e56043bbb', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '1c275210cc7cffe57dda7d063f93fae77cdf7471', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: 'afb65742e9e36aaf4d807f1f51b827acc97fbe21', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: 'b032b5cda345d071c21f6091abc7ccda05c0e2aa', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: '2950f03d12ebf96b99ff864d4d223f4711c5da5e', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '02bf0a8f26a35be30cc6eafe213673590648b0d7', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: 'bb21e60937984a08c7f9e1d2dd32049a4910059b', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: '0f62d72dbdd7a897984dc216b0c2f75427d057b3', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c28affff08d62282406a3ce7ed08a7abb49c2edc', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '98c2af34d6009b3966a96d57c7c18c60a6301dcb', value: "hk-toggle-clean-dirty", size: "medium", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: '4124f6ddc67ea6f5a315af5557d03d95b4deb55e', value: "hk-clean-inspect", size: "medium", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dd1f9cc819b79c245fa077182d917b9e3283ed51', class: "legendContainer text-left" }, index.h("div", { key: '3aceec04487d75cb7d48df71c0857208009358e8', class: "fd-legend__header" }, index.h("h2", { key: 'ad51361d5076c6329b75b3dc78e4b473dfaa7892', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '8e113f3cd5c8c97110c86d4b6e5ea8164dece37a', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'c8de9c241e921ba25f0a7d4dfc3ab2e012e27e23', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '852221d005ccee4e695e6e04b7c7fceb2c552bf7', class: "fd-legend__body" }, index.h("div", { key: 'ab90245338e5babd226d17c3c3c56373cf903573' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '487df3f922286c69538e8c53a632fc6e5b31da38', class: "fd-legend__row" }, index.h("div", { key: 'd7f826fe2140af93b90f80b461d130b740a06ed0', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '404bc51c390249d65f8caed8d5fec7386b6a6e66', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '83c1763c3db208100d047c93bd9f19c6e75dab09', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: '27c515007b5d4cdd944723eb870c604f7faffe81' }), index.h("h5", { key: '5abe938ae2da8be16666524b07d37077d96e2222', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: '88e80e2a5dc05c62e4dc6be9d6826edc0d405662' }), index.h("div", { key: '37e5fb52ac063ce6ddec969343753f8ab28c13f6' }, index.h("div", { key: 'd558d358173d5c8cf33aa7faf76d3aabee172f96', class: "legendCalendar" }, index.h("div", { key: '2d37ffe93792d5c7678ea007a11322cd70048c78', class: "legendRow align-items-center" }, index.h("div", { key: '35ebe9e4a45d587d3d372e541f9f76fce78354d7', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '9ddec4ed847cfd81b2aa961aa2e45061cc9fa5ba' }, "MAR 2022")), index.h("div", { key: '59c03d7e3ef7d6597b5903b23fae9ae1ff7ed273', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '2e92141a42489b23185ee238d544eeb1f67ac3b1', class: "legendRow" }, index.h("div", { key: '3aaface69715825b03801e031349939ae1eb3560', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: 'f3d6c7e4e22d918a28286b6329c8e116dce164eb', pill: true }, "3")), index.h("div", { key: 'b2559fbb653407b5a6136c46c27593a21bbcba3e', class: "hyphenLegend" }, index.h("div", { key: '5c6be64c259bfc9cd142edae17d7031c8472a201' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '374a2dd136eb0e00deb625d84cb8871db1a723ba', class: "legendRow" }, index.h("div", { key: 'dc5c28c0156497874846da13c4453be6df5fc975', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'ac91344e1bd93a0e96a206ce9c31fd12d8c727cc', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '2d77e55c260a0b5166a6b061802ec5f4c87e49e7', class: "legendRow" }, index.h("div", { key: '6e9e50a8961d76b69c8bd522008ef6e1d500d3aa', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'f40868d744d7cbc47603894487de6e17edc30aff', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '31aad3b375fcd4bd369cb6816272806a8b467f63', class: "legendRow" }, index.h("div", { key: '906e39acce49bbde2d17fd1e1a7b756be5948b42', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '87b710826f52626cece5969034897eef0fd8b7d8', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        // ></ir-select>
        index.h("wa-select", { key: '41f4bad6cb9016688aa92de8caf08c8a16b23d6d', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '2f9a48635dc1bb13587d3622b852dd85693f7ce0', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'bcd9883d1b0c390f4547c85bc9c76ab9dd3df672', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '39b77ab4f763f560db70e59b183cbbd60fa767a7', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: 'bad0b36a000068e2e9a99fe7e9af4c595fc1f9c9', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '9a0cb1b30e6c55d542777be6637133d2d0b94549', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '92be85365118ab6b1c1a40e6d5eef848d8c5bb36', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '0cc29bb9a0153acb9dfeaefb46445e522954566e', class: "px-1 sheet-body" }, index.h("div", { key: 'f535fce9e273e01b59655a5b0d05f99756411715', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'cbd7edbc09044ea72c0825fe865c439f84da28a1' }, index.h("ir-date-view", { key: '8666a0892b94174d712f80ba93160a383ff5478e', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: 'c354aafe956ca6049cf7df0d287fc35b70d567a7', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: 'bd17e376625c1a1d7042e9ede3bb457260388e88', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'f664696a13b8f211419cd6c9624b78f69c0f7eec' }, "From:"), index.h("ir-date-picker", { key: '5199a69a7e714652c9581539435607ff5af37d43', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '22a16a4744fc4fb3178af44b00eb61b276c40b76', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '9214676bec7aeda744219df0c24c392cf39c447f', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '6a37ecaa0b8a1e282d9eb09053f2738c06504d49', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '1999fbf722273dfcd1bd9691060dd782aea6ec4e', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '526a417a416ff194ca3f2ce8a8b870e60a47e4b6', class: 'sheet-footer' }, index.h("ir-button", { key: 'ac12925e11c018c8e3197a99a3af75704fcdcc5b', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '5b31552b1414169d0c7caa11ca9ba55049cb7091', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5e95872e8b36f81efcb0bf8c517f75ec69994a6a' }, index.h("div", { key: 'b9ed71205618e58052255448d9e4a70c3d8dea0a', class: "sectionContainer" }, index.h("div", { key: 'c503c6208bbaa2c7ab1f77c7bd01d0031e7daa39', class: "font-weight-bold font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3082d14c0737ca5731a86a0695c562baa79adaf2', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '0e5c715341c360c6c214ff1391a073e2c605e2a4', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: '39e7a256a9aaa3cbe03347d21d6586537a8f7074', for: this.titleId, placement: "top" }, title)), index.h("span", { key: 'd94d2cbf8db75d0f4f9107372c63647559a21d6d', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: 'b2f130f449c04bb70bbb41b2ef5b570f5e57b40c', class: "hk-dot" }, index.h("slot", { key: 'ad84ac0996ef5d1d49311cc2404987a114f6db33', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '966e2c301ce531554d6ba0081bae0ecf2f3ab10e', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '399a77a6157af9a0ea63c5de6b5c2e9d13104929', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'a93f8398b49c06c42621402e57bb180a3f8c3659', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '5666b1a6f1b5b9421adfe4542b2147fd03ce70a6', class: `ir-alert-header` }, index.h("p", { key: '4e92f1198e64a5e89d41efa3ff5ebd53f77d00a7' }, this.modalTitle))), index.h("div", { key: '7c5b922ea60fb433af204491592100be0266d85c', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '040a59ff090b03131978c48050bc4f40b9a58c7d' }, this.modalBody)), index.h("div", { key: 'dd52ce1b258f1241384153ea48edc8b3819f7e72', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: 'c30a6a1e624f0505b3589d6d1eeff2d981518eb9', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: 'c2147ad857b5c13db644f69a130a3867d6a7394c', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'd3ab60c148124e833e192f1edf44823252c86883', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2f2fdb6e7ad9622ed6569e11cceffb7815378c58' }, index.h("span", { key: '5109b25161204c177e7942c926e715363078bc56', class: "new-badge" }, "new")));
    }
};
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: '7c7eaafa9846a5532202edde03440474526b561a', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '73796dc768b60b916ef879135de35e94cfc0697f', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '81425a2273bd28f5ed0be27ebfa92fff1216c1c5', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'a2d433e2876707162ff50647bb77b714c8511875', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'a203a883e444fcabbd6324d8e2b4be4685e344d9', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '00b100d32abb9009dcf173afa600dce7bf93b25d' }, index.h("span", { key: 'b02f57577ed7ff7b6b57eb7c38e714373ba001b8', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'd30f856e6a54f07f30903c733a48cbc0d517d1b1', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '987fb4d5e6986063b5579fe29502bb3de8a94ccf', class: "input-group" }, index.h("label", { key: 'e7d956e4c060d3e37a6ba501bb9e65b640356bd8', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: 'e13f2cfca1d9a94d23a7d5b5ef61289c6bd6b089' }, this.label), index.h("input", { key: 'a4a97ea4694243fca47b6481791ee91c1838d0e9', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '303a9f69dd453b71a4f94287f102aff077a3dd79', class: "checkmark" }))));
    }
    static get watchers() { return {
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '2bac1287a96f840badaef2aea5e2e3dbe114b5e2', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: 'c0e33e11f02d545ad3d6d130a7b5249a0723231c', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '55fcfa34b5a597dd63382e6c30b8a6c6802a7a49', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'e1c90f694ba9327a8213ba368b190e9eca2582dd', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '951370d5b77cbd20b78d4ca42dd8cf3c0c0ff201', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6a327b1b15d4b187969e9f11544e2d6c0cff4979' }, index.h("form", { key: '224c78e30cd231fd6216ccc5a7a1288f4a759d6c', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '0df5842e15a3dcde0410c7d6bc668e8a292fe6e1', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: 'e9f0ac2b5b168ce72f066d88d768980418f98ffb', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: '5112fe3d397adb5da8b046bcc158f5a595c894e2', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: 'f6502e448776157fb1d22d900672aeb7c9f24d4d', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '00180d48d6666d1f6bffd3f82f2d318d0186c04b', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: 'a67037aafd895fc0233fe52fe4f5b854efab76ae', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: 'df18fbb07be3ff81ec08f1f2f94a56754e8391f3', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: 'df28a87fafaeb15924d10441f1e7c496ddccbb13', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: 'f4e40c3b2d9501ad4611328b95b74583cd3733de', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cdea644ab2ac3a73ba3503b720bfa45226b44e32' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
