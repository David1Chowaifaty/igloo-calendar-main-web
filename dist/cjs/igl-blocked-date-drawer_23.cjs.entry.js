...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'ac5810101b5aaa44c54633d2b56f72caf2535ca1', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: 'f94b14d8ea6c16c4741bab26f72bbb6276537fd5', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: 'e5dd373ea4e6491a579e6352b861a2ebac924132', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'c68a6860928c851790786c4d6a2a06fe863523eb', "data-drawer": "close", size: "medium", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '7db925e8e641d2079f0739bc1317cd5f1ddfb3f6', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9efb6a24cacb84c88af6769dbf5d3a6249152b81', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: 'b46eee2d9ce70568ed9d706d32680032c8628741', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: 'a38f7e3065349574b22fc9673bd82adea412665c', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '557ab8ef7e4f4bee95482385c350467d367604f9', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '83ac477a011aafbb75e0f83e9f86f54472b9ab1a', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: 'bba557a0c6d79b0ffd83f7a34dd1387c7e056864', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: 'e9b88e586a68923e5276629f295a6432771f7e7e', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'a73167999abe8f6f2ee4397c23f3a502111588e2' }, index.h("div", { key: '3435c9fd2657f1b5024661df746b76dc02a9028a', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'da8d28ea31e7b917127c1521bcaa6c2697f6eef3', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '642dacec53ba75f3686ccb8d0ec3ae6b447fa8fe' }, index.h("ir-drawer", { key: '9bf072dc81a7c92534595ffb8b6545075b0d44b2', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: '0e72f06e4e22cbfb137b08bbdd53a3ef66005546', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: '9e650397a8b9853b357766066e2465f5cbcfc4c6', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: '70efe9716afda6bd7674e5eda9ae44097d2997c5', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '2f06f6ef92ab6995a657d568cfb2c361753122ba', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: 'ff067fdf7099caacb120972ee8fe974ca59c3914', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '9e6181ca8c2b7995fb4e3a0a0fa2687ca15a6ebb', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: '911f42da8aff3f36817359f419bc5e34d02ca4d0', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: 'a0216efca2af84690395ceb51ffb0efa3205561f', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'ca9540a46a2e8066e594d1f6b8eb15a3105a09d8', size: "medium", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '7d2e669ef6b46c1ad9001f4659a16d297f709bb0', loading: this.isLoading, type: "submit", form: formId, size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd1cfeb30121fa85b804021687d6c0485dc368323' }, index.h("div", { key: 'fae81232ea7db02aa9fbd9417515bbc1e2375beb', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '86366d304114bcfd6c8fcdbde264c8787d5cf85f', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: '1936e96f0f155566e38e4fb12e2fc77a5767dd8a', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: '69009fa920e6bf754853d47272a2f9422fa9e900', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '114fe4a24ea0b1f3c082e9f38376c08b5113214b', class: "footerContainer" }, index.h("div", { key: 'ec8862576763e74f933fc2aa72cb60d1971bc15b', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '9d54416f4538dc7398a1737d3493ef5d12995236', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '2dfd3af2d25990a13d7bf8b5d8afa375f1a05b8f' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '5b8920beeee8df717fefdeeede99449679d741b6' }, "v1.4"), index.h("ir-new-badge", { key: '1d63900b44480d9bc441cd82f87d3b9f3dc75ac1', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7a154d9e6860066ead3410246792545d67f2b94d' }, index.h("div", { key: '779ed592871af93710e30fee19ed1cb1c67131f3', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '7d2ed0c5016f446e86b99743ccbccdd2aa404022', class: "header__fd-actions" }, index.h("div", { key: '432076ef500dc1494b1e3f27d7809279c904f9ee', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: 'd8232a1c7f2ba9d11836f3189b3b02c41ef11c9d' }, index.h("wa-tooltip", { key: '0a3d09e00150326a15095b53f68bd9c27979b94e', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '9cb22ccf6daf91f67a79fa2666cb6022a1165dde', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: 'af808158647829869fe54bfb80a4c68d98d34b1a', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: 'f642e9ded1902b06563c184004a9d61063b5cc63', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '4137b223c42567055f00a954ae4ed6ee41d38d46', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: 'dc99cfc31ed357989d8c10b303a6aa98bf4bf33c', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '07deb53ae620a538664f9b1a8250acbb51285f80', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: 'fc53ff2b35c66814ce297a38426363f1ffa5be49', class: "fd-dates__actions" }, index.h("wa-divider", { key: '71f7b226cb61a48065765d6b267b3ad9950487ff' }), index.h("ir-custom-button", { key: '5535ac9c1c744782ebbf952e5dc77a29dfb99952', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), index.h(index.Fragment, { key: '1cbe82130b0b5440cd04e8bee4074d7a8ca9b68f' }, index.h("wa-tooltip", { key: 'd7fd76219f2cb5cae5b62f89baca9392ae337751', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: 'ca69b056aefd667229541f2af204510e0d065f92', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'ddb00463212ef53e64fb92f322fb2c6982752a32', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: 'd0ba93705a92061adbaece4202c4b89ef0fe74c3' }, index.h("wa-tooltip", { key: 'b26e036a6daabc937be44e27c78841a9372c2100', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: '6186570406a52309f33ca095a402c9f5d55d133f', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: '9ec4074f889b954f443e1da4d64d29a10013774b', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: 'f419c903a3b0986346ea220b4afe0d4b2e0e904c', class: "searchContiner" }, index.h("ir-picker", { key: '7f6380ea5d33610ee7baf2ebb06a62c2d75a918e', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: 'be696baa2b3b9e94280abd902b94e0b8b4992d00', class: "stickyCell headersContainer" }, index.h("div", { key: '18ba2d5c010657799dfcf9b2ac000a97b604e234', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'a2b22bb414f16581f9a0a523295d14b8ee8bf404', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '36e2b65da10123f4acf5a1331b9ac3e3839a0fde', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: 'b141d6003d3f4ba9f46a771aead5e19bfd595650', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: 'f9b73336d6269980f1112ccca965fc19dc4d811c', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '48ee0639eeddddebee6232a273965dc3adc0f283', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: 'f6092bf916ad64c95547a82e84ad01b89b8f6cf4', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: '203a7f8a158a107535bc7e46108ea7dc573a15b6', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '5ac518c317e98357933ec4e6d6d23f872131b3fa', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '9162e13e5a701f7c9a3d2e545ba50846cf9de8ff', value: "hk-toggle-clean-dirty", size: "medium", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: '44fabde67b575190c09637328d23c5c9c78bf9c4', value: "hk-clean-inspect", size: "medium", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c1120ffc983f3438773857fdedf179f07cb01a5f', class: "legendContainer text-left" }, index.h("div", { key: '906e660f23ed36cefc0d0dbfddf0afd3030095af', class: "fd-legend__header" }, index.h("h2", { key: '2dde875fb94d6132264200626598f0f7aecf0c06', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: 'ff772d893f3c134a0752ebbb83b115bae673b7ca', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'baad7870d335fbca59ea52f8118d989f95a0ae00', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: 'f15d1a5dee1028327065d4a9d638119621dd8d40', class: "fd-legend__body" }, index.h("div", { key: '21fa8a11b1178510cf777bd7b974495829c6920c' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '697dd81bfce2bae886454069bc1dfaaffe0c4a28', class: "fd-legend__row" }, index.h("div", { key: '85d63b30009a525093022242519d68dd6edcaaa7', class: 'fd-legend__shape' }, index.h("wa-icon", { key: 'a6827f4a325042fd53d9ee95c40eeb0f1db9c02c', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: 'ab56cad81e25fdc114a21b029d94f09c179882e0', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: '16175bf4098081cbd7b7add8c711cc5df306945e' }), index.h("h5", { key: 'bb5d1c4b8b589a65c3729490b964135f2c9672e3', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: '89cdca77cb44b75dfe0dc41bef5881e8b5705122' }), index.h("div", { key: 'a0900210509e8fb321ee093a6ddc52f1838a8263' }, index.h("div", { key: '4b68b582e5213864e69d44c7ff47106b8c091352', class: "legendCalendar" }, index.h("div", { key: '1c9af768f0de89094dc6619e3ea4282539f10505', class: "legendRow align-items-center" }, index.h("div", { key: '84884c66ce01d343bff2af5a51d0db53f83fd803', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'b9f600d1c89dbb3480415487a260940d354fc425' }, "MAR 2022")), index.h("div", { key: '1f7021e3f105634f5106ec1028bc6c594b3d98f2', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'cc9b8bf1599fed13c4a961e110607fe436f036f8', class: "legendRow" }, index.h("div", { key: '805065954ddfcc96526ef8c299cb8b32bf21c283', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '6cd3500c789eb192545dabeeec4dc92dc9d70699', pill: true }, "3")), index.h("div", { key: 'b90b4d32df6e84b360ca4681585aa24112251aea', class: "hyphenLegend" }, index.h("div", { key: '0484d9caccd7890ad0c058e6877fa88cf0c23d35' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '98e8420b9c5991ef17728d156c9db909f2c98ccc', class: "legendRow" }, index.h("div", { key: '81a915603f731d0544cddc56853417f08ac4dbde', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'a223a01ae5a10800470229a9794f22c6d3331d85', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '51d0eb2c10f4b26941713348ae9667187516bdd3', class: "legendRow" }, index.h("div", { key: 'ffc77080484c33e30e4602e8372d9bdb3d877f13', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '83214df1a48a231168e846de60e6ca6376ea6eeb', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'c02c92e20f3b6f23b977f90c3f14890e41f8678b', class: "legendRow" }, index.h("div", { key: '3d31c65b5d6ae47ba425f17c1012defbc678a150', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '73875cc47f0ef75c63987a9b70c2d62aa6c1bb7d', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'a44261fd72b20c2dc78447a59c90a4cca1ea6602', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: '0df73f46d76743dc54913a5cd43c7291adb1cc43', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            ...
            } })), index.h("div", { key: '2d918052047ea364a43ed12fa6dbdc1c3f90afae', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'bf3ad47f06b62a70fc98f2c108181087ef084819', size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '50c3ed0de8f1f88fa2ca4afd6e1d3f186b51bbff', loading: this.isLoading, disabled: !this.hasInventory, size: "medium", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '4d2d81c365046f5a8dd820bdf11275e2e2c09496', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: 'b595b70401e5aa6f9c5675a1e294bbd42bf5242f' }, index.h("div", { key: '39c74bcfcfd971ac38e9521991bc1d92cafb55cd', class: "dialog-body" }, index.h("p", { key: 'd14125b5b908a285978a94be47fbf7045ccb97c5', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '97231ae388caf314f161be0b9d752b656a136b63', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '544526e1e74381e1e9b6545e9acb19ad2394965f', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '9c194a88f17bc0d2f9a7d0761eadbd639067809c', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '5f882c0a21ae470a14aa772497e931e505aa8622', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: '6fe92d9e0076d31a7c462d98a54f11c3de7e33b4', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: 'e3193c9159389a7fdb93bd16e868b9ad52f4e624', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '0c823495592d799940fdf8a62be4046f4192e256', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: 'fc9ca9e0d9112ea2b923bf2e62f0320f2c4a0800', class: "px-1 sheet-body" }, index.h("div", { key: '234aad9577dc8ace78847b80857dcb868440101e', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '7aa556d3bdaa083898603decab5853a155a99f5a' }, index.h("ir-date-view", { key: 'a9cd4fc4ef9c0ef37a4298912828fc75f44fbc2c', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '1813b1882af880b929683a66d63817d026edde4a', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: 'c23c5f42a6ed2efbd066856f336abc679555dda9', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'f172249dd61b93cedd5b8e6534e796b70d6f435e' }, "From:"), index.h("ir-date-picker", { key: 'd300f6b618b0bde6d5790b439ce8752ec23270b2', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '0fb5a4314526a92f1577571fe04725c50411f0a9', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '5b5a30be806d9363ce81a745d2ea6575cac895bd', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '5e30d8601630f2ff9ce01234e2cac23848ce4e32', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '932d50d9f3696e0ea9513a29c274471f4d195b35', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '0eb7ead1f6946190bb2a17d8ca7c4678fede9e74', class: 'sheet-footer' }, index.h("ir-button", { key: 'f547ac019c0c53a9e7395092d99988782b59a7ad', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '6f9acf6ef8ea7b202f7da2307edcedf1dd6a5a4d', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '673cdde0c79a509115868985a127ac376e86c0b1' }, index.h("div", { key: 'b28e08ab6c481f61f136a4a27acd7aa4efa63baf', class: "tba-category" }, index.h("h5", { key: 'f0a6c43988ee9ea0f99477546f5c4a13206fb0aa', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '525cf4793b25facfe26a75fc0a896104658d853f' }, index.h("div", { key: '466007f2c9622d9d4ef1547503bb35df63488c9d', class: "tba-panel" }, index.h("div", { key: 'a169e5eb02c96b501cb1abad3aea0f949f4fb1fc', class: "tba-panel__head" }, index.h("header", { key: '704839d86300193153f8b865554c8e7d3a4ccd6f', class: "tba-panel__header" }, index.h("h2", { key: '74d457f21f1a9a5a258e5650ef899e69a5567e57', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: '80003d0a9e4b48b5d5c9ea8b39b1afa636fc4456', size: "medium", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: '313ebaa365b82a6651d07bf5802be004492836be', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: 'ced76ac503855df6bfcadfdc89e0b6d4c73d7a05', class: "tba-panel__toolbar" }, index.h("wa-select", { key: '495e42c33a4d8484d728b27e6e85e1f830565d2d', size: "small", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: 'cd9e79aeaa010958194549abf4ffe32897bb077a', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bbdf2070902b4e469a8873cf3a707bc771f14c1f', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'e490e7198950ce761bfe8ea7cae198bae54739b3', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: 'c6b8c39156636b04ccef3e8baac2dd908521e51d', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '718b52c748a8368db28d1f0901f7bfaad38b6610', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: 'db6b885511319aa9bed7e688f83220b8e6a2b86e', class: "hk-dot" }, index.h("slot", { key: '224c7ef60083fbe4e8218bbcf2190d28937232cf', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '53318e77801bb5bb1f14eb699bb591b25650fdc0', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '926f8522d39220e3163eef6fcfc1326806f86f63', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'b4d9cd031e0025476885ad9faf9e7f602dcc823f', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '8adfd17f7fafef5c559aa5c2af8c036d66a0e91e', class: `ir-alert-header` }, index.h("p", { key: 'be87b314f77f69fca4e6ecce41d7d10edd800c24' }, this.modalTitle))), index.h("div", { key: '5c70e90800dcf6a2136d95c902e3373ee1d90543', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '13b1946e9d1a96a39c7c344f3ee119492586e1be' }, this.modalBody)), index.h("div", { key: '42d7fb56daf0ecf807f83513741faec53591b1f4', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '5f875a68faef07a35867789da0eea9899fc7354c', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '9f08fd054798fb7baf62f2aca3ec2c7f7f75d801', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'e3017257a7fca47a8fe6a122e031711f3d821588', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e8814838b48336131e24d27a597322dd57a8d321' }, index.h("span", { key: 'b5bef436c178ee58b92cde0412f2a8165af6c468', class: "new-badge" }, "new")));
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: 'f18824943d18925221496b1a7fad37062605d6c8', class: "input-group" }, index.h("label", { key: '2cc4c4330af64686c07971285982af861671867e', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '7dace345031fc4b45e94f92b99b5c03295584c59' }, this.label), index.h("input", { key: 'aece65b433526f91d81e8167f8014add7a0bdcc8', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: 'ba8377fa7f86a1fa794508124200fe3523979f85', class: "checkmark" }))));
    }
    static get watchers() { return {
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '1b30bc9ffc2d9d248e4481e25e5112d4fe9fc921', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '6401e992cfb8eae39d6edeaa3ac19d24107dd269', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '7af8e61af55f502ffec88f54dd6ecebc0d485591', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a3b85f388de094f3d8fcae6eb74ddcc9ea98cd3f', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '144b5bbe76e163ae9ff2c2da0ba7948f017cb1b3', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b7e146f426f9c5c6e1e1402121a69328f7beac43' }, index.h("form", { key: '36ae94b25ec92fadd202a7eef730cc1a07521b7d', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '54d91af154d2748ace61ffff49f060ec2327147d', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '590d2607e4cc2964a527171a2759eae26ca5cf24', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'e4c8b036f593ae7440fcab7c97e4078c4432b074', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '14db5f69f5860292189f193d8d9e8cab3ee402ba', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '26d136fe3e383cfed7bc0d62fd93d3fab0f656a3', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '6ef274da19108c419542556c9e13ede41489bbb5', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: 'd5726ccb71ece33bcbb0d1420ddaf4a67d4166f5', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: 'd131f8a2e0464a7e448371077bf944b82a28e7ac', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '8c191ebac7199ba2213cd693c58665d349c7e42e', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '709fc1c1f0831137252a7d54a93c813bc68b8a35' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
