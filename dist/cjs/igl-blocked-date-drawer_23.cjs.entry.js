...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '20cd299bc60110483a2d51c4657a861d95ddf154', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: 'ed8b5e06c73a24cf3c353e5a3fd991a80824e47f', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: 'e3b25bbf41f7a42f90f108f9bd7a0ff8f8d557a7', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '232fecac8070dbbc2bd874eeb3f4242d2ca3eef5', "data-drawer": "close", size: "medium", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '4d087759fdfac99c71b1b16eadc6cdfed8cbe2e0', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd563ea79ccb2831d797c9a34c71da9b072b4ed45', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '0dccd26822ec8ccbe64106da2d3a6e89d0aea30d', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '5f7a58313b99371bc7f0be517a2fda7637c5ca35', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '82b85aacd0efac70a62d71309b2ff214ef749923', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '4e3d58b59fdc5f3c5a9e680140e5660a6657a6f5', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: 'e9716188e6a4716d52449054b196d9cc1247e7c3', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '15900d8fcc3b4848c9b3f5a648f91506de7b1b4d', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '190f17c78fc640357468eafed802f5c3ac6acdd1' }, index.h("div", { key: 'd692de190f26d232019f782ac7fd5aa3285c70cd', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'f71b64703c2bd549aaac1ec1c9974da5235609bf', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '91879c76c2b872ccadd233cfc81f77382d301b62' }, index.h("ir-drawer", { key: 'db492945cb547c87bec83b8342279f93c27ce13d', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: 'cfcb1d77f98aa897624e91e8e425b02e245e5f8f', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: 'd9a4c3d23526dca30cbeadc3442948ca942378c2', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: 'b107d6218e8cc5743a2dcc07c7346da256f0e78a', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '0caadbab66e8772ccdf49777c23d1b82b8289fa9', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: '7d9d64f0b38c6a88c6f0524b2d5bd193d25e7107', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: 'fe6952c22bc9e5a5a433df250ceea2697f85b01f', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: '58b64348d2a864cc0c2521ea72cebdda8c7bc42a', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: 'c186d7680b7da4090376ee8793e445cedab2b3f0', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '7b1d3c0c41fe8fc12af95de08a541ee1b9e030e1', size: "medium", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '4575519e93ed92216ae605c9c0e69dcc875c1923', loading: this.isLoading, type: "submit", form: formId, size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '583e05fe39156f816043011e73144f851642f28d' }, index.h("div", { key: 'e69ab1fe9d2ec5b4a281d3a3b8f50e012162bb10', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'a0d059835c41fa18d3e49686eb3839063604cdf0', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: '8eaa7001979f3d200bb3dcddecdce9946896b00c', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: 'a2aa4777893e921e72a31331e65bbdc0088b0540', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8001f521d84b2beb2ed9ee75972ff8615083aa53', class: "footerContainer" }, index.h("div", { key: '4a54725d78fc2695a200e6b1c4c2ab09a79fa18b', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '02224947f963b26be6bb1fe9fbef9876fc9636a5', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '241f85d8f7c24d630fff24f1be8d640275764d30' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '8bd2730b0398ffed67171f6a7316d11b2d6f6703' }, "v1.4"), index.h("ir-new-badge", { key: 'edf04d4914f2fdb6ab9a9fdc81b3d67bbcc9ede4', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a9c4c29c4036fba59857a535d846704db76545ba' }, index.h("div", { key: '7afb72a686a60b469fcec6e16f96059f879f4c7d', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '1f7f03cc13a2e63af81ca95bfa1f34ec776e3f4a', class: "header__fd-actions" }, index.h("div", { key: 'b19e10f3a999723dbaae978c3c3ad08da74aca9d', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: '12d9a5dd6a225f34f76e9adb07ad6fe62e334047' }, index.h("wa-tooltip", { key: '1aa17b0f665aff0c9b524115b2266d1e4f28a445', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '0215242e13d867c20b7f789bfde75d82f96b9003', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '73753363382474e4afb73325a43cbf1b409d9339', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: '9d89a3441f4c445788aaff22babf3ce134c71e70', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '5945cfdcd0e8f8b1be6950b56add152354b17381', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: 'b032946185ecd76f4ef3de4eac5a6f485f4d3be1', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '59c2648b0bb9a10da1eedfed05d4297008a66048', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '941e459aece580190977ad4cc473622a23acebf9', class: "fd-dates__actions" }, index.h("wa-divider", { key: '15159fba3bf5a092b6542374f9861534d2a01240' }), index.h("ir-custom-button", { key: '799aa8f8e1556e95e672c6869518200e97e282f8', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.closeDatePicker();
            } }, "Today"))), index.h(index.Fragment, { key: '9de9b98c1345ac117015e8492da0181cf8e691ee' }, index.h("wa-tooltip", { key: '2da294eba7c15216af0417bc0e6f271074facfb8', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: '080a3b5d8e249bb5eeee5f35f29ecb856bd920d6', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: '8ca380da5f4602bd7da6cfa5b6c92d547106da98', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '585c29df4867411170ee8f76519188e1dfc6b3d9' }, index.h("wa-tooltip", { key: '8bd9fedf6569f8d142f369fdc643d5a12b043a06', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: 'd5ccfbf3eac41963011de84f0ab20507bfe021b3', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'e7d026ee5020638da037856781321b2cea93a9e3', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: '4ed6c49bd5dbe910bc231f3696fc726b8c758ff8', class: "searchContiner" }, index.h("ir-picker", { key: '086d53c2dae4b4162306085d9d9cb538b64190aa', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: '3935c52d96652b036f75e25ce5b8742eabbb30e5', class: "stickyCell headersContainer" }, index.h("div", { key: '1a4fd83ca0b4b8c356ae5ba53afb35ab7e0be4c2', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '3386235e47a4f4e2b21da63b644e1f66d9e0362d', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: 'be548bcc217b32d4a73156b40aff4d2672a6cd37', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: 'a53eb52c509c3b11999cb798810601d80ff67b3c', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: '38833c8c28716e9eb6cd296ee63208714cc1aa0a', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '81940964c7e7d0b1d4fa31157def5e1bbe58b6c9', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: 'df28b7a126f8f6e0eb69081483361fef080c0a83', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: '4b3bfe550a10f1285b868439479184e59a90fc18', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '9e96767f92574bb54f563f0a66a58cbbc61cccc2', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '60e4fb023f918c521ea43d7d3fa548897dc373db', value: "hk-toggle-clean-dirty", size: "medium", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: 'e4a14dc1cc71b72036c1fbb37789475ae21b1873', value: "hk-clean-inspect", size: "medium", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6226fd521925e701be553f21920e2b2390d790ba', class: "legendContainer text-left" }, index.h("div", { key: '6936f21d08bb1435e4d8219d27216427040dd029', class: "fd-legend__header" }, index.h("h2", { key: 'd6683d69897cf3f0aec8de5433d851df4a2938b0', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: 'c9ca2e0e01e2b28fff92353a5c9110cd703e4e18', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '1568f9dc3ab6d20a421e34a33c681d3038430d7c', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: 'a848c29e516a855d611a3783adc89e06348b2d1a', class: "fd-legend__body" }, index.h("div", { key: '922022d304176ce98ecf55fccde2f2ae0028dcda' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '6d270614d2dd67844f895c4d8d50d63da8d1004d', class: "fd-legend__row" }, index.h("div", { key: 'deb160cf5b72a6ee24d9fdf6301ad13fa0fe6091', class: 'fd-legend__shape' }, index.h("wa-icon", { key: 'ff97bae62f40027dbf82abfd0ccaa8c34a1a4d9c', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '844c2b0992ed32fb270f2cb7dc68134102de7c40', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: '2b415b1603db4a75b4398a19f10172d1f2ce0fc5' }), index.h("h5", { key: 'bb9b15b383e57900ecc5137e483b6c38080fe57e', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: '1d06e259408d371425d036cab75efbc080ffce8a' }), index.h("div", { key: 'e2c3670762d6f7b9b013cf5bf49fbc8555aa4f17' }, index.h("div", { key: '2cc7f88d4ddfec79a79c3c9a252d98dc05d339d0', class: "legendCalendar" }, index.h("div", { key: 'ab0e25005a953b91c7268f813afb789567d8edbc', class: "legendRow align-items-center" }, index.h("div", { key: 'ed70a27862ed9282c44542ebd5d9ad44632122e8', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'b38df8102adfa2876997e38ff03f7ce973390a2a' }, "MAR 2022")), index.h("div", { key: '6018035dc85aa67447f94a2aae155cd3ef88c358', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '5b26e18890f141df76dddc04bb40d9842ee8d779', class: "legendRow" }, index.h("div", { key: '04780f74db799da3417da12c529f617c5b426b80', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '3152699804ba8855369eb73c34219b98c1e693bf', pill: true }, "3")), index.h("div", { key: 'ab0116e0d585769d16b6730ef761295df2cbf5b6', class: "hyphenLegend" }, index.h("div", { key: '5e575407f5b12afe62259e6607d306c66233d02f' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '78d862c838d2c1e355eae7cc83a2441bf6a99d99', class: "legendRow" }, index.h("div", { key: 'c855c8d3aa0cee62b901e9e3e1c8cf2742cada83', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'ce4e2daf2b3e83ffa7e111e3ea157b0b96d262dd', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'cbf5b4bb3f88ce4bb35ea297fc37e2d24ce1ef50', class: "legendRow" }, index.h("div", { key: '62879edff8e72daf1d7d7e9cdb6a86cae4be5a1f', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '51161ab00a9543105934281a0c045075f6167921', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'ba2a5f1210ffa985b1f13379d97d9fd68879b5f6', class: "legendRow" }, index.h("div", { key: 'd34493286810e246f20a769c63f35b099ad28e73', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '4438f533a2e2108fb306010e523c874c7f7b9f72', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '31a47cb21a8f47aafced0579b67933eff06e50bf', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '82180680f274e5d8ac3554dd5d7805217126cd9e' }, index.h("div", { key: '398d44dba3433e39dba89cd2f9783cbe5bf4cf53', class: "dialog-body" }, index.h("p", { key: '9e410095cc01fe0b18c60bc7fc6719010daf97c0', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '3dce3001e65a98926144dcef924f9922f410ad72', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '0e17abc9da2c6be63f94130e011674589e2702e5', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '0fb4d983853fedd58625c8b1d6559828391b4e9d', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '77188149da21fde7f2d8be9bde2a66b130077d74', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: '63dcdc058dea9ae226e88e72fbe63da9bb835b65', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '01e13ea8f50fa180c4a211b1e4ad7e410b16e1e7', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '733ee3cbbf000d7bd7795ce803f1ab93529b8e1c', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '43c5da4d4906f3b588d81784a9237d02adaa331d', class: "px-1 sheet-body" }, index.h("div", { key: '9c05c6c1684e8cf00006d4cb20391605824c0905', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '47a6b82b640c2f4b722ace5c08a665af5ce213bf' }, index.h("ir-date-view", { key: '84bdb4a7278c17cd499edc4612c9b7fcb46cd597', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '0cb542d868fea5c6704f001b2104ad251e4c8293', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '0287b4b191a99e019121d0f134141034f0af42de', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: '7525349672b457185bb443fdddb63bbdad00c99a' }, "From:"), index.h("ir-date-picker", { key: 'b512ed451e016f52a9ca6d126c7520fd91c025b2', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '5a2aa9910bb4f5580b44bd03ec0d199221c064fe', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '1e2fc4af625981f0ea2cea43c73d28ec7fe6deb1', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '9ab149e9f532461b62c051d4666f28c6c0de26e9', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '35b74347f8baa9de5c852efe8205c0d1d7ca0afe', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '1d3df6c14895b31bacf88d6fa4f1c17be44f53d0', class: 'sheet-footer' }, index.h("ir-button", { key: 'bb363e0337a70abb54425845664faca74ae0ea2c', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '8a4a3a4e40e5b8187a34bf29aeca3b9f26dd21b6', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9ce9544ccebdbec39ee2cc4da1edb7620b241d6d' }, index.h("div", { key: 'bcfe58986356e025687234d49aec74f36ed6d15a', class: "sectionContainer" }, index.h("div", { key: 'd29b7093e8e73e040f85296442039acd01254c5b', class: "font-weight-bold font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fba255bd0e143990368e6b26fa75ff2a8b59597c', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'df9d2ac39582ae5fd3cc1699f72ce24b2a81bad6', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: '131acf15036bde90ba4d828db31013ecc0bad7ce', for: this.titleId, placement: "top" }, title)), index.h("span", { key: 'b567a8e5dc7a87be6e5e6f533a3eff98d3c4d699', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: '612f02915b03f271f6eb35aebd6832136128634d', class: "hk-dot" }, index.h("slot", { key: '17112b53af4e8d4a900fab9bab303ba9b86a2a08', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '0eeb19ba773594642d104f9319def138d11915f9', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '804223cd89b76e43a7dbc05d2a9933d26116539e', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '44affb22a3b669c148ca4deab37952511c65fb9e', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'ad0f7d241584d3392601b1236cf891bb1008a008', class: `ir-alert-header` }, index.h("p", { key: 'e1bdb8f7fed26dbeef23d6f44c46cdfc3590301c' }, this.modalTitle))), index.h("div", { key: '627dd7339d9b43eac51c5afa48523144873b882b', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'b001bde89b244de9ac3f906a6203b57654a7f013' }, this.modalBody)), index.h("div", { key: '59748eb9d240c1599f45e8172e28ae9708d4dcdb', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '705f0a391190ed5061d351715115b99dde4a5098', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: 'd2013724481bf58de5dd552ed18294440f38f3de', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '960acb24d7250aafd0400405739585ca0f3571e0', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9009293a94ed8f54f96e2fb4468d8da64c193a05' }, index.h("span", { key: '9e5ffed81d758beacbc57309c211be29dca90272', class: "new-badge" }, "new")));
    }
};
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: 'a1cdb6bc11c5b64088eecd93efc91d85efe1dd34', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: 'bc024db9ef7e638c12b668daca900245db545269', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '9b99a1dd016f541ac2f8093d58412405a8f6228c', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '0fc99e70af2110568c398783e8483eb445c6a1c7', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '95c779648c2d01465fcc60d749d137cc0c523b53', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '7ee3d1591370ffeddd1f80ca9fbb2542d72d52bf' }, index.h("span", { key: 'b47b79a290a89e196967b5a552fc9f957e13af39', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'a55b22c3c2ae8582d12108648711f96d7ab9067f', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: 'd2b98fc657268f474a38d4a08944ae15fec0c0b2', class: "input-group" }, index.h("label", { key: '9c4114b3c68d88756ac7358f7c3327bead8c7cb4', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: 'b23492a1f157ca6caadf435e33fb622e5491fa61' }, this.label), index.h("input", { key: '242e8aa05d8676b668a27007e085bdcbd098f9fb', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '43be8ad91c35bd2026a9b5887565f71e6673b75c', class: "checkmark" }))));
    }
    static get watchers() { return {
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'b05b27f9565a285a220fdc5a9b76a47a4f5b71a6', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: 'b4af0c976c917ce58488656fd07f3ed8ccbb3a05', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '445c0bf36a79e709e3904c72aebe8d7b74bdd425', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '9d153328b66acbc7bee234fc24dff15aeea905aa', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '8473ee22e59047e1f7403981860fa4f25a4c21d8', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '977ed1949c880e077f2ba2fe2ec314934db309de' }, index.h("form", { key: 'cd613d510f56f9630ab5c42347fa571c46ad8daf', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: 'e6f97815b7d54ebe185b66beaa56e5f1083e1c64', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: 'bc1f55d0265d697905f86bfed3049ee715750fd2', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'd19020a9ff43e222db27e11bbd77c6608c57505d', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '8631ed79f89f70838ef7763f2fc36f96286dd79e', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '1158bc74d71354ba4257c6c6079e01e54eb48ce9', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '9f4501298418520da2128ba6c6c66668d98c9915', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: '921b8f369f2f1144bffd12effbab97cef1178229', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '728c8ce07a737226d6c4a7982fbcfdf1e4eb122e', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-custom-date-picker", { key: '17fdd66ba0b405745d835038c4325578cf4daba6', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
        ...
        try {
            ...
            if (this.bookingEvent) {
                ...
                if (!moment.hooks(this.selectedRoom.to_date, 'YYYY-MM-DD').isBefore(moment.hooks(this.toDate, 'YYYY-MM-DD'))) {
                    ...
                    const amount = await this.fetchBookingAvailability(this.selectedRoom.to_date, moment.hooks(this.toDate, 'YYYY-MM-DD').format('YYYY-MM-DD'), this.selectedRoom.rateplan.id);
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2c7b5bc4a7cb54b2424447aad2737b91bc4dea6b' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
