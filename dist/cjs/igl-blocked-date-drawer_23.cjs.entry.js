...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'ef5baac285f0f9e0c3f41cd115d0f1c1708624f9', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: 'd4cbe750aef5576655d26c9a367657352a23c0fd', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            ...
            } })), index.h("div", { key: '51c07727defc40059e628c1d4232ad92d544c85a', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '3c2bbb8e1483f5050baad8456e2b72a85e7ae603', size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '6cf17e32027c590170dc55d3e748c7aa5a34eab9', loading: this.isLoading, disabled: !this.hasInventory, size: "medium", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '005ecab8ce4e78b6d225c3bfffb68f9bc7b28404' }, index.h("div", { key: '5bdcd65e2363ad5b2839cd3ad25cf9cecc69b435', class: "tba-category" }, index.h("h5", { key: '20d2ad12f93ffed3d148fc43fd1cb5bad5722100', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '176ade5de967afd371f9bc4df4a459953fef3201' }, index.h("div", { key: '295fdb91c54138e59a0f3fe1fcc0d2e84a35a498', class: "tba-panel" }, index.h("div", { key: '0588788b3410d0244f73592efb1aefd736aca580', class: "tba-panel__head" }, index.h("header", { key: 'b46846187b217904f8e84bdb7a29c9042c523c25', class: "tba-panel__header" }, index.h("h2", { key: 'c6d75debba75be031e83dd4379e3473f5e435443', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: 'a3b6d73e5428611714f45fdcff64c0b43b3c6593', size: "medium", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: '0a9858355eb6a9dd1524f41a0e625a44088430dc', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: '5b40f7425b2af5add23a10e4b107aae4683c9d0a', class: "tba-panel__toolbar" }, index.h("wa-select", { key: '81ac0b32f6b2ec50c28720536b58ae0da784dcfb', size: "small", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: '4b53485b899db5fbb170495f95060a1723b9f1be', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bae7765e0d8e4f18e707bd3f7467b0208ceb77c4', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '1d6d33c74b6e0fba5ed65baf4b8c0f356adfef0f', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: 'cef7b671cea94227ede875e0309fa3d48c82668b', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '03bc517dbe792b2f8ca425eb5b345fa414ee9451', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: '217bf1d83cb71429e9ca124fbb85cf72e13c1963', class: "hk-dot" }, index.h("slot", { key: 'a47d9a8e06702b6b72a2b78384385e582f4c5626', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '840084123fa60608d4fdfe203968e07b133b7ce6', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'f4a6dfb6f960e4e3f1c969f4e6f29038556cc9b6', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '57973106def1acddab1b1ba50a19b73316692311', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '5615dc20542089cb073cedbbc6d4d9ce090d349e', class: `ir-alert-header` }, index.h("p", { key: '2e879696926d5ac59a3599e1bd9919bd6f9b8d58' }, this.modalTitle))), index.h("div", { key: 'f23ebca9bb9baf29b22f73c3cb8b974ebf622597', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '09c5a1b4e2cbcb2a2e8602fc850bffffaa7e6e41' }, this.modalBody)), index.h("div", { key: 'd312d08cc2553305b0d14680991ff0dbea308884', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '14b1fd98566c7cceeac953a4ba400ecb3ba79cae', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: 'bc1966b8b7e0937d2a8b900c5f49048ff5aa090c', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '93a7639fee54632bfac0c91a52768d1a10bbc403', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b01d408f1f26696319c7a1ebb7578d14c0626fdf' }, index.h("span", { key: '2bf1f84f05ea1ba431fbfbe19e91bfa0524f31e8', class: "new-badge" }, "new")));
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '7cc9b062f9abf64cd66c60b8664e9a662c5561c8', class: "input-group" }, index.h("label", { key: 'edd4b2e6d4921d01a1c4ef9b21cabfd608e566e2', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '416ee71ead11c2574a34704cb301944d1a9f6be3' }, this.label), index.h("input", { key: '7c573b94981922738dde75d4dc15d20ab4fbd547', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '87f4fc087360afca552460d1613ae0fadb75b316', class: "checkmark" }))));
    }
    static get watchers() { return {
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'a28f293566efaece0617bea8e9dc5be8d16707e1', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '1ad3f95ad2c6f0d4c5209216eca3e5efdbea7654', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: 'efb2ecd8206eda2d0ed1c02325deaa103bbf18dd', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'e005f5934ab6198929f8091321a8a822a56d4559', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '0ac914fabd4d2e651fc0cf66068433eba5384957', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fe9928a516a0be4bfb49ffb8c996041bdd7f6c38' }, index.h("form", { key: '00f8f7ad0b2f2d1021bc8d89a151ffd9d778d776', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: 'a0a43bdd74ebc54e5669bdd441e7ade9bb5316d6', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: 'eb9a6a1cbaeb6f1eb381dfc16351c17e3a2acd1f', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: '7ae9348d8ef95c624e3f0f0cc9c004c036914c5d', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: 'c6d2a592db1c01dbdab38173773e9fddcae00a8c', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '73836d52ca8af6c3ffdcf92a210f416433606a14', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: 'd51a09ab225fd3887176eaef3c8f1bd2ce652b20', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '61f3af5e8d2a712ced8b0c85973660363ad0e538', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '7fca6e977bf3585f47f19a03b2c16cefdd9f5ffa', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: 'd4fd343b8613eba9fe20f937bb59413cceffa2f7', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '441dc30e4ce0dcdcb8361824a7dabb10e610d553' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
