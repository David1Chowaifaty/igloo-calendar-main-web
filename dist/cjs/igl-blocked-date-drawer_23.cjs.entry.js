...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '3979e3dc6b92fb5e9cb7e7c1c37ccc41c31959dd', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: '6abbf6957be6fa4acd1f5c863006ec3a80f3a98f', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: '2b0390453f81e30d86038fa2bca41cbd61a6a07e', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a3f44ee853962385f3f428f00d290aa7a0766375', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '82087bd131060d393f3ae21d031256f7904a61af', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd54587c5a1aaa9efaa82966e9a0e1ab84ccf5813', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '2d488632283f747e106eb4e4778d5ec10c534117', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '4338e87bc2bf718b09ff38d9d7b2d08a13f5996c', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '2ee1c28fbf7ed606424ffa1219821a53085a96fb', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: 'd2fc5a21f486475dbd6911f5dc9b844d08359b10', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: 'b35655961702792c39581453c3bd222c35d18a03', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '150192c682dcbb97bb09cb5dee749ee1c5e3e31d', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '40436c7f477351fe81c0a9d2e3c4966291370667' }, index.h("div", { key: 'c33d000dbfc104574123b45a249e41e79c1c0d1d', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '6a79d2ff287e717c37c419104c75b940f7bc1e10', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ebefaff02652ab2f0e0c147fb79c926ef97f08c0' }, index.h("ir-drawer", { key: '74a7040efff1c3b04b123bfae4b1bb8e53cbd42b', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: '65b2df73113d2ff4c48875095ff1c50f5ab6fa15', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: 'b6f9473d64eb05e607128c0e75ef13315641b957', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: '8fb44d739876d4e79c56463d28c9a6913c80daf4', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '554cfd9f068aeb11b9a54665536dd9355f391485', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: '056a8ca080b071bcbe1c16e85273c95caac18178', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))))), index.h("div", { key: '6ba8a174d57ff670fcd632b40b8123842b860264', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'b184584de4c88b750719f1f87e3a7d8ad9b95606', size: "m", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'a75535a487b8c583b5123fbc9e74c2f65ee98d29', loading: this.isLoading, type: "submit", form: formId, size: "m", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b06801db882c0082015f8147af37bb4f92058b3e' }, index.h("div", { key: 'bc22b3062db57dcf5efb4d644fcddfdd96af46fb', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'b6d842e8f5d70b3c0442b8782452e4f30d8bcdb5', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: 'c7e0b8a22d0acbfbefe78bb35bca04a02c10efdc', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: '75563835e70af0666e54232cf70b3a9991b94a88', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '321fc2eb9c0eff545f6ca211510e68b2943b0017', class: "footerContainer" }, index.h("div", { key: 'afe0b7812689ade742e8483783de84152e9b26f1', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '027862087bfabe7999979aac39a9ebe8933bfe60', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '22665d6d0060c64f855cff298764b2caaaa7ab63' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '4e020290d03b01678d916458fb19501048e19bfe' }, "v1.53"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: '62e25264549fff19947766ce9014aa0045b33b21' }, index.h("div", { key: 'e1b1f52f3950fdcb84b509905bf1bfaa5df69c6e', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '974d214275e87edbefe4da6636f843dd7491cc66', class: "header__fd-actions" }, index.h("div", { key: '76cbaf965e7fda9c6c2928cf1ecd098ef36819c9', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: 'bd33eeb3eacff1e29f3bd6e3b53c879c70c9276f' }, index.h("wa-tooltip", { key: '01783702ccc13534213ff3c9b220700f14687815', trigger: "hover", for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: 'aad735d0c8f639ebe46c6cf33932be5c2c629821', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '18d334aa5d208c93799c7d3e9e55ec4746208d04', style: { fontSize: '1.5rem' }, name: "list-ol", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: '095da56843ea9ecb753f20da02c642a81d27ec6a', trigger: "hover", for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: 'b311230ecb6559f19f580bed76dbfdff459698ff', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: '10acfe1349c7e289ceb866431ae08d3a3e6e3a56', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '52eb6573806e21a9b33f3145d9ad52ddd1f4cbe5', style: { fontSize: '1.5rem' }, name: "calendar-days", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '7004675cb536429bc41b404af600a57392600fcf', class: "fd-dates__actions" }, index.h("wa-divider", { key: '187b7785ca9d2f61cf1f8a7c310a0ac3dcb700da' }), index.h("ir-custom-button", { key: '2aa3397eaf76e48450903d5dc78099d1acdf51c3', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), index.h("wa-tooltip", { key: 'a94a9eac4f5231dd55bbe40ca5b3834fcd4ccda8', trigger: "hover", for: "fd-rectifier" }, "Rectify or open availability"), index.h("ir-custom-button", { key: 'aa7768fadd15c9a1e53be0fcac0e80d22d79d2f9', id: "fd-rectifier", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('rectify') }, index.h("wa-icon", { key: '1a4552431cac0d17982cb4a54826117534474201', style: { fontSize: '1.5rem' }, name: "circle-check", variant: "regular", label: 'Rectify or open availability', "aria-label": 'Rectify or open availability' })), index.h(index.Fragment, { key: '50bbcc2f8fcc4f5953b9584fd7fb11ab6ad52094' }, index.h("wa-tooltip", { key: '54d868988baffd199bd95f6570c1b82376b7c882', trigger: "hover", for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: 'aa7a29efcf5c6f167355efad6b8a120b24726c52', id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'c4c20e096b8ba0f94e308146b5551dd2f95ef51b',
            // variant="regular"
            style: { fontSize: '1.5rem' }, name: "xmarks-lines", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), this.roomsList.length >= 20 && (index.h("div", { key: '393472034af52f4f1e9ab1dfd7060511dd307e9d', class: "searchContiner" }, index.h("ir-picker", { key: '542807de1478b0cc8df0aa5d6fac28f64eb00c6f', size: "s", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name)))))))), index.h("div", { key: '58021622f3b2300af5dbc72ce58a997020e958bc', class: "stickyCell headersContainer" }, index.h("div", { key: '19a79307ced34bd0e6c8305edbcc80ab77917147', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'a78883c201ed5730cece79e1f38737914529b39a', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '6b4182c84f41bbe680b3c6faf44296cdd52cdf4f', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: 'babdbe259c3b736910e1fcf40454f6bb2dd566f8', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: 'd095904baff5ef5bfd157467fe119f88d5312a89', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '6c8437957126c95c5a0dd2015c1734152259320b', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: '5b1a23a0464c8188bfbc9e6f529b1f2759d8588c', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: 'ed9944015e2ad97a7e81e4a8448550c337dd022f', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '70cd4215de24a5c3547ff4dee7a6f95a87e1a042', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'c7439ebedb20fb61865667af760d62ecef6877e6', value: "hk-toggle-clean-dirty", size: "m", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: '6a45eb3d30df2c11aa10f0e8c9dea5eb41db952e', value: "hk-clean-inspect", size: "m", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9b6a65a1a7ee95d7e1d773f2297a064632bd1094', class: "legendContainer text-left" }, index.h("div", { key: 'ee690bcaaba80d56273db471aec37ef6f26af2e7', class: "fd-legend__header" }, index.h("h2", { key: '3fd81e195b57048a4ac39fd5bf939b518c431f99', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '9500d1dc17d6470f226a42adc4e6129c5247ad64', size: "m", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '6c2fb36c26d7a014b231f2cdbeb169d9c05c2311', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: 'df5e58befa54db0ce551e772f8341b119484ab53', class: "fd-legend__body" }, index.h("div", { key: 'c6e935b499c9d4ecf17fa24b4809ebc9b971e7b3' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '4e97888bf8ef00d23328bc2a37d519615808b334', class: "fd-legend__row" }, index.h("div", { key: '4aa676f0dcfff0b319996098ea918f7616ba5c0c', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '8cca0bcdf230450628005f0654da7855fa21d9e9', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '5012038db99b13f9d9cd256c2646ef8214784747', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: 'a78e86e5468fc3dea0fbd3b9dc2750121f6950b2' }), index.h("h5", { key: 'e8f2d9e0a05890d904080e17ad4f5dbf89de79be', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: '6f6981f200be7419550d2368bd733eb3ba0bf1de' }), index.h("div", { key: 'bfdeead4a7e0d993fcbdc131e6fcd86adbaa0d50' }, index.h("div", { key: '72162e32233241ba9dca939b6bf9384936ea2ee5', class: "legendCalendar" }, index.h("div", { key: 'd194e5b72cb114275f617e6fa8592820ae8671c6', class: "legendRow align-items-center" }, index.h("div", { key: 'f8df4bcc093ff73a04ba658e9de654ad4b81ce85', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'e9e9abac7c48ccd063f06b26938f3cf6c2c057e6' }, "MAR 2022")), index.h("div", { key: '16ca04e0320a637507bce60a90d2f545f7c1a35e', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'ca29c15e8e22117d9a86cc5287f032088358ea5c', class: "legendRow" }, index.h("div", { key: 'eb662e60bfd975e86379507452c4f2c6226fafa3', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: 'ecf888db4687fa1a8da54c5c58b2084f86131e19', pill: true }, "3")), index.h("div", { key: 'f603257838e035f4754b70d6380299855e836004', class: "hyphenLegend" }, index.h("div", { key: 'c086b856acf7fc1b601a7f14203d5f960ddbbfed' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'd81b8cab338e5a8dba569bae17cccb1c8688d518', class: "legendRow" }, index.h("div", { key: '71fa549acb8c43276b9f3defc20b1a00c06a7b9f', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '92151253677735683132859562ba78a197326fd6', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '38cdb81206acac36de14a30bd379b3def76bce21', class: "legendRow" }, index.h("div", { key: '5d8b02ec42f6ec183261fb127b47136acbdd0e78', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'b447f52bd965361d549bf2e0c9e709e71acc4a27', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '4020c476da159ac35fff77b8b469dd45a9c67de5', class: "legendRow" }, index.h("div", { key: '276e7a96e9109ecf5839b1479751f0aa7dee7d75', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '5b7aaabdb39eff9243216fb712cfd318b31fce95', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '6fddd29852d066bb47ea6b29d0df6672610dc885', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: '879df6806983cad2f5cfbd3c88197cd4e5c9e3d3', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            ...
            } })), index.h("div", { key: '4b46c1fa148c81b1b36ee54b006dbcff5114a88c', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '28a5fa4bd817633409584c17448a36d6edaf1e16', size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '040027c2964affa65508366a0ba8e15d9e678192', loading: this.isLoading, disabled: !this.hasInventory, size: "m", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '9394e5a8bf2e2ad57640b094d70d2048c62fce57', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '7fdd0e05224ce66bad3fd683304d21748c270fb9' }, index.h("div", { key: '791000c965ff3be95b7cb3f404820bc36f021e5c', class: "dialog-body" }, index.h("p", { key: '923a753b814097fe541ef9b959735e3b517cd62b', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '6b6555da4af3b3ed3f49591782fb2acf41d33fd1', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "s", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '6522bbc8c7a7e54d701350f57619c10672292a87', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '7d1797b13de3b8438c59c3fce51680861f1035bf', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '15813a0eae90e28b0bf5f28d6b4a19579ee5799f', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "m" }, "Cancel"), index.h("ir-custom-button", { key: '2d22864fcfea7061a18ed6a4cf4bffc81015832b', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '640eb62a9f82ff25c7d763b8c59272d1ee708f69', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '6477cbb4f34690d33820e7960ab017bd0e79da44', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '16a461e289536ec01374691a96cfa1c9a31a5db1', class: "px-1 sheet-body" }, index.h("div", { key: 'a7ffb6effb94a09d92a399b8481686e7c848ff39', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '07df52181ed6124db7dbb4377cef57d8762ea282' }, index.h("ir-date-view", { key: '1e764e84e2782bcbbaca9600c35cc6d3e4f4c599', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: 'f3e5b580089c7d62dd5f124561a120d1bff1fb12', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '44821e6b4790150306d7646db1ca8369386668dd', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'fe8b0311035fbb2c8da95dabbc93c762fc510443' }, "From:"), index.h("ir-date-picker", { key: '53cdb45a4fec0a00c7037931dc28bba31c2b3de0', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '95c5335e459366ef46cc4ec7e53af3156d0324d1', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '6cabcf4c152c8753276a71f17f830dc7ec15500e', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: 'b1de54c6686276e7d3fcaaf869fc35350ffbdd68', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: 'dd43dfcfbc5701762a545418db42f55802722e40', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: 'f9c9e0eb24ce2ff6cc13e738a194594cfb55f327', class: 'sheet-footer' }, index.h("ir-button", { key: '0b2e98234a58206366f1c64797b27e796b74a11b', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'c02c341a9b6f7c6c9186b32d5ac078542cb0c82a', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6af28aae744e9eb6dd3aa92a397f262175a46477' }, index.h("div", { key: 'c0e18f52d2b42dc1154d1c989281655bfd98e01e', class: "tba-category" }, index.h("h5", { key: 'b1f2b8b6c49f06d3fcfcfebcf3016583870514e2', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6ca91f9996cf148fbb2c119852823164efa43a12' }, index.h("div", { key: '87b5f8e5d299fece3eca6ebab29dd79ca5970fcb', class: "tba-panel" }, index.h("div", { key: '4b1e9fdbe686fd3a85948f42db396ec192e5dc8d', class: "tba-panel__head" }, index.h("header", { key: '6ccb2e65a56866ab2cb7ce1e1928b3630f0a7202', class: "tba-panel__header" }, index.h("h2", { key: 'c8e5b0b7bbe63dbbf996e2e58e9133a304f7afd5', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: 'e6c2b05b8b48766807a86a5bbb980db5901f5e5a', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: 'd0d9e45740bf51e37ecab626259a90dd14dd1819', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: '468ab278d766a5acf9902ca527e394e053237a39', class: "tba-panel__toolbar" }, index.h("wa-select", { key: '3e2092d1dcb50941e23e253f9bb1ca7ebb940156', size: "s", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: '592fe41f0fa4b49915547285d92a81ba538cece0', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '260ec00aabf75518cd9fc0ed9f9a0b9dff92f208', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'c34274f5aa8a177d1a2b577922a5d0de98896db5', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: 'bac95a46afcb808f4812756cdd9d292cdb851e7f', for: this.titleId, placement: "top" }, title)), index.h("span", { key: 'adfcb8b83db5148e3db32554ed96ecef15630fc1', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: 'c8f665f768f67eba36a3758d333a22720b6f4fdb', class: "hk-dot" }, index.h("slot", { key: '234ba5597e566196d72dc4e5e6e84091d4ac9c70', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'b5e9e40c27c7e032124c8078022778c79d3a6404', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'e35560ab940aeb6fd33a72a21e10bd31006516cf', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '772ebfc4b358473f298c6d0b4a26c58556c53d27', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'd6f8bec8399cc01b409196fec8c2069a59f5ac29', class: `ir-alert-header` }, index.h("p", { key: '3d22778cf254cbcf302123ac788163cd17f4bf44' }, this.modalTitle))), index.h("div", { key: '2e970b532a98bebd3f6e76c478850994eb48852e', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'f4cc615546c6c568795bc1606f6870a5274f01f2' }, this.modalBody)), index.h("div", { key: '93ada143f09f3be88774720e6aedc6a2ea1488ef', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '4d118d5a1ecce2fc98085bcf8b08d8f4f51b382f', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '009634aded127239fcf6897da24cc2deca89946e', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '3d76147304b673013070bf51cfe6f97813c45a4a', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: 'b48cfd566d096481cf87a225a6218cb659611433', class: "input-group" }, index.h("label", { key: 'df369cc5497ae890f3afaa88dbb991bef3922ecf', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '64202aae1a82f37940f753ad7d83039528e1320b' }, this.label), index.h("input", { key: '21ae8b6d25d194965f54377a60a6b701614c7563', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: 'c5305873f13dffbe9ffc20bc1dcd0b944f745826', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '14decd505176572bb86a0058a733dc2063d2b9c6', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: 'e419decb2376be8394cfd37a53977b014bcff7f0', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '8254f0cb635f56f415f7a87a8a231156ad6486ed', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '761cd2dfbb491e13ed19cb2bf37f8c20a3b4d6c1', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '028578827480aa194c8f0238044ed158196318e0', form: this._id, size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '24e7e5de742e8e0f9d15c4ff1ae7c73be8a6e712' }, index.h("form", { key: 'bbd638e86afea92500662ace9d537287d6760a2b', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '525336e0c3c5b6dfa7cc2c7f423888fc0011a0fe', size: "s", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: 'e3bef570d15005e0fef44e4519d71de6dccfd549', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the selected room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'a23d655177d84ad4976e1a3b04c3f8ef532feae6', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '8334ad25f23de607992fb3dd6c49785c904f3b30', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '4f841250776917ff50f01406f4029bfbf0a82627', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '7200da038d20cad81bc8463956bd93b2019d517f', value: this.form.from ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '41ba0608bc0270812d57e05dd1b1c7fb90feada5', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '9df67e1e50f9c765fbff3e07a2370aaeb81a993a', value: this.form.to ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '127a5e38847a8bac9704b704281fbdea45a1fce1', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrRectifierDrawer = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ab5ed60c359c3be8d4b44416e89a330231f7e8ea' }, index.h("ir-drawer", { key: '3b4600512b1dcf2a5c228571af2c6e4d7655fa47', onDrawerHide: this.handleDrawerClose.bind(this), label: "Rectify/Extend Availability", open: this.open, class: "rectifier__drawer" }, this.open && index.h("ir-rectifier", { key: 'c68bcf59c069bf3e2ea95b2ea7a60f82b61ee560', formId: this.formId, onCloseDrawer: this.handleDrawerClose.bind(this), onLoadingChanged: this.handleLoadingChange.bind(this) }), index.h("div", { key: 'd46bc6a010f41dbe703d331fd4baeec29c4fa90c', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '720d4619f9fc461960da4fe72bfb28c8d6193533', size: "m", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'f931f1d501da881ed8145f2cfef7ac2fbdf1c25f', loading: this.isLoading, type: "submit", form: this.formId, size: "m", variant: "brand" }, "Confirm")))));
    }
};
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3410aacdd59bd3a19affdef8f083421e2626bf80' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
        "active": [{
                "onActiveChange": 0
