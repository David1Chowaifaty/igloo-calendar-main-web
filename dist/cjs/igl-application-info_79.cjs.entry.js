...
const IglApplicationInfo = class {
    ...
    variationService = new variation_service.VariationService();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dd469c63a4d00f77b54f50e28f50187a0dc7483c', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '7ade52b10da336839cb51f98258fd72749f84348', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: 'f7555ac1f05a51284798f7f6271a046472f567ff', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '98c22c40320b0068504c4152145f48ed172957f6', class: "fd-application-info__details" }, index.h("div", { key: '26f8c2a92089872a6cc0d87bfe079adb1f0ffc22', class: "fd-application-info__rateplan" }, index.h("p", { key: '92d03edbc068ae6a6a111a7626b1cbeeb12d2043', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: 'd9c63c9bf34b44d3854c4afe2647af5a37d25456', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: '5a20f4c0683f34fb7f73a135205f3ea19c074500', for: this.tooltipId }, index.h("span", { key: '97dc5fb98b8b4545573ba1e3230be1cf952f3ea8', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '6b379cec21f5fe0cc6b30749da988814b70d0ee4', name: "circle-info", id: this.tooltipId })), index.h("p", { key: 'a3128018cd77ef4c423ee6e47847babe1ff276e8', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: 'b7528b4dd62d1ddb2be1f6a6b45291e39f073652', class: "fd-application-info__price p-0 m-0" }, index.h("span", { key: 'a9cce9f07f7df76881a5acf4ae15d9b3ce3e95d4', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.getAmount())), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: '7db6c0363a203bca90cbb2212e8103f553a4fd3c', class: "fd-application-info__footer" }, index.h("div", { key: '0feaa04e93e475097b59b467c3970b1c9b316344', class: "fd-application-info__rateplan" }, index.h("p", { key: 'f5f82279017e8279d8d737325f0635238d180522', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: '81068afc554d677d29dfb50bca909498e790a04b', for: `mobile-${this.tooltipId}` }, index.h("span", { key: '75cf8ebfc2a0bf801f9fe0eb92c516ee4535e993', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '737594d9e5322fbe89e8742550ac95c25b18a77d', name: "circle-info", id: `mobile-${this.tooltipId}` })), index.h("p", { key: 'cd5cbde8f769a82967a84623f2f1c3309bebe383', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: '61195bbbe740f1ebfadfdcb191053c25ab5afaa4', class: "fd-application-info__form" }, index.h("ir-validator", { key: '8e0bf637fc3ae23b9e36b7453b5f12d57803ada3', value: this.guestInfo?.first_name, schema: types.GuestCredentials.shape.first_name }, index.h("ir-input", { key: '5667f64327e28a0a3b95970444a49865921cc38e', class: "fd-application-info__input",
            ...
            } })), index.h("ir-validator", { key: 'fe82f91eae9a72a3f32bf9de74ed7ca84347ec78', value: this.guestInfo?.last_name, schema: types.GuestCredentials.shape.last_name }, index.h("ir-input", { key: 'd24914f44acb34e92a196b1fca770071a80d5af0', class: "fd-application-info__input", type: "text",
            ...
            }) }, this.bedPreferenceType.map(data => (index.h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("p", { key: 'e5bf077cbf088e0d3a0a3d7f701db695e279e7c4', class: "fd-application-info__price-inline" }, index.h("span", { key: '3439739d0696f9e1538f981e2656fa373bbdc8e7', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.getAmount())), "/", locales_store.locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: 'ecc4866da1b6c0f85dcc1bd077541b84f2c14974', class: "fd-application-info__infant" }, index.h("p", { key: 'cdb6ead8af814e41d8d84fc74cb99b67ea066f5f', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), index.h("wa-select", { key: '970bfaf1d47790a5625a1a9a976d854847bad164', size: "small", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales_store.locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => this.updateGuest({
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '90dde0929e494b4cd6387ae3668a742ee35e939d', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: 'ba3b336f10a15ea934351d6000d6eca65233145b', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: 'bed25d8ad524dfa236503513db2f24801c9db076', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (index.h("p", null, index.h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable")))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (index.h(index.Fragment, { key: '3e8727047f09d1da5a667635d111fb393910d8e8' }, index.h("wa-tooltip", { key: '9e52d67bc1eca5c3b3637b99168d826d8062df00', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: 'f07e6eff96e3a3cd02d7db64bc0da9a6c61dd75f', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'b1e97aed2428144474fcedc14d03cda47623273d', name: "circle-info", id: `rateplan-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b54f7c3dcea64ff64ebc3036816bd358fa1654bc' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("h5", { key: '6b90ad6a17e3edd9b9ab53ac3a108bb3800f86ae', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '4b28083665593e0261408c36e54f14556ed79949', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: '02ba1873b4141b9fc3af549e8eab7b7c2d800b31', booking: this.booking })));
    }
};
...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'eacdb37271d6fe72181aa149be5364d2fcda4a68', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: '36a3888a0049289f758dea6b512cd6317bfdd0d1', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: 'b475a8f34d0db540c6936f7e1bf9e73c991af155', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'a7845ed35291af23651d3a3563da0b6f86c55e92', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '63617c8a31e1d787fe5264cdbca9d1759b0d8ef0', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: 'e3730373ad0105ffdefacc9316eaf395e0aef08b', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-input", { key: '69762f187838820135d4d6c866dfe47e79a1db97', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-input", { key: '13a63190c9b60bca86afe941e03adc16f4e1e500', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'a29b76a8a638ed0af6ca11b580ecb5a283640991', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (index.h("ir-booking-editor", { key: 'c292835e50993578a0c45782dfecdef9ca4afd6b', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), index.h("div", { key: '80f02136ac58512d4648b447b581485e12072635', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
...
const IrBookingEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '9202d2f513bf54029566e87ab0bb615f1fa1b0de', class: "booking-editor__guest-form", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                this.doReservation.emit(submitter?.value);
            } }, index.h("div", { key: '7a590a35e144c2103d37583a945c367f947ac4dc', class: "booking-editor__header" }, index.h("ir-date-view", { key: '5786dad0847188479743e4b8da678545b5f0ad13', class: "booking-editor__dates mr-1 flex-fill font-weight-bold font-medium-1", from_date: dates.checkIn, to_date: dates.checkOut, dateOption: "DD MMM YYYY" }), totalRooms > 1 && (index.h("div", { key: 'e4ba21bdda1f3f75ab8be1b26089f3ca404ed52c', class: "booking-editor__total mt-1 mt-md-0 text-right" }, index.h("span", { key: '08388f7f7c9ebdd3eda6961681a60aa57fe97f49', class: "booking-editor__total-label" }, locales_store.locales.entries.Lcz_TotalPrice), ' ', index.h("span", { key: '6540046658db62ade6d4b983e2078c41d6ba0457', class: "booking-editor__total-amount font-weight-bold font-medium-1" }, utils.formatAmount(calendarData.calendar_data.property.currency.symbol, totalCost))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
        ...
        })), ['BAR_BOOKING', 'PLUS_BOOKING'].includes(this.mode) && (index.h("section", { key: '0c701710d402258e6c7171eafe768f08a227d55c', class: 'mt-2' }, index.h("div", { key: '321ddbaaea5a345b6b1828134f5792f1c8e99a3a', class: "booking-editor__booked-by booking-editor__booked-by-header" }, index.h("h4", { key: 'cf61cce83492d6fa7d181097cd72774d52e91d7e', class: "booking-editor__heading booking-editor__booked-by-title" }, "Booked by"), index.h("ir-picker", { key: '21874b08aef42bdbc6c49cc7c982e81968cecf70', class: "booking-editor__booked-by-picker", appearance: "filled",
        ...
        })), booking_service.booking_store.bookedByGuest.id !== -1 && (index.h("ir-custom-button", { key: 'c0c9319a52c1d4b81d086d8bdac9a5c0f1657e8a', onClickHandler: () => {
                booking_service.updateBookedByGuest(booking_service.bookedByGuestBaseData);
                this.pickerEl.clearInput();
            }, variant: "brand" }, "Clear user"))), index.h("ir-booking-editor-guest-form", { key: '3f94b61473b882dd67e17fd0f813e9da6ec73055' })))));
    }
};
...
const IrBookingEditorGuestForm = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b3d8b8449c67a87cadef7eb5a01ffa9a0cf015ba' }, index.h("section", { key: '5bab6a6fdf04552e6de86b55a7059f6bf3d77a7b', class: "booking-editor__form-control" }, index.h("ir-input", { key: '1f81b18c2a988b5937ef461009e8a421365e6c73', label: "Email address", "onText-change": e => booking_service.updateBookedByGuest({ email: e.detail }), type: "email", value: bookedByGuest.email, defaultValue: bookedByGuest.email, placeholder: "Email (leave empty if not available)" }), index.h("div", { key: '37d6b269760bb2ef4d35da409442cd8b0025c24d', class: "booking-editor__guest-name-group", id: "booking-editor-guest-name-group" }, index.h("ir-validator", { key: 'c6f2a1a63cfbbb114921cce14fc3d234771abf46', class: "booking-editor__guest-input-validator", value: bookedByGuest.firstName, schema: BookedByGuestSchema.shape.firstName }, index.h("ir-input", { key: 'bc68714368e72ce48d85b0f29162345815a82123', id: "booking-editor-guest-first-name", class: "booking-editor__guest-input --first-name",
            // label="Name"
            value: bookedByGuest.firstName, defaultValue: bookedByGuest.firstName, placeholder: "First name", autocomplete: "off", "onText-change": e => booking_service.updateBookedByGuest({ firstName: e.detail }) }, index.h("p", { key: 'daa3bb4e5a3dd9b7e24d2be859bda56dffbce3ca', style: { margin: '0', marginBottom: '0.5rem' }, slot: "label" }, index.h("span", { key: 'aaa5b0194244d59149355bd5c58fcc1fe22b4bfa', class: "booking-editor__guest-input-label --first-name-pc-label" }, "Name"), index.h("span", { key: '19cfdd63388e41577caed67ddd5c0cc5c58d474b', class: "booking-editor__guest-input-label --first-name-mobile-label" }, "First name")))), index.h("ir-validator", { key: 'ea03c7cc188d6c6034866ce10904de329962c235', class: "booking-editor__guest-input-validator", value: bookedByGuest.lastName, schema: BookedByGuestSchema.shape.lastName }, index.h("ir-input", { key: '039dee310089ba68bf8ab5185eff04d0eb748298', id: "booking-editor-guest-last-name", class: "booking-editor__guest-input --last-name", label: "Last name", "onText-change": e => booking_service.updateBookedByGuest({ lastName: e.detail }), value: bookedByGuest.lastName, defaultValue: bookedByGuest.lastName, placeholder: "Last name", autocomplete: "off" }))), index.h("ir-input", { key: '48229c8b17fcfb205db719741bdd201821f91b4e', label: "Company name", placeholder: "Company name", value: bookedByGuest.company, defaultValue: bookedByGuest.company, "onText-change": e => booking_service.updateBookedByGuest({ company: e.detail }) }), index.h("ir-country-picker", { key: 'd259e05d217a29a9f05c3fa5a3d3dff2faa2020b', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.updateCountry(e), countries: selects.countries, country: selects.countries.find(c => c.id.toString() === bookedByGuest.countryId?.toString()) }), index.h("ir-mobile-input", { key: '44e79c20eeed71c28fa43feab77e0c40fac74195', size: "small", "onMobile-input-change": e => {
                booking_service.updateBookedByGuest({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => booking_service.updateBookedByGuest({ phone_prefix: e.detail.phone_prefix }), value: bookedByGuest.mobile, countryCode: selects.countries.find(c => c.phone_prefix === bookedByGuest.phone_prefix)?.code, countries: selects.countries }), index.h("wa-select", { key: '0cc3b2e203da1e0644255a19cec977e083dcc48d', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", id: v4.v4(), defaultValue: selects.arrivalTime[0].CODE_NAME, value: bookedByGuest.selectedArrivalTime, onchange: event => booking_service.updateBookedByGuest({ selectedArrivalTime: event.target.value }) }, selects.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: bookedByGuest.selectedArrivalTime === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("section", { key: '44466c552fa24fa8096b2b0d05a052088d5834f7', class: 'booking-editor__form-control' }, index.h("wa-textarea", { key: '8aa602beb7f1093ee28876d1e07c19fab7c94144', onchange: event => booking_service.updateBookedByGuest({ note: event.target.value }), size: "small", value: bookedByGuest.note, defaultValue: bookedByGuest.note, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 3 }), this.paymentMethods.length > 1 && (index.h("wa-select", { key: '96bf0976efc4f025b2c884f41a8a85fdfabbf0fb', label: 'Payment Method', size: "small", defaultValue: booking_service.booking_store?.selectedPaymentMethod?.code ?? this.paymentMethods[0].code, value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: '8c6f08a9e0df0801d83d669162630f9657d4f4da' }, index.h("ir-input", { key: '9e536e73a3c688f78a9d2fc516e1a306da022f8d', value: bookedByGuest.cardNumber, defaultValue: bookedByGuest.cardNumber, "onText-change": e => booking_service.updateBookedByGuest({ cardNumber: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: 'c0c2817128de0e107953f28ccea50c72f2ce77f7', value: bookedByGuest.cardHolderName, defaultValue: bookedByGuest.cardHolderName, "onText-change": e => booking_service.updateBookedByGuest({ cardHolderName: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: 'd0ad157bd34e85d43a5bdb0f6fb54de7584a7a74', "onText-change": e => {
                const [month, year] = e.detail.split('/');
                booking_service.updateBookedByGuest({
                    expiryMonth: month,
                    expiryYear: year,
                });
            }, value: this.expiryDate, mask: this.expiryDateMask, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h(index.Fragment, { key: '0709cb4e1baf9402415115f810c93e23a08bf94e' }, index.h("style", { key: '85e67a452df52fb2194848a83204f4194c891be2' }, `p{
              margin:0;
              padding:0}`), index.h("div", { key: '40d68e43e7b970d1fa351705e591935a2d485df3', class: "booking-editor__payment-info-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description }))), index.h("wa-checkbox", { key: 'ec414470fdc142e3abd10f81dbfd254e1024203f', defaultChecked: bookedByGuest.emailGuest, checked: bookedByGuest.emailGuest, onchange: event => booking_service.updateBookedByGuest({ emailGuest: event.target.checked }) }, locales_store.locales.entries.Lcz_EmailTheGuest))));
    }
};
...
const IrBookingEditorHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9061d00591eda5c697969289a38625ffafc7ec3a' }, index.h("form", { key: '8d724e6e5881c91904e909008d37d0c612c21b76', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (index.h("ir-validator", { key: '03cbb20ea20bf83af7429ccc01ddee17a0225116', value: booking_service.booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, index.h("ir-picker", { key: 'b6ae12a2149a8aae8184be051b2d11d3a67acacf', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales_store.locales.entries.Lcz_Tobooking}#`,
        ...
        })))), index.h("div", { key: '9fa3fd038d07fffe7272410bf434cc15045b8bc7', class: "booking-editor-header__container" }, !this.bookingEditorService.isEventType(['EDIT_BOOKING', 'ADD_ROOM', 'SPLIT_BOOKING']) && (index.h("wa-select", { key: '3b5b99eb38307024babcd9aaaa1cf2d3a3b83abe', size: "small", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_service.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_service.booking_store.bookingDraft.source?.id, "onwa-hide": this.stopEvent.bind(this), onchange: this.handleSourceChange.bind(this) }, sources.map(option => (option.type === 'LABEL' ? index.h("small", null, option.description) : index.h("wa-option", { value: option.id?.toString() }, option.description))))), index.h("ir-validator", { key: '768c3610cc9cce5fe9bbcebbaa5942b4df9ab8f1', class: "booking-editor__date-validator", showErrorMessage: true, value: booking_service.booking_store.bookingDraft.dates, schema: this.datesSchema, style: { position: 'relative' } }, index.h("igl-date-range", { key: '8238357173f0aaa1f6ae5fbd665538b5834e10a6', defaultData: {
                fromDate: checkIn?.format('YYYY-MM-DD') ?? '',
                toDate: checkOut?.format('YYYY-MM-DD') ?? '',
            }, variant: "booking", withDateDifference: true, minDate: this.minDate, maxDate: this.maxDate, onDateRangeChange: this.handleDateRangeChange.bind(this) })), !this.bookingEditorService.isEventType('EDIT_BOOKING') && (index.h(index.Fragment, { key: '79c0086322386f8439c83ac1f17914648ee44ad7' }, index.h("ir-validator", { key: 'ebfbf0e7908d6c49ab85bc5510a5f47e7ec78071', value: adults, schema: this.adultsSchema }, index.h("wa-select", { key: 'f7d509d10ca9a479d41a3a374561b5777be156a7', class: "booking-editor-header__adults-select", size: "small", placeholder: locales_store.locales.entries.Lcz_AdultsCaption, value: adults?.toString(), defaultValue: adults?.toString(), "onwa-hide": this.stopEvent.bind(this), onchange: this.handleAdultsChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.adult_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))), calendarData.calendar_data.property.adult_child_constraints.child_max_nbr > 0 && (index.h("wa-select", { key: 'dae10c9caefa26ae935e253408585839c5edbd2b', class: "booking-editor-header__children-select", size: "small", placeholder: this.childrenSelectPlaceholder, value: children?.toString(), defaultValue: children?.toString(), "onwa-hide": this.stopEvent.bind(this), onchange: this.handleChildrenChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.child_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))))), index.h("ir-custom-button", { key: 'e481d1225214f2297483424239974ed25a6fadff', loading: irInterceptor_store.isRequestPending('/Check_Availability'), type: "submit", variant: "brand" }, "Check")))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"],
        "mode": ["handleModeChange"]
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '7b05c1f698359721d7458ab96d750f09bd24e03c', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: 'fc8dacb8d181901d8057107c2c5f04a9018d071c', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '76e0318ee87ee3f4a8b5c3413dbf99cc6662eafa', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c929339df0fae7af9533b8860f3aa850322f61a5', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '5e77ee500a4dc33075ba17c7e7f6c1edf76d2aa4', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7b1a92057b354c3b12d27fd7e06428ffdeeb7ca6', class: "fluid-container px-1" }, index.h("div", { key: '8f0917775702222ecc42fde12c434fa3a58d7006', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: 'fb65bd90d9258cd747da630a370724f0f1778827', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("div", { key: 'd86226c285e8dcdb2a38d202dfc75fdfbb27f5a5', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("p", { key: 'cc7e6a00af98d1d7526cbac9ec8bab1abf412274', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("wa-dropdown", { key: 'a03d2a38c9a2844f0e179234e865723f37de36e8', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                this.bookingStatus = e.detail.item.value;
                this.modalEl.openModal();
            } }, index.h("ir-custom-button", { key: '857579be49fa024eac593a60423540f7afff9085', slot: "trigger",
            // onClickHandler={() => {
            ...
            appearance: 'outlined', size: "small", variant: "brand" }, index.h("ir-booking-status-tag", { key: '3ce64c140b2853eb9ac446955caed501aff0b901', slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", { key: '590537577739b3e1e25c1ea025404016941bc55d' }, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))), index.h("p", { key: 'c74c3f8a7d4c5ccd4039a41940cb12745ee2a3d2', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'a0ab0bdbad5be0eea712e06dc3ad0243df83eb9d', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '5bdbcd35aa7142cb9caf15386d8651bf629557dc', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: 'a05e6a97f246e32670c36e6756448a700b42ae25', class: "d-flex flex-column align-items-center" }, lastManipulation && (index.h("ir-popover", { key: 'aee3785ec8e6183d9fdd174c35d5b1f159fc5727', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: '38401bab52ad85c87c10989b1ce050e1f3e0290b', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '1e22b491853a22eee83bb1803fe43753e292e8a5' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'e4c489e2222e483c1d457e29be78c94a973805eb', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } })), index.h("ir-custom-button", { key: 'e1fe835e52e454d6a74477ba6508c9112ebbcca2', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), showPms && (index.h("ir-custom-button", { key: 'ed558def47a0583a6430a71808734ac3ab31d922', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: 'bd91f0d47f332651372212b88a9fc4f24351e1e0' }, index.h("ir-custom-button", { key: '0e41fd1812048c31f3c2410c9ef4a8c0023538b7', id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: 'd0ea504636f0a822c15b2343761966fca3b3f381' }, index.h("wa-tooltip", { key: 'b2f8b87a90d2a9ec2363846d6b173ea3481bcb7a', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '8af820731255e96dbede405429be0834cb2c4f2a', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'f536d515b6e17beee18f62300ea5055e967edc38', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '873714b37ead6f5eaced416cfe86a0bf45ae6d98' }, index.h("wa-tooltip", { key: 'e179fc69826f8a457e1e8b198484d02aa588ee19', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '91bef3dbd44d559909111cdbed73e2a937bfae8e', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '6380458415b7861b4591b10f800a4309686bf389', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '291c634ce3b2bcca748426a00c963d7ea27e1d65' }, index.h("wa-tooltip", { key: '332363ae7faccff323561dc17f749731aae708be', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '5b82f98c22499695d4bce5fc0b8edd3851aa3518', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'baa8a6b8f817e73d7c6d3c8dac9ae2f5719a0415', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: '2a81d1f18edf94122dbd8e21bf3cb478c83000e7' }, index.h("wa-tooltip", { key: '46e5c437ee6a5fdbe6533aa266a6efa49cf94d28', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '25927cb3841c64affcde4713a6cc9a41392623d9', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '0b5c014ebaa1fb131fd3c4fd64b9845208fc66e3', name: "list", style: { fontSize: '1.2rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '8957d75442420b7547932c58114e30ac95d3c963', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'aa7045547992c390df649009403a9893f1a72b64', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '7703f502c6e402c0f120c53b5147bbc6576e7865', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '74a43152a8b88744fcdfaaf0ae006bda750d5d2f', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: 'e0b37a292cbf9dbb0f4223a3d1d1c5849a3fde9d' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'd7d7d4cf898cb9e124588f4187179484b8b2626c', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: 'f21e0122e67249554a426eeb6203dce1118893ec', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: 'd62bac6d4c41fc5da7f87253fa8e08cb116431ce', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '2ebeb32189f89096d853f9e84342e9f0bcffa210', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9b13e8fc8ced4f6b02c0e14a2347d9e45f2efb7c', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: 'd3ffec785d8a2e6080df2910845ada0c31219503', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-input", { key: 'b66d642602bec62a3ea360d12cc9d275144fe13e', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), hint: this.hint, class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: 'd2a03b30bd2aeafd4e5deb0425b6be52e998f38d', name: "hint", slot: "hint" }), index.h("slot", { key: 'd885312f124c594eac7c742f40e6633f0bbcab96', name: "start", slot: "start" }), index.h("slot", { key: '47669a8d3ea86f9649c8d0819a66a7378b1663da', name: "end", slot: "end" })), index.h("div", { key: 'e369754468ef4092709a439caa875d3d1c8a1552', class: "picker-surface" }, index.h("div", { key: '99a9bd18fe15f4ba7c089c28fff1d562e0e35ce9', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: '1fe0425b68f6feb3506234e61ae0951b2ac22060', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
        "date": ["datePropChanged"],
        "minDate": ["minDatePropChanged"],
...
const IrDateSelect = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0e9899c09d2c114f5ff4dd8b8ec0c34a5d7be72d', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, index.h("wa-popup", { key: '9a01a74e8dfbdb9091a2f410ce22ae64a98e2e66', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, index.h("div", { key: 'b34efd0b7742231efd1e1e8af8f5fb14df7d9a88', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, index.h("div", { key: '24d2a6c43c50f43bb5b63d8420f29be915074893', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("slot", { key: '36634dc2830358707240c0a29dfe437f7a090c54', name: "trigger" }, index.h("ir-input", { key: '8de7de5e8ffb7d458116971376dd377279429af4', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && index.h("slot", { key: 'f504ce1750e5d0a9909cca23538bd2e09b700370', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: 'e83abd498172d60f9ee992e44a827315d406ce2a', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '4ab74349fb8d14992a146306e406d07e7d359ca2', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: 'bd85df4240242dc60ec2100e6f9907f10655073c', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '1547d8014ea13d0088accf4e8f59703e189222b1', name: "hint", slot: "hint" }))))), index.h("div", { key: '891310cf1bf8337e862d51aadacf1c2eef300cc0', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, index.h("ir-air-date-picker", { key: '984efe2d3fa626f5aa53fe3cc2b0c83952dd0ae6', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), index.h("slot", { key: '17dde800721c1bb7cacc18aeb2bf27ac10d34be8' })))));
    }
    static get watchers() { return {
        "aria-invalid": ["handleAriaInvalidChange"]
    }; }
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd507425f8ab617398de333d27b6f813b77e35ef2', class: "d-flex align-items-center" }, index.h("span", { key: '763b7278b10f0305c87021d7b1d7935fbf5ac643' }, this.dates.from_date), ' ', index.h("svg", { key: '884b2620b0ebf37592b1cfe4c534a28cad60b152', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'c5abec372b6a5f47ce1e777fe95b22d2433bc3fd', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '707ddecfde09fd9ba8f57faee46b5c95752ad803' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '3eb6ca2d9e39333cdb3a9b625bd0a7a1d8cdddfb', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: 'f21b6fbfcf5e0cff2210cb5616aec71a289247bd', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: 'f8f5cc91d8704cd7d15fb9fadba41caba6320f6e', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: 'd020e51de89e6ad8e9326ac9ca91f6accaead49b', name: "label", slot: "label" }), index.h("slot", { key: '98e63c9ea4f505fb80cf552bf912160a5f70684e' }), this.slotState.get('footer') && index.h("slot", { key: 'e10a11a321f23f780c0bbca81dbc179593c9cbbf', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrEmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b799e70f5bdd6afc97e34e5d34922838d3f8be6' }, index.h("slot", { key: '328223d6192c4d322138fcdafd7fbb79d04e27ef', name: "icon" }, index.h("wa-icon", { key: '4b9e1f523c353d0adc15950b6fc4198d54fa8ff1', name: "ban", style: { transform: 'rotate(90deg)', fontSize: '2rem' } })), index.h("p", { key: 'e793cad17151fcc76321772ef4c05dfc2eceba79', part: "message", class: "message" }, this.message), index.h("slot", { key: 'fd9bb2f91bca9a72f98d76684fb85741593762e3' })));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0f8db61c8454eb40339a64156737e3408d228419' }, index.h("div", { key: 'a6bf5e1e9e93faa56dc7bbb7ae84b4172fbeb1ae' }, index.h("div", { key: '43c8145a747cb0a6b6222d4f3959cea31e136da7', class: 'extra-service-container' }, index.h("p", { key: '7a97186817f5bf8a90e73257849649b43d16677c', class: "extra-service-description" }, this.service.description), index.h("div", { key: 'b0bd75e82f98a5da48430620eff6ee7bedf98e18', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: 'c700cfce7e185ea8956fffecb43b5707a4373dfe', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: 'f82924dc3d5e8a9b8a6af96f8bcb39dc9b6663b9', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '437338fb7766251941326d1a6d5732a35c51d84d', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: 'a4414d6ca1e9015ed525e37857776e49e0a8908d', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'd5773e99243a6b0b23f55a27d1c2e6a57f5fd126', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: '6f4a1739ce3fa1b0baee11ff443ac9d9a4499d43', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: '493be2e0309b2b5c55a756674bef8d715b3bb8f9', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: '18ac55fa766bf2015635016a37392d4ccc27c25a', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: '097eae5487ebf1e57503059f4e8067d0ab83575c', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: '5c70e8b89784c5de5593cd59224b6462ba051c2f', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'd4d7f99a1b5a88c585dd38ca870cfd78f7d06966', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '925a42d215ee8638f1736d8e2680ab787f28770f', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'aebc416e923c4bf8b6676c879145f83d14d56b99', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '9e7c806e784f4d5c4f442458fdd788d3bf225e7b', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: 'a8a35769fb0baf6198fcba55f1186a19a64ed32e', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: 'a0892bf40492ebad37e522408ae5698bf22276fd', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'fea574c479a676a23ad3aa054df3f47036beb975', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '4c9641b8c7b79ce8a3f40b41585339e4dbf5828b', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '7a3d143d32ce68e5e7fed7c5b3c2d11f01643754', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: '6b61dc0c9bb5e63c643fe7e255f53c50531cdd90', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '80760d862010c38fb05c8112b60c4e37a982fc9c', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: '1aacea021f460c1abb080f684819e2384358a222', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: '2d04ada4417d71966888e84b2e3643b19e885219', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: '0e94f5a19a6422a418852f92d922ea26d6046332', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'de5a265cee997d5b3111c22e9e810631f85abe7c', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-input", { key: '6b07fe9be9f538d1ede4d7fb3b906e387b1108e4', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: '1de7314fb5849f8e5f538aa40dd8a528538b4a4a', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: 'babc97fcaf560a255a710032f5c6c4f694653c91', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: 'c90e9b2e1aff5d4e87de1d5ee36706350804ef25', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: 'ea75cafcfe2bd87bcd929ebefc09db30a897aeeb', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: 'd4bf548be185a6cd0d241ad8ae5d21ce6f3625e8' }, index.h("wa-card", { key: 'd403d94e1c20f829570be00335ed315770f85147' }, index.h("p", { key: '183f3b66cb3577b08da000afd844c1a4f67f6f53', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: '1798f105b17f18015da6b0ed1a9d88b05a88f50b', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: 'aba680f5cd0375af57ba8126510730a6cf3733ea', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '9f2095c06155e3dea657c73f0bbb2f11c0278a2b', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && index.h("ir-empty-state", { key: '9fed3f356af89ff419cd9fb6c091a98c2331ac7d' }), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '9facef1d4d8057b4b8fbea6e8dfaf8cfdee557d6', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: '3910022da09474bc8c9e195a7ef2bac5c0bf8689', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: 'f9bbb5ade8bcb7fd10d2435a8dc05609315cf8eb', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'e0ec335e0d99356f84eb6aaffa781071803d56d0', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '1a38b848c1a62d4442c9dd34a685f4c7ab7e44cc', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'be601780841fc938860892a56d206f2f35977922' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'f41ca60cf25c06b6b4f310cce4c1aee853bcef87', class: "loadingScreenContainer" }, index.h("div", { key: '30d14d9f7931f0dfa825c130e57c7f976b248a01', class: "loaderContainer" }, index.h("ir-spinner", { key: '4bc3766013798c444f7c72774b6a3b85dc405459' })))), this.showModal && (index.h("ir-otp-modal", { key: '9fa3d714feb8df915003db8867c3659ae1322d93', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b146af693a01cbbec9afb3e4ca5e3add44a5e9fb' }, index.h("ir-drawer", { key: '49ffc555d696446acf2990ced7ca24d714d70c72', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '3cd380dacfea299f14fb7c355984a48d5a560426', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: '600e38365adcc47c0acde03a7bcbb76ef35e0862', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: '52918df5d5c6294ce9afeb8da6ab7c635a8a9c19', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '74f5de0687a1f6fa7b840eb918674396125b7e90', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'dd3dfb37285486ba45446269bd828205be1b8e57', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: 'e3af62b8d452c643912565a3ff60005030227df0', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: 'f2e0d88f5d7a462e05b0dbc32db0e22a4fa832cc', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: 'ad7aee9294e18edeee7ac3a5e0fe4d5fdcd5a1be', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c2e09200fe913e295ad0bc17cd7c1e2e67d2156d', class: "otp-input-container" }, index.h("div", { key: '899ca528866b7b39f64e0b9c77415cc2a4e2ba6b', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '9d3171ad29e54b79821a9a91f2e932eb28b90f50', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: 'd0275067c7758ea702bc69c70a6c4fe6b0723076', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: '5ef8fb4e56bf99400f3ed7f273709a04d0ab2eb1', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '6e778fd660302608a021d97ec2c5269bf6f820e8', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '032929ce6403644cc8c1c3ec6b9296397e125ee3', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: 'ef9b3b8922c72f97e4697c46a4f558e7b9425244', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '99ffb7d7d8bf26993610dfa08f6c82f0ec2e974c', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '22d8ad38497f2828c99bf5d7c7db6acec96d3304', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '48f4149aa4e4fab250094d64006bdbcc89710a90', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '15a316b4d6e062148460d9d215591d3efac9c7b2', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: 'c5adb9455b585c1021a6e258559c85ca4be16d8d', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'a689385f848ef3c08e2981c65254c1ec6628c838', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'c16d705512a87eb340287596ea81bd7487f5ad85', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '6433a00afdbaa22d3e2e440a3ea69dede2b20cfa', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '46fab8ef365733513b8d3c1df9a679d9a6305b3f', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: 'b19312013c180073123dc1634438a0869d458d8a', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: 'b50c2e8be749030a5ff71a90c4302e653fec6250', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '97fd852072639052443c4e319846d6392f3a904f', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5679c68bd980bc81e21390d5350f2094420ef56f', class: "payment-item__payment-item" }, index.h("div", { key: '586ae12fc16ee5e05bd6add9ed357ab457bda27f', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: 'f0728e2546c10d3d54afa4684646b99d1ccba6f9', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '3435bcc7c42f55dd5455f18c016f077388bcadb5', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '45e46c46f2fd187da2d006e37f2b0ca9d19f93ca', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '6faf403a8e6fef6990a951451f1cea61f2b38a90', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: 'd0fc320694fedc1ee91fa99e78204ea7f81249c5', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '4c1a06d2f2a792ea712da777eeb60b62d44e6aaf', class: "payment-item__payment-toolbar" }, index.h("p", { key: '10d25865322fcf12c48795a21f73d487a1628d74', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '961904e0d2ca580ff23fd0fe972fb012d47a72b2', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '95a831387ea5bfc57e67797ce5db00534ce83146', class: "payment-item__payment-actions" }, index.h("div", { key: 'f71b9b19e6d58b616989b08d9f9fb0436a99e186', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: 'e32065be775701708ff54866296bebec746982b4', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: 'e9e4dd11f03c5cac4707b5de80831072fb2a082b', name: "user", id: this._id }), index.h("wa-dropdown", { key: '522efca3f77ab64eb7b845c110ffb3fb8a4d7d3c', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: 'cd0e9025aa53f1e34b96477a047aebbd1d95c5a2', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'a9d809ef15ba3e1fa850ee7bde98bb84b4325c83', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: '67630330774812019412b925d96edc223db1973d', value: "receipt" }, index.h("wa-icon", { key: '093f27a38ea332ef08e240405a8f2e4a5f19d1d7', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: '42d691d5d42f5db1383bd3f007778a0449ecbaf4', value: "edit" }, index.h("wa-icon", { key: 'f12e0e64763332f3ed493e2f75e51bc77f75225d', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: '24f97778fcf2673b9560b29d73667d2f7debb9f6', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '45dc950aae82b995c187f12b45f124276a7eb4f8', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: 'f9daf4806c5a77499ae4d957e3f97eb2dcee07c5', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '0ae1331aacebe2aa3a83253ca9f00959a7b5cf9c', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: 'a6d61fb823a8eb86e0c8a182167c43a35dd9af4f', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: 'a6553b823615b39315c6aee2231e1f640bc97d26' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: 'f3a3a73d5e05e62a9e03f07b95a0e20ccbec856f', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '7540ccd49ef4cf28d3476ad739da23fe176196f0' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '9a8ffd9b68327ecdf3efed4a5eb5a053dfc6d573', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '526fc44b6adafea4173553be038b560d32609777', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '2e774eecce6e25a15401d1e3c15b674492676909' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '6b6803a3c615a2855aef96373d2e0fd42db09252' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '0b25673b0598f2f22335309bdd4a07c9de7d9d27', class: " payments-container" }, index.h("div", { key: 'c2fcea8766fc65e96352aa0dddda768d0b9158fc', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '6edf8433553e86c03ddf6e7f42a8ba29356a835d', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: 'ab380dfa915169652df25eda82a211f2e97c8039', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: 'c4c6379c37dafdc894b52e2be488dde5a8eebe83', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: 'ab4aa6ce6aa2efd1ce66a123269660a02bbf91df', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: 'be5053a59e65c84fb45ed04ce95fb60fcbd9b840', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6bedc661a661dfd3fca2a2a5cfe71d1c58623847' }, index.h("wa-popup", { key: 'd57f875386049a0c34d3315fb04a09a776d467ae', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '87097aef7b9eae52e8e31d734b45b1d0094be3a3', slot: "anchor", class: "search-bar", "aria-invalid": this.isValid, withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, onblur: () => this.inputPickerBlurred.emit(), autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: '66875b3620871e69edebd4a7eb49c9ad6fec4cc5', slot: "end" }), index.h("wa-icon", { key: 'b57edd12c5c822ea12fba18677671ccc3ec3f3cb', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), index.h("div", { key: '8285fc0a3061810cc6953ef59edddd11e8940bf8', class: "menu", role: "presentation" }, index.h("p", { key: '7fbc87e49579153dd90542d59fc742e2b7cba931', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: '63e9cf33709086ccf87aa27f264c92685ba2ffb4', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: '02dbcc291a07b946b549098652511e1c42d57c6b', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: 'f1d52b783d6ea2bfac842bbc0cae3739bacd65fa' }), index.h("p", { key: '529398a307f096be3880b5586469c83453967663' }, "Loading suggestions\u2026"))), index.h("slot", { key: '9be6eb3416d9195e5217fb494e3697a8269119fc', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: '140fe19fd14a8d02e257bd95711364f8e7809aff', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: '8fea431453d4d16248e5222a30f82da859ce6e22', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '0511abccaddbc69f25a24517b577d970610496e6' }, "No results found")))))), index.h("span", { key: '3f6eaa5654d74d103b3030d792ba0ff024c74664', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '5a257fceb76001f682d37e3040bd18be44e4aa9d', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'f38acdada220f7ae24639a0bc8a67bee74386912', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'a9aa83a8272dbd2d0f7f0fef3cda6356a8f21c65', class: "picker-item__check", name: "check" }), index.h("div", { key: 'a1781e226c92d804d5f0753997e9c7fc62a9189d', class: "picker-item__content", part: "content" }, index.h("slot", { key: '5adef740e00d4de58a76dbab1d5445845ff625d3' })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '06a4ed8e7e77ad086fe98061fe687237286c5f8e', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: 'af8a415fb6615134f07020c0ed0692031c9c13f8', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '263ef868d04a88162eeda81defa930a7694778da', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '295b2ac065ffd0913569ee500cf28fe96741d2e3', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '6ec2ac8d288c2720ce0b6898f3eb363ac8d9e520', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: 'c329bd17f2864559b595f645299806c4387c0edc', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '01abc7ae459245731807e1c0f3a18d6ac99d905d', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'bfe7467fef5a16f893ae8a3329e4e35ba42b23a9', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: 'd771aa4028941a25966fec3784d8635b8923c3be', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: '0460512155312e631487f310812c8eeb93bca18b', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: 'fab5808d7d56b3effca9842921d41ac3d309956f', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: '8d764c26279771d4033f9ba249d5748f4d43a645', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '11c3b35714e5c1172c6bfac6232e711aee72a4f3', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '9d9b09790ad8058edb22e2a7516f109c143899ad', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '5c89afbaffd1001511c0a86d7eaaa807727b0e55', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '3ab0db52332fb00bbba82073a65905f0efd6a401', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'a16b3e0b7dc59de68f367d60c9d069013ab5b300', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '6ddf55471953e3e6caee2af71aabaee7cc54f704', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'c3013698171acdacbd7f230f91f86811a91934b8', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '1e66576457d161d2e9877ea931c372e005d9c3b1', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: 'e0fac9eae19c0e7b1efc0f4735743a3fb171c770', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: 'aa0a6381dc864f96f17a586bb00569a59a25b904', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1a3b93d5949c347ed323d77223768e22f063a7c6', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '665033037182cd2e86f6e7b485615b4f58c21f7f', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, !this.hideDefaultAction && (index.h(index.Fragment, { key: 'a5c93a2cb81404e91a5efda919b99bf45a51af5f' }, index.h("wa-tooltip", { key: 'a27f5c2d17f980e7aa55d3032a8b9afc6b78de99', for: this._id }, "Print PDF"), index.h("ir-custom-button", { key: '240cf0e6d4abc110a85a2a054cb39f20d7e17323', id: this._id, size: "medium", slot: "header-actions", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'ca0dc57617236d4ca160275325a9d1aec180f4b6', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() })))), index.h("slot", { key: 'b06032ae3c12e0cc64c0962f45e67c9e8577ea84' })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: '9ad89bd425b716695cc983b6deb7713f148b7d9e', class: "ir-print-room" }, index.h("header", { key: 'b4eb736ad5c9b349ef924913981faf97ee991b8d', class: "ir-print-room__header" }, index.h("p", { key: '1eafc61ced4a2a48376102c198964b15e0b6f8a4', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: '75bc809e2c90caea6640c258cf3ea888faa30168', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), index.h("p", { key: '3fa924c8f28df02fdd3631001b59aa691d7ce3dc', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: '3babdc64abd4581a8d615673a81b9f5043848366', class: "ir-print-room__body" }, index.h("div", { key: '90dce4f71042fdd76c6a7f5ec47d81ae6fbe0aa6', class: "ir-print-room__details" }, index.h("div", { key: '6c6eb914bfb9160cf63f834771b77fbcff87e637', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: '400305f8f4ec57634de4b3b7c35a3d6a5bfed0e7', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: '0a8ac88f0d02cbfe95bcf01d8dd0a671037a2807', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '5d5242de5013fd6f3399d2e7e7c498e3f886891e', class: "ir-print-room__row" }, index.h("div", { key: 'c354351e782047c40f278df2df042cc42587eda9', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: 'f4de7f84404b863fd9cc96f593d39c7b44f7f910', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: '4ca35d8e59d325c1825c4910b4e31815db799e6f', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: 'dbdf897649456e3dac4d36845eed7e0ab40ff541', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: 'c47b4319943ca1e21197dcfc985dae9ae732553b', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: 'd4e9bc89e0d577b1c5fb0322f41e752f979155d3', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: '6395aec1d5301a648f6d08487e27cd2f9705869f', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: 'c01da4aeed0b92526324c37857dc55553bf65816', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: '0bc9e46411a3352fc7eaa1880c83c40444271dc0', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: 'f542a849b42f03d0732e9f7008400bf001105cc1', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: '5e6d85a375937dd9bf6cd6e10975a8a513abd1d3', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: 'a87e06fe8522f12ed75a547e9c80494051d18f68', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: '8e11823e994caa30065667a147cf87931944a33d', class: "ir-print-extra-services" }, index.h("h3", { key: 'e0c546e36bee99bd524363029b9e0ba73931c031', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: '09dfed0ae3fa16a7d752ca07321a5770193e387a', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '5da4e1c76346a5f8e0bef871eea4386aa9d8450b' }, index.h("div", { key: '7ee560548cc03b9320165d6082ab627fee874f72', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '81793b70f87b0ca70ea55f36d3f1bfdad27903eb', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '4b0d72aedd366b3d064abde99eeaab5aa1dea07a', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '50797872b4184075ccc5e64613f5e841b3931d0a', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: 'ee2b6757d86e4e4d86d441f04e52072bfd8ec8ca', class: "reservation-information__row" }, index.h("ir-label", { key: '158b62443576f2b107033d0fd0284ebfa90ba3aa', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: '99773589b011209de16124f1568e879d7a954493', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '1689f1db97aad3fd6973c0762d0b87a232be3d9d', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '06fc03dcfc8ceac7e9aa77d514ecb839c5b74f1f', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: 'c85bc85b03028bfb480c54af50177377549bef35' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '4b768c75e3d888c88d230df3193309c5a32e654e', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '43e410050f53bff9a3ec4444104111b97db13189', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: 'ea428f4ef0ffd6462dfa24eee3604c87a0292b58', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'f02c54d9476ce60bda22910227c2e16deccaecf3', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: '8f6d94c37241051a37460aa7baee9dabc10a8030', class: "reservation-information__row" }, index.h("ir-label", { key: '23f6cdf0f586222154488de25bf609c3b36917c7', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: 'b28173b0abe3dee998e2dad0b04ee5f11cb150d4', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: 'edbac3d5e413477756bb79252387703f01da285b', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'ac4611f8a01acf6a44f38942520c71ce45272c4a', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: 'c873d4a128944f85c0e1670297dec5593ca64f56', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '0e5f884c34909a2941c7011edc65697e63ac1244', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'fa6e828347d1995899b5119f82e60ef3322b22ab', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '2225883e5ed48ceb1f7ac85a3db9621ca5742a6f', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '83179110539476bffe80121693333e5c324cb9b3', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '248b481274724fc5c08d29c14bb81c9342145a1e', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && index.h("ir-label", { key: 'db11417a52eb45d82bf3d84c15156bfb4b46e183', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '4370c2ae5f6fb23c82b61323d730096cbe5cf430', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '5bf8118236b4e397884b522f52f413034eb1ff80', class: "d-flex align-items-center" }, index.h("svg", { key: 'dc32967936801a36cf25eedb3bfc16b1b76dd94f', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '1bd30fc2516befc639e04ba7f01d37256e6d9967', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'a839a129cf1a8cca17a42000f96c1898caa227a3', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '3f13259f5baa6cba8eb714c37f3b30e0bea70b11', class: "reservation-information__row" }, index.h("ir-label", { key: 'da02514f4a71a0d906aad9f16cfa1d346ea53eb1', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: '033b655794972d21345b9e4523d54af1e6640c13', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '036bee3c6687042d74a3e2f35fd54ccef5a8217c', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '1c9652d50509b3faa823c8bf1e07e3c72c3698ae', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '596ff6ab226435db6b1ba8080813ac7d954c9b04', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: '59b56cf1b808c397f5457089a56aa86446be78a5', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '711376c363a2af90c40f65107c435c9b156266b8' }, index.h("div", { key: 'a56a3f27980f5ba628e8491a703859456eb945f4', class: "booking-room__header-row" }, index.h("button", { key: '481cbd09d7bda8c91641deee2a7596d45efe826e', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '4e37ca111ac53c467eb526cd4bab03063bb6a8d9', name: "chevron-right" })), index.h("div", { key: '045401f2727e6e23c5b454e197dd890fd995a807', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'eba5bcdf818ed96814b7a6e422d713b3c9c5f82e',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'c77d1a1a24f44f16bb43038e8769e7b5a6b3d550', class: "booking-room__summary-row" }, index.h("p", { key: '35609bc78bb63431440b2e47a6f542a9ae680386', class: "booking-room__summary-text" }, index.h("span", { key: 'd880ed3b4841df759fb0c0a858e8cda015a27ba8', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'baf5a574dd7da7ae5c821a8cdac12d8a0cb46169', class: "booking-room__price-row" }, index.h("span", { key: '15a5c99694faf91fbd8e52e9fc96331b283b99eb', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: '35303b16c1aaf2a5882354ce8ab27fb36fffc65c', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: '1bdfb7d19ec4d04e558740b5dfcb7b5182b5549b' }, index.h("wa-tooltip", { key: '32a5066b6b06f25e5846b6bc93495ed91e71a659', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: '7e093233767f3f8ac0e8afd163481bf6e4e695fa', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'e7915731b9327461c4a6a490f8cd9930c36bc610', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: '14e15a5ccc5431f77fdcfe7f199933d04e9bb34a' }, index.h("wa-tooltip", { key: '3e3f14be2b6d3f9ad952752bd63e68353c19165d', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: '3c13f2d4f768fa64b4541778c47c4595d812b491', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '4b3a11c8b762067ad2412460fae21bc140765ec7', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: 'ddaac93b07f6cc976acea4353465441f84b17f33', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: 'eb6a1f595d8b6bf349a25a2c73a36647e318950f', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        index.h("ir-unit-tag", { key: 'd19d760ba42118f9eb821f494203c546e5532c3f', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '2749ede12cbc4962d066ccce4a7e157d4418f432', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '92a7fd7d12b549844c32a142b7bd8313c8e4ffb8', appearance: "outlined", variant: "brand", onClickHandler: () => {
            ...
            }), index.h("tr", { key: '29f7fb218b4d3bede6d4697231b79c2abfb0540f', class: '' }, index.h("th", { key: 'b3dd29f648f8645d3ce2d7354bf0f91b935b37b7', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '0de4632bf2db24d09e4dc57f2e7f343b90f8e0c1', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '7042aa2b25f1d7eecd1298f559b12212610556ba', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '5b83ef648d5643d5c4910a52e58cea6c569f0349', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '1db76be2a7383e93e5b1f7e12cdd3362def89815' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '80e40c56d509e0c768100a3361e76f187f339dd4', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '9cfd8a4159529383e99c5c36cffc86dffaa23e0c', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: 'c207d6eaf8e334b426359e7b38747d4511922ac9' }, index.h("ir-label", { key: '644178a654c92af2cf39b8a2dedac000eb84dd56', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'dec07952b6710f8123d7cd9405e0da512d24d6bc', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: 'e7c009ea0b954b29f8bb66e191a3a96820a9c00f', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '0d2a6cc4f9b8297b8f73a25c5aca9c7f7a59d576' }, this.renderModalMessage()), index.h("div", { key: '500a7cab60229208545ab676d8fd02168a382d48', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c2ca4cfdd59aa2720183d67e15b7fb793fbb665d', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '3db2e9ccfe0eaa67de83546caac0df918c135875', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '8691ad821d7a1ac464696c6699ea2f60dbfcd626', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '594bd2164d5621676a54218aee40a403f1ef6ce2', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (index.h("ir-drawer", { key: 'f0a5dc1f3f2486cc5954a12d724f023464e097c8', style: {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3a4e1de31fd25dacdbfe404250ac5f8fe36a092b' }, index.h("wa-spinner", { key: '09a6e3749873421db517631ae17470599705c06c', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrToastAlert = class {
    ...
    render() {
        return (index.h("div", { key: '3bae2d7ecf4b8848fdbfb8768d859fdd80eec9a4', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, index.h("wa-callout", { key: '0da3721bf1e96dd8f95a36a2e95010cc82502639', variant: this.calloutVariant }, this.getIcon(), index.h("div", { key: 'b1b8dcc897d61e3e513166409328d2418c79e2aa', class: "toast__body" }, this.label && index.h("h3", { key: '54452811e2c82b8f9ba559cb224c12219c6bd5c8', class: "toast__title" }, this.label), this.description && index.h("p", { key: 'c77cdfad225e8e1aa18c2ac64b900e6066fe1213', class: "toast__description" }, this.description)))));
    }
};
...
const IrToastProvider = class {
    ...
    render() {
        return (index.h("div", { key: '9f1ed8ca4bd15b7e6bdf8f853c1160fda565b1e6', ref: el => (this.popoverRef = el), popover: "manual", class: "toast-popover", onToggle: this.handlePopoverToggle }, index.h("div", { key: '9c3da1d3cd35189e04e6cc22c52f73eb1cdcf266', class: `toast-container ${this.getPositionClass()} ${this.rtl ? 'rtl' : ''}`, role: "region", "aria-label": "Notifications", "aria-live": "polite", dir: this.rtl ? 'rtl' : 'ltr' }, this.toasts.map(toast => (index.h("div", { class: "toast-item", key: toast.id }, index.h("ir-toast-alert", { toastId: toast.id, label: toast.title, description: toast.description, dismissible: toast.dismissible, actionLabel: toast.actionLabel, position: this.getAlertPosition(), variant: this.mapVariant(toast.type), leaving: toast.leaving, onIrToastDismiss: this.handleToastDismiss, onIrToastInteractionChange: this.handleInteractionChange })))))));
    }
};
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '600cb85b653577a3065e79537ae63c6b0c0cde42' }, this.showTooltip && index.h("wa-tooltip", { key: '88586fb81d57d4777dfd7f82340d4093389bdfac', for: this._id }, this.unit), index.h("wa-tag", { key: 'e67f07b1c09b5494fec5c0035a6ac551db396875', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '1f68831762f0a48b4e0dea82113bf4edc3a34b46', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: '712152d9857c41d24caa81a83c01513f87bb8f09' }, index.h("slot", { key: 'f9042654e6de46e5b79c13e7d7547d8d1dc1f2fd' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: '1e587c6a9b73f182be6596c122eaedecde7f4977', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_79.cjs.entry.js.map