...
require('./booking.service-6916e481.js');
...
const IglBookingEventHover = class {
    ...
    getInfoElement() {
        ...
        //   </div>
        // </div>
        index.h("ir-label", { containerStyle: { padding: '0', margin: '0' }, class: "m-0 p-0", labelText: `${locales_store.locales.entries.Lcz_RatePlan}:`, content: this.getRatePlan() })), ((_e = this.bookingEvent.DEPARTURE_TIME) === null || _e === void 0 ? void 0 : _e.code) !== '000' && (index.h("ir-label", { containerStyle: { padding: '0', margin: '0' }, class: "m-0 p-0", labelText: `Departure time:`, content: (_f = this.bookingEvent.DEPARTURE_TIME) === null || _f === void 0 ? void 0 : _f.description })), this.bookingEvent.PRIVATE_NOTE && (
        // <div class="row p-0 m-0">
        //   <div class="px-0  col-12 text-wrap">
    ...
    render() {
        return (index.h(index.Host, { key: 'f23f255d4b0ada1a5a1fdf04ba81d82c433b37ca' }, index.h("div", { key: '9fe5368405d22279e1ae39492178af5c5c31588c', class: `pointerContainer ${this.bubbleInfoTop ? 'pointerContainerTop' : ''}` }, index.h("div", { key: 'cfe1adfcb9f6e796eaf4f2853bec6205baf5aa60', class: `bubblePointer ${this.bubbleInfoTop ? 'bubblePointTop' : 'bubblePointBottom'}` })), this.isBlockedDateEvent() ? this.getBlockedView() : null, this.isNewBooking() ? this.getNewBookingOptions() : null, !this.isBlockedDateEvent() && !this.isNewBooking() ? this.getInfoElement() : null));
    }
