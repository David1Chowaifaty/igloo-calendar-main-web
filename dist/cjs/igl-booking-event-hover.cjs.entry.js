...
require('./booking.service-fe6bae45.js');
...
const IglBookingEventHover = class {
    constructor(hostRef) {
        ...
        this.eventService = new property_service.EventsService();
    ...
    getInfoElement() {
        ...
        return (index.h("div", { class: `iglPopOver infoBubble ${this.bubbleInfoTop ? 'bubbleInfoAbove' : ''} text-left` }, index.h("div", { class: `d-flex p-0 m-0  ${this.bookingEvent.BALANCE > 1 ? 'pb-0' : 'pb-1'}` }, index.h("div", { class: "px-0  font-weight-bold font-medium-1 d-flex align-items-center", style: { flex: '1 1 0%' } }, index.h("img", { src: (_b = (_a = this.bookingEvent) === null || _a === void 0 ? void 0 : _a.origin) === null || _b === void 0 ? void 0 : _b.Icon, alt: (_d = (_c = this.bookingEvent) === null || _c === void 0 ? void 0 : _c.origin) === null || _d === void 0 ? void 0 : _d.Label, class: 'icon-image' }), index.h("p", { class: 'p-0 m-0' }, !this.bookingEvent.is_direct ? this.bookingEvent.channel_booking_nbr : this.bookingEvent.BOOKING_NUMBER)), index.h("div", { class: "pr-0  text-right d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("ir-dropdown", { caret: false, onOptionChange: async (e) => {
                var _a;
                const newBookingColor = e.detail === 'none' ? null : (_a = calendarData.calendar_data.property.calendar_extra) === null || _a === void 0 ? void 0 : _a.booking_colors.find(c => c.color === e.detail);
            ...
            }, style: { '--ir-dropdown-menu-min-width': 'fit-content', 'width': '1.5rem' } }, index.h("button", { class: "booking-event-hover__color-picker-trigger", slot: "trigger" }, this.bookingColor ? (index.h("div", { style: { height: '1rem', width: '1rem', background: (_e = this.bookingColor) === null || _e === void 0 ? void 0 : _e.color, borderRadius: '0.21rem' } })) : (index.h("ir-icons", { class: "p-0 m-0 d-flex align-items-center", style: {
                '--icon-size': '1rem',
                'height': '1rem',
                'width': '1rem',
    ...
    render() {
        return (index.h(index.Host, { key: 'ec4dc67336159f0af1981718b9f849f23d23fb16' }, index.h("div", { key: 'bb0ae4ff743aa9c58f4edb558b0262a2b2c15b89', class: `pointerContainer ${this.bubbleInfoTop ? 'pointerContainerTop' : ''}` }, index.h("div", { key: '7c96a0b57633a0a074b3e83238280895de336d96', class: `bubblePointer ${this.bubbleInfoTop ? 'bubblePointTop' : 'bubblePointBottom'}` })), this.isBlockedDateEvent() ? this.getBlockedView() : null, this.isNewBooking() ? this.getNewBookingOptions() : null, !this.isBlockedDateEvent() && !this.isNewBooking() ? this.getInfoElement() : null));
    }
