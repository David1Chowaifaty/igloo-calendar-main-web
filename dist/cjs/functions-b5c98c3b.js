...
function transformNewBooking(data) {
    ...
    rooms.forEach(room => {
        var _a, _b, _c;
        const bookingFromDate = moment.hooks(room.from_date, 'YYYY-MM-DD').isAfter(calendarDates_store.calendar_dates.fromDate) ? room.from_date : calendarDates_store.calendar_dates.fromDate;
        const bookingToDate = moment.hooks(room.to_date, 'YYYY-MM-DD').isAfter(calendarDates_store.calendar_dates.toDate) ? room.to_date : calendarDates_store.calendar_dates.toDate;
...
//# sourceMappingURL=functions-b5c98c3b.js.map