...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: 'e12c2671cfaac2257169161057d73d96e152f287', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '13818ac6fc1b7c66fc98d950630d5876d5df55a3', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '86c3f17923f95d1d43cacc2afc5241b9a273d64b', ref: el => (this.titleEl = el), onCloseSideBar: e => {
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: '0df233ad92f4feb8ee1b6f89c2fa16587f8d2d12', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), this.selectedTab?.id === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
