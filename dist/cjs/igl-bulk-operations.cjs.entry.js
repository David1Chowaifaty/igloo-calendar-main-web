...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: '12491e6b710095a83e3ea7dc69e0e82698377529', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '8088f960cd78dffef4e280701522981d904e6288', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '3c835fdb7c5aafd77c4a03148c31e9879d6d0b2a', ref: el => (this.titleEl = el), onCloseSideBar: e => {
