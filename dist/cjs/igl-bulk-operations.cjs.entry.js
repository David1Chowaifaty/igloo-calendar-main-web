...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: '969900421fe0b242a377655540589299e7a88708', class: 'bulk-operations-sheet-container' }, index.h("div", { key: 'e7a90768c4ec465800273c7d86f2b3ec9dece9fa', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '2597b61d00fb1d0a09722ca6cacd8fa4e1285087', ref: el => (this.titleEl = el), onCloseSideBar: e => {
