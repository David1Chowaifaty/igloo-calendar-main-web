...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: 'cc604e51997282b6a2cf304aacfdda6b6efb9f6b', class: 'bulk-operations-sheet-container' }, index.h("div", { key: 'f94c57d61f713496e0ccbfac3e5401a146a2af7d', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '12b0a3fa9c2f1ae988dfff7f13149531c8a2a522', ref: el => (this.titleEl = el), onCloseSideBar: e => {
