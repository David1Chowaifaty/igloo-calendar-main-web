...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: 'e95c5d42f8f274a237e64250ab1daa84a2d85bb9', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '2e13f6c53ab8d3d565e77d73efa497a76f58875b', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '0101d43f84cb829eea6aae53306ed2fb58e82864', ref: el => (this.titleEl = el), onCloseSideBar: e => {
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: 'cd991a6aac054af59feb0adebac222328f5d2232', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), this.selectedTab?.id === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
