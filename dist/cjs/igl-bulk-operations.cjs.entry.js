...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: '65b683bca982d68fd338442c07810e98cf6a86c3', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '35b04e95ff2bc76bdc08dfefeb52943ec58b26d9', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '87e8a827c8c8a7305bf14b1dfa2eb96c27557799', ref: el => (this.titleEl = el), onCloseSideBar: e => {
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: '167e97faab893eb14877eac8d85c9f960527908d', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), this.selectedTab?.id === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
