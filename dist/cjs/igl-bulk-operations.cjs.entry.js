...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: '10b19cf27642f92de10a002eba7925fa19e33ff5', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '1fb9d23355663639699aed1f69e7643dee2f4253', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'f28f017a03d658c380c0e7aca905029d134e271e', ref: el => (this.titleEl = el), onCloseSideBar: e => {
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: 'a279dc08a66a17ff49ddb9fac17c4682792a0315', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), this.selectedTab?.id === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
