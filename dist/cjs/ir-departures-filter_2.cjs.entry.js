...
const IrDeparturesFilter = class {
    ...
    render() {
        return (index.h("div", { key: '6b104cc60951d93fd6552d0e8403780f276722bd', class: "departures-filters__container" }, index.h("ir-custom-date-picker", { key: 'a69624c076aa85bc6180493a86870d08f22821a1', class: "departures-filters__date-picker" }, index.h("wa-icon", { key: '216271031ef9c5643ce80eb4a490e7a77e93ab6e', name: "calendar", slot: "start" }), index.h("wa-spinner", { key: '42d778d8cb68a52f54a221410c5b666b669e287d', slot: "end" })), index.h("ir-custom-input", { key: 'bbbaa474810da46b072f70ddb87400b2e0834481', withClear: true, class: "departures-filters__search-bar", placeholder: "Search guests or bookings", value: departures_store.departuresStore.searchTerm, "onText-change": this.handleSearchChange }, index.h("wa-icon", { key: '0334b228fe92020e22d78868c03d1820ba3055dd', name: "magnifying-glass", slot: "start" }))));
    }
};
...
const IrDeparturesTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9c00c1de05bd81bf910002dbdd13e474f31287d3' }, index.h("div", { key: 'f36b535ea59486fc5314e7178c29361c1fda32a0', class: "table--container" }, index.h("table", { key: 'be6e3c321552790e7ceed8dd3890044ecc37299e', class: "table data-table" }, index.h("thead", { key: 'c3d2bb8e4813c3128cadff9cb92b58564bbe15d6' }, index.h("tr", { key: '5463909845360def693f24a872b86a930582271f' }, index.h("th", { key: '24171bd466aa2fba1af23552f3b8c36d6e6c600c' }, index.h("span", { key: 'eea6c328a35a16bf61c02311f296476f261070b2', class: 'departures-table__departure__cell' }, "Booking#")), index.h("th", { key: 'bfb044451c8deafdb50b0f6629d18ac91f4a6550' }, index.h("div", { key: '93a80f4bd4351aca7adfeb433044a99e68b74b0c' }, index.h("p", { key: 'aae96d218353901ca7ef8604e092fc24cb8cd43d' }, "Booked by"))), index.h("th", { key: 'be621b1f8ffb1e4d4c1d19c94b4097f51c753804' }, "Guest name"), index.h("th", { key: '4c91079957d255727a976f2c1f42818d22ef3101' }, "Unit"), index.h("th", { key: '50f4f56675f754bf7b384cb5a3b82153cfc95135' }, "Dates"), index.h("th", { key: '9f78697c12b10dc992abde9b0f994f254073f5f0', class: "text-right" }, "Balance"), index.h("th", { key: 'f33d4a95fa854870dfeecbdc800c7bc75ea27756' }))), index.h("tbody", { key: 'c8183065103397cf0473821bcb442155d1dd6138' }, this.renderSection(needsCheckOutBookings, true), this.renderSection(outBookings), !needsCheckOutBookings.length && !outBookings.length && (index.h("tr", { key: '4c3236f1159fa0ee1888cc3c989a5a4dd27c9c71' }, index.h("td", { key: 'a20f8a8fef81363f102d3ff7b993656b62430616', colSpan: 7, class: "empty-row" }, "No departures found."))))))));
    }
};
