...
const IrDeparturesFilter = class {
    ...
    render() {
        return (index.h("div", { key: 'fd7c9a2da5fb11ac6fcf8c2f38f6fc81713b02f4', class: "departures-filters__container" }, index.h("ir-custom-date-picker", { key: '1820989a4a4541017205f4a5493733617ea45708', class: "departures-filters__date-picker" }, index.h("wa-icon", { key: 'a5044ab2d71deb0dc6da06290e02e6f61a315104', name: "calendar", slot: "start" }), index.h("wa-spinner", { key: '76cb9406e8797250ce7d577cb69bc7ab4fc9fc39', slot: "end" })), index.h("ir-custom-input", { key: '06691b0cadbc62f2a598376dd17c432e5ab5afa5', withClear: true, class: "departures-filters__search-bar", placeholder: "Search guests or bookings", value: departures_store.departuresStore.searchTerm, "onText-change": this.handleSearchChange }, index.h("wa-icon", { key: 'dcb83127c4e49758cb9b5be4ea24d4097e3e8ecf', name: "magnifying-glass", slot: "start" }))));
    }
};
...
const IrDeparturesTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '512018d685f1bc0e8836067f29e992ccc01e5b7a' }, index.h("div", { key: 'f8d76b20d731dbfb68e74201c243cb57bb4f1f0c', class: "table--container" }, index.h("table", { key: '09a7f13b72d0e63f58e5365086a74eced2e980b4', class: "table data-table" }, index.h("thead", { key: 'b6b920101601a4ac9a69d144fc0564a07704e7bb' }, index.h("tr", { key: '598405b61ac9b6c707feade50b897c44df504075' }, index.h("th", { key: '78ec5335df3355739e6c6fce7200d7f4b94a2f82' }, index.h("span", { key: '587f1163d278613d2ebd59f6d2c64b3734259131', class: 'departures-table__departure__cell' }, "Booking#")), index.h("th", { key: '45ad1fc0dc65e1d2212cc29013c2aa7943287a5a' }, index.h("div", { key: '4b9a0e50e288546098e57052ec7d7d54a9f5bee8' }, index.h("p", { key: 'ef9c3e5355a8c1f149e9cedadac975a52667841c' }, "Booked by / Source"))), index.h("th", { key: '03079288de13a8df64dce551bd3c1b442a8b3f9b' }, "Guest name"), index.h("th", { key: '39713ead8df5c65b60bea92b3d733d0880c272c4' }, "Unit"), index.h("th", { key: '09e63edb8804c53a805cbd9eb37deb6f98e01c4f' }, "Dates"), index.h("th", { key: 'b02aa7ddc58e05f39b893577c3e827eb9a8c1527', class: "text-right" }, "Balance"), index.h("th", { key: '16363ead8d6e7282e7a0948c8ae1e46663b25efe' }))), index.h("tbody", { key: 'a0dfc5b45b72e027646ec07d753ab283dd8fe98d' }, this.renderSection(needsCheckOutBookings, true), this.renderSection(outBookings), !needsCheckOutBookings.length && !outBookings.length && (index.h("tr", { key: '51e6e165a9cb71e53349bf3dc014cf27c334d86e' }, index.h("td", { key: 'e836bf8bccf8b0578eb1e3b4fc42081cd0840bf6', colSpan: 7, class: "empty-row" }, "No departures found."))))))));
    }
};
