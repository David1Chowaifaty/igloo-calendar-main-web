...
const IrMComboboxItem = class {
    constructor(hostRef) {
        ...
        this.comboboxItemSelect = index.createEvent(this, "comboboxItemSelect");
        this.comboboxItemRegister = index.createEvent(this, "comboboxItemRegister");
        this.comboboxItemUnregister = index.createEvent(this, "comboboxItemUnregister");
    }
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6c22e99f353ac07f3c8ddccdf23235be63bb00eb', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true }, onClick: this.handleClick }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
};
