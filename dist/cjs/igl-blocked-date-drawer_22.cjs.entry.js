...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'e57e3761f3fa0f65849b370a38b2d2933441c7cf', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: '7d637ca9025549dd237aa16526d3e66ecbcf9cad', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: 'c9a215391382dc8dcea7df240b9f4722e9d7b140', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'b8ee57ec48be17aa07fe3f57519161da86539675', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '36447bded6c2a8e269809edc4c3045fb35fc9df9', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '880d34f7718dbdb55542f0148beff14264eb15c8', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '53748245eff86894fbfd4e4c4ba4e63e7462227a', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: 'd8d94196c7779b87207959fe59ac86a60c639442', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '3673c65de3b33a8207a09b9ec710b45917e764ba', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: 'a9354a00cde8193f445a58b77a61f9afdfac236d', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '1121352eb8ee871f608a904d89cf23467a337762', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '27c7b1b6096ed95e5c046e3d46a4baa8f621b07f', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'eacbe7c4603620de564ecbdcdacee9ccef42450c' }, index.h("div", { key: 'ec01e16c40883495158c0189f59fa59e863604f8', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '4eb7b000c4bae897b7af21aeb41cb18baac91824', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3acc1c1503f5a0a6dac64ce3652a2e54b785855c' }, index.h("ir-drawer", { key: 'cca26e8887558d68a943778a7f703a78eaa70ffb', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: '216b3f943ed9c95bdccb0715e3e9b89e380a393b', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: 'a6e289a1422ab29df46c221ebc9ee0844113268f', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: 'fd760502fa4f45b0f68e002294e263cf72615f13', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '9c4f0359249be208accb36799f6b9ab574c42175', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: '4476217b24ca10e39eac7d5ad4d114259fae8fd3', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '225fb4cb4b514b9f8bcb241cbc16002efcc9ab38', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: '33dbeef4e9d3958cc419a1c781739591ebed1703', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: 'ee915c3a66d651624535165905429438bbac1cb9', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'fccbced5aa7ae8410339065bf5aca8f8f4d8fe2e', size: "m", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '867bfc7762fcbca0b48dbd37078bede71707d4f5', loading: this.isLoading, type: "submit", form: formId, size: "m", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6011b7f4f695c997291fa22cf10c38a54eb81107' }, index.h("div", { key: '7e34b70a07eeec9544b8c9bcf1ab12b69d855d13', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '5287d2bb7aef56c406fe7e90b6993678d591f2bd', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: '9b4c894946473d242d565b6da0a34278066e0b28', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: 'bf426979af0be435756616534974b6556cbc50fd', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '07788dad80462444ae7e3db17e8c8cb56925cd4b', class: "footerContainer" }, index.h("div", { key: '7c6d851c44427fb97e98349157c3828ebc23ebab', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '5ff0c42c555a2efd926e65691c34e04119b30021', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: 'ac18436ba29221093bf983eb4e6c6e0854a3366d' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '522414a281ed175ea3d0a3d0c5d505c91201046c' }, "v1.51"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ea06d6e0b52344fa02ea91c80932c46175b71c13' }, index.h("div", { key: 'e44b61dcff24fc6128ff7748d4b986217d2a371c', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '144ef2bb26bcc2dc6c7aa2abe2d0fddbc31ebe7a', class: "header__fd-actions" }, index.h("div", { key: 'f47473728de31fa95ad37a2032084a0917ef0053', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: '57c85d6ffd61e840ad16c3c192651eab5ed6a90e' }, index.h("wa-tooltip", { key: 'ba49d54eb8f754ad06f7dd4adc5a060216d51a55', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '8592292812bb030e917f25e7db583d87488ca857', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '5b5ff9be47e0fa967d4d551b9429b2bf1a460542', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: 'ca07ecd211f820984892801392bcc42c944d12a6', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: 'b83f2e33a45fed40569ab636d0d4a81276d08d1e', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: 'c79c2fccc11a4e9aec3f0dbefadc5a2377a28166', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: 'eafbb55e5d483d8d1e3e04b66e72bcb495709cca', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: 'a208ebf841940a413c0438b22aefdbf78c5fba04', class: "fd-dates__actions" }, index.h("wa-divider", { key: '42c874be4c5aa290a554b773f25225401ae33f58' }), index.h("ir-custom-button", { key: '88bedcb34a2b5c790958f59a5176e4bac3de6f71', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), index.h(index.Fragment, { key: 'd28c53e954ecad1b98293e3adde6f67b0800ea67' }, index.h("wa-tooltip", { key: '859788b684f440dbbffaf94c4a461e8c5e9b68fd', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: 'f26ac2c4535df44885ae7eb650efbc9239e74806', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'b040afd9140b30a52d8de82733725b61280bf7dc', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: 'b9a6e50b7f64cab9d3a9e70aefe80b84a6dcabe1' }, index.h("wa-tooltip", { key: 'f92d8502081f72fa1bfa108f1642597e2887d652', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: 'ec5c8ad4a527dc16bfd760afae3662397652401b', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'c4afe5808856dda26affd2c98539bbf9013f621f', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: '9c25372db56ff21d78ebf0ed21cbf35d9857c391', class: "searchContiner" }, index.h("ir-picker", { key: 'dc268586964f1d1fd9c2d9b0aceb3c32e5895c2c', size: "s", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: '480fcab535ec0e1cb84b66545023cea5a6d74fd9', class: "stickyCell headersContainer" }, index.h("div", { key: '4c18b91e01af4602353ff85e4e36b2e3ce3a298b', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'c793fb98e003c15a4d9c0efcc849c6556e60fff8', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '25d50b34738aa7a4ce70abd1d8dac0a68d9ca29b', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: '12e373e49fac5ef115034739237f050f0fc5d40c', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: 'e214ac28e99ddbfbe304c0cba070a2d2931f7043', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '0c235b6431370e024b1e22dfa92703775f97f0e3', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: 'ac8c9ebc90b389369c692c910b32582aa916eb8b', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: 'ad79174c6e427fd8f4cd0ec9f00471af44789c97', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '7d24a3810b7a97f845e142e627add178a7063ecf', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '115ac9b53151ce64c38fc8976acdc04cbf968be2', value: "hk-toggle-clean-dirty", size: "m", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: 'd1e7f119eb935571d071479eaa0f95865b259172', value: "hk-clean-inspect", size: "m", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f35408782a9d00b940e01c844bf2e4bcdaea3c98', class: "legendContainer text-left" }, index.h("div", { key: 'ff46092eeda6646d2d50ddbf169ef6ff47206de4', class: "fd-legend__header" }, index.h("h2", { key: 'f4f1e5e764f6dcd0d7600434b8dec52d59978ea1', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '5bd5a8b5907fcee6ce20bf9f94aad904f46ed2a1', size: "m", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '6b2666d331c1f8e8036305665cd5f6f67f8df235', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '44f28f901eefc7579537920c65face0ea87b72c8', class: "fd-legend__body" }, index.h("div", { key: 'd9fe6f0f7a6c2a8ad8c820774be00596b306d4be' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: 'bdc1276721997f8d314ee2fb3048183fc9df3091', class: "fd-legend__row" }, index.h("div", { key: '942090e9aeac05cfbde56cb2d1d22ac7877f2c2b', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '305f72a74bd0849031629533f6ba199370ddb5ee', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '6066653ab9e6504cd8026c6d3cfa3fb55fe477a1', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: 'ed245312d8d45f149cb4f4932d42eb3d9b83f534' }), index.h("h5", { key: '2de989aa8ec068e7ffec53dd9df33cc9116ff6df', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: '38967a2cada390d346741e3344f27da0c0c1aead' }), index.h("div", { key: 'f6265f36ebf1a972fd0fdf3288d513713750c507' }, index.h("div", { key: '6a6c046ea6236001286687d246dfd40490c48a58', class: "legendCalendar" }, index.h("div", { key: 'fb7aefe2449723d137c1436208f61ee030741ee1', class: "legendRow align-items-center" }, index.h("div", { key: '886877921065f62da17ac501ed7211289c77e5ec', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '332e6f166eb60c6036b7aea3e216f04818a01f2b' }, "MAR 2022")), index.h("div", { key: '707b57017f01882fd9d25f1e7441893cc9b8d1f4', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'be0f6571d4b891eddf0c488c3b581ebf957ba939', class: "legendRow" }, index.h("div", { key: '45fda9e928ed6e529d523476f1ecec7b53ef390a', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '34c523c7f3e1f6c7e49eabd6b1431233c3402ca0', pill: true }, "3")), index.h("div", { key: 'da5dcd1a9f4d2c7bd6668ff0ef55fce085c56892', class: "hyphenLegend" }, index.h("div", { key: 'f41e902e058fec66f131ba352436da5621399ae0' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'ce498384469d83bf9107cdb80ad932791e817cd2', class: "legendRow" }, index.h("div", { key: '446fbed489bc990835a79527a3e3d6c0fa7a17d5', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'a343411b34e890c1b754600809c610980b43ae32', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'fceca9ef116afe778f98204e19a21b6124c1ab36', class: "legendRow" }, index.h("div", { key: 'f7634beb98f590517fc0c5b251528c9d04358861', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '4d51985475d031067ccc8fd62190a36c014fe395', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'e89c3a8c02ff565140590df5e5a7fb0784ef8316', class: "legendRow" }, index.h("div", { key: '70d06ffd3f9ac148ba3a25891dc114bb8bdfe152', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '1f9a9f396917267c5b1e69f830775d9988d74dc7', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '9ba679a69f649786d72bb64f6412bb7317bfaa1f', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: 'a8b86bf8221e7e83a4f9d83654f63bf5621aada4', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            ...
            } })), index.h("div", { key: '416cf5666dbeffc13cf15bf2111f6a5439156ef4', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'de6b13699bb8972fbcdc43b08e43799f4e9b2849', size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '97f4a458c39439520d49605a68b8b8bc40f30574', loading: this.isLoading, disabled: !this.hasInventory, size: "m", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '9e16c813ab441acc67bff7c0d67dac26ed77017a', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '0ac987a9183b431489f76fd73ed537e6900d051b' }, index.h("div", { key: '1ed4bc519075463348f9d4a0f64dc0ca84b995ba', class: "dialog-body" }, index.h("p", { key: 'f61eaab7bf6bedba240fa43e8c988700e8135f4d', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '9ca1b8f0fa779d5909ceff1f8fb68aa97af012bb', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "s", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '5243d32e221877eef9428dbf793480863ed53043', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '8a7642aeb898a77426a1f0f7a17fc8b4f28584bd', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: 'becff5144605a3684692b648848b5a3880659f7d', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "m" }, "Cancel"), index.h("ir-custom-button", { key: '83cb395eb13bc9e5f8fbce10460fe8b6c8207009', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: 'eac17286b340a4496d7771dc5f9fcbbffc52c0de', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '3b0cdb94f12cf30f9992637756614bfceca7fae5', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '3a78e3262940a459b042220e38be8193fc1ad88b', class: "px-1 sheet-body" }, index.h("div", { key: '2d8300d5a33aeb115784efed7dd5aceabcfebbea', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '900799f02ab5ec441ae70223b008e47e2daf418d' }, index.h("ir-date-view", { key: '0daeb4ccc447204756eadc1791d642056fcb0877', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: 'dacf82b3a730dcfc9124ddd048703caa94c28030', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: 'd756fe5f96996acc2a4cdad94ec0e2247cc7607f', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: '4c08effdef77a132e1e408636012ad36e5e3fa24' }, "From:"), index.h("ir-date-picker", { key: 'eb5fe39edccb910138a4a020e6f7d4c72dcfd1be', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '1c729e91b58afc69d6323d7dc67ae50a072fba9a', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '8420c1fd12e2319054fce46cd51c4f6ad580aead', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: 'b318deaa59c19723fee8924a09d2335dedb6b5fb', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '0d3d520cd92a6ca17f7f49c2fe39d886ed18fafb', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: 'd556864659242f1b31e92aff09f33e34767613f6', class: 'sheet-footer' }, index.h("ir-button", { key: '0c1d1b8d64301119ee61904ef43295777f57e2ec', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'd07eaf87042bf943af0990b4042db78145dc8735', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b7c62979a896f369b6fdd0d5475c01a3764165f' }, index.h("div", { key: '2bf678de2df93aa9dbe311112e0f5ae3f18b77bb', class: "tba-category" }, index.h("h5", { key: 'c776d340589147984f8604a61e11a308c4d8c13c', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ee43d18defc14166bdd8b0e884c49061e2e770e4' }, index.h("div", { key: '98f5ca461c32f82fcbfbcdfc7873831d1e4da031', class: "tba-panel" }, index.h("div", { key: '0c27b91537717e23ed56906b68276162baff07e9', class: "tba-panel__head" }, index.h("header", { key: '1526abad2161776cb8003799c3f6ac10578158b4', class: "tba-panel__header" }, index.h("h2", { key: 'e636bb8e3629d9fa560fcbb38cba0a250f4e5c86', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: 'b4c6e4be41f26249f174a2f32acc01124ad852a6', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: 'b04b3dcc34516ba71afacb2c311cd446e721a86a', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: '315cf5e601dd2e102d95ee11492bd3f82066f2ad', class: "tba-panel__toolbar" }, index.h("wa-select", { key: '949358802bffa45494f7d60ea95513a8c7c2d35e', size: "s", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: '0569d149c1b6ee3e738639cdb051469b94d782d5', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a4fa27b3c0df72e438fa1de2b20b0db088e02445', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '0b058f5fc877fab5405d67125fe1967ee4d1aa18', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: 'bf311d1f0400bd37c5ea80408fd87504cd9564dd', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '0232bbfd952524d5454bc5ef3545804b819f43fb', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: 'fbff930eea177763d90d1789e42115718aa4b3e1', class: "hk-dot" }, index.h("slot", { key: 'bcc5ea22ca9a9afd2e2496ba00588418e995db97', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '567b69f2e65e71ec8021de848d0059a246c60e36', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'f83a4b989cb5d6d65b473f6886d9efa7f362a05d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '879067babefcf0a927cf2c70ecc54527fb7efbe5', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'c79a22985053a1eb804e21a40b03b69649e43fd0', class: `ir-alert-header` }, index.h("p", { key: '84a7abe745616355cc62467fe0ab331323421b79' }, this.modalTitle))), index.h("div", { key: 'b173a2b4b999f16f64c131e5b15cf260b9de9175', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '19ad27d17b459846c2fa40d44afb3157cc8f5bf0' }, this.modalBody)), index.h("div", { key: '6b5b439e52b316a56da32294ad5dd49322b2f488', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '7e7762bb846d3e3dd3b85d673258711c447f4078', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '06a20c8b03ddfba28d887a79fd7ce1c34a1df9ec', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '4fbd66fc188fff6225d4bdb4a47f38ffc028e219', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '434f315d83119ba4ee50ebbc052b84d5842558f5', class: "input-group" }, index.h("label", { key: 'f38e5e9704c0c15e9c36435ad1b455d428337594', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '3b60cfdc374cc232f99c09f53ac2dbc7744c4845' }, this.label), index.h("input", { key: '03cb4ea3725a68feed1528eb327cc6406b028d01', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '5e996cdd819b7fd1d4d3558642b4ad7e662dafc3', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'e918f2daa14200dde59a471d2f28ce574e8dfe1a', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: 'b52234d6174a0f48f1f60eb2c420f90e3fd6244b', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '17250e411f3e19388771928a13ec2b1693c31347', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '148ae1982bc76a245c883e5342c1b880d6bfec3a', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'c6add6429601f27ff822a96f26577438a25c910b', form: this._id, size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '151beed392cf8e9ea94b9eda794b69fd706f71b5' }, index.h("form", { key: '2c76e9ba4e20080e44d8722c9031f6e9f5ffb92e', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: 'ac98752adb2e182ad2986879eea48edff9df6b98', size: "s", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '5ccc96c809cc381cde193ad2ea90355fb91c9e3d', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: '8b7301e9ce3c9c2cd036f6f686d2256a3058c3ee', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '0f0c2c35f440fe53faeb43499fc47d98921c06af', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: '09b45e83ab355e426be390ed764b42c96a1cf7d9', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: '27849f5a8a01eaed8683e1d291680f011ede0adc', value: this.form.from ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '86bc422e604d05f9accd7ecf0315e80e31efdeb2', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '292df5f14e5f6da30c49a5ae68d53dd921616e4c', value: this.form.to ?? null, schema: index$1.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '9de3499ddc4b60031c20da4c566be6457655092b', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '20714a21a0ad9ea34c01feb3cffeb14445e8a333' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
        "active": [{
                "onActiveChange": 0
