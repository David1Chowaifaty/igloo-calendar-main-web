...
var events_service = require('./events.service-Cn1tdeAW.js');
...
var unassigned_dates_store = require('./unassigned_dates.store-DBhoh55u.js');
...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'd8fc63c32cead335a1c5f81742578d6222e38201', label: this.label, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: '39f4ca546d08c64e406775643a3befd4bfd309be', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: '626d9f44b5340662293e3f7e1149990e72b23489', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '2c537650b0335d15499f5f18dfe2eaead392cb9b', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '26bac3d929f5422557efa7cfe21cd9931368861f', loading: this.isLoading, onClickHandler: () => {
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '463f98f13a018d6845e85cee2ae30718cabf29b8', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: 'c20b5bfe04349b131bee163094488d93b52445d4', "data-identifier": this.bookingEvent?.IDENTIFIER, "data-status": this.bookingEvent.STATUS, class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '0e09f915a124d750ccb7bdf886e9cf0b4c45b3d7', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: 'f455bbdd19e90ccc288b6ee51e84cc1f118b64d8', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '62e1a8bbbc62fc9ee7681e75b235cfb60181ab08', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '87375bb3f96c019ea03e9962376e1a2c1359daf2', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '079518d0c6244e61db37b81edf3b2c9dc829911e', class: `bookingEventTitle ${pending ? 'pending' : ''}`, style: !pending && { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '3b75b827297ee7d1ac376e389757cf5be2fc34c2' }, index.h("div", { key: 'b48d977671520dd877a4f6d4b5c922fdfdff9f17', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '75cdf7b390cfd2c4a57cbf0269377644c61857f8', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkOperationsDrawer = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1c1c821e1a8dc4d27c81fe6c183dc088699a26ac' }, index.h("ir-drawer", { key: 'a7da5345012cc631ced482768e2301a3e1606756', onDrawerHide: this.handleDrawerClose.bind(this), label: "Bulk Availability Operations", open: this.open, class: "bulk-operations__drawer" }, this.open && (index.h("wa-tab-group", { key: 'd72eef683bd9e68b794a7c3005b710a70381d981', class: "bulk-operations__tab-group", active: this.selectedTab, activation: "manual", "onwa-tab-show": e => (this.selectedTab = e.detail.name?.toString()) }, this.tabs.map(tab => (index.h("wa-tab", { panel: tab.id }, tab.label))), index.h("wa-tab-panel", { key: '744a6840ed2509f83502f6a7d18b19e3a065698e', name: "stop-sale" }, this.selectedTab === 'stop-sale' && (index.h("igl-bulk-stop-sale", { key: 'e86bd6b346e6e51eae588a1aa39aa5ef98da770a', onCloseDrawer: this.handleDrawerClose.bind(this), maxDatesLength: this.maxDatesLength, formId: formId, property_id: this.property_id }))), index.h("wa-tab-panel", { key: '459a6d1acdbe0097a71ecfd85b1835db16e0eab2', name: "block" }, this.selectedTab === 'block' && (index.h("igl-bulk-block", { key: '4bfb9c3456d41958b0a9e04dddbbc6cb75a84aff', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId, maxDatesLength: this.maxDatesLength, property_id: this.property_id }))), index.h("wa-tab-panel", { key: 'dd5d0f52786652fafea590130cf797ae95b8f9cd', name: "rectifier" }, this.selectedTab === 'rectifier' && index.h("ir-rectifier", { key: 'f6f13760cd41e176d91eba82c25b62b86bde1db5', onCloseDrawer: this.handleDrawerClose.bind(this), formId: formId })))), index.h("div", { key: 'dd2d89d61974ad2451dd274f5e6c76af808f708b', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a75dea0b3dfa58651f9a92d999fb74509635df2d', size: "m", variant: "neutral", appearance: "filled", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '17113f832c34adaf0e262c36a1381e4c2251d242', loading: this.isLoading, type: "submit", form: formId, size: "m", variant: "brand" }, "Confirm")))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'de6e23ca86c4772b889ae4455dd235734e239c78' }, index.h("div", { key: '0fdb2e725ed2b32ee22efabc0662592f50176ef0', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '3203c2c36d2d2e74a123aea6c86176bffe9ef8c6', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
        ...
        }))), index.h("igl-housekeeping-dialog", { key: 'a06718d7c4c93d6807a85c0eb767b42aa267b5e4', onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedRoom = null;
            }, bookingNumber: this.selectedRoom ? this.bookingMap.get(this.selectedRoom?.id) : undefined, selectedRoom: this.selectedRoom, open: this.selectedRoom !== null }), index.h("igl-hk-issues-dialog", { key: '8a599f815b9e4822ab95e7cbb12160121bc5aa49', open: this.issues !== null, issues: this.issues, unitName: this.issues?.length > 0 ? this.issues[0]?.unit?.name : '', propertyId: this.propertyId, onIrAfterClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.issues = null;
            } })));
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b07dda3d4645087c291ffbe0ced36ee241465c9d' }, index.h("div", { key: '80a3077c7ea0fd3ddcb080bf397c760ab1489b93', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'af7168c35881bdb7c4ce10eb748a4f4760db7e6b', class: "header__fd-actions" }, index.h("div", { key: '0584370cba2a65ad6db64289a67f5b2309b435ae', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: '1cbea4c0b920d7c6e1cbdc3df7bc3a4dbfb0b7cb' }, index.h("wa-tooltip", { key: 'f89efdb21b4f04d72720ee6f016ab4074c1450df', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '79c1b61ee12b1deb156f395b988b283309c4d079', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: 'ecda838b7b346a506d883b83e695e0d69a88080a', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: 'e94adbd233bf330872378473112aeebf6200f017', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: '80ad365c9454e17497ea2fcfbffc7e836d0a50b0', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: '4a158f1a9875878d745338322a259b373cad41e1', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: 'abf85a002033cca1349e9074b1904c613c99371c', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '69d82b192744f6e960eda7cd5987e1a1b3e6bfc2', class: "fd-dates__actions" }, index.h("wa-divider", { key: '81db0a95ae39cbb980f6302809da6e1f2c58f3ef' }), index.h("ir-custom-button", { key: '9bab5a006b2ed588fb3e5207a6820da8b074d85d', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), index.h(index.Fragment, { key: '3f5f0a2591e3c6a136932d9e3b5df37116e0f291' }, index.h("wa-tooltip", { key: '12b9027fbccecd1a6297059da5cb4d8e0d4eb2e7', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: '3c767c8f8d54c68985784d99104ca346697cc842', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: '7148361b5c54e07b047b69c99b41efd8734304e1', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '66d1732e51ff36348ff318e046add7b3475a8a61' }, index.h("wa-tooltip", { key: '8957f4e288b5c74501f90f6862557f1906958475', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: '30bbcd412ce9ce11efa83fff1b82f06d673b003b', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'a2fbc4ff661cf0a490c8238d1b5addec537eca06', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: '65f3ce5ff1f19478131f095bd2467fcdba2ee1a7', class: "searchContiner" }, index.h("ir-picker", { key: '3a4cedddc56bff2c8218ffdba2abfeade599ff6f', size: "s", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: 'b90bcb75a79903952be2817327b10faaee492cc2', class: "stickyCell headersContainer" }, index.h("div", { key: 'aacfa0f6139835a7124d8f4e1db7fcb10b2338c2', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'd3753554166bf666fbfbf61502d2034f82a234c2', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '834276de4a154e954b13a0460b489f9040b9bd6c', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: '43fa7abfe8da049ba8dd7470c523061b816164cd', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: 'e0aba2e59bc16576fc31b07f8641824f9c3e2588', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglHousekeepingDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '8583779e84a006dec641f1985cacb41c4647fb7f', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, index.h("p", { key: '509341a14646b2bfe7a9108d1698e14ecc46813d', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), index.h("div", { key: '64ba83197b9aaf2cd38cf6611ae7582a5943e006', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '3b68e05a3db64aeacda2cb96d75cc9c738ab12ba', "data-dialog": "close", size: "m", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'fe02514a4f3f37c5d6985e35619ac8a18436fe30', value: "hk-toggle-clean-dirty", size: "m", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), index.h("ir-custom-button", { key: '441c907b72416f8622f1d973fa56ad9692c8e01a', value: "hk-clean-inspect", size: "m", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
};
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '26b7a6e21ef0c2cb4b2284351aaa5d12ecca8d8b', class: "legendContainer text-left" }, index.h("div", { key: '8d2bad14518716943139d40223217fd20ec05e9e', class: "fd-legend__header" }, index.h("h2", { key: '2a6d8334d8f3205873fe0ce68d4ed6daab50d02a', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '008012aca7f494d2fd732d8b0160cff3720e8659', size: "m", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '6ca884f1016079b0ba90aed4eeda072e0d6edccb', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: 'f7458b9ecbdccdf49e7528749bcaf86c2edd032b', class: "fd-legend__body" }, index.h("div", { key: '4c2bfea1f4b29feb2c7e948fdd88d2eab49ddbeb' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '01e9ccf4a2bc5496f6593eb417778f8b0f89cebd', class: "fd-legend__row" }, index.h("div", { key: 'cf3fc42659f4c813e3baf8141e62076b2e8fe1a9', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '5c4c29f3bb05dd8b1159efc846ff106fddd14282', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '8026a9d9fdf366d477af999eae6c7e9df91af9bb', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: 'f7e15e66eea53c306ed2025952aa9b84600ba06e' }), index.h("h5", { key: '4de5dd20254e6c6187118738800172bfe71b7a1e', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: '59e191534359e52ea3057d8209a7f4196945eec0' }), index.h("div", { key: '723aa0f1c46a399193cc0c0d0d38808a1ebd8465' }, index.h("div", { key: '4725d09988bebbc2961f2ae951b77e0ec7f85771', class: "legendCalendar" }, index.h("div", { key: '19ebaa89c2fbfe755c1d7477d4ab0848ace92e5c', class: "legendRow align-items-center" }, index.h("div", { key: '203d06de617e972dd945b268106f15027dde4e42', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '1f7992768811696f5d2aecc6638339f1d4781d32' }, "MAR 2022")), index.h("div", { key: 'bc719ed30d34298e25ec64e0d869205d30af4284', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'af1cf88ef11836d856bce80d00b9f73ab07c2cad', class: "legendRow" }, index.h("div", { key: '6559b4ab3c1bca2811664de0a2ed7835dd68161c', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: 'd254ddd8b0c5c33bcccca0119731e790b8bcb66a', pill: true }, "3")), index.h("div", { key: 'ee8918ebc7de1a73728b34cd029b002ae23ff85f', class: "hyphenLegend" }, index.h("div", { key: '85482c5fda231e65f3a908b3518042159745da00' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '9c4df4e341e23f17745dd3f0634bd18ac1a0a8b8', class: "legendRow" }, index.h("div", { key: 'ab05b817c4c5dd06a63728fe1f4e8dfee29965f7', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '049c39776848e3c21c2fddb3d2a4e98fd8eefdf6', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'b272256ce846784d129baee972543a9c89106538', class: "legendRow" }, index.h("div", { key: '0bd4a3e4cf9dd8dabd85817899605dee7d1f7be3', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '85c414698446d0b676793367f4cc993250f3cdeb', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'a65d26b67f7ff6e98442f662085244dc46e540f2', class: "legendRow" }, index.h("div", { key: '0a9bc2e3f6f6517cbd1e60588c878f2bf2c609b6', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '3c9750ee93385adc8c62d01c50b7e06c570a8de0', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '5d49a1ca6f6260cde45cd8ae3ea10710707fecba', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: 'ffc84218f76f39b61acb4181cd1487d04f5e9cb0', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            ...
            } })), index.h("div", { key: 'd181cabcd96bdead025445451ffe3e1cfec6b0d8', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '388a10e1b8254c6ec1504d848abaeb08d825b5a2', size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '5607ba4690701bed1ab962256d824e544ab3032f', loading: this.isLoading, disabled: !this.hasInventory, size: "m", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglRateExtenderForm = class {
    ...
    render() {
        ...
        return (index.h("form", { id: "rate-extender-form", class: "rate-extender-form", onSubmit: e => {
            ...
            return [
                index.h("ir-validator", { key: day.date, value: day.amount, schema: index$1.libExports.z.number().min(0) }, index.h("ir-input", { ref: el => (this.inputRefs[index$2] = el), disabled: this.disabled(index$2), class: "rate-extender-input", "aria-describedby": "rate cost", "aria-label": "rate", "onText-change": e => this.handleInput(e.detail, index$2), value: day.amount.toString(), defaultValue: day.amount.toString(), mask: 'price', label: moment.hooks(day.date).format('ddd, MMM D') }, index.h("span", { slot: "start" }, currency_symbol))),
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '2c59875b52dc260d17972a3d2777ea3c354910b5', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '13b882cbb755cd71a090357a199a3bc860a97f35' }, index.h("div", { key: 'cabaffda86c22fc7c2e4a0cc24527f2b5eae4729', class: "dialog-body" }, index.h("p", { key: '5e34bc8c0909c3bda41888e090b79adebef0dda0', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '3e04127ba452d6f6657330b7944755059336d8e3', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "s", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '6bd6d16a8309642f36a37e536f483ac11833dbdc', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '754d48435317acaaafa5ee2afd4fd7fe56a986e3', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '0adc8ab0ba0b962eae2aad87077b63d3fd3628b4', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "m" }, "Cancel"), index.h("ir-custom-button", { key: 'df9bdc988934e3b84596ea0cfbdf113e9ca6be3d', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: 'd66809d06ac355850d2247234a4e8de7cb367c24', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: 'ff3581bc29169ac2097b0ab2e27df7e88c540bef', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: 'e98502509390d27aef0718320d41980b5177c2c5', class: "px-1 sheet-body" }, index.h("div", { key: 'b475211334e51fa8260d42d95b61e021cfff19d0', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'a4250d161a01d9a75a65ae2255517c15a7824a71' }, index.h("ir-date-view", { key: '786fc8274801a03cc931d6321e7d6adf591fbc26', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: 'edaced2c3497c1a4c35762ccef31d4f6b29f82e7', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: 'ddf52c350d571094b9e00d78b089b0e39afe4ff3', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: '8557bb5acd72c8591b5bd18b2fb1d59539a9530f' }, "From:"), index.h("ir-date-picker", { key: 'fd37c9a94852639f579c8253b60b80beffa72483', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '4afd44567d0a64fa9354c1e2239830f28aa7694e', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: 'a780cbd76c668c231962743be74af392e14de85b', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: 'd2f540bf18efe8ed94c03a7891b34babbb0e6001', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '84d0a6cbad6952dc54e60770832f230b7d7a3ea4', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '1a7d284c61069fb1229365ad2beb13e814831773', class: 'sheet-footer' }, index.h("ir-button", { key: '559f23a01748cecc68033f1ec4d77ce0be9f8669', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '2c5b45ee335eb778a469566323fb77605c4086af', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e5ee5017030b60f8392761d0506ba5736206fdbb' }, index.h("div", { key: '5e718c5c722b007f0329cd23d42a194353006572', class: "tba-category" }, index.h("h5", { key: '96b0325833f0b0e58935499f5b548d0e973ef460', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '89652ae9de4523f190f894d9a2b4f24538f2f731' }, index.h("div", { key: '7dbe92548bf3dc0ba5125c40b33c69ce4aeca94c', class: "tba-panel" }, index.h("div", { key: 'c0e1b12d3f0d37a6ae98f59572426e1adaa9f296', class: "tba-panel__head" }, index.h("header", { key: 'de8e8f2f3d593c9b65ac2e66ba69efbbe229afc1', class: "tba-panel__header" }, index.h("h2", { key: 'b314cdb74bbb5a3c076ac0c2c5e33410b5f6db42', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: '83bca5cc87a9efefca3a837af52a1a871d5076e1', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: 'f17ce23032f671d9bfeacea56fdb75560eba28f7', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: '3a58d3f289002a1d602c21954fb13a1729efd8b9', class: "tba-panel__toolbar" }, index.h("wa-select", { key: '02865362ee646c231b4285dc9c6182fd8810d2e8', size: "s", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: 'fae8d8dc329f1b2e8b83c0ec8403da8b8cd612be', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b75ddb98694c1f2cc0a00d1431d8e2aac2a7e44c', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '634c752555b411b45642e5cb6364b66aa27db48b', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: 'e9f4a8e7635a2287b26c3215642bad15861e1cf7', for: this.titleId, placement: "top" }, title)), index.h("span", { key: '52324d02f5e79de031fe564d104be1705689d984', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: 'ea9e59141bbd0973a16f57bcc410bf8b30905c2d', class: "hk-dot" }, index.h("slot", { key: '26870811ba33d10088f9a9af259d2a2763b6c950', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '34badca9435a19d2231ae22335d3541b54886c30', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '8ef51ed7a2fe04150559299c57fb440c780e4ee9', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '404ee1f1f1eb7e6727172c1de1e05bab7ea0cc74', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '1e61c676d57be9779311ed1dfc2dad870551efde', class: `ir-alert-header` }, index.h("p", { key: '36c3bcafbadc2cc800bbc307e2c886e271608a22' }, this.modalTitle))), index.h("div", { key: '45fdb54aa0edd31d7c77d37479a9f4c18c18628d', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '3e800b682685de6dd32941be2759368637c4e365' }, this.modalBody)), index.h("div", { key: '1a0dac65ba6c7926620f9f1f9cc806e98f6dd1dc', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '75137fe500b7892985d9a398453538d0402c8429', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '206875415fd443e25868dad7e4c835bdaf517c9a', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '9c0e0be3d4c49268a6ff2b0a95c1fd2f49f0a136', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '01328ec40af2fd9ddeef8084a88addd3ffcebb1f', class: "input-group" }, index.h("label", { key: '826ad65a948ac64b932834cdc9b45455f7c0e1f0', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '95de0d4172f388bede9ff990ac30d9e1ecc4b813' }, this.label), index.h("input", { key: '493b374b21cdcbdf6eb94c191c3df6636de59ad0', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '7f0d63a5c471b39194a704f676c97aaf90c59b08', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '7d63b749a1fd67b08b4768936ad43e5cb47f7554', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '545d4dacd48144bd933677e8b79cd662701af360', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: 'fd8db73250d96c97d9b1f64899d9604e409d90a7', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '4a6616a094350c2d0744cfcd96e889383c889795', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '0462da5f64d3b760fae417a374ac0bed50c046bb', form: this._id, size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fdf30b4419765fd15e6be89debf05454b3c1ef52' }, index.h("form", { key: '9cb86a36f4b3c92df8e20e304fc64b61fec5b899', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '86f8c1909accbdd6219447b46da16aefabd4ae2b', size: "s", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: 'cd7cab167ad3fe701ab3cde8b4fea7c0e3812ee4', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'ac84c3d9c1b2b8ed4ba3e4b5bf108f741b1998e9', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: 'f3bcba9ddc2bd160f992367e85526dd864fa14a0', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: 'edb97e92db6547c310babaae4aab8dc0d73f90e5', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: 'a60fe0cdb27bcf1291e8884c0de8415c9ccccb36', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '41dd3fdfea83f168e2d709e4d3aecf8519a93e90', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '3a04462e48447ffb788db63b67e6e54b8fddb5e3', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '3f534d0a94b4774bf5107a32d0f4e65b10a1bffa', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1885b899cfe4451fe66f551cc858e6b38aa11f76' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
        "active": [{
                "onActiveChange": 0
