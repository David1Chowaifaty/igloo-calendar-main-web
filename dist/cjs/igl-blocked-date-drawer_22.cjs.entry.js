...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'd8fc63c32cead335a1c5f81742578d6222e38201', label: this.label, onDrawerHide: e => {
                ...
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: '39f4ca546d08c64e406775643a3befd4bfd309be', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: '626d9f44b5340662293e3f7e1149990e72b23489', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '82d73d9f38b20d4bf24b8a018b95f9a7b790fcb5', "data-drawer": "close", size: "medium", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '3fe63f5d07373422e8a3bc898a88d69cbe4a4b5e', loading: this.isLoading, onClickHandler: () => {
...
const IglHkIssuesDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'd3753554166bf666fbfbf61502d2034f82a234c2', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), index.h("div", { key: '834276de4a154e954b13a0460b489f9040b9bd6c', slot: "footer", class: "dialog-footer" }, index.h("ir-custom-button", { key: 'dabc798bc6fcac1a1e233e5e9db977962779f91e', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), index.h("ir-custom-button", { key: 'a8658c364d949608856273419eb581e16c855fa6', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '26b7a6e21ef0c2cb4b2284351aaa5d12ecca8d8b', class: "legendContainer text-left" }, index.h("div", { key: '8d2bad14518716943139d40223217fd20ec05e9e', class: "fd-legend__header" }, index.h("h2", { key: '2a6d8334d8f3205873fe0ce68d4ed6daab50d02a', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: 'ae0539730aaf223c12833639003b933e3bbc7364', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'f528d3cbc6a793a7982165eb0ba3f1776350158a', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: '8a2a60a472cbc13e686f95951e7414bb3398b04e', class: "fd-legend__body" }, index.h("div", { key: '39e7673244f7d5ffdaf9e3d0ab43c9ce236bf6c4' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '88638eb29d1322ab46caaf6abdb6a896ebcda649', class: "fd-legend__row" }, index.h("div", { key: '7c36c2c63f4824753bb14253f5ca5eb65a465871', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '6399b74c39ac4cef6312bd9f742878da1190328e', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '01c453b259b8e8494bd8c8d3d63e05bd2f9af14f', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: '97e15350b8ff9942ba0e297b069ff0497965c07c' }), index.h("h5", { key: 'c5d605542be725d8ed8f70335e7ae47f0fc61b27', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: 'ea1a2d721d8b6b99c45ae21abd9d4c45f5f83aba' }), index.h("div", { key: '2305e51069740e1dc5b9354331887f9ba12c8cfc' }, index.h("div", { key: '01a39353f28c774e9d2c8c309b3c91d8e0fe7900', class: "legendCalendar" }, index.h("div", { key: '6cb07a26c73edceba30bd92a5f793bfc43aa6c44', class: "legendRow align-items-center" }, index.h("div", { key: 'd0be5811abc15bceca6665424661f4d5a331b1cf', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'eecbd30c8285476bfe98cbf8f8c02e3d0b5b1455' }, "MAR 2022")), index.h("div", { key: '3de838ec03ad1e6e27726dadccfc20362eccc88a', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '5fc5575514043079694ff73c0964990eed932a02', class: "legendRow" }, index.h("div", { key: '2d6ee08bc4c479f5be21dd5d1a8b5b080a6e9b95', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '6000cf600c8a383a18a5c76682db81ec7f802098', pill: true }, "3")), index.h("div", { key: '51c1867c2a7625df9778eff1dce46b4d3256ccca', class: "hyphenLegend" }, index.h("div", { key: '26fa2de180e41f3b6a53b1c9385e5ae9df77eb2b' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '2c32e2c702b9eac774f8a0ed9f5705b4ce8ff793', class: "legendRow" }, index.h("div", { key: '894ef63c6c4e8d71d6f2ea965532398a4dc96f42', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'a1c32dfe44aa9d98f9ae54f85682b9e5783072f8', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '7775fa77eed74d48c2a0a31e8ce3ef37d3792cb0', class: "legendRow" }, index.h("div", { key: 'f97d752de19e89c70942f2dca37081cf78268a55', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '6ee57dd049e86be6bbbef520ca573e4385a5f253', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'cdac885efe00e0b85b127e07a7cfe69cfc1131fc', class: "legendRow" }, index.h("div", { key: '505220450da5d1be9d24a55e74ff26b9f2927216', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'b76b0e20fd082c8e75d6cf1ad9b54d6282050bfe', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '5d49a1ca6f6260cde45cd8ae3ea10710707fecba', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: 'ffc84218f76f39b61acb4181cd1487d04f5e9cb0', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
            ...
            } })), index.h("div", { key: 'd181cabcd96bdead025445451ffe3e1cfec6b0d8', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'ff2a203f0433dcb5aa2c493b0da0b52e0dcccab1', size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '926ac2c9ccb6dd7a177651b1cbb3b244a9e9a8af', loading: this.isLoading, disabled: !this.hasInventory, size: "medium", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        // ></ir-select>
        index.h("wa-select", { key: '17ca6aa0ca677b180f62fb6ff61d117f95a7f7ff', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '206a922682ee7a533ef0701a729a364d5ab3cc2e', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'ebf985e3507c965157f55a446a0edab1facd0afc', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: 'd984b5174834c5b2a9f5c2558b74e4d548a57572', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: 'a482612e58c06c92c582508c22c114669c55fc64', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '7d63b749a1fd67b08b4768936ad43e5cb47f7554', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
            ...
            } }, this.open && index.h("ir-reallocation-form", { key: '545d4dacd48144bd933677e8b79cd662701af360', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: 'fd8db73250d96c97d9b1f64899d9604e409d90a7', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'b8762f43f2dc07db31b9e4f7f43e2ba3454c8a70', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '4b72d0bd8450ea8a20a2942150bb64dac7cc8bbe', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fdf30b4419765fd15e6be89debf05454b3c1ef52' }, index.h("form", { key: '9cb86a36f4b3c92df8e20e304fc64b61fec5b899', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '034d95370f14febc9f88f7f2dff33db788de0a11', size: "small", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '619485ad364acdc0d21fe857a06196917c202332', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: '1211ca67465cedfd3794e078f62debd9dca01237', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '2b7f747d2b3f948a5bde42daba9b4a887ce23223', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: 'cb2daaf3ebebd467f900214f5191f5e1e71581a1', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: 'f0dd541eedaa0581f4f27fe6a6a5c405245e572f', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '137393edeb1779cc890a29c397609133c01b52d2', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '4bebca6eb59ed19e0c12f15eec91e33f39f3e787', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: '27d086502e2cd1bbf9f3e8dc07362c01ae15274e', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
