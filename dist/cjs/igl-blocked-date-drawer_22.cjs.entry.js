...
const IglBlockedDateDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '7ac66c5594cdf06f038526eec71a22ca849dc961', label: this.label, onDrawerHide: e => {
                ...
                e.stopPropagation();
                this.closeDrawer();
            }, open: this.open }, this.open && (index.h("igl-block-dates-view", { key: 'f73cfc1d39f2045528fa66bfe82fc2d24dce84e5', onDataUpdateEvent: e => (this.blockDatesData = { ...e.detail.data }), fromDate: this.fromDate, toDate: this.toDate })), index.h("div", { key: '0f50d0f0861e8b1a0d0442daf16224d3765f54df', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '328dac22a10a8d44e9d94e32c3a367e244f9ca8e', "data-drawer": "close", size: "m", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: 'd7d1e0e75647df67765cd26de5b2400602b4edee', loading: this.isLoading, onClickHandler: () => {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f75051b011e07197087ff39ddc32b2388783c6fc' }, index.h("div", { key: '9fc42421c6f142948c496fd967be76ac9c482998', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '834d59e38ac05083042645022d8804d43b8463fd', class: "header__fd-actions" }, index.h("div", { key: '31a362ea911fa9c70512a56e78e52c658bc57f27', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: '4e5cb6db45a12d1d5c5fca88f770620e892616d1' }, index.h("wa-tooltip", { key: 'f279f9f54a71f21e1cd595f48b0f2a06c28b1ff9', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '41aa2a2847f32e82c0dd7d74cfe77c85dcebb662', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '58e713e44c4170c11b9e703c92c8d969c6d99942', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("wa-tooltip", { key: '5aad34845b5f126d1ee122318c8fb816abfd95ef', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h("ir-date-select", { key: 'd582463631fbdb503f79e4575cb50aa05011b93b', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, index.h("ir-custom-button", { key: '539afaedd89a1763554c572e5691b698be6c6994', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '5f042216341e54f569c1a105426388c4592f131a', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate })), index.h("div", { key: '7ec9b152e86cbe65c5d01fad37f1a255f1054d3d', class: "fd-dates__actions" }, index.h("wa-divider", { key: '42f2dd1cd223cbdbda19fb2451054ad36d7b5649' }), index.h("ir-custom-button", { key: '9a4ff8f01f9fabe51c1b55f872f844c4985e4ae3', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), index.h(index.Fragment, { key: '6ec44932f9f1f8ea6ddf7f0ed6ef5ba2048fd607' }, index.h("wa-tooltip", { key: '044be4de740d66cdd004755c3475f1ee57e4bf3a', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: 'b573fbacd24c1a1ebbcffa68c0a7c6a006b58809', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: '7416266dec407bae6824273fe0c88b21d6b92af2', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '59f6f14f203b14078133bc56a3d146ec98a3cbd7' }, index.h("wa-tooltip", { key: '9ffd33475a8935ee9562b0545489a99ece58e397', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: 'f55b750116d36111a68aa490d0038c66466369d8', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: '18cd72b7a833b7cf91fae3a5770933133422c669', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: '82f1f6dfa0fb2e58ad4c3de0610a5458f637800a', class: "searchContiner" }, index.h("ir-picker", { key: '3e36b77dc32cc788606f9370275fb7704f9ac32e', size: "s", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: 'a72c9ede4cf00d4402979579bd7ce2afec07dfb9', class: "stickyCell headersContainer" }, index.h("div", { key: '29dfec98ac819a668a4aa94cd8e99f5c68f6e8bb', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8e0e2489d74f4975206a9e8959bd6a5bf92f5c1e', class: "legendContainer text-left" }, index.h("div", { key: 'b1766410c8fc68353a1c5e7644936d83295678e6', class: "fd-legend__header" }, index.h("h2", { key: '1780dc452e9b89aed2d9604df0f9566147dac829', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '50afc9594ce06e56cbfb5458e8924ba8f0f0eb04', size: "m", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'cb0c7a8f14a28bc4ace435b1241dad86b0485a42', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: 'fc6677148c6275e0e7a6d5d09970a9a1341c8992', class: "fd-legend__body" }, index.h("div", { key: 'af095071fe2df579503ab7670c9dc956dc2d7154' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '8e533ab22a071b93fc90d99d6ffce65a123d4801', class: "fd-legend__row" }, index.h("div", { key: '84f954893364ef921ae37a1065f4d11fdc52eac7', class: 'fd-legend__shape' }, index.h("wa-icon", { key: '0b0c4a6f419ebf6e9fb739867f16353b772a11f0', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: '5316c7f9c89a9c453bc159f862f0deaaabff40bf', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: '01c5bb9f82fe2908adddb75c502e2052b6c9ca54' }), index.h("h5", { key: '518e11637e6e75e4242b3780aed24f3bf7304a70', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: '0bc9155f3baddf33ffe9ca8fb465bd28da9a1f11' }), index.h("div", { key: '2612e3f0cf76098b04bbc9e2e19e29796039f4b9' }, index.h("div", { key: 'ada1728dc475d6bdc190d6a6b55190bfd3449a79', class: "legendCalendar" }, index.h("div", { key: '9a9d040e6b7c94b2b25241cafae95e95d247491e', class: "legendRow align-items-center" }, index.h("div", { key: '65247ac48342cf03e0328f402817b8ac5d5685c5', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '572d67057529108efd52170df8072c2f5e420855' }, "MAR 2022")), index.h("div", { key: 'c99650c58d2a28b3061c496e785d208c81d4248e', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '81bf3cae31393dc2469d30189275981b8d0860ee', class: "legendRow" }, index.h("div", { key: '6fe11090e835bed97fd2e3a4041504ea4eb935eb', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '1ac441888310df56f8a68e882ecda1255fb09262', pill: true }, "3")), index.h("div", { key: '1d097d2b5b42ca1839e6e7904f6cc5145cfbb7b9', class: "hyphenLegend" }, index.h("div", { key: 'f5f03805a016eb36ce72cd53a82863b45c463f0b' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '8382328a32c16cd56a1cd9dd31b39d8be89d3baa', class: "legendRow" }, index.h("div", { key: 'd68d36b98320c737b9f78c24cdf57ad042509e79', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '05ee2faf2746c8b77f246b7b10618e89e4b7fffe', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '3b8dda4cf432e037010b1fbfdd970c8e0a341a74', class: "legendRow" }, index.h("div", { key: '82ce58fc936d019f96283769264ebf4d16419e21', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '7061b5cccecdecf03918922c7d90e485734c847a', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'a7877d9c302747deda1e5236586fd7b7630a018d', class: "legendRow" }, index.h("div", { key: '0f1d4a09d4d8d01c59bfc4ac6680234d34016bb3', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '6979fbadfd6c200143581a928bde7f8dfc6bf679', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'f4b41bc0397239d9b846ef93b786afa61513cf82', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: '1d191438e6be361d449529146db9919bca67fe41', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            ...
            } })), index.h("div", { key: '233feb4c2241c53318929e642527980fa8423149', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '08b67aed1a1dd72db45d74325717d6753f750e98', size: "m", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: '30a23242fbf68418db90361f911be3ebfd144ed6', loading: this.isLoading, disabled: !this.hasInventory, size: "m", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'c8eaf0530aae0a68cb2efbe1e18bdbcfd3edc9e3', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: 'ce92ecd0f84df50c1ebed913197a8d392efd7105' }, index.h("div", { key: '788a33aed43e920a41e092091d260a20d8d117b1', class: "dialog-body" }, index.h("p", { key: '990985f0535a45561649179867bb562f1df1d4f3', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '2ab36d993fb6e8e2c480ef192ae5e7e1b53eb1c7', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "s", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '952ad2d66a9cfc9c88a4e14258ef9756dc865bbb', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '3e89877262d61131c01fbea0912e0200a89248e5', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '4dc3fdbb53f3b72203f52b75af86a12fcaa4f89e', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "m" }, "Cancel"), index.h("ir-custom-button", { key: 'a284429b732aba7a4f26a5ce1b10453a83f489d2', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: 'c953bd8f3fd60a6090a56301ecd521decbbd79d2', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: 'ab0fdab2cd6051b2d09682c488f973b643cb9ec1', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '8e367597995c4f8c8c7705702c395a946fae1320', class: "px-1 sheet-body" }, index.h("div", { key: 'a73c0dae1b8494f52183b3eb3edc76c660a3f7e9', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '5b47801da5b5d9418651de32561f91d56339e37f' }, index.h("ir-date-view", { key: 'faad56f6f35268918f442e3b8cc2ce189ce45e0f', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '6b1fc3e388a6a4640138cb8fd62b7e1746a8e03f', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '32b4d780529f3378c30747f25cddb376ed334c0e', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'f2b197815523bbe9c4006fd9715f9ef122a717e5' }, "From:"), index.h("ir-date-picker", { key: 'f0e1dd4ef2664d6bbd4dc81e056f47552f3a7d90', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
        ...
        }))), index.h("div", { key: 'bebb8fca7b1f709a58fdccf638d9ff9c79baa651', class: 'sheet-footer' }, index.h("ir-button", { key: 'a01359be45db48838fce14f46a6696d4a27e67a0', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '3d936ebf37da178d5d34c5f812e2fba60740d054', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6882c84ecefc5682a0ab18fa90f6c43ddfa901e5' }, index.h("div", { key: 'beb0243e9811dffcba9062a854738232fe649662', class: "tba-category" }, index.h("h5", { key: '8d36a7e8e590bd44d80c6fd47bdb7611131e4cb0', class: "tba-category__title" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IglToBeAssigned = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '106a2af13a3d53d48e342a25398f86210685cc92' }, index.h("div", { key: 'f4bb3a4c52658e7e2f399e605aef60829850eb90', class: "tba-panel" }, index.h("div", { key: 'b6d076af4eddf89ab72804dc98f15feb76a4834d', class: "tba-panel__head" }, index.h("header", { key: '5c5c9004cb111f4e9102a80be9bc3b8a84069a1f', class: "tba-panel__header" }, index.h("h2", { key: 'c44055fe54f588756b9bd10674f040352089b214', class: "tba-panel__title", id: "to-be-assigned-title" }, locales_store.locales.entries.Lcz_Assignments), index.h("ir-custom-button", { key: 'a7e87bae69399a0f1cfa8f4fe07b595386142dde', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, index.h("wa-icon", { key: '61631d591c534a0f8c05a08a50e27bbd188e5339', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (index.h("div", { key: '57b52a73c14c856e22506a8b102b80372e1a5467', class: "tba-panel__toolbar" }, index.h("wa-select", { key: 'bcf492e8c9a1a71093fa7e98f1db4fe7d536def0', size: "s", "aria-label": locales_store.locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (index.h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), index.h("div", { key: 'b09ca2bf189cf8d7ff5a504c3ccec7beba2d9512', class: "tba-panel__body" }, isEmpty ? (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (index.h("div", { class: "tba-panel__loading" }, index.h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (index.h("p", { class: "tba-panel__empty" }, locales_store.locales.entries.Lcz_AllAssignForThisDay))))));
    }
    static get watchers() { return {
        "unassignedDatesProp": [{
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '293250f484db303abfa6d3aa927704a25041fb8b', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '03ac475fc61de98ea6d8f0e97e3b95b2ab763307', class: "popover-title" }, title.length > this.cropSize && (index.h("wa-tooltip", { key: '8b34d6ca3081b90bb0258114d43f6ad08c77d4d5', for: this.titleId, placement: "top" }, title)), index.h("span", { key: 'ef7cf929583d1025537556da35effa0c15d728b2', id: this.titleId, class: "cropped-title" }, title), this.hkStatus && (index.h("div", { key: 'edad3819b194bd830506fe464fcbec0d7fa21340', class: "hk-dot" }, index.h("slot", { key: 'f0aa72c7f0560200d23d36d3d96ceec8b5b1beee', name: "end" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '6eb6a315f823fa0e86a461806f099ea10abac896', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '8538f6198f69a49b362e56ddcc65ddc3f3300b40', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'ff4fccc23f7dc8cda62ccdc3f0d5c0653e32515a', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '4249e98e3111774e21e05f7760f5307fcf8ad445', class: `ir-alert-header` }, index.h("p", { key: '8331ddfe08fa3a6307397405bd5af4d4b7aa34ca' }, this.modalTitle))), index.h("div", { key: 'c6ae277add198ea912eabcff0317be12a88fd11c', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '337b00b376f0b9410033bdabc7e8cfb605cde280' }, this.modalBody)), index.h("div", { key: '1adc9fb45696d29d3d166df293ad86d577534113', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '56327c5598e8ecd75a965b53bf904df9e58680d7', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: 'eb2f93ff0b92350011cba91106bbed9e3cc27c1c', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'e39ec2b6128f49de15e561c01e155ca15dc71b1b', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '35c7525e0f61ea4fcb25e68aef88865b34f03c9f', class: "input-group" }, index.h("label", { key: 'c7848801d64af6eae4e26185b14892ec8d52d859', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '6d7648fb9bfa7e4a86b95a6af8dae797bd26af63' }, this.label), index.h("input", { key: 'ff588ec029b78c9a4a61ceb2c7cde6ed0e7e0d9f', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '744a4ed56004ea28e59c99041c19c17c28c7bb0a', class: "checkmark" }))));
    }
    static get watchers() { return {
        "checked": [{
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'c6792c804e44d4c856e1ec39a19500eb678efda9', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: 'd79bfbb284ad93167c533ac9df5e1f641ab5b90a', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '202c1b8d6f4b0f56ea45896321ab7fcca00ef7c0', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '944223b7ba3f803979079fa02cb685123f785c8f', size: "m", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'ee9e88b4c000eaf821357a5899a297cb1430e31a', form: this._id, size: "m", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
...
const IrRectifier = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bdec2e7a1df149f301bacff9ccfa363f0ec1e8c9' }, index.h("form", { key: '88324fb35ea572df61c4201507d9f7cbe15d2c70', onSubmit: e => {
                e.preventDefault();
                this.handleSubmit();
            }, class: "ir-rectifier__form", id: this.formId }, index.h("wa-callout", { key: '902be9627dd8dcca57f6779f2934b10849453ca5', size: "s", appearance: "filled", variant: "warning" }, index.h("wa-icon", { key: '90254d264d127603125128eb223a932ff89cebd9', slot: "icon", name: "triangle-exclamation" }), "This will update the total availability of the select room types by calculating: No. of physical rooms - Booked - Blocked - Pending"), index.h("div", { key: 'ced9f7f372bc7ec94e40ff33ed0a8963cbe5634c', class: "ir-rectifier__roomtypes" }, roomTypes.map(roomtype => {
        ...
        })), this.showRoomTypeError && index.h("p", { key: '827957eab5bdc84b73b3a46af5763f9bf63af721', class: "text-danger m-0" }, "Please select at least one room type."), index.h("div", { key: 'b65f6676890ce87309b5b7dba56a1eef72f442d1', class: "ir-rectifier__date-range" }, index.h("ir-validator", { key: 'ed7812ecfb2a75771588c733433831196aff7e66', value: this.form.from ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.from, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: 'd9748ca0aabc7edfb0b69927d837c77d6d781b72', class: "ir-rectifier__date-picker ir-rectifier__date-picker--from", label: "Date from", emitEmptyDate: true, date: this.form.from, onDateChanged: e => {
            ...
            } })), index.h("ir-validator", { key: '3bb337e0a002fac064d2aa588e99c7a3119df4ff', value: this.form.to ?? null, schema: property_service.ExposedRectifierParamsSchema.shape.to, autovalidate: this.autoValidate }, index.h("ir-date-select", { key: 'd101618eb4e692b446115c62391c6709bd6fd1cd', class: "ir-rectifier__date-picker ir-rectifier__date-picker--to", label: "To (inclusive)", emitEmptyDate: true, disabled: !this.form.from, ref: el => (this.toDateRef = el), date: this.form.to, minDate: this.form.from, onDateChanged: e => {
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3e709e627eb6d9fde2fdc2b7f67844e8e60ed3c5' }, this.phase === 'spinner' ? index.h("wa-spinner", null) : index.h("wa-icon", { part: "check", name: "check", style: { color: 'var(--wa-color-success-fill-loud,#45b16d)' } })));
    }
    static get watchers() { return {
        "active": [{
                "onActiveChange": 0
