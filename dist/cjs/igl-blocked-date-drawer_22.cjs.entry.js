...
const IglLegend = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8e0e2489d74f4975206a9e8959bd6a5bf92f5c1e', class: "legendContainer text-left" }, index.h("div", { key: 'b1766410c8fc68353a1c5e7644936d83295678e6', class: "fd-legend__header" }, index.h("h2", { key: '1780dc452e9b89aed2d9604df0f9566147dac829', class: "fd-legend__title", id: "legend-title" }, locales_store.locales.entries.Lcz_Legend), index.h("ir-custom-button", { key: '1b94648d44cff1d50e4f8e514f4f7204b6e9fa7f', size: "medium", onClickHandler: () => this.handleOptionEvent('closeSideMenu'), appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '41df838d4205e8aa93074df4b59bd35813692423', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), index.h("section", { key: 'fa2a49e43bfc7595101c4508d54d5f8441dbb360', class: "fd-legend__body" }, index.h("div", { key: '8dc14707a6a51cd49c8517470e730e512cfc363b' }, legend.map(legendInfo => {
        ...
        }), index.h("div", { key: '8a9728297c97c7e4db1d060dc3688b0cb92a9590', class: "fd-legend__row" }, index.h("div", { key: '8469b31f60af15f60791eb0baa40e506b7c7c11c', class: 'fd-legend__shape' }, index.h("wa-icon", { key: 'd70d0317b353f9727177f1abb12374d21a966e87', name: "triangle-exclamation", style: { color: 'var(--wa-color-danger-fill-loud)', fontSize: '1rem' } })), index.h("p", { key: 'd44f49d31defd71aaf57a6f628f74242e59f1af6', class: "fd-legend__row-title" }, "Housekeeping reported issue")), index.h("wa-divider", { key: '6ffbceb9a5dfa2a73dc2a27399fbe013384968f0' }), index.h("h5", { key: 'aa2fc480203d01422db2fc4ed43f50cdc2b6a443', class: "fd-legend__section-title" }, "Use custom colors"), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        })), index.h("wa-divider", { key: 'bc892c639f80463b1bbb0f1b78b5af5afb38adec' }), index.h("div", { key: '2ac95e9337cf25f1ec4165262b81a2da995c25e1' }, index.h("div", { key: '3595b248500e6de49a387d646b9d9568c6af4d13', class: "legendCalendar" }, index.h("div", { key: '62b26a2f48504d3e547488d430b2b30ac1fce0a9', class: "legendRow align-items-center" }, index.h("div", { key: 'c83c7ae5024b0e2562d83bf1e5c5bec619081819', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '5186c9d974c3a378dc39fb35ec6c2260ddf8e3fc' }, "MAR 2022")), index.h("div", { key: '1819abd9953d3e3c8b312cd28c2eb6356749a0a6', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'dafda2d8675bb42d3f40682b16126faebe25ca05', class: "legendRow" }, index.h("div", { key: '042cea1a3fcfcc2f192589ae9985c97400d0141b', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '52eecb2049fb470e0392381da260c86fb9364631', pill: true }, "3")), index.h("div", { key: '764c249cf974cd8d3596953238405002fdffb39a', class: "hyphenLegend" }, index.h("div", { key: '239606ead7721e2611da8dfedcbf9401cfa6ecbb' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'd2fa11f2229c09983f8dc58b7d1e78151d505a6b', class: "legendRow" }, index.h("div", { key: '4683ff38d9b906d8deda0a03ae9d5ff128ba5080', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '6ea40ad3b0a72142465badad1921dbe4ec295b21', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '0985262287341b04691f50acd9a5e2ce6ff3a11a', class: "legendRow" }, index.h("div", { key: '030b72c9a081414cb919b959efe94fe53e1bb627', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'bcb6066a65ba98ff147b7b7f028c190c316527bc', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'b6348cd125cc241e9196ae764075ab1fd2d6c379', class: "legendRow" }, index.h("div", { key: 'cd891521a9d57e1de64bf2f8a0f83f2d35256d85', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'b98acf4eebfaa082c7250d9b01c1633e36416e68', class: "hyphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability)))))));
    }
    static get watchers() { return {
        "saveState": [{
...
const IglRateExtenderDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'f4b41bc0397239d9b846ef93b786afa61513cf82', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (index.h("igl-rate-extender-form", { key: '1d191438e6be361d449529146db9919bca67fe41', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
            ...
            } })), index.h("div", { key: '233feb4c2241c53318929e642527980fa8423149', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '702d2796243a7e8712f01e3710f9c950bcf95b90', size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'c5bb7c07d654101bc5cc6c93b2102522d0493b4a', loading: this.isLoading, disabled: !this.hasInventory, size: "medium", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
};
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        // ></ir-select>
        index.h("wa-select", { key: 'f534c84c3a92018fda5b8cd33876b446bc97fc5e', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '2d2014bc2ccf2b30c1c25d2846bb3159cb62ceb8', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'b1dc116969492201e8853920c3ecf1d4a93c6b4f', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: 'b4413f8db86f6e9030a68f8c25dbeb977a441264', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: 'b67b8bc754c8363b38303759cc6a058ef7ec1129', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
        "data": [{
                "handleDataChange": 0
...
const IrReallocationDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'be0bd2713ba8ffea4b36450f6ce41edb4f0bb647', label: "Reassign Unit", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && index.h("ir-reallocation-form", { key: '2974266ba5073a43cefae2b9bd67f445caa38569', pool: this.pool, formId: this._id, booking: this.booking, identifier: this.roomIdentifier }), index.h("div", { key: '925b87f26df69b237207cd7b1b73a0b7be04855b', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a9f2b399000d10229816e2513466ef636074af5b', size: "medium", "data-drawer": "close", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '3f42dfd7cc1b5e7888308f73553c28a7d5029ae9', form: this._id, size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room'), type: "submit", variant: "brand" }, "Confirm"))));
    }
};
