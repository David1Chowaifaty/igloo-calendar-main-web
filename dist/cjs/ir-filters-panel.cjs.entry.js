...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'dae4071b9c7ae31761d13bc92ce24f00db64e3ed', class: panelClasses }, index.h("div", { key: '2df6b321a7c95e61b80c02c52d173f145cb9ef6f', class: cardClass }, index.h("div", { key: '3948273b821e39b0fc505be46a4585526126efbf', class: headerClasses }, index.h("div", { key: '882f32d6ac4dcdea535157ab29f36c8a2a37828d', class: "filters-panel__title-group" }, index.h("slot", { key: '9849bca4e8fd00815298bb7f5f0d1a1dbb4b247e', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: 'f95b4a3c22e2ed3eae3b77c2cf3a5d8e8a4a3408', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '277b07d2f5d8557fde80831b721a727eb7446a19', name: "header-title-extra" })), index.h("div", { key: 'f5252f6d19ff85d8e9f0123eb19246cf57ed4b90', class: "filters-panel__header-actions" }, index.h("slot", { key: 'e78087626160e3b7175ee0586ce5e73d15467dcc', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: 'eb7b89e47fe69128e5970153cf9a2a384a773ba8', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: 'b867d2f13ed37a6bc0f8153888597b96600a2e3e', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '269773fb6259f640b7d303253c8e121b53064b8f' }), !this.hideDefaultActions && (index.h("div", { key: 'ba8aafecb9f9256f08084e4bd3011454cacb1e77', class: footerClasses }, index.h("slot", { key: '3ef9f225f50c183095471b11b25e2a51577374d9', name: "actions" }, index.h("ir-button", { key: '8ed965fb403c2e27389570a94a3ddd86ddab2ba7', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '5fa9077e1a550b8dbd60b4789b15fad062da562b', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
