...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7ac8a173cd05a4dd193a1123268ef3c08009a5e2', class: panelClasses }, index.h("div", { key: '42e5f5f3e8a848ac5e53976a862d8cccdbabc9e4', class: cardClass }, index.h("div", { key: '1e6fbd46af6d77ccce286fd1e97c1a4f2eb3e724', class: headerClasses }, index.h("div", { key: '80a77e0b510559871a51347813e452a1dca3126a', class: "filters-panel__title-group" }, index.h("slot", { key: '36c35338c4631c6d9d0c77cddbac723582a5d4b9', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: 'db59cefecbbb03ea1020644c7f279ff2f9eba412', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: 'a5b1d5e72dff05211db12df38602d0f68036d65e', name: "header-title-extra" })), index.h("div", { key: '71f6f70ca102319ea99e62ff19c8c4a0e9b6725d', class: "filters-panel__header-actions" }, index.h("slot", { key: 'fbe7c5b86471953e8ffda5bc162b964e6f7e8ccf', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '90eee618d0fa34010b8bede171f8ca5314955e2a', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: 'da9afab15290fa2c612149797597af87f1268fc5', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '175351c5e2e58cda45dee3ad0dae1644176e2804' }), !this.hideDefaultActions && (index.h("div", { key: '83ebb48ef35d7e50831027219b2de5217fb3835f', class: footerClasses }, index.h("slot", { key: 'fadb2ebdbb4709249ba370386b8062147428b74c', name: "actions" }, index.h("ir-button", { key: '82d0d233936567beace8538ac39fdaf95e24b445', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '0385b32f2fdb6e4a2cc6810f0ecd8480d3c852c6', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
