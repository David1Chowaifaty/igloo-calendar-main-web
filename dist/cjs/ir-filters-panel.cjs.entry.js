...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ebb9674e7189964fa56300e142749fc057dc8c9e', class: panelClasses }, index.h("div", { key: 'ed351dcf7d24cddf8ac72163cbf51e52cecdcfcc', class: cardClass }, index.h("div", { key: '8429f7059e0edf1b593a334d263665de375799c6', class: headerClasses }, index.h("div", { key: '8fe5a8cd3780b5c75f7c30319d9db0d9916577da', class: "filters-panel__title-group" }, index.h("slot", { key: '7807fd2f380d4f1ed095796aa17514feaba6dde0', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '217e3d4e5338fdd45300ab0eaa2c9c80dc142705', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '66fc280afb8c88a56b70cf402dde18ac9222fe37', name: "header-title-extra" })), index.h("div", { key: 'e3b7eaa7077b92a41dce5084d0ed25d3c9b8bd6d', class: "filters-panel__header-actions" }, index.h("slot", { key: 'b8ea251f1c7dc30b4f5351924926a405fbc3b752', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '067752246fce12d78a60fee5e33135a24d50abc6', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '17b391e9401e27184ebe746409b442c683efcf40', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: 'd8640b6906ef8443765b6631ea92289be17790ea' }), !this.hideDefaultActions && (index.h("div", { key: '59d914a569cd1cae1a2298898069c04a9c29bf7c', class: footerClasses }, index.h("slot", { key: 'd056520ebacd08728c958d7f960b9a7fda43553b', name: "actions" }, index.h("ir-button", { key: '7aa7228c00d1d786bea00709fb49ea0b8bf16500', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '5b3b46ece9b21d0c0fdbefec650b388cbfab8a0a', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
