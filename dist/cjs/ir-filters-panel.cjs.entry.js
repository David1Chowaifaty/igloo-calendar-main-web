...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '56e2dd40c15d82f8337a0d7e6e602f461513c4af', class: panelClasses }, index.h("div", { key: '6680a3007ffa38d6868df324d8547a96f81b9543', class: cardClass }, index.h("div", { key: '67b1f095a709c29495ded99bf1667f50a858787d', class: headerClasses }, index.h("div", { key: 'a7db72882c3216ec0119a1506033a435ebcf26bc', class: "filters-panel__title-group" }, index.h("slot", { key: 'ad06e95d6f72d8208c1bd46985cba5f01cea7781', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: 'e083c8b2465cf91004f0e08e27d970d629098992', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: 'd20317a1e334cf9be7b8fc03018efccd0fb4de5e', name: "header-title-extra" })), index.h("div", { key: '88b1dc2355dcfcf2e15f68bc3647c5a10317804b', class: "filters-panel__header-actions" }, index.h("slot", { key: '8342e0c6a375421de36be3728e36193bc6a15acb', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '48759655ce872c9e21b4756b8df54e8bba36f473', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: 'fb68ee56f036a32c5a47af8ca96a6de949ebed30', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: 'd983f78684e360574d85f2dfff327479ece43b14' }), !this.hideDefaultActions && (index.h("div", { key: '0e8891e12f9315be146ce4c2cb010667d5e5f4f6', class: footerClasses }, index.h("slot", { key: '529f01207c7ad1448a37708db431b7eca3ad84c7', name: "actions" }, index.h("ir-button", { key: '0747b721a0e90c1a0722efd62c17988a85d07cba', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '7452f777c609d9e826dfcf6f5288f220ffb3b037', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
