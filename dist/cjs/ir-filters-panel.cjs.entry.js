...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f19fe41db2d39a549f42db9a2f014121be239473', class: panelClasses }, index.h("div", { key: '270713f2e02fd66d2cfdd14c11e6496053493100', class: cardClass }, index.h("div", { key: '7fff93947bf36345ca79070bd46ee09bb0c54a48', class: headerClasses }, index.h("div", { key: '76bb848fa8e2452684730501bb9d07b6c0161e43', class: "filters-panel__title-group" }, index.h("slot", { key: '6b0ca3b32ba8f31adf3d156d2e4099d8d505f8a1', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '77d79e0e6f156ceb4c9fa472a958e04b43a0a6d6', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '8333afa08ac62b2e8916906bab13775ea050f3fc', name: "header-title-extra" })), index.h("div", { key: 'cc691ea5230f4ab829e748c62cd27f08f36ee1e7', class: "filters-panel__header-actions" }, index.h("slot", { key: '448acc632fcd0215d6387badd73e8e5bcd0261fd', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: 'd24c0c00b9d75c90ba1f892bfe0132a526fc6314', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '4f09a6c2fae90a77644d2160308b5b79d5109a75', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '922feed6015f12809623c1cc86fbf270f0675c0c' }), !this.hideDefaultActions && (index.h("div", { key: 'f50e012234c5f1de1e2c759d7f6651d61ff490b3', class: footerClasses }, index.h("slot", { key: 'c087da3f3937a23d25c700193573bdb172835049', name: "actions" }, index.h("ir-button", { key: 'ff0d3ae0da20e97ba09a2c1100435f9f088ed7ab', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: 'c142eb5f21b23bd9303f3c6f2f1eceb21ef03bb6', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
