...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '361222daa2dbb5e7aa12d39bb07cd37fdb7b92b4', class: panelClasses }, index.h("div", { key: 'ff9263bd3936b450e7481eafd8e13603f7476b91', class: cardClass }, index.h("div", { key: '1be81e1cede571a148dc653b1fcd2e5628a4d4e0', class: headerClasses }, index.h("div", { key: '568bbe2d27ecf5ecedfba52183a398dea95e48e5', class: "filters-panel__title-group" }, index.h("slot", { key: '5903336cd40fca5ab38254c14f59bf624cf791f6', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '8edadea05067b0891507d021f5823e5b0f59d800', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '83a55c9efe9f98250b9d1b8e58ba72599926c6a1', name: "header-title-extra" })), index.h("div", { key: 'd48bdd7f328eaa707fc31f05badad34335a95539', class: "filters-panel__header-actions" }, index.h("slot", { key: 'ade390fde6caa67287bc66d44bded016da2a68a5', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '846a5735d07f2edfe4d03c8336a96a24b1dcdc34', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '62ba1595e342ba49a5f53ec0c2afc3d69dcbd2d5', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: 'e7b36338332441bf1cd6269c2b729d3f1c6b6b7d' }), !this.hideDefaultActions && (index.h("div", { key: '4a13f808d4f08a40697ad51ce21979ea24548c4d', class: footerClasses }, index.h("slot", { key: '7a0d91e307ac724d7474c742520b5ca22d4da5aa', name: "actions" }, index.h("ir-button", { key: '90ffc1af1e8c96c6a57e14808b3b9d6634044899', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: 'b253d5022a6edbfe75e0fa0309a4d38f001563af', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
