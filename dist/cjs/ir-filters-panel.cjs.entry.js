...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4f646a54ff3393b43054ec1aa70a7448261fd814', class: panelClasses }, index.h("div", { key: '6bf77fd73ca8334ef5c6e326221763ea2def66f9', class: cardClass }, index.h("div", { key: 'c51e8525dd703eeb8f68b3793376edd78baa6c82', class: headerClasses }, index.h("div", { key: '62d37db9d8b5306b9df7b980a1ae68bc36411690', class: "filters-panel__title-group" }, index.h("slot", { key: '76b87c56455d2bf114cca28ebe5416790e701c86', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '5fff81cd354ab377e307541a3374564eb0f5247a', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '1b58ef010addb4dfad1cef7c2255ef6f46dd43cc', name: "header-title-extra" })), index.h("div", { key: 'bd28a7a42fdb1ee453ed716a0c1d722a15b8a04b', class: "filters-panel__header-actions" }, index.h("slot", { key: '9d9599652e7f9411233d8557a5f44c1f06d56e06', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: 'b27b56c794e53923cdcdc18f4d0d2f075927e4eb', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '5e592e376782a6da4f875452feef16c9ff6d202c', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: 'a096388fcef2ba3de146892d6535a479f42e9984' }), !this.hideDefaultActions && (index.h("div", { key: '566ffcc8a53422023954df3b053f78264b2fadf1', class: footerClasses }, index.h("slot", { key: '1f678817ca816dff4f50f900f88943a64878473e', name: "actions" }, index.h("ir-button", { key: 'de61c6e35d5884fe491e2ac5013afa53bef75433', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: 'a5f764d6c0a916f8a7cb2f997db46fa1db1a2aac', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
