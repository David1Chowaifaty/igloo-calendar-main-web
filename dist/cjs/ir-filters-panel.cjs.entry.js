...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '628faf87bab298e7a51d68ffd0adde9951106e73', class: panelClasses }, index.h("div", { key: 'af602141a57506fe35d75e56c65cff5260504ec5', class: cardClass }, index.h("div", { key: '9e07ae9c544964b1fd393e9ed825e7203fa3e36d', class: headerClasses }, index.h("div", { key: '4dcbb0921daf2c682baefa74c2084aa4b35e17fa', class: "filters-panel__title-group" }, index.h("slot", { key: 'df02d4c979d322c471556acb3c5c1cf94f712f03', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '7be4b5bbd58278bfdf0e3e83945efa8f2654ad2c', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: 'da6d1077e1e5c86c8a1cbe0db6e0f4e83992a616', name: "header-title-extra" })), index.h("div", { key: '55896e190928a3ff6634e27b776ac82d67817af9', class: "filters-panel__header-actions" }, index.h("slot", { key: '2c21cf501ab5d317a5ace0608ee8d4681ace16dd', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '7b030fff01038c85499ca8cf04fe7e47128057d5', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '0084664ac303cfc5f2592ed10c1528d9db272f57', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '50cceb07dbeab2fd2d7c41267deacaf7413c23c8' }), !this.hideDefaultActions && (index.h("div", { key: '39d49c0b9269e2cb25ea55ec5ca29fdcc844de6e', class: footerClasses }, index.h("slot", { key: '37f52e6c9eca13006153f6ee89bcc5d1cb2d33ac', name: "actions" }, index.h("ir-button", { key: '004e0ef1c013db14fa15205cf182580f5a33266d', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '2678b4656d9ce628f61ca85fe2791abd54dfcc35', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
