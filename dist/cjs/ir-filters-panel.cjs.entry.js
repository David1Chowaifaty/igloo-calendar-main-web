...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f3b7534e897908d41c44ff3646ec812d0aa5caf3', class: panelClasses }, index.h("div", { key: '6fd92ff0f6db663ce219a5d1ec1599a6f42736ed', class: cardClass }, index.h("div", { key: 'c1b6400031a6e63d16e16e6341f58c798aa3d581', class: headerClasses }, index.h("div", { key: '5bdb651b083e494f8de8346ef84659d67e52b054', class: "filters-panel__title-group" }, index.h("slot", { key: '646e0cf395b4cd50675be48faa6cb53722348a76', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: 'f77b8bba20c9dcfb8f539e2a5ff8e6ded671865e', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '0f85cfd83f67519675debeb02f2b113e75524020', name: "header-title-extra" })), index.h("div", { key: 'fa29501912b5afd71e1596b7ef49bf9484b7db94', class: "filters-panel__header-actions" }, index.h("slot", { key: '2a5e04d03f96ac7e6807fa3054ecbc2b676f7920', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '2c307a28933b1d325fbd11725a47f45d56772f7d', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '306577ddf50120307930572c4a7f4c2095eb818b', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '247969d24cc72feccb9438d0a8f647f8abfe6556' }), !this.hideDefaultActions && (index.h("div", { key: '8f2551d98016e4fb14d207d4032117a3cb97ca39', class: footerClasses }, index.h("slot", { key: '7225983a412ff8b2ffaabe635c537bd61f1d2864', name: "actions" }, index.h("ir-button", { key: '4e1c01b40c96fe7e5e304219a50edf507a261ecb', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '760a9d162266fd1c042ce03717ad9f5f76583076', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
