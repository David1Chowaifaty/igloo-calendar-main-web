...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b911b09e37cff82bce7efe125d301f8a292cb119', class: panelClasses }, index.h("div", { key: 'd850b8f77e2ec81b1c4e7b6b960f3759bfa65e09', class: cardClass }, index.h("div", { key: '33d47eeeaf88fdd1e9de235f7fd8fd7b364c6aa3', class: headerClasses }, index.h("div", { key: 'b1ce5a14718536e49a0545ff010d7dbae051b0fd', class: "filters-panel__title-group" }, index.h("slot", { key: 'eb5bed8a409103330b45b926c828129cdc5be5c6', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: 'c43ba612b268926acb2ee06100761a1cbb0c712f', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: 'cb2885e8aaa45ed8891b4d7a5fdc77d65fc5a4fe', name: "header-title-extra" })), index.h("div", { key: 'ce9a16c2215e7bc15a4ca593307307f70db22954', class: "filters-panel__header-actions" }, index.h("slot", { key: 'e53c9648293546820ee3ad36de02d5806c25ab74', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '67982758bbbc41cb48e15c0a063dc3e0ce90c1b7', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '396c4a324ba6bc7c605333126e4bb8f03f6f2af3', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '4a81ab460b2000ab6e42307e2085db541c32ee96' }), !this.hideDefaultActions && (index.h("div", { key: 'c764228b56da7071e9a88ce6e225b6e1e0006130', class: footerClasses }, index.h("slot", { key: '9df4f4b2ec0fb05bd5f352a115b2cb13f52698ef', name: "actions" }, index.h("ir-button", { key: 'da93b88696aea62206cc575c2dfc11f4e12b42ed', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '62e17585f05f21f44a311c003b128dd8a610e480', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
