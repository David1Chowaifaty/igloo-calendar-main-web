...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '22bc0562d7fb57858e6af7e475295e74d7712b75', class: panelClasses }, index.h("div", { key: 'ae050f7eac1f41e11a60bd8c6e56155586b20a3c', class: cardClass }, index.h("div", { key: '6a904ecff5a0944dd93a7ac17ebc2868c94a83ec', class: headerClasses }, index.h("div", { key: 'e402b11b4965ca97c441cc33e4cfee949378bdf4', class: "filters-panel__title-group" }, index.h("slot", { key: 'fc6dc6d321fc43693af0969a9946aa1bab5edaf2', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '39a24ddb9e5cb6846a79fd4f7df0d2bbe29e523f', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '3100ce9f1bcc6a205020c1650731fa6dc12cf732', name: "header-title-extra" })), index.h("div", { key: '5df96698d3ce27de71e4c92763903ee6fbc566cc', class: "filters-panel__header-actions" }, index.h("slot", { key: 'f624d82fcc99aed8367b50f8544d791519c5f342', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '205da5672ce64916ef9b030468d32f0ae259b055', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '8a330d566d504b5cae68a5b6ccb3c26a0a4dd3e6', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: 'd1437dd619128f039c1f98ad7ceb3b01f3a7595d' }), !this.hideDefaultActions && (index.h("div", { key: '0b47dff4213ab8420402985948c509a85a9dc690', class: footerClasses }, index.h("slot", { key: 'd7bcf0eaa9c49b55625573f58e991d9a737c2ce4', name: "actions" }, index.h("ir-button", { key: 'cefea0f98d9e39d1419a9ac765cb1d536fd5272a', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: 'f752b1da0d932e96e6827b697412d3e776df93e2', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
