...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5670add1cd066e3e3493d32056d91b3344119ded', class: panelClasses }, index.h("div", { key: '3c7a972ca4e0b026deb7810f99000766a223359e', class: cardClass }, index.h("div", { key: '83453d352ff2e1ebaeb85c69c2d5f83d47f87a6e', class: headerClasses }, index.h("div", { key: '71959ad463efb88ae1433eb96e8ba2d9c034c4fe', class: "filters-panel__title-group" }, index.h("slot", { key: 'ba891ec4be1a2eec069aeb132b417f85f7573593', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: 'a39f3c3113fab5ca664d64c8b870e13e2d33aa66', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: 'd67686718e1506396bb9ce824e1411312c49b414', name: "header-title-extra" })), index.h("div", { key: 'c9c90a58239e04729dee735f3293c7e8f562368d', class: "filters-panel__header-actions" }, index.h("slot", { key: '68d7142a82e759621e898f4bfcdb585ee27ea45b', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '5993f550816184b1d8db75ce1dd660211ca7dcb8', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: 'f385f38d0f9a27e397a34c15150b820d870cbad5', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '5c9f1e702081972c5a60b59f573971cba4b245e1' }), !this.hideDefaultActions && (index.h("div", { key: 'c28f313371791f1262707b4b8da917ee320ee5e2', class: footerClasses }, index.h("slot", { key: '35233c78c6b626a2afb5962a545ee2ce96fd7489', name: "actions" }, index.h("ir-button", { key: 'ecce4a6bb245ca845630201813e59f332d3a5c45', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: 'fdc6aa8214083f7655f3c0e9ba770b4b38583188', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
