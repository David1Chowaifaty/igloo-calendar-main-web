...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '447e70bada2aa301d22f45d9c08ec2251a243293', class: panelClasses }, index.h("div", { key: 'd6fe332cbce6a986cd7d62e35e67ecca413d6796', class: cardClass }, index.h("div", { key: 'e2840f799f97e122ef7ed532000008a73ecc76e2', class: headerClasses }, index.h("div", { key: 'c4ef298e89dde04cc6c8fe6766cad91180119c68', class: "filters-panel__title-group" }, index.h("slot", { key: '4e705fb439ab1550577098e53cf8c9ca8f48c2be', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: 'b7e1c045f9af114cede1f1e75f504ecc3fa189c7', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: '98e753c834ce5afa1d05e8b8e476d845f5228a2a', name: "header-title-extra" })), index.h("div", { key: '80899bbcbee3106d2e5098c2548b646dc7eebcb1', class: "filters-panel__header-actions" }, index.h("slot", { key: '2da933d646068895d7deef9b47dffc1c430b2f05', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '45ffbe625a98e0c2793782343e867e322863fc4d', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: 'd4f20c923cf6535aeea6661ae1a297b62115dce6', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: 'e2086fa2e83a8681bfcf7ee2db597662cf9461b3' }), !this.hideDefaultActions && (index.h("div", { key: '36422a86ffe887ba955fb980a416b1af7724f0f8', class: footerClasses }, index.h("slot", { key: '91844f3c8b985efc12a7aa08940f03f4b3988f77', name: "actions" }, index.h("ir-button", { key: 'e0a8b0aad879fb8fa74e3051b68b3726809a086f', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '4a37449782c07e869a3c2496cf089fae7c5d2656', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
