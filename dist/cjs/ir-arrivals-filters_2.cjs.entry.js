...
const IrArrivalsFilters = class {
    ...
    render() {
        return (index.h("div", { key: '34549f8402830be91a2dae1dd0c974442a3a24ed', class: "arrivals-filters__container" }, index.h("ir-custom-date-picker", { key: 'a0c5410096bfa0a10350cd966d35247c75824a11', onDateChanged: e => arrivals_store.setArrivalsReferenceDate(e.detail.start.format('YYYY-MM-DD')), date: arrivals_store.arrivalsStore.today, class: "arrivals-filters__date-picker" }, index.h("wa-icon", { key: 'ba68dc7f503379a534ede9d02b976ca9ff861d61', name: "calendar", slot: "start" }), irInterceptor_store.isRequestPending('/Get_Rooms_To_Check_in') && index.h("wa-spinner", { key: 'ec7719dec58d0f29a6975d35a2c7d5d93f022125', slot: "end" })), index.h("ir-custom-input", { key: 'af2fe2f1689f517fa31950d32bdcabccced25341', withClear: true, class: "arrivals-filters__search-bar", placeholder: "Search guests or bookings", value: arrivals_store.arrivalsStore.searchTerm, "onText-change": this.handleSearchChange }, index.h("wa-icon", { key: 'cba3428d6d2478176411d1e17cf902b983c6020b', name: "magnifying-glass", slot: "start" }))));
    }
};
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '553070d130b886cb25cdef7d48668a80c347ac6e' }, index.h("div", { key: 'c88db77626b1e5e03ce08ac075802bd7aaee2a26', class: "table--container" }, index.h("table", { key: 'd664860bbf4c39735717677956f86a387e2ae58b', class: "table data-table" }, index.h("thead", { key: '7b5b2128a06f132fb3e1e62ee6709e980a170c21' }, index.h("tr", { key: 'dd16786a617a1d4817f19763a3513b49103eb55d' }, index.h("th", { key: '088574bf80becfa2070ba7214f5459aeb558fcbe' }, index.h("span", { key: '2dab42e28a697aee10bdd1c931436fb95ee5c790', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: '1de0ae1347503e8816bfa276ae1139e34ad24a5d' }, index.h("div", { key: 'c343755c93f740f6aa7bfc9409b3339382a04b59' }, index.h("p", { key: '78184f0ed5278186169e2285d0c3de125db7edd9' }, "Booked by"))), index.h("th", { key: '66bf936b00cc9be3d84cf55d585f15e7d5df0bc7' }, "Guest name"), index.h("th", { key: 'e90197183ff087fba9c48fc8872400626ad06ef9' }, "Unit"), index.h("th", { key: 'd3972f24256d1709ec4cf854ef9c2f61a4629775' }, "Dates"), index.h("th", { key: '11de63abff917312bbf063546231d022a9f4a8fc', class: "text-center" }, "Balance"), index.h("th", { key: '84c4c103662480f21dee36fa30aeeed61cbaa3a6' }))), index.h("tbody", { key: 'a4020e75cdedd8c3dcfb113b254a8bafe1e8019f' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (index.h("tr", { key: '27a68fcb99988c08203531761b5b463157ba3fe3' }, index.h("td", { key: 'b5e538de8dd799d95271851051be39d58b888f69', colSpan: 7, class: "empty-row" }, "No arrivals found.")))))), index.h("ir-pagination", { key: 'b93d7873364a48550fe5a1a2c2590327f1e19b8a', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
