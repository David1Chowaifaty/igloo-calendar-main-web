...
const IglBookProperty = class {
    ...
    render() {
        //console.log('render');
        return (index.h(index.Host, { key: 'ec78c79290d63c12b74e6dc7ae3c6c8c7cf17472' }, index.h("div", { key: '24ea8b8cc818081a48490953ce292e9b5b015f94', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: '3046d100d4bf014c2c2149a4577f565b09eceb2e', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: '013328a979c30c9beeebd8e47d8b68baaafa1d39', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '6e1c9bef4ac854771fc46050d9fa6e19ab5f4ef8', class: "card-header-container mb-2" }, index.h("h3", { key: 'a3e2af2b5a025145d88d2eceb3d6859d7e2faef2', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '3e7b7df3b40c8733044e305647fb08f8defa4188', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '307c1e1f6b99f5a2e5cdfd90e807914dcdcdd037', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '4909d374ac73e60486a02552713c2dcd9c508ab1', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: '41b4e16b55686129b3788178c09f0e17c072be35', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: 'c9064851934bd58f26ce2ecc76ee923537ea1b19', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData,
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '741441411497f2cb7bb0c5405ac58f37bc3c49b6' }, index.h("a", { key: 'ef8e7c6ea153bf4930b77e56b4c12255db94239f', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '2d79a50b4d47d99675cd3a57b166210b148e8552', class: "sr-only" }, "download url")), index.h("section", { key: 'dbc1be760d2beef3e5ac3117a64c7e81eca33d32', class: "d-flex align-items-center " }, index.h("div", { key: '93954876de3c3126e65a3f7ad4a0caf8bdb1d78a', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'b305639e80af8da843d137b6f4a5ea76af097d61', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'df913e403ca29c713365dfca69a9caa04755fbb3', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'aee2b5a2b2e0175df7e5e0e94b678a938e3f20a8' }, booking_listing.token && (index.h("igl-book-property-container", { key: '73f1016fe677032a6b214947ec3aeea266540773', withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, baseurl: this.baseurl, ticket: booking_listing.token }, index.h("ir-button", { key: 'e8c3bc45616743db233b206fc09739f44eeaddad', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" }))))), index.h("h3", { key: '00fd68956871504645190115d67df778195a92f2', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '3b5888912b2e20618133c453242da6b5dab09b5f', onSubmit: e => {
                ...
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: '38bff132d550e01f6e0e38af38738f3493cc3d0f', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
