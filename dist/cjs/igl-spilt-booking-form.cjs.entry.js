...
const IglSpiltBookingForm = class {
    ...
    render() {
        return (index.h("form", { key: '04ae910e8f3e32068e928f92103bd5b51b9208c3', id: "split-booking-form", onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("div", { key: 'ad9c75f482e19fa5bbac3ae0a5343570d52f022f', class: "split-header" }, index.h("div", { key: '6d9d4781ddc1b5a091ad0ecfc98103e8bf43562e', class: "split-header__summary" }, index.h("ir-date-view", { key: '889db03f0bdce3c8d99ffacbb9089adb640aeb11', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), index.h("div", { key: '20767bcf221ca0ecff11a1879887f23036239d1d', class: "split-header__tags" }, index.h("wa-tag", { key: 'db7701ab3264d364b3cdb73857d173fdecc254f9', size: "small", variant: "neutral" }, this.room.rateplan.short_name), this.room.rateplan.is_non_refundable && (index.h("wa-tag", { key: 'e2c1e5c649363a9a2a0288b913a27b5b0ba1f51f', size: "small", variant: "warning" }, locales_store.locales.entries.Lcz_NonRefundable)))), index.h("div", { key: 'bdeeb845a89ab702cc51b09e96ce8aaf651731e1', class: "split-header__controls" }, index.h("label", { key: '1e3ed734cf76f76b12459a0932676abba7c74fc8', class: "split-header__label", htmlFor: "split-from-date" }, "Split from"), index.h("ir-date-picker", { key: 'a72948fd8fa7a43971388887c50dc5b9fe0ba29e', class: "split-header__date", "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true, onDateChanged: evt => {
                this.selectedDates = {
                    ...this.selectedDates,
                    from_date: evt.detail.start,
                };
            } }, index.h("wa-input", { key: 'c666eede0dd5c36f60ee8dc6924112280a1837f1', id: "split-from-date", slot: "trigger", size: "small", readonly: true, class: "date-trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null }, index.h("wa-icon", { key: 'cb901c04722edb6eebb0c83c407e28e0957dedb1', slot: "start", name: "calendar" }))), index.h("wa-button", { key: '64644d7593e8d23a2c3ef2eeebea7e518813abd9', class: "split-header__check", size: "small", variant: "brand", loading: irInterceptor_store.isRequestPending('/Check_Availability'), onClick: () => this.checkBookingAvailability() }, index.h("wa-icon", { key: 'ffa7ed133aa0326842bf3f8aad65eb8929774418', slot: "start", name: "magnifying-glass" }), "Check"))), this.errors?.roomtype_id && index.h("p", { key: 'bb621c1b8a463d88c7faab2d87e33045fb1064d5', class: "error-message" }, "Please select a room"), index.h("wa-radio-group", { key: '267d31c9b5fb8eb730e9c14064d9157c0bfb677f', class: "room-type-list", name: "unit", onchange: e => {
