...
let { state: booking_store, onChange: onRoomTypeChange, reset } = index.createStore(initialState$1);
...
class BookingService {
    ...
    async getBookingAvailability(props) {
        try {
            ...
            const { data } = await axios.axios.post(`/Check_Availability`, Object.assign(Object.assign({}, rest), { adult_nbr: adultChildCount.adult, child_nbr: adultChildCount.child, currency_ref: currency.code, is_backend: true }));
            if (data.ExceptionMsg !== '') {
                throw new Error(data.ExceptionMsg);
            }
...
//# sourceMappingURL=booking.service-ecc6743b.js.map