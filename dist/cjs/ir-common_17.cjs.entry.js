...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '99e124fa46d3b4f581902b13838fabba5e6795de', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '965c879c42a7b0d7657fe0ad529e7bdddbd1a392', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: 'a801d039e62613c9cb806b2541baeb0452001cf4', name: "label", slot: "label" }), index.h("slot", { key: 'd5b5446672422364199394a26e2a9202ffb60787' }), this.slotState.get('footer') && index.h("slot", { key: '0ff6c34bf079248430afb7a8c6629d16731c8392', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'ee776dade9096689fa2a7e2040b9520cd49e01f1', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '9715056baf5b365469f70a3392fc249079a15961', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '5b51ba5c531393c0750a8244301ee0b39fe0c9cf', class: "picker-item__check", name: "check" }), index.h("div", { key: 'cdf42bc8696874783dfff46583dca4d76ecebf09', class: "picker-item__content", part: "content" }, index.h("slot", { key: 'd44b00390b53e1dfd0f6c6bf648ae44ba9485ddd' })))));
    }
};
...
const IrPropertySwitcher = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'af71f34d468a6715125670a5bf3c5e03e8f84a4a' }, this.trigger(), index.h("ir-dialog", { key: '1f6c7506b7b43b9572754c1d6cb0db64f28a99ed', onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, withoutHeader: true, open: this.open, label: "Find property", class: "property-switcher__dialog" }, this.open && (index.h("ir-property-switcher-dialog-content", { key: '62211cbfe0e987039dda5aee2488921854f1af8a', open: this.open, selectedPropertyId: this.selectedProperty?.id, onPropertySelected: this.handlePropertySelected })))));
    }
};
...
const IrPropertySwitcherDialogContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '02d56f42f4d1684fe4ac17ad50656ef98b0fb6cd' }, index.h("ir-input", { key: 'e3fbb6d57d704cd3e1305bf9e6f1deafafd42ebd', autoFocus: true, ref: el => (this.inputRef = el), placeholder: "Find property", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), index.h("div", { key: '9abf7261cef7dd82763c298f3bb0617d6953d680', tabIndex: -1, class: "property-switcher__results" }, this.isLoading && this.renderStatus('Loading properties...'), !this.isLoading && this.error && this.renderStatus(this.error), !this.isLoading && !this.error && this.filteredProperties.length === 0 && this.renderStatus('No properties found'), !this.isLoading &&
            !this.error &&
