...
var OverflowLock = require('./OverflowLock-BUzR7XVo.js');
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: 'c1c30c0aef0959d0e73ef7cd51317998303019aa', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '3e25ebce6030493f8bb11a8e31cd7232cf6efab8', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '78c3389bfb6e5b77a6e496ce3451e2351f8ba872', name: "label", slot: "label" }), index.h("slot", { key: '44b63102b0e01d2edcd9598c82e570e833408f46' }), this.slotState.get('footer') && index.h("slot", { key: 'd9c33559a88fb3de6fef6c709334c6ba2446f982', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
...
const IrEmptyState = class {
    ...
    showIcon = true;
    render() {
        return (index.h(index.Host, { key: '54f4ba58bec90bb5e844d760eae59639447293d5' }, index.h("slot", { key: '5b25eb13fe9128bc61ec4703c64e168a1f38816e', name: "icon" }, this.showIcon && (index.h("div", { key: '44a7a6ac6bcdf90e8586dfa3ad741833fc6d3c27', class: 'icon_container' }, index.h("wa-icon", { key: 'ba396b6a7b157513fe81f4c9de8c1fbf02d7ad9d', name: "ban", style: { transform: 'rotate(90deg)' } })))), index.h("p", { key: '9f035bcea810a302294f831ae47748ff25d7756a', part: "message", class: `message ${this.showIcon ? '' : '--secondary'}` }, this.message), index.h("slot", { key: '2bd483f0a9d4570387da9d99b55c4d548f75f025' })));
    }
};
...
const IrExtraServicesSettings = class {
    ...
    formatAccChargeRule(rule) {
        ...
        return `${rule.value ?? 0}% ${rule.mode === index$2.taxationModes.INCLUSIVE ? 'Inclusive' : 'Exclusive'}`;
    }
    ...
    render() {
        ...
        return (index.h("ir-page", { label: "Extra Services", description: "Define pricing and options for the extra services offered on this property.", "data-testid": "ir-extra-services-settings" }, index.h("ir-custom-button", { slot: "page-header", loading: this.isSaving, type: "submit", form: "extra-services-settings__form", style: { width: '100px' }, variant: "brand" }, "Save"), index.h("form", { id: "extra-services-settings__form", onSubmit: e => this.handleSubmit(e), class: "extra-services-settings__groups" }, this.serviceGroups.length === 0 && (index.h("ir-empty-state", { message: "No extra-service groups are set up yet. Add a service category whose CODE_NAME is referenced by other categories' NOTES to group them here." })), this.serviceGroups.map(group => (index.h("wa-card", { appearance: "plain", class: "extra-services-settings__card" }, index.h("div", { slot: "header", class: "extra-services-settings__header" }, index.h("span", null, group.label), index.h("span", { class: "extra-services-settings__tax-chip" }, index.h("span", { class: "extra-services-settings__tax-chip-label" }, "VAT"), index.h("span", null, this.formatAccChargeRule(this.vatSummary)))), index.h("div", { class: "extra-services-grid" }, group.categories.map((category, idx) => {
            const rule = this.priceCategoryRules.get(category.CODE_NAME);
...
const IrInput = class {
    ...
    async initializeMask() {
        ...
        if (!nativeInput)
            return;
        this._mask = index$3.IMask(nativeInput, maskOpts);
        if (this.value) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '23369d30d29fce3ee12b8b33aa3bf713ea1ba96e' }, index.h("wa-input", { key: '01f90daed45924794fd6a25f8c598e9f0ca16605', part: "wa-input", type: this.type, name: this.name, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, oninput: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotState.get('label') && index.h("slot", { key: '7be73e562c69f7445eb2c86adf8d4ad9c1e0df58', name: "label", slot: "label" }), this.slotState.get('start') && index.h("slot", { key: '05448b93c81834c070e21d19419328913773eda9', name: "start", slot: "start" }), this.slotState.get('end') && index.h("slot", { key: 'ad4154f77ef8bb49084b3da28594234a38ea5520', name: "end", slot: "end" }), this.slotState.get('clear-icon') && index.h("slot", { key: '764c2dfa48e35bf61b4383b1bcc370699f721f04', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && index.h("slot", { key: 'ae88dfe8863693fc66c6dea63e7288da20670545', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && index.h("slot", { key: '067314da5d6c558559ed4669ba1972b3079365a7', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && index.h("slot", { key: 'd7d77d24f95ee8b135dc31830a2e9f76d7d4c70e', name: "hint", slot: "hint" }))));
    }
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7da95e991c1c32f40e15f664efb66a5d268ba4be' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '9357222413a563bd9b5abd737eda43e80ffcc358', class: "loadingScreenContainer" }, index.h("div", { key: '98ac264caef14557ee7b38fb445c207206addefe', class: "loaderContainer" }, index.h("wa-spinner", { key: '27ee4deb75fe872fe17f9086b00d56533856bd12', style: { 'fontSize': '2.5rem', '--track-width': '3.5px' } })))), this.showModal && (index.h("ir-otp-modal", { key: '12f0f556021981d759d194a07b264e3c31140401', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    message = '';
    render() {
        return (index.h("div", { key: '5bf21e597da12c5a558dc86e77b52813c9c4d3bd', class: "loader__container", "data-testid": "loading-screen" }, index.h("wa-spinner", { key: '22edfe698c84e2663bcad932e6b53c58032d950e', style: { 'fontSize': '2.5rem', '--track-width': '3.5px' } })));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e82ed22a3443b23213b3bbebdec0765ba980d056', class: "otp-input-container" }, index.h("div", { key: '6c078f3de8d689e72b78c10e357f1eed519764a5', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrOtpModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e6406a0ffd0d0c13634d0a2da9c4a23f4bac8410' }, index.h("ir-dialog", { key: '69051d21b4a31c836c49c1c637740d4f93bc386b', class: "otp-modal", ref: el => (this.dialogRef = el), open: this.open, withoutHeader: true, lightDismiss: false, onIrDialogHide: e => this.handleDialogHide(e) }, this.isInitializing || !locales_store.locales.entries ? (index.h("div", { class: "modal-loading-container" }, index.h("ir-spinner", null))) : (index.h(index.Fragment, null, index.h("header", { class: "otp-modal-header" }, index.h("h5", { class: "otp-modal-title" }, locales_store.locales.entries.Lcz_VerifyYourIdentity)), index.h("section", { class: "otp-modal-body" }, index.h("p", { class: "verification-message" }, locales_store.locales.entries.Lcz_WeSentYuoVerificationCode, " ", this.email), index.h("ir-otp", { autoFocus: true, length: this.otpLength, defaultValue: this.otp, onOtpComplete: this.handleOtpComplete }), this.error && index.h("p", { class: "otp-error" }, this.error), this.showResend && (index.h(index.Fragment, null, this.timer > 0 ? (index.h("p", { class: "otp-resend-timer" }, locales_store.locales.entries.Lcz_ResendCode, " 00:", String(this.timer).padStart(2, '0'))) : (index.h("ir-custom-button", { class: "otp-resend-btn", link: true, size: "s", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resendOtp();
            } }, "Didn\u2019t receive code? Resend"))))), index.h("div", { slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { variant: "neutral", appearance: "filled", size: "m", onClickHandler: () => this.handleCancelClicked() }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { variant: "brand", size: "m", loading: this.isLoading, disabled: this.otp?.length < this.otpLength || this.isLoading, onClickHandler: () => this.verifyOtp() }, locales_store.locales.entries.Lcz_VerifyNow)))))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '80f693e862be35c65c1940f3c55500b5003074e9' }, index.h("ir-interceptor", { key: 'c48881071ddd051a9b72e6d38b18cf8b46266f64' }), index.h("ir-toast", { key: 'bce105f9f130be7bec2e649c68a1b88687fd416d' }), index.h("main", { key: '5009693b2de4a5d0ecd66f86e07a0a21ee99165a', part: "main", class: "ir-page__container" }, index.h("header", { key: 'fec2c2fb6b47612ff74636b80fcecfdd99539ae4', part: "header", class: "tax-page__header" }, index.h("slot", { key: '2b083ef23cc45d6db01673c352f76c83519bcb93', name: "heading" }, index.h("div", { key: 'ba590087d23cb19065673ebdaf632c400af0a634', class: "tax-page__heading" }, index.h("h3", { key: 'c276afb6edcb7cf20a355627e13c29e209bc78f6', part: "title", class: "page-title" }, this.label), this.description && (index.h("p", { key: '5e8ddb06a2f50d5227b0e9cb65a50eb5741a86bc', part: "description", class: "page__description" }, this.description, index.h("slot", { key: '2575b144ce5f6f4e6c07b6bdf9d5135fae7299a8', name: "page-description" }))))), index.h("slot", { key: 'd3357399ff34025747caefc1600b2401fca9894c', name: "page-header" })), index.h("div", { key: 'd278bccf0f4e3e75fec1d73c8b142ef7aa5a3af6', part: "body", class: 'page-body' }, index.h("slot", { key: '89d768ccbf978a28a3198263db6679c6a13dd224' })))));
    }
};
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6635dee77ce0aa2a458e89200a6374c4e9a78627' }, index.h("wa-spinner", { key: '79b9a4c39dcc65a1b62a9a9ae5863eb85fd272a0', style: { 'fontSize': '2rem', '--track-width': '3px' } })));
    }
    static get watchers() { return {
        "size": [{
...
const IrToastItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5f6b8d9b080d6f132f913f1220611220ff38887c', "data-leaving": this.leaving ? 'true' : undefined, "data-entered": this.entered ? 'true' : undefined, style: { '--accent-color': `var(--wa-color-${this.variant}-fill-loud)` } }, index.h("div", { key: '7b2092fec027d8800a24fdad7c91a517f31f12f9', class: 'toast-item', onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave, onFocusin: this.handleFocusIn, onFocusout: this.handleFocusOut }, index.h("div", { key: 'c5255090a853cd5b5ee4cb12f19081fbdbdbb443', part: "accent", class: "accent" }), index.h("div", { key: 'b4e9ad998bdff56b9d760b86e6cdc83deed34b86', part: "icon", class: "icon" }, index.h("slot", { key: 'fae7702f4846e46f03bda9f98cc789b6e93619df', name: "icon" })), index.h("div", { key: '6875dcb044c374df4cd9b67a0ece32d52a76022d', part: "content", class: "content" }, index.h("slot", { key: '02a7f5794a593b1f4e63b8757085e4115a55cfba' })), this.dismissible && (index.h("button", { key: '1c361d6f8e3bea47c4fe795e24daba3196f405dd', part: "close-button", class: "close-button", type: "button", "aria-label": "Close notification", onClick: this.handleClose }, this.hasTimer ? (index.h("wa-progress-ring", { part: "progress-ring", "aria-hidden": "true", exportparts: "\n                  base:progress-ring__base,\n                  label:progress-ring__label,\n                  track:progress-ring__track,\n                  indicator:progress-ring__indicator\n                ", value: this.progress }, index.h("wa-icon", { part: "close-icon", exportparts: "svg:close-icon__svg", name: "xmark", library: "system", variant: "solid", "aria-hidden": "true" }))) : (index.h("wa-icon", { part: "close-icon", exportparts: "svg:close-icon__svg", name: "xmark", library: "system", variant: "solid", "aria-hidden": "true" })))))));
    }
};
...
const IrToastProvider = class {
    ...
    render() {
        return index.h(index.Host, { key: '2f1289fca9959b51251762ed70cc6134363475a2' });
    }
};
...
const IrValidator = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.validationChange = index.createEvent(this, "irValidationChange");
        this.valueChange = index.createEvent(this, "irValueChange");
    }
    get el() { return index.getElement(this); }
    ...
    render() {
        return (index.h(index.Host, { key: '3dfe5322d24fab483716b2d3cb7ef5ca6b9f372a' }, index.h("slot", { key: '22e26c52126aa405b06d6eb50f6f1989f7758e04' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: '3d37c994beb9d49c14d32838bbd235888cb95441', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
        "schema": [{
