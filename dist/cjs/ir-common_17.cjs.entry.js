...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: 'a053aa643747ecc02aca90686a673e7d978b4b2a', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '09be50be104bc43b69ae5b64dee8a433fe5d3ea4', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '70397dd97f4b3ee91ab4bdad05dab0bcd96066e8', name: "label", slot: "label" }), index.h("slot", { key: '3c0d467e009f31963a9e70a304aa2d0507bf3b8f' }), this.slotState.get('footer') && index.h("slot", { key: '86cf7194eb72baa7a5acf21f24e7d8ac38a9e9b0', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f2ca5db52a3b70e41141d629c73937022cdf1f47' }, index.h("wa-input", { key: '64f71e2bfee66e18d33cd1a75354dd68fc2762ae', type: this.type, name: this.name, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, oninput: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotState.get('label') && index.h("slot", { key: 'e087226de7a9010d70848d2ce0180680cc0e1a9f', name: "label", slot: "label" }), this.slotState.get('start') && index.h("slot", { key: 'd507cfebf7d3d80df85d5396d3f40573f5d4c2fe', name: "start", slot: "start" }), this.slotState.get('end') && index.h("slot", { key: '56729d59c9727b20cf33d588eb1a6eb27e2c7392', name: "end", slot: "end" }), this.slotState.get('clear-icon') && index.h("slot", { key: 'e9f7a758085d382afb96a141a1b21b701a961d76', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && index.h("slot", { key: 'eefc99d494f32b0595e101bd2f9cee90c8b021b5', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && index.h("slot", { key: '41a54c4b65ec2bcd8878dd4880ac7748017b3786', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && index.h("slot", { key: '825a748bdcc1413935dfeadce5a2b84318f1761f', name: "hint", slot: "hint" }))));
    }
...
const IrMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fd9ae8adcf784b1b71767c77efb8ee399c7ed585' }, index.h("slot", { key: 'cab8a9e7d33f5c6099b8d4dd3aff465aa15a5cb0', onSlotchange: this.handleSlotChange })));
    }
    static get watchers() { return {
...
const IrMenuDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'dc349fd87dafde9f94e2567466f79051dfd31cee', class: "menu__drawer", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, style: { '--ir-drawer-width': '25rem' }, placement: "start" }, index.h("slot", { key: '344e190cd75f3f60ca7c9c02e2c7c65811298635', name: "label", slot: "label" }), index.h("slot", { key: 'd9a53e347422fc23f9888e26bd5dc7cb3d7e229e' }), index.h("slot", { key: 'd26676db84985ff4ca61ae79aad42b6715edb9f6', name: "footer", slot: "footer" })));
    }
};
...
const IrMenuGroup = class {
    ...
    render() {
        return (index.h("wa-details", { key: '20bc74e8d055c338aa5e5bb4887b47119422a387', class: "menu-group__details", open: this.open, appearance: "plain", name: this.groupName, "onwa-hide": this.handleHide, "onwa-show": this.handleShow }, index.h("slot", { key: 'a4cb5dd9d212955ffc50383b6d811d4e2e884327', slot: "summary", name: "summary" }), index.h("slot", { key: '7a729ae81f9d2253ce51291a148f48fb8ca676e1' })));
    }
};
...
const IrMenuItem = class {
    ...
    render() {
        ...
        const content = (index.h(index.Fragment, { key: '04e57bd2e4f4bf806c8a0047742e9c296cded043' }, index.h("span", { key: 'edf2f1fa1d6f7bae2442de1ae175c6db5f1a1ef1', class: "menu-item__icon" }, index.h("slot", { key: '10a428cea096c77405cdfe0a209fdb0ec22dcf70', name: "icon" })), index.h("span", { key: '0ab111cfca5c83be4ec6278ff2f9755abfdac320', class: "menu-item__label" }, index.h("slot", { key: 'e85ebb98fd6fb8e36f880fef05b97092e454a627' })), this.badge ? (index.h("wa-badge", { variant: "danger", class: "menu-item__badge", appearance: "accent" }, this.badge)) : null));
        return (index.h(index.Host, { key: '5647280000bc76228b1039ae6acab3dd864e97b9' }, this.href ? (index.h("a", { class: contentClass, href: this.href, "aria-current": this.selected ? 'page' : undefined }, content)) : (index.h("div", { class: contentClass }, content))));
    }
};
...
const IrNotifications = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: '06d3b434d65a119cf66ed66c0202573160e1ed6d' }, index.h("div", { key: '81e1184e9b0ffa207391bfa2fe308bf71c67126e', style: { position: 'relative' } }, index.h("wa-tooltip", { key: '6c90a1b65ed017d1103a197f0cece0b3edf63829', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (index.h("wa-badge", { key: '19ca2208fa8e6f4175259c5b5ebe2a494dfba0b9', pill: true, class: "header-notification-badge" }, this.notifications.length)), index.h("wa-animation", { key: '10a8e9d69b8fd185fa548c00932d136ffb6e7a3f', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, index.h("ir-custom-button", { key: 'f17f2ca4d309527d85970706fe9cdfd2deac1cb0', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, index.h("wa-icon", { key: '80bb5a547604e6b9d11524cb8554ac977dc83178', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.2rem' } })))), index.h("wa-popover", { key: 'c00b1e8f6a9d4d0455237c3b21768edbdba78c10', class: "notification__popover", for: "notifications-button" }, index.h("p", { key: '171d2edb216097614f2e7d1ef2d50faf53045734', class: "notification__popover-title" }, "Notifications"), this.notifications?.map(notification => (index.h("div", { class: "notification-item" }, index.h("div", { class: "notification-item__content" }, index.h("p", { class: "notification-item__title" }, notification.title), index.h("p", { class: "notification-item__time" }, this.getRelativeTimeFromParts(notification.date, notification.hour, notification.minute))), index.h("span", { class: "notification-item__unread-indicator" })))), this.notifications?.length === 0 && (index.h("ir-empty-state", { key: '378a306a29d4538d945f8a604cd53c26d729d1eb', style: { width: '250px', height: '150px' } }, index.h("wa-icon", { key: '4c56b5bd8486389b6693e0fa089438e9a7010fcf', slot: "icon", name: "inbox" }))))));
    }
    static get watchers() { return {
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'c9a0a308550c3fede856a9bbafbb7f52d805cd2c', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'ad4f4dc3caadec28563eb05937247c446bcf6227', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'ef704be24ec92c639a2c9826ec01261987f442f1', class: "picker-item__check", name: "check" }), index.h("div", { key: 'f633a942fad10a5c4389f0f78beadf11ed71d09c', class: "picker-item__content", part: "content" }, index.h("slot", { key: '5830b7b4ae1d71cfc9e07ac5c264e61e66e19be1' })))));
    }
};
...
const IrPmsPage = class {
    ...
    render() {
        return (index.h("div", { key: '2a153437352638ec90f60bec654bc3a578fd2600' }, index.h("header", { key: 'a61fecd823b9dd1f58bc8feec7a4c56352f09b11', class: "app-header" }, index.h("div", { key: '403096a04123936cb29b8010ef8cc8d630234c3f', class: "app-header__left" }, index.h("ir-custom-button", { key: '759d2ee99db57b4e4eb4232e932c6e08d989bc56', onClickHandler: () => this.menuDrawerRef.openDrawer(), size: "small", appearance: "plain", variant: "neutral", class: "header-action" }, index.h("wa-icon", { key: '60b403bc41857bcffbb65badae0aaecfd1c7f2b0', name: "bars", style: { fontSize: '1.2rem' } })), index.h("ir-property-switcher", { key: 'af4487d94eef45803a78c18bf13767a5816ef74c', ticket: this.ticket })), index.h("div", { key: '523a03db3a4ef16bca5133aa3b6db05e70dcd6bf', class: "app-header__center" }, index.h("ir-pms-search", { key: '2b900ba2bcedaf44a8f81af3f01d35e578e80d93', ticket: this.ticket, propertyid: this.propertyid, class: "header-search" })), index.h("div", { key: '1086c9242758a3d0d1b30724b43c9947a68d7a72', class: "app-header__right" }, index.h("ir-custom-button", { key: 'bac303d1e16e9b55735af0ea0e2729fce2963e0e', id: "add-booking-btn", size: "small", appearance: "plain", variant: "brand" }, index.h("wa-icon", { key: '9b4ed6f0b6fa9e7c2684f146e74994c7694f9600', name: "circle-plus", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: 'c203a7e483b52ffeeec56dae601a9967adb3ee71', for: "add-booking-btn" }, "New booking"), index.h("ir-custom-button", { key: '3a7ca3659e0fca43a848e728a1d03df646ed13bc', id: "calendar-btn", href: "/frontdesk.aspx", size: "small", appearance: "plain", class: "header-desktop-only" }, index.h("wa-icon", { key: 'b77d35f456f8ba4aa824417723682da9b382e331', name: "calendar", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: 'ad3f09c814faf408ec0fd1e8ef9dac151e73b4c0', for: "calendar-btn" }, "Calendar"), index.h("ir-custom-button", { key: 'd15febbc69156d38747998378d213dfb1872852b', href: "/acbookinglist.aspx", id: "rooms-btn", size: "small", appearance: "plain", class: "header-desktop-only" }, index.h("wa-icon", { key: '9adb694875d84134e1e1b6f89d62ff0bc2864498', name: "bed", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: 'abbde12a9b169765f77dcc20a8875f3c095998a6', for: "rooms-btn" }, "Bookings"), index.h("ir-custom-button", { key: 'c526c8db6353cb8a9973e31708796e36fc5b471d', id: "departures-btn", href: "AcDepartures.aspx", size: "small", appearance: "plain", class: "header-desktop-only" }, index.h("wa-icon", { key: 'e141536f068344fde658bd2daabfa621611773da', name: "plane-departure", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '7ae4032470bcdb3ee701e555aeba74252774e8c3', for: "departures-btn" }, "Check-outs"), index.h("ir-custom-button", { key: '1a3047c649025f8682b6e31b3bb1aeae0d50e7ba', href: "/AcArrivals.aspx", id: "arrivals-btn", size: "small", appearance: "plain", class: "header-desktop-only" }, index.h("wa-icon", { key: '51201d3b1cdfb9b9fd77eedf70a6d91f3b6c5daf', name: "plane-arrival", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '3455ec50b9f58f38370409a1186af1a5cdd265bc', for: "arrivals-btn" }, "Check-ins"), index.h("ir-notifications", { key: '4d2e29480237b1e59ad5354d0276c813eae6e3dd', notifications: this.notifications }), index.h("wa-dropdown", { key: '26703286d81eab8317e8e26b205c7f5515204599' }, index.h("wa-avatar", { key: '9cee42e8cd3901ad33c384d32ebb007d8f161ed9', slot: "trigger", style: { '--size': '2rem', 'marginLeft': '0.5rem' } }), index.h("wa-dropdown-item", { key: 'd610980f9cdf8e236790ef19330789a2f32e62de' }, index.h("wa-icon", { key: 'b189196cddea853336f29e9a8e30e44a3c5c7798', slot: "icon", name: "globe" }), "View Your Website"), index.h("wa-dropdown-item", { key: '425a4e63c878e15378d5bbf88923736a8a1151a3' }, index.h("wa-icon", { key: '94bb83fa9cbc3b01906dca9bed6c268a0c59d9d5', slot: "icon", name: "arrow-up-right-from-square" }), "bookingmystay.com/A35"), index.h("wa-dropdown-item", { key: '7130b7f57a0f53a8e75d1595cb0e343861068e76', disabled: true }, index.h("wa-icon", { key: 'a2f99250d273b40e34ccfce91a9cd1bd62a4a4e7', slot: "icon", name: "hashtag" }), "Property ID: 42"), index.h("wa-divider", { key: 'bbdd2d838928d5cd619d0d790192ab07e06a3041' }), index.h("wa-dropdown-item", { key: 'ffcc979332f04bd9181b66310d96e9c545cfa388' }, index.h("wa-icon", { key: 'd970d9aec51b9852da5322c13fb0c720619bf5aa', slot: "icon", name: "users" }), "Extranet Users"), index.h("wa-dropdown-item", { key: '2ef0e9a3bbebf62acd0959b138fb9b1ae3a126bb' }, index.h("wa-icon", { key: '28bb6b21d40d288997d75be8ac96cf47821ebe6a', slot: "icon", name: "lock" }), "Change Password"), index.h("wa-divider", { key: '812c756688f705d5aeb1cded73d7cb03337a3da6' }), index.h("wa-dropdown-item", { key: '05da9e52b05d60ab53150fc252071bda6cceba65' }, index.h("wa-icon", { key: 'b7be0b6882269aecb6e85ad92c223ee797f8487c', slot: "icon", name: "wallet" }), "Billing"), index.h("wa-divider", { key: '239d3d85f846870027e12a1f47a9f974e151fa5e' }), index.h("wa-dropdown-item", { key: '3db6467ca2e585f1333c4b29f3fd8c000c88ab16', variant: "danger" }, index.h("wa-icon", { key: '68f923d754bc91d4ab12285900d7d851c3ecefb1', slot: "icon", name: "power-off" }), "Logout")))), index.h("ir-menu-drawer", { key: 'e7d643b388d4a5f821e3a69aac75421849f86e0b', ref: el => (this.menuDrawerRef = el) }, index.h("div", { key: 'ca14dc623576373ff22a0d616a74ea1a764562b8', slot: "label" }, index.h("img", { key: 'a9a5a7b0723f8d34de7264e46673ae3d7f0e720e', style: { height: '24px' }, src: "\thttps://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "" })), index.h("ir-menu", { key: '11a1a47cb4d24571c72bcfcd54c09ebe29a0298f' }, index.h("ir-menu-item", { key: '2de7526e658c194db3ab79717606b03ccf8212e3', slot: "summary" }, "Property"), index.h("ir-menu-item", { key: '3e254b5c140473d8e8db7b1faba1d3f97dec1e07', href: "acdashboard.aspx" }, "Dashboard"), index.h("ir-menu-item", { key: 'c300fa3469a83075e7d3295562e8a3bd5db9fec6', href: "frontdesk.aspx" }, "Frontdesk"), index.h("ir-menu-item", { key: '9edb2088105f03a8e711cf2dd2398b2ef5761740', href: "acratesallotment.aspx" }, "Inventory"), index.h("ir-menu-item", { key: 'f2ef1a99d80407800035f44f95ea0d91cf982b7d', href: "frontdesk.aspx" }, "Frontdesk"), index.h("wa-divider", { key: '58473bbec67d90b190a8cc7ed7356c095d25743d' }), index.h("p", { key: 'cc49d6a5e3538d578ae1f030dabaf4f64b690cb8', style: { margin: '0', marginBottom: '0.5rem' } }, "Property"), index.h("ir-menu-item", { key: 'd7158609230e79b531e33a570dbe8ec9ee218f32', slot: "summary" }, "Property"), index.h("ir-menu-item", { key: '1ccec55f889849eed63ae441ce372189978d0766', href: "acdashboard.aspx" }, "Dashboard"), index.h("ir-menu-item", { key: '46e5ba0e817c623569d4416106f7074c08e66667', href: "frontdesk.aspx" }, "Frontdesk"), index.h("ir-menu-item", { key: 'c61cdf4996a45368d4d4ed85cbf060f208dbcba3', href: "acratesallotment.aspx" }, "Inventory"), index.h("ir-menu-group", { key: 'ab7c6acdc889980bc9a481d53a550d697337b1f3', groupName: "sub-property" }, index.h("ir-menu-item", { key: '42eec125edcb292b1bcc61ba0c423d0960598139', slot: "summary" }, "Marketing"), index.h("ir-menu-item", { key: '5e1d89e1c57ee693ee51587a613d9a77256b5ae1', href: "acpromodiscounts.aspx" }, "Discounts"), index.h("ir-menu-item", { key: '0612b4eea3579845d7589965a7e55e3e5c945d24', href: "acautomatedemails.aspx" }, "Automated Emails")), index.h("ir-menu-group", { key: '8dc1d38981e505b4108e18b3ab25b12496d5e1ee', groupName: "sub-property" }, index.h("ir-menu-item", { key: 'd7ac96a3ee51a748927b6e481cb74faf4dc7ff6b', slot: "summary" }, "Bookings"), index.h("ir-menu-item", { key: '53b259d0b6594507536e2aac5b248c2e886eb493', href: "/acbookinglist.aspx" }, "Bookings List"), index.h("ir-menu-item", { key: '53acbd13a332db7650401d80a7f1d769f071b89f', href: "/AcArrivals.aspx" }, "Check-ins"), index.h("ir-menu-item", { key: 'a64c5fbb691f91a6e99b4c74d74d97ed92f743af', href: "/AcDepartures.aspx" }, "Check-outs")), index.h("ir-menu-group", { key: 'adcdc1ffe6852eff233101448e48efa0bdffadc0', groupName: "sub-property" }, index.h("ir-menu-item", { key: '55d7493c9d2651cf72f8e6b615e78cfaeea19a7d', slot: "summary" }, "Settings"), index.h("ir-menu-item", { key: '2ef6aad33a0ea26cd71fac70da1b207ed175bf83', href: "acgeneral.aspx" }, "General Info"), index.h("ir-menu-item", { key: '17c45fcc77a3a34da5a3b0a4c4367e6a8e24c8b5', href: "acamenities.aspx" }, "Facilities & Services"), index.h("ir-menu-item", { key: '3f8be1f410f7c73e210b20a397ecc924e8db93f7', href: "acdescriptions.aspx" }, "Descriptions"), index.h("ir-menu-item", { key: '6830253e015731a623e4edc4a39e33121a1a9933', href: "acconcan.aspx" }, "Policies"), index.h("ir-menu-item", { key: '2d7ea3f7a54bc49beea883cc0c69087ff5f1089d', href: "accommtax.aspx" }, "Money Matters"), index.h("ir-menu-item", { key: 'efc5e6949634c9221077bc4016539f3cd2f6b2b1', href: "acroomcategories.aspx" }, "Rooms & Rate Plans"), index.h("ir-menu-item", { key: '76d8a5006695cb331b8f793febc4a4e7c6ef2ef2', href: "ACHousekeeping.aspx" }, "Housekeeping & Check-in Setup"), index.h("ir-menu-item", { key: '9cf5d1579cb4a4a7a3aa4aa0e92f4ace6ade6bbf', href: "actravelagents.aspx" }, "Agents and Groups"), index.h("ir-menu-item", { key: 'c141b47ce6f20423e8dfff5ef7eea21f7df39917', href: "acimagegallery.aspx" }, "Image Gallery"), index.h("ir-menu-item", { key: '4f258ef4e734c5e8719863eeb93cdd907fcc93df', href: "acpickups.aspx" }, "Pickup Services"), index.h("ir-menu-item", { key: 'fa00534de5cbfac6ed5696e89ea9a731f059d18f', href: "acintegrations.aspx" }, "Integrations"), index.h("ir-menu-item", { key: '7a30cf48054ee35d45c32c31d3f21b38595e3a6a', href: "acthemingwebsite.aspx" }, "iSPACE"), index.h("ir-menu-item", { key: '5ce0e92097daa5c653e17447ad50c4fb716d9f20', href: "acigloochannel.aspx" }, "iCHANNEL"), index.h("ir-menu-item", { key: '3c04a38a33bccea76e73eb1cc8271c1942633a45', href: "iSwitch.aspx" }, "iSWITCH")), index.h("ir-menu-group", { key: 'dc9310ccad6ef092322d68c4483fb48c4c77b895', groupName: "sub-property" }, index.h("ir-menu-item", { key: '8d367be2e705b1b1e8073cb02ee819b88332e0f0', slot: "summary" }, "Reports"), index.h("ir-menu-item", { key: '959edab1e63e9d653fc9879d66ddb03a9eab7457', href: "ACHousekeepingTasks.aspx" }, "Housekeeping Tasks"), index.h("ir-menu-item", { key: '352565fc93a5d6c8230ad4081854e5c1363a72ff', href: "acmemberlist.aspx" }, "Guests"), index.h("ir-menu-item", { key: '0c987379e8205c1146f513f6d23a575c73036a1b', href: "acsalesstatistics.aspx" }, "Sales Statistics"), index.h("ir-menu-item", { key: '50b97d05882a21710835da4946034a961fe7436f', href: "acsalesbychannel.aspx" }, "Sales by Channel"), index.h("ir-menu-item", { key: '24102cfe70411b2cfb4939b0e44f1c9df37352d6', href: "acsalesbycountry.aspx" }, "Sales by Country"), index.h("ir-menu-item", { key: 'b7a380c06e58a569589d8cd9120b5241f03c2e21', href: "ACDailyOccupancy.aspx" }, "Daily Occupancy"), index.h("ir-menu-item", { key: 'f9ee6c0cbb747b6aa8e4a87c2ddfc8df589ad423', href: "acaccountingreport.aspx" }, "Accounting Report"))), index.h("div", { key: '7e0e172e89b3474bff7a5dd3119712e2c170ef84', class: "menu-footer", slot: "footer", style: { textAlign: 'start' } }, index.h("h4", { key: 'fbf96a97e4e6a0b14351fc7269fe6da70ec4f939' }, "A35"), index.h("span", { key: '861cc358eb9aecfa623e0cea4732a15249053d0b', style: { fontSize: '0.875rem' } }, "lorem@noemail.com"))), index.h("div", { key: '7f128594fc2d64de0fb3ff0287a3e7d0a87d8226' }, index.h("div", { key: '0a3c8a3187516c0df8f6f6d719af6e4917af8ab0', style: { height: '200vh' } }))));
    }
};
...
const IrPmsSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1f9bb18260f1bda89c4baa7f0635b50fcdb3c6d7' }, index.h("ir-picker", { key: '9849e7e165ca554c0ecb9f46e882dc80e9bca401', loading: this.isLoading, "onText-change": event => this.fetchBookings(event), mode: "select-async", ref: el => (this.pickerInputRef = el), pill: true, appearance: "filled", "onCombobox-select": event => this.handleComboboxSelect(event) }, this.shortcutHint && index.h("span", { key: 'c9633767a7dd424b4a4eb77b80ae6e5ff83ae029', slot: "end" }, this.shortcutHint), this.bookings.map(b => {
...
const IrPropertySwitcher = class {
    ...
    render() {
        return (index.h(index.Host, { key: '287a8b94ebdd635ce0fd8afc3eaaa27b48f9ec78' }, this.trigger(), index.h("ir-dialog", { key: '09944cba0f9f35d15316864cc6ae17b85624dbd3', onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, withoutHeader: true, open: this.open, label: "Find property", class: "property-switcher__dialog" }, this.open && (index.h("ir-property-switcher-dialog-content", { key: '1d3243ff3d342cb0234e364572b3f3de4d2815bf', open: this.open, selectedPropertyId: this.selectedProperty?.id, onPropertySelected: this.handlePropertySelected })))));
    }
};
...
const IrPropertySwitcherDialogContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '71536b7a3a4b3fa70c072c8fa4817c56e9877482' }, index.h("ir-input", { key: '03b54ebd605ca6993732e77cc5efbdf4104a4503', autoFocus: true, ref: el => (this.inputRef = el), placeholder: "Find property", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), index.h("div", { key: '103a32e5486eca93610f8cdcd74c209e658bcdc9', tabIndex: -1, class: "property-switcher__results" }, this.isLoading && this.renderStatus('Loading properties...'), !this.isLoading && this.error && this.renderStatus(this.error), !this.isLoading && !this.error && this.filteredProperties.length === 0 && this.renderStatus('No properties found'), !this.isLoading &&
            !this.error &&
...
//# sourceMappingURL=ir-common_17.cjs.entry.js.map