...
const IrTestCmp = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'bf489e350df61c9eb8dd764e3a0b4aeb95ff883a', class: "card p-4" }, index.h("ir-range-picker", { key: 'b9fd5f7efb6401125923338aeac1b77ffb2e94ff', onDateRangeChanged: e => (this.dates = e.detail), fromDate: (_a = this.dates) === null || _a === void 0 ? void 0 : _a.fromDate, toDate: (_b = this.dates) === null || _b === void 0 ? void 0 : _b.toDate })));
    }
};
