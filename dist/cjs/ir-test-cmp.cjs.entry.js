...
const IrTestCmp = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '8b9274414d262df44ccd706572cdd67c5839788f', class: "card p-4" }, index.h("ir-range-picker", { key: '68ccb8fcd183b80b860f0117b8aa016418d26ecb', onDateRangeChanged: e => (this.dates = e.detail), fromDate: (_a = this.dates) === null || _a === void 0 ? void 0 : _a.fromDate, toDate: (_b = this.dates) === null || _b === void 0 ? void 0 : _b.toDate })));
    }
};
