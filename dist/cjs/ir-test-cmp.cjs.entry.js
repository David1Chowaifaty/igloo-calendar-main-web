...
const IrTestCmp = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '7055e4131d7a8fe18d61605f9e99ed3f7c523a9e', class: "card p-4" }, index.h("ir-range-picker", { key: '295740f654d96d362abb83110ea944eec0b62ac7', onDateRangeChanged: e => (this.dates = e.detail), fromDate: (_a = this.dates) === null || _a === void 0 ? void 0 : _a.fromDate, toDate: (_b = this.dates) === null || _b === void 0 ? void 0 : _b.toDate })));
    }
};
