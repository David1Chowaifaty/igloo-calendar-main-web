...
const IrTestCmp = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'fa21e328941e94bf56b2938464125c0ae07cd83d', class: "card p-4" }, index.h("ir-range-picker", { key: 'b2c3bc99be67d9c9f22534c81e2ead287a888ba9', onDateRangeChanged: e => (this.dates = e.detail), fromDate: (_a = this.dates) === null || _a === void 0 ? void 0 : _a.fromDate, toDate: (_b = this.dates) === null || _b === void 0 ? void 0 : _b.toDate })));
    }
};
