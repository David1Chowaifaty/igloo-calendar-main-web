...
const IrTestCmp = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '15bb042936887cf57199db9f7d765fac0cbd794a', class: "card p-4" }, index.h("ir-range-picker", { key: '2e3990e8debae0441ac12ed700f9b342f0f8954d', onDateRangeChanged: e => (this.dates = e.detail), fromDate: (_a = this.dates) === null || _a === void 0 ? void 0 : _a.fromDate, toDate: (_b = this.dates) === null || _b === void 0 ? void 0 : _b.toDate })));
    }
};
