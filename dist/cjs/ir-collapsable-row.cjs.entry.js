...
const IrCollapsableRow = class {
    ...
    render() {
        return [
            index.h("tr", { key: '7eacbbd6b73d8cc4bc2be74f4621450c266fb229' }, this.row.getVisibleCells().map((cell, index$1) => (index.h("td", { key: cell.id, class: {
