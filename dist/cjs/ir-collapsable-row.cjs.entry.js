...
const IrCollapsableRow = class {
    ...
    render() {
        return [
            index.h("tr", { key: 'a2f54689c6cd5b78028a7873d8f9732ebcdaab11' }, this.row.getVisibleCells().map((cell, index$1) => (index.h("td", { key: cell.id, class: {
