...
const IrCollapsableRow = class {
    ...
    render() {
        return [
            index.h("tr", { key: '3e355faac439c71c852f6ffbbf9dad8695ae5006' }, this.row.getVisibleCells().map((cell, index$1) => (index.h("td", { key: cell.id, class: {
