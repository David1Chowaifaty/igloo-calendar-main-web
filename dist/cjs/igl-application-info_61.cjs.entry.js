...
const functions = require('./functions-e01d9db9.js');
...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: '21389937e2dfd0904e61facae2dcc4a61c6e1eb3', class: "d-flex flex-column h-100" }, index.h("div", { key: '790cda9dee063c859a5938b01516614ef9d09128', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: '10fcea72a777af157ea078c3243c82071cb5de2b', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: '5ea6899c903bc797c41a91aff77e26af19070c8c', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '15f90ad6a79a527e18090afb008cd55c36fc5a21', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6911c6ff8c38e5c844b9b104302feedc81e9c4f4' }, index.h("div", { key: '4d095670a31d895fdf87a9d406e5d8e4ca0617c5', class: 'd-flex align-items-center ' }, index.h("label", { key: 'bb1fdd8b0c627df42dc1d5dadcf7ed9a0d66b92a', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'b98857b3add891841aec25124e4237e44ac422f8', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'a6c82d50ed9740849985832047c6bf7eab3cde07', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '857c69f2f9e5085a4dc484608900f0289e2eb673', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '4b117cab2fc60867de703924dc4ee58fbc3de422', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'd8393188477ee92b2532162dba20c4a41f2c6cb9', class: 'sr-only' }, "clear input"), index.h("svg", { key: '39e3b6eb7c1a4315023a40111c282785f1b9bf3a', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '75f793881d9936d833064c69c8e2b6d331589a91', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("form", { key: '8ad702a17bed9006ccc17bf8f42c26492c6ce5c2', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-title", { key: 'e98cc433b10fe26e4af610812b49ef06f55df6e8', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("div", { key: '53b10461a2d8608c66e9a3e4fbcb4790040db3f4', class: "sheet-body px-1" }, index.h("ir-textarea", { key: 'a6e039053a0840b4cf35487bd74f2f2146757589', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), index.h("div", { key: '7499b1730b2daba70595e3ea59c95ed8701bbdf8', class: 'sheet-footer' }, index.h("ir-button", { key: 'a98a7755a90d299d7bdd8e1ee0146d656fdfec85', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '84b307b9aa2d4c89f3471b73bcf317d317167c47', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ef85ca033354b6ff748b9cef568ed5ea947cf608', class: "fluid-container px-1" }, index.h("div", { key: 'e935847dbdc9af3a1c919cc248a3b7bd9062f49a', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '283074da2c8f960ef9b180d963e117da61bcb93b', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: '18eb00c9b33779db80b3b091c09ac8a1082e94cb', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '89144b1ccb3b28188b4255f52c75769326276d94', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '7597b1f4ade4c7cfe01fb714f4db1681e2ea7fa3', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '5e6bd8d1cb4982b62b684bf221f2baeb1ceaa9f5', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: 'fdf8876be8c595a5238700d5f083fc7513a5f140', class: "d-flex flex-column align-items-center" }, index.h("span", { key: '9cf3f249fadcf3d17cb26c481b820d84b98a511b', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (index.h("ir-popover", { key: 'd6390fa0d340b0024a7fd42ccf959c0a4fa1755e', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'befe97f34d832af772cfc0457b9b275f7725ff72', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '5fade0c08c086dffddd1d19692cd8f86f0f7c909' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '1dbdd23ee045c883d831fbb32cf41adb1221b9e7', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: '6d7d077cae2150898351c8aeac517fff11cfa776', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '4d072ed804d09d2a46ae9c3bb6e5072dc1e185c8', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '78343af200ab2729e3b11beb48c7b7cc0caa7746', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '1f8954b933f8662b6c6402745c6a142e10ee30fc', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: 'a5bf3f4bc094d236a8d66e2cd8df07ff3b7375a6', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '440017b0c18ec145b11a5b94beaf7159906944e7', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '87265fcfa170bfa5b9dcc7336b6580b57df9035c', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: 'a0b101cb5dd2d3a31b5e83f2c0bd5507bf69fcbf', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '1b5320c9c15065fde97faddefda3fa5cb53e1c4b', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '5b2231ea43fed616a4c7f2e978d1f6861ceb0f01', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '9f33c274a178482fd88ded2fdcbba624acee1b71', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': '400px' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-modal", { key: '150e3647789d3f08357e542f29674f186f97faf7', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales_store.locales.entries.Lcz_OTA_Modification_Alter, isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
        ...
        return (index.h(index.Host, null, index.h("ir-interceptor", null), index.h("ir-toast", null), index.h("div", { class: "p-1 main-container" }, index.h("ir-listing-header", { propertyId: this.propertyid, p: this.p, language: this.language }), index.h("section", null, index.h("div", { class: "card p-1 flex-fill m-0 mt-2" }, index.h("table", { class: "table table-striped table-bordered no-footer dataTable" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 :
            ...
            _o.map(booking => {
                ...
                return (index.h("tr", { key: booking.booking_nbr }, index.h("td", { class: "text-left" }, index.h("ir-button", { btn_color: "link", btnStyle: { padding: '0', margin: '0' }, onClickHandler: () => (this.editBookingItem = { booking, cause: 'edit' }), text: booking.booking_nbr }), booking.channel_booking_nbr && index.h("p", { class: "p-0 m-0 text-center secondary-p" }, booking.channel_booking_nbr)), index.h("td", null, index.h("p", { class: "p-0 m-0 date-p" }, utils.hooks(booking.booked_on.date, 'YYYY-MM-DD').format('DD-MMM-YYYY')), index.h("p", { class: "p-0 m-0 secondary-p" }, functions._formatTime(booking.booked_on.hour.toString(), booking.booked_on.minute.toString()))), index.h("td", null, index.h("div", { class: "h-100 d-flex align-items-center ", style: { width: 'max-content' } }, index.h("img", { class: "mr-2 logo", src: booking.origin.Icon, alt: booking.origin.Label }), index.h("div", { class: "text-left" }, index.h("div", { class: "d-flex align-items-center" }, index.h("div", { class: "booking_name m-0 p-0" }, index.h("ir-button", { btn_color: "link", onClickHandler: () => (this.editBookingItem = { booking, cause: 'guest' }), text: `${booking.guest.first_name} ${(_a = booking.guest.last_name) !== null && _a !== void 0 ? _a : ''}`, btnStyle: {
                    ...
                    ? '_'
                    : utils.formatAmount(booking.currency.symbol, booking.financial.gross_cost))), index.h("td", null, index.h("p", { class: `m-0 badge ${confirmationBG} ct_ir_badge` }, booking.is_requested_to_cancel ? (_d = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_CancellationRequested : booking.status.description), booking.events && booking.events[0].type.toLowerCase() === 'modified' && (index.h("p", { class: "mx-0 p-0 small", style: { marginTop: '0.25rem', marginBottom: '0' } }, "Modified")), lastManipulation && (index.h("ir-popover", { trigger: "hover", content: `Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}` }, index.h("p", { class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", null, "Modified"))))), index.h("td", null, index.h("div", { class: "d-flex justify-content-center align-items-center", style: { gap: '8px' } }, index.h("ir-button", { title: "Edit booking", variant: "icon", icon_name: "edit", onClickHandler: () => (this.editBookingItem = { booking, cause: 'edit' }) }), index.h("ir-button", { title: "Delete booking", style: { '--icon-button-color': '#ff4961', '--icon-button-hover-color': '#FF1635' }, variant: "icon", icon_name: "trash", onClickHandler: () => {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '15e3651e664e08b210616ec8961bc4e71bdf17a6', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '58e31ae5957b8b604f286b222c94fef3b69e7510', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: 'd45c463788997d7de6be9d9921fb05ae102a5634', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '673c7c5f9affa37b67bf406812eb85d572b10975' }, index.h("button", { key: '338dcb3501efe5a5d2d329cd12df6968c18192e3', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '9d1c4e8cdf26458306533a3030b1efb7f21e2fce', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: 'c4b4c750c1d2ccc1fe0f5f4a8b5c3a276e409757', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'f5aa633d09025a7693c47eab191a47edb42609ca', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '5f26802960be12881401826a75fec468e8e5f102', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'ce47cee63897a24a5cf72f0e51ab93a7627cc253', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '51119bd03316288b65b15c8f4b0246cb287b2cc6', name: "trigger" }), index.h("input", { key: '2ef7ced552a8528e0fdc5b59037dc795defc1a89', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8c960babc6ba9be2ffa83dec69db523922b662e7' }, index.h("input", { key: '8fffd4467ef6b8f92e2b557829b08c60ca521a0e', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fe545e6d10e5ab6358ce499f482f4f2d3b1d0d6f', class: "d-flex align-items-center" }, index.h("span", { key: '7bbdd1f911b3ddf06cb91b9a56776df72238a3e5' }, this.dates.from_date), ' ', index.h("svg", { key: '543fd0c267ecbf3cae7e8e46701560ec9ddec31f', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '5c32e2342fa312552bb16184cec03e8e231d141f', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'dce23ec93eb703998d84a9698a2fcde309f7f37d' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'c0b17a804a3dbf2563421afbcf016c0cec55aac7', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd9e88719512abc8227ae07a935c40f1f4b8adfa2' }, index.h("div", { key: '858729b8aa51102c9b6c435128cc986237faaa4a', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '53ab9cc84b8312f3ab019a782dd7e433b01742f3', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'b125f0b8215c685f6a585b616ac51a32019fa622', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '3f1d0c42b17388844f4a9cdc65567e48bf2e1f5e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '8cbe1d590a47cdec2e050cb18b66c46a4f09c8d0', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '4f9e2cb4e7d2ff2a5093432cc92d304a19dcb93f', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '2544b78f8ac2eb59ffd8701c2cff435825ede06b', name: "modal-title" })), index.h("div", { key: 'd94cb21f5f47f9ed2c2157441e2619affc86c91b', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '4a5dbcc0869ac628a7b9c2d860e53633b37404ed', name: "modal-body" })), index.h("div", { key: '66b1a4d92f6831444713382455bedd6ddde6def5', class: "modal-footer" }, index.h("slot", { key: '68d9b390c0dfcf596f6bc7473f68e2c843f5c36b', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '6d4a5d063bee402e6f2373f0c7977492bcaeb765', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: 'e10bc873ca0dab7432bc9b9eb5653585019d8457', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: 'be1d99b66f4d38dcb6da78c9c9dc80ae0a186747', class: 'px-1 sheet-body' }, index.h("fieldset", { key: 'cc533a6ee9b5719166c520374a24eb6c3dfdf890', class: "input-group mb-1 service-description" }, index.h("div", { key: '2502fdcd607c51b294916fc7d5f4da738b0febe5', class: "input-group-prepend" }, index.h("span", { key: 'c9d551ef5b67160166a49b76cb0d649829d45b72', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '5bcb59ea7d6696f0ba343584ac65fe74dd5c830e', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '488137e1eb767f9c35f138b1306229b4f8a1e4e4', class: 'row-group mb-1' }, index.h("div", { key: '8739d67f4735a83d73f4f181e7ecca70869d807c', class: "input-group" }, index.h("div", { key: 'a554963396615715ce2c9fd28e068a07d377b77b', class: "input-group-prepend" }, index.h("span", { key: 'fd33fb61a084c07f8151a1adb1dd4c4dda7cc512', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '6868c8cadd1a22f7f15c0fff1f3936d1b608f272',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: 'b8dc0388719ca9709ee0f30cabffb660ff47886e', class: "service-date-container" }, index.h("ir-date-picker", { key: '94964f045d5d447d39403c0a2f86368e6ed8610d',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: '9d01a712e6e619894701437ad7674f2b08a9c24d',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: 'd8f5a40cad3557ea1687d496abba5cb37887dfb6', class: "btn-container" }, index.h("ir-button", { key: '34d05a6b5d15408368eda44c680be58c2e71931a', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: 'd0a0a021f35c2b15ba074ef057cf98fae22642d8', class: "input-group" }, index.h("div", { key: 'c3c3a9045ad0d803727f49db563e68fa3d74b86c', class: "input-group-prepend " }, index.h("span", { key: '60aaa92a9c8db0337409851b86ae6deb465f7c0a', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: '330e128cdf78ab0c21e06447f49a82098a123070',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '8a7722e93ffd601229421c278dc663aab87f244d', class: "service-date-container" }, index.h("ir-date-picker", { key: 'b12c3e505d9b884dbb7c4cf2ebf0c378956ab0f1',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: '5b66f8e512ccc36ab6ab15b6afbdad4a65d894f9',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: 'd7c42f03a63213f5def18a732e748758a1a8eab7', class: "btn-container" }, index.h("ir-button", { key: 'eca1f742fda421f220fdaa85f36b161ed02ce91d', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: 'f08d39e33fc60adeb34636b8065f7d9dd2305267', class: 'row-group' }, index.h("ir-price-input", { key: 'a80d53dba9f954ad02ac9a82d8e746c9aed91af2', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: 'bf6f7b0b96dc4ff89bdffdc0ea2c398e09a6f404', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: '4eb28f71511eeb6d27218677b857b9c77df5d0be', class: 'sheet-footer' }, index.h("ir-button", { key: '07b59f743dcfd38aa136ea7d0de5488b080be81b', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '391bcd70afa5ffe4ad4306c8fec8f90533a23920', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '5ae23f90d0b3e25f2051b261b3c948d8455a2d62', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '8b13ee45f756e30655c6bbeef19a8fa6b62b6c2f', name: "icon" })));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '577d74d2f634fd2d99556ed2b194f44d8a79f711' }, index.h("section", { key: 'd9c4dd13dd8807602d3e38aab31083f7fea2f39f', class: "d-flex align-items-center " }, index.h("div", { key: 'f3eea5d9dd63d0460acd1ecf17d2ff54abe174cc', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '29a3603101ccc4028f6f8c10a1a1a6e667780a84', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '487d5774b4922d2bd5fbe10e26dc229360cccb4b', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '0429f67f0d7d7c6be0ae4e3bf4659a0d2fdf587d' }, index.h("igl-book-property-container", { key: 'a285c00c1a3315c23c98cdbbcdf2418343a13c7d', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: 'e7778043fd9759fd68f365c168abd80db23e4314', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '928e6f714ac281632d269f395e5b36059d4b9fe0', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '816d8ad352bb2bf7573f8df39769ae230b2c030a', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '8ce1dd562ec61e35bd05567f7eae501161a5b378', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '5a9a4c8763b383aa40d8e0c390d05d70ea828136', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '99ff6eb546bc25ab63aae88d1c6b2beea5e526e6', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: 'c11f35a703438b485b1c5e0c02942cba5a04ce12', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: '95a0b3b67e075fed21e5bf8239216c5655617f24', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: 'a42ad1335c31bd8bc18d0d7994e5a7c8e1321c1e', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: 'aff3464732f1d64246757f9bcef3eab42d80e22b', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: 'd691a58c340e9daf9e5bd06e7fbb09ef253e5c75', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '5a1f14d124069f4ec2c1808a556f581386a91ca1' }), index.h("h5", { key: 'e1dba528a9eb0c5fbc6cba554f462992e85791a8', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: 'be5285e3e9617799cdb78d910ab43ede0aac1bcd' })), index.h("section", { key: 'ebb966ded4fd03023ed7234849160120be8de335', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: 'da1be60599874c43ea70751d7be28755313020fc', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("ir-range-picker", { key: '5d49ff128beb36d2c8bf92f23092d6865b129c81', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, allowNullDates: false, fromDate: utils.hooks(booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: utils.hooks(booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("ir-select", { key: 'f01a80f8678a1d0ff599acc730728a3891864870', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'b0b294eeb9b7bb254202c35056510fb9be51728f', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("ir-select", { key: '8b9147f685150e7aeab5532a125b93309d8bf706', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.balance_filter, onSelectChange: e => updateUserSelection('balance_filter', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.balance_filter.map(b => ({
                value: b.value,
                text: b.name,
            })), showFirstOption: false, select_id: "balance_filter" }), index.h("div", { key: 'c3f1287438b8a1e056e144b4963f1a2e216324ae', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: 'a54027f0e86f294ef7048701bfd1974c04e589e3', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: '58bf61e519495b78ace2123f4986cb6b73348272', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: 'a92a5d74a7176a7ea04c29603aa895d701b08322', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'f13b776a5a5608963bd86eb92650864adf3058b3', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '574566f9dcb2390706758c4a5bca7ceaada77801', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '20c24190e2f39edea775316535fa9c245b894123', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'ffcc5fe7e7b8c17ea577c259921844464dfae501', class: `ir-alert-header` }, index.h("p", { key: 'eb1f181b3d26c29dec40908cf0818c31163df69e' }, this.modalTitle))), index.h("div", { key: 'f69a968495cc42d6583beb2664b984b927dab170', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '160dfb5e9c3a471dfd002fa84df0d22f79291f6c' }, this.modalBody)), index.h("div", { key: '0d4849f0fecfad8d0ce398ca883e0b48dd0b16f1', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '43815c315e5fac80dc69232d5058fb9a2e8fd0eb', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (index.h("ir-button", { key: '42e14935ccbffab8f5e1c6b986e90ac9564e8325', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e907b84795c18dc23b15f32edc56b354d88c3c9c', class: "otp-input-container" }, index.h("div", { key: 'db45bb15e8b64417a9ed413f61c3dfb93a50ad77', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '61d166d6c66f4ab5393e7659395a3c8ee6ed8f23' }, index.h("div", { key: '3a47f2df5dcaae17e10f313b1db8290df199bf24', class: "form-group mr-0" }, index.h("div", { key: '874a52666d7615afeb0cdebe9f1dca13a708d9c5', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '2978ec586a5209447edf33a7e61ba63eadfd8936', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'e5c50e9200a51e3719e4b80701c64a3d10fea73f', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: 'aa6f89312a041e6f6be8914d46386e388b61944a', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '24e1b141593e086938a5dc89143d1f39d57900dd', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'ee75ad02de644b45ff346cf78a53c9d15233ee39', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'e75490272852a9288b7b15d9b0a77df089af14c8', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '16f27f4f8f06b51f3783441f8bbc655d734e64c9', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '3b32f49bd34a051497d3c7b3739120b1d0b39cc0', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: 'cbfe0a9ad5551c9ae38cc142f2d35d891654e962', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '35858bf17f9e69aea3ebbff3a290d7d7f96a2054', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '79925258b92fce5207c34e0c50577fbc32d57df0', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '8d49d07df0df1f2debbce22c3ace672a88e69d5c', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '5c384ef71e994d997fd9c4769486e8633dbe5ecb', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '0d2ba6fe40532681058d2ea7ee045f7a73bb1083', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '20ab589211d2167748b776a28c436cbfe6e4e41e', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '50d09916e20139dd1a07cd2b5488e07612407ab9', class: 'd-flex' }, index.h("div", { key: '0a56a67f6b8a9437dd50acc1324306bc05c25ea5', class: "form-group  mr-1" }, index.h("div", { key: '992255f51720e6e080f78c33571e1a73c7295018', class: "input-group row m-0" }, index.h("div", { key: 'dca16f230943ac08e2dbeefed2ee59f353cd46dc', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'df92788201be1f6959bb3e997d6e961e56f94ada', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '8abba91fc958085e4372814c0595eb17e77f4b30', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '320a03502e86e282c4ae2aa3660d231c207218ef', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '566753d765355dfc3a41e54d4edab4d09bfdb83c', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? utils.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: 'e89f336b54573a86fb8fac4ca520942e3f4e7348', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '195cc0817c760c582591ede4337ea9d1e5918286', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: 'f9bffb8dceb1e11769bb2ffb3eca770526101e07', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '92049648f574b5a6910c2cd59e80b31156bb53b7', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'd71d6b9d8b44a35abfa71566c84dc10cfe1776a2', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: 'fe7f9f2d49482a33f44b17bd8c4a5e25604f0c25', class: "price-input-container" }, index.h("ir-price-input", { key: '6a18796f403bb91507fdbe587c351afde83e8797', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: 'ea3200d2a3e6d7b3e26eaae5d9c442c08f1026b5', class: 'sheet-footer' }, index.h("ir-button", { key: '5da37ab7d7245a189fb8f845475f996d800eeac8', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '07f51b38f398e0ae85137b4c4f835728443c195e', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e90f4615dec4704693c94d5457d953ac7bd9596b', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '3711dac141512c64f4698d6d4f143428eba9c1be', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: '5d996322dbff8fcc66b66b5ed942e4782ba979e2', class: "input-group-prepend" }, index.h("span", { key: '6801b3036ba3fb423d0bd236bad54de4d6132901', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '2ce79a48fa22dc0f515cb6f08b5d32d654c6b98e', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '3a1618b7d46f8e0b467d8c0dcdc6d6e230b9b5fe', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'f4f8b17e32e77b1eefa9bdc531ecf308cbd67700', class: `input-group-prepend` }, index.h("span", { key: '6d491df9450dbe9e7a953ba72f538176384e935f', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '130ea0369f06f5c58ba38ffa4899d6bda7d242d8', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRangePicker = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'd1ffdb431758e14c24a850f4e67560e0146e154a' }, index.h("div", { key: '950cd5d56a520c39090af2d87a6c11b75119252c', class: "form-control range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: 'ab3df6292846bf18bdb5b6b4a34e8f9d2afc0e7b', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("svg", { key: 'ff523ddb3c5130148700b0711f76dd065ac5b1bb', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '83dcead9aad04d3061fb4aee90c4f75ebce717b6', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), index.h("p", { key: '47e5da8dcd1bb7a6b264c41ba1cfcc48b49aaa7a', class: "m-0" }, index.h("slot", { key: 'fdff1d1b666134bdba97cea79b4a10f35d3f448b', name: "message" }, "Cleaned on")))), index.h("svg", { key: '66fdc3084dce84d9c4421f8049a9f79933a1153f', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '4171bb8a986094cb8c7bc8b16be6e16d25efa9ec', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: 'e21b9d7d0191377d3d508e42e6a4afba8e1ea6be', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'a2e3d6f4a7dc4350862b1cd84e14fa51e3659bf6', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, ((_a = this.fromDate) === null || _a === void 0 ? void 0 : _a.toDate()) || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '823a5a4bd898ff464ed62b45faba854c37c6bbdd', class: "card" }, index.h("div", { key: '80ef030904340b9f4f904e7afd870c0451740e3d', class: "p-1" }, index.h("p", { key: '24b2785d9a65164709537f385b96287e8f64ebf2' }, this.booking.property.name || ''), index.h("ir-label", { key: '97ab31d3ead7261d795041b8bcb7be05153c0d92', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '9ce2e4a0189e87af969bcb65760465e3159ab1e5', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: 'ded8847080828e07e827068e11741ef3a2f0eb39', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '81a0e4796212eafd9314edc4f20c0a9cf1a366c5', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'fbb03c2277400639c759af0655665fa47f49079a', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'd19473163784895d287d2d9fbb5a290275272211', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '58a627b8f92cb87bcbc945914b742e6b06fb718a', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'c94e1affffc91032ce20bd9a928890b9aec35ea9', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: 'ab47f281c51c83b94c044e682e1a9210f39f0003', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'a3a73e4ed3a9517531bcfd68cbc7c34376390205', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'cfb9143bd12e7c5d297dbc571aaf67d613e48f4c', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '5bc0a868151fcb288928282912f639b21618b5fb', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '78673e9856c2ea3682233bd19cdd640473dcaf7a', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'b7ab61af4df3f8fc6647fb59c9edd611df662677', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'd9608f30716e8971f0438d7d7a1d7479ebc7a0e3', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '904a27010ff7a9879459ff63581c26f0689e003f', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'f21364afa8fc3056f7dc5b8b7ecba273b53e5133', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '13603ae31d63d934e6cc928cd70afcd9b0ecd7c4', class: "d-flex align-items-center" }, index.h("svg", { key: '7c71a0add605e5f3bcdf20f845dc87e4a12d6afa', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '44dd7ffb0da5a0b9dfcecfca98abd9d03e4fb1fc', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '72a1f50ced7eca09748085dd67e64ee56faa979a', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'a28876051249dca587ccd14dccc48baef6029575', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '0e2bf543c75612152e32d05bc222bb42d34934df', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '51889f212dd166934bccf0639beb61663e998792', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e3675863ef9aa761c3dc64fab207322bc3b22862', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '9610a4b247568faab6bc235d7ca8bd48bd1e6dc8', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '2f70d75a0b3554acd8382fa81c06b8c499521a22', class: "flex-fill m-0 " }, index.h("div", { key: '69a4c7434c2852739f0c1f50ac86ca78452722da', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '7ee2e4fcfcc1b1367dbd734ac33428fd7cd890de', class: "m-0 p-0" }, index.h("span", { key: '2d26fced6c7012efe9531bcd3f5fd28b6b487f66', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '584ebaf78a12014a7de439a0c05925eeb59cf0f7', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '2f6e322bd779df4ea1c09dbc21ddf503a0993ae3', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '1e146d3c2d29dfe5f64fe1f45dd60e40fc27736f', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '1e4c75836ef8ae5a5104e7eb0c163baca8f67379', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'a761406ee93810ed3d7cbd57930bec6c3cb1c3bf', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '4ced57e7fa40b54c123d1f26b087d1e3fe087d3a', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: 'ef5deb54e95c8b5bf62ac73c0f007e65827362fc', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '84a7fbc86a8d57ae8d4b4eaace400ee932587eef', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '334816d42a8aae3e802e18729b15219bde66125c', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '46a1358ffb38561571be8bd63ab8f8926dd59ac7', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '6c537f5233798316a67f78d2a7fe68c4b20c9c91', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '0f1697632d4f926e2d55b0cb42a2d4c93d42dde3', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '85e56354d23d146aff8079b7947adaa689f249b9', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '44f2f6162b8eb15d250d29e5033a11b98abda627', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '552d8396bf26c4d10ae3d566d062d6eef2ef1888', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '06f70572def00958845244bd97094885670fe0ef', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '3607ecfbafa48d2eebde47498246e09038ab76db', class: " sm-padding-top" }, index.h("p", { key: '9db61733abe33873b9797d231f37caf7b47c3664', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '2bddd9ad1b50d419a1b8087405adfaa488da04b0', class: 'flex-fill' }, index.h("table", { key: '6b574aec91954e90fb3aece1c6ee2da0af2673c2' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '6906d3a40e9bbc87571352bbe9ebf6b5daf2a05f', class: '' }, index.h("th", { key: '6d6d682e9f4d4b0204511e6d35b5697a9f7a2d65', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '771fe19d24c8e50073aded97375c319e7a06d97b', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: '22221523e150dea63a64b1eeae5c7dd973145d6b', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '3630f37116e3915b7eaab5aa4faa838203bb83d4', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '80acf7229c7aa1a2c63e07a1d6b4a8a74e2a3300' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '9fda0c77a0ba217d38541d001cc5f7df096fbb91', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'db6a0f01c234cb7352f445f295e1ab3fd9c1fb2d', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '2d5db27bba446ee05106ea94d96d828898de4293' }, index.h("ir-label", { key: '3a5b15ba7530f19aa533fb3c186d503bfc0380d7', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '05e5bc80e735a75ca532e9d1bc105c1a6449aeb0', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: 'f41f578d939c23446bf3569422ef9c8539e951dd', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: 'c52056293093c54721694c314fe0ff62940308ff', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '3fafd352ebe5abb4f1cbf11b5f60b3b3604cabb6', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '4d99fa7b421e691b862ae37bf7e898c1eb888688', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'e3b999ad4feb37b1fce4b633549513c0c74712df', class: "input-group row m-0" }, label, index.h("select", { key: 'c0e3fc4aadd2ea3b6fffe614df6a19e5bce2ab5d', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '81ac47fb62929ab8d6cfa8a289e1e9fe56e4448f', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '828a25ebd41d26c7e8a48a59e8761d26d63532a2', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '79a0a7410ae0c84b6f66b06b67579015bedd45e9', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '821c30377d38709b4a3ae698a81a0ed03548c157', class: 'sidebar-title' }, index.h("p", { key: '11261a7f58a13402e0e414d792f8384be01a9049', class: 'p-0 m-0' }, this.label), index.h("div", { key: 'b7aaa8d3b1ff7e6d038b598b0f03296bd47b5a0e', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '6d26333aa71c4e20ec09869583a58f8bcca0d6ba', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'd12f4333233b3284df4e7cd7a5c06ecad8d1b07a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '2f2e4a5ee867c418aa6398f7a947cb355d50727c', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '7efefc8efa292bf243e4bf49666cd7e1f8965fde', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'fce65043be0494981adb391da0a318b566461c23' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bd1f2488a05d00b37ba536971141906b739e36a9' }, index.h("h4", { key: '2c752262df7444cee8184b30bf3d680ce1049922', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '09e0e07e884306e4b7c4582e2d02842c4a2002d8', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '17c54f1fc10a8a67609519a3b1ffb49961743e1e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '1e5dab3d98f9e5a638c47b0f5d5fbe6e3791ee81', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '72c68356af1dad62876889d3ab25b87df5564b4f', class: 'title-body' }, index.h("slot", { key: '2f49fc83148e08b9c7bb73ba690706a3d03df6dd', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'a3c0b6de4829050dbe01b7ed9d74fcb173f81f80' });
    }
    get element() { return index.getElement(this); }
};
...
//# sourceMappingURL=igl-application-info_61.cjs.entry.js.map