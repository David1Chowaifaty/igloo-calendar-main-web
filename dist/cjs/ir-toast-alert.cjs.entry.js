...
const IrToastAlert = class {
    ...
    render() {
        return (index.h("div", { key: 'dcc23370583fba2ebf5fa45be9a10a8fdb17297a', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, index.h("wa-callout", { key: '23e8fb59f2a0bb36804e1ce1cb4bcf498e3df8af', variant: this.calloutVariant }, this.getIcon(), index.h("div", { key: '9383f60e816cd23d668a56b859e13f45d148f1d1', class: "toast__body" }, this.label && index.h("h3", { key: 'bc11f3acda3584e9957995f1f790385a34174ecb', class: "toast__title" }, this.label), this.description && index.h("p", { key: 'ffc1e580c0c6d4258e3b185b2ad94be9dd4be2ee', class: "toast__description" }, this.description)))));
    }
};
