...
const IrToastAlert = class {
    ...
    render() {
        return (index.h("div", { key: '843193a1f1814610dac4117bee5f87bc854a2576', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, index.h("wa-callout", { key: '4af3302205f9ce8ecb08e694dc979d7d772a8976', variant: this.calloutVariant }, this.getIcon(), index.h("div", { key: 'd4483292316ad073d8eaa7f0c5a506643cffe8f5', class: "toast__body" }, this.label && index.h("h3", { key: '81fbef56f3c0a45ec9fffef2c771558ff71dd2ff', class: "toast__title" }, this.label), this.description && index.h("p", { key: 'd931898c0af278f9da9626e4d647f1606ee918c7', class: "toast__description" }, this.description)))));
    }
};
