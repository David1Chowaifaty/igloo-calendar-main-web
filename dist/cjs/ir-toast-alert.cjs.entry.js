...
const IrToastAlert = class {
    ...
    render() {
        return (index.h("div", { key: 'bf2ea16312c4c5d005655c9cc3596720eac4c1f7', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, index.h("wa-callout", { key: '4f3378ac25c48724b450e9db53ca159a233ad557', variant: this.calloutVariant }, this.getIcon(), index.h("div", { key: 'e49d6d29f6b49351c46e38bfc4c1c41b109a934e', class: "toast__body" }, this.label && index.h("h3", { key: '1981dee038f16b4804733aca5b01e0f6ae7087b9', class: "toast__title" }, this.label), this.description && index.h("p", { key: 'ff4ca00b28f2d7912ec428978685d592f7f68fdd', class: "toast__description" }, this.description)))));
    }
};
