...
const IrToastAlert = class {
    ...
    render() {
        return (index.h("div", { key: '56a78d4112c7fe2cafb392d8159ac340b4884175', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, index.h("wa-callout", { key: '8a61c9a4f5ad2d8e0fb3782a6b8d92c13b9264d1', variant: this.calloutVariant }, this.getIcon(), index.h("div", { key: '47af46ac0378ebced57d2b328d93b7a7c5d83b1f', class: "toast__body" }, this.label && index.h("h3", { key: 'b0fc463db8ccae4d3c7447d56c77e173bf9b484c', class: "toast__title" }, this.label), this.description && index.h("p", { key: '876af7d5e70fc5e8605324aa67541d3dcb63570b', class: "toast__description" }, this.description)))));
    }
};
