...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c658a80a16d0c1acb739e27f4b4e39204901eb33' }, index.h("ir-title", { key: '1611c6046dea55f93f43941e7a6dbfc563bd4c28', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '3fb817cef1e2fe3cb97088c6f6d104485aaa1bfd', class: "px-1" }, index.h("div", { key: 'db87aac59a48e4f24a63d3cb5de8f09be83497bb', class: "d-flex" }, index.h("ir-select", { key: '5e9a78e84ec7f739e895613cc5a841446fe5cba1', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), index.h("div", { key: 'e66a441e2cbb37094f45664b3529425bdb6b454d', class: "d-flex mt-1 align-items-center" }, index.h("ir-range-picker", { key: '7ceefa196485624f91056ecc065197dbe66f9071', maxDate: moment.hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? moment.hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? moment.hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), index.h("ir-button", { key: '6cf62e0c4df1e9576a0e77c4d92f43a453897d77', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), index.h("ir-button", { key: 'a444451639b0ad98870dd910fbbe73fbf675d39f', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (index.h(index.Fragment, { key: '61b2051711260e64c199036eb97117a2c0b64fe5' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("p", { class: 'text-center mt-2' }, locales_store.locales.entries.Lcz_NoResultsFound)) : (index.h("table", { class: "mt-2 table" }, index.h("thead", null, index.h("th", { class: "pl-0" }, locales_store.locales.entries.Lcz_Period), index.h("th", null, locales_store.locales.entries.Lcz_Housekeeper), index.h("th", null, locales_store.locales.entries.Lcz_Unit), index.h("th", null, locales_store.locales.entries.Lcz_BookingNumber)), index.h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (index.h("tr", { key: d.id }, index.h("td", { class: "pl-0" }, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales_store.locales.entries.Lcz_WasVacant))))))))))), index.h("ir-sidebar", { key: '7a0b0c8dd4120132c1ba37cf7713115aa2bac9ff', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: '58cd39b6d0fb0e0eb03f737afb2c714cc2fb6e9c', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e67c9427aa858a4c1a2b8825310bcddd668ddf56', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: 'c8c706b2f8e6bc4bb874497debee4c1fd20414b6', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'df5d4278ba87f57707d6807063f7c5e8248dd511', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'f8b47184181b104ae64c4ce543c7912727a52dae', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '05520508c72175970938e896b6aca41985f33594', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '5a6fe56e1704f76472eb001a0c0b7aea16691290', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: 'a69e16651135c32d262f538cd5de72251a3dbaf3', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'fff0080986a081ee69caab5c8460b608aaec4e07', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: 'b30256877b40036531716c70e091bbddc980024d', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'd13e64eadb31fd2a900ed6450c157ad81d651bc9', class: "pt-1" }, index.h("p", { key: '6e5cff071b4a03b400dd48cd73c966eabfd72d71', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Period), index.h("ir-select", { key: 'ff92c82f97dcc2f2384a8f2b44943e534fb47503', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: '40396673e3c525b23ee858de373a1a4f313cda6f' }, index.h("p", { key: 'a0d596efeede9732013b9271db52c82147ace74e', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Housekeepers), index.h("ir-select", { key: '7805b8824225e5877ba27eab8f41e9e8f2b8290c', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } })), index.h("fieldset", { key: '26342ad10c5703ab51ea4ca5865a217dbff88d27', class: "mb-1" }, index.h("p", { key: 'e08355a7c7656c85be31d4edafe462fb15b717bd', class: "m-0 p-0" }, locales_store.locales.entries['Lcz_HighlightCheck-insFrom']), index.h("ir-select", { key: '6df072cea1bbd38ca6329717c7601c90c50da94a', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '5713450f52581ddea98e24ffe9c09171cba39023', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '1fde6ef161a34b7e0cbf9dc82952d8379ce7ba68', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '1676cc6c9b410ec80638ec03e808eb09562c6e53', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '75624c3e7775f2bf78e6f22a12a63dbcfbcba791', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: 'e2459bcdac3d3fef79f642e9af04ca6cfa0f66ba', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: '5542ee186c68e3102b22825186bc801f6eec6561', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: 'f455f3468d62408b3dc14dc1ae5155504cd2c68c', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: '886a6398de7a3c93b6a48574d0f289beada88243', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: 'c9a030cab1ed0f274be46ee5904897d28e3529d8', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0b79f5bcf66e2e0a01df32fb6310b739e1977b52', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '0aee98421eb8f63679257c68f7036d8ab327c59e', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'd2843eaeb3a46b9ef206ddc22f2bc8d8e6ae11ea', class: "table-header" }, index.h("tr", { key: 'b85b1929859480c5e902ebd10c9ed75550b36e8f' }, index.h("th", { key: '26cffdee2c948b05821f493e35ab2ccfb4ac3b1b', class: 'task-row' }, index.h("ir-checkbox", { key: '8543cbf72d94752fc3146fcac38c72b5475e2e5a', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'a8436e413721397d03def38b28c8171ba910394a', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '54ee6d7a5561a9569627819e93d32c609eba2fd3', class: "extra-padding" }, locales_store.locales.entries.Lcz_Unit), index.h("th", { key: 'c8a9e39095ca0562ce289351adf742c7e1ff2d8d', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'b800d68d1ff3393a342adbdef381b93570be26fc', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '05efbb960d8cc079941212f51386717029dcbca3' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: 'bf412580392aab2f9c3261fd78ed39d71497b05a', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '42d9d3dbaabe1a0776b938e34278e2cf8702074e', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'faf95da799011b9e5b4e6f5cecedb44f3ebf13c4', d: "M17 20V4" }), index.h("path", { key: '29c8086f4703cb7994a7d68638546151227f6ab9', d: "m3 8 4-4 4 4" }), index.h("path", { key: '8050d46e2aecd0ccef019f539198bfdb3d24dce0', d: "M7 4v16" })))), index.h("th", { key: 'dad031310cba9446d06c00feda7c00e1381b022a', class: "extra-padding" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: 'adc99f481b858a350930114bce11088f99eb8f78', class: "text-left" }, locales_store.locales.entries.Lcz_A), index.h("th", { key: '27aedc2840385d53bfe7461741227c0d7cbc9906', class: "text-left" }, locales_store.locales.entries.Lcz_C), index.h("th", { key: '5827b140b727c6df435893d9e3484f17ecfdc4bc', class: "text-left" }, locales_store.locales.entries.Lcz_I), haveManyHousekeepers && (index.h("th", { key: '7b01eb607903734377387371457df55633521dc4', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'b1b9b17056b4c7b4e19345478d55c54d121c2e60', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '0aab1578b0672d899846ca8771cecce11767cc57' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '3ccadc489b3d47c7a7833ab2ed63987a25336648', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '4942c1d472b1170b9c4cafa7b82f5663e2a082ee', d: "m21 16-4 4-4-4" }), index.h("path", { key: '2924ea4c41e5f4cd5cdba3db2eaaa1a0780f7009', d: "M17 20V4" }), index.h("path", { key: '2be966a75faa8b3f4f4a2b9c835001c19a74bb56', d: "m3 8 4-4 4 4" }), index.h("path", { key: '3afc5ce629e2f0cd75bb4cb8878b9ab3124e5af1', d: "M7 4v16" }))))))), index.h("tbody", { key: '6a7a3258b7339f4c10cca7c0ab11508c98687fbe' }, this.tasks.length === 0 && (index.h("tr", { key: 'd59ed56edb48067546d0a3869f2e5b68565cd947', class: "ir-table-row" }, index.h("td", { key: 'b88708b44ea8b72a60595d0fa029021dc4dbb2a6', colSpan: 9, class: "text-center" }, index.h("div", { key: 'e5eaf1c50766919b155dc37d70956f070e973a71', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '16aed3d8ca8a933da972fc6819f8c587298161e5' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), this.tasks.map(task => {
            var _a;
