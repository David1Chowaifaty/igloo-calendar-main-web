...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8f6c5f0d34da398af4b91503e9887869658c9d9a' }, index.h("ir-title", { key: '223a61303a256b0f4f3ce54f23e37785e109e3c2', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '2b5a9d08d157c9df25e48eee93a3fee7ec01bb10', class: "px-1" }, index.h("div", { key: '1a4c0cfbf285b8120d7e1035a38d7582ba1f05d8', class: "d-flex" }, index.h("ir-select", { key: '5e8a7942d29933cad1e6b1b51e30f4d4fdc2b5f2', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'd3c4bcd4a846391b7be199fb7bf8d2c71d6501ac', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: 'f6087d8cf38e7cd06d9f7f2790d021cd949ee842', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: '10b0ed513710d944ca457984f1f5f90ae0b19856', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '4474d437ddaf2e17452ec78a2c83861d31ccc48e', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '955891c2df2697d648bb54c94dd1d239277efd55', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'b80fa700839f5cc90270daa2f8cc2284386c715f', class: "m-0 p-0 flex-grow-1" }, "Filters")), index.h("ir-button", { key: 'd6125b566b209f2ee19eb47568e91c95442b6094', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '630049e9ab48b19a7a5ee3923ef64e08389b3c34', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: '062b5c6ea1a7089deea905a376ccb7cfbdf32d56', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'fb35f435aa05af78687b6227c77f0292c40bdd9e', class: "pt-1" }, index.h("p", { key: '969843dab350f7db15b168c63db3cc39969c9b09', class: "m-0 p-0" }, "Period"), index.h("ir-select", { key: 'af6060eeba3de2bd5caa79d2d331ae20d87a054e', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), index.h("fieldset", { key: '400747f0d40f4dc020347db70f62ab976f165f00' }, index.h("p", { key: 'b886273b5d57086f1081bfe41d11498000a1462d', class: "m-0 p-0" }, "Housekeepers"), index.h("ir-select", { key: '2a9be827856a5b586f36283948bd55365662baa3', testId: "housekeepers", selectedValue: (_d = this.filters) === null || _d === void 0 ? void 0 : _d.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
                { text: 'All housekeepers', value: '000' },
            ...
            } })), index.h("fieldset", { key: '1761ab122a72c269410d13096530d8ac8a1d5466' }, index.h("p", { key: '5d97011d708a3d1fa7a180e1c3eab73d7357fee2', class: "m-0 p-0" }, "Cleaning frequency"), index.h("ir-select", { key: 'dfbcf1ced0bd8e1a73e2063e568928a5ea733ae5', testId: "cleaning_frequency", selectedValue: (_g = (_f = this.filters) === null || _f === void 0 ? void 0 : _f.cleaning_frequencies) === null || _g === void 0 ? void 0 : _g.code, LabelAvailable: false, showFirstOption: false, data: (_h = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _h === void 0 ? void 0 : _h.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: '9a08e27ea5b710ad007f94149a41e27ad1ffbd86' }, index.h("p", { key: '387a15c7afb0f714ef1be1228416cfb955975e56', class: "m-0 p-0" }, "Dusty units"), index.h("ir-select", { key: '174b03d1ffaffc3d2983adcc0556bc742597a91b', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_k = (_j = this.filters) === null || _j === void 0 ? void 0 : _j.dusty_units) === null || _k === void 0 ? void 0 : _k.code, data: (_m = (_l = housekeeping_service.housekeeping_store.hk_criteria) === null || _l === void 0 ? void 0 : _l.dusty_periods) === null || _m === void 0 ? void 0 : _m.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), index.h("fieldset", { key: '344a6704b232097bc34a50da7520ac9a76920b26', class: "mb-1" }, index.h("p", { key: 'c64e7d0de13aa5bc98a6bdd51c7c83945862c35b', class: "m-0 p-0" }, "Highlight check-ins"), index.h("ir-select", { key: '9db69748701c90cffd379c3cec07ab48ba92e091', testId: "highlight_check_ins", selectedValue: (_p = (_o = this.filters) === null || _o === void 0 ? void 0 : _o.highlight_check_ins) === null || _p === void 0 ? void 0 : _p.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '50e568ca860ffd8bd9f94760ee34c18fe8f7ec1e', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: 'f64c22e14f369b46d34b9072e4c6e42ef9a8ba77', btn_type: "button", "data-testid": "reset", text: "Reset", size: "sm", btn_color: "outline", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '18df7fff3d961a824b26e4b9b375ab86477f8825', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: "Apply", size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '9c7b0158cf4d190aed602ae94ab540b11bef29dc', class: "d-flex align-items-center justify-content-between" }, index.h("h3", { key: 'b99190b7e737350ae0fdd540eba29295b0f5be58' }, "Housekeeping Tasks"), index.h("div", { key: 'a1ad5b48f4ebb0f90e65b88586b08004aaef4527', class: "d-flex align-items-center", style: { gap: '1rem' } }, index.h("ir-button", { key: 'ed4758a84920ec23bf9290336749d0687d3404fd', size: "sm", btn_color: "outline", text: "Export", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }), index.h("ir-button", { key: '6a40e2426fdafe5995125818310acf9406e7f8e4', size: "sm", btn_color: "outline", text: "Archive", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: '4a221d8f272a5c9417aee10b1d04099bdb66a814', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        return (index.h("div", { key: 'e15b15a32c6c919be119627476aa4661f48b09e0', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '79c87765d91fb75f8154f0d40998e0e6615c09b8', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'f25f26c77758796cd0997696c7590e52c5e5c761', class: "table-header" }, index.h("tr", { key: '04b53417f5e10dbd37fb1bf92451cf338fd60745' }, index.h("th", { key: 'c95c1ad920ca250c60f5eb1db7f294a9f76e2832' }, index.h("ir-checkbox", { key: '5857b6b5bb81ea83581dbf25a5f9e3917a8639a7', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '1c5b0075c46c5cf90a208f618e2ca54e850bfe32' }, "Period"), index.h("th", { key: '65ed71ea8d5f2704d09c2fd1ce3eea16b810bce0' }, "Unit"), index.h("th", { key: 'ce578da4586b44bdd17517a7d9b8eb5bd3256bd0', class: 'sortable', onClick: () => this.handleSort('status') }, index.h("div", { key: '286b7bfba528ce252c833ca2691e98d4bca569e1', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '045dbcc008345d27429019591df37ecdb696ff58' }, "Status"), index.h("svg", { key: 'f13f3a1a3610146d3434f978035174f4dd8850a7', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '7564eb55607cd677e17f811f79ddab10a0ee371c', d: "m21 16-4 4-4-4" }), index.h("path", { key: '2f61a48eeefdd99f9a506b5717b3a57a657d6f2f', d: "M17 20V4" }), index.h("path", { key: '162741865f42e6a08105446b6883c4ec002a9128', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'b1c613dab0e6dd07200bf11a7fdf523ace5640bc', d: "M7 4v16" })))), index.h("th", { key: 'e96af181db9ab2cae97205d6a1721647bf970cdb' }, "Hint"), index.h("th", { key: '4bbe4700804ba23fd79dba8bf14a60d1276e6512' }, "A"), index.h("th", { key: 'd80029193dd0c1dfd31dfde88968034ad0d63b21' }, "C"), index.h("th", { key: '2e5f18d1751113c15ee1a37e5fac2b4b916d3189' }, "I"), index.h("th", { key: '15c8b6d9703cd984a0c26b6be8be2e118e3f5b66', style: { textAlign: 'start' }, class: 'sortable', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '0f104f0e307ac200434663bc8fa942ccdb244f3c', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '23ee0fb8d596b29996757724e5d7a2c6a0d1979a' }, "Housekeeper"), index.h("svg", { key: 'daa4ea9a647e0079a46244e0a6cf6ee2ce815075', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'd1af7ecd7a9b5f8bda689ae3aedc001657008f0a', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'ca49984d9143289bfb6fd85d5d3fab27069ffe61', d: "M17 20V4" }), index.h("path", { key: '818ab9f0dc8c1cbda997c0129207b0757a13258f', d: "m3 8 4-4 4 4" }), index.h("path", { key: '598e2db6a6844b9d9aa3bc1f1bef421e8ff14953', d: "M7 4v16" })))))), index.h("tbody", { key: '706e729788204b54e3a2f025ffbea329c015ae32' }, this.tasks.length === 0 && (index.h("tr", { key: '35a0aac223516f11c36108ec53d55088553d39fb' }, index.h("td", { key: '19e099cc6d9c30009add79e97c794ff652eb7f9f', colSpan: 9, class: "text-center" }, index.h("div", { key: '087c221008af188858d53db03371a41a994f9290', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: 'f6f656e50d71e678b2631bce58ed46a116e2535e' }, " No Tasks Found"))))), this.tasks.map(task => {
            var _a;
