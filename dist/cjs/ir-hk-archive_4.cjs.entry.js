...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'da5f2f3c440aa04606283ec68237f906e0b581a1' }, index.h("ir-title", { key: 'cc45ed9fdec55516b0c23de7bed4f569b5b0cbc2', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '9c251f6aad249a885faee9aec2f0080681570018', class: "px-1" }, index.h("div", { key: '1714afe1b99eb3eef174d8b09255ad076bbf05ae', class: "d-flex" }, index.h("ir-select", { key: '2f00090d9a94aad230ca753ad631aa44454872e2', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } })) : (locales_store.locales.entries.Lcz_WasVacant))))))))))), index.h("ir-sidebar", { key: '10cd00831a1205d738a977b801bef3cf10a58197', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: '18a89a9cb5a278685af9eeebdece38db6846c366', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: 'c6c0bb51e02996d0ca4f0b96d06be46813c0bae5', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: 'dc53ac0fa43f081987f796c97a2fb873f187e0db', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: 'e652cef9552e3235becb8d5c28969194b261b755', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: '33221562fd5ecc735d5e053caad3b63ad6db38e5', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: '289cefd2eb6de7b92a7bcb1633eb9e8aa24b6d78', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: 'ad45849e44dc1778c4bf6c708dac7775689b16c1', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0b128b2f1202a097431884ca9aee5a358e6d8e18', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '4bf89fce83a06f9df596fc96c692b1add7a6f6b3', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '39ada41550cca50115048c2bbbca5346585837b0', class: "table-header" }, index.h("tr", { key: '8d4bfc701063051011944573dcfe60fd455e2b64' }, index.h("th", { key: '1c028173ced1869fa1aba132fea7491b2c38e0ee', class: 'task-row' }, index.h("ir-checkbox", { key: 'd22c2eca1e777f36edcfd538b77b728d83c85ea1', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'cbd714be2728ac24678235b8036a87eb8e8c58bd', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '4935a552df76d33ab7760219983db7846cc8695e', class: "extra-padding" }, locales_store.locales.entries.Lcz_Unit), index.h("th", { key: 'f62cb7876810acf12917943da09c89d8612b979d', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'b9a457a1f360fdfd9752634aab7844654891710b', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '9459c4af0fd1b1dc968a24a66a29df07eb39cc6d' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '1d0fc66573739d20f1472128c14989b87e4332e9', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '0e703de3dd96412d15283391faac54b974f52c7f', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'e694e723fc628d5ac8a709a7d5ed14580b0b59cf', d: "M17 20V4" }), index.h("path", { key: 'e81218dfab66744686ebe17a48fa83f39a540c43', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'e63c586bac6bc4c4af3debf8ca82d637a9956cba', d: "M7 4v16" })))), index.h("th", { key: '9207b116b65487053a19097454c4851f261a8808', class: "extra-padding" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '38ef238eb57961b6b16648b373c19b82effff8b2', class: "text-center" }, locales_store.locales.entries.Lcz_A), index.h("th", { key: '42d1a9c126709c9e9f1efcd70bee7b6c902aea02', class: "text-center" }, locales_store.locales.entries.Lcz_C), index.h("th", { key: 'a4b276a06390b0162ac734e8f097db4cc8549f4f', class: "text-center" }, locales_store.locales.entries.Lcz_I), haveManyHousekeepers && (index.h("th", { key: '4493ecf2219b16b49287d7116e80c36701a2abbb', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'a42997bdfc6c00a9912fe3969c166521f3438bfa', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '0fe1b62a23f516768fcb5538a09af962903d32bb' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '649f46230cbde018322fc218578bde2ac133f000', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'a83f4777507dcb48bc02e1b0812671e9dee9deae', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'cf54c2ecbcc90d1bfa7d74d5b48143284ddddf88', d: "M17 20V4" }), index.h("path", { key: '28de4a5de60e87b86b9fd6c94c9090e67f9ef75d', d: "m3 8 4-4 4 4" }), index.h("path", { key: '6c66ddd475b45fe897c5a6fa42f6c8c2e106d122', d: "M7 4v16" }))))))), index.h("tbody", { key: '39e1b3c641fe0c60c47cfc0b7351deb03cd2f3d9' }, this.tasks.length === 0 && (index.h("tr", { key: '35cab6bbdfda9f9e8422c0335391b14398ecb778', class: "ir-table-row" }, index.h("td", { key: '918262b945274cafb3608045e9b6e2d08a10bba1', colSpan: 9, class: "text-center" }, index.h("div", { key: 'e9e3c0d14475c7063d86a9305c12ef80865d8e59', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '3e68ead486e8dd14889a7f9b3c8892a374670c8b' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), this.tasks.map(task => {
            var _a;
