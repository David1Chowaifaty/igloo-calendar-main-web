...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '900a5543c3427c61e01ada10fc749df9d2529d43' }, index.h("ir-title", { key: '1bdc2f434a47d239abab46afe1adcf35a0c7029a', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '4be9470e42c50fad3bf00fe4a669ae26bc3f9c68', class: "px-1" }, index.h("div", { key: '3222fb3243a37739805f46b1903c035b43586301', class: "d-flex" }, index.h("ir-select", { key: 'b613d389dd082c54e715360c194a7582e7377d4c', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), index.h("div", { key: '2907943b540e227b2a4acce9bbe06c28de35e06f', class: "d-flex mt-1 align-items-center" }, index.h("ir-range-picker", { key: '470214ae25fc4ae17c01b86f0836dcf63e7fbf44', minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? moment.hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? moment.hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), index.h("ir-button", { key: '3bb5b1afe7049dc9f7c2cff648a92389c3a226d4', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), index.h("ir-button", { key: '1d2ddcf39ba68f11a85ef48b55f4ce4edb198af9', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (index.h(index.Fragment, { key: '5b593f07046690624a69d5673de9b3ba2cabc420' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("p", { class: 'text-center mt-2' }, locales_store.locales.entries.Lcz_NoResultsFound)) : (index.h("table", { class: "mt-2 table" }, index.h("thead", null, index.h("th", { class: "pl-0" }, locales_store.locales.entries.Lcz_Period), index.h("th", null, locales_store.locales.entries.Lcz_Housekeeper), index.h("th", null, locales_store.locales.entries.Lcz_Unit), index.h("th", null, locales_store.locales.entries.Lcz_BookingNumber)), index.h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (index.h("tr", { key: d.id }, index.h("td", { class: "pl-0" }, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales_store.locales.entries.Lcz_WasVacant))))))))))), index.h("ir-sidebar", { key: 'c8de1d1a59df249b9afed6a6c5e3fe3de59c44c6', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: '1dc4a51524697536025a5586eab5ca3eca32a798', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '8db2222f4f836869e0b4fe665d6f9af4eee8a686', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '9f3e61f6b20a63901a2a79aa97ce99960ee5ef01', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: '755ea45480f861fc497c9ebf57694a34a76c135b', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'dc6b979f62b6dec00bfd7d94cd229f2e36708098', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '227bdf0b2e9f76bdee9f1148f4d1b4b7b5c68e04', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'f0c1024c90f1ef850b0a10b875e6af59cc537e0d', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: 'c4a964314d767cead93526395e85a7087f6b7580', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '636c9f6a007daf15bfd7c3f8c788bb468e6b72f6', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: '69d7c79e4ab4e0a8e2ac362246b10cde21eb25fe', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'cb25063e2337030109b14c2cffb1ee7b758377ae', class: "pt-1" }, index.h("p", { key: '94d27acffce9ed5c6addee346e981bcd5f79df61', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Period), index.h("ir-select", { key: '745f0bbdca05785c46a7d367e14ef1d4e0a2d0f1', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: '76c8cd03b7933762a65de1e160bb23166db4c1a7' }, index.h("p", { key: '78952b2fd5299cc0adaaf6dc02a2a16f892005f2', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Housekeepers), index.h("ir-select", { key: 'e75d574f7f081c2d3b051bd10c539f68d7dd3ab2', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } }))), index.h("fieldset", { key: 'd11fd5cb25507cc33add93af4ef1f0aae47bfa37' }, index.h("p", { key: 'd05870ec2b988a80286f534c833e20744dceec6d', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_CleaningFrequency), index.h("ir-select", { key: '5438654f61ec81efc67f726e7d9e942e3ee022dd', testId: "cleaning_frequency", selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: 'a946be2d91734ca241110a425b4df0dd85615379' }, index.h("p", { key: '78e76dac2e453f3e279bad6b0ea7c445731cbfde', class: "m-0 p-0" }, "Include dusty units"), index.h("ir-select", { key: 'eb792d2b18fb8d9b86a0165065001f38398261b1', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.dusty_units) === null || _l === void 0 ? void 0 : _l.code, data: (_o = (_m = housekeeping_service.housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.dusty_periods) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), index.h("fieldset", { key: '7d2205fe1e8833a23b2c0a2118704d6c1efd17c4', class: "mb-1" }, index.h("p", { key: 'efa1950c24b586afd6fe6f20195ae909fd09d37f', class: "m-0 p-0" }, locales_store.locales.entries['Lcz_HighlightCheck-insFrom']), index.h("ir-select", { key: '413876cb70ec0ed2d6394553c829c807b12b805a', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: 'ab884bd40ef06bde247d64fe2af3ac0faed5f0dd', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: 'c9e152019c3585d748c9785920eb451d70c3b14c', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '77689ea42c002baca19636f7f951c75915d83a9f', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '84fa74592b6ab81b3ae4e2c2945cc65b1cf0188c', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: 'fb9581699f9593de4c4472de987630d1f2bb49ac', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: '8dd7fa1d322eebd5079c3073942fe76d2a63d060', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: 'f60effedd72b3528bdd733772e3053480753a599', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: 'fa84c76685f6a6866aa3cf2c6323ea35b37e67e3', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: 'dbc4531f252dfa71f74b02d89e3986079bb5d33e', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a618c8e8169d8d374899185982373d651b4ddd78', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: 'cfe45bd5e5ae5af0c8ce25be0240275d6486b171', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '7d72bedfcdc0ea7598c2d89903224f83ecda31eb', class: "table-header" }, index.h("tr", { key: 'e78f99d943b116b8d5e4d9befb2d48158aca5d3f' }, index.h("th", { key: '1a1e3fba349bd49c7be60b0f84102484347cafd9', class: 'task-row' }, index.h("ir-checkbox", { key: '06b8aad4437620758fb79c5f6be52ce8af232c63', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'bd32a8d869848ad69712ab5c5cd2a5307230f158', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '8f42d2bc9c7ba4e8cda5704b47d1c959d5b79a7d', class: "extra-padding" }, locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '187ee2ad01fa747f29672d2af7749c82fd36c1cb', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'c7177009236edb50a7cae1aeed1f835d35873c1f', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '60d06ed1c1e31a646409fea31d54bed902d93ded' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '72958085f4280462400921c0cd192a143ee03742', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'd21ee8d1ed934f76df89de88caca70274c7574c0', d: "m21 16-4 4-4-4" }), index.h("path", { key: '2aa42e9c98137079943809afe2a9933a95a111a6', d: "M17 20V4" }), index.h("path", { key: 'd6606dd4ac505d9b84662fb0b40b5d4316d26d09', d: "m3 8 4-4 4 4" }), index.h("path", { key: '16580302c8b8480f12be53634b422b24b2b15b84', d: "M7 4v16" })))), index.h("th", { key: '17651114a31b7774c1c58069c3dd2237a6b9375d', class: "extra-padding" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: 'f768975a75a0317f21cd56b139c0862c73bc0a1f', class: "text-center" }, locales_store.locales.entries.Lcz_A), index.h("th", { key: '3803e9617638dbc830b885ab82f4eefb716c2f05', class: "text-center" }, locales_store.locales.entries.Lcz_C), index.h("th", { key: '112aff3ec4c62b8477d0023e376ff275f27a4c0d', class: "text-center" }, locales_store.locales.entries.Lcz_I), haveManyHousekeepers && (index.h("th", { key: '8dc89bfa39e3b8628984bca4c97fa17eba219181', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '826997bae4bf3e8416517ce44d576ecff063a2a0', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '33a76ac6f1795e155aeda00047d3d776c9026e82' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '2cb834e002c731b5e3e2398c965c9628be3fd658', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '307d17db0a6229aad236f9a261f3c4da79892bbf', d: "m21 16-4 4-4-4" }), index.h("path", { key: '8d335249be2d2715ca814f6ac738b8190d007707', d: "M17 20V4" }), index.h("path", { key: '969ca30c5748701f6a1fcc1922d5e371e5761c13', d: "m3 8 4-4 4 4" }), index.h("path", { key: '654e0f160949626ae82c0ae257546fe5fdcf5bf6', d: "M7 4v16" }))))))), index.h("tbody", { key: 'f4081c780aad82c3cc0972f1b8be8ac0c61dc048' }, this.tasks.length === 0 && (index.h("tr", { key: '773c7464f39cc31f6fbfed963cd8534cb912ca67', class: "ir-table-row" }, index.h("td", { key: '0d54b6f9261c222fc336e90643cdb9b7c119711c', colSpan: 9, class: "text-center" }, index.h("div", { key: 'bd5bc510c68e4d80af1fc6f86962d85bb2c42c5e', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: 'ae52006d60b5524f8d00a62e47a79abed2caa28f' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), this.tasks.map(task => {
            var _a;
