...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6252f91fc52ec53a377cd1bc5c421705f9fcd11b' }, index.h("ir-title", { key: 'f5f0d4d536409927c05b58b4d213479f170bef4e', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '75d487cdb83f842b7fde45f44d8d5ca029b2321f', class: "px-1" }, index.h("div", { key: 'def36d4fa9af19d9e64a8a1bdd5882894790f1d8', class: "d-flex" }, index.h("ir-select", { key: 'bea34faa2299a0c256518eec39fc0e39d62ae243', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), index.h("div", { key: '0ec9f5fefb4a3f4f54ed483e139796e88a86cf82', class: "d-flex mt-1 align-items-center" }, index.h("ir-range-picker", { key: '7b49fb715ca79da309f896417eb50937fa9fff76', maxDate: moment.hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? moment.hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? moment.hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), index.h("ir-button", { key: '3a49ea9b40fdbae02755cdda56e4fbe7ec8936d5', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), index.h("ir-button", { key: '966c2ec9838e2311531d91aae4d541cb4b791b04', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (index.h(index.Fragment, { key: '313c050e1c77c0fafe749604b8020e5c977ff050' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("p", { class: 'text-center mt-2' }, locales_store.locales.entries.Lcz_NoResultsFound)) : (index.h("table", { class: "mt-2 table" }, index.h("thead", null, index.h("th", { class: "pl-0" }, locales_store.locales.entries.Lcz_Period), index.h("th", null, locales_store.locales.entries.Lcz_Housekeeper), index.h("th", null, locales_store.locales.entries.Lcz_Unit), index.h("th", null, locales_store.locales.entries.Lcz_BookingNumber)), index.h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (index.h("tr", { key: d.id }, index.h("td", { class: "pl-0" }, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales_store.locales.entries.Lcz_WasVacant))))))))))), index.h("ir-sidebar", { key: '792d0f116b91d7826df501fdd097cf06e5503e0d', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: '6c07071b3b9bf014c0c215d0436f08bb83409bb8', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4dd8fcb942d40862dfa60829675fac16d7ab0305', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '38e2c8cbe89d6f4307246b6639b341d039edc67d', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'f74ada7389bec50d8b92ef716a96caf3b32ced62', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '9402b57a22bcf390199468145a5d25cdd1feffaa', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '8dcf3d27d94eb8a15bf4505b5aaddff36bf4558b', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '5ee2c783aa3a8cc06dda9e51b385c4c8a7ccbbb2', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '8e55de081c7c1f23501ce4234ca1a230b8bab8ce', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'd929b9ecd0f89b032fcc9f1f4cb5de60049f0c25', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: 'b1a867153d33b2dd9f2e9fc1d2d05f3658231816', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '7b3c390d0d7382c6b92e6248bb8f34f88893a343', class: "pt-1" }, index.h("p", { key: 'e8acf7d524194e9715eda94990a940e7cba9fbb2', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Period), index.h("ir-select", { key: '4c5a4c50cccb13db0bd09687bf36ee7a3a9576c6', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: '31fe085c190352db135318b4f8031bad73ab8e02' }, index.h("p", { key: 'd95b39357187ba65b70ae2742fca74c41cc7eba6', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Housekeepers), index.h("ir-select", { key: 'f886de456b90ce8bcf131a574c59bd9eecbc8c12', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } }))), index.h("fieldset", { key: '67a3eba170fbcc8ccbaf166278244cb5dfabfa05' }, index.h("p", { key: '64c08d0f07532688a1516232d25d9507ebde1e93', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_CleaningFrequency), index.h("ir-select", { key: 'a662b94b6f6dfb96684634f2fba20841a40ace37', testId: "cleaning_frequency", selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: '74aaae9d031a8609d2007baafa95efb64ec66c80' }, index.h("p", { key: '21d09a92cc8c1cba1a7ef24feb488b3df0178c4a', class: "m-0 p-0" }, "Include dusty units"), index.h("ir-select", { key: '378593c97be1749eb2d1d44c34d1806ef1c41efd', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.dusty_units) === null || _l === void 0 ? void 0 : _l.code, data: (_o = (_m = housekeeping_service.housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.dusty_periods) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), index.h("fieldset", { key: 'd2b8ef5d8be05f8edcf6c277407ce5b8e5262753', class: "mb-1" }, index.h("p", { key: 'c0fcadbbf0d6a2aca94a11efe95f15f06b19d6e2', class: "m-0 p-0" }, locales_store.locales.entries['Lcz_HighlightCheck-insFrom']), index.h("ir-select", { key: '2dd848cdfce16cc080ee400a2f578d0cbaf4c777', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '28135332d66cb9169221b9187b91f53f2825ebad', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: 'e9edf43ea448776cee9c3392c1aeb7726597a343', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '85029331fb90df85a8aca9c6a23629e0e60872d9', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '3babac362c1e064d62cf8ff54ed09448cfb654a6', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: 'e8cf6e85b68e6272cd074bc030d0477a612684d7', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: '750662c686d9425955d40cc6c10790db3ce1b587', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: 'e3ea8d44912a6f9bcacaf5a237b2d6a83b0384ee', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: '7f8ea1b1938e9ce696bdcbf22bd411c633364a9d', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: 'b26b5d1aa9d2e32b17156f601aadb096deaea78d', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '48bca6f23abbdd5c92a54040589022c4ee73dd9a', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '623e18e9e7c29872e142d5e079110f4a5169f00c', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'ca1c3d1606285894da44590ff8a30c46b8dbefd6', class: "table-header" }, index.h("tr", { key: '84f7bef0fd90660f540f86e08ad31750f83af968' }, index.h("th", { key: '5f2cf23e04c2697c02705bc9a127a14c9ffc9f66', class: 'task-row' }, index.h("ir-checkbox", { key: '0e42eb0d01390189081f6888611cd1b7823007c1', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'c6d0b91d2864ca02d474e46c735d8b1ad6b3df20', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '7b5154cf3a01e93176b46fe4432136acd16af759', class: "extra-padding" }, locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '710351e3afbae6370ab63150007524e0289c9569', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'f5689bc20b808b7ca880a7b47a98b85609d128c9', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '3787202a20ced33835adb9fc3d47e4877557d1dc' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: 'c8287c951362ba4ac7d1bb8cecdbbcba1b70a5ce', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'a18c46cefddcc043da2914b86a1f67ab5999d6f0', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'd7a2df531a4275cd14d65626b23766050b7a8083', d: "M17 20V4" }), index.h("path", { key: 'b9f83a94fc9e57500d8c37715b1227cbb7d5c280', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'c777f0fc706511d71c6b45f3fa0dedcadab8d365', d: "M7 4v16" })))), index.h("th", { key: '545e42b4c85748def3a4049c6d9d12991da50ca1', class: "extra-padding" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: 'f33a5da4a8880ae74a03d6e12bf3f002f29c9beb', class: "text-left" }, locales_store.locales.entries.Lcz_A), index.h("th", { key: '797439a9e028503c2573886c18afc85990093cbc', class: "text-left" }, locales_store.locales.entries.Lcz_C), index.h("th", { key: '59784a77923e32f3ace4d148a88e81b759d3115f', class: "text-left" }, locales_store.locales.entries.Lcz_I), haveManyHousekeepers && (index.h("th", { key: 'bbe2a810128a9406bebfa4f6291adc7ecefe248c', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '0f34ca5d3b41e1b9cbcd0a04dbc706b22a6376b0', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '00452cdfcd70d5c2c7b51fbd970cbc923e8aaa9e' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '0dec45813a30e1afd3f4cb0b4a4a49bf1a3a450e', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'd62bb2b0663c0e4029410ca1b27e2e65df96342e', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'ce5132007a1fe679156c0e36f59a511a2ee57aa7', d: "M17 20V4" }), index.h("path", { key: '10310d4a4b1830e600dc2393e75d4b21b0276d05', d: "m3 8 4-4 4 4" }), index.h("path", { key: '835ca6f1d1ad8c0584f9fff4a66577ee7331c013', d: "M7 4v16" }))))))), index.h("tbody", { key: '6de53dac173ab11b5f9aa1c6dec72d3a12ee8f9b' }, this.tasks.length === 0 && (index.h("tr", { key: 'fe120474647f6a6a7ae567fae12c8b2c0f5cb57a', class: "ir-table-row" }, index.h("td", { key: '191061a13a40eca8151ffaa545b29ef78066ff07', colSpan: 9, class: "text-center" }, index.h("div", { key: 'dfb384ff384c4dec245527511ba0a2e7448d6220', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '1607b47deffbbdefcee2f8d6800e65f03ce02d3d' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), this.tasks.map(task => {
            var _a;
