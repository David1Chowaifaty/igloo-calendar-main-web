...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9396af77c852423f4f50f5ead15388efdefe5ddb' }, index.h("ir-title", { key: '4d06c5aa8d48a7f15e07c7f8b9887b47156ae9b5', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '95f52495f075925578ebb63b858b193c6b4d66cc', class: "px-1" }, index.h("div", { key: '02b3fe7839c361d9808587748c7d5e517c40c91c', class: "d-flex" }, index.h("ir-select", { key: 'cff58de56ebccef94efa32766106e9230600c728', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), index.h("div", { key: '0a315e56c7ce803ac2976095c1dcda3636079567', class: "d-flex mt-1 align-items-center" }, index.h("ir-range-picker", { key: '0a44257464286614d1c56541e3431f8a155aa37c', minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? moment.hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? moment.hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), index.h("ir-button", { key: 'de4165652ea192d2bee2bddb3d890b178678e4d8', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), index.h("ir-button", { key: 'cbb05f114b920053323445a3ac7a94d94c473315', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (index.h(index.Fragment, { key: '1f34dde93ab754d50cf3b03492b3b208c642faf5' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("p", { class: 'text-center mt-2' }, locales_store.locales.entries.Lcz_NoResultsFound)) : (index.h("table", { class: "mt-2 table" }, index.h("thead", null, index.h("th", { class: "pl-0" }, locales_store.locales.entries.Lcz_Period), index.h("th", null, locales_store.locales.entries.Lcz_Housekeeper), index.h("th", null, locales_store.locales.entries.Lcz_Unit), index.h("th", null, locales_store.locales.entries.Lcz_BookingNumber)), index.h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (index.h("tr", { key: d.id }, index.h("td", { class: "pl-0" }, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales_store.locales.entries.Lcz_WasVacant))))))))))), index.h("ir-sidebar", { key: 'fca4d7b9ee870764714989f2ef03dcd4a8998fbb', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: '255ab08b815968b6f318e72f28b887e1b4c31b9f', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b7678dad5ce1225f360d4e408140f14cf951e1e0', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '514a788658f209eab2dd0b8bd6cdc24f638ba92d', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: '4cd7798efcef951b1d4307629bd6a28e6a521d04', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'd677e117ded9bbf61d9cc0a523ad0485f1556fe8', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '8c2f0bcc78893702f07bbdcf3ac790add0211b80', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'f1c67f611918788833577c7e30676863b7be31b7', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '7e3c5a057ca17f35f4d96ccd622e6e8612b5eacb', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'b9b4bd1c7fe260b769bef1d5becafd410e105959', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: 'a9ae70ff6fc2a355475c5e9996da201ebbe3ef38', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '57f955729b7cb7b8312f37861196accf25d3dccd', class: "pt-1" }, index.h("p", { key: 'c8012c3493fdf28964b0a38068b2478a36557561', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Period), index.h("ir-select", { key: 'd1efe35afcc2f7e207d3e76c8c3ffa79e6c9760f', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: 'cfb9ec3a28aaffe38f5c05e2cbbbcf9631b3a86c' }, index.h("p", { key: '4dd1b9408ca0f15762fb63ed909edb76a91e7a5b', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Housekeepers), index.h("ir-select", { key: 'af286613b40510ecea2ae92519c6338cb1af4deb', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } })), index.h("fieldset", { key: 'bff1dd10a941426681e5f33f6d006cfc1f08b19c', class: "mb-1" }, index.h("p", { key: 'b6d17adffb501c2406cb50e9ceadf7c2abe6ff0e', class: "m-0 p-0" }, locales_store.locales.entries['Lcz_HighlightCheck-insFrom']), index.h("ir-select", { key: 'eb14a483c0cc078cc1ae8eb27070e5c059696d86', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: 'b2ababfb54d8b897b037ba2f4f0eeebbae66f732', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '74cace3da2ceeae72552426be90ce22bbc135dd5', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: 'c2afe73148a4d02335b1f445ca0bbd4dbbba083d', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '05a7169025637cc2bf045e21c6af197411499122', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: '845b83521e1ed5180b4cd17244e1227129acdbe2', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: 'e4b76aa6af0662fffe9e46061714e3acbcf89759', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: '8531da31638c6cf6b5dc8b38cf2458860123923d', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: '644f5c2e2a46b5706442e12b8e334854c9532bba', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: '18969892bb01d94f245a7c31a4ed49dcd1aecc1e', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4ad69ac27a36dd20927b827d2802fc04361e3327', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '0a5e7ac6fb24d074905842fdb33c66ac50af1f37', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '06dcd0b9363e446e3eb3c272468310857d2a097d', class: "table-header" }, index.h("tr", { key: '3bf6fac98e4146e736b3623365330b51c49c4a7f' }, index.h("th", { key: 'd8a533ed60d45cbaea08a38ab585d4cfcdb8b81d', class: 'task-row' }, index.h("ir-checkbox", { key: 'cdef34a9e6a08b66933745a4fc9ce2ec90c31108', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'e5208f9c421062ddf8ca7ad539446942f5859f68', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: 'bd4ea0f6c4a093b93bf46f7d78d627fbe14a4cf6', class: "extra-padding" }, locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '1f0826f2ad6d8fbe0ff17553941db9432c1e3673', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'f2a8b102ab6f72c4a998b3b629c57ef18161393f', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'b3f18d96d4a64bafb1b5de19e64e09082c727bfb' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: 'c34407c18df986d7b84b0b98becb6bb538466119', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '0b6b3cf89f0788599db4d125429e63120fa03bc1', d: "m21 16-4 4-4-4" }), index.h("path", { key: '3180b8098200ebe8d634059c8f8ae3b9758fc4af', d: "M17 20V4" }), index.h("path", { key: 'ec0baf5fa7136c2416f9c2bfa8f029341e99819b', d: "m3 8 4-4 4 4" }), index.h("path", { key: '6bd9cc4d337eaf184ea5345fdcca5b9d8bc71d34', d: "M7 4v16" })))), index.h("th", { key: '1ece5d9c53545c6224e6cb0af0195b4c00d9d01f', class: "extra-padding" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '0fde690541ad0765c0df24411a5f1969cb995b52', class: "text-left" }, locales_store.locales.entries.Lcz_A), index.h("th", { key: 'd4377eada7f2940fba42c730be175aac127253c0', class: "text-left" }, locales_store.locales.entries.Lcz_C), index.h("th", { key: 'bd2adbcb92410a42b25f06e4f4599f3fd5d33e1c', class: "text-left" }, locales_store.locales.entries.Lcz_I), haveManyHousekeepers && (index.h("th", { key: '56c24c14416de3ad6e6230cdc3c7b410b1070e5c', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '02cc0ca6f55d067ffd36ac1a9ac5882fda3dc276', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'e107441699df756c653366841b46886eef157900' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '90021f8733b4a8d6c8cf8c4e3278485e2d8b54fd', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '8a2a7f6e80fd4cdad7342b7f7e5898a0c804b286', d: "m21 16-4 4-4-4" }), index.h("path", { key: '2e1b28a1156472e63b61f0e524abe1b04eaa004b', d: "M17 20V4" }), index.h("path", { key: '156ddb50377d548fdc843e168d6a6cf2fd9c7310', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'c490b38eff3ff84f8de30d3b77a46d77d063e77a', d: "M7 4v16" }))))))), index.h("tbody", { key: 'e5ef41d12629aec24cdf282a5c7fc9d62ffdcfef' }, this.tasks.length === 0 && (index.h("tr", { key: 'de8098ede02ba865db7354e752c658aa2a58071d', class: "ir-table-row" }, index.h("td", { key: '7e6a995effcd62afa02e1c2f41787df0e5fb1175', colSpan: 9, class: "text-center" }, index.h("div", { key: '9c22648e15bceba7ad0b305a2f39871755e8ba80', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '12252f9f26a8d6dc2b3a25897ed3f158f8d467bb' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), this.tasks.map(task => {
            var _a;
