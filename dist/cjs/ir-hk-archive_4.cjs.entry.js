...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '038744c091646211a65c8e1cb2308d8e3240c6e5' }, index.h("ir-title", { key: 'a11c4fee9f64f987ee633af190f4b9323c3cbc0b', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: 'd0c56caf008ebf8f1caf2a6927c5f2d5f1200d6b', class: "px-1" }, index.h("div", { key: '2b983b98ffdefac1f06c3d7711358235a5e1be2a', class: "d-flex" }, index.h("ir-select", { key: 'a52b159e4d09ce60c17e38d08f2af7f2d7e27ced', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), index.h("div", { key: '15c2d3872d4072755e41d6687163ebe87acb550d', class: "d-flex mt-1 align-items-center" }, index.h("ir-range-picker", { key: '8c9394a8cba6bd3c5bb2512782f07b0f8d31d42d', maxDate: moment.hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? moment.hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? moment.hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), index.h("ir-button", { key: '89535d76a81df2dc76e69c0df5830bda692b0a0b', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), index.h("ir-button", { key: '2b38ce875dffb9bc079e28180bd4d4358f37ff94', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (index.h(index.Fragment, { key: 'e0d3a190f78d87fc7617dd56a5c2f3e549d8e342' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("p", { class: 'text-center mt-2' }, locales_store.locales.entries.Lcz_NoResultsFound)) : (index.h("table", { class: "mt-2 table" }, index.h("thead", null, index.h("th", { class: "pl-0" }, locales_store.locales.entries.Lcz_Period), index.h("th", null, locales_store.locales.entries.Lcz_Housekeeper), index.h("th", null, locales_store.locales.entries.Lcz_Unit), index.h("th", null, locales_store.locales.entries.Lcz_BookingNumber)), index.h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (index.h("tr", { key: d.id }, index.h("td", { class: "pl-0" }, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : (locales_store.locales.entries.Lcz_WasVacant))))))))))), index.h("ir-sidebar", { key: 'a71252eda0447f4549def9049fe68512c20f1926', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: '7feeab665d32ac2f2ddad3a1aeaa1a65a2945d44', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b48e4309cc1f4f123f20c284f619f892248f7253', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '33ec0a735eff51b79e0a41ea7ebb7d9e30e9cf08', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'eeb845915ba1e2e27d64ae04d7e2ea35cb8ea1fd', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '7013d05c480fb144d4abf178125b162af5707bed', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '540bceee9d5cd37308e10a7850bd15a829073d04', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '79adf30afa8c4ac56b7e35d58aabbd71f0719613', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '59a18c0e648b59518f7bab2671a0fc9335d101dc', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'c4843c589dd6e7efc55b85bb2daacf5d4cf90b67', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: '38f40e554c75fea77f282a0b5c4ea7a778a4b7b1', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '72521e1ff3ce130f530fb074d2b37833f71f02f4', class: "pt-1" }, index.h("p", { key: '591734cd75648926185676ce5ea9a4b8864b426d', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Period), index.h("ir-select", { key: '46c0e50808083d6a36e1b2bdb0da8ca61d53c8ca', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: 'e59603d1a0d3e5241091c7d75cecada0ad6259b8' }, index.h("p", { key: 'd67abf3b213ddd8383a0c2c0e7ef1a5ebe1a8884', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Housekeepers), index.h("ir-select", { key: 'b11a1cf9866cc7c3ae6691f94cb5687446de2803', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } }))), index.h("fieldset", { key: 'ae001971e76a5157ca653914a4702207cc9b9b5f' }, index.h("p", { key: '765f2be9594a0566018d84f904b907c8377723d4', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_CleaningFrequency), index.h("ir-select", { key: '0ada18f3d216a09db3f19e09bf2250460697af50', testId: "cleaning_frequency", selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: '9901ffab5212881370b27d08fdf142746f259f95' }, index.h("p", { key: '7ef900d8523beafcb72e62bd3b5cea26f1681d39', class: "m-0 p-0" }, "Include dusty units"), index.h("ir-select", { key: '478b4f605d2c0fcf5034ff96a700838a4fddbd78', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.dusty_units) === null || _l === void 0 ? void 0 : _l.code, data: (_o = (_m = housekeeping_service.housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.dusty_periods) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), index.h("fieldset", { key: '84f20d3caac536c83252a8eeb7ced43bef1be9a1', class: "mb-1" }, index.h("p", { key: '5a5483cb86f95a902d95abb644d6c4ba82763627', class: "m-0 p-0" }, locales_store.locales.entries['Lcz_HighlightCheck-insFrom']), index.h("ir-select", { key: '7a757b64fdfb731c04f1e75d17baf1bc40ad2dc8', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '4d5b51aab4d20f62162a9d504c7751e8018765f8', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '04118f7e6a8a616a79ae520fd6b7ace96b0d4c83', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: 'd722707a9da660662a2ea2d037a6edcd310af439', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: 'e2913cf4233e74fd14b3d9fee8d2edc1aa06e148', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: 'f972f27d9f2798712be83bb023d972074166a618', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: '43b2f0a4a889de5168f27093d0f4b6b5dc0c8b23', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: 'c8a32e827059bf88555ab34c93acaae411b186d9', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: 'd5ac194abeda00c06b6aa84963713d182508cd4c', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: '181741ecd2837cae83b74dc3bc29e8d971dea855', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5ba67ce2dfd43ccd14ed48d39c2d94f5ff4085ff', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '1806f5e6a180f41320cd5d1304b714b04ff0d205', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'a7cccbb3e62aeae740c01566808ecf18b188d29f', class: "table-header" }, index.h("tr", { key: '236b5c6011b3a49e7b12b4621adfbd44b7e3c646' }, index.h("th", { key: '0e64c56b88b003ec9202eadd8d9b38b70a82a11e', class: 'task-row' }, index.h("ir-checkbox", { key: '7eda835aa979682500553175a4068fca245ec520', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '0ac85574d34f1725db1ccef31996012e7cd4b796', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: 'c21c4530d8041822929946018ff4ac58c21e7223', class: "extra-padding" }, locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '146678baf50116cda74d5048d3a5c40fff5eec7c', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: '27f88601deed900a4d8a318b264cf4dbd9aadfed', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '85b8e0051ff353cdd0e0d0c50c44cdb69774adc2' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '865d30d9d19e5ce664517533d2dd7488353768d8', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '7e0ea2b7c7c707a3a329ac0bad2ae6a20cad67c5', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'ec278b5e8d2fd1d12c306c0b94b17a024f4e6919', d: "M17 20V4" }), index.h("path", { key: '21468323f7cb570df68fd57274c13d810a494155', d: "m3 8 4-4 4 4" }), index.h("path", { key: '81b1c9ca1096eb3eb2893c0b92ef7594ee1ae229', d: "M7 4v16" })))), index.h("th", { key: '1e5255db53726c70a670677d874cb771d9246f39', class: "extra-padding" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '366ae790266ec71aae81f42736952812c8d9a22d', class: "text-left" }, locales_store.locales.entries.Lcz_A), index.h("th", { key: '88948f8b6bc610464a5352964b9502123d3ef095', class: "text-left" }, locales_store.locales.entries.Lcz_C), index.h("th", { key: '158cea268a9345583eed81b7c1e45fab10827f6a', class: "text-left" }, locales_store.locales.entries.Lcz_I), haveManyHousekeepers && (index.h("th", { key: '574dd974876d08a15eba168f3bdcd8b13ae8ed19', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '643ecfb1cce1c09924f8bd1c7acff1474862df7c', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '70a8f8d05bddc4643fb93441101d56af9972ac7f' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: 'da65047bea75d04d8737c15dd6b7efef5203e138', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'c7365ce695d2e18de2b6a05e24006d014006fd42', d: "m21 16-4 4-4-4" }), index.h("path", { key: '831ad18bbb182b9b8b810de93ed64ba7c65184d2', d: "M17 20V4" }), index.h("path", { key: 'a8fdc48b1e7084dd5fb77433b55a55f6a5d514aa', d: "m3 8 4-4 4 4" }), index.h("path", { key: '6144bf7a81d0136f399ec634e9c4c4de5ad9d2e6', d: "M7 4v16" }))))))), index.h("tbody", { key: '7d28d85fd0a0e79769ff55b7bf4e78666ec9add7' }, this.tasks.length === 0 && (index.h("tr", { key: '500d0549a96a119626f049308123a67bd32d9822', class: "ir-table-row" }, index.h("td", { key: 'd07404eb61c6ceec21d6c6374c799c07aa1a2589', colSpan: 9, class: "text-center" }, index.h("div", { key: '6f502c02000f4c806bc99cd8a81683951b3f0f28', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '1c738b496936d4deddf6697294d18a4fa1939de9' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), this.tasks.map(task => {
            var _a;
