...
const cityLedger_service = require('./city-ledger.service-7c7b0ca7.js');
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b14d0e57080bd1e7a6f6fe2f0afad53d691ff432' }, index.h("section", { key: '98c3ca59e8743b3856c7a84576c80beb3bbfd8ff', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: '6ea90372ef23bd94a08ba7c2546ee120f615f008', onFiltersChange: e => (this.filters = e.detail), onCreateStatement: e => {
                this.filters = e.detail;
                this.fetchStatement(e.detail);
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: 'f26951739a0a21364f85824979d48362bc57adcd', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate })), index.h("ir-preview-screen-dialog", { key: '4f37fad9db25af6df36b0f55c7512015fceaee33', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: '186352f9a3f220b55673fe6843f0aaa6773ac5a1', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: '769009c2aaa02cf47fde8f7a8ae12bdb14d05dda', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '25516ec05be02b6a3712cb625589f4a9d0892795', name: "download", label: "Download PDF" })))), this.printFilters &&
