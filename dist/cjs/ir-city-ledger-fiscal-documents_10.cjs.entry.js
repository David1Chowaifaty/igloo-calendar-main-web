...
const types = require('./types-bb99ee1b.js');
...
const IrCityLedgerFiscalDocuments = class {
        ...
        try {
            const result = await this.cityLedgerService.getFiscalDocuments({
                ...
                LIST_FD_TYPE_CODE: filters.proformaOnly
                    ...
                    : filters.type === 'all'
                        ? [enums.FdTypes.Invoice, enums.FdTypes.Receipt, enums.FdTypes.CreditNote, enums.FdTypes.DebitNote, enums.FdTypes.Draft]
                        : [filters.type],
            });
    ...
    render() {
        return (index.h(index.Host, { key: 'cd7e7452046fd080d35daf0e753614aebb17a0b9' }, index.h("section", { key: '16fb309bf8152140d3ad394d7a5a61aac5d04ca5', class: "fiscal-documents", "aria-label": "City ledger fiscal documents" }, index.h("ir-city-ledger-fiscal-documents-filters", { key: '4721fd5784f1866a5574274278111c6930fed0bc', filters: this.filters, onFiltersChange: event => {
                this.filters = event.detail;
            }, onApplyFilters: event => {
                this.filters = event.detail;
                this.fetchFiscalDocuments(event.detail);
            } }), index.h("ir-city-ledger-fiscal-documents-table", { key: '3d2e591b9b3273c46ef1b37bff0b003b586dcb0f', isLoading: this.isLoading, rows: this.filteredDocuments, currencySymbol: this.currencySymbol, currencies: this.currencies, taxableOnly: this.filters.taxableOnly, hasDates: !!(this.filters.fromDate && this.filters.toDate), hasFetched: this.hasFetched, ticket: this.ticket, propertyId: this.propertyId, agentId: this.agentId, fromDate: this.filters.fromDate, toDate: this.filters.toDate, onFetchRequested: () => this.fetchFiscalDocuments(this.filters) }))));
    }
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h(index.Host, { key: '05c9afef89d6234abef21fdd2778b30a83cb1c86' }, index.h("div", { key: 'e3d5b17c22a7a039d2dd1b55540d59303e00184b', class: "filters-bar" }, index.h("div", { key: '64f24378b062402eeda23d934bfb83810c1cfd85', class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: 'c2f9336cf70d9027bd738676fc075619dbc08801', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: '2ac55064afd0fb066f32e5ce492f380af856b758', class: "filters-bar__search-group" }, index.h("div", { key: '8a026bc0f834a44e9c4f00297156cffcd0cd7569', class: "filters-bar__type-group" }, index.h("wa-select", { key: '31a09bb0fb202f8aef8c4b4764907135f089c4b6', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: '77c8f3e5b1539edb1b989603689be987883497c4', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), index.h("wa-switch", { key: '892028d802e8d8a0de8b84ff661c5502204a092f', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Pro forma")), index.h("ir-input", { key: '44c6cd2a1b9ad0d901cadfc3653ff3ab80e52c03', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: '9dd21c47ecb35925d1236b65fca87e5cf55ae06a', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'e1ff740cfeb83ff621dffce2d379f468fe0d928a', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit(this.filters) }, index.h("wa-icon", { key: '157ec7abfe9d1bd67f796777d42e312a3ca77b62', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '109bdb71018e30f6aa2e2d33aaf765329784d5cd' }, index.h("ir-city-ledger-folio-filters", { key: 'a97e0dd404cfbbe50e46d3ccbb6e9634349d7059', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), index.h("ir-dialog", { key: '53def11f7a6d0a4b0186bbeec360f0788b010857', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, index.h("p", { key: '8927be60214e1f669ef184f9b7728de83af18ede' }, "Are you sure you want to delete this entry? This action cannot be undone."), index.h("div", { key: '493738d964242d48b9baa7967c117b17fd18803b', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '0f22e5c7b27dd681293b3ce32f4a067c7766ebd0', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), index.h("ir-custom-button", { key: 'f62b2bb7bee10bf6ff393a822dc009d3f44f5ab2', size: "medium", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), index.h("ir-city-ledger-transaction-drawer", { key: 'cf28142e9da2f2f7fe0f1a249214984fe3f106ee', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ffebf1eb1d8a5d8e06aa52e065b815ddd283298b' }, index.h("div", { key: 'a848206454411f59e155f2f6aeed7f5e4e5324aa', class: "filters-bar" }, index.h("div", { key: 'df6231086696ff98d76b0afbfdbba301b8acebbf', class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '63e9b53377a37b8703f0674869ddbabd5773e355', maxDate: moment.hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), index.h("div", { key: 'c58dfb845d75baf83c3767b462b4f5bcd9532679', class: "filters-bar__search-group" }, index.h("wa-select", { key: '7c8f8436e948ee54f1d1157533adba4f64f55a29', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: 'e1963d78c542d30f5ec07bc4a033afd02052eb73', class: "filters-bar__search-input", "onText-change": e => {
                this.searchQuery = e.detail;
                this.emitFiltersDebounced();
            }, value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: '9f794d5bd6924210497a0b85bc5bdf061c33b4aa', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '0d1dc07aad029fb42b49cb391a35daf60735de5b', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit({
                fromDate: this.dates.from?.format('YYYY-MM-DD'),
                toDate: this.dates.to?.format('YYYY-MM-DD'),
                status: this.statusFilter,
                search: this.searchQuery,
            }) }, index.h("wa-icon", { key: '4f6a54b228f12e784cecefe8766d1a36c91293ca', name: "magnifying-glass" }))), index.h("div", { key: 'e5aecbc4d5d735db538bc12e5e9f710eb17ac316', class: "filters-bar__actions" }, index.h("ir-custom-button", { key: 'd8aeb96d34b2cb351347ef5f8fe4c44a18b6629a', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, index.h("wa-icon", { key: '4c719a85215ce47225f060420fd64d6dee1ecdc7', name: "download", slot: "start" }), index.h("span", { key: '97ae2596c263a05fef4e0b0452a448806a83ccb2' }, "Export")), index.h("ir-custom-button", { key: '992c1ca4b797960db0623e4bd2084617253575df', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    debounce.Debounce(300)
    ...
    columns = [
        this.columnHelper.accessor(row => row.status.label, {
            ...
            cell: info => {
                ...
                return (index.h("div", { class: "folio-table__status-cell" }, index.h("wa-tag", { size: "small", variant: info.row.original.status.variant }, value, info.row.original.status.id === 'billed' && index.h("wa-icon", { name: "lock" }))));
            },
            enableGrouping: true,
            enableSorting: false,
        }),
        ...
        this.columnHelper.display({
            ...
            cell: info => {
                ...
                return (index.h("wa-dropdown", { "onwa-hide": e => {
                    ...
                    } }, index.h("wa-button", { slot: "trigger", size: "small", variant: "neutral", appearance: "plain", class: "fiscal-table__action-trigger" }, index.h("wa-icon", { name: "ellipsis-vertical", style: { fontSize: '1.2rem' } })), index.h("wa-dropdown-item", { value: "hold-transaction" }, row._raw.IS_HOLD ? 'Revert to Unbilled' : 'Hold entry'), types.actionableClTypes.has(row._raw.CL_TX_TYPE_CODE) && index.h("wa-dropdown-item", { value: "edit-transaction" }, "Edit"), index.h("wa-dropdown-item", { value: "delete-transaction", variant: "danger" }, "Delete")));
            },
            enableSorting: false,
            enableGrouping: false,
        }),
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0a68429600c3ef92d7948d4fcc08b7de9e8f2443' }, index.h("section", { key: 'e0a274e9c6f8a4a31c9e286477caf4438483b537', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: 'e0c98634804cdd2c9cc3308011da8fdbed2e0e64', onFiltersChange: e => (this.filters = e.detail), onCreateStatement: e => {
                this.filters = e.detail;
                this.fetchStatement(e.detail);
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: '369b9dd6bd301c06e26e735243e578c2ab24c29b', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), index.h("ir-preview-screen-dialog", { key: '829b0d4ca49a417c9d6dde80aa765ca9c9386e17', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: 'f1cae9a4745e9097a6976d2f9d57421a931e790a', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: 'd6510880be39990920011c5fe4104c6ea424114d', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '7970750fb17cdf6663c1bab09e1eead59c284fd3', name: "download", label: "Download PDF" })))), this.printFilters &&
...
const IrCityLedgerStatementsFilter = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ad67e6463f55640f69c468c40e23665c17cae7a7' }, index.h("div", { key: '312ceb9c000c4f520d148697f1a472bea61c062c', class: "stmt-filters" }, index.h("div", { key: '3065744d9f11191b99508cc8694435bc237f729f', class: "stmt-filters__left" }, index.h("ir-date-range-filter", { key: '822b594cfcf03c2ff7349f8846035e84c0fc2113', class: "stmt-filters__date-picker", maxDate: moment.hooks().format('YYYY-MM-DD'), fromDate: this.fromDate, toDate: this.toDate, onDatesChanged: e => {
            ...
            } })), index.h("div", { key: '1897481f2acceb4d2d15b5a17c968e43f232b1f2', class: "stmt-filters__right" }, index.h("ir-custom-button", { key: '7fa6b1038e6f3e8202cb5195bb5865571e5c2bec', variant: "brand", disabled: !canCreate, onClickHandler: () => {
                if (canCreate) {
                    this.createStatement.emit({ fromDate: this.fromDate, toDate: this.toDate });
                }
            } }, "Create Statement"), index.h("ir-custom-button", { key: '78124c07aaef1516ec079462b30c172bfa7aff74', variant: "brand", appearance: "outlined", disabled: !canCreate, onClickHandler: () => {
                if (canCreate) {
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '3d228e09248633afb71d3f37eb5a23f29433f229' }, index.h("ir-interceptor", { key: '09c1eec684d537e53f0cc9b8b4a7da89da7799f3' }), index.h("ir-toast", { key: '847d5aadf65ecced44050571179aa8cb49338010' }), index.h("main", { key: 'd05ee7dd590a39938906f22939341229b7269a29', class: "ir-page__container" }, index.h("header", { key: '30e712c6728528a6fb038f49622dd7d1b487b11d', class: "tax-page__header" }, index.h("slot", { key: 'ad499bfb354ad56e72a09667e8d5541d76eef02b', name: "heading" }, index.h("div", { key: '6ecbcae7d62081842c84feef2bfea05c97993554', class: "tax-page__heading" }, index.h("h3", { key: '06643eaf449297080e45a729a498db89a27c2438', class: "page-title" }, this.label), this.description && index.h("p", { key: '5c7ddb2cc72854aba82a2a70d8affd0e1dd25002', class: "tax-page__subtitle" }, this.description))), index.h("slot", { key: 'ef4bb53e846a54519caf34ca5679ef71c3fed5f3', name: "page-header" })), index.h("slot", { key: '67e5acfac9900f02b4fcd37bb4dd9816450b1e36' }))));
    }
};
