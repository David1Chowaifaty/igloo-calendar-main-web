...
const IrCityLedgerFiscalDocuments = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0cd5e1e5728f3d58122daae7ca50dc5a2c60b19f' }, index.h("section", { key: 'ad24ef95fa5a7d974c21fb5021300aa23df1bfd9', class: "fiscal-documents", "aria-label": "City ledger fiscal documents" }, index.h("ir-city-ledger-fiscal-documents-filters", { key: '652bd6297301cc4426423a3a349f73ea906b3cf9', filters: this.filters, onFiltersChange: event => {
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h(index.Host, { key: '533a347071439f2be31a887e6afb3961568c0f70' }, index.h("div", { key: '55baede3e7a45d4b44e2f2ec0c3972fed646aa38', class: "filters-bar" }, index.h("div", { key: '8b1b2b5375abf984b58fb5035cc6037c0ded4d2a', class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '5f036e9bbf317cfa13c1e3f56a92d26920678065', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: '167768d2de7674d6bac60233a4a2f64c0ecbf9de', class: "filters-bar__search-group" }, index.h("div", { key: '6a0ba82e63ef10d3e0aeae0de2ff4fd993e68871', class: "filters-bar__type-group" }, index.h("wa-select", { key: 'e2f99124d322458c1261decf230ef2c828df4a7e', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: '16305361cf04ebf76b13163787a6b3fa4b9da37c', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), index.h("wa-switch", { key: 'be734d27cbb1551cecc8fc5928af17de3d24694e', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Pro forma")), index.h("ir-input", { key: '2ec76f01a05d08763e6cd463868fa8bf29b089ff', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: '09bfec0f4fdcf3aeb14eb3ff20c4b597d5f0b026', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'cdea8e7eb6d5bcd5bbfc08cb59357851f65da6f9', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit(this.filters) }, index.h("wa-icon", { key: 'ac836947e73aa6dd175b3222931ef7bd29b83719', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5aaadbd6e7e4f17f3c51b3855d6dec8bbf771b32' }, index.h("ir-city-ledger-folio-filters", { key: '77db8334a600c624cbe86ec99eb653913fefafdf', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), index.h("ir-dialog", { key: '31042b47239211279080e85b2a38aaa495fbbea7', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, index.h("p", { key: '69f785bba4fd779d5569a4dafa27d852e5d35bdf' }, "Are you sure you want to delete this entry? This action cannot be undone."), index.h("div", { key: 'e0f0bb5450ad923ad5a9a436c8b4b77e4da43151', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c6d1a9620c35bc77454001ce5f4b176003af52d6', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), index.h("ir-custom-button", { key: '326f9d45d926d2040ba22f87410f7fa095222109', size: "medium", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), index.h("ir-city-ledger-transaction-drawer", { key: '2693b24a0468f9e5d8604902d20b6dbcd1488148', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h(index.Host, { key: '16ef8cfbe24ab46db55a2b37ada8cb5d725ce674' }, index.h("div", { key: 'b3b8e2e4b9aec750db264b491c20960350991066', class: "filters-bar" }, index.h("div", { key: 'b8832c8d22a819661d22a9b6401b8e106d3cee5a', class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: 'b0bb39862973975c5358c14ed498d2da01417758', maxDate: moment.hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), index.h("div", { key: '455cabd10c973617dddf74f2f048142bd3b2c8f7', class: "filters-bar__search-group" }, index.h("wa-select", { key: '832921e18b41a3251e48189c2ff5931aebfeb1a0', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: 'f78b450ab9ee61eaf90230526f536d602bf71868', class: "filters-bar__search-input", "onText-change": e => {
                this.searchQuery = e.detail;
                this.emitFiltersDebounced();
            }, value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: '0f526be955144d2f387d5ef6bc2c9f6cf6c2d606', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '77c4cb81d76f6b44fd9f618207c1bf3d7bdf45ef', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit({
                fromDate: this.dates.from?.format('YYYY-MM-DD'),
                toDate: this.dates.to?.format('YYYY-MM-DD'),
                status: this.statusFilter,
                search: this.searchQuery,
            }) }, index.h("wa-icon", { key: 'd3aacf477d7fc2556c134777ccdadb16392471db', name: "magnifying-glass" }))), index.h("div", { key: 'f5c9da9a4c60ce9146ee0da19f6c89441cb55942', class: "filters-bar__actions" }, index.h("ir-custom-button", { key: '11d254ce949bfc12ed195123f02a0a596c96a01b', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, index.h("wa-icon", { key: '15e9ed4b21a65a73b5d94acad631b5906415b938', name: "download", slot: "start" }), index.h("span", { key: 'f41ace599c1d5604c4476e63a4d352350c263950' }, "Export")), index.h("ir-custom-button", { key: '0f575afe0cfea5423c10dee979358610efd033dd', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    debounce.Debounce(300)
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ffd4f5c083e249138138cdf50fc11940dfa069c5' }, index.h("section", { key: 'bf9e10d7ed2cca47b47894c8a7d03e6f2b155fd9', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: 'a332fb2d0eb9bf2d97ff7c950fdc35a1aeb2b053', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
                this.filters = e.detail;
            ...
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: 'eb3c05c64bae0949c6056c7d189e9ae968e74e07', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), index.h("ir-preview-screen-dialog", { key: '6af183daf99f00f6d0924f42eed74857dc6455e7', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: '84a05237c9fc4d26e39d0a7f90cb9a1307f85a30', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: '49f69b41496fdae10f6fa431fbfbc9063108728f', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '3912da663ba9e8aa5060506e2865fc04be68bb8e', name: "download", label: "Download PDF" })))), this.printFilters &&
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: 'e5d5fb9b804784d6ffdea3978976ad44134a36a1' }, index.h("ir-interceptor", { key: 'a71692e59319d20b9780708b860692d140a47d99' }), index.h("ir-toast", { key: '30fc0262add660e50067a98ab6c248e1a4814bdb' }), index.h("main", { key: '3af9f0e957ea1d3356adce0566560c94b62117f3', class: "ir-page__container" }, index.h("header", { key: '1c9c7931e9143983f41f3bc4b068e90bd45b872a', class: "tax-page__header" }, index.h("slot", { key: '55e74544a9d6360245c67d0337555e4cd775397a', name: "heading" }, index.h("div", { key: '245d83970f566a3af86b9becc989838770c32298', class: "tax-page__heading" }, index.h("h3", { key: 'db33c61b131ae5dbc2c0173e1f4888c0cf78bb89', class: "page-title" }, this.label), this.description && index.h("p", { key: '29b056eb0473eb6f78f02544c43e728dbb36b397', class: "tax-page__subtitle" }, this.description))), index.h("slot", { key: 'e2c3436aa1aabaad7d9f7bc032e1273c8dd82193', name: "page-header" })), index.h("slot", { key: 'a425865a42b9e40b4cc0895225b5b0f1cad7d5a4' }))));
    }
};
