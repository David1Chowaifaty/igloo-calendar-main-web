...
const cityLedger_service = require('./city-ledger.service-11f02924.js');
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1927e54a0e84774295e3d8377cf60a6e94bb9672' }, index.h("section", { key: 'f23775f5e04b10798302a55c02abcb20ad83fbce', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: 'f95c3ebfc973b6c7ef08b7c7a64f374a8c67d985', onFiltersChange: e => (this.filters = e.detail), onCreateStatement: e => {
                this.filters = e.detail;
                this.fetchStatement(e.detail);
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: 'a34ae926b37a452fe3fded9d32005d2699a17c86', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate })), index.h("ir-preview-screen-dialog", { key: '982edfc8baaa1f02c3c341e14dbbe6a0e38c38ea', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: '1032792df1660d67293c1a25e60161670fccc410', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: '5aaa8a82011e5d6b938e4422a650cd3d1f7a3437', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '86079a91e34e75b3f78d34e7220513cd3d8bdbec', name: "download", label: "Download PDF" })))), this.printFilters && (this.isFetchingPdf ? (index.h("div", { class: "preview-loading" }, index.h("ir-spinner", null))) : (index.h("div", { class: "preview-body" }, index.h("ir-pdf-viewer", { src: this.pdfUrl })))))));
    }
    static get watchers() { return {
        "agentId": ["handleAgentIdChange"],
