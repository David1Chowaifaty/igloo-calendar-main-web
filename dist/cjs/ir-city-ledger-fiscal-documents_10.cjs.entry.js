...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd3bbb2dc13d2b93dd494a6ac9d9e8da759ba171a' }, index.h("div", { key: '3f0673b2f61c3c3cb47fe7cffee3938a15b9d48b', class: "filters-bar" }, index.h("div", { key: '8c4b3a79e3a8a2518af6e59482bd0585d5d560be', class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '6b9a497bbd7c347255a71f9285f4ba09332af274', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: '7e805087a18f05bf27a658503bb1d5a8f8187412', class: "filters-bar__search-group" }, index.h("div", { key: '4ecacfa7ed99861698765d6f14f0bdd5c1a46cf6', class: "filters-bar__type-group" }, index.h("wa-select", { key: '6a466a72ec16787777e2458131a0ccf22b95d42b', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: '76792325ef2bbb6c68ef8909ca85e03236de38f4', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), index.h("wa-switch", { key: '3fba4cd111bf54d9e691024714bbe7b58511920b', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Pro forma")), index.h("ir-input", { key: 'd3c0f7d44c3af0b99d3e9851a48f0310f52f4586', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: '78bf1cf178952ea49e13c93e2b955ee36518f313', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '3f6493c4830e87abb691de0c71fb112d26430d41', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit(this.filters) }, index.h("wa-icon", { key: 'af808a652186923dc19f03b69d4f4ec9a6a416ec', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dbad0f1e15d946c62c89d59771ff6873b697d512' }, index.h("section", { key: '50400f14c912ca3a8e377d1ee8a40bdae6917e78', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: 'f5bb235536013f9eebd618d53d77902bbb86aeb2', onFiltersChange: e => (this.filters = e.detail), onCreateStatement: e => {
                this.filters = e.detail;
                this.fetchStatement(e.detail);
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: '17c62c52240319d379311b115abd2b995cb157ab', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate })), index.h("ir-preview-screen-dialog", { key: 'f6381bae4334cfc0deba7be4f171c9da17515876', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: 'd6b844311a0131d52e84e102d6921b438fb27c68', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: 'c44e13c330def0c36e057e350678a4d34136d3d9', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '760cea2c63038e4ba507f14f936ad75e2e08f8b9', name: "download", label: "Download PDF" })))), this.printFilters && (this.isFetchingPdf ? (index.h("div", { class: "preview-loading" }, index.h("ir-spinner", null))) : (index.h("div", { class: "preview-body" }, index.h("ir-pdf-viewer", { src: this.pdfUrl })))))));
    }
    static get watchers() { return {
        "agentId": ["handleAgentIdChange"],
