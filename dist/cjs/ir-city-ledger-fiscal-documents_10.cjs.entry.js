...
const IrCityLedgerFiscalDocuments = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f091255fa88ca34d6fe912b13d23a5578c62a5ca' }, index.h("section", { key: '0211775a213342ef4840821689bd1232394d9d93', class: "fiscal-documents", "aria-label": "City ledger fiscal documents" }, index.h("ir-city-ledger-fiscal-documents-filters", { key: 'e288191cf5efa44a7ce9a9246b4a1bd3188c832e', filters: this.filters, onFiltersChange: event => {
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: '49db317c5952445e7060c4e44324138beef6d0fa', onSubmit: e => {
                e.preventDefault();
                this.applyFilters.emit(this.filters);
            } }, index.h("div", { key: '76e37dafd402850bcbf744a354f578f742b4cf2a', class: "filters-bar" }, index.h("ir-validator", { key: '9300681526a32c894852b257a20314fe9334db17', value: this.filters?.fromDate || this.filters?.toDate, schema: index$2.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '5895e1144e1ae5018acb597fd85ae956a136a594', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: 'fd632455272d8f6a407481c3c10c8b219fc4f6e3', class: "filters-bar__search-group" }, index.h("div", { key: '7ed4c36cf88b0c5a811d00abb1f59d664dd1dedc', class: "filters-bar__type-group" }, index.h("wa-select", { key: '4d052d9b96e016a24b4f5e910ee7bae1aa74d120', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: '28322ff6eda4299ed3b263f12dfab0cdb0aab0d0', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), index.h("wa-switch", { key: '12267b1d35d65f545c5c258a81fd761a666ca6cd', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Proforma")), index.h("ir-input", { key: '20475ce1e409e8e8d15575857e235d3dd80885b9', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: '8f012b674450654a9839285c5b88ee4e86da44f7', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'bae7b89e47b0f87c54d5a4450a23f8a49f93ed30', variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: '4a2d620987100886a225c9adbb27ad4e6046b680', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '768886a076b169b38848961b89a655220625d6dc' }, index.h("ir-city-ledger-folio-filters", { key: 'f302c2421eb4528e09dd66c03902cb5cf3e1b537', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), index.h("ir-dialog", { key: '6401c36349d7a3d9bb6facbe0d0cb06ba90159a6', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, index.h("p", { key: '49308c263cc8d4eda6d006504f6d3456e854d4cd' }, "Are you sure you want to delete this entry? This action cannot be undone."), index.h("div", { key: '891625bb6cd0b321158fe71ddb475dfaec78c1b0', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '4c89488edb91ae6a0bde53456aa5d3b1a410f479', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), index.h("ir-custom-button", { key: 'f16e5fd3936201059e42fb1c22e883438769f2a0', size: "medium", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), index.h("ir-city-ledger-transaction-drawer", { key: '4e8f8903033d8d088ed0af7182d597df8d82dda7', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h("form", { key: '2f50e2c5a0fd4e2465a9088d61cb50dd6116493c', onSubmit: e => {
                e.preventDefault();
            ...
            } }, index.h("div", { key: 'eb0914fad32d2466ccdc6918341fabc50465f4b0', class: "filters-bar" }, index.h("ir-validator", { key: 'a58f1483fbac58565c02307a1085b6c62e0c2d2c', value: this.dates?.from?.format('YYYY-MM-DD') || this.dates?.to?.format('YYYY-MM-DD'), schema: index$2.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '992ff7a731de454bb06129fedeb633c75ba65fd5', maxDate: moment.hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), index.h("div", { key: '0a829e27cb6b50dab4d6f32245414cd54b76a091', class: "filters-bar__search-group" }, index.h("wa-select", { key: 'f703d6643c383f23b006c891cd7e07905f5afc31', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: '5753ec7aaea34deb5819d1f75ccb0f3e94694755', class: "filters-bar__search-input", "onText-change": e => {
                ...
                status: this.statusFilter,
                search: '',
            }), value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: 'c2a43087d21ab89f5b6cb40104adae3a363b6f1d', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'e32c75b4e0bc72d7b9abc80617e142cab3853e31', variant: "neutral", type: "submit", appearance: "outlined" }, index.h("wa-icon", { key: 'e8c6a8fd2555616844ad770ec104f569cee664ad', name: "magnifying-glass" }))), index.h("div", { key: '4ac3b3603667d222ea5432bf0241bceab573bfae', class: "filters-bar__actions" }, index.h("ir-custom-button", { key: '1a6b65eae1ebe949e6ba2b77bd69162166ff6858', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, index.h("wa-icon", { key: 'f174a4c76ebacfe0cdd4d4059113b7523c46a128', name: "download", slot: "start" }), index.h("span", { key: 'a9520e405977f36e2c4926596f4605929e438748' }, "Export")), index.h("ir-custom-button", { key: '79470747669e0cf9b4f023e85a5f37cb987187f1', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    debounce.Debounce(300)
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ef95d8ec4064ea008c67b6d760ab786508987cc3' }, index.h("section", { key: '34530afb133d3f4c9362b38d26a616350fbb2ebd', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: 'ec7023e123ef944d57b3b836759e35a163d6cac0', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
                this.filters = e.detail;
            ...
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: '408900cd0bd1b2c8291fa8f9bde59f88aac1788c', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), index.h("ir-preview-screen-dialog", { key: 'b2a5ae7bd8072b6fd1411bc1b7d35fab1f017e5e', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: '6739caa225435392838d27098e10c2018ae4767f', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: 'f1c5e110cf24808c87b2824a26ba97b39935c2d5', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '2a4ac2e1b28e385cd906e9d6aae7219473ffde72', name: "download", label: "Download PDF" })))), this.printFilters &&
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '306844eba3590966ead43c3a98be21dba5dbf910' }, index.h("ir-interceptor", { key: 'f3b84ecdca062b1ac0d8b04f392b5ec62acf8dc0' }), index.h("ir-toast", { key: '8737ea370d42b48868200f6c99e06725d90d9a51' }), index.h("main", { key: '57bf36b2da4c93158b625c2f81d8ae93e3ef7c44', class: "ir-page__container" }, index.h("header", { key: 'c900b32107470cd2f3e4cf7b60d9e1a7fa99df81', class: "tax-page__header" }, index.h("slot", { key: '9efe748487c61f6d208226a1b10b3235b3e80167', name: "heading" }, index.h("div", { key: '769a6639816de66df7b1847926760d8bb165756c', class: "tax-page__heading" }, index.h("h3", { key: '934097caa0c0c54b152f9ecd3c9f509bc9a7ac8c', class: "page-title" }, this.label), this.description && (index.h("p", { key: 'c7106892fb78816002b7dd4b5d253ca48fcbc8ac', class: "page__description" }, this.description, index.h("slot", { key: '006d7cbb36b2a51dda25e1998517de2c1281640f', name: "page-description" }))))), index.h("slot", { key: '153f39574252a7ced66622e4c3b44c761a17aeaa', name: "page-header" })), index.h("slot", { key: '011878acf203b599cabc6616828271e5354f8674' }))));
    }
};
