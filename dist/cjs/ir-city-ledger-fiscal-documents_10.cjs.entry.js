...
const cityLedger_service = require('./city-ledger.service-9e025c5f.js');
...
const IrCityLedgerFiscalDocuments = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e6b0cfec13482c6f66a1220d76bdd2c3953b22bf' }, index.h("section", { key: 'f1e837a006a03cbc832fbf842743c04159d3468e', class: "fiscal-documents", "aria-label": "City ledger fiscal documents" }, index.h("ir-city-ledger-fiscal-documents-filters", { key: '43626d0befe34280634b57c475faedd8aef80ead', filters: this.filters, onFiltersChange: event => {
...
const IrCityLedgerFiscalDocumentsFilters = class {
    ...
    render() {
        return (index.h("form", { key: 'e9677566a89414fe075e87eae092cdbe3c520154', onSubmit: e => {
                e.preventDefault();
                this.applyFilters.emit(this.filters);
            } }, index.h("div", { key: 'ce7f2ef54037ef985acb4a28c56cd4f072b48f6e', class: "filters-bar" }, index.h("ir-validator", { key: '00825710e4e4d0999a501f56a9271f786d330d24', value: this.filters?.fromDate || this.filters?.toDate, schema: index$2.z.string().nonempty(), class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: '544376914142b889a3f55ebd71966fe0c9a55554', maxDate: today.format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.filters.fromDate, toDate: this.filters.toDate, onDatesChanged: e => this.updateFilters({ fromDate: e.detail.from, toDate: e.detail.to }) })), index.h("div", { key: '36df3b1c2c3e16dff1103c8e1915522f9f5822cf', class: "filters-bar__search-group" }, index.h("div", { key: '7754bc324336ea2029c440c8c44beadaeea7b1f2', class: "filters-bar__type-group" }, index.h("wa-select", { key: 'f6543244830010b27b2c47dacc679857bdd97534', class: "filters-bar__status-select", value: this.filters.type, defaultValue: this.filters.type, onchange: e => this.updateFilters({ type: e.target.value }), size: "small", placeholder: "Document Type" }, this.typeOptions.map(option => (index.h("wa-option", { value: option.value, key: option.value }, option.label)))), index.h("wa-switch", { key: '68dd2368ccf21ded0f713a3bd48cc8806ccc9256', class: "filters-bar__tax-switch", checked: this.filters.taxableOnly, onchange: e => this.updateFilters({ taxableOnly: e.target.checked }) }, "Taxes"), index.h("wa-switch", { key: 'd96ab81143d43b71a7279d60b35670e92ccebb63', class: "filters-bar__proforma-switch", checked: this.filters.proformaOnly, onchange: e => {
                const updated = { ...this.filters, proformaOnly: e.target.checked };
                this.filtersChange.emit(updated);
                this.applyFilters.emit(updated);
            } }, "Proforma")), index.h("ir-input", { key: '4b0e2b1c0b4fb6bc479a69ee78b2d8079f41a4c7', class: "filters-bar__search-input", placeholder: "Search by doc number", value: this.docNumber, "onText-change": e => {
                this.docNumber = e.detail;
                this.emitSearchDebounced(e.detail);
            }, withClear: true }, index.h("wa-icon", { key: '49b5d88598353728593b3d24cccb223c70a1d2f5', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: 'a73ae95db20d96ad508824c0cf9d3f52d7f14c89', variant: "neutral", appearance: "outlined", type: "submit" }, index.h("wa-icon", { key: '96e06ca323830473d483d9f2d5def4e967eed55b', name: "magnifying-glass" }))))));
    }
};
__decorate$1([
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3dd54f9ac615cbe915420e106ba2ad277e0362d3' }, index.h("ir-city-ledger-folio-filters", { key: '237f655cba54fb7f8ea281aa510b54575d2e932e', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
            ...
            } }), index.h("ir-dialog", { key: 'b86e8003cc55007f7f01333e252c55ffe5087632', label: "Delete Entry", open: !!this.deleteTarget, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!this.isDeleting)
                    this.deleteTarget = null;
            } }, index.h("p", { key: 'c886fd031c9b17a84a7a4b64d0e272807304bf79' }, "Are you sure you want to delete this entry? This action cannot be undone."), index.h("div", { key: '11d587ac8fae8429cba789c46b3a7e9df28ee38e', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '2f5e9c4f3406dd2eac4a64bf419d277f58b5cc80', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => (this.deleteTarget = null) }, "Cancel"), index.h("ir-custom-button", { key: '69c17c3f7066d5a2f954a2767e5aad1622887d53', size: "medium", variant: "danger", loading: this.isDeleting, onClickHandler: () => this.handleDelete() }, "Delete"))), index.h("ir-city-ledger-transaction-drawer", { key: '23a125ca5ca311a0c6497039c93b353f877c19a4', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h("form", { key: '6a9d745f0bccfd1fa29170bbae694d3d0547a291', onSubmit: e => {
                e.preventDefault();
                ...
                this.emitFilters();
            } })), index.h("div", { key: 'da7933076adfadd8e8bbc30ed3e4a5871a253cf9', class: "filters-bar__search-group" }, index.h("wa-select", { key: 'b60f582f279c34f497c33eb857b160b70860b662', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: '5ada9321aec92cf3212a7c9e017019595999b20d', class: "filters-bar__search-input", "onText-change": e => {
                ...
                status: this.statusFilter,
                search: '',
            }), value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: 'e0a7c88bcf796de4439f2fda2d9480228546b825', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '8fdb28e259da1ad280ad3a29204b5e5bff0e7b77', variant: "neutral", type: "submit", appearance: "outlined" }, index.h("wa-icon", { key: 'cde255ce6d32911c6f7e0139f4ba057d4cda0b63', name: "magnifying-glass" }))), index.h("div", { key: '799917a7f7ed08839d5e39b90600bd9c38bb3500', class: "filters-bar__actions" }, index.h("ir-custom-button", { key: 'facb8c46fdb025473cfcc2a2bd3318760e4dea60', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, index.h("wa-icon", { key: '4e7234dc31b584a51202a3353a13b05e5bb67fd2', name: "download", slot: "start" }), index.h("span", { key: 'ee693633dd4388465d7c1a4b4d36d768322730fc' }, "Export")), index.h("ir-custom-button", { key: 'ed8dfc647ffd6023a251b4197a63a93086028efe', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    debounce.Debounce(300)
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6e10cafa2911cce4e43d001ab87df06f582e17e0' }, index.h("section", { key: 'a9bf7946ff9cc08c66c4cd29bae30165539209c1', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: '2521fda24e7ff456e7599b9deb574a5b3ff9f1e6', initialFromDate: this.filters.fromDate, initialToDate: this.filters.toDate, onFiltersChange: e => {
                this.filters = e.detail;
            ...
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: '025d11b7c94fd97be4fba188faab3ad141556b60', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate, agentId: this.agentId })), index.h("ir-preview-screen-dialog", { key: 'a7a28d3141281fea29d430421f9e58363fbab406', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: 'd9356b214f74680fa88279fe848886f8b60a4383', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: '3b71dd6bfea4d3506b2c9120146ed1beeb12732e', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '9d940d950d2b1b77792fbc27ed21fa78a390000c', name: "download", label: "Download PDF" })))), this.printFilters &&
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '45d09d8caa5d3a9cf29b227e70aa95064d9614fc' }, index.h("ir-interceptor", { key: '233fd8e0658c0b9277763d0b95af3a3c08e64720' }), index.h("ir-toast", { key: 'b6f8160d35402621768a5b5c873c3d4dc69e8c55' }), index.h("main", { key: 'e3ba16f4aa60bdd48059cf1a42786b83184cb369', class: "ir-page__container" }, index.h("header", { key: '8fa87bdd352cfbbea6e20767e4d3823c6f2aa612', class: "tax-page__header" }, index.h("slot", { key: 'bc25de4ad193923273d9b159c62a0e5e252eefc6', name: "heading" }, index.h("div", { key: 'f6fa482ce9a4754f17df8471b93add88b0c0ecd0', class: "tax-page__heading" }, index.h("h3", { key: '41e42ebccb24f429efddbab5823387a0dc7bcd0b', class: "page-title" }, this.label), this.description && (index.h("p", { key: 'cb368e6437a928a3b3e9409c1a055bf43f4483c1', class: "page__description" }, this.description, index.h("slot", { key: '84b2926bc8d14c915897d85efc9b779e17d53cef', name: "page-description" }))))), index.h("slot", { key: '266c17bde0f439c0abd731bbe06d0bd4c514c363', name: "page-header" })), index.h("slot", { key: '86f7b8e7bff9fc3fba2b44ed49862859e845795c' }))));
    }
};
