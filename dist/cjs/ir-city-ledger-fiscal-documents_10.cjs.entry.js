...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1699c939172b542e53a74167e910b521a6809bd4' }, index.h("ir-city-ledger-folio-filters", { key: '4b2f7a04f247e8df6dcb5a3282c3cdd965153481', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
                ...
                this.isTransactionOpen = true;
            } }), index.h("ir-city-ledger-transaction-drawer", { key: 'cf74a271f3d5e1d4afc326bbcfc4bbb7aeb7ad73', open: this.isTransactionOpen, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, transaction: this.editingTransaction, drawerLabel: this.editingTransaction ? 'Edit Entry' : 'New Entry', onTransactionSaved: () => {
                this.fetchFolioData();
            }, onCloseDrawer: () => {
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bbc3344a08cf1e09d9d58889c971e58455aff7ee' }, index.h("div", { key: 'bc5c7522f3bd48e967cd08059a57aff5025c2b91', class: "filters-bar" }, index.h("div", { key: 'fdd26373a75378a08829ae6b1be0df4f72f33a25', class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: 'b72170e354b7843e3311c39d6b3bad1c8057692a', maxDate: moment.hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), index.h("div", { key: '08bc178a4ba31b48d23112285e5fee238723f18f', class: "filters-bar__search-group" }, index.h("wa-select", { key: '30698045496fa76b8554ed07e2088beef5b9f45e', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: 'c3e7f9982f41d2332afec3bc319946ec6efae1f5', class: "filters-bar__search-input", "onText-change": e => {
                this.searchQuery = e.detail;
                this.emitFiltersDebounced();
            }, value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: '1a632c0ac316ad6dc3d2738d840f1e5efb520763', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '10152861db5eaac957975c233b4e65c9331ac69f', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit({
                fromDate: this.dates.from?.format('YYYY-MM-DD'),
                toDate: this.dates.to?.format('YYYY-MM-DD'),
                status: this.statusFilter,
                search: this.searchQuery,
            }) }, index.h("wa-icon", { key: 'f4bc49b7a1b1e09d151ce20142d565f19a54f5ee', name: "magnifying-glass" }))), index.h("div", { key: '5ac639c58192696c106f9c9fd6206e87e22ecee1', class: "filters-bar__actions" }, index.h("ir-custom-button", { key: '3a5bdf28737a4ac0e2a5cd051ae71d52edb7fcda', loading: this.isExporting, appearance: "outlined", disabled: !this.dates.from && !this.dates.to, onClickHandler: () => this.exportFolio.emit() }, index.h("wa-icon", { key: '8d6e5cbb5e86cbc557d35e8fcd8ce04f5972443c', name: "download", slot: "start" }), index.h("span", { key: '00600e7862d9d14d4ec8f84d7352d80330ea1bad' }, "Export")), index.h("ir-custom-button", { key: '02656d59180755cb9d4c9c87acf725de856fb701', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate([
    debounce.Debounce(300)
        ...
        this.columnHelper.display({
            ...
            cell: info => {
                ...
                if (row._raw.IS_LOCKED)
                    return null;
                return (index.h("wa-button", { appearance: "plain", variant: "neutral", size: "small", onClick: () => this.editEntry.emit(row._raw) }, index.h("wa-icon", { name: "pencil", style: { fontSize: '0.875rem' } })));
            },
            enableSorting: false,
            enableGrouping: false,
        }),
...
const IrCityLedgerStatements = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ab3996582a3cc7b84fd2b76d21194d64f7e8dbb6' }, index.h("section", { key: 'e5d68fee2be8bc256f661bbabc0f45788b797b54', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: '9c554a1abdbc334aa45fc13493e3db6dd551c251', onFiltersChange: e => (this.filters = e.detail), onCreateStatement: e => {
                this.filters = e.detail;
                this.fetchStatement(e.detail);
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: '6209f8902ae6a0ce4712081cd42515031749aa0b', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate })), index.h("ir-preview-screen-dialog", { key: 'f12911c305251bb330df9cb67feb30b6f024eb25', hideDefaultAction: true, open: this.printFilters !== null, label: this.getPrintLabel(), onOpenChanged: e => {
                if (!e.detail) {
                    this.printFilters = null;
                    this.pdfUrl = null;
                }
            } }, index.h("div", { key: '09ca8aca5bf58256168a54147114f9e561825fbc', slot: "header-actions" }, this.pdfUrl && (index.h("ir-custom-button", { key: '9c0cc0cebb0ff3f724783d5d3da3989b1822cfb2', size: "medium", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleDownload() }, index.h("wa-icon", { key: '3e9f4cd84569065f5e51d222f6e996420b75f66e', name: "download", label: "Download PDF" })))), this.printFilters && (this.isFetchingPdf ? (index.h("div", { class: "preview-loading" }, index.h("ir-spinner", null))) : (index.h("div", { class: "preview-body" }, index.h("ir-pdf-viewer", { src: this.pdfUrl })))))));
    }
    static get watchers() { return {
        "agentId": ["handleAgentIdChange"],
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '78509332d78daba3e8ac1cc00be7a248416c5fb8' }, index.h("ir-interceptor", { key: '58fee75b4ed0035653a5f42378f0afd9e82de48c' }), index.h("ir-toast", { key: 'e42df8e4086b0167db82314756ad58699749322f' }), index.h("main", { key: 'bb9fa9808f1fa159355baac667cd29a08950616d', class: "ir-page__container" }, index.h("header", { key: '54ed2c712acb93b917e6796b21b877262ed86370', class: "tax-page__header" }, index.h("slot", { key: '90f2e79df1c841770e5aea61e844c49b8b6d5954', name: "heading" }, index.h("div", { key: '4d80056b47b92913eafad8597ed6538e5b64539c', class: "tax-page__heading" }, index.h("h3", { key: '099b0a67881b3f5a75f17eaa049dc36c66d1dfb7', class: "page-title" }, this.label), this.description && index.h("p", { key: '628c7b32d17bbea16de41525c7354e674500016e', class: "tax-page__subtitle" }, this.description))), index.h("slot", { key: 'ca8842e4913d8b2ef9af01e287ab6ac6a39f3620', name: "page-header" })), index.h("slot", { key: 'fc16b3ba6d56d18cd175ae6f7db81366c99b345c' }))));
    }
};
