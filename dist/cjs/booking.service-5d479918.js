...
class BookingService {
    ...
    async getBookingAvailability(props) {
        try {
            ...
            booking_service.booking_store.roomTypes = [...results];
            booking_service.booking_store.tax_statement = { message: data.My_Result.tax_statement };
            return results;
        }
        catch (error) {
            console.error(error);
...
//# sourceMappingURL=booking.service-5d479918.js.map