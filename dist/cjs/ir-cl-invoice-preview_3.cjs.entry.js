...
const IrClInvoicePreview = class {
    ...
    renderLineItems() {
        ...
        return (index.h("section", { class: "invoice-items" }, index.h("table", { class: "invoice-items__table" }, index.h("thead", null, index.h("tr", null, index.h("th", { class: "invoice-items__th" }, "Date"), index.h("th", { class: "invoice-items__th" }, "Description"), index.h("th", { class: "invoice-items__th invoice-items__th--num" }, "Net Price"), index.h("th", { class: "invoice-items__th invoice-items__th--num" }, "VAT"), index.h("th", { class: "invoice-items__th invoice-items__th--num" }, "VAT Amount"), index.h("th", { class: "invoice-items__th invoice-items__th--num" }, "City Tax"), index.h("th", { class: "invoice-items__th invoice-items__th--num" }, "City Tax Amount"), index.h("th", { class: "invoice-items__th invoice-items__th--num" }, "Total"))), index.h("tbody", null, this.transactions.length === 0 ? (index.h("tr", null, index.h("td", { class: "invoice-items__empty", colSpan: 7 }, "No transactions found for this document."))) : (
        ...
        //   </tr>
        // ))
        groupData(this.transactions).map(level1 => (index.h("tr", { key: level1.PR_ID, class: "invoice-items__row" }, level1.subRows.length > 1 && index.h("td", { colSpan: 8 }, level1.PR_ID)))))))));
    }
    renderTotals() {
        const t = this.totals;
