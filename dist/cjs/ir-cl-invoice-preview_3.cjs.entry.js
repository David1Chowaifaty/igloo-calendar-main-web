...
const IrClInvoicePreview = class {
    ...
    renderTxRow(tx, indent = 0) {
        ...
        return (index.h("tr", { key: String(tx.CL_TX_ID), class: cls }, index.h("td", { class: "invoice-items__td invoice-items__td--date" }, moment.hooks(tx.FROM_DATE, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("td", { class: "invoice-items__td invoice-items__td--desc-cell" }, index.h("span", { class: "invoice-items__td--desc" }, tx.DESCRIPTION)), index.h("td", { class: "invoice-items__td invoice-items__td--num" }, utils.formatAmount(this.currencySymbol, tx.NET_AMOUNT)), index.h("td", { class: "invoice-items__td invoice-items__td--pct invoice-items__td--num" }, tx.VAT_PERCENT, "%"), index.h("td", { class: "invoice-items__td invoice-items__td--num" }, utils.formatAmount(this.currencySymbol, tx.VAT_AMOUNT)), index.h("td", { class: "invoice-items__td invoice-items__td--pct invoice-items__td--num" }, tx.CITY_TAX_PERCENT > 0 ? tx.CITY_TAX_PERCENT + '%' : ''), index.h("td", { class: "invoice-items__td invoice-items__td--num" }, tx.CITY_TAX_PERCENT > 0 ? utils.formatAmount(this.currencySymbol, tx.CITY_TAX_AMOUNT) : ''), index.h("td", { class: "invoice-items__td invoice-items__td--num" }, utils.formatAmount(this.currencySymbol, tx.TOTAL_AMOUNT))));
    }
    buildDicts() {
    ...
    renderLineItems() {
        return (index.h("section", { class: "invoice-items" }, index.h("table", { class: "invoice-items__table" }, index.h("thead", null, index.h("tr", null, index.h("th", { class: "invoice-items__th invoice-items__th--nowrap" }, "Date"), index.h("th", { class: "invoice-items__th", style: { width: '100%' } }, "Description"), index.h("th", { class: "invoice-items__th invoice-items__th--num invoice-items__th--nowrap" }, "Net Price"), index.h("th", { class: "invoice-items__th invoice-items__th--nowrap" }, "VAT"), index.h("th", { class: "invoice-items__th invoice-items__th--num invoice-items__th--nowrap" }, "VAT Amount"), index.h("th", { class: "invoice-items__th invoice-items__th--nowrap" }, "City", index.h("br", null), " Tax"), index.h("th", { class: "invoice-items__th invoice-items__th--num invoice-items__th--nowrap" }, "City Tax", index.h("br", null), " Amount"), index.h("th", { class: "invoice-items__th invoice-items__th--num invoice-items__th--nowrap" }, "Total"))), index.h("tbody", null, this.transactions.length === 0 ? (index.h("tr", null, index.h("td", { class: "invoice-items__empty", colSpan: 8 }, "No transactions found for this document."))) : (groupData(this.transactions).map(item => this.renderTopLevelItem(item)))))));
    }
    renderTotals() {
        const t = this.totals;
...
//# sourceMappingURL=ir-cl-invoice-preview_3.cjs.entry.js.map