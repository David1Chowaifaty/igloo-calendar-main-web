...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '0423f42bc2a615832ec14a0fad034916265821db', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: 'ed13086516300c3563698074fca76fc83cf8e18c', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '9a132b3f993f9016ab25193ba0ff956a6dcef2d4' }), index.h("slot", { key: '0a9c337af762d2ec7abdbeeebf10dde035d5763b', name: "start", slot: "start" }), index.h("slot", { key: '666b93d5f4d9dee9a205d9ce91c575c23e92d579', name: "end", slot: "end" }))));
    }
};
