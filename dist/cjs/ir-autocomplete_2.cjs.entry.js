...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '88d06ba8d4e89ba8d11d879dd24f2c966c169873' }, index.h("wa-popup", { key: '2f4337389c32bff2b4b7011fba2d36c9981da26e', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: '455b05fc1bff9937643de66de94bbd913cf96769', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && (index.h("div", { key: '3245f1599e2f2822837b48324b21609550f48aac', slot: "start", class: "selected-tags", part: "tags" }, this.selectedOptions.map(option => (index.h("wa-tag", { key: this.getOptionValue(option), size: "s", "with-remove": true, "onwa-remove": (e) => {
                e.stopPropagation();
                this.removeOption(option);
            } }, this.getOptionLabel(option)))))), this.withExpandIcon && (index.h("div", { key: '2f89add92109336340e9c31773cf1b12cd9b24b1', slot: "end", class: `expand-icon${this.open ? ' expand-icon--open' : ''}`, onClick: this.handleExpandIconClick }, index.h("wa-icon", { key: '0d6cee13379617e630e0d162ec173c283580a42a', library: "system", variant: "solid", name: "chevron-down" }))), this.slotManager.hasSlot('label') && index.h("slot", { key: '50472644030c83ce9c73bc508b905b6edb12530e', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: 'efab52460c23369535254291d84fb4dd23b2606b', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: 'b3850d8da4b882a9cd6427e37238bd0d7c77a3f1', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: 'ed0dddd5bb43cbd99454e4a0871e9ef9f29045ae', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: 'd2e2038c08d203001838a89319b09dd71eed2fcf', name: "hint", slot: "hint" })), index.h("div", { key: 'c11b1e026f09308fee52e9a72c3372b34018d97e', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: '66784f250a680085e2fcfab5a06fa40b21337c61', onSlotchange: this.handleOptionsSlotChange })))));
    }
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '15d6665e587d5fb0c3f4e5365602c688b5b1c3ef', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: 'db955981b40623d1357e71e544f521c9cdbfcd7b', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '2a16db09d61b116fd443ab3da007bf26cb22605f' }), index.h("slot", { key: '45faae817eb94f66c6ce59ee329865baadf5c485', name: "start", slot: "start" }), index.h("slot", { key: '90a6410cc73d3fc6977e9d0061a61c41b8b633df', name: "end", slot: "end" }))));
    }
};
