...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'fa5505cec3848f2f3a801fee20911d4a0093c339', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: 'cbf0c9b263e0969d986b9d04ade5e07e531b7411', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: 'f962b1410094ca91d033dde4405acccf2bcf60e4' }), index.h("slot", { key: 'd32397ddd3f7e887ed1b78070ee918a5cddfd882', name: "start", slot: "start" }), index.h("slot", { key: '3c186bff9fb35a5073763ebaf1a3587686e2b57a', name: "end", slot: "end" }))));
    }
};
