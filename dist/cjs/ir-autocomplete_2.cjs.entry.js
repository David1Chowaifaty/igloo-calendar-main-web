...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '39c35e13b57d3a8d048131b52a80a09b7805b0fa' }, index.h("wa-popup", { key: 'c4804163b776622520418a05fe140687aa349079', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: '90df6ab15c854bbc958210a06e75ff9610fe4cd2', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && this.renderSelectedTags(), this.withExpandIcon && (index.h("div", { key: '76937c972337afb775715b844b8f5d461ffe7d31', slot: "end", class: `expand-icon${this.open ? ' expand-icon--open' : ''}`, "aria-hidden": "true", onClick: this.handleExpandIconClick }, index.h("wa-icon", { key: 'c5945cc6d49e4a0e2e75c691cf3d90ba307b8d2c', library: "system", variant: "solid", name: "chevron-down" }))), this.slotManager.hasSlot('label') && index.h("slot", { key: '565588e50bbd59dc486fba530e4284d85c63dc59', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: 'ae3caacb336e9a8774a108397494fc9b7afb9b54', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: 'b50903d923ac89591572f376579e0e3caf0c9308', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: '303439affa1b0341eddba08718a8a00a49713478', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '22fc84e5955d15461f1ecce370532f80b2f69a3f', name: "hint", slot: "hint" })), index.h("div", { key: '7036ec2525dc81d4467325c00d69aae3cd9cd0e5', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-label": this.label || this.placeholder, part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: '1463618cf725cb3ce45ba9ec7d274551ef09dd9d', onSlotchange: this.handleOptionsSlotChange })))));
    }
...
const IrAutocompleteOption = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ac6aaa2193b9fdb2fb4aee1af1ffa47d46c698c3', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '84d85411eeefe29768723e2a39339a237b7a4dbe', ref: el => (this.waOptionRef = el), value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '58bfe354eb7c39c312ae2f424cb4a986c7f6ecbb' }), index.h("slot", { key: '5593cfdf9673b76e1cbe83826de7ef1be6fe6dd8', name: "start", slot: "start" }), index.h("slot", { key: '5981e073def8eee2d42cee7478e7232dcbd83222', name: "end", slot: "end" }))));
    }
};
