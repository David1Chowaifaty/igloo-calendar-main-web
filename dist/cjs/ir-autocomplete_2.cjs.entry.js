...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5ba0348788deb41049d1a0f98b935c606bca1abf' }, index.h("wa-popup", { key: '8185ccc52c39259e7316f8a345cca497a487d137', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: '0e6f71c6d4721e60607605b4f4748cf1d0c8bed2', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && (index.h("div", { key: '7dd6428f9dd8572d5229cfc422063ffbd5954b56', slot: "start", class: "selected-tags", part: "tags" }, this.selectedOptions.map(option => (index.h("wa-tag", { key: this.getOptionValue(option), size: "s", "with-remove": true, "onwa-remove": (e) => {
                e.stopPropagation();
                this.removeOption(option);
            } }, this.getOptionLabel(option)))))), this.slotManager.hasSlot('label') && index.h("slot", { key: 'fa15db891cd9157efa1e5057bc45bf0627eda9c9', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '87c2ec6613ded52063d10dd71c978cecfe0ed3ed', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '67945f61ea9a184807c6bb77170e44bc5f2548d0', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: '7b2c19ce064342d03e0ef6c4e29b932faf90989b', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '1b78c9eaedb312ff22605e320ff69438b9d2b7bb', name: "hint", slot: "hint" })), index.h("div", { key: '092acfbe2931d2bbbe209453bb6c1198368072cf', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: '64c8b08d259be57b7a9e0cf750a1e10ce4f49168', onSlotchange: this.handleOptionsSlotChange })))));
    }
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '31cd8c3f6a8806be6b8fb6b7b0630373414d7574', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: 'fd76bf3e7d231dcd69539fdfe0f7e067f0262b9b', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: 'fc77050363fceb543a4c8e821ce3cc3eb52fb197' }), index.h("slot", { key: '3ec4b51e050c6f5f6c51bb370f02343b16f50c24', name: "start", slot: "start" }), index.h("slot", { key: 'e9f0f5ab96ba3632b0ad88b23cb1731942aedd13', name: "end", slot: "end" }))));
    }
};
