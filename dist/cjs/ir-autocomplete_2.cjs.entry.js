...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '777f18037832c4ffe61817177e98b6e908e6682b', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '2aecd0d247c76bf67de153807c3aa02c34a21707', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '051aade2e280a848fce3a0cae99a3dc52c3eb329' }), index.h("slot", { key: '84c93dd17ae22d247f681349a4b3f8967c03da3f', name: "start", slot: "start" }), index.h("slot", { key: '8b29befe46189baa6efbdf16e77f04400bf1050e', name: "end", slot: "end" }))));
    }
};
