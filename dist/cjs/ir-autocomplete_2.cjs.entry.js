...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b350152ebfba582a2dc8581a15833a5e8777199b', class: "m-0 p-0" }, index.h("span", { key: 'fd3963a706034ed7df18e6a926b51d27fc38a355', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (index.h("svg", { "data-toggle": "tooltip", "data-placement": "top", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", class: "tooltip-icon", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '8fe446e1016dc31b51ed19e26125fa4dd7a1c071', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'f05029ac549a2cbff4b8b37121e230547d340933', class: "tooltip-arrow" }), index.h("div", { key: '9829bfba7d40ad55e0da1fd766bed6f6a94182db', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: 'c3ef3dd1b0f64607a417956791f87e4f51305a2d', innerHTML: this.message }))))));
    }
};
