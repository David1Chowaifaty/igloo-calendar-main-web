...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd73c33e01ad86230b21e7f6e793ec2eb184218b0' }, index.h("wa-popup", { key: 'a52aafa20a652b08d083619afcc09aab4dc0d552', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: '6da1398e86fe80f8010929b0a5d352463826aa02', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && this.renderSelectedTags(), this.withExpandIcon && (index.h("div", { key: '5a0d18058253e34d0ec76bb5aa0c4e33831bf049', slot: "end", class: `expand-icon${this.open ? ' expand-icon--open' : ''}`, "aria-hidden": "true", onClick: this.handleExpandIconClick }, index.h("wa-icon", { key: 'c7fc82f35d5134c5bc0edd70702931410f6daf2c', library: "system", variant: "solid", name: "chevron-down" }))), this.slotManager.hasSlot('label') && index.h("slot", { key: 'aa9c07b87e11eebf038b495fd8481a698d9f6ea3', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '222a8347028adf25924d48d0156a882a89ef5223', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '186d9f640c2fe16cc1c1e7ba0e20b77fe56df468', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: 'bf99dfe9886d9903f82b3dc38c6d7d6240127098', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: 'aee588ee30cbdff9fa029582c840ddc9812c56b0', name: "hint", slot: "hint" })), index.h("div", { key: '2fd52471ef780b98f6e5358d1a238edf030c4104', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-label": this.label || this.placeholder, part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: '2e2fd367c0068c2c4dccf1f71dddf78c359d9615', onSlotchange: this.handleOptionsSlotChange })))));
    }
...
const IrAutocompleteOption = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f5658878194063ce2cd141fe5e90ab57f4fa66de', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '6dfa37d84c71bc24249e8c0ac1167ee932ed1f63', ref: el => (this.waOptionRef = el), value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '8b0606848bb9ffb8609348f067e9867615074cad' }), index.h("slot", { key: 'dd5d9d105d610d2bfbee3ace4518c571e6b2db8d', name: "start", slot: "start" }), index.h("slot", { key: '5cf28224247cb358a93a5712cf4902a8451d5a6c', name: "end", slot: "end" }))));
    }
};
