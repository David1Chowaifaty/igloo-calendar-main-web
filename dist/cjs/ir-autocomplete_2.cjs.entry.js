...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '08a41d4a0cd3c49b5e857763592c5b7b590a6e4c' }, index.h("wa-popup", { key: '463f9429e5050af99ab09802e2f747e20e8944c0', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: '6bc7339e9d2bda041e4e032171f61281b5d769a4', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && this.renderSelectedTags(), this.withExpandIcon && (index.h("div", { key: '19de5a8252c9f87bc22fa87c6dc49c0a3fd2b6c9', slot: "end", class: `expand-icon${this.open ? ' expand-icon--open' : ''}`, "aria-hidden": "true", onClick: this.handleExpandIconClick }, index.h("wa-icon", { key: '44623577e40435d203e0b42b5daf6a2b9a2fa16f', library: "system", variant: "solid", name: "chevron-down" }))), this.slotManager.hasSlot('label') && index.h("slot", { key: 'c6416de5ae65b08864bb76e26e1394530ed02450', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: 'd010c8bc982c4bfcb32a208153f38edbaef87d49', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '6dc90a3776afb0ca1e3cd8863d412b8f33011ee9', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: '60c7dee7952e3cb8c1c9bdb99e361302aa55b571', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: 'f3866acf93324235b3353af55f9fdb1a9e61200e', name: "hint", slot: "hint" })), index.h("div", { key: 'c6abb537cd19c96a916467125d91cafa1b965d26', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-label": this.label || this.placeholder, part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: '86c6a0dfe194835328bcbbb545262a506a36707e', onSlotchange: this.handleOptionsSlotChange })))));
    }
...
const IrAutocompleteOption = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f7544574d3cd4b309f8ef3bb1bd939dd9531d49d', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '008f146e70dec7fc043c4f8a82b2d6501dfe4fd6', ref: el => (this.waOptionRef = el), value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '2681c46c5d33a812e485f48fbbf24dff9d6df90a' }), index.h("slot", { key: 'ef1bab2409b9900eed56a6f71829a1e36182fb20', name: "start", slot: "start" }), index.h("slot", { key: '25a8a616045affec2eb82009ff06c07bb2aa57fd', name: "end", slot: "end" }))));
    }
};
