...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fcc0b3ff895edaf589d138c9fa6c4e19c3d7e00d' }, index.h("wa-popup", { key: 'dec06316666e924d87fc6e48f28a39e5e8734860', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: '10c91197cdbfdde10c68cda2ae8d8c0851f67e59', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && index.h("slot", { key: 'f4e23d3d90b65793d664e5ba6ca76040a15e98ff', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '1ec9eae46fbaa4b8e64ecec65c09df90a3ada110', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '538084f2cd46ecdc084cd1b89c7d4ed5d7fbace2', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: 'fd3fa2d898e89cd343a989f69cf2fbb7fd629f6e', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '1587ce0a817406ea3160490ab8521341e3d4ffeb', name: "hint", slot: "hint" })), index.h("div", { key: '503062e23ed067f3b27cda30d3142a58d6f16833', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: '81cfa653d5a63a67532d80c87eeabc6c4f39bea0', onSlotchange: this.handleOptionsSlotChange })))));
    }
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '3d991a983257278dce268bc4801468ce2dc7fc7b', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '5bbe2ec55b6b34fef8a74416a10a7e9e6eaff422', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '2a79d45756a261003122be5ab4796a1f5abff0bf' }), index.h("slot", { key: '267a7967a415e2e906b6b7cba64d40aa3a0db0e8', name: "start", slot: "start" }), index.h("slot", { key: '42fcd5d9bfcd3d59d9baf51e873022feb7786192', name: "end", slot: "end" }))));
    }
};
