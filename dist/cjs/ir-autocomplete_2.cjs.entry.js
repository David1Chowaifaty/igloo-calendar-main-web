...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'e50da0cca4d73271ca17ffc5535443aa1e0885f5', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '72c24cfb7427d0c4696a065230d7514d25b4eb2d', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: 'dd30c2e6b06e0aa2df39ed49a806464ca38d818d' }), index.h("slot", { key: '74f934142fa04e66350917d6b9dc639cb2698f02', name: "start", slot: "start" }), index.h("slot", { key: '56e0b141068ee11fcebaf8e1e503f4e86e76e975', name: "end", slot: "end" }))));
    }
};
