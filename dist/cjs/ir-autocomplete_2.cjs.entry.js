...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '2b7f6e4fb8ace9c3c260cec6ecf249929393a3d0', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '8d9bba4630f3618c4a816471e59fc2a54e918eaf', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '8d5f19a70b3e21208dc0455298508a35f7012fd0' }), index.h("slot", { key: 'f1dc44b307a414dce8f48468fc26d751f98e027a', name: "start", slot: "start" }), index.h("slot", { key: '87626d4cddfba09d67daff1c2cfb8e89e0f65f1a', name: "end", slot: "end" }))));
    }
};
