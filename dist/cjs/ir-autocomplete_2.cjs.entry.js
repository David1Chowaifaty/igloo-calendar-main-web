...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'a367bb796c3681bac392a814616951519d98d29c', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: 'f15dc6fc746a4fd23a10137443f0a32b4566cf67', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: 'eb157472f3f14285f89d6ec6f94a66bcd45a1f3d' }), index.h("slot", { key: 'dfe80d6612a853a4f93616b803a06082718ab16b', name: "start", slot: "start" }), index.h("slot", { key: 'e687fe58bedfcfdb4ecbe4b99df6cd0be69b2c5e', name: "end", slot: "end" }))));
    }
};
