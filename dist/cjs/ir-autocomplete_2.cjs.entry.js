...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'be05769af78824ef1952ca4861d45be0a57e43cd', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: 'a38d587d8cfe97f82f191c7da648dd0146a3438c', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '86e7d85e208d4da6c3c7d60bf98add55c6a60ea6' }), index.h("slot", { key: 'e75e0609a2a1e4301dd4bc234dafedfc34019f8b', name: "start", slot: "start" }), index.h("slot", { key: '208c3dc21d62ce31ebe29dfcdfcd8737e4239c7b', name: "end", slot: "end" }))));
    }
};
