...
var slot = require('./slot-DNV1zOGP.js');
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'afb85b7ede046032074b0a0458a3d06b1024daeb', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '9950fe317c9cac7cf0f38adc94494a691f7a2113', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '040e2dd00126ee7f47fd9f274ce2902a6c557f6b' }), index.h("slot", { key: '9b5b006d8557b87caf95bfb69903cc1e1ec0f506', name: "start", slot: "start" }), index.h("slot", { key: '45ae12ae93951b6364bbda1f297f50724910ffe1', name: "end", slot: "end" }))));
    }
};
