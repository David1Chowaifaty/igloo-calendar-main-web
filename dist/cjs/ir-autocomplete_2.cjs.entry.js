...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '1249bc0763cb7891c83c1433c75676bd8aa9ce94', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '1930bd06b93bd10dc121060ea2916b40b41170cd', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: 'fe35582c9551f32ab03c71c15d1cf4c00cb2278b' }), index.h("slot", { key: '1c86c194c7fa8c1b1424d585549cdf15733b60a0', name: "start", slot: "start" }), index.h("slot", { key: '60c764afc16d03c22a64fdec8365d5b8e1a1f636', name: "end", slot: "end" }))));
    }
};
