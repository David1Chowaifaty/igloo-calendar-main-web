...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1d78c619f9cf5d3f62376ece16f5e449c5d36327' }, index.h("wa-popup", { key: '039e14f8fd444513636ac638e73711e5c13920e3', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: '76e5c931265cd67efd6e1f04649af8e35d922f45', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && index.h("slot", { key: '9ace6031b8578040594479024ccc925fc50497c9', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '172bd19173f3b2ed61bba6a60d7aa9c1212a9444', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '6aa9806307d4488a72f5ea14d01119112fcbbadb', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: '663dcdb7628bd8e62824742f501923649f68ef7a', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '538ad5c59958b8ca288d02ff3e2c00cc319d79a3', name: "hint", slot: "hint" })), index.h("div", { key: 'a84e969de9770f9c036ffebb2a78202cdc0e2182', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: '822712c67e18604d7dbf93954e5ed2a6fbac3404', onSlotchange: this.handleOptionsSlotChange })))));
    }
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'bacc038c258410220c571654bba7d67affa05bd9', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '7ddc4256e59dd3e3689ac84823c24c6575b754bd', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: 'd6a2e10b8d8a783b30e6622d39477e6f756b54f0' }), index.h("slot", { key: '506f4876b6634e959478f35cd6505872c791a112', name: "start", slot: "start" }), index.h("slot", { key: '3e6d880ac7e50b87d16637fedde5c9baa2010767', name: "end", slot: "end" }))));
    }
};
