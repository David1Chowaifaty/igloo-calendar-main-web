...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: '01a1d5f682cff823e395dd3c29a40f0b18860093', class: "ir-print-room" }, index.h("header", { key: 'd353b17d4d9d081dcffabfdb390550ef9dc01696', class: "ir-print-room__header" }, index.h("p", { key: 'bc05b554d156cbaf43306e1f771e30dced70fe0d', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: '843e19f0786b0a9731aba6f3b38c65a225f6f9ad', class: "ir-print-room__unit" }, t.t('Lcz_UnitLabel', { fallback: '(unit %1)', params: [room.unit.name] })), index.h("p", { key: '04f9a252048542ecc9543cd9b5a9cbc563edde05', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: 'b3a6595b480f6446c66c39eb63b17b8bdb66e3ca', class: "ir-print-room__body" }, index.h("div", { key: '6f5128bc8e34348cea9bc3d928f3dd14a5a777ea', class: "ir-print-room__details" }, index.h("div", { key: 'fee70b686fa8900123f8c5b6154e75d6e0a37a2e', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: '37fb1431b7232177500134896247fc4ee7320381', class: "ir-print-room__label--capitalize", label: `${t.t('Lcz_GuestName', { fallback: 'Guest name' })}:`, content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: '24d3ad1877ffa1232917fcb3da03a8e6da94c9da', class: "ir-print-room__label--lowercase", "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '4ab9beb44de7fffddc7f88540e010affa2fa4f47', class: "ir-print-room__row" }, index.h("div", { key: 'e437a3f85b13edd7e1a4710b3bca98e2a85476e0', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: 'f414038bb57bbd9498629957e2bdfd1fe0d2089c', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && (index.h("p", { key: '4ed2a3c2b4f15373b9293e4706a9272eb19f46ee', class: "ir-print-room__departure-time" }, "(", t.t('Lcz_ExpectedDepartureTimeDialogTitle', { fallback: 'Expected Departure Time' }), ": ", room.departure_time.description, ")"))), index.h("ir-printing-label", { key: 'f3029c0aebed9500d1020b377a8bdf457a4920e5', label: t.t('Lcz_SmokingOptionsLabel', { fallback: 'Smoking options:' }), display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: 'b3dc220c113c93dd7e91e89faec8d7e07cc66b54', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: '1e080c9712e4ee97b6f94737d92961a3d7a85f95', label: t.t('Lcz_CancellationLabel', { fallback: 'Cancellation:' }), display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: 'df725abdb01e0ca9a9099641f62d9a576044fb6d', label: t.t('Lcz_GuaranteeLabel', { fallback: 'Guarantee:' }), display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: 'a4993f734fa87783e277696210f98d80f360e5b0', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: 'a122398320d372ffd474db614900641eac936390', label: `${t.t('Lcz_Total', { fallback: 'Total' })}:`, content: number.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: '7b549bcb2a715c6793f2d2acfdaaa9a6deccdbe2', label: t.t('Lcz_GrandTotalLabel', { fallback: 'Grand total:' }), content: number.formatAmount(currency, room?.gross_total) }), booking?.is_direct && (index.h("ir-printing-label", { key: '460b195158a7a4ae21ee939052a185cee986a7f2', label: t.t('Lcz_DueUponBookingLabel', { fallback: 'Due upon booking:' }), content: number.formatAmount(currency, Number(room?.gross_guarantee)) })))), index.h("div", { key: 'f1468d2b8c1bf8f6cf21083d4e1543a8d224c52f', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: '54a11af4cc09204a6b998c4af60d85158c5c58a0', class: "ir-print-extra-services" }, index.h("h3", { key: 'd2a20bdc817a92d143f0e230acf782f27a8a6474', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: '36128ff4fd9d556ca16e755012793752d186ab5a', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
