...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: 'f318eba1b06ea774fba56fdbc90d325b3b78236e', class: "ir-print-room" }, index.h("header", { key: '5dbdc19448bbf2709cd50c4272802f1df697d8a6', class: "ir-print-room__header" }, index.h("p", { key: 'a0ece8d45f92cb4f341bc6cd417a4f7349168a6d', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: '2367c12f3e825a7c46389781fd10a1d2389f002b', class: "ir-print-room__unit" }, t.t('Lcz_UnitLabel', { fallback: '(unit %1)', params: [room.unit.name] })), index.h("p", { key: '61138e6c082ce22d3dc6f9a5ab2d8fffd7e406d4', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: '023bd6fcaba822091a49e3c913820ccd6c98e0f2', class: "ir-print-room__body" }, index.h("div", { key: 'a6cc09dd8fc947f7e1b74c304c18b337213f0922', class: "ir-print-room__details" }, index.h("div", { key: '0d4f5a20912cd9c59b571cb48a3d8382c806fa0c', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: 'f7378d073c586dac2921a1cd0103a154d2d5abce', class: "ir-print-room__label--capitalize", label: `${t.t('Lcz_GuestName', { fallback: 'Guest name' })}:`, content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: '142356b751190d45916043a0fe3e2d38d007e20b', class: "ir-print-room__label--lowercase", "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '44463ef5b1696c0de9bfc090986c5f49b21bb009', class: "ir-print-room__row" }, index.h("div", { key: '0dd6f3e679acd450bcad044b47b64c1de60b4146', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: 'e20254a3f82c319e6e7d0becfb28628a52a63796', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && (index.h("p", { key: '6417c0cf9ece6e2ad264184ac64d29775be74683', class: "ir-print-room__departure-time" }, "(", t.t('Lcz_ExpectedDepartureTimeDialogTitle', { fallback: 'Expected Departure Time' }), ": ", room.departure_time.description, ")"))), index.h("ir-printing-label", { key: 'a7d445574b3850117197b591ee5f5fdc4300035f', label: t.t('Lcz_SmokingOptionsLabel', { fallback: 'Smoking options:' }), display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: '9486e9be34af4f7f718b38dec69eb5287a660234', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: '0016f8ae572dfaaf83c87957e4c98bef218f2467', label: t.t('Lcz_CancellationLabel', { fallback: 'Cancellation:' }), display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: '30f124874fb834819857f3d648f6b3aadea628a7', label: t.t('Lcz_GuaranteeLabel', { fallback: 'Guarantee:' }), display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: '1a25e65b36e62e73e91bc4b2e0df2c9b6dc271a7', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: 'a0585136cbd99c2f3036ec8df0e8402d9f9106d0', label: `${t.t('Lcz_Total', { fallback: 'Total' })}:`, content: number.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: 'ba4a750d7db26871dc021abbbbfab9833f9291cf', label: t.t('Lcz_GrandTotalLabel', { fallback: 'Grand total:' }), content: number.formatAmount(currency, room?.gross_total) }), booking?.is_direct && (index.h("ir-printing-label", { key: '188c3ae343460664a01f9bacff729fb04423c9b2', label: t.t('Lcz_DueUponBookingLabel', { fallback: 'Due upon booking:' }), content: number.formatAmount(currency, Number(room?.gross_guarantee)) })))), index.h("div", { key: '9a1ce5c028c77c1a4b930c7e3cc387fc99269b77', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: 'b70c112afede7ef3be308ffe94e52522a6872fb4', class: "ir-print-extra-services" }, index.h("h3", { key: '9b0b009aa22f7c491f9014ed0c7d262e68496ae4', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: '93bbfc6458f74890de8eca7fa6f036a10a170950', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
