...
const IrAccordion = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '554c1f6a1e01eb650dc55cc21b673c5d0dd80a87' }, index.h("div", { key: 'a09b8ef46050bf82eab4bf5540adadb27ff216f0', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, index.h("button", { key: '9b5c579a5a1e8467d571e852fe0878435b57386a', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && index.h("ir-icons", { key: '5241ab159e2c868920764065264c019729454818', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), index.h("div", { key: '602f7cefdda4396578b373eb980a85e2d05e63dd', class: "ir-accordion__trigger-content" }, index.h("slot", { key: 'c8b19e439e5e73f176fc35e63251bf466be8b770', name: "trigger" }))), index.h("div", { key: '7ac9ac585adddad0e7cff1cb9889985e23e3da0e', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, index.h("div", { key: '2220e3ffc281110bae4beb466077049af9ca7973', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, index.h("slot", { key: '31d5481c89073502a21bf0bb44e55b0b00a4ea48' }))))));
    }
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '99c48e69fcde6d6c3e21ad12609eec0ca991251f' }, index.h("ir-accordion", { key: '7e1f3d4160be0f3981a8e04acbf1735d6bf0212d', class: "ir-revenue-row__accordion" }, index.h("div", { key: '61bf001065e2d112b7cc472b12db508ee8ab3371', slot: "trigger", class: "ir-revenue-row__title" }, index.h("div", { key: 'd7f648de5aed63e75c7b3ef336aea72204da9b38', class: "ir-revenue-row__header-left" }, index.h("p", { key: '41a0518f728fb9a64e10391a66bcbdf114c5453c', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("span", { key: '0eb11f845998a8768b08c87153f26107647947f2', class: "ir-revenue-row__badge", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: 'cda9daf94034585aa849ca611eabbbbcffc75ee2', class: "ir-revenue-row__total" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '7ab2aa2c5bb03b12568bd35658dfd0a69db0e4f0', class: "ir-revenue-row__details", id: this.contentId }, index.h("div", { key: '43706ad899a686492db6ba5051470864de716e40', class: "ir-revenue-row__details-inner" }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
    get host() { return index.getElement(this); }
};
