...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f94ef78b54b5f70a7c545bd9293ae78a0fa6c199', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'deed37ac25035295001bb8e37b92c80c81cfee15', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '7f0dcf8bbd285237f3bd95636da9ff89e15c7b61', class: "staff-task__card" }, index.h("div", { key: 'dec19190f0c1ed73763eaf1c89a5798264cc77f5', class: "unit-label" }, index.h("span", { key: '63ffcad2184de9e8fda247a57a57c2797b9cd3ee', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'de00a20210cf33ac2ba0fa8a8344ebdc8a6ce1cf', class: "task-content" }, !this.future && (index.h("div", { key: '064e0c59c881882b09b3ebacee49dfb8735f866d', class: "task-status" }, index.h("span", { key: 'de9375c4c5406afc686ab8bf546a5e5cc831f300', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '020104737128dd56ff399f8198e922fdce86b448', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '698601191a2d7bcf2c94861a0c017a94445ba4fa', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '78d127d64b36c077a176efd76d975fcba41b117f', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'd1caa348f98c4b4f08638637321b94206ea6d2d8', class: "task-action" }, index.h("wa-icon", { key: 'b10d527b0961edc7de25bb8a52841f980f874088', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '44ac2e007443db8a5600104d5a17773a0dab3b3b', class: "tasks-header" }, index.h("div", { key: '5dd9065f1bc43988cc6243708821a635279eb035', class: "tasks-header__inner" }, index.h("div", { key: '7504b1a1c3c687e799f61cb142bdf37aa0732d02', class: "tasks-header__brand" }, index.h("img", { key: '01adff4c7c57fc61d5e020cd80a4a9c1412256d4', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'd46eb4cc1ea327ccf8cbb6f04b7f10216f2d18b5', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '6a67c7b8ce383ec99dae11b2bf1fd1249b2b6e75', class: "tasks-header__actions" }, index.h("wa-select", { key: '2f7978498ab6c5d9078b3fb879b48343a2add39f', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '6e2067332ce30cdd90a81318837d33b12ba02de3', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: 'b3796f6ce23895c6a0634e0fe71030e117705311', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
