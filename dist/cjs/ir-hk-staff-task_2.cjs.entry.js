...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '82f0350bfd1634d765d93cacf70f5bfc59ac55ea', class: { 'staff-task--future': this.future } }, index.h("button", { key: '41535732a9351a209687c8fd2acf149127dbf077', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '8f2eac862a7cae58e83abe9c5e396812797658ed', class: "staff-task__card" }, index.h("div", { key: 'ca7e03825362dcb2e909e033e10b7a34df965d15', class: "unit-label" }, index.h("span", { key: 'e3749296e538be438307ad85813f2fcbf39d30d0', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '76bf268173ef0e326f66e7aecad5e9c07b9cdd1f', class: "task-content" }, !this.future && (index.h("div", { key: 'd496aab9528e5b839d3f36bab893ba45aba32040', class: "task-status" }, index.h("span", { key: '73ae991c62e8e66319ed6df361c3e72cc98c7aaa', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '6e8b97d1527e46c23aec06c4519dca2a2088634c', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'eee637b478d8919f624dc1da47f29a19a63dc7a9', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '955ef6e820f4f2af45d0b9e0bf7c287edfb9b2c1', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '44846effab0a91a421096fca7f50bba251aedde3', class: "task-action" }, index.h("wa-icon", { key: '461d02d5a2aed3c7d3490f8f18a72b30111afd4f', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '67ffc9921fb7baf97c611661b29aa53cf6d9319b', class: "tasks-header" }, index.h("div", { key: 'ac87e14dc32104a8c760368cd449ae9c3807d33d', class: "tasks-header__inner" }, index.h("div", { key: '68629bf96cc5e1cee39bf134ae636345624bf773', class: "tasks-header__brand" }, index.h("img", { key: '58a522ca0c201bd46a6040ce271a7bc42935e4d7', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'eafdc96ed3e3b14832d0c962537e9271b2493800', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '89627af151ca436ace43ec163dea10b8d07b5f95', class: "tasks-header__actions" }, index.h("wa-select", { key: '38c3ec86fbb933ed86d77efaaf8e127a29a7456a', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'e2246215818d98f38499eac045ed743c1373cc77', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: 'a1ddfff3ca9a9aa48c7f23788bb75688a15fec90', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
