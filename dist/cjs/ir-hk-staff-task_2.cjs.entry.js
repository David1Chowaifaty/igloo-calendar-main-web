...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1448f41cc032639c6954f5fe6f12ea2a741f95da', class: { 'staff-task--future': this.future } }, index.h("button", { key: '2c47133ed448621bdd412011873f000883d70e4f', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'fa9463428685224c41b36a10c665276e91a3bfcf', class: "staff-task__card" }, index.h("div", { key: '290e771cd177e3bb29d0c019d9a2f063ff5cec68', class: "unit-label" }, index.h("span", { key: 'dea99f98c051881e3aff7c6d1dfec7db60a20b6e', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '3d87813963301f7aa4ef4557b606b35cd113970f', class: "task-content" }, !this.future && (index.h("div", { key: 'f16dc475df771d9194df98f99ece8c6dc175c5d0', class: "task-status" }, index.h("span", { key: 'd3dce31ab4edb54db1a81e8ff9497486afd9d631', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '4fc3f2d314c411be7f913bb52040b3ed5ece7926', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'a58369e812fa53bbc52ec1cd4f8b6bb384c27866', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '15ae09b74499b17f48ec25ff68db64940b0b60fa', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '3e214b95aa7746f9072eb6fada4daae4879b7c2b', class: "task-action" }, index.h("wa-icon", { key: '6b542e4676ad1ae7a9bcc0b9be8b6de3b20b0aaa', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '12eee4ec538eff699587b422b38057b75407e7e2', class: "tasks-header" }, index.h("div", { key: 'cfa2291a3aa0d238ffece3516b86bc0565c54d05', class: "tasks-header__inner" }, index.h("div", { key: '4fbfc18f79c24f581cdbbb02c95c0dbb702ef557', class: "tasks-header__brand" }, index.h("img", { key: 'fadf0a0eb324b0372b50ff2d4b1ce5fa4302f646', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'dd4e58124e65c7d189568f9767f6f5d220db6c78', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '81d0ccef1b09ff72a2f814c233123022603278a6', class: "tasks-header__actions" }, index.h("wa-select", { key: 'ca395480da3b2dbc51f65b0f68ef8ae865595ff5', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '6b1b25f2ce591e2f32aa21bf8f825a3c4e812945', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: 'cd0d681205cdf538051c84b0ffb73b60e07bb171', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
