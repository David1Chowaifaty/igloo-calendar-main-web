...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5dc9c8eb99fa53a588a97fee43289d92fd31f78f', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'c82b5d4df174b07487ad5e9bf89ec36257df68ad', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'dc34cf66a75afe1560688096dbffeeda11ad2ad9', class: "staff-task__card" }, index.h("div", { key: 'd12f92cf7a3cdc724c1b8d7b5961cd29b007417e', class: "unit-label" }, index.h("span", { key: 'dc2ce47cd59e2a4cf8c9c4d1f8ed1ec4dda97717', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'a7a072b11c70c9ca7015189fdd173012b22887c2', class: "task-content" }, !this.future && (index.h("div", { key: 'a8680d5eab74bd93f47a88c07f195e9a021ddee0', class: "task-status" }, index.h("span", { key: 'cb32927b58f208510d617fc871bd9844565e9721', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '1df71f961f63c077f0638b22636c9753d6c28bae', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'debbd7505423c48517641de3eaa8bdeb77c91175', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'd4c831ac867459dc8024da9cfc436d29217dde5f', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'b19a8f515426afcdaea7b1b186deeba421d9cd71', class: "task-action" }, index.h("wa-icon", { key: '1ef0d2e4ead7d2c609309abfd868fa5f75b612d9', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '74b1f8ecc158f498409f9454fec20081a861c223', class: "tasks-header" }, index.h("div", { key: 'b48be8117fe5d97e245262eb2bbec53e7cbe2417', class: "tasks-header__inner" }, index.h("div", { key: 'e0c435503b6bdabe7a2050b1364df0eb8103a49a', class: "tasks-header__brand" }, index.h("img", { key: 'c443290a1322d3a4eff8c8f8571423d467a64785', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'fc7173384b5cd21a66fb8034e5060c22151351d5', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '70153850cad77feb8857729bc7a88f6598e112f4', class: "tasks-header__actions" }, index.h("wa-select", { key: '108c6543c2e678e033e0ac307bd52d689e500c04', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '888c43228acfe862fe883cbca21a3360b8ef61b9', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '30b21ce2e108938bc4fdf9cfda83ca58f375fd0d', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
