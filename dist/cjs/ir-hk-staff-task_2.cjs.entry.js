...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a5719e1d8505a3a8a1e91e7621d6ece5a28a1023', class: { 'staff-task--future': this.future } }, index.h("button", { key: '1c82832be26f59d22a306de19c716a8f4d840291', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '1bf8ce5a0e884f8f6f2dedf1e910cc4fce49cf6b', class: "staff-task__card" }, index.h("div", { key: '71694419a123751c516435ab231c1017c455829b', class: "unit-label" }, index.h("span", { key: '9d611fd9e1af81c814cab406a5f7f8bf2be8ad09', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '73bcf3de0e73cc0482d1a5b80a25db85c7a26a4c', class: "task-content" }, !this.future && (index.h("div", { key: '1d60162967b2862a5cd6a2ef48508df30ba3a207', class: "task-status" }, index.h("span", { key: 'b653b7ba73825426810d0410ef465c0d9c6f6b0d', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'f65c868517a545f3236a835153b24a48dbc78049', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'e2bcf4e19d9d2edaf47003c477192ccb35bd81a6', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '3a48e614f0e2ed1326c304a5bb083c0f6b64ef83', class: "task-guests", style: { paddingInlineStart: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '02e274d29f87584de41ed64098bbf5ef2cf1d5cc', class: "task-action" }, index.h("wa-icon", { key: 'b997a52e1af2080956511bc5615540113587baa9', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '7b56ffc184cbdb723fe69f287f1de210b7268117', class: "tasks-header" }, index.h("div", { key: '686d0824f756d3a542d3d9f7a36555eff60cb081', class: "tasks-header__inner" }, index.h("div", { key: '31a080203a64f5093d2349f739ab8d9d4780c334', class: "tasks-header__brand" }, index.h("img", { key: 'e1ecd7c2cd90acb0a75d91a29069645115a8f8d6', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'e87ca8fafd3e80997f7278ada312358ac929d742', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '5a78ea199557aea5ecc2af3fd7a7f8de6fa0fa95', class: "tasks-header__actions" }, index.h("wa-select", { key: '53643e32175af4f265254afdc04ccb90948752b7', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'c65235d5c3aca5816dccad7268c08ab8eec56edb', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '64d2b61f90996fc1d4ab62aad0c42f4433bf7bba', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
