...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9a0e6cee08d256d9238db1fe08a1469aeacb69ab', class: { 'staff-task--future': this.future } }, index.h("button", { key: '4fe17f728c6a3e8477aebaad4b0f10b70d77b681', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '0e09e2f4ad90036a52f8cfb513b0e966e0587d2d', class: "staff-task__card" }, index.h("div", { key: 'a5367cdb8dea83cba9baf96937991c09f1703a16', class: "unit-label" }, index.h("span", { key: '39959ed102fd5e16667dbe0743b1e0d5356eaef4', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'c9026497005538a0de2ab2175f16eb865176a49a', class: "task-content" }, !this.future && (index.h("div", { key: '3bf9efdb74f847aff872e4c397157ebb6d8e7b5b', class: "task-status" }, index.h("span", { key: '5047e1fcb9bd88864438db38e8d200f51d595db8', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'fb9fa209b272bbe01448c079c904ef2f8826f2ff', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '0c580ce95c6eaa399032883fab975b212452d508', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '130ca8c5e6545575a22d68bc4e4c1516d3b7dafe', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '7504ad32a75c6236c01659508874d74f99164f6c', class: "task-action" }, index.h("wa-icon", { key: 'c3b797a0c79aa4f4d98e296086432674bc4d3c3f', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: 'ef12d8d215e5bea0a7175deeec75434e7e890534', class: "tasks-header" }, index.h("div", { key: 'aa35b17e1be9bdf6c79317dfafd68b71cb3b6190', class: "tasks-header__inner" }, index.h("div", { key: 'd7ad3bff9112d78478db393f6f9490ac281c5c50', class: "tasks-header__brand" }, index.h("img", { key: '4306ca00b2acf8cc5701f53b95fdef19a5fe48e5', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'd05937068f0d7e7e8c5204aaea20cd2e99ee4539', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '2f3f89d325fd673c5fa63a76793a7089e1e5ce30', class: "tasks-header__actions" }, index.h("wa-select", { key: 'd72e269f597e3ec3a5acd640e1ec48acffd503e2', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '968606d032a55c0fcd6b179915dbeea82966c05e', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '4b789e68f13a6fa3eec74fe1ae266b2541d64cc9', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
