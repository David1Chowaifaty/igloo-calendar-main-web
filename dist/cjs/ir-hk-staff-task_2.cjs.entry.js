...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e5491a77ba5eb8ab79a89f7b9c9c872bec1776e0', class: { 'staff-task--future': this.future } }, index.h("button", { key: '93340e5889266ee08d5e5b6e50e66bd0e6082a82', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'bded2423f4c0cf3836747b323e9511c223a8cc51', class: "staff-task__card" }, index.h("div", { key: '3dd4c6317498cfbc4b4e3ccc77240cb751d09e9c', class: "unit-label" }, index.h("span", { key: 'e9464a7f80d897ade3483a3b6394fec0a43a975a', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '2e9ccb39810ca154306b5d0261600ecbd4bf31c8', class: "task-content" }, !this.future && (index.h("div", { key: 'e39ec5c5e600bda9d8a42989ab2f789c05726ca5', class: "task-status" }, index.h("span", { key: '4a38fcac4f97aa0ce8dd0781ef64b440d5cd1834', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '71cfa5a1e55d093698ebd81917eef7373db0b9da', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'fc3a984d0f5744d236ca3019c49ab811e1e12f14', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'e9feaa9128a39b4848d2e840809e9b37a79cc342', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'b178e3ac9f380771b771e4c0c715e267e32b14ac', class: "task-action" }, index.h("wa-icon", { key: '216a69d29bd0806b7a45db3ac9a1bea27c1a0e3b', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '4e5518cc7bd8c9d615e3f5db96d418e4950f6a55', class: "tasks-header" }, index.h("div", { key: 'b0d4e1eb11cffd11d72559fa46fc00149846dfb7', class: "tasks-header__inner" }, index.h("div", { key: 'b2efe54f1b9fbe187a026bec0fe67c788636314d', class: "tasks-header__brand" }, index.h("img", { key: '1e567e5d78c344710ed0b5736c590e5da2a816aa', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '3f98d83c7e0cd50178c7efd58eb1bc71ca509d1a', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'd252302bdba8b91d25c7a4ba4fc6bdecea6e8ea3', class: "tasks-header__actions" }, index.h("wa-select", { key: '49bd8deb8e5fe8ccef2f802709c9c75127befb87', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'e65b23d80425d8cff9084b13cf3e7be3fcbe8466', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '9866e3c006c4afad83eb095ade5a91a67017f775', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
