...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4f944c4f97770f940c64425c3324975f7965cbea', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'd65a4ffe4a1e8891e0d5d4065d625e5274aa9ed5', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '2cdbb222b55ed090c75da1f9345b7e283daa467c', class: "staff-task__card" }, index.h("div", { key: '0abfddcee67742afe20fabd917fff888a688de55', class: "unit-label" }, index.h("span", { key: 'd63e57d1798b01128206a2a23adb5228c6247895', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '538e99a7b2ca6b853a6d763d46a826577201a5cc', class: "task-content" }, !this.future && (index.h("div", { key: '2f911ac2fb2eec3f8cfcb4b27b9d9cc8ab23947d', class: "task-status" }, index.h("span", { key: 'd674e25a64e3f99992843493006286f617ab8111', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'aee2a848dd59ffb19d616b13fe8d8eb7b8d30e2c', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'dfeffd00d09553339455d657ef7503f1116349f0', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'a522de92f6092376c1f5fc3e66c0719f62a4e1a6', class: "task-guests", style: { paddingInlineStart: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, number.formatCount(g.count)), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '1b49e109a97ba877230c7d787a8d63b7721a1303', class: "task-action" }, index.h("wa-icon", { key: '07b2a3add5da16d40b798b353826972420ec28b8', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '12bf20cd08a33a5e262de1f270a6887dd96c5f44', class: "tasks-header" }, index.h("div", { key: '8102b96fe277cec8e9b635d9000d1b2e67fcfca2', class: "tasks-header__inner" }, index.h("div", { key: '893c66680f7c1ccf3401dbef07d566723ed6957b', class: "tasks-header__brand" }, index.h("img", { key: '7d9491a61822069252d31393bc2b1b1d3ecac077', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: t.t('Lcz_IglooRoomsLogo', { fallback: 'IglooRooms logo' }) }), index.h("span", { key: '18142e5a34536a67125f509172436bbebd904352', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '63bd861a832c258b54117d49d7ca88673df3743f', class: "tasks-header__actions" }, index.h("wa-select", { key: '66620f621fc8bdea3494118fe58fcd49eebb4912', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'b39bed6925494f5a5ccbdb8138b7bb1f3c8655d1', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '5b48f0fb659d6f044998e9e8f3043b417aca5f73', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
