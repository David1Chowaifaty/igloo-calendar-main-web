...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0408bb8a36eeccec956910b97773067eb35a5233', class: { 'staff-task--future': this.future } }, index.h("button", { key: '1adc46ac4150731b6d8120b19c482777f0555adb', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '5ac2b4d6c376b3d3c38e63a1dc277007bd3d3363', class: "staff-task__card" }, index.h("div", { key: 'c4ea1c68ae3af579ed4c821f70bfa3d96f68081f', class: "unit-label" }, index.h("span", { key: 'f3929b67d5deb9b8836f4e78f7de1792561c558d', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '9350a367e3728780efc1ba73a9b6a4c3d55a6e47', class: "task-content" }, !this.future && (index.h("div", { key: '87e5c1ef74ebb25b0b5cd240e55b561549511a6e', class: "task-status" }, index.h("span", { key: '891d78dc14039892673a89471bee22cedac8fed1', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '301cf5c81ca9b655223589b2298b80f4c79000a8', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '8c880489b178c88913095fb8619695d5f51cd190', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '414ae1dfa33fdd64c9b43f508cd7308a8703171b', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'eba108e5c98b72b97260f925b28fcfa1a4784e39', class: "task-action" }, index.h("wa-icon", { key: '7317ee51299cfb34bcf498af27878ec01a7bdf2b', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: 'b606d10bbcd8a82e45de7ba77fd2526385d43154', class: "tasks-header" }, index.h("div", { key: 'f4a7ce8980921eb029f399b66380f3f455558857', class: "tasks-header__inner" }, index.h("div", { key: '8e5be7afb18c81d88ce6005132fcef3532bbc181', class: "tasks-header__brand" }, index.h("img", { key: '14e46ac46b8240e600372f63029234c9cd267bce', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'fb963b1dcd60b2bb47a463d1aa714fbbd58844d4', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '7662d33d370892014eec96da5af4ad877b34c13e', class: "tasks-header__actions" }, index.h("wa-select", { key: '7eb81bd6c0f78f5d00817be094e3cfabca17e38b', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'cb2e3a280bb019320d8184624a8b7510f9cde4b5', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: 'f513798b033fa4bb392b937b157d6ca3fda58866', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
