...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2301c527f5dbe2530482abce6b6383e8380e1767', class: { 'staff-task--future': this.future } }, index.h("button", { key: '6d7c189d10a3ec7cddce4661b0bc15b7898eb516', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'd9892feb0695bc2040415acdc9aa3df1ea9a55ac', class: "staff-task__card" }, index.h("div", { key: '542f10246c0f165efb1d17566ba4bda5442555e2', class: "unit-label" }, index.h("span", { key: '64e9901a53e158d24a6d64dcd27ae92207bd0471', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '4fe73cde48ba4820b87903b86bd00f363523ddad', class: "task-content" }, !this.future && (index.h("div", { key: '55c48c8c850c34e8ba36f66f8eb9f7281e970796', class: "task-status" }, index.h("span", { key: 'c047ea2d74be136caec8cf68dcb11aac270e1c8d', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '5a3546565d06b2d71dfd3da59bdc0e463ece6f13', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '9b2771806854b355c9cba19f60e7c6ec99f74f6b', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '362d4110338ecf6a8f400f652f3669c161ddf2f9', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '38140fe1e87876144889c317a668a58f709deec0', class: "task-action" }, index.h("wa-icon", { key: '27668f857b45913b6dd5b5c04c3964b544564ecb', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: 'baa76b5c7d232739079e364aa87bf1cde1a188c9', class: "tasks-header" }, index.h("div", { key: '4a2249512fc56573aea994f9f8978ccdc31d92cc', class: "tasks-header__inner" }, index.h("div", { key: '9d084573aff38edf98a59b49654b07d0db74a723', class: "tasks-header__brand" }, index.h("img", { key: 'b59ace6c0ff51e0753cd0ffd50f4263f4b96c518', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '507e875dad6287016aff5a6b87828b903ab4d29a', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'f70a45e522723eb559cef74674df9660bade6d85', class: "tasks-header__actions" }, index.h("wa-select", { key: '7534a699000fdbb76abea967d7c5923c5f50956a', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '961da25101a3ce006977ad8b43146b98ed5cf544', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '9a2e86d63ad9a0e3dd083481c38eefbb164c3666', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
