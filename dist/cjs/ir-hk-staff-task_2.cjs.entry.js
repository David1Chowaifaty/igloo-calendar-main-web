...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '899d7a5c625f4873d410d85f2f481c6e3b8319f8', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'e3125b602111941c0ef6f406e33bd8060583fe25', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '7ef94dd332876850f11b9338a73417da1d538d73', class: "staff-task__card" }, index.h("div", { key: 'c5e741badd41df4fccad9def06c2667496937bcc', class: "unit-label" }, index.h("span", { key: 'e293c20959283ceb9bb38504798298e570ed8200', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'ae62473bec4865ea711a25498a1824185fbee3fa', class: "task-content" }, !this.future && (index.h("div", { key: 'aec4cc9810e5454aeef41326ad3470ff2fd04f8d', class: "task-status" }, index.h("span", { key: '3323a79bf217b6b0402062025ad305e09b2fb4e2', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '9f35bafbdf121af96b467ed18b88fd2d4c66a31e', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'faee89a7bdb33dcf361f23f91b5b9b639607a5f9', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '89be0b9f207e2a7a990e6380ba8cc3ca8ffd2e09', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '03ba0975399def19c732d809eb11a77161bc28a7', class: "task-action" }, index.h("wa-icon", { key: '684710269c10698b2daa68376ff4a13ba4f656e3', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '2b1d6e8f14fafc1072245fe58a8a03d04edcacff', class: "tasks-header" }, index.h("div", { key: 'c17b3f9b10a20e48239bea1acc567da0ad8e6ecc', class: "tasks-header__inner" }, index.h("div", { key: '9bdf863eaa61b55f23bd29f26d6e3579ca212660', class: "tasks-header__brand" }, index.h("img", { key: '80df1a57874ca6afc0cd1943edf4f2472e03b7fa', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '2d443e0bb6f26a2d91aeda05c709d2521fbd5a85', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'e5e0e159ad740f8611c4bc159454d139fc7e8f64', class: "tasks-header__actions" }, index.h("wa-select", { key: '3f6b2b344cc96e1a2f7db143b5e86cbb8b9ea9d0', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'e8519eb7c686c1255b46d0638d4736e91c3caa2b', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '72cbb94296403c5940db33d0efce05b3c8efa8cb', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
