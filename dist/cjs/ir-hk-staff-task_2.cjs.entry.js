...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2e46bc5a0b3ec12ee9a6765449b76d5ca11524c6', class: { 'staff-task--future': this.future } }, index.h("button", { key: '9c5028402d1c8ecd40caa52296bb50b89faec6be', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '245cae56fd04d2b07f416649628fa0912e760f45', class: "staff-task__card" }, index.h("div", { key: 'bfdcf634ff84dccd326157a54fc21baa1049cea5', class: "unit-label" }, index.h("span", { key: 'a255da9e0b2f5137329180cac6bbecfad67311c0', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'c25dca96d30d93ced49f9e8e75c53277114f1dd6', class: "task-content" }, !this.future && (index.h("div", { key: '48388433d0bc03e46b8e34a0becb470e413157c0', class: "task-status" }, index.h("span", { key: '7f3ba82c3135e6a84969176b69a4f841d65cfccf', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'd66418d390dc936d011850315252e1a62f9a7b4f', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '57ab8f340d633d689a3c9b09aab97a9aa4742baf', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'ccabaad3752f907e8a9a044a99f2e3cdedb54510', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '57668f7d8efb46a92246f25a0de8c6b1a4f32341', class: "task-action" }, index.h("wa-icon", { key: '534e3d412f8f3cb53995ff66f583aa3a3229f05b', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '6ac2b3033c5334753bc3f44f47b571d192878652', class: "tasks-header" }, index.h("div", { key: '5d1b81c36e77b98a168628fe0aa639994b5f6db8', class: "tasks-header__inner" }, index.h("div", { key: '0e505aef35b8af6eaa56096f05438cd22021d7a3', class: "tasks-header__brand" }, index.h("img", { key: 'a8eae9152018b95fa07dd5b4f9dcf58385d8bcd9', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '906621a83dac7c0b8a587cc58d41345af77d3a3a', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '3c2b8f5e58e2fac4aad821ad8cbb117dee96d4cb', class: "tasks-header__actions" }, index.h("wa-select", { key: '7b9036219775c72d7804c4345641e399118f74a4', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '681b14744a76cf4ebf2978f4ac5286c92526f5b1', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '831ffab4f0394f06ce49f488b3c812d990f3e7b6', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
