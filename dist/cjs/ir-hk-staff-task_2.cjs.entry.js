...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b5856601f3a56492d83d788e8a4610c6c8469af', class: { 'staff-task--future': this.future } }, index.h("button", { key: '51f5738a475796068adb42bd6704893f92679169', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'b4e7e0bc3966be93cb9278e2caf1d45ad9a595eb', class: "staff-task__card" }, index.h("div", { key: 'a54b17d423f6f439f22d2ad684801b7164310b4e', class: "unit-label" }, index.h("span", { key: '63901ed472c94c16f15dfc49706f5fb2021ce7a8', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'f99b7a12261cf46e2c71e623b24c6476a81dee0b', class: "task-content" }, !this.future && (index.h("div", { key: '9010a9193aa8a7941984324061bde78afc81044b', class: "task-status" }, index.h("span", { key: 'ad6b0ff35ed011963153300e4b718e0523c4b77c', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'deea196fac56d6edbe4f058a779af2e6c0770c19', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '6bcd4bdc0dd9c1fdd345ef192db00c12143eb904', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'ed94630c90fa4d639d2680775a82824a29fa0e26', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '9d1047eb8342092cd74d2303b42979a2cfc34d30', class: "task-action" }, index.h("wa-icon", { key: 'ccfe1fcc9896c53e037ee22c1ddbeac83ceef90f', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: 'f0c6729b470ada06a4e2f2e9589d816fd57f06ed', class: "tasks-header" }, index.h("div", { key: '669f1f2fd813d480a9722df9990735e205145f27', class: "tasks-header__inner" }, index.h("div", { key: '33a01244c83596861ca33dcdeda8aaef09260d71', class: "tasks-header__brand" }, index.h("img", { key: '9d2cc83d0f914625121251acdca4737aeb19f6e9', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'fe875a89cd6cff350397ecc0d218ebb27f89c18b', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'a70913f0dfa7799f3b8c0c4301f478d23f6ee94e', class: "tasks-header__actions" }, index.h("wa-select", { key: 'db8657636f7ba58b33f76bc9860846bb6860a52c', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '0aa7afd9ac38b37a7c78e24443982a02263250c5', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '4481cf028bda065ff5d6c41f4efa7f2f20b09b7a', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
