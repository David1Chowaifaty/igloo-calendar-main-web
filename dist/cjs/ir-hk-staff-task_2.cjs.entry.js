...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '254a30dcb07fc3914a03a015df60bb135c96ddc5', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'ef2d51c9649852e0746fff6693debfb8414b3282', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '9e78579575ded013b87613108386e8be4683c6e5', class: "staff-task__card" }, index.h("div", { key: '291f81e77ed53c320b8a65bc7ce05d04887d3456', class: "unit-label" }, index.h("span", { key: '3e81fd0e44dab7cfec2320b8a0c4a6e50a485d4d', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'b4275c78674d68df9462450939028a39fcb1053b', class: "task-content" }, !this.future && (index.h("div", { key: 'ff9120cb300cd0645b8669eaa48fb03c1831fed5', class: "task-status" }, index.h("span", { key: '62a70e281bd8fc7b512175df30cd0d559f9bccab', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'bf16f28f2ac8f1c923f4e4b720a5e0ba74a4913b', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '4be33cd5f66eee8880170b1d4f57f784d823bcbf', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'e9ce49739f5a8353bebad52f22832c71e37020d6', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '999af0e3a17dccfab734e090fb55cf03acc690b7', class: "task-action" }, index.h("wa-icon", { key: 'f7d3ae8beda02b9554f587a9019aee14b4203138', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '004812e912cc03357ae022303d86ca4625ba4a93', class: "tasks-header" }, index.h("div", { key: '10d9e49f639530c8714961b5b1b1f73c763d669c', class: "tasks-header__inner" }, index.h("div", { key: '522733a5576926597c968a600f668968f6a77750', class: "tasks-header__brand" }, index.h("img", { key: 'b34ef544bbd79ba03b1ad95c0bc3eb6e34f5c15a', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '1c2983f1c95179e0eb3e1413227b4bb0c167fd6a', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'd0ad4dc48f32e70c5d3ff2360fb5cf2158e0fc88', class: "tasks-header__actions" }, index.h("wa-select", { key: 'd633c9c79a814df8c2c0794a11bbe625447a5240', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'e0f101dffb95a4a9440a46c79a8f85842aed6f07', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: 'e40c09042fcc2c78f49597522afc81ca98c9f408', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
