...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '87c169fa7c76bbd78003962b9c1206fb3c3b087d', class: { 'staff-task--future': this.future } }, index.h("button", { key: '06ff0b84e110429c3c3159cf1f5d26578399529c', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '6492b943dcc1f6dc2ac692ab587be9798abe8ff4', class: "staff-task__card" }, index.h("div", { key: '0c914e8777732f9122add1bdfd88943e566a75c6', class: "unit-label" }, index.h("span", { key: 'd6fedf4c44a116dfb928ca2d5d45e52b216b6d11', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'f92f0bb1a6fc69d01b5d999ae04a8fe867546229', class: "task-content" }, !this.future && (index.h("div", { key: 'a02b4ed57d4702fe3deaab765b36d4d148c9430d', class: "task-status" }, index.h("span", { key: '828648d9402143db7621fc1745eab2242c0af8e4', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '689729951d269d5f6608d44dc70177b8005d5214', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '68ef39bf229f294769d9702a014c02d33fcfa762', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'bd739af26a421ddc734ae52b1051b703cefeb082', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'e7d8ed20b663819dc8697edd9a7665c88a11283b', class: "task-action" }, index.h("wa-icon", { key: '692e01f36725e870a5ae927fdc01f2b230ba63e5', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '2ed05b85514332cbe3b0d5a3d24c00f170a7f65f', class: "tasks-header" }, index.h("div", { key: 'ff0756302c42766469a93c62ef35576430e2f269', class: "tasks-header__inner" }, index.h("div", { key: 'e22851f02c3acb07f16ebaf3f4037f077de3f059', class: "tasks-header__brand" }, index.h("img", { key: '9f12bca7498e2b883fcc10361d11617655f0116f', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '070ca9a82c5f5f56cbda0a52e1260f17d03382a6', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '88cf61f4566558c21282a02d50b20efdbd791570', class: "tasks-header__actions" }, index.h("wa-select", { key: '5bf73cf89a3e566a5056b06714c3c79fb4bd8642', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '7e70cc3d6fa140724a6634ae877ed2c2b4975b59', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: 'fccd9428eb508d94f878d5726ef6dbc4c6355661', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
