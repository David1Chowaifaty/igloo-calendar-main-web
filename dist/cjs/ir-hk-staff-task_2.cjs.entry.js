...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'db109f0f8acb5a0d6b1f80df122b232ceead8287', class: { 'staff-task--future': this.future } }, index.h("button", { key: '878a91fdfdf68cc6278114532fdf7d51d27f0a73', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '10584cf585ce27c11b651f072360798f895a5ef2', class: "staff-task__card" }, index.h("div", { key: 'bd926d14dd544195eb3029d3c01ac75d54b9f1b9', class: "unit-label" }, index.h("span", { key: '4566ff692d79e046702da636979a4cd56537e6e0', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '041cbba4dccf14fe3dc03a29610a793e62bd796f', class: "task-content" }, !this.future && (index.h("div", { key: '35928edd30cafe444181a39e4f2e48ba5a1b494e', class: "task-status" }, index.h("span", { key: 'adc08c557c73b44997993af25728f31cac06814e', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'c80c15ef9463efad50f4a2d0e2990f867b27e451', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '12ae41f12c3671a21c6092fb7794a3a7c241266f', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'eb18195db41445df5de02a94b6e35f0a8d07dcd3', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'd792ab9deecb376fc3a81d8c3ea2131188e8f6df', class: "task-action" }, index.h("wa-icon", { key: '35c49eb4af2cb722a56b44e5a642a26f1255a5ac', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '27f962aa9dd115f220de74c0c6871d53794add6a', class: "tasks-header" }, index.h("div", { key: 'a6d2efa9fd358ef1a77be1df9b18d446f336747b', class: "tasks-header__inner" }, index.h("div", { key: 'd62c5d6591a76cb4a68b6b7af1e6798d41b85db9', class: "tasks-header__brand" }, index.h("img", { key: '31bb4f0de290c724f472fcdfcafff9e2a6c78672', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '8d2a28eebf143621ef1b9aa75294bf0960f330c1', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '836630a77324f22701cba9d1b9ec3b3f9254430a', class: "tasks-header__actions" }, index.h("wa-select", { key: '50603aa01540e05d8c1975d0ba5f0df61b72d76d', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'e7cdae14e17a581ddb3ad5c81cda56b3b07a4502', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: 'd7e98396ed2e0d3c5978289153ed8cdf4472662f', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
