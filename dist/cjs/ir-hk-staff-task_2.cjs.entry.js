...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8dbd9891762d8431eb4b31974c62e1aa79e113d1', class: { 'staff-task--future': this.future } }, index.h("button", { key: '8f71ea03f8831eaa35942d2428ebfe730b45a694', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '68b5d52c7c9bc08c84b54bd5a0a61225c21de0b8', class: "staff-task__card" }, index.h("div", { key: 'f34ea7daf37e2bfba2f92887f388f1444a17bca7', class: "unit-label" }, index.h("span", { key: '5a273669d441c8517e08ce075ccb0d98f183271c', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '29e90da87c789254e8f292cbf0e9fc9d21831988', class: "task-content" }, !this.future && (index.h("div", { key: '09c50fd00422272043a1ad7c0d38f9952d841a91', class: "task-status" }, index.h("span", { key: 'c8cfa20cc5d862ee426db2d72ffb6b7dbec5af0d', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '4cb39e896d9e297c9f2600bcefaafae177e7bb57', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '3157576ce68e70abe34490e36a1a7e8a4d906980', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'b2942f90a09c3a228ac686e0a34c6de993a91693', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '01460e5025bdd45565e9ff1a7701fbe9b24d035e', class: "task-action" }, index.h("wa-icon", { key: '3dfda011ac48ec92118511be7ce5a825a2a1d4a4', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '6bda3ed877025eb66bfb22977abae92d0492da7a', class: "tasks-header" }, index.h("div", { key: '8b4c94303d80662c7d870734fa735566102960cd', class: "tasks-header__inner" }, index.h("div", { key: '2b908fd0048bb83d20ff263759e35dd50a487745', class: "tasks-header__brand" }, index.h("img", { key: 'dd8a6609a97b095ba5b8af8cbc234bc7604a8652', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '3c6c7fe3483e267de468579e5cc8552db6ae9e2e', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '8493e50427274c8270e42d9a00910fe86b1a67b1', class: "tasks-header__actions" }, index.h("wa-select", { key: '1b37dd9b2e6a9809b194a715e0743c39906640c3', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'fb9015b1629615bcc345ca13ec9e4ee37553eb0d', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '177976b799bc3ae46899ae490a635399928c6be5', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
