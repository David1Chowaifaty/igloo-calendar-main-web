...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dab085200faa8418458242077878295a2b5c42a7', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'db33919aaddf1d66f543d4a065e5a08150b8ef96', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '3485ca1fd406e96afe50c09b67c05270bd5eae90', class: "staff-task__card" }, index.h("div", { key: '816d7c6ba5d6fad322584ccbc8267983f6dd4c4f', class: "unit-label" }, index.h("span", { key: '2696e56d4a88d62faab84b8ff89d91d95cf9084e', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'e878dac8b37e01a26e1201f442553e63c426f299', class: "task-content" }, !this.future && (index.h("div", { key: '7c143cac02f4151730c26b6fa209bb77d9c006d3', class: "task-status" }, index.h("span", { key: 'fef459765407dd4ecd7d75ec56bec08f346bad28', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '410f982a01baa3879f2865aacb1d3ae0baee9a36', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '18524512e65dd8f258d280ffe4ba5fcfa119236f', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '775dc05d654456094e93c376dbebfec5c22793b4', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'a2b7020e64250881e7c31cb405608ce2716fc732', class: "task-action" }, index.h("wa-icon", { key: '057bb489edd874fced5746306c7d4b0b6077fbbc', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '86ccde1bbd104ae9ad6e3402078e632bc73e5e1d', class: "tasks-header" }, index.h("div", { key: 'fde7868d673231f0a38568e8f64d1b9caa4df463', class: "tasks-header__inner" }, index.h("div", { key: 'baccba33dde146d90f8149f9a3d4e6d74f9ddd4a', class: "tasks-header__brand" }, index.h("img", { key: 'c5b98add758e10fd53d06235161a4c6487e899aa', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '882c57307134049568ab6b42c1de43739aa892dd', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'fea2eff3790ac227241fd216f90b76918bc35260', class: "tasks-header__actions" }, index.h("wa-select", { key: 'dc4eb4aed8b72b0a615095fa6e324a1b24a6f526', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '3e8f9853bc61de95c46fee8f29a783bef51285c9', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '5c1be933c3061a1df22e44192ab102f022850f46', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
