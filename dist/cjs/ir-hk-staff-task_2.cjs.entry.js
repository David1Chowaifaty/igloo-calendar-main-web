...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4f65ce28060fa11d2bd4a857fc1fc86557832999', class: { 'staff-task--future': this.future } }, index.h("button", { key: '54c7b564e885a8528669ac647c513f0db998cde4', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'e88197f7baed645b815494b4f6a1f60fa29fff5e', class: "staff-task__card" }, index.h("div", { key: 'd0e1f08c56d6ebe6c9c2561cbb29ae173eced4b2', class: "unit-label" }, index.h("span", { key: 'c925dc48336c07a8fc521c428b495c0937c79d85', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '9a74388cb4a14c5a029e40811a9660c69ff96f4c', class: "task-content" }, !this.future && (index.h("div", { key: '2603fbc515cc1ae9d01220e72e22485d2f1be5b4', class: "task-status" }, index.h("span", { key: '85d3fd680200b62953725c0e7135a0222f85128a', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '80628bcf644ccef2a06421ca0dba9cd7215ea245', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '6ce83a05dec2f64b150232bbe3b5d09429233ae1', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '63cfa54b57eddaeadf24751b09565cbeb98e2911', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'c06d3fc7ca7b288044cac072ad117975f0392b36', class: "task-action" }, index.h("wa-icon", { key: 'a1062459a8d2baeccb37e0d8ac090230f40ea60b', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '44b3fba73e5951d08d6f82eae007b08a8ac7c65b', class: "tasks-header" }, index.h("div", { key: 'ac6bbd86a25fffdf52012b06559bec833d189551', class: "tasks-header__inner" }, index.h("div", { key: 'dcea6ee722d96d8cf78fded23a3d7a5b9facce83', class: "tasks-header__brand" }, index.h("img", { key: 'c29a16b299364276dcf9ca3dd59c345a1a60744a', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'aaef1f9d6f77a4f609d19e0db37964a4a94d24dc', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'fc3f3c057d77d57aea8acbf872bc73fe256f927e', class: "tasks-header__actions" }, index.h("wa-select", { key: 'd8477bfd00aea4dd1e9c7cfdf0f0b94bfe1cec7e', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '8b1ad99d8b3a48c59a6bcec5644e354dfdc196e9', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '2a4b00d64dd75d13a3a4959848cada7f1c06c077', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
