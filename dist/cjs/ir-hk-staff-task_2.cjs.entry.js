...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cf03f4de43055ffe336605a86ac8a2c08d251f6e', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'd1ed042343aca1c9cc2acb83897ef11952508a89', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'accb50a520d4de1ec5cecdb281026b0e46804910', class: "staff-task__card" }, index.h("div", { key: '91073a2df66f83948a26f28d830bb69921716d13', class: "unit-label" }, index.h("span", { key: '74f31b1bc52e2eb922c3922ebe34253627ff54d8', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '19e0aa17570a2d2cf17098b52439d8dbc6f259b7', class: "task-content" }, !this.future && (index.h("div", { key: '22a2318c008e43193fa0fcf938b597782ceed057', class: "task-status" }, index.h("span", { key: '9bf9f02a12c44686439781fbefc9651dec3fbffa', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '7ac226d2e8155ed0550dc1740999326be12e5a93', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '888621777a452a205799f7d4e92eb69721e364df', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '0f8ea3ec6d89cb11d07d24f20be509a3aaf5cc9c', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'e23a545c0e650abd9590b9ac13ab59e462a9ac72', class: "task-action" }, index.h("wa-icon", { key: '84f9c8b0ff11d2da2fdb5f5fc6c868cd123c7456', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '821014c11d3270ce81435291e785b35479bef86c', class: "tasks-header" }, index.h("div", { key: '98e8d0b92504b102ce908e698657e92f79f43d17', class: "tasks-header__inner" }, index.h("div", { key: '48fd51d1b814416fb9eb7a5d857ec31ce6f5bb09', class: "tasks-header__brand" }, index.h("img", { key: 'da7ded52d58fc39fce1c978ce941929c35534c06', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'c982ae75d643d85470de65b40df22e9646a7ba20', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '987c92f33e6df3fce873f80a93a76cabbb12e424', class: "tasks-header__actions" }, index.h("wa-select", { key: '2cd218b26eb861fd6b72fd9507cd6419ea41cebb', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '6c22fa9c1b388b4032759f6ea0caefab5613b88a', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '57e60b75d53a4046fe9a4af7fec13c7fb7f7620c', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
