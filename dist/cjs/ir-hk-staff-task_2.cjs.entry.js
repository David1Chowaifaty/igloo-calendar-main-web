...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0223c43a58c1fb6478b944d25e5032c5fc1dc9a2', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'd3963f72bece054069950b2a63b67708b10f7054', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '8caf3269c015c18f9e6f7c1bf2bd1d9cb8a451da', class: "staff-task__card" }, index.h("div", { key: '3f7fbabec400a210cb94340e67326730a304ba56', class: "unit-label" }, index.h("span", { key: '2f150b69c08e6f7a50f08446156445899a61c579', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '703b4428a22fd31022446eef8913044a2768b569', class: "task-content" }, !this.future && (index.h("div", { key: '5929d193f020049f4be591b84792ae4a36cf1019', class: "task-status" }, index.h("span", { key: '49740cc0f310bb3704f97d630be81b2d24bd1a7a', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'bbcf102dfe39c7b22df7cc5e3bda3ca375132dba', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'c821134ee7e683c9bf9c97ba420d4b123b11dbc3', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '7822c0ba78f2da8d146205f190c7acaa0b2ef6cc', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '0835f0aab3d5b71b368739512f2c0a4cd49a60a2', class: "task-action" }, index.h("wa-icon", { key: '9c9d2a3c9be798ea2fc0eddd4c4648c3926ad4b4', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '227b1650375542d55fb6a02e5d40bd5768ff628a', class: "tasks-header" }, index.h("div", { key: '3c44b3dde684b73ba05c033714ee2093be82a91d', class: "tasks-header__inner" }, index.h("div", { key: 'dfab5222d073bc2daab8b65ad3083bd8d5b89ba2', class: "tasks-header__brand" }, index.h("img", { key: '74fc1f1405663fdedcbc214bc673e79bdc8f588e', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '31375b0af7dec453e5fc4f2fd85decf6d7d684a7', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '0bdce91253e8cddb0b160a97a6852fb0989109c6', class: "tasks-header__actions" }, index.h("wa-select", { key: '98e72c7e40ca5a46ee3c5e069632f37c811d92ab', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'dd5fc96d3c1d72fc49a53413be3e907452a67f84', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '080a3d62fa1a14b3632130f153b5b775dbac8dfb', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
