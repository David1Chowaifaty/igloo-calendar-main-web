...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '01a9e9e9f34edb3f750f8b2a0612635968eea5a8', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'ac3d9b8ba150d2b032787e9e4f8d543f455556a6', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '0b407e838707e4ae3a1163ed4bd5997fa8089d88', class: "staff-task__card" }, index.h("div", { key: '52630c64cad6f458a7544dd258109ca480f3e31e', class: "unit-label" }, index.h("span", { key: 'c822d0546234cecbf188d6b6fd1fd60087211902', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '6ce8ebd452aafb14b732d43621b6a21294c5455b', class: "task-content" }, !this.future && (index.h("div", { key: 'e3b37fe3f711b09213bd8be5747515770dcecbcf', class: "task-status" }, index.h("span", { key: 'b86c2fd1f662a209fe880bbcc38ddb1f18428446', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '22ff33067fc0fd467f1af47e3c09df5865d88ae6', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '8e749f9498c7e3ba13616467f8af0524db004b3a', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'c45bd255ee507ac9a53d915232d2bec498123687', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'a2344f8cf361f64a0522e566f90d368f10d315bc', class: "task-action" }, index.h("wa-icon", { key: 'dd96db8a4eb602f8e56ceb18bb7b6d884ead4b76', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '0c47446c57db00114729c0146ea8f94db3f16143', class: "tasks-header" }, index.h("div", { key: '00d78b73ec8098da7820fa0ad8639e5a39efd5c8', class: "tasks-header__inner" }, index.h("div", { key: '4d8528dc9b2438ca493327f031f572963140e1d9', class: "tasks-header__brand" }, index.h("img", { key: 'c358c94a4be5fa59ca7428665e4eff05f6c5ea3e', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '2a547b86093d004e1c0111cb3c4ed627e96418f8', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'd5ea3f6e376a20a57851f9680edca02f89c5f4de', class: "tasks-header__actions" }, index.h("wa-select", { key: '1d197f255ae9fba073e963daf9455ec5faaa6a3c', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'da3c4efa0048561bd4a9ea88936bad210b33bbeb', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '1398e70b97076e240b019a7621edebd6c34233ce', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
