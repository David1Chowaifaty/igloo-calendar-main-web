...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ec4b2cc627749d19b1b694912f4ecca8c212938c', class: { 'staff-task--future': this.future } }, index.h("button", { key: 'bed69cfa0d00cfe4db0d9b67db341a33d922fa70', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'bd8d45c2db52e140d78df66261d5601145459130', class: "staff-task__card" }, index.h("div", { key: '7b6b18b69a6ef50b12857b9773183fc2f1f8340f', class: "unit-label" }, index.h("span", { key: 'ae39b5ab5ca2f7f0760e15ae5d249390457606a4', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'a04631f911ca9cb414caf7a9446da899aeacfda4', class: "task-content" }, !this.future && (index.h("div", { key: 'ad10f6a3b1803d033f7889f3bc0410fad99b69fb', class: "task-status" }, index.h("span", { key: '36a0005c4fb5d9e698a905ba4daf67ca865ef1ae', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '3bee88fc7495a2de58681c9c13cf1e80820ea0b1', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'c03586aaffbc397d0b62f7d51cf1551277e32ea2', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'd55f9185b1f59884cdbbf8ef749aab0d4ecaf8e3', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '706eecfcee9e92e64e15964821d08a2b37c65eae', class: "task-action" }, index.h("wa-icon", { key: 'fe445d846f3e46cb10d59252d2fefcd135a2a505', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '30df173e14c42f86a305557e2afc51a386830b8d', class: "tasks-header" }, index.h("div", { key: 'cf07b9d7ba07622060715dd5f138ef32edb51a7e', class: "tasks-header__inner" }, index.h("div", { key: '517e04b8fefcc9e31ae656015374992aeca8e2c1', class: "tasks-header__brand" }, index.h("img", { key: '9dab0b94eeaea5f4c90f9e5a92d7ee7dcb65b9e4', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'f8be5932113c9dd653f4dc8f4dfd6ebe35ad2d79', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'affe73e846fd24f94199ccaaf5f70097ed6b0dfe', class: "tasks-header__actions" }, index.h("wa-select", { key: '5e5e0c18387ef6dd6015625988a427b2e5315c78', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'e3b34b551407afca3384419930e3e358f5bd2b99', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: 'c9b13f81c8977053db72c148664983d5afba16ab', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
