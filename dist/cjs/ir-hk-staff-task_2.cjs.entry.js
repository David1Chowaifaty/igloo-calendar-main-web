...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e63b914c574ac5ae25de60827bb9c8d027c2988d', class: { 'staff-task--future': this.future } }, index.h("button", { key: '709d45b27ef446ba32fd4be4d4dd52eb07e83e00', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: 'f17102cea5b0f19ed5b70ceb4b252fbcccc832ce', class: "staff-task__card" }, index.h("div", { key: '7108c99362690ad709f782bac5220df5fa87c590', class: "unit-label" }, index.h("span", { key: '8249282938ff42ef91e79e3b39240eb5b9ce0be7', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '4e37ae93f29ce1fb0090a1d7bfca7fbe1e649520', class: "task-content" }, !this.future && (index.h("div", { key: 'b8048409c8dc5558f92d6fd9b4ef06a6eb89a1c9', class: "task-status" }, index.h("span", { key: '0ecac655b87e90c8fbc04c3a6a7c6a51f2ae6802', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'dea171b88bbcd6f170cd247111e4fbd034cc5903', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '606230a1ee6018e8f7b8f18a58a52482d8dee279', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'ef85985bf6101a920767d356f28cb2306ef5a612', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'f6e0183314b13da5fe01b5af0ee1f44669929b54', class: "task-action" }, index.h("wa-icon", { key: '15112e1753ebac6dc2e72516db48b428375e70cd', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '8b7db09a7cd05b4c40534c4e33037b70f7a32908', class: "tasks-header" }, index.h("div", { key: '9d9601839c579ff15ba58938b4e573e7c1a97cc2', class: "tasks-header__inner" }, index.h("div", { key: '312766843ac902b3d6193803fc1cc26d9fa42ce3', class: "tasks-header__brand" }, index.h("img", { key: 'e009b8439692202011b5bbf4f1c8a395ef723b82', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '11b0810e0c9fe5f2a3828146c98d0f0a9c96d908', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '7193059b9ae4eeda332b2612ef317f1468478775', class: "tasks-header__actions" }, index.h("wa-select", { key: '136ae38dd4e3adc450ecc08b4f8f0af105194035', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '101f66116e284641ac22b5bb028c270374c75e1c', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '6b1e16a0c31e61b49c445168643c65d71c4d1c4c', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
