...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2fbc15174dd7df81ddda1db8a4cb5648d502459c', class: { 'staff-task--future': this.future } }, index.h("button", { key: '2dc10523d54cceeed46dd952bbb3f941395017e4', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '30a9b59cb64f11b37dd90cfc6899746199a39703', class: "staff-task__card" }, index.h("div", { key: '64b5e43b3701d7b353f872acd0a6b18c841dfa6e', class: "unit-label" }, index.h("span", { key: '57ef76eb1d5c9eb66497d1ebf035a8f84f3f13d9', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '1de5ccd1be098eb106a66da8092471d85f545f5b', class: "task-content" }, !this.future && (index.h("div", { key: 'f8a0d57b7b1b83a4b2acd42aeaca14c82e5c656d', class: "task-status" }, index.h("span", { key: '05024a7e8a8f84378ce8ff7423a519935f88f10e', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'a38c7f1509a37d59f69334ec9460599960fc9913', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'c727a0bb71260a8a88513a141d1bb1629fa33479', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '642d9e9ce3ca8a6e4bbe75746a8061a7e98fbd73', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '988a5e6c96576294c0267d7010a98abfc45440ac', class: "task-action" }, index.h("wa-icon", { key: '0fe4218046043045c2bffbd891b2738491223aa5', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '19c5b19a0ccc835fcc65b793474e231a30d93c39', class: "tasks-header" }, index.h("div", { key: '27c303d516ad311c6fe8ba71d59ffd722f237b3a', class: "tasks-header__inner" }, index.h("div", { key: 'db3271ff7804a802fb5e2a6f7edd3f7c4d89c7e6', class: "tasks-header__brand" }, index.h("img", { key: 'a43c0ffea0e424509ce287c67370cbae6a9209a5', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'b3c98dc787ef50a3bdb05ca8b6c09dd315af2306', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'c24a6f7dd2df8ff24c522f4981796cbe9d4446e4', class: "tasks-header__actions" }, index.h("wa-select", { key: '3e6b21ab3dede5cecdb1a3c423935ae67c04e955', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '33cb9e65a523015e7c9cb6591274e59b940a9bc3', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '77e7777a9356388e8e11436661f982698207d98c', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
