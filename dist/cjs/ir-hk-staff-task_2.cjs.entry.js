...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4c013c878f802b743a4bc23726ee99c7908c35f3', class: { 'staff-task--future': this.future } }, index.h("button", { key: '0f72de01c49fa192f898769aa075e686a08e410c', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '059a090d405048444b081f50471d51d19275e40b', class: "staff-task__card" }, index.h("div", { key: 'e2256ff3751203ab3031ebb3992e09910ea47f30', class: "unit-label" }, index.h("span", { key: '37c260feefe20ee2cb5385c4d78280ae68022894', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '5ccc2dcc7e1b725511e099bba64503513472f8ef', class: "task-content" }, !this.future && (index.h("div", { key: 'fa1b63d76888654783738e0db96a3a030dd01931', class: "task-status" }, index.h("span", { key: '25822a183e84a90f9053d2a141ac9ed3a6488c7d', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '9cb797f20ffc96cae3cdde89e12e6f449d53ba01', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '3107e46d1b401f08c5473b6424cee9bc5ee07bfc', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '10a22eac3973bc39c3444dd510c5b4782bd7bbc2', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '7452d72a5a8b18cbe24451d045c679a468f7e767', class: "task-action" }, index.h("wa-icon", { key: 'c10710e9f280e6002c42d5fa68d66ca8c74da479', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: 'ddc874f0d239c36522289f488f3fe73d67985ae1', class: "tasks-header" }, index.h("div", { key: 'a92df6c77ac13cc1a06033990c933f242e53158c', class: "tasks-header__inner" }, index.h("div", { key: 'a1359ea574e9e27544502845da7c5cc220d11acf', class: "tasks-header__brand" }, index.h("img", { key: '592f9e43c1b30b70661dff0fa4d41e2e5cbb43ca', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'd3fcee6457ac180830d2fba66c5f5b35a3b090d5', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '02aef22f135a6070f72d08a067420137059029b4', class: "tasks-header__actions" }, index.h("wa-select", { key: 'b2325150fb939c3dba6329ba80b9273f2ec1bfa9', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '5de242a91ab086fb040fa0b0b6fcef2fe576944a', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '5d555f84922ee4e2e6d7e6eeb393137c3bb7dda7', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
