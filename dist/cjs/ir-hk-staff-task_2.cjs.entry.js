...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bc217b56a23b0f3e92d6043e16beaf71c0458aa5', class: { 'staff-task--future': this.future } }, index.h("button", { key: '2d1bb01f8745da680a94d2577de0478635759f37', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '8996106dbd3ed4348bb98a24e6e251db4ca6a67a', class: "staff-task__card" }, index.h("div", { key: '677dc7e8975b066c194e7a48dbddb3b7b5a11005', class: "unit-label" }, index.h("span", { key: '852f607079d89594f8fb0618ec42634293605a8d', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: '8463dba930365a39a5b7cb2d45aedcb0bdef8d3b', class: "task-content" }, !this.future && (index.h("div", { key: 'b884f659978f05e441f14763680e4dbb5b866eee', class: "task-status" }, index.h("span", { key: 'f70a2d87530d9b425cbe3f67e431b8d0cd789601', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'a21fec6d0cb67931158ec11dafa7dd48bd6e99aa', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '2228406e9e0f0cb2284452a3ce88b8799c65783a', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '5d202959b7558bf807c53f1f8f4dd5ab1dcb8790', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'ac33e709c9e25791c96688fa0a6a4c1dfce5ac93', class: "task-action" }, index.h("wa-icon", { key: '6fd1e3acc96fca4da6044b57230d7fa7e5948229', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: 'eaa96ed3ae13a9e0359861060a26b3173a0b08dc', class: "tasks-header" }, index.h("div", { key: '35bb36792f14d8d0e1f6be8f88506889b55ce3b5', class: "tasks-header__inner" }, index.h("div", { key: '76a077759e7ababa7899e2ae109f18089ac93ba7', class: "tasks-header__brand" }, index.h("img", { key: 'ac65f2cbbceb8e41997cdb798913d6850354e765', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '63876c1d176dce5b3972055b8a30f5d0ae51fe48', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '36b0b4327da7b11402525d6add0fd5c61493f799', class: "tasks-header__actions" }, index.h("wa-select", { key: 'd1421cf2892e70a845fdd7b5386be2bcfc54fc9a', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "s" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '2af49340c8aad77ceb5260843bd8274c18f6dcfc', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '58061f8f0b29b06282671971fd06bb162c9a3e12', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
