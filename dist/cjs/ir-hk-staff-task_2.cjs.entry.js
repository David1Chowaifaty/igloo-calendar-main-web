...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4fa9c1af694296640068178dd1867e41ece7c70f', class: { 'staff-task--future': this.future } }, index.h("button", { key: '6c047a61baaa2c813133dbfe4a5700b256dbde80', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '0c36cda7d696986050844a4fe7a4a1f559f01652', class: "staff-task__card" }, index.h("div", { key: '2374ff7e6cfb6b8fb2fe6f33bd5cf14d688319e0', class: "unit-label" }, index.h("span", { key: 'ed19fe6c8184a9a74b9cc2a766cf3bac2d001a10', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'a9c06d44786697c766db01c6edf895408138674c', class: "task-content" }, !this.future && (index.h("div", { key: 'cc97462fea1e3376e6557fe30f47b4800ffc929a', class: "task-status" }, index.h("span", { key: '6ef3bbdae5469e5ce3dde78255378fcf75e5e9ed', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '8a6eb8137a8e413b36e727e34168c827c10da1c1', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: 'fc6586ba570a81e5fe8e2de899fb3d7f84a655d0', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '0f91756dd8e8aeb3605650e5f8c1ce43f360dab6', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '10b0c758b9c3ac5db179f2c5d16cd95f143b57ba', class: "task-action" }, index.h("wa-icon", { key: '913fcd5c599598348bc53572f52a17e56a694953', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '391d9b6efbdc02561590a69ba6b5ce7c2abb5871', class: "tasks-header" }, index.h("div", { key: '3f628109388c260c9a93eb60c7189c99592ad0fc', class: "tasks-header__inner" }, index.h("div", { key: '16dcc9dd5f67bbc2ab46c87ce2fa5ab9ed81d68e', class: "tasks-header__brand" }, index.h("img", { key: '83393c1a6ba7238f324284029ac5dc32da897494', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '0aaf1e1f7421db2751cebe66d5c3012033f17c26', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '1a925e0adb4e0f3c235d4566b06f0758440dcc29', class: "tasks-header__actions" }, index.h("wa-select", { key: 'b398b8f5dc10ac2d4bf47a73a4bd895ee16bd073', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: 'feace3565ab8bc485632ff648487c4c447e56bce', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '0f2dd8acb643fda69c5c479c2ab536a1b3589425', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
