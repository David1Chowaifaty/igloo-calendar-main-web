...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e5e539975e47e7b88369e1405ee19c420484f950', class: { 'staff-task--future': this.future } }, index.h("button", { key: '8d6e2dc6d630cab6d8fc407792571510ef98b1f1', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '42b4378341dda8afca86d71d12593a15ba1df439', class: "staff-task__card" }, index.h("div", { key: 'dfcff44d2c813eff35ae7e88017d95f021541afd', class: "unit-label" }, index.h("span", { key: 'a0da15aa506fece35d77050b39387752e1f3b172', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'd3aad0f81b69a7c3c88794b4b9132a524c6c9741', class: "task-content" }, !this.future && (index.h("div", { key: '0a1ae85266fda1926ad08b314c44a0e3188c2e9d', class: "task-status" }, index.h("span", { key: 'a3f25531c522f88d8780f7b2dd7286009508bac6', class: "task-status__label" }, this.task.status.description), index.h("span", { key: 'd907a863fd607c4297f9ddcef97b3abde3b0fa4c', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '4ec800cda7dd96a02c364a889bc19ba7295a48aa', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: 'ee21d5a3b31c472920cef4c494e17ba02b2d0147', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: '513ebc65e29a974ab4a81b83e1a58827149a3cdf', class: "task-action" }, index.h("wa-icon", { key: '3e16e8a99248ea4e3fb0ef546a1e71c55eba741f', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '9a2e1466f0296c3760b1587495e3ebac1e4afd3f', class: "tasks-header" }, index.h("div", { key: '98cc59ecedc2bebdb42fb3a6c6de89823906a12a', class: "tasks-header__inner" }, index.h("div", { key: '347cc287fd9379a6413f6eff603d2987316d06d6', class: "tasks-header__brand" }, index.h("img", { key: '42f8ea7832690a295f374f28a0aded46c165209e', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: 'd675a701d83d210ac17abfdf3a2f64c05cf2f58b', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: '924858faef0773197739f1df2c4bee8cc9b6c5c8', class: "tasks-header__actions" }, index.h("wa-select", { key: '767e991294c19c7b1d9b3d0a823838aeb8471b55', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '56dc3b2e4fdc081796efd8dee3b1ef8979f5285b', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '56ac9f4cd064764db2d31f069371e0f74e16e83a', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
