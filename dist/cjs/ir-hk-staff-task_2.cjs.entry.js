...
const IrHkStaffTask = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4ba0c48b958b816a2b02a1323121978baa28f120', class: { 'staff-task--future': this.future } }, index.h("button", { key: '033be7dde9ae226cb98dc2036e5f740f01f73f87', onClick: () => this.taskClick.emit(this.task), class: "staff-task__button", disabled: this.future }, index.h("wa-card", { key: '0132f9241ad5d2b20529222adfe04f1733e78117', class: "staff-task__card" }, index.h("div", { key: 'c86ee48f55641f589554c5431be4fe087a178444', class: "unit-label" }, index.h("span", { key: '33b5a507e24174db75bcc99737eac1515f67d09f', class: `unit-label__name ${this.unitNameSizeClass(this.task.unit.name)}` }, this.task.unit.name)), index.h("div", { key: 'fe23e1c9ebcc90027b05d0874f32c170ab634184', class: "task-content" }, !this.future && (index.h("div", { key: 'b0d50c19011272dca8619a4225ffb21ac991ccdc', class: "task-status" }, index.h("span", { key: '144fe970210434abede711b5bcef45951b582818', class: "task-status__label" }, this.task.status.description), index.h("span", { key: '2788f513d1797d6356943a442b87cab9885186e1', class: "task-status__hint" }, this.task.hint))), index.h("div", { key: '1452410bb7368e162a3fde129f426bb573461a23', class: "task-badges" }, [this.task, ...(this.task.extra_task ?? [])].map(t => (index.h("wa-badge", { key: t.task_type.code, variant: this.badgeVariant(t.task_type.code), appearance: "filled" }, t.task_type.description)))), !this.future && this.guests.length > 0 && (index.h("div", { key: '3b1dc3caadc0161ab44e0256136eb0c64a2afd0c', class: "task-guests", style: { paddingLeft: '1px' } }, this.guests.map(g => (index.h("div", { key: g.label, class: "task-guest" }, index.h("span", { class: "task-guest__count" }, g.count), g.label === 'adults' ? (index.h("wa-icon", { name: "person", class: "task-guest__label" })) : g.label === 'children' ? (index.h("wa-icon", { name: "child", class: "task-guest__label" })) : (index.h("wa-icon", { name: "baby-carriage", class: "task-guest__label" })))))))), !this.future && (index.h("div", { key: 'e9759063d17098b505604c53c4834d08d1d5296f', class: "task-action" }, index.h("wa-icon", { key: '7ea81311cf636ddb94be5c4a35b7740fa87e584b', name: "broom" })))))));
    }
};
...
const IrHkStaffTasksHeader = class {
    ...
    render() {
        return (index.h("header", { key: '5ded96671330aa11393a18778cc03a6276b20ef2', class: "tasks-header" }, index.h("div", { key: '3d4226622f132ee66fd903019146ed047bdc97f9', class: "tasks-header__inner" }, index.h("div", { key: '61fef89d902400cc7e71a0bc1c0b881e033a91f4', class: "tasks-header__brand" }, index.h("img", { key: '3861957004c9cfe8fb428e2f8d218fd38891e908', class: "tasks-header__logo", src: "https://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "IglooRooms logo" }), index.h("span", { key: '3dbbd88b15853cae9134516d80b6c17b10671170', class: "tasks-header__name" }, this.connectedHK.NAME)), index.h("div", { key: 'a9e704182061e928cca51c1823a099eebc34140d', class: "tasks-header__actions" }, index.h("wa-select", { key: 'eda62a07e1610a01d1915c8a69b374baddae3637', onchange: this.handleWaChange, defaultValue: this.language, value: this.language, size: "small" }, LANGUAGE_OPTIONS.map(opt => (index.h("wa-option", { key: opt.value, value: opt.value }, opt.label)))), index.h("ir-custom-button", { key: '9828364055bec4530ccf2e12d5413fb8fc642518', onClick: () => (window.location.href = 'Logout.aspx'), variant: "danger", appearance: "plain" }, index.h("wa-icon", { key: '3947202e17af7c94e75b945fa2e9c2d3fa82175d', name: "arrow-right-from-bracket", style: { fontSize: '1.2rem' } }))))));
    }
};
