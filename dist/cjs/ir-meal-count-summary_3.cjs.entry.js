...
const IrMealReportFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: '66d16e2652fb35c7873e3f469f6f7d4204c59079' }, index.h("wa-radio-group", { key: '9fec740f7667bb9fc6ba97fb19ce898b9c6f242b', label: t.t('Lcz_ReportType', { fallback: 'Report type' }), size: "s", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, index.h("wa-radio", { key: '4d6241fd2b85ec215f28e54ac6d633bfb7fba18b', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, t.t('Lcz_GuestList', { fallback: 'Guest list' })), index.h("wa-radio", { key: 'f08169fd96064b65f8711d6b014495c42bd9c013', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, t.t('Lcz_MealCount', { fallback: 'Meal count' }))), this.reportType === 'GUEST_LIST' ? (index.h("wa-radio-group", { label: t.t('Lcz_StayDate', { fallback: 'Stay date' }), size: "s", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            } }, t.t('Lcz_Reset', { fallback: 'Reset' })), index.h("ir-custom-button", { key: 'bd672c30ab2d352092bfda9e190c58b82a62f186', type: "button", size: "s", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
