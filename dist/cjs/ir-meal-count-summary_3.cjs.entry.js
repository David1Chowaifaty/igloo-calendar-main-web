...
const IrMealGuestList = class {
    ...
    columns = [
        ...
        this.columnHelper.accessor(row => `${row.guest.first_name} ${row.guest.last_name}`.trim(), {
            ...
            header: 'Guest name',
            enableSorting: false,
            cell: info => (index.h("div", { class: "meal-guest-list__guest" }, index.h("span", null, info.getValue()), info.row.original.is_arriving_today && (index.h("wa-badge", { variant: "brand", appearance: "filled", pill: true }, "Same day arrival")))),
        }),
...
const IrMealReportFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: '0532ef8923362698f8ec2678518e5499be4e825b' }, index.h("wa-radio-group", { key: '16625e7badeda3fdaffc318513cf1911ffe06e74', label: "Report type", size: "s", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, index.h("wa-radio", { key: 'dfc3e6458a55fb5536ce5f3e46c630f1fade6047', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, "Guest list"), index.h("wa-radio", { key: 'c40a6f91437ca89736dd921803ca4768bcc01dca', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, "Meal count")), this.reportType === 'GUEST_LIST' ? (index.h("wa-radio-group", { label: "Stay date", size: "s", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            (mealTypes.length > 0 ? (index.h("wa-radio-group", { defaultValue: this.mealType, label: "Meal type", size: "s", orientation: "horizontal", value: this.mealType, style: { width: '100%' }, onchange: e => {
                ...
                } }, mealTypes.map(type => (index.h("wa-radio", { style: { flex: '1' }, appearance: "button", value: type.CODE_NAME }, type.CODE_VALUE_EN))))) : (index.h("div", { class: "ir-meal-report-filters__warning" }, "No meal types found."))), index.h("div", { key: '51cd50b9756c16f766d9ec59cda2b7324da6f8aa', slot: "footer" }, index.h("ir-custom-button", { key: '0b8783483c20d9e8879362158a6742ee6513fa28', type: "button", size: "s", variant: "neutral", appearance: "filled", onClickHandler: (e) => {
                const ev = e.detail;
            ...
            } }, this.lcz.Lcz_Reset || 'Reset'), index.h("ir-custom-button", { key: '565557515ce49c2a781d3dd45798d85912ce5243', type: "button", size: "s", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
