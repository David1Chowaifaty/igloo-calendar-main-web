...
const IrBookingNewForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '237b023747a2fb5b78e908fcf31e3f4bcddbc4f8' }, index.h("div", { key: '46c895333ccbaee843befdec06d26569e24cfb32', onClick: () => {
                this.handleTriggerClicked();
            } }, index.h("slot", { key: 'e42813c302ad98c4123168babfc8c610670a0827', name: "trigger" }, index.h("ir-custom-button", { key: 'c277b20a8f4d6bbeda2e262b4269173c5da45edd', appearance: "plain", variant: "brand" }, index.h("wa-icon", { key: 'fb8f93894f04bb35420f1f185bab76ae1030c5c3', name: "circle-plus", style: { fontSize: '1.2rem' } })))), index.h("ir-booking-editor-drawer", { key: '78b65892d172f6ddcabb13dfc40b10c292df8c1e', onBookingEditorClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrListingHeader = class {
    ...
    render() {
        ...
        //   </ir-custom-button>
        // </igl-book-property-container>
        index.h("ir-booking-new-form", { key: 'dc7f3c23b16a53c89298bf680bcb8ef7501b7d1f', propertyid: this.propertyId, language: this.language, ticket: booking_listing_service.booking_listing.token })))), index.h("h3", { key: 'e8a2bcb090e72675e3fe581faac5a77943e7391e', class: "d-none d-md-block page-title" }, locales_store.locales.entries?.Lcz_Bookings), index.h("div", { key: '660b024bbb50fc393e32e68a004bdb0926dcf222',
            // onSubmit={e => {
            //   e.preventDefault();
            //   console.log(this.inputValue);
            //   this.handleSearchClicked(false);
            // }}
            class: "booking-search-field width-fill" }, index.h("ir-input", { key: '3714ce40c570571d5629929224c436ec85526dd6', class: 'flex-fill w-100', value: this.inputValue, onKeyDown: e => {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    this.handleSearchClicked(false);
                }
            }, "onText-change": e => (this.inputValue = e.detail), size: "small", placeholder: locales_store.locales.entries?.Lcz_FindBookNbrorName }, index.h("wa-icon", { key: 'dd09968033463a131bed63721a8afe69cceb93c3', name: "magnifying-glass", slot: "start" })), index.h("h5", { key: '35a0744e72371cc2209ef58dc7575cc7544eeea3', class: "m-0 font-weight-bold d-none d-sm-block" }, locales_store.locales.entries?.Lcz_Or))), index.h("div", { key: '75cf00d9d4ae92192396d935172f0577c8aeca62', class: "d-none d-md-block" }, index.h("wa-tooltip", { key: '081fead1f8f084b916fe23668481586dfcae9214', for: "new-booking" }, "Create new booking"), !havePrivilege && (
        // <igl-book-property-container
        //   p={this.p}
        //   withIrToastAndInterceptor={false}
        //   propertyid={this.propertyId}
        ...
        // </igl-book-property-container>
        index.h("ir-booking-new-form", { key: 'a8c6d050999ae82a8a08de7dc67367d9f52c6781', propertyid: this.propertyId, language: this.language, ticket: booking_listing_service.booking_listing.token })))), index.h("section", { key: '5365ab2b79f546b09d86ddbaf8e7efd85da7b6af', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '07164c477c40be2c405661f490fbc82cdb41edf3' }), index.h("h5", { key: 'f4b49acd5df7418f2456ffe6d4d58382ca7af9af', class: "m-0 font-weight-bold" }, locales_store.locales.entries?.Lcz_Or), index.h("span", { key: '1bd5e530e769938aabd95e9e45262fe5f1ecdf28' })), index.h("section", { key: '0e65b45356636bc4bc7056453fbb469d83b2b695', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("wa-select", { key: '756e706a427c181f62b5710381b2069a7e07f5b6', onchange: e => {
                booking_listing_service.updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.filter_type?.toString(), size: "small", defaultValue: booking_listing_service.booking_listing?.types[0]?.id?.toString() }, booking_listing_service.booking_listing?.types.map(b => (index.h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), index.h("ir-range-picker", { key: '691be17ae9b91a4158c88af3261d7e3fe4e77fdd', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, allowNullDates: false, fromDate: moment.hooks(booking_listing_service.booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: moment.hooks(booking_listing_service.booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("wa-select", { key: 'c9e5e3082730d826f3ca3c4347ccfb1662fa16cb', onchange: e => {
                booking_listing_service.updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.booking_status, size: "small", defaultValue: booking_listing_service.booking_listing?.statuses[0]?.code }, booking_listing_service.booking_listing?.statuses.map(b => (index.h("wa-option", { key: b.code, value: b.code }, b.name)))), !utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && (index.h("wa-select", { key: '90a3cdd32bd5b147c92862d247f19e6abbd22efa', onchange: e => {
                booking_listing_service.updateUserSelection('channel', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.channel, size: "small", defaultValue: booking_listing_service.booking_listing.userSelection.channel }, index.h("wa-option", { key: '28cd57fec6cd71491863b640e954d131ed0f8f4e', value: "" }, "All channels"), booking_listing_service.booking_listing?.channels.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name))))), index.h("wa-select", { key: '937e48b8de092aa15ddf2efc8440fd0e48333ff6', onchange: e => {
                booking_listing_service.updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.balance_filter, size: "small", defaultValue: booking_listing_service.booking_listing?.balance_filter[0]?.value }, booking_listing_service.booking_listing?.balance_filter.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name)))), index.h("div", { key: '89cca7cb24faf87ebd9fea00d55c4271667f103f', class: "d-flex flex-fill align-items-end m-0" }, index.h("wa-tooltip", { key: 'b7922ab7bf71f3b3f442f5bc8ced7f69f3563c6e', for: "search-btn" }, locales_store.locales.entries?.Lcz_Search), index.h("ir-custom-button", { key: 'cf45713d7625e410b0771be1d90cdff9f6b1972f', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, index.h("wa-icon", { key: '9c82c3b408c91ab83c3e540004c4385cba415ac3', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: 'b9b702b59c791a5269e6fe40fb118148f1874d45', for: "clear-btn" }, locales_store.locales.entries?.Lcz_Erase), index.h("ir-custom-button", { key: '85cbc665c9c4ee79c2629a247536d33779c6a155', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, index.h("wa-icon", { key: '80f2be7e37606dcacc7bfb4bb48443f93a291e58', name: "eraser", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '2a291b017b215630d9c0f2f91a5024ecb6661042', for: "excel-btn" }, locales_store.locales.entries?.Lcz_ExportToExcel), index.h("ir-custom-button", { key: '7c20691ce7695f2bf5093628a4592ac3597829e2', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, index.h("wa-icon", { key: '87e0132516d087416723f98870ee9f251965d8ef', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
