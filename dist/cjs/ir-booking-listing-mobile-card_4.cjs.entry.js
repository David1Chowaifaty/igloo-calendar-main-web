...
const IrBookingListingTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5824a775169ac1a974610728b2481ec1742f8132' }, index.h("div", { key: '33f7466558487812f5a0f5987192796f36ad46ea', class: "table--container" }, index.h("table", { key: '419e638964bfa1f3304a74a006c4b3f8f8af3e2b', class: "table data-table" }, index.h("thead", { key: '2f0814423a9b367323dd781f413c587ec5d83786' }, index.h("tr", { key: 'c68ed6f11c085d67ce09d796ae080f5da17961ed' }, utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && index.h("th", { key: 'd1576aa939d3e93ca320589e54d6781a5ad282c7', class: "text-left" }, "Property"), index.h("th", { key: '8dcdba219953be2174ef576b4b3703aa3597864f' }, index.h("span", { key: 'b5751bb862c4a1122233db87de0aaf1eaca5d924', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: '58be4c261b4824ce8301cbf46ce510191db42e66' }, "Booked on"), index.h("th", { key: 'dc87c4efc96daac5b7c4fa1ed0348d46c19367c7' }, index.h("div", { key: '41a257a2ea62b3ea9c5684e6d94bc1503331fdd0' }, index.h("p", { key: '131dffb2a2fd6b21bb1ed8f927cc4d6545fa613d' }, "Booked by"))), index.h("th", { key: '930c9afb04a51984cc98f611ee9230854bcd1a26' }, "Dates"), index.h("th", { key: 'dde14f5f3c306fefef47f59df12064a92a08bb8a' }, "Services"), index.h("th", { key: '957d0c7e71a11d43ca0ef6f680842cd16d9794de', class: "text-center" }, index.h("p", { key: '1a23a61cd74a4e061fb4f6692fa388248b42d099' }, "Amount "), index.h("wa-tooltip", { key: '7c4c26b2010afcdd07cac22f7d82a2577c21e7ac', for: "balance-info" }, "Booking balance click to settle."), index.h("div", { key: '44bcb988e8823e30aae25fa536c3e48a45b26b54', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: 'cb365144daec9156b1e8d5a0de3209f113da6d28', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Balance"))), index.h("th", { key: '3ea6c318f6fe1f264a6005242f373357a1f9e981', class: "text-center" }, "Status"), index.h("th", { key: '6e8d10bb4c0d839a11fea0ecc82ad134d4372e45' }))), index.h("tbody", { key: 'c7ad8d76b855da4b5bfe246d344ba5e68dbd17f6' }, booking_listing_service.booking_listing.bookings.length === 0 && (index.h("tr", { key: '8f1440e045f60f3285e6d8cd4734a9c505ea115a' }, index.h("td", { key: '6c8e7e014067b0cb228e1137731a601df3c3bed6', colSpan: utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) ? 9 : 8, class: "empty-row" }, "No bookings found"))), booking_listing_service.booking_listing.bookings?.map(booking => this.renderRow(booking))))), index.h("div", { key: 'e5a22507ff096cdc51a09bcac5b46daf3d42618c', class: "card--container" }, booking_listing_service.booking_listing.bookings.map(booking => {
            ...
            return (index.h("ir-booking-listing-mobile-card", { key: rowKey, booking: booking, totalPersons: totalPersons, lastManipulation: lastManipulation, extraServicesLabel: locales_store.locales.entries.Lcz_ExtraServices, onIrBookingCardAction: event => {
        ...
        })), pagination.totalRecords > 0 && (index.h("ir-pagination", { key: '6b6a4d98a9c6e5d990ffa8468c8978117ed0e5e9', class: "data-table--pagination", showing: pagination.showing, total: pagination.totalRecords, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })), canLoadMore && (index.h("ir-custom-button", { key: '17e2fe446fdc037df02728a0c30e85c977258f6d', class: "booking-listing__load-more", variant: "brand", appearance: "outlined", loading: this.isLoadMoreLoading, disabled: this.isLoadMoreLoading, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.loadMoreBookings();
            } }, "Load more")), index.h("ir-dialog", { key: '2f2f41bf6e97b48394f8d3f2717aad47ff4043c8', label: "Delete", open: !!this.booking_nbr, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.booking_nbr = null;
            }, lightDismiss: false }, index.h("span", { key: 'ad3bd070cf8fba4847ffabd95768b28d9f40b7fe' }, locales_store.locales.entries.Lcz_SureYouWantToDeleteBookingNbr + this.booking_nbr), index.h("div", { key: 'ad31ffb653fa670438224c4c9f245d7252d290d6', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '84d9aa37972f71725f715840e0a07a367b3e4f95', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'eb5ee10581e3c9713074b63edce2d828347c2055', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.deleteBooking();
...
const IrBookingNewForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e47c0beb103b3fa2da11e9411ed2b345ff67f4c6' }, index.h("div", { key: 'dd80ff44b3206a2c0e56376e9c70cba54f5a92b0', onClick: () => {
                this.handleTriggerClicked();
            } }, index.h("slot", { key: '1594ab753b9796a466f9619142467e9e7c9f3e19', name: "trigger" }, index.h("ir-custom-button", { key: 'fbc76030d631abb16706828bedd7066239666503', appearance: "plain", variant: "brand" }, index.h("wa-icon", { key: 'ff725f3865bb6302c476ee82965d85dd9e6dfcb5', name: "circle-plus", style: { fontSize: '1.2rem' } })))), index.h("ir-booking-editor-drawer", { key: 'deb74c9c9a958b4701cad765843496c8ef23bb67', onBookingEditorClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '168977cccd03c0b71e4678a60c18ed986a656910' }, index.h("section", { key: 'a5955b0f7a1b246bf08a035f5c655d06983336a2', class: "d-flex align-items-center " }, index.h("div", { key: 'b28eab2fa39f5f99751c379aac8b49898ee25f6c', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '9afad244743d2be7c0eabeb78f7212025d55180f', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '2417ea7322294db4c7ea3719f40fdbcf6251b5db', class: "page-title" }, locales_store.locales.entries?.Lcz_Bookings), index.h("div", { key: 'aafa105a489d582617bf307fc49ca62bd2a3566a' }, !havePrivilege && (
        ...
        //   </ir-custom-button>
        // </igl-book-property-container>
        index.h("ir-booking-new-form", { key: 'c79363f0476fd111cc7b642cd4e61f812fe824da', propertyid: this.propertyId, language: this.language, ticket: booking_listing_service.booking_listing.token })))), index.h("h3", { key: 'e9579e4597771e0156f656abd685906f4c29b609', class: "d-none d-md-block page-title" }, locales_store.locales.entries?.Lcz_Bookings), index.h("div", { key: '3b71aeecb0bb901ed4bed0b87fcfdad5e216a3a9',
            // onSubmit={e => {
            //   e.preventDefault();
            //   console.log(this.inputValue);
            //   this.handleSearchClicked(false);
            // }}
            class: "booking-search-field width-fill" }, index.h("ir-input", { key: '013326a4067f46884152b94c68a99221e933f3c4', class: 'flex-fill w-100', value: this.inputValue, onKeyDown: e => {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    this.handleSearchClicked(false);
                }
            }, "onText-change": e => (this.inputValue = e.detail), size: "small", placeholder: locales_store.locales.entries?.Lcz_FindBookNbrorName }, index.h("wa-icon", { key: '756e1f7de15cd4e5c5d41e4eb57787294d5153be', name: "magnifying-glass", slot: "start" })), index.h("h5", { key: '13aadf5ca1895e255662bd949aa8d52a2ca2c0de', class: "m-0 font-weight-bold d-none d-sm-block" }, locales_store.locales.entries?.Lcz_Or))), index.h("div", { key: '78df9234e700bac9ce8afc8438a5f4c560dfe0a7', class: "d-none d-md-block" }, index.h("wa-tooltip", { key: 'f9242fcea73fc06dc961bd419fecaecdae4e7f5b', for: "new-booking" }, "Create new booking"), !havePrivilege && (
        // <igl-book-property-container
        //   p={this.p}
        //   withIrToastAndInterceptor={false}
        //   propertyid={this.propertyId}
        ...
        // </igl-book-property-container>
        index.h("ir-booking-new-form", { key: '4604f2442eed6a16bb24125a2d28a3b60cd0c6c4', propertyid: this.propertyId, language: this.language, ticket: booking_listing_service.booking_listing.token })))), index.h("section", { key: '3f4da06ffe1edcb0557729f7d78a96a0582da619', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '5548bcb186869767d476135119fe3cae7100e740' }), index.h("h5", { key: 'b68ac4fc854cf7108051c6ca0eced34af87c867a', class: "m-0 font-weight-bold" }, locales_store.locales.entries?.Lcz_Or), index.h("span", { key: 'e95ac7935ed23a57cb193f0980667a907236e35a' })), index.h("section", { key: 'e1940476bea185dca00afb20088540f95451fc80', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("wa-select", { key: 'e9e53f5fe7cfc2bb8ddfedf74fe11e96230d0031', onchange: e => {
                booking_listing_service.updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.filter_type?.toString(), size: "small", defaultValue: booking_listing_service.booking_listing?.types[0]?.id?.toString() }, booking_listing_service.booking_listing?.types.map(b => (index.h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), index.h("ir-range-picker", { key: '58ca5ee236798ac03cc21e5cf47a044a7310529b', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, allowNullDates: false, fromDate: moment.hooks(booking_listing_service.booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: moment.hooks(booking_listing_service.booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("wa-select", { key: '84a130febdfd0a5e496cbec40804860ad809f8a9', onchange: e => {
                booking_listing_service.updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.booking_status, size: "small", defaultValue: booking_listing_service.booking_listing?.statuses[0]?.code }, booking_listing_service.booking_listing?.statuses.map(b => (index.h("wa-option", { key: b.code, value: b.code }, b.name)))), !utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && (index.h("wa-select", { key: 'e84f4d267f4d691c0201f938511d93416cecd061', onchange: e => {
                booking_listing_service.updateUserSelection('channel', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.channel, size: "small", defaultValue: booking_listing_service.booking_listing.userSelection.channel }, index.h("wa-option", { key: '30cc5b66ce366c7997e36d5f7195445ab93e5ebd', value: "" }, "All channels"), booking_listing_service.booking_listing?.channels.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name))))), index.h("wa-select", { key: 'a35ef23e409ac514cd3216dc903c877a125d52ea', onchange: e => {
                booking_listing_service.updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.balance_filter, size: "small", defaultValue: booking_listing_service.booking_listing?.balance_filter[0]?.value }, booking_listing_service.booking_listing?.balance_filter.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name)))), index.h("div", { key: '48c2c0b73c9f95e26c586641a12dab7fc94d3d77', class: "d-flex flex-fill align-items-end m-0" }, index.h("wa-tooltip", { key: 'acf4869dac35d5801020aff43a5e39f0ac12119d', for: "search-btn" }, locales_store.locales.entries?.Lcz_Search), index.h("ir-custom-button", { key: '468d0d03397ba9155e46a7d48430e5101a929349', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, index.h("wa-icon", { key: 'efcd329bd800d54f6911ffdbf67c26cbce25ae12', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '2936da4b23371ba3a735d8ef134c41c7a06199b6', for: "clear-btn" }, locales_store.locales.entries?.Lcz_Erase), index.h("ir-custom-button", { key: '82f6d9e12541b55464392db1ba0532ff084bf492', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, index.h("wa-icon", { key: 'f7e3a8f9b682e820b5ee5b7ce853d18123a25a14', name: "eraser", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '6e457696b371133ae44b04f2dbc3549d3cf6045b', for: "excel-btn" }, locales_store.locales.entries?.Lcz_ExportToExcel), index.h("ir-custom-button", { key: '6cd3a35fe33b104059617f1d87a1a8d9a851aaaa', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, index.h("wa-icon", { key: 'f0ebcc457fa4594f367bf33aa1a7f1bbae590f98', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
