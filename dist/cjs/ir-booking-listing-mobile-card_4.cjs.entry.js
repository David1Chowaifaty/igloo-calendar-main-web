...
const IrBookingNewForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2afa02d820c7ec1046c0d2424da653d6d19977fd' }, index.h("div", { key: 'df94b33b046999fdf2fdb8c3ded0b336269a97a6', onClick: () => {
                this.handleTriggerClicked();
            } }, index.h("slot", { key: '1ba6f0625bc5ae06721b4b3dd6d80bb452990c0f', name: "trigger" }, index.h("ir-custom-button", { key: '70b3eab63c6fb820ab2988780966605955b15ab5', appearance: "plain", variant: "brand" }, index.h("wa-icon", { key: '9c867f972a9173ba29ee1daa5875b9d759730932', name: "circle-plus", style: { fontSize: '1.2rem' } })))), index.h("ir-booking-editor-drawer", { key: '5153fe3e72a91fc04c37f94cce67397095784506', onBookingEditorClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
