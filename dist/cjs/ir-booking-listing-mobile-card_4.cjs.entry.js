...
const IrBookingListingTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a4dccf8603caec5414ae56533e7a924688073f01' }, index.h("div", { key: 'ecd10c88e5bfc98775147eee2f07f3c2edf9f0a1', class: "table--container" }, index.h("table", { key: '53133631e69ccbd3d5f96eace08dd89f47d6f315', class: "table data-table" }, index.h("thead", { key: 'bab828c2c7c8334e472be8c8e27b3d3cfe15f137' }, index.h("tr", { key: 'cfa70bbb9ade44fbbd21f416b34cac01c1502760' }, utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && index.h("th", { key: '2f9b719c8736794f6f6c916731567b2a10d0de61', class: "text-left" }, "Property"), index.h("th", { key: '4e6c04867bd024efdb06f76dc66338bc7431af07' }, index.h("span", { key: 'bf139c7e782051b571308cc5a8402f9fa4569411', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: '7ca3ed914db71844776ef45625a869ae6caec11c' }, "Booked on"), index.h("th", { key: 'd6a9a82ae3cbd3c018127956784e7993fec00427' }, index.h("div", { key: '12ed67f2db3d2bbc7ac17c90a8d01e9262ef2ea8' }, index.h("p", { key: '627d6606e31143d697dfd6704f7a87c1b2909cf7' }, "Booked by"))), index.h("th", { key: '1901b5c6186ec0aac57328c4f879fa208f00c650' }, "Dates"), index.h("th", { key: '2b01ec3b928273313c2e2bb572dc5093ced479bc' }, "Services"), index.h("th", { key: '4c2d9a3246211eeb46654e25ff55b66434545e9a', class: "text-center" }, index.h("p", { key: '8a5d8b25af6080b3b718f9ec1fbbcff8346b1c33' }, "Amount "), index.h("wa-tooltip", { key: '138b7dc1238cdc9e191a7df618c52d5bf226bcc3', for: "balance-info" }, "Booking balance click to settle."), index.h("div", { key: '6e073753bdfb21643578d8c5324bc39a8063c97f', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: 'c87740eb9df73e91b8b5570f0256a021f229a5a4', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Balance"))), index.h("th", { key: 'bcaf5e946eb670c95506d2efd475fa0c8d733f80', class: "text-center" }, "Status"), index.h("th", { key: '0fc5d96e5a065a874c604424193499dcc1646ce2' }))), index.h("tbody", { key: '668ac63c56a99ffcf8d40474674131c5ac62140d' }, booking_listing_service.booking_listing.bookings.length === 0 && (index.h("tr", { key: 'b5a7bec5d26e97df2af7750598a66c9a2edfe2c5' }, index.h("td", { key: 'ad1fa48c8a2911b78a171e7d253ebc351c588d13', colSpan: utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) ? 9 : 8, class: "empty-row" }, "No bookings found"))), booking_listing_service.booking_listing.bookings?.map(booking => this.renderRow(booking))))), index.h("div", { key: 'cbb00f52d2de03521241d581b590c3b15811ccae', class: "card--container" }, booking_listing_service.booking_listing.bookings.map(booking => {
            ...
            return (index.h("ir-booking-listing-mobile-card", { key: rowKey, booking: booking, totalPersons: totalPersons, lastManipulation: lastManipulation, extraServicesLabel: locales_store.locales.entries.Lcz_ExtraServices, onIrBookingCardAction: event => {
        ...
        })), pagination.totalRecords > 0 && (index.h("ir-pagination", { key: '55f506dd008430a8f2996f5becfd7ddcd8a696b6', class: "data-table--pagination", showing: pagination.showing, total: pagination.totalRecords, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })), canLoadMore && (index.h("ir-custom-button", { key: 'f4178ac7ee37729b5e65963314d0831069ed8939', class: "booking-listing__load-more", variant: "brand", appearance: "outlined", loading: this.isLoadMoreLoading, disabled: this.isLoadMoreLoading, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.loadMoreBookings();
            } }, "Load more")), index.h("ir-dialog", { key: 'f3b4da6ccec7e4353bc2f756555441bae43b0749', label: "Delete", open: !!this.booking_nbr, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.booking_nbr = null;
            }, lightDismiss: false }, index.h("span", { key: 'd0c0c7fae8c0682b77472c54312935ca80808167' }, locales_store.locales.entries.Lcz_SureYouWantToDeleteBookingNbr + this.booking_nbr), index.h("div", { key: 'be865e2d6b2af7912f82dcbcf0e39ee14869536e', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '3c91a3ba02cad68f00adc97248d4fb370601ddb3', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '95262f021950d0476ab459b6b218a4f18a1a5ce0', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.deleteBooking();
...
const IrBookingNewForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0649786629a0f16c90b5f91f6ad2a601b66a7c2a' }, index.h("div", { key: '747c1be1d6053fbbf3f4760abb313547c63c4881', onClick: () => {
                this.handleTriggerClicked();
            } }, index.h("slot", { key: '45c75a0cc8b3bbc8d629df21d890448804d5d979', name: "trigger" }, index.h("ir-custom-button", { key: 'ebd332682df87f3427de550f09e6409505347c69', appearance: "plain", variant: "brand" }, index.h("wa-icon", { key: '2623ca5decf3e5d5472ec02ff905f4d20e48fb7f', name: "circle-plus", style: { fontSize: '1.2rem' } })))), index.h("ir-booking-editor-drawer", { key: '1e7366d077799665d12def013cafbd85fc372624', onBookingEditorClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4fa748704bf41e708718bd4ceb5fe0396807abfb' }, index.h("section", { key: '55880a00f440b586ff765f6ed8596b98ede236de', class: "d-flex align-items-center " }, index.h("div", { key: '91f0f69e969c8c4e35151de90be6fed2456c7dcd', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'b65037bb5c2b53b30fee54003f08872e774a514f', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '799b97966c7e5d759ba401f484f59b3ebe74b6dd', class: "page-title" }, locales_store.locales.entries?.Lcz_Bookings), index.h("div", { key: '743c1a997c5968ff79152f7a257fe08e8c493c6d' }, !havePrivilege && (
        ...
        //   </ir-custom-button>
        // </igl-book-property-container>
        index.h("ir-booking-new-form", { key: '9022e49ba38bfb8bccca938c351aa111da3c7125', propertyid: this.propertyId, language: this.language, ticket: booking_listing_service.booking_listing.token })))), index.h("h3", { key: '03056220ac8138b55c5769469af8e4735651a98a', class: "d-none d-md-block page-title" }, locales_store.locales.entries?.Lcz_Bookings), index.h("div", { key: 'bab221eed57c979685558250e6441be1dd49cf45',
            // onSubmit={e => {
            //   e.preventDefault();
            //   console.log(this.inputValue);
            //   this.handleSearchClicked(false);
            // }}
            class: "booking-search-field width-fill" }, index.h("ir-input", { key: '5660ca7b61017ad67c98a0112cdc9b7923e5eded', class: 'flex-fill w-100', value: this.inputValue, onKeyDown: e => {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    this.handleSearchClicked(false);
                }
            }, "onText-change": e => (this.inputValue = e.detail), size: "small", placeholder: locales_store.locales.entries?.Lcz_FindBookNbrorName }, index.h("wa-icon", { key: 'fb226d1219294fd968534a0f9f657000d60fddfd', name: "magnifying-glass", slot: "start" })), index.h("h5", { key: 'cde7473b57b957b91f6f416144059d70cf875284', class: "m-0 font-weight-bold d-none d-sm-block" }, locales_store.locales.entries?.Lcz_Or))), index.h("div", { key: '594b77ff0d324c4070c7e79c286dc82c4fb94ae7', class: "d-none d-md-block" }, index.h("wa-tooltip", { key: '893fe695dc29313ecf5e5200af22d9b2fe43ccad', for: "new-booking" }, "Create new booking"), !havePrivilege && (
        // <igl-book-property-container
        //   p={this.p}
        //   withIrToastAndInterceptor={false}
        //   propertyid={this.propertyId}
        ...
        // </igl-book-property-container>
        index.h("ir-booking-new-form", { key: 'aa15681794200bc703bc4dda737db83450a6216b', propertyid: this.propertyId, language: this.language, ticket: booking_listing_service.booking_listing.token })))), index.h("section", { key: 'c4dc3abc9c34c6cb5bcc5e2d4c0def69e096de47', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '77ab0e06a247300931fcadd9a3b1dc2ce115fee1' }), index.h("h5", { key: 'e02830f73bf2fda196cb9ba8cef28433d723db19', class: "m-0 font-weight-bold" }, locales_store.locales.entries?.Lcz_Or), index.h("span", { key: '8c2e2737d4761a61f86250e748c4869e6703cff1' })), index.h("section", { key: 'b2676ec475f5f903fcf4db1375f129bfcee1f824', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("wa-select", { key: '28b1988fe58fcc73d23591a2ce7d5984d77222b1', onchange: e => {
                booking_listing_service.updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.filter_type?.toString(), size: "small", defaultValue: booking_listing_service.booking_listing?.types[0]?.id?.toString() }, booking_listing_service.booking_listing?.types.map(b => (index.h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), index.h("ir-range-picker", { key: '9683ef4417578314c50c6d33bb383071453149df', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, allowNullDates: false, fromDate: moment.hooks(booking_listing_service.booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: moment.hooks(booking_listing_service.booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("wa-select", { key: '3f20ad72882f30d2368c661167638ad1fd454afc', onchange: e => {
                booking_listing_service.updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.booking_status, size: "small", defaultValue: booking_listing_service.booking_listing?.statuses[0]?.code }, booking_listing_service.booking_listing?.statuses.map(b => (index.h("wa-option", { key: b.code, value: b.code }, b.name)))), !utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && (index.h("wa-select", { key: 'f4b59c943e9a48f48144c97fb14fef7f12e21ff8', onchange: e => {
                booking_listing_service.updateUserSelection('channel', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.channel, size: "small", defaultValue: booking_listing_service.booking_listing.userSelection.channel }, index.h("wa-option", { key: 'bc7e0428c7ff151332a1114e38e37650bdc55b39', value: "" }, "All channels"), booking_listing_service.booking_listing?.channels.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name))))), index.h("wa-select", { key: '00402b312998614e7887fb4a19d6d2e71e6de9a5', onchange: e => {
                booking_listing_service.updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.balance_filter, size: "small", defaultValue: booking_listing_service.booking_listing?.balance_filter[0]?.value }, booking_listing_service.booking_listing?.balance_filter.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name)))), index.h("div", { key: 'fa41838c6b2c0dde16274c001aa080aaf566d94d', class: "d-flex flex-fill align-items-end m-0" }, index.h("wa-tooltip", { key: '31c93d1fb4d82f1e4d830af3397b45271a0817cc', for: "search-btn" }, locales_store.locales.entries?.Lcz_Search), index.h("ir-custom-button", { key: 'a3b8cdebe1de748352b47dc085bec8847f1c9b8d', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, index.h("wa-icon", { key: '9027ce0211fc957d957923d2c54e79608c261a1b', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '2461a95bd3fd6e145132064b1ea4704ba3fc5611', for: "clear-btn" }, locales_store.locales.entries?.Lcz_Erase), index.h("ir-custom-button", { key: '066fe6a9399a981fd171d525bf61eb1cc4b86c11', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, index.h("wa-icon", { key: '47c8797134f14361cd3bd9fe5100a02fad3ca777', name: "eraser", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '6a4abdc01988cc5e98b74b5aa24b959e194743dc', for: "excel-btn" }, locales_store.locales.entries?.Lcz_ExportToExcel), index.h("ir-custom-button", { key: '6c9fcd8b9192f1ed8df30f0fcaf808bd8ecc5e32', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, index.h("wa-icon", { key: '8590aa9de352af2481ba2e1f5978f14540a6ffab', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
