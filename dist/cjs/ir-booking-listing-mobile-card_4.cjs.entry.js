...
const IrBookingNewForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bb99286fab5417d263ff877119305b9f2f636792' }, index.h("div", { key: 'a96ee1dad02d945c1d449cc2ffe50c8398bb89ba', onClick: () => {
                this.handleTriggerClicked();
            } }, index.h("slot", { key: '771c9c44a39f71f27405bff88ab5fd949a1b78eb', name: "trigger" }, index.h("ir-custom-button", { key: '9ff6a67824f0453ce5883fdce147fedc1f517819', appearance: "plain", variant: "brand" }, index.h("wa-icon", { key: 'e0dec258027a2488e01edb2000565370f7e4aa1a', name: "circle-plus", style: { fontSize: '1.2rem' } })))), index.h("ir-booking-editor-drawer", { key: '962fc27ed2a348e21c83a5907ea68de56cc468da', onBookingEditorClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrListingHeader = class {
    ...
    render() {
        ...
        //   </ir-custom-button>
        // </igl-book-property-container>
        index.h("ir-booking-new-form", { key: 'e6096fc5e3c131fcfd992de77e876840363cc64a', propertyid: this.propertyId, language: this.language, ticket: booking_listing_service.booking_listing.token })))), index.h("h3", { key: '31a219ae04310348738c135b8b6b66272f8b9401', class: "d-none d-md-block page-title" }, locales_store.locales.entries?.Lcz_Bookings), index.h("div", { key: '25d94fa0b4ada5ceba6dd270e132701c8f811483',
            // onSubmit={e => {
            //   e.preventDefault();
            //   console.log(this.inputValue);
            //   this.handleSearchClicked(false);
            // }}
            class: "booking-search-field width-fill" }, index.h("ir-input", { key: 'dbae4e4181c8268ef3b266ddfabb04923fa501a2', class: 'flex-fill w-100', value: this.inputValue, onKeyDown: e => {
                if (e.key === 'Enter') {
                    e.preventDefault();
                    this.handleSearchClicked(false);
                }
            }, "onText-change": e => (this.inputValue = e.detail), size: "small", placeholder: locales_store.locales.entries?.Lcz_FindBookNbrorName }, index.h("wa-icon", { key: '9ad267ef249f7bbaa68b620e4bceb7c7314d7bdc', name: "magnifying-glass", slot: "start" })), index.h("h5", { key: 'fb3dd375fbbf3e6efedce961991eff616788d922', class: "m-0 font-weight-bold d-none d-sm-block" }, locales_store.locales.entries?.Lcz_Or))), index.h("div", { key: '89adbc48584d415d83be60e7e9ace4f23ebbd6bd', class: "d-none d-md-block" }, index.h("wa-tooltip", { key: '81701b8e45c2d3adb4ab78de9a3714ac2cff38a3', for: "new-booking" }, "Create new booking"), !havePrivilege && (
        // <igl-book-property-container
        //   p={this.p}
        //   withIrToastAndInterceptor={false}
        //   propertyid={this.propertyId}
        ...
        // </igl-book-property-container>
        index.h("ir-booking-new-form", { key: '7b461973df7d8966b04624d69c06f79a009f5085', propertyid: this.propertyId, language: this.language, ticket: booking_listing_service.booking_listing.token })))), index.h("section", { key: 'd9a9117880424bb60d26147fea7cb06112e7f9ee', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '53c60653cccda1bd5e1121bf29c1d7ac0aeb54f9' }), index.h("h5", { key: 'c67dc06db8cf96eb1f5777cc393a995142df7f6f', class: "m-0 font-weight-bold" }, locales_store.locales.entries?.Lcz_Or), index.h("span", { key: '2079977326689e1c89fca5203d9fd9a4297b5ce6' })), index.h("section", { key: '98db088b0bab5a3d3e5902624ae891bbc5d91165', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("wa-select", { key: '1cf136f1cff38335b9a7c37b5b5e454a42ed33ac', onchange: e => {
                booking_listing_service.updateUserSelection('filter_type', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.filter_type?.toString(), size: "small", defaultValue: booking_listing_service.booking_listing?.types[0]?.id?.toString() }, booking_listing_service.booking_listing?.types.map(b => (index.h("wa-option", { key: b.id, value: b.id?.toString() }, b.name)))), index.h("ir-range-picker", { key: 'cc42190d87dab5b42703a0dc7a591f6a3dfefe90', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, allowNullDates: false, fromDate: moment.hooks(booking_listing_service.booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: moment.hooks(booking_listing_service.booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("wa-select", { key: '7c9d3c61b6bf8ddc109d21bbc8725438ab789d87', onchange: e => {
                booking_listing_service.updateUserSelection('booking_status', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.booking_status, size: "small", defaultValue: booking_listing_service.booking_listing?.statuses[0]?.code }, booking_listing_service.booking_listing?.statuses.map(b => (index.h("wa-option", { key: b.code, value: b.code }, b.name)))), !utils.isPrivilegedUser(booking_listing_service.booking_listing.userSelection.userTypeCode) && (index.h("wa-select", { key: '2a794558f960dbce9801ae628c2db6cec9305e61', onchange: e => {
                booking_listing_service.updateUserSelection('channel', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.channel, size: "small", defaultValue: booking_listing_service.booking_listing.userSelection.channel }, index.h("wa-option", { key: '6f662c71850df90eee3523893ebad4b4668c00fc', value: "" }, "All channels"), booking_listing_service.booking_listing?.channels.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name))))), index.h("wa-select", { key: '0437c4dc758df66418c09a4e7691c64a746cf6f8', onchange: e => {
                booking_listing_service.updateUserSelection('balance_filter', e.target.value);
            }, value: booking_listing_service.booking_listing.userSelection.balance_filter, size: "small", defaultValue: booking_listing_service.booking_listing?.balance_filter[0]?.value }, booking_listing_service.booking_listing?.balance_filter.map(b => (index.h("wa-option", { key: b.value, value: b.value }, b.name)))), index.h("div", { key: '7f4c8dbf334a4dc8eda6c46f22f4d4df1a0a065f', class: "d-flex flex-fill align-items-end m-0" }, index.h("wa-tooltip", { key: '2c0ec95a04be7eccb71b6cdcae07789c3a3658b1', for: "search-btn" }, locales_store.locales.entries?.Lcz_Search), index.h("ir-custom-button", { key: '96b725d48aa3a002092fef5958ef8f05667d1190', id: "search-btn", loading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false), variant: "neutral", appearance: "plain" }, index.h("wa-icon", { key: '85d122931872aa36f385689a06a5401acc173634', name: "magnifying-glass", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '6462d13852643571a5411101c5eebae857ca7662', for: "clear-btn" }, locales_store.locales.entries?.Lcz_Erase), index.h("ir-custom-button", { key: 'afba2aebf0ce64bc937232c2bb29c95f519a7d95', id: "clear-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleClearUserField() }, index.h("wa-icon", { key: '704b9df63be9287f7bf2a7e49989ff2c0e2d6bc9', name: "eraser", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: 'e28635e5c910bb7bb88495ecfbca768750cd494b', for: "excel-btn" }, locales_store.locales.entries?.Lcz_ExportToExcel), index.h("ir-custom-button", { key: 'de20c6bfd0e1c4bcc7d3452299086213aa9de16c', loading: this.isLoading === 'excel', id: "excel-btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleSearchClicked(true) }, index.h("wa-icon", { key: '9f69219ef5c96d1f28dbd2d2bcc00250ddc8563b', name: "file-excel", variant: "regular", style: { fontSize: '1.2rem' } }))))));
    }
};
