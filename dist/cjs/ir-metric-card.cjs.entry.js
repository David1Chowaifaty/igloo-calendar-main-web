...
const IrMetricCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '12fe32d13be0bf6849a52570bbc19ab52a97e04c', role: this.clickable ? 'button' : null, tabindex: interactive ? '0' : null, "aria-label": this.clickable ? ariaLabel : null, "aria-busy": this.loading ? 'true' : null, onClick: interactive ? this.handleActivate : undefined, onKeyDown: interactive ? this.handleKeyDown : undefined }, index.h("div", { key: '37ef86e69226d279d705b769dadb2afb7eddadb1', part: "base", class: "metric" }, (hasIcon || this.label) && (index.h("div", { key: '6702aede1060278853316ef0bbe4856c3a235494', part: "header", class: "metric__header" }, hasIcon && this.renderIcon(), index.h("span", { key: 'df2cc4d797aedf09a6f0a954e1ae82b00ca9fa4d', part: "label", class: "metric__label" }, index.h("slot", { key: '8ebffe02fb2aed3d6af5285b4572f4a3aa2c49f6', name: "label" }, this.label)))), this.loading ? (index.h("div", { class: "metric__skeleton" }, index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--value" }), index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--caption" }))) : (index.h("div", { class: "metric__main" }, index.h("div", { part: "value", class: "metric__value" }, index.h("slot", { name: "value" }, this.value !== undefined && this.value !== null && index.h("span", { class: "metric__value-number" }, this.value), this.unit && (index.h("span", { part: "unit", class: "metric__unit" }, this.unit))), this.renderTrend()), this.caption && (index.h("p", { part: "caption", class: "metric__caption" }, this.caption)))), index.h("div", { key: '8e4038c33996cbec83b6c8e75c527be5a9fb286f', part: "body", class: "metric__body" }, index.h("slot", { key: 'b137ca1184859ab4a15c47c5a71cffdb7f59bb3d' })), index.h("div", { key: '24a83c875a40330dc69ceac5bb1c1b5bbac4ac79', part: "footer", class: "metric__footer" }, index.h("slot", { key: 'b7b5aee044beec0d252968d5dc21e8fe481f99d9', name: "footer" })))));
    }
};
