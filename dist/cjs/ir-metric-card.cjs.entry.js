...
const IrMetricCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fa6674178a09649be88da2b74dce0d1b9d6f50eb', role: this.clickable ? 'button' : null, tabindex: interactive ? '0' : null, "aria-label": this.clickable ? ariaLabel : null, "aria-busy": this.loading ? 'true' : null, onClick: interactive ? this.handleActivate : undefined, onKeyDown: interactive ? this.handleKeyDown : undefined }, index.h("div", { key: '7fed0bd7fe3ab98e183f5415f78c55959ae7d5cd', part: "base", class: "metric" }, (hasIcon || this.label) && (index.h("div", { key: '6b234fea4763d8eab7a756f4f189b70b75a3ffd1', part: "header", class: "metric__header" }, hasIcon && this.renderIcon(), index.h("span", { key: '8ec99a7391af94c2fab3733961989b27ed8e5755', part: "label", class: "metric__label" }, index.h("slot", { key: '39613f2da42ef4a666d7f27c35f5108427173c7a', name: "label" }, this.label)))), this.loading ? (index.h("div", { class: "metric__skeleton" }, index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--value" }), index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--caption" }))) : (index.h("div", { class: "metric__main" }, index.h("div", { part: "value", class: "metric__value" }, index.h("slot", { name: "value" }, this.value !== undefined && this.value !== null && index.h("span", { class: "metric__value-number" }, this.value), this.unit && (index.h("span", { part: "unit", class: "metric__unit" }, this.unit))), this.renderTrend()), this.caption && (index.h("p", { part: "caption", class: "metric__caption" }, this.caption)))), index.h("div", { key: 'bbcac387c611d083d9c62ed7efd55f29f189325e', part: "body", class: "metric__body" }, index.h("slot", { key: 'ac8d8050c9228ac6f5ad7e63f4d167a5f668864e' })), index.h("div", { key: 'd6a604c720e9e892ce4258c716596aec2d788c3c', part: "footer", class: "metric__footer" }, index.h("slot", { key: 'd944240325159701a52e51ee98164bf1cdd16bde', name: "footer" })))));
    }
};
