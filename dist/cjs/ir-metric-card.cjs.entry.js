...
const IrMetricCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '749477d847527ba9ade22dd4d11bb9bfcb9a5405', role: this.clickable ? 'button' : null, tabindex: interactive ? '0' : null, "aria-label": this.clickable ? ariaLabel : null, "aria-busy": this.loading ? 'true' : null, onClick: interactive ? this.handleActivate : undefined, onKeyDown: interactive ? this.handleKeyDown : undefined }, index.h("div", { key: '4fc3b336708a31b1563f5b7243b9667d6e6ca881', part: "base", class: "metric" }, (hasIcon || this.label) && (index.h("div", { key: 'a32bccf64b9b003aeab9af75be12fd499a0728db', part: "header", class: "metric__header" }, hasIcon && this.renderIcon(), index.h("span", { key: 'f10e1aab34d8cde48cad1389c9c9e1258000eae7', part: "label", class: "metric__label" }, index.h("slot", { key: 'b4151bfe384d3e36bf943728bd5df19a59116625', name: "label" }, this.label)))), this.loading ? (index.h("div", { class: "metric__skeleton" }, index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--value" }), index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--caption" }))) : (index.h("div", { class: "metric__main" }, index.h("div", { part: "value", class: "metric__value" }, index.h("slot", { name: "value" }, this.value !== undefined && this.value !== null && index.h("span", { class: "metric__value-number" }, this.value), this.unit && (index.h("span", { part: "unit", class: "metric__unit" }, this.unit))), this.renderTrend()), this.caption && (index.h("p", { part: "caption", class: "metric__caption" }, this.caption)))), index.h("div", { key: '399ded6b9a37ee1038e7d8cd3eb170eaa9c887d0', part: "body", class: "metric__body" }, index.h("slot", { key: '0495250966a51aca76b0c010d9c759764c991c8a' })), index.h("div", { key: 'd13ea5a4a7295b80928cc317a58fed264781db33', part: "footer", class: "metric__footer" }, index.h("slot", { key: '8e54b223cadd55326b029d24ae3809069368462c', name: "footer" })))));
    }
};
