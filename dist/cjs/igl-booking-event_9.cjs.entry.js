...
const IglCalBody = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e7ce9a37dea3348a582fab3612b257b8da907947' }, index.h("div", { key: '3a812ef76d12d23905f65b01d61494eb8ae8668c', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '098471ca74d5391ca800ec221befad93d9a34ab8', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IrInteractiveTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd2d6dbd982be3dd45c646b7ed13dc631115954a1', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '2682c8002840054204444e3188829e6dde39cff9', class: "popover-title", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, index.h("span", { key: 'e496ca16ceffd14b1eda25b34c0a12056560a35b', ref: el => (this.croppedTitleEl = el), class: "croppedTitle" }, this.croppedTitle), this.hkStatus && (index.h("div", { key: 'a94e5b24a76dfb546d01b2c3fa79d9aa51039e78', title: "This unit is dirty", class: `hk-dot` }, index.h("svg", { key: '06f2ec400ba90395ee805adaa9d45b6f4e384189', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512" }, index.h("path", { key: '3e4d89f0d7b62f14406119feb9218ff28f7a9b57', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
