...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '556f4962a3a7f26dedc749957f2059f789445c5d', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: '83953ab68de3069ccb3d9acb52a748b8a5d666af', class: `bookingEventBase  ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: 'cf56911beba90d58078e4b2d4962f556e6a89fdb', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), (this.bookingEvent.is_direct || utils.isBlockUnit(this.bookingEvent.STATUS_CODE)) && (index.h(index.Fragment, { key: '8419a082893a2ffa4634017c4e59e1cfce473737' }, index.h("div", { key: 'c4fd688e6c2883c2bd3698a26d4c1f3b0d864b8e', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'bbde5c270c4100fbdbab3b5c242ec417da3ca490', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglCalBody = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cf355d15dd2c31ec28bcdefdc63e1a5c2256171d' }, index.h("div", { key: '4d52c06e85aa1d65057f2f2c4959e60006d7eb76', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '06c915eec85062f729470ab4fe1ce31b22284291', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e5dd327c1cec35f7160f03d57249be41a92d0ae9', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '174d9d9ef96f6750105eccedf708e7aaff2c34ad', class: 'w-full' }, index.h("div", { key: '73199c192d3b1fda640218bed073f85f30bae390', class: 'w-full' }, index.h("div", { key: 'b543b5a5d8c78bcc33ce7869f676aaa2a8782fc4', class: "stickyHeader pt-1 " }, index.h("p", { key: '8a9fac4840f4f620355e878ac5c98dfc6274b326', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '3a9190ea5d27bce17183bb69fca8c82bbb6e2056', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '0bdb80374ef30fd7f32e6dcee052f1ea8a274738', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'a2f102616a8f9bfebdfb7845123f55af7bf81108', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: 'b3699e555190bb1c45c14a46c2c16a620ebcd9af' })), index.h("div", { key: '6975c0c7bec1b4a398578cd6fdab028b02de0a42', class: "mt-2 pl-1" }, this.legendData.map(legendInfo => (index.h("div", { class: "legendRow " }, index.h("div", { class: `legend_${legendInfo.design} mr-1`, style: { backgroundColor: legendInfo.color } }), index.h("span", { class: "font-small-3" }, legendInfo.name))))), index.h("hr", { key: '1b8f13775ea8cbe35bdebf4716d8f8d995bcb4f4' }), index.h("div", { key: '8c031e14291be7fc0e3ac45d2fd0f492855ff9ba', class: "mt-2" }, index.h("div", { key: '393781e27087e6985ce809f0c00abb0de9e0840b', class: "legendCalendar" }, index.h("div", { key: '485bb5b0d9b01eaaad30e27f69812380b18ff652', class: "legendRow align-items-center" }, index.h("div", { key: '3f13c9c1d459c79e6bba481305ef1fb4184e332e', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '9f7a4054bfe1c0e7310b36a98100a4be62904e1e' }, "MAR 2022")), index.h("div", { key: 'd1dd2f64b1ffe5576848f8682d17972157ac7d1e', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '94cedc7c806e5e496bb0c5cfae8f835aa4526a7d', class: "legendRow" }, index.h("div", { key: '82afd1d6fbe2daf7b5df7615b644f57911fa92c7', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'd9cb328ec2380de56d73d485185a87277481d507', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: 'a52b3d808b22e5efec2df882faf6ad3a8843857b', class: "highphenLegend" }, index.h("div", { key: '86c18154812190b0f802df0cb8a82a51e5468634' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'c3df21e96e442c52f0505b39c6421398efc29a0b', class: "legendRow" }, index.h("div", { key: 'bbf881dad021385078f9c99d2ca8cbb1dba8d85f', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'ca710d101aa3ac3fe80a9d0c7488d3d45433cdcc', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '18b1e780a893359d13228e98b9e3b1c5b13ebb5c', class: "legendRow" }, index.h("div", { key: '126ec58c641d688ed4ccc079402bcf71cd3c936d', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'e5e7e062b3b91baf063a9081c2d0961e4cd54cf5', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '7b4b2e51235ac908b7f915e28f4383598a74b023', class: "legendRow" }, index.h("div", { key: 'b76b56cb2792151c0886665d7850837ff01d1676', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '0c380ebf9c858ffecfd3824c41610dac281839c8', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '8c6890085c588548169d4f66d7785b4a68c3c895' }, index.h("div", { key: '02b66a2968cbfd05372ea7867cd4ceb30d590346', class: "sectionContainer" }, index.h("div", { key: 'bf762a8bbb352688b323efb5db19053dd34370f2', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9372eafdf4b1365472f10dec81209e6372d2b7d0', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'e07106e17bdaf467cd0ea2988628926f87ec328d', class: "popover-title", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, index.h("span", { key: 'f35179336b0cabe44569d1bd61274111d72a011e', ref: el => (this.croppedTitleEl = el), class: "croppedTitle" }, this.croppedTitle), this.hkStatus && (index.h("div", { key: '2b76e38970902ffb2795efee564ae11f6d6a6d0d', title: "This unit is dirty", class: `hk-dot` }, index.h("svg", { key: '75f493179b3ebd916f29c17a9923150e9f950930', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512" }, index.h("path", { key: '93d16f68cf6d1b76807b6f405d72582dd770e76b', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
