...
const IglCalBody = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a7f340bf44d7d6d6099d8e67fcc270de3f802f9a' }, index.h("div", { key: 'b478600b92a5e6f1e5e710938471cedc3afa7c13', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'a9c3af0909e8a38c1599bf24792f61b255350125', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IrInteractiveTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7ff880d81c977388fcff3367ed40e98016e8b2a3', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'baa7d279fa45447459bb5a58cd3e608211fd7b3a', class: "popover-title", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, index.h("span", { key: '309cbc3b946aa43d60616b40b448f645837528f8', ref: el => (this.croppedTitleEl = el), class: "croppedTitle" }, this.croppedTitle), this.hkStatus && (index.h("div", { key: '154f1eded3ece5eec1ca8dcb47741b8c197a437b', title: "This unit is dirty", class: `hk-dot` }, index.h("svg", { key: 'c2b7f834a603c54bad2f2a3d701aedc04c23b83a', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512" }, index.h("path", { key: 'ff0587370ecce086a624e9432d47a83a7f3b598d',
            // fill="currentColor"
