...
const IrPaymentOption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: "p-2" }, index.h("ir-toast", null), index.h("ir-interceptor", null), index.h("div", { class: "card p-1 flex-fill m-0" }, index.h("div", { class: "d-flex align-items-center mb-2" }, index.h("div", { class: "p-0 m-0 mr-1" }, index.h("ir-icons", { name: "credit_card" })), index.h("h3", { class: 'm-0 p-0' }, " Payment Options")), index.h("div", { class: "payment-table-container" }, index.h("table", { class: "table table-striped table-bordered no-footer dataTable" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, "Payment method"), index.h("th", { scope: "col" }, "Status"), index.h("th", { scope: "col", class: "actions-header" }, "Action"))), index.h("tbody", { class: "" }, (_a = this.paymentOptions) === null || _a === void 0 ? void 0 : _a.map(po => {
            ...
            return (index.h("tr", { key: po.id }, index.h("td", { class: 'text-left po-description' }, index.h("span", { class: 'p-0 m-0' }, po.description), " ", index.h("img", { src: "https://www.jccsmart.com/assets/images/app-logo.svg", alt: "", class: "payment-img" })), index.h("td", null, index.h("ir-switch", { checked: po.is_active, onCheckChange: e => this.handleCheckChange(e, po) })), index.h("td", { class: "payment-action" }, this.showEditButton(po) && (index.h("ir-button", { variant: "icon", icon_name: "edit", onClickHanlder: () => {
