...
const IrChannelHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b46f0a9e2b2d440683307c64006d10de724118e9' }, index.h("ul", { key: 'f1a88529c7d4fb4a65477a1d5fdf396dd3b35c2f' }, this.headerTitles.map((title, index$1) => (index.h("li", { class: `tab ${title.disabled ? 'text-light' : ''}`, key: title.id, onClick: () => {
                if (!title.disabled)
                    this.handleTabSelection(index$1);
            }, "data-disabled": title.disabled, "data-state": this.selectedIndex === index$1 ? 'selected' : '' }, title.name)))), index.h("span", { key: '0c22c3a9eccb21490a146f30517797c2b53e2817', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
...
const IrChannelMapping = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: '38d1727a16de53a3d1ac2b65bfea9671b1ee6d95' }, index.h("div", { key: '0f101eebd51cea7cebabb2a5af12d6c465ec2ce6', class: "d-flex w-100 justify-content-end" }, index.h("button", { key: '371c07fd27d0163f7d1a3415577b82ff6ea23038', onClick: () => {
                channel_store.setMappedChannel();
            }, class: "btn refresh-btn" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Refresh)), index.h("table", { key: '7254fbafe65f7f603104914afb5998521ad72399', class: "m-0 p-0 w-100" }, index.h("thead", { key: '27bcee74bfd48eae0651aeeec3647a48cea16de1', class: 'py-1' }, index.h("tr", { key: '74e56c1c910d3e8323b89af1ee9fb010de5b47d7', class: "py-1" }, index.h("th", { key: '2e127a699ef1e24661838d3adc27c6cb11d64894', scope: "col", class: "py-1 pr-3" }, (_b = channel_store.channels_data.selectedChannel) === null || _b === void 0 ? void 0 : _b.name), index.h("td", { key: 'aaf27056f38d13f599ef3c00aa05328b0ad44caf' }, index.h("svg", { key: '41f0633347ebbbdea8a8c4e4fadbbc1922ece4ee', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '0c9592a3de2e067ad2f3e994cdd3586807783d4c', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" }))), index.h("th", { key: '238067b072c6297da2d4e685fe3d43cd0790ce8e', scope: "col", class: "px-2" }, "Igloorooms"))), index.h("tbody", { key: 'da525151cc31371e903c21d5d291593d231a631d' }, (_e = (_d = (_c = channel_store.channels_data.selectedChannel) === null || _c === void 0 ? void 0 : _c.property) === null || _d === void 0 ? void 0 : _d.room_types) === null || _e === void 0 ? void 0 : _e.map(room_type => {
