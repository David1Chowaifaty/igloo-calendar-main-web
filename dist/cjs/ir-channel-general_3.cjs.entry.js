...
const IrChannelHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '39b0aebaac7465d856ce83dd1ad2209cac09cc51' }, index.h("ul", { key: 'afdf6c725d39d1b3f76011d40b27a3816f382d6b' }, this.headerTitles.map((title, index$1) => (index.h("li", { class: `tab ${title.disabled ? 'text-light' : ''}`, key: title.id, onClick: () => {
                if (!title.disabled)
                    this.handleTabSelection(index$1);
            }, "data-disabled": title.disabled, "data-state": this.selectedIndex === index$1 ? 'selected' : '' }, title.name)))), index.h("span", { key: 'ac0e4f15fa5a68986f89118305a152215047ba4c', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
...
const IrChannelMapping = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: 'de9192aca49e6559ac52c489a4320614ed5c404d' }, index.h("div", { key: '001279dcd0bbda9e6a9d0822bc422e4d3a8a67d3', class: "d-flex w-100 justify-content-end" }, index.h("button", { key: 'a30a7321b2368f2910524d662cd2d4d2696597a8', onClick: () => {
                channel_store.setMappedChannel();
            }, class: "btn refresh-btn" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Refresh)), index.h("table", { key: '6d51dab16a5d042aeaf0a39b6bcc31c5addb3d80', class: "m-0 p-0 w-100" }, index.h("thead", { key: 'ce4a54d72d564dab8837215227d84b02b0a6af46', class: 'py-1' }, index.h("tr", { key: 'af767a56915f418bed0d6e8e18dae93962237dcb', class: "py-1" }, index.h("th", { key: '555c5c820c730861ffd9fb3d441a9f54fc496373', scope: "col", class: "py-1 pr-3" }, (_b = channel_store.channels_data.selectedChannel) === null || _b === void 0 ? void 0 : _b.name), index.h("td", { key: '7a4725022f2bf1762fccf90c9bab59f1abeb794b' }, index.h("svg", { key: 'dafcd3cbf9cbb393d5593d8bcb082f1cc6fff106', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'e09e01fab50b8373f58d0050f1d8396a67c96187', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" }))), index.h("th", { key: '4ae73bce6738e5e6aad1a13753c45c26b1df1512', scope: "col", class: "px-2" }, "Igloorooms"))), index.h("tbody", { key: '0d0b9caaee222dcc67463cb982d10fa606765a0c' }, (_e = (_d = (_c = channel_store.channels_data.selectedChannel) === null || _c === void 0 ? void 0 : _c.property) === null || _d === void 0 ? void 0 : _d.room_types) === null || _e === void 0 ? void 0 : _e.map(room_type => {
