...
const IrChannelHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ce076bf830bf287c6fe02fa4ccdf28b2c781c1c6' }, index.h("ul", { key: 'd04307019f3fd520e548e2f78a82c4637dc96e4e' }, this.headerTitles.map((title, index$1) => (index.h("li", { class: `tab ${title.disabled ? 'text-light' : ''}`, key: title.id, onClick: () => {
                if (!title.disabled)
                    this.handleTabSelection(index$1);
            }, "data-disabled": title.disabled, "data-state": this.selectedIndex === index$1 ? 'selected' : '' }, title.name)))), index.h("span", { key: 'f82f6a4c79914aaeb6e7f21077b2d9fecaa4a57d', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
...
const IrChannelMapping = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: '725c17d425336effaa185bfb800a5929c73fcc83' }, index.h("div", { key: 'becb995be14fbfdefedbc384ceaeacc3a99a9184', class: "d-flex w-100 justify-content-end" }, index.h("button", { key: '60ac9de2f9fdba7a03889dce5fe190ae9cecf2dc', onClick: () => {
                channel_store.setMappedChannel();
            }, class: "btn refresh-btn" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Refresh)), index.h("table", { key: '3ef091890fac76f9d1af17ea0a16258b35651f1b', class: "m-0 p-0 w-100" }, index.h("thead", { key: 'c7e3cd275f5be53cf73a2777a176abe71d90b579', class: 'py-1' }, index.h("tr", { key: 'a7a63f9e4590023ffb6d7aad995500432e9606d2', class: "py-1" }, index.h("th", { key: 'bbd07e887eb32ffd5b66d892494c2c400147b119', scope: "col", class: "py-1 pr-3" }, (_b = channel_store.channels_data.selectedChannel) === null || _b === void 0 ? void 0 : _b.name), index.h("td", { key: '031c1c0a797db07b880fc2882360aabbb6e32565' }, index.h("svg", { key: 'ae4f8daf7f86972024d89c8d7ce5a3777e57ba46', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'b1d99e0f56efda07f9b8cc7886b9bb9051e089ff', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" }))), index.h("th", { key: 'b3fe80ec8e31998a99219fabbf4d1675bb3af3bc', scope: "col", class: "px-2" }, "Igloorooms"))), index.h("tbody", { key: '1c005adab83d59d5840dd59dc18badfe4a04a4a6' }, (_e = (_d = (_c = channel_store.channels_data.selectedChannel) === null || _c === void 0 ? void 0 : _c.property) === null || _d === void 0 ? void 0 : _d.room_types) === null || _e === void 0 ? void 0 : _e.map(room_type => {
