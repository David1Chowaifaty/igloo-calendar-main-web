...
const IrChannelGeneral = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a862dcb587ac6aa642f6a2a2d2a9ba98f45fcf86', class: "px-1" }, index.h("section", { key: 'b550fe0ac564c14ea8a6e3c8734035b9749cbe72', class: "ml-18" }, index.h("fieldset", { key: 'e98a8e0195f53e8193accf279863e86cfe9e447c', class: "d-flex align-items-center" }, index.h("label", { key: 'b92b4fb4dde885ec87cd7b1591759731703a762d', htmlFor: "hotel_channels", class: "m-0 p-0 label-style" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Channel), index.h("ir-combobox", { key: 'e1c5b386bba99b1a2e7375323df7a0980612fa19', input_id: "hotel_channels", disabled: channel_store.channels_data.isConnectedToChannel, class: "flex-fill", value: (_b = channel_store.channels_data.selectedChannel) === null || _b === void 0 ? void 0 : _b.name, onComboboxValueChange: (e) => {
                channel_store.selectChannel(e.detail.data.toString());
            }, data: channel_store.channels_data.channels.map(channel => ({
                id: channel.id,
                name: channel.name,
            })) })), index.h("fieldset", { key: '7332515129adeaceaad03ddabd432a9dbc8d7c26', class: "d-flex align-items-center mt-1" }, index.h("label", { key: '5515830587d773a134979a3e288765345f35df8b', htmlFor: "hotel_title", class: "m-0 p-0 label-style" }, (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_Title), index.h("div", { key: '38c43098d9c620f465395c9d6c201e2eaf4de965', class: "flex-fill" }, index.h("input", { key: 'e6fefa6ecf2824dd8d94abf7eb8a073fb13f1a7d', id: "hotel_title", value: (_d = channel_store.channels_data.channel_settings) === null || _d === void 0 ? void 0 : _d.hotel_title, onInput: e => channel_store.updateChannelSettings('hotel_title', e.target.value), class: "form-control  flex-fill" })))), channel_store.channels_data.selectedChannel && (index.h("form", { key: 'ee1f2c86f6c3a0b34c92517812ef7b2dd4df60e8', onSubmit: this.handleTestConnectionClicked.bind(this), class: "mt-3 connection-container" }, index.h("h3", { key: '5cab7e4c5df67b135c9b8bc48121263c0a90e981', class: "text-left font-medium-2  py-0 my-0 connection-title py-1 mb-2" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_ConnectionSettings), index.h("div", { key: '97ee4d410a8cbab369bb892cfaced0a7e918a260', class: "ml-18" }, index.h("fieldset", { key: 'a5ea9397c5c33c5d09032234befee0ea9d5a9c71', class: "d-flex align-items-center my-1" }, index.h("label", { key: 'a6abe8c86ce45ab3306646712684210537fb1285', htmlFor: "hotel_id", class: "m-0 p-0 label-style" }, (_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_HotelID), index.h("div", { key: '4bb9917168779f538024fe91001298adfc21424d', class: "flex-fill" }, index.h("input", { key: 'd2e87348fb99a9bd95de75729a990aab9ebf7509', id: "hotel_id",
            // disabled={channels_data.isConnectedToChannel}
            class: `form-control  flex-fill bg-white ${this.buttonClicked && !((_g = channel_store.channels_data.channel_settings) === null || _g === void 0 ? void 0 : _g.hotel_id) && 'border-danger'}`, value: (_h = channel_store.channels_data.channel_settings) === null || _h === void 0 ? void 0 : _h.hotel_id, onInput: e => channel_store.updateChannelSettings('hotel_id', e.target.value) }))), index.h("div", { key: 'ccb7e3dc860455fa16c37c8828e059aed1cf19af', class: "connection-status" }, index.h("div", { key: 'eb24ed7764bc5ea4bb3e8fa2debfd7fa95192f00', class: "status-message" }, this.connection_status_message &&
            (this.status ? index.h("ir-icons", { name: "circle_check", style: { color: 'green' } }) : index.h("ir-icons", { name: "danger", style: { color: 'yellow' } })), index.h("span", { key: '12c8260fa3c203c2b8779be25795f593ac615fa9' }, this.connection_status_message)), index.h("button", { key: '2843955380c2514e0307b3ddee33aa54c351706d', class: "btn btn-outline-secondary btn-sm", type: "submit" }, (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_TestConnection)))))));
    }
};
...
const IrChannelHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7b80e348a4d26eeee7822abb3bb36139d8bbff07' }, index.h("ul", { key: '03045fb2fc0da4193be1ca64006e83e22c8e9a2e', class: "px-1" }, this.headerTitles.map((title, index$1) => (index.h("li", { class: `tab ${title.disabled ? 'text-light' : ''}`, key: title.id, onClick: () => {
                if (!title.disabled)
                    this.handleTabSelection(index$1);
            }, "data-disabled": title.disabled, "data-state": this.selectedIndex === index$1 ? 'selected' : '' }, title.name)))), index.h("span", { key: '41db9ab52c3b1cf99b3ba0868458eb710cd660b0', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
...
const IrChannelMapping = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: '99661d3a3063e6dc326323081d85352f241f2550', class: "py-md-2 px-md-2" }, index.h("div", { key: '253495ea3f790e7e5a607ee678a5a3195dd30369', class: "d-flex p-0 m-0 w-100 justify-content-end" }, index.h("button", { key: '5891f2a757e62487187f793914498ed7bc686f25', onClick: () => {
                channel_store.setMappedChannel();
            }, class: "btn refresh-btn" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Refresh)), index.h("section", { key: '71649394f2aae8498294b02f1dab6dc92af6ce65', class: "w-100" }, index.h("div", { key: 'b6f12d1a35fb42a8331b996e56c13bda7b240752', class: "pt-1 mapped_row" }, index.h("p", { key: '36360de416a927e820176d86ad28f24adaba654a', class: "mapped_item channel_name" }, (_b = channel_store.channels_data.selectedChannel) === null || _b === void 0 ? void 0 : _b.name), index.h("svg", { key: 'e0184f6e5b76dc480344bf42f5fb5a7c63524fd0', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'e01292312b80983f2eb1f18e1fd1d3c8b98e7c0b', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), index.h("p", { key: '986f8811b51a868679f444f32ce7a06c905bb442', class: "pl-2 mapped_item channel_name" }, "igloorooms")), index.h("div", { key: '3a9944dba5c2be2f4e2b2304d802fe5f7a985417' }, (_e = (_d = (_c = channel_store.channels_data.selectedChannel) === null || _c === void 0 ? void 0 : _c.property) === null || _d === void 0 ? void 0 : _d.room_types) === null || _e === void 0 ? void 0 : _e.map(room_type => {
