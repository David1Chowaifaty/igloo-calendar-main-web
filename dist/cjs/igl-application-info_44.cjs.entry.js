...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0ec36aeab13b68387474a715fd8cb62986500d0a' }, index.h("a", { key: 'd59f71d5a0302a7bb9937f5ef288929b7e994857', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: 'bd23df398d0c99a690d349491c9bd00dca8414b6', class: "sr-only" }, "download url")), index.h("section", { key: '60dd4d2d5c0fa3323c75d2af83f7f2dd9ab6559d', class: "d-flex align-items-center " }, index.h("div", { key: 'f88134b269fc44ccfdb8f984de38a41104ad2bb9', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '95c92f642b3e30b0ba2e64807df2c714629a3367', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'bdf5e0aedf13b5f99f59d8df47d2e5a9c3aba109', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'e069d643f6267548ddf43cf0094e95166f6a907c' }, index.h("igl-book-property-container", { key: 'fed386b20ebfd130b2b11afa84fd042283d62eb5', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: 'd06b021c033fa954df65c368b31a93bdf4c9ab56', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: 'ccde1e36d873d859772eaed5a25e0d72d8399cd9', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '32c1e245ce1f65e7c548a9b3e6616bccf7ccecc5', onSubmit: e => {
            ...
            } }))), index.h("ir-select", { key: '06740e236025797adc04ca145ccb3dc352afe94e', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: '5dc74840d5c246c2463e812bd9a96920d220b7e6', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
...
const IrRoom = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4f03ccbc1a9506fd0265daa9408bc406b075c787', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'b8534894d04826620e6de93b30a6f2ba2e4f6a3e', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'cb2dca92248b1f411fb566219269c85c4c5d6cf5', class: "flex-fill m-0 " }, index.h("div", { key: '280926b89ce1e531ecd8029f74991c67ca102db6', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '30de8524e11e689f43cfac5de35b4ddeac4762a7', class: "m-0 p-0" }, index.h("strong", { key: 'a36199e55a9507b2ba1a44331f69bff1061e49d6', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '5e5eb9a6f34cf7e5668f6bcf25497093df6b6ce7', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '8f4e933dc6b14cd462dcf9c49e1cd621528a2448', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '9b26a7012a7e98e3fcf58138260793305015125d', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHanlder: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '29f6673ab8c2222f18cae67c12aae1c4d8b8ac2d', variant: "icon", onClickHanlder: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'aa75558b86068b871a1985cce03480dda039f5ad', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '6a78017171de7f2ff723ab14646e87e38b4b41fd', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: '6e3d68679bd3bb72c4b1181d294480f3a68edd03', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: 'b04432dec56904d7b125b1be309021b0dca5130b', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), index.h("div", { key: '029ff297c17bb597ad1a9393e96e5e47224b7a79', class: 'd-flex justify-content-end' }, calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("span", { key: '6a201d0c3b0a83098da5d411ecf5180e3c3fcc2d', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: '33538088fcf400619986a6b6b00c07ac2b2b07df' }, index.h("span", { key: 'ed6e478da49f15344192f3c93753bcc8caf92d1f', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", { key: 'c93650978824eef252e47076130ba997c64a9454' }, " ", this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy))), index.h("div", { key: '1ecc7b80ff7c203ae619c9c206db6460efb7fb67', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '331929bf9fee76402f18bc669f5dfc740d383970', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '1f1ff20002561503a8af436368172af40a573161', class: " sm-padding-top" }, index.h("strong", { key: '803243ebd88a6b8f81b2e614a2b71d8b0bc9817f', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'e8110d13654e7ced2dcfe63fe8ede6f06b1dbbc9', class: 'flex-fill' }, index.h("table", { key: '393c1be39da0c5263534ce0cfb2e5ff77d6955f1' }, this.item.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'ebaabb6e842806450aa83e91bb9bca372967d3d9', class: '' }, index.h("th", { key: '362a6756a4d9673da5442fc5f17734e58ed13037', class: "text-right pr-2 subtotal_row" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: '47e029889c5c74a7e3c2594f9cb22aa59e94f649', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && index.h("th", { key: '25483d5cc332cc4d7c9c9a5ed3a3580bff9dc2ec', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        //   </span>
        // </div>
        index.h("div", { key: '383d9937e554aac36fd0aff339ee26a254e330b9', class: "room_statements" }, index.h("span", { key: '7b386ffd461d604b621aa934901f68dcf670b45c' }, index.h("b", { key: 'ee3889f836a264653937eeb022205776ae85fab4' }, this.defaultTexts.entries.Lcz_Cancellation, ":"), index.h("span", { key: '957222d7b2896864bd6d4d72ba6fad40627e3e12', innerHTML: this.item.rateplan.cancelation || '' })))), this.item.rateplan.guarantee && (index.h("div", { key: '80fb35f5527f79fb7326559bc69a51c415699200', class: "sm-mb-1" }, index.h("span", { key: '8b24841f83ceeb38201ae8636c9462d75eb38ec2' }, index.h("b", { key: '0cf44d6d0d1dfc0024ba8bfd8f2d331c273e5411' }, this.defaultTexts.entries.Lcz_Guarantee, ": "), index.h("span", { key: 'eccaff9214b1116b76b14b8d6eb31e6adb1a802f', innerHTML: this.item.rateplan.guarantee || '' })))), this.bookingEvent.is_direct && index.h("ir-label", { key: '96c639e99a2e00ad2d8a56630b77d84266e8d135', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), index.h("ir-modal", { key: 'ff42be89e62b7d7df71ee4c31936802aaec475d7', autoClose: false, ref: el => (this.irModalRef = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_44.cjs.entry.js.map