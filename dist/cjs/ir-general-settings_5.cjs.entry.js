...
const IrGeneralSettings = class {
    ...
    render() {
        return [
            index.h("div", { key: '0ac2d1391198326ea3bc730723d309fb68543ed3', class: "General Settings font-size-small" }, index.h("div", { key: '5871b4266b37e93ad3ddff9aed0c6159558518a8', class: "container-fluid" }, this.mode == 'edit' && index.h("div", { class: "text-light border-bottom-light mb-2" }, `ID ${this.data.id}`), index.h("div", { key: 'dfb781a1544c0c6e27764f5ef9ab5cc75e95f1e6', class: "column" }, index.h("ir-select", { key: '32dc032c518139099248cb09d47ce0c7b3667a69', class: "channel-select", label: "Channel", data: this.allowed_channels, "label-background": "white", "label-position": "right", "label-border": "none", size: "sm", textSize: "sm", labelWidth: 4, selectedValue: this.data !== null ? this.data.channel : null }), index.h("ir-input-text", { key: 'd1eca5fca354958de93398634673456d9ecc446d', id: "title-input", label: "Title", placeholder: "Title", value: this.data !== null ? this.data.title : null, "label-background": "white", "label-position": "right", "label-border": "none", size: "sm", labelWidth: 4 }), index.h("ir-select", { key: '97ad8fda492ed227554fbc8fa203a321f9d61531', id: "property-select", label: "Propery",
                // placeholder="Propery"
            ...
            index.h("ir-modal", { key: '52cf45ad586f88e83ec5a585cb0d40ce457c1d23', class: "alertFields", modalTitle: "Please fill all the fields!", modalBody: "There are fields that are not filled yet.", iconAvailable: true, icon: "ft-alert-circle warning h1", leftBtnActive: false, btnPosition: "center", rightBtnText: "Close", rightBtnColor: "primary" }),
        ];
    }
...
const IrLoader = class {
    ...
    render() {
        return (index.h("div", { key: '3ae8b95512eba678328459bb00f6a6905a9238f9', class: `lds-default ${this.size}` }, index.h("div", { key: '771d84e576ec2731f3646a54a825d965c7cf7812' }), index.h("div", { key: '389bd49fe8ce10044fc5794ea116a2b53926919e' }), index.h("div", { key: '4c5de0a35c121861ab3419e1a4d6e4355529a2c6' }), index.h("div", { key: '932ac437e2f6238273b4842adc5a79ba9dc5b167' }), index.h("div", { key: 'd5ee6e3b5ce09d60542c7584baadf9c1c7216e18' }), index.h("div", { key: '3c1e0f2ca360564e77f1b59fd055238a8bdc93e6' }), index.h("div", { key: 'a024004e22de35883064584f57fbbe9fcad9e027' }), index.h("div", { key: '0eba04006282f4a740be1ce1be53645254e5fd93' }), index.h("div", { key: '2bb62b3d173cd5f1516ff324207ab0b4b8e848a0' }), index.h("div", { key: 'e6134b37f2a09148c6ef4daf1cdbf5afb2980240' }), index.h("div", { key: '8e507a7e8e38484ce404e59aeac48219dad5558c' }), index.h("div", { key: '6b6554221ebc42218de6271961aff6a20650edfb' })));
    }
};
...
const IrMapping = class {
    ...
    render() {
        return [
            index.h("div", { key: '4a252becbb0eeaf800d5e91b2804af63e9f66b7f', class: "Mapping font-size-small" }, index.h("div", { key: 'b46339539dcba64859db33f57314f30dbdca4ace', class: "d-flex justify-content-end align-items-center" }, index.h("a", { key: 'f299d13b4bbee957e1b3209abe95de513365ddd5', class: "text-primary" }, "Refresh")), index.h("div", { key: '6e08be211858c0520f03d6e985876b784b6f858e', class: "container-fluid" }, index.h("div", { key: '98797c332ecbac93d8d3a3f411bd5d953ce9c2e0', class: "row" }, index.h("div", { key: 'eaed84172b246f9546024d9680904ec99f843d8f', class: "col-12 mb-1" }, index.h("div", { key: '381e340ca4849a413bdadbff7d55aceefa57d9f9', class: "row " }, index.h("div", { key: '198518f89d78ae46973c66f6a6b3a683808509f4', class: "col-6 d-flex justify-content-between align-items-center font-weight-bold" }, "Iglooroom", index.h("ir-icon", { key: '35c28f33cef44b2a0d03df7390119ecabfc80059', icon: "la la-long-arrow-right" })), index.h("div", { key: 'e83a5897b501ba055777e55969dffb8cb0cda997', class: "col-6 font-weight-bold" }, "Channel Manager"))), this.hostRoom.map((room, index$1) => {
...
const IrChannelManager = class {
    ...
    render() {
        return (index.h("div", { key: '349260214eeb982e595dbc34071418713575d9df', class: "card-head" }, index.h("div", { key: '127169644b0bdc7f34e86852757705259f2c7e9c', class: "input-group input-group-sm" }, index.h("input", { key: '8a380f7b5797a65fe4add97e185885f206158b40', type: "text", class: "form-control border-light", placeholder: "Search" }), index.h("div", { key: 'b0126989965f6ad048f50794ed4499082634f8eb', class: "input-group-append" }), index.h("button", { key: '65ab7bc50fc88315ecb442127aad7a2066d69498', class: "ml-1 btn btn-primary btn-sm openSidebar", onClick: () => this.handleCreate() }, "Create")), index.h("div", { key: 'ec0e4cef6d4f8ffc737c1afb25f44ece8d8d2eb7', class: "container-fluid" }, index.h("div", { key: '7c4c45cab83a01e6d3592ef84331028e46313dfc', class: "row" }, index.h("div", { key: '527a88cd009a3e7c262661123c5df4d6cc192e22', class: "col-3 p-1 section-title" }, "Title ", index.h("ir-icon", { key: 'c82717883d1ad51748ad2d87402d400e754fec22', icon: "la la-unsorted" })), index.h("div", { key: 'd72cc281c8654c516d7100f26068ebbe561ba07f', class: "col-3 p-1 section-title" }, "Channel ", index.h("ir-icon", { key: '558c1c71bf6eaa123f33a6b3176a3237df015577', icon: "la la-unsorted" })), index.h("div", { key: '17f7b983b303b6880e95bfedaf68742434c34555', class: "col-3 p-1 section-title" }, "Status ", index.h("ir-icon", { key: '6cd8e5df086bdc1111dd4f0b58bbe4b802d605ab', icon: "la la-unsorted" }))))));
    }
};
