...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: 'eb6ec8767669dec3c810053325e63d508af99522', class: "input-group" }, index.h("label", { key: '6a34bd573721b2ec243b40509f3131e5a63a8d09', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: '61ad597a1712da92bec1214c6ce675baf1097d23' }, this.label), index.h("input", { key: 'dbc6cac805c08feaecf4db7436b59c3533dc1e1b', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '85035ee23ee46436b176feb56111032c8cd4ff30', class: "checkmark" }))));
    }
