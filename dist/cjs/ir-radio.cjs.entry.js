...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: 'dfac7c77c531540bbe1bb18d54778cca04747cf4', class: "input-group" }, index.h("label", { key: 'e8e8d2456c9007bbe8d84beea9fc17b62e9f0234', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: 'df3dac1f3d8f84ca3d65fc455f0e39f27bcdc5f2' }, this.label), index.h("input", { key: 'cf255899fcc177123510bb4d405af499376b2ad3', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '5f7b72c76eea46f6947b19b2b0a2d8573f4aef21', class: "checkmark" }))));
    }
