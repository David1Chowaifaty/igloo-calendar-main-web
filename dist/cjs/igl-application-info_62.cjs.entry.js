...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b4bafc8bbc1519cdc664c0f46c5dc9b1aab3a530' }, index.h("div", { key: '972b5a3d3f69f99656eeb1b22908d9353fd97ea2', class: 'd-flex align-items-center ' }, index.h("label", { key: '0c52b613c30b223649cebaebe67f853bce642719', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '7a66f2e3c1870fce69975ee3e479573cea2157ca', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: 'c900db300a83f68eb05225ff551504f0daa3e203', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'c3fd433f78793e0c0b52561b5b5328b9744b7ea6', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'd84a74d5e3cfa1781e64da056a0c42880aa23e14', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'b0e5617af49bff4f604063146c7e6897d7c3c1ae', class: 'sr-only' }, "clear input"), index.h("svg", { key: '7731d09d11e15aafbadf50c173bcda66ad2fbac6', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'f750a9ce298113feab3289d54e0179c5e9b4d955', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9072443ec36d0ef75afe372a4dbbcbfbf9a17b47' }, index.h("slot", { key: '2bf699716c0d1e4bd90c10174802f29c4248a5e4' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '2c88a790bf2d31d95500eb37162c6c7114b94ea8', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'da09eeb34d01048fcafadee1f388456a3f3bef7d', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '9e034c621bdcf5f5b34fff3ee3438dd7d7a21174', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '6c12d1d6467737858a70db51eac2f433c92f77ec', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: 'f517b8ec28c7b950767ff687b361d033096a16df', name: "trigger" }), index.h("input", { key: '08e5c6a11f6a80c520fcd48de39a6b14e4bb540f', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd54594f36b0b0c81d5d2c80fe1edf87f1c220448' }, index.h("input", { key: '445affe34ef2bcef98bb15b21eac45c4381c2929', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a0d4770382764e93c1f6d563f49230a25f25adba', class: "d-flex align-items-center" }, index.h("span", { key: '7ef2883c4e35131e8bca676342dc53da2237e59a' }, this.dates.from_date), ' ', index.h("svg", { key: '253e48df36988caa6e31441eabf435ec468c55ef', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '6bd42493a075fe873a823900e4e378e033ec4256', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'a3669efe6e5762560f52a0557836c9dc92b98650' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'f05fca9bfb3a5dbf5ffdae26ee72c0b500568d68', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '31e552e7994ae9a93bb88fbb2db5cc945def7f20' }, index.h("div", { key: 'bcc4be756b70b5a877ac21c69ea46707d8ad937d', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '538e23f3735cc7fc7c4cf71187a94056978656d8', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '87c6ee047a06a2462bfde46ed4a3e65700269738', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '75053d1e722f7f0794a3dab3ea25418d376be82a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '65cc33b0f78c59b9ad20c58edd1992ff8912c4f7', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '58374b0273e97bd86b4a55439a7c34714933f0ee', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'bd2c31f35d3c7f18ebf11270a3165de304a11746', name: "modal-title" })), index.h("div", { key: 'e1865454f5912847624b9729bb241c8b66ea31dc', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'a934dcd4520054a7f03215f53169f64b1aa16b0a', name: "modal-body" })), index.h("div", { key: '595f196bbe3db7d68363f83a49bc129a08678cad', class: "modal-footer" }, index.h("slot", { key: '1221984e642a7dcb644a8002de077bdea2b619ec', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fa4678cc567b522edff991817473e9bfd649dd74', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'fa899dfb356f623738e8839670d8846296886d96', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'f518dfa3f9cca90a35f9e07521693475c4d353ca', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '62f21fc598b63911f1f00bbd5ead3f9ae3fd0f4f' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '56e7523199de07174bdf752882855f89c40e3dac', class: "loadingScreenContainer" }, index.h("div", { key: '4fc585a48786b59b772e89b7fa83a73a0b71478f', class: "loaderContainer" }, index.h("span", { key: 'fd44fce45732ceafe5315dc677da4475df2161f0', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '14e1173f806d63a78a2ce2af6139b20c01c8566e', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'a316892ded20c8c7eda3417b75cd670cde42053b', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '2b6e45dc1ccc6ac153fb99f7f8b5ac29fd891403', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '3c39d456d85626019c7d91025e456a668567dd64', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '61c4276b962f5a24d6515415577d29bd60c6814f', class: `ir-alert-header` }, index.h("p", { key: '95b19841445362a61255be71a7c2fa9c6e6616cd' }, this.modalTitle))), index.h("div", { key: 'fe702f199ecadea7355e1bb98d5f2ac80b2776aa', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'd90ada347d7488836d0f0c2e719b414576f274a5' }, this.modalBody)), index.h("div", { key: '4d4080e6fd1b13c365aa0fb49433468200d2785f', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '8a9b725f09749f8c4198b75029f8afc965ed20f7', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: 'bd99eb7a0e8316dd2e8396c9173389c09cdadd25', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '548626aeb3e30727a02b544b504980cb53fd8734', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ab998f89ae19acb16c08cf1786f8e710be0bbd8b', class: "otp-input-container" }, index.h("div", { key: '84030e82f012f2cf5c989f4f7a69dc2abbb06cb6', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '29db5447060e62206e7447ee152c6a31a2987c3e', class: 'sheet-container', onSubmit: async (e) => {
            ...
            } }, index.h("input", { key: '0c0c362ce8c9d4d9284adf4cdb9996c3d92cdc56', type: "text", slot: "trigger", value: ((_d = this.folioData) === null || _d === void 0 ? void 0 : _d.date) ? moment.hooks((_e = this.folioData) === null || _e === void 0 ? void 0 : _e.date).format('MMM DD, YYYY') : null, class: `form-control w-100 input-sm ${((_f = this.errors) === null || _f === void 0 ? void 0 : _f.date) && !((_g = this.folioData) === null || _g === void 0 ? void 0 : _g.date) ? 'border-danger' : ''} text-left`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } })))))), index.h("div", { key: '3d58d14782935aacc085bdd6d1bf8116a3680f76' }, index.h("ir-price-input", { key: '8737a8f273d43bf3a399466b57ac2b88d5e8f4e7', containerClassname: "row", labelContainerClassname: "col-4 col-md-3 p-0 text-dark border-0", minValue: 0, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ amount: true }), wrapKey: "amount", label: "Amount", labelStyle: 'flex-grow-1 text-dark  border-theme', error: ((_h = this.errors) === null || _h === void 0 ? void 0 : _h.amount) && !((_j = this.folioData) === null || _j === void 0 ? void 0 : _j.amount), value: (_l = (_k = this.folioData) === null || _k === void 0 ? void 0 : _k.amount) === null || _l === void 0 ? void 0 : _l.toString(), currency: calendarData.calendar_data.currency.symbol, onTextChange: e => this.updateFolioData({ amount: Number(e.detail) }) })), index.h("div", { key: '595ad16ea55ad04b9c982d95d70235ba15124803' }, index.h("ir-dropdown", { key: '84948dd67ceee9f9951a962f39efaa351b873e34', value: (_o = (_m = this.folioData) === null || _m === void 0 ? void 0 : _m.payment_type) === null || _o === void 0 ? void 0 : _o.code, disabled: this.mode === 'payment-action', onOptionChange: this.handleDropdownChange.bind(this) }, index.h("div", { key: 'f3a26fa3961fb9ca87cc2129046176628934b751', slot: "trigger", class: 'input-group row m-0 ' }, index.h("div", { key: 'e4a34c7c8b75e92a175297bc3cc2f1cb020f8dd5', class: `input-group-prepend col-4 col-md-3 p-0 text-dark border-0` }, index.h("label", { key: '0a6c589aa3e051c44c0f638bf485410b7396533e', class: `input-group-text flex-grow-1 text-dark  border-theme` }, "Transaction type")), index.h("button", { key: '493a184f5b3c09d492e1cf5312dd3757b8b95821', type: "button", disabled: this.mode === 'payment-action', class: `form-control  d-flex align-items-center cursor-pointer ${((_p = this.errors) === null || _p === void 0 ? void 0 : _p.designation) && !((_q = this.folioData) === null || _q === void 0 ? void 0 : _q.designation) ? 'border-danger' : ''}` }, ((_r = this.folioData) === null || _r === void 0 ? void 0 : _r.payment_type) ? index.h("span", null, (_s = this.folioData.payment_type) === null || _s === void 0 ? void 0 : _s.description) : index.h("span", null, "Select..."))), index.h("ir-dropdown-item", { key: '25bf9962574791104bdace450d37b53a70caebbe', value: "" }, "Select..."), this.renderDropdownItems())), global_variables.PAYMENT_TYPES_WITH_METHOD.includes((_u = (_t = this.folioData) === null || _t === void 0 ? void 0 : _t.payment_type) === null || _u === void 0 ? void 0 : _u.code) && (index.h("div", { key: 'be9cb05cac206c39494863a18e678b4c11240f96' }, index.h("ir-dropdown", { key: 'f4c00d450e2e4dba761b723e40e2c7ebb1b3620f', value: (_w = (_v = this.folioData) === null || _v === void 0 ? void 0 : _v.payment_method) === null || _w === void 0 ? void 0 : _w.code, onOptionChange: this.handlePaymentMethodDropdownChange.bind(this) }, index.h("button", { key: '9e2a91600f59651fd706b1ae903f971aa9f0defd', slot: "trigger", type: "button", class: `form-control d-flex align-items-center cursor-pointer ${((_x = this.errors) === null || _x === void 0 ? void 0 : _x.payment_method) && !((_z = (_y = this.folioData) === null || _y === void 0 ? void 0 : _y.payment_method) === null || _z === void 0 ? void 0 : _z.code) ? 'border-danger' : ''}` }, ((_0 = this.folioData) === null || _0 === void 0 ? void 0 : _0.payment_method) ? (index.h("span", null, (_1 = this.folioData.payment_method) === null || _1 === void 0 ? void 0 : _1.description)) : (index.h("span", null, "Select ", ((_3 = (_2 = this.folioData) === null || _2 === void 0 ? void 0 : _2.payment_type) === null || _3 === void 0 ? void 0 : _3.code) === '001' ? 'payment' : 'refund', " method..."))), index.h("ir-dropdown-item", { key: '78478b72fe986bf4947be0c0ae06ab3717b7ab53', value: "" }, "Select ", ((_4 = this.folioData.payment_type) === null || _4 === void 0 ? void 0 : _4.code) === '001' ? 'payment' : 'refund', " method..."), (_6 = (_5 = this.paymentEntries) === null || _5 === void 0 ? void 0 : _5.methods) === null || _6 === void 0 ? void 0 :
            _6.map(pt => {
                return (index.h("ir-dropdown-item", { value: pt.CODE_NAME, class: "dropdown-item-payment" }, index.h("span", null, pt.CODE_VALUE_EN)));
            })))), index.h("div", { key: '300ba4ba509113f5bf19046fb09ce514853d2c76' }, index.h("ir-input-text", { key: 'dfbbf757360e944928c3fc52b671839caea51850', value: (_7 = this.folioData) === null || _7 === void 0 ? void 0 : _7.reference, error: (_8 = this.errors) === null || _8 === void 0 ? void 0 : _8.reference_number, autoValidate: this.autoValidate, zod: this.folioSchema.pick({ reference: true }), label: "Reference", maxLength: 50, inputContainerStyle: {
                margin: '0',
            }, onTextChange: e => this.updateFolioData({ reference: e.detail }), labelWidth: 3, labelContainerClassname: 'col-4 col-md-3' }))), index.h("div", { key: '59986d51a542a340121d9cb12951133560ee8f62', class: 'sheet-footer' }, index.h("ir-button", { key: '90dfa974f50313093939c0117caf5f061f816561', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: 'Cancel', btn_color: "secondary" }), index.h("ir-button", { key: '188f903dd7cac4041cf82690eb3258a117ff4791', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: 'Save', btn_color: "primary", btn_type: "submit" }))));
    }
    static get watchers() { return {
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: 'd55d1bbe439a85d60f4d06ba2afb125a28749a8b', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '59eb2e3cb4d1cd7f5710548f9387411142f991f3', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: 'c063b41055f5c2803e13ce59b9d5ab0f914a752c' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '934f7440170576ea57ece36bdd153f8284d66b3d', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '9c99a9c2162a1322c69f17c0582eb42c6799f7ce' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '2ac569872da9971d39bb8d6e234c35b758f592e6', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '32820c216f9b89663eba71b0ce2983f1deaffe82', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '0fe4ca9740c26463d004afd8047de5b10435f2a4' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: 'b54d7eab4d1ef3f61d105a5bdc6c59029aa7c3f8' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("div", { key: '9e7aef89c52fd4d8061abcbfad9e7384bd2b03a6', class: "mt-1" }, index.h("div", { key: '68e5425f99add400cd37ad23f4a973750b7a2a1a', class: "d-flex flex-column rounded payment-container" }, index.h("div", { key: '4891fe4e5e636aeee38f6680c015db9e54e170ad', class: "d-flex align-items-center justify-content-between" }, index.h("p", { key: 'ab01415c5388291f148b5777593f49314a7c97bf', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h("ir-button", { key: 'bbe393244bba66436ad00de91895418c9ca91f63', id: "add-payment", variant: "icon", icon_name: "square_plus", style: { '--icon-size': '1.5rem' }, onClickHandler: this.handleAddPayment })), index.h("div", { key: '7a79db1fde71e2567b6b16ee623b555c628fcf22', class: "mt-1 card p-1 payments-container" }, this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bac37c54eb6999d06b54165a5bc20276fb0ea7a8' }, index.h("div", { key: '28f66fe4079db98315d66e12a7f6bc813fdd57e0', class: "form-group mr-0" }, index.h("div", { key: '4210cd88388f4e6e94f62db050c53eee68cad83a', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: '3175b8e83884ab493f2daef346b22bf05f49ef39', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '61e04abbedf064fb93261776c8e75628307980a3', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: '48a8b92f145ce172531f1d2645ca2e88f9946aae', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '2afc3b701e9c17101e137b69497eaf4ad611e178', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'dda89d7b829036dd27b56fcfd07ca14d0303c5e0', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'b46f285651855065cafb10570b0b0681fe79e10a', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'e0ef29bff339b4e8e3307ddb0a9c932a7c30d728', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: '2fcb3512f1586f6694987c540e8a766763a5bf80', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: '77704a673e5d2c3008a115e2528ca5ef21f85f00', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: '5e58acbedd8a8c512bb77f0f2358f66f6018e151', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: 'dd1e6dfe8cfc4bd829f467429928a9f302ba6229', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '560fadcbb0e89ff5cd20d803d3b124a133878570', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: 'c7cfb5c667303641bfb016329794ba938dff4479', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '32a12e034e8eaecdd7201494afe19f00895bcc44', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '5a91828625e4d7d4a0555c2bba636ead8b7b80c1', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '75e6213d537bafbe36af62e5068167216bccd05d', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '91a5eae35cbc3efe96d79b4015139d594ca5fd80', class: 'd-flex' }, index.h("div", { key: '7348bc029008dd464d1dae58d81ee9d40f1c95a4', class: "form-group  mr-1" }, index.h("div", { key: 'f9a67a399dca035a770cfb75af08c9a89916c33f', class: "input-group row m-0" }, index.h("div", { key: '45e911c0d599ccbbe7d7872e22a7a3487869c527', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '33de3b4e405a0a5be0156139dd8496b81ca0251c', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '22ed037175fc436ef04818c4027542007d148760', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: 'a4f8e4a2443e49d8da36afdd519ce640e142de01', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: 'fc8e3058487e91d45bfceffc2ab5dd96e9720de0', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '3a11f457f840d85eaef3baf2450111c6f51a864a', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: 'ddc9411a1a4f059fadfd1247851466981a52cf40', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '3dc7eec2f6f1f8c3607760a49cc0a105bb8938b1', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'a23b8582f8bc81a82870b57fc0937cd6e7d01cff', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '8b49f49e643eb69914d981d3b08c409b1fe12c3b', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '2548fc95590c4d93f9d0db1060fd4e62727d45f3', class: "price-input-container" }, index.h("ir-price-input", { key: '472d1a7808c8a151bda9952b2c9c2f5311207c9f', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '7fdaa17f2feb8f346b77424fe2df9a58c4e76ca4', class: 'sheet-footer' }, index.h("ir-button", { key: '48355dd6143c10c91acec2210b5e23fa4674c84e', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '9082722c3b064f08b269610aab0d87789a924314', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fcb48c584fc19d7c4f8359ed6b852e83e49d9e6a', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '80e9e7ccaecaed0a0ea188eb70fe4e6421c3c2ee', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '9f42120bad1ae01a15039237c968398e2bca4441', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: 'd41af3e784806558232e09bbffdcb0e80098d37c', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'd2ad0c1e06bebe9fc2c5eaec3006d11cd10f3ccc', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '3f4b17783923057a3873b4651ffb1c0cbf731402', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'f71cd94aa7705e85b20144f4882349e76d2e08fc' }, index.h("span", { key: '30ad6ccd2b3130326c16357d5c202b30a31c98e5', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '693cecb90e291f5472ff4be95ee72bab9443ae45', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '195ad20a1517ffc050da94784d962089260e2083', class: "card" }, index.h("div", { key: 'bb34527be78d3b0122d115588280db5c50995ef1', class: "p-1" }, index.h("p", { key: '4db979af93312cb7c5c051015d1c20e399ae35d3' }, this.booking.property.name || ''), index.h("ir-label", { key: '81ae81b7ee31db0b0ac771cf6517b96c6f440b4d', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'd40492a75b01160359764d73d8ff2b35e19fd525', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '5d8137b9fedda2a36151c1bad62396242db5d197', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '0f751aa431d37bd1bdf6b4a76b5dbcaa076a5b6d', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: 'edb49326f2a7bc37555fc13282f0a744a1cc93da', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'afa70d221d8cb5496f6f1beb98d2e8a778577849', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: 'a7479e253b8961d7b0b192b175e84a2ed18fd786', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'df1a0999a88fca2ca095882c59b9cf79a07decca', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '19fac92fcd5ab120a314e2d8fd42b968ac3b0cb9', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'cb6f8407ffae3fa025fb6ca2d3b85af6af7086e9', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '356ed998241a1312fd414c32da79bbc2e9ec29fa', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '23e4fb585724b97e05a63eebb9e56376fbaf08bb', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: 'dc0086de742438bef1b2abd68d761f760e72faed', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'f2746af92c8381c8caad2518c7f9307d11d80400', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '701b5099d6c55dfbfb4ba880ab486a56b8b47335', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '44394b0bd109fea316ac2ad466ceeaec71e4a814', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '8e56541dccdcf2d1c87dea8e87c17efc1382e732', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '94b43a38b6130d3e44944b8ce4382259744ef88a', class: "d-flex align-items-center" }, index.h("svg", { key: '6cd634968739c5dc9c101c708f755ccbee103ac5', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '5900e4ed1dce779b80daa7a5f687f9599dad1f43', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '50447c1b204f3b9587f6743829a66506ad54678c', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '9b67bf5380c4db7ef76016c03b3f5ea0a4547067', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: 'c34fe7b11f83e95705505d081b66992581dc137e', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '9a2be28ba63a9d7dbe59d485f3a67509f2bddd2b', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0287902af625c6bc7a8beaf08c1093809c31d572', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'aaa5bb89d8f15a83e4c88c0956574eb615a5761e', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'c6d776ce2addb232bebfb89a8f63519ae3b7fd13', class: "flex-fill m-0 " }, index.h("div", { key: '0824d1bcdc7658165d2b391ae1bd696957a3cd8a', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: 'f24261dd0782776940f4a0b15b9f49b33a5e377f', class: "m-0 p-0" }, index.h("span", { key: '4c6b572428df32dc6c3c4c0304d36311cf32ef90', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'ddbbed0a2f4d1a4062458d1a92ce16ec51992525', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '359ea9ad73352cb217d21d97834cd0a04cca2f0d', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '7a569493d6de96293fe84ae4359690054b807563', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'f6652036789e297c0a37d1af3727c232f6f47539', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'e5034627c0daadc2dcc80bceafd90de7e37282e9', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '7657dbea3b76674d5a1d9d0ab00ab89598535870', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '7a0a6e68f09070118e93173ecb2328c9cc35edb7', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '760741fc2e07b21450f097f11a98e16b06c8cbc9', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '2a8650292de300706d670c58e30f596d13da035c', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '3f6f6eaa57cfdc209e811059fff8684c6a58a2fb', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: 'ebe2c5136f0813281003db39800ace4f531c3a54', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '453714907c0f18a394d6aac222bf49803c9e29df', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'bce5710c812eddf397efa25859d42f88c1a31b1e', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: 'f2ce42aa93e6df629927b44312f7f640cf1baac2', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '9d8081cf13873c8028b5b6b46645c2af0ac08d0b', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: '1da486a6855701ec52595fcdcd24cb2743343cd9', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: '553ca81d9949e57d708edfd92ab4a030458b1f09', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: '183e02ebaaa1b6a321956d5e71e8a1868a61928f', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: '77b4593ed35a33ce695a1eb9de71efdb4b8b8bfa', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '8b5660a9936fa7b3edbf882904a4156eee2b4d6d', class: " sm-padding-top" }, index.h("p", { key: '4a86e1b2bce965837d4716b4db7eb1cdaa87f649', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '2c9c4788365a20eb3cfffbc31d657c2bcfaafcc0', class: 'flex-fill' }, index.h("table", { key: 'a98dfbcf964565c34bb3c8ee82d34686dc65ba65' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '98f91236a0b9dfb4e547124877876283fcc4f595', class: '' }, index.h("th", { key: '9e384650e68198afc47fc97f6dfcd6e428413bb1', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '7f10ceed31a732f19452a13ff7105e5aa4b04536', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: '0673c2939bbbb46b41f6969da7717aa2b087930f', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '2889d3b88c108c052423f8a3359650521af261e2', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'ef9a62a6f14c1978932add73d5e4786255557f79' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '9249d858778e4a19d9925934c6a261530356f796', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '539a3c18de8e211ed82378d2ed5f0586cbd658c6', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: 'a6204c791adfe98ce202807d68618014c6751a61' }, index.h("ir-label", { key: '642046ed7d975b390ff13d6d6deb6b6a1dc9d4d2', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '155190857e1c2356b9d4c63cae4cf64fa3a76922', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: 'd3be10eeae4dc6b1604bf541a34ae5f386f6370a', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3b556b263ad133941eaa02579e2762fed7c700c7', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'fe4b1fdf3967103b4c8c1105ed0ec3f3c77961ea', class: "input-group row m-0" }, label, index.h("select", { key: '13f3e9071e22fa441c0b26358b3f13ffedd02395', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'd320f00fe6afdb58fdeef0ccb3957b18a2482c73', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '87cf49ea5bb0a1ae32d66bf1fc992cff07627398', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '3fb6e85544b1c8ee8ddb716fce24fd3a7e8c2cd7', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '991f5d7cf43eaaefab21f78b4100c6730419d89b', class: 'sidebar-title' }, index.h("p", { key: 'db6e2a73b1ba90a377b33d6f65b8162d387152c0', class: 'p-0 m-0' }, this.label), index.h("div", { key: 'a0cf544860bc2b7a78065b4e679025b18cd59c4e', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '77b76a8499f51a371e8fcaae411b32f581b2f76f', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '2c9f372f3f6157ac7257a9bd6cb3dd5bdab8eecf', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '3114ae7e7f97da36d5f4f207dbb38e8638e8b46d', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '85b6e0425acaec1b3a6813005a185b880bf1bfef', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '9a92b6e1b011d42af6d19eada8e2280d1a42da0a' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8d461f265e1574ab3b8219451edb7addb514c8be' }, index.h("h4", { key: '9b9999164f1549fbcd6b9712a6e23f2daf935fc2', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '077fd50443c00511f6c82af8463a34acfe4dfa90', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '877c39c7012a028d16ac2d0cb76ea66352e69348', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'a6d2dc7aadd094ba11dc24a8d348ebb9c19b18db', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '06d7c28f17f7acdde8ee1078456d1e843031952e', class: 'title-body' }, index.h("slot", { key: '45a32433514ebe0526d38fb7d6b2293d925e2942', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
