...
const IrHkDeleteDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { lightDismiss: false, label: label, open: this.isOpen, onIrDialogHide: () => this.closeModal() }, !hasAssignedUnits && (index.h("p", { class: "delete-modal__description" }, t.t('Lcz_ConfirmPermanentDeleteUser', { fallback: 'Are you sure you want to permanently delete' }), " ", index.h("strong", null, this.user.name), "? This action cannot be undone.")), hasAssignedUnits && (index.h("wa-select", { size: "s", defaultValue: this.selectedId, value: this.selectedId, onchange: e => (this.selectedId = e.target.value) }, index.h("wa-option", { value: "" }, t.t('Lcz_nobody', { fallback: 'nobody' })), housekeeping_service.housekeeping_store.hk_criteria.housekeepers
...
const IrHkOperationsCard = class {
    ...
    render() {
        return (index.h(index.Host, { key: '750faf6ad9fb852de48090910bd7f8a2318baf5a' }, index.h("wa-card", { key: 'b1cab7d5964547f63ced401b643662a87deb96ef', appearance: "plain", class: "hk-operation__card" }, index.h("div", { key: '71781f8f63b397bb21e1ee114ee58b8807066e98', slot: "header" }, index.h("span", { key: '549733272c736ae175d6c2ff9a4b134c119888f0', class: "ops-header__title" }, t.t('Lcz_OperationsSettings', { fallback: 'Operations Settings' }))), index.h("div", { key: '04ac47f2bcfe11b3542e5df5b354b8a9915cdde1', class: "ops-settings" }, index.h("div", { key: '3cf6f5f2672813f4a3e233cf126b85998c9fa9d0', class: "ops-setting-item" }, index.h("div", { key: 'b7eaef67b7073fe0337a088a7bfa60c1bd0dabba', class: "ops-setting-item__info" }, index.h("span", { key: '1d5c719276b11ab0d7decfe32c2a347d6e288326', class: "ops-setting-item__title" }, t.t('Lcz_AutomaticCheckInCheckout', { fallback: 'Automatic Check-in & Check-out' })), index.h("span", { key: '4aafd3b9e56d5f81fa6587f8b0d4c24b19ad8d6c', class: "ops-setting-item__subtitle" }, t.t('Lcz_ProcessGuestsAutomaticallyBasedOnPropertyRules', { fallback: 'Process guests automatically based on property rules' }))), index.h("div", { key: 'b76214f22f187865de9d93add85c738905b42d6e', class: "ops-setting-item__controls" }, index.h("wa-select", { key: '82acf5aac7c8b2865f43f3f54e4635f7fd097457', size: "s", style: { minWidth: '260px' }, value: calendarData.calendar_data.is_automatic_check_in_out ? 'auto' : 'manual', defaultValue: calendarData.calendar_data.is_automatic_check_in_out ? 'auto' : 'manual', onchange: (e) => this.saveAutomaticCheckInCheckout(e) }, index.h("wa-option", { key: '1f20605908255825d113db829536ca12633d4842', value: "auto" }, t.t('Lcz_YesAsPerPropertyPolicy', { fallback: 'Yes, as per the property policy.' })), index.h("wa-option", { key: '7b29a6846151c55b771ac7d363d3d57e0e792a47', value: "manual" }, t.t('Lcz_NoIWillDoItManually', { fallback: 'No, I will do it manually.' })))))), index.h("div", { key: '003ab401ef70a5e8b72e4353b831e8647a870a55', class: "ops-tasks__header" }, index.h("p", { key: 'a64257c360751d47eaca11b306e9b6dcc0c0fd54', class: "ops-tasks__title" }, t.t('Lcz_RecurringTasks', { fallback: 'Recurring Tasks' })), index.h("p", { key: '0ff95b7c77d45791f454ba48d3d7c9f876c78926', class: "ops-tasks__subtitle" }, t.t('Lcz_DefineYourHousekeepingTasksAndFrequency', { fallback: 'Define your housekeeping tasks and frequency' }))), index.h("div", { key: 'fa760d52b0e029434efe99d3f358c11f6d94095d', class: "ops-tasks__list" }, index.h("div", { key: 'c6aa330035369145da362e7a9743e0fb66fbd4d4', class: "ops-task-row ops-task-row--locked" }, index.h("wa-badge", { key: 'f05e1d9a1574a849f31b4ff285b21dc7a8ad50fe', variant: "danger", appearance: "filled" }, t.t('Lcz_CleaningAbbreviation', { fallback: 'CL' })), index.h("span", { key: '8ffc0ad81c39997bb62b9c08f181d288929ded3e', class: "ops-task-locked-label" }, t.t('Lcz_Cleaning', { fallback: 'Cleaning' })), index.h("wa-select", { key: '9c28d70602a075a35e92ebc99e75d37baea2a3d3', class: "ops-task-select", size: "s", value: this.selectedCleaningFrequency, defaultValue: this.selectedCleaningFrequency, onchange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.selectedCleaningFrequency = e.target.value;
                this.dialog.openModal();
            } }, housekeeping_service.housekeeping_store?.hk_criteria?.cleaning_frequencies.map(v => (index.h("wa-option", { key: v.code, value: v.code }, v.description)))), index.h("span", { key: '7e2c3eae9e55b986b9cc2c5d660eed3618bc87f7' })), this.hkTasks.map((task, i) => (index.h("div", { key: i, class: "ops-task-row" }, index.h("wa-badge", { variant: i === 0 ? 'success' : 'brand', appearance: "filled" }, "T", i + 1), index.h("ir-input", { class: "ops-task-input", size: "s", placeholder: i === 0 ? t.t('Lcz_ChangeSheetsPlaceholder', { fallback: 'Change sheets, ...' }) : t.t('Lcz_AmenitiesRefillPlaceholder', { fallback: 'Amenities refill, ...' }), maxlength: 30, value: task.name, onChange: (e) => {
                ...
                this.hkTasks = updated;
                this.saveHkTasks();
            } })))))), index.h("ir-dialog", { key: '01ac05add09d9e278e493f68b7d67e752a6973cf', ref: el => (this.dialog = el), label: t.t('Lcz_Confirmation', { fallback: 'Confirmation' }), lightDismiss: false }, index.h("span", { key: 'ec0685a51a2135ad66a15cb553ad90c0a0a1e6b6' }, t.t('Lcz_RescheduleCleaningTasksConfirmation', { fallback: 'This action will reschedule all cleaning tasks. Do you want to continue?' })), index.h("div", { key: '36d480d222ddac23cf1d7c0c02bfcfb6995de4dd', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '35c9660d679e4cb064221e97987012b9b3f5d766', size: "m", appearance: "filled", variant: "neutral", onClickHandler: () => {
                ...
                this.dialog.closeModal();
            } }, t.t('Lcz_Cancel', { fallback: 'Cancel' })), index.h("ir-custom-button", { key: '6d3017d5d8ee0819813518893f179b44783eb98b', size: "m", appearance: "filled", variant: "brand", loading: irInterceptor_store.isRequestPending('/Set_Exposed_Cleaning_Frequency'), onClickHandler: () => this.saveCleaningFrequency() }, t.t('Lcz_Confirm', { fallback: 'Confirm' }))))));
    }
};
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'ae892351c02b3c664ee948121f7dc13479ff04d8', class: "sheet-container" }, index.h("ir-title", { key: '75857472e289414d89d6ae1824be4176cdd2ff7b', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? t.t('Lcz_AssingnUnitsTypo', { fallback: 'Assingn Units' }) : `${t.t('Lcz_AssignmentForUser', { fallback: 'Assignment for' })} ${this.user.name}` }), index.h("section", { key: 'cf9939191f14ab04f32db9cc93841655233c63a1', class: "px-1 sheet-body" }, index.h("table", { key: 'bc9882213b527840aeb6a5448ad16b9c190d5f8c' }, index.h("thead", { key: '10805006ec07ffbe25f0bd6c30944b82f5cae056' }, index.h("th", { key: '35c4ef28922b8b734029b5de0ada2727b45985ac', class: "sr-only" }, t.t('Lcz_RoomName', { fallback: 'room name' })), index.h("th", { key: 'f6737bb1d1846df2479537f3a7354bde01a9d0c6', class: "sr-only" }, t.t('Lcz_HousekeeperName', { fallback: 'housekeeper name' })), index.h("th", { key: '94369185079ca469fc6fc802efbbbcd5b028910e', class: "sr-only" }, t.t('Lcz_Actions', { fallback: 'Actions' }))), index.h("tbody", { key: 'd8e902fe9db83acd58389ab9054be59a4c21cb01' }, this.renderRooms()))), index.h("div", { key: 'b963dca707d808ba9ae47d049a4e31743cb6414a', class: "sheet-footer" }, index.h("ir-button", { key: '26c672f1a7dd5e51bc5ea144821a38deec3b8254', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: t.t('Lcz_Cancel', { fallback: 'Cancel' }) }), index.h("ir-button", { key: 'c6050fe7d15832c41e73a62895fe8ba1ec3942a7', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: t.t('Lcz_Confirm', { fallback: 'Confirm' }) }))));
    }
};
...
const IrHkUnassignedUnitsDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'e55d1013a0199f8c363b9f5642886dab805d850c', label: !this.user
                ...
                e.stopPropagation();
                this.closeSideBar.emit(null);
            }, style: { '--ir-drawer-width': 'max-content' }, open: this.open }, this.open && index.h("ir-hk-unassigned-units-drawer-form", { key: 'a232a2262e2ed9cfa7b84448da1aefe2d7d8a413', formId: this.formId, user: this.user }), index.h("div", { key: '23e8c56a93f76f5d1c7a2cefa3b7f217e7daf126', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '2c1a9f9b3552cbc7cb980994c390d464b530df0f', "data-drawer": "close", variant: "neutral", size: "m", appearance: "filled" }, t.t('Lcz_Cancel', { fallback: 'Cancel' })), index.h("ir-custom-button", { key: '5e9b7d8fd807775004dd4c1e9f0f78c4a8a4e4fb', loading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), variant: "brand", type: "submit", form: this.formId, appearance: "accent", size: "m" }, t.t('Lcz_Save', { fallback: 'Save' })))));
    }
};
...
const IrHkUserDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '2cb1265d0ee04d14f9c6a5b2573b74facd796b31', open: this.open, onDrawerHide: () => {
                this.closeSideBar.emit(null);
            }, label: this.isEdit ? t.t('Lcz_EditHousekeeperProfile', { fallback: 'Edit Housekeeper Profile' }) : t.t('Lcz_CreateHousekeeperProfile', { fallback: 'Create housekeeper profile' }) }, this.open && (index.h("ir-hk-user-drawer-form", { key: '24a3b16026f39772fd86e184ab9c45fcdd4e56f3', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            }, isEdit: this.isEdit, user: this.user, formId: this.formId })), index.h("div", { key: 'eb1ccebd60c204683bf6568e3ac4b2a3862578f2', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '5c19f268e5f3044e950a77f302fc4d2f8d210a95', "data-drawer": "close", variant: "neutral", size: "m", appearance: "filled" }, t.t('Lcz_Cancel', { fallback: 'Cancel' })), index.h("ir-custom-button", { key: '4840621db08ea4aab31f248c2fd9e42d2234fcb1', loading: this.isLoading, variant: "brand", type: "submit", form: this.formId, appearance: "accent", size: "m" }, t.t('Lcz_Save', { fallback: 'Save' })))));
    }
};
