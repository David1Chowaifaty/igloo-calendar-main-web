...
const IrTasksCard = class {
    ...
    render() {
        return (index.h("wa-card", { key: 'bcd6a99e50712be72073bf9bc91f9f0f6498f5a7', class: "task-card" }, index.h("div", { key: '7551f86e2e039758d41aa80b896f3f24536dd6df', class: "task-card__body" }, index.h("div", { key: '5a8e3bf4ded8d5a73bc9357ba9689c4423f1061c', class: "task-card__unit" }, index.h("span", { key: '11119a54a0b2ec0498a37f214b605deded9d70d7', class: "task-card__unit-name" }, this.task.unit.name), index.h("div", { key: 'ff1db92315bbd55150c26c0256dc93bbb057ad8a', class: "task-card__meta" }, index.h("span", { key: '0cbee4fd26ce939ada1e6a7cdb64419e4f95db17', class: "task-card__status" }, this.task.status.description), this.task.hint && index.h("span", { key: '358bd4b374f69cd9db593470577e32065f60cbe6', class: "task-card__sep" }, "\u00B7"), this.task.hint && index.h("span", { key: '2d87ab385fdd60a2341d097d75dcbeceae08ba6b', class: "task-card__hint" }, this.task.hint), index.h("span", { key: 'b9812d47b94ddc8b1b25efb489fa44ae44365e0e', class: "task-card__sep" }, "\u00B7"), index.h("span", { key: '07f47ef99694fe5dac33e4194ba129cb6e5c58e6', class: "task-card__date" }, this.task.formatted_date))), index.h("div", { key: 'b77c9d41c1ca669b7a8723c6cd251f458b615610', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (index.h("div", { key: 'f49d8dede96d2de3da7602f2c5b144481c536b34', class: "task-card__guests" }, this.guests.map(g => (index.h("div", { class: "task-card__guest" }, index.h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), index.h("span", { class: "task-card__guest-count" }, g.count)))))), index.h("div", { key: '1506697589ba8773d1f180fe02775ce6859bc012', class: "task-card__assign" }, index.h("wa-select", { key: '7bca214c22f2fa1876498120ac2750102c116941', label: "Housekeeper", class: "task-card__hk-select", size: "small", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, housekeeping_service.housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (index.h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), index.h("div", { key: '92efe622e712c20850e7ce8e963b9b0c049b4811', class: "task-card__actions" }, this.isCheckable && (index.h("div", { key: 'bae7e8ccd7dadd8b03d1de85b75a4aa30ae4ab81', class: "task-card__clean-group" }, index.h("ir-custom-button", { key: '90505a5f1099174b72f2771a06408a63ce476484', variant: "brand", appearance: "outlined", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '001' });
            } }, "Clean"), index.h("ir-custom-button", { key: '13535094fc24056fd74a3367b0c9fe0b81288b15', variant: "brand", appearance: "filled", onClickHandler: () => {
                hkTasks_store.toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"))), this.isSkippable && (index.h("ir-custom-button", { key: '3885a16ea9f82cd12d6c58fdf7610efe45f4d939', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip"))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '68d7b2216703d310cd306a4e7d8801725fce5319' }, index.h("div", { key: 'f9bf5a6decc1eaf9c1b8e3b0ea6bd6bb13cc8cb2', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input", { key: '80b57d5f4c5549ee56831881d70885f982a28d6d', placeholder: "Search unit", class: "search-filter-input", value: hkTasks_store.hkTasksStore.searchField, "onText-change": e => hkTasks_store.updateSearchField(e.detail) }, index.h("wa-icon", { key: '05ee91ce78e0cf768d5ef5b9808422dd9d784940', name: "magnifying-glass", slot: "start" }))), index.h("div", { key: '629c881360d9919f1b53ff7f2c202a9feea086c9', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-custom-button", { key: '037fbac46373498dd904eaa7b5a5612f50499eef', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }, index.h("wa-icon", { key: '6f5ea8e1f105fd6fecfa48657f3f9b5c5ca38721', slot: "end", name: "file-excel" }), locales_store.locales.entries.Lcz_Export), index.h("ir-custom-button", { key: '1f68597d810044bd09c53d736b83d6e7ccb62fe5', appearance: "outlined", variant: "neutral", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }, locales_store.locales.entries.Lcz_Archives), index.h("wa-animation", { key: '4f99a75ccb720e11d2f4bde06b8450f41f34495b', class: "clean-button", iterations: 1, ref: el => (this.cleanInspectAnimationRef = el), name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: '96b8cce67459ede76ee4ef708caae2347b5fbf25', appearance: "filled", variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'clean-inspect' });
            }, disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0) }, "Clean & Inspect")), index.h("wa-animation", { key: '92973872f7331f13ec28ad7d534dbcf158e87428', class: "clean-button", iterations: 1, ref: el => (this.cleanedAnimationRef = el), name: "rubberBand", easing: "ease-in-out", duration: 800 }, index.h("ir-custom-button", { key: '3a1f5a10be1d572ac15c15fa1833b88ebae8c0ac', disabled: !(hkTasks_store.hkTasksStore.selectedTasks.length > 0), onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e54a0888b240a0e05ee1de065382e667dabaa41a' }, index.h("section", { key: '32d76bad994b474801acd6d19807646bb182cf49', class: "mobile-tasks-container" }, index.h("wa-card", { key: 'd5d1a4cfbccc27fe49ab1f079d11abab8e4ca09e' }, index.h("ir-tasks-header", { key: 'c0f692efaf3746bf030d27fd2159a47db69ee557' })), mobileTasks?.length === 0 && index.h("p", { key: 'aa369ea6c5c2460687cce2742ff739d6eaf4faa8', class: "empty-msg" }, locales_store.locales.entries.Lcz_NoTasksFound), mobileTasks.map(task => {
            const isCheckable = this.isCheckable(task);
            const isSkippable = this.isSkippable(task);
            return index.h("ir-tasks-card", { task: task, isSkippable: isSkippable, key: task.id, isCheckable: isCheckable });
        }), index.h("ir-tasks-table-pagination", { key: 'e66d9389a7ec3d33afee282f5815dbd9917d6baf' })), index.h("wa-card", { key: 'b558a42616b8a34fa45666d1271b3ad0ce6936bc', class: "table-container" }, index.h("ir-tasks-header", { key: '990775b377a905e51375cf2ef9053e8293c53641' }), index.h("div", { key: '88a2d9854f9a1d73c494319dfc6bbaf74f54cee8', class: "table--container" }, index.h("table", { key: '895799d96fc21cfeed903ff92b69f2c55c4c399f', class: "table data-table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'fe48519d545e1700ccae057b6449f6e8ab4cc985', class: "table-header" }, index.h("tr", { key: '2e3af5222b1d858ace9188a0033cdf83f575e8a6' }, index.h("th", { key: '9ac77e01cfccaf50061564d18a2a6ad3aac4c9f6', class: 'task-row' }, index.h("wa-checkbox", { key: '549e8270d24bb3d7221da2f09b3e7fdb1711a5b8', indeterminate: hkTasks_store.hkTasksStore.selectedTasks.length > 0 && hkTasks_store.hkTasksStore.selectedTasks.length < hkTasks_store.getCheckableTasks().length, checked: this.allSelected, defaultChecked: this.allSelected, onchange: () => this.toggleSelectAll() })), index.h("th", { key: 'a22631e62a172cb9194a4f3d75c4b8bd6b69c42a', class: "" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '2c4ee2a0137970202bc36ee9f7d868dd792420ac', class: "" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '3caccd9f77b8dff1fb25ad7f44a1168b179da34a', class: "sortable", onClick: () => this.handleSort('status') }, index.h("div", { key: '5f1d1fd5ec56271899301d1368f01fe4c97e4824', class: "th-sort-inner" }, index.h("span", { key: '29de8728128b351c6e630e3956b526ec661d3381' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '2dd94a629ffdc0aa422407aac86d09edee23ebfe', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'dbdcd8a385d4940991e35ae3f75cf550e9791c1c', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'c104e8df3f991b05ad8dfc3ca0b854e6c01a505d', d: "M17 20V4" }), index.h("path", { key: '50c1794407ac37a6f92817e4c7d62e9b44821ff0', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'dd7eff1335f82bf082420fc4d5043c69a67a566c', d: "M7 4v16" })))), index.h("th", { key: 'ba41c289dc91ab21bcb1ec06e417ae17e5a21637', class: " text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: 'a29658690b9c3fe511733b3fde3b43df928886ed', class: " text-left" }, "Tasks"), index.h("th", { key: 'd843b90cd668eb565a5e04eaa335fbf7f2597884', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: 'fab781016ce1f552694630b516fedf5c788a65f4', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '603e7fab6980fce8791e9cccbcd995d1efd8f380', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: 'c8f34d9c3d0a7aee19c95a162788a11a16b51ef6', class: "sortable", onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '6766764bac5c6fe8f0de01b3c44ab3ad2cec42db', class: "th-sort-inner" }, index.h("span", { key: '5a1977189dfef72dc28a9cd522824865f44f7dfb' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: 'b8111c7ed28e2bd9ca928bf62e9e6b5616965b32', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'cd34647236deb560cf9f75994b401bd744ad8d48', d: "m21 16-4 4-4-4" }), index.h("path", { key: '493e6b0b454a54a657c699e81eb8e508e6143b8c', d: "M17 20V4" }), index.h("path", { key: '13cf98ad8b97134f07ed017a8f177e695980cd50', d: "m3 8 4-4 4 4" }), index.h("path", { key: '298114ddb442deaa774a12c9c67ce1e709be4c92', d: "M7 4v16" }))))), index.h("th", { key: '532fa18cd9755b758068e97d0f8d94f28455bee3' }))), index.h("tbody", { key: '80aab7d2edc0d56a9b2c8130a973c6ed9995986d' }, tasks.length === 0 && (index.h("tr", { key: '58098f6029a45bba3a6f9d948e032122be93f255', class: "ir-table-row" }, index.h("td", { key: 'c76b304febe3842782c6622c864c3cb5928ca1a1', colSpan: 9 }, index.h("div", { key: '4ff54999c0420bd1ec9b688c5775b07c702b0cc7', class: "table-empty-state" }, index.h("span", { key: '062a0ecc8b7a7c8412993cd918d74495bf6857e9' }, locales_store.locales.entries.Lcz_NoTasksFound))))), tasks?.map(task => {
        ...
        })))), index.h("div", { key: 'c88e3ddaee3cfece85d980a436d53e7eec900a0c', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: '61f47f49c04cdda40c884d28a3d5fc3f1d35f5d9' }))), index.h("ir-dialog", { key: 'cd7bb115f0b146e66ba91933aef9d95067aa6c92', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: '62d7c1fa428e6cd2a769617876d3043fafbebdd3' }, locales_store.locales.entries.Lcz_Assign, " ", index.h("strong", { key: '46b09abe2a6aa20de082d09617a2098a7df99fbb' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: '165761b22700348b9ade3a3779817980ad1182a1' }, pendingHkName), "?"), index.h("div", { key: '05c4b069e5493a93e8bd4bd17b1a4e6a389c2057', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: '8d22b6b787d3359f472c429f595b6c69fb267b10', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '404b46ef446289b9025c062d98b4c038ac53642a', size: "medium", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales_store.locales.entries.Lcz_Confirm)))));
    }
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '00591432cb32b455b7607b31dfeb67678cca1556' }, hkTasks_store.shouldLoadMore() && index.h("ir-button", { key: '19681bc03e4f27244ff689f45f983586e1f62a43', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => hkTasks_store.loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: '103b1a7550ca52dd01c53b6b6a437dd83d7e1a27', showing: {
                from: start,
                to: end,
