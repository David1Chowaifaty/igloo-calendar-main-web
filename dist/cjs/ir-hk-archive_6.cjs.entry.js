...
const IrTasksTable = class {
    ...
    render() {
        ...
        })))), index.h("div", { key: '0f1c8709d13d6e8d7d5f317c33222a1d492dd1d6', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: 'cc62809a550d680e12323b04a3c792ca944dc62b' }))), index.h("ir-dialog", { key: '9f03ffbfae19f89ead5fcc153a822be023758be4', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: '53c65040f423d490c0004c3cef84897011f00ab4' }, locales_store.locales.entries.Lcz_Assign, " ", index.h("strong", { key: 'd4375dc35218f5e3437ad3cf45babffe24603b58' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: 'df1b15e6969c3676add82faaf83b1ce089a7f956' }, pendingHkName), "?"), index.h("div", { key: '6b2bc29f386b3eff885fd649f3c03cd2067a9962', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: '6fea5f415dc1fa63bbe3279562c1f924204f3ba7', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '68fd440a5a760aeff0c2480d421935ad021cf66d', size: "medium", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales_store.locales.entries.Lcz_Confirm)))));
    }
