...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '789fc15ec36dd4a7e8f9c38132ec3cda52939211' }, index.h("section", { key: 'd215d59b720c990e67cc78fdf22ff3028b07d589', class: "mobile-tasks-container" }, index.h("wa-card", { key: 'bf7024cb83ce4b2f60f5ee0165ce92db556fc450' }, index.h("ir-tasks-header", { key: '5fa18ef089d3ec0a6594096e633a8f237e3a74d2' })), mobileTasks?.length === 0 && index.h("p", { key: '90535c447b16c2904b28bbb3cf6ed7e78c0e1891', class: "empty-msg" }, locales_store.locales.entries.Lcz_NoTasksFound), mobileTasks.map(task => {
            const isCheckable = this.isCheckable(task);
            const isSkippable = this.isSkippable(task);
            return index.h("ir-tasks-card", { task: task, isSkippable: isSkippable, key: task.id, isCheckable: isCheckable });
        }), index.h("ir-tasks-table-pagination", { key: 'e8bf9f3627e7d07a526582f8d63ee66bb412fbba' })), index.h("wa-card", { key: '992d043476eda61350f18eee3fc105bbb0cef76a', class: "table-container" }, index.h("ir-tasks-header", { key: '8732d2e5bad8c6f8a9fc8ff7686fa491184edf6e' }), index.h("div", { key: 'b321e0c8d2f498258c8c17a8741117ca62bec73b', class: "table--container" }, index.h("table", { key: 'cdf786891abae31b964e917c044ce1e663bf93f3', class: "table data-table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '80f055eb7618acce6fc09104a2d7059b9bbbef95', class: "table-header" }, index.h("tr", { key: 'c559b2fae552cccef6a4d638bd0f85dbe77d1fb6' }, index.h("th", { key: 'f3a6b4ae086ff7e552d5055394cd06c7e960a9a8', class: 'task-row' }, index.h("wa-checkbox", { key: '63d262d4b77667657865200e8faef0bf8527e153', indeterminate: hkTasks_store.hkTasksStore.selectedTasks.length > 0 && hkTasks_store.hkTasksStore.selectedTasks.length < hkTasks_store.getCheckableTasks().length, checked: this.allSelected, defaultChecked: this.allSelected, onchange: () => this.toggleSelectAll() })), index.h("th", { key: '3398728d6075764f6376374df8e77a106c9f1181', class: "" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '4a49e5b83fce616521dde739334e146eb52a71ef', class: "" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '80869bb6f7434e6aa9f49b6ec824e638446a0fb2', class: "sortable", onClick: () => this.handleSort('status') }, index.h("div", { key: 'a06a6c9d5ecbabbcea98e8ed149356c930d144eb', class: "th-sort-inner" }, index.h("span", { key: 'bc883f34b1e1b5f7232a7720d24673ec5a98f1ce' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: 'c36158c6358b6a46f765e0b1b132f5a426ae6111', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '286c5af937a9801aab5b13822738085b6aa5d9a3', d: "m21 16-4 4-4-4" }), index.h("path", { key: '531c335f3c50151c662ee7b976507b01d38e52f4', d: "M17 20V4" }), index.h("path", { key: 'f390e607397b7857521b74f26f1ce76423030347', d: "m3 8 4-4 4 4" }), index.h("path", { key: '445292f36e636e2b26abbd2b3fd83a18723439f6', d: "M7 4v16" })))), index.h("th", { key: '993d66643c32036ff6585e43a7f5a2862b1209fc', class: " text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '8f423f0b73abb116695845211ca5e08366e80dd0', class: " text-left" }, "Tasks"), index.h("th", { key: '42ef9c899f553aa205c9fc4a4157586c1390a25c', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: '9824d126a63a2f346bd82214d3def9af1e66b284', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '89627a9a5bc6d91f9fabf1ee483c000e12681241', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: 'f2cb1cf62b3c141a12a9fda7fbef2eaef7d90a68', class: "sortable", onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'e98ae7756d8d34f185f59715fc716cadc2c07c90', class: "th-sort-inner" }, index.h("span", { key: 'a7c8240178a959a8a8ad9fd9d3cdc182c52615a9' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '9563586eb6d9b7059cceaa15aee91d58766a0d10', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'e811c0eb50efe80921df1ae65604b1c4c072ce04', d: "m21 16-4 4-4-4" }), index.h("path", { key: '3ff2f853086255e33b177e311fd60a7a0c720b7d', d: "M17 20V4" }), index.h("path", { key: '78ffbcecae0075d37c336ae305ab2dafbf0ebd65', d: "m3 8 4-4 4 4" }), index.h("path", { key: '5ddadfb1661659ee57b65d99f9bb6d572fee6de6', d: "M7 4v16" }))))), index.h("th", { key: '4738051cf4728ecfcab84fced619f197217f0d4c' }))), index.h("tbody", { key: '5e575eee1aabae19902b0f44dd28d43f39872711' }, tasks.length === 0 && (index.h("tr", { key: '9b7a7f7d02862c3c6860e2bad5f601aaa333c980', class: "ir-table-row" }, index.h("td", { key: '3c47dd6e2f37135cacca35c725efc6b751ce11ee', colSpan: 9 }, index.h("div", { key: '37f359c41580505b13754ccd316e22c9f97a57b0', class: "table-empty-state" }, index.h("span", { key: '873e763871b6ba578a61b8d329fe563c4b251cc7' }, locales_store.locales.entries.Lcz_NoTasksFound))))), tasks?.map(task => {
        ...
        })))), index.h("div", { key: 'aef4dcb2effb03b4f2a46dde5cb8e8f7f87c5bcf', class: "data-table--pagination " }, index.h("ir-tasks-table-pagination", { key: '3bd18125e651db3d8a264c933d7869f54f54c011' }))), index.h("ir-dialog", { key: 'be488bd77cfed95f476fd6894d6073312e10cb77', ref: el => (this.dialog = el), label: locales_store.locales.entries.Lcz_Confirmation, lightDismiss: false }, index.h("span", { key: '9d01a502e3e932a659dce840040a28f5a0d68859' }, locales_store.locales.entries.Lcz_Assign, " ", index.h("strong", { key: 'a04cb93d7dd29bb37a33d00154f6fe2260bb9341' }, this.pendingChange?.task?.unit?.name), " ", 'to', " ", index.h("strong", { key: '177aa767a76d2d07490906dea45bc0c08769af84' }, pendingHkName), "?"), index.h("div", { key: '45921c78666fd2a46c7240334968623533bacf10', slot: "footer", class: "hk-dialog-footer" }, index.h("ir-custom-button", { key: 'dcb5c53d95b599c641c863d492cd4850ade7ccc1', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => {
                this.pendingChange = null;
                this.selectRevertKey++;
                this.dialog.closeModal();
            } }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'fc9b566adf88e1d0e4619706d510ddc0a942d2ad', size: "medium", appearance: "accent", variant: "brand", loading: irInterceptor_store.isRequestPending('/Override_HK_Task_Ownership'), onClickHandler: () => this.confirmOwnershipChange() }, locales_store.locales.entries.Lcz_Confirm)))));
    }
