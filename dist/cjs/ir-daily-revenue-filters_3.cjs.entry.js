...
const IrDailyRevenueFilters = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: '8e8747ff4f2265c61fbd4a274904a6c2e5ef57b3', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: 'e261c521e3797246cb49266a3b3f1c2210b47d41', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: 'd7092edf1db8c6e6379cb70e94fb3b559f847835', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'd98590fa3cb1b3ae4ad2d896972a8bad9209bd48', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '12aaa2b5047f35292a0d98e3d5a404b9c9738777', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '59b1967e1e8d20dc4c3e5624d4bf9dc98a119123', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: 'a8dcf8e980c09cfb1ae15d766e133bac9da27bd5', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#dailyRevenueFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "dailyRevenueFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'eae0d70e9d0748ad31caf6b79cf4f37043cd3dfb', class: "m-0 p-0 collapse filters-section", id: "dailyRevenueFiltersCollapse" }, index.h("div", { key: '7eeed83d8b6422e8832a73df1bf96274327e25fb', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'cc85d6212b3177f397f82b1c76180e366c6aea29', class: "pt-1 filter-group" }, index.h("label", { key: 'dd9cdab4248a41c5529d2f9f3f503a9afbfb0cf2', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Select a date"), index.h("div", { key: '6190582f3fa50cef94028a7cd366427eace9096f', class: "w-100 d-flex" }, index.h("style", { key: '5c5ec4d6fc8e75915ebfb28f2d502f57be2bdb29' }, `
                  .ir-date-picker-trigger{
                    width:100%;
                  }
                  `), index.h("ir-date-picker", { key: '38c654f3217a86a3f31282cf43101b9ed52b3ecc', "data-testid": "pickup_date", date: (_a = this.filters) === null || _a === void 0 ? void 0 : _a.date, class: "w-100", emitEmptyDate: true, maxDate: moment.hooks().format('YYYY-MM-DD'), onDateChanged: evt => {
                var _a;
                evt.stopImmediatePropagation();
                evt.stopPropagation();
                this.updateFilter({ date: (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') });
            } }, index.h("input", { key: '67341fada049704890b8aae427680d76e3bfc593', slot: "trigger", type: "text", value: (_b = this === null || this === void 0 ? void 0 : this.filters) === null || _b === void 0 ? void 0 : _b.date, class: `revenue-table__date-picker-input form-control w-100 input-sm  text-left`, style: { width: '100%' } })))), index.h("div", { key: 'ab508693277492d33e27b6181cf6bcfcd759dfba', class: "d-flex mt-1 align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: '50cf7372ee3c15da36f5db3593b25c3e55f77158', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '98e136bdaa591638421604d531ceb43ba02bf139', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
...
const IrRevenueSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ea8b3b77a71dc6638fc892671bd561f1b6d912f7' }, index.h("div", { key: '206f405354ddfbe6913b3d34255a736770c87d28', class: "ir-revenue-summary__mobile" }, index.h("ir-stats-card", { key: 'a7fd0a9196f5bc5e62af051f04f200caa13e675a', icon: 'arrow-trend-up', value: utils.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal), cardTitle: "Payments" }, index.h("p", { key: 'fab0062961dd0013d3576a1d0b59eac41cd3d710', class: "stats-card__payments-value", slot: "value" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal))), index.h("ir-stats-card", { key: '941e7e60d3a3e948dc8e01a76c76020fa2f7c1dc', value: "123$", class: "refunds-card", icon: 'arrow-trend-down', cardTitle: "Refunds" }, index.h("p", { key: 'b599cf8d295fad4bbe61811922cba58ed6b54bc0', class: "stats-card__refund-value", slot: "value" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, refundAmount)))), index.h("div", { key: '278a24ffea81cd4da3ecc2f3c78576e0f5bd5855', class: "ir-revenue-summary__tablet" }, index.h("ir-stats-card", { key: 'b99d85bb408a2b18b4d40abbf1c0dbb5649e5046', icon: 'arrow-trend-up', value: utils.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal), cardTitle: "Payments", subtitle: `Previous day  ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDatePaymentsTotal)}` }, index.h("p", { key: '727c6569b361fd2be06b1d4cf608b92f853cdb77', class: "stats-card__payments-value", slot: "value" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal))), index.h("ir-stats-card", { key: 'ec5bd42a51d74eccee2dae4926ac4805651e2d6c', value: "123$", class: "refunds-card", icon: 'arrow-trend-down', cardTitle: "Refunds", subtitle: `Previous day  ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDateRefundAmount)}` }, index.h("p", { key: '102c33f3d6551b1a6d4befe19f4bc986ab0db1a3', class: "stats-card__refund-value", slot: "value" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, refundAmount))), index.h("ir-stats-card", { key: '99020d946fe0924a67158037d06a6c60c52ef9ef', icon: this.getTrendIcon(totalAmount, previousDateTotalAmount), value: utils.formatAmount(calendarData.calendar_data.currency.symbol, totalAmount), cardTitle: "Difference", subtitle: `Previous day  ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDateTotalAmount)}` }))));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        return (index.h("div", { key: '378fd079b312db4e1fe17f9df9c48066b0c2e3db', class: "card p-1 revenue-table__table" }, this.payments.size > 0 ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), Array.from(this.payments.entries()).map(([key, p]) => {
