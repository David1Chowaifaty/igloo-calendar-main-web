...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '64fb5261c86a260330c7582138de7d5c9791e4e6' }, index.h("div", { key: 'a89b9ad6d4333b98678d9a041bf1293aca1e917a', class: "text-left mt-1 " }, index.h("div", { key: 'a904832f886f4be254d752a24e6ed6e4e7b39813', class: " mb-1 " }, this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING' ? (index.h("span", { class: "h5 mr-1" }, this.guestInfo.roomCategoryName)) : null, index.h("span", { key: '98d808a885bbc4a2d62ad78ab9b8b3c0061ddaaf', class: " font-weight-bold" }, this.guestInfo.ratePlanName.replace(this.guestInfo.roomCategoryName + '/', ''), index.h("ir-tooltip", { key: '245e3e929d843f96d039e20c5cd53ca70ef6b00b', class: " mr-1", message: this.guestInfo.cancelation + this.guestInfo.guarantee })), index.h("span", { key: '00e97792d951fc79c0fee3f63c06054252cc6cc2' }, this.guestInfo.adult_child_offering)), index.h("div", { key: '85303a274ddd38429d66caafe04192b0eeb8eaab', class: "d-flex flex-column flex-md-row m-0 p-0 align-items-md-center aplicationInfoContainer " }, index.h("div", { key: '54d4ce05a3bb987c222110a2ef2a631e31c708d2', class: "mr-1 flex-fill guest-info-container" }, index.h("input", { key: 'e8d7c09d53b9a17aee52b47897d16d12cec8a35a', id: v4.v4(), type: "email", class: `form-control ${this.isButtonPressed && this.guestData.guestName === '' && 'border-danger'}`, placeholder: locales_store.locales.entries.Lcz_GuestFirstnameAndLastname, name: "guestName", onInput: event => this.handleGuestNameChange(event), required: true, value: this.guestData.guestName })), index.h("div", { key: '4cfec2b54636c51f801e75b230286fd707076514', class: 'mt-1 mt-md-0 d-flex align-items-center flex-fill' }, calendarData.calendar_data.is_frontdesk_enabled && (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') ? (index.h("div", { class: "mr-1 p-0 flex-fill  preference-select-container" }, index.h("select", { class: `form-control  input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('roomId', event.target.value) }, index.h("option", { value: "", selected: this.guestData.roomId === '' }, locales_store.locales.entries.Lcz_Assignunits), this.filterdRoomList.map(room => (index.h("option", { value: room.id, selected: +this.guestData.roomId === room.id }, room.name)))))) : null, this.guestData.is_bed_configuration_enabled && (index.h("div", { class: "mr-1 flex-fill" }, index.h("select", { class: `form-control input-sm ${this.isButtonPressed && (this.guestData.preference === '' || this.guestData.preference === 0) && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('preference', event.target.value) }, index.h("option", { value: "", selected: this.guestData.preference === '' }, locales_store.locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => (index.h("option", { value: +data.CODE_NAME, selected: this.guestData.preference === +data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("div", { key: '71d59b3f36b4e51b41372b14133c844449bc42de', class: "" }, utils.getCurrencySymbol(this.currency.code) + Number(this.userRate).toFixed(2), "/", locales_store.locales.entries.Lcz_Stay))))));
    }
...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c66408dcbcc060682b6481e2d028a554ddd26e6f' }, index.h("div", { key: 'a52059f3b3e5f7de5ebf392494beecf775d6fd61', class: `m-0 p-0 mb-1` }, index.h("div", { key: '2b345abb37ec3d8418af82b212007909b2329faa', class: "text-left p-0" }, index.h("ir-date-view", { key: '45bccc329a66c77da878fdc88f369a9686057c0c', from_date: this.fromDate, dateOption: "DD MMM YYYY", showDateDifference: false, to_date: this.toDate }))), index.h("div", { key: '4aa02f20d3c987b3c46449140e96fdf9749f024d', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { key: 'f2e8e44036b23117bf1c53a6018d675206e96250', class: "mb-1 " }, index.h("label", { key: 'ca5b3560436c725f6dfba76337d120a945f5d8a2', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales_store.locales.entries.Lcz_Reason, ":"), index.h("div", { key: 'd5ff23be9f4a5d9a7ac2bc6bb973afd5f047c366', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { key: '57f3460fa1b58422d7fc2116e176ea2e11b24192', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { key: '9e2b3a78878137ba6fa08e1fdd561e65b02779d8', class: "align-middle out-of-service-label" }, locales_store.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, locales_store.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: locales_store.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, locales_store.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: this.blockDatesData.RELEASE_AFTER_HOURS == +releaseItem.CODE_NAME }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, locales_store.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglBookProperty = class {
    ...
    render() {
        //console.log('render');
        return (index.h(index.Host, { key: 'b0a6de1155c155179612c12da160986d45e39ce1' }, index.h("div", { key: '015e69245f25606be8aed01769c2aad86dcf468a', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: 'da7df334c458fcb97b39d7e57d7dc5118b40c7c8', class: 'sideWindow ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: 'a54c9816503b2a267574f1ccd146571b1d6e9d48', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: 'a6a9889d26af6c9e859475978acbb522808b847d', class: "d-flex mt-2 align-items-center justify-content-between  " }, index.h("h3", { key: '773956119f7fd4827b38d963af5f62a0703b90f9', class: "card-title text-left pb-1 font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '24fee7f1fdc4b40957a4a26462c522bb1a83d472', class: "close close-icon", onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '8572fa78d2a90b5a76eff2eba22a076711f91bec', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '504f24dece03db174b07959cd66213bfedc544a7', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: '916f28260f72f28aa2bc300bb0c2238924ace9ce', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData,
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '429cc5c3276d563593c2db9de958837887f60be9' }, showSourceNode && this.getSourceNode(), index.h("div", { key: 'fc81cbd29561d7181814d67ce946c84134aea701', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, index.h("fieldset", { key: 'db932ec47484c68c61bfde1e124d4c864677c22a', class: "mt-lg-0  " }, index.h("igl-date-range", { key: 'a4a822dfb1900aeba8bfef633eea7a0cd891ed3f', dateLabel: locales_store.locales.entries.Lcz_Dates, minDate: this.minDate, disabled: this.isEventType('BAR_BOOKING') || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: 'b38fc5bb6d992ba1bc4ed163c977d18f132e34ca', class: "text-right mt-1 message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingOverviewPage = class {
    ...
    render() {
        ...
        })))), index.h("igl-book-property-footer", { key: '48899cfd3a74794162ca9377240b0b1388c60023', class: 'p-0 mb-1 mt-3', eventType: this.bookingData.event_type, disabled: this.selectedRooms.size === 0 })));
    }
};
...
const IglBookingRooms = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4b04c4ae8e18154c24237923ac663b7731770185' }, isValidBookingType && index.h("div", { class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomTypeData.name), this.roomTypeData.rateplans.map((ratePlan, index$1) => {
...
const IglDateRange = class {
    ...
    calculateTotalNights() {
        this.totalNights = booking_service.calculateDaysBetweenDates(utils.hooks(this.fromDate).format('YYYY-MM-DD'), utils.hooks(this.toDate).format('YYYY-MM-DD'));
    }
    ...
    render() {
        return (index.h(index.Host, { key: '08b031f1270928054754d5724239962f8d84980a' }, index.h("div", { key: 'ad9336e567c4fae3da5fcb067590b133f983cf60', class: "calendarPickerContainer form-control input-sm", "data-state": this.disabled ? 'disabled' : 'active' }, index.h("ir-date-picker", { key: 'e200404269561cb3671f26763ecb959292441e80', maxDate: this.maxDate, class: 'date-range-input', disabled: this.disabled, fromDate: this.fromDate, toDate: this.toDate, minDate: this.minDate, autoApply: true, "data-state": this.disabled ? 'disabled' : 'active', onDateChanged: evt => {
                this.handleDateChange(evt);
            } }), index.h("div", { key: '3eeff6228abf401183b24015d8d44c3ed0cd2315', "data-state": this.disabled ? 'disabled' : 'active', class: "date-view" }, index.h("svg", { key: '0d1a55d1af8ee2a5315e65fca2fbb3e07f35775a', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "10.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'f497eb6696ac2119f29223068a3284930e65df64', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), index.h("ir-date-view", { key: '0d1c643020220c26fa100338d448edc79a1a0239', showDateDifference: this.disabled, from_date: this.fromDate, to_date: this.toDate }))), this.withDateDifference && (index.h("span", null, this.totalNights && !this.disabled ? (index.h("span", { class: "iglRangeNights mx-1" }, this.totalNights + (this.totalNights > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`))) : ('')))));
    }
};
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'aa42606dae5072a1326c149c1e8edd5b4ca78aaa' }, index.h("div", { key: '1ba1bab330e7518eb2501ab55dd20a75c768f313', class: "text-left mt-3" }, index.h("div", { key: 'b510eabf94e8ca6848c573483fb6a53dbb065552', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: '5d6917b81ae329b93a3d683c9bd07e79e73fd8c2', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: 'ce198a77baaa27b84454ffb2dc3645d68a224ca2', class: "bookedByEmailContainer mt-1 mt-md-0" }, index.h("ir-autocomplete", { key: '944a7e3e7b9341ff2e8c0a4306296c698d227445', danger_border: this.isButtonPressed && this.bookedByData.email === '', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "email", value: this.bookedByData.email, required: true, placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent() })))), index.h("div", { key: '299751649b635950e8db0a2239cc22b74905556b', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: 'cb37597dfd5aa121c7670a23c0124e141768da36', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: 'be417b02f72ba3df5e01bbd63e84d0d400f4e0db', class: "p-0 flex-fill " }, index.h("div", { key: 'db00c477bd80cb6885bf5c8a132ab239ed8d387c', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: 'b67f186eba80cda108fadb77741d152a2a3ffbe6', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: '78f9002a33d0de75954c237cee8dfcee32fe2305', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: '7b417b099d42244e0c5e36ff150bd6c38419d55f', class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => this.handleDataChange('firstName', event), required: true }))), index.h("div", { key: '33331234b64c617fb0c13101832d87622ffab479', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '9996ca4ee10bbf18a4394930ced9d0f46f4c95c0', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: 'f093b4ec7820a769ace450bdfbf0b3ea39451859', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '47e372c293b088446b404b2b4f46baf1a833c9fc', class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: 'ff6c460ec0055aaf2c4b5c95ebcc0a4c0c1a2ea2', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '2463a4ebc626e96d4795784e6b0d2fb7e8af8eb2', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("div", { key: '308a52c3180ed149a00d946bae465cd018043f38', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '9aa4dc0e233fcb5d1f3bb4a10f2a70c8d09773ac', class: `form-control input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('countryId', event) }, index.h("option", { key: 'd0d17034f60bedda9d9146600de8cb80c83237fc', value: "", selected: this.bookedByData.countryId === '' }, locales_store.locales.entries.Lcz_Select), this.countryNodeList.map(countryNode => (index.h("option", { value: countryNode.id, selected: this.bookedByData.countryId === countryNode.id }, countryNode.name)))))), index.h("div", { key: '6515ec6456a86bdc3d8fff574bab2fa0f6e43930', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '1ad26b7bad2a38b717c6f5ecd5bbf6d6ebd9bcf9', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: 'a9731ec9dc2a134cdbdb93d4e5dd43e3c877bcb0', class: "p-0 m-0  d-flex  controlContainer flex-fill" }, index.h("div", { key: '0f4c4748e11eb6405e68b9a4f28bae8a41b3a75b', class: " p-0 m-0" }, index.h("select", { key: 'ad5e10ca43df6a029a347b84f6551c1e85572da0', class: `form-control input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('isdCode', event) }, index.h("option", { key: 'd9e564607db328814288b53035cc9cafee1cd449', value: "", selected: this.bookedByData.isdCode === '' }, locales_store.locales.entries.Lcz_Isd), this.countryNodeList.map(country => (index.h("option", { value: country.id, selected: this.bookedByData.isdCode === country.id.toString() }, country.phone_prefix))))), index.h("div", { key: 'cac563fdddbcb5faa12e1d5818e5749e99063747', class: "flex-fill p-0 m-0" }, index.h("input", { key: '4eca8f65eff34ad690266976c27e8271d7aafe90', class: `form-control
                     
                      `, type: "tel", placeholder: locales_store.locales.entries.Lcz_ContactNumber, id: v4.v4(), value: this.bookedByData.contactNumber, onInput: event => this.handleNumberInput('contactNumber', event) })))), index.h("div", { key: 'd7763e3c0dc172dc51ccdf3aeb5e585697ceadc4', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '13b11f01403bf61c2a1a07194e9faf7196c38b8f', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: 'b9db8a8e057c25cc2d6b6b5922c24546ac6e5031', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: 'c64cc8fea074db7459f18226d198abbc2590f2c4', class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: 'fd851cea392345ce1fff1f873fc04fb830a3d843', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: '13838ff41cd7f40107118f22273df624765f8a2f', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '94146bd911a194de6ad0b97f2c4888d4df9e9aea', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: '1485de346a0470cf51ca8cc08155e64fe91c2f6b', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: 'a95e979b8f572c166f0c91a6e422f48fdc3ccb19', id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, null, index.h("div", { class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { class: "p-0 m-0" }, index.h("select", { class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { class: "p-0 m-0 ml-1" }, index.h("select", { class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: 'd3277edd2c80dbcd9ccb1235699d78c2ac78a43e', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: '87de57ffaa7de3c02c492d4a5d82970484957428', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: '8f1fed3a034f6533825c83f80ce67da30fe9479d', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: '362b0589ab9f76c065f94dad02d363d36e29fb77', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const irBookingListingCss = ".sc-ir-booking-listing-h{display:block;height:100vh}.card.sc-ir-booking-listing{overflow-x:auto}.secondary-p.sc-ir-booking-listing{font-size:12px !important}.h-screen.sc-ir-booking-listing{height:100vh}.main-container.sc-ir-booking-listing{height:100vh;overflow-y:auto}.bg-ir-red.sc-ir-booking-listing{background:#ff4961;height:28px;padding-top:0 !important;padding-bottom:0 !important}.due-btn.sc-ir-booking-listing{border:1px solid #ff4961;color:#ff4961;cursor:pointer;padding:0.25rem !important;font-size:12px !important}.due-btn.sc-ir-booking-listing:hover{background:#ff4961;color:white}.booking_number.sc-ir-booking-listing{all:unset;cursor:pointer}.booking_number.sc-ir-booking-listing:hover{color:#1e9ff2}.in-out.sc-ir-booking-listing{width:150px !important}.buttons-container.sc-ir-booking-listing{gap:10px}";
...
const IrBookingListing = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-interceptor", null), index.h("ir-toast", null), index.h("div", { class: "p-1 main-container" }, index.h("ir-listing-header", null), index.h("section", null, index.h("div", { class: "card p-1 flex-fill m-0 mt-2" }, index.h("table", { class: "table table-striped table-bordered no-footer dataTable" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 :
            _a.Lcz_Booking, "#"), index.h("th", { scope: "col" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_BookedOn), index.h("th", { scope: "col" }, (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_GuestSource), index.h("th", { scope: "col" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 :
            _d.Lcz_Price, "/", index.h("span", { class: 'text-danger' }, locales_store.locales.entries.Lcz_Balance)), index.h("th", { scope: "col" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Services), index.h("th", { scope: "col", class: "in-out" }, (_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_InOut), index.h("th", { scope: "col" }, (_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Status), index.h("th", { scope: "col" }, index.h("p", { class: "sr-only" }, "actions")))), index.h("tbody", { class: "" }, (_h = booking_listing.bookings) === null || _h === void 0 ? void 0 : _h.map(booking => {
            var _a;
            const currency_code = utils.getCurrencySymbol(booking.currency.code);
            let confirmationBG = '';
        ...
        }))), index.h("section", { class: 'd-flex flex-column flex-md-row align-items-center justify-content-between' }, index.h("p", { class: "m-0 mb-1 mb-md-0" }, this.renderItemRange()), index.h("div", { class: 'd-flex align-items-center buttons-container' }, index.h("ir-button", { size: "sm", btn_disabled: this.currentPage === 1, onClickHanlder: async () => {
                this.currentPage = 1;
...
const IrButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: '8287957d9cdc43024296053e2fa482d84b8617a1', id: this.btn_id, ref: el => (this.buttonEl = el), onClick: () => this.clickHanlder.emit(), class: `btn btn-${this.btn_color} ${this.btn_styles} d-flex align-items-center btn-${this.size} text-${this.textSize} ${blockClass}`, type: this.btn_type, disabled: this.btn_disabled }, index.h("span", { key: 'ecaff1533fd855d315b2f1697a1b0753a1e7a5b9', class: "button-icon", "data-state": this.isLoading ? 'loading' : '' }, index.h("slot", { key: '56fc05ad815efb813ccf52d9192649e02c1c91d4', name: "icon" })), this.text && index.h("span", { class: "button-text m-0" }, this.text), this.isLoading && index.h("div", { class: "loader m-0 p-0" })));
    }
};
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bcd16052ea223eb3304cbd0ec356da38f7da69cb' }, index.h("slot", { key: '2f0505c9d5079a5b8ddb668fdf047e1a4aa855a1' })));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dffa5037bf389650937110772e295f6e36584c22' }, index.h("input", { key: 'c101a6ba7168b9969f6b021b0e5820025d4288d1', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
};
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '79341c36cb9d1a18c7ddbe6f24f11134650709b4', class: "d-flex align-items-center" }, index.h("span", { key: '8b864b603e874ff38bd94ae8a0bb8e3ca7eff1f9' }, this.dates.from_date), ' ', index.h("svg", { key: '14626113834437d398175e467830e99aeaf5501a', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '0199bba3afedc1c9a76e869d58ca4c97d7e8ba0e', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '015abf43e9f373ce5bd8e971b925b4c881be9069' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '1000085bd4c8aa8b570c66d1825acbe068864598', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '2b5bd630f7185361a894cc8c6e6f69b3b892d983', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '23dea28b6e5c0466bfa0115c723f8e2cd95d4388' }, this.isLoading && (index.h("div", { class: "loadingScreenContainer" }, index.h("div", { class: "loadingContainer" }, index.h("ir-loading-screen", null))))));
    }
};
...
const irListingHeaderCss = ".sc-ir-listing-header-h{display:block;margin:0;padding:0;--ir-date-range-border:#cacfe7;--ir-date-range-width:260px}h3.sc-ir-listing-header{margin:0}ir-input-text.sc-ir-listing-header{width:300px}.booking-container.sc-ir-listing-header{gap:14px}.filters-container.sc-ir-listing-header{gap:10px;justify-content:space-between}.buttons-container.sc-ir-listing-header{gap:14px;color:#104064}@media (max-width: 575.98px){.sc-ir-listing-header-h{--ir-date-range-width:360px}.flex-fill-sm-none.sc-ir-listing-header{flex:1 1 auto}}@media (min-width: 1400px){.flex-fill-sm-none.sc-ir-listing-header{flex:0 0 auto}}";
...
const IrListingHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '71bde7c164f96afe74b64dae879b81624a85414d' }, index.h("form", { key: '51ad0a4d7cb002aeba8711d95e7f78f9f0f4e5a8', class: "d-flex align-items-center booking-container" }, index.h("h3", { key: 'f694d00caa51acbeb92aa894dc4343aadacf77d8' }, locales_store.locales.entries.Lcz_Bookings), index.h("ir-input-text", { key: 'cd7f60bde40c2523c5d1d8ff428baea9ccce9241', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", class: "ml-md-5", placeholder: "Find booking number/name" }, index.h("svg", { key: '09880533b425f8b72ace0623b336ea5d594f8f9c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '57561f8a785c4017816a2c08bfc7c6fb329f25ea', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '66661e0e936657d28e448c43f25f7a9849e3d017', class: "m-0" }, locales_store.locales.entries.Lcz_Or)), index.h("section", { key: '86d8060280851e40e1ff16fd54d7b48bbc0566de', class: "d-flex align-items-center flex-wrap filters-container justify-content-lg-start mt-1" }, index.h("fieldset", { key: '7383631aca60aa48f9f871f021f512e76f5640e2', class: "flex-fill-sm-none" }, index.h("label", { key: '50c08ad4706018e2eca6abe909b4f2a2db0c6dac', htmlFor: "dateTo" }, locales_store.locales.entries.Lcz_DateOf), index.h("ir-select", { key: '25037764cc0a665518add450d85710e806fcb950', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "dateTo", LabelAvailable: false })), index.h("fieldset", { key: '10a4f6842b489d083f2d86f13c8ad0a3b6244d90', class: "flex-fill-sm-none" }, index.h("label", { key: '2f135eb885c7eeba40495ef2c38c1d8511592fdc', htmlFor: "dates" }, "Dates"), index.h("igl-date-range", { key: '31cf5c2aa019fcdeadc276a065bf6fa932724b55', minDate: "2000-01-01", withDateDifference: false, defaultData: {
                fromDate: booking_listing.userSelection.from,
                toDate: booking_listing.userSelection.to,
            } })), index.h("fieldset", { key: '1c27ff85a67aee9032878eecfa152ac4615b4659', class: "flex-fill-sm-none" }, index.h("label", { key: '06ce3f35c225c51ce23464ceee711f13cdd0138a', htmlFor: "booking_status" }, locales_store.locales.entries.Lcz_BookingStatus), index.h("ir-select", { key: '8ef3079ea20d1393c4e3b74af88b7a7a4905e2b0', onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "booking_status", LabelAvailable: false })), index.h("fieldset", { key: '12608e37b14eb9072a47b155cca951154cd6fdc2', class: "flex-fill-sm-none" }, index.h("label", { key: '5afc758bf7a99b6259a926156fafa78cda23510a', htmlFor: "channels" }, locales_store.locales.entries.Lcz_Channels), index.h("ir-select", { key: '9275cabfbe660814b1de812480c9ea716372008d', onSelectChange: e => updateUserSelection('channel', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "channels", LabelAvailable: false })), index.h("fieldset", { key: 'ca519a818f8c3987b474370e376b8ad1ac279e69', class: "flex-fill-sm-none" }, index.h("label", { key: 'cc101467dae6012366c61f219ee0182f3a48d1f3', htmlFor: "payment_status" }, locales_store.locales.entries.Lcz_Payments), index.h("ir-select", { key: '22c358d2cf74fe759d26ae9a94b5344b5c196361', showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.settlement_methods.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "payment_status", LabelAvailable: false })), index.h("div", { key: 'aedda67a3e6a7d6470bd59dd5455b814feee6843', class: "d-flex align-items-end m-0 mt-2 buttons-container" }, index.h("ir-icon", { key: '812b91c3979c0fecc07953f8d2f3ae22eba7880a', title: locales_store.locales.entries.Lcz_Search, onIconClickHandler: () => this.handleSearchClicked() }, index.h("svg", { key: 'b458307bc2052d64d0933bb1627e59b8d5d32505', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { key: 'a92e3aa5f3c3984279b60de9ce06db83c01c0845', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("ir-icon", { key: '6cc301562f38a285df5da4f7afeb0629eae7f55b', title: locales_store.locales.entries.Lcz_Erase }, index.h("svg", { key: '1f1f758c06c815a46fffc218b46a7942fdce2ef4', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { key: 'a7243863ce44408060b45f9e1c17fec6c93a0de2', fill: "currentColor", d: "M290.7 57.4L57.4 290.7c-25 25-25 65.5 0 90.5l80 80c12 12 28.3 18.7 45.3 18.7H288h9.4H512c17.7 0 32-14.3 32-32s-14.3-32-32-32H387.9L518.6 285.3c25-25 25-65.5 0-90.5L381.3 57.4c-25-25-65.5-25-90.5 0zM297.4 416H288l-105.4 0-80-80L227.3 211.3 364.7 348.7 297.4 416z" }))), index.h("ir-icon", { key: '1b3e69f82352e6917ce197a1c5fec1d5031e50ac', title: locales_store.locales.entries.Lcz_ExportToExcel }, index.h("svg", { key: '0104fe77974e49c88118550856d91ee25cc22090', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { key: '9b707e20416c13d58eb271f1a5c62700028c0d1c', fill: "currentColor", d: "M0 64C0 28.7 28.7 0 64 0H224V128c0 17.7 14.3 32 32 32H384V288H216c-13.3 0-24 10.7-24 24s10.7 24 24 24H384V448c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V64zM384 336V288H494.1l-39-39c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l80 80c9.4 9.4 9.4 24.6 0 33.9l-80 80c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l39-39H384zm0-208H256V0L384 128z" })))))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9da9b458ff15e8d1b4668649ceb9d738024db884' }, index.h("div", { key: 'dc6c3b064d88316618b41c00189949a7a3a7d70f', class: "loaderContainer" }, index.h("span", { key: 'e95551affff7a260841250e15c3ce8e4ee361770', class: "loader" }))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'e11664c1b51283718f74189c0c0e0d34843b9412', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.closeModal();
                } }),
            index.h("div", { key: 'f8ccfc83a9462bff96bc316c0ba872a924c1971d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '9743015c06c0e9a8ebe8a7b2d023010b03088556', class: `ir-alert-content p-2` }, index.h("div", { key: 'dbbe10726b98a4e8535ea7d4fdf42e4b5d7b6aa2', class: `ir-alert-header align-items-center border-0 py-0 m-0 ` }), index.h("div", { key: '9344ec61e673b99ea28f3a307f2950da066a5a91', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'd4913afa72ba11146592780f4c2aef77ec2670ef' }, this.modalBody)), index.h("div", { key: '65a51f92561ca711dfcd8138dc8599def822eb18', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && index.h("ir-button", { icon: '', btn_color: this.rightBtnColor, btn_block: true, text: this.rightBtnText, name: this.rightBtnText })))),
        ];
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '63419e81095dcb7922ccd015a23b528918dec505', class: 'p-0' }, index.h("div", { key: 'f4d33e55a5c4064d9d7c41650547d4361aa14377', class: "position-sticky mb-0 shadow-none p-0" }, index.h("div", { key: '9d225bf66be4da6a63bcb7dd19a4629962bf2e48', class: "mt-2 custom-card-container pb-1 mb-3 px-1" }, index.h("h3", { key: 'f54267f32748860af36ef6a52ce15ae3821c2ad8', class: "card-title p-0  m-0 text-left font-medium-2" }, locales_store.locales.entries.Lcz_Pickup), index.h("div", { key: '5e8078da854feac24cfb1d59af461dd8358a2432' }, index.h("ir-icon", { key: 'b03b6000aaf1185bdac30c651dffc454d2a9bbad', class: 'close m-0 p-0 ', onIconClickHandler: () => {
                this.closeModal.emit(null);
            } }, index.h("svg", { key: '9c6cf7e79a46902894b6758d6a832df142db9276', slot: "icon", xmlns: "http://www.w3.org/2000/svg", class: "m-0 p-0", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '854cab113dab28e6fed7fa020a7247aae0088f45', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("section", { key: 'c9cc60b5c8c7da420445557f59c305a0bbdaa7aa', class: 'px-1' }, index.h("ir-select", { key: 'bd6e0c27d65b2ace97ca848c38110d096fb4239d', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h(index.Fragment, null, index.h("div", { class: 'd-flex' }, index.h("div", { class: "form-group  mr-1" }, index.h("div", { class: "input-group row m-0" }, index.h("div", { class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, index.h("ir-date-picker", { minDate: utils.hooks().format('YYYY-MM-DD'), autoApply: true,
...
const IrRoom = class {
    ...
    render() {
        return (index.h(index.Host, { key: '99a1656926e380edc6afad775e36e1969a2c2230', class: "p-1 d-flex m-0" }, index.h("ir-icon", { key: 'b55e9e50d439a84a7d208430378fc971021d8f72', id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "pointer mr-1", onClick: () => {
                this.collapsed = !this.collapsed;
            } }, !this.collapsed ? (index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { fill: "#104064", d: "M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "25", viewBox: "0 0 640 512", slot: "icon" }, index.h("path", { fill: "#104064", d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z" })))), index.h("div", { key: '9de60b826a544a0b33d85e0d00bc6a3abef8162e', class: "flex-fill m-0 " }, index.h("div", { key: 'a39cca235db27c26c4e23be7b3a96fd66b22fd97', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: 'fcc45accaf37b89566cfd432ab0805b06f4fb6fd', class: "m-0 p-0" }, index.h("strong", { key: '70c1642e7caf70f4507f347862eacc22f7c36198', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '1829c05284be8be7dad71b00d2acea7f9bf636c7', class: "d-flex m-0 p-0 align-items-center" }, index.h("span", { key: '19c6aa32ac3e83b0567b9690c8a4f3f7e4583c81', class: "p-0 m-0 ml-1 font-weight-bold" }, _formatAmount(this.item['gross_total'], this.currency)), this.hasRoomEdit && (index.h("ir-icon", { id: `roomEdit-${this.item.identifier}`, class: "pointer mx-1", onClick: this.handleEditClick.bind(this) }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" })))), this.hasRoomDelete && (index.h("ir-icon", { onClick: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, class: "pointer" }, index.h("svg", { slot: "icon", fill: "#ff2441", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "14.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" })))))), index.h("div", { key: '5cd0876f3c7cca455b8e1bf1a2921f7d778a1fa2', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: 'a234543e983b1aa6ed0dd863f915ae7e7fa22841', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && index.h("span", { class: "light-blue-bg mr-2 " }, this.item.unit.name), this.hasCheckIn && index.h("ir-button", { id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), index.h("div", { key: 'c45f0622f37bcba483df1910c09da8c067dc5468' }, index.h("span", { key: '6244de1bab2a373ae084a8d98e6b964cdb36eaf2', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", null, " ", this.item.rateplan.selected_variation.adult_child_offering)), index.h("div", { key: '207de689340f483a7a0a6cf184bd38ca884afc5e', class: "collapse", id: `roomCollapse-${this.item.identifier.split(' ').join('')}` }, index.h("div", { key: '1f474991a17ef4d2dce0b1be1c555f4428c6cd72', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'a8b4bb1b6e01ac90e3ac80bf67cb4b58f77f56e5', class: " sm-padding-top" }, index.h("strong", { key: '544d692dd5f14a2b4e8a53c3db0582a2f6dc00c8', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'd077f7b6f388b977569455dbd3948fd0afd9385a', class: 'flex-fill' }, index.h("table", { key: '3baa3b2a736e73ffccb1aefd5e8cadb4aefe7a42' }, this.item.days.length > 0 &&
            this.item.days.map(item => (index.h("tr", null, index.h("td", { class: 'pr-2 text-right' }, _getDay(item.date)), " ", index.h("td", { class: "text-right" }, _formatAmount(item.amount, this.currency))))), index.h("tr", { key: '9efaa5f13d01c9e4b5e4303a093143932c4132a5' }, index.h("th", { key: '7d956ef41eb6706903c8a992fe3512ddd5297b4b', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: '21a7a9b3cb4d9c96d2510be1f09da5aaa64fbf1f', class: "text-right" }, _formatAmount(this.item.total, this.currency))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '9fda8ae37ce800ae08c28e4528023842c5c04ef2', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '2cd6407fcf94b0d7cef2c290fd9661e8c7e2366c', class: "input-group row m-0" }, label, index.h("select", { key: '052e2b423ff6e260ee312af4d766cfc7e5c668ce', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'c6180d04d1630465edeb57e3d0bcdf98683b8a23', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '152ce87d6f0444bbfc00f559d8aa6bf629596570', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("ir-icon", { class: "close", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("slot", { key: 'b13fdf1b40e5117a226bee354fd6179b002e52b1' })),
        ];
    }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '690869c5616a177d70fb1497fb9a1110a5f37b6a' });
    }
    get element() { return index.getElement(this); }
};
...
//# sourceMappingURL=igl-application-info_35.cjs.entry.js.map