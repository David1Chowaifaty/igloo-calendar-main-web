...
const IrDateSelect = class {
    ...
    render() {
        return (index.h(index.Host, { key: '563be7b4cea65095222fa879f545f6712b9e8902', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, index.h("wa-popup", { key: 'eb3e653177c7b6d905e4b7ae0a060b571bc18215', style: { '--max-width': 'auto' }, arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, index.h("div", { key: '7dda62d3babe489f3818327631fec214f3fb6566', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, index.h("div", { key: '75c38bebfbdf7b54a8af0b30a33a2ad32961c3cb', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("slot", { key: 'bda97ce03c1b47e750009ce54868bd6803c3c59e', name: "trigger" }, index.h("ir-input", { key: '348b28bbb95748e656a316610b3f1daa92723be4', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && index.h("slot", { key: 'b7591972a9c748c60ba63c5a5f706d663628cf32', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '51286ac8ef8c7c58641791fd266c7d826c672658', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '145e03106ae1b00dd0d280890222911b05c785b8', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: '5d162fdee749b3c253d05b7cd4a879acccd2dc20', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '0fbb86d3b674a24d28a3c3187fc6a8f60bb851b2', name: "hint", slot: "hint" }))))), index.h("div", { key: '9cbde43e69c07248d577f5a4efe0a1c2684667d3', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, index.h("ir-custom-date-range", { key: 'f2a9ae921060f07471dd2d499f6b2680982659ae', style: { '--cal-button-size': '35px' }, fromDate: this.selectedStart, toDate: this.selectedEnd, minDate: this.minDate ? moment$2.hooks(this.minDate) : undefined, maxDate: this.maxDate ? moment$2.hooks(this.maxDate) : undefined, onDateChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), index.h("slot", { key: '619a8b33e8bec48f82a8d63969c98217788f4fa3' })))));
    }
    static get watchers() { return {
