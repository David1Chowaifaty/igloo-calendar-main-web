...
const IrDateSelect = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0878825015815908577f0e2b7af65a7046a6e7c2', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, index.h("wa-popup", { key: '141199989dc963087d17bd41903d52486cd9808e', style: { '--max-width': 'auto' }, arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, index.h("div", { key: 'fdca9b74697769ab546fb2ce2114e9828159fc43', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, index.h("div", { key: 'eded1be06bcf2f60d579813dd41a0092352f2906', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("slot", { key: '6c5a69a3631900949a61c455c3366a004ca91dab', name: "trigger" }, index.h("ir-input", { key: 'c20ee6ff41a59e60639797043d1b409c24858545', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && index.h("slot", { key: 'a885a99876ee465591202d23fb5e061d3a0d6f41', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '85f9728c3319340c4048566e3fac9086379882d5', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '8803ee6258a6eab06fc8e0bcc790de1c65aac18e', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: '92606e4fc56e041ff92fb20dd4bc4bc41cd100b4', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '1012a89986e4d5d3856595005a388971c90e6d29', name: "hint", slot: "hint" }))))), index.h("div", { key: '21685b0720401e5d4893dc22b6a69eacc08ab1f3', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, index.h("ir-custom-date-range", { key: 'bce51aff820aade29da53e48d55ff75ceed22400', style: { '--cal-button-size': '35px' }, fromDate: this.selectedStart, toDate: this.selectedEnd, minDate: this.minDate ? moment$2.hooks(this.minDate) : undefined, maxDate: this.maxDate ? moment$2.hooks(this.maxDate) : undefined, onDateChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), index.h("slot", { key: '2f3faca30ee186d90d798d7dda6f4e1ab9eec69e' })))));
    }
    static get watchers() { return {
