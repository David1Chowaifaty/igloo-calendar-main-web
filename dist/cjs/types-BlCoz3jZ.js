...
class ZodObject extends ZodType {
    ...
    pick(mask) {
        const shape = {};
        for (const key of exports.util.objectKeys(mask)) {
    ...
    omit(mask) {
        const shape = {};
        for (const key of exports.util.objectKeys(this.shape)) {
            if (!mask[key]) {
                shape[key] = this.shape[key];
            }
        }
...
class ZodNativeEnum extends ZodType {
    _parse(input) {
        ...
        if (!this._cache) {
            this._cache = new Set(exports.util.getValidEnumValues(this._def.values));
        }
        if (!this._cache.has(input.data)) {
            const expectedValues = exports.util.objectValues(nativeEnumValues);
            addIssueToContext(ctx, {
...
exports.effectsType = effectsType;
...
exports.strictObjectType = strictObjectType;
