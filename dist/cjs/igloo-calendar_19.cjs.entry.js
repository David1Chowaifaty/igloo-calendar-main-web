...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1635bb31293fa287a7e9a818cfb12eff87297e36', class: "p-1" }, index.h("ir-interceptor", { key: 'e14a28b2c7402e0a7688a2acb844db9b3aa7576a', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), index.h("ir-toast", { key: '9e744d616b45e270a39d3fc48a8d5ba1222e05cf' }), index.h("div", { key: 'b369ddc8501c06b09936704abaa138be0c686496', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, index.h("ir-input-text", { key: '977d9a833b8902a6faf26b54294586268d974e11', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), index.h("ir-button", { key: 'c797c1694096a84bed1913ca917a67592ddf4363', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), index.h("p", { key: '5ad5786846e92f46059f5a4e573576aba3debe34' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
