...
const IrPropertySwitcher = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c3086a6e4a14b2c97cdb08996a9a5b7a378172ff' }, this.trigger(), index.h("ir-dialog", { key: '955ad68c2c5bb3c1b7d6f266006ef26f1c2ec864', onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, withoutHeader: true, open: this.open, label: "Find property", class: "property-switcher__dialog" }, this.open && (index.h("ir-property-switcher-dialog-content", { key: 'eae10886fb3a36d8bae2bda54ade3fcaec13058a', open: this.open, selectedPropertyId: this.selectedProperty?.id, onPropertySelected: this.handlePropertySelected })))));
    }
};
