...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '4548031cbba1ae255225accf2d8fc3a209aae3c8', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '2b5770bd0722a47a648c2d8612355f7a5c56d16b', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '694ab6d2cba327fa024d68705be3fa55ee27e4a3', name: "label", slot: "label" }), index.h("slot", { key: 'e130359e624663bb362150dd4194519f30242f21' }), this.slotState.get('footer') && index.h("slot", { key: '8a5c180104ba4dea0084d1d946cb85ae3c6d25cb', name: "footer", slot: "footer" })));
    }
};
__decorate$2([
    OverflowRelease()
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '8eef7f4cc6730850f2a2594a92a337fa0d62133e', class: "sheet-container" }, index.h("ir-title", { key: '2ebf62630ff175cf862797f41230d36cd448761a', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '3532e0a14d51be64766f7b88866bff2d1a810f64', class: "px-1 sheet-body" }, index.h("table", { key: '69ec3a2e744c4e83cf3ddfdb2c5a2c16bfca72d2' }, index.h("thead", { key: 'd8e12f8e1b2f4218f525686733ac3fbdb8fad5ec' }, index.h("th", { key: '6ce8704cb447c4a4852405f5d4ac9f2e871fb086', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'b6c6105284e9937fa2a8e4ad99023cc2c99deb09', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '96067ab1d567875e7e6052d9ab91101998149bb9', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '2c19a629d2f23a79ad4404ae9c68374e9684eb00' }, this.renderRooms()))), index.h("div", { key: 'd7112d7e47c98191d0e098c27e96f19949f25a71', class: "sheet-footer" }, index.h("ir-button", { key: '4f4678c0b076da42e7a486a90bebac20a8796884', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'e0b23b38d9a492961ac40e6ee493eb3abef0b3d0', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUnassignedUnitsDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '15710d5edfd5fa4689160a6174f1b104e909f7ae', label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}`, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeSideBar.emit(null);
            }, style: { '--ir-drawer-width': 'max-content' }, open: this.open }, this.open && index.h("ir-hk-unassigned-units-drawer-form", { key: 'c9e6abca9d580b71ef9e5849d81b704804fe251f', formId: this.formId, user: this.user }), index.h("div", { key: '9ae446adae8b21f688d1e10f790bd827ae315b9e', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'd48234fc69413930be78daa26577286efeb557d4', "data-drawer": "close", variant: "neutral", size: "m", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: 'aa486dc16f587e1ba0d03079ebbcb29df142ca3c', loading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), variant: "brand", type: "submit", form: this.formId, appearance: "accent", size: "m" }, "Save"))));
    }
};
...
const IrHkUnassignedUnitsDrawerForm = class {
    ...
    render() {
        return (index.h("form", { key: 'f63af0cc7b3c019f48f0b2a2b9b9d8e9e217fa85', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.assignUnits();
            } }, index.h("table", { key: 'e5c87237b1975ac182a96995b48e3cdbc2e69605' }, index.h("thead", { key: 'aa5f9d13de45ff384077cbe78fce28e44bb93a3e' }, index.h("th", { key: 'a764347185389fdb0d0796cd84c604be50f9c4f8', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'b097fbf687458984369e2c8c9fc84e657a9803dd', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '0d028fabf8fb21c229dc7f5fb3a25ef9852cccd0', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '3a68109c39a6ebb35b8f96e3f10774db82ad33a3' }, this.renderRooms()))));
    }
};
...
const IrHkUserDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'ee2ee1ee724fec85e9b45580fe06e130bcbed219', open: this.open, onDrawerHide: () => {
                this.closeSideBar.emit(null);
            }, label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }, this.open && (index.h("ir-hk-user-drawer-form", { key: '0049d2276c86c8ceb3a9c09e059d5f49259d7452', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isLoading = e.detail;
            }, isEdit: this.isEdit, user: this.user, formId: this.formId })), index.h("div", { key: 'f428b26530e21ea338194af32c71906f2e4e6ca7', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'ac74a179faaf5c8aa4a61c9f814a33a7d2c21ecd', "data-drawer": "close", variant: "neutral", size: "m", appearance: "filled" }, "Cancel"), index.h("ir-custom-button", { key: '99254987682851914b64d68b68119afa5e531572', loading: this.isLoading, variant: "brand", type: "submit", form: this.formId, appearance: "accent", size: "m" }, "Save"))));
    }
};
...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (index.h("button", { key: '4fe47c47cb4d332f44c3285d83fbadbfa0debbb1', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '1f50ca3296c9e639ae738eda4d181c333104f968', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '990bedfe2c91cc0df647ace99769cdeba2694dd0' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '533872bc7a7aa94d3a0e1f0981a66d5723a4d631', class: "loadingScreenContainer" }, index.h("div", { key: '860d280cb9514d4545ece35f17fcc29bb348747c', class: "loaderContainer" }, index.h("wa-spinner", { key: '9fefa7e948aa75ebbeb7d90fc9345156286ff8de', style: { 'fontSize': '2.5rem', '--track-width': '3.5px' } })))), this.showModal && (index.h("ir-otp-modal", { key: '47d561c088149abd089a83015dcae6c7875cc356', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    message = '';
    render() {
        return (index.h("div", { key: 'cca78623250e8e7e2e75969179f2ccd37a48c40f', class: "loader__container", "data-testid": "loading-screen" }, index.h("wa-spinner", { key: 'a1e141e00a08b1890c41d006c92cc90c1427ccb8', style: { 'fontSize': '2.5rem', '--track-width': '3.5px' } })));
    }
};
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e3be737eabd0befee05d43c0b38189300520f2a3', size: 's', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: '7485b53bf0e57e0ecb9b72a43a8187f0a7c500d6', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: 'd9fb04a8a6b74caee7de8a40ba43d71413937809', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '8191434ffc62396a17a4890444fb38b49522b9a0', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '7d234f561624baf51cb940097292f167d878b400', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: 'b15e5f06e43cb50b1e21c1e006b741f413095751', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: '614a5771eb1b5116dd4840e5aeff635abef2f7cf', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: 'e55d0f10e4822de7f67201295c57b97a316a60c0', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("ir-input", { key: '8b9f49dd3e01e94a144383fb323632c2a6cb17a7', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && index.h("span", { key: '4ae65a6a1386533292c4ac1c23cc31ec95a533c9', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (index.h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
        "countryCode": [{
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2e78f389bc0b47244aa669a5124c27df2a0ed91f', class: "otp-input-container" }, index.h("div", { key: '98cd91f9693927e918f5a6693cc5f1dddd3155a5', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: 'fde8f8ceade3fe5df5784c6a6b6122fff0b3fd16' }, index.h("ir-interceptor", { key: 'd544ffd4de22dffc4538901444d91215cc844ca8' }), index.h("ir-toast", { key: 'd64ec87f1c40f1f7fa5f097db35a3a3dfd5f2c17' }), index.h("main", { key: '36aa78e43aaec235053987e01bb6a17a500f30c7', class: "ir-page__container" }, index.h("header", { key: 'b29d319eec64482e7894af0920a0c9b9cea7f80d', class: "tax-page__header" }, index.h("slot", { key: 'e9d662181b8aac169d29d41758925dbbd4dfdd07', name: "heading" }, index.h("div", { key: '307a00a9b5db99b9b7c2d58301f8f6fbac58557a', class: "tax-page__heading" }, index.h("h3", { key: '603b771cef20f074a7c31fa06d4238a27b8481a9', class: "page-title" }, this.label), this.description && (index.h("p", { key: '68d0376e6aedd8c4799dd26e9ad8f61d5b975a83', class: "page__description" }, this.description, index.h("slot", { key: '268b69aa1e65622bd2ba5b16058c58d69a2bca7d', name: "page-description" }))))), index.h("slot", { key: '4b6b74a2ef0ddeea18dcd02813a4413301eeba63', name: "page-header" })), index.h("div", { key: 'bcb5322c8c13d426286d96d9ded2135db5f26391', part: "body", class: 'page-body' }, index.h("slot", { key: 'cb6d2e143d0cbe8d68788bb01b04bd1c73702437' })))));
    }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '96468755f209098ef5bd1c7758f01853324068db', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '164eeb1b4206dec4ccc5165d73888bd8b089acdb', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'b18ba639d0efd72b0d34a583de53f9fb4daa4bcd', class: "input-group row m-0" }, label, index.h("select", { key: '1b6fe6638931c3da0596a5c12a1d5d45a0289ba4', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '90f1a5bbf944ca113e69ae0acc33e1a9a3d5fc4d', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dbc1109a370cfe770962e0fdfaea218bc3beb394' }, index.h("wa-spinner", { key: '7025406219d05fda92dca5762a6afc93b1498db5', style: { 'fontSize': '2rem', '--track-width': '3px' } })));
    }
    static get watchers() { return {
        "size": [{
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '21dc910dbac7e7299413e3bb4c8dcbd852dc80c3' }, index.h("h4", { key: '78bbe34fc784b20cff7c7e30cebf3d265d021f4d', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '6101170779a4fda415b4b42b8811700a1947981b', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'd60ae478e081818ff3ed7af81f6008f022bc9459', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'df5c3462c011050f7366e4206684e45dc3ada262', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '5100bf1b14c2c1fe33f7b8e9db520f7df99008da', class: 'title-body' }, index.h("slot", { key: '64da630e73552324186f5d04cfb538b61b17247f', name: "title-body" })))));
    }
    static get watchers() { return {
        "justifyContent": [{
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fe1e4c4dd3179c0ad6119fc95a249f59609402e5' }, index.h("slot", { key: '7c809cca4968753697025249cc3c8a0dc587940a' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: '45a8a8c7fccfbb051393d21853d4eabce9ab090a', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
        "schema": [{
...
const RequirementCheck = class {
    ...
    text = '';
    render() {
        return (index.h("div", { key: 'f802c497b9ae89b51a79d823c88d181c44ec0988', class: { requirement: true, valid: this.isValid } }, index.h("ir-icons", { key: '7e78cc65b1218e986537a1047ec416287c68f4ce', style: { '--icon-size': '0.875rem' }, name: this.isValid ? 'check' : 'xmark' }), index.h("span", { key: 'a90bf91b3e944abba62b5a53810c11c8e957e1f6' }, this.text)));
    }
};
