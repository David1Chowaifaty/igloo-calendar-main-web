...
const index$2 = require('./index-316f57ca.js');
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9c5bd3253a45611b68755ad9b6b793e4d0c792be', class: 'my-2', "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '6d014fa8f81013416b7eb7947c0dcd370c4b95b3', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '218581df0c8a0c25e2b3083d84842065e6a9e2b2', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: 'd8f54be3bd8a4e8e80e416264ddd09b8e9e36d8c', class: "booking-details-container" }, index.h("div", { key: '47b645dc1029a10e508eb20c7ee4797618fab6c0', class: "booking-rateplan" }, index.h("p", { key: '71d3c3692cef17e4df11f74764f5f415d83371a7', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '47e4bed0d15ab28bc3f9bb0f1ba232a01bf7888f', class: 'non-ref-span' }, "Non Refundable")), index.h("ir-tooltip", { key: '879857a84f5cee99577047f4c8c62816a5e05ec8', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: 'a201a8cacc9d69053030b2190072f934648fe8d7', class: "booking-variation", innerHTML: formattedVariation })), index.h("p", { key: 'dc19b6e3caf8b661be451b46ccc8c1f4159a717c', class: "booking-price" }, utils.formatAmount(this.currency?.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: 'd980ed17d2fe3b8d58ac185181addeb302421b1a', class: "booking-footer" }, index.h("div", { key: '51ff5590c5900fc14243847dff0c26857155fbb9', class: "booking-rateplan" }, index.h("p", { key: 'ab065dd67f49c998b7c3243f59ceabade9f03aca', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("ir-tooltip", { key: '97590537862b331c8595cf1bf3bebc408c466d4b', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: '3b7498210300e7dd3f808bfe3c34eaa7d9d09553', class: "booking-variation", innerHTML: formattedVariation })), index.h("div", { key: '76d052318390d4f6711dbab72f6d8f96e1b3b306', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, index.h("div", { key: '0f8e917e8179952f4537adb61721420ffa318f76', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, index.h("input", { key: '8386ecc2917475f0d5b9cb8a827881ddf9c52b72', id: v4.v4(), type: "text", "data-testid": "guest_first_name", class: `form-control ${this.isButtonPressed && this.guestInfo?.first_name === '' && 'border-danger'}`, placeholder: locales_store.locales.entries['Lcz_GuestFirstname'] ?? 'Guest first name', name: "guestFirstName", onInput: event => {
            ...
            }, required: true, value: this.guestInfo?.first_name })), index.h("div", { key: '6fc2ea967a4f8ddfabf2a7d9b4009245995e2aa7', class: "mr-md-1 flex-fill guest-info-container" }, index.h("input", { key: '06e9530a6f0fcf5a151b939303866c92c4cb0648', id: v4.v4(), type: "text", class: `form-control ${this.isButtonPressed && this.guestInfo?.last_name === '' && 'border-danger'}`, placeholder: locales_store.locales.entries['Lcz_GuestLastname'] ?? 'Guest last name', name: "guestLastName", "data-testid": "guest_last_name", onInput: event => {
                const name = event.target.value;
            ...
            }, required: true, value: this.guestInfo?.last_name })), calendarData.calendar_data.is_frontdesk_enabled &&
            !calendarData.isSingleUnit(this.rateplanSelection.roomtype.id) &&
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("div", { key: '9e9c777eeea3db78044d979c20e0e8d3ca5db6f8', class: "mt-1 mt-md-0 d-flex align-items-center flex-fill" }, index.h("div", { key: '135d6ea519685907017089844e4606abedf5b008', class: "mr-md-1 p-0 flex-fill preference-select-container" }, index.h("select", { key: '6d69752bc7cbe59af0cff72198120da0fcccadda', "data-testid": "unit", class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, index.h("option", { key: 'd64fde750ada1b2fc54f9559df3a673be1f40054', value: "", selected: this.guestInfo?.unit === '' }, locales_store.locales.entries.Lcz_Assignunits), filteredRoomList?.map(room => (index.h("option", { value: room.id, selected: this.guestInfo?.unit === room.id.toString() }, room.name))))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("div", { key: 'e4a15532da016995daf49d6e2af6c4c1ae14bcd0', class: "mt-1 mt-md-0 mr-md-1 flex-fill" }, index.h("select", { key: 'a2a43c0d25139b55763d9bd7688c5ea1940f18cb', "data-testid": "bed_configuration", class: `form-control input-sm ${this.isButtonPressed && this.guestInfo?.bed_preference === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, index.h("option", { key: '670b843f72f83d5af065aa65cde3490b89d619a3', value: "", selected: this.guestInfo?.bed_preference === '' }, locales_store.locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => (index.h("option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("p", { key: '8a5899b1c3672900f3113be88776b4676296e9b9', class: "rate_amount" }, utils.formatAmount(this.currency?.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: '29e6e003b6e7a44247ca67d36cdab7cab7338324', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, index.h("p", { key: '8fcaa98db3e925cde9c784cb0fb31fb06d4f4014', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), index.h("div", { key: '4b19f4854e46a9f5a5beb15de2e01b534be02d5b', class: "mr-1 flex-fill" }, index.h("select", { key: '432cd7726ade5b6f023279d6859ef32ae5d64678', class: `form-control input-sm ${this.isButtonPressed && this.guestInfo?.bed_preference === '' && 'border-danger'}`, id: v4.v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, index.h("option", { key: 'ca36bfbeee7f878024b543464ffff50fc3f01432', value: "", selected: Number(this.guestInfo?.infant_nbr) === 0 }, locales_store.locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => (index.h("option", { value: item, selected: this.guestInfo?.infant_nbr === item }, item)))))))));
    }
};
...
const IglBookProperty = class {
    ...
    _sourceOptions;
    async componentWillLoad() {
        console.log('<==>roomtypes<==>', booking_service.booking_store?.roomTypes);
    ...
    async bookUser(check_in) {
        ...
        try {
            ...
            let sourceOption = calendarData.calendar_data.property.allowed_booking_sources.find(o => o.id === this.sourceOption.id) || this.sourceOption;
...
const IglBookPropertyHeader = class {
    ...
    getAdultChildConstraints() {
        return (index.h("div", { class: 'mt-1 mt-lg-0 d-flex flex-column text-left' }, index.h("div", { class: "form-group  my-lg-0 text-left d-flex align-items-center justify-content-between justify-content-sm-start" }, index.h("fieldset", null, index.h("div", { class: "btn-group ml-0" }, index.h("ir-select", { testId: "adult_number", class: 'm-0', selectedValue: this.adultChildCount?.adult?.toString(), onSelectChange: e => this.handleAdultChildChange('adult', e.detail), selectId: "adult_select", firstOption: locales_store.locales.entries.Lcz_AdultsCaption, data: Array.from(Array(this.adultChildConstraints.adult_max_nbr), (_, i) => i + 1).map(option => ({
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '59150d80c772565070b63831bcf3021f18f87231' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), index.h("div", { key: 'a4a725848e20181f71b66e79a691a80ac49cc516', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, index.h("fieldset", { key: '454b3a59306d0fe936d1df21f77c509cc2f1f234', class: "mt-lg-0 mr-1 " }, index.h("igl-date-range", { key: '871c9647640b6dd07ca68ef1d23dc0a820562aeb', "data-testid": "date_picker", variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: '2547fe12b06b797461cbbc803f84657a5728c84d', class: "text-right mt-1 message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: '20c9e58e7e78537c2dac961b55672f1c8a8b712a', class: "d-flex flex-column h-100" }, index.h("div", { key: '2aba855f7dcfcc064e1a32205d093353c8c29cc0', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: 'f71811eaba5b15d0aebcb3e6744cc28ec263cd7c', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: '1f6d81522af0a79b1905cbe23ecb0ca57fb7b528', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '0db2fbd2d69859dc6ea94a5e77f225da55b43a23', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8fe613b2db93726876920a5b0b09edd30187c5dc' }, index.h("div", { key: 'ec1473c65c240a97cec135400df4107c4ff892e2', class: "text-left mt-3" }, index.h("div", { key: '4b8e40d864076f223e659318b8f4e0667a584290', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: '9e8913449e87f14089247380ac80e7383a2a617b', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: 'b79bf188034b511187fa91540d4d2f92a6295b0e', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: '4f087b1c6656572a6d95be7bd14d2f4c2381d053', testId: 'main_guest_email', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: '4abcab534c4d9b716a8010c8948e14f02f006339', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: '60f4ccdb1c942f1551a515f0beeb31099d6a69c3', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '10593aecf69aeea1d945d38bee268f0d36e4a0bc', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: '036202b79999707f2ec9155f34330170ca068307', class: "p-0 flex-fill " }, index.h("div", { key: '480b847fa7eb39a61191288c32758e2cd7fbce57', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: 'b54e7ba3d20de4b7e89af8dc06d55edc497d1bd4', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: '82072fb991ce59466b313c62d19acaeb15df7e0a', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: '40ebc3269f85705fc15e2a09a8d37777765ee330', "data-testid": "main_guest_first_name", class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => {
                this.updateGuest({ first_name: event.target.value });
                this.handleDataChange('firstName', event);
            }, required: true }))), index.h("div", { key: 'f79edcf2928f2c204d151786209f881dd6aa50e1', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '88a97fe4e9738fd3f875074d3b0f854493e4759f', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '7d95e5f9fed3856faca3cf040a239c70f2481716', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'e3e58957745fac5bac946bb7bbe0d6d046bba0a7', "data-testid": "main_guest_last_name", class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: '46ffce0b94f78ecdce1b39c8de70a54cdd35a238', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'eeef5b7877d233ea7f23c88123d22f794062dbf3', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("ir-country-picker", { key: 'bf2eff0811b0114957c2a33bbec15656d3302fd1', testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) })), index.h("div", { key: '04d134acc7a0ff7c55b4dc53172eee3a21cdf367', class: "form-group p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '151997ff875ef228c87006158e1927fc07100d60', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: 'd66deb5692cdd92944af178dc7a903fb498ece98', class: "p-0 m-0 controlContainer flex-fill" }, index.h("ir-phone-input", { key: '1910a06bf427e3a3f7f4a587b6c724a59555f552', testId: "main_guest_phone", language: this.language,
            ...
            } }))), index.h("div", { key: 'e609d4dda726c23e7ae8dcac9471783f05965faf', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '33c140769c6075cfd25c1d21ffcfcae6f3d09f30', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: '1a6cfe5aad46ec38e5bbd1c2f733a499682735d3', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '20b5f59503764f5c5db48ff5937ca26d00d0a37b', "data-testid": "arrival_time", class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: '86f2d8483d00c99c3d7c2c6467635334b3625753', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: '2cc0a11af718cc3af1a87d47ddec3997e35c168a', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '2529b0e97ee15abe86070667bd05375dd4c532ac', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: 'b72110c9115504b4a696e5d9a9e1e6099e6240ec', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: '5d7558b845256d4b36cbc206dc3b30c6dc8a822f', "data-testid": "note", id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.paymentMethods.length > 1 && (index.h("div", { key: '0a4e7ac2347be777bfdadd91ebe63e7c0c2de37f', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'dcee47580206dda18cfab4bed072b4f5bc218e42', class: "p-0 m-0 margin3" }, "Payment Method"), index.h("div", { key: 'b349bd8289e9af94acfb2c7c7186e7af683816d5', class: "p-0 m-0  controlContainer flex-fill" }, index.h("ir-select", { key: '7dc585e733a5b9a0cfc2329b5cd1b3bfc41bca22', showFirstOption: false, selectedValue: booking_service.booking_store?.selectedPaymentMethod?.code, data: this.paymentMethods.map(p => ({
                text: p.description,
                value: p.code,
            })), onSelectChange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.detail,
            }) })))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: '97ed1e839b7d77ef26f3fce83d413c374435dba3' }, index.h("div", { key: 'eb8890d36513bc1a87f2a1fcf01318f145fe9531', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'd120e648aba969fd9983e0e13d1e614d8c5123dc', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: '362d9bcbe449241030549a43fdae28a6329e8a39', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '760011f92e491d7d60278024e2f867bd4060dcef', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: 'ddbd92c24ce5620d434da6a157142ff6b0fb2159', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '5bc4b7e13475ace70284b995d841d31627bc7824', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: 'dc66aeb787108ba4e0aa2f24f7562abb3b852a8f', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'eedc59cd8b0a423b47bfc6ad59f5eb9d76520d21', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: '90c07ee5a739c4a02c6c3a91e25599e82da329e2', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '0acaf9fd9e4b21fbc513ca958aab5fb851e2c22b', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: '6e88e9bb83b72595cd983c9ef15acbf0f7a729e0', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: '1ebfab5f369c71b93a393fc5a1fa57ac53d9864a', class: "p-0 m-0" }, index.h("select", { key: 'a263a33cffb068fff6995c6b10ffbacf951a4560', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: '8fb50de4ccd4028b2adf2dad70061e7f9a93ea2a', class: "p-0 m-0 ml-1" }, index.h("select", { key: '1a746a89e803ecc22f9ee11a59320826363c7d2c', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h("div", { key: '12033537608ffcde034532baf0664cd6ef76e5de', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '3c893a8df94c4bb6b0c2251f9cb4d08b9faf78b5', class: "p-0 m-0 margin3" }), index.h("div", { key: '9b09c4dd54b86c5b5fd3eec6a9d83d0d154c4304', class: "p-0 m-0  controlContainer flex-fill" }, index.h("div", { key: '2bb5f6c2ed74bc1067acf9f0dfe83c113594e096', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), index.h("div", { key: '3f2ca08487a7d7a14e6222aa8ea842e837014f7b', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: 'cc44888afdab6e7e740a2f77e2f21d08a37b9e4d', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: '100fb7c94cc1dd701f3d050bcbff385069723a7a', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: '5f595686211fc7f0c998552b2948cd4d123af6ae', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: 'd480caf3306472716f013bbf751a41497e15ffd6', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: '3eeb9ed8ddb77cfd8ff7cb6b536cba127ab3eb96', class: `d-flex mt-1  p-0 ${isAvailableToBook ? 'flex-column flex-lg-row align-items-lg-center justify-content-lg-between' : 'align-items-center justify-content-between'}` }, index.h("div", { key: 'fed1e9ae229d59254f5221ef5fa3b64a38f2255d', "data-testid": 'rp_name', class: "rateplan-name-container m-0 p-0  d-flex align-items-center", style: { gap: '0.5rem' } }, bookingType === 'BAR_BOOKING' ? (index.h("p", { class: "m-0 p-0" }, index.h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable")))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && index.h("ir-tooltip", { key: '72c4bc572f43460b89e639398671b77f24fb3bce', message: this.getTooltipMessages() })), isAvailableToBook ? (index.h("div", { class: "d-md-flex m-md-0  justify-content-md-end align-items-md-center flex-fill rateplan-container" }, index.h("div", { class: "flex-fill max-w-300 flex-grow-1" }, index.h("fieldset", { class: "position-relative flex-grow-1 w-100" }, index.h("select", { disabled: disableForm, "data-testid": "adult-child-offering", class: "form-control input-sm flex-grow-1 w-100", id: v4.v4(), onChange: evt => this.handleDataChange('adult_child_offering', evt) }, formattedVariations?.map(variation => (index.h("option", { value: variation, selected: this.formatVariation(selectedVariation) === variation }, variation)))))), index.h("div", { class: "m-0 p-0 mt-1 mt-md-0 d-flex justify-content-between align-items-md-center ml-md-1" }, index.h("div", { class: "d-flex m-0 p-0 rate-total-night-view mt-0 flex-grow-1" }, index.h("ir-price-input", { testId: 'amount_input', disabled: disableForm, onTextChange: e => this.updateRateplanSelection({
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a4feed1422373487263a9ed0189ce1a56ba74967' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("div", { key: '6183a2ed0d323c6e3f4b73259b1854e8cbcebcdd', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrBilling = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: "billing__container" }, index.h("section", null, index.h("div", { class: "billing__section-title-row" }, index.h("h4", { class: "billing__section-title" }, "Physical documents"), index.h("ir-custom-button", { variant: "brand", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = 'invoice';
            } }, "Issue invoice")), index.h("div", { class: "table-container" }, index.h("table", { class: "table" }, index.h("thead", null, index.h("tr", null, index.h("th", null, "Type"), index.h("th", null, "Number"), index.h("th", null, "Date"), index.h("th", { class: "billing__price-col" }, "Amount"), index.h("th", null))), index.h("tbody", null, this.invoiceInfo?.invoices?.map(invoice => (index.h("tr", { class: "ir-table-row" }, index.h("td", null, invoice.status.code === 'VALID' ? 'Invoice' : 'Credit note'), index.h("td", null, invoice.status.code === 'VALID' ? invoice.nbr : invoice.credit_note.nbr), index.h("td", null, invoice.status.code === 'VALID'
            ? moment.hooks(invoice.date, 'YYYY-MM-DD').format('MMM DD, YYYY')
            : moment.hooks(invoice.credit_note.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("td", { class: "billing__price-col" }, index.h("span", { class: "ir-price" }, utils.formatAmount(invoice.currency.symbol, invoice.total_amount ?? 0))), index.h("td", null, index.h("div", { class: "billing__actions-row" }, index.h("wa-tooltip", { for: `pdf-${invoice.system_id}` }, "Download pdf"), index.h("ir-custom-button", { id: `pdf-${invoice.system_id}`, variant: "neutral", appearance: "plain" }, index.h("wa-icon", { name: "file-pdf", style: { fontSize: '1rem' } })), invoice.status.code === 'VALID' && (index.h("ir-custom-button", { onClickHandler: () => {
                this.selectedInvoice = invoice.nbr;
            }, variant: "danger", appearance: "plain" }, "Void with credit note")))))))))), index.h("div", { class: "billing__cards" }, this.invoiceInfo.invoices?.map(invoice => (index.h("wa-card", { key: invoice.nbr, class: "billing__card" }, index.h("div", { class: "billing__card-header" }, index.h("div", { class: "billing__card-header-info" }, index.h("p", { class: "billing__card-number" }, invoice.status.code === 'VALID' ? invoice.nbr : invoice.credit_note.nbr), index.h("p", { class: "billing__card-type" }, invoice.status.code === 'VALID' ? 'Invoice' : 'Credit note')), index.h("wa-tooltip", { for: `mobile-pdf-${invoice.system_id}` }, "Download pdf"), index.h("ir-custom-button", { id: `mobile-pdf-${invoice.system_id}`, variant: "neutral", appearance: "plain", class: "billing__card-download-btn" }, index.h("wa-icon", { name: "file-pdf", style: { fontSize: '1rem' } }))), index.h("div", { class: "billing__card-details" }, index.h("div", { class: "billing__card-detail" }, index.h("p", { class: "billing__card-detail-label" }, "Date"), index.h("p", { class: "billing__card-detail-value" }, ' ', invoice.status.code === 'VALID'
            ? moment.hooks(invoice.date, 'YYYY-MM-DD').format('MMM DD, YYYY')
            : moment.hooks(invoice.credit_note.date, 'YYYY-MM-DD').format('MMM DD, YYYY'))), index.h("div", { class: "billing__card-detail" }, index.h("p", { class: "billing__card-detail-label --amount" }, "Amount"), index.h("p", { class: "billing__card-detail-value" }, utils.formatAmount(invoice.currency.symbol, invoice.total_amount ?? 0)))), invoice.status.code === 'VALID' && (index.h("div", { slot: "footer", class: "billing__card-footer" }, index.h("ir-custom-button", { onClickHandler: () => {
                this.selectedInvoice = invoice.nbr;
            }, variant: "danger", appearance: "outlined", class: "billing__card-void-btn" }, "Void with credit note"))))))), this.invoiceInfo.invoices?.length === 0 && index.h("div", null, "No invoices created"))), index.h("ir-invoice", { invoiceInfo: this.invoiceInfo, onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = null;
                ...
                e.stopPropagation();
                this.selectedInvoice = null;
            } }, index.h("p", null, "Confirm that you want to void this invoice and generate a corresponding credit note."), index.h("div", { slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { loading: this.isLoading === 'void', onClickHandler: this.voidInvoice.bind(this), size: "medium", variant: "danger" }, "Confirm")))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '97a7849b786f85d214ab2dea6cd26e427fefd26b', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: '39d807781310e675327ff5e7b76cf561041f9c20', booking: this.booking })));
    }
};
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '0ff94e30034daa7a6917c02a9e7938806faa028f', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '21a259c85f18956310be1c308962e46f6efa3c68', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '79736b4c3a2d17cd2a27580268d855db7dd6b7b5', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'f094dc3683738f090953daa62fe470126b6c895e', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '96c7bf098ee387fb6f0d9b4849a63f84d403a359', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a7b6e93bb4b3f06d6a9e4f5e8d1b72f6e93b2a21', class: "fluid-container px-1" }, index.h("div", { key: '9ec60a75d37025a66a3f52e1a8eead291162ae17', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: 'df2026d371346d91d98a0777804e01570a8119ba', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: '894b17690d685395ff49d1d4273e647e31fefd7f', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: 'abb10826850756a44177f90946f60700cfc3a45c', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'c832620ee54e65c47b0c950f1ece5d54ffa7f3d9', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '921b94d523869b3c73553501f95883120aa2fe1a', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '9c55395dd7cfc1b4e554089518ccbc79199b2793', class: "d-flex flex-column align-items-center" }, index.h("ir-booking-status-tag", { key: '2f57a8fea841add0b5ad3ad15b9c8ccb3749495b', status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), lastManipulation && (index.h("ir-popover", { key: '229712ee37171b5620be9860f2ad4856d4accfe4', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'a6ac37dd001371e2546fd9420a038fd83fb94a68', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: 'a7783da874325d1f435b63d707041010afefec59' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '394b1a5dc0607859e24bf828dc1b0d8edf54b987', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("wa-select", { key: '9119ed07411b4f33b99c2dbdda36da64f8b85ec9', onchange: e => {
                this.bookingStatus = e.target.value;
            }, style: { width: '120px' }, size: "small", placeholder: "Select...", value: this.bookingStatus ?? '' }, index.h("wa-option", { key: 'c8db0a1555609f055bc8d573d7eee627e3e62b55', value: "" }, "Select..."), this.booking.allowed_actions.map(option => (index.h("wa-option", { value: option.code }, option.description)))), index.h("ir-custom-button", { key: 'bbf7611cda25006298d559909da36c7de99e058c', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), appearance: 'accent', size: "small", variant: "brand" }, "Update"))), index.h("ir-custom-button", { key: '7f05aa442316a83970698a3bd7e0a2b3f79576fd', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), index.h("ir-custom-button", { key: '65863a17748b389d27b536f47786e6d2bebb8344', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS"), this.hasReceipt && (index.h(index.Fragment, { key: '590f522b71300aafcf541783252575f0a601be88' }, index.h("ir-custom-button", { key: '7e53561dddc6d60bf6ae0533e7de12e07725e9e2', id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billings"))), this.hasPrint && (index.h(index.Fragment, { key: '9891c32196a5a4eb2f65c86309610dad0cd7c5da' }, index.h("wa-tooltip", { key: 'f65f86b9d26a601beb9e758c4db5fb4677776500', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '886cfaed86655db48953339360aaefb7764deda2', id: "print", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '146e902812bc3064b9cb4c9ca2354a9e6dd2f617', label: "Print", name: "print", style: { fontSize: '1.65rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '78ae9d0ce80707cabc5fb9afb358545b21b60eeb' }, index.h("wa-tooltip", { key: 'd3f299a04d7d610bd1e625b110bab468b1139312', for: "email" }, "Email this booking"), index.h("ir-custom-button", { key: 'f7cc871247e9e5c5251a1877de7f14fec234ff0f', id: "email", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'f64c28720325503cf2796d6005c8a82b3a9a1033', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: 'd8d20cf6a4fa48f62af691273ce4ed22eea9fac0' }, index.h("wa-tooltip", { key: '5bbd5c8e56eafe9285765ef2fa4ffdd812973ea4', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '80b002dcd61ec5db2fbe4c622e81acb7910e3885', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'c90a6098b6c012453ff7e138483806a52b474f42', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: '8f53e99e9155b3f471544af6afe3502c4540e9be' }, index.h("wa-tooltip", { key: '7a447433b0c5ebe4b1d85434e433164395ef6d1a', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: 'd663ac55acda2ba7c8e794d73fdcebed3ee990cc', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '76efba4f7577dbe3bf044421334d331c1ef9fdf8', name: "list", style: { fontSize: '1.65rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: 'ce4699e04d48d69cf74fa9140f305e2d883673d1', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'ca13b98926b517eed5d55e62263af5359ebea118', name: "xmark", style: { fontSize: '1.65rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '4cab8ff4981b7834abf9239cd3ca498a92e9cc9e', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '751d2d77eec90aa1e5c0fd993387e81e3ccb7d8b', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            } }, index.h("p", { key: '0ec8a330e913688809aba680d73f9c802071a295' }, locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'cf44e091e09464981dc857341680c40db9c0c864', class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '3e13791dbd8ddd5df8588418dc020aa37141f2bd', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: 'da28c894063e192eedc875f3f3226e4644292cf5', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
            }, size: "medium", variant: "danger", loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status') }, locales_store.locales?.entries?.Lcz_Confirm)))));
    }
};
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '959b9431f45767b0709ed73b364981cd597eda71', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomButton = class {
    ...
    render() {
        return (index.h(index.Host, { key: '726ea6a2dd1c85ee1c436b4da83c2f91e69fe253' }, index.h("wa-button", { key: '353e07102eba0653250f8bb93d31502ed58f3c3e', ref: el => (this.buttonEl = el),
            /* core button props */
            ...
            /* form-related props */
            name: this.name, value: this.value, form: this.form, "form-action": this.formAction, "form-enctype": this.formEnctype, "form-method": this.formMethod, "form-no-validate": this.formNoValidate, "form-target": this.formTarget }, index.h("slot", { key: 'ab4e9976bfea6f165f616dd1fcb24feed4ed7633', slot: "start", name: "start" }), index.h("slot", { key: '44fd50c1d92f2072fc9d9773ff173b8a71848414' }), index.h("slot", { key: '6a74d828e7f1d5c1189c1c63f8289b05dfcd5957', slot: "end", name: "end" }))));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8eb0fe06a59bdce1579efc6bd9c46221852c734f', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: '2d82780d50fcaf4c1776c1791aca630a49573afe', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-custom-input", { key: 'e8e1393e443d3f4581d885947eb3331b635eb403', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: '16937fa13bf6a4ed3e19c8ac2093003060d4d2de', name: "start", slot: "start" }), index.h("slot", { key: 'af9c4df37a70e668e7677334f9714d36d9bb6749', name: "end", slot: "end" })), index.h("div", { key: '4a3f6e7602d5f581107c7fbf87b2f6f8b982b770', class: "picker-surface" }, index.h("div", { key: 'c8ebadd41d4dc2d2ea7eb4aee2a75e25eaf99821', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: 'e94644a27df9ecdd19c25af93aac00e8236797b7', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrCustomInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cc64b4dc35373f15e2a76991746d59b40ce623c9' }, index.h("wa-input", { key: 'bd8532aefa3bb44e4e058521cb54bf63eaee6242', type: this.type, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, onchange: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus }, index.h("slot", { key: '4b978fb6f19a96394e72fde934f78461309d2566', name: "label", slot: "label" }), index.h("slot", { key: 'bd41dfd11c762f91441cda17b62558136d2a4736', name: "start", slot: "start" }), index.h("slot", { key: '285d492c25ed7bcd41b756c27091b3d647e99fbb', name: "end", slot: "end" }), index.h("slot", { key: 'cb2d756787b547ea2603f587d9aa2233eff647c3', name: "clear-icon", slot: "clear-icon" }), index.h("slot", { key: 'a6090b7bc97f18af322f72f4790fe37ba5db2c9d', name: "hide-password-icon", slot: "hide-password-icon" }), index.h("slot", { key: 'd92d006f8dfb594c337401f206fdd47c2867a55d', name: "show-password-icon", slot: "show-password-icon" }), index.h("slot", { key: '38832507783b1f25b97af86869a029acc7d53c95', name: "hint", slot: "hint" }))));
    }
    static get watchers() { return {
...
IrCustomInput.style = IrCustomInputStyle0;
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6fb64377ca6ef4fa4afb884fb258af549459af36' }, index.h("input", { key: 'fa7c44c3ee571ad17ad06acb4aa26dfed8396bac', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '64f478c14fde5bfa6ea8b9d1fe441f662bf23b86', class: "d-flex align-items-center" }, index.h("span", { key: '248e464b3d058e3bf143328c8ee2e2d7d54b6a7f' }, this.dates.from_date), ' ', index.h("svg", { key: '6add43f1a87a57e78531e9c8d1048522a2aa3971', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'd06726842c8161280377b87957e53f577299780e', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'a3ae35f98ba7ad5685e8072cc8609f565c0b92b6' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'ea2156ef69fca3303f98e22e0acf3a80bcb5cfd5', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: 'bbf8f8cf8aa4eaab64d21da230c6b7c04dab9f8f', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss }, index.h("slot", { key: '8f829884d0730ea360214db24103ebfdfcd02fc5', name: "header-actions", slot: "header-actions" }), index.h("slot", { key: '270b95bd94dc8358ecbb636bfa9180753a046e55', name: "label", slot: "label" }), index.h("slot", { key: 'bdb80a5c64f6f22611796b234240100b452ec434' }), index.h("slot", { key: '850fa759cfb5e5d647d18618a7eb54885f5301c9', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrDrawer = class {
    ...
    render() {
        return (index.h("wa-drawer", { key: '58af1410e0ababfe234f7b1baa9273004c799b11', "onwa-show": this.onDrawerShow, "onwa-hide": this.onDrawerHide, class: "ir__drawer", style: { '--size': 'var(--ir-drawer-width,40rem)' }, open: this.open, label: this.label, placement: this.placement, withoutHeader: this.withoutHeader, lightDismiss: this.lightDismiss }, index.h("slot", { key: '5db3a97f47e5e138fca7bb814783b9946c025816', slot: "label", name: "label" }), index.h("slot", { key: 'a963e70a33f9537b5280d69efdea81a89a3afb28', slot: "header-actions", name: "header-actions" }), index.h("slot", { key: '966c5cd74d7069cdc387c08714d6485a72c0e613' }), index.h("slot", { key: '56ea23f578f4361b08504b412cd946996911e31a', slot: "footer", name: "footer" })));
    }
};
__decorate([
    OverflowAdd()
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e2e03ccd5dd38998f46e482fb12ba238ee4b753b' }, index.h("div", { key: '792b5c8ed86345157e7c68f874fd1cca9394fb40' }, index.h("div", { key: 'c522335963b19b8cf4a3cc9f53af394e0cd20cb7', class: 'extra-service-container' }, index.h("p", { key: '59cf325c741c452eb0e93e46312b4ba7115a7ee9', class: "extra-service-description" }, this.service.description), index.h("div", { key: 'a8a8f64d0e0bcbcb100afd67b44f6aa90c839df6', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: 'dc002f071434925d4d5afad7e71a4e376a10f712', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: '1a3f39c33fa58a278aad67263f1ca61019d8b24e', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: 'a87322219bca1c75a21d04362e343f27a0f172b7', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: 'c451adfac9f413987c8b303bb467e909d8c25f4d', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '241bc9a5f62fd99787300ef69340dfcc66287baf', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: '018a0110a788412b974e264c4426670aef34fb42', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: '2000635bc6cbea9216be5bf05e5ed73b7d42e536', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: 'ed5107cece96338f544bdaaade8716220d722259', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: 'f438678c9cf6138a456ae49e77fdd9ae370c45ed', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: '208799762bef578f758d21be7720ee85c922a751', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: 'bea579d4b3f8601617241b3cdc1680b6e21c1437', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '6c172f4c325bde67fd8a199ccab202549ce9fe4d', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'c744e9c4a9282108eb6f99e6693e62e21dcb9417', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '5de04414d2b4656e051bc0785e788738ca3cb3dd', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: 'ec70ca040f7d172d21153c37a8db4cf37d52dc75', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: '86e3e8a1e05f852d27e4911d4016abc57b917864', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '21f884518ab35d51997019f4790851c3d39ec075', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '51ef3930ec68f2e7c0c268aa6541b9a4a889204f', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const ExtraServiceSchema = index$1.z.object({
    ...
    start_date: index$1.z.string().nullable().optional().default(null),
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '3b3a762f896894dca174cec83250e0da54bef7de', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: '6c7c92d9256951eadb6cd7d6e56f585839cbd2bf', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '70ef22af28e8a2cec9b30f3e735a455c636f559c', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-custom-date-picker", { key: '09cbf532128612719f6a1b64fd494301313b3fcd', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) }), index.h("ir-custom-date-picker", { key: 'f9a8b45eee4f08ae7851a67518595cfeb430e813', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: '0508a07a0651a25a624af20177d2ac3a794cab5f', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-custom-input", { key: '14a2924c75f14cbc234eb1f745887356a524d0dd', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: '86c3e0e795fcd35db573fb7e2cc15d8339fdf970', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: 'a155c5217ce4967839c37ee6077667280f773127', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-custom-input", { key: '2e5b07a97381784cf78988e6bb24bee08781549d', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: '9f91bdca30e31794ccf3d79f1d9d35bc525b6216', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: '2fff9df49988e98c3ea60c68a48733c9b82a9d8b' }, index.h("wa-card", { key: '0baec271a3decbe82cb2a1ca9fb6d0ebc5610e72' }, index.h("p", { key: '67834b36b886ccf06151533d4872a504efdff531', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: '9420a1369c1868c99f07a7cc7f4698ee331b4505', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: 'dc0348d3cf1a5a408fca5ba279dbd5d9c36dd0aa', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '9d87276f99a2d7adae23e17d2041e64be47ed98b', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && (index.h("div", { key: '3142e72ee972929d5d468f5913bbca019c96ec7b', class: "text-center p-1" }, index.h("p", { key: '01f0d179d9e1cc517b2a297c4ccc3f824dd64e9c', class: "text-muted" }, "No extra service recorded yet"))), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '23160e66d1605a5f32f82b344ee3119cbe785ad0', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (index.h("div", { class: 'loading-container' }, index.h("wa-spinner", { style: { fontSize: '2rem' } }))) : (index.h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), index.h("div", { key: 'cfa562b476d5924b33762eb035b0d114a7d1ba24', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'd00ce205c08b8e79a016d5692f7ff1e00033cfab', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '937cdbe1be7d0780eb726b6d5fa7175b9960add5', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrGuestInfoForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4a2fc58c908456a3fb289c680a0b032a067c57d3' }, index.h("ir-validator", { key: '2ee76ff5d4258ac732d0609b7a5a0e9bf81e93b1', schema: guestInfoFormSchema.shape.first_name, value: this.guest?.first_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '1a4c2a5d155ee558f42267dbd16df573e7b80623', id: 'firstName', value: this.guest?.first_name, required: true, "onText-change": e => this.handleInputChange({ first_name: e.detail }), label: locales_store.locales.entries?.Lcz_FirstName })), index.h("ir-validator", { key: '61162e455a0404e2140167d5d086856764a526cf', schema: guestInfoFormSchema.shape.last_name, value: this.guest?.last_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '23e205354334b771410c10978e712c81ced2d468', value: this.guest?.last_name, required: true, id: "lastName", "onText-change": e => this.handleInputChange({ last_name: e.detail }), label: locales_store.locales.entries?.Lcz_LastName })), index.h("ir-validator", { key: '08e0f3ba08937e8c48d79e6d9778f5760a9b9c53', schema: guestInfoFormSchema.shape.email, value: this.guest?.email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: 'cd8c61f1f1b43eb1a4309e20b08a7c8efc77cadc', label: locales_store.locales.entries?.Lcz_Email, id: "email", value: this.guest?.email, required: true, "onText-change": e => this.handleInputChange({ email: e.detail }) })), index.h("ir-validator", { key: '98543268808a659f56ec0e4f7690f64dd4176f2c', schema: guestInfoFormSchema.shape.alternative_email, value: this.guest?.alternative_email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '47f0806f6ae1c272b16138a22ba7a705acdd73bd', label: locales_store.locales.entries?.Lcz_AlternativeEmail, id: "altEmail", value: this.guest?.alternative_email, "onText-change": e => this.handleInputChange({ alternative_email: e.detail }) })), index.h("ir-validator", { key: 'b38ee78abe251b187ed3c8126b41fd9202be0f8a', schema: guestInfoFormSchema.shape.country_id, value: this.guest?.country_id ?? undefined, autovalidate: this.autoValidate, valueEvent: "countryChange" }, index.h("ir-country-picker", { key: 'c75c11ad082e8df28e9f2d8b596754f2c7c68686', size: "small", variant: "modern", country: this.countries.find(c => c.id === this.guest?.country_id), label: locales_store.locales.entries?.Lcz_Country, onCountryChange: e => this.handleInputChange({ country_id: e.detail.id }), countries: this.countries })), index.h("ir-validator", { key: '73c568252db91222218585143d76f5ef676b07a4', schema: guestInfoFormSchema.shape.mobile, value: this.guest?.mobile ?? '', autovalidate: this.autoValidate, valueEvent: "mobile-input-change" }, index.h("ir-mobile-input", { key: '5157518cb604359ffd115318afddae94132aa2ee', size: "small", "onMobile-input-change": e => {
                this.handleInputChange({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => this.handleInputChange({ country_phone_prefix: e.detail.phone_prefix }), value: this.guest?.mobile ?? '', required: true, countryCode: this.countries.find(c => c.phone_prefix === this.guest?.country_phone_prefix)?.code, countries: this.countries })), index.h("ir-validator", { key: 'f07798d6299155d4e3d7dacf56aff51428e78752', schema: guestInfoFormSchema.shape.notes, value: this.guest?.notes ?? '', autovalidate: this.autoValidate, valueEvent: "wa-change change input", blurEvent: "wa-blur blur" }, index.h("wa-textarea", { key: 'c0966460b91fbf9e81fb4e4c472df9db5dfacb94', size: "small", onchange: e => this.handleInputChange({ notes: e.target.value }), value: this.guest?.notes ?? '', label: locales_store.locales.entries?.Lcz_PrivateNote }))));
    }
};
...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (index.h("button", { key: '6a660a952784a0d87722a3add6b8dab1c2c556d0', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '6a4493d1938ddbde7a967b9a740e6bc89ed03e4d', name: "icon" })));
    }
};
...
const IrInputText = class {
    ...
    initMask() {
        ...
        this.maskInstance = index$2.IMask(this.inputRef, this.mask);
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '765f93e3fc58ad388ebf4c533848b48559bc3bae' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '46187e654c2d9c0cea49cdaa6911f01138e34774', class: "loadingScreenContainer" }, index.h("div", { key: 'cc118f5ef1a283a27b23285b2cf1392021f9d862', class: "loaderContainer" }, index.h("ir-spinner", { key: 'cfd51d1317ab6ed6506627fc79d0bfc674d97507' })))), this.showModal && (index.h("ir-otp-modal", { key: 'cdb0925379c6726de2156d199bff0f35dfef5ec0', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '778dee5a744933a44c8e927428c85e50b4ed0d4b' }, index.h("ir-drawer", { key: '8bc320bcee0197d5c0d4f5c8b70552ed6c3986ae', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, this.open && (index.h("ir-invoice-form", { key: 'bc3d12d09eac9a58e64642f3242be915d0df48c8', for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, mode: this.mode, formId: this._id, invoiceInfo: this.invoiceInfo })), index.h("div", { key: 'c0f5238e5120e79743810d080464bf34b3c4727e', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'b1ceb88c6bef53096ee37d3a7ef0d1b71134fb84', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '7b6ed72795d060d7581989d1cca5a2c3ae40fc12', value: "pro-forma", type: "submit", size: "medium", class: "w-100 flex-fill", appearance: "outlined", variant: "brand", form: this._id }, "Pro-forma invoice"), index.h("ir-custom-button", { key: '3522b45faf40e09a2a2c7ba0d24d1b0c31b10fa1', loading: irInterceptor_store.isRequestPending('/Issue_Invoice'), value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand" }, "Confirm invoice")))));
    }
};
...
const IrInvoiceForm = class {
    ...
    renderRooms() {
        ...
        if (!hasSplitGroups) {
            ...
            return invoiceableRooms.map(room => {
                ...
                return (index.h("div", { class: "ir-invoice__service", key: room.identifier }, index.h("wa-checkbox", { size: "small", onchange: e => {
                        const value = e.target.checked;
                        this.handleCheckChange({ checked: value, system_id: room.system_id });
                    }, defaultChecked: isSelected, checked: isSelected, class: "ir-invoice__checkbox" }, index.h("div", { class: 'ir-invoice__room-checkbox-container' }, index.h("b", null, room.roomtype.name), index.h("span", null, room.rateplan.short_name), index.h("span", { class: "ir-invoice__checkbox-price" }, utils.formatAmount(this.booking.currency.symbol, room.gross_total)))))
        ...
        return groups.map(group => {
            ...
            return (index.h("div", { class: "ir-invoice__service", key: group.order }, index.h("wa-checkbox", { size: "small", onchange: e => {
                    const value = e.target.checked;
                ...
                return (index.h("div", { class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("b", null, room.roomtype.name), index.h("span", null, room.rateplan.short_name), index.h("span", { class: "ir-invoice__checkbox-price" }, utils.formatAmount(this.booking.currency.symbol, room.gross_total))));
            })))));
        });
    }
    ...
    renderPickup() {
        ...
        return (index.h("div", { class: "ir-invoice__service" }, index.h("wa-checkbox", { size: "small", onchange: e => {
                const value = e.target.checked;
                this.handleCheckChange({ checked: value, system_id: sysId });
            }, defaultChecked: isSelected, checked: isSelected, class: "ir-invoice__checkbox" }, index.h("div", { class: "ir-invoice__room-checkbox-container" }, index.h("span", null, "Pickup"), index.h("span", { class: "ir-invoice__checkbox-price" }, utils.formatAmount(this.booking.currency.symbol, this.booking.pickup_info.selected_option.amount))))));
    }
    render() {
        if (this.isLoading) {
            return (index.h("div", { class: "drawer__loader-container" }, index.h("ir-spinner", null)));
...
const IrMobileInput = class {
    ...
    initializeMask() {
        ...
        this.mask = index$2.IMask(this.inputRef, maskConfig);
        if (this.value) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8df77143c0600f4ac9781f4a78998fe5c0dee521', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: 'ff70606be2b0aaee37ffd35bc82a7a9ebcdffbb8', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: 'ebdb3b0131ece6aaf8f1ba3d0ca20417ddc9fa62', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '15cf504b03df39b124decfe86e9284435e383bec', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '00cdc437a9cb0161435206113deb900cce7988c4', slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: 'f5d163592a2ce1cb54b57ba2063165c52f687783', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: '585f2688120b5d231a50ca7078b0516c4ae60ab0', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: 'a75c93a692af05ddf60cffcbc094379f54ce8781', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("input", { key: 'fca9399eab3ec8b94baaf918e3851d8904baa1b5', ref: el => (this.inputRef = el), id: this.inputId, class: {
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '122189cc945e0228a5dddd82401be27e0fda925f', class: "otp-input-container" }, index.h("div", { key: '11990cb15ed5ba2d65dc3c3fd172ca1162c8036f', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'b723c66773719706f0a208c5ee338ac20303b629', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '69c438da802cbfdcfa3e9ddfa8d07bfcb98fa4ed', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'c0d1926e4ea33e9988d20c7e2bcd7d2d6779e86b', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: 'd638c79be31622d86b09c2e0dac2a4a35ee6b86d', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: 'b1dafc15631e20cf6fa29343a2d346b076b4a90b', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: '842e9e97b94c7a0f3b32c33f537d81fb3ad2fd42', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '290419ee8eef1be861ba75f941e6a85a98116eb0', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '673a8a527b707a2627beeac319da34db81f52e4a', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'f2caee8f1372a669d176806a2989af71749e723c', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'fab131fd877643f99031504712621ae1cdbb3b1c', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: 'ac916de99b498b6b3a44c7f1edee84040760ad9d', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '096c4b1128d8023ed2997f7db2040965409f0fc0', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '8c69f6a7385314bd4e563c5d799421adf2726711', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: 'c226527b1b7e703dc1a8b879a1fda0af1c217deb', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-custom-input", { key: 'c3e2948be12d2c11a57cf1bcde24856de512aea9', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: 'bb2106021fe7754a0f5d29958333fc8926c0083c', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '21f43cec7b0b29e68fef97fbcdcbfd061d3e5e17', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-custom-input", { key: '0d7425be12374f8b7c3d91cb985c34ed2181735c', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'ce5406c689e02b234515bdd59e1b30077a4e8c51', class: "payment-item__payment-item" }, index.h("div", { key: '63dce9d730e4a0d7aca0639235cbcc1883eb39c5', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '9304a9d1bb0d809fc71e938d72b3d201f4d79db0', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '5a9ba554116c7bb92df706f871277afd17eae8b3', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '2701c848972f98e9ff2a2f48a801fdd1238c71a2', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '33cc9d662b96a175b7495165a645e65af26d0125', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '12600876408e6872907899975cf65ed15aa5f550', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '73c3f68cd0ca7ac3c12b5f4a61a6d5dcc8fd9b26', class: "payment-item__payment-toolbar" }, index.h("p", { key: '04393358df77be456c44e0336ca38aabc986e079', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '9fdb4f5a665a396e030fd26b74ca3e0da44bd957', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '8d466ff397bf0040c7c75d9ab8ffa22728d27593', class: "payment-item__payment-actions" }, index.h("div", { key: '101dbb208d40970bfe461d334457742fb526948e', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: 'b153b9d1a6a0099103adf023778470cab7f93797', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '65970150d1f02a678ca6762dffafb2213bb333d0', name: "user", id: this._id }), index.h("wa-dropdown", { key: '60a85a1dd198747a973d23071ec6dd32a2e24d44', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            } }, index.h("ir-custom-button", { key: '301b0dfc6a7ecddef531d89f87e2aaa9721ec1e2', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: '4abd3c89150d17bbafc60ca6d803b4daaf1dacf8', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: 'd31e7e0434d51c8ae1aa0b7bdc69588ab4865068', value: "receipt" }, index.h("wa-icon", { key: 'c92af65b48c55ea68c6baa0004d70f9b690734f5', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: '2741452fc22db4648257a37090a5a4590c741031', value: "edit" }, index.h("wa-icon", { key: '8f24c5c7238ae3e938a5d64f8ecce046dc40b4ce', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: 'b11e4255c4e05ee5c4d7edcfa4f48f60fa3d6bcf', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '0c327553e33fc2acb8d8fb73f09c2760bb294a7e', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: '220b89638a003096a3a848851e7e6a7ac283cc7e', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: 'ba36ac16f152836697e9ef7add05ba9ef3cf2500', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '7e5faddde9423092ae38a49f779a64a798f855de', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '4aa6ad6095275ba15dd1962209f6b6418a261fa8' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '51532f54c6d0d2f17166b6028b929d727848722b', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'ced8b3ddf8c1856e43ee7a07a7d9ea83968ef3b6' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: 'e1b82982d7ef1f443fe1b83813ab80918602c619', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '614faef9932a110d58b8a1f85ee94071e7439dd7', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '6b78302dae3f3331d695384665b0e5744f450e46' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: 'b643e85632dd86f9e22ba604d6e48e9fb9a789d4' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '779668782e1587825b855c644f0be1a8e2b9e277', class: " payments-container" }, index.h("div", { key: '011bd5aae8cd61e08991a591c8fa1b5255635f5e', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '1ace0c626da30386cd102af3b60f0b6605c8a1ec', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: 'f01e2ee65485085f96201136ef63fc14cbe19d7f', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: '00b055d2c6de0bf77dde5a5c3d742a5a49c24b0e', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: 'ad00e8a8443aad6d97701521556f9542326452c3', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: 'fd905b3377841be2c8e43f61633bc0f65c58ae0d', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b2921847833f3d4e2fb9bf1b603a2227a92ab9a7' }, index.h("wa-popup", { key: 'f7eb05ed4b1b9472eaff50f10bb9e001e4e5f1f9', flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '562e6dbdd68ebf9ab0692eead94bc54054217145', slot: "anchor", class: "search-bar",
            // withClear
            size: this.size, value: this.query, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
            } }, this.loading && index.h("wa-spinner", { key: '1033ea1be35602c6329f56701532dc9c71706ebe', slot: "end" }), index.h("wa-icon", { key: '05a5c420f8d0330452d9ac965e2a8884bdb58e01', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), !this.loading && (index.h("div", { key: '0cd34893353cf4a1dfdd1dcc32e37390d634dd21', class: "menu", role: "presentation" }, index.h("p", { key: '68b39bf25b84db0c61a1b0fb8f34ed8cf9ec6c34', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: '3af6afab6183e12dd0c054a1506bb1da3f501650', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, index.h("slot", { key: 'd110336024ba60bcf4571848e8e6ac8796e04dc2', onSlotchange: this.handleSlotChange }), !hasResults && (index.h("li", { key: 'f363437f00ec137a5e554d8dde1f9a17ed003bdf', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: 'c572230095375127f3b9f1c1a9189a41d1e2d02a', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: 'f5490cc18df9fb00c9136700d447cd8eb26ddeb7' }, "No results found"))))))), index.h("span", { key: '1f4bfff92ff82b610ed44232fc2cd0f1708ad77d', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '7d7d9d1847a3322afd0ca3e39b52fa6762b1f059', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '7266d8d1e5f95af670d72523d88517271801311d', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'a3ccb88c933fc3fc0c8b8879b84ba4755e0e5395', class: "picker-item__check", name: "check" }), index.h("div", { key: '7a101e5747901ef713e863cac24fa7b3e5717753', class: "picker-item__content", part: "content" }, index.h("slot", { key: '6d6ef0dd82507631a860a991a130f6641d26b54d' })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'ef670216c445a7b01e6c0586614c94435dc4cfd6', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: 'd95ce85350b37af1a30a9c44c66af5727fd6e090', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '6e810ca51ed2b641aff23385e65ae660d42ec867', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '97b1cdc6ce2d2d12ac018fae53cfca4997c6dd1e', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '096624119b476d433407dc218b71670c184b32ea', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '826c111e1d6aa2e15c9f1fc5e167abeeeee28090', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '6505317e331bad1389bacbc15434eda44ee94b1e', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '133b52694ab962eacab6e367cd82ef4fe72cbc7f', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '59f41417bc0b1e3c863790330a5958197599b7fa', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: '4867a5761552e9dfda2604ca841d894152937ca8', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '8835a4549efea72d59f3a640832348d002e469ab', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: 'c461528953419bc967f5ea84ca29083cae28bb14', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: 'e2f0ab376cd8f3f479b8a15d832ea1a1cbebc91c', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '1aa6afdecf291164ce9cc3f20e548c5783052810', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '834dfce86371b2e732feac36432b6b94afa85e57', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: 'c1e36d261bfda568784ede2b00e2f6a5f9046de1', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: '58e7b791cf1a1463cb3e9d13fa54b7217030e414', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '06f406d085eebf2c70c568ba4fde5170a481aecf', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: '75961cfea1faaa727296c74d4b4cca660d744a1a', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'ceff2c004a3d08ad3f81254f9e290a4974a51004', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-custom-input", { key: '68ac6e7b0ef6c64325a2cc7ae95a47f3d91b1a6b', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: 'daabe3a80579ee43f4ddd5b3b603f6186f0c2f06', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '649205af68ffe8d03decb137c9026aba425a95c9', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: '2ac9f6a8d49ec541078fd22b15b9ce5fe8392720', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '28e75c0c739b68ae28cf79cb2e83ece48eb7ee9c', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '98e04e2bac4d9bb77da92936b76cff0c889f53e9', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '336d84110ddf3ed9ed2987dd1a45b3305120b855', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '2318ac97fa9b446ef85dfa58c7cea499aeec85a2', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '3ba403bb44c998547159ba252cb92f759e8bb9c7' }, index.h("span", { key: 'ea3433f140442d69a3b04f88ffa9679853388d28', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'bf2fab551bad834776eb7681ba8d35591d12e008', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '4b84673aac4b17b9969658d31bab3abe968c4e3a' }, index.h("div", { key: '6b3743b035a1a830e1103a351d83ed146fce8107', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '678cc947f6e4824ad0a55a42658873ee091d7391', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: 'b5acabbdcbe3100987635e6219dc2a58263f6474', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'b3e6ff2c6c13daa51ba626ebdffbae7870166f33', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '2d5dfdf6946aabceba0e0adef5bb95e13877d6f4', class: "reservation-information__row" }, index.h("ir-label", { key: '9e82518feedf40d932aa2ffc3112e996e053bed4', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: '9444a325ebaa5c27145f27e26296ff5a87ec7bf0', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '79b9df853a1f470f72966ed89cbc5837683431a7', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '4b0c074d124212a0258c3eefa10b0e490a8cab44', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: 'ad8143987f9999a7e369f894387d594e9a3bc08c' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '509b5ef85b4882e1328977e10b83650c578e3980', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: 'b78e92b0cfd4f7977d90b1f8fc0d6a987464e011', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: 'cd9fbbc678204d6f79c7ffca1cc06169ed3fb27b', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '4194dfc398bffd4e213a3a6542474e7d9cddc979', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: 'c4a892edc4ae471b7e3715ed08a1c35de0727d3a', class: "reservation-information__row" }, index.h("ir-label", { key: 'c4df76080b45e225d742f3f1019d49f244bc66f6', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '730c1a21b9015b3b08cbe800660dcb1a804fe604', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: 'a85d18609937308797ecc979718d2530c5e85f23', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '3ff1597cb0484ca793918f5011ae12312f368e59', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: '4b7dc3478414324ff6159206a03c6c29f06cea0a', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '810183d6215fa3638a6661f90ef2cbba15993182', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '6d1a4cd16ce46feabc7e610fb528038f266d6f93', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: 'ee5a7d74577bad86705d851493a3bd4143632dd6', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'c0fc6b6142639ac5278f4ea8a230c8bbc3ba2092', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '9913424b09c38d10fc7d66b475267c9cef48ce62', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && index.h("ir-label", { key: 'dadbdcf04ba03ed17cc250208be52513cd44ee46', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'e98f3d966b081af8230be98f89fd3bcf60ae6e19', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'cc9cd8eaaffd33a24929f25ca99edeb4cf895655', class: "d-flex align-items-center" }, index.h("svg", { key: '87c9b779f3c04715074ba0b9392686c18d4db285', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '0edf397af8d4e68c8e79673babc7742fba54e902', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '124556a8e4937b3b680adc3b140727aee5dbb027', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '908bfd90fd73b903e5940c5e144d5609380e3295', class: "reservation-information__row" }, index.h("ir-label", { key: 'dba1300ce7b16fd2677fba1d2e1c0222a615a53c', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: 'a95ca4e7a62fc946d22c1b34c01de11b9f8c9648', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '30482ef6e7e80c2655eb6d872f75bc27fa09aaf4', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'b4c67ecaf2c23092383f6cd45207c4c6875da179', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: 'c04ca5d0a26df9372d746ce633eddca8a86dd93d', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-form", { key: 'ffdfa6a6360b25dd0bb2fabbf721dbc2f9ba0cd4', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f5894ba97a84cdf1f99db5b4cc8d47ef7da2a558' }, index.h("div", { key: '70bcf6edc5c02b32f66aba5652375c5488b12128', class: "booking-room__header-row" }, index.h("button", { key: 'de8e7a9a12caaa78d54266b9d9c51adc3cbf7e5c', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '916f1fab845c535e7fe737693dce20e3f2f1dc76', name: "chevron-right" })), index.h("div", { key: 'eb5efdc2716abdb5bf91b08974e993660f3824c5', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '58c7966a66d8173feda3028211023f27770b6706',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '41a26cecf74ad3a40624f77bc438f92760537eb5', class: "booking-room__summary-row" }, index.h("p", { key: 'c07947cc30e15db4111a59f3bd0f56f8606308ff', class: "booking-room__summary-text" }, index.h("span", { key: '91ac7b5888a8af33f9485ad0cfeae95258b269d5', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '1db15c7e851748fa4ca28599cb967ef4b8111a35', class: "booking-room__price-row" }, index.h("span", { key: 'f28d73282ad75537c8da615caa4fefaf72f2c4a7', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: 'eb2d019b9d2d88164773a677d071fa3b8ac77783', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: '9c2eca4f0cf335be814fd7d38b6727b1629d52bb' }, index.h("wa-tooltip", { key: '8305abae5df7c2804714398c0351fab56de6417d', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: '2682bb5f8de1c455123130b10579de26d7ad4db4', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '1a27ada2b9f9a6b6c80bfa419a3f76378928b97c', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: 'a1609a53bffbfb8105d8a29ca67b8fc8a5dd059d' }, index.h("wa-tooltip", { key: '86cb75ff0d54412747564b365db0140da397787c', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: '1ebe947fb63de795f8454db74a37cd8f5f24ddc9', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'cf2ebb02d38f1fc05119144dd312fa6434510a5e', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: 'a1f0dacf49b6b05ee188cf0bd2b61469f1b4fd9c', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: '770bc0bbdefada3331d6f50e944626e7b7ecc444', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: '5fc9b669ad871e08832fb9984048c9914bd4e136', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '44493808b025b3c8e11454bfb4183b4ae6a03d52', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '8a26a7c7264322420bff9401a09d610cce38a306', appearance: "outlined", variant: "brand", onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: '2146aa249ca0cf4742f3caf42b5c667d1c530e8e', class: "booking-room__guest-row" }, index.h("p", { key: '1a6bcb06d7c67ef31735a43046a1442356072785', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (
            ...
            //   ></ir-button>
            // </ir-tooltip>
            index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: 'c19846cda4b9d8365326a2726a8a0e0cc1a3bb34', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '5c942a343c4db9f917cb690deaf2798df0116e3a', class: "booking-room__departure-row" }, index.h("p", { key: 'b9e52473961fb4e475bf9223c8ef168f5979d00b', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: '385d48f4534fd46a1486f46ec36b6ca67614d5a5', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: '418576ec569ff06523a06d21fc910e4af9a6fcb4', class: "booking-room__details-container" }, index.h("div", { key: '131b731cdbb7e33fe13340686632bde27f6b65d7', class: "booking-room__breakdown-row" }, index.h("div", { key: 'b06d77bdb91893345d42854937d4a0922a56c7e1', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: '1e4c80f02620b317b0851b971476b81498f8a040', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '8c615cee3c03e46a8b864a8cd8be89ecd435caba', class: "booking-room__breakdown-table" }, index.h("table", { key: 'b6f512d859bf6bf8d3a11f024d4ccb7edc92f4b8' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '690f5e2d7ac56dfc2aeca3471fd62361093ac87e', class: '' }, index.h("th", { key: '10391521d6ef1f924160c789739d79334c96c001', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '2ccc2e725267ebb12fb32f7dd326cb235f824345', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '09142a4b9c41afe74da2e4262685f54556eae074', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '190659f52198dd8744a56ed314ce1bf9affbe408', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '44f5e73990cb0e7c7934e94052cd03e5a444905d' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '0ab8768991f37c318b39e88318f58202ba889639', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '89dd86c0bcefae8e5de6a05ff19d7282d9ce0dd9', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '36da71e7048d0ff711bf11d3f58fe192f13983e3' }, index.h("ir-label", { key: '7986fb851515d4ed4ec94284c64ee23b0a93fc43', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'e7250ebae5f5e8780a979744b9390be4ea7c91a6', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: '1e87ef1f8f3662de80e119834a826d2b466431c9', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '28cceaed9c4079205122ccaaaa15776591def04d' }, this.renderModalMessage()), index.h("div", { key: '4185cb3916210c04b395f756f6b856e266affff7', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'd1534a6c84c4eede8855b83858e0df3b212c5847', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '69f082e613ea52dcc9fa69613795020ce3f384a8', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm)))));
    }
    showGuestModal() {
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
        this.openSidebar.emit({
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (index.h("ir-drawer", { key: '197472c5fd11c9387199e9c74caa28f9705a3f63', style: {
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-room-guests-form", { key: '3a553bf64ce141fb9cf8b7a0aa16f1c997d213df', sharedPersons: this.sharedPersons, roomName: this.roomName, countries: this.countries, totalGuests: this.totalGuests, identifier: this.identifier, bookingNumber: this.bookingNumber, checkIn: this.checkIn, language: this.language })), index.h("div", { key: 'ed363338bb6dd96b2bd721ed84a11a9179587974', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '486bed22b236d3af81ad9a40067936c64db43345', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: 'da8c138147e01706a80f0bb7dd0ba46ceb2ed1fa', loading: irInterceptor_store.isRequestPending('/Handle_Exposed_Room_Guests'), size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save))));
    }
};
...
const IrRoomGuestsForm = class {
    ...
    render() {
        ...
        return (index.h("form", { id: `room-guests__${this.identifier}`, class: "sheet-container", style: { minWidth: '300px' }, onSubmit: e => {
            ...
            return (index.h(index.Fragment, null, idx === 1 && (index.h("div", { class: "d-flex mx-0 px-0" }, index.h("h5", { class: "mx-0 px-0 sharing_persons_heading" }, locales_store.locales.entries.Lcz_PersonsSharingRoom), index.h("p", { class: "mx-0 px-0 sharing_persons_label" }, locales_store.locales.entries.Lcz_PersonsSharingRoom))), index.h("div", { key: idx, class: "guest-grid" }, index.h("div", { class: "room-guest__section" }, index.h("label", { htmlFor: `first_name_${idx}`, class: "guest_label" }, "First name"), index.h("ir-validator", { class: "flex-grow-1", schema: ZSharedPerson.shape.first_name }, index.h("ir-custom-input", { "aria-invalid": String(!!this.error['first_name'] && !isRowValid), size: "small", id: `first_name_${idx}`, placeholder: "First name", "onText-change": e => this.updateGuestInfo(idx, { first_name: e.detail }), value: guest.first_name, maxlength: 40 }))), index.h("div", { class: "room-guest__section" }, index.h("label", { class: "guest_label" }, "Last name"), index.h("ir-validator", { class: "flex-grow-1", schema: ZSharedPerson.shape.last_name }, index.h("ir-custom-input", { "aria-invalid": String(!!this.error['last_name'] && !isRowValid), size: "small", id: `last_name_${idx}`, placeholder: "Last name", "onText-change": e => this.updateGuestInfo(idx, { first_name: e.detail }), value: guest.last_name, maxlength: 40 }))), index.h("div", { class: "room-guest__section" }, index.h("p", { class: "guest_label" }, locales_store.locales.entries.Lcz_DOB), index.h("ir-validator", { class: "flex-grow-1", schema: ZSharedPerson.shape.dob }, index.h("ir-custom-input", { "aria-invalid": String(!!this.error['dob'] && !isRowValid), id: `dob_${idx}`, mask: dateMask, size: "small", placeholder: "", "onText-change": e => {
                    this.updateGuestInfo(idx, { dob: e.detail });
                }, value: guest.dob }))), index.h("div", { class: "room-guest__section" }, index.h("p", { class: "guest_label" }, locales_store.locales.entries.Lcz_Nationality), index.h("div", { class: "flex-grow-1" }, index.h("ir-country-picker", { size: "small", variant: "modern", "aria-invalid": String(!!this.error['country_id'] && !guest.country_id), propertyCountry: this.propertyCountry, id: `{locales.entries.Lcz_Nationality}_${idx}`, error: !!this.error['country_id'] && !guest.country_id, country: this.countries?.find(c => c.id?.toString() === guest.country?.id?.toString()), onCountryChange: e => this.updateGuestInfo(idx, { country_id: e.detail?.id?.toString() ?? null, country: e.detail }), countries: this.countries }))), index.h("div", { class: "room-guest__section" }, index.h("p", { class: "guest_label" }, locales_store.locales.entries.Lcz_Documents), index.h("div", { class: 'room-guest__info-container flex-grow-1' }, index.h("wa-select", { class: "room-guest__id-info", defaultValue: this.idTypes[0]?.CODE_NAME, value: guest.id_info?.type?.code, onchange: e => {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3dfd95ba6d6072c937f53af3379637919ce0f439', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '4ed4ad9363b69bd17a238e899be3db717139a261', class: "input-group row m-0" }, label, index.h("select", { key: '85720d18a7e126bf6edc84a63632c79ef4ccf50d', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'fee814bb57d7f960f270cb8b890766f11ebff143', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f8c6219ea08f01ab68ce8727a360b9dc3b5768db' }, index.h("wa-spinner", { key: '92ce72b0a18ce705b66b9288bfe3485f246102fc', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '848e16f2b5dca881a69c014d494ed60ba162dbc9' });
    }
};
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '2ecc4e11053e4984a0a2a0da6b657cb4c92db85a' }, this.showTooltip && index.h("wa-tooltip", { key: '7807a3a4d5354ae99b0a9fcdf1e0240a45248003', for: this._id }, this.unit), index.h("wa-tag", { key: 'a45fd52c099737e949edc5abd0f53b12d71116c2', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '63740d9cfa9c05d3cfea36278841810717570406', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ab8e64224f4f1e64f52917e3080f44fc8e3edd0f' }, index.h("slot", { key: '7a9a55f8f9e6d7fb949270dc14584317ce3db32f' })));
    }
    static get watchers() { return {
...
exports.ir_custom_input = IrCustomInput;
...
//# sourceMappingURL=igl-application-info_76.cjs.entry.js.map