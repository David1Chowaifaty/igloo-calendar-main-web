...
const IrDateRange = class {
    ...
    render() {
        ...
        return (index.h("wa-popup", { key: '8d20ef69fc85191d1e8d65573cb88df550f3f7a8', part: "popup", arrow: true, placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "igl-date-range__popup" }, index.h("div", { key: 'c2671c97537547dde41c94afea90d28ff672f6db', slot: "anchor", part: "anchor", class: "igl-date-range__trigger" }, index.h("div", { key: '8735b5c30727f3a98a0b150e0b21926f94c19a6f', part: "combobox", class: "igl-date-range__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date range", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("ir-input", { key: '58558908cfeb0fa0656cc4a4486849dab0d7f392', part: "input", disabled: this.disabled, class: "igl-date-range__input", readonly: true, value: this.formattedLabel, "aria-invalid": this.isInvalid, "aria-expanded": String(this.isActive), "aria-disabled": this.disabled ? 'true' : undefined }, index.h("wa-icon", { key: 'fce1ba47458d0c2670e07386c6e327b69e037833', part: "calendar-icon", slot: "start", variant: "regular", name: "calendar" }), showNights && this.totalNights > 0 && (index.h("span", { key: '0a7409cae2fce21b171660b385a9426ffc5f0693', part: "nights-badge", slot: "end", class: "igl-date-range__nights" }, this.totalNights, " ", this.totalNights > 1 ? locales_store.locales.entries.Lcz_Nights : locales_store.locales.entries.Lcz_Night))))), index.h("div", { key: '7d48acc7b240c23201b2f7d0074bfab1dacfa6f9', part: "body", id: this.popupId, class: "igl-date-range__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date range selection dialog" }, index.h("ir-custom-date-range", { key: '46a80db7aeec22507ad0360169a1add35729c375', part: "calendar", exportparts: "base: calendar-base, calendar, calendar-header, month-navigation, nav-prev, nav-next, month-label, weekday-row, weekday, days-grid, week-row, day-cell, day-button", style: { '--cal-button-size': '35px' }, fromDate: moment$2.hooks(this.fromDate), toDate: moment$2.hooks(this.toDate), minDate: this.minDate ? moment$2.hooks(this.minDate) : undefined, maxDate: this.maxDate ? moment$2.hooks(this.maxDate) : undefined, onDateChange: e => this.handleCustomDateChange(e) }))));
    }
    static get watchers() { return {
        "defaultData": [{
                "handleDataChange": 0
...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: 'a9af5bee84f7c579db2a02a55e377eabdd68962e' }, index.h("wa-radio-group", { key: '3ea37e2de2893217fd40e077ec2834468854e9a3', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "s", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: 'f8460541b2f18a8e21159128924c83673384d970', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: 'ef36ce5dbecb31bb84baa943a4a132dbc859340d', value: "guest", appearance: "button" }, "Guest"))));
    }
};
