...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: '9a452aaa4bdddecac14360120b1125cd75a736b0', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: 'fdbefd9faa402a98ec40051738459cb44ba46ec5', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
