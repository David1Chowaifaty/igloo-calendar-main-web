...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: '9796c1066226e9fe383a1ea3591e2abc355547cd', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: '6ffc2d80dc21d99eee6d54606b757bf9b4cf364c', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
