...
const IrBalanceCell = class {
    ...
    payBookingBalance;
    render() {
        return (index.h(index.Host, { key: 'd1735b031a301fef9a2ca10b52782ccde61ec6fb' }, this.label && index.h("p", { key: '2e468bb817fa010c9898b29f5f712dd931924350', class: "cell-label" }, this.label, ":"), this.removeBalance && this.isDirect && this.financial.due_amount !== 0 ? null : (index.h("p", { class: "ir-price", style: { fontWeight: '400' } }, utils.formatAmount(this.currencySymbol, this.removeBalance ? 0 : this.financial.gross_total))), index.h("div", { key: 'a9cfbfc1b87c4abf7a3f278930ce031fd04ae4f5', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bab81a9c0a3ec30b7790dd1c7d22817ae852e3c8' }, this.label && index.h("p", { key: '1a24c24071862ebe6628fc6e85c7a3e76e490790', class: "cell-label" }, this.label, ":"), index.h("div", { key: '6d243c700eba3d2636f0d7c9490a35a37a328c7c', class: "booked-by-source__container" }, this.clickableGuest ? (index.h("ir-custom-button", { size: "medium", onClickHandler: this.handleGuestClick.bind(this), variant: "brand", appearance: "plain", link: true }, guest)) : (index.h("p", null, guest)), this.showRepeatGuestBadge && (index.h(index.Fragment, { key: '7b9c88ba4dc7e5dd4a9056b36cd06f275a1befec' }, index.h("wa-tooltip", { key: '80fc740e2b18082aaec55fef3628c94e4d2f7f10', for: repeatGuestBadgeId }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), index.h("wa-icon", { key: 'e816a6f7c03ecf87e5f34093be5bab934ba458e5', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (index.h("p", { key: '54871e48d0eb16eb5b90b25c616e6a76e1d96a0c' }, this.totalPersons, locales_store.locales.entries.Lcz_P)), this.showPrivateNoteDot && index.h("span", { key: '61f52cf72ab300c9a6fecac4ffd2dc2a66287c80', class: "booked-by-source__private-note" })), index.h("div", { key: '1a1d9dcd109c43987713dcbe338ce5261d44979c', class: "booked-by-source__container" }, this.showLoyaltyIcon && (index.h(index.Fragment, { key: '70313ee7c19ac6d26ef1d9ec5de96e4202b62efc' }, index.h("wa-tooltip", { key: '2dd3320b2b1c751cde2ed8ac9d8b25e38a6dfff6', for: loyaltyBadgeId }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied), index.h("wa-icon", { key: 'f61038888f95fae442d5cb62f8b000ee54e325d7', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (index.h(index.Fragment, { key: '65f5558186bf8e9d3445e51c3a3bfcf313f88672' }, index.h("wa-tooltip", { key: 'a9b9ebdb7212f212ed16b01ac7a4c0a8c3325781', for: couponBadgeId }, locales_store.locales.entries.Lcz_Coupon, ": ", this.promoKey), index.h("wa-icon", { key: '0ac6477cd0a509e210bb30b5a747f449f3fe2950', id: couponBadgeId, name: "ticket" }))))));
    }
};
...
const IrBookingDetailsDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'e7137f096aec0219e316501a18dbca27c86bff20', onDrawerHide: this.handleClose, withoutHeader: true, open: this.open, style: {
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'e19b2526c98e733031e6654dea483842126a51aa', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '9bc54c7f915e2fb454d2a909f27ff256731e7650', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '7511ad158873db4dc24be8ee6513e8da2907ee8e', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '806ee7c088b5ce0e325b871b1d03811687265ab9', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'f87d9583abda1fc259c9c838dbaa4870e271a062', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a16a096c24f427a7bd68b8015030480a00f8c2d6', class: "fluid-container px-1" }, index.h("div", { key: '352fcb06af789ef0a5b3fe149eb8add2a63a9500', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: '7da768146f8277f34796f6d09443bcf84546e5ee', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("div", { key: '1a5e71cf178a8f6438649fd15a152202e707bb36', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("p", { key: '96b4bb2cc90643274ef3afc51836e557a57cecd7', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("wa-dropdown", { key: 'b64f0624c078277d8a1db64b13f9a93d5924fac7', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                this.bookingStatus = e.detail.item.value;
                this.modalEl.openModal();
            } }, index.h("ir-custom-button", { key: '980dd4a3c164319dc1b4a251c7ba35a9c56d8f54', slot: "trigger",
            // onClickHandler={() => {
            ...
            appearance: 'outlined', size: "small", variant: "brand" }, index.h("ir-booking-status-tag", { key: '686146a96aefa15c9b829e94199b8108b5bef6fc', slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", { key: 'c6dc650fea10c3ed414e8671e8a0cb5afbe2d8a8' }, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))), index.h("p", { key: '9b7ab757d002c0860008a0653df4de546bf61bea', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '78232502e294d46e6db97dd12a0a7f4fcf95413a', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '4df2cf117fc78034a74100708ed3f0127e96a5bb', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: 'f4fab99294d426fce388e6c40cb0871c6cdd5cb8', class: "d-flex flex-column align-items-center" }, lastManipulation && (index.h("ir-popover", { key: '0d9299fd7b1f96a4eb144dd61fb3feb855fa0338', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: '929450e572325900f93905117c572b1cb407d274', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '83a27645fd442caa0523a2e92e279ed7b0b1ac97' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'b9c93827c797bf6b080565c7cad9f01b4e931f44', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } })), index.h("ir-custom-button", { key: 'f190fad7190377a72d1cd082fba1264828af10cf', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), showPms && (index.h("ir-custom-button", { key: '8d61f3665183a94b9eb77f241604c1844769252c', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: '445c82c2ba3417f29eea3a7f60529fe2653c5a3b' }, index.h("ir-custom-button", { key: 'c731f0c829728d9cbe09baaceee5ec1d3c525859', id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: 'e8341e0f78009fe5289e6a021b7780bccbe39dca' }, index.h("wa-tooltip", { key: 'fca424247713a1c799de49f4a37582537d9df940', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: 'ea34ee42ca96c0e1de33063d99988c123bded0da', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '30e34e68d0b498f8fd42180ddefe20b3bd4935f5', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '0589ca67533a60d0e66ff398a1cf3f4ba10aed36' }, index.h("wa-tooltip", { key: 'a860692a27c37ae95092ffec7834ad30047b1cf2', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: 'af37cfcc4b9d4691f69bbf54fd4f8af5b6268838', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '90ba406aa2285e9a085a69580bc6338192d7cb1c', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '87b1ae85052d85f352e986cdfdc8ff6cb33e4723' }, index.h("wa-tooltip", { key: '6f69ddaec3090e9f6b1d381aad4e075927bfa262', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: 'b33211c2de23a4fb47eb733d40ed85e55e6f80e6', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '87832ba39b6ac7be2e7a89c19550b8632f1fa983', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: '831578976b6b344b96cce0aeb457ac1090038627' }, index.h("wa-tooltip", { key: '91e385ba88937ee999e879434e324da244e78da5', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '9cb478fa0a9fdb2f22747aa3b2e6cf76cdf253da', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '33700ac9dd5b2e652831804f0e4a60827af86ae0', name: "list", style: { fontSize: '1.2rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '71d04b4b2043506b836484c29440ee60bdf52bf5', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'd4918a34ba03c65a755d3ae786aa7ceae9a5137c', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '9287ec1dee0b87e9a4014077c89f29c61e9633b0', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '92589fe04dd691a47a37a15abadb135fb89dfeb2', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '8abe0183857e27730f24afb4b017acf757912cd1' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'bc82c341be3359b350de6c1fb87dd9ba14827548', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '173fe7947159699c2d77eb3d47fa76b9564d01a9', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '9bb5c86dd301c502407729f1db5fc30c336f8ed1', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (index.h(index.Host, { key: '2e06475a7b70329a57ae3399f626fe19c5d9053b' }, this.channelBookingNumber && index.h("wa-tooltip", { key: '51927d07df080f81a5cef08eaaf308024844021a', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), index.h("img", { key: '8c9546f88106cc16cffa1f22232c7ce99000fcbb', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), index.h("div", { key: '65b9d60896297ec3d6fab278ae74702177545f73', class: "booking-nbr-cell__container" }, index.h("div", { key: '788f924c12e75ffdf73cbc25638a7cd807acc6f4', style: { width: 'fit-content' } }, index.h("ir-custom-button", { key: '2e3ccc7311cf06a12c868375c40b970f2153ae5c', size: "medium", onClickHandler: () => this.openBookingDetails.emit(this.bookingNumber), link: true, variant: "brand", appearance: "plain" }, this.bookingNumber)), index.h("p", { key: 'a5532426aefdcfd51607832f6f89dd01e6b2fe02', class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
};
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: 'b8c9961795200060c6f8966e720769e4187c2ae7', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '35cf9a0eb893a70145cad9e93812632cdd35c682', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: '0a21740e2b4a296f37021ab2a9b08003facb887f', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-input", { key: 'd409c62fabc33a66bbfd588e164254e6d02421ae', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: 'b82cdbc5999d84b3d3c15a4c7fdf73807b42a27a', name: "start", slot: "start" }), index.h("slot", { key: '6f3dfed7444e7fdb64465b27873076d7419857c7', name: "end", slot: "end" })), index.h("div", { key: '6e79dfea0d1c85da0983c4075775116106af5c4b', class: "picker-surface" }, index.h("div", { key: '2a67952c8380d97bad11fbdea2f924e2709294c3', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: 'ea897ebb4fb8cd2fe4a5dd313cdf82f805d38708', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '48d1eb670bbbf0b850284608ac4a54257ac83ef0', class: "d-flex align-items-center" }, index.h("span", { key: 'ba51582cd2d19d487e38b7e6514dcc62eab5c639' }, this.dates.from_date), ' ', index.h("svg", { key: '192412034b5bc8cefb4a6ced9f0a97b69c10afa5', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '37400f227842c5e204e8d5211d3bccddc6626d1b', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'e96a25249a2b0f1c12929ac0efb632638348dfca' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '6d3d1b03348db7a5d2d5a92672ff5478c0ced1b4', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDatesCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a278b5c9bcb804cf9a50062e3f194ddfbd86922f' }, index.h("div", { key: '0acd306c8be4075ec25b6e41a9aade4ff94c110a', class: "date-cell__container" }, this.checkInLabel && index.h("span", { key: 'b3354455ca64d447e4c14692afe1fd18b47f9dc5', class: "date-cell__label" }, this.checkInLabel, ": "), index.h("p", { key: 'e2ce4e02e004d5fa7e6e97081e7d08127b798607', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), index.h("div", { key: '08ba250ad4e674f42030be978fb95958144247ac', class: "date-cell__container" }, this.checkoutLabel && index.h("span", { key: '2abc49bbc2bbfb4e60ca8cf4c09c65fe0c3bf77e', class: "date-cell__label" }, this.checkoutLabel, ": "), index.h("p", { key: '2af1884f36bb7f652376f9e1f4105bf27e00c2cb', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '5b4f3570e2fcf348c4142837cdb3b3b81484d200', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: 'd2f7a6f0209bafcc86763a93dcb250a1b49a6c64', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '8afd5a7db5017744dd69b8a999673ebefdc36788', name: "label", slot: "label" }), index.h("slot", { key: '9604e8f110148f09cff529139dd7657656f97022' }), this.slotState.get('footer') && index.h("slot", { key: '41c11ead861df4c80f0831016551a416b78c6dff', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrEmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: '362bd639be3ebe59f3a1c37f35bd1dc45691a623' }, index.h("slot", { key: 'de6890473f003d96b8a070f100e25870f446af33', name: "icon" }, index.h("wa-icon", { key: '15bc1a8dc48701c48545ea0d0c400808ce343746', name: "ban", style: { transform: 'rotate(90deg)', fontSize: '2rem' } })), index.h("p", { key: 'ecf53c786196ec2a6002a2582591f3002a6c9614', part: "message", class: "message" }, "No records found"), index.h("slot", { key: '8760375214d5bf237d91c1cc8bf25ae439c48f15' })));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '71b28b64a6c7ca24f58ea380a5ceced4f1bf6e51' }, index.h("div", { key: '7a3b560640616682b00c9142dfe3a5ad32ac553f' }, index.h("div", { key: 'f95e248eefdc2526e9dd2db02bbe04dd5a2e370b', class: 'extra-service-container' }, index.h("p", { key: 'd53bd9f5974fd115128a63285e7eb6d827ac053d', class: "extra-service-description" }, this.service.description), index.h("div", { key: 'f1b4611bcb880b3136130370d0646d701031ef35', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: 'fe2d59f337b8b8583730f1fa4d548241bd98d2a2', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: 'e7d066bdd8b9333370e0506c24ed0b1061829d20', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: 'b84c54d005ed28eab1e1a38fbcec11671c8bc586', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: '5531915b409615ba98d01fa27722413ce7b59139', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '1ca3766da1579ed63ac66602869b4b741ba2bca9', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: '8cdc92eadabcdded9ea11e57c62894a808226a43', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: '4c6e1b17e9480d344ebdb3e6ab37bf49faeecbd2', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: '00d4ec6fd36bbc20da71aaff28a85461c404b57d', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: 'c3636da93d53bfd0d43a269314152cb82360ec74', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: 'a577d8d9b289a38ee8c9dffb41925a59e263491b', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: '85709533d017ac8ac219fb9d5b23799efb37564d', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'cfa3edc1af4904b19257093f8a2b4d26e38556da', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'a112c35082282ed39abb1e5188ea5a83591cdb4a', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '1aad335fc2ace63ae074780c796a9728cd0fbd59', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '018280eef51894d2641a3ab21a00e9c2f8d0b200', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: '2494b82c58de61daf1a25f760de755b2d171d1d5', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '06c7d59cb0a5e33aa504d589a66ab848f10fa1cd', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '19a52ff63f6fca60b33b4c34b977da2e5550d15a', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '5208ec0f03d3b209bbb565f5a9b2e62ad071b4b1', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: 'b9ff098850f2187629859444a7f3563f93e0ec2e', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '57be3544de8400a4fcf32670f11b227c6c925ac0', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: '6c4778c4caa4a01552a1e49feafecb564fe9fa28', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: '9f5ebf932d29d99011d4173468332ac4bf617fca', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: '4617a0919cbf7575a399cfc9b5d7f415f4025ee6', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: '557259fe78f080d572ab7c7b1720901a548d8e2d', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-input", { key: 'fdfc3d1523d785422fb319c1d1eb625876e63734', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: '91b617306217929d3e93ddfbab90935e577fe9f9', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '95a87b2c11c5c6bd2c36d6572888a5bbd2811d01', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '4b5cf3292604304973d3be2a1505c90340165744', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: '3196184807135c8550f589b485006077817f74f7', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: '88473808e29646f98b3452f7de0a30d8cb3a2653' }, index.h("wa-card", { key: '1c97d2b2a3e7150ef818be36a522733452500fe4' }, index.h("p", { key: 'fe8e38f563d57d7ff259e3499279429f01ee7676', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: '2fd2ed40c404d630414498b135801865aa16e8e7', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: 'd8cc4434c02f2f33ed421f30cc0d41a64913b956', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: '12b20a9e01c7d9858cee869c077a34c439e2323d', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && index.h("ir-empty-state", { key: 'a85195288bccba622c4709664f01cddec4172b9b' }), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '836e11d47303989d2c3a4094a632486e62abf2b4', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (index.h("div", { class: 'loading-container' }, index.h("wa-spinner", { style: { fontSize: '2rem' } }))) : (index.h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), index.h("div", { key: '9a778bd6b5637ae98d2c778221f52a5ef9d3bd5a', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '79f1a95d6a055d061e3ae8a4597f3ec00f171290', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '1e89035bf5c796dbf5713113678859fca0ee18d1', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrGuestNameCell = class {
    ...
    name;
    render() {
        return (index.h(index.Host, { key: '87451c9c8816b2f704e0c2c88b5657a24e264c7a' }, this.name.first_name, " ", this.name.last_name));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a274a9e8b569795f4e6f994c26c30195ac721238' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'c25a15cd49eac6df1c953236ad12d9b7e287c7a9', class: "loadingScreenContainer" }, index.h("div", { key: '80fd8788ccd331e2d581577a2b7951d32bd264c4', class: "loaderContainer" }, index.h("ir-spinner", { key: 'dfea955bb05c1f75f201f751ef02b82618aaebb6' })))), this.showModal && (index.h("ir-otp-modal", { key: '2b3ca7b2d54e59484f7d08ee69276cb08a07db69', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '534b505ab7138f3919fd277c9638c1aeeb341a92' }, index.h("ir-drawer", { key: 'ae2e202c86fc5e99b709d0ddbde1b07a372a4312', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '60542a230c78b95f5ada3adad367195c04d694ba', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'b91ec80b1d5a52064426fb2eb12c0fc0dfaf5c8a', onchange: e => {
                if (e.target.checked) {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: 'e746afce080138224a2836ac2efb4ab161e373f2', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'f1301ef6994f34b19b2f62b13592b7454e959643', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '18686479ba5b83533696354e2e7dd85be99f7564', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: 'a189a6191420a64f9c12d0b78778d0583f396618', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '2c6c42a1e1f3844cca8f1c40661af37d3ef1fc07', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: '64112502443827cb797a5b1632f8bf3c45d6a2bf', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
};
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '090ea55008beb630b0b2d8508b14d40994d891ba', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '4fc1b301900a07dc6622f2ca7d9637ddd3b28d74', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: '4b799fa3200e6458e59c4d8dfbeb5ec0c41da3cc', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '6d965e437ae16dcfc0ab54125bc9ae010ae4e14f', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '070763b1a85e60835464b0619f033df7eb95e9a1', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: 'dedfc4bb340ca770437bdfdac7d49b6cdb25dcc8', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: 'b856a00c839284dd39d7b9086a50bcf114f31f19', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '0c0d269d96e36d99270cac5aa724acc6dc1f89f8', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'ab7ae4b376e693340f335a17b6d6d40d96776135', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '09651e7302a3f2644e605f748623c6cf8765e390', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: '7d94dc566fbec1876c28a5338da4a0e805d69fc5', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'c9de6b10f3e9be62230078c32d1415a900f40e58', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'df70b9beb710bfa95e727053afa703fad5ce7b7f', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '25b8f407b8a7c357b2e84478e27d325098d03034', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'c2e9f76a735b60d9c60d16277108d36bf953ecb7', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '13c95b32e52eb82cb60e3ec2a4284da8a536178b', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '020256b068beaf87794d82bcad5ab1f2d0a27ce8', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'a57840d2ad2911aac3d964f42bff2e086492975c', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '44765e7ad6c997559051daec014662762e8f6928', class: "payment-item__payment-item" }, index.h("div", { key: '75b1fffc793c9a328da6accce1a19db5a5c4cc1f', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '8ab3802d7e593de4aa1957861b35672492983ac2', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '83f63e3e29c44e5d333899faeef7d38ef8b3f0a2', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: 'bbab44654954cec4d6465d6479ac3a85cc72f1db', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '3e4ea6b8f0e29347e341cc9f1b247cd0f5e07e17', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '37583653fd7cbc93fd843a822a3bb4f4ac211df1', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '930841c65d3b0d02cf92ab7abb21c54599ac2b19', class: "payment-item__payment-toolbar" }, index.h("p", { key: 'b02ee04a2c3956fce0ec4a8327d1e2ed6e4069b6', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '8f0ad5a002fc8302295867a9223680543700a228', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: 'e88e5803e3bd2e8f091b783be0892caed9d2b872', class: "payment-item__payment-actions" }, index.h("div", { key: 'e0a98dffb2d2d5b63b140ca89da3f254dd1aa545', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '2f98ad638d280b70cb2dbb0ded8e91532d5626ac', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: 'e9e4bb6fda1c16ff0dfb2439a67e692a39a50388', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'accfe9e0829869e09f2b6e6d57cbb5614e86e00d', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: '92e5b41d8b8467578a69e421c175767818f178f8', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: '47742cacf653c75d238b9a750b0e1ea0370e0b0f', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: '907c759e57243870d74cccd16ef32109c6a8d6e6', value: "receipt" }, index.h("wa-icon", { key: 'f5eb2965ef2371120f72e6489a7b897665a17070', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: '7e425c70514d398b6c066fe5cca67bf6662e0259', value: "edit" }, index.h("wa-icon", { key: '760fb480927b16c00ca50e69725a26b64b46ae8a', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: '6f9519499280ef7131b27be9b101008e2a67cdfa', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '0f767cf7dcde87c224d893e6166d25c9e0816fba', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: '3650322c05e16431650830d1fa49dc36209cdbc0', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '7a1d316bd04226854cdf6b0ef4d59a6b13c1cd66', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '17950a5d74ad753f5166b19e92d6823d868f3205', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: 'ba8853b53cd34614af3da4d54f22f05f1a4a29a2' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '337467c2d912e48e6a09efc7d5a535a17c914762', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '792dcf213ec5a678dcc8643df53a5b94a64b6613' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '97cf081a640788ee86a0669074965e1c77aa342a', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '89ae5fa787abb89fae92cae28e36a73a890272f2', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '80cc65281c032e23534f32f7d4aae84947725451' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: 'ff9f06e55cba8435625a77e4019bd104f56b3475' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '770d2ac29f31e7d43eb1c81b5204bbc30655aa39', class: " payments-container" }, index.h("div", { key: '2bb0687dd311c0b807e8f8f635be04283fc6e01d', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'c2fbfa99f3ab58aeb3e7ae8d958681675aaae54f', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '494af3eeb22d0edb23517d9149fdb59701b99675', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: '4dffbe95ab05d14d9b3e8d0e091642e6cc274ea0', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: 'e6eb348c3010dabd5bf9efb9c5c18a872506b719', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: 'f497cd82af375053ea91ae712ec297a7e82b96c7', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b1617b8f4ec458b5b41fa17893f48d4fc1fdd937' }, index.h("wa-popup", { key: 'fd6ca131577c491d90f397da91acd1cc6bf10ef2', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '29a5f365fd31f380451463ce5a546e8ae4d7f35a', slot: "anchor", class: "search-bar", withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: '655f33676b074fcc7a079973c24b924ac52e9a38', slot: "end" }), index.h("wa-icon", { key: '61212a3b35f3b73ea87c63d41c1428cad04ebea9', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), index.h("div", { key: '7f753a2b8fa534646d0c5da14fa946ef9cbc7a94', class: "menu", role: "presentation" }, index.h("p", { key: '575063d29b80bb88a8b9dc161150e815fb635b15', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: '6f62dfeda794e093e2a8a927ef5ca162e142c56d', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: 'c81b09df329de11ab83bf2e098cb75304f76caa6', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: '6279df6a900e43029dcff37c227af7a372ce5f3e' }), index.h("p", { key: 'f74ab782d4e61e35f98223f841998331931038b0' }, "Loading suggestions\u2026"))), index.h("slot", { key: '560cad104f954f9e7c54c18e297da8e18ea0cd08', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: 'b6e949b5196f1512e2fc73965b6454e31bf7aa65', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: '0ed374e4ba98aaebebb1dfb17a205087ca7da04b', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '230d1ab83a5de4040e879d3e93607fb8f636f49c' }, "No results found")))))), index.h("span", { key: '11975db85c35a9dc9be4b260d45aab62b32c7a35', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '2e6ab804cc9fd60608e10cd748e219c73f66d990', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '92c41c1e5fd2dca2dd41ac87f810a018e0f3502f', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '4a548cc1f4dcbbeb961adbb36094c0b17a1dcf49', class: "picker-item__check", name: "check" }), index.h("div", { key: '991c93dd129a0ecd267ff4de073f51575d670541', class: "picker-item__content", part: "content" }, index.h("slot", { key: '29b744be33d4451ab9fb8ee7895f518510fca520' })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '11a02842accd4cad2ee052b92c4f678f55484e30', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: 'd01bd19ddec9655edf5c2ed448e8c88c6f190625', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '9286eb96ef900351e1c521b1760912ad3ebff66d', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '90f4bb3d9c815af54597ce7dd123796839fcd7ba', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: 'dca23ad2d4e088df03af0eed6c07772ed88b3d5e', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '47ed6be283dbf032fb557b03e56830667f726821', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: 'ed8afed285b66fc749cada5d3496fa6fab56f6a1', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '3ee754adea825f40ce81d71c5e6f9dc854adba57', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: 'b49811c9af66ac5694d2be3ac816e156a26fa4b7', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: 'ea0809e4cf5b590ff23d0b190469a9f2d2f5313b', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: 'f5630a8abccd3ad8fe233b7343bc723976de550f', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: 'e715a78bf1e21d05bfe2b9767c350b92192c10fd', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: 'bcfcf58e71a1f2a228c1353b746d73e1e9dfcc3d', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: 'e3e258aa08513ac534de9cc803d4e67bc2075091', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '3c01d28fa5a2a39fc7ac08d9c4d605b8e9d7c820', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '8c1e565a8666a023a0f3a04d589e7319b4b6b3b3', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'd6cc9769250552f85f9342f0db7174e07d99cad9', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '800e9d58fd1c45237ce3d1fcf99439ad01d7be5a', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'fb4192b2ab2b1b737bf7147ae8908f88f94536c4', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'dedbc35cc4a7fd2da246d2e4095cd040175926da', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: 'ab17bf2afc065b212c5922d2c335645e12e8a24b', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: '509a9bc2721df61060c986d060691c38f1b815d3', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '36477b7bdd891b4e01770d129518376ff5c87543', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '8e4c1fb229458185cae4ff638279ac6b52ab333c', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, !this.hideDefaultAction && (index.h(index.Fragment, { key: 'eee843a3397ddb51f195cf60d2197091e51e03f2' }, index.h("wa-tooltip", { key: '827c4cdf233c3fcc633748b1f5b65abd30204a74', for: this._id }, "Print PDF"), index.h("ir-custom-button", { key: 'c09088d2b5fe4c019b323c6ea486d38139ef0b87', id: this._id, size: "medium", slot: "header-actions", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'b6712a1bd69f4b572f31cbeb698906aac171a778', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() })))), index.h("slot", { key: 'b0ac0a9916bf2d8d759078229cb41048f86f402a' })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: '8cde4dca308de80195758cafde29eeb8d8e64b1d', class: "ir-print-room" }, index.h("header", { key: '1081dd4b49c31a298118490c89ad5f91855e4ee7', class: "ir-print-room__header" }, index.h("p", { key: '4f3833bc1da70b4f96e80ba2b342606c97e7c90a', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: '665287847777dae82db43e60bc84c7b7b151a9c7', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), index.h("p", { key: '62ec0f57b679d158e46436b80dd18d1437743377', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: '58fe2c451605eab1c1914623793d3b8b5b6de40e', class: "ir-print-room__body" }, index.h("div", { key: 'e87566547413b77705d93bca59b801ec66f999e0', class: "ir-print-room__details" }, index.h("div", { key: '593e6093e88fd275699c2fbaa8bfcaea5f8d0563', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: '742fce03728cd5758ada713b2c1f19a53e533fe4', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: 'e3d0a31553b48397fa93c2cfef119a084352df12', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '825118595d148fdaf9a036ae355ba72088e97709', class: "ir-print-room__row" }, index.h("div", { key: 'd3d12d46b16aa472c3e7c6936f8849611a441af7', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: '624352091ff1247719e89a570e016b08df7db20a', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: '513f4687a59951f896ee38b7d276025adc6dfd55', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: 'f2f44b535375245e1323315c85688d0222e541d0', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: 'de0cfa59b2015e06d4642d2b889bcc7002980108', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: 'c903a59d458a8174ac1f6ea4578d3c90b5cff3d6', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: '772cbb10ee7df23d356fbcaaf19d7ed95eb86aa3', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: 'ee93e4883e39105c64e4fb2c4e111a91f9f7265a', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: 'fca3534b2572bfa2decf17934d31c8897c276ac4', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: 'af22ab2464e56ba3482af68c88a90a5acc136406', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: 'fee3e4ff6426876fdddab2a70a71bdbd9424edf9', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: 'cd58edc1387a15a3d7961b5e795233d4825b888e', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: '5b694d8793e6841e624d3e50ffefafdcc025bc70', class: "ir-print-extra-services" }, index.h("h3", { key: 'de45dc624cd017daade9f2892775a9233cf67abd', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: 'a58b646721eae9db2297c4f18dc47017dfd1e8e2', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '13f05604b7afdcd89382c2528c6b98519c26a2ad' }, index.h("div", { key: 'cc69f735bdd0949a1b4e79190ae12e940f5e44b9', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '6b90213a54f06982ede65ef29a23076665a75a28', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: 'cdadaaae82871651e5d945dfdab03bad3de06673', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'c0332560a4d8a68510e49aabfa827f8614f2c820', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '263d999207179a84822487eaee94be2d6a4be7e3', class: "reservation-information__row" }, index.h("ir-label", { key: '32a5b2f9fdd7e28cd1f7594ce6a22f75dfb88ca7', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: '2a2f7a5fe4a82bb7b064e9d10665370c909ef036', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: 'c2fca752b5b862f195839f03c00d9a8fa60c2bdb', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: '31d1a2314e6b100aa16def4195b33ee2bbd42033', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '4dac36e3ec7387b4b680b7fa82fd6b578a2bf06d' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '403c9d22a354edd50433655438d5b61ab014d2f4', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: 'd1125dc04cddefc53177d9eb9dd27f6d09f05434', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '75dd085e39e3128b507024d9c2c6dfc3623e9c0f', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'efbb28ea7da72577c7a49149481ee5533b9fee1c', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: 'b6a2a688968fa3d218b85d3cc9b0731851aa2a70', class: "reservation-information__row" }, index.h("ir-label", { key: 'd2329611af5d899942aba548169d4f04a5f5a21b', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: 'cd3f9cab02ffccfe936e3fa077e439fa8d991c5b', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: 'b145e7c844621c8965f9f79f348bb4185c7e96a4', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '8d0fea767187a8299f6291baf08964da3ccfb8c2', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: '29c0312b371dd011ea9fad521e74817da165346d', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '9f81c82895b2a9d47bc5f4af47a17802f05316be', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'e45f8f2428cd66bf6466582dc67e6f60374a0b8a', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '92467f16bc43f74a609446e05994fdff60d24800', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'f4c04eb354fd7e825d537c6e489e44abbee5751e', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: '3f2da8fdba21095a929441b6a48fce6f4a88f76c', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && index.h("ir-label", { key: '238f93cda46223202b1cb83dc5515d5d10f4720a', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'd84eb40296d4a615e7ec8a816c8de22137030bfa', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '3d33e470a7e9adca8aa1279c624908d57afcba3e', class: "d-flex align-items-center" }, index.h("svg", { key: 'c4e10ca458c851a8b0c68e04893c21a468269ed3', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '7fec85fa275815041bed10d9a88d8e17ee4b87f4', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '32da528d95bef34c64983a173ca8e50df9e993f0', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: 'afec7954b87c3184d5df8560a2469a148da978c7', class: "reservation-information__row" }, index.h("ir-label", { key: 'ed23f53e915785ac2cc438001cd8846f1bd6bec9', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: '7049a422d50ade9a4410dae634fe07414000615c', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '8129779cc98ae7516d9809394e597d1c531a341c', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '04a5533121304de3100b2422eecce6fb7c9a78be', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '82f847a7f962590fa38b3f743994053ee838b9ce', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: 'd1ab1029edd054d1e400d48fa0c7654ba2840492', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0262eb2875f30d950df49e6909893f3ea0e6e8c8' }, index.h("div", { key: '0dd4700fd8ec9d2aa128cf17f9b78865b8ec769a', class: "booking-room__header-row" }, index.h("button", { key: 'ce2fbfec0773cbc522a6944e7f2a4a9cff4e3005', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '6fa6d84029179d37a7c9fd755e6d7bd27c666e9a', name: "chevron-right" })), index.h("div", { key: '2b968e9ba7ddf63f0837b927825e31cea378e862', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '19e96b2bb629d3eec1b47caad9139164be46fbdb',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '0e46b1218f756e7fdfe207b2384f9010260e1945', class: "booking-room__summary-row" }, index.h("p", { key: '55467580fd9320408288585c51a78139cf0ad4e8', class: "booking-room__summary-text" }, index.h("span", { key: '9d48b5b162746ec99751d78547a4ddd089fe6e84', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'e33b217e1f34104f9f2fe5467202092712400040', class: "booking-room__price-row" }, index.h("span", { key: '5600f285724cc3826d77e916aecbb2c9a3232205', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: '1a3a4367fa975b2e1efc505cc640bb276770406c', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: 'd1495a33ab175d714faae76e942d1d1767dd6a42' }, index.h("wa-tooltip", { key: '2ef82cfec42676b4054bbd27a11667e87fa98c39', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: '9be9f97da4cc877ece65b29cd9079960aeb0084c', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '7a324a65165748165a9ec1be612909064ac0dc94', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: 'd516490d5742c89f744f55b6f3c5d6e9ac75d653' }, index.h("wa-tooltip", { key: '572c4ea92469018419c2f95ea2008fb02e482811', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: '451fdaf75b691677cdb7d9be4adc5667b23671a0', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '9412da1b84b1a682f8fd20cc327f8398730e7817', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: '06b254bc1c39648c2c4b4503027f18e5ae015f78', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: '1bc721514e0bd7ad9e045eab7e5a16926fd2da12', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: '1fd442fd1d2f5044a6af9f72d879425d75d0f731', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: 'a4f36abcac3d246c7a16836644a535636260f679', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '159cba84ee983ac0e45982c35e161a2201a2a6a2', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: '2aeff75dc35b3af993781433f04094ff34afc01f', class: "booking-room__guest-row" }, index.h("p", { key: '459e63c9f58359a4cdff7f01cc873f61ea79443d', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (
            ...
            }), index.h("tr", { key: 'e51868aa7e011e1c14ddcd08c61b01c17568d0cf', class: '' }, index.h("th", { key: '56f53a45c35f2ba411f195f6aba707c5b99cfbec', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '4b70d64186bfeb4e29e74dd367eccb38bc156b0f', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '56b899efead5fa8bb9095657acb8a752b4bc65b8', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '4b7bb1f921d5004c4845bea4256612e0491ed2bf', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'a5b1c14fb71e2488c35d7c1a7a8bc15e5a48378b' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'ca7f2398e899921a5c74cb7d06bffc267c5b1ecb', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'a331772129a5e907d98f02c1241bae9a994a1d26', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '43121c8df4c2c71b874c5b9f930aa6f2f0c65577' }, index.h("ir-label", { key: 'ec998dcb3a6e63fe2666be25f2c0a0e38e24b0b9', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'dc0ca9a525b94e9e2dd998e40618b7b924523a73', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: 'aac277382a05a477d4c1a8b757ef73d5e49711f8', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '49d49befedc02cfe3d21807b6802c062cbfe3f14' }, this.renderModalMessage()), index.h("div", { key: '26d39b64a7cd15c1773961e628387802f3e22e53', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '510e738eb5d438b277c0de3bef89a7e21464738b', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '291d0958d8eeef4ab138f000b63169953b69d708', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: 'b93ab599b6a3cfa632166a30a3c074079abdc5a0', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '8de80fdb652648df7338391d1fcd83e900c7da69', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (index.h("ir-drawer", { key: '7e75c39d6279f6968fadcf145f05325dde8713d2', style: {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b3d8bfee5eadcbccb13bf62e37fc096bf14e3e4d', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '55a9bdfef70e19c8dc872fa037f624850024f1a6', class: "input-group row m-0" }, label, index.h("select", { key: '9dcbab95f24129942e678667e49cb29bf5610f13', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'bff70c3836228ed3daf22574169d5dce19b73b2b', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9bbf24d28f9891e2b152910e00285dd398d5ed1d' }, index.h("wa-spinner", { key: '4a6355ace8013d37d4ed630459190caecc2a75aa', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrUnitCell = class {
    ...
    room;
    render() {
        return (index.h(index.Host, { key: '0f3c5ba8ddab2ce523d1b04beea368ca2ab459e3' }, index.h("p", { key: 'cbd417e36990cc0d86251c3cb78246e05dcfc797' }, this.room.roomtype.name), this.room.unit && index.h("ir-unit-tag", { key: 'aa1ba5a5b7f056f312ca3b33942e921357df8fa2', unit: this.room.unit.name })));
    }
};
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '379f3bf719a6e3c3875dd4dba0adf730f6314a51' }, this.showTooltip && index.h("wa-tooltip", { key: '2a98c144cd00c5ff6baa2d8aaeb35db2d9557ca0', for: this._id }, this.unit), index.h("wa-tag", { key: '948a7530ab8ccf5bf9da2d7bbfc3ba3e789232c8', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '596ad4987e8f2cea2f04e305cdf9be255af8d75a', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b02bb76fdd3813875dcfa56838898640f4207bf4' }, index.h("slot", { key: '858408d91ff1922ed1c172bd39469eac310b4f6d' })));
    }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_90.cjs.entry.js.map