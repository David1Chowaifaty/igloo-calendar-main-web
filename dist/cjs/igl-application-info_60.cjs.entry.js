...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: '90b3733ea4c64938c267fdde4fd688e496e126f4', "data-testid": "book_property_sheet" }, index.h("div", { key: 'b51b2d02a8acb149d48fd69fab1cb80ef26a020d', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: '955579e54b25cf0756f0c8f9dc44439566fa8194', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: 'ace5ca9b4148ff69c83ff1f6c259d4b0f5321f36', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '649325c6b8ab466e7e8e0b96befcc3c111154ce5', class: "card-header-container mb-2" }, index.h("h3", { key: 'd390e1532ca6f24bff528d7a2c87da6ed4ce28be', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: 'aecbdcf37cacfa06e6f859d7ccdb41bd17b5a663', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '8071cd1782a92b748b499a41315b869faeecfcc1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '2cb0ebc0a7804b85f1b20f09d07531c4be93b393', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: '97495b2e375bca5a6631ffef06ec3169bba75241', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: '43713298b79d26a80d34001b3862653cfd7a9fd9', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index.h("igl-booking-form", { key: '34bede8eebdd6d46700865fda0230992dcb736f8', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countries: this.countries, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1e75f18a605286bf6c9419b8001a252f4a094a7c', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '60dce2da7bd0ff64119167c022932a4fc5b91a3f', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'c29c1da2565a535b0a8a532bee11b15ad144afdd', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '0f3b02ec06a92c1cef0e9fbe4012dd285b3ca73f', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '400585db9a133c32fac2495bcccfded4fd29c81d', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '5402d5e3fa3fd27228fb96f7cf1573b68ca197ee', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: 'a7050c947dadbaad16f3e136c790b5766e084770', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '1831631ac9dd338b2242accf1cea234a72110415', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: '62cde7ebc04a5fac7d509cecbcf9dd325016c4c9', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '9a20d0935bd78c2d1dd042824ee31e76fd0933a1', class: "pt-1" }, index.h("p", { key: '0891e7d72801a76f875de8548254534a41364d82', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Period), index.h("ir-select", { key: '5fb8fa972ac9d57f30fcca8096e7e0d45a62dd9f', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: 'f9a234d3890e03bde5412897b967b35c6bfd112e' }, index.h("p", { key: '7ccdd9f74cb9a55c01d97c508ddd72a0aa573cec', class: "m-0 p-0" }, locales_store.locales.entries.Lcz_Housekeepers), index.h("ir-select", { key: '642f5deb6e91360b4339921d7c035db7523909d6', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } })), index.h("fieldset", { key: 'b2a9da327ffe1793cc0f64def33c04f1a75ce0ad', class: "mb-1" }, index.h("p", { key: '4c317ce68e973c28c85d0c8defdb87290f8dd33b', class: "m-0 p-0" }, locales_store.locales.entries['Lcz_HighlightCheck-insFrom']), index.h("ir-select", { key: '6153920c9e850fcc9870e401d27571c06bbfb71e', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '6c04aa95a0fa72b0b6b079d0934fb076533f11a8', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: 'd2d79a5045fa63378dea2c508ae31c697e79fe8b', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '07a1d76a2209fbe7c7dd307f16f94c20dcf3e484', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
    ...
    render() {
        ...
        return (index.h("div", { key: '2d6888e0864b1169a22bb5e26c8047bb301bd841', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: 'bbe5fde07d767840b69cef6140bfc0f0c1671364', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '94931488dde441130873e38f3abb90d762fd5d51', class: "table-header" }, index.h("tr", { key: '40903838ca91f57f6709003c7599bcd966d36fcf' }, index.h("th", { key: '58814820a5611188a368b4f93fb760c14a939614', class: 'task-row' }, index.h("ir-checkbox", { key: '9dbf45a92ddc15e9438524af3c5e12324a6d2526', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'd269a889095f5588c3e3a7392067ef329c3f3bb7', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: 'f30690b7f38f9c4a7a11aad95b57485cc0faca8e', class: "extra-padding" }, locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '1944003f08f40a21030773b41f8444fe9501791e', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'b588083e4139ae9c8f4c1ceb63b384a4b564b8e1', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '18a02509d9a34550cc117fb640d847f5dc8784b7' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '7852d207cde736357ba9fe7f3ad8053176fe834d', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'b8cd7593fab3bd23b96fe2aed0560ba3a31352af', d: "m21 16-4 4-4-4" }), index.h("path", { key: '723ac9d9ca9a0b30720bbad7e25b30eeec994733', d: "M17 20V4" }), index.h("path", { key: 'ba5c9b93a5855a178d0e37433af5a2ba5f64d756', d: "m3 8 4-4 4 4" }), index.h("path", { key: '1efdc5d3619f25e1ed9ab47ebe8b3ccca7967bf4', d: "M7 4v16" })))), index.h("th", { key: 'a316d7f2c1a57ec2f008d6a4efe8075291fbda52', class: "extra-padding" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '42607f80bd7712f1e5e80c92ee2d6246af00a67b', class: "text-center" }, locales_store.locales.entries.Lcz_A), index.h("th", { key: '0faa4fb70aaeaeebf2986d8ce377db6b8e8572c7', class: "text-center" }, locales_store.locales.entries.Lcz_C), index.h("th", { key: 'b24f678699842ba1a143447c67ff789fe5356186', class: "text-center" }, locales_store.locales.entries.Lcz_I), haveManyHousekeepers && (index.h("th", { key: '742f3ec898150ed4a6d650f0b84a292a1e4669a7', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '1dc076619bc5a1cec9cb83f508ecdcd5d9a5728f', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'fc0734d3674690c1e5a04a8847c5ecef0f927c5f' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: 'b1915f8a2a16f1869617dce992e5e554324f8cc6', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'c42f45ad8f188da8768120e4986cc8743d7837bb', d: "m21 16-4 4-4-4" }), index.h("path", { key: '6427b77c1eabf9dfac14a0939fcd770181e49976', d: "M17 20V4" }), index.h("path", { key: '909330f27247ac4f8ffdc24d3f8c8e0105017136', d: "m3 8 4-4 4 4" }), index.h("path", { key: '2bbfd2e28e5f39a6450a1eb29ee8479b82eaa155', d: "M7 4v16" }))))))), index.h("tbody", { key: '4e944f19f2484f67d6a46e58b608864698320757' }, this.tasks.length === 0 && (index.h("tr", { key: '48c869f8c4d26c471dabfd62bb4e96833d3397b6' }, index.h("td", { key: '9368467be15adbf6fe14b89b4e6fc494dab34d1f', colSpan: 9, class: "text-center" }, index.h("div", { key: '020ab2c2b593f727c023b4e562e795ffd9922108', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '359c8132431c9738b05a41dd54d840c218ccd5eb' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), this.tasks.map(task => {
            ...
            return (index.h("tr", { "data-date": task.date, "data-testid": `hk_task_row`, "data-assigned": task.housekeeper ? 'true' : 'false', style: isCheckable && { cursor: 'pointer' }, onClick: () => {
                ...
                }, class: { 'selected': isSelected, 'task-table-row': true }, key: task.id }, index.h("td", { class: "task-row " }, isCheckable && index.h("ir-checkbox", { checked: isSelected })), index.h("td", { class: "task-row extra-padding" }, task.formatted_date), index.h("td", { class: "task-row extra-padding" }, index.h("span", { class: { 'highlighted-unit': task.is_highlight } }, task.unit.name)), index.h("td", { class: "task-row extra-padding" }, task.status.description), index.h("td", { class: "task-row extra-padding" }, task.hint), index.h("td", { class: "task-row text-center" }, task.adult), index.h("td", { class: "task-row text-center" }, task.child), index.h("td", { class: "task-row text-center" }, task.infant), haveManyHousekeepers && (index.h("td", { class: "w-50 task-row extra-padding", style: { textAlign: 'start' } }, (_a = task.housekeeper) !== null && _a !== void 0 ? _a : locales_store.locales.entries.Lcz_Unassigned))));
        })))));
    }
    static get watchers() { return {
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b49436d2ebec831d582b8347b5a7dce780bbb6ea', class: "m-0 p-0" }, index.h("span", { key: 'b10b26abf45126fd33205169c5431f55dcff32cf', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '4a2a4325a5c0367cc2f6a8b1754e50a96884007c', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: '6ac45c64e256976f34035c94bd9ef09fbf7b5599', class: "tooltip-arrow" }), index.h("div", { key: '06b7766d6fdc6dc33248cfa44c4c217c7abd4674', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '2ce6bb94221ae2eb268e51661ed93e696ebc267c', innerHTML: this.message }))))));
    }
};
