...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: '84d598da3a62dc05497eb2b7b054f859f3159c54', "data-testid": "book_property_sheet" }, index.h("div", { key: 'af5bf4a802f8b25289823c026778b78a98fafa6e', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: 'be32f6c05a58cd928a55378505e7997d89750dfd', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: '3c5cc5f47d3629a71679659a7e87209715de5c95', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '0cd7c776ffcc5ea1ef41289d35f2aafcda7c2e5d', class: "card-header-container mb-2" }, index.h("h3", { key: '86b31421b16746d6b746f198b5676426b2919f92', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: 'd69d80d582003dcd864a735fbe33d4b538dbbea4', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '69915b559dec8434ff00319a7b73a2432f9a004f', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '10af7ae1ebc07cdb64404db36aa6dd14d128ca6e', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: '9672925872160e91819710d28a9f27558305d472', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: '512943ed4dd82bc88427052a5c5e2267b62ca609', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index.h("igl-booking-form", { key: '8eee5bec70dd1cb060de5c2a286f3734f6a7b9cc', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countries: this.countries, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '70275de6568f4e972a20af5ef5673bbdff145183' }, index.h("button", { key: 'e8b8f54113cc0328aa967c3e9cdfeea5443bc359', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'd1d860a0ce1b65cc1408adebdc4ef98f3e8bd024', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '86cc53746049ea9bf9673d6ff53edcd63710062c', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: 'cded17309983e0d884b35caa76a6d6bdfe9a0275', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'aa6d914e82518c517d05ffbb25b7f91da3654149', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '2a0464ec3d0441e3f125d9da28d695a15b9e626b', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: 'af02f9cb707e36828fe22c6b28cdb5802f6d4ccd', htmlFor: this.checkboxId }, this.label)));
    }
    static get watchers() { return {
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6863ea1aefebbfe88c51b57deeb7093e6c655343' }, index.h("slot", { key: 'f4f894173b2740b11cad36596b7e484ee9f01023' })));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '017f6aab05646d16062620172881fb19bb356834', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: '15704a2f06d4aa82663249345a521c2c4c3a7829', name: "trigger" }), index.h("input", { key: '892f1c5c515270a9cb2b5c5e22bc7c02cb608735', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '867bb8b9da1549ba7a731d351bf220410ab342fd', class: "d-flex align-items-center" }, index.h("span", { key: '640f4948c80b4b8a6b0de7cb179eb570d6e7557b' }, this.dates.from_date), ' ', index.h("svg", { key: '2ce642f21b11ea8ee2112e0961973fcf30592cc7', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'cfd138705fa387012d493525061c84b0694d38ba', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'ceb7f8905571a463cae628a027328f2eb9bd0baa' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'd6070a3a42969402f5710b72488e25c594f4d28c', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5033abd0b2a3bd15a5d5da64c93de586b3d399fa' }, index.h("ir-title", { key: '7aab3f6cbc3bd0892f7c021d32dcff20c28008dc', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '81a45fa8c8fb773f0078fa9fcf383bc8818d7b64', class: "px-1" }, index.h("div", { key: 'ca6ccd9086409c5edb44b54b02fe2b82ae60e676', class: "d-flex" }, index.h("ir-select", { key: '989b3f1d6f0058602947a7f663d40cd69bb8a638', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } })) : ('N/A'))))))))))), index.h("ir-sidebar", { key: '8fad2bf2ae30fc97ccc497aaaccb7f985b80cfc4', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: '2d97e29ce6573403e0eb91787a4a6dad8bf8b065', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f5746a824463f12246b54569a1cece3f1f951cc0' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: '956cd01f1d0526eb97c2af004ba5ca84068680a7', class: "loadingScreenContainer" }, index.h("div", { key: '5f3710a3095a88a8f00d6755971b7f06b5fef0c4', class: "loaderContainer" }, index.h("span", { key: '291096060d0b7317a116f6516f05fdf16666e85c', class: "page-loader" }))))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '68662eb0bf00aa36b1dc8bb42475673ce1727e18' }, index.h("span", { key: '4c1836102b498956f01e9602b2fecd00b6d4ffc3', class: "loader" })));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '68af4657bfde5477911b00b34b0f5497b16b089a' }, index.h("div", { key: '3a74a435806b7b5c8a619ebdf009cea0cc73012b', class: "form-group mr-0" }, index.h("div", { key: '7bc56118edc1dc8aa0d97b6eba9ae0df590de9e9', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '708608c72c07720dafa8f059866eb54dd420a982', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '77d0ba7be6613226dbf87f4b81aa9a6d6866acf6', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: 'efdc87cfa1493d1d0c12e6b63df7a649a46fc734', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '92ec406982f57d91c845d415777e04728b5db4b0', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '125473d1e27f7ec426a682f3d0002aa3273c924e', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '5517f7652c6156b8f43426c505fb276bf2aa669d', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '587666d712fa99fb91c7a78da3c3cf617ada4064', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: 'e3330712c22203692a0f4492150ac7ff65fcb60e', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: '16e3aa478b3c4c3a14d648f97d794ecb515f7162', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '60cf5b300b8200754a969b8bb790313d52bb8062', onComboboxValueChange: e => {
...
const IrRangePicker = class {
    constructor(hostRef) {
         ...
         */
        this.maxDate = utils.hooks().toDate();
        /**
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0c5a96dc1934ce1bb36383c54181999537b4f3dd', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '71192473e0dcb5f15e5f399180132ffd20f4920f', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'e810b435de472a57b645ec023dcbec19195be1e2', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'bab5fb019467ed74219c40e4993ba94ab5519885', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'ef6fde261f38c0490e92fedb69e61470ef8896a4', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'f55b787f2264474fb04eeee630d4e4582fd9c3f2', class: "m-0 p-0 flex-grow-1" }, "Filters")), index.h("ir-button", { key: '976eb9c662183b02b6855b7cdc39222dc0b89801', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '63a97e1e6627be7f81cce05201845460d59441c8', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: 'f2bd6469c76b7d6acda55b753f654e4908d3aea3', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'a689be235571e7ed743feb3d2cd40df735bb40a3', class: "pt-1" }, index.h("p", { key: '1118858765b05aa19e020f01838300fa45279762', class: "m-0 p-0" }, "Period"), index.h("ir-select", { key: '1aff8cd81ea1eef66236106c88b29514980f3ee6', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: '2a96adb606b4679a3bad7a2fb2fb6f65e4ab1d23' }, index.h("p", { key: '7d17c3ce0b41b25ef233445f5100d57dd7bdae33', class: "m-0 p-0" }, "Housekeepers"), index.h("ir-select", { key: 'f35a6a24460519c234b6a319594a10fba2825edb', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
                { text: 'All housekeepers', value: '000' },
            ...
            } }))), index.h("fieldset", { key: '33e536fcdac9da1fa301a04d1b59dda57d261c95' }, index.h("p", { key: 'ad2ed03b2cbe13091d5fed5dff95e5cd91daa4e8', class: "m-0 p-0" }, "Cleaning frequency"), index.h("ir-select", { key: '96e6c3ff5fa2b93be073acf87d92fdfda2476416', testId: "cleaning_frequency", selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: 'c0ade0b5b0701d2124c49f745a937bb1010fe8a2' }, index.h("p", { key: 'e8ab9db47623b92958a3e0d7312474a02ce16bfa', class: "m-0 p-0" }, "Include dusty units"), index.h("ir-select", { key: 'c08cc207e9f66c7cb1ff64f061228e73aa9f0bab', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.dusty_units) === null || _l === void 0 ? void 0 : _l.code, data: (_o = (_m = housekeeping_service.housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.dusty_periods) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), index.h("fieldset", { key: '68687b7e0e556541ecf7d12f69a1a2c8db030f53', class: "mb-1" }, index.h("p", { key: '8b337074317efd71eb387ea9f8cad327edc26689', class: "m-0 p-0" }, "Highlight check-ins from"), index.h("ir-select", { key: '1023b02cfdd1f6bf8ca0b967de746028ee503e9c', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: 'c5eef891d1945fc835c2f61a85b8a57b1822ee02', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '39b233f6e3b647d5db8ed517aa625e6aaf4bf078', btn_type: "button", "data-testid": "reset", text: "Reset", size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '461ec68975a995374004858159f7113fc5874bf6', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: "Apply", size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '8ea3496dea07bd6173a52a5092bf4ff3c727e89b', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: '90f4d2acb5977fd8f8df4b3f1d47c6205cff9267', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: 'eaafa88a7dff62b06ee5e7c943379b3a14b61a19', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: '0019d83ec4ab622eaef7ad84dbab94c71b8d1f97', size: "sm", btn_color: "outline", text: "Export", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: '87eaec07ab41415bd916a4dbabc4001675052add', size: "sm", btn_color: "outline", text: "Archives", btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: '030d56519f58fc3f1d8b19418d204b1716040e15', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '95cdfee8392a4ac980c8c87f7e4e6e195671d5e9', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '18683383580c47761503546f289a064ce3f930d6', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '78c1e4156f6dc2fcb5c49b37c051a9e6a7275b51', class: "table-header" }, index.h("tr", { key: 'ed514f54c030f29bd9ae71af1dfeab94c91dc834' }, index.h("th", { key: '4c66482ab326a64b668d1d1f1cd82dbacfb9d6c5', class: 'task-row' }, index.h("ir-checkbox", { key: '64bc7f4a8681e451783347aa59f15a062b2198fc', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '58d2f4384374897f4549bbff40e70aabd1a8e2bd', class: "extra-padding" }, "Period"), index.h("th", { key: '53e7af2e34405086f0be9508abf158d2889d2f50', class: "extra-padding" }, "Unit"), index.h("th", { key: 'eccb22b4618497a3b53703d7ceae8af306c9f95f', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: '999226191cd9390246b8fd9b0d5a02ec943bd2e3', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'c1f7ba593496a1da9380fc214596b58ef5e1e5e0' }, "Status"), index.h("svg", { key: 'a5d63bdb04e007f9f2c0de71c8b6b477c28e95bd', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'adc3975b0ebae6d2778401afae1d118fc2bdd027', d: "m21 16-4 4-4-4" }), index.h("path", { key: '1c5b3ef0cb9a03d6ebfd59e364bd1f2c28526603', d: "M17 20V4" }), index.h("path", { key: '369ee34c2a1051b2e541fec5655e0c735c9790d6', d: "m3 8 4-4 4 4" }), index.h("path", { key: '3a7f3edb4d33a022448f3a1ef907556f288bc62e', d: "M7 4v16" })))), index.h("th", { key: 'ead24f3c849f0e93f99ecbe1e1bf9b0aa0f58233', class: "extra-padding" }, "Hint"), index.h("th", { key: 'ed44206dcb3fd3d07db6a51df04a43dc4641f74e' }, "A"), index.h("th", { key: '29363e432ed77719eb48ab0abc3540bc2a6097a4' }, "C"), index.h("th", { key: '092ba9cc924ec7e283c3b629e829bcceac5654bd' }, "I"), haveManyHousekeepers && (index.h("th", { key: '8063d8c31fe2bfc114a2986de23885a23b09d5d9', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '5a8ba8045d63427a3fe9f1276c6327953e33bf5f', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '0f7aa8884249582db79309777ee5a347292beff4' }, "Housekeeper"), index.h("svg", { key: '79c76a9c971ae04d3d9e94dbfeaa9360acc9ebe3', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '56d15b2347bdd9d85a5ee6fa073db7cc5aa20204', d: "m21 16-4 4-4-4" }), index.h("path", { key: '537fb3f2420226f84c42b4c744184426e2e85e0f', d: "M17 20V4" }), index.h("path", { key: '6b0ae574997875a9683e55b1abbcdf025f788ae9', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'b677a5e39710754809cb8faf6dba54f12497d780', d: "M7 4v16" }))))))), index.h("tbody", { key: '06b04d1b3173c0751fb047177451aa0e64f0cc98' }, this.tasks.length === 0 && (index.h("tr", { key: 'dbb4df8f1c03da68b7ebda095f02fb9c1f5dd64a' }, index.h("td", { key: '6eeba9a71f00537b76b1ea137ce3cc6e654ea7d2', colSpan: 9, class: "text-center" }, index.h("div", { key: '79066becfdaa1fffb66dee7f1fa69ccbfa3f42b8', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '34315e5f7345d2024b75608a2bcd21d7b371e37c' }, " No Tasks Found"))))), this.tasks.map(task => {
            var _a;
