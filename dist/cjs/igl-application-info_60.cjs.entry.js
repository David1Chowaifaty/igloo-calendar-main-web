...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '70ce330836aa0c637e7b5ca10a1a45bbe5945967' }, index.h("div", { key: '847f4d27d6518018037fd289cdece58d2f30bf0c', class: 'd-flex align-items-center ' }, index.h("label", { key: '09342d46eae3a18f635ee04658700b65fd9f9591', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'eda6dc9a488686ff26e1f139d61c0f353fec9a6e', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '89e73e0466e9b4bca7f0f1b5caaffc5ffe2d84c0', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '6c4bc734a204f21f16f441297594e301d5948a93', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '621efb692e6c4da1f45a5ba90799bcf55351e8d0', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'c33236911af62dd9cab48b9b68686c320571a55b', class: 'sr-only' }, "clear input"), index.h("svg", { key: '65ffa72a01ab9cbaabdccb7461be6ac10e684007', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'e833e872437e5c80c74c8ec4b66c6fe07d31bba4', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7a3e4c9d5fbea10663757fd3711a94fd628b6efc' }, index.h("button", { key: '1ce441f5e9d9cac5936d823942b7b57524ff24f5', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'b807ff00789e7cbd3145f1c9c0878246549fd5fd', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'd34b4bb847b1a6d971e0decaae5131ad21f40b39', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: 'e1384687a65747a3c6c5dbfa35dd65427d26ae03', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'cf09677e50c2f55f887be374e4a356c42f80e3e5', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '53dd803e878978834eaa603e0aee46005220c297', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: '4fe42cfa61b3bdc8e9d68a44653d09f6ac2d72e1', htmlFor: this.checkboxId }, this.label)));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'cb9768e2f319f6ad5f94a6c245d0001b09b0cd71', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '68e280a6e56267b32208d7441a1d113d60fdaeb4', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: '4d8aa7bf9ad410fbb90fcab89e2de7daca1bb669', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '898fd0873f83296a29d0cfac61a8968ded7d101c' }, index.h("button", { key: '6ebb72fc2f5cb6640b7e1c4fa5ae6a0c65c58a99', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'c5717cec5bcba2e6e0b805b7d62aaa2e1091da5e', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '39410fa87d62880701e8037a4e25ae531e8de72e', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '381bf4f67ce110617ee2aa85b220361c95124424', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '6ac28d3f2427743f44b449715d976f1d9e8499a1', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '31162bfd9b9fb139ac002990bc319490946410cd', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: '673f6b63533a918d805d1ea0c800b691dbf1432d', name: "trigger" }), index.h("input", { key: 'af9ca00b0cfb27c520f71aa8674ead2e0c6686f8', type: "button", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '87e012238947f745347949b09b2f3db94f3987b0' }, index.h("input", { key: 'c7b025f2578f48300c2881753c4ada05ae78711e', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f5d82fae802b43663e3e55838184f67538b845ed' }, index.h("div", { key: '3d6f1c556b22ce1071a3888483d5cde58e0565f3', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '144cf74e8417c70e9978c609838ce02a34e8c7c5', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '5edad5fce2d5681ee2953be18e1ee47fa7717437', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'ed4bf0ae822c9bf41b281e9be9b8b91ef20049d1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '75952ac11ae8c8f3114f55f98412bb71510a7948', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'e61713f351cdb3cfc6cc2876401bb56e69a5c804', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'ac7a87ab42f69c2278c46affc11e70f226b59eed', name: "modal-title" })), index.h("div", { key: 'ba73a7778edfc11b5dcbf3590c19196697997772', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '9fa5ada2dbbf7933c61ca81f39e38d1254928754', name: "modal-body" })), index.h("div", { key: 'e89879a8e92345fc9b90aca60db4ca794f1b8904', class: "modal-footer" }, index.h("slot", { key: '9fc8842991dab55e299e8985dea29c1aeda4c42b', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '90a3031237c92558484715a5f2d671e24326cdba' }, index.h("ir-title", { key: 'db2fbd3931b58668896bcbeac83b1bbe84b1d463', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '96289e7d972be8ac93abe59de4af65944c172f39', class: "px-1" }, index.h("div", { key: 'd0a4041225468f44b7b7618d166282a1b738c246', class: "d-flex" }, index.h("ir-select", { key: '564ade08c38e5a27e4bfb8cf6cbb7edb85d330f6', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), index.h("div", { key: '0287c94c344e5aba163301d1ac79648ec92800e3', class: "d-flex mt-1 align-items-center" }, index.h("ir-range-picker", { key: '7945b7ca1a58429ccad952fd8ffbe6de0feb0ff2', class: "mr-1", fromDate: this.filters.from_date ? utils.hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? utils.hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), index.h("ir-button", { key: '98705ebf593f9945630fa17229efd31168c57b31', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), index.h("ir-button", { key: '49a1eb6ba7fe09f3796b50406835bf935340e5e9', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (index.h(index.Fragment, { key: 'dfe1072e6dfa2b5c3c6f04718e5222ae5dc065fa' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("p", { class: 'text-center mt-2' }, "No Results Found")) : (index.h("table", { class: "mt-2" }, index.h("thead", null, index.h("th", { class: "sr-only" }, "period"), index.h("th", { class: "sr-only" }, "housekeeper name"), index.h("th", { class: "sr-only" }, "unit"), index.h("th", { class: "sr-only" }, "booking number")), index.h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (index.h("tr", { key: d.id }, index.h("td", { class: "pr-2" }, d.date), index.h("td", { class: "px-2" }, d.house_keeper), index.h("td", { class: "px-2" }, index.h("ir-tooltip", { message: d.unit, customSlot: true }, index.h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), index.h("td", { class: "px-2" }, d.booking_nbr ? (index.h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
            ...
            } })) : ('N/A'))))))))))), index.h("ir-sidebar", { key: '2ba2361597c634a1594a162fe5ff31ced9c1c60b', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: !!this.selectedBooking, showCloseButton: false, sidebarStyles: {
                width: '80rem',
                background: '#F2F3F8',
            } }, this.selectedBooking && (index.h("ir-booking-details", { key: 'dff119e7ca970d7746d42a8dcaa56ca5832e64b7', slot: "sidebar-body", hasPrint: true, hasReceipt: true, hasCloseButton: true, onCloseSidebar: () => (this.selectedBooking = null), is_from_front_desk: true, propertyid: Number(this.propertyId), hasRoomEdit: true, hasRoomDelete: true, bookingNumber: (_m = this.selectedBooking) === null || _m === void 0 ? void 0 : _m.toString(), language: this.language, hasRoomAdd: true, ticket: this.ticket })))));
    }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '64282271b487428727b07cf9316d518730b084fb', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '40ac45ca4afd9305c630491ff5cdb64f2d85614f', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '14421f48428f3cd024ca9313486a63ceb080b212' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: 'dbbecc8a92bfebb58ffce37fa73146e2d093856b', class: "loadingScreenContainer" }, index.h("div", { key: 'dfce9bce199082ab4d2e7fe3457154f486a58316', class: "loaderContainer" }, index.h("span", { key: '39cef7553cfce55b4bd3aa5632e948b80307f802', class: "page-loader" }))))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e824e74348a0699956eb7ff003af22f0ec1bb070' }, index.h("span", { key: '7d6c351b9ddc16b70f5537efdd2dd032b198aa37', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'f5fc0d7807027e87e98a13c25871ebfa0945efa6', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '25cf84280e2c14ca610a2b2690724ab0c46f4044', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '789dc23eccbb9e54703d192fd2a5233f571e587a', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'bbaf699c0033d81a228ca9ff329208714cbd042e', class: `ir-alert-header` }, index.h("p", { key: 'e21f7c92956bcf52d1b966c290bbeba524ff79d5' }, this.modalTitle))), index.h("div", { key: 'f9f0f36cf7ff34d8f08d2168fecff038a990037b', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'fd65783ac7679d9ad8abcb1348b7564ee7ec4fe0' }, this.modalBody)), index.h("div", { key: 'feb578490c67bf83eb9fbb852d8cc71b92986fad', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: '9cf07af66ab078b44adb1c2be556ce859bd8923e', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '377ad693d3175c6ccb0481bfadade952f3e10af2', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '0dc99363b764abd7da4a4bd706497d755e76b849' }, index.h("div", { key: '598e2ea6f218f5caea7ef1583c20efc30cc97de6', class: "form-group mr-0" }, index.h("div", { key: '44b71496dc31c652ef0b48fee387789fb646fbdc', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: 'ea943f83a93cb2c0c5ee70fddcbea96992134aff', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'e7591b649115629fa8d55293b98289bcde51107d', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '3c892c2b8c174910145c5ff3558d0786dff33168', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '74925f265e01d981affe2e44c0daf4897a0b60ea', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'dd2b832fc2880eea888fd1e619deb43b1c14be0f', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'd2dd27c95f27ae12c473cf3542720233ddd4bddd', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'be31cca4b91e65d5875f187484f11cc0a6e092e8', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '34d0e26fb87f8678ff5242346d0c8f69d584676c', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: '50f1708126ca6126908f211957da32524d40fc96', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '9210cf3695e2591f137e62f5eeb997ddba3ac702', onComboboxValueChange: e => {
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '6f690c398157af6f4e484b71b0775dc68c0b767b', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: '5b1dc985cf88245e54baadd62bce14906332719a', class: "input-group-prepend" }, index.h("span", { key: '38fc659d2b2104b123a0dea77feeab81901a1b96', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'e24d965895b06489f87d94736964d2348502eced', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'f4c86edd119a2f60551685bb38bbfadf84ceaeab', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '0d360119381fa1c8d7adbdbb85a64fb731e555fd', class: `input-group-prepend` }, index.h("span", { key: 'f6594f34157feab2de2ee6727d4e0845d36dfa04', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'f89f6caa8742a89e4b9918b838d22b472b2a3cb9', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRangePicker = class {
    constructor(hostRef) {
        ...
        this.maxSelectableDate = utils.hooks().toDate();
    }
    ...
    renderDatePicker(id, date, minDate, buttonText, refCallback, additionalProps = {}) {
        ...
        return (index.h("ir-date-picker", Object.assign({ class: {
            ...
            }, customPicker: true, ref: el => refCallback(el), minDate: minDate, maxDate: this.maxSelectableDate, date: date === null || date === void 0 ? void 0 : date.toDate(), id: id, emitEmptyDate: true }, additionalProps), index.h("ir-button", { class: "range-picker__date-picker-button", btn_styles: "p-0 m-0", slot: "trigger", btn_color: "link", text: (_a = date === null || date === void 0 ? void 0 : date.format('YYYY-MM-DD')) !== null && _a !== void 0 ? _a : buttonText })));
    }
    render() {
        var _a;
        return (index.h(index.Host, { key: 'e4cd6932627ac2c6691c7193dd197b2b0da0fa21' }, index.h("div", { key: 'd5f4bd08ef9d9ccded35ef48d50e4440da6f4ed1', class: "form-control range-picker__container" }, index.h("p", { key: '77590f6dca2abad04401c2f730de60a0f6f760f4', onClick: () => this.fromDatePicker.openDatePicker(), class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            } }, "Cleaned on"), index.h("svg", { key: 'aa22f62f4f4cbc4d8a98b8583a6ab3deb283ebe1', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: '2fa41debff6938107bbd9575c0606f2cd6b92306', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minSelectableDate, 'from date', el => (this.fromDatePicker = el)), index.h("svg", { key: 'fe75e6c74c16be02a2430ff8a922dd7febfd854a', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '0381efd9a7ae309e2fb2ee5f59f07c9b74f1f9a8', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, ((_a = this.fromDate) === null || _a === void 0 ? void 0 : _a.toDate()) || this.minSelectableDate, 'to date', el => (this.toDatePicker = el), {
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '3a4b59d674811dbc4275bdfcd7e8df66e624e977', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '2a967d355e3026bf385a86fa618ea6863a795842', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: 'd8031cde33c3178978bf59ddd165194f89d08b82', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'dd39c245bee8e5d94d6e521a5ce40bcbea2ff1ef', class: "input-group row m-0" }, label, index.h("select", { key: 'dfaa264493d8397789d8ff57295d3df1136b7b8c', "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'd1484f09329aa806cde1513f137d5dc8c927c02c', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'b06e702da7ef2fbe122dd27124a7c12d3c54a3ef', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '70f6250ead7a5c927f6b2de55bcb972f34e65a19', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'aee3da129ede1e1804289c70d8b6ede1942dc746', class: 'sidebar-title' }, index.h("p", { key: 'a6738da19d1c22dbd766ab7c2c50358f2a15053b', class: 'p-0 m-0' }, this.label), index.h("div", { key: 'a148e987a0597ce77455ded18ad59afb56c3e963', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '47a4b1d84ba7718a99fd7b5a08821b3145301b4d', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'fc9103fa1d3b6061e83cf736f8c10749028ad3ed', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'e6d60f43f239552cc16ca6a921f1039269adb5c0', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '4d4aea8e6f2159618ffebdf581052b5fe205019f', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'b140ccd89afbe57d75745dedecc2ae8e05c0d0fb' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'be1436bc95cc0bcab827b78012fea40e7013b46f', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: 'e68d42de2bbe8abe5f248ae16ba841dc3e8fb56f', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'b29ada82797384c69ed3e15c82cd6d441e549f2a', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'c0e5b66f58b055fd897e37df0fd00a9c0a23ea88', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '2e559599092f8ff2d383a5357f651228ede2fdfa', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '12688f4cec8c5ab35b50d3da4b601d651630a51e', class: "m-0 p-0 flex-grow-1" }, "Filters")), index.h("ir-button", { key: '6a9c43bb8e253b261857c100951ef0039e8ceb2b', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'a486a705b13f6f033616ca5ac06c6ed32cd473f3', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: 'f93d01837b50a52edb7e8100a7c25d2fd3586f8f', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '3ca6a36df4091516bc3d8a8f663ea5ca9e67ac09', class: "pt-1" }, index.h("p", { key: '4b1574aa8b5f646e8e6fe788147980eb3c329c94', class: "m-0 p-0" }, "Period"), index.h("ir-select", { key: 'cd472e543bb6f000aaa2c6086b68aa3e468ca939', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: 'd13de5f11805eb9c0218e7e8c04b7ece5bdf20ef' }, index.h("p", { key: 'ddab0a41ec0e58085146e2e0285e485e435fc16b', class: "m-0 p-0" }, "Housekeepers"), index.h("ir-select", { key: '463e281ac7464672b41e39ac22d10a185bc84b12', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
                { text: 'All housekeepers', value: '000' },
            ...
            } }))), index.h("fieldset", { key: '7557a66670069094e144d68629a12597d83853e2' }, index.h("p", { key: '07a7df0b907d7c78af81807ea1711c7f273375a5', class: "m-0 p-0" }, "Cleaning frequency"), index.h("ir-select", { key: '565431d52a8c127a66649370472db1882a333558', testId: "cleaning_frequency", selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: '6e2b83bb92dc71a64f97cdc864936aa8b08c7bfb' }, index.h("p", { key: 'b22f73b965ba1a2cd8050ad05186f1bc9fde2574', class: "m-0 p-0" }, "Include dusty units"), index.h("ir-select", { key: '56144feaf2aa7e51ca79be79cf0ffa6e6e77d89f', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.dusty_units) === null || _l === void 0 ? void 0 : _l.code, data: (_o = (_m = housekeeping_service.housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.dusty_periods) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), index.h("fieldset", { key: '233b1ba46d40c55c7b696aa0f096ecfd5df2a34c', class: "mb-1" }, index.h("p", { key: 'bba79da60ce2018811aa82affa6252ad7257ee0a', class: "m-0 p-0" }, "Highlight check-ins from"), index.h("ir-select", { key: 'e804f38936b7bb7d0628e38855d3d4f1649b26f7', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '10ac41db8efbaeeee58e3987ae2f8110a9016418', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '3fbfdd54349ee34d410e99696ad5eb5add6dd00c', btn_type: "button", "data-testid": "reset", text: "Reset", size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: 'd12a2c26a994603bb0f42e126d7890c969b76872', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: "Apply", size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '7774ff8a502c6ea04e2d2ff5f70f82834bf24266', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: 'bdcf3c526b8e3219b2b70eec864a60d1e2f99b37', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: 'a501df0cdda5814938b72ce5bdfaf93c2f196369', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: '3d04c9d99903314b27326e5594c1ca87c07c9d62', size: "sm", btn_color: "outline", text: "Export", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: '994cd1c3aac58eca6db5aab2162e71f3e49780d8', size: "sm", btn_color: "outline", text: "Archives", btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: '9dd1dc3b486e3bbb295bd400346da6bc01461a5b', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '6de9769081a2c19dbc063a41d297d1bdb6d27f93', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '90f4866fd0440deb974b18bf165c82f4ce9642d8', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '8e42a67a042d0b333189ac8b1c7f9d4127671e60', class: "table-header" }, index.h("tr", { key: 'c77dc4373c40de69454f6f825f407454b114cbc3' }, index.h("th", { key: 'a90a6977a73a4ecbabeb81857cef6e10d1e3827e', class: 'task-row' }, index.h("ir-checkbox", { key: '470e19f1b4229c30a12499b7356085f979fa1f58', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '4185f685bc68b281be0aaffe91ae3de753cac885', class: "extra-padding" }, "Period"), index.h("th", { key: '8beaa08f69c442facb42758134bb840e87c38e27', class: "extra-padding" }, "Unit"), index.h("th", { key: '469cbcef7f97ddaddca72621377de313f415043d', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'cc7d6d6b15abf52d8d7db0bbeea16bb537f56fa7', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '93f0996d9ad8c74d98ff5145a1cc71d1c8b17772' }, "Status"), index.h("svg", { key: 'ef3314a401e18688967574525182d7ea68c9d0ea', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'c1b269e7a919f4771dd572df87dfd4e20847a1eb', d: "m21 16-4 4-4-4" }), index.h("path", { key: '3606822a05e09a8d48c253bdd9643f550435ed5f', d: "M17 20V4" }), index.h("path", { key: 'da0085e163e17bb1e460053194e3da236c54017e', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'd5aed9991ff3a0f71a7d7f297080a2e72f2e9db4', d: "M7 4v16" })))), index.h("th", { key: 'f4cc44aedb2e6aa2c2ee7436ec0571f399c2c02d', class: "extra-padding" }, "Hint"), index.h("th", { key: '8840accfc31d96706144c0badb6e295ba40d4f46' }, "A"), index.h("th", { key: 'd790b674c52a6017158ffaff1a9d0ccf75617fd3' }, "C"), index.h("th", { key: 'e7ab2e22a0347fce9406433802d1634d036fba4e' }, "I"), haveManyHousekeepers && (index.h("th", { key: 'e89a67b1e25db695d1b18ed3056a7f86dff03960', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '65ac2989783141be47531bb28591a4c4f85d4bdc', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '5ac44cefe06c85674b7a8a3b44b2a068a7445025' }, "Housekeeper"), index.h("svg", { key: '0d39f5eaf19b3ee55f091718ab4a5ba4452b222d', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '9eef098ea962acd2a30262a0de1861aea3f58a6f', d: "m21 16-4 4-4-4" }), index.h("path", { key: '3162f6917e48644c9c30a2b4769b2ec122b65ca0', d: "M17 20V4" }), index.h("path", { key: '8618cd507c5e40ebf6fc44efd2c8ee3ff6de2f63', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'cf4fb1779976705557f469e29314e8b28bb32722', d: "M7 4v16" }))))))), index.h("tbody", { key: 'de8d269c41a415b2a47bd06da8acbdff9581fe9a' }, this.tasks.length === 0 && (index.h("tr", { key: '7bd38986b2d5e38de44e6472dd9f35f5c8aab859' }, index.h("td", { key: '6811c1ec82ba7f4b73e5f8870f350560ab63aa09', colSpan: 9, class: "text-center" }, index.h("div", { key: '388aca4a10ce09c95dfaaaec31cffc31faf24ef1', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '177e3097d4908e986c849b68df9c0fbbc3754328' }, " No Tasks Found"))))), this.tasks.map(task => {
            var _a;
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9487c802a411e9307ecc5fa52258364f0fe0b766' }, index.h("h4", { key: '3c590bd644a8bbb4ec26002017816f7090ee785c', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '72b0d565c18b69cbb4fe4f66d0472300a3a059f8', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '9898f5926ec9903df3f1d8ea1414671603129748', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '013bbfad055cbb0e7ff46ca0d792e7b70bdc5870', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '26335635bf54b38353bf1ac8c4e0227b59a57bc1', class: 'title-body' }, index.h("slot", { key: '5fc59b0e980cc770e19c3b13f18a02827fa70409', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '147f27d122dff64feb117215f36a4c1773e2d714' });
    }
    get element() { return index.getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd7ba75702a996401892b837d8294d661dc383b41', class: "m-0 p-0" }, index.h("span", { key: '1dcd9214d32b2320d2605915622943f78cfd3928', class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: 'b83e876efb75d8d3790267a1d53e705618bd776b', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'ba404895aa8e16f3682c529d26bcb04732b53f63', class: "tooltip-arrow" }), index.h("div", { key: '6488b7de6fc0a5e65f9cdde7b6a377bac2d713e4', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: 'f7e98f30c67032124263e77b32a3b3eae630465a', innerHTML: this.message }))))));
    }
};
