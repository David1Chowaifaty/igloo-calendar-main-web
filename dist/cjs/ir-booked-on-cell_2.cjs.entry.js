...
const IrStatusActivityCell = class {
    ...
    bookingNumber;
    render() {
        return (index.h(index.Host, { key: 'c1439c790bbbd6f77752d3d4650906660f01a03e' }, index.h("ir-booking-status-tag", { key: '6bef3441c4c58215973a84f1d31d238f5289f9d4', status: this.status, isRequestToCancel: this.isRequestToCancel }), this.showModifiedBadge && index.h("p", { key: '35c1f77080c6237f51844c13bdfba51e4d375474', class: "status-activity__modified" }, "Modified"), this.showManipulationBadge && (index.h(index.Fragment, { key: 'bc91fd00ab392679b0e453915a4f172d9b6d8b88' }, index.h("wa-tooltip", { key: '9ac448dcce07eeb67b53e900789ef5bba6bdab2f', for: `manipulation_badge_${this.bookingNumber}` }, `Modified by ${this.lastManipulation.user} at ${this.lastManipulation.date} ${this.lastManipulation.hour}:${this.lastManipulation.minute}`), index.h("p", { key: '83d8b54ef9c9674b49eea2d8d8890ac7c4615992', class: "status-activity__manipulation", id: `manipulation_badge_${this.bookingNumber}` }, "Modified")))));
    }
};
