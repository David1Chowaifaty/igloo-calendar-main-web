...
const IrBookedOnCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e0640a5f95364bf5a981c9150c613d25eeca934d' }, this.label && index.h("p", { key: 'c47aa43a0712fdd2ec0b2f81218f3e8766ddb264', class: "cell-label" }, this.label, ":"), index.h("p", { key: '1e590de5f379a1b9cb9e2df65ee17fe578ea0d39', class: "booked-on-cell__date" }, moment.hooks(date, 'YYYY-MM-DD').format('DD MMM YYYY')), index.h("p", { key: '368f52c72bcd274a3f8f4f8d6734feae88400aec', class: "booked-on-cell__time" }, functions._formatTime(hour.toString(), minute.toString()))));
    }
};
