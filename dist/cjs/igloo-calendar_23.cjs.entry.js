...
var index$2 = require('./index-CGEg1Fow.js');
...
var channel_service = require('./channel.service-9MoWl-6T.js');
...
var index$3 = require('./index-BgFNePQr.js');
...
function hasUnassignedDatesInRange(data, { fromDate, toDate }) {
    const from = moment.hooks(fromDate, 'YYYY-MM-DD').startOf('day').valueOf();
    const to = moment.hooks(toDate, 'YYYY-MM-DD').startOf('day').valueOf();
...
const IglooCalendar = class {
    ...
    async initializeApp() {
        try {
            ...
            if (!this.calendarData.is_vacation_rental) {
                ...
                calendarGrid.addUnassignedDates(data);
            }
        ...
        for (const span of mergeUnassignedDatesRanges(batch)) {
            ...
            for (const source of span.sources) {
                ...
                if (!hasUnassignedDatesInRange(data, source)) {
                    calendarGrid.removeUnassignedDates(source.fromDate, source.toDate);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a25d1faea6d4a315772475a99a2d9b0364d02b2f' }, index.h("ir-toast", { key: '7c9b48cf1d7f1aef0cd5962af7bc27f450dc3310' }), index.h("ir-interceptor", { key: '734f6eb8cea19c2c20c1305e41c6b9c134629a48' }), index.h("div", { key: '06de2e126d3155b107d034ea2ea6a5a30fafb105', id: "iglooCalendar", class: { 'igl-calendar': true, 'showToBeAssigned': this.showToBeAssigned, 'showLegend': this.showLegend, 'showDayUseBookings': this.showDayUseBookings } }, this.shouldRenderCalendarView() ? (index.h(index.Fragment, { "data-testid": "ir-calendar" }, this.showToBeAssigned && (index.h("igl-to-be-assigned", { unassignedDatesProp: this.unassignedDates, to_date: this.to_date, from_date: this.from_date, propertyid: this.property_id, class: "tobeAssignedContainer", calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) })), this.showLegend && index.h("igl-legend", { class: "legendContainer", legendData: this.calendarData.legendData, onOptionEvent: evt => this.onOptionSelect(evt) }), this.showDayUseBookings && (index.h("igl-day-use-bookings", { class: "dayUseBookingsContainer", calendarData: this.calendarData, dayUseBookings: this.dayUseBookings, onOptionEvent: evt => this.onOptionSelect(evt) })), index.h("div", { class: "calendarScrollContainer", dir: direction.isRtlDirection(locales_store.locales.direction) ? 'rtl' : 'ltr', onMouseDown: event => this.dragScrollContent(event), onScroll: () => this.calendarScrolling() }, index.h("div", { id: "calendarContainer" }, index.h("igl-cal-header", { unassignedDates: this.unassignedDates, to_date: this.to_date, propertyid: this.property_id, today: this.today, calendarData: this.calendarData, highlightedDate: this.highlightedDate, onOptionEvent: evt => this.onOptionSelect(evt), dayUseBookings: this.dayUseBookings }), index.h("igl-cal-body", { propertyId: this.property_id, language: this.language, countries: this.countries, currency: this.calendarData.currency, today: this.today, highlightedDate: this.highlightedDate, isScrollViewDragging: this.scrollViewDragging, calendarData: this.calendarData, dayUseBookings: this.dayUseBookings }), index.h("igl-cal-footer", { isLegendOpen: this.showLegend, highlightedDate: this.highlightedDate, today: this.today, calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) }))))) : (index.h("ir-loading-screen", { message: t.t('Lcz_PreparingCalendarData', { fallback: 'Preparing Calendar Data' }) }))), index.h("igl-split-booking-drawer", { key: '213bd387f79254ac5c5b18ab417d9a0b456f282d', open: this.calendarSidebarState?.type === 'split', booking: this.calendarSidebarState?.payload?.booking, identifier: this.calendarSidebarState?.payload?.identifier, onCloseModal: () => (this.calendarSidebarState = null) }), index.h("igl-rate-extender-drawer", { key: '3229dabd331a2cff7374baca0b1925a561c1ef2e', open: !!this.roomNightsData, bookingNumber: this.roomNightsData?.bookingNumber, identifier: this.roomNightsData?.identifier, toDate: this.roomNightsData?.to_date, fromDate: this.roomNightsData?.from_date, defaultDates: this.roomNightsData?.defaultDates, pool: this.roomNightsData?.pool, ticket: this.ticket, propertyId: this.property_id, language: this.language, onCloseRoomNightsDialog: this.handleRoomNightsDialogClose.bind(this) }), index.h("ir-booking-details-drawer", { key: '87a0e7d4d82d3e3c84a157b5723b7f3ff385d841', open: this.editBookingItem?.event_type === 'EDIT_BOOKING' || !!this.checkoutRedirect, propertyId: this.property_id, bookingNumber: this.checkoutRedirect?.bookingNumber ?? (this.editBookingItem && this.editBookingItem?.event_type === 'EDIT_BOOKING' ? this.editBookingItem.BOOKING_NUMBER : null), checkoutRoomIdentifier: this.checkoutRedirect?.identifier, ticket: this.ticket, language: this.language, onBookingDetailsDrawerClosed: () => {
                this.editBookingItem = null;
                this.checkoutRedirect = null;
            } }), index.h("ir-room-guests", { key: 'e5de340965a705db97dabebe68bbc6913533b4d6', open: this.calendarSidebarState?.type === 'room-guests', countries: this.countries, language: this.language, identifier: this.calendarSidebarState?.payload?.identifier, bookingNumber: this.calendarSidebarState?.payload?.bookingNumber, roomName: this.calendarSidebarState?.payload?.roomName, totalGuests: this.calendarSidebarState?.payload?.totalGuests, sharedPersons: this.calendarSidebarState?.payload?.sharing_persons, checkIn: true, onCloseModal: () => (this.calendarSidebarState = null) }), index.h("ir-reallocation-drawer", { key: '288a5542b051eefd11b1bac9fb0ad4799826f474', open: this.calendarSidebarState?.type === 'reallocate-drawer', booking: this.calendarSidebarState?.payload?.booking, pool: this.calendarSidebarState?.payload?.pool, roomIdentifier: this.calendarSidebarState?.payload?.identifier, onCloseModal: () => (this.calendarSidebarState = null) }), index.h("igl-reallocation-dialog", { key: '54d39119ead8306cc62b1e15d4fe0006f45f7e4c', onResetModalState: () => (this.dialogData = null), onDialogClose: () => this.handleModalCancel(), data: this.dialogData?.reason === 'reallocate' ? this.dialogData : undefined }), index.h("ir-modal", { key: '677ba7c018d0596987651b597f859b36c24d34d3', ref: el => (this.calendarModalEl = el), modalTitle: t.t('Lcz_ModalTitlePlaceholder', { fallback: 'lol' }), rightBtnActive: this.dialogData?.reason === 'reallocate' ? !this.dialogData.hideConfirmButton : true, leftBtnText: t.t('Lcz_Cancel', { fallback: 'Cancel' }), rightBtnText: t.t('Lcz_Confirm', { fallback: 'Confirm' }), modalBody: this.renderModalBody(), onConfirmModal: this.handleModalConfirm.bind(this), onCancelModal: this.handleModalCancel.bind(this) }), index.h("ir-checkout-dialog", { key: 'd10421ccbe194f71a8f883f5f8f4154052a638ac', style: { textAlign: 'start' }, booking: this.dialogData?.reason === 'checkout' ? this.dialogData?.booking : null, identifier: this.dialogData?.reason === 'checkout' ? this.dialogData?.roomIdentifier : null, open: this.dialogData?.reason === 'checkout', onCheckoutDialogClosed: event => this.handleCheckoutDialogClosed(event) }), index.h("ir-invoice", { key: 'f75e034cbdebe3b6f808a3293ffa670523fd60ac', style: { textAlign: 'start' }, onInvoiceClose: event => this.handleInvoiceClose(event), booking: this.invoiceState?.booking, roomIdentifier: this.invoiceState?.identifier, open: this.invoiceState !== null }), index.h("ir-booking-editor-drawer", { key: 'd662c2dcadbd3b6a02b658ac816f8305fe79abe5', roomTypeIds: this.bookingItem?.roomsInfo?.map(r => r.id), onBookingEditorClosed: this.handleCloseBookingWindow.bind(this), unitId: this.bookingItem?.PR_ID, mode: this.bookingItem?.event_type, label: this.bookingItem?.TITLE, ticket: this.ticket, roomIdentifier: this.bookingItem?.IDENTIFIER, open: this.bookingItem !== null && this.bookingItem.event_type !== 'BLOCK_DATES', language: this.language, booking: this.bookingItem?.booking, propertyid: this.propertyid, checkIn: this.bookingItem?.FROM_DATE, blockedUnit: {
            ...
            }, checkOut: this.bookingItem?.TO_DATE, dayUse: this.bookingItem?.dayUse === true }), index.h("igl-bulk-operations-drawer", { key: '2c532470805fbf4052b15c528256f726e6fc3e3f', property_id: this.property_id, onCloseDrawer: () => (this.calendarSidebarState = null), open: this.calendarSidebarState?.type === 'bulk-blocks' }), index.h("ir-rectifier-drawer", { key: '0470ab38f75f5e8619a56b4d5236e866ee7e694c', onCloseDrawer: () => (this.calendarSidebarState = null), open: this.calendarSidebarState?.type === 'rectifier' }), index.h("igl-blocked-date-drawer", { key: 'c439b6938b8afcafe2525a3f463797ed910c1cc4', onBlockedDateDrawerClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingItem = null;
...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ed602a1924449cbee284244bbfb64ae8e87c653d', class: "p-1" }, index.h("ir-interceptor", { key: '42bbeb1b35bef5839103cc3a126485be2251b1a9', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), index.h("ir-toast", { key: '76abedd7b80e0c531653c10a0452100bc60aad43' }), index.h("div", { key: '04a331c6239afebe2862651154dbc453b0e08361', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, index.h("ir-input-text", { key: 'b3ea73c0557827339235fd4d090ca2e4ec5db209', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), index.h("ir-button", { key: 'af3d5bf3989863958cf55ba6019f5ac93f686dff', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), index.h("p", { key: '95b6b16af806e661d9aab0c8e3cf98b637d831a3' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": [{
                "handleTicketChange": 0
...
const IrLocaleSwitcher = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '532274949dfe6dafc52115613527cb8b273117fc', class: `ls-host ls-host--${this.placement}` }, !this.open && (index.h("button", { key: '9c27c40b2161fbff8224322954e5f9bd6d4aae44', class: "ls-fab", title: "Locale switcher", onClick: () => this.setOpen(true) }, index.h("wa-icon", { key: '41d7d0cc1d7099311238d653ab86d22d2dfac182', name: "globe" }), index.h("span", { key: '036ce57ab24fe74602f5cfd992f6e79737b4c076', class: "ls-fab__label" }, language.toUpperCase()))), this.open && (index.h("div", { key: '64af5334776c390db1143969df5ee78c7efefe35', class: "ls-panel" }, index.h("header", { key: 'd73dc9490d7907313449c381768c6d472624d8fb', class: "ls-panel__header" }, index.h("span", { key: '39e1b47ee20721793d1304030d168e51c2042993', class: "ls-panel__title" }, "Locale switcher"), index.h("button", { key: 'c5e192529a027a1f3452dd108c9c77ae955951c5', class: "ls-panel__close", title: "Collapse", onClick: () => this.setOpen(false) }, index.h("wa-icon", { key: '93e69df8117521f759368adf72aeb809efd1301a', name: "xmark" }))), index.h("wa-select", { key: 'b577bdfe507e462d0e45cbc61c214587d810699d', label: "Language", size: "s", value: language, onchange: (event) => {
                const value = event.target.value?.toString();
                if (value) {
                    this.applyLanguage(value);
                }
            } }, LANGUAGES.map(({ code, label }) => (index.h("wa-option", { key: code, value: code }, label)))), index.h("wa-select", { key: 'f5caedfa5fbd62fab6cf9cdbae7e1cab262911e4', label: "Calendar", size: "s", value: calendar, onchange: (event) => {
                const value = event.target.value?.toString();
                this.applyCalendar(value);
            } }, index.h("wa-option", { key: '8f5120feedbca0e9d1b9b7e554895b66863ba31e', value: "auto" }, "Auto \u2014 detect from device"), index.h("wa-option", { key: 'ff178c4e48ee0c27aec419760254002436b97542', value: "gregory" }, "Gregorian"), index.h("wa-option", { key: '40ffa1cde8058b4a092dc9ddb2a5f43bb5c590f5', value: "islamic-umalqura" }, "Hijri \u2014 Umm al-Qura")), index.h("wa-select", { key: '4305f0b34dce7dd761fe47e04f782d9896a7087b', label: "Numbers", size: "s", value: irDate.calendarPreference.numberingSystem, onchange: (event) => {
                const value = event.target.value?.toString();
                this.applyNumberingSystem(value);
            } }, NUMBERING_SYSTEMS.map(({ value, label }) => (index.h("wa-option", { key: value, value: value }, label)))), index.h("wa-select", { key: '95383f13a0ee4426367cca3c428bada97cbb34de', label: "Direction", size: "s", value: this.direction, onchange: (event) => {
                const value = event.target.value?.toString();
                this.applyDirection(value);
            } }, index.h("wa-option", { key: '844c8fcf862f93601f3c8802bb449945e55f3703', value: "auto" }, "Auto \u2014 from language"), index.h("wa-option", { key: 'bd50da7adfa94f6c9e0beae09aa44d19668f2553', value: "ltr" }, "LTR"), index.h("wa-option", { key: '9566fb41da7b841ded7d61a260497441b4b2be23', value: "rtl" }, "RTL")), this.renderPreview(), index.h("footer", { key: 'c497ed52cf0759fd7f4c02b28575bc39604a0ad1', class: "ls-panel__footer" }, index.h("span", { key: 'a102306370f928d9aa1b1f33d9f31da0bafaeaf9', class: "ls-panel__resolved" }, "resolved: ", language, " \u00B7 ", irDate.calendarPreference.resolved, " \u00B7 ", irDate.calendarPreference.numberingSystem, " \u00B7 ", document.documentElement.getAttribute('dir') ?? 'ltr'), index.h("button", { key: '604730e8b4141f6df962659f1dba2bfcf80c09cb', class: "ls-panel__reset", onClick: () => this.resetSettings() }, "Reset all"))))));
    }
};
...
const IrMealReport = class {
    ...
    render() {
        ...
        // ];
        return (index.h("ir-page", { label: t.t('Lcz_MealReport', { fallback: 'Meal Report' }), description: this.localReportType === 'GUEST_LIST' ? 'Guest List' : 'Meal Count', class: 'page' }, index.h("ir-custom-button", { slot: "page-header", type: "button", size: "s", appearance: "outlined", loading: this.isExporting, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
