...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'b8722a6638df3bfadb0255cc8539db7787ab7efe', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'bebaa8aba2c52bcb7febe0a00e2ed75f67a5572c', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '5ed58518cf166c4e117f573375914025161ac0f3', class: "picker-item__check", name: "check" }), index.h("div", { key: 'cffcd68fddb5d52647935f874b2dc6e0f18b0b20', class: "picker-item__content", part: "content" }, index.h("slot", { key: '6aff6b6f6220a8a4cb6f97a4edd0024209919db4' })))));
    }
};
