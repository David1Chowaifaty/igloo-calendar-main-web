...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '4756c1c0936e20e1020e0b523b0d0244eed0e3f1', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '8b06df83e37e906e8028b85798dc19f01940709f', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'acc52b4efdab9d2021901eac394b0bec5b8afc33', class: "picker-item__check", name: "check" }), index.h("div", { key: 'ff5edc4f9618918cbbe74477c93f0e734ca82b8f', class: "picker-item__content", part: "content" }, index.h("slot", { key: '3083a9dbb7377f211dfb3c82c6666c758118a892' })))));
    }
};
