...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '5f0cef0261f9863a57a29b9cbed41d10b850a36b', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'adf03ddeef2b25f3bd90d41c07c2fb6b6569db11', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '93e984ab092d7863b892bdb6a02eaeff4a88aed6', class: "picker-item__check", name: "check" }), index.h("div", { key: '87a449e16c1089153d140a465699f5dbcbaa5911', class: "picker-item__content", part: "content" }, index.h("slot", { key: 'c44c52154e4ea28ac3becb11d497dc895caa37b2' })))));
    }
};
