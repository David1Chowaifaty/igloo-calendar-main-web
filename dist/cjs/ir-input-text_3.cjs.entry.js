...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '33bb939bdfeaaa8973232edf3e78b8e03e5bea52', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '9c77954bbdbe21fa2345cac2d856b0e49e1ab416', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'ea7652af5694ce90d22631c3a6e200a41e0caaf2', class: "picker-item__check", name: "check" }), index.h("div", { key: '3ecaa6e5e5964e370846bc10df4f61d08a61e5b0', class: "picker-item__content", part: "content" }, index.h("slot", { key: '73b1058099f339caa66d71c4b95e6cef82273938' })))));
    }
};
