...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '1a3c05e807678f794f8674fde163f27d55521c28', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: 'e15e5b5923034b645acc6fdcc6d013760411d928', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'af56b8f1da49af8b17589ad978a254058c07203c', class: "picker-item__check", name: "check" }), index.h("div", { key: '57c3dd53e927c9effaa48dd4b72b0cbad0508835', class: "picker-item__content", part: "content" }, index.h("slot", { key: 'e3c49453253c7d3dbd9f5b6444c1725ced5ae9a6' })))));
    }
};
