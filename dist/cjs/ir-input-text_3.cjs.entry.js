...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '472972d7c85588536716ed30169034eb65950ba1' }, index.h("wa-popup", { key: '25812f55b6bd824dcec6c6472e42fe22209f7a04', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '91ed3dfe2d7ce18df394cc23f9c67392f64716aa', slot: "anchor", class: "search-bar", "aria-invalid": this.isValid, withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, onblur: () => this.inputPickerBlurred.emit(), autocomplete: "nope", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: '4956eb29f28bcf087b0acfa788df8081e1717f25', slot: "end" }), index.h("wa-icon", { key: '298c08413c49caf3b73713d136359232516c3d38', slot: "start", name: "magnifying-glass", "aria-hidden": "true" }), index.h("slot", { key: 'ec91a97370cd5f073999c1f28da99cc56e5e5c5c', name: "end", slot: "end" })), index.h("div", { key: '656df750123b627e6225e40bbe2f1fbcc9c1ce46', class: "menu", role: "presentation" }, index.h("p", { key: '972d9a2f3410367cb1dafa86a017d10031c9d053', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: 'e678014b76276d3d8011c565d32441d74908eae1', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: 'e3f805952a03f8fd53bd6afd0911ac5838f8014d', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: '6089904a0de3f0fe9f19324bb31445304f1be872' }), index.h("p", { key: '2640cc67894fd696e1bce93519b9f6166e28d3f1' }, "Loading suggestions\u2026"))), index.h("slot", { key: '7df70937d013015cf0a179c2513eeb65781802b4', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: '1fc140ccb51b850ff6296d16d1e3f439bb922b3a', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: '872ac6d9cf2d22e98e37f577b9a214552b60342b', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '1bdbbeedfe17e5d612b328ecf53112fd43da8a73' }, "No results found")))))), index.h("span", { key: 'e3bd8f726daa9df2ecb6fd6f2dc97c83acd417b7', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'dfa6ea5bfe8143bfbb1113dcd4025d51cdd2eec2', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '6ccdbe98ea51c974652218e4fad9ab70c64c5c8e', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '36e103de37ec28c94a3aec1bb4464fba7a69240b', class: "picker-item__check", name: "check" }), index.h("div", { key: '64191b78267a938e95bd508ffa4f71ae8caa88ff', class: "picker-item__content", part: "content" }, index.h("slot", { key: 'd90df81cf5b58a3e0ab5511114cfdbdbd1b546e6' })))));
    }
};
