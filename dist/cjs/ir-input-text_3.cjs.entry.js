...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '37554f72eabf7fa73feac4774a54282eb682d6b0', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '9422dc40240c9ba7cf5c7fa31edb0d978c28a55a', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'c4cd6a9fc125b1a20a1a05f4c012e7f421c770d1', class: "picker-item__check", name: "check" }), index.h("div", { key: '5c4e152a879a872f11f2e95dc6aa65eca1c9be22', class: "picker-item__content", part: "content" }, index.h("slot", { key: 'a31450137471a451c60e3794acd2975d2ecba9c3' })))));
    }
};
