...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '56587baa5380406a7d97697e5fa9e89e10be7a2c', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '5c3b6e05632053a2f5dc10d40eed95688a0d7cd3', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'b2e8caf9653f80551c67b24f6ac0bb320b4277e5', class: "picker-item__check", name: "check" }), index.h("div", { key: 'ac7386c203eb52ac0b612f58210a2937a5ea2f52', class: "picker-item__content", part: "content" }, index.h("slot", { key: '08501569d996d4711d128cc4bc6a778f275e62e2' })))));
    }
};
