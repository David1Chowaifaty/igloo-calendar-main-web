...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '848f552b82a1d86a485c56ee31b9d61be1509996', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '075d8bf8f1db4a33288a40b1fcd87c103aa019f5', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'ad3c09b3609c56e4052fdd8e3c65f08711dfc00a', class: "picker-item__check", name: "check" }), index.h("div", { key: '14abbc81b42935af00b951a95f18fca7b289ff63', class: "picker-item__content", part: "content" }, index.h("slot", { key: '0439b57a84dab57f1d903ad7b7271a2d175d4247' })))));
    }
};
