...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dbcab56da13a4cdfad81366590c8ed6878b5dc60' }, index.h("wa-popup", { key: 'ebbaaf900302483402cea9a285d3b27f49e69052', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '90598b42e587e9fc2f8140694f7011329bd8f5bb', slot: "anchor", class: "search-bar", "aria-invalid": this.isValid, withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, onblur: () => this.inputPickerBlurred.emit(), autocomplete: "nope", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: '7426eec809912697a298b1b8f8b4df92c0ec4b7e', slot: "end" }), index.h("wa-icon", { key: '82aec949e6f3a672b5054dd268a88b04524aaaf8', slot: "start", name: "magnifying-glass", "aria-hidden": "true" }), index.h("slot", { key: '7018d518cd30fb1da948bdd088357b342069759a', name: "end", slot: "end" })), index.h("div", { key: '6c2a43c3e84385cedd52bd815295e2b926d932de', class: "menu", role: "presentation" }, index.h("p", { key: 'ebfacda4eb83688ee9f9ce03f614356a7abf5f05', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: '845c04e671b9b94803beb12a26fe321d7c4c0c43', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: '1cb733e5ea997c93ba1c9a914f25cf7671b3bfce', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: '8f3d62c7ca1ef29533858c1f9daad862eea30665' }), index.h("p", { key: 'f8c0c1c531e82c65cdc8745159c935b781cc5963' }, "Loading suggestions\u2026"))), index.h("slot", { key: '55dc942cc5caa8ac4ab9aa6b1ab4f0a95f76f2c8', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: 'a9baf349b97b432697bf8f072e61c18ecf36a06b', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: '3c2e7d6d1c6af5e8add6d5c5ca66f47ddc858f9f', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '0b97e08ff01ac61e663cf16e0f08c5069d56d464' }, "No results found")))))), index.h("span", { key: '97eeb44de712b725bdf330d7fe14ec5af5564299', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '3315fc46c7b117174fe0388d28737da90202f918', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '610c72b4020678232eee877c96ed8f45ba7b76a7', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'd27e487b14d5d1adfe67ad44e761d38a4a335975', class: "picker-item__check", name: "check" }), index.h("div", { key: '5644ef2dbd28eacfd7cdfae47c95ec727f152374', class: "picker-item__content", part: "content" }, index.h("slot", { key: '5ff1b59f422dab0868a0607b229d61b8b2315ccb' })))));
    }
};
