...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'feef0644cfdc6426050f0cf9fcb717bc968046a1', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '5832eb7bead9b2acbc01a5e548ec0a81de9bd0eb', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'f7b4db4160bfd0504104aca0a5ca0c4ac4865660', class: "picker-item__check", name: "check" }), index.h("div", { key: 'e252c508d06e7c375a28228fcdc0bb68cddaba42', class: "picker-item__content", part: "content" }, index.h("slot", { key: '8081a42cf13de9f7e5c433590b9a01d774ec2508' })))));
    }
};
