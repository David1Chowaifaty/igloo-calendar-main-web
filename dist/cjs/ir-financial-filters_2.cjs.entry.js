...
const IrFinancialFilters = class {
    ...
    render() {
        return (index.h("div", { key: '82ade3acab6de7f2079178c9c0384906cb91a274', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: 'd14368b7753bf3b39867dfd458d3c2eb6042278b', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: '3e22a2ea7007ca513bf7db490d55f42b431e5ceb', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: 'e28da4ad15fba98d3df6a90ffe7ab4fbd6d041ae', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '3c31a5715fd2a939a3fd7dba312bb26de0bcc524', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'e0176dda5080c4e50cad8abe9187a1f6cdc42dea', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries?.Lcz_Filters)), index.h("ir-button", { key: '6f7f0fa17be3491e0ab65f336abe7bf68b3452a9', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#financialFilterCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "financialFilterCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '3a72c7935f9e65579c728516e868485976bae62e', class: "m-0 p-0 collapse filters-section", id: "financialFilterCollapse" }, index.h("div", { key: '86456df1912bbaeec97f64ae48a303823ad9c963', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'd2c53f99747a58c94bf9da5a96213ff47eae3af3', class: "pt-1 filter-group" }, index.h("label", { key: '0cb8197d06904da0ece3ab9127e17c3613724a84', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Select a date"), index.h("div", { key: 'e166b84bf4365f372a5d51c67c181a90e807bfd1', class: "w-100 d-flex" }, index.h("style", { key: '05514b79f27c3070d13bae5cf9c5bdc498848dfc' }, `
                  .ir-date-picker-trigger{
                    width:100%;
                  }
                  `), index.h("ir-date-picker", { key: '142eb5f33c7ec940f734f28bc5581ae910b2d0c8', "data-testid": "pickup_date", date: this.filters?.date, class: "w-100", emitEmptyDate: true, maxDate: moment.hooks().format('YYYY-MM-DD'), onDateChanged: evt => {
                evt.stopImmediatePropagation();
                evt.stopPropagation();
                this.updateFilter({ date: evt.detail.start?.format('YYYY-MM-DD') });
            } }, index.h("input", { key: 'afa09050b4d72b2104f392751ab26b9faaa17ac3', slot: "trigger", type: "text", value: this?.filters?.date, class: `financial-filters__date-picker-input form-control w-100 input-sm  text-left`, style: { width: '100%' } })))), index.h("fieldset", { key: 'aec546ecf2f0e1088b3f7fba80438b4b2651e3db', class: " filter-group" }, index.h("label", { key: 'e4a1d902c49ee74f213a620e0b24ffd2ca1e718c', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Users"), index.h("ir-select", { key: 'b2b15aacd636d9bf813d107be3465a6e2642e1e7', selectedValue: this.filters?.sourceCode, selectId: "rooms", firstOption: "All", onSelectChange: e => this.updateFilter({
                sourceCode: e.detail,
            }), data: Array.from([]).map(u => ({
                text: u,
                value: u,
            })) })), index.h("div", { key: '5b0586c3c76c6686d6ea0c689329e4b4f3589ada', class: "d-flex mt-1 align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: '4dcb744762f318843fe5cb9f1e7fa3064bda935a', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '8fd1ae575292aa8a363dbdc3cc7f3af5d03d2e6b', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrFinancialTable = class {
    ...
    render() {
        return (index.h("div", { key: '55028b6ee5da7ed8d4047cb144a28733d044f1ec', class: "table-container h-100 p-1 m-0 mb-2 table-responsive" }, index.h("table", { key: '9318cdf10f26b294e92366d7a2b01946f4769bda', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'f33198613b0cdf975005004c5be8e6e6bcdda130', class: "table-header" }, index.h("tr", { key: 'bb957807f1b075754ba9fcc94234fc28f8844aa7' }, index.h("th", { key: 'da39da276064bb4b488e92e3b7c7390f95ef7f4c', class: "text-center" }, "Date"), index.h("th", { key: 'b60f6b089c4faa3b12e46f1d51793143c87bb01d', class: "text-center" }, "Booking"), index.h("th", { key: '434f64d96de73e53451da22ad0a576c35b05db6d', class: "text-center" }, "By direct"), index.h("th", { key: '18bf52281f70339415f905330118e2b0bf959b7d', class: "text-right" }, "Amount"), index.h("th", { key: '2d83e5d57a92e841b5a31d7fc08c10666aa0dc3c', class: "text-center" }))), index.h("tbody", { key: '83a6938bc055dcd3f62274d8daaa036e69d333c6' }, index.h("tr", { key: '1535009aadad82ed017f0c2b78ca3afdff43cfd3', class: "ir-table-row" }, index.h("td", { key: '7ea38ef7daefe5d6f8411ea1a00165a775d2e8ba', class: "text-center" }, "1"), index.h("td", { key: 'ff131d2d983d236483a5cd201918319aaf059301', class: "text-center" }, index.h("ir-button", { key: '10ba559dc27c2012c25d279a3088f3698e0c6b74', btn_color: "link", size: "sm", text: "31203720277", onClickHandler: () => {
            ...
            } })), index.h("td", { key: '86fa5df12d152e531c2ee0d435f033cf7b7cc188', class: "text-center" }, "1"), index.h("td", { key: '2a1a706fad8e7526b7b291b2bb72dccf9888a0cb', class: "text-right" }, "1"), index.h("td", { key: '9e7966be7df40af1bea059413a5e659952f5646b' }, index.h("ir-button", { key: '55518f0eb7d37d387edfe9b902a9067b088ba586', size: "sm", text: "Pay", onClickHandler: () => {
                this.financialActionsOpenSidebar.emit({
                    type: 'payment',
                    payload: {
                        payment: {
