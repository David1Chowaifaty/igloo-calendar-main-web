...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cff364875a123a5679f37052d92e3e6485303967' }, index.h("div", { key: '6969e6402b34e7de0b27344d3d683f6f9304feb2', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: '28f89b3bb7c59c275da8d7c03873bdffada1d0bc', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: 'e319497e3ff3b1a60ee28171c1c3a956b95db909', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '1f191efbb8bc0ef9d6b0e3679a9ebdd764e51e74', class: "card-header-container mb-2" }, index.h("h3", { key: 'b4c05cbea68dd4baacefa551da8d7e9831f144e9', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '5f1b1d138af54499a1d0da1ff7d0dcb073c18609', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '8537f60e699772143477f486a638467b44ed9773', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '193e02ef2dd5161b0caf952d79257731668d1884', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: '7e04f6c777cd9457d63d4f1c084629dcde2c4e46', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: '97e98a9d1dc5af8895d0e047a306032ea9c84a89', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index.h("igl-booking-form", { key: 'dbfd1982c93dff1b20dd5721d9a824afdc59f541', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countryNodeList: this.countryNodeList, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b0fcc63c52e82825c97e5a44cceea83c55286842' }, index.h("input", { key: '9d3b63e9eaad7aea298bd73ff64a580420d028c5', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    initializeDates() {
        ...
        this.dates.date_difference = booking_service.calculateDaysBetweenDates(fromDate, toDate);
    }
    ...
    render() {
        return (index.h(index.Host, { key: 'f2c65eb52caa7e6c3c20a6e3d487038fa576a82c', class: "d-flex align-items-center" }, index.h("span", { key: '2f3a43246d0a522a803961372d828052c216c06b' }, this.dates.from_date), ' ', index.h("svg", { key: 'd562bb268a0a4bf74796f76521276331058fe23e', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'ff5af7eed5cf47378e912d84218dcd9bffec6f36', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '9edb988899792ff0d28abafad9f80d6a867fa711' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'd1abc622f88e8f7679f2dfd24284b1ad6bedcf9f', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrListingHeader = class {
    ...
    async handleFromDateChange(e) {
        ...
        if (moment.hooks(booking_listing.userSelection.from, 'YYYY-MM-DD').isSame(date, 'days')) {
            return;
        }
        let fromDate = date;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd23d06e4116941db431c934cdc293f991fd66baf' }, index.h("a", { key: 'a21783d55f1df1048917d5532d0d2ca1bbd44c7d', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '27b4b69046e530dee640ba804e04771c12921ec0', class: "sr-only" }, "download url")), index.h("section", { key: '69309020b011df51ed4d869bcfb3ae7dd0a05ca6', class: "d-flex align-items-center " }, index.h("div", { key: 'a53c5ae8afed76e906a406675a846297038c9cd0', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: 'c14abceed2b450a5ea4afe7a90169381561e0ce6', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '7dc62ead1e3d5f81b97294c20ce03160a0bdb224', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: 'a30dda66ee2672eaf6024c909c8630f7ea631da6' }, index.h("igl-book-property-container", { key: '1a538a61b39ab94cdce8ba9f3e3d6da0304faab8', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '6f126b2068091cfd8e8183358e2a8844ba984a25', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '0c689c2cf194becc2c792af05fed73a5f59aea4a', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: 'f3efddb94f71c9c81b039490cb50defe704a0146', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '577e0e721d84dac2ac8734f61e07492826715f55', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '628c7522036d0720010a092ce4bfb413b115ae4a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '45920ef4f65a126e1ca9f8282f87791987e2a77e', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '1b582fdb695c9bbe86f89ba9ce302099aa20c284', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: 'eb254af9903eff80cc9975f537e45031a2cf01e5', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: 'c3363eb6990ddf8ce844c14a93d6aafca2499a13', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: 'f9bc6286d6eacd1a987d1b45af5fd33a104644d3', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("section", { key: 'b1d77e86afd62a5a17d3c68a86acb24c528b6767', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: 'f8f2e60cd2a426302b14a1ec581afdbc15551f67' }), index.h("h5", { key: 'c5fcccc3d266f748c0ea410b967f7dffd5be07f4', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: 'd5adcb78242b0aa8d935b9cade14a15400fd49ef' })), index.h("section", { key: 'f25a86387d1c19bb57fa8838d431426773d191e4', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: '9691d3bcf12a3cc19231cc4903b814c216434fc8', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false }), index.h("div", { key: 'eb8744a7f6435347279b8efc1b1704219885b2fc', class: 'booking-dates-container' }, index.h("span", { key: 'fcd504de3f809150c7763700d3383b027338fbb7' }, index.h("svg", { key: '71297d664848418eef437fb1f652954de8308dbe', xmlns: "http://www.w3.org/2000/svg", viewBox: '0 0 448 512', style: { height: '14px', width: '14px' } }, index.h("path", { key: '0544c84e60715ef07aec970fae2053123e7cb180', fill: "currentColor", d: 'M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z' }))), index.h("ir-date-picker", { key: 'f60bf68a0aba16d81638dcab0851eeeb9b40babe', id: "fromDate", class: "date-picker-wrapper", date: new Date(booking_listing.userSelection.from), minDate: "2000-01-01", onDateChanged: e => this.handleFromDateChange(e) }, index.h("p", { key: '1a13b673a080817082c86bea3537df33191c2205', slot: "trigger", class: "m-0 p-0 date-display" }, moment.hooks(new Date(booking_listing.userSelection.from)).format('MMM DD, yyyy'))), index.h("span", { key: '14da43d4da5bd50e0ff8811ed70465b0387e5316' }, index.h("svg", { key: 'd45be337bce9d6c2a3f1a2539b973c6518c9912e', xmlns: "http://www.w3.org/2000/svg", class: "arrow-icon", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '77d528a0428a2b3dec67d57a1fe6f246d363da08', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), index.h("ir-date-picker", { key: '8249b19445ca57914a5b0d6e199045148cfb692b', id: "toDate", forceDestroyOnUpdate: true, class: "date-picker-wrapper", date: new Date(booking_listing.userSelection.to), ref: el => (this.toDateRef = el), minDate: new Date(booking_listing.userSelection.from), maxDate: moment.hooks().add(1, 'years').endOf('year').toDate(), onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }, index.h("p", { key: 'efadc5845647af2a8800ee66896476cd9bafd2df', slot: "trigger", class: "m-0 p-0 date-display" }, moment.hooks(new Date(booking_listing.userSelection.to)).format('MMM DD, YYYY')))), index.h("ir-select", { key: '29d7fc64f5a01f3672bc0ad3cfab3c10fc753c1f', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'ce04d375ca0a89856d789f8947ed14e5a326df19', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), select_id: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) }), index.h("div", { key: '29fdd54950955792fdecf7b91d6a32f98c9366ca', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: '36c59a2f3b5daf492ef8a984f433f945ebb63d4b', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: 'd9dacc03e002d2e759d092f99c626468c3d3b5f2', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: 'dada34f2ae38d30492190186974fa2b020cc8413', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
