...
const IrDailyRevenueFilters = class {
    ...
    baseFilters = {
        ...
        from_date: moment.hooks().add(-1, 'days').format('YYYY-MM-DD'),
    ...
    render() {
        return (index.h("div", { key: 'd691b03bf794e3f282576c23c06cc300aaef7908', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: 'e1303b9d50719d4535fee1477de9e3d4f1c9ae6e', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: '9c139c688430ec21e12750aa0c6c7a1a909dec92', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '434819621ccd1ab9f1f53f32a8a1afff3d87e0b6', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '69f97d44876ee13a643225243de8561823bac5e5', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'a60365f7d7b2873a1114ae21a866f7c8e8b2ef46', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '1900662c3886f378e91f0ec8e0e849331dcfd17c', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#dailyRevenueFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "dailyRevenueFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '9a9be2295a6b329a5e8423ee4a21553ef0ff948f', class: "m-0 p-0 collapse filters-section", id: "dailyRevenueFiltersCollapse" }, index.h("div", { key: '5feb816b0b16f9396a0a5121474d3e40433034d2', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'eee60da150d2b8070d6d567acd752ff2d1a17721', class: "pt-1 filter-group" }, index.h("wa-select", { key: '769f68b75cb1c6f6602a5f7fd25cf140d7ad1d16', onchange: e => {
                const value = e.target.value;
                this.updateFilter({
                    date: value,
                    from_date: moment.hooks(value, 'YYYY-MM-DD').add(-1, 'days').format('YYYY-MM-DD'),
                    to_date: moment.hooks(value, 'YYYY-MM-DD').format('YYYY-MM-DD'),
                });
            }, placeholder: "Select a date", size: "small", value: this.filters?.date, defaultValue: this.filters?.date }, this.getLast30Days().map(({ label, value }) => (index.h("wa-option", { key: value, value: value }, label)))), index.h("div", { key: '0b1aed928bf955bfe3c550f0bcb4cd6e423bb865', class: "or-divider" }, index.h("span", { key: '53e21b895ee22caa42fcc325252b0dc66d3a8adf', class: "or-divider__line" }), index.h("span", { key: 'af3cea85485c203d465d894e7fd3377b9c422e49', class: "or-divider__text" }, "Or"), index.h("span", { key: 'a08b4dea061a58a889d78d8ecba8853a29f26872', class: "or-divider__line" })), index.h("ir-date-range", { key: '1cadfc361062c1bd2682e815070c0ba4c2bf89c1', dateLabel: "Select a date range", withDateDifference: false, defaultData: { fromDate: this.filters?.from_date, toDate: this.filters?.to_date }, onDateRangeChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateFilter({
                    date: null,
            ...
            } })), index.h("div", { key: '8725cd31d70319ad31ce047fb55444eade2de882', class: "d-flex mt-1 align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: '8ff193f110cac53be48da78df123b6612d7a1bf9', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '86df86f84a6603c4e5a697d7be80231bdc037148', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c74f3ba7e25ce7c71f2b7a83a77400082617a30e' }, index.h("ir-accordion", { key: '1faf3450d0affe0af8c7c2fc09a599142ffc2ee5', class: "ir-revenue-row__accordion" }, index.h("div", { key: '21fec368a4da5ea0e490a69b6967453c4427f335', slot: "trigger", class: "ir-revenue-row__title" }, index.h("div", { key: '00acbce26dbd00525bc41dab249408875a2fcbec', class: "ir-revenue-row__header-left" }, index.h("p", { key: '958baa5e74047229079feeee33e5c0ad0d024365', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("span", { key: '46f652f302569f3e0133af9fd1e6c1bbe2c9e63a', class: "ir-revenue-row__badge", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: 'bea07519b6c61b38f0681c3407bdff6becf91771', class: "ir-revenue-row__total" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '87fbf29d711435394723d2a5ebfbc1ba947a27d2', class: "ir-revenue-row__details", id: this.contentId }, index.h("div", { key: 'b074b7fdc5c2629b48c91996414330f43386f8bb', class: "ir-revenue-row__details-inner" }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'bba788ccd4523136f8ee3ceaf07a099b993a390a', class: "card p-1 revenue-table__table" }, hasPayments ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), this.groupType === 'type' &&
