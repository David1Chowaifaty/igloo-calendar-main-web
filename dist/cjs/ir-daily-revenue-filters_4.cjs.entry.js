...
const IrDailyRevenueFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '91f2b1fc0751c39fe09ade4d7c6cf515ca497f47' }, index.h("wa-select", { key: 'bddc087bd3c085433d1d13d89ecfd53849469ea4', label: "Selected period", size: "s", value: this.filters?.date?.toString(), defaultValue: this.filters?.date?.toString(), onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: value, to_date: value, from_date: value });
            } }, this.getLast30Days().map(({ text, value }) => (index.h("wa-option", { key: value, value: value }, text)))), index.h("div", { key: '481b4bce8e102d365c41d30bdedef7c0c3712aa3', class: "or-divider" }, index.h("span", { key: 'e10dd702840dea4bdb6470cde2bbf3182272cd42', class: "or-divider__line" }), index.h("span", { key: '6896f4202cbb13e324e33c9c29eeb02bd231b3f4', class: "or-divider__text" }, "Or"), index.h("span", { key: 'e4623e0c171b16eb08b351f59b961e4977c8f5b2', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '7834fe9342d0cd0f638d40e2de5256e42f4f43ae', showQuickActions: false, label: "Date range", fromDate: this.filters?.from_date, toDate: this.filters?.to_date, selectionMode: "auto", withClear: false, maxDate: moment.hooks().format('YYYY-MM-DD'), onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ from_date: from, to_date: to, date: null });
            } }), index.h("div", { key: '571ca51ff749508ed5a6e27e2aba17a2c8dfcd78', slot: "footer" }, index.h("ir-custom-button", { key: '868a68f4695b6ef53385b8ca44a448cd318356f4', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: 'ccd41380ea4b18cb6fb593c032b17a0dd7e46882', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '69aebbd6e67bcbbfd72378097ba42ade516f910f' }, index.h("ir-accordion", { key: '752b4433bd7cfbc30912c85221b42d546a3448aa', class: "ir-revenue-row__accordion" }, index.h("div", { key: '6bedf516e2b4bd3fd6889e91e63aee7437451a61', slot: "trigger", class: "ir-revenue-row__title" }, index.h("div", { key: '8d1cd608ecc43058ab085d66194890f79a1b939c', class: "ir-revenue-row__header-left" }, index.h("p", { key: 'bddf54073de42184db206bc83ef1728b3d8353da', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("wa-badge", { key: '6a6b0b794580c93f823dab68ad8ad40d22482ba9', variant: "brand", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: 'f03e6698f040d87f6d4ee3f26cd867e7db0714ae', class: "ir-revenue-row__total" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '85c8ab2225e81f8a2d118404e9b74a7f9dc84bab', class: "ir-revenue-row__details", id: this.contentId }, index.h("div", { key: 'f91842dce8dc519b97feb8dfaa00daa9e62800fc', class: "ir-revenue-row__details-inner" }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '981d64ef468d5183921a12d264722c160c2e64b5', class: "revenue-table__table" }, hasPayments ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), this.groupType === 'type' &&
