...
const IrDailyRevenueFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '42ad8f49390fde5dfe6542819b230d7449db5496' }, index.h("wa-select", { key: '679ee813decde699613dd31df16468230096b4e1', label: "Selected period", size: "s", value: this.filters?.date?.toString(), defaultValue: this.filters?.date?.toString(), onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: value, to_date: value, from_date: value });
            } }, this.getLast30Days().map(({ text, value }) => (index.h("wa-option", { key: value, value: value }, text)))), index.h("div", { key: 'fe80de4d77cd305c79a045b378cbe1698bd889c9', class: "or-divider" }, index.h("span", { key: '4aa76f738e82243218f697ecdffd89d6066efd05', class: "or-divider__line" }), index.h("span", { key: '30bdb9a95a030a8fac8462212f36a0f87f7ffb13', class: "or-divider__text" }, "Or"), index.h("span", { key: 'e576dee4f76c04173fe0616dec97990b97dc6e54', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '4b6d109f3b29cf224f22e2506c2252abe37a1ca2', showQuickActions: false, label: "Date range", fromDate: this.filters?.from_date, toDate: this.filters?.to_date, selectionMode: "auto", withClear: false, maxDate: moment.hooks().format('YYYY-MM-DD'), onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ from_date: from, to_date: to, date: null });
            } }), index.h("div", { key: '0783b4975f675fc3cdaa64f3aa934135cc5d607a', slot: "footer" }, index.h("ir-custom-button", { key: '444d1c670b8472f1bf82855b34aa69dd6646db12', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: 'a1ab6963a57cd53d656a58ce8583099d7bddd950', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'eb4a209e64660b08b8e34bf42ccbd6ca23575046' }, index.h("ir-accordion", { key: 'bb594442d05c57e15d1b46f0a7f8969f92070974', class: "ir-revenue-row__accordion" }, index.h("div", { key: '271340e53d4e13eb9d21d798ccf5d2cc27a5f09b', slot: "trigger", class: "ir-revenue-row__title" }, index.h("div", { key: '41f078fde4299bfcc218984026f3a74922d20faf', class: "ir-revenue-row__header-left" }, index.h("p", { key: '5668a6d0984ff1243213f39d8dd6967d45141b96', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("wa-badge", { key: '4bd1adae65f896d70c25c602a1c9650649bd83a1', variant: "brand", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: '15db8ddf461a99e4e9e2eabf45f9151ca549e883', class: "ir-revenue-row__total" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '7edaf92084e8152ff6a00bfd217a40f34f6616f8', class: "ir-revenue-row__details", id: this.contentId }, index.h("div", { key: '4b105f1845c0cb7d8ed4d660d4ebd517928c8aec', class: "ir-revenue-row__details-inner" }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '2221c1e2abb84a30a6589e6635324429ac9bd465', class: "revenue-table__table" }, hasPayments ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), this.groupType === 'type' &&
