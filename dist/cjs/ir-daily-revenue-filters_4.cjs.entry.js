...
const IrDailyRevenueFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '5c12d52166b5a3025bdfbfe512ad51c0a5b1bd99' }, index.h("wa-select", { key: '1ceb3d0133ff5bc7842cd90a7039c2dc6160fe5f', label: "Selected period", size: "s", value: this.filters?.date?.toString(), defaultValue: this.filters?.date?.toString(), onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: value, to_date: value, from_date: value });
            } }, this.getLast30Days().map(({ text, value }) => (index.h("wa-option", { key: value, value: value }, text)))), index.h("div", { key: '3e54804d2f43bedcb61ed90864e79e668b610bee', class: "or-divider" }, index.h("span", { key: 'be656c6c331701fa60673af72e6e7f9bc51490f4', class: "or-divider__line" }), index.h("span", { key: 'ceea3dd372aff47105194358d46253387d226676', class: "or-divider__text" }, "Or"), index.h("span", { key: '08cd235cacddf9575bacd97b8465d9dfc6c12aa2', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: 'b88c3b4bc44b3a3dba74f3962970051b8f9098b3', showQuickActions: false, label: "Date range", fromDate: this.filters?.from_date, toDate: this.filters?.to_date, selectionMode: "auto", withClear: false, maxDate: moment.hooks().format('YYYY-MM-DD'), onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ from_date: from, to_date: to, date: null });
            } }), index.h("div", { key: '03534b746c3f202b9566ad9f9b5fdabf56b70a83', slot: "footer" }, index.h("ir-custom-button", { key: '7f14e9f2869fed72af3820c33196c0ab1cc3b16d', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '7c84b28c716e616a51d1d3ea99308fe2c64a308f', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4b0541512495dc478c6c18cd04d51af996c3ba94' }, index.h("ir-accordion", { key: '29fd50925907c6ba6bf4fb4642c3f3fc91f8a7fd', class: "ir-revenue-row__accordion" }, index.h("div", { key: '0f544a85cd89f010a111dfb1bc8fa11c46785aa2', slot: "trigger", class: "ir-revenue-row__title" }, index.h("div", { key: 'b5cd2c3f0c1f74612754a9521efb555ad1f3a80f', class: "ir-revenue-row__header-left" }, index.h("p", { key: 'cde3bd4c6486b64d9312164265ebfcadaad81b46', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("wa-badge", { key: '075ff07df0abc208f0558c13d388d9d4d2b66395', variant: "brand", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: '2da500e56dcfd2a13272a40b1bd50c5ee7db69e2', class: "ir-revenue-row__total" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '1f679ed54c71d633c51f800e171d3b1004ebd656', class: "ir-revenue-row__details", id: this.contentId }, index.h("div", { key: '48a8841bd8d8cae365b7ff3f2e35a134600f75f2', class: "ir-revenue-row__details-inner" }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'a0343c457aafb618d7bab79bd4b5eb4ef8302ba1', class: "revenue-table__table" }, hasPayments ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), this.groupType === 'type' &&
