...
const IrDailyRevenueFilters = class {
    ...
    render() {
        return (index.h("div", { key: 'cb6de64b854d47d89cc61d47a785925e12df356d', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: 'e62637ff6c550757e9535c50c1fb52bf1fb2a8ac', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: '7579f6a2759ce6b6b85d4a9a1fdd73f38728eb23', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '85c57c741d6731726b896cc3d6f5798b1b8321e2', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '003425a3b3234fdfdf59170c61bd478a5fc3aded', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'c9d13e36d04d98dbc0f981a3bb32020b87bbe610', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '0c49203089dfdf868261a2a66f9666204e679fe2', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#dailyRevenueFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "dailyRevenueFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '9b0b038bb5583ae9d1be63735841048fe7a1defe', class: "m-0 p-0 collapse filters-section", id: "dailyRevenueFiltersCollapse" }, index.h("div", { key: 'a415505a369f836ed03a8e7b5eedbf2e7f6454fa', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'af4b3a7a2d1780879d43170171c751c2057c2d85', class: "pt-1 filter-group" }, index.h("label", { key: '47790d10086706851045d33ca6ba3638741371b9', htmlFor: "rooms", class: "m-0 px-0", style: { paddingBottom: '0.25rem' } }, "Select a date"), index.h("div", { key: '722b1f099888cbc46eb2bfc2b9b672050c974aa0', class: "w-100 d-flex" }, index.h("style", { key: '7947d2e2d22db52f2115cd142133746684eb2662' }, `
                  .ir-date-picker-trigger{
                    width:100%;
                  }
                  `), index.h("ir-date-picker", { key: 'f07653686b15a3ce83de41dbe5035769a0145735', "data-testid": "pickup_date", date: this.filters?.date, class: "w-100", emitEmptyDate: true, maxDate: moment.hooks().format('YYYY-MM-DD'), onDateChanged: evt => {
                evt.stopImmediatePropagation();
                evt.stopPropagation();
                this.updateFilter({ date: evt.detail.start?.format('YYYY-MM-DD') });
            } }, index.h("input", { key: 'c8ed669dc20d217b4f69ae8c48ccad30bb195181', slot: "trigger", type: "text", value: this?.filters?.date, class: `revenue-table__date-picker-input form-control w-100 input-sm  text-left`, style: { width: '100%' } })))), index.h("div", { key: 'b55c963cf356a759490190c4e7d4a5c61101742d', class: "d-flex mt-1 align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: 'b5ab64914b9e113cc3cf97690ab6ad6117675698', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '279b69aa5699e6849da8893a6ac6147b41c28f75', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '78587f95a8998e2f18f8dd0f434ded6d575924a0' }, index.h("ir-accordion", { key: 'ab912b435c7b0f0a05c1361fa1d347ff9b420a2b', class: "ir-revenue-row__accordion" }, index.h("div", { key: '84eafefa3450ca8767cd66da54965b5495302198', slot: "trigger", class: "ir-revenue-row__title" }, index.h("div", { key: '90c8af6da49597c669306d305286f397024636d0', class: "ir-revenue-row__header-left" }, index.h("p", { key: '06a7c311fb5c549dedb605d14cd3e2a8cfbe0fb7', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("span", { key: '8b672cd60f6b6e87be0ecd7e79c55f98bd324139', class: "ir-revenue-row__badge", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: '22bca4f9ee826280a84c3225aaf3d59da6164354', class: "ir-revenue-row__total" }, booking.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '4189ad8dceddc2d5bdc90d221af5e1baf14906d2', class: "ir-revenue-row__details", id: this.contentId }, index.h("div", { key: '6268502a6a841be75009ee75fcf88c182acb450a', class: "ir-revenue-row__details-inner" }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
};
...
const IrRevenueSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f3bcb8e3c3d6d718cd617ea2865e93d8ad619e9c' }, index.h("div", { key: '1183bbc5840ea2e0e51e1c70031d313f5b504573', class: "ir-revenue-summary__mobile" }, index.h("ir-stats-card", { key: '569c6d9e4ee4bf1d7f91cf5ada11d644057338f9', icon: 'arrow-trend-up', value: booking.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal), cardTitle: "Payments" }, index.h("p", { key: '8053c752b08ff4f0ce1af3052734c026eb1ebc55', class: "stats-card__payments-value", slot: "value" }, booking.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal))), index.h("ir-stats-card", { key: 'bca648bd10464e1d6c7fa87ec54b8d30f9bd7991', value: "123$", class: "refunds-card", icon: 'arrow-trend-down', cardTitle: "Refunds" }, index.h("p", { key: '00e29d5816096bc2171c265b6f07b3ce61ef7a50', class: "stats-card__refund-value", slot: "value" }, booking.formatAmount(calendarData.calendar_data.currency.symbol, refundAmount)))), index.h("div", { key: '1b3ce66381e754e78273a1298814fbd7e1786114', class: "ir-revenue-summary__tablet" }, index.h("ir-stats-card", { key: 'a1d2697c3a8d84b0dc96f356398039e4aa925404', icon: 'arrow-trend-up', value: booking.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal), cardTitle: "Payments", subtitle: `Previous day  ${booking.formatAmount(calendarData.calendar_data.currency.symbol, previousDatePaymentsTotal)}` }, index.h("p", { key: '1cd8823a39a870655fd42a42c148e693727305b9', class: "stats-card__payments-value", slot: "value" }, booking.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal))), index.h("ir-stats-card", { key: 'f85dc2f19907454b62c6309ba551cb874f4353ef', value: "123$", class: "refunds-card", icon: 'arrow-trend-down', cardTitle: "Refunds", subtitle: `Previous day  ${booking.formatAmount(calendarData.calendar_data.currency.symbol, previousDateRefundAmount)}` }, index.h("p", { key: '6bb56494778d1c7b5cdf7a3978f363e743734541', class: "stats-card__refund-value", slot: "value" }, booking.formatAmount(calendarData.calendar_data.currency.symbol, refundAmount))), index.h("ir-stats-card", { key: 'e3ed0316a6fbc07b4780f73ded175a194871b27c', icon: this.getTrendIcon(totalAmount, previousDateTotalAmount), value: booking.formatAmount(calendarData.calendar_data.currency.symbol, totalAmount), cardTitle: "Difference", subtitle: `Previous day  ${booking.formatAmount(calendarData.calendar_data.currency.symbol, previousDateTotalAmount)}` }))));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '2dfddb70e4833fedc937b580c6d032a17b049588', class: "card p-1 revenue-table__table" }, hasPayments ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), this.groupType === 'type' &&
            ...
            Array.from(this.regroupPaymentsByMethod().entries()).flatMap(([methodKey, byType]) => {
                ...
                return (index.h("div", { key: `method_${methodKey}` }, index.h("div", { class: "revenue-table__method_header" }, index.h("p", null, this.payMethodObj[methodKey] ?? methodKey), index.h("p", null, booking.formatAmount(calendarData.calendar_data.currency.symbol, total))), Array.from(byType.entries()).map(([typeKey, list]) => {
