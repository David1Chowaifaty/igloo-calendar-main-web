...
const IrDailyRevenueFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: 'ede22a379a1c9ef558dc815b267ea0540ee5d139' }, index.h("wa-select", { key: 'aa97c3e9aafffa4b90b06c2ca677a1333fdcf8e9', label: "Selected period", size: "s", value: this.filters?.date?.toString(), defaultValue: this.filters?.date?.toString(), onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: value, to_date: value, from_date: value });
            } }, this.getLast30Days().map(({ text, value }) => (index.h("wa-option", { key: value, value: value }, text)))), index.h("div", { key: '451d9fafe139fc6c8604a4e8aafec103c5131bb3', class: "or-divider" }, index.h("span", { key: 'e14a9da3fb6a9e64009049050a6e325b9589f0ad', class: "or-divider__line" }), index.h("span", { key: 'c712bb9df99fd064645f525375348000f6d8eea3', class: "or-divider__text" }, "Or"), index.h("span", { key: 'dc442101d4b9a68e2cf2b5d2ca3322bbc20846b8', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: 'a404be34c5a87705dd82332021b34c49106eef19', showQuickActions: false, label: "Date range", fromDate: this.filters?.from_date, toDate: this.filters?.to_date, selectionMode: "auto", withClear: false, maxDate: moment.hooks().format('YYYY-MM-DD'), onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ from_date: from, to_date: to, date: null });
            } }), index.h("div", { key: 'cad06da8749199b36a98bc975796b9b2b7830219', slot: "footer" }, index.h("ir-custom-button", { key: '14d49622ae61044397520f7bd8d8bca394f5187b', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '442360afc5b29593ed831c01624a1e3c75f4e43d', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '559f7bbb212f788916e3f439928abfcef4fb61db' }, index.h("ir-accordion", { key: 'ade55e62ed1468b65613bba65d71bb0690f90610', class: "ir-revenue-row__accordion" }, index.h("div", { key: '05972b78f36a8b60d5baa0224fc7622eb4fd3808', slot: "trigger", class: "ir-revenue-row__title" }, index.h("div", { key: '9c5fac15fae1abb3b7d2b9831a9df3cb77289050', class: "ir-revenue-row__header-left" }, index.h("p", { key: '2af2f11aa235685aa316b9e248a940213ef52dcf', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("wa-badge", { key: '4c2c6d82a4f7aba97df4be26be47ce3f488cc873', variant: "brand", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: 'd5bac1623e2ac1635011eed8d954792d13471349', class: "ir-revenue-row__total" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '271b91e5cfcfeb2288b00e0d6042db32e96b587e', class: "ir-revenue-row__details", id: this.contentId }, index.h("div", { key: 'cc707b0d683e66f46dafa165052ebb5c114a0367', class: "ir-revenue-row__details-inner" }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '3d8646668e8197a29c93dce1bbd665125f6a8ea7', class: "revenue-table__table" }, hasPayments ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), this.groupType === 'type' &&
