...
const IrDailyRevenueFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '0a633a1774e1bf084c7dc07e7ee85f9086da8e47' }, index.h("wa-select", { key: 'c18606bd1f70557fc95204a426a7a024f6d01be8', label: "Selected period", size: "s", value: this.filters?.date?.toString(), defaultValue: this.filters?.date?.toString(), onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: value, to_date: value, from_date: value });
            } }, this.getLast30Days().map(({ text, value }) => (index.h("wa-option", { key: value, value: value }, text)))), index.h("div", { key: '0e128412e70de38f1fdb5da64d3ae6f68c86ec57', class: "or-divider" }, index.h("span", { key: 'eee4dd75c6ada9394aa9aaa41ec16f84bac98490', class: "or-divider__line" }), index.h("span", { key: '04db49fc5a7ad576cb3361255f4dec7978f568d5', class: "or-divider__text" }, "Or"), index.h("span", { key: '0ed0e379a0a0133c5b66962b89d0e4d8ea18296d', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: 'c84941331f361cd3d1fe587d2a23768c3a207ea8', showQuickActions: false, label: "Date range", fromDate: this.filters?.from_date, toDate: this.filters?.to_date, selectionMode: "auto", withClear: false, maxDate: moment.hooks().format('YYYY-MM-DD'), onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ from_date: from, to_date: to, date: null });
            } }), index.h("div", { key: '484b17685f731ee0d9dc6fc05a6caff7dc502572', slot: "footer" }, index.h("ir-custom-button", { key: 'cfb2b62a8e9b1901c258c5057669ed438c530307', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: 'e8c3d970e7d78301db2b071cd0ecf0a041cd83a6', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
...
const IrRevenueRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b783a54a6ad08cc9d2d15b0137556be279da3f58' }, index.h("ir-accordion", { key: '9034424a0f39740357d1b33af79c897f52bbaa17', class: "ir-revenue-row__accordion" }, index.h("div", { key: 'b075cc4a662823a21cf36ba7b5a042849e74cc61', slot: "trigger", class: "ir-revenue-row__title" }, index.h("div", { key: '768d03cbd53ccf1071ecfc3ef6ebb679417b8b85', class: "ir-revenue-row__header-left" }, index.h("p", { key: '3a719eac5b91bc457b64bb4b6d032703983f7f3a', class: "ir-revenue-row__group" }, this.groupName, ' ', index.h("wa-badge", { key: 'a527c3ea427624b71d29c9b7b5cea9d04369fb6b', variant: "brand", "aria-label": `${this.payments.length} transactions` }, this.payments.length))), index.h("p", { key: 'a455e9e05374a3fae645e40647cff9184c18a2f4', class: "ir-revenue-row__total" }, utils.formatAmount(calendarData.calendar_data.currency.symbol, total))), index.h("div", { key: '3c8695a51747a95941cbfdda758f7aa809fcacd5', class: "ir-revenue-row__details", id: this.contentId }, index.h("div", { key: 'c69e8c2e97bfe5bf623a6faaaa40d8f7b4aea237', class: "ir-revenue-row__details-inner" }, this.payments.map(payment => (index.h("ir-revenue-row-details", { class: "ir-revenue-row__detail", id: payment.id, payment: payment, key: payment.id }))))))));
    }
};
...
const IrRevenueSummary = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3c128693ff069a64605a27a7bf519625de82eb2c' }, index.h("div", { key: '35d4093825ccb9dc3a8f3edf6c0911475021352f', class: "revenue-summary__row" }, index.h("ir-metric-card", { key: '5dc03dd08dc05601d48198f60c043d6c1f0749b7', class: "revenue-summary__metric", icon: "arrow-trend-up", label: "Payments", value: utils.formatAmount(calendarData.calendar_data.currency.symbol, paymentsTotal), trend: hasPrevious ? paymentsTotal - previousDatePaymentsTotal : undefined, trendLabel: "from previous day", caption: hasPrevious ? `Previous day: ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDatePaymentsTotal)}` : undefined }), index.h("ir-metric-card", { key: '69c61895a70002cd2047c4eb6315b073a604a87b', class: "revenue-summary__metric", icon: "arrow-trend-down", label: "Refunds", value: utils.formatAmount(calendarData.calendar_data.currency.symbol, refundAmount), trend: hasPrevious ? refundAmount - previousDateRefundAmount : undefined, trendLabel: "from previous day", invertTrend: true, caption: hasPrevious ? `Previous day: ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDateRefundAmount)}` : undefined }), index.h("ir-metric-card", { key: 'c62ccf83719b2f1a5fdfc610d06d6a7ac4868d19', class: "revenue-summary__metric", icon: this.getTrendIcon(totalAmount, previousDateTotalAmount) ?? 'money-bill', label: "Net Total", value: utils.formatAmount(calendarData.calendar_data.currency.symbol, totalAmount), trend: hasPrevious ? totalAmount - previousDateTotalAmount : undefined, trendLabel: "from previous day", caption: hasPrevious ? `Previous day: ${utils.formatAmount(calendarData.calendar_data.currency.symbol, previousDateTotalAmount)}` : undefined }))));
    }
};
...
const IrRevenueTable = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'd7bcd68f5c9d8f8162a76974b0c930e163edcb70', class: "revenue-table__table" }, hasPayments ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), this.groupType === 'type' &&
