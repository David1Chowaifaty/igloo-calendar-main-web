...
const IrDailyRevenueFilters = class {
    ...
    render() {
        return (index.h("ir-filter-card", { key: '6c270e58beb66f77b006899ad6572c097e407d84' }, index.h("wa-select", { key: '61fc87cd02722466c5ebadbe62c7bf0b78389c1c', label: "Selected period", size: "s", value: this.filters?.date?.toString(), defaultValue: this.filters?.date?.toString(), onchange: (e) => {
                const value = e.target.value;
                this.updateFilter({ date: value, to_date: value, from_date: value });
            } }, this.getLast30Days().map(({ text, value }) => (index.h("wa-option", { key: value, value: value }, text)))), index.h("div", { key: 'd39fba08b482c301f1ad4655c24be416db5c1d29', class: "or-divider" }, index.h("span", { key: '477f9a0972dead81eca64cd36aae0742ad44fe8e', class: "or-divider__line" }), index.h("span", { key: 'd87f18393556a5465586a4218cf37604ae4e5ff6', class: "or-divider__text" }, "Or"), index.h("span", { key: '8375d181585a4db0f2bc55a42e6c89b0ca35a99c', class: "or-divider__line" })), index.h("ir-date-range-filter", { key: '3e0c17d59ed1d73b11d691678c777386d911699f', showQuickActions: false, label: "Date range", fromDate: this.filters?.from_date, toDate: this.filters?.to_date, selectionMode: "auto", withClear: false, maxDate: moment.hooks().format('YYYY-MM-DD'), onDatesChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                const { from, to } = e.detail;
                this.updateFilter({ from_date: from, to_date: to, date: null });
            } }), index.h("div", { key: '89c102a7fc95928e85c28a7e808bdbdd601ae8d0', slot: "footer" }, index.h("ir-custom-button", { key: 'e3f774ae5c8690e39968e7b311358f17fb4b1489', variant: "neutral", appearance: "outlined", onClickHandler: e => this.resetFilters(e) }, locales_store.locales.entries?.Lcz_Reset ?? 'Reset'), index.h("ir-custom-button", { key: '87d08e7c3ca18ef250bf99eef8011e1b5a9dfb1a', variant: "brand", loading: this.isLoading, onClickHandler: e => this.applyFiltersEvt(e) }, locales_store.locales.entries?.Lcz_Apply ?? 'Apply'))));
    }
...
const IrRevenueTable = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'babf1e74cdfafbfe603e4e9cbe3b293ef7814211', class: "revenue-table__table" }, hasPayments ? (index.h(index.Fragment, null, index.h("div", { class: "revenue-table__header" }, index.h("p", null, "Method"), index.h("p", null, "Amount")), this.groupType === 'type' &&
