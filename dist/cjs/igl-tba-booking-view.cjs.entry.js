...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cf1e34eb2dd90268c4fdabe7de4e276b335f6e23' }, index.h("wa-card", { key: 'd889cea22aefe4e9d9ada56a3b4c5a4c08c73734', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: 'edc1c6a9fa1d37e1b11e247b60fa05cf0f9805d0', slot: "header", class: `tba__header`, title: "Click to assign unit" }, index.h("p", { key: 'f20518568b4ef173a4a6e40cb98e8dd835019c75', class: "tba__booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: '787557d57ae9068e2cc0ecfeeccc0d380af1aad5', class: "tba__separator" }, "-"), index.h("p", { key: 'e8e62367c6411d2b0705897cd7c03933ad15cc65', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: '6d6490b60fdc1fee906140ff5eaad7ff5ae792eb', class: "tba__occupancy" }, index.h("span", { key: '44836817e6b91bd6c335e70ce43b01ecaf3842a7', class: "tba__occupancy-paren" }, "( "), index.h("span", { key: '706141df6fc1bf0fef5c23de42ec53cae66d42c5', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: '64d5e8c8e123e6cf79acd147a49ca49fe1172617', class: "tba__occupancy-paren" }, " )")))), index.h("div", { key: '89b3011ff111fbb4725742857d5c6ab0fc044e03', class: "tba__actions" }, index.h("wa-select", { key: 'fb80442b347bc783ddbb2775e077099d62e12d82', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4.v4(), size: "small", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, index.h("wa-option", { key: '9b7aabe4c81a35507b5f408b853b65a3a75408ca', value: "" }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (index.h("div", { class: "tba__close" }, index.h("wa-button", { type: "button", appearance: "plain", size: "small", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, index.h("wa-icon", { name: "xmark" })))) : null), index.h("div", { key: '36188e5ae5ff2057c345dfe543ed02a7fad5c8a9', class: "tba__assign" }, index.h("wa-button", { key: '7a00c8fe450eed4be6c0f1a7b7c70c4e6f1b51e3', class: "tba__assign-btn", size: "small", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, locales_store.locales.entries.Lcz_Assign), this.canCheckIn() && (index.h("wa-button", { key: 'e2af8c427e8d1040e5b492c57a233879bd40d791', class: "tba__assign-btn", size: "small", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, locales_store.locales.entries.Lcz_AssignedAndChecIn))))));
    }
};
