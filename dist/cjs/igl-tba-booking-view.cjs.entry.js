...
const toBeAssigned_service = require('./toBeAssigned.service-c3133d66.js');
...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c0ae9a01403c92e543db53c030ba217e67ae246a' }, index.h("div", { key: 'a326162098383e14675a315b6d3adf9480623b9c', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: '7eb92d96c122e7474e301530d2bcb7a42eff47e4', class: `guestTitle booking-guest-title tba-guest-title pointer font-small-3 ${this.highlightSection ? 'selectedOrder is-active' : ''}`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, index.h("p", { key: '28acb2f6031f248233c6d716ecc834811c780d95', class: "guest-booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: 'fffde39d8d1b29b3d5a286c71b4ec734dc0d423e', class: "guest-separator" }, "-"), index.h("p", { key: '6c733951e7be119c79aee7825434ba5d459dbeca', class: "guest-name truncate" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: 'a9f94b1a69ffdf98503a112d7e2b9b356c81ca9f', class: "guest-occupancy" }, index.h("span", { key: 'fa1cd9585a6ef1643b35daabc04599b08dba3a58', class: "guest-occupancy-wrapper" }, "( "), index.h("span", { key: 'c6563d26d15bb0e4ee7c7c27ed17dbe7c3025703', class: "guest-occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: '35f8e47c0170088fee46c7fbd761f81e13455376', class: "guest-occupancy-wrapper" }, " )")))), index.h("div", { key: 'f8321bd7f3b2a106db8b3da0bceb190051d9f3b4', class: "row m-0 p-0 actionsContainer" }, index.h("select", { key: '9d07d55aed2ed60b0f73e90786fcc466532ce7b1', class: "form-control input-sm room-select flex-grow-1", id: v4.v4(), onChange: evt => this.onSelectRoom(evt) }, index.h("option", { key: '44870b9fbbce418641096a61cd6f89e0ea9f1b6f', value: "", selected: this.selectedRoom == -1 }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (index.h("div", { class: "buttonsContainer bg-red" }, index.h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, index.h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, index.h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), index.h("div", { key: '1408402fddabf87bcf567613ea479e225fcd7161', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, index.h("ir-button", { key: '15626efc075385411cbdd6d1140173bbf1e47eac', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (index.h("ir-button", { key: 'b515f80411aec18fd847b520a6c0783dc1e6fe21', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), index.h("hr", { key: '3aaef12351f850ac76874bc565061099098c1976' }))));
    }
};
