...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '24db209169a3932e28dbef3880b29340ebc6bb02' }, index.h("div", { key: '38f1cc5b40355306579edd5871b23f9f60069fad', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: 'dd50122ef84b7abfd47551b855901a2fb26d7981', class: `guestTitle booking-guest-title tba-guest-title pointer font-small-3 ${this.highlightSection ? 'selectedOrder is-active' : ''}`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, index.h("p", { key: '9d98de2946e74410ca496310429f968b7c48a361', class: "guest-booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: '3231190bf824f75266cc4006c85c36f4dfd4230d', class: "guest-separator" }, "-"), index.h("p", { key: '713db0558b5938e90319a074e6997eeebe054c64', class: "guest-name truncate" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: '5e5523eff22c79d173734cb877f976cc1a800305', class: "guest-occupancy" }, index.h("span", { key: '3034c2fde2946687725b049e5cc5cf4465dd0b18', class: "guest-occupancy-wrapper" }, "( "), index.h("span", { key: 'e6f6b03feadd22c94422a77f090f1e41cdf8c20f', class: "guest-occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: 'e8ed74c574e6300deba73a6d85bdd5069d904237', class: "guest-occupancy-wrapper" }, " )")))), index.h("div", { key: '6a0a43f3caa29bc6778e179102ebcc49cbb65b9f', class: "row m-0 p-0 actionsContainer" }, index.h("select", { key: 'e3a87f81b69422de670658d447aa7880c8f8ad71', class: "form-control input-sm room-select flex-grow-1", id: v4.v4(), onChange: evt => this.onSelectRoom(evt) }, index.h("option", { key: 'f7c94ef69a972572bb0d4de82c9927d9e107db03', value: "", selected: this.selectedRoom == -1 }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (index.h("div", { class: "buttonsContainer bg-red" }, index.h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, index.h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, index.h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), index.h("div", { key: '11eaf9e71ea192fc5f98d5d28596b47eee37c27c', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, index.h("ir-button", { key: 'fa4ac6402904bd672fbc5fe4aa28bb8aeb69d6fb', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (index.h("ir-button", { key: 'aaae32290a540ad8edfc9a9cd0f9d613feb4864b', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), index.h("hr", { key: '88777f6eb493a82a088e563a90ff8e110ba8ccd3' }))));
    }
};
