...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '407206572fb75939f566cbbcdb179965fabc2378' }, index.h("wa-card", { key: '26ecdae02deffa715baa5d2b852a9a16f82cab9b', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: 'caa60a846b4f8dfe414d2ceb34ff208bb5a8cf39', slot: "header", class: `tba__header`, title: "Click to assign unit" }, index.h("p", { key: 'b2d0033127ca97ccf5eb7a41d1bdd354a1d7d816', class: "tba__booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: 'abc7e2188813e6692a381317627e66a2aab73998', class: "tba__separator" }, "-"), index.h("p", { key: '6445a9a98d8420df60a5fecc3bc5635caed5dfd8', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: '647c6d854e40a5dbe70119871dc38d9debb2186b', class: "tba__occupancy" }, index.h("span", { key: '7c6afe7d13543ff4000044be83042f0fdc651d81', class: "tba__occupancy-paren" }, "( "), index.h("span", { key: '9232f43c8a850e31d25aaa359368edd23f93b576', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: '0fbc87ba899ab18b24e267c5d4b8c28fcd3c4aec', class: "tba__occupancy-paren" }, " )")))), index.h("div", { key: '073d73b3bdb1edf9797c3eb9adcbfbb8722b04e7', class: "tba__actions" }, index.h("wa-select", { key: 'fa8866f7ca3f1f29b5c2ee674465ceb519406f47', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4.v4(), size: "small", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, index.h("wa-option", { key: 'a70f5f3c5e3681421ba2b41775b8d80e819395d0', value: "" }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (index.h("div", { class: "tba__close" }, index.h("wa-button", { type: "button", appearance: "plain", size: "small", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, index.h("wa-icon", { name: "xmark" })))) : null), index.h("div", { key: 'ea0e4318f61a7e26cbbcde46ec176ad9dd5ef5b4', class: "tba__assign" }, index.h("wa-button", { key: '3c652977dde40fd26f293e78bd99e74f4e3cd930', class: "tba__assign-btn", size: "small", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, locales_store.locales.entries.Lcz_Assign), this.canCheckIn() && (index.h("wa-button", { key: '655e9079926f749ab2fd1b3404f26c5a4fa7622e', class: "tba__assign-btn", size: "small", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, locales_store.locales.entries.Lcz_AssignedAndChecIn))))));
    }
};
