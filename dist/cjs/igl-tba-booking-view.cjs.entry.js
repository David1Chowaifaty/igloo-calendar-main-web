...
const toBeAssigned_service = require('./toBeAssigned.service-609c17ee.js');
...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '62cf24a7e8dfc01c108676a07d03fa6fe450f994' }, index.h("div", { key: '4636d00865a93e54c0ec1222c08a2cc5d21316f9', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: '099de4a3d286ae04c70033094bdb88e445b9239f', class: `guestTitle booking-guest-title tba-guest-title pointer font-small-3 ${this.highlightSection ? 'selectedOrder is-active' : ''}`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, index.h("p", { key: 'ebb8d7610b6c21e84c6034c7d771a8a3c8f9b573', class: "guest-booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: 'b5ea7cd9a964ffda722e62a8d3ea5206fa474ce0', class: "guest-separator" }, "-"), index.h("p", { key: '7166eafb8601a647e8f9aa31883f68315ee42b82', class: "guest-name truncate" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: 'd65146ecaafcd45ce697f5954f3bc8741e492bb8', class: "guest-occupancy" }, index.h("span", { key: '4589b2a219e437e81fc45506cd105f0835f234bc', class: "guest-occupancy-wrapper" }, "( "), index.h("span", { key: '04bd0e77e75dcb56a271d9eb855598878ec66571', class: "guest-occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: '556930e9657a188e53668c6639943027ab934c21', class: "guest-occupancy-wrapper" }, " )")))), index.h("div", { key: '9dfbafba8c8ee28f122c1e19d17671fdb35dd6ef', class: "row m-0 p-0 actionsContainer" }, index.h("select", { key: 'c6addfdfe398459eee392f377a9d5641f18451bd', class: "form-control input-sm room-select flex-grow-1", id: v4.v4(), onChange: evt => this.onSelectRoom(evt) }, index.h("option", { key: 'd8076b4ff9ee5137d244784023f54b7f3055901f', value: "", selected: this.selectedRoom == -1 }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (index.h("div", { class: "buttonsContainer bg-red" }, index.h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, index.h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, index.h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), index.h("div", { key: '0dc6ba46cb09d089c26cf44ce952b17c3ba878cb', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, index.h("ir-button", { key: '1ddbe274619e2e6655f647269cdf18505de366f8', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (index.h("ir-button", { key: '996b931901c80e83c5cc92506066d42b285e3bba', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), index.h("hr", { key: 'f8372a29904457d35d299e2476a10919ea7a3a0d' }))));
    }
};
