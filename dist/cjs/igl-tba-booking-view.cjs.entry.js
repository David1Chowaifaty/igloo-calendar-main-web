...
const IglTbaBookingView = class {
    ...
    formatVariation({ infant_nbr, adult_nbr, children_nbr }) {
        ...
        const adultLabel = t.t('Lcz_AdultAbbreviation', { fallback: 'A' });
        const childLabel = t.t('Lcz_ChildAbbreviation', { fallback: 'C' });
        const infantLabel = t.t('Lcz_InfantAbbreviation', { fallback: 'I' });
        const parts = [];
        if (adultCount > 0) {
    ...
    render() {
        return (index.h(index.Host, { key: '828e67511ca29298527ab28ef15bfdbe4205eff0' }, index.h("wa-card", { key: '22eab65d9a5de635f055498629102834bfc0d187', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: '3e6f44f048e7d51777dd6f8b9be1066aadbdc80d', slot: "header", class: `tba__header`, title: t.t('Lcz_ClickToAssignUnit', { fallback: 'Click to assign unit' }) }, index.h("p", { key: 'f45963eae1bb32c9510a645df511f8cfcb355ac2', class: "tba__booking-number" }, number.formatBookingNumber(this.eventData.BOOKING_NUMBER)), index.h("span", { key: 'cfca24409df807b213bb2f0f284490d34e8651eb', class: "tba__separator" }, "-"), index.h("p", { key: '204f8f3c8c1127f1fbbd3be2e8b969c04b6535a2', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: 'ba2740b011585c1e77ad2d7aaf41eeb84a870c09', class: "tba__occupancy" }, index.h("span", { key: '6f5a6b6c382e3c4c9f41ebb5cf00654054075867', class: "tba__occupancy-paren" }, "( "), index.h("span", { key: '37ce441a15d322a08895308e484a0d4e71cc43de', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: 'b0ac05f36d24ae00a4d3d74c8c668c8d94184346', class: "tba__occupancy-paren" }, " )")))), index.h("div", { key: '88ce777ca238d64dae745674300566f3641e3e62', class: "tba__actions" }, index.h("wa-select", { key: '8f5de80b1c9cc20cf18c42beb965fa8bee194b4a', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4.v4(), size: "s", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, index.h("wa-option", { key: '4452fdc637f9eb21b7c247719a3b7e3b4a5ddb70', value: "" }, t.t('Lcz_AssignUnit')), this.allRoomsList.map(room => (index.h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (index.h("div", { class: "tba__close" }, index.h("wa-button", { type: "button", appearance: "plain", size: "s", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, index.h("wa-icon", { name: "xmark" })))) : null), index.h("div", { key: 'f2c176d4cf1f01b5f4a9839f8a657b8b7abfbfc2', class: "tba__assign" }, index.h("wa-button", { key: '80bb72a7e1f92de558696b2232d3186771fea764', class: "tba__assign-btn", size: "s", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, t.t('Lcz_Assign', { fallback: 'Assign' })), this.canCheckIn() && (index.h("wa-button", { key: '28fcfb6ad43eba1f291c7107780e648cf11cbe3d', class: "tba__assign-btn", size: "s", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, t.t('Lcz_AssignedAndChecIn')))))));
    }
};
