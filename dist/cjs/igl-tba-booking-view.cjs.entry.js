...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b5f5586a04039f834cb481889febfeb1df44cb2f' }, index.h("wa-card", { key: '600cfb6103ec96599d685d49b64c1cf7e5fc6581', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: '66d874f25147d68b90a1904aa5a5ec2dc704def1', slot: "header", class: `tba__header`, title: "Click to assign unit" }, index.h("p", { key: '407d06eda927d2bb7730c6094d660914e8f33bec', class: "tba__booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: '6a22ab31d78b65d3581a12c682f8bd69f07342b8', class: "tba__separator" }, "-"), index.h("p", { key: '84a750623679e60b259a901d625df2677cb23000', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: '40409d23a1e58ef7e46774f371bda967ba2ed3fe', class: "tba__occupancy" }, index.h("span", { key: 'a605c105a2100904cb23f21349873cd2f9d617a1', class: "tba__occupancy-paren" }, "( "), index.h("span", { key: 'f08c46440d6e498dcf334d3554be879bb814d2a7', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: '8712a6093baeaf5d3f5c94d5b142f52e1e2eb37e', class: "tba__occupancy-paren" }, " )")))), index.h("div", { key: '7357c9fd90ec28f36bdc3c71c4bec83c1be254f2', class: "tba__actions" }, index.h("wa-select", { key: '627e627856c5380fe32b672873233ed00749890a', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4.v4(), size: "s", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, index.h("wa-option", { key: '983fd52ccd9f232062360aa8ca97c428cd9459a6', value: "" }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (index.h("div", { class: "tba__close" }, index.h("wa-button", { type: "button", appearance: "plain", size: "s", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, index.h("wa-icon", { name: "xmark" })))) : null), index.h("div", { key: '72cd7b256fda75a5a498eb9be8e8147f9790cda0', class: "tba__assign" }, index.h("wa-button", { key: 'c22fa6c2c2a02f264c28aa7530abd7d35489dc8f', class: "tba__assign-btn", size: "s", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, locales_store.locales.entries.Lcz_Assign), this.canCheckIn() && (index.h("wa-button", { key: '1ff8c6b76931e7f461ff771c3dc008e79ce082e8', class: "tba__assign-btn", size: "s", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, locales_store.locales.entries.Lcz_AssignedAndChecIn))))));
    }
};
