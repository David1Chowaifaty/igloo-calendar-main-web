...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2e24d0723c16ed61cfcb5b28fc7e4bb614728d61' }, index.h("div", { key: '3aebf3ade8aefeb76f9cbeb1278d31bfb26af890', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: 'db89146377176492d5ed66e0893afc796dd74c18', class: `guestTitle booking-guest-title tba-guest-title pointer font-small-3 ${this.highlightSection ? 'selectedOrder is-active' : ''}`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, index.h("p", { key: '4cea4bf2d95c6309fa117c1a7e2b3fff13aba96b', class: "guest-booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: 'f22a9529c3c0cb2f9a2b765d22ea412075c77ee0', class: "guest-separator" }, "-"), index.h("p", { key: '1bdddb6eff2224a77bfbe24b10a219b91c737a17', class: "guest-name truncate" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: '27fb9a5cb1f84a711350ae40035b649ab57287c2', class: "guest-occupancy" }, index.h("span", { key: '4c3f29e5d82ff4e52082a9ff0e9ca5088d653036', class: "guest-occupancy-wrapper" }, "( "), index.h("span", { key: 'c0f85b113017d65ed463573bb3b9230f7d8fc1eb', class: "guest-occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: 'c1316a03b569ebaef456a8b978ebc70023447ce9', class: "guest-occupancy-wrapper" }, " )")))), index.h("div", { key: '3dd7d3d96a6defbe5f700248ac7d87642bbf6487', class: "row m-0 p-0 actionsContainer" }, index.h("select", { key: '5e210a817fce57d90e28785e16114cd253a0eb50', class: "form-control input-sm room-select flex-grow-1", id: v4.v4(), onChange: evt => this.onSelectRoom(evt) }, index.h("option", { key: 'f1d6a7ff209f0f110c8340c3480ab06aebb0868c', value: "", selected: this.selectedRoom == -1 }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (index.h("div", { class: "buttonsContainer bg-red" }, index.h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, index.h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, index.h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), index.h("div", { key: '1ac4fa15b489bfbedab083a108ac23d04771792b', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, index.h("ir-button", { key: '39b5ed49a7620baf3782ab6850cf63aa30ce2873', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (index.h("ir-button", { key: '4d859b8579fc5e50b44096419aecde24520921f1', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales_store.locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), index.h("hr", { key: 'bb84c27293609e96dd17cf9b5e45ea04c7144cb3' }))));
    }
};
