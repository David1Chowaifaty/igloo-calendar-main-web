...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '70e10cc267f1d13e71cb118593192af5e866edfe' }, index.h("wa-card", { key: '4c8e1839d40474a16160f8698db9df3f64ddb3d4', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: '61861b9b200d7d7797f0c2fa28c7dc9c4e7ccb2b', slot: "header", class: `tba__header`, title: "Click to assign unit" }, index.h("p", { key: 'e480a2a301659aedb26a59f263fdee7464cfc4e9', class: "tba__booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: 'e280a343271ec452a278d61e94897d4676fdc2b0', class: "tba__separator" }, "-"), index.h("p", { key: 'a56fb288d2c92d65f975284ffddb94f395e6c91b', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: '32e0e6017b355a38b3f685651f1b7d39a7002d56', class: "tba__occupancy" }, index.h("span", { key: '2dbecb54799f12e153433d2eb2bbd1f95888e3fe', class: "tba__occupancy-paren" }, "( "), index.h("span", { key: '9c8ca4d4eca660af2fe8ca3f8e1d681c123aaf93', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: '67243ecf74cedc3c65933f1701309fe32369fa93', class: "tba__occupancy-paren" }, " )")))), index.h("div", { key: '9750a5a800f2e8a95affc9bddba55ef0578876bf', class: "tba__actions" }, index.h("wa-select", { key: '475807d8dad2eec1d4fa5a2a3ee40e4cf49fe60a', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4.v4(), size: "s", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, index.h("wa-option", { key: 'e1c7dffcae472d20064d236c0e95df92571d1966', value: "" }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (index.h("div", { class: "tba__close" }, index.h("wa-button", { type: "button", appearance: "plain", size: "s", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, index.h("wa-icon", { name: "xmark" })))) : null), index.h("div", { key: '0acb2d8c92c82636c01bad53f5673ab6d41349e8', class: "tba__assign" }, index.h("wa-button", { key: '88e12516804ba7e278619702780f2226228df699', class: "tba__assign-btn", size: "s", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, locales_store.locales.entries.Lcz_Assign), this.canCheckIn() && (index.h("wa-button", { key: 'a6baab0d5a9f59e5fcffa765e0f622531746766b', class: "tba__assign-btn", size: "s", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, locales_store.locales.entries.Lcz_AssignedAndChecIn))))));
    }
};
