...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '87cea68a98616cee40bbb16a8bd7f03fca26cf41' }, index.h("wa-card", { key: 'f389c962b2e97819a5df9db5cdd2ecf263fb937e', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: 'dad33003bf247caf8f120cb211dc53e305e91584', slot: "header", class: `tba__header`, title: "Click to assign unit" }, index.h("p", { key: '9a77668fa95db68bf039988c29fdbb801781e656', class: "tba__booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: 'bfd5aabe0f8dd4822f18869c248e7e0b8e5b25fc', class: "tba__separator" }, "-"), index.h("p", { key: 'ac9f3875be31f9a846b2e0c144ceee3f39ec98e9', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: 'dfc825e27c5663896af72fdb3215c5436c0eb46c', class: "tba__occupancy" }, index.h("span", { key: '16d9b6f706c7f478cb59512d4649a1530052a9a7', class: "tba__occupancy-paren" }, "( "), index.h("span", { key: '6078b1a842331eed02da4e28f2017421e71170ba', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: 'd0e8a218425546ebbd603d1d83c7f0fa55b0f543', class: "tba__occupancy-paren" }, " )")))), index.h("div", { key: '943d594a1175ed804ba47d7abd2e238fb3945fcd', class: "tba__actions" }, index.h("wa-select", { key: 'f2e59f2415749be362b2d33e89e50b7bff6d7089', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4.v4(), size: "small", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, index.h("wa-option", { key: '9c9d6aae6f7e888a05bb8eac81b2a966da2d3f17', value: "" }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (index.h("div", { class: "tba__close" }, index.h("wa-button", { type: "button", appearance: "plain", size: "small", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, index.h("wa-icon", { name: "xmark" })))) : null), index.h("div", { key: '1c34714e00dcb51e44d446d0bdc8f90b8f4f709b', class: "tba__assign" }, index.h("wa-button", { key: '7d9b5cbdce6e3ca34778e353e634ac1185d9da40', class: "tba__assign-btn", size: "small", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, locales_store.locales.entries.Lcz_Assign), this.canCheckIn() && (index.h("wa-button", { key: '9fc7f74fe96e1d9977b6280cf1262204e39ec93d', class: "tba__assign-btn", size: "small", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, locales_store.locales.entries.Lcz_AssignedAndChecIn))))));
    }
};
