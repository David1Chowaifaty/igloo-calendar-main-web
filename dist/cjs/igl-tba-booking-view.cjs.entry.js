...
const IglTbaBookingView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '512a9e2442b7c49fd62c0121731b4b97838e4ab0' }, index.h("wa-card", { key: 'd691fe8ee04ce5f0c65972024d0a41249d9a2a16', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, index.h("div", { key: 'daf5a8454acc1d97fe9698945a24094d9deece0b', slot: "header", class: `tba__header`, title: "Click to assign unit" }, index.h("p", { key: 'a1551201a01adc4b16fc8a8c3e1c0e80c31c3d90', class: "tba__booking-number" }, this.eventData.BOOKING_NUMBER), index.h("span", { key: 'bb4822bf76ff1339c00dc5ac21705495aeeb2ff0', class: "tba__separator" }, "-"), index.h("p", { key: '86633e1490ee2b2f6be10ca0a1cd2eaca8030b5a', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (index.h("p", { key: '31c9f3be3c0b37f522d190e24ac7100b647d0f2a', class: "tba__occupancy" }, index.h("span", { key: '4f84292fdf2fae6e0af73f3144132d5556652c41', class: "tba__occupancy-paren" }, "( "), index.h("span", { key: '024bc4b095da882679728a59da0a7262026b51f7', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), index.h("span", { key: 'b8390f43bc44a7c26402aba8620a9e7704e1840e', class: "tba__occupancy-paren" }, " )")))), index.h("div", { key: '7bfcbd453e6de035bd0170891ff62fab759236fc', class: "tba__actions" }, index.h("wa-select", { key: 'dc4cf6afa087362d5328b94ce2933dab10ca2ac7', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4.v4(), size: "s", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, index.h("wa-option", { key: '12e2be64d405923fb9ce1483140c9f6bed2d970d', value: "" }, locales_store.locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (index.h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (index.h("div", { class: "tba__close" }, index.h("wa-button", { type: "button", appearance: "plain", size: "s", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, index.h("wa-icon", { name: "xmark" })))) : null), index.h("div", { key: 'bb442f87104ba460bb3f547186a3f5202c46b2d6', class: "tba__assign" }, index.h("wa-button", { key: '66f649ca6219f8e6140d30eb5bd52afc3feddc10', class: "tba__assign-btn", size: "s", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, locales_store.locales.entries.Lcz_Assign), this.canCheckIn() && (index.h("wa-button", { key: '1c4c706d7e9a5f20077a97ef14f1b4098c5fa790', class: "tba__assign-btn", size: "s", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, locales_store.locales.entries.Lcz_AssignedAndChecIn))))));
    }
};
