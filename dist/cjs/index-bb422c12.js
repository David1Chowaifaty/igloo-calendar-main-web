...
const IssueFiscalDocumentParamsSchema = CLAgencyContextSchema.extend({
    ...
    FD_STATUS_CODE: index.stringType().optional().default(enums.FdStatus.Issued),
});
const GetFiscalDocumentsParamsSchema = index.objectType({
    ...
    LIST_FD_STATUS_CODE: index.arrayType(index.stringType()).optional().nullable().default(null),
    AGENCY_ID: index.numberType(),
});
...
const VoidReceiptByCreditReceiptParamsSchema = index.objectType({
    FD_ID: index.numberType(),
    VOID_DATE: index.stringType().optional().default(moment.hooks().format('YYYY-MM-DD')),
    REASON: index.stringType().optional().default(''),
});
...
//# sourceMappingURL=index-bb422c12.js.map