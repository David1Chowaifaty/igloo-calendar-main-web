...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'e6240c5c9129bc9c128412dfb086847d8dae5d0d', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: 'a7f85cd32616ffb67cf351a760cb814abff135de', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '9d24ec1424160c17dda6e3aea65585aa63f46fbd', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '50036a683007aa844d86deabb0c51cd7c13dd806', size: "m", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: 'fad7894f85de996e986258e5502470f97c0af3bd', type: "submit", form: this._formId, size: "m", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: '06e470f5ae75aa50939747970ab0b63c658d334d', style: {
            ...
            } })), index.h("div", { key: '77c82a3e4674deaa511398cc6fd13bf024093f19', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'ef5d4d81028a2c4fc72692e67932ee616049c977', size: "m", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: '8cfe430028aac17b8faa9847d80256400b4b2338', value: "save", loading: this.isLoading === 'save', size: "m", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: '22916fc00e6f21b512aac278c39e27c1ff71a2f9', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "m", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
