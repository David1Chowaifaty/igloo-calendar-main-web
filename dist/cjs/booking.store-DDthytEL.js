...
types.objectType({
    ...
    language: types.stringType().optional().optional(),
...
types.objectType({
    booking_nbr: types.stringType().optional(),
    currency_id: types.numberType(),
    language: types.stringType().optional(),
});
...
/* INVOICE TYPES */
const GetBookingInvoiceInfoPropsSchema = types.objectType({
    booking_nbr: types.stringType().optional(),
});
...
const DoDayUseParamsSchema = types.objectType({
    language: types.stringType().min(1),
