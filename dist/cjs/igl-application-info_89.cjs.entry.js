...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4169417fc20c275a4ec848b47db306105237a94b', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '207b15239dbc35ef209f87a9766fc9672854fc0e', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '9a98e01b373d2f9c2ff0dc518ead31763fdcac34', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '19a40e11dd6175c64d1b6f957502ac808a3035d6', class: "fd-application-info__details" }, index.h("div", { key: 'd8f0c5247e9aaef1fc9bf53b0618ab63f7ddce23', class: "fd-application-info__rateplan" }, index.h("p", { key: '4219b032bbeb8cc3f91aef7ffca547811ef45f87', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '54a77c37d3c51cb3646014a301b8b764708d6ca7', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: '7495a4e3f811b5c58960bbc0e368d23a10edb071', for: `room_info_tooltip_${this.rateplanSelection.ratePlan.id}` }, index.h("span", { key: 'a98472c123acd291ea3a12d53d1a0040937050de', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'b868da4cffae0f2e024f756cb9ffccfd4f7392f0', name: "circle-info", id: `room_info_tooltip_${this.rateplanSelection.ratePlan.id}` })), index.h("p", { key: 'ee8e27d27227adbf4e57014951b8fcaa14a1419c', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: '34d1cc0eccf750025578f72d9a2fdf5cb767874c', class: "fd-application-info__price p-0 m-0" }, index.h("span", { key: '14a2e09bab02db0e9e29754a0b43cd11de9448da', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.getAmount())), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: 'c2e8c4e357ab0460bdddce86d112914d12dde9fb', class: "fd-application-info__footer" }, index.h("div", { key: '1edaee6891e6e9d9787264d0a36cd3cd5f3d6538', class: "fd-application-info__rateplan" }, index.h("p", { key: 'eb08c2b96c53c5d660eee2e45301d35d1d236155', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: 'ae09bc4ea94dc420e2fe8a56c844bfdae7aa8410', for: `room_info_tooltip_mobile_${this.rateplanSelection.ratePlan.id}` }, index.h("span", { key: 'a7d5fd5135b66b8b349f56f192b88568231aaecd', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '7ebd9cd2b4c9c991a626cb67d4926366fc68c778', name: "circle-info", id: `room_info_tooltip_mobile_${this.rateplanSelection.ratePlan.id}` })), index.h("p", { key: '99243be7972d50c8c5f2075c26f01195445f1abd', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: 'b65efbe9800a3601ec6f37a7538cd1f287e3c857', class: "fd-application-info__form" }, index.h("ir-input", { key: '8068d93bc4b0f3d3eb0102a09a00111ad5bf57e5', class: "fd-application-info__input", "aria-invalid": String(Boolean(this.isButtonPressed && this.guestInfo?.first_name === '')), value: this.guestInfo?.first_name, defaultValue: this.guestInfo?.first_name, "data-testid": "guest_first_name", placeholder: locales_store.locales.entries['Lcz_GuestFirstname'] ?? 'Guest first name', "onText-change": event => {
...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5f2bc36497176401550d17ca6ed584324b398246' }, index.h("div", { key: 'a5e4975eb449e0db85703765155d1b0a22a1e1cc', class: `m-0 p-0 mb-1` }, index.h("div", { key: '464722a11cc28beaa852a2ec3fd4b793a5bd102a', class: "text-left p-0" }, index.h("ir-date-view", { key: '4023f8f9cc4277363eb4abf9aaf9d6b81b86e5c0', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), index.h("div", { key: '554fe2e97198bc41443b1c5b776703bd472633fb', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { key: 'fcf1ce823ff52e724524268230c6db3dfbbd147d', class: "mb-1 " }, index.h("label", { key: '6e0bb4b8de52ddd1e754ae01362147d6e63d200b', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales_store.locales.entries.Lcz_Reason, ":"), index.h("div", { key: 'de22d73fd43e4618f13fb0f338ddc7963a025c7f', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { key: 'f8f888c91d7786657a2323a7602e1b2980b91071', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { key: 'd0244701a18577216aabb7bfbff0ae9f74b5d977', class: "align-middle out-of-service-label" }, locales_store.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, locales_store.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: locales_store.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, locales_store.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, locales_store.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '39e371b2107e21d5c597205415fc1f82f762ac26' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), index.h("div", { key: 'e2ec09ef725b96ddf9beac84a4d63aeb806aac7b', class: `fd-book-property__header-container` }, showSourceNode && this.getSourceNode(), index.h("igl-date-range", { key: 'ec9047bffb83d7b6c01eaf03ad9faa34b3d94c78', "data-testid": "date_picker", variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange }), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: '7889fb83a912c3e620577032a376d3c309a6e9ed', class: "text-right message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: '29bbb3d2a0a95e082fdcc75c6f58989a0a24df07', class: "d-flex flex-column h-100" }, index.h("div", { key: '770a47d94ffe0be0a66a814af893195f12a2b222', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: '4a4b150db09094ea66bc0cc664bd79ab7e77ddb4', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: '97daebae96cc446d1e6d55d9708bd57c0796a30e', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: 'a244f59a9bdd2b2bae89849044b38f12ca98a94b', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglDateRange = class {
    ...
    render() {
        ...
        //   </div>
        // </Host>
        index.h("ir-custom-date-picker", { key: '020f961ae5397008d5571912bfe8775969eb19f9', disabled: this.disabled, class: "custom-picker", minDate: this.minDate, maxDate: this.maxDate, onDateChanged: e => this.handleDateChange(e), range: true, dates: this.dates }, index.h("wa-icon", { key: '6f67b0290f69e842b3d5502ea4a99da80fd3b22d', slot: "start", variant: "regular", name: "calendar" }), showNights && (index.h("span", { key: '170663fa002e19b92e8f346bb3db5a3bc5266f80', slot: "end", class: "date-range-nights" }, this.totalNights + (this.totalNights > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1fd17c85e4b92c5699d6ee26de45df8078282f03' }, index.h("div", { key: '4f870039f2db381c02e79872a7c5d62b94b0353f', class: "text-left mt-3" }, index.h("div", { key: '3bcd054521c6ab16cd8f65a0ad1567e51677b41e', class: "d-flex", style: { alignItems: 'flex-end', gap: '0.5rem' } }, index.h("ir-picker", { key: '178b30a3bde82b4ffc03a80db2ad8deb51e58369', class: "bookedByEmailContainer m-0 p-0", label: locales_store.locales.entries.Lcz_BookedBy, value: this.bookedByData.email, "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email))), withClear: true, "onText-change": event => this.fetchGuests(event.detail), debounce: 300, "onCombobox-clear": e => {
        ...
        })), index.h("div", { key: '44b0317769c0728d2529241c5901fdb11a2c382f', style: { paddingBottom: '0.5rem' } }, index.h("wa-tooltip", { key: 'd9105cdd25a7e0a6cf05576195c4ff5f01caade6', for: `main_guest-search-tooltip` }, "Leave empty if email is unavailable"), index.h("wa-icon", { key: '617918f248a47adc7ff8902e72e6af3485d2a674', name: "circle-info", id: `main_guest-search-tooltip` })))), index.h("div", { key: 'dac85f6dc677f8b7c3e970e88ab31d4c572c36d1', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '0fe4c27416e89df8b9c29a4b0722eef5952e9419', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: 'e9b9356c241223a8b953f86146c57876937cdd2c', class: "flex-fill fd-property-booked-by__guest-form " }, index.h("ir-input", { key: '5e043eb0d70735bfadf3b0e79411cd48208ba6b8', "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.firstName === '')), "onText-change": event => {
                this.updateGuest({ first_name: event.detail });
                this.handleDataChange('firstName', { target: { value: event.detail } });
            }, defaultValue: this.bookedByData.firstName, value: this.bookedByData.firstName, label: locales_store.locales.entries.Lcz_FirstName, placeholder: locales_store.locales.entries.Lcz_FirstName, required: true }), index.h("ir-input", { key: 'e8119b52bb125f94cd7a10f544ae25b0bc48842d', "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.lastName === '')), "onText-change": event => {
                this.updateGuest({ last_name: event.detail });
                this.handleDataChange('lastName', { target: { value: event.detail } });
            }, defaultValue: this.bookedByData.lastName, value: this.bookedByData.lastName, label: locales_store.locales.entries.Lcz_LastName, placeholder: locales_store.locales.entries.Lcz_LastName, required: true }), index.h("ir-country-picker", { key: 'c83e9052507b37a3b9ca8dfb95978089b3705760', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) }), index.h("ir-mobile-input", { key: '7908e110234e00e1fc17ea28f6da83a69aef323c', size: "small", "onMobile-input-change": e => {
                this.handleDataChange('contactNumber', { target: { value: e.detail.formattedValue } });
            }, "onMobile-input-country-change": e => this.handleDataChange('isdCode', { target: { value: e.detail.phone_prefix } }), value: this.bookedByData.contactNumber, required: true, countryCode: this.countries.find(c => c.phone_prefix === this.bookedByData.isdCode)?.code, countries: this.countries }), index.h("wa-select", { key: '40ccfa6894dc7f1e4fe4e005574da51c1f99e2ca', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", "aria-disabled": String(Boolean(this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '')), id: v4.v4(), defaultValue: this.arrivalTimeList[0].CODE_NAME, value: this.bookedByData.selectedArrivalTime.code, onchange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("div", { key: '2cceef0656221a3f629ea590762d289a10be47b7', class: "p-0 flex-fill  ml-md-3 d-flex flex-column", style: { gap: '0.5rem' } }, index.h("wa-textarea", { key: '8ec4474d9e70ba34c9ab4a3fd58d65f46542923f', onchange: event => this.handleDataChange('message', event), size: "small", value: this.bookedByData.message, defaultValue: this.bookedByData.message, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 4 }), this.paymentMethods.length > 1 && (index.h("wa-select", { key: 'c5e6207b8291046558017e7c376da2c2fea5d7f7', label: 'Payment Method', size: "small", value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: '0b6b55e8009e528c1bdd95ddcfbf1c4b201f46f3' }, index.h("ir-input", { key: 'b899c6c22de4762e59a07e5fa1e42b4665bf344f', value: this.bookedByData.cardNumber, defaultValue: this.bookedByData.cardNumber, "onText-change": e => this.handleCreditCardDataChange('cardNumber', e.detail), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: '63f8137bcf1fd829a62ae3097a76b133b452cbdb', value: this.bookedByData.cardHolderName, defaultValue: this.bookedByData.cardHolderName, "onText-change": e => this.handleCreditCardDataChange('cardHolderName', e.detail), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: '71e0b6f1ad07ead371dca0d5415aa28f4bf4a091', "onText-change": e => {
            ...
            }, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h("div", { key: 'ffb82d6a414d8cceadfaf0f0671ed7f206f4cc78', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '9272237afdac6cc11d25dbdb06fd163a7d6898a3', class: "p-0 m-0 margin3" }), index.h("div", { key: 'f83be9422f9a46e97de7feb971ce46bb03319b80', class: "p-0 m-0  controlContainer flex-fill" }, index.h("div", { key: 'f7b2529a947095fe6835c28fdbc0160406c4e64f', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), index.h("wa-checkbox", { key: 'a37def81a8459ee064e461abe456c84834bf955a', checked: this.bookedByData.emailGuest, onchange: event => this.handleDataChange('emailGuest', event) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '4f56deb6ac2ebd3d02908f04db3406982300d0ee', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: '4af60caab0fee78177ee202f2d94b57e353134a0', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: '841409be592912df53fff3d42dcad06d8d74c292', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (index.h("p", null, index.h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable")))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (index.h(index.Fragment, { key: '2cc14e5e120af9ff64d6158fa673ea26dc4b1559' }, index.h("wa-tooltip", { key: 'e6ced321e02b4fe645c90db13990256492e4f0de', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: '7f895890c65c5a4dea45c0d3ee9ae4ed25357fc5', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '6e44b77b62f2c68b4cce5fa04770744869e0b318', name: "circle-info", id: `rateplan-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dfcec7d589967cab61474f9acc81c42d7d6992f4' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("h5", { key: '2237daac0a7033f74d5373dc7e6b94828a59bea0', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: 'afce846a7e2f9cf41b47f31b1b8e3f59cdb07d76', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: 'dfde1d7d5091ccf79c79e98f52895d242e90c43f', booking: this.booking })));
    }
};
...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (index.h(index.Host, { key: '22e22a653e668b371fa7d18921f386bb4be5fb53' }, index.h("wa-radio-group", { key: '8b96afd0d6c791e211603050cb70bc7c520f6479', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, index.h("wa-radio", { key: 'ec307fb7f1df06568efeb028427d172a2cea8173', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (index.h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, index.h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), index.h("wa-radio", { key: '111e2f9358bc975b68a1f61a5582686689bdc3b5', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name')), index.h("ir-booking-company-dialog", { key: '181abe6d5d93e34ac7e41527174880699cc86e2e', onCompanyFormClosed: () => {
...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '29924ee05781e1f399b004f8d238fc9721f5d46f', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: 'f02ef58a6799a2b97681ce346f428251d23203a4', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: '6ac805dc8e6cb7584c49c448cb639d4908e0a7b3', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '90ec31f57c0001e7ff6c6918ff567c30f1154a24', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: 'e6ab7ded88f105e389d0651089158d7bc3f64d10', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: '8ff2bc089247e4f0b836b71236dbd5df6cd4f12f', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-input", { key: '865ba8fb7ad3f49ac27b24096c64d5498d2332b3', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-input", { key: 'f6fa899ccc19837405822826c760f0c82dacdfbf', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '1ad49d3a85b330c4d846a6db47f083d260e1a3b5', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: 'c876eb865510f2ecbaa7b60861ee4f1fd732c396', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '4cfded467181b590d9eb2ce40a17143fef714f71', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'a56d9ea86766694bab58f2d7f0436f824965a9d3', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'b5eaf7f9c4663441868e37cdc43d5dad8034ff7b', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '76b0880a790269c2c4edf8329a4388cc15a6c134', class: "fluid-container px-1" }, index.h("div", { key: 'f505d5f57c50da9f4a4e19fe1cf2fd41dfa0831f', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: '8440bc0b6bbb2472b8eeb11e3ce768b88cffcee2', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("div", { key: '48948b2a63741ceeff140272c95384ecf7ac724c', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("p", { key: '4027c608039cac5339435e1c0babfe7a03ef876f', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("wa-dropdown", { key: '2dd61adc25d5637d681287d81d20e38d91a1d6a1', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                this.bookingStatus = e.detail.item.value;
                this.modalEl.openModal();
            } }, index.h("ir-custom-button", { key: '61669867f99e03863c622dd98a9896f6b90e9d7b', slot: "trigger",
            // onClickHandler={() => {
            ...
            appearance: 'outlined', size: "small", variant: "brand" }, index.h("ir-booking-status-tag", { key: '97aa31449096498abd945ff6bfe975725497efb4', slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", { key: 'eb8bfcbd786fe5b43ca71fa816d1c650a051b8eb' }, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))), index.h("p", { key: 'd971eff0b568e5c1aa1ff1fcaadbae5b61346ef5', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'a919d460a6e2fbe86eb3ac12574a9febe9b211f2', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'cd89c5ced61a3699e02718e181b30f8ae8f7ba7c', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: 'e7e92a8b06d0e0314cb58404b0787e29a096a01a', class: "d-flex flex-column align-items-center" }, lastManipulation && (index.h("ir-popover", { key: 'd43bceb57697e97b8177b46ae3eecc57864c35c2', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'bc17dac1a9732803eed8c5f6a65bfe315e8a2cb8', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: 'a70919fd80d289192356146a9cb66ac7fae3e8c7' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '2f547b40505c1769495e6e36676351a57087e684', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } })), index.h("ir-custom-button", { key: 'dadc0b519c987d856faafb5a2a38e2b14e0ee9ac', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), showPms && (index.h("ir-custom-button", { key: '2df4fdc389bd8e97718cf826d21f960b183e87b9', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: 'ae8112182d5b3ce432fcae57d9259c74a1878a64' }, index.h("ir-custom-button", { key: 'cc775d98d5b12cce4410a663755d00eb9bc63e2e', id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: 'b7b469f9560e1b5f289385718af42e0c777564da' }, index.h("wa-tooltip", { key: 'bc59a67b4ad1bb0c57f77cfd855b048929e758c5', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '31eb4454b7a1431b8f585b4f7877df12d84dba1e', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '351d59696ce78885f99308cca27972d36cbe19b3', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: '2e2159f3143f0dd69c14937c5f0be1d86bbe9242' }, index.h("wa-tooltip", { key: '63b7bd0d7e510338edf419c7e9df7086ac651be2', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '586be91e1a332758aeb107c70e26f2cc5b2c8be6', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '7273fb2db1ee74e51b96fb7186dfec1a472f0f2c', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: 'dce286979b781ee48d0200fa0e32197063a91e7c' }, index.h("wa-tooltip", { key: '0cdb2b9de6891cb09cc0c71d58cfab363c957a66', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '6ec977d5437dc9b7ecdf350b1fee8ae16abde7fb', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '9708bea792fda9c7574c0606f18ae0dc69fe0ba4', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: '48a60507e9498346f829a3485c87e4910dae4db5' }, index.h("wa-tooltip", { key: 'f570fab409ce2f8af8f91c3e521c6f0ff3b0f0ea', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: 'a215a9c9869f7113d53ef2444a2518b6e270aa0d', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'b776e521ecff46d78dbda2639bc1a76e16724d65', name: "list", style: { fontSize: '1.65rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: 'b29fc0cfee738c36bf5c02de63d7a43c96ffdaf2', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'db2cba1e8cafea3d1e0fc7625ddb6cdde0744cbe', name: "xmark", style: { fontSize: '1.65rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '6cb7b6ae6405717a6606b53089a5b3abdd0018bf', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: '94bbd2b79be59641ddfeed3731f0b318b1840f48', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '3ceeffdf45a1dde7b37bf16eb249352ac4d376bd' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: '87b8af4693eac98c4b4319148c635a5bfaca64ae', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: 'af3073497f65831d079a9ba4dca7fcb950e89fdb', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '4bdf9c0473ac5a21f68b967e8253132f95f7ae32', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '922097674808ad8d51b56db5171c1102aef87c2e', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCheckoutDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'de39dc8dcc6ea0c4eb375ebf49b5b48d3caa293f', open: this.open, label: "Alert", style: { '--ir-dialog-width': 'fit-content' }, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrCustomButton = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8d0c39f199e3da00a72a1ca7f13d841d0b5319d4' }, index.h("wa-button", { key: 'f475edbcf270935579aa62bf438433703b09fb1c', ref: el => (this.buttonEl = el),
            /* core button props */
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0fdef035afd988585dc2c863c80bc082174ad11a', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: '64e06ef2d4e02e440d75f29b1f6cc63211f985b3', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-input", { key: 'ef15ae0f638f04aaa494bc3bfb569aa2709120f7', disabled: this.disabled, placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", defaultValue: this.getTriggerLabel(), value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: '4c8401f418a2f64fb8484cc5b50697edc7cda47b', name: "start", slot: "start" }), index.h("slot", { key: 'dbdb66c05908945a1831d3d18dec908178e3031f', name: "end", slot: "end" })), index.h("div", { key: 'bf76c39740fd2b83d20a2199484900d52031fad4', class: "picker-surface" }, index.h("div", { key: 'eb0293cbd2ac023ce6254c6b5b9ae0a96ac28bd7', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: '9511b17baffa9753d3c57f933384ade7e67d962c', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '45f39f4c56d70dd358eb39de2baf2f5da3af3869', class: "d-flex align-items-center" }, index.h("span", { key: '16a48c0a3426c682c22295c4adea99d05c39fc64' }, this.dates.from_date), ' ', index.h("svg", { key: '9d77b4a3da8777be1016b84b526231fb2fc8218d', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '3f33b438459cc14f4f11cf79c523846967f2dd7f', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '49eb2634e47c83439dc92bed684876e554661bb6' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'a5e050f4c6129ad347efcbfac897f74f3d705120', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDeparturesTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aed9b0fb479e51cb9068eb535d1f77f3c658a03c' }, index.h("div", { key: '362192efaf40626f3aa2c056ea93ffd4bc4bf822', class: "table--container" }, index.h("table", { key: 'ef3cc6e486e5cf46095f6adbd91475b1703e4002', class: "table data-table" }, index.h("thead", { key: '9dd9706acfe3e16f1654ef7b26df127f5b11f1f7' }, index.h("tr", { key: 'eaa285208c7ee9e305a3e729ba0ba7752249486b' }, index.h("th", { key: '522d76f3e83fe783fd27399aa461e2e37cd3e6d9' }, index.h("span", { key: '37c17e98ade03c4b8d7544d54f53bf2df61b3042', class: 'departures-table__departure__cell' }, "Booking#")), index.h("th", { key: '08c35e79478dcd92469a3bd37e1125fef8f79805' }, index.h("div", { key: '4ceae1d7ea7bb42a1551787a538a2417ca51e8e6' }, index.h("p", { key: '2e54836a1dc86455e20a326f9a1d6032a1068da2' }, "Booked by /"), index.h("p", { key: 'daa957b96e03062d39312f7313ef6db21d3bb1b6' }, "Guest name"))), index.h("th", { key: '54a2f7bb2c693cdd0bcbde390772897decacf982' }, "Unit"), index.h("th", { key: '045c40ded2d633852b9e72d0b85c38d4d80923c7' }, "Dates"), index.h("th", { key: '0f4485d3b1339f56027e47b059c6bea5cf5e48f9', class: "text-center" }, "Balance"), index.h("th", { key: 'a35d6f9e725af06e8903a0a44c3beda45da4767f' }))), index.h("tbody", { key: 'd25520a7aa7da2ea2be9d788420829b92f81629d' }, this.renderSection({ bookings: futureRooms, isFuture: true }), this.renderSection({ bookings: needsCheckOutBookings, showAction: true }), this.renderSection({ bookings: outBookings }), !needsCheckOutBookings.length && !outBookings.length && (index.h("tr", { key: '4e402dac8189eb57b3b0954792e029745f0fb0cd' }, index.h("td", { key: '568935c6b756282638431842fe6d9987fb062540', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '0f7a54e9b2e5917f6fbcb2cd314f5a390198ca85' }))))))), (needsCheckOutBookings.length > 0 || outBookings.length > 0 || futureRooms.length > 0) && (index.h("ir-pagination", { key: '4a2bcc305290f9d045f2e6bf55669976647d4e14', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) }))));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '69fd57db345d237ad9e89db4c64e2d312a64b67a', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: 'b3374a4743daa04a476657dfd063961f35624601', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '501dfe83d9c9e4e3bf9ab5a997f207894446f38a', name: "label", slot: "label" }), index.h("slot", { key: '9b67d11c8f0e71570172a1081c0aca8483c289ad' }), this.slotState.get('footer') && index.h("slot", { key: 'd2cb9697a5caf2d4cadc2d0a8b3acea25958dbf7', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrDrawer = class {
    ...
    render() {
        return (index.h("wa-drawer", { key: '52c655ae297bcc49713c57a89322e4f234d6ad8c', "onwa-show": this.onDrawerShow, "onwa-hide": this.onDrawerHide, class: "ir__drawer", style: { '--size': 'var(--ir-drawer-width,40rem)' }, open: this.open, label: this.label, placement: this.placement, withoutHeader: this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '1d94a9bf2d220ce8ac9c2ff8a1d272b3144d7d3e', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '315762e59ce49fddfb8a643f85365b7c3e233375', name: "label", slot: "label" }), index.h("slot", { key: '3997ea4bf9bc66a3291d17eb1deeafadde8b6a8f' }), this.slotState.get('footer') && index.h("slot", { key: '7ddaff6af2a06e791115229f0481a04d0acb7b9a', name: "footer", slot: "footer" })));
    }
};
__decorate([
    OverflowAdd()
...
const IrEmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: '08991885d5735949c57451379890074b99987e28' }, index.h("slot", { key: '6f147d8c258bfcd76317a8fa4c127332a8811fee', name: "icon" }, index.h("wa-icon", { key: '35588a7e17c7fc836a19c335df16b03c727a369c', name: "ban", style: { transform: 'rotate(90deg)', fontSize: '2rem' } })), index.h("p", { key: '7b2d0868ad52df3569a3225e86f16f8c6ba2126a', part: "message", class: "message" }, "No records found"), index.h("slot", { key: '5b07dd2e2e9acdb99bd5a3ffbd06c55cf13b6fe6' })));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'baa6bfbc9ac57be93b94f4432517ce69a532c81f' }, index.h("div", { key: 'ea8c3ec69b4e947086696cee735431c613e0d20a' }, index.h("div", { key: '2d039849b3cbb7418ff20b8dca9cc0716f54eddd', class: 'extra-service-container' }, index.h("p", { key: '15f22212cf7493e57623b4fe09b2eafa15135b7e', class: "extra-service-description" }, this.service.description), index.h("div", { key: '8ae4eb4c57ee0d6ae747afe2783c7d6e6ad9f0a2', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: 'a98c3aa8615c6856244c806e594cd05c2c10435d', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: '294f0eb3a7bc67a1d1512e55d2588d6798315cca', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '11d274854cb0f57c027eeec02b39f538b6dc2a2a', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: '238b15e751deff15d3f7f7c6e82e0ba81413339b', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '9ca71e196db8d7a04576556b7a8596800d04414f', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: 'bb9f33aeef1b63e106e5e548acf83fa8f2fdec86', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: 'b1bfc9e8c22225f0362aed9985016322c9a60971', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: '0cb532016aa0f2475bf61933e9893677462080d7', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: 'ffa9fa395cc0593796625a39d8d8c2251c0eebba', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: 'cea740aada9e7ff0dd898c6bd354936865983315', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: '0e860f235bf45e98aac66b4090f61eb537f93faa', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '0a352e1b02785324d8b8d3c36a3e4b29ddbeb298', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '130c62d02a788bbf178dc839b4437310aa0df442', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'd2c49a78a75ad62202b0c87dd3d1fd8edaaa6d4c', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '232da336356dd0f32156c78a96187727fa5a5d3a', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: 'ec171d3d4d585aebb7e0014831df588c10f84017', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'a18ffd85b729c9544f2bc0f2379e9ccc0af79a9a', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'bad4b2e1bc76050681f8e50893732e1aa5074f92', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '42a2153e5896154c64cef2351f613c23b8409aeb', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: 'edf1ad1441addc716acf762317d01f5463f2425b', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '1ca465629dbe1be957ccd0092a827f34e9eb2dd8', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: 'f1e136b0f91a90cae2c2dd1346ed28d9a2d1fd82', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-custom-date-picker", { key: '249bc6b02bf4e2d52d294656f450344d1e130019', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: '3ed8f9d91d6b68c3c1aef5c02ff06c0bc26730de', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'b3f948c04088bd05239af0ea22ad947858156b35', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-input", { key: '41a746bfb12a4c04142aa054b6ae8d1b82b4855c', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: '60a84939b72f23aea28ff6a4053123f06f668850', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '5d671d88c00c5af05995d70e0423d2bea189e6fe', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: 'e43e8fe0a358c3060e1708e05683f77f1e190e1f', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: '27187e9033851ad62b01e9ce5fdde133c512d98e', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: 'ffca066c39b372ca9c958968aff7fa24a792b72d' }, index.h("wa-card", { key: '662383bbc33a5f68d445d91edc875a37aac091b9' }, index.h("p", { key: 'ed63c598f343204d56ee1ed0e906e8092808e460', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: '9c809b47ae4aa9a0f1867efcf547192593d3405c', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: '6706bf53422b6cb4994f80b7148356eabf62bb81', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'b1bb1b93e453c489089dc0f4323a86e7c75e87ca', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && (index.h("div", { key: '2bd893ac52cd7e2121bb07dc56434653f162bae6', class: "text-center p-1" }, index.h("p", { key: '2c11bb6cd49ae92070515d8f70b056d5607dd9ba', class: "text-muted" }, "No extra service recorded yet"))), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'cecf8374006426b778722b4324ee3ca2e6b0d33a', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (index.h("div", { class: 'loading-container' }, index.h("wa-spinner", { style: { fontSize: '2rem' } }))) : (index.h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), index.h("div", { key: '9a73bf92a5724bb0095bf1436aa8c63e330213ba', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'bb31d69e0f4ff93254965262d3b55915b6a0a9e7', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '3e856e79795cd5a68ddf9d0148849a952b6f1a4a', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrGuestInfoForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '659c2f9f84419f44d6ec0439c9b73bc2a14a704e' }, index.h("ir-validator", { key: '92195626b42acaf019fc64aef09f226b851f9575', schema: guestInfoFormSchema.shape.first_name, value: this.guest?.first_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: 'f86e36eb8abb5f4e01790e420ce86e07d67a74d6', id: 'firstName', value: this.guest?.first_name, required: true, "onText-change": e => this.handleInputChange({ first_name: e.detail }), label: locales_store.locales.entries?.Lcz_FirstName })), index.h("ir-validator", { key: '00cf761451ca974af9f74ee5249cc86db72fa72b', schema: guestInfoFormSchema.shape.last_name, value: this.guest?.last_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: 'fae347948b6763db415f7c55ba0b1cfe5a855970', value: this.guest?.last_name, required: true, id: "lastName", "onText-change": e => this.handleInputChange({ last_name: e.detail }), label: locales_store.locales.entries?.Lcz_LastName })), index.h("ir-validator", { key: '58606d383c050f8313340ab39bd9112dfb6858a6', schema: guestInfoFormSchema.shape.email, value: this.guest?.email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '05d44cafe8de52f0b7b0bc54c5ece38f5a28868f', label: locales_store.locales.entries?.Lcz_Email, id: "email", value: this.guest?.email, required: true, "onText-change": e => this.handleInputChange({ email: e.detail }) })), index.h("ir-validator", { key: 'e4a960a0f02d2fac6d73b99ad7aa6091010d8d75', schema: guestInfoFormSchema.shape.alternative_email, value: this.guest?.alternative_email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '8d3d25df58e9f7d0d84dd86c7c57ce7e1972fde4', label: locales_store.locales.entries?.Lcz_AlternativeEmail, id: "altEmail", value: this.guest?.alternative_email, "onText-change": e => this.handleInputChange({ alternative_email: e.detail }) })), index.h("ir-validator", { key: 'bfb9fba8942755af4c693cf7db8d0169d9336aac', schema: guestInfoFormSchema.shape.country_id, value: this.guest?.country_id ?? undefined, autovalidate: this.autoValidate, valueEvent: "countryChange" }, index.h("ir-country-picker", { key: 'cea5e7f00910c67eb8eae6b7014ac2156c0cde0b', size: "small", variant: "modern", country: this.countries.find(c => c.id === this.guest?.country_id), label: locales_store.locales.entries?.Lcz_Country, onCountryChange: e => this.handleInputChange({ country_id: e.detail.id }), countries: this.countries })), index.h("ir-validator", { key: 'b3583cd3a5eb11ce87fdbdb1e182eafb99cae8d0', schema: guestInfoFormSchema.shape.mobile, value: this.guest?.mobile ?? '', autovalidate: this.autoValidate, valueEvent: "mobile-input-change" }, index.h("ir-mobile-input", { key: '1df76102e518c6898042e42946844ba74dc43e18', size: "small", "onMobile-input-change": e => {
                this.handleInputChange({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => this.handleInputChange({ country_phone_prefix: e.detail.phone_prefix }), value: this.guest?.mobile ?? '', required: true, countryCode: this.countries.find(c => c.phone_prefix === this.guest?.country_phone_prefix)?.code, countries: this.countries })), index.h("ir-validator", { key: '927f9922f910a1c15bd6d9d094128a45d6ca9d07', schema: guestInfoFormSchema.shape.notes, value: this.guest?.notes ?? '', autovalidate: this.autoValidate, valueEvent: "wa-change change input", blurEvent: "wa-blur blur" }, index.h("wa-textarea", { key: '210b21a3894ba3be6cb5047f3e114604bb07433c', size: "small", onchange: e => this.handleInputChange({ notes: e.target.value }), value: this.guest?.notes ?? '', label: locales_store.locales.entries?.Lcz_PrivateNote }))));
    }
};
...
const IrInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'db7f6aa17fc95ad2757662a625ae86e93c80ca6d' }, index.h("wa-input", { key: '9d81dcc1d92c8787ab4a532e50573638671774b6', type: this.type, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, onchange: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base" }, this.slotState.get('label') && index.h("slot", { key: '47051ddfa01fb1d020f10f1b1c4accc757201195', name: "label", slot: "label" }), this.slotState.get('start') && index.h("slot", { key: '6535922f04f7827d19c36ce060f2eeb40692adf1', name: "start", slot: "start" }), this.slotState.get('end') && index.h("slot", { key: '5f6b7673336ee9afa732c40df9b87c6a95e8835e', name: "end", slot: "end" }), this.slotState.get('clear-icon') && index.h("slot", { key: 'db2f3bf619c36f7fddcbb42ec331597f9a250caf', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && index.h("slot", { key: '540deea447c0f7ff8ec3e03a0ec42ec6bb190f76', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && index.h("slot", { key: '6107c4f57e91aa189d723c5e385f92b37b3271d8', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && index.h("slot", { key: 'd9113c78960930cd36593003e6615cf1e2c29f9b', name: "hint", slot: "hint" }))));
    }
    static get watchers() { return {
        "disabled": ["handleDisabledChange"],
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'eeda11dfa1d8ae2c7c3607e923c9ad7fe8b3fdda' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '4aba42f14d35eb7aec0c0c3155e58e8251bd2d41', class: "loadingScreenContainer" }, index.h("div", { key: '85968058a2d9b501f1f53ea2938b501a7d1b1a8c', class: "loaderContainer" }, index.h("ir-spinner", { key: '8e7b78a2dbbee21cb0cac9c989994a0f24b823d9' })))), this.showModal && (index.h("ir-otp-modal", { key: '5d8f2a691f701708d84554adcf338be14a15bcd9', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2619dfcf4cb0a13a3010e152236ff7d04fe9ed01' }, index.h("ir-drawer", { key: '5522d030e25ea7daa61ce71ef541e5b3c54f67df', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '425e3dcc18071c2ad8d6e011cbf1808c481ab8e3', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: '26bb862eac2955eed4ad0cdc2afd5a8531e06223', onchange: e => {
                if (e.target.checked) {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: '8c97426b9d24430cb57942672f9437a9b7514b4c', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '943b9003dbe721ab314dc2ef08654b3d747584e2', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '179d548c76f8e5d18c88120742a658125e9036f7', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '5e7c202dbf199b111c1989abcee368761ce81295', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '8b77dfe9e9242ffb3bfe32004a8b84e40705decf', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: '226753cb7a589d2d3c7d26495a0cc5f76bb957be', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
};
...
const IrLoadingScreen = class {
    ...
    message = '';
    render() {
        return (index.h("div", { key: '92fd07deed9d56474d2abc300d7aac8d2ce6eeb6', class: "loader__container" }, index.h("wa-spinner", { key: '1524c227cb5ebac15db5aff9281d4c9c4c07ba48', style: { fontSize: '2.5rem' } })));
    }
};
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1a83b718cf0986f0ff5f8d58ff572701810ac643', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: '03957b5e9bb0a592520057bbde686daf05afc64b', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: '6a8580fca1ca63b9d795fe7fa3912f3167e7b89d', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: 'f639a54bc49f21144ac4de2544e655c26d983576', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: 'ad933fcf93ba37e5d4dfd4119d68e849e5e8ba69', slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: '69a11487ec036967138d1ecd96ba1155829465ca', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: 'a5f89637e79563a244386b09f0d777229653bbe0', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: 'b4fb778ae403e393b413a32ffb2a3364bd40e5da', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("input", { key: '5835a808b35f34d2e5f13f7a665fa1ce8224520c', ref: el => (this.inputRef = el), id: this.inputId, class: {
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4e2a1596bd15e751bd0accdb97a780cf20c83748', class: "otp-input-container" }, index.h("div", { key: 'df0eb383d643464c42e9299014c96910ea241502', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '571e39077adc0ef426f5a9e439f532aea27e13f3', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: 'e3254f1fe537dd6e8c374cdedb5dc4d97e74c162', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'e49f57c8a96203984404eb83c53b544fa775c2b9', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '00dde7ae9a4644b599361d3690df74c7f4c783c3', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '5fea0e51a24a9637a19ee805172c69dd0774cfa6', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: 'ee67951c4383d73096d445abeb096bc1980a10e7', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: 'b27ec6952d0c9952843f9ed6245256eb0c9317d3', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '502abbdb0b8b39dbfca6b0899d8396bd50200d3e', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '5cda900e2e730141201c0f8f6d595dc6d33ed745', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'f2a832d6d09b0ab4b653d4d78fced792f219bebe', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: '1ac1527afdc7a2e6ca1ace8845f49d7fa2f5197a', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '1ba3af1add3dc71e715482154c5c21d2a9aafd8a', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'a93d767a16a01917b128a3c78134a5e1cf11dcca', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '007532bc5523bbff1f2cdda3057d7ab236b0d8ba', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'ea0cff66c3c552de2536b7ea0a6b6caa8a71644e', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '0e069e361f8c847b4f588f1ca690107bbe734ed5', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '7c637058a6525c370eb0bf25bce8895bd7a65603', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '7ab379e0d17e7affa9f157311da7ee1c05533cf2', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'fbca15196221d56ca6db3168dd85017bc1abd5ae', class: "payment-item__payment-item" }, index.h("div", { key: 'c57368222344035a9bdbc86d1980e3dfb8ad8400', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: '5c7584aaed9588d7283ab13ccff6123a0c073eb8', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '3afb0270d51ef0670e563302c5c21afe3885107a', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: 'a77665af3d27b727816e16cbdb4dec0495baff6b', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'f08e39a1c112fece93c49b38d0a38a7a0e96d284', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '09552a9364f9ae7f926dd26f0ad56d6d96eeee33', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '89607a8e43ecb1b1096bc4aae7c7e97b44ca90fd', class: "payment-item__payment-toolbar" }, index.h("p", { key: 'f13db918fc0101bddecf085e1ed41ed028ab5a9a', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: '0ab6d0ad8e4bf7b31c523e14ce4f2db27d63c12a', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '0ebababbec508f9bcc642faf5d72a9985c9376f5', class: "payment-item__payment-actions" }, index.h("div", { key: '35bf1507cfe1e1b52fefe41f6daeb4f235da63d1', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: 'f9d6404b50d9af4e61eaa168c94459c952b9eb30', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: '9192ba654b2f7f64de68de18ec2366525c67ae11', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'afcb82e62ffc1a80b81ae75f7f06ca0319ae7e88', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: 'ac46d918afea94bb7865487476edba60eabf2a7d', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'f0921b5a6fefeb6463d38de06b9daa9b6a85bea4', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: 'caa274981696ac08140eb02686b40a61589454da', value: "receipt" }, index.h("wa-icon", { key: 'f146454073ce48c91975fcbed04b60d7dfed9ce9', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: '1a35eb22066f25971e59fa78352f3164c526b5d9', value: "edit" }, index.h("wa-icon", { key: 'e74964b120000dc403dea2912061cb57c70068cc', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: '040ac2e7a7b593c89efd3c5ec69821dfc7b9ff65', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '8709b411055a395f843994636d0078366bad72c0', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: 'ccf257c59baee715666c586b1424a35d4849df7a', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: 'ad0625eb6a193bd009ed2b115491e26e95a8d6e5', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '02d2415622144c9a4334d862b8b73058c9c7c593', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '7e5ff2867363b4dea66ccafffa6f79fb8d167aba' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: 'a5b040089a661adf5339432ab4b6196818856a76', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '4e2224ef23d236ccd80816c5efe2abc1aadd5248' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '4d980af014aa6cd342ec790a6bda7b944af10f30', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: 'e0c93df45456d9785966e674f48efa956e09258c', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '32a47ba545005ab4d9d25dc58d98873715108789' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '2fc28702b4f9e54afe66b34d95499eb072ae7609' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '758c9dfaa2d148c32fe7d9afa528cf2953130563', class: " payments-container" }, index.h("div", { key: 'f92457e333886c1d228f2a45ba5a84a6a3498020', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '96bfad9b2065b7201548e183a9904f1ae00001c0', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '2d74d6ca87cefaab51b7f64b7e89a1df8cf94605', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: 'd60051e06348933d7e9cd44dd821c3868ffff3f1', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '64d78f103bc58c046d420be50e208627d1b48485', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: '12410b37903aa6279fed2eb7f143d04d0ddedba2', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ba66c6cb1a057f864d08404452fbf986c39047de' }, index.h("wa-popup", { key: '30ad590f00ecdf0daf3b630eac9284605be641bf', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '300eb2242c8ebdb625573fe53792635ca2883fc1', slot: "anchor", class: "search-bar", withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: 'a9c7b9526a6121f51cb670491c6bb43e5e4f719c', slot: "end" }), index.h("wa-icon", { key: 'f85dbbc7a9a07a46f99f11606fdb3f0df1dce9d9', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), index.h("div", { key: '5e73ec45311d29f1bc1aef5cad98575edd88c695', class: "menu", role: "presentation" }, index.h("p", { key: '151bd84d58320271a00c20bc7981372468f63c81', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: 'b1c574d073cb383fd00a9f63691e72ae262b88d1', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: '3f3cbf61109abfab42b4ea3edd01f559f234e5e4', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: '14e0318056db73e91514f426dc67b79084db5b0c' }), index.h("p", { key: 'e83539f3edc3ca5d949603eaadb0330d40ce938f' }, "Loading suggestions\u2026"))), index.h("slot", { key: 'c66725d680599a7eba86005ec58d427a98d83d3b', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: 'ff84be6ea7d3e1c433b762960d3b613035578950', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: 'a57b4086b3b9914c601acef1425f517ae9f09fb0', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '05536e9b1b597f47f45064aeaa7376ca6a29808e' }, "No results found")))))), index.h("span", { key: '8169efdec8bb418b1a1bbc70d77a22875557c512', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '43ba22b3a7bbdd45f453d84dbe4f6688675be5cd', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '617317f3ea11a79488a5294ceb645a118031c7c4', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'c12c9ea574da6a183bdf5ec9ad2838ff34da5433', class: "picker-item__check", name: "check" }), index.h("div", { key: '1c9d11a009cfdd4d31952c9687fc3caed2587f31', class: "picker-item__content", part: "content" }, index.h("slot", { key: '983bc7fd02522753b92803ad245ab9652d0c1304' })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'efb4353ce87d015fee29e43071b24accc7ab9fc8', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '9fefad979b9a5b764f0e7d7ba524b552fa50d007', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: '112239cd3084154c15f0eb2840a2c475ea1b2628', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'a46ab5f861d5f836fdd731024d96f4540a921f1b', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '71c98c274d6e686a75d60e52115cee17749681d0', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: '37b4c9775f4095bf333bf9d41bc18223dde6db30', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: 'c21230af61e222bbbf8ff0841672bbf84d7063db', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'c7892f07ec74cb9642f679ecd606c47bbed7a8ad', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: 'd97278c21a809ae00756c493b631e0e0de042756', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: '56b34bcda57c40b1db43da65c3863e7f8743dce6', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: 'b1b205cc148c5b7bca62344034c308bb7ed01ec8', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: 'c8bed91f9222586594478614070646c821ed0d89', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '729c06dd5da47e116f8cca71ea87ae8805c52e8b', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '293e443cc0809755acd71693683d5614ab724483', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: '2246fddb555bace62ac22557320f597d4b7ff338', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: 'cf22df014ac96a1667c3ce48bd568481d9468777', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'e03a3efd54349b41a7f78a275f884d53a4d13516', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '3b5c03d5205c6a73283a62c33394c6dc0776874f', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'dcda88e34144dc69d80bb716763de9681bc41d29', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '109c80b04278e41198ef449d77c02545c0a8e826', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: '08bdf10055faaa877ec750415d955cdd5ad62664', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: '43434f170279f0086583a9cacc47be1ac87909b9', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7bf6f594bd37afd6950c76d879837ddae5f050c1', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'db6c2d49fed91c57890ac7a9dc24349fbe083012', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, !this.hideDefaultAction && (index.h("ir-custom-button", { key: 'dce040f64851cf891a9b989f4482ec472e1cdb4b', size: "medium", slot: "header-actions", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'bda6dff552d0ba80425358e6e4205a2b6fea0c47', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() }))), index.h("slot", { key: 'ef6545a6485f5968e08e3719d033baa2f0b6ded9' })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: '20fdfffd2d6640c81f09c5d9dafbfa9247220e68', class: "ir-print-room" }, index.h("header", { key: '95702519f9b0f2a40218c51b28794d4e18d1335c', class: "ir-print-room__header" }, index.h("p", { key: '09952ec4dd9e651b84428089a5a0bc8d2c3c4ef6', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: '681cbc0f260078f583117aced519ef73d18c74af', class: "ir-print-room__unit" }, "(unit ", room.roomtype.id, ")"), index.h("p", { key: '3dca19c6623fa026fd88028aae50f98afb9970e3', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: '32bb7898ecb0d99b05e75f4767e572b7140265f8', class: "ir-print-room__body" }, index.h("div", { key: 'dee651053e1529124120a89f560eeff107e8aeae', class: "ir-print-room__details" }, index.h("div", { key: '5a92fae22d143ea454f251b1815ef42d05c680ad', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: '4af2d012bfc68cc324db68130b9e7f0b95f95f9b', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: 'd94842d6a854dbc9022a34d40fa84979b88cbe38', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '378bee4acbea195a25f32b530b05901eaaffb2b1', class: "ir-print-room__row" }, index.h("div", { key: 'fc24d3c93b9a82206289b38314e1eeac0e5a0039', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: '82f5f312527293d1250a08f91d6572c062bb24a6', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: '049f4b883b56c5f0a221bb30eac3281477a1cb24', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: 'a5b3ed3a4bbd2d9716e0056ea806b6761002bae3', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: 'cccfff8898fa261400d472cf6e14e63d3db12855', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: 'faac6519644077cbae02ed213925a639994ab7af', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: '76c7cd6521947e2495cf1edf3e7c24238388b241', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: 'bddd2b4b521281913aec802aca58e55ae82d71bb', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: '264e97da678e0e6e5cc855652a8ba627909c17e9', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: '2dc40f15601770ae0b708a103aa4a438c6acbe25', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: 'acddc4fb063f4afa51444553d9ae5349fe8cd358', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: '17f0ce3af9b29e7acd1707cf14c9b5b82f673abb', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: 'a26e040cb32dfe4af0168b2ce60eef7ae66c3df0', class: "ir-print-extra-services" }, index.h("h3", { key: 'a4fa867e6dc0298a3d6a394f3fb482ab796eb479', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: '882ee29b73a0aa8b65bdaa0d53b519616b8f2f78', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'ebab26c14de00bc7eb967c9ac6c7dfdbb8903f0e' }, index.h("div", { key: 'c4209180bb6199d0c29875e66b7bcfc40322f5c0', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '4121ddfe4531b164f46339c0d80c6c0cdacb82cf', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '1dd3c11e52fda37c06e374331407cecd50f1d38b', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '69f8230bbd8b45d3340d575a0ab811e5fafaaf32', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: 'b71c75e155ae036d14c1cd985ec5c27530790b3f', class: "reservation-information__row" }, index.h("ir-label", { key: 'c8e6c1e33fa5398b719f00441ac95d37bbcee8ff', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: 'f17be37c0589834373fc65111ab640edced8f99b', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '62f43052131248fee8164f2c18881588af44e7a5', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: 'a818860285506a5ac80853d969bcc8f6c7a47898', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '43f0a1b4db6d4fa31c05651b17e6bf47a49117b1' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '3bc3c48f43d91a71a0e7a908b6366dd7b0ed6b28', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: 'c7499b1683651e9d4df6cf6213b16500d4b1f529', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '602af99e5875d7153e2fb561f84c502ff403a208', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '969fb9d0cfc3378dc219e672609feea4cb91739e', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: '464d28a76222515b0a29218ab5fd83314cde2480', class: "reservation-information__row" }, index.h("ir-label", { key: '69a09d06d49e5e228f7a76f83d0ec405fe700deb', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '0e5b256cbf04cc3823fe88f368057dc49c4df33d', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '9e58dd63f5bfe405495d7daa04cb27076d7d98b4', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '59ed7b5dce1089ce2b189c38ca5571a0e3ebaec9', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: 'dcdd40582df1685fac33045e8fba642763ff6d9a', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '35e74a1e6f8bb88b82a7e9a8c3fa42718e6566a9', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'ee85dcf900523f4c7fadeafc9a29258fd3af8be9', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: 'e435924d9cb6572e8de0ed8af1da1b75306a6639', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'cbde4c70bf42c8220053f8f14537e9b5fb5a546c', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: 'be6729105e07cbecb72d2fb03828447fdef2d2ae', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && index.h("ir-label", { key: '27e4e19712f7ad98024a04f16b4138d843b85a85', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'e8fdf85d0ea706a516245650500dabe500b428e0', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '66628c8b21468fe1568689b7bd8886d26b2d28cc', class: "d-flex align-items-center" }, index.h("svg", { key: 'cac184aa326310dd74d50e996048d920ac2efc36', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'fa1fc1ca365d98d6332336d1c6be602192350014', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'd1d883e0fd9d480ac31595669518c6e6e9631e12', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: '814b6dbcc59e23a616f5c1e2c5adfa92a2bdad6a', class: "reservation-information__row" }, index.h("ir-label", { key: 'd3e93382c3694a47228cbae5d4737f8a2066fb5b', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: 'be06f29fb55d146253e2b77838cff2888dbf671f', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '988a060791801eeed741dde270e2fe21661cc15e', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '71a3a671afb7d1d0e9ce6e198a85472301ffffa5', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '7ce9affd6e350d9597229a89456809afa7181635', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: '1f6734dc45def8eb9ef5688786fe53f281fb3c67', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f3b3e76dc8732e68512701a962134ae112bfc847' }, index.h("div", { key: '2036da3d7e5470aac1cef0c33ac8e3bfde504524', class: "booking-room__header-row" }, index.h("button", { key: 'aeee10b1096bf31e8f57d8a2a27c3fcad51649b8', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '8ca52f8f080d14deb7e4f975ff722b9242862b69', name: "chevron-right" })), index.h("div", { key: 'd83b1af19e76626f40a50d9223f7dbfd2ad75251', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'ad2b37c10af5dd41740933ac322f131113f6b1db',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '85ff04ca3513de2feaa7b2ff187bf942e71a55d4', class: "booking-room__summary-row" }, index.h("p", { key: '8d5a94f6ddc6850bb91cb2e896163daa105ceb02', class: "booking-room__summary-text" }, index.h("span", { key: '81ee115d9d8c3b97701c6e5ccecd78a89e17013d', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'fb77e5414c71d0e2a5ccce4a9160f598fade4bd3', class: "booking-room__price-row" }, index.h("span", { key: '4f7da5e867edb46ff7d1bacd755b5646202d0bf3', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: '7c335a0d0d24ad22d78802a832fc4f3fa07bd532', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: '099c8906633475ac82cbbde39c1962e5e01dd9a0' }, index.h("wa-tooltip", { key: 'e89a0c96d676c11a0acacffb71da5d3b91d81bac', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: '6b00d76915d437d1a102c069e4687ed885f123da', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '6af5e3367be4f1697522044722f9ec7a48017a01', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: '4e51d95b379b302154372d837fdd220e281ac5dd' }, index.h("wa-tooltip", { key: '6d9ed4f9408fe9bb52e4178a32ab87891af4c114', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: '5107e5305269f085c9d3e61127bec700a21ef6dd', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '19629996a7f0c13a526def45c8ca4b4d81c22c6e', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: 'ef317c5a0f65963e219ea080aff07c327fbd310e', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: '3f7246897731311bf666289df11ca8f386de61d8', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: '34666f502f636d8fbf8ab6ae3b0a83cdfce51d43', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '7e85c8128430172c40b1be15e9c627444ece723e', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '4a88863e10a77278a824215bc3c881e3146d497a', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: 'e002dbe24a34de715d96318e58dceffe22edded0', class: "booking-room__guest-row" }, index.h("p", { key: '60da5436435c2aa0fd1e4ba0848b1986b016f818', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (
            ...
            //   ></ir-button>
            // </ir-tooltip>
            index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '2f1646911c2006c22c566f5375c8ccd1fa9650e8', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: 'abbf916cf8d2fc500a069d44f805462f328aa698', class: "booking-room__departure-row" }, index.h("p", { key: 'e1de42ea6b3f324b0caabae1753a5fba77d14728', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: 'baa712353b91776011a9c51e336d152cd3596cae', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: 'ee7f8511987e77fee05e3ea035452342c96fb70a', class: "booking-room__details-container" }, index.h("div", { key: '42dcfcf882a1936b5f8b1e5f23b68dd6407edb35', class: "booking-room__breakdown-row" }, index.h("div", { key: '37c7a2b45fcffae8be862347565074e8e17f71ab', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: '379792f5012c79abae29aa5bf9ba760b20976c4d', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '0643a2d625a6ceb0790a81af02f381166c4d3de0', class: "booking-room__breakdown-table" }, index.h("table", { key: '9c0f4603e011bd5f50dc25499079c2a323030422' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'dc9bbb0bbc451d04a2c3e2551db10179e1f63c6c', class: '' }, index.h("th", { key: '03ddcb37694bd80708a301376b6da80e41fbbb7e', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '0a622d82a8cba6eb3909157eae9b1f3fbc1660ff', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '7efd1cbf7c27901ce4da210569e5922c4ac4e7ef', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: 'c4631e9ec88c82cee80ec5eaf489b21ceb04385c', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'dbc1b3f5560e4046a960931e233b6459456ef9ee' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '9a860ea742bcafe9d3a6c0ab996ee6fe65a5a4a1', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '647437f63fd64440e0b01adad88597e129d8984b', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '35071cc7f732e38433a6f12090129ca3a92d638b' }, index.h("ir-label", { key: '3cee0fcbd09a2f7f712c8ac4e28f033cc348a43d', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '8fbd04673a01c213734d5094e83915948c593a04', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: 'd9af20fbf7dee8646f9c7d0ea649418d65230f5e', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '5d54140c47addff758f7174207259bc2146c2885' }, this.renderModalMessage()), index.h("div", { key: '59a67400c9e87815c56174ae050a41954a41db73', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'e73ead4817b24f4e1fc61809298f3bf07787376b', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'aed36ae37cc4b9b050e96f0e85609a8d19bcf6a6', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: 'a16b122982c8d49e40d653a131258536e985eac0', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '5ae82e47f1aeb050a8afd9510b24317c338c490a', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (index.h("ir-drawer", { key: 'dc6fe7dce9e8884cbe1afaa1e67fdd51c2865f89', style: {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'de5c30266929011629f74c957716217009033ce5', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '0028c4226296f357b83d6c79c8afdad73188e42a', class: "input-group row m-0" }, label, index.h("select", { key: 'cdd4101fc693ff3e580dadee3628f3ccd5f52481', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'cf1f14cc825ef3e6da594870f396b6925bc03c73', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '25442078f538fb72d7b2ea49ebd73a5bac764663' }, index.h("wa-spinner", { key: '3d461c118e0e4a5de686e963ee113fa361c929bf', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '3d9f0fa350581ea728021081d92c2c0773c309a8' }, this.showTooltip && index.h("wa-tooltip", { key: '03b7d5e7915efbd22851b76fde0e84ebd29028f8', for: this._id }, this.unit), index.h("wa-tag", { key: '2d17bf881af8f4ac8dbfc78253fefa48d0fed3e3', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '7d1fd207002bd668ca78f3674c581d603c54152d', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: '11859f7b7839b959980a031a81f9ac60f176ac79' }, index.h("slot", { key: '4cd3bfe3a6c67e16e09dd68cd0878bc536abf187' })));
    }
    static get watchers() { return {
