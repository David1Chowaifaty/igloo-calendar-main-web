...
const IrChannelEditor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '565e15ddc3a33a9df8bb1beba810c4e5583e0a33', class: " d-flex flex-column h-100" }, index.h("nav", { key: '45959f7cc67f851d166e331d56aa196e7cf2a67f', class: "position-sticky sticky-top pb-1 top-0 bg-white " }, index.h("div", { key: '5c411ce9d99cdf0e5201c078db2d42f5086ed2fa', class: "d-flex align-items-center px-1 py-1  justify-content-between" }, index.h("h3", { key: '6ed1fc872d3c8905d22928dd37b1548635b99e76', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? locales_store.locales.entries?.Lcz_CreateChannel : locales_store.locales.entries?.Lcz_EditChannel), index.h("ir-icon", { key: '6e07b1ce4eee46600b227515778e5b787f356e40', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '172c35290eee5222a0cade4c3a80caf7ee7b7243', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '5922df62f6c4bbaa982af142a683c384a2e10033', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("ir-channel-header", { key: 'ceac35c1505271a803f1b3c3d31e6f7e3e4c17df', class: "mt-1 px-0", headerTitles: this.headerTitles })), index.h("section", { key: '5c26c8a122a114432e3557fca203a752a054a3b5', class: "flex-fill tab-container px-1" }, this.renderTabScreen()), index.h("ir-button", { key: 'a9302c61e16372652b77e21c859ccf217ad7f36c', isLoading: this.isLoading, onClickHandler: () => {
...
const IrChannelGeneral = class {
    ...
    render() {
        return (index.h(index.Host, { key: '98d74423af68beafa9eeacaa9d2cd098b4219abd', class: "px-1" }, index.h("section", { key: '9ee521af046ec0397819d643a71205c0e2312264', class: "ml-18" }, index.h("fieldset", { key: '6860a46b86c38a6759c23a0462815e3fdaf6afb4', class: "d-flex align-items-center" }, index.h("label", { key: '1db779f14ad504d530d8672e45e782bded9d84d2', htmlFor: "hotel_channels", class: "m-0 p-0 label-style" }, locales_store.locales.entries?.Lcz_Channel), index.h("ir-combobox", { key: 'a001c637748b72077012482f519b1ccb2923b44e', input_id: "hotel_channels", disabled: channel_service.channels_data.isConnectedToChannel, class: "flex-fill", value: channel_service.channels_data.selectedChannel?.name, onComboboxValueChange: (e) => {
                channel_service.selectChannel(e.detail.data.toString());
            }, data: channel_service.channels_data.channels.map(channel => ({
                id: channel.id,
                name: channel.name,
            })) })), index.h("fieldset", { key: 'e0ea1cc6e53f0e97db09032bfa96224518687bb4', class: "d-flex align-items-center mt-1" }, index.h("label", { key: '37e6acc747b869ed319356f0b0873d0453c1054e', htmlFor: "hotel_title", class: "m-0 p-0 label-style" }, locales_store.locales.entries?.Lcz_Title), index.h("div", { key: 'cb18e06362aba17c2323b35185d679f82a8f3f8a', class: "flex-fill" }, index.h("input", { key: '1c167979004b3c5696f4c5ab18f081cd057805f7', id: "hotel_title", value: channel_service.channels_data.channel_settings?.hotel_title, onInput: e => channel_service.updateChannelSettings('hotel_title', e.target.value), class: "form-control  flex-fill" })))), channel_service.channels_data.selectedChannel && (index.h("form", { key: 'c13f6649e3cf4ff6a83ca75b1e07b2fc1c6bc321', onSubmit: this.handleTestConnectionClicked.bind(this), class: "mt-3 connection-container" }, index.h("h3", { key: '97f7aceca10082f07251351a158b4d2caf21aeb0', class: "text-left font-medium-2  py-0 my-0 connection-title py-1 mb-2" }, locales_store.locales.entries?.Lcz_ConnectionSettings), index.h("div", { key: '22bf7a45ed4c07d4f62e4a635a8c0551a60f6e8c', class: "ml-18" }, index.h("fieldset", { key: '514962958a97286c0ddbed5dcdb6136e43c4c0cd', class: "d-flex align-items-center my-1" }, index.h("label", { key: 'b0677343e29a04170f8e63c7b2dc7985d48f7147', htmlFor: "hotel_id", class: "m-0 p-0 label-style" }, locales_store.locales.entries?.Lcz_HotelID), index.h("div", { key: 'a4ed0968b9dd0d69a1e25eeb4f76023a2ae7a486', class: "flex-fill" }, index.h("input", { key: 'df30b802ec7fa9c5971e287d8fe14e7a804f8809', id: "hotel_id",
            // disabled={channels_data.isConnectedToChannel}
            class: `form-control  flex-fill bg-white ${this.buttonClicked && !channel_service.channels_data.channel_settings?.hotel_id && 'border-danger'}`, value: channel_service.channels_data.channel_settings?.hotel_id, onInput: e => channel_service.updateChannelSettings('hotel_id', e.target.value) }))), index.h("div", { key: '4b94e41783588ed436ca7972f74822dbcc14246c', class: "connection-status" }, index.h("div", { key: '6e450fb74abede46da1aa607f87c768525f76451', class: "status-message" }, this.connection_status_message &&
            (this.status ? index.h("ir-icons", { name: "circle_check", style: { color: 'green' } }) : index.h("ir-icons", { name: "danger", style: { color: 'yellow' } })), index.h("span", { key: '541e43af6c8a1af79203fd6f730cae36f89da547' }, this.connection_status_message)), index.h("button", { key: 'bcb337c0566439aa2e732bacef44545cc61f578f', class: "btn btn-outline-secondary btn-sm", type: "submit" }, locales_store.locales.entries?.Lcz_TestConnection)))))));
    }
};
...
const IrChannelHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a7966725c1b7390f42acad1e3f1a433515a793d4' }, index.h("ul", { key: '45f684667c0ce99e7ab738ea874c12989c3cb794', class: "px-1" }, this.headerTitles.map((title, index$1) => (index.h("li", { class: `tab ${title.disabled ? 'text-light' : ''}`, key: title.id, onClick: () => {
                if (!title.disabled)
                    this.handleTabSelection(index$1);
            }, "data-disabled": title.disabled, "data-state": this.selectedIndex === index$1 ? 'selected' : '' }, title.name)))), index.h("span", { key: 'f73eed8f1e6131cd5d28e740371ca9ab8cd10773', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
};
...
const IrChannelMapping = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ec94504792885e06875464995a4cb00a401b402', class: "py-md-2 px-md-2" }, index.h("div", { key: 'dbd82916a216fdbf7b67739834c655c07e6dfa09', class: "d-flex p-0 m-0 w-100 justify-content-end" }, index.h("button", { key: 'b170404caa171d4b6f793b36209c70d5c87d513c', onClick: () => {
                channel_service.setMappedChannel();
            }, class: "btn refresh-btn" }, locales_store.locales.entries?.Lcz_Refresh)), index.h("section", { key: 'd68f4e7dc723abd65f96287e65828112eba70c66', class: "w-100" }, index.h("div", { key: '069f0daa1a3b24db984d1a7279e853fe6547675e', class: "pt-1 mapped_row" }, index.h("p", { key: '87e2925a33e5d3330b007c4512e044e57e8b48fd', class: "mapped_item channel_name" }, channel_service.channels_data.selectedChannel?.name), index.h("svg", { key: 'fcc1e650103de610f3ea9a9074a903e0fc595a66', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'cbfc873e37333784e63c337f780b52402f2fbb59', d: "M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z" })), index.h("p", { key: '42b8bf9de2238bf9f14f7fa40963c5aa43d802a2', class: "pl-2 mapped_item channel_name" }, "igloorooms")), index.h("div", { key: '2524240f39c4d5793119ef37961ab40966206ef8' }, channel_service.channels_data.selectedChannel?.property?.room_types?.map(room_type => {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3c0185447b1f3b214eefb49041b0aebb03d604c1' }, index.h("button", { key: 'd5247e19f8ced5f0abbdf65018c6bae2d1fa7d18', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: 'efc8da506e00a49077be45db4f83b120d34396da', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: '9ad1ed26bffffdd64ed0cd947e90aead393c709f', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
