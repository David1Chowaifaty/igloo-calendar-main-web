...
const IrMealReportFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: '13272631a85fb18efc638680de208686d5539707' }, index.h("wa-radio-group", { key: '1eca4b58f82d04f5d94a556fa76bfc8c7543d7ac', label: "Report type", size: "small", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, index.h("wa-radio", { key: 'fb96a40f061cb270e1ebbac63582ade7396e6aa2', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, "Guest list"), index.h("wa-radio", { key: '3925ab13077e72ae33acabb140abf7db057477e8', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, "Meal count")), this.reportType === 'GUEST_LIST' ? (index.h("wa-radio-group", { label: "Stay date", size: "small", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            } }, this.lcz.Lcz_Reset || 'Reset'), index.h("ir-custom-button", { key: 'b9dbb994459b5638cf8a1f9955741725c661c43e', type: "button", size: "small", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
...
const IrMetricCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '931ba17010b21bfbf18c8184ec8a6d0f6095d86f', role: this.clickable ? 'button' : null, tabindex: interactive ? '0' : null, "aria-label": this.clickable ? ariaLabel : null, "aria-busy": this.loading ? 'true' : null, onClick: interactive ? this.handleActivate : undefined, onKeyDown: interactive ? this.handleKeyDown : undefined }, index.h("div", { key: 'b88c08dd4ce940cd8a860af6d679404ab2be023e', part: "base", class: "metric" }, (hasIcon || this.label) && (index.h("div", { key: '03b35d044d14651028851d99b785c9cb5accc968', part: "header", class: "metric__header" }, hasIcon && this.renderIcon(), index.h("span", { key: 'adf6aaa84e2e9e3826f5c676ec5514fd1888d42b', part: "label", class: "metric__label" }, index.h("slot", { key: 'b1375445a6b0818206698f5d7e671217c222125e', name: "label" }, this.label)))), this.loading ? (index.h("div", { class: "metric__skeleton" }, index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--value" }), index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--caption" }))) : (index.h("div", { class: "metric__main" }, index.h("div", { part: "value", class: "metric__value" }, index.h("slot", { name: "value" }, this.value !== undefined && this.value !== null && index.h("span", { class: "metric__value-number" }, this.value), this.unit && (index.h("span", { part: "unit", class: "metric__unit" }, this.unit))), this.renderTrend()), this.caption && (index.h("p", { part: "caption", class: "metric__caption" }, this.caption)))), index.h("div", { key: '8a659e320e087ec6acabd4c01b59481fb41b1e98', part: "body", class: "metric__body" }, index.h("slot", { key: '6d01aad0fd762c88b4722a23d6cbae6b24712650' })), index.h("div", { key: '8a8c4def413d560e60e336ddf16a4fe16c620adb', part: "footer", class: "metric__footer" }, index.h("slot", { key: 'ad89b2d8689e5485317d7fd3e27089a0bf243752', name: "footer" })))));
    }
};
