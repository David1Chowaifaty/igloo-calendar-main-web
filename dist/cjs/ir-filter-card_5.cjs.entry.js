...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'bc4686654d2c762df6debc5849e1bf1b6df68d6a', class: expanded ? '' : 'filters__card__collapsed' }, index.h("div", { key: '838911a315a445532be3c3fb36cc3728ef4e5c53', part: "header", class: "filters__header", slot: "header" }, index.h("div", { key: 'a222128d5e9ebb254aa57a29604c859e943ef097', class: "filters__title-group" }, index.h("wa-icon", { key: '5b1d72de2cc1a4347cffa52d0df18386c5a55a6b', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: '699d5c4201925252f79c505f6e84636136d28286', class: "filters__title" }, "Filter")), !this.isDesktop && (index.h("ir-custom-button", { key: '926d6f8f16426c01cfbbea065de4612b411a07dc', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'ac729376c0d1a1c1741f5c0c9a98591f55478f80', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), index.h("div", { key: '80ce03487255019545b3d9273e5fbbf7dc3217c7', part: "filter-body", class: 'filters__body' }, index.h("slot", { key: 'ca10d09670d1d43902977c96a37aae923398eb60' })), index.h("div", { key: '8844dd2c68d35c504111fc69387ae9cd3c1b96de', part: "footer", class: 'filters__actions' }, index.h("slot", { key: '47f8e7de21cb8443a6a170afbacce6d3d9b33576', name: "footer" }))));
    }
};
...
const IrMealReportFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: 'b74f37108851b34ed99d75edffd1db242f75f72e' }, index.h("wa-radio-group", { key: 'c09991e03481ef75af7e2aa32a9e77afde6fadca', label: "Report type", size: "small", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, index.h("wa-radio", { key: 'f9374e57cdadbee7e9e6f71b020c9ab77d7b9771', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, "Guest list"), index.h("wa-radio", { key: '3a9be744559f3908fe57992547b85cafbe9ee1d9', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, "Meal count")), this.reportType === 'GUEST_LIST' ? (index.h("wa-radio-group", { label: "Stay date", size: "small", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            (mealTypes.length > 0 ? (index.h("wa-radio-group", { defaultValue: this.mealType, label: "Meal type", size: "small", orientation: "horizontal", value: this.mealType, style: { width: '100%' }, onchange: e => {
                ...
                } }, mealTypes.map(type => (index.h("wa-radio", { style: { flex: '1' }, appearance: "button", value: type.CODE_NAME }, type.CODE_VALUE_EN))))) : (index.h("div", { class: "ir-meal-report-filters__warning" }, "No meal types found."))), index.h("div", { key: '948a3f0fa3194c10bba4aea66ccfa0c69e689097', slot: "footer" }, index.h("ir-custom-button", { key: '8d280ceb6a2a5e009b589494c2e5927b19a64757', type: "button", size: "small", variant: "neutral", appearance: "filled", onClickHandler: (e) => {
                const ev = e.detail;
            ...
            } }, this.lcz.Lcz_Reset || 'Reset'), index.h("ir-custom-button", { key: 'd6ed86d781d01cbf86a6168b4410aec3d462c730', type: "button", size: "small", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
...
const IrMetricCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ed6c354e9e423c8a054784d0a1ad6bd089ef6f5e', role: this.clickable ? 'button' : null, tabindex: interactive ? '0' : null, "aria-label": this.clickable ? ariaLabel : null, "aria-busy": this.loading ? 'true' : null, onClick: interactive ? this.handleActivate : undefined, onKeyDown: interactive ? this.handleKeyDown : undefined }, index.h("div", { key: 'db7448c45c25c517676dde8e5ebcda70cf4ac51a', part: "base", class: "metric" }, (hasIcon || this.label) && (index.h("div", { key: 'a69a5b7711d63573620041d6fb2ea0242da063aa', part: "header", class: "metric__header" }, hasIcon && this.renderIcon(), index.h("span", { key: 'efb7341d377ed5c15ba3ed5c5c3b088b557f808f', part: "label", class: "metric__label" }, index.h("slot", { key: '619983bf7a8e9aeb0c14062d79bab4cc9b270dd0', name: "label" }, this.label)))), this.loading ? (index.h("div", { class: "metric__skeleton" }, index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--value" }), index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--caption" }))) : (index.h("div", { class: "metric__main" }, index.h("div", { part: "value", class: "metric__value" }, index.h("slot", { name: "value" }, this.value !== undefined && this.value !== null && index.h("span", { class: "metric__value-number" }, this.value), this.unit && (index.h("span", { part: "unit", class: "metric__unit" }, this.unit))), this.renderTrend()), this.caption && (index.h("p", { part: "caption", class: "metric__caption" }, this.caption)))), index.h("div", { key: '20732b53b4011b51c4697f01cd7bb8a35e4c2602', part: "body", class: "metric__body" }, index.h("slot", { key: '250399d5b7526f138b88b93711e75cccb56ef7a1' })), index.h("div", { key: '2341717fccc57a5432bb522b8274fcd7064ab492', part: "footer", class: "metric__footer" }, index.h("slot", { key: 'c241c875af05b2a4132a79a0a004b89814ec6d2e', name: "footer" })))));
    }
};
