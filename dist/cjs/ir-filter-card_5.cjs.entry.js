...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '1720c4081923a17eef82a80d4f7e33b668fd99c6', class: expanded ? '' : 'filters__card__collapsed' }, index.h("div", { key: '3218e4dcf5b018941deece79e58ff57857f4045e', part: "header", class: "filters__header", slot: "header" }, index.h("div", { key: 'cec7db05353903abebf17d4c0d80eee76214fd05', class: "filters__title-group" }, index.h("wa-icon", { key: 'bca79ccd0b7a61280d86985946dfbc8010b1f07c', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: '6ad96f4f774a81aa7c2d829fbbe852d40a23a3da', class: "filters__title" }, "Filter")), !this.isDesktop && (index.h("ir-custom-button", { key: '73d8c85cd02e0417122da839a829547b30061d43', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '56fe6c61349d6285a9dbffacdebe230170169b54', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), index.h("div", { key: 'f77a4a762c61ec608f6b8f837184775140dd25f2', part: "filter-body", class: 'filters__body' }, index.h("slot", { key: '14dfb7f937682f730cd105690f4cbecb390673e3' })), index.h("div", { key: 'aef1136a490f19281c8900ae23d0f578891dde76', part: "footer", class: 'filters__actions' }, index.h("slot", { key: '0b16472d20a5f7a8d6cad0552a4b27c0d2066790', name: "footer" }))));
    }
};
...
const IrMealReportFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: 'e5eb1f2e82c979f0bd8d9a89519a9a8093c1b2aa' }, index.h("wa-radio-group", { key: '0fdb8f154de0da146cfebd611e78e0c30752c89e', label: "Report type", size: "s", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, index.h("wa-radio", { key: '91177ce85d5fb6cc669cdde573981dc2785a3c30', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, "Guest list"), index.h("wa-radio", { key: 'e8ab9472f69c81cb73b96efe4bd9479a7c720864', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, "Meal count")), this.reportType === 'GUEST_LIST' ? (index.h("wa-radio-group", { label: "Stay date", size: "s", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            (mealTypes.length > 0 ? (index.h("wa-radio-group", { defaultValue: this.mealType, label: "Meal type", size: "s", orientation: "horizontal", value: this.mealType, style: { width: '100%' }, onchange: e => {
                ...
                } }, mealTypes.map(type => (index.h("wa-radio", { style: { flex: '1' }, appearance: "button", value: type.CODE_NAME }, type.CODE_VALUE_EN))))) : (index.h("div", { class: "ir-meal-report-filters__warning" }, "No meal types found."))), index.h("div", { key: '60b88d11ae11fe0035b350d36c26b8f2ce6da15f', slot: "footer" }, index.h("ir-custom-button", { key: 'd41594d42de2a8ab469f9616d280d445a2d73bf3', type: "button", size: "s", variant: "neutral", appearance: "filled", onClickHandler: (e) => {
                const ev = e.detail;
            ...
            } }, this.lcz.Lcz_Reset || 'Reset'), index.h("ir-custom-button", { key: '9c57eac5b573c8454a2b45cad6e575d58c316f90', type: "button", size: "s", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
...
const IrMetricCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9414666358e1e10a11ecc812f1a29cb3ac668b40', role: this.clickable ? 'button' : null, tabindex: interactive ? '0' : null, "aria-label": this.clickable ? ariaLabel : null, "aria-busy": this.loading ? 'true' : null, onClick: interactive ? this.handleActivate : undefined, onKeyDown: interactive ? this.handleKeyDown : undefined }, index.h("div", { key: '931d1460d0f01ec67a32858db39d3a547be08938', part: "base", class: "metric" }, (hasIcon || this.label) && (index.h("div", { key: '626fe85d1b6c8b05e5b79f96e636f3bf51aa0b5d', part: "header", class: "metric__header" }, hasIcon && this.renderIcon(), index.h("span", { key: '723de1ceb9d6fb681721bd2b03a92c3d02616706', part: "label", class: "metric__label" }, index.h("slot", { key: '3bbc2815ac67b5253956041a427af97dff1132a8', name: "label" }, this.label)))), this.loading ? (index.h("div", { class: "metric__skeleton" }, index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--value" }), index.h("span", { class: "metric__skeleton-bar metric__skeleton-bar--caption" }))) : (index.h("div", { class: "metric__main" }, index.h("div", { part: "value", class: "metric__value" }, index.h("slot", { name: "value" }, this.value !== undefined && this.value !== null && index.h("span", { class: "metric__value-number" }, this.value), this.unit && (index.h("span", { part: "unit", class: "metric__unit" }, this.unit))), this.renderTrend()), this.caption && (index.h("p", { part: "caption", class: "metric__caption" }, this.caption)))), index.h("div", { key: 'e3f7af642c3f3b5e5d30ba1ae310ad833e26e8af', part: "body", class: "metric__body" }, index.h("slot", { key: 'deda9d8301f6e4fe00af320bb309c7ef428387b3' })), index.h("div", { key: 'd306d07f449a392ed8448810b0418eb223793781', part: "footer", class: "metric__footer" }, index.h("slot", { key: 'cbca79a57b501e51be43243f63c377d87c4888a0', name: "footer" })))));
    }
};
