...
const IrBookingBillingRecipient = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3e867f80ab68a8edfe961d04d3837397a4525441' }, index.h("wa-radio-group", { key: '3230a797084fca2d47a3a34c54623816584f2cca', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, index.h("wa-radio", { key: '376cebc6d4b1a653be30a891430e8cd3fb694975', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (index.h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, index.h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (index.h("wa-radio", { key: 'ae4f01b418ac90c5e11729a3b9dae8987893ad73', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), index.h("ir-booking-company-dialog", { key: '754fafd74a2f9077e2b7de07b437449add67e0a6', onCompanyFormClosed: () => {
...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '3ac7f05f4de516f5855a7f93837d5d422e025106', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeCompanyForm();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: 'bfada58ba46d4006201273a7edb1a99fa66bc42f', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
                this.open = false;
                // this.closeCompanyForm();
            }, formId: formId, booking: this.booking })), index.h("div", { key: '11972f4d79beb0e84df9829650acbc7fa991e600', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '2452c933a2a1019ab9e510d2d5f9eade08eba244', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '7c2b56768a7f31ffbbd886b2be81900330884762', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/DoReservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: 'ac96306ae438c25df322616c61adf613f113cd42', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-input", { key: '12a74d3c1f4bcdb48a8198ac7dad55bae96c498d', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-input", { key: '74852225496d7e86015126d72762a12835004491', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrPrintRoom = class {
    ...
    render() {
        ...
        return (index.h("section", { key: 'fa2633cdcf70823469d40b701f46c5b9316797e9', class: "ir-print-room" }, index.h("header", { key: '848f918b8f3d23f706a46df5aa2f8dd5bab07479', class: "ir-print-room__header" }, index.h("p", { key: '7e58d8ad6d7384ea816fc768546e2e1b4cc98402', class: "ir-print-room__room-type" }, room?.roomtype?.name), haveMultipleRooms && room?.unit && index.h("p", { key: 'e6be062f3b61fdf98f580b4ee14ce25d43961321', class: "ir-print-room__unit" }, "(unit ", room.unit.name, ")"), index.h("p", { key: '788756e13a81769d5b4b27b5a107d725a3e85fb2', class: "ir-print-room__rate-plan" }, room?.rateplan?.short_name || room?.rateplan?.name)), index.h("div", { key: '5b3dde9a333246e6aaed9e75cbec17564a6b8201', class: "ir-print-room__body" }, index.h("div", { key: 'b1a09550cc8732fc7de092645fd8fc6779c8526f', class: "ir-print-room__details" }, index.h("div", { key: 'a17e4af93cdc54505b0e15aa9fe9db8a60f68105', class: "ir-print-room__row" }, index.h("ir-printing-label", { key: '4ac0e21ed3d49414d117e8f82424ab74104101f6', label: "Guest Name:", content: this.formatGuestName(room?.sharing_persons?.find(p => p.is_main) ?? room?.guest) }), index.h("ir-printing-label", { key: '849de2200d9cc005fa837fd61f9e6c6f0807b517', "as-html": true, content: this.formatGuestAvailability(room?.occupancy) })), index.h("div", { key: '676c1731411806b6c5ee4daa0cd3f2aa54c823d7', class: "ir-print-room__row" }, index.h("div", { key: '30d36f4ceeb0f77c134b69fa40af5977b4adf949', class: "ir-print-room__dates" }, this.formatBookingDates(room?.from_date), index.h("span", { key: '61de57434198aef13240efe879915346065cea45', class: "ir-print-room__date-separator" }, "\u2192"), this.formatBookingDates(room?.to_date)), room?.departure_time?.description && index.h("p", { key: '66c5ecc514251887e68057e847ea2f63f464994d', class: "ir-print-room__departure-time" }, "(Expected departure time: ", room.departure_time.description, ")")), index.h("ir-printing-label", { key: '53f40397c6e4b81b305b8432baec610600bce5fe', label: "Smoking options:", display: "inline", content: this.getSmokingLabel() }), booking?.is_direct && (index.h("div", { key: '782f8b9ec581d128ec53269d7b9206d82e335e12', class: "ir-print-room__policies" }, index.h("ir-printing-label", { key: '20e23a217eae9beb30d724b2fec48cb36aa3ebfc', label: "Cancellation:", display: "inline", asHtml: true, content: room?.rateplan?.cancelation?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') }), index.h("ir-printing-label", { key: 'a74ffe0d6e971554f03225ec517daebfc1a496dc', label: "Guarantee:", display: "inline", asHtml: true, content: (room?.rateplan?.guarantee ?? '')?.replace('<u>', '')?.replace('</u>', '')?.replace('<b>', '<b style="font-weight:bold">') })))), index.h("aside", { key: 'ad407ebfb573554462871d73f8e9196fe854d42d', class: "ir-print-room__totals" }, index.h("ir-printing-label", { key: 'f8dd81dc0beda9e8136c61bddad4a1af567af007', label: "Total:", content: utils.formatAmount(currency, room?.total) }), this.renderTaxSection(), index.h("ir-printing-label", { key: '5d8a738fefd35a7fa8477dbda5440998bc28a056', label: "Grand total:", content: utils.formatAmount(currency, room?.gross_total) }), booking?.is_direct && index.h("ir-printing-label", { key: 'c6945dc48044fb1ee826ca980b4c26d55caa2575', label: "Due upon booking:", content: utils.formatAmount(currency, Number(room?.gross_guarantee)) }))), index.h("div", { key: 'e2039758d8fc09084c90bf1ceb4d16f1c422b50f', class: {
...
const IrPrintingExtraService = class {
    ...
    invocableKeys;
    render() {
        return (index.h("section", { key: '8e2177b407af0db79afa65baccf69a0f9855e5e1', class: "ir-print-extra-services" }, index.h("h3", { key: 'c5f49c56727b68398e4731abab921c2b118fc83d', class: "ir-print-extra-services__title" }, "Extra services"), index.h("div", { key: 'a4d8b330b2692f7966d0a1b38c8bf8eb5e023e40', class: "ir-print-extra-services__list" }, this.extraServices?.map(service => {
