...
const IrAccordion = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6d9fe79bb4fb85b5c9a13f01ae46e36eb77ff3fa' }, index.h("div", { key: '514b10afea348c726dbfb27d6d09227bb009c984', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, index.h("button", { key: '8ca43063882922ff05741b45cee01f68725c1397', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && index.h("ir-icons", { key: '93933dd768a43aa91c3d665b6c705f3a73cf8b70', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), index.h("div", { key: 'e21dbe78162884740e115cdab29988f61bea1a3a', class: "ir-accordion__trigger-content" }, index.h("slot", { key: '635c6648a40ec321f6445abe765baec0790267a8', name: "trigger" }))), index.h("div", { key: '434a6ec986e5acf775049822256e390e137b5cfe', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, index.h("div", { key: '546afb19d2679c63f6b93cda368c68a755538b94', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, index.h("slot", { key: '8ec261da6b4876d1c9183b72ea083b0e59bcc323' }))))));
    }
...
const IrRevenueRowDetails = class {
    ...
    revenueOpenSidebar;
    render() {
        return (index.h(index.Host, { key: '04fd8b3b86c6659ad0b90c62e459825d3b6f2fa7' }, index.h("div", { key: '841e3695c428a0594f760603d171e79c31b6bf63', class: "ir-revenue-row-detail" }, index.h("div", { key: '93627421956e2454c2dc72b05fab8cb289a799b5', class: "ir-revenue-row-detail__info" }, index.h("div", { key: '18c774c35824156fe3001a5715a7364f21df1c0c', class: "ir-revenue-row-detail__time" }, index.h("span", { key: 'bcd1034c3d99db99237bbf46b7e32cf4f92a93f7', class: "ir-revenue-row-detail__label" }, irDate.formatDate(this.payment.date, 'MMM DD, YYYY')), index.h("span", { key: '59ad6c052f829d82d48e9f51d428e3b7fd301b17', class: "ir-revenue-row-detail__value" }, functions._formatTime(this.payment.hour.toString(), this.payment.minute.toString())), index.h("div", { key: '275fc33717ce327671486b1f664d8fd5a1358092', class: "ir-revenue-row-detail__amount" }, number.formatAmount(calendarData.calendar_data.currency.symbol, this.payment.amount))), index.h("div", { key: 'c90dbffc31e692546af0663eaff9374ec2f29077', class: "ir-revenue-row-detail__meta" }, index.h("div", { key: '5975eea46515b4de4834882b8a8f3463141eab51', class: "ir-revenue-row-detail__user" }, index.h("span", { key: 'b1dfe23c3dbdf4cf3666c767f4a46a7a10bfeb2c', class: "ir-revenue-row-detail__label ir-revenue-row-detail__label--capitalize" }, t.t('Lcz_User', { fallback: 'user' }), ":"), index.h("span", { key: '443947d5ce0a69b631e5e71c7534cf7c9a247124', class: "ir-revenue-row-detail__value" }, this.payment.user)), index.h("div", { key: '8a5801340245b0cf2f7160484eb2b68a4c394bed', class: "ir-revenue-row-detail__booking" }, index.h("ir-custom-button", { key: '6defb4bad0224d35d85d9698eb2c361b969722f5', link: true, style: { marginInlineStart: '1rem' }, onClickHandler: e => {
            ...
            } }, number.formatBookingNumber(this.payment.bookingNbr))))), index.h("div", { key: '5451e3f283aa820d6d55414c852782711ae8afa4', class: "ir-revenue-row-detail__amount" }, number.formatAmount(calendarData.calendar_data.currency.symbol, this.payment.amount)))));
    }
};
