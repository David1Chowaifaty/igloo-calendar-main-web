...
const IrFdConfirmDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '16d0ec301373052e965efdf376db446d5a4d4f1e', open: this.open, label: config?.title ?? '', lightDismiss: false, onIrDialogHide: () => this.cancelled.emit() }, index.h("p", { key: 'dd46ed9de8cce7ba46aa74abd9a4c7ea2888a111', class: "confirm-dialog__message" }, config?.message ?? ''), index.h("div", { key: 'e6c511c6ee8b509bcf84745146f9c1e56d79c1dc', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'fdd85d1d4e51fb8497a9ce023fd3d7b02229f9c8', size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.cancelled.emit(), disabled: this.isConfirming }, "Cancel"), index.h("ir-custom-button", { key: '05fc779e3d9ef91ef222e257d5c425c552dfe5be', size: "medium", variant: config?.confirmVariant ?? 'neutral', onClickHandler: () => this.confirmed.emit(), loading: this.isConfirming }, config?.confirmLabel ?? 'Confirm'))));
    }
};
