...
const IrClStatusTag = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("wa-tag", { size: 'small', className: `${this.size === 'default' ? '' : 'cl-status-tag__xs'}`, variant: variant }, label, showLock && index.h("wa-icon", { name: "lock" }))));
    }
};
...
const IrFdConfirmDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'cf1a87ede37e3f48e83d43281fa003ad3545347e', open: this.open, label: config?.title ?? '', lightDismiss: false, onIrDialogHide: () => this.cancelled.emit() }, index.h("p", { key: '83036dd2745118ab860b40170385032cffd0ed66', class: "confirm-dialog__message" }, config?.message ?? ''), index.h("div", { key: '4b6236095abccca1ec5261b63fbded0e2cc96878', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'acfdca017a8ac961f29ce7014f5f1faf7c29ccda', size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.cancelled.emit(), disabled: this.isConfirming }, "Cancel"), index.h("ir-custom-button", { key: 'fd96a34033a457fec2ec27323cc5219dcf7333b8', size: "medium", variant: config?.confirmVariant ?? 'neutral', onClickHandler: () => this.confirmed.emit(), loading: this.isConfirming }, config?.confirmLabel ?? 'Confirm'))));
    }
};
...
//# sourceMappingURL=ir-cl-status-tag_2.cjs.entry.js.map