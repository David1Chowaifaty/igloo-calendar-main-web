...
const IrUnvoicedBookingsFilters = class {
    ...
    render() {
        return (index.h("div", { key: '891c1bdadd8bb5c40e7d58c71f3e39e2c50a1963', class: "uninvoiced-bookings-filters" }, index.h("ir-date-range-filter", { key: 'e2f6373883f4ccbdac020e431b8fe758e74486be', class: "uninvoiced-bookings-filters__date-picker", fromDate: uninvoiced_bookings_store.uninvoiced_bookings.filters.from, toDate: uninvoiced_bookings_store.uninvoiced_bookings.filters.to, maxDate: moment.hooks().format('YYYY-MM-DD'), showQuickActions: true, quickDates: this.quickDates, quickDatesMode: "range", withClear: false, selectionMode: "auto", onDatesChanged: this.handleDatesChanged }), index.h("div", { key: 'b64fd4eeb5a776799137bde9da606a2c6ceead1c', class: "uninvoiced-bookings-group" }, index.h("wa-select", { key: 'a075d2ebb6fa8681dca8df5f23ca573721610c13', onchange: this.handleSourceChanged, value: uninvoiced_bookings_store.uninvoiced_bookings.filters.source, size: "s" }, index.h("wa-option", { key: 'ce42fbc54ada4cf1d696afce633967fa2d3b9676', value: "" }, "All channels"), uninvoiced_bookings_store.uninvoiced_bookings.channels.map(channel => (index.h("wa-option", { key: channel.value, value: channel.value }, channel.name)))), index.h("ir-custom-button", { key: '6facec7b9d7a02ac05ed6e9bcc5743d266edbaec', id: "uninvoiced-bookings-search-btn", loading: uninvoiced_bookings_store.uninvoiced_bookings.isLoading, disabled: uninvoiced_bookings_store.uninvoiced_bookings.isLoading, onClickHandler: this.handleSearch, variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: 'a720931b1d9abceb7a6079efdcf7e3f804e4fe94', name: "magnifying-glass" }))), index.h("wa-tooltip", { key: '57bc96ee31df52bf3673a48b304e433abe321d11', for: "uninvoiced-bookings-search-btn" }, "Search")));
    }
};
...
const IrUnvoicedBookingsTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '09d869a7b7b157c443f26b6651464893fc75db7b', class: "uninvoiced-bookings-table" }, index.h("div", { key: '50c77f8e5ae5a55d8dbd624fc8fce5bcde000d80', class: "table--container" }, index.h("table", { key: '128f49064a9faa894791fc014e8bd490ab371f31', class: "table data-table" }, index.h("thead", { key: '497c38dbdfd09389c3c5be528986a1920db98546' }, table.getHeaderGroups().map(headerGroup => (index.h("tr", { key: headerGroup.id }, headerGroup.headers.map(header => (index.h("th", { key: header.id, class: {
            ...
            } }, useTable.flexRender(cell.column.columnDef.cell, cell.getContext()))))))))))), index.h("ir-pagination", { key: 'd502e6e0420dd276b870ae2291c1f02f815be93e', class: "uninvoiced-bookings-table__pagination", total: total, pages: pageCount, pageSize: pageSize, currentPage: currentPage, allowPageSizeChange: true, pageSizes: this.pageSizes, showing: { from: total ? startIndex + 1 : 0, to: startIndex + pageRows.length }, recordLabel: "bookings", onPageChange: this.handlePageChange, onPageSizeChange: this.handlePageSizeChange })));
    }
};
