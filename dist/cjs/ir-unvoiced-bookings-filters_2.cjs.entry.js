...
const IrUnvoicedBookingsFilters = class {
    ...
    render() {
        return (index.h("div", { key: '6acb4f69e55ea94f969721e10c943badfe169f8a', class: "uninvoiced-bookings-filters" }, index.h("ir-date-range-filter", { key: '91bd3dcce2183bbbc534d34c13a15380910fcf97', class: "uninvoiced-bookings-filters__date-picker", fromDate: uninvoiced_bookings_store.uninvoiced_bookings.filters.from, toDate: uninvoiced_bookings_store.uninvoiced_bookings.filters.to, maxDate: moment.hooks().format('YYYY-MM-DD'), showQuickActions: true, quickDates: this.quickDates, quickDatesMode: "range", withClear: false, selectionMode: "auto", onDatesChanged: this.handleDatesChanged }), index.h("div", { key: 'e15c16a2e1db61961fb39df43ffbc9433d64d62e', class: "uninvoiced-bookings-group" }, index.h("wa-select", { key: 'c06935830b2e849f3de05031afee23eb94f8b262', onchange: this.handleSourceChanged, value: uninvoiced_bookings_store.uninvoiced_bookings.filters.source, size: "s" }, index.h("wa-option", { key: 'aead2e4d0a3e787ca2cea6006be8c46bead8b77e', value: "" }, t.t('Lcz_AllChannels', { fallback: 'All channels' })), uninvoiced_bookings_store.uninvoiced_bookings.channels.map(channel => (index.h("wa-option", { key: channel.value, value: channel.value }, channel.name)))), index.h("ir-custom-button", { key: '445f9b74be670faf18bd98bc957d8cef48521953', id: "uninvoiced-bookings-search-btn", loading: uninvoiced_bookings_store.uninvoiced_bookings.isLoading, disabled: uninvoiced_bookings_store.uninvoiced_bookings.isLoading, onClickHandler: this.handleSearch, variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: '81cb73705dece2888d930941be506451a6bd35ba', name: "magnifying-glass" }))), index.h("wa-tooltip", { key: 'fb88ec79db8cccbb7f52ce746bd694da42f2b089', for: "uninvoiced-bookings-search-btn" }, t.t('Lcz_Search', { fallback: 'Search' }))));
    }
};
...
const IrUnvoicedBookingsTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '9f6de9e5e01f0e3722c397edfe73240e080842b7', class: "uninvoiced-bookings-table" }, index.h("div", { key: '10dab680bbcf219998e1221b61270761d0532957', class: "table--container" }, index.h("table", { key: '627677b4a667187ce77982eff971e89e48ede060', class: "table data-table" }, index.h("thead", { key: '384331e865669c5c35a9d56a726a0729a9ad00ce' }, table.getHeaderGroups().map(headerGroup => (index.h("tr", { key: headerGroup.id }, headerGroup.headers.map(header => (index.h("th", { key: header.id, class: {
            ...
            } }, useTable.flexRender(header.column.columnDef.header, header.getContext())))))))), index.h("tbody", { key: '1db4144ee068373e1b7b5a326c229a8d9f511d20' }, uninvoiced_bookings_store.uninvoiced_bookings.isLoading ? (index.h("tr", null, index.h("td", { colSpan: this.columns.length, class: "empty-row" }, index.h("ir-spinner", null)))) : table.getRowModel().rows.length === 0 ? (index.h("tr", null, index.h("td", { colSpan: this.columns.length, class: "empty-row" }, index.h("ir-empty-state", { message: t.t('Lcz_NoUninvoicedGuestPaidBookings', { fallback: 'No uninvoiced guest-paid bookings for this date range.' }) })))) : (table.getRowModel().rows.map(row => (index.h("tr", { key: row.id, class: "ir-table-row" }, row.getVisibleCells().map(cell => (index.h("td", { key: cell.id, class: {
            ...
            } }, useTable.flexRender(cell.column.columnDef.cell, cell.getContext()))))))))))), index.h("ir-pagination", { key: '8db929dc37bbed331f870e6a33448e1d3effe43e', class: "uninvoiced-bookings-table__pagination", total: total, pages: pageCount, pageSize: pageSize, currentPage: currentPage, allowPageSizeChange: true, pageSizes: this.pageSizes, showing: { from: total ? startIndex + 1 : 0, to: startIndex + pageRows.length }, recordLabel: "bookings", onPageChange: this.handlePageChange, onPageSizeChange: this.handlePageSizeChange })));
    }
};
