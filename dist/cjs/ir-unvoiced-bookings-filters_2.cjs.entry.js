...
var uninvoiced_bookings_store = require('./uninvoiced_bookings.store-D7ljNVBw.js');
...
const IrUnvoicedBookingsFilters = class {
    ...
    render() {
        return (index.h("div", { key: '8f50b6a25cf686c75136193965c5b1929f883f6b', class: "uninvoiced-bookings-filters" }, index.h("ir-date-range-filter", { key: '2405f298b85112a5e7945446993f1f020523822b', class: "uninvoiced-bookings-filters__date-picker", fromDate: uninvoiced_bookings_store.uninvoiced_bookings.filters.from, toDate: uninvoiced_bookings_store.uninvoiced_bookings.filters.to, maxDate: moment.hooks().format('YYYY-MM-DD'), showQuickActions: true, quickDates: this.quickDates, quickDatesMode: "range", withClear: false, selectionMode: "auto", onDatesChanged: this.handleDatesChanged }), index.h("div", { key: '53a1328a6b7e9f2e4e8fc64f73252bdc51f50a61', class: "uninvoiced-bookings-group" }, index.h("wa-select", { key: '2bc38017511964a65f32897238cb77e8bfb756d0', onchange: this.handleSourceChanged, value: uninvoiced_bookings_store.uninvoiced_bookings.filters.source, size: "s" }, index.h("wa-option", { key: 'e8125e102c8aea350f7ee7bf0fb122a2bd39520c', value: "" }, "All channels"), uninvoiced_bookings_store.uninvoiced_bookings.channels.map(channel => (index.h("wa-option", { key: channel.value, value: channel.value }, channel.name)))), index.h("ir-custom-button", { key: '0028f47880cc80d2928a1fc56330f52893e0c0a0', id: "uninvoiced-bookings-search-btn", loading: uninvoiced_bookings_store.uninvoiced_bookings.isLoading, disabled: uninvoiced_bookings_store.uninvoiced_bookings.isLoading, onClickHandler: this.handleSearch, variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: '05a23277532a28b6e90d033297595bdc3c9f8a60', name: "magnifying-glass" }))), index.h("wa-tooltip", { key: '6a999f125a5509921790d01919b9e0cce312062c', for: "uninvoiced-bookings-search-btn" }, "Search")));
    }
};
...
const IrUnvoicedBookingsTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b5d653b5cec4726fa421d9bc1752c0f6acf23f95', class: "uninvoiced-bookings-table" }, index.h("div", { key: '7de40b681b3285e5883b48c1af9293b9dac58f87', class: "table--container" }, index.h("table", { key: '88f98d7d30b07bdd4371266d0b0cd851c85fa3d5', class: "table data-table" }, index.h("thead", { key: '1e4f215499abc40e3e764eddedf56a6be4129bb7' }, table.getHeaderGroups().map(headerGroup => (index.h("tr", { key: headerGroup.id }, headerGroup.headers.map(header => (index.h("th", { key: header.id, class: {
            ...
            } }, useTable.flexRender(cell.column.columnDef.cell, cell.getContext()))))))))))), index.h("ir-pagination", { key: '2190bcc25f471e995c01ddcc2fd38116fed441f6', class: "uninvoiced-bookings-table__pagination", total: total, pages: pageCount, pageSize: pageSize, currentPage: currentPage, allowPageSizeChange: true, pageSizes: this.pageSizes, showing: { from: total ? startIndex + 1 : 0, to: startIndex + pageRows.length }, recordLabel: "bookings", onPageChange: this.handlePageChange, onPageSizeChange: this.handlePageSizeChange })));
    }
};
