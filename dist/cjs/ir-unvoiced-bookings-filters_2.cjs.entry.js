...
const IrUnvoicedBookingsFilters = class {
    ...
    render() {
        return (index.h("div", { key: 'bb4612f159c8c8faa86400d442a35a8e228de5fb', class: "uninvoiced-bookings-filters" }, index.h("ir-date-range-filter", { key: '3a4c2a80a3a47556589f4ea8ed619fa4f048f088', class: "uninvoiced-bookings-filters__date-picker", fromDate: uninvoiced_bookings_store.uninvoiced_bookings.filters.from, toDate: uninvoiced_bookings_store.uninvoiced_bookings.filters.to, maxDate: moment.hooks().format('YYYY-MM-DD'), showQuickActions: true, quickDates: this.quickDates, quickDatesMode: "range", withClear: false, selectionMode: "auto", onDatesChanged: this.handleDatesChanged }), index.h("div", { key: '01c3989afafbd57b597fa5d0de7da2c269665fb0', class: "uninvoiced-bookings-group" }, index.h("wa-select", { key: '781d7ce0594765aa78800ebe6411dad170a71813', onchange: this.handleSourceChanged, value: uninvoiced_bookings_store.uninvoiced_bookings.filters.source, size: "s" }, index.h("wa-option", { key: '8521ccccac83c93a88e50b215480972e44941292', value: "" }, "All channels"), uninvoiced_bookings_store.uninvoiced_bookings.channels.map(channel => (index.h("wa-option", { key: channel.value, value: channel.value }, channel.name)))), index.h("ir-custom-button", { key: '49381aad6cbd16ba93d76b93c1f06ea0731cddf0', id: "uninvoiced-bookings-search-btn", loading: uninvoiced_bookings_store.uninvoiced_bookings.isLoading, disabled: uninvoiced_bookings_store.uninvoiced_bookings.isLoading, onClickHandler: this.handleSearch, variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: '99e964c463c6f4d5328098f03be4d370af03cf18', name: "magnifying-glass" }))), index.h("wa-tooltip", { key: 'e7f8c4549b2aab3bbce7809dbb1121ea262f3a32', for: "uninvoiced-bookings-search-btn" }, "Search")));
    }
};
...
const IrUnvoicedBookingsTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e16bf47b365b80d4235db7b06d663844df82faec', class: "uninvoiced-bookings-table" }, index.h("div", { key: '3f1a9dd71fe8e5a4d37df4ff15e09a867c6118da', class: "table--container" }, index.h("table", { key: 'e56c1b6a80def419a64d790d8bcd50c37c29e342', class: "table data-table" }, index.h("thead", { key: 'aae18f677b821b379d93ad10459ea21c38084161' }, table.getHeaderGroups().map(headerGroup => (index.h("tr", { key: headerGroup.id }, headerGroup.headers.map(header => (index.h("th", { key: header.id, class: {
            ...
            } }, useTable.flexRender(header.column.columnDef.header, header.getContext())))))))), index.h("tbody", { key: '69a37ef71c151059bf422844fbde16bf8c767778' }, uninvoiced_bookings_store.uninvoiced_bookings.isLoading ? (index.h("tr", null, index.h("td", { colSpan: this.columns.length, class: "empty-row" }, index.h("ir-spinner", null)))) : table.getRowModel().rows.length === 0 ? (index.h("tr", null, index.h("td", { colSpan: this.columns.length, class: "empty-row" }, index.h("ir-empty-state", { message: "No uninvoiced guest-paid bookings for this date range." })))) : (table.getRowModel().rows.map(row => (index.h("tr", { key: row.id, class: "ir-table-row" }, row.getVisibleCells().map(cell => (index.h("td", { key: cell.id, class: {
