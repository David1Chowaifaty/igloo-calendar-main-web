...
const IrBookingEmailLogs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0c1471f41fe82480ccdcaba0c0d2a7b13f29cb6c', class: "p-1" }, index.h("ir-interceptor", { key: 'e4e876fd327630c1822822f635ec45aa31e64de7', handledEndpoints: ['/Get_Email_log_By_BOOK_NBR'] }), index.h("ir-toast", { key: '43e88ce2bb5f5cf0eaa95661904f337585205579' }), index.h("div", { key: '17224bbf479502b9a2885022c88d0ff394e58569', class: "d-flex align-items-center mb-1", style: { gap: '0.5rem' } }, index.h("ir-input-text", { key: 'e4cc9bbbb4a639629a53f58c4801db0963aa5c28', class: "m-0", inputContainerStyle: { margin: '0' }, value: this.bookingNumber, onTextChange: e => (this.bookingNumber = e.detail), placeholder: "booking number" }), index.h("ir-button", { key: '6e225088b1ffe1ba8e3388915ba049b18e025460', size: "sm", text: "search", onClickHandler: async () => {
            ...
            } })), index.h("p", { key: '06fd39af6ffad7351773e853cdab754ebc4362b8' }, JSON.stringify(this.data, null, 2))));
    }
    static get watchers() { return {
        "ticket": ["handleTicketChange"]
    }; }
