...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '476336aef08f0fc91a1e921c6aa1910dd7cdf6c4' }, index.h("div", { key: '5cb12b8b443b426f130eec00a0d1c1f417087c46', class: 'd-flex align-items-center ' }, index.h("label", { key: 'd557357d7314797c438bb2c46120010377736366', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'f76f6b87d56eefb5a411ea6ea47cac657a1256c0', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '860077cd654757f81ac59870858d1e591ad65577', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '73239a8cd91bfcae8545b33b5c64c3dab296c671', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '02163e308a57300a093169be817541831b013ed9', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'c0d988015982805f5a7b005e01cd4346fd0ba570', class: 'sr-only' }, "clear input"), index.h("svg", { key: '5d5f20159dbfa8ff7d1d1b87178d5c6f89fe1912', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '026e8f4d9170923c29142738a7bb9e71fae0d559', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingHeader = class {
    ...
    render() {
        var _a, _b;
        return (index.h("div", { key: '613b48d580d0336673f3f0a207f0f7a554f3fc17', class: "fluid-container px-1" }, index.h("div", { key: '04b4382f0618ac01d1f7a870fd03112353be6d0a', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '77984104a3f5c18c0194e994372b17917c09faaa', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: '3c5cd92829be841352681122f5682cea11de6c93', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '28112dd2fcee0d33c6b120fcc7d876db38afb23c', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'bb36b41140ca6d71163532ac44e78834aebebcd9', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '3368267a32a015b034674c5983f3a2f8a9a57e0f', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: 'e9a0aa553cd09073597adda8ecebf3b1bfd90301', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'c8a0dd94a1bad60eea61a0cdb026385e14cfa322', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: 'd89349106dea1ba59b9afde8600d5eaddd943c3c', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '5aaad0723b97dd9602750781fb74d458b84b7995', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: 'ef7525fae5538d67dd1357432586e292209059e9', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '331f392915f67dcf2849e9fbacc839dc29ad781e', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '003392caff64fd24a2ebfd4fa822128c8c7e9883', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '513695edab0edb89855a907a349a941b51beeca6', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: 'c1b778bd2ec0a2b09870e7ae08108455398335b8', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: 'fea665c3ad0f4abd80ee640299b1fa4e44c44be0', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: 'd15cd666da6cf306d5bc139d6a472bab7447df61', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '8068bb0542cca92841e11bfe855455d7c6c1386f', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '9570ea9ce7bc0b156faf5d8ba9b2ab0e0bc2ef49', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': '400px' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-modal", { key: 'ddf452ae2c3754b27f64cac5e7cb6db069617e93', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: 'ALERT! Modifying a channel booking will create a discrepancy between igloorooms and the source. Future guest modifications on the channel may require manual adjustments of the booking.', isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cd71000db688f1a37d940aedcc01a3e3930c2c0c' }, index.h("button", { key: 'f3b4379cf49658a5ad10f60c902610559c50dbe2', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'fa9a88d30e2d4e61f62eeeda06796be46df9b411', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '8a9a7dba72882f18e85d817a2f1b18fee01e4a92', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: '7847d0adea4d044ff1238f9621d2b3ba3fbed440', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '88746610e8be6db5ddcc433f35b0cd6287f431db', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: 'e00731f17823f7e1b7e6af8947c65b0393875c08', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: '0d735ce22dae3eda2c59d551209f4f5407b001eb', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
    static get watchers() { return {
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '090dcb02c881a45d24a3b6fc843b68836ea4cccc' }, index.h("slot", { key: '75be769a29b896ace78f6332883b5245538d41bc' })));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'a77c52ad87b8bde36f363b1239c799cd3403f8c0', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'd14fe66a55875abb965637b3d80b777ddb5184d8', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: '399f0a71f649ce0978146fa122bca21fa58a457b', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'bb2cc2448b19a688fb929a64224aa6136f6f9900' }, index.h("button", { key: '8441e37be03dcb881256162bf84108344dcf7716', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '9a88d8e2810bad1b386534ee6e589ab6f399f8b4', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: 'd9d277a4355d933e2cdcd104a116a45f158376e8', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '4516d20fab887372f69cc4e738d626ad1f264dfc', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '01adec47f509010017ad0227ba002aed98ac1566', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '91cdd122a657234f4e3540918c0ea53e9eb63772', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '479bf2f4739c5d4fd17be71b14e7cc7e938354f2', name: "trigger" }), index.h("input", { key: '3b2f4c1370fe14494b3e0906d9df9679bb70d4f3', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fdd27d69b63de775e59f2b1a940cdde00d56d60c' }, index.h("input", { key: '42782359b928d66a42207d0705201249ff9fcf3b', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6e23ecdb2ab5a82ace1c528072dacaeb6e9201c7', class: "d-flex align-items-center" }, index.h("span", { key: '13305594fb7e8c1505b210b5450252fb0d17db5f' }, this.dates.from_date), ' ', index.h("svg", { key: '77b39d8f2a3c73171677a0fac4d5ffc2516b5613', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '919527fcc952e675fd9bbbbca29442157d14a4f5', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '4b9d8296383362b362caf6711280ae90262f444e' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '804901c6922e3d12954f17f039bf9d92284f3f91', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9be9c377a65673545f45b59e7df3ee0bfe69cc26' }, index.h("div", { key: 'e931687d37adcf2b682b7b0fc172712e8ba1ba7b', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'c4625541e5fdac3cc042b8be3aa3daa811ad06ef', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'f61b39760dfb9d5f0135d8d6ddf9814e6e19ac83', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '0e38b8a22b470505ecbb930433318ba3221069c5', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '8ecd920b7cae67e2b20821049de1f0441cd18af3', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'dfde1b316b0fd56988dba27051834f9ca3dbabef', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '3ebfa2194784c4504ba4f898c9c3f7c6a55bcf9a', name: "modal-title" })), index.h("div", { key: 'c29fd8870a7d06f0098406701ccc00c6d2f60fdc', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '38aea9784cabb4d00ebd6c14c1e0670222102218', name: "modal-body" })), index.h("div", { key: 'a0031af1c0a6c1aa482d3fac90fa5a1e3f325feb', class: "modal-footer" }, index.h("slot", { key: 'd19b0c58e66d37126fc74723ae9e86922dfadfba', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '945245064f94556019ab0de25e71e51bc329ddad' }, index.h("div", { key: 'ca68c3a47bcb4e4a3f7abd65e63fe3520aa393bd', class: "p-1" }, index.h("div", { key: 'fede9cce9ebbb14b8343dcf45dbe46f6e0985163', class: 'extra-service-container' }, index.h("p", { key: '2637a49c8a8ce72d67321b55c555152781d5e6b1', class: "extra-service-description" }, this.service.description), index.h("div", { key: 'dde73177376dc216ae9f7b2a6c476220e34fc784', class: "extra-service-actions" }, this.service.price && index.h("p", { key: '8909025a797191327c881ae46f84fafb7efe5f8e', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price)), index.h("ir-button", { key: 'f95990a3f800705eaaee9474cf38868a0a9b13b8', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: '6a1a05fbdeaa36e4034c126db54ee7d2f9b8bfda', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: icons.colorVariants.danger }))), index.h("div", { key: 'f4230b0010bb2b69a002948ef1ec89f83f8250a6', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, utils.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: 'bd4841dbb077f4c573c2c71566dcb5842a3e6837', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'de4c3c2def1da976ae8a21557b7cc89b3459d70e', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '7ca7bd771f2640a2e68b66df6a35119e10f5743d', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '000faefd7d3d6a11440035935398407c1681fef1', class: 'px-1 sheet-body' }, index.h("fieldset", { key: '36747ec58f3676ba08da90042b591ae6ebf3e14f', class: "input-group mb-1 service-description" }, index.h("div", { key: 'bdd0e1e93c16d770a6f935b2492346ec9ecd9901', class: "input-group-prepend" }, index.h("span", { key: '3f3e47fb2478d076535f97a62d80eabe43cd5c4c', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '2dba57edabfa5a99de3c20d6bc91d85db9d9a84b', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '9440bacc78eb7681144dae14fac9fde0329352c8', class: 'row-group mb-1' }, index.h("div", { key: '5bc2f569bbc64ea115334dbd3e7dd4cda9b751de', class: "input-group" }, index.h("div", { key: 'd64de56cd0335b93b4f93038b04b5648b3c83a33', class: "input-group-prepend" }, index.h("span", { key: 'e92fe32335513cb6e2d10ca0d9f2d80b11976af4', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '16f6a8b98d53c72ef03b6aa48bf688d8c27d4c29',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '6119c56e003707441e991c31a87fe032638e4174', class: "service-date-container" }, index.h("ir-date-picker", { key: 'f508d3490d677a4c503f0b80382c7fd1fe8fc5df',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: '378d49f19af4ed1f02997932df62b6be9057a1e0',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: '70d2dce454c4b6d327a391193e9c6b9fcd066cb5', class: "btn-container" }, index.h("ir-button", { key: '7bb3867a00796dc62728947d3d8bc6a2882b2564', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '34567542ab78f0d8de36db18f763d57599ad227f', class: "input-group" }, index.h("div", { key: 'dc3f853d9cf4a7f136bff6e15eeebfef2550c627', class: "input-group-prepend " }, index.h("span", { key: '273c8716e426a50cca1240ad989572f91f82d235', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'd99f103fdd57f76d342ed296af83b48690cb79c5',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '402b0b10b99fdd9da538a1e13aa92064ba5d218d', class: "service-date-container" }, index.h("ir-date-picker", { key: '40d8506d0dd3f4530162f891e982463cc9d8763d',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: '05109bac006bb4c969066793e11fb57e5d2f94cd',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '03fc47c816b0ef0c9970bc31497f9c839de9445b', class: "btn-container" }, index.h("ir-button", { key: '7fdb8c023524aef3670d0f93c8e09aa1936bcd12', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '0954fc48f3d14b9dd1a601d67b24a1ece34afab2', class: 'row-group' }, index.h("ir-price-input", { key: '8d4c809ab46b111b65a87fe7e3ca1f7e26fab053', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: 'e56db5bee89b94e4f6ea6d5cede70a57400fe6d9', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: 'a1159964b456660308a5db6497e5b3a8b3d4e193', class: 'sheet-footer' }, index.h("ir-button", { key: '1537d74c91acee8f4ced7d5e53a5dee479f96cfb', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'bb7ffb0212f3b3a2f32c33f4b38b30138567b1fe', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrHkArchive = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        return (index.h(index.Host, { key: 'd993c6a65195c18851c1517444c7e079f6743d41' }, index.h("ir-title", { key: '66f6d959f56c777e6848f4dc5aaf2429225fa2a3', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: 'e0ccf51bc148494cd1fc7aa2c1591ae1d233da63', class: "px-1" }, index.h("div", { key: 'a9c0c25393156c8200a7db8e225d3d9f7a1f8c39', class: "d-flex" }, index.h("ir-select", { key: 'f3df8dd12d1b3e768511284ad588c350d8d29990', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }))), index.h("div", { key: '11589bf8ec2cfce398d4ca671bb406361f435793', class: "d-flex mt-1 align-items-center" }, index.h("ir-range-picker", { key: '53484d6a267948c3130a99db942d458a4637224a', maxDate: utils.hooks().format('YYYY-MM-DD'), minDate: this.minSelectableDate, class: "mr-1", fromDate: this.filters.from_date ? utils.hooks(this.filters.from_date, 'YYYY-MM-DD') : null, toDate: this.filters.to_date ? utils.hooks(this.filters.to_date, 'YYYY-MM-DD') : null }), index.h("ir-button", { key: 'ff91848be90e6ad735e19375895c522fd02a395a', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", class: "mr-1", isLoading: this.isLoading === 'search', onClickHandler: e => this.searchArchive(e) }), index.h("ir-button", { key: '645ac9e19a048433ba9c800d1660c34783607f2f', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: e => this.exportArchive(e) })), this.fetchedData && (index.h(index.Fragment, { key: '5e19ec6063a872dc74bc97ea47bfde78cc8cef3f' }, ((_k = this.data) === null || _k === void 0 ? void 0 : _k.length) === 0 && !irInterceptor_store.isRequestPending('/Get_Archived_HK_Tasks') ? (index.h("p", { class: 'text-center mt-2' }, locales_store.locales.entries.Lcz_NoResultsFound)) : (index.h("table", { class: "mt-2 table" }, index.h("thead", null, index.h("th", { class: "pl-0" }, locales_store.locales.entries.Lcz_Period), index.h("th", null, locales_store.locales.entries.Lcz_Housekeeper), index.h("th", null, locales_store.locales.entries.Lcz_Unit), index.h("th", null, locales_store.locales.entries.Lcz_BookingNumber)), index.h("tbody", null, (_l = this.data) === null || _l === void 0 ? void 0 : _l.map(d => (index.h("tr", { key: d.id }, index.h("td", { class: "pl-0" }, d.date), index.h("td", null, d.house_keeper), index.h("td", null, index.h("ir-tooltip", { message: d.unit, customSlot: true, containerStyle: { width: 'fit-content' } }, index.h("span", { slot: "tooltip-trigger", class: `unit-name` }, d.unit))), index.h("td", null, d.booking_nbr ? (index.h("ir-button", { btn_color: "link", btnStyle: {
                width: 'fit-content',
                padding: '0',
                margin: '0',
            }, labelStyle: {
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '342a1dc682d13f80db974eb9a901df8f6d2055be', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '10f1b82463e5e67596e5b33f70f1b240d7a4d72a', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ee78fce8ae2dea9dc89181ede7868279db71af5d' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '433614b9144317f7bc9f0c4571ee353d4f5ccf57', class: "loadingScreenContainer" }, index.h("div", { key: 'bbd4adfbd4d4bef24d182eb086c1dd5d76bb13e2', class: "loaderContainer" }, index.h("span", { key: '7c2c28e8c9d9e98db7f4fb7228e99d5f8185c1aa', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '62cf2e822e716642bd3ae682b06dc9e5bb9eab07', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b342b1803b03609cd5f7235de393664cc7cdd70a' }, index.h("span", { key: 'e1176daab80f6e981d8fdf665c3fdb03b5d4bb60', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '69d29cc3d7d969fae80bb05e9b3d16bd95a01505', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'e47753fc1a47de63350d4d91fc4b779572923d46', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'bf81330006518b7d02df46f44ec7bfc05b0f86c4', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '669184ee929fcae23422249deb19f80782ba528c', class: `ir-alert-header` }, index.h("p", { key: '72a4d151a1f51d1b471409c07f36822e3989be28' }, this.modalTitle))), index.h("div", { key: '41893034aa25967f6258663198df6538432ddfa8', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'db9c3981ccfe250575b9e1eafcda4f3c45624edc' }, this.modalBody)), index.h("div", { key: 'f9c9f155d0d35be2378fdd1bc370408f4a06c280', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '989d9820d41fe7f1789a109d6727fdf5cb2d9fe3', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (index.h("ir-button", { key: '5a7639ccb4d9bfb55adde9dc696becc21c843ccd', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '701cd8eb797c166149566477228ec6132286a881', class: "otp-input-container" }, index.h("div", { key: 'f308098dabc83fb458522bdf1ca86f4e8bd1e1d8', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'f514461d9262eaf0154c459d50e915a5ef4ea4fb' }, index.h("div", { key: '94731ed0616ef4f2d85eebb97769f09017af1756', class: "form-group mr-0" }, index.h("div", { key: '99a1f4ba73f2f5ff9eb4eef6c1b1f5ada394dcc7', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '3b7e875f1c07e630d5219f2d618d262f4fbe5162', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '2ad5fe5be664a57ff1dce8f15bc07408c698a653', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '978f58b895441463b71f5387b2386b0193803283', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: 'c647eb275010433a4dcf70b17dc3652d1a5efa88', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'a8803822bd14a8ba9a19516a3054a909825e6a34', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '3957c2edc288a91d48ccaf4805e396cdc1a89fa5', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '20fc1a4f27aaaf2b3bb4e75be23eea12c29c3cbf', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '5f77cd70096efdc205a1507a7ba398b18d5ef01b', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: '92e386a6c0375ee5286bc9f3d9e9a5902c665900', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: 'd90f059a664d452bd65c94a45eec90ff9ec5b394', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: 'f73539ff1c8cf54c4b867dde5039b480ab7401f8', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: 'e6d757322c86cd36546f32934c39b0b5b6650a20', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '09316423627a4236a90ea901552923acc95bd65a', class: 'px-1 sheet-body' }, index.h("ir-select", { key: 'c73bde28e595829342d55d9d9768b58c4d144683', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '8900efc722b5c7142114465e9ba825cc1ab07d61', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '733bc90fa2535c22d3acc931544d96f01837babb', class: 'd-flex' }, index.h("div", { key: 'fd772839e0680530220aceb647f2c42ceca87386', class: "form-group  mr-1" }, index.h("div", { key: '0fbc10c7cc65d89aea73e5c31a9720f19b29ff97', class: "input-group row m-0" }, index.h("div", { key: 'f324297c93ee002ef8cf32e2d8dd8e926d949c5b', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'bca0de286717d00ff99d6a1e4fa5edec17580f01', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '031f695bcaf8c10d15cf95af2c445073457e47cd', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: 'b31ce5669339a0cb74efe7bea758491093c943da', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '4cb26eaa4c63917f5642bd6858aba939478ba647', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? utils.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '5d70a4d1b5f23ac1b02284d64eb088d3dd44d9d4', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '1f07e220001cd47142c629d168a09a83d2da1424', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '16ffc3131d158a8536e7dee28da5a5bf492aef6c', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'e218bac1bf2555bcdd750ef74337b543de26a367', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'fbd89d3f10597a5dda9c2ed1c91c60e695820506', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: 'e3349a15dce628e2806adaf60bcc7c10a04ab802', class: "price-input-container" }, index.h("ir-price-input", { key: '6eb402a406a4b96fe1ebee117955f11dc020f9f7', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '1a9ea848521cd6c9614007e7b3ab39280273fa1c', class: 'sheet-footer' }, index.h("ir-button", { key: '8279f86f81d922f248314467a6c7a577a3029459', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'c68a087ede322434cc151130bc74fbd87e4828cf', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '7888bc73765b03c75697455c3faf862e8bd6f532', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: 'd185a2711b8473d735fc1a6313d62c7f32a1e4a8', class: "input-group-prepend" }, index.h("span", { key: '5e6c0020fb93d6b2f1ac9b3ba6b293db6f34a0c8', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'fb38ef34ba568f2e00dc4a33bebcb19be2f37f0a', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '7c57dca63fad7292c9740485ff65f962baf11f5c', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'a8f3903f88c93a73bf292d99af30aa912eb16d3a', class: `input-group-prepend` }, index.h("span", { key: '2c1a714a92f7e86dd1531026f18fe287b2ae30f8', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'a0dbbf5988063da173d6538306a0f58ba58dfece', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrRangePicker = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '804dd8cddc974ed390f83380a34c84e79cd3abfb' }, index.h("div", { key: '566b1330e08de5ffe599a049e637995b8e1cdc7d', class: "form-control range-picker__container", ref: el => (this.date_container = el) }, this.withOverlay && (index.h("div", { key: '62be42c0140563a0283bf1a7bd5efe65508c33c7', class: {
                'range-picker__overlay': true,
                'range-picker__overlay--active': !this.fromDate,
            }, onClick: () => this.fromDatePicker.openDatePicker() }, index.h("svg", { key: 'e668b7d7e951d944873f6b6bcc32f69d74d9c43c', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: 'eeb0c0ecd39d779dac3924798feb7784d9cfcdb6', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), index.h("p", { key: '086990c2d302d831a28f8a913eb12279fcc7c254', class: "m-0" }, index.h("slot", { key: 'f7d51b6c1bd7473fa4a74c64dc0a6ba4bdf6b783', name: "message" }, "Cleaned on")))), index.h("svg", { key: 'c046c42cb79228057511c716099e5391d793c1f8', class: {
                'range-picker__calendar-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", style: { height: '14px', width: '14px' } }, index.h("path", { key: 'e89dc440b62f53454b4bc145dcb13943ff08d280', fill: "currentColor", d: "M152 24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H64C28.7 64 0 92.7 0 128v16 48V448c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V192 144 128c0-35.3-28.7-64-64-64H344V24c0-13.3-10.7-24-24-24s-24 10.7-24 24V64H152V24zM48 192H400V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16V192z" })), this.renderDatePicker('fromDate', this.fromDate, this.minDate, el => (this.fromDatePicker = el)), index.h("svg", { key: '5aa13f17a8113eb6c5b17ac470ecf30f65db2eee', class: {
                'range-picker__arrow-icon': true,
                'range-picker__icon--hidden': this.withOverlay && !this.fromDate,
            }, xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'ac5533e36e24178d1e6f6fbc85c442f7bd92aab4', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), this.renderDatePicker('toDate', this.toDate, ((_a = this.fromDate) === null || _a === void 0 ? void 0 : _a.toDate()) || this.minSelectableDate, el => (this.toDatePicker = el), {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1596be4ee045d43ea3913b3562ff289918810dbf', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'ced88620af821b18554520ce456f38b4927c5f91', class: "input-group row m-0" }, label, index.h("select", { key: '1ec15c57b4420ba0a8036ef03c5ca90c4fd922ad', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '8b5ca527ae392891eab1efcf83bb8774c280fa23', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'ef03e64b9bd168f56ac10c8cf5e9000f520c4ceb', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '6805c6aef9533fe749c6a7c68fa1db0f841c718f', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '16a13aaa421cfd776b1b0b76cabd33208c64aa70', class: 'sidebar-title' }, index.h("p", { key: '224ab95e68c50c7533c842979ade8eec035bc849', class: 'p-0 m-0' }, this.label), index.h("div", { key: '9723d915716e82c0d898f0b0955838206047b16f', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'cf5609c772eb221fd56fadf3a2c4c3b3d68bb733', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '3a1bfaa300a47f867953f7c67d4041c2e102bd0a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '79fb193b47ac3b2350fd520998dc928872515fcd', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '93c19f7b1bdad07389c958a2a6e204b7f175874b', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '76bb7ecdde37938aa49784dce3f386936e95445e' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTasksCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ecf394ea44f3b2e81065c505be105749e4752085', class: "card p-1 flex-fill m-0", style: { gap: '0.5rem' } }, index.h("div", { key: 'dcb80252c9d2aca602edfbb4611dc00c91c54573', class: "d-flex align items-center p-0 m-0 justify-content-between", style: { gap: '0.5rem' } }, index.h("div", { key: '3c087ef89e9397c04c6d98ad80126446b69688ca', class: "d-flex align items-center p-0 m-0", style: { gap: '0.5rem' } }, index.h("p", { key: '8cc5c659773d0ea72da7db2cdca6db23aa6d25eb', class: "m-0 p-0" }, this.task.formatted_date), index.h("span", { key: '515aa0a6a487769bc4d807a4f7fc9dd2b23544e2' }, "-"), index.h("p", { key: '5f4aaa8fcb4ac1120eac962af3e99070456918be', class: "m-0 p-0" }, "Unit ", index.h("b", { key: 'abd66b604ee7bdc42452805e319c8129a6ee4844' }, this.task.unit.name)))), index.h("p", { key: 'c5d03618d9d40d19091775d7bab985f8fbb2e184', class: "m-0 p-0" }, this.task.status.description, " ", index.h("span", { key: '9948e5e71830f7d1ece024dfd2bc4cbc678976e6', style: { marginLeft: '0.5rem' } }, this.task.hint)), index.h("p", { key: '94950a9ea8ef828608c484f99889bf62a4a5120b', class: "m-0 p-0 d-flex align-items-center mb-1", style: { gap: '1rem' } }, index.h("span", { key: '578ea7070e83f75f83e8cddca056b5f835ea8f39', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: '59df15786efaa08309c13be416446e6dc0489f1b', width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512" }, index.h("path", { key: 'ecacab320703ec38a7ba3a88806e040bb28883ba', fill: "currentColor", d: "M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z" })), index.h("span", { key: 'fbe39ac40715c7cb2f8b73df1124f32ea254634b' }, index.h("b", { key: 'a4e98021b7c12e0b4f74a641ec002af15dfda70f' }, this.task.adult), " Adults")), index.h("span", { key: 'a0e9c1ffec3587853c302e2093393f3c6688d752', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: 'ac8fcc4ebd8d4025e97cbdf58c5df70ffa0349c1', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 320 512" }, index.h("path", { key: 'd09c975044e55b84acb48c1fb9aae7e5dafbd70e', fill: "currentColor", d: "M96 64a64 64 0 1 1 128 0A64 64 0 1 1 96 64zm48 320l0 96c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-192.2L59.1 321c-9.4 15-29.2 19.4-44.1 10S-4.5 301.9 4.9 287l39.9-63.3C69.7 184 113.2 160 160 160s90.3 24 115.2 63.6L315.1 287c9.4 15 4.9 34.7-10 44.1s-34.7 4.9-44.1-10L240 287.8 240 480c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-96-32 0z" })), index.h("span", { key: '8be2c4a2094ea3341ea357c65871e4c4ceff3d37' }, index.h("b", { key: '9e2dc1d0256995ff3857b572e85948895eb34900' }, this.task.child), " Children")), index.h("span", { key: '18a610d59d4452686a44fc420be7742eb394f67b', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: 'e1cb0c8ac9d94f5e117bc786674224b57c21677f', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-baby-icon lucide-baby" }, index.h("path", { key: '0bc8c274fc3f23468ebbfee53d696964d476e6ab', d: "M10 16c.5.3 1.2.5 2 .5s1.5-.2 2-.5" }), index.h("path", { key: 'fa6d8e56f7e0dfbb01191ee18553fc2b44dd7e25', d: "M15 12h.01" }), index.h("path", { key: '7d5083701aac70e9db5a7cffa3f74e16e6497e36', d: "M19.38 6.813A9 9 0 0 1 20.8 10.2a2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3.5 1.1 3.5 2.5s-.9 2.5-2 2.5c-.8 0-1.5-.4-1.5-1" }), index.h("path", { key: '83d79c596557f44b5ba8fdc5b1224dd15bdae263', d: "M9 12h.01" })), index.h("span", { key: 'bbe0dbb1fc0c55b2be4dd9fa0944b0cdf2b5dbff' }, index.h("b", { key: 'dff5d397efa95cc9ca5fb268e8e4f61f82e86ef2' }, this.task.infant), " Infants"))), this.isCheckable && (index.h("div", { key: '42e366c6c4f254c7647909a7486fc8cf0a6d677b' }, index.h("ir-button", { key: '1fcffa9f1a3182cc33e821432085473741b4c294', onClickHandler: () => {
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '507c1b9f5c15c7be8fa514da6bc3a36d03a30142', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '98fae303b9ca03006ebad895186a3fd4d3b2befe', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'd8c211a8511685dc7b973a0ff841d3a7672b79c5', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '77176aece6cc13fcf8d3519cde28d30b0df5560d', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '78a556ba27b97b7657953911de74be348a8a0d61', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '2c5ef32b458f55887d94d4390467a3c24cec1cec', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '48d1df5599d1b2ac8001e6de4970a6c96c164a7c', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'ebff66c79685ff3e20b2f1e4315a4b89f7f198da', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: '5a23c1f6a13cb0f82ed35cff3d971f1e7e030666', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: 'd62832d63cb67982bd442df8dcea600baf10888d', class: "pt-1" }, index.h("p", { key: '9f7ad9085247f02aa56c78e38b81cd9159e5c57e', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales_store.locales.entries.Lcz_Period), index.h("ir-select", { key: '31ab8f8430fa06e626039944b089b2f5cae169d1', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (index.h("fieldset", { key: '306a27049f1a7fb752642cf47fec2aea68e74d52' }, index.h("p", { key: '9f3e3d8acf7f4d44f0e849bca7212e7964afe847', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales_store.locales.entries.Lcz_Housekeepers), index.h("ir-select", { key: '8efcddea8200f43167f55bf03883a847770f1dc2', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } }))), index.h("fieldset", { key: '5e43de7ec77ac1c44dfae7b2520458af7da06e51' }, index.h("p", { key: '1a2f9df4872672c2baf2418919abca9ae4089042', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales_store.locales.entries.Lcz_CleaningFrequency), index.h("ir-select", { key: 'a17346780a34ed8f25c793c0a8f2013f9824ead6', testId: "cleaning_frequency", selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: '7ec261473c07a8c1d1db388aa3d3b0333ec7b1dc' }, index.h("p", { key: '514129392a0e61eac4c45f51bc629a1adc430828', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, "Include dusty units"), index.h("ir-select", { key: '6cdc84ce9f6ea97377c356a3e298eafb718d2013', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.dusty_units) === null || _l === void 0 ? void 0 : _l.code, data: (_o = (_m = housekeeping_service.housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.dusty_periods) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), index.h("fieldset", { key: '77bdf7b4960137be206652ded8162eefc1a0d214', class: "mb-1" }, index.h("p", { key: 'e834e98cf3de2e1f533bc7d4c28cdfa4a2b7cd8d', class: "m-0 pt-0 px-0", style: { paddingBottom: '0.25rem' } }, locales_store.locales.entries['Lcz_HighlightCheck-insFrom']), index.h("ir-select", { key: '2593cacbd392b2652c146b5552c1429a08f1d194', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: 'ea47b25f66b94ef34e1f89026054f9fe32e93593', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '44ad0346d603d37f1f9f82434978e73e1edcdc91', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '89f73fa74a32d200bfefbab746029054fcccbdf1', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '51836c466f027f6a3528c1e5a48f92c82212d4b6' }, index.h("div", { key: '23d7bf50bdd1288d59e02be587f305c78fa79753', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input-text", { key: 'c09756f1a8886194d1bc1af8b09f8322ed36d1c0', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, index.h("ir-icons", { key: '48ca27e77af00ff318db5f3d13c15d6daf5f59fc', name: "search", slot: "icon" }))), index.h("div", { key: '11b59885db5f8447cf4fd78aed0434c116b55b47', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-button", { key: '22b2a976c9e9fabffab02121dc698ba63c5b6284', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: '4bf53aaad04d063dae0ffc604740c5fe86437a3a', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Archives, btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: 'c7c331b26e8d8b19d0adb7fd347d678dceaf1d9d', class: "d-none d-md-flex", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '07d897c452214ad3b1129041ddfdd9e5e782bea7', class: "flex-fill" }, index.h("section", { key: '6132bb07e5ea8b0ae7a68516948e3c0e6600d388', class: "mobile-tasks-container flex-fill" }, index.h("div", { key: 'bb944406b382259baf981db66586eaea954debb1', class: "card p-1 m-0" }, index.h("ir-tasks-header", { key: '55ead99b3b6f90ce7c9643863de70a5429271065' })), (mobileTasks === null || mobileTasks === void 0 ? void 0 : mobileTasks.length) === 0 && index.h("p", { key: '88789898640e4eb7c28e79fd40fbbd8ff82e3a5f', class: "mx-auto" }, locales_store.locales.entries.Lcz_NoTasksFound), mobileTasks.map(task => {
            const isCheckable = this.isCheckable(task);
            return index.h("ir-tasks-card", { task: task, key: task.id, isCheckable: isCheckable });
        }), index.h("ir-tasks-table-pagination", { key: '41700a0f310c40a8d1887f00b506d0b29cc575f3' })), index.h("div", { key: '966f178e5b060247f33041acf8d7e7f30143de16', class: "card table-container flex-fill p-1 m-0" }, index.h("ir-tasks-header", { key: '4f40e7c7224ba22ea68ed936487b215a8ad2e7a5' }), index.h("div", { key: 'a8f1e471a58182167e39b927a2e45a250e36e7e6', class: 'table-responsive mb-auto' }, index.h("table", { key: '09a9d80f043b287c16ebbc769a0a96186e0a34e5', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '8b2158dc12bc08a192d6a41ac8746eab72809a1e', class: "table-header" }, index.h("tr", { key: '688ded02cefa4887a79ec19970dc2c22374e25f4' }, index.h("th", { key: 'd039765a5513a6df5efde9449114e05a15187bdb', class: 'task-row' }, index.h("ir-checkbox", { key: '12b420e557e9691dfc4d0fe6b3943ee1f1ec3b13', indeterminate: hkTasksStore.selectedTasks.length > 0 && hkTasksStore.selectedTasks.length < getCheckableTasks().length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'be316220fbfc2cd8c96f086c92684539f5307c70', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: 'f8b1d96c4bb7ab1ec05650b97d275d5e9f828f9d', class: "extra-padding" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '130102d365553acd0bad44cd00117fe00476365b', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: '38a4220d647b680441ccfbd7a45296d5fe04a174', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '3b1d96c95dbd60bf39275b8cda0dea5e2a5512cd' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '9c2a4715755a1ecc5db35bc91d00264d5ae77db0', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'eb15173f45b9d2f9975df136dbe8f3160ecc6c15', d: "m21 16-4 4-4-4" }), index.h("path", { key: '9a182d7908a02d0c2e9e331af12e173a3be15c3d', d: "M17 20V4" }), index.h("path", { key: '7c2fb880a82559e5f7348918d172d62f2e9adb4d', d: "m3 8 4-4 4 4" }), index.h("path", { key: '58eef8a5fa226c2311a1227228e2a1c8350135d3', d: "M7 4v16" })))), index.h("th", { key: 'a8e601913bad23c1f9aafab24a3e38aaf66b1569', class: "extra-padding text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '8432d0ce6e629eef41a18e158966d8db8e894f9e', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: '6027ab6475b0bc74fa197bbcdce6a98c8df75a75', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: 'bf018dbbd331de7a9d799837fbe2c60156ac7d83', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: '856f5271e721304b76b2554a88dfb4f2d8014466', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '78adb87f5d106845c18a5c74becfbf66d99f3741', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '72aae0499eadd2429e63df67e77d1646f468ecc5' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '3a0a7fc49a36f0091b6ce98ed3327ee60dd132b1', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '99feefceab2ffda041ba7a75e4972e9bf9431fc5', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'e54f4640031337922f7e6fae6912f8b3f8a190e3', d: "M17 20V4" }), index.h("path", { key: 'f434cedd951f3216e26e4aa8cf011b10625b900e', d: "m3 8 4-4 4 4" }), index.h("path", { key: '81fbcb9ea6c6380e93032bd30b5312517540635a', d: "M7 4v16" }))))))), index.h("tbody", { key: '384ff2473903ef5d1434e680012b193533e6bf2f' }, tasks.length === 0 && (index.h("tr", { key: 'bb02791b6d51903fe88f632e47b8c79f97f7da73', class: "ir-table-row" }, index.h("td", { key: 'f75a2a39ffafe7d0981a6f375b7ed94521d02164', colSpan: 9, class: "text-left" }, index.h("div", { key: '9c4c99a723ef411750cbd281ff9ffa6075e289b0', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: 'af8d701c4e62521c4afc84ff4868d3c0703cad1b' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), tasks === null || tasks === void 0 ? void 0 :
            tasks.map(task => {
                var _a;
            ...
            })))), index.h("div", { key: 'd40df35850a5c0f327bea58f02b20ba5ae576037', class: "mt-auto" }, index.h("ir-tasks-table-pagination", { key: '6613390d876d87c0fed2986f0223d100c8e6344d' })))));
    }
    static get watchers() { return {
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6f417827ec1e830dbcc11ea1c5083d363036c063' }, shouldLoadMore() && index.h("ir-button", { key: 'd3c8e51ba0e3fcbbc59f9660c1f3efc420a1793a', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: '68f485d3626b2c1dda34d8f84c139203fd1bce18', showing: {
                from: start,
                to: end,
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '79b3536369db8cbecaef10d3572bf48f2b2f3856' }, index.h("h4", { key: '038663289edefd27cd8cae3f4cc50ced13ea2dae', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '6009a302776497fc751cb8f6f4e94b9a5f0d0a92', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'bfa86383c90dced8680dabcb23f5136d8977eda0', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '2f13d72201bda8a48b368a8ddfe9419ba117153e', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'c9d4be162cfe82c8a5efa010f186f484137ecb3e', class: 'title-body' }, index.h("slot", { key: '761215d9df409719f2cd4b858ea9f4c5f922098a', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '560529ec139a03de2adcf4fbe9eb91ee7bb3a73f' });
    }
    get element() { return index.getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '347942ed3882baf98d7867e54d7fa406dac30010', class: "m-0 p-0" }, index.h("span", { key: '77a4620526a94df63204a227479b7cb2ab7e123a', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '66c7c0bdf03cd02c0d794529db508657dd5555c9', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'e3ce58d3f6b4dae6dc2f656c3793f777a4c4b7e4', class: "tooltip-arrow" }), index.h("div", { key: '0227bd761338ab314be0e8759947dacd09cecc76', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: 'f6a5bb3e766c9c4d78426c2b314d21955a56b5a7', innerHTML: this.message }))))));
    }
};
