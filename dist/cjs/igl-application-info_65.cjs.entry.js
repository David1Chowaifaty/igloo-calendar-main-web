...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '13d5799d1e3851447d13bbb725bdd6845ab1a1f6' }, index.h("div", { key: '24f23af334a099196e8881c2476b8efeea902b00', class: 'd-flex align-items-center ' }, index.h("label", { key: 'e33b3c8e98950727e7ce4b4e9deac7b24b493070', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: 'f0fb3aa19f775c3ba1a94441edc99c69118c7c99', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '9af2ad376f6a8b8f1636427d467fd74c2c4d73a7', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'fd7c99c558303f1629039e44b5170f058c38defe', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'f21f92425933083f7ae953b6ef67dba59953af7a', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '643ef74374b2e24845e1519bfc9ca6bc0ced2008', class: 'sr-only' }, "clear input"), index.h("svg", { key: '98329699ee97973d92a19d7f5b78c8710ee3a629', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'a2c869a9de4f8f33601fb5939b38a01eb9d786d4', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrBookingHeader = class {
    ...
    render() {
        return (index.h("div", { key: 'b25c98073012ed54fab8f73c72f154dbed36a0be', class: "fluid-container px-1" }, index.h("div", { key: 'b3b9f4032207dac70a894dab45f5ee44423256e9', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: 'eefbc1368576bf9db0bec7b7fda0426735e76c7d', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'ec73c7a30a7b03bd0c2d49c402c867dbcf125264', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: 'f6edf9e1cb5189b0d46dbbb7c3c6c69917eb87ce', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'e60711d0b58de037c180a014db39894748547902', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'd4a5350e5f80619b8185dbe063250b7252ddfed2', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("span", { key: 'f36d7cb54dbdf365c3fd9e91fcb2900a63189d53', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'f878efb2c0ad3dbb5002ea5e831c4851f1ce9e7f', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: 'fb8ae50e82471ead947848ea268fc0bdf7152180', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '5224ac44af5b02535f573d8355bd56e4c9004a19', onClickHandler: this.updateStatus.bind(this), btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '41415f671177f3aae80c86ad76c517a61430011c', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '5f1fef717caf63a01b10cd219b8fa8c480ffc136', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '3e0e649c808e038d843de1dfc0ddbac560b1aa0e', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '167671d7ddeb07a32c391a72f0d0077a2699b2d2', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '80a880fefa51a69f10378e0f8d7a49a820f0f0c2', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '2a4ef4fcefe2ecc1357796822bb7bc47f7147a21', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '662f942fe4ff3cf47a26fd177ef5792fa536777f', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '323837b6a0570eaf08e3481cdc02267a51702feb', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '1eff0564a4ed2e40e41b39dd0e013fbcd8f0872a', onOpenChange: e => {
                if (!e.detail) {
...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3ebd2934f603bf3eb31c38070f6390e0d8ec1b26' }, index.h("button", { key: '3fbd7883a13b1470a0e706edce5b4c73b086bff2', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '923d0b5de398bc83b8de3a5fa64ff81b3848e627', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '649cc831c561a8d97b618cb354c8453704a264e5', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: '45ceeea0ecabdedb6642525abbd0de6494e8656a', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '8fbc1ef8a4a8b8ca5e70f30b62cf44ce5d51a02a', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '03fafb5aa913860e2ba09538e58d3d4d54a23d3d', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: '71747887cd34780e7252509638d6c7efe72c3a0c', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
    static get watchers() { return {
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '458a23d1fb81b59ed0e0a396e4139d63e2feeb31', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '4b6822379dcbe55f3a7f756712b46e178c29bc30', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: '9214bcab328c063cadf0256b73a149ff291e2d97', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '0024bb2924395f856ab0c4ba4a8b02de412f3a12' }, index.h("button", { key: 'b02430b6dc671f8a660a10ea87a008b9a2eb4047', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'a6c19323683e9401d0de08be3b392b3333374d1d', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '8cfa020be603178137840829deff7024cfc110eb', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '51e424b8b304bb2c5b90fefe2c1894d63c88eab3', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '3ebebfaa94dac97899fa089194b29cedc726693e', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '457cdbf56fe710f4dc54a8118383a0ab8d8d2350', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '77037f0c854fe434025f148ec1cd5a2a90a6b58b', name: "trigger" }), index.h("input", { key: 'c1ed93363ea0d56c56ecfe54dc58defcf4fda05b', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '749c479c75b918d11b6c04179c3060270f647758' }, index.h("input", { key: 'cbab33907846edb34cd9572a4abd59f415767ad8', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ba636c4ebfe658ccd25e4038ec08f866e4372a64', class: "d-flex align-items-center" }, index.h("span", { key: 'c7bd625c317db6387cfaa87c5d94b6f1fb2b0b36' }, this.dates.from_date), ' ', index.h("svg", { key: 'bbb0aef8e1df7c9ca1e7f3dae35ae646cd9424d6', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '5e636d53cec37c224d095dfee5fb3293af7f527a', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '25aea196ba016cdc01c2cac7fcf84390f77507ea' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '41df27e61533be1679ecc8224789f2687d7e1dfd', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '84a909c84b08d213179c304485b2be144a2f7db8' }, index.h("div", { key: 'ede9751abcc4aefc4458077f1ba4c0bb8d5aca35', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '617d974029a76a019672939c1142965c4cfcfd61', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '2f061a1cb0bfe063ed4bd66f30f8d0c61b7ccefc', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'bf072cbe2704125d8cbc43a74df9775a61a08604', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'cdf5e6117ba542b265c682f09e8a54f4944a6324', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '28882e22499de7a7127710bf90862d3c82526ea9', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '743444a333f226b3e42ead3fa9702daedb228fd3', name: "modal-title" })), index.h("div", { key: '5c14f94dae8ecec82cf1a6bc5e54aa08890e8a43', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '6b9d85a4605f4c93e556ccdddad325c0a5a6e6b7', name: "modal-body" })), index.h("div", { key: '98fe7b0a41d02ba1b1ea8a05d8202d1498475d2c', class: "modal-footer" }, index.h("slot", { key: '011bc66190ba1db5aee36b5a07da06b6777ee123', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'bef68a4cd7f088ca688b625fc3ce33780279652b', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '8c4643cb9b9c6ae3d670ca46d9f1b65947e82ede', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '0d6c6f7e070a806361e9b5138c5cb76cf5a32bdd', class: 'px-1 sheet-body' }, index.h("fieldset", { key: 'ba416d63f97b31b30daa9c203703bfc8f3d287e4', class: "input-group mb-1 service-description" }, index.h("div", { key: '3d476136bfb8de2cf294899c3c952a4348791ca0', class: "input-group-prepend" }, index.h("span", { key: '8ecadeb755376ff9aa14a93b992fb850c747b702', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: 'f8789eebadc0a37c01c3cc6edb5e2ce97e5383d6', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '6e9a92d41141f66129ec4475d166be3ebd11c747', class: 'row-group mb-1' }, index.h("div", { key: 'f774c4dc4ecd0fe47a05486381926a0ae8cf32fe', class: "input-group" }, index.h("div", { key: '3bd20267bc79846fbe4c9c5c8af8964863326234', class: "input-group-prepend" }, index.h("span", { key: 'e1699ac72d5700822825b3443f29d6e93839eb70', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '41b033afeacb55fc385473136a0d61f46d3681dc',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '9cda2a0161cdaff8a73c07f2226bfae67f942743', class: "service-date-container" }, index.h("ir-date-picker", { key: 'fb3a7de9c16f051684572a97c5a42274d89e25a1',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: 'fcf04c3f26b4e2b09b1ec2a610d6087a1089971c',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: 'e3fae9d9f80c1a64b542c9bcce6b8d7b2c1d2e5d', class: "btn-container" }, index.h("ir-button", { key: 'e6517dd2c385d247e95bf9127138bf88546bea5e', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '46c1d68d0680ed57777a21171df3061e818f8375', class: "input-group" }, index.h("div", { key: '25800474030e2cb1c70242aad53e358b10d99873', class: "input-group-prepend " }, index.h("span", { key: '7e9c2660fe045c3772e290449c92896673358922', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: '9a5726a62e7e71690c4265820fd3e8f758abde25',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: 'd6d1f818f0e02ef3fb4a93acabc43b7e30c04926', class: "service-date-container" }, index.h("ir-date-picker", { key: '66abc95f56c4c8d304180eb13e3d5069bdd7fb08',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: '964a3a6c1b64770bf8a623a99ecd6c401d134c61',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '5eb4606f5b0904fb2eab9cbe8e5b9d6860d059e6', class: "btn-container" }, index.h("ir-button", { key: 'd5d7423ee3ac9b1ba933841b2eae1c70fb6833db', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '51033c1dfb51d8b39b835eec4d4fb9f2cff380d3', class: 'row-group' }, index.h("ir-price-input", { key: 'ab45fa838c01fcf9cb6ee7c020c99d96e188acb7', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '26ab4b2286dc702a087422629c98ede4e58b9189', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: '7c5913855b87a4e5e499cc3556aec80c13da7eee', class: 'sheet-footer' }, index.h("ir-button", { key: 'ad215f96a02f2feec54aecc567ddb8804c1422df', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '0a88e07538ecc4b4c157f8be20f06bf4a599ebc9', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'cc388725a144599aa21baba30b316af800900f72', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '08ab09b7812e2cbb34a380520a1ee3ee46936e5d', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '2a682baf5b5bbeafa869009795d2156dbe6d0d23', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2139dcb20fed8c2af0e700e29d7b23be96cf2880' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'b470238fa54ce91dca18ccf531d94378a8a1265b', class: "loadingScreenContainer" }, index.h("div", { key: '5aea1c47fb81dc90ec609140abab70d0427bbeaa', class: "loaderContainer" }, index.h("span", { key: '7107f5fc84134b963f4335a2797c24513e2078dd', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: '462374d4491a203d3b9abf2a51bd04512ea204a7', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dd49142cf346543a91babdcf1852d8c759e5dbfe' }, index.h("span", { key: '5f1cb06ca780e1746ea49ede77cbd5d59d3b34ef', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'df60233f513d18ea1db4434703c0ac60880edf05', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '5a71db597c6e1fe598d09756fb84ac2ba2f1ec9d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '4122681aa4baf425ea32dba38644382f326f3668', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '50cd70cd465e6a57035fc907b96dfd18174e5571', class: `ir-alert-header` }, index.h("p", { key: 'f8fc7fafa43d553ddbcaa2617c8ded1948be6b76' }, this.modalTitle))), index.h("div", { key: '1f7d9a0bd758eab13421f620cd99576503b79cdd', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '07a31be6de13b0fc3d9d1c8b9277e000d126ab10' }, this.modalBody)), index.h("div", { key: '2e503d3c5057cee454d9fa993e87dc60c1a051ab', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: 'dd386faa9f68a9b5f1310e5cc6a2088a7eb8b487', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (index.h("ir-button", { key: '5fa04ff1995e42305f9051a9f0c469b7937a270e', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a6e405323ad29345f2146cb53219df42be80083e', class: "otp-input-container" }, index.h("div", { key: '4b123984f725e373e1ef292f21d3945b2a70b9e3', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'af8e706ffe21fb97cdd97dbe0493fedc207ebc54' }, index.h("div", { key: '51ae77fe6560441c6b2a7f4bb96a4c646d2a09e9', class: "form-group mr-0" }, index.h("div", { key: 'f677e670abcc01905f8575874f9ea35415d3b1ba', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: 'bca216b19858db4c1c431c5e79192ed941f4d513', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'd86612f6234b58747c519beeb1a057dc63bb33bb', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '6e98ca7b3afd03856f24e5d4fe9193284db6b712', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: 'c9407f67a39eb77a50459fee9c206c7e7135486f', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: 'c8121fadd6e48b2658d0c079eaeb2d45bda43353', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: 'd8241325e80a6ce48e4e88a518f61a6bfb405e6e', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'c7236ba16d72312579a79be7de3586420311b3cd', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: 'b1aa8de3449b20179cdc0ede455ae0d600fbbade', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: '58665eda1cc00edf727afb7e980ac63017dbf881', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '38dddc882a624688fd43da39cb56fc224bb8fb45', onComboboxValueChange: e => {
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: 'e97d337b9a21f2e711f6a977f520036b36366b8f', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: 'c0a3f204883851be6f497a5ad819cc6ded7619f9', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '6c895c20060c9d6ed1b4104d5f9cdff69143e953', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '3e681bdbcdedc720d01adf50e121019ee2fed9c0', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '7dc91ed82e321eb618c2bfdfb51ed30c730a8c64', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: 'bab235516bd0f52f5dd1dcec28c05c3f63b1f4cd', class: 'd-flex' }, index.h("div", { key: 'd7b3639627d7b4c69d98a96e50b08588a552c45b', class: "form-group  mr-1" }, index.h("div", { key: 'ee48067dc5bdea1aa3c741f7481ab276ad68e359', class: "input-group row m-0" }, index.h("div", { key: '7d676169869b485e74aa4a1c90c12e69e29efab9', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '2dec3d49a845b60f27e682e1af7d53f8683f0543', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '27cd44f4e6d64cce217f4057ee2dd09bdf34a038', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '98c6eca97b1148df1fcde173f4dc6ca1bb6cbd8f', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: 'f74e1a71e0535b0e8355927d3e2d26a27d141a96', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? utils.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '9730b0336326f20ebd827758e18d29091a2b4719', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '81649cbe9cfd80e75aab44f26099cc8629560088', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '7826ed9135e1bf29b65cd5d5e70a4f2d2d986345', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '0464b7f147d30912c855ec592dffad16d584159d', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '37db97af19f6b7039403a7414e3bf59700c57425', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '2660fc9876293a95c70175929c6becdfd763c055', class: "price-input-container" }, index.h("ir-price-input", { key: '90ac971d4643253871a82927ef6fc7d48701e719', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '4752763f92bfcd247d7f1eea9172f0c359d9d899', class: 'sheet-footer' }, index.h("ir-button", { key: 'd3113f7ad6be750e5257224532a5dfd5e57bea44', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '7aa1d870e2fbe1d787c02eacfec98adac020e297', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '7d902a357759760c346edfaa34bf1de1b724bcbb', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: '13f62c503e4f20971bd1bb25ae04f5507e7b6e58', class: "input-group-prepend" }, index.h("span", { key: 'f0a36c59bc33f8c4d2004bdfaf1e8bee7dd101e2', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'bb36331b3c7b604757367d5fb87253c88f86f44d', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '6108b1ae0339a7b5f4bc4559eefd9b1ffd7a377f', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '4169707c83b914053b5f442f34c68f91e83a89a2', class: `input-group-prepend` }, index.h("span", { key: 'cd20a40e2b10c31e58edb0d9929276364289e5ed', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '5526e6c97f3363e26799d7d2dcc7f94bc402ab2e', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0b05b7ab21509929338b68966b3ab2ec505f2487', class: "card" }, index.h("div", { key: 'a1a8e4214a5ff3b8ce516fb651d3c7076b804c25', class: "p-1" }, index.h("p", { key: '9af68fdb483d3c0bcf137b5b37b147d94b8442d8' }, this.booking.property.name || ''), index.h("ir-label", { key: '777ae4cd6a12b6c82490bdc73c0899e90ed0005f', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'f75815818fad76425652e036952f544e67610c7f', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '24bf5e246335d6bc68e4fe6ddefba6a41195f1cf', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '8f95ee2392e43c663f80d26a657d7e486d1bf6e1', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '164e823047cf03b97acfcefc6025e3747255e0ae', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '61f090b34af81dbcf181cb1f2138188fe0b72819', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: 'b1afe01d322526abe5eeb828088edb43634710cc', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'c8082b2af5e1b1512d2fef5a39d0da4d3bf828b8', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '6a30adc3cb73e05ccbbc3e3928f12d7dd1175548', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '30e7fdbb43f201c82dfde85657db1dc78e3e1bd6', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'ad8d01effd359a16a906bcb45d536f98012e4d44', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'e3f7afc3853aa5c282974531e6e8736e94f8bd43', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: 'cc366cda9b7cf1ea7310ffd4cb508bdb900b2888', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '27e276c78b53ed1f9d3e7cb609cb67a1479330a9', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'f02178be26efa96c77214a217b2214e921bc873c', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '23277c04ebc4f7439aec500786198b2fa8fa24f4', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'a8e6b199934e7ac32fba182b77af3d9f75b6c8f7', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'a2f6f6d557f37e5b511b539134b121ac91079a27', class: "d-flex align-items-center" }, index.h("svg", { key: 'e0f40acd2382539245a0ecd6ae35bb855b52ffbe', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '7997a8f6020748157d606fa4316e6e31ae926e9f', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '7dfdbb2686c01ca0d07689c4369981f160144573', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '840bc48c9b3f68ba620f327793efdf46804747e3', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: 'ebcd4094f75bfd807312ba1c000388e639bc0ff7', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: 'ad73db2f5a02ce6a6c0a3eaef0f7643d29714338', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'da262b842f324eaf501fd4e9119db50468d9cd2a', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '5f187fd6b8a285d4a745e8cc31626609df3e2e3c', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '4c293c0d05bf4b04dfc1d81d525fa1380e5552b0', class: "flex-fill m-0 " }, index.h("div", { key: 'f6ec2c84a9860a02568473796d6f05424fcb9329', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '8da2abe30f1ad10420aee1b5ea3a5ec6d1c7af46', class: "m-0 p-0" }, index.h("span", { key: '7c8143818126717f12faee55ba9bb88a1026fcad', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'a08398890dea99827576809fb5275ed1a241353a', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '8ad4122b6ef9e4cf53a1834815b9675be2a7d267', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '61c44b5093a6344c1b9f29f2b4babe3b92adb382', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '8068a86bf319e442fba22480cb9505cba7ba7995', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '77884b05adfbd4ae38c2cdbd813423a64e9a89e3', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '5dc657017219cf8da9e96b0111e95a4d93a2b071', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '310187d095ce1bd4e583ae2d1d805876ffe53c02', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '7e4bb0d02fd4e5711cdff337190a3668875e46a8', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '21272597eda23aa9b798657ee34978b8dbc1a97c', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '0f949b7ec16a5e633988afef0f0be3f84ec61d5c', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '64e3ba1b8cde9e572af3b1ce5117de1775869bf7', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '84d59525b1326dd02b072fd0d7927806ae5f25aa', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '4d76be0cf436ae211ab2a43ec8d8e7435bf442c2', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), bed && index.h("p", { key: '4713032c948ee87c69f6fdd7cbff3aca21bb8d3b', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '7276c10a8e6c1f5540a6be66e1380a262211c625', class: "collapse", id: `roomCollapse-${(_b = this.room.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '2af978fd982314147475a467ac31ffdce3f24d80', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'd708904f34670e44e0e30c62dd6e5b33f59f23c7', class: " sm-padding-top" }, index.h("p", { key: 'd5d9ea3da033e2c9246bdbb02b93b1997758a55b', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '6b745105f38783d474d9a35eea8998052c28af43', class: 'flex-fill' }, index.h("table", { key: 'c829d5401281c29f5c2860013275b11437860222' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '1c61084e488c7a4b6e78a264d625d7f678229d32', class: '' }, index.h("th", { key: '5ded8f64da517cd8192fbaebf0f2208362004939', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '578965431ad1ae7d979896996aada079caff873b', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: '8ff9e8cf488d985e534b9cbec6275eb30d5afb0c', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: 'e1ada6547e8bf1c80e997225aa5d4f78e8f50679', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'f5967959b13be950032e5450c03a51f05d198df3' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '9640c5245ab71346d9afb6176f48e24dc3f94e84', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '290c465b2d3207ba3667ed0a86c2be87da16f40c', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: 'ea90aa9831b1afeb88b896842eb872001d7be8d0' }, index.h("ir-label", { key: '0be47d4e79af0d5fbfee5d4a97be79478540e1cf', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'd0a782aebfdb91997f249938865d609f83b931d9', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '28055ec7913c63130bc43dfce504d4829b105177', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
    ...
    async saveGuests() {
        try {
            ...
            await this.bookingService.handleExposedRoomGuests({
                ...
                guests: this.guests.map(g => (Object.assign(Object.assign({}, g), { dob: g.dob ? utils.hooks(g.dob, 'DD/MM/YYYY').format('YYYY-MM-DD') : null }))),
            });
            if (this.checkIn) {
                await this.bookingService.handleExposedRoomInOut({
                    booking_nbr: this.bookingNumber,
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '5b4a9459feb82eb041630b5bc40fd3193624ea65', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '44b9f0b4dc7aab86ab19e96eb2ddf5d65c792134', class: "input-group row m-0" }, label, index.h("select", { key: '1ced8f3ffc5e2a8a348fdc7a8230cf8bf0f53628', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '26135a3125b4c02f2df2d3922b19f4049f162c2e', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'bcee53f8e44d0da6587a83c1f168f6231248e4c3', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: 'fddffac2cb06ba3ca770910645e22c0ebe9382da', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'e41ab0573273bc74d9ac50f1c5132a76b2f410c9', class: 'sidebar-title' }, index.h("p", { key: 'bcc26af08dadb5f062c84912c983baa887dde81f', class: 'p-0 m-0' }, this.label), index.h("div", { key: 'b8c8675c447431bb35f4c20ead8b0d0bbd8826ab', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'ac9feb1b85fb3798b0c04f26fa3500758e8cb689', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'f26f7481305c0b6800d9483c3349cd450515ca71', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '3255c49860961e56cf553a969a7258436a7cfac7', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: 'e4e6063eeda16858c9000598a3947821ede72861', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '301c78e9713e0ddee7cba0acc18c2a606af2dd5d' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTasksCard = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c7d9224f5e8af81495c0478311e995aaab5129ed', class: "card p-1 flex-fill m-0", style: { gap: '0.5rem' } }, index.h("div", { key: 'e7484cac24fc1a9e8eb34861d2cd776686c175fd', class: "d-flex align items-center p-0 m-0 justify-content-between", style: { gap: '0.5rem' } }, index.h("div", { key: 'f233f81e5c6d1def84b59c289e201b648a26968e', class: "d-flex align items-center p-0 m-0", style: { gap: '0.5rem', fontWeight: 'bold' } }, index.h("p", { key: '38dc90c9e0c749fe6bcda0f5dea1ce5f5bc1bfa5', class: "m-0 p-0" }, this.task.formatted_date), index.h("span", { key: 'e5170219a0573500ce57d9845a379017d99035aa' }, "-"), index.h("p", { key: 'd561094bf859c73630aeb258556a3e7fa990da95', class: "m-0 p-0" }, "Unit ", index.h("b", { key: '2babde0842858044193baecbd0822a8eb34e629e' }, this.task.unit.name))), index.h("span", { key: '172cdc3802822e218150722bfb31b23564872a78' }, this.task.status.description)), index.h("p", { key: '4713a528b7d13a85b37c61e67d6ba3186f432702', class: "m-0 p-0", style: { fontSize: '12px' } }, this.task.hint), index.h("p", { key: 'ab03b1fb06a30c965c71a819a02de5ec0d6c6236', class: "m-0 p-0 d-flex align-items-center mb-1", style: { gap: '1rem' } }, index.h("span", { key: '60cb4fe6fba42fb2cc6a4c458b3f7e38988408ab', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: '46a3f6b7ee6e9023c8b027790da9f38bfa89311a', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-user-icon lucide-user" }, index.h("path", { key: '9227f5b5c73341e9378a95546a1363acb72df76e', d: "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" }), index.h("circle", { key: '98783125bb8c796cfef00a26c426e9dfb7250e25', cx: "12", cy: "7", r: "4" })), index.h("span", { key: '316e0a149365d334932674e28ecb51833d5e43b1' }, this.task.adult, " Adults")), index.h("span", { key: '72662c248aacd13efb0f1f0627a66502d2d1721f', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: '16cbb90dbf5a27eea9b1006ae831690243ce16ef', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-users-icon lucide-users" }, index.h("path", { key: '4d9fc8aa1899b1340f949cb14db10f7c83bc631d', d: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" }), index.h("path", { key: 'dbeed478ba7d472cb335623a9dbaaabec031322e', d: "M16 3.128a4 4 0 0 1 0 7.744" }), index.h("path", { key: 'b7689e7dade7e5ec8a15b157045e614a9b96ef5c', d: "M22 21v-2a4 4 0 0 0-3-3.87" }), index.h("circle", { key: '819a1ba2875b7a7818c46cfda77c27fb9ef6480b', cx: "9", cy: "7", r: "4" })), index.h("span", { key: '642d07c437e6c6402361a4aa38d087376a5bf0b9' }, this.task.child, " Children")), index.h("span", { key: 'b785c6d21e05fa21db03a7d5dedfe0f9782d02c2', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("svg", { key: '7d71282ed0a56a495a0b4c044fe6bc4cc9beb619', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-baby-icon lucide-baby" }, index.h("path", { key: '3ee9e25a90cea7fb6daabc3af8b8123bc3a2117f', d: "M10 16c.5.3 1.2.5 2 .5s1.5-.2 2-.5" }), index.h("path", { key: '461025f341584b15e8a3568d5e6a1ab5557937ea', d: "M15 12h.01" }), index.h("path", { key: '98df4199a514275b14453a0ed1c5625cd0454409', d: "M19.38 6.813A9 9 0 0 1 20.8 10.2a2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3.5 1.1 3.5 2.5s-.9 2.5-2 2.5c-.8 0-1.5-.4-1.5-1" }), index.h("path", { key: 'a1bc2bf5e1e708863098e50b22b2efa9ee498849', d: "M9 12h.01" })), index.h("span", { key: '15ea4cd814da812496b5af4c296f6605da4166f6' }, this.task.infant, " Infants"))), this.isCheckable && (index.h("div", { key: 'b4d215cb3955a99a6f8b1998ead98909bb05afcc' }, index.h("ir-button", { key: '4002d69af7b44e0641b7100eee7b61f892265793', onClickHandler: () => {
...
const irTasksHeaderCss = ".sc-ir-tasks-header-h{display:flex;flex-direction:column;gap:1rem;margin-bottom:1rem;flex-wrap:wrap}.action-buttons.sc-ir-tasks-header{display:flex;align-items:center}@media (min-width: 640px){.sc-ir-tasks-header-h{flex-direction:row;justify-content:space-between;align-items:center}.search-filter-container.sc-ir-tasks-header{display:flex}.action-buttons.sc-ir-tasks-header{justify-content:stretch}}";
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '895464bc6c01d33abe6c952c831a2356af9f6e0f' }, index.h("div", { key: 'd65a313ac165105cf69ebef18ce8e26aaad6f4d2', class: "search-filter-container", style: { gap: '1rem' } }, index.h("ir-input-text", { key: '34001001acabe7c1eb421bf4a6276b32038882af', class: "search-filter-input", placeholder: "Search unit", variant: "icon", value: hkTasksStore.searchField, onTextChange: e => updateSearchField(e.detail) }, index.h("ir-icons", { key: 'e537af37d03fb25c529a8fe141991e177b9ddc0f', name: "search", slot: "icon" }))), index.h("div", { key: '4f28d0d83b28b3b39db0ef917526e424db7380c3', class: "action-buttons", style: { gap: '1rem' } }, index.h("ir-button", { key: '1a33e7fd8b0747713d43f25aa8132c540300b673', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_Export, onClickHandler: e => {
            ...
            } }), index.h("ir-button", { key: '604d3fd2609a377ece69477729e041aa93a26e11', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'cleaned' });
...
const IrTasksTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2374d80f19ece5fb1afcf031c7f63b4b0459ff51', class: "flex-fill" }, index.h("section", { key: '0f438fdaa0632b60422f67e2ed42ce108e5c1724', class: "mobile-tasks-container flex-fill" }, mobileTasks.map(task => {
            const isCheckable = this.isCheckable(task);
            return index.h("ir-tasks-card", { task: task, key: task.id, isCheckable: isCheckable });
        })), index.h("div", { key: 'd8d291d9654b42d736f098c0342a871ae2ee5137', class: "card table-container flex-fill p-1 m-0" }, index.h("ir-tasks-header", { key: '77cdf1f91dde0a4c0937f2cef07a4ff82d0b6458' }), index.h("div", { key: '2142b55d7606044095e1a301d6cbb9bafd108a3b', class: 'table-responsive mb-auto' }, index.h("table", { key: '7dcd836e3d199898918cf350396f7870ce9d6e88', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'd95aa49e8438b8d24235ad34c15490e2df53e538', class: "table-header" }, index.h("tr", { key: 'f96c41c4e995590a297230fe016d30112757f88b' }, index.h("th", { key: '6230d84786858111b8f1d67437945c1def386424', class: 'task-row' }, index.h("ir-checkbox", { key: '4a31444172f4fefd995a0e16d1f5f5d2dfb7aa44', indeterminate: hkTasksStore.selectedTasks.length > 0 && hkTasksStore.selectedTasks.length < getCheckableTasks().length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'ff2f1dc7d1a2be744f116bc55399b0782c67c5b9', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: '9e549edaf1c348da52d42dc44c880358e0d6b2c7', class: "extra-padding" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '3556a4ef2fa7f7b7b33088a5eb5e7b3195480788', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'cc118d8242bf0a3cb08ecf35dcc043f433ee9b33', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '71804ca808ed43cca1511a92685a1a2d590ab16a' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '3c2deb8c3aad84d4172e2813e408a3f38fbeaeea', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '955e8cc5549231a60edf141d4e42cabdc59ad093', d: "m21 16-4 4-4-4" }), index.h("path", { key: '159c4276499ba6667a8f9c749ba9950d609876e1', d: "M17 20V4" }), index.h("path", { key: 'a99f11ee75cba4562077dce321673a842c9ae379', d: "m3 8 4-4 4 4" }), index.h("path", { key: '1e3fad02f74aedcbc87ed2e6ee173060d8ace6b4', d: "M7 4v16" })))), index.h("th", { key: 'c1aea827b9167ab6674aeda8a37d0af76fa3dd60', class: "extra-padding" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: '82efd58868a680fcb4bbd9a2ec789915d7c50832', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: 'a0dda92eeaac2f9ca0f4b3e80c69a1c6f3c6cacd', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: 'fb85163f85bd95b116c48f98f91a39fa24949b52', class: "text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: '351bc83ac155269d1cace5e491f4b0d85e28ee0f', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '2abe20b4b6455aed75a9595a6e125b21b545170a', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '7404cf5129b9690b268010bceba2a579a376e6cd' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '771d342f9943e4ebb2c1d7c860b7948f3c3d90c1', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '1a7132e1789d3b14484b1d3d50bff0a7c2e8dfc2', d: "m21 16-4 4-4-4" }), index.h("path", { key: '509e184a1ccee5817e52a06119b0551bb1d82583', d: "M17 20V4" }), index.h("path", { key: 'dc83f666a57cae04361ca27d7eb40a3086c042e7', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'f6365de1d2d40260b22ed715ebd9063111a9b112', d: "M7 4v16" }))))))), index.h("tbody", { key: '3ccdc09388cc1429889b5ff0ef77e1dfb8f9e952' }, tasks.length === 0 && (index.h("tr", { key: '386c9609a4fd2ae27e1c679cc1a58cd2e5a9c196', class: "ir-table-row" }, index.h("td", { key: '626ebfbce0d7005bb304dd8d61b62878e8c238b7', colSpan: 9, class: "text-center" }, index.h("div", { key: 'caab3601395195dbd9ac716433abc08cc6d33ecc', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: 'd60fa45eefa09c1896e1af97636f29ace7d63774' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), tasks === null || tasks === void 0 ? void 0 :
            tasks.map(task => {
                var _a;
                ...
                return (index.h("tr", { "data-date": task.date, "data-testid": `hk_task_row`, "data-assigned": task.housekeeper ? 'true' : 'false', style: isCheckable && { cursor: 'pointer' }, onClick: () => {
                    ...
                    }, class: { 'selected': isSelected, 'task-table-row ir-table-row': true }, key: task.id }, index.h("td", { class: "task-row " }, isCheckable && index.h("ir-checkbox", { checked: isSelected })), index.h("td", { class: "task-row extra-padding" }, task.formatted_date), index.h("td", { class: "task-row extra-padding" }, index.h("span", { class: { 'highlighted-unit': task.is_highlight } }, task.unit.name)), index.h("td", { class: "task-row extra-padding" }, task.status.description), index.h("td", { class: "task-row extra-padding" }, task.hint), index.h("td", { class: "task-row text-left" }, task.adult), index.h("td", { class: "task-row text-left" }, task.child), index.h("td", { class: "task-row text-left" }, task.infant), haveManyHousekeepers && (index.h("td", { class: " task-row extra-padding", style: { textAlign: 'start' } }, (_a = task.housekeeper) !== null && _a !== void 0 ? _a : locales_store.locales.entries.Lcz_Unassigned))));
            })))), index.h("div", { key: 'f19f0e4f4f285b98c34836a309af48bdbff2a5ab', class: "mt-auto" }, index.h("ir-tasks-table-pagination", { key: '727b2b63288240a4a7dfe71b7f3fcb9f7825aadd' })))));
    }
    static get watchers() { return {
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1cf12f61c6274d71824ec6d5d6799d25965bd077' }, shouldLoadMore() && index.h("ir-button", { key: 'a403a90a32a59a69bc0cd2781853cd2d9ba39925', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: 'fed4129684833fdd1e2111d3c908238e97ca7221', showing: {
                from: start,
                to: end,
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3828476ee291c26d8024de2e1945ca88b6263207' }, index.h("h4", { key: '39146c9703b9c79cfda120d46ee3e20beaf55bad', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'da7c5b18a7577a3a17321af206ed966ac71bc996', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'd02b217a81fb954e6d080d6f59a4dcda38443b36', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '12e29fdb8d139e10bcd88e2dae4bcd52cb7555c9', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'feee0152800b2a652496cf02cf432a5949aec17a', class: 'title-body' }, index.h("slot", { key: '5be27e8912eee1eb814007500caa6be5aa502922', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '419810172bca78d429b7478f02cccd1421ccd5ae' });
    }
    get element() { return index.getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4a9fe089868835bd3874c354c1e3112e86887690', class: "m-0 p-0" }, index.h("span", { key: 'a8a293bd53831a836d5b00e279fcf0b5e9d8945a', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '452aad7402fbc15865820b15658b74117387f86a', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'ab13210dfbe2b14b57a9d33e7acf7eab4883f2fb', class: "tooltip-arrow" }), index.h("div", { key: '63f1dd941d812ba8c7a217df04e59222dc0181b6', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '1919f96aa91138bf9a6d891fa6e4abadbd5b1aa9', innerHTML: this.message }))))));
    }
};
