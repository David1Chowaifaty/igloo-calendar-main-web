}, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'eb7984cc85516dce91c3d5fe012d2cff25afb8b1', class: "loadingScreenContainer" }, index.h("div", { key: 'e450762a60f0a104ac652d4763e7ca1985b4e3e6', class: "loaderContainer" }, index.h("span", { key: '70c6fecd43eba810c80e15d3cc96887e1413a60f', class: "page-loader" })))), this.showModal && (index.h("ir-otp-modal", { key: 'b1db3d7122c1e5ec541c3e2c90de2b8fac2abcb5', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7cdf5089783667e4ba64aed5cdc4ab5f29e639c1' }, index.h("span", { key: '633d028ce4547e18cc018ed6ed7760c548db8722', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '24496810abd2d41ae2708c8bdb19ff17e9eeb30f', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '8f9f74f8128fcf2fd9885c12b3f4da5aaf67e1cb', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '46a28b2c6df535f29559e920fea24d474d5453b0', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '8f6160c5c314688bd208fd5b4449ad65dd3c6b23', class: `ir-alert-header` }, index.h("p", { key: '27dd69ad027efa9c32b3f27aad338e619d43d4b9' }, this.modalTitle))), index.h("div", { key: '97bfa58d29215a015704870b33cee8336f500eef', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'e4d78306e863168bea9148bead564d6e26f6059f' }, this.modalBody)), index.h("div", { key: 'c85a0640f279f974da972bdee972381c86cd4ff3', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: 'c35ce54e9bef45047007e0a710f4419762f96da8', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (index.h("ir-button", { key: '52c15990f98dad0f3b0aff1b35f54488652baea5', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'de727a5ca03029738d5275636060c6a16d56a996', class: "otp-input-container" }, index.h("div", { key: '9cbb8c25026941a732e5abdca4ff660d4705f522', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'a4d26bdd13711d6dbaf917adf0774ed12be38397' }, index.h("div", { key: 'cbbbd020fead5ef56e2d21d686a8781bd30f0313', class: "form-group mr-0" }, index.h("div", { key: '3dd077bc04ce72817505fbee479a2fd5b77ce48b', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: 'a84a20ddfb3a8404a5cd330d6b1d9d61d1fa8ab3', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'df8eba97d0c32cd38ec6963695ef1676fcbfac8c', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: 'e48ef0927f3c26990618f955639a98a1879b28d8', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: 'f137486dafc4ecfeb8abdaac1444210e6c126b77', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '10f79acdca0c9103827d24dd2697b4aa1a1871ca', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '295f43fe9cfe2c9c8779360c13a076631baac4d8', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '7a50e2015d9a0790b7ed7ea4aae1aa41edf2eab3', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '08d2d5d3360d517aa95f706717d85f42f3876ef0', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: '670f0df1e7827f814e872ba54d976544e6f462a9', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '206f97aa208fe8041daeba5ab9e1567851eb7421', onComboboxValueChange: e => {
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '710aa4e55695f54ae1a62bcba67b73a4771f1320', class: "input-group price-input-group m-0 p-0" }, this.label && (index.h("div", { key: 'e0516f32f5589c0e02e95f067f698c9bd155d567', class: "input-group-prepend" }, index.h("span", { key: 'a9ad8f9727784fee83bcd0c0247dc41028fc9ead', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '6ce3b85303858cab4a941c384fd783f515a238fa', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '8ac01bc9c1a0484b94f2978a8131a3920f9b47a4', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'a94a0f3fe66c126d6b55005623a05013f1b92ff0', class: `input-group-prepend` }, index.h("span", { key: '74a525627215d3825f5044e2e4d26eacc7f92146', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'ff3e924f513121702be0a242d34e0ab0dfae2454', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '9e4da427dbaabb39e2bce8f4a7c8898f7449f2c8', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'ad7c2c694b5d22c29a8a785f01fd51e438a64d2a', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: 'f3ad0f0b5e9d98b60983e0393327542dd86ba66a', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '459e500832c8560fb98e0560ef97f5c69d85f3d6', class: "input-group row m-0" }, label, index.h("select", { key: '7d4aeb905deadf94109a3341e01ca9bd29f5c33b', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'd3e35bef9eaac271b21b705af7be9defacfa16a3', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'bd6779acc3620afaf9e432063b2993c4236ac7d8', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: 'db25aa024f8f4f90c65e8451b92893d785b1f2e6', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'c0ccfccc183df87a2033d4af60776b787599b577', class: 'sidebar-title' }, index.h("p", { key: '5e5ed992fec50f05d6c0b62e9add64bda9645ebd', class: 'p-0 m-0' }, this.label), index.h("div", { key: '0ba9f4305426ac862c68ec80dee24be0b5ed5461', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '9178baa74d6ffcbd4c23cf6b40e7bd3edf594120', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'cdf83c5d67ab1d019ba1f5c548d8a599c33ae630', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '9434c6ddd6023fcae0af9b6ac5d103b3831f1f7c', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '602d49980ba3b431d1526fe7bde62338bcf92cff', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: '166d561410d2290be717b3f32a880e8a64ee9f77' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTasksTable = class {
    ...
    render() {
        ...
        })), index.h("div", { key: '99b4f6b2566e80b71dd8d38a4685c693bb713d00', class: "card table-container flex-fill p-1 m-0" }, index.h("ir-tasks-header", { key: '665c390e9763aced48b8925784963ea0019b7159' }), index.h("div", { key: '2e52a9fd5183440adeaf38b27b43164972f30c68', class: 'table-responsive mb-auto' }, index.h("table", { key: '5a0f1486f858d8fb0799c15c54e023168a610e03', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '18e2d0073bde78e8f24b45ac847b055c71efcb4b', class: "table-header" }, index.h("tr", { key: 'b751c7fa223070247b1de7f3e062a31305929c68' }, index.h("th", { key: 'b8b091e6ac3f0df703431c6e34f9a401488f88ac', class: 'task-row' }, index.h("ir-checkbox", { key: '176221b858afc7ef0668a17cf313545b461daee5', indeterminate: hkTasksStore.selectedTasks.length > 0 && hkTasksStore.selectedTasks.length < getCheckableTasks().length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'bfaf939ead7e7214d723e9abe52fdb53a6fdb61b', class: "extra-padding" }, locales_store.locales.entries.Lcz_Period), index.h("th", { key: 'c1beef3f01cfda4ee64cca600eb1c068f537eb50', class: "extra-padding" }, this.tasks.length > 1 && this.tasks.length + ' ', locales_store.locales.entries.Lcz_Unit), index.h("th", { key: '04e60e798a629352d02395ad0f6e28215bb658b8', class: 'sortable extra-padding', onClick: () => this.handleSort('status') }, index.h("div", { key: 'ee306249944817291007e61a45f362eadfbc38a8', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '761bb1da9f9026563fb8e41968aa8a600e992b67' }, locales_store.locales.entries.Lcz_Status), index.h("svg", { key: '53adf144abf28bdffc81de3c279c588a1f6db107', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '94550b661d6fdcf9a0b175a657c030c69e5c5a5d', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'ea51a34f774749c80a78a2a285354273bd3a92b1', d: "M17 20V4" }), index.h("path", { key: '323879ef196bcef41d5985e4d73b1f2364d13d16', d: "m3 8 4-4 4 4" }), index.h("path", { key: '7a4e1b9a3b1844fc4759735a972beeb0f84e04a0', d: "M7 4v16" })))), index.h("th", { key: '69b057f2cedab84bcf164040e8b3e0c9ed302c75', class: "extra-padding text-left" }, locales_store.locales.entries.Lcz_Hint), index.h("th", { key: 'ddada1b46f805b9adbf598b4602d94d1353624a3', class: "text-left" }, locales_store.locales.entries.Lcz_A, "d"), index.h("th", { key: 'd27530c9a8062c148ac52bea8dc563da0954dd2b', class: "text-left" }, locales_store.locales.entries.Lcz_C, "h"), index.h("th", { key: '9b2414568de40ecbf0044a6f120b45f304c87e15', class: "text-left text-left" }, locales_store.locales.entries.Lcz_I, "n"), haveManyHousekeepers && (index.h("th", { key: '0f675445646ae5b9136e1ef3bb5d0e48627da5d1', style: { textAlign: 'start' }, class: 'sortable extra-padding', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '4824d0e2a34cb3eba21e3e48b26a130eca3b9a15', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'e6d157379ef5de9569ad13329fefcfb51dd68048' }, locales_store.locales.entries.Lcz_Housekeeper), index.h("svg", { key: '9542d2fc9659ad85a0a91ed0df04b5391d86d6e9', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '742ba101b120040c6b9e821aa8a25da6eddff394', d: "m21 16-4 4-4-4" }), index.h("path", { key: '1e281c357252698ecbb4f8e16d37f295f5926a23', d: "M17 20V4" }), index.h("path", { key: '18dbf4d05f12016304ba67240c89c97395ca6b01', d: "m3 8 4-4 4 4" }), index.h("path", { key: '1ab6f51cf728befb59bbfaf02efdaa34bc9050ad', d: "M7 4v16" }))))))), index.h("tbody", { key: 'de21060136a1af2912637c811833ea24c3ce9016' }, tasks.length === 0 && (index.h("tr", { key: '768e5b428754d67eb3f26058e9bcb73223c5a7fb', class: "ir-table-row" }, index.h("td", { key: '2e1672d9fbaf4fc7ea77f423643fbe88f1472893', colSpan: 9, class: "text-left" }, index.h("div", { key: 'ab00312ebccf7ba032148cf08b44b569eb212ba0', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '5157b78b0509b39d58003996696e80d699acc839' }, " ", locales_store.locales.entries.Lcz_NoTasksFound))))), tasks === null || tasks === void 0 ? void 0 :
            tasks.map(task => {
                var _a;
                ...
                return (index.h("tr", { "data-date": task.date, "data-testid": `hk_task_row`, "data-assigned": task.housekeeper ? 'true' : 'false', style: isCheckable && { cursor: 'pointer' }, onClick: () => {
                    ...
                    }, class: { 'selected': isSelected, 'task-table-row ir-table-row': true }, key: task.id }, index.h("td", { class: "task-row " }, isCheckable && index.h("ir-checkbox", { checked: isSelected })), index.h("td", { class: "task-row extra-padding" }, task.formatted_date), index.h("td", { class: "task-row extra-padding" }, index.h("span", { class: { 'highlighted-unit': task.is_highlight } }, task.unit.name)), index.h("td", { class: "task-row extra-padding text-left" }, task.status.description), index.h("td", { class: "task-row extra-padding text-left" }, task.hint, " aaa"), index.h("td", { class: "task-row text-left" }, task.adult), index.h("td", { class: "task-row text-left" }, task.child), index.h("td", { class: "task-row text-left" }, task.infant), haveManyHousekeepers && (index.h("td", { class: " task-row extra-padding", style: { textAlign: 'start' } }, (_a = task.housekeeper) !== null && _a !== void 0 ? _a : locales_store.locales.entries.Lcz_Unassigned))));
            })))), index.h("div", { key: '8971900cdb2e78901a0495378d68d3714c4bfba8', class: "mt-auto" }, index.h("ir-tasks-table-pagination", { key: 'b1b29680f79f1975dff3d4f0a6b3d7f5712a0aff' })))));
    }
    static get watchers() { return {
...
const IrTasksTablePagination = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b9468ad72a409549f6425eedcaf7b454a985ac34' }, shouldLoadMore() && index.h("ir-button", { key: '36f8c1ffeef24d39d692a2f65032c64f501608d2', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), index.h("ir-pagination", { key: '592db8f86fb7917db6f69679dbfb0ce7db163d67', showing: {
                from: start,
                to: end,
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '233c50c7756fe00b40ff6b08fcf95bf1876dbc8c' }, index.h("h4", { key: '029cd2a4cd0922610ebcb53d0d0ddbf420a10e90', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '6866e18176fff2a0686504f8cc273452055b5f7a', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '83af12fb8ca7fc8eafda853c572ef387400b94db', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '68c9f52126bc14e50f50f83f291719872d5b5baf', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'aa96930e41f3dd98d02e4785d1a6e9e4c3215d75', class: 'title-body' }, index.h("slot", { key: 'e1af5a325c0d441d4d622e274b0c5db217d87743', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '7e0a249601b48463fc6c8ef6750dc78d924b98f3' });
    }
    get element() { return index.getElement(this); }
};
...
const IrTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f13fe0f7a5a0933829e7268251bea92bde2194fd', class: "m-0 p-0" }, index.h("span", { key: '0a4f97bab96972ca423493459231a804da4ee969', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (index.h("slot", { name: "tooltip-trigger" }))), this.open && (index.h("div", { key: '32e3876db0ac11b6416bc777a8a02ac30e36b733', class: "tooltip bottom show position-absolute", role: "tooltip" }, index.h("div", { key: 'e20b88a84f1fe9126a0a5a96de9f1d7333a65b06', class: "tooltip-arrow" }), index.h("div", { key: '2e28ab1672aba1323708a828e69376a47308473e', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, index.h("span", { key: '1601552ffc241e85ba9917351ef5ed5afb36825c', innerHTML: this.message }))))));
    }
};
