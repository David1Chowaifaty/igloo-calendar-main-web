...
const IrNotifications = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c64ee2e220c1db1123b63eb04b16841f29c52597' }, index.h("div", { key: '91705f2e4e5c7615de0e73882869b4ee1e3735cb', class: "dropdown notifications-dropdown" }, index.h("ir-button", { key: '4429d5fc46699ef0b0acec85bc7d8518f94a4492', ref: el => (this.buttonRef = el), variant: "icon", icon_name: "bell", "data-notifications": this.notificationCount.toString(), class: "notification-trigger", btn_type: "button", "data-reference": "parent", "data-toggle": "dropdown", "aria-expanded": "false" }), index.h("div", { key: '510bba019a93de1004e5c1a53a5403b86c3a160f', class: "dropdown-menu dropdown-menu-right" }, index.h("div", { key: '89bfde70ae445b00b7d547b7d269dcf839e7deca', class: 'dropdown-header m-0' }, index.h("p", { key: 'e1dfa22647ae34e3174e1081f8b0629d9fb087dd', class: 'p-0 m-0' }, "All caught up."))))));
    }
