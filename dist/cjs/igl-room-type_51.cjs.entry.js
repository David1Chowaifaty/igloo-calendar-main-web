...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'eb152d3a2f750915352282f2eea660f2519d7be4' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("h5", { key: 'cd952e756171dc0273594aff62ff8f6e0f7d9ee7', class: "roomtype__name" }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrArrivalTimeDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: 'd3421ab9ebe94c2e6cbb843ff40bef50e665a35d', label: "Edit Arrival Time", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-select", { key: 'b4e9f3d7b5de3e0d4668306dbc14bd0fdea5c12b', size: "small", value: this.selectedArrivalTime, defaultValue: this.selectedArrivalTime, onchange: e => this.updateArrivalTime(e.target.value) }, this.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: time.CODE_NAME === this.selectedArrivalTime }, time.CODE_VALUE_EN)))), index.h("div", { key: '7ce63fbbc1421c9863f2c5709bc89fc5df94b0a5', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '137c661fe6f4e57f21284e3f49ab3a256d14c295', size: "medium", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeDialog() }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '2979d91b3b5a892e83a58c6101a0a5af6e5d6249', size: "medium", variant: "brand", onClickHandler: () => this.saveArrivalTime(), loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrAssignmentToggleDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b6ca310a6a1a4ed27a94a544d851af76f8671eed' }, index.h("ir-dialog", { key: '79448abd99be4562395b0f067b1ab53ac9fb5b92', label: this.label, lightDismiss: false, ref: el => (this.dialogRef = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            } }, index.h("p", { key: 'd9903a88f8fca75d51ad2a507f11738f055aa537', class: "assignment-toggle-dialog__message" }, index.h("slot", { key: '0c13f843c29400f8d090c86c1440c80cf2cfae12', name: "message" }, this.message)), index.h("div", { key: '6faf6a3ea85d4dd3ed8dd4550339f38bec6b9e4f', slot: "footer", class: "assignment-toggle-dialog__footer" }, index.h("ir-custom-button", { key: '5e53691ddd7a56364b402d23ff6dd51543a5ead5', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close", disabled: this.loading }, this.cancelLabel), index.h("ir-custom-button", { key: '5d8a3243612b84c696910ba3ab90185285f8f641', variant: "brand", size: "medium", loading: this.loading, onClickHandler: () => this.confirmToggle.emit() }, this.confirmLabel)))));
    }
};
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '592d83763ae16f9a37a616b940bb220120be6c32', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: '204e69d512d0709f098a35c5f80f20f5a54e83ca', booking: this.booking })));
    }
};
...
const IrBookingAssignItems = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '42eb644e576bf1ad36ae2a6fec39d73b5bced866', size: "small" }, index.h("div", { key: '95e88930407d932156ed55304b88a317eddf2fb2', class: "assign-container" }, index.h("p", { key: '1ddf3c312ac7f43827604ebe16760999bd4909e5', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (index.h("div", { key: 'deed464dfa5778a8cfc3ac6125badeed56876628', class: "assign-section" }, index.h("p", { key: 'de46a8872699d8f35e05957b835a80af62abc15c', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (index.h("div", { key: 'd1e5dec09a0673f0c68785363f34e3b5ce6860dd', class: "assign-section" }, index.h("p", { key: '7e4f800debdd55d19fd1a5080218e8aa978a49a9', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (index.h("div", { key: '9ef751477d4582e0ed25ff0d078ad1190b1b0a46', class: "assign-section" }, index.h("p", { key: '9116c30c2a64ad1419d11142f84a329904db58b2', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
};
...
const IrBookingEditorDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'de35abc1e11032fabf5f6d1f37c36b481d3c0af0', onDrawerHide: async (event) => {
                event.stopImmediatePropagation();
                event.stopPropagation();
                ...
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            }, class: "booking-editor__drawer", label: this.drawerLabel, open: this.open }, this.open && this.ticket && (index.h("ir-booking-editor", { key: '492bb62eec3709a66a3420a72966530231851f1c', onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                this.initializeBlockedUnitState(undefined);
                await this.closeDrawer();
            }, step: this.step, blockedUnit: this.blockedUnit, language: this.language, booking: this.booking, mode: this.mode, checkIn: this.checkIn, checkOut: this.checkOut, identifier: this.roomIdentifier })), index.h("div", { key: '1dfb56f920e924b7bda5925a5b52ead633bd3515', slot: "footer", class: "ir__drawer-footer" }, this.renderFooter())));
    }
    static get watchers() { return {
...
const IrBookingEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '7ed65f1640eaa20b965bea7792fd7289a01fcf4b', class: "booking-editor__guest-form", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                this.doReservation.emit(submitter?.value);
            } }, index.h("div", { key: '345fc05b4dc47770f6a81c212239bc405d73f0bd', class: "booking-editor__header" }, index.h("ir-date-view", { key: 'f874e2ae3541f81df0d9b53e7b3ea9d0bed47fb3', class: "booking-editor__dates mr-1 flex-fill font-weight-bold font-medium-1", from_date: dates.checkIn, to_date: dates.checkOut, dateOption: "DD MMM YYYY" }), this.totalRooms > 1 && (index.h("div", { key: '84634426c724cff873072db23fe01b7474eafff4', class: "booking-editor__total mt-1 mt-md-0 text-right" }, index.h("span", { key: '84a235df063263de77661517669fc22fc428ae58', class: "booking-editor__total-label" }, locales_store.locales.entries.Lcz_TotalPrice), ' ', index.h("span", { key: 'c0507f3fe1aee5a1365c0e47456d3833b51f6546', class: "booking-editor__total-amount font-weight-bold font-medium-1" }, utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.totalCost))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
            ...
            }, variant: "brand" }, "Clear user"))))), index.h("ir-booking-editor-guest-form", { key: '8ea5aba8938a073c9c7ce18fc9814b2a5ffb4974' }))), this.bookingEditorService.isEventType(['SPLIT_BOOKING', 'ADD_ROOM']) && functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '5c8fc812783cbc4e442d61aaaf5696da10e858ab', style: { maxWidth: '500px' }, agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrBookingEditorGuestForm = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3da6c6a92b01b43ddf81a4c849585f81bbced0a1' }, index.h("section", { key: '85f1aca1b458892d2bc11ce2676304e6582f9fab', class: "booking-editor__form-control" }, index.h("ir-input", { key: 'ff65052667ca3fac291cbc9f03de00ddb1a76208', label: "Email address", "onText-change": e => booking_service.updateBookedByGuest({ email: e.detail }), mask: 'email', value: bookedByGuest.email, defaultValue: bookedByGuest.email, placeholder: "Email (leave empty if not available)" }), index.h("div", { key: 'e54ef8a81512e6894421f8f381a897538a115835', class: "booking-editor__guest-name-group", id: "booking-editor-guest-name-group" }, index.h("ir-validator", { key: '383eef36a33f201dd4ac1e8290dc74df141f8489', class: "booking-editor__guest-input-validator", value: bookedByGuest.firstName, schema: BookedByGuestSchema.shape.firstName }, index.h("ir-input", { key: 'e8cb41a3378d431364c325032b30c92deab04ab1', id: "booking-editor-guest-first-name", class: "booking-editor__guest-input --first-name",
            // label="Name"
            value: bookedByGuest.firstName, defaultValue: bookedByGuest.firstName, placeholder: "First name", autocomplete: "off", "onText-change": e => booking_service.updateBookedByGuest({ firstName: e.detail }) }, index.h("p", { key: '3b012f221da90e29bccbcd4c0a3ce66af703c699', style: { margin: '0', marginBottom: '0.5rem' }, slot: "label" }, index.h("span", { key: 'bf0e8e6557ffce8d37d02ced9d111174ce825bc0', class: "booking-editor__guest-input-label --first-name-pc-label" }, "Name"), index.h("span", { key: '178f5cc306f8bed674ec13672839dcb9a1989977', class: "booking-editor__guest-input-label --first-name-mobile-label" }, "First name")))), index.h("ir-validator", { key: '37cae267ac2b4436c6e145f08769afcdd4607319', class: "booking-editor__guest-input-validator", value: bookedByGuest.lastName, schema: BookedByGuestSchema.shape.lastName }, index.h("ir-input", { key: 'bd484cb0f4425388fd64498ad191f1e5b297155b', id: "booking-editor-guest-last-name", class: "booking-editor__guest-input --last-name", label: "Last name", "onText-change": e => booking_service.updateBookedByGuest({ lastName: e.detail }), value: bookedByGuest.lastName, defaultValue: bookedByGuest.lastName, placeholder: "Last name", autocomplete: "off" }))), booking_service.booking_store.bookingDraft.agent ? (index.h("ir-input", { label: "Booking code", placeholder: "", value: bookedByGuest.bookingCode, defaultValue: bookedByGuest.bookingCode, "onText-change": e => booking_service.updateBookedByGuest({ bookingCode: e.detail }) })) : (index.h("ir-input", { label: "Company name", placeholder: "Company name", value: bookedByGuest.company, defaultValue: bookedByGuest.company, "onText-change": e => booking_service.updateBookedByGuest({ company: e.detail }) })), index.h("ir-country-picker", { key: '2fcbffe6b6c35ecb23aab81efebe2f0b47fa6dfa', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.updateCountry(e), countries: selects.countries, country: selects.countries.find(c => c.id.toString() === bookedByGuest.countryId?.toString()) }), index.h("ir-mobile-input", { key: 'd0d8f26b8dc3b32ad0798f36ac81e5934dc5fb35', size: "small", "onMobile-input-change": e => {
                booking_service.updateBookedByGuest({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => booking_service.updateBookedByGuest({ phone_prefix: e.detail.phone_prefix }), value: bookedByGuest.mobile, countryCode: selects.countries.find(c => c.phone_prefix === bookedByGuest.phone_prefix)?.code, countries: selects.countries }), index.h("wa-select", { key: '42ef778a3d62916860d9f332d8948dd2456eb76b', size: "small", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", id: v4.v4(), defaultValue: selects.arrivalTime[0].CODE_NAME, value: bookedByGuest.selectedArrivalTime, onchange: event => booking_service.updateBookedByGuest({ selectedArrivalTime: event.target.value }) }, selects.arrivalTime.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: bookedByGuest.selectedArrivalTime === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("section", { key: '35eacd6fe946c682620313b0370fc1b808bedc5f', class: 'booking-editor__form-control' }, index.h("wa-textarea", { key: '6a65ff6c256e4625e7f95ad087d7f579ef6174bf', onchange: event => booking_service.updateBookedByGuest({ note: event.target.value }), size: "small", value: bookedByGuest.note, defaultValue: bookedByGuest.note, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 3 }), (!agent || agent?.payment_mode?.code === '002') && (index.h(index.Fragment, { key: '869840eaa22bc7525381f911f661e950181c8a82' }, this.paymentMethods.length > 1 && (index.h("wa-select", { key: '9a10eb82b7403d562572e22cafecc3114b554920', label: 'Payment Method', size: "small", defaultValue: booking_service.booking_store?.selectedPaymentMethod?.code ?? this.paymentMethods[0].code, value: booking_service.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: 'dd7cb213e63f9ad2cf5a3694ca3f167ea567e456' }, index.h("ir-input", { key: '20be3b0a4c43f6459398c01d25b96cc71d73ebfa', value: bookedByGuest.cardNumber, defaultValue: bookedByGuest.cardNumber, "onText-change": e => booking_service.updateBookedByGuest({ cardNumber: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: '645149ac9e817e0b22d1c9c74e0cc526de64a051', value: bookedByGuest.cardHolderName, defaultValue: bookedByGuest.cardHolderName, "onText-change": e => booking_service.updateBookedByGuest({ cardHolderName: e.detail.trim() }), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: 'fda61887b5a9180ecd9a6d57714e7d2398d69ebd', "onText-change": e => {
                const [month, year] = e.detail.split('/');
                booking_service.updateBookedByGuest({
                    expiryMonth: month,
                    expiryYear: year,
                });
            }, value: this.expiryDate, mask: this.expiryDateMask, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h(index.Fragment, { key: '5eae43855fb6c29461070d45be761246d2ddeb35' }, index.h("style", { key: '72323c9e87d9be3cff68b8b0912b1b1bc08ab7d1' }, `p{
              margin:0;
              padding:0}`), index.h("div", { key: '95096a4284d92c3d8ac2f7c0f2e2cbbf6e367cea', class: "booking-editor__payment-info-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description }))), index.h("wa-checkbox", { key: '9120890bc08b99ef87dce5ce55ec6bf4669bffe1', defaultChecked: bookedByGuest.emailGuest, checked: bookedByGuest.emailGuest, onchange: event => booking_service.updateBookedByGuest({ emailGuest: event.target.checked }) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
...
const IrBookingEditorHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6ec0bbbc6620611141470527c02024d8bfcc6494' }, index.h("form", { key: 'b8ba656ce38f8ad5649f13ccf187d029f89c99af', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (index.h("ir-validator", { key: '19ee79515d03a802445ade6eefcc9d6727fdc048', value: booking_service.booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, index.h("ir-picker", { key: 'eaf69c3609fca803ba02c0ce40edba5fdb6682ca', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales_store.locales.entries.Lcz_Tobooking}#`,
        ...
        })))), index.h("div", { key: '1ab6f732b209c1f3db96c1918e380921fa309279', class: "booking-editor-header__container" }, !this.bookingEditorService.isEventType(['EDIT_BOOKING', 'ADD_ROOM', 'SPLIT_BOOKING']) && (index.h("wa-select", { key: '6b0f3fdaa12578cc0f9cb1be81944a18c9503c98', size: "small", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_service.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_service.booking_store.bookingDraft.source?.id, "onwa-hide": this.stopEvent.bind(this), onchange: this.handleSourceChange.bind(this) }, sources.map(option => (option.type === 'LABEL' ? index.h("small", null, option.description) : index.h("wa-option", { value: option.id?.toString() }, option.description))))), index.h("ir-validator", { key: '3676663dc3008bc6f84c84efffd48586ea8fb2b8', class: "booking-editor__date-validator", showErrorMessage: true, value: booking_service.booking_store.bookingDraft.dates, schema: this.datesSchema, style: { position: 'relative' } }, index.h("igl-date-range", { key: '6c389b9c15035f1f1a43c6f645cee4dbd69b2213', class: "booking-editor__date-range", defaultData: {
                fromDate: checkIn?.format('YYYY-MM-DD') ?? '',
                toDate: checkOut?.format('YYYY-MM-DD') ?? '',
            }, variant: "booking", withDateDifference: true, minDate: this.minDate, maxDate: this.maxDate, onDateRangeChange: this.handleDateRangeChange.bind(this) })), !this.bookingEditorService.isEventType('EDIT_BOOKING') && (index.h(index.Fragment, { key: 'ad536c5e1330a7eac24bf2ec920a59edf12328da' }, index.h("ir-validator", { key: '2ffe194cdc6d9e88dc42d25230b654b888f045ac', value: adults, schema: this.adultsSchema }, index.h("wa-select", { key: 'f3bb26060561b8d828391f005dda604d2d50b4ad', class: "booking-editor-header__adults-select", size: "small", placeholder: locales_store.locales.entries.Lcz_AdultsCaption, value: adults?.toString(), defaultValue: adults?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleAdultsChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.adult_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))), calendarData.calendar_data.property.adult_child_constraints.child_max_nbr > 0 && (index.h("wa-select", { key: '2cb32ea1e79063d09263c993bf88a97fa4cdd869', class: "booking-editor-header__children-select", size: "small", placeholder: this.childrenSelectPlaceholder, value: children?.toString(), defaultValue: children?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleChildrenChange.bind(this) }, Array.from({ length: calendarData.calendar_data.property.adult_child_constraints.child_max_nbr }, (_, i) => i + 1).map(option => (index.h("wa-option", { value: option.toString() }, option))))))), index.h("ir-custom-button", { key: '12305c30f1214f7d4d50656221671098606aa356', loading: this.isLoading, type: "submit", variant: "brand" }, "Check")), booking_service.booking_store.roomTypes?.length > 0 && !this.isLoading && (index.h("wa-callout", { key: '8c552ca2d9c1fd19ec3adc6318595dc5dc9a71d3', size: "small", variant: "neutral", appearance: "filled", class: "booking-editor-header__tax_statement" }, calendarData.calendar_data.tax_statement)))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"],
        "mode": ["handleModeChange"]
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '3bd4f55db4b28c760a68fe315357045a81dcede4', label: "Private Note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '1738e5d857ffad90821859ff067905642e1cfb8d', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '072ca92409caf857e82787e6020694f7bd89adc9', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'ac925c05341f365e0d209eb5ca02c2f02fd3f187', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '57016c4b46b98242ac52f57a96172e39032389b7', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '9a2aa20c86bcea452fc619a307db28b15fe04e5e', class: "booking-header" }, index.h("div", { key: 'c3334e3c8da89b0545da58c9ee65890e065e282e', class: "booking-header__row" }, index.h("div", { key: 'c3837e8b515c751e362cf02cb8ce49e105a100a8', class: "booking-header__info" }, index.h("div", { key: '2d879a6c0c0d6bfec7373c5cb39167b63a41679a', class: "booking-header__title" }, index.h("div", { key: '8dd90b492314151f2dfff84ff643ad0482eb3b30', class: "booking-header__label-container" }, this.hasMenu && (index.h(index.Fragment, { key: '57e137cc58a7c6210abd9f9d8ffa1324766cb9b3' }, index.h("wa-tooltip", { key: '905a6135da6cc6022d9b5243c0b2ec72c3c91316', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: '045f05a5b8e2e68cdc8c0ef40bd1a7de14865d40', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '8f4d7e960f3d489b2befd496f53e050edfdeb991', name: "arrow-left", style: { fontSize: '1.2rem' }, label: "Go back" })))), index.h("wa-avatar", { key: '70f11313114174035bb8edeba0eab3a50fa04bf6', shape: "circle", initials: this.initials, image: this.avatarImage, loading: "lazy" }), index.h("div", { key: 'e0279613e28aff3254e7ae6c3ccad39fb0fcda9f', class: "booking-header__identity" }, index.h("div", { key: 'e4a401d28f8137d6b53e912b5a34d3c7a17c13f2', class: 'booking-header__label' }, index.h("h4", { key: 'c2a10d9fbfd426e98bf1278e5d7e1b57395bffff', class: "booking-header__label-number" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`)), index.h("div", { key: '001b33b561444a9d9b7bc6fd418074f425aa040c', class: "booking-header__meta" }, index.h("p", { key: '21b371ea21c8392f4feec4eab2a849022d0910b6', class: "booking-header__channel-number" }, this.booking?.agent ? (index.h("span", null, "Agent:", ' ', index.h("p", { class: 'truncate p-0 m-0', style: { maxWidth: '100px', display: 'inline-flex' } }, this.booking.agent.name))) : (this.booking.origin.Label)), !this.booking.is_direct && index.h("p", { key: 'ca09675576f0750dbd020b1dc5e6bf08775757d2', class: "booking-header__channel-number" }, this.booking.channel_booking_nbr), index.h("ir-custom-button", { key: '4b4136093d30a06adad12ef5c8b872e290f0e5a2', link: true, onClickHandler: () => this.bookingSourceEditor.openDialog() }, "Change source"), lastManipulation && (index.h(index.Fragment, { key: '3743c3c62db336fef8acd749e85ca5a829c0c480' }, index.h("p", { key: '850ae111a6c7ad7d732da1097cf3e146d120335a', id: `booking-${this.booking.booking_nbr}-modified`, class: "booking-header__modified" }, "Modified"), index.h("wa-tooltip", { key: '3a07837d89e672e171958be1adf0c17fe93f5197', for: `booking-${this.booking.booking_nbr}-modified` }, index.h("div", { key: '5cdaec38b57feecb9bb0b9edcb9b318e6282ef1b' }, index.h("p", { key: '6d984c2983cc873a929119c0b8d2d8f34a02afad', class: "m-0" }, "Modified by ", lastManipulation?.user, " at ", lastManipulation?.date, " ", lastManipulation?.hour, ":", lastManipulation?.minute, "."), index.h("p", { key: 'a1fdcee35d74604b4a8e836dfd30d58aea1f3a6b', class: "m-0" }, this.alertMessage)))))))))), index.h("div", { key: '418b45bc2e0daca6633034325b2e7e3d8048e725', class: "booking-header__actions" }, index.h("div", { key: '386395307221c4d1b6a15e9fd120553af3c96c00' }, this.booking.allowed_actions.length > 0 && this.booking.is_editable ? (index.h("wa-dropdown", { "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
            ...
            appearance: 'outlined', size: "small", variant: "brand", class: "booking-header__status-trigger" }, index.h("ir-booking-status-tag", { slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", null, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))) : (index.h("ir-booking-status-tag", { status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }))), functions.isAgentMode(this.booking) && (index.h(index.Fragment, { key: '71dc0d446b7f163db346738c6ef81ad3c6ff0c0c' }, index.h("ir-custom-button", { key: '777f6faaf5db96d7b834a2a15235bf5615bb567d', onClickHandler: e => {
            ...
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "warning" }, "Force city ledger"), index.h("ir-custom-button", { key: '4b2667905a5431ea0ecd27e6d0c9a44df1980bb7', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.invoiceDialogRef.openModal();
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Invoice to agent"))), index.h("ir-custom-button", { key: '200d28fdf0d55db39021f013a30aec22e072ebd6', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Logs"), showPms && (index.h("ir-custom-button", { key: 'f47dfe86e2f56969cce6f3cb8eddf42b06f4b925', class: "booking-header__stretched-btn", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS")), this.hasReceipt && (index.h(index.Fragment, { key: '4ffc0df46f7e5c6456b30815d272dcd0d5fcfc00' }, index.h("ir-custom-button", { key: 'a8a156079ca8a1d71a5646438f84b9d0588250fe', class: "booking-header__stretched-btn", id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: '19808c093552bcd257b12899094461a12e310141' }, index.h("wa-tooltip", { key: '36aee5308a65c658263368881c701c614517b303', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '21299309d4841b8278c836eb6c501f5662820afa', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'b139919b7506422bd72ae823000773a38c447e25', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: 'c24b5992a1dc119b3fa1453456709e77bea9a2f1' }, index.h("wa-tooltip", { key: '41e9581a158020d7378217d01519237e0e3e9916', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: 'c0e0fe6328c60b1f6709262ffa92f5ff1e118973', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'a0df011ec4a1e46d4ba1605428736e0d8f84c086', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: '5db271844cd316a3927343b0018b8211dbb938f3' }, index.h("wa-tooltip", { key: 'd5fd84f0b49fad054284977c9cf51f13a67e2c38', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: '4d76f825a1a803dba068e7da9f66080946276e2b', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '8a635d9345d8d858b0da39ba505a3c03d1f2d22c', name: "envelope", style: { fontSize: '1.2rem' }, label: "Delete this booking" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: 'ba68fa19d5608f3ec471dd66162c8584dcbcae93', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '301bde575b8e3e2af0cd6c69825093bfd4680335', name: "xmark", style: { fontSize: '1.2rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '1838b8eb94dce7642a46e9047df8fa7695c2ff0c', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: 'c8f48e820da47332192e8bc5318a2b5cccc7680d', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: 'f98e2c214d9dfebe350981601222737cb946bb88' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'ca7f233c7ff24f2846010eecc25974b9eed87f61', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '5c6333181da614bb773af5baf4e9831d2061bdd2', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '5e900a732742f7243116506e939b7f48b83eba41', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
            }, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status') }, locales_store.locales?.entries?.Lcz_Confirm))), index.h("ir-booking-source-editor-dialog", { key: 'a7b6be467746185042fceec3de1494c1a266092c', booking: this.booking, ref: el => (this.bookingSourceEditor = el) }), index.h("ir-cl-invoice-dialog", { key: 'db8e3206e612ebed0b2212cb3c63f838a45d4e58', mode: "booking", agentId: this.booking.agent?.id, bookingNbr: +this.booking.booking_nbr, startDate: this.booking.from_date, endDate: this.booking.to_date, currencyId: calendarData.calendar_data.property.currency.id, ref: el => (this.invoiceDialogRef = el) })));
    }
};
...
const IrBookingSourceEditorDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '7ee849c75951ba59e20b86b96f03f64efd0676fd', label: "Change Booking Source", onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, open: this.open }, this.open && (index.h("ir-booking-source-editor-form", { key: '56724f41e28225c3cb1b7269d6250c14c1cb608e', booking: this.booking, onBookingSourceSaved: () => {
                this.closeDialog();
                setTimeout(() => this.resetBookingEvt.emit(null), 100);
            }, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'dbecf435d6d621c2911db5a3292eaf9d8c452cf7', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '5bb7e9b35ba637fe5419f9768fa00a38b6d5fc7a', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, "Cancel"), index.h("ir-custom-button", { key: '7bfd7039193b130bd78312b522810587b585f395', type: "submit", form: `change-source-form-${this.booking?.booking_nbr}`, size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading }, "Save"))));
    }
};
...
const IrBookingSourceEditorForm = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'f7e59fad0d25e3f0d2d35ec38726974609ebf124', id: `change-source-form-${this.booking?.booking_nbr}`, onSubmit: this.handleSubmit.bind(this) }, index.h("wa-select", { key: '661ebf52995532ea60e0730f4727c20608cc4f08', label: "New source", onchange: this.handleSelectChange.bind(this), size: "small", value: this.selectedSource?.id, defaultValue: this.selectedSource?.id }, calendarData.calendar_data?.property?.allowed_booking_sources?.map(option => option.type === 'LABEL' ? (index.h("small", { key: option.id }, option.description)) : (index.h("wa-option", { key: option.id, value: option.id?.toString() }, option.description)))), isAssign && index.h("ir-booking-assign-items", { key: '2bf43dce2afb8b8bf849d8e9701ec82cba6238e7', items: this.buildAssignableItems(), onBookingSelectionChange: e => (this.checkedItems = e.detail) })));
    }
    static get watchers() { return {
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '5edd1e7c02949f1cb7db69796be66d61d826944a', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCityLedgerTransactionDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'd0d26473a3a489d4f213495ba9b9965f06b7fbfd', open: this.open, label: this.drawerLabel, onDrawerHide: event => {
                ...
                this.closeDrawer.emit();
            } })), index.h("div", { key: '8fe07b6de29ce5f511cfe7d041a88ecc629fab06', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '1f0a9ab6d45474bdaa380793abcf9e0eae1ad930', appearance: "filled", size: "medium", variant: "neutral", class: "city-ledger-transaction-drawer__btn", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), index.h("ir-custom-button", { key: '9ed2144f191464b5c2a71e12696bef9fb5ceee41', form: this.formId, size: "medium", type: "submit", variant: "brand", class: "city-ledger-transaction-drawer__btn" }, "Save"))));
    }
};
...
const dateSchema = index$2.z
    .string()
    .refine(value => moment.hooks(value, DATE_FORMAT$2, true).isValid(), 'Date must be in YYYY-MM-DD format.')
    .refine(value => {
    const valueDate = moment.hooks(value, DATE_FORMAT$2, true).startOf('day');
...
const commonFieldsSchema = index$2.z.object({
    date: dateSchema,
    amount: index$2.z.coerce.number().gt(0, 'Amount must be greater than 0.'),
    taxId: index$2.z.string().min(1, 'Tax selection is required.'),
    reference: index$2.z.string().optional(),
    notes: index$2.z.string().max(500).optional(),
});
const openingBalanceSchema = commonFieldsSchema.extend({
    transactionType: index$2.z.literal('OB'),
    entryType: index$2.z.enum(ENTRY_TYPES),
    isCutover: index$2.z.boolean(),
});
const paymentTypeSchema$1 = index$2.z.object({
    code: index$2.z.string().min(3).max(4),
    description: index$2.z.string(),
    operation: index$2.z.enum(ENTRY_TYPES),
});
const paymentMethodSchema$1 = index$2.z.object({
    code: index$2.z.string().min(3).max(4),
    description: index$2.z.string(),
    operation: index$2.z.string().optional().nullable(),
});
const paymentSchema = commonFieldsSchema.extend({
    transactionType: index$2.z.literal('PAY'),
    payment_type: paymentTypeSchema$1.nullable().optional(),
    payment_method: paymentMethodSchema$1.nullable().optional(),
    designation: index$2.z.string().optional(),
    invoiceId: index$2.z.string().optional(),
    onAccount: index$2.z.boolean(),
});
const manualChargeSchema = commonFieldsSchema.extend({
    transactionType: index$2.z.literal('DB'),
    serviceCategoryId: index$2.z.string().optional(),
});
const adjustmentSchema = commonFieldsSchema.extend({
    transactionType: index$2.z.literal('ADJ'),
    entryType: index$2.z.enum(ENTRY_TYPES),
    linkType: index$2.z.enum(LINK_TYPES),
    linkedId: index$2.z.string().optional(),
    reason: index$2.z.enum(ADJUSTMENT_REASONS).optional(),
});
const creditNoteSchema = commonFieldsSchema.extend({
    transactionType: index$2.z.literal('CN'),
    invoiceId: index$2.z.string().min(1, 'Invoice is required for credit note.'),
    generatesFiscalDocument: index$2.z.literal(true),
});
const debitNoteSchema = commonFieldsSchema.extend({
    transactionType: index$2.z.literal('DN'),
    invoiceId: index$2.z.string().min(1, 'Invoice is required for debit note.'),
    generatesFiscalDocument: index$2.z.literal(true),
});
const cityLedgerTransactionSchema = index$2.z
...
const todayDate = () => moment.hooks().format(DATE_FORMAT$2);
...
const transactionTypeFieldSchema = index$2.z.enum(Object.keys(TRANSACTION_TYPES));
const dateFieldSchema = dateSchema;
const amountFieldSchema = index$2.z.coerce.number().gt(0, 'Amount must be greater than 0.');
const taxIdFieldSchema = index$2.z.string().min(1, 'Tax selection is required.');
const entryTypeFieldSchema = index$2.z.enum(ENTRY_TYPES);
index$2.z.string().min(1, 'Payment type is required.');
const paymentMethodCodeFieldSchema = index$2.z.string().min(1, 'Payment method is required.');
const invoiceIdRequiredFieldSchema = index$2.z.string().min(1, 'Invoice is required.');
index$2.z.string().min(1, 'Service category is required.');
const linkTypeFieldSchema = index$2.z.enum(LINK_TYPES);
index$2.z.enum(ADJUSTMENT_REASONS);
({
    transactionType: 'PAY',
    date: todayDate(),
    amount: 150.5,
...
const IrCityLedgerTransactionForm = class {
    ...
    renderPaymentFields() {
        ...
        return (index.h(index.Fragment, null, index.h("div", { class: "payment-section" }, index.h("div", { class: "transaction-form__field" }, index.h("ir-validator", { schema: paymentMethodCodeFieldSchema, value: this.formData.payment_method?.code ?? '', valueEvent: "change" }, index.h("wa-select", { size: "small", label: "Payment method", placeholder: "Select method\u2026", value: this.formData.payment_method?.code ?? '', "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), onchange: event => {
            ...
            } }, index.h("wa-option", { value: "" }, "Select method\u2026"), this.paymentEntries?.methods?.map(method => (index.h("wa-option", { key: method.CODE_NAME, label: method.CODE_VALUE_EN, value: method.CODE_NAME }, utils.getEntryValue({ entry: method, language: this.language })))))))), index.h("div", { class: "payment-section" }, index.h("wa-radio-group", { label: "Apply to", size: "small", orientation: "horizontal", value: isOnAccount ? 'on-account' : 'apply-to-invoice', onchange: e => {
...
const IrClInvoiceDialog = class {
        ...
        try {
            if (this.mode === 'booking') {
                const result = await this.cityLedgerService.issueFiscalDocument({
                    ...
                    FD_TYPE_CODE: index$1.FD_TYPES.Draft,
                });
    ...
    render() {
        return (index.h(index.Host, { key: 'cec5004f35ca19ddff1e3b1c09ad52802387eb8c' }, index.h("ir-dialog", { key: 'da41d839b1a3d7562edcf5041c0533ebdf67dcbd', label: "Create Invoice", ref: el => (this.dialogRef = el) }, index.h("div", { key: 'ddcb1a195dbf58e320858a1f85c884c7eddf83ec', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (index.h("p", { class: "create-invoice-dialog__message" }, "Issue a draft invoice for booking #", this.bookingNbr, " to the agent?")) : (index.h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.error && index.h("p", { key: '770e80791151115466b0583c17b50b73c61ad5bc', class: "create-invoice-dialog__error" }, this.error)), index.h("div", { key: 'f35dcea94c2f2593b0377c18a4f5f14c0f4ceee6', slot: "footer", class: "create-invoice-dialog__footer" }, index.h("ir-custom-button", { key: 'dc6b006aa4a1b6d6fd589c754d094637edac4166', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), index.h("ir-custom-button", { key: 'a95e3bcee70110d6d3edc94e9b4d42df2b371a08', size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, "Show draft")))));
    }
};
...
const IrClInvoiceForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5a67f34667cae63b33db2c7e9b9fff5dc5802f44' }, index.h("wa-callout", { key: 'c34b21d493f40fee087d893d1022e0c94b9ca2c5' }, index.h("wa-icon", { key: '9f99d9c9b259a22700ef48c52fac055e1f107227', slot: "icon", name: "circle-info" }), index.h("div", { key: 'a6c8607fc70d99f14961f08b8f13b92c275cef39', class: "invoice-form__scope-text" }, index.h("span", { key: '6cde4e0bb0c4f36caa4a6ec5a894fc3d316e32ac', class: "invoice-form__scope-label" }, "Unbilled Folio Entries"), index.h("span", { key: '58f8984c20cffc6246b43351a7bae46538d839c4', class: "invoice-form__scope-desc" }, "Including all services from bookings, manual charges and adjustments."))), index.h("div", { key: 'f27d6fa0346c4f21403cc9b220842d479b9b76d6', class: "invoice-form__field" }, index.h("ir-date-range-filter", { key: '84f40359c1f67484d15d6889f22f15431b5cd294', showQuickActions: false, style: { width: '100%' }, fromDate: this.fromDate || undefined, toDate: this.toDate || undefined, onDatesChanged: e => {
                this.fromDate = e.detail.from ?? '';
                this.toDate = e.detail.to ?? '';
            } })), index.h("div", { key: '8a081f89acd6febdbcf3a360b3892c0ed9a9529f', class: "invoice-form__field" }, index.h("wa-checkbox", { key: '091e5c750c89ea4ca3f2847045b65920b754e3fa', checked: this.scope === 'UNBILLED_CHECKED_OUT', "onwa-change": e => {
...
const IrExtraService = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ea595a4234c9e346587127b45cd97ecee4dc7dac' }, index.h("div", { key: '86a726eee3e68deab60baa5737bd00ad5b89b8b7' }, index.h("div", { key: '4c2747535671ab84eb2e1d7fcefbf032bb0c7e3b', class: 'extra-service-container' }, index.h("p", { key: '5025e331b2c8f244a83db1d5e1a9d1ad62dc2b34', class: "extra-service-description" }, this.description), index.h("div", { key: 'bd5856d277a5963015305c9dfbb9dd01844393df', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: '15e13f8af6ff5fb2ff8f92c81e96359a2ea11b0a', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("wa-dropdown", { key: '689e861812c9df7372c701c6688a66c24cfedc4b', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: 'c4a37a48521099c243ab391800dfa312b078d5ff', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.service.system_id}`, iconBtn: true, style: { marginBottom: '4px' }, variant: "neutral" }, index.h("wa-icon", { key: '2e431563d13332674e9a85b3c95187bbe1f95cc7', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), index.h("wa-dropdown-item", { key: 'b14526219190c52a705d14b98b48c170845e4bf2', value: "edit" }, "Edit"), agentMode && index.h("wa-dropdown-item", { key: 'a8e50dbaa8dbad595039cd70d7bac01073613da6', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), index.h("wa-dropdown-item", { key: '4acbaf42ac632d851b2aeb1c8937767a94539f89', value: "delete", variant: "danger" }, "Delete")))), index.h("div", { key: '3e7e8fd666607363b9de7f2d8c4858a4802fb5d4', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-assignment-toggle-dialog", { key: 'a7ba6d279186a9a8e5bfdcce8276153027702f6f', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, index.h("span", { key: 'a79f1ad3bff83eacafcb0a7587c0242caeeeb426', slot: "message" }, "Re-assign ", this.description, " ", index.h("br", { key: '9d44165ac078b37208991112cb36f8ba03c1a22d' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", index.h("b", { key: '5e9d81b2843dccc286ac25ddbad3fcb34c699c3e' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), index.h("ir-dialog", { key: 'b3e0209b34efd4ee0ffbb3ff0cefe553e0e40d81', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: '5d940dc01d09ae72ff85a0bef3dec267cf4ffaa2', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'a791a77a38f16788d209f86eff1d77b20dc3f1cd', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'fb3052bd7c2ab4c53f612d67988889463dd630e0', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'b43247ca59ce249d7325c551f5f7591a530f5dab', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: 'c26689d653afb921c31b8b34e1b3ab1a518fbd32', language: this.language ?? 'en', svcCategories: this.svcCategories, onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: '861bb446179e31a48a1d2150a80389f17e52f631', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '8667807918ce903eaa4462f2c3da4132a8368954', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '5dcaffbd31e1ece7d8de201204d4c97f79264625', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: '2188daf935ba503e549803331e664a6869a3b483', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (index.h("ir-validator", { key: 'a461b03aa6b2066bcc0f4d8b081ffb83deba64cb', value: this.s_service?.category, schema: utils.ExtraServiceSchema.shape.category }, index.h("wa-select", { key: 'a2bc209470f0fe79cee11b4102a894d642940b45', size: "small", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), index.h("ir-validator", { key: 'f73551e637df71fc0a948e44e5f2e80f6086de28', id: "amenity description-validator", schema: utils.ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '7ec0fd252d016d5b52894908b589672e7b6f91fe', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-validator", { key: '999904b8a8eb5db0927d01a711d9a84362d58f29', value: this.s_service?.start_date ?? null, schema: utils.ExtraServiceSchema.shape.start_date }, index.h("ir-custom-date-picker", { key: '302769d5f938268a3c0c6b19f016b4d91d842e94', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), index.h("ir-custom-date-picker", { key: 'a0c6217504da5aa082feade0c637c3bd9c50e697', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'f8ef67ce93832db941c5faf4ef4946797f99185d', value: this.s_service?.price ?? null, schema: utils.ExtraServiceSchema.shape.price }, index.h("ir-input", { key: 'aa34738517a462709a9ec66a465d12fea3611042', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales_store.locales.entries.Lcz_Price} (including tax)` }, index.h("span", { key: 'c43585eef0e85a1e5b732043bc71dc6db4bb745a', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '14a3582d6668d5745d140ac4781c2a8424e3082b', value: this.s_service?.cost ?? null, schema: utils.ExtraServiceSchema.shape.cost }, index.h("ir-input", { key: '72cf826cd50f8862a32f1bb6b1934d0107e0905a', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales_store.locales.entries.Lcz_Cost} (optional)` }, index.h("span", { key: 'c33246a5569c2abdf799334930db103adad3e196', slot: "start" }, this.booking.currency.symbol))), functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '2eb2962df3373ca9e8a34e823718d78435232846', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
    static get watchers() { return {
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '6e8a216adaa9ac0bc7f3981d3d8214c05fc30a2d', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.open && (index.h("ir-guest-info-form", { key: 'f5886390d3d3cacd9fe5c6caff6840c6680241b8', ticket: this.ticket, language: this.language, email: this.email, booking_nbr: this.booking_nbr, fromId: this._formId })), index.h("div", { key: '0c350bfe28e34c5c1f02a4891ace757f7ab705c1', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'ccfe4e2a17ae992f6dab1af20a7e90021211414e', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: '6407fef74b85ba5b2e2fa8b6f49cacfcd2f3bdcd', type: "submit", form: this._formId, size: "medium", variant: "brand", loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest') }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a22b1937e83d96936d18818fca3e5a7b9a641dd0' }, index.h("ir-drawer", { key: 'f6aec46f24a55e658d38f649d8a169323849753c', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '25099a46d18b666d15657ad598cd2e0bba50dc13', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'fe2ed488173ea2dc360cdc8f7d83a96b2647d7ce', defaultChecked: this.viewMode === 'proforma', checked: this.viewMode === 'proforma', onchange: e => {
                if (e.target.checked) {
                    this.viewMode = 'proforma';
                }
                else {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: 'e85bf2164cbeded6aec5da9b26f10d4cc3543f24', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, onPreviewProformaInvoice: e => (this.invoice = e.detail.invoice), invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: '15f2c4e0532007dea997a4ecec7f777584a9f403', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: '86bf6d66c2178d8104f54be61869ed879c8b3b05', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: 'ed5caa5c66e13a98523c5a1870cf147d1d2e66ac', disabled: this.invoiceInfo?.invoiceable_items?.filter(i => i.is_invoiceable)?.length === 0, loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand", id: `confirm-btn_${this._id}` }, "Confirm")), index.h("ir-preview-screen-dialog", { key: '5ceb4f07eb59a3774a660a6e6b391ecc82b3ad02', onOpenChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (!e.detail) {
                    this.invoice = null;
                }
            }, open: this.invoice !== null }, index.h("ir-proforma-invoice-preview", { key: 'a70d129e39d770dd4ec5c011a7c89c0ad132743c', invoice: this.invoice, property: calendarData.calendar_data.property, booking: this.booking })))));
    }
    static get watchers() { return {
        "booking": ["handleBookingChange"]
    }; }
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '441dfb543946f934c9ad659a906740080034ed53', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: 'e223eaa0af5edb6f0ac23d78792354b77991b437', booking: this.booking, formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: 'ac47fa676a23f9d5883d0e82e53d9eef6f51a67d', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: '7afc5dd7e4835da71dcb1bfb26ccbe59355e82cd', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: 'df7f7e472c4472d3bfc751b265a1bbc941276a24', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: '6412f2f5165842e751d927c30dbe05199bd8c216', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: '0a43a310f8e1e8e643872d4bd34b100be05261a2', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: 'ae5bd3d9b39f7303af6a87a625ac6eb541396c75', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'c292d942c8ce4fe058abb0942502176a369bc06e', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '72ad5f34dc2aee0b0f19f98b098f9f74aad1367e', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: '8f7f7bad05d371da7f2d39f381b2860dccce8815', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '1d92cdb907613c1dd74d644c87d3b40e6fa81cbf', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '2b69c073a0ec5e323437d5ed068d7436d79b9fb3', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '1d8c83879e55ffceb873032b00817e31451ec460', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: 'b3769a9a5ecfaa3898b27a0220420665fcb33c4c', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: '5670c5257414d49a94182876c08cf55de7e96995', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '5bdd71a78b9b3b85e4c0d665c154be98188e3a17', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-input", { key: '3e1600550a39db276010fa16c1366acf914622fa', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) })), functions.isAgentMode(this.booking) && this.hasUnassignedItems() && index.h("ir-service-assignee-select", { key: 'c60eec3e96cdf4912972f9da16ac1a183e008998', agent: this.booking.agent })));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '036f022f68c317de1f367325131fdac532b02d98', class: "payment-item__payment-item" }, index.h("div", { key: '204c90dd691732827fd1215331809e0673ca2f3b', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: 'a248e9cc72642bee042fafb69deb9a520403c94c', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '2b11a66efe1e12e05f9640dba09d6df373b03219', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: 'f14963f1fb74f431fc20f0ae13220cf36260630c', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'c28f1309144f75896bae28f335cc4e76ac20fa75', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '59560df4e0cfa46183ea14f6b86748a79d886928', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '44a6ff1d59b5b2e78ee544c6f0d384b395626418', class: "payment-item__payment-toolbar" }, index.h("p", { key: '59a97e2c8b74fb5033b084cc3a90526b7356cf6f', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'cca3c45f9424d0de57ae5d188dd56a48fa925277', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '8e32992db0eba4ebf0d99ea805fb73a69c57a1b5', class: "payment-item__payment-actions" }, index.h("div", { key: 'd4a904a1446904540564ec35207c16d3771a92b3', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '8d59e23a6b39e2ea5cd84f2df5a2ef41276559f1', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: 'cd92af44f61effc456329fbfc0090a30bb8baed0', name: "user", id: this._id }), index.h("wa-dropdown", { key: '38eaf7b7f8bb04c5a1c9333553e31f68b9e83672', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: '2bc4993874a5cc587e48ecfe6165b01078de32ab', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: 'e06f69389c216bec8f5b9a3f8600b2e46e1825fc', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: '09affa1f365bba56506dfdfd860a3b81f690278b', value: "receipt" }, index.h("wa-icon", { key: '3555bbcc414c683415dffbe86fe31c66f4fdb32e', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: 'fd0549a99ab8adef7273c54d9bbfeae94cfb8d5e', value: "edit" }, index.h("wa-icon", { key: '0568eca47690c849ac1d97a537b547b2fac216b0', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: '635bec4a9a0b3e86916ddaf56d6afbb9a36fa12c', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '82705ff4d436f3c72ea77407315f542f5df2e433', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: 'a1f0cc0d00aa09c0477e708b56d3fd7ce054f355', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: 'bc25d162dec4300117fccc9d6456c3ba4abd0a2f', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: '6858c305ca7a04da564b98521e36fb973f0f64fa', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: '1aad253de815a7726eaf80846be26eb6e2dd9dd3' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: 'dbfa2206f34762339c34a86d1b80949264d620ff', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'e9cb930dded44a77e060cfec6051e2425346993f' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '798a2d740b78d979319ce84ff9bae760c19048d7', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '2beed140d98438c44d1b81444e8d3ba4700f5b2a', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'ec32ef06408102c0b6d4e897ec24d2ce07150b6d' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '5748c72e4d9cc167722ec3629736fc410be8b2e6' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '6acd4483ace4b2d83207eac0ff0450a0227d00af', class: " payments-container" }, index.h("div", { key: '6d64b4912505487d93bc31061fc06d5d42d47caa', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'ab0fcd8f83904215ca5c57ba37c75a4a51157d26', class: "font-size-large p-0 m-0" }, "Folio"), index.h(HelpDocButton, { key: '66318f75df2eee452a33a294aa8550d8a9ab845b', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: '220d874a43189170a74b175544f38b901488b85f', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '79c4f008171a75b8de49faa59a8941ef6d8ad308', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: 'e30cfa8d14eb6ec9a7c11807f29b0c17129cc668', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'fa334943e70a7ca71e3239d7cfe4bdcd96e0522b', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '9556d0f9a100b2cb1fcf58d852add97614a263cf', booking: this.booking, onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: 'f8e14c28dc84354d3b9cf00962f3c3f66b3f9e8d', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '73fb9eb878522c4fcdc0f3faf2e470ae25ae8b67', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: 'f5dee8a9ad30bb61a7a1685e3d1cf75da69cb922', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: 'cf11687a98c9dbbd62f93a310513b2d8fdca249d', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: '849bc6a093cf540d42a548a534d2897767fafcb9', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '0169fe406d8bed32beb74e42faa8f8d8572904cb', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: '681dd7623de0e473d0719082fa45f156faa04d9e', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: '6c0d8f0807c3dc6103af9f7bbcf560ce090990b3', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '99d3e48691d609f189cd97737033e294bee72832', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: 'cf0d91ab746067347126ebffaf85f85bc1efc4ef', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '722f1d981ca1dc09cb8f7ed7caf5ec06b60d3523', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '7f9baaef609c287b67393fa74e48269a9edbfe83', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: 'e180318de54be6e44ecddc7bc0343e0ff7962326', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-input", { key: '4de7358bfb524802e86690926d2c9ab1fef2f41a', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: 'ad9edcb6e9ba22d964d39bce4f7de5102e3f139e', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '83b8a96869261c8d9ae31650b47c1eb014f3f855', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: '2b758f75260d6cd1aa4c9adbb00647e70795b2b3', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '666c6ceb1f687cd95f80c54f14aa6db06602e5a0', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-input", { key: 'ddf44e38bd01fc4c5697fbd788a58ed828d6f301', mask: 'price', label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, "onText-change": e => {
                this.pickupData = {
                    ...this.pickupData,
                    due_upon_booking: e.detail,
                };
            }, value: this.pickupData.due_upon_booking }, index.h("span", { key: '537fbe45946d25e398df65773b21dce7e50252e3', slot: "start" }, this.pickupData.currency?.symbol)), functions.isAgentMode(this.booking) && (index.h("ir-service-assignee-select", { key: '6f66f1acaede5b4cba49da2af2b7bfcd51a4578e', agent: this.booking.agent, assigneeType: this.assignee, onAssignmentChange: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.assignee = e.detail;
            } }))))));
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: '9ee287f7ac21f359a1e6b33c083b09514a4b7382' }, index.h("div", { key: '45f15faffe36968f89f7830352717d68900223e8', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: '4c3d80df6e037c164151af53e83552462c5e156c', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '4b21613769668438938f751dfc2efe81f960bdfb', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: 'd2bd021caad32f4d5d4d11978862203e3d1ba7e3', class: "reservation-information__row" }, index.h("ir-label", { key: '76c4bd22c106c15bae4b18470c03feb2e6206c86', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: 'c21062f6c02f25b0b1786ea61c836a7c8736df9f', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '580365a6cff9a3aaed34f02fe4cee70e90c80ce4', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: 'cc78f3238332cbf6d3b4ca907eb092258931a9e2', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '3ca0affd4afdb81675b37aac906c3b3311f1a969' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: 'ce25bba2dd02bf5ac628e3c3a6ddbecf85c0a9e9', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '2a2e06897c6d0d31c6692ab00532f0c35127693f', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '85c7bb307dd1075092632a0c60e2fcfae2191f81', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '9dceeeb29877d44594bc94f0ffb2cdd4be34da4c', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), !this.booking.agent && (index.h("div", { key: 'e2e2502f07848e6b8cdfc7b57533a522bceb801d', class: "reservation-information__row" }, index.h("ir-label", { key: 'c8a7a61b4986544e9b33ec22c35c029ed7fdf815', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: '7d58bda0c2821126636c440d6a5b97d32fd6e47f', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: '3aaee289f9bd952463bcc4be1d6bf9c79a2532c7', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'ec0388fe4ee7cea5774943996fd01a1b8d17d959', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } })))), this.booking.guest.mobile && index.h("ir-label", { key: '41f949c63aa8a61b6d1676037797d22676c270d6', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '05c8c03bbb8c5ef500468489d7d3d8a4677ab1e2', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '5363828a325d5ee6c140e53c2265f7512d27f574', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '06bfc3ee27d9d0904c7193eb2c8b74b1e9e6e991', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '5ed614a6c1f01bad1335c7818365c80832c76076', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: 'a84423bf940b175fafe7d840be0ff5af49d0aa85', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && (index.h("div", { key: 'd9246190f0875b0884a3ac63846aed9f5c054247', class: "reservation-information__row" }, index.h("ir-label", { key: 'c2e85eb6ee9c85760fca44707f21cc8fd640d86e', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, display: "flex", content: this.booking.arrival.description }), index.h("wa-tooltip", { key: '2528eb2fb175c6f3ada4a0240b2289ac43376910', for: `edit_arrival_time` }, "Edit arrival time"), index.h("ir-custom-button", { key: 'a88b0a454f6ab9476c50152e8aed7607bcfb3148', iconBtn: true, id: `edit_arrival_time`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irArrivalTimeDialogRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '271ae5e59c9944581bd8ddb9a45aeba8ec1d975d', name: "edit", label: "Edit arrival time", style: { fontSize: '1rem' } })))), this.booking.promo_key && index.h("ir-label", { key: '5297992a430d15b94675c023e05e157b635cb438', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '1176feddd09ca900ac40891848fbccb8a6a4758f', class: "d-flex align-items-center" }, index.h("svg", { key: '0c90a80b4fda8e824f0d45bb897518989c0110db', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'f69682cb2e8ec7cc0647447edcd2cd3700c0d5ef', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '21736fbd3c1b835b4b4212186c3237e892a97d22', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: 'e65ee23059e5d77a680046e6654d24d58f110371', class: "reservation-information__row" }, index.h("ir-label", { key: '7ac3dfdbc3d9e7861be149c825bf6221fb171cc1', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: 'e66c9389b30037cdf4039f8272f8da01d4e7c3be', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '081a6a70f8f427242886ca58cc09566101b76dcb', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: 'ca37fe1586f003eb59cf5eb5b08fd3843982c798', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: '87a22fe6daf5152fcc3dd1c764a17c091aba3dac', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: '903040256182c5f21c4ccf37bfe1797e208ddb6d', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) })), index.h("ir-arrival-time-dialog", { key: '4ae96c826600539391c3458d43a1d5e71ad1fb0a', booking: this.booking, arrivalTime: this.arrivalTime, ref: el => (this.irArrivalTimeDialogRef = el) })));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '94e41e9ed6811551dc6b731375a6f59c4dee240e' }, index.h("div", { key: '52a259c4d72e52b837e8e87880c8f3ae2abeb238', class: "booking-room__header-row" }, index.h("button", { key: 'b7b558770665c42095ca677e172e8d5668f4ca0e', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'aea3b7b2be91fd90e68dff40a9ab0867eaac236e', name: "chevron-right" })), index.h("div", { key: '9e5277ad802015691b7400ce742bf49a7e84c30f', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '1df89b5d62d63dab73d26997856f70dfe941555f',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '97fe627b77374ea551df02c5ba15ce810f256511', class: "booking-room__summary-row" }, index.h("p", { key: '1588bb4e0c4740a2d2876110dbaea4fe0063b9db', class: "booking-room__summary-text" }, index.h("span", { key: '4c646b90f48db8365e5bb1427e0171742c04b2ea', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'd5d0fda8d6ee20daa6a39fc762c0df691d427034', class: "booking-room__price-row" }, index.h("span", { key: '0720cd2646aa8955dbe533b59ff7e598b9b0ed9b', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (index.h("div", { key: '3ffdc5b8fed9a08edf238f1214c77176764945db', class: "booking-room__actions" }, index.h("wa-dropdown", { key: 'd4836178ed3ee2d4b3f8291b14109a4a681287b0', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, index.h("ir-custom-button", { key: '6804cbb8606f07704cbd08cffd007d4c388af21f', slot: "trigger", size: "small", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, index.h("wa-icon", { key: '1c89da0955ceb68739c4a0146800bd711f0249ef', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && index.h("wa-dropdown-item", { key: 'f8f7b9f094429d4bad75f198c703624335fdf4e3', value: "edit" }, "Edit"), functions.isAgentMode(this.booking) && index.h("wa-dropdown-item", { key: '65684331d46cd0deb4532dc21bf62bd64ac65d76', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (index.h("wa-dropdown-item", { key: '9ae82fcf4354f593056222aa2b32d19ab14c94f6', value: "delete", variant: "danger" }, "Delete"))))))), index.h("div", { key: '702f406dc09092b0477eb6ea4cfbf8ae29977ab7', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: 'ed1469ac43750519851974f58ad3bc4bfd1ea0a4', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        index.h("ir-unit-tag", { key: 'cc11a6c79798ef9f2d6ffccbe133ee5c721c6c48', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: '3779e4dc7ced6b4e28cbba35cd7164c001e89fd0', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: 'cb38ddb003e3946db3b9faac2fbb1e5cf3c9bf29', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales_store.locales.entries.Lcz_CheckOut))), index.h("div", { key: '5425f296d523f911155b8fe28d3a1b51d3c74451', class: "booking-room__guest-row" }, index.h("p", { key: '3fc1c3709dd436d62bdc167ba853869dfd819975', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h(index.Fragment, null, index.h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), index.h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: 'dc00b815abf2a73be367ea07170281b5cd5e305c', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (index.h("div", { key: '346565b8a57954e263b5cba5e4d2301867d40fbc', class: "booking-room__departure-row" }, index.h("p", { key: '9c89d6afa6c73955fe8e88cd09bdd86525918407', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), index.h("wa-select", { key: 'a359286c41d054b745e8aa7ae634dc7f7f72231d', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "small", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (index.h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (index.h("div", { key: '371986d6d1d9576941758141a9c3f262223294e4', class: "booking-room__details-container" }, index.h("div", { key: '57ddd0c7cfdd36c8544f63ee9b7ada836bf3aba2', class: "booking-room__breakdown-row" }, index.h("div", { key: '5575357fac6d159f2d8b59f8bd482388f7107439', class: "booking-room__breakdown-label-wrapper" }, index.h("p", { key: 'e478be49eae48c36b907f0db9764827425fda187', class: "booking-room__breakdown-label" }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'd45a0565ef56a99ae79cd98477af98d0ea900687', class: "booking-room__breakdown-table" }, index.h("table", { key: '3e88e9de73aa7920b90edc600ea5ea861e643edf' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '98c7eccdf96710c8f9c1cc21ed227522f5724dfb', class: '' }, index.h("th", { key: '6b54552dff408efde53f8685e5fae54052ed4063', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '9f1f112e75a8fb6ca07fbcf7f1b143cd7cc7ed79', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '99b07a1448e9dcbb6f389b72a4f54c67d6ab3171', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '1e3778569418c5efc260fd5f79df712edee6fce8', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'c7ba371de3a4aac6d1215e32b318b9c1ba940fe9' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '3457a5ae3c470a806fec2be7646a5d5eb92be111', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '138e043d7741a394dbe446adb094a9c302f48088', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: 'a287b687c089eac077d0bc57d56c2eef45c69b1a' }, index.h("ir-label", { key: '84db5f1b7f4b170bc97b254711d0ee4f6ddaead0', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '5c73b4fc13517c53623f19168250238607ed33aa', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-assignment-toggle-dialog", { key: '362fa49f91c1f0887701db6dc78d4b481d209379', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, index.h("span", { key: 'ff0f9ffb0639069ab594ea5ffbf03ecd50e40999', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', index.h("b", { key: '9fbd1f6411412b7b4bd41eb473060bd32fd93b6c' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), index.h("ir-dialog", { key: 'a7134dac4526a279032702582a7fb93134b2372b', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '6ecd487cce92806056bf85ceded788f25a1ca72c' }, this.renderModalMessage()), index.h("div", { key: '9fe132cdac0be66ddcc9fd04d49a0996624d17a9', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '970a10cf5758877db10d5932b16b7c4f3d7da848', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: '3cadcf2ec5680a9248dde1f8635c1b766615b25d', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '93ebb93a814aa56a0f9d2a08ad3b866b0c5eeee7', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: '1d4fb4b7c04760a96ee09103e65265dac35f58ba', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    isLoading;
    render() {
        return (index.h("ir-drawer", { key: 'a0d884a83e853c08b835b008c790df8c8e8f58f0', style: {
            ...
            } })), index.h("div", { key: 'c9c68b98a5c1b3662019a6c96db21742c0278cc3', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'c2cebb59d00d9019ef575a13122e17e875769144', size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel ?? 'Save'), index.h("ir-custom-button", { key: '9ea9bf4a246a051a325dd526db35ef0882488fef', value: "save", loading: this.isLoading === 'save', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales?.entries?.Lcz_Save ?? 'Save'), this.checkIn && (index.h("ir-custom-button", { key: 'bbd07b3e2b9d9d97c3ad971dd8154cf3a0a0227c', value: "save_checkin", loading: this.isLoading === 'save_checkin', size: "medium", form: `room-guests__${this.identifier}`, type: "submit", variant: "brand" }, locales_store.locales.entries?.Lcz_CheckIn ?? 'Check in')))));
    }
};
...
//# sourceMappingURL=igl-room-type_51.cjs.entry.js.map