...
const IrHkUnassignedUnitsDrawerForm = class {
    ...
    render() {
        return (index.h("form", { key: '0780d5dd13a0c33853d7ff8fad69f30406586e3d', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.assignUnits();
            } }, index.h("table", { key: 'a81732097a23a6a10fb09a7728d215837136f40a' }, index.h("thead", { key: 'cdc6ecc30abb27d35a521d74c6727fcbaec69cb2' }, index.h("th", { key: '09ce8005f086b74fc5bec3fae59e4f22230c6efb', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'c6c5aa9f7c155ea7aba99554ceb787d36b98963d', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'f83c578f25e1d78454fa008dc7fa3d339ca29c54', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '11e695aa6b6da73e8a5e80df62dfbe829a3ad147' }, this.renderRooms()))));
    }
};
