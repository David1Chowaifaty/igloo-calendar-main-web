...
const IrResetPassword = class {
    ...
    render() {
        ...
        // }
        return (index.h("div", { key: 'f161fee4128dda26014d3abcd4ffbc21186e7c7d', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, index.h(index.Fragment, { key: '8096081a8befc76cc6ecd4fee6decff005345857' }, !insideSidebar && (index.h(index.Fragment, { key: 'ee3c5ac644d1aef58e9451c4c29dfc4f4fc930be' }, index.h("ir-interceptor", { key: '33310919ec6d7acbbbeeba2267f451c09ce8a511', suppressToastEndpoints: ['/Change_User_Pwd'] }), index.h("ir-toast", { key: 'd47c7d776bae687bc4f484c8cc52ddaeedace8ba' }))), index.h("form", { key: 'c318c34741f2d46d01a1512dbfabbde007d43b88', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && index.h("ir-title", { key: '2725fbb3c9a11da8193be5e8bb781f7f7f365f33', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), index.h("div", { key: 'f1a512fd09ca84f28602e4c89d87edf429b2ec41', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, index.h("svg", { key: 'ccafc331ecde893c6802572871d3f67fb2f5954c', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, index.h("path", { key: 'c1a226b0292100ffdef0d5082f4a911e5954df94', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), index.h("div", { key: 'b67c45b6877e6b39f142de2bb861f6f60a49c7e1', class: "text-center mb-2" }, index.h("h4", { key: 'ba5d359033c18f9b931d53c8ef3a3d2840cae5aa', class: "mb-1" }, locales_store.locales?.entries?.Lcz_SetNewPassword), this.submitted ? (index.h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (index.h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (index.h("section", { key: 'ff5ff99eccc6b0efc78df5694ea122c068afbf39' }, index.h("div", { key: 'eff3d1fb73810a60832103b2904d15d150ebc1b7', class: 'mb-2 d-flex flex-column', style: { gap: '1rem' } }, index.h("div", { key: '52b647f8653083f76a7e473be41da0d1901c7617', class: "m-0 p-0" }, index.h("div", { key: 'a86c5d468677149f51f83212c02040aeb698bd3e', class: 'position-relative' }, index.h("ir-validator", { key: '2f3c16b4219a354b13269498220c2020e3a06709', schema: this.ResetPasswordSchema.shape.password, value: this.password }, index.h("ir-input", { key: '9632bb8fe72813b1a0adcd05416cf8280e971d59', type: "password", passwordToggle: true, "onText-change": e => (this.password = e.detail), onInputFocus: () => (this.showValidator = true), placeholder: locales_store.locales.entries?.Lcz_NewPassword, value: this.password }))), this.showValidator && index.h("ir-password-validator", { key: 'a5d72262e420f8e204de48a7f0ad58a31fe4e4d3', class: "mb-1", password: this.password })), index.h("div", { key: 'a179acdd87f83c822d0c55c0dbc2ec8a0cae12ad', class: 'position-relative' }, index.h("ir-validator", { key: '966302c4854fe13388b5c0e8e0e75fce2db2d211', schema: this.ResetPasswordSchema.shape.confirm_password, value: this.confirmPassword }, index.h("ir-input", { key: 'dfe9a10d7c819eaa720ea172ae428162cf321278', type: "password", passwordToggle: true, "onText-change": e => (this.confirmPassword = e.detail), placeholder: locales_store.locales.entries?.Lcz_ConfirmPassword, value: this.confirmPassword })))), !insideSidebar && (index.h("div", { key: '543c51a8659e947c07accb5e2f8d6974f319d42b', class: "d-flex flex-column mt-2 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, index.h("ir-custom-button", { key: '6b86abbda9556ed17abbc80ca28473e76a74a100',
            // btn_styles={'flex-fill'}
            onClickHandler: () => window.history.back(), class: "flex-fill",
            // text={locales.entries?.Lcz_Cancel}
            size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '1ff9469830ee0fcff41e4ab9d6db39bbcf347c19',
            // btn_styles={'flex-fill'}
            class: "flex-fill", loading: this.isLoading, type: "submit", size: "medium", variant: "brand" }, locales_store.locales.entries?.Lcz_ChangePassword)))))), insideSidebar && (index.h("div", { key: '74162d620395408b9916895b2ed9fcbf08012ec9', class: 'sheet-footer w-full' }, index.h("ir-custom-button", { key: '11d63ae07a083f2c6959ef91ff67ce2668c0c0e1', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", appearance: "filled", variant: "neutral", size: "medium" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'ea9de36132b278e7507545ff3267ee89c9eab6b2', variant: "brand", loading: this.isLoading, class: "flex-fill", type: "submit", size: "medium" }, locales_store.locales.entries.Lcz_ChangePassword)))))));
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        // ))
        )), this.user?.sign_ins?.length > 0 && (index.h("section", { key: '81cba5a3a83c94f29f0da0539f470cdef1afeecc', class: "logins-history-section mt-2" }, index.h("div", { key: '02fd4add9914faf06c045769bafa203716f26bec', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '916f7b37e07be20490b6e811bc8cf074217a9ffe', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: '6d70cca6d0ace31430e160588df37c6f820ca661', btn_styles: 'pr-0', text: !this.showFullHistory ? locales_store.locales.entries.Lcz_ViewAll : locales_store.locales.entries.Lcz_ViewLess, btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: '946fb29191231c670717b3c12a33da5155e78031', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
        ...
        })))), index.h("ir-sidebar", { key: 'ab04cd4ff6c804f21e49efe1071698deff554ac6', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '0891f82187bd1c78e71ae3b050df42f6be73b406', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))));
