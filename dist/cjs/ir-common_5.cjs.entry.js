...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '45debc9e17a6e118cc4e1785a14df1a51af4c9e0' }, index.h("slot", { key: '81a506b7013add9a13dad8132ac76566fe92371c' })));
    }
...
const IrMenuBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '71c95aa06a7e93547928befc1e2019bdc8a4e344', role: "menubar", class: hostClass }, index.h("nav", { key: '21e31cf9fd190639b4a7fc9f8fa7fdd22a384acf', class: "menu-bar", part: "container" }, this.isMobileLayout && (index.h("button", { key: 'b3f0df7e2e80589e47c5f4b3b833272a461b1cef', class: "menu-toggle", part: "toggle", type: "button", "aria-label": this.isSheetOpen ? 'Close menu' : 'Open menu', "aria-expanded": String(this.isSheetOpen), "aria-controls": this.sheetId, tabIndex: this.isSheetOpen ? -1 : 0, onClick: () => (this.isSheetOpen ? this.closeSheet() : this.openSheet()), ref: el => (this.toggleButtonRef = el) }, index.h("svg", { key: '7547d33ef0faddd02c665e97b18269834424da40', xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-menu-icon lucide-menu" }, index.h("path", { key: '34d0687b84998a66fea64028b01342862bba55f8', d: "M4 5h16" }), index.h("path", { key: '1b7f1ec28e438a1a0f3b821b843c3706d088ebe6', d: "M4 12h16" }), index.h("path", { key: '125dd0eb222fc29a3af02323a3e4ac759d03e474', d: "M4 19h16" })))), this.isMobileLayout ? (index.h("div", { id: this.sheetId, class: { 'menu-sheet': true, 'menu-sheet--open': this.isSheetOpen }, "aria-hidden": this.isSheetOpen ? 'false' : 'true' }, index.h("div", { class: "menu-sheet__panel", role: "dialog", "aria-modal": "true", "aria-labelledby": this.sheetTitleId, tabIndex: -1, ref: el => {
                this.sheetPanelRef = el;
                if (el) {
                    el.toggleAttribute('inert', !this.isSheetOpen);
                }
            } }, index.h("div", { class: "menu-sheet__header" }, index.h("slot", { name: "sheet-header" }, index.h("span", { id: this.sheetTitleId, class: "menu-sheet__title" }, "Menu")), index.h("button", { type: "button", class: "menu-sheet__close", "aria-label": "Close menu", onClick: this.closeSheet, tabIndex: this.isSheetOpen ? 0 : -1, ref: el => (this.closeButtonRef = el) }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-x" }, index.h("path", { d: "M18 6 6 18" }), index.h("path", { d: "m6 6 12 12" })))), index.h("div", { class: "menu-sheet__body" }, index.h("slot", null))), index.h("div", { class: "menu-sheet__overlay", role: "presentation", onClick: this.closeSheet.bind(this) }))) : (index.h("div", { class: "menu-items", part: "items" }, index.h("slot", null))))));
    }
...
const IrMenuBarItem = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.menuBarItemClick = index.createEvent(this, "menu-bar-item-click", 7);
        /**
    ...
    render() {
        return (index.h(index.Host, { key: '9b846f2544dcb5c0dc1bb3b417c64c583602de91', role: "menuitem", tabindex: "-1", part: "item", onClick: e => {
                if (!this.href)
                    this.menuBarItemClick.emit(e);
            } }, this.href ? (index.h("a", { target: this.target, onClick: e => {
                const ce = this.menuBarItemClick.emit(e);
                if (ce.defaultPrevented) {
                    e.preventDefault();
                }
            }, class: "menu-bar-item__link", href: this.href }, index.h("slot", null))) : (index.h("slot", null)), this.newBadge && index.h("ir-new-badge", { key: '5b9450dd9e04efb063d845add44ba9a4f3019f0c' })));
    }
};
...
const IrMenuBarMenu = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.menuBarOpenChange = index.createEvent(this, "menuBarOpenChange", 7);
        /**
         * Displays an `ir-new-badge` next to the trigger when set.
         */
        this.newBadge = false;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '605e1c36d72a9ecac637dbb0d7d71dc7bfe7fb39', class: hostClass, role: "none", onPointerEnter: supportsDropdownHover
                ? () => {
                    this.cancelDropdownClose();
                    this.open = true;
                }
                : undefined, onPointerLeave: supportsDropdownHover ? () => this.scheduleDropdownClose() : undefined }, index.h("div", { key: 'd7cc8005d17b9900ad81382e52f245abbac204d9', class: "menu-trigger-wrapper", part: "trigger", role: "menuitem", onClick: () => {
                if (this.hasDropdown) {
                    this.open = !this.open;
                }
                else {
            ...
            }, ref: el => (this.menuTriggerRef = el), tabindex: this.hasDropdown ? '0' : undefined, "aria-haspopup": this.hasDropdown ? 'menu' : undefined, "aria-expanded": this.hasDropdown ? String(this.open) : undefined }, index.h("slot", { key: 'a7c81ace22eba3fc63286fbddf3688fd9a13a6a2', name: "trigger" }), this.hasDropdown &&
            (!this.open ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "menu-bar-menu__accordion_indicator" }, index.h("path", { d: "m6 9 6 6 6-6" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "menu-bar-menu__accordion_indicator" }, index.h("path", { d: "m18 15-6-6-6 6" })))), this.newBadge && index.h("ir-new-badge", { key: '32bc70467aecb38953acce9ed8af86b10165e053', class: "menu-new-badge", part: "new-indicator" })), index.h("div", { key: 'e0b73fc017ad5373aced0a1af7e39b06a36eba53', class: "dropdown-menu", ref: el => (this.dropdownContainerRef = el), part: "dropdown", role: this.hasDropdown ? 'menu' : undefined, "data-state": !this.hasDropdown || !this.open ? 'open' : 'closed', onTransitionEnd: this.handleAccordionTransitionEnd }, index.h("div", { key: '2c1d117f4d208ab58c9ba3c533f98c7ec2668bde', id: "arrow" }), index.h("slot", { key: '0b8795c854d1bee6535d2020e08bfe6799bd02bf', onSlotchange: this.handleItemsSlotChange }))));
    }
    get hostEl() { return index.getElement(this); }
    static get watchers() { return {
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4be2faa5cfa6c685600bfe156493e6f3aafa13a9' }, index.h("span", { key: '2a9c0f275c55cbc6afe1ead4e0280d33754f2819', class: "new-badge" }, "new")));
    }
};
IrNewBadge.style = IrNewBadgeStyle0;

exports.ir_common = IrCommon;
exports.ir_menu_bar = IrMenuBar;
exports.ir_menu_bar_item = IrMenuBarItem;
exports.ir_menu_bar_menu = IrMenuBarMenu;
exports.ir_new_badge = IrNewBadge;

//# sourceMappingURL=ir-common_5.cjs.entry.js.map