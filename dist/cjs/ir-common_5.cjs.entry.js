...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: '30b17425927964b92669001974f8c54e3d0efc37' }, index.h("slot", { key: '858fc6af85172306888ec4b47596d396c916aca4' })));
    }
...
const IrMenuBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '90185f7f4f261aba279176e8b49d96a757d601d3', role: "menubar", class: hostClass }, index.h("nav", { key: 'f7375e7158b4bebc918a5530ae4ac94e2f3bf1b1', class: "menu-bar", part: "container" }, this.isMobileLayout && (index.h("button", { key: 'fde3a3d2e4030bdaf4ff67a6133271a2a5dbec7d', class: "menu-toggle", part: "toggle", type: "button", "aria-label": this.isSheetOpen ? 'Close menu' : 'Open menu', "aria-expanded": String(this.isSheetOpen), "aria-controls": this.sheetId, tabIndex: this.isSheetOpen ? -1 : 0, onClick: () => (this.isSheetOpen ? this.closeSheet() : this.openSheet()), ref: el => (this.toggleButtonRef = el) }, index.h("svg", { key: '2db878b9b989800ed98ace5a1b5aa2df30912e40', xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-menu-icon lucide-menu" }, index.h("path", { key: '0a134c2ae2894dccfda4b60c8efb73827f66c0c4', d: "M4 5h16" }), index.h("path", { key: '332ebcdafe3f9d1571c267714101e22d35033730', d: "M4 12h16" }), index.h("path", { key: 'c09e11c846d9eab08cbd1bc9b7b9626bb90a37d8', d: "M4 19h16" })))), this.isMobileLayout ? (index.h("div", { id: this.sheetId, class: { 'menu-sheet': true, 'menu-sheet--open': this.isSheetOpen }, "aria-hidden": this.isSheetOpen ? 'false' : 'true' }, index.h("div", { class: "menu-sheet__panel", role: "dialog", "aria-modal": "true", "aria-labelledby": this.sheetTitleId, tabIndex: -1, ref: el => {
...
const IrMenuBarItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bf80cf6aa8959020c23d88645d7e268087f102d0', role: "menuitem", tabindex: "-1", part: "item", onClick: e => {
                if (!this.href)
            ...
            }, class: "menu-bar-item__link", href: this.href }, index.h("slot", null))) : (index.h("slot", null)), this.newBadge && index.h("ir-new-badge", { key: '856d5aef2c06a05ba9e7983631af995e94a6312c' })));
    }
};
...
const IrMenuBarMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '048c50f3fdd3d9d27d849f5850ae3e209959036e', class: hostClass, role: "none", onPointerEnter: supportsDropdownHover
                ? () => {
                    this.cancelDropdownClose();
                    this.open = true;
                }
                : undefined, onPointerLeave: supportsDropdownHover ? () => this.scheduleDropdownClose() : undefined }, index.h("div", { key: 'bfd443f425c0ab865241b666d5ff0b4b339f3f1a', class: "menu-trigger-wrapper", part: "trigger", role: "menuitem", onClick: () => {
                if (this.hasDropdown) {
                    this.open = !this.open;
                }
                else {
            ...
            }, ref: el => (this.menuTriggerRef = el), tabindex: this.hasDropdown ? '0' : undefined, "aria-haspopup": this.hasDropdown ? 'menu' : undefined, "aria-expanded": this.hasDropdown ? String(this.open) : undefined }, index.h("slot", { key: '6551e340ee5c6367709818e92362ed9549d99217', name: "trigger" }), this.hasDropdown &&
            (!this.open ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "menu-bar-menu__accordion_indicator" }, index.h("path", { d: "m6 9 6 6 6-6" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "menu-bar-menu__accordion_indicator" }, index.h("path", { d: "m18 15-6-6-6 6" })))), this.newBadge && index.h("ir-new-badge", { key: '9fcd526d245c73002a5553e1d3bfc00af75ddd50', class: "menu-new-badge", part: "new-indicator" })), index.h("div", { key: 'c1f2fcd2badbc28326e1f7da788bb50bf684cc2c', class: "dropdown-menu", ref: el => (this.dropdownContainerRef = el), part: "dropdown", role: this.hasDropdown ? 'menu' : undefined, "data-state": !this.hasDropdown || !this.open ? 'open' : 'closed', onTransitionEnd: this.handleAccordionTransitionEnd }, index.h("div", { key: 'c0b9719cb800b729f7149594cc08a9d7b34de573', id: "arrow" }), index.h("slot", { key: 'd8f337e36cc4294ce349f1fd210f2f36dfdef7d4', onSlotchange: this.handleItemsSlotChange }))));
    }
    get hostEl() { return index.getElement(this); }
    static get watchers() { return {
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a1b409e11c7f232065befd30fdf6681d66af73f4' }, index.h("span", { key: '5e16c293b6dbee1fdeeeaa04eb4fea1c74101a87', class: "new-badge" }, "new")));
    }
};
