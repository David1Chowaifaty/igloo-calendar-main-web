...
const IrMenuBarItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fcf374f93531f756cb44afd26cfeececbe2dddbc', role: "menuitem", tabindex: "-1", part: "item", onClick: e => {
                if (!this.href)
            ...
            }, class: "menu-bar-item__link", href: this.href }, index.h("slot", null), this.newBadge && index.h("ir-new-badge", null))) : (index.h(index.Fragment, null, index.h("slot", null), this.newBadge && index.h("ir-new-badge", null)))));
    }
};
...
const IrMenuBarMenu = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9c99ab74e7663bbc779c0ddc5b6c5e920fb6c9f6', class: hostClass, role: "none", onPointerEnter: supportsDropdownHover
                ? () => {
                    this.cancelDropdownClose();
                    this.open = true;
                }
                : undefined, onPointerLeave: supportsDropdownHover ? () => this.scheduleDropdownClose() : undefined }, index.h("div", { key: '6ccee0bfc2ea1175b9db058de6821081bfbf19d2', class: "menu-trigger-wrapper", part: "trigger", role: "menuitem", onClick: () => {
                if (this.hasDropdown) {
                    this.open = !this.open;
                }
                else {
...
const IrNewBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4be2faa5cfa6c685600bfe156493e6f3aafa13a9' }, index.h("span", { key: '84bb2ee1bc6f2da76b780962729020eb0c6b4699', class: "new-badge", part: "base" }, "new")));
    }
};
