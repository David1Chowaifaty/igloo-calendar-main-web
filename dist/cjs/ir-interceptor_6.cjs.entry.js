...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '230d0eb2e72d9f471c9f4cdcff6cb9644a12b8d4' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'b8dad1d0c1a02242691addcb0df861719516f674', class: "loadingScreenContainer" }, index.h("div", { key: 'f56de4b2a7ea113dc3d60b2980c0a9be46aa6aa2', class: "loaderContainer" }, index.h("ir-spinner", { key: 'fbaf0ba10885242438da3522102bf11342f6543b' })))), this.showModal && (index.h("ir-otp-modal", { key: 'b7ba276f90442ea704e9035dd71623c088a2b2bc', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ed26f270fe90c2001427cc00ec4166425fb6cd4a', class: "otp-input-container" }, index.h("div", { key: 'c6dbb3690188e92232e6a220a09cdabd2e833218', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
