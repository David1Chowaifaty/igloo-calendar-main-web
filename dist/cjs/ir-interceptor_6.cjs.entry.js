...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b89efa2c138748154cbaac42703416e5bc9a3146' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '6eb54b85bdd56d527bab2b5523a6640142b7e96f', class: "loadingScreenContainer" }, index.h("div", { key: 'c06b3c544a5b186fe0109e62e5ecf97379fce32a', class: "loaderContainer" }, index.h("ir-spinner", { key: '1cb82d9c12406e5293489e219defa826c806b12b' })))), this.showModal && (index.h("ir-otp-modal", { key: '0fc81dd1be93382382140b5fa643159f900e2f08', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '458851ac6bf02f350103db33f1439ede7d73948e', class: "otp-input-container" }, index.h("div", { key: 'ba64268ce86fbee4414655140bad837be0f8e9a3', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
//# sourceMappingURL=ir-interceptor_6.cjs.entry.js.map