...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1db08a9fec27f6d0e7e51162e278e14aeebae7e3' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: 'bfd1460b08fd9a645014d9fb37fa15ca483ea943', class: "loadingScreenContainer" }, index.h("div", { key: 'c825a4303d25e1e2ceb27afa3d7364d5c0e7ec7f', class: "loaderContainer" }, index.h("ir-spinner", { key: '34f399fdd311988c8b677c0fc6ca64e91f10fae1' })))), this.showModal && (index.h("ir-otp-modal", { key: '8d91edbb6741d2a304a2fe4c145de4c76250bb71', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4e075981f5e9b2b00788c78ba3531a574a04fcd9', class: "otp-input-container" }, index.h("div", { key: '50960dafaf2a64404586d2bb84ea6613b027d9cf', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrToastAlert = class {
    ...
    render() {
        return (index.h("div", { key: '0fdc6c0863ee18b87256e2221c9e1914b41128a1', class: "toast", "data-position": this.position, "data-leaving": this.leaving, onMouseEnter: () => this.setInteracting(true), onMouseLeave: () => this.setInteracting(false), onFocusin: () => this.setInteracting(true), onFocusout: () => this.setInteracting(false) }, index.h("wa-callout", { key: 'b675511d6d4943f224f240eaa0bfc40b03871b4b', variant: this.calloutVariant }, this.getIcon(), index.h("div", { key: 'd08b2d31199e083b76203f0edbcebae14cb57d6b', class: "toast__body" }, this.label && index.h("h3", { key: '3ef844875726268282fbe53aad0b4143383bb4bc', class: "toast__title" }, this.label), this.description && index.h("p", { key: 'f25d4d70a1141174c094d1fb7f6946b27fa08612', class: "toast__description" }, this.description)))));
    }
};
...
const IrToastProvider = class {
    ...
    render() {
        return (index.h("div", { key: '4ecd86864f5ce3a2995dc4de6b9a4691c29c7924', ref: el => (this.popoverRef = el), popover: "manual", class: "toast-popover", onToggle: this.handlePopoverToggle }, index.h("div", { key: 'a72986077d42bb1fa76c11c5fe304f97f470dd71', class: `toast-container ${this.getPositionClass()} ${this.rtl ? 'rtl' : ''}`, role: "region", "aria-label": "Notifications", "aria-live": "polite", dir: this.rtl ? 'rtl' : 'ltr' }, this.toasts.map(toast => (index.h("div", { class: "toast-item", key: toast.id }, index.h("ir-toast-alert", { toastId: toast.id, label: toast.title, description: toast.description, dismissible: toast.dismissible, actionLabel: toast.actionLabel, position: this.getAlertPosition(), variant: this.mapVariant(toast.type), leaving: toast.leaving, onIrToastDismiss: this.handleToastDismiss, onIrToastInteractionChange: this.handleInteractionChange })))))));
    }
};
