...
const IrCombobox = class {
    ...
    render() {
        return (index.h("form", { key: 'bb42041e3c4c7cb1d792473799103683782516af', onSubmit: this.handleSubmit.bind(this), class: "m-0 p-0" }, index.h("input", { key: '1bf97c967a2fe9703d0a2072e613800d96f12482', id: this.input_id, ref: el => (this.inputRef = el), type: "text", disabled: this.disabled, value: this.value, placeholder: this.placeholder, class: "form-control bg-white", onKeyDown: this.handleKeyDown.bind(this), onBlur: this.handleBlur.bind(this), onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), autoFocus: this.autoFocus }), this.renderDropdown()));
    }
