...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '3a79d530c4ae85606730039f90d6e77f08c9e66d', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'f656d850e51b740282adca9a07bf364e7d659455', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '2f690e6456b14a63c95f57159c5812ebf4df036b', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '76c3d41fc00e7ac4146df173691ecbe8dda4450a', class: "input-group row m-0" }, label, index.h("select", { key: '3d668d28b289c2bb91bba687ccab2031afe850f6', style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '8f3d3ee04748241e6642a4f951dd1c02db95079d', value: '' }, this.firstOption), this.data.map(item => {
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0ab43eb17ea5044643fa26c5f38dbdb3bdec2cbc', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: 'eb1602381b1a0c0592f8a566c1602461b9af3e70', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: '9399faadd850f3bdf2ba0540f200846905f60050', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '9334fcfa03a8cc031b285d400da37500035e693e', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '67cf103696b99d01c2bedbdd5e69f6e816845491', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'e471386eedc5bd07a4c11ecc5c7feb05a134841d', class: "m-0 p-0 flex-grow-1" }, "Filters")), index.h("ir-button", { key: 'bea4ff677eb2243bcb1eb99897bce6be6439a6cf', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '61bb78025e3b420132c31484768ad3cd62c892fa', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: '32963c826f7ddb25e1d0afde01c19ab08dfde307', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '6b60a4303ab726c6ab7f8af444db2cacd211d574', class: "pt-1" }, index.h("p", { key: '1cd81ad57e0b696774ff5d5bdfc0a201e51f1ff8', class: "m-0 p-0" }, "Period"), index.h("ir-select", { key: '3c6ac5b7e73ba08e680fc5137409a2181f617db3', selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_service.housekeeping_store === null || housekeeping_service.housekeeping_store === void 0 ? void 0 : housekeeping_service.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), index.h("fieldset", { key: '5b1895c331210a54a3dd250f1310ace91484ea3e' }, index.h("p", { key: '4adc903639e33a90d5e1fef57b46e81af504b713', class: "m-0 p-0" }, "Housekeepers"), index.h("ir-select", { key: '78fbc5fd97262f8b2d5ff60f95764f5996a6e34c', selectedValue: ((_e = (_d = this.filters) === null || _d === void 0 ? void 0 : _d.housekeepers) === null || _e === void 0 ? void 0 : _e.ids.length) === housekeeping_service.housekeeping_store.hk_criteria.housekeepers.length ? '000' : (_g = (_f = this.filters) === null || _f === void 0 ? void 0 : _f.housekeepers) === null || _g === void 0 ? void 0 : _g.ids[0].toString(), LabelAvailable: false, showFirstOption: false, data: [
                { text: 'All housekeepers', value: '000' },
            ...
            } })), index.h("fieldset", { key: '99a2999710db6e6f0cfcb348a91a09cd9efc51f4', class: "mb-1" }, index.h("p", { key: '54e6871b20061b6046ff4fbfde7bd204dc8dca9d', class: "m-0 p-0" }, "Highlight check-ins"), index.h("ir-select", { key: '0c6fb939e4134364a3a3dec082bec3e1510ddbc8', selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: 'd3515ace3b9e39bc36acf6b0fd4c4394917ccbc8', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: 'd34fa4c4d73d508db73ff494487c0c6137e2a530', btn_type: "button", text: "Reset", size: "sm", btn_color: "outline", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '25da376cac7e3f2acff20577678f2c81d78c79f6', btn_type: "button", isLoading: this.isLoading, text: "Apply", size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
...
const IrTasksTable = class {
    ...
    render() {
        return (index.h("div", { key: '5411b152b8ea911b9a54a6867442b4122bf935da', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: 'b19fa2991af98a4cb11e12334ac3f09fac831186', class: "table" }, index.h("thead", { key: 'b41cb4f57657adc68d888f7e7c1790f9258b18e3', class: "table-header" }, index.h("tr", { key: '1e0e02505f2254eaa37c53cfeb8fa15573347948' }, index.h("th", { key: '2c1bac6183fbf1d8f224d200875e9d77d9d7a4aa' }, index.h("ir-checkbox", { key: 'fe04eedeef8da7bc5b83c7553b35969f962bd6f9', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '63cfa273064e11eb994721d98b653710f734d6bb' }, "Period"), index.h("th", { key: 'dcafdbee419ae981bd667efe815c8023d272b97d' }, "Unit"), index.h("th", { key: 'facbe6f6e49fa1e8130a7c1d1f6ff5273e27b239', class: 'sortable', onClick: () => this.handleSort('status') }, index.h("div", { key: '86958e4eef4a3bc76f4f2192accc0063be965269', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'f4e2f3fa929b7f43a63995ac3b7e6ef857b32c88' }, "Status"), index.h("svg", { key: '1e1d59cd8298a1862052f8a9b2a78900fbf73dc0', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'e96e3e21948525c30fea660003e78371a6deef60', d: "m21 16-4 4-4-4" }), index.h("path", { key: '8182583634243b651b71e21876220cdc5b804a58', d: "M17 20V4" }), index.h("path", { key: '6a1602f0b760f83fc3b2222b93b4005b2f1cce8d', d: "m3 8 4-4 4 4" }), index.h("path", { key: '9a67444fbe83c6fd123cac58ffeac6ca20e20bce', d: "M7 4v16" })))), index.h("th", { key: '7fe0c07d914da317b3e9549e23eeb36302f339be' }, "Hint"), index.h("th", { key: '474c75bc7257e45cd0956541ca088078abeadec8' }, "A"), index.h("th", { key: '9e31a1ae1c2a399feee2a1d416190d946e4ae8a6' }, "C"), index.h("th", { key: '2eea3de1349bb3fefda4c5650773e7dabce3dd0a' }, "I"), index.h("th", { key: 'a023943e7d4e164a6e1852d2b9a66d36c30b01bb', style: { textAlign: 'start' }, class: 'sortable', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '834dddcf85e84f91d3fae765e81dc8c3dac05ba3', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '87c07e74aa3a5a81506aca352217f5190a865af0' }, "Housekeeper"), index.h("svg", { key: '5ae0319fd8e8f2ba53e2546aa28e7c41eb0a4f67', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '1670c67552d3e1ce57408e48dcf03c7fc8cf3c97', d: "m21 16-4 4-4-4" }), index.h("path", { key: '21ff5c326ad98c7a0e495d55f1aa33012ec007b2', d: "M17 20V4" }), index.h("path", { key: 'c634856db31588292156189512083499c4e71c25', d: "m3 8 4-4 4 4" }), index.h("path", { key: '28c5d49b9fb3bb6b0d40b26ccf544bdb45df02f7', d: "M7 4v16" })))))), index.h("tbody", { key: 'a6d9a000c30c6224545602ca3de49019a02b4b58' }, this.tasks.length === 0 && (index.h("tr", { key: 'f2fe8b423be5b7a39f678beda334922b72088762' }, index.h("td", { key: 'b3e41444cf8978e5f08220f38ba154b80c566666', colSpan: 9, class: "text-center" }, index.h("div", { key: 'ac5ef302c6a4f1f02970a620dc3e5309ca9de6e4', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '81b406854a85600c3fdf9d7ecb037a2662870c5b' }, " No Tasks Found"))))), this.tasks.map(task => {
            var _a;
            const isSelected = this.selectedIds.includes(task.id);
            const isCheckable = this.isCheckable(task);
            return (index.h("tr", { style: isCheckable && { cursor: 'pointer' }, onClick: () => {
                    if (!isCheckable) {
                        return;
                    }
