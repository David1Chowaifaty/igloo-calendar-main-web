...
const IrHkArchive = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '87b4681d984b24ff5234ffa56a45baf736ba178e' }, index.h("ir-title", { key: '107471bf3f5816ca7ec2f4894e7b7ed8a88ff1d5', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '58b2c73a94b8552cfd534a5c13588b9e3ca19b34', class: "px-1" }, index.h("div", { key: 'c061d8e7a39072206641cc6e612c8f589c6365a4', class: "d-flex" }, index.h("ir-select", { key: '87b940fcf055c8ba1ede07dd6ad13c674eb49acd', class: "w-100", showFirstOption: false, LabelAvailable: false, data: [
            ...
            } }), index.h("ir-select", { key: '806c369799c0a03d4fc2c07ef9c189f50e13aab4', class: "ml-1 w-100", selectedValue: ((_c = (_b = this.filters) === null || _b === void 0 ? void 0 : _b.filtered_by_hkm) === null || _c === void 0 ? void 0 : _c.length) === housekeeping_service.housekeeping_store.hk_criteria.housekeepers.length ? '000' : (_e = (_d = this.filters) === null || _d === void 0 ? void 0 : _d.filtered_by_hkm[0]) === null || _e === void 0 ? void 0 : _e.toString(), LabelAvailable: false, showFirstOption: false, data: [
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '6aec772448c3ce06ec424a2397cd0196a66c5124', class: "d-flex flex-column flex-md-row align-items-md-center justify-content-between" }, index.h("h3", { key: 'ff481d22070d37294b9821e39b45a129b473e768', class: "mb-1 mb-md-0" }, "Housekeeping Tasks"), index.h("div", { key: '9ac91c8a4d4f5827a0f5d97dd241dc36c1b1f6ec', class: "d-flex", style: { gap: '1rem' } }, index.h("ir-button", { key: '5c378c6fe5adb5abd51e1965ffaad64422565a8a', size: "sm", btn_color: "outline", text: "Export", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            }, btnStyle: { height: '100%' }, iconPosition: "right", icon_name: "file", icon_style: { '--icon-size': '14px' } }), index.h("ir-button", { key: 'cce15dadb1e8d28c4163aa3f82c30fe3ff4158e8', size: "sm", btn_color: "outline", text: "Archives", btnStyle: { height: '100%' }, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: 'ff162c87cca8ff443518866a5042a9a2af3bf099', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
