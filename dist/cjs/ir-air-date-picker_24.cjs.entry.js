...
const IrDateRangeFilter = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7acfb985ed78fa2efba4ac1912303ac43c81a2aa' }, this.label && (index.h("label", { key: 'ec5fd029c9e4ef5c607948f52f70aa96f2045011', id: `${this.groupId}-label`, class: "drf-label", part: "label", htmlFor: `${this.groupId}-from-btn` }, this.label)), index.h("div", { key: '5d2d9229a6e08ff76fcf80dcf1918af7fbe4b9b7', part: "container", class: "drf-container", role: "group", "aria-labelledby": `${this.groupId}-label` }, !this.label && (index.h("span", { key: 'ffb5be3f64402e267974d1345491ef965e5df195', id: `${this.groupId}-label`, class: "sr-only" }, "Date range selector")), index.h("div", { key: '8a0b36f993f85dd4d432065d4f1a6eaa6c0e33e0', part: "field field-from", class: "drf-field" }, index.h("button", { key: 'b9653c6de41f6c5d2f669ca020921c8a77a18d74', id: `${this.groupId}-from-btn`, type: "button", part: "text-btn", class: `drf-text-btn${!fromLabel ? ' drf-text-btn--placeholder' : ''}`, onClick: () => this.fromDateSelectRef?.show(), "aria-haspopup": "dialog", "aria-label": fromLabel ? `Start date: ${fromLabel}` : 'Select start date' }, fromLabel ?? 'From'), fromLabel && this.withClear && (index.h("button", { key: 'bc6ae6c8f5b4eb2471bd957e8f17792d3a79f663', type: "button", part: "clear-btn", class: "drf-clear-btn", onClick: () => this.clearDate('from'), "aria-label": "Clear start date" }, index.h("wa-icon", { key: '401de7b981a1244c17cc31e84573f1c176d6e6cc', name: "xmark" }))), index.h("ir-date-select", { key: 'c66a5b51d16a33292db51230bf2f1f524ae741c8', ref: el => (this.fromDateSelectRef = el), exportparts: EXPORT_PARTS.from, date: this.dates.from?.format('YYYY-MM-DD') || null, placeholder: "From", minDate: this.minDate, maxDate: this.maxDate, emitEmptyDate: true, class: "drf-date-select", onDateChanged: evt => this.selectDate(evt.detail.start, 'from') }, index.h("button", { key: 'ef4f685716ba4fdfd79ea9ed78d0eba2eb09f7ab', slot: "trigger", type: "button", part: "cal-trigger", class: "drf-cal-trigger", "aria-label": "Open start date calendar" }, index.h("wa-icon", { key: '662aba4e00d3720a57cb31cdb37624fb79e5559e', name: "calendar", variant: "regular" })), this.showQuickActions && (index.h("div", { key: '71debc9b0b0e2d5fc716b5e5bee65e3040ab163b', part: "quick-actions", class: "drf-quick-actions", role: "group", "aria-label": "Quick start date options" }, this.quickDates.map(action => (index.h("ir-custom-button", { type: "button", variant: "neutral", appearance: "outlined", disabled: this.dates?.to?.isSameOrBefore(action.getDate(), 'date'), "aria-label": `Set start date to ${action.label}`, onClickHandler: () => {
                this.selectDate(action.getDate(), 'from');
                this.fromDateSelectRef?.hide();
            } }, action.label))))))), index.h("span", { key: '23e5631566fe83a9f89471362136f2591900ab4b', part: "divider", class: "drf-divider", "aria-hidden": "true" }), index.h("div", { key: '58adc0b1422d743d9300c554eaac522474b893a1', part: "field field-to", class: "drf-field" }, index.h("button", { key: '25caac55fb77230a48b692c7b546efb9b656467f', type: "button", part: "text-btn", class: `drf-text-btn${!toLabel ? ' drf-text-btn--placeholder' : ''}`, onClick: () => this.toDateSelectRef?.show(), "aria-haspopup": "dialog", "aria-label": toLabel ? `End date: ${toLabel}` : 'Select end date' }, toLabel ?? 'To'), toLabel && this.withClear && (index.h("button", { key: '301b0bc58e062d7888faad98309f6fffc24de68b', type: "button", part: "clear-btn", class: "drf-clear-btn", onClick: () => this.clearDate('to'), "aria-label": "Clear end date" }, index.h("wa-icon", { key: '659293d7cbeb086b0411825705bc255969d3f2c0', name: "xmark" }))), index.h("ir-date-select", { key: 'd2e3b662cc4fc4841f0cd204c6e80672641f25b0', ref: el => (this.toDateSelectRef = el), exportparts: EXPORT_PARTS.to, date: this.dates.to?.format('YYYY-MM-DD') || null, placeholder: "To", minDate: toMinDate, maxDate: this.maxDate, emitEmptyDate: true, class: "drf-date-select", onDateChanged: evt => this.selectDate(evt.detail.start, 'to') }, index.h("button", { key: '471efbaea60b2ac8463998d62e77bcfc886e6c8c', slot: "trigger", type: "button", part: "cal-trigger", class: "drf-cal-trigger", "aria-label": "Open end date calendar" }, index.h("wa-icon", { key: '8d9891d07809406159ca07f38dbdf74cb73ffd56', name: "calendar", variant: "regular" })), this.showQuickActions && (index.h("div", { key: '21afd4f1f8e59970b4a22488bfc6c150572d0fa4', part: "quick-actions", class: "drf-quick-actions", role: "group", "aria-label": "Quick end date options" }, this.quickDates.map(action => (index.h("ir-custom-button", { type: "button", variant: "neutral", appearance: "outlined", "aria-label": `Set end date to ${action.label}`, disabled: this.dates?.from?.isSameOrAfter(action.getDate(), 'date'), onClickHandler: () => {
                this.selectDate(action.getDate(), 'to');
                this.toDateSelectRef?.hide();
            } }, action.label))))))), index.h("span", { key: '083ea3761099ffcc5bf67e48aeacfa391cafe434', "aria-live": "polite", "aria-atomic": "true", class: "sr-only" }, this.liveMessage))));
    }
    static get watchers() { return {
...
const IrEmptyState = class {
    ...
    showIcon = true;
    render() {
        return (index.h(index.Host, { key: '894020fc794304a576eede3f7e7890af19e3fa5b' }, index.h("slot", { key: '2df91c8445acf19d8ea504caaa5346a2521d61cf', name: "icon" }, this.showIcon && (index.h("div", { key: 'd2ff7899e220def27e03e7e0ff84a4541c7ee65d', class: 'icon_container' }, index.h("wa-icon", { key: 'd3519738f3c44d25e0d537d56be17fe044b8b26e', name: "ban", style: { transform: 'rotate(90deg)' } })))), index.h("p", { key: 'd3a10cad16d28f422d0c4a6fbf01de4916f62455', part: "message", class: `message ${this.showIcon ? '' : '--secondary'}` }, this.message), index.h("slot", { key: '7d643c73bba0c9d5ff84fbf3ee6aac3403015f45' })));
    }
};
...
const IrFilterCard = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'c583042eee4540b61b50ab24746c71a4d8eed89a', class: expanded ? '' : 'filters__card__collapsed' }, index.h("div", { key: '760de1659c3585fcac07af4a875fc2f306e76a13', part: "header", class: "filters__header", slot: "header" }, index.h("div", { key: '7e8721b3ffd2371689d5c365137195469c27224f', class: "filters__title-group" }, index.h("wa-icon", { key: '41c99e2e3c388156e4bc31d5029e509f1e00926e', name: "filter", style: { fontSize: '1rem' } }), index.h("h4", { key: 'bd51016401f98fcf92951e12ca543f09fc3fb9e5', class: "filters__title" }, "Filter")), !this.isDesktop && (index.h("ir-custom-button", { key: '182ac40df2a364fa6cdf21533f760815e93778dc', appearance: "plain", class: "filters__collapse-btn", variant: "neutral", id: "drawer-icon", "aria-expanded": expanded ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", onClickHandler: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: 'ef554b5c9f9bc8c4758dfe26c02de270a61c77ae', style: { fontSize: '1rem' }, name: expanded ? 'eye-slash' : 'eye' })))), index.h("div", { key: '013ea764d4d78e123ba4faab29b6cd090ab10669', part: "filter-body", class: 'filters__body' }, index.h("slot", { key: 'f3d644ca3464e3841dba1901376b76cd0f381090' })), index.h("div", { key: '374838bd11bb768a81f9ce4f38e99bfc4a2eb2fb', part: "footer", class: 'filters__actions' }, index.h("slot", { key: '96cc84d7f379217b4a199487d4abf2de3353a501', name: "footer" }))));
    }
};
...
const IrInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a8ebfa3df7b0da737ee362dc90bc3cb3fa199e0c' }, index.h("wa-input", { key: '08ddde56c009fa9d00397d6ccc904f29a71ac207', part: "wa-input", type: this.type, name: this.name, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, oninput: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotState.get('label') && index.h("slot", { key: 'fa0c718fc72c0f335e2bd6cfe95c9ea33798932d', name: "label", slot: "label" }), this.slotState.get('start') && index.h("slot", { key: '026586c02c91521dd82b18bead3b0afc50499b0b', name: "start", slot: "start" }), this.slotState.get('end') && index.h("slot", { key: '11efb18aff2e335ba76ef4e5c5a01579c5a2bf05', name: "end", slot: "end" }), this.slotState.get('clear-icon') && index.h("slot", { key: '5b9bfd53bcd2fc0bd9efe68311d286a5f21a4adb', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && index.h("slot", { key: '873227eb4a5f2c0b18a5f0b6d22f266157916e5d', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && index.h("slot", { key: '37e158f4143a5ea2ab185abb1d5cc28e8286f6bb', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && index.h("slot", { key: 'ec197a0be49acce6265a57cd4517b5ce0af08da6', name: "hint", slot: "hint" }))));
    }
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fcdbaa4f4decc803410b6f34e6346c1e578e40df' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '9344a3a882501ddd225fab2308dcb49bdb89933f', class: "loadingScreenContainer" }, index.h("div", { key: 'ade97d1182a8d4bb6592372ff219f36a22ab538c', class: "loaderContainer" }, index.h("wa-spinner", { key: '31b198173a7daa41ba5d551a08d8f7c38b17b984', style: { fontSize: '2.5rem' } })))), this.showModal && (index.h("ir-otp-modal", { key: 'a47c6e74e0925dd93eeeb6b923b8268c88bb4ab8', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrMealReportFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filter-card", { key: 'f29dc7c305630ec44caf7a4557917d155923f0d0' }, index.h("wa-radio-group", { key: 'fc3b1a069e24c5eed92cf8a043ae3afd78144bc3', label: "Report type", size: "small", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, index.h("wa-radio", { key: '5726e20dd2b13a69b403aa2aee08512cdc6d604d', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, "Guest list"), index.h("wa-radio", { key: 'f417d9f56a206f284bb08c899fa0bc248b2cdcb7', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, "Meal count")), this.reportType === 'GUEST_LIST' ? (index.h("wa-radio-group", { label: "Stay date", size: "small", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            (mealTypes.length > 0 ? (index.h("wa-radio-group", { defaultValue: this.mealType, label: "Meal type", size: "small", orientation: "horizontal", value: this.mealType, style: { width: '100%' }, onchange: e => {
                ...
                } }, mealTypes.map(type => (index.h("wa-radio", { style: { flex: '1' }, appearance: "button", value: type.CODE_NAME }, type.CODE_VALUE_EN))))) : (index.h("div", { class: "ir-meal-report-filters__warning" }, "No meal types found."))), index.h("div", { key: 'f8b581f162673ac5690a0abf13bfe7a642a891c9', slot: "footer" }, index.h("ir-custom-button", { key: '68e308cd987bd9d696ca295d492cf15800133d40', type: "button", size: "small", variant: "neutral", appearance: "filled", onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
            ...
            } }, this.lcz.Lcz_Reset || 'Reset'), index.h("ir-custom-button", { key: 'a0d6a001959b8ee79c026221edbdfe43350b691d', type: "button", size: "small", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f7fa9f278f09fd2112dab72cf1717acc5e0c8929', class: "otp-input-container" }, index.h("div", { key: '83cbc11ac807515ab38885f36848270928713a24', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5147aaea61a39745a8b520195c0923dac43552bb' }, index.h("wa-spinner", { key: '75b04682dbc4d19ae111cd490c5043fd3bb19929', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrToastProvider = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.toastAction = index.createEvent(this, "toastAction", 7);
    }
    position = 'top-end';
    rtl = false;
    duration = 5000;
