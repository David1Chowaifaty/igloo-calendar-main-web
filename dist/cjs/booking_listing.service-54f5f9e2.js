...
class BookingListingService extends Token.Token {
    ...
    async getExposedBookings(params) {
        ...
        const { data } = await axios.axios.post(`/Get_Exposed_Bookings?Ticket=${token}`, Object.assign(Object.assign({}, params), { extras: utils.extras }));
        const result = data.My_Result;
...
//# sourceMappingURL=booking_listing.service-54f5f9e2.js.map