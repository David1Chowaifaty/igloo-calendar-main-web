...
const IrColumnAutocomplete = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c3295fb880ac18c8bdb53921478f2cb001c01258' }, index.h("wa-popover", { key: '31dc9ebdba76887e8334c5e495f5bfbabbf92a60', placement: "bottom", for: this.generatedTriggerId, class: "column-autocomplete__popover" }, index.h("div", { key: '75ebfaba66e3016842b747b653b4e032771ee588', class: "column-autocomplete__input-container" }, index.h("wa-input", { key: '604164d82791c0a33920c84f1cbfa15233a3d10f', size: "s", value: this.query, placeholder: this.placeholder, oninput: this.onQueryInput })), index.h("div", { key: '07de0636a48f82699802b80a08bff1843e4b15c7', class: "column-autocomplete__list" }, this.showSelectAll && (index.h("wa-checkbox", { key: 'bb24dec2a75ace7b5c426c4fff258acabe6db8f2', checked: this.areAllFilteredSelected, indeterminate: this.areSomeFilteredSelected, onchange: this.onToggleAll }, this.selectAllLabel)), filteredOptions.length > 0 ? (filteredOptions.map(option => (index.h("wa-checkbox", { checked: this.selected.includes(option), onchange: event => this.onToggleOption(event, option) }, option)))) : (index.h("div", { class: "column-autocomplete__empty" }, this.emptyLabel)))), index.h("div", { key: '10c7ce5acb6d88aaedf40eca8ff89d6fa3eb181c', id: this.generatedTriggerId }, index.h("slot", { key: '4236bb62093ba0c46322b90cb89fedfb2bd07e8d', name: "trigger" }, index.h("wa-button", { key: 'e71446f10a237bf2739246249fe367a6326618d4', size: "s", variant: "neutral", appearance: "plain", class: "header-button" }, index.h("wa-icon", { key: '7448238009e49727f5a9c8be40bf038f72e4ec76', name: "filter" }))))));
    }
