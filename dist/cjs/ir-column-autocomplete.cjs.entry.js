...
const IrColumnAutocomplete = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9bf1bd264eabd07242b6625943116fa1278d5a42' }, index.h("wa-popover", { key: 'f341ea9af1c0484098d54f6a9fa54aec7dbe0d8c', placement: "bottom", for: this.generatedTriggerId, class: "column-autocomplete__popover" }, index.h("div", { key: '9805dd4ffd1e14e9069f94c5319074443ad9311b', class: "column-autocomplete__input-container" }, index.h("wa-input", { key: '061af130bee792f87b184cef7fb0036cb1e6bc74', size: "small", value: this.query, placeholder: this.placeholder, oninput: this.onQueryInput })), index.h("div", { key: '81b8c0474af23f78ee124d267cd4a5b7810f578b', class: "column-autocomplete__list" }, this.showSelectAll && (index.h("wa-checkbox", { key: '3bdebade7b823e50162cd5690303c1b69fbda06c', checked: this.areAllFilteredSelected, indeterminate: this.areSomeFilteredSelected, onchange: this.onToggleAll }, this.selectAllLabel)), filteredOptions.length > 0 ? (filteredOptions.map(option => (index.h("wa-checkbox", { checked: this.selected.includes(option), onchange: event => this.onToggleOption(event, option) }, option)))) : (index.h("div", { class: "column-autocomplete__empty" }, this.emptyLabel)))), index.h("div", { key: '2253499bd6fd953feba0cc8f29ca6451f4dcd6b5', id: this.generatedTriggerId }, index.h("slot", { key: 'f663b80d4c115b054f743b54b56d46792e24aabe', name: "trigger" }, index.h("wa-button", { key: '495f1eb1dddf66c0118b876942c71e2024e8e7b6', size: "small", variant: "neutral", appearance: "plain", class: "header-button" }, index.h("wa-icon", { key: 'a6ba6d0bd732cc0e32b6a523c59669e02531f3bb', name: "filter" }))))));
    }
