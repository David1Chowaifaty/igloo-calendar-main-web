...
const IrColumnAutocomplete = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0a5e0facc460a4302eaa1d745b74745a73c12dfc' }, index.h("wa-popover", { key: '81fa9333f669242534dc637ee2a2478b2a50958d', placement: "bottom", for: this.generatedTriggerId, class: "column-autocomplete__popover" }, index.h("div", { key: 'd76cff47e6a3a9fb24d245177765519ea4f84052', class: "column-autocomplete__input-container" }, index.h("wa-input", { key: '47a7cf761b3232cc0a830487e381be34c72ec2c3', size: "small", value: this.query, placeholder: this.placeholder, oninput: this.onQueryInput })), index.h("div", { key: '685afbdd344e115189fb0382597c40fbeb1bbd12', class: "column-autocomplete__list" }, this.showSelectAll && (index.h("wa-checkbox", { key: 'd8646f57d8ec5ecc686d43911b1052aabc8bbdf9', checked: this.areAllFilteredSelected, indeterminate: this.areSomeFilteredSelected, onchange: this.onToggleAll }, this.selectAllLabel)), filteredOptions.length > 0 ? (filteredOptions.map(option => (index.h("wa-checkbox", { checked: this.selected.includes(option), onchange: event => this.onToggleOption(event, option) }, option)))) : (index.h("div", { class: "column-autocomplete__empty" }, this.emptyLabel)))), index.h("div", { key: '1cdc73236998f2b2f0f6ded6c4aa1d2a73ad3ae4', id: this.generatedTriggerId }, index.h("slot", { key: '8251b24b38b2bd0738d2d5070d9a14c881843bd8', name: "trigger" }, index.h("wa-button", { key: '2b545fc3a9e618e41f43c113f50d4a4adeae024d', size: "small", variant: "neutral", appearance: "plain", class: "header-button" }, index.h("wa-icon", { key: '098706798f1320e2ef7eb05884d1cfb68cbe9d3b', name: "filter" }))))));
    }
