...
var clFiscalDocument_service = require('./cl-fiscal-document.service-DGmjC-qv.js');
var t = require('./t-C54QV4_c.js');
require('./ApiClient-u7fuhiXA.js');
require('./axios-EresIryl.js');
require('./_commonjsHelpers-BJu3ubxk.js');
require('./index-DpwnNqsB.js');
...
const IrClDebitNotePreview = class {
    ...
    async fetchData() {
        ...
        try {
            ...
            this.error = e?.message ?? t.t('Lcz_FailedToLoadDebitNoteData', { fallback: 'Failed to load debit note data.' });
        }
        finally {
