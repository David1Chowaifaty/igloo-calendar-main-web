...
const IrCheckBoxes = class {
    ...
    render() {
        return (index.h("div", { key: '16f4ea1fdeacb205e3174f27deb79ab7c9ea4ba0' }, this.checkboxes.map((checkbox, index$1) => (index.h("ir-checkbox", { name: index$1.toString(), label: checkbox.text, value: checkbox.value, checked: checkbox.checked || false })))));
    }
};
