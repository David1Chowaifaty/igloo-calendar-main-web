...
const IrCheckBoxes = class {
    ...
    render() {
        return (index.h("div", { key: '5a1b7d24d704bb1a7b887042762600aa2b0837bb' }, this.checkboxes.map((checkbox, index$1) => (index.h("ir-checkbox", { name: index$1.toString(), label: checkbox.text, value: checkbox.value, checked: checkbox.checked || false })))));
    }
};
