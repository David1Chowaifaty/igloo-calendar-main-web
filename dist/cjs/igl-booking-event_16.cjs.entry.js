...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7277f6262466ea8b72dca41a48886ad423534b7c', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '7cea756b0373f8aaecdd5af8c6834d8f23e50384', class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '47c43497ff66fab9bcca00aaa028ab13ff650786', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '3eca1364fc229d874bf775cdf590ce8ff6ee93ff', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '0197b83fdecf5c0b7dc220f4840bb3043f9e704c', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '2f16582be5e7cdd3ba7088e4f2c090c5473b2d3a', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '393639ef3e3f45615ac7a0ec6f3d10f567b33cfc', class: "bookingEventTitle", style: { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'a7bdcf856e820c2c7a391da171f9582a600ccbf8' }, index.h("div", { key: '8108f53b090f7238da075c9680d4a74204a15efe', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '470f8f2844165b45ead0c5e42e7ea8c17db75885', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: 'd2b1cf0bd4b31b67d5873dc92cc09b150e34bf03', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'a31d9ce9ce2f9eee794cea3c433666527992ea54', class: "sheet-body px-1" }, index.h("div", { key: '08268dcd20a051883e434833d8d4e6d2b4547da7', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, index.h("p", { key: 'c54cfcc3eea6751678a6a7e3d102c8252bd26a2d', class: "m-0 p-0" }, "Select the unit to"), index.h("ir-select", { key: '1f0689a8fd1612993ef0f94e92de99e901406621', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), index.h("div", { key: 'c7de6f89aef9ff8b2bf7cc55f8d9a15aeabd4a41' }, this.errors === 'rooms' && (index.h("p", { key: '850960c18e5c359ba37d102553a519eb84260703', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("ul", { key: 'ddde10b1f061152be683add2066d4b9e035fdf34', class: "room-type-list", ref: el => (this.unitSections = el) }, calendarData.calendar_data.roomsInfo.map(roomType => {
        ...
        }))), index.h("table", { key: '63919ad06f19672d7f35c95ceb07add61c3e92e7', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'b46bf2cc8d4065d0458c57707458dd3a795409aa' }, index.h("tr", { key: 'b5aa34c87104c34f809690abd629ac0c5ee5b0e6' }, index.h("th", { key: 'd989a4ced64f17cdc238b1b57f74794efdad37d0', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: 'abd85346627b286f196740633fe624f7888c02f8', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '3d31503a081c680ac07283c0aca58f8e5ab09d12' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: '14adc377a4a51bf5de48741ad7609d4af33a78ff', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: 'c41fef76d23e477fa324abf9d4e3715d79a1225d' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: 'df83f05e163840542eec16caafb9398239fda5c3', class: 'sheet-footer' }, index.h("ir-button", { key: '6794eb047e690e8a522e84a1a6b77ffccf1b694d', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'fa7546a1a61669fff080a3d91dff6567cd287fa4', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: '490eda0ebec1511cb6361cde66fb64a810657675', class: 'bulk-operations-sheet-container' }, index.h("div", { key: 'b6091a4f6459e23481ede63a6fcf71b5568d59cc', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'e74ed590f9e06f5c0b72ab53b0f71e5354f09ac3', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '5562d4126780e80fe0150f5dc3140ce16767f84a', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'eebdf60cfd616989173512444becbc3e5e6155c7', class: "sheet-body px-1" }, index.h("div", { key: '6989696850ae23fe20e5818d791b8eae78ddbd84', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: 'a2e4772f1bd0e136d490b04d03dedd83c3863ef4' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: 'c4c6eb73d898f7d4595d8498d5963cba2b6e309c' }, this.errors === 'rooms' && (index.h("p", { key: '6789a3bf4fcbc7903e154915734d3ba91b09dfaf', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: 'f2dbb912408acbad566a33407a26ea1b1b69d1c1', ref: el => (this.unitSections = el) }, index.h("thead", { key: '0833d47483d0f34fe63c956243e44e0e318af0f7' }, index.h("tr", { key: '0ee5a9d2f4c4a857e884469a9c898311674cb0e4' }, index.h("th", { key: '5243b5f97e67e762d4be9a62835a29d50d22087f', class: "sr-only" }, "choice"), index.h("th", { key: 'f09592e1cedbb81f2da2f4ca03e7313d1f275589', class: "sr-only" }, "room type"))), index.h("tbody", { key: '68d348fd2d44c07faf3a300cb318edcb5ec685a5' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: 'aed9d623987ba10b0ce84a38c47493fbbc562f35', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: 'aff1ddb07fc1f0fb4a12294a688a11d1471aad82', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: '65344765d42de10d7fbe9aea64b94b7cc3447b0d', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: 'eeb88a7827428df6a7493c91626c0fd981e2f1a1', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '4addd7681b6b6e6b9f533353d3c80e191cdd7a2f' }, index.h("tr", { key: '48796539f10af43d5ed843440e26bdbbb9c52d5e' }, index.h("th", { key: 'f3220d70c9ae50a1373af7be6e636bf4ced7ebc6', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '904251a12cacbddf45617f42409fb5cfef318c5f', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '2ecb811f88e257becb4dd2d86d77d4ae817a1fa2' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: 'beed10435007e83f7ba0e4b59e115e96ea9fe195', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '5356139594d3045483e0ee607d35f621c3dbbf30' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate : this.minDate;
        ...
        })))), index.h("div", { key: 'e05da211e5bc95004e76711b045a8c5a396099b5', class: 'sheet-footer' }, index.h("ir-button", { key: 'c033d43d71a79301041c1f789404357c3d8b797c', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '9613fee5f1e6b72afe1370c44047dc705d28445e', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f178ed726d15da34c63e123783f0ab08279cde5d' }, index.h("div", { key: 'f47ef9a62eb18ec249e02d33232f6d8fd502318a', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'f104114a74a2b9b3d627edea71ddf7f808688e28', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a6a4e9ef339739dc5d159bfe2e3786dfc2b31b2e' }, index.h("div", { key: 'f9d52b8cdd4ccd52f68bbce36df304bd6deac937', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '8c8e713009264e2df39fbf980367d3278b81bb6b', class: "header__fd-actions" }, index.h("div", { key: '65c47206a6b3c00346c656bfc06e63b42e5d51bf', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '1f4401db96f17dc4b593767a03aaea41a2f11e1d', variant: "icon", icon_name: "server", style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: 'dbbf8c752319c23657220d5f0b14acab72dbca0a', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: 'aa94ba2e289ca826ffea1eb46670571d3f8278ee', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: '393b2bfd4307568b76c2991c594630e4b1aa7043', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: '0830237744b67c1e731c357a60c175abfd2d0cd9', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: '542400b75e3b58f6d8241c5874e5f17cf82ede6f', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: '681549c381a16d1c964fbeadd095f1d1b52e7e13', class: "searchContiner" }, index.h("ir-picker", { key: 'b7e90dc74aa2a47996edb6eda6e23c073a714d2c', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: 'd00f83ec4c0bc5bad0f70331b7197941f0fe33de', class: "stickyCell headersContainer" }, index.h("div", { key: 'babfabb471caa327e8e016aa696f55ac66117b73', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '376686df1590c2bc6cee71fbccb951e81c7d4d02', class: "legendContainer pr-1 text-left pb-4" }, index.h("div", { key: '544b2ebdf226b8eae9117167084ad8fd354a86bc', class: 'w-full' }, index.h("div", { key: '03155075937096b6dffad2c0f557b78d9476ae90', class: 'w-full' }, index.h("div", { key: '17b7cebad1b34d5a05de2a8e1970869982f571cc', class: "stickyHeader pt-1 " }, index.h("p", { key: 'c9e75170184c475e1e0eced1e69d69ed2d7ff4c9', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: 'f79d71818bb2b51c559b54b473ee4052487cc59a', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '3815edd8c20af316eb34e7e59cbc4577678ba5b2', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'b7d7c0ad1209e72ecb65df2e5e383c5f89d4d4e6', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: 'a449d6f817ebe030aebfa11401de789d5bccb141' })), index.h("div", { key: 'cd9724d736786e06b35ce129858ffe717fe26732', class: "mt-2 pl-1" }, index.h("table", { key: 'd4d44853f92718947a43829303d78eaf6c333f86' }, (() => {
        ...
        }), index.h("tr", { key: '0d3981bfd9cdc2c520fedacb5c71b56242fd5bec' }, index.h("td", { key: '08762afebf76d85e8123c6e758c4c2e6d8a2f86d', colSpan: 2 }, index.h("hr", { key: 'dfe7efc159e9011cc56b60eec9c913bd6d87d625', style: { marginTop: '0.5rem', marginBottom: '0.5rem' } }))), index.h("tr", { key: '6eda2a9333e307d5fcb165ab92da551dc1317199' }, index.h("th", { key: '53d9981929908d5fc94717157814b1d5fc38fbd2', colSpan: 2, class: "", style: { paddingBottom: '0.5rem' } }, index.h("div", { key: '7ab670de37d2cd08bccfc9a574054e46bcb645d5', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: '09361edde4fd059abf8807ad3d18d088b9ffdcb0' }, "Default colors")))), this.legendData.map(legendInfo => {
        ...
        }), index.h("tr", { key: '4943068397f449db2b58092c9e4784880bda5097' }, index.h("td", { key: '94e95390fc12236d4452dddee4b25a5e4d25591f', colSpan: 2 }, index.h("hr", { key: '5e22d9ff010fdbe50698bb234640abc00ab93d6a', style: { marginTop: '0.5rem', marginBottom: '0.5rem' } }))), index.h("tr", { key: '4a819ab6d8c938b1be8f75b2351ed94d7e4c6526' }, index.h("th", { key: 'f09699afc6fdb75bbbb56d29709864dbcc6667c1', colSpan: 2, style: { paddingBottom: '0.5rem' } }, index.h("div", { key: '6b521fb5faecfb2b4155e7239e1d06067239eae6', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: 'de5a126bb71ca7ca8096313a8d45e746b7bf2e35' }, "Use your own colors"), index.h("ir-new-badge", { key: '2e5004d8c72800ec0a9792e2c3455c9f182e39bf' })))), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        }))), index.h("hr", { key: 'c90d0d77f5759414f5fc2af0a74a15bed5ba8178', style: { marginTop: '1rem', marginBottom: '0.5rem' } }), index.h("div", { key: '03b9e2fac9fe09ac6a3537e398f6acbc5e4cbd29', class: "mt-1" }, index.h("div", { key: '49191fe8180080f37abc81e1ee9583f740c5ec0c', class: "legendCalendar" }, index.h("div", { key: '91fbf1af4a1c4d16247aedd2b82cdbf39931b554', class: "legendRow align-items-center" }, index.h("div", { key: '81a675ba3f7e1e372059f46f3953e6c027400727', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'ecd7676778e35780e45eb4feaa18dca4f1259b18' }, "MAR 2022")), index.h("div", { key: '9d03028e4d87361ffa624113880ed8468eabbb5d', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'fcc1db522c110d28a14eaa66d8acc8a4c54a3ce9', class: "legendRow" }, index.h("div", { key: '0f2c32be3529ebecb24e7865d2e897cd2034852a', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: '8fdeb1c2d16eb930959c32be6fbb619d6af5de91', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '181863812f85d5f813f2c9b6bcaebd0f6342a2b8', class: "highphenLegend" }, index.h("div", { key: '015342ad8d95464accabc979da008bc6b80e641a' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '91584f31a5816f44f5c7998ebe8692a6e963d577', class: "legendRow" }, index.h("div", { key: 'c1d80aab7144d119014db3c842595a13fb0a29b1', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'e9a497de76cc6bbaebadd3cc48e99a12cf67873c', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '1f10e2a271cd76d4ff8446b7a9998400d437ed11', class: "legendRow" }, index.h("div", { key: 'fdf90668b4613318addb0365e20951e97154c311', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'a13221012c54e9e13149a8772fdb4140c3875d7e', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '3f02899d18abff73e25f723a8d4d185d4cf7850b', class: "legendRow" }, index.h("div", { key: '526e05c9c782e9c244f476731bc2693bfb6c624c', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '0adb1a9d8034ad9b5371a953fed15c28c0cd78ae', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
    static get watchers() { return {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'b936141de9f3a1791ceb934c1ea2773ca05e45f8', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: 'c47b6da4b6d4f4f73d2206c5de3cab76356d2427' }, index.h("div", { key: '7117867a6dea593fe87d21cec97373c2c856b823', class: "dialog-body" }, index.h("p", { key: '8a2d70d82fb244580013b9d087e5995c87676378', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '27df2e2cde969c73192cc2e13a53ab92c8fc6caf', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '28d08191fe41ee18177b01214c606496718dcc25', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'e1887d6fb8a503b1f89b75a6600065c75125d4b3', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '52a26e4d951f2d755095e5e16566662100191e73', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: '44024c277fe3c0ef9e6457630542e738c41ab9fa', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '4e2a32eea55bdfd2a90e77159f50183adf80d5c9', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '28b27ade2ccf1d185374f557907a91da2af59d7e', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '8f60c6ef971902c68f73e6c4a8c519d289d671fc', class: "px-1 sheet-body" }, index.h("div", { key: '49348203471ce491bea1c34b90453ba3937dac35', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'dc1ed8e126cd7a11bcc4efa236fb468926a25c19' }, index.h("ir-date-view", { key: '00fad800dcf46b989658be646e6e05912e2710ca', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: 'c91144d6c63820441e8fb2e3e4b3ece73f639238', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: 'fb1327ba65a4c1e22f2740c5d8dbbcaca0b1f5ea', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'f7d5ba40c04316edc407089ebbfd3d7a276e418d' }, "From:"), index.h("ir-date-picker", { key: '29cfdd213dd9bfb398321e2b1c09795e647a862b', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '079804d42576881a168c75e6b0199454c4660bd0', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '1c506902aa81f457b925b8e527bf7211c305a4f1', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '245730a13555d6ea7c3e375a42fd6c7720c217dd', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '9e0d8ec3ecb8320d1374fb08baac21d0cb27fcfb', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: 'a31e0404f5394fe2b45816e398445f98fd07b6c9', class: 'sheet-footer' }, index.h("ir-button", { key: 'cef8222b8bab83e04a42d61afab2b292ddc8e1af', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '643d8ee794cfd4b3be3a6538d46d2058c965af2a', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7b5d9f9ae7599006b6aae5503ce92777b1e4447c' }, index.h("div", { key: '135ac55e3fac12fadf7d6d9e6af8ecec96487e8d', class: "sectionContainer" }, index.h("div", { key: 'f35ac1136c3c4fa2eaba3f7c9af9954e0ca3eaf3', class: "font-weight-bold mt-1 font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd91026873c9a0e23f0438e7e4e6b2e67483f3d11', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '5d57fcb6429d446c5eeda93a34756eb36b4e2e47', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '979828fea8c661845f3d22ed358c8c0f5fc11cc4', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: '120805745293e163b7d79bf4fc45f24f4329e51c', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, index.h("slot", { key: '56333b73354a4253810aa26ccb3735abbdc47cd8', name: "end" }))))));
    }
};
