...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: '28897841a28871c89262b39941ca790668ecb079', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '85c3a6b6c7ea90623368381d512cd78be43baf3f', class: "sheet-body px-1" }, index.h("div", { key: '0d0ca78feeda312ba5d7a5c310142060ea2f72dc', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, index.h("p", { key: '87bf5c41226b0c463c6c4bf2e984aad7e287b4ea', class: "m-0 p-0" }, "Select the unit to"), index.h("ir-select", { key: '311875577ce0ba644c52bbe0a5521ee8edf98b2c', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), index.h("div", { key: 'a62e53437fb84bb18774d1100e7c247fec8efaad' }, this.errors === 'rooms' && (index.h("p", { key: '935efa72401becffa905e57658e6173a3851be45', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("ul", { key: 'a13da8da2647be9cec3641f3255e2a6c9b5af073', class: "room-type-list", ref: el => (this.unitSections = el) }, calendarData.calendar_data.roomsInfo.map(roomType => {
        ...
        }))), index.h("table", { key: '56d57817ea6b86a83d88095cd5f5bef6cf779492', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '8c038d4b0b4503a41151e320a2ae8250bbc59b9e' }, index.h("tr", { key: '9ede2a0c046b94cca8ae4850ea1d0a0a75e43289' }, index.h("th", { key: '6aa74d2f9938875fb89a72b0b22614bfc8445c8d', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '55932857fe3240065e9a1bf8a08ba36927230de6', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'e6eb25956fd3e51cc006e23cac9b5b522718f9ab' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: '1017f947716b17aa7bfb72e2d19158fcaa1adfd6', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '63917917171a9f063687af44a9cdd0489f15459c' }, this.dates.map((d, i) => {
        ...
        })))), index.h("div", { key: '9c8f79f1a255c190f2c9abb4b8b4b25f8d71be42', class: 'sheet-footer' }, index.h("ir-button", { key: '41d1a543395aca22f097b2c563b8538926491fdd', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'b4c539f38a66e8260468d67c52cc8a8e256cbf27', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '287017b1f9c5646ce1332d88512058348725f20f', class: "footerContainer" }, index.h("div", { key: '10542a159d54738f508fdb8fa777baee7d76480c', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: 'bb9fec55a8a12c923d416b1fe907e19ccdb70a83', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, index.h("svg", { key: '86f85793975db56e4801eb3544b0f0ebbbce31c7', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { key: '59d696b7bd29780f2ab505ce7586bf9dc90be9b9', fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" })), index.h("span", { key: 'c4e7855f1a802ef7946195a7a375ab0814dae115' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '711ec1c3cedc5c1c1661029ee5612b20e53f4cc0' }, "v1.02"), index.h("ir-new-badge", { key: '6b6caa9aa4110de0f234f3f058af2ed6393ed9a0', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ce9127343ea0438b6afcfb16c0b0759ebb4fa8a1' }, index.h("div", { key: '1e1bc6fb8b4f6028791fb6b6482f14fd4b78c9fd', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '347ac0ee863b63563888862b1fe5c92287df48d5', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '98a62425db000d20551c29d191bbde9dc37d1e1f', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: '386f0e7a6123062c6c83e90980efe68175e880bd', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: '605f53d1e57c166ba34698fe6cb6e9bda68a76a0', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: '6004f82b8c2f605a2252b513e421315ccb748e86', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: 'ee810d38aa47cd268b6904c27560b2029a263913', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: 'c12867f9a93b58a452a1acca2b377cbd36720e28', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: 'a1752a5244e782d221c868bed63c5ef72cf0db64', class: "row justify-content-around no-gutters searchContiner" }, index.h("ir-m-combobox", { key: '67a35b4a388d3a605249f6ff25e0354765b739e5', placeholder: locales_store.locales.entries.Lcz_FindUnit, options: this.roomsList.map(r => ({
                label: r.name,
                value: r.id,
            })), onOptionChange: e => {
                this.handleScrollToRoom(e.detail.value);
            } }))), index.h("div", { key: '8de1fb6e1e858a4b8ef31a22d7b14e9b2f8febaf', class: "stickyCell headersContainer" }, index.h("div", { key: 'ddd8b1872ae6b069330ce591742b5f39e646b4e4', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
    static get watchers() { return {
...
const IglLegends = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '7993e5d784c6664e89051f3181acd63b5493df21', class: "legendContainer pr-1 text-left pb-4" }, index.h("div", { key: 'dc9348002b82a690f0a968eac5b1f15ae652a825', class: 'w-full' }, index.h("div", { key: '7cb6efdaaab206c60dd3c1a01b3f2243b2e0743b', class: 'w-full' }, index.h("div", { key: 'bdee4778906c952dbd88c140ca37f6e7dfacc7d1', class: "stickyHeader pt-1 " }, index.h("p", { key: '62f80f4bb330c4ab715b531209b05c5bd96e887b', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: 'c68b410aa1870d91638e2e24f436453273349f48', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '10a2e7ae45f96e165ea6053fdf6d515a11f1813a', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'cb79d15821c2bc329553fe47dc1754986e9e6d6e', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '6ca44508c19b4bb2b26313c049046121ac8aea41' })), index.h("div", { key: '43898db92b59861fa1d357a23610ec4c71988425', class: "mt-2 pl-1" }, index.h("table", { key: '0838e04ea6b02945b3724d5ee6e9bd44892f3acb' }, (() => {
        ...
        }), index.h("tr", { key: '8f2ba39b9f23ab730af89b73011200793c39fd77' }, index.h("td", { key: '068fed0ecb17ac6af8e34e64a00887e8e5496fa6', colSpan: 2 }, index.h("hr", { key: 'bd096b403817d5059fc26f074996281e9af3d02b', style: { marginTop: '0.5rem', marginBottom: '0.5rem' } }))), index.h("tr", { key: '7905f0955b8aef8f70e3616b57ab4f27bfb4bd71' }, index.h("th", { key: '764693a7a034025ae0a3898fb6390180cec16b1e', colSpan: 2, class: "", style: { paddingBottom: '0.5rem' } }, index.h("div", { key: 'be846fdde2a31f10f8f1c7081ffd79cb5d3135f0', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: '112714c9937ff62b8f8b648af49bae2e05599211' }, "Default colors")))), this.legendData.map(legendInfo => {
        ...
        }), index.h("tr", { key: 'ac875c89b8d3ca23df67a6b6edd72ce18bba6ce8' }, index.h("td", { key: 'c4acef1c7990913425cfe38e756a2a23388633bc', colSpan: 2 }, index.h("hr", { key: '5b97a34c2e5e9bb51d2fde292a33fc5fb09032c5', style: { marginTop: '0.5rem', marginBottom: '0.5rem' } }))), index.h("tr", { key: '9d9f5a840fa44bbc1aec28cff346ca7454af7fd0' }, index.h("th", { key: 'ed037c0970708d11c0e4501e8b501ac5c8618288', colSpan: 2, style: { paddingBottom: '0.5rem' } }, index.h("div", { key: '2b6323ef8bc5660255d51d8af69558157090acaa', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: '3496f90058d9dfd51d201e9e1db576b482a568a6' }, "Use your own colors"), index.h("ir-new-badge", { key: 'af54cee714c2f6ca30096585046f4d8b055712c5' })))), (_a = calendarData.calendar_data.property.calendar_extra) === null || _a === void 0 ? void 0 :
            ...
            }))), index.h("hr", { key: '1d2bb4f591b164daf6623ff45973cfd146dd0937', style: { marginTop: '1rem', marginBottom: '0.5rem' } }), index.h("div", { key: '73d07c5abc36ec73968ca8de14c30d80b14cb94f', class: "mt-1" }, index.h("div", { key: '7dad72b79320775db336612220ce39749017943d', class: "legendCalendar" }, index.h("div", { key: 'ca25780b726e77a63f3f8c1f61331b93e11da964', class: "legendRow align-items-center" }, index.h("div", { key: 'a1615e4c0b5d9d05aeaf60aafb393cb1ec7804eb', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '86b8a299745312c5e77f6ea8756714698cf3a863' }, "MAR 2022")), index.h("div", { key: '59ad10383106694737de87508b1153918ec56275', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: 'dc6a5f25377e6ecb30619ccee8d813f378582b11', class: "legendRow" }, index.h("div", { key: '9e8623cc9e360d0af8ca90b2e56163bfe7aa6fa8', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: '9a58b7616445d5de111f5c058056139142e26b02', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '87e89a6b32f47d4300d15daa01a03ad56ee7f236', class: "highphenLegend" }, index.h("div", { key: '5f1073d707f27fedd3f9a0d06c7af23764982301' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '78d1ddb8f5ea545cccabca305dbf5cb03bb911af', class: "legendRow" }, index.h("div", { key: '0ffbdbd0da798912046d619328596a3eec746f53', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: 'a10d43f8505764e5feb8ba50e69ea19d177fba37', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'c9a943ddda3880c161447ad84bc79bd4bf5ccea2', class: "legendRow" }, index.h("div", { key: 'f95a02c1e34fb9ad98bf0ddd576922b8c9aaea9e', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '3b183c69dbbc5e800d3f0b804bd8c92d8f9d8793', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '5644122ab47fc06165cf3b025c85e2367867f14c', class: "legendRow" }, index.h("div", { key: '7af8ed1981f451885c4471f2cf902367f396566e', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '90ef267c25f9db50c347b71404a1f0a614d0122c', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
    static get watchers() { return {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'f8d05ecefbfa825c6960cc9e5c03bf492cd1c4a2', ref: el => (this.dialogEl = el), onOpenChange: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '3dc3978f5818ca0c41a86805f823daaac9437480' }, this.data.title && index.h("div", { key: '4728c2068d04f7393b2301502877cdf07d801e86', slot: "modal-title" }, this.data.title), index.h("div", { key: 'b2ddd9020373860b26e9a6904f89767a6993988d', slot: "modal-body", class: "dialog-body" }, index.h("p", { key: 'b9cfea3802ca93dc624877169f387d742a0a1bdf', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (index.h("ir-select", { key: '9ca1947dbac2c5294d1a535bf99bd43d637dad66', ref: el => (this.rateplanSelectEl = el), required: true, firstOption: "Select rate plan...", data: this.rateplanOptions.map(option => ({ text: option.text, value: option.value })), error: this.showRateplanError, onSelectChange: this.handleRateplanChange }))), index.h("div", { key: 'ee7537c6b375fb2bd85b2150d3107c5f5fe88c3d', class: "dialog-footer", slot: "modal-footer" }, index.h("ir-button", { key: 'ebd80de6ec4512d73fae72e0302d01554fe68f9b', onClick: this.handleCancelClick, text: "Cancel", size: "md", btn_color: "secondary" }), index.h("ir-button", { key: 'a2f819e6227f20850e7f771d4998bbf23959bd97', text: "Confirm", onClick: () => this.reallocateUnit(), size: "md", isLoading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }))))));
    }
...
const IglSplitBooking = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g;
        return (index.h("form", { key: 'bd5e1dc2cfda4b97eaf69b781b7668520c233ff9', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '19c6b7a3614944709ef1a0c34f4704a4e6eaf397', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${(_a = this.room) === null || _a === void 0 ? void 0 : _a.unit['name']}` }), index.h("section", { key: '06d86ae9845bf6e150de729c9fb0a156bf9256da', class: "px-1 sheet-body" }, index.h("div", { key: '3c616bf3cdd3d6d942c5bcb333a54d067a3e1519', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '3a213c7df5db1bd348860b1dee35ac45445b0e31' }, index.h("ir-date-view", { key: 'c2a3dd1fa6d042ce7f1687de2a6441081a805307', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '9fae47841b6b58be624fb4d50abc3307295fa481', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '7ce35830363a43d70ccdc5876438e348d95670df', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'e6b9eccfbfa84cf0b441dc51baf151c5eb383243' }, "From:"), index.h("ir-date-picker", { key: 'b92cbea1093568603c8d31f9f72caa9b3889698a', "data-testid": "pickup_arrival_date", date: (_c = (_b = this.selectedDates) === null || _b === void 0 ? void 0 : _b.from_date) === null || _c === void 0 ? void 0 : _c.format('YYYY-MM-DD'), maxDate: (_d = this.defaultDates) === null || _d === void 0 ? void 0 : _d.to_date.format('YYYY-MM-DD'), minDate: (_e = this.defaultDates) === null || _e === void 0 ? void 0 : _e.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: 'f86cdcec2491029f169b8050cf79c63bfd750b0e', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '9b4ee505d797d617c5a690f73cca825c5454c687', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.roomtype_id) && index.h("p", { key: 'ce1e9e4d3966121f91f86abe704f9946a0639174', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: 'd7e484ea496c3487c7c99d5e1a66aa1be7c93a83', class: "room-type-list mt-2" }, (_g = this.roomTypes) === null || _g === void 0 ? void 0 : _g.map(roomType => {
        ...
        }))), index.h("div", { key: '351a4b4f20eabd514008fb5eeec077224a07e388', class: 'sheet-footer' }, index.h("ir-button", { key: '514e1dc46774a5971413b02ef4889d776f8912e5', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '5de04d8e382927d2f44355cda992deb56d11c857', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'cecb8a951ad656ecfec0d005505ca23785ef96fb' }, index.h("div", { key: '96976cc9b64f3a183446404404907c97e75ddb41', class: "sectionContainer" }, index.h("div", { key: 'f567c916f0812d2c0ff38d074aa1ff1da9d636a2', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5e5d958cc28c179d36046216aa31840ec73222f3', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '443214bc0cae1c197931c9da74b711b18acae869', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '10d45a69788a9159b106a7027fdcd8873fa01365', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: '61a887712b59033ed648755aa83fd5eed42341d3', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, index.h("slot", { key: '34dc58fa219d7d6a39e2203108eeddf8b501bd7f', name: "end" }))))));
    }
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8d7d71a398ae473eaf194fc3f718d27de84fd3b5' }, this.phase === 'spinner' ? (index.h("svg", { part: "spinner", width: "18", height: "18", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { d: "M10.14,1.16a11,11,0,0,0-9,8.92A1.59,1.59,0,0,0,2.46,12,1.52,1.52,0,0,0,4.11,10.7a8,8,0,0,1,6.66-6.61A1.42,1.42,0,0,0,12,2.69h0A1.57,1.57,0,0,0,10.14,1.16Z", class: "spinner" }))) : (index.h("ir-icons", { part: "check", name: "check", style: { color: '#45b16d' } }))));
    }
    static get watchers() { return {
