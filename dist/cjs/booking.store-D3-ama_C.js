...
var booking = require('./booking-8g-2AB9e.js');
var index$1 = require('./index-daCuTVuG.js');
...
const ZIEntrySchema = index.libExports.z.object({
...
const NumberOrStringSchema = index.libExports.union([index.libExports.number(), index.libExports.string().optional()]);
const CurrencySchema$1 = index.libExports.object({
    id: index.libExports.number(),
});
const CurrencyWithCodeSchema = CurrencySchema$1.extend({
    code: index.libExports.string().optional(),
});
const ItemSchema$1 = index.libExports.object({
    amount: index.libExports.number(),
    type: index.libExports.string().optional(),
    key: index.libExports.union([index.libExports.number(), index.libExports.string().optional()]),
    description: index.libExports.string().optional().optional().default(''),
});
const TargetSchema = index.libExports.object({
    code: index.libExports.string().optional(),
    description: index.libExports.string().optional(),
});
index.libExports.object({
    unit_id: index.libExports.number(),
    from_date: index.libExports.string().optional(),
    to_date: index.libExports.string().optional(),
});
index.libExports.object({
    starter: index.libExports.string().optional(),
});
index.libExports.object({
    booking_nbr: index.libExports.string().optional(),
    currency_id: index.libExports.number(),
    language: index.libExports.string().optional().optional(),
    rate_plan_id: index.libExports.number(),
    room_type_id: index.libExports.number(),
    property_id: index.libExports.number(),
    is_preserve_history: index.libExports.boolean().optional(),
    room_identifier: index.libExports.string().optional().optional(),
});
index.libExports.object({
    booking_nbr: index.libExports.string().optional(),
    room_identifier: index.libExports.string().optional(),
    status: index.libExports.string().optional(),
});
index.libExports.object({
    booking_nbr: index.libExports.string().optional(),
    currency_id: index.libExports.number(),
    language: index.libExports.string().optional(),
});
const RestrictionSchema = index.libExports.object({
    room_type_id: NumberOrStringSchema,
    night: index.libExports.string().optional(),
});
index.libExports.object({
    is_closed: index.libExports.boolean(),
    restrictions: index.libExports.array(RestrictionSchema),
    operation_type: index.libExports.string().optional().optional(),
});
index.libExports.object({
    book_nbr: index.libExports.string().optional(),
    status: index.libExports.string().optional(),
});
const AdultChildCountSchema = index.libExports.object({
    adult: index.libExports.number(),
    child: index.libExports.number(),
});
index.libExports.object({
    from_date: index.libExports.string().optional(),
    to_date: index.libExports.string().optional(),
    propertyid: index.libExports.number(),
    adultChildCount: AdultChildCountSchema,
    language: index.libExports.string().optional(),
    room_type_ids: index.libExports.array(index.libExports.number()),
    room_type_ids_to_update: index.libExports.array(index.libExports.number()).optional(),
    rate_plan_ids: index.libExports.array(index.libExports.number()).optional(),
    currency: CurrencyWithCodeSchema,
    is_in_agent_mode: index.libExports.boolean().optional(),
    agent_id: NumberOrStringSchema.optional(),
});
const AvailabilityBracketSchema = index.libExports.object({
    from_date: index.libExports.string().optional(),
    to_date: index.libExports.string().optional(),
});
index.libExports.object({
    unit_id: index.libExports.number(),
    block_status_code: index.libExports.enum(['003', '004', '002']).optional(),
    description: index.libExports.string().optional().optional(),
    property_id: index.libExports.number(),
    brackets: index.libExports.array(AvailabilityBracketSchema),
});
const SetDepartureTimePropsSchema = index.libExports.object({
    property_id: index.libExports.number(),
    room_identifier: index.libExports.string().optional(),
    code: index.libExports.string().optional(),
});
index.libExports.object({
    service: index.libExports.custom(),
    booking_nbr: NumberOrStringSchema,
    is_remove: index.libExports.boolean(),
});
/*Arrivals */
const GetRoomsToCheckInPropsSchema = index.libExports.object({
    property_id: index.libExports.string(),
    check_in_date: index.libExports.string(),
    page_index: index.libExports.number().default(1),
    page_size: index.libExports.number().default(10),
});
/*Departures */
const GetRoomsToCheckOutPropsSchema = index.libExports.object({
    property_id: index.libExports.string(),
    check_out_date: index.libExports.string(),
    page_index: index.libExports.number().default(1),
    page_size: index.libExports.number().default(10),
});
/* INVOICE TYPES */
const GetBookingInvoiceInfoPropsSchema = index.libExports.object({
    booking_nbr: index.libExports.string().optional(),
});
const VoidInvoicePropsSchema = index.libExports.object({
    invoice_nbr: index.libExports.string().optional(),
    reason: index.libExports.string().optional(),
    property_id: index.libExports.number(),
});
const InvoiceSchema$1 = index.libExports.object({
    booking_nbr: index.libExports.string().optional(),
    currency: CurrencySchema$1,
    target: TargetSchema,
    Date: index.libExports.string().optional(),
    nbr: index.libExports.string().optional(),
    remark: index.libExports.string().optional(),
    billed_to_name: index.libExports.string().optional(),
    billed_to_tax: index.libExports.string().optional(),
    items: index.libExports.array(ItemSchema$1),
});
const IssueInvoicePropsSchema = index.libExports.object({
    is_proforma: index.libExports.boolean().optional().default(false),
    property_id: index.libExports.number(),
    invoice: InvoiceSchema$1,
});
const PrintInvoicePropsSchema = index.libExports.object({
    invoice_nbr: index.libExports.string().optional(),
    property_id: index.libExports.number(),
    mode: index.libExports.enum(['invoice', 'creditnote', 'proforma']),
    invoice: InvoiceSchema$1.optional(),
});
const ExposedGuestSchema = index.libExports.object({
    address: index.libExports.null(),
    alternative_email: index.libExports.null(),
    cci: index.libExports.null(),
    city: index.libExports.null(),
    country: index.libExports.null(),
    country_id: index.libExports.number(),
    country_phone_prefix: index.libExports.string(),
    dob: index.libExports.null(),
    email: index.libExports.string(),
    first_name: index.libExports.string(),
    id: index.libExports.number(),
    id_info: index.libExports.null(),
    is_main: index.libExports.boolean(),
    last_name: index.libExports.string(),
    mobile: index.libExports.string(),
    mobile_without_prefix: index.libExports.string(),
    nbr_confirmed_bookings: index.libExports.number(),
    notes: index.libExports.null(),
    password: index.libExports.null(),
    subscribe_to_news_letter: index.libExports.null(),
});
index.libExports.array(ExposedGuestSchema);
const SetHbPreferencePropsSchema = index.libExports.object({
    property_id: index.libExports.number(),
    room_identifier: index.libExports.string(),
    code: index.libExports.union([index.libExports.literal('001'), index.libExports.literal('002')]),
});
const CalculateExclusiveTaxPropsSchema = index.libExports.object({
    property_id: index.libExports.number().min(1),
    amount: index.libExports.number(),
    taxes_to_include: commonSchemas.TaxTypesSchema,
});
const AckExposedRevisionPropsSchema = index.libExports.object({
    revision_id: index.libExports.number(),
});
const VoidPaymentPropsSchema = index.libExports.object({
    receipt_nbr: index.libExports.string(),
    booking_nbr: index.libExports.string(),
});
const CalculateOptimBaseGrossAmountParamsSchema = index.libExports.object({
    booking_nbr: index.libExports.string(),
});
const SimulateDirectBookingParamsSchema = index.libExports.object({
    booking_nbr: index.libExports.string(),
});
const DoDayUseParamsSchema = index.libExports.object({
    language: index.libExports.string().min(1),
    is_to_block: index.libExports.boolean().optional().default(false),
    booking: index.libExports.object({
        property: index.libExports.object({
            id: index.libExports.number(),
        }),
        occupancy: index.libExports.object({
            adult_nbr: index.libExports.number().nullable(),
            children_nbr: index.libExports.number().nullable(),
            infant_nbr: index.libExports.number().nullable(),
        })
            .optional()
            .nullable(),
        currency: index.libExports.object({
            id: index.libExports.number(),
        }),
        source: index.libExports.object({
            code: index.libExports.string().min(1),
        }),
        guest: index.libExports.object({
            first_name: index.libExports.string().min(1),
            last_name: index.libExports.string().min(1),
            email: index.libExports.union([index.libExports.string().trim().email(), index.libExports.literal('')]),
            mobile: index.libExports.string(),
        }),
        from_date: index.libExports.string().min(1),
        to_date: index.libExports.string().min(1),
        status: index.libExports.object({
            code: index.libExports.string().min(1),
        }),
        remark: index.libExports.string(),
    }),
    extra_service: index.libExports.object({
        pr_id: index.libExports.number(),
        category: index.libExports.object({
            code: index.libExports.string().min(1),
        }),
        description: index.libExports.string().optional().default(''),
        start_date: index.libExports.string().min(1),
        end_date: index.libExports.string().min(1),
        from_time: index.libExports.string().min(1),
        to_time: index.libExports.string().min(1),
        net_amount: index.libExports.number(),
        tax_amount: index.libExports.number(),
        gross_amount: index.libExports.number(),
        currency_id: index.libExports.number(),
        price: index.libExports.number(),
    }),
});
const SetArrivalTimePropsSchema = index.libExports.object({
    property_id: commonSchemas.PropertyIdSchema,
    room_identifier: index.libExports.string(),
    code: index.libExports.string(),
});

const CurrencySchema = index.libExports.object({
    code: index.libExports.string(),
    id: index.libExports.number(),
    symbol: index.libExports.string(),
});
const StatusSchema = index.libExports.object({
    code: index.libExports.string(),
    description: index.libExports.any(),
});
const ItemSchema = index.libExports.object({
    amount: index.libExports.number(),
    booking_nbr: index.libExports.string(),
    currency: CurrencySchema,
    description: index.libExports.any(),
    invoice_nbr: index.libExports.string(),
    is_invoiceable: index.libExports.boolean(),
    key: index.libExports.number(),
    status: StatusSchema,
    system_id: index.libExports.number(),
    type: index.libExports.string(),
});
const CreditNoteSchema = index.libExports.object({
    date: index.libExports.string(),
    nbr: index.libExports.string(),
    reason: index.libExports.string(),
    system_id: index.libExports.string().nullable(),
    user: index.libExports.string().nullable(),
});
const InvoiceSchema = index.libExports.object({
    billed_to_name: index.libExports.any(),
    billed_to_tax: index.libExports.any(),
    booking_nbr: index.libExports.string(),
    credit_note: CreditNoteSchema.nullable(),
    currency: CurrencySchema,
    date: index.libExports.string(),
    items: index.libExports.array(ItemSchema),
    nbr: index.libExports.string(),
    pdf_url: index.libExports.any(),
    remark: index.libExports.string(),
    status: StatusSchema,
    system_id: index.libExports.number(),
    target: index.libExports.any(),
    user: index.libExports.string().nullable(),
    total_amount: index.libExports.any(),
});
const InvoiceableItemReasonSchema = index.libExports.object({
    code: index.libExports.enum(['001', '002', '003']),
    description: index.libExports.string().nullable(),
});
const InvoiceableItemSchema = index.libExports.object({
    amount: index.libExports.number(),
    booking_nbr: index.libExports.string(),
    currency: CurrencySchema,
    invoice_nbr: index.libExports.string().nullable(),
    is_invoiceable: index.libExports.boolean(),
    key: index.libExports.number(),
    status: index.libExports.any(),
    system_id: index.libExports.any(),
    reason: InvoiceableItemReasonSchema.nullable(),
    type: index.libExports.enum(['BSA', 'BSP', 'BSE', 'PAYMENT']),
});
const BookingInvoiceInfoSchema = index.libExports.object({
    invoiceable_items: index.libExports.array(InvoiceableItemSchema),
    invoices: index.libExports.array(InvoiceSchema).nullable(),
});
