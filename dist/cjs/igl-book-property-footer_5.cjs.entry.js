...
const IglBookPropertyHeader = class {
    ...
    getSourceNode() {
        ...
        return (index.h("wa-select", { size: "s", placeholder: locales_store.locales.entries.Lcz_Source, value: booking_store.booking_store.bookingDraft.source?.id?.toString(), defaultValue: booking_store.booking_store.bookingDraft.source?.id, id: "xSmallSelect", "onwa-hide": e => {
    ...
    getAdultChildConstraints() {
        ...
        return (index.h(index.Fragment, null, index.h("ir-validator", { value: adults, schema: index$1.libExports.z.number().min(1), autovalidate: this.autoValidate }, index.h("wa-select", { class: "fd-book-property__adults-select", "onwa-hide": e => {
            ...
            }, value: adults?.toString(), defaultValue: adults?.toString(), placeholder: locales_store.locales.entries.Lcz_AdultsCaption, size: "s" }, Array.from(Array(this.adultChildConstraints.adult_max_nbr), (_, i) => i + 1).map(option => (index.h("wa-option", { value: option?.toString() }, option))))), this.adultChildConstraints.child_max_nbr > 0 && (index.h("wa-select", { class: "fd-book-property__children-select", "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c576e29d995471fb00f7935b36dd582767000b23' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), index.h("div", { key: 'a77b9aa8b4d6cc05f6d4bf9fddc3746bdbda2d70', class: `fd-book-property__header-container` }, showSourceNode && this.getSourceNode(), index.h("ir-date-range", { key: '0f80bd3a2213cc76a8b298f8cdfeeca0acb551f9', "data-testid": "date_picker", variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange }), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints(), index.h("ir-custom-button", { key: '20b4c19cee25049d3112ee7fef0a054ab4184af9', loading: irInterceptor_store.isRequestPending('/Check_Availability'), variant: "brand", onClickHandler: () => this.handleButtonClicked() }, locales_store.locales.entries.Lcz_Check)), index.h("p", { key: 'a6f93a8db8cdd120ab1e5244ac194d2f0f318d83', class: "text-right message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("form", { key: '944cdbaf4b73ea52fa92873999d900984c19e150', class: "d-flex flex-column h-100", id: "new_booking_form", autoComplete: "off", onSubmit: e => {
                e.preventDefault();
            } }, index.h("div", { key: 'dddf48a8fb89fb6818c000b2c8c655ad653fb74f', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: 'a7b6239aa56f8fa49f557221c6473da755891af4', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: 'd08b7f4bd6ffb7552192b361edfb2b97312f992c', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '3cd8c15c247e5a5d3a03e30038e1170cd05499e3', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5aec1dbf9cc9816a1d8ab790bd4ca094d6a394cd' }, index.h("div", { key: 'b2344827f8e41190135a85c15f7521309767fb2e', class: "text-left mt-3" }, index.h("div", { key: '581ff88815e881d2a8718b8c22135d8873deaf05', class: "d-flex", style: { alignItems: 'flex-end', gap: '0.5rem' } }, index.h("ir-picker", { key: '8671ecbf42dc6225bc2254ffd7ac8fe914885dd5', class: "bookedByEmailContainer m-0 p-0", label: locales_store.locales.entries.Lcz_BookedBy, value: this.bookedByData.email, ref: el => (this.pickerRef = el), "aria-invalid": String(Boolean(this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email))), withClear: true, "onText-change": event => this.fetchGuests(event.detail), debounce: 300, "onInput-picker-blurred": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
        ...
        })), index.h("div", { key: '70ce51bdcc66289b95606db3f9b50082559c26d9', style: { paddingBottom: '0.5rem' } }, index.h("wa-tooltip", { key: 'f6b81e4da3a4cec4de95a356885e3b61501e7343', for: `main_guest-search-tooltip` }, "Leave empty if email is unavailable"), index.h("wa-icon", { key: 'a582b8890bd984d6f7ae577d97cd313c012ef49d', name: "circle-info", id: `main_guest-search-tooltip` })))), index.h("div", { key: '7d427fd5b56fed58a65ca364e193fbfac3241b71', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: 'f937d0e7c2cd22f6053b7dc394fd303d975717a5', class: "d-flex flex-column flex-md-row  justify-content-md-between ", style: { gap: '1rem' } }, index.h("div", { key: 'b341fa6f8f745d82f95b0a56d1c76f708b84f84b', class: "fd-property-booked-by__guest-form " }, index.h("ir-validator", { key: 'd964188f735f786334bba3b51a4f1a344c6aed26', value: this.bookedByData.firstName, schema: types.BookingGuestSchema.shape.first_name }, index.h("ir-input", { key: 'd36ce4072bd9f03fa66bb38ca59874c2e961094f', "onText-change": event => {
                this.updateGuest({ first_name: event.detail });
                this.handleDataChange('firstName', { target: { value: event.detail.trim() } });
            }, defaultValue: this.bookedByData.firstName, value: this.bookedByData.firstName, label: locales_store.locales.entries.Lcz_FirstName, placeholder: locales_store.locales.entries.Lcz_FirstName, required: true, name: "last_name_custom", autocomplete: "family-name" })), index.h("ir-validator", { key: '9859af9d563cc50561136f22edbb5f01edcab32a', value: this.bookedByData.lastName, schema: types.BookingGuestSchema.shape.last_name }, index.h("ir-input", { key: '2a4ca70f18785084f9f8d989473933e2c1d158b8', "onText-change": event => {
                this.updateGuest({ last_name: event.detail });
                this.handleDataChange('lastName', { target: { value: event.detail.trim() } });
            }, name: "first_name_custom", autocomplete: "given-name", defaultValue: this.bookedByData.lastName, value: this.bookedByData.lastName, label: locales_store.locales.entries.Lcz_LastName, placeholder: locales_store.locales.entries.Lcz_LastName, required: true })), index.h("ir-country-picker", { key: '00d6c67068739e64803c3ffd6b8b304b807731f0', label: locales_store.locales.entries.Lcz_Country, variant: "modern", testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) }), index.h("ir-mobile-input", { key: '636337b3c96c55677253d67028fe4a5880971df2', size: "s", "onMobile-input-change": e => {
            ...
            // required
            countryCode: this.countries.find(c => c.phone_prefix === this.bookedByData.isdCode)?.code, countries: this.countries }), index.h("wa-select", { key: 'cc423da8f8b44ad7c2c062e0060361879e938a6c', size: "s", label: locales_store.locales.entries.Lcz_YourArrivalTime, "data-testid": "arrival_time", "aria-disabled": String(Boolean(this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '')), id: v4.v4(), defaultValue: this.arrivalTimeList[0].CODE_NAME, value: this.bookedByData.selectedArrivalTime.code, onchange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("wa-option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))), index.h("div", { key: 'fb0336d38370f085f1836803ad8a0153bd51deda', class: "p-0 flex-fill  ml-md-3 d-flex flex-column", style: { gap: '0.5rem' } }, index.h("wa-textarea", { key: '15dbd3c60693da447a41f814e9e65fe167ed459a', onchange: event => this.handleDataChange('message', event), size: "s", value: this.bookedByData.message, defaultValue: this.bookedByData.message, label: locales_store.locales.entries.Lcz_AnyMessageForUs, rows: 4 }), this.paymentMethods.length > 1 && (index.h("wa-select", { key: '9d3747e7d240516d59b4d0a45eee0abd8850f6cd', label: 'Payment Method', size: "s", value: booking_store.booking_store?.selectedPaymentMethod?.code, onchange: e => booking_store.modifyBookingStore('selectedPaymentMethod', {
                code: e.target.value,
            }) }, this.paymentMethods.map(p => (index.h("wa-option", { value: p.code }, p.description))))), booking_store.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: 'c5229f3a06d72855e9a58331feae89b54ca675a3' }, index.h("ir-input", { key: '6ed6001e5ded1848d26f9df614a03806b9838d82', value: this.bookedByData.cardNumber, defaultValue: this.bookedByData.cardNumber, "onText-change": e => this.handleCreditCardDataChange('cardNumber', e.detail.trim()), label: locales_store.locales.entries.Lcz_CardNumber }), index.h("ir-input", { key: 'c8cc57de88c4c804f47dbcd33a3e3cdae0b3723c', value: this.bookedByData.cardHolderName, defaultValue: this.bookedByData.cardHolderName, "onText-change": e => this.handleCreditCardDataChange('cardHolderName', e.detail.trim()), label: locales_store.locales.entries.Lcz_CardHolderName }), index.h("ir-input", { key: '84f0363c41a014aecdccfc63cd2d1ed4652ea01e', "onText-change": e => {
            ...
            }, label: locales_store.locales.entries.Lcz_ExpiryDate }))), booking_store.booking_store.selectedPaymentMethod?.code === '005' && (index.h("div", { key: 'b8bd729897e74579443e7625e79d8a838652fbda', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '2d5b1c6a2fdfb43e0c593b0ad4a6e3ae8afbb2a8', class: "p-0 m-0 margin3" }), index.h("div", { key: '35d38f6663db5d3bae4a3d90e3e3083762e85489', class: "p-0 m-0  controlContainer flex-fill" }, index.h("div", { key: '9ff728fc2a13bd45b58f4f63782091d52027acb6', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), index.h("wa-checkbox", { key: '9bec877878180607f92c3412daa3b52050354bc1', checked: this.bookedByData.emailGuest, onchange: event => this.handleDataChange('emailGuest', event) }, locales_store.locales.entries.Lcz_EmailTheGuest))))));
    }
};
