...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("form", { key: '28786bdd20a7ae2d47cfac994fd4dd16d0f7af7e', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-title", { key: '55450af3acc62163d60d486979388853e365a3bc', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("div", { key: '930a6da6f130775d71fb73edecf1bf5a69202252', class: "sheet-body px-1" }, index.h("ir-textarea", { key: '09bf7bdf6e120a451f9c5c5a631fcd5839bab2c7', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), index.h("div", { key: '7b1e9bc3b6e74c01f2e6ad54bc175eec0d2e76e9', class: 'sheet-footer' }, index.h("ir-button", { key: '8cdbdc859453e64779103c6946c0b3cdaf07e9f1', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'aa4ec8df85bc7fdc0661966ccf1164ae17aaaad6', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '28fc8b63fe4dcbc951444ae78d44fda6e842674a', class: "fluid-container px-1" }, index.h("div", { key: '1f65c6d16610dbdf411574fb1125b1f8822efeb2', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '424552c79a4cca7bb60d1fd59b633a9c4959c972', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: '1068d176c7913bfe96d1777aaaaa92af484b2bf2', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '5fb408c5c8a9aa50773209db85323805885560f7', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '4c44c15e972d5139a0cf6df95c2008a5e956f1e6', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'd6b726f1ddfed144803e0b7c88c92c0e19f18da4', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: 'b73747de4661e033f25fa42542ad31cf980f2233', class: "d-flex flex-column align-items-center" }, index.h("span", { key: '3abf8c4d3a02f203d1e2ed6f9548bbfa9b200a75', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (index.h("ir-popover", { key: '2b8d1cde11b537052998a2efb38bc2b6c1b07705', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'ab44511c6c056fbfb002564986918b05e2c58784', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '8d1ce352361aed729f87d973026e62bfb664bcff' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'bb6d24fa2371ff1fb236373e2f421233b9355507', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: 'b2fe223aa9ea1b6cb0507eba7f234afd8aeeab4e', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: 'cb7e9e20e38078557d9bce2bda132cbb7e34d3b7', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '4d4cb737f48f5d297d387a16c44e4cbda1bc220e', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '56cc04f00baea6429c86dbb9bd0b5215fa015103', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '3d269a1a10087c327a7a777a5bdb1f4ebf24b28d', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: 'cd7c3f13507efd0a25458156c4b172b352be61bd', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '411706941e13993f20d232be263954b723dc7475', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '54701dae4c2870854f6b5321c7150c98d88786ad', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: 'bcb8d8219cb5ff08d2404674c35fb2d5f0e5feb0', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '6db53ad60e9575874a886779691340012c6f4fea', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '7432d3b944ad09394462a5a647706f4aa5bdf947', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-modal", { key: 'e1a6a1f9de9681eef76ffa83765e2bf68e960068', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales_store.locales.entries.Lcz_OTA_Modification_Alter, isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '92abfcb47a02f3fddccbce413e7d986b1c3c4dfe' }, index.h("div", { key: 'dde75443ae36ac14a7fcc89e105f33e992aa2ccf', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '28d3c4dd41503e1966a31a68f17db29ce35b6a1d', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '7a01d9dfb938624d6f5095e8742946e32325f60b', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'f244502bffdbbe221ef10261889b831cd5bb7eb6', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'e684a2400d29da5d4972026de5ad908d72e95a15', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '5215c280c6dc38b95c9630e06dc7b8c743acf0dd', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '7acb7086466956a0c834937fc3ba26c97962ff91', name: "modal-title" })), index.h("div", { key: 'f0efb449ab60f33e299aaa18d01d0cb2208ebe28', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '79f17cc2d52e28b02e78a4e62dac0909afee9316', name: "modal-body" })), index.h("div", { key: 'f3afe43db2dd090d68593c0d6833b6e5f4edd782', class: "modal-footer" }, index.h("slot", { key: 'ee6a951a46560c48a43061f0c9117dabf8c78171', name: "modal-footer" }))))));
    }
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '714a0cc0afe387d76ff4c82633713b7d9f46dcf8' }, index.h("div", { key: '9d1ff5ea265985b5141b5ffb8a384eec536a1ebc', class: "p-1" }, index.h("div", { key: '6feddeb626b8d7628e5d241192df0c772c947dc5', class: 'extra-service-container' }, index.h("p", { key: '7fdac86f34173acf15420ee3aa548f9639d858aa', class: "extra-service-description" }, this.service.description), index.h("div", { key: 'e7f76c53af5482d321b2ca43500c372c6e3400c1', class: "extra-service-actions" }, this.service.price && index.h("p", { key: '9fa900ebdfb2d0564b0eea718c8ec7f49f1e0937', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price)), index.h("ir-button", { key: '392f5caca4235a7aa2b0645ea012337bc3f326a2', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: 'ad95eee1a312d09152f53b71de20ff168ab6544f', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: icons.colorVariants.danger }))), index.h("div", { key: '1889861fc2b59bd7b7e647a03272970c0dce901c', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: '30011da982b7a02ded718e95ce1ad53547371ace', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'b014036b832ecfb83174916e46a1d9acb61f7e85', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '78364265724824c1c1a268365f315396f38964d2', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '05f286d34329a2f777366173d373b09c2107b681', class: 'px-1 sheet-body' }, index.h("fieldset", { key: 'a8b14fe66d2ae165b7705e26ca55d0165274978e', class: "input-group mb-1 service-description" }, index.h("div", { key: 'd886af77cc296a2b0cafcedbaf5dc3b606049d00', class: "input-group-prepend" }, index.h("span", { key: 'f6f6d8f91718463b43b609d89ae7a1caf9507dfc', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '8763e29aa282ccfde08608a6b544b161edb510ff', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: 'b60a23ada8dac693256388f56369efd902491501', class: 'row-group mb-1' }, index.h("div", { key: '06c54264babbcb29a61bd43e7b64715c252348c3', class: "input-group" }, index.h("div", { key: '68146c6c25618d7ad23f76e6a099cd59dad3bc9b', class: "input-group-prepend" }, index.h("span", { key: 'fddbb5b9dc4a4271577671f26d5d295912442b2e', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '74c6485313cc3cdc8c720502c869cb16a486b23a',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: 'be315d5ea79d6e0a5afa62d87577fe137fbfbae3', class: "service-date-container" }, index.h("ir-date-picker", { key: 'dde528d5b513885e876fd2c6859bf36767f2fe4c',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: 'f08d8d9763dde6699eb7cec27164c47a474a34e1',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: 'a3446e8a652acb2bf0a8779121ec23241392c16e', class: "btn-container" }, index.h("ir-button", { key: '80348700579fa1a25a6ae7b13dc595ecbf2f7d5f', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: 'e63809211b78c745b5369ccad35e696c2b859e5a', class: "input-group" }, index.h("div", { key: '8947a95ec00a1418adbfd2f24f37606fccd77ec2', class: "input-group-prepend " }, index.h("span", { key: '8e710516b1022cef5ce71c9f62ef2bb348cff909', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: '016e3889c108fd0516447a9517f2bace41799271',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '37b29a90c76c901b4b3440690841ee3ef59269a9', class: "service-date-container" }, index.h("ir-date-picker", { key: '47c2ecb123be72cd770d9dd634f3fdfaae92145b',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: '4e2172bcac0722310dc873c68b5c0269cd7f020f',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '17c64071f775294aa955e37f977ae12d5cc361d5', class: "btn-container" }, index.h("ir-button", { key: '85fda2b69f9ad774b5927b558ec74a3ed3ce93f8', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '94173c836686564048488c93b0327b05df04057c', class: 'row-group' }, index.h("ir-price-input", { key: 'f9d9f395c97716a51cb2172ac50c94eec55b3789', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '20b5b0b970ecb36c2cfdedf6b139db98e9b4fd35', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: 'f5fba63e99e092bd0ad93fd4d5db48dbbf339bea', class: 'sheet-footer' }, index.h("ir-button", { key: '0d90d4525974193f7c2636c33ad5b42b5e11a9a1', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: 'b3369d90e90afc5b0a94f1da0839b7081b1d9f34', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '438d1af1500b8296006751071bb2d17a922fe5f9', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '9b917a5bbb598f68e8ff15bd339af330a2dfdbaa', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '92b4e60a26eb685f0e156c7b9936a28b7af4faa5', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '4b63ecc682865e7c207b6deb6508fc2a1c35aa79', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '1cbe42b66625f29a3a4c8dfe90667248d60b10a5', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '4da5917e5651fecd011acfde2906e89020580d75', class: 'd-flex' }, index.h("div", { key: 'e513dec82d925e86e1ab369e8e4c76c036a3bb45', class: "form-group  mr-1" }, index.h("div", { key: 'eca20a2339caec55517306f3312faaa1d39d99da', class: "input-group row m-0" }, index.h("div", { key: 'd78556ad86ba2415da7df847aea4d4a43fb72ac0', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '340d21755cb968769606ce1aef9bc95d4daf5290', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '5d633f192c70a0916591e5732afb48ebb8ab0ff6', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '903b0504d1feda42552040175f8eeae924178448', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: 'aa9bfb2a4b15e4931e7e218c00a003b311d6b833', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '473103254cead8f402113243d3ee6acdb4e579da', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '7b017de52fe16a93a04cb68f2a288e31cb71aef9', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: 'ee23371cf66ab4b8195450591d3766dbb93d03ec', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '6237c0984bc20034a910ba8df3b7270b36d1baea', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '532c4221ef58ed25299c956da7605498556707a5', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '2f9e45c542552e091f1e5f9ac812a73f352955bf', class: "price-input-container" }, index.h("ir-price-input", { key: '82f0187caf47467b8ce6a054a35581b4ccaf4081', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '01adad06d9c24a9a0d62ddef4774fa4208e80bcb', class: 'sheet-footer' }, index.h("ir-button", { key: '9ec791dfb3ea0844b777605a41db6e12b339a2d2', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '3324863195a3f8bcc7f285a1fecb75934ccb9ec8', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '51006ca10c9e32d3e9edc154940b0592aa412943', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f558fc6f8359a828a27e7de05d1fed5a4208e1e6', class: "card" }, index.h("div", { key: '0448d9c4fe0f5d00600dee6d17b458e002adb06e', class: "p-1" }, index.h("p", { key: '21624c07bb13f20bf3e3c9e74cbd3310fad97bdc' }, this.booking.property.name || ''), index.h("ir-label", { key: '86417a9b18b4cb66d10737477ce8fd8ab79ff049', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '43ed449ce4f0c611e0325db1a9cfc1475df78721', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '15255a39f5f6b38c34adce03e113395e3edc6a91', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '3c7f636a04f374116b34bb59892f778c7ce218f6', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '4add9fd95c753dbcadc50236213568fea539a645', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '5431376d1b70900d3c84d0ebbe3cf3996c9ee47e', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '7092de0bbc87bb228aaa38802ea28d3aad0988d1', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '8ebce2af7ae3fc5e8f7038982aec97286b488349', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: 'eac502ce5f392cab2dbf2dcdf4087f324fb5138f', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '664f56545a0a6621d38364dd693fca8ecf8fe08b', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '5e3af5e6f83fdcdfb6bd92c98dbfd966a0b5127b', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'bedd1825936064d447809b620ec9face4ba1445d', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: 'e68a9264d45e948b9fe8858a36299ca98a28c538', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '9e878820dfa1cb1b1d69e131b205406fbce95cb6', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'b996154cbcd14e970f7165d720d1f26170138637', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '6702e1c3de5789fff756522fe5229fe126b984b5', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: 'ed5cbdef350050fdf1562cba6e1630b9dba9d277', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '33aa8b300c3aadfef84c0ae0217d6ff79d833ad3', class: "d-flex align-items-center" }, index.h("svg", { key: '68249a946f71be4e8c16e608000af26a611e41a5', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'f7532e48aed742ee4fd12d20d41dfad68abc5dfd', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '5b2e582f221a58254908c99a55ec88b12fed0757', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '95635fd438b32c5b342caee2f3b400906751239d', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: 'a8b273addfb59fc3b82e0aa501a99abb719a5d8d', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '0c96a407175bc4f4ee1c9a49658206c33d57fa8b', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '83df43bbbdcd67357f4bea4abd57f7bf1d4934d5', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'a5a7d0d4976136c33225eab2bb523e9aa88653d3', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'eeb51321de3555729ee6501a9374a8983c998a51', class: "flex-fill m-0 " }, index.h("div", { key: '61824f905b1c06a61cfe9bd50dc4b2752ea78d4d', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '55c948ed359a8ca3ac485fc78969833e2dbbf612', class: "m-0 p-0" }, index.h("span", { key: 'b96c2a887d513140443b5d07217f15178e493112', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'dc960f18eb399406a6fb54ee6961928b469dc0fe', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'c988da20e29bf05047cb758d98001b51269cb462', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '5cc7ea487cc0770363918edeb9cd5ab1825e6792', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'cf48f10d9db17c5a7aec82852020eddab611b0f4', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'ae14ee9f61279d845bc72417c82f8e34c5291b17', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: 'de0bd4d624d707da524cc223ba42321244ff1fbc', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '7c88dc11be8836de6ffb15f588489e317564a367', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '8ddf0a0ca651316cef726759e7d7b5b5e2180d58', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '815b71381ba74d497af51f158132c2f452015bc9', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '5198346d6d38040a7d10ca9d337ce90ebd1c37bb', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '80e2e3ea127430b6583ebdfcb1db501ec0d40931', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '4fa003447c482bd8547db41cc730a49c8cd1eaff', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'dc2b5102467fd8a8ea77c0b3fea5d80dc2f3c5c3', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '39bfb417bf2aafb801fa47d0eddf050b97c9d00a', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '840b46ebd4081fb0bf56fff57e3b1bf61bf11433', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: '85e71aeeb0573b6d1407a61ef793112b990c3286', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: 'adaf60b3dbef2cacdf5e7a7b62627ad672488d2a', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: '87a78b84e4dc024139a3d37a056718846464a54c', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: 'c0edb8101ee241392a58fe85bb020631e4d2a471', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'c4cfa83820d40253f90b5d45bdbb445ea18c2540', class: " sm-padding-top" }, index.h("p", { key: '4aff85f38b820b1137d941676426fa7c0b61371a', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'f8dc1f33ea539d879882f590566c2283f1f5f52b', class: 'flex-fill' }, index.h("table", { key: '2bd03a2a1dc91e9429adfe68e31823b5baefea3b' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '4c3ba7faca4ab213c15c267506f14a61a3cbcc2c', class: '' }, index.h("th", { key: '3a7434ed50452883fb541b2324d5cd3f762363ff', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'fc1bac5fcc387407506dc08bae653deb726f2f4f', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'ca8db4d2de861dd0388e550f0eeb32323217e9c8', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '5d6ef64fe98162d6e0be70020b1de16393242532', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'fa2fba88ba5251e6984c0fb472d7b6cbecd99ca8' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '93463a2dc202ce2560025f5203abda7a307daf75', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '17e43fa29d84dce0ae8f7442c7211efeb0ed4924', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '66d15ea6515021527d422c58a7ed4a95b153a089' }, index.h("ir-label", { key: 'edc91ef753198bc9f9250cdc42105b9a31ee901d', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: 'fb388cecfc98d4bfc58a1125ed06d7b93f023637', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '90eab94312eb41bcf1e4e7a879fca81228073bcd', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
