...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b04c4de24f51e490b4f0de4e101a9b3568fa2fe1' }, index.h("div", { key: '16cab5db5eaefebb8a21a247838792d345dfc4fb', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'c075c598862d47ff4acde7ab5ce9c25b93374a96', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'a7f11e3838aabc916c9aa997627326bb7c7faf85', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'a398936fd721e1975fbbb0bfaf8bc4aaf885b926', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '6605226a190244e070e7a49be9af6088ade2eed8', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '52730bb318685218ed9e34009ec8e98640bbc96f', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '8616c7d617b2fb82dec8f090d28e40badade76ea', name: "modal-title" })), index.h("div", { key: '3f0ebf1ba140b2394ed3aed0aceed8877836694b', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'b02f6f2339c9a0accc1384addc4b77a6a7bdaaf8', name: "modal-body" })), index.h("div", { key: '38a0b44fb7c4af62809e11e6a4a52c565a69cf18', class: "modal-footer" }, index.h("slot", { key: 'c218293f2f000cc59d35a6709409ef0c17c327ff', name: "modal-footer" }))))));
    }
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e73639b110c51c46dca9f9563c5e71f5dcfc61c8', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
