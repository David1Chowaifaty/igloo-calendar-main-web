...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3c3d87bac36d514f1a646bcc531f8181a2959ad3', class: "fluid-container px-1" }, index.h("div", { key: 'f9ec8af22a17c54bcabbeb0c898aea9be3e669a3', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '66cac96d4a3a93c2390af9b7fa36a57843bff369', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'd3dd41876966054096719dc0957c0b994d8666f6', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '61fc7183441149ffd3a8143f50dd3b84a6301f80', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '3154b2ca8eb27fa458ce80adce9dc62de5d1f3d1', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '40c8b010ef7d505a685736579bf869cd3ccf6601', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '2a00e6e71ed34246a133ea16b8f3bf80ee2bcc5c', class: "d-flex flex-column align-items-center" }, index.h("span", { key: 'e805a54a664f03cd25064bb15bdae9c6b3578e56', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (index.h("ir-popover", { key: '890284168c55e8ea40b309bcc40938438ee26de3', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: '4e971132922d93124b9d92c43ac58f77b598bee4', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: 'b57a3fda9a32191895b0fe7a9170b7060c1c2b10' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '74c3c0ca1f68362339139a605869950ede97ba24', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: '9cd8231974d9ee6529e83ddc3d8f53633939c3b5', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '994867e657738df7a2a7a7272470697fb040133b', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: 'aef75d498e9a4008c71fc001ccbb3f2744160d6c', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: 'b49e678efdd72bc5dd598aa45c6aa9f57f81c6cd', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '7c9620adf9076314d67eb8e7eab08e422125f948', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '7c5dc56951c0442c5fa87cae27338e9dba9ef5f9', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '4f695ad231b81123b24c9f64c1bc30894ccb2100', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '652ab04e4c2f0433bd058d581793f9c3ec1aab1e', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '35bacee2053efa67ea8b8236b3af745c6fc9c440', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '3420792e92c346602b5f6544ff4683c76689a981', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '8bbd4e709d09a2d2988696666823c0b618185f16', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-modal", { key: 'c235f43ef868f60246f2ceea6194155b82413809', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales_store.locales.entries.Lcz_OTA_Modification_Alter, isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7367c6e74712a161ae4afe30fd60b485c2456448' }, index.h("div", { key: 'bf8e8028537f5dfc8d8bb723650cd44cd940e2e9', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '7412cce9ba0e25cff3c605a8deb5fecc41f2854d', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '84267bb03675fb4d6dd9f8863a5dab0330cf4adc', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'd62a5a482bc171eaa10be9b61d4cdc347c91568c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '64ad55d0e14f2320b159aa10251281b951e71318', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '3b51140ecff9dc255dba9ec1300303aca8108731', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '07487607f7987aa8c2c69227cc7ca69601898d76', name: "modal-title" })), index.h("div", { key: '2108a8575332d39761abbb37c4c4bce1429a787c', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '9ac00dff185281003167f24b1bf35e59d4f3669a', name: "modal-body" })), index.h("div", { key: '58fe71b34715d1e5dcab57a472fd6eededcfdf16', class: "modal-footer" }, index.h("slot", { key: '2faccca96c46884ad9b9226948abecfcc5e48d5d', name: "modal-footer" }))))));
    }
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: '04e69af6bca32153913fac83a93702f7187a6edd' }, index.h("div", { key: 'f77202a5aaded11932f46a71f4728c6784139de8', class: "p-1" }, index.h("div", { key: 'da6753626ada4e7720d750075e1bbc1a9a18d001', class: 'extra-service-container' }, index.h("p", { key: '819096419f7ec816b5edb5d3d1cce26ddd6ad28d', class: "extra-service-description" }, this.service.description), index.h("div", { key: '4e607bd8e84dd2e28f2c1c4b44bbdba9e83de3f8', class: "extra-service-actions" }, this.service.price && index.h("p", { key: '82890e887b15d8441df8852943906b70364f124e', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price)), index.h("ir-button", { key: 'f5dab9393ec9afb6c04487b823c5a18202e195e9', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: '6f29fb06d57018fe946bda96e0a6b854c9877a48', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: icons.colorVariants.danger }))), index.h("div", { key: 'bd667984daee5e8a67d3803364cbb55775f93c66', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: 'a1ec7807e43deef94ac70a2ca27c7ad5a8bd200b', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '57d9215be41ffb2fb8d764784ee6b7fd7f22c7ed', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '571b30f45fa675f841e42d5bc1d8160d063cb54a', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '145b811eabd2ecf53049dd70d30acdcb3b44fce4', class: 'px-1 sheet-body' }, index.h("fieldset", { key: 'd44131037350b527155a42ae8bfec9b455df3a0d', class: "input-group mb-1 service-description" }, index.h("div", { key: '0a64e41a3460e0fa528085c2f18c48444d86dd43', class: "input-group-prepend" }, index.h("span", { key: '8856246858f5107f1e51a8ad08dfabff05e6f4c0', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '957d896f25f6256464d078a2c3b93d149120ac7f', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '198272d3eeff9c1477ae1168e88d6118bf075bdb', class: 'row-group mb-1' }, index.h("div", { key: '02fae4566061820a02e9f4681fd90ce6dba504da', class: "input-group" }, index.h("div", { key: 'd22bc965e36592b9e3fd4f948d8a0817084a59f2', class: "input-group-prepend" }, index.h("span", { key: 'd931063b0ac4abe200ef0a12a1b24d95be508cf4', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '7e321d7651a1489a8abdf538b7c943d11bda4f61',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '346b5cb1c5257c8e7d34c0ea10cf07f3b868e7e3', class: "service-date-container" }, index.h("ir-date-picker", { key: '766fc408dd83b69803b3ea0174467e9b0f75b5a4',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: '34c075077bef12cc4470541c492866fc197d22ba',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: 'd0c34ab597ac2e5310869c47aa409af95b8041d0', class: "btn-container" }, index.h("ir-button", { key: '5ed55d77febf76d8e97cad822a3db1057f30db3f', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: '85b63ffad74b59f42d7a7f26fb940783b92c08a7', class: "input-group" }, index.h("div", { key: 'a4e69557e2afbae3352a76974b0a7cea8770b396', class: "input-group-prepend " }, index.h("span", { key: 'f2d7e014121ceb05299258862144b07120840864', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'ce91756ea06f9da4f517eaf7efa33a2fc477cea6',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '3ad115b96603148f52fda264952d99007fa417a4', class: "service-date-container" }, index.h("ir-date-picker", { key: 'd09116a0b4876fbc213d0176834a3e8efc726bda',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: 'a3b1bc681e8315402d8923923e9bbc7ec2079861',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: '92285b01b75f8794b72825c4288510503c22b8e2', class: "btn-container" }, index.h("ir-button", { key: 'abadec48507e6ef392b8fe03d8ce8a666aff15a5', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '744c4671bbb10a8fafc44176752c3dc44555cf43', class: 'row-group' }, index.h("ir-price-input", { key: 'b6779de0e9e5295e8a86ec0fdfbfd940fa632a28', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '4e1450bd70cdefed3486cc4f801ff2fc50d35d04', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: 'da9c5df4dec2a91e60db52c759d4302dd1492dd1', class: 'sheet-footer' }, index.h("ir-button", { key: '79dc61a841ca8566be9ae0001695a254b525175b', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '4933fe9223ffb0e390a3d5e472119c683cdaeff1', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '95ab56ac5ea7bf34ecf098a6b5236379852339d1', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: 'de75c789733b0311fa2d8af0d58c1fc9a7a85ef8', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '2b083c43018117fa4adfbfed50bc1222c35f8895', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '2c55c0f9c741301c2c4bdc691c48b4a3a0a65a74', class: 'px-1 sheet-body' }, index.h("ir-select", { key: 'beba143d9a288846df99c0945924f335e61304f6', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '92716aa2f70236804c1042c0ae63bc8ee77c08a4', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '161fc3d2a2047d8df492a388a42c18a8a0099890', class: 'd-flex' }, index.h("div", { key: '4a3475769d2c6ddcd4e5e67049d4d9cb4e3ef110', class: "form-group  mr-1" }, index.h("div", { key: '2dc4e7728f9a8c22022989e3334ab32780ce2e93', class: "input-group row m-0" }, index.h("div", { key: 'c9c0e92f16b7411d1169458092afeef6cba377f7', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'bf20663a262086c210df6df4de765dae9793ca2c', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'c089a0fd0d54f6a4a1bc972f01f91c9766b1ea59', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '07102f76e29a001c4206e44aada1655c77858223', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '5ee82825f0637d363f0dacf189ed311a086317c5', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '6e49ac8bb440a093b1939e1ac46b9eabefc0b2be', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '92fdd8d27e96b9eb526a5e64ca7b1619db5e6f93', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '418cb4d0ac6e023af6a148c289c9b018a86185a7', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'c9227001eeea30e273b1078870d30e067390e6b9', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '24fb31404ed8de34ad178ee410df555141c0a593', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: 'e606953cd4d8579e76b8a0f579d7ea3064bae9a3', class: "price-input-container" }, index.h("ir-price-input", { key: 'fd18042f5ba0cf68949663ce0b7898c03b686ee6', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '8412f6ef8910494c7ef48e320e329227c1ba5c94', class: 'sheet-footer' }, index.h("ir-button", { key: 'a302b0760631ce40715757bcbb6342b91a086551', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '0ad51fb0706d64194d5116828123660e52736ba8', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '064f7e9d42863b6989154054178b32bfe649e270', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e15d17cd1ec922b781470a03915961aed7acfacc', class: "card" }, index.h("div", { key: 'bf08209974a4ceec689ea00507c8906bdfee5208', class: "p-1" }, index.h("p", { key: 'b716f0effad645b1585a71ae3de7b45c20d26eab' }, this.booking.property.name || ''), index.h("ir-label", { key: '272dad2262a0e1e576971d3f6507f433b8672575', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '4e72251d0d806f32695fdd6954ffc264e7fcbb0d', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '03765d916cb31a0fc123e23958800a8e8f2ec14b', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '18f451e84e00398cba27df2e373b99de7b6ff4f2', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '9228efc8fe844d184d70ac273942fec66ad5d236', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'df0a66c89bf1f86e2bcba0dfedddaa8eee7101a8', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: 'd474fb8e75c4b69bd9f329a99740f05ba42d3399', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: 'f3dfae4d2073911868d3a5e004fefd4be44eb190', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '28fe49ab27b8f5cfa21fec23e4297bbffce7213d', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '28a2bc6e4e12e113216f8757c3e60edfdb7bf8aa', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'a8a271bade196c51f7017fb7bdf841fe2dfeae1e', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '4313376f758cf733309d43e8c151d8838fb8c4a7', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: 'ab13ddd72cdbde91ed741d438d75d762780d3dba', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'f240c9560ee93545bd4e44a09a99e73387d2caf5', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: '40737039628585fb5f61755a02e141bd89e09bee', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '9e156e6332be385e20bc498a28519b28947b3cce', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '18ceefbd60d0c9776d7b65bc1be5b16e67b8c7de', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '96834b2ac03f4ea33c3eff1be0a55424d8d0feb6', class: "d-flex align-items-center" }, index.h("svg", { key: '9dcd9dfe92ebbdf1e7a24428133c9f11f3167aca', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '38ffdec63bf93fb885d11abd0ae8a7c2b4dac174', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '300c011c5d0c6aabebb17c1f329b8bb9ef783d42', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'be4bcc8dd3122486d1b9ebe57bda41e02ae529b3', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '37dbe5a1273b2421a7f4443e4fd64fe588d55b03', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '7bdea5528a367baaf8b955448ec336b0e2fb36fd', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6c9694c877b47f5e63ef8a500c78990c7f20ee2d', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '8cfd851a779da4cbafbb444ff3be647e4b68ca3f', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'c182ae14d896826e3a4df205825de81722c3748b', class: "flex-fill m-0 " }, index.h("div", { key: 'e34d8a3af41cb003c02f548b453b934f94580fb1', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '927bae0af761838f025072c6952afada2ad69207', class: "m-0 p-0" }, index.h("span", { key: '2da0ac3b49bb4ba4454e7d7a8f67fd2af2ebd64f', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'a39e69722c7eb857734244dc34261c9e8c90eaeb', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '272f65390bd8608a275d3627e43c3948ce439ea5', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '6a14dc3a66c8bdd345c223f14309f2a4884c2a6d', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'e208b973a9cc832e32f1aed308e44bd3e24d5b60', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '935b6bb350d392a4e0677d469ad34a7dd432a743', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: 'fb025b08c4064c2608b356a31389c9519f4472fb', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '7cd2cecfcd3e4c710f2bc9823859090fda0fab8e', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: 'a616bfdc02fee02f9f433dedf82b43eaccaada0b', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '67aea0c1cd430b14e8625a6a0b82009648293adb', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: 'f952ed8438a4f96d0cbebbd5a16f516c07faa077', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: 'ebfb167547257948c7eff9bf8a11adf955623634', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '286844ecdff20f46372cd4acc92c368652517ce9', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '176a4feb98ff14f0179a12100bff60889ede41d7', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '7e63d54bbdcfc129b7e1afe964f190d30563a9ce', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '9cca8ed1694417353e6afa282291557fb0bb0126', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: 'fff7dc4b2d19e041571a847f8e61b1c02eb7b03d', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: 'd9e01b68d30d8502271d83f1227e13e5dcf517ff', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: '8f42acc91b9992921c7570a74e730f5263e6bf34', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: 'fa5565fe0fe6d39c008a13bdf285e4b13f84c5c5', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '45f02757240cdec31df9ec5ece14096c56a458e4', class: " sm-padding-top" }, index.h("p", { key: '651959ba296b077cd79d2184813410f34fd3872e', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '1b0e50b2bb749ffce71d23c08dd5746bcab2baf4', class: 'flex-fill' }, index.h("table", { key: '63e436bf57293756925d6f9dafb3e2028943704e' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '81f4458f313b4217c969d6a0db71a3c869ba80fa', class: '' }, index.h("th", { key: 'd0b53960e96bef6616ced039b8f228a59710dbf7', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'a49c5fc60f4c66861376a03a686bfd25a4dd251d', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: '01b0db32e4da89f5533e85496231819bc3e09041', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '971376af571045b7f449b1e69325a6c57c5ba701', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '1072af549f31c9fce4127e2e784ba7bf0661c96a' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '81d20ea57241f83b5c7062433e2e18ea468e10f9', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'da4816698f0df751654371e3eef6b3cc7df3bc3b', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '8c045f7e40365ee3aea8f821a2d9ef24be3b3cec' }, index.h("ir-label", { key: 'cece74e670e4a79bc0188e19e0ed9b74ec3942f0', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '580198f1380b0023adbd35724aceb078dbbaaded', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: 'f1efe122e1d74c47fbf0e649dda71e824768feda', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
