...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: '3190328c2638fb7119081614d2a79f6edf915af0', class: "d-flex flex-column h-100" }, index.h("div", { key: 'e2d0e208954b0465f205238bfb6e03657381ff84', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: '40239b7700bfe2e03a466609b1996f0a45bad6b0', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: 'e3840c69deb186376d4e45079e28cf847179e28d', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '5edd663ca6455f0e939c479795f1de6ade494cc4', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '8fed07252ed9dda5be797a1270c357ac6e130659', class: "fluid-container px-1" }, index.h("div", { key: '43fa7780621e23de99d13245bb4469cd9bf5bdd6', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '4578cca3e1c0917c3995b9b07ccf1ebcf0d118c8', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'f8fe9e8cb4eaa951bf6fad756fbc95564838957d', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '445d8d5ee05bb34955eb178a24fd9e896a4c8c14', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '35c4ecdced074fb82c47a6b0a50e699f9ecc11cb', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'd6e1bced1a093958dbd89b9fba25469946212eb0', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '1e65e5a187395197b88223f94735d5f7f6bafe76', class: "d-flex flex-column align-items-center" }, index.h("span", { key: 'aa26de7c01571f1ec8a063cf7941026a791d7b55', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (index.h("ir-popover", { key: 'e0feb77d5d7b6d4ee87d01089f3c10dff661c144', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'd870c8a5bcc0f56c9130c0ec9f0f452ac9d6776a', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '32f284c535d4ad3d1588c0f438d66637fac2f5b7' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'ac73df135c2e448c3ed6bad687da15139b345172', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: '494656b9f1c5b3c7362e7690cd8ae2611385f682', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '33aa803f6bfc21fc6cde51a8c77a3fcb9c266c48', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: 'cf1a250f778c2d9ad7e0b7e5c242cd2af9759e1a', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: 'cb2465a8c4232a6d7dd288dadd39d97f27214ed0', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '619dfff64f6343467ae05d73600a4f5fbda7037e', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '31be4063491a8a69b5c6aa0c6fc70015bb068a2a', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '2f8b2517637208a758654c2bb080623ce38428aa', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '7f82bb6c7dbf2e103a34cf311f560482d6416c10', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '0f03a7432b159a43661ad92163c1a1bfe3f87d01', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '39f4af54200501fcbb561a604d9cffd62c1dc5dc', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '41d2a27a6515a9aed076ed6d7219723bf453f28a', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-modal", { key: '268281e1d5b60d07431e39078d552c66f1702726', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales_store.locales.entries.Lcz_OTA_Modification_Alter, isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd82ebcf692b29f598f722c7e24080a94b615b17a' }, index.h("div", { key: '0a5e846da01e13031d3be555e4eb9e7b9701136f', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '5bda720f4ba0c226cd083d8b7e67fa0b4a342848', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'cb703ad9614f918043841e9db95e6f05b40d9e18', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '3ce1a1ea17e83ddafb3bf1bce3b4d094d7a0945d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'd5fcb8c60405631b56e5128b1fc132388b9c3f34', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'aa334f0421bac11b8ebe93e722c6676f7dd425aa', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '3847d2535339c8ad077a971191b434b98c0430c9', name: "modal-title" })), index.h("div", { key: 'db6984ad8dd265bec2d7865feef680b940528fed', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'a2a7243b489e48daa7ae7ebaa026a25aafb9baa8', name: "modal-body" })), index.h("div", { key: '5722616b4c042d594372a963bc7ee653d6ac2a28', class: "modal-footer" }, index.h("slot", { key: 'a6cb7acfb00358561417328c84cdab4ab56a8e61', name: "modal-footer" }))))));
    }
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '69d4577745a931007be6a699557264ec567b7634', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '477e30743a3046db6716ae0e127f502530c34dd5', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '58c0a5dc7254a61a41915581f1f45057dc99dbb1', class: 'px-1 sheet-body' }, index.h("fieldset", { key: '03380fb3f216f00ac422402c6c4ef0d92c5f4f59', class: "input-group mb-1 service-description" }, index.h("div", { key: '55a00fd6692704cf4478af9bf1f79a876fa98204', class: "input-group-prepend" }, index.h("span", { key: 'ff4329950dc528735d6288c73b93d5bbe8024a4d', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '1e8990f9c27e3fbeca60b9e861d700b79d95bce5', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '7477354033b38ee366cce8ff4d807d2a7d4680b8', class: 'row-group mb-1' }, index.h("div", { key: '95699fd7957a3210d42874417e68daa9eb45535d', class: "input-group" }, index.h("div", { key: '570ddca62764abc802360280a2d4df4a27ad8e75', class: "input-group-prepend" }, index.h("span", { key: 'bdc5305c8227df0ac8126fcb392c537252f3c35c', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: '83bcdbd037bf4a232dd5daebc846ca7f448a2ea0',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: 'ed190d608dce9a5eaa937c5e9c177623af580957', class: "service-date-container" }, index.h("ir-date-picker", { key: 'd869c71396feeeda312c2c17fca2246f72c46206',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: '899188a91baf6a2af24e8d01234149b1fa7cdf89',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: '3f9c4f547a93396df74f91807b5f538783d39ad5', class: "btn-container" }, index.h("ir-button", { key: '8bdae4d6541322deb5309b7359766a769402b1d2', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: 'ac5e2c75f40b196990577811c49d1813ae150821', class: "input-group" }, index.h("div", { key: 'ca406c442aa6c06a7d7e8f3b75056606154ca013', class: "input-group-prepend " }, index.h("span", { key: 'dc865cadebc735ac82c5d5e92eaaf0fe22d8f1fc', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: 'be4ae323adcfc1fcd2441e9a01a1c6178aa8f6c7',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '258c10ae5ffadff5a0142ccd7aaff149d8ae043d', class: "service-date-container" }, index.h("ir-date-picker", { key: 'fc661d4c0632c9c1a286d82342d467f2e2ee65ec',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: 'c3a42722a6b1b02d34611798c314268e14c732a2',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: 'ed59dcf8c40e851e7368bb75777a810f50f44cf8', class: "btn-container" }, index.h("ir-button", { key: '8c7039dc178ee9b5ed9fe1ac58f84f9497229ba0', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '1430e4f9715b523ba8f520a90de779f472a032e9', class: 'row-group' }, index.h("ir-price-input", { key: 'd03910dc64a8c7a5ef12630a4549a9ac451ac000', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '0a13a840a0f0fb8a31c47f00b1246d2585bc4737', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: '91e4581824df58d510595566c8cd914b0223b5ec', class: 'sheet-footer' }, index.h("ir-button", { key: '886db8fd7787e84bc1ba6932ac19934dd96277e4', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '438845c9d9c0065dd0ff651c18eb779baa9f4aa3', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '8d0b745f9f91db2969ae08667251da80ccb07b16', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '15d250f98f56c4bcf9bdf4d882eb6c8acf202189', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '571de9b9458414e25e39c26f54a04fc451ba6d45', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '2b62bae5562b79197ef3bdb2a3e1aaaff456cb3e', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '72991028b678d23d454090a276b67e74488f54cc', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '92412f491e25cd480d1bd8b2c0c2784061296303', class: 'd-flex' }, index.h("div", { key: '4464075adc62d430578a24be58761bc319aed381', class: "form-group  mr-1" }, index.h("div", { key: 'bd0eb0f14817b580b0af5b4fb123c27b3a4b9113', class: "input-group row m-0" }, index.h("div", { key: '68eb48a616d459e1b4bcd210a894e9dea383a97a', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '7f3ad3e11b31c4680615345b74cf0a2284b3d62c', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '1f41f3fe5ed0f0adb588754a7b7de040d433ceb0', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: 'e9b4d5375bbcdab6f7214750bfd5ca6115334918', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '7ae081196b8c4d41df81a9f026d755b976e1467f', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: 'f56fe9ce3eb846baac3efc04cbae5e3c76d40529', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '175f762d644efb33df235bd19b2a7ae11c8db578', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '1fa10eb09af167bb8a8e3b0009916e8135e13e38', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'bbc2f4d354a8e868f13a875cf4ed5f1082f43840', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'f8f7e8cfda47a73b4a562a81d0ef698c9fd57df4', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '65863c02e82a355875570f387b3934a9be7fb294', class: "price-input-container" }, index.h("ir-price-input", { key: 'fb0cc75957dc020756c532f8f8a653a1389d178e', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '6755e3c4fd325cf04e3b35902c054a38a85bea21', class: 'sheet-footer' }, index.h("ir-button", { key: '78c0b89f22318e0b7c34fb06599095532ac54606', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: 'f594f6ac1effedbf1db660d09cc0ee3d164cbef0', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1be3bc389befb761c462691d40b00238061b3664', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'e4c3b37f24cdb0c70f07a28b88902959be464823', class: "card" }, index.h("div", { key: 'd17547a6f18ca39858891338af23643c1657d076', class: "p-1" }, index.h("p", { key: '3a261a12fa09a70d4bc5a00fe094c2657f67e272' }, this.booking.property.name || ''), index.h("ir-label", { key: '0bb5ed08f030eaa8b4ff54c5a3044105958dbe50', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '6aea668efa829291bd5e06da312fdf801d272a0c', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: 'ff1650efba27fc047fbcb650d240971ae5467040', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: 'ff93cf29ecb709cdceab8fae720d9abe84b4cb75', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '000e0b2308eff81abe8d5f2989ab9a07a6d6b3fe', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: 'cf5a7076aa514efb35f24449e3315a00be5e663a', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '8218aaa06e23f3f2fdc2479740ed3c26add154a0', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '36efa99779baa5efc5d9a30e2a77f0882e2731cf', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: 'e133600b829b8f772ecb08032a114dbd68172d27', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '14469be30a5dcb90f712e1a6a98332a57644e0b4', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'f5e67766b59fe1b6eb8e71738c468fcaec0e8520', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: 'c68dd6b17ce261d2752930f23cc59c4de2983cdf', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '0d3faa28bdaf9bfe7ca5ed46de582f5cb2044c4c', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: 'faaa4a45e55e77cc16035b28df872268a7c0334e', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'ead6bd720bf057d0c8d39f73dc2bd08273aceb83', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: 'b658bcd138fb3180be7eb21bb7d1f18b0d3873d2', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '8d4d46c7dc3d1bb518f20266236b0d5638b86709', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '57b82b02a3e110147bb09be0211ba1d4273a32e1', class: "d-flex align-items-center" }, index.h("svg", { key: '09645dadb637651ee7ef075ca938d44efeefc37a', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '08035a4c2d6a143eb20596c37a050534a923016c', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'c9c0b1ff57badddb7880ed81690af192c40f0462', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '2df6025a14c96af842ba33bf82d41762971469b8', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '0f9abea72feb6a27b567570ac473628e7a3b48bb', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '4a5bc6f5500abf0c292d989e1fef5f800fc2f7a7', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0c017970771f9dc28a84d32594a7d43c153d319b', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'fd8582c1fc5e19a520e294a522c3e46f4ddd3ffd', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '44b10861fc9dc4ffa2b1c5596d2f1b94debc056b', class: "flex-fill m-0 " }, index.h("div", { key: '33a5392af37ac008e7853693c817a57f14a2a840', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: 'ccc5a610129d811e68133a077ec6211ca88c6cfb', class: "m-0 p-0" }, index.h("span", { key: '5718f9731deb0af6a1a767fe1324edcfe1a7f496', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '458d54262e6019d36db5f020031aa09147299e66', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '7a1c0ff8a5c96aa1a02651328c01f75a661b64c7', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'e441ff6ca5124869879290a9a9e13b0cdbd91cda', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '1e08c2c1932ce06f165ed8986653b814f4426fd9', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '8d47421e6c38de2ec065267f81d450dbb8ef6c3b', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '27114708e50e329cef9934ad2e9b43a2cca7c48e', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '46b1fda83c2c5ed5f04590013c7f5046a3bba667', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: 'bf847ae609ad589a0e34af250ef0d40ca9089609', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'f2326bdb17c7db7653761d1a746ade111b6109c9', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '8829804f1f133a87a9ce82e4c01eb16a040a751e', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '4ea56d1dd04f34a70074070befd6e10ed5b063a8', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: 'f1ed8e41b44bedde72d9d952cf5e5f4526e83422', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '4122fe508e474bc5593281378d9e60036080bd47', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '658721eda6287d64dc2a7305a0f6e4f173684118', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '574d88cbeafce6faa3308569fbf8b1549d1b0337', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: 'e1613c47c9fe7d0fb75c20808e78a5f88c095a60', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: '4c5039cccf0503b5f1b816b07bca129da77015ad', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: '196fe1da404f7587f20416a1a8f89765c3c36074', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: '1401bbb2fadd0dd13ec81a51dc46103d00bfb994', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'c5578e272d9b43cde78d039805db289bce89a18a', class: " sm-padding-top" }, index.h("p", { key: '5bcab8d1b01122cf543776a78d06b12a3c94976b', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '34e44ecf9c4593932f9e0552e98f6188b562fe62', class: 'flex-fill' }, index.h("table", { key: '63de427e6e3e38002fdca276e330117ec367b0c7' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '281757f7260460b52d9b5db4cb71b915d4f62041', class: '' }, index.h("th", { key: 'fc26aa973c27fde423b4a449028aa86e5e9663d1', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '78a2a74043527989b78f9174501023479e4cfa17', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'ae2c1e405c9aaecb2881231cf903c72dfcaa4de7', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: 'c43e794cf506cf836b3b2f0a4762b4c4a4ea222f', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '4d4200046b0cacfeec2350f7f3373c90b6b0969c' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'a78dd281e64158675c578b8e3ec243e526a050dd', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '56b3fae2c00c9022f91514d14da7cbc1a8c8566a', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '01091f7b668acab3bccfab86dc36f379c3b36c10' }, index.h("ir-label", { key: 'd33f478702b315eaad5882292e6f19e957b97f5c', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '136b0a350d0e7bf6db304185cb67e57741049215', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: 'bd91772c29faedca9001bcfa2e8b2adf08c4861a', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
