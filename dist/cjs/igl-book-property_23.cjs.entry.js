...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: 'b8b51a3909346a246bea6ddcd5072cd01eda922a', class: "d-flex flex-column h-100" }, index.h("div", { key: '26a8787bdab1f2e4528032989b16ffe853fa9f74', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: '965d5edac399183cd59056e91b5eab87373704e0', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: '0f4e646ff3481fbfd2a67ef2ca2ba8d41c06ab3b', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '1520bda2e4f6df121353d6410c559827016a4ce3', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("form", { key: 'fca9fcc06a5243737751f307e2948180a38db0fa', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-title", { key: '27fe380ca848f03e00e6632d5edb57df70fa9a0a', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("div", { key: '240e045a911825ab4a71f0850932952e2326f258', class: "sheet-body px-1" }, index.h("ir-textarea", { key: '09a1e286ed352aade7ead23d44daf698619c23fd', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), index.h("div", { key: 'f73f0d637b3ea8b7c577644136b99acaaf210fbc', class: 'sheet-footer' }, index.h("ir-button", { key: 'd7d180d61647c00eeaaf0b657d1c93ab8e02ffd2', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '5ccce5c028560df75b3e0ea79de0b5245502fa2b', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '4ec646ea6d5409c35fad0f3063bb186e9d950944', class: "fluid-container px-1" }, index.h("div", { key: '13a436f2b5bd9079122a8a47f0373066a595f8c8', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '55d1f5803a8a3e088c177e144d5ba8f3fc3ad1f8', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: '4f5582dcedd598b05a87d703c1232fa2a032b7a5', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: '8c0113a41a3df8c4f502434ab6769a2f24bc9601', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: 'f73d456517ae95213350e4c87de989e395973e34', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: 'e7f4cd0a2b044a067824e084c02c3f90ae30697b', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '8a213efd792a7e0534641cd25fc796094f52089f', class: "d-flex flex-column align-items-center" }, index.h("span", { key: '26ff9c9b301d1bb834ad71ceb910c7d87427b4b6', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (index.h("ir-popover", { key: '76bd8770012ccf818ca16ee71d2fb92edd0d2e22', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'c09e02771aebc93d9d53553b0dc981f8fdcb83c3', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '9e795ed1bcf59f48933c9ffbd0f108d6f65b916c' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'ebb7c1b28336e49842f762254e1286e787fbbaff', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: '755dbdd438966d91a6cde2b04294dfe61d94ccb1', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: 'c75f458cf8ed735d1209c559586dd23dbf897897', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '6c4caf497c181572d1e0641234fe933f4fb1485c', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: 'd361d1703967f495d79c6165cf2cc31dca0187e7', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: '1cb547b2b05b670c7ac746f3bd89429ddd470b82', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: '8d50c50b57f59f3c1de076e7f557723259a4eddd', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '79a5cb6d2fcdd36fd5a3874054bd799a3765899d', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: '4f9833e78371b789dfb28ddcf7b53dd8cfba38fa', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: '5605c92e1203f0d82fecfe748936fb32b884e944', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: '3a58694114812d84b5ba8ac4822cc071665e2cb4', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '69e0eb9ca5baa3b5292ceabe7041e1c8369c1b80', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': '400px' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-modal", { key: '1101c80cf3b88d4876a1dcc2e476cc835efae33a', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales_store.locales.entries.Lcz_OTA_Modification_Alter, isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '532a1587e57850df7494fd4bae32daa06a8ff552' }, index.h("div", { key: '8dd6f70d60da4d57afd89431d1e939e851f71c2b', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: 'd2ca87efa31830d40dc6a7e509c4494f29b7d242', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '2be81f5e4a778673ce000e3f3905c19c6fad6111', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '8c3cc5a6ac9f83fbcdafc62d4895f2b56e4f327f', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: 'e176fb9a60d8af7777c426d5fa818571d8d57760', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: '66016b6265f4ee1bc97a3e7be79398fa00fae0df', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '11d3c699a429a8ddd70b839f34c0913982f2e670', name: "modal-title" })), index.h("div", { key: '1e4b1e4a4d45d6f20baef9a099692c4661a619d8', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: 'cca9ae34d5659a0a465f8fc2843d39c244d1d8fe', name: "modal-body" })), index.h("div", { key: '3e2c9799c44b76d2e3f897ce6fc2ec8100928144', class: "modal-footer" }, index.h("slot", { key: '56d53842472a1fc56cd6a4d07e6b1bd8969b1b92', name: "modal-footer" }))))));
    }
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '647ce745cf64da938133a03b70af59a3e8c38326', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: '71b1a02813c073686d40860b3c8801ad74b1ac02', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '056bd860f8991c9dc37b0142cc3dce236652c1ef', class: 'px-1 sheet-body' }, index.h("fieldset", { key: 'eeb3cdb04b7f1e88d6d6d4d330d0f90f9601d13c', class: "input-group mb-1 service-description" }, index.h("div", { key: '10dbe5bd99e2ff6a501628050069d3abee5b4eb6', class: "input-group-prepend" }, index.h("span", { key: '5505549a2b4d5768fe9b5cd9a7214a2e8e9f6b71', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '5c33b625cdff1a7af6382268a998c8e89d88f9d6', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: 'cbdf25aa63d9672c4ae6e7a0e1bd5a796a50c20b', class: 'row-group mb-1' }, index.h("div", { key: 'a9c1838c549b0c3ea9cc145624bc38e9edb32a51', class: "input-group" }, index.h("div", { key: '7131d97c40b28814d3f7efadb207b4b8312dd7d3', class: "input-group-prepend" }, index.h("span", { key: '6a7618f8e06c7a4f9480d1f8094b28811abbe69d', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: 'c4c21c07243115c2e95a6c29f6f57454df615a76',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '6a3592ea97cd71106299ab13c147497a16a1b27b', class: "service-date-container" }, index.h("ir-date-picker", { key: '9707f64230132bfbaaeedc04504b8660686b004a',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: '4c3393621645b8c1648cc9452f16c8d1d3d089b9',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: 'bb5679e1de924502e25073c45c7eac53e96f2621', class: "btn-container" }, index.h("ir-button", { key: '8d7b85336fb9c653e0571eab4b7fde27d2e3b315', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: 'fcd5b0652fc6013e51c4c982b5c10bc70e47382b', class: "input-group" }, index.h("div", { key: '2aad6ef8687b3fc942eced80adc22b27bc098a2a', class: "input-group-prepend " }, index.h("span", { key: 'c8a7df9050735ed70a5b87360bcc0f1ffc160845', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: '2010a37426a7483e747a57941f0e2225988b1d02',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '412f39110cecd895093d13296ff89a5683b1b503', class: "service-date-container" }, index.h("ir-date-picker", { key: '909fcb9ae32533265f8e6d68eed9441a6b483fcf',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: '951484aa5bd0cd06acb24dc84c668d0b83882416',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: 'e52bb51ccaf61ead731f5379577f28483f51984e', class: "btn-container" }, index.h("ir-button", { key: '856338fbfbc8961726a7a9c5a930ac11ccf40a84', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '11668ae2ed4109488d75da1a611099ba4af53e1c', class: 'row-group' }, index.h("ir-price-input", { key: 'fe6ddcd65c4ea9c906a289f4558a269edd30f369', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: '3ba7f3b46c17fcb5034e853e40a2bb35aae45ca4', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: 'fc2e56854c5ca457cc20e48d1c3a3a10e90756e0', class: 'sheet-footer' }, index.h("ir-button", { key: 'e3ea4832a0e1fb9561ac759904a525d86f5d8a4f', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '25d90e7090c71048856fd229120575fe2074eeb7', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '663c0d44c2771340b6857134a7ef5beff2e42b1f', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: '03c67d5499dc69d55bd137758ecf4118e3caf71c', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: 'ffeae470adc28c186e4e0892463a877773a9aa40', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: 'a72ac84a8e60e62b03f47481a6d89faeebe10988', class: 'px-1 sheet-body' }, index.h("ir-select", { key: '515a49869ab06e69953777fcc76beb17be6d2812', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: '2749d0d3353650ad40cd0de435420fcfd828b184', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '28af7e02866c4f25db4d13f0a60850dde60f1a9e', class: 'd-flex' }, index.h("div", { key: 'c1b6313d047499b37b45e1c9b1d7c65630050574', class: "form-group  mr-1" }, index.h("div", { key: 'cdbb9e1c464e700042e2c55384353cc98dc11573', class: "input-group row m-0" }, index.h("div", { key: '524488c67f7b7511ea758b29cf6f58f032dd1f27', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: 'f61c1c35189418cd841d98ecb58fb69ce6eadbcd', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: 'a5c3341d1329de1e88dbe4e0313f299eff444000', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: '39d8a5a7227a256c913cbe976380d6d7d7b9e01c', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '3eee007206da6904f6e7f492fd6538833ae79056', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '7002c5145584503d88539cafdcf162171e655682', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '37fb9a894ae712ae5de5d541959ec3150f13d0b1', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '68d5bf65133307002547fc8e3bfdd76c1724b658', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: '34d4344c9c29383abd4c365667bdddb099525286', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: 'c00ce7467029f4a7534dc1e5781b5a0fbf8d6728', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: '6b39fef0521755c1b69bb1bf367896e3b858fd8a', class: "price-input-container" }, index.h("ir-price-input", { key: '9d053d1b5d8b180a386b5c50a24e75cb652c9b9b', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '2d4aa2c5408157ef17aef3debe89ed7456068a77', class: 'sheet-footer' }, index.h("ir-button", { key: '8af7e5ef5f7bca6411fb84bd7ce943d564c02ee7', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '25d668891c249f778e0f0974a221b0bfb02cba09', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a48817ec7e93d05fbd25457c0ed4a0c9aee0cd85', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'a6f7353cd9a95b8951f7b9797e59116d00b40d6f', class: "card" }, index.h("div", { key: 'e84ec7f0f3f96ab744832c62eab4a34985b2e4f7', class: "p-1" }, index.h("p", { key: 'd59630040d4a56782b72174c3a5180215de17cf8' }, this.booking.property.name || ''), index.h("ir-label", { key: '800328f2ef0642761bb3a77c6b08e03a3737b290', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'eb03bc878c8c7fa0dd78b9228b25aabea5a7c0f4', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '406068567cec18de42ba64879d6ad2b3fbf5603f', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '30bf1c0a96a2ed3dbc81d176223da157ddcd4666', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '4e6256dbf4e4b1fa139cd4574bd9ccff524e9831', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '2cf60155c4dda533668a938b7247a8338feee9e6', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: '81e6679f46d19d63916986116d769db027efc236', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '76aaac1ca65a82f89cf8826e13c9546adff8bf70', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: '3035518ea14a230038c4d6faa6a6918e336a2c6a', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: '22557c45f5a47252c71130f24e4890954fe10f5c', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'a93c37ce581d93daf9912e2bb2cc3eafd5c04d6d', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '0c0a6707b5d5c5e77b75334471d113360ab0742b', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '5ef52b6130a67168c22c0bb0d2ca2f5fba1933dc', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '940698f03d8ded8ab5b0a711c5a8acd7781e1973', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'e78744d314e5c1a5b9f1a1d6875787372915d91c', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '18fde2263a989eadd22a236e9e699b9230db5834', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '7f2e8c98a5aed01d9e4b5948f18503b0dc21a378', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '446c320caba22626a97a6ec5ae7b709f75208b7e', class: "d-flex align-items-center" }, index.h("svg", { key: '7b11f713d259e8ea1c9892069b9eaf3d429f21f9', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '21c4e28c727c857c81391e063e6bd4fffb21d724', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '09ac71e435c5cbe9e383d5433a335d3299521ec2', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: 'a0ed17d3f4682a7c7e96d676a9919747dcbc210e', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '5b9551ecc23e80746251c141573e850e52c7c613', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '77b6d834709dc0c031fa9f53026931c16ffa2702', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9108da7f69c8ee8b751933daefd77169b4ae173d', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '061d54bf730c81924bf0742f140758d7dbeaeb0a', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: 'cab22cd4b7724a41f368eeea1264b995a30dae8a', class: "flex-fill m-0 " }, index.h("div", { key: '2f7aacdd7f304b58c28ce1f7a9b36df05988525b', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '03fcd4fb923c86cb4e1149dea049d3dbbd94db28', class: "m-0 p-0" }, index.h("span", { key: 'f8264632250adf3f949014c09242fc60eec847be', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'ae4823afa7d6c1cec68c6c595fe15bdc17f043e0', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'f6d947278bea42250fe5f638a951b0fbeb9b5970', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'fc1337dbcaaf4ff7687aa376d16d2a165195271c', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'b3f8cf585eff3b29421b522b7d7542f3bef2f44a', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'a71e3b865cc04cf3aefe2a8ad27506f830284915', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '44ea08e168e84fa0691e54b955f6ca5ead0dff3e', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: 'ac72728e0603c79ccd14f8a83e0e8f9d26c3f090', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '1fa6b8266a30a0cce0f633f77b1b13959d58ffaa', message: this.room.unit.name, customSlot: true }, index.h("span", { key: 'e8323a633389681c3f7dc79279e9e371757e6610', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '1bace9891b243597596ddf5870d28d627b4fba69', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '50332d088d64743d9cf51da5715112946c157e38', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: '025b75ca4ae79374b324a0bdf2aef04567517f19', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: '24a421199b67ed2924be58ea26641be38242363a', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: '6ce45112e6b9c0d30ca98a71a4407ca1f9eaddd8', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: 'bef730b55e76b63ea8c3f7c2891f2eee85da8dce', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: 'aa302c16fda1a4a34a25177ca9ee43b761502c62', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: '43eff4840f0c2421b733d7e91cdaba82c866e430', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: '2c394cf79a1c7330a4ae6d81ce8c5dcad55cd11c', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: '1f8a501ec3338d210fc0d4982522da4be0590fc4', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'c3c61652a1f198fdbd969a2464a7053d98b57beb', class: " sm-padding-top" }, index.h("p", { key: '950f0a01e78ca5465bc7a6dbdede768de6322ff8', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '48b8508f3acbedf70a6c9c4e73bf9ffb364eb8ee', class: 'flex-fill' }, index.h("table", { key: 'ad1a770cf4a82652fa1b13d816ddab8da07a68c6' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'c8acd336b7ccb0b687abde8e19e28355bd7f3256', class: '' }, index.h("th", { key: '3c1161f2df0625ea02651ccc14bee750cf08283f', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: 'f49727159d682d7c3f0100608adb3a45dbcd3500', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: 'a6b406e51e13caaa6f34167976ace2137af74198', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: 'cd494d22c138bd389aa2dc89d00046ba8535765d', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '73d50527d6f595553258283be26649453b201753' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '56fa821b5ed39499345cadd8bb02832eba0ea7ca', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '26783b61e93ba0f78b854de16efe1a4169db184f', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '0f449ec9034778b1b3f185bc66adaac2a7eb1a2b' }, index.h("ir-label", { key: '64a3e8014a3e774ec3c0f826fe1ffe939ff9a98c', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '8c019d0e4183eb3a710fef2654406d0435fd4c7e', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '34e716687a902c1097915c410fb070a30e1b75bb', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
...
//# sourceMappingURL=igl-book-property_23.cjs.entry.js.map