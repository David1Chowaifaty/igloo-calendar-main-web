...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: '4ef15988268e754af817465bf78976ff48dbab2d', class: "d-flex flex-column h-100" }, index.h("div", { key: 'd337efafbd27d0ea6a3d8a256dd59f578edb89ea', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: 'a397c89e5d740bf333270ea39fa645cacf60c051', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: '76fd0c09e76017a6fa60e4070ab6c891d59d550d', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '2e6a9f65a1465a62fdcfc186a3f51a8aeb59cace', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("form", { key: '3c8e71ae6b33bbc14f0efc2ad09644db4d1ebb3b', class: 'sheet-container h-100', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, index.h("ir-title", { key: 'a0dddae2ffdb707aadf69dc04b98788b0174131b', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), index.h("div", { key: '0ff10d142f240199c261f97a3b81017edb0872fb', class: "sheet-body px-1" }, index.h("ir-textarea", { key: '1734d9b85f4b3d2b3870b399ca55ec408118f05f', placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) })), index.h("div", { key: '2636baa0107fd7822dc8933aa207aa88cb3f79bb', class: 'sheet-footer' }, index.h("ir-button", { key: '73598105b534afabd3182a2365c4b14b0ce3b942', onClickHandler: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '2a5463b475ca52346d8b28a59a6ae50c498c25b6', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" }))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3f522abf98d034fa8e236f327939bccc1df3dac2', class: "fluid-container px-1" }, index.h("div", { key: '5208b7aaff1f43d465f0525fde3a7ab977b29a34', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between mt-1" }, index.h("div", { key: '53f71936e7138e395c0e86fe503dfb14bf12716f', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("p", { key: 'cf7ef2be9a7c0a3efda94ff2ae004d265ba2794b', class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("p", { key: 'bf35fbe9d2ba409422a686f3663e61cf26ef6187', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '05a8ee73108aedd032fd4fe36d67b12e6ad4724a', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '20a944d26484dce405b0c462de699e692972151b', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '217861c4acc8298415b310101d24c50b8f02c3fe', class: "d-flex flex-column align-items-center" }, index.h("span", { key: 'dddf5f3cf31668e8e5f2bed2a9f6cc67d451f643', class: `confirmed btn-sm m-0  ${this.confirmationBG[this.booking.is_requested_to_cancel ? '003' : this.booking.status.code]}` }, this.booking.is_requested_to_cancel ? locales_store.locales.entries.Lcz_CancellationRequested : this.booking.status.description), lastManipulation && (index.h("ir-popover", { key: '3e71771c2b3fc275ba693f5f4863f08ebec2dbbc', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'fcc4f23eb608c31ffa6e203cfc58055d20e835a1', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '94426197cd98fa8377c56350ea28a9d63e6dac77' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: '4ea187548c88663f58d8b8b3cd9b06c2f1086b60', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } }, index.h("ir-select", { key: 'b92d1790174303754975f2f52df5074af998384d', selectContainerStyle: "h-28", selectStyles: "d-flex status-select align-items-center h-28", firstOption: locales_store.locales.entries.Lcz_Select, id: "update-status", size: "sm", "label-available": "false", data: this.booking.allowed_actions.map(b => ({ text: b.description, value: b.code })), textSize: "sm", class: "sm-padding-right m-0 ", selectedValue: this.bookingStatus }), index.h("ir-button", { key: '4cd0f0e2d0147f08b8a483c6044ca0915a8a643d', onClickHandler: () => {
                if (!this.booking.is_direct) {
                    this.modalEl.openModal();
                    return;
                }
                this.updateStatus();
            }, btn_styles: "h-28", isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), btn_disabled: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), id: "update-status-btn", size: "sm", text: "Update" }))), index.h("ir-button", { key: '5597d643f488803aa753e2ca3942d53e0c42bc0b', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_EventsLog, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            } }), calendarData.calendar_data.is_pms_enabled && (index.h("ir-button", { key: '8c50134f310b0cc5ff11e9b2d2b4d5b335e2c533', size: "sm", btn_color: "outline", text: locales_store.locales.entries.Lcz_pms, onClick: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            } })), this.hasReceipt && index.h("ir-button", { key: 'b54b254b61d35363900bb1be2a4c933030635998', variant: "icon", id: "receipt", icon_name: "reciept", class: "", style: { '--icon-size': '1.65rem' } }), this.hasPrint && index.h("ir-button", { key: 'fdc185d737732aee1859297ab26bee2b7aae53ab', variant: "icon", id: "print", icon_name: "print", class: "", style: { '--icon-size': '1.65rem' } }), this.hasEmail && index.h("ir-button", { key: '961dbb610563505c961cecd2d4e48cada7f1caf1', variant: "icon", id: "email", title: "Email this booking", icon_name: "email", class: "", style: { '--icon-size': '1.65rem' } }), this.hasDelete && index.h("ir-button", { key: 'a7ae9dd8c8b4271b4cbed74d1803d89c23373b3f', variant: "icon", id: "book-delete", icon_name: "trash", class: "", style: Object.assign(Object.assign({}, icons.colorVariants.danger), { '--icon-size': '1.65rem' }) }), this.hasMenu && index.h("ir-button", { key: 'a6fccc72b5f280ad9a2ffea5b676006122c2aff8', variant: "icon", class: "mr-1", id: "menu", icon_name: "menu_list", style: { '--icon-size': '1.65rem' } }), this.hasCloseButton && (index.h("ir-button", { key: 'c11f80faedee85047280afe55eb61de8f31b9ae0', id: "close", variant: "icon", style: { '--icon-size': '1.65rem' }, icon_name: "xmark", class: "ml-2", onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            } })))), index.h("ir-dialog", { key: '7ade80db65ebe37d1948e85010d6e0bad51e5e53', onOpenChange: e => {
                if (!e.detail) {
                    this.currentDialogStatus = null;
                }
            }, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-modal", { key: 'd68730bd25b7ae323fb558798701a318fd8ee048', ref: el => (this.modalEl = el), modalTitle: '', leftBtnText: (_a = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Cancel, rightBtnText: (_b = locales_store.locales === null || locales_store.locales === void 0 ? void 0 : locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Confirm, modalBody: locales_store.locales.entries.Lcz_OTA_Modification_Alter, isLoading: irInterceptor_store.isRequestPending('/Change_Exposed_Booking_Status'), onConfirmModal: this.updateStatus.bind(this) })));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd370b1aa0a800283335e72f2fae207402285049e' }, index.h("div", { key: 'c5c74022637cfa0f53f4815494eab77db271ea25', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '4051f68344c817fd23c97d0090e9e8c4a5463c9c', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: '4ee79c0f032334f56ec740e84d14f96d6aff22ee', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: '35254846900d50be14c2e5a838937466aa7362d9', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '126a808c4a30e5f24689d2e98945a66ac02fd6f9', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'ca57bc4d054a0b632b7e8870b26927a12fdb8e33', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: '814746b4834ff93a56c851b03aaf7c5f566d432d', name: "modal-title" })), index.h("div", { key: '33f70de6167aa76573f5f39e7850afbc987e7765', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '3bc3e05db61848d504571b5b42b0f850268e709a', name: "modal-body" })), index.h("div", { key: 'c6c4fdb3db04b624206cb6538bf9d3ea187b0f3d', class: "modal-footer" }, index.h("slot", { key: 'b46114653083c67192a1372bd951a71d41e8af48', name: "modal-footer" }))))));
    }
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b57cc415f441ae62b631462df316763b65f096ab' }, index.h("div", { key: '273354107e2f1bbb6cbdaccaf314ef1e71f409ad', class: "p-1" }, index.h("div", { key: '5a97eff04287ea4f0abfedd37d77275bba544bcc', class: 'extra-service-container' }, index.h("p", { key: '5c99355111c6607189a6c8567421a8d026098a04', class: "extra-service-description" }, this.service.description), index.h("div", { key: 'bcbea50d08c1ea1e480ce2514a0912511dfd308b', class: "extra-service-actions" }, this.service.price && index.h("p", { key: '4ac6e209cc2367a63475af42aaa56619865a97b4', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price)), index.h("ir-button", { key: '05c69573708fc975955641b5ba660d31db21313f', id: `serviceEdit-${this.service.booking_system_id}`, class: "extra-service-edit-btn m-0 p-0", variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: () => this.editExtraService.emit(this.service) }), index.h("ir-button", { key: 'e00a8aab2f4f9cce52cfdb5e2533b23f9d237c28', class: "extra-service-delete-btn m-0 p-0", variant: "icon", onClickHandler: () => this.irModalRef.openModal(), id: `roomDelete-${this.service.booking_system_id}`, icon_name: "trash", style: icons.colorVariants.danger }))), index.h("div", { key: '44f001c53fa12afafa9b57a136228239730d9f45', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-modal", { key: '8daa1bbf9e34b54d1c749414cb27afd1f63cfcd7', autoClose: false, ref: el => (this.irModalRef = el), isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), onConfirmModal: this.deleteService.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: locales_store.locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}` })));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '173821e8acd1559e2e166ad558a906e2cd546afb', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.saveAmenity();
            } }, index.h("ir-title", { key: 'cfec3d3450f21f909cca8fd32539316767e89f6b', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_ExtraServices, displayContext: "sidebar" }), index.h("section", { key: '3347af0dd58c04d4415232e52efec8821f53c028', class: 'px-1 sheet-body' }, index.h("fieldset", { key: '4f262abc66eab892e4c0188eb56223fbc8affe9b', class: "input-group mb-1 service-description" }, index.h("div", { key: 'ed7d6116cc596d624815e1ac44de133f5f901911', class: "input-group-prepend" }, index.h("span", { key: 'bf7a6df064518ab8a644413d00bb2bb56e0cf1ed', class: "input-group-text" }, locales_store.locales.entries.Lcz_Description)), index.h("textarea", { key: '6275fec8bc6432bcf3bef4c4a0edccbe7a2c13ff', value: (_a = this.s_service) === null || _a === void 0 ? void 0 : _a.description, class: `form-control service-description-input ${this.error && !((_b = this.s_service) === null || _b === void 0 ? void 0 : _b.description) ? 'is-invalid' : ''}`, style: { height: '7rem' }, maxLength: 250, onChange: e => this.updateService({ description: e.target.value }), "aria-label": "Amenity description" })), index.h("div", { key: '7e327dd59fa861cb90e8600dd942532ddfee1068', class: 'row-group mb-1' }, index.h("div", { key: '952d9b9c615bb7780c56881af316411574dda991', class: "input-group" }, index.h("div", { key: '7ed258cfe3443faf8227a8133f0d395c78d77409', class: "input-group-prepend" }, index.h("span", { key: 'ba36902df594b178bfc0ac0afb2af0e99a3bfb05', class: "input-group-text", id: "basic-addon1" }, locales_store.locales.entries.Lcz_DatesOn)), index.h("div", { key: 'a69bc52978bdaf7f8b33df25a645ff72b6e54ade',
            // ref={el => (this.d1_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center date-from" }, index.h("div", { key: '462c9b9c99c888fe5a3d7474bd5ce32497510ae3', class: "service-date-container" }, index.h("ir-date-picker", { key: '3574a0b15e6e6297ca7ffa438a2ee8518150b332',
            // onDatePickerFocus={() => {
            ...
            // }}
            // customPicker
            emitEmptyDate: true, date: (_c = this.s_service) === null || _c === void 0 ? void 0 : _c.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => { var _a; return this.updateService({ start_date: (_a = e.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD') }); } }, index.h("input", { key: 'c53123cd1ad1d3464bdac68f23e9caa95eafa2df',
            // ref={el => (this.d1 = el)}
            type: "text", slot: "trigger", value: ((_d = this.s_service) === null || _d === void 0 ? void 0 : _d.start_date) ? functions._formatDate(this.s_service.start_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%', borderRadius: '0' }, class: "text-center w-100 form-control input-sm" })), ((_e = this.s_service) === null || _e === void 0 ? void 0 : _e.start_date) && (index.h("div", { key: '381322239e0dfc3d3f41f2f803a57cea628a288a', class: "btn-container" }, index.h("ir-button", { key: '61aa45dcd38ba75768f909d9d5b70cb556310c30', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ start_date: null });
            } })))))), index.h("div", { key: 'f26f8ab25811d933e0fd11a9c90f88ff5a6d7cac', class: "input-group" }, index.h("div", { key: '86fe29eb92b4cee77e3aa0cac31846f8b543cc1e', class: "input-group-prepend " }, index.h("span", { key: 'd7c8ffa90f7c4108b75b07f1dcc5e155120b25b0', class: "input-group-text until-prepend", id: "basic-addon1" }, locales_store.locales.entries.Lcz_TillAndIncluding)), index.h("div", { key: '82b9f91eecad36d273ca3bca7d0a340fdc104c92',
            // ref={el => (this.d2_0 = el)}
            class: "form-control p-0 m-0 d-flex align-items-center justify-content-center" }, index.h("div", { key: '4ffee8b957d09078d15deb2e1278e68568262907', class: "service-date-container" }, index.h("ir-date-picker", { key: '7263f62fedcd1506d7a607f5b3da182a0954afb6',
            // onDatePickerFocus={() => {
            ...
            } }, index.h("input", { key: 'accf672dc989b021ecb3e2dced52c9ec597c59d0',
            // ref={el => (this.d2 = el)}
            slot: "trigger", value: ((_j = this.s_service) === null || _j === void 0 ? void 0 : _j.end_date) ? functions._formatDate(this.s_service.end_date) : null, style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' }, class: "text-center form-control input-sm" })), ((_k = this.s_service) === null || _k === void 0 ? void 0 : _k.end_date) && (index.h("div", { key: 'fa1b3117a51baab3c31f930c4359079e8d7087b8', class: "btn-container" }, index.h("ir-button", { key: 'ebb1a4e0ba1d63ed36e49128515a0512d3c5d365', title: "clear", id: "close", variant: "icon", style: { '--icon-size': '0.875rem' }, icon_name: "xmark-fill", class: "ml-2", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: null });
            } }))))))), index.h("div", { key: '1a23eeedebb342d5cc87567416dfcad434b51e2c', class: 'row-group' }, index.h("ir-price-input", { key: 'de49b392954e4671b4155b65fcdcdf3964ccde95', label: "Price", currency: this.booking.currency.symbol, class: "ir-br-input-none", value: (_m = (_l = this.s_service) === null || _l === void 0 ? void 0 : _l.price) === null || _m === void 0 ? void 0 : _m.toString(), zod: ExtraServiceSchema.pick({ price: true }), "aria-label": locales_store.locales.entries.Lcz_Price, wrapKey: "price", "aria-describedby": "service price", autoValidate: false, "data-state": this.error && !this.validatePrice() ? 'error' : '', onTextChange: e => this.updateService({ price: parseFloat(e.detail) }) }), index.h("ir-price-input", { key: 'e5907471b075e5dc4ca5c34537b5dcd41ee045a4', autoValidate: false, label: locales_store.locales.entries.Lcz_Cost, labelStyle: "rounded-0 border-left-0", currency: this.booking.currency.symbol,
            // class="ir-bl-lbl-none ir-bl-none"
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), index.h("div", { key: '49daeb70b3bd213b9f8213d4ec67a02b5b821179', class: 'sheet-footer' }, index.h("ir-button", { key: '8c9196e57bb0841c31aa1f6490d7f964c7bc9098', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), index.h("ir-button", { key: '5435e9806d752fd165fa0dcb8f3ca8a049ed56a4', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), text: locales_store.locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
};
...
const IrExtraServices = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '1328b221db2a1df32863339b1c9c8c9126b2aba9', class: 'card p-0 ' }, (_a = this.booking.extra_services) === null || _a === void 0 ? void 0 : _a.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("hr", { class: "mr-2 ml-2 my-0 p-0" }))))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h("form", { key: 'b88aa8e2c02426d094c5bec2017d6f943a736375', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-title", { key: '0bda01026a2c2b61a998eff0b00c559433e6369e', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales_store.locales.entries.Lcz_Pickup, displayContext: "sidebar" }), index.h("section", { key: '835f52d870ae6b0a53d2683ce8cb0fc9aff7c2b7', class: 'px-1 sheet-body' }, index.h("ir-select", { key: 'c3bef3b4ee5163b6dd5cefb10d3dd200770d7f96', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h("div", { key: 'b1a0ca4b12979f1fef8a1ea27a839ffdc76a8c8d', class: "m-0 p-0", "data-testid": "pickup_body" }, index.h("div", { key: '97329f4b6a8f5071e403a0de303a60fbdc9bf15c', class: 'd-flex' }, index.h("div", { key: '7b18564642175a3a96864bad4d8ab250a54c95c6', class: "form-group  mr-1" }, index.h("div", { key: '49f162915f9051fc87d9ec549fd15b9b3bb28dbd', class: "input-group row m-0" }, index.h("div", { key: '9f97d3f634b906af46d8bafd9d894b4df396a8ac', class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { key: '5cd79297bc5d06434dac7d676eb60e796d28e227', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { key: '0a10bffa57840e1f559ea016b388483d57d583bc', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, index.h("ir-date-picker", { key: 'a0929f16ec8e25a4fb1ada7b72010b050b260c31', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, index.h("input", { key: '4eb6fb0fbbcd0ad9062b2afeba3ee7b5ba2517fa', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? moment.hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), index.h("ir-input-text", { key: '700d302e44bf4f2943b4a1ee2ff267e0235f0c9a', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales_store.locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), index.h("ir-input-text", { key: '5debaa600137370ab057df7f52cc679be07ebbd1', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), index.h("ir-select", { key: '36e8b3416d0ccf6c83ee6edf3bd2ad19c0b2b74a', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), index.h("div", { key: 'db76d151babef6a0d7c688c1930f43e00bcbb298', class: 'd-flex flex-column flex-md-row' }, index.h("ir-select", { key: '781d37505bec3d2768c64a9d3e15143771817be2', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales_store.locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), index.h("div", { key: 'f8a75d715fa1e41d3832bc7b715cc6b334473f74', class: "price-input-container" }, index.h("ir-price-input", { key: '24f39e815df52a14347c8496280522ba98881cb0', readOnly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), index.h("div", { key: '153ad385d13ac0d0a9f08cbb2fbfe19cbfbcf222', class: 'sheet-footer' }, index.h("ir-button", { key: '85de67826dbbb435f54dcc37f1fc0e665e2db23e', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (index.h("ir-button", { key: '65a6a494a4d257093c757cabfe67dc7fe3852fcd', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return index.getElement(this); }
};
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2ba3a6f480327c72121cd2a37457270ffdf58c38', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '98a095224c18f31865e18131fd4183b17421cdf1', class: "card" }, index.h("div", { key: '3984af9766a9cbc412c89639a339ddbc5a3a78a8', class: "p-1" }, index.h("p", { key: 'da3d5aa0282b416f0526a3e5957b9d6d28599d76' }, this.booking.property.name || ''), index.h("ir-label", { key: 'ab92cb57757528b5d6c2f618b4bf117f537cd408', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: '67dcec39e40625189c500fde97275a0d19bfb583', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("ir-label", { key: '70e96b9737da1e2744044abc206844cf7b27fa6d', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, ((_a = this.booking.guest) === null || _a === void 0 ? void 0 : _a.nbr_confirmed_bookings) > 1 && !this.booking.agent && (index.h("div", { key: '15e5d2fd76a3371c54126d49f97e16f17a1c389c', class: 'm-0 p-0', slot: "prefix" }, index.h("ir-tooltip", { key: '3b797555ffdd8b348cd6c3b935efa5a38408b67c', message: `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString()), customSlot: true }, index.h("div", { key: '548807df94e9c8e4a5991639304ab2877dc99c19', class: "d-flex align-items-center m-0 p-0", slot: "tooltip-trigger", style: { gap: '0.25rem' } }, index.h("p", { key: 'e292bc6fdc32f44ee422e03abe97025e46acb434', class: 'p-0 m-0', style: { color: '#FB0AAD' } }, this.booking.guest.nbr_confirmed_bookings), index.h("ir-icons", { key: '159d646ce2f0089357b38c0c902f3f53d1506890', style: { '--icon-size': '1rem' }, color: "#FB0AAD", name: "heart-fill" }))))), index.h("ir-button", { key: 'f4cea11b2ab464682977ccd16e0d5e0fd4804b9a', slot: "suffix", variant: "icon", icon_name: 'edit', style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.1rem' }), onClickHandler: e => this.handleEditClick(e, 'guest') })), this.booking.guest.mobile && index.h("ir-label", { key: 'ff83458f4dd55b7b4eaee70b531c4d0351216e9d', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: 'e75ba3a5fd9045adcc787bc290fde358b1d615f5', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '7d2c6bed1f51b1df79e6a05d02354fb5ae126f09', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), ((_c = (_b = this.booking) === null || _b === void 0 ? void 0 : _b.guest) === null || _c === void 0 ? void 0 : _c.address) && index.h("ir-label", { key: '503a948b3f2d49a348255d77b04b208ec80fb028', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '2d98f34eef39a424059f28e16d2763db7f120217', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), ((_d = this.booking.guest) === null || _d === void 0 ? void 0 : _d.notes) && index.h("ir-label", { key: 'a8866135bb1053732ef42602b46fe6d331b10d8b', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: (_e = this.booking.guest) === null || _e === void 0 ? void 0 : _e.notes }), this.booking.is_direct && index.h("ir-label", { key: '5bcbf396b6014d240f41d8b83683772b9a5ff867', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '9235ebda2cbb91730b490a881b763ba206805dc5', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: '3d3e427c8f8bf1060e9d5685f7f04cc129186902', class: "d-flex align-items-center" }, index.h("svg", { key: '9065432ace9160620776b2550ee1deea8d1da9e2', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'ac14c88f793bf8297c28fab1fb8a5660b2469063', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: 'b795d755a9e53f2cb59af8e77494134f98c19aeb', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: (_f = this.booking.ota_notes) === null || _f === void 0 ? void 0 : _f.length })), index.h("div", { key: '9eb1e113087f317087f56449a59dd8a7a0e2e5cd', class: "d-flex align-items-center justify-content-between" }, index.h("ir-label", { key: '15da2dd776f9ee269ab9be9a378f25c155dfb0c8', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("ir-button", { key: '1523a539849d0d6c225734f88a57f47accb8444c', variant: "icon", icon_name: "edit", style: icons.colorVariants.secondary, onClickHandler: e => this.handleEditClick(e, 'extra_note') })))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a04d60cbcd20ff4b7d810d8ea27a16c36ac5646c', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '3ff6913188fac274b50157a06ceecab2b95373f6', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '0acf157bdee7b6ba4da4dd61c5c7a5a63c997e3a', class: "flex-fill m-0 " }, index.h("div", { key: 'c65836d484e3664743651ce8cb464fbe03e0aebd', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: 'f7a7724b67f3549b639040c1587fbbd73bfa8fca', class: "m-0 p-0" }, index.h("span", { key: '9b7a22ac56329ab0329dce9692ceb9823b782de6', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '44a5f6818d27a5eda3da0bdba246fde4df573327', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'd2d4b07ae0e70a05b6e78aeaaed1414c070e4ae8', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '3d3b4ac1f1f90bffaf0c014af581a05378d209d0', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '21effba132efb58338d8942f57ea9b73d2485bc1', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '053b434fb2cae3726512afb70c1e5d279401fe7d', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '1bb7d8c6b8a3a9f1896f2b1545524bca0eca00b6', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (index.h("div", { key: '7646693b78b2562e673619b2bd27a91b6b4da2ea', class: 'd-flex justify-content-center align-items-center' }, index.h("ir-tooltip", { key: '6eb41a579b333e436cf96214e3a4857e4c3daf89', message: this.room.unit.name, customSlot: true }, index.h("span", { key: '4d86cc353e11459f1748355425aeacc2dd72e046', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (index.h("ir-button", { key: '92936ad329def3d109617a4d8d9acd0f5f834b0c', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckIn })), this.hasCheckOut && (index.h("ir-button", { key: '17880cca52129cbb406aa378f128a2426952771e', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales_store.locales.entries.Lcz_CheckOut }))), index.h("div", { key: 'ee30c878ce9e489ffcf09807ecb82cee40acf865', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'd82a05e57ce3d1ca2fa44c77b69ca6f3945c2c18', class: "m-0 p-0" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (index.h("ir-tooltip", { message: 'View guests', class: "m-0 p-0", customSlot: true }, index.h("ir-button", { class: "m-0 p-0", slot: "tooltip-trigger", btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btnStyle: { width: 'fit-content', margin: '0', padding: '0', fontSize: 'inherit', textAlign: 'center', lineHeight: '1.2' }, text: this.formatVariation(this.room.occupancy) }))) : (index.h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && index.h("p", { key: 'cf3480a95ed36286af67e4fbe78349ea942731ae', class: "m-0 p-0" }, "(", bed, ")")), index.h("div", { key: '5cf1ca4260ea6fc7e4e1315225243ca9f83bd634', class: "d-flex align-items-center", style: { marginTop: '0.5rem', marginBottom: '0.875rem', gap: '0.5rem' } }, index.h("p", { key: '4e591f2a78f5083fd5e9621a07e0f683ce47e4d0', class: "m-0 p-0" }, "Expected departure time:"), index.h("ir-select", { key: 'b6e2e38af6ebbf5ec77651100c6d26cd7a89d717', selectedValue: (_b = this.room.departure_time) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
            ...
            }) })), index.h("div", { key: 'f55b8592589bf50fa614aa4a502d11782c5f4db5', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, index.h("div", { key: '81d762926ae628242c9800e4c1293b092526433d', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '607e2c3c5ee6469a176fab45c374ad579623c0e2', class: " sm-padding-top" }, index.h("p", { key: '99915bab8775bbf6599097ac21154a25fc413722', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales_store.locales.entries.Lcz_Breakdown}:`)), index.h("div", { key: '06cae10cdcc178948cc5a581da7ee14f432c9278', class: 'flex-fill' }, index.h("table", { key: '28e30d203d72e80dbcca3419bc104cade6127455' }, this.room.days.length > 0 &&
            ...
            }), index.h("tr", { key: '6b69eeca3d8f50983bebd369c0424fb9cc29bb72', class: '' }, index.h("th", { key: '979a3cfc7e3954c68da7b4bb9b0c50ab1fc61144', class: "text-right pr-2 subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '4c46eb4f62eaac19a2fdba25d6bdb23760f9501e', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && index.h("th", { key: '7a29f399b17121ba7eaca4bf46ecc7e15d986767', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("ir-label", { key: '0984d00da0908dc4ad224b3ab038dd04434d72cc', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: '2491b5bc58d59e33374cbbe431da9f6eafb08c04' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: 'd2112adcf08681a220193fc070b4e1b14df05ac5', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: 'ebb1c59fb3a37d5a32372c617bfee5dbd7a51d53', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '11cf5cfa0f473e59e1864fd578d75bd1a8c63bcd' }, index.h("ir-label", { key: 'a9fdb1a7547ba1b4aa47f03a5a7c713d1655836d', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '1eecf09cceb3d41cf953f0236caef157dc52a542', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))), index.h("ir-modal", { key: '8bc4f09b5a627ac9fd1c72627b667afb0fc17bfb', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales_store.locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales_store.locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
