...
const IrPhoneInput = class {
    ...
    async componentWillLoad() {
        if (this.countries.length === 0) {
            const countries = await this.bookingService.getCountries(locale_controller.LocaleController.language);
    ...
    render() {
        ...
        if (this.mode === 'modern') {
            return (index.h(index.Host, null, index.h("div", { class: "phone-input__container" }, index.h("wa-input", { class: "phone-input__prefix", label: this.label, readonly: true }, index.h("button", { slot: "start", type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: this.currentCountry?.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, t.t('Lcz_Select', { fallback: 'Select' })), this.currentCountry && index.h("span", null, this.currentCountry.phone_prefix), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" })))), index.h("wa-input", { onchange: e => this.handleInputChange(e), max: 14, value: this.inputValue, class: "phone-input__phone", placeholder: this.placeholder })), this.isDropdownVisible && (index.h("div", null, index.h("ir-combobox", { onComboboxValueChange: e => {
                    this.setCurrentCountry(+e.detail.data);
                    this.isDropdownVisible = false;
                }, class: "bg-white", autoFocus: true, placeholder: t.t('Lcz_SearchCountry', { fallback: 'Search country' }), data: this.countries.map(c => ({
                    id: c.id.toString(),
                    name: `${c.name} (${c.phone_prefix})`,
                    image: c.flag,
                })) })))));
        }
        return (index.h(index.Host, null, index.h("div", { class: "form-group ir-me-0" }, index.h("div", { class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: this.currentCountry?.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, t.t('Lcz_Select', { fallback: 'Select' })), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { class: 'phone_prefix_label' }, this.currentCountry?.phone_prefix), useFloating && (index.h("label", { id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
