...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '67c1e5ce0d9680432570e113aa31b52928840132' }, index.h("wa-popup", { key: '138dc1e8659fdccc343312f744446f2f5d5c9674', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: 'afbe88673dabc2c959c1d19e7236e6a602631fb4', slot: "anchor", class: "search-bar", "aria-invalid": this.isValid, withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, onblur: () => this.inputPickerBlurred.emit(), autocomplete: "nope", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && index.h("wa-spinner", { key: '9a0aaa1479a1d8cf09d40b680a3467ba0f63924b', slot: "end" }), index.h("wa-icon", { key: '97ad3fe0ddaba871220f64a9eca1cbcd932fa278', slot: "start", name: "magnifying-glass", "aria-hidden": "true" }), index.h("slot", { key: 'df91c3e39234ac153995fc180c001b1e3d9deaed', name: "end", slot: "end" })), index.h("div", { key: '8e4b1f1f9208eea6629586e06fa5feeb4f1b9b02', class: "menu", role: "presentation" }, index.h("p", { key: '6cddae720faa53a3f3b02d4c7ac9a885ab1eeefe', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: 'c6e459912fb3611c183149b893e8d539805b2463', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (index.h("li", { key: '54d3462605f01511c7536d4208fca17e6b4654e3', class: "loading-state", role: "presentation" }, index.h("wa-spinner", { key: '146e49734f3bd3014e5fb0ab448c0b6ad92aa890' }), index.h("p", { key: '69db25c9af8803d0212fed3a6c8b14dfc57afc6e' }, "Loading suggestions\u2026"))), index.h("slot", { key: 'c698883192af90b984737aa842f1e46278ec1ed2', onSlotchange: this.handleSlotChange }), showEmptyState && (index.h("li", { key: 'b17d308cacee6638e6619dd68bfc3cb7109b3070', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: 'de56faaf06e4f661b6e1583f92579d7b4e0997f1', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '2d496c4ba61fa36bd09e35cb5cde2a863865dd76' }, "No results found")))))), index.h("span", { key: 'd02421f116329e406d95018e35f093a38c24406e', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'f7a4f5d29a1678c8f8209acf342412325f188282', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '193d61d447745a18d834553f1f99ceeb20c8cedf', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '41a7a34bcc3296c8de24a3c0410c244d4acd1804', class: "picker-item__check", name: "check" }), index.h("div", { key: 'bd828b332f84db3eee79f00369671513f15bbe37', class: "picker-item__content", part: "content" }, index.h("slot", { key: '89e67328c1ff6aa43906ac2382eae885ede6f024' })))));
    }
};
