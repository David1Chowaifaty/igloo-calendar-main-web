...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: 'c714ffce11d726f227385c062b8b86faaa4c3e30', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '2e7778b6f2f8e394b2d28e52ff2f1004ae09d9b1', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: '9478f94fc3a67ad5fc2f9a29a30770883362102c', class: "picker-item__check", name: "check" }), index.h("div", { key: '8483128cec407fd579393bdec4e5654e2c731ee9', class: "picker-item__content", part: "content" }, index.h("slot", { key: '50595749888bcbbd424e14d0d030d6ad8ee35fcd' })))));
    }
};
