...
const IrHkArchive = class {
    ...
    render() {
        return (index.h(index.Host, { key: '00dad796b8239707629f8bcd37500b01699ca144' }, index.h("ir-title", { key: '52eff9626342c83859118495353bd3a986bd6477', class: "px-1", label: "Cleaning Archives (90 days)", displayContext: "sidebar" }), index.h("section", { key: '668bb0ed78afed5d7193a2d15bece098d80e6e43', class: "px-1" }, index.h("div", { key: '8a1d83679a4c3bf06ea9f846c6cce2da7778a059', class: "d-flex" }, index.h("ir-select", { key: 'ec526d21c9bbd1dd58225b338a1c1a98a39f6949', class: "w-100", LabelAvailable: false, data: [], firstOption: "All units" }), index.h("ir-select", { key: 'a6f7f72d0af85c46b499bbffb04796c28741d839', class: "ml-1 w-100", LabelAvailable: false, data: housekeeping_store.housekeeping_store.hk_criteria.housekeepers.map(hk => ({ text: hk.name, value: hk.id.toString() })), firstOption: "All housekeepers" })), index.h("div", { key: '16cde526fc4ba566c481522c8f87156e37b9f742', class: "d-flex mt-1 align-items-center" }, index.h("igl-date-range", { key: '374383378d346cd0645ad5d38ec9691b8103d1cd', class: "mr-1", withDateDifference: false, minDate: utils.hooks().add(-90, 'days').format('YYYY-MM-DD'), defaultData: {
                fromDate: this.selectedDates.start,
                toDate: this.selectedDates.end,
            } }), index.h("ir-icon", { key: '039e5e8c77296c9090fcf3c72a63837651e2e17e', onIconClickHandler: this.searchArchive.bind(this), class: "mr-1" }, index.h("svg", { key: 'b4352da089da892d06c3da7f62328f0013bc91da', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { key: '6e25a290e3c1adf4caca5f3252d1755c4e9f6e18', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("ir-icon", { key: '429b5163c79fd483b6127b129268d7664459100b', onIconClickHandler: this.exportArchive.bind(this) }, index.h("svg", { key: 'f061b3dc0b5cd88202adc8a65911dfc204c0fefa', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "15", viewBox: "0 0 384 512" }, index.h("path", { key: '879e4124023f24dd7f94aef8a9f79101faab37f1', fill: "currentColor", d: "M48 448V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm90.9 233.3c-8.1-10.5-23.2-12.3-33.7-4.2s-12.3 23.2-4.2 33.7L161.6 320l-44.5 57.3c-8.1 10.5-6.3 25.5 4.2 33.7s25.5 6.3 33.7-4.2L192 359.1l37.1 47.6c8.1 10.5 23.2 12.3 33.7 4.2s12.3-23.2 4.2-33.7L222.4 320l44.5-57.3c8.1-10.5 6.3-25.5-4.2-33.7s-25.5-6.3-33.7 4.2L192 280.9l-37.1-47.6z" })))), index.h("table", { key: '61248acad126e1a30691a048d2fe626bd0a276a8', class: "mt-2" }, index.h("thead", { key: '9800d39acd118d8f64301bd7f04f39a49c1e8ef6' }, index.h("th", { key: 'dd88f00dcfb365ed588d66c8b86377c9b3c52e9d', class: "sr-only" }, "period"), index.h("th", { key: 'c0f13d6bdd374166bd5d638be8f15981c84d1654', class: "sr-only" }, "housekeeper name"), index.h("th", { key: '199df2ca361e666cf2c911f402147ea2005e85e0', class: "sr-only" }, "unit"), index.h("th", { key: 'ff9b551b10611812ae486f7adeec29756156e09b', class: "sr-only" }, "booking number")), index.h("tbody", { key: 'd928be602fe1b28a9f499203de41ea084307e357' }, this.data.map(d => {
            var _a;
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a8b506e44c56c065494c2aa13c1d8ca2908b890f' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: '4878e91c014581007cfe3a22fb0a7acddcb7d81c', class: "loadingScreenContainer" }, index.h("div", { key: 'b770a250e1dd5a0f4b3294c9924965e24a0267bc', class: "loaderContainer" }, index.h("span", { key: '33e9b6d2368f4d29387bb4657e4301af46311f8c', class: "page-loader" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '511d2d926c9c54eea452a73f93a40a76e723953f', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'b35c5ab3e7e87269857b84e27c257d7ad36a692d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '5f82875ab8ba2a51c5b54b5f1a4e3fdab873c828', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '7294f392ce9bc98e07cc3020ba516ff692793b62', class: `ir-alert-header` }, index.h("p", { key: '2579db47684473940ec329815c76c015d83222aa' }, this.modalTitle))), index.h("div", { key: 'ee42615eb26cb8b02ca83f4649e7dea2ba25a8f4', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '4b2691a63cb415d6102ef8137e189fd537f3cd85' }, this.modalBody)), index.h("div", { key: '77a491fcdba30875bfd0e2a8f0e4bdd5383ce83b', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: 'ea9ecce1dc133f3468c0f7d9e711769a9f053267', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '49af6e6d34bb00a07d472b951588cdd7e4a56313', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '4721f5dfa0b5b4170d68430c2ea713a6d25e2ffe', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'ebc73b5fa9606e3db98a8c14652d7fb86a9d04bc', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: 'dcff1cbebe7ae96fc38554c3f4d86c9e2e830ed3', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'dfeae6aea42e780dbcbbde878887f5f66d6050d5', class: "input-group row m-0" }, label, index.h("select", { key: '84f3975f6640333319c52281d7e65f3f62e76872', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '1cce1e0219ff119036f331c443d94f87b9f91426', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'c86b87f1e822178059e71c9b4a53ac932c08ad24', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '5c8c21078032cbc27391a88bbcf23048986986e1', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'ca36091e017e92d0ca7b92363efd5f072c35a09b', class: 'sidebar-title' }, index.h("p", { key: '63b981a63bac4f064b98b301e256fd41d8c1baea', class: 'p-0 m-0' }, this.label), index.h("div", { key: '0f3dd19fb8a9a66ac09b7e51d02ba5926453f53a', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '9fca4c9131bbc431ca6c10e92085f721f4b785a7', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'cd78127fa7a858b2bb5280148887d047dd942e41', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '501d5ea26b872d6e3f2acdb0131035df6f485d82', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: 'eb5d789547cfb892acaeecb99cb96da3caf44c64', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrTasksFilters = class {
    ...
    render() {
        return (index.h("div", { key: 'd08891c9e346bb8e19524aba6c2d468d4f16631b', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '3130a6c42a74ec687dea741c6ac952a9b9dad8d7', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: 'd392acea4c6aaeb0dba5547fd86821186a414e92', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '862de28cf1ed3bb2f6c42c1237760648901232e2', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '0cc58569d3e280c69f2532c7d5dfb46c1e07dd77', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '678f70d0cc576bcb14e5c8ee804cba4c094d0941', class: "m-0 p-0 flex-grow-1" }, "Filters")), index.h("ir-button", { key: '9dc155e290547005084964c14dc02260dbddf25b', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'dbb2a8294b04650b844e4e8f9b0e3671f70bf0f6', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: '1ee8d1660c4f230d38e8d3c195bdbfab0590fa50', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '53e94d427db363999288fbdbfe1565bfa1718f9c', class: "pt-1" }, index.h("p", { key: '5702cd05699e36983d5ba2c25afd403f8dcb56b1', class: "m-0 p-0" }, "Period"), index.h("ir-select", { key: 'b73e619702e9d9ecf10233e0bcdff7d92a82aba9', LabelAvailable: false, showFirstOption: false, data: [
                { code: '001', value: 'For today' },
                { code: '002', value: `Until ${utils.hooks().format('DD MMM')}` },
                { code: '002', value: `Until ${utils.hooks().add(10, 'days').format('DD MMM')}` },
            ].map(v => ({
                text: v.value,
                value: v.code,
            })) })), index.h("fieldset", { key: '0fe866abd1205c7bd66b3a7bda8e0a1c993483b1' }, index.h("p", { key: '0d7134c51751d5e56eca2738ea2da44080885866', class: "m-0 p-0" }, "Housekeepers"), index.h("ir-select", { key: 'ab56fbef167634888de688ffbed12ddc34c29ebd', LabelAvailable: false, showFirstOption: false, data: this.generateDaysFilter().map(v => ({
                text: v.value,
                value: v.code,
            })) })), index.h("fieldset", { key: '52e806e6fae249ac83ce9a727d7627c21ac757b6' }, index.h("p", { key: '46c825fb09ebd2baea471455ff141df4d3f6e433', class: "m-0 p-0" }, "Cleaning frequency"), index.h("ir-select", { key: '74b832df78030d5f6707c0940157e9d5dd9b1425', LabelAvailable: false, showFirstOption: false, data: this.generateDaysFilter().map(v => ({
                text: v.value,
                value: v.code,
            })) })), index.h("fieldset", { key: '6bd38d739ddb47cf7cfe1872e9376d0e6c9b4c87' }, index.h("p", { key: 'e814e5d1f8be03647dbac09bdd2bb4382dd8717a', class: "m-0 p-0" }, "Dusty units"), index.h("ir-select", { key: '9f24eeb9343cbf33d4e374c5e82df3fb4afba43c', showFirstOption: false, LabelAvailable: false, data: [{ text: 'test', value: 'hello' }] })), index.h("fieldset", { key: '62733e351e7fb1e2896fb9b569f75183c52f4a3f', class: "mb-1" }, index.h("p", { key: '38f21804aa213d3af8dabbe404edcb1b6a8b4de0', class: "m-0 p-0" }, "Highlight check-ins"), index.h("ir-select", { key: 'c5e4671b16b0c38e7cb6b1800cc3578b59098cf3', LabelAvailable: false, showFirstOption: false, data: this.generateCheckinsDaysFilter().map(v => ({
                text: v.value,
                value: v.code,
            })) })), index.h("div", { key: 'ef2284a4ba484e8482c8c03737ef49906c06411f', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '022fe4c53f3d0efec43314c0cb564857aaa26b2b', text: "Reset", size: "sm", btn_color: "outline" }), index.h("ir-button", { key: '29e8caa13422643de026674a469507e4792699a7', text: "Apply", size: "sm" }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: 'a64f19d3fc3d24a9ed9fd703f2a5435c6da23f19', class: "d-flex align-items-center justify-content-between" }, index.h("h4", { key: '44a7e2f1f7884a1e60b579d79c9bbdade367e3c1' }, "Housekeeping Tasks"), index.h("div", { key: 'c18021cc6e662fed759bcf6ddf248663f1e95362', class: "d-flex align-items-center", style: { gap: '1rem' } }, index.h("ir-button", { key: '84fd22cfa3d65d112359d7f315cf20e9610a0cbb', size: "sm", btn_color: "outline", text: "Export", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'export' });
            } }), index.h("ir-button", { key: '2e6f9156bc742d97b7b6b58a6db96f185d133ace', size: "sm", btn_color: "outline", text: "Archive", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: 'c9d52bb6f0ee13f771b2dcf1f239764e7618da46', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        return (index.h("div", { key: '79e046c9920ce1aeb711ce004deb60597c051dfb', class: "card h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '6d284d944fd8f5493e2da6381d87a6a7ff61ecb7', class: "table " }, index.h("thead", { key: 'b3328f2f394d6f3c076473e79802022564f0dcf5' }, index.h("tr", { key: '7847418aebd491145e66d0f935f27a22f6f3d109' }, index.h("th", { key: '44071f11d4cff84dcbc77b0d6ad08eae2250216d' }, index.h("ir-checkbox", { key: '2538974e104c7eea7b809a8f8b44410d8ae4f58f', checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: 'b0c8ed9e2fa81ba9104b8395b0baa81e9a962019' }, "Period"), index.h("th", { key: 'e73fa2dc8425334930a65674fcb696bfaab290b2' }, index.h("span", { key: '65fc5021e7d3f485d3c5eb55a25eca750fe6d393' }, "Unit")), index.h("th", { key: '7b15770b877e2a52ad54b6517fe7a6438c242233', class: 'sortable', onClick: () => this.handleSort('status') }, index.h("div", { key: 'df5609bc4a91e32c8c340dd5795e1e9f5a1dff7b', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'c1ce0abbbb8e1e26abeeefd36125314e4ae95914' }, "Status"), index.h("svg", { key: 'c0deb0794b9a785fa32328e67ceed261c3cfc3bf', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '6782bfbfc17bf73b3123009e117ae028eb7c572b', d: "m21 16-4 4-4-4" }), index.h("path", { key: '2522d7ea838d43ede7a384275c9b0834a04190c4', d: "M17 20V4" }), index.h("path", { key: 'f9e191e5c0f0feff51e6cea028934992d14e89c3', d: "m3 8 4-4 4 4" }), index.h("path", { key: '829f059eae8f2f0113160fe798519ece4e26c8e1', d: "M7 4v16" })))), index.h("th", { key: '7070a3b2d3f689ed2815ce0091d18b12d83c3ea4' }, "Hint"), index.h("th", { key: '9bb6fa3c6df0d4351b88d30117cabfcc3da425fc' }, "A"), index.h("th", { key: '381d78abaee03e9e39091cbd8a845bb7bf6ba91d' }, "C"), index.h("th", { key: '0f855dace3e3118104c9ba63490793a609ef379f' }, "I"), index.h("th", { key: '7f83ece82ea971169829d72105b6b0e91d58d52f', style: { textAlign: 'start' }, class: 'sortable', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '1ce5275be4bf759dd61ac7fb82813b17ef6f329c', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '170844e96fd29c63357d2d737795c8c21f7a7344' }, "Housekeeper"), index.h("svg", { key: '3c0eb85611fa6d74f4147d071f3395cba8f8900a', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'a0e5c5b47248047a27d0311dbb07cbb84ab9246f', d: "m21 16-4 4-4-4" }), index.h("path", { key: '02496015617825c3f845f38c9afcbf80a13f14fa', d: "M17 20V4" }), index.h("path", { key: '045590d6e67dd598aa4165fafabd3a3066c77f34', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'd35d0904094f955466e6b8600fd8608832bb914c', d: "M7 4v16" })))))), index.h("tbody", { key: '11306bafe695915398bbe9f4ce983382b7945353' }, this.tasks.map(task => {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7cc11c50ae55f04a0db257ea8752d97122a7747b' }, index.h("h4", { key: '8eed5222d7229e5c1e99c39cd29609a44bb971b9', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'a867da3f058c2589ebb8068f417283bad6a79d8b', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '51eb5fc46c5b6de790d49aae840febceebb7b1c7', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '28f96ce8392246b8dcbdfff7dce7f45f3b8784e1', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '0d63c91f2da94775e0e67036c303082449b7fd8c', class: 'title-body' }, index.h("slot", { key: '27d34e4f18fe615ebd687ee64d3b2e1778496d75', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '6ed825638ee5371c033567e950631f9ee57cac1d' });
    }
    get element() { return index.getElement(this); }
};
...
//# sourceMappingURL=igl-date-range_20.cjs.entry.js.map