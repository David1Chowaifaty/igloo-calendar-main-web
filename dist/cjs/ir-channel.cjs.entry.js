...
const IrChannel = class {
    ...
    render() {
        ...
        }))), channel_store.channels_data.connected_channels.length === 0 && index.h("p", { class: "text-center" }, (_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_NoChannelsAreConnected))), index.h("ir-sidebar", {
            // sidebarStyles={{
            //   width: '60rem',
            // }}
