...
const IrAccordion = class {
    ...
    render() {
        ...
        console.log(isOpen);
        return (index.h(index.Host, { key: 'd81d6941539848723f0d859d054f7333bc7b5141' }, index.h("div", { key: '305b7b4f723ce2354862a4bcbd35300112b97cfe', class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, index.h("button", { key: '7c25744654d687af2db7d210203f89f060edbc9a', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown,
            // ref={el => (this.triggerBtn = el as HTMLButtonElement)}
            disabled: this.isAnimating }, this.showCaret && index.h("ir-icons", { key: 'db68a8212d344da37bd19c974306bd708362ef06', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), index.h("div", { key: '5236c81205688cc57d8759db6cd2497bd0448790', class: "ir-accordion__trigger-content" }, index.h("slot", { key: '86c799d064fa9b75f62d81241676809924e67bcd', name: "trigger" }))), index.h("div", { key: '6570f8742ea5b529a67df23749be6a451bfb6631', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, index.h("div", { key: 'ef20adb812e6d549f8ef43506fd4ab6260bf0e6d', class: "ir-accordion__content-inner", ref: el => (this.contentEl = el) }, index.h("slot", { key: '255b54d5ac0b6a0648d8d5e3e9287faf039d0bc0', name: "body" }))))));
    }
...
//# sourceMappingURL=ir-accordion.cjs.entry.js.map