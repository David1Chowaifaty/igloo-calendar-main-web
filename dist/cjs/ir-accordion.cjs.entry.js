...
const IrAccordion = class {
    ...
    render() {
        ...
        console.log(isOpen);
        return (index.h(index.Host, { key: '512315a15a1a6690aadf6402bdf1eef37a8640b6' }, index.h("div", { key: 'ca5a5b9cd233dfbd7e6cd86442caa0da5c77970f', class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, index.h("button", { key: '9bcee8c400d9c082d79a3ad6029e61708b417fdb', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown,
            // ref={el => (this.triggerBtn = el as HTMLButtonElement)}
            disabled: this.isAnimating }, this.showCaret && index.h("ir-icons", { key: '8164064d5fb12f9ce1bfed89971e01efde21dfc3', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), index.h("div", { key: '41ef0077b8cc670b5af31aa5862c256ab59e9649', class: "ir-accordion__trigger-content" }, index.h("slot", { key: 'd0dd6b41b8177b0b57d0685c889776ffe4cdbb7e', name: "trigger" }))), index.h("div", { key: '2389aa0047f5b5442d30615239837b87e49bf042', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, index.h("div", { key: '564cbe3611396dcaffc4a3e63c6b9405e0910d73', class: "ir-accordion__content-inner", ref: el => (this.contentEl = el) }, index.h("slot", { key: 'fe762287c9ce74b9d7101b3ce6688dbf5b9bc4c9', name: "body" }))))));
    }
