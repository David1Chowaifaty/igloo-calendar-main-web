...
const index$2 = require('./index-3cfd4bf8.js');
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'ba4430ab173204a6b69b225e3490477b283e9700', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'cd816bbabdb1ee25ed3e7d6a5b9ee6f45be9fdb3', name: "icon" })));
    }
};
...
const IrInputText = class {
    ...
    render() {
        if (this.variant === 'icon') {
            return (index.h("fieldset", { class: "position-relative has-icon-left input-container" }, index.h("label", { htmlFor: this.id, class: "input-group-prepend bg-white m-0" }, index.h("span", { "data-disabled": this.disabled, "data-state": this.inputFocused ? 'focus' : '', class: `input-group-text icon-container bg-white ${(this.error || this.isError) && 'danger-border'}`, id: "basic-addon1" }, index.h("slot", { name: "icon" }))), index.h("input", { maxLength: this.maxLength, "data-testid": this.testId, "data-state": !!this.value ? '' : this.mask ? 'empty' : '', ref: el => (this.inputRef = el), type: this.type, onFocus: e => {
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'be7e00913480b80e2907347011a89442c10bbe48' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: '92c8ed4acd14347e55aec9adf825fdd9c247ce4c', class: "loadingScreenContainer" }, index.h("div", { key: 'af4da4c5a9abe9fbcfbd52720ff285a0087a8ef6', class: "loaderContainer" }, index.h("span", { key: 'f43cc912e75c72ea915e61a757a8277f8baad9ba', class: "page-loader" }))))));
    }
};
...
const { state: payment_option_store } = index$2.createStore(initialState);
...
const IrOptionDetails = class {
    ...
    render() {
        ...
        })))) : (index.h("div", null, (_d = payment_option_store.selectedOption.data) === null || _d === void 0 ? void 0 : _d.map((d, idx) => {
            var _a, _b;
...
const IrSelect = class {
    ...
    render() {
        let className = 'form-control';
        let label = (index.h("div", { key: 'b7add54465a738d0425dab78741352a7b96446f5', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '7389a261b13f4da569a4e5a2307e2277422bbb10', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '714ea328a8a570789e861aad9e747a498883d4f5', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '35d309c769c9b0017877bbf99633fca446dfd35e', class: "input-group row m-0" }, label, index.h("select", { key: '57cb99f100f18ee324e799af966bd1034a395242', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'a2309460c12e7e26ca9a5e2e864cad1e4ee878ca', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'c4fa917e178d63428689c4dfba876de6d1a22b55', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '5f9214114f23615612094736a3ca26ad480c6320', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '4965b0e6023447e2e817026a97d470d11055ed53', class: 'sidebar-title' }, index.h("p", { key: 'a54e41618e94ab67d1f6f4da6ecd69cf303638c2', class: 'p-0 m-0' }, this.label), index.h("div", { key: '65f516350a97dddf509a1394610de5d8c5bc069d', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '8dedc6dd73d2f015de0f04be2057d8bdd9076b9c', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'e670540f024db1e4cab99d731aa41977e027f0a7', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'ce8bc847e82d6eb58b50247e894cbfaf69701620', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '4b60e198a8b27d7bc6c50918b1ad38b12718deb0', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6019533e5e2cd96186a459d477766fb819eda944' }, index.h("button", { key: '8b1d8b8b522ecf8d04eebec7d3037a0332faf6ba', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: 'd038444c788b6d8cdafb33f08bfd0a45686b1662', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: '150eacdef8c16e9b5590f3e29b1bd1d0c817055f', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const Delta = /*@__PURE__*/_commonjsHelpers.getDefaultExportFromCjs(Delta$1.exports);
...
class Text$1 extends TextBlot$1 {}
...
class Emitter extends eventemitter3.exports.EventEmitter {
  static events = {
      ...
      if (op.insert != null) {
        ...
        if (typeof op.insert === 'string') {
          ...
          if (line instanceof Block) {
            ...
            if (leaf) {
              formats = merge$1(formats, bubbleFormats(leaf));
            }
          }
          ...
          if (isInlineEmbed) {
            ...
            if (leaf) {
              const formats = merge$1({}, bubbleFormats(leaf));
              attributes = Delta$1.exports.AttributeMap.diff(formats, attributes) || {};
            }
          }
        }
...
function expandConfig(containerOrSelector, options) {
  ...
  const modules = merge$1({}, expandModuleConfig(quillModuleDefaults), expandModuleConfig(themeModuleDefaults), userModuleOptions);
  const config = {
    ...quillDefaults,
  ...
  return {
    ...
    modules: Object.entries(modules).reduce((modulesWithDefaults, _ref2) => {
      ...
      return {
        ...modulesWithDefaults,
        // @ts-expect-error
        [name]: merge$1({}, moduleClass.DEFAULTS || {}, value)
      };
    }, {}),
    ...
    if (context.offset === 0) {
      ...
      if (prev) {
        ...
        if (!isPrevLineEmpty) {
          ...
          formats = Delta$1.exports.AttributeMap.diff(curFormats, prevFormats) || {};
          if (Object.keys(formats).length > 0) {
  ...
  handleDelete(range, context) {
    ...
    if (context.offset >= line.length() - 1) {
      ...
      if (next) {
        ...
        formats = Delta$1.exports.AttributeMap.diff(curFormats, nextFormats) || {};
        if (Object.keys(formats).length > 0) {
...
function deleteRange(_ref2) {
  ...
  if (lines.length > 1) {
    ...
    formats = Delta$1.exports.AttributeMap.diff(lastFormats, firstFormats) || {};
  }
...
const IrTextEditorStyle1 = quillSnowCss;
...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: '31e1e65c3ad2653854595df1faddef9cf35f6bb4', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: '6899c7bd5c3c3cbd2bc0a190389992e09a090b45', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "value": ["handleValueChange"],
        "readOnly": ["onReadOnlyChange"],
        "userCanEdit": ["onUserCanEditChange"]
    }; }
};
IrTextEditor.style = IrTextEditorStyle0 + IrTextEditorStyle1;
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '341151c4db19b53c6bcce95642752772b46000e0' });
    }
