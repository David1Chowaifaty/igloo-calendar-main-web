...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '83a588679bb01dced8db9a4de7039dbd12bf54b4', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'b10e3c567efbe188f8c84aeee4530fd88ac4db54', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c51e5f163a0384f8d4570e6ab50bd5edf6f82770' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: '7dffacc501b9c65d8e70fb440fbf1efcc6a6ec6e', class: "loadingScreenContainer" }, index.h("div", { key: 'be77c9220275ba78a81192f9de8538815798cd4d', class: "loaderContainer" }, index.h("span", { key: 'aa32665d929c82d2eafb9b780ad67eb8a758d0f2', class: "page-loader" }))))));
    }
};
...
const IrSelect = class {
    ...
    render() {
        let className = 'form-control';
        let label = (index.h("div", { key: '9657e1cd146a86a882cf38865ccd2755f3db5662', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '08e91922255586af475dde88232e39756cd6a0cc', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '94341362ecae5438bd193de782c820527d9bf70e', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'bfd9d81b8f659f7949f44f89da18864bfb6408a5', class: "input-group row m-0" }, label, index.h("select", { key: '9eb97c86ea71fabd899bb0dd785c323eedf358fa', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '8acf48ff16ec122efb80ba3dc4c8d13770ef71ec', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '6f0031a03d52401ce0858d17456298d54eb62d47', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '685a933ec889c0d1a4e8b283137f3d6b5c3131df', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'c5d73617d38ad05559685f5dd550087de1ab1d22', class: 'sidebar-title' }, index.h("p", { key: '3f280523445ac3249518a19b5fab25b512655b30', class: 'p-0 m-0' }, this.label), index.h("div", { key: '7497b140368e6206e98762c0be7f528747c64ae5', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'd8bb40594a7118d654c83e96e2509dcb54b774ac', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'c1a6392fb5e2e8ec8bab7895115ccf0bf990472b', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'b88effb5797c2a9a07bd30cc3e7be6af990eb339', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '03560c110d8479ffac51d891b47593236f8bbb2f', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a9b335ccf73428ba66995aed7dfac2c455affc1a' }, index.h("button", { key: '421775f21fd8c3c92aeb3ad46594d5dec96a81d9', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: 'd19781d80de6f4f4ab1922431a194e57582fec6a', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: '846d10087ba9df869aaab691f6338de2132a34e4', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: '6866da246ee94adb8b250b85c1a2c7669ba0a2bf', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: 'faad61cddd164e2d1f01fd365e3127b30a760d8a', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '91a9bdb0954794eb15d5189ade4ccbfa88292a16' });
    }
