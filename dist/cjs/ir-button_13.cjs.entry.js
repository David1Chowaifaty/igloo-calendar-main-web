...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '24949f82628ef5dd46bb9cd8c587a8d3d04f2a8c' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: '2df168d296058556b483846d43832d4642edd6b4', class: "loadingScreenContainer" }, index.h("div", { key: '8af9f6d3be332522c35f7aba6c45bc08e4a8be8b', class: "loaderContainer" }, index.h("span", { key: '8e24260bf96d159fe6d94c75813d9b8dc36765f6', class: "page-loader" }))))));
    }
};
...
const IrPaymentOption = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: this.defaultStyles ? 'p-2' : '' }, index.h("ir-toast", null), index.h("ir-interceptor", null), index.h("div", { class: `${this.defaultStyles ? 'card ' : ''} p-1 flex-fill m-0` }, index.h("div", { class: "d-flex align-items-center mb-2" }, index.h("div", { class: "p-0 m-0 mr-1" }, index.h("ir-icons", { name: "credit_card" })), index.h("h3", { class: 'm-0 p-0' }, locales_store.locales.entries.Lcz_PaymentOptions)), index.h("div", { class: "payment-table-container" }, index.h("table", { class: "table table-striped table-bordered no-footer dataTable" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, locales_store.locales.entries.Lcz_PaymentMethod), index.h("th", { scope: "col" }, locales_store.locales.entries.Lcz_Status), index.h("th", { scope: "col", class: "actions-header" }, locales_store.locales.entries.Lcz_Action))), index.h("tbody", { class: "" }, (_a = this.paymentOptions) === null || _a === void 0 ? void 0 : _a.map(po => {
            ...
            }, label: locales_store.locales.entries.Lcz_Information.replace('%1', (_b = payment_option_store.selectedOption) === null || _b === void 0 ? void 0 : _b.description), open: payment_option_store.selectedOption !== null }, payment_option_store.selectedOption && index.h("ir-option-details", { propertyId: this.propertyid, slot: "sidebar-body" }))));
    }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '45baeb2c5334296bac9faa74c203b221054a70ca' }, index.h("button", { key: 'ce0a48d0a201bdcc91127732798497a5ba85a46a', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: 'a630a350b19671df99792649fbc467a6bc09a4ae', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: '5686710231eae7c0a65540d7f0e48237952c804f', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
