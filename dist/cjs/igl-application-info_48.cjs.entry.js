...
const IrRoom = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '162c96060dac86e90f57c5808a1ffbe583d10b25', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '2462359c32afd8f562b86466c836a81cebc8c802', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '7e1fc0242a0019fbba9fbf4430d8e42b8eb3cdee', class: "flex-fill m-0 " }, index.h("div", { key: '79070207fcb27f011246726a4fbd84e9c922db6f', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '613dae189ed0168746ced73d67fb1112ca4e0158', class: "m-0 p-0" }, index.h("strong", { key: '0f0013394fd967d453393d8b8bbea8de47ffa717', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'e7ddc9b175f05233cf51d7b7ed790d4386d23135', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'eb8045619ebbe150b483bad283bec6c417a9951d', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'c434169f823619206a7597c8feb2dfea0659178d', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHanlder: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '8fef2e721d1bbf354837b68aeeebdd25117aa2a8', variant: "icon", onClickHanlder: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'c9a614ee99994c593a6df7d89449ad185f06f27d', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '750d5c8745a673b8cce45f5f2a43be024f6c9de0', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: '660a5f8e7b68c630b87ac37e85a051a4d582e8ca', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: '99fbee150dc40a01305c1b51f681050505aaac3b', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !calendarData.isSingleUnit(this.item.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("div", { key: '7d681e1e8aabad70f7a506c8d41c654f06880c75', class: 'd-flex justify-content-end' }, index.h("span", { key: 'b20eb1e27c5a09d4dc51f0ccc9d2c8cdc83d3585', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: '5e06bb7bac1b800e7c2a11f8f1c9bfbe20c48133' }, index.h("span", { key: '0986abd7a0e1a2deceb545aeb6238c54f8b3ded5', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", { key: 'c24dbe06a55fc64d59046c50eaa68042a523a6a8', innerHTML: this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy) }, " ")), index.h("div", { key: 'd3fc57c1aa9b20d4674eda02590780660ac0a3aa', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '45fa82a87a0c3361e601cd67dadb072145b60cf0', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '342c2f5b9df586742594bc0c27b3f4c22bdc72d5', class: " sm-padding-top" }, index.h("strong", { key: '8af446783358a247c992a3f4036596705492f1c9', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: '4d470b6c61e41001206eed75a9bfe2023da891dc', class: 'flex-fill' }, index.h("table", { key: '436bae489df10a05fe23530252fd23b3409b2bf7' }, this.item.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'aa130c03d95c7a03175953093a98146012b192bc', class: '' }, index.h("th", { key: '1665d2b5288e00bf63bc3e1159fb1ec6e9825bff', class: "text-right pr-2 subtotal_row" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: '428529b61f45fa07d932f43e9ad63d8d22111080', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && index.h("th", { key: 'cba506cc3f552db3fe2b80430a7df0ef408ad799', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        //   </span>
        // </div>
        index.h("div", { key: 'bbf92aa77b542fed13f09f2e92af8c366eb4b470', class: "room_statements" }, index.h("span", { key: 'd404490bc4ec1a7cc44b8fbe1507ba82f4797ea5' }, index.h("b", { key: '38e34b4d4d4a9b349e8d58f8223a8bfe52f47506' }, this.defaultTexts.entries.Lcz_Cancellation, ":"), index.h("span", { key: 'b00d978fb7e46bef348e58567b2dc101bb107a8d', innerHTML: this.item.rateplan.cancelation || '' })))), this.item.rateplan.guarantee && (index.h("div", { key: 'dabba12bc6fa4b404e28b0e8016cd8330e6b8ce7', class: "sm-mb-1" }, index.h("span", { key: '8a77a399a2cb575f4148a22dbc509d4d87416196' }, index.h("b", { key: '27f0ffd16509b315a324dd9f419a41a206a62bfe' }, this.defaultTexts.entries.Lcz_Guarantee, ": "), index.h("span", { key: '9e5cac0f8dc6b89be0b9f984f3289ca87ef4bf8b', innerHTML: this.item.rateplan.guarantee || '' })))), this.bookingEvent.is_direct && index.h("ir-label", { key: 'ffe26e10f42462cbd4a8e4d67f5803a5c2899e81', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), index.h("ir-modal", { key: '409b1c2104b282e2ff2e324e80456e5dc553d3d7', autoClose: false, ref: el => (this.irModalRef = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
