...
const IglBookProperty = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ebfa6a4ed9bba3ac93fcc3823265b83a22e85e52' }, index.h("div", { key: 'c3adf78e046061e520b43b10d17b3bbe73585cad', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: '9996cb6caba26b8ca3cc5d4b9521062d54dbd21a', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: '110b418bdc9998b6211aa8627e65ee53eaf7729c', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '5acaa4d5aa2c9223e3f1ba7d69462879e2fb7b4c', class: "card-header-container mb-2" }, index.h("h3", { key: '369f749b865d81c7c2a3b29719c732944de94df9', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '97f952bc8e977f2246111b64c55e3a90c025db4c', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '1b8cf4b7bdda3e0990f74abe426442e5c3a21ae2', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '16cdd34727acc874ea5b27b9951655d13364d255', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: '33649de6b767590eed417a6a83334fadad78d1eb', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { key: '1b0b9940fc02f8da6db90ade4b7a744879622484', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (index.h("igl-booking-form", { key: '58b339a0e8605106445e01c1030a4623b09a3036', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countryNodeList: this.countryNodeList, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '588e1e22e0216c6018307a8f8acaec58cfb2a4d6' }, index.h("a", { key: 'bd08289dc1cf190b70dd5fd79d191ee1b4f2b5f9', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '3f093883de7b9d10cd1efc31bb6adecce730c86d', class: "sr-only" }, "download url")), index.h("section", { key: 'cef2eadcf7eef3832d4c68fcdecf973eff720e50', class: "d-flex align-items-center " }, index.h("div", { key: 'cffed2db288af39f19cc4f3d328331a9ae37f4ba', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '5057e3f0cacd7225ea8df363946d12b97d2303c8', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '7722349c4b3b60367b034f581aae93070d225d6a', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '32f86ebf3f3b150a49d7802d5821615ba7db2b3b' }, index.h("igl-book-property-container", { key: '3f27104e14f72ed30247c70585833ad0c5136ea6', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '553521690014a3becc2b83648d964cd491db559f', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" })))), index.h("h3", { key: '08013a7c087a5ad517aceadce0783e085bd5efc2', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: 'e98ca82831dcbedeebad20b9ccf64c08da991ac6', onSubmit: e => {
                ...
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false }), index.h("ir-select", { key: 'e5a8eeb5ef279bf6b36d0e0b7045379307394835', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), LabelAvailable: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
...
const IrRoom = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'e967012163c2aebe4bb02be0ba8ae2058d0840d5', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: 'df6b0d15dd49225497ed17c26bee2c1cfd3023a7', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '07656e3d509aaf748e7ba8f45542a14aeaa609e5', class: "flex-fill m-0 " }, index.h("div", { key: 'a3a5e2fffc760b7c2e4f14772d1671e81a0e7982', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '3dfd1cac9eec697f01538229e0918e781dcc7953', class: "m-0 p-0" }, index.h("strong", { key: '0c83a9db9df0458ca465e9d0961f332455cfaf04', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'c0dcfb799b80337fd2ec3eac95e79c784ad4ff6e', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: 'e1e31c0ab3ebe43df571bd4f1bef21e4a6d9c40f', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: '09ab5f6ddf91ef24833c0cce4431260028cdcf1d', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHanlder: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: 'bbdb7d5ab60bf97bfc167255e07735d0e53c5fff', variant: "icon", onClickHanlder: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: 'b5613144c118310452cda6111513aa54d08397a8', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: 'ea62ccfe7febfadfa4bb23e4e5c3d52ef7c8ab77', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: '7f4a6bd4369dde551d5d276a04fac7b632216274', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: 'bc8f153c0d7e4c0b30f0ce10396226f4bd2ec3e1', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !calendarData.isSingleUnit(this.item.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("div", { key: 'adde98b6689d34d345f2bf3baddfb7642c0dfa73', class: 'd-flex justify-content-end' }, index.h("span", { key: 'ebca2ac46d5d895689fedba25fe1b1edbf529e80', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: '7a3a49699bbd74ba6c5bfdbd0810d5f93ea190f4' }, index.h("span", { key: 'def5c694c155863b043244ec861c3cad8c29a34e', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", { key: '71eaa4e44c0b0b62a6f527d4c14fafe9f0e36152' }, " ", this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy))), index.h("div", { key: '36d59d6909c5569d8185b99aad3f54e0dfc5c909', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '8854d24750faebadd87613b898fc697007163fab', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: 'f888ee86eef143663ed7be44bb967eb12c7b5dd5', class: " sm-padding-top" }, index.h("strong", { key: 'c974d834c62d1dd28df96bb3725b0c8ad014e43c', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: '8d7ba315f99d35b3ffb9f5de355a24fb7c1c5e9f', class: 'flex-fill' }, index.h("table", { key: 'fc3693aaef45bbac0a655814771039f90e44707f' }, this.item.days.length > 0 &&
            ...
            }), index.h("tr", { key: 'a94654edd359f3996aafbf8af597fd44d904a019', class: '' }, index.h("th", { key: 'f84b4d7d2dc02b9c3194d700e7f125afc7fde67f', class: "text-right pr-2 subtotal_row" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: 'a54da3916f701aa1bdbabdda54e3a5c7ecd8c851', class: "text-right subtotal_row" }, utils.formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && index.h("th", { key: '59fad81241e5b0ecd5829a4458ef8aa34fb5486e', class: "pl-2 text-right night-cost" }, utils.formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        //   </span>
        // </div>
        index.h("div", { key: '0bfa98a9b599cdaf901b7125cab7bf8a8d126514', class: "room_statements" }, index.h("span", { key: '0dc1748f5a7c54a37c8fb0954d04467a338195d6' }, index.h("b", { key: '8f6b8e11700e8937684c9f4bf78131b22bc2ed48' }, this.defaultTexts.entries.Lcz_Cancellation, ":"), index.h("span", { key: 'ee0a39f432520abc49c0ee00c752c1a3c776276a', innerHTML: this.item.rateplan.cancelation || '' })))), this.item.rateplan.guarantee && (index.h("div", { key: 'a1bc4fe5a823b692d67b1c0e81a4f6ea9677cce2', class: "sm-mb-1" }, index.h("span", { key: 'f441e9f6213ed9b588261a6815b97d9f8de2a5e8' }, index.h("b", { key: '6c4379ff26cd0d4e00b4643f586896b02b434448' }, this.defaultTexts.entries.Lcz_Guarantee, ": "), index.h("span", { key: '7ebf72da5340bd1cb1283d537aee4618cb471d2b', innerHTML: this.item.rateplan.guarantee || '' })))), this.bookingEvent.is_direct && index.h("ir-label", { key: '2de6b261da7e0a2cab29e975c98de28c412c4373', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), index.h("ir-modal", { key: '286be4e059cfb0c005463e00de49fa99af98350e', autoClose: false, ref: el => (this.irModalRef = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_48.cjs.entry.js.map