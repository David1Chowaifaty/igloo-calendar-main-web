...
const IrExtraServicePriceInput = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f49a9e338398242c725f6d9036876093d2eaaf78', class: "ir-extra-service-price-input" }, index.h("ir-validator", { key: '4bcf7c24ca23a5230adbbdebd698244592a17ea0', form: "extra-services-settings__form", class: "ir-extra-service-price-input__price-wrapper", value: this.price?.value ?? null, schema: index$1.libExports.z
                .number()
                .nullable()
                .refine(value => value === null || value >= 0.01, { message: 'Price must be greater than 0' }) }, index.h("ir-input", { key: '7a4ad13a17d24a846e2f46c822366a5917f7678a', value: this.price?.value?.toString() ?? '', mask: 'price', onChange: () => {
            ...
            } }, index.h("span", { key: '61a32b3b86a868b333d97ebe00e4abe7aeba7e80', slot: "start", class: "ir-extra-service-price-input__price-symbol" }, "$")))));
    }
