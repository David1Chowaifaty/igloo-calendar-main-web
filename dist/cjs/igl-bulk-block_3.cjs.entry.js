...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: '4ff531669f6e2dc202c542793d078443a6a781a0', id: this.formId, class: "igl-bulk-block__form", onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("wa-radio-group", { key: '672f4b86779f38214b8aac553cb9de3b45f36925', size: "small", label: "Block or unblock a unit", orientation: "horizontal", name: "action" }, index.h("wa-radio", { key: '19fcc9463f59a30e185118698c0e0efaeb7b1c57', style: { flex: '1 1 0%' }, appearance: "button", value: "block" }, "Block"), index.h("wa-radio", { key: 'f73418e8349cc00ba10a307822123cb036c5189b', style: { flex: '1 1 0%' }, appearance: "button", value: "unblock" }, "Unblock")), index.h("div", { key: '3070d6da728cff3f28451336426e83dc5f6cd235' }, this.errors === 'rooms' && (index.h("p", { key: 'a5848ebf61b008dc56dda6e58d89c44ffcccd571', class: "igl-bulk-block__error" }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("wa-radio-group", { key: '6c773baa66d2b5a016fdef861ec998b1e7b33fc3', name: "unit", ref: el => (this.unitSections = el), onchange: e => {
        ...
        }))), index.h("table", { key: '0e7556bb9e3e90852e46c41c2d6615027026a7cd', class: "igl-bulk-block__dates-table", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'fab3fcd72d8c558c67eeb73b357df6af4e24f964' }, index.h("tr", { key: 'f20bac7eb4c90da94ac7458ff7c09588d8ab4f2b' }, index.h("td", { key: 'bafad4c358894406805a02e6908365cd131f3602', class: "igl-bulk-block__dates-header" }, locales_store.locales.entries.Lcz_From), index.h("td", { key: 'e2c2c41128f02bd3fcac47b8dd218ed8a0d80682', class: "igl-bulk-block__dates-header" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'c70fd801b650be49966fdc2e741b0ef7c0021104' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-custom-button", { key: '79f2df702723d61c914456d6d97398954ecefebc', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, index.h("wa-icon", { key: 'f177292010a95418e836f8fe16c5cec447241926', name: "plus", style: { fontSize: '1.2rem' } })))))), index.h("tbody", { key: '0ec4db30e76399587a7957279722560acf982c56' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '92d4909f276f2f00504c0c045edc712e3b887ac9', id: this.formId, class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'f85c32a518c650e60d2c980dfa09e26abc7cc5a7', class: "sheet-body px-1" }, index.h("div", { key: '8dd9200261a012ccfcdc1b94431065339af5ee75', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: 'fb1d7a2dc0e504cb594a3bcd35656503d7dda91f' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: '6dc0c2114cfff07b5a7666943b66f3db147e0559' }, this.errors === 'rooms' && (index.h("p", { key: '8d9e1878dbf4ff4f4cfca4accf8c734287ec42e8', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: '4b0a9c7ad6a81f74e56ae76d701a376d934fe6dd', ref: el => (this.unitSections = el) }, index.h("thead", { key: 'a7d0540500f91940c4dbbb18ef53d474e005c4b7' }, index.h("tr", { key: 'fa400b7932e1671c4a0bb977ae0d192ee21bb3c5' }, index.h("th", { key: '961468bca49fd69d43a7f50efabff9abab101c6b', class: "sr-only" }, "choice"), index.h("th", { key: '866b59572c367675d969bee08ebbf190cd45fbdc', class: "sr-only" }, "room type"))), index.h("tbody", { key: 'e78d830ec0845ab10e992b822f1f2aea006064fe' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: 'c904f65344970e5600c6d20a9171f2b92f1bf497', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '07ffee7eb1be055ff7e3c2e6ff1dd7eaaaa41c76', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: 'df0ee3d6e6ee37afc7f92f17ecb79bb6b4ab9ae0', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '3d8742491237fc884e7515f35dae6bf6961bcded', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'a9cb12f106c7b6c2c432e306986ce3308dff9883' }, index.h("tr", { key: '302b44b2402ec67c4db1d75ee0f7e30a661c33aa' }, index.h("td", { key: '6bf9d582dd77921be1f72b95d266eaa6698e3b4c', class: "text-left bulk-stop-sale__date-label" }, locales_store.locales.entries.Lcz_From), index.h("td", { key: '20e655d3f7bd0f5053680f0056e530548bfb285c', class: "text-left bulk-stop-sale__date-label" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '91becf80961b7c2a48b3b929db790073b066161a' }, this.dates.length !== this.maxDatesLength && (index.h("ir-custom-button", { key: '3af065aee2c4aae7bc4be471e67cbd809a63ae2b', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, index.h("wa-icon", { key: 'fb23e399c248672323dc43249cd8c766352b8329', name: "plus", style: { fontSize: '1.2rem' } })))))), index.h("tbody", { key: '910b9c5a6948d31685664c5664f4a0df3b7b06eb' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate : this.minDate;
