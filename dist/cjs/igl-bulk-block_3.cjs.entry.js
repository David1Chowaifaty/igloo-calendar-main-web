...
const booking_store = require('./booking.store-f55038c7.js');
const calendarData = require('./calendar-data-70bc3b4b.js');
const moment = require('./moment-1780b03a.js');
const index$1 = require('./index-8bb117a0.js');
const locales_store = require('./locales.store-32782582.js');
const booking = require('./booking-7e2a012c.js');
...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: '34d2eb6bf67b9205f287fc6aae357c5ea2de852b', id: this.formId, class: "igl-bulk-block__form", onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("wa-radio-group", { key: '298916cd2f8c31e908a2df9ccb23741300a58678', size: "small", label: "Block or unblock a unit", orientation: "horizontal", name: "action" }, index.h("wa-radio", { key: '36caf60c45e28c31db437b232c288e45b4949f29', style: { flex: '1 1 0%' }, appearance: "button", value: "block" }, "Block"), index.h("wa-radio", { key: 'f8c9342a19854f2b495a43276d7765d0fea16a14', style: { flex: '1 1 0%' }, appearance: "button", value: "unblock" }, "Unblock")), index.h("div", { key: '96d88951fc57540bb9fd50a3abb32b45b60d597a' }, this.errors === 'rooms' && (index.h("p", { key: 'd68fb80a40318412b93dd5647fd2a534a2ae6a79', class: "igl-bulk-block__error" }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("wa-radio-group", { key: '9ecf309a9a9eb298805bc3f4466139fc9674bda3', name: "unit", ref: el => (this.unitSections = el), onchange: e => {
        ...
        }))), index.h("table", { key: '443b50f72272ea7da50f4f77ae5148fb6d6e9b77', class: "igl-bulk-block__dates-table", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'b1a2800616b1c855c045046e80916efd3b2372b5' }, index.h("tr", { key: 'ec20f850c2c4c3f803958dc0dfab92061e61a90b' }, index.h("td", { key: 'e59534b094fce56381cc32731c5bbdb30bbe73ae', class: "igl-bulk-block__dates-header" }, locales_store.locales.entries.Lcz_From), index.h("td", { key: '654c888baa6d18983ae8a4093ef7cd16660c70e0', class: "igl-bulk-block__dates-header" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '4b2e6e0d3693e9111225cac9ce2662e122e6b24e' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-custom-button", { key: 'a2fa14f03fdd6e355611de898462cd2534c010b2', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, index.h("wa-icon", { key: 'f85562e39bd6c6eb74cec62882c899e11a083ed2', name: "plus", style: { fontSize: '1.2rem' } })))))), index.h("tbody", { key: 'b1b6a3bd23bcd6e25eb762260430d7ef81cfe344' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '9c8a52a44cc307e03b87ff06ba452a1d48fa2cf4', id: this.formId, class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '941bba4b46d28aacb96150a118fd714018e4f653', class: "sheet-body px-1" }, index.h("div", { key: '35824901249978037ae373576bff39888ffc58f5', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '03dd6052bc2cb75d4d38d084fc4bdb50036de46e' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: 'daf5d9e9acc1a4d84370734a8fedd2f41d8272b1' }, this.errors === 'rooms' && (index.h("p", { key: 'd40bb43f4e3837689f1de2925530dc3ef842cc6d', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: 'acd08717bfe00d626e6eef3445508545212cbf3c', ref: el => (this.unitSections = el) }, index.h("thead", { key: '4dd25cbecc0602806b33219a4edb484485306d67' }, index.h("tr", { key: '9d48ba1a9a211f6d89cc977e35d8a9bab512197d' }, index.h("th", { key: '6f64bba7dc840937c5839ed69170948cf57d4a54', class: "sr-only" }, "choice"), index.h("th", { key: 'b4a46974c65b518eaf6815e562d9936b962a33be', class: "sr-only" }, "room type"))), index.h("tbody", { key: '0514610627367bd72206ea0f7173a7d283eac72d' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: 'ecac55b7c030b8f89ad970d360f8a2196919ec36', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '81ffb1c28ad02b726decb3688b10a0e61e951732', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: 'dbe744e648200d9dc03a2eccb09a4ab4488e412b', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: 'eae672cd985e81808590d4fd300902b9ad99245b', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'accf953b3b841ea1060bf077e05ac05419d0998e' }, index.h("tr", { key: 'c95b1c8e2dd79c84823c4e91bdb163b2203d5436' }, index.h("td", { key: '7d630dba469f47b7c735231f13db678bd9350ed6', class: "text-left bulk-stop-sale__date-label" }, locales_store.locales.entries.Lcz_From), index.h("td", { key: '87319b2d5e2a60f9fa744e3fa3d5fc1288522f05', class: "text-left bulk-stop-sale__date-label" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '51d979905728e86468fa4a8ea4320fee95866ba3' }, this.dates.length !== this.maxDatesLength && (index.h("ir-custom-button", { key: '04a95d8b31a3f5e34c262da3b19225213fd23994', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, index.h("wa-icon", { key: '6f559eefd72b54409a1cd86f0991e56874b99820', name: "plus", style: { fontSize: '1.2rem' } })))))), index.h("tbody", { key: '75cc9bab4899546a9e5a6cbfdc59653c662c46c1' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate : this.minDate;
