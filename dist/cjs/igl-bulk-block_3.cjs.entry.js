...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: 'd38dbd7c57d6058da56ec5bb10744e78881e6fb9', id: this.formId, class: "igl-bulk-block__form", onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("wa-radio-group", { key: 'ed85884407e2a01d33688a45294ee4566192b1df', size: "s", label: "Block or unblock a unit", orientation: "horizontal", name: "action" }, index.h("wa-radio", { key: '460ebac8ef9b1daaffaec2f86a02682a2f69e7c4', style: { flex: '1 1 0%' }, appearance: "button", value: "block" }, "Block"), index.h("wa-radio", { key: '39d403ab026ed8fe3c520a302f0f733f21a6702c', style: { flex: '1 1 0%' }, appearance: "button", value: "unblock" }, "Unblock")), index.h("div", { key: '6f80eb8349883fee8c6c163197d1f0b9509f75f6' }, this.errors === 'rooms' && (index.h("p", { key: 'f0ef58628547bcfedc53aa158b49d00ceefbd761', class: "igl-bulk-block__error" }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("wa-radio-group", { key: '86c3c6df95fa0a3efc0ba9da9df2f1c81b685517', name: "unit", ref: el => (this.unitSections = el), onchange: e => {
        ...
        }))), index.h("table", { key: '65451167ed5ad198152b2edfe86c3b99bca57837', class: "igl-bulk-block__dates-table", ref: el => (this.datesSections = el) }, index.h("thead", { key: '86145c84c348af2b29d5873fb5db99a85532090f' }, index.h("tr", { key: '13398519cdd472771eb1398ab2189e247671aba8' }, index.h("td", { key: 'b6a11a2e9843a892c24225f06c8eaf31ad4b40fd', class: "igl-bulk-block__dates-header" }, locales_store.locales.entries.Lcz_From), index.h("td", { key: 'cd71357094e31e0406c992798550fdf05970c30a', class: "igl-bulk-block__dates-header" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'a9a6508059789b3aaaf199cc8b8bc1e590305f06' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-custom-button", { key: '5062eff370fe6d630ed850a48024f63a4dd91535', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, index.h("wa-icon", { key: '3d20e53a79f17458a7aaf36ec8bb0742edab0e79', name: "plus", style: { fontSize: '1.2rem' } })))))), index.h("tbody", { key: 'b30ee2e2fcb9e2590ff127c6c64d35918e1c2508' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: 'bbc7e3193bfb6c98505cd26893fbe5c451ae0a4c', id: this.formId, class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '2c8d4270a74746e2d00edbf56ca6e7e3ab01a897', class: "sheet-body px-1" }, index.h("div", { key: 'a11d96adee1a8b855d653791700102523e05da8d', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '01461d4403e01a03784c4b1027a021d7441017c0' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: '9d56c042794e609b8cfc8b3ae129ce6289b87228' }, this.errors === 'rooms' && (index.h("p", { key: 'aca9f52e7c7ce0c769c7385067883b449f2bdb5a', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: 'e8d85668611c8d43e1fe2b9b0a8549c7b514e110', ref: el => (this.unitSections = el) }, index.h("thead", { key: '2a305e8e3f5c23eadfd1862d4f8186f1467b9306' }, index.h("tr", { key: '16feed37432ff9e4806b53b7b9dd6106119f7fcf' }, index.h("th", { key: '0a0c08550821be06e695d8e7048ebcf98604fce6', class: "sr-only" }, "choice"), index.h("th", { key: 'fc8b9a2aec7113aaab46f6a8497ed46fd0d1d26f', class: "sr-only" }, "room type"))), index.h("tbody", { key: '4927521fd65afeccfb96044440e69aea9ae9db4d' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: 'fb79f406b0e5183b5acb5f6c8e3838f4468925fd', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '968b5a6bcd9853af71d853699f60a6fd32d300a1', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: '90eb030ec85d9c22cf15f5f45d7fc62fe62731ab', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '2019e10f4a31c9a1ac8aad08829585e4c5a46049', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'b5d490d10de6c02f1ec34f3db864b57c316f7996' }, index.h("tr", { key: 'f3517d79ed45aaaa37521166ec494f7b14b99211' }, index.h("td", { key: '9204b6aa01ca57462ce286d898017f50abed19f3', class: "text-left bulk-stop-sale__date-label" }, locales_store.locales.entries.Lcz_From), index.h("td", { key: '0bb7a949ac901decd7f45f43dabe3aeb3044b3fe', class: "text-left bulk-stop-sale__date-label" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'a06d8bb5931affdd55a6efeca8d7e9bad48eb5de' }, this.dates.length !== this.maxDatesLength && (index.h("ir-custom-button", { key: 'b31d4616869baff06163011728f3985873f9d3b2', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, index.h("wa-icon", { key: '436e3aa1465ac5e6239ea1b3d1880b0a468cdfc0', name: "plus", style: { fontSize: '1.2rem' } })))))), index.h("tbody", { key: '2dbc0e3c0c0a63d03142e2ee426846803d299396' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? (this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate) : this.minDate;
