...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: '5a5918d857713590aab6c7d93bd279bebc0fba7e', id: this.formId, class: "igl-bulk-block__form", onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("wa-radio-group", { key: 'edfe3153903751a03a887041cf4d88e1669d02c1', size: "s", label: "Block or unblock a unit", orientation: "horizontal", name: "action" }, index.h("wa-radio", { key: 'c57f0bec7aa1fc74ed7265251dfefa20bc0ce018', style: { flex: '1 1 0%' }, appearance: "button", value: "block" }, "Block"), index.h("wa-radio", { key: 'fab0019ced11a26a8bf5cb0eabfa56db4779b7fc', style: { flex: '1 1 0%' }, appearance: "button", value: "unblock" }, "Unblock")), index.h("div", { key: 'ddfe036e2733861855972e0003f0eb4080a449f8' }, this.errors === 'rooms' && (index.h("p", { key: '576f3a8271b6e6c17e710f9a9a0b045b50611f83', class: "igl-bulk-block__error" }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("wa-radio-group", { key: 'f53dcfcdc7bbcb3d2fd1e1c9a76eaa2135be6dc8', name: "unit", ref: el => (this.unitSections = el), onchange: e => {
        ...
        }))), index.h("table", { key: '4b3a06ba69b7ca46027153d02899ff8b67894518', class: "igl-bulk-block__dates-table", ref: el => (this.datesSections = el) }, index.h("thead", { key: '1d5a3f2e892ad6f6a09de6246bd7cc4d0ddb1fe6' }, index.h("tr", { key: '424e4c80777cc4445132adb4323ed936498240ea' }, index.h("td", { key: 'cc91843008733895d68f64825ec2ceecb12b1851', class: "igl-bulk-block__dates-header" }, locales_store.locales.entries.Lcz_From), index.h("td", { key: '9af72381a5b0c1704d17b07d43a2c1a0d1f7c489', class: "igl-bulk-block__dates-header" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '0f43277f888c6f899a0240183f26d9d53500e974' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-custom-button", { key: '4ae1b7f4d97ca6ce136d1d7e5f137aeb7044d9c7', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, index.h("wa-icon", { key: '7a08de23844f6a84b03cc9cb878ad089dd41f618', name: "plus", style: { fontSize: '1.2rem' } })))))), index.h("tbody", { key: '33c5ac274f81df01c243390775c23e756ce6d836' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
...
const IglBulkStopSale = class {
    ...
    render() {
        ...
        })))), index.h("p", { key: '4799dff5d11f0c2e252437164b71f0cdee054422', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '9fbe15e103069643b1d851afc9d9d53e4bf8b6a6', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: 'a9ff0315c61251d7170de736f416808782005429', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '020721868ecdc3dceb6a315feb6970a010bf75cb', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'e4f0ecc3abd08de3419339c6498c4fece6778bb5' }, index.h("tr", { key: 'afe7bca9315406caedc4434652b9b5b9d29f830d' }, index.h("td", { key: '449fd8469ca9f2078eb246697cef01b66926b7fa', class: "text-left bulk-stop-sale__date-label" }, locales_store.locales.entries.Lcz_From), index.h("td", { key: '3b72b58fa59cb59bcad64d183922a815084b098c', class: "text-left bulk-stop-sale__date-label" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'fcb84ba4b2517bceff5db61645214cba95da8821' }, this.dates.length !== this.maxDatesLength && (index.h("ir-custom-button", { key: '410ba96f540b24c3226b37b200a6d828faaa9682', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, index.h("wa-icon", { key: 'd61886e0da7eba9a3be0b41dbf0faa7d67354024', name: "plus", style: { fontSize: '1.2rem' } })))))), index.h("tbody", { key: 'e85ac65f5825ddea829ec51d773966b2c6e326e9' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? (this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate) : this.minDate;
