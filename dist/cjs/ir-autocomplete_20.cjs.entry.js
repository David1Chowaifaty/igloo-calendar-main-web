...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5e3786eb82f752a14526b5df03c3eab4be5105c5' }, index.h("wa-popup", { key: 'e5215768bde838185049ba70e4557c7f88168c56', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, index.h("ir-input", { key: '2eb9aba94685c096164de16b2c9990261cf1e92d', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotManager.hasSlot('label') && index.h("slot", { key: '99776d6f79d0acdc51c71715dfebcf1db78e1395', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '51037418317e134195cfd15a06d541d08cfcf545', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: 'bd002f6acf9f6c3d679f845afa5e720e92a524b4', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: 'ba1935ec832a554dc50f9371c54894864ab90e75', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: 'e672f79cb0b477caba30fa4d1ff6dde5c545dee2', name: "hint", slot: "hint" })), index.h("div", { key: '11c385c3e20a9f5647c6260f8e9d31aca5a9497e', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, index.h("slot", { key: 'ae716ed52a8053fef1bf4852d0869b94341068b6', onSlotchange: this.handleOptionsSlotChange })))));
    }
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '98c61bb1bf204f67d68943715439f3d90acb3d68', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: 'f69b79e5d360a2b1e4a1d93da9ca2c490afb3b22', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '7fdaf1acc5d33108f1945b2864b0a66896d04fab' }), index.h("slot", { key: '56acf727286f0b64b2a2ca53f8775e18c9eeaf29', name: "start", slot: "start" }), index.h("slot", { key: 'c9e40040ef8f6370c296de09967a310921b51b6c', name: "end", slot: "end" }))));
    }
};
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '59cf6ce52a45b486915b509ea977575e90187aa1', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '36ce40f90c31064c616bf3aa729d893c4a0df12c', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '1a019876b15ad53865c2d06b06b5755fe814aa33', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: '497e5d9dc28efe388237fbadbebd6da75f8d55b6', name: "label", slot: "label" }), index.h("slot", { key: '2579a6a7ac7fa2e6019ea91d0e5aba3cf80817da' }), this.slotState.get('footer') && index.h("slot", { key: 'a1a6ee3869d04dcf05167da289a67a9720ff2f60', name: "footer", slot: "footer" })));
    }
};
__decorate$2([
    OverflowRelease()
...
const IrEmptyState = class {
    ...
    showIcon = true;
    render() {
        return (index.h(index.Host, { key: '97882c2eef4ad530435f86aecb5a11adfde5d43b' }, index.h("slot", { key: '7b9cb327db882231a99db89ca94cdff130f6d5f7', name: "icon" }, this.showIcon && (index.h("div", { key: 'a41adef97f3ac225a62a8e2eaa9eb3b6dadff2b9', class: 'icon_container' }, index.h("wa-icon", { key: '1f22ad96495998aab89ce15b1938fd3c9a00e1de', name: "ban", style: { transform: 'rotate(90deg)' } })))), index.h("p", { key: '113879bd3220a447fb4e3b450121ebeea6ba4c55', part: "message", class: `message ${this.showIcon ? '' : '--secondary'}` }, this.message), index.h("slot", { key: '48fb0bc9010857474861079d7d7f5ac79cf46df2' })));
    }
};
...
const IrMenu = class {
    ...
    render() {
        return (index.h(index.Host, { key: '130f4d8a4936a809251d48959bcab95a83c8b74a' }, index.h("slot", { key: '7245e1d666de2cc1c47d049e621c9764f7716707', onSlotchange: this.handleSlotChange })));
    }
    static get watchers() { return {
        "selectedHref": [{
...
const IrMenuDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '43125e0631a5ec258de241ddcf49d4493165504e', class: "menu__drawer", open: this.open, onDrawerHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.open = false;
            }, style: { '--ir-drawer-width': '25rem' }, placement: "start" }, index.h("slot", { key: '7ccde3b7f9352dc976ee387c6ac9ec6fa55c93ff', name: "label", slot: "label" }), index.h("slot", { key: '5545af30c3e2ad7db75755b15e16f7eb41830179' }), index.h("slot", { key: 'c158b8b970b227a404f416c7369f7e5bd0f6e5ef', name: "footer", slot: "footer" })));
    }
    static get watchers() { return {
        "open": [{
                "handleOpenChange": 0
...
const IrMenuGroup = class {
    ...
    render() {
        return (index.h("wa-details", { key: '556edbb9b9f33388e096278dba4a1a510b8e487a', class: "menu-group__details", open: this.open, appearance: "plain", name: this.groupName, "onwa-hide": this.handleHide, "onwa-show": this.handleShow }, index.h("slot", { key: '79c52ae959539c3575a34543d5ff3196dc382d72', slot: "summary", name: "summary" }), index.h("slot", { key: '9bd825f563cfbcebbd68b6bc2083a2a2bf829d0f' })));
    }
};
...
const IrMenuItem = class {
    ...
    render() {
        ...
        const content = (index.h(index.Fragment, { key: 'e6d7f844434b8573b9a7672c72b189bb9acd7515' }, index.h("span", { key: 'a5f46a3ee63b31a57c6e7570355ba71824d555d5', class: "menu-item__icon" }, index.h("slot", { key: '740d956b100b64eca386bc108412a53e4cef65d8', name: "icon" })), index.h("span", { key: '0f3c19407cd573804a2be181f8bf2f3861ac80e7', class: "menu-item__label" }, index.h("slot", { key: '9946205267e4c718ff5f71abfdcabb070c10cef9' })), this.badge ? (index.h("wa-badge", { variant: "danger", class: "menu-item__badge", appearance: "accent" }, this.badge)) : null));
        return (index.h(index.Host, { key: '012e3f94f9bb3d57114cf9eb9d8c93f40d6484cf' }, this.href ? (index.h("a", { class: contentClass, href: this.href, "aria-current": this.selected ? 'page' : undefined }, content)) : (index.h("div", { class: contentClass }, content))));
    }
};
...
const IrNotifications = class {
    ...
    // }
    render() {
        return (index.h(index.Host, { key: '58abf3e09255becdff2b5ca5688dcdadc730e132' }, index.h("div", { key: '0cb6be9533c24aed9df98595a647b0fee64ec609', style: { position: 'relative' } }, index.h("wa-tooltip", { key: '183f21499c51a484163b2f8e6d13f1c2204c66e2', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (index.h("wa-badge", { key: 'a241a3399652784529752ba0f3f9023e47af3cfb', pill: true, class: "header-notification-badge" }, this.notifications.length)), index.h("wa-animation", { key: '9ad30d2477e67baf01b0c1294f6418dee22229da', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, index.h("ir-custom-button", { key: 'be7525f104368f7d4776ac5d305141b6b1742e65', id: "notifications-button", size: "s", appearance: "plain", ref: el => (this.buttonRef = el) }, index.h("wa-icon", { key: '3d89e9523e9ea73ed2732ad217b5049457ebd967', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.4rem' } })))), index.h("wa-popover", { key: '12efe5c884e2349bfd045bc03938ebc82d2f0429', distance: 15, class: "notification__popover", for: "notifications-button" }, index.h("p", { key: 'cead592cee7c5861553cc2a08c0954b960ab323c', class: "notification__popover-title" }, "Notifications"), this.notifications.map(notification => {
        ...
        }), this.notifications?.length === 0 && (index.h("ir-empty-state", { key: 'a915cd7515e261084278ae4364790e2f19162cdb', message: "All caught up!", style: { width: '250px', height: '150px' } }, index.h("wa-icon", { key: 'fba0fcc255c076849c7a274f665125e7054e1d01', slot: "icon", name: "inbox" }))))));
    }
    static get watchers() { return {
        "notifications": [{
...
const IrPmsPage = class {
    ...
    render() {
        return (index.h("div", { key: 'eeaf184059174cf905d30eddf710f66465dd20f9' }, index.h("header", { key: '6bea082325ce9145a75b9fa3cfadb45b40f6bb54', class: "app-header" }, index.h("div", { key: 'c352c9562679088a9b515ea5e3bae5b81dcf59db', class: "app-header__left" }, index.h("ir-custom-button", { key: '64703a377e171e289fd7d2188c84db6a8e3828b1', onClickHandler: () => this.menuDrawerRef.openDrawer(), size: "s", appearance: "plain", variant: "neutral", class: "header-action" }, index.h("wa-icon", { key: 'bbe56ea1e9c1d7f3d872b898b0ced0c0e26ec40c', name: "bars", style: { fontSize: '1.2rem' } })), index.h("ir-property-switcher", { key: '0b107ec33e58b9102310b9d90c4eedb5fd6af647', ticket: this.ticket })), index.h("div", { key: '001aab2b18d4d53695bcf06d0efb64595a9f1742', class: "app-header__center" }, index.h("ir-pms-search", { key: '1abfbe4cb6cace0c91a8031a44d51595f7e9a577', "onCombobox-select": e => {
                console.log(e.detail);
            }, ticket: this.ticket, propertyid: this.propertyid, class: "header-search" })), index.h("div", { key: 'f4e1029993730331a94a5e6cfc489b3c55836c3e', class: "app-header__right" }, index.h("ir-custom-button", { key: '6f81dd28fff42f9c1fd8818a12e8d578cf40a0a1', id: "add-booking-btn", size: "s", appearance: "plain", variant: "brand" }, index.h("wa-icon", { key: '472ff021c4a4969d73887a9f1e3f955a5a051299', name: "circle-plus", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '8d04eda6255dc495f2d62573ec6fe8ef953adba1', for: "add-booking-btn" }, "New booking"), index.h("ir-custom-button", { key: 'ee4f7ef1c16358aafe41dcc8bf4319a697da9939', id: "calendar-btn", href: "/frontdesk.aspx", size: "s", appearance: "plain", class: "header-desktop-only" }, index.h("wa-icon", { key: '94c3cc022c337450b6369369f0e05297e335e7eb', name: "calendar", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: 'b6011f9e4c5b3ef50e256b6314232791bef2bbb1', for: "calendar-btn" }, "Calendar"), index.h("ir-custom-button", { key: '6b959da2b4da15b27d29e8c2f06d90d83f415278', href: "/acbookinglist.aspx", id: "rooms-btn", size: "s", appearance: "plain", class: "header-desktop-only" }, index.h("wa-icon", { key: '93fbe1abaf13a2723d627b189beee35a053dbbb7', name: "bed", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: 'bbb175093d9e1283b4a7475a5d8b9b5eb2fd9b52', for: "rooms-btn" }, "Bookings"), index.h("ir-custom-button", { key: 'ca264d43ce8aa08896d1a08ad0b51e4f45e892de', id: "departures-btn", href: "AcDepartures.aspx", size: "s", appearance: "plain", class: "header-desktop-only" }, index.h("wa-icon", { key: '5837c4ba368017f8ca7ad47eb72bf295b076ec59', name: "plane-departure", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '5d04b2b5f69a55f5fa29e49b2b15d926f662c61b', for: "departures-btn" }, "Check-outs"), index.h("ir-custom-button", { key: '0c481c1c790effa046b47d92bb297031838ad1ae', href: "/AcArrivals.aspx", id: "arrivals-btn", size: "s", appearance: "plain", class: "header-desktop-only" }, index.h("wa-icon", { key: '3fcb65b7e344baa2c86e0c34c3d16f4bfac36a8c', name: "plane-arrival", style: { fontSize: '1.2rem' } })), index.h("wa-tooltip", { key: '9369060110c20b25d5a1b97f56139dcfd576541c', for: "arrivals-btn" }, "Check-ins"), index.h("ir-notifications", { key: '4c23a59cebe05c0d58151c13e65b212f487b046b', propertyid: this.propertyid, ticket: this.ticket }), index.h("wa-dropdown", { key: '6aa96c905e4025d46ae6241aa029ee1d32b0d758' }, index.h("wa-avatar", { key: 'cc609a4c1a87775ef8eb3c9c064d7b49d3488576', slot: "trigger", style: { '--size': '2rem', 'marginLeft': '0.5rem' } }), index.h("wa-dropdown-item", { key: '7322e3798d107dcce51eb7f15cbb08e5f28b1d64' }, index.h("wa-icon", { key: '46a0bc51e682954d304310b035387ccd870966e2', slot: "icon", name: "globe" }), "View Your Website"), index.h("wa-dropdown-item", { key: '6363c24125e600e0724b8606121b8e8d40d4d6f6' }, index.h("wa-icon", { key: 'e3da429fcce782b16d8ff3e15f0f5d4c6c383c70', slot: "icon", name: "arrow-up-right-from-square" }), "bookingmystay.com/A35"), index.h("wa-dropdown-item", { key: '0828b9205429663f2325cadd334fc8aea9ecb0cf', disabled: true }, index.h("wa-icon", { key: '89c440189cd06dd17414749ed6e4b10a4d40dd79', slot: "icon", name: "hashtag" }), "Property ID: 42"), index.h("wa-divider", { key: '09bbfa25db1eee547e26d5521a2abb73f42fbe63' }), index.h("wa-dropdown-item", { key: '4c6382f076d77c3725d1879c7f0598cc309fc827' }, index.h("wa-icon", { key: '98c23841ae371c799fcbe3fd3b24917fddb982d9', slot: "icon", name: "users" }), "Extranet Users"), index.h("wa-dropdown-item", { key: '9f6e59b632f6c5307a330d1bc1ab8ae7a74e0432' }, index.h("wa-icon", { key: '5acfe629effed7f466b92cc34581d18c9cf8425a', slot: "icon", name: "lock" }), "Change Password"), index.h("wa-divider", { key: '768821bea3eec17a57ab0d4d5326b9ec926d63b9' }), index.h("wa-dropdown-item", { key: 'f4ee518c6ee7d831ffc15d07175a5a21eb44c70d' }, index.h("wa-icon", { key: 'eac3c73ed424ebe34e50b22f6d996d47df0f04d1', slot: "icon", name: "wallet" }), "Billing"), index.h("wa-divider", { key: 'c4939cba61f124f2c7c8b516b4ddd99b4c89d657' }), index.h("wa-dropdown-item", { key: '319cf545e6c4b6fd6c370a2b9f5db222ee7a0ad2', variant: "danger" }, index.h("wa-icon", { key: 'f86e38f3a6f8f75c813485183f240b3d98ed75b3', slot: "icon", name: "power-off" }), "Logout")))), index.h("ir-menu-drawer", { key: 'c18f8af6d1c2f6461f96e443b79717b7efc9dc6c', ref: el => (this.menuDrawerRef = el) }, index.h("div", { key: '951c84ef79e7a51051fcaddaeacec2452f350f46', slot: "label" }, index.h("img", { key: '8a7468d4e838d7543d844b9251a4f1c3df52cbd4', style: { height: '24px' }, src: "\thttps://x.igloorooms.com/app-assets/images/logo/logo-dark.png", alt: "" })), index.h("ir-menu", { key: 'ab1f439147cea43ec906e59f575622d3c7c49275' }, index.h("ir-property-switcher", { key: '5f93b5596fead920221112ebef72f886bd5258ca', ticket: this.ticket }), index.h("ir-menu-item", { key: '46527e0f9d928989cfa64321166fab6b7565f1ac', slot: "summary" }, "Property"), index.h("ir-menu-item", { key: 'b5bf482dddbfce69e79417e39a5c24a13901d8eb', href: "acdashboard.aspx" }, "Dashboard"), index.h("ir-menu-item", { key: '29cb43f79f4f29be7c45e2e4a650f3ba14a1a206', href: "frontdesk.aspx" }, "Frontdesk"), index.h("ir-menu-item", { key: '5a162371627dde238d191cce5263bc224f544ac6', href: "acratesallotment.aspx" }, "Inventory"), index.h("ir-menu-item", { key: 'bb6865234f3e36e84ee7424697ed22fbc03ef551', href: "frontdesk.aspx" }, "Frontdesk"), index.h("wa-divider", { key: '568a80b85bd77c8963b779c46a8dcb824639967a' }), index.h("p", { key: '034ce9c7737485e1917287d9f87cfd3cdbff4ee9', style: { margin: '0', marginBottom: '0.5rem' } }, "Property"), index.h("ir-menu-item", { key: 'd07f9a42cad75dd9c54ba57856edb3be9c3de91f', slot: "summary" }, "Property"), index.h("ir-menu-item", { key: 'c9d69ea02ee2ee717a2eac573c27d0a22989741a', href: "acdashboard.aspx" }, "Dashboard"), index.h("ir-menu-item", { key: 'c6c007fb0f9f5d62399714fbfb2f612e40a0b634', href: "frontdesk.aspx" }, "Frontdesk"), index.h("ir-menu-item", { key: '6bd4209d5e5f188e8777379f4f0645336c2abf57', href: "acratesallotment.aspx" }, "Inventory"), index.h("ir-menu-group", { key: '2a0f460a13cd7a11e4d3ae9adc31b6598d3da1c1', groupName: "sub-property" }, index.h("ir-menu-item", { key: 'fdca80a428417cbcd8df4e141c22996a79d8243a', slot: "summary" }, "Marketing"), index.h("ir-menu-item", { key: '2a98623d1e9f4ac72ec6edcabcf66a20ae5cea94', href: "acpromodiscounts.aspx" }, "Discounts"), index.h("ir-menu-item", { key: 'c8f914a11984bb39f0f2f83a30c0647cd522fbf9', href: "acautomatedemails.aspx" }, "Automated Emails")), index.h("ir-menu-group", { key: 'fddbf38e7caf49765633b761d002155f7eed833d', groupName: "sub-property" }, index.h("ir-menu-item", { key: '4edd15475d7493fbb5d773d97968a29a7453aca4', slot: "summary" }, "Bookings"), index.h("ir-menu-item", { key: '72d1f000dc88cb0b468a7cc9b87e7deb6971fc2d', href: "/acbookinglist.aspx" }, "Bookings List"), index.h("ir-menu-item", { key: '71f767d0d738ebdad7d512e0a3a85bedab28b05f', href: "/AcArrivals.aspx" }, "Check-ins"), index.h("ir-menu-item", { key: 'c0ea926d41f84881d2cdeb9f21151b078e8703c6', href: "/AcDepartures.aspx" }, "Check-outs")), index.h("ir-menu-group", { key: 'c45ef123b6e9a6a23d866e5381fae1d5422737e4', groupName: "sub-property" }, index.h("ir-menu-item", { key: 'e49416c75955dbe69239b17700bb903e8532608d', slot: "summary" }, "Settings"), index.h("ir-menu-item", { key: '30373c588ead25bddf37cf2628b9c79df3ba42ef', href: "acgeneral.aspx" }, "General Info"), index.h("ir-menu-item", { key: '087112ad8616c32d8bfbd3d26430e90895a8e88a', href: "acamenities.aspx" }, "Facilities & Services"), index.h("ir-menu-item", { key: '2d63b0ab46886943d2b8a4d42e387ab2b80e14a9', href: "acdescriptions.aspx" }, "Descriptions"), index.h("ir-menu-item", { key: '267bdc56dceb85dd82c41b6c70926657f94babc9', href: "acconcan.aspx" }, "Policies"), index.h("ir-menu-item", { key: 'ff5db894121a56ffb07fcb010b8662a1bd1d75bc', href: "accommtax.aspx" }, "Money Matters"), index.h("ir-menu-item", { key: '315f30e8d281f434971b23852fe3b1cfd479edd3', href: "acroomcategories.aspx" }, "Rooms & Rate Plans"), index.h("ir-menu-item", { key: 'a2901bb698bb86cc8efa62d9e62a181768507eb2', href: "ACHousekeeping.aspx" }, "Housekeeping & Check-in Setup"), index.h("ir-menu-item", { key: '1a8c59ba359930e27ca103dabf719c2f53072924', href: "actravelagents.aspx" }, "Agents and Groups"), index.h("ir-menu-item", { key: 'f96f85668b520ccdd763a183020a62310ab393b5', href: "acimagegallery.aspx" }, "Image Gallery"), index.h("ir-menu-item", { key: 'f5f4d088e73e843e52fcadba1e3bf9b97df78c7f', href: "acpickups.aspx" }, "Pickup Services"), index.h("ir-menu-item", { key: '95e199d3e8d8336c3dddb6b48fb9362d821b466e', href: "acintegrations.aspx" }, "Integrations"), index.h("ir-menu-item", { key: '0eed053ad53275392e0b184d88f7ddb1b126390c', href: "acthemingwebsite.aspx" }, "iSPACE"), index.h("ir-menu-item", { key: '4c64ed6f4d6a99a59a42d25a86f422a7dfb4dae1', href: "acigloochannel.aspx" }, "iCHANNEL"), index.h("ir-menu-item", { key: 'c92a1c507c4e2c5c4c97c1630e4a09b280e93616', href: "iSwitch.aspx" }, "iSWITCH")), index.h("ir-menu-group", { key: 'b10bbf86c49c0e2fe41086795c9cec4444bfd9ee', groupName: "sub-property" }, index.h("ir-menu-item", { key: '71cba7f3c8b0c3a90309bab1d70a237e1ff32d5d', slot: "summary" }, "Reports"), index.h("ir-menu-item", { key: '5ec7d09934c1c96f669f2bb7232938a1898701b9', href: "ACHousekeepingTasks.aspx" }, "Housekeeping Tasks"), index.h("ir-menu-item", { key: '89b7b6cfefa9e431207558840e4bcd927e00ec53', href: "acmemberlist.aspx" }, "Guests"), index.h("ir-menu-item", { key: '66f3e158774cd7131dc72587b39ded2ac808b969', href: "acsalesstatistics.aspx" }, "Sales Statistics"), index.h("ir-menu-item", { key: '5d3a9245ce830864743fd0956ee917a2c3e8976f', href: "acsalesbychannel.aspx" }, "Sales by Channel"), index.h("ir-menu-item", { key: 'ed090f3f6b40018aaad51fa89dd5e33cb6094a3d', href: "acsalesbycountry.aspx" }, "Sales by Country"), index.h("ir-menu-item", { key: 'c1c67fdc978dee098516df303a3c90286b6ef698', href: "ACDailyOccupancy.aspx" }, "Daily Occupancy"), index.h("ir-menu-item", { key: 'dd3ca0d3a0244a763b32c67b1982c622c98e2386', href: "acaccountingreport.aspx" }, "Accounting Report"), index.h("ir-menu-item", { key: 'e0a199f278c7aa62e7dd6b004d582ee9ea7709e8', href: "/", selected: true, id: "hello" }, "Hello"))), index.h("div", { key: '847a3964b8c9ce72af0fa9720b7c69bc769aee62', class: "menu-footer", slot: "footer", style: { textAlign: 'start' } }, index.h("h4", { key: 'e6326828342eb43cacedeaf756ca588dd3bcc297' }, "A35"), index.h("span", { key: '61e67f2c1f81a32af7f493e26964654542cd58ab', style: { fontSize: '0.875rem' } }, "lorem@noemail.com"))), index.h("div", { key: 'a38f5a329a254eb9eadcf814367adc00970bd096' }, index.h("ir-pms-payment-due-alert", { key: '58eadb2c968310a85798854568a599ee3da381ff', propertyid: this.propertyid ? Number(this.propertyid) : null, ticket: this.ticket }), index.h("div", { key: '34efeb0069ecbe41214c4b9ea3e4c7ca1f9bad13', style: { height: '200vh' } }))));
    }
};
...
const IrPmsSearch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4dcacf6d9d496724f33011f7da18db5025ffb262' }, index.h("ir-autocomplete", { key: '7b2a4fa8e90058a612cebce07cd3c595f570a587', class: "pms-search__autocomplete", placeholder: "Booking# or guest name", ref: el => (this.autoCompleteRef = el), "onCombobox-change": event => this.handleComboboxSelect(event), "onText-change": event => this.fetchBookings(event), pill: true, appearance: "filled" }, index.h("wa-icon", { key: '2bc87534d20213b4ab232a281af43b2115740ce6', name: "magnifying-glass", slot: "start" }), index.h("div", { key: 'e1bf5acbc66fa3704562a5585d03fb521c366d9e', slot: "end", class: "pms-autocomplete__end-slot" }, this.isLoading && index.h("wa-spinner", { key: '0e41baa5321d37e778876ed466a11cd6c6256beb' }), this.shortcutHint && index.h("span", { key: 'b8db0f678d0c7be0f73021bb36f29de3ae532505' }, this.shortcutHint)), (this.bookings ?? [])?.length === 0 && !this.isLoading && (index.h("div", { key: '08bac14c0cdef8cd7625224a529e31f863ab91e3', class: "pms-search__empty", role: "status", "aria-live": "polite" }, index.h("wa-icon", { key: '5bd1d36854a295643670491d7b5f936122d4ca69', name: "circle-info", "aria-hidden": "true" }), index.h("div", { key: 'eea679efa94aa0ee8ee7c775555fbc9c32058421', class: "pms-search__empty-content" }, index.h("div", { key: '961ebead306631af5491d32e2b2c99041c548c7f', class: "pms-search__empty-title" }, "No results found")))), (this.bookings ?? [])?.map(b => {
            if (!b) {
                return null;
            }
...
const IrPropertySwitcher = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3a82c5b6727dba1f974c3a961ebf484eedcc7e4c' }, this.displayMode === 'read-only' && this.renderReadOnly(), this.displayMode === 'dropdown' && (index.h("wa-dropdown", { key: '8df1a604540b33cf0604a6de4ded2a80a67c2f01', "onwa-show": () => {
                this.ensureLinkedPropertiesLoaded();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            ...
            } }, index.h("wa-button", { key: '9ce84618a2e2023e654336541e8849f794eb5156', size: "s", class: "property-switcher__trigger-btn", slot: "trigger", withCaret: true, variant: "neutral", appearance: "outlined" }, index.h("p", { key: 'dad952a01e31f77cb44dc754d301ce3d73bc4717', class: "property-switcher__trigger" }, this.propertyState.selected?.PROPERTY_NAME)), this.isLinkedLoading && (index.h("wa-dropdown-item", { key: 'b83b7ce2e78dc282555c0a41b305a782ce0e5ab3', disabled: true, class: "property-switcher__dropdown-loader" }, index.h("wa-spinner", { key: '29f59832593c3160e130a52b70f483e7bed15819' }))), this.propertyState.linked?.map(property => (index.h("wa-dropdown-item", { value: property.property_id?.toString(), key: `dropdown-item-${property.property_id}` }, property.name))))), this.displayMode === 'dialog' && (index.h("div", { key: '898a765567a84f58cc94daee188176d822b5ae29' }, this.trigger(), index.h("ir-dialog", { key: 'ac36e31437650457d3a7008b1e7a8bd353244a4d',
            // withoutHeader
...
const IrPropertySwitcherDialogContent = class {
    ...
    render() {
        return (index.h(index.Host, { key: '341b64231177182ddddc5f85267e3b35724b6f2f' }, index.h("ir-input", { key: '51a930b1167e71f0e42a10a468d47e8bc78167be', autofocus: true, ref: el => (this.inputRef = el), placeholder: "Property name or A number", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), index.h("div", { key: '33e5005bb1ef13a2c7b1f45bc994949910202768', tabIndex: -1, class: "property-switcher__results" }, !this.searchTerm && this.properties?.length > 0 && (index.h("div", { key: '977e6142f0002b7fb48dcb44513fa856542705d6' }, index.h("p", { key: 'f41a18d92aacac4962841ccc87851e0d3f4281cd', style: { padding: '1rem', margin: '0', paddingTop: '0' } }, "Linked Properties"), this.properties.map(property => {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6d6885baf66bb1392cc2b1099968ad6148122d24' }, index.h("wa-spinner", { key: 'efeffea080f920109669d84019036f31a79c43c5', style: { 'fontSize': '2rem', '--track-width': '3px' } })));
    }
    static get watchers() { return {
        "size": [{
