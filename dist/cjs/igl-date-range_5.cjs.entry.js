...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e595d23b87769f63a1b46adfacfc62a5d726077e' }, index.h("div", { key: 'aa09059c1167411703ab8e5440dbf7996bf7b1dd', class: 'd-flex align-items-center ' }, index.h("label", { key: 'e95aac52d92901dc8a70d87802836882ed8deb47', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '28a096db870aaf00827c71f9f919180a0a26b829', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '29d738e00d0c8860301b0dea82028b4b25245634', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'ed020ab980eb944e3dac9fc121de6f967a3db915', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: 'f455ecba783a715846b6657ce132faf5aabeebb9', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'dfd6421bd6fc2347e13adbaa1a60629847db6448', class: 'sr-only' }, "clear input"), index.h("svg", { key: '138879a95b21227ece5b9d3722ca03af80953a1d', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'aed5d3b53494d4253f4994f81e39e9e6b41b09b2', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'ef30f7bfdacd2f896eef023f9ca9cbec12f1b287', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: '7f1d04daf04c3642f08ed23a899c6a929bb388ce', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, testId: this.testId, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), index.h("div", { key: '9d11df92490dd5974558c3d0b9861bf909d3a782', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '2f3ffe12022ac68d3a1bb9101a3e1aaa9f63776b' }, index.h("button", { key: '02ef1896a13a3a7f5ecc0cfe692f3d3167fa5fc1', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '9f6417561b94ee7146bf6a93b3cb677dcf24bf79', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: 'fbceb99f4bf1a82dc14f84ab8b8b40de952b7464', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'f6be359ce636a3205035da97cc0804d7420f5207', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '27bba5ea7d1ccf6e58eef918787158771f880913', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b72b6f8d54df4d07391f92911d32aff63048ab16' }, index.h("input", { key: 'ef23bbd71a76dc94254df9e7a881730c3cb02124', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
