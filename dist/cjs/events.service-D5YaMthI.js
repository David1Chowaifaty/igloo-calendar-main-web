...
class EventsService {
    ...
    async reallocateEvent(pool, destination_pr_id, from_date, to_date) {
        try {
            ...
            const { data } = await axios.axios.post(`/ReAllocate_Exposed_Room`, { pool, destination_pr_id, from_date, to_date, extras: booking.extras });
...
//# sourceMappingURL=events.service-D5YaMthI.js.map
