...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '20fc3749a6898a89658b48f1c2043fc30055f0fe', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: 'ccfc7e4dfee31a9fe95ac40aaebd36c4e00b02d2', class: `bookingEventBase  ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: '70044e91516b77d92f2b936822e746962f8d0a67', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '03f9ee2c2cbfb884a9664d4d625e7a85b3571849' }, index.h("div", { key: 'd6d8e0dfd0d9edb5a5ca25b611fe3e6b22f3bc47', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'ed7f5454a6ec938b4e6a1246eb2574cbd156a02b', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '84038df49f7eedf9faa511d696aea0a1142d585a', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '20c63c11b8682add0f805a962c4f47cf2abdc277', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'e01ec4fb0eb833462bc88fba6648ca5d2e592233', onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (this.isLoading) {
                    return;
            ...
            }, class: "px-1 mb-0", label: locales_store.locales.entries.Lcz_BulkStopOpenSale, displayContext: "sidebar" })), index.h("div", { key: 'b1b0fa41ce251e79a734e8ca4f796759d1c20170', class: "sheet-body px-1" }, index.h("div", { key: '647bb5764a8a1ea4d750b7bb3e44bdf6ed1708ec', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '342b8cf0041eb4ebe92a1611ecaa0e208897082d' }, locales_store.locales.entries.Lcz_SelectAffectedUnits)), index.h("div", { key: 'aeca3897312457d8845815f453b94f154cff1663' }, this.errors === 'rooms' && (index.h("p", { key: 'af87bdce44341448383d636baf28f865626d1645', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: 'afb068503f91d5ff732548cc6fbb5e26022059e2', ref: el => (this.unitSections = el) }, index.h("thead", { key: 'aa5f756836d53c03df840adb388bfd4fe46a5ded' }, index.h("tr", { key: '3c69419272442bd7d07bd774d0879919195826cc' }, index.h("th", { key: '0f72fec7f9e7df37d94ec82fc9ce7ee10f95619f', class: "sr-only" }, "choice"), index.h("th", { key: 'f852541fe355d6e836a06e7e134e373550942ec9', class: "sr-only" }, "room type"))), index.h("tbody", { key: '68d115a44376dc809afd6f8127e99f8baed6e791' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '4c83109cb466243a5f524fcc04b6c2f51d497268', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '23a42a61fe1d59be548d262f450497e4bc90fad7', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: '427f7405e71add2727a22038a70bf6b4621ca2bd', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: 'ee36946240ee5f04e4c1b158e26caad83a18b708', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'f4d8f60bb950934c1aa3a06ae0a66c78f9d04de6' }, index.h("tr", { key: '61cb3fa368057a6438bbc4bed73a7190509a8ede' }, index.h("th", { key: '7bd45008ca1ff10d552b9597267af93a978f098f', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '3ffb7669aeca4861af6cdb986b7c038c70ad3971', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '968760f473c17aba1231b51e2b8cb639cc60d01a' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '3b16caec87da68b4341560adce6a7f88583b6677', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: 'a5e8d0922f64a26f38b24d118674611efcc39010' }, this.dates.map((d, i) => {
        ...
        })))), index.h("div", { key: 'd7b420b7994305ee89069ed2610788e64d822743', class: 'sheet-footer' }, index.h("ir-button", { key: '3bbe89f795dcf81a66f6ef0ec8952d192efa4cba', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'd58a154809aa0f0912100956575cc88ce4222675', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '505530ad5a7efcbd49b37c69d2dc99c29a5541f2' }, index.h("div", { key: '80a05aaf673aacd9ae7bc4aeb981987cce7151c1', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: 'c68e07eeec1f04833cb1ae4f9c90e712cb04a286', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '83143d272b2c04c57d75f2c369dd6093a9a5c825', class: "footerContainer" }, index.h("div", { key: 'b1656f40cc4be3e9db26464f03409ccb2e480b2c', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: '9652e43d4340f425e0dbc2a37e4a5ef21d5fd091', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: 'c2a73bb04a05e330ce6279c50abe572814a332e5', class: "la la-square" }), index.h("u", { key: '18f0afd7e873650ae446729f0f8ef58acb7f9b4e' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: 'caf3438686a703073132ea283a8e60c4851c3660' }, " - v1.0125"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7fc9ca3432e86e6d40fc8d40df87b953c6e116b5' }, index.h("div", { key: 'c94b2fc09076f2276e1510de53dffa39b834ab73', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '7b6c30a6cc50c20a83f80b59a5113193c4137417', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '1d34332708234cceb900b9eebce769af0e05c3d5', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: '68e3d6d789ec5bffa9a8bd50bef06a4e0d5ebc9a', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2095ad61e38a5e7cdce9a44ec66d33317623aec2', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '0d85f37c7fdfb6aef31de12014329ba8330b903a', class: 'w-full' }, index.h("div", { key: '85846211649baf493f46746d0b96d3e6ab95a1d6', class: 'w-full' }, index.h("div", { key: 'bdb5676d30b38d9da126c3ff3bc8c5f5b9ac7bbd', class: "stickyHeader pt-1 " }, index.h("p", { key: '50df8974c6e8f1a5dc4bec5274e0cbcd234f4b8b', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '26246e7aaa339064af8d02c96a8c00860dd3b719', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '59d289c25e5900796e9192bfa6d6606c6440dcae', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '279f3dd300c61a07eabba3c9a2ddc833ee481881', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '7582ddc55925003b9180484666af666fd0a4e6ae' })), index.h("div", { key: '91df73f41832d4b8748143926069fe285f4376af', class: "mt-2 pl-1" }, index.h("table", { key: 'dd754219a23fdce1368afb89964cd2da4dd3e632' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: 'e8d4dc2a927c585194d803f93e2d00d5c3443892' }), index.h("div", { key: 'c0f6e5dea10693b99f67cee1410a24a222cca205', class: "mt-2" }, index.h("div", { key: '23222c146c739d45280ff4948d036aa7d0b359d6', class: "legendCalendar" }, index.h("div", { key: '23caa923ef9e3ab130bce65e5a82bb9cf1fc87e9', class: "legendRow align-items-center" }, index.h("div", { key: '557f5a803aa8006fcd756b1208e0eb7524b8a439', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '6f0fcfce9a9959d3c3e3f22a6fcf5e14b706c7b0' }, "MAR 2022")), index.h("div", { key: 'd2e711b6e89e4f2a202643f0f18d79f0d697d396', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '6fb38bf0f94d2adc84aa49f7fd7d310e773740b0', class: "legendRow" }, index.h("div", { key: 'a71f79e00e1c30e20a08eb97135b9cd3eedda618', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: '55d7d3b1074f66ae42aba501195370326f1928f3', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: 'e4c0d3d1f91c2a34746e6f52df4ed931e21da195', class: "highphenLegend" }, index.h("div", { key: '03be88f3ed228d0a8bfb4a23ca614476731e2880' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: 'b07099d143d8fa3d730d0b1a87be330208900a1e', class: "legendRow" }, index.h("div", { key: '13bc3621222d62b3e318fd1206cb6e2a649d2460', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '341c5e2072743eee65e5642b45eb3a427d2a224e', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '598a75eda2006a18f27fd4c4324fce68d53475b2', class: "legendRow" }, index.h("div", { key: '5029721ba51bc3e7bfe5aa14e8a2556b8eea8799', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'b98aa370434bb42d1034c3c313a258f84f88addc', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '24675011f52f9bd490db133d4b1aa5d9e38b3c0b', class: "legendRow" }, index.h("div", { key: '1c4016fd494906fc62f1e901903133c7937f71c6', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'b12bca4565ce90351d97f185574573375ee0bf30', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '92a0cc7e9707f3aee41687d3d193902d28e8e1d6' }, index.h("div", { key: '0ef0d90c55b7448910fa74075610904a9ef18ff1', class: "sectionContainer" }, index.h("div", { key: '6ddf9259a3ccdc5c59e343c586b0dd59eb5b5046', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b51fe06895ac5eb5453f2f1a04ea7198edfd7f1e', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '6149821b3b97135c11022a6db770f2d993ef0c82', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: 'd06391339b3723cda98ea9ff525d79d2941dfc1d', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: 'd83f3c7def1b59a21c8daf153c58f1eb50b1e026', title: "This unit is dirty", class: "hk-dot", style: { flexShrink: '0' } }, index.h("svg", { key: 'f89176155bd2b9a31b28fda4089bd95e2f058f86', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512", style: { display: 'block' } }, index.h("path", { key: '12c9b00e5bd3b2982541f56abe6233ed10a9bd78', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
...
const IrWeekdaySelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '20b78cb72b750272678831d2bb47a07ccc8862cb', class: "my-1 d-flex align-items-center", style: { gap: '1.1rem' } }, this._weekdays.map(w => (index.h("ir-checkbox", { checked: this.selectedWeekdays.has(w.value), onCheckChange: e => this.toggleWeekDays({ checked: e.detail, weekDay: w.value }), label: w.label, labelClass: "m-0 p-0", class: "days-checkbox" })))));
    }
    static get watchers() { return {
