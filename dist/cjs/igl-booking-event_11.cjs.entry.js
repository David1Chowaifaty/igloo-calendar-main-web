...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5675b5a4092559be073dacf6d591f7aa81430923', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: '6176c37041e85631642c11bbaa423dcae2f24910', class: `bookingEventBase  ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: '2adb29d1ce12def664de83a072875e999c0b20a4', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'aacce4b5eed4affaa34336f24b2615f6bc350fc3' }, index.h("div", { key: '24a32721dd7c9fbe2ce10bc006cd366e951d6aec', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '2e2e54c8e12968ae245c8758cb1779bb7dacf0f0', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '111a2c046421d9fc4be74c0a3187e70fd78e496b', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '1f26750cf78bf6ecaa00b5e6eab8dfb394fac2a7', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'a60f9250ebed5139951ab302bfd0aa2e212cc90f', onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (this.isLoading) {
                    return;
            ...
            }, class: "px-1 mb-0", label: locales_store.locales.entries.Lcz_BulkStopOpenSale, displayContext: "sidebar" })), index.h("div", { key: 'a42c32b352c4f1689bace52585600d642d16ef58', class: "sheet-body px-1" }, index.h("div", { key: '57ee5809f13cfc6e91a638e523b819804d409c36', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '4a4470a9d2039dd6781cbb1727876ef82c14a8c8' }, locales_store.locales.entries.Lcz_SelectAffectedUnits)), index.h("div", { key: 'b8632c8a45d9c7ecd6b152fc4874cf7e22e60126' }, this.errors === 'rooms' && (index.h("p", { key: '428ad7e161ab513bfaef7fc5ff5b2341a539351a', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: 'e49e3a55da0fbd032041abf6bc56af9c77d1c4be', ref: el => (this.unitSections = el) }, index.h("thead", { key: '7acb65d052ef5962f9d6fa1b9fa9bf2410ad2593' }, index.h("tr", { key: '8f3d78c6a07ad34749c8cd3d843674113c3aa962' }, index.h("th", { key: 'a5190f687b9b9aecf1e39bd9eced9b9a239d0e28', class: "sr-only" }, "choice"), index.h("th", { key: 'dfaa347c5e5173acfa3f6110118699b34d11ecb7', class: "sr-only" }, "room type"))), index.h("tbody", { key: '582bcab93335bde0f0deb256d1f44630080622f4' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '5fde4c16c89cecf282e8f4377f45b19bab276bab', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: 'e74d66d5319e1bcb7894f60d613dc8699bfbab72', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: 'e3a6cf6076d24732fda59a0504c9b7c753af567b', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '7638e40aebf0e4a370739e0758c7b294c5e96505', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '88da3fb385694d960841dc81490928878d3f98d8' }, index.h("tr", { key: '6cf17f823a4bf8974e75d4a63d9c08219303be6b' }, index.h("th", { key: 'cf03318e53d1126814ca7b422e69fba2ec048cb4', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: 'ca7f6c55eae2fffb753cca16f9c803bd4e1313e0', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '93d374163ce67a019cb0e74dcb897e81dc0f644f' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: 'c19354fdd4ce0e551da7447ea5f58e5ff4379ad2', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: 'dab015883b4bc900d7b983609e12bda021ed5c97' }, this.dates.map((d, i) => {
        ...
        })))), index.h("div", { key: '7ed78ddc96f62ba492dbc4ac3dd3ba5424bb4511', class: 'sheet-footer' }, index.h("ir-button", { key: 'ca580da8881f653d095ec4a7b1bf9fd0757403e9', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'ceda9a1014a397b543f5c28beedc4a3e77c597d8', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '559aa3a6165c22a3d01cac12b53d25c27037f600' }, index.h("div", { key: '2cac3111b1085526d5bcbbde507a020a5103912c', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '4ef78bdd7f9480f045dc855cb2d40501496eeb9c', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a4e961812cbde06e6bd60e184308553915c58210', class: "footerContainer" }, index.h("div", { key: '514a02909babbfb6e3d98fcea2a51d773c295c6f', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: 'a86795edbfed19fa6166702db10f1fb70905dcfe', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: 'a2d817fac3a93243ea308224be7f303a1b664dc0', class: "la la-square" }), index.h("u", { key: 'b757e42c3c05115cf6ad513feb537be28d8deb9c' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: 'a71e453a2e91ffd76a6f48b291edf14925fabe6e' }, " - v1.0125"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a13c170b958c41aae04d845f1c220a19e986ddd5' }, index.h("div", { key: 'b14a4d8ae9e79e643c66c94778aeedb6a04fa463', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '685d42d2a1c4dd573a623177946dc20b43e0f45b', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: '28d9d2bf2a961a1a1fd416bcac74ef8859c5c204', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: 'fe44aa88c8d10d68c9ae30e3b660074e1971e8c2', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '83cc7255a4168c62fcdac388fab6c83f15682add', class: "legendContainer pr-1 text-left" }, index.h("div", { key: 'b0cf9dc26945f044c6a393aea4a353842fcdd000', class: 'w-full' }, index.h("div", { key: '2cb56bd39f643253dced02a5767c789d50e11d63', class: 'w-full' }, index.h("div", { key: '19decbc347b9849b64fece054231441f76ddaba0', class: "stickyHeader pt-1 " }, index.h("p", { key: '08da7373ba6e497fd5ee77f6249375ad5321419f', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '9aa2ddfda65b1ec6a653a14b900a61886aa8c494', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: 'ee865f7f1cb8795db75205ec874311cbdf84c8e1', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'a72ceb9be6b4cb0b36b81506072be68d4ac92691', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '3c5dd29f340b25b618c1dd185280f4d3563f81c4' })), index.h("div", { key: '959df6e6433b6ae7cf2d021518dee64220992d8a', class: "mt-2 pl-1" }, index.h("table", { key: '95f78baf81334e74e0964ad3cdde435aee519570' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: '0b4af14d75613d37b4c5483b50cfbf7e553d10b1' }), index.h("div", { key: '1efe0c61c34f6b2ce6f827f599a3ae9b659c2adf', class: "mt-2" }, index.h("div", { key: '6f41dc3fcfbffb89496a22dd2f103a2bc19e97cc', class: "legendCalendar" }, index.h("div", { key: '98e100a816e71a077972b3c82915e457d8be9be7', class: "legendRow align-items-center" }, index.h("div", { key: '54e0afb2f21f5fce0658668818cd5a5da67d2480', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '9a252bd5d2d52ade62be9b1cc0a932c9dae236b2' }, "MAR 2022")), index.h("div", { key: '5562611d944a834737b138e0283eb89c9735d0e0', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '2fe262d37b471278bbc0b94be68e9501259cb26e', class: "legendRow" }, index.h("div", { key: 'a5ca531bc453d9547d5781c0351104e13d060de4', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'c10b02e81595e5ed4db81c33ae78a157f3ba0095', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '429a996f4060af47860e388eb6c3d96b964af585', class: "highphenLegend" }, index.h("div", { key: '1ba3e29ced4b4b9304f98075a58a6cb3525c123b' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '7438431ececf71bdef13e63e5ad4b0649f134847', class: "legendRow" }, index.h("div", { key: '60325c6e41bf53282ce464a1ec3876315300afee', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '30f0572b2a6f6e040498dda96ab77bcf907d004e', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '4e95ab177ec054ceaa4e726bb44353e775e4bfb9', class: "legendRow" }, index.h("div", { key: '498f89504e72bba677b28872386b9714e3d8918c', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '69c6c38c8641df1e43e4cb6da8c765b9cbabea32', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'b41b4c688d655c08b2d6f60ccf7da1c0025e064c', class: "legendRow" }, index.h("div", { key: 'e03bd0744d9d7af0151bc7d0134afd25054d152a', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'f7b8e7093a391ff3915d530e4b44ae1a77fc3235', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'b44c1049387cc9104836ead0c3215a68c6533737' }, index.h("div", { key: 'ba074b8a4db8ed114cef9ec7a82bfd64c6ebc7fd', class: "sectionContainer" }, index.h("div", { key: '253ee357111ea01a3a26a37bb32c7125ec943b50', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '54503363cca9baa0cdd4ed474da6036f88e5359c', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '4fca2c4cc760d4528bd358221db129e73b3029fa', ref: el => {
...
const IrWeekdaySelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '80c330c72a3d09e6e1d2e1865abd38c37bae8cb5', class: "my-1 d-flex align-items-center", style: { gap: '1.1rem' } }, this._weekdays.map(w => (index.h("ir-checkbox", { checked: this.selectedWeekdays.has(w.value), onCheckChange: e => this.toggleWeekDays({ checked: e.detail, weekDay: w.value }), label: w.label, labelClass: "m-0 p-0", class: "days-checkbox" })))));
    }
    static get watchers() { return {
