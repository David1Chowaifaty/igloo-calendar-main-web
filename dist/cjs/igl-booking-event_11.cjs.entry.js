...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '24db8a532e2f61b373eab44b0dfaa1cb07cdf020', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, index.h("div", { key: '674b6c034bf84b3c7667f8b3178abf9633f5bdf6', class: `bookingEventBase  ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
          ...
          ${!this.bookingEvent.is_direct &&
                ...
                'border border-dark ota-booking-event'}  ${this.isSplitBooking() ? 'splitBooking' : ''}`, style: { 'backgroundColor': legend.color, '--ir-event-bg': legend.color }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, balanceNode ? index.h("div", { class: "legend_circle balanceIcon", style: { backgroundColor: balanceNode.color } }) : null, index.h("div", { key: '78259249cd8c6c3523ff9e0259924b5b0b6416d6', class: "bookingEventTitle", onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '0012348418d20e765bec3e87178891ef4d082f3f' }, index.h("div", { key: '9c11363f01801b2f48a736b2c99b541de3edf449', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '74ae103afda80c6af0c2b6a0d9d96124b149513b', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: 'a0f62d89627e57b0b4f1ad60eb9d159c7a4ee38e', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'e8d6c0f9f4fd0ac7735a48c82ccf01b93089863f', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'ba795d460a3d5f96150632660d6c50d56a21223f', onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                if (this.isLoading) {
                    return;
            ...
            }, class: "px-1 mb-0", label: locales_store.locales.entries.Lcz_BulkStopOpenSale, displayContext: "sidebar" })), index.h("div", { key: 'f0395ff05d7d4fdc3eef2002c1312e239fea5f01', class: "sheet-body px-1" }, index.h("div", { key: '978ee6605eb9e418d093e58b0c8a57c3a5cb3f89', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '5f069f10ca3112471afb1c4b8e2788842575c7f7' }, locales_store.locales.entries.Lcz_SelectAffectedUnits)), index.h("div", { key: '1c59009d4e4bd5f09db1fcb7bf3521a55fdfecb9' }, this.errors === 'rooms' && (index.h("p", { key: '8ed1401304636f80d04ff627e1cc7f584e041b7b', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: '9e722c5a570a49a9dfd5cb65b92f9e7726e7cdd8', ref: el => (this.unitSections = el) }, index.h("thead", { key: '5f577bc3d4ed4ec4746d898c25920fd91792bf35' }, index.h("tr", { key: 'd1dc9bf70e6e4a13eb8368edb668c7ce3a24c41f' }, index.h("th", { key: '70f0936bee82e88c7f418ec9af0fa4bb5ae085b1', class: "sr-only" }, "choice"), index.h("th", { key: '50d7828acfd007966589929fd43cd11e99c21e5f', class: "sr-only" }, "room type"))), index.h("tbody", { key: '3ff7fb890d7358a54688d098c938dbc68cbdc17c' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '004959822fc09d9b52033d4a49f062811a118159', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '0ff4edbfaa902e52c8425ed4ea94b904e41f8e1f', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: 'a53e78c17634936b241244fc3bf77445968736e8', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: 'c6fc2d1b9eaa57ce471e48eb6d7838309ba8103b', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'e291ac470d1eb8fdc5346f69e57ca571f04631d7' }, index.h("tr", { key: 'edd074eaecc1a533e98d0bc70528623a3878e686' }, index.h("th", { key: '73026fd63de1af4d5fc26e4f06dbf9cc073b2d75', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '85ef8dcb59075489725f5844b21652a5fdb5a07f', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '37dbf00361f1e2e6bb76665c6bd4d5440d7c93e7' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '8e548cc05aaf2161768004eb847ec6072e020027', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '80d7290ef51100a1391ad3a70c2717b517bf24db' }, this.dates.map((d, i) => {
        ...
        })))), index.h("div", { key: 'ea2b551df3aa214bc46be1a2e6ccc0504f55c6a4', class: 'sheet-footer' }, index.h("ir-button", { key: 'cde0af3e70e90e2195f298f7daf863b6df2163af', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'ba1cd23a47d6bccb6ce077480282e77964a7eee1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h(index.Host, { key: '3b77b52ead76e33806ca6abf0bc91c9de197ca5f' }, index.h("div", { key: 'b9ee49753eaa46d4d29d813cb693a133f2598c61', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '6c543a29c006842586339f32759fed26adfd027d', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '44d02bdc8ae9b0594afb54e54860b7756d3635e3', class: "footerContainer" }, index.h("div", { key: '25c860a857243562fd402c113d8637e3aea95bab', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, index.h("div", { key: '6d24f163994f4e694a2916e8c9ca2bdd10254899', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, index.h("i", { key: '0188a6080675fa62e782bea83e30e0e5cafe9378', class: "la la-square" }), index.h("u", { key: 'ccba7ed6bd0ddecfcec3958c1e94ee8e186b6119' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '1fe2ac53ea8c3667cb04e73973808cba262cf8e5' }, " - v1.0125"))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
};
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '225c1b5c339f51165a4d95c2d4f099da3176813f' }, index.h("div", { key: 'b8f543760b98d63b7513bc41f016d8c4a11ce8f0', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'f31380fd2ce0b635d9df6911fdef6f5d60c73a2d', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: 'a606be4ff625d354ee813cc35833b198dcb50c56', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: 'a3866a08509dceb669773545191640f05af1974a', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f7dc39f828acdd87a08c2e3a01663b431d1d62eb', class: "legendContainer pr-1 text-left" }, index.h("div", { key: 'ddd590a13f6762f4ee707397ab5da9089708fcc2', class: 'w-full' }, index.h("div", { key: '92a8ed997b4d817372ea8454a296f54901de8efc', class: 'w-full' }, index.h("div", { key: '7f5a3b6b4f73b1f3966087a426e2c172f0ec6584', class: "stickyHeader pt-1 " }, index.h("p", { key: 'e940adc055c3669d1f8119f13bff34e386590fae', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '1c4b5b8e034736249033252a3065778bcd50c115', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '73e9b3122a359f9e084b5dcb12e402a5b136d701', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'cab7748859b876d8db1c69be6b3dc749ad84857b', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '7ea00e170695a3044f97dca90fc8201239b877c5' })), index.h("div", { key: 'e1d0387913ac3b24e62b1b76f31b25cda53db9c1', class: "mt-2 pl-1" }, index.h("table", { key: '92f9f243041b88229bb97f0c4706bc1bfa9b427a' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: '2c7a8da10d26a154e122e7388282f18244491ae5' }), index.h("div", { key: 'bae46e9befeb31109659487430cde4c828f32603', class: "mt-2" }, index.h("div", { key: '0e3d1f479be1343304502bf13325b50326dbe51c', class: "legendCalendar" }, index.h("div", { key: '636c637ab485eacae717922d5dccc29f0674e84e', class: "legendRow align-items-center" }, index.h("div", { key: '1478685b283b591ea180633a02572d89b615b0ac', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '7acfbb8f046bee9b1a193f64f5e598d261fca27f' }, "MAR 2022")), index.h("div", { key: 'd629773ab4f11a893fd4be46eb7288b06ac6f815', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '604b99ca077359f4fc5e97016cc905b73544baac', class: "legendRow" }, index.h("div", { key: '6cff2148b46ada4c1fd9fad5ffd87bf1494763fe', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: 'b311b93373527f40b0dd71781cab4ce3e593fe40', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: 'df34e9e1105097a250d29cad0979d615bbd18234', class: "highphenLegend" }, index.h("div", { key: '473f85e83056d6ca7ee531a06b221c3e04ceaeae' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '1edcedad106c37102f75f8f16b193775049ad6b1', class: "legendRow" }, index.h("div", { key: 'f038e480b261f21b957e6bbaabafa12ea06668ae', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '94b93a894d05bdcf08ad99a453995e6557797a77', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '7135ff7cda8fd0f04101133c28bf54c07a7b8b62', class: "legendRow" }, index.h("div", { key: '4de93e6ab668c6d05b15a5327c86b607e5f8f204', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: 'a100027809bcf31b170408c20ec3cc01f1883fbc', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: '942b6c682911d458700970a496795d83ce9476f3', class: "legendRow" }, index.h("div", { key: 'f003fd51e3ff002bc76d4bf46f822b57474c03b0', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '4b86588f7946aad85047d96a53545ad0c949171b', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: 'a17933ed6d60abffaa6ac0e7052a03ac12ec4f6c' }, index.h("div", { key: '467f73fb4feb14011708f54d6347a05335199ab3', class: "sectionContainer" }, index.h("div", { key: '0914c70fda43cc61c436464fe30a1e3f8bd06ff6', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '10cb46a2281ac3a4e0244ef6ecd82718b3a15891', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '396304eb3f84c90344dd8f8b69e20f7015cafddd', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '886922e9f274830f8c6c19bb7de2907f02d2cb65', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: '57d620cc4e24328c9531bc4220789f828f7e54e5', title: "This unit is dirty", class: "hk-dot", style: { flexShrink: '0' } }, index.h("svg", { key: '9b9440fbcb1c8e928d2e1c7d02787f241affb346', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "13.5", viewBox: "0 0 576 512", style: { display: 'block' } }, index.h("path", { key: '0a545cb836cbceb358c2c77d3df3202d9d2abe39', fill: "currentColor", d: "M566.6 54.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192-34.7-34.7c-4.2-4.2-10-6.6-16-6.6c-12.5 0-22.6 10.1-22.6 22.6l0 29.1L364.3 320l29.1 0c12.5 0 22.6-10.1 22.6-22.6c0-6-2.4-11.8-6.6-16l-34.7-34.7 192-192zM341.1 353.4L222.6 234.9c-42.7-3.7-85.2 11.7-115.8 42.3l-8 8C76.5 307.5 64 337.7 64 369.2c0 6.8 7.1 11.2 13.2 8.2l51.1-25.5c5-2.5 9.5 4.1 5.4 7.9L7.3 473.4C2.7 477.6 0 483.6 0 489.9C0 502.1 9.9 512 22.1 512l173.3 0c38.8 0 75.9-15.4 103.4-42.8c30.6-30.6 45.9-73.1 42.3-115.8z" })))))));
    }
...
const IrWeekdaySelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1f5878b5f4efcd04461923367ac4528d6b6960ea', class: "my-1 d-flex align-items-center", style: { gap: '1.1rem' } }, this._weekdays.map(w => (index.h("ir-checkbox", { checked: this.selectedWeekdays.has(w.value), onCheckChange: e => this.toggleWeekDays({ checked: e.detail, weekDay: w.value }), label: w.label, labelClass: "m-0 p-0", class: "days-checkbox" })))));
    }
    static get watchers() { return {
