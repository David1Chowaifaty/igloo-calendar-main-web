...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '508601206310673b3b9f22b771c308faf2b32366' }, index.h("div", { key: '9cd70d3a8a3b0828f1eaee1f81f0409a4d109aea', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '8677000b8938a5117c10f115d0731672af7dd154', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: 'dd73f8d1f5eb1843b4ba41413388b408a8901e43', variant: "icon", icon_name: "server", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: 'e47a51cf635a2c89e63aa6f3135976e8f193ff96', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: '4a1bb0deca535124851718afce6c1a97e6676e4b', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: '1aab06125aede9b716be568d77d061b5a43e085c', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: 'c7e6c31bc0712b09021ac51f15fff28ffe2d4b02', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: '73f6465ceab078d4d313959a25975dc6545895c4', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: Object.assign(Object.assign({}, icons.colorVariants.secondary), { '--icon-size': '1.5rem' }), onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: '175db5a3bfc21808ed6889de8bc6294bfeb34668', class: "row justify-content-around no-gutters searchContiner" }, index.h("ir-m-combobox", { key: '1a73eb44c33316f8d7a1d3bb6d7c8c173dfa7d05', placeholder: locales_store.locales.entries.Lcz_FindUnit, options: this.roomsList.map(r => ({
                label: r.name,
                value: r.id,
            })), onOptionChange: e => {
                this.handleScrollToRoom(e.detail.value);
            } }))), index.h("div", { key: 'f92a72dd200f014f6efdb48e39e4487f8ba7b7b3', class: "stickyCell headersContainer" }, index.h("div", { key: 'f43e0aaa7db8323c2a4ad54c94955e3dc6e21767', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, index.h("span", { class: `badge badge-${this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? 'info pointer' : 'light'} badge-pill`, onClick: () => this.showToBeAssigned(dayInfo) }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))), index.h("div", { class: "dayTitle" }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")))))));
    }
    static get watchers() { return {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ed9c0c97c4ac9c2ca0af08dc4afb1703816ad49a', class: "legendContainer pr-1 text-left" }, index.h("div", { key: '6aa97506965e993b903e4a4e333816d4f792647c', class: 'w-full' }, index.h("div", { key: '99cbd4cb14049f543fe27a5dd99001ceb13f9f97', class: 'w-full' }, index.h("div", { key: '49346530e092c10c5d38984743ea934bed959d1c', class: "stickyHeader pt-1 " }, index.h("p", { key: '6aec61cc3a6b06d716e035b013d58562455b54a1', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '1b045cb400e30b9b7548f7f62c124ce83e0cac0a', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '9ee9354ec18d5f303916ae150ee18b24b40bb9d8', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '03b2705c5a94c444b359ce537180d018540a6520', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: 'fab0fdbc2d502e7b5a8df89749d436132166325d' })), index.h("div", { key: '683c21c4ee84aea6e3615742888178327aa73b2d', class: "mt-2 pl-1" }, index.h("table", { key: '82aa053103187b6f7165ad15365b21d755033fce' }, this.legendData.map(legendInfo => {
        ...
        }))), index.h("hr", { key: '3490c9d5668ee7330e9cbe0183001ceaabd8d85d' }), index.h("div", { key: '7318184f8357c79e1a0337e6444c286a98cdce30', class: "mt-2" }, index.h("div", { key: '4943ec2202d8d79adefa622090b260fa2ed82567', class: "legendCalendar" }, index.h("div", { key: '8524c8aa2be86b59392cf34b3309a5c229078b75', class: "legendRow align-items-center" }, index.h("div", { key: '320ca99363bd9bac98733c1d9ff9927b6779b421', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '6b3e491c6bff9dc4d60348be4e682b0beba7f617' }, "MAR 2022")), index.h("div", { key: '3586e7b40ba90d8f6ac9615e7d2873af082fa0b4', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '7097609023bb993afce62e17a7efff50e3f2f978', class: "legendRow" }, index.h("div", { key: '0d8d6063a8ad0f87c7846de37f9d5fbebca263b8', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: '3e007fede4f43179c5817b0a6e39824a26523ee5', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '94e1f225dd1f9f25e12a04ea6d80aad8008e61c0', class: "highphenLegend" }, index.h("div", { key: '84a8b146f48691beef544bd7c491241e3b088fb8' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '9b8d7b07e1ffb6b4fe2467d8c00a350a6161924b', class: "legendRow" }, index.h("div", { key: 'd0ae99df863d9a856d1aaaab3614e154479590eb', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '70e355d40cab1677fb11a33e357f80535165c03a', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'f1bcd03443c5ab1335aebd4b597ebb1abeaceeb3', class: "legendRow" }, index.h("div", { key: '1466b01506242d11ea8add0991cce7de9513aaf9', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '2a83ad42f84b700a52f43896f5a0e42176ddf05c', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'b7454dc46754e8145a33ac6cb5364b0c351c8b07', class: "legendRow" }, index.h("div", { key: 'ae2cad55b490c7f1e32562edcff3e3d3493c3134', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '8e6c52089c8e5c69b19cb710a4a211090ac90474', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '48a2c2689f4b233a84127188ab8fc07197d386e7' }, index.h("div", { key: '0843b560159583127082e1b0fa545817860f0991', class: "sectionContainer" }, index.h("div", { key: '5cd05520dd45eff19ebe094336abdb3c79e40c17', class: "font-weight-bold mt-1 font-small-3" }, (_a = this.categoriesData[this.categoryId]) === null || _a === void 0 ? void 0 : _a.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
