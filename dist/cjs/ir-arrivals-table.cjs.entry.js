...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9d0ecd65cf74564fd3ae3bbe20a2cc57e22185f2' }, index.h("div", { key: 'c6b9527629bc38634ec4d1eb6f4d33d91755454c', class: "table--container" }, index.h("table", { key: '53608cdd173bf67b704d4ba425f5fbf14f1f6e39', class: "table data-table" }, index.h("thead", { key: '6e75c2e2c6ca6f8dec29e4893113222d4b1e7239' }, index.h("tr", { key: 'ddfeed2661690ad6a45970065ff596cf14d22548' }, index.h("th", { key: 'fc112647721e5dc85a8168bc40a5dd7ce3705946' }, index.h("span", { key: 'd39ab54ef6263f10baa8c52f935bb6f13cc2aaa6', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: '5f4b49835682e6f5a1e5654b851480a0cb4948a6' }, index.h("div", { key: '7deb67f76a0190aa218dd08d14b1a90ff47c4ef2' }, index.h("p", { key: 'e52f573f7d4277f7c40bc898c0dc7cc11b5be8a2' }, "Booked by /"), index.h("p", { key: '849668fd68a34ced04061297b57bea347e283071' }, "Guest name"))), index.h("th", { key: '0e77085f398b77a6a057075fabc1c502913cd6db' }, "Unit"), index.h("th", { key: '58b68d146be81f6e778e69ac8c3d927ee8ee4a55' }, "Dates"), index.h("th", { key: '43d7d78b0eb1a35fc0973ae9eb0107527f78528c', class: "text-center" }, "Balance", index.h("div", { key: '9d351fe42d9ba0a1e0ba9e31884591de042d932d', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: 'ecb9438bc0aa2057d0554e4ce29f1c575406dc59', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "s", variant: "danger", appearance: "outlined" }, "Click to collect"))), index.h("th", { key: 'b6621645d5081d1c4deaba02fedbc2063d1fc93e' }))), index.h("tbody", { key: '1edb0f26869fb4fc76efb2a203679272d1c6f128' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (index.h("tr", { key: '3a30c10d2ba3d2f7f498388ed70350883edef102' }, index.h("td", { key: 'ac9f10ea077eb27c0336dcd88e56bb41bdba58fb', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '8ea22e48fd111e87949edfcf736ebe91b9575927' }))))))), index.h("ir-pagination", { key: '1419759d4f0373f8279d111904acf68ce686956e', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
