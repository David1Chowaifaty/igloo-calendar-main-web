...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '44a22f98ade26200167603f0ff7a363719ba69d1' }, index.h("div", { key: '71503de3f18c5de02b729f87539a89f868f90e66', class: "table--container" }, index.h("table", { key: '4eb84bd83ef2b736ffb7ac542c92e986086a6847', class: "table data-table" }, index.h("thead", { key: 'ff9c555a6e390acd8d91eb450fa6f07ca2ae701b' }, index.h("tr", { key: '2d542278dbc30a8b4fb54cdeb131889e650e837c' }, index.h("th", { key: '45d23baa80957dfa49fe39a5941a4dc42974df60' }, index.h("span", { key: '80e5c1b44033ccc45e773636fa3365a40b4ee4a5', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: '4bdbcf988f70a42aaf8fc620274ed735d6a73d56' }, index.h("div", { key: '1827e4b3010953cb03344b547e2ab6d06a187982' }, index.h("p", { key: '473b93eb6423fac4130f365daa397ec4f2c7ae7c' }, "Booked by /"), index.h("p", { key: 'ceae8460ab315c187bcb6512aa94d12d00013946' }, "Guest name"))), index.h("th", { key: 'd7e92358f0842f306322c172f7b66fefc836f2dd' }, "Unit"), index.h("th", { key: 'da654eafe8f928490ae8990b9f48e737938200c9' }, "Dates"), index.h("th", { key: '42a9a35cf3a0096c75e1f491bd86c1e22d756f55', class: "text-center" }, "Balance", index.h("div", { key: 'f0ef54354c34358d3276386e4ebeb7c2325f759e', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: '0215ce668ce8b65af7275dcd05dc16037a9e7eb6', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), index.h("th", { key: 'c9dac8fc85d8f766df83f9fa185c8c2d9e88d196' }))), index.h("tbody", { key: '95a01f0940cfea654d3844a620e246f3ce9204ce' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (index.h("tr", { key: 'd987a3aac6f2b9d57bb853d314b03d23ad8ff87a' }, index.h("td", { key: 'b11704af0499f6990a11ecfd9fca1a7bf4ba4a38', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '16f061ac1d8ef61c01f3b39131ab1c0ba9950c70' }))))))), index.h("ir-pagination", { key: 'e666ebcb934aa40775ce2073f24090517c9be7c1', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
