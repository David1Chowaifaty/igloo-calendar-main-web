...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '14452f5f38b43bb5677f4f5b4751d9ebda69d4ca' }, index.h("div", { key: '11d14348b4c64ca81b2d999fe38ef28a2ca85f10', class: "table--container" }, index.h("table", { key: 'e7667e6bd9d76ae3a437f5824e30416e3fbefc50', class: "table data-table" }, index.h("thead", { key: 'fd38eca93eeeb7cd765398a93354d699d33bef33' }, index.h("tr", { key: '40ba6bbbad1afa6ca885b7347ff8e267bdf2177b' }, index.h("th", { key: '97da5c4c4b3cb83fb88dfd1f05e367d96746cc00' }, index.h("span", { key: 'd2aa6eb5481c44d7c54b021f7bb0f8dcf6088c4f', class: 'arrivals-table__departure__cell' }, t.t('Lcz_BookingHash', { fallback: 'Booking#' }))), index.h("th", { key: '5963bf00eac4fe60642a3168f62ce1b8102f0310' }, index.h("div", { key: 'dd1fb04787741a0b1272e6af63ca2267e295c0e4' }, index.h("p", { key: '0aed03c9de286392744b47abc0c1b8b1a8fd1cf8' }, t.t('Lcz_BookedBySlash', { fallback: 'Booked by /' })), index.h("p", { key: '079fda9142ce184543e912ce5183464ac8e2278f' }, t.t('Lcz_GuestName', { fallback: 'Guest name' })))), index.h("th", { key: '0f78f5a25795cfdb069a3f83230380a5f4965f2f' }, t.t('Lcz_Unit', { fallback: 'Unit' })), index.h("th", { key: '84e1fdfb5e6905cdd919f3c62657883249bc1c52' }, t.t('Lcz_Dates', { fallback: 'Dates' })), index.h("th", { key: '2a444299d3ae0601ec07e1893accc114dfa83680', class: "text-center" }, t.t('Lcz_Balance', { fallback: 'Balance' }), index.h("div", { key: 'f6b9f020d1aeec8c19246744b4287c0da6c0905f', style: { width: 'fit-content', marginInline: 'auto' } }, index.h("ir-custom-button", { key: 'c85527f2ef04955eac9c324eb95b5dba90c9dd6a', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "s", variant: "danger", appearance: "outlined" }, t.t('Lcz_ClickToCollect', { fallback: 'Click to collect' })))), index.h("th", { key: '2f59792f42e103e3b4bae6759920e487dedcbe01' }))), index.h("tbody", { key: 'a00b5e63e5e60b4cc6bd8b74c6b2f6006f9ad460' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (index.h("tr", { key: 'aadd1ccb044745c223cf5ed85dd39038ca80e752' }, index.h("td", { key: 'bfd636a31a8481c9655817103b728f7aa4236576', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: 'ddad750cbe9f218fc91feae8942d0bce72d571b0' }))))))), index.h("ir-pagination", { key: 'c3cf5fd3aa7da5c585c73b4bbed1f33d41b0c2e8', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: t.t('Lcz_Bookings', { fallback: 'Bookings' }), onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
