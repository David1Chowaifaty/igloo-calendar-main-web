...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9b407718ce9e62dce11875d059026592d2bd35f7' }, index.h("div", { key: '0009c298dc3c133c1b9ac7b8ac5e8d2e0aa01c71', class: "table--container" }, index.h("table", { key: 'bfa6a5bb2e133d00878e689c7176f41ff558887d', class: "table data-table" }, index.h("thead", { key: '4307b19310e786c305d299d57ab947dbc035f0dd' }, index.h("tr", { key: 'd345d66946063dccbd78fa663e8ea1046785085f' }, index.h("th", { key: '032e0be8bf8e97a999e4d369713233ba7649a4fd' }, index.h("span", { key: '3010a57bc634676e3102d1f5164f631a72fa7661', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: '7b97a18327b1f2209a48951439fe8c08de7de67a' }, index.h("div", { key: '850c7e48a30ebc63544ac37d8ae161b70335a9fd' }, index.h("p", { key: '8731314834a311b80cf5c46b5beb0d79726aa024' }, "Booked by"))), index.h("th", { key: 'b8aa3626081e8a8502d79270064763120c62ae7f' }, "Guest name"), index.h("th", { key: 'fa38505b2f94fb1b94310656589de447649523e1' }, "Unit"), index.h("th", { key: '2124c4881f542da2cfa2ce49a6ead165ea42fadb' }, "Dates"), index.h("th", { key: '812c010e357a702c79c020b785f156e9c0593e9d', class: "text-center" }, "Balance"), index.h("th", { key: '2012f17678258e14c23dde47706e614695050e0c' }))), index.h("tbody", { key: '04656c01913e44166a19186072eded2cf04e1a96' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (index.h("tr", { key: 'cd4577c52a65f01254f771b76a4c1030565ba9cf' }, index.h("td", { key: '96defca00398a8d24553771be8b6c3f57637f0fa', colSpan: 7, class: "empty-row" }, "No arrivals found.")))))), index.h("ir-pagination", { key: '8589b669a1af1a9ae16245bf3e5f5e3a749f23f2', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
