...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a6908d1b6e34e16b124751a65910617591dd47e2' }, index.h("div", { key: 'cedcbff3e25a51456b81d16b42fa61afeb08193e', class: "table--container" }, index.h("table", { key: '85ed20bb4268abbff32fcf9e859a154c3c5c3be2', class: "table data-table" }, index.h("thead", { key: 'db487345f50e393e76d4305c5111d6daf1e18bf7' }, index.h("tr", { key: 'cacdd0d37467de6ce1c669f762ffd29780329f67' }, index.h("th", { key: 'e109e738b7ec95d0498e4d4121aa3a0fdfea0133' }, index.h("span", { key: '61b18fe7db8ca5ea398af7ecde53bc3f00b30de2', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: 'b074422b7966af2d8d96697b4e4cebead7a9f6de' }, index.h("div", { key: 'ae2252458c5b92be37aa875fe9070a08079223da' }, index.h("p", { key: 'f4e4910c0ee4847bf22df3731856d31a0b6de34d' }, "Booked by /"), index.h("p", { key: '958674bb600e88562e7d458a1cba39251e0b0772' }, "Guest name"))), index.h("th", { key: '88097d947e026e96c25e2f0f2ac6124a31b3e546' }, "Unit"), index.h("th", { key: 'fb35c3d33dcc325a3a424d141fd4a357d57b394e' }, "Dates"), index.h("th", { key: '001538ca0ff71fcfc68bc979bf0145a9df6b4c39', class: "text-center" }, "Balance", index.h("div", { key: 'd889162114e8f6a05a26105202a7a26a82d73a07', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: 'd65e5b20c1c187fa43800920f076221dae861ae1', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), index.h("th", { key: '17bf17a547ec21b736c3648868c729f6872b0696' }))), index.h("tbody", { key: '302301a265d603c2ab2d1e5c597245ccb0890b46' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (index.h("tr", { key: '3e8061261695ad483b8cc056471acdfe26533a4c' }, index.h("td", { key: '4d4b0fd93914c4c2ac7ee2e94b862fbeede429d4', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: 'c7b738d4dc42e298a4f208d0bea3cdb4c7fd6a31' }))))))), index.h("ir-pagination", { key: '95e6fa7de2c20369c123e0737e9b6f5444b0d69f', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
