...
const arrivals_store = require('./arrivals.store-2f19f243.js');
...
const IrArrivalsTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7f04bdedb28a0196aa30cdb8ebeac1d7412d37cc' }, index.h("div", { key: '606a65a606633d275843cbf7870d9970e6cf7ea3', class: "table--container" }, index.h("table", { key: '9987dbc8cd0c5b8db9dc2c16ede4dbdd7b2373c2', class: "table data-table" }, index.h("thead", { key: 'afc1d8edf9e492127b395c1b46a04f50abc37c34' }, index.h("tr", { key: 'c26b12dabeef99923107041655029392e6b1e5bc' }, index.h("th", { key: '6b595573588168b571704b29e79a5a0f001a18f0' }, index.h("span", { key: 'c9695b25acc784edf1088167f4cfb0fc1a3c7ad0', class: 'arrivals-table__departure__cell' }, "Booking#")), index.h("th", { key: '4b4bf54351352cff975bc146cb16a0babadb5aab' }, index.h("div", { key: 'a0a467d3b99c16971dd35e8abba6ced20c625bbd' }, index.h("p", { key: 'defb25e486f5cb1e98325bfd6eb48c5f3b398503' }, "Booked by /"), index.h("p", { key: 'e4f7f336e829575b53ea594f5b02343ac66ff7bb' }, "Guest name"))), index.h("th", { key: '2bff5e4d8ec4d975ed7d895ac249752fab6404c0' }, "Unit"), index.h("th", { key: 'bc6803df6b2dbf07c41bdd1022ade7b8ffe76050' }, "Dates"), index.h("th", { key: 'cc164faacca05a9a84d85e2d8b9311b2d41bf0c8', class: "text-center" }, "Balance", index.h("div", { key: 'b54cd66dd9646c91a49b12512c900ff96aba3bbd', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: 'f49e27bef42a21bae2f562669e1041ef0bbed203', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), index.h("th", { key: 'cea87baab787f2c02a3ba1c9431602a32fda9795' }))), index.h("tbody", { key: '75e7c31463c22024a580e9fa1f1d46a94a473089' }, this.renderSection(futureBookings), this.renderSection(needsCheckInBookings, true), this.renderSection(inHouseBookings), !needsCheckInBookings.length && !inHouseBookings.length && (index.h("tr", { key: '2b1eb57afef4858a9a5cb77f8d9c49b82165bf47' }, index.h("td", { key: 'b657df2a0cb4ecbb8e84189caf4754e99ad70485', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '4d11ff70eac729faea024b593c62b23d36c66884' }))))))), index.h("ir-pagination", { key: '66aae6744d7eba5317fec49e66ea0d35d2ef3938', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) })));
    }
};
