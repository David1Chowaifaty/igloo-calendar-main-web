...
const IrTextEditor = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '367034dfe86f243c69f34edb7e109192716796f8' }, index.h("div", { key: '256f946cb6db56d7c1af9f9345a701c6583a6c5c', class: "field" }, hasLabel && (index.h("label", { key: '3b8f6b4330c78fe25149c26162946c9d2aa46df8', id: this.labelId, class: "label has-label ", part: "form-control-label label", onClick: () => this.editor?.focus() }, index.h("slot", { key: '0bfb8ac450c694bfd419abb3c85fe1bcabb841bd', name: "label" }, this.label))), index.h("div", { key: 'fb8c2ba15a3079b0f7523d5e7888b762fd1c5a8d', class: { 'editor-wrapper': true, 'error': this.error }, part: "base" }, index.h("div", { key: '27549487fbbbc80eec0cbafac24ebdc4a1938331', ref: el => (this.editorContainer = el), class: "editor-container" })), hasHint && (index.h("div", { key: '4a1caab82f68f30bbb16c38c2ede555585a6121a', id: this.hintId, class: "field__hint has-hint", part: "hint" }, index.h("slot", { key: '635dcc4a0485f1efa8acc79dd5f2030f0478b455', name: "hint" }, this.hint))))));
    }
