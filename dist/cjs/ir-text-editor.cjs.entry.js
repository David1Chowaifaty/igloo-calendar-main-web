...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: '76907003e437118e81556158bd7fda6ba2fe2f58', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: '0c21c958c4b5bf0de07a4623cc4a5d4579ba3941', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
