...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: 'f5971d8915061aa5d1e927758b6845fe53128ef3', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: 'a08d362720e21f13a9c11d82d4c4b47b9338a79f', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
