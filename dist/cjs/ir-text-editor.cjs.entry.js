...
const IrTextEditor = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c433ba28f96d5462b2f5c9b634f32757c1002a83' }, index.h("div", { key: '3a79b2d4a70bc2ca84ec9b930e4a2a60b8bc0c07', class: "field" }, hasLabel && (index.h("label", { key: 'e916934e539232e2fb8d2beac4b6280e93e1d34b', id: this.labelId, class: "label has-label ", part: "form-control-label label", onClick: () => this.editor?.focus() }, index.h("slot", { key: 'b6fab49045ce0a46f1008944be71321f0959afda', name: "label" }, this.label))), index.h("div", { key: '7be7c9cd47c0a7557a61b0c8c5f755deab55feaa', class: { 'editor-wrapper': true, 'error': this.error }, part: "base" }, index.h("div", { key: 'cc7b88e47c10acc8393cd83995663f05f6fa2a30', ref: el => (this.editorContainer = el), class: "editor-container" })), hasHint && (index.h("div", { key: '5f8dfa4567bf2f989eecf18c13cbd31ba0e46616', id: this.hintId, class: "field__hint has-hint", part: "hint" }, index.h("slot", { key: '57a8d1a216d5794fbbb6dd59c191feb5276a33a2', name: "hint" }, this.hint))))));
    }
