...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: '4a55fbf5b16618f16f52614fc0f002eb43f0458e', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: '58d6e5cd4b7aa15a44c23ee264a2f9aa980f32e5', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
