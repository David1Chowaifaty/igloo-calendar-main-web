...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: 'de71686982b621e70fb5974149ce989f7d2855d3', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: '93dfc7c77c95a10895bfb882d49b5e6e8e2cdeff', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
