...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: 'ae62cac45c979fd5a0b52cba8e1766f09a690081', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: 'b33231d4d19f8fa25157353cddee97a9b8df393b', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
