...
const IrTextEditor = class {
    ...
    render() {
        return (index.h("div", { key: '3034946bc58f13feb540ddc78b0874661d767b62', class: { 'editor-wrapper': true, 'error': this.error } }, index.h("div", { key: 'd6077805255266d64eaf3143304f1ed8b2dff348', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
