...
const IrRoom = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '8da717b9e1e4deb1f9116330cdcd9fc3a2567a93', class: "p-1 d-flex m-0" }, index.h("ir-button", { key: '65c8c3d7481fc227eb3049e75b1b1e61fce4a260', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), index.h("div", { key: '67026922026d7896cb974fd1379613da453a3447', class: "flex-fill m-0 " }, index.h("div", { key: 'c38ca6d0e962824a5df5bc10a20b1494ab0dd406', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '8d3b3399cb7265541f2fc9ed7e18bad9506f4a66', class: "m-0 p-0" }, index.h("strong", { key: 'e2396cde5ca0127c0a417586aeec2bc874c4f582', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: 'cd7b04b1023ddc3f5711129ea386ef2a3ef51e9a', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, index.h("span", { key: '12849fb0cddace0bc58c73d6643038d1094c1640', class: "p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (index.h("ir-button", { key: 'bc9171e9cfd8454b6e489b1c2b7290b0e8ea12a8', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: icons.colorVariants.secondary, onClickHanlder: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (index.h("ir-button", { key: '90b6e1ff57739a5ade2f442ca720bc2e7a5739bc', variant: "icon", onClickHanlder: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: icons.colorVariants.danger })))), index.h("div", { key: '85da60654a7efb50844628499ea9d32a5ac94374', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '7e1125acab1699aa0b94873c1331934ba6da9286', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && index.h("ir-button", { key: '502f0ed4ac5397118df1eb72cb749ccee96226db', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { key: 'e93f5b8868de544355c42747a7727284db0e6b30', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), index.h("div", { key: '041daa4457a5cbe0b260829c7d5671da5b07ba56', class: 'd-flex justify-content-end' }, calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && (index.h("span", { key: '89a4bcbd3e828a199e99fff40d10cdc551b64d10', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), index.h("div", { key: '74f0be4857ad7e7e645aba3f772b9cc997aedbc2' }, index.h("span", { key: '46bc5ec42c62e50d0617ee80d517caffbb5395d4', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", { key: 'ca9e0cbd8e56e4edf940f13a96052527c9d85390' }, " ", this.item.rateplan.selected_variation.adult_child_offering)), index.h("div", { key: 'c30ca50e0c7e77405cb0d4ca8b614d7743a2523e', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, index.h("div", { key: '3dccfcad8dffcd8fba953edc62ff85daccde9ce2', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '08a380dd1840c927eddc694dd9a2276e8a5078c4', class: " sm-padding-top" }, index.h("strong", { key: '348ba8929bd309c25ca1c1ed6e2fa184673cd8df', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: '63fac56b2bedb68363ca28b270c1fb8a1c721c21', class: 'flex-fill' }, index.h("table", { key: '5797a9e28cee737666f8924cf41f44ce58166fcb' }, this.item.days.length > 0 &&
        ...
        })()))))), index.h("div", { key: '4e497b3e46a83abffd9a1195d0e5c341274b8292', class: "sm-mb-1", innerHTML: this.item.rateplan.cancelation || '' }), index.h("div", { key: '95c449610b7c642741582f6581775540d33025d0', class: "sm-mb-1", innerHTML: this.item.rateplan.guarantee || '' }), this.bookingEvent.is_direct && index.h("ir-label", { key: '7062a75d0e0c63b681c5ab04d7819ee898527f29', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), index.h("ir-modal", { key: '7a89950364396e9e8bd2efb209700006d99493d2', autoClose: false, ref: el => (this.irModalRef = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
//# sourceMappingURL=ir-booking-details_11.cjs.entry.js.map