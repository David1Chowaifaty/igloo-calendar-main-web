...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '59ae671ea0856097dec179875f6851943e888a8d' }, index.h("div", { key: 'c4a3f6e77aed713c4959bb423733d268a1f365d0', class: `m-0 p-0 mb-1` }, index.h("div", { key: '1bd55885ffacb4ac18e6981ad7bd3560f2f1384e', class: "text-left p-0" }, index.h("ir-date-view", { key: '13e44492d1e582612b16771165f6d8c66f65264d', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), index.h("div", { key: 'aa71a79d84a93e1856c586fd003a596b8a013946', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { key: '5b243f2edf28981bf3c47f1aa64a2fa66a306c4e', class: "mb-1 " }, index.h("label", { key: '479d473f7170fed1afc8af75e1b40adae1df883a', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales_store.locales.entries.Lcz_Reason, ":"), index.h("div", { key: '53a3c9c681b6b58766f66967f0c87cccade5e15e', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { key: 'be525e51003b7e2fb2e66c6e957421aa5799becd', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { key: 'f2dd82fa3389a039571eb253db86c08d12994218', class: "align-middle out-of-service-label" }, locales_store.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, locales_store.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: locales_store.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, locales_store.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, locales_store.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'da945306f09dc7736ba6b1bf175e03baf029a6a3' }, index.h("div", { key: '0c51d1f59d48188515deeaced51c6e499e1060ba', class: 'd-flex align-items-center ' }, index.h("label", { key: '3afe7cd1b6fd3aed5f0da50b48e5f26fed63aadd', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '77fd7c99cd438b09ee22da9cea4591d325e45b1d', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '6111c8aae55fe381101724c35ac063cb06993691', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '80e9093ebdc2288729977fe63547f3bbee019a21', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '6ebe11e8c11dbe6756bd505f3f6a8d9d3c3aeb8c', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '85d87b58f340840c66374782674eb1762f658627', class: 'sr-only' }, "clear input"), index.h("svg", { key: '18ae6e9b9ca032b0607934f9cb589af7c2744596', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'a45fc410160ad3635ffdebbcc374a4d57e12e300', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'e59506b5abb9c0a4e373dcae8d9049aa115c86f1', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'cb9c63f2803c39e36b3fbb15f2d5cd2617bf3002', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: 'd5514dd73d71ba08023f1194cdb62ba9dcf3e15d', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: 'aed44b8dbbb23c8814ddff86edb8d1a64d0b124d' }, index.h("button", { key: 'c0f5c60b0042e31f50218b4ed15f872b52034de4', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'f91fc0cffbb7c5d1002f99768de6cc024db1567a', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '11bca34ce88c445e092f4cc656c6d58469b59e55', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '97f89c831f49daa283b70fbc70452a901026cfac', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: 'c95db95316aad76f065894a61499f0112f64e055', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2c3a627cc8f0cd0585ae0978a3874f61334e40a2' }, index.h("input", { key: 'fef221cf1f6fea3ca635948422925e319cf26598', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'faab7568e423cee3e885ac3c0284da4c1ca14102' }, index.h("div", { key: '4741c264172629af07cd0e2074f8707cbfa8dd66', class: "form-group mr-0" }, index.h("div", { key: 'a034e8c94f897c449017c14dd0ad79980dde9db2', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: 'e708766719a6a8559b307183ec9641f11c6fea1a', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '916545a6596eba53a95d6d004ed9bb31c5385996', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: 'b513840bc3f345d41be686c67ec991b8cb0f3694', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '613872268bc3f08d74cb4abdf69211711b2964a2', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '6f6e850298bfcb42eda9dc657a9db2aed76db6a2', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '7004f666583812afd35f59dba924463bb1994e53', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '403beb72a22033d9ae2d88d38880c52a32b3f37a', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: '4754c6b82055ce5ec2658e69684cd7927a02b0a1', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: 'b0258e2cb505007105148f5ba01f8cbd6d0c909a', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: '6491be4241c74dc0d1e7a3b20d8422a2896881e2', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: 'bfa615c9089e38053ea657fb6bc1fd67c08c117c', onComboboxValueChange: e => {
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: '3609c4b097bfd787701da87d12544c729045febb', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '0b748318da179918707dcc61c716635a62da4ccb', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '3fefa18ea2aa9182d17292bed396e03d8e58cad6', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '76c06da08a935c44146272c98190098804fad06d', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'af445e0f422d601d224a14694190a8fa04a11059', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '69c3b3d2b6a378fb293780ce31cc1c6828dd78e6' }, index.h("span", { key: 'f9122227ecc37828cda60e8f559d1ba0e8bd97b3', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'e6849f85ee236bfc8f77a1b28605af651e4837e7', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
