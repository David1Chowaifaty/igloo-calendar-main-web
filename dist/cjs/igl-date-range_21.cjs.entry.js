...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '34fe9e362149dbc1064812600492bb03ae3cbe6b' }, index.h("button", { key: 'f485b024ce708a7d3a56883912069d821e2d26bf', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: '028b72abc14950f5fac81c7d4fff4e753f35d6e5', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '5410ae48c0fc6d3ea23e6ec4d52a65948fd978b0', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: 'fe833882aa5a5a3a58fc846420fdb6af40e11d07', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '350372fc3d0995669729a51bdc453d8f3834b28b', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: '4f01e6bdb4ed6c53ba648a7cb2c6e16c61d7e504', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: '8b6084635021922bebf40047e1140a2127785389', htmlFor: this.checkboxId }, this.label)));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '8d7a539b3f88dd6042af82d3bb1c133fb1f8a0bd', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: 'c461d25180cd128d900b6b58313e92fe73062a29', name: "trigger" }), index.h("input", { key: '88d26d25452fc1956af9da6346f7ef2fd3db389d', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dbbf06701a3cb322676dc210f33bea54f21d47a0' }, index.h("input", { key: '2117fe91637779065505166eec77163dfd495023', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'a740d9ab2ceb31eb7aa0d6f945a39cd676d4bcc3', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '59c721a51836c9d1eee03f931c9fab6cb4e19a00', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '3d0a93cabdffbf4a0d56ddc7e41a80634392cb81', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '3010f020d387b410c95daed7b96b8c693537ed49', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '357140c64219bf03ca1234162ef213ad99c9e19e', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'b64272d9719bffb5e8dd17e28d1af79c693977f0', class: `ir-alert-header` }, index.h("p", { key: '39e0497bda038d26dde44fd236e23196dfe6c686' }, this.modalTitle))), index.h("div", { key: 'e430f3e72cf10f0bce5982bdbb1b87fd009a200b', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '5a3f521a2849a12be5ca9d543c371761bc36113c' }, this.modalBody)), index.h("div", { key: '9262f15d77f08aa88307b05ac45c2024cd670b48', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: '5a9c331909aaa886e423d4ac023f242d35c92e91', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '48ebe85b41569b7428bc88f0805f0cc9e29088ce', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '84cf127e34720608ed9c8e829b2a08a02f794941', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'd6dc19c3ed580edb547d768f113a7d0ca8c36277', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '4b96a9e1a9ddb10f19678e44e693357955a8be13', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '9ed7abaee7eb5251d2f01d20344d548cbae45466', class: "input-group row m-0" }, label, index.h("select", { key: '10d4e0291b20b19c969e7ea3b20e455450200691', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '751453f907e007060168055ff21bbc3eb7bf2a81', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'b2eed7a5ae1e98bc8d635aa00b9fe35d63f4effa', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '54a1e1679664cddfa24ae65839ba27993ee23464', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'c26abd29a8d51c320511abddb8918f478d4d41e8', class: 'sidebar-title' }, index.h("p", { key: '2809968dc5bfd6c3d4250aac0486b1a363e67a8e', class: 'p-0 m-0' }, this.label), index.h("div", { key: '1fbaf16bb47313a28dde2197b5f5df0f1e1e0031', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '2c6ad581f21f17ef643ba54352a1c7bd07d7e785', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '4fc4919ab0cda2a394c1f67393219758d38369e2', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '5af9db7bf32e06174470620b7445a885b6017083', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '03782cfa47902d2b4f670ea22cf144ea941c7df2', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrTasksFilters = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3b840947344003709e999e9c7f9f3b4695e37ba0', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: 'b5ba63ca83f036c804a9820c3b29c4d15d8f6f4e', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: '8266b96341f53a3f661213f69b56b60629c2f6cd', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '51184ff1a6ce092821e82bec37883efc8d9c31ff', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '17d48295a584b066d4ddfee10b02865c42456c3e', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'f6258af0162e7a6056d2818ce1cf8ed93e1b9c28', class: "m-0 p-0 flex-grow-1" }, "Filters")), index.h("ir-button", { key: '0a26b35db6fe3220f0db57da05000b13a6beb9a5', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
            ...
            } })), index.h("fieldset", { key: '393b80e416f50607b18f61e3e07785a578038102' }, index.h("p", { key: 'f20e830fb2edf002c6ff2015b444b05b8e761482', class: "m-0 p-0" }, "Housekeepers"), index.h("ir-select", { key: '5b17e6132e26f14630a6f443ca1993831bf26aaf', selectedValue: ((_e = (_d = this.filters) === null || _d === void 0 ? void 0 : _d.housekeepers) === null || _e === void 0 ? void 0 : _e.ids.length) === housekeeping_service.housekeeping_store.hk_criteria.housekeepers.length ? '000' : (_g = (_f = this.filters) === null || _f === void 0 ? void 0 : _f.housekeepers) === null || _g === void 0 ? void 0 : _g.ids[0].toString(), LabelAvailable: false, showFirstOption: false, data: [
...
const IrTasksTable = class {
     ...
     */
    isCheckable(date) {
        return utils.hooks(date, 'YYYY-MM-DD').isSameOrBefore(utils.hooks(), 'days');
    }
    render() {
        return (index.h("div", { key: 'fc9dda23977fffdd04f8655f9f82062548212ffe', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: 'cb4aead87deefb12d9dd52adaa511873e58889fc', class: "table" }, index.h("thead", { key: 'bcaa1ab8556487f05d4195bd54514ad5be9208a5', class: "table-header" }, index.h("tr", { key: '9e7c6b9acd79878e4b3a4b9eec5cfd05f7e8d220' }, index.h("th", { key: '1853b1e03e7a7a27c1fea2b1f3e3258649e82b47' }, index.h("ir-checkbox", { key: '6def043b67399a40a5373692f127cafdec51dd83', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '1ece345cf42459cc7ad2dc8483ea1c4dd472e2de' }, "Period"), index.h("th", { key: '163930a2a555f88eefad7fe3f0ce037a2518b1ac' }, "Unit"), index.h("th", { key: 'c7dc41891519d09fe3aa312425253927d90da7d6', class: 'sortable', onClick: () => this.handleSort('status') }, index.h("div", { key: '15a928a88154758c418fb100a7da99ab506f144f', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '28cec0d19ad35f900ce4c6af875465e2bf5c77dd' }, "Status"), index.h("svg", { key: '58828376506766b4d1ff81dab70a0e8ed71ea565', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '84ffa522abbb4ae26f65136a3b7ada912d9e920a', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'dd0265a6784574b7727f0d176542804ee21473a3', d: "M17 20V4" }), index.h("path", { key: 'ea591f02b71f890c2d14cc0f29cd7011c9b4b180', d: "m3 8 4-4 4 4" }), index.h("path", { key: '4e39a2b96b1f703d10f021673264ae288cf97930', d: "M7 4v16" })))), index.h("th", { key: '886923603db1d592d0f2f6b6cd1cccfa6902580e' }, "Hint"), index.h("th", { key: '82a192f393b16f5850bd645153d134c96f9dd17e' }, "A"), index.h("th", { key: '9c55d5ccd5d99c3a2b3ca020d9472cbae35fa225' }, "C"), index.h("th", { key: '8923090e83da67911c43f3742d749a58d166f9f8' }, "I"), index.h("th", { key: '92466709679c26d9ff90e11e358422a973221e75', style: { textAlign: 'start' }, class: 'sortable', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '558328722d52215ee55edb5a8e90143545dfc4d8', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '40affa35fb0fe3cd03d3ceff139d6880e36c6429' }, "Housekeeper"), index.h("svg", { key: '7b086189ac415a6f18e67dec5899d3e194db86d6', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '7494bd2c04d5744f7efce948eaaca143e7204956', d: "m21 16-4 4-4-4" }), index.h("path", { key: '84288f8d12fc26c2b9a7fc412f5abbf7eae9d5c0', d: "M17 20V4" }), index.h("path", { key: 'f5a319533123e96bd059f13ff6c0a73ac628b0de', d: "m3 8 4-4 4 4" }), index.h("path", { key: '65e6e3b566d2d189b4c7eee080e50b880e3786a8', d: "M7 4v16" })))))), index.h("tbody", { key: 'd6815b8d2aa586e21717a5142d8307886c0f3dcd' }, this.tasks.length === 0 && (index.h("tr", { key: 'da2c02d59e26c9b2ccb71a2c15d52e5f1f333218' }, index.h("td", { key: '857b9f6c09f177740f6681f2839ed959090d07f9', colSpan: 9, class: "text-center" }, index.h("div", { key: '15ee8f767b2a0f6184cb9a71b47a745a28c7a9e0', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: 'd2aaefeea5c731470b6423cbec24900ec0e354ff' }, " No Tasks Found"))))), this.tasks.map(task => {
            var _a;
            const isSelected = this.selectedIds.includes(task.id);
            return (index.h("tr", { style: { cursor: 'pointer' }, onClick: () => this.toggleSelection(task.id), class: { 'selected': isSelected, 'task-table-row': true }, key: task.id }, index.h("td", { class: "task-row" }, this.isCheckable(task.date) && index.h("ir-checkbox", { checked: isSelected })), index.h("td", { class: "task-row" }, task.formatted_date), index.h("td", { class: "task-row" }, index.h("span", { class: { 'highlighted-unit': task.is_highlight } }, task.unit.name)), index.h("td", { class: "task-row" }, task.status.description), index.h("td", { class: "task-row" }, task.hint), index.h("td", { class: "task-row" }, task.adult), index.h("td", { class: "task-row" }, task.child), index.h("td", { class: "task-row" }, task.infant), index.h("td", { class: "w-50 task-row", style: { textAlign: 'start' } }, (_a = task.housekeeper) !== null && _a !== void 0 ? _a : 'Unassigned')));
        })))));
    }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '316438140add7602a0fe3df35b0bcbf797b23236' }, index.h("h4", { key: 'aa143990770ea5d0066a84270096589d498b982a', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'a7ac790fc147d4074f36fce48e3e895537d9ef38', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: 'a5bf9d65b8fbb4c5fd521c4ce10955791389a442', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '1161f00c5b8c4e129ba58dc21ea859325c257fe5', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '70dd8e65ba3e1c00b6be1af90f4ef42a24dea7e6', class: 'title-body' }, index.h("slot", { key: '14275d5eb1505b3141bc0c69121053b58050c85b', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'a21f3a5f3de5b418da685c6db63ae351512a4993' });
    }
    get element() { return index.getElement(this); }
};
