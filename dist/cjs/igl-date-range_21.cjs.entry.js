...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3187f8986e166da0bfe1dae14714687a17923f0e' }, index.h("button", { key: '60ac9e655bb52c36be7be76cb5cbfa68f1cc2a09', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'ec1e2c3f3f0e4e15e3dfa8da967988228acaa836', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '741457f2078802c30f38ceaf5a00d802330e5dc8', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: '69233440ac83af2d556e9e291fc7c94c1e1f5db3', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: 'c7f2659a6f24f452d435f4acafe79f480887ee8a', htmlFor: this.checkboxId }, this.label)));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'de0a3c7a7a0b67dc00cc42b40ff57e43af13782f', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: '1b08d0d551ce3c7ed7dc75c05f10f13131bf7077', name: "trigger" }), index.h("input", { key: 'fff3477ca850db6f63a68f2ffbc46141e404e59d', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8a0bc7e81094770089de24003b71d592df07d3f3' }, index.h("input", { key: 'd84aad9a6d8f27200ffd8eed5634d6ae79b7cfb7', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'ffa4ae58b1257244041e368eb6e595b5ca7593fb', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'b6e3c78c418eb5672ba5228f3e4114669f4cb3c4', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e5ab3521c012deb09582244c5d9ace68f4612b10' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: 'ea775c5f730347c8a4aa771235dbfe62176e7b5a', class: "loadingScreenContainer" }, index.h("div", { key: '29a812bde5e180b752c16907a35f5cde5b0daa7d', class: "loaderContainer" }, index.h("span", { key: 'c9065abf7671e4464db216672fc5214b8281461e', class: "page-loader" }))))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a445022c4ab42997dda6b3194d8723669300dd43' }, index.h("span", { key: '5a027791c126a620a7f7088ff9fbf14ccb66fd3d', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'b07d52ff61b815c4a08aef5fd1ea3db9944011ab', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '5403f237e942b2ff6f3a76c2d3a9ef40aa58095d', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'afe6f964ed3459e254c738e22b5506c27520414d', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '396662f520905ce9d0f351147d52877414af0977', class: `ir-alert-header` }, index.h("p", { key: '12729ece4a9313fee4b4e79b4d4beb7bd986caa7' }, this.modalTitle))), index.h("div", { key: 'da239d0a329f331e087cf3f1daffd64474e90ffe', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'c82222ff30eac5af543bf7a089cd96c50e4613c7' }, this.modalBody)), index.h("div", { key: 'bc8af6d641aeadbe5b7f55205ee538337b03b85d', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: 'f68e60448cd5f6b180ff6dca870f011c32d232a8', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'e5852cadeb7265bf855e5cc1fbded1a189afa8d3', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'dac748ff5141d4280389cd32b038dce2d1bbda22', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '5570e4704cb298312fffb29fe4a83f8b141102c0', class: "input-group row m-0" }, label, index.h("select", { key: 'b4f18890b7e7cb29f868f00a3701659e5474d8b0', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '382fe97b6155e63de5dcb0b811d5f15ffee8199e', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'b459dabe43c9f354cad098f5a013d6852c8d7883', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '02c7c23f32cbbeaabad534d5c62caad0c284e8ae', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '2b492f232a06ec77cd2c35a1d904159d5ce46c86', class: 'sidebar-title' }, index.h("p", { key: 'c33c506d464a8588d1c4e4c44d16bb400458f4ca', class: 'p-0 m-0' }, this.label), index.h("div", { key: '57bc9f7013a4f35b5cb245255612885881cda4ec', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '5e9868a5f5f0771aff6ff37310db94126615a934', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: 'da71b44c476565daa7b6c6184987554dfc135796', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '52b56c2e4c3ca7994e1f6a4375f3352e58f47369', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '8aef5fc1282aa27f29f4a480afaf178525bf5dc8', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrTasksTable = class {
    ...
    render() {
        return (index.h("div", { key: 'efce2880f3eb4efc93508e5f29681203ddccf03f', class: "card h-100 p-1 m-0 table-responsive" }, index.h("table", { key: 'ef777af10ef1a8a3de79925e06657c2b3bc17402', class: "table" }, index.h("thead", { key: '6aa1600f9d6410bd3a787d917b00a47250f154e4', class: "table-header" }, index.h("tr", { key: 'fa6fae8180807a5f01b6071da33020b84ca6f76f' }, index.h("th", { key: '4e0e0122ab9a5d8b668a37cb803334ad1dd0807c' }, index.h("ir-checkbox", { key: 'd7c3221702ed2a7cf14388d877641f0297d8b80a', checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '5747791a6934bb4c6874207c4dfff284262a6bcc' }, "Period"), index.h("th", { key: '44bc830ab976da7f3b32dce5a217f671b5a363a9' }, index.h("span", { key: '36f805d7f9285824f2808f81370f57ebcb6fa267' }, "Unit")), index.h("th", { key: 'eadcc79eefa1e88813c3cd01287fc1e7033b31c1', class: 'sortable', onClick: () => this.handleSort('status') }, index.h("div", { key: '0546ffbb627ef3a2cb2b73881aafea9b85000cd4', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'd90c2b8155fa208a4c1fe69c2264285a5e825dad' }, "Status"), index.h("svg", { key: '39d808bab5b0759feefdd0a88f496b2bbdd048ef', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '221edfbaaac0c405ea4bf0d398d48d5dec5f61c6', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'd75236b106045a0c775ab0eaf3fa196125d7988f', d: "M17 20V4" }), index.h("path", { key: 'ea091683a5e2d74be80f418037c7dc170bc6d1a9', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'ba5ef2c8bb16d330ea70ecf12671e4569075c00e', d: "M7 4v16" })))), index.h("th", { key: '7d1a031260882acf95b1a11ec2b7f8f6bef46cee' }, "Hint"), index.h("th", { key: '08338436a75911c85f253e6be3ebdf75cd84a89f' }, "A"), index.h("th", { key: '1723e7f30fb8690faad8917a8f4d78bfd1f2053e' }, "C"), index.h("th", { key: '644c6b85e1214636343361248ddae88330d2357f' }, "I"), index.h("th", { key: 'e0b9f6ec148ccc7f81b7a500f5ec0d97645298fa', style: { textAlign: 'start' }, class: 'sortable', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'dc78248c54cdf52c5ffc00dc20cea0fc25781674', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '0f59d0a39e12bc1f58685f87a21ae1bfeee1b339' }, "Housekeeper"), index.h("svg", { key: 'ada559e023b26690acea53ddcea31d89ed34ad6d', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'ac5b4af7515b2b2a843607c99b7022ce65f7c0ee', d: "m21 16-4 4-4-4" }), index.h("path", { key: 'f04f39eb8b7160d6a36a0e00b205ca5f54b42e8c', d: "M17 20V4" }), index.h("path", { key: 'ec3b53a2755d37dd262559c4f3db82461edf4e8c', d: "m3 8 4-4 4 4" }), index.h("path", { key: '0dcf830210fbb93ef712761352aba59f2808f7c6', d: "M7 4v16" })))))), index.h("tbody", { key: '6b4e1c497ccb63c6d4c36bd7ec10c4e207e08841' }, this.tasks.length === 0 && (index.h("tr", { key: '381e634e05da7219c882c900800b51d45531fbdf' }, index.h("td", { key: 'aaee2df2a919bcfdbe29ff748091c9d1fadaec73', colSpan: 9, class: "text-center" }, index.h("div", { key: '63e5b66e9adfcaa959701809cd03de8e7f027212', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: '94c856f16ac159d89072cd033e36f9d59a2e83e3' }, " No Tasks Found"))))), this.tasks.map(task => {
            var _a;
            const isSelected = this.selectedIds.includes(task.id);
            return (index.h("tr", { style: { cursor: 'pointer' }, onClick: () => this.toggleSelection(task.id), class: { 'selected': isSelected, 'task-table-row': true }, key: task.id }, index.h("td", { class: "task-row" }, index.h("ir-checkbox", { checked: isSelected })), index.h("td", { class: "task-row" }, task.date), index.h("td", { class: "task-row" }, index.h("span", { class: { 'highlighted-unit': task.is_highlight } }, task.unit.name)), index.h("td", { class: "task-row" }, task.status.description), index.h("td", { class: "task-row" }, task.hint), index.h("td", { class: "task-row" }, task.adult), index.h("td", { class: "task-row" }, task.child), index.h("td", { class: "task-row" }, task.infant), index.h("td", { class: "w-50 task-row", style: { textAlign: 'start' } }, (_a = task.housekeeper) !== null && _a !== void 0 ? _a : 'Unassigned')));
        })))));
    }
};
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'be55c3210114bf53f0194bc5993d3cedbe05a613' }, index.h("h4", { key: '7a9f5785921cf5f35a60e510cc45df7bdc98bc30', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'f12135e183ef07029ba7a59bc9c925c341c5f9e7', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '13230d479975ff61cc63c80ce7b2b7864de1d973', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '0b068af5d281be1a19873096d7195049bedd38ba', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '4866e854c1109ca813b0e5db51b4c61b9dd1f1bb', class: 'title-body' }, index.h("slot", { key: 'd1f7774b1bedab61005bf7969c9816a33250b0c7', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '44b3ffda4430f823dbe98954e750a22260fc4add' });
    }
    get element() { return index.getElement(this); }
};
