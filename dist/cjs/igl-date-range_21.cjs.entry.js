...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: 'e6ff414e20fe370634aae6cc49cbfe3ec87b513e', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'b06eaebdd077242c919f6dcb7f7a24b494f28751', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '8a4b901c0f83cedf77289057318573a6831bf377', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '0c5bd2357fc7f475501916dc20ef5ee3ea0f7392', class: "input-group row m-0" }, label, index.h("select", { key: '9be7f8b65bab03263a80ce5c6142e6f13fa3283b', style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '9fbd293e13cb2e5f606f165c10e69849627a1f47', value: '' }, this.firstOption), this.data.map(item => {
...
const IrTasksTable = class {
    ...
    render() {
        return (index.h("div", { key: '7f5d032318aa9c2ebd3471c0fc8f0894c1849a3b', class: "card table-container h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '02b83be5a5dddf88428d11a2d4409d4369a93398', class: "table" }, index.h("thead", { key: '7e63cd59b23fcba5cbf4e91254778b067644df40', class: "table-header" }, index.h("tr", { key: '79016d2e3c24661052d8b0c37a1d3daf0c3b1068' }, index.h("th", { key: 'fe933926f257bdd2cad9837aff5d4fbe1609c387' }, index.h("ir-checkbox", { key: '1f5aa2cdef87cffaeeb6fc2203e968b383e03a5d', indeterminate: this.selectedIds.length > 0 && this.selectedIds.length < this.checkableTasks.length, checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '059eeed4b94a50e2beb94f5dbfd63889f202d937' }, "Period"), index.h("th", { key: '4776d78e78c385aa4cbd29429bbac91e68c48ab5' }, "Unit"), index.h("th", { key: 'c8c0abc978c2d19fdbb322a1245f0c46a71dc556', class: 'sortable', onClick: () => this.handleSort('status') }, index.h("div", { key: 'bd475f9f3ad6c805ead80a567be8063b7d421ee1', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: 'e9dbbff2ef6f30b3c313e9f5345bf0606cdc6314' }, "Status"), index.h("svg", { key: 'e4bfa34dfe966a0a0b7d111b6a5b575b0ce4c378', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '254a960d7a3eec5d21517291e8a15d3f1d88f032', d: "m21 16-4 4-4-4" }), index.h("path", { key: '04f4a911639ca46cb2693c85913662ecbc55fa00', d: "M17 20V4" }), index.h("path", { key: 'a0a0ef7a82bcff45f41b9a2dedb60aedd2674dcb', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'd9d36abf1409b6dc0adf0329453161e80000228f', d: "M7 4v16" })))), index.h("th", { key: '45ed00d174aa09fdd6962ee9d0abaa60b79f9c98' }, "Hint"), index.h("th", { key: '783c9a73f65d8eb10af9e48e2f960de85042105f' }, "A"), index.h("th", { key: '156ff8518a6079ef0f43bcb235be0650304e55fe' }, "C"), index.h("th", { key: '12353001b279c601a1d7991d01e48ea7908a5351' }, "I"), index.h("th", { key: 'd4c0c863f9a386f39dd714fe2ba38bd4dbc74ded', style: { textAlign: 'start' }, class: 'sortable', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: '00ae3cd5dc72c6404f2cf8ea07c4c6e7edccbef2', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '1cbdeb3b0610eda37865cec809de7e3f828d87a9' }, "Housekeeper"), index.h("svg", { key: 'ade3892e7debdc18bee86f77cd666b4ed34ab3c1', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: '83d65eff8278caa28ecc8dcdd5726de802b1ae69', d: "m21 16-4 4-4-4" }), index.h("path", { key: '0f022fb455b29769f2de722661af0985b57960f7', d: "M17 20V4" }), index.h("path", { key: 'c051e61e2a0f351c7e1700f64fc7961b3b08d14c', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'e5de7fd48b8e0c33c41a8c54f592f963f3d7cf18', d: "M7 4v16" })))))), index.h("tbody", { key: '30e7e5169af915a550c6c529a6cbf952bb6952de' }, this.tasks.length === 0 && (index.h("tr", { key: 'cf63a97c444db1f1d76d1ea5b4131a0c4818bc31' }, index.h("td", { key: '75908b70105a479d4e8d832224e72fbe1124fe8d', colSpan: 9, class: "text-center" }, index.h("div", { key: 'ef186bc74bf8d1c0e3444bfabcc3e11f9d95cabf', style: { height: '300px' }, class: "d-flex align-items-center justify-content-center" }, index.h("span", { key: 'de76290fbdc749221ea21647f3c5b5f2eefa57c7' }, " No Tasks Found"))))), this.tasks.map(task => {
            var _a;
