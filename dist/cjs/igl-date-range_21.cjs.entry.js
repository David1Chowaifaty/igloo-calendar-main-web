...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'df59ba742a643cc246dd9b71243448aa1f7e9264' }, index.h("button", { key: 'df2ae40a45ec984748a0805c2bc4ffd03158e769', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'df4ee57368cb7947875fbcdc467f6345741b931b', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '50819b4f18134223067575ce35f1305a2353508d', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), index.h("input", { key: '61fb9f19ace02d7768608d94400aebb7d4469ad1', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && index.h("label", { key: '0e04f261ae10c1f054917c756f9e15f2a381b053', htmlFor: this.checkboxId }, this.label)));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '9f786536c54402841247d17a90f6a60852884926', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: '5bc1abafcd14db8fe4927753bd91753331e5dd8e', name: "trigger" }), index.h("input", { key: '31ac4b4c9a38ab061babd25bbd5906cc4e1f080c', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3c35902ef4bedc6288fa2bc7ab34ba1b9ecc6862' }, index.h("input", { key: 'b8bbe6f0e1b1c5a5f73dd42a362885f42c0d630e', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4e08b9367287d05660cd19caa7ee97fce59078a7', class: "d-flex align-items-center" }, index.h("span", { key: 'bd72dde338c01fc5bb55081eb03089ced5947b54' }, this.dates.from_date), ' ', index.h("svg", { key: 'b595f5b85d4e07e5ec5bb0fa4c02807ab2421e2d', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '3e9849e90017b05a17e99692de8e34b89f09987a', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '592b4ece9e44cb7069215de3347ce7390e9f3f1f' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'aa09696c78bdb29938cadf55c2e4fc14a6ad5ca0', class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '8ed09ccdd73f3f0969cd0133b32ebf72d4d9e7ff', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '3d414972882211b6d2e9e261aa167c8934336697', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '34d12c137f49d49d1c7087411f50ce65cd299cc3' }, this.isLoading && !this.isPageLoadingStoped && (index.h("div", { key: '9fe640f6747f716853420f63d8fb13f4b5215127', class: "loadingScreenContainer" }, index.h("div", { key: '0ef4afbe33b4ca2c796b50f6286985f23698614b', class: "loaderContainer" }, index.h("span", { key: '0616c5306c878e31a4b7ac38dc5b2ab623f72f5a', class: "page-loader" }))))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '222fee4b706717d9c81bfb0608b1aad468c7892f' }, index.h("span", { key: '0adfd9a8d7694c89b05c6a56491d833965b86fff', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '175d679336961b53d97bf396791506695bf61a81', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '1c13a5ce74f4d6368050f3b15916d370c45dbd9c', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'e1e0d7c698d09725f620a272037fdd0acc9663fe', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '2d007183793629b46168325d8011f61123444fd8', class: `ir-alert-header` }, index.h("p", { key: 'd1a9749f659aabefc9035d102f16a40a623af081' }, this.modalTitle))), index.h("div", { key: '10f6159f586fb3b90cfd28919b8d859b43a3960a', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'ea1dc2bb41b0557b191c4617a9a5cd9ebc901414' }, this.modalBody)), index.h("div", { key: 'c1f4d4fec9bafd350318634f2243fc8a8c9075fe', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: 'f3535e03350bc6bcb45e4cc23b077989d655ef41', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'a7fbceaa8ff7e1bfba81c7ebe19c7de62610cd78', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '52e9b9ecc5a0278038b32f29898c450b53a48466', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'f5f6e0a803454d183bc9dc2b590c669e32e3bafa', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '16bae4dabcff11a8130694dc1ed93aadfcc54ddd', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'b5d047919a2a82968e4da66bb2867dc82ba9eb73', class: "input-group row m-0" }, label, index.h("select", { key: '7d88b6806ec47bd7fd4ee695c55b2e851e849527', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ebf4838e49e0f0ceb734879f1935b05d3ce65100', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '6d669f5f44909349c8314f3b2d6c8021dfe17a7b', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '58155608308c766dd20c7842e3607515b32dd976', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '67c8b73e55a0159fa5d50d82b60fca75037df134', class: 'sidebar-title' }, index.h("p", { key: '884a281d3881bdd5991baeb81d9a13f111e292c8', class: 'p-0 m-0' }, this.label), index.h("div", { key: '92debe28a5ebb5889cbd786a492f93e7f96b9f63', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '0b09ed1b8dc0c16fe32eb091b8fe028b33af7e31', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '3998947d1fae1121888142c468f67bca20dc482a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '5fac432384f3e443e7f98d9fb895addbeec90216', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: 'c5dd32e7b8bdc3cce3bff85dda0f2645b4822383', name: "sidebar-body" })),
        ];
    }
    static get watchers() { return {
...
const IrTasksFilters = class {
    ...
    componentWillLoad() {
        ...
        this.baseFilters = {
            ...
            cleaning_frequencies: (_b = housekeeping_store.housekeeping_store === null || housekeeping_store.housekeeping_store === void 0 ? void 0 : housekeeping_store.housekeeping_store.hk_criteria) === null || _b === void 0 ? void 0 : _b.cleaning_frequencies[0],
            dusty_units: (_c = housekeeping_store.housekeeping_store === null || housekeeping_store.housekeeping_store === void 0 ? void 0 : housekeeping_store.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.dusty_periods[0],
            highlight_check_ins: (_d = housekeeping_store.housekeeping_store === null || housekeeping_store.housekeeping_store === void 0 ? void 0 : housekeeping_store.housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.highlight_checkin_options[0],
        };
    ...
    render() {
        ...
        return (index.h("div", { key: 'be27d6bb6421fa3b20bd3fa0a58287d5c274cb49', class: "card mb-0 p-1 d-flex flex-column" }, index.h("div", { key: '15e15d7c3bab1acf95d7b2ae14f530da2fd6f9e7', class: "d-flex align-items-center justify-content-between" }, index.h("div", { key: '87f68c3b228315375a65ead5b0196515cd05ea04', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '7d8371c4606fa0f0aa0dcb23c98e53907c0c9024', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '09276b28b123e4aa7298b7cd3a8270dc140199e4', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'a791a831d62a59f5871f4adc628db65f9d2af3e2', class: "m-0 p-0 flex-grow-1" }, "Filters")), index.h("ir-button", { key: '6d6cc5512f5709db47a81fe34777e4b42a786b51', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'ca00b24f93d4e76d935fc3bfc4a124ec5ead7c94', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, index.h("div", { key: '2870566bd26be26ef7ddf26d364d548828f8a56f', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '47139f34aff0da09464f443b09e974cdde1c24d7', class: "pt-1" }, index.h("p", { key: 'ab5fe71fbb0710b414177655855f3481f15533a4', class: "m-0 p-0" }, "Period"), index.h("ir-select", { key: 'd58762785c1b7366b2924e54ebec9e28ac2f9cf8', selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_store.housekeeping_store === null || housekeeping_store.housekeeping_store === void 0 ? void 0 : housekeeping_store.housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), index.h("fieldset", { key: 'f4d525139319bddc39185e1a4584b6175857d6fc' }, index.h("p", { key: '3416125fc0882797779bdd6e7b9f6a5b5cc0636e', class: "m-0 p-0" }, "Housekeepers"), index.h("ir-select", { key: 'f24ddf34fec38d7b84515a01684205fae56b8e90', selectedValue: (_e = (_d = this.filters) === null || _d === void 0 ? void 0 : _d.housekeepers) === null || _e === void 0 ? void 0 : _e.code, LabelAvailable: false, showFirstOption: false, data: [
                { text: 'All housekeepers', value: '000' },
                ...(_f = housekeeping_store.housekeeping_store === null || housekeeping_store.housekeeping_store === void 0 ? void 0 : housekeeping_store.housekeeping_store.hk_criteria) === null || _f === void 0 ? void 0 : _f.housekeepers.map(v => ({
                    text: v.name,
                    value: v.id.toString(),
                })),
            ], onSelectChange: e => {
                this.updateFilter({ housekeepers: { code: e.detail } });
            } })), index.h("fieldset", { key: '81fa307c7c7d6bafa7f6a07dc0b5836f68da7314' }, index.h("p", { key: '7d87638d5a502f14df7819730e64e26bbe79bd43', class: "m-0 p-0" }, "Cleaning frequency"), index.h("ir-select", { key: '28035f4555d33ca7d805b2338e783e6ab3b92b5b', selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_store.housekeeping_store === null || housekeeping_store.housekeeping_store === void 0 ? void 0 : housekeeping_store.housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), index.h("fieldset", { key: 'c070ed9b8af3b3b6e734d57dd0a4f5517a1e7cdb' }, index.h("p", { key: '0acb240da9e7a019822f835da90a394821a65da5', class: "m-0 p-0" }, "Dusty units"), index.h("ir-select", { key: 'e37de7fbd35227a9eda776ee80fb195bfedd1659', showFirstOption: false, LabelAvailable: false, data: [{ text: 'test', value: 'hello' }] })), index.h("fieldset", { key: '95fa477a3c187d199b895293994a381f9ff772b1', class: "mb-1" }, index.h("p", { key: 'a8fb456a76794653ff8dd4005ac00c7bd2e5ee3d', class: "m-0 p-0" }, "Highlight check-ins"), index.h("ir-select", { key: '7b4fae6e210fc7a080e9b602f37cbea9545e1928', selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.highlight_check_ins) === null || _l === void 0 ? void 0 : _l.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                this.updateFilter({ highlight_check_ins: { code: e.detail } });
            }, data: (_o = (_m = housekeeping_store.housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.highlight_checkin_options) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })) })), index.h("div", { key: '7d9c662b289c221429caf61edf95e131ad8b901c', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, index.h("ir-button", { key: '7841b2d963e10a071c76433a8ba0035308b3fe93', text: "Reset", size: "sm", btn_color: "outline", onClickHandler: e => this.applyFiltersEvt(e) }), index.h("ir-button", { key: 'b7a72e070a848824817e51e96ebba802d1a95b79', isLoading: this.isLoading, text: "Apply", size: "sm", onClickHandler: e => this.resetFilters(e) }))))));
    }
};
...
const IrTasksHeader = class {
    ...
    render() {
        return (index.h("div", { key: '3431ff6010b60d9648cd428ccdf4df48f1c79c54', class: "d-flex align-items-center justify-content-between" }, index.h("h4", { key: '3c21f2b0ad1fce3f51c07d6047ce7da2fb262bfd' }, "Housekeeping Tasks"), index.h("div", { key: '6198b889632d7b36699dc414d987f32c19c70a1c', class: "d-flex align-items-center", style: { gap: '1rem' } }, index.h("ir-button", { key: '9c5b658fe21c199be07f7483445bcceeda83bce8', size: "sm", btn_color: "outline", text: "Export", onClickHandler: e => {
            ...
            } }), index.h("ir-button", { key: '48ddb92b1719de218805eaf69bff0ecca221f60c', size: "sm", btn_color: "outline", text: "Archive", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.headerButtonPress.emit({ name: 'archive' });
            } }), index.h("ir-button", { key: 'd3922297e862acfd7748bd67572b38a36ba561f5', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrTasksTable = class {
    ...
    render() {
        return (index.h("div", { key: '25b5fc05dc0c5e2cff953d01af66a4ef23a84f43', class: "card h-100 p-1 m-0 table-responsive" }, index.h("table", { key: '17a3aa8029bf6be0ddc85a8f7178a1de7374b7e7', class: "table " }, index.h("thead", { key: '2fb5e070c435c73cf00f85e18e6204fe634198d0' }, index.h("tr", { key: '16119ace4803b6c425a7e5ede7b047e4ed39cbbb' }, index.h("th", { key: '7444dae4b7c5a64548065725258eb5ed603ee87c' }, index.h("ir-checkbox", { key: 'dc11a4475d5ca9e3fc6647c3d70ab06fa120aab1', checked: this.allSelected, onCheckChange: () => this.toggleSelectAll() })), index.h("th", { key: '448c382938f8917289ca5515d51539c89858a232' }, "Period"), index.h("th", { key: '608badd4300c47ffc7407560441f09166de9240e' }, index.h("span", { key: '3ffd1d49ac0d11bc72ab9e10a0825e74e3a3564e' }, "Unit")), index.h("th", { key: '490cd64b8af1a9584cce1764085b79468b8d50ae', class: 'sortable', onClick: () => this.handleSort('status') }, index.h("div", { key: 'cb7677c9ea55bec473905d6a91d90316610ace0c', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '01bc91ab3a261a27fd6768203174412c7fb46f10' }, "Status"), index.h("svg", { key: '9c84e5fc83cb7150ef208a077b51d542fbc09889', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'e697de954bd6d396c6961bcf5fbaa75167ecfcfe', d: "m21 16-4 4-4-4" }), index.h("path", { key: '5903184d8bd083bfb062aac62b761f91855313ea', d: "M17 20V4" }), index.h("path", { key: '17377542bd88c50d7fea70fe9ef2dbd6c378a63e', d: "m3 8 4-4 4 4" }), index.h("path", { key: 'ac741050967b1ef3f1b0d9f7c5f943d5a8e81399', d: "M7 4v16" })))), index.h("th", { key: 'd117a5c23facc9957e787f38583a6697f4458611' }, "Hint"), index.h("th", { key: '81e974891cd2052cbac859f57122e5e0b9de5f4c' }, "A"), index.h("th", { key: '749632a916d4928644b4cc7037bc3ca1b0950af3' }, "C"), index.h("th", { key: '22cf3d18391a28deaa13fff7e2b09d3662067a05' }, "I"), index.h("th", { key: '38e1310c6e5e83a16a2a6e6bd700d1d9ae194934', style: { textAlign: 'start' }, class: 'sortable', onClick: () => this.handleSort('housekeeper') }, index.h("div", { key: 'adeff533a7a9bb7d02426dd6b2889205187a6cbe', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("span", { key: '336c3531f0831d9e2629b7fa5d2b3de422aa98ba' }, "Housekeeper"), index.h("svg", { key: 'e4952802e16194f7b2a025ab27824eccd74bd095', xmlns: "http://www.w3.org/2000/svg", width: "16", height: "16", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round", class: "lucide lucide-arrow-up-down" }, index.h("path", { key: 'e37a799ae2485625a5e6d8a9fc016045ec0a5a93', d: "m21 16-4 4-4-4" }), index.h("path", { key: '5717e7dabe2cd8369536becf0595d257ebface09', d: "M17 20V4" }), index.h("path", { key: 'aab161d8180675ba9573d053627564d55a5d2a32', d: "m3 8 4-4 4 4" }), index.h("path", { key: '69302cb54d716c1bdbb0a8c858ebb232d8c6a9f7', d: "M7 4v16" })))))), index.h("tbody", { key: 'ef50dead269bd21d5bd030e3febe39a2bdd47778' }, this.tasks.map(task => {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c6f2a4c0a9c2c0f1bccddd49d1a02f9f8d32980e' }, index.h("h4", { key: 'ae7e15d4f94def4c943009c31220098aca0638e4', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'd980fe105247f0fac1e5d7fa314593ef5646983c', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '95de551cbe7da6d3665c4730804d10ca508d684e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'c793f3180222451694206d1fb4b8843477464874', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'b0ad02c0b78ae9b358fb99eb4b3b1c1cf6f91080', class: 'title-body' }, index.h("slot", { key: '167fa58539d7c5f0072a7f9360ef17239c7d1c36', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'ea98d399bbc38dec1a526d40800030a1563cdd7a' });
    }
    get element() { return index.getElement(this); }
};
