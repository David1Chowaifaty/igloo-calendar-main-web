...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '76bfab82e4dee2da9f69d6f3a555bb835f351941', class: "sheet-container" }, index.h("ir-title", { key: '3580f0a252ff093a9a1512124099b441a3d6221b', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '088c31b016a925b13c342c115a8abdb2408e0e47', class: "px-1 sheet-body" }, index.h("table", { key: '5d237fb5828eb2eccb28ec63192bfb7b0ee600b2' }, index.h("thead", { key: 'b031c6da17fb4678cc6cd5d2e91de6d9bd8f860d' }, index.h("th", { key: 'b427f208191ae3b887c4433bf3ae79c7e9e274ab', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '9cc8ede1d5c9ee5a9b6e8d9278fa4a7535378dc9', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'c072d281da7e57a0a1bd4e9f2cf6e08c6a22e66b', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: 'effa29b8b6f13778211fdfc1964bccf00040e336' }, this.renderRooms()))), index.h("div", { key: '8f08ffa061532c2af0aca1832d0f777e5215386f', class: "sheet-footer" }, index.h("ir-button", { key: '9553d8b25e889ecf6e2e619a816b74ff3c3d1401', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '8f6b85133523f526680d24127a7c75340cdfb0d9', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '0be02f21b725a6fbbd8f22e9176ffd4b5eb9aacc', class: "sheet-container" }, index.h("ir-title", { key: 'db435ac65979b9c13061e616f0ebb73a8c679a23', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '21076625ec0a1a3bc82322e9a464bda8f1c705d0', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '0b732365423aaf93f1835e5f81ffb261755433ae', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '6af0efa66649a4c0dd85f2a110915e3135009c2b', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '412b40039f5202568941d16cbd5d8ea931093dfd', class: "mb-1" }, index.h("ir-textarea", { key: 'aca2bd18b3553177f57ae9289a6cfad585105a4a', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '4e257b85c49857dc3b82aa3f1e0bb9b763e7c027', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'c9cf22ba9af22880aef2bd9d0633b167d4092800', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: 'b74eee9e7349d71f83ebc63a850deaea5bab5096', password: this.userInfo.password })), index.h("div", { key: 'e27a586b9b11c64fbbd1c38cca5f8035253d11e5', class: "sheet-footer" }, index.h("ir-button", { key: '35315fbf2a6f80d32c09b42582a6071fa42e0ecb', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'ba4002a9058c76995700c7bde8435a5c94d90ec7', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
