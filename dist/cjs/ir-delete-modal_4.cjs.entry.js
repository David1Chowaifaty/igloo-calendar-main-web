...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'fbb84723155f23e4259c7fe9ed38af77885f6efa', class: "sheet-container" }, index.h("ir-title", { key: '37aa909ceb947fe38b19612298349df50e9c4bdb', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '919724d8d2f5001d415b4b56b7939ec74417333b', class: "px-1 sheet-body" }, index.h("table", { key: '365c6a52b9febc50841a9e89399c565187f36481' }, index.h("thead", { key: '98c227b970e66d7a06a5dca86564d7b543d4cacc' }, index.h("th", { key: '7f5bab23bc6d4e1a5be9dc2b4e502fff5f0376f7', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '904fcc2fb91b96b840e95905a6fa2c840773003c', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '3ca7d2cf559af4bc17c2372f3850def587cf0254', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '4a999507210c929b9b0512fa532bc3655bdfeec6' }, this.renderRooms()))), index.h("div", { key: 'ef38107145a8dd6f954c73ac4489299c3adf5858', class: "sheet-footer" }, index.h("ir-button", { key: '8fd5815a5563c9655e37a30569a7126b844fbc3f', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'ca17f672b401b2f16f9240ed399bc1220592b654', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: 'bc596bee21a93c34815fc60e57a2ad33cc28adc2', class: "sheet-container" }, index.h("ir-title", { key: '01022cafc93b21809f497d8c1e345367b54959fc', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '01080bcba54b67b6ace3405c555a335883ec7f5c', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'aac5423f7259a8fc16991dd21e4d56352ef98475', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: 'cb282df4cc68fa93618d7663e1f9da613272f295', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'e55751d7858bc41f26163e7238764c3aba6905a5', class: "mb-1" }, index.h("ir-textarea", { key: 'cf2f489ea964b3b696f30bf4e80c2b7384208c01', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '37c6fa89a0a9508bcf93d474c65b20af920fd641', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '7435202a3b2c39ed00f096cced1458d1032f2820', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: 'cc51f72ed18df21ba72fa2f740f5dc59cd3d24f9', password: this.userInfo.password })), index.h("div", { key: '494a5eae222673251849bd2f90a4dc8f0ded9377', class: "sheet-footer" }, index.h("ir-button", { key: 'a95a630efb9ee3a9d12fec68535133ce788c2050', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '78bac6912dac20716062f2f74ca468072bc406de', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
