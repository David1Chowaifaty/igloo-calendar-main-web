...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'c23c843cbfe48d154eed644f26934e436f5f3ed7', class: "sheet-container" }, index.h("ir-title", { key: '4ab1942a947b59af85d7d8f10d4023dc8f6ce8e1', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: 'fbac8a9f5badf29cd7cb139e0120f44e7adb9d8c', class: "px-1 sheet-body" }, index.h("table", { key: '220a6230d2c6e7d58d9645c6dc3c3891b70c72b7' }, index.h("thead", { key: 'eabb913d7ac9446615657aef6a75d3f1c9f7951a' }, index.h("th", { key: 'd6b02b39d98c13f2fb709540924a937391d5fdd0', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'c6ffd8f9ada266809a01337a489fc8fe4cb08f80', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'b0c81ececa92fabbcba133dc83a30e7900157db2', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: 'f043aa72dea236a19aab0ebcc3a7ce79de8eee65' }, this.renderRooms()))), index.h("div", { key: '6e6b54d0f71477c3269cf8cef39eddd9ec4a172b', class: "sheet-footer" }, index.h("ir-button", { key: 'aa8547627c8bbe62a645fa5ccae6b943397ffda7', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '0e9f28b68172915cfbc7110c316b66503e87ebfa', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '471e5ffe4fe98d1dd6681b8937d65e03401b4d33', class: "sheet-container" }, index.h("ir-title", { key: 'a2d78327f4423e767762d86742f2d2f99f306364', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '2d1b5262ba7dfc0e97846cba54126618daa320f5', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'a3e1333411faed28439e88ee9e5f6fd1cfa29ba3', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '87064ee001e2bc0c30785f6980eb84a867122cae', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile) && !((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile), language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_d = this.user) === null || _d === void 0 ? void 0 : _d.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '6f8b69215bcb41cf1334e20f529a42e5725d2d0e', class: "mb-1" }, index.h("ir-textarea", { key: 'c8616efd30f64ab3cc7ce0e4b60e54f99a5e4437', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '33ee0918ecba7615ee0cebacb746a17d9379a9a3', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.username, asyncParse: true, autoValidate: this.user ? (((_f = this.userInfo) === null || _f === void 0 ? void 0 : _f.username) !== this.user.username ? true : false) : this.autoValidate, errorMessage: ((_g = this.errors) === null || _g === void 0 ? void 0 : _g.username) && ((_j = (_h = this.userInfo) === null || _h === void 0 ? void 0 : _h.username) === null || _j === void 0 ? void 0 : _j.length) >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'bfbe2071ce4f233187fd4fd31954b78452f6843e', testId: "password", autoValidate: this.user ? (!((_k = this.userInfo) === null || _k === void 0 ? void 0 : _k.password) ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: (_l = this.errors) === null || _l === void 0 ? void 0 : _l.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: 'd166bf1524271435adc26eb9b16fd1130de8d2fa', password: this.userInfo.password })), index.h("div", { key: 'c6b3993590f75790f16f089cd276fdf20277237a', class: "sheet-footer" }, index.h("ir-button", { key: '5e3fd4f370e143ab2684d25ab948b49899a48137', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '3a7daa0d3b3f8d88e14f4609588c5306673153a5', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
