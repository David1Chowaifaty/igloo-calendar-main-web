...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'fc297f31a68e537cd11b7e4588a12110328eedb4', class: "sheet-container" }, index.h("ir-title", { key: '58a4abecb14f8ae7256cd6c4053488461fe25343', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '220bb618205631992c2d0974eabcc7c372ddeff8', class: "px-1 sheet-body" }, index.h("table", { key: '8d5a4764b35fe6c28c2da3737401daf5e1e6c6d2' }, index.h("thead", { key: 'f43620845c4443d2caca5d14ba169cf3c3be102c' }, index.h("th", { key: 'ee5ef42fc7199312e974e36b42b674110f8a7b10', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '66bfebbe8283f3e15d281833a2eb1a00bd91c3cb', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'fbf8040565069eb445601cc8695fc8278c5fa752', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '00a983a3d36f49dd9af760e22b401b25a885397e' }, this.renderRooms()))), index.h("div", { key: '553846fdeac6fde4ee8487d891fdfad80416de51', class: "sheet-footer" }, index.h("ir-button", { key: '9f3dd98147f9e37769609eaa0eabe340a957cee8', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '986700c792f95ad3b9de8e207b9e670759083dd4', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '7502d7ba62f632afb34536373529971918d826e0', class: "sheet-container" }, index.h("ir-title", { key: 'c3fa163958a05145f18138df8742a65bb8f41998', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '33ba79b4de3bcd484b34eeb22a28780c8f38e9ec', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '6c74e077717969d9e89ef4ff03b73c27b4969e00', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '8b1f654c5e94ec92da26745b27cc6ece3cc41e9a', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile) && !((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile), language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_d = this.user) === null || _d === void 0 ? void 0 : _d.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'de24b859d1d68ec01194e15fac51c623e2d3bc63', class: "mb-1" }, index.h("ir-textarea", { key: 'b40aa2efa912dc16800c988c3f5c1ab120710a54', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '62890c9c98fcab1fa25bd4f1872ad4a2ec8a236a', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.username, asyncParse: true, autoValidate: this.user ? (((_f = this.userInfo) === null || _f === void 0 ? void 0 : _f.username) !== this.user.username ? true : false) : this.autoValidate, errorMessage: ((_g = this.errors) === null || _g === void 0 ? void 0 : _g.username) && ((_j = (_h = this.userInfo) === null || _h === void 0 ? void 0 : _h.username) === null || _j === void 0 ? void 0 : _j.length) >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '9f729323a93870bf6ad5cd2bdb74b4669965f6f3', testId: "password", autoValidate: this.user ? (!((_k = this.userInfo) === null || _k === void 0 ? void 0 : _k.password) ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: (_l = this.errors) === null || _l === void 0 ? void 0 : _l.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '76b95f53f4099909dc696fb923b17cdf0d06bd7e', password: this.userInfo.password })), index.h("div", { key: 'f09f29e3b1a1e3ef1573ebffb964902434b5977a', class: "sheet-footer" }, index.h("ir-button", { key: '3e917d4b81c1adc2cfc1e61c6239392634c8039b', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '11c4a79e7d899e6d09db19fa1e8830841f6edec7', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
