...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '01bf2eb5e53a7206f751e9c40250f603a05e124a', class: "sheet-container" }, index.h("ir-title", { key: '8b29953073728caa90d977a5899f69986181aed9', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: 'cdd8c47568f0c0cc98b3ebadffa479ab232be5e7', class: "px-1 sheet-body" }, index.h("table", { key: 'f645ff9817157b15cbebcd027859a046e220312d' }, index.h("thead", { key: '638d4cc7154da99d6bc4451d40ae61f1afeb7f65' }, index.h("th", { key: '4c73d188aaf68dcaeb78fdc44882e0ad8f61c9c7', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'ed6342b9e6006ce72e1933c2c72f43dfa4b0aa38', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'f258642e2059068bc0c14feb27a8a0f325104b00', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: 'ebfcd7e7415c338b39500cf1bfd2d11daaef0de9' }, this.renderRooms()))), index.h("div", { key: 'fa12e087ec52816cc71544887ee449ae01490dcf', class: "sheet-footer" }, index.h("ir-button", { key: 'adb0e9dd8aabddfd36511e33f2d6c4201cd9da61', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '839353d8463e430f4306c14a9012f572e2dea70f', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '685b59ce7d17fb285984d4549ea9b45b8e8b0bce', class: "sheet-container" }, index.h("ir-title", { key: '510ac7bd74b89ec0cdae97bbdc14a594a31d3828', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '1930332c48f4de281de6be67fbd662d4ad024167', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'f57ce56815b6234a6d5e48dd7b9b0d73f071303c', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '82e74b5abd96d3362c3b96dfbb50d0fb501fc294', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '3ac59489152279b83293bbf08bd52e818dbc4885', class: "mb-1" }, index.h("ir-textarea", { key: '552eda6902c9b247ca112b82a96fd94ef25970ce', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: 'c6471c2e8481f4d429aa42fcbbe070e976c55706', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'c1fd7056a36f3e1119c733706d4645712c7c9007', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '795c091f6547164ce6765217a9faccf7e4002e98', password: this.userInfo.password })), index.h("div", { key: '3befcad2aa71a46ac472ffc1879f1170d0d95955', class: "sheet-footer" }, index.h("ir-button", { key: 'ee768b7b2fbd259f817ac3dc3061dee066263416', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'cdbc9482e522f4032c8ddd292ff4d96d74b44055', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
