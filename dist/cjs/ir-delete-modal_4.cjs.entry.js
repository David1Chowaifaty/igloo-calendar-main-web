...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '12a2b7564bf5b86a6f895246993c96a675f35c5d', class: "sheet-container" }, index.h("ir-title", { key: '2edc67b83225155f711b0e5f1293db6484a3092e', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: 'db4e1784a9bbf03fa85ebec793b1a89f5df346d7', class: "px-1 sheet-body" }, index.h("table", { key: '800c8044f7be2b34d73e6878c7bb548ad6385aa0' }, index.h("thead", { key: '1006b6cfa351d1b05d3376d9f8fbc95ac9a7c802' }, index.h("th", { key: '262b5285849af3045fc341859b9a91e55183ec5c', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '682a2bb6d1c95bb11e77a0f55acf7bb4ee38830b', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'a9760d3244ab010820cd550aa4baf45dac44a654', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '58f8fcd7cef88983b853ad8b85d0bf6f66b48b5c' }, this.renderRooms()))), index.h("div", { key: '03aa2942a20874afca17f6aac1a1e22e25cde64a', class: "sheet-footer" }, index.h("ir-button", { key: '4928064e3b50034869b2980a86ea63678bbda6f0', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '1c088e6906896eafbe75c73a8ea03419cfad1122', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '5a67404b4c5c40ba596d165188da2fdc5ba7ecde', class: "sheet-container" }, index.h("ir-title", { key: '5df3716dc69c84ee654ef837eb02e270c76865be', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'eb6e4e77b34e516093cff413c010a02605da2e8b', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '551f03cc20b6948d7caa8106aef380178761ea68', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '219ab89f4b543addc22036f4384bfb65705f83f1', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '36acbb106b6772441598db81acf382597cffa570', class: "mb-1" }, index.h("ir-textarea", { key: '4e3d7a474f656504fa7c68f7b19c6cb2347b7e33', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '810fc6be75d7585b4ef68becd3d18ae6e876108c', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '0f50febd99deec04b12edfe9cd5b3c841e6924a3', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '4a82815abb445e7948f1ba819f611948c7c5a221', password: this.userInfo.password })), index.h("div", { key: '4c69b9bf1b6603bd99bf6115b74eb3981eb9bb53', class: "sheet-footer" }, index.h("ir-button", { key: 'd80f51ef4cd8b58f3a931f2b8b38a6c1b1aa2773', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '1c8a6c2e9a455fc0435b84b00276ce68eaf92cb9', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
