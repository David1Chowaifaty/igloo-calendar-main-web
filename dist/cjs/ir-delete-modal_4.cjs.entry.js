...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '7927b7eae2990cefbaf4ae1c5c7d31e538cdf648', class: "sheet-container" }, index.h("ir-title", { key: '9704ea0fa80f43e06c500bac63da854f49a853f7', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '8c6cd21701c3c84d51da76b6c081af9e70292940', class: "px-1 sheet-body" }, index.h("table", { key: 'b1786f7a2b138c296c50ad561716878a0930664d' }, index.h("thead", { key: '87198889dbdaa186e341ca03cb480cdf852651cb' }, index.h("th", { key: 'd48be69efc0016181c4596d2d7d53f0983195cab', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '86e74b55553bdccecc5d7d1764e98b9d71750b45', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '79f7fcf8c52b472f908496607a82a06d713a62ce', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '3b7be978b8225722069e8b9828c6f9e2321f7bd8' }, this.renderRooms()))), index.h("div", { key: '6292ace831f6e02ba7084150226c51bbb69fc5a0', class: "sheet-footer" }, index.h("ir-button", { key: '08c0def7021b79507ec9f871e7761be0e49c8f97', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '333daf6f8661599bcb5bb415a938a65374244a0b', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '7103d3a2fd4b9e049ef58ce930b79c79564c4244', class: "sheet-container" }, index.h("ir-title", { key: 'f67e9175dcdcf10dc5cc02391a3c1361251f11d9', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'c7a345cc5bc1cf635b908df3297ddd2dfd78b216', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'e3979d7173624fc57ae2771a3077d592f22fcfbd', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '6c60ee9154b876f2de2db0e6328120be2bb0a591', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '89b43b0d90a27cd7c42b6f42954bc7a551fd488f', class: "mb-1" }, index.h("ir-textarea", { key: 'ff324789a0d324e1b894e5533ad690adfed2b541', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: 'a7b01509ef172a1c7cbd6fdaa179ac9a0e120c0a', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '50e0d01c39f71e87d7a031343b5fca4da07782d7', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '7f8d027a5abfaa958c676ae710bd56f96e5dce73', password: this.userInfo.password })), index.h("div", { key: '79971c6a05ec13a94e4b5aa13470a718f3b525d6', class: "sheet-footer" }, index.h("ir-button", { key: '5dc9b568d270f2bb54e8213b70ade7a9800ff9f9', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '021efd2f157bc784edf87ccbc19ea8c61118c1fd', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
