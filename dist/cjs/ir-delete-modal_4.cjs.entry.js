...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'b534470349c6a71e2ec22e37fc167803254382e0', class: "sheet-container" }, index.h("ir-title", { key: '3d46fcd97a8461f35a6eb92b41577d4ccadc878a', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '01958c0a047d93bc74f0c9a3d7af2244b246297a', class: "px-1 sheet-body" }, index.h("table", { key: 'e24287faf098196c4573b49a2819c4c86f2c00b3' }, index.h("thead", { key: '3588a99b88e6378b2c5b1ab7a605abaf84a7e5d7' }, index.h("th", { key: 'aa99f7269564b9b76e5a7b89fc3c96e794ae0644', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '99e7e36f8c46bd6fdb503a2bf2c98a488734ca2e', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '37de295444e4ec17073c8aefb494e96967a8d85b', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: 'b3bed83b4ed1a7f88f51d8770a7a2f3e26b096dd' }, this.renderRooms()))), index.h("div", { key: '392a20ae741d062db04e6f06d82c4fb031890c53', class: "sheet-footer" }, index.h("ir-button", { key: '3ac0a979792eefee4e43febbca1aeddc22fbb53f', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'b5584b2bc2dfba4f890c1fe0e3c6cf5b8896cb2b', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '2f9a736254973febda69dfbf6cdc0931c0fce298', class: "sheet-container" }, index.h("ir-title", { key: '92c99e8ec34a40b190cded6b7279e2cb00496615', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'ff4726a9af1aa83b3a00e7c76ed3628023f011df', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '1c2e85a9793ecd367b269d4fe024b5699b90524f', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '881d2dc02c3af9dd828dc9ae2cdbfce2b03d8cd9', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'cd850b8ec5fc1309f938c575595defc2c30b9b7e', class: "mb-1" }, index.h("ir-textarea", { key: 'de3614dc12ed2be41d2d91c72d74c7977d4c0cc4', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: 'e3f2fcbd51f5bbb16573f1ea117781a93efcdfb8', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '69469fcf55d640889e49d75e885ee69317d5ec0a', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '2a03bebc8bce651f57f31e58409da30be28207aa', password: this.userInfo.password })), index.h("div", { key: '006f4964985e394067be2f5c4388f604c8f21ea8', class: "sheet-footer" }, index.h("ir-button", { key: '1f8ac1b9aeaf7b6f58c61ab9619049b49f935bae', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'c4c1a62288656d30f95f2bceac7c66aeef8c2ed8', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
