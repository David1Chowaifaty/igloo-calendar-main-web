...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '942dce727480b7b25364e1832b4563cab9fbc30c', class: "sheet-container" }, index.h("ir-title", { key: '1f136eb440be834b5cf6a474fbe833fd6836eaa6', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '042c5e343c0a41407a8346803f063231e66a07f1', class: "px-1 sheet-body" }, index.h("table", { key: 'd1133c3c8a2a2a9515d99922cc3a6e8f6271c6c3' }, index.h("thead", { key: '4ea61e71227b5f9000f1a31d42d0db331faa5d8b' }, index.h("th", { key: 'ca58cee46ced62d2368e1f531b81111015273c73', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'b969fb5d66890f6653a00daa26452ffa9fd26486', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '8391ea58503a534f6baadb17b043f4f915fed024', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: 'e5b1c2caa9821e759a8dcec4a048cb68a88754ce' }, this.renderRooms()))), index.h("div", { key: 'ceff337d8eb9b5e619ef28406f29cea3bc434ffd', class: "sheet-footer" }, index.h("ir-button", { key: 'a49b7887ba30a7246899a313b565980b00b2e477', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '8e3bacc92265601a8f85afb5fd7cf62a8650fb6f', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '58eb77984ff28d333a68437f09cbafa9ff151232', class: "sheet-container" }, index.h("ir-title", { key: '9218f498875e0535aea46a5dd7905178ee8d45c8', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'f5b0fff08382659e167d35eebb7ea6816414ba6b', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'baab161887a7013a8dac244b25fea8212f2fab46', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '7344e6f61873970c423eb726dd485818bae01725', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '567c7c831defa2d0cebe6fa56492bf3a8510ece1', class: "mb-1" }, index.h("ir-textarea", { key: '5f7f4393ade7d5d3e63147576be9a3325b1308cd', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '363cdce678018461af2b873c6cdf2c99e0d9894c', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'ec8a0f584e3f89cb0bda594cf60a07cd73d18697', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: 'bdcc8aa5caad2293613e13b7eea0ac5744e54643', password: this.userInfo.password })), index.h("div", { key: 'b1c843f5ef89ecc465940ee0318c99a693d8c931', class: "sheet-footer" }, index.h("ir-button", { key: '8f21cd82b5efadedd8d9500e4905ba79b3d330e4', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'b03a5c74673f034e1f7baee52cfd87ee7f55ed5f', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
