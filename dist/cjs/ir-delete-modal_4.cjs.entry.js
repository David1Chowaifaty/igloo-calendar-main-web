...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '8bc658b6bb9c24f54671ef8927b5f07f5228851b', class: "sheet-container" }, index.h("ir-title", { key: 'b38097f9cb9ea87c0f9e459c5408f2f3b5e0f751', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '9a1e3c1f0cff33873bf4ce5660eef290f4339aa9', class: "px-1 sheet-body" }, index.h("table", { key: 'b8b9144000162d676844f5077a49d6125f524673' }, index.h("thead", { key: 'eaabba01dcb401088cb6f6a1216708b93497a5ee' }, index.h("th", { key: '481180169c1455fd9630ab1ea46b08f517038388', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'aa5787face28573501475331018366abee08ed2c', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: 'be97cd3c7fada8019329d4b85f2d930e32ae8089', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '16449aa32f12de6c461b337c4e463f711117ab03' }, this.renderRooms()))), index.h("div", { key: 'b8438e2b19154588d9af7d60e1e5f6be4614fe0f', class: "sheet-footer" }, index.h("ir-button", { key: '42a2c28e9a7d112d5c02fd9c7351b6eab296e5f6', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '5300aec795dde4c77375c9e826fb453d2150bd89', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '9e3399d3d23df2f360d386a3382f150830eccaaa', class: "sheet-container" }, index.h("ir-title", { key: 'ddfa528ee2eb5e9adb417d153267b0a9ff4d8df6', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '88cb6ccb8f61f4b80ed2f980a8ca438cf77cfa1f', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'b4d97b394624be0e2a661cb58ab0d128f6f4a4b7', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '1e2200ba66428e0144872651288ed92a72682323', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'c440a3996aae1f3b2556444466f10e604d698198', class: "mb-1" }, index.h("ir-textarea", { key: 'cd62e9e1715a13537bdc89a0b4247c2db0d3f151', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '60d8c9cb6e78a524c4e193dc4857382120508f50', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '900b85e551836b6015ce3ba149ac9454f6b48807', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '5629076e9fece47ca8371f6f3d2a080a7c849e88', password: this.userInfo.password })), index.h("div", { key: '135535f9a5ded2a4f2b8f89fe8c1a4886598452e', class: "sheet-footer" }, index.h("ir-button", { key: '6da2bd50dff534ac99f61f4a204ef8c5a693cbcd', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'b77720b0870d1bd0395531aca848fbb5d74fdbbe', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
