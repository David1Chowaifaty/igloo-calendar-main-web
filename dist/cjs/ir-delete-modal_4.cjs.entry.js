...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'ee113120cd9b8bb2f16aaf3802bb52439fd705f8', class: "sheet-container" }, index.h("ir-title", { key: '9729c2a90888e48d518d79d2cfa4facf511540af', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '0edfab1aa96a5604d87cea2d5967e4a14d2aec0f', class: "px-1 sheet-body" }, index.h("table", { key: '75ae4d7e1819d38a239513395f4101237ea1fe96' }, index.h("thead", { key: '35501e0dfc1ec4a853228382123c11b2e43e0826' }, index.h("th", { key: '11605fb514a63876e827b2dbed47b1f3196171c1', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '9eaa3888226d256cb86ff212ce06321f0b5b1233', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '6f99475a0f1e55f92fc0545250835e829703a20d', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '645dc164a3b6571772fb66dabe73c417a2fe8cba' }, this.renderRooms()))), index.h("div", { key: '0af67cb78188577d818492401d502cc00d72eebe', class: "sheet-footer" }, index.h("ir-button", { key: '802c58fdadd21b0d96f58f327e191c796a383160', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '4a3df3be4959860ae9d6f2555053b2d8eda12af5', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '7504fe5efc76a58ae5eca8bdeab52e3744bc4c77', class: "sheet-container" }, index.h("ir-title", { key: '6c63aeaade73f35abe7558cb81a7a9383c1a5b17', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '32d6d36c0c0f63c013fcd6cdd36dd9da025611a7', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '8f3f6e771d1f33cac6e4dbf3dea0c873637642cb', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '491cf41c2852768e6b39767d83758d9f8589b0ad', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '399ba4f8b7221ea5e432b395976c7ba46ec80e41', class: "mb-1" }, index.h("ir-textarea", { key: '81e1252e5397db956de59e8ddeca28c63ced7615', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '6ae9515e6e586540666b0f71200d11c679579fb6', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'afd753ddf7f3b870ba207acf533b514047a14cc3', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: 'd0290dc56777982a5dc0180878fb827a61baf65c', password: this.userInfo.password })), index.h("div", { key: 'a458c34b02836e1379adce430b607a9b126c0e22', class: "sheet-footer" }, index.h("ir-button", { key: 'daab4e0c2b157ca99577967dc9c1f28594533625', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '0492bac9f03be1745c4e95dbf378687bec4e905d', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
