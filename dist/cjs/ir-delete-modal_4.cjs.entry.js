...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'e8873d269c9ca4b962978890872a287554350f45', class: "sheet-container" }, index.h("ir-title", { key: '320a805c1a1da121d006276eb4ab022814477a6a', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: 'afa254b286d30f034c670d214a59a4fe00024c28', class: "px-1 sheet-body" }, index.h("table", { key: 'd33c917433a7ec4ad45b7052ace3846431797f8e' }, index.h("thead", { key: '1eea775d81c0ad37302df74c101e30d975de9beb' }, index.h("th", { key: 'e5e70b98bb2c297ccb2fce0fbf614654f99aa224', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'f8c58f06507ea8bd094131399b6e864062be913c', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '3b00b2780dbdf3e3384ff55a06247f0c399f4bb3', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '1c0cfae5004bec6907f0ecc12424f5831addfb86' }, this.renderRooms()))), index.h("div", { key: '966f0ce1fc9bf02bb8728eba95fedcb528531bd4', class: "sheet-footer" }, index.h("ir-button", { key: 'c73bcd129f9860ea69fbaad5734f3461ff20c13a', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '85c1776381e3554cb39f652de2b5753e072f12b5', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '9d68a96059b038007f640bae4cdcb2d026bcda8e', class: "sheet-container" }, index.h("ir-title", { key: '2a6d7e57c04ea2b6979de2af43c129535e264b04', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'a69eb229aee6461fc7014e8076e866c34166f8e7', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'f4a3bfe9e271f2b70f0025898913e68a8de03bc7', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '751d9a2b92b991c0e0ac40739bc303c4535e57e2', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '36917f7b2a95243404df88c8d64fba9e8f82383c', class: "mb-1" }, index.h("ir-textarea", { key: '62eade083fa8e52008433b0a59115cfc4c5fd9b3', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: 'c0724b9bfde095c7d3eb7123f73bb5fbd3ab6373', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'a7686be9d3215b39487ab5ca8108851e221be6ad', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: 'f9a132cf9cefb3623e446fb70c10ef920f657c46', password: this.userInfo.password })), index.h("div", { key: 'b611ededea4cd5132f6852adf07c210b671302e6', class: "sheet-footer" }, index.h("ir-button", { key: 'e1e14e9420933977b872d1121bd46ef06dbfa8a3', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '4032fa3b0235a1b6698a9ea1556f3682371485db', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
