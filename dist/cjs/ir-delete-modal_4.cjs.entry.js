...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'b1ce01bd71d370c36d26c34f79eea228e0f73389', class: "sheet-container" }, index.h("ir-title", { key: '35a548d546004cef2cea1579a0c68897c8f94c1c', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: 'c3f887ba6dfe8df8bbabb73235d503bd4751e198', class: "px-1 sheet-body" }, index.h("table", { key: '9d7cff01eef1f865593277b5414f64cc370e8742' }, index.h("thead", { key: 'a768924b1176e81bb5395dc55e9a5f75f3a591bb' }, index.h("th", { key: '6ebefeaa3c0bd4b051a02eb67c1bb4bdd89419bd', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'b52e60e95ffe6ae90bb04ce626d1b51ade76f6f2', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '668a3e28630acccad0c3030ac81d603d80bd6dd8', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '7a8f6369685bd4d50791a6eb27195a30a41ccdf0' }, this.renderRooms()))), index.h("div", { key: '8e6763576f40d9c85cc0d57752aaa6b8186fa17a', class: "sheet-footer" }, index.h("ir-button", { key: 'f0e588343245056ea66f6c96fb5b7dc2c9bcde35', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'a22c1d4a45626f08c1c56df0468e69d3fe45cf26', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '2a2e6b85170d061be8156d360b9af12ef7fd935f', class: "sheet-container" }, index.h("ir-title", { key: '53f1d3c6d081b09ab8d275187c5fc14eee8b5b2f', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '31c39932aaffa2a16e82bc3954a108ce923df0e9', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'bd00d2ed1492eec46ba19ceb06aea5558f6e9ec3', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: 'ab679e7fb4250722f958919f06e25f15a9ddf339', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: '27ef532682f638578792089d8941994b20009200', class: "mb-1" }, index.h("ir-textarea", { key: '78cedc3f15a21b820a71dc44e44688727300df3f', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: 'ad930ed227d737969e8c27cf314af15ce5067d4d', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'a995456baccffc96b477aec3bc7aa37389a29bfd', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '8c6d0590fef3840d3bb14d4194f3c26d3e616c83', password: this.userInfo.password })), index.h("div", { key: 'cad706119a11690397ad24b86197e6ffc9c60d6a', class: "sheet-footer" }, index.h("ir-button", { key: '29c9dd22e43d190a3e0f077178bb741d3890e20a', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '9a07e3c37a0fcc72b07630950b9844b7669397bb', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
