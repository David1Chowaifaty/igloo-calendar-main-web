...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'ef460de5a5c9560e6b926c0f11e1e86d1a41c9c1', class: "sheet-container" }, index.h("ir-title", { key: '40778e6f64797cd5a7730e9532756de56f00d2d3', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '6af4e4880598de891d3994f2d47ec7f4bc73bdd4', class: "px-1 sheet-body" }, index.h("table", { key: 'c94c8d1751523857094fc6d3b48049ebd7b591d0' }, index.h("thead", { key: 'c8f1cb340241e87aebecb9c30656248c2110221c' }, index.h("th", { key: '066c2e3148f33ecf9a08744afd51adeb41cc8dff', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'a5d37731b05e82b42e2958f07107f64714b31ea4', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '9a8a611cd44c3936f91ce1f343ec4840d7620a33', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '9cfa6adbb1e8f5e1f2b082cef805974ef200c522' }, this.renderRooms()))), index.h("div", { key: '31e178da27467f5e92af59faa517aaf1edadcaff', class: "sheet-footer" }, index.h("ir-button", { key: 'f0fc9c1de5b6c779834bc9b99f5b7ac04251bbed', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '9837fc1928ab49bf043caa2cc916b6d8654744ff', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
