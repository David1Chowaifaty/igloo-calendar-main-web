...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '90d91b57192e86f8613240cd59dfcea38804c134', class: "sheet-container" }, index.h("ir-title", { key: 'e5a88afbac7db9bdf4b771e90b1fbb4d74da7ff5', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '7945bf4966c7bb7e6cb78675ad42c11bd5bcd92e', class: "px-1 sheet-body" }, index.h("table", { key: '566954346ab30d2553f0670d7a086829a6b218fc' }, index.h("thead", { key: '230a3294b7b29fbb3f5a25e4e9fc54ba452aedc4' }, index.h("th", { key: '5f323620a3625f2b5cc83a79f0f5ffb7d0d97272', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'e66b28bd2f6cab7fa870cbd1a172148481dbdb35', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '11d3f6429a917e0d6977142d7a1300f757c39014', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '85c9d1c51ca79f4cc699e1223e159638f81182bc' }, this.renderRooms()))), index.h("div", { key: '4a7eccdaa5d2f3fa94e7a8601a5c49acb748982b', class: "sheet-footer" }, index.h("ir-button", { key: '1e698e6d6d8547f79ea21fc0e173e8e54cf04c1f', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '8f24e536390b12c0d98088a65b32bf47e5c3a33f', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '917bf0fd92a2eb00ea01fa49165511bdc6eaec05', class: "sheet-container" }, index.h("ir-title", { key: '87333a8bd1ef7344dbf56eaf4c9ccbf989e03267', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '77b5cc707747f1fa84a7f751c548862cfda24252', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '3d3f335445595ed0a7e438f5047fcc0f9582b088', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: 'e593d6bc389ccc9738006c5ddf926203b1f430f2', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile) && !((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile), language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_d = this.user) === null || _d === void 0 ? void 0 : _d.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'd539096a2d3e300e8f2a5afed5610f42f8e0e69d', class: "mb-1" }, index.h("ir-textarea", { key: 'bfd2b601ab19a6931f959722fa3f17d64bcae32e', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '72a651d496e61e39cebc913c43f922ff1b8fc004', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.username, asyncParse: true, autoValidate: this.user ? (((_f = this.userInfo) === null || _f === void 0 ? void 0 : _f.username) !== this.user.username ? true : false) : this.autoValidate, errorMessage: ((_g = this.errors) === null || _g === void 0 ? void 0 : _g.username) && ((_j = (_h = this.userInfo) === null || _h === void 0 ? void 0 : _h.username) === null || _j === void 0 ? void 0 : _j.length) >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '8171be6bfc230c330db78d5ed5ac98cad90472bd', testId: "password", autoValidate: this.user ? (!((_k = this.userInfo) === null || _k === void 0 ? void 0 : _k.password) ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: (_l = this.errors) === null || _l === void 0 ? void 0 : _l.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: 'b754d711435512d652499227b8ee04ca356c9052', password: this.userInfo.password })), index.h("div", { key: '368da02f9fb85ddd88f97750e3d53ce5b9237f31', class: "sheet-footer" }, index.h("ir-button", { key: 'a7e9e5d94bf0d2b6e90f511c0f471c7451f80f5a', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'd16a58c0d390597df902d92f05b12cdce8aea2a7', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
