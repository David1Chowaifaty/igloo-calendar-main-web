...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: 'fc7f8baca520c20250f113c4486224594433b522', class: "sheet-container" }, index.h("ir-title", { key: '6999840cf3880404164a104f38a648ed4e70d352', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '712098b5956885703dec5ce9e66199510a814809', class: "px-1 sheet-body" }, index.h("table", { key: 'd37daaf2c0ffcdb97f4f80be61b4da3128966a84' }, index.h("thead", { key: 'f0128d19f77e475fd961ce96114352bac95ec746' }, index.h("th", { key: '77d297812536e132f0f37b58395749255817fcca', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: '19a2d9af6790ad2dd7f1680cea2fa08216f83549', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '9049368d50b6465d74615afef43ac829fbde40d1', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: 'edfea06b9eda8ab874758812d91201cd528063ed' }, this.renderRooms()))), index.h("div", { key: '59604773f8dde024e94c794c3602cad256143d49', class: "sheet-footer" }, index.h("ir-button", { key: '3fefc8ba89cfb57470b5fb18423a3791dd66477a', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '29329a6c267685f6243f3fb5eb557aee1baab967', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'be439185ce492023742dc8f869d5828baaa00ecd', class: "sheet-container" }, index.h("ir-title", { key: '1449ce5dc1bf4ba7fa7597aa81deac978a1aff64', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: '6bd5933787c9861a10903f00b23b56d4c8f73a17', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '44be6533192d0a4b9c45b07fb1e78cc7594db3b3', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '671c4cf35742b2d329a51a127dd6514500c77106', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile) && !((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile), language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_d = this.user) === null || _d === void 0 ? void 0 : _d.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'edd414789fe5fa43dd8d8f05fb73483a2796b605', class: "mb-1" }, index.h("ir-textarea", { key: 'eba9c2a1320aff14b51f93fc4bc1b8cea7bfdd68', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: 'cc4d4b3d5db01da6a251d96a3174b5679964dd04', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.username, asyncParse: true, autoValidate: this.user ? (((_f = this.userInfo) === null || _f === void 0 ? void 0 : _f.username) !== this.user.username ? true : false) : this.autoValidate, errorMessage: ((_g = this.errors) === null || _g === void 0 ? void 0 : _g.username) && ((_j = (_h = this.userInfo) === null || _h === void 0 ? void 0 : _h.username) === null || _j === void 0 ? void 0 : _j.length) >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'e99f4ad5b1752efc882c102aa7a582f9d7260f67', testId: "password", autoValidate: this.user ? (!((_k = this.userInfo) === null || _k === void 0 ? void 0 : _k.password) ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: (_l = this.errors) === null || _l === void 0 ? void 0 : _l.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: '15fa94419aa8963e855095c706602d5b044ae6e1', password: this.userInfo.password })), index.h("div", { key: '750dad21a3e3e6be1346c1701163377add63e72b', class: "sheet-footer" }, index.h("ir-button", { key: '4e5e40223b3410378225b22fa4e87bf7283f9fc4', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '0e487c498c99faa656d39b214027d745ef1631a5', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
