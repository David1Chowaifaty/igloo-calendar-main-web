...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h("div", { key: '31bc4e64b9e142308c57b810787b14793889b770', class: "sheet-container" }, index.h("ir-title", { key: '2b43cb160dc1067b6fcab1351aa20fe369e82366', class: "title sheet-header px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: 'fca887d7647c327d2f745d39589527ebf26bc559', class: "px-1 sheet-body" }, index.h("table", { key: 'ce847e1dc2e76e36afd23d3061c24048f355956b' }, index.h("thead", { key: '1fb0048972ea25262b6da70fd769d21b737f5ee4' }, index.h("th", { key: '67a111b59ee65621674a6c3d0a5e25cc3d7d7e91', class: "sr-only" }, locales_store.locales.entries.Lcz_RoomName), index.h("th", { key: 'df0a26ccc5232ea55771744cc0ca08e984a0410a', class: "sr-only" }, locales_store.locales.entries.Lcz_HousekeeperName), index.h("th", { key: '656a1c5a56fb893b810e0f6484fea7af492dfa00', class: "sr-only" }, locales_store.locales.entries.Lcz_Actions)), index.h("tbody", { key: '4d75b2ed4757051209b14b29dd98f23367fe8e85' }, this.renderRooms()))), index.h("div", { key: '01f6cbd45728debe2f0f393d557e81f8f4c6664b', class: "sheet-footer" }, index.h("ir-button", { key: 'd7e256cb4611f5d5bc9b3d7d08b64ca97354f997', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '83824f2709dd426dd38b56179a4b74f431154d44', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Confirm }))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        return (index.h("div", { key: '923f899472eaa6ca480b67e2c81bbc22529b2c6a', class: "sheet-container" }, index.h("ir-title", { key: '26a4ec602e49a55a1f1f97687a2472a742cb1d07', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'e9fccfedc623a507aac6341f10359f344d4845a0', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'f16435316e9be70699bdb4d634beb2d67d053078', testId: "name", zod: this.housekeeperSchema.pick({ name: true }), wrapKey: "name", autoValidate: this.autoValidate, error: this.errors?.name, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-phone-input", { key: '664fed0c124a7c40b94f69fa89253db0a466872d', testId: "phone", placeholder: locales_store.locales.entries.Lcz_Mobile, error: this.errors?.mobile && !this.userInfo?.mobile, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: this.user?.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("div", { key: 'c27a5820316b74e57b30a9c7e3fae8521fc7f313', class: "mb-1" }, index.h("ir-textarea", { key: '81878c1d62c070c8cd520a255ee4e9131dd7f7d6', testId: "note", variant: "prepend", maxLength: 250, label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) })), index.h("ir-input-text", { key: '0af5539b07a1c120095ea5b14f2da787c9eb5fec', testId: "username", zod: this.housekeeperSchema.pick({ username: true }), wrapKey: "username", error: this.errors?.username, asyncParse: true, autoValidate: this.user ? (this.userInfo?.username !== this.user.username ? true : false) : this.autoValidate, errorMessage: this.errors?.username && this.userInfo?.username?.length >= 3 ? locales_store.locales.entries.Lcz_UsernameAlreadyExists : undefined, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: '2591ed4f4d034cf646c30f54ec2844dceddd3b85', testId: "password", autoValidate: this.user ? (!this.userInfo?.password ? false : true) : this.autoValidate, label: locales_store.locales.entries.Lcz_Password, value: this.userInfo.password, type: "password", maxLength: 16, zod: this.housekeeperSchema.pick({ password: true }), wrapKey: "password", error: this.errors?.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
                // if (this.user) this.showPasswordValidation = false;
            }, onTextChange: e => this.updateUserField('password', e.detail) }), this.showPasswordValidation && index.h("ir-password-validator", { key: 'a9390c5da3327a7ec887ce0b7064b9987a381ecb', password: this.userInfo.password })), index.h("div", { key: '5d32230d1d90b9bc7d0cf9e859247b5410a1fe27', class: "sheet-footer" }, index.h("ir-button", { key: '519d4ef50f54e706ea87d86d17a71614da9ea014', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '624043879a80f9ac9b1174dba01202155ec22139', "data-testid": "save", isLoading: this.isLoading, onClickHandler: this.addUser.bind(this), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
