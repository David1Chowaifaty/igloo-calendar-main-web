...
const IrDpReportFilters = class {
    ...
    render() {
        return (index.h("div", { key: 'ade02fc338bbf18495d39f9b4c16e1519c4791c9', class: "dp-report-filters" }, index.h("ir-date-range-filter", { key: 'df6d726e60696720b3318b712ff5809d3496bd8b', class: "dp-report-filters__date-picker", fromDate: dp_report_store.dp_report.filters.from, toDate: dp_report_store.dp_report.filters.to, minDate: this.minDate, maxDate: moment.hooks().format('YYYY-MM-DD'), showQuickActions: true, quickDates: this.quickDates, quickDatesMode: "range", withClear: false, selectionMode: "auto", onDatesChanged: this.handleDatesChanged }), index.h("wa-tooltip", { key: '6c8585f240c28115d9c9c582d4dd3866e72823b4', for: "search-btn" }, "Search"), index.h("ir-custom-button", { key: 'cb6bcf88cd25727f8347d5d749b001c8a041c118', id: "search-btn", loading: dp_report_store.dp_report.isLoading, disabled: dp_report_store.dp_report.isLoading, onClickHandler: this.handleSearch, variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: 'f17ef0bca260c77ad02f1f65292f2bc99a310754', name: "magnifying-glass" }))));
    }
};
