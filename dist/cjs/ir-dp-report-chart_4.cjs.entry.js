...
const IrDpReportFilters = class {
    ...
    render() {
        return (index.h("div", { key: '9402fdb2ed3ff496ad1ac3e759cd4a9c2de12978', class: "dp-report-filters" }, index.h("ir-date-range-filter", { key: '3a1ea24739aef75e68ec426565ad183399a79da6', class: "dp-report-filters__date-picker", fromDate: dp_report_store.dp_report.filters.from, toDate: dp_report_store.dp_report.filters.to, minDate: this.minDate, maxDate: moment.hooks().format('YYYY-MM-DD'), showQuickActions: true, quickDates: this.quickDates, quickDatesMode: "range", withClear: false, selectionMode: "auto", onDatesChanged: this.handleDatesChanged }), index.h("wa-tooltip", { key: 'aca5c6339a3edc27eacf7ce6354e553d60b9fdfd', for: "search-btn" }, "Search"), index.h("ir-custom-button", { key: '48181f8eed408ae980d1b0b0848235810a794d79', id: "search-btn", loading: dp_report_store.dp_report.isLoading, disabled: dp_report_store.dp_report.isLoading, onClickHandler: this.handleSearch, variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: '8da6ad75c580b9991be07635ed48f0b8555e3cd4', name: "magnifying-glass" }))));
    }
};
...
const IrDpReportTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1817a033344d961786633b6af0648f088f26577e', class: "dp-report-table" }, index.h("div", { key: 'a4b887032d36aa94e814fda8480177b73dd955e4', class: "table--container" }, index.h("table", { key: '4f6704916740fbc94fa2e26cb9f667f23df7dd53', class: "table data-table" }, index.h("thead", { key: '3e3446b66f7fc7011a5be18caa667100000e047b' }, table.getHeaderGroups().map(headerGroup => (index.h("tr", { key: headerGroup.id }, headerGroup.headers.map(header => (index.h("th", { key: header.id, class: { 'cell--align-end': header.column.id === 'effect', 'cell--align-center': header.column.id === 'units' } }, useTable.flexRender(header.column.columnDef.header, header.getContext())))))))), index.h("tbody", { key: '4b83ce262a2165b15750af353beb7f1c81bd8a81' }, dp_report_store.dp_report.isLoading ? (index.h("tr", null, index.h("td", { colSpan: this.columns.length, class: "empty-row" }, index.h("ir-spinner", null)))) : table.getRowModel().rows.length === 0 ? (index.h("tr", null, index.h("td", { colSpan: this.columns.length, class: "empty-row" }, index.h("ir-empty-state", { message: "No dynamic pricing data for this date range." })))) : (table.getRowModel().rows.map(row => (index.h("tr", { key: row.id, class: "ir-table-row" }, row.getVisibleCells().map(cell => (index.h("td", { key: cell.id, class: { 'cell--align-end': cell.column.id === 'effect', 'cell--align-center': cell.column.id === 'units' } }, useTable.flexRender(cell.column.columnDef.cell, cell.getContext()))))))))))), index.h("ir-pagination", { key: '4efd7df88857592a5a13d3e5b9f5fb4f7c67b37d', class: "dp-report-table__pagination", total: total, pages: pageCount, pageSize: pageSize, currentPage: currentPage, allowPageSizeChange: true, pageSizes: this.pageSizes, showing: { from: total ? startIndex + 1 : 0, to: Math.min(startIndex + pageSize, total) }, recordLabel: "bookings", onPageChange: this.handlePageChange, onPageSizeChange: this.handlePageSizeChange })));
    }
};
