...
var dp_report_store = require('./dp_report.store-D3I92WOL.js');
...
const IrDpReportFilters = class {
    ...
    render() {
        return (index.h("div", { key: 'eb8b8c31c6300f8e821878a3ea273627b666569c', class: "dp-report-filters" }, index.h("ir-date-range-filter", { key: '3e389423ff4e11d06c51b40bc17c3ee7506546f2', class: "dp-report-filters__date-picker", fromDate: dp_report_store.dp_report.filters.from, toDate: dp_report_store.dp_report.filters.to, minDate: this.minDate, maxDate: moment.hooks().format('YYYY-MM-DD'), showQuickActions: true, quickDates: this.quickDates, quickDatesMode: "range", withClear: false, selectionMode: "auto", onDatesChanged: this.handleDatesChanged }), index.h("wa-tooltip", { key: 'f41faa6358ab3421ff7e0dbadf5727b990ba7f9f', for: "search-btn" }, "Search"), index.h("ir-custom-button", { key: '477f4ef2a2c4a42f69abe4d17a5a47ce3bfbf25f', id: "search-btn", loading: dp_report_store.dp_report.isLoading, disabled: dp_report_store.dp_report.isLoading, onClickHandler: this.handleSearch, variant: "neutral", appearance: "outlined" }, index.h("wa-icon", { key: 'e161d8f7d98cb61cbc34013d0e064b275f662d86', name: "magnifying-glass" }))));
    }
};
