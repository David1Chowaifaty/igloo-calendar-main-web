...
const utils = require('./utils-cb089e29.js');
...
const IrAutocompleteOption = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '8ca69e44075a12fe767d73d7b99616c3a964b1f1', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("wa-option", { key: '778e593bcaac83098fa1375dd90f178ec08b72c2', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, index.h("slot", { key: '6c5f2c7a562db4870b6138a99426ec9c09db61b0' }), index.h("slot", { key: 'aa99a1eda28da8bd5e9dc3a450394c01a1bd4f56', name: "start", slot: "start" }), index.h("slot", { key: '6a0e69dcfc6407bd5b5b086acfd7c005b7b2faf0', name: "end", slot: "end" }))));
    }
};
...
const IrCityLedgerFolio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '02f36dbea320839d70b32ecb3b3182b59ca9d838' }, index.h("ir-city-ledger-folio-filters", { key: '0939bac7767cf9e925f8dec1d1ec7bf4e40b09ef', onFiltersChange: e => (this.filters = e.detail), onApplyFilters: async (e) => {
                ...
                this.pageIndex = 0;
                await this.fetchFolioData();
            }, onGenerateInvoice: e => console.log('Generate invoice for', e.detail) }), index.h("ir-city-ledger-transaction-drawer", { key: '91f08418fafa4ca2cf165fd9a551520f1f6aeb8c', open: this.isTransactionOpen, taxOptions: this.taxOptions, serviceCategoryOptions: this.serviceCategoryOptions, agent: this.agent, onTransactionSaved: () => {
                this.fetchFolioData();
...
const IrCityLedgerFolioFilters = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'eceebbc6a6d0314decba84b3e2539c3431da4c1e' }, index.h("div", { key: 'b68c5876043fe69e4cfd275b006fd08f2ca0f813', class: "filters-bar" }, index.h("div", { key: '122cda4d4f453047f36f0cc6bb72ca4eb4448787', class: "filters-bar__dates" }, index.h("ir-date-range-filter", { key: 'e256f0c4883776a68edaaa027b378ac1f2b5eb36', maxDate: moment.hooks().format('YYYY-MM-DD'), class: "filters-bar__date_picker", fromDate: this.dates.from?.format('YYYY-MM-DD') ?? undefined, toDate: this.dates.to?.format('YYYY-MM-DD') ?? undefined, onDatesChanged: e => {
                ...
                this.emitFilters();
            } })), index.h("div", { key: '15f02a5eac3e78e057cca481ad87a7cae09326dc', class: "filters-bar__search-group" }, index.h("wa-select", { key: 'bb6b95fb5a303844775e30624c44af19925cabda', class: "filters-bar__status-select", value: this.statusFilter, onchange: e => {
                this.statusFilter = e.target.value?.toString();
                this.emitFilters();
            }, "onwa-clear": () => {
                this.statusFilter = 'all';
                this.emitFilters();
            }, placeholder: "Status", size: "small", withClear: true }, this.statuses.map(s => (index.h("wa-option", { value: s.value, label: s.label }, s.label)))), index.h("ir-input", { key: '890a5bf0ac0c1c15e82318a119ea07adfe230193', class: "filters-bar__search-input", "onText-change": e => {
                this.searchQuery = e.detail;
                this.emitFiltersDebounced();
            }, value: this.searchQuery, placeholder: "Booking# or doc number", withClear: true }, index.h("wa-icon", { key: '3a199b1164a2ad81042f2e6db138c4f52957d3c1', name: "magnifying-glass", slot: "start", class: "filters-bar__search-icon" })), index.h("ir-custom-button", { key: '60cbb2e715fb3426faf6a99292d411f191f9c2f9', variant: "neutral", appearance: "outlined", onClickHandler: () => this.applyFilters.emit({
                fromDate: this.dates.from?.format('YYYY-MM-DD'),
                toDate: this.dates.to?.format('YYYY-MM-DD'),
                status: this.statusFilter,
                search: this.searchQuery,
            }) }, index.h("wa-icon", { key: '3ffcf3083261c305d44dd4c9599c5c6a165c2e5d', name: "magnifying-glass" }))), index.h("div", { key: 'bd5a78b7247130f7dd39dd20d1f4fd44443f9d78', class: "filters-bar__actions" }, index.h("wa-dropdown", { key: 'bdb8b1d15bfaa721bd65eb9027fd2fe11f4afac9' }, index.h("ir-custom-button", { key: 'e390089e71d913acb3cbc1ad30f8d4356755b9f1', slot: "trigger", appearance: "outlined", withCaret: true }, index.h("wa-icon", { key: '9c7a455939fa4742430ef6d1a758ceaf95eaad8e', name: "download", slot: "start" }), index.h("span", { key: '5e5153d52a64472b02dab67fa84b93eb42695cb3' }, "Export")), index.h("wa-dropdown-item", { key: '7b56f0597d908f044eea40789ef0c0d520b9aac9', value: "csv" }, index.h("wa-icon", { key: 'd169b55bbc9f7705173e3a58f5e9c6f38a98b03f', slot: "icon", name: "file-csv" }), "Export as CSV"), index.h("wa-dropdown-item", { key: 'f763b8128142ca2ef2e7d0719a7e0ec2ed72b78b', value: "pdf" }, index.h("wa-icon", { key: '0ba4f96c97c4aa61f86027795f6f9a8ec87ff7e0', slot: "icon", name: "file-pdf" }), "Export as PDF"), index.h("wa-divider", { key: 'a1414404d61d75074ef61f97c49e4939c88302c0' }), index.h("wa-dropdown-item", { key: '62bf36297b8cb37bceebb7f47fc7680ace1e99d0', value: "print" }, index.h("wa-icon", { key: 'abbc209054f70cc6e17cdb4b7381a4af7faafb78', slot: "icon", name: "print" }), "Print Folio")), index.h("ir-custom-button", { key: 'ef22fd1260fe78ed5c674a3b773490e44da55906', variant: "brand", appearance: "outlined", onClickHandler: () => this.addEntry.emit() }, "Add Entry")))));
    }
};
__decorate$4([
...
const IrCityLedgerStatements = class {
    ...
    render() {
        const currencyId = calendarData.calendar_data?.property?.currency?.id;
        return (index.h(index.Host, { key: '11aa002fbc29c13bbfb808c8e7bd079b81bb79e9' }, index.h("section", { key: 'aa84c4b94dec0f02d0d25035292518692c860d6d', class: "cl-statements", "aria-label": "City ledger statements" }, index.h("ir-city-ledger-statements-filter", { key: '67972e1a14a4ec1c94aba3a40500e153f146c439', onFiltersChange: e => (this.filters = e.detail), onCreateStatement: e => {
                this.filters = e.detail;
                this.fetchStatement(e.detail);
            }, onPrintStatement: e => (this.printFilters = e.detail) }), index.h("ir-city-ledger-statements-table", { key: '57a8dfe39b3490033d3d356b640e9f7639eb454d', rows: this.rows, startingBalance: this.statement?.STARTING_BALANCE ?? 0, endingBalance: this.statement?.ENDING_BALANCE ?? 0, currencySymbol: this.currencySymbol, currencies: this.currencies, isLoading: this.isLoading, hasFetched: this.hasFetched, fromDate: this.filters.fromDate, toDate: this.filters.toDate })), index.h("ir-preview-screen-dialog", { key: 'd6ef8811bfe9bcdcc1aa358d499bae7a4550ddbd', open: this.printFilters !== null, label: this.getPrintLabel(), action: "print", onOpenChanged: e => {
                if (!e.detail)
                    this.printFilters = null;
            } }, this.printFilters && this.agentId && currencyId && (index.h("ir-cl-statement-preview", { key: '5c57548a37194914ddf7f5e5a94851fda8f8a686', ticket: this.ticket, propertyId: this.propertyId, agentId: this.agentId, agentName: this.agentName, fromDate: this.printFilters.fromDate, toDate: this.printFilters.toDate, currencyId: currencyId })))));
    }
    static get watchers() { return {
        "agentId": ["handleAgentIdChange"]
    }; }
...
const IrCityLedgerTransactionDrawer = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '4e9d9cd2d4b72947b982ffa5cc70507be0a074cd', open: this.open, style: {
            ...
            } }, this.open && (index.h("ir-city-ledger-transaction-form", { key: '9bcd2db54c1a5aa6ec456bc2433a9337f027e560', booking: this.booking, formId: this.formId, agent: this.agent, initialTransactionType: this.initialTransactionType, taxOptions: this.taxOptions, unpaidInvoiceOptions: this.unpaidInvoiceOptions, bookingOptions: this.bookingOptions, serviceCategoryOptions: this.serviceCategoryOptions, onTransactionSaved: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } })), index.h("div", { key: 'ba57c326f38ca10ca0b2974ce756a849898ee9fa', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '18e125f19ddb075d19601230e3404055ba6d313c', appearance: "filled", size: "medium", variant: "neutral", class: "city-ledger-transaction-drawer__btn", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), index.h("ir-custom-button", { key: '4bb9470c5255d3e63b731eb3b028cfd72bc566b2', form: this.formId, size: "medium", type: "submit", variant: "brand", class: "city-ledger-transaction-drawer__btn", disabled: this.saveDisabled }, "Save"))));
    }
};
...
const IrClAdjustmentFields = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'e99008a0f1fcfdac3e367b2780e86763f76ecec3' }, index.h("div", { key: '2b920def4476c32efe5c3f91a87bf3670dd6eb7f', class: "field field--full-width" }, index.h("ir-validator", { key: 'ef1420892ddad3ff3c693efb06fa878a156af9b3', schema: entryTypeFieldSchema, value: this.entryType, valueEvent: "change" }, index.h("wa-radio-group", { key: '212c5ec5c34f40ed1fbb612e62569b431104aa33', label: "Entry Type", orientation: "horizontal", size: "small", value: this.entryType, onchange: event => {
                this.fieldChange.emit({ entryType: event.target.value });
            } }, index.h("wa-radio", { key: '9577bf83d16da5d179920fa4aad6c1c02e217f78', value: "CR", appearance: "button", class: "entry-type --credit" }, "Credit"), index.h("wa-radio", { key: 'c6ca3ec310551d84191ab39d6ced7583334ce528', value: "DB", appearance: "button", class: "entry-type --debit" }, "Debit")))), index.h("div", { key: '38bf5cda3e61c80d7cad69463b0e4c9bc111e24a', class: "field" }, index.h("ir-validator", { key: 'c14f33d4d3fd13679bd7d3c897fe65874a7ce479', schema: linkTypeFieldSchema, value: this.linkType, valueEvent: "change" }, index.h("wa-select", { key: 'b3421057f25e25b36264c3c4bb9ddc1a4da6d275', label: "Link Type", size: "small", value: this.linkType, onchange: event => {
                const linkType = event.target.value;
                this.fieldChange.emit({
                    linkType,
                    linkedId: linkType === 'NONE' ? undefined : this.linkedId,
                });
            } }, LINK_TYPES.map(lt => (index.h("wa-option", { key: lt, value: lt }, lt)))))), this.linkType !== 'NONE' && (index.h("div", { key: 'ed4e2483a7992d50c4049e46cd3c08bb2f92da3a', class: "field" }, index.h("wa-select", { key: 'baedc8d36d8ed567f102cbc920f4cce0302b0658', label: "Linked Record", size: "small", value: this.linkedId ?? '', onchange: event => {
                this.fieldChange.emit({ linkedId: event.target.value || undefined });
            } }, index.h("wa-option", { key: '96455865b26d4b8636788401547183b262034388', value: "" }, "No linked record"), this.linkedIdOptions.map(option => (index.h("wa-option", { key: option.id, value: option.id }, option.label))))))));
    }
};
...
const IrClCreditNoteFields = class {
    ...
    render() {
        ...
        return (index.h(index.Fragment, { key: '8edda657d3099cf6fdfc30c72492ac1e0511e169' }, index.h("div", { key: '05055bea86bb4a83c8248c100214432466412283', class: "field field--full-width" }, index.h("wa-radio-group", { key: '600a24e3aef817ff8b15076a77017e0ab311ab15', label: "Credit Note Type", orientation: "horizontal", size: "small", value: this.creditNoteMode, onchange: e => {
                const val = e.target.value;
                this.fieldChange.emit({
                    creditNoteMode: val,
                    invoiceId: val === 'goodwill' ? undefined : this.invoiceId,
                });
            } }, index.h("wa-radio", { key: 'a361690c5342131f284aba22e2ca1e2bc14567ef', value: "cancel-invoice", appearance: "button", disabled: noInvoices || this.isFetchingFiscalDocs }, "Cancel invoice and unlock all items"), index.h("wa-radio", { key: 'c3d1ee28833131a14062f281d4b559845ce7792f', value: "goodwill", appearance: "button" }, "Goodwill credit"))), this.creditNoteMode === 'cancel-invoice' && (index.h("div", { key: '4cb54b7128366d22fcbefe229ffbf0036308df63', class: "field" }, index.h("ir-validator", { key: '82f2bcb6b7dab72cb09ebd4d443daf20b44692f2', schema: invoiceIdRequiredFieldSchema, value: this.invoiceId ?? '', valueEvent: "change" }, index.h("wa-select", { key: 'd442d68051017756aff0978aee4269989869b31b', label: "Invoice", size: "small", required: true, value: this.invoiceId ?? '', onchange: event => {
                this.fieldChange.emit({ invoiceId: event.target.value || undefined });
            } }, index.h("wa-option", { key: 'bb447ebc0e1dbc264c7d2e435f7b27eb8c34e34a', value: "" }, "Select invoice"), this.fiscalDocuments.map(doc => (index.h("wa-option", { key: doc.FD_ID, value: String(doc.FD_ID) }, doc.DOC_NUMBER, " \u2014 ", doc.FD_TYPE_NAME)))))))));
    }
};
...
const IrClDocumentHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd854bc3261f77a093873dc356615125dd42f92c6' }, index.h("header", { key: '0ff61f43652f3d6bccf6f2f5cc9400035260c5fe', class: "invoice__header" }, index.h("h3", { key: 'd68779416ec978d3eeba40a59aedaa1907af70ba', class: "invoice__title" }, this.documentTitle), index.h("section", { key: '5dc9f915e6ead22bc86db1ebb9042b0b1f03790f', class: "invoice__layout" }, index.h("div", { key: 'c4fcb0398707ee5a1b4ae8e60c1a5d58f2b2affc', class: "invoice__column invoice__column--details" }, index.h("div", { key: '02abd7cf544a8ce0f8f362e0dc9d28ea5a6c7150', class: "invoice__details" }, this.documentNumber && (index.h("div", { key: '5e8ebac839617ccf1331fc241849482b744ae606', class: "invoice__meta-row" }, index.h("span", { key: '2c096acb34af60ca84bf059b29a223ef9d322208', class: "invoice__meta-label" }, "Document #"), index.h("span", { key: '7eac7a35ecf997c898442ac074f35a5241b366af', class: "invoice__meta-value" }, this.documentNumber))), index.h("div", { key: '933a88aa7743e564c367c93c2aa9a382b9658ce2', class: "invoice__meta-row" }, index.h("span", { key: '70f1fb9db7c17e3b8ca589c155b8f2b0cba0b040', class: "invoice__meta-label" }, "Date"), index.h("span", { key: '054ed8bda474dcc604d95b1c14e2a31547849485', class: "invoice__meta-value" }, moment.hooks().format(DATE_DISPLAY$1)))), this.agentName && (index.h("section", { key: '8250815cd9644efa30f15ebdcfac1bda3391f9a8', class: "bill-to-section", "aria-label": "Bill to" }, index.h("h4", { key: '5e485ca0ad54786c1d65d9784292ffe33e011297', class: "section-heading" }, "Bill To"), index.h("div", { key: '23a942826c79d5a575e5da2ceea06aebd616bcef', class: "bill-to" }, index.h("p", { key: '8033c1489868ed8c3406cabd20dd040e571372e6', class: "bill-to__name" }, this.agentName))))), index.h("div", { key: 'bb41247cdd120968f48e6e16d5ef83c070640629', class: "invoice__column invoice__column--property" }, index.h("div", { key: '3905d5423d8272e3f7bb763cb1e7b8c7d7055752', class: "property-overview", "aria-label": "Property overview" }, logo && index.h("img", { key: 'aba9616576b029ba2bc94b48fccce643614c101e', src: logo, alt: p?.name, class: "property-logo" }), index.h("div", { key: '5acab6006e00b7c8669ba9064b4a8c5936594209', class: "property-overview__text" }, index.h("p", { key: '00c61a42023ad7924c55f30d179063fa0af5ff0a', class: "property-overview__name" }, p?.name), propertyLocation && index.h("p", { key: 'c6216c1d925cc142ec4c6a3fb479f67209aeeffe', class: "property-overview__location" }, propertyLocation), p?.address && index.h("p", { key: 'c1db5732505164fa88b760f4a37436baa2eeb192', class: "property-overview__location" }, p.address), p?.phone && index.h("p", { key: 'eda425ba01d2e54ac8be8a48918f987e6800f900', class: "property-overview__location" }, p.phone), this.primaryContact?.email && index.h("p", { key: '92adb0f8e0073f2698911b3e452a05b6acf1d47f', class: "property-overview__location" }, this.primaryContact.email), p?.tax_nbr && index.h("p", { key: 'a8cdb9d5fd6da5c415b08df8ead1ae856f76086f', class: "property-overview__location" }, "Tax Reg: ", p.tax_nbr))))))));
    }
};
...
const IrClFiscalDocumentPreview = class {
    ...
    render() {
        return (index.h(index.Host, { key: '374e00366e8cf22e5690894f80c2b493cdbcfe5a' }, index.h("ir-preview-screen-dialog", { key: '53c083e404f9f90ebef89fe1c3392796038bbdbc', open: this.request !== null, label: this.getDialogLabel(), action: "print", onOpenChanged: e => {
                if (!e.detail)
                    this.request = null;
            } }, this.request?.fdTypeCode === FdTypes.Draft && (index.h("ir-custom-button", { key: '0e916e9e9d80a8f9b2c4d8c14c2c3e301e178835', onClickHandler: () => (this.showConvertDialog = true), variant: "brand", appearance: "accent", slot: "header-actions" }, "Convert to invoice")), this.renderPreview()), index.h("ir-fd-confirm-dialog", { key: '15b21762b3f9bdf92eedb1c4bda94cf69733efce', open: this.showConvertDialog, action: "convert-to-invoice", docNumber: this.request?.documentNumber ?? 'this document', isConfirming: this.isConverting, onConfirmed: () => this.handleConvertConfirm(), onCancelled: () => (this.showConvertDialog = false) })));
    }
};
...
const IrClFiscalDocumentTable = class {
    ...
    render() {
        return (index.h(index.Host, { key: '47bd09e4d24ccbe99dae7b93be190beb28831be5' }, index.h("section", { key: 'ddc351a1a9defffb6c4605fd74d8a7fb27d12fe5', class: "invoice-items" }, index.h("table", { key: 'c931edc66a51c50fcf7e40769d9f169b1c7e56d6', class: "cl-table" }, index.h("thead", { key: '348a8bbf59cf2d7660376214bbd94c2e72f6509f' }, index.h("tr", { key: 'c43ad0d8affb7c7b9939e07ec6e3012c4797c9ca' }, index.h("th", { key: '9d528a0ac487793766ff66aad40ec5d9936097ee', class: "cl-th" }, "Date"), index.h("th", { key: '92e6a3ff60f48e5a1bb9ff341e9fb4353e60cf95', class: "cl-th", style: { width: '100%' } }, "Description"), index.h("th", { key: '3ce20bf4cc27fe6571562cdfc7aed5626187dc64', class: "cl-th cl-th--num" }, "Net Price"), index.h("th", { key: '0fbef9d5258f564232037a2276d137d3dd0a3083', class: "cl-th" }, "VAT"), index.h("th", { key: '20dee06e654ed22563de46e6826c3333bb0a195d', class: "cl-th cl-th--num" }, "VAT Amount"), index.h("th", { key: '42354811cd39da4ea98b5aec38be0352b0e767e0', class: "cl-th" }, "City ", index.h("br", { key: 'fca8f01e97b1bed0deaf58eb3bbd69de2bc17b79' }), "Tax"), index.h("th", { key: 'e88e71aad4ee74c9b77d704b207d1f54cb01c9c3', class: "cl-th cl-th--num" }, "City Tax", index.h("br", { key: 'a083794fa91f67836c000137cbd81d8b05dc42dc' }), " Amount"), index.h("th", { key: '6f9a0568c7fa872c2ebf67851530f20ebe7fa51f', class: "cl-th cl-th--num" }, "Total"))), index.h("tbody", { key: 'fa2189e4accdbe2153dc9681d311f9d8007bd0bf' }, this.transactions.length === 0 ? (index.h("tr", null, index.h("td", { class: "cl-td cl-td--empty", colSpan: 8 }, "No transactions found for this document."))) : (index.h(index.Fragment, null, groupData(this.transactions).map(item => this.renderTopLevelItem(item)), this.renderTotals())))))));
    }
};
...
const IrClInvoiceCityTaxAmountCell = class {
    ...
    cityTaxPercent;
    render() {
        return index.h(index.Host, { key: '79ac87d246bb560cf9070d20a25557733505909c' }, this.cityTaxPercent > 0 ? utils$1.formatAmount(this.currencySymbol, this.amount) : '');
    }
};
...
const IrClInvoiceCityTaxPctCell = class {
    ...
    cityTaxPercent;
    render() {
        return index.h(index.Host, { key: '1fb8aa481d7bb4dcc417b276d359e467ceab933f' }, this.cityTaxPercent > 0 ? `${this.cityTaxPercent}%` : '');
    }
};
...
const IrClInvoiceDateCell = class {
    ...
    date;
    render() {
        return index.h(index.Host, { key: '0f3a3169b3e2a155ce775349328859bd8deb6859' }, moment.hooks(this.date, 'YYYY-MM-DD').format('MMM DD, YYYY'));
    }
};
...
const IrClInvoiceDescriptionCell = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '428f6c035af1dc16bc39a1180930853e6ce61ef4' }, index.h("span", { key: '574223c2e3401125a5d1be9409eb7f32d74e6e11', class: "desc" }, this.description)));
    }
};
...
const IrClInvoiceDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f08354589d28e65ea47865be727b44730ec92866' }, index.h("ir-dialog", { key: 'a57a10d6cc58657d34bda349dc8fb62563d7c528', label: "Create Invoice", ref: el => (this.dialogRef = el) }, index.h("div", { key: 'fc6cee6fc5672a5de230e4b237ef6969dc10e73f', class: "create-invoice-dialog__body" }, this.mode === 'booking' ? (index.h("p", { class: "create-invoice-dialog__message" }, "Issue a draft invoice for booking #", this.bookingNbr, " to the agent?")) : (index.h("ir-cl-invoice-form", { ref: el => (this.formRef = el) })), this.noResults && (index.h("wa-callout", { key: '7320b5b39c18f690d85b2d0f28ce218fb66b3bca', variant: "warning", class: "create-invoice-dialog__no-results" }, index.h("wa-icon", { key: '713740030085b8214097149d043b41fbee970390', slot: "icon", name: "triangle-exclamation" }), "No transactions found for the selected period and filters.")), this.error && index.h("p", { key: '1032b5d42e0795991d9edbaf5844b43a6999cad6', class: "create-invoice-dialog__error" }, this.error)), index.h("div", { key: '7f7503876a4ee022f7d7ff982b8fa9b32b8197ba', slot: "footer", class: "create-invoice-dialog__footer" }, index.h("ir-custom-button", { key: 'e5aa0320fe03305147c3cab45932363286383ff5', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close", disabled: this.isLoading }, "Cancel"), index.h("ir-custom-button", { key: '731bd7d0ceac82f2b2af113169c059c2712aead0', size: "medium", appearance: "accent", variant: "brand", loading: this.isLoading, onClickHandler: () => this.handleSubmit() }, "Show draft")))));
    }
};
...
const IrClInvoiceNetPriceCell = class {
    ...
    amount;
    render() {
        return index.h(index.Host, { key: '08edb699c68220f0d54b751036ae7248ac462fb6' }, utils$1.formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceTotalCell = class {
    ...
    amount;
    render() {
        return index.h(index.Host, { key: 'a6994f260188fe7cf8e4b5d09bff19fcfae67f80' }, utils$1.formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatAmountCell = class {
    ...
    amount;
    render() {
        return index.h(index.Host, { key: '8a4d09e35d7e6724efa755075c53628eb99995af' }, utils$1.formatAmount(this.currencySymbol, this.amount));
    }
};
...
const IrClInvoiceVatPctCell = class {
    ...
    vatPercent;
    render() {
        return index.h(index.Host, { key: 'eafc70fd32bf8ca0409850fb16333ed64708b700' }, this.vatPercent, "%");
    }
};
...
const IrClOpeningBalanceFields = class {
    ...
    fieldChange;
    render() {
        return (index.h("div", { key: 'f2cb82b501961f5bc10b215d153ad860819ca700', class: "field field--full-width" }, index.h("ir-validator", { key: '1fd3f83838fc6977c733bc4141a5139ba4f41421', schema: entryTypeFieldSchema, value: this.entryType, valueEvent: "change" }, index.h("wa-radio-group", { key: 'e6c41bffae9fa73bd7ff7c95f3a4f8bf71a4a5bf', label: "Entry Type", orientation: "horizontal", size: "small", value: this.entryType, onchange: event => {
                this.fieldChange.emit({ entryType: event.target.value });
            } }, index.h("wa-radio", { key: '477a81ba027d7f3a57c1d62f6e60caaacfc8dcfb', value: "CR", appearance: "button", class: "entry-type --credit" }, "Credit"), index.h("wa-radio", { key: '8752ab7b2737ab666cf059c39171341e0e81ea15', value: "DB", appearance: "button", class: "entry-type --debit" }, "Debit")))));
    }
};
...
const IrClPaymentFields = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'c257b04fa584181c6314dfd38bcf4d0eb2260c3b' }, index.h("div", { key: 'ec2a13ebd6608c492cb2c1243b5e0f3500e68fea', class: "payment-section" }, index.h("div", { key: '728503005e38081618d90c6821d772884349f2e1', class: "field" }, index.h("ir-validator", { key: 'de9ef49942d8e49fc4d367d088b7458270ca1d4b', schema: paymentMethodCodeFieldSchema, value: this.paymentMethodCode, valueEvent: "change" }, index.h("wa-select", { key: '4968c8e5e29296e2c444ffbd71a3704159d3e6f6', size: "small", label: "Payment method", placeholder: "Select method\u2026", value: this.paymentMethodCode, "onwa-show": e => this.stopPropagation(e), "onwa-hide": e => this.stopPropagation(e), onchange: e => {
                this.stopPropagation(e);
                this.handlePaymentMethodChange(e.target.value);
            } }, index.h("wa-option", { key: '046cafff6120749688f4af3fb6bc8f7309785ab5', value: "" }, "Select method\u2026"), this.paymentMethods.map(method => (index.h("wa-option", { key: method.CODE_NAME, label: method.CODE_VALUE_EN, value: method.CODE_NAME }, utils$1.getEntryValue({ entry: method, language: this.language }))))))))));
    }
};
...
const IrDateSelect = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1357c62c600b86bbf40406a869f13840c24e3e95', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, index.h("wa-popup", { key: 'aa89b8e59ba260d1f22c6de22d86b314b9e51395', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, index.h("div", { key: 'a3c4137e2d33cdbce4ba5c92a9f40893acb7087e', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, index.h("div", { key: '98064b97164f91606000b3eafc725e0dbd645d46', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("slot", { key: '6aafa2b4abe6f8b0aa83a53d58895d8b477daf42', name: "trigger" }, index.h("ir-input", { key: 'da055adbcf1da260373eede17e83953c686e5605', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && index.h("slot", { key: '139cd5b394ffe6d4d86a3074e7eb5a2376960e29', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '31abb526c164869940f86e159983e3b52c1f4a37', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: 'b04f7d6d8483496d3d31a52d42c264af8863a4de', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: '9dfee6f79045e4b2017985190f55020336165b64', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '1d78733b5ad6cbbda8a08a0fc5953c378c0de0d1', name: "hint", slot: "hint" }))))), index.h("div", { key: '3018e56ff31f122be728457b67610b52bbb76292', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, index.h("ir-air-date-picker", { key: '40579e9bf157cdae297bf705501d0fabdc517b9c', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), index.h("slot", { key: '5c79e25cadd9365a70060ef95aff15154e2b54ff' })))));
    }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '49abce9b1089b2e1d7b44677254e3a1a72cc712c', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && index.h("slot", { key: '9e3de3785b6b21b1b49c742a2250f3ba74a218e5', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && index.h("slot", { key: 'd4286638046238c32e2fec5a69ce7ac0edcf59c9', name: "label", slot: "label" }), index.h("slot", { key: 'd7f7d7891728596d6e0b6b2ad70a106f7f98a35d' }), this.slotState.get('footer') && index.h("slot", { key: '168cd1a50cc785a3193653c352d5ae7ffe9e33b7', name: "footer", slot: "footer" })));
    }
};
__decorate$2([
    OverflowRelease()
...
const IrEmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e2c2d24e70059b8d21d78c57ddfb1d39e7fbe10b' }, index.h("slot", { key: 'ff165e105e3f8629d2fdfe93be247e34e87826a5', name: "icon" }, index.h("div", { key: 'a3733f2ee11fcee7d1e45dbd038b85efacd68c42', class: 'icon_container' }, index.h("wa-icon", { key: '8fd6d5ae2bd7dce619bd4e5e09e0b7e37a8fe932', name: "ban", style: { transform: 'rotate(90deg)' } }))), index.h("p", { key: 'a1be634038da21af8e9984cd766a1df8cdb0563f', part: "message", class: "message" }, this.message), index.h("slot", { key: '90fd5a4b3abbba917bfc6f82dcea9246785f7da7' })));
    }
};
...
const IrInputCell = class {
    ...
    render() {
        return (index.h("div", { key: '391e646113a9b8a6d3e018acf75622a1e7cc81f7', onDblClick: () => {
                if (this.disabled) {
                    return;
                }
                if (!this.active) {
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bc40cf971d0aa36e4b6fa3173b93101da86058f7' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '83bfae244876b46245d2acf3a5773bad66ef0757', class: "loadingScreenContainer" }, index.h("div", { key: 'f9966cb62747c29e798fea6c9033500ac356b9cc', class: "loaderContainer" }, index.h("ir-spinner", { key: 'e9545bd4380c1685a4ca007398a3ed48d2c7457b' })))), this.showModal && (index.h("ir-otp-modal", { key: '422b80be60f4d3776a1ee884583d0b93b025a200', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrLoadingScreen = class {
    ...
    message = '';
    render() {
        return (index.h("div", { key: 'a14f4ffc31a351fff61d60bdc2559ff445c871b7', class: "loader__container", "data-testid": "loading-screen" }, index.h("wa-spinner", { key: '4794d7e1d223fa25dae3240da0bc445daf1a1f92', style: { fontSize: '2.5rem' } })));
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7fcebeb375878fbec1c816a019b3bcf258a14970', class: "otp-input-container" }, index.h("div", { key: 'c1e3308cecdcfa3f27d8e4beb6203c2edf1d3163', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPage = class {
    ...
    description;
    render() {
        return (index.h(index.Host, { key: '998c8b68b456c3b06fb957fe69c869e293d45346' }, index.h("ir-interceptor", { key: 'e02b3598af566e383a3efcb39e222efdfceefe96' }), index.h("ir-toast", { key: '810014aee806ac94096c54e14e8c0476b5f23fb4' }), index.h("main", { key: '77c11aee24754227a521593de3699e83ff880444', class: "ir-page__container" }, index.h("header", { key: 'd51605a9d32b0b890e8b0ed057f735389fa8db67', class: "tax-page__header" }, index.h("slot", { key: '6bd1036f7fda85351a3978a892cd2c868aeef230', name: "heading" }, index.h("div", { key: '5af03903d766bd3200c55b25861a026ba9c19907', class: "tax-page__heading" }, index.h("h3", { key: '11f46c609b637d45a1339252d8e572780f240cb0', class: "page-title" }, this.label), this.description && index.h("p", { key: 'dfced4abc0b6fecbf16f154d7716be6cd4e56dff', class: "tax-page__subtitle" }, this.description))), index.h("slot", { key: '650afe7f260a80a2f9089fa91f579cc0a6c136f9', name: "page-header" })), index.h("slot", { key: '897594c15717c5245ccc4bd21b7a3a6b996f3979' }))));
    }
};
...
const IrPreviewScreenDialog = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '7945af356075ee986b8b8bf9f186359dcffbbaf4', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openChanged.emit(false);
            }, label: this.label, open: this.open, class: "ir-fullscreen-dialog" }, index.h("div", { key: 'c018e77a8e7aaffc6d072bc2bf36e897ef48bc9d', slot: "header-actions", class: "ir-fullscreen-dialog__header-actions" }, index.h("slot", { key: 'fa4de4108b98ae4976163351f02f2582a42f5031', name: "header-actions" }), !this.hideDefaultAction && (index.h(index.Fragment, { key: '68a174962a5952af0f728845c9010e88b92db1bb' }, index.h("wa-tooltip", { key: 'f49a69d5f445449d6fb060e0be487c39fffff400', for: this._id }, "Print PDF"), index.h("ir-custom-button", { key: 'd2ed5100767a5f4e7e7abe3924e7b62268554876', id: this._id, size: "medium", variant: "neutral", appearance: "plain", onClickHandler: this.handleActionButtonClick.bind(this), disabled: this.shouldDisableActionButton() }, index.h("wa-icon", { key: 'd002ed398ca3e5b4c2c8c0c80ea2f7d7b2be7753', name: this.actionIconByType[this.action], label: this.getActionLabel(), "aria-label": this.getActionLabel() }))))), index.h("slot", { key: 'ac14fe5812ae1691bc1577fed5e843e6d5cfff3b' })));
    }
};
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b4274ed02bf43348861e6d21d553b269eaf315c1' }, index.h("wa-spinner", { key: '38db0143179fd3cb789e3fbf5dfbfa9b99bfa13d', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5e517f3e838a05da769cff6a5a7cfd8e0c445c67' }, index.h("slot", { key: '570e8e6edc67eea24bef1007bb24df3889a7fe08' }), !this.isValid && this.showErrorMessage && (index.h("span", { key: '3663b0f3ba3304c2b5c996d253a6023b9dae41a0', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
    static get watchers() { return {
