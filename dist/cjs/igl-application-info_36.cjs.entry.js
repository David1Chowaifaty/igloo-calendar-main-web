...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2b6c46f7de33d706041878876747101cf34469ee' }, index.h("div", { key: '87453b6694430be38158f55d68bc0148b25a6364', class: "text-left mt-1 " }, index.h("div", { key: '4e15986ec0aa1d5d124e55aed71824729d3e6b73', class: " mb-1 " }, this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING' ? (index.h("span", { class: "h5 mr-1" }, this.guestInfo.roomCategoryName)) : null, index.h("span", { key: '14b32f321f2b27b3a26b871e81f6b79e30b92ace', class: " font-weight-bold" }, this.guestInfo.ratePlanName.replace(this.guestInfo.roomCategoryName + '/', ''), index.h("ir-tooltip", { key: '9af293a94de0b675be2c4b7df1f57456d3252c4e', class: " mr-1", message: this.guestInfo.cancelation + this.guestInfo.guarantee })), index.h("span", { key: 'f39ccd8de237fa4185b16aa0cd33b30cc389cacc' }, this.guestInfo.adult_child_offering)), index.h("div", { key: '655018a075816f586e2e2519a2458edc19a84694', class: "d-flex flex-column flex-md-row m-0 p-0 align-items-md-center aplicationInfoContainer " }, index.h("div", { key: '5e3e52ef9497c18f6e00dc4d7c09b0719d18efc4', class: "mr-1 flex-fill guest-info-container" }, index.h("input", { key: '7ba5751d9a0f97089328729bae758107b928566c', id: v4.v4(), type: "email", class: `form-control ${this.isButtonPressed && this.guestData.guestName === '' && 'border-danger'}`, placeholder: locales_store.locales.entries.Lcz_GuestFirstnameAndLastname, name: "guestName", onInput: event => this.handleGuestNameChange(event), required: true, value: this.guestData.guestName })), index.h("div", { key: '6c2bb38540341af9e347c7be5e10586dd7c9c71e', class: 'mt-1 mt-md-0 d-flex align-items-center flex-fill' }, calendarData.calendar_data.is_frontdesk_enabled && (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') ? (index.h("div", { class: "mr-1 p-0 flex-fill  preference-select-container" }, index.h("select", { class: `form-control  input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('roomId', event.target.value) }, index.h("option", { value: "", selected: this.guestData.roomId === '' }, locales_store.locales.entries.Lcz_Assignunits), this.filterdRoomList.map(room => (index.h("option", { value: room.id, selected: +this.guestData.roomId === room.id }, room.name)))))) : null, this.guestData.is_bed_configuration_enabled && (index.h("div", { class: "mr-1 flex-fill" }, index.h("select", { class: `form-control input-sm ${this.isButtonPressed && (this.guestData.preference === '' || this.guestData.preference === 0) && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('preference', event.target.value) }, index.h("option", { value: "", selected: this.guestData.preference === '' }, locales_store.locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => (index.h("option", { value: +data.CODE_NAME, selected: this.guestData.preference === +data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("div", { key: 'e7d373a3d81973f6f96ad3751dbcd2c166e4c52b', class: "" }, utils.getCurrencySymbol(this.currency.code) + Number(this.userRate).toFixed(2), "/", locales_store.locales.entries.Lcz_Stay))))));
    }
...
const IglBookProperty = class {
    ...
    render() {
        //console.log('render');
        return (index.h(index.Host, { key: '477f3a9f71dd50d37e486858136f0c5633705d46' }, index.h("div", { key: '04a382efa46796e046b0a66c5cc57040c9ee3b93', class: "background-overlay", onClick: () => this.closeWindow() }), index.h("div", { key: '559a87d1851800e91ff2ed3c7601e450a485f2bf', class: 'sideWindow ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, index.h("div", { key: '8f1b573f346b2e3c6f5d1e0f34c62e9bf2190b86', class: "card position-sticky mb-0 shadow-none p-0 " }, index.h("div", { key: '45f85743afbdabead715a06db1e642ddb3ab15ea', class: "d-flex mt-2 align-items-center justify-content-between  " }, index.h("h3", { key: 'f5f8f17846b083460258cc197f003b40509e8a51', class: "card-title text-left pb-1 font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), index.h("ir-icon", { key: '3623d5a8b9c54106c51f580dc64a9786212891d2', class: "close close-icon", onIconClickHandler: () => {
                this.closeWindow();
            } }, index.h("svg", { key: '053e146a822073287591f5be8b79ab7701e8d8e4', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '5c8472d4cdda5920c16395ad298318b5cd67eeac', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), index.h("div", { key: 'a494b096975a13a5bd29552b147e13206a055f6e', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (index.h("igl-booking-overview-page", { initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData,
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fa6d57534c2a9ee783480a1e3d3a4a8728035f99' }, showSourceNode && this.getSourceNode(), index.h("div", { key: 'd6fe08fa85bb8fd108b5a7769c1d526d30111deb', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, index.h("fieldset", { key: '1779eeb95d9f999d7679c72256a06ff1134188ce', class: "mt-lg-0  " }, index.h("igl-date-range", { key: 'faed65ca9e0e6898fd97fc3af8fb3e443a9e9406', dateLabel: locales_store.locales.entries.Lcz_Dates, minDate: this.minDate, disabled: this.isEventType('BAR_BOOKING') || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: '697e33de9d21f808b718779f1bf58624cf9618f2', class: "text-right mt-1 message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingOverviewPage = class {
    ...
    render() {
        ...
        })))), index.h("igl-book-property-footer", { key: 'bbf18f64bd60a0d85f6207b09208c1250de883ae', class: 'p-0 mb-1 mt-3', eventType: this.bookingData.event_type, disabled: this.selectedRooms.size === 0 })));
    }
};
...
const IglBookingRoomRatePlan = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a53694eacf619e359f4845043975f0fc2a884e95' }, index.h("div", { key: 'eb867f5712ffd54f5c6ca84bd1882fd5ab787260', class: "d-flex flex-column m-0 p-0 flex-lg-row align-items-lg-center justify-content-lg-between " }, index.h("div", { key: '2833658bd65b00f81a40c516a1c0af47ff2e2fc1', class: "rateplan-name-container" }, this.bookingType === 'BAR_BOOKING' ? (index.h(index.Fragment, null, index.h("span", { class: "font-weight-bold\t" }, this.ratePlanData.name.split('/')[0]), index.h("span", null, "/", this.ratePlanData.name.split('/')[1]))) : (index.h("span", null, this.ratePlanData.name)), index.h("ir-tooltip", { key: '29365a5ff1a826bb1dc50ad93c29d0eec7de0655', message: this.ratePlanData.cancelation + this.ratePlanData.guarantee })), index.h("div", { key: '6711c90d59bf3101bb1252e6327330cb0e1da74f', class: 'd-md-flex justify-content-md-end  align-items-md-center  flex-fill rateplan-container' }, index.h("div", { key: 'd4135ca9a83f2957381361587de1fe59c5d34c63', class: "mt-1 mt-lg-0 flex-fill max-w-300" }, index.h("fieldset", { key: '44db542207713a4ba9fd9bd03c4288600b337200', class: "position-relative" }, index.h("select", { key: '9bf475a8880801c9e8262ccf29c67f384271b464', disabled: this.disableForm(), class: "form-control  input-sm", id: v4.v4(), onChange: evt => this.handleDataChange('adult_child_offering', evt) }, this.ratePlanData.variations.map(variation => (index.h("option", { value: variation.adult_child_offering, selected: this.selectedData.adult_child_offering === variation.adult_child_offering }, variation.adult_child_offering)))))), index.h("div", { key: 'b061ae3d410aae56a6d13586216d5f01a011c3fb', class: 'm-0 p-0 d-md-flex justify-content-between ml-md-1 ' }, index.h("div", { key: 'ea5d49850e38f678bc20f4b9d1012a98e0ebdffb', class: " d-flex mt-1  mt-lg-0 m-0 p-0 rate-total-night-view   " }, index.h("fieldset", { key: '4bcf22040e00245137df815a0156c77d1a24f9cb', class: "position-relative has-icon-left m-0 p-0 rate-input-container  " }, index.h("div", { key: '060b33f1cba9513c0fe64f548402eb98fbf82896', class: "input-group-prepend" }, index.h("span", { key: 'a9cf19be0852878615e3a48f668e3ad805bc4327', "data-disabled": this.disableForm(), "data-state": this.isInputFocused ? 'focus' : '', class: "input-group-text new-currency", id: "basic-addon1" }, utils.getCurrencySymbol(this.currency.code))), index.h("input", { key: '8e8cb37977cb69d598f9c39e6c0fbbd1980d596b', onFocus: () => (this.isInputFocused = true), onBlur: () => (this.isInputFocused = false), disabled: this.disableForm(), type: "text", class: "form-control pl-0 input-sm rate-input py-0 m-0 rounded-0 rateInputBorder", value: this.renderRate(), id: v4.v4(), placeholder: locales_store.locales.entries.Lcz_Rate || 'Rate', onInput: (event) => this.handleInput(event) })), index.h("fieldset", { key: 'c0be6574066082c4e7b820e059f74673c8e61160', class: "position-relative m-0 total-nights-container p-0 " }, index.h("select", { key: 'f38dd7aa3a6f2f56264ffeedc03d04d6c0cd282b', disabled: this.disableForm(), class: "form-control input-sm m-0 nightBorder rounded-0  py-0", id: v4.v4(), onChange: evt => this.handleDataChange('rateType', evt) }, this.ratePricingMode.map(data => (index.h("option", { value: data.CODE_NAME, selected: this.selectedData.rateType === +data.CODE_NAME }, data.CODE_VALUE_EN)))))), this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' ? (index.h("div", { class: "flex-lg-fill  mt-lg-0 ml-md-2 m-0 mt-1 p-0" }, index.h("fieldset", { class: "position-relative" }, index.h("select", { disabled: this.selectedData.rate === 0 || this.disableForm(), class: "form-control input-sm", id: v4.v4(), onChange: evt => this.handleDataChange('totalRooms', evt) }, Array.from({ length: this.totalAvailableRooms + 1 }, (_, i) => i).map(i => (index.h("option", { value: i, selected: this.selectedData.totalRooms === i }, i))))))) : null), this.bookingType === 'EDIT_BOOKING' ? (index.h(index.Fragment, null, index.h("div", { class: " m-0 p-0  mt-lg-0  ml-md-1 mt-md-1 d-none d-md-block" }, index.h("fieldset", { class: "position-relative" }, index.h("input", { disabled: this.disableForm(), type: "radio", name: "ratePlanGroup", value: "1", onChange: evt => this.handleDataChange('totalRooms', evt), checked: this.selectedData.totalRooms === 1 }))), index.h("button", { disabled: this.selectedData.rate === -1 || this.disableForm(), type: "button", class: "btn btn-primary booking-btn mt-lg-0 btn-sm ml-md-1  mt-1 d-md-none ", onClick: () => this.bookProperty() }, this.selectedData.totalRooms === 1 ? locales_store.locales.entries.Lcz_Current : locales_store.locales.entries.Lcz_Select))) : null, this.bookingType === 'BAR_BOOKING' || this.bookingType === 'SPLIT_BOOKING' ? (index.h("button", { disabled: this.selectedData.rate === -1 || this.disableForm() || (this.bookingType === 'SPLIT_BOOKING' && this.isBookDisabled), type: "button", class: "btn btn-primary booking-btn mt-lg-0 btn-sm ml-md-1  mt-1 ", onClick: () => this.bookProperty() }, locales_store.locales.entries.Lcz_Book)) : null))));
    }
    static get watchers() { return {
...
const IglBookingRooms = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1e9103475269676900d929810f166f211e84cfc5' }, isValidBookingType && index.h("div", { class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomTypeData.name), this.roomTypeData.rateplans.map((ratePlan, index$1) => {
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '30c036c9e187922bf60e5cc14bccaa1ea282fa2f' }, index.h("div", { key: '4b43fc0480da0d3b21ba0a617c34f41dfa13a3e8', class: "text-left mt-3" }, index.h("div", { key: 'f6a32cac23e4f17392e5ba27378b8bbb9b76a8a9', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: 'ddad9dad7cdbf017dcc27ca273beb04bf519e54e', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: '17429d3972fb0ef9934ed6f110e51647e5d4a664', class: "bookedByEmailContainer mt-1 mt-md-0" }, index.h("ir-autocomplete", { key: '05061b0a20e97356c9cf9f4168c5d073f68efcdc', danger_border: this.isButtonPressed && this.bookedByData.email === '', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "email", value: this.bookedByData.email, required: true, placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent() })))), index.h("div", { key: 'd011c9cc3860136127bab4470a5829942c21b533', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: 'f1f2f591fcea66c7cdfe1a3e1f2f285c2b15073c', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: 'f549b41889397968316cbd8c8c3fe7387d0ec02e', class: "p-0 flex-fill " }, index.h("div", { key: 'ae75d93576bafed79060ab18bb59cf76059ba42c', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: '222e9506850067141e4030493e7399fc5a4d29d4', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: 'fbea1b21bc05fd762e54c91fb99a44727a5ad7f6', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: 'e3b148eb71319358780fe79c231c146575b4610d', class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => this.handleDataChange('firstName', event), required: true }))), index.h("div", { key: 'af8fc1d3246e9004db3cdc3de896d8828adc25fb', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'b7d3c4f76666faa0e902213387fbf303c6871ecf', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '0fb29e3802dcfe649a91cead6d628e53f77a0ac8', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'af2d905460689d49c0ab2f544a5458ec620cc459', class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: 'd841e44cc9933017c23d53c444fe6a180f3f51ff', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'f6f15b5a77d1690d8ed1dc9d85c9e35153ee4053', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("div", { key: '50a99daaf61f12aa3c878324e578d37c86b31f68', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '126079e38d0eb0d025b755efcee63a46a9771d2c', class: `form-control input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('countryId', event) }, index.h("option", { key: '0567cbae28e8b8cee0043b9cdf6f2dd577347ac7', value: "", selected: this.bookedByData.countryId === '' }, locales_store.locales.entries.Lcz_Select), this.countryNodeList.map(countryNode => (index.h("option", { value: countryNode.id, selected: this.bookedByData.countryId === countryNode.id }, countryNode.name)))))), index.h("div", { key: 'eaf983cf9293d59bb3302d8bab21ad6a51ee20d1', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'e713593e152e8165444afed65519171173ff994e', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: 'f73938ca242a17331f49a8e58ad9ffc28e73bc7e', class: "p-0 m-0  d-flex  controlContainer flex-fill" }, index.h("div", { key: '0e9be578b67fe60bf8ebcf6c4aff945b8f048ccd', class: " p-0 m-0" }, index.h("select", { key: 'e1098ee8a8ef2a5f9b26922ab63066b83622a9b8', class: `form-control input-sm pr-0`, id: v4.v4(), onChange: event => this.handleDataChange('isdCode', event) }, index.h("option", { key: '558430b3f9657fdba2aa0434436b6959ba0796f9', value: "", selected: this.bookedByData.isdCode === '' }, locales_store.locales.entries.Lcz_Isd), this.countryNodeList.map(country => (index.h("option", { value: country.id, selected: this.bookedByData.isdCode === country.id.toString() }, country.phone_prefix))))), index.h("div", { key: '1e9cd40ea133d69c1737a76d782b014e3262321c', class: "flex-fill p-0 m-0" }, index.h("input", { key: '4863d2b7fa0b6e5bf503d9589e9ccaffcd5f8d58', class: `form-control
                     
                      `, type: "tel", placeholder: locales_store.locales.entries.Lcz_ContactNumber, id: v4.v4(), value: this.bookedByData.contactNumber, onInput: event => this.handleNumberInput('contactNumber', event) })))), index.h("div", { key: 'e06ab495a182edc2a8024d8886efda85a2a9ad56', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '4e8fc47d83cee4c878330207c95facf757fbce01', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: 'ace041718db81601669c1abb9dc0d622709e2837', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '4e20cca4c6d65f040116c9394674ab335f287f51', class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: '10ab9a55cade6725c645c0aa347438465cceef96', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: 'ab3045e134452b89e51bc989aae4d98c2444cab0', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '5b776f3652c1ca71994ca25cbb7b167d798d051d', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: '7008e99ab6d8b56b244e6fc674547bc38cae3c62', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: '71361350584351c7096fcff87bd93bed67595f03', id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, null, index.h("div", { class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { class: "p-0 m-0" }, index.h("select", { class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { class: "p-0 m-0 ml-1" }, index.h("select", { class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: 'ea31b2a60530c5babb8ebedb1468d95a625c2fd3', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: '088ee1617ffe8c0388c0c9b263fd5de1ddb177d1', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: 'c109c3c0f2dfbe2133804ebd3556d1bf2d80f51e', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: '5c993f340b723f72588b31228f2201d02379cbd1', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
function initializeUserSelection() {
    ...
    booking_listing.userSelection = Object.assign(Object.assign({}, booking_listing.userSelection), { channel: '', booking_status: booking_listing.statuses[0].code, filter_type: booking_listing.types[0].id, book_nbr: '', name: '', from: utils.hooks().add(-7, 'days').format('YYYY-MM-DD'), to: utils.hooks().format('YYYY-MM-DD'), start_row: 0, end_row: 20 });
}
...
const IrButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: '1738442aaa0987dea4fa61a329a5f923b47753c9', id: this.btn_id, ref: el => (this.buttonEl = el), onClick: () => this.clickHanlder.emit(), class: `btn btn-${this.btn_color} ${this.btn_styles} d-flex align-items-center btn-${this.size} text-${this.textSize} ${blockClass}`, type: this.btn_type, disabled: this.btn_disabled }, index.h("span", { key: 'd92899637e149ac53492119d302e67d86d12c9cd', class: "button-icon", "data-state": this.isLoading ? 'loading' : '' }, index.h("slot", { key: '013b2e1041086ff11f5aea59773a9454e0643a7e', name: "icon" })), this.text && index.h("span", { class: "button-text m-0" }, this.text), this.isLoading && index.h("div", { class: "loader m-0 p-0" })));
    }
};
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dd52fc84a0c93730fe1ac34769e7368b8750045c' }, index.h("slot", { key: '6fe24c859c86be3fc3b74033d2599c19a1c475b1' })));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dc5146a825f1db49632cc96f3de497c4d7771344' }, index.h("input", { key: '706f0a17af67bd9f6fc78885c5cf15752cf28f95', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
};
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c355049085876d96440a69950ca25ee2695ed7b8', class: "d-flex align-items-center" }, index.h("span", { key: 'e074b2ad22de3a991801fcdd936cfccadd0594b8' }, this.dates.from_date), ' ', index.h("svg", { key: '2d1a4932685cb88bfb59f06b72b6a3e54f56f1b8', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '88490422a08f489064dd9b5840b15891b5fb2f80', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'a331da23020714a0aec95f15ebf765aad0339b4d' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'd9b91481fc1dd016cbe63534bac42a2f8ee01642', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'c762fd4a86cc1e9110b941b06f87fc4cc68211a6', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c323aefc1e573d11c409769de2f9e93536d415c7' }, this.isLoading && (index.h("div", { class: "loadingScreenContainer" }, index.h("div", { class: "loadingContainer" }, index.h("ir-loading-screen", null))))));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b772e358704facb61b442a66e9577e39eb83178' }, index.h("a", { key: '69c487412644a71585ee49e7c796fffc414ffb76', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '4ec15ba00472248e7b912d7b83048764cdf4146e', class: "sr-only" }, "download url")), index.h("section", { key: 'eb55131e72b3e4068a3435707d91575fd08e67e4', class: "d-flex align-items-center " }, index.h("div", { key: 'f5e238d034c55da4a627587b2ed26de7e12b78e5', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '7e1c7913d56b762b8870d6fcb0da9ef082d3658b', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '26b5ae3f60fbdde1ad64fab929eff1bb10bbe945', class: "flex-fill" }, locales_store.locales.entries.Lcz_Bookings), index.h("div", { key: '82aef96bea43a6da698c1636e7f492fc070a2ec5' }, index.h("igl-book-property-container", { key: '02029dfe230ba83fc6be3748b40b33d7b0baa8e9', withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, baseurl: this.baseurl, ticket: booking_listing.token }, index.h("button", { key: 'f46d9f4224e90c860ac07eec1c1021a9c0d8b465', slot: "trigger", class: 'new-booking-btn' }, index.h("svg", { key: 'dc65a466304416005a6c9f290f8e01328a7dcca8', xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'd901d5f72e7192758781fdce14d0a992b79a2d7b', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("h3", { key: '05e5f25d3925eb8732e5c8bb5e25379b4ad05c95', class: "d-none d-md-block" }, locales_store.locales.entries.Lcz_Bookings), index.h("div", { key: 'e6444c5951eee01a9105abc5d49a3f4c52e6ac1c', class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '912718e90bbc0f6351d73aa0581d72c90e859d2d', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: locales_store.locales.entries.Lcz_FindBookNbrorName }, index.h("svg", { key: 'c39b81010ec7868da83ae37d7bf23c4c67eb55f2', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '2fca3920880fad720c8cd373a2984064bb14815b', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: 'd722241d1a32d3778e6a3f46a696e845df6b579a', class: "m-0 font-weight-bold d-none d-sm-block" }, locales_store.locales.entries.Lcz_Or))), index.h("div", { key: '54f2ecad663a3736ee81a05d8f01377b9dd43252', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: 'b4c22d2467737cb696acd407a034ddd8db942d4e', withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, baseurl: this.baseurl, ticket: booking_listing.token }, index.h("button", { key: '7b53fb2d778e7865aa2f84c8b5ab37a9da97aa4e', slot: "trigger", class: 'new-booking-btn' }, index.h("svg", { key: 'd3544f8b53e4d7526e1dd0cbcbaa199aeb41524e', xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'a9d11e64536bfbce60784fb9a42e362a41ffe5fd', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("section", { key: '2bf46d9195dcc0fe11f56f2ee3a518a6c5e5b825', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '5085d6c65293a4160dd6975375712bf9089a1999' }), index.h("h5", { key: '14d3c4e479f453f80a96a2c8c0daed8bcc10e3cb', class: "m-0 font-weight-bold" }, locales_store.locales.entries.Lcz_Or), index.h("span", { key: 'dd2aee4fdccf39d54551f8690cd63444e524db18' })), index.h("section", { key: '09461ddcc88dc31f742a46ee41b4ed368cc2708d', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("fieldset", { key: 'ab1b57d224a6fc39146a26ff64545fdb4998d572', class: "d-flex align-items-center flex-sm-column align-items-sm-start flex-fill-sm-none" }, index.h("label", { key: 'bcb3c02994a23e7f123f38ae34d6aa570e101698', htmlFor: "dateTo" }, locales_store.locales.entries.Lcz_DateOf), index.h("ir-select", { key: '985666318a0f254e28a203d658d87814802c7097', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-fill", selectedValue: booking_listing.userSelection.filter_type, select_id: "dateTo", LabelAvailable: false })), index.h("fieldset", { key: 'd9d77cd452b16468f2fd4faeb2f1f3bbf4ce3ff3', class: "d-flex align-items-center flex-sm-column align-items-sm-start flex-fill-sm-none" }, index.h("label", { key: 'c7ea07b024cf3ad923ad7d37a190b55ec64e2d52', htmlFor: "dates" }, locales_store.locales.entries.Lcz_Dates), index.h("igl-date-range", { key: '028ff2f0f3f8032e73b1c2f6f8bbf71c32477fac', class: "flex-fill", minDate: "2000-01-01", withDateDifference: false, defaultData: {
                fromDate: booking_listing.userSelection.from,
                toDate: booking_listing.userSelection.to,
            } })), index.h("fieldset", { key: '90ebcc3ad9fe22ec633a4e57985a405e256acc5b', class: "d-flex align-items-center flex-sm-column align-items-sm-start flex-fill-sm-none" }, index.h("label", { key: 'ac285ec25088be3af4404d3c242a675376c0eb63', htmlFor: "booking_status" }, locales_store.locales.entries.Lcz_BookingStatus), index.h("ir-select", { key: 'c43a866f6d1cc2ca64c7231dfd29d5922b102b96', class: "flex-fill", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false })), index.h("fieldset", { key: '1a9312a1304a18fc07dc339fff29622e901c4ba2', class: "d-flex align-items-center flex-sm-column align-items-sm-start flex-fill-sm-none" }, index.h("label", { key: '41b025b795bb1fcae944ced705c6fc57d31e64c0', htmlFor: "channels" }, locales_store.locales.entries.Lcz_Channels), index.h("ir-select", { key: '50d6635304195c5586a2e5989aaad08bd32e5393', class: "flex-fill", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "channels", LabelAvailable: false })), index.h("div", { key: '12746b9d55f0a1e95530fa9c3a8bcd57c7757183', class: "d-flex flex-fill align-items-end m-0 mt-2 buttons-container" }, index.h("ir-icon", { key: 'c0fd136d7daa03deb241296ef96474055713cef7', title: locales_store.locales.entries.Lcz_Search, onIconClickHandler: () => this.handleSearchClicked(false) }, index.h("svg", { key: '514426af0154e258766d9f06bffa5ef60af694ec', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { key: '630962a8c10b080dda3a726fc25f4e4b736f12e3', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("ir-icon", { key: '016fa2319271e9b82c5a5c1262886c375d278cbe', title: locales_store.locales.entries.Lcz_Erase, onIconClickHandler: () => this.handleClearUserField() }, index.h("svg", { key: '2000ef35c6c9f0b992586a076d8d62e878232e8d', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { key: 'b702050e13517dcc4228ff38f5aa01e89507501d', fill: "currentColor", d: "M290.7 57.4L57.4 290.7c-25 25-25 65.5 0 90.5l80 80c12 12 28.3 18.7 45.3 18.7H288h9.4H512c17.7 0 32-14.3 32-32s-14.3-32-32-32H387.9L518.6 285.3c25-25 25-65.5 0-90.5L381.3 57.4c-25-25-65.5-25-90.5 0zM297.4 416H288l-105.4 0-80-80L227.3 211.3 364.7 348.7 297.4 416z" }))), index.h("ir-icon", { key: '43db960a2bb8c9d028521727f627828d3fc23439', onIconClickHandler: () => this.handleSearchClicked(true), title: locales_store.locales.entries.Lcz_ExportToExcel }, index.h("svg", { key: 'dc005c7a0eb0cf2affe04950bec57871c49cbcd7', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "15", viewBox: "0 0 384 512" }, index.h("path", { key: 'b023fe8df3b21f76388047187b3fcc956479f9bb', fill: "currentColor", d: "M48 448V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm90.9 233.3c-8.1-10.5-23.2-12.3-33.7-4.2s-12.3 23.2-4.2 33.7L161.6 320l-44.5 57.3c-8.1 10.5-6.3 25.5 4.2 33.7s25.5 6.3 33.7-4.2L192 359.1l37.1 47.6c8.1 10.5 23.2 12.3 33.7 4.2s12.3-23.2 4.2-33.7L222.4 320l44.5-57.3c8.1-10.5 6.3-25.5-4.2-33.7s-25.5-6.3-33.7 4.2L192 280.9l-37.1-47.6z" })))))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '501f4dddee6a7ed67ca54d72ddca7f057b8bf8e9' }, index.h("div", { key: '777e5f192c8d7b896eff0aecd7f14603a0b06ad6', class: "loaderContainer" }, index.h("span", { key: '1c33f04ca49649515f48f2d890ddfe238e4591f1', class: "loader" }))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h(index.Host, { key: '131cdfe2ba32cb265494c237a7c302d01710258e', class: 'p-0' }, index.h("div", { key: '4b2fda20d970ee4a31d8097715278d07dd3bb82f', class: "position-sticky mb-0 shadow-none p-0" }, index.h("div", { key: '85450759c171e5bcdb3afad60578a9d7e647991c', class: "mt-2 custom-card-container pb-1 mb-3 px-1" }, index.h("h3", { key: 'e3d1889e1269978ce45ec0f3b0f9625e0e464559', class: "card-title p-0  m-0 text-left font-medium-2" }, locales_store.locales.entries.Lcz_Pickup), index.h("div", { key: '19b1d3563c198de3bec771de41de6a0dc4714300' }, index.h("ir-icon", { key: '6ebd75b3493b1b73ddb07850f7d2a127f688a46c', class: 'close m-0 p-0 ', onIconClickHandler: () => {
                this.closeModal.emit(null);
            } }, index.h("svg", { key: 'c27bddb543a7b0dd65286abd890def9b8860bbe8', slot: "icon", xmlns: "http://www.w3.org/2000/svg", class: "m-0 p-0", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '1455a72e9f3dcee090eceecc5dff194029ae9bf4', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("section", { key: '40911996bbc01810958d7eb62dc5e0b35b9779b8', class: 'px-1' }, index.h("ir-select", { key: 'd50191852a28fb1a79aa9946ca8fd84c99b5ea0a', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales_store.locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (index.h(index.Fragment, null, index.h("div", { class: 'd-flex' }, index.h("div", { class: "form-group  mr-1" }, index.h("div", { class: "input-group row m-0" }, index.h("div", { class: `input-group-prepend col-5 p-0 text-dark border-0` }, index.h("label", { class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales_store.locales.entries.Lcz_ArrivalDate)), index.h("div", { class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, index.h("ir-date-picker", { minDate: utils.hooks().format('YYYY-MM-DD'), autoApply: true,
...
const IrRoom = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9128caace64aa071600d1cf4b0e96a5554fe6982', class: "p-1 d-flex m-0" }, index.h("ir-icon", { key: '51c7cfbcbb22cdac6b6f12ea53dc08f3284b97d3', id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "pointer mr-1", onClick: () => {
                this.collapsed = !this.collapsed;
            } }, !this.collapsed ? (index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { fill: "#104064", d: "M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "25", viewBox: "0 0 640 512", slot: "icon" }, index.h("path", { fill: "#104064", d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z" })))), index.h("div", { key: '4629e1b77d56668e46269135f1791edbaa8e485b', class: "flex-fill m-0 " }, index.h("div", { key: '9573a54feb219e6e9df2f2b5516be333db8dc893', class: "d-flex align-items-start justify-content-between sm-mb-1" }, index.h("p", { key: '20f2f67a569b7f03099382701d624c02658a1c8d', class: "m-0 p-0" }, index.h("strong", { key: '95690b5076473cded2af87fc834055d028e8fe6a', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '77ae7637175098c19d4289643707b0e67d48dd71', class: "d-flex m-0 p-0 align-items-center" }, index.h("span", { key: '6e3c0261d0083268f0515c830aa59560e840c21d', class: "p-0 m-0 ml-1 font-weight-bold" }, _formatAmount(this.item['gross_total'], this.currency)), this.hasRoomEdit && (index.h("ir-icon", { id: `roomEdit-${this.item.identifier}`, class: "pointer mx-1", onClick: this.handleEditClick.bind(this) }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", viewBox: "0 0 512 512" }, index.h("path", { fill: "#6b6f82", d: "M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" })))), this.hasRoomDelete && (index.h("ir-icon", { onClick: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, class: "pointer" }, index.h("svg", { slot: "icon", fill: "#ff2441", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "14.25", viewBox: "0 0 448 512" }, index.h("path", { d: "M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" })))))), index.h("div", { key: 'ab3fcb2a7a91bfb513e746c1037f7cdb4bb8a332', class: "d-flex align-items-center sm-mb-1" }, index.h("ir-date-view", { key: '75b3f8e8eeedb7c59188f43536e4895319f79f7c', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), calendarData.calendar_data.is_frontdesk_enabled && this.item.unit && index.h("span", { class: "light-blue-bg mr-2 " }, this.item.unit.name), this.hasCheckIn && index.h("ir-button", { id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && index.h("ir-button", { id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), index.h("div", { key: '37ae6361784917732c7a2a3e20ffe7eefe179b98' }, index.h("span", { key: '58afe8d061052492c4c05bd2424d8b2aef5739f5', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && index.h("span", null, " ", this.item.rateplan.selected_variation.adult_child_offering)), index.h("div", { key: '066588f3719eca2b5b5c2c6e1bc7a719fe04e415', class: "collapse", id: `roomCollapse-${this.item.identifier.split(' ').join('')}` }, index.h("div", { key: '46fa101c2d64f3b372ab69cefa18b2130aed749d', class: "d-flex sm-mb-1 sm-mt-1" }, index.h("div", { key: '5eda9756a15f12a449404b610e6be0025a94fcf0', class: " sm-padding-top" }, index.h("strong", { key: 'b0a8fa43f7e44466cce8e3ffad7dc665a805e73a', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), index.h("div", { key: 'e9c0db11a2057c058d2c452f879b6300bcbc22fc', class: 'flex-fill' }, index.h("table", { key: '57fbfbb64a1f6a49899ad0a18ef78e81dc5f27fb' }, this.item.days.length > 0 &&
            this.item.days.map(item => (index.h("tr", null, index.h("td", { class: 'pr-2 text-right' }, _getDay(item.date)), " ", index.h("td", { class: "text-right" }, _formatAmount(item.amount, this.currency))))), index.h("tr", { key: '20251cb098f136bb08d802dabf6512a42462c88e' }, index.h("th", { key: 'f03e5ade20088020ec52012756d3199c0df4c56a', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), index.h("th", { key: '84ceb678bee5a39c8877324d5adb6b0c775f2cfe', class: "text-right" }, _formatAmount(this.item.total, this.currency))), this.bookingEvent.is_direct ? (index.h(index.Fragment, null, (() => {
        ...
        })()))))), index.h("div", { key: 'bc5fda867757595a3c1e1c805f15c892f9b9c184', class: "sm-mb-1", innerHTML: this.item.rateplan.cancelation || '' }), index.h("div", { key: '3ed222433fcd8de2d6c89dcc247af7638441aabe', class: "sm-mb-1", innerHTML: this.item.rateplan.guarantee || '' }), index.h("ir-label", { key: 'f6cb6cb064fe17520fa71a677fea992fdb7150eb', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), index.h("ir-modal", { key: 'eef224d71fdaaa0efcbc7dda6eddf9f2c18bbdcd', onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSelect = class {
    ...
    render() {
        let className = 'form-control';
        let label = (index.h("div", { key: '7ee619587ecb6098bd6da5ab40d1e5cb2578b356', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '92fa1d228472bd0de47e641ae413ff4c55fb37e7', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '84dfe2a61744d932d8cc1088300a5134b81b57af', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'e4a9ca90da58b01177775e585a3b9940f66a804e', class: "input-group row m-0" }, label, index.h("select", { key: '5a73b607bcbd84f310d1dea5b2ec1743d658c205', ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '89d218bb2cf93e880baab1372e838760246992a3', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '2654f86df5875bb6aa086ea24327e0a91ac5e58e', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("ir-icon", { class: "close", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("slot", { key: '69ecdb6bc1ec7b93be734c9cb8657397fc5babae' })),
        ];
    }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'b7afd418ea8c504eb3f5ecad0053b0a751de57aa' });
    }
    get element() { return index.getElement(this); }
};
