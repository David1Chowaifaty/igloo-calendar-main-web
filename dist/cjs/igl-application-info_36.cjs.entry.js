...
const IrBookingListing = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-interceptor", null), index.h("ir-toast", null), index.h("div", { class: "p-2 main-container" }, index.h("ir-listing-header", { propertyId: this.propertyid, language: this.language, baseurl: this.baseurl }), index.h("section", null, index.h("div", { class: "card p-1 flex-fill m-0 mt-2" }, index.h("table", { class: "table table-striped table-bordered no-footer dataTable" }, index.h("thead", null, index.h("tr", null, index.h("th", { scope: "col", class: "text-left" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 :
            _a.Lcz_Booking, "#"), index.h("th", { scope: "col" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_BookedOn), index.h("th", { scope: "col" }, (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_GuestSource), index.h("th", { scope: "col" }, index.h("p", { class: 'm-0' }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Price), index.h("ir-tooltip", { customSlot: true, message: `<span style="width:100%;display:block;">${(_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_BookingBalance}</span><span>${locales_store.locales.entries.Lcz_ClickToSettle}</span>` }, index.h("p", { slot: "tooltip-trigger", class: 'm-0 btn due-btn' }, (_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_Balance))), index.h("th", { scope: "col", class: "text-left" }, (_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Services), index.h("th", { scope: "col", class: "in-out" }, (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_InOut), index.h("th", { scope: "col" }, (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Status), index.h("th", { scope: "col" }, index.h("p", { class: "sr-only" }, "actions")))), index.h("tbody", { class: "" }, booking_listing.bookings.length === 0 && (index.h("tr", null, index.h("td", { colSpan: 8 }, (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_NoDataAvailable))), (_l = booking_listing.bookings) === null || _l === void 0 ? void 0 :
            _l.map(booking => {
                var _a, _b, _c;
...
const IrButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: '7b8d53a1c16c07a9ac68ca254100d9d3132b7235', id: this.btn_id, ref: el => (this.buttonEl = el), onClick: () => this.clickHanlder.emit(), class: `btn btn-${this.btn_color} ${this.btn_styles} d-flex align-items-center btn-${this.size} text-${this.textSize} ${blockClass}`, type: this.btn_type, disabled: this.btn_disabled }, index.h("span", { key: 'ac0c2e9dc17cc5fb7835e98967b96ea1ca4cd8c6', class: "button-icon", "data-state": this.isLoading ? 'loading' : '' }, index.h("slot", { key: 'ed6a699fad2a9077ccd10ba2e142845b8f409826', name: "icon" })), this.text && index.h("span", { class: "button-text m-0" }, this.text), this.isLoading && index.h("div", { class: "loader m-0 p-0" })));
    }
};
...
const IrCommon = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a31c59484ace28c0b7b3bf544f90130909fb740e' }, index.h("slot", { key: 'bda2c1e036ac2f582bfac5260a356b88e1afd3b6' })));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a458e2a9d08a45216753e96303070d070749507f' }, index.h("input", { key: '5fd28b3337cf27b3bcfa6e8696cdc5e1d8e2a8d9', class: "date-range-input", type: "text", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
};
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9d7525393d974cc927d50d04f88ff0dafca744b6', class: "d-flex align-items-center" }, index.h("span", { key: '864e472b09d3047cc03a65358cd9b9daef3f2045' }, this.dates.from_date), ' ', index.h("svg", { key: '6f46c9dc2d23dd6ab32a71ddb6241affcad80638', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'ff094a553b6d448644dd6992fada9c24ac105114', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: '3ff75a76c023cf6b56199880bd56f1681e528f76' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { class: "mx-01" }, this.dates.date_diffrence, '   ', this.dates.date_diffrence > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'f47ac83d2bbae08b90e4b9778d647a74c9f99896', class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '118ced97ff6908a06849d4e9fcd853f96c3b3720', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8a7d938aaa121cc799c4be9aa1c29ff27cc63e87' }, this.isLoading && (index.h("div", { class: "loadingScreenContainer" }, index.h("div", { class: "loadingContainer" }, index.h("ir-loading-screen", null))))));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b772e358704facb61b442a66e9577e39eb83178' }, index.h("a", { key: '69c487412644a71585ee49e7c796fffc414ffb76', ref: el => (this.downloadUrlTag = el) }, index.h("p", { key: '4ec15ba00472248e7b912d7b83048764cdf4146e', class: "sr-only" }, "download url")), index.h("section", { key: 'eb55131e72b3e4068a3435707d91575fd08e67e4', class: "d-flex align-items-center " }, index.h("div", { key: 'f5e238d034c55da4a627587b2ed26de7e12b78e5', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '7e1c7913d56b762b8870d6fcb0da9ef082d3658b', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: '26b5ae3f60fbdde1ad64fab929eff1bb10bbe945', class: "flex-fill" }, locales_store.locales.entries.Lcz_Bookings), index.h("div", { key: '82aef96bea43a6da698c1636e7f492fc070a2ec5' }, index.h("igl-book-property-container", { key: '02029dfe230ba83fc6be3748b40b33d7b0baa8e9', withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, baseurl: this.baseurl, ticket: booking_listing.token }, index.h("button", { key: 'f46d9f4224e90c860ac07eec1c1021a9c0d8b465', slot: "trigger", class: 'new-booking-btn' }, index.h("svg", { key: 'dc65a466304416005a6c9f290f8e01328a7dcca8', xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'd901d5f72e7192758781fdce14d0a992b79a2d7b', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("h3", { key: '05e5f25d3925eb8732e5c8bb5e25379b4ad05c95', class: "d-none d-md-block" }, locales_store.locales.entries.Lcz_Bookings), index.h("div", { key: '59e4f5fe1205e9b7efd18cd08c3fbfc70a4b153e', class: "booking-search-field" }, index.h("ir-input-text", { key: '85a74641688694f9ea435e736d07d30b2d305e4c', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: locales_store.locales.entries.Lcz_FindBookNbrorName }, index.h("svg", { key: '967ca36b99cf11ac52a362f5f37f7c3272a3a2b8', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '5f847404b297407dc14d90f12ea05f1bedc8d2f8', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '3e66f73c482c8ee8d8f26979a6b1b01f159265e4', class: "m-0 font-weight-bold" }, locales_store.locales.entries.Lcz_Or))), index.h("div", { key: '9ea1d2bb5c4df7465b5f49a96b9f8147d9dc6883', class: "d-none d-md-block" }, index.h("igl-book-property-container", { key: '71b96c8b1a5dd81e9f1b8b3a72641d0a054d84af', withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, baseurl: this.baseurl, ticket: booking_listing.token }, index.h("button", { key: '555750ca26f0cf6e4492f323a1d267c0d06f2158', slot: "trigger", class: 'new-booking-btn' }, index.h("svg", { key: 'adfd07b827a7882baf8e19e4f06f4cd8dc575655', xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'fd93dad3d72615970937ce32604f581e6f64810b', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), index.h("section", { key: 'd47e3863cbf7341d6a05233bbc4bf960e2fc6165', class: "d-flex align-items-center flex-wrap filters-container justify-content-lg-start mt-1" }, index.h("fieldset", { key: 'cc3e6e94cb5518ef474686d488c2c36521553cd6', class: "flex-fill-sm-none" }, index.h("label", { key: 'a86499c5abe21c500a7b8bc441b7098d31ff8d9b', htmlFor: "dateTo" }, locales_store.locales.entries.Lcz_DateOf), index.h("ir-select", { key: 'ef7a05634613969c8a8302a91a2244225319ecb1', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), select_id: "dateTo", LabelAvailable: false })), index.h("fieldset", { key: '4fab9c30911f399dc03d692d474244abc30e150b', class: "flex-fill-sm-none" }, index.h("label", { key: 'dfffe6346ef0861811d4e51e48cb823d3ad79ea7', htmlFor: "dates" }, locales_store.locales.entries.Lcz_Dates), index.h("igl-date-range", { key: 'a70ca0b275a7b1e3b32b04601b114647518f42f8', minDate: "2000-01-01", withDateDifference: false, defaultData: {
                fromDate: booking_listing.userSelection.from,
                toDate: booking_listing.userSelection.to,
            } })), index.h("fieldset", { key: '1783efec682a22cf7ee66eeeb906964a892aef5f', class: "flex-fill-sm-none" }, index.h("label", { key: 'c9c3f0149b2c2cb0bd3f1c50973c6f35375a7e07', htmlFor: "booking_status" }, locales_store.locales.entries.Lcz_BookingStatus), index.h("ir-select", { key: '246588a5854ebaa06d41ab7f5165c8cf8fe96560', onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), select_id: "booking_status", LabelAvailable: false })), index.h("fieldset", { key: 'e095184e5f47726d880476718476cab8e38aa176', class: "flex-fill-sm-none" }, index.h("label", { key: 'c16df79e8eeaed15c348ad6791b8c0d268cbf51a', htmlFor: "channels" }, locales_store.locales.entries.Lcz_Channels), index.h("ir-select", { key: '7cc9f3098c1a0b18b63e1ce92dd21dd3fd3ac7df', onSelectChange: e => updateUserSelection('channel', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.name,
                text: channel.name,
            })), select_id: "channels", LabelAvailable: false })), index.h("div", { key: 'f78bc15e4f3416b0dd860d7bdf6d3a8b75bbcb5c', class: "d-flex align-items-end m-0 mt-2 buttons-container" }, index.h("ir-icon", { key: 'c409c7e54f329bce9cd099f0e20cf6ca992bf59d', title: locales_store.locales.entries.Lcz_Search, onIconClickHandler: () => this.handleSearchClicked(false) }, index.h("svg", { key: '7369565bbb86b88a4c3ce0799744ab8a7a0e7df6', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "20", viewBox: "0 0 512 512" }, index.h("path", { key: 'b93715ba3a9cd16d224fbc0bd2141b4b16041221', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("ir-icon", { key: 'b2390944ce2ae67999713a60992fa8d7bb7d622b', title: locales_store.locales.entries.Lcz_Erase, onIconClickHandler: () => this.handleClearUserField() }, index.h("svg", { key: 'afc8431b9d0a4e913c137b7f343bcb26c23bb01a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, index.h("path", { key: 'bba65de52f2db94beeaabbe1d04c99d0d4464891', fill: "currentColor", d: "M290.7 57.4L57.4 290.7c-25 25-25 65.5 0 90.5l80 80c12 12 28.3 18.7 45.3 18.7H288h9.4H512c17.7 0 32-14.3 32-32s-14.3-32-32-32H387.9L518.6 285.3c25-25 25-65.5 0-90.5L381.3 57.4c-25-25-65.5-25-90.5 0zM297.4 416H288l-105.4 0-80-80L227.3 211.3 364.7 348.7 297.4 416z" }))), index.h("ir-icon", { key: '907b95066377f2c070bfcf59fa5a249a3bba0def', onIconClickHandler: () => this.handleSearchClicked(true), title: locales_store.locales.entries.Lcz_ExportToExcel }, index.h("svg", { key: 'def686f64ce799c52970f443eae142258941b598', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "15", viewBox: "0 0 384 512" }, index.h("path", { key: '3813ab3172be95716a1f5a5ffb77558511ae3742', fill: "currentColor", d: "M48 448V64c0-8.8 7.2-16 16-16H224v80c0 17.7 14.3 32 32 32h80V448c0 8.8-7.2 16-16 16H64c-8.8 0-16-7.2-16-16zM64 0C28.7 0 0 28.7 0 64V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V154.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0H64zm90.9 233.3c-8.1-10.5-23.2-12.3-33.7-4.2s-12.3 23.2-4.2 33.7L161.6 320l-44.5 57.3c-8.1 10.5-6.3 25.5 4.2 33.7s25.5 6.3 33.7-4.2L192 359.1l37.1 47.6c8.1 10.5 23.2 12.3 33.7 4.2s12.3-23.2 4.2-33.7L222.4 320l44.5-57.3c8.1-10.5 6.3-25.5-4.2-33.7s-25.5-6.3-33.7 4.2L192 280.9l-37.1-47.6z" })))))));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0b5b4c3ecdad5e6b7399630e5cc9f52d5e9be7ad' }, index.h("div", { key: '5e85af39df8c54fd499226c8bfddac88a3667eaa', class: "loaderContainer" }, index.h("span", { key: '4aed808b1469e6107cff3843d5a1dddd5324905d', class: "loader" }))));
    }
};
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '0e818fbedf36787c6453e33e77d8749fdb712210', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: 'dcc0c2ba1a7ad6798bac9b2fff41f4025032f602', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("ir-icon", { class: "close", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), index.h("slot", { key: '95613d4286e14604c5a010f14cc29a087f80250d' })),
        ];
    }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '0e38cf63e32f963e8138c0be2ef7d715bc64b6cf' });
    }
    get element() { return index.getElement(this); }
};
