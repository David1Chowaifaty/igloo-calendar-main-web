...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b0ea9c45ca572d54ce2edd16b9c3be67f0b91c7c' }, index.h("div", { key: '2afc0cfed752602b7e16490281ce08920f92a69d', class: 'd-flex align-items-center ' }, index.h("label", { key: 'b39c65b2d6403bb1db47a56a75a28736c94b7b0b', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '545af0b79665834c4115f5936e2c0c96a19c7385', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '8ec8ca38205611f10de1f100b6f991224f2abbe0', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: '6d3f4374708ece04f6bd80cb4920ae1795319549', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '17e4024bffe029bb3d5bc8e0ef3d82e81b8ce92f', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: 'f786f97bc9ecfbd35f3bb51c0c4f2134063b4ad0', class: 'sr-only' }, "clear input"), index.h("svg", { key: '775e37daa0d26f31be995d0f907f5e6327dc5516', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '4771d2d94a20701bc1d6cb9c89629f0b568586ff', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const ymdDate = index$1.z.string().regex(/^\d{4}-\d{2}-\d{2}$/, 'Expected date in YYYY-MM-DD format');
index$1.z.object({
    channel: index$1.z.string(),
    // These are null in your initialState, so allow nulls
    property_id: index$1.z.number().int().nullable(),
    balance_filter: index$1.z.string().nullable(),
    filter_type: index$1.z.union([index$1.z.number(), index$1.z.string()]).nullable(),
    from: ymdDate,
    to: ymdDate,
    name: index$1.z.string(),
    book_nbr: index$1.z.string(),
    booking_status: index$1.z.string(),
    userTypeCode: index$1.z.number().optional(),
    // In the interface these were literal 0/false, but you treat them like values.
    affiliate_id: index$1.z.number().int().default(0),
    is_mpo_managed: index$1.z.boolean().default(false),
    is_mpo_used: index$1.z.boolean().default(false),
    is_for_mobile: index$1.z.boolean().default(false),
    is_combined_view: index$1.z.boolean().default(false),
    start_row: index$1.z.number().int(),
    end_row: index$1.z.number().int(),
    total_count: index$1.z.number().int(),
    is_to_export: index$1.z.boolean(),
    property_ids: index$1.z.array(index$1.z.number().int()).optional(),
});
const initialState = {
    channels: [],
    settlement_methods: [],
...
class BookingListingService {
    ...
    async getExposedBookings(params) {
        ...
        const { data } = await axios.axios.post(`/Get_Exposed_Bookings`, Object.assign(Object.assign({}, rest), { extras: utils.extras, property_id: havePrivilege ? undefined : property_id, property_ids: havePrivilege ? property_ids : null, channel: havePrivilege ? '' : channel }));
        const result = data.My_Result;
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '44812b251f57d20178fc69fad9141afffa988b40', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'bb08a6f37e60b2e6ab689facef99e20aef534d55', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: 'b973094a4305436e64e5170f570715d9922ff7cb', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '3fee348f1d42d16089a95e7da3ae0d16c403eb71' }, index.h("button", { key: '2bfa2d5760032d42e8ee196f06bd427818cc1c54', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: 'f8634b61ae6bdce0a5481775e316faf2f098c8fb', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: '783b8852217f7a259975b2d212a1746fa40005e5', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: '34cab97735cb3f4cf62c7e7c9a8171af57818801', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: 'a1ea11311de7e7b2a6a5732a79f18f089c5ec98e', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '82480fcf1424972908cb8c2126f4ccf550107ce6', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: 'f7168a9176eae4e147d38e86a5a627691b5a5148', name: "trigger" }), index.h("input", { key: '0bb4f4e9a4d4b69344ca4ab910af8babcf9027f8', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5a5fdf469880fc2139ad3c0f011956e0e3c1491a' }, index.h("input", { key: '30d8d66077e5bdfb09740dfb0284631fcd0955a4', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDialog = class {
    ...
    render() {
        return (index.h(index.Host, { key: '55fdf7ca83674c469cfa116794a348e0e6567475' }, index.h("div", { key: 'a1279db57749c5b9eaa3eea583784f820ca65e77', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (index.h("div", { key: '05e5b64e0bd8c5bcd21409a7758ca5ceb207f9b5', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, index.h("ir-icon", { key: 'a8da0b120e6c1a347664496c096005924b71fb9d', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, index.h("svg", { key: 'b28077067540573f5bd3ffcfbf84d4556d868022', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, index.h("path", { key: '7fb7dbec67cbb3851bd543141e86f299e41ced5d', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), index.h("div", { key: 'f9bac595a3561efe6d169f4540a5004f9ffc00b7', class: 'modal-title', id: "dialog1Title" }, index.h("slot", { key: 'fdb16248cf284c8bd52ce3c3ff615bbbadac30c3', name: "modal-title" })), index.h("div", { key: '095f512d91741443447a722fe4c0548299ccf55e', class: "modal-body", id: "dialog1Desc" }, index.h("slot", { key: '5ae44538ee722715dc5feb036bb80fa643ecfac9', name: "modal-body" })), index.h("div", { key: '7b49843d60ba67a863c2cfb7007b2a74fcca9794', class: "modal-footer" }, index.h("slot", { key: '1a68647546537093cf0171a96fd994dd06a5360d', name: "modal-footer" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrDropdownItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f47d71f02ec98ac6b5203893c5f61db959f78f1c', role: "option", tabindex: "-1", "aria-selected": "false", class: { 'dropdown-item': true, 'hidden': this.hidden }, onClick: this.handleClick, "data-value": this.value }, this.html_content ? index.h("span", { innerHTML: this.html_content }) : index.h("slot", null)));
    }
    get el() { return index.getElement(this); }
};
...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '65f155a69b0d230e00a9205a3983a13b06d74b16', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '4203a331631a498c807f1cc9955c47857771eead', name: "icon" })));
    }
};
...
const IrListingHeader = class {
    ...
    render() {
        ...
        const havePrivilege = utils.isPrivilegedUser(booking_listing.userSelection.userTypeCode);
        return (index.h(index.Host, { key: '59d1e6abe87325bead148cdf7ce560700f66de14' }, index.h("section", { key: 'b1aca43e47e83551cc6d790634b7ab8afa9cedc6', class: "d-flex align-items-center " }, index.h("div", { key: '289b2de1ac6e3a9714b3cdc37cebe6887042284c', class: "d-flex flex-fill flex-column flex-md-row align-items-md-center booking-container" }, index.h("div", { key: '8d2c3d0b76936f8a854b408e9d51f6a7d9a23929', class: "d-flex mb-1 d-md-none align-items-center justify-content-bettween width-fill" }, index.h("h3", { key: 'b394ae42467f8bd75d394d3c0f9be5ef99a9307e', class: "flex-fill" }, (_a = locales_store.locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_Bookings), index.h("div", { key: '431b89900be97b301c0682e83b4981b929a353ef' }, !havePrivilege && (index.h("igl-book-property-container", { key: '5787535269a5f13524e70faa518a101bfdf91dc0', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '9f7a8ef0775549c0b089854bcb6d205b5a9b89cc', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" }))))), index.h("h3", { key: 'df0931642abaf35ccf2b84e724772ab14b9b90ad', class: "d-none d-md-block" }, (_b = locales_store.locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_Bookings), index.h("form", { key: '86531bb8c478203cf898456af7224c3a61e812b7', onSubmit: e => {
                e.preventDefault();
                console.log(this.inputValue);
                this.handleSearchClicked(false);
            }, class: "booking-search-field width-fill" }, index.h("ir-input-text", { key: '330b58879dfab038de4d9fa01f06e6af162a4802', class: 'flex-fill', value: this.inputValue, onTextChange: e => (this.inputValue = e.detail), variant: "icon", placeholder: (_c = locales_store.locales.entries) === null || _c === void 0 ? void 0 : _c.Lcz_FindBookNbrorName }, index.h("svg", { key: '7acbe736b50398edc98e1af41a94846b973e2db5', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '1fe29119887cbc10814c67a8b450feb2c64fba66', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("h5", { key: '520f8e502faac4c23534a5c77e5a0f28f7e626b8', class: "m-0 font-weight-bold d-none d-sm-block" }, (_d = locales_store.locales.entries) === null || _d === void 0 ? void 0 : _d.Lcz_Or))), index.h("div", { key: 'a57e8f21f0ef487f441a9305ab3f3db1a5111332', class: "d-none d-md-block" }, !havePrivilege && (index.h("igl-book-property-container", { key: 'f177121e4fc56a7c849cf2b39a63410c3a640ac1', p: this.p, withIrToastAndInterceptor: false, propertyid: this.propertyId, language: this.language, title: locales_store.locales.entries.Lcz_CreateNewBooking, ticket: booking_listing.token }, index.h("ir-button", { key: '8e27134a313013ea7cdddbf8bb9a8fbd335a6540', slot: "trigger", class: 'new-booking-btn', variant: "icon", icon_name: "square_plus" }))))), index.h("section", { key: '3710a26f443d1711d83aa3fc5de4de0e3b064d71', class: "d-flex align-items-center justify-evenly seperator-container d-sm-none" }, index.h("span", { key: '8c881ba5d05b56fd06daf22d4fe90fb122b2a51c' }), index.h("h5", { key: '6d9a868526dc42a56c0045cd2c01b7f2bc1223ea', class: "m-0 font-weight-bold" }, (_e = locales_store.locales.entries) === null || _e === void 0 ? void 0 : _e.Lcz_Or), index.h("span", { key: 'b5f756ecd0ed09e7d08b111ef66e654a6bb5b034' })), index.h("section", { key: 'c8c799d26fd92ba5854da7bb789604c5be43b2d0', class: "d-flex flex-column align-items-sm-center flex-sm-row flex-sm-wrap filters-container justify-content-lg-start mt-1" }, index.h("ir-select", { key: 'ec0c5f233e48c2910de6c2fa40bac03a22c7f3de', onSelectChange: e => updateUserSelection('filter_type', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.types.map(t => ({
                value: t.id.toString(),
                text: t.name,
            })), class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.filter_type, selectId: "dateTo" }), index.h("ir-range-picker", { key: '94d9d757cdd775fee15c2feed1e0d9cd53e6c757', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, allowNullDates: false, fromDate: moment.hooks(booking_listing.userSelection.from, 'YYYY-MM-DD'), toDate: moment.hooks(booking_listing.userSelection.to, 'YYYY-MM-DD') }), index.h("ir-select", { key: '39083e54d3d8ad89fd3e8cfd9223fd2d062edc28', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.booking_status, onSelectChange: e => updateUserSelection('booking_status', e.detail), showFirstOption: false, data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.statuses.map(status => ({
                value: status.code,
                text: status.name,
            })), selectId: "booking_status" }), !utils.isPrivilegedUser(booking_listing.userSelection.userTypeCode) && (index.h("ir-select", { key: 'f6b469b014fd9238ea9ecc28b25a721aee928e73', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.channel, onSelectChange: e => updateUserSelection('channel', e.detail), data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.channels.map(channel => ({
                value: channel.value,
                text: channel.name,
            })), selectId: "channels", firstOption: ((_f = locales_store.locales.entries) === null || _f === void 0 ? void 0 : _f.Lcz_All) + ' ' + ((_g = locales_store.locales.entries) === null || _g === void 0 ? void 0 : _g.Lcz_Channels) })), index.h("ir-select", { key: '386a410ec8178f0f6a9caba95aeefbee6ad71f30', class: "flex-sm-wrap", selectedValue: booking_listing.userSelection.balance_filter, onSelectChange: e => updateUserSelection('balance_filter', e.detail), data: booking_listing === null || booking_listing === void 0 ? void 0 : booking_listing.balance_filter.map(b => ({
                value: b.value,
                text: b.name,
            })), showFirstOption: false, selectId: "balance_filter" }), index.h("div", { key: 'a2fc945e5a11e92a2cb494300fafb47e62ade4d0', class: "d-flex flex-fill align-items-end m-0  buttons-container" }, index.h("ir-button", { key: 'dd466c58bff52920fe837652443ded040a5fb723', title: (_h = locales_store.locales.entries) === null || _h === void 0 ? void 0 : _h.Lcz_Search, variant: "icon", icon_name: "search", isLoading: this.isLoading === 'search', onClickHandler: () => this.handleSearchClicked(false) }), index.h("ir-button", { key: '21cb913447769f2a2f8bacc057a07e28b12cd239', title: (_j = locales_store.locales.entries) === null || _j === void 0 ? void 0 : _j.Lcz_Erase, variant: "icon", icon_name: "eraser", onClickHandler: () => this.handleClearUserField() }), index.h("ir-button", { key: '15825ca682d05f7b01cea5dbfc44550cac3444ac', title: (_k = locales_store.locales.entries) === null || _k === void 0 ? void 0 : _k.Lcz_ExportToExcel, variant: "icon", icon_name: "file", isLoading: this.isLoading === 'excel', onClickHandler: () => this.handleSearchClicked(true) })))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: 'a935b4beb3c13bdefd37218a5617be777a53e16d', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'eb554255e1b7dd0a4e4c06952cabe48648d3be8f', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '7b8be76db3f211e1f0ba7c9bfa30e4312ea3f36b', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '6d3d8a359cbe81aef6e18f8357d943d598e780dd', class: `ir-alert-header` }, index.h("p", { key: '21769f53f1a28f81c3c60d59e36238cdad94171f' }, this.modalTitle))), index.h("div", { key: 'afa278a6fb143459ae5a1826cf5874cb51331d43', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'dc17aeb590472b76cca023729f07e08bfebf9117' }, this.modalBody)), index.h("div", { key: '5782b4a6dbeaf2985e5eb0b7c30dd9f6ef8e8457', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && index.h("ir-button", { key: '1c30d21d02264ca499844adc566e33f44b9b41ba', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (index.h("ir-button", { key: '2a0bec6dc2daa0c0e906a22fab1d196837c8faa0', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'b793a848bbdeba4f61a948cda38c8fad0bb61c48', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'eea4c45410b3a48ff5d2a1317bceb34a419444e3' }, index.h("div", { key: 'f3e4ed10e037f9ddd0ea06d538a91fcb5c1bf637', class: "form-group mr-0" }, index.h("div", { key: '102ac42e1ec5db76cd088433b97e150de166e69d', class: "input-group row m-0 p-0 position-relative" }, showSideLabel && (index.h("div", { key: '8c1699595a8441a755ed105011578c2fe1ece9f9', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '5ca182aa656c68deb4f6444b37fbf7c7a204f840', class: `input-group-text border-theme flex-grow-1 text-dark` }, this.label))), index.h("div", { key: '28b01d4c1aa501d7f4e9e3dfccceb324b9c80b3c', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '5f901a80272de6c178891d491e1f45b3c9204adc', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '4655a8daa2f134e2a210a08b4ec9fccfdcb9216d', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '8dfa504fcdded4248c3b0d96b269a5c301af4051', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: '063f2c593fcc81c1610b63de5305dc8d2d5e2b64', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), useFloating && (index.h("label", { key: 'cea4894585e5c6ebf26a8a61eccf7d8d98f66411', id: this.labelId, class: `floating-label ${isActive ? 'active' : ''}`, htmlFor: this.inputId }, this.label)), index.h("input", { key: 'ad389ab11c028971750cc6491d79cf663dc6d05e', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e), onFocus: () => {
                this.hasFocus = true;
            }, onBlur: () => {
                this.hasFocus = false;
            } })), this.isDropdownVisible && (index.h("div", { key: 'dbd008dfe9da6fda40a6da975e4bda7e9960b57e', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: 'f5f5cfc1678765d13f3e3fbbd698f07d3d0d7227', onComboboxValueChange: e => {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b2423dc2f9af38bd5cb892620e470b5c85af083d', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h("fieldset", { key: 'e884c698827d3dae13e8bca9405464d9c5c65cec', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '2483959ec93f84f0e0cd2c9392e7ba4cccea6dee', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: 'b6d104c7aab40c470004de2ee0b5898fb73556c5', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '5c4f64abb8db0a24a42690f1517425b81c634c1d', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'cbcc07dc43604e6579f147fa0d278c0ec7f2479d', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '0b107ac10136f5f55113f191ab010b09b76896fe' }, index.h("span", { key: '75187514360a01e4017a6731764329d30ced087b', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '6e91053e359122285ae6ac6ed94edaadcf8e2e4d', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'aecf35a8fcfdd07e5b60ef579b9d4de499a0e23e', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '65e414a90769b3b460a4c62b26e0102d323b1c28', class: "input-group row m-0" }, label, index.h("select", { key: '4aee5a801b550021ce9c4f3fbf728ae25354297f', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '6e0ac9d3beb50e67249ccfe3de26e31c1e509ce2', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '2faf053d6d28da4ae74a58c0f903e97ddb6b57a8', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '8e29312a26d70717ab115c9d909635321b1f5366', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'b02101677c219dfd134a4232793489eda920e10b', class: 'sidebar-title' }, index.h("p", { key: 'da5ca53a8304b957259bb92ca6c8bf7afeb5cfe5', class: 'p-0 m-0' }, this.label), index.h("div", { key: '1888fc5fa82a9dc6270bba59c68bece931c3c31a', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '4149dc45d2de154e2bc88caf512580ee6ef57649', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '188b819230fe59dfb3e0625bf65a15e3159f6383', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '57caf975e8722075eabe562cc93cd5cf6c249f0a', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: 'b5c21497003024e935047147ec12eed23429d9a5', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSpinner = class {
    ...
    render() {
        return index.h(index.Host, { key: 'ce6288020edb5926b080affc9fddaae57170d9b7' });
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2d019ba7d4a96d4bf0aae269f21dd0eb65aea80a' }, index.h("h4", { key: '383abbfd6ae17bf496ea8389bf866976a3b93248', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '5054e049c99e5fd91bcb3f54fd5ac6c8c7329ef3', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '967910f1c04142538ba1dae4e0ad1a500ccda6e2', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '47dd5a5c1cb355403cd52fe554ab45e41d6960cb', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '2ab0738a3c959a82f4dd007dce8e29a9be643894', class: 'title-body' }, index.h("slot", { key: '8b0fa6f10e29c34317f9e8a8f1cbf6eaaa2e09b4', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
