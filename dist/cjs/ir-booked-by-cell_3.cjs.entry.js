...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (index.h(index.Host, { key: '47b1ab3c62670d98f7681962b187b08a9a4ebcb3' }, this.channelBookingNumber && index.h("wa-tooltip", { key: '53d1d3b5e76848a3c413def13905baf84dfd129e', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), index.h("img", { key: '698cefaabc7f4475601657f91d0f2cd9acf885f0', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), index.h("div", { key: '4e5ed20605caf2c912546eacf7db55645ade0099', part: "container", class: "booking-nbr-cell__container" }, index.h("div", { key: 'b71c154f36ccb128118caff3b1f3e980917fe7b6', style: { width: 'fit-content' } }, index.h("button", { key: '06eee7079a7040257d7ed6313231b23d90c46d3f', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, number.formatBookingNumber(this.bookingNumber))), index.h("p", { key: 'd57c6dfdf02af31fae0046a8eff474ca3d0ef7c6', part: "booking-reference", class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? number.formatBookingNumber(this.channelBookingNumber) : this.origin.Label))));
    }
};
...
const IrDatesCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ff071426c90c7375c384423115a76bf3d407cd18' }, index.h("div", { key: '0a38826f330632db0d5b7b035c463224debf15bb', part: "checkin-container", class: "date-cell__container" }, this.checkInLabel && index.h("span", { key: 'f4c741d3231ca9e90d2549bb3af4d63c55a22783', class: "date-cell__label" }, this.checkInLabel, ": "), index.h("p", { key: '576f1e616d8da42a8cd3f657aa186d9c90a5d0cc', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), this.showArrow && index.h("wa-icon", { key: 'cf778b4a332400a82da3a3252f0c4149a61694a4', class: "date-cell__arrow ir-flip-rtl", name: "arrow-right" }), index.h("div", { key: '8c3ece82db3b02b7b05452c0fe82d3f54e04bba6', part: "checkout-container", class: "date-cell__container" }, this.checkoutLabel && index.h("span", { key: '2e263ffc3aa3da264c95b5554d0765805fa2538f', class: "date-cell__label" }, this.checkoutLabel, ": "), index.h("p", { key: 'fb5af5c6e576481206d48524efc048a6c24b7c1e', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
