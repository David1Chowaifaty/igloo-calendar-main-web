...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (index.h(index.Host, { key: 'f5b0bf6066fd062a8100c643291d6aba840233f9' }, this.channelBookingNumber && index.h("wa-tooltip", { key: 'eaceb67c0f452b77d03ec655c6bf0e3177c7ab95', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), index.h("img", { key: '8eed352fa13976f1e0d09021eac29c659080af37', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), index.h("div", { key: '32c4b7809d67e948b09b0be4fcdc02e472984d80', part: "container", class: "booking-nbr-cell__container" }, index.h("div", { key: '22e13ca797ae33b5170ade2854a70cb18e8e687a', style: { width: 'fit-content' } }, index.h("button", { key: '3b2efce3f1f418e17d5f411d6d0bbf7d7859f2e8', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, this.bookingNumber)), index.h("p", { key: 'de7ea5735f41c8e5babe0f2979c59348846fbf81', part: "booking-reference", class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
};
...
const IrDatesCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7f4081435342f3d4112c051fff600f6f8ff9551e' }, index.h("div", { key: 'bfa7164fcfbfe188d40ad2789308392aae29493b', part: "checkin-container", class: "date-cell__container" }, this.checkInLabel && index.h("span", { key: 'cce968206dced51a3718736689b0cf2edb41a2fc', class: "date-cell__label" }, this.checkInLabel, ": "), index.h("p", { key: 'c7122a9fbcab12fe0a9f318377aa54cc30397fcf', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), this.showArrow && index.h("wa-icon", { key: '5d15adcbda0cee315f852dee176d9acf59efe732', class: "date-cell__arrow", name: "arrow-right" }), index.h("div", { key: '4e6656c3e3314d6c62895349c73022995a65aaed', part: "checkout-container", class: "date-cell__container" }, this.checkoutLabel && index.h("span", { key: '0f8401eb69de9622b30ebb9d5a238160ff788564', class: "date-cell__label" }, this.checkoutLabel, ": "), index.h("p", { key: 'c874f0c4507031d21a13928b989635a61290d8c8', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
