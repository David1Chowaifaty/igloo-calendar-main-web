...
const IrBookedByCell = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fa65aff937daefdb2a797845bd846dfef36971bf' }, this.label && index.h("p", { key: '18040f4e23781ec2bf5a6571e7f63eea2c8ca327', class: "cell-label" }, this.label, ":"), index.h("div", { key: '6dc1951886b7219796e1383119454a2e4b289826', class: "booked-by-source__container" }, this.clickableGuest ? (index.h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (index.h("p", null, guest)), this.showRepeatGuestBadge && (index.h(index.Fragment, { key: '2346f7eb1440e6bf59fc43458ebab9ec5766b028' }, index.h("wa-tooltip", { key: 'd88c60e2bd34f443bb73d6fbd1c5d6caa3a192d8', for: repeatGuestBadgeId }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), index.h("wa-icon", { key: 'a05de48b1ac4432e2d6efb3329f60f83990e3c58', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (index.h("p", { key: 'eaf2ea7993459e047940cc90d3ab2c5b67a6211f' }, this.totalPersons, locales_store.locales.entries.Lcz_P)), this.showPrivateNoteDot && index.h("span", { key: '4d57520c09e9ba19c1e39b57b2b4ead16229000c', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (index.h("div", { key: 'f8748e67cc1ec938de16e7e4352654b7feff101d', class: "booked-by-source__container booked-by-source__contact" }, index.h("a", { key: '8d51f37c6e83fc5367f49f6a3e658f95dff6ddbd', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, index.h("wa-icon", { key: 'f7b79418d873fc9e530b8fc6d9ca7d840ddc3c90', name: "phone" })), index.h("a", { key: '4f9db8ffb81584526ea8730e0cf78823c362a44a', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, index.h("wa-icon", { key: '247fdb974643481649e142b400b65b4ed36cb217', name: "whatsapp", family: "brands" })))), index.h("div", { key: '7ac8f8f727f94b9bf241bdb43a6271267f3dc3e8', class: "booked-by-source__container" }, this.showLoyaltyIcon && (index.h(index.Fragment, { key: 'cfa197721f567ea8885dd35756b282d13c0c2a9d' }, index.h("wa-tooltip", { key: '2a9f6db0deb2a7627d495a3f7683533b68f293f2', for: loyaltyBadgeId }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied), index.h("wa-icon", { key: 'ca8999e8c766a1fc61edb40558d3bae4228d01d1', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (index.h(index.Fragment, { key: '3dd0faab89e392a608d268b5005759e3179db316' }, index.h("wa-tooltip", { key: '1f1c20e90659dc7766fcfa9580e7d922a29e6028', for: couponBadgeId }, locales_store.locales.entries.Lcz_Coupon, ": ", this.promoKey), index.h("wa-icon", { key: '83f9d0e2087b6a73ed8fc87db705a1f5ca5c6394', id: couponBadgeId, name: "ticket" }))))));
    }
};
...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (index.h(index.Host, { key: 'd6043caa733fc1c9b77e6ecda8c9da157240e3d6' }, this.channelBookingNumber && index.h("wa-tooltip", { key: '02a6a2d0dc0722f79d03fd4842d9648e265ccd41', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), index.h("img", { key: '6307cc17d8517a8c063188b18855d028f2f3a006', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), index.h("div", { key: 'ccd685df1815d896af6aae792c8e41c64791ea27', part: "container", class: "booking-nbr-cell__container" }, index.h("div", { key: '637afd051818af6fb7ce7528d3cd4f6544b17452', style: { width: 'fit-content' } }, index.h("button", { key: '584ce51f1f2ef02e5fe0974f49825e815a2d776e', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, this.bookingNumber)), index.h("p", { key: '4d095c61dfe76b6dc123cf2d35d95a4fdb8d9799', part: "booking-reference", class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
};
...
const IrDatesCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1da779bbaa7dbdd504909095e3b44cdd94fd1b24' }, index.h("div", { key: 'c0fe27bd03de10fd515d2e45fa9ca7ed2e202b06', class: "date-cell__container" }, this.checkInLabel && index.h("span", { key: 'a20cb79658d51d71ae02288c249101fcbdf00ab6', class: "date-cell__label" }, this.checkInLabel, ": "), index.h("p", { key: '6cc0c3f72b115d7a81793ebc613bbd1aee55c767', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), this.showArrow && index.h("wa-icon", { key: 'ca15c63e82eeb9f5402c2d21d2123359d7554c70', class: "date-cell__arrow", name: "arrow-right" }), index.h("div", { key: '82c53416fbc2bcc48b04096b36e0ec0f59af82f6', class: "date-cell__container" }, this.checkoutLabel && index.h("span", { key: '19773ff9f89ee564b06c9569f4974e5920377897', class: "date-cell__label" }, this.checkoutLabel, ": "), index.h("p", { key: '6a6b3fc36545d3ee74575874e27fe72f27c41161', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
