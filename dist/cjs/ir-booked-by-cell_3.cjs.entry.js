...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (index.h(index.Host, { key: 'b1eed32adf24ad9b6df61b0a82e066292432cb50' }, this.channelBookingNumber && index.h("wa-tooltip", { key: 'e50fcccd0c1796244757fd51d4fe80369741e896', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), index.h("img", { key: '022de486aa89032780034c78952e1cd73704a807', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), index.h("div", { key: '550d2cf083865a51f9c8a832f04bd8663c788fcf', part: "container", class: "booking-nbr-cell__container" }, index.h("div", { key: '2dd5be60c6c62bc58ea9777290a8841cadf12c71', style: { width: 'fit-content' } }, index.h("button", { key: '6a6f11f6c778a41160ef90560e9365db39508197', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, this.bookingNumber)), index.h("p", { key: '1db1e9757efa1fd8766976f1e30106d925c95c1d', part: "booking-reference", class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
};
...
const IrDatesCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'cf91158a3d8dc9188547a8c7b99e811527d2e4d7' }, index.h("div", { key: 'cc9a6a65f3ea0bfb8ec988b9e0d7e6cc38c9f144', part: "checkin-container", class: "date-cell__container" }, this.checkInLabel && index.h("span", { key: 'b591da6985b6e46eee9b411188a708f16646d019', class: "date-cell__label" }, this.checkInLabel, ": "), index.h("p", { key: 'fa2afd094816d1eec029afb69a5ec0b7c70c9484', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), this.showArrow && index.h("wa-icon", { key: 'dc0c7c01b9a1d3c1c494484f0bb7574fd8a993c0', class: "date-cell__arrow", name: "arrow-right" }), index.h("div", { key: '1afbce8d4adced36cede521d3d8c53a4602ba6af', part: "checkout-container", class: "date-cell__container" }, this.checkoutLabel && index.h("span", { key: '596278394f0d8003c039510e36c5bbf1c5c7444c', class: "date-cell__label" }, this.checkoutLabel, ": "), index.h("p", { key: '4e5779fb7e368c4e545612f54e73d5b35d6b0f8f', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
