...
const IrBookingNumberCell = class {
    ...
    openBookingDetails;
    render() {
        return (index.h(index.Host, { key: '9ea9c41152adba331a3adcb1c99e3c062b1df54e' }, this.channelBookingNumber && index.h("wa-tooltip", { key: '64b4514f90aa253635bade73c133f472c6986572', for: `source-logo__${this.bookingNumber}` }, this.origin.Label), index.h("img", { key: '1266208401495385c12f108145684e4aba23a7eb', class: "booked-by-source__logo", id: `source-logo__${this.bookingNumber}`, src: this.origin.Icon, alt: this.origin.Label }), index.h("div", { key: '1b3572b70652c797a12730152088debec6cf8e3b', part: "container", class: "booking-nbr-cell__container" }, index.h("div", { key: 'f57c3c0623a0ba065a08ab7b055cee688850fb8e', style: { width: 'fit-content' } }, index.h("button", { key: '21db7457745d07bb2f47f50eef83ef507a1d6c9a', class: "booking-nbr-cell__button", onClick: () => this.openBookingDetails.emit(this.bookingNumber) }, this.bookingNumber)), index.h("p", { key: '646f0a4edd5c6a832a7df7a97cb849f4fefdf85b', part: "booking-reference", class: "booking-nbr-cell__channel_nbr" }, this.channelBookingNumber ? this.channelBookingNumber : this.origin.Label))));
    }
};
...
const IrDatesCell = class {
    ...
    render() {
        return (index.h(index.Host, { key: '15932ef452d7985b3381bc8b4b328e1dac6422bc' }, index.h("div", { key: 'd5dd08c4e2f56fe204809913fde0ccbbac048e7f', part: "checkin-container", class: "date-cell__container" }, this.checkInLabel && index.h("span", { key: 'e4e732c6b358ff3a1d7cfd3f402f6f959fc479d7', class: "date-cell__label" }, this.checkInLabel, ": "), index.h("p", { key: '81af43599a8b865e647e6fee0590b7483bc3f98e', style: { fontWeight: this.overdueCheckin ? 'bold' : 'auto' } }, this.formatDate(this.checkIn))), this.showArrow && index.h("wa-icon", { key: '71fb1be72be5fa6229b3871c67bb960729057e5a', class: "date-cell__arrow", name: "arrow-right" }), index.h("div", { key: '87edd0cee93df71a96e23b560209c0048b17fa75', part: "checkout-container", class: "date-cell__container" }, this.checkoutLabel && index.h("span", { key: '5d03282b256db32df80e6ea4f42b280160fa3309', class: "date-cell__label" }, this.checkoutLabel, ": "), index.h("p", { key: '6110132901af9ca0cc49fb859f97b6a751abf6b3', style: { fontWeight: this.overdueCheckout ? 'bold' : 'auto' } }, this.formatDate(this.checkOut)))));
    }
};
