...
const irMComboboxCss = ".sc-ir-m-combobox-h{position:relative;display:block}.dropdown.sc-ir-m-combobox{position:absolute;top:100%;left:0;z-index:1000;width:100%}.dropdown-menu.sc-ir-m-combobox{max-height:var(--ir-combobox-height, 200px);overflow-y:auto;min-width:100%;width:var(--ir-combobox-width, 100%) !important;scroll-behavior:smooth}.dropdown-item.loading.sc-ir-m-combobox,.dropdown-item.no-results.sc-ir-m-combobox{color:#6c757d;cursor:default;pointer-events:none}.dropdown-item.active.sc-ir-m-combobox,.dropdown-item.focused.sc-ir-m-combobox{background-color:var(--blue, #1e9ff2) !important}[slot='dropdown-content'].sc-ir-m-combobox .dropdown-item.focused.sc-ir-m-combobox,[slot='dropdown-content'].sc-ir-m-combobox .dropdown-item.active.sc-ir-m-combobox{background-color:#1e9ff2 !important;color:white !important}[slot='dropdown-content'].sc-ir-m-combobox [data-option].focused.sc-ir-m-combobox,[slot='dropdown-content'].sc-ir-m-combobox [data-option].active.sc-ir-m-combobox{background-color:#1e9ff2 !important;color:white !important}";
...
const IrNotifications = class {
    ...
    render() {
        return (index.h(index.Host, { key: '9794cc0a02d5b72470fa5af8170fbff233c33bae' }, index.h("div", { key: 'ab25d8313ad06ef23b05b9cf97a073c55b448449', class: "dropdown notifications-dropdown" }, index.h("ir-button", { key: '2bea0b4f52a2009c645eabcb2e4569279f865abd', ref: el => (this.buttonRef = el), variant: "icon", icon_name: "bell", "data-notifications": this.notificationCount.toString(), class: "notification-trigger", btn_type: "button", "data-reference": "parent", "data-toggle": "dropdown", "aria-expanded": "false" }), index.h("div", { key: '93df5bc176bbf2beda6a45b086ca27c8c397add7', class: "dropdown-menu dropdown-menu-right" }, index.h("div", { key: '72fbbb7c24f54ecd840cb531892463ef03026327', class: 'dropdown-item' }, index.h("ir-icons", { key: '3fb3c451f30566f4947bb0237e5697865c527389', name: "danger" }, " "), index.h("p", { key: 'a0e27a201f5fe2dbef614d8746df208d0085f8d4', class: 'p-0 m-0' }, "Something went wrong"))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrTestCmp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0799693e2747ba2ab6a2391625019e074d3ae36c' }, index.h("nav", { key: '7d3ed4e9b1355018bdb694923016a0b20d464ba3', class: "modern-navbar" }, index.h("span", { key: '130f721478f295ee2e63ac4f0ce18a1c3ecc3d4c', class: "overdue-banner" }, "Overdue $300"), index.h("div", { key: '7270e464552ea79ec5f9fa33d16c26031c318c60', class: "navbar-container" }, index.h("div", { key: '4171c937064c09de271377a22c67556101562333', class: "navbar-left" }, index.h("button", { key: 'ca1b12a4ef6d5decbe315cf68b063badad834836', class: "mobile-menu-toggle d-md-none", onClick: () => this.toggleMobileMenu() }, index.h("span", { key: 'efb320de3c78f411eb26b177bfe07665f08e98e4', class: "hamburger-icon" }, index.h("span", { key: 'ddffcebe4ceddc681967f38a5336dad443da590d' }), index.h("span", { key: 'a514d1ada13e387ae9ad63bc989841dcc494fd00' }), index.h("span", { key: '11d685e9040a44b7270fc1f81cf226ab6c0723ea' }))), index.h("div", { key: '6ee5613d1d76b6544cc4419b234c95c3080948bf', class: "navbar-brand" }, "Logo"), index.h("div", { key: '59619ec8d892886efb5e4d5266424b465cf8ff6f', class: "d-none d-md-flex " }, index.h("ir-m-combobox", { key: '3755c0d4b2e50dca78e16e9c821d1ed90b1bebb3', style: { '--ir-combobox-width': 'max-content' }, placeholder: "Find property", dataMode: "static", options: this.staticOptions, onOptionChange: this.handleStaticOptionChange })), index.h("div", { key: '599fb559146564c56468c12cec4fcef4004ccb83', class: "hotel-name d-none d-md-block" }, "Hotel Name"), index.h("div", { key: 'a030cbfc5d74bacb02f79fc91d26269070d7b412', class: "ml-auto d-md-none" }, index.h("ir-notifications", { key: '0f2c5fd8b140af437b407ff7758608c71b57e537', notificationCount: this.notificationCount }))), index.h("div", { key: '700b1ab76a3f4e29a3e70a1c905a7a214b31905c', class: "navbar-center d-none d-md-flex flex-fill mx-auto" }, index.h("ir-m-combobox", { key: '24ddb83d66411c32a4f5457adcd81c4821bd431f', placeholder: "Search...", dataMode: "static", options: this.staticOptions, onOptionChange: this.handleStaticOptionChange })), index.h("div", { key: '21d2738490db307ebdbe43cebae83a2b65d5f2bc', class: "navbar-right" }, index.h("ul", { key: '41362aada247c1cd59ad83649f09b5b89fbadd71', class: "nav-items d-none d-md-flex" }, index.h("li", { key: 'e825a6e4f8be2367f12e1003b060e1f243d768ec', class: "nav-item" }, index.h("a", { key: '4d26bca4d4211bab3e8435bea03d3cbf130d01e1', href: "#", class: "nav-link" }, "a")), index.h("li", { key: '2cded1cda85211ac7edea1b2fc617371a01f6b78', class: "nav-item" }, index.h("a", { key: '00ad6bc1eea9cefa46acee4f967c0f1b4e0fea16', href: "#", class: "nav-link" }, "b")), index.h("li", { key: 'ae54bb7eedf1b4fa4823e763264b8e0ed395fec4', class: "nav-item" }, index.h("a", { key: '470c5f69411c6b7df15df9c705ee88d7bd5e2ce5', href: "#", class: "nav-link" }, "c")), index.h("li", { key: '1289c110f4f503b7d36cdd9462969928ec22d6a3', class: "nav-item" }, index.h("a", { key: '2b84ab8a4460a8d0838e4469b6751c34734268f6', href: "#", class: "nav-link" }, "d")), index.h("li", { key: '753bad76c22d53a5b91f7c01ff83e29f24286871', class: "nav-item" }, index.h("div", { key: 'd8915fecab878936f425e2d9a6a23cecdbdf2d59', class: "d-flex align-items-center justify-content-center", style: { marginTop: '2px' } }, index.h("ir-notifications", { key: 'b272509637f9749227936b1407d3cd405bdac04f', notificationCount: this.notificationCount }))))), index.h("div", { key: 'e948c8f19de9e3472bfddbe03025c190c0631c40', class: `mobile-menu ${this.isMobileMenuOpen ? 'active' : ''}` }, index.h("div", { key: '249b98087490f2156255660d003b5dc7197a9601', class: "mobile-menu-header" }, index.h("div", { key: 'f3644267092fc6d62f8dcc2e39b6184204563b8b', class: "hotel-name" }, "Hotel Name"), index.h("button", { key: '6715e9f99e3400f367830259112958ff1d3c895a', class: "close-menu", onClick: () => this.toggleMobileMenu() }, "\u00D7")), index.h("div", { key: '5db0fb53b37b7861b603ff871c1dce2d638292d1', class: "mobile-search" }, index.h("ir-m-combobox", { key: 'c9880508f8713237681cbe7ee6133becc5ff8ef2', placeholder: "Search...", dataMode: "static", options: this.staticOptions, onOptionChange: this.handleStaticOptionChange })), index.h("ul", { key: 'd0ceddf0f8dbb7d2cde8ad6965191570f93dca53', class: "mobile-nav-items" }, index.h("li", { key: '1a788a21490dbbcff188d663dcc8df945d4e6fd1', class: "mobile-nav-item" }, index.h("a", { key: '5f80fd3c668f413f3b12b27f20bb8d1849b6c5f7', href: "#", class: "mobile-nav-link" }, "a")), index.h("li", { key: 'a946cc29c140cb2f063240caceb33312cc489182', class: "mobile-nav-item" }, index.h("a", { key: 'e48e2c9f4379d5c917bbc07f9c310ec1200319ae', href: "#", class: "mobile-nav-link" }, "b")), index.h("li", { key: '971a53cf2e9dbd28d208af6588871d03e7ed6ef6', class: "mobile-nav-item" }, index.h("a", { key: '528444d03c522bcfdeff537fd4319cc9bff47f62', href: "#", class: "mobile-nav-link" }, "c")), index.h("li", { key: 'f77b3ae5a246f1e2d76127fc8f5053093c418deb', class: "mobile-nav-item" }, index.h("a", { key: 'a99329893bf9f3c3fff54bf2d9afc73449ea3e7a', href: "#", class: "mobile-nav-link" }, "d"))))), index.h("div", { key: '715458d1104a743db2679fa3336fe866ee23e5dd', class: "submenus d-none d-md-block" })), index.h("section", { key: 'b158c96421d9cf2260151ded6c1499958425bdca', class: "p-2" }, index.h("div", { key: '50be9f6ff74e73f0c93f6252945f1bb2c5101716', class: "row g-3" }, index.h("div", { key: '06d1119cdb5b42431c450280e6ebdf848b9aca3b', class: "col-md-3" }, index.h("h5", { key: '53f772453ce02d328084c2b8ac7169c4c1b4e8d8' }, "Static Options Example"), index.h("ir-m-combobox", { key: '9b47bb0e5ca4554f37f9b23247bb28a36eed9175', placeholder: "Select an option...", dataMode: "static", options: this.staticOptions, onOptionChange: this.handleStaticOptionChange }), this.selectedStaticOption && index.h("p", { key: 'd79e0b71a7f0788737ef85dd83bddb3d6a37271e', class: "mt-2 text-muted" }, "Selected: ", this.selectedStaticOption.label)), index.h("div", { key: '1a7a0a8575a3f18e870136a3823c1097ef2d8e6a', class: "col-md-3" }, index.h("h5", { key: '64b9b1e866482a3fd0de0857894ee5dd46984ded' }, "External API - Countries"), index.h("ir-m-combobox", { key: 'fd48b7d7f5727115ca0f22ccaf8d58c2e85a7a7b', placeholder: "Search countries...", dataMode: "external", options: this.countryOptions, loading: this.isLoadingCountries, debounceDelay: 300, onSearchQuery: this.handleCountrySearch, onOptionChange: this.handleCountryChange }), this.selectedCountry && index.h("p", { key: 'f39767bb26f768f92e8c02038f848101aba0c959', class: "mt-2 text-muted" }, "Selected: ", this.selectedCountry.label)), index.h("div", { key: '0f61b525bc5971ca0aa2ec5f1179c2150691a339', class: "col-md-3" }, index.h("h5", { key: '52522a4d162e8cfafd5fa6052e834b4d7e84a38c' }, "Custom Dropdown Content"), index.h("ir-m-combobox", { key: '30188ae7bcda01e6f372a11d44d85744b497c82c', ref: el => (this.customComboboxRef = el), placeholder: "Search with custom dropdown...", dataMode: "external", options: this.customOptions, loading: this.isLoadingCustom, useSlot: true, debounceDelay: 500, onSearchQuery: this.handleCustomSearch, onOptionChange: this.handleCustomOptionChange }, index.h("div", { key: 'cf23c0c7d4b3fef6db0b3fde35c5142bc6ad8026', slot: "dropdown-content" }, this.isLoadingCustom && index.h("div", { key: '0f0dca00688c3d5f25f0052bdbf4dd20b6ae59ce', class: "dropdown-item" }, "\uD83D\uDD04 Loading custom results..."), !this.isLoadingCustom && this.customOptions.length === 0 && index.h("div", { key: '95f90804e01fd0195fd54cd29781d9cd258d3c59', class: "dropdown-item" }, "\uD83D\uDD0D Type to search..."), !this.isLoadingCustom &&
