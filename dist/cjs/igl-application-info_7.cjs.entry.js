...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: '920d944a8b3cefef99ac9ea3a0418f9cc9cad962' }, index.h("wa-radio-group", { key: '94c64abb67db814f216c06377aa844a0377a127e', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: '94a7ad1cbb93e8aaa56a6128bf169396b4737b27', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: '607dad5de3851d6f03a5649bae6404975ae4306a', value: "guest", appearance: "button" }, "Guest"))));
    }
};
