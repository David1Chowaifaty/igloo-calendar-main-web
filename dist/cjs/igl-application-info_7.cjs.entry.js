...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2d1afcc4c1e61324d69e270ca37e2e0f2ea91aa8', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: 'ca771937b988411725513ac95c679dd5269b5a7d', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: 'cc44641b06d4e5c99b1568e97b194bf484f9152e', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '5229b4b9f6a50b9780a102dae0840bee8eda1192', class: "fd-application-info__details" }, index.h("div", { key: '1f567032ec2afdb2a003d16ab2a85ce1596e5191', class: "fd-application-info__rateplan" }, index.h("p", { key: '7d7eb20b6e4e9dae7c7ee2ca6ce10ea1ed77562f', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '80358629a0a3140dfbcb9c8c1e4d84b1a1a7b8a4', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: '1d0d5423b4a3484c233b4c6611183a830af98368', for: this.tooltipId }, index.h("span", { key: '801f9a4d6bb8d5e7e97ce1fe6a21749a92122abd', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'b353f06581ff6ed67e790d1243dd6d5393735ab4', name: "circle-info", id: this.tooltipId })), index.h("p", { key: '91195606a783c0702f8b50af99d7fb182959e288', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: '09e9d2616b51c597db8e539b6c8fd802003bc4d3', class: "fd-application-info__price" }, index.h("span", { key: '45b034aff3bce76dedca607e97ed35c0c7863ad5', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: '4afb3064b53e228dde7d060077e3d9fd528fd703', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), index.h("div", { key: '7db1db0967d1139b3d1a97fe26f99707eb56abbf', class: "fd-application-info__footer" }, index.h("div", { key: '17a303e622d4b46c6d25bf1e4ca9d0f5bfd91eaf', class: "fd-application-info__rateplan" }, index.h("p", { key: '71e319e724e17428a909224fefe7686e3df8ff16', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: '3afa82e2f73243b5b4154548806565d4815d576f', for: `mobile-${this.tooltipId}` }, index.h("span", { key: 'b669353d2c961f5377f935ee6efe3d7cd36c994e', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '90a416e65e2309aef0b23d689d1b2e9672daac23', name: "circle-info", id: `mobile-${this.tooltipId}` })), index.h("p", { key: '6a9bb89ff2b84f8fcf10b36669fe28daddb221c2', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: '6ecdaa21d846649b93c652aaff93fa3fc1df4170', class: "fd-application-info__form" }, index.h("ir-validator", { key: 'b78eef581b8b4cd57bbf2ee7e40f7464e8442728', value: this.guestInfo?.first_name, schema: types.GuestCredentials.shape.first_name }, index.h("ir-input", { key: '3a8c8dc3c4408e1bafddf13d0b3c275feaf43db0', class: "fd-application-info__input",
            ...
            } })), index.h("ir-validator", { key: 'ef5b1ac88e6f1868cc12ea5e1e71264db7f2dde7', value: this.guestInfo?.last_name, schema: types.GuestCredentials.shape.last_name }, index.h("ir-input", { key: '48481f3cc5d3e6bbd44b6fb626c036449d57a099', class: "fd-application-info__input", type: "text",
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '59813b2824c24442ca96b47a247614d6c76d5298', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: '05e4ebd5fe040d045b4be236d753e364290e7771', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: 'fcd5f995a7ad30e5e2458ab81a9b2254b677cf21', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (index.h("p", null, index.h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable")))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (index.h(index.Fragment, { key: '6b065e3148b3c8c33ae5cd3f389d41b515a8a846' }, index.h("wa-tooltip", { key: '344859a7e137cb8076f73a03dc004287774978f2', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: '6c145686144f4257354e2d6b11d0a957ca29c3d1', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'e7b9c8b1675291cb65f37e271c04eb189efaaa9f', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (index.h(index.Fragment, { key: 'a2cff30522f1485904c460e376a12041ea70cb14' }, index.h("wa-tooltip", { key: 'aab2cbebcbc4fda8f4e8098aefdd13eca5858c99', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), index.h("wa-icon", { key: '8898bc872fca284c7df8476947de666e03aed6e2', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrDateRange = class {
    ...
    render() {
        ...
        return (index.h("wa-popup", { key: 'd44633c614fdf4b68091cd33b58b9d8c62f02d23', part: "popup", arrow: true, placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "igl-date-range__popup" }, index.h("div", { key: '8bda879e96a6405c8fcf293ca7b3cb55b4addfea', slot: "anchor", part: "anchor", class: "igl-date-range__trigger" }, index.h("div", { key: '787830b9e4bcf6e34764ebecc2f107c4e141c0c3', part: "combobox", class: "igl-date-range__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date range", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("ir-input", { key: '0445dffd0b99c57aa9775f8cbf548bb1e404bbff', part: "input", disabled: this.disabled, class: "igl-date-range__input", readonly: true, value: this.formattedLabel, "aria-invalid": this.isInvalid, "aria-expanded": String(this.isActive), "aria-disabled": this.disabled ? 'true' : undefined }, index.h("wa-icon", { key: 'bbadc0130a27eb9a6579107028cfc0049055cfaa', part: "calendar-icon", slot: "start", variant: "regular", name: "calendar" }), showNights && this.totalNights > 0 && (index.h("span", { key: '3496a0b624d08a90ac96e6f612db5735ae5b6cc7', part: "nights-badge", slot: "end", class: "igl-date-range__nights" }, this.totalNights, " ", this.totalNights > 1 ? locales_store.locales.entries.Lcz_Nights : locales_store.locales.entries.Lcz_Night))))), index.h("div", { key: 'f7a1a81340b7a9db09dd5864c84867d17a129caf', part: "body", id: this.popupId, class: "igl-date-range__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date range selection dialog" }, index.h("ir-custom-date-range", { key: '2d131362496c8b1302adcbc224556d2f41e5d97f', part: "calendar", exportparts: "base: calendar-base, calendar, calendar-header, month-navigation, nav-prev, nav-next, month-label, weekday-row, weekday, days-grid, week-row, day-cell, day-button", style: { '--cal-button-size': '35px' }, fromDate: moment$1.hooks(this.fromDate), toDate: moment$1.hooks(this.toDate), minDate: this.minDate ? moment$1.hooks(this.minDate) : undefined, maxDate: this.maxDate ? moment$1.hooks(this.maxDate) : undefined, onDateChange: e => this.handleCustomDateChange(e) }))));
    }
    static get watchers() { return {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '682d2b9f8d2455c9f46dfde7f5ed57701432ff5e', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: '6bf9e50a29db70abd5e701f803df0acf757cbee9', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: '535043ffde53721c201d01261ff8a32a42001b9a', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: 'e2d076e01ad227d835969d14bf961fce872402b5', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: 'f19f3b9c3fca4b63bbd641a3db0de02912d8ba3a', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: '47811d0a14a77087ffe2d06213c79460d60bdffc', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: 'ffcdb130865d29c7b30b5abb5fc5214b54e43b68', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: '9cff8ce4f86ea98343426918d59feade8ebd3797', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("ir-input", { key: '08607f1a440f7a09f4826091768e41f9bb21363c', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && index.h("span", { key: 'b2799584ad587433bbfab8755ad672662dd424f6', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (index.h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: '03b6cecb9e5fc2f21dcfe63843e30e942f78dd6d' }, index.h("wa-radio-group", { key: 'd3380f4b36b8928b0841db9d95ba1c6d07c03c4e', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: 'f082c24f8c6d8a7ac9d4e756b069276d04877690', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: '60dfa96cda4281893507050300900a4c7d47555e', value: "guest", appearance: "button" }, "Guest"))));
    }
};
