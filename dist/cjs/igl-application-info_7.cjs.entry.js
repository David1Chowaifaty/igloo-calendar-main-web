...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: '4b4f346e8afa353aa84c4c3a21bd6cc5808cee93' }, index.h("wa-radio-group", { key: '10d1b10f73145976f0ffdae3f641fb58bf229272', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: '01ba39a768e344e18141de10c23fef48fec944bf', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: 'a04082628710bb15b817626a5486c27253359531', value: "guest", appearance: "button" }, "Guest"))));
    }
};
