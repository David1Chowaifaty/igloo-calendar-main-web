...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4714f5b69de17d66b9a7e28ffe83678a99f8b418', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: 'c6e10b11fe5cfdc1c4f5357d39ddf4aa3f76b464', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: 'c494182c2aa733bbe442a14b92121e1ef8b34c41', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: 'cb0d3375c99d3b0f026f1d8969b2c78427d52cd5', class: "fd-application-info__details" }, index.h("div", { key: '5376578f26b9efd615e4270d9978c64b0aa24b90', class: "fd-application-info__rateplan" }, index.h("p", { key: '8de4ade3ecad87f172d291cfb3ad2e5996d87125', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '58e27e7bd8adbd998ab41df5d138330fd63afeff', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: '6b762259faaa625fe4452f208606f8bdc9421703', for: this.tooltipId }, index.h("span", { key: '16e86c11b8d46b0e4847e496504aa6bb6d0a6160', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'acd7ddc1be8a39b2ee1e0c670562ea493294af22', name: "circle-info", id: this.tooltipId })), index.h("p", { key: 'b23fca9d66acf625dba978bed23acd5c5ee7402f', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: 'eb5723dc20c51531f8881df5dcab73de244ac7ae', class: "fd-application-info__price" }, index.h("span", { key: '51e5aa40049163591c3afa2b1e72c59afab6a439', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: 'bcade8e765a9932e35245ce405df03d6e50f6a9c', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), index.h("div", { key: '8c5fc31f6e986db32d58042d6f5be0c1294e98a9', class: "fd-application-info__footer" }, index.h("div", { key: 'd5b6077af31a8e294584fa3b7de0084f8e78a507', class: "fd-application-info__rateplan" }, index.h("p", { key: 'ad283f4adfa3ca6fdec688106af0e81dcdf155ba', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: 'ab800d1816422c213357c1510bc7676d31ae2a8e', for: `mobile-${this.tooltipId}` }, index.h("span", { key: 'd9a89cf40a0bfaa290366f1036178171906440c8', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '8846ae44ff884609b06f3c111a2230a9a361cd13', name: "circle-info", id: `mobile-${this.tooltipId}` })), index.h("p", { key: 'eb3ea7af1e69966b853d12cd5562fd089b393524', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: '2887443d7ad8c7029ad4babb37c12d832db9ba36', class: "fd-application-info__form" }, index.h("ir-validator", { key: '258269056a9c51ed220e1c8f1e2f20b36ba94268', value: this.guestInfo?.first_name, schema: types.GuestCredentials.shape.first_name }, index.h("ir-input", { key: '92aeaff323ea0077595a67761278557465b552db', class: "fd-application-info__input",
            ...
            } })), index.h("ir-validator", { key: '3172e3fe75365788bc860ee80c8848cdc24c51b3', value: this.guestInfo?.last_name, schema: types.GuestCredentials.shape.last_name }, index.h("ir-input", { key: 'c74e2bad75f00e37d8ee3e6317d8d84cbc6be943', class: "fd-application-info__input", type: "text",
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("wa-select", { key: '24580883cef03166c3040f88009ed916816ee0cc', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_Assignunits, "data-testid": "unit", value: this.guestInfo?.unit, defaultValue: this.guestInfo?.unit, onchange: event => this.updateGuest({
                unit: event.target.value,
            }) }, filteredRoomList.map(room => (index.h("wa-option", { value: room.id.toString(), selected: this.guestInfo?.unit === room.id.toString() }, room.name))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("ir-validator", { key: 'a053fb4b6117f4d5ad5d0cd74733db61b2999e78', value: this.guestInfo?.bed_preference, schema: index$1.z.string().nonempty() }, index.h("wa-select", { key: 'b32552ab3ef7ff3ac8920f4e1342ebb9a167c40b', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_BedConfiguration, "data-testid": "bed_configuration", value: this.guestInfo?.bed_preference, defaultValue: this.guestInfo?.bed_preference,
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '9c556db647f6b4a8b5068f92ab582304cc487891', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: 'c53e539def610bbb5b39d75b41ab84f08868ccd1', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: '91f2e3a27c23f55043283d36607d441ca8eaf300', "data-testid": 'rp_name', class: "rateplan-name-container" }, index.h("div", { key: 'da1a2b82f5b45a7218ef3b5b958744a41226b8b8' }, bookingType === 'BAR_BOOKING' ? (index.h(index.Fragment, null, index.h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))) : (index.h(index.Fragment, null, index.h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), ratePlan.custom_text && index.h("span", { key: '0b001658a85f89fd0c23982a841c70500fadaa35', class: "custom-text-span" }, ratePlan.custom_text)), isAvailableToBook && (index.h(index.Fragment, { key: '82ddc1764536664eed0d26f6f452148f06a4bd7f' }, index.h("wa-tooltip", { key: 'a3f97bddb38e03872e1950e87b48a5dfd760833c', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: 'e47afbea971d70baad8aaec10e45f6874b46e3ae', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'd99f82b8ef91b32a4309204375d482b3b712018b', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (index.h(index.Fragment, { key: 'd5d352357af9f6ca5d2477d7c3526cc976afd62a' }, index.h("wa-tooltip", { key: '567d64606c51831c941327bcc3b26f409cc614b9', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), index.h("wa-icon", { key: 'a8da8c84e11cf5cf8f9406f8f7d5ca79fbabca22', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrDateRange = class {
    constructor(hostRef) {
        ...
        this.dateRangeShow = index.createEvent(this, "dateRangeShow", 7);
        this.dateRangeHide = index.createEvent(this, "dateRangeHide", 7);
    }
    ...
    fromDate = moment$1.hooks().toDate();
    /** Currently selected check-out date. */
    toDate = moment$1.hooks().add(1, 'day').toDate();
    ...
    calculateTotalNights() {
        this.totalNights = booking.calculateDaysBetweenDates(moment$1.hooks(this.fromDate).format('YYYY-MM-DD'), moment$1.hooks(this.toDate).format('YYYY-MM-DD'));
    }
    ...
    handleCustomDateChange(evt) {
        ...
        this.toDate = end;
        this.calculateTotalNights();
        const startMoment = moment$1.hooks(start);
        const endMoment = moment$1.hooks(end);
    ...
    get formattedLabel() {
        const from = moment$1.hooks(this.fromDate).format('MMM DD, YYYY');
        const to = moment$1.hooks(this.toDate).format('MMM DD, YYYY');
        return `${from} → ${to}`;
    }
    render() {
        const showNights = this.variant === 'booking' && this.withDateDifference;
        return (index.h("wa-popup", { key: 'c7cd1482316de14eac48e2fb59ff4ef6cbfa6f6d', part: "popup", arrow: true, placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "igl-date-range__popup" }, index.h("div", { key: '0955f4c043930dc228fce18fa50f5a09dc65e6a8', slot: "anchor", part: "anchor", class: "igl-date-range__trigger" }, index.h("div", { key: '96ef92c93143bff038f2a8768d45a5cd8e1ea092', part: "combobox", class: "igl-date-range__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date range", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("ir-input", { key: '35862b446fb0fa93cc91698d6bc0f2eba5c61ee3', part: "input", disabled: this.disabled, class: "igl-date-range__input", readonly: true, value: this.formattedLabel, "aria-invalid": this.isInvalid, "aria-expanded": String(this.isActive), "aria-disabled": this.disabled ? 'true' : undefined }, index.h("wa-icon", { key: 'a0fdb0669fc9be883362cdc7ed636fb1f9f285c1', part: "calendar-icon", slot: "start", variant: "regular", name: "calendar" }), showNights && this.totalNights > 0 && (index.h("span", { key: '6a6c4f10c8231cc051cee5e9f8b2f4a7ff449ef2', part: "nights-badge", slot: "end", class: "igl-date-range__nights" }, this.totalNights, " ", this.totalNights > 1 ? locales_store.locales.entries.Lcz_Nights : locales_store.locales.entries.Lcz_Night))))), index.h("div", { key: '035c1c990560e87fb55216f075327bddef1d4c71', part: "body", id: this.popupId, class: "igl-date-range__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date range selection dialog" }, index.h("ir-custom-date-range", { key: '5d2bddfb6fbfceeb51906af4a285e90a0b58441c', part: "calendar", exportparts: "base: calendar-base, calendar, calendar-header, month-navigation, nav-prev, nav-next, month-label, weekday-row, weekday, days-grid, week-row, day-cell, day-button", style: { '--cal-button-size': '35px' }, fromDate: moment$1.hooks(this.fromDate), toDate: moment$1.hooks(this.toDate), minDate: this.minDate ? moment$1.hooks(this.minDate) : undefined, maxDate: this.maxDate ? moment$1.hooks(this.maxDate) : undefined, onDateChange: e => this.handleCustomDateChange(e) }))));
    }
    static get watchers() { return {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '69f813a37d22638f465740686f261e9d5d9aa197', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: '2ac35f0fcf9fa6c9674aabf5ca57e735ee80c1d0', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: '7a9bb953e9214a7f2cc4dd0a74fb47faeefb0391', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '37e18fd33a25a28bae6ea10db5dc19123d43b8d8', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '52b79d8f7896cb7a39f4695c44ba1bd8bb6d79f7', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: 'd91a51ebcdc274db79657ffb0b253605a78d0eae', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: 'eb671e599a714c38f7b208fc644ebbd2afb51b40', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: 'ea676ec01292d6bba1383376e2aef30ec77fee6f', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("ir-input", { key: '1ef6c281ba41c266e152fc201ce0ab853d722b40', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && index.h("span", { key: 'f13a13510a5c6448c5d335b509f51299f813544e', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (index.h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
...
const IrServiceAssigneeSelect = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.assignmentChange = index.createEvent(this, "assignmentChange", 7);
    }
    /**
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: 'f0d41664206ea3d60bff816c703953b947fc0150' }, index.h("wa-radio-group", { key: 'bc72ffd009010549b4022474d38ec3df2439e758', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: '205b8976691ecf323e7b60c314adbfc8ba2cd9cb', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: '05a94ba16719cef7b18b13aeb1af79bcc68468dc', value: "guest", appearance: "button" }, "Guest"))));
    }
};
...
//# sourceMappingURL=igl-application-info_7.cjs.entry.js.map