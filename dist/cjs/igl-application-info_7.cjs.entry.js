...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '6be02f60ce6ce12d036035915efea6d689b952a1', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '933cf294c219fe4653f663b5fc08ca82433eb0da', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '28361f25baf9bd21c84235af3281132e4cd8ce95', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '9acea0d8e22cba9de1115223942211951ad90f42', class: "fd-application-info__details" }, index.h("div", { key: '7ece43f97603c4cba3ec05da4a2087538d7365dc', class: "fd-application-info__rateplan" }, index.h("p", { key: '44c76ed36424d26f4ee04950a51cd9ddeea8367b', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '27840169e9bba718a519dade0dfd4bd4619bcdd9', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: 'fa8a2f909164bdc9e031844852aa63db5d1433aa', for: this.tooltipId }, index.h("span", { key: '544ac6805f93144dd9b2dd30e7b026462f1df596', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'ae1513a98ebeb340995724541167ead1c6e231de', name: "circle-info", id: this.tooltipId })), index.h("p", { key: '3b02b40c01a5ef461ea9110de69ce285b91786ec', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: '74c8bc8172967774fcaf84f493e4fe2b6bccfdd5', class: "fd-application-info__price" }, index.h("span", { key: '7def5af8c8b0d34131c4c2225665a45350756265', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: '12f67eebd1bb14c06aed188d6448bca257c9e964', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), index.h("div", { key: 'a1865c459087e3f79cfe7a1d9c2efdd54aa98277', class: "fd-application-info__footer" }, index.h("div", { key: '5daaef94ac7273e9d113b48d82a29a2a665125b7', class: "fd-application-info__rateplan" }, index.h("p", { key: 'f74b2edfb033b838625bb3d6dff2730ea0bed559', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: 'a393b203befd3ef2dbc6ac9bdc672e6e12804bff', for: `mobile-${this.tooltipId}` }, index.h("span", { key: '9f51bcefd0a23f222970240efb57c06e02c093b9', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'c3472bd1dc3698f3f85efb1c22d954954b661194', name: "circle-info", id: `mobile-${this.tooltipId}` })), index.h("p", { key: 'c6289f47cc9d899b3b3ddb0e9d9ed2b0f9f17052', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: '6892c3c49befdd24022ba792b8a933b27a1f0186', class: "fd-application-info__form" }, index.h("ir-validator", { key: 'c10150d6eec91d0464e899162b679cc2f6f3c2a4', value: this.guestInfo?.first_name, schema: types.GuestCredentials.shape.first_name }, index.h("ir-input", { key: '59568e80ce3f1f690d1033c5c233a3b4c74b18cb', class: "fd-application-info__input",
            ...
            } })), index.h("ir-validator", { key: 'bae1f1280a2586e1b0005e4113548cff6c5ea42e', value: this.guestInfo?.last_name, schema: types.GuestCredentials.shape.last_name }, index.h("ir-input", { key: 'd00bf16e719664a7b746f010064bd76eaa9dbdca', class: "fd-application-info__input", type: "text",
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("wa-select", { key: '11092dcccd2accf1c4ad3f86470c3c38a8fa4d62', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_Assignunits, "data-testid": "unit", value: this.guestInfo?.unit, defaultValue: this.guestInfo?.unit, onchange: event => this.updateGuest({
                unit: event.target.value,
            }) }, filteredRoomList.map(room => (index.h("wa-option", { value: room.id.toString(), selected: this.guestInfo?.unit === room.id.toString() }, room.name))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("ir-validator", { key: '499356a202dace9294a53f8f61ea6edd16de444b', value: this.guestInfo?.bed_preference, schema: index$1.z.string().nonempty() }, index.h("wa-select", { key: 'e68ee05b7178bacf5e9f98bf89162918e5edb105', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_BedConfiguration, "data-testid": "bed_configuration", value: this.guestInfo?.bed_preference, defaultValue: this.guestInfo?.bed_preference,
            ...
            }) }, this.bedPreferenceType.map(data => (index.h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("p", { key: '8aaae200c1fa20c6c6e37c7edba08197b926877a', class: "fd-application-info__price-inline" }, index.h("span", { key: '28225bf6e44f9cceb606ca53eb0708116ca887a5', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: 'c4b6a1ec04ec09eef4bbfce0f8d70dd3bd2b9005', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: 'e630cdeb5485be310e950328f96396995cf8757c', class: "fd-application-info__infant" }, index.h("p", { key: '6ef015ad2264f05f3b6877ee74dbf6547cba62b9', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), index.h("wa-select", { key: '29dd92eacf5b32ab436857ac5dfdcacea454d445', size: "small", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales_store.locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => {
                this.updateGuest({
...
const IglDateRange = class {
    ...
    render() {
        ...
        return (index.h("wa-popup", { key: '4b7ff0a84b5fa5dce6db8ae896684cfc7fe79a90', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "igl-date-range__popup" }, index.h("div", { key: 'ea86000b818a0780ce61e1e1e38cb3a4b41d246c', slot: "anchor", part: "anchor", class: "igl-date-range__trigger" }, index.h("div", { key: 'd3887b927bd66e1bca8f1f9f05895975a5a2d4a6', part: "combobox", class: "igl-date-range__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date range", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("ir-input", { key: 'fb99158cbc2cec477c2356d6717afabd428ecc8a', disabled: this.disabled, class: "igl-date-range__input", readonly: true, value: this.label, "aria-invalid": this.isInvalid, "aria-expanded": String(this.isActive), "aria-disabled": this.disabled ? 'true' : undefined }, index.h("wa-icon", { key: 'd3701f6efb59a9b168fed6f66dcbf36ad33b7d25', slot: "start", variant: "regular", name: "calendar" }), showNights && this.totalNights > 0 && (index.h("span", { key: 'e6e1a54aac673d2b144559e1c48348e6e88f2888', slot: "end", class: "igl-date-range__nights" }, this.totalNights, " ", this.totalNights > 1 ? locales_store.locales.entries.Lcz_Nights : locales_store.locales.entries.Lcz_Night))))), index.h("div", { key: '59191d5ae697bfc88088152cb641e9114d33c04a', part: "body", id: this.popupId, class: "igl-date-range__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date range selection dialog" }, index.h("ir-custom-date-range", { key: '0633e43d67709da5383c50351e0b419f8683180b', style: { '--cal-button-size': '35px' }, fromDate: moment$1.hooks(this.fromDate), toDate: moment$1.hooks(this.toDate), minDate: this.minDate ? moment$1.hooks(this.minDate) : undefined, maxDate: this.maxDate ? moment$1.hooks(this.maxDate) : undefined, onDateChange: e => this.handleCustomDateChange(e) }))));
    }
    static get watchers() { return {
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: '139389817c0d5fb6ab586b9ec21fa9a1493b645f', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: 'd17e9f8996e4a408c0548a9936fb6777c2e23631', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: '4e3571aa25f205f3e70c9bd6b71ddbe3ac1ace66', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (index.h("p", null, index.h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable")))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (index.h(index.Fragment, { key: '6923af72ace465e128625d214c88e0e3aaabd8a1' }, index.h("wa-tooltip", { key: '17751af63ff302e548250a7533f729af6659d7d8', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: '3cdc5dae792b96f44a24b798fb32b5c526ef18af', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '5a9d55e7503cb501b13f65e7cd5f96056fc4d4b0', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (index.h(index.Fragment, { key: '024480175ed170f19bf8fb9a7af9038ed89ecacb' }, index.h("wa-tooltip", { key: 'd03a753ec897717d0a6a06b1e00f8f0239d287a7', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), index.h("wa-icon", { key: 'cd91c8915d5dceeae29d7ecee0d306a5f8453a4c', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1d8edff1b928ce07dada04ba1f812fe76a46f47d', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: 'ab37cef373c20b68d69f6f5c280a311e738f683e', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: '2c060110323a31ce23d28539e472789ac655e793', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '5bd81f013294c55dde81b2a9d55f9dff9055b850', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '4fc349dcd9547037f96feb8e3595d2ef290551e5', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: 'f2187aa1d5ed15525a7531e67d9ae69748eb45bb', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: '16aeeff27847a0f91f65d29188f33373b42dc7e8', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: 'a031ea0a6f3a874be65d095bab9b8af784d20bc6', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("ir-input", { key: 'f4bcca4b4b2fdf6e7835836a43998a9ca93e9d5a', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && index.h("span", { key: 'dfca32ac836e15b018b20e0cba22975af9032cc2', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (index.h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: 'f735f8f7afdd7172e7e9c950e47d6653a51e4d5c' }, index.h("wa-radio-group", { key: '68a3f2435bb1ae6478b555550970d54cae9cba5e', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: 'd40e343141467f6e67db46c0795d50b6b3a8c767', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: '0f11f59ce853ee08a0284dd47e496c4a47bf2f2a', value: "guest", appearance: "button" }, "Guest"))));
    }
};
