...
const momentWithLocales = require('./moment-with-locales-673ce3c1.js');
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '67277367962668f1fad27e110c9a4f11b0812fcd', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '94dd16ae75e2ef93560c486776e9425c5829e565', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '4f589697356620fce1eead6eed1d211615d45675', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '678c226b1d2b41e555df7cd22d579acd7765378d', class: "fd-application-info__details" }, index.h("div", { key: '8876b86d5ddd16f1bf08bbd1765cd322651a1690', class: "fd-application-info__rateplan" }, index.h("p", { key: '5b9a9abeb71bcd16cc82e074423d24e5cfd9168e', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: 'bec88b27e54fa59098ee84ab4ca2d3d3e20cef2e', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: '9134b57b45d68afa649fd3940c8f70a443f4b05d', for: this.tooltipId }, index.h("span", { key: '09273ff03a22b44e1235ff264cef2093180088fe', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'b5f48681d6f40c58933aa5d851900cd745c809f5', name: "circle-info", id: this.tooltipId })), index.h("p", { key: 'd9388881bbb14a189fd72815cc0a132b13eea1fa', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: '8b6d8833a51eb8c591fa3ecefde2d8f72a769492', class: "fd-application-info__price" }, index.h("span", { key: '303716193df2d23e246b889cb756d5c188b995e3', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: '53508f93dcba4c8bec25f6a29ba2b94c7af034c7', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), index.h("div", { key: '7d43882558b884ff96634ba0edb3e5ac2588fed7', class: "fd-application-info__footer" }, index.h("div", { key: '6e2e196b7652baa60b037a93b188ad2f470fdf32', class: "fd-application-info__rateplan" }, index.h("p", { key: 'd5047c52e551638ba4ceab9477e5c4dbd3dd2b1b', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: '544ae90e22bd9d04eab0bace43349bd6cafcca7c', for: `mobile-${this.tooltipId}` }, index.h("span", { key: '78975163b7f706658f6ef080e95a4f4c504a4f3c', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '2a1776e13d397b2eb4b40bcb479f513312ebd8cf', name: "circle-info", id: `mobile-${this.tooltipId}` })), index.h("p", { key: 'a1b36990dedbe47d68c923862b962dd3c48c476f', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: '058baf631f384c7d47aa4a2ee66f96ae83aada25', class: "fd-application-info__form" }, index.h("ir-validator", { key: 'b7843258900ae93de52b72701dbd629a4ac1dbdf', value: this.guestInfo?.first_name, schema: types.GuestCredentials.shape.first_name }, index.h("ir-input", { key: '52bd6ff8959c9f979e84ec42d45e7fa7c4063563', class: "fd-application-info__input",
            ...
            } })), index.h("ir-validator", { key: '12a954ad32d613880997f3f436232ccf97a09b19', value: this.guestInfo?.last_name, schema: types.GuestCredentials.shape.last_name }, index.h("ir-input", { key: 'a32e9d4450df55b6caa711e512f2b980c95d4cbf', class: "fd-application-info__input", type: "text",
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("wa-select", { key: '3775b69f56d4599ee2b60044ac0aa0c2abb42bff', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_Assignunits, "data-testid": "unit", value: this.guestInfo?.unit, defaultValue: this.guestInfo?.unit, onchange: event => this.updateGuest({
                unit: event.target.value,
            }) }, filteredRoomList.map(room => (index.h("wa-option", { value: room.id.toString(), selected: this.guestInfo?.unit === room.id.toString() }, room.name))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("ir-validator", { key: '4a1e5b337c7649ec5a7257ce6cd35f263070c8df', value: this.guestInfo?.bed_preference, schema: index$1.z.string().nonempty() }, index.h("wa-select", { key: '9db4df3e51b7e65a739253419965b3b2be0d8d74', "with-clear": true, size: "small", class: "fd-application-info__select", placeholder: locales_store.locales.entries.Lcz_BedConfiguration, "data-testid": "bed_configuration", value: this.guestInfo?.bed_preference, defaultValue: this.guestInfo?.bed_preference,
            ...
            }) }, this.bedPreferenceType.map(data => (index.h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("p", { key: 'bf886bab71ce3210b38072c57ebe946c1145c695', class: "fd-application-info__price-inline" }, index.h("span", { key: 'da6304df5a47f9a6ec030f43d949fa504066d99e', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: 'ebbcdfcfa836872c502554d8cd624c4624d194db', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: 'bf12d26285df401363f812b7483453e78ee877a5', class: "fd-application-info__infant" }, index.h("p", { key: '802b677defa4174fca09fc4282877e460215b81c', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), index.h("wa-select", { key: 'cf0a33f11abcb93044d7ffc471b864edb75d9778', size: "small", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales_store.locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => {
                this.updateGuest({
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: 'a7228a6188c17c627c7715b69a17969f23064ab5', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: 'cef81127a4410f8c78c959206249cf9584948342', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: 'e16439a7b18039e6a208e76c47d8e801bdd32f2c', "data-testid": 'rp_name', class: "rateplan-name-container" }, bookingType === 'BAR_BOOKING' ? (index.h("p", null, index.h("span", null, ratePlan.name.split('/')[1], " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable")))) : (index.h("span", null, ratePlan.short_name, " ", ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), isAvailableToBook && (index.h(index.Fragment, { key: '83ab67f158c7a8baf7b2cb0d8d24106ca1c6ccff' }, index.h("wa-tooltip", { key: 'c30b0f28af22fa5573331ecf5372b7f345d30e93', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: 'ebd93d0adfee6dde3d5efe0068721c3fe063974f', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '3e2b9150ce3ec2046268f2ed5b19dd987ed858ae', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (index.h(index.Fragment, { key: '9ae54354da86400407906d1f8e8b3facdd213045' }, index.h("wa-tooltip", { key: 'e262ca5e28c2121b43b555721ce501c6de1188cd', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), index.h("wa-icon", { key: '7a474c4813b55cf61d3b3de2489ee043f26c9ee5', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a6bf266461e3ab1b0d64cadcbf367e97cdda04f1', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: '91fc59cc40d52e96c47610d03373994f1dce3d81', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: 'f827be32446800c8ab3f32898b029b53008a6c83', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '9ae24728076b7d3c52ab74d176eed65f8dbbe1d1', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '5bb6d98a3e7dc082f4eec72f4ba34153602fbaf2', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: '3a08028b4ea12871caa67553662b2a64d9303bc1', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: '6cbeeddf23d4079dea17d3fe7eb9195b9545e10b', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: '97dbb87f395df6b2b86e4706c4b68f7c511d1a62', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("ir-input", { key: '64802e81c116ffb1713963c8dfcd94a1c9fcfe51', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && index.h("span", { key: '57a5b3db6450301de5882f36667305eec1965198', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (index.h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
