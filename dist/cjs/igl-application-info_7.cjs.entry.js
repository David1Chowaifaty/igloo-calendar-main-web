...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: 'aef677bb83dec7f4caaddbe21ff64da3cbaaea10' }, index.h("wa-radio-group", { key: '8b37400b0a137be0b202a299b622e278cb404be3', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: 'c9bb0d48214fdc350911717ea57f6e8f3f3c6305', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: '2076a38ad82ef7a3df4ef13bc28b31ac42bf92ea', value: "guest", appearance: "button" }, "Guest"))));
    }
};
