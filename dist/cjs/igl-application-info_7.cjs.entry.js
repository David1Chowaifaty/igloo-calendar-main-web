...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'bc1f00b905d7aec1c03819047b35cf613147dc55', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '3dbf56e04d0dfedc18b234ea1bccdec1bb844af3', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: 'd2505bcca9979b3d958737317e321b2c38238a88', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: '27f7f576a00d32d5d15c56b321854184f544bcfc', class: "fd-application-info__details" }, index.h("div", { key: '1e246a5338085199804bb4cb2f24cf71fc98d8c5', class: "fd-application-info__rateplan" }, index.h("p", { key: '94aed86a1282d844813ea75a46f51cde57158a7c', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '511e61862ded92bd07becd96219cfdb3c71dd5da', class: "fd-application-info__non-refundable" }, "Non Refundable")), index.h("wa-tooltip", { key: '296d6f0d86f81236e9a970824edd3791e21f0e44', for: this.tooltipId }, index.h("span", { key: '0f5ff8992db193dae2fd9b7eeb8810a824504ae1', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'b9ae4d26e54c0c190e55527ed82a9462ba5e3fd9', name: "circle-info", id: this.tooltipId })), index.h("p", { key: '0375986086094d4708a2ca971ee09d1dfe5308cf', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("p", { key: '30195032fcb2ea7816b262b38399a010d6787932', class: "fd-application-info__price" }, index.h("span", { key: 'a53e21e6cc392ef097828f50c846996863abc809', class: "ir-price" }, utils.formatAmount(this.currency?.symbol, this.amount), "/", locales_store.locales.entries.Lcz_Stay), index.h("p", { key: 'edb52e010fecab33605db7938761a045f45bd061', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), index.h("div", { key: '0256f9b405f1eb33e96a31466d9250bc0e3f67f9', class: "fd-application-info__footer" }, index.h("div", { key: 'ec60dd68397e43c311a5ff970b6fa2c7cb5f4f10', class: "fd-application-info__rateplan" }, index.h("p", { key: '2f5cf396e6568bff331d12f13306418680cefae6', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("wa-tooltip", { key: '87b16e0ed2f9e1f720f10bc3036309434ec6200d', for: `mobile-${this.tooltipId}` }, index.h("span", { key: '234b82f08724313a60c05e726274a7215dee0aa9', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: '14616f3694e5829ec8af765455c93f778efafc34', name: "circle-info", id: `mobile-${this.tooltipId}` })), index.h("p", { key: '9f8670baf99638bb02016c7a964f3b8ed981ff4c', class: "fd-application-info__variation", innerHTML: formattedVariation })), index.h("div", { key: '97ad04a79ebf166231c2eb4ee6af2dc2d6908684', class: "fd-application-info__form" }, index.h("ir-validator", { key: 'a7c0599efda58ea5e21f74764890807354321222', value: this.guestInfo?.first_name, schema: types.GuestCredentials.shape.first_name }, index.h("ir-input", { key: 'bde0a0a8be2d018c5b5497adf36e04cbd6812665', class: "fd-application-info__input",
            ...
            } })), index.h("ir-validator", { key: '288ad79928faac295d424c241f530a9c5bb860e4', value: this.guestInfo?.last_name, schema: types.GuestCredentials.shape.last_name }, index.h("ir-input", { key: '847c65fb382a24986760bac88226a7ebcfbe6022', class: "fd-application-info__input", type: "text",
...
const IglRatePlan = class {
    ...
    render() {
        ...
        //   return null;
        // }
        return (index.h(index.Host, { key: 'f04fa00149fcf94859b2d2094941366641bbd201', "data-testid": `rp-${this.ratePlan.id}` }, index.h("div", { key: '977f3f522b0b2b20337cfbc7e36862965a28a2df', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, index.h("div", { key: 'c196391f85c705a7c568abc15512d78a8b31ecba', "data-testid": 'rp_name', class: "rateplan-name-container" }, index.h("div", { key: 'e58c1f394d9a460466c15f7e439cb978aff1f20b' }, bookingType === 'BAR_BOOKING' ? (index.h(index.Fragment, null, index.h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))) : (index.h(index.Fragment, null, index.h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && index.h("span", { class: "non-ref-span" }, "Non Refundable"))), ratePlan.custom_text && index.h("span", { key: 'b3614cb0c80d04b3a52a3322edcdc549a598520d', class: "custom-text-span" }, ratePlan.custom_text)), isAvailableToBook && (index.h(index.Fragment, { key: 'c2ada475ac96856962ca5a4f2746a08747404197' }, index.h("wa-tooltip", { key: 'b10bea22ac8fba0c2bb00bf85194154b8630001a', for: `rateplan-${this.ratePlan.id}` }, index.h("span", { key: '613b44687dbebea824a3908a1068e155c9212481', innerHTML: this.getTooltipMessages() })), index.h("wa-icon", { key: 'f16da0833bbdd59ec1b214d992e369f2875684f8', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (index.h(index.Fragment, { key: '69d3e9549190b80dc928fa9bd4c2ad7a70f4308f' }, index.h("wa-tooltip", { key: '262f679b8fde6d81f1fe384583aa22b5c1cca9a1', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), index.h("wa-icon", { key: '3618938a38efc11c80091fe59d87ccf18ec80ede', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (index.h("div", { class: "rateplan-container" }, index.h("wa-select", { size: "small", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
...
const IrDateRange = class {
    ...
    render() {
        ...
        return (index.h("wa-popup", { key: 'afb3a221ae5726bd3c02349ea999ce695b01398c', part: "popup", arrow: true, placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "igl-date-range__popup" }, index.h("div", { key: '7ded5b6b42e38df0976c0207abdad91707ca2b51', slot: "anchor", part: "anchor", class: "igl-date-range__trigger" }, index.h("div", { key: '1a32369c40e9dea8a79014b57b022b24a12c82c4', part: "combobox", class: "igl-date-range__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date range", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("ir-input", { key: 'd5ef99e566fae2ebe25f0328b26eddb0b65fa1a9', part: "input", disabled: this.disabled, class: "igl-date-range__input", readonly: true, value: this.formattedLabel, "aria-invalid": this.isInvalid, "aria-expanded": String(this.isActive), "aria-disabled": this.disabled ? 'true' : undefined }, index.h("wa-icon", { key: '3874a2ed2c719c29adec3f2278e978e12e4847c0', part: "calendar-icon", slot: "start", variant: "regular", name: "calendar" }), showNights && this.totalNights > 0 && (index.h("span", { key: '68c5c740feb7f1b93e5d7baf83aaf721ece53d38', part: "nights-badge", slot: "end", class: "igl-date-range__nights" }, this.totalNights, " ", this.totalNights > 1 ? locales_store.locales.entries.Lcz_Nights : locales_store.locales.entries.Lcz_Night))))), index.h("div", { key: '4f17d129149d71349dc415eea7d3a98fab51b0dd', part: "body", id: this.popupId, class: "igl-date-range__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date range selection dialog" }, index.h("ir-custom-date-range", { key: '5ef54098e15100ee2d08a91ef59d2f4484f1c004', part: "calendar", exportparts: "base: calendar-base, calendar, calendar-header, month-navigation, nav-prev, nav-next, month-label, weekday-row, weekday, days-grid, week-row, day-cell, day-button", style: { '--cal-button-size': '35px' }, fromDate: moment$1.hooks(this.fromDate), toDate: moment$1.hooks(this.toDate), minDate: this.minDate ? moment$1.hooks(this.minDate) : undefined, maxDate: this.maxDate ? moment$1.hooks(this.maxDate) : undefined, onDateChange: e => this.handleCustomDateChange(e) }))));
    }
    static get watchers() { return {
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5855647a8ea4bfc0aa4d9f84af4617bc5907c178', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: '75d6292651b3b88d609499210032da7b67a5a0e9', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: '27310c3329ae065d4cc0a382fbee4d2c6b98c558', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '833b104dc825c1fc5838925fb5ddc7f9c1035ae7', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '7ceb6e05a533471fd09b1ab7fb24aecf9267f991', "aria-invalid": String(this.isInvalid && !this.selectedCountry), slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: 'ec4b4e4c53328179d9eba6d60664556f567574c6', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: 'e1c5cef60ccdd1495209b4a656629c22bad5dd3c', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: 'cb396f674339d5e44edfd86f5bd8aadf0573144d', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("ir-input", { key: 'dbe4abe26554a42025b94ab5953a1af7186eb7aa', "aria-invalid": String(this.isInvalid && (this.value ?? '').length < 4), type: "tel", inputMode: "tel", autocomplete: "off", disabled: this.disabled, placeholder: this.placeholder, defaultValue: this.value, value: this.value, class: "phone__input", "onText-change": e => {
                const value = e.detail;
                this.value = value;
                this.mobileInputChange.emit({ formattedValue: value, value, country: this.selectedCountry });
            } }, this.selectedCountry && index.h("span", { key: '73f6a0b491dce2a721785bacfb423d031b19b9f2', slot: "start" }, this.selectedCountry?.phone_prefix))), this.error ? (index.h("p", { id: this.errorId, class: "mobile-input__error", role: "alert" }, this.error)) : null));
    }
    static get watchers() { return {
...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: 'f4fe2e72905fe5c6aebfa1e2bf81e8b830bb6928' }, index.h("wa-radio-group", { key: 'f7be83dddb1780ed983da69d0e0404b35bff71f4', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: '30ddb425627c91050e26875706ab1229f648abb9', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: '213b89facef28e98d8dffbac9860bb5e6bf92581', value: "guest", appearance: "button" }, "Guest"))));
    }
};
