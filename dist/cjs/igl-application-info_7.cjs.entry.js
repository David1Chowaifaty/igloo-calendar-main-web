...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: 'c5804a9688c6459cc68f1d8efc3016afa4950e6f' }, index.h("wa-radio-group", { key: '86f6d489958d351f338bf07471dbe9e05db1fe37', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: 'b65de01c231d0b72c18f3a0d1c9633824090d5fc', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: 'bfc96838adda26e66f3cf910b7f573b8337baa9f', value: "guest", appearance: "button" }, "Guest"))));
    }
};
