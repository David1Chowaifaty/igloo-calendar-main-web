...
const IrServiceAssigneeSelect = class {
    ...
    assignmentChange;
    render() {
        return (index.h(index.Host, { key: '8a9705f0475341e46ffb96ecb10e913f64dc5af8' }, index.h("wa-radio-group", { key: '706e4941b69ff080848f25c17b01b3e6e95d2431', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, index.h("wa-radio", { key: '5d03b5c4c87bbf8b08b4fe73e68ba855bef31a98', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), index.h("wa-radio", { key: 'bad0973efa6c86e6cd5039d6f7ab9c3864f988e4', value: "guest", appearance: "button" }, "Guest"))));
    }
};
