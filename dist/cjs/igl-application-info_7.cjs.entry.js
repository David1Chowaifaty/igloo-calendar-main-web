...
const types = require('./types-82916890.js');
...
const IrDateSelect = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b8e54967e59467506831852fea8025f5052232e3', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, index.h("wa-popup", { key: '4d338fc670ec2cd33a94e63794aa55c6c18890df', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, index.h("div", { key: '739bb55a8381883da92184c7df4915018c822f44', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, index.h("div", { key: 'c10a88e399d6d76117d0368d78627dba520629c8', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": "Select date", onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("slot", { key: '05d75c74a0fed47cb17d3f4931a854d68c5c0824', name: "trigger" }, index.h("ir-input", { key: '2b22244e987b7c8e93486a1a44a4a2d6cd7246c8', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && index.h("slot", { key: '39b96ce3fd0f8a3b3c6b2f5400efb8f603622ee6', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: 'ac8e45f72cbdb17d11b18fce1becf588a42b3e77', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '430c871cfda396e9219365c99aaac37499813521', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: 'b7378ac7e436e782f66e07e98b9af8dbc47d0f33', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: 'cad43898d1b040d0f564003b608777c49f4d29e0', name: "hint", slot: "hint" }))))), index.h("div", { key: 'ce3e441d48da66cf56c47eb9536917edb0b63610', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": "Date selection dialog" }, index.h("ir-air-date-picker", { key: '2aa299b3702718609149cda2981d112a75328e19', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } }), index.h("slot", { key: '5b360e50160d8cef60e09247da4a4fd525d5a688' })))));
    }
    static get watchers() { return {
        "aria-invalid": ["handleAriaInvalidChange"]
    }; }
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'b26b7421869d677dd9b730b2288034ab24d6fa69', class: "d-flex align-items-center" }, index.h("span", { key: '9e943cd9bbc012de16afa5705df700b4c01c31f2' }, this.dates.from_date), ' ', index.h("svg", { key: '1b76cef51c99ab9183325653ae1b647d91cc5897', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: 'fc21fb7f8231720a83196f9877249f30adff8abf', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'd64ee612cf535ebc6c63f1ac909e4f950715b2ca' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '83db93bbf713db933bcc17b286df79f21f6e446b', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
