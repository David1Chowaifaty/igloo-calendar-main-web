...
const functions = require('./functions-672ef4f2.js');
...
const IrBookingPrinting = class {
    constructor(hostRef) {
        ...
        this.mode = 'default';
        // @State() token: string;
        this.bookingService = new functions.BookingService();
    ...
    formatBookingDates(date) {
        return utils.hooks(date, 'YYYY-MM-DD').format('DD-MMM-YYYY');
    }
