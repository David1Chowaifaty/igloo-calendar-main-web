...
const IrBookingPrinting = class {
    ...
    renderBookingDetails() {
        return (index.h(index.Fragment, null, index.h("p", { class: "booking-number" }, "Booking#", this.convertedBooking.booking_nbr), index.h("div", { class: 'reservation-details' }, index.h("p", { class: "booked_on_date" }, moment.hooks(this.convertedBooking.booked_on.date, 'YYYY-MM-DD').format('DD-MMM-YYYY'), ' ', functions._formatTime(this.convertedBooking.booked_on.hour.toString(), this.convertedBooking.booked_on.minute.toString()), " |"), index.h("img", { src: this.convertedBooking.origin.Icon, alt: this.convertedBooking.origin.Label, class: "origin-icon" }))));
    }
    renderPrintingHeader() {
        var _a, _b, _c, _d;
        if (this.mode === 'invoice') {
            return (index.h(index.Fragment, null, index.h("div", null, index.h("p", null, "Address:", index.h("span", null, " ", (_a = this.convertedProperty) === null || _a === void 0 ? void 0 :
                _a.address)), index.h("p", null, "Phone:", index.h("span", null, ' ', "+", ((_c = (_b = this.convertedProperty) === null || _b === void 0 ? void 0 : _b.country) === null || _c === void 0 ? void 0 : _c.phone_prefix.replace('+', '')) + '-' || '', (_d = this.convertedProperty) === null || _d === void 0 ? void 0 :
                _d.phone)), index.h("p", null, "Tax ID:", index.h("span", null, this.convertedProperty.tax_nbr)), index.h("p", { class: "property_name" }, this.convertedProperty.name)), index.h("div", null, this.renderBookingDetails(), index.h("p", { class: 'invoice_reference' }, "Invoice Reference:", this.convertedBooking.financial.invoice_nbr))));
        }
        return (index.h(index.Fragment, null, index.h("div", null, index.h(BeLogoFooter, { width: 120, height: 30 }), index.h("p", { class: "property_name" }, this.convertedProperty.name)), index.h("div", null, this.renderBookingDetails())));
    }
    getTaxAmount(room) {
        ...
        return filtered_data.map((d, index$1) => {
            ...
            return (index.h(index.Fragment, null, index.h("p", { class: "label-title" }, d.is_exlusive ? 'Excluding' : 'Including', " ", d.name), index.h("p", null, d.pct, "%: ", functions._formatAmount(amount, this.currency)), index$1 < filtered_data.length - 1 && index.h("span", null, "-")));
        });
    }
    render() {
        ...
        return (index.h("div", { class: "main-container" }, index.h("section", { class: "header" }, this.renderPrintingHeader()), index.h("section", null, index.h("section", { class: "booking-details" }, index.h("p", { class: "label-title" }, "Booked by:", index.h("span", { class: "label-value" }, this.formatGuestName((_a = this.convertedBooking) === null || _a === void 0 ? void 0 : _a.guest), " - ", this.totalPersons, " ", this.totalPersons > 1 ? 'persons' : 'person')), index.h("p", { class: "label-title" }, "Phone:", index.h("span", { class: "label-value" }, this.formatPhoneNumber((_b = this.convertedBooking) === null || _b === void 0 ? void 0 : _b.guest, (_c = this.convertedBooking) === null || _c === void 0 ? void 0 : _c.is_direct))), index.h("p", { class: "label-title" }, "Email:", index.h("span", { class: "label-value" }, (_e = (_d = this.convertedBooking) === null || _d === void 0 ? void 0 : _d.guest) === null || _e === void 0 ? void 0 : _e.email)), this.guestCountryName && (index.h("p", { class: "label-title" }, "Country:", index.h("span", { class: "label-value" }, this.guestCountryName))), this.convertedBooking.guest.city && (index.h("p", { class: "label-title" }, "City:", index.h("span", { class: "label-value" }, (_g = (_f = this.convertedBooking) === null || _f === void 0 ? void 0 : _f.guest) === null || _g === void 0 ? void 0 : _g.city))), index.h("p", { class: "label-title" }, "Arrival Time:", index.h("span", { class: "label-value" }, (_j = (_h = this.convertedBooking) === null || _h === void 0 ? void 0 : _h.arrival) === null || _j === void 0 ? void 0 : _j.description))), index.h("section", null, index.h("div", { class: "accommodation-summary" }, index.h("p", { class: "accommodation-title" }, "ACCOMMODATION"), index.h("p", { class: "booking-dates" }, this.formatBookingDates((_k = this.convertedBooking) === null || _k === void 0 ? void 0 : _k.from_date)), index.h("p", { class: "booking-dates" }, this.formatBookingDates((_l = this.convertedBooking) === null || _l === void 0 ? void 0 : _l.to_date)), index.h("p", { class: "number-of-nights" }, this.totalNights, " ", this.totalNights === 1 ? 'night' : 'nights'), index.h("p", { class: "vat-exclusion" }, index.h("i", null, this.convertedProperty.tax_statement))), index.h("div", null, (_o = (_m = this.convertedBooking) === null || _m === void 0 ? void 0 : _m.rooms) === null || _o === void 0 ? void 0 : _o.map(room => (index.h(index.Fragment, null, index.h("table", null, index.h("tr", { class: 'roomtype-title' }, index.h("td", null, room.roomtype.name), index.h("td", null, room.rateplan.name)), index.h("tr", null, index.h("td", { colSpan: 12 }, index.h("p", { class: "label-title" }, "Guest name:", index.h("span", { class: "label-value" }, this.formatGuestName(room === null || room === void 0 ? void 0 : room.guest)))))), index.h("div", { class: "policies-container" }, index.h("p", { class: "policies", innerHTML: room.rateplan.cancelation }), index.h("p", { class: "policies", innerHTML: room.rateplan.guarantee })), index.h("div", { class: "pricing-summary" }, index.h("div", { class: 'pricing-breakdown' }, index.h("p", { class: "label-title" }, "Total:", index.h("span", { class: "label-value" }, functions._formatAmount(room.total, this.currency))), index.h("span", null, "-"), this.getTaxAmount(room)), index.h("p", { class: "label-title" }, "Grand total:", index.h("span", { class: "label-value" }, functions._formatAmount(room.gross_total, this.currency))), index.h("p", { class: "label-title" }, "Due upon booking:", index.h("span", { class: "label-value" }, functions._formatAmount(room.gross_guarantee, this.currency)))), index.h("div", { class: 'room_amount_main_container' }, room.days.map(d => (index.h("div", { class: 'room_amount_container' }, index.h("p", { class: "room_amount date" }, this.formatDate(moment.hooks(d.date, 'YYYY-MM-DD'))), index.h("p", { class: "room_amount amount" }, functions._formatAmount(d.amount, this.currency)))))))))))), this.convertedBooking.pickup_info && (index.h("section", { class: "pickup-container" }, index.h("p", { class: "pickup_title" }, "PICKUP Yes,from ", this.convertedBooking.pickup_info.selected_option.location.description), index.h("div", { class: 'pickup-details' }, index.h("p", { class: "label-title" }, "Arrival date:", index.h("span", { class: "label-value" }, moment.hooks((_p = this.convertedBooking) === null || _p === void 0 ? void 0 : _p.pickup_info.date, 'YYYY-MM-DD').format('ddd, DD MMM YYYY'))), index.h("p", { class: "label-title" }, "Time:", index.h("span", { class: "label-value" }, functions._formatTime(this.convertedBooking.pickup_info.hour.toString(), this.convertedBooking.pickup_info.minute.toString()))), index.h("p", { class: "label-title" }, "Fight details:", index.h("span", { class: "label-value" }, (_q = this.convertedBooking) === null || _q === void 0 ? void 0 : _q.pickup_info.details)), index.h("p", { class: "car_name" }, this.convertedBooking.pickup_info.selected_option.vehicle.description, index.h("span", null, " - "), functions._formatAmount(this.convertedBooking.pickup_info.selected_option.amount, this.convertedBooking.pickup_info.selected_option.currency.code)), index.h("p", { class: "label-title" }, "No. of Vehicles:", index.h("span", { class: "label-value" }, (_r = this.convertedBooking) === null || _r === void 0 ? void 0 : _r.pickup_info.nbr_of_units)), index.h("p", { class: "label-title" }, "Due upon booking:", index.h("span", { class: "label-value" }, functions._formatAmount((_s = this.convertedBooking) === null || _s === void 0 ? void 0 : _s.pickup_info.total, this.convertedBooking.pickup_info.currency.code)))))), index.h("section", null, index.h("table", { class: "billing_table" }, index.h("caption", null, "Billing"), index.h("thead", null, index.h("th", { class: "billing_header" }, "Date"), index.h("th", { class: "billing_header" }, "Amount"), index.h("th", { class: "billing_header" }, "Designation")), index.h("tbody", null, this.convertedBooking.financial.payments.map(p => (index.h(index.Fragment, null, index.h("tr", { key: p.id }, index.h("td", { class: "billing_cell" }, moment.hooks(p.date, 'YYYY-MM-DD').format('DD-MMM-YYYY')), index.h("td", { class: "billing_cell" }, functions._formatAmount(p.amount, p.currency.code)), index.h("td", { class: "billing_cell" }, p.designation || '_')), p.reference && (index.h("tr", null, index.h("td", { colSpan: 3 }, "Ref:", p.reference)))))))))));
    }
};
