...
const IrOtpModal = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '4d50bfd3f91f8723bfdf311440e29d661af00e09' }, index.h("div", { key: '4353d1d7836c1b1041305b5b226aeefc6fa30b61', ref: el => (this.modalRef = el), class: "modal otp-modal fade", id: "staticBackdrop", "aria-hidden": "true" }, index.h("div", { key: '7028be368fe4a3379c4f8ca952e348f518512c7a', class: "modal-dialog modal-dialog-centered" }, index.h("div", { key: '52a06e9b1918ac8d4e6fd63e65222b1e0f0dc45d', class: "modal-content" }, index.h("div", { key: 'b586baa1ec10b9c8aab03e42dcd959b89afad654', class: "modal-header" }, index.h("h5", { key: '8e14cd214dd82bb7622ca20eb797854e853c50c0', class: "modal-title" }, "Verify Your Identity")), index.h("div", { key: 'e64fef9ed820947d74dc72630310a4ef8ac2ec08', class: "modal-body d-flex  align-items-center flex-column" }, index.h("p", { key: 'f2466712badd6df05f394124217ac79b4a8d68a3', class: "verification-message text-truncate" }, "We sent a verification code to ", this.email), index.h("ir-otp", { key: '4b552d4be05361505d66d853793a8c1594450b5c', autoFocus: true, length: this.otpLength, defaultValue: this.otp,
            // value={this.otp}
            onOtpComplete: this.handleOtpComplete }), this.error && index.h("p", { key: '8bf7a36ff4b9024361227eb577a8021b9fdb94ad', class: "text-danger small mt-1 p-0 mb-0" }, this.error), this.showResend && (index.h(index.Fragment, { key: '25f94009fce02e6c185758ff3fa14a0ee875acc9' }, this.timer > 0 ? (index.h("p", { class: "small mt-1" }, "Resend code in 00:", String(this.timer).padStart(2, '0'))) : (index.h("ir-button", { class: "mt-1", btn_color: "link", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resendOtp();
            }, size: "sm", text: "Didn\u2019t receive code? Resend" }))))), index.h("div", { key: '6edf2e709f6041f1b7552143721a99c16a1fbc6f', class: "modal-footer justify-content-auto" }, index.h("ir-button", { key: '66aeee78c363ba37b6f8b0a3db4b665ee72d1593', class: "w-100", btn_styles: 'flex-fill', text: "Cancel", btn_color: "secondary", onClick: this.handleCancelClicked.bind(this) }), index.h("ir-button", { key: '1d185c7c954c939d09cb97b2134987890e9fada8', class: "w-100", btn_styles: 'flex-fill', text: "Verify now", isLoading: this.isLoading, btn_disabled: ((_a = this.otp) === null || _a === void 0 ? void 0 : _a.length) < this.otpLength || this.isLoading, onClick: () => this.verifyOtp() })))))));
    }
    static get watchers() { return {
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '8cab0da4e7ee38ba3d763e9a64bd7afe54434cd3', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: 'ac59a5734ad8b5a48495fb45b16e078a5f3f2e30', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: '2332337390f06ae970275a199ff62d988fe3260c', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'a497ea77abbfde569e98ba4d08f8bf179d94799c', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), index.h("ir-input-text", { key: '292050c033b4751da2a6bf611986d284940f0cdb', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: "Mobile", mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (index.h("ir-input-text", { key: 'f9bff05a269e7ea7d417475b32bddf95da2d5c38', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: "Username", disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username, onInputBlur: this.handleBlur.bind(this), maxLength: 40 })), !this.user ? (index.h(index.Fragment, null, index.h("ir-input-text", { testId: "password", autoValidate: this.user ? (!((_l = this.userInfo) === null || _l === void 0 ? void 0 : _l.password) ? false : true) : this.autoValidate, label: 'Password', value: this.userInfo.password, type: "password", maxLength: 16, zod: this.userSchema.pick({ password: true }), wrapKey: "password", error: (_m = this.errors) === null || _m === void 0 ? void 0 : _m.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: '1b3d4d73249ad804d649eb4a3c754ecb168fd717', class: "logins-history-section mt-2" }, index.h("div", { key: 'b9a7ad9445418f177e463a25cf700bd76a4adf56', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: 'f1128bf9ee5ffedf58c1fb570ba703a8750fdf90', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: '3438946087ccf8073d5fab08a67edfca58f9c6aa', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: 'f3cced9b3537846dab358092188d76dc69db9ef5', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: 'd927cd612e3dad804b6a29246c387bc7b5072ca5', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '6fc5f74496b29e378e39f63f1e736f5bd03a85d2', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '680e605a545b4444706b3b45ea81179c96e0428e', class: "sheet-footer" }, index.h("ir-button", { key: '012302704deb230312dfaaf51b287d82e05abdbc', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '00f9ecd303a22b9beaac30702f7f80de29607a16', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
