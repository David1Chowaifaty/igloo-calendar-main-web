...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '873bff8e45fdb638170cd46a867a5c0375ab9186', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '245b76bfaa01666ceeada352a2cb306f8a460b68', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '2b3eae26664080b7d72bf7c06257a21e27596dfe', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '513daf30db8846e07d15536cf893ebf5386b5873', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '8c84c76c09840112619a32d036cfa14225af7a6b', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'b4dfd1562a63a20753ab25a307a06b2a5d2c3d87', class: `ir-alert-header` }, index.h("p", { key: '88739123ec105a0af7f60987bf7931f858c97beb' }, this.modalTitle))), index.h("div", { key: '534608cb038b1ea2806fe05791fec3c0f6efa241', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'a829b5545b16bef5bd030756134f8774155ef33c' }, this.modalBody)), index.h("div", { key: '1fde98705d92cbb0c98d77951f1add4efc4a87f0', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: 'c168ff95eb4aca3479d2a4144d34e18eef3fdc24', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '4124dc76591d2aaf35d72835b23d8f9f33dee7d4', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '19b9da60784218122d2aa7fc19be6642e6d4cf70', class: "otp-input-container" }, index.h("div", { key: 'dcf32712ed40afe3e92299fd28898e9e3679f7d3', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrOtpModal = class {
    ...
    // };
    render() {
        return (index.h(index.Host, { key: '02c24111de1d77b6c8938eeb64c791ade369f6d5' }, index.h("div", { key: 'ba441ed6192920c3636a4142bb8d30bcd807a623', ref: el => (this.modalRef = el), class: "modal fade", id: "staticBackdrop", "aria-hidden": "true" }, index.h("div", { key: '629ccff5d858c019a1c5f85590f5bb810015337e', class: "modal-dialog modal-dialog-centered" }, index.h("div", { key: 'b06276666d21456453db9c10a77091ff1ba3a0a8', class: "modal-content" }, index.h("div", { key: '304937375e7217b8cbd0c856258b1db1d7499f37', class: "modal-header" }, index.h("h5", { key: 'd7378d329dd9681dd5fa48686cf656194bff4b6d', class: "modal-title" }, "Verify Your Identity")), index.h("div", { key: '7747ce5d450280006fe0846d8e96377635270cd6', class: "modal-body d-flex  flex-column" }, index.h("p", { key: 'ee68a2b4127a026f461d7149412edffca42709df', class: "medium" }, "Please enter the 6-digit code we just sent you."), index.h("ir-otp", { key: '0ad921870c5eaa31176cdef64b800f00dea6c1c0', autoFocus: true,
            // value={this.otp}
            onOtpComplete: this.handleOtpComplete }), this.error && index.h("p", { key: 'e3a91187f0a811352013565633f229fcc4a06761', class: "text-danger small mt-1 p-0 mb-0" }, this.error), this.showResend && (index.h("p", { key: '7b441511c8b16edf705087e62810ed15847293ce', class: "small mt-1" }, this.timer > 0 ? (`Resend code in 00:${String(this.timer).padStart(2, '0')}`) : (index.h("a", { href: "#", onClick: e => {
                e.preventDefault();
                this.resendOtp();
            } }, "Didn\u2019t receive code? Resend"))))), index.h("div", { key: '258778ad14cc9f762d3f320b62bbbcaac82a65ed', class: "modal-footer justify-content-auto" }, index.h("ir-button", { key: '5c3517d654194abc2a1926f77accac5fea5d05ce', class: "w-100", btn_styles: 'flex-fill', text: "Verify now", isLoading: this.isLoading, btn_disabled: this.otp.length < 6 || this.isLoading, onClick: () => this.verifyOtp() })))))));
    }
};
...
const IrResetPassword = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '1139126dd7494506fbd9c5c3bb208a5aaea6b898', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, !insideSidebar && (index.h(index.Fragment, { key: '71b457cdf28905cc9a1bde5ef4af60e263348da3' }, index.h("ir-interceptor", { key: '5653348bfcfd72828fa50a5c3f32540f6b977f60', suppressToastEndpoints: ['/Change_User_Pwd'] }), index.h("ir-toast", { key: '3851fd27efbea33e51916067f1311ecc3b0a52d5' }))), index.h("form", { key: '39d216b254360c757ce692f6cda2aed8fb00e6b1', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && index.h("ir-title", { key: 'b44b133206418043e6c6684ec03d89ca7396219d', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), index.h("div", { key: 'e8f6f72e5340390f26d0592cc25c65c5e4008766', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, index.h("svg", { key: '270be1567dbcbced4d14644c7dadcd84b77228fd', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, index.h("path", { key: '0e37afffd3c84727f73a22d37901092a256a04bb', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), index.h("div", { key: '78c72c92c692897a88e2e75051ef02683c52cb04', class: "text-center mb-2" }, index.h("h4", { key: 'cd75c8fbbfe0df126f7029a29c1ed4273558e04a', class: "mb-1" }, "Set New Password"), this.submitted ? (index.h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (index.h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (index.h("section", { key: '1895d4e5d8c3abc38409d6ef8be29c43f2a2a385' }, index.h("div", { key: '19c26b46cd881592848c42c0b9c75d2b4d8c5318', class: 'mb-2' }, index.h("div", { key: 'f78c063fa5c661a0888dba02b30edea563b751f7', class: "m-0 p-0" }, index.h("div", { key: '39ae3f51b4574374038d6d5066f6e02ec10dc32e', class: 'position-relative' }, index.h("ir-input-text", { key: '0541461aebd00ae789c1411e726209c3a6318ebc', error: (_a = this.error) === null || _a === void 0 ? void 0 : _a.password, autoValidate: this.autoValidate, value: this.password, onTextChange: e => (this.password = e.detail), label: "", class: "m-0 p-0", inputStyles: 'm-0', zod: this.ResetPasswordSchema.pick({ password: true }), wrapKey: "password", placeholder: "New password", onInputFocus: () => (this.showValidator = true), type: 'password' })), this.showValidator && index.h("ir-password-validator", { key: '1c63021610a84931e4977120092e734b552bc41c', class: "mb-1", password: this.password })), index.h("div", { key: '4086548cda87afa80526deda0eb553afce6e5a6d', class: 'position-relative' }, index.h("ir-input-text", { key: 'bf7c0b0c20873fe9380c217d357e5c0279e45524', error: (_b = this.error) === null || _b === void 0 ? void 0 : _b.confirm_password, autoValidate: this.autoValidate, zod: this.ResetPasswordSchema.pick({ confirm_password: true }), wrapKey: "confirm_password", value: this.confirmPassword, onTextChange: e => (this.confirmPassword = e.detail), label: "", placeholder: "Confirm password", type: 'password' }))), !insideSidebar && (index.h("div", { key: 'a7c32e681a98caba3488de4d1e7871ba60fe080a', class: "d-flex flex-column mt-1 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, index.h("ir-button", { key: '935b97358d18712138ce1fe0213438b6a00ea472', btn_styles: 'flex-fill', onClickHandler: () => window.history.back(), class: "flex-fill", text: 'Cancel', size: "md", btn_color: "secondary" }), index.h("ir-button", { key: '86ef34cf036857d45ecfd7bb52dbbd4be0b95418', btn_styles: 'flex-fill', class: "flex-fill", isLoading: this.isLoading, btn_type: "submit", text: 'Change password', size: "md" })))))), insideSidebar && (index.h("div", { key: '15ec702d0f4f9beaef3cd4880b5fcb98a0ef37cb', class: 'sheet-footer w-full' }, index.h("ir-button", { key: '77edc55140f69a3db468e96cfd63a5d6e1cba06c', text: 'Cancel', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_color: "secondary", btn_styles: "w-100 justify-content-center align-items-center", size: "md" }), index.h("ir-button", { key: '88b2ff7d32bf6829b114b4a9022153d4fc34e715', isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: 'Change password', size: "md" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '45769470437f36f07d55f3f0739455356a85ba2c', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '706843cd4f67a69f3f80c599f95c82c387710591', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: 'fe89f8b3b6b12dfd3e24806682133a1fb44e5b9c', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '416376ad49a60c89e25ddd963491668e269be597', class: "input-group row m-0" }, label, index.h("select", { key: 'a6eb278126112f4931a86093f0c3daa3d7f85cd6', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'cb331effa7203ad5f39e1a9fd71c30ce430e9667', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '8363e817c9cc106bb2861f3071ac902c71f21c88', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '71d9d89c0594146cd077fb05b809188bee5a3c98', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'aac48e7ae3eb2c4e9aa54091473482163ddf9617', class: 'sidebar-title' }, index.h("p", { key: 'af6210b49ca437adeb4f9958032f41b3e821bb99', class: 'p-0 m-0' }, this.label), index.h("div", { key: '230d722be520f1c028ba4a64d9c899aa38eca09f', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'c6b38cc74d372edc17e5492c660d267d26a5af23', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '09c9bf4d90bb790b5a2f48565e545cc2e8f51e83', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '816c45ca6a32a479a2991a3278ba391dbc25e181', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '58cd0f42bc74a32dcd88f9963152f132136ff410', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '41ea17518437e858195a9bd9884274a9757c3415' }, index.h("button", { key: '33ffc2d8221a34be5de06114f2b34c060c9b2cc1', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: '02b7a645f430984222c928dd29978860fb1a4ee0', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: '9e70e43f5c5bfe6a317bfde92579fcfd242265fd', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '36c9e5be709a2bc8b4d98a0ecd276a6c37520c99' }, index.h("h4", { key: '216ca63ec52ba11d4b8db905f0cad76f3f8b39b9', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '5653d63ce90d895eafec33d2278c64c7fcdca55d', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '3ceb0ca0869c9e81fd8e25b0a1d66776ddc0aaa0', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'ece249efbfda0cce3c11a026854e74e84532bf45', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'd6b01db7016cd6c00da1c534939b0d94c4cf292c', class: 'title-body' }, index.h("slot", { key: '191067a7c648f5f8a3d064f7e24cf7694a7bbc1d', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '45d56b52ada4d59207492c7cdc0b30f49155a1bb' });
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '7268f2936b6378ac43cd968e2a932e6b40bd1a6f', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: 'c8d4f4a402f7bf2d52bf4011fac373417cb5e51a', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: 'e6e24db75569db0ac0f54260de982079dacb2363', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '7051fcec59dc64494ba70c778a05ff1332a1adcc', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), index.h("ir-input-text", { key: 'ef1945f890d7dc2ad1421136ed36666161142ca7', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: "Mobile", mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (index.h("ir-input-text", { key: '39068c5faa54b0014ea91db57a01fe17c9e01d0a', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: "Username", disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username, onInputBlur: this.handleBlur.bind(this), maxLength: 40 })), !this.user ? (index.h(index.Fragment, null, index.h("ir-input-text", { testId: "password", autoValidate: this.user ? (!((_l = this.userInfo) === null || _l === void 0 ? void 0 : _l.password) ? false : true) : this.autoValidate, label: 'Password', value: this.userInfo.password, type: "password", maxLength: 16, zod: this.userSchema.pick({ password: true }), wrapKey: "password", error: (_m = this.errors) === null || _m === void 0 ? void 0 : _m.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: '6264947485b16c0fe1faff5b7095239f314dbc6a', class: "logins-history-section mt-2" }, index.h("div", { key: '37ff4b82a34cbd6f72d209945ec34999a1ca53cb', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '29211d867411807d2dfdc4c4d84d36e0da5f7241', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: 'b5c4343e28c91741d00e6b6cd4150b5d173d36eb', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: 'e2fb72910e4068e81aaf6a7f630f9ab2f6259ec6', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: '8590bbc459d0fcc6e85886fb9be837a1b60810c5', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '9b8332c99eb57c58a7e21519bcd984e9545b5075', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '8a060008a001fdc8dade4610927c90b483a63b76', class: "sheet-footer" }, index.h("ir-button", { key: 'e0cd8604591d80d037546a2c2e8e24beedede817', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '66d400989a37320c0a578edc6f096f08ab1d245a', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ac00946e671059bc42805ac18043f0ec0012d436' }, index.h("section", { key: '8befca041bf838ad7713c33759e5a3450a31e4a7', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: 'c37d1d9d13ffbc070c040c32d4c835ba91b002a8', class: "table" }, index.h("thead", { key: '5f68c5dbaae238377b964fe26be86e68b7d33b87' }, index.h("tr", { key: '8d65538ce35eadbab2cd71373517a55b0308a6de' }, index.h("th", { key: 'd8b02ffe81220e5e5928724856d01cf291ef7700', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '6081e3a00e71fdff53ee8460bb6003cef5456813', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: '774a58eed95c728eb1b21b9c8cf14dbb9f6b4ccd', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '32ee5c4cdd187d4c4baba7e5be57a4c95c034d76', class: "text-left" }, "Role"), index.h("th", { key: '5237d3d59c66df5d8bbf8d5cfe58d25c0689cb4a', class: "text-left" }, "Last signed in"), index.h("th", { key: 'b89bb94de6d9191547eed00aecd2a6ae13072474', class: "text-left" }, "Created at"), this.haveAdminPrivileges && index.h("th", { key: 'd54d483c5bc30245745fc254bd609f0b259d909d' }, "Active"), this.haveAdminPrivileges && index.h("th", { key: 'c73dfd7c8516b5640f6f49ff51c1d462992ee2ce' }, "Email verified"), index.h("th", { key: '22e7f675101cd236c0b9cade10f645ac33b2514c', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '05aa7b9d2f2321984b497203cddbd36d9d0ddd85', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '5b9235cd9b561a7d4dfc00ec3a00884b9d1ecd74', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'c4841cb985f11545f6b5437eea107f46afeec39c', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: 'e39993ad7c0a07e24cf88b7fadd3aee1e9236cd9' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: '641aa11d2f7005742e3e157e2d97dff2fb3869ef', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
