...
const IrOtpModal = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '3c2de3f0cd93c9f4dccae26231f2a01eb2c38a2c' }, index.h("dialog", { key: '7acfe003ee25d600fa3da6441abd00a3987fa812', ref: el => (this.dialogRef = el), class: "otp-modal", "aria-modal": "true" }, index.h("form", { key: '8eedcd34036a3d35b0328e7875548fea40528f89', method: "dialog", class: "otp-modal-content" }, index.h("header", { key: '08c1cfac93cfb85c209d8d5dd3933d1fb86d203b', class: "otp-modal-header" }, index.h("h5", { key: 'dcd70017901a9b55bbe46538152b6c29e5ba181e', class: "otp-modal-title" }, "Verify Your Identity")), index.h("section", { key: '8ca848ff9ae5d3761b1dfb1be8bbd18c4d3cce3f', class: "otp-modal-body d-flex align-items-center flex-column" }, index.h("p", { key: '9a155d2b8d93afecf08750f20805fd121873a9aa', class: "verification-message text-truncate" }, "We sent a verification code to ", this.email), index.h("ir-otp", { key: 'b8fa2b4cbcc44495deb822a79ff66ebdd40c111c', autoFocus: true, length: this.otpLength, defaultValue: this.otp, onOtpComplete: this.handleOtpComplete }), this.error && index.h("p", { key: '93ced14ba05a46f00f1a7550ae19b41df9f9f89e', class: "text-danger small mt-1 p-0 mb-0" }, this.error), this.showResend && (index.h(index.Fragment, { key: '887def9d34b29fda4aac33ce3af79ac95fc2d0f2' }, this.timer > 0 ? (index.h("p", { class: "small mt-1" }, "Resend code in 00:", String(this.timer).padStart(2, '0'))) : (index.h("ir-button", { class: "mt-1", btn_color: "link", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resendOtp();
            }, size: "sm", text: "Didn\u2019t receive code? Resend" }))))), index.h("footer", { key: 'f2dca34470555bc6032cd16616ed4c3ce1af0d25', class: "otp-modal-footer justify-content-auto" }, index.h("ir-button", { key: '045076aba32bbc506009c944ace09ec304fca908', class: "w-100", btn_styles: "flex-fill", text: "Cancel", btn_color: "secondary", onClick: this.handleCancelClicked.bind(this) }), index.h("ir-button", { key: 'af2787f2bfbccf3b79967dc5dce5865e73931287', class: "w-100", btn_styles: "flex-fill", text: "Verify now", isLoading: this.isLoading, btn_disabled: ((_a = this.otp) === null || _a === void 0 ? void 0 : _a.length) < this.otpLength || this.isLoading, onClick: () => this.verifyOtp() }))))));
    }
    static get watchers() { return {
