...
const user_service = require('./user.service-cafac5f1.js');
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '076637f92cfb148d61ae8027dc843abaf2d6bd8b', class: "otp-input-container" }, index.h("div", { key: 'bd4cd055e841b29fe9af40c7878015a70a4159a5', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrOtpModal = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '5833bc91160ee015b59746e59972e2ddcb344e52' }, index.h("dialog", { key: 'ef85636727b87628611e7fd4f17f05cc7c3f7221', ref: el => (this.dialogRef = el), class: "otp-modal", "aria-modal": "true" }, index.h("form", { key: '2ac2f140c2f0b37027b9f34a6f194021064b8bc2', method: "dialog", class: "otp-modal-content" }, index.h("header", { key: '312e5c5decd9c420f4fd7afb63c6c7426ddff13f', class: "otp-modal-header" }, index.h("h5", { key: '1b51d37d71a7cf8d07168676c4c86ecd90c0e6aa', class: "otp-modal-title" }, "Verify Your Identity")), index.h("section", { key: '5068e8d4725c990df8ed3049b74e9c0c19a77518', class: "otp-modal-body d-flex align-items-center flex-column" }, index.h("p", { key: '41008372dc599071178f023ce264d8f7349e72c7', class: "verification-message text-truncate" }, "We sent a verification code to ", this.email), index.h("ir-otp", { key: '96ecf89d7232678f762c135bbb4f47e573d6a309', autoFocus: true, length: this.otpLength, defaultValue: this.otp, onOtpComplete: this.handleOtpComplete }), this.error && index.h("p", { key: '4620c40f3014f7b7d260cb54c9d353e3a239f4cb', class: "text-danger small mt-1 p-0 mb-0" }, this.error), this.showResend && (index.h(index.Fragment, { key: 'f8835de67ad048b3c7aa7298a23ccab4adbff421' }, this.timer > 0 ? (index.h("p", { class: "small mt-1" }, "Resend code in 00:", String(this.timer).padStart(2, '0'))) : (index.h("ir-button", { class: "mt-1", btn_color: "link", onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resendOtp();
            }, size: "sm", text: "Didn\u2019t receive code? Resend" }))))), index.h("footer", { key: '5a1b898a2f67643ea943594aee20176dc20a1734', class: "otp-modal-footer justify-content-auto" }, index.h("ir-button", { key: '6e1ab6c18b2cb627b3d9ff348720f27b85f57b3f', class: "w-100", btn_styles: "flex-fill", text: "Cancel", btn_color: "secondary", onClick: this.handleCancelClicked.bind(this) }), index.h("ir-button", { key: '4947629cc23abf841b0742e527cb9fe53b47689e', class: "w-100", btn_styles: "flex-fill", text: "Verify now", isLoading: this.isLoading, btn_disabled: ((_a = this.otp) === null || _a === void 0 ? void 0 : _a.length) < this.otpLength || this.isLoading, onClick: () => this.verifyOtp() }))))));
    }
    static get watchers() { return {
...
const IrResetPassword = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'cdee1cc8f73aa2af8ff30ae866412b90c77c5498', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, !insideSidebar && (index.h(index.Fragment, { key: 'e27f0fff16360e267d4b701a3753683ec864d522' }, index.h("ir-interceptor", { key: 'c286c1d4202702430cb438bfcafe6650b10d07b6', suppressToastEndpoints: ['/Change_User_Pwd'] }), index.h("ir-toast", { key: 'cb52fab8ad8c2ca33e79d4130ccfa2dfbc4905c3' }))), index.h("form", { key: '4f645f39a5ffc7eb4a624250476e196e91d4b82d', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && index.h("ir-title", { key: '4c58dc34cb7b5f2d50d79d04cdd9c8e67caf114b', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), index.h("div", { key: '1ef833a9e36c9b80161a2a35077865211d6ef061', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, index.h("svg", { key: 'a699c3095c57de48489fdfd2e23851fcfa808bff', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, index.h("path", { key: '3fce5ab1cfb3e8f286c4f03912a51d72ce1b03e4', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), index.h("div", { key: 'f3cff0da53c731d3dfa79e33863a8ce9c87768fb', class: "text-center mb-2" }, index.h("h4", { key: 'd63b007fce6e60b3cf482c13affcdfe7898002cd', class: "mb-1" }, "Set New Password"), this.submitted ? (index.h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (index.h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (index.h("section", { key: '85139610bed1ca3269d6d2fade2919f6a011f796' }, index.h("div", { key: 'ef36d9154087a8ce52d76adca4c483d2aba1f852', class: 'mb-2' }, index.h("div", { key: '2e4dbeb71d3adf4d5a4002017ef82557ee13249c', class: "m-0 p-0" }, index.h("div", { key: 'f493e1bce80348447ba84ebe754a3f679595cf1c', class: 'position-relative' }, index.h("ir-input-text", { key: 'e3dbb4ec4789ed98850d7257b459633863880781', error: (_a = this.error) === null || _a === void 0 ? void 0 : _a.password, autoValidate: this.autoValidate, value: this.password, onTextChange: e => (this.password = e.detail), label: "", class: "m-0 p-0", inputStyles: 'm-0', zod: this.ResetPasswordSchema.pick({ password: true }), wrapKey: "password", placeholder: "New password", onInputFocus: () => (this.showValidator = true), type: 'password' })), this.showValidator && index.h("ir-password-validator", { key: '4c331fc2688e827f869ef41a3dc8d4b777c716e8', class: "mb-1", password: this.password })), index.h("div", { key: '88723c19c1130227a6c38000ced46751d2e52d83', class: 'position-relative' }, index.h("ir-input-text", { key: 'c4f2fe15122fcd7a2cf386f70afed1ef8e1629d6', error: (_b = this.error) === null || _b === void 0 ? void 0 : _b.confirm_password, autoValidate: this.autoValidate, zod: this.ResetPasswordSchema.pick({ confirm_password: true }), wrapKey: "confirm_password", value: this.confirmPassword, onTextChange: e => (this.confirmPassword = e.detail), label: "", placeholder: "Confirm password", type: 'password' }))), !insideSidebar && (index.h("div", { key: '2cc05a131f27993265ae3a62a9d7d494b72caaf4', class: "d-flex flex-column mt-2 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, index.h("ir-button", { key: '2ecbf8f8013f3fb3df8b922855d507aa95b55e8a', btn_styles: 'flex-fill', onClickHandler: () => window.history.back(), class: "flex-fill", text: 'Cancel', size: "md", btn_color: "secondary" }), index.h("ir-button", { key: '39b6f4430b1c1a1d019822d0e3d106896e28182e', btn_styles: 'flex-fill', class: "flex-fill", isLoading: this.isLoading, btn_type: "submit", text: 'Change password', size: "md" })))))), insideSidebar && (index.h("div", { key: '1fa34dbdb24d2db531f315421ffbde114954022e', class: 'sheet-footer w-full' }, index.h("ir-button", { key: 'd11647e0f4717f33bfa6c35de651fb2976595731', text: 'Cancel', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_color: "secondary", btn_styles: "w-100 justify-content-center align-items-center", size: "md" }), index.h("ir-button", { key: 'aad349985b756f3293148bf2d7ffb5d967bf752b', isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: 'Change password', size: "md" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
        "ticket": ["handleTicketChange"]
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '36c9e5be709a2bc8b4d98a0ecd276a6c37520c99' }, index.h("h4", { key: 'c992cfd59a322936c0ea96b13cfb16a4ac695b7d', class: "text-left label font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'd4b88dcc36ab890933161570d3f233c7c3495653', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '3b0e14fb483a012600d954dee24e4d66c69d538f', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '2a4f4f70df1410e8c3133b0b17747113a0972668', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '2c4ffd6b90919f9d8fad83d7c931638f01442547', class: 'title-body' }, index.h("slot", { key: 'b2fa2484ce3f6439348672d571f0daf4473a2b80', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'c620569c8cfd2670d6ee0b6777c6adc967b03d88', class: "sheet-container", onSubmit: async (e) => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: '1353669a97b6a2793f79f1dd503d95693b7ef662', class: "logins-history-section mt-2" }, index.h("div", { key: '8cc203e8aa16d7a5b54bb2c12c28c9c348a139fd', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '1ddc1eeb74b6197c97108fb3d5a0a9dec9d6258b', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: '29c2baf593269d66b52db66a975533ab77482273', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: '0b24856303c0b402e7c3220f80bf46e1b5cc81c3', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: '119a64cda2f793163a7049933860a07525faf42d', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '4834d821553d026222161293443198767c78a25d', ticket: this.token.getToken(), skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '58239adc56aa9990c7d9269afd801992772d6c6a', class: "sheet-footer" }, index.h("ir-button", { key: '42305a6dd516525cb337bd8018ebd30f892b453e', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'b9071f106da1d65c2c50594ae73ec2081063223d', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e1e7cf814f31136b4e7c46eb30962a29c94b1051' }, index.h("section", { key: 'cce0ad92769b411150ebc86f9c2cfe74606eb185', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '432e06d469e6090684fe7d4525bede30171e5dc3', class: "table" }, index.h("thead", { key: 'd4dbd9e11d0d5013de50930627326826b9e678f2' }, index.h("tr", { key: '326dd06a0a4ded631988355082e7561186853026' }, index.h("th", { key: 'dc5eef694f0ca372057d44ed18f2eb9eec6a4524', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '9a2e4dbe37e2a9edd1bfd75dd19f6c7237a5e270', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: '55549d2a7714ec81a4048f1604afbd484f20ed37', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '5d98689072039b0db2065ec7644278228de4fbec', class: "text-left" }, "Role"), index.h("th", { key: '878bfd5c651ec81718d2bb99baea50ea44f150dc', class: "text-left small", style: { fontWeight: 'bold' } }, index.h("p", { key: '6807660eef0bd126d88aab0cf9736d29b7ffcd97', class: "m-0 p-0 " }, "Created at"), index.h("p", { key: '17dae72dfdf9189e65df085746f768e89c4ec531', class: "m-0 p-0" }, "Last signed in")), this.haveAdminPrivileges && index.h("th", { key: '55308e16bd40ef53fff67b244618022be2190fed' }, "Active"), index.h("th", { key: '488e69a7274341b58ceb893e8c87da8237d010d7', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '5fde42ea632c15b4c037a6c476936876f0d12428', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.verifyAdminAction({
                    type: 'user',
                    isEdit: false,
                    user: null,
                });
            } }, index.h("svg", { key: '65f2eaa1197f982370a74c8c2ed22994ec17c7de', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'e66c48fb5d3a59568fae8c7ac4d7eebd5fa74857', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: '91c73037547495ba910d6e4c9d533f68d83082ce' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: 'cc1cadd8d37e8bf11cd33173f0778215eff3275d', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
