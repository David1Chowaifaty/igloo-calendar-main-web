...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'd45ff95b8d8feba7a90d89c736cfe003aa342b88', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'dbfb7d4179718668c77031922866bfa0018a8051', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4181027c7fb8c97389b512d2dff97ce6b3cca052' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '2b073ebaabf10d27a648a3c371bc83c41586e4bb', class: "loadingScreenContainer" }, index.h("div", { key: 'a1b9c06d055d3ed65c84ad3f79dfb25593851304', class: "loaderContainer" }, index.h("span", { key: 'ef04f94a0b24a3b7cd16ea1b5804d514cc8203ed', class: "page-loader" })))), this.showModal && index.h("ir-otp-modal", { key: '5619a6bbaf8a7066f0495e6d490fc655db1f66bd', requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) })));
    }
};
...
const IrLoadingScreen = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6a007b19d04e406da2eedc670ee2f4a75e24ccde' }, index.h("span", { key: '241a6b1c3cb7333c92d3175403ab09168a14b384', class: "loader" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '560b9a9d787aa8931f93dea2d52078f39047d03f', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'a7fa9119bc76001aa9bdf7be69887343a43b4ce4', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '63427e7f45f21b80bddb5fc0bc24ad9f06103dfc', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'efc39c7987884071a78cb55ef55fa5dc0bc219f6', class: `ir-alert-header` }, index.h("p", { key: '801c5643e39e14aac649dfcda306a8e99478266f' }, this.modalTitle))), index.h("div", { key: '36588669eac072a41b8b2cadda329a593d90edad', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: 'e484a049fffe9634baf6a95145dff7c86d7f77a8' }, this.modalBody)), index.h("div", { key: '55e5ca5605658dabe4ab61fb279676fc0ed21bb2', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: 'b18911f53e8f31ce82c2a6f7a9cbc4c07da8f2a4', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '658c2fc14fa635208e47c9b3c567f14866993359', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8ba8a99a565a91f525048ccc62a3b2fb2ec56bb0', class: "otp-input-container" }, index.h("div", { key: 'f22e1eba73d41ffd65f5ab000d11b3fcde26e6af', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
class SystemService {
    async validateOTP(params) {
        const { data } = await axios.axios.post('/Validate_OTP', params);
        return data;
    }
}
...
const IrOtpModal = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e704909e7f888a8670fb08ad5649824f94cf6118' }, index.h("div", { key: '0266fb6309885e3d30750c032b25a5f0323a0024', ref: el => (this.modalRef = el), class: "modal fade", id: "staticBackdrop", "aria-hidden": "true" }, index.h("div", { key: 'b5c8d7223fef35c95e4f97f32e9d40202966fade', class: "modal-dialog modal-dialog-centered" }, index.h("div", { key: 'e34aea228e3a9fbe7f28ba7242dec00af4227473', class: "modal-content" }, index.h("div", { key: 'b51cb66914767241b7d22e7c408f15dd14faf0e1', class: "modal-header" }, index.h("h5", { key: '9ea02797863d65b7c8c0e1ce25b0391cf51e7b2b', class: "modal-title" }, "Verify Code"), index.h("button", { key: '7528e3e3a5bca6e939c661d0301d1a36f076bdcc', type: "button", class: "close", onClick: this.onCancel }, index.h("span", { key: '200c079d92c0fcfc6cb5da206c5e46f1e0cc5467', "aria-hidden": "true" }, "\u00D7"))), index.h("div", { key: 'fd1a7e0e01ebb74f2754019476ec7c23bef5fb14', class: "modal-body d-flex  flex-column" }, index.h("p", { key: '6ae6bf30f36c65f0a2f98e7f83860359c790f3ae' }, "Please enter the 6-digit code we just sent you."), index.h("ir-otp", { key: 'feb4a4c8b208a22f4168f25d8334c040625ff75f', autoFocus: true,
            // value={this.otp}
            onOtpComplete: this.handleOtpComplete }), this.error && index.h("p", { key: '454100bf678eb4e2f47c825993a442489014cef1', class: "text-danger small mt-2" }, this.error), this.showResend && (index.h("p", { key: 'ffa473e4db67cffdb057b30d6367c74914a59d88', class: "small mt-1" }, this.timer > 0 ? (`Resend code in 00:${String(this.timer).padStart(2, '0')}`) : (index.h("a", { href: "#", onClick: e => {
                e.preventDefault();
                this.resendOtp();
            } }, "Didn\u2019t receive code? Resend"))))), index.h("div", { key: 'd825d36502a1e398ac4ac0a9219b3931738541a2', class: "modal-footer" }, index.h("ir-button", { key: '2bbd74e17252450d4249b763e7e414b2df83225a', text: "Cancel", btn_color: "secondary", onClick: this.onCancel, btn_disabled: this.isLoading }), index.h("ir-button", { key: 'bd2267f210018a231017b42b73c18957cdb5420d', text: "Verify", isLoading: this.isLoading, btn_disabled: this.otp.length < 6 || this.isLoading, onClick: () => this.verifyOtp() })))))));
    }
};
...
const IrPasswordValidator = class {
    ...
    render() {
        return (index.h("div", { key: '70e23b1551a3a6213688859d3b089b57ca8ae533', class: "m-0 p-0" }, index.h("requirement-check", { key: '662d41424e2dc3a9e7f5548823f2f9362ca7dae5', isValid: this.validLength, text: "Minimum 8 characters" }), index.h("requirement-check", { key: '0d18b0f2888e0a2637cb09e9761cac50ecc0abf1', isValid: this.hasUppercase, text: "At least one uppercase letter" }), index.h("requirement-check", { key: '1037c0bf9623c734ef99d33a60d2c98cbdfea648', isValid: this.hasLowercase, text: "At least one lowercase letter" }), index.h("requirement-check", { key: '514837ae8b0a258923c0f334515b69cf98a0f59b', isValid: this.hasDigit, text: "At least one digit" }), index.h("requirement-check", { key: 'dfd7729f84ea6689a173ce7bb76cd9d753b3e771', isValid: this.hasSpecialChar, text: "At least one special character" })));
    }
    static get watchers() { return {
...
const IrResetPassword = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '354678d2c20ac44b57fa3ca80a1f44ea3ef7738a', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, !insideSidebar && (index.h(index.Fragment, { key: '5a99d58779dc7428230f8e4816d2765ecc3ba5d7' }, index.h("ir-interceptor", { key: '0137141a104b08c2e44e90381a3d05a9df2ad1da', suppressToastEndpoints: ['/Change_User_Pwd'] }), index.h("ir-toast", { key: 'fa6010539bcbad1001e6ff36dfae560b6af5b032' }))), index.h("form", { key: 'dcc20e2b1f393df1c04ece823123058b29ce926b', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && index.h("ir-title", { key: '2f21ccec470fbfeb0c13d921e8cacfaf52f85d2c', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), index.h("div", { key: '2eea7ca4b4aa01f118f1de619f4708fba99e9860', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, index.h("svg", { key: '70979ec95ee63609931a4751a4f4f3f115effed6', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, index.h("path", { key: 'bbbd3eca75aaef0958fca63d0f29788921f9d5f3', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), index.h("div", { key: 'e5759f2577a8aa22203dec80e78d2516cec31525', class: "text-center mb-2" }, index.h("h4", { key: '9b380041fc95e582cef9a7caf92304a90096dc78', class: "mb-1" }, "Set New Password"), this.submitted ? (index.h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (index.h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (index.h("section", { key: 'aac6b3deeacf39ed95c5843e65a51a4c4bf30029' }, index.h("div", { key: 'cce32f33d930961742ec812d87bfb5c87eb28779', class: 'mb-2' }, index.h("div", { key: 'e0b18b1688d71f5d3018b2d8f39f4cb6f154316a', class: "m-0 p-0" }, index.h("div", { key: '6646492e9f720d8c3ee61c924dad079db7e7e993', class: 'position-relative' }, index.h("ir-input-text", { key: 'b8758bd68b4ed9b9a7d586e059e8da353b664b66', error: (_a = this.error) === null || _a === void 0 ? void 0 : _a.password, autoValidate: this.autoValidate, value: this.password, onTextChange: e => (this.password = e.detail), label: "", class: "m-0 p-0", inputStyles: 'm-0', zod: this.ResetPasswordSchema.pick({ password: true }), wrapKey: "password", placeholder: "New password", onInputFocus: () => (this.showValidator = true), type: 'password' })), this.showValidator && index.h("ir-password-validator", { key: '9ae56354025369f54596cc3ce5f8a3afb854beb4', class: "mb-1", password: this.password })), index.h("div", { key: 'dcf79f3178d3bf144103ef9c85fad4537b304ddb', class: 'position-relative' }, index.h("ir-input-text", { key: '5cb8534146e431ab69761c8384fb24cacf2d8610', error: (_b = this.error) === null || _b === void 0 ? void 0 : _b.confirm_password, autoValidate: this.autoValidate, zod: this.ResetPasswordSchema.pick({ confirm_password: true }), wrapKey: "confirm_password", value: this.confirmPassword, onTextChange: e => (this.confirmPassword = e.detail), label: "", placeholder: "Confirm password", type: 'password' }))), !insideSidebar && (index.h("div", { key: '9013d2d396c4932323d1ef9b21ad7e738c2ddd9f', class: "d-flex flex-column mt-1 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, index.h("ir-button", { key: 'aa559ff1f12d85eddd7c47b25564e8b699b229a2', btn_styles: 'flex-fill', onClickHandler: () => window.history.back(), class: "flex-fill", text: 'Cancel', size: "md", btn_color: "secondary" }), index.h("ir-button", { key: '32b0727b3524fa279e7e06631fe8e007136db04e', btn_styles: 'flex-fill', class: "flex-fill", isLoading: this.isLoading, btn_type: "submit", text: 'Change password', size: "md" })))))), insideSidebar && (index.h("div", { key: '994e276f5f53d764179014d4c5a1df7d9e31ac8f', class: 'sheet-footer w-full' }, index.h("ir-button", { key: 'c1f2e80930ed936d3be48e5f7c8d55c984e61268', text: 'Cancel', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_color: "secondary", btn_styles: "w-100 justify-content-center align-items-center", size: "md" }), index.h("ir-button", { key: 'dec61561b37bfc39dea506f0100a5c8329feb7bf', isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: 'Change password', size: "md" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '99608c198756635badf8065bce6b7583cf1ef9ad', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: 'f0c330a021af1728caa7c73a55b966a10c83fcd4', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '87aa6d0b081cb583d864e852fe98e97f1445dc7b', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '1a4286cbf501b287fb8ef3c6053e4dc39b2c5518', class: "input-group row m-0" }, label, index.h("select", { key: '7ff06a9b2937a0f3f910ed9f5d6788675a6533ac', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'ebd01fc64dd625cfbb8ac21b86aa8a862854e7c0', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '38d0003787e2c5347118ea2e932e1d5addd15997', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '7eabf7fe0d906a95ee248454e09809476b5a60fd', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'd322bfb87cd3895501b772cac02efc311f649cc6', class: 'sidebar-title' }, index.h("p", { key: 'd4906cfc41071116c0adaadbc88540d57f87364c', class: 'p-0 m-0' }, this.label), index.h("div", { key: '38f96e37a1496c5a86cc03451d2c73d6e8ff6bfa', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '21fb00dc1f9c950699d12db6f0cde2f8c8f54a25', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '0ec6d3cfe5602377909b9b5d29c47ffe777395b3', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'd61b39f0db21c0475c133dcfc5452a16b091dfa3', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '4960ad0b09a0cca5d6b06bd88bdd749a03c6939c', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd3aa106130c995e1861e641b70978303ea2c77a4' }, index.h("button", { key: '49841fa1f15debb41a4868e552cd5e4f4b8107a4', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: '6615a1627771bf155e9401ab8d190089515344c1', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: 'f3c87177859d216d2390f8fa222b75a771450fbe', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: '21da3c37907046fc7584c3ce46c3224dd7526222' }, index.h("h4", { key: '1e0591099e465dac432ce87a452665baa422b40c', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'a96ea930ed116e711bc5e7eb15dd0ca1fa14be60', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '7d26f82357e01146b864e64373e9a18b96cee161', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '32617615707214ba079a6519a4be24bb16bee6fd', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: '166410fda3679dff1916f19759df32c5759bd957', class: 'title-body' }, index.h("slot", { key: 'a1e97a2f7f8a0d72cf826dade2c1576b2b04e787', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '6042321b2918b271d30c24c3305fd806d4d5246c' });
    }
...
const IrUserFormPanel = class {
    constructor(hostRef) {
        ...
        this.userSchema = utils.z.object({
            ...
            type: utils.z.union([utils.z.literal(1), utils.z.literal((_a = this.superAdminId) !== null && _a !== void 0 ? _a : '5'), utils.z.coerce.string().nonempty().min(2)]),
            username: utils.z
                .string()
                .min(3)
                .refine(async (name) => {
    ...
    render() {
        ...
        return (index.h("form", { key: 'fc9189181a303b8477fe2dad7b258b904bb8fc47', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: 'd3d69d0fca41bf60e1d8f660c5808a4c7f0f3696', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: '5a06a3b1a6b261de5d58b7929895ade62e5047c4', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '11c1641e78b39bcca7c0ada695c3601860655b94', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40, errorMessage: this.emailErrorMessage }), index.h("ir-input-text", { key: 'd45eb5fd1aec69411e7bdc944ad916aff5a26132', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: "Mobile", mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === this.superAdminId) || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "Role", data: this.allowedUsersTypes.map(t => ({
                text: t.value,
                value: t.code,
            })), selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '5' && (index.h("ir-input-text", { key: '8762a06d5c759374b336f1f20388eaa30c4a741d', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: "Username", disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username, onInputBlur: this.handleBlur.bind(this), maxLength: 40 })), !this.user ? (index.h(index.Fragment, null, index.h("ir-input-text", { testId: "password", autoValidate: this.user ? (!((_l = this.userInfo) === null || _l === void 0 ? void 0 : _l.password) ? false : true) : this.autoValidate, label: 'Password', value: this.userInfo.password, type: "password", maxLength: 16, zod: this.userSchema.pick({ password: true }), wrapKey: "password", error: (_m = this.errors) === null || _m === void 0 ? void 0 : _m.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: '93bc1258d394bbe261ef2a7ad2862a0ef249767f', class: "logins-history-section mt-2" }, index.h("div", { key: '45cf937cc710666698e940812144cd2bbbbeadb2', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '9461b43f0b61fe0d1601b2cc54e2ee1d01b06d05', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: '46819218fb2f21438b672bd4164456ed8a708df3', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: '5c2164fdb637daf313abe69bc61f77f47d4e5c03', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: 'e3a63618a3f675e554ccd4cc4dcadb4d7edaa0ca', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '54433f14c69d27f72c5dd5e426d305047ba24d57', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: 'd06bad108329ea9e3d6c52d1c6405b8376b3ed19', class: "sheet-footer" }, index.h("ir-button", { key: '67efe27beae1eb5aa84eb7297a49aaf027f474ae', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '701d76483e26d8526f53409592369e077b2b271a', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagement = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-toast", null), index.h("ir-interceptor", { suppressToastEndpoints: ['/Change_User_Pwd', '/Handle_Exposed_User'] }), index.h("section", { class: "p-2 d-flex flex-column", style: { gap: '1rem' } }, index.h("div", { class: "d-flex  pb-2 align-items-center justify-content-between" }, index.h("h3", { class: "mb-1 mb-md-0" }, "Extranet Users")), index.h("div", { class: "", style: { gap: '1rem' } }, index.h("ir-user-management-table", { allowedUsersTypes: this.allowedUsersTypes, userTypeCode: this.userTypeCode, haveAdminPrivileges: [this.superAdminId, '17'].includes((_a = this.userTypeCode) === null || _a === void 0 ? void 0 : _a.toString()), userTypes: this.userTypes, class: "card", isSuperAdmin: ((_b = this.userTypeCode) === null || _b === void 0 ? void 0 : _b.toString()) === this.superAdminId, users: this.users })))));
    }
    static get watchers() { return {
...
const IrUserManagementTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ace0bc8a9f261d841c349f9b5def8082e6fb9a0e' }, index.h("section", { key: 'a10ce4206ce564eb894514cf78d9756296d11299', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '6ac337e9299fd5c754e85a99743ab12873c878ef', class: "table" }, index.h("thead", { key: '9ed3b9519cf40e0324bfa2e32a3268a4f17552d6' }, index.h("tr", { key: 'b646a3bcd995e80c6c42d5bcd064d86507c3db26' }, index.h("th", { key: '5c1c0cf75832fcce2746f01befe0c44c344ffcc8', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '192b1bbed362ad55378e66fa550530ea5314dc98', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: '22e10c9a0ac640f3a53b2a96232ce0f544836358', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: 'bcde43627c77f16a9094cfa8e4f4592e7d9df6d0', class: "text-left" }, "Role"), index.h("th", { key: '7ba215d5dbe125231a71c538554816810c2029df', class: "text-left" }, "Last signed in"), index.h("th", { key: 'e5e77ab152d742e2d8d87ec2de0cdd98bbd72718', class: "text-left" }, "Created at"), this.haveAdminPrivileges && index.h("th", { key: '04c85ce07de4d0a5450869991e8e0a0444dccf84' }, "Active"), this.haveAdminPrivileges && index.h("th", { key: '05270f421356b31e80e7a3cd579e0d5e7e6a1609' }, "Email verified"), index.h("th", { key: 'cced45e6cb05513fa5fde9a31a1eb8b2f31ca325', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '8aab924a8924e0d6da2f4b325ab8ce6e8085284c', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: 'df9a3e018726335dd56b99a49b7e9e3b8206a32e', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'bb2b6dcfac00a7137fedbc39ebfeb222e8eb0f88', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: '97bb85311ecd61d10cad284784d329f27bf89c0d' }, this.users.map(user => {
            var _a;
            const isUserSuperAdmin = user.type.toString() === this.superAdminId;
            const latestSignIn = user.sign_ins ? user.sign_ins[0] : null;
            return (index.h("tr", { key: user.id, class: "ir-table-row" }, index.h("td", null, user.username), index.h("td", null, user.email), index.h("td", null, (_a = user.mobile) !== null && _a !== void 0 ? _a : 'N/A'), index.h("td", null, user.type.toString() === this.superAdminId ? 'Super admin' : this.userTypes.get(user.type.toString())), index.h("td", null, latestSignIn && new Date(latestSignIn.date).getFullYear() > 1900
                ...
                ? null
                : !isUserSuperAdmin && index.h("ir-switch", { onCheckChange: e => this.handleUserActiveChange(e, user), checked: user.is_active }))), this.haveAdminPrivileges && (index.h("td", null, user.is_email_verified ? (index.h("button", { "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "user-verification", title: user.is_email_verified ? '' : 'Click to resend verification email.', class: `m-0  badge ${user.is_email_verified ? 'badge-success' : 'badge-danger'}`,
                ...
                } }, user.is_email_verified ? 'Verified' : 'Not verified')) : (index.h("ir-button", { class: "m-0 p-0", onClickHandler: () => this.sendVerificationEmail(user), btn_styles: 'px-0 m-0 text-left', labelStyle: { padding: '0' }, btnStyle: { paddingHorizontal: '0', width: 'fit-content' }, "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "user-verification", title: user.is_email_verified ? '' : 'Click to resend verification email.', btn_color: "link", size: "sm", text: "Not verified" })))), index.h("td", { class: 'action-row' }, (this.canEdit || this.canDelete) && ((!this.isSuperAdmin && !isUserSuperAdmin) || this.isSuperAdmin) && (index.h("div", { class: "icons-container  d-flex align-items-center", style: { gap: '0.5rem' } }, this.canEdit && (index.h("ir-icon", { "data-testid": "edit", title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
                    this.currentTrigger = {
                        type: 'user',
                        isEdit: true,
                        user,
        ...
        })))), index.h("ir-sidebar", { key: '41a39907827b61bc60dd75e5cc5243d8a93abb8a', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
...
const RequirementCheck = class {
    ...
    render() {
        return (index.h("div", { key: 'c80e3a497dd1cc32c22f2b91e4cc01c6b9a5c45c', class: { requirement: true, valid: this.isValid } }, index.h("ir-icons", { key: '8dd6a3b0646da9b84637cdd888d9bc6ca325cc03', style: { '--icon-size': '0.875rem' }, name: this.isValid ? 'check' : 'xmark' }), index.h("span", { key: '561a33f81ad3d5e9cee326e2818a90c96458c1ce' }, this.text)));
    }
};
