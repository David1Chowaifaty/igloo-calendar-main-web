...
var IBooking = require('./IBooking-BT0vyd3Z.js');
...
class SetupService {
    ...
    async getSetupEntryByCode(params) {
        ...
        return result ? IBooking.SetupEntrySchema.parse(result) : null;
    }
    /**
    ...
    async getMissingSetupEntries(params) {
        ...
        return index.libExports.array(IBooking.SetupEntrySchema).parse(result ?? []);
    }
    /**
