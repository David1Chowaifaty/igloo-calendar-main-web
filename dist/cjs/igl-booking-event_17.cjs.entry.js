...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8b3a39d351a71db44773635f391cf9c542c1c777', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: 'aec075457aa7816902d855982b2e443114dd2f78', class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '3d76783243f957a192ef8c3d58c395b8e978c8c4', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: 'a11522018d271d356db7f2fca02ea0d9cbe03bd4', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: 'f2661ecb2aed925e7aeca493fffe6277c26f8c69', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '72c4c95d609b0b77bf6fcb74ca93f78b4255aa3a', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '2a0b960661230a4d56b5a68463e0c5a7ef55b1af', class: "bookingEventTitle", style: { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '5f3f1a3f90a46c3aa2bdd2ff7cfe5e479596e4b2' }, index.h("div", { key: '51521c233d11256fcc47c82be5985d6ed5c33348', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: '6484840c60680a053fe1591daa57a8f4b3b66396', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: '4af03846c259ad1f09ecda894ca093e9715718aa', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'cf63b1cc36b2f6e772ac5226bc11bd299201b1a0', class: "sheet-body px-1" }, index.h("div", { key: '81444c97b98120ea68ddf625dd63cafc676d4c4f', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, index.h("p", { key: '10a2bf0d09cfcdc5251d8a49188a8e2de643f963', class: "m-0 p-0" }, "Select the unit to"), index.h("ir-select", { key: 'a35ec1a1a041e54984acc59361dce3764b62cdcc', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), index.h("div", { key: 'acc966037bd32f839e674de7551c7100bb49e38d' }, this.errors === 'rooms' && (index.h("p", { key: 'c012b4133d00e31cef52abcdaacac5e30521f63c', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("ul", { key: '355cbf10aa1f0247106edd966ef628bab4dd379e', class: "room-type-list", ref: el => (this.unitSections = el) }, calendarData.calendar_data.roomsInfo.map(roomType => {
        ...
        }))), index.h("table", { key: 'fc26e937bf8770397c1ffdbdbf2886ff57417968', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '8604ad6d7090af6c9bcbfcfbb55617e6d5cdbf99' }, index.h("tr", { key: '7b9d34bf6a7add7fd631557eeff3f21dbcb64400' }, index.h("th", { key: 'e2f46f2574f967c94c8990318906af965b7bcb58', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '08546aca927101bce31cadabd3e38de319534301', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '75aae070e37a141f7182306e8e19bc7c2eb3c2f8' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: '49870deeef7e97fe2f4b037d8eb4ceb20cc24216', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '47e3437f286091c17218c971d4aa52c6c796646a' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: '68fe1535f40fd1df0ac0c1778c25774f9cd28d20', class: 'sheet-footer' }, index.h("ir-button", { key: '64c879313ac5f8f904612dd86ff7363d71aaf9a9', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '5006708ac3d8e44521c5cef92f8c3ca5677e7b69', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: '3529749e792f2dd8bf9e3cf19bc6e1f942078480', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '21bdeeadfbfe804770f3616a47c98b4b3aed3e13', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: 'bb6063f3ab5d3c7627ee5590e65b4f77a4455c6b', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: '24f8e9968ea4923c96fdd971b3026956376aaace', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), this.selectedTab?.id === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: 'a705f45b352600f6eca4629b2061ef93cc0eaf4d', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'a8825fcd87d360fdb6dc95d006226a1948fa0acc', class: "sheet-body px-1" }, index.h("div", { key: 'b5522ec8acff909b24224cfe05171b190e5c52db', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '08e56ee2d59b585aa1f1b2eaaf97956728635bad' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: '9a8719147c54b7c4062353caf701dacceb77bc59' }, this.errors === 'rooms' && (index.h("p", { key: 'd9923b39b88adcbc636ce324079f9badddd813e7', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: '760fdbb88c136fd5c0ea0952c678d398a5f9669c', ref: el => (this.unitSections = el) }, index.h("thead", { key: 'dfb2c8f0b4e78fbeca9b5f3f578440897923d0a7' }, index.h("tr", { key: 'adc20cdcc5c6d30acf8a5f6539bb52527a02ac05' }, index.h("th", { key: '315d2d252e9272062352f7930fb27d1428b19e4d', class: "sr-only" }, "choice"), index.h("th", { key: 'a0fc0671f74513f8cbbd5841429cea2cc6c5f0d0', class: "sr-only" }, "room type"))), index.h("tbody", { key: '7317b5d401fb95676fe633ec110777d3414bd42f' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: 'f715228b734abbb4644e49521f8baa8a0b0fb9db', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '904e06a87b58d7c248e8f7810059c629a16f6ab9', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: '1b2abc4d775a74771113414e70cf5cc69e45a27a', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '0e5113e32eac9574f31a0ca43adbe88b01e5cc04', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '0ad39c9288e376969cbc1e5a3772c522973526db' }, index.h("tr", { key: '983b28db0902aa4cacb7e83db5f1e9fb31aa9e6b' }, index.h("th", { key: '0686a741198bef2ebfb82ebc7346cb4961763986', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '72eff62855c1298cf60250992433fd0932709f7b', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '2fc95f07cd0df980ad4695f686f874b7baabef45' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: 'ba265c728f59004cf57bfe9cefd1dfb5eed6d00d', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '265334f5e6cfd575eead06ebfa2ebaacd53a1313' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate : this.minDate;
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '3edaaacd33492cd989c144c039d7afc54a4a928a' }, index.h("div", { key: 'fb27870b459bef8bcbfb1dcdff1cba4b699dde70', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '82d00c4a52830af695cf0268d964ccb4a1a85b5d', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '501f89d336ee15efe4eef99a3d7b8c9f9078b8e7', class: "footerContainer" }, index.h("div", { key: '44ca2aa6e427a0af9e4bf5839e77b74bed821df6', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '9bbe1b2f1cad4227e637af1ac8f917dab37b8b1d', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: 'cf4c5d6a8a9babdd4a6aadee457221c95845e618' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: 'e26259ad7a740118ff2cfc4a59354f93f30f4f81' }, "v1.05"), index.h("ir-new-badge", { key: '9a36e117e32bbe83719365312e155567ebc73df3', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c7fa81cc900bcd5281d1cc7d6248e219b43a8ddc' }, index.h("div", { key: '42dcefd004e295022b5abbae17ebdbf89f07ba36', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: 'c875c21c0a259e0b341ddf1bacd9613efa9f313a', class: "header__fd-actions" }, index.h("div", { key: 'bfe7f0871545e2268a1594d2d3c0dc48542de7ed', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: 'ead396ede04e6ac2d2444c3b3602e3c2ffc8c1ce' }, index.h("wa-tooltip", { key: 'cf51815070699d9df00f3156800463a69d551934', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: '854b25d2ceb14723dbde7600731e71365aeefca7', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: '7025392f6fb61f74712722b20f6915aea4648a12', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("ir-date-picker", { key: 'c85f95af0030cf17280abc2ed902b1457bb8947f', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-custom-button", { key: '6b62f3d809e459cdea220c5c967e5297f13de8c3', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '1bf2685a9fb91d833a070a65b00366b2253115d4', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate }))), index.h("wa-tooltip", { key: 'b263357427373ced05f412744465c9b2d729d01c', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h(index.Fragment, { key: '95609acefb421508e9bf8462cf0d3f4256b23daf' }, index.h("wa-tooltip", { key: 'c2b5c01c26cbc505fdfa479ca0c587d88c83491b', for: "fd-today-navigation_btn" }, locales_store.locales.entries.Lcz_Today), index.h("ir-custom-button", { key: '07f567778ef19a733df3ba9b4f5be74c09f3fd93', slot: "trigger", id: "fd-today-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('gotoToday') }, index.h("wa-icon", { key: '42624c3af89e1b958cb89111faf8abaddeb3292a', style: { fontSize: '1.5rem' }, name: "clock", variant: "regular", label: locales_store.locales.entries.Lcz_Today, "aria-label": locales_store.locales.entries.Lcz_Today }))), index.h(index.Fragment, { key: '3e2f06e7e52cdcdedb408339a757cdc3534b2623' }, index.h("wa-tooltip", { key: 'd172e8e3307f8dad6474b770695bfb1db25e376a', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: 'f2ab6b05ff58a5d82153e13f5fadc82d06a3d34b', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'd9c4b7ef3339d400f235a9406273c1efaffacb65', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '1a77644a8df6435f4858c9e6cbc042a48321775f' }, index.h("wa-tooltip", { key: 'b99c43c18a63eee51a32d5adbbfd1124b737355b', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: '99bbccc32ac78edf8cecbbe6035e99b3d9fa6668', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'ff2b7367bf2fadae6dc8856c32515f3caa8a2006', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: 'e1a033a691d1abaa80a7eb99d40d55c7d4c7b155', class: "searchContiner" }, index.h("ir-picker", { key: '7701938d205da9d354be97b81388232242e6575e', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: '9238feb0ecc436fb2ea4e8cfc1c7f69cf638c277', class: "stickyCell headersContainer" }, index.h("div", { key: '73fa2583e2f80cabcb07f43d939609a8bc55a09b', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
            return (index.h("div", { class: `headerCell align-items-center ${'day-' + dayInfo.day} ${dayInfo.day === this.today || dayInfo.day === this.highlightedDate ? 'currentDay' : ''}`, "data-day": dayInfo.day }, !this.calendarData.is_vacation_rental && (index.h("div", { class: "preventPageScroll" }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr !== 0 ? (index.h("button", { class: 'fd-header__badge-btn' }, index.h("wa-badge", { class: "fd-header__badge", variant: 'brand', appearance: 'accent', pill: true }, this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr))) : (index.h("wa-badge", { variant: 'neutral', appearance: 'filled', pill: true }, ' ', this.unassignedRoomsNumber[dayInfo.day] || dayInfo.unassigned_units_nbr)))), index.h("div", { class: { dayTitle: true, weekend: utils.isWeekend(dayInfo.value) } }, dayInfo.dayDisplayName), index.h("div", { class: "dayCapacityPercent" }, dayInfo.occupancy, "%")));
        }))));
    }
    static get watchers() { return {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a1738055a62aad4d774a8bba8aead690997574fb', class: "legendContainer pr-1 text-left pb-4" }, index.h("div", { key: 'c8799863440f6bcc577c36e9f7aa25331699243e', class: 'w-full' }, index.h("div", { key: '110dab4acbe3aac110a15855e1cf8054e4a51f06', class: 'w-full' }, index.h("div", { key: '34644c1db7ceda47f7accd30b83833bec1a1c6d7', class: "stickyHeader pt-1 " }, index.h("p", { key: '36858acf2d4f0e80c285353397e064898a0ee846', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: 'b64681317f9698d6adbec0d30b78d202a9d522e1', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '708e8f22462a6fef7d8515ac324eaf88e15f2d4a', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '7f329396f2c7e9241af6d7404248aba8c114b3f7', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '570e8271e88be597912296c9b77f9fac3e18ff7b' })), index.h("div", { key: '0ab8968cc43604d8a8c468627fbd2bf9371478b0', class: "mt-2 pl-1" }, index.h("table", { key: 'a1fe78b0a42ada031db23bebd2c8eb0f8d72a4e9' }, (() => {
        ...
        }), index.h("tr", { key: '600802bf96d660b1311c325c5ececfcd44812b8f' }, index.h("td", { key: '5aa0c4c5786ab9ee1a9b2980f61c732f0ec9c5d1', colSpan: 2 }, index.h("hr", { key: 'a3db6e4af9708786c2636be5104290812b0437d6', style: { marginTop: '0.5rem', marginBottom: '0.5rem' } }))), index.h("tr", { key: 'c25e9f22913c55abdd5efb888a6c0b478f17c531' }, index.h("th", { key: 'ef97fc2fffa2b952f9438dc455472c440051135e', colSpan: 2, class: "", style: { paddingBottom: '0.5rem' } }, index.h("div", { key: '517e28c9aecb1d3714ce2b178768f35c600c6faa', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: '95d5cf6f5184388f805433855e95912fedeaa3d4' }, "Default colors")))), this.legendData.map(legendInfo => {
        ...
        }), index.h("tr", { key: 'd44fefd508197d791b18f75235f7a8d317bdbcb2' }, index.h("td", { key: 'a3b5af837d57044da057ddf40e7d96edf4470ff9', colSpan: 2 }, index.h("hr", { key: 'b915b6f747b78d2ad7139135bbb3f6881354be0d', style: { marginTop: '0.5rem', marginBottom: '0.5rem' } }))), index.h("tr", { key: '6b6d1ff7907d0cd5a0b897750607002fa7f19931' }, index.h("th", { key: '0a939078f2710348ee7e8ed51a7aa9a975998568', colSpan: 2, style: { paddingBottom: '0.5rem' } }, index.h("div", { key: 'c501108c63089a918d44a273ced3840c0d0867e5', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: '7cd4a524c1c6d008521643a15a482209205f3471' }, "Use your own colors"), index.h("ir-new-badge", { key: '3ebb141e7b310a3d7ce7b4bc57174f82f90191e7' })))), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        }))), index.h("hr", { key: '4d6b74577d8b07aa4e23b1bf035a88789e645273', style: { marginTop: '1rem', marginBottom: '0.5rem' } }), index.h("div", { key: 'c08b5e7cf3a760913b3d9adbe95179551ff28fb4', class: "mt-1" }, index.h("div", { key: 'b231f51ad63d57db0adde44345f593f4b55f50d4', class: "legendCalendar" }, index.h("div", { key: '0200c988fc4913e89dabfa10924781eb24635569', class: "legendRow align-items-center" }, index.h("div", { key: '3870c466b9e227674a4406ff8874c8cbd024f16a', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: 'decde60570e85ab5212bb752b9d00d0fce622c5e' }, "MAR 2022")), index.h("div", { key: '7cbdf59a37413821654dae9b8b1e39274b728bfb', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '6a59e617e6add6521f5ce308d1d07f758a7a7bed', class: "legendRow" }, index.h("div", { key: '4899007968c60672b606cb90f76c79f0ff9ae1e3', class: "legendCal headerCell align-items-center br-s" }, index.h("wa-badge", { key: '906888dd0b18608cb6113f122ab36e3719801a2e', pill: true }, "3")), index.h("div", { key: '804878562a5a2008c6f0fa7ef968de41ae50dfde', class: "highphenLegend" }, index.h("div", { key: 'cd1a988bf3deefa4feb0eb56ddc3ba84ceb009c6' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '7f9540678f51ffb0dc23ff8e603cda7983c723c6', class: "legendRow" }, index.h("div", { key: '6f7457a995d98990ae5446094eeb1165b7c237f2', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '3886312ef50215369e706d8507956e67212fc6f0', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: 'fefe51cdecd24bfd820c31eec51547c8e043949a', class: "legendRow" }, index.h("div", { key: '01ebd7d03f60404d513ba4edb854432e006e2759', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '08ce0f92dc6a4d0fea6f1e809195ce5efc9915d5', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'abf15f3f107616e1f77f994c1d66ae76b94e6f1b', class: "legendRow" }, index.h("div", { key: '60d099bdfda2921c70b3ddda46c8a680771a3366', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: '9ee011963b9d6c7caefaef4fe7e3a8fc8d542aa9', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
    static get watchers() { return {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'efa3e248e996ab9954234c051b4a9f6328e446cd', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '07faf0421cf2fdc540210f984531bd46c20b7c21' }, index.h("div", { key: 'dcc9a62aa56692ef8805b146e68e8e879a836ac4', class: "dialog-body" }, index.h("p", { key: 'cb904f286728352b9a39ef6913e0103a010cec97', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: '2b0800b8f27fed6dafbc091a41b781d7b74e1134', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '449ab6c16698044e45ee92d27577745d575f16ea', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: 'aa4dcbceb6c5e04be71f67e77a367a4e83248b27', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '5fa811f9485bc9d3c9668521eff6398ab1b7bcab', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: 'cc7874f70ba4d55f77a8658b6266373ea152f2fa', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: '574b6c1029af0e42856f8680cc63466f5b82369b', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: 'a28f2813e7bd573951abcb5f03e07d6dc156509d', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '417dfe8b26d16f84520118a3adb24cd9d4f4c23c', class: "px-1 sheet-body" }, index.h("div", { key: '26f40561a676baedac681469959d5506b8161c6e', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '9ddefb0a05c4f548c9ab300533148bf83c7fc363' }, index.h("ir-date-view", { key: '6c070598366e4b7456dae2470273f7eafae8ae99', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: '33ee5b2c15eaa05505f1a67fd044a7b75a7d8c18', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: 'c0fdce0ca510a2a39c4ec25dbe3319fc2b20ba7d', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: 'b3f1887db978a490b1c9bc31facad269810fc46f' }, "From:"), index.h("ir-date-picker", { key: '6b791637246db38f333efb40e766ddd3dea95409', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: '4c8bfd04c3c78a70011888bc8d357c8c85bdf013', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: '1f955f118d08035d0e2b911ab658ac921ebba669', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: 'c569eeb0fafcda68f6bc7aa448cb291bdf295a61', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '1d261658f6a215cde08ebeb868d387de8f95f8f5', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '3c4ba27d4a4dd2dc48f27157ecef95419dac88f3', class: 'sheet-footer' }, index.h("ir-button", { key: 'e88f533834e2f3fe030e919c4a3a6506eb0f7b5c', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '71b543f402d552500216bf6060966b3d779777a2', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '009373742a0f689edd20d1fd551ce25cfefc8cd0' }, index.h("div", { key: '838a9e353f042a05f4bf9f43f85f0d83d2a225c0', class: "sectionContainer" }, index.h("div", { key: 'cca1419b4d8f721b72cdf9e14869e9eb6fa5e6a1', class: "font-weight-bold mt-1 font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '894bfb053abb19791a9b16f82ceb9cf00d8f366a', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '5a286cb7bf98553f9e9398c88b31fd15eb08f3e8', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '7c33f29949681298749f57bc8b1fb8f1415cedc2', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: '0f1ae81cffdc23d4b844b909615cfdaec96e2733', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, index.h("slot", { key: '5c0c25daedd2cc8f83b29c28185678aa0763bfc9', name: "end" }))))));
    }
};
...
const IrPriceInput = class {
    ...
    initializeMask() {
        ...
        this.mask = ClickOutside.IMask(this.inputRef, maskOpts);
    ...
    render() {
        return (index.h("fieldset", { key: '2dd546f608b42216942ccc6d1e1d26f2ef5f5909', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '3abb21ec6d5d6fb59e35cb285cfd957aa9872b7b', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: 'b19c73a05c000738c3ac7cd71812155da4580d52', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: '7aa05103ac29cfb637010736e34d71870088d407', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '22e2bc306873ab621a754f27cf566d2f94b36873', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'ecf6ed42c425fbd18f2aa35bd68021bfadcc06c0' }, index.h("span", { key: 'c4427b7d42fb429d6a14b8937b3d9c5cb7dc16a1', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '6db48e68558015125b512ad4868f5d5a30f584c1', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
//# sourceMappingURL=igl-booking-event_17.cjs.entry.js.map