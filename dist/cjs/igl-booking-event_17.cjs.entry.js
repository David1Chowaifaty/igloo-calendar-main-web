...
const property_service = require('./property.service-f6d16d3e.js');
...
const toBeAssigned_service = require('./toBeAssigned.service-77a51307.js');
...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5da58054d0acb5a1a268101d2a0dfa119577c1bc', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '32e80385c485f7fd66f37a237daedb4393306aed', class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: '3b268241ff22270c7eb56c3e98d5fa1810fc7936', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: 'a29edf5bae0def4100bf9cd5621bb3e95b1494b8', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '2d48b27e99bbaaf47937bc2dcf0e9a4675dbb4f5', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '87804bdc42a43fc8533b1aa7c067b34f0e198709', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: '0028de118e319c4ba647766ea796f8e8327d34c2', class: "bookingEventTitle", style: { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: 'daea488229f58330a8d6f29fe42a1201db6ab6c7' }, index.h("div", { key: 'a47ce54b87b82422c5412658041cd3edd22482de', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'd48cc352858d485e9207c757ff26b9f45e5c63bc', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: '98f1d909066318fd1f588ef1ef018648ec852fb3', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '4df0eca04c81f0d8359119f37aa426a130ef56b6', class: "sheet-body px-1" }, index.h("div", { key: '234a4775e3557f7e1e4496cc2ac8a3d4a203e1b2', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, index.h("p", { key: 'b2f44d4d0633aaf5c5239a99d863e84b9d20c669', class: "m-0 p-0" }, "Select the unit to"), index.h("ir-select", { key: 'acbf675424f34d43b8e39a83d0bfb408a5ce6eee', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), index.h("div", { key: '8bc6953be2ae2eca9d7ea074a79cfc6a2dec8c6a' }, this.errors === 'rooms' && (index.h("p", { key: 'b9291ca7a609617578810798f5509bd86c65552c', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("ul", { key: '62585ff25e1b4b418fe328adcdfdc19135bb9c9f', class: "room-type-list", ref: el => (this.unitSections = el) }, calendarData.calendar_data.roomsInfo.map(roomType => {
        ...
        }))), index.h("table", { key: 'f16b2f2db3391ac6c5d1ed90800143b3eecfaede', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: '6cfbf9eb0eedcc43d2c2f66fe1cf919f20c7f7f0' }, index.h("tr", { key: 'acf2c3d3c115e5796df6009a2c1dac76d3164810' }, index.h("th", { key: '546d1a994b8fa4db1f205eb5cb9727860c34cffc', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '50d66bcda35dba60f809b7bbda53314bf60bcb34', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'a607c96b3fba32d8ee416abee6d9ee8816af617e' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: 'ede46398a54f1d235f8bc8c4780bf557aa000914', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '598e99bd917879afacb848369a547468ca1fd755' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: '71196382f82ef6b90360ceec43f7a50b7d8db89d', class: 'sheet-footer' }, index.h("ir-button", { key: 'c43a99069b7edd711d0e46ad7f285fe1bf050672', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '8af1aeac3b85927c9a539057759fe2efea344276', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: '339245e148d20e93f67c4a1f78a428cbe65e20a3', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '3f93f512b9ba0a1de35579cc6dac196f6e463c7a', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '55679e25035505a54d7a442a8d8058dc291dfbf9', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: '411cd10ed4ca32075d2ba1bea2d59776e15f03f8', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'ea84f47659740bd49ee2a25ee476ac0cd786c527', class: "sheet-body px-1" }, index.h("div", { key: 'f9f7027010230ba0061a012d28352b8e6ce1971a', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '14ec27baeff69f719c932f43e08b4d3956823358' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: '7cdfc2c7ed3c964efdf0b2e95e95d5f1e76a9ec2' }, this.errors === 'rooms' && (index.h("p", { key: '2910e5aa968750508f82ab1f54f1670f1c9cca43', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: '2d1595785f087755b3b95b8e674c2aabb215ab7e', ref: el => (this.unitSections = el) }, index.h("thead", { key: '181f3592e001d3911a4114cea19389e81595015a' }, index.h("tr", { key: '6b011ef91ee4479a71da067c8246ec67fd62c3a4' }, index.h("th", { key: '7ed19f4178555dada543c00eef82dad2b7fff986', class: "sr-only" }, "choice"), index.h("th", { key: '959303b84d625cbbb09b7d76cf59f5b173e738f6', class: "sr-only" }, "room type"))), index.h("tbody", { key: '67104857bf9bfb95618d4d200c7012283af903b2' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: '4121283270251a628d9f96e08dbcc5ac330b5cd6', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '52b574c0e218b8f87057dd7fd1a53b923600ca4b', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: 'aa3a4ceee623c76f42dbe981130161d34679faa7', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '82258414defc468e90f4b84a95302f299d372bdd', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'e5c63e010bd0c1aba9deefc7ddfd725e10a2b30a' }, index.h("tr", { key: '1009068d213763338be98dd743dfde6961831715' }, index.h("th", { key: 'ef28bcb50697617f1bd8fb8f61729b611e8b1185', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '5512a91225ea21b2745f17a1d31e7fb4f49deaa5', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: 'c01e80bc12e2949b3719f72d2942322f165ddfee' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '72f9c8cf80b6106d8819ecba4f392e00b697d943', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '8193d2358978f01f2247ab3e0f77bb50c6462cbe' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate : this.minDate;
        ...
        })))), index.h("div", { key: '261b66a12abd58562df021b01db23d8af58f67a6', class: 'sheet-footer' }, index.h("ir-button", { key: 'e172b1f9b9fde72d5144f4081119bdb525d44bb4', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '8890fd446b27b761ab6baa5f9fe5507b8b88fd08', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e0664dd85a04a9a6ed2203fdd1bbdffb5d00b053' }, index.h("div", { key: '2231db9c3876b3c9b7cf9d0726e1c7684ccdf606', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '1c7bac8f81d3e1795a1d69f71d029423fa6f5b98', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ccca54fa83d1eed59b35a2fb3e363ca8ba1bd00b', class: "footerContainer" }, index.h("div", { key: 'b263467cd820f47ab4f19f3e577584d1ea46c038', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: 'e6d5bcf0cd5ffcd8011a88f6b0553c5f14efbabf', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: 'bacf5da739473591bb2a4e79c640ba4f304115a4' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '7a4490939498f90cfca9e88da12f70e335c5b2d0' }, "v1.07"), index.h("ir-new-badge", { key: 'e6bc5ab3a50080818d560b11ff3df50e40b9e51e', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '05726b8000e0315327e2dc63adbe54c64a201550' }, index.h("div", { key: '94c322bea11f62f1c21b7f96adc7556721c32e87', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '8030d49ab09ecb60236e4dd3689afe1e033c05b4', class: "header__fd-actions" }, index.h("div", { key: 'd94ed749110f853834896a5d9b68a933199ef317', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (index.h(index.Fragment, { key: '46766651cdf99512535de79ab692e183f8f0b42f' }, index.h("wa-tooltip", { key: '356b5c3373c014f407c51127740758836eb42a12', for: "fd-unassigned-dates_btn" }, locales_store.locales.entries.Lcz_UnassignedUnitsTooltip), index.h("ir-custom-button", { key: 'c4436745b0a6b9f21304840311d2d55e1f58cf82', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, index.h("wa-icon", { key: 'afacbdc8dc4588e9e32c56fa5204cb19a1b424f2', style: { fontSize: '1.5rem' }, name: "server", label: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales_store.locales.entries.Lcz_UnassignedUnitsTooltip })))), index.h("ir-date-picker", { key: 'ad5068dd444f0e05340519514d6b41ddc36d76a8', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-custom-button", { key: '3d753813edbc2322e6bed9b696a8de2c5bdeb9b0', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, index.h("wa-icon", { key: '6f7d010486a7e4d8912c326c4fc29b328f545c23', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales_store.locales.entries.Lcz_Navigate, "aria-label": locales_store.locales.entries.Lcz_Navigate }))), index.h("wa-tooltip", { key: 'eea5f73c4cb11e90bc086f073e40e8d89bf4937a', for: "fd-dates-navigation_btn" }, locales_store.locales.entries.Lcz_Navigate), index.h(index.Fragment, { key: 'ac9de9a98e371c820fe028c5e6ad7d8f71d3f47f' }, index.h("wa-tooltip", { key: '0d926f6009bcaa0d4bb64f6c22c42b1204a4c493', for: "fd-today-navigation_btn" }, locales_store.locales.entries.Lcz_Today), index.h("ir-custom-button", { key: '8dc9e684cb306e0fa678c8948b9a31cbd6b75ec2', slot: "trigger", id: "fd-today-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('gotoToday') }, index.h("wa-icon", { key: 'ee7baebd1bd6de2460b89453c8292a5378e32f4a', style: { fontSize: '1.5rem' }, name: "clock", variant: "regular", label: locales_store.locales.entries.Lcz_Today, "aria-label": locales_store.locales.entries.Lcz_Today }))), index.h(index.Fragment, { key: '18411c8ef47eab94044acea094b0d691d6b39c6d' }, index.h("wa-tooltip", { key: '1c01b9f3c4c62657eb422dc76cc02428dab9480f', for: "fd-new-booking_btn" }, locales_store.locales.entries.Lcz_CreateNewBooking), index.h("ir-custom-button", { key: '113634ee7516befaf15b4dffd732984ce19c6096', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, index.h("wa-icon", { key: 'c49ddd7f5de4e4613d9e94c85c54b58510c1793f', style: { fontSize: '1.5rem' }, name: "plus", label: locales_store.locales.entries.Lcz_CreateNewBooking, "aria-label": locales_store.locales.entries.Lcz_CreateNewBooking }))), index.h(index.Fragment, { key: '351116138a923796550bced445b2bf0b5cdd6f79' }, index.h("wa-tooltip", { key: '53c1f0d0f4e4c31ead367cf98596c3ec55d48723', for: "fd-stop-open-sale_btn" }, locales_store.locales.entries.Lcz_StopOpenSale), index.h("ir-custom-button", { key: 'be5ae474337e3bcc6beb0822e367bb349fc48793', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, index.h("wa-icon", { key: '7eca58d6cc8fb8bf98ce212b1a7c9b481559a144', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales_store.locales.entries.Lcz_StopOpenSale, "aria-label": locales_store.locales.entries.Lcz_StopOpenSale })))), index.h("div", { key: 'e4be60f58a7d317f670173811d6fb06b2b5bf8d8', class: "searchContiner" }, index.h("ir-picker", { key: '2c1b937747bc423b6a70fdc6ba35dcab34c4e323', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: '45d79cd5754b3697ef6de04625e19e80cc6cde81', class: "stickyCell headersContainer" }, index.h("div", { key: 'eb277decba32c40607a04057a32d6516778b9440', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: 'e3c735e10b2a705831d011ff15018de46e8c217b', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: 'be13aea9ccac321d26a2dcbfba186bc753415c54' }, index.h("div", { key: '3310e81f6f635f1ffaaaf663b446424c6ec0b599', class: "dialog-body" }, index.h("p", { key: 'c943956141c68238920798e20226d0ef592a816f', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: 'c65fd68a3f6315c7ef56d946975daf1ae8e8705d', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: '235ce783c56ff2a5fce22b80035990611b83cd7f', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '9144ca79349dfc0c321d9e184613dca0edc11a71', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '51f6d8170cdb8a210ffd098b9ded8103e184812e', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: 'a3369e86bd1b7a7b2f1cc91527b937e01c051a36', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5b24dd8c12e534a5feb819537bb77a036b191aa6', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: '8f45b43c9e55bd530ace29c125f1b257e46b45ba', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: 'd301fd3152dd21fe1efc6c97c80a9808b3c043b5', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: '923c61cdf5c4df71bfd17c9d0937e6844f2d7fc6', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, index.h("slot", { key: 'd0550191323999abf3d1db469586ce3ecefa3829', name: "end" }))))));
    }
};
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: '1ceb1f2a19f0294d28cc6d55e255f97d107ba8d6', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: 'cb90c2cff064454e59a108646d606935bd6c1262', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '429b52e20b6ab202cf6231a7811887db3fa04851', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'c6bdf7f747b3dc4b7f04929f06fe009d2425584b', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: 'a97e1a4c105664a611b290371f1e768fb89f7e14', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'b83d26f89685eb726dee202f565f8db826a21b73' }, index.h("span", { key: '6925364c7e22c51e3758211571c5f6fd64908b97', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '961cf01617310f2b102a6b995f9e086478ee9641', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrSuccessLoader = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'da47fbe6f5b52f95e0521e5809c6ea7ea1700fe3' }, this.phase === 'spinner' ? (index.h("svg", { part: "spinner", width: "18", height: "18", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { d: "M10.14,1.16a11,11,0,0,0-9,8.92A1.59,1.59,0,0,0,2.46,12,1.52,1.52,0,0,0,4.11,10.7a8,8,0,0,1,6.66-6.61A1.42,1.42,0,0,0,12,2.69h0A1.57,1.57,0,0,0,10.14,1.16Z", class: "spinner" }))) : (index.h("ir-icons", { part: "check", name: "check", style: { color: '#45b16d' } }))));
    }
    static get watchers() { return {
...
const IrTabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: '113b6e6c1779aa0e292d8ba2068175f3aae29265', role: "tablist", "aria-label": this.ariaLabel, "aria-orientation": "horizontal" }, this.tabs.map(tab => (index.h("button", { class: "tab", key: tab.id, type: "button", "data-tab-id": tab.id, role: "tab", tabindex: this._selectedTab?.id === tab.id ? 0 : -1, "aria-selected": this._selectedTab?.id === tab.id ? 'true' : 'false', "aria-controls": `tabpanel-${tab.id}`, id: `tab-${tab.id}`, disabled: this.disabled, "data-state": this._selectedTab?.id === tab.id ? 'selected' : undefined, onClick: () => this.selectTab(tab), onKeyDown: event => this.handleKeyDown(event, tab) }, tab.label))), index.h("span", { key: 'ee47994f0ab0f1a20a28dd8cd0a01743089ed5e4', class: "active-indicator", ref: el => (this.activeIndicator = el) })));
    }
};
