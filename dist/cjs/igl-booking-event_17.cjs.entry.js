...
const IglBookingEvent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'dd6339dd193396fe8d530f7284e776b71275b04b', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: bar }, index.h("div", { key: '988d9ffa0410421bded2717529577303a6415448', class: {
            ...
            }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }), isDepartureAfterHotelCheckout && index.h("wa-tooltip", { key: 'b48e31637f2dcaff9d5b406c5507667b8bcdb49a', for: lateCheckout }, "Departure time: ", this.bookingEvent.DEPARTURE_TIME?.description), balanceNode && index.h("wa-tooltip", { key: '4d2a3a67372cb5c6199245e11332476bbaa2b571', for: balance }, "Balance: ", utils.formatAmount(calendarData.calendar_data.property.currency.symbol, this.bookingEvent.BALANCE)), noteNode ? index.h("div", { class: "legend_circle noteIcon", style: { backgroundColor: noteNode.color } }) : null, (balanceNode || isDepartureAfterHotelCheckout) && (index.h("div", { key: '282927e552793b2612e754cef97a0d0823b1d3b7', class: "balanceIcon d-flex" }, isDepartureAfterHotelCheckout && index.h("div", { key: '02ba80336e30d32ba2b330555dcc74d33d483b56', id: lateCheckout, class: "legend_circle", style: { backgroundColor: '#999999' } }), balanceNode ? index.h("div", { id: balance, class: "legend_circle", style: { backgroundColor: '#f34752' } }) : null)), index.h("div", { key: 'f5153ee1f2476f92dd6f06ad9fbb6242b7835185', class: "bookingEventTitle", style: { color: foreground }, onTouchStart: event => this.startDragging(event, 'move'), onMouseDown: event => this.startDragging(event, 'move') }, this.getBookedBy(), this.renderEventBookingNumber()), index.h(index.Fragment, { key: '1058a2689cd750b0938d95551aca9151a164b6a0' }, index.h("div", { key: '76c88efaec56314b79faf66473d6c3b1cb76162e', class: `bookingEventDragHandle leftSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
            ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.to_date)).isAfter(new Date(this.bookingEvent.TO_DATE)) ? 'skewedRight' : ''}`, onTouchStart: event => this.startDragging(event, 'leftSide'), onMouseDown: event => this.startDragging(event, 'leftSide') }), index.h("div", { key: 'ff82136870188dfaafa822c9b7f8afe52ff06b17', class: `bookingEventDragHandle rightSide ${!this.isNewEvent() && moment.hooks(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
...
const IglBulkBlock = class {
    ...
    render() {
        return (index.h("form", { key: '3ebfa780908fa3f0258f16e7db007b6ce2c72c22', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: 'cd96b1affdae841133dac2906dc02a36a097f423', class: "sheet-body px-1" }, index.h("div", { key: 'e4f8688ca995649bc62ddee448d93eb04208ab70', class: "text-muted text-left pt-0 my-0 d-flex align-items-center pb-1", style: { gap: '0.5rem' } }, index.h("p", { key: 'e64480ca9d5c7f24b775e27410ff00ec9ea5f271', class: "m-0 p-0" }, "Select the unit to"), index.h("ir-select", { key: '58185689e48745f29b0bb7e6630a8f93954efc97', showFirstOption: false, selectedValue: this.blockState, data: [
                { text: 'Block', value: 'block' },
                { text: 'Unblock', value: 'unblock' },
            ], onSelectChange: e => {
                this.blockState = e.detail;
            } })), index.h("div", { key: '537374a62af03fbf0141b3f5d07052ab8ac8bbda' }, this.errors === 'rooms' && (index.h("p", { key: '4ee1c1b9b3a1eb90f3bfbafe6e697bf34bd472c6', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("ul", { key: 'c02561140f8a0b24f7ce582a81cbaa1ed7697a8c', class: "room-type-list", ref: el => (this.unitSections = el) }, calendarData.calendar_data.roomsInfo.map(roomType => {
        ...
        }))), index.h("table", { key: '64a776572976406c5ea8151aee15dbff93f9b265', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'f9f01881e1ac93e809e7bce82ba03ab556f9da76' }, index.h("tr", { key: '14a0b59c452aaf72e1d2d280ab15bbf33d274b9f' }, index.h("th", { key: 'f0d4e14cff5b7f578b558ad9eaa124e8825133c0', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: 'd1a1aea1cf8f272c9dd3c205b707b6c80be2f9c6', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '45b191ea59b299d98322a76dabb6adcccce7bbb7' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (index.h("ir-button", { key: 'daea23c6359bf09830220fdadc35818740b9f4e3', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '10fdce141987e0536fd04db841b875b6fe93f2e8' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
        ...
        })))), index.h("div", { key: '4a980b40f9a580e7a24d6d2a544e773bd9464190', class: 'sheet-footer' }, index.h("ir-button", { key: 'da01946cc43e7e2526dbaff615e4cc53359ca8e3', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'f4fec46d67438dff9d4ec30b4caa7103bf83d0f6', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglBulkOperations = class {
    ...
    render() {
        return (index.h("div", { key: '82b91745d520420bcecf3ea6d7da3ca77f5809e9', class: 'bulk-operations-sheet-container' }, index.h("div", { key: '2f8fa14dfdc5dffebdb8b18446d11485960152b9', class: "sheet-header d-flex align-items-center" }, index.h("ir-title", { key: '954afea90fadc44c1c69f502f73e7dc092b3d28d', ref: el => (this.titleEl = el), onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                // if (this.isLoading) {
                //   return;
            ...
            label: 'Bulk Operations', displayContext: "sidebar" })), index.h("ir-tabs", { key: 'ebc17d2530a4324d7394633e4c2293aa75cb1664', ref: el => (this.tabsEl = el), class: "tabs", tabs: this.tabs, onTabChanged: e => (this.selectedTab = e.detail) }), this.selectedTab?.id === 'stop-sale' ? (index.h("igl-bulk-stop-sale", { maxDatesLength: this.maxDatesLength, property_id: this.property_id })) : (index.h("igl-bulk-block", { maxDatesLength: this.maxDatesLength, property_id: this.property_id }))));
    }
};
...
const IglBulkStopSale = class {
    ...
    render() {
        return (index.h("form", { key: 'a552dc73974d75d5500ff4cc92e4f3819d1826e2', class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, index.h("div", { key: '43eb5d3365b2f0902108100f002cba829555e823', class: "sheet-body px-1" }, index.h("div", { key: 'f842c1f62d81516f2ae182502cfbf851b6e2375c', class: "text-muted text-left py-0 my-0" }, index.h("p", { key: '69a0a24551c1072c4b561a1ca66869d843555eff' }, "Select the types to stop or open sales for all related rate plans")), index.h("div", { key: 'f1b347c6b3fa684bb57eb362c990d2f1b2420a4f' }, this.errors === 'rooms' && (index.h("p", { key: 'ac8f7c79529760d64aa24bceabb5a116ff51d198', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendarData.calendar_data.is_vacation_rental ? locales_store.locales.entries.Lcz_PlzSelectOneListing : locales_store.locales.entries.Lcz_PlzSelectOneUnit)), index.h("table", { key: '5c62cc98b88638a74e753d76d65cdf4acdedd2f4', ref: el => (this.unitSections = el) }, index.h("thead", { key: '3d3d205a26425af05a375ac8aed355f324010e68' }, index.h("tr", { key: 'd8c01d37873dda11d5df803f2e3eabaaefd1539c' }, index.h("th", { key: '9bc084ca0c0bb514afaf61cf9f57f6c7d1b25956', class: "sr-only" }, "choice"), index.h("th", { key: 'ab914758c4e423e767fc338ccd63067292a91bac', class: "sr-only" }, "room type"))), index.h("tbody", { key: '8673cc1cc9dfa12412d3270c35264aa3a77f9d98' }, calendarData.calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), index.h("p", { key: 'c985d955380a4019dfab8041c98fef8ba10438dd', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && index.h("p", { key: '85ce4caea94d550ca98c4ad381c12b4eb2b25501', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), index.h("ir-weekday-selector", { key: '915d3ffae0d58f363bb074799deabeaab24ed8b9', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), index.h("table", { key: '176b5e940d8a4e40002eb6fa031d8934cd001de3', class: "mt-1", ref: el => (this.datesSections = el) }, index.h("thead", { key: 'ea8c7dd17840635639e58d6f5b9ea5868c673abc' }, index.h("tr", { key: 'bb2abd41d8b002a2d0bcb7ce5c8c1838da793b98' }, index.h("th", { key: '8504ba73db7d19342be9a6e9c7dca6bf5d99ab20', class: "text-left" }, locales_store.locales.entries.Lcz_From), index.h("th", { key: '33303cec31c9c7895ae07b37ea098355b54fb354', class: "text-left" }, locales_store.locales.entries.Lcz_ToExclusive), index.h("td", { key: '5e968b6a33fe766796de2e1f9ffaf760d6af52be' }, this.dates.length !== this.maxDatesLength && (index.h("ir-button", { key: '04d8e682af5dfb5b4fa3999d1066e68487255511', variant: "icon", icon_name: "plus", onClickHandler: () => {
                this.addDateRow();
            } }))))), index.h("tbody", { key: '7f883c55fecd1bd82bedbf17c4316856a8d6b2fc' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
            const fromDateMinDate = i > 0 ? this.dates[i - 1]?.to.clone().add(1, 'days')?.format('YYYY-MM-DD') ?? this.minDate : this.minDate;
        ...
        })))), index.h("div", { key: 'f26b3c4d02836f68a81657c855627560452cb960', class: 'sheet-footer' }, index.h("ir-button", { key: '11fe9a24985fc53c43a7c44587289c1d1c16f2c1', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: '9e22c6374a9f41b3cebd23c41ef3baeb5e84cab1', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Save, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglCalBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8cd5e8fb6fccfca3b90d2a634f3522262817f47e' }, index.h("div", { key: 'cfe2bc7f19e713d6e47335bcf1b772f430eaca8d', class: "bodyContainer" }, this.getRoomRows(), index.h("div", { key: '15fb85ced98f418cbd2a5d1e94d437a656615b30', class: "bookingEventsContainer preventPageScroll" }, this.getBookingData()?.map(bookingEvent => {
...
const IglCalFooter = class {
    ...
    render() {
        return (index.h(index.Host, { key: '85513fae6c082e8584e4b02c3e051365557132f7', class: "footerContainer" }, index.h("div", { key: '6942f045eb09eddd8bee6e9245448263b9b80fa1', class: "footerCell bottomLeftCell align-items-center preventPageScroll", style: { paddingLeft: '10px' } }, index.h("button", { key: '67c3985185449fe2d0c4a73e117dcb575d814df6', class: "m-0 p-0 btn btn-sm  legendBtn d-flex align-items-center", style: { gap: '0.25rem' }, onClick: () => this.handleOptionEvent('showLegend') }, this.isLegendOpen ? (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M105.4 297.4C92.9 309.9 92.9 330.2 105.4 342.7L265.4 502.7C277.9 515.2 298.2 515.2 310.7 502.7C323.2 490.2 323.2 469.9 310.7 457.4L173.3 320L310.6 182.6C323.1 170.1 323.1 149.8 310.6 137.3C298.1 124.8 277.8 124.8 265.3 137.3L105.3 297.3zM457.4 137.4L297.4 297.4C284.9 309.9 284.9 330.2 297.4 342.7L457.4 502.7C469.9 515.2 490.2 515.2 502.7 502.7C515.2 490.2 515.2 469.9 502.7 457.4L365.3 320L502.6 182.6C515.1 170.1 515.1 149.8 502.6 137.3C490.1 124.8 469.8 124.8 457.3 137.3z" }))) : (index.h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 640 640", height: 16, width: 16 }, index.h("path", { fill: "currentColor", d: "M535.1 342.6C547.6 330.1 547.6 309.8 535.1 297.3L375.1 137.3C362.6 124.8 342.3 124.8 329.8 137.3C317.3 149.8 317.3 170.1 329.8 182.6L467.2 320L329.9 457.4C317.4 469.9 317.4 490.2 329.9 502.7C342.4 515.2 362.7 515.2 375.2 502.7L535.2 342.7zM183.1 502.6L343.1 342.6C355.6 330.1 355.6 309.8 343.1 297.3L183.1 137.3C170.6 124.8 150.3 124.8 137.8 137.3C125.3 149.8 125.3 170.1 137.8 182.6L275.2 320L137.9 457.4C125.4 469.9 125.4 490.2 137.9 502.7C150.4 515.2 170.7 515.2 183.2 502.7z" }))), index.h("span", { key: '89bc7915afd84e19323b718a7f92c0fa7c085a02' }, locales_store.locales.entries.Lcz_Legend), index.h("span", { key: '204b916315809827f99ea24b8b89e520aba0aa44' }, "v1.05"), index.h("ir-new-badge", { key: '509450aa66213890ea9f1bb97a74f79ff4fa5ffe', style: { marginLeft: '0.25rem' } }))), this.calendarData.days.map(dayInfo => (index.h("div", { class: "footerCell align-items-center" }, index.h("div", { class: {
...
const IglCalHeader = class {
    ...
    render() {
        return (index.h(index.Host, { key: '89ec7e8200cc1829c6e2b8659677074979a05840' }, index.h("div", { key: '452f313f008ca61276da5bc7a5e4f1401a5e1898', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, index.h("div", { key: '7ad466f877df785b8369237180793b3b2a82573d', class: "header__fd-actions" }, index.h("div", { key: 'd46d73884a3fb72cf703e05be30576299cf1d49d', class: "row justify-content-around no-gutters" }, !this.calendarData.is_vacation_rental && (index.h("ir-button", { key: 'a83841b84491e1b98c6d8f7576586a6405ea5dc9', variant: "icon", icon_name: "server", style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_UnassignedUnitsTooltip, onClickHandler: () => this.handleOptionEvent('showAssigned'), btn_styles: "caledarBtns", visibleBackgroundOnHover: true })), index.h("ir-date-picker", { key: 'd3c509ac3941be2a086c6e1f8baa88056c37398e', minDate: moment.hooks().add(-2, 'months').startOf('month').format('YYYY-MM-DD'),
            // autoApply
            // singleDatePicker
            onDateChanged: evt => {
                console.log('evt', evt);
            ...
            class: 'date_btn', title: locales_store.locales.entries.Lcz_Navigate, "data-toggle": "tooltip", "data-placement": "bottom" }, index.h("ir-button", { key: '963078b243f27c1362dca23a1e6da58e4bbe947e', slot: "trigger", btn_styles: "caledarBtns", variant: "icon", icon_name: "calendar", style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('calendar'), visibleBackgroundOnHover: true, ref: el => (this.dateRef = el) })), index.h("ir-button", { key: '31e887dca9ea2a90909b9710af17cb900bf5a284', variant: "icon", btn_styles: "caledarBtns", class: 'pointer', icon_name: "clock", visibleBackgroundOnHover: true, style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, "data-toggle": "tooltip", "data-placement": "bottom", title: locales_store.locales.entries.Lcz_Today, onClickHandler: () => this.handleOptionEvent('gotoToday') }), index.h("ir-button", { key: '5032f34e72c7d2970748571f638c1f4e5e4a8469', variant: "icon", btn_styles: "caledarBtns", icon_name: "plus", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_booking_btn", title: locales_store.locales.entries.Lcz_CreateNewBooking, visibleBackgroundOnHover: true, style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }), index.h("ir-button", { key: 'e5ccd67d4fe6a75b178c93e8de6ddec2bd00d5fc', variant: "icon", btn_styles: "caledarBtns", icon_name: "calendar-xmark", "data-toggle": "tooltip", "data-placement": "bottom", "data-testid": "new_bulk_btn", title: locales_store.locales.entries.Lcz_StopOpenSale, visibleBackgroundOnHover: true, style: { ...icons.colorVariants.secondary, '--icon-size': '1.5rem' }, onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) })), index.h("div", { key: '78cd0b4d48b8f2a4ba05efc4407179e25381f13c', class: "searchContiner" }, index.h("ir-picker", { key: '634c09452d6e7db233bbdb384f750ce0638f1e4d', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (index.h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), index.h("div", { key: '42a329eff21192b2a014150b8bc0f9446ccab9d1', class: "stickyCell headersContainer" }, index.h("div", { key: '93107b10823f30522d84f0f2bbb217d3904a0078', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (index.h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, index.h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
...
const IglLegends = class {
    ...
    render() {
        return (index.h(index.Host, { key: '76b6fb40ac969430a892f907ebfb70e044713645', class: "legendContainer pr-1 text-left pb-4" }, index.h("div", { key: '18680a5d8970191e286315c9d53f73b3a6ecc3b4', class: 'w-full' }, index.h("div", { key: '21903beaf5f9709965c073d167972e55fa8a2ef9', class: 'w-full' }, index.h("div", { key: '7cbbad2b85b2c3763dea523a93ae8bc47f79cd3b', class: "stickyHeader pt-1 " }, index.h("p", { key: '1625651ba1b1d8fa5311f10b4c45645cb4f910ed', class: "legendHeader" }, locales_store.locales.entries.Lcz_Legend), index.h("div", { key: '1c23b62b6ddc508f26fd41b23efc4f2c640139d0', class: "legendCloseBtn", onClick: () => this.handleOptionEvent('closeSideMenu') }, index.h("svg", { key: '69a976ab3dd5ff3c3be9f9fd818c34f3cdc9f3b3', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: 'babbe88c00e20c9a69755169e6a8d26c821d98b1', fill: "#6b6f82", d: "M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z" }))), index.h("hr", { key: '0b2becd3200243b42a153755fa4a1e6a262ff7fe' })), index.h("div", { key: 'ce0f948413067ec3edaf1f7b0add579740b8ec95', class: "mt-2 pl-1" }, index.h("table", { key: 'b3625798f78e2eba1b20b0396437e249b140c39d' }, (() => {
        ...
        }), index.h("tr", { key: 'eba235268cd345404c6151b2adee32f87d7a638c' }, index.h("td", { key: 'b89d8bf740939151d059fd7678dddd988132d0bb', colSpan: 2 }, index.h("hr", { key: '0153fa7d140dd7f3c013504caff6142e5fc94740', style: { marginTop: '0.5rem', marginBottom: '0.5rem' } }))), index.h("tr", { key: '08cb6c9c223a489fb46c758ed8c5cf0f86643b9e' }, index.h("th", { key: '0de62a974c9f821c6cbf01fcf7b98ea67d9f613d', colSpan: 2, class: "", style: { paddingBottom: '0.5rem' } }, index.h("div", { key: '8190e19f4d25f72906e5e08598f394a1da1bdfcd', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: 'd719da7d9d3e09fa2d9a179ac231c2ffea600281' }, "Default colors")))), this.legendData.map(legendInfo => {
        ...
        }), index.h("tr", { key: '838f0464bcc07433dc80e467f80166795c634ef8' }, index.h("td", { key: '7934c21ce0350885700d030acc2bff06888575b8', colSpan: 2 }, index.h("hr", { key: '323d7a4a7f6313137cad1d838931d646957c9bcc', style: { marginTop: '0.5rem', marginBottom: '0.5rem' } }))), index.h("tr", { key: '3c88604fc8eaaeac8aaa38fdc382587983a3ae31' }, index.h("th", { key: '96eef958160b902010934705e135f05764dd655d', colSpan: 2, style: { paddingBottom: '0.5rem' } }, index.h("div", { key: '53664688107a07adad9616fdfaea7b2f822e2e35', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("span", { key: 'f22bf02d108d34517ee0cfa24f0084d1def8666b' }, "Use your own colors"), index.h("ir-new-badge", { key: '4e41bd2b2e5a0729e3d09c877724b0028f4d3c1f' })))), calendarData.calendar_data.property.calendar_extra?.booking_colors.map((legendInfo, index$1) => {
        ...
        }))), index.h("hr", { key: 'ead019db7d0e48fac0d9773eb8c39f73831c2c74', style: { marginTop: '1rem', marginBottom: '0.5rem' } }), index.h("div", { key: '31339821a281f44b29ab0a64e395c39ba9fba0ae', class: "mt-1" }, index.h("div", { key: '25cddc7427e7e718d5f0e8060709dd35d92c9b12', class: "legendCalendar" }, index.h("div", { key: 'e83a8400f60757c05e3b36162cd539f016770f9b', class: "legendRow align-items-center" }, index.h("div", { key: '319b8bbe8b3f6ba69225653c91b962752206c5dd', class: "legendCal br-t br-s br-bt" }, index.h("strong", { key: '9ad1e2eb79507cb51c0708397db289d4eaab04c7' }, "MAR 2022")), index.h("div", { key: 'f0ec280d293b069e7a26bf6d90ea4555db33bc0f', class: "highphenLegend" }, locales_store.locales.entries.Lcz_MonthAndYear)), index.h("div", { key: '702c515ad0cdcd80471ddd50cbed085f9aed3a76', class: "legendRow" }, index.h("div", { key: 'efdd703bec24afdce744d02972f22c04638ec489', class: "legendCal headerCell align-items-center br-s" }, index.h("span", { key: '13fb083c142511e1ff8a5bd2ef356f3be2a00123', class: "badge badge-info  badge-pill" }, "3")), index.h("div", { key: '9aeb386da5b1acb40526898c973e4a0feb0ab838', class: "highphenLegend" }, index.h("div", { key: '9af85a256994080619ae3ccc2822e4a7c42ecc99' }, locales_store.locales.entries.Lcz_UnassignedUnits))), index.h("div", { key: '499bf2c3c6f4a29f793da45f55a6d910a89c4003', class: "legendRow" }, index.h("div", { key: '73055fbabfee12c55377b37e97fc28ce7a2af673', class: "legendCal dayTitle br-s" }, "Fri 18"), index.h("div", { key: '561166814e7c09e7d0443b2e0be02c45a95f6df8', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Date)), index.h("div", { key: '1789e72dd03fc3c575b4bbffd29372554e8a6f6f', class: "legendRow" }, index.h("div", { key: 'bcf9ce73183490532bf37ef347380f2c3af583d7', class: "legendCal br-s br-bt dayCapacityPercent" }, "15%"), index.h("div", { key: '3f4d903a6ae755a5df7060b510010e435b48ac41', class: "highphenLegend" }, locales_store.locales.entries.Lcz_Occupancy)), index.h("div", { key: 'ca668b94a94f797d9664885c07c8df5ab7a62eb9', class: "legendRow" }, index.h("div", { key: 'cff70fcc953766c4beb7192d7858c3c0fafe8f6a', class: "legendCal br-s br-bt  font-weight-bold total-availability" }, "20"), index.h("div", { key: 'e5db9ca4eab87d4ee49f751f54139d6c997943e6', class: "highphenLegend" }, locales_store.locales.entries.Lcz_TotalAvailability))))))));
    }
    static get watchers() { return {
...
const IglReallocationDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '617f247411e2a8a071586c44766b435f3d4c3731', label: 'Alert', ref: el => (this.dialogEl = el), onIrDialogHide: this.handleDialogVisibilityChange }, this.data && (index.h(index.Fragment, { key: '8ea9662b47d5ef14d6a3afc61529f030e39c2c40' }, index.h("div", { key: '930163fd52bcfc5eba0e06eabb9d7950206b3e09', class: "dialog-body" }, index.h("p", { key: '83efa6d3855cd16e691431022e22b332a1b61f37', class: "text-left dialog-body__description m-0 p-0" }, this.data.description), hasRateplans && (
        // <ir-select
        ...
        // ></ir-select>
        index.h("wa-select", { key: 'd69416a5cf547efe782652895771364bc1e3a177', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, defaultValue: '', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, size: "small", "aria-invalid": String(this.showRateplanError), onchange: e => this.handleRateplanChange(e.target.value) }, index.h("wa-option", { key: 'bfedd4c9db65bbe990e382c591fb3709a926838c', value: "" }, "Select rate plan..."), this.rateplanOptions.map(option => (index.h("wa-option", { key: option.value, value: option.value }, option.text)))))), index.h("div", { key: '4beb371c011d246c2e9019d384280ecc887e4461', class: "dialog-footer", slot: "footer" }, index.h("ir-custom-button", { key: '8ec008ce32822c6136d1ce0740c3effe905a3293', appearance: "filled", variant: "neutral", onClickHandler: this.handleCancelClick, size: "medium" }, "Cancel"), index.h("ir-custom-button", { key: '8a66ea697b305c35148bfca9e4fa4aa3ad4eac4b', variant: "brand", onClickHandler: () => this.reallocateUnit(), size: "medium", loading: irInterceptor_store.isRequestPending('/ReAllocate_Exposed_Room') }, "Confirm"))))));
    }
    static get watchers() { return {
...
const IglSplitBooking = class {
    ...
    render() {
        return (index.h("form", { key: 'f8afe36140f634df37c4b299908118ba476c035f', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, index.h("ir-title", { key: '91ec9522edec6c6bcc43b65e328b7cd599135142', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), index.h("section", { key: '100760a834b0a8ae134d7e76fedc7c04377cf3c6', class: "px-1 sheet-body" }, index.h("div", { key: '86f22380e97ed26b671058526737ce8d749ddb5c', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '81a7b2db3056beeab8d70fa05ca5007f49bc0cab' }, index.h("ir-date-view", { key: '575eab21461af61425af3e2c80d4e1bde8d6fbff', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), index.h("p", { key: 'b92ce8f4e51ee81f1a211bd1b46977c777289b11', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales_store.locales.entries.Lcz_NonRefundable : '')), index.h("div", { key: '33c683fa51507497772f750c47d31edc1e1bab85', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, index.h("span", { key: '3df899d74c5e34b738a6d09468d7e2f57bc38da1' }, "From:"), index.h("ir-date-picker", { key: '6b4f0f3896231ff043ce2a96f9203b1f31a4375c', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, index.h("input", { key: 'aee22ae84575a7be21fc533e4be21678c0bede01', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), index.h("ir-button", { key: 'fad053b9aef299ab89e3b477cdda8fff9b8fc499', isLoading: irInterceptor_store.isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && index.h("p", { key: '4a79049e984bc07d2f6128a228c3f52c992f2eba', class: "text-danger text-left mt-2" }, "Please select a room"), index.h("ul", { key: '7afbac4c9fe4b7fd33455bdd10f2bfca49cf55b8', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), index.h("div", { key: '895232adca500ae837058c1dbccc8101ded21fd9', class: 'sheet-footer' }, index.h("ir-button", { key: 'aa057f4d9d7a9cd4c770c6db8eca3e0934538266', text: locales_store.locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), index.h("ir-button", { key: 'fe3c9dc58791fb89b8375332410c1a559b485e02', isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
};
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '50d61eaecb60d8facde0453f039269c4c69e7f44' }, index.h("div", { key: '1fd5720063c05f1bcc8653f57236f7dfc29271c5', class: "sectionContainer" }, index.h("div", { key: '0c0319005f7f45861c870e97890843c0a0ff8fb0', class: "font-weight-bold mt-1 font-small-3" }, this.categoriesData[this.categoryId]?.name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
...
const IrInteractiveTitle = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '4836bff7badafc92499f0f9f8767d374441bce1a', style: { '--ir-popover-left': this.irPopoverLeft } }, index.h("p", { key: 'e7cedd2a881609d62b631ad3d344e0f6824dff23', ref: el => {
                ...
                alignItems: 'center',
                gap: '4px',
            } }, index.h("span", { key: '5e7f9e01d70c183d3744c65783d794e3a01adc3c', class: "cropped-title", style: {
                flexShrink: '1',
                minWidth: '0',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
            } }, displayTitle), this.hkStatus && (index.h("div", { key: 'fe584d87d34154842ede1026ea2301b94c6942cd', title: this.broomTooltip, class: "hk-dot", style: { flexShrink: '0' } }, index.h("slot", { key: 'ee6d7362f53ef29fa9344ceb9d1b58482e7453a2', name: "end" }))))));
    }
};
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: 'c0bbd2df4d1bca657dc609494cd0d0c48d135eea', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '55849cc2eddc9e13f1bfd9c9d396aab6b68b9455', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '6e3556c8a19db4c38faf95e380fb423aabc2458e', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'ad7d17cfda4b510d2ae2febb7d5d235f7e852a30', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '2ea7b35599f9b9a83d2584e7f513d55c9558123a', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: 'f954ecb891ef829cc780bf3cedf992861ddd2d1c' }, index.h("span", { key: '1364917b19b783ee1a2e526c3160b83784b2e070', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: 'e249e75b4be4cb9b498b45ac92235704d40a9ff0', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
