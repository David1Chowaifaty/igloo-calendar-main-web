...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '8e714cf83c704d77b9aa50d332c74daa6cb0fa40' }, hasLabel && (index.h("label", { key: '296bb6278fe670167182d2b1f4de5a153367ed91', part: "form-control-label label", class: "label", htmlFor: "file-input" }, index.h("slot", { key: '59ab8354b204e8fcaa743ca61627046626569829', name: "label" }, this.label))), index.h("div", { key: '0d9af7c41b0d548a6f967fc80c4ed989ebf8dfff', part: "base", class: "file-input" }, index.h("label", { key: 'c606af0f144b6f4f1a1cedadbdbc91c8e9dee0c6', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, index.h("slot", { key: '3a098d334859901973e507f4b1e443a676bc8254', name: "dropzone" }, index.h("wa-icon", { key: '1b309f81172b94d537c6194d3b9204dd293e4917', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), index.h("span", { key: 'b14bf4e93b7bb86cbb60f62f2dbb2fdb9aecb6b1', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), index.h("input", { key: 'cb9ffe768fab1ef23642dac806800d56a7b88e75', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (index.h("div", { key: '455b651522e7df9fbefdd3959bd452645b88fe15', id: "hint", part: "hint", class: "hint" }, index.h("slot", { key: '0acfc3357f4c1bf0a42fb2205aa26219b5437a2d', name: "hint" }, this.hint))), this.files.length > 0 && (index.h("ul", { key: '5e4cb1258938641b0763518b2e8ebd3ce50f2712', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index$1) => {
