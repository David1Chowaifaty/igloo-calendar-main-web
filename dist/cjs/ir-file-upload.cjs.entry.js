...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '309938867ab1d1d281993b57c4687c202f5c0cc7' }, hasLabel && (index.h("label", { key: '921a2c25d9c8349515c19cb35c0b52a8dd126551', part: "form-control-label label", class: "label", htmlFor: "file-input" }, index.h("slot", { key: '373088c08daf0631445cf897868267c63f19420a', name: "label" }, this.label))), index.h("div", { key: '418027a77097c84bc44f31ebcf9408efac1adc0c', part: "base", class: "file-input" }, index.h("label", { key: '8a124d7b260e1d8a027c94756d8832cb36454e34', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, index.h("slot", { key: '21d3be37f78485dc0ae4974cc6da2d353d06d5f7', name: "dropzone" }, index.h("wa-icon", { key: '512a0b46f107982b0bfb545f71e62a622c02a6e3', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), index.h("span", { key: 'c2fdae0269b4256d972f90a2037367d9de73e30d', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), index.h("input", { key: 'd84836335ada2e1b5b03062483d6942399a4122b', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (index.h("div", { key: '6659c5464bd8d3f71bd7504f895da7812d80383c', id: "hint", part: "hint", class: "hint" }, index.h("slot", { key: '2d1042e373fa7d83eb14891bf8ab67d7e9a9c46b', name: "hint" }, this.hint))), this.files.length > 0 && (index.h("ul", { key: 'ddd9506b15f9c62bd969ce258cf5ff8178620458', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index$1) => {
