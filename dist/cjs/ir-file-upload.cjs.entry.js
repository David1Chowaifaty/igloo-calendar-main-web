...
const IrFileUpload = class {
    ...
    updateValidity() {
        if (this.customValidityMessage) {
            ...
            this.internals?.setValidity?.({ valueMissing: true }, this.multiple ? t.t('Lcz_PleaseSelectOneOrMoreFiles', { fallback: 'Please select one or more files.' }) : t.t('Lcz_PleaseSelectAFile', { fallback: 'Please select a file.' }), this.inputRef);
        }
        else {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '13396f3b4fdca64eb92c4d8ea14b77cab1e76d06' }, hasLabel && (index.h("label", { key: '29c9e9712dae603e8525f348e2dd32ae14398f4d', part: "form-control-label label", class: "label", htmlFor: "file-input" }, index.h("slot", { key: 'a72972402f32665375c3441602da6f3030a4912f', name: "label" }, this.label))), index.h("div", { key: '05ae1b63c0c972d2447d8ad509409bbf1d8336ec', part: "base", class: "file-input" }, index.h("label", { key: '2be407e2e031796295dcfa9f27e47546dcebb9a0', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, index.h("slot", { key: '68ed6121525891ba2815a36495fe4e0b9c785e27', name: "dropzone" }, index.h("wa-icon", { key: '82a8d3c649b3bcab8b016f9936f14470ecd00489', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), index.h("span", { key: '9723389c08a882a359b584bd88fcca49260423bc', part: "dropzone-text", class: "dropzone-text" }, this.multiple
            ? t.t('Lcz_DropFilesHereOrClickToBrowse', { fallback: 'Drop files here or click to browse' })
            : t.t('Lcz_DropFileHereOrClickToBrowse', { fallback: 'Drop file here or click to browse' }))), index.h("input", { key: '28955b20a6ce4549bf20dda935f70c273e844612', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (index.h("div", { key: '6398d107514ee6997421ca7893e51a8b0c086754', id: "hint", part: "hint", class: "hint" }, index.h("slot", { key: '5830c11e508c9f7629634da1c597864e37bff578', name: "hint" }, this.hint))), this.files.length > 0 && (index.h("ul", { key: 'f0d9eb2a16e191f54be2daa3f33fefe9e845e22b', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index$1) => {
            const thumbnail = this.getThumbnail(file);
            return (index.h("li", { part: "file", class: "file", key: `${file.name}-${file.size}-${file.lastModified}` }, index.h("span", { part: "file-thumbnail", class: "file-thumbnail" }, thumbnail ? (index.h("img", { part: "file-image", class: "file-image", src: thumbnail, alt: "" })) : (index.h("wa-icon", { part: "file-icon", name: this.fileIconName(file), "aria-hidden": "true" }))), index.h("span", { part: "file-details", class: "file-details" }, index.h("span", { part: "file-name", class: "file-name", title: file.name }, file.name), index.h("span", { part: "file-size", class: "file-size" }, index.h("wa-format-bytes", { value: file.size }))), index.h("wa-button", { part: "remove-button", exportparts: "base:remove-button__base", class: "remove-button", appearance: "plain", variant: "neutral", size: this.size, disabled: this.disabled, onClick: () => this.removeFile(index$1) }, index.h("wa-icon", { name: "xmark", label: t.t('Lcz_RemoveFile', { fallback: `Remove ${file.name}`, params: [file.name] }) }))));
        }))))));
    }
