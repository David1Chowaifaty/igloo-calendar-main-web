...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'e88f0a30fe16d3e3307af4daa003b526031ae064' }, hasLabel && (index.h("label", { key: '62d61f520e0d2ef23d93eedc1873b568a0193106', part: "form-control-label label", class: "label", htmlFor: "file-input" }, index.h("slot", { key: 'ae7ec0770b38741d2d2afb156680fa8a3a97d9de', name: "label" }, this.label))), index.h("div", { key: '5281234ca3e8fdc910ce4eff703bd46eb9138330', part: "base", class: "file-input" }, index.h("label", { key: 'b077fdbda5797451a17d0f7b9ff36c24c1860009', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, index.h("slot", { key: '68d363fc8626bf317300deec4b33291784737da8', name: "dropzone" }, index.h("wa-icon", { key: '5230fc2146b33b078aef5393ae9e9a75bde8b765', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), index.h("span", { key: '43f0827dbd8c1d40ce18bf24f756326c14bb2dea', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), index.h("input", { key: '618a528d9579c2f46001e1c80819459bdc94b036', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (index.h("div", { key: '66ec64ff7595a1065503b37ec64618e310364aa8', id: "hint", part: "hint", class: "hint" }, index.h("slot", { key: 'ee6925881ee6307b4882a9bbbe5e1becc2fa25e0', name: "hint" }, this.hint))), this.files.length > 0 && (index.h("ul", { key: '7e8945a71fba099599fdff95fc95fc9db739d98d', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index$1) => {
