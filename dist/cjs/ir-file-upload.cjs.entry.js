...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '81ac987649b4d69abe729dd7666426b6f18db43c' }, hasLabel && (index.h("label", { key: '7569479ef39d15f656e267f75e9e5bc9cdf73f2a', part: "form-control-label label", class: "label", htmlFor: "file-input" }, index.h("slot", { key: 'a5056184ef59dbc19d44f721d0035b1c2aef2fb4', name: "label" }, this.label))), index.h("div", { key: 'dd2e7a5dd8540c3ec70a06d0e43e0975ba601ac1', part: "base", class: "file-input" }, index.h("label", { key: 'de75f38a7aad2d1ff205e0067b8baa21870d8115', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, index.h("slot", { key: '0c8a635a90432de7d98b2a7c658a0aff6c51781c', name: "dropzone" }, index.h("wa-icon", { key: '498d59e870d271d25b53276bbc6878a5d6757d7d', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), index.h("span", { key: 'c623367e1345466eb7bd1b24149292431a14d4e7', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), index.h("input", { key: '8b7e6e43eeff7c4e017092b97613de330694a79a', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (index.h("div", { key: '7ccdd9c8bfe66e69607d303cbc4eeddfdae211b2', id: "hint", part: "hint", class: "hint" }, index.h("slot", { key: '79f32f058945adb34ab24ff56fa84c7201b8f572', name: "hint" }, this.hint))), this.files.length > 0 && (index.h("ul", { key: '85d023f586794b867675d6d770edacf770081a34', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index$1) => {
