...
const IrFileUpload = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0fcc809ad345cacbae8664ebd0f741caad4fb7a3' }, hasLabel && (index.h("label", { key: '25070c26e3d78bafd5abed6f5bfa8ff41b3bca84', part: "form-control-label label", class: "label", htmlFor: "file-input" }, index.h("slot", { key: 'a1a4dbf2b635a2b253ca9ad8a553b2d428cd6427', name: "label" }, this.label))), index.h("div", { key: '0ea2570d813e079ca1629c01b31cbb75478518a3', part: "base", class: "file-input" }, index.h("label", { key: 'ac8bf175b93afe7fdbfe8709d407c7fed593170e', id: "dropzone", part: "dropzone", htmlFor: "file-input", class: { dropzone: true, dragging: this.dragging, disabled: this.disabled }, onDragEnter: this.handleDragEnter, onDragOver: this.handleDragOver, onDragLeave: this.handleDragLeave, onDrop: this.handleDrop }, index.h("slot", { key: '8b60933e753b2d2417c17a099354531d3e023eee', name: "dropzone" }, index.h("wa-icon", { key: 'e36e14e079dec137d69c6a19ecd15e598bd70329', part: "dropzone-icon", class: "dropzone-icon", name: "upload", "aria-hidden": "true" }), index.h("span", { key: '59ac3f6988afcc7d853c59222a1cdf93fbd20170', part: "dropzone-text", class: "dropzone-text" }, this.multiple ? 'Drop files here or click to browse' : 'Drop file here or click to browse')), index.h("input", { key: '3286674ee5387c255b645828b859cd17e6c7dd76', id: "file-input", type: "file", class: "hidden-input", accept: this.accept || undefined, capture: this.capture, multiple: this.multiple, disabled: this.disabled, "aria-describedby": hasHint ? 'hint' : undefined, ref: el => (this.inputRef = el), onChange: this.handleInputChange })), hasHint && (index.h("div", { key: '002183b3922986e9c67b093dfe823ac9819fc64b', id: "hint", part: "hint", class: "hint" }, index.h("slot", { key: '5f948d6777498f0c6524db27ad8254eb50702746', name: "hint" }, this.hint))), this.files.length > 0 && (index.h("ul", { key: '605ce6ef4335001b1399f779635e0b703bb0b6bc', part: "file-list", class: "file-list", role: "list" }, this.files.map((file, index$1) => {
