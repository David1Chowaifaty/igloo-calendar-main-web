...
const IrCityLedger = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-page", { label: 'City Ledger', description: this.selectedAgent?.name }, index.h("i", { slot: "page-description", style: { marginInlineStart: '0.5rem' } }, this.selectedAgent?.code), index.h("ir-autocomplete", { slot: "page-header",
            // size="m"
...
const IrHkTasks = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { "data-testid": "hk_tasks_base" }, index.h("ir-page", { label: "Daily Housekeeping Schedule" }, index.h("div", { class: "tasks-view" }, index.h("ir-tasks-filters", { isLoading: this.isApplyFiltersLoading, onApplyFilters: e => {
                this.applyFilters(e);
