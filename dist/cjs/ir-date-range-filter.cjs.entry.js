...
const IrDateRangeFilter = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '67632446bb9f10085be584e789e6c48259e57cbb' }, this.label && (index.h("label", { key: 'c19a33689e5f2fdb50d225ab2222a16f46e6b4ff', id: `${this.groupId}-label`, class: "drf-label", part: "label", htmlFor: `${this.groupId}-from-btn` }, this.label)), index.h("div", { key: '963ea94bfc0602dc9084bebb05f2f25e4329e134', part: "container", class: "drf-container", role: "group", "aria-labelledby": `${this.groupId}-label` }, !this.label && (index.h("span", { key: 'cbbec81af7d6153894da46a0451ef8cba8a651be', id: `${this.groupId}-label`, class: "sr-only" }, "Date range selector")), index.h("div", { key: '727431e4b1607bd9e76ba18682639359bcb9a293', part: "field field-from", class: "drf-field" }, index.h("button", { key: 'f9e0786edc9494add5a36419987e8ea26162b0ec', id: `${this.groupId}-from-btn`, type: "button", part: "text-btn", class: `drf-text-btn${!fromLabel ? ' drf-text-btn--placeholder' : ''}`, onClick: () => this.fromDateSelectRef?.show(), "aria-haspopup": "dialog", "aria-label": fromLabel ? `Start date: ${fromLabel}` : 'Select start date' }, fromLabel ?? 'From'), fromLabel && this.withClear && (index.h("button", { key: '6c7750cc53b05b7ab29bf10925990fadb41170ca', type: "button", part: "clear-btn", class: "drf-clear-btn", onClick: () => this.clearDate('from'), "aria-label": "Clear start date" }, index.h("wa-icon", { key: '7c595f2bd4c37c713556db73595c7dd03cea36be', name: "xmark" }))), index.h("ir-date-select", { key: '75c23dfe81d28d2c1bbeb3432afc75535320f704', ref: el => (this.fromDateSelectRef = el), exportparts: EXPORT_PARTS.from, date: this.dates.from?.format('YYYY-MM-DD') || null, placeholder: "From", minDate: this.minDate, maxDate: this.maxDate, emitEmptyDate: true, class: "drf-date-select", onDateChanged: evt => this.selectDate(evt.detail.start, 'from') }, index.h("button", { key: '532aca46f190babbfc0763add8d2defd90f5a032', slot: "trigger", type: "button", part: "cal-trigger", class: "drf-cal-trigger", "aria-label": "Open start date calendar" }, index.h("wa-icon", { key: 'ecf14cc0952a5fb324df30f697f4556dc36993b1', name: "calendar", variant: "regular" })), this.showQuickActions && (index.h("div", { key: 'e0d6732ce920f80049eed41f3bfd72324fa1fab9', part: "quick-actions", class: "drf-quick-actions", role: "group", "aria-label": "Quick start date options" }, this.quickDates.map(action => (index.h("ir-custom-button", { type: "button", variant: "neutral", appearance: "outlined", disabled: this.dates?.to?.isSameOrBefore(action.getDate(), 'date'), "aria-label": `Set start date to ${action.label}`, onClickHandler: () => {
                this.selectDate(action.getDate(), 'from');
                this.fromDateSelectRef?.hide();
            } }, action.label))))))), index.h("span", { key: '15dff3f39a490982950d26e7a07de056302e2efc', part: "divider", class: "drf-divider", "aria-hidden": "true" }), index.h("div", { key: '7272ac5f2572ebbc95ab605678b0276274b94c25', part: "field field-to", class: "drf-field" }, index.h("button", { key: '102f3120d223b72f495aab30b0802280573221e3', type: "button", part: "text-btn", class: `drf-text-btn${!toLabel ? ' drf-text-btn--placeholder' : ''}`, onClick: () => this.toDateSelectRef?.show(), "aria-haspopup": "dialog", "aria-label": toLabel ? `End date: ${toLabel}` : 'Select end date' }, toLabel ?? 'To'), toLabel && this.withClear && (index.h("button", { key: '14e138b8afa5bd089bd82b28c01df0625b3fc4c5', type: "button", part: "clear-btn", class: "drf-clear-btn", onClick: () => this.clearDate('to'), "aria-label": "Clear end date" }, index.h("wa-icon", { key: 'e70ae5c2b88dae7bb43a77fa496ecd48ffef9130', name: "xmark" }))), index.h("ir-date-select", { key: '8a59f4e46c6c817a2ebe5703e5696c7fdad273bd', ref: el => (this.toDateSelectRef = el), exportparts: EXPORT_PARTS.to, date: this.dates.to?.format('YYYY-MM-DD') || null, placeholder: "To", minDate: toMinDate, maxDate: this.maxDate, emitEmptyDate: true, class: "drf-date-select", onDateChanged: evt => this.selectDate(evt.detail.start, 'to') }, index.h("button", { key: 'fdd9ae0075a58b96f1da3b5a125299998308b6e7', slot: "trigger", type: "button", part: "cal-trigger", class: "drf-cal-trigger", "aria-label": "Open end date calendar" }, index.h("wa-icon", { key: '79f6d687acb58144e09e353d592d81c02aa0feb8', name: "calendar", variant: "regular" })), this.showQuickActions && (index.h("div", { key: '6bd7626c7fa506c541f618dd9db6461bd5856e37', part: "quick-actions", class: "drf-quick-actions", role: "group", "aria-label": "Quick end date options" }, this.quickDates.map(action => (index.h("ir-custom-button", { type: "button", variant: "neutral", appearance: "outlined", "aria-label": `Set end date to ${action.label}`, disabled: this.quickDatesMode === 'range' ? false : this.dates?.from?.isSameOrAfter(action.getDate(), 'date'), onClickHandler: () => {
            ...
            } }, action.label))))))), index.h("span", { key: '5282018c6f198f7faec3340caac2ecb416f3526c', "aria-live": "polite", "aria-atomic": "true", class: "sr-only" }, this.liveMessage))));
    }
