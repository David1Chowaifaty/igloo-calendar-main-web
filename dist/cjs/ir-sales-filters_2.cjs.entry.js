...
const IrSalesFilters = class {
    ...
    render() {
        return (index.h("div", { key: '4aaef3dd154471e4853c6fde7dd9d1614cae54f1', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: '367353eb59e1ef03a11329f975b52e4f869add42', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: 'ff80cdb123a77d301393c8170bed1ffb81026d64', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '9505719cf96fe17c4ab3ce94a9824be035fe8406', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '965277809e62bf6948db0c9af9ecc65ccdb1fc33', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: 'b67f002b427becab1fab8ad3de7f338acc2e2633', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '9b698c89a4169f2abaecdf3e89daf2ee49c19a53', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#salesFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "salesFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: '14c5cbcb2d42cae2bd53bfa562443d5268e460aa', class: "m-0 p-0 collapse filters-section", id: "salesFiltersCollapse" }, index.h("div", { key: '6cf8f36d78d2088e0735904cb093e2bac4201e4f', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '13eacdad80da75eb41c6e43a1d500975eb1e3b02', class: "pt-1 filter-group" }, index.h("label", { key: '057f984d9322295ff9b09152cc976ee1af8a6043', htmlFor: "rooms", class: "m-0 p-0" }, "Rooms"), index.h("ir-select", { key: '421ec5b203902161ffaac754aa4c8fc3da6e2999', select_id: "rooms", LabelAvailable: false, showFirstOption: false, data: [
                { text: 'Booked', value: '001' },
                { text: 'Stayed', value: '002' },
            ] })), index.h("fieldset", { key: '1eea44552a4bd2c6bac6d3804026fba5d14b07e1', class: "pt-1 filter-group" }, index.h("label", { key: '14743cf2ce24fb8181344dbb96fc02f0eb1a8a23', htmlFor: "period", class: "p-0 m-0" }, "Selected Period"), index.h("div", { key: '1e7e2a399d6a017ebd0ec801e10b4f08986f8e08', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: '138dd405fd1c534257b3248c3658dc0d9d218f68', select_id: "period", LabelAvailable: false, showFirstOption: false, data: [
            ...
            ] }), index.h("p", { key: '6b155b9a5995159bc65244c8ce0c74e1b3e83b1f', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: 'ae3cb3d928e63bc2f966dee743c9ff4b1cdda911', withOverlay: false }))), index.h("div", { key: '768c89abb65409643de7898397a288c33c13de36', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: 'a823affd658ceacff8cd72b2c78d11137af7c093', htmlFor: "compare-prev-year" }, "Compare with previous year"), index.h("ir-checkbox", { key: '648f271bc1900bd992895cb54dd4f38ddb0dff6e', checkboxId: "compare-prev-year" })), index.h("div", { key: 'c309f2e87a1b80e2ee9e66b74eb4ceabb32e3cae', class: "d-flex align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: '3a36c66bee44b2271d6260b170ece0292f1ebf4e', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '5f50769c089771c223f76b8d0744ead962425601', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
