...
const IrSalesFilters = class {
    ...
    render() {
        return (index.h("div", { key: '448eba54eababb530c9ad565e9e50136385ba4c8', class: "card mb-0 p-1 d-flex flex-column sales-filters-card" }, index.h("div", { key: 'cee83c232f397f7e9bcc186af89376aadb5110f1', class: "d-flex align-items-center justify-content-between sales-filters-header" }, index.h("div", { key: '7a84cce106101da65e11a3fad181eae3c9932368', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("svg", { key: '6584b5609bf7b816e47f7621a801369e0ddc641a', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '0c6ba1fc927e817d39c251c01fc9175edec393be', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), index.h("h4", { key: '3171c169f300ac8e2f17b226c8548b840bc96c3f', class: "m-0 p-0 flex-grow-1" }, locales_store.locales.entries.Lcz_Filters)), index.h("ir-button", { key: '90af633464c9d8ab8ac77d9c4736e0e959d49f5e', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#salesFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "salesFiltersCollapse", class: "mr-1 collapse-btn toggle-collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), index.h("div", { key: 'b811c5adf48190ef41b35cf657384215bb4c83ed', class: "m-0 p-0 collapse filters-section", id: "salesFiltersCollapse" }, index.h("div", { key: '157d20a9ef233a388d8e2e1906a573e6ad8a0698', class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("fieldset", { key: '81f544006136b841d5c8de220934f1a32bf9712b', class: "pt-1 filter-group" }, index.h("label", { key: '9dc254b3e90e2f304e17f9c2407135809a66cf3c', htmlFor: "rooms", class: "m-0 p-0" }, "Rooms"), index.h("ir-select", { key: 'f7d543766b6eaf615037bbe70a2933ede3a20f7a', select_id: "rooms", LabelAvailable: false, showFirstOption: false, data: [
                { text: 'Booked', value: '001' },
                { text: 'Stayed', value: '002' },
            ] })), index.h("fieldset", { key: '19a91b5f0360d472bce2610502d51995b050a8dd', class: "pt-1 filter-group" }, index.h("label", { key: '916c4b74d4e13096565cb73640b0ff1c618a214b', htmlFor: "period", class: "p-0 m-0" }, "Selected Period"), index.h("div", { key: '31256baefbdb712cfb15bde612cefe4f567ac679', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: '550b4a537505eb3d714f72c87e0450f14dc87bbc', select_id: "period", LabelAvailable: false, showFirstOption: false, data: [
            ...
            ] }), index.h("p", { key: '27a4eaf7eb60b267f2181b437a1f1b1f76938eed', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: 'd4d422bcefecebeabeca6e0bd2104aff31902abd', maxDate: moment.hooks().format('YYYY-MM-DD'), withOverlay: false }))), index.h("div", { key: '64d5ba764e9ebc02852ea7405885a469014ae810', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: 'c9a5e87d8d3d8ed68766c19e0f6acf675b525f14', htmlFor: "compare-prev-year" }, "Compare with previous year"), index.h("ir-checkbox", { key: 'e51de613a85183601a841b0623b894f3f574acf8', checkboxId: "compare-prev-year" })), index.h("div", { key: '56e5128f50e3dd52597be6aada801d96f7e087f3', class: "d-flex align-items-center justify-content-end filter-actions", style: { gap: '1rem' } }, index.h("ir-button", { key: 'eaf5d44bd9103ab66b766b50b492405eeeecd875', btn_type: "button", "data-testid": "reset", text: locales_store.locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), index.h("ir-button", { key: '623d7b7d5315fc0b3d2710a941b58e07cce2c735', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales_store.locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
};
