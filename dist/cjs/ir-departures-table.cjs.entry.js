...
const IrDeparturesTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7465804e6ce88de529dfff585997ba0405c3806c' }, index.h("div", { key: '9e81b7ed8e74697f9b3f91b8a5d7248361b0ae14', class: "table--container" }, index.h("table", { key: '4811c86c36c0f33abb0e041a4808ecd81d2a6015', class: "table data-table" }, index.h("thead", { key: '2c115348f4cabf201a231623714a62799552c172' }, index.h("tr", { key: '90e8586771ee8f347bb6aad71b1fc79c3fd0daaf' }, index.h("th", { key: 'f725fce839e47113651b7bda18dfb4050bec0660' }, index.h("span", { key: 'a86750a01993045430b48badbab8489ed275fb98', class: 'departures-table__departure__cell' }, "Booking#")), index.h("th", { key: 'afd1dce25bf446d9c8d1eea12d89650ce40c8cbf' }, index.h("div", { key: 'd04f129ee86b33d4d7c9d607ce4375058dd6ad2d' }, index.h("p", { key: '3dd5b3f6d60f63b11507682e17871889b1f932d3' }, "Booked by /"), index.h("p", { key: '920010a0341b2288df63ef62f2a9d877068f5fd7' }, "Guest name"))), index.h("th", { key: '01c6d49ffbe63e103213c570e0784df8582db6f2' }, "Unit"), index.h("th", { key: '2cd7885161feca0b064d7da99f4e38efa49cdaf5' }, "Dates"), index.h("th", { key: 'e88cd523cc53bfc0935fc2b33841a094409de381', class: "text-center" }, "Balance", index.h("div", { key: '57af8eabe2f33029660f7c43da77ebb5a999188d', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: '7e8cb2b9b7a5e6474df0ae670f3f66209adadce2', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), index.h("th", { key: '598934aa298b0e2c1c3ecc41c8ebec12915766c7' }))), index.h("tbody", { key: 'eeaa905afad8663b8abc60b7df49f61cb1fcc4fe' }, this.renderSection({ bookings: futureRooms, isFuture: true }), this.renderSection({ bookings: needsCheckOutBookings, showAction: true }), this.renderSection({ bookings: outBookings }), !needsCheckOutBookings.length && !outBookings.length && (index.h("tr", { key: '938dbc892121a6b7d8a519b549d8530b271f56db' }, index.h("td", { key: '30945132f6ba020c18f56e5b03fca69b7630f352', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '141f9f7fe16e8d249545fd6e5b9ef1e94fe82b23' }))))))), (needsCheckOutBookings.length > 0 || outBookings.length > 0 || futureRooms.length > 0) && (index.h("ir-pagination", { key: 'cb3e581525e3df703d76cecdf8f0ce2bc6423e69', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) }))));
    }
};
