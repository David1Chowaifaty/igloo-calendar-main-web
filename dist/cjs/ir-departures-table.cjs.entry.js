...
const departures_store = require('./departures.store-251f4971.js');
...
const IrDeparturesTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '28ba59bcf87a59854137af9b43a3fc4c97debdf1' }, index.h("div", { key: 'a0ec2ffa8d2cdb13291e0862cad76259015388d7', class: "table--container" }, index.h("table", { key: '448c7778f8f74387baf31cdfeca738d91429ed6e', class: "table data-table" }, index.h("thead", { key: '7069ff661ad8ec54554432e8c5025e653c2e4e73' }, index.h("tr", { key: 'c97aacfdeb6a97ba2ff1876a3eaf8e177bfb5374' }, index.h("th", { key: '35030df112d11eafafef74c4aef30f990654e963' }, index.h("span", { key: '467aef6295667d6ea5ae6381a4d470c6bf816127', class: 'departures-table__departure__cell' }, "Booking#")), index.h("th", { key: '4854ff905c24b75ae4c0ee9da0bbe605ae7ebfdd' }, index.h("div", { key: '0995df413e514bfdf690b1f0c9d5a99c7b4df438' }, index.h("p", { key: '78b58d883bfc93695ed62a92b4bbade36f7e8e95' }, "Booked by /"), index.h("p", { key: '476e248871eaf0e9f31259242861da1334d8649a' }, "Guest name"))), index.h("th", { key: '43baf6ef423ed613c72dff84bcc37318a76bcf10' }, "Unit"), index.h("th", { key: 'fead17435ef9f83ad32a75a6d2434975d8b92a1f' }, "Dates"), index.h("th", { key: '2da5c6a452dba2f0ed83f0bcd7ccb907d56e8cb8', class: "text-center" }, "Balance", index.h("div", { key: '67044e9cfece4fb9ee927f4ae40fa343bf958120', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: '52b11eeff1080aafa58c61608e40e5bfcdbde15a', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), index.h("th", { key: '2af2a990ae199c0ecafcf90d0e262d28d8d12b9c' }))), index.h("tbody", { key: '79fa843026e56e32847b7249546f4850e864a402' }, this.renderSection({ bookings: futureRooms, isFuture: true }), this.renderSection({ bookings: needsCheckOutBookings, showAction: true }), this.renderSection({ bookings: outBookings }), !needsCheckOutBookings.length && !outBookings.length && (index.h("tr", { key: '57004b27d511581e1f1a2ecf124fd4bdeec943a9' }, index.h("td", { key: '73cba415650c697102a791d17d6ed33049aecc56', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: 'd0a87253c23a63c49aedba47cd242a23c4db60b7' }))))))), (needsCheckOutBookings.length > 0 || outBookings.length > 0 || futureRooms.length > 0) && (index.h("ir-pagination", { key: '7e5d46522d244030fb3951e2c199dd19efe22772', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) }))));
    }
};
