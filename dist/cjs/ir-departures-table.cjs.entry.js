...
const IrDeparturesTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '5464de48896a704049178837a7d124bf73d4e008' }, index.h("div", { key: '93f0c3aa9289651aa627da1c7dd4b9d336ab53aa', class: "table--container" }, index.h("table", { key: 'a6bc8291071fd43453abdf948f9ae1e3bb511ce5', class: "table data-table" }, index.h("thead", { key: '39dd9574f63f10bdf2724f61dcdb1c5918ce2237' }, index.h("tr", { key: '9286e1761b70d6a118e37e5b3a8e0e6a44d461af' }, index.h("th", { key: 'e10241944e6714ad19cad88b57fd20860a4d4466' }, index.h("span", { key: '24d9ce959ab8b3bdf30a7d817f1a94c8881d9f99', class: 'departures-table__departure__cell' }, "Booking#")), index.h("th", { key: 'c186b1822faff7486759f08976b2af45bf007606' }, index.h("div", { key: '065ff65313b8686d45afb0816aa4f225040bc851' }, index.h("p", { key: 'ddeb59b47127a4aa98e24b2cfe7f15ad1aa418f3' }, "Booked by /"), index.h("p", { key: '5f359234b13fec9564339246dfc06edc91382a9e' }, "Guest name"))), index.h("th", { key: '3d1168d169cafc49544237e2353369fd4dda8a69' }, "Unit"), index.h("th", { key: 'de30738b351de429035120b69059c82bf7088735' }, "Dates"), index.h("th", { key: '7cac621b1844704144b25e23e9f36578a70de7e8', class: "text-center" }, "Balance", index.h("div", { key: '2949d7fdf1f3a0961ac7a8c2baf01a826bbd0dc5', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: 'f619d26f4aa0ee0bb7439081d1bc071a31b82dbe', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), index.h("th", { key: '13821f653022c5d16146dd58eef9a99ddbb77923' }))), index.h("tbody", { key: '09463bc369c1d81eeba22a8c9589367bc9cc77fc' }, this.renderSection({ bookings: futureRooms, isFuture: true }), this.renderSection({ bookings: needsCheckOutBookings, showAction: true }), this.renderSection({ bookings: outBookings }), !needsCheckOutBookings.length && !outBookings.length && (index.h("tr", { key: '05ec854b35bf24645565f1b7ec0af8367dba78f7' }, index.h("td", { key: '26fa969ea9f8275478f966c6107241d808f1d2a2', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '3c244076423da4de9b7cad2d3d2e7455b3cccbc8' }))))))), (needsCheckOutBookings.length > 0 || outBookings.length > 0 || futureRooms.length > 0) && (index.h("ir-pagination", { key: 'af814feefdde91b75eeec76a16f0eba454297b83', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) }))));
    }
};
