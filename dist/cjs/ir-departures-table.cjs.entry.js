...
const IrDeparturesTable = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd0c7d443ba22c01f4a803ee8b13e8fd00053a491' }, index.h("div", { key: '3c81676c92497a157577fb5e2b79dd197d1a3f39', class: "table--container" }, index.h("table", { key: '3a1dcd1a5b212db38a3e151ee50848955213368a', class: "table data-table" }, index.h("thead", { key: '6bfb8893d507d499dfec4b62d1cf9d7cf8a90a95' }, index.h("tr", { key: 'e3bd69454317f31eb35463def114aaabf0adb821' }, index.h("th", { key: 'ddda3f3e7017ca9cd3fe8e687788b8f0fef4b076' }, index.h("span", { key: 'b99678dbcd9b6da3ca57ac9b7929457f2cbcb545', class: 'departures-table__departure__cell' }, "Booking#")), index.h("th", { key: 'b6ac11f71c8eb4602992cffee2765fabd5edb04d' }, index.h("div", { key: '2de65643a8ab8f858c9f7d03a595c6eb039f151e' }, index.h("p", { key: 'd4f7dca79fe7955bdc3d64128774a3566c50b78a' }, "Booked by /"), index.h("p", { key: 'ffcdcf20bee8ce06d10fba68169d981a46be8a5f' }, "Guest name"))), index.h("th", { key: 'cdfeb87e6648d19e0f2c76d775f359e428edbe17' }, "Unit"), index.h("th", { key: '4012f1892edaef1016ac2240acb0cd3133c6a985' }, "Dates"), index.h("th", { key: 'a910911d369a6c002913685c795e5b7e7903d12d', class: "text-center" }, "Balance", index.h("div", { key: '55d8e44f84462473ea95d1408d7bea528adf8c6c', style: { width: 'fit-content', marginLeft: 'auto', marginRight: 'auto' } }, index.h("ir-custom-button", { key: '8d991258eed793646cd4cf0103793040bef1c4cf', id: "balance-info", style: { '--ir-c-btn-height': 'fit-content', '--ir-c-btn-padding': '0.25rem', '--ir-c-btn-font-size': '0.725rem' }, size: "small", variant: "danger", appearance: "outlined" }, "Click to collect"))), index.h("th", { key: 'd4f7554f23d54533abd0c021c8a691c968f61967' }))), index.h("tbody", { key: '96a9b1a38a2485ac442bb3bbbe6125017fd247c0' }, this.renderSection({ bookings: futureRooms, isFuture: true }), this.renderSection({ bookings: needsCheckOutBookings, showAction: true }), this.renderSection({ bookings: outBookings }), !needsCheckOutBookings.length && !outBookings.length && (index.h("tr", { key: 'e5c24201de8de978333b28a38ad4544c4a754258' }, index.h("td", { key: '7b2bcfab54f8d9eb25d370d11274c280dd0e03af', colSpan: 6, class: "empty-row" }, index.h("ir-empty-state", { key: '45925294a4a913820fcfe8a4341a43de9e73cd06' }))))))), (needsCheckOutBookings.length > 0 || outBookings.length > 0 || futureRooms.length > 0) && (index.h("ir-pagination", { key: '029b69799062cafec08d42fb35cd6827fc75aac1', class: "data-table--pagination", showing: pagination.showing, total: pagination.total, pages: pagination.totalPages, pageSize: pagination.pageSize, currentPage: pagination.currentPage, allowPageSizeChange: false, pageSizes: [pagination.pageSize], recordLabel: locales_store.locales.entries?.Lcz_Bookings ?? 'Bookings', onPageChange: event => this.handlePageChange(event), onPageSizeChange: event => this.handlePageSizeChange(event) }))));
    }
};
