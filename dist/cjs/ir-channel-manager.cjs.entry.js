...
const IrChannelManager = class {
    ...
    render() {
        return [
            index.h("div", { key: '8d4ada6aaacd85a2931a01825867b38749edfde6', id: "container" }, index.h("div", { key: '8006c60935180226ceab4beec5ad2585e074146b', class: "card" }, index.h("ir-topbar", { key: '1fdf0259ff29e1f0ca4d689f0519a2fa574516da' }), index.h("ir-list-item", { key: 'ebdcab8d5af1f95bb8caac3cb977fc55ede5723c', id: "ir-list-item", listData: this.listData, dropdownData: this.dropdownData }))),
            index.h("ir-sidebar", { key: '493dd41b8e56d65f68c1585a01e3bf1ecb7d445c', side: "right", class: "" }, index.h("div", { key: 'dca77faeb93751c56b0bee4fe822caf29aad88c0', class: "container pt-1" }, index.h("h5", { key: '51a81567034efe5dcdf0ce21fc07dc2fb1acab88', class: "font-weight-bold" }, this.mode === 'create' ? 'Create' : 'Edit', " Channel")), index.h("ul", { key: '0aa7937cd8898669298ea10d820dd795874a136e', class: "list-group list-group-horizontal mb-2" }, this.tabs.map(tab => (index.h("li", { class: this.activeTab === tab ? 'active' : '' }, index.h("a", { class: "", "data-mdb-ripple-color": "dark", onClick: () => {
                ...
                index.h("ir-mapping", { hostRoom: this.hostRoom, class: "mb-3", mapReference: this.mapReference, map: this.mode === 'edit' ? this.selectedItem.RoomsMapping : null }))), index.h("div", { key: 'eb37c655e85d2eeba062752887be0383db724aa1', class: "btn-position" }, index.h("button", { key: '2f8c81c47b0747122fa3fbf23dcf4f4bd5c15190', type: "button", class: "btn btn-primary btn-sm btn-block", onClick: () => this.goNext() }, this.activeTab == 'General Settings' ? 'Next' : 'Save'))),
            index.h("ir-modal", { key: 'eaba7d79c4d92e764220324117b143955ca1185f', class: 'exit', modalTitle: "Exit without saving?", modalBody: "All unsaved changes will be lost.", iconAvailable: true, icon: "ft-alert-circle warning h1" }),
            index.h("ir-modal", { key: '351a65305efcf514db6ade906d18fdf3c1c8f01a', class: "alertModal-manager", modalTitle: "Please fill all the fields!", modalBody: "There are fields that are not filled yet.", icon: "ft-alert-circle warning h1", iconAvailable: true, leftBtnActive: false, btnPosition: "center", rightBtnText: "Close", rightBtnColor: "primary" }),
        ];
    }
};
