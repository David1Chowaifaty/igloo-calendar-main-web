...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '5c8a3b5e0ef703aca882d1be29d32094ea21610f', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'de6bcc7811cf0ecfd261d0048d24fe273e343ee2', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '50d405635cc74b7dbaaf9842db2a4d074b5b0ab0' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '76446e61119b17d291d40c8916b2408f5faeeb44', class: "loadingScreenContainer" }, index.h("div", { key: 'f281d9d5bc5bbbf180a9df951b928d8867916da3', class: "loaderContainer" }, index.h("span", { key: '83889d9f6b773297a81d0a0935f6c90b631bf792', class: "page-loader" }))))));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '987b9ed08aec1bd8bb3cdf0f3e4fcc60d192874a', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: '1c259d707466ebe3edb5818b812b1103aaa318ac', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '93319e1d59a2cbf340c20ade36fe5f60d3f6576b', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: 'a202a0ee50ad6ba72c250992ca1f65a2b407b85b', class: `ir-alert-header` }, index.h("p", { key: '7750ad708e9f1d116918debb05bbcd28b28677fe' }, this.modalTitle))), index.h("div", { key: 'f4f7a79925be0b5cf989565c27e920da9187924e', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '35c28b0bc57488e33944fcfdc4aa13eba1251838' }, this.modalBody)), index.h("div", { key: '4521c42fe9acc26066bc221a08f9a6f513a3a3bc', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: '5c5b852a3d88a1358dca060b199cfe3ce6bf72b0', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'f02841bb5597286edc41cdada7144342560a9d03', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrResetPassword = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '30948a42daf47acbc3cd29cb0de1fb3a52383e71', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, !insideSidebar && (index.h(index.Fragment, { key: 'c327435e7924b3c82b4639847253408c5941915d' }, index.h("ir-interceptor", { key: 'a440ad15e25b0dafc72a7af90d89ff98ceb25a74', suppressToastEndpoints: ['/Change_User_Pwd'] }), index.h("ir-toast", { key: 'b535d06c04d6fdca4fc550e362998b6306b05c94' }))), index.h("form", { key: '8ff885400a9ed18f1b32d12fe3020c57262f9ad1', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && index.h("ir-title", { key: '1e7ea4a7164ccc99d94afafc29de20c56c56b057', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), index.h("div", { key: '289f5f9325a2352cbed5ad66ba71cd2747146e18', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, index.h("svg", { key: '1e3173db245593452dffaf95d236b29d7f89c597', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, index.h("path", { key: '10b0040ed7ec9e75e8dd3be8b863461cc0f1c196', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), index.h("div", { key: '0739e36493278ac50fc9f9c1b8c72852177b0476', class: "text-center mb-2" }, index.h("h4", { key: '607b99a6f137d800014e09918c3220e6fb8306a5', class: "mb-1" }, "Set New Password"), this.submitted ? (index.h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (index.h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (index.h("section", { key: 'ba90e47d46b08b45f1932678c511186ba7259f8d' }, index.h("div", { key: '5737505b90e68684b5235d4f8df0aac1ac37465e', class: 'mb-2' }, index.h("div", { key: '732dac8272eca5eac6dc574d59f58d3a52549b76', class: "m-0 p-0" }, index.h("div", { key: '10c367d4c9964ab49e9ebb907344a4a75bc52ab2', class: 'position-relative' }, index.h("ir-input-text", { key: 'a14bc5ea56498a33f3911092dde68db478d065a1', error: (_a = this.error) === null || _a === void 0 ? void 0 : _a.password, autoValidate: this.autoValidate, value: this.password, onTextChange: e => (this.password = e.detail), label: "", class: "m-0 p-0", inputStyles: 'm-0', zod: this.ResetPasswordSchema.pick({ password: true }), wrapKey: "password", placeholder: "New password", onInputFocus: () => (this.showValidator = true), type: 'password' })), this.showValidator && index.h("ir-password-validator", { key: 'ef8486d61e134e3b9c982c649de86fceb3d4a819', class: "mb-1", password: this.password })), index.h("div", { key: 'd2ab754be201a3c1c8763b05692cea389f32b253', class: 'position-relative' }, index.h("ir-input-text", { key: 'a5e9c76fc852acc99234480951af384558e0d9c2', error: (_b = this.error) === null || _b === void 0 ? void 0 : _b.confirm_password, autoValidate: this.autoValidate, zod: this.ResetPasswordSchema.pick({ confirm_password: true }), wrapKey: "confirm_password", value: this.confirmPassword, onTextChange: e => (this.confirmPassword = e.detail), label: "", placeholder: "Confirm password", type: 'password' }))), !insideSidebar && (index.h("div", { key: '97723cf3a9b519036fe3409e3609895786a633c4', class: "d-flex flex-column mt-1 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, index.h("ir-button", { key: '17ba53d21a2080d8c5130ea5be59055763518af5', btn_styles: 'flex-fill', onClickHandler: () => window.history.back(), class: "flex-fill", text: 'Cancel', size: "md", btn_color: "secondary" }), index.h("ir-button", { key: '66fdad8d2fa2a255a844e0c8a68eb999246a3495', btn_styles: 'flex-fill', class: "flex-fill", isLoading: this.isLoading, btn_type: "submit", text: 'Change password', size: "md" })))))), insideSidebar && (index.h("div", { key: '3c535d4766f2024e5fc2540f41b75b93a5203eae', class: 'sheet-footer w-full' }, index.h("ir-button", { key: 'f497d722a013fd287428bbbb503d6d277f40893c', text: 'Cancel', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_color: "secondary", btn_styles: "w-100 justify-content-center align-items-center", size: "md" }), index.h("ir-button", { key: '6f367774cf308e9af4af6c48039932b10880537d', isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: 'Change password', size: "md" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '4d27e2e42fb410dea9bd938daa94e1dbcad897f1', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '402b622dde78cadfedf851f91ddbe13e8fbb2186', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '2ca66cbde7a98f997c7c00e3d3e919a4a22702fd', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '0062180d877c2d4fb95611fb4ac4f2d91a1771bd', class: "input-group row m-0" }, label, index.h("select", { key: '933004ad56e0b5f0d5278d57376e115ff21ccf62', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '0045adf2c6f7fce4eb682c54d83074e79046b69f', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '63f7287dd4341b96cda710df01ba169993ad10fe', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '313eb960ec5586d6349783f5804bf227deb9af48', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '31e4fbf608821913004197e12515c18457f1b9fc', class: 'sidebar-title' }, index.h("p", { key: '7e254326becdcc33c101077dbc08672b4ac5c4d7', class: 'p-0 m-0' }, this.label), index.h("div", { key: '54929185cdc5652c1a3f1f2f3e9a149780d2b719', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'f546f49bf6127f5d864609d1b7797a95c65abbce', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '2e8bbd577f6ca2f5fcea49cc0b5c3f88ee073895', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '6f4199b74c821c0b407f9bbd5440d72ee76714b2', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: 'cf9402b5be2ebaa0cc0f96c800d111340803e348', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '41d18e6c3d82ae1a077dc9ff65b1bf774cacda7a' }, index.h("button", { key: '069132c32799887789ac41defea8e241be7f9698', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: 'b9da42717931edbde9efcfd1b4c46fdf62e7c620', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: 'ec9d73d8c149a9328e5a4ef8c96b4ba35c7d0c87', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f901cb0b37b56f57d7062d751b7a3f0b9715683b' }, index.h("h4", { key: '890100280623be18ef5fcb3bc906cd37d9f6046e', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: '5a5f6f5f3e3e43ed5ad62c48235ee825cf8d85d0', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '5f2ea0b69e76229b8787f5656ad041190c78d9c8', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'bb150fe0a18d7d9202c715cac90df70b479d8474', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'a27aa6e412323a7d6ce6f90fbd591881e16f8327', class: 'title-body' }, index.h("slot", { key: '01fb195c0a2af49b6e6c32274d427234c716e626', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: '1bc471aa1e4c56d71ba4d59d3a798fb46289b3fd' });
    }
...
const IrUserFormPanel = class {
    constructor(hostRef) {
        ...
        this.userSchema = index$2.z.object({
            mobile: index$2.z.string().min(1).max(20),
            ...
            type: index$2.z.coerce.string().nonempty().min(2),
            username: index$2.z
                .string()
                .min(3)
                .refine(async (name) => {
    ...
    render() {
        ...
        return (index.h("form", { key: '864bf7e85909be4d31ac8fe3dd7a44664527ce54', class: "sheet-container", onSubmit: async (e) => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: '47d796cc413bd75139605ddab942c16efb394715', class: "logins-history-section mt-2" }, index.h("div", { key: '97e4251f6657c1ad1eff0000e165702456cb7b8a', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '8c011011c5c96861ac10f2ed18e379c896bb9780', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: '01fd000cfcd79c3fe33a80cb447b672f21404f96', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: 'e40f88828777dc67fc553e59d4d5ac776d1fa4e8', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: 'fdcc2fb5570a359df65c39305e57cecb775a349b', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: 'dd31a747bcabc4e9f21449b79d73c07facb6806f', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: 'c226220b8b55180481037a9530e01df4b9a206d3', class: "sheet-footer" }, index.h("ir-button", { key: '52424c09548caf51855483eed5d0d49001edac82', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '9e5937f6282bfcdb6e61e45d51b64e155d56b8d3', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagement = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-toast", null), index.h("ir-interceptor", { suppressToastEndpoints: ['/Change_User_Pwd'] }), index.h("section", { class: "p-2 d-flex flex-column", style: { gap: '1rem' } }, index.h("div", { class: "d-flex  pb-2 align-items-center justify-content-between" }, index.h("h3", { class: "mb-1 mb-md-0" }, "Extranet Users")), index.h("div", { class: "", style: { gap: '1rem' } }, index.h("ir-user-management-table", { allowedUsersTypes: this.allowedUsersTypes, userTypeCode: this.userTypeCode, haveAdminPrivileges: ['1', '17'].includes((_a = this.userTypeCode) === null || _a === void 0 ? void 0 : _a.toString()), userTypes: this.userTypes, class: "card", isSuperAdmin: ((_b = this.userTypeCode) === null || _b === void 0 ? void 0 : _b.toString()) === '1', users: this.users })))));
    }
    static get watchers() { return {
...
const IrUserManagementTable = class {
    ...
    renderCurrentTrigger() {
        ...
        return (index.h("ir-user-form-panel", { allowedUsersTypes: this.allowedUsersTypes, userTypeCode: this.userTypeCode, haveAdminPrivileges: this.haveAdminPrivileges, onCloseSideBar: () => (this.currentTrigger = null), slot: "sidebar-body", user: (_a = this.currentTrigger) === null || _a === void 0 ? void 0 : _a.user, isEdit: (_b = this.currentTrigger) === null || _b === void 0 ? void 0 : _b.isEdit }));
    }
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: '6a52d74b4e5e4893ede8133f2faafd4cdba00169' }, index.h("section", { key: '7b64964ef655f6666c96d4b967d6f6a50573c071', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '50cab2ff3cc0728c59bcde4d4752d9457bdedf55', class: "table" }, index.h("thead", { key: 'd8a6aee372bdba2ff4eb93bad9037b35c6e8ba28' }, index.h("tr", { key: 'fe96d5e5efab07610f53815d0d5a7aad5595d481' }, index.h("th", { key: 'c7c12f6deaf2bae5695a78e4c67bd14a8a0c710b', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '5f03ccae30b32bb83648b5bc58e569b2444e5b8e', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: 'f09b8e15624883c81b7180475e0cf5ee540f863d', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: 'c4b833a95bf8464f5c05cb93eed8a558a7cb4be3', class: "text-left" }, "Role"), index.h("th", { key: '0267e22fa164e4ee3555d8285db48c3d55345122', class: "text-left" }, "Last signed in"), index.h("th", { key: 'a520e912f035ccb2fdc048640be5335cb8219b56', class: "text-left" }, "Created at"), this.haveAdminPrivileges && index.h("th", { key: 'c348440007faab6dfa9039e5059e209dd7306178' }, "Active"), this.haveAdminPrivileges && index.h("th", { key: '4c020ac2ecf7ac9e7ab6474615887a43811b93e0' }, "Email verified"), index.h("th", { key: '4e77582a6924253a78da0b622e18d05462f7ae0e', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: 'cf883cb9f83b92bc6b67048e6aab54b2c48449c0', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: 'ef8377c50e9a3b86d7ba099fbc8290cac9f0ba7b', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '9640da68782ae36e75a698be012e9f9148be34d7', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: 'cd30f0103dec8c8542ae66169e317e6d4c5c9295' }, this.users.map(user => {
            var _a;
            ...
            return (index.h("tr", { key: user.id, class: "ir-table-row" }, index.h("td", null, user.username), index.h("td", null, user.email), index.h("td", null, (_a = user.mobile) !== null && _a !== void 0 ? _a : 'N/A'), index.h("td", null, this.userTypes.get(user.type.toString())), index.h("td", null, latestSignIn && new Date(latestSignIn.date).getFullYear() > 1900
                ...
                ? null
                : !isUserSuperAdmin && index.h("ir-switch", { onCheckChange: e => this.handleUserActiveChange(e, user), checked: user.is_active }))), this.haveAdminPrivileges && (index.h("td", null, index.h("button", { class: `m-0 badge ${user.is_email_verified ? 'badge-success' : 'badge-danger'}` }, user.is_email_verified ? 'verified' : 'not verified'))), index.h("td", { class: 'action-row' }, (this.canEdit || this.canDelete) && ((!this.isSuperAdmin && !isUserSuperAdmin) || this.isSuperAdmin) && (index.h("div", { class: "icons-container  d-flex align-items-center", style: { gap: '0.5rem' } }, this.canEdit && (index.h("ir-icon", { "data-testid": "edit", title: locales_store.locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
                    this.currentTrigger = {
                        type: 'user',
                        isEdit: true,
                        user,
        ...
        })))), index.h("ir-sidebar", { key: '134d3b3a3298acf6518c50e07fe1eec80a202550', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: '74062ea624961100bff06ce10401d2154fc77d47', autoClose: false, modalBody: `Are you sure you want to delete ${(_e = this.user) === null || _e === void 0 ? void 0 : _e.username}?`, rightBtnColor: "danger", isLoading: irInterceptor_store.isRequestPending('/Handle_Exposed_User'), rightBtnText: locales_store.locales.entries.Lcz_Delete, onConfirmModal: this.removeUser.bind(this), ref: el => (this.modalRef = el) })));
    }
    static get watchers() { return {
