    ...
    async getChannelSales(isExportToExcel = false) {
        try {
            ...
            if (shouldFetchPreviousYear) {
                const previousYearSales = await this.propertyService.getChannelSales(Object.assign(Object.assign({ AC_ID: this.propertyID ? this.propertyID.toString() : undefined }, filterParams), { LIST_AC_ID: this.propertyID ? null : LIST_AC_ID, FROM_DATE: moment.hooks(filterParams.FROM_DATE).subtract(1, 'year').format('YYYY-MM-DD'), TO_DATE: moment.hooks(filterParams.TO_DATE).subtract(1, 'year').format('YYYY-MM-DD') }));
...
const IrSalesByChannelTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f32c37e752f9ef566d5a6e0bef32c6a7ce4ea3f8', class: "table-container h-100 p-1 m-0 mb-2 table-responsive" }, index.h("table", { key: '01fbf98c12877c60726b655a56d136054000f15b', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: '842c7a0315f76b26ce86dbec539648099a33ec73', class: "table-header" }, index.h("tr", { key: '30d9af3e10a6894cee7b4c0caf3ac17559e3292f' }, index.h("th", { key: '55d054e4bff706b9439dbbdaa1c8e10f19a916d3', class: "text-left" }, "Channel"), index.h("th", { key: 'd2f4511f5d1a9da2facf64d03cb902a16ddc5ab6', class: "text-center" }, "Room nights"), index.h("th", { key: 'd293bace587a5da18b9ec4a20a7edb45b5a77aad', class: "text-right" }, "Room Revenue"), index.h("th", { key: '988406543529a426efcd62540026680bd54fc1d2', class: `sales-by-channel-table__progress-col ${!isSingleProperty ? 'single' : ''}` }))), index.h("tbody", { key: 'eb9653dc078f537c566ecb1c9c586de1355645a3' }, this.records.length === 0 && (index.h("tr", { key: '2d0366e118ad721cd4e9b2844716420ccdb2be8f' }, index.h("td", { key: '14a791313774e8e3e4648700113ca11f6055cf3a', colSpan: 5, style: { height: '300px' } }, "No data found."))), visibleRecords.map(record => {
            var _a, _b, _c, _d, _e, _f, _g;
        ...
        })), isSingleProperty && (index.h("tfoot", { key: '99975691c9f508682bc941f60156dac910d442cf' }, index.h("tr", { key: '652cea05ce4ce50359715863bf34bd0c3dba33fe', style: { fontSize: '12px' } }, index.h("td", { key: 'de2655a5c9aef285b6e93586a95b025a1ea0a812', colSpan: 4 }, index.h("div", { key: '8a9c70877c0c34b187193cc42de0056b613d9a13', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: 'b8cd86437617f21511f2bda270a2edecb6ff37d4', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: '43fed4d51323cfc4733c7cc183e9ea49aa9baae6', class: "legend bg-primary" }), index.h("p", { key: 'e3815c87230cf55dc0602b2e3cf9a225ed62bd6e', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '47902cff9be84724451607c97fec77e43bfa6986', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'f3f72b40c52ccde2508439bb558e456fcbeddd15', class: "legend secondary" }), index.h("p", { key: '191d6ab36954ba83692e9749a8e2b33f10119b58', class: "p-0 m-0" }, "Previous year")))))))), this.visibleCount < this.records.length && (index.h("div", { key: '39694e8c97b0a5beb4eb1d1e0c5a276e3592da97', class: 'd-flex mx-auto' }, index.h("ir-button", { key: '3c9ddf1132e511188e50b9cb08e89ccfa8e04992', class: "mx-auto", size: "sm", text: "Load More", onClickHandler: this.handleLoadMore })))));
    }
    static get watchers() { return {
