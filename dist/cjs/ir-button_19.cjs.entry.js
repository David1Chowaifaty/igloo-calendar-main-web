...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '87c61cf798fd976eee8fdfbec1004c36533b8621', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'cc73f4b932263a6723d0c329c9944d42f5ec617d', name: "icon" })));
    }
};
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '009bc108c559cc5e45e9e0371c0413bb6a684463', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: 'c8ff49af54c2e031be3d3115277520d47f2e7f5a', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: '07906af5386c1eebcdbf9b59ea1c39db3489fd20', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: '300f96c8acef018019e93f71e4488a31dad9f088', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-input-text", { key: 'c1f591163180a937e657da592967e479a86c3c9d', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: "Mobile", mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === '1') || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "User type", data: [
                { text: 'Frontdesk', value: '16' },
                { text: 'Property Admin', value: '17' },
            ], selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), index.h("ir-input-text", { key: 'e08495b57b646f2ea6cf79d07474ac6f5183316e', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_h = this.errors) === null || _h === void 0 ? void 0 : _h.username, label: "Username", disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), !this.user ? (index.h(index.Fragment, null, index.h("ir-input-text", { testId: "password", autoValidate: this.user ? (!((_j = this.userInfo) === null || _j === void 0 ? void 0 : _j.password) ? false : true) : this.autoValidate, label: 'Password', value: this.userInfo.password, type: "password", maxLength: 16, zod: this.userSchema.pick({ password: true }), wrapKey: "password", error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
            ...
            (((_l = this.user) === null || _l === void 0 ? void 0 : _l.type.toString()) === '17' && ((_m = this.userTypeCode) === null || _m === void 0 ? void 0 : _m.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_p = (_o = this.user) === null || _o === void 0 ? void 0 : _o.sign_ins) === null || _p === void 0 ? void 0 : _p.length) > 0 && (index.h("section", { key: '94f3ef09c4c8703e7fb01b923044b82dc83ff3ba', class: "logins-history-section mt-2" }, index.h("div", { key: '6e00ad18846e9ecccb6b0ecec24830fb5b475d29', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '5b90bcf180a38a1643187e43c2c9e99efdd9b338', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: '6dfca6b9ec3799f2eb235939d0c717adbd93562c', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: 'e127a6aadc9e1ef77bc69550ad006c21eb5f1544', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: '4736963039d83e8b8897b399e3cc651f4a3cc89e', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '92da2ba6918d74773e5c99c2272e6c26ead4807a', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: 'a31f34f5cd1ff397988252940d1e3ebdf4ae4aea', class: "sheet-footer" }, index.h("ir-button", { key: 'd32e75a48c54615707a2b692b86a0b802291fba6', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '7dad6274d586a8dd87969d01242d0ceddd9447cf', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
