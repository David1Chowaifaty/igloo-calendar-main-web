...
const IrCheckbox = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'bf0b21e5bc6ea28f86464d10f11559a363560829' }, index.h("button", { key: '51981cca4601fe952a3a27b004accbb8d2483740', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked || this.indeterminate ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (index.h("svg", { key: 'db480ccc1eb5d4f603e51427891be7592e767c99', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '4690197ea4d38f3025c46cbb2c49609bc167a9b0', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" }))), this.indeterminate && (index.h("svg", { key: '78adeeb01f7cb7bc598a1ad13133dfd6e39248e0', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '99876ef320ac5ae23c3b72dd9a323e93948eae70', fill: "currentColor", d: "M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z" })))), index.h("input", { key: 'c3f30b22b65a2d421d600c4853a44221d212a19b', type: "checkbox", indeterminate: this.indeterminate, "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && (index.h("label", { key: 'f2cbab72b8155700d896af1d5078c0b87f39c494', htmlFor: this.checkboxId, class: this.labelClass }, this.label))));
    }
...
const IrFiltersPanel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '43aa22f0a1dc39d661a24598e8db284bc55481a6', class: panelClasses }, index.h("div", { key: '0a21d3d3839d303441937ecd057c26218cfe9ce9', class: cardClass }, index.h("div", { key: '5947dd409a14b66ae38bb50e265adb9dfe6913a8', class: headerClasses }, index.h("div", { key: '2dc5762642af4039ab59ccdd87620058395fe941', class: "filters-panel__title-group" }, index.h("slot", { key: '97be829bcceec751e7f75461f5dff9c4e9da5662', name: "header-icon" }, this.renderDefaultIcon()), this.filterTitle && index.h("h4", { key: '0dbaa8f1c9a96c646b51639d3b366235f29ab73a', class: "filters-panel__title m-0 p-0 flex-grow-1" }, this.filterTitle), index.h("slot", { key: 'a81a659ac0aee44685a80b66d19c8cb0972680fd', name: "header-title-extra" })), index.h("div", { key: '04b657fa86fc1464bc7ab1b4480e28a372f838f6', class: "filters-panel__header-actions" }, index.h("slot", { key: '1256b2e57628f5ae2f754887277200857d2d854f', name: "header-actions" }), this.renderCollapseButton(collapsed))), index.h("div", { key: '8e7cd26f126a3087f625895ce040b1a6604c8a40', id: this.targetId, class: {
                'filters-panel__content': true,
                'collapse': true,
                'show': !collapsed,
            }, "aria-hidden": collapsed ? 'true' : 'false' }, index.h("div", { key: '814a5304aa8f589d614c943eb4e87cf5e3eb184b', class: contentWrapperClasses, style: { gap: this.contentGap } }, index.h("slot", { key: '079b02647a70eaf73b683cedc3c83eff9f97e34a' }), !this.hideDefaultActions && (index.h("div", { key: '620d5355a89671579d31ede676027b872614f493', class: footerClasses }, index.h("slot", { key: 'd35127d9bf572b88299f3cdac90d2b5791d1f655', name: "actions" }, index.h("ir-button", { key: '36ad68e558472736f63f5a21998ebde8ed4fa8f9', btn_type: "button", "data-testid": `${this.actionTestId}-reset`, text: this.resetLabel, size: "sm", btn_color: "secondary", btn_disabled: this.disableReset, onClickHandler: this.handleReset.bind(this) }), index.h("ir-button", { key: '6ecb3bebfc450b6bfa6f4a0efc18fe19359e27ac', btn_type: "button", "data-testid": `${this.actionTestId}-apply`, isLoading: this.isApplyLoading, text: this.applyLabel, size: "sm", btn_disabled: this.disableApply, onClickHandler: this.handleApply.bind(this) })))))))));
    }
    static get watchers() { return {
...
const IrMCombobox = class {
    ...
    render() {
        var _a;
        return (index.h(index.Host, { key: '9381d326d858e2376d4e1f8b8b6bd4f1440716f8', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, index.h("div", { key: '3a33c1e498b728f7a9468c9c6f6e00d9fde9baea', class: "input-wrapper" }, index.h("span", { key: 'd15f06dd9a2499fa9af231154047dd1c7d6c8e8f', class: "prefix-container", "aria-hidden": !this.hasPrefix }, index.h("slot", { key: '4c44b8f174e2248a2340326bffdfcd8483d0f249', name: "prefix", ref: el => (this.prefixSlotRef = el) })), index.h("input", { key: 'ae0d63b13889583103d57a4379da6196e4ea2092', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: ((_a = this.selectedOption) === null || _a === void 0 ? void 0 : _a.label) || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), index.h("span", { key: '77c7fc0c52abf77764d80e60fad25ad127ed4086', class: "suffix-container", "aria-hidden": !this.hasSuffix }, index.h("slot", { key: '466ff0d36d4a6c7d9593a6438d45755734fc4c16', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), index.h("div", { key: '66ed524fdc5ced9b5e2f811a53d9bd8c0414e955', class: `dropdown ${this.isOpen ? 'show' : ''}` }, index.h("div", { key: '479c776492ef970f0e99d93ff7bc85d16fa27b6c', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (index.h("slot", null)) : this.useSlot ? (index.h("slot", { name: "dropdown-content" })) : ([
...
const IrSalesByChannelFilters = class {
    ...
    render() {
        ...
        return (index.h("ir-filters-panel", { key: '58aeea7f41bf6de9653fafc1f0b5de13f98ce0a0', isApplyLoading: this.isLoading, onIrFilterApply: () => {
            ...
            ] }))), index.h("fieldset", { key: 'b81fcfb6d5167d07bff1d209acac249d32280340', class: "filter-group" }, index.h("label", { key: '05dcce13aec45da3cfb0a8170bbd0dc3a6c84bf4', htmlFor: "period", class: "px-0 m-0", style: { paddingBottom: '0.25rem' } }, "Selected period"), index.h("div", { key: '4c960cc66b807ca4ac85ef87258d326234516645', class: "d-flex flex-column date-filter-group", style: { gap: '0.5rem' } }, index.h("ir-select", { key: 'e9d6f89c941f4d272fc3fb07be8f178f482beb1e', selectedValue: this.window, onSelectChange: e => {
            ...
            ] }), index.h("p", { key: '05b80535609df3c060e37880a8d1b35290db3a4a', class: "m-0 p-0 text-center" }, "Or"), index.h("ir-range-picker", { key: '7c86d346b2c0ecd3861619eae079da05ace58dce', onDateRangeChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            }, fromDate: moment.hooks(this.filters.FROM_DATE, 'YYYY-MM-DD'), toDate: moment.hooks(this.filters.TO_DATE, 'YYYY-MM-DD'), maxDate: moment.hooks().format('YYYY-MM-DD'), withOverlay: false }))), index.h("div", { key: '590a2041fdb834093e6a8b4e61025d86ed8f9d01', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, index.h("label", { key: '649e1652f1c431da18a1001a2855264d4a4b5a39', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), index.h("ir-checkbox", { key: 'bd79c883430c7e6cda81c6962b07baeb97f642b5', checked: (_g = this.filters) === null || _g === void 0 ? void 0 : _g.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
...
const IrSalesByChannelTable = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '106ceec2c0d9e49af94ed4e612ed841cf6ecf161', class: "table-container h-100 p-1 m-0 mb-2 table-responsive" }, index.h("table", { key: '0844154c927efb9defb5c6fd05da1ad8a36a5fdb', class: "table", "data-testid": "hk_tasks_table" }, index.h("thead", { key: 'bcf8cdec4b81a70cf2e904a28b302f102ea14cbc', class: "table-header" }, index.h("tr", { key: '4431e98cee99595352a09b6da615d08c201a81b5' }, index.h("th", { key: 'd53aa2f6e17ed14b5242829357ebdaedbf98e052', class: "text-center" }, "Channel"), index.h("th", { key: '0b3a24b958aa65994989ffc207d43bed2c54ed1d', class: "text-center" }, "Room nights"), index.h("th", { key: '197c1a789b39cb48f244ae03eaaf6bd780e0a35c', class: "text-right" }, "Room Revenue"), index.h("th", { key: '6fa165dd0ed61b97381ab96cee92692460089b44', class: "" }))), index.h("tbody", { key: '8faa28bf820f7aa3ca59cf41483ea7c1523d86be' }, this.records.length === 0 && (index.h("tr", { key: 'cb6a069228e67f12b3fd036c30ab7a6276b97c97' }, index.h("td", { key: '8c68e74c63582b2efe9616e0c4a7184c4a33e214', colSpan: 5, style: { height: '300px' } }, "No data found."))), visibleRecords.map(record => {
            var _a, _b, _c, _d, _e, _f, _g;
            const mainPercentage = `${parseFloat(record.PCT.toString()).toFixed(2)}%`;
            const secondaryPercentage = record.last_year ? `${parseFloat(record.last_year.PCT.toString()).toFixed(2)}%` : null;
            return (index.h("tr", { "data-testid": `record_row`, class: { 'task-table-row ir-table-row': true } }, index.h("td", { class: "text-center" }, index.h("div", { class: "d-flex flex-column", style: { gap: '0.25rem' } }, index.h("p", { class: `p-0 m-0 ${((_a = record.last_year) === null || _a === void 0 ? void 0 : _a.SOURCE) ? 'font-weight-bold' : ''}` }, record.SOURCE), ((_b = record.last_year) === null || _b === void 0 ? void 0 : _b.SOURCE) && (index.h("p", { class: "p-0 mx-0", style: { marginTop: '0.25rem', marginBottom: '0' } }, record.last_year.SOURCE)))), index.h("td", { class: "text-center" }, index.h("div", { class: "d-flex flex-column", style: { gap: '0.25rem' } }, index.h("p", { class: `p-0 m-0 ${((_c = record.last_year) === null || _c === void 0 ? void 0 : _c.NIGHTS) ? 'font-weight-bold' : ''}` }, record.NIGHTS), ((_d = record.last_year) === null || _d === void 0 ? void 0 : _d.NIGHTS) && (index.h("p", { class: "p-0 mx-0", style: { marginTop: '0.25rem', marginBottom: '0' } }, record.last_year.NIGHTS)))), index.h("td", { class: "text-right" }, index.h("div", { class: "d-flex flex-column", style: { gap: '0.25rem' } }, index.h("p", { class: `p-0 m-0 ${((_e = record.last_year) === null || _e === void 0 ? void 0 : _e.REVENUE) ? 'font-weight-bold' : ''}` }, utils.formatAmount(record.currency.symbol, record.REVENUE)), ((_f = record.last_year) === null || _f === void 0 ? void 0 : _f.REVENUE) && (index.h("p", { class: "p-0 mx-0", style: { marginTop: '0.25rem', marginBottom: '0' } }, utils.formatAmount(record.currency.symbol, record.last_year.REVENUE))))), index.h("td", null, index.h("div", { class: "d-flex flex-column", style: { gap: '0.5rem' } }, index.h("ir-progress-indicator", { percentage: mainPercentage }), ((_g = record.last_year) === null || _g === void 0 ? void 0 : _g.PCT) && index.h("ir-progress-indicator", { percentage: secondaryPercentage, color: "secondary" })))));
        })), index.h("tfoot", { key: '47df0812cfd60cbac87956735bfc7a71665bdaea' }, index.h("tr", { key: '393e8bb8189b51cc60b64c67d080b68bc1f44152', style: { fontSize: '12px' } }, index.h("td", { key: '00edd9e405d4019b8fe8d4b06e4a30d0c2c9786e', colSpan: 4 }, index.h("div", { key: 'b9461efa5a0b922dfdcf6b85b8b93c2f37fb6e4a', class: 'd-flex align-items-center justify-content-end', style: { gap: '1rem', paddingTop: '0.5rem' } }, index.h("div", { key: '80a7058ff2eed43d0cf3971b8aae3c091eba4698', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'a7cc62133c2b498992dd24071cff6d4e3c5ae983', class: "legend bg-primary" }), index.h("p", { key: '8603c5862b19ae9d47e1954d16cc82bdcbae5336', class: "p-0 m-0" }, "Selected period ")), index.h("div", { key: '4b930e8820184dcd589ad8f74b02fc81f34af67a', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("div", { key: 'eb3eda955fb52875efffb23361b0eb74771c9b7a', class: "legend secondary" }), index.h("p", { key: '8b221c365fc6f95f669ed28d55342a6ccaa3134d', class: "p-0 m-0" }, "Previous year"))))))), this.visibleCount < this.records.length && (index.h("div", { key: '0b0f8f9f7e0ca9e2dad25dea8fbe1aacb08571d4', class: 'd-flex mx-auto' }, index.h("ir-button", { key: '4f605c9b2a760816e6b4811f3d496d2d23bac14d', class: "mx-auto", size: "sm", text: "Load More", onClickHandler: this.handleLoadMore })))));
    }
    static get watchers() { return {
