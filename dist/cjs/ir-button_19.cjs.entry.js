...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '300a64be788aa16153d531c90e62c9bfa03fb7a2', class: "sheet-container", onSubmit: async (e) => {
            ...
            return (index.h("li", { class: "login-entry", key: s.date + '_' + i }, index.h("div", { class: "login-meta" }, index.h("p", { class: "login-datetime" }, moment.hooks(s.date, 'YYYY-MM-DD').format('DD-MMM-YYYY'), " ", functions._formatTime((_a = s.hour) === null || _a === void 0 ? void 0 : _a.toString(), (_b = s.minute) === null || _b === void 0 ? void 0 : _b.toString())), index.h("p", { class: "login-location" }, index.h("span", { class: "login-ip" }, "IP: ", s.ip), " \u00A0|\u00A0", index.h("span", { class: "login-country" }, "Location: ", s.country), " \u00A0|\u00A0", index.h("span", { class: "login-os" }, "OS: ", ua.os.name, " ", ua.os.version))), ua.device.type && (index.h("div", { class: "login-user-agent" }, index.h("p", { class: "ua-device" }, ua.device.vendor || '', " ", ua.device.model, " (", ua.device.type, ")")))));
        })))), index.h("ir-sidebar", { key: '3c01f57152c544cafd55d25cce5d83d121c33501', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '7e183dc5c615cc7ce78009f672f4b9474c5fa411', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '05d96bd06b377f467905fb913e47c5eef4797e23', class: "sheet-footer" }, index.h("ir-button", { key: 'c60cc870524dff0b72b02a4431895d02a2715fca', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'cf5c86edc8f5ea46df50c7af19540818af457add', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
