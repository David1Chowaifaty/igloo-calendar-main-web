...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: 'f009478ce8f5cca00720d285332ea250df07331e', class: "sheet-container", onSubmit: async (e) => {
            ...
            (((_j = this.user) === null || _j === void 0 ? void 0 : _j.type.toString()) === '17' && ((_k = this.userTypeCode) === null || _k === void 0 ? void 0 : _k.toString()) === '17' ? null : (index.h("div", { class: "d-flex align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0" }, "Password"), index.h("ir-button", { btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), index.h("ir-sidebar", { key: '8ee7c3e4ab63b84abcd9c3fcff323ebd20663a18', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '417b314ad0c4bca75f0013d165540aa27c41da8f', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '88baf643c2dc7d654c7392f67b2a7cb7bba75006', class: "sheet-footer" }, index.h("ir-button", { key: '31596c1399e3356c9d9195583bbb3208bab5f5f7', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '670b65abfeaa8a767141d87824b0bd32432f1e28', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: 'f639ace7139a16d392f43b5f1da15609b63b9475' }, index.h("section", { key: '3197ea1cd611893f4519333db64eeea224cc64c3', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '68a684186e00777c925a035a0fd36889078e9aeb', class: "table" }, index.h("thead", { key: '6c75d5f0cbeb9b0d84dfe290c87e5e348e13c545' }, index.h("tr", { key: 'f5972ae6285028b328a9dde4668ad71424d4033e' }, index.h("th", { key: '8218404f84497755438d0cb2769674310b6ff9cf', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: '7d9dc00a864e04a7f92ce7ea5aea1c4454bfe97b', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: 'db02bc57cd97bd00e28c977ae915f24107eab8b1', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: 'b2b1fded4f278f7d494a13ecfaf37aa88a117a41', class: "text-left" }, "Role"), index.h("th", { key: '556b6908f11ccf5f710382db7ddd00a72ab5b8fb', class: "text-left" }, "Last signed in"), index.h("th", { key: '61ae9699717c8eab155665b4d6deb4c2aef87251', class: "text-left" }, "Created at"), this.haveAdminPrivileges && index.h("th", { key: '7986083c5f0b041d1c0e7fd7ab3d719ea9c2635c' }, "Active"), index.h("th", { key: '589758f215715c50522a1266cccd10b4bd89de8f', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '864cd71230b6be34d46d728a964b73690161c387', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: 'c1f6e9d12831ec628bfffb13cc46ecbe7cb72319', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: '7fe20e72ce344b01961cd8faeed34db4a7c889f6', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: '77f39438beb9bf9da7ce65b754db87a6a2da61c3' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: 'eabb7ddaac129c65cdd2217171607c9471539b21', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: 'e7cfa16a4b5b9611bbf3fa5eca8ea455fab3a5e5', autoClose: false, modalBody: `Are you sure you want to delete ${(_e = this.user) === null || _e === void 0 ? void 0 : _e.username}?`, rightBtnColor: "danger", rightBtnText: locales_store.locales.entries.Lcz_Delete, onConfirmModal: this.removeUser.bind(this), ref: el => (this.modalRef = el) })));
    }
    async removeUser(e) {
        try {
            e.stopImmediatePropagation();
