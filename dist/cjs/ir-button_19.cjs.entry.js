...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4d777471ffc9c4011a3c269bb10356b48e69733d' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '3ee3c569ece1e79c6a14cf4b0ceb3333e4dd480b', class: "loadingScreenContainer" }, index.h("div", { key: '2127a0896597c30ce15259c32a8dbbaaf4781c8d', class: "loaderContainer" }, index.h("span", { key: '95d4666aa3fe8d3b109c6f4807fff0f941bf2603', class: "page-loader" }))))));
    }
};
...
const IrUserFormPanel = class {
    constructor(hostRef) {
        ...
        this.userSchema = index$2.z.object({
            ...
            type: index$2.z.union([index$2.z.literal(1), index$2.z.literal((_a = this.superAdminId) !== null && _a !== void 0 ? _a : '5'), index$2.z.coerce.string().nonempty().min(2)]),
            username: index$2.z
                .string()
                .min(3)
                .refine(async (name) => {
    ...
    render() {
        ...
        return (index.h("form", { key: '3b52e2981f8ccc17b533aacf8282cda4b37bc213', class: "sheet-container", onSubmit: async (e) => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: 'c5c661f057521a89775cbea1fc0dc3ee96a80100', class: "logins-history-section mt-2" }, index.h("div", { key: '00ea4ae0111146afdc93b9b2490da8c3e158bda6', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '85d3ef5a2836878b0692e82a1a89e643ccbd52f6', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: 'ddbdcf67591ace5f555fda03a325052ef65525c0', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: '2c3b748ca58f7c47a09af75660dbacc56597a8a9', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: '9d8cf8bcc6ddbbd9a6cb917ed830d4e197dff242', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: 'd12f086dc0b63375f601953c7c18354e210e47cf', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '0341637fc5665c01b34cb7d8aea950bf72ad04aa', class: "sheet-footer" }, index.h("ir-button", { key: 'e9ec3935b8fbbc5017301d92d2a1629d11e51d39', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: 'cea29f1b73ab26a4ad9c2016a9262338a1f8f092', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: 'fae0cb8c39517eb914896d269b99b931e988dad9' }, index.h("section", { key: '4f7ee9403eba3be18d35f9580270ed2a9be5f2de', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: '2a1ea3f09bcd768c56f2d96039ca2b5cad4d0b85', class: "table" }, index.h("thead", { key: '197a08cf4823f1c2394296c63031bb662129206a' }, index.h("tr", { key: '1b0e1df5369a23004ece57f5be95a4b19c8c5646' }, index.h("th", { key: '19feec3b4e34aa8356a245c67467730c9128e9fd', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: 'dad4b1f255fa1dd89b70a9402f333944e9837d12', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: '1d0d7ddb4ccc266c034e3e3390067a5aa1f0f3c3', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '838970b6ec606d86e32b758df1736c4fff7d0edb', class: "text-left" }, "Role"), index.h("th", { key: '567092489b28ef81866100a96604aec782bae2f9', class: "text-left" }, "Last signed in"), index.h("th", { key: '96f77200db12db952e5b7b2147d6f1418a462e57', class: "text-left" }, "Created at"), this.haveAdminPrivileges && index.h("th", { key: '6fe00f9c07c558934ea043e7d8c98d9310194af4' }, "Active"), this.haveAdminPrivileges && index.h("th", { key: '319484d89fe950bc22166a0157b34e88644de741' }, "Email verified"), index.h("th", { key: 'b3214acfb03fc32892ec76011402111683dfabd4', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: 'ccaab28dd4862c5f78447a1d2bb474e822780885', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: 'b7b30513e702e4272f42974c6bf5eca3c67a258a', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'bfdc95e25615e38556a451fedc44167adcd34a7e', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: '22f36b5b7a76b92e2cefe3ae9db0cc846b140428' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: '15cc069552c6a8abeb7af053ac58fa4bdf879e91', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: '71e6f3d1d57431ee1c11d4fa315ad33736e20f8a', autoClose: false, modalBody: `Are you sure you want to delete ${(_e = this.user) === null || _e === void 0 ? void 0 : _e.username}?`, rightBtnColor: "danger", isLoading: irInterceptor_store.isRequestPending('/Handle_Exposed_User'), rightBtnText: locales_store.locales.entries.Lcz_Delete, onConfirmModal: this.removeUser.bind(this), ref: el => (this.modalRef = el) })));
    }
    static get watchers() { return {
