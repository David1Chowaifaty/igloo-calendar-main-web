...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: '80f31e664de0a97aa71a0d030757ab43ff4ee4e3', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '23bd00ea059654eeeb4a1588225699ea47984a8b', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '0a13862f206114ef9122dc0d378726f4a603ee41', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'b8bf1f335360990900bda4d319ffeda67665b04a', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: '75eee73ee68832e9e0f1288d7b3409df9b1dd68c', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '4d8c88353d00fe9e453b00477743aa6a60a6db8c', class: `ir-alert-header` }, index.h("p", { key: 'eca6b2c01ebf3bebcf6543cc49eac9fa6a656970' }, this.modalTitle))), index.h("div", { key: '20700a557df08296ac543a8d5b8be44a769a0979', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '961a26cac3306bb2db55d9aef086d49b533976ac' }, this.modalBody)), index.h("div", { key: 'db3d49242361c11786180f5fce50ee558e8600e6', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: 'ed3c82eb7d35ead6b470fd6c3cb2c84501e2017d', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: 'a36e1e4a62792259031068094535b664601e792d', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrSelect = class {
    ...
    render() {
        ...
        let label = (index.h("div", { key: '019819fdc4691b23e3967a981991b55fe4bfa3ff', class: `input-group-prepend col-${this.labelWidth} p-0 text-${this.labelColor}` }, index.h("label", { key: '7899252476c7f552c9e502545778cab8d047865a', htmlFor: this.select_id, class: `input-group-text ${this.labelPosition === 'right' ? 'justify-content-end' : this.labelPosition === 'center' ? 'justify-content-center' : ''} ${this.labelBackground ? 'bg-' + this.labelBackground : ''} flex-grow-1 text-${this.labelColor} border-${this.labelBorder === 'none' ? 0 : this.labelBorder} ` }, this.label, this.required ? '*' : '')));
        ...
        return (index.h("div", { key: '9627e9bab1692a6d373bde1e709b1d8d17009515', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'cbd9730e66018126f8c70ce11e03f4646b27768a', class: "input-group row m-0" }, label, index.h("select", { key: 'ee8551d8c0fd988882d01ae3997d293e907beadc', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '0d5041e668efcbd56b7a76c92bc6673c91238d22', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '281a31ef941a6ae5affcc44405e14c6472f04fcc', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: 'a16d25b2437a690b916a8d02ade75830bd38a34e', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: '97e4a23d705186ab49584e445791b947627d0874', class: 'sidebar-title' }, index.h("p", { key: '4c1c465d5bf733b80e9b89df801278772c252da1', class: 'p-0 m-0' }, this.label), index.h("div", { key: '9016b2a208585507d0b25d5afbf80325b043343c', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: '301e77e31a2c5dd7bd52b4908c78bfba30a870ba', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '6995a032305d507cd8f0e28c2d238362486fcc15', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: 'cd9b165544af1b961e9f50f180517f0fa7febb7c', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '23e4bdf92b1d23e02b0e030b87450dc3388ff503', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '00bbbc8863ad95c14c30306a216bde2e1fc105a4' }, index.h("button", { key: '49c5f517918608126ee7f3c060fdc5ad2c51d478', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: 'ffa19afaf7e711b30facb552c8a576a305ad234a', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: '66185795b74b16b7255a8f2cc80d08615f822d26', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'a8d931930594f0526276b3896517edb667f4e1de' });
    }
...
const IrUserFormPanel = class {
    constructor(hostRef) {
        ...
        this.userSchema = index$2.z.object({
            ...
            type: index$2.z.string().nonempty().min(2),
            username: index$2.z
                .string()
                .min(3)
                .refine(async (name) => {
    ...
    render() {
        ...
        return (index.h("form", { key: '3e96eedd39cf8db954948c8236beeb8fb77a354c', class: "sheet-container", onSubmit: async (e) => {
                e.preventDefault();
                await this.createOrUpdateUser();
            } }, index.h("ir-title", { key: '3034d526d38917d8551e901a61f24d2867ff1fac', class: "px-1 sheet-header", displayContext: "sidebar", label: this.isEdit ? this.user.username : 'Create New User' }), index.h("section", { key: '045e57ab0904be351dbef952cc82d5017779c518', class: "px-1 sheet-body" }, index.h("ir-input-text", { key: 'ea6c431ac4e27b8043a3ce4358a0403ec91710b0', testId: "email", zod: this.userSchema.pick({ email: true }), wrapKey: "email", autoValidate: this.autoValidate, error: (_a = this.errors) === null || _a === void 0 ? void 0 : _a.email, label: locales_store.locales.entries.Lcz_Email, placeholder: "", onTextChange: e => this.updateUserField('email', e.detail), value: this.userInfo.email, onInputBlur: this.handleBlur.bind(this), maxLength: 40 }), index.h("ir-input-text", { key: '861c6ba7e2026738dd0bc0e216105c6988794e9f', testId: "mobile", disabled: this.disableFields, zod: this.userSchema.pick({ mobile: true }), wrapKey: "mobile", error: (_b = this.errors) === null || _b === void 0 ? void 0 : _b.mobile, asyncParse: true, autoValidate: this.user ? (((_c = this.userInfo) === null || _c === void 0 ? void 0 : _c.mobile) !== this.user.mobile ? true : false) : this.autoValidate, label: "Mobile", mask: this.mobileMask, placeholder: '', value: this.userInfo.mobile, onTextChange: e => this.updateUserField('mobile', e.detail) }), (this.user && ((_e = (_d = this.user) === null || _d === void 0 ? void 0 : _d.type) === null || _e === void 0 ? void 0 : _e.toString()) === '1') || this.isPropertyAdmin ? null : (index.h("div", { class: "mb-1" }, index.h("ir-select", { testId: "user_type", error: ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.type) && !this.userInfo.type, disabled: this.disableFields, label: "User type", data: [
                { text: 'Frontdesk', value: '16' },
                { text: 'Property Admin', value: '17' },
            ], selectedValue: (_g = this.userInfo.type) === null || _g === void 0 ? void 0 : _g.toString(), onSelectChange: e => this.updateUserField('type', e.detail) }))), ((_j = (_h = this.user) === null || _h === void 0 ? void 0 : _h.type) === null || _j === void 0 ? void 0 : _j.toString()) !== '1' && (index.h("ir-input-text", { key: '6967a3d34b3b2c3e206f3e2d8a96fb85c72cb218', testId: "username", zod: this.userSchema.pick({ username: true }), wrapKey: "username", autoValidate: this.autoValidate, error: (_k = this.errors) === null || _k === void 0 ? void 0 : _k.username, label: "Username", disabled: this.disableFields, placeholder: "", onTextChange: e => this.updateUserField('username', e.detail), value: this.userInfo.username, onInputBlur: this.handleBlur.bind(this), maxLength: 40 })), !this.user ? (index.h(index.Fragment, null, index.h("ir-input-text", { testId: "password", autoValidate: this.user ? (!((_l = this.userInfo) === null || _l === void 0 ? void 0 : _l.password) ? false : true) : this.autoValidate, label: 'Password', value: this.userInfo.password, type: "password", maxLength: 16, zod: this.userSchema.pick({ password: true }), wrapKey: "password", error: (_m = this.errors) === null || _m === void 0 ? void 0 : _m.password, onInputFocus: () => (this.showPasswordValidation = true), onInputBlur: () => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: 'baa0d9f9638d79b4c1da92c1aa4fa506db36fb2d', class: "logins-history-section mt-2" }, index.h("div", { key: '5dc3af1442f238400bd59754c1ee1e055e0641a4', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: '87f2e005188da12ce241f9cc1887404478c402ef', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: 'c38e1efc2f3c27194d521286e6713a20d3e1c84b', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: 'b0be026b90657c53e4708106a5f1fb9dd5e17ea0', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: 'f3f90c92494271af85a883fbb3e37355e08b4591', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '723eec0e78d54a07a68472d4e32993c64827eb5b', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '46b3d564990445f0ed0720a56ef6d81f774f058b', class: "sheet-footer" }, index.h("ir-button", { key: 'fa1c3cf4ae56aa451884f75c4ff8bcab640c9ba4', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '0a351f238492fedc6c2345e5cb0b31343a6073e8', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagementTable = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: '99c248bec92928b477755bccd7ae87a1fa6b5bc5' }, index.h("section", { key: 'de08287b5b9622ed0b959d537a581c4db9253838', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: 'eada6d1ee7dbfef122521e047d1c3b84159ced21', class: "table" }, index.h("thead", { key: '7249129e8b97fedfb045b8d711be1a900dd433eb' }, index.h("tr", { key: 'abba8fbc31acd9f4e6dfc94be234fa6315832fd4' }, index.h("th", { key: 'e4dd0d1a4fff4e71ef58d457dcee876944b936ae', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: 'a551dbd319d4a697737aa96fb722fc08fbe32861', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: 'f145ddef2624066e728433da17e7737a62adc973', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '83e6fcd57a3e584a7db2ad07f07607fda8b3f861', class: "text-left" }, "Role"), index.h("th", { key: '00a306cbb416ed985acf8b6bfb8e9b75fc53bdb5', class: "text-left" }, "Last signed in"), index.h("th", { key: '61da727f7ffe00772dd80cbc9ec9d28e9ce9bfe3', class: "text-left" }, "Created at"), this.haveAdminPrivileges && index.h("th", { key: 'd14da7bf7389c347092cdc00b1cba6cb0b028513' }, "Active"), index.h("th", { key: '9a003dee51a41c07c3e0a9331a4cb8e23abb3079', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '8bcc9afe3acc2fd74519efa618e4d2e470a28b9f', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '194c35ff272f52a637ce1e8ff301bfccb24d058c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'f29a4e515953d326995b144329866f33a4c8fe4d', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: '9c3bacbbb8cd324413c4cd2171221bf7480b3db1' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: 'd92f234e327038d019e34b836e10fe22e67265b5', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: '6e867def4bc0694bd2f62dd5893233d239451d69', autoClose: false, modalBody: `Are you sure you want to delete ${(_e = this.user) === null || _e === void 0 ? void 0 : _e.username}?`, rightBtnColor: "danger", isLoading: irInterceptor_store.isRequestPending('/Handle_Exposed_User'), rightBtnText: locales_store.locales.entries.Lcz_Delete, onConfirmModal: this.removeUser.bind(this), ref: el => (this.modalRef = el) })));
    }
    static get watchers() { return {
