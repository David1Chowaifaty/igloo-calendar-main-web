...
const IrIcon = class {
    ...
    render() {
        return (index.h("button", { key: 'b42d30972f6775d0e8bb8da94c5cec58f3d5d3ca', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '722857b331e903a4e1f488198f0bfc7da2bd4383', name: "icon" })));
    }
};
...
const IrModal = class {
    ...
    render() {
        return [
            index.h("div", { key: '0ca3a50c90f1d866f9db7c76327a6d209234ad80', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            index.h("div", { key: 'b892ff98d6123e03c52995b2a7bb766b25203eaf', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, index.h("div", { key: 'd4a5b99e6cc76ccbeb0983dfd8e636f2e32fc737', class: `ir-alert-content p-2` }, this.showTitle && (index.h("div", { key: '5cf984976501b82061ffac5a935bb7c6c77e58dd', class: `ir-alert-header` }, index.h("p", { key: '2814da0c516d406944a377a351ae5d079afb2e5e' }, this.modalTitle))), index.h("div", { key: '731cd0fce31c70c8fa2afd937e0cb2d98dce1db8', class: "modal-body text-left p-0 mb-2" }, index.h("div", { key: '14d75a930c45552bd9fbee63189017b65d0df51d' }, this.modalBody)), index.h("div", { key: 'ccd4a36d40be011a0cf8916d5bb481409da109c6', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && (index.h("ir-button", { key: 'fa228b46dbfd4cbef581f5f880370f579a2f5b2e', btn_disabled: this.isLoading, icon: '', btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText })), this.rightBtnActive && (index.h("ir-button", { key: '02ce648f5f6b3d16dbca9f62e9ec22e9906d0d95', icon: '', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
};
...
const IrResetPassword = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'b4f9c3a3886768dcaab2775844ec16deac3f4859', class: { 'base-host': !insideSidebar, 'h-100': insideSidebar } }, index.h("ir-interceptor", { key: '3678ef49baed199b6d65950f4741faa7aa8fae32' }), index.h("ir-toast", { key: 'a6ee70229de82da09ada626d16960a82fc42f34f' }), index.h("form", { key: 'fa09dfe44d82d5a5fdb4a0c3fe0199d3eab5a63e', onSubmit: this.handleChangePassword.bind(this), class: { 'sheet-container': insideSidebar } }, insideSidebar && index.h("ir-title", { key: '359d71f6cfcf5bcaafd0302093ed16a85b9de3fa', class: "px-1 sheet-header", displayContext: "sidebar", label: 'Change Password' }), index.h("div", { key: '67b14a694432c85a7d788d79591f87683fee0c05', class: { 'form-container': true, 'sheet-body px-1': insideSidebar, 'px-2': !insideSidebar } }, index.h("svg", { key: '17e06920ffd1eb6f6700e1b1f1c60988b1bd74db', class: "lock-icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 448 512", height: 24, width: 24 }, index.h("path", { key: '8372f908dc3281bf605ff3abe2707966af068b00', fill: "currentColor", d: "M144 144l0 48 160 0 0-48c0-44.2-35.8-80-80-80s-80 35.8-80 80zM80 192l0-48C80 64.5 144.5 0 224 0s144 64.5 144 144l0 48 16 0c35.3 0 64 28.7 64 64l0 192c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 256c0-35.3 28.7-64 64-64l16 0z" })), index.h("div", { key: '6195c10f955bd7f20795c25a2de557a0cde89998', class: "text-center mb-2" }, index.h("h4", { key: '692fc074587c107432c7b39087d4d54913c55bb4', class: "mb-1" }, "Set New Password"), this.submitted ? (index.h("p", null, "An email has been sent to your address. Please check your inbox to confirm the password change.")) : (index.h("p", null, "Your new password must be different to previously used password"))), !this.submitted && (index.h("section", { key: '53b7d92a310c4087234d5ea2dbb2563d8e61b87a' }, index.h("div", { key: '647e2a9a74064a929fc1a2c58d545d0fe351c033', class: 'mb-2' }, index.h("div", { key: '85faa77678dde0ebebcda7618a9e662f519662a4', class: "m-0 p-0" }, index.h("div", { key: '08639c5acbc55c7e979dddfdc7ab7de3793d45ed', class: 'position-relative' }, index.h("ir-input-text", { key: '42ddfef0e805b02b03cf0ea919c40acaf6f4a8b7', error: (_a = this.error) === null || _a === void 0 ? void 0 : _a.password, autoValidate: this.autoValidate, value: this.password, onTextChange: e => (this.password = e.detail), label: "", class: "m-0 p-0", inputStyles: 'm-0', zod: this.ResetPasswordSchema.pick({ password: true }), wrapKey: "password", placeholder: "New password", onInputFocus: () => (this.showValidator = true), type: 'password' })), this.showValidator && index.h("ir-password-validator", { key: '42a44953a32cbac229676124b9d971af3756ac08', class: "mb-1", password: this.password })), index.h("div", { key: 'a032212c024bf3d0197c343d0ed441e615e68614', class: 'position-relative' }, index.h("ir-input-text", { key: 'cb94ac9d33405080a452db7f306481dfd2c38487', error: (_b = this.error) === null || _b === void 0 ? void 0 : _b.confirm_password, autoValidate: this.autoValidate, zod: this.ResetPasswordSchema.pick({ confirm_password: true }), wrapKey: "confirm_password", value: this.confirmPassword, onTextChange: e => (this.confirmPassword = e.detail), label: "", placeholder: "Confirm password", type: 'password' }))), !insideSidebar && (index.h("div", { key: '12d4f5aa194cc5633f9613e65bca953d0fd7dd7c', class: "d-flex flex-column mt-1 flex-sm-row align-items-sm-center", style: { gap: '0.5rem' } }, index.h("ir-button", { key: '86acc3ba01cfe80c5c9611c5e4fc947bfb017df4', btn_styles: 'flex-fill', onClickHandler: () => window.history.back(), class: "flex-fill", text: 'Cancel', size: "md", btn_color: "secondary" }), index.h("ir-button", { key: '5f1cb6a242b4c4bb59f498997d1866c55289f626', btn_styles: 'flex-fill', class: "flex-fill", isLoading: this.isLoading, btn_type: "submit", text: 'Change password', size: "md" })))))), insideSidebar && (index.h("div", { key: '90ba0eb78749f9875a31007e322b237964923133', class: 'sheet-footer w-full' }, index.h("ir-button", { key: 'ed652a0871b454828774d4f92c3abeca7326d42f', text: 'Cancel', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_color: "secondary", btn_styles: "w-100 justify-content-center align-items-center", size: "md" }), index.h("ir-button", { key: 'ed588c115cc3cd536dabb6e5321850e114d0b52c', isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: 'Change password', size: "md" }))))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'd7ab21855f7ada7ac2bd975d3a52060faf73c77f', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: '5742ed73122fc9d24f4d805613beb6237d2e3850', class: "input-group row m-0" }, label, index.h("select", { key: '64d62f6998229f9df0abb93eab097bdc08e8e492', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: 'd22e1472a14e8435a35ffdac8bdd7028b6944213', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSidebar = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '213b70eb16a479b34e4290ff532375a2268f0aff', class: `backdrop ${className}`, onClick: () => {
                    this.toggleSidebar();
                } }),
            index.h("div", { key: '5b2f1eef9ff3b66ec2a0ac09b6c18a7f87a3a526', ref: el => (this.sidebarRef = el), class: `sidebar-${this.side} ${className}` }, this.showCloseButton && (index.h("div", { key: 'e52bfadd1ead913ccdcb1db946628b69d32128fd', class: 'sidebar-title' }, index.h("p", { key: '6993c36f64b15c853b40ee9ed8dd34426d56c25c', class: 'p-0 m-0' }, this.label), index.h("div", { key: '751b6694315ac87486d31782a32b581406a6b0ba', class: 'p-0 m-0 sidebar-icon-container' }, index.h("ir-icon", { key: 'e93d208422d6ef3afdc3895c0d97c017d1a41133', class: "", onIconClickHandler: () => {
                    this.toggleSidebar();
                } }, index.h("svg", { key: '11c652d9fff0a7fb41b5a57dd6441c5f438782a1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '255461e717d8e74018c55d8b6a8e2a249c042f90', fill: "#6b6f82", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))))), index.h("slot", { key: '64c1cc3db127cbaf98fd3e6deccfbd98bb46701b', name: "sidebar-body" })),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrSwitch = class {
    ...
    render() {
        return (index.h(index.Host, { key: '609836ffaaf8892a62adcd5a1c6863aa58ecd499' }, index.h("button", { key: '691dcf962d4cd8ce72adf37b5cae6b5f7cab4f3d', disabled: this.disabled, ref: el => (this.switchRoot = el), type: "button", id: this.switchId || this._id, onClick: this.handleCheckChange.bind(this), role: "switch", "data-state": this.checked ? 'checked' : 'unchecked', value: 'on', class: "SwitchRoot" }, index.h("span", { key: '5eb27fb1a518148e3e78e632d19989733d766dd2', class: "SwitchThumb", "data-state": this.checked ? 'checked' : 'unchecked' })), index.h("input", { key: 'fe94d7001853bf4b6508288c43ad2e16da0a473d', type: "checkbox", checked: this.checked, "aria-hidden": "true", tabIndex: -1, value: 'on', class: "hidden-input" })));
    }
};
...
const IrTitle = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a23218a1dfbf16e66e470a87683f1c9340b9a990' }, index.h("h4", { key: 'e5d037576236056849e53b6422ee90fcdeee8692', class: "text-left font-medium-2 py-0 my-0" }, this.label), this.displayContext === 'sidebar' && (index.h("ir-icon", { key: 'b406dc1c8cc8215939937c403b1eec88159267c0', class: 'close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, index.h("svg", { key: '42bdfa7982fc3e9b672d3a2f2c9c6f28acf816d4', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, index.h("path", { key: '520295dbb81199270da5fbb139e359bc51a0f7f9', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), this.displayContext !== 'sidebar' && (index.h("div", { key: 'ae9c6ce8d5ad917b640ee31f66fe63974312f30d', class: 'title-body' }, index.h("slot", { key: '62fe792375096203d358bcb2a6b47a292fbe40fb', name: "title-body" })))));
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const IrToast = class {
    ...
    render() {
        return index.h(index.Host, { key: 'dc31ef0e4999a750e2cc5d21a254dff4ac820826' });
    }
...
const IrUserFormPanel = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '6bf9448225cfccbfa4b0cfe601649d3258449d37', class: "sheet-container", onSubmit: async (e) => {
            ...
            (((_o = this.user) === null || _o === void 0 ? void 0 : _o.type.toString()) === '17' && ((_p = this.userTypeCode) === null || _p === void 0 ? void 0 : _p.toString()) === '17' ? null : (index.h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, index.h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), index.h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_r = (_q = this.user) === null || _q === void 0 ? void 0 : _q.sign_ins) === null || _r === void 0 ? void 0 : _r.length) > 0 && (index.h("section", { key: 'da05c5efdaf5b937327d5c9c17b8304615b60049', class: "logins-history-section mt-2" }, index.h("div", { key: '28e81f07f5333c0d26295ca40d24b5a3da2e1e05', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, index.h("h4", { key: 'd7afe57bab585daa3f86c30412510638af7c87e5', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (index.h("ir-button", { key: 'c7f8c643a1305ba973a2f51ae1ed0c89e25cc65f', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), index.h("ul", { key: '0b460fef94d4018626d8545fd4215f79fd670692', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b, _c;
        ...
        })))), index.h("ir-sidebar", { key: '7836fde7beca26381e0e69263558d112491136d5', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (index.h("ir-reset-password", { key: '2bc70c297c5d2ff3b27af5828cd0db4a1eeffcc2', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), index.h("div", { key: '2c777a0438e616eacd0a52159ddbb323e4276b56', class: "sheet-footer" }, index.h("ir-button", { key: 'f918e194a5dfd29b2cd8a870e3127bc6bb0e9f71', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '2d672468143e8c981b24070818cfd043f4610793', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales_store.locales.entries.Lcz_Save }))));
    }
};
...
const IrUserManagement = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("ir-toast", null), index.h("ir-interceptor", null), index.h("section", { class: "p-2 d-flex flex-column", style: { gap: '1rem' } }, index.h("div", { class: "d-flex  pb-2 align-items-center justify-content-between" }, index.h("h3", { class: "mb-1 mb-md-0" }, "Extranet Users")), index.h("div", { class: "", style: { gap: '1rem' } }, index.h("ir-user-management-table", { allowedUsersTypes: this.allowedUsersTypes, userTypeCode: this.userTypeCode, haveAdminPrivileges: ['1', '17'].includes((_a = this.userTypeCode) === null || _a === void 0 ? void 0 : _a.toString()), userTypes: this.userTypes, class: "card", isSuperAdmin: ((_b = this.userTypeCode) === null || _b === void 0 ? void 0 : _b.toString()) === '1', users: this.users })))));
    }
    static get watchers() { return {
...
const IrUserManagementTable = class {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (index.h(index.Host, { key: 'aa1bdf60be06e19005ac4b5dde41ecafda7f882f' }, index.h("section", { key: 'a60b4f85860f95484dac05ca6fb209a8451eec61', class: "table-container h-100 p-1 w-100 m-0 table-responsive" }, index.h("table", { key: 'a8bdb14ce0ef4921d0147363fb1c8155cfcc3a4b', class: "table" }, index.h("thead", { key: 'b19a3b3848f1477b9713298c7e644d6e502a86c1' }, index.h("tr", { key: '01671a55d445e02d6e9041440b099fa0acee1266' }, index.h("th", { key: '49d84ccc5e3598213cabb57826ccc10ff2d541dc', class: "text-left" }, (_a = locales_store.locales.entries.Lcz_Username) !== null && _a !== void 0 ? _a : 'Username'), index.h("th", { key: 'dcbc0cf3bc1e4700362256120f51993a5addcbdf', class: "text-left" }, locales_store.locales.entries.Lcz_Email), index.h("th", { key: '892cd85a0de011cd4c6f761cc6f8f16fe3a4415e', class: "text-left" }, (_b = locales_store.locales.entries.Lcz_Mobile) !== null && _b !== void 0 ? _b : 'Mobile'), index.h("th", { key: '02a6ab71f6a37a0e1ec26c17f12752818d275b59', class: "text-left" }, "Role"), index.h("th", { key: 'b823e6ca038b393f84645879840bf68c99a02d54', class: "text-left" }, "Last signed in"), index.h("th", { key: 'b57b5df91ff528164e04d15eead9207ee6bf350e', class: "text-left" }, "Created at"), this.haveAdminPrivileges && index.h("th", { key: 'd81330271e96f7aaafaee4dfe5c8d8c39b5bf8b0' }, "Active"), this.haveAdminPrivileges && index.h("th", { key: '18a5bae09cddac006fd82103a265cc0d1ebe479a' }, "Email verified"), index.h("th", { key: '4d5fa803fa122a31dabcc6417dc3039db3c079ef', class: 'action-row' }, this.canCreate && (index.h("ir-icon", { key: '48432c55bb0e88e93bf554af18a6f700f52f2f58', style: { paddingLeft: '0.875rem' }, "data-testid": "new_user", title: locales_store.locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, index.h("svg", { key: '39e15b2df29065d52d48f727eb06c186cdfda2bc', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, index.h("path", { key: 'bf7abfab7c67c68d9eb90939c41bc9cd70a825a0', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" }))))))), index.h("tbody", { key: '4a0f1764ac66bea6e0667c501ebf1fd076d02859' }, this.users.map(user => {
            var _a;
        ...
        })))), index.h("ir-sidebar", { key: '1b33c24478297803e7e1d58671e1db073b23dff7', open: this.currentTrigger !== null && ((_c = this.currentTrigger) === null || _c === void 0 ? void 0 : _c.type) !== 'delete', onIrSidebarToggle: () => (this.currentTrigger = null), showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            ...
            } }, this.renderCurrentTrigger()), index.h("ir-modal", { key: '0b14f4aaa7cf4049c584ed5f04f0b05e030e4667', autoClose: false, modalBody: `Are you sure you want to delete ${(_e = this.user) === null || _e === void 0 ? void 0 : _e.username}?`, rightBtnColor: "danger", isLoading: irInterceptor_store.isRequestPending('/Handle_Exposed_User'), rightBtnText: locales_store.locales.entries.Lcz_Delete, onConfirmModal: this.removeUser.bind(this), ref: el => (this.modalRef = el) })));
    }
    static get watchers() { return {
