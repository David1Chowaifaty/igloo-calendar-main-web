...
const index$3 = require('./index-6299b0f7.js');
...
const IglApplicationInfo = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'c2e6990bc5b1a9b23c772d9e46d21294a84e8207', class: 'my-2', "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, index.h("div", { key: '779e7b24b1601af26f9a10a2f8f8517d8b8ec05e', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("span", { key: '9413ec7854a9a250c865ddd3114915ef8355f295', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), index.h("div", { key: 'e21bad842a4367efaac9163025cbbee1f7d39c42', class: "booking-details-container" }, index.h("div", { key: '3ae85e6eefc1dfcd6c55309c57486fd62438d889', class: "booking-rateplan" }, index.h("p", { key: 'd83ad1e3cf500c0a776f60ae9cddff5625f90bad', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && index.h("span", { key: '7ac90960fc99a44a8f1cb5c59c87405ad4039a6d', class: 'non-ref-span' }, "Non Refundable")), index.h("ir-tooltip", { key: '6da870274f38f4054412cbbc468c8a19a07b3e2f', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: '9c596af7f6e9c7842df2d40e99ae495d73d6b5bd', class: "booking-variation", innerHTML: formattedVariation })), index.h("p", { key: '2f93367f79053cf4faa1634683e854b5d7f6abd5', class: "booking-price" }, utils.formatAmount(this.currency?.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), index.h("div", { key: 'ff536acaaf193208e9c706d1084ffef7822ba9ce', class: "booking-footer" }, index.h("div", { key: 'cf27f327b52def68e08ccb9dd676d42b9e963bcc', class: "booking-rateplan" }, index.h("p", { key: 'c018565c86afe4e94ac0822700e2c47fd4244da3', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), index.h("ir-tooltip", { key: 'a9d325e9c60f56361086db51abc991cb9405beb7', class: "booking-tooltip", message: this.getTooltipMessages() })), index.h("p", { key: '7c10925bf6db5a6f19957440979248e4f4f16a3c', class: "booking-variation", innerHTML: formattedVariation })), index.h("div", { key: 'f84fd00de39ccc7d79e19c2fc14e327aa7d43daf', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, index.h("div", { key: '1e10e9df662500845daa3f926990916c6f1b1ec1', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, index.h("input", { key: 'bbea675012e784caaf8c13dc61a029b359ae7419', id: v4.v4(), type: "text", "data-testid": "guest_first_name", class: `form-control ${this.isButtonPressed && this.guestInfo?.first_name === '' && 'border-danger'}`, placeholder: locales_store.locales.entries['Lcz_GuestFirstname'] ?? 'Guest first name', name: "guestFirstName", onInput: event => {
            ...
            }, required: true, value: this.guestInfo?.first_name })), index.h("div", { key: 'a8533ca5ae1ffc24e16d14f3fcedd54cb9f97aa2', class: "mr-md-1 flex-fill guest-info-container" }, index.h("input", { key: '2be1ff3eb86b45b34715b413bbfd0bd85a39a4b9', id: v4.v4(), type: "text", class: `form-control ${this.isButtonPressed && this.guestInfo?.last_name === '' && 'border-danger'}`, placeholder: locales_store.locales.entries['Lcz_GuestLastname'] ?? 'Guest last name', name: "guestLastName", "data-testid": "guest_last_name", onInput: event => {
                const name = event.target.value;
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (index.h("div", { key: '0a1574ea65808b33b9ddd37e9a021e9ac84c9e27', class: "mt-1 mt-md-0 d-flex align-items-center flex-fill" }, index.h("div", { key: 'f8de9317fb4f53198c60b1c407f758d10d296933', class: "mr-md-1 p-0 flex-fill preference-select-container" }, index.h("select", { key: 'bb9dec41b4a2f9981d05c6c272a418c7a819e57c', "data-testid": "unit", class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, index.h("option", { key: '0a557d3694a70882974bb938f5990e81a8be54f5', value: "", selected: this.guestInfo?.unit === '' }, locales_store.locales.entries.Lcz_Assignunits), filteredRoomList?.map(room => (index.h("option", { value: room.id, selected: this.guestInfo?.unit === room.id.toString() }, room.name))))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (index.h("div", { key: '88ba07e29d081c9d3f4bd68f5917d9162c0e695f', class: "mt-1 mt-md-0 mr-md-1 flex-fill" }, index.h("select", { key: '7d951c52398b59c459a906d41343e577d5bab15c', "data-testid": "bed_configuration", class: `form-control input-sm ${this.isButtonPressed && this.guestInfo?.bed_preference === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, index.h("option", { key: 'd7c9c13700a258bacaf642dbfc5b412271fe0231', value: "", selected: this.guestInfo?.bed_preference === '' }, locales_store.locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => (index.h("option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), index.h("p", { key: 'c521cc7c13e431fe5ac53f71d864076ae982b3c0', class: "rate_amount" }, utils.formatAmount(this.currency?.symbol, this.getAmount()), "/", locales_store.locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (index.h("div", { key: '5740ea5e80e091c1ec66d860190514f8b102ca93', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, index.h("p", { key: '907b649671cf26d174569bd604a08aee87380759', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), index.h("div", { key: '44b36c047bbd72f5dd410b46984b5b8974a5af01', class: "mr-1 flex-fill" }, index.h("select", { key: 'fb1d00c81f68117c704f03ddbd544892995b3221', class: `form-control input-sm ${this.isButtonPressed && this.guestInfo?.bed_preference === '' && 'border-danger'}`, id: v4.v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, index.h("option", { key: '588a3ecbd7fea6568141e36d5e6036b2eef6daff', value: "", selected: Number(this.guestInfo?.infant_nbr) === 0 }, locales_store.locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => (index.h("option", { value: item, selected: this.guestInfo?.infant_nbr === item }, item)))))))));
    }
};
...
const IglBlockDatesView = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '101274b1aed5b38211ad6a63b65c4b981beee983' }, index.h("div", { key: 'f1f84447fbceb879ae7164d033c0a612ab8ae271', class: `m-0 p-0 mb-1` }, index.h("div", { key: '757a09a24b5b2bc3754f54caf9f6200bfa449775', class: "text-left p-0" }, index.h("ir-date-view", { key: '655587d76b6421316e5b827a70388437da039e42', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), index.h("div", { key: '98585f2a06c1c911e2e5c0a30ecace87b7a927f8', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, index.h("div", { key: 'c3de8500dfbd76244136b0b6cfcd73bb74f674c2', class: "mb-1 " }, index.h("label", { key: 'aed962c6c8345b4e74a20d1c8328bae7290851ab', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales_store.locales.entries.Lcz_Reason, ":"), index.h("div", { key: '0c9110b18022f1c7062230fc9d46c062f407571c', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, index.h("input", { key: 'd5a603661f60334e8b012a83bcbc2d405cadb0d0', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), index.h("span", { key: '919e4741f836cbfd8fe90d555a0850d656e952b7', class: "align-middle out-of-service-label" }, locales_store.locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (index.h("div", null, index.h("div", { class: "mb-1 d-flex  align-items-center" }, index.h("span", { class: "align-middle" }, locales_store.locales.entries.Lcz_Or, " "), index.h("div", { class: "d-inline-flex col pr-0 align-middle" }, index.h("input", { class: "form-control", type: "text", placeholder: locales_store.locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), index.h("div", { class: "mb-1 w-100 pr-0 " }, index.h("span", { class: "text-bold-700 font-medium-1" }, locales_store.locales.entries.Lcz_AutomaticReleaseIn, ": "), index.h("div", { class: "d-inline-block" }, index.h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (index.h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (index.h("div", { class: "d-inline-block releaseTime" }, index.h("em", null, locales_store.locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
};
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '77f9f6993d8542f55cad01b233cc8eccb9364856' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), index.h("div", { key: '2e8b381cc1373fc6e3a5b0359e5d25529810162e', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, index.h("fieldset", { key: '80fe139a3b37c244d8a253aa6f63fd00c51154d6', class: "mt-lg-0 mr-1 " }, index.h("igl-date-range", { key: '200e68ffa29de66dbf5ffd4a0287e07dbf6ce9ff', "data-testid": "date_picker", variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: '816776d6336e876391ea660c5682b003ec200c74', class: "text-right mt-1 message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglBookingForm = class {
    ...
    render() {
        return (index.h("div", { key: '00e76925601991f8af6dbf3217115e5ebbb450c5', class: "d-flex flex-column h-100" }, index.h("div", { key: 'fd57b91dda0c0cf44ed5118e4a6d4d1b664df32d', class: "d-flex flex-wrap" }, index.h("ir-date-view", { key: '407ce5b98ad942bd2588c3f930a8e1ca5c770098', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (index.h("div", { key: '6a63ee8bf23a8c77d97717a2a34ada93959c53bf', class: "mt-1 mt-md-0 text-right" }, locales_store.locales.entries.Lcz_TotalPrice, " ", index.h("span", { key: '94aee72dcc60a12535408c4aabbd129bd8250fc9', class: "font-weight-bold font-medium-1" }, utils.formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_service.booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f876d5d2e2e7e66d1f3ab78055c943b8c2f10c68' }, index.h("div", { key: 'f395b7c10f4a5da079536f9b2d39ab11c6270d26', class: "text-left mt-3" }, index.h("div", { key: '4786d6eedf275b9bb7de99b019e7e61f651cf332', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: 'b90dd9e70e5f58d29bdb31230a1aa17f34ceb11c', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: 'df61f5900ec1986e92f76ce69eb8785013bdb0a1', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: 'd205b05ae1d47a412811bed9863f548bc31b42ad', testId: 'main_guest_email', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: '9fd20f80f95188acc736e5d101f5b0fd2fdd3138', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: '018e2f7ac8ad949179d082d5323effa9eee5be52', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '10340b95e215fb0e7025d99b541bebab7d186207', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: '49e5e46b104b4e6d27062e7b00eeb2a66b29fd62', class: "p-0 flex-fill " }, index.h("div", { key: '839bf08aff978946d58fa054bb214b06a1b415f3', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: 'ad6b465ae7e52776c85163a54c4daf17444664e8', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: 'c38b41f333c867d2423ffbd274cd9c7d25171a8b', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: 'ec574fd5aa4149a19ad8f37e1ec46376a316b9b6', "data-testid": "main_guest_first_name", class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => {
                this.updateGuest({ first_name: event.target.value });
                this.handleDataChange('firstName', event);
            }, required: true }))), index.h("div", { key: 'cee1d9db0c88f978fb67659a367d4f0a960e7bdf', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '609f9bdd1172d32c04ff1869b4ed74bf6355ced1', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '2446b2f825849d6ef14b001daeaa5a60173ade67', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '29e8ddb4440b5a08108171ea233d68e4195fbf01', "data-testid": "main_guest_last_name", class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: '00a97c5ad5e7fa42aaf6eadfc89a270ace664279', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '3d5842ab9edc2a2596ec1665632b741a4947c750', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("ir-country-picker", { key: '941d9fae2003b4e5f7c134981d0030959d5f3657', testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) })), index.h("div", { key: 'f1b1f88324108c93572e97e382ab4ac003f77834', class: "form-group p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '78b90cebd5540359993d8f35363ac64f2b2f5e5d', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: 'f156043a3853d53c7502758bfd39cd02b6cd2df1', class: "p-0 m-0 controlContainer flex-fill" }, index.h("ir-phone-input", { key: '6c3e1ac2f31752ff73780d71eb80166ae2c64535', testId: "main_guest_phone", language: this.language,
            ...
            } }))), index.h("div", { key: '4bb8eda795172337777630b03e1baf5fc3534080', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '707dd9c6a4f6dab5759f805fb858e463493dde2d', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: '1e9f19174938798f6a8f0ff938212141071f2c55', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '0b5d95fff3d82f7dc23a113d89c4c6b6314126e4', "data-testid": "arrival_time", class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: '5afbb6c71c0ba0ab52f40c2938a26f10c1fc689e', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: '39a7cd424d4ea91f9c35beccf0318aa5001bc475', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: 'b7a069a1347d6f39535182e6750d990aadc7523a', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: '839f44b65f273f495cb0029c47570780728bdbbb', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: 'd8f50d940ff56516b844d0c2d005c3752004a1ff', "data-testid": "note", id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.paymentMethods.length > 1 && (index.h("div", { key: '92b907b0dec8ee240070894e91131a780f1801dd', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '2dcf8ee9599ecc746c3b80152e200ae6a068b1d8', class: "p-0 m-0 margin3" }, "Payment Method"), index.h("div", { key: '7ad946c3a75ba60122c8c4221c0e9318b2d2bd23', class: "p-0 m-0  controlContainer flex-fill" }, index.h("ir-select", { key: '862d3b762e883b8ae17516fa6747f3ae3db255ca', showFirstOption: false, selectedValue: booking_service.booking_store?.selectedPaymentMethod?.code, data: this.paymentMethods.map(p => ({
                text: p.description,
                value: p.code,
            })), onSelectChange: e => booking_service.modifyBookingStore('selectedPaymentMethod', {
                code: e.detail,
            }) })))), booking_service.booking_store.selectedPaymentMethod?.code === '001' && (index.h(index.Fragment, { key: '49d27409905d066096bbedaa8924c284d08ecb11' }, index.h("div", { key: '9703f6801e7638a7f89ded4477b348901228a6a1', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'fc9cbb2c13f3b8befc51fe04a48d7db895ca9755', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: '3ab135a8ce4da1634f7a2fcb3785e7243353ea60', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '2ed3bd997159889f1b943c6f78d288e8f5ad7fcf', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: '074e008c081aef06b595fa73ad9a734f6fd37819', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '34d23006e0baa6eb207e8e6c0459021f86ccfff9', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: '9c8c9b2b2f24b4f1569d872b7d4b57dc2cd89029', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: 'e8ef894a9d5459f3e0260dc97848fd36c934f6fa', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: '4e0880ea1275649bd998fc9244038a02a1030b86', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '791416041f9dc46711399bcdc7fd70472240eb6f', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: 'f9fb7f706aeecfc98b09bac51cfb37f86e0dd73a', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: '75c561b9bd072fa28981ebe782477fcd770a792a', class: "p-0 m-0" }, index.h("select", { key: '00fdf9eba243b9f852e05710427dd61d17311e4e', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: '9458258f1635ba7e8d73d6ecda5e15c28ea3274c', class: "p-0 m-0 ml-1" }, index.h("select", { key: '09ff4869b7b312f3885ccd4a1424b08215a732b1', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), booking_service.booking_store.selectedPaymentMethod?.code === '005' && (index.h("div", { key: '3082d628e2bdc4516e7bd3949dd129395bceec97', class: "form-group mt-md-1 mt-1 p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '96dcb1d8f16de2295c570670b7d3f47bef82b4f4', class: "p-0 m-0 margin3" }), index.h("div", { key: '98935151a6e1ae2f5df3fdfd6d451ab96caeaa6a', class: "p-0 m-0  controlContainer flex-fill" }, index.h("div", { key: '755a9a7602adbf987a98f3485bfd4f3ab86eb8c2', class: "property-booked-by__money-transfer-description", innerHTML: this.paymentMethods.find(p => p.code === '005')?.localizables.find(l => l.language.code.toLowerCase() === 'en')?.description })))), index.h("div", { key: 'cff8afd91cd81023daabdf33a7eca5f1169864a4', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: 'a07c31fb7ce06c029168579b845789e762454a69', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: '2dbe59842139b33c9cdd13f5e146fec8f139a3e0', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: '420b0396a437e44590f043983663d734245bc421', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '61ef4b9feb3b35ed4465cfece59109bcf7aa041e' }, isValidBookingType && this.roomType.rateplans?.length > 0 && index.h("div", { key: '8ebfd679180eaaf0ad2ff89b11ccaf603d0cb2b9', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), this.roomType.rateplans?.map(ratePlan => {
...
const IrBalanceCell = class {
    ...
    payBookingBalance;
    render() {
        return (index.h(index.Host, { key: '2cdcf05890fbed25993acc150ea14f5556a0af81' }, this.label && index.h("p", { key: '08ffcd2868bee101061377cac2e934e280e4d9b5', class: "cell-label" }, this.label, ":"), index.h("p", { key: '595c2512b02c5eef985b1155bb7c508a39c9065a', class: "ir-price" }, utils.formatAmount(this.currencySymbol, this.financial.gross_total)), index.h("div", { key: '1ac05790dd522e32ab434cb5cc69e59acfec26d5', class: "balance_button-container" }, ['003', '004'].includes(this.statusCode) && this.isDirect
...
const IrBilling = class {
    ...
    render() {
        ...
        })), this.invoiceInfo.invoices?.length === 0 && index.h("ir-empty-state", null))), index.h("ir-invoice", { invoiceInfo: this.invoiceInfo, onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = null;
...
const IrBillingDrawer = class {
    ...
    billingClose;
    render() {
        return (index.h("ir-drawer", { key: '65aaa2d676e387aa72639c23b041a9233e1f137e', style: {
            ...
            }, open: this.open, label: "Billing" }, this.open && index.h("ir-billing", { key: 'dd437f7195c0638422cfadd4affc913db22f26c0', booking: this.booking })));
    }
};
...
const IrBookingCompanyDialog = class {
    ...
    render() {
        ...
        return (index.h("ir-dialog", { key: '47d18b8a195033f152c68726aec92cca5bd194ef', open: this.open, onIrDialogHide: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.open = false;
                this.companyFormClosed.emit();
            }, label: "Company", id: "dialog-overview" }, this.open && (index.h("ir-booking-company-form", { key: 'fb7f36e99acd538beb349d8596ea297e796ddfc8', onResetBookingEvt: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.resetBookingEvt.emit(e.detail);
            }, formId: formId, booking: this.booking })), index.h("div", { key: 'c4e936c81f21159727cc2b39a6c12418eb2e77fa', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'c216683b25b9f7c4c6ed8cf4127773aad5babdcf', size: "medium", appearance: "filled", variant: "neutral", "data-dialog": "close" }, "Cancel"), index.h("ir-custom-button", { key: '7140bdb608f004f41e9523f7f14d995d4e8e4978', type: "submit", form: formId, loading: irInterceptor_store.isRequestPending('/Do_Reservation'), size: "medium", variant: "brand" }, "Save"))));
    }
};
...
const IrBookingCompanyForm = class {
    ...
    render() {
        return (index.h("form", { key: '142ffb0198b805299a8200073a0118be4f8b300e', id: this.formId, onSubmit: e => {
                e.preventDefault();
                this.saveCompany();
            }, class: "booking-company__form" }, index.h("ir-custom-input", { key: '5da547c1478fc848e23336edb7585a9c9f56d0de', value: this.formData.company_name, "onText-change": e => this.updateGuest({ company_name: e.detail }), label: "Name", autofocus: true, placeholder: "XYZ LTD" }), index.h("ir-custom-input", { key: 'ab6ab47b6151051ef291b52918a3870a11404651', value: this.formData.company_tax_nbr, "onText-change": e => this.updateGuest({ company_tax_nbr: e.detail }), label: "Tax ID", placeholder: "VAT 123456" })));
    }
};
...
const IrBookingExtraNote = class {
    ...
    render() {
        return (index.h("ir-dialog", { key: '28fbdc486e3fbcbcef1c02a054d6d379e09dd51e', label: "Private note", open: this.open, onIrDialogHide: () => {
                this.open = false;
            } }, index.h("wa-textarea", { key: '41d121c66e91ce04b787a2c3c95ae86b1e9a5aab', size: "small", placeholder: locales_store.locales.entries.Lcz_PrivateNote_MaxChar, defaultValue: this.note, onchange: e => this.setNote(e.target.value), value: this.note }), index.h("div", { key: '4366f7b4005d44f497cc430afc68846d754e1844', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '80506040080e616509f25e34a7482eed852a1918', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled", onClickHandler: () => this.closeModal.emit(null), class: `flex-fill'}` }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'd019a7c16c61e7f20cc4693254ee8d6f4ab25b44', size: "medium", onClickHandler: () => this.savePrivateNote(), variant: "brand", loading: this.isLoading }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrBookingHeader = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3c6fa7e2f757c29d234827f256db3833b4d12252', class: "fluid-container px-1" }, index.h("div", { key: 'b0693032d726e2ede7b948a4537ac4a695b9bac5', class: "d-flex flex-column p-0 mx-0 flex-lg-row align-items-md-center justify-content-between" }, index.h("div", { key: '7e669ced290b54b3a8d16e5a617cd0189cc71624', class: "m-0 p-0 mb-1 mb-lg-0 mt-md-0" }, index.h("div", { key: '4d230fdcbeefde7e1b013967f82740fab2a5cab8', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, index.h("p", { key: '8480c4cf2619270046b023d2fb4e753d98513a27', style: { color: 'black' }, class: "font-size-large m-0 p-0" }, `${locales_store.locales.entries.Lcz_Booking}#${this.booking.booking_nbr}`), index.h("wa-dropdown", { key: '05f6e3ff8caa841b6e81e241f48ac702bc2648c2', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                this.bookingStatus = e.detail.item.value;
                this.modalEl.openModal();
            } }, index.h("ir-custom-button", { key: 'c3c427a44f7c28ff28d8ccb59a6d4d47aee566f3', slot: "trigger",
            // onClickHandler={() => {
            ...
            appearance: 'outlined', size: "small", variant: "brand" }, index.h("ir-booking-status-tag", { key: '8fb50fed65e600296bd5a1aeddd8782265c994e1', slot: "start", status: this.booking.status, isRequestToCancel: this.booking.is_requested_to_cancel }), index.h("span", { key: 'd837da4d407c82929222e7cf421cd8946f7f6365' }, "Update status")), this.booking.allowed_actions.map(option => (index.h("wa-dropdown-item", { variant: ['CANC_RA', 'NOSHOW_RA'].includes(option.code) ? 'danger' : 'default', value: option.code }, option.description))))), index.h("p", { key: '89c0703aaff3c05be66d72bc4640571e411822f5', class: "m-0 p-0" }, !this.booking.is_direct && index.h("span", { key: '0e6047680611ac348bb0252dbab76df6d618440f', class: "mr-1 m-0" }, this.booking.channel_booking_nbr))), index.h("div", { key: '75acfcf758c40ef187b1337cc9284287930358cc', class: "d-flex justify-content-end align-items-center", style: { gap: '1rem', flexWrap: 'wrap' } }, index.h("div", { key: '6efac98e3b8e05ed8122d6bb015a006c777bf297', class: "d-flex flex-column align-items-center" }, lastManipulation && (index.h("ir-popover", { key: '004f2650c1c929156774d76c778a48074926a9e4', trigger: "hover", renderContentAsHtml: true, content: `<div><p>Modified by ${lastManipulation.user} at ${lastManipulation.date} ${lastManipulation.hour}:${lastManipulation.minute}.</p>
                <p>${this.alertMessage}</p></div>` }, index.h("p", { key: 'c95c0185e9f4f23fe26aff988d1f1a1bfe53b334', class: "mx-0 p-0 small text-danger", style: { marginTop: '0.25rem', marginBottom: '0' } }, index.h("b", { key: '246da69540e9b2d75e3c1257052d3aef956ffc2d' }, "Modified"))))), this.booking.allowed_actions.length > 0 && this.booking.is_editable && (index.h("div", { key: 'da942262417ed28b687c1e4ac8f59c52657d07e8', class: "m-0 p-0 d-flex align-items-center", style: { gap: '0.25rem' } })), index.h("ir-custom-button", { key: '3bfbd2d6841b4031975b7875e29b1e78660f1258', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'events-log' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "Events log"), index.h("ir-custom-button", { key: '1b1f576ccf4778284cb73e686ba6c1cac5f1fccc', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.openDialog({ type: 'pms' });
            }, appearance: 'outlined', size: "small", variant: "brand" }, "PMS"), this.hasReceipt && (index.h(index.Fragment, { key: '4aab51d4370046e1ac99b442a063b4eb2e67bfa9' }, index.h("ir-custom-button", { key: '1ac92add63cfc4fcd4a3bf3d87c32e9459fea3d5', id: "invoice", variant: "brand", size: "small", appearance: "outlined" }, "Billing"))), this.hasPrint && (index.h(index.Fragment, { key: 'e7a5db5f332f84eb8e18310f932fa7cad3074654' }, index.h("wa-tooltip", { key: 'f2e2a23b4ce89528c50e0233be4ad535b2753e85', for: "print" }, "Print booking"), index.h("ir-custom-button", { key: '4dcea2f7e441ff4c2863538db5c69cd37514fcb7', id: "print", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: 'e5d4a208e097e5861e8f30b8b05dda311e2306ef', label: "Print", name: "print", style: { fontSize: '1.2rem' } })))), this.hasEmail && (index.h(index.Fragment, { key: 'af7655b09fe9ada5bcc2a9737092ffed9c0e023c' }, index.h("wa-tooltip", { key: 'deff9cde18f0b738c4fc195e226c3a213cbe1733', for: "email" }, "Email this booking to guest"), index.h("ir-custom-button", { key: '917635a879822b93e6b4a395fcce4244fdc4130e', id: "email", variant: "brand", size: "small", appearance: "outlined" }, index.h("wa-icon", { key: '5f761f179c189aeac6443166af8328019995659b', name: "envelope", style: { fontSize: '1.2rem' }, label: "Email this booking" })))), this.hasDelete && (index.h(index.Fragment, { key: 'd6f7d82035e638dee9469240f9216c40954a126e' }, index.h("wa-tooltip", { key: '209a116617136e27988e7b0851173b2c5439c20b', for: "book-delete" }, "Delete this booking"), index.h("ir-custom-button", { key: 'b0ccbc15dd5dfaacbe4cc7f345d99c7c611ab046', id: "book-delete", variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: 'b55793944aa78ebf237584ec010400684b4cc51d', name: "envelope", style: { fontSize: '1.65rem' }, label: "Email this booking" })))), this.hasMenu && (index.h(index.Fragment, { key: 'e9759f686858bd855bfc5529e5199b5e14ae15e1' }, index.h("wa-tooltip", { key: 'f3f068e9650d93a103e9e58171508c705e4d67cc', for: "menu" }, "Go back"), index.h("ir-custom-button", { key: 'baef59001c673db3fb9b7e4fd24ca8144a15e4e8', id: "menu", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '297e48060b4863d198a565a857f14695ddef30b0', name: "list", style: { fontSize: '1.65rem' }, label: "Go back" })))), this.hasCloseButton && (index.h("ir-custom-button", { key: '486cf76ebe03a30945c71accc7094b2991690506', onClickHandler: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.closeSidebar.emit(null);
            }, id: "close", variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '934d4ea92f0bf121a5b64ddc2b54ee0559c45d40', name: "xmark", style: { fontSize: '1.65rem' }, label: "Go back" }))))), index.h("ir-dialog", { key: '12e9ea79ecd8f875de0908ee7fdfcc313b00dbb8', onIrDialogHide: _ => {
                this.currentDialogStatus = null;
            }, label: this.currentDialogStatus === 'pms' ? locales_store.locales.entries.Lcz_PMS_Logs : locales_store.locales.entries.Lcz_EventsLog, style: this.currentDialogStatus === 'events-log' && { '--ir-dialog-max-width': 'max-content' }, ref: el => (this.dialogRef = el) }, this.renderDialogBody()), index.h("ir-dialog", { key: 'e4dea3308010d2786cb3e4416ce527b3a0c4f5f3', ref: el => (this.modalEl = el), label: "Alert", lightDismiss: false, onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingStatus = null;
            } }, index.h("p", { key: '69ee4a59176dd6b749517f7dcc62bbf9f10ba148' }, this.booking.is_direct ? 'Are you sure you want to update this booking status?' : locales_store.locales.entries.Lcz_OTA_Modification_Alter), index.h("div", { key: 'bd71452191265a03f5ae9e7213e2ef6fa2685034', class: "ir-dialog__footer", slot: "footer" }, index.h("ir-custom-button", { key: '630eaaff88703b2ca55386c745b981b962ba3b50', "data-dialog": "close", size: "medium", appearance: "filled", variant: "neutral" }, locales_store.locales?.entries?.Lcz_Cancel), index.h("ir-custom-button", { key: '1507e8eba033ec6ba71aa29640d97e8689379769', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateStatus();
...
const IrBookingStatusTag = class {
    ...
    render() {
        return (index.h("wa-badge", { key: '677d743082018bda82b5f7e1762f1380271449f0', style: { padding: '0.375em 0.625em', letterSpacing: '0.03rem' }, variant: this.badgeVariant[this.isRequestToCancel ? '003' : this.status.code] }, this.status.description.toUpperCase()));
    }
};
...
const IrCustomDatePicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1de5744d9dc0bee29f2b1d3c5daf0836a568635d', class: { 'custom-date-picker': true, 'custom-date-picker--open': this.isActive, 'custom-date-picker--disabled': this.disabled } }, index.h("wa-popup", { key: '7d1e590ecf1f374a93340055b1457878cd22e6a4', distance: 8, class: "custom-date-picker__popup", arrow: true, "arrow-placement": "anchor", flip: true, shift: true, active: this.isActive }, index.h("ir-custom-input", { key: 'a83375fa669d745fcab5ddfd35878416378d83e5', placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onKeyDown: this.handleAnchorKeyDown, "aria-invalid": String(this.isPickerInvalid), class: triggerClasses, onClick: this.handleAnchorClick, readonly: true, slot: "anchor", value: this.getTriggerLabel(), label: this.label }, index.h("slot", { key: 'ae2d67586d060e2f48c3b0584acfbf008f617eea', name: "start", slot: "start" }), index.h("slot", { key: '3d9861d2aba0315a66104f00dea06a4d50095056', name: "end", slot: "end" })), index.h("div", { key: '67e6fd774865d119ab3595f1476270425ffc279c', class: "picker-surface" }, index.h("div", { key: '7be84d43e150d2c64848ece2a7b01ea67589cf62', class: "picker-surface__calendar", ref: el => (this.calendarContainerRef = el) }), index.h("input", { key: 'da3606334b333be37156fa72a6804390017f2b79', type: "text", class: "picker-surface__input", ref: el => (this.pickerRef = el), "aria-hidden": "true", tabIndex: -1, readOnly: true })))));
    }
    static get watchers() { return {
...
const IrCustomInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '47545377bf913cb78e4b308d03fc418f1346f5ed' }, index.h("wa-input", { key: 'cf684c267f0125ee9aa36baaef5cb8b5fb9caa5b', type: this.type, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, onchange: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus }, index.h("slot", { key: 'b134eac7201348d25531361178171b07b1b80a1e', name: "label", slot: "label" }), index.h("slot", { key: 'e133cef1c4114a6304611abefd96948ee46b2e95', name: "start", slot: "start" }), index.h("slot", { key: '914024d2189bbc5bfed7b71e3a4cacbb1769d8c6', name: "end", slot: "end" }), index.h("slot", { key: '8fd9b72c68cc816b040afb04c23da547c95c1043', name: "clear-icon", slot: "clear-icon" }), index.h("slot", { key: 'ea7dde711e6ed64decb136d4631758e76eb97b47', name: "hide-password-icon", slot: "hide-password-icon" }), index.h("slot", { key: 'e4f7d6af8c7d2f2bceb35376bf660cb311446d53', name: "show-password-icon", slot: "show-password-icon" }), index.h("slot", { key: 'bd9b736c79231f4e42970f0fa6d51ad226dbd637', name: "hint", slot: "hint" }))));
    }
    static get watchers() { return {
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7f138be0fcc3eb5d853950fcf988bd2479913dd5', class: "d-flex align-items-center" }, index.h("span", { key: 'e1348d1d9dfdfbb9b87b59199628c98a5531c5af' }, this.dates.from_date), ' ', index.h("svg", { key: 'ba068785537675450a37fb060df8443f9c3d0acc', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '154e0ac2aba3965f9baed86cf9f9dd3a488ebd9f', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'f816d47468ace34dd4b1e8de3e18c6acaf6e7b33' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: 'b588e31184b49b68f8c32b1902fd03e33c5ddb1a', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const { state: departuresStore, onChange: onDeparturesStoreChange } = index$3.createStore(initialState);
...
const IrDeparturesFilter = class {
    ...
    render() {
        return (index.h("div", { key: '501b60a928283c691308842e15565bd13c9af350', class: "departures-filters__container" }, index.h("ir-custom-date-picker", { key: 'ee809452ddda506a7a36bb529b76d289d010bb7d', onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                setDeparturesReferenceDate(e.detail.start.format('YYYY-MM-DD'));
            }, date: departuresStore.today, class: "departures-filters__date-picker" }, index.h("wa-icon", { key: '48021ee13b7fd73952cfc2cf841dc8127654cb40', name: "calendar", slot: "start" })), index.h("ir-custom-input", { key: '797572768f2d9dcbd863e24847c02efd604862b6', withClear: true, class: "departures-filters__search-bar", placeholder: "Search guests or bookings", value: departuresStore.searchTerm, "onText-change": this.handleSearchChange }, index.h("wa-icon", { key: '891dea45b9e159f5d697d924ea8d7a5a530a1b4d', name: "magnifying-glass", slot: "start" }))));
    }
};
...
const IrDialog = class {
    ...
    render() {
        return (index.h("wa-dialog", { key: '4985a017f4a210836d6c7d6117b6c654af1bfa8a', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss }, index.h("slot", { key: 'c604ce08de2c3ef95e280f3daf4eb9ca15d88067', name: "header-actions", slot: "header-actions" }), index.h("slot", { key: 'ae2af1bc0d7dad3b4ba48403766d786868b427b7', name: "label", slot: "label" }), index.h("slot", { key: 'b2047c2822b731967fdf9420c43061e129b9606d' }), index.h("slot", { key: 'eeda92c2aa17ff8596a0b7444475174e3f9132d7', name: "footer", slot: "footer" })));
    }
};
__decorate$1([
    OverflowRelease()
...
const IrEmptyState = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f51e8a4c77d058d39aa1dfb9520b4ffbb6278669' }, index.h("slot", { key: '890d873c22da39173f10f648d2f983f664c06617', name: "icon" }, index.h("wa-icon", { key: '925b25de4d0704645c69fe493b6745eeccd1700a', name: "ban", style: { transform: 'rotate(90deg)', fontSize: '2rem' } })), index.h("p", { key: '31de7e096836b0d96bf05251417b63286b12fbc8', part: "message" }, "No records found"), index.h("slot", { key: '2f45fbb2c1c4e34fb66ec81809007472e0e41478' })));
    }
};
...
const IrExtraService = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'da229b3875c5a062c1f9f78961730c17a82ae505' }, index.h("div", { key: 'e58704ba35313adc5b25b2b74022abd8fb72c68f' }, index.h("div", { key: 'd2a2a094102064fe40c568fd1eb3f44484848129', class: 'extra-service-container' }, index.h("p", { key: 'f49e94d745df2a82598917310b474d6f3be28697', class: "extra-service-description" }, this.service.description), index.h("div", { key: 'd04ee92e15216e11803863fc9bbdf1fad8c96bdc', class: "extra-service-actions" }, !!this.service.price && this.service.price > 0 && (index.h("p", { key: 'f2222509f1f06c630db3719276066db95feb0530', class: "extra-service-price p-0 m-0 font-weight-bold" }, utils.formatAmount(this.currencySymbol, this.service.price))), index.h("div", { key: 'da384a1e16bd0fe357368d178f8e90454d398fec', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: '75449df2743c52c6c15faa3d0479cf9b84ccf92f', for: `edit-extra-service-${this.service.booking_system_id}` }, "Edit service"), index.h("ir-custom-button", { key: '5a461e0a65858968d05799be3f5f5c62263f9e65', id: `edit-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.editExtraService.emit(this.service);
            }, iconBtn: true, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '0652f6e4387e4cda92894eab2fc6ffab7c4fb0bf', name: "edit", label: "Edit", style: { fontSize: '1rem' } })), index.h("wa-tooltip", { key: '6002141b34d563d1e14b1bda605f5cf6be7b569e', for: `delete-extra-service-${this.service.booking_system_id}` }, "Delete service"), index.h("ir-custom-button", { key: 'a6f9d14c923d000a10b433afa227b18461443a3f', iconBtn: true, id: `delete-extra-service-${this.service.booking_system_id}`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irModalRef.openModal();
            }, appearance: 'plain', variant: 'danger' }, index.h("wa-icon", { key: '39aba2ff23e19501339521799a8071755b707eed', name: "trash-can", label: "Edit", style: { fontSize: '1rem' } }))))), index.h("div", { key: '46687cd5bd01d853ce3a820eac84af725d3fef9e', class: "extra-service-conditional-date" }, this.service.start_date && this.service.end_date ? (index.h("ir-date-view", { class: "extra-service-date-view mr-1", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (this.service.start_date && index.h("p", { class: "extra-service-date-view" }, moment.hooks(new Date(this.service.start_date)).format('MMM DD, YYYY'))))), index.h("ir-dialog", { key: '3584b0af1d4e6a8f06bd24b9974ba57ff0f3f33d', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales_store.locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales_store.locales.entries.Lcz_ThisService} ${locales_store.locales.entries.Lcz_FromThisBooking}`, index.h("div", { key: '0d3fb25e051bd3c5322588687a61ba224bbde34b', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: '5a9b8b9cb967ebf7f4335503a4a93ad11587e6d0', appearance: "filled", variant: "neutral", size: "medium", "data-dialog": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'dc4579f0a19de65a90e2fc9da1bac1c494dec7f9', onClickHandler: () => this.deleteService(), loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "medium" }, locales_store.locales.entries.Lcz_Delete)))));
    }
};
...
const IrExtraServiceConfig = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: 'de2bfa2e42395b3710b1813678c58eba9c6096da', style: {
                ...
                e.stopPropagation();
                this.closeDialog();
            }, label: locales_store.locales.entries.Lcz_ExtraServices }, this.open && (index.h("ir-extra-service-config-form", { key: '4c55d9f8e07f36b7ed3cf109486cd98b79c274ff', onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeDialog();
            }, booking: this.booking, service: this.service })), index.h("div", { key: 'b63f866259a094c4d22ebbd1eae480dcc62bd6f8', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: '6aab7d9d3ced5f2d42130863bcf1ee54472bb904', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'ba6ed41af8c4fdbdde63aa5a1892fb405a7b461c', type: "submit", loading: irInterceptor_store.isRequestPending('/Do_Booking_Extra_Service'), form: "extra-service-config-form", size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save))));
    }
};
...
const IrExtraServiceConfigForm = class {
    ...
    render() {
        return (index.h("form", { key: 'd188ce1bda1bb3c88d1d1022ed1fd8daba3c2fc5', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, index.h("ir-validator", { key: 'c4028e02b7886142bb05a95a0145ebd495a9e746', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, index.h("wa-textarea", { key: '45917b484d167b5023b6601ec6de6744acd5fce3', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales_store.locales.entries.Lcz_Description })), index.h("ir-custom-date-picker", { key: 'fc2f0177410ed07c17ae8fb531ff8e01c3ff5078', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) }), index.h("ir-custom-date-picker", { key: '5048bf361e2bb5b7677a88d1003f6a380916d000', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), index.h("ir-validator", { key: 'c93819853a37ca5e49d2e48b727e7bdb776a4f97', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, index.h("ir-custom-input", { key: 'd5057bf3358ec244bacc6a5265f7b0d7277db273', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales_store.locales.entries.Lcz_Price }, index.h("span", { key: '0d2d16a8aa21cf091486aa70e901a16544e491d1', slot: "start" }, this.booking.currency.symbol))), index.h("ir-validator", { key: '30bcf898aeb5e0e35905e11cda6a491935a8c26e', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, index.h("ir-custom-input", { key: '821b07bbab7574239b5783952a3b70f6f3776a7b', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales_store.locales.entries.Lcz_Cost }, index.h("span", { key: '239956cada4946285f225bea0389b7b8c7a08f02', slot: "start" }, this.booking.currency.symbol)))));
    }
    static get watchers() { return {
...
const IrExtraServices = class {
    ...
    booking;
    render() {
        return (index.h(index.Host, { key: '82734c29bc703c5fec765c656851a3bf162ecdfd' }, index.h("wa-card", { key: 'bda2ace4caa81237435660658422ea955a62ee69' }, index.h("p", { key: '0b31db261550d251f53acae6a97ea231467629ba', slot: "header", class: 'font-size-large p-0 m-0 ' }, locales_store.locales.entries.Lcz_ExtraServices), index.h("wa-tooltip", { key: 'd3768edede85018b02d602429a277ac78ebdf94a', for: "extra_service_btn" }, "Add extra service"), index.h("ir-custom-button", { key: '3d079749ef12a5678e8d087f8148f21f50445fa4', slot: "header-actions", id: "extra_service_btn", size: "small", appearance: "plain", variant: "neutral" }, index.h("wa-icon", { key: 'a6d1caa6c187de2d5bd91a10a26d09a2da7b3857', name: "plus", style: { fontSize: '1rem' } })), (this.booking.extra_services ?? [])?.length === 0 && (index.h("div", { key: '2b8fb572dc3ca689f9324b5fb4fe4066e557d00e', class: "text-center p-1" }, index.h("p", { key: '12df8d2bce03c6bc95426e6f20edcf9a5ded2911', class: "text-muted" }, "No extra service recorded yet"))), this.booking.extra_services?.map((service, index$1) => (index.h(index.Fragment, null, index.h("ir-extra-service", { bookingNumber: this.booking.booking_nbr, currencySymbol: this.booking.currency.symbol, key: service.booking_system_id, service: service }), index$1 !== this.booking.extra_services.length - 1 && index.h("wa-divider", null)))))));
    }
};
...
const IrGuestInfoDrawer = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: '946b2521f67486a8bc82574480fed92ce447ba87', open: this.open, label: drawerLabel, onDrawerHide: this.handleDrawerHide, style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                '--ir-drawer-padding-top': 'var(--spacing)',
                '--ir-drawer-padding-bottom': 'var(--spacing)',
            } }, this.isLoading ? (index.h("div", { class: 'loading-container' }, index.h("wa-spinner", { style: { fontSize: '2rem' } }))) : (index.h("ir-guest-info-form", { guest: this.guest, countries: this.countries, language: this.language, autoValidate: this.autoValidate, onGuestChanged: this.handleGuestChanged })), index.h("div", { key: '3dd48cc0b41bf77a34362b97d7881b9ee8e9e056', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'f9502e50689a51ed4fa4c088a072a3d1ff834925', size: "medium", appearance: "filled", variant: "neutral", type: "button", onClickHandler: this.handleCancel }, locales_store.locales.entries?.Lcz_Cancel || 'Cancel'), index.h("ir-custom-button", { key: 'e3f9223e4c0ca8c39c8df43f43e45e6760300c63', size: "medium", variant: "brand", onClick: () => this.editGuest(), loading: irInterceptor_store.isRequestPending('/Edit_Exposed_Guest'), disabled: this.isLoading }, locales_store.locales.entries?.Lcz_Save || 'Save'))));
    }
    static get watchers() { return {
        "ticket": ["ticketChanged"],
        "open": ["openChanged"]
...
const IrGuestInfoForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f6daae2a016ca7a5f5d47e21f75218d31aa7893f' }, index.h("ir-validator", { key: '9fc64ea8fc8224c5ff81dde00633690273ebdb7e', schema: guestInfoFormSchema.shape.first_name, value: this.guest?.first_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '0fe056de91d0d10943b4874116936676c0420296', id: 'firstName', value: this.guest?.first_name, required: true, "onText-change": e => this.handleInputChange({ first_name: e.detail }), label: locales_store.locales.entries?.Lcz_FirstName })), index.h("ir-validator", { key: '99afb414d907e9f8c31f10423bcf76b07687551b', schema: guestInfoFormSchema.shape.last_name, value: this.guest?.last_name ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: 'e8f2d885a5731cb7956f3d055c3ef3a6239a4e5f', value: this.guest?.last_name, required: true, id: "lastName", "onText-change": e => this.handleInputChange({ last_name: e.detail }), label: locales_store.locales.entries?.Lcz_LastName })), index.h("ir-validator", { key: 'c5915e9ffa3bfc9a98d90809c300be3fb7f2b318', schema: guestInfoFormSchema.shape.email, value: this.guest?.email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '154a58b31845d7e5870783e673c1d7a304fc5250', label: locales_store.locales.entries?.Lcz_Email, id: "email", value: this.guest?.email, required: true, "onText-change": e => this.handleInputChange({ email: e.detail }) })), index.h("ir-validator", { key: 'd481516daf699dfde7467102376c745431a849b7', schema: guestInfoFormSchema.shape.alternative_email, value: this.guest?.alternative_email ?? '', autovalidate: this.autoValidate, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '71ed797d31dc6d75cbf2461129fdcc06295d8629', label: locales_store.locales.entries?.Lcz_AlternativeEmail, id: "altEmail", value: this.guest?.alternative_email, "onText-change": e => this.handleInputChange({ alternative_email: e.detail }) })), index.h("ir-validator", { key: 'a17ecdc7fa581042ca40d0d8efa8359857bcbd4f', schema: guestInfoFormSchema.shape.country_id, value: this.guest?.country_id ?? undefined, autovalidate: this.autoValidate, valueEvent: "countryChange" }, index.h("ir-country-picker", { key: '131c31baebb04a77d9845e5c2ffc860ac9d00bfd', size: "small", variant: "modern", country: this.countries.find(c => c.id === this.guest?.country_id), label: locales_store.locales.entries?.Lcz_Country, onCountryChange: e => this.handleInputChange({ country_id: e.detail.id }), countries: this.countries })), index.h("ir-validator", { key: '670439c35ec6ab3e4d0b30eaa8167381c155ec47', schema: guestInfoFormSchema.shape.mobile, value: this.guest?.mobile ?? '', autovalidate: this.autoValidate, valueEvent: "mobile-input-change" }, index.h("ir-mobile-input", { key: 'f4da263f62e73f8a9ea133da09305738c4d7187b', size: "small", "onMobile-input-change": e => {
                this.handleInputChange({ mobile: e.detail.formattedValue });
            }, "onMobile-input-country-change": e => this.handleInputChange({ country_phone_prefix: e.detail.phone_prefix }), value: this.guest?.mobile ?? '', required: true, countryCode: this.countries.find(c => c.phone_prefix === this.guest?.country_phone_prefix)?.code, countries: this.countries })), index.h("ir-validator", { key: '97d908de56bbb43a4b02207dd1e781f2e5b1fe33', schema: guestInfoFormSchema.shape.notes, value: this.guest?.notes ?? '', autovalidate: this.autoValidate, valueEvent: "wa-change change input", blurEvent: "wa-blur blur" }, index.h("wa-textarea", { key: '0db1974934429ebe4c22eb5b2769fa936974df4b', size: "small", onchange: e => this.handleInputChange({ notes: e.target.value }), value: this.guest?.notes ?? '', label: locales_store.locales.entries?.Lcz_PrivateNote }))));
    }
};
...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (index.h("button", { key: '2ce10db0710f2e5a3307a3e67bc08533210777a8', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: '9669ef0486ce3f7ec28e747d8488de7d7b7b5702', name: "icon" })));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5ae7926d2d6250be859a9ab2a963b9588f8ea680' }, this.isLoading && !this.isPageLoadingStopped && (index.h("div", { key: '90c876c95f7f39477d6e03e6e7a63e38185091f0', class: "loadingScreenContainer" }, index.h("div", { key: 'c5a095a0ccf1d4466cfb5f4a9bfba20b46736349', class: "loaderContainer" }, index.h("ir-spinner", { key: '2fcb84b90ac04223cfb43c2d10248205b23af89e' })))), this.showModal && (index.h("ir-otp-modal", { key: '6cfe5f60f91df27b1a9246a2e867a9b377f1ec80', email: this.email, baseOTPUrl: this.baseOTPUrl, requestUrl: this.requestUrl, ref: el => (this.otpModal = el), onOtpFinished: this.handleOtpFinished.bind(this) }))));
    }
};
...
const IrInvoice = class {
    ...
    render() {
        return (index.h(index.Host, { key: '97d05c76facccc5268e7888166fbc75fcf14c67c' }, index.h("ir-drawer", { key: 'e75dafa1786345c58b91ebc337f8acec49d714a4', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeDrawer();
            } }, index.h("div", { key: '2b655461fd3a5b4738a0964ce8638d718bed2bf7', class: "d-flex align-items-center", slot: "header-actions" }, index.h("wa-switch", { key: 'dea6cba32571f6b11953fe0fa2b4d29188a2bf26', onchange: e => {
                if (e.target.checked) {
            ...
            } }, "Pro-forma")), this.open && (index.h("ir-invoice-form", { key: '7d3bde2889e7d6709aa3f7cb440d54a98a51f8a3', viewMode: this.viewMode, for: this.for, roomIdentifier: this.roomIdentifier, booking: this.booking, autoPrint: this.autoPrint, formId: this._id, invoiceInfo: this.invoiceInfo, onLoadingChange: e => (this.isLoading = e.detail) })), index.h("div", { key: 'ee0ac917957a5f4525fae267aa65c934d7c181d1', slot: "footer", class: "ir__drawer-footer" }, index.h("ir-custom-button", { key: 'a34e940777ac03d67a854ad511b4054a9884d6a7', size: "medium", appearance: "filled", class: "w-100 flex-fill", variant: "neutral", onClickHandler: () => {
                this.closeDrawer();
            } }, "Cancel"), index.h("ir-custom-button", { key: '8c85f3885e63a9c7305e1baa726a09bc87f6b76e', loading: this.isLoading, value: "invoice", type: "submit", form: this._id, class: "w-100 flex-fill", size: "medium", variant: "brand" }, "Confirm")))));
    }
};
...
const IrLoadingScreen = class {
    ...
    message = '';
    render() {
        return (index.h("div", { key: '100feff23fd91de910ba78570b9d39b01faaf42a', class: "loader__container" }, index.h("wa-spinner", { key: '77ad70e8f950625f940256ec4d969d27a6602120', style: { fontSize: '2.5rem' } })));
    }
};
...
const IrMobileInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '97ab91e6194c10d3deaabd52e786e2c43a8ae86c', size: 'small', role: "group", "aria-labelledby": this.labelId, "aria-describedby": describedByIds }, index.h("label", { key: 'f4777767ad6f69b246110bdcc0a2e035cf351793', class: "mobile-input__label", id: this.labelId, htmlFor: this.inputId }, this.label, this.required ? (index.h("span", { class: "mobile-input__required", "aria-hidden": "true" }, "*")) : null), this.description ? (index.h("p", { id: this.descriptionId, class: "mobile-input__description" }, this.description)) : null, index.h("div", { key: 'f17e8eb8bb8ec55a10b50ad9ea04d0bb989df66e', class: { 'mobile-input__container': true, 'mobile-input__container--disabled': this.disabled } }, index.h("wa-dropdown", { key: '4cf4752091cc73860b1b7cf085b6c3fa16678d37', "onwa-show": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-hide": e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
            }, "onwa-select": this.handleCountrySelect, class: "mobile-input__prefix-dropdown" }, index.h("button", { key: '68910725596da004a7bd86182157c6dbe8ac2920', slot: "trigger", type: "button", class: "mobile-input__trigger", disabled: this.disabled, "aria-haspopup": "listbox", "aria-label": "Change country calling code" }, index.h("div", { key: '45d59ba47d9c199596a2a29f893e8432a0abee22', class: "mobile-input__phone-country", style: { marginRight: '1rem' } }, this.selectedCountry ? index.h("img", { src: this.selectedCountry?.flag, alt: this.selectedCountry?.name, class: "mobile-input__logo" }) : index.h("span", null, "Select")), index.h("wa-icon", { key: '1ba85588a0833cfe447543c23ac05a47879bf2cb', class: "mobile-input__phone-country-caret", name: "chevron-down", "aria-hidden": "true" })), index.h("span", { key: 'b43bae5543291c3b4ac58ba33b716d2129fc40db', class: "sr-only", id: this.countryStatusId, "aria-live": "polite" }, this.selectedCountry ? `Selected country ${this.selectedCountry.name} ${this.selectedCountry.phone_prefix}` : 'Select a country'), this.countries.map(country => (index.h("wa-dropdown-item", { value: country.id.toString() }, index.h("div", { class: "mobile-input__phone-country", role: "option", "aria-selected": this.selectedCountry?.id === country.id ? 'true' : 'false' }, index.h("img", { src: country.flag, alt: country.name, class: "mobile-input__logo" }), index.h("span", { class: "mobile-input__country-name" }, country.name), index.h("span", { class: "mobile-input__country-prefix" }, country.phone_prefix)))))), index.h("input", { key: '0c471d5c7ceb05c35eef333cb473d09ea809cf24', ref: el => (this.inputRef = el), id: this.inputId, class: {
...
const IrOtp = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f21c70e442fa427fe5b59ec42eaa0aa5adc802e1', class: "otp-input-container" }, index.h("div", { key: '313c7f673a6ece484c2c121c8a25c89d4ca07380', class: "otp-input-wrapper" }, Array(this.length)
            .fill(null)
...
const IrPaymentFolio = class {
    ...
    render() {
        ...
        return (index.h("ir-drawer", { key: 'f31698f3a1f91d25541cb068950a9216e8d3be23', placement: "start", style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                event.stopPropagation();
                this.closeFolio();
            } }, this.isOpen && (index.h("ir-payment-folio-form", { key: '8108780a16283ff2d831a6ea9ffee540aaad4b68', formId: this._id, onLoadingChanged: e => (this.isLoading = e.detail), onCloseModal: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.closeFolio();
            }, paymentEntries: this.paymentEntries, bookingNumber: this.bookingNumber, payment: this.payment, mode: this.mode })), index.h("div", { key: '64109e89e195398072e8164980caaa596363e94c', slot: "footer", class: "w-100 d-flex align-items-center", style: { gap: 'var(--wa-space-xs)' } }, index.h("ir-custom-button", { key: 'a6c3401c4adc5fc7d4b25ff3900c48d18d3252ba', class: "flex-fill", size: "medium", "data-drawer": "close", appearance: "filled", variant: "neutral", onClickHandler: () => this.closeFolio() }, "Cancel"), index.h("ir-custom-button", { key: '2d8b7dfe6630a310558e2002950eb2c2a4c6263c', form: this._id, loading: this.isLoading === 'save', class: "flex-fill", size: "medium", type: "submit", value: "save",
...
const IrPaymentFolioForm = class {
    ...
    render() {
        // const isNewPayment = this.folioData?.payment_type?.code === '001' && this.folioData.id === -1;
        return (index.h("form", { key: 'ae4168bb6622b5673b21d1487e14009c2639557b', onSubmit: e => {
                e.preventDefault();
                const submitter = e.submitter;
                if (submitter?.value === 'save') {
                    this.savePayment();
                }
            }, class: "payment-folio__form", id: this.formId }, index.h("ir-custom-date-picker", { key: 'e920c8a7632a2e8630645fd57f8c2e20adb90ab8', id: this.controlIds.date, label: "Date", "aria-invalid": this.errors?.date && !this.folioData?.date ? 'true' : 'false', "data-testid": "pickup_date", onDateChanged: evt => {
                this.updateFolioData({ date: evt.detail.start?.format(DATE_FORMAT) });
            }, minDate: moment.hooks().add(-2, 'months').format('YYYY-MM-DD'), emitEmptyDate: true, maxDate: this.today, date: this.folioData?.date }), index.h("ir-validator", { key: '8d51ec239f10cbb5759c807d3c8ba4d283b313b0', value: this.folioData?.payment_type?.code, autovalidate: this.autoValidate, schema: paymentTypeSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: 'a7b76e8cc49b86d667fe4c71a78b559c622d2075', id: this.controlIds.transactionType, size: "small", "onwa-hide": event => this.stopEventPropagation(event), "onwa-show": event => this.stopEventPropagation(event), placeholder: "Select...", label: "Transaction type", defaultValue: this.folioData?.payment_type?.code, value: this.folioData?.payment_type?.code, disabled: this.mode === 'payment-action', onchange: event => {
                this.stopEventPropagation(event);
                this.handleDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: 'c25694c419afe91202efe823714bd8fea68be0ae', value: "" }, "Select..."), this.renderDropdownItems())), this.requiresPaymentMethod(this.folioData?.payment_type?.code) && (index.h("ir-validator", { key: '665096c5f29f784e90d974f763f72b1ba59f85ae', value: this.folioData?.payment_method?.code ?? '', autovalidate: this.autoValidate, schema: paymentMethodSchema.shape.code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide" }, index.h("wa-select", { key: '371c059298c7350fad77dfa73a709a5b9a91d51d', id: this.controlIds.paymentMethod, size: "small", label: `${this.folioData.payment_type?.code === '001' ? 'Payment' : 'Refund'} method`, "onwa-show": event => this.stopEventPropagation(event), "onwa-hide": event => this.stopEventPropagation(event), defaultValue: this.folioData?.payment_method?.code, value: this.folioData?.payment_method?.code ?? '', onchange: event => {
                this.stopEventPropagation(event);
                this.handlePaymentMethodDropdownChange(event.target.value);
            } }, index.h("wa-option", { key: '0b3454c43c821523bf95f3fa3552426738220260', value: "" }, "Select..."), this.paymentEntries?.methods?.map(pt => {
            return (index.h("wa-option", { key: pt.CODE_NAME, label: pt.CODE_VALUE_EN, value: pt.CODE_NAME }, pt.CODE_VALUE_EN));
        })))), index.h("ir-validator", { key: '0baa3289bcc9be8ffcdb05db4ea71c545e2ea048', value: this.folioData?.amount?.toString() ?? undefined, autovalidate: this.autoValidate, schema: folioBaseSchema.shape.amount, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-custom-input", { key: '7deaceddaca9afaa9f1c48d2377133d6a46cb027', id: this.controlIds.amount, "aria-invalid": String(!!this.errors?.amount), value: this.folioData?.amount?.toString() ?? '', label: "Amount", mask: "price", min: 0, "onText-change": e => this.updateFolioData({ amount: !e.detail ? undefined : Number(e.detail) }) }, index.h("span", { key: 'b23dba7894fe07aeaf12c9abd88e59af6d294ccf', slot: "start" }, calendarData.calendar_data.currency.symbol))), index.h("ir-validator", { key: '408936904f2857ca98f377f92253be8350f6fd03', value: this.folioData?.reference ?? '', autovalidate: this.autoValidate, schema: folioBaseSchema.shape.reference, valueEvent: "text-change input input-change", blurEvent: "input-blur" }, index.h("ir-custom-input", { key: '1ecfbb7bb4196de0dbbe26a7d9be83a578ca848a', id: this.controlIds.reference, value: this.folioData?.reference ?? '', label: "Reference", maxlength: 50, "onText-change": e => this.updateFolioData({ reference: e.detail ?? '' }) }))));
    }
    static get watchers() { return {
...
const IrPaymentItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '975efda06d42fafcaf2406f7b410d644f97ce119', class: "payment-item__payment-item" }, index.h("div", { key: '4b9c0e754125693cacacd569618f388ea64b8059', class: "payment-item__payment-body", part: "payment-body" }, index.h("div", { key: 'fe0ed3312e70c62050b5a9c250e9717726d51dc3', class: "payment-item__payment-fields", part: "payment-fields" }, index.h("p", { key: '1ca29b776e9fc30a96d5ba735c59a3059f6048ce', class: "payment-item__payment-date" }, moment.hooks(this.payment.date, 'YYYY-MM-DD').format('MMM DD, YYYY')), index.h("p", { key: '62d30c96b6f8d539e7deef2ebf0eb27330146b73', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'c4bb5cd51a94dbdfb4129e4e91c8b5776049f289', class: "payment-item__payment-description" }, paymentDescription)), this.payment.reference && index.h("p", { key: '80578ef745c4b1407cba21d6f76553c8a2c81c51', class: "payment-item__payment-reference" }, this.payment?.reference)), index.h("div", { key: '23e794088d3a347624272aa091f7243ff2cdfff7', class: "payment-item__payment-toolbar" }, index.h("p", { key: '3adb18a0ff89f727fe8f49ad1dada8653f9214e6', class: `payment-item__payment-amount ${isCredit ? 'is-credit' : 'is-debit'}` }, utils.formatAmount(this.payment.currency.symbol, this.payment.amount)), index.h("p", { key: 'a762aa292f963f8957e051cf77cfb3cd024d31ac', class: "payment-item__payment-description" }, paymentDescription), index.h("div", { key: '350fdfa2411d6cab8153344be2e63344c7f18d2c', class: "payment-item__payment-actions" }, index.h("div", { key: '738ee81565063211a9ac1d9eb54e63904d0125ad', class: "d-flex align-items-center" }, index.h("wa-tooltip", { key: 'acd35b677ae91c8043a96f95784b5c1db815a51c', for: this._id }, "User: ", this.payment.time_stamp.user), index.h("wa-icon", { key: 'a813bcc8097be164f4626e4b7d137bb94a1d2646', name: "user", id: this._id }), index.h("wa-dropdown", { key: 'efce17b008071913812681bec2e748655a64efaa', "onwa-hide": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-select": e => {
                switch (e.detail.item.value) {
            ...
            } }, index.h("ir-custom-button", { key: 'cbcfc9c1cac56062c4570ccb99a3eb0763540298', slot: "trigger", appearance: "plain" }, index.h("wa-icon", { key: '2ee2d4d69282fdfa079f9cd2a49cc6de9ca7414b', name: "ellipsis-vertical" })), this.payment.payment_type.code === '001' && (index.h("wa-dropdown-item", { key: '8a5c3f81212731965c85a2dd63f69a2cb7acc26f', value: "receipt" }, index.h("wa-icon", { key: 'bbac27273d3e85e13fad46a7671239ab3450c387', name: "receipt", slot: "icon" }), "Print Receipt")), index.h("wa-dropdown-item", { key: 'fd10e9ab856a1fdefe9f9a4fe4ba9e2771411850', value: "edit" }, index.h("wa-icon", { key: '8a872f06444f1c507ad1e9e46777978ffc5c8ccf', slot: "icon", name: "edit" }), "Edit"), index.h("wa-dropdown-item", { key: '1cf0120bbd7a897d002e09c656234537d656426d', value: "delete", variant: "danger" }, index.h("wa-icon", { key: '4e45afca69a47b099896e115c48534c1ff08a5a2', slot: "icon", name: "trash" }), "Delete"))))), this.payment.reference && index.h("p", { key: 'e59c35660f503e1c455ccbac3019bed3d87b4d8c', class: "payment-item__payment-reference" }, this.payment?.reference)));
    }
};
...
const IrPaymentSummary = class {
    ...
    render() {
        return (index.h("div", { key: '336c5af2578684dce7bd19992ad0b20782656512', class: " m-0" }, this.shouldShowTotalCost() && (index.h("div", { key: 'b9576c27e5a095873b8377ca18d23e641fe036fa', class: "mb-2 h4 total-cost-container" }, locales_store.locales.entries.Lcz_TotalCost, ":", index.h("span", { key: 'f5e91ab25ec8ac4d4dc8af0cbde15cbd475237ba' }, utils.formatAmount(this.currency.symbol, this.totalCost)))), index.h("div", { key: '2d6fdfa1b3fbb17e93a6b0a6f8eab6f4991da362', class: "h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: 'b61aa6abb4a4a2fa9852bd785e0d71080895f040' }, locales_store.locales.entries.Lcz_Balance, ": "), index.h("span", { key: '35aa21ee877cc8b4257e3d24d64a093a4cc656a9', class: "danger font-weight-bold" }, utils.formatAmount(this.currency.symbol, this.balance))), !this.isBookingCancelled && (index.h("div", { key: '8a5924fd25080f9d9bb4dc1f805fe657f829ea4b', class: "mb-2 h4 d-flex align-items-center justify-content-between" }, index.h("span", { key: '084a73d518478e173ef095a5dca13d2e4afb8f84' }, locales_store.locales.entries.Lcz_Collected, ": "), index.h("span", { key: '0ee497e5ac6d6960fbce6ee0ee206e20824f3532' }, utils.formatAmount(this.currency.symbol, this.collected))))));
    }
};
...
const IrPaymentsFolio = class {
    ...
    render() {
        return (index.h("wa-card", { key: '968100c4f314511d37076708a46650b953d6324a', class: " payments-container" }, index.h("div", { key: '65a065091c2a717e932899081d09949353612291', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, index.h("p", { key: 'd54eaa605172b3ad4a86e6d44bcd76fdc5a102b6', class: "font-size-large p-0 m-0" }, "Guest Folio"), index.h(HelpDocButton, { key: '7662222d0ba114385359004c744a6653201f8003', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), index.h("wa-tooltip", { key: 'd7d343f70065336aae6ff62326d27775b05c7ae4', for: "create-payment" }, "Add Payment"), index.h("ir-custom-button", { key: '1363db6eac820603c21788134baf025786818711', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, index.h("wa-icon", { key: 'd9c50aa2e4ae938a675f266144d71deb6e5f0638', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
};
...
const IrPicker = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9053fbe8e7fc13e7a8c309caf706cf225e9ef0c1' }, index.h("wa-popup", { key: '5a2aaef12589265593744f78e16b8bba857cfe8e', flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, index.h("wa-input", { key: '277aa2b64d676bae6e331e8eda2eb469fec600bb', slot: "anchor", class: "search-bar",
            // withClear
            size: this.size, value: this.query, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
            } }, this.loading && index.h("wa-spinner", { key: 'b872b831af31210909afbd8b267381b6ded77d7b', slot: "end" }), index.h("wa-icon", { key: '1d0088b32db6e72e5b3a95bfccb1b2a3072dec57', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), !this.loading && (index.h("div", { key: '550f9ee5dd32b0bda004877fba48bef03e305b4c', class: "menu", role: "presentation" }, index.h("p", { key: 'dd9be93053853fee7e28927c5782e2caf8693c00', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), index.h("ul", { key: '1f20e4da089f4e3849bdd888b5d9283d3e6ecf43', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, index.h("slot", { key: 'b027f492fcc7198e88b47d41bea566424428a051', onSlotchange: this.handleSlotChange }), !hasResults && (index.h("li", { key: '5c7b8034cf9db480b26a05980ac17b662f8a1947', class: "empty-state", role: "presentation", id: this.emptyStateId }, index.h("wa-icon", { key: 'd20437dd5c5fba96214a347c1efd39ab0f5d01c7', name: "circle-info", "aria-hidden": "true" }), index.h("p", { key: '58409fb65e7de8551e5b5487c3861c73d8568341' }, "No results found"))))))), index.h("span", { key: '3f1cd7d7db661626b58dabec6103ea7669abe3e6', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
...
const IrPickerItem = class {
    ...
    selected = false;
    render() {
        return (index.h(index.Host, { key: '33e85516cbe48b88fb86e08bbc5e956dd1758926', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("button", { key: '910ef0fbbcaf30c4f8b9496ccf6551cd5806dd67', class: `picker-item__container`, type: "button", tabindex: "-1", disabled: this.disabled, part: "base" }, index.h("wa-icon", { key: 'ec1518e00da501d327b5bffc8e804da0a3968b21', class: "picker-item__check", name: "check" }), index.h("div", { key: '82ed26f039fb861ce7f4f858566de36a7d0c53fd', class: "picker-item__content", part: "content" }, index.h("slot", { key: '496486e8e38f94ffca9c14fb91d3aa6b93659028' })))));
    }
};
...
const IrPickup = class {
    ...
    render() {
        return (index.h("ir-drawer", { key: '51a7aa6c1094d06479183d031eb17be9ba7a4622', style: {
                '--ir-drawer-width': '40rem',
                '--ir-drawer-background-color': 'var(--wa-color-surface-default)',
                '--ir-drawer-padding-left': 'var(--spacing)',
                '--ir-drawer-padding-right': 'var(--spacing)',
                ...
                e.stopPropagation();
                this.closeModal.emit();
            } }, this.open && (index.h("ir-pickup-form", { key: '1455268c7697c5941544b3dafc1890c4af1aca2b', onCanSubmitPickupChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.closeModal.emit();
            }, formId: this._id })), index.h("div", { key: 'b87e00eeee84a5ff4f73f2c648c4b82dcd2fff5c', slot: "footer", class: 'ir__drawer-footer' }, index.h("ir-custom-button", { key: 'b18eb516d752c94a3c3b4ba1da48c6f2148996c5', class: `flex-fill`, size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, locales_store.locales.entries.Lcz_Cancel), this.canSubmitPickup && (index.h("ir-custom-button", { key: '4c1a385f028f1b119e8feb53cb0b6ac31f7c896c', type: "submit", loading: this.isLoading, form: this._id, size: "medium", class: `flex-fill`, variant: "brand" }, locales_store.locales.entries.Lcz_Save)))));
    }
};
...
const IrPickupForm = class {
    ...
    render() {
        return (index.h("form", { key: 'f760922db42ab5e054bc4366e8da721637642e71', id: this.formId, class: "pickup__container", onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, index.h("ir-validator", { key: 'e792694af0312abce46771f8a06b877dc953cd91', schema: this.pickupSchema.shape.location, autovalidate: this.autoValidate, value: this.pickupData.location, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: 'fabc22a1f5813fd7920d3d0baa7f6dd6225ee27b', size: "small", onchange: e => this.handleLocationChange(e.target.value), defaultValue: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString(), value: this.pickupData.location === -1 ? '' : this.pickupData.location?.toString() }, index.h("wa-option", { key: 'b4d35a4d46a34735486fb37b7af0584cefcdfa7e', value: "" }, locales_store.locales.entries.Lcz_Pickup_NoThankYou), this.pickupService.getAvailableLocations(locales_store.locales.entries.Lcz_Pickup_YesFrom).map(option => (index.h("wa-option", { key: `pickup-location-${option.value}`, value: option.value?.toString() }, option.text))))), this.shouldRenderDetails && (index.h("div", { key: 'd888d3f8304117be3ad1a2de7841273e00a83e7a', class: "pickup__container", "data-testid": "pickup_body" }, index.h("ir-validator", { key: '68b1ad0fd2056b3cf7da44edb1f5ac2d0a5248ea', schema: this.pickupSchema.shape.arrival_date, autovalidate: this.autoValidate, value: this.pickupData.arrival_date ?? '', valueEvent: "dateChanged", blurEvent: "datePickerBlur blur" }, index.h("ir-custom-date-picker", { key: '1acfff57ebbe5b884045ab5a6ad37c12e9ad3144', date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: this.bookingDates?.to, emitEmptyDate: true, onDateChanged: evt => {
                this.updatePickupData('arrival_date', evt.detail.start?.format('YYYY-MM-DD') ?? null);
            }, label: locales_store.locales.entries.Lcz_ArrivalDate })), index.h("ir-validator", { key: '1a8b79606897d04484d36e5c78d83587bc641b73', schema: this.pickupSchema.shape.arrival_time, autovalidate: this.autoValidate, value: this.pickupData.arrival_time, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: 'b060605d151d68b9c81a76ed3312b0188e5c1e91', value: this.pickupData.arrival_time, "onText-change": e => {
                this.updatePickupData('arrival_time', e.detail);
            }, mask: 'time', label: locales_store.locales.entries.Lcz_Time })), index.h("ir-validator", { key: 'd6a2ac933bec29723acd5e9518629ace98289758', schema: this.pickupSchema.shape.flight_details, autovalidate: this.autoValidate, value: this.pickupData.flight_details, valueEvent: "text-change input input-change", blurEvent: "input-blur blur" }, index.h("ir-custom-input", { key: '6ef5f4aa8f63bbdf6b225812ae5d43e7b178dd1f', "onText-change": e => this.updatePickupData('flight_details', e.detail), value: this.pickupData.flight_details, label: locales_store.locales.entries.Lcz_FlightDetails })), index.h("ir-validator", { key: '770577df3c65ef80b08dddcdf1012f9aba8e7521', schema: this.pickupSchema.shape.vehicle_type_code, autovalidate: this.autoValidate, value: this.pickupData.vehicle_type_code, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '5486e6d400cca6091a9722225a0766a4a759b3a5', size: "small", onchange: e => this.handleVehicleTypeChange(e.target.value), value: this.pickupData.vehicle_type_code, defaultValue: this.pickupData.vehicle_type_code }, this.allowedOptionsByLocation.map(option => (index.h("wa-option", { value: option.vehicle.code, key: option.vehicle.code }, option.vehicle.description))))), index.h("ir-validator", { key: 'bc60b50d6cb981a6b5195efba5920ebb77e4c911', schema: this.pickupSchema.shape.number_of_vehicles, autovalidate: this.autoValidate, value: this.pickupData.number_of_vehicles, valueEvent: "change wa-change select-change", blurEvent: "wa-hide blur" }, index.h("wa-select", { key: '75ad8186913a104acad814176a1da7511ea73c9c', size: "small", defaultValue: this.pickupData.number_of_vehicles?.toString(), value: this.pickupData.number_of_vehicles?.toString(), label: locales_store.locales.entries.Lcz_NbrOfVehicles, onchange: e => {
                this.handleVehicleQuantityChange(Number(e.target.value));
            } }, this.vehicleCapacity.map(i => (index.h("wa-option", { key: `capacity_${i}`, value: i.toString() }, i))))), index.h("ir-custom-input", { key: '06aa8886b9afb6477686ede7c8d7930c005f060a', mask: 'price', readonly: true, label: `${locales_store.locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking }, index.h("span", { key: '89d7bf6203363a7883cb88c93022987ee594559a', slot: "start" }, this.pickupData.currency?.symbol))))));
    }
    static get watchers() { return {
...
const IrPopover = class {
    ...
    render() {
        return (index.h(index.Host, { key: '919ac1f63f118582f17c49673898b16189484fbd', style: { '--ir-popover-left': this.irPopoverLeft } }, this.trigger !== 'focus' ? (index.h("p", { ref: el => (this.popoverTrigger = el), class: "popover-title m-0 p-0", style: {
                whiteSpace: 'nowrap',
                overflow: 'hidden',
...
const IrPriceInput = class {
    ...
    render() {
        return (index.h("fieldset", { key: '737308a49d59201de32089330df3e4e831acdbc1', class: `${this.containerClassname} input-group price-input-group m-0 p-0 ` }, this.label && (index.h("div", { key: '3d1c1ba277b56ffba4842d0db4a4aed505314063', class: `input-group-prepend ${this.labelContainerClassname}` }, index.h("span", { key: '6bc2d4f87919989f7b0dee9ec1085efffce42a56', class: `input-group-text 
                ${this.labelStyle}
              ${this.hasSpecialClass('ir-bl-lbl-none') ? 'ir-bl-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-lbl-none') ? 'ir-br-lbl-none' : ''}
              ${this.hasSpecialClass('ir-br-none') ? 'ir-br-none' : ''} 
              ${this.hasSpecialClass('ir-bl-none') ? 'ir-bl-none' : ''} 
              ` }, index.h("label", { key: 'e12efb07bca69ce32fbea1670ef477dc5ca1abf9', class: 'p-0 m-0 ', htmlFor: this.id }, this.label)))), index.h("div", { key: '576aeb8e53007c6af8e97edc141d6647dc711125', class: "position-relative has-icon-left rate-input-container" }, this.currency && (index.h("div", { key: '6ad7d8ccff61775d5293d6a805c2736270538df9' }, index.h("span", { key: '479b4f529549a7aa867370ff4d1c5820251a9a74', class: `input-group-text ${this.disabled ? 'disabled' : ''} currency-label ${this.error ? 'error' : ''} ${this.label ? 'with-label' : ''}` }, this.currency))), index.h("input", { key: '0e316df26217fa3d5c7fbfdd0631b13564b82220', ref: el => (this.inputRef = el), "data-testid": this.testId, disabled: this.disabled, id: this.id, class: `form-control input-sm rate-input 
              ${this.inputStyle}
...
const IrReservationInformation = class {
    ...
    render() {
        ...
        return (index.h("wa-card", { key: 'e163c49d4b351f13d4dc11dbaafa4f5088f1be10' }, index.h("div", { key: '9dfa1877761e2fa710388d5a348dc8c9d8599a23', class: "reservation-information", ref: el => (this.reservationInformationEl = el) }, index.h("p", { key: 'bfb8597150ca8295ac6ab3d6806eff5bb26da62a', class: "reservation-information__property-name" }, this.booking.property.name || ''), index.h("ir-label", { key: '83684304f54a98782a921288ad8d431f34f82370', labelText: `${locales_store.locales.entries.Lcz_Source}:`, content: this.booking.origin.Label, image: { src: this.booking.origin.Icon, alt: this.booking.origin.Label } }), index.h("ir-label", { key: 'ad18ce6e188a5eb90cd20cc1af41984bace6ad45', renderContentAsHtml: true, labelText: `${locales_store.locales.entries.Lcz_BookedOn}:`, content: `${functions._formatDate(this.booking.booked_on.date)}&nbsp&nbsp&nbsp&nbsp${functions._formatTime(this.booking.booked_on.hour.toString(), this.booking.booked_on.minute.toString())}` }), index.h("div", { key: '39a2aa07228820f4f661d37b37cb4b00567e8adf', class: "reservation-information__row" }, index.h("ir-label", { key: 'd55af053ba8ea0c007a128d748e9341212a1fa0b', labelText: `${locales_store.locales.entries.Lcz_BookedBy}:`, content: `${this.booking.guest.first_name} ${this.booking.guest.last_name}` }, this.booking.guest?.nbr_confirmed_bookings > 1 && !this.booking.agent && (index.h("div", { key: 'a5a0c7b57ee85748d2e5f06eb2218177764e99e9', class: 'm-0 p-0 ', slot: "prefix" }, index.h("wa-tooltip", { key: '52dfb02a94d6e86576e723d21e4d151123243b70', for: "guests_nbr_confirmed_bookings" }, `${locales_store.locales.entries.Lcz_BookingsNbr}`.replace('%1', this.booking.guest.nbr_confirmed_bookings.toString())), index.h("div", { key: 'fceabec14d8df9fbd56ba79f4a8c7f17f4d129c4', style: { color: '#FB0AAD' }, id: "guests_nbr_confirmed_bookings" }, index.h("span", { key: '5117a95aa518885390e75a17f9e9a78fe8b17d9c' }, " ", this.booking.guest.nbr_confirmed_bookings), index.h("wa-icon", { key: '7c7a33a1814add3f8f8d9bfbcb9587cb0ffd9b77', name: "heart", style: { color: '#FB0AAD' } }))))), index.h("wa-tooltip", { key: '1c55e7b17ee4f2ccba10474b362f82c5b7cd93e6', for: `edit_guest-details` }, "Edit guest details"), index.h("ir-custom-button", { key: '04638094ec97cf391d091f9e099c5c99e7c4b8e8', iconBtn: true, id: `edit_guest-details`, onClickHandler: e => this.handleEditClick(e, 'guest'), appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '57e4647f685bb800a4c1e8cb9cb3b2fdaa8f6530', name: "edit", label: "Edit guest details", style: { fontSize: '1rem' } }))), index.h("div", { key: '9f4807bc1d48ab1d99afa633e53e0d5057471b12', class: "reservation-information__row" }, index.h("ir-label", { key: '1cf2f23f70796ef9a2a9874ff650429bc83f5bc8', labelText: `Company:`, placeholder: 'No company name provided', content: `${this.booking.company_name ?? ''}${this.booking.company_tax_nbr ? ` - ${this.booking.company_tax_nbr}` : ''}`, display: 'flex' }), index.h("wa-tooltip", { key: 'b75cebe8e1be5d4a15b87b60161ba43c95579c92', for: `edit_create-company-info` }, "Add company info"), index.h("ir-custom-button", { key: 'c4c753577c8299833fb7ec8d218e932597a9f9a0', iconBtn: true, id: `edit_create-company-info`, onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.irBookingCompanyFormRef.openCompanyForm();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '5e16ea6aac255267ea3c48cfbda0eda6f45ab78f', name: "edit", label: "Add or modify company info", style: { fontSize: '1rem' } }))), this.booking.guest.mobile && index.h("ir-label", { key: '88312e08094adad9f443ea701476af7462e456b0', labelText: `${locales_store.locales.entries.Lcz_Phone}:`, content: this.renderPhoneNumber() }), !this.booking.agent && index.h("ir-label", { key: '7a7f9452460acc9e8dd2b458635ad58c7d5d98c8', labelText: `${locales_store.locales.entries.Lcz_Email}:`, content: this.booking.guest.email }), this.booking.guest.alternative_email && index.h("ir-label", { key: '0b5616b9165321068a758600276c57e81b060050', labelText: `${locales_store.locales.entries.Lcz_AlternativeEmail}:`, content: this.booking.guest.alternative_email }), this.booking?.guest?.address && index.h("ir-label", { key: '7a0f8c73f3fd55603866d1a854468fdad122dc4e', labelText: `${locales_store.locales.entries.Lcz_Address}:`, content: this.booking.guest.address }), this.userCountry && (index.h("ir-label", { key: '10bde7cb9040f68ed0568d72997e845d3b91ee86', labelText: `${locales_store.locales.entries.Lcz_Country}:`, isCountryImage: true, content: this.userCountry.name, image: { src: this.userCountry.flag, alt: this.userCountry.name } })), this.booking.guest?.notes && index.h("ir-label", { key: 'ec7835fb436e85043fcff4d558cd1328eccc28e6', display: "inline", labelText: `${locales_store.locales.entries.Lcz_GuestPrivateNote}:`, content: this.booking.guest?.notes }), this.booking.is_direct && index.h("ir-label", { key: '2a15d6a07cfa89a679c6f2608ba193f69395b218', labelText: `${locales_store.locales.entries.Lcz_ArrivalTime}:`, content: this.booking.arrival.description }), this.booking.promo_key && index.h("ir-label", { key: '3226dc2fcf52c9f7315060df045bcf8a116c62fe', labelText: `${locales_store.locales.entries.Lcz_Coupon}:`, content: this.booking.promo_key }), this.booking.is_in_loyalty_mode && !this.booking.promo_key && (index.h("div", { key: 'c1326e25d210945d87a73de33f230dcfb787fe71', class: "d-flex align-items-center" }, index.h("svg", { key: 'eb187ac695af34c42239ca0d3ba39215405c75c6', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, index.h("path", { key: '036c927f86f5362e38298f54e8b98f703d0c4e2f', fill: "#fc6c85", d: "M225.8 468.2l-2.5-2.3L48.1 303.2C17.4 274.7 0 234.7 0 192.8v-3.3c0-70.4 50-130.8 119.2-144C158.6 37.9 198.9 47 231 69.6c9 6.4 17.4 13.8 25 22.3c4.2-4.8 8.7-9.2 13.5-13.3c3.7-3.2 7.5-6.2 11.5-9c0 0 0 0 0 0C313.1 47 353.4 37.9 392.8 45.4C462 58.6 512 119.1 512 189.5v3.3c0 41.9-17.4 81.9-48.1 110.4L288.7 465.9l-2.5 2.3c-8.2 7.6-19 11.9-30.2 11.9s-22-4.2-30.2-11.9zM239.1 145c-.4-.3-.7-.7-1-1.1l-17.8-20c0 0-.1-.1-.1-.1c0 0 0 0 0 0c-23.1-25.9-58-37.7-92-31.2C81.6 101.5 48 142.1 48 189.5v3.3c0 28.5 11.9 55.8 32.8 75.2L256 430.7 431.2 268c20.9-19.4 32.8-46.7 32.8-75.2v-3.3c0-47.3-33.6-88-80.1-96.9c-34-6.5-69 5.4-92 31.2c0 0 0 0-.1 .1s0 0-.1 .1l-17.8 20c-.3 .4-.7 .7-1 1.1c-4.5 4.5-10.6 7-16.9 7s-12.4-2.5-16.9-7z" })), index.h("p", { key: '850905460e11ef0029ad81b5412dea7c1c2295d4', class: "m-0 p-0 ml-1" }, locales_store.locales.entries.Lcz_LoyaltyDiscountApplied))), this.booking.is_direct ? (index.h("ir-label", { labelText: `${locales_store.locales.entries.Lcz_GuestRemark}:`, display: "inline", content: this.booking.remark })) : (index.h("ota-label", { class: 'm-0 p-0', label: `${locales_store.locales.entries.Lcz_ChannelNotes || 'Channel notes'}:`, remarks: this.booking.ota_notes, maxVisibleItems: this.booking.ota_notes?.length })), index.h("div", { key: 'f74d4f0c19c396e3318718bcd434b4df5a050e3e', class: "reservation-information__row" }, index.h("ir-label", { key: 'c45c90bf6a5dbf90420c72f0515f366e3c9d33b7', labelText: `${locales_store.locales.entries.Lcz_BookingPrivateNote}:`, placeholder: locales_store.locales.entries.Lcz_VisibleToHotelOnly, content: privateNote, display: privateNote ? 'inline' : 'flex' }), index.h("wa-tooltip", { key: '1cd15ad229e624dbe5ad2851535398f0475a2e88', for: `edit_create-extra-note` }, privateNote ? 'Edit' : 'Create', " private note"), index.h("ir-custom-button", { key: '169ea99232c7591c63c6ead5810354beb7b29e9b', iconBtn: true, id: `edit_create-extra-note`, onClickHandler: () => {
                this.irBookingExtraNoteRef.openDialog();
            }, appearance: 'plain', variant: 'neutral' }, index.h("wa-icon", { key: '71b2359bbb7e274e2cd17eddc9771a21a62ae3e7', style: { fontSize: '1rem' }, name: "edit", label: "Edit or create private note" }))), index.h("ir-booking-extra-note", { key: 'db9307ac48a576d35d4a98f8e051ce9552674a09', booking: this.booking, ref: el => (this.irBookingExtraNoteRef = el) }), index.h("ir-booking-company-dialog", { key: 'ff2f0a8e08c2598beb0ac874679d4a486199e9f7', booking: this.booking, ref: el => (this.irBookingCompanyFormRef = el) }))));
    }
};
...
`;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '08c08bca827c9c43963ad1645e258cc5ceebd642' }, index.h("div", { key: 'f7fba8d138ee84f3ef4ccd2c7f6c415c152d1043', class: "booking-room__header-row" }, index.h("button", { key: '484e02e6d9e934cd71d3493c72c9d13d1d8dd344', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, index.h("wa-icon", { key: '88c82cb9171d1c087b55d54ff4f743ef80ebc0a3', name: "chevron-right" })), index.h("div", { key: 'f4c70e7992feabbe1faa41284daa34186cf84658', style: { width: '100%', cursor: 'default' } }, index.h("div", { key: '236d9e0dae8c0a161a258f540a3e84edae23db7d',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, index.h("div", { key: 'fea0b8aeeb94d02cebbeabe40a7b5bc273b493f4', class: "booking-room__summary-row" }, index.h("p", { key: '3bd944e6ea6fe5fb3330371e436ee7db06fff2d4', class: "booking-room__summary-text" }, index.h("span", { key: '1ad2e6c52a051ee165ea45648b6d8ed37ccb5f8c', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales_store.locales.entries.Lcz_NonRefundable}`, ' '), index.h("div", { key: '0821dc31259fdf1c41ecad6badc3049548146593', class: "booking-room__price-row" }, index.h("span", { key: 'a79aabb3a05be521f5c1dc02296e402b34bcdbd7', class: "booking-room__price" }, utils.formatAmount(this.currency, this.room['gross_total'])), index.h("div", { key: '26035855cfe62c39d3b96387d5abd07a7e75d9c4', class: "booking-room__actions" }, this.hasRoomEdit && this.isEditable && (index.h(index.Fragment, { key: 'fa8cc8340d9f00b0d37959cb704b84a10135bb58' }, index.h("wa-tooltip", { key: '132234466765cc573ffea1780c5f0c41779e3300', for: `edit-room-${this.room.identifier}` }, "Edit ", this.room.roomtype.name), index.h("ir-custom-button", { key: 'b0594b69fc8016a6b3b297f19ba84897db89d242', iconBtn: true, id: `edit-room-${this.room.identifier}`, class: "booking-room__edit-button", onClickHandler: this.handleEditClick.bind(this), variant: "neutral", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '93f1dc385e6a45b192671d5358207ce8955b32af', label: "Edit room", class: "booking-room__edit-icon", name: "edit", style: { fontSize: '1rem' } })))), this.hasRoomDelete && this.isEditable && (index.h(index.Fragment, { key: '6fdefc0159bf846bad0c196e51b6c6445e747396' }, index.h("wa-tooltip", { key: 'a06520a8cca51f9627104f74d5d227991cc0f023', for: `delete-room-${this.room.identifier}` }, "Delete ", this.room.roomtype.name), index.h("ir-custom-button", { key: '00f6de38a8023e91345eeede64866be85c7f3c07', iconBtn: true, id: `delete-room-${this.room.identifier}`, class: "booking-room__delete-button", onClickHandler: this.openModal.bind(this, 'delete'), variant: "danger", size: "small", appearance: "plain" }, index.h("wa-icon", { key: '480c5312491e3a15ee2790c8a779fc287e1bd238', label: "Delete room", class: "booking-room__delete-icon", name: "trash-can", style: { fontSize: '1rem' } }))))))), index.h("div", { key: '7a80b2298e796fa3a784b9356c2563af2b19d749', class: "booking-room__dates-row" }, index.h("ir-date-view", { key: 'edddc1d759a0f73be587050bc2060787d115acae', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !calendarData.isSingleUnit(this.room.roomtype.id) && calendarData.calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        index.h("ir-unit-tag", { key: '1fbd6763ae8112561f3ac059788d5bb0e8a6b621', unit: this.room.unit.name })), this.hasCheckIn && (index.h("ir-custom-button", { key: 'c07176c189b1761aaa70d546bc74279dc9a6df02', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales_store.locales.entries.Lcz_CheckIn)), this.hasCheckOut && (index.h("ir-custom-button", { key: '2d487a987c7a08b4185c197d9a930c83e8f247db', appearance: "outlined", variant: "brand", onClickHandler: () => {
            ...
            }), index.h("tr", { key: '6616f9ccc89ac8fc5fb85a5df0f46ddb50fba2bd', class: '' }, index.h("th", { key: 'b4a35c934e4142e75b85bb1e29ead54edd30eda7', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales_store.locales.entries.Lcz_SubTotal), index.h("th", { key: '222d10155ad51db3594494c458642bedae0af893', class: "booking-room__cell booking-room__cell--right subtotal_row" }, utils.formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (index.h("th", { key: '06668ff8ae37533c3d8631a5822058d05b8315d1', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, utils.formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (index.h(index.Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), index.h("ir-label", { key: '9daa17282271a0ac81302a9ae38efeaeedb22e47', labelText: `${locales_store.locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (index.h(index.Fragment, { key: 'ef288f47396135dd86534ccdcadd31162324ff00' }, this.room.rateplan.cancelation && (index.h("ir-label", { key: '44c95495ff6bf40cd178009bb6443844da1b19f7', labelText: `${locales_store.locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (index.h("ir-label", { key: '97f58b9dcd0277ccab31882baa2c9b3ca42ac2e3', labelText: `${locales_store.locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (index.h("div", { key: '20c4821eeb72d20a4bb72f943d36a531a2028f35' }, index.h("ir-label", { key: '08181164636f9f870875758ac3118e5e77d81f1f', labelText: `${locales_store.locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), index.h("ir-label", { key: '1d855d7fd78e5a05e2f659ef6e3275fe44d7a9c5', labelText: `${locales_store.locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), index.h("ir-dialog", { key: '31f5e7c51ffcae7bf8faf81c177c6dc9b914b03a', label: this.modalReason === 'delete' ? 'Alert' : locales_store.locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, onIrDialogAfterHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, index.h("p", { key: '1ce51bd821ac7072dd8b93fc5ed9a3973cc32161' }, this.renderModalMessage()), index.h("div", { key: '9a0c6fdc602bf26ce99e43ec8df020257f001741', slot: "footer", class: "ir-dialog__footer" }, index.h("ir-custom-button", { key: 'b8868f04d87a73dac8e7321afc48aa917dc8837f', size: "medium", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales_store.locales.entries.Lcz_Cancel), index.h("ir-custom-button", { key: 'b00600fb6c6c843e578edbb2f96b220ebbeef8ab', size: "medium", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales_store.locales.entries.Lcz_Delete : locales_store.locales.entries.Lcz_Confirm))), index.h("ir-checkout-dialog", { key: '7bed0693b199e2ed44e9810a561edd8e12f2c546', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), index.h("ir-invoice", { key: 'f22532dc3b2d97e4800fbf61bbb13c522e9d52e4', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
...
const IrRoomGuests = class {
    ...
    closeModal;
    render() {
        return (index.h("ir-drawer", { key: '84ffca3909d356dc1c46a3440700cde40d32a7e9', style: {
...
const IrSelect = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '8a600424f3da50da54ce0d06fbfbe4440293bc0e', class: `form-group m-0 ${this.selectContainerStyle}` }, index.h("div", { key: 'c4d2b56fb059703c1e19f7e41bc675d79c2796e2', class: "input-group row m-0" }, label, index.h("select", { key: 'dd9b6c505f8b4090119a67af51f05bce9a1efd9c', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && index.h("option", { key: '3217e401a6b09ed4c55508ce44d965eafcb6b886', value: '' }, this.firstOption), this.data.map(item => {
...
const IrSpinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1803b431a6adf8a62160ae1a8cea8c95bcc91a8d' }, index.h("wa-spinner", { key: 'a437d9a58718476b293bbf5a84f85cc6578eb812', style: { fontSize: '2rem' } })));
    }
    static get watchers() { return {
...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '9af74200b726d14dafa97935afab31054cdbbf6c' }, this.showTooltip && index.h("wa-tooltip", { key: '4d318cd4b7981d3e1afb0acce99b25d5578aecf5', for: this._id }, this.unit), index.h("wa-tag", { key: '094ed1f5d4e04b6f7151c327b4767b0dcc8bd24e', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: 'a35d472f306988efae7011923902251fe999dd08', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
    static get watchers() { return {
        "unit": ["onUnitChange"]
    }; }
...
const IrValidator = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'dcfc4a6d56ba9da0748e4adcbe4c1e23b6b9da48' }, index.h("slot", { key: '40bf6b36c484785fde318440aa7b0aa649f5ace6' })));
    }
    static get watchers() { return {
...
//# sourceMappingURL=igl-application-info_91.cjs.entry.js.map