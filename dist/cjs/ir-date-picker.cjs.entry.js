...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'd849bcc9239531aea802c7ec5f8865a12b3b665b', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '52a5a7f22bd14a60176a98b0293467d831dfefdc', name: "trigger" }), index.h("input", { key: 'bf23e735b3c1090ce6014e40eba3c45cbdd99653', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
