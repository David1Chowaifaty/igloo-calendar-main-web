...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'f1611a9b500bb3165cbedf0ac3fa018ba25d5800', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '7f885b83e4392cee1611661f3c017ac43df00fb0', name: "trigger" }), index.h("input", { key: 'afb0f12f0f30cb24d71e4f338d13e7532fd576a6', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
