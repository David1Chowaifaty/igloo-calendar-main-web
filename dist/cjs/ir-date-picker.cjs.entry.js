...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'f0a6330f0f1cf60cb79c1a3d703c5ff2cdaba3f6', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: '0883a58daa270049ee02e97e4f6d50c21faecbc4', name: "trigger" }), index.h("input", { key: 'dd0f1af7b8af03a1de9607d350fd478a9cec5528', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
