...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '7bad5a1a39fc02bd727714107e94cb583438c1c8', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: 'eec425a9cb1b8eca156c0ae1672c57b026409b58', name: "trigger" }), index.h("input", { key: '0f638a52ba4d69bb6843baacc081368f0a66497e', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
