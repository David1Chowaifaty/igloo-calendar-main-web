...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '197a0312746b1a8bc3a527a5430417d87899d66c', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: 'a77e49a86ddbe9fec0d35939b50f36d0ff009868', name: "trigger" }), index.h("input", { key: '25a3ec9d281a2b3f4cc881e3626062df44cec2d5', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
