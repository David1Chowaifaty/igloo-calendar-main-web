...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '2a9555ffc14dbb15abef5cae13d282c9bd9f2e69', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: 'e83b6b1734260d7312e292dcd10d057e56a5f8dd', name: "trigger" }), index.h("input", { key: 'e0a6288e9f91a0973ce8a77675e69ea25351b052', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
