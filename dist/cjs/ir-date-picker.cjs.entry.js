...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: 'e9d5cf2bd803e80a743bbbf3a4cc81af540c014a', class: `ir-date-picker-trigger ${this.triggerContainerStyle}` }, this.customPicker && index.h("slot", { key: 'aab1db63cb3efe0176176faffe8348ed8eed3175', name: "trigger" }), index.h("input", { key: 'c58be5b7387d4849d825eb884665a08c9cf2462f', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
