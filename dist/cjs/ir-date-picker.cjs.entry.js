...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '2099e353ee4779eacc9f42feb3effb4cd1794716', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: 'e4120b2b1cf254aa0a07a5a34418f3c134285abc', name: "trigger" }), index.h("input", { key: '8beee0f5535c6f29805082791209190848e47086', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
