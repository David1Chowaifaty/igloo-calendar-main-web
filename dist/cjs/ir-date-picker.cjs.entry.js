...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '339896527dea6a29f18b570eb0fb4f4539751dca', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: '0bedaac811766a18b1b855fb6dd62aa8798e1a77', name: "trigger" }), index.h("input", { key: 'c615537b46f6f05ab30323f71392ab96a9e62cf5', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
