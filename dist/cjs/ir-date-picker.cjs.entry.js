...
const IrDatePicker = class {
    ...
    render() {
        return (index.h("div", { key: '519be67e59fbde2a0add5007629b4bd4386e69f5', class: "ir-date-picker-trigger" }, this.customPicker && index.h("slot", { key: 'd7b00e7d37b2d37a80b7e92fd917cd538519d3a1', name: "trigger" }), index.h("input", { key: '52854c791bf617bc94799af445cb1fe2fc50d0f8', type: "button", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
