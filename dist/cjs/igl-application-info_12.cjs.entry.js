...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'f1b9538864eaf305091877101065f77cabd3befb' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), index.h("div", { key: 'c27387d5270cc6fb8bef74b1dc7b84e48bd60b0a', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, index.h("fieldset", { key: '765e82190065795be1ac3bcba5d52746c33e281d', class: "mt-lg-0 mr-1 " }, index.h("igl-date-range", { key: 'fc38414b6ec436f5ce25b265b994675b94a2152f', "data-testid": "date_picker", variant: "booking", dateLabel: locales_store.locales.entries.Lcz_Dates, maxDate: this.getMaxDate(), minDate: this.getMinDate(), disabled: (this.isEventType('BAR_BOOKING') && !this.wasBlockedUnit) || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), index.h("p", { key: '8cdb3f2e4808fe9304d16da9e9b3d5b0e636f758', class: "text-right mt-1 message-label" }, calendarData.calendar_data.tax_statement)));
    }
};
...
const IglPropertyBookedBy = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ea782174d50276aaf1b09f003eb419ac893257a' }, index.h("div", { key: '6b753d99773a2f7c9d2eba4fb0495191907fc4c7', class: "text-left mt-3" }, index.h("div", { key: 'a780c9421d94ecc367dd732517d75e853d91afb8', class: "form-group d-flex flex-column flex-md-row align-items-md-center text-left " }, index.h("label", { key: 'd58f4c1806d206ad445b78732a047960355e6f16', class: "p-0 m-0 label-control mr-1 font-weight-bold" }, locales_store.locales.entries.Lcz_BookedBy), index.h("div", { key: '874bbb2b3f5340351fddcb9aa26ed5e97f2b4825', class: "bookedByEmailContainer mt-1 mt-md-0 d-flex align-items-center" }, index.h("ir-autocomplete", { key: '7fcf6cfd21038c29c3372849f262bcadb66efd1e', testId: 'main_guest_email', onComboboxValue: this.handleComboboxChange.bind(this), propertyId: this.propertyId, type: "text", value: this.bookedByData.email, required: true, class: 'flex-fill', placeholder: locales_store.locales.entries.Lcz_FindEmailAddress, onInputCleared: () => this.clearEvent(), danger_border: this.isButtonPressed && this.bookedByData.email !== '' && utils.validateEmail(this.bookedByData.email) }), index.h("ir-tooltip", { key: 'e7e76209748b2f0a1582f2364e7190fe13297cf7', class: 'ml-1', message: "Leave empty if email is unavailable" })))), index.h("div", { key: '657c784b089d91569a8a4f6d60d21e75710f2ef5', class: "bookedDetailsForm text-left mt-2 font-small-3 " }, index.h("div", { key: '240b5be884581076c33150210b36b14ec77b766c', class: "d-flex flex-column flex-md-row  justify-content-md-between " }, index.h("div", { key: 'd7a979843bee0f640a00b372908ddf94c29ff624', class: "p-0 flex-fill " }, index.h("div", { key: 'c509ef36d4b9162fd775539e251aa04b9b5bb21f', class: "form-group d-flex flex-column flex-md-row align-items-md-center p-0 flex-fill " }, index.h("label", { key: '5556165bb43abc3f0e1591228a67bbadf9a9b92e', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_FirstName), index.h("div", { key: '6c44a48c7caa387130e78ee4c530a1cb46b6718e', class: "p-0 m-0  controlContainer flex-fill  " }, index.h("input", { key: '4c4b0add70d47e44c2d9f531fd9d1efe1fd8cc76', "data-testid": "main_guest_first_name", class: `form-control flex-fill ${this.isButtonPressed && this.bookedByData.firstName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_FirstName, id: v4.v4(), value: this.bookedByData.firstName, onInput: event => {
                this.updateGuest({ first_name: event.target.value });
                this.handleDataChange('firstName', event);
            }, required: true }))), index.h("div", { key: '41363d5342e4d0fee32c781d033dac9a97c663d0', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '7461e190681b615dd2e26fd75fb5837cafa90cd1', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_LastName), index.h("div", { key: '3d2d882dcfb5abd42c44d55a076cc6ebae7704c9', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '3ad7e39340f24673210545e3b2387157bbce9003', "data-testid": "main_guest_last_name", class: `form-control ${this.isButtonPressed && this.bookedByData.lastName === '' && 'border-danger'}`, type: "text", placeholder: locales_store.locales.entries.Lcz_LastName, id: v4.v4(), value: this.bookedByData.lastName, onInput: event => this.handleDataChange('lastName', event) }))), index.h("div", { key: '34e6b5628a62e708c6956ede5c06be8ae1473aef', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'fa6ffb4f6c860f76e6d431c6cdd24ae290819505', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_Country), index.h("ir-country-picker", { key: '06d6bbb395edec624d76033b9218ea9e4dbb7ad3', testId: "main_guest_country", class: "flex-grow-1 m-0", onCountryChange: e => this.handleCountryChange(e.detail.id), countries: this.countries, country: this.countries.find(c => c.id === this.bookedByData.countryId) })), index.h("div", { key: '962112da6166d076c91e19fda47bdaec71f98945', class: "form-group p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '3bd86a0eab5f5906c2b863745eb5db6d1432a804', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_MobilePhone), index.h("div", { key: 'd8912b098fd8aca007fd088f5d438210b6d1bfac', class: "p-0 m-0 controlContainer flex-fill" }, index.h("ir-phone-input", { key: '1a981aa81ac1f4f2fd7b68ed8f6921da6f07ea42', testId: "main_guest_phone", language: this.language,
            ...
            } }))), index.h("div", { key: '4048d787bdc294875b9df38e82254e25323ebc52', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '4483fccaaecf24e50e324c9bbd65850a95e2fe28', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_YourArrivalTime), index.h("div", { key: 'e41336fdf5305119f976323791756bb006c6fad5', class: "p-0 m-0  controlContainer flex-fill" }, index.h("select", { key: '979cbbd98e4ac15ba06e8671d8eb4e23d786bc7b', "data-testid": "arrival_time", class: `form-control input-sm pr-0 ${this.isButtonPressed && this.bookedByData.selectedArrivalTime.code === '' && 'border-danger'}`, id: v4.v4(), onChange: event => this.handleDataChange('selectedArrivalTime', event) }, this.arrivalTimeList.map(time => (index.h("option", { value: time.CODE_NAME, selected: this.bookedByData.selectedArrivalTime.code === time.CODE_NAME }, time.CODE_VALUE_EN))))))), index.h("div", { key: '8609849db8472bc73ead0ae0aaf1bffa930437b7', class: "p-0 flex-fill  ml-md-3" }, index.h("div", { key: 'ddc4cb6522cabd9e5e9ed1ecc8e05762e84189bb', class: "  p-0 d-flex flex-column flex-md-row align-items-md-center " }, index.h("label", { key: '7f705b771805f7df05a1e005dd38632260598f57', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_AnyMessageForUs), index.h("div", { key: '6563f3ce79193d3ad71b0b6a8bf48e4d16824b14', class: "p-0 m-0  controlContainer flex-fill " }, index.h("textarea", { key: '116f0245fd5772b407b6d158fac309dfce7c4994', "data-testid": "note", id: v4.v4(), rows: 4, class: "form-control ", name: "message", value: this.bookedByData.message, onInput: event => this.handleDataChange('message', event) }))), this.showPaymentDetails && (index.h(index.Fragment, { key: '263c0f847d59ea41a1110b2243313048f8e53093' }, index.h("div", { key: '63d062cff01b19ba6eb8d6d4992893098fe310ed', class: "form-group mt-md-1  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '808d928b8a44cce1974c2f5068eb9b522c9e2388', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardNumber), index.h("div", { key: '678d11cf617078c6216afd480b1aebacd9547896', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '007df8a38c6fa0f8bcd81517d42603f59debc660', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardNumber, onInput: event => this.handleNumberInput('cardNumber', event) }))), index.h("div", { key: 'c24631f8da45a8d39b3319ce966e6e2efa6128c7', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: '403c7df4ddaf56507fd0d0ab4b8c5151fd16077d', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_CardHolderName), index.h("div", { key: '5fc0c09248ec750a1488c0664c913c9e8faff7a7', class: "p-0 m-0  controlContainer flex-fill" }, index.h("input", { key: '0eb4e73a8c5797ea838533bd292a92467577fb6e', class: "form-control", type: "text", placeholder: "", pattern: "0-9 ", id: v4.v4(), value: this.bookedByData.cardHolderName, onInput: event => this.handleDataChange('cardHolderName', event) }))), index.h("div", { key: '90f766c409e93d32e43f4ebca7cb3ab2c2692919', class: "form-group  p-0 d-flex flex-column flex-md-row align-items-md-center" }, index.h("label", { key: 'b5673fed6853c1b7cfc7a2901b0d0086839263e9', class: "p-0 m-0 margin3" }, locales_store.locales.entries.Lcz_ExpiryDate), index.h("div", { key: 'b217488bbbcaf8db12bf54bdd7645504f7b6562e', class: "p-0 m-0 row  controlContainer flex-fill" }, index.h("div", { key: '3ffa9bec909a42bca3651b81f241c8b791afae23', class: "p-0 m-0" }, index.h("select", { key: 'eb3d081d2cc73b699843133b97754b1f0482cfc6', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryMonth', event) }, this.expiryMonths.map(month => (index.h("option", { value: month, selected: month === this.bookedByData.expiryMonth }, month))))), index.h("div", { key: 'e792e8f52abfcae3c7515d684c5e6a493f85f6e9', class: "p-0 m-0 ml-1" }, index.h("select", { key: 'f49a40505154f34beb2c9d7e2c6c0eca2c519674', class: "form-control input-sm pr-0", id: v4.v4(), onChange: event => this.handleDataChange('expiryYear', event) }, this.expiryYears.map((year, index$1) => (index.h("option", { value: year, selected: index$1 === this.bookedByData.expiryYear }, year))))))))), index.h("div", { key: '000d62206a0ccf09390705289f3f33e5ab7af199', class: "form-group mt-1 p-0 d-flex flex-row align-items-center" }, index.h("label", { key: '473239ccf34077db1c87ec87bf143b2a3699cbcf', class: "p-0 m-0", htmlFor: 'emailTheGuestId' }, locales_store.locales.entries.Lcz_EmailTheGuest), index.h("div", { key: 'f808883172b3627097549325a41bbca830263047', class: "p-0 m-0  controlContainer flex-fill checkBoxContainer" }, index.h("input", { key: 'de8eca87ac850adfb2730891514b277a6891c7a6', class: "form-control", type: "checkbox", checked: this.bookedByData.emailGuest, id: 'emailTheGuestId', onChange: event => this.handleDataChange('emailGuest', event) }))))))));
    }
};
...
const IglRoomType = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '11b3db3cc2e509309da85855800ed701433d68e7' }, isValidBookingType && ((_a = this.roomType.rateplans) === null || _a === void 0 ? void 0 : _a.length) > 0 && index.h("div", { key: 'd084ffce91c1a580181566f8d379e47ce8a968b6', class: "font-weight-bold font-medium-1 margin-bottom-8 " }, this.roomType.name), (_b = this.roomType.rateplans) === null || _b === void 0 ? void 0 :
            _b.map(ratePlan => {
...
const IrAutocomplete = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a2d97b04a2daf10e434786fb58809338793aa5e0' }, index.h("div", { key: 'd36d26c9365b987f603073a5ea47218141d4ec21', class: 'd-flex align-items-center ' }, index.h("label", { key: '8914a087b97bf41ea3f1b443003ad13e07cb2414', "data-state": this.inputFocused ? 'focused' : 'blured', htmlFor: this.inputId, class: `form-control input-sm ${this.danger_border && 'border-danger'}` }, index.h("svg", { key: '68e7bf21f0b4e31c5c0202463139c94a7cf3c950', xmlns: "http://www.w3.org/2000/svg", height: "12", width: "12", viewBox: "0 0 512 512" }, index.h("path", { key: '98444a25d2dfe31df51a2934dd91e6be13cbc295', fill: "currentColor", d: "M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z" }))), index.h("input", { key: 'b46ddf74680fc14e2b6f6dfc3bc08713114b18e2', "data-testid": this.testId, required: this.required, disabled: this.disabled, id: this.inputId, onKeyDown: this.handleKeyDown.bind(this), class: `form-control input-sm flex-full ${this.danger_border && 'border-danger'}`, type: this.type, name: this.name, value: this.value || this.inputValue, placeholder: this.placeholder, onBlur: this.handleBlur.bind(this), autoComplete: "none", onInput: this.handleInputChange.bind(this), onFocus: this.handleFocus.bind(this), ref: el => (this.inputRef = el) }), this.inputValue && (index.h("button", { key: '0c512fa9bc73b6e3517df45c2daa0c2e1674ec97', type: "button", class: 'position-absolute d-flex align-items-center justify-content-center ', onClick: this.clearInput.bind(this) }, index.h("p", { key: '81a0c59c6dd5f6ebd7b1ce31806ab0a23d81b8ea', class: 'sr-only' }, "clear input"), index.h("svg", { key: 'afbce44adc1c3f9dcd48a68dd8de7c6b5241dae1', width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'b6c9d9e3a183c0fc9cedfb8f53b3634525b5d980', d: "M11.7816 4.03157C12.0062 3.80702 12.0062 3.44295 11.7816 3.2184C11.5571 2.99385 11.193 2.99385 10.9685 3.2184L7.50005 6.68682L4.03164 3.2184C3.80708 2.99385 3.44301 2.99385 3.21846 3.2184C2.99391 3.44295 2.99391 3.80702 3.21846 4.03157L6.68688 7.49999L3.21846 10.9684C2.99391 11.193 2.99391 11.557 3.21846 11.7816C3.44301 12.0061 3.80708 12.0061 4.03164 11.7816L7.50005 8.31316L10.9685 11.7816C11.193 12.0061 11.5571 12.0061 11.7816 11.7816C12.0062 11.557 12.0062 11.193 11.7816 10.9684L8.31322 7.49999L11.7816 4.03157Z", fill: "currentColor", "fill-rule": "evenodd", "clip-rule": "evenodd" }))))), this.isComboBoxVisible && this.renderDropdown()));
    }
...
const IrCountryPicker = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '60009683fe1047fdf2b1b105f1cf82d9ff891ea0', class: "dropdown m-0 p-0" }, index.h("ir-input-text", { key: 'b94700c13f6b4a992cb1b5bf592eecfcecb60c64', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
            ...
            } }), index.h("div", { key: 'cd48852873b440c3d867ac015e9187bd4d5d356c', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (index.h(index.Fragment, { key: '1fcb634187365fc437d96a3cf471ac41cd3247a7' }, index.h("button", { key: 'd7e7bd77d6d4df52befb4f153a912de3c6383ef7', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, index.h("img", { key: '4f14012977103f64447a2b09cd847f4e88c4abaa', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), index.h("p", { key: 'fc754a7e53142f22b23f7e5ff1b89d4c5e5422dc', class: "pl-1 m-0" }, this.propertyCountry.name)), index.h("div", { key: 'f2eb29a738e1e4b85fb590294d1ef06b5d4584b4', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && index.h("p", { key: '27b8d6dd60df43c8603196aa35c312a423a31ed7', class: "dropdown-item-text" }, "Invalid Country"))));
    }
    static get watchers() { return {
...
const IrDateRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: '72664da201b1baf1cbde1bc34f37ec3d1aaf8046' }, index.h("input", { key: 'ab89c03a6299cb958b304a360288446b738f8047', class: "date-range-input", type: "button", disabled: this.disabled })));
    }
...
const IrDateView = class {
    ...
    render() {
        return (index.h(index.Host, { key: '7a83d080375592ff42f67e7d93e57d32b75d33c6', class: "d-flex align-items-center" }, index.h("span", { key: '4cbb88cf67b411bd424f312a736a2f0763e0a749' }, this.dates.from_date), ' ', index.h("svg", { key: 'e7e7541228acf32c50e45367af1806a5e2cd6ba7', xmlns: "http://www.w3.org/2000/svg", class: "mx-01", height: "14", width: "14", viewBox: "0 0 512 512" }, index.h("path", { key: '7a886c7fcd5469c481f93cd64e9148bbdd9d3f6b', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" })), index.h("span", { key: 'a7e0fc1a7094d4043e9db274e82b534654a2350e' }, this.dates.to_date, ' ', this.showDateDifference && (index.h("span", { key: '551440ce7feb94142be3cc106b368a46a6853e9d', class: "mx-01" }, this.dates.date_difference, '   ', this.dates.date_difference > 1 ? ` ${locales_store.locales.entries.Lcz_Nights}` : ` ${locales_store.locales.entries.Lcz_Night}`)))));
    }
    static get watchers() { return {
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: '1216b6592fb729dfe1a980b2a914eb5057194cb1' }, index.h("div", { key: 'cdb3825c151eb9c5a9aeb69170d37275ee11f468', class: "form-group mr-0" }, index.h("div", { key: '11592da009c07ef5d1df124f7de56d2519960549', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: 'c4b20cdc02139ce81feffa7748117deef5237b90', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: 'a354ba5790ad3b29dc406e91288a1b28fc3ccec4', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '6e12b7931c04b63ce4da5dabe87d83ddf774e0ab', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: '0c514f0feb69c294ae9c45e24bf52ba94c60a8d3', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? index.h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : index.h("p", { class: "p-0 m-0 " }, locales_store.locales.entries.Lcz_Select), index.h("svg", { key: '1ee07e544c48d93fb3848452e0496903f67719e3', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '0f05a6e7d7593ec95a0a32c26853caf59b61f636', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("p", { key: 'c3d053ff6c5fdbf4c5bbd67e7188e4b0cb0a6490', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '5d0aa9ac0d923dc73ba9737d76eadaf6692caa5f', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (index.h("div", { key: 'a6b31d379e60515b3c6162745da44eb3c96097a3', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '4a93c06f8fb88310c2b74566581509b6e0870d23', onComboboxValueChange: e => {
