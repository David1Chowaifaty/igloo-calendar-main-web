...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '222755b3d680c6ab2888c1a9fe3a7770cff36ae3' }, this.showTooltip && index.h("wa-tooltip", { key: '0bad8ab9ef96b85400fdbfa634ad05812dba1884', for: this._id }, this.unit), index.h("wa-tag", { key: 'ffa43c0511ad36c83ececd9deb98bdf0e64588f1', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '58b52b8c37d2ae7104ad951b199976aac4e3e088', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
