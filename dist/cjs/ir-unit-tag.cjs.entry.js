...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'a46d82b2503e50db26e025a91a7ebc2475bc9277' }, this.showTooltip && index.h("wa-tooltip", { key: '21a0a3d12bf075c2a2821cb140c619d4a7c9c3da', for: this._id }, this.unit), index.h("wa-tag", { key: '91d201890659a9474982efc54db8c46f33c3729d', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '95b12c6464267435341bad5a8f3dabb2ca987111', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
