...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '2e4f4d71dd29b760adcb4f62f5e1c067757ec3e1' }, this.showTooltip && index.h("wa-tooltip", { key: 'feb3ee479c48a39221b0ab46956c21ea9a490041', for: this._id }, this.unit), index.h("wa-tag", { key: 'c007812dc8af2bc0fbcd5350f264d543e26363a4', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: 'd2e2d05f3a807a1d394391650c8594031c335a5c', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
