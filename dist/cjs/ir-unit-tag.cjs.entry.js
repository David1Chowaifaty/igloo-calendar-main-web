...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '67ab98143b7baca5ab68e35c6ffebae3542dbdec' }, this.showTooltip && index.h("wa-tooltip", { key: 'b9b4e69e11affc1ebe3c3ea48ae77bed6a7f37c0', for: this._id }, this.unit), index.h("wa-tag", { key: 'f35e8ddb78563a3bf9f40cb9c3f1cceaefbdcbc1', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: 'eaf434a200ea541f4a7ced69c479df43d502ee54', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
