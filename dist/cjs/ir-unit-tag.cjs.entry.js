...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: 'bc71687914bed2f0119141ac87c2c0388a6308d5' }, this.showTooltip && index.h("wa-tooltip", { key: '74387be4abf1c6aa393ab4ca2037abf18ede09b0', for: this._id }, this.unit), index.h("wa-tag", { key: '690e5d94b5a05d689de71d7cc03cc5084b02d6a4', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '1555888a29974a7be54e8c96dd19802e844bfee1', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
