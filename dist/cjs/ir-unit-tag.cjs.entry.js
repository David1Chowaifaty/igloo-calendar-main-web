...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '5e76a0ac552416c36ef65c0ade7ab7ab9bf743cb' }, this.showTooltip && index.h("wa-tooltip", { key: '2d1c4060c5af0e1ee6cb62a4a44d52ca70617934', for: this._id }, this.unit), index.h("wa-tag", { key: 'f4a6f44057477a1a594589cb65916a1d8d6e0d13', id: this._id, class: "unit-tag__el", size: "s", appearance: "filled", variant: "brand" }, index.h("span", { key: '64e3f2c98ef1e2c01ceacdf1a2d2578f6ed7683e', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
