...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '0827838b53471cacf7ad239276f36e8e6bc02450' }, this.showTooltip && index.h("wa-tooltip", { key: '3f8591901392cabc5db3fd510877f64f6d6c9bc7', for: this._id }, this.unit), index.h("wa-tag", { key: 'e92efb948cf14d8516e790f57efb6deb3901efb7', id: this._id, class: "unit-tag__el", size: "s", appearance: "filled", variant: "brand" }, index.h("span", { key: '545d21d493892eae23fa85bfd6eefcbde365781e', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
