...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '5b48b647570417f43a46c19e9a946e44788da384' }, this.showTooltip && index.h("wa-tooltip", { key: '622e0038846de817755ff8a59e9e096aababf93c', for: this._id }, this.unit), index.h("wa-tag", { key: '5a304db3aa535ffe1da1207f7b9397093b32dc1c', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '51c8b767b9435edcb54ac4a4d4826f08d8be7945', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
