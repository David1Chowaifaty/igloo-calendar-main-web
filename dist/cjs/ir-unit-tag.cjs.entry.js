...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '3a1fc8bc4847ae0a04a3d4f1cbde6d27fbcefbc4' }, this.showTooltip && index.h("wa-tooltip", { key: 'cea49d2cbe13e9f55d58bc91f238e3a9527d6aa1', for: this._id }, this.unit), index.h("wa-tag", { key: '7fba0c157394a837b879f02b7e62e67a2fcb8f14', id: this._id, class: "unit-tag__el", size: "s", appearance: "filled", variant: "brand" }, index.h("span", { key: '66d881643cc376976f5ca9bd44288d291e60c65e', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
