...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '61997c546c505deb28699ba383025ce9ba065050' }, this.showTooltip && index.h("wa-tooltip", { key: '9cbd259c597da42ddee04bc73e4dbbcc978789fa', for: this._id }, this.unit), index.h("wa-tag", { key: '6849d9969a1ccfbde1e78dd13a054977b032ffab', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '2c4c1773607c6a1acae0834a14c8dc5ffff6979b', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
