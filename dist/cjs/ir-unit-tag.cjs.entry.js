...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '7e284f2ef60f6c6ecf361acf19cc6be83ee9dd4f' }, this.showTooltip && index.h("wa-tooltip", { key: '49352af176943e1f7cb57a0293acefb5decad177', for: this._id }, this.unit), index.h("wa-tag", { key: 'db4e45b58a79e87329bb5458f60de6bf164c36ef', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: 'e70e7e26ed6a254749b29393c0fecba216d0f72b', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
