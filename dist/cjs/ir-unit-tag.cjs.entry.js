...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '8d451f7aa6a06410917e5c144377d458e508cc5c' }, this.showTooltip && index.h("wa-tooltip", { key: 'db7e1e3f71af7f4ecf029a21a97be836a9248e9f', for: this._id }, this.unit), index.h("wa-tag", { key: '1323a2b3b2c67348174aae5f6d7bd4f087de2343', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: 'd3ec6075cfa66a6f03e34187faea686310d444a3', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
