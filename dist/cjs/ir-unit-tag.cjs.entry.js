...
const IrUnitTag = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '0196a0af6b3c71b8200d493f43865f6c28655156' }, this.showTooltip && index.h("wa-tooltip", { key: 'c30659837f5ba32da41f2eca932a5b267233896d', for: this._id }, this.unit), index.h("wa-tag", { key: '40b82acc9552d8028f84e8d93140c8e6ba8a1697', id: this._id, class: "unit-tag__el", size: "small", appearance: "filled", variant: "brand" }, index.h("span", { key: '7fecaf8f399d0d68101f9044c99bac3e624a95f3', class: "unit-tag__content", ref: this.setContentRef }, this.unit))));
    }
