...
const IrRadio = class {
    ...
    render() {
        return (index.h("div", { key: '1e4d4f9f5a9995e225d207171537f4919eeb44d4', class: "input-group" }, index.h("label", { key: 'cfa6cf22d4c4397bd48442d1a56e3184f50c8224', class: "check-container radio-container align-items-center m-0 py-0" }, index.h("span", { key: 'b6d25d893b94aa4cbb3932d5a2c78cdd9af8897e' }, this.label), index.h("input", { key: 'ba5c664bafb164de14e68602c7c0879cc886eeb0', class: "p-0 m-0", type: "radio", value: "000", name: this.el.name, title: "", onChange: () => {
                this.handleCheckChange();
            }, checked: this.currentChecked, ref: el => (this.radioRef = el) }), index.h("span", { key: '3ab6d8643512e64104616582e39a566eab4e90f3', class: "checkmark" }))));
    }
...
const IrWeekdaySelector = class {
    ...
    render() {
        return (index.h(index.Host, { key: '6c012b8ab10005ee6a0adfdbca113365c88067e0', class: "my-1 d-flex align-items-center", style: { gap: '1.1rem' } }, this._weekdays.map(w => (index.h("ir-checkbox", { checked: this.selectedWeekdays.has(w.value), onCheckChange: e => this.toggleWeekDays({ checked: e.detail, weekDay: w.value }), label: w.label, labelClass: "m-0 p-0", class: "days-checkbox" })))));
    }
    static get watchers() { return {
