...
const IrIcon = class {
    ...
    iconClickHandler;
    render() {
        return (index.h("button", { key: '58e26ec1fc7caa5ba25daa427c73168af4a97f1a', type: this.type, class: "icon-button", onClick: () => this.iconClickHandler.emit() }, index.h("slot", { key: 'f3987257e4fbac52e3ca4c144cf90f387b8f5f75', name: "icon" })));
    }
};
