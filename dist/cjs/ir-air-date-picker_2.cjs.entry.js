...
const IrAirDatePicker = class {
    ...
    currentLang = this.normalizeLang(languageObserver.LanguageObserver.getLang());
    ...
    componentDidLoad() {
        ...
        this.unsubscribeLang = languageObserver.LanguageObserver.subscribe(lang => this.handleLangChange(lang));
    }
    ...
    async initializeDatepicker() {
        ...
        if (this.datePicker)
            return;
        this.datePicker = new airDatepicker.AirDatepicker(this.el, {
...
const IrDateSelect = class {
    ...
    get _label() {
        if (this.range) {
            return this.dates.map(d => irDate.formatDate(d, { style: 'medium' })).join(' → ');
        }
        if (!this.currentDate) {
            return null;
        }
        return irDate.formatDate(this.currentDate, { style: 'medium', withTime: this.timepicker ? 'short' : undefined });
    }
    render() {
        return (index.h(index.Host, { key: '2a58b702eacc138248599d660474352b0eb0e994', class: {
                'ir-date-select': true,
                'ir-date-select--active': this.isActive,
                'ir-date-select--inline': this.inline,
                'ir-date-select--disabled': this.disabled,
            } }, index.h("wa-popup", { key: '7ef9a0e711e689b1c0529b83b370b7aa7bf4ff10', arrow: true, part: "base", placement: "bottom", flip: true, shift: true, "auto-size": "vertical", "auto-size-padding": 10, active: this.isActive, class: "ir-date-select__popup" }, index.h("div", { key: '2713f0823dfcac0bec2a5157d58c6a32175c87c7', slot: "anchor", part: "anchor", class: "ir-date-select__trigger" }, index.h("div", { key: '99da4e0d2308900f750b24cabaed94e5ead150d0', part: "combobox", class: "ir-date-select__control", role: "combobox", tabindex: this.disabled ? -1 : 0, "aria-haspopup": "dialog", "aria-expanded": this.isActive ? 'true' : 'false', "aria-controls": this.popupId, "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": t.t('Lcz_SelectDate', { fallback: 'Select date' }), onClick: !this.disabled ? this.togglePicker.bind(this) : undefined, onKeyDown: !this.disabled ? this.handleKeyDown.bind(this) : undefined }, index.h("slot", { key: 'cc9c96792484deb66a9d7cb032902128ed01b966', name: "trigger" }, index.h("ir-input", { key: '053046e5a993f14dff23d5c5f5e8a810449f9fc2', disabled: this.disabled, class: "ir-date-select__input", placeholder: this.placeholder, withClear: this.withClear, tabIndex: !this.customPicker && !this.disabled ? 0 : undefined, "aria-expanded": !this.customPicker ? String(this.isActive) : undefined, "aria-disabled": this.disabled ? 'true' : undefined, "aria-invalid": this.isValid, readonly: true, defaultValue: this._label, label: this.label, value: this._label }, this.slotManager.hasSlot('label') && index.h("slot", { key: 'bbd662d7e16498ea33763e04de8eea2c9595878a', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && index.h("slot", { key: '488450bc788f36202d65b88e438c6c7a83fbf989', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && index.h("slot", { key: '0a9c3c647f8df2933858958e7d5685e926c9757e', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && index.h("slot", { key: 'f05cc21f0059148adbfb9bb389a090eae71294f3', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && index.h("slot", { key: '39f0998771e5940a9a4af8c2d2f64af878d90696', name: "hint", slot: "hint" }))))), index.h("div", { key: '1c721bda2c83e189cceb9e1c690550db1b158c4e', part: "body", id: this.popupId, class: "ir-date-select__calendar", role: "dialog", "aria-modal": "false", "aria-label": t.t('Lcz_DateSelectionDialog', { fallback: 'Date selection dialog' }) }, index.h("ir-air-date-picker", { key: '1026eb7c0098b1eed4a0e7dfa310b548ce99af76', ref: el => (this.airDatePickerRef = el), withClear: this.withClear, placeholder: this.placeholder, label: this.label, dates: this.dates, inline: this.inline, date: this.date, multipleDates: this.multipleDates, range: this.range, dateFormat: this.dateFormat, timepicker: this.timepicker, minDate: this.minDate, maxDate: this.maxDate, disabled: this.disabled, autoClose: this.autoClose, showOtherMonths: this.showOtherMonths, selectOtherMonths: this.selectOtherMonths, customPicker: this.customPicker, container: this.container, forceDestroyOnUpdate: this.forceDestroyOnUpdate, emitEmptyDate: this.emitEmptyDate, onDateChanged: e => {
            ...
            } }), index.h("slot", { key: '89d852c5f475777625e93eafc46879eb4eb518c1' })))));
    }
    static get watchers() { return {
        "aria-invalid": [{
