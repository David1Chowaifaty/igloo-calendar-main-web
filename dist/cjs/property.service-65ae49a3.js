...
const CategorySchema = utils.z.object({
    code: utils.z.string(),
...
const TaxCategorySchema = utils.z.object({
    category: CategorySchema,
    taxation_mode: CategorySchema,
    pct: utils.z.number(),
    property_id: utils.z.number().optional(),
});
const HandleExposedPropertyTaxCategoriesParamsSchema = utils.z.object({
    property_id: utils.z.number(),
    VAT_INCLUDED_CODE: utils.z.string(),
    VAT_PC: utils.z.number(),
    CITY_TAX_INCLUDED_CODE: utils.z.string(),
    CITY_TAX_PCT: utils.z.number(),
    SERVICE_CHARGE_INCLUDED_CODE: utils.z.string(),
    SERVICE_CHARGE_PCT: utils.z.number(),
    tax_categories: utils.z.array(TaxCategorySchema),
});
...
//# sourceMappingURL=property.service-65ae49a3.js.map