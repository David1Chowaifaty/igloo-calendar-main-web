...
import { C as ChannelService, d as defineCustomElement$e } from './ir-channel-editor2.js';
import { T as Token } from './Token.js';
import { d as defineCustomElement$f } from './ir-button2.js';
import { d as defineCustomElement$d } from './ir-channel-general2.js';
import { d as defineCustomElement$c } from './ir-channel-header2.js';
import { d as defineCustomElement$b } from './ir-channel-mapping2.js';
...
const IrChannel = /*@__PURE__*/ proxyCustomElement(class IrChannel extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-channel":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrChannel);
            }
            break;
        case "ir-button":
            if (!customElements.get(tagName)) {
...
export { IrChannel as I, defineCustomElement as d };

//# sourceMappingURL=ir-channel2.js.map