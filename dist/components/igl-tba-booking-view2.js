...
const IglTbaBookingView = /*@__PURE__*/ proxyCustomElement(class IglTbaBookingView extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'e48866ec2f881979354434d70712c9d7806e6852' }, h("div", { key: 'b89258141774b7d43c6a680356e6fe7e9c0c5fae', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, h("div", { key: 'cd2ab53c790f918697070c186b77707eba39938a', class: `guestTitle booking-guest-title tba-guest-title pointer font-small-3 ${this.highlightSection ? 'selectedOrder is-active' : ''}`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, h("p", { key: 'f89f66711bc9fefd5712ca1aaf5841ae4f552e4d', class: "guest-booking-number" }, this.eventData.BOOKING_NUMBER), h("span", { key: '60cca4e9b3cac2b3f18806c95a0f5635e8de0176', class: "guest-separator" }, "-"), h("p", { key: '9eb761cab3f1ec9158bda791d69631de5808be5a', class: "guest-name truncate" }, this.eventData.NAME), this.eventData.occupancy && (h("p", { key: 'd30af6165d349120d7bae681a981e2740a59edb4', class: "guest-occupancy" }, h("span", { key: 'c8165540933770b3c70a334b6bcbb898b284c981', class: "guest-occupancy-wrapper" }, "( "), h("span", { key: '59820df94906cae7505e1da1c2cff1ac57d47eac', class: "guest-occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), h("span", { key: '3a01b2b39de066b279a9262305f9f5b323aa42c7', class: "guest-occupancy-wrapper" }, " )")))), h("div", { key: '41a2fbd1efb02d668ee92549a513bf096ec6d003', class: "row m-0 p-0 actionsContainer" }, h("select", { key: 'e100cbbc1c91a4703e87e88e69ea82695106d3a3', class: "form-control input-sm room-select flex-grow-1", id: v4(), onChange: evt => this.onSelectRoom(evt) }, h("option", { key: 'fc6f592675c5fcdf0d631bc460b6012c8106b0f8', value: "", selected: this.selectedRoom == -1 }, locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (h("div", { class: "buttonsContainer bg-red" }, h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), h("div", { key: '869de6dbb5349150cb7d804e5ffcce84c60ab442', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, h("ir-button", { key: '314cc72b9d3211fefae0ad17474855c03d66367d', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (h("ir-button", { key: '3491a4a93df4775fa227dae407efa000164bb68b', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), h("hr", { key: 'b4e132019dcd09078a05a4842ffb55c8fd4cf96d' }))));
    }
