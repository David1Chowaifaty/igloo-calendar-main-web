...
const IglTbaBookingView = /*@__PURE__*/ proxyCustomElement(class IglTbaBookingView extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '5982a086ac558b44ccefaf23ace01b6268a78e1b' }, h("div", { key: 'c4e7abc4170c8a9f2d27b6c7c6ccc4c4697196a4', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, h("div", { key: '9ed620ccebc047c3a15bbd9eebc39aeee419aaf4', class: `guestTitle booking-guest-title tba-guest-title pointer font-small-3 ${this.highlightSection ? 'selectedOrder is-active' : ''}`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, h("p", { key: 'd71cbb461060364fd31631a85ac6de4bf19e733c', class: "guest-booking-number" }, this.eventData.BOOKING_NUMBER), h("span", { key: 'e23fbd184ba78d62fddb9188320c0dc3a6a10102', class: "guest-separator" }, "-"), h("p", { key: '0474ac26c1f5ad61426e848267b78ec0d0129c2f', class: "guest-name truncate" }, this.eventData.NAME), this.eventData.occupancy && (h("p", { key: '722b7cfdac2997897b90d0a66324bb31370c16a3', class: "guest-occupancy" }, h("span", { key: '5630130debe9d804dfeb8bb67643a3d8f9a323c6', class: "guest-occupancy-wrapper" }, "( "), h("span", { key: '836755d8ef77d779dadaa13507ad5f0e617ae4b8', class: "guest-occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), h("span", { key: '943aa280477737f63ff54adb7fcb761fe1369885', class: "guest-occupancy-wrapper" }, " )")))), h("div", { key: '43924f553f0ff0ec09d5c5358e790d743a0db558', class: "row m-0 p-0 actionsContainer" }, h("select", { key: '1f95e66d3b1c62d2ff239c20e6b8f7e2df26b9ff', class: "form-control input-sm room-select flex-grow-1", id: v4(), onChange: evt => this.onSelectRoom(evt) }, h("option", { key: '9dfab72dfef76a60b6b7c44be78737c70dc673b8', value: "", selected: this.selectedRoom == -1 }, locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (h("div", { class: "buttonsContainer bg-red" }, h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), h("div", { key: '05b07134d0ad621fba97b7c237934f9020d54382', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, h("ir-button", { key: 'c282b169609e21af36c5d5fff55b36631db95a87', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (h("ir-button", { key: 'f3cb9b92fb8fbfcfb3b5baffdd9d518fe6965b81', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), h("hr", { key: '1b2cd8aa1b2bbd0c430d268e53ffa7a0db778f51' }))));
    }
