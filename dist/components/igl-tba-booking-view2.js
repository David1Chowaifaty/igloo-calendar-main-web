...
const IglTbaBookingView = /*@__PURE__*/ proxyCustomElement(class IglTbaBookingView extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'b5530370a3225ebd5d2757501c41e869facdef8f' }, h("div", { key: 'deca41667b03777d2ea97eaff2b9601370ccba0f', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, h("div", { key: '5b43c6f1d62e25d71301e732a6619b79df28a2e6', class: `guestTitle booking-guest-title tba-guest-title pointer font-small-3 ${this.highlightSection ? 'selectedOrder is-active' : ''}`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, h("p", { key: '239802bf2612f4443bbb63409f426c6d24da0057', class: "guest-booking-number" }, this.eventData.BOOKING_NUMBER), h("span", { key: 'ef9035c75c8ec77104132891663aab18ec5876d0', class: "guest-separator" }, "-"), h("p", { key: 'f492b7219c005087a16454e9d5f9d232106a67b5', class: "guest-name truncate" }, this.eventData.NAME), this.eventData.occupancy && (h("p", { key: 'c84e558d81790b309cab3952e6e4537ffbdf7b82', class: "guest-occupancy" }, h("span", { key: '9f33d59c33bf29347014794da4b157ac53207a22', class: "guest-occupancy-wrapper" }, "( "), h("span", { key: '64df43b3f4a81ec89c256d8616dc4f9f5a1edb7b', class: "guest-occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), h("span", { key: '5d1541804214adcc9afaf43d2e01e778dbe0a727', class: "guest-occupancy-wrapper" }, " )")))), h("div", { key: 'a75c05ee00bf3c521d22f2e862ec49452c1a6e8c', class: "row m-0 p-0 actionsContainer" }, h("select", { key: 'b73791bf5f077eea39975076bc8801990041629a', class: "form-control input-sm room-select flex-grow-1", id: v4(), onChange: evt => this.onSelectRoom(evt) }, h("option", { key: '3f9696ea7f44f44c8fbad71fe53cc7fb478b0a32', value: "", selected: this.selectedRoom == -1 }, locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (h("div", { class: "buttonsContainer bg-red" }, h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), h("div", { key: '12314cace225bee65e911bee659aed61ca8b6aad', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, h("ir-button", { key: '5bbeaf08106282adb2c23d6feda5422cdc00052e', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (h("ir-button", { key: '1d20d00e5f1ca38f6cffda7769e53ab496f8ad1d', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), h("hr", { key: 'f20123fc22159fdf2f44e4e9fbacf25c4ae12bd5' }))));
    }
