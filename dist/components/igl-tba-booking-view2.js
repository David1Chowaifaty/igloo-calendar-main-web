...
const IglTbaBookingView = /*@__PURE__*/ proxyCustomElement(class IglTbaBookingView extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '926b96686331b39c6c2ab653e85d679f78db4709' }, h("div", { key: 'f29703889fa9e1b60b76d5a41a3969c0cd133c56', class: "bookingContainer", onClick: () => this.handleHighlightAvailability() }, h("div", { key: 'e79350335f54742ee6fe5c7000c0639c6560586a', class: `guestTitle booking-guest-title tba-guest-title pointer font-small-3 ${this.highlightSection ? 'selectedOrder is-active' : ''}`, "data-toggle": "tooltip", "data-placement": "top", "data-original-title": "Click to assign unit" }, h("p", { key: '424b2c1e4016bf64c14e17edad9c4125df12568a', class: "guest-booking-number" }, this.eventData.BOOKING_NUMBER), h("span", { key: '0f4d6a1e5be830a878e94cb5b1a2ca012b7fb4e3', class: "guest-separator" }, "-"), h("p", { key: '2438d585f0156b8e90482eb418785b1257e23229', class: "guest-name truncate" }, this.eventData.NAME), this.eventData.occupancy && (h("p", { key: 'f502b704b1ff23d0727bf3405765530a92852f41', class: "guest-occupancy" }, h("span", { key: 'a0148d3ccc9501d837c7248f4ddd220fd91133e0', class: "guest-occupancy-wrapper" }, "( "), h("span", { key: '2f317d369f34731dd0da69672fb53fc5a0854bce', class: "guest-occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), h("span", { key: '5fa32d50e876ee563ae9a3a90652d510c8ea9229', class: "guest-occupancy-wrapper" }, " )")))), h("div", { key: '08e0745426f24e11c69aa8883aa35be7451bb071', class: "row m-0 p-0 actionsContainer" }, h("select", { key: '4707f0b691d71e0e8883d9e9e041bb7d2af3e642', class: "form-control input-sm room-select flex-grow-1", id: v4(), onChange: evt => this.onSelectRoom(evt) }, h("option", { key: '1db10ad737e85c47f11af2c7690694c61c57c892', value: "", selected: this.selectedRoom == -1 }, locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (h("option", { value: room.id, selected: this.selectedRoom == room.id }, room.name)))), this.highlightSection ? (h("div", { class: "buttonsContainer bg-red" }, h("button", { type: "button", class: "btn btn-secondary btn-sm mx-0", onClick: evt => this.handleCloseAssignment(evt) }, h("svg", { class: "m-0 p-0", xmlns: "http://www.w3.org/2000/svg", height: "12", width: "9", viewBox: "0 0 384 512" }, h("path", { fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))) : null), h("div", { key: '13e5f4c2412810a37c0c2ebc98e1062294f9c7dc', class: "d-flex align-items-center ", style: { gap: '0.5rem', paddingInline: '5px' } }, h("ir-button", { key: 'ab2a886cdcfa2602e6b5cbed27844e0ffc00ddbd', isLoading: this.isLoading === 'default', size: "sm", class: "flex-grow-1", text: locales.entries.Lcz_Assign, onClickHandler: evt => this.handleAssignUnit(evt), btn_disabled: this.selectedRoom === -1 }), this.canCheckIn() && (h("ir-button", { key: 'e3f83bff2358f43076630b463b665b793d5163c0', isLoading: this.isLoading === 'checkin', size: "sm", class: "flex-grow-1", text: locales.entries.Lcz_AssignedAndChecIn, onClickHandler: evt => this.handleAssignUnit(evt, true), btn_disabled: this.selectedRoom === -1 }))), h("hr", { key: 'cbdc93d9fece8ae132d3a6ab91fba9d385d44f78' }))));
    }
