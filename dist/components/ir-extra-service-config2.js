...
import { d as defineCustomElement$2 } from './ir-extra-service-config-form2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-extra-service-config", "ir-custom-button", "ir-custom-date-picker", "ir-custom-input", "ir-drawer", "ir-extra-service-config-form", "ir-validator"];
