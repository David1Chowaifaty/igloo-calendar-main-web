...
const IrServiceAssigneeSelect = /*@__PURE__*/ proxyCustomElement(class IrServiceAssigneeSelect extends HTMLElement {
    ...
    assignmentChange;
    render() {
        return (h(Host, { key: '6e04f88d98ecfc018458c8211f6715a3891da01d' }, h("wa-radio-group", { key: '5d749b19a04120bafe764325c8cd0bae330d2eba', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "small", label: this.label, orientation: "vertical" }, h("wa-radio", { key: '42d5d3ea3c99bef6828f8eebabcfb21a036b4116', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), h("wa-radio", { key: 'bbd75677569b3687e7a44fb041359e3d273e235d', value: "guest", appearance: "button" }, "Guest"))));
    }
