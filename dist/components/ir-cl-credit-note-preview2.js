...
const IrClCreditNotePreview = /*@__PURE__*/ proxyCustomElement(class IrClCreditNotePreview extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-cl-credit-note-preview":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrClCreditNotePreview);
            }
            break;
...
export { IrClCreditNotePreview as I, defineCustomElement as d };

//# sourceMappingURL=ir-cl-credit-note-preview2.js.map