...
const IrDateView = /*@__PURE__*/ proxyCustomElement(class IrDateView extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'e47007a80112a877672afd07ea4a4920ee7030dc' }, h("span", { key: 'ee24af6317bb457351db815e31424d5668dd2bb8', part: "base" }, h("span", { key: '53d5c72d37d64064c68939de6d4498b4e4d2bfe5', part: "from-date" }, fromStr), h("span", { key: 'dfc9c52ef7dcbda72de3a6790e35d10b566c6268', part: "separator", "aria-hidden": "true" }, h("svg", { key: '75c58b263ef00837c12a3d17c250adfd96845d91', xmlns: "http://www.w3.org/2000/svg", part: "separator-icon", viewBox: "0 0 512 512", "aria-hidden": "true", focusable: "false" }, h("path", { key: 'bda27be1ec13d8c3a1cd88a5fa3d232c3f929d9b', fill: "currentColor", d: "M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l370.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128z" }))), h("span", { key: '97a45a4bf2a8c378cb64d7a486429ba44e42dbb9', part: "to-date" }, toStr), this.showDateDifference && diff > 0 && (h("span", { key: 'd7e4eff4ce97e6cf9d53c47c255a8ffdf977ac08', part: "night-count" }, diff, "\u00A0", nightLabel)))));
    }
