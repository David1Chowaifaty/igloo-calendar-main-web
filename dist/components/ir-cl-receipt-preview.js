...
const IrClReceiptPreview$1 = /*@__PURE__*/ proxyCustomElement(class IrClReceiptPreview extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-cl-receipt-preview":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrClReceiptPreview$1);
            }
            break;
...
const IrClReceiptPreview = IrClReceiptPreview$1;
const defineCustomElement = defineCustomElement$1;

export { IrClReceiptPreview, defineCustomElement };
