...
const IrDatePicker = /*@__PURE__*/ proxyCustomElement(class IrDatePicker extends HTMLElement$1 {
    ...
    render() {
        return (h("div", { key: 'bd4a733129b4e03ec27a27a9450feabe25306fe4', class: "ir-date-picker-trigger" }, this.customPicker && h("slot", { key: '5b9bebf76bc830cb0a8f69eb37ff3a1f4d7bf807', name: "trigger" }), h("input", { key: '95defc645be7f4ac5779260fc8805618a38de585', type: "text", disabled: this.disabled, class: this.customPicker ? 'ir-date-picker-element' : 'form-control input-sm', ref: el => (this.pickerRef = el) })));
    }
    get el() { return this; }
