...
const IrQueueChart = /*@__PURE__*/ proxyCustomElement(class IrQueueChart extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-queue-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrQueueChart);
            }
            break;
    } });
}

export { IrQueueChart as I, defineCustomElement as d };

//# sourceMappingURL=ir-queue-chart2.js.map