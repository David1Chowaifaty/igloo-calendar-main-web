...
const IrAccordion = /*@__PURE__*/ proxyCustomElement(class IrAccordion extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '5c655b1d923d8df4adf0782482168f546d5c7858' }, h("div", { key: '90882f48a84c41551ad6dce2c80b855a12c8b4b1', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: '09ec4f5a63ad22a7e7b6070b3dfc86da5aaea236', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: 'e751e45aa56f090fb2eb9a787e4e1bf48babb5fc', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '813434318abe2ba7a533e861ac759e2c64b79940', class: "ir-accordion__trigger-content" }, h("slot", { key: '3fa383a0a2e10fdcc3cc6cf47123ad31ae97d93d', name: "trigger" }))), h("div", { key: 'dda515a613962b3e98f43d5c51ca430099cbaac1', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: 'f02fc289ec4f7559c0f02a5a149b90f36ce2a791', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: '119547ff44ab65e46bb154fa3687e48162a178fb' }))))));
    }
