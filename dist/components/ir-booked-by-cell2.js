...
const IrBookedByCell = /*@__PURE__*/ proxyCustomElement(class IrBookedByCell extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'de592c9f09ac605503cda826966fcd6c79dc44e5' }, this.label && h("p", { key: 'ee26a5b2e7da1450f8f2271f2a0f5feb94ecaf8c', class: "cell-label" }, this.label, ":"), h("div", { key: '175e7e84128d0c3a2459153a3890861b7679c590', class: "booked-by-source__container" }, this.clickableGuest ? (h("ir-custom-button", { size: "medium", onClickHandler: this.handleGuestClick.bind(this), variant: "brand", appearance: "plain", link: true }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: '804f1ddcff3d6cf93a4a1061422fd99fc495be32' }, h("wa-tooltip", { key: '03d880382dc6c9ac02811f55505a5cdfa326d6ad', for: repeatGuestBadgeId }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: '3bfafefd4168ce1aa7dbe6041fc66d652c5f328a', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: '446a6ff8c6dacdb87b249927a0db0801e8973af4' }, this.totalPersons, locales.entries.Lcz_P)), this.showPrivateNoteDot && h("span", { key: '29b2eaf7179433760f7b59c75b911a1106e6e19b', class: "booked-by-source__private-note" })), h("div", { key: 'd95a5ea19f079de1485e515a9b6790a5cb35d269', class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '418ef698b667e0f3411b731a3d2a4afa99a8c5fa' }, h("wa-tooltip", { key: 'f586570481b0b64a6add9bf141d158bb6dc3c2fc', for: loyaltyBadgeId }, locales.entries.Lcz_LoyaltyDiscountApplied), h("wa-icon", { key: '2b5d16febd31426989b65f2c6bc6e42bdfc109ab', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: '4175710ac17aa49f9223d848dedb11eb9e52bda6' }, h("wa-tooltip", { key: '9f836f1ca5b6986015405637eb3267e3b9d12bf3', for: couponBadgeId }, locales.entries.Lcz_Coupon, ": ", this.promoKey), h("wa-icon", { key: 'bb4b534f15ea1dae594560ca08f20b9f66d7ddce', id: couponBadgeId, name: "ticket" }))))));
    }
