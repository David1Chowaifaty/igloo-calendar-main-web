...
const IrBookedByCell = /*@__PURE__*/ proxyCustomElement(class IrBookedByCell extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '83206067a47517e29ea5767b5c0de94051801ac0' }, this.label && h("p", { key: '69bec2b5e846221d3a11754586173bb7da9372e9', class: "cell-label" }, this.label, ":"), h("div", { key: 'c8fc6f742f4fddce5461bbe38f326c368e5761e9', class: "booked-by-source__container" }, this.clickableGuest ? (h("button", { class: "booked-by-cell__button", onClick: this.handleGuestClick.bind(this) }, guest)) : (h("p", null, guest)), this.showRepeatGuestBadge && (h(Fragment, { key: '69c9cd406820b5861ecc013d9ae74e036af99ddb' }, h("wa-tooltip", { key: '1cad229a0a741eacf4e763e34e32295271f088f2', for: repeatGuestBadgeId }, `${locales.entries.Lcz_BookingsNbr}`.replace('%1', this.guest.nbr_confirmed_bookings.toString())), h("wa-icon", { key: '16568cc9697e99fc2c5f9ed67f4f566b8dd3384f', name: "heart", style: { color: '#FB0AAD' }, id: repeatGuestBadgeId }))), this.showPersons && (h("p", { key: 'a491ff2db6f90947530aa3b69842d5ff66252bc5' }, this.totalPersons, locales.entries.Lcz_P)), this.showPrivateNoteDot && h("span", { key: 'd156e3f7455b7421c4e43cd169c605d2131a43a5', class: "booked-by-source__private-note" })), this.showContactIcons && this.guest.country_phone_prefix && this.guest.mobile_without_prefix && (h("div", { key: '665b4d59137c3058735f79de01a32246754a6bfa', class: "booked-by-source__container booked-by-source__contact" }, h("a", { key: 'a4f56f0e0c9dd7c32fa42d02d5b69cf97d5bfc19', class: "booked-by-cell__button --mobile-only", href: `tel:${this.guest.country_phone_prefix}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}` }, h("wa-icon", { key: 'f46025c0a1e80a355ab7b4d68e66bbcbc81d9211', name: "phone" })), h("a", { key: 'e3d6409d0213d3c138b11b9daf742f7d95a5739a', class: "booked-by-cell__button", href: `https://wa.me/${this.guest.country_phone_prefix.replace('+', '')}${this.guest.mobile_without_prefix.replace(/\s+/g, '')}`, target: "_blank", rel: "noopener noreferrer" }, h("wa-icon", { key: '47aee8707e17c975449945519236d2f27cfbba40', name: "whatsapp", family: "brands" })))), h("div", { key: 'f6ef711b90bc9d2d173844cc027e50da51f8952a', class: "booked-by-source__container" }, this.showLoyaltyIcon && (h(Fragment, { key: '8453f9dea1a34fba18dde12c780d3fcfadd15ccc' }, h("wa-tooltip", { key: 'c394ae3fc22cb021d09c6081bb10f90a858c7d5a', for: loyaltyBadgeId }, locales.entries.Lcz_LoyaltyDiscountApplied), h("wa-icon", { key: 'eb70bab4052d77aea2ece023f8049ea0d7ab3854', name: "heart", variant: "regular", style: { color: '#fc6c85' }, id: loyaltyBadgeId }))), this.showPromoIcon && (h(Fragment, { key: '9279af43100dba2de4a1effb1b6eca76a1c8432c' }, h("wa-tooltip", { key: 'b50e5e10afe8132006338ae879833341a22a09ad', for: couponBadgeId }, locales.entries.Lcz_Coupon, ": ", this.promoKey), h("wa-icon", { key: 'ea544e1cfe06fa8602533523cacde19cc96f9865', id: couponBadgeId, name: "ticket" }))))));
    }
