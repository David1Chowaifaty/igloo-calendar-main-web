...
import { d as defineCustomElement$21 } from './igl-application-info2.js';
import { d as defineCustomElement$20 } from './igl-block-dates-view2.js';
import { d as defineCustomElement$1$ } from './igl-blocked-date-drawer2.js';
import { d as defineCustomElement$1_ } from './igl-booking-event2.js';
import { d as defineCustomElement$1Z } from './igl-booking-event-hover2.js';
import { d as defineCustomElement$1Y } from './igl-bulk-block2.js';
import { d as defineCustomElement$1X } from './igl-bulk-operations-drawer2.js';
import { d as defineCustomElement$1W } from './igl-bulk-stop-sale2.js';
import { d as defineCustomElement$1V } from './igl-cal-body2.js';
import { d as defineCustomElement$1U } from './igl-cal-footer2.js';
import { d as defineCustomElement$1T } from './igl-cal-header2.js';
import { d as defineCustomElement$1S } from './igl-date-range2.js';
import { d as defineCustomElement$1R } from './igl-hk-issues-dialog2.js';
import { d as defineCustomElement$1Q } from './igl-housekeeping-dialog2.js';
import { d as defineCustomElement$1P } from './igl-legend2.js';
...
import { d as defineCustomElement$1F } from './ir-arrival-time-dialog2.js';
import { d as defineCustomElement$1E } from './ir-assignment-toggle-dialog2.js';
import { d as defineCustomElement$1D } from './ir-billing2.js';
import { d as defineCustomElement$1C } from './ir-billing-drawer2.js';
import { d as defineCustomElement$1B } from './ir-booking-assign-items2.js';
import { d as defineCustomElement$1A } from './ir-booking-billing-recipient2.js';
import { d as defineCustomElement$1z } from './ir-booking-city-ledger2.js';
import { d as defineCustomElement$1y } from './ir-booking-company-dialog2.js';
import { d as defineCustomElement$1x } from './ir-booking-company-form2.js';
import { d as defineCustomElement$1w } from './ir-booking-details2.js';
import { d as defineCustomElement$1v } from './ir-booking-details-drawer2.js';
import { d as defineCustomElement$1u } from './ir-booking-editor2.js';
import { d as defineCustomElement$1t } from './ir-booking-editor-drawer2.js';
import { d as defineCustomElement$1s } from './ir-booking-editor-form2.js';
import { d as defineCustomElement$1r } from './ir-booking-editor-guest-form2.js';
import { d as defineCustomElement$1q } from './ir-booking-editor-header2.js';
import { d as defineCustomElement$1p } from './ir-booking-extra-note2.js';
import { d as defineCustomElement$1o } from './ir-booking-guarantee2.js';
import { d as defineCustomElement$1n } from './ir-booking-header2.js';
import { d as defineCustomElement$1m } from './ir-booking-rooms2.js';
import { d as defineCustomElement$1l } from './ir-booking-source-editor-dialog2.js';
import { d as defineCustomElement$1k } from './ir-booking-source-editor-form2.js';
import { d as defineCustomElement$1j } from './ir-booking-status-tag2.js';
import { d as defineCustomElement$1i } from './ir-button2.js';
import { d as defineCustomElement$1h } from './ir-checkout-dialog2.js';
import { d as defineCustomElement$1g } from './ir-city-ledger-transaction-drawer2.js';
import { d as defineCustomElement$1f } from './ir-city-ledger-transaction-form2.js';
import { d as defineCustomElement$1e } from './ir-cl-invoice-dialog2.js';
import { d as defineCustomElement$1d } from './ir-cl-invoice-form2.js';
...
import { d as defineCustomElement$1a } from './ir-custom-date-picker2.js';
import { d as defineCustomElement$19 } from './ir-custom-date-range2.js';
import { d as defineCustomElement$18 } from './ir-date-picker2.js';
...
const IglooCalendar = /*@__PURE__*/ proxyCustomElement(class IglooCalendar extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '6d7859655b675f05a2e03581a0b92326bb7240c5' }, h("ir-toast", { key: '48b6430d48619f9642b6fada95607f55b9387e25' }), h("ir-interceptor", { key: '728551aa55b7d569bd2f43773a3bb9663a5a0f4d' }), h("div", { key: 'c13a0ec7d16aa958d9fc4a09d73e3a3e463011e0', id: "iglooCalendar", class: { 'igl-calendar': true, 'showToBeAssigned': this.showToBeAssigned, 'showLegend': this.showLegend } }, this.shouldRenderCalendarView() ? (h(Fragment, { "data-testid": "ir-calendar" }, this.showToBeAssigned && (h("igl-to-be-assigned", { unassignedDatesProp: this.unassignedDates, to_date: this.to_date, from_date: this.from_date, propertyid: this.property_id, class: "tobeAssignedContainer", calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) })), this.showLegend && h("igl-legend", { class: "legendContainer", legendData: this.calendarData.legendData, onOptionEvent: evt => this.onOptionSelect(evt) }), h("div", { class: "calendarScrollContainer", onMouseDown: event => this.dragScrollContent(event), onScroll: () => this.calendarScrolling() }, h("div", { id: "calendarContainer" }, h("igl-cal-header", { unassignedDates: this.unassignedDates, to_date: this.to_date, propertyid: this.property_id, today: this.today, calendarData: this.calendarData, highlightedDate: this.highlightedDate, onOptionEvent: evt => this.onOptionSelect(evt) }), h("igl-cal-body", { propertyId: this.property_id, language: this.language, countries: this.countries, currency: this.calendarData.currency, today: this.today, highlightedDate: this.highlightedDate, isScrollViewDragging: this.scrollViewDragging, calendarData: this.calendarData }), h("igl-cal-footer", { isLegendOpen: this.showLegend, highlightedDate: this.highlightedDate, today: this.today, calendarData: this.calendarData, onOptionEvent: evt => this.onOptionSelect(evt) }))))) : (h("ir-loading-screen", { message: "Preparing Calendar Data" }))), h("ir-sidebar", { key: 'bb7d99acef50cf2cde3b16877a73596d26bcc79d', onIrSidebarToggle: this.handleSideBarToggle.bind(this), open: this.isSidebarOpen, showCloseButton: false, sidebarStyles: {
            ...
            }, checkOut: this.bookingItem?.TO_DATE }), h("igl-bulk-operations-drawer", { key: 'dca329cbfdafde69a0b948585d4c07a4a6bbe46a', property_id: this.property_id, onCloseDrawer: () => (this.calendarSidebarState = null), open: this.calendarSidebarState?.type === 'bulk-blocks' }), h("igl-blocked-date-drawer", { key: 'de4426e04e7877970fe9f53b5c224f91090f025b', onBlockedDateDrawerClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.bookingItem = null;
