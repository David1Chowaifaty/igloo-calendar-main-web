...
import { d as defineCustomElement$1u } from './igl-block-dates-view2.js';
import { d as defineCustomElement$1t } from './igl-book-property2.js';
import { d as defineCustomElement$1s } from './igl-book-property-footer2.js';
import { d as defineCustomElement$1r } from './igl-book-property-header2.js';
import { d as defineCustomElement$1q } from './igl-booking-event2.js';
import { d as defineCustomElement$1p } from './igl-booking-event-hover2.js';
import { d as defineCustomElement$1o } from './igl-booking-form2.js';
import { d as defineCustomElement$1n } from './igl-booking-overview-page2.js';
import { d as defineCustomElement$1m } from './igl-bulk-block2.js';
import { d as defineCustomElement$1l } from './igl-bulk-operations2.js';
import { d as defineCustomElement$1k } from './igl-bulk-stop-sale2.js';
import { d as defineCustomElement$1j } from './igl-cal-body2.js';
import { d as defineCustomElement$1i } from './igl-cal-footer2.js';
import { d as defineCustomElement$1h } from './igl-cal-header2.js';
import { d as defineCustomElement$1g } from './igl-date-range2.js';
import { d as defineCustomElement$1f } from './igl-legends2.js';
import { d as defineCustomElement$1e } from './igl-property-booked-by2.js';
import { d as defineCustomElement$1d } from './igl-rate-plan2.js';
import { d as defineCustomElement$1c } from './igl-reallocation-dialog2.js';
import { d as defineCustomElement$1b } from './igl-room-type2.js';
import { d as defineCustomElement$1a } from './igl-split-booking2.js';
import { d as defineCustomElement$19 } from './igl-tba-booking-view2.js';
import { d as defineCustomElement$18 } from './igl-tba-category-view2.js';
import { d as defineCustomElement$17 } from './igl-to-be-assigned2.js';
...
import { d as defineCustomElement$O } from './ir-dropdown2.js';
import { d as defineCustomElement$N } from './ir-dropdown-item2.js';
...
import { d as defineCustomElement$D } from './ir-interactive-title2.js';
...
import { d as defineCustomElement$x } from './ir-modal2.js';
import { d as defineCustomElement$w } from './ir-new-badge2.js';
...
import { d as defineCustomElement$n } from './ir-picker2.js';
import { d as defineCustomElement$m } from './ir-picker-item2.js';
...
const IglooCalendar = /*@__PURE__*/ proxyCustomElement(class IglooCalendar extends HTMLElement {
    ...
    render() {
        ...
        )), h("igl-reallocation-dialog", { key: '7874b568ee9a80fb56b4071070975121ff66d359', onResetModalState: () => (this.dialogData = null), onDialogClose: () => this.handleModalCancel(), data: this.dialogData?.reason === 'reallocate' ? this.dialogData : undefined }), h("ir-modal", { key: '272da20744f7094cf4542a7fa37818255ef5d09d', ref: el => (this.calendarModalEl = el), modalTitle: '', rightBtnActive: this.dialogData?.reason === 'reallocate' ? !this.dialogData.hideConfirmButton : true, leftBtnText: locales?.entries?.Lcz_Cancel, rightBtnText: locales?.entries?.Lcz_Confirm, modalBody: this.renderModalBody(), onConfirmModal: this.handleModalConfirm.bind(this), onCancelModal: this.handleModalCancel.bind(this) })));
    }
...
function defineCustomElement() {
    ...
    const components = ["igloo-calendar", "igl-application-info", "igl-block-dates-view", "igl-book-property", "igl-book-property-footer", "igl-book-property-header", "igl-booking-event", "igl-booking-event-hover", "igl-booking-form", "igl-booking-overview-page", "igl-bulk-block", "igl-bulk-operations", "igl-bulk-stop-sale", "igl-cal-body", "igl-cal-footer", "igl-cal-header", "igl-date-range", "igl-legends", "igl-property-booked-by", "igl-rate-plan", "igl-reallocation-dialog", "igl-room-type", "igl-split-booking", "igl-tba-booking-view", "igl-tba-category-view", "igl-to-be-assigned", "ir-applicable-policies", "ir-autocomplete", "ir-booking-company-form", "ir-booking-details", "ir-booking-extra-note", "ir-booking-guarantee", "ir-booking-header", "ir-booking-status-tag", "ir-button", "ir-checkbox", "ir-combobox", "ir-country-picker", "ir-custom-button", "ir-custom-date-picker", "ir-custom-input", "ir-date-picker", "ir-date-range", "ir-date-view", "ir-dialog", "ir-drawer", "ir-dropdown", "ir-dropdown-item", "ir-events-log", "ir-extra-service", "ir-extra-service-config", "ir-extra-services", "ir-guest-info-drawer", "ir-guest-info-form", "ir-icon", "ir-icons", "ir-input-text", "ir-interactive-title", "ir-interceptor", "ir-label", "ir-loading-screen", "ir-m-combobox", "ir-mobile-input", "ir-modal", "ir-new-badge", "ir-otp", "ir-otp-modal", "ir-payment-details", "ir-payment-folio", "ir-payment-item", "ir-payment-summary", "ir-payments-folio", "ir-phone-input", "ir-picker", "ir-picker-item", "ir-pickup", "ir-pickup-view", "ir-pms-logs", "ir-popover", "ir-price-input", "ir-radio", "ir-reservation-information", "ir-room", "ir-room-guests", "ir-room-nights", "ir-select", "ir-sidebar", "ir-spinner", "ir-success-loader", "ir-tabs", "ir-title", "ir-toast", "ir-tooltip", "ir-validator", "ir-weekday-selector", "ota-label"];
