...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'aaf413ab3ceff39ba0d6137856951b8394d7a017', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '4be22679c1ec37e8d1239ea6c7ccb3f4b0f346ff', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '1fd29306bc9c798def5f27eb701804cfb595bb51', name: "label", slot: "label" }), h("slot", { key: '3643c3673c6871268abbbeaada4665d438d8b9be' }), this.slotState.get('footer') && h("slot", { key: 'fb151b084ecc1cfb1e32f1dbe843809fde272b15', name: "footer", slot: "footer" })));
    }
