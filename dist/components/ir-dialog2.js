...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '6ceb874120af586a433474795b723200eb958a0d', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '44b4cf44be8ffd8f2a786d80e83ceae17f394d6c', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '13f2a41d89b9336a8badd046f910a699c2625f69', name: "label", slot: "label" }), h("slot", { key: '5248889f1b6571a3f60ec3aad4efb31f14d586cf' }), this.slotState.get('footer') && h("slot", { key: '119165c75f167bf27e6f148f8de5d1a1628868b8', name: "footer", slot: "footer" })));
    }
