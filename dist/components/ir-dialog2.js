...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '1939fde07d5a9e7961d1f92a060a74c6b20c4029', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'ad0b5c6a317962481228ce6225d7f85327505b7f', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '3ac7bdd2a8c7b004695fa962f73d103923f42295', name: "label", slot: "label" }), h("slot", { key: '647ef32c5b1ae28f4a183facfda55a0027293c3b' }), this.slotState.get('footer') && h("slot", { key: '8ddba4062717376845cde962d125e17856189022', name: "footer", slot: "footer" })));
    }
