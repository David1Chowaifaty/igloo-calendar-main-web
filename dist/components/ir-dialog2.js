...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '4cc908170651e043ac506fdcb2ced6688556abc8' }, h("div", { key: 'ae5450fdb1f07636dd0014bc375e9ec9e806cf5b', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '7eda348732a5190df11bce3c5bcde38fe36a6b58', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'fb07978f773bc69d2578c2e87bed69ab7f6c3c63', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '15ca6841ce4cfa8a59bdae329cdd25c7633abef5', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '7f635a03b2720df82d0436c0a90dcb552f0ff770', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '18dfdc9fcd50737537d394a4a38fb6afe1b1d2a0', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '23237838d47ee729e16084fb1d6fc7f0edbfb1df', name: "modal-title" })), h("div", { key: 'fe96fc0266bfe6955062da22a00719b73d99bc4b', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'b62fd9cfb195dcf6e7ce59c9970d938991051776', name: "modal-body" })), h("div", { key: 'e04bb792750602eee7c5b0926aa2ae89a76eb338', class: "modal-footer" }, h("slot", { key: 'bcb4fd4dcc9d354dba8e54bf61a6f88a79a7fef6', name: "modal-footer" }))))));
    }
    get el() { return this; }
