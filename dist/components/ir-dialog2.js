...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '4ebbd45388e20e7a5490aab9e9922fb122738e7a' }, h("div", { key: '379fe52eaa95a506e2f19215a176f77f96e125a6', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '09539cdb8be9708e8c86e7d3a9e8e4ec0e871166', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'f87103400e4d094b9d1075b3789057ac4a27c20f', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'a309d7106e15a3d509b04573f6d57d321eab0a42', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '90a370ad55d06fd659efc38bfbb58a66d15867dd', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'c93812c6c514ebcd2ad0b0507dcb856dee6e54d4', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '7ebd23f6b6c3c9001a92d71853bdc403aa2fbf1a', name: "modal-title" })), h("div", { key: '09594b1d02c105b6e9305aef10addbbfc62b27df', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'b2502c283aeff728770b75120268793ffc96d733', name: "modal-body" })), h("div", { key: 'aea5ba9efe73e50bfc19ac7a305e1b3895f2b588', class: "modal-footer" }, h("slot", { key: '0c1522e77e250e35a7691bda35161dfbf8cc780b', name: "modal-footer" }))))));
    }
    get el() { return this; }
