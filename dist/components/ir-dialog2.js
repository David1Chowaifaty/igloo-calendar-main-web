...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '77dda878abe85352e69172f786b66fcc61cf1bfa', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'd336b12999daab229bd564eaac3f7de4cf144c50', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '306b8605d0bf5919bc3f39123541c0ed8b61699b', name: "label", slot: "label" }), h("slot", { key: '69b09ef00864491aa5d3e2f69d6512a431ccb927' }), this.slotState.get('footer') && h("slot", { key: '0e1dcbedc2cb80565a6de170bfa998fc268863f0', name: "footer", slot: "footer" })));
    }
