...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'ed6f0adde9764b5465c3223ae4526b33560410c5', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '11c8acd02efc109d2236161dab9ecc117ae16443', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'a94aac4fa384dc0ebb41879d0b10201e7a9b9e8d', name: "label", slot: "label" }), h("slot", { key: '9e8473a3b0839d33cce2a5d016e9dc26a2734fc6' }), this.slotState.get('footer') && h("slot", { key: 'ea82a8f975caeade31fa4afa311bdfd5717cfd42', name: "footer", slot: "footer" })));
    }
