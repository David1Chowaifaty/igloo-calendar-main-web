...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '975d430b5d0bbd8465ca3a9180c5bad160d82425', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '481c54f16c8853c957ecddf2f36132441fd43ca7', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'f1309352aa20971872c59e1b176945491dbbd15f', name: "label", slot: "label" }), h("slot", { key: 'f7f687daef54a440f2b227a8c45ce7d3207aba99' }), this.slotState.get('footer') && h("slot", { key: 'b4cbca1344746db0f5ccf77c4843f9434110b709', name: "footer", slot: "footer" })));
    }
