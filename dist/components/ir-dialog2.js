...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '82b9f40ecec1f81755e1323d38a9405b3eb1b959', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '750bd670fdbd1b93bf297e4182cc06099297ee17', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'e508e7379873bc6009d277c9730fb9828464677c', name: "label", slot: "label" }), h("slot", { key: '043049dd8b4bee6476b92313860977cc618da4a5' }), this.slotState.get('footer') && h("slot", { key: 'e42b13c864e66a6da0d75a4ea39dee68de59a3ef', name: "footer", slot: "footer" })));
    }
