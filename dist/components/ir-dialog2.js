...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'f05ee76f664377c9007c5a1b10ce5581c3d58a6b', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'bc5f7bdfb9f6c1e93f22ed8fd2f2ec067fb11517', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'ef611ef55c36e39d91dc199698fdeaec98d380b3', name: "label", slot: "label" }), h("slot", { key: '264f5904082b01946323662eaa7c02dfbd463f61' }), this.slotState.get('footer') && h("slot", { key: '866e0415ae9367e3fef26df606e5dbd41c63204b', name: "footer", slot: "footer" })));
    }
