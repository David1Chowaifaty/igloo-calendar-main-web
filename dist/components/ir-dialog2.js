...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'c62d57dcf2d0761dabec2f7832d2a6f411c8c546', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '384ef3899aba215df2ceeb82ecd32ad627b941bb', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'd95c8a7daafaa522c76f897e15b0532d198b91ec', name: "label", slot: "label" }), h("slot", { key: '35f028689245f490dd400dc680b05a370f036c62' }), this.slotState.get('footer') && h("slot", { key: 'da5497b85acd3d80aa2e7fc272988a1fd7a12ab5', name: "footer", slot: "footer" })));
    }
