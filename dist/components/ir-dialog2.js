...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '895c99d0d09aae07c03897f5abb571bce50a9ffd', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '1bd2e18addf09a2230a05b7fe51e08d4cde8c737', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '572d7b63ccb486194813292623e5938f9ba81d9d', name: "label", slot: "label" }), h("slot", { key: '83e032846f487953d6ed14fdb3c6a7620d56ded2' }), this.slotState.get('footer') && h("slot", { key: '3d53870225e7c676cf876b7f966cb8bbfbb9375f', name: "footer", slot: "footer" })));
    }
