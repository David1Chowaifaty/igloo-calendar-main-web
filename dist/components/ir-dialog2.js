...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '6594f802eab568e4be9371e3deeacc06f6ddc42c', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'b8707c950828a60b6d80e585c23a04a558e1db9e', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'eee522e37d49660175bca70d3aba4db5b00b20f0', name: "label", slot: "label" }), h("slot", { key: '3d1be2033704690c020028a5828817f5a79a2924' }), this.slotState.get('footer') && h("slot", { key: '4295b73644370a7ca884e04046a6ce22ed6a5554', name: "footer", slot: "footer" })));
    }
