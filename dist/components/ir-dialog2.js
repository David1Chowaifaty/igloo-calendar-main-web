...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'fa2fc507c27199d6bb02b252051536d77ee038b5' }, h("div", { key: 'f0e6f2393a868ac8ebc08786f035dd6db25a5018', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '31814700d0dd5ad0410ec4d94fabe467feda3359', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'ba7282d85a1c22f7cd04881dd8a0ff9d5e79f1f9', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '0bcd7949a4303ce03404167231e7595f70b57abc', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '09d800647e2b47daca2766829eef6c802e459aa6', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '76f2a67f10a8979095d39c83d0477a06b5653de4', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '0e3ec330de18cf5388d8d331dceb50d3a83f1d0f', name: "modal-title" })), h("div", { key: 'd2da791dcd71280391587d65a1cd2ca204d99f0c', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'bbc5f30e035c6ce9babf27ddd506fea2610395aa', name: "modal-body" })), h("div", { key: '07135bcf0cc5345a742d5e244b436183713bbfbd', class: "modal-footer" }, h("slot", { key: 'f9f51ed6864d07be040fe45813112a036f262c20', name: "modal-footer" }))))));
    }
    get el() { return this; }
