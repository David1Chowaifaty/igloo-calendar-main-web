...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'cfaadfd5ba464594e480eaac948a816aac6612d5', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '2e5347cfab4dff92c9b5b1f698e83836794642f8', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'fa3bc743064c1b04dd2a40b78526f5fc22838bd5', name: "label", slot: "label" }), h("slot", { key: '9d12482e7d2142e39b9b0e79e35bd68906da9cfc' }), this.slotState.get('footer') && h("slot", { key: '490e7734ba6ff53d7f1038f1bf44a7c9d8340e30', name: "footer", slot: "footer" })));
    }
