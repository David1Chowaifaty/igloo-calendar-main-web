...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '987fcd9aa0e4e4dd05b6c53c4a5e5ed6f6cd5d02', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '0e5257c9cde41c774b8d4010e0f0afe39f56d303', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '53dc899698e716b8233aaacb3cfccc248fddf47e', name: "label", slot: "label" }), h("slot", { key: '2be150c60140fa3fd72ec12ae879b57254e9d246' }), this.slotState.get('footer') && h("slot", { key: 'e13d5767708d38560a78541c847542f0419e2bf4', name: "footer", slot: "footer" })));
    }
