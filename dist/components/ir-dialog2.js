...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '37b34c7a3dbf5ca724d89e4168fc1f013458801a', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'd97d78e18d5035c1940deba4835c652412925123', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '2eb5994671c008140bbae5d4d6748185d1fde514', name: "label", slot: "label" }), h("slot", { key: '1cadd0e1c9e5535e7c96a36fc82d41a182c13f2a' }), this.slotState.get('footer') && h("slot", { key: '6215add082e9151f8f21fd2ebea49a0b02fd8b79', name: "footer", slot: "footer" })));
    }
