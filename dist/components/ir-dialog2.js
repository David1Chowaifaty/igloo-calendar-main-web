...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'e9dcc1e40c89e89f5af3b83fe750f94cdfd26af2', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '8df409336ebc48e4447328e14343bde628feaf65', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'f8b037efc5caa8dc193e5b1fb1e18c430df6ba5d', name: "label", slot: "label" }), h("slot", { key: 'a21374d5cd68ff1f8887c6c876950f907bdb609d' }), this.slotState.get('footer') && h("slot", { key: 'b756368aa4d42e147aef930a68c58949934d3499', name: "footer", slot: "footer" })));
    }
