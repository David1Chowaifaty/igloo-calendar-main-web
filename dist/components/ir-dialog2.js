...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '7c2c01c457313eef0b7560cef42b36294689eb30', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '626da11cbeae0e12cf86d4f1be91e2841076871a', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '3afdb4e07ad9d57f2a0d2644d5e930c3caa85356', name: "label", slot: "label" }), h("slot", { key: 'e3322826fae393365d1a78f6d6cc151aaef053dc' }), this.slotState.get('footer') && h("slot", { key: '4cc7b5fa62f37bbe661302ce9ee756914a479bd2', name: "footer", slot: "footer" })));
    }
