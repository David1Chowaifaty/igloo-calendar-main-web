...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'da71b12b936a93cf37abac41159e90e38a15e5ca', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'd61e538c954cb723207492d6e6a82dd40a333ed9', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '7f4c8749de507ae9d5e8a9700f0cea98c8536f04', name: "label", slot: "label" }), h("slot", { key: '8751f1311e98bd58a984052f25b7d4805009d33b' }), this.slotState.get('footer') && h("slot", { key: '19e01bcfe7b80afc2419e3119c1bfb27490750ab', name: "footer", slot: "footer" })));
    }
