...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'a053aa643747ecc02aca90686a673e7d978b4b2a', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '09be50be104bc43b69ae5b64dee8a433fe5d3ea4', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '70397dd97f4b3ee91ab4bdad05dab0bcd96066e8', name: "label", slot: "label" }), h("slot", { key: '3c0d467e009f31963a9e70a304aa2d0507bf3b8f' }), this.slotState.get('footer') && h("slot", { key: '86cf7194eb72baa7a5acf21f24e7d8ac38a9e9b0', name: "footer", slot: "footer" })));
    }
