...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '06e0770c0281e2ed663a6f131aa8252dddcad769', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '25d497a919a82cfb68d6cf29bc0ed0c89211a377', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '4adcc4c3c57ea95c42ce70c7542bdcb42edb88e8', name: "label", slot: "label" }), h("slot", { key: '8a17183eb44b33d04ed336ba715729403cb2e330' }), this.slotState.get('footer') && h("slot", { key: '788d370d4825fce23db9785e800f52364ba12382', name: "footer", slot: "footer" })));
    }
