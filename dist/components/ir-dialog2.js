...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'cd20f13387be416eed3ee2d699bd345cb115b65b' }, h("div", { key: '4670ce25bf6610ed1488238a2df0189d6d5ec3aa', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '21961380f9dcf1550a1fb3a70502d11be5cc90b1', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'de9ded9edf79941f77332e499749795f88d5bb31', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '144fc42695b0bd0c8cae2aaab9c0da4297fe2d20', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '4b1fce5b10b98613d4321bf88c2d7377a0f05eaa', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'd9ae2b1e309708f70fca8592e6a41565567c14dd', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'ba574cf45cad0d426646d43aaebfaaf171026ccd', name: "modal-title" })), h("div", { key: '86a858cc8b0a9bd7113283148ff5769e1700655a', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'b82f638afddb94726d97dcacbdf0f94ece853c81', name: "modal-body" })), h("div", { key: 'b3cdf9f7012c92f10e79467bef54d5bfce5829ee', class: "modal-footer" }, h("slot", { key: 'e728d2fb1e11c6c7a1501d19f7e0fcb065db3672', name: "modal-footer" }))))));
    }
    get el() { return this; }
