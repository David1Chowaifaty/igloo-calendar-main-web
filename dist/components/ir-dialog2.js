...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'c33471cec3783d31884a6bf2f9170fe3503a575b', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '96738187195b6dc668b3ad2fef2c0af744bfb2ac', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '92be0cd2cddd1c6c558fcf7b667b794ed70edcfa', name: "label", slot: "label" }), h("slot", { key: '206d0f56de1214e49fd12d910ff81027e5b1c32b' }), this.slotState.get('footer') && h("slot", { key: '4e0dac79ae7fb7474705fb64d58da19d7110663b', name: "footer", slot: "footer" })));
    }
