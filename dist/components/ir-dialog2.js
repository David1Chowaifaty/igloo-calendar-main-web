...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '135525e92c4979da1a1c90f326a2abc2604e2bbf', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '4c27840a43d3b36989c63404418a602f9982f6e2', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '601aeb0b18272f44dd097132d953c9485b46ffc2', name: "label", slot: "label" }), h("slot", { key: 'ec09e1a8aee126b3dc22fd654a57b4dbb287fbb3' }), this.slotState.get('footer') && h("slot", { key: 'd8bdcf6491cef8f22b19e5d929cb39cb4ba77871', name: "footer", slot: "footer" })));
    }
