...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '96edf838e0098f72be17559248b056c379d9c50e', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'cf3843ed46376484717690f27ba03a93d6509512', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '46e65a95fb0aacd4593d890dfd4456c6ef79c624', name: "label", slot: "label" }), h("slot", { key: 'f2c0622154bd5ff12ccf8f55fe39a5c110b254cc' }), this.slotState.get('footer') && h("slot", { key: '42657478374a4a8bb5d461b21878408944d849ae', name: "footer", slot: "footer" })));
    }
