...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '08a4013a5f9379252fafdba5b7839ed446460853' }, h("div", { key: 'a9528d6113dd7bb9afc88568b838f9236db6d8c4', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '285d35578417c7e8adee7608e6fde41e10beedf3', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'e9b0ad823cce979395ab2e4e4fa0fe04e125298d', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'caa6d3d43f9d2d28743bb48bdcd39304cbfc9c01', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '0a885b0f7809dad2a5e43bc99907d7f1c95c41c3', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'f1e46107dc228a9ce41dfbbcb1eee49148f6dd71', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '596d4ac5df2a2e99357cecf1a6339dbe41ab0b90', name: "modal-title" })), h("div", { key: '16847a59b09191130a4539205d8a092f4ad9251d', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '3dca97cb8bdb78e9958f4bb356fe11f6d57fc9b7', name: "modal-body" })), h("div", { key: 'b3a74d7eec1c3b64eaa81240b44d5ae3c5e65b56', class: "modal-footer" }, h("slot", { key: '71224ae00ce572df9981785957097468c3d1af47', name: "modal-footer" }))))));
    }
    get el() { return this; }
