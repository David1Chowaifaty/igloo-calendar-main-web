...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'e4e750da1ec6fba46bf18c884cdc811f83804a5d', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '9b51a7bf244a01ed1fc48b4dbe18ff4c923141c6', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'f45c7e3065ed2aea5a4f87666a783c694342744b', name: "label", slot: "label" }), h("slot", { key: '76126c9362b1581f1ad58566f708a8d20e494c78' }), this.slotState.get('footer') && h("slot", { key: '42c33f892f006837dadce8818f401364b6118355', name: "footer", slot: "footer" })));
    }
