...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'c58e848036a0ec8ba265451597157d18eec002b8', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '3a0b09e110512bfd893f0cdc434210681a0af855', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '092423b776aa586af0d1d3c7b2bbbcea53712813', name: "label", slot: "label" }), h("slot", { key: 'f1a20d002c5a14620c316ad3a28aac4aed12d36f' }), this.slotState.get('footer') && h("slot", { key: '2fe9c92c8bc396fa43259c1f94a3aa9fc1b0e5b8', name: "footer", slot: "footer" })));
    }
