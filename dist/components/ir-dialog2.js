...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'c4357126635f06838256e0da3d023b66d6b7295c', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'fbcd3e5f73b59d9d53a6f21e02f759280dce97d7', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'cb6bd1f2f8bc691faea3357f2986b8c5194709b4', name: "label", slot: "label" }), h("slot", { key: '2b3e94a62bb0949c8141fc5d3f9d1e4438fc6146' }), this.slotState.get('footer') && h("slot", { key: 'a09d7a83bc3cb9183cb0007df3cd3673dce57e49', name: "footer", slot: "footer" })));
    }
