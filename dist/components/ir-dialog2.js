...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '0d958de7180c990dadb244b5018d5327f91d7f06', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '07be91347abdbee0f4bb0ad024b995f5d87e4522', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'fec104da9999813df00e1c309b93a448c8d35c70', name: "label", slot: "label" }), h("slot", { key: '901730a43df1987bad4bd0624f495b2b48943b50' }), this.slotState.get('footer') && h("slot", { key: '96bc7a63a81e4c1daa4a0c36d4c744bfc5489e26', name: "footer", slot: "footer" })));
    }
