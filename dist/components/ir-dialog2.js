...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '1bb979cb0bff3c880d596acedb6e262ea2d260c1', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'cb40738f029cec32955bbb17902b3e1777f68ab8', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'bc2ede34d063c7c48175c7aba1758aa58eef144d', name: "label", slot: "label" }), h("slot", { key: 'e76faee17306b3269829fcf99e3348b3e59418f3' }), this.slotState.get('footer') && h("slot", { key: 'd423728a70f5acd8386ae01918f8a354a20814c0', name: "footer", slot: "footer" })));
    }
