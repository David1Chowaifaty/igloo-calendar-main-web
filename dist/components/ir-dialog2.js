...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '3c96fbcf6dda303c97f582540d2034becce75727' }, h("div", { key: '82f8444ddb831898ceb81158af9b847482fec4c0', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: 'f640dffabb56f9c07c5e8a9a5401b30e99cbacb5', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'e6666eaad5f5f500fb804da7f1fe2b5fb45fd455', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '42b945b0ae6f9743178b75899bf9ac8d9febc218', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '28356c55e601e33cf4b9c3dc678022dabbadaf96', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: '3786f566a0ac9cc17a7a483eb866392d21c7cbda', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '3f5a8e01373cc5f43b9b1badd25f156c999f34ab', name: "modal-title" })), h("div", { key: '6e1910db1f080b02dd377c8ddd28bf41ef6e6da9', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'f652941e5f4ce3c765020b9b77acb9f76cbd7553', name: "modal-body" })), h("div", { key: 'fc87f0a105e51632d3decc34b6e3b3a344d57cbe', class: "modal-footer" }, h("slot", { key: '96d3253acbeb7fb0b9a1109c3a876c6c83d1eea2', name: "modal-footer" }))))));
    }
    get el() { return this; }
