...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '9490cd7bd2654829bd2dd2076c90c73264644146', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'e5df7caa3d9d90e7f9974c02d4e504d31ca50e87', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '3feb4d6cd275a37ca379d5c840adca8fecbc00d1', name: "label", slot: "label" }), h("slot", { key: '6d44a82e9fde48730ac7f929a10bff138c0fc783' }), this.slotState.get('footer') && h("slot", { key: '042f42b2d722c7753509c3702ef9c0014e46d22e', name: "footer", slot: "footer" })));
    }
