...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: 'b4862ea1ef92f286b23f332187a09de618dd747f', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'd83609af88b165cdd49fe06659edaeb1fe92edf6', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'd895f1a48fb28468c977106dbc27d083ff86015c', name: "label", slot: "label" }), h("slot", { key: '384967743ae1a96af083ef491f78e57513052e32' }), this.slotState.get('footer') && h("slot", { key: '26c7a031843b660f5d584ea6e2ee196ed488dbf4', name: "footer", slot: "footer" })));
    }
