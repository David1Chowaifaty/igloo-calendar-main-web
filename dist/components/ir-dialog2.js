...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '532dc60b6334ea6f7cf3353c4f8e11d7aac7820c' }, h("div", { key: '83fc14376c0bd6edad36f1fb73d23ed0ab46b2bd', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '7fc5bbe621c8e9b87785dcf0666d6434461a38e6', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: '51daea59fde3489929f0e85002c04b1b5bcbcb16', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '723f482d7e000eb70c7175f783ebf07068ffbdec', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: 'c339b3f15dcd4e25cb89ebafebaea89d05f6eca2', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'c68332c15acab9f78a865bb0275d02b5916a5851', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'ff4178300f484e38a8e971bc873c3f31d3afce9e', name: "modal-title" })), h("div", { key: '58073f557293c0cb585891f58305104f74adbaaa', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: 'c802862673e42b004f5cacb6093208dc05aa29ab', name: "modal-body" })), h("div", { key: 'a31c2ba743383614fb0fa4156ef8c218d3a1ee67', class: "modal-footer" }, h("slot", { key: '6e56e8599a844163c7f49d3e8506ba1de008f4dc', name: "modal-footer" }))))));
    }
    get el() { return this; }
