...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '50d29521d981e296f0a6dec20b7fd3b216ce9a42', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: 'd0a349686167049cd218f53083d32d5e94b87b94', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: '5bb49f3205dc455b8a66d1576ecf0a666c1bb769', name: "label", slot: "label" }), h("slot", { key: 'f335ecf0239dde51de6dc13ebeeb9e7f5a184ea1' }), this.slotState.get('footer') && h("slot", { key: '178447fd3598c0ca281b0383426faae45ab40d0e', name: "footer", slot: "footer" })));
    }
