...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '999d63b7ad41169ac68b19d03e1d7124681b770a' }, h("div", { key: '507c0a7aff5109d8a80d4bb9ee6061c2e8ff3a2e', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '10a1f5ba5dc8b69b5619651316bb93695a21407b', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: 'cd82e52620599eb70e749a8a4db36333dbd6a2ba', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: '2cb605293b6863db27d80666c6d8c77a5f66314b', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '9c2dd0da09fdd930d957f15a29e4a1bfb15cd43a', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'cfabcaa12054af012f45b1613c0b22349345a69b', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: 'a40edecb4018dc8ddb81d0fc1a8a259bacd11836', name: "modal-title" })), h("div", { key: 'd3e8dd4a08e9a9cf4b0b668f48c74dbe95744c8a', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '05a68a33491fcb7474ff81e62071a67d32e82fe9', name: "modal-body" })), h("div", { key: '021a865b68ebdc57bc9a0ea2d1479c8c3688a723', class: "modal-footer" }, h("slot", { key: '44d98d3741c6e74a7f7be0ddd8c12f1e7116f705', name: "modal-footer" }))))));
    }
    get el() { return this; }
