...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '791abf0152b7f676d787d85391fea8aa90f5a15a' }, h("div", { key: 'dc960c541b1a28137adc08e9f5e2db10b4ada255', class: "backdrop", "data-state": this.isOpen ? 'opened' : 'closed', onClick: () => this.closeModal() }), this.isOpen && (h("div", { key: '1c0135cdf55bc9fc9891acfa5d9a44eb47e4b1e0', class: "modal-container", tabIndex: -1, role: "dialog", "aria-labelledby": "dialog1Title", "aria-describedby": "dialog1Desc" }, h("ir-icon", { key: '85f48054d218168da482a030ca71661f0dbd739e', id: "close", class: "dialog-close-button", onIconClickHandler: () => this.closeModal() }, h("svg", { key: 'f8d80e7685dd0f2588a9f0b5e3a39865925ecc30', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 18, width: 18 }, h("path", { key: '0c38a150d5ffe2c1bf4923c35398356b5dc1756e', fill: "#104064", class: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))), h("div", { key: 'a9742e733b8bf8273e2a58a41ece609e136f3234', class: 'modal-title', id: "dialog1Title" }, h("slot", { key: '3036fb662c26c1a256210ccaf033d4f32ba2d0b6', name: "modal-title" })), h("div", { key: 'c71a015ae694276a427adf3263b03c244181ed70', class: "modal-body", id: "dialog1Desc" }, h("slot", { key: '7d5003a34d04ae8f9c45567a85aa3b799fa5ac2e', name: "modal-body" })), h("div", { key: '00d29c1f6747bd9c49e147781dc9274c02ce22fa', class: "modal-footer" }, h("slot", { key: '93b3a5f67c8842c7fd5769718944601f415a56aa', name: "modal-footer" }))))));
    }
    get el() { return this; }
