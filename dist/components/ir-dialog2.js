...
const IrDialog = /*@__PURE__*/ proxyCustomElement(class IrDialog extends HTMLElement {
    ...
    render() {
        return (h("wa-dialog", { key: '0101a4d5386b83f9e0e3f25544d3340508ec36d8', "onwa-hide": this.handleWaHide.bind(this), "onwa-show": this.handleWaShow.bind(this), "onwa-after-hide": this.handleWaAfterHide.bind(this), "onwa-after-show": this.handleWaAfterShow.bind(this), label: this.label, id: "dialog-overview", open: this.open, style: { '--width': 'var(--ir-dialog-width,31rem)' }, "without-header": this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotState.get('header-actions') && h("slot", { key: '18a568f418faa7ef62ed69d7680f76a79af98f92', name: "header-actions", slot: "header-actions" }), this.slotState.get('label') && h("slot", { key: 'dbb8ce27fa48c0d75f1d89252d44cff04a148732', name: "label", slot: "label" }), h("slot", { key: '7915a6c3bd9cd1f7cd1e6b5c5af2394c6d670786' }), this.slotState.get('footer') && h("slot", { key: 'd4c524f566deb71a0a558561c798c64ae8789d6e', name: "footer", slot: "footer" })));
    }
