...
const IrBookingNewForm$1 = /*@__PURE__*/ proxyCustomElement(class IrBookingNewForm extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'a671a424a6ae34d0c5b50609a7e3866130fe3048' }, h("div", { key: 'a0e1fb67634b1bd7b3e0f9e13ccf6a8599f34fc9', onClick: () => {
                this.handleTriggerClicked();
            } }, h("slot", { key: '69979fdf8e1ffdef23a6e401fe25dd70b1625849', name: "trigger" }, h("ir-custom-button", { key: '33e1d8da120d65cbf173b4ca8c7431edbde5971a', appearance: "plain", variant: "brand" }, h("wa-icon", { key: '77b32e08980b362a72d8a8de4fa56a28c8d3a6e5', name: "circle-plus", style: { fontSize: '1.2rem' } })))), h("ir-booking-editor-drawer", { key: '2d291439899440170b600058d3efe2446d0dddd0', onBookingEditorClosed: e => {
...
function defineCustomElement$1() {
    ...
    const components = ["ir-booking-new-form", "igl-application-info", "igl-rate-plan", "igl-room-type", "ir-booking-editor", "ir-booking-editor-drawer", "ir-booking-editor-form", "ir-booking-editor-guest-form", "ir-booking-editor-header", "ir-button", "ir-country-picker", "ir-custom-button", "ir-custom-date-range", "ir-date-range", "ir-date-view", "ir-drawer", "ir-icons", "ir-input", "ir-input-text", "ir-interceptor", "ir-mobile-input", "ir-otp", "ir-otp-modal", "ir-picker", "ir-picker-item", "ir-service-assignee-select", "ir-spinner", "ir-validator"];
