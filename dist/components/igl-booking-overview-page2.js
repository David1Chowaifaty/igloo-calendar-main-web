...
function defineCustomElement() {
    ...
    const components = ["igl-booking-overview-page", "igl-book-property-header", "igl-date-range", "igl-rate-plan", "igl-room-type", "ir-custom-button", "ir-date-range", "ir-input", "ir-picker", "ir-picker-item"];
