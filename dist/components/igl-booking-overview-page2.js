...
function defineCustomElement() {
    ...
    const components = ["igl-booking-overview-page", "igl-book-property-header", "igl-rate-plan", "igl-room-type", "ir-custom-button", "ir-custom-date-range", "ir-date-range", "ir-input", "ir-picker", "ir-picker-item", "ir-validator"];
