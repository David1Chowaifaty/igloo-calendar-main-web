...
const IrMenuBarMenu$1 = /*@__PURE__*/ proxyCustomElement(class IrMenuBarMenu extends HTMLElement$1 {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return IrMenuBarMenuStyle0; }
}, [1, "ir-menu-bar-menu", {
        "newBadge": [1540, "new"],
        "open": [1540],
        "hasDropdown": [32],
        "isAccordionLayout": [32]
    }, undefined, {
        "open": ["handleMenuBarOpenChange"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["ir-menu-bar-menu", "ir-new-badge"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-menu-bar-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrMenuBarMenu$1);
            }
            break;
        case "ir-new-badge":
            if (!customElements.get(tagName)) {
...
const IrMenuBarMenu = IrMenuBarMenu$1;
const defineCustomElement = defineCustomElement$1;

export { IrMenuBarMenu, defineCustomElement };
