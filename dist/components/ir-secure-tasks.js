...
function defineCustomElement$1() {
    ...
    const components = ["ir-secure-tasks", "igl-date-range", "ir-button", "ir-checkbox", "ir-date-picker", "ir-date-range", "ir-date-view", "ir-hk-archive", "ir-hk-tasks", "ir-icon", "ir-icons", "ir-input-text", "ir-interceptor", "ir-loading-screen", "ir-login", "ir-modal", "ir-select", "ir-sidebar", "ir-tasks-filters", "ir-tasks-header", "ir-tasks-table", "ir-title", "ir-toast"];
