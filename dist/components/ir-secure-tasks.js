...
import { d as defineCustomElement$2B } from './igl-application-info2.js';
import { d as defineCustomElement$2A } from './igl-block-dates-view2.js';
import { d as defineCustomElement$2z } from './igl-book-property2.js';
import { d as defineCustomElement$2y } from './igl-book-property-container2.js';
import { d as defineCustomElement$2x } from './igl-book-property-footer2.js';
import { d as defineCustomElement$2w } from './igl-book-property-header2.js';
import { d as defineCustomElement$2v } from './igl-booking-event2.js';
import { d as defineCustomElement$2u } from './igl-booking-event-hover2.js';
import { d as defineCustomElement$2t } from './igl-booking-form2.js';
import { d as defineCustomElement$2s } from './igl-booking-overview-page2.js';
import { d as defineCustomElement$2r } from './igl-bulk-block2.js';
import { d as defineCustomElement$2q } from './igl-bulk-operations2.js';
import { d as defineCustomElement$2p } from './igl-bulk-stop-sale2.js';
import { d as defineCustomElement$2o } from './igl-cal-body2.js';
import { d as defineCustomElement$2n } from './igl-cal-footer2.js';
import { d as defineCustomElement$2m } from './igl-cal-header2.js';
import { d as defineCustomElement$2l } from './igl-date-range2.js';
import { d as defineCustomElement$2k } from './igl-legends2.js';
import { d as defineCustomElement$2j } from './igl-property-booked-by2.js';
import { d as defineCustomElement$2i } from './igl-rate-plan2.js';
import { d as defineCustomElement$2h } from './igl-reallocation-dialog2.js';
import { d as defineCustomElement$2g } from './igl-room-type2.js';
import { d as defineCustomElement$2f } from './igl-split-booking2.js';
import { d as defineCustomElement$2e } from './igl-tba-booking-view2.js';
import { d as defineCustomElement$2d } from './igl-tba-category-view2.js';
import { d as defineCustomElement$2c } from './igl-to-be-assigned2.js';
import { d as defineCustomElement$2b } from './igloo-calendar2.js';
import { d as defineCustomElement$2a } from './ir-accordion2.js';
import { d as defineCustomElement$29 } from './ir-actions-cell2.js';
import { d as defineCustomElement$28 } from './ir-applicable-policies2.js';
import { d as defineCustomElement$27 } from './ir-autocomplete2.js';
import { d as defineCustomElement$26 } from './ir-balance-cell2.js';
import { d as defineCustomElement$25 } from './ir-billing2.js';
import { d as defineCustomElement$24 } from './ir-billing-drawer2.js';
import { d as defineCustomElement$23 } from './ir-booked-by-cell2.js';
import { d as defineCustomElement$22 } from './ir-booked-on-cell2.js';
import { d as defineCustomElement$21 } from './ir-booking-billing-recipient2.js';
import { d as defineCustomElement$20 } from './ir-booking-company-form2.js';
import { d as defineCustomElement$1$ } from './ir-booking-details2.js';
import { d as defineCustomElement$1_ } from './ir-booking-email-logs2.js';
import { d as defineCustomElement$1Z } from './ir-booking-extra-note2.js';
import { d as defineCustomElement$1Y } from './ir-booking-guarantee2.js';
import { d as defineCustomElement$1X } from './ir-booking-header2.js';
import { d as defineCustomElement$1W } from './ir-booking-listing2.js';
import { d as defineCustomElement$1V } from './ir-booking-listing-mobile-card2.js';
import { d as defineCustomElement$1U } from './ir-booking-listing-table2.js';
import { d as defineCustomElement$1T } from './ir-booking-number-cell2.js';
import { d as defineCustomElement$1S } from './ir-booking-status-tag2.js';
import { d as defineCustomElement$1R } from './ir-button2.js';
import { d as defineCustomElement$1Q } from './ir-checkbox2.js';
import { d as defineCustomElement$1P } from './ir-checkout-dialog2.js';
import { d as defineCustomElement$1O } from './ir-combobox2.js';
import { d as defineCustomElement$1N } from './ir-country-picker2.js';
import { d as defineCustomElement$1M } from './ir-custom-button2.js';
import { d as defineCustomElement$1L } from './ir-custom-date-picker2.js';
import { d as defineCustomElement$1K } from './ir-custom-input2.js';
import { d as defineCustomElement$1J } from './ir-daily-revenue2.js';
import { d as defineCustomElement$1I } from './ir-daily-revenue-filters2.js';
import { d as defineCustomElement$1H } from './ir-date-picker2.js';
import { d as defineCustomElement$1G } from './ir-date-range2.js';
import { d as defineCustomElement$1F } from './ir-date-view2.js';
import { d as defineCustomElement$1E } from './ir-dates-cell2.js';
import { d as defineCustomElement$1D } from './ir-delete-modal2.js';
import { d as defineCustomElement$1C } from './ir-dialog2.js';
import { d as defineCustomElement$1B } from './ir-drawer2.js';
import { d as defineCustomElement$1A } from './ir-dropdown2.js';
...
import { d as defineCustomElement$1q } from './ir-hk-archive2.js';
...
import { d as defineCustomElement$1m } from './ir-hk-user2.js';
import { d as defineCustomElement$1l } from './ir-housekeeping2.js';
import { d as defineCustomElement$1k } from './ir-icon2.js';
import { d as defineCustomElement$1j } from './ir-icons2.js';
import { d as defineCustomElement$1i } from './ir-input-text2.js';
import { d as defineCustomElement$1h } from './ir-interactive-title2.js';
import { d as defineCustomElement$1g } from './ir-interceptor2.js';
import { d as defineCustomElement$1f } from './ir-invoice2.js';
import { d as defineCustomElement$1e } from './ir-invoice-form2.js';
import { d as defineCustomElement$1d } from './ir-label2.js';
import { d as defineCustomElement$1c } from './ir-listing-header2.js';
import { d as defineCustomElement$1b } from './ir-loading-screen2.js';
import { d as defineCustomElement$1a } from './ir-login2.js';
import { d as defineCustomElement$19 } from './ir-m-combobox2.js';
import { d as defineCustomElement$18 } from './ir-mobile-input2.js';
import { d as defineCustomElement$17 } from './ir-modal2.js';
import { d as defineCustomElement$16 } from './ir-monthly-bookings-report2.js';
import { d as defineCustomElement$15 } from './ir-monthly-bookings-report-filter2.js';
import { d as defineCustomElement$14 } from './ir-monthly-bookings-report-table2.js';
import { d as defineCustomElement$13 } from './ir-new-badge2.js';
import { d as defineCustomElement$12 } from './ir-otp2.js';
import { d as defineCustomElement$11 } from './ir-otp-modal2.js';
import { d as defineCustomElement$10 } from './ir-pagination2.js';
import { d as defineCustomElement$$ } from './ir-password-validator2.js';
import { d as defineCustomElement$_ } from './ir-payment-details2.js';
import { d as defineCustomElement$Z } from './ir-payment-folio2.js';
import { d as defineCustomElement$Y } from './ir-payment-folio-form2.js';
import { d as defineCustomElement$X } from './ir-payment-item2.js';
import { d as defineCustomElement$W } from './ir-payment-summary2.js';
import { d as defineCustomElement$V } from './ir-payments-folio2.js';
import { d as defineCustomElement$U } from './ir-phone-input2.js';
...
import { d as defineCustomElement$M } from './ir-price-input2.js';
...
function defineCustomElement$1() {
    ...
    const components = ["ir-secure-tasks", "igl-application-info", "igl-block-dates-view", "igl-book-property", "igl-book-property-container", "igl-book-property-footer", "igl-book-property-header", "igl-booking-event", "igl-booking-event-hover", "igl-booking-form", "igl-booking-overview-page", "igl-bulk-block", "igl-bulk-operations", "igl-bulk-stop-sale", "igl-cal-body", "igl-cal-footer", "igl-cal-header", "igl-date-range", "igl-legends", "igl-property-booked-by", "igl-rate-plan", "igl-reallocation-dialog", "igl-room-type", "igl-split-booking", "igl-tba-booking-view", "igl-tba-category-view", "igl-to-be-assigned", "igloo-calendar", "ir-accordion", "ir-actions-cell", "ir-applicable-policies", "ir-autocomplete", "ir-balance-cell", "ir-billing", "ir-billing-drawer", "ir-booked-by-cell", "ir-booked-on-cell", "ir-booking-billing-recipient", "ir-booking-company-form", "ir-booking-details", "ir-booking-email-logs", "ir-booking-extra-note", "ir-booking-guarantee", "ir-booking-header", "ir-booking-listing", "ir-booking-listing-mobile-card", "ir-booking-listing-table", "ir-booking-number-cell", "ir-booking-status-tag", "ir-button", "ir-checkbox", "ir-checkout-dialog", "ir-combobox", "ir-country-picker", "ir-custom-button", "ir-custom-date-picker", "ir-custom-input", "ir-daily-revenue", "ir-daily-revenue-filters", "ir-date-picker", "ir-date-range", "ir-date-view", "ir-dates-cell", "ir-delete-modal", "ir-dialog", "ir-drawer", "ir-dropdown", "ir-dropdown-item", "ir-events-log", "ir-extra-service", "ir-extra-service-config", "ir-extra-service-config-form", "ir-extra-services", "ir-filters-panel", "ir-guest-info-drawer", "ir-guest-info-form", "ir-hk-archive", "ir-hk-tasks", "ir-hk-team", "ir-hk-unassigned-units", "ir-hk-user", "ir-housekeeping", "ir-icon", "ir-icons", "ir-input-text", "ir-interactive-title", "ir-interceptor", "ir-invoice", "ir-invoice-form", "ir-label", "ir-listing-header", "ir-loading-screen", "ir-login", "ir-m-combobox", "ir-mobile-input", "ir-modal", "ir-monthly-bookings-report", "ir-monthly-bookings-report-filter", "ir-monthly-bookings-report-table", "ir-new-badge", "ir-otp", "ir-otp-modal", "ir-pagination", "ir-password-validator", "ir-payment-details", "ir-payment-folio", "ir-payment-folio-form", "ir-payment-item", "ir-payment-summary", "ir-payments-folio", "ir-phone-input", "ir-picker", "ir-picker-item", "ir-pickup", "ir-pickup-form", "ir-pickup-view", "ir-pms-logs", "ir-popover", "ir-price-input", "ir-progress-indicator", "ir-radio", "ir-range-picker", "ir-reservation-information", "ir-reset-password", "ir-revenue-row", "ir-revenue-row-details", "ir-revenue-summary", "ir-revenue-table", "ir-room", "ir-room-guests", "ir-room-guests-form", "ir-room-nights", "ir-sales-by-channel", "ir-sales-by-channel-filters", "ir-sales-by-channel-table", "ir-sales-by-country", "ir-sales-by-country-summary", "ir-sales-filters", "ir-sales-table", "ir-select", "ir-sidebar", "ir-spinner", "ir-stats-card", "ir-status-activity-cell", "ir-success-loader", "ir-switch", "ir-tabs", "ir-tasks-card", "ir-tasks-filters", "ir-tasks-header", "ir-tasks-table", "ir-tasks-table-pagination", "ir-textarea", "ir-title", "ir-toast", "ir-tooltip", "ir-unit-cell", "ir-unit-tag", "ir-user-form-panel", "ir-user-management", "ir-user-management-table", "ir-validator", "ir-weekday-selector", "ota-label", "requirement-check"];
