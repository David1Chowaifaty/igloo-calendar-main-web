...
const IrClInvoicePreview$1 = /*@__PURE__*/ proxyCustomElement(class IrClInvoicePreview extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-cl-invoice-preview":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrClInvoicePreview$1);
            }
            break;
...
const IrClInvoicePreview = IrClInvoicePreview$1;
const defineCustomElement = defineCustomElement$1;

export { IrClInvoicePreview, defineCustomElement };
