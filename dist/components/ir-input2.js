...
const IrInput = /*@__PURE__*/ proxyCustomElement(class IrInput extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '93b1f8cc879ff8c7a8c8f31344c2e3bc66187d68' }, h("wa-input", { key: 'bd82b9c4a2500ea658f814e25a5df14253fb155f', type: this.type, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, onchange: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base" }, this.slotState.get('label') && h("slot", { key: '3096a18dd235f15fa039c02253cffac677dc302d', name: "label", slot: "label" }), this.slotState.get('start') && h("slot", { key: '99543df137ac28fcc04c67b1b2ff4c57f760f99a', name: "start", slot: "start" }), this.slotState.get('end') && h("slot", { key: 'ff2263920df445b0ebac4818143f84508308a5e7', name: "end", slot: "end" }), this.slotState.get('clear-icon') && h("slot", { key: 'ec37359c8c3c22bd88a96c49cd753e7064eb3041', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && h("slot", { key: '101d36aab83643bcb1ecdbe7cc05f8396431d86c', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && h("slot", { key: '6bb4d835b275758578e44a33337068bec61fbc23', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && h("slot", { key: '64ca2e6997b71967d619c74ec4a857a5ff555416', name: "hint", slot: "hint" }))));
    }
