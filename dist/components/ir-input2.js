...
const IrInput = /*@__PURE__*/ proxyCustomElement(class IrInput extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '172e8a58d8fc714d799bd01b1a46c91272dbc22e' }, h("wa-input", { key: '55d17ece2bdaba7df41766f4a6dd3d2bd43fff4f', part: "wa-input", type: this.type, name: this.name, value: displayValue, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, class: this.inputClass, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, oninput: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.slotState.get('label') && h("slot", { key: '52cccb134bc1f32c720ec25ca8aca4eca7691eeb', name: "label", slot: "label" }), this.slotState.get('start') && h("slot", { key: '573381fedfef5eac1efd3b75fe2b49e419b69092', name: "start", slot: "start" }), this.slotState.get('end') && h("slot", { key: 'f94e2972f40af078e4a2ae3ec7b12f850ca8dd0d', name: "end", slot: "end" }), this.slotState.get('clear-icon') && h("slot", { key: '0fb1d1a640ead0223db567941f66518923919170', name: "clear-icon", slot: "clear-icon" }), this.slotState.get('hide-password-icon') && h("slot", { key: '3970d082fad1c30eac87c3f8fc9a6e3ac2154ef3', name: "hide-password-icon", slot: "hide-password-icon" }), this.slotState.get('show-password-icon') && h("slot", { key: '93823da94a40cd8ea52ea3c6d2aa6be08f1ba0ba', name: "show-password-icon", slot: "show-password-icon" }), this.slotState.get('hint') && h("slot", { key: '1a7135182d5ef9dab6577db7f7dcbd91d387738a', name: "hint", slot: "hint" }))));
    }
