...
import { c as commonjsGlobal, a as commonjsRequire } from './_commonjsHelpers.js';
...
const IrCustomDateRange$1 = /*@__PURE__*/ proxyCustomElement(class IrCustomDateRange extends HTMLElement {
    ...
    static get style() { return IrCustomDateRangeStyle0; }
}, [1, "ir-custom-date-range", {
        "fromDate": [16],
        "toDate": [16],
        "minDate": [16],
        "maxDate": [16],
...
function defineCustomElement$1() {
    ...
    const components = ["ir-custom-date-range"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-custom-date-range":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrCustomDateRange$1);
            }
            break;
    } });
}
