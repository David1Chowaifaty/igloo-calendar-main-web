...
const IrPaymentsFolio = /*@__PURE__*/ proxyCustomElement(class IrPaymentsFolio extends HTMLElement {
    ...
    render() {
        return (h("wa-card", { key: 'b5f74a787669f99cc1da37d97a152bfb82f87ac0', class: " payments-container" }, h("div", { key: '0eb3a4a732e922f66eb5872b369fae122bd8016a', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '84a2b20f9ddc7198e957f66c7acb416ace77de89', class: "font-size-large p-0 m-0" }, "Folio"), h(HelpDocButton, { key: 'a9ef195871dbedd232389ffe383f208fccdee1b4', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), h("wa-tooltip", { key: 'c6e0104af153b6da6967018f6946cf5f2b23f6bf', for: "create-payment" }, "Add Payment"), h("ir-custom-button", { key: 'b0205e98fac903898e8130f149dcbcc99a53f315', slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, h("wa-icon", { key: '2ddf8da7ab8e736790e962592a4cb62a899d7d7e', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
