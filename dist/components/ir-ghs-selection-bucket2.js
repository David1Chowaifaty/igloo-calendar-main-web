...
const IrGhsSelectionBucket = /*@__PURE__*/ proxyCustomElement(class IrGhsSelectionBucket extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.generateRequest = createEvent(this, "generateRequest", 7);
        this.removeAll = createEvent(this, "removeAll", 7);
        this.removeProperty = createEvent(this, "removeProperty", 7);
    }
    selectedProperties = [];
    isGenerating = false;
    generateRequest;
...
function defineCustomElement() {
    ...
    const components = ["ir-ghs-selection-bucket", "ir-custom-button"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-ghs-selection-bucket":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrGhsSelectionBucket);
            }
            break;
...
export { IrGhsSelectionBucket as I, defineCustomElement as d };

//# sourceMappingURL=ir-ghs-selection-bucket2.js.map