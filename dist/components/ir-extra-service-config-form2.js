...
const IrExtraServiceConfigForm = /*@__PURE__*/ proxyCustomElement(class IrExtraServiceConfigForm extends HTMLElement {
    ...
    render() {
        return (h("form", { key: 'd188ce1bda1bb3c88d1d1022ed1fd8daba3c2fc5', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, h("ir-validator", { key: 'c4028e02b7886142bb05a95a0145ebd495a9e746', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, h("wa-textarea", { key: '45917b484d167b5023b6601ec6de6744acd5fce3', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales.entries.Lcz_Description })), h("ir-custom-date-picker", { key: 'fc2f0177410ed07c17ae8fb531ff8e01c3ff5078', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) }), h("ir-custom-date-picker", { key: '5048bf361e2bb5b7677a88d1003f6a380916d000', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), h("ir-validator", { key: 'c93819853a37ca5e49d2e48b727e7bdb776a4f97', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, h("ir-custom-input", { key: 'd5057bf3358ec244bacc6a5265f7b0d7277db273', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales.entries.Lcz_Price }, h("span", { key: '0d2d16a8aa21cf091486aa70e901a16544e491d1', slot: "start" }, this.booking.currency.symbol))), h("ir-validator", { key: '30bcf898aeb5e0e35905e11cda6a491935a8c26e', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, h("ir-custom-input", { key: '821b07bbab7574239b5783952a3b70f6f3776a7b', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales.entries.Lcz_Cost }, h("span", { key: '239956cada4946285f225bea0389b7b8c7a08f02', slot: "start" }, this.booking.currency.symbol)))));
    }
...
function defineCustomElement() {
    ...
    const components = ["ir-extra-service-config-form", "ir-custom-date-picker", "ir-custom-input", "ir-validator"];
