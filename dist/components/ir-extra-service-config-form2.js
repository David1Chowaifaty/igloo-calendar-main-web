...
const IrExtraServiceConfigForm = /*@__PURE__*/ proxyCustomElement(class IrExtraServiceConfigForm extends HTMLElement {
    ...
    render() {
        return (h("form", { key: '8dc633c250120edd5027eebbd86a3e4551dbb77a', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, h("ir-validator", { key: '07fa3978fb07fa9d20d3503181e24a30b1089674', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, h("wa-textarea", { key: '637dd0f0faf07c949fdbdf706dacf18982340744', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales.entries.Lcz_Description })), h("ir-custom-date-picker", { key: '39970fdfe8f2dad184be75a245dc7ddc41ac5cbd', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) }), h("ir-custom-date-picker", { key: 'c9b9e4f6557494b50c42d4b7746e2cf4fae6f778', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), h("ir-validator", { key: '8d33a8f4a67053b875667a8d6b253cfe944a2277', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, h("ir-custom-input", { key: '7323c979bc37e36dec5cbb37f427b2d8dca7250b', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales.entries.Lcz_Price }, h("span", { key: 'ba20b4ce6cca89bc4102084e8941efb8dba8dd26', slot: "start" }, this.booking.currency.symbol))), h("ir-validator", { key: '24fd84c76e8d43028d0d7ab3abd1f328848d3610', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, h("ir-custom-input", { key: 'aaa4341b0bd487b05dd469a9d685feff03db17e9', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales.entries.Lcz_Cost }, h("span", { key: '4aab1185cae6b92f554ad1bc74d07573e4f8a6dc', slot: "start" }, this.booking.currency.symbol)))));
    }
