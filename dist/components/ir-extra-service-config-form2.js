...
const IrExtraServiceConfigForm = /*@__PURE__*/ proxyCustomElement(class IrExtraServiceConfigForm extends HTMLElement {
    ...
    render() {
        return (h("form", { key: '42a2153e5896154c64cef2351f613c23b8409aeb', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, h("ir-validator", { key: 'edf1ad1441addc716acf762317d01f5463f2425b', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, h("wa-textarea", { key: '1ca465629dbe1be957ccd0092a827f34e9eb2dd8', size: "small", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales.entries.Lcz_Description })), h("ir-validator", { key: 'f1e136b0f91a90cae2c2dd1346ed28d9a2d1fd82', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.price }, h("ir-custom-date-picker", { key: '249bc6b02bf4e2d52d294656f450344d1e130019', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), h("ir-custom-date-picker", { key: '3ed8f9d91d6b68c3c1aef5c02ff06c0bc26730de', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), h("ir-validator", { key: 'b3f948c04088bd05239af0ea22ad947858156b35', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, h("ir-input", { key: '41a746bfb12a4c04142aa054b6ae8d1b82b4855c', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: locales.entries.Lcz_Price }, h("span", { key: '60a84939b72f23aea28ff6a4053123f06f668850', slot: "start" }, this.booking.currency.symbol))), h("ir-validator", { key: '5d671d88c00c5af05995d70e0423d2bea189e6fe', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, h("ir-input", { key: 'e43e8fe0a358c3060e1708e05683f77f1e190e1f', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: locales.entries.Lcz_Cost }, h("span", { key: '27187e9033851ad62b01e9ce5fdde133c512d98e', slot: "start" }, this.booking.currency.symbol)))));
    }
