...
const IrAutocompleteOption = /*@__PURE__*/ proxyCustomElement(class IrAutocompleteOption extends HTMLElement {
    ...
    selected = false;
    render() {
        return (h(Host, { key: 'af5df3e5bc86d6f049a8922ef9887daadf34e21d', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, h("wa-option", { key: 'cc7bcaadb948dbbeeca9896fbe7ffe4a03aa4a8d', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, h("slot", { key: '2ed772881195b80a1e51edad1c1a709980ad7ee9' }), h("slot", { key: '7935a1d77b8ca8cc5b0fa7f535e9c3e77d11b207', name: "start", slot: "start" }), h("slot", { key: 'b075bd823e85009e7407c2107f57d99a08e964e4', name: "end", slot: "end" }))));
    }
