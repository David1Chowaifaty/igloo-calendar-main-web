...
const IrAutocompleteOption = /*@__PURE__*/ proxyCustomElement(class IrAutocompleteOption extends HTMLElement {
    ...
    selected = false;
    render() {
        return (h(Host, { key: '2889efab7e2f7cec3da3e8e87df01d69e08c3abe', role: "option", "aria-selected": this.selected ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false' }, h("wa-option", { key: 'bf95b180e6df6fbb7a94f38a004184794948379a', value: this.value, label: this.label, disabled: this.disabled, current: this.current, selected: this.selected, exportparts: "checked-icon, label, start, end" }, h("slot", { key: '792f51190586a0ec30d83fecd147810b1fa9c5ce' }), h("slot", { key: 'b54e019abcc5726b0ed7a755c24946ac94209280', name: "start", slot: "start" }), h("slot", { key: 'b5535156d3325730c059925f4fb601d3c2de7b57', name: "end", slot: "end" }))));
    }
