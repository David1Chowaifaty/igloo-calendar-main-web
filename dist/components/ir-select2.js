...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'd12c72184a4d510d181d9eb78b51f4d486883b74', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'd984fbfb1aaa234749b209b1b2825b03ec951b68', class: "input-group row m-0" }, label, h("select", { key: 'c72d467be6f56eccd5af75df8b19f4fdf8801fd3', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '48b4f81ccefe2f93f25f4129d497da7d90bd5292', value: '' }, this.firstOption), this.data.map(item => {
