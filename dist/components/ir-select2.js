...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '895dc7cc6aa68eb7942ec3a2c0b647abf80c5182', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '500fa7102f6953d6290b734c8f63b19bceea3dc9', class: "input-group row m-0" }, label, h("select", { key: 'b7cfd59fc2de3ce9b66a8daa9617fd77b41eb164', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '750f93e23a72db3136d41d5d8ca48c9b0b06e1a4', value: '' }, this.firstOption), this.data.map(item => {
