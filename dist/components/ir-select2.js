...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '88af58cc547a893c2d4d343ab3e78d903fbea7c8', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '1694cab290f1fad118ceefd26ec62c0f85653a64', class: "input-group row m-0" }, label, h("select", { key: '4752c271057c595a51aa57e92538b980523e8727', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'a4540d739f6a94404b50f33bd5ccf19d65477187', value: '' }, this.firstOption), this.data.map(item => {
