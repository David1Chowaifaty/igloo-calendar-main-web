...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'eebc536b6cdd79058a646d1cea7042ae0541a6e7', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '6bdb7a4ef111eb719fc490b921bd3b55425cb03f', class: "input-group row m-0" }, label, h("select", { key: '5570021c3734b3e3cae02733af511ddb4a6b7ed5', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '4bf4288fe437d9997bd7e167a029e771e1ff3b30', value: '' }, this.firstOption), this.data.map(item => {
