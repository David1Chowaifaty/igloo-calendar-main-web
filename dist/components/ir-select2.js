...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '5f7a3d3d383fe46c641f6bd3a4895242d1765d1f', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '35bd88c0087527824a6dce4cc215465ffae53dad', class: "input-group row m-0" }, label, h("select", { key: '11a30d81888dd8aa16be6c7c929a0c25c64a57de', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '19060a9aae7acbee9e9bfd86310a7bb854d9bdc5', value: '' }, this.firstOption), this.data.map(item => {
