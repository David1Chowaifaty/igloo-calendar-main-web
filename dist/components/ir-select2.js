...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'fdf97471e940f327ff20a5981550930068b22e15', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'cb01b6093a7d7511c95120fcff720f080d3031be', class: "input-group row m-0" }, label, h("select", { key: 'feb5662c82c5847c5e13cd49f67d13beb77a52df', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '81e234bd1cf4e07d64811135d1aaca42731606e8', value: '' }, this.firstOption), this.data.map(item => {
