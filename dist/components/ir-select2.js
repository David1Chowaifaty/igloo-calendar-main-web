...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '38622a9327f34278b44373bdb3d57efa976c633a', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '2b845cab916d2a91931bf1e61ae9e2151402ec7f', class: "input-group row m-0" }, label, h("select", { key: 'ee50edf3bd1fb41cce0309ce692a0144c3e5ebc7', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'c5d1b3e66904485b9f256ca203b589466cf6efb4', value: '' }, this.firstOption), this.data.map(item => {
