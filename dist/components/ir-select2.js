...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '8a808805628284adf8dd6e090d6969d63eeb6ccb', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '839e1b8ab5f6a9c23c7d1e3f6b68faec9d348e92', class: "input-group row m-0" }, label, h("select", { key: '0e6d6da8b79aa0fb8bfd4032ccf56ed7eabc5631', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'a9f22f7864ede8503d5eef3f252c73e8677c187b', value: '' }, this.firstOption), this.data.map(item => {
