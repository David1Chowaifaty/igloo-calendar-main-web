...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '9c59266e7e592c354919ef100c37df5b8939ceac', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'eab9c7d04254a561fba465d37b64f5983c69d794', class: "input-group row m-0" }, label, h("select", { key: '67187fee11ed6b75b7cbfbd2b6ac0394eccba9d9', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '750c23474adc7a6c9ce5f8afb9145a87678a442c', value: '' }, this.firstOption), this.data.map(item => {
