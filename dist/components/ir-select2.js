...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'af5c544a8c3f7b80fc5b8be8b2c672624044e7b6', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '857eec2e4fea2f250426dde855c6423423b8f778', class: "input-group row m-0" }, label, h("select", { key: '85fb218c78138ec48cad26fabb0030ab125c16b5', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '8e9d019d8ce91920a99ac90a1fc9e0f1cbd41d97', value: '' }, this.firstOption), this.data.map(item => {
