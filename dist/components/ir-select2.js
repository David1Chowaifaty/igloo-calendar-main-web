...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '5846aa111271cfdcc9b9c17d310bd0f49447dca0', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '0ac0abf75ef2f9f66dad53b67f00e88aa1dfebca', class: "input-group row m-0" }, label, h("select", { key: '686d679c0b640b9fe7facfc140013a6c2f0d0ce6', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '9d606d70bfb708e6acfcd3592103c60022fc94c4', value: '' }, this.firstOption), this.data.map(item => {
