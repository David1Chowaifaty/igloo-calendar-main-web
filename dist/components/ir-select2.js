...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'de365042adcd35fd034935c445b34a6684502180', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '1683e2ccb0415b87880a925501921667d72d7e23', class: "input-group row m-0" }, label, h("select", { key: 'f3acb9edfaacf380113748e96680749d9b541740', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '4025dd577a3cb036678645dbd0daa2b77018f1bf', value: '' }, this.firstOption), this.data.map(item => {
