...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '9f973337688430a57b5e69ed501ca1ce44fc9b02', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '4b6c5d0f3b0487915424cb7099249798b00bd34a', class: "input-group row m-0" }, label, h("select", { key: '5d00d3e672f0aa5f03d45e50fa7448677f6e4da7', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'f57622dd74a187db6c8f5a80b3f1a93b44cdc784', value: '' }, this.firstOption), this.data.map(item => {
