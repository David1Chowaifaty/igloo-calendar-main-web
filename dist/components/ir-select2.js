...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'eb20eed82b64e396542736079cc7641d378c9a91', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '182a4a1e742c1edeb8d96f7f1fa26fb5122f76a5', class: "input-group row m-0" }, label, h("select", { key: '0efff883f8244a3ffed64f37be01d14161d22305', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '6f92067951bfc27cfade367131e6d15d81b38400', value: '' }, this.firstOption), this.data.map(item => {
