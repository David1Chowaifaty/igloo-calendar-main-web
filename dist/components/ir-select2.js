...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'afa400a687f808bcdd1cf2041a4ec2841b787ed1', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'd4690236e2967db60402f0c47cbdf56c9a25c01c', class: "input-group row m-0" }, label, h("select", { key: '5d1b342fc12595a5e7d3b24b0f1b0b2c7d697825', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.select_id, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className} form-control-${this.size} text-${this.textSize} col-${this.LabelAvailable ? 12 - this.labelWidth : 12}`, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'f5626566b1dcc7b8eddee0c32d02406f72440766', value: '' }, this.firstOption), this.data.map(item => {
