...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '4d18a1cdd82ed5a68ec53514f1818b4aa2fa9dd3', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '54451efd57cd67451efecb6d2726152634bea65f', class: "input-group row m-0" }, label, h("select", { key: '2ae928ab1944a553c58e0a0dff91552440fc42f6', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'dae35a668e7cee46f47d508bb4e0322500bf02e8', value: '' }, this.firstOption), this.data.map(item => {
