...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '9395187cde8f39ae88995c2a6d87866f7f339802', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'c9136360179d31450e2498799564f72c43dd5ee4', class: "input-group row m-0" }, label, h("select", { key: '348a589bc2c8f7985af6c7540ea96a20937328da', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'f07980827eb868e82f38a5ce31f0afa727d61905', value: '' }, this.firstOption), this.data.map(item => {
