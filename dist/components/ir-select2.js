...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'd5464fd1e752ba770e72c151b1e196e52f57db3a', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '60e464daaf05cbb5d25e854e286d9ffa92b912ad', class: "input-group row m-0" }, label, h("select", { key: '58a382bb39eb30a9e9d5a263b6c24147b3925b89', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '2aa5d1b73d95a879600a483e58ebedd1868aa7fd', value: '' }, this.firstOption), this.data.map(item => {
