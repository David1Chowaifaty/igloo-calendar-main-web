...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '2f0e6348f4904c2a92543efa11750eab6613bd17', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'ec9db272118642d256055e6fc73c245612b59680', class: "input-group row m-0" }, label, h("select", { key: 'aee5e496792c8287cc1957224081478656c32e71', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '389edc922c71685ac85522c66ec1ee0768cb3c5e', value: '' }, this.firstOption), this.data.map(item => {
