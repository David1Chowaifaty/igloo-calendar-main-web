...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'c79afd82e6575ff78d88fd85908a9da6a35708c6', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '6c250b20547674820d171903bf8e740e58b64a67', class: "input-group row m-0" }, label, h("select", { key: '989687194edc34cb4324803ae720ecd6d65ed566', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'a5464252f0e3ed4cb367be87bfd60017699bb856', value: '' }, this.firstOption), this.data.map(item => {
