...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '56bde2fff637e1dcfb9cdac67832e21b97adc537', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'd24b0dfed9b6aafafd80d54ce35732ea546feb30', class: "input-group row m-0" }, label, h("select", { key: '6ad7c423a0d2fda2486c5bc7882f3bf3671713d6', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'c66d72fd9a3f8e3c5a2f38463e9a65d4db4398a1', value: '' }, this.firstOption), this.data.map(item => {
