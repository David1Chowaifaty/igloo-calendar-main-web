...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '147578f80297f6394da0fe59e01600244ed996c2', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '72e3406fa855c85c2eb3012be27822896b9ea438', class: "input-group row m-0" }, label, h("select", { key: '8c7a61720b5080c72ec3d9af46b02fd73049f377', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '569e7ab18eb07991a6634512167b82d12137974e', value: '' }, this.firstOption), this.data.map(item => {
