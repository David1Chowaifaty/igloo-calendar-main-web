...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'f155234606cf23fc0cdc94423eda3e1fee276cde', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'cfe4b800474fbb98d3752811d786eb1004b07035', class: "input-group row m-0" }, label, h("select", { key: '98cdda20d80d76f914a98e5f89ae78d84644fb7f', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '4f3b65641387fa7b24d5aabf104b18aa14a4e568', value: '' }, this.firstOption), this.data.map(item => {
