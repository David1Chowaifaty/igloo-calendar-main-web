...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '994066ab5c7a4e022eb42c3d7d40c65692c8de63', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'a9fe9f1fd8ccc2be54e175152f7daa3df57b8a7c', class: "input-group row m-0" }, label, h("select", { key: '274e0093c5ec1ba4a66a67b6538ab27f19c79ed3', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '2222ed9d63ea53997b299457259537311e11dbb0', value: '' }, this.firstOption), this.data.map(item => {
