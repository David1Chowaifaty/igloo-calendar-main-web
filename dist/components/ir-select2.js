...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '3dfd95ba6d6072c937f53af3379637919ce0f439', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '4ed4ad9363b69bd17a238e899be3db717139a261', class: "input-group row m-0" }, label, h("select", { key: '85720d18a7e126bf6edc84a63632c79ef4ccf50d', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'fee814bb57d7f960f270cb8b890766f11ebff143', value: '' }, this.firstOption), this.data.map(item => {
