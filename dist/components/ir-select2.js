...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '1d2bcb96209a48bf781b764e816c4f9a52d1299f', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'bd13d2dbd0ad51ea07895bd9ce68a994ff73b083', class: "input-group row m-0" }, label, h("select", { key: '60f0e77a85090dfd80816b0d6d3fc6581545a428', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '2631541384043d287116ad2049e98c92f886a65e', value: '' }, this.firstOption), this.data.map(item => {
