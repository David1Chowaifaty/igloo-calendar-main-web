...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '84f89056467cbfd653e977f29b5d2a62d6dc8310', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'ccc0b3ee06ce680042f88967d4d1393df0519fb0', class: "input-group row m-0" }, label, h("select", { key: '41dda43c10dd1ed4c7751f2f170ff6aa98c169ec', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'b9eafbbc13b96efe8906add4da98bcbc72f1d2e3', value: '' }, this.firstOption), this.data.map(item => {
