...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '8a600424f3da50da54ce0d06fbfbe4440293bc0e', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'c4d2b56fb059703c1e19f7e41bc675d79c2796e2', class: "input-group row m-0" }, label, h("select", { key: 'dd9b6c505f8b4090119a67af51f05bce9a1efd9c', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '3217e401a6b09ed4c55508ce44d965eafcb6b886', value: '' }, this.firstOption), this.data.map(item => {
