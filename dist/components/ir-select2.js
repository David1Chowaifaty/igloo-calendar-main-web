...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '38fc7c8efe06a6cf6932ab45a0778eaeb5bdb87b', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '4bbbba719527eb35c620344af4cd5391c51202f9', class: "input-group row m-0" }, label, h("select", { key: '059553b5c5e9d1453965e62a8c9a60b88ba45bd6', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'ca2311787526101cc55fac684d001e61b1a77d1f', value: '' }, this.firstOption), this.data.map(item => {
