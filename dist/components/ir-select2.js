...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'c82cc94546f37e4b4fccca62f881764598ef968a', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'a7d251f5184360ed7dc3c14ad4d93d896deb68ca', class: "input-group row m-0" }, label, h("select", { key: 'a48d40cfb70169abbc739d3830705d49a15ceaca', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '0512b9b231924d328b21ec1350fa8752e24716ab', value: '' }, this.firstOption), this.data.map(item => {
