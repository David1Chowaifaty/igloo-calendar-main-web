...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '07e281272c01cd2ce417cdbb99d12a96b226fe6f', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'a4c5f3d6d798907bab9bd159bf0f1dd181a7e319', class: "input-group row m-0" }, label, h("select", { key: '9459bde364eb117e4abbec09d1ce2993ff52dddd', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '6524bec0f028d775ff2e7df13498be9b195713a6', value: '' }, this.firstOption), this.data.map(item => {
