...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '4b7995d7fbd16946d48974bde9b2889ef8513da2', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '4d6745b914cedfa41834cc40a885f55b598de662', class: "input-group row m-0" }, label, h("select", { key: 'cc7e12fb8c07c92a99bebf2a894a9c3e5297ab03', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '17287d1c0f78a1683305366ee6c1152b4cd6a220', value: '' }, this.firstOption), this.data.map(item => {
