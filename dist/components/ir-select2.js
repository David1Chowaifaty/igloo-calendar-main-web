...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '12db4ae9177e8aece5562b73051c3b5a1cadb601', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'e67f6e058270a0ef9b7b78b30eaab127623217fb', class: "input-group row m-0" }, label, h("select", { key: 'cfe92906b72f261feb5a6c42fc5dc2c8e186677b', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'f73dff88a1801c21a82682327f97f54e1ffb063d', value: '' }, this.firstOption), this.data.map(item => {
