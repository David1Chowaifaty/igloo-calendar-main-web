...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'ee42bf341d729fbb879b86d3e04fbf821ca44ad6', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'bf4cfcba87c51698441aafbe764292567ca57861', class: "input-group row m-0" }, label, h("select", { key: 'de4acfb3938e13a6cd0548c0d1353ae717a07258', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'e349b6707e1721ac01cb8c0760a6a4d297bc4171', value: '' }, this.firstOption), this.data.map(item => {
