...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'b58f4fdd0b8032e249fa60cf156e9ce174cd4dab', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '17ecb7302b826bb9274c873b0ea643c942d6cfc4', class: "input-group row m-0" }, label, h("select", { key: 'cbec97b0a0d6fd32fdd251cb75d34d9e4b4fe7c5', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '0bd19484996dbc3d47a31b0aea84626733e547df', value: '' }, this.firstOption), this.data.map(item => {
