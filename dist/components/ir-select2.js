...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '1920fa52d76402e8f90ce2ee31cca7d9f56feaab', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '51c39f9a0e7c4f340a2718c181a55f1f57db2932', class: "input-group row m-0" }, label, h("select", { key: '62d2d425774c13e3eb01ab424a97370ebd3046a2', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '51f00ce23f262626f535c3f9cea976ef8245f509', value: '' }, this.firstOption), this.data.map(item => {
