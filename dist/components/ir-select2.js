...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '75480d0f855b5e7bc07d69b607c79814d5e875ab', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '64e7421b0fa79664037418bcf2dec1a9bbb2c734', class: "input-group row m-0" }, label, h("select", { key: 'c98a153983c16978d671a7d2ae7e153c9d78eb25', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '3fa06dd3079ab701a131ddcf144d7a093538981b', value: '' }, this.firstOption), this.data.map(item => {
