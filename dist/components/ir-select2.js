...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '1ab76d3a1fcddb909d119215acefbe2e5cfd6e48', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '02a552305ddc023f964aed6818fe53c0cf4c4f2d', class: "input-group row m-0" }, label, h("select", { key: '9474079d5703865c0a9db2616f19533811b821f4', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '25072d5b1a258bcee6bc560230d752d88fa82957', value: '' }, this.firstOption), this.data.map(item => {
