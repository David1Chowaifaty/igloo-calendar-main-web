...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: 'e7863b49d28fc45ff40f5820e262656995c10c3f', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'b999b9932ef4fba35b3851769c2d8d3ce4d478ee', class: "input-group row m-0" }, label, h("select", { key: 'eccf23327975f59f04a3c932f1ba6ec73a86a825', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '2298df1ceabc8427b6c83589457e07e01e074249', value: '' }, this.firstOption), this.data.map(item => {
