...
const IrSelect = /*@__PURE__*/ proxyCustomElement(class IrSelect extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '3cbd1b824f3e31670c568818f5b8786ea792db33', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '5e085c8e660ae10970b48849d810e83b2c6e97b7', class: "input-group row m-0" }, label, h("select", { key: 'a27440a780f67f400469ecce914b3d7a81f40ef4', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '5d29b1398641b101df45d477f4841a20cfe34ada', value: '' }, this.firstOption), this.data.map(item => {
