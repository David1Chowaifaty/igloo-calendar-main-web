...
const IrUserFormPanel = /*@__PURE__*/ proxyCustomElement(class IrUserFormPanel extends HTMLElement {
    ...
    render() {
        ...
        return (h("form", { key: '300a64be788aa16153d531c90e62c9bfa03fb7a2', class: "sheet-container", onSubmit: async (e) => {
            ...
            (((_j = this.user) === null || _j === void 0 ? void 0 : _j.type.toString()) === '17' && ((_k = this.userTypeCode) === null || _k === void 0 ? void 0 : _k.toString()) === '17' ? null : (h("div", { class: "d-flex mt-2 align-items-center justify-content-between" }, h("h4", { class: "m-0 p-0 logins-history-title" }, "Password"), h("ir-button", { size: "sm", btn_styles: 'pr-0', onClickHandler: () => (this.isOpen = true), text: "Change password", btn_color: "link" }))))), ((_l = this.user.sign_ins) === null || _l === void 0 ? void 0 : _l.length) > 0 && (h("section", { key: '54a2f065cda1429dcc628470824e13e511c7a31c', class: "logins-history-section mt-2" }, h("div", { key: '95190417475627c1573a50ebefd9a9b0b191e044', class: "d-flex align-items-center logins-history-title-container justify-content-between" }, h("h4", { key: '242d9ad428366467ab38dcc7dc026a3dd0414e22', class: "logins-history-title m-0 p-0" }, "Recent sign-ins"), this.user.sign_ins.length > 5 && (h("ir-button", { key: '7fb6685a7570455134fb1ad038b54398479a725d', btn_styles: 'pr-0', text: !this.showFullHistory ? 'View all' : 'View less', btn_color: "link", size: "sm", onClickHandler: () => (this.showFullHistory = !this.showFullHistory) }))), h("ul", { key: 'ec7b55329d4994852fbb0182140fcbdc106492f5', class: "logins-history-list" }, this.user.sign_ins.slice(0, this.showFullHistory ? this.user.sign_ins.length : 5).map((s, i) => {
            var _a, _b;
            const ua = uaParser_pack.exports.UAParser(s.user_agent);
            return (h("li", { class: "login-entry", key: s.date + '_' + i }, h("div", { class: "login-meta" }, h("p", { class: "login-datetime" }, hooks(s.date, 'YYYY-MM-DD').format('DD-MMM-YYYY'), " ", _formatTime((_a = s.hour) === null || _a === void 0 ? void 0 : _a.toString(), (_b = s.minute) === null || _b === void 0 ? void 0 : _b.toString())), h("p", { class: "login-location" }, h("span", { class: "login-ip" }, "IP: ", s.ip), " \u00A0|\u00A0", h("span", { class: "login-country" }, "Location: ", s.country), " \u00A0|\u00A0", h("span", { class: "login-os" }, "OS: ", ua.os.name, " ", ua.os.version))), ua.device.type && (h("div", { class: "login-user-agent" }, h("p", { class: "ua-device" }, ua.device.vendor || '', " ", ua.device.model, " (", ua.device.type, ")")))));
        })))), h("ir-sidebar", { key: '3c01f57152c544cafd55d25cce5d83d121c33501', open: this.isOpen, showCloseButton: false, style: {
                '--sidebar-block-padding': '0',
            }, onIrSidebarToggle: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            } }, this.isOpen && (h("ir-reset-password", { key: '7e183dc5c615cc7ce78009f672f4b9474c5fa411', skip2Fa: true, username: this.user.username, onCloseSideBar: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, slot: "sidebar-body" })))), h("div", { key: '05d96bd06b377f467905fb913e47c5eef4797e23', class: "sheet-footer" }, h("ir-button", { key: 'c60cc870524dff0b72b02a4431895d02a2715fca', "data-testid": "cancel", onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100 justify-content-center align-items-center", btn_color: "secondary", text: locales.entries.Lcz_Cancel }), h("ir-button", { key: 'cf5c86edc8f5ea46df50c7af19540818af457add', "data-testid": "save", isLoading: this.isLoading, class: "flex-fill", btn_type: "submit", btn_styles: "w-100 justify-content-center align-items-center", text: locales.entries.Lcz_Save }))));
    }
