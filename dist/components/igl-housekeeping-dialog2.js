...
const IglHousekeepingDialog = /*@__PURE__*/ proxyCustomElement(class IglHousekeepingDialog extends HTMLElement {
    ...
    render() {
        return (h("ir-dialog", { key: '54b76b72ff670c594a51b7babc3cbb2947eab662', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, h("p", { key: 'a5bb72689b34f1873aad869ec65e8b58f33c20d6', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), h("div", { key: 'dbf51c3d0384c21bc72f9240a9932392a4e68c9b', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '9568409760ab553bad72f329bf29d4baa187e77e', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: '0827ce170ef4d4ad837cd36b891a975d8002bb65', value: "hk-toggle-clean-dirty", size: "medium", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), h("ir-custom-button", { key: 'b61bf629ad69d1229d124d302317bcdb1db46103', value: "hk-clean-inspect", size: "medium", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
