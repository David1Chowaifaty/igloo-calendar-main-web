...
import { m as moment } from './moment-with-locales.js';
...
function defineCustomElement$1() {
    ...
    const components = ["ir-hk-staff-tasks", "ir-custom-button", "ir-dialog", "ir-hk-staff-task", "ir-hk-staff-tasks-header", "ir-loading-screen"];
