...
var lang = {
  ...
  isBuffer, isDate, isElement, isEmpty, isEqual: isEqual$1,
...
var util = {
  ...
  matches, matchesProperty, method, methodOf, noop, nthArg, over, overEvery, overSome,
...
const IrTextEditor = /*@__PURE__*/ proxyCustomElement(class IrTextEditor extends HTMLElement$1 {
    ...
    static get style() { return irTextEditorCss + quillSnowCss; }
}, [0, "ir-text-editor", {
        "error": [4],
