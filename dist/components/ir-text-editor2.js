...
import { c as commonjsGlobal, b as getDefaultExportFromCjs } from './_commonjsHelpers.js';
...
const IrTextEditor = /*@__PURE__*/ proxyCustomElement(class IrTextEditor extends HTMLElement$1 {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        return (h("div", { key: '1cde476ca88b4b99cd0c05ba1ae0eb00de0f2240', class: { 'editor-wrapper': true, 'error': this.error } }, h("div", { key: '7e0ee8aaea596b1ae8a5f26e17282b7fc60b880a', ref: el => (this.editorContainer = el), class: "editor-container" })));
    }
    ...
    static get style() { return IrTextEditorStyle0 + IrTextEditorStyle1; }
}, [0, "ir-text-editor", {
        "error": [4],
        "maxLength": [2, "max-length"],
        "value": [1],
        "readOnly": [4, "read-only"],
        "userCanEdit": [4, "user-can-edit"],
        "placeholder": [1],
        "toolbarConfig": [16],
        "editorValue": [32]
    }, undefined, {
...
function defineCustomElement() {
    ...
    const components = ["ir-text-editor"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-text-editor":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrTextEditor);
            }
            break;
    } });
}

export { IrTextEditor as I, defineCustomElement as d };

//# sourceMappingURL=ir-text-editor2.js.map