...
const IrToastsProvider$1 = /*@__PURE__*/ proxyCustomElement(class IrToastsProvider extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-toasts-provider":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrToastsProvider$1);
            }
            break;
        case "ir-toast-item":
            if (!customElements.get(tagName)) {
...
const IrToastsProvider = IrToastsProvider$1;
const defineCustomElement = defineCustomElement$1;

export { IrToastsProvider, defineCustomElement };
