...
function defineCustomElement() {
    ...
    const components = ["igl-booking-event", "igl-block-dates-view", "igl-booking-event-hover", "ir-button", "ir-date-view", "ir-icons", "ir-label", "ota-label"];
