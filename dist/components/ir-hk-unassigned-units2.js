...
const IrHkUnassignedUnits = /*@__PURE__*/ proxyCustomElement(class IrHkUnassignedUnits extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '28250b419e8e3449cab9cbb97651541baaca0fda' }, h("ir-title", { key: '0c84c9bb1d9e9fbeffecceb35e4758e3e8e22540', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '0a70852ab99a41c636bc7d0733d9e9006ddd82fc', class: "px-1" }, h("table", { key: 'f184f202548872d5e24c25a3668d06b00d8567fc' }, h("thead", { key: '17856269b125f1368b3f283d370d86e698e30112' }, h("th", { key: 'fe6f73ed1367dcc76f694598d303cb98db5a9906', class: "sr-only" }, "room name"), h("th", { key: '509a94b39cbf8b3ddfc641a56c58103d23e2dc5e', class: "sr-only" }, "housekeeper name"), h("th", { key: 'ef7225dcb94e6db939b3a43525c0267ea4e3120e', class: "sr-only" }, "actions")), h("tbody", { key: '30f623d4c8a1e6b1043a410aea86ae051b223ca3' }, this.renderRooms())), h("div", { key: 'b551f5c91f5bfa50745eabe5a2e60736c6f12712', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: '4c3c1ea36364b3508da95f20e9fe0577a8e6e609', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: '6dfbda2b6bfbc8e82f0e5b995ded885fdc6c7952', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
