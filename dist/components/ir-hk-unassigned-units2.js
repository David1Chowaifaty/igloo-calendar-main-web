...
const IrHkUnassignedUnits = /*@__PURE__*/ proxyCustomElement(class IrHkUnassignedUnits extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '2db5a1b04113f6725ebe308287340f4629b67039' }, h("ir-title", { key: 'b6e6e1088c07f6a6b7a37a543c617d839b67e5e8', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '90ce92a336fb387a8c0825489df9ce0d81a3dd2d', class: "px-1" }, h("table", { key: '779d4638878c31c9d94b9ef84b540f9642f5409b' }, h("thead", { key: '79b57cd98e4e6b568d41415b1805c256aed002d6' }, h("th", { key: 'a696e8af0002eb4052beb85e4dad0a195126d68d', class: "sr-only" }, "room name"), h("th", { key: 'ec5b8ae007ef69199aae773b1b5c6abf06add2f0', class: "sr-only" }, "housekeeper name"), h("th", { key: 'e71b6dee8afb94d2d2dd774df56f843356e5c389', class: "sr-only" }, "actions")), h("tbody", { key: 'a03b0087362b851b09325255f85cdafd77c001cc' }, this.renderRooms())), h("div", { key: '9971d0189cdcd1d8cceab6ee3316d45049494bc2', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: '73e3c77d1e13c17d0f606100feb58d4dc7a92a00', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: '43e6165d275edcb841949c47799a650d3ef255cf', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
