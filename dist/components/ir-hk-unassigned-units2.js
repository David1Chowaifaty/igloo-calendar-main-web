...
const IrHkUnassignedUnits = /*@__PURE__*/ proxyCustomElement(class IrHkUnassignedUnits extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '1914579981f7bd0480bc55844a080102de232006' }, h("ir-title", { key: 'b85b99286a913ac8c730f4a96644e7ef1d2666dc', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '65e2031bf13e2c9eda0a05c355755db54c8f683b', class: "px-1" }, h("table", { key: 'd0b35526b26ab7c8b40a86a6be3ba05d1059a9e8' }, h("thead", { key: '0a51c63d4d429e8609334ec4b5de5863f8d5242e' }, h("th", { key: '30bb325529f074cdae8dda001446f6a46a920c4b', class: "sr-only" }, "room name"), h("th", { key: '48c93af889ae162559b1eda5fb9146fe54ced884', class: "sr-only" }, "housekeeper name"), h("th", { key: 'e185026fa93f7196742ef5b0e64aa087a5074ece', class: "sr-only" }, "actions")), h("tbody", { key: 'ef509c0f197ba44e1240769ea6a01b03940430cd' }, this.renderRooms())), h("div", { key: 'b698bd0cb06745e5e72ac5db6beee1db009d2b05', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: '85b360eafb394458ef33eb0ff424e593c35d690f', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: '92fe0ad11981dd2746689b11bb329d4c2a315452', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
