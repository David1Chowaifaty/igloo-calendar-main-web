...
const IrHkUnassignedUnits = /*@__PURE__*/ proxyCustomElement(class IrHkUnassignedUnits extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'f742a2220c5633d244f52664b04d2eed90d574dd' }, h("ir-title", { key: '94933efb09f335ab8354a0987e59e346b477b63d', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), h("section", { key: '4e86ba6937d347c31f23c8be67fd34873c1f24a3', class: "px-1" }, h("table", { key: 'bd2736ff2a701b6c2d4ed237d0325dfd77f4ece2' }, h("thead", { key: 'f49637ebab532a8e79c074800f3884a143cc3fb2' }, h("th", { key: 'a06355ad30c920432540b11df346f9d2df00903c', class: "sr-only" }, "room name"), h("th", { key: '56d54729cb40fe3ce466c5be965b325027ab8fcd', class: "sr-only" }, "housekeeper name"), h("th", { key: 'bcfe65d5c3c348b2509a600ca34e29b7a1642e32', class: "sr-only" }, "actions")), h("tbody", { key: '2b048d6562e76c527f8752e95cffb226401e6f7b' }, this.renderRooms())), h("div", { key: '26c9fcf388bddcda573079d6e0976825b28632c7', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, h("ir-button", { key: 'df10545c5d13d2403a4c1aecca4bc6f5dee01756', onClickHandler: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), h("ir-button", { key: 'ad1efcf3112777c90ca30dc91b00f9ca78fb75c5', isLoading: isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHandler: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
