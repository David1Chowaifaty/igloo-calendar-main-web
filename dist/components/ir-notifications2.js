...
const IrNotifications = /*@__PURE__*/ proxyCustomElement(class IrNotifications extends HTMLElement {
    ...
    // }
    render() {
        return (h(Host, { key: '4577341f67935d67877a92b1c95a00f7d9112526' }, h("div", { key: 'ea5b9a5b05b03f92c8032a3343abbdeb63df29ba', style: { position: 'relative' } }, h("wa-tooltip", { key: '65ff85c36a40993c43e3e9f46ceb96bd72823c8e', for: "notifications-button" }, "Notifications"), this.notifications?.length > 0 && (h("wa-badge", { key: '62ff4215a220bcd1b9d1e1f660015dd0619fb5c1', pill: true, class: "header-notification-badge" }, this.notifications.length)), h("wa-animation", { key: '15a6345509c69f64434fc55891786fd6855b11f1', duration: 1200, iterations: 1, keyframes: this.bellKeyframes, ref: el => (this.animationRef = el) }, h("ir-custom-button", { key: '1de4d69fb1a2696f3dcab866973ef877bca2bf31', id: "notifications-button", size: "small", appearance: "plain", ref: el => (this.buttonRef = el) }, h("wa-icon", { key: 'a10593900222d1988997d6a14046b2a6842f8b85', class: "notification__bell-icon", name: "bell", style: { fontSize: '1.4rem' } })))), h("wa-popover", { key: '3f288d86067b881aae2e96a5f9cb1223924b546a', distance: 15, class: "notification__popover", for: "notifications-button" }, h("p", { key: '2278a64b0ea77202ac02693129e1e39ed09271ff', class: "notification__popover-title" }, "Notifications"), this.notifications.map(notification => {
        ...
        }), this.notifications?.length === 0 && (h("ir-empty-state", { key: 'c2e455f0a5bf2ac8664c2357d4bcd0879b468e2e', message: "All caught up!", style: { width: '250px', height: '150px' } }, h("wa-icon", { key: '6df6414c80e396b1f615041dec1652510bfb542a', slot: "icon", name: "inbox" }))))));
    }
