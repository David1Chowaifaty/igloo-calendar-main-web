...
function defineCustomElement() {
    ...
    const components = ["ir-city-ledger-fiscal-documents-table", "ir-cl-status-tag", "ir-custom-button", "ir-dialog", "ir-fd-confirm-dialog", "ir-input", "ir-spinner"];
