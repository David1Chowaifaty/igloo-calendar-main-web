...
import { d as defineCustomElement$S } from './ir-booking-company-form2.js';
...
import { d as defineCustomElement$O } from './ir-booking-status-tag2.js';
...
import { d as defineCustomElement$I } from './ir-custom-input2.js';
...
import { d as defineCustomElement$C } from './ir-events-log2.js';
import { d as defineCustomElement$B } from './ir-extra-service2.js';
import { d as defineCustomElement$A } from './ir-extra-service-config2.js';
import { d as defineCustomElement$z } from './ir-extra-services2.js';
import { d as defineCustomElement$y } from './ir-guest-info2.js';
import { d as defineCustomElement$x } from './ir-icon2.js';
import { d as defineCustomElement$w } from './ir-icons2.js';
import { d as defineCustomElement$v } from './ir-input-text2.js';
...
import { d as defineCustomElement$o } from './ir-payment-folio2.js';
...
const IrBookingDetails = /*@__PURE__*/ proxyCustomElement(class IrBookingDetails extends HTMLElement {
    ...
    static get style() { return IrBookingDetailsStyle0 + IrBookingDetailsStyle1; }
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-details", "igl-application-info", "igl-block-dates-view", "igl-book-property", "igl-book-property-footer", "igl-book-property-header", "igl-booking-form", "igl-booking-overview-page", "igl-date-range", "igl-property-booked-by", "igl-rate-plan", "igl-room-type", "ir-applicable-policies", "ir-autocomplete", "ir-booking-company-form", "ir-booking-extra-note", "ir-booking-guarantee", "ir-booking-header", "ir-booking-status-tag", "ir-button", "ir-combobox", "ir-country-picker", "ir-custom-button", "ir-custom-date-picker", "ir-custom-input", "ir-date-picker", "ir-date-range", "ir-date-view", "ir-dialog", "ir-drawer", "ir-events-log", "ir-extra-service", "ir-extra-service-config", "ir-extra-services", "ir-guest-info", "ir-icon", "ir-icons", "ir-input-text", "ir-interceptor", "ir-label", "ir-modal", "ir-otp", "ir-otp-modal", "ir-payment-details", "ir-payment-folio", "ir-payment-item", "ir-payment-summary", "ir-payments-folio", "ir-phone-input", "ir-picker", "ir-picker-item", "ir-pickup", "ir-pickup-view", "ir-pms-logs", "ir-popover", "ir-price-input", "ir-reservation-information", "ir-room", "ir-room-guests", "ir-select", "ir-sidebar", "ir-spinner", "ir-textarea", "ir-title", "ir-toast", "ir-tooltip", "ir-validator", "ota-label"];
