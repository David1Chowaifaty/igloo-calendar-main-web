...
const IglToastProvider$1 = /*@__PURE__*/ proxyCustomElement(class IglToastProvider extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    static supportsPopover = typeof document !== 'undefined' && typeof document.createElement('div').showPopover === 'function';
    toastTimers = new Map();
    get el() { return this; }
    toasts = [];
    static getToastStack() {
    ...
    getIconPath(icon) {
        const icons = {
            'check-circle': '<path fill="currentColor" d="M10 0a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm4.854 7.854l-5 5a.5.5 0 0 1-.708 0l-3-3a.5.5 0 0 1 .708-.708L9 11.293l4.646-4.647a.5.5 0 0 1 .708.708z"/>',
            ...
            'exclamation-triangle': '<path fill="currentColor" d="M8.982 1.566a1.13 1.13 0 0 0-1.96 0L.165 13.233c-.457.778.091 1.767.98 1.767h13.713c.889 0 1.438-.99.98-1.767L8.982 1.566zM8 5c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 5.995A.905.905 0 0 1 8 5zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>',
            'x-circle': '<path fill="currentColor" d="M10 0a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm3.854 12.146a.5.5 0 0 1-.708.708L10 9.707l-3.146 3.147a.5.5 0 0 1-.708-.708L9.293 9 6.146 5.854a.5.5 0 1 1 .708-.708L10 8.293l3.146-3.147a.5.5 0 0 1 .708.708L10.707 9l3.147 3.146z"/>',
        };
    ...
    static get style() { return IglToastProviderStyle0; }
}, [0, "igl-toast-provider", {
        "toasts": [32],
        "show": [64],
        "hide": [64]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["igl-toast-provider"];
    components.forEach(tagName => { switch (tagName) {
        case "igl-toast-provider":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IglToastProvider$1);
            }
            break;
    } });
}

const IglToastProvider = IglToastProvider$1;
const defineCustomElement = defineCustomElement$1;

export { IglToastProvider, defineCustomElement };
