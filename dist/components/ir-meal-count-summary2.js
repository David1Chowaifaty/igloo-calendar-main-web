...
const IrMealCountSummary = /*@__PURE__*/ proxyCustomElement(class IrMealCountSummary extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    static get style() { return IrMealCountSummaryStyle0; }
}, [2, "ir-meal-count-summary", {
        "mealCountSummary": [16]
    }]);
function defineCustomElement() {
    ...
    const components = ["ir-meal-count-summary", "ir-empty-state"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-meal-count-summary":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrMealCountSummary);
            }
            break;
        case "ir-empty-state":
            if (!customElements.get(tagName)) {
...
export { IrMealCountSummary as I, defineCustomElement as d };

//# sourceMappingURL=ir-meal-count-summary2.js.map