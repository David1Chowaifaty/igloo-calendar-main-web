...
const IglBookProperty = /*@__PURE__*/ proxyCustomElement(class IglBookProperty extends HTMLElement {
    ...
    render() {
        //console.log('render');
        return (h(Host, { key: 'dd8eda0235f7ec815394e9173a5194fa64c6f6d6' }, h("div", { key: '9ad954d7307bcb1361b3d89c09b5f298892c6298', class: "background-overlay", onClick: () => this.closeWindow() }), h("div", { key: '906e4774cddac4795b9c74f4f50795e5b3e548d8', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, h("div", { key: '72f421ed5736277e2a39ffdf97cc87f2f9d85d18', class: "card position-sticky mb-0 shadow-none p-0 " }, h("div", { key: '49e9bc0026340a568975361b1353a6ebd5450a9a', class: "card-header-container mb-2" }, h("h3", { key: 'f121cc4396fdb964754c7cfee4244a764c6e7fc1', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), h("ir-icon", { key: '1e7952b3f26e8d545794f5c78211e8449037b5a3', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, h("svg", { key: 'e5d73fb81d45779a528c8e3b362e72f656855a64', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '871bdcb30ab9373119b376634a8d9aede3648925', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), h("div", { key: '470fe3bb68c225e1193eeb5bc3423b9af8b707c5', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (h("igl-booking-overview-page", { key: 'd087cde0c3582bcb988d79d62b0e150069ad531c', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData,
