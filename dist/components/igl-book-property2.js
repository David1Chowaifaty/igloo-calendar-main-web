...
import { V as VariationService, d as defineCustomElement$l } from './igl-application-info2.js';
...
const IglBookProperty = /*@__PURE__*/ proxyCustomElement(class IglBookProperty extends HTMLElement {
    ...
    async bookUser(check_in) {
        ...
        try {
            ...
            const serviceParams = await this.bookPropertyService.prepareBookUserServiceParams({
                ...
                check_in: this.isEventType('BAR_BOOKING') ? check_in : false,
            });
    ...
    render() {
        return (h(Host, { key: '5d9986c3bd611f48c46cc15c4bb5ccb4642b3ab5' }, h("div", { key: '4707f16560cee8b6162eedf2f44a8f6d9ba11274', class: "background-overlay", onClick: () => this.closeWindow() }), h("div", { key: '3f1d797cfe8fdd72bac58b28c1410f9a0eb71997', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, h("div", { key: '9e8a82c2447107da594a4dcaf12892b1f7bace1f', class: "card position-sticky mb-0 shadow-none p-0 " }, h("div", { key: '54629f95c5eb1c83c4351e46ed92a3383caafebd', class: "card-header-container mb-2" }, h("h3", { key: 'adbb9857a7548fd05dd5d3f73e3427c7c47f99a4', class: " text-left font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), h("ir-icon", { key: 'd963e14d29728cea32dfa7251f6cb27ec135f3f2', class: 'px-2', onIconClickHandler: () => {
                this.closeWindow();
            } }, h("svg", { key: '09766d157e6ea00c5d235825e4932ca0b94c75df', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '1b0a5f231defba67d5c521356dabe7e8af2ca783', fill: "currentColor", d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), h("div", { key: '1158882a3b9219c54d03a5dc078c90284e58800c', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (h("igl-booking-overview-page", { key: '9975b61355f72391790629c05c1e9d905835010a', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData, adultChildConstraints: this.adultChildConstraints, sourceOptions: this.sourceOptions, propertyId: this.propertyid })), this.getCurrentPage('page_two') && (h("igl-booking-form", { key: '319a584d71c937bbf2fbc9eb4ecf40fdbb6bb6ff', currency: this.currency, propertyId: this.propertyid, showPaymentDetails: this.showPaymentDetails, selectedGuestData: this.guestData, countryNodeList: this.countryNodeList, isLoading: this.isLoading, selectedRooms: this.selectedUnits, bedPreferenceType: this.bedPreferenceType, dateRangeData: this.dateRangeData, bookingData: this.defaultData, showSplitBookingOption: this.showSplitBookingOption, language: this.language, bookedByInfoData: this.bookedByInfoData, defaultGuestData: this.defaultData, isEditOrAddRoomEvent: this.isEventType('EDIT_BOOKING') || this.isEventType('ADD_ROOM'), onDataUpdateEvent: event => this.handlePageTwoDataUpdateEvent(event) })), this.getCurrentPage('page_block_date') ? this.getPageBlockDatesView() : null))));
    }
...
function defineCustomElement() {
    ...
    const components = ["igl-book-property", "igl-application-info", "igl-block-dates-view", "igl-book-property-footer", "igl-book-property-header", "igl-booking-form", "igl-booking-overview-page", "igl-date-range", "igl-property-booked-by", "igl-rate-plan", "igl-room-type", "ir-autocomplete", "ir-button", "ir-combobox", "ir-date-picker", "ir-date-view", "ir-icon", "ir-icons", "ir-phone-input", "ir-price-input", "ir-select", "ir-tooltip"];
