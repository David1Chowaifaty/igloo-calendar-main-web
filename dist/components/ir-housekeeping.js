...
import { d as defineCustomElement$e } from './ir-hk-team2.js';
...
function defineCustomElement$1() {
    ...
    const components = ["ir-housekeeping", "ir-button", "ir-combobox", "ir-delete-modal", "ir-hk-team", "ir-hk-unassigned-units", "ir-hk-user", "ir-icon", "ir-input-text", "ir-interceptor", "ir-loading-screen", "ir-phone-input", "ir-select", "ir-sidebar", "ir-switch", "ir-toast", "ir-unit-status"];
