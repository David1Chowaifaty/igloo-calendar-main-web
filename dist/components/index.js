...
/*! Copyright 2026 Fonticons, Inc. - https://webawesome.com/license */
var vs=class extends kt{constructor(){super(...arguments),this.localize=new Nt(this),this.value=0,this.unit="byte",this.display="short"}static get styles(){return[]}render(){if(isNaN(this.value))return"";const t="bit"===this.unit?["","kilo","mega","giga","tera"]:["","kilo","mega","giga","tera","peta"],e=Math.max(0,Math.min(Math.floor(Math.log10(this.value)/3),t.length-1)),i=t[e]+this.unit;return this.localize.number(parseFloat((this.value/Math.pow(1e3,e)).toPrecision(3)),{style:"unit",unit:i,unitDisplay:this.display})}};s([bt({type:Number})],vs.prototype,"value",2),s([bt()],vs.prototype,"unit",2),s([bt()],vs.prototype,"display",2),vs=s([ft("wa-format-bytes")],vs);