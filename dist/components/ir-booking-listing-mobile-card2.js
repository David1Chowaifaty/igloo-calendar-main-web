...
import { d as defineCustomElement$b } from './ir-arrival-time-cell2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-listing-mobile-card", "ir-arrival-time-cell", "ir-balance-cell", "ir-booked-by-cell", "ir-booked-on-cell", "ir-booking-number-cell", "ir-booking-status-tag", "ir-custom-button", "ir-dates-cell", "ir-status-activity-cell", "ir-unit-cell", "ir-unit-tag"];
