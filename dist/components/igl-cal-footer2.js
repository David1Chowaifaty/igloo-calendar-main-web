...
const IglCalFooter = /*@__PURE__*/ proxyCustomElement(class IglCalFooter extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '7c93e37e8cc0d7abde9f5add16eff5e2118330d3', class: "footerContainer" }, h("div", { key: '63f589d761412574323643bdf2554bad0882efb5', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, h("div", { key: 'd34df420b91f38c5f1f42f82b25d718f009ca93b', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, h("i", { key: '8413772b452309a52392a502a8204781b2ac11cc', class: "la la-square" }), h("u", { key: '4c0c39339794d957d2df4d41752609c509eb5d49' }, locales.entries.Lcz_Legend), h("span", { key: 'a2302e5d606aff2ba3dd6ed0b2e740542af7d94f' }, " - v1.0125"))), this.calendarData.days.map(dayInfo => (h("div", { class: "footerCell align-items-center" }, h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
