...
const IglCalFooter = /*@__PURE__*/ proxyCustomElement(class IglCalFooter extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'f34f33edecc7417ca79eb772ee3a9359167c7962', class: "footerContainer" }, h("div", { key: '9c466094129caf11c8f112c7ac9df42ad2372ace', class: "footerCell bottomLeftCell align-items-center preventPageScroll" }, h("div", { key: '127623d51ce6fac5a1ed1bf5eb0466b4b70ff86f', class: "legendBtn", onClick: () => this.handleOptionEvent('showLegend') }, h("i", { key: '9e0d00a1cf363bad0ed792d977716725599a6bd7', class: "la la-square" }), h("u", { key: 'd76d97e55a41b4a8c478cfb8f33f4d4e036b63f5' }, locales.entries.Lcz_Legend), h("span", { key: '23552d70607fb27fe800ae2e3294c4142cbd1490' }, " - v1.0128"))), this.calendarData.days.map(dayInfo => (h("div", { class: "footerCell align-items-center" }, h("div", { class: `dayTitle full-height align-items-center ${dayInfo.day === this.today || this.highlightedDate === dayInfo.day ? 'currentDay' : ''}` }, dayInfo.dayDisplayName))))));
    }
