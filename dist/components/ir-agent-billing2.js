...
const IrAgentBilling = /*@__PURE__*/ proxyCustomElement(class IrAgentBilling extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'ded0686926ea2e0759d13d6b104326fc12fc1e80' }, h("div", { key: '085a9696da63f4e8c0da07f5148f2ae3ab168c8e', class: "billing__container" }, h("div", { key: '129a4d1ea93c7eb2232dc4b31fcb59ecb2f6d9c5', class: "billing__section-title-row" }, h("h4", { key: 'f9f45a7709873e5df0c93ec182b96e8964c668ce', class: "billing__section-title" }, "Issued documents"), h("ir-custom-button", { key: '0859f70eb78d9baa337dd4f4143a85ceb06423b4', onClickHandler: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.invoiceDialogRef.openModal();
            }, appearance: 'accent', class: "booking-header__stretched-btn", size: "small", variant: "brand" }, "Issue Invoice")), h("ir-city-ledger-fiscal-documents-table", { key: 'e12876fb6d6018c03bad21eaf3f3d9c1e0cc5cdc', class: 'agent-billing__table', rows: this.fiscalDocuments, isLoading: this.isLoading, hasFetched: this.hasFetched, agentId: this.booking?.agent?.id ?? null, currencySymbol: calendar_data.property?.currency?.symbol ?? '$', fromDate: this.booking?.from_date ?? null, toDate: this.booking?.to_date ?? null, hasDates: true, ticket: this.tokenService.getToken(), propertyId: calendar_data.property?.id, onFetchRequested: () => this.fetchFiscalDocuments() })), h("ir-cl-invoice-dialog", { key: 'ad0968b471269499e968f364f7f26f81b78c9eb0', mode: "booking", agentId: this.booking.agent?.id, bookingNbr: this.booking.booking_nbr, startDate: this.booking.from_date, endDate: this.booking.to_date, currencyId: calendar_data.property.currency.id, rooms: this.booking.rooms ?? [], ref: el => (this.invoiceDialogRef = el), onInvoiceIssued: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
