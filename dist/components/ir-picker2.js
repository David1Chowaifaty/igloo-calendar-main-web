...
const IrPicker = /*@__PURE__*/ proxyCustomElement(class IrPicker extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '2fde71d842982e9a09d35effb03652e125a639a1' }, h("wa-popup", { key: '795eefdbdc5a535b5164efb42b382725f2e52ba1', flip: true, shift: true, placement: "bottom", sync: "width", "auto-size": "vertical", "auto-size-padding": 10, active: this.isOpen }, h("wa-input", { key: '6c9bd4148cfac94599191133a5672420a1f8f7e9', slot: "anchor", class: "search-bar", "aria-invalid": this.isValid, withClear: this.withClear, size: this.size, value: this.query, defaultValue: this.defaultValue, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, onblur: () => this.inputPickerBlurred.emit(), autocomplete: "nope", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
                this.comboboxClear.emit();
            } }, this.loading && h("wa-spinner", { key: 'b6c10e80a98ae21553a809aa1100dd433d871ca9', slot: "end" }), h("wa-icon", { key: '34dec64fbb3e1720cdf72fc84b4e9fa25b514203', slot: "start", name: "magnifying-glass", "aria-hidden": "true" }), h("slot", { key: '19a75e41ad4fef4f49bafc91db0efecb1b3967c7', name: "end", slot: "end" })), h("div", { key: 'ae301f9331f5cbe2b0a39c45db5fe6339a1bbba8', class: "menu", role: "presentation" }, h("p", { key: 'b35a3f9cc351591447c17b1ca2e28c2b00bff135', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), h("ul", { key: '3303f0d33e4f4b1d8ed6e03ecee180e79829feae', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, "aria-busy": this.loading ? 'true' : undefined, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, this.loading && (h("li", { key: 'd51aee2b6a6989e19b563730dfd7a868f4114d6d', class: "loading-state", role: "presentation" }, h("wa-spinner", { key: 'bb81d4c455b93f62c8914f54975fcfa234029c4a' }), h("p", { key: '5cfbf6b7d4e0fac7b503d0cc8f5e750c72aff92a' }, "Loading suggestions\u2026"))), h("slot", { key: 'c0a3276f1e4bf40ba2082f1d742784c0e2f112ec', onSlotchange: this.handleSlotChange }), showEmptyState && (h("li", { key: '9f37255cccf6e778361b8f325c055f583b0d35a8', class: "empty-state", role: "presentation", id: this.emptyStateId }, h("wa-icon", { key: 'e6ca572184182b95b7dbc8c470a8328e18af5977', name: "circle-info", "aria-hidden": "true" }), h("p", { key: '6fabd9172c36a7dc28e166b900d400002ed88234' }, "No results found")))))), h("span", { key: '218b1eeb80677dfa0e8304d76bbebdd0ee1b7511', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
