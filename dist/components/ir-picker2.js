...
const IrPicker = /*@__PURE__*/ proxyCustomElement(class IrPicker extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'b2921847833f3d4e2fb9bf1b603a2227a92ab9a7' }, h("wa-popup", { key: 'dc0cd1a63c62ca868c89d62499f7e18ace5caa2e', "flip-fallback-strategy": "best-fit", shift: true, "shift-padding": 10, "auto-size": "vertical", "auto-size-padding": 10, flip: true, active: this.isOpen }, h("wa-input", { key: 'f43924e7810d7c1e8b3f2642ae485af2671af6ce', slot: "anchor", class: "search-bar",
            // withClear
            size: this.size, value: this.query, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
            } }, this.loading && h("wa-spinner", { key: '95c1b819ed413cf33a05ac130e43644ede7331b6', slot: "end" }), h("wa-icon", { key: '93be03f9d4bc8667d60ddc51c4ab326ac168d0db', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), !this.loading && (h("div", { key: '003c00c87bc246864cc8b48deff57e695055909a', class: "menu", role: "presentation" }, h("p", { key: '5fd886206968d0605c99f1c4df4769be5b562e86', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), h("ul", { key: '89a25451c96c13fc9257dffbb3f9ed411baf2160', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, h("slot", { key: '5c60e825f29f78b572f4b71064f9869e71e73410', onSlotchange: this.handleSlotChange }), !hasResults && (h("li", { key: '151112224d049bbe4c531514ccb3449bfbaf2d89', class: "empty-state", role: "presentation", id: this.emptyStateId }, h("wa-icon", { key: 'a703da3dc43c3c83ad4462ed9f0f9814998bf9d2', name: "circle-info", "aria-hidden": "true" }), h("p", { key: '05ff7482d24e90b1b7f85c68374275c28cb586b3' }, "No results found"))))))), h("span", { key: 'd057dd366258724dc18d3c085837ae7dae569943', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
