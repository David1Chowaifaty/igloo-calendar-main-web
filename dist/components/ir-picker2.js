...
const IrPicker = /*@__PURE__*/ proxyCustomElement(class IrPicker extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'b2921847833f3d4e2fb9bf1b603a2227a92ab9a7' }, h("wa-popup", { key: 'dc0cd1a63c62ca868c89d62499f7e18ace5caa2e', "flip-fallback-strategy": "best-fit", shift: true, "shift-padding": 10, "auto-size": "vertical", "auto-size-padding": 10, flip: true, active: this.isOpen }, h("wa-input", { key: '20106adbaab25398ce19ef7e25f915ea41a54fb3', slot: "anchor", class: "search-bar",
            // withClear
            value: this.query, ref: el => (this.inputRef = el), appearance: this.appearance, label: this.label, pill: this.pill, autocomplete: "off", placeholder: this.placeholder || 'Search', oninput: this.handleInput, onfocus: this.handleInputFocus, "onwa-clear": () => {
                this.applyFilter('');
                this.open();
            } }, this.loading && h("wa-spinner", { key: 'f5b41a86d9a539faf36cef17cb5b74c25b3c0172', slot: "end" }), h("wa-icon", { key: '8488c7b20577da83fe51a09dae9052d3ebdcad38', slot: "start", name: "magnifying-glass", "aria-hidden": "true" })), !this.loading && (h("div", { key: 'd19d077c5635a33db538e24dad13cdb2fd3cace0', class: "menu", role: "presentation" }, h("p", { key: 'b3ba45622ebda8243346b9f24e493dbc0b76a23c', class: "sr-only", id: this.listboxLabelId }, "Available search shortcuts"), h("ul", { key: 'fdce4e9b342fecd0718499a58ee1824d30d1be08', class: "results", id: this.listboxId, role: "listbox", "aria-labelledby": this.listboxLabelId, "aria-describedby": emptyDescriptionId, onClick: this.handleResultsClick, onPointerDown: this.handleResultsPointerDown }, h("slot", { key: '86276fc15bae8e3288f8046b5688b905cc77e1d5', onSlotchange: this.handleSlotChange }), !hasResults && (h("li", { key: '116c0c5ea513a514d45a0b5bb4d888d56e74339e', class: "empty-state", role: "presentation", id: this.emptyStateId }, h("wa-icon", { key: '9884bab02825781b9d4b43245adb5f8b919d02e3', name: "circle-info", "aria-hidden": "true" }), h("p", { key: 'd9537cecbb3e626562942b81d83612c6319a782f' }, "No results found"))))))), h("span", { key: '210a8a3e07c70266104e4faeffad02e4767d1172', class: "sr-only", "aria-live": "polite" }, this.liveRegionMessage)));
    }
