...
const IglBookPropertyContainer = /*@__PURE__*/ proxyCustomElement(class IglBookPropertyContainer extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '0cc7eda8b717943c4fc585d11ef722adfac94989' }, this.withIrToastAndInterceptor && (h(Fragment, { key: 'e84448cdcd03c413b6b68bfd8145855e96ee73ec' }, h("ir-toast", { key: '11c8f4fe71e984aa2ffb6b03b94aa8a826c98033' }), h("ir-interceptor", { key: 'c0fd0b1699af1913abfdf7de862518330eeb2fd4' }))), h("div", { key: 'c5b7ac6067b49e5bd2cddb9ca8171a0bf14a4c9b', class: "book-container", onClick: this.handleTriggerClicked.bind(this) }, h("slot", { key: '19a9f3b63a9aa1da901f8aaef30a9ca7df65571d', name: "trigger" })), this.bookingItem && (h("igl-book-property", { key: 'de5946a09e266cb83e5ab2339c9418e402a49073', allowedBookingSources: this.calendarData.allowed_booking_sources, adultChildConstraints: this.calendarData.adult_child_constraints, showPaymentDetails: this.showPaymentDetails, countries: this.countries, currency: this.calendarData.currency, language: this.language, propertyid: this.propertyid, bookingData: this.bookingItem, onResetBookingEvt: (e) => {
...
function defineCustomElement() {
    ...
    const components = ["igl-book-property-container", "igl-application-info", "igl-block-dates-view", "igl-book-property", "igl-book-property-footer", "igl-book-property-header", "igl-booking-form", "igl-booking-overview-page", "igl-date-range", "igl-property-booked-by", "igl-rate-plan", "igl-room-type", "ir-button", "ir-country-picker", "ir-custom-button", "ir-custom-date-picker", "ir-date-view", "ir-icons", "ir-input", "ir-input-text", "ir-interceptor", "ir-mobile-input", "ir-otp", "ir-otp-modal", "ir-picker", "ir-picker-item", "ir-spinner", "ir-toast"];
