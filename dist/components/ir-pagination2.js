...
const IrPagination = /*@__PURE__*/ proxyCustomElement(class IrPagination extends HTMLElement {
    ...
    static get style() { return IrPaginationStyle0; }
        ...
        "pages": [2],
        "pageSizes": [16],
        "allowPageSizeChange": [4, "allow-page-size-change"],
        "total": [2],
        "currentPage": [2, "current-page"],
        "showing": [16],
        "showTotalRecords": [4, "show-total-records"],
        "recordLabel": [1, "record-label"],
        "disabled": [4],
...
function defineCustomElement() {
    ...
    const components = ["ir-pagination", "ir-button", "ir-icons", "ir-select"];
