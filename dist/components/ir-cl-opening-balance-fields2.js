...
const IrClOpeningBalanceFields = /*@__PURE__*/ proxyCustomElement(class IrClOpeningBalanceFields extends HTMLElement {
    ...
    fieldChange;
    render() {
        return (h("div", { key: '6abee7e8d251cf9f6c827eb2acda5fa2e6e4f163', class: "field field--full-width" }, h("ir-validator", { key: 'c81cc6c0a7427d8fa72e3d78b34750783ca9a8a4', schema: entryTypeFieldSchema, value: this.entryType, valueEvent: "change" }, h("wa-radio-group", { key: 'e1444e029613c2bbe8add72cb7cbc4380e89217d', label: "Entry Type", orientation: "horizontal", size: "small", value: this.entryType, onchange: event => {
                this.fieldChange.emit({ entryType: event.target.value });
            } }, h("wa-radio", { key: 'b2e1438647059de9aa899c14e75e005227934883', value: "CR", appearance: "button", class: "entry-type --credit" }, "Credit"), h("wa-radio", { key: '48a2bbfec4a715cdf166b11da1bf730280d603c6', value: "DB", appearance: "button", class: "entry-type --debit" }, "Debit")))));
    }
