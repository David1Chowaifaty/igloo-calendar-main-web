...
const IrBookingBillingRecipient = /*@__PURE__*/ proxyCustomElement(class IrBookingBillingRecipient extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: '866d39eb703c7b074578cbe8843377f546ed124b' }, h("wa-radio-group", { key: 'eae446174ebfdd246aa70a5987e30210059c71ed', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, h("wa-radio", { key: '334fba0e172f9b36f35c80cc5d73bbdc9c30bc93', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), !this.booking.agent && (h("wa-radio", { key: '01b032bd6d46c3347fe4f8c8ef9fc6bf9c758d11', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name'))), h("ir-booking-company-dialog", { key: 'a934be1a587d0eb36e434ff92a7188536bfb2e50', onCompanyFormClosed: () => {
