...
const IrBookingBillingRecipient = /*@__PURE__*/ proxyCustomElement(class IrBookingBillingRecipient extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'e3d2b1c1b0b60b2eead9ff95df546757cf5b6ccd' }, h("wa-radio-group", { key: 'b63f275e10933265fa26c57f6a24569bdad20421', defaultValue: this.initialValue, onchange: e => this.handleRecipientChange(e.target.value), label: "Bill to", orientation: "vertical", name: `${this.booking?.booking_nbr}-bill-to`, value: this.selectedRecipient, size: "small" }, h("wa-radio", { key: 'fed54b0818f15ce87bafc7d35c00b2ef672bef9e', appearance: "button", value: 'guest' }, this.booking?.guest.first_name, " ", this.booking.guest.last_name), this.rooms.map((r, idx) => (h("wa-radio", { appearance: "button", class: "billing-recipient__room", value: `room__${r.guest.first_name} ${r.guest.last_name}`, key: r.guest?.id ?? `guest_${idx}` }, h("span", { class: "billing-recipient__guest-name" }, r.guest.first_name, " ", r.guest.last_name)))), h("wa-radio", { key: '8056a98f34aa169a49bc97d1ee9c57cbfd4a8e35', appearance: "button", value: "company" }, this.booking.company_name ? this.booking.company_name : 'Use company name')), h("ir-booking-company-dialog", { key: '2c31fa779142e80ff6eb4fdd29e813e8c3900785', onCompanyFormClosed: () => {
