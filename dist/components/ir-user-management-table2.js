...
function defineCustomElement() {
    ...
    const components = ["ir-user-management-table", "ir-button", "ir-icon", "ir-icons", "ir-input-text", "ir-interceptor", "ir-modal", "ir-otp", "ir-otp-modal", "ir-password-validator", "ir-reset-password", "ir-select", "ir-sidebar", "ir-spinner", "ir-switch", "ir-title", "ir-toast", "ir-toast-alert", "ir-toast-provider", "ir-user-form-panel", "requirement-check"];
