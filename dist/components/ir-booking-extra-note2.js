...
const IrBookingExtraNote = /*@__PURE__*/ proxyCustomElement(class IrBookingExtraNote extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'deef0d543272c93a43b014910997c6a6dc006413', class: 'px-0' }, h("ir-title", { key: 'f7782be78c17be16b439f2fc8695948a47c1feff', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_PrivateNote, displayContext: "sidebar" }), h("form", { key: '42ca14787664b3ed48dabb81d85694f86bbb85dc', class: 'px-1', onSubmit: e => {
                e.preventDefault();
                this.savePrivateNote();
            } }, h("ir-textarea", { key: 'fdda794d49cbede6385fb7eb5a27bf32beecffcb', placeholder: locales.entries.Lcz_PrivateNote_MaxChar, label: "", value: this.note, maxLength: 150, onTextChange: e => this.setNote(e.detail) }), h("div", { key: 'bbb94a7d3cd5a9556415cfb303956f552b1993d2', class: 'd-flex flex-column flex-sm-row mt-3' }, h("ir-button", { key: '0f3368b0caaf74361cf18eb7a121541832d526cb', onClickHanlder: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  mr-sm-1'}`, icon: "", text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: 'c7d6b5b5bdc6c9bde44dd4fa3a84d98d93485dc9', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center ml-sm-1', icon: "", isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
