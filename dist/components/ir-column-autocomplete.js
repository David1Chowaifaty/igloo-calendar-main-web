...
const IrColumnAutocomplete$1 = /*@__PURE__*/ proxyCustomElement(class IrColumnAutocomplete extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        ...
        return (h(Host, { key: '2b4e38ace8b394c3236a01218cefae125c4a69c3' }, h("wa-popover", { key: '3fcc056aec609e354e595dd843714a26e0f8cffb', placement: "bottom", for: this.generatedTriggerId, class: "column-autocomplete__popover" }, h("div", { key: 'df6316d4c9e2b7cd401512d4b1245ea7c864c2d4', class: "column-autocomplete__input-container" }, h("wa-input", { key: '28911757f0843addea81b7d6cb0f88d2eead2da6', size: "small", value: this.query, placeholder: this.placeholder, oninput: this.onQueryInput })), h("div", { key: '2048cf9f0f38b9badf7b127df50dd1746e59dba0', class: "column-autocomplete__list" }, this.showSelectAll && (h("wa-checkbox", { key: '105e4eb51e44d368bd9d708254a0a27f610e6872', checked: this.areAllFilteredSelected, indeterminate: this.areSomeFilteredSelected, onchange: this.onToggleAll }, this.selectAllLabel)), filteredOptions.length > 0 ? (filteredOptions.map(option => (h("wa-checkbox", { checked: this.selected.includes(option), onchange: event => this.onToggleOption(event, option) }, option)))) : (h("div", { class: "column-autocomplete__empty" }, this.emptyLabel)))), h("div", { key: 'c2e94306c013c2c0407f18c023aa7b1cb8e1735d', id: this.generatedTriggerId }, h("slot", { key: '615aef99c17cceb14b3f1539b6dc62c2a1a6f61c', name: "trigger" }, h("wa-button", { key: '34b2253ea5f30fcb844c5bb013a990986d1b8571', size: "small", variant: "neutral", appearance: "plain", class: "header-button" }, h("wa-icon", { key: 'e01d196baf959577bb9af0de9a8e2e9402ebe7d3', name: "filter" }))))));
    }
    static get watchers() { return {
        "options": ["handleOptionsChange"],
        "selectedValues": ["handleSelectedValuesChange"]
    }; }
    static get style() { return IrColumnAutocompleteStyle0; }
}, [6, "ir-column-autocomplete", {
        "options": [16],
        "selectedValues": [16],
        "placeholder": [1],
        "selectAllLabel": [1, "select-all-label"],
        "emptyLabel": [1, "empty-label"],
...
function defineCustomElement$1() {
    ...
    const components = ["ir-column-autocomplete"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-column-autocomplete":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrColumnAutocomplete$1);
            }
            break;
    } });
}

const IrColumnAutocomplete = IrColumnAutocomplete$1;
const defineCustomElement = defineCustomElement$1;

export { IrColumnAutocomplete, defineCustomElement };
