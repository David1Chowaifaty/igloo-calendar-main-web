...
import { d as defineCustomElement$1P } from './igl-room-type2.js';
import { d as defineCustomElement$1O } from './ir-actions-cell2.js';
import { d as defineCustomElement$1N } from './ir-agent-billing2.js';
...
import { d as defineCustomElement$1J } from './ir-arrivals-table2.js';
...
import { d as defineCustomElement$1x } from './ir-booking-details-drawer2.js';
import { d as defineCustomElement$1w } from './ir-booking-editor2.js';
import { d as defineCustomElement$1v } from './ir-booking-editor-drawer2.js';
import { d as defineCustomElement$1u } from './ir-booking-editor-form2.js';
import { d as defineCustomElement$1t } from './ir-booking-editor-guest-form2.js';
import { d as defineCustomElement$1s } from './ir-booking-editor-header2.js';
import { d as defineCustomElement$1r } from './ir-booking-extra-note2.js';
import { d as defineCustomElement$1q } from './ir-booking-guarantee2.js';
import { d as defineCustomElement$1p } from './ir-booking-header2.js';
...
import { d as defineCustomElement$M } from './ir-guest-billing2.js';
...
import { d as defineCustomElement$J } from './ir-guest-name-cell2.js';
...
import { d as defineCustomElement$q } from './ir-pdf-viewer2.js';
...
import { d as defineCustomElement$9 } from './ir-service-assignee-select2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-arrivals", "igl-application-info", "igl-rate-plan", "igl-room-type", "ir-actions-cell", "ir-agent-billing", "ir-air-date-picker", "ir-applicable-policies", "ir-arrival-time-dialog", "ir-arrivals-table", "ir-assignment-toggle-dialog", "ir-balance-cell", "ir-billing", "ir-billing-drawer", "ir-booked-by-cell", "ir-booking-assign-items", "ir-booking-billing-recipient", "ir-booking-city-ledger", "ir-booking-company-dialog", "ir-booking-company-form", "ir-booking-details", "ir-booking-details-drawer", "ir-booking-editor", "ir-booking-editor-drawer", "ir-booking-editor-form", "ir-booking-editor-guest-form", "ir-booking-editor-header", "ir-booking-extra-note", "ir-booking-guarantee", "ir-booking-header", "ir-booking-number-cell", "ir-booking-pricing-drawer", "ir-booking-pricing-form", "ir-booking-rooms", "ir-booking-source-editor-dialog", "ir-booking-source-editor-form", "ir-booking-status-tag", "ir-button", "ir-checkout-dialog", "ir-city-ledger-fiscal-documents-table", "ir-city-ledger-transaction-drawer", "ir-city-ledger-transaction-form", "ir-cl-adjustment-fields", "ir-cl-credit-note-fields", "ir-cl-debit-note-fields", "ir-cl-fiscal-document-preview", "ir-cl-invoice-dialog", "ir-cl-invoice-form", "ir-cl-invoice-select", "ir-cl-opening-balance-fields", "ir-cl-payment-fields", "ir-cl-status-tag", "ir-country-picker", "ir-custom-button", "ir-custom-date-picker", "ir-custom-date-range", "ir-date-range", "ir-date-range-filter", "ir-date-select", "ir-date-view", "ir-dates-cell", "ir-dialog", "ir-drawer", "ir-empty-state", "ir-events-log", "ir-extra-service", "ir-extra-service-config", "ir-extra-service-config-form", "ir-extra-services", "ir-fd-confirm-dialog", "ir-guest-billing", "ir-guest-info-drawer", "ir-guest-info-form", "ir-guest-name-cell", "ir-icons", "ir-input", "ir-input-text", "ir-interceptor", "ir-invoice", "ir-invoice-form", "ir-label", "ir-loading-screen", "ir-mobile-input", "ir-otp", "ir-otp-modal", "ir-pagination", "ir-payment-details", "ir-payment-folio", "ir-payment-folio-form", "ir-payment-item", "ir-payment-summary", "ir-payments-folio", "ir-pdf-viewer", "ir-picker", "ir-picker-item", "ir-pickup", "ir-pickup-form", "ir-pickup-view", "ir-pms-logs", "ir-preview-screen-dialog", "ir-print-room", "ir-printing-extra-service", "ir-printing-label", "ir-printing-pickup", "ir-proforma-invoice-preview", "ir-reservation-information", "ir-room", "ir-room-guests", "ir-room-guests-form", "ir-service-assignee-select", "ir-spinner", "ir-toast", "ir-toast-alert", "ir-toast-provider", "ir-unit-cell", "ir-unit-tag", "ir-validator", "ota-label"];
