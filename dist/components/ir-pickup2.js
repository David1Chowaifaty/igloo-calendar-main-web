...
import { K as renderTime } from './utils.js';
...
const IrPickup = /*@__PURE__*/ proxyCustomElement(class IrPickup extends HTMLElement {
    ...
    render() {
        var _a, _b, _c, _d, _e;
        return (h("form", { key: '59c03f89c7f80e55a9549d9705c608dba1698690', class: 'sheet-container', onSubmit: async (e) => {
                e.preventDefault();
                await this.savePickup();
            } }, h("ir-title", { key: '084af4c6bbb2a7855aa9eaa8827374ae8644288c', class: "px-1 sheet-header", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_Pickup, displayContext: "sidebar" }), h("section", { key: '54a2a11313b73e847146cc3f70004e0f378a3c24', class: 'px-1 sheet-body' }, h("ir-select", { key: 'e52b201b6e85deb85a67617762e737fdfd45acfd', testId: "pickup_location", selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h("div", { key: 'a8c665ad7f7c827172dd0fec2d7bdc643e5daf8b', class: "m-0 p-0", "data-testid": "pickup_body" }, h("div", { key: '58b2a14bdf6e923d4fdbf81ae7722e978c52286a', class: 'd-flex' }, h("div", { key: 'c352055c1501bde417c443b847e82a5ef23ea103', class: "form-group  mr-1" }, h("div", { key: 'f0ccb813d77dbd1234bb202574ba356bf84e3162', class: "input-group row m-0" }, h("div", { key: 'ff2d864aab02ded55de6672c338361defa9a337e', class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { key: '7adc960bdf5ec6229fafe97e9732ef1ce2e8ac81', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { key: '2f5a77bef7975f3bb364bca3251e3e3b8cd57a18', class: "form-control  form-control-md col-7 d-flex align-items-center px-0 mx-0", style: { border: '0' } }, h("ir-date-picker", { key: '22bc1f3982062b2a0dd68c8313d4285df9696ee5', "data-testid": "pickup_arrival_date", date: this.pickupData.arrival_date, minDate: this.bookingDates.from, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, emitEmptyDate: true, "aria-invalid": ((_b = this.errors) === null || _b === void 0 ? void 0 : _b.arrival_date) && !this.pickupData.arrival_date ? 'true' : 'false', onDateChanged: evt => {
                var _a;
                this.updatePickupData('arrival_date', (_a = evt.detail.start) === null || _a === void 0 ? void 0 : _a.format('YYYY-MM-DD'));
            } }, h("input", { key: '58d50f8cd2486699d9373a99028dcacb7ee9df42', type: "text", slot: "trigger", value: this.pickupData.arrival_date ? hooks(this.pickupData.arrival_date).format('MMM DD, YYYY') : null, class: `form-control input-sm ${((_c = this.errors) === null || _c === void 0 ? void 0 : _c.arrival_date) && !this.pickupData.arrival_date ? 'border-danger' : ''} text-center`, style: { borderTopLeftRadius: '0', borderBottomLeftRadius: '0', width: '100%' } }))))), h("ir-input-text", { key: 'dcc1b301f3f3720d217ea8dc4263804da970ec2d', autoValidate: this.autoValidate, wrapKey: "arrival_time", testId: "pickup_arrival_time", error: (_d = this.errors) === null || _d === void 0 ? void 0 : _d.arrival_time, value: this.pickupData.arrival_time, zod: this.pickupSchema.pick({ arrival_time: true }), label: locales.entries.Lcz_Time, inputStyles: "col-sm-4", "data-state": this.cause === 'arrival_time' ? 'error' : '', mask: this.arrival_time_mask, onTextChange: e => this.updatePickupData('arrival_time', e.detail) })), h("ir-input-text", { key: 'a837c00aa70bb761f62a74ea111ce6ccb071426d', wrapKey: "flight_details", zod: this.pickupSchema.pick({ flight_details: true }), autoValidate: this.autoValidate, testId: "pickup_flight_details", value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", error: (_e = this.errors) === null || _e === void 0 ? void 0 : _e.flight_details }), h("ir-select", { key: 'a452ad0e84e058deac3117dc15b963ef048328b5', testId: "pickup_vehicle_type_code", selectContainerStyle: "mb-1", error: this.cause === 'vehicle_type_code', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), h("div", { key: '7487d1b9c92f5fcd7b8b54c72833e1e6df8c2616', class: 'd-flex flex-column flex-md-row' }, h("ir-select", { key: 'f74be95becc3599735ce37b9443e6248846cdb15', showFirstOption: false, testId: "pickup_number_of_vehicles", labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectedValue: this.pickupData.number_of_vehicles, error: this.cause === 'number_of_vehicles', labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), h("div", { key: '1ed45676b6c8992b170991a312a59fabdfa32b5a', class: "price-input-container" }, h("ir-price-input", { key: 'c8c684cf83dcc9707cb36dd18f85c7d5f0e47f5b', readOnly: true, label: `${locales.entries.Lcz_DueUponBooking}`, value: this.pickupData.due_upon_booking, currency: this.pickupData.currency.symbol })))))), h("div", { key: 'aac0a45eb1ceb416e4b0704ebd10393076b263d3', class: 'sheet-footer' }, h("ir-button", { key: 'e857540cb05e0b7551d678f9880ae4c9b48dc7bc', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (h("ir-button", { key: 'c366bed7d5afe774666b41ac4e0b3c51ba5e9963', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", btn_type: "submit" })))));
    }
    get el() { return this; }
