...
const IrPickup = /*@__PURE__*/ proxyCustomElement(class IrPickup extends HTMLElement {
    ...
    render() {
        var _a;
        return (h(Host, { key: '2d0403a22e760d8165bc302f044147fdd1da0950', class: 'p-0' }, h("ir-title", { key: '5ef1d8da6c394d3d12711f15eac4404ca753ecde', class: "px-1", onCloseSideBar: () => this.closeModal.emit(null), label: locales.entries.Lcz_Pickup, displayContext: "sidebar" }), h("section", { key: 'd4759c637874c8d3be8a1444dbd031f1269a0910', class: 'px-1' }, h("ir-select", { key: 'b4b012c93a6b9579bd6db10f1b03bab833348c79', selectedValue: this.pickupData.location, selectContainerStyle: "mb-1", onSelectChange: this.handleLocationChange.bind(this), firstOption: locales.entries.Lcz_Pickup_NoThankYou, class: 'm-0 mb-1', LabelAvailable: false, data: this.pickupService.getAvailableLocations(locales.entries.Lcz_Pickup_YesFrom) }), this.pickupData.location > 0 && (h(Fragment, { key: 'ac1a6448c5282b815dbcb79d74b7ce727953b8e5' }, h("div", { key: '5a9c52bdd4626e1534df3224091e4cfc83e8d190', class: 'd-flex' }, h("div", { key: '618718896190fb607fc624dea2130d58593a7e89', class: "form-group  mr-1" }, h("div", { key: '83b5c85430c7df3bcbf4db861567cbd1617a4870', class: "input-group row m-0" }, h("div", { key: 'd671455e0feb38a9700dfdf78413afd4190f3ba1', class: `input-group-prepend col-5 p-0 text-dark border-0` }, h("label", { key: '07530de7f745d0d14ffadd6c208f2d1bdfb5f357', class: `input-group-text  flex-grow-1 text-dark border-theme ` }, locales.entries.Lcz_ArrivalDate)), h("div", { key: '81fd21d2beb4fe40f31677c1b35a6d21eec48a0d', class: "form-control form-control-md col-7 d-flex align-items-center pl-0" }, h("ir-date-picker", { key: '7b6b11fd9eaff2bb626d2b31e544395a16cf600a', date: this.pickupData.arrival_date, maxDate: (_a = this.bookingDates) === null || _a === void 0 ? void 0 : _a.to, minDate: hooks().format('YYYY-MM-DD'),
            // customPicker={false}
            // autoApply
            ...
            } }, h("input", { key: 'c145d560db9c65d36285818403d1563ed7d83d54', type: "text", slot: "trigger", value: hooks(this.pickupData.arrival_date).format('MMM DD, YYYY'), class: "form-control input-sm text-center", style: { borderLeftWidth: '0', borderRightWidth: '0', width: '100%' } }))))), h("div", { key: 'ba17b52024a8fc478149863b48d7d2e5bfea4fdc', class: "form-group" }, h("div", { key: 'af2cce615401e45877670e6741810fd8e7f7946d', class: "input-group  row m-0" }, h("div", { key: '4bb48ec8a280e6c8f3f6ac1e1efeadabd4f9217c', class: `input-group-prepend col-4 col-sm-3 p-0 text-dark border-0` }, h("label", { key: '6d14ac53e2cc14d43cb814da33c7d3717b64b853', htmlFor: "pickup", class: `input-group-text flex-grow-1 text-dark border-theme` }, locales.entries.Lcz_Time)), h("input", { key: 'ead5d7f55242ac1a0be91332ebf911583c944303', type: "text", value: this.pickupData.arrival_time, id: "pickup-time", class: `form-control col-8 col-sm-4 ${this.cause === 'arrival_time' && 'border-danger'}` })))), h("ir-input-text", { key: 'fd66c6e7afe413bf9208ffcb218e2367c8e7f8d7', value: this.pickupData.flight_details, label: locales.entries.Lcz_FlightDetails, onTextChange: e => this.updatePickupData('flight_details', e.detail), placeholder: "", inputStyles: this.cause === 'flight_details' ? 'border-danger' : '' }), h("ir-select", { key: '99cd9a305e3e44fc59e7e328ff17f3f0a4c3c08a', selectContainerStyle: "mb-1", selectStyles: this.cause === 'vehicle_type_code' ? 'border-danger' : '', onSelectChange: this.handleVehicleTypeChange.bind(this), firstOption: locales.entries.Lcz_Select, selectedValue: this.pickupData.vehicle_type_code, class: 'm-0', LabelAvailable: false, data: this.allowedOptionsByLocation.map(option => ({
                text: option.vehicle.description,
                value: option.vehicle.code,
            })) }), h("div", { key: 'cddb6c4158f1c542ffad7ce07badf9e5802b7e6b', class: 'd-flex flex-column flex-md-row' }, h("ir-select", { key: 'c3a8c6423055bb69d83a49f5f9d95d59377ea18f', labelBorder: "theme", selectContainerStyle: "mb-1", onSelectChange: this.handleVehicleQuantityChange.bind(this), selectStyles: this.cause === 'number_of_vehicles' ? 'border-danger' : '', selectedValue: this.pickupData.number_of_vehicles, labelWidth: 7, class: 'm-0  mb-md-0 mr-md-1 flex-fill', label: locales.entries.Lcz_NbrOfVehicles, data: this.vehicleCapacity.map(i => ({
                text: i,
                value: i,
            })) }), h("ir-input-text", { key: 'b70be23eef7ead740bf005fd5872a0c2c6af7c30', labelBorder: "theme", readonly: true, value: this.pickupData.due_upon_booking, labelWidth: 7, label: `${locales.entries.Lcz_DueUponBooking}  ${this.pickupData.currency.symbol}`, placeholder: "", class: "" })))), h("div", { key: 'f42f6a454fe6c7ab6326318fa6d637443a0a3b81', class: 'd-flex flex-column flex-sm-row mt-3' }, h("ir-button", { key: '8886a428b4051c0faf07ac4f201304a34d70e286', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `mb-1 mb-sm-0 flex-fill  ${this.defaultPickupData || this.pickupData.location !== -1 ? 'mr-sm-1' : ''}`, icon: "", text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), (this.defaultPickupData || this.pickupData.location !== -1) && (h("ir-button", { key: 'f7d2772458c8ece44b55a15516599997caf938f3', btn_styles: "justify-content-center align-items-center", class: 'm-0 flex-fill text-center', icon: "", isLoading: this.isLoading, text: locales.entries.Lcz_Save, btn_color: "primary", onClick: this.savePickup.bind(this) }))))));
    }
    get el() { return this; }
