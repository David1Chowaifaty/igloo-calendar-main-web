...
const IrModal = /*@__PURE__*/ proxyCustomElement(class IrModal extends HTMLElement {
    ...
    render() {
        return [
            h("div", { key: 'cf65a31eff742a483f6ae60ddbe3564faefccd2d', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'b06452990893e81a80c5e6316fd9c00ef836c26b', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'bf1c8362ddf39c9a98b58cecfbba09f46a7dce7a', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '8bd705081c4e3ccd51d76d6c03a3e7ae15508d1a', class: `ir-alert-header` }, h("p", { key: 'e443db509323b082501db3e40afedc615be0c783' }, this.modalTitle))), h("div", { key: '177d4056b5ac92df7e2233b800366f89b0d2a4f7', class: "modal-body text-left p-0 mb-2" }, h("div", { key: 'd8ab5a8b4c857a331d654e04b34f33cd62a89b92' }, this.modalBody)), h("div", { key: 'f9d7d6f8c6716f2441a190e45a3953f64291fb4e', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '9dfb26cb024e1ebd7023ee30308e39ba53230b10', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.rightBtnActive && (h("ir-button", { key: '4af48d3ece6678d40503f3fcecd2e17a4c60ed3f', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
