...
const IrActionsCell = /*@__PURE__*/ proxyCustomElement(class IrActionsCell extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
...
function defineCustomElement() {
    ...
    const components = ["ir-actions-cell", "ir-custom-button"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-actions-cell":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrActionsCell);
            }
            break;
...
export { IrActionsCell as I, defineCustomElement as d };

//# sourceMappingURL=ir-actions-cell2.js.map