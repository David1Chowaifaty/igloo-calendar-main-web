...
const IrTasksCard = /*@__PURE__*/ proxyCustomElement(class IrTasksCard extends HTMLElement {
    ...
    render() {
        return (h("wa-card", { key: '0c51f3729ec129f5e220a9a8c1101206e6b47f62', class: "task-card" }, h("div", { key: '5876175555f82a4381a521f0689f2e14fc0caf70', class: "task-card__body" }, h("div", { key: '122e8d8839fca4941795ab66ef28f3cdf847c075', class: "task-card__unit" }, h("span", { key: 'd2f89826f9d655c5cbb0b85948c4553a86a1bc3b', class: "task-card__unit-name" }, this.task.unit.name), h("div", { key: 'bfed771fc30088aaaae1979bb2f6e5a14f2be126', class: "task-card__meta" }, h("span", { key: '660919986ccf1a6de83499e7602d1aeeb909692b', class: "task-card__status" }, this.task.status.description), this.task.hint && h("span", { key: '051a252192ea7ea98a616844950338c790ed7f1c', class: "task-card__sep" }, "\u00B7"), this.task.hint && h("span", { key: 'c993ffc8e355f7e312514cab6b3dd32b5889bbb0', class: "task-card__hint" }, this.task.hint))), h("div", { key: '9250850ddeac88d4ce705cd705488925287d04b9', class: "task-card__badges" }, this.taskTypeBadge(this.task.task_type?.code), this.task.extra_task?.map(et => this.taskTypeBadge(et.task_type?.code))), this.guests.length > 0 && (h("div", { key: '553cc4c780cee279c2c93b3a550138907e212c37', class: "task-card__guests" }, this.guests.map(g => (h("div", { class: "task-card__guest" }, h("wa-icon", { name: g.icon, class: "task-card__guest-icon", style: { fontSize: `${Math.min(0.75 + g.count * 0.15, 1.4)}rem` } }), h("span", { class: "task-card__guest-count" }, g.count)))))), h("div", { key: '107dd1240989e7127aeb1e1685765c4758a7301f', class: "task-card__assign" }, h("wa-select", { key: 'f355533c75ac7669a1a3a740fe71d2b5b9d21474', label: "Housekeeper", class: "task-card__hk-select", size: "small", placeholder: "Unassigned", value: this.task.hkm_id ? String(this.task.hkm_id) : '0', defaultValue: this.task.hkm_id ? String(this.task.hkm_id) : '0', onchange: e => {
                const hkm_id = Number(e.target.value);
                this.assignHousekeeper.emit({ task: this.task, hkm_id });
            } }, h("wa-option", { key: '93e7c83f4042042c7c23eb6724e763d1d7aa54e7', value: "0" }, locales.entries.Lcz_Unassigned), housekeeping_store.hk_criteria?.housekeepers
            .slice()
            .sort((a, b) => a.name.localeCompare(b.name))
            .map(hk => (h("wa-option", { key: hk.id, value: String(hk.id) }, hk.name))))), h("div", { key: '13e65c30752ea79ff97b8b75bdfb05793a93ab2e', class: "task-card__actions" }, this.isSkippable && (h("ir-custom-button", { key: 'c2127e95ff80e486ca7d0f1a04fc62644fecc255', variant: "neutral", appearance: "outlined", onClickHandler: () => this.skipSelectedTask.emit(this.task) }, "Skip")), this.isCheckable && (h("div", { key: '9dd302d71e23d5e53a90a456401a2f87cea5920d', class: "task-card__clean-group" }, h("ir-custom-button", { key: '7441a1438b035f8d9241911f3a7e3be42abdeb08', variant: "brand", appearance: "filled", onClickHandler: () => {
                toggleTaskSelection(this.task);
                this.cleanSelectedTask.emit({ task: this.task, status: '004' });
            } }, "Clean & Inspect"), h("ir-custom-button", { key: 'b3adf27e5d0f56b4f8e8a5b155e005d8f1ef6829', variant: "brand", appearance: "accent", onClickHandler: () => {
                toggleTaskSelection(this.task);
