...
import { b as _formatAmount, c as colorVariants, d as _getDay } from './icons.js';
...
const IrRoom = /*@__PURE__*/ proxyCustomElement(class IrRoom extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '4f9f10776e8d23d9b3d07cc10c1ec107ead37208', class: "p-1 d-flex m-0" }, h("ir-button", { key: '265ddf41ede4f0fe03784ccef083fbfaf4cffc19', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
            ...
            }), h("tr", { key: '6eb93a962d87e994bbc046d7c7663c4c056f17d9' }, h("th", { key: '8f30f2067af2433b08f9d4250b3e477d20489f3c', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), h("th", { key: '49b3887f4623d8e2925929b8529c53ee58120965', class: "text-right" }, _formatAmount(this.item.total, this.currency)), this.item.gross_cost > 0 && this.item.gross_cost !== null && h("th", { key: '8527a2a411033b5a3ede272f81b75496c5e1bb5c', class: "pl-2 text-right night-cost" }, _formatAmount(this.item.cost, this.currency))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
