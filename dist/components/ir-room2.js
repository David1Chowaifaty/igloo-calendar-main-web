...
const IrRoom = /*@__PURE__*/ proxyCustomElement(class IrRoom extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '07408077b814158a6deec74a49ab2350617dc27c', class: "p-1 d-flex m-0" }, h("ir-button", { key: '959da430c1894949df4144f03ffbfeb5a7778854', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
            ...
            }), h("tr", { key: '370d46feac6f823f100c2d4a13f0376e69fc0a25', class: '' }, h("th", { key: 'c2df3b1ee2d040c55524f845dc5502764f35efa8', class: "text-right pr-2 subtotal_row" }, this.defaultTexts.entries.Lcz_SubTotal), h("th", { key: '7a4d108a4bbdb4a793a29d25539bad3f34e7c45f', class: "text-right subtotal_row" }, _formatAmount(this.item.total, this.currency)), this.item.gross_cost > 0 && this.item.gross_cost !== null && h("th", { key: '1500bf7c309c9448517b8cdfa3d60b59b9d581ad', class: "pl-2 text-right night-cost" }, _formatAmount(this.item.cost, this.currency))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
