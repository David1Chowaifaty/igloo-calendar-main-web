...
const IrRoom = /*@__PURE__*/ proxyCustomElement(class IrRoom extends HTMLElement {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: 'a87483b7d1e27dd3d7be5d98bb4c8aeb654c079e', class: "p-1 d-flex m-0" }, h("ir-button", { key: '0e12711c8aa29371c68ffb0219d931a35bab9cf7', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '35aa48d4283df4fe666e3280079eb5c4d840f7b2', class: "flex-fill m-0 " }, h("div", { key: '8e0281f448abca17bad410dcf076538946c12573', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: 'd913fe107514155420122a1197ef8835ecb69439', class: "m-0 p-0" }, h("strong", { key: '1a9dba40ad941e26c86be04d2d809e9342daf191', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '8e79b855e491c9e04fbc594229ccd3aa59df868d', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: '38c0ad42dec02284b433bfcf6e24995658c1c259', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: 'cdbc0254672d53d0361dfd4550f2cec7b91a9040', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHanlder: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '173a83fcda242f60a0d4247b699a8b64173e0b5e', variant: "icon", onClickHanlder: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: 'c1c0ab61ec99fc558c1029fd10fc9f6afb5f5510', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: 'f70afc149b264b10d45f27539e05529aeb902fa4', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && h("ir-button", { key: 'c3ea0252296f1520a11fc959047bbefa43fc36cf', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && h("ir-button", { key: '0e148907ae77c3a72b45a4dd697059aa6f76b8a9', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !isSingleUnit(this.item.roomtype.id) && calendar_data.is_frontdesk_enabled && this.item.unit && (h("div", { key: 'd01e989054a76d4f85c05c1e7e5aba4e75ccd428', class: 'd-flex justify-content-end' }, h("span", { key: '243e16e82365fcc9a432fb029f7849cfbe20b135', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), h("div", { key: '40369c5007bd5d14f8a10c35e0fc3ca37f837899' }, h("span", { key: '1b59de5f388aaacc39d4c580f20060b19eb2294c', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && h("span", { key: 'c56b5c046b89f1cf6b2a2bb390da6c23f4cc6081' }, " ", this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy))), h("div", { key: 'b1b489d8cc12ba24c11d0156ecec1ad6ccc124ab', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, h("div", { key: '2cf6d62a676618c8e3795ea105e78626d850a823', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '1a4251d12c89bb4f257e641450ae1141b16f0495', class: " sm-padding-top" }, h("strong", { key: 'd1198b60afb518fbc1e4c70a1c0530ab70d5fc52', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), h("div", { key: 'd95e2686b57052cbc4c581628556b06bd6de634f', class: 'flex-fill' }, h("table", { key: 'f24dc932c6e284e6679f3763d452e3a122ad4e7d' }, this.item.days.length > 0 &&
            ...
            }), h("tr", { key: '05aea3620609927f58966e5ba7301132c334b627', class: '' }, h("th", { key: '099575da9d456f396eab3e1dfd0c0d7f5103940f', class: "text-right pr-2 subtotal_row" }, this.defaultTexts.entries.Lcz_SubTotal), h("th", { key: '86be0e1bef2c7157d2aaa91c6cc780e24d0cbb84', class: "text-right subtotal_row" }, formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && h("th", { key: 'a6942353a7f3677115d71f5cafd3b4539c36643d', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
        ...
        //   </span>
        // </div>
        h("div", { key: 'ea55da88adc617a5b46ea6fc5c573e6ffe664579', class: "room_statements" }, h("span", { key: '390266966606d4527f2216d46ed97cfd3f994b87' }, h("b", { key: '3bf2c8a07d0bc5fafd056ffbe59d8d775cc1a889' }, this.defaultTexts.entries.Lcz_Cancellation, ":"), h("span", { key: 'c25a588abfe65328b5eb591da4b05eb086b138c9', innerHTML: this.item.rateplan.cancelation || '' })))), this.item.rateplan.guarantee && (h("div", { key: '2aec248a2aa2c8f65ab8aa61c14d744ef578c98a', class: "sm-mb-1" }, h("span", { key: '8e8b79cd68be8ed7871eb443ac8da942fdc51267' }, h("b", { key: '0d95be6c80e7fabe3d6721ab7d382e1c23fa0bda' }, this.defaultTexts.entries.Lcz_Guarantee, ": "), h("span", { key: 'e7ddf1666894fa417cb1c3d99546f04f771cfa09', innerHTML: this.item.rateplan.guarantee || '' })))), this.bookingEvent.is_direct && h("ir-label", { key: '365cbd827add3b0726cc3b99939782fbd25de18a', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), h("ir-modal", { key: '6ab7aca2426875546671be8ee8ee7d37df30041f', autoClose: false, ref: el => (this.irModalRef = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
