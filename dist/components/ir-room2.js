...
`;
    ...
    render() {
        var _a, _b, _c, _d;
        return (h(Host, { key: '98e723bad75da5367db19a9f5a1c38128282e874', class: "p-1 d-flex m-0" }, h("ir-button", { key: '739a27992ec8fd788b8acdaafffb071162c03061', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.room.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '0d6d6afbd24432751d3808bcdb71ff9dc271a07b', class: "flex-fill m-0 " }, h("div", { key: 'ff67241691210cec166d6e72952226acf94c0d10', class: "d-flex align-rooms-start justify-content-between sm-mb-1" }, h("p", { key: '0cca58757a55f0f7ea601c09d37de121f984e16d', class: "m-0 p-0" }, h("span", { key: 'a87ca01b0dbf49bc212c3cd7a634acc5847bb6bd', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: 'cb13e089585ce3f26bca140d80dc5d015dc99d2d', class: "d-flex m-0 p-0 align-rooms-center room_actions_btns" }, h("span", { key: '4afe7d066e38fb2d01047baa95d39216c7ee6e85', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.room['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: 'dc0ea0ba1df1bf19a4330b36bee93d3ade5e0a1a', id: `roomEdit-${this.room.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '6c82931e1577418d4b60d8ea0ae5bf2dfe784170', variant: "icon", onClickHandler: this.openModal.bind(this, 'delete'), id: `roomDelete-${this.room.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: '9f7550f87d173bc010422223a90b928674800ef4', class: "d-flex align-rooms-center sm-mb-1" }, h("ir-date-view", { key: 'adab00d3b48aae4fec813845ad5ea64b7b5718e0', class: "mr-1  flex-grow-1", style: { width: 'fit-content' }, from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (h("div", { key: '9f0bfd9e3f66cb717c381e1fffd3454b8ebebb0c', class: 'd-flex justify-content-center align-items-center' }, h("ir-tooltip", { key: '3c95d8cc93784f5b9852af916138b628def2ce97', message: this.room.unit.name, customSlot: true }, h("span", { key: 'f82d7bef5781eb9200117afe40c06b069c1b431a', slot: "tooltip-trigger", class: `light-blue-bg  ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.room.unit.name)))), this.hasCheckIn && (h("ir-button", { key: 'b1acf26e6d245cd81674a88cde3f82145c82eae3', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckIn })), this.hasCheckOut && (h("ir-button", { key: '7b051a6b895cbf23a24a21fcaced882ac41cc85d', onClickHandler: this.openModal.bind(this, 'checkout'), id: "checkout", btn_color: "outline", size: "sm", text: locales.entries.Lcz_CheckOut }))), h("div", { key: '0b244ef29c3bce26cc2b24d75680dd443783cdd0', class: 'd-flex align-items-center' }, h("span", { key: 'bb509ee75e40b48a2a3c77fc5c58491b0b19ca46', class: "mr-1" }, `${((_b = this.mainGuest) === null || _b === void 0 ? void 0 : _b.first_name) || ''} ${((_c = this.mainGuest) === null || _c === void 0 ? void 0 : _c.last_name) || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h("ir-button", { btn_color: "link", renderContentAsHtml: true, onClickHandler: () => this.showGuestModal(), size: "sm", btn_styles: "room_guest_name", text: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) })) : (h("span", { innerHTML: this.formatVariation(this.room.rateplan.selected_variation, this.room.occupancy) }))), this.room.bed_preference && h("span", { key: '6284b11274ecd835cce38f4d0ed2163274cb6b43' }, "(", this.getBedName(), ")")), h("div", { key: '474f1a87aa50541880d4c1774c89df665c1c125a', class: "collapse", id: `roomCollapse-${(_d = this.room.identifier) === null || _d === void 0 ? void 0 : _d.split(' ').join('')}` }, h("div", { key: '503dfce346b12e718a1040e24a1f20ff9efe6cd4', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '2f2e3eef2a4357eebddf75f103284cbcdb9d51f1', class: " sm-padding-top" }, h("p", { key: '7d055302418f9974e9f3f375ce611603baf59da1', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: '987d85d8692dbe31550356854c1185275a09bffb', class: 'flex-fill' }, h("table", { key: 'fcd67ac9d5e9aeb73fe9005eac26b3b433eb96ec' }, this.room.days.length > 0 &&
            ...
            }), h("tr", { key: '996646c47d63f8eb69a65569ba8681797e3f0865', class: '' }, h("th", { key: '8db575e1ff9888a27ba49662c8046d2f5d9fc95d', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '805fc4efc6aa4a503d58a97f6fa44783bc7dfa4b', class: "text-right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && h("th", { key: 'e661c0b1f6817d38625707162a62136f62779e8e', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.room.cost))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), this.booking.is_direct && (h(Fragment, { key: 'a6ed9957cb94902d4f281a5c766dc18a80abaa88' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'e5e1c4a049430c586c099ba4e97887d5e894c32e', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '7b7668be6aaabdaa5c41c5e24402a12c2d02cbd7', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))))), h("ir-modal", { key: '8eaf20ee805196ec1b01c7752149292147a5f3d3', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.handleModalConfirmation.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm, leftBtnColor: "secondary", rightBtnColor: this.modalReason === 'delete' ? 'danger' : 'primary', modalTitle: locales.entries.Lcz_Confirmation, modalBody: this.renderModalMessage() })));
    }
    showGuestModal() {
        var _a;
        const { adult_nbr, children_nbr, infant_nbr } = this.room.occupancy;
