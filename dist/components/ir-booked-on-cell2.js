...
const IrBookedOnCell = /*@__PURE__*/ proxyCustomElement(class IrBookedOnCell extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '35ca51a29536ef70366b655031443a1cce8d80ea' }, this.label && h("p", { key: 'ced8f819636055a6ddfec64e2c57b9cf945b154b', class: "cell-label" }, this.label, ":"), h("p", { key: 'cc6362c7c6745a0549395a5c1f9142202adbdbc1', class: "booked-on-cell__date" }, hooks(date, 'YYYY-MM-DD').format('DD MMM YYYY')), h("p", { key: 'c9d85c72fb60ec52ee693bb4b39e3549051f7b2b', class: "booked-on-cell__time" }, _formatTime(hour.toString(), minute.toString()))));
    }
