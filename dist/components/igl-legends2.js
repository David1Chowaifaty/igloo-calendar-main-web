...
function defineCustomElement() {
    ...
    const components = ["igl-legends", "ir-custom-button", "ir-icons", "ir-input-text", "ir-new-badge", "ir-success-loader"];
