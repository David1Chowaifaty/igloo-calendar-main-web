...
const IrRoomNights$1 = /*@__PURE__*/ proxyCustomElement(class IrRoomNights extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-room-nights":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrRoomNights$1);
            }
            break;
        case "ir-button":
            if (!customElements.get(tagName)) {
...
const IrRoomNights = IrRoomNights$1;
