...
const IrPaymentOption = /*@__PURE__*/ proxyCustomElement(class IrPaymentOption extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-payment-option":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrPaymentOption);
            }
            break;
        case "ir-button":
            if (!customElements.get(tagName)) {
...
export { IrPaymentOption as I, defineCustomElement as d };

//# sourceMappingURL=ir-payment-option2.js.map