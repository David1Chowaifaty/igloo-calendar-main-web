...
const IrHkTeam = /*@__PURE__*/ proxyCustomElement(class IrHkTeam extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '3bb3670e6a44435ba6fd3e5b5580736e56414f07', class: "card p-1" }, h("section", { key: '77f827eb11d64133d45d1a3ac545316131763674' }, h("ir-title", { key: '56cc7c7211c7ac64243fe35fc918aa3fb5f11ded', label: locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, h("div", { key: 'e0f0be994de499c8f923edbf4391ba7916f8550c', slot: "title-body", class: "assignments-container gap-16 m-0" }, h("p", { key: 'd7c77a4fb154dd3c85f86a01fe0762457cb051b9', class: "font-weight-bold m-0 p-0" }, total, " ", locales.entries.Lcz_TotalUnits), h("p", { key: 'a20ef2f5eeb3642b371860eb85e0e6468f767e5e', class: 'm-0 p-0' }, assigned, " ", h("span", { key: '09100800e882639cfe1fe8a812e144bcae4e42ff' }, locales.entries.Lcz_Assigned)), un_assigned > 0 && (h("button", { class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales.entries.Lcz_Unassigned)))), h("p", { key: '62aaf71aff4a21e68f9dcf0954fb56ab95025abd', class: 'm-0 p-0' }, locales.entries.Lcz_AsAnOption)), h("section", { key: '731d65381d91bb60ac71529dceeef93a8c0be940', class: "table-container" }, h("table", { key: '8e6586eb481b475b71552d9c12f737e848d623bc', class: "table" }, h("thead", { key: '36f7a6234c4956667b1aedce1740e2f88c291100' }, h("tr", { key: '514350e1a634b9f1b69af94c5f016a34f0dc481b' }, h("th", { key: 'e6e3eea7622c7f9ecfa3e955b3c45ce3e01eda6a', class: "text-left" }, locales.entries.Lcz_Name), h("th", { key: '398c9a449a3c4a774f55d9593316c491b807c4d0' }, locales.entries.Lcz_Mobile), h("th", { key: '3052beb8dae1cfe9ff210c01a402f672df288530' }, locales.entries.Lcz_Username), h("th", { key: '88809ffc11e086c799d30f04c3ed058d50a4e87f' }, locales.entries.Lcz_Note), h("th", { key: '7a1297cfe11366d8339b5b8f78fcd2ca9ecea1eb' }, locales.entries.Lcz_UnitsAssigned), h("th", { key: '5d64aa6baf8c046163066db4e0351594b8bfdd93', class: "text-center" }, h("ir-icon", { key: '7601c75ba6e5c78a1df6f572b0330a0ccd996cfd', title: locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, h("svg", { key: 'ef7a0fd8bc18519bd70b457912fb432ae4555b5c', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: 'c15fd2e8ed2731e4e431ccdb5d49a98b54237c6e', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), h("tbody", { key: 'b93fceb1e49ff7b4bc84a7baf828ab48326e9181' }, housekeeping_store.hk_criteria.housekeepers.map(hk => (h("tr", { key: hk.id }, h("td", { class: "text-left" }, hk.name), h("td", null, hk.phone_prefix, " ", hk.mobile), h("td", null, hk.username), h("td", null, hk.note), h("td", null, this.renderAssignedUnits(hk)), h("td", { class: "text-center" }, h("div", { class: "icons-container" }, h("ir-icon", { title: locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
