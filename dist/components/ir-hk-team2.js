...
const IrHkTeam = /*@__PURE__*/ proxyCustomElement(class IrHkTeam extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '87145b928467148d056a7a59993e71628a2e6448', class: "card p-1" }, h("section", { key: '83369c2be659bfbda14f4ea9e0e66e21dd03d6a2' }, h("ir-title", { key: 'aeed7bb51204f085af4acf8d8fd85ca9bc8b74e3', label: locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, h("div", { key: 'cfd9b336957f867001ff1672d4526534bf76f751', slot: "title-body", class: "assignments-container gap-16 m-0" }, h("p", { key: '751ed8bfca49b67809708c2df89d230185886b03', class: "font-weight-bold m-0 p-0" }, total, " ", locales.entries.Lcz_TotalUnits), h("p", { key: 'ac1fbaf21d719899c4e77d79b4479c6bb2f1cd90', class: 'm-0 p-0' }, assigned, " ", h("span", { key: 'e7d7647756afd9eb16ac4fa146079d9f384589a7' }, locales.entries.Lcz_Assigned)), un_assigned > 0 && (h("button", { key: '5ba20f55867365f3c7c97c8fbf37a98f78744da3', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales.entries.Lcz_Unassigned)))), h("p", { key: '0592fd7cf4575a7289ac81c504aa802ff06a4b5f', class: 'm-0 p-0' }, locales.entries.Lcz_AsAnOption)), h("section", { key: '6f6dc7fca898a4ca759d3625ab970ab62dddf1b4', class: "table-container" }, h("table", { key: '4d3be2303952064b73163f0bec62f527f01c6a75', class: "table" }, h("thead", { key: '704312dad2a743163c6a619378cc7ef3b3fa9876' }, h("tr", { key: 'd5b35caf0086002eff2182b7454db4b1008b4c08' }, h("th", { key: '246c0b70109d6b9871e6af8b5518e7f2390fdd74', class: "text-left" }, locales.entries.Lcz_Name), h("th", { key: 'da661ac108c141f21786fd81ac8584c86637a1ad' }, locales.entries.Lcz_Mobile), h("th", { key: 'b8ebbd36a5b7dde72d38f73b9abd58c85c9b0128' }, locales.entries.Lcz_Username), h("th", { key: '035d14c6ded07b510dbf48ce1c2a44b4ef5f7fd5' }, locales.entries.Lcz_Note), h("th", { key: '16d6a08b98c9804c57ec67edd2dc40fd8ed28669' }, locales.entries.Lcz_UnitsAssigned), h("th", { key: '795ef067e04a8dede2e77ea96c4ccc2cd3cfee64', class: "text-center" }, h("ir-icon", { key: 'b303e26fcb92d095396182f5ebe154da205ed7d7', title: locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, h("svg", { key: '455057781361dec313e9fe6d5b8691c655348ac1', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: 'fe157b571dcd0cbe2edbe96dc8b71dc6255f6412', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), h("tbody", { key: '8863f271573e888fbe125c9f5d2e5e74834ea8b3' }, housekeeping_store.hk_criteria.housekeepers.map(hk => (h("tr", { key: hk.id }, h("td", { class: "text-left" }, hk.name), h("td", null, hk.phone_prefix, " ", hk.mobile), h("td", null, hk.username), h("td", null, hk.note), h("td", null, this.renderAssignedUnits(hk)), h("td", { class: "text-center" }, h("div", { class: "icons-container" }, h("ir-icon", { title: locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
