...
const IrHkTeam = /*@__PURE__*/ proxyCustomElement(class IrHkTeam extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '1530453c1cb5e7ce46128d139eff9bd75a8cd346', class: "card p-1" }, h("section", { key: '0cb423b77b395d24d3b945a61e6a62b252456383' }, h("ir-title", { key: '489adaa445743b338bf539de459e61886ee232ee', label: locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, h("div", { key: '9ecc9abc6827d36002ba9c8c819d3447a50cd15f', slot: "title-body", class: "assignments-container gap-16 m-0" }, h("p", { key: '8ad78c385baf07a4ec4b43e049f60fecda2a29c7', class: "font-weight-bold m-0 p-0" }, total, " ", locales.entries.Lcz_TotalUnits), h("p", { key: 'f40b7d3ff12d52ed60138f85e3338cd060b7cb41', class: 'm-0 p-0' }, assigned, " ", h("span", { key: '5b94eb2be1b1e265d2681494d104595c1c7351dc' }, locales.entries.Lcz_Assigned)), un_assigned > 0 && (h("button", { key: '1a210137276cfb37865c904e113b544dbd96aec4', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales.entries.Lcz_Unassigned)))), h("p", { key: '37fa3ab9682f2cdbdd52b518e3173340813dda85', class: 'm-0 p-0' }, locales.entries.Lcz_AsAnOption)), h("section", { key: 'bdbb861fee0dd8252efecfc876188bbd918cff16', class: "table-container" }, h("table", { key: 'd8cabf104c463094bd76f8813225211c4fabc1fd', class: "table" }, h("thead", { key: 'e779f33104180358ce21088950687caa7dc2a76f' }, h("tr", { key: 'd66825b468d84c0ade4d1bd26c2c04e168abee82' }, h("th", { key: 'cbbe5692103e6d0e81f864705747188fa8832dad', class: "text-left" }, locales.entries.Lcz_Name), h("th", { key: 'c4eaf46840efd5d5ea05437065730979a863f66b' }, locales.entries.Lcz_Mobile), h("th", { key: 'a35667c350d9326cacaae05b7feda4302427b4ec' }, locales.entries.Lcz_Username), h("th", { key: '4850ef337b8fec835b1bb6d3cbe0678b3fa7b305' }, locales.entries.Lcz_Note), h("th", { key: '210c6e213b6071d1e4e7ad53f1cfb4e47bdd3a88' }, locales.entries.Lcz_UnitsAssigned), h("th", { key: '7be84c45ed691bb03fed805cd7991355165fd198', class: "text-center" }, h("ir-icon", { key: '494e30c4e4572c3972f7d0a2d10683099243ad92', title: locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, h("svg", { key: '6b295724d3a580e91b334c257a5258d5007a5965', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: '6e1bd575ac5a9e9ba653acae5c008422f615e7ef', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), h("tbody", { key: '41934effbb6c70361a2b47500fd0328cb14cfb56' }, housekeeping_store.hk_criteria.housekeepers.map(hk => (h("tr", { key: hk.id }, h("td", { class: "text-left" }, hk.name), h("td", null, hk.phone_prefix, " ", hk.mobile), h("td", null, hk.username), h("td", null, hk.note), h("td", null, this.renderAssignedUnits(hk)), h("td", { class: "text-center" }, h("div", { class: "icons-container" }, h("ir-icon", { title: locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
