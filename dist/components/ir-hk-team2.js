...
const IrHkTeam = /*@__PURE__*/ proxyCustomElement(class IrHkTeam extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'ed4c5b5988151e34afd212b0b8b849367a7f0d8e', class: "card p-1" }, h("section", { key: '38d3e909690d2bc2a3954a3fb9002b7fbc74195f' }, h("ir-title", { key: 'b97f0b932aa44b0bbba60c53f7513d07ae2e773a', label: locales.entries.Lcz_HousekeepingTeam, justifyContent: "space-between" }, h("div", { key: 'b6dafdb86489196786863b804e3af1d1b26a43bb', slot: "title-body", class: "assignments-container gap-16 m-0" }, h("p", { key: '0b4c0107cb7e1f8c11373ae2fbe18c999edfc714', class: "font-weight-bold m-0 p-0" }, total, " ", locales.entries.Lcz_TotalUnits), h("p", { key: '2bb08e28fc2a36234f0a43b56c3d6038d764082e', class: 'm-0 p-0' }, assigned, " ", h("span", { key: '718ec2ce7651d9996d04b8f0fc22bf3413da74f1' }, locales.entries.Lcz_Assigned)), un_assigned > 0 && (h("button", { key: '1277069068f09bb3758c072b8e3a645fb290f933', class: "outline-btn", onClick: () => (this.currentTrigger = { type: 'unassigned_units', user: null }) }, un_assigned, " ", locales.entries.Lcz_Unassigned)))), h("p", { key: '598382990a9c268718bd257bf2dc4cc19b1aec7b', class: 'm-0 p-0' }, locales.entries.Lcz_AsAnOption)), h("section", { key: 'c41f2669cacef74ec9d469b94c38e66a87814598', class: "table-container" }, h("table", { key: '903acbeb5b984bc66589f1f45539da3edbeb7557', class: "table" }, h("thead", { key: 'a53d9c9902cef27b9b13d9a09e785bccbd61b7b2' }, h("tr", { key: '9b618a238252e63ec05bd2273ef2cd426bbf22b3' }, h("th", { key: '1a2e4934d3dc66b6b2763615dc1d71986d192b9f', class: "text-left" }, locales.entries.Lcz_Name), h("th", { key: 'c590253c107e37b27b61551689d24ebdeb33daf6' }, locales.entries.Lcz_Mobile), h("th", { key: '97822060a67215148ac41995ec4ce6a410f9a5ef' }, locales.entries.Lcz_Username), h("th", { key: 'ac5389502b1159360ce9817e45351f613898e2f2' }, locales.entries.Lcz_Note), h("th", { key: 'ae010fade70dfd6ae65086fc2b6d3524fc82c0e1' }, locales.entries.Lcz_UnitsAssigned), h("th", { key: '3a98051a0921b13c919dcab8d8be7f150f3568ea', class: "text-center" }, h("ir-icon", { key: '7e4bffd4d207d26644197625bd2e0a9957d17ff6', title: locales.entries.Lcz_CreateHousekeeper, onIconClickHandler: () => {
                this.currentTrigger = {
                    type: 'user',
                    isEdit: false,
                    user: null,
                };
            } }, h("svg", { key: '2e635f5c7e0f0e7554b2ef1fe7895243967f9ff2', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "17.5", viewBox: "0 0 448 512" }, h("path", { key: '226dd511eeedd841775df5d87c5b3ad0d1ade887', fill: "currentColor", d: "M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" })))))), h("tbody", { key: 'a8c7069590d883cec5e339cad7a2b428c105006b' }, housekeeping_store.hk_criteria.housekeepers.map(hk => (h("tr", { key: hk.id }, h("td", { class: "text-left" }, hk.name), h("td", null, hk.phone_prefix, " ", hk.mobile), h("td", null, hk.username), h("td", null, hk.note), h("td", null, this.renderAssignedUnits(hk)), h("td", { class: "text-center" }, h("div", { class: "icons-container" }, h("ir-icon", { title: locales.entries.Lcz_EditHousekeeper, onIconClickHandler: () => {
