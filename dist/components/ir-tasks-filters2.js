...
const IrTasksFilters = /*@__PURE__*/ proxyCustomElement(class IrTasksFilters extends HTMLElement {
    ...
    render() {
        ...
        return (h("div", { key: '8db2222f4f836869e0b4fe665d6f9af4eee8a686', class: "card mb-0 p-1 d-flex flex-column" }, h("div", { key: '9f3e61f6b20a63901a2a79aa97ce99960ee5ef01', class: "d-flex align-items-center justify-content-between" }, h("div", { key: '755ea45480f861fc497c9ebf57694a34a76c135b', class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("svg", { key: 'dc6b979f62b6dec00bfd7d94cd229f2e36708098', xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", height: 18, width: 18 }, h("path", { key: '227bdf0b2e9f76bdee9f1148f4d1b4b7b5c68e04', fill: "currentColor", d: "M3.9 54.9C10.5 40.9 24.5 32 40 32l432 0c15.5 0 29.5 8.9 36.1 22.9s4.6 30.5-5.2 42.5L320 320.9 320 448c0 12.1-6.8 23.2-17.7 28.6s-23.8 4.3-33.5-3l-64-48c-8.1-6-12.8-15.5-12.8-25.6l0-79.1L9 97.3C-.7 85.4-2.8 68.8 3.9 54.9z" })), h("h4", { key: 'f0c1024c90f1ef850b0a10b875e6af59cc537e0d', class: "m-0 p-0 flex-grow-1" }, locales.entries.Lcz_Filters)), h("ir-button", { key: 'c4a964314d767cead93526395e85a7087f6b7580', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": "#hkTasksFiltersCollapse", "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "hkTasksFiltersCollapse", class: "mr-1 collapse-btn", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } })), h("div", { key: '636c9f6a007daf15bfd7c3f8c788bb468e6b72f6', class: "m-0 p-0 collapse", id: "hkTasksFiltersCollapse" }, h("div", { key: '69d7c79e4ab4e0a8e2ac362246b10cde21eb25fe', class: "d-flex flex-column", style: { gap: '0.5rem' } }, h("fieldset", { key: 'cb25063e2337030109b14c2cffb1ee7b758377ae', class: "pt-1" }, h("p", { key: '94d27acffce9ed5c6addee346e981bcd5f79df61', class: "m-0 p-0" }, locales.entries.Lcz_Period), h("ir-select", { key: '745f0bbdca05785c46a7d367e14ef1d4e0a2d0f1', testId: "period", selectedValue: (_b = (_a = this.filters) === null || _a === void 0 ? void 0 : _a.cleaning_periods) === null || _b === void 0 ? void 0 : _b.code, LabelAvailable: false, showFirstOption: false, data: (_c = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _c === void 0 ? void 0 : _c.cleaning_periods.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_periods: { code: e.detail } });
            } })), ((_d = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _d === void 0 ? void 0 : _d.housekeepers.length) > 1 && (h("fieldset", { key: '76c8cd03b7933762a65de1e160bb23166db4c1a7' }, h("p", { key: '78952b2fd5299cc0adaaf6dc02a2a16f892005f2', class: "m-0 p-0" }, locales.entries.Lcz_Housekeepers), h("ir-select", { key: 'e75d574f7f081c2d3b051bd10c539f68d7dd3ab2', testId: "housekeepers", selectedValue: (_e = this.filters) === null || _e === void 0 ? void 0 : _e.housekeepers, LabelAvailable: false, showFirstOption: false, data: [
            ...
            } }))), h("fieldset", { key: 'd11fd5cb25507cc33add93af4ef1f0aae47bfa37' }, h("p", { key: 'd05870ec2b988a80286f534c833e20744dceec6d', class: "m-0 p-0" }, locales.entries.Lcz_CleaningFrequency), h("ir-select", { key: '5438654f61ec81efc67f726e7d9e942e3ee022dd', testId: "cleaning_frequency", selectedValue: (_h = (_g = this.filters) === null || _g === void 0 ? void 0 : _g.cleaning_frequencies) === null || _h === void 0 ? void 0 : _h.code, LabelAvailable: false, showFirstOption: false, data: (_j = housekeeping_store === null || housekeeping_store === void 0 ? void 0 : housekeeping_store.hk_criteria) === null || _j === void 0 ? void 0 : _j.cleaning_frequencies.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                this.updateFilter({ cleaning_frequencies: { code: e.detail } });
            } })), h("fieldset", { key: 'a946be2d91734ca241110a425b4df0dd85615379' }, h("p", { key: '78e76dac2e453f3e279bad6b0ea7c445731cbfde', class: "m-0 p-0" }, "Include dusty units"), h("ir-select", { key: 'eb792d2b18fb8d9b86a0165065001f38398261b1', testId: "dusty_units", showFirstOption: false, LabelAvailable: false, selectedValue: (_l = (_k = this.filters) === null || _k === void 0 ? void 0 : _k.dusty_units) === null || _l === void 0 ? void 0 : _l.code, data: (_o = (_m = housekeeping_store.hk_criteria) === null || _m === void 0 ? void 0 : _m.dusty_periods) === null || _o === void 0 ? void 0 : _o.map(v => ({
                text: v.description,
                value: v.code,
            })), onSelectChange: e => {
                e.stopImmediatePropagation();
            ...
            } })), h("fieldset", { key: '7d2205fe1e8833a23b2c0a2118704d6c1efd17c4', class: "mb-1" }, h("p", { key: 'efa1950c24b586afd6fe6f20195ae909fd09d37f', class: "m-0 p-0" }, locales.entries['Lcz_HighlightCheck-insFrom']), h("ir-select", { key: '413876cb70ec0ed2d6394553c829c807b12b805a', testId: "highlight_check_ins", selectedValue: (_q = (_p = this.filters) === null || _p === void 0 ? void 0 : _p.highlight_check_ins) === null || _q === void 0 ? void 0 : _q.code, LabelAvailable: false, showFirstOption: false, onSelectChange: e => {
                ...
                text: v.description,
                value: v.code,
            })) })), h("div", { key: 'ab884bd40ef06bde247d64fe2af3ac0faed5f0dd', class: "d-flex align-items-center justify-content-end", style: { gap: '1rem' } }, h("ir-button", { key: 'c9e152019c3585d748c9785920eb451d70c3b14c', btn_type: "button", "data-testid": "reset", text: locales.entries.Lcz_Reset, size: "sm", btn_color: "secondary", onClickHandler: e => this.resetFilters(e) }), h("ir-button", { key: '77689ea42c002baca19636f7f951c75915d83a9f', btn_type: "button", "data-testid": "apply", isLoading: this.isLoading, text: locales.entries.Lcz_Apply, size: "sm", onClickHandler: e => this.applyFiltersEvt(e) }))))));
    }
