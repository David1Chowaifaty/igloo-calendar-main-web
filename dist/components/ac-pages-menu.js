...
const AcPagesMenu$1 = /*@__PURE__*/ proxyCustomElement(class AcPagesMenu extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ac-pages-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AcPagesMenu$1);
            }
            break;
        case "ir-icons":
            if (!customElements.get(tagName)) {
...
const AcPagesMenu = AcPagesMenu$1;
const defineCustomElement = defineCustomElement$1;

export { AcPagesMenu, defineCustomElement };
