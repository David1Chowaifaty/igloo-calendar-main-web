...
import { B as BookingListingService, b as booking_listing, u as updateUserSelection } from './booking_listing.service.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-listing-header", "igl-date-range", "ir-date-picker", "ir-date-view", "ir-icon", "ir-input-text", "ir-select"];
