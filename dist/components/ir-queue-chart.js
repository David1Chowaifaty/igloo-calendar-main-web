...
const IrQueueChart$1 = /*@__PURE__*/ proxyCustomElement(class IrQueueChart extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    render() {
        return (h(Host, { key: 'b0b6e2d9fff9911a78bec8bd30df967f624ac94b' }, h("div", { key: '78931ad7cc9e2d5824fdc4a19604e37c88431ea3', class: "chart-container" }, h("canvas", { key: '27bc6e7987b6f1fe735432fe3e0030afe9140f0a', ref: el => (this.canvas = el) }))));
    }
    static get watchers() { return {
        "values": ["dataChanged"],
        "labels": ["dataChanged"]
    }; }
    static get style() { return IrQueueChartStyle0; }
}, [0, "ir-queue-chart", {
        "labels": [16],
        "values": [16],
        "label": [1]
...
function defineCustomElement$1() {
    ...
    const components = ["ir-queue-chart"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-queue-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrQueueChart$1);
            }
            break;
    } });
}

const IrQueueChart = IrQueueChart$1;
const defineCustomElement = defineCustomElement$1;

export { IrQueueChart, defineCustomElement };
