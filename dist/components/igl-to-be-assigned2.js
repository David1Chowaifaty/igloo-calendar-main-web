...
const IglToBeAssigned = /*@__PURE__*/ proxyCustomElement(class IglToBeAssigned extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '525cf4793b25facfe26a75fc0a896104658d853f' }, h("div", { key: '466007f2c9622d9d4ef1547503bb35df63488c9d', class: "tba-panel" }, h("div", { key: 'a169e5eb02c96b501cb1abad3aea0f949f4fb1fc', class: "tba-panel__head" }, h("header", { key: '704839d86300193153f8b865554c8e7d3a4ccd6f', class: "tba-panel__header" }, h("h2", { key: '74d457f21f1a9a5a258e5650ef899e69a5567e57', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: '80003d0a9e4b48b5d5c9ea8b39b1afa636fc4456', size: "medium", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: '313ebaa365b82a6651d07bf5802be004492836be', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: 'ced76ac503855df6bfcadfdc89e0b6d4c73d7a05', class: "tba-panel__toolbar" }, h("wa-select", { key: '495e42c33a4d8484d728b27e6e85e1f830565d2d', size: "small", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: 'cd9e79aeaa010958194549abf4ffe32897bb077a', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
