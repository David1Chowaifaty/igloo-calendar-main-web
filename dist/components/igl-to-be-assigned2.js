...
const IglToBeAssigned = /*@__PURE__*/ proxyCustomElement(class IglToBeAssigned extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '3576a25daf06721f844766f99645351c1f34cfa4' }, h("div", { key: 'ad03987590cbfb21518aa595d298598c130247e2', class: "tba-panel" }, h("div", { key: '387f23d2a50efdd2ef6560fabe29487af1685fa7', class: "tba-panel__head" }, h("header", { key: '0c1290d373b34d680d4049f7fd47bd15099b0792', class: "tba-panel__header" }, h("h2", { key: '7ce68bb53f0d0ba55ae0ac6ee898ebdbfdf79e09', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: '1cf96f156744e30df5ae8e7ddb81945591f0ca6e', size: "medium", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: '468dc2ba504361869ae5320b3fe9bb5ea214aec1', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: '6af619cc633ffc28bfdbcc70fa23d8bb45f16255', class: "tba-panel__toolbar" }, h("wa-select", { key: '728e5f1678f564406649203a55e5e79fe060e1fc', size: "small", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: 'ad2039409b1c82bca606e3652ea3358b2aec23bb', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
