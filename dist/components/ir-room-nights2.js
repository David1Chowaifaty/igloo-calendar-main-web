...
import { n as getDaysArray, g as getCurrencySymbol, o as convertDatePrice, p as formatDate } from './utils.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-room-nights", "ir-button", "ir-icon", "ir-loading-screen"];
