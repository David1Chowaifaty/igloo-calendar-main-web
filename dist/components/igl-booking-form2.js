...
const IglBookingForm = /*@__PURE__*/ proxyCustomElement(class IglBookingForm extends HTMLElement {
    ...
    render() {
        return (h("div", { key: 'c25ad3074bdab1d651b309c85a100d6b9e35d767', class: "d-flex flex-column h-100" }, h("div", { key: 'c8fd2327e00aba7911c8d59ccf623cbf1b7ff6b4', class: "d-flex flex-wrap" }, h("ir-date-view", { key: '4a26dfd2c1c2be7ee12e70fff433978c3dc0211d', class: "mr-1 flex-fill font-weight-bold font-medium-1", from_date: new Date(this.dateRangeData.fromDate), to_date: new Date(this.dateRangeData.toDate), dateOption: "DD MMM YYYY" }), this.guestData.length > 1 && (h("div", { key: 'b53ab8b27ae01822b2d5f17d8a1fb7bc83296207', class: "mt-1 mt-md-0 text-right" }, locales.entries.Lcz_TotalPrice, " ", h("span", { key: '87baa0fe1c18d920426bf797231923e66a284ba2', class: "font-weight-bold font-medium-1" }, formatAmount(this.currency.symbol, this.bookingData.TOTAL_PRICE || '0'))))), Object.values(booking_store.ratePlanSelections).map(val => Object.values(val).map(ratePlan => {
            const rp = ratePlan;
            if (rp.reserved === 0) {
                return null;
            }
