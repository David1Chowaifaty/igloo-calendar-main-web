...
import { d as defineCustomElement$12 } from './ir-balance-cell2.js';
import { d as defineCustomElement$11 } from './ir-booked-by-source-cell2.js';
...
import { d as defineCustomElement$X } from './ir-booking-number-cell2.js';
...
import { d as defineCustomElement$Q } from './ir-custom-input2.js';
...
import { d as defineCustomElement$L } from './ir-departures-filter2.js';
import { d as defineCustomElement$K } from './ir-departures-table2.js';
...
const IrDeparturesStyle2 = irDeparturesCss;

const IrDepartures$1 = /*@__PURE__*/ proxyCustomElement(class IrDepartures extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    static get style() { return IrDeparturesStyle0 + (IrDeparturesStyle1 + IrDeparturesStyle2); }
}, [2, "ir-departures", {
        "ticket": [1],
        "propertyid": [2],
        "language": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["ir-departures", "igl-application-info", "igl-block-dates-view", "igl-book-property", "igl-book-property-footer", "igl-book-property-header", "igl-booking-form", "igl-booking-overview-page", "igl-date-range", "igl-property-booked-by", "igl-rate-plan", "igl-room-type", "ir-actions-cell", "ir-applicable-policies", "ir-autocomplete", "ir-balance-cell", "ir-booked-by-source-cell", "ir-booking-company-form", "ir-booking-details", "ir-booking-extra-note", "ir-booking-guarantee", "ir-booking-header", "ir-booking-number-cell", "ir-booking-status-tag", "ir-button", "ir-combobox", "ir-country-picker", "ir-custom-button", "ir-custom-date-picker", "ir-custom-input", "ir-date-picker", "ir-date-range", "ir-date-view", "ir-dates-cell", "ir-departures-filter", "ir-departures-table", "ir-dialog", "ir-drawer", "ir-events-log", "ir-extra-service", "ir-extra-service-config", "ir-extra-services", "ir-guest-info", "ir-guest-name-cell", "ir-icon", "ir-icons", "ir-input-text", "ir-interceptor", "ir-label", "ir-loading-screen", "ir-modal", "ir-otp", "ir-otp-modal", "ir-payment-details", "ir-payment-folio", "ir-payment-item", "ir-payment-summary", "ir-payments-folio", "ir-phone-input", "ir-picker", "ir-picker-item", "ir-pickup", "ir-pickup-view", "ir-pms-logs", "ir-popover", "ir-price-input", "ir-reservation-information", "ir-room", "ir-room-guests", "ir-select", "ir-sidebar", "ir-spinner", "ir-textarea", "ir-title", "ir-toast", "ir-tooltip", "ir-unit-cell", "ir-unit-tag", "ir-validator", "ota-label"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-departures":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrDepartures$1);
            }
            break;
...
const IrDepartures = IrDepartures$1;
const defineCustomElement = defineCustomElement$1;

export { IrDepartures, defineCustomElement };
