...
const IrListingModal$1 = /*@__PURE__*/ proxyCustomElement(class IrListingModal extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
...
function defineCustomElement$1() {
    ...
    const components = ["ir-listing-modal", "ir-button", "ir-icon", "ir-icons", "ir-select"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-listing-modal":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrListingModal$1);
            }
            break;
        case "ir-button":
            if (!customElements.get(tagName)) {
...
const IrListingModal = IrListingModal$1;
