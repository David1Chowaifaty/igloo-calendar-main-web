...
function defineCustomElement() {
    ...
    const components = ["ir-room-guests-form", "ir-country-picker", "ir-input", "ir-input-text", "ir-picker", "ir-picker-item", "ir-spinner", "ir-validator"];
