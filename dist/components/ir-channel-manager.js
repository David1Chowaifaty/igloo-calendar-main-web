...
const IrChannelManager$1 = /*@__PURE__*/ proxyCustomElement(class IrChannelManager extends HTMLElement {
    ...
    render() {
        return [
            h("div", { key: '6805616032ee5a5f42d0091a6ec64d3f3c3370ba', id: "container" }, h("div", { key: 'eff67b996207717f13b2d0bdfd78dc392a6707d4', class: "card" }, h("ir-topbar", { key: '0c855b007513114a3d09fd7b03407b1e2f6da8e1' }), h("ir-list-item", { key: '5d27b9cccd98e3c926578a64071e47d74125cb85', id: "ir-list-item", listData: this.listData, dropdownData: this.dropdownData }))),
            h("ir-sidebar", { key: '10260e04e48ec6fbb32ff167e0bdc3215a013637', side: "right", class: "" }, h("div", { key: '9688ac65c1483faf18631f022e2adc5bf9c582ca', class: "container pt-1" }, h("h5", { key: 'b72e0377da453fba32479fe9f87f544b17cfcf5d', class: "font-weight-bold" }, this.mode === 'create' ? 'Create' : 'Edit', " Channel")), h("ul", { key: 'f0b04b7a9e6bb3b599bf929b5d47c1654f8c3357', class: "list-group list-group-horizontal mb-2" }, this.tabs.map(tab => (h("li", { class: this.activeTab === tab ? 'active' : '' }, h("a", { class: "", "data-mdb-ripple-color": "dark", onClick: () => {
                ...
                h("ir-mapping", { hostRoom: this.hostRoom, class: "mb-3", mapReference: this.mapReference, map: this.mode === 'edit' ? this.selectedItem.RoomsMapping : null }))), h("div", { key: 'e56ccdbebac95097eb40f0bc27c3befec28a8803', class: "btn-position" }, h("button", { key: '7d9090264b120240205210f84f6f8d09b72d1733', type: "button", class: "btn btn-primary btn-sm btn-block", onClick: () => this.goNext() }, this.activeTab == 'General Settings' ? 'Next' : 'Save'))),
            h("ir-modal", { key: 'b3a2122de581113e2b253d7dc960b521f2c71803', class: 'exit', modalTitle: "Exit without saving?", modalBody: "All unsaved changes will be lost.", iconAvailable: true, icon: "ft-alert-circle warning h1" }),
            h("ir-modal", { key: 'b7b16a8c6712d77276a8283898de592c7b285ff6', class: "alertModal-manager", modalTitle: "Please fill all the fields!", modalBody: "There are fields that are not filled yet.", icon: "ft-alert-circle warning h1", iconAvailable: true, leftBtnActive: false, btnPosition: "center", rightBtnText: "Close", rightBtnColor: "primary" }),
        ];
    }
    static get style() { return IrChannelManagerStyle0; }
