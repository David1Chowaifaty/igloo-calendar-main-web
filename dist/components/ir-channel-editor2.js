...
const IrChannelEditor = /*@__PURE__*/ proxyCustomElement(class IrChannelEditor extends HTMLElement {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '5457820bc2d675f619e6e27066cafc390c1119e9', class: " d-flex flex-column h-100" }, h("nav", { key: '6594874a8e9481ae6a65de689f6a4ae173c8b412', class: "px-1 position-sticky sticky-top py-1 top-0 bg-white" }, h("div", { key: 'fa96c7fc32cfc2bd86c6125e7fb8bccebdff2b93', class: "d-flex align-items-center  justify-content-between" }, h("h3", { key: '10220a1ac3318e18249ddb3cc7342a4b37705fdf', class: "text-left font-medium-2  py-0 my-0" }, this.channel_status === 'create' ? (_a = locales.entries) === null || _a === void 0 ? void 0 : _a.Lcz_CreateChannel : (_b = locales.entries) === null || _b === void 0 ? void 0 : _b.Lcz_EditChannel), h("ir-icon", { key: '5650afcd4d969eb5042f9af5e614862395ea7161', class: 'm-0 p-0 close', onIconClickHandler: () => {
                this.closeSideBar.emit(null);
            } }, h("svg", { key: '3cd62b72e398c1657ee08c3528f352a299186e51', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: 'c030ba70dbd3330fe07fb773166965856af03ebd', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" })))), h("ir-channel-header", { key: '3d64cd1ab0641d85c144ed78e7ca1a32863b3cd6', class: "mt-1 px-0", headerTitles: this.headerTitles })), h("section", { key: '83fbfdb0d9c6cc6f1d7ab2639be5123fd56f7116', class: "py-1 flex-fill tab-container px-1" }, this.renderTabScreen()), h("ir-button", { key: '30bbbfbaf3c6ec640e942716e62fff1a91355df4', isLoading: this.isLoading, onClickHanlder: () => this.saveConnectedChannel(), class: "px-1 py-1 top-border", btn_styles: "w-100  justify-content-center align-items-center", text: locales.entries.Lcz_Save })));
    }
