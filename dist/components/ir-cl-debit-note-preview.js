...
const IrClDebitNotePreview$1 = /*@__PURE__*/ proxyCustomElement(class IrClDebitNotePreview extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    components.forEach(tagName => { switch (tagName) {
        case "ir-cl-debit-note-preview":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrClDebitNotePreview$1);
            }
            break;
...
const IrClDebitNotePreview = IrClDebitNotePreview$1;
const defineCustomElement = defineCustomElement$1;

export { IrClDebitNotePreview, defineCustomElement };
