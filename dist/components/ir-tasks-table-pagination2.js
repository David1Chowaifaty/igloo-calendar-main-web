...
const IrTasksTablePagination = /*@__PURE__*/ proxyCustomElement(class IrTasksTablePagination extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: 'b61d5bef56b01b15b67318be3a1d8272b37b080d' }, shouldLoadMore() && h("ir-button", { key: '71a2b4b5493d09faac6071223b14802cf0c7b3a0', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: 'c3f4459bad84c4cf9e322e2133b4845f2735b38b', showing: {
                from: start,
                to: end,
