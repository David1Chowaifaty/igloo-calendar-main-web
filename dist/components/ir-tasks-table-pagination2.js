...
const IrTasksTablePagination = /*@__PURE__*/ proxyCustomElement(class IrTasksTablePagination extends HTMLElement {
    ...
    render() {
        ...
        return (h(Host, { key: '9ec38d1ce0a9106576e26408a9610c8bdfa48654' }, shouldLoadMore() && h("ir-button", { key: '213f21e3f2b22e8d9ab50dbdae8709717079e1c0', size: "sm", class: "tasks-load-more", text: "Load more", onClickHandler: () => loadMoreTasks(mobileCurrentPage + 1) }), h("ir-pagination", { key: '5014ed7c6296ed62f00ebfcc334fbbc2de825bdd', showing: {
                from: start,
                to: end,
