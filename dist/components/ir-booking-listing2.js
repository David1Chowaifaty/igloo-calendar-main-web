...
import { d as defineCustomElement$1$ } from './igl-room-type2.js';
import { d as defineCustomElement$1_ } from './ir-actions-cell2.js';
import { d as defineCustomElement$1Z } from './ir-air-date-picker2.js';
import { d as defineCustomElement$1Y } from './ir-applicable-policies2.js';
import { d as defineCustomElement$1X } from './ir-arrival-time-cell2.js';
import { d as defineCustomElement$1W } from './ir-arrival-time-dialog2.js';
import { d as defineCustomElement$1V } from './ir-assignment-toggle-dialog2.js';
import { d as defineCustomElement$1U } from './ir-balance-cell2.js';
import { d as defineCustomElement$1T } from './ir-billing2.js';
import { d as defineCustomElement$1S } from './ir-billing-drawer2.js';
import { d as defineCustomElement$1R } from './ir-booked-by-cell2.js';
import { d as defineCustomElement$1Q } from './ir-booked-on-cell2.js';
import { d as defineCustomElement$1P } from './ir-booking-assign-items2.js';
import { d as defineCustomElement$1O } from './ir-booking-billing-recipient2.js';
import { d as defineCustomElement$1N } from './ir-booking-city-ledger2.js';
...
import { d as defineCustomElement$1A } from './ir-booking-listing-mobile-card2.js';
import { d as defineCustomElement$1z } from './ir-booking-listing-table2.js';
import { d as defineCustomElement$1y } from './ir-booking-number-cell2.js';
...
import { d as defineCustomElement$1n } from './ir-cl-credit-note-preview2.js';
import { d as defineCustomElement$1m } from './ir-cl-debit-note-fields2.js';
import { d as defineCustomElement$1l } from './ir-cl-debit-note-preview2.js';
import { d as defineCustomElement$1k } from './ir-cl-document-header2.js';
import { d as defineCustomElement$1j } from './ir-cl-fiscal-document-preview2.js';
import { d as defineCustomElement$1i } from './ir-cl-fiscal-document-table2.js';
import { d as defineCustomElement$1h } from './ir-cl-invoice-city-tax-amount-cell2.js';
import { d as defineCustomElement$1g } from './ir-cl-invoice-city-tax-pct-cell2.js';
import { d as defineCustomElement$1f } from './ir-cl-invoice-date-cell2.js';
import { d as defineCustomElement$1e } from './ir-cl-invoice-description-cell2.js';
import { d as defineCustomElement$1d } from './ir-cl-invoice-dialog2.js';
import { d as defineCustomElement$1c } from './ir-cl-invoice-form2.js';
import { d as defineCustomElement$1b } from './ir-cl-invoice-net-price-cell2.js';
import { d as defineCustomElement$1a } from './ir-cl-invoice-preview2.js';
import { d as defineCustomElement$19 } from './ir-cl-invoice-total-cell2.js';
import { d as defineCustomElement$18 } from './ir-cl-invoice-vat-amount-cell2.js';
import { d as defineCustomElement$17 } from './ir-cl-invoice-vat-pct-cell2.js';
import { d as defineCustomElement$16 } from './ir-cl-opening-balance-fields2.js';
import { d as defineCustomElement$15 } from './ir-cl-payment-fields2.js';
import { d as defineCustomElement$14 } from './ir-cl-receipt-preview2.js';
import { d as defineCustomElement$13 } from './ir-country-picker2.js';
import { d as defineCustomElement$12 } from './ir-custom-button2.js';
import { d as defineCustomElement$11 } from './ir-custom-date-picker2.js';
import { d as defineCustomElement$10 } from './ir-custom-date-range2.js';
import { d as defineCustomElement$$ } from './ir-date-picker2.js';
...
import { d as defineCustomElement$W } from './ir-dates-cell2.js';
import { d as defineCustomElement$V } from './ir-dialog2.js';
import { d as defineCustomElement$U } from './ir-drawer2.js';
import { d as defineCustomElement$T } from './ir-empty-state2.js';
...
import { d as defineCustomElement$P } from './ir-extra-service-config-form2.js';
import { d as defineCustomElement$O } from './ir-extra-services2.js';
import { d as defineCustomElement$N } from './ir-fd-confirm-dialog2.js';
...
import { d as defineCustomElement$J } from './ir-input2.js';
import { d as defineCustomElement$I } from './ir-input-text2.js';
import { d as defineCustomElement$H } from './ir-interceptor2.js';
import { d as defineCustomElement$G } from './ir-invoice2.js';
import { d as defineCustomElement$F } from './ir-invoice-form2.js';
...
import { d as defineCustomElement$z } from './ir-otp-modal2.js';
import { d as defineCustomElement$y } from './ir-pagination2.js';
...
import { d as defineCustomElement$l } from './ir-preview-screen-dialog2.js';
import { d as defineCustomElement$k } from './ir-print-room2.js';
import { d as defineCustomElement$j } from './ir-printing-extra-service2.js';
import { d as defineCustomElement$i } from './ir-printing-label2.js';
import { d as defineCustomElement$h } from './ir-printing-pickup2.js';
import { d as defineCustomElement$g } from './ir-proforma-invoice-preview2.js';
...
import { d as defineCustomElement$b } from './ir-room-guests-form2.js';
import { d as defineCustomElement$a } from './ir-service-assignee-select2.js';
import { d as defineCustomElement$9 } from './ir-spinner2.js';
import { d as defineCustomElement$8 } from './ir-status-activity-cell2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-listing", "igl-application-info", "igl-rate-plan", "igl-room-type", "ir-actions-cell", "ir-air-date-picker", "ir-applicable-policies", "ir-arrival-time-cell", "ir-arrival-time-dialog", "ir-assignment-toggle-dialog", "ir-balance-cell", "ir-billing", "ir-billing-drawer", "ir-booked-by-cell", "ir-booked-on-cell", "ir-booking-assign-items", "ir-booking-billing-recipient", "ir-booking-city-ledger", "ir-booking-company-dialog", "ir-booking-company-form", "ir-booking-details", "ir-booking-details-drawer", "ir-booking-editor", "ir-booking-editor-drawer", "ir-booking-editor-form", "ir-booking-editor-guest-form", "ir-booking-editor-header", "ir-booking-extra-note", "ir-booking-guarantee", "ir-booking-header", "ir-booking-listing-mobile-card", "ir-booking-listing-table", "ir-booking-number-cell", "ir-booking-rooms", "ir-booking-source-editor-dialog", "ir-booking-source-editor-form", "ir-booking-status-tag", "ir-button", "ir-checkout-dialog", "ir-city-ledger-transaction-drawer", "ir-city-ledger-transaction-form", "ir-cl-adjustment-fields", "ir-cl-credit-note-fields", "ir-cl-credit-note-preview", "ir-cl-debit-note-fields", "ir-cl-debit-note-preview", "ir-cl-document-header", "ir-cl-fiscal-document-preview", "ir-cl-fiscal-document-table", "ir-cl-invoice-city-tax-amount-cell", "ir-cl-invoice-city-tax-pct-cell", "ir-cl-invoice-date-cell", "ir-cl-invoice-description-cell", "ir-cl-invoice-dialog", "ir-cl-invoice-form", "ir-cl-invoice-net-price-cell", "ir-cl-invoice-preview", "ir-cl-invoice-total-cell", "ir-cl-invoice-vat-amount-cell", "ir-cl-invoice-vat-pct-cell", "ir-cl-opening-balance-fields", "ir-cl-payment-fields", "ir-cl-receipt-preview", "ir-country-picker", "ir-custom-button", "ir-custom-date-picker", "ir-custom-date-range", "ir-date-picker", "ir-date-range", "ir-date-range-filter", "ir-date-select", "ir-date-view", "ir-dates-cell", "ir-dialog", "ir-drawer", "ir-empty-state", "ir-events-log", "ir-extra-service", "ir-extra-service-config", "ir-extra-service-config-form", "ir-extra-services", "ir-fd-confirm-dialog", "ir-guest-info-drawer", "ir-guest-info-form", "ir-icons", "ir-input", "ir-input-text", "ir-interceptor", "ir-invoice", "ir-invoice-form", "ir-label", "ir-listing-header", "ir-loading-screen", "ir-mobile-input", "ir-otp", "ir-otp-modal", "ir-pagination", "ir-payment-details", "ir-payment-folio", "ir-payment-folio-form", "ir-payment-item", "ir-payment-summary", "ir-payments-folio", "ir-picker", "ir-picker-item", "ir-pickup", "ir-pickup-form", "ir-pickup-view", "ir-pms-logs", "ir-preview-screen-dialog", "ir-print-room", "ir-printing-extra-service", "ir-printing-label", "ir-printing-pickup", "ir-proforma-invoice-preview", "ir-range-picker", "ir-reservation-information", "ir-room", "ir-room-guests", "ir-room-guests-form", "ir-service-assignee-select", "ir-spinner", "ir-status-activity-cell", "ir-toast", "ir-toast-alert", "ir-toast-provider", "ir-unit-cell", "ir-unit-tag", "ir-validator", "ota-label"];
