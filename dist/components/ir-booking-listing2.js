...
import { F as isPrivilegedUser } from './utils.js';
...
import { d as defineCustomElement$1T } from './ir-actions-cell2.js';
import { d as defineCustomElement$1S } from './ir-agent-billing2.js';
import { d as defineCustomElement$1R } from './ir-air-date-picker2.js';
import { d as defineCustomElement$1Q } from './ir-applicable-policies2.js';
import { d as defineCustomElement$1P } from './ir-arrival-time-cell2.js';
...
import { d as defineCustomElement$1M } from './ir-balance-cell2.js';
import { d as defineCustomElement$1L } from './ir-billing2.js';
import { d as defineCustomElement$1K } from './ir-billing-drawer2.js';
import { d as defineCustomElement$1J } from './ir-booked-by-cell2.js';
import { d as defineCustomElement$1I } from './ir-booked-on-cell2.js';
...
import { d as defineCustomElement$1s } from './ir-booking-listing-mobile-card2.js';
import { d as defineCustomElement$1r } from './ir-booking-listing-table2.js';
import { d as defineCustomElement$1q } from './ir-booking-number-cell2.js';
import { d as defineCustomElement$1p } from './ir-booking-pricing-drawer2.js';
import { d as defineCustomElement$1o } from './ir-booking-pricing-form2.js';
import { d as defineCustomElement$1n } from './ir-booking-rooms2.js';
import { d as defineCustomElement$1m } from './ir-booking-source-editor-dialog2.js';
import { d as defineCustomElement$1l } from './ir-booking-source-editor-form2.js';
import { d as defineCustomElement$1k } from './ir-booking-status-tag2.js';
import { d as defineCustomElement$1j } from './ir-button2.js';
import { d as defineCustomElement$1i } from './ir-checkout-dialog2.js';
import { d as defineCustomElement$1h } from './ir-city-ledger-fiscal-documents-table2.js';
...
import { d as defineCustomElement$1e } from './ir-cl-adjustment-fields2.js';
import { d as defineCustomElement$1d } from './ir-cl-credit-note-fields2.js';
import { d as defineCustomElement$1c } from './ir-cl-debit-note-fields2.js';
import { d as defineCustomElement$1b } from './ir-cl-fiscal-document-preview2.js';
import { d as defineCustomElement$1a } from './ir-cl-invoice-dialog2.js';
import { d as defineCustomElement$19 } from './ir-cl-invoice-form2.js';
import { d as defineCustomElement$18 } from './ir-cl-invoice-select2.js';
import { d as defineCustomElement$17 } from './ir-cl-opening-balance-fields2.js';
import { d as defineCustomElement$16 } from './ir-cl-payment-fields2.js';
import { d as defineCustomElement$15 } from './ir-cl-status-tag2.js';
import { d as defineCustomElement$14 } from './ir-country-picker2.js';
import { d as defineCustomElement$13 } from './ir-custom-button2.js';
import { d as defineCustomElement$12 } from './ir-custom-date-range2.js';
import { d as defineCustomElement$11 } from './ir-date-picker2.js';
import { d as defineCustomElement$10 } from './ir-date-range2.js';
import { d as defineCustomElement$$ } from './ir-date-range-filter2.js';
import { d as defineCustomElement$_ } from './ir-date-select2.js';
import { d as defineCustomElement$Z } from './ir-date-view2.js';
import { d as defineCustomElement$Y } from './ir-dates-cell2.js';
import { d as defineCustomElement$X } from './ir-dialog2.js';
import { d as defineCustomElement$W } from './ir-drawer2.js';
import { d as defineCustomElement$V } from './ir-empty-state2.js';
import { d as defineCustomElement$U } from './ir-events-log2.js';
import { d as defineCustomElement$T } from './ir-extra-service2.js';
import { d as defineCustomElement$S } from './ir-extra-service-config2.js';
import { d as defineCustomElement$R } from './ir-extra-service-config-form2.js';
import { d as defineCustomElement$Q } from './ir-extra-services2.js';
import { d as defineCustomElement$P } from './ir-fd-confirm-dialog2.js';
import { d as defineCustomElement$O } from './ir-guest-billing2.js';
import { d as defineCustomElement$N } from './ir-guest-info-drawer2.js';
import { d as defineCustomElement$M } from './ir-guest-info-form2.js';
import { d as defineCustomElement$L } from './ir-icons2.js';
import { d as defineCustomElement$K } from './ir-input2.js';
import { d as defineCustomElement$J } from './ir-input-text2.js';
import { d as defineCustomElement$I } from './ir-interceptor2.js';
import { d as defineCustomElement$H } from './ir-invoice2.js';
import { d as defineCustomElement$G } from './ir-invoice-form2.js';
...
import { d as defineCustomElement$z } from './ir-pagination2.js';
import { d as defineCustomElement$y } from './ir-payment-details2.js';
import { d as defineCustomElement$x } from './ir-payment-folio2.js';
import { d as defineCustomElement$w } from './ir-payment-folio-form2.js';
import { d as defineCustomElement$v } from './ir-payment-item2.js';
import { d as defineCustomElement$u } from './ir-payment-summary2.js';
import { d as defineCustomElement$t } from './ir-payments-folio2.js';
import { d as defineCustomElement$s } from './ir-pdf-viewer2.js';
...
function defineCustomElement() {
    ...
    const components = ["ir-booking-listing", "igl-application-info", "igl-rate-plan", "igl-room-type", "ir-actions-cell", "ir-agent-billing", "ir-air-date-picker", "ir-applicable-policies", "ir-arrival-time-cell", "ir-arrival-time-dialog", "ir-assignment-toggle-dialog", "ir-balance-cell", "ir-billing", "ir-billing-drawer", "ir-booked-by-cell", "ir-booked-on-cell", "ir-booking-assign-items", "ir-booking-billing-recipient", "ir-booking-city-ledger", "ir-booking-company-dialog", "ir-booking-company-form", "ir-booking-details", "ir-booking-details-drawer", "ir-booking-editor", "ir-booking-editor-drawer", "ir-booking-editor-form", "ir-booking-editor-guest-form", "ir-booking-editor-header", "ir-booking-extra-note", "ir-booking-guarantee", "ir-booking-header", "ir-booking-listing-mobile-card", "ir-booking-listing-table", "ir-booking-number-cell", "ir-booking-pricing-drawer", "ir-booking-pricing-form", "ir-booking-rooms", "ir-booking-source-editor-dialog", "ir-booking-source-editor-form", "ir-booking-status-tag", "ir-button", "ir-checkout-dialog", "ir-city-ledger-fiscal-documents-table", "ir-city-ledger-transaction-drawer", "ir-city-ledger-transaction-form", "ir-cl-adjustment-fields", "ir-cl-credit-note-fields", "ir-cl-debit-note-fields", "ir-cl-fiscal-document-preview", "ir-cl-invoice-dialog", "ir-cl-invoice-form", "ir-cl-invoice-select", "ir-cl-opening-balance-fields", "ir-cl-payment-fields", "ir-cl-status-tag", "ir-country-picker", "ir-custom-button", "ir-custom-date-range", "ir-date-picker", "ir-date-range", "ir-date-range-filter", "ir-date-select", "ir-date-view", "ir-dates-cell", "ir-dialog", "ir-drawer", "ir-empty-state", "ir-events-log", "ir-extra-service", "ir-extra-service-config", "ir-extra-service-config-form", "ir-extra-services", "ir-fd-confirm-dialog", "ir-guest-billing", "ir-guest-info-drawer", "ir-guest-info-form", "ir-icons", "ir-input", "ir-input-text", "ir-interceptor", "ir-invoice", "ir-invoice-form", "ir-label", "ir-listing-header", "ir-loading-screen", "ir-mobile-input", "ir-otp", "ir-otp-modal", "ir-pagination", "ir-payment-details", "ir-payment-folio", "ir-payment-folio-form", "ir-payment-item", "ir-payment-summary", "ir-payments-folio", "ir-pdf-viewer", "ir-picker", "ir-picker-item", "ir-pickup", "ir-pickup-form", "ir-pickup-view", "ir-pms-logs", "ir-preview-screen-dialog", "ir-print-room", "ir-printing-extra-service", "ir-printing-label", "ir-printing-pickup", "ir-proforma-invoice-preview", "ir-range-picker", "ir-reservation-information", "ir-room", "ir-room-guests", "ir-room-guests-form", "ir-service-assignee-select", "ir-spinner", "ir-status-activity-cell", "ir-toast", "ir-toast-alert", "ir-toast-provider", "ir-unit-cell", "ir-unit-tag", "ir-validator", "ota-label"];
