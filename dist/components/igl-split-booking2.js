...
import { n as checkMealPlan } from './utils.js';
...
const IglSplitBooking = /*@__PURE__*/ proxyCustomElement(class IglSplitBooking extends HTMLElement {
    ...
    async doReservation() {
        try {
            ...
            let rooms = [
                ...oldRooms,
                Object.assign(Object.assign({}, this.room), { from_date: this.room.from_date, to_date: this.selectedDates.from_date.format('YYYY-MM-DD'), days: this.room.days.filter(r => hooks(r.date, 'YYYY-MM-DD').isBefore(this.selectedDates.from_date, 'dates')) }),
                Object.assign(Object.assign({}, this.room), { identifier: null, assigned_units_pool: null, parent_room_identifier: this.room.identifier, is_split: true, roomtype: {
                    ...
                    }, unit: { id: selectedUnit.unit_id }, from_date: this.selectedDates.from_date.format('YYYY-MM-DD'),
    ...
    render() {
        ...
        return (h("form", { key: 'c89ee908a319d19758fbdc3af015c0ec46e3fe44', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("ir-title", { key: 'ad41ba64fe4d8f2cf03079642026a878ce33c3e1', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${(_a = this.room) === null || _a === void 0 ? void 0 : _a.unit['name']}` }), h("section", { key: '85d9c4efb8b226247eae5b34128130d4133b6330', class: "px-1 sheet-body" }, h("div", { key: 'ef77e8858de30aa22e8572d4cd395c69714410d6', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, h("div", { key: 'bda3b8e2faa446d9dfeae30c736b84f83b9f22dd' }, h("ir-date-view", { key: 'ee95a22c5502c8cc3b3ff0d2349c4418d2605b8f', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), h("p", { key: '5f66f85d599a2ecb8c18895d03498678112f2a79', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales.entries.Lcz_NonRefundable : '')), h("div", { key: 'c61e895d6ec215e751c791cc1310d9e7671bfa8a', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, h("span", { key: '9ad0e5faa7ea9c80890f83d9c78a4d263502f3eb' }, "From:"), h("ir-date-picker", { key: '8d5c045ef7f951f96926b0265c3118f8b18bb908', "data-testid": "pickup_arrival_date", date: (_c = (_b = this.selectedDates) === null || _b === void 0 ? void 0 : _b.from_date) === null || _c === void 0 ? void 0 : _c.format('YYYY-MM-DD'), maxDate: (_d = this.defaultDates) === null || _d === void 0 ? void 0 : _d.to_date.format('YYYY-MM-DD'), minDate: (_e = this.defaultDates) === null || _e === void 0 ? void 0 : _e.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, h("input", { key: '8b684309678e8b48454166be68e9464db915457b', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), h("ir-button", { key: '793ce3224bdf891c1619289d1fad60e3ee9b4b7a', isLoading: isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.roomtype_id) && h("p", { key: '99e8387153258f555155407fc40ca02be75b82af', class: "text-danger text-left mt-2" }, "Please select a room"), h("ul", { key: 'e67954a90d2afb95d999390fbb1bbddc72a59bca', class: "room-type-list mt-2" }, (_g = this.roomTypes) === null || _g === void 0 ? void 0 : _g.map(roomType => {
