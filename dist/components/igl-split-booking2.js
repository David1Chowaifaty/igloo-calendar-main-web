...
const IglSplitBooking = /*@__PURE__*/ proxyCustomElement(class IglSplitBooking extends HTMLElement {
    ...
    render() {
        ...
        return (h("form", { key: '7cdd8f643cb6687a9d6cb65643876ad78e52cd6d', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("ir-title", { key: '4f823dbd8970a7b9ae6a86bd9290c6fb66b512c6', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${(_a = this.room) === null || _a === void 0 ? void 0 : _a.unit['name']}` }), h("section", { key: '9d1c539078754a2cb64fb9ed576ba6c842400792', class: "px-1 sheet-body" }, h("div", { key: '7a78587887b16ca998683247dd90be3146cf8df3', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, h("div", { key: '95e8359343dee21f10372d54578f26b93dd42350' }, h("ir-date-view", { key: '99bd577055e4024fab31ee3a9178d1ea1202e241', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), h("p", { key: '20dfce047b99101eb197a132ed11dddd96254c46', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales.entries.Lcz_NonRefundable : '')), h("div", { key: '02be8dcc3423237f88b28b885b61dcd3c636e94e', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, h("span", { key: '6ce8d12b4eaada2c3cba5a77237c3f30b1398502' }, "From:"), h("ir-date-picker", { key: '24e4c7d77a02bd3935ce4f128e576d04d3ac871b', "data-testid": "pickup_arrival_date", date: (_c = (_b = this.selectedDates) === null || _b === void 0 ? void 0 : _b.from_date) === null || _c === void 0 ? void 0 : _c.format('YYYY-MM-DD'), maxDate: (_d = this.defaultDates) === null || _d === void 0 ? void 0 : _d.to_date.format('YYYY-MM-DD'), minDate: (_e = this.defaultDates) === null || _e === void 0 ? void 0 : _e.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, h("input", { key: 'c3dfeb7d7c59f955a1664f94fbb7d5b51c047093', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), h("ir-button", { key: '47be499886ff8618c97f13c8a396883f9b9e0936', isLoading: isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), ((_f = this.errors) === null || _f === void 0 ? void 0 : _f.roomtype_id) && h("p", { key: '303a3f387e159c6fa10717255fc3defef7d68cb2', class: "text-danger text-left mt-2" }, "Please select a room"), h("ul", { key: '222b2647817b7bb20cfe10f1b20da336f26437a5', class: "room-type-list mt-2" }, (_g = this.roomTypes) === null || _g === void 0 ? void 0 : _g.map(roomType => {
        ...
        }))), h("div", { key: '20a28a52a6139dcb6b68882c9999803ddfa04768', class: 'sheet-footer' }, h("ir-button", { key: '7db3dbef130db30877da9a14074dc6f8f260ea6d', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: '404d266cd576d594ecad6ba88ae3fad3ba24bb70', isLoading: this.isLoading, text: locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
