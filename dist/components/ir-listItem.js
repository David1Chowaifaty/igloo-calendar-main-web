...
import { d as defineCustomElement$3 } from './ir-dropdown2.js';
...
const IrListItem = /*@__PURE__*/ proxyCustomElement(class IrListItem extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        ...
        "dropdownData": [16],
        "dropdownDataDisable": [16],
        "listData": [16],
        "type": [32]
    }, [[0, "confirmModal", "doAction"]]]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["ir-list-item", "ir-button", "ir-dropdown", "ir-icon", "ir-modal"];
    components.forEach(tagName => { switch (tagName) {
        case "ir-list-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, IrListItem);
            }
            break;
        case "ir-button":
            if (!customElements.get(tagName)) {
...
export { IrListItem as I, defineCustomElement as d };
