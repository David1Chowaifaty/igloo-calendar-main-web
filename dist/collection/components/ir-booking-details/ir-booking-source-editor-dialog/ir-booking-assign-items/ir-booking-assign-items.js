...
export class IrBookingAssignItems {
    ...
    render() {
        ...
        return (h(Host, { key: 'dc8f8ba42900d1ea081e7387684135c91ebf71c0', size: "s" }, h("div", { key: 'd95d43b4aaa61f448540c4ec44bcec91a6ce0ebd', class: "assign-container" }, h("p", { key: 'd87abdb6a36c637897512d6af1791087d272758d', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (h("div", { key: 'f61e5efacfe02b07345cb574bc72d622ba995626', class: "assign-section" }, h("p", { key: '9ffb5d6961e7315e34e59036c8fd612a87258224', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (h("div", { key: '1853287212000002012c68e72c3714a5e7de0dfc', class: "assign-section" }, h("p", { key: '56628663bcc0b8f6ca98d4a7217b3231f679b200', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (h("div", { key: '214c2a8d11a692e1f2642db13e40777c3a2118d6', class: "assign-section" }, h("p", { key: 'fc181abc078188c43dd60173b36f466f1110c913', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
