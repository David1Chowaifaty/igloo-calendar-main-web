...
export class IrBookingAssignItems {
    ...
    render() {
        ...
        return (h(Host, { key: '72b404604c94d5841febc7551ce1b7521b9a5421', size: "small" }, h("div", { key: '25de8a0c04e6551423374b0419da049bea736144', class: "assign-container" }, h("p", { key: 'b803f77b2075dbe9dea1c7eaf495b2ec7d8b8cc7', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (h("div", { key: '433343375590d2a87a7870a70e5c7aba03768b0d', class: "assign-section" }, h("p", { key: '8849752973550ffabe19ac4a6fe48f45b89e6d72', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (h("div", { key: '5e6d11ed0e2fa8b624e417a80b28368f240ff275', class: "assign-section" }, h("p", { key: 'd1f013b2d12a192639d92068b34108769afd35a8', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (h("div", { key: 'e08ea6ba102fb2fd89028ec1fa9ec5841da142e8', class: "assign-section" }, h("p", { key: '054444b756ad93707f1793ea77c689d14138ce62', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
