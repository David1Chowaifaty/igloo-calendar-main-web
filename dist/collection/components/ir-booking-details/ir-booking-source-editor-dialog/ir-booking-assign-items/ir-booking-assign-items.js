...
export class IrBookingAssignItems {
    ...
    render() {
        ...
        return (h(Host, { key: 'c668a9b523ecb622b09ab11614662533bbf8937e', size: "s" }, h("div", { key: 'f1916cadb0a4f0a414d58eb65d072c42d30bc218', class: "assign-container" }, h("p", { key: '6bfb796a829014ece976c29c071fc31fa1062c1f', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (h("div", { key: '21970a98a36f1801b3be9387f1f942270306ac0d', class: "assign-section" }, h("p", { key: '0ebc66cb5dfb4a09fb760949448b2ad5ce0db14f', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (h("div", { key: '37f0e2122e86d59554702b08312eb6b8bdd5b262', class: "assign-section" }, h("p", { key: '819e31732cce6d683e4f1a03a3a3660cdc434b10', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (h("div", { key: 'e65b96e2a317de2c55ca201df95c6ee6656cb2ab', class: "assign-section" }, h("p", { key: '1241c291a5949d028b4eaea25e98c0de6e87f362', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
