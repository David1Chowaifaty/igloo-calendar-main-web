...
export class IrBookingAssignItems {
    ...
    render() {
        ...
        return (h(Host, { key: '2e5a09eaf0b82f5606bda6fd643407fd0a370858', size: "s" }, h("div", { key: '6426a4013a6557d265727414f5f189f8ee346cf1', class: "assign-container" }, h("p", { key: '3730009e76d729e155e38abef4dbba8b0bac6a0d', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (h("div", { key: 'ff108a9f99625bd18466f55ad02c1a0048058574', class: "assign-section" }, h("p", { key: '7758caa19cc22b45663642e1d886605e4c92f326', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (h("div", { key: 'fae81fab065dc28b85834855bfaffb9d4147f86a', class: "assign-section" }, h("p", { key: '3149bf3ac21b73e644694918e8b0ea5ea1d3ddb3', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (h("div", { key: 'd750398e2a03c859b28ad7b483c2bcb90d58a8ce', class: "assign-section" }, h("p", { key: '824f7e6b2635439382b7368c85be449a467197f5', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
