...
export class IrBookingAssignItems {
    ...
    render() {
        ...
        return (h(Host, { key: 'bc459212482a33feed8abea13068e4faaea1d598', size: "s" }, h("div", { key: 'dcc87973a6ad2f5684416004719b2a979c0f01b7', class: "assign-container" }, h("p", { key: 'fe50df548de6fd7947b0cf71ea3a091c42ab384b', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (h("div", { key: 'd8525976242acf71922db5be78515b7d6aead599', class: "assign-section" }, h("p", { key: '910070b1f33876477a914008f2951f205b9e54c0', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (h("div", { key: '476131265b639391037831ee08e0a1e0aa224a03', class: "assign-section" }, h("p", { key: 'ff93bbd6f4136d317715974b24196c361c776369', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (h("div", { key: 'ae24bd6bcf35db5155f80b20d7fd30f4862c7675', class: "assign-section" }, h("p", { key: 'f230c506c7f05a4ede1847529da71bb652d26b32', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
