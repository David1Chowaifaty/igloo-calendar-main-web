...
export class IrBookingAssignItems {
    ...
    render() {
        ...
        return (h(Host, { key: '01290e86f471638bae13aeee54ce7f4f48e223a5', size: "small" }, h("div", { key: '0adde7459281f6ecac0c4dcda0101da841808e72', class: "assign-container" }, h("p", { key: '0013f51fbb291e9b7fc559c3906ab5c589901b3c', class: "assign-intro" }, "Select services for the Agent folio; others remain on the Guest folio."), rooms.length > 0 && (h("div", { key: 'e703f9508677b983d5a7dd1e9390c3d9c499c2e5', class: "assign-section" }, h("p", { key: 'fa301ea8c3a5be870ba8c062989ad383f44bb96b', class: "assign-section__label" }, "Accommodation"), rooms.map(item => this.renderRoomItem(item)))), pickups.length > 0 && (h("div", { key: 'be8a272fced53522b2393a02e4e3db182399959b', class: "assign-section" }, h("p", { key: 'f3f740260127a145b4e0d290aea63639afb097fb', class: "assign-section__label" }, "Pickup"), pickups.map(item => this.renderCheckItem(item)))), extras.length > 0 && (h("div", { key: '1a2086f6126db438dcbf9d7ac0a7d4f3df55145f', class: "assign-section" }, h("p", { key: '70ccc353d99065c8888d6ccf77b4d6055ea90223', class: "assign-section__label" }, "Extra Services"), extras.map(item => this.renderExtraItem(item)))))));
    }
