...
export class IrServiceAssigneeSelect {
    ...
    assignmentChange;
    render() {
        return (h(Host, { key: 'af37a7c1cbd749c2a39941e4d46b7a4d0abf4fc4' }, h("wa-radio-group", { key: '212e4ea9c753affaa772b7f30ea1c137366b6058', onchange: e => this.assignmentChange.emit(e.target.value), defaultValue: this.assigneeType, value: this.assigneeType, size: "s", label: this.label, orientation: "vertical" }, h("wa-radio", { key: 'dd213cf926b50b4c8a5cf5bad890de86e8540738', value: "agent", appearance: "button" }, "Agent: ", this.agent?.name), h("wa-radio", { key: '131621cd720e2f2895741f13ef0af1c54f2cae20', value: "guest", appearance: "button" }, "Guest"))));
    }
