    ...
    static get properties() {
        return {
            ...
            "arrivalTime": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Available arrival time options for the booking.\nPassed down to each room when applicable."
                },
                "getter": false,
                "setter": false,
                "defaultValue": "[]"
            ...
            "svcCategories": {
                ...
                "docs": {
                    "tags": [],
                    "text": "`_SVC_CATEGORY` setup entries, threaded down to each room's extra-services section for category labels."
                },
                "getter": false,
                "setter": false,
                "defaultValue": "[]"
            ...
            "checkoutRoomIdentifier": {
                ...
                "docs": {
                    "tags": [],
                    "text": "When set, the room whose identifier matches auto-opens its check-out dialog. Used to\nroute early check-outs triggered from other screens through the full booking details."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
