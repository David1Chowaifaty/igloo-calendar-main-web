...
export class IrPaymentsFolio {
    ...
    render() {
        return (h("wa-card", { key: '4ceda5ee216690da9c11fe852d9eeef7b690301d', class: " payments-container" }, h("div", { key: 'ffa46cc8de2224688c168ecd03fc8be93e0133f8', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: 'd3fcc41b0f16067009915c7e5cf618394b12f7d6', class: "font-size-large p-0 m-0" }, this.booking?.agent ? 'Guest Folio' : 'Folio'), h(HelpDocButton, { key: 'b227466d6cd3b38b72fc225f863050a6b9a88b72', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), h("wa-tooltip", { key: '7690055d4e3bd2baa0a4343398698025e63890b5', for: "create-payment" }, "New Folio Entry"), h("ir-custom-button", { key: '171115e5b7851aafc71e13c9125da47add3da151', disabled: this.isAddPaymentDisabled, slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, h("wa-icon", { key: '3f3dfc2418163080daab3c3d41b7a064e6e21e2f', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
