...
export class IrPaymentsFolio {
    ...
    render() {
        return (h("wa-card", { key: 'ceb5626d1925ab25e1da793f559de03f0ea4a618', class: " payments-container" }, h("div", { key: '73e90d7b49e0b263d0eb5f429aadeffd7e8f5eb2', slot: "header", class: 'd-flex align-items-center', style: { gap: '0.5rem' } }, h("p", { key: '6fe786c9fba193977ae43ea007bafceca263b212', class: "font-size-large p-0 m-0" }, "Guest Folio"), h(HelpDocButton, { key: 'a4104344eff56ea85d7d8c2f004441f7e006a293', message: "Help", href: "https://help.igloorooms.com/extranet/booking-details/guest-folio" })), !this.isAddPaymentDisabled && h("wa-tooltip", { key: 'f3bba8774a47c1a8533570aec4a08ea6d29a382b', for: "create-payment" }, "Add folio entry"), h("ir-custom-button", { key: '43fe47d0945f95d67613d9c00dcb0dccf7f0fe1c', disabled: this.isAddPaymentDisabled, slot: "header-actions", id: "create-payment", size: "small", variant: "neutral", appearance: "plain", onClickHandler: this.handleAddPayment }, h("wa-icon", { key: 'b6b50ae9f16b316c2c349986a7a873a5cbe6589e', name: "plus", style: { fontSize: '1rem' } })), this.hasPayments() ? this.payments.map((payment, index) => this.renderPaymentItem(payment, index)) : this.renderEmptyState()));
    }
