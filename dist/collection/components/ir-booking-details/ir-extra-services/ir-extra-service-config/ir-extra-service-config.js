...
export class IrExtraServiceConfig {
    ...
    render() {
        ...
        return (h("form", { key: '28353a4e848199a7ad0cd9a86523f52ff1514996', class: 'sheet-container', onSubmit: async (e) => {
            ...
            value: (_p = (_o = this.s_service) === null || _o === void 0 ? void 0 : _o.cost) === null || _p === void 0 ? void 0 : _p.toString(), zod: ExtraServiceSchema.pick({ cost: true }), onTextChange: e => this.updateService({ cost: parseFloat(e.detail) }), wrapKey: "cost", "aria-label": "Cost", "aria-describedby": "service cost" }))), h("div", { key: 'dc006026be6d1c4a39b0817b5d95d19f3c89f646', class: 'sheet-footer' }, h("ir-button", { key: 'e2e6cf16b76bcabc86023fee2054591f2318fd90', onClick: () => this.closeModal.emit(null), btn_styles: "justify-content-center", class: `flex-fill`, text: locales.entries.Lcz_Cancel, btn_color: "secondary" }), h("ir-button", { key: 'ed49c6d2711debe448b6709fdf005c6bf446d32c', btn_styles: "justify-content-center align-items-center", class: 'flex-fill', btn_type: "submit", isLoading: isRequestPending('/Do_Booking_Extra_Service'), text: locales.entries.Lcz_Save, btn_color: "primary" }))));
    }
