...
export class IrExtraServiceConfigForm {
    ...
    render() {
        return (h("form", { key: '8dee12eb6b6710274cd1deb29114b9ec368b0c4c', id: "extra-service-config-form", onSubmit: async (e) => {
                e.preventDefault();
                this.saveAmenity();
            }, class: 'extra-service-config__container' }, this.categories.length > 0 && (h("ir-validator", { key: 'd6e6e5767dbbf4968ddbb2e14be72bb311447139', value: this.s_service?.category, schema: ExtraServiceSchema.shape.category }, h("wa-select", { key: '9764b6498c575fdfa752aca16e40e223ba94e168', size: "s", label: "Service category", value: this.s_service?.category?.code ?? '', defaultValue: this.s_service?.category?.code ?? '', onchange: (e) => {
        ...
        })))), h("ir-validator", { key: 'ec2321b81c361f9968c08f7672ed542a5b0012b7', id: "amenity description-validator", schema: ExtraServiceSchema.shape.description }, h("wa-textarea", { key: 'c132dac7df168d0011a84fac278bbca991637299', size: "s", defaultValue: this.s_service?.description, value: this.s_service?.description, onchange: e => this.updateService({ description: e.target.value }), id: "amenity-description", "aria-label": "Amenity description", maxlength: 250, label: locales.entries.Lcz_Description })), h("ir-validator", { key: 'fe13fddc95ee18a5026b6bb7a94d6068b8af6c59', value: this.s_service?.start_date ?? null, schema: ExtraServiceSchema.shape.start_date }, h("ir-date-select", { key: 'fbf894ffddd499fbfe063e840b988c3372af70a0', placeholder: "Select date", withClear: true, label: "Dates on", emitEmptyDate: true, date: this.s_service?.start_date, minDate: this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => this.updateService({ start_date: e.detail.start?.format('YYYY-MM-DD') }) })), h("ir-date-select", { key: '961dd3fb805b1b3840412ddf22ea2884cc0b9d4b', withClear: true, emitEmptyDate: true, placeholder: "Select date", date: this.s_service?.end_date, minDate: this.s_service?.start_date ?? this.booking.from_date, maxDate: this.booking.to_date, onDateChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.updateService({ end_date: e.detail.start?.format('YYYY-MM-DD') });
            }, label: "Till and including" }), h("ir-validator", { key: '6b2615d7005927c6e25e08b81c170d7aa9632975', value: this.s_service?.price ?? null, schema: ExtraServiceSchema.shape.price }, h("ir-input", { key: 'af7f2a7e732eb31a212072b396fd2dc6e54387d1', "onText-change": e => {
                this.updateService({ price: Number(e.detail) });
            }, defaultValue: this.s_service?.price?.toString(), value: this.s_service?.price?.toString(), mask: 'price', type: "text", label: `${locales.entries.Lcz_Price} (including tax)` }, h("span", { key: '3c475e910a1909bcfe4f0178cdac0f8f610ee4fb', slot: "start" }, this.booking.currency.symbol))), h("ir-validator", { key: '6db552b1c1a313e68f15c8478d63762b4944f2d5', value: this.s_service?.cost ?? null, schema: ExtraServiceSchema.shape.cost }, h("ir-input", { key: '81c4cf096f0b466c2e2e4c598f03813573616d60', defaultValue: this.s_service?.cost?.toString(), "onText-change": e => this.updateService({ cost: Number(e.detail) }), value: this.s_service?.cost?.toString(), mask: 'price', label: `${locales.entries.Lcz_Cost} (optional)` }, h("span", { key: '31021a74635e852a7eacdd24ab28268b7b4f443c', slot: "start" }, this.booking.currency.symbol))), isAgentMode(this.agent) && (h("ir-service-assignee-select", { key: '979af9006e25c4523612e939d3c7efa5259b616f', assigneeType: this.assignee, onAssignmentChange: e => this.assignmentChanged(e), agent: this.booking.agent }))));
    }
