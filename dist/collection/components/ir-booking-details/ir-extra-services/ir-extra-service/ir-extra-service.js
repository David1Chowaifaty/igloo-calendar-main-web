...
export class IrExtraService {
    ...
    render() {
        ...
        return (h(Host, { key: '4a0982594124a004a16369b66b1a6d7c805f0560' }, h("div", { key: '74bf9fd7b93ef57719f1b5c8cfae35070f3ba0e9', class: "es-row" }, h("div", { key: 'a87c635142c441990f7aa2e6ec015415ff4bc424', class: "es-content" }, h("p", { key: 'df75098456b36071dc436349577a62080cc285c3', class: "es-description" }, this.description), hasMeta && (h("div", { key: 'e292c04c1c043a5b22a5e309385d7c106f7a0696', class: "es-meta" }, this.service.start_date &&
            (this.service.end_date ? (h("ir-date-view", { from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (h("span", { class: "es-meta-date" }, moment(new Date(this.service.start_date)).format('MMM DD, YYYY')))), unitName && h("ir-unit-tag", { key: '7975fae2f97920d378d226ee1e13a0ea691ca252', unit: unitName }), statusTag))), h("div", { key: '214c3c07b30579ed35f68d5ad14680ccd898ebcb', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (h("div", { key: 'fb3bc8ef5431b04aaa255574521bb97817a70837', class: "es-pricing" }, h("p", { key: 'a94c1deb5b7a51515a4476eed6dabebfb314698c', class: "es-price" }, formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && h("p", { key: '08bc952c2937d20bbc938e83e7db733809c03888', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), h("wa-dropdown", { key: '0ff5f65ca993cfb738802cbbd6f28b82c7aef11c', "onwa-show": e => {
            ...
            } }, h("wa-button", { key: '3626a8ad150e157dbba4bf8e93510107f20b3bcc', class: "es-action-trigger", slot: "trigger", size: "s", appearance: "plain", id: `extra-service-actions-${this.service.system_id}`, variant: "neutral", "aria-label": "Service actions" }, h("wa-icon", { key: '0008859ab6563f430b0f6784a9a6192902cfe730', class: "es-action-trigger-icon", name: "ellipsis-vertical" })), h("wa-dropdown-item", { key: '73f7c602fdd84624287922a534c5ce7366e64b8d', value: "edit" }, "Edit"), agentMode && h("wa-dropdown-item", { key: 'deb439db20db78ed55c47d0414583d134b06010b', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), h("wa-dropdown-item", { key: 'd59303ae8f4158e3b0c4df683a3f68106ec7f3be', value: "delete", variant: "danger" }, "Delete")))), h("ir-assignment-toggle-dialog", { key: '81be6f78191f71914d74a9273ce2f866f088495f', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, h("span", { key: 'bc3953cb7f2559e259f8a738bc2c8b2864f93c9f', slot: "message" }, "Re-assign ", this.description, " ", h("br", { key: '73c12f8dc69e6c7be0a092cd0501fca73f6d231b' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", h("b", { key: '6134dae66ddab76662b065a13fc8c12dd2e7a439' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), h("ir-dialog", { key: '792c9a1420d9c28fa17c5764d6c7588ae254197f', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}`, h("div", { key: '61d97271a82f2cf0523041891e8b97789cc97f0d', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '92d1fcac1ccdaacf1167f121383eb73b33f64064', appearance: "filled", variant: "neutral", size: "m", "data-dialog": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '36e8ce7f3b8b939f7725bde9e71351351f4f49c2', onClickHandler: () => this.deleteService(), loading: isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "m" }, locales.entries.Lcz_Delete)))));
    }
