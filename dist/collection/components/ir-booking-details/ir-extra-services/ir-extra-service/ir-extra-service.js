...
export class IrExtraService {
    ...
    render() {
        ...
        return (h(Host, { key: '9b89873e10a3ad2fd8bfc7f20166f216f5067407' }, h("div", { key: '5495918d66eb17cde3bd60bac2966baead9a29cb', class: "es-row" }, h("div", { key: '9840b5dc83c92a251909166a06175cda3eaaa53a', class: "es-content" }, h("p", { key: 'b1de613f23dfacb445022210d231959cda5595b3', class: "es-description" }, this.description, this.service.category.code === 'DUZ' && (h("span", { key: '7c25e38038cd5c7ff6b2d3de2090898ef6073ccf' }, ": ", this.formatDayUseTime(this.service.from_time), " \u2013 ", this.formatDayUseTime(this.service.to_time)))), hasMeta && (h("div", { key: 'de667c22620fab6f1ceaa451d523ceb1b3784d19', class: "es-meta" }, this.service.start_date &&
            (this.service.end_date && this.service?.category?.code !== 'DUZ' ? (h("ir-date-view", { class: "es-meta-date", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (h("span", { class: "es-meta-date" }, moment(new Date(this.service.start_date)).format('MMM DD, YYYY'), " "))), unitName && h("ir-unit-tag", { key: 'b303a718777c755139e66a128b7eb82b9afb4242', unit: unitName }), statusTag))), h("div", { key: 'ab62a44b9c885997ba3519d892c2a41e7abc7933', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (h("div", { key: '714a68fc09fbda5f0a0b83dc10a13b359a2b1323', class: "es-pricing" }, h("p", { key: '47405662d8b6662f93490b22d503b77e0d0e6181', class: "es-price" }, formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && h("p", { key: '036f2ec663aeb02c700b1dc5cb4b7121dd275b5f', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), h("wa-dropdown", { key: '241eb0596e50b94f9c8290f55722a8573bb81f57', "onwa-show": e => {
            ...
            } }, h("wa-button", { key: 'dcb76c6b75f736ab9573ea9921ca3f47bcd3f8e8', class: "es-action-trigger", slot: "trigger", size: "s", appearance: "plain", id: `extra-service-actions-${this.service.system_id}`, variant: "neutral", "aria-label": "Service actions" }, h("wa-icon", { key: '61bb03d1977aafc653da0bc3ad07e450b1e07be1', class: "es-action-trigger-icon", name: "ellipsis-vertical" })), h("wa-dropdown-item", { key: '463f7a0d94521c3d2781f5db93723e1f51133c1e', value: "edit" }, "Edit"), agentMode && h("wa-dropdown-item", { key: '5d5f0e9688512096191290b3217a155c6167375d', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), h("wa-dropdown-item", { key: '44ebec0df1e1b415d82a5e390a9b8930b00e5be9', value: "delete", variant: "danger" }, "Delete")))), h("ir-assignment-toggle-dialog", { key: '1cfeec643def59f54af4f305d70b903f66a5cc8d', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, h("span", { key: 'f2b3a35623ae6433648c62ba285b9b288c7b48d4', slot: "message" }, "Re-assign ", this.description, " ", h("br", { key: '476222f368642b600adade0f2dd57e3411a24485' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", h("b", { key: '94cde74bfa776bddf8e32655a4e6f79c81c6e64b' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), h("ir-dialog", { key: '0702333d875653ca1ac8f90476c822dceb493891', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}`, h("div", { key: 'b0b11233719566c1e7f5c6eaa8485cde2d1fda69', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '36508040e10f5c9714ab2cef8c6ccc062f05a618', appearance: "filled", variant: "neutral", size: "m", "data-dialog": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '1a991248f48647378dd3a70379c065cf2b6d2971', onClickHandler: () => this.deleteService(), loading: isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "m" }, locales.entries.Lcz_Delete)))));
    }
