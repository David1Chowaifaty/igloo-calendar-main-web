...
export class IrExtraService {
    ...
    render() {
        ...
        return (h(Host, { key: 'f96b728d01d8401140f79cad2939fb2888c4cf79' }, h("div", { key: '4bdb291cbe0277e6334999c5a2758b0849cb82d2', class: "es-row" }, h("div", { key: '39a6195380df8a53c390f663a26e4d6f7fbed705', class: "es-content" }, h("p", { key: '339cc92b3d4785513e774eeea01de15182bc8cfa', class: "es-description" }, this.description, this.service.category.code === SvcCategory.DayUse && (h("span", { key: 'd45c74ff306dc68e4f32bd2d8121e41f2b2713e2' }, ": ", this.formatDayUseTime(this.service.from_time), " \u2013 ", this.formatDayUseTime(this.service.to_time)))), hasMeta && (h("div", { key: 'f41cbbc8371b9ff8aacdb24884e63990094603ea', class: "es-meta" }, this.service.start_date &&
            (this.service.end_date && this.service?.category?.code !== SvcCategory.DayUse ? (h("ir-date-view", { class: "es-meta-date", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (h("span", { class: "es-meta-date" }, formatDate(new Date(this.service.start_date), 'MMM DD, YYYY'), " "))), unitName && h("ir-unit-tag", { key: '70309b5679251d1b80e4c17fc6d6b582b8696a5b', unit: unitName }), statusTag))), h("div", { key: '504579d6a2b698b36d4fa808e1fe6387f97d658e', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (h("div", { key: '48c2f1295edb85ee6e319101472344848f90543a', class: "es-pricing" }, h("p", { key: 'd243cdd0573d957ffebc53a93c76953cf10f95ce', class: "es-price" }, formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && h("p", { key: '3b1ad87a0e0373c7eccf05117e49a6c828310890', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), h("wa-dropdown", { key: '644c412cc168d3a4e8cb81750c0fd686163ce6dd', "onwa-show": e => {
            ...
            } }, h("wa-button", { key: '93a76f060ed9adf4254f26b423d943f359d12005', class: "es-action-trigger", slot: "trigger", size: "s", appearance: "plain", id: `extra-service-actions-${this.service.system_id}`, variant: "neutral", "aria-label": "Service actions" }, h("wa-icon", { key: '9881107adf2e6429a63f1e96d702f7c8d69f2cd6', class: "es-action-trigger-icon", name: "ellipsis-vertical" })), h("wa-dropdown-item", { key: 'f88412724dd76c29658445b7475c18aae4d84f64', value: "edit" }, "Edit"), agentMode && h("wa-dropdown-item", { key: 'aeabdddd540f6b1366c5c66750bddd17d2de181a', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), h("wa-dropdown-item", { key: '934085417b65a1883743f7e719f6dfff30b395f8', value: "delete", variant: "danger" }, "Delete")))), h("ir-assignment-toggle-dialog", { key: 'f747eae6bc88dac1113e0e9e5da348397fa79d84', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, h("span", { key: 'fe44172626d638221c80edc1fd1410a4ec51de53', slot: "message" }, "Re-assign ", this.description, " ", h("br", { key: '2ac7657e52a7cae52d9b0d86762b1bfb25e52ade' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", h("b", { key: '8ececb7767cabfe47e95964cd182da4061676143' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), h("ir-dialog", { key: 'e469a08db49ed3c48abc3684d2d2e60163c1124d', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}`, h("div", { key: '2225026f1c17519ccec81e42652fe5136dc82959', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: 'eb7cf873cb0675f73a4c00cce14a60bdc017cd78', appearance: "filled", variant: "neutral", size: "m", "data-dialog": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '09f2e4f50a63637816347517d1fb05729a36bedf', onClickHandler: () => this.deleteService(), loading: isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "m" }, locales.entries.Lcz_Delete)))));
    }
