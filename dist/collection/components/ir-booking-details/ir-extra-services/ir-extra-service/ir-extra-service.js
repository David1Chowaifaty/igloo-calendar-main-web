...
export class IrExtraService {
    ...
    render() {
        ...
        return (h(Host, { key: 'd9f9ecb9c031b588f7bd100aab38600ff7a118d4' }, h("div", { key: 'dec227e66fa40aa99d2599247ed288b223fa3f3f', class: "es-row" }, h("div", { key: 'ebbc866c323c1e137923f68cce0db62636929999', class: "es-content" }, h("p", { key: '850f49eb4ef02d35a9d0a21a1968ae90f5128258', class: "es-description" }, this.description, this.service.category.code === SvcCategory.DayUse && (h("span", { key: '6f2efc958ad5d1b6c892a1455057371f7c01b347' }, ": ", this.formatDayUseTime(this.service.from_time), " \u2013 ", this.formatDayUseTime(this.service.to_time)))), hasMeta && (h("div", { key: '52539dc655f7880af6adb572223bf402e138ce29', class: "es-meta" }, this.service.start_date &&
            (this.service.end_date && this.service?.category?.code !== SvcCategory.DayUse ? (h("ir-date-view", { class: "es-meta-date", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (h("span", { class: "es-meta-date" }, formatDate(new Date(this.service.start_date), 'MMM DD, YYYY'), " "))), unitName && h("ir-unit-tag", { key: '81fb65e8e0c7f6e7b3c568f4e0e98e6cf9abd1ec', unit: unitName }), statusTag))), h("div", { key: '62cd144bd720889a7e0af43800e33241b1ac8a60', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (h("div", { key: 'e098f950be4daf18229f63c15fe668246354e1c7', class: "es-pricing" }, h("p", { key: 'fb61dc567a955cd4b202d6e3d6d8da5129a110f5', class: "es-price" }, formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && h("p", { key: 'eb1727730f930cf75e057bd0ed041ff2d1ab6234', class: "es-vat" }, t('Lcz_InclVat', { fallback: 'incl. %1% VAT', params: [this.service.charges.vat_percent] })))), h("wa-dropdown", { key: 'c5775b736803b227a8acb4ad68e4e63dd1321360', "onwa-show": e => {
            ...
            } }, h("wa-button", { key: 'c7703a0cf23e75cca5459d5ac73bb2fa34b7fcbd', class: "es-action-trigger", slot: "trigger", size: "s", appearance: "plain", id: `extra-service-actions-${this.service.system_id}`, variant: "neutral", "aria-label": t('Lcz_ServiceActions', { fallback: 'Service actions' }) }, h("wa-icon", { key: 'dc91f354ef50f9ce2795c96c46de0a25e9832a68', class: "es-action-trigger-icon", name: "ellipsis-vertical" })), h("wa-dropdown-item", { key: 'a125536e177348243b682da1d42daf07249da1c2', value: "edit" }, t('Lcz_Edit', { fallback: 'Edit' })), agentMode && (h("wa-dropdown-item", { key: '23aea92920ff0c1523179d7bd1420ec83291566a', value: "toggle" }, t('Lcz_ReassignFolioDropdown', { fallback: 'Re-assign %1 folio', params: [this.service.agent ? 'guest' : 'agent'] }))), h("wa-dropdown-item", { key: '46a29a18591124b6de700d90a7871c360d3d4a79', value: "delete", variant: "danger" }, t('Lcz_Delete', { fallback: 'Delete' }))))), h("ir-assignment-toggle-dialog", { key: 'afc1e62186d8a37d57eda350785ae49d838dacaa', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: t('Lcz_SwitchFolioConfirm', {
                fallback: 'Switch "%1" to %2?',
                params: [this.service.description, this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')],
            }), onConfirmToggle: () => this.toggleServiceAgent() }, h("span", { key: '077d05f244bffc1190921591fcd281dca50116b1', slot: "message" }, t('Lcz_ReassignFolioMessage', {
        ...
        }))), h("ir-dialog", { key: '84edbcd057820b66e3f4faec94e24c96764c646e', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: t('Lcz_Alert', { fallback: 'Alert' }), ref: el => (this.irModalRef = el), lightDismiss: false }, `${t('Lcz_AreYouSureDoYouWantToRemove ')} ${t('Lcz_ThisService')} ${t('Lcz_FromThisBooking')}`, h("div", { key: '327fa99fe9f0d201dc489ebf9505891e73d99dbe', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '478346144696bc93cce41a406ef4dfa139f0f4f8', appearance: "filled", variant: "neutral", size: "m", "data-dialog": "close" }, t('Lcz_Cancel', { fallback: 'Cancel' })), h("ir-custom-button", { key: '4009ba3ea54282707bec4670c0b794312e4e60ae', onClickHandler: () => this.deleteService(), loading: isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "m" }, t('Lcz_Delete', { fallback: 'Delete' }))))));
    }
