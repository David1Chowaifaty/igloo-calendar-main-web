...
export class IrExtraService {
    ...
    render() {
        ...
        return (h(Host, { key: '474eba84158fb0c7703ecf44df81048ffcec418a' }, h("div", { key: '5a18400e031a597ab65bf4053b5c74a9c1f9e9a2', class: "es-row" }, h("div", { key: '36e15d15b545a111a5e89b325be849ee1216e0d6', class: "es-content" }, h("p", { key: '7ae5627caa2e9a915c26118e6f2529f28ff6a0f9', class: "es-description" }, this.description, this.service.category.code === 'DUZ' && (h("span", { key: 'ca1df21a76bac5cd62e3b63e17cdf462f4b31b63' }, ": ", this.formatDayUseTime(this.service.from_time), " \u2013 ", this.formatDayUseTime(this.service.to_time)))), hasMeta && (h("div", { key: 'e78f5d02763e89ee274a93ce2751cfce05beca0b', class: "es-meta" }, this.service.start_date &&
            (this.service.end_date && this.service?.category?.code !== 'DUZ' ? (h("ir-date-view", { class: "es-meta-date", from_date: this.service.start_date, to_date: this.service.end_date, showDateDifference: false })) : (h("span", { class: "es-meta-date" }, moment(new Date(this.service.start_date)).format('MMM DD, YYYY'), " "))), unitName && h("ir-unit-tag", { key: '18487c9063a0bcfc05184facced7bf9615a75b78', unit: unitName }), statusTag))), h("div", { key: 'fe8179af763c07297f839585219e67fe08cc5548', class: "es-aside" }, !!this.service.price && this.service.price > 0 && (h("div", { key: '0f3e4e2612ab2921ead5ed0a0a625adbe2ccf917', class: "es-pricing" }, h("p", { key: 'ed9a598414456a8d4048a269fa9c0db7afde9ab9', class: "es-price" }, formatAmount(this.currencySymbol, this.service.price)), !!this.service.charges?.vat_percent && h("p", { key: '8518237994c75ca90742e3dc72cb66c12c6eda45', class: "es-vat" }, "incl. ", this.service.charges.vat_percent, "% VAT"))), h("wa-dropdown", { key: 'a4e523fa497969bab2211e70f4c4ea485ba7d7b1', "onwa-show": e => {
            ...
            } }, h("wa-button", { key: 'd96f72b004f219a86194712fdeca3e7275cbf2a0', class: "es-action-trigger", slot: "trigger", size: "s", appearance: "plain", id: `extra-service-actions-${this.service.system_id}`, variant: "neutral", "aria-label": "Service actions" }, h("wa-icon", { key: 'd937945a139eb8300a7336a19a9d7f51a83b235d', class: "es-action-trigger-icon", name: "ellipsis-vertical" })), h("wa-dropdown-item", { key: '102b71f1e69058e3ced69312a22a400bf6cff0df', value: "edit" }, "Edit"), agentMode && h("wa-dropdown-item", { key: '855fc4ff29fffa2e8f27060db991591e311f7d3c', value: "toggle" }, "Re-assign to ", this.service.agent ? 'guest' : 'agent', " folio"), h("wa-dropdown-item", { key: '75ab691512cea6b0e85d252b47957d29ca672b24', value: "delete", variant: "danger" }, "Delete")))), h("ir-assignment-toggle-dialog", { key: 'f6b3ce6e7ecadbcc94ceb201cba9b7d0c6a2adc3', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, message: `Switch "${this.service.description}" to ${this.service.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent')}?`, onConfirmToggle: () => this.toggleServiceAgent() }, h("span", { key: 'ebd596ab0bac6ec9963def0ecaf4ba1dc1d53fd5', slot: "message" }, "Re-assign ", this.description, " ", h("br", { key: 'fec6d97ae20ec18f608d34736410a9c9d546f32c' }), " from ", this.service.agent ? 'Agent' : 'Guest', " folio to ", h("b", { key: '5537a84be1557785a285b38897467f5a30b3a0ee' }, this.service.agent ? 'Guest' : 'Agent', " folio"), ".")), h("ir-dialog", { key: 'd92dd4e642bd6099e029796f28d25eaa2b0e7e41', onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, label: "Alert", ref: el => (this.irModalRef = el), lightDismiss: false }, `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${locales.entries.Lcz_ThisService} ${locales.entries.Lcz_FromThisBooking}`, h("div", { key: '0016dc68af3d90db0a72b1b8ba204b53a6dc8a37', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '3ccdb4adcd68dc48046679627aa386828f7635df', appearance: "filled", variant: "neutral", size: "m", "data-dialog": "close" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: 'c364fddba78b1b81bed2835d0769feb61c90bbd1', onClickHandler: () => this.deleteService(), loading: isRequestPending('/Do_Booking_Extra_Service'), variant: "danger", size: "m" }, locales.entries.Lcz_Delete)))));
    }
