...
export class IrBookingDetailsDrawer {
    ...
    render() {
        return (h("ir-drawer", { key: '32415f2bb1ba0a7cd3dcc5c2fdc6fd4672dfa2e9', onDrawerHide: this.handleClose, withoutHeader: true, open: this.open, style: {
