...
export class IrRoomBreakdown {
    ...
    render() {
        return (h("div", { key: '17ccc78c42a021b1f6622210203ab7f2c63416f0', class: "booking-room__details-container" }, h("div", { key: '0a2f12b4a0e69b905c8f0e7a8adaf311881959b4', class: "booking-room__breakdown-row" }, h("div", { key: '58a89efe6257721aba4648a7ce6dce0da6826033', class: "booking-room__breakdown-table" }, h("table", { key: '21258d81f42dbdd87698c6938c0dd5ab110c4aef' }, this.room.days.length > 0 &&
            (() => {
            ...
            })(), h("tr", { key: '168836bcde525123bd6d465e23c87a902834f7a4', class: '' }, h("th", { key: '73d1187c9241e8eb84ef8fbf670aa6ea18853303', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '76cc381c33c9887619350f3b3568f74de395174d', class: "booking-room__cell booking-room__cell--right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (h("th", { key: '108b4167c9a59d77f385e450e762a842fc874ca2', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '7771df97c6e9b7f0932caa5b89446b471b2c4f78', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: 'c13fdf1f78f12092392a635a2d1c5dd28030ce5f' }, this.room.rateplan.cancelation && (h("ir-label", { key: '3e4eaf9439d0697b750d397abf240462347b5a5f', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '11219f6de69d58257244565992afe9214feabac4', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '5331859e44a76d9031488dde19a6c77604983219' }, h("ir-label", { key: 'b564643d61409e0fd93878944d27062fd424d2e4', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '26a15489744c30ed198ec195cd3df7d7935b9894', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies })))));
    }
