...
export class IrRoomBreakdown {
    ...
    render() {
        return (h("div", { key: '4a6121e5d001137d3a05515bac6ea09459f4961f', class: "booking-room__details-container" }, h("div", { key: 'c42936b729a2359143ffea1797ffa9a7cbb0f01e', class: "booking-room__breakdown-row" }, h("div", { key: '241cb96b97534727cb370f08fd645d357e583f32', class: "booking-room__breakdown-table" }, h("table", { key: '11b217a497ea35fee10412b821df24c559185e2f' }, this.room.days.length > 0 &&
            (() => {
            ...
            })(), h("tr", { key: '5358dae7cedb27edc0b28bacde7309e65a86438e', class: '' }, h("th", { key: '71dba10cb790da6f5846b4d6af19eb5bcb5bb3f5', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: 'f00fe96bfc49a2638e28baae6a2aaa454db282ae', class: "booking-room__cell booking-room__cell--right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (h("th", { key: '06d004768814413100f53a5aae370f1e7278435a', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("ir-label", { key: '3e8603737191f9209d60bea06905bd412fa1a502', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: 'd94e96b029330edb957fdd20054fb789837a7f49' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'e6d62f39bd73cbe7924a572744a747d874683d08', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: 'eae5ffb8ac2083787f67f9cf3326bca138ceb191', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '9b6907f6a97734f7069e9b895ea8f8ab4981f514' }, h("ir-label", { key: 'b0952865b55ef377e0f7b04b2bbc4803a94e9de8', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '0b086673fd3b92737e0e5b9bdaf31616e0a390c4', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies })))));
    }
