...
export class IrRoom {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '00c21cd7648067403d139db95a16550394febcab', class: "p-1 d-flex m-0" }, h("ir-button", { key: '0fbf3ced05ce6ce0bc4529a712c8ca2bfe707d0a', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHandler: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: 'e68864e506f778bc781396baa5b852131c9c71bf', class: "flex-fill m-0 " }, h("div", { key: '8cd9a54d16e8f06f9f869cf585aa254eda0cc37d', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '00dbb69397a38f4c1fc46dfc212441edfac900ad', class: "m-0 p-0" }, h("span", { key: '45a89cc3bfda1cd78eba242771390c4ea301cf89', class: "m-0 p-0", style: { fontWeight: '600' } }, this.myRoomTypeFoodCat || '', ' '), ' ', this.mealCodeName, " ", this.item.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' '), h("div", { key: 'fa3ec252f1dd8485d7b81a40bd15958766db22db', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: '417b12d4aa433a13ace2f07547b6b748e1b96b34', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: 'eb7afba89d7b3fef5e18a596f5dd9e3f81a9afed', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHandler: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '834a054fca74aa23a5c27d95fdaa28acaf2c8717', variant: "icon", onClickHandler: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: '4c59224047620ab2dc82bb42ec194e3383d4e51e', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: '41f1f77e1af3137437b25ca94544b4a04f51f9d8', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && h("ir-button", { key: 'e53147bfebcbeaa9fc6a68345d675e58a197923a', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && h("ir-button", { key: 'cf18ba454a839f9fc1e8c1f4e0e95f6fbb3b37fd', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), !isSingleUnit(this.item.roomtype.id) && calendar_data.is_frontdesk_enabled && this.item.unit && (h("div", { key: 'fb5b55720caf823ebcd398819b71d687bb26ec5d', class: 'd-flex justify-content-end' }, h("span", { key: 'f2b337fe70a14eeb4111f4be9d2f7af8e621a5e4', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), h("div", { key: '78698db5fc1a61d8fc2e728e7264b9e5f254b23c' }, h("span", { key: 'c1f5c0c2628da0ea28658959314db181d3ac4476', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && h("span", { key: 'f99a8ea30febb376b5daeaed0ea02fafbfcac445', innerHTML: this.formatVariation(this.item.rateplan.selected_variation, this.item.occupancy) }, " ")), h("div", { key: '8714932f980b5a7ce1a042bab5b1babe27acbba8', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, h("div", { key: '6c3ad52d0cbb820b6d4449087fd294590299645b', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: 'ef5b7a9f4ee3385c0dcc20fc4c34219da3124e3f', class: " sm-padding-top" }, h("p", { key: 'ba8c9940b62e5825ab4ba9bf09e0354154eeb203', class: "sm-padding-right", style: { fontWeight: '600' } }, `${locales.entries.Lcz_Breakdown}:`)), h("div", { key: 'b8c41755d915f183339860b47aab96a34afca4b2', class: 'flex-fill' }, h("table", { key: '0bb6b43006361461b3d0d2f594217154bb1fea1f' }, this.item.days.length > 0 &&
            ...
            }), h("tr", { key: '3244c264de213bbca1c42addc7ff74341beaed41', class: '' }, h("th", { key: '6e5bed02e028d29012d9c2157a551a1e61eb86ab', class: "text-right pr-2 subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '37e265f29184f05eb485034045b605d29e7d0976', class: "text-right subtotal_row" }, formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && h("th", { key: '77920e70b6ced588a491cd361d36c35ce851cfe2', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), this.item.rateplan.cancelation && (h("ir-label", { key: '832593872fa2dedb045290c0eb0dddb0c9bf85c6', labelText: `${locales.entries.Lcz_Cancellation}:`, content: this.item.rateplan.cancelation || '', renderContentAsHtml: true })), this.item.rateplan.guarantee && h("ir-label", { key: '37675b4988017f73393221a3e1ab333295d95901', labelText: `${locales.entries.Lcz_Guarantee}:`, content: this.item.rateplan.guarantee || '', renderContentAsHtml: true }), this.bookingEvent.is_direct && h("ir-label", { key: '54e2884487df0076294b3c0313a6b2bffa627539', labelText: `${locales.entries.Lcz_MealPlan}:`, content: this.mealCodeName }))), h("ir-modal", { key: '63f45cf4eff6fdaf2bed9438023ac9c6c840d38c', autoClose: false, ref: el => (this.modal = el), isLoading: this.isLoading, onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: locales.entries.Lcz_Cancel, rightBtnText: locales.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: locales.entries.Lcz_Confirmation, modalBody: `${locales.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${locales.entries.Lcz_FromThisBooking}` })));
    }
