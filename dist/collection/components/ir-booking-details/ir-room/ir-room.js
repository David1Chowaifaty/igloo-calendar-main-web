...
`;
    ...
    render() {
        ...
        return (h(Host, { key: 'a9d6f9eda051e87e349b718e257080040cc4ebff' }, h("div", { key: '5f6a64088d558d86e8d228288ef1601493513e3d', class: "booking-room__header-row" }, h("button", { key: '5c29a01d6fd89c4bbb0536cb4961001b89bfb2c0', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '11ea38529c6575e0298aa2b819863bba71663d12', name: "chevron-right" })), h("div", { key: 'f519c5d4d451da547b8e358f7e41757f361041aa', style: { width: '100%', cursor: 'default' } }, h("div", { key: 'b8f5b86bf9c0231af67add0bf55a59f998b8496a',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, h("div", { key: 'b95c766b85a79f68648fc4531c51d82611fcf757', class: "booking-room__summary-row" }, h("p", { key: '5702a947796d5524fc94bbe9eccec1d2fa9baa3c', class: "booking-room__summary-text" }, h("span", { key: 'eb1a7472deb2d57ef91b48ba7c7a9fd1229be7ba', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' ', this.isHalfBoard && (h("wa-button", { key: 'edec04e432d204600bd990af359a1ff1ed2669fc', size: "xs", class: "booking-room__meal-report-button", appearance: "filled", variant: this.room?.hb_preference ? 'brand' : 'warning', onClick: () => (this.isHbDialogOpen = true) }, this.room?.hb_preference === HbPreference.Lunch ? 'With lunch' : this.room?.hb_preference === HbPreference.Dinner ? 'With dinner' : 'Choose lunch or dinner'))), h("div", { key: '71c7883474ee2cc9b9d7de363404add949f58f9c', class: "booking-room__price-row" }, h("span", { key: 'e21b09ac93f644eee311ce780bd114ec24cb928d', class: "booking-room__price" }, formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (h("div", { key: '6a6cdf0a8646b036759a15e4fa106258ca359c0b', class: "booking-room__actions" }, h("wa-dropdown", { key: '5a5fd0581fc89bf1ffaa91b85c04df7eb3e68c35', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, h("ir-custom-button", { key: 'f36a967b0b39b76e21bdd66bca6e5fdf38181235', slot: "trigger", size: "s", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, h("wa-icon", { key: '63ae76ee8bcf6ac7ca5818c4f621c93ef920b51c', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && h("wa-dropdown-item", { key: 'b948492b747bfbff16c603f006c5381110b14ac2', value: "edit" }, "Edit unit"), this.hasRoomEdit && h("wa-dropdown-item", { key: 'da0aef24dc6cc631db83fbd22ccad605f97779a7', value: "edit-rates" }, "Edit nightly rates"), isAgentMode(this.agent) && this.hasRoomEdit && h("wa-dropdown-item", { key: '019266fbabd354d5843339ac687ed1eb8c09905b', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (h("wa-dropdown-item", { key: '70d793c01a1ee51ea5b33eac5621271612a3fef6', value: "delete", variant: "danger" }, "Delete"))))))), h("div", { key: '302d8566d6e130e8d61fbb2f077a0fee143375da', class: "booking-room__dates-row" }, h("ir-date-view", { key: '4215deb9a949e4a62158462385947ce1ca2461b8', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        h("ir-unit-tag", { key: '0335b9dd730de560587e5d1c482733c9c80a5b0e', unit: this.room.unit.name })), this.hasCheckIn && (h("ir-custom-button", { key: '3845f1284a1f4d664ce9934d4886a21556bf5d35', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales.entries.Lcz_CheckIn)), this.hasCheckOut && (h("ir-custom-button", { key: '7a467e8ede6b62b24e72345b403784f078df68f4', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales.entries.Lcz_CheckOut))), h("div", { key: '5a8585e1202a0aa7c991c8d8de40fbc8dd414758', class: "booking-room__guest-row" }, h("p", { key: '0f56e31a3fbe5a4fbc6a44e8df99cc65346d4746', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h(Fragment, null, h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: '248fc4217d1e73494aeb044db5e961f1c966a6be', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (h("div", { key: '05d302fb8f0870b39fb78d731b6437464621f6f4', class: "booking-room__departure-row" }, h("p", { key: '15e6e6ec3814418963c9dc36b3873ddbfc18703f', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), h("wa-select", { key: 'caf49866be44f5ad8f48bee643da302ae85fc032', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "s", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (h("div", { key: '8eec4e35df94504ac234efebca7b3b6f805030d1', class: "booking-room__details-container" }, h("div", { key: '799df1f28cfeddbffdc1d3a89d6487ff69c8f3a3', class: "booking-room__breakdown-row" }, h("div", { key: 'c1413028a069dc14cf216a0967773f750ec2bc2f', class: "booking-room__breakdown-table" }, h("table", { key: '0dae9c59f6fa913373b0f7f7fee769f41a0dfdfb' }, this.room.days.length > 0 &&
            (() => {
            ...
            })(), h("tr", { key: '98ec7f966e0b218afa88e8516c1d9341eac2d28c', class: '' }, h("th", { key: '333d52d62ea6e503e31478549a4478dcda83919b', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: '7e7ac04815ed1b8333727bba34eede73ee10e5da', class: "booking-room__cell booking-room__cell--right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (h("th", { key: 'ebe5d819ac9160fbd1e2bb5274f85604491a854f', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (h(Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), h("ir-label", { key: '3dd30ffe853cc4e9657643715c03078202481b79', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: 'f00fe49e0431fb6e56f541b8d27b251db5e9ed9a' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'f1b591fd483d14c84307d777065fe1cfda189cac', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '1ba895bdf566f18c0ed7b148835ead1a6a72175a', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '3502b213651bd23bcef54464c74c667d49eb424d' }, h("ir-label", { key: '89926091df1e22983449d8ab30f1f709f7bf0189', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: '955fe3faaaefbf3435def71eff5932fab42767ea', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), h("ir-assignment-toggle-dialog", { key: '00571e2d65782caaf028eb008929d8912974fc05', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, h("span", { key: 'b2dbb9ad4b145e95cf1217da886bb5103fdaf310', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', h("b", { key: 'e4ef2d54a72a62d8123daa334ca8e9176cdd7b5f' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), h("ir-dialog", { key: '7e517f8faec6a95d228784f5cb6a57c1948e886b', label: this.modalReason === 'delete' ? 'Alert' : locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, h("p", { key: '6c020d77030d4b2cf82d7091b35601aca642d5c5' }, this.renderModalMessage()), h("div", { key: '16bd481509f2f0e7cd671c1f3411dd87187f1e59', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '90427dd15b4392a0bb773b9dcd3f949e9d7dcbb0', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '0f13605e919aac37dbbd39dcef74f9f42583a9c7', size: "m", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm))), h("ir-checkout-dialog", { key: '42588ba5ee83a1128acb1f9fc27c34692d0d8a2d', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), h("ir-invoice", { key: '2c4de1275716ce304e6ee81f8fdc073e5a80e3fa', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, open: this.isOpen, booking: this.booking, roomIdentifier: this.room.identifier }), h("ir-booking-pricing-drawer", { key: '4173aabdbde1e462f7e0086f7b7fb23aac0fce1e', open: this.isPricingDrawerOpen, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.clTransactions, currencySymbol: this.booking?.currency?.symbol ?? '', onCloseDrawer: () => (this.isPricingDrawerOpen = false), onPricingSaved: () => {
                this.isPricingDrawerOpen = false;
                this.resetBookingEvt.emit(null);
            } }), h("ir-hb-preference-dialog", { key: '1fa91735c488c1b23fb8572f713169bcc48a9a4b', room: this.room, open: this.isHbDialogOpen, onHbPreferenceClose: (e) => {
                e.stopImmediatePropagation();
                e.stopPropagation();
