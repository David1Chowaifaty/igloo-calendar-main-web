...
export class IrRoom {
    ...
    render() {
        ...
        return (h(Host, { key: '93d25016a5c21a22262d37ffeb2e0f12d2ab3931', class: "p-1 d-flex m-0" }, h("ir-icon", { key: '832811ae22c50c1ce7d8c9fb5e75037cb6a99bd1', id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "pointer mr-1", onClick: () => {
            ...
            }), h("tr", { key: 'c2213ea780f9a9d7f4000b255c22c0406cc3521b' }, h("th", { key: 'd2ff69f32a49aba4d3fb37d4e4b87842e83f9480', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), h("th", { key: '1490df6fff68ba16ab506158afc3ed755c7d26d0', class: "text-right" }, _formatAmount(this.item.total, this.currency)), this.item.cost > 0 && this.item.cost !== null && h("td", { class: "pl-2 text-left night-cost" }, _formatAmount(this.item.cost, this.currency))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
        ...
        })()))))), h("div", { key: 'ae4f0116244021748bf4e8efdc4842feb48db33a', class: "sm-mb-1", innerHTML: this.item.rateplan.cancelation || '' }), h("div", { key: 'c0261b3f63c5c36b2141284a2f4d425318a2a9c3', class: "sm-mb-1", innerHTML: this.item.rateplan.guarantee || '' }), h("ir-label", { key: 'e6b2feb940292c7b899bcf033cb967e5dd473f89', label: `${this.defaultTexts.entries.Lcz_MealPlan}:`, value: this.mealCodeName }))), h("ir-modal", { key: '8b07e8ce0429666dab15e69272fda451ee8c6fb8', onConfirmModal: this.deleteRoom.bind(this), iconAvailable: true, icon: "ft-alert-triangle danger h1", leftBtnText: this.defaultTexts.entries.Lcz_Cancel, rightBtnText: this.defaultTexts.entries.Lcz_Delete, leftBtnColor: "secondary", rightBtnColor: "danger", modalTitle: this.defaultTexts.entries.Lcz_Confirmation, modalBody: `${this.defaultTexts.entries['Lcz_AreYouSureDoYouWantToRemove ']} ${this.item.roomtype.name} ${this.item.unit ? this.item.unit.name : ''} ${this.defaultTexts.entries.Lcz_FromThisBooking}` })));
    }
