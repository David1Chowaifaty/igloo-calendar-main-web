...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '8a887108a0e119c64e51169b2e03411b82ca26ad' }, h("div", { key: '2a1879a101b48d0408973e6c3db1af63bda85e62', class: "booking-room__header-row" }, h("button", { key: '251c4b356ba8d0bd1009082c5a8a68fa8a2f886c', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: 'ef4c32465bb3f4d0ecd0b0d99473bc93fe3deb71', name: "chevron-right" })), h("div", { key: '6c5c1fd0b71a801d16adaafc25158bce085a969c', style: { width: '100%', cursor: 'default' } }, h("div", { key: 'be53aa357be6395049b89de626023da0668ec48c',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, h("div", { key: 'a64b467b8255d738c1d648fef272cc80f2c5bbe3', class: "booking-room__summary-row" }, h("p", { key: '46269e3dea7aa8859e8eecedade51714e9951f3f', class: "booking-room__summary-text" }, h("span", { key: '79c5c0ff997ee0f403ee07482a1c8bd23344e10e', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' ', this.isHalfBoard && (h("wa-badge", { key: 'adfadc26b53e2153a49c969f457c750767dddb58', appearance: "filled", variant: "brand" }, "With ", this.room.hb_preference === HbPreference.Lunch ? 'lunch' : 'dinner'))), h("div", { key: 'cd977fb624a476462dcea8460e414f0e6b7965df', class: "booking-room__price-row" }, h("span", { key: '44623bb56ef8f7756a7807274f1309c4dd0922a5', class: "booking-room__price" }, formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (h("div", { key: 'd3a3f56d0c96210f268a310cf06f51905e86bb20', class: "booking-room__actions" }, h("wa-dropdown", { key: '1cb66321fe23c6ca3c8a31569996a9d67b99ebbc', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
                ...
                switch (e.detail.item.value) {
                    ...
                    case 'meal-report':
                        await this.bookingService.setHbPreference({
                            ...
                            room_identifier: this.room.identifier,
                            code: this.room.hb_preference === HbPreference.Lunch ? HbPreference.Dinner : HbPreference.Lunch,
                        });
                        this.resetBookingEvt.emit();
                        break;
                    case 'toggle':
            ...
            } }, h("ir-custom-button", { key: 'fb9a581be04a596146028c7e0f070e4fccd11e2e', slot: "trigger", size: "s", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, h("wa-icon", { key: 'cc1c478493c2ed4d7de73a2e4e532cc6c00c2b3e', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && h("wa-dropdown-item", { key: 'd23c2b90cb2a0c00b931455246d63d0f436dfd69', value: "edit" }, "Edit unit"), this.hasRoomEdit && h("wa-dropdown-item", { key: 'fd4e5fe19d497be00a08a52985f12260ed28aa61', value: "edit-rates" }, "Edit nightly rates"), this.hasRoomEdit && this.isHalfBoard && (h("wa-dropdown-item", { key: '531d203f78b8cc3d1bb329d3c94bf85afeaa5caf', value: "meal-report" }, "Switch to ", this.room.hb_preference === HbPreference.Lunch ? 'dinner' : 'lunch')), isAgentMode(this.agent) && this.hasRoomEdit && h("wa-dropdown-item", { key: 'f2c7d883f2030c9275734629c86fec98f9193995', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (h("wa-dropdown-item", { key: '8d597af090c51b3e9be1ff6ade6bb38d1fa2fb08', value: "delete", variant: "danger" }, "Delete"))))))), h("div", { key: '5e27374fdc62f275cbe09b9c184b44fd19c6fa29', class: "booking-room__dates-row" }, h("ir-date-view", { key: '49135139f3cf12cbda0e28528ab6c637a768835c', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        h("ir-unit-tag", { key: '1549754bc9ac6713a3273e0f9f966759a285dede', unit: this.room.unit.name })), this.hasCheckIn && (h("ir-custom-button", { key: '99c342cdb43c2529f8b2cf4f013b5e93eebfda07', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales.entries.Lcz_CheckIn)), this.hasCheckOut && (h("ir-custom-button", { key: 'bf08e9d666c07272e7351e935fa51ad9a00f24c5', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales.entries.Lcz_CheckOut))), h("div", { key: 'be00b90f9a4a3c99e7a8407ce6274bbf6a0981af', class: "booking-room__guest-row" }, h("p", { key: '536def966d8787fe8f5eeaf8bfb6c0a107bea476', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h(Fragment, null, h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: 'b5e4830d02d9ebbcb0b2dbfdbc739e04749b9869', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (h("div", { key: '25110010eb941dec300c7b7deb4702cb8f789933', class: "booking-room__departure-row" }, h("p", { key: 'afcc71f9917ade747819a34fb94bfcfcb8260f61', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), h("wa-select", { key: '0d2d1ac5d1f0fe994552200859ad77b7eaf3b8ff', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "s", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (h("div", { key: '51885fb3688144f9d0c05ae1248e900efe04eb2c', class: "booking-room__details-container" }, h("div", { key: 'b4c98addb0bb60d77d87286262a490496e0cbdbd', class: "booking-room__breakdown-row" }, h("div", { key: '69a456cbe68a06db85aa3d4095c60ffd22e2def5', class: "booking-room__breakdown-table" }, h("table", { key: 'c32552a6419d9468bf56c32148d33053e04417c2' }, this.room.days.length > 0 &&
            (() => {
            ...
            })(), h("tr", { key: '30fb1451c7b5b7d1063b89b93d489e5e5ec7c0a3', class: '' }, h("th", { key: '6040db4db7b3b38887fc674987acfc848508147f', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-right subtotal_row" }, locales.entries.Lcz_SubTotal), h("th", { key: 'b172ad6e33aa1820c96a0db9c0e4b1d5a1973400', class: "booking-room__cell booking-room__cell--right subtotal_row" }, formatAmount(this.currency, this.room.total)), this.room.gross_cost > 0 && this.room.gross_cost !== null && (h("th", { key: 'bb4ecc6166d04b9fdfe4436c5983abfb26057170', class: "booking-room__cell booking-room__cell--right booking-room__cell--pad-left night-cost" }, formatAmount(this.currency, this.room.cost)))), this.booking.is_direct ? (h(Fragment, null, (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), h("ir-label", { key: '43b9b9600df92c64d549599b9d686e7e4b2d4e26', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: 'ad6cf7d8bd4c68432b9cda9aa45529f9acde1866' }, this.room.rateplan.cancelation && (h("ir-label", { key: 'a89faf98b55b32df0e7b4c21973944be1dfbc7c9', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: 'c407977d9fda3138a961630d9c50c5ede16ae067', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: 'ad577e3e2bf636827db0a12bec3a0a5549ab216c' }, h("ir-label", { key: '62f96903fb472d0c20930061c82dbbedbea483d3', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: 'b9060fa4631e4b11ad25bc7914bb58392bb77fe2', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), h("ir-assignment-toggle-dialog", { key: '5b106c8c77597596e45a88ea88cb4ef5de08362f', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, h("span", { key: 'b3005e57b364a8279adfa9ba30c709c0e98648cc', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', h("b", { key: '0cd948fd9d7d84f73fe570f2c3de041cf12a44c1' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), h("ir-dialog", { key: '5a4e0914e23f945b83141ced678b48a974e6e3ef', label: this.modalReason === 'delete' ? 'Alert' : locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, h("p", { key: 'e6bc2b1fcc5010f1e183de0a8da5296b9624b5fa' }, this.renderModalMessage()), h("div", { key: 'bdc4ef312d72f01454d43a3c8bff695e7fc3c6a2', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '96091b8b371726bac5b66d3588f2821da32cbab9', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '2eac814ddca21c1676070325c048980f58bd3625', size: "m", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm))), h("ir-checkout-dialog", { key: '65b873f6cae430a305140ccf522e23fe460e9ee1', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), h("ir-invoice", { key: '8afbd3d4903ace1f8120f7a54a69814b0c5401d1', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, open: this.isOpen, booking: this.booking, roomIdentifier: this.room.identifier }), h("ir-booking-pricing-drawer", { key: 'b4e2c654f30d8e2e38e157336655c38b466335c6', open: this.isPricingDrawerOpen, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.clTransactions, currencySymbol: this.booking?.currency?.symbol ?? '', onCloseDrawer: () => (this.isPricingDrawerOpen = false), onPricingSaved: () => {
