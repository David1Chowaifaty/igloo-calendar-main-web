...
export class IrRoom {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: 'b8bd7227c010fb55f41102e956383a61cc63022f', class: "p-1 d-flex m-0" }, h("ir-button", { key: 'b7789be9b099840781e066df1438162b7323d475', variant: "icon", id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${(_a = this.item.identifier) === null || _a === void 0 ? void 0 : _a.split(' ').join('')}`, "aria-expanded": this.collapsed ? 'true' : 'false', "aria-controls": "myCollapse", class: "mr-1", icon_name: this.collapsed ? 'closed_eye' : 'open_eye', onClickHanlder: () => {
                this.collapsed = !this.collapsed;
            }, style: { '--icon-size': '1.6rem' } }), h("div", { key: '2d80e5156049cf1b816c3cf16e128c6e91bcdc40', class: "flex-fill m-0 " }, h("div", { key: 'ee4d009a6abc41f7959342023e4131b22c5a030d', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '2205540b252fe2dbf30a97dd39e9849f8ca58407', class: "m-0 p-0" }, h("strong", { key: '2ef95eabfcde4a13fafa6bd9b27ad1c88b917ac6', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), h("div", { key: 'd2bb00a6a1245041fc20446b7e5a5ca3000cd5cd', class: "d-flex m-0 p-0 align-items-center room_actions_btns" }, h("span", { key: 'cfe8a1c6d78d6bae23caf3ae2bc8a49da3927b85', class: "p-0 m-0 font-weight-bold" }, formatAmount(this.currency, this.item['gross_total'])), this.hasRoomEdit && this.isEditable && (h("ir-button", { key: '8a578c06fa5fb91c1995e198de9f135288d9d150', id: `roomEdit-${this.item.identifier}`, variant: "icon", icon_name: "edit",
            // class="mx-1"
            style: colorVariants.secondary, onClickHanlder: this.handleEditClick.bind(this) })), this.hasRoomDelete && this.isEditable && (h("ir-button", { key: '558770e29981eb7a66ee9b994d5e58a9f1bdf522', variant: "icon", onClickHanlder: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, icon_name: "trash", style: colorVariants.danger })))), h("div", { key: '07a08949e96e4a3db783d874abcfd8f510dd1f7e', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: '8d2c38afb6467bd2c99e208e640420bd330b6454', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), this.hasCheckIn && h("ir-button", { key: 'cd89ef93c8dd1992341ff2acbabe472cbe017e88', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && h("ir-button", { key: 'bf1476250879bfbc3b88eede5c6720c518c3d4bc', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), h("div", { key: 'ea07331d8d4a7b843837b564ef97b1f3fc53a3e8', class: 'd-flex justify-content-end' }, calendar_data.is_frontdesk_enabled && this.item.unit && (h("span", { key: '1a1de29dcf5eff444a1847125f8c50f0d33cf710', class: `light-blue-bg ${this.hasCheckIn || this.hasCheckOut ? 'mr-2' : ''} ` }, this.item.unit.name))), h("div", { key: '180c9659dcf1e105021f3118a3362de6f908d7b4' }, h("span", { key: 'a1dfc46ff75f89d889d1c9696dc28375e9ddbd10', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && h("span", { key: '5b01039bb9b238c2fe650558620598fbe698ccba' }, " ", this.item.rateplan.selected_variation.adult_child_offering)), h("div", { key: '7bc0280abf3d0279c138b56de092c4a70cdc6604', class: "collapse", id: `roomCollapse-${(_b = this.item.identifier) === null || _b === void 0 ? void 0 : _b.split(' ').join('')}` }, h("div", { key: '0f063a4ab2eebccf11ac23feb5e250e3d80f7d38', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '875ecef20e20469efcb67b37a9d360d5a10e7ae7', class: " sm-padding-top" }, h("strong", { key: 'c7e96fc8b447a79c3fb9c105ee7706e08e68534f', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), h("div", { key: '5d192a3c445804dacff0f0770d562fdad2d2def8', class: 'flex-fill' }, h("table", { key: '0234ad0c35de0dfc7c5b445afb159df7e9604354' }, this.item.days.length > 0 &&
            ...
            }), h("tr", { key: '7283fdd26952a4945ec326a8dcf66f36bb0e12bf', class: '' }, h("th", { key: '583862912ba98de08689444ac605e9e075c0cddc', class: "text-right pr-2 subtotal_row" }, this.defaultTexts.entries.Lcz_SubTotal), h("th", { key: '6a59f7a5e5f93028f408a4e41fc67f08632d535a', class: "text-right subtotal_row" }, formatAmount(this.currency, this.item.total)), this.item.gross_cost > 0 && this.item.gross_cost !== null && h("th", { key: 'eeeb37f03ab58ae40c9269c898feb9271062bfe7', class: "pl-2 text-right night-cost" }, formatAmount(this.currency, this.item.cost))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
