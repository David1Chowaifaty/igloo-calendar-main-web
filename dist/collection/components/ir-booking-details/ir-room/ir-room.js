...
`;
    ...
    render() {
        ...
        return (h(Host, { key: '2c38bf9174e8b3932b2c4e6419d3da95ad5c3b8b' }, h("div", { key: 'a51574f26fa08671ffa8f4f7393b0baf77311005', class: "booking-room__header-row" }, h("button", { key: '290c7b105c22e19f9987ef24bcb1114014bf799b', "data-state": this.collapsed ? 'closed' : 'opened', class: "booking-room__collapse-btn", onClick: () => (this.collapsed = !this.collapsed) }, h("wa-icon", { key: '029f36da5b2f0c0345a8b340c4593068335a6b4a', name: "chevron-right" })), h("div", { key: '910ed9c2a8e37fbca0b20d8a45127553cb4019d9', style: { width: '100%', cursor: 'default' } }, h("div", { key: 'cba1d1ddfc08ce40d5688526d5a4294e0de97c1a',
            // slot="summary"
            class: "booking-room_summary", style: { width: '100%', cursor: 'default' } }, h("div", { key: 'bf0c7c085a1ff0f19b402c0044ffa6b01eed4eb8', class: "booking-room__summary-row" }, h("p", { key: 'ef2d05c84cccad1808c27dc54294c8704fffb4c5', class: "booking-room__summary-text" }, h("span", { key: '410abcdddc4df9be7f60735954052311f24273ba', class: "booking-room__summary-highlight" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.room.rateplan.is_non_refundable && ` - ${locales.entries.Lcz_NonRefundable}`, ' ', this.isHalfBoard && (h("wa-badge", { key: '167befba6658af71ff648348225c6e0588b42d47', appearance: "filled", variant: "brand" }, "With ", this.room.hb_preference === HbPreference.Lunch ? 'lunch' : 'dinner'))), h("div", { key: 'f7df46b6d80053a8356ee6de658d2403f61159f4', class: "booking-room__price-row" }, h("span", { key: '2c454394bf518a1c83697779501499388a2e35a4', class: "booking-room__price" }, formatAmount(this.currency, this.room['gross_total'])), this.isEditable && (this.hasRoomEdit || this.hasRoomDelete) && (h("div", { key: 'f17b2242524d44d4995127e7de24e97917ea9f4e', class: "booking-room__actions" }, h("wa-dropdown", { key: '59010836204961072adce5f5dafb7920e31712d7', "onwa-show": e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            }, "onwa-hide": e => {
                e.stopImmediatePropagation();
            ...
            } }, h("ir-custom-button", { key: 'f020c20953db22525fb219724f8817154de56ed7', slot: "trigger", size: "s", class: "booking-room__edit-button", appearance: "plain", id: `actions-room-${this.room.identifier}`, iconBtn: true, variant: "neutral", style: { marginBottom: '4px' } }, h("wa-icon", { key: '79478749cf34eed7ff1afc4e801d480a77fe1140', style: { fontSize: '1rem' }, label: "Actions", name: "ellipsis-vertical" })), this.hasRoomEdit && h("wa-dropdown-item", { key: '8de5cd1c89b796236e092d5969da5ff100cf7bd4', value: "edit" }, "Edit unit"), this.hasRoomEdit && h("wa-dropdown-item", { key: '7a07f373c4e32ceb7eff595ea31f73f4be7ebad8', value: "edit-rates" }, "Edit nightly rates"), this.hasRoomEdit && this.isHalfBoard && (h("wa-dropdown-item", { key: '0a7993fd686d3f8f82491027787c1bef25aa0faf', value: "meal-report" }, "Switch to ", this.room.hb_preference === HbPreference.Lunch ? 'dinner' : 'lunch')), isAgentMode(this.agent) && this.hasRoomEdit && h("wa-dropdown-item", { key: '8451c5969aafbcb0ee472cb0373f4e5303cafb6a', value: "toggle" }, "Re-assign ", this.room.agent ? 'guest' : 'agent', " folio"), this.hasRoomDelete && (h("wa-dropdown-item", { key: 'cc9c497b8c6a0811ea213f20c9a3594b8e49bdab', value: "delete", variant: "danger" }, "Delete"))))))), h("div", { key: 'bc5df7a726716226af6568a7ea704c5356e14e84', class: "booking-room__dates-row" }, h("ir-date-view", { key: '53c88a7c1e417be64c0638b7fe22a4df1701954f', format: 'ddd, MMM DD, YYYY', class: "booking-room__date-view", from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false }), !isSingleUnit(this.room.roomtype.id) && calendar_data.is_frontdesk_enabled && this.room.unit && (
        ...
        //   </ir-tooltip>
        // </div>
        h("ir-unit-tag", { key: '7ec891e8e672807daa7ca6258540283a097793f6', unit: this.room.unit.name })), this.hasCheckIn && (h("ir-custom-button", { key: '40ccfc31b108aaa6a01d6ea26757df509e58b1a5', onClickHandler: this.handleCheckIn.bind(this), id: "checkin", appearance: "outlined", variant: "brand" }, locales.entries.Lcz_CheckIn)), this.hasCheckOut && (h("ir-custom-button", { key: 'c405ab5e28abbfdbfc7544c10d39effa35a535ff', appearance: "outlined", variant: "brand", onClickHandler: () => {
                this.modalReason = 'checkout';
            }, id: "checkout" }, locales.entries.Lcz_CheckOut))), h("div", { key: 'ff7b63f3dfca10257e609ba26fdb0b8933d2acb4', class: "booking-room__guest-row" }, h("p", { key: 'f29d6434bf51b73f029900457dd7690c4af2ff57', class: "booking-room__text-reset booking-room__guest-name" }, `${this.mainGuest.first_name || ''} ${this.mainGuest.last_name || ''}`), this.room.rateplan.selected_variation.adult_nbr > 0 &&
            (this.room.unit ? (h(Fragment, null, h("wa-tooltip", { for: `view-guest-btn-${this.room.identifier}` }, "View guests"), h("ir-custom-button", { link: true, onClickHandler: () => this.showGuestModal(), id: `view-guest-btn-${this.room.identifier}`, variant: "brand", appearance: "plain" }, h("span", { innerHTML: this.formatVariation(this.room.occupancy) })))) : (h("span", { innerHTML: this.formatVariation(this.room.occupancy) }))), bed && h("p", { key: 'b396d3b9b8e72f44b5bb81beb9f56c46e783601f', class: "booking-room__text-reset booking-room__bed-info" }, "(", bed, ")")), this.includeDepartureTime && (h("div", { key: '6b62ccccc38b7bcf4bb1d3dfc5a9a341e32c4ab8', class: "booking-room__departure-row" }, h("p", { key: '401bc96a476d3b4b0c93fcf21798d12f7a4aa4ac', class: "booking-room__text-reset booking-room__departure-label" }, "Expected departure time:"), h("wa-select", { key: '545c29f57e64f1925dfe0ddfd3a74a58037c52fd', onchange: e => {
                this.updateDepartureTime(e.target.value);
            }, style: { width: '140px' }, size: "s", placeholder: "Not provided", value: this.room.departure_time?.code, defaultValue: this.room.departure_time?.code }, this.departureTime?.map(dt => (h("wa-option", { key: dt.CODE_NAME, value: dt.CODE_NAME }, dt[`CODE_VALUE_${this.language?.toUpperCase()}`] ?? dt[`CODE_VALUE_EN`]))))))), !this.collapsed && (h("div", { key: '91035b70daba735d263da213368cf8ae13b3da26', class: "booking-room__details-container" }, h("div", { key: 'acae4aea881b04856349a00cafaab78365e08da7', class: "booking-room__breakdown-row" }, h("div", { key: '260808348bdf64339af720a4ba51da8d3923ee74', class: "booking-room__breakdown-table" }, h("table", { key: '45a9e5135be6387fa3614ee43295683b6ff65ed8' }, this.room.days.length > 0 &&
            (() => {
            ...
            return filtered_data.map(d => {
        ...
        })()))))), h("ir-label", { key: '183f994ad64a25a70b512ae0c1f779d327fa9f2a', labelText: `${locales.entries.Lcz_SmokingOptions}:`, display: "inline", content: this.getSmokingLabel() }), this.booking.is_direct && (h(Fragment, { key: '9171e46b9e715a2498e3a4f47b34f9ffe67c737f' }, this.room.rateplan.cancelation && (h("ir-label", { key: '0a144a14baffa8d86e009159f28fda406d61b1c8', labelText: `${locales.entries.Lcz_Cancellation}:`, display: "inline", content: this.room.rateplan.cancelation || '', renderContentAsHtml: true })), this.room.rateplan.guarantee && (h("ir-label", { key: '4516583ba2dd78647db1c141353b0888e6d3ab74', labelText: `${locales.entries.Lcz_Guarantee}:`, display: "inline", content: this.room.rateplan.guarantee || '', renderContentAsHtml: true })))), this.room.ota_meta && (h("div", { key: '4136e675be8620d9079d6513ba02f9cf4876aeba' }, h("ir-label", { key: '10fa0861d3a858a789d48fee45a2913a180c4c4c', labelText: `${locales.entries.Lcz_MealPlan}:`, display: "inline", content: this.room.ota_meta.meal_plan }), h("ir-label", { key: 'f89dd87534565af7caeb0460f12d276a7119a2fd', labelText: `${locales.entries.Lcz_Policies}:`, display: "inline", content: this.room.ota_meta.policies }))))))), h("ir-assignment-toggle-dialog", { key: 'f3836b59f42ce4cc23a5746bd68b586f1490ede6', ref: el => (this.toggleDialogRef = el), loading: this.isToggling, onConfirmToggle: () => this.toggleRoomAgent() }, h("span", { key: '1f8dbc55f177d960f08153ba96a154a841059f55', slot: "message" }, "Move ", this.room.roomtype.name, " ", this.room.rateplan.short_name, " ", this.room.unit?.name, " to", ' ', h("b", { key: 'ff57a1427d86bcdaf2de9606e200fe6aad9de370' }, this.room.agent ? 'guest' : (this.booking?.agent?.name ?? 'agent'), " folio"), ".")), h("ir-dialog", { key: 'f37c9bd5733993fa64d409cf4a8864159dd2134e', label: this.modalReason === 'delete' ? 'Alert' : locales.entries.Lcz_Confirmation, ref: el => (this.modal = el), onIrDialogHide: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                ...
                e.stopPropagation();
                this.modalReason = null;
            }, lightDismiss: this.modalReason === 'checkin' }, h("p", { key: '36bf60cad2caa4dd9d78f3fcc20c6f4662af134e' }, this.renderModalMessage()), h("div", { key: '6157e4d339d32f28b9f90740dc5fc17229149748', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '8044851668cfb4c35541a2538692c6717f8b8d26', size: "m", "data-dialog": "close", appearance: "filled", variant: "neutral" }, locales.entries.Lcz_Cancel), h("ir-custom-button", { key: '653741a20eca63b254fd8798b76217f9bff66e9a', size: "m", loading: this.isLoading, onClickHandler: e => this.handleModalConfirmation(e), variant: this.modalReason === 'delete' ? 'danger' : 'brand' }, this.modalReason === 'delete' ? locales.entries.Lcz_Delete : locales.entries.Lcz_Confirm))), h("ir-checkout-dialog", { key: 'c7648ca32f5f806f6737875bb3f3b32cf203b0af', onCheckoutDialogClosed: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.modalReason = null;
            ...
            }, identifier: this.room.identifier, open: this.modalReason === 'checkout', booking: this.booking }), h("ir-invoice", { key: '3687c27b1a8d8f0a335aa654cd53a40c6d741306', onInvoiceClose: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
                this.isOpen = false;
            }, open: this.isOpen, booking: this.booking, roomIdentifier: this.room.identifier }), h("ir-booking-pricing-drawer", { key: 'f622211249a83b8f5e6a23856e013f80d775367b', open: this.isPricingDrawerOpen, booking: this.booking, room: this.room, agent: this.agent, folioEntries: this.clTransactions, currencySymbol: this.booking?.currency?.symbol ?? '', onCloseDrawer: () => (this.isPricingDrawerOpen = false), onPricingSaved: () => {
