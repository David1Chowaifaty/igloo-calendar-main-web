...
export class IrBookingPricingDrawer {
    ...
    render() {
        return (h("ir-drawer", { key: 'f7d156f14133bf3c3dccee74e20a16c63da7c6f6', open: this.open, label: this.drawerLabel, style: {
            ...
            } })), h("div", { key: 'b4068a29fc40ba97d70a12b1f33d210ef0b2bbba', slot: "footer", class: "ir__drawer-footer" }, h("ir-custom-button", { key: '616e1a631d3f9ab2f2f98f1850b0339ea092ae8d', appearance: "filled", size: "m", variant: "neutral", onClickHandler: () => this.closeDrawer.emit() }, "Cancel"), h("ir-custom-button", { key: '2d07ffb7e3727c9232e95a7e9672ea26b6344121', form: this.formId, size: "m", type: "submit", variant: "brand", loading: this.saveDisabled, disabled: this.allItemsDisabled }, "Confirm"))));
    }
