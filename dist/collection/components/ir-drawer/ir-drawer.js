...
export class IrDrawer {
    ...
    render() {
        return (h("wa-drawer", { key: 'e28d1ee3819331f6230e27db1c48627c4d5aa04a', id: this.el.id, "onwa-show": this.onDrawerShow, "onwa-hide": this.onDrawerHide, class: "ir__drawer", style: { '--size': 'var(--ir-drawer-width,40rem)' }, open: this.open, label: this.label, placement: this.placement, withoutHeader: this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotManager.hasSlot('header-actions') && h("slot", { key: '854465ecd74cbca8f1bcbb2d2affd1146b8e4573', name: "header-actions", slot: "header-actions" }), this.slotManager.hasSlot('label') && h("slot", { key: '36c480612f87f082347a5133605a1ba7de960e4f', name: "label", slot: "label" }), h("slot", { key: '2a46f8ff2e09ead27c654be815f6d60444e3b3b8' }), this.slotManager.hasSlot('footer') && h("slot", { key: 'b8d51682384a9bce4662d520900e3837b45cb172', name: "footer", slot: "footer" })));
    }
