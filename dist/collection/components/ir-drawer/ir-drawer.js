...
export class IrDrawer {
    ...
    render() {
        return (h("wa-drawer", { key: '07a49f032d4ee8b8611aca3524c56b1972f89789', id: this.el.id, "onwa-show": this.onDrawerShow, "onwa-hide": this.onDrawerHide, class: "ir__drawer", style: { '--size': 'var(--ir-drawer-width,40rem)' }, open: this.open, label: this.label, placement: this.placement, withoutHeader: this.withoutHeader, lightDismiss: this.lightDismiss, exportparts: "dialog, header, header-actions, title, close-button, close-button__base, body, footer" }, this.slotManager.hasSlot('header-actions') && h("slot", { key: '963cf3df034018ee0287d7fb05c42f8bbcd22029', name: "header-actions", slot: "header-actions" }), this.slotManager.hasSlot('label') && h("slot", { key: '7cbf1f03f659e8f6fb281a4d28a95f898880c3a4', name: "label", slot: "label" }), h("slot", { key: 'fa474cf96f2e6a896c224c78f67833a7ed0a7be6' }), this.slotManager.hasSlot('footer') && h("slot", { key: 'cbfd0c34a24f3960e1887ab4e828522b26035c19', name: "footer", slot: "footer" })));
    }
