...
export class IrMealReportFilters {
    ...
    render() {
        ...
        return (h("ir-filter-card", { key: '3db8b2ed81b04417647fc5e78b1f5754ba974955' }, h("wa-radio-group", { key: '7e8c49a5e781e4e787983186ca0d3d409b9684ed', label: "Report type", size: "s", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, h("wa-radio", { key: '9aff7dc20bf2bd98ce10d9164b5ba20d24ffeebb', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, "Guest list"), h("wa-radio", { key: '82f0c056b8ae8e9019317e1c3881e47df9849723', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, "Meal count")), this.reportType === 'GUEST_LIST' ? (h("wa-radio-group", { label: "Stay date", size: "s", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            } }, this.lcz.Lcz_Reset || 'Reset'), h("ir-custom-button", { key: '51c0ca15517bd9d5a743399f485c9957cfaa06e3', type: "button", size: "s", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
