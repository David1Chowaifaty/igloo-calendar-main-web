...
export class IrMealReportFilters {
    ...
    render() {
        ...
        return (h("ir-filter-card", { key: 'b799236c1abd5b6378362a80cbf90eba0ed1e776' }, h("wa-radio-group", { key: 'df48fdaa245f8327a7fb3d9bad7c6f88cee8ad80', label: "Report type", size: "s", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, h("wa-radio", { key: '824c8e749fa11f68ca4f3da2063e2734c2efe57e', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, "Guest list"), h("wa-radio", { key: '9a093981bce1e32cc8d4c420d13e9e2dbd1c33b6', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, "Meal count")), this.reportType === 'GUEST_LIST' ? (h("wa-radio-group", { label: "Stay date", size: "s", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            (mealTypes.length > 0 ? (h("wa-radio-group", { defaultValue: this.mealType, label: "Meal type", size: "s", orientation: "horizontal", value: this.mealType, style: { width: '100%' }, onchange: e => {
                ...
                } }, mealTypes.map(type => (h("wa-radio", { style: { flex: '1' }, appearance: "button", value: type.CODE_NAME }, type.CODE_VALUE_EN))))) : (h("div", { class: "ir-meal-report-filters__warning" }, "No meal types found."))), h("div", { key: '2906b958399731e73de3d18d5084a3c7bc1c72a8', slot: "footer" }, h("ir-custom-button", { key: '2bc52831087ba90217ccf76c2f574b19524fca11', type: "button", size: "s", variant: "neutral", appearance: "filled", onClickHandler: (e) => {
                const ev = e.detail;
            ...
            } }, this.lcz.Lcz_Reset || 'Reset'), h("ir-custom-button", { key: 'd3dec409911264239a52471c1d6ad7bed9263485', type: "button", size: "s", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
