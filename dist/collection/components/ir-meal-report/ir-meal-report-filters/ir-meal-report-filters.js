...
export class IrMealReportFilters {
    ...
    render() {
        ...
        return (h("ir-filter-card", { key: 'ad908aab7e813509aec2a0ce7b48cb9a5b7e5ad4' }, h("wa-radio-group", { key: '5409025a247597e9013d41506abcd366e355467f', label: t('Lcz_ReportType', { fallback: 'Report type' }), size: "s", orientation: "horizontal", value: this.reportType, onchange: e => {
                this.reportTypeChange.emit(e.target.value);
            } }, h("wa-radio", { key: 'a7c23708177479eaed39009bb48816e8cd1e7002', style: { flex: '1' }, appearance: "button", value: "GUEST_LIST" }, t('Lcz_GuestList', { fallback: 'Guest list' })), h("wa-radio", { key: '5ec70997fd3a57b90f66708444b09e10ed0f3e9d', style: { flex: '1' }, appearance: "button", value: "MEAL_COUNT" }, t('Lcz_MealCount', { fallback: 'Meal count' }))), this.reportType === 'GUEST_LIST' ? (h("wa-radio-group", { label: t('Lcz_StayDate', { fallback: 'Stay date' }), size: "s", orientation: "horizontal", value: selectedPreset, onchange: e => {
            ...
            } }, t('Lcz_Reset', { fallback: 'Reset' })), h("ir-custom-button", { key: '0987d021fe23d4e32b6a442068797d1a4c959d88', type: "button", size: "s", variant: "brand", loading: this.isLoading, onClickHandler: (e) => {
                const ev = e.detail;
                if (ev && typeof ev.preventDefault === 'function') {
                    ev.preventDefault();
                    ev.stopPropagation();
