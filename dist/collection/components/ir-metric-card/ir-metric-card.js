...
export class IrMetricCard {
    ...
    render() {
        ...
        return (h(Host, { key: '718521dde1e2792be5faac7d8cd77974387b0f04', role: this.clickable ? 'button' : null, tabindex: interactive ? '0' : null, "aria-label": this.clickable ? ariaLabel : null, "aria-busy": this.loading ? 'true' : null, onClick: interactive ? this.handleActivate : undefined, onKeyDown: interactive ? this.handleKeyDown : undefined }, h("div", { key: 'eccfb4d71b2d094e9cc937f76790999c19c42bc3', part: "base", class: "metric" }, (hasIcon || this.label) && (h("div", { key: '70bff4de25d804e70ed27c8070924ef39a9ad619', part: "header", class: "metric__header" }, hasIcon && this.renderIcon(), h("span", { key: 'e613d8b9288ca6401903509639e5b9832fea5751', part: "label", class: "metric__label" }, h("slot", { key: '59e7b9f40e5ae2a271293de3f6753967209d8c2e', name: "label" }, this.label)))), this.loading ? (h("div", { class: "metric__skeleton" }, h("span", { class: "metric__skeleton-bar metric__skeleton-bar--value" }), h("span", { class: "metric__skeleton-bar metric__skeleton-bar--caption" }))) : (h("div", { class: "metric__main" }, h("div", { part: "value", class: "metric__value" }, h("slot", { name: "value" }, this.value !== undefined && this.value !== null && h("span", { class: "metric__value-number" }, this.value), this.unit && (h("span", { part: "unit", class: "metric__unit" }, this.unit))), this.renderTrend()), this.caption && (h("p", { part: "caption", class: "metric__caption" }, this.caption)))), h("div", { key: 'bb9ecb692a2f72bc501c34f1ebd260d96ed938e2', part: "body", class: "metric__body" }, h("slot", { key: '095da1fc329e885b06895b235efc67f53ed2a2bb' })), h("div", { key: 'ea0430e26daec0e5ad00804d40b88a8bdf411e76', part: "footer", class: "metric__footer" }, h("slot", { key: '602ab1452db0c3e92d522c2c2e439b9fde73d94b', name: "footer" })))));
    }
