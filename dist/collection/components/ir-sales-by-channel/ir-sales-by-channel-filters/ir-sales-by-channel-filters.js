...
export class IrSalesByChannelFilters {
    ...
    render() {
        ...
        return (h("ir-filters-panel", { key: '3323ac7ac602326aade7405e7c1f49b6c7fa7233', isApplyLoading: this.isLoading, onIrFilterApply: () => {
            ...
            }, fromDate: moment(this.filters.FROM_DATE, 'YYYY-MM-DD'), toDate: moment(this.filters.TO_DATE, 'YYYY-MM-DD'), maxDate: moment().format('YYYY-MM-DD'), withOverlay: false }))), h("div", { key: 'ae9012fa51504124905f9ff8258b7ee9a28999e5', class: "d-flex align-items-center mt-1 mb-2 compare-year-toggle", style: { gap: '0.5rem' } }, h("label", { key: 'b16ddac397dd708b6bfa2a326dda681b55109a2c', htmlFor: "compare-prev-year", style: { paddingBottom: '0.25rem' } }, "Compare with previous year"), h("ir-checkbox", { key: '1888f667375c639c45631098ecae869f6b063503', checked: this.filters?.include_previous_year, checkboxId: "compare-prev-year", onCheckChange: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
