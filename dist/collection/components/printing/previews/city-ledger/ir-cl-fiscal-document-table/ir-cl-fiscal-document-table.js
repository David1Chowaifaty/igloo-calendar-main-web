...
export class IrClFiscalDocumentTable {
    ...
    render() {
        return (h(Host, { key: '15ea151628f8ebf8d18ceb0fd1f086c835337c07' }, h("section", { key: 'c61b5d018fa85b2897f1605c9452ef25cb6ee41b', class: "invoice-items" }, h("table", { key: '04d80a00731c568e36316bef125480d6f2a17fef', class: "cl-table" }, h("thead", { key: 'b318fbf89b7073353354eb53b7a218c23a03170e' }, h("tr", { key: '91870945a5198042f358b6559c964687c27ca48d' }, h("th", { key: '21020ba62175ed078fa33870e09ae4b754903bac', class: "cl-th" }, "Date"), h("th", { key: 'df31e5739aba4875c0aeeff53efbdfba14ad2574', class: "cl-th", style: { width: '100%' } }, "Description"), h("th", { key: 'cf763165f6c10bf5c679435514aba46825314704', class: "cl-th cl-th--num" }, "Net Price"), h("th", { key: '6c2fb18d13437858854e1eda07ebcb1bc8595eba', class: "cl-th" }, "VAT"), h("th", { key: 'bb0053ce4082615dbb3504ba385575eb15b56996', class: "cl-th cl-th--num" }, "VAT Amount"), this.showCityTax && (h("th", { key: '6ae44075dbb6aadaa485f2faa9e452c459466aff', class: "cl-th" }, "City ", h("br", { key: 'c3ebcdf5d3a27598bb3541b7d0a645f6d2c648e0' }), "Tax")), this.showCityTax && (h("th", { key: 'e1115f3110f142e1c8c77eacd45f8254ce44fdd2', class: "cl-th cl-th--num" }, "City Tax", h("br", { key: '426f521172f8d8ce62910b8b2293785ab1bd8c8f' }), " Amount")), h("th", { key: '4ea16a800e8c70d4e8c7a9b624679692c92ccfef', class: "cl-th cl-th--num" }, "Total"))), h("tbody", { key: '1d6b59e1f677fa64dbcb4708734db0fe8bf48841' }, this.transactions.length === 0 ? (h("tr", null, h("td", { class: "cl-td cl-td--empty", colSpan: this.showCityTax ? 8 : 6 }, "No transactions found for this document."))) : (h(Fragment, null, groupData(this.transactions).map(item => this.renderTopLevelItem(item)), this.renderTotals())))))));
    }
