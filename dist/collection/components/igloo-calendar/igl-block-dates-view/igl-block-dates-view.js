...
export class IglBlockDatesView {
    ...
    render() {
        return (h(Host, { key: 'b031d1045a7bd0032016d570705d4e1f97b1ef16' }, h("div", { key: 'ad1372d29a56b87d2cb27591f4029951be44a1de', class: `m-0 p-0 mb-1` }, h("div", { key: 'adb37ae346468f7daa6e20c1ac00b5e46e55adb4', class: "text-left p-0" }, h("ir-date-view", { key: '2b81b220526a57314fb498d27a7e4234e6d1c5d0', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), h("div", { key: '52969cfb89a6ab61bcdcdec5de96b7b19bd880cc', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, h("div", { key: '2dce43d2388432d7f14f88c04f2182a767ab4c44', class: "mb-1 " }, h("label", { key: '964d29a5fbe22f5ad587e2beb4b3be9039cab7cc', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales.entries.Lcz_Reason, ":"), h("div", { key: '94d463177aec29c89b0d8a807f619a29ff3a0b86', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, h("input", { key: '8ee52f8a1570a90f8ad4279f32ab39377b7619ac', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), h("span", { key: '5bb8e8b0671e3063debbe06c9160688e21681ee1', class: "align-middle out-of-service-label" }, locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (h("div", null, h("div", { class: "mb-1 d-flex  align-items-center" }, h("span", { class: "align-middle" }, locales.entries.Lcz_Or, " "), h("div", { class: "d-inline-flex col pr-0 align-middle" }, h("input", { class: "form-control", type: "text", placeholder: locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), h("div", { class: "mb-1 w-100 pr-0 " }, h("span", { class: "text-bold-700 font-medium-1" }, locales.entries.Lcz_AutomaticReleaseIn, ": "), h("div", { class: "d-inline-block" }, h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (h("div", { class: "d-inline-block releaseTime" }, h("em", null, locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
