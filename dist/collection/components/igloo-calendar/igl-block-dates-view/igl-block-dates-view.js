...
export class IglBlockDatesView {
    ...
    render() {
        ...
        return (h(Host, { key: 'fc3259f8f1c7db2d7e5c1155d9bd6c11484a2a00' }, h("div", { key: '35f7140496c62384ba377254ab08d439b06f9358', class: `m-0 p-0 mb-1` }, h("div", { key: '801901e7d18d709d055aa3e49691f459039a738a', class: "text-left p-0" }, h("ir-date-view", { key: 'b6bf3fd1c1a413ff97e545769ae0241b8d7bc006', from_date: this.fromDate, dateOption: "YYYY-MM-DD", showDateDifference: false, to_date: this.toDate }))), h("div", { key: '7dc393bc37a9f820ace54c53d82de8c7573d04d3', class: ` mb-1 text-left ${this.isEventHover && 'p-0'}` }, h("div", { key: '8fe45f93a819a77744b1f82a75f9b55643acde3a', class: "mb-1 " }, h("label", { key: '87b849300cb9c40f13ccf6b88dc6fc86b85f4f0c', class: "p-0 text-bold-700 font-medium-1 m-0 align-middle" }, locales.entries.Lcz_Reason, ":"), h("div", { key: 'a4485892af9b9c686fe853e2075e9e67e8f346f9', class: "p-0 m-0 pr-1  controlContainer checkBoxContainer d-inline-block align-middle" }, h("input", { key: 'c7a43a043b9a2b2505a87c8ccdd9258ad63bb002', class: "form-control", type: "checkbox", checked: this.blockDatesData.OUT_OF_SERVICE, id: "userinput6", onChange: event => this.handleOutOfService(event) })), h("span", { key: 'b79cdf3747e937ccab1ed25c742e1a3f2c943973', class: "align-middle out-of-service-label" }, locales.entries.Lcz_OutOfservice)), !this.blockDatesData.OUT_OF_SERVICE ? (h("div", null, h("div", { class: "mb-1 d-flex  align-items-center" }, h("span", { class: "align-middle" }, locales.entries.Lcz_Or, " "), h("div", { class: "d-inline-flex col pr-0 align-middle" }, h("input", { class: "form-control", type: "text", placeholder: locales.entries.Lcz_OptionalReason, id: "optReason", value: this.blockDatesData.OPTIONAL_REASON, onInput: event => this.handleOptionalReason(event) }))), h("div", { class: "mb-1 w-100 pr-0 " }, h("span", { class: "text-bold-700 font-medium-1" }, locales.entries.Lcz_AutomaticReleaseIn, ": "), h("div", { class: "d-inline-block" }, h("select", { class: "form-control input-sm", id: "zSmallSelect", onChange: evt => this.handleReleaseAfterChange(evt) }, this.releaseList.map(releaseItem => (h("option", { value: +releaseItem.CODE_NAME, selected: Number(this.blockDatesData.RELEASE_AFTER_HOURS) == Number(releaseItem.CODE_NAME) }, releaseItem.CODE_VALUE_EN))))), this.blockDatesData.RELEASE_AFTER_HOURS ? (h("div", { class: "d-inline-block releaseTime" }, h("em", null, locales.entries.Lcz_On, " ", this.getReleaseHoursString()))) : null))) : null)));
    }
