...
export class IglSplitBooking {
    ...
    render() {
        return (h("form", { key: '50945ea9bbb4313664222e8ebd0a4460f04e7d74', onSubmit: e => {
                e.preventDefault();
                this.doReservation();
            }, class: "sheet-container" }, h("ir-title", { key: 'b9e768c8abf5baaaeae4d7dc66073cebd16b3248', class: "px-1 sheet-header mb-0", displayContext: "sidebar", onCloseSideBar: () => this.closeModal.emit(), label: `Split unit ${this.room?.unit['name']}` }), h("section", { key: 'e4c3eb7b21e147749987bc9d75c308e85d56b870', class: "px-1 sheet-body" }, h("div", { key: '4c8d4e9f130702196e43cde9d9b2b4fcdef6ec04', class: "d-flex align-items-center", style: { gap: '0.5rem' } }, h("div", { key: '616b011d470957c5cfc9b6910cc967cc551d2b26' }, h("ir-date-view", { key: '6169c155f10888a795095a4c1f842a01e9550a43', from_date: this.room.from_date, to_date: this.room.to_date, showDateDifference: false })), h("p", { key: '561b25a48ef0a0cdf71fb0c1cc1c41e8b9ecacb6', class: "m-0 p-0" }, this.room.rateplan.short_name, " ", this.room.rateplan.is_non_refundable ? locales.entries.Lcz_NonRefundable : '')), h("div", { key: '48875c52c67278b45e8d50459d6a43e869bc8d23', class: 'd-flex align-items-center mt-1', style: { gap: '0.5rem' } }, h("span", { key: 'df9b32f653580da391094f4ff9114def113aa879' }, "From:"), h("ir-date-picker", { key: '6af4513cff67ecff00263660d5c2f79e17f9a55e', "data-testid": "pickup_arrival_date", date: this.selectedDates?.from_date?.format('YYYY-MM-DD'), maxDate: this.defaultDates?.to_date.format('YYYY-MM-DD'), minDate: this.defaultDates?.from_date.format('YYYY-MM-DD'), emitEmptyDate: true,
            ...
            } }, h("input", { key: 'da36f1acfed1ee80f6f808af81c589f31d3138ee', type: "text", slot: "trigger", value: this.selectedDates.from_date ? this.selectedDates.from_date.format('MMM DD, YYYY') : null, class: `form-control input-sm  text-center`, style: { width: '120px' } })), h("ir-button", { key: 'b2bb8d8c11097b118164bedb143d2acf5ef3155b', isLoading: isRequestPending('/Check_Availability'), text: "Check available units", size: "sm", onClick: () => this.checkBookingAvailability() })), this.errors?.roomtype_id && h("p", { key: '43b57752c97babe1d8a7e2986c420352159e422d', class: "text-danger text-left mt-2" }, "Please select a room"), h("ul", { key: '3c29745bb96bc8019a25b315453ddd2059cafd04', class: "room-type-list mt-2" }, this.roomTypes?.map(roomType => {
        ...
        }))), h("div", { key: '6ff9db4435f0e5eb4db6905bdef2389207f9f087', class: 'sheet-footer' }, h("ir-button", { key: '7e64d7482e18592245860472cb17eb926aba0ff2', text: locales.entries.Lcz_Cancel, btn_color: "secondary", class: 'flex-fill', onClickHandler: () => this.closeModal.emit(null) }), h("ir-button", { key: '527248a32ecfb840936f279f4b6a952083807f79', isLoading: this.isLoading, text: locales.entries.Lcz_Confirm, btn_type: "submit", class: "flex-fill" }))));
    }
