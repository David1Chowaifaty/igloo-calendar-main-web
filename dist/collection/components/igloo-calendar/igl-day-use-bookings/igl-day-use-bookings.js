...
export class IglDayUseBookings {
    ...
    render() {
        ...
        return (h(Host, { key: '0fb477466949e66247319ea08906f202064eb8c3' }, h("div", { key: 'ba6a2e5ad1b3d7b4a9c4b223a0f7af9340c7a9ef', class: "dub-panel" }, h("div", { key: '9350617ffd97fc1cc0da277683b05dded065b09d', class: "dub-panel__head" }, h("header", { key: '1ef38886cd12c1ea3a842f4151242bcea2d3e64d', class: "dub-panel__header" }, h("h2", { key: 'c9997cc8375244818bd3f302ad9b5b9981b19d34', class: "dub-panel__title", id: "day-use-bookings-title" }, "Day Use Bookings"), h("ir-custom-button", { key: '76ade2f807f2b7f94a4d26dc73a154e410d66480', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: '5a942ca3fd6f9f6e2de73099daa2f7641e407831', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: 'ee00daf9568611ddf231ac5b20a7377ca3fc903b', class: "dub-panel__toolbar" }, h("wa-select", { key: '82b5516a7d427b8a7675f1bc0523c45b84f91a06', size: "s", "aria-label": "Date", value: this.selectedDate, defaultValue: this.selectedDate, onchange: evt => (this.selectedDate = evt.target.value) }, this.orderedDates.map(date => (h("wa-option", { value: date }, moment(date, 'YYYY-MM-DD').format('ddd, DD MMM YYYY')))))))), h("div", { key: 'fe638ef4a941d237e09aebf237d4286fe120541d', class: "dub-panel__body" }, isEmpty ? (h("ir-empty-state", { message: "No day-use bookings for this date." })) : (Array.from(grouped.entries()).map(([roomTypeId, roomTypeBookings]) => this.renderCategory(roomTypeId, roomTypeBookings)))))));
    }
