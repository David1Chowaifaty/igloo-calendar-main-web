...
export class IglRateExtenderForm {
    ...
    render() {
        ...
        return (h("form", { id: "rate-extender-form", class: "rate-extender-form", onSubmit: e => {
            ...
            return [
                h("ir-validator", { key: day.date, value: day.amount, schema: z.number().min(0) }, h("ir-input", { disabled: this.disabled(), class: "rate-extender-input", "aria-describedby": "rate cost", "aria-label": "rate", "onText-change": e => this.handleInput(e.detail, index), value: day.amount.toString(), defaultValue: day.amount.toString(), mask: 'price', label: moment(day.date).format('ddd, MMM D') }, h("span", { slot: "start" }, currency_symbol))),
