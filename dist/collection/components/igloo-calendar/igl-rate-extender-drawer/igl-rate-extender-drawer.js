...
export class IglRateExtenderDrawer {
    ...
    render() {
        return (h("ir-drawer", { key: 'd036a72f894f52523875f82a4bde41681d86fd87', open: this.open, label: this.label, onDrawerHide: this.handleDrawerHide }, this.open && (h("igl-rate-extender-form", { key: '65f90ee07d6bdd4f5ca0f15f0daeaaad5372a42c', bookingNumber: this.bookingNumber, propertyId: this.propertyId, language: this.language, identifier: this.identifier, toDate: this.toDate, fromDate: this.fromDate, pool: this.pool, defaultDates: this.defaultDates, onLoadingChanged: e => {
                e.stopImmediatePropagation();
                e.stopPropagation();
            ...
            } })), h("div", { key: '05d4b824d67bb928eb0b97930e19329bb516012b', slot: "footer", class: 'ir__drawer-footer' }, h("ir-custom-button", { key: '52d457b0602a584b41d872e4f105d3c5c45641a8', size: "medium", appearance: "filled", variant: "neutral", "data-drawer": "close" }, "Cancel"), h("ir-custom-button", { key: 'bfcf6e463f3b4d125a5426178a290aa765d51ef5', loading: this.isLoading, disabled: !this.hasInventory, size: "medium", type: "submit", form: "rate-extender-form", appearance: "accent", variant: "brand" }, "Confirm"))));
    }
