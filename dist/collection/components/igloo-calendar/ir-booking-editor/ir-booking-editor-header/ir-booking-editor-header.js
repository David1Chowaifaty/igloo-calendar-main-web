...
export class IrBookingEditorHeader {
    ...
    render() {
        ...
        return (h(Host, { key: 'fa21296249fd87b31e3087f99edd3846a19f5e4e' }, h("form", { key: '3f20448d49bc828b69b4ae56ef0bdb4fdc7b448b', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (h("ir-validator", { key: 'd7b2398a683ae950071a0d492a1487f82f42612b', value: booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, h("ir-picker", { key: '720c001f3d9c5cd077320dd2f73bc95cd5257271', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales.entries.Lcz_Tobooking}#`,
