...
export class IrBookingEditorHeader {
    ...
    render() {
        ...
        return (h(Host, { key: '8c0c9a8fddd63648398a9ac7df7227119b78c389' }, h("form", { key: 'f353975e6b919ef4cb54df8208e4f35c8617f742', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (h("ir-validator", { key: '7aeedc059ceab650c418880e403f05028b757d72', value: booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, h("ir-picker", { key: 'a26fc10346491e985775b7232c8dd208a0cb17bf', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales.entries.Lcz_Tobooking}#`,
