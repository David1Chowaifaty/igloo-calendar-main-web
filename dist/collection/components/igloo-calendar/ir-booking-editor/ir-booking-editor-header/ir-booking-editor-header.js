...
export class IrBookingEditorHeader {
    ...
    render() {
        ...
        return (h(Host, { key: '405ccb3c0239da1bb64a0af1d8faeaa0a5137a1c' }, h("form", { key: 'd03b049b6eae3e0431f49c3113116113df4d12be', onSubmit: this.handleSubmit.bind(this) }, this.bookingEditorService.isEventType('SPLIT_BOOKING') && (h("ir-validator", { key: 'ae04f515179fe3edbe187cd4ba0f22021220d625', value: booking_store.bookedByGuest, class: "booking-editor-header__booking-picker-validator", showErrorMessage: true, schema: this.BookedByGuestPickerSchema }, h("ir-picker", { key: '64896da44128a0bc07e0d01a530c1825d00ff8ba', withClear: true, mode: "select-async", class: "booking-editor-header__booking-picker", debounce: 300, ref: el => (this.pickerRef = el), label: `${locales.entries.Lcz_Tobooking}#`,
            ...
            }, variant: "booking", withDateDifference: true, minDate: this.minDate, maxDate: this.maxDate, onDateRangeChange: this.handleDateRangeChange.bind(this) }))), !this.bookingEditorService.isEventType(['EDIT_BOOKING', 'EDIT_DAY_USE']) && (h(Fragment, { key: 'aa2c831bf21b6208ae2db5bfdc122e00e098853f' }, h("ir-validator", { key: 'b49a50aae6908932499b2e3e88db586a42e84fea', value: adults, schema: this.adultsSchema }, h("wa-select", { key: 'c1dc46f7f0acb136ec20a0496020603162d6850b', class: "booking-editor-header__adults-select", size: "s", placeholder: locales.entries.Lcz_AdultsCaption, value: adults?.toString(), defaultValue: adults?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleAdultsChange.bind(this) }, Array.from({ length: calendar_data.property.adult_child_constraints.adult_max_nbr }, (_, i) => i + 1).map(option => (h("wa-option", { value: option.toString() }, option))))), calendar_data.property.adult_child_constraints.child_max_nbr > 0 && (h("wa-select", { key: 'cedb6186b64e365deb96b906b0bc2fca73bbfc96', class: "booking-editor-header__children-select", size: "s", placeholder: this.childrenSelectPlaceholder, value: children?.toString(), defaultValue: children?.toString(),
            // onwa-hide={this.stopEvent.bind(this)}
            onchange: this.handleChildrenChange.bind(this) }, Array.from({ length: calendar_data.property.adult_child_constraints.child_max_nbr }, (_, i) => i + 1).map(option => (h("wa-option", { value: option.toString() }, option))))))), h("ir-custom-button", { key: '2f8ebeaa5b58c5f3c3b4f804de6dfe765814d375', loading: this.isLoading, type: "submit", variant: "brand" }, "Check")), booking_store.roomTypes?.length > 0 && !this.isLoading && calendar_data.tax_statement && (h("wa-callout", { key: 'ac373218e62eea5fe730b530dec579a4f06239df', size: "s", variant: "neutral", appearance: "filled", class: "booking-editor-header__tax_statement" }, calendar_data.tax_statement)))));
    }
