...
export class IglBulkStopSale {
    ...
    render() {
        return (h("form", { key: 'fe0ccaaa17aa7f2eea89f840dc0ed2ff22335efb', id: this.formId, class: 'bulk-sheet-container', onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("div", { key: '697db232df7179aa7ac281c35da49743fd2b3b49', class: "sheet-body px-1" }, h("div", { key: '082572258e94bf8056820552a4c46c63284c74c7', class: "text-muted text-left py-0 my-0" }, h("p", { key: '790f67949eb2f2cae2d25f0cc99f3b0f28a6e49a' }, "Select the types to stop or open sales for all related rate plans")), h("div", { key: 'cf1d316c95834e1caf00081afbfa1ae426fcd865' }, this.errors === 'rooms' && (h("p", { key: '4398baf65f12bdfa7ba5acbe51e6f49f0ce4473f', class: 'text-danger text-left smaller p-0 ', style: { 'margin-bottom': '0.5rem' } }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("table", { key: '6804d82582d874138eb7310a861364da622fab18', ref: el => (this.unitSections = el) }, h("thead", { key: '6db2b493b293129e6aff09feda9df6872af006cc' }, h("tr", { key: '9a10ade430c70bc32de607a6b382b069da96f027' }, h("th", { key: 'abbdcd7fdb754879e75b5ede90c23d1a5f4cca89', class: "sr-only" }, "choice"), h("th", { key: 'f0adf5a5691aadec53092fe7d0ed60f6ae96b508', class: "sr-only" }, "room type"))), h("tbody", { key: 'f266c0c1e2b4bd4f4160c44a86416e6fd52e8119' }, calendar_data.roomsInfo.map((roomType, i) => {
        ...
        })))), h("p", { key: 'bd1d652de7b68c35635459a555e8af8cf9036cfd', class: "text-left mt-2 text-muted" }, "Included days"), this.errors === 'weekdays' && h("p", { key: 'e35af50a6a2464f2754746260b71c87d7318c4b3', class: 'text-danger text-left smaller m-0 p-0' }, "Please select at least one day"), h("ir-weekday-selector", { key: 'fa972bc94a0a25b84ed05393c592ed1d8f0c8f03', ref: el => (this.weekdaysSections = el), weekdays: Array.from(this.selectedWeekdays), onWeekdayChange: e => {
                e.stopPropagation();
                e.stopImmediatePropagation();
                this.selectedWeekdays = new Set(e.detail);
            } }), h("table", { key: '7e0a48841590047dafd256f57bcb2b3829d04608', class: "mt-1", ref: el => (this.datesSections = el) }, h("thead", { key: '0e36f2f4dafbf6e006a26e0176c807785c9316e5' }, h("tr", { key: 'a1b1f4c2764eba0754470cfad750bd99f70c1b6e' }, h("td", { key: '6bff324fdd1f0c33a87915f993b1d3ab9b493901', class: "text-left bulk-stop-sale__date-label" }, locales.entries.Lcz_From), h("td", { key: '99f53d8e26cd479678dadff78044ca716b787e25', class: "text-left bulk-stop-sale__date-label" }, locales.entries.Lcz_ToExclusive), h("td", { key: 'a5ab9cc981aa368aa8edf1838d73e4f495bc833e' }, this.dates.length !== this.maxDatesLength && (h("ir-custom-button", { key: '4b2c22999ea167550e0a91bda2a331d3147a4784', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, h("wa-icon", { key: '30a552892bdf0b551ae32e11a3ec72ac41e819a4', name: "plus", style: { fontSize: '1.2rem' } })))))), h("tbody", { key: 'bb45e7e6f7c01b741fea477c1f9812aaf9446340' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
