...
export class IglBulkBlock {
    ...
    render() {
        return (h("form", { key: 'f59820b68fc2068ff4342ceda895f63516ea7aea', id: this.formId, class: "igl-bulk-block__form", onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("wa-radio-group", { key: '1b2cdeae951ef52df04c37998c31da1e0a2c35d4', size: "s", label: "Block or unblock a unit", orientation: "horizontal", name: "action" }, h("wa-radio", { key: '828e4b9c1c14b16859a3d856b14bba3b6fe724e5', style: { flex: '1 1 0%' }, appearance: "button", value: "block" }, "Block"), h("wa-radio", { key: 'cb4cf9ce2e010def68e4ee98e51d93bfc7b3a2ca', style: { flex: '1 1 0%' }, appearance: "button", value: "unblock" }, "Unblock")), h("div", { key: 'fa0b7519cebbe7136c4c0cebef8941b087a0f020' }, this.errors === 'rooms' && (h("p", { key: '7bb7ab9db37c4313a176e75c359c79444a5f433d', class: "igl-bulk-block__error" }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("wa-radio-group", { key: '2b02860ca9ca066b64b1ac8a7923f31022163470', name: "unit", ref: el => (this.unitSections = el), onchange: e => {
        ...
        }))), h("table", { key: 'a30844565050a84c72392291a7a0be4fda81cdf8', class: "igl-bulk-block__dates-table", ref: el => (this.datesSections = el) }, h("thead", { key: 'b4e53c5f56dd976aa0c01d337526baf586be8656' }, h("tr", { key: '03baae683c1fa1edec01e20dfd240f8a25a2bb42' }, h("td", { key: 'c7433899185c04281710643c74eb90fd62132cce', class: "igl-bulk-block__dates-header" }, locales.entries.Lcz_From), h("td", { key: '2bd7c04c5e42551f67d9433f71df59d9efa4c97a', class: "igl-bulk-block__dates-header" }, locales.entries.Lcz_ToExclusive), h("td", { key: 'bb64b9b95683ce2b7e664356adf842a20441f270' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (h("ir-custom-button", { key: '12db85baf1e62742e9806562b1e77db2b759609d', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, h("wa-icon", { key: '7c28a0065c942478ea37daa959830a7a898daea8', name: "plus", style: { fontSize: '1.2rem' } })))))), h("tbody", { key: '149b63a18490f4f52de905ea7ea7f181f5ccc5d8' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
