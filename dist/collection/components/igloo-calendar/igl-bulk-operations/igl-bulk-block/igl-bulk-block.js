...
export class IglBulkBlock {
    ...
    render() {
        return (h("form", { key: '77adc53741808246cece616de1788c9315e83b57', id: this.formId, class: "igl-bulk-block__form", onSubmit: e => {
                e.preventDefault();
                this.addBlockDates();
            } }, h("wa-radio-group", { key: '6a9158742854f3e54043d695f518389c5a9f25cf', size: "small", label: "Block or unblock a unit", orientation: "horizontal", name: "action" }, h("wa-radio", { key: 'a3b7d08e35f8ac740209b273688c816562fe850c', style: { flex: '1 1 0%' }, appearance: "button", value: "block" }, "Block"), h("wa-radio", { key: '83992b5e8e7f0a15cc3531b805ea4ea608074fa0', style: { flex: '1 1 0%' }, appearance: "button", value: "unblock" }, "Unblock")), h("div", { key: '00a6ef467947c8b2645ab63b7573b29b05aa8cea' }, this.errors === 'rooms' && (h("p", { key: '81457017a883ab8713ce8873ef4a40083b7ac98c', class: "igl-bulk-block__error" }, calendar_data.is_vacation_rental ? locales.entries.Lcz_PlzSelectOneListing : locales.entries.Lcz_PlzSelectOneUnit)), h("wa-radio-group", { key: '80c868277e21c1e8c708d47c0cc230ab46ff9144', name: "unit", ref: el => (this.unitSections = el), onchange: e => {
        ...
        }))), h("table", { key: '9d1eeb36d06015551f56d24148c67a476c5acb89', class: "igl-bulk-block__dates-table", ref: el => (this.datesSections = el) }, h("thead", { key: 'dac2cf3ec9798db70bfce39dc7734ecae0a2ef6e' }, h("tr", { key: '37e460f1e81f61bc902df815f32b68286d881279' }, h("td", { key: '6101b0528e9f0b7ebaa4aad35e22f2e873923cf3', class: "igl-bulk-block__dates-header" }, locales.entries.Lcz_From), h("td", { key: '6793a4ad421b7694545a9745beb54738e56e404e', class: "igl-bulk-block__dates-header" }, locales.entries.Lcz_ToExclusive), h("td", { key: 'f67e7efe97fe81c6aec538d5a3191886ccca2913' }, this.dates.length !== this.maxDatesLength && this.blockState === 'block' && (h("ir-custom-button", { key: 'e83de4c0fcf1c1077fbfc4601d71007a91ebd73f', appearance: "plain", variant: "neutral", onClickHandler: () => {
                this.addDateRow();
            } }, h("wa-icon", { key: '341154eef90ba77aaa1bea178f93fd04f7ecb657', name: "plus", style: { fontSize: '1.2rem' } })))))), h("tbody", { key: '5a5ac4f5dba6bbcdf1954d63f0e893e599c9adb9' }, this.dates.map((d, i) => {
            if (!this.dateRefs[i]) {
                this.dateRefs[i] = {};
            }
