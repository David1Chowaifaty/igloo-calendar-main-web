...
export class IglToBeAssigned {
    ...
    render() {
        ...
        return (h(Host, { key: 'd8016f1a0fa9c7b7f26f8c9d5557704d57094445' }, h("div", { key: '22a349563dcb76246ee057738188079809a1b68e', class: "tba-panel" }, h("div", { key: 'cf052bad0bc6a3c694381e29b012ab67aa07994f', class: "tba-panel__head" }, h("header", { key: 'a77b2cab64ed819ffba3e00a16e0b1a3c405e802', class: "tba-panel__header" }, h("h2", { key: '7f09065b472c031338d82b71a9abaddbafc0059a', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: 'eb8ff2f5fd8b2c1ad0b3aefadf01dffdf2a845db', size: "medium", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: 'fbd2dea2ea96a4ca99872692230fd768c89f847e', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: '6f509e9cba4256d9e52fc2692895adec81f7b125', class: "tba-panel__toolbar" }, h("wa-select", { key: '06b661b3b5f8c03ba803d1ec85119872aef92028', size: "small", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: 'fe1a65ec5186e6c1d9f0fbc36a5209603ea145d9', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
