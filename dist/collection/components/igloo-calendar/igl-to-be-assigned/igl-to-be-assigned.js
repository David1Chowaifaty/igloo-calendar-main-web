...
export class IglToBeAssigned {
    ...
    render() {
        ...
        return (h(Host, { key: '58664c03d466eca90395c734384194a21b8957b1' }, h("div", { key: '4a62380eb4bde8ce01110c7c47f28c57e8a666bc', class: "tba-panel" }, h("div", { key: 'd2f1256cc286521910c1bd6db71e7a9c0d73e994', class: "tba-panel__head" }, h("header", { key: '2fe2c5bafb0dfc08ac788930c8357e596b9ea62b', class: "tba-panel__header" }, h("h2", { key: '3d22305441e02f52085e2b68195f89267541d30b', class: "tba-panel__title", id: "to-be-assigned-title" }, locales.entries.Lcz_Assignments), h("ir-custom-button", { key: 'ed0fffdbbe2fd985a3ff327bcda1f392ec30a0c3', size: "m", appearance: "plain", variant: "neutral", onClickHandler: () => this.handleOptionEvent('closeSideMenu') }, h("wa-icon", { key: 'e985873eaad00e16dded7b6ba4ca1fa50c52450f', name: "xmark", variant: "solid", label: "Close", "aria-label": "Close", role: "img" }))), hasDates && (h("div", { key: '59cdfd537cec8363f963a13a4676923b0af75cb2', class: "tba-panel__toolbar" }, h("wa-select", { key: '41b0003e7e7c86098440b8548f28adefa956d89e', size: "s", "aria-label": locales.entries.Lcz_Assignments, value: this.selectedDate ? this.selectedDate.toString() : '', defaultValue: this.selectedDate ? this.selectedDate.toString() : '', onchange: evt => this.showForDate(evt.target.value) }, this.orderedDatesList.map(ordDate => (h("wa-option", { value: ordDate.toString() }, this.data[ordDate].dateStr))))))), h("div", { key: 'e128c21740630ce620f63fbcefa8461b5fb6112a', class: "tba-panel__body" }, isEmpty ? (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllBookingsAreAssigned)) : this.isLoading ? (h("div", { class: "tba-panel__loading" }, h("ir-spinner", null))) : selectedDateData && Object.keys(selectedDateData.categories).length ? (this.getCategoryView()) : (h("p", { class: "tba-panel__empty" }, locales.entries.Lcz_AllAssignForThisDay))))));
    }
