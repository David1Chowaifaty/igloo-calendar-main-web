...
export class IglTbaBookingView {
    ...
    render() {
        return (h(Host, { key: '6f3e0d704fb0887207a9f966ed7d089786297338' }, h("wa-card", { key: '031c70ed6fde73947fe36cf753bb8f9c53a05a8f', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, h("div", { key: 'dcdcb961cfc4a51869541190a30ecf11d27a7bff', slot: "header", class: `tba__header`, title: "Click to assign unit" }, h("p", { key: '3c9f35ac907dfb90ebabcd2c84e4adef0bee726a', class: "tba__booking-number" }, this.eventData.BOOKING_NUMBER), h("span", { key: '17acd69bc6af19f046c3383b2296685b58c05bb7', class: "tba__separator" }, "-"), h("p", { key: '832dbce13adbca9550bc950b4576a60844ab6560', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (h("p", { key: '21f1f5c5b4c733d7eb64f2caa82c241cde19fd2f', class: "tba__occupancy" }, h("span", { key: 'd446ba0fcc44296a8f31aa940574cbbd72d4eb42', class: "tba__occupancy-paren" }, "( "), h("span", { key: '11ae96467f03891f3fa67cdea1f8988355f15467', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), h("span", { key: '890c2308c24c20935335a2909e686463a55d036a', class: "tba__occupancy-paren" }, " )")))), h("div", { key: '2148de9afc0fb630b11ba57f38c3feef1fce6eeb', class: "tba__actions" }, h("wa-select", { key: '5c820393780caf6085cddd0f7e8023253f96a8a8', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4(), size: "s", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, h("wa-option", { key: 'fa343f4a921d293331d3a400fe9fcdba446f88cb', value: "" }, locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (h("div", { class: "tba__close" }, h("wa-button", { type: "button", appearance: "plain", size: "s", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, h("wa-icon", { name: "xmark" })))) : null), h("div", { key: 'ee1f9a900b75d41ff93fea09cc29d0ca9e6a346b', class: "tba__assign" }, h("wa-button", { key: 'c7fe2f8884ad2cc00f4c7b5a8ec1df49b80f215a', class: "tba__assign-btn", size: "s", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, locales.entries.Lcz_Assign), this.canCheckIn() && (h("wa-button", { key: 'bc579d81a9e0db261f58eb29bb48bba767a9548b', class: "tba__assign-btn", size: "s", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, locales.entries.Lcz_AssignedAndChecIn))))));
    }
