...
export class IglTbaBookingView {
    ...
    render() {
        return (h(Host, { key: '847c57a2bdb93dd3d76bc7134d0a4cbefad69e99' }, h("wa-card", { key: '801dbdaa279ed0b7643fd25c44ea5d61e153421f', appearance: "filled", class: `tba ${this.highlightSection ? '--active' : ''}`, onClick: () => this.handleHighlightAvailability() }, h("div", { key: '9272d8ab65c2d513a46815e2391eecf0c212d226', slot: "header", class: `tba__header`, title: "Click to assign unit" }, h("p", { key: '9606f1ece9e125b8897c4211f66140f9727bff7c', class: "tba__booking-number" }, this.eventData.BOOKING_NUMBER), h("span", { key: '7248b893178819616dcc2ddfd6c2ae35cf625c57', class: "tba__separator" }, "-"), h("p", { key: '4f953b892fe197b68e93b25a0da0b5f6fd9f3bec', class: "tba__guest-name" }, this.eventData.NAME), this.eventData.occupancy && (h("p", { key: '3f7809029bd86d153e9575473fa3af4333f28b5b', class: "tba__occupancy" }, h("span", { key: '49fc2f4500c09f290b7e88f35b73865397f001e1', class: "tba__occupancy-paren" }, "( "), h("span", { key: 'd8309277b2d1efa17b16dd75e6c61779bae3ab5b', class: "tba__occupancy-values", innerHTML: this.formatVariation(this.eventData.occupancy) }), h("span", { key: '0fb9224ee33851f3b513601cb97389abaa36418d', class: "tba__occupancy-paren" }, " )")))), h("div", { key: '684e47ae67c105846e8b8ab16b13d9d2fc7d3bb1', class: "tba__actions" }, h("wa-select", { key: '812df794eaaedfec5f548217c338b1fa92f4747e', defaultValue: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), class: "tba__select", id: v4(), size: "small", value: this.selectedRoom === -1 ? '' : this.selectedRoom.toString(), onchange: evt => this.onSelectRoom(evt) }, h("wa-option", { key: '8fa6505cc7eca73e05c45bf842bd28532d331e7a', value: "" }, locales.entries.Lcz_AssignUnit), this.allRoomsList.map(room => (h("wa-option", { value: room.id.toString() }, room.name)))), this.highlightSection ? (h("div", { class: "tba__close" }, h("wa-button", { type: "button", appearance: "plain", size: "small", class: "tba__close-btn", onClick: evt => this.handleCloseAssignment(evt) }, h("wa-icon", { name: "xmark" })))) : null), h("div", { key: '0a845dc0a12da0ec345af6fe4cf4169168f3de80', class: "tba__assign" }, h("wa-button", { key: '03b1b43312e82d5179cab113e6320e959413e1ba', class: "tba__assign-btn", size: "small", variant: "brand", appearance: this.canCheckIn() ? 'outlined' : 'accent', loading: this.isLoading === 'default', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt) }, locales.entries.Lcz_Assign), this.canCheckIn() && (h("wa-button", { key: '74d7c7569540c0f544dbb5a77ee6e6f48f0addb7', class: "tba__assign-btn", size: "small", variant: "brand", loading: this.isLoading === 'checkin', disabled: this.selectedRoom === -1, onClick: evt => this.handleAssignUnit(evt, true) }, locales.entries.Lcz_AssignedAndChecIn))))));
    }
