...
export class IglCalHeader {
    ...
    render() {
        return (h(Host, { key: '82848f6832aebd5cfbdb9d46ef253d48ef1d4d69' }, h("div", { key: '2166d88415786346b94de603823eddf5ccfa9e76', class: "stickyCell align-items-center topLeftCell preventPageScroll" }, h("div", { key: 'daa45e6d4afd45f377d0f774c6e9800538e238d6', class: "header__fd-actions" }, h("div", { key: '1da38d19cd757217c57a460544f854ef8b7e4d09', class: "row justify-content-around no-gutters", style: { gap: '0' } }, !this.calendarData.is_vacation_rental && (h(Fragment, { key: '78cd584915f3c0a80325d29da6f7b7116b4b2e1f' }, h("wa-tooltip", { key: 'a68a408e1e1ec0ce725a2630948e31c53959ef29', for: "fd-unassigned-dates_btn" }, locales.entries.Lcz_UnassignedUnitsTooltip), h("ir-custom-button", { key: 'db57af8388c6ccbe0b01bedd2a6dc6994e755f2e', id: "fd-unassigned-dates_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('showAssigned') }, h("wa-icon", { key: '73902ac665244671e8335cdaef345f525a8a1a3c', style: { fontSize: '1.5rem' }, name: "server", label: locales.entries.Lcz_UnassignedUnitsTooltip, "aria-label": locales.entries.Lcz_UnassignedUnitsTooltip })))), h("wa-tooltip", { key: '2fe41c490205a701dee022f1863e8d515c9312dd', for: "fd-dates-navigation_btn" }, locales.entries.Lcz_Navigate), h("ir-date-select", { key: '47477acd0f750af0ffd9b524e6da1a6df344feff', minDate: moment().add(-2, 'months').startOf('month').format('YYYY-MM-DD'), onDateChanged: evt => {
                console.log('evt', evt);
                this.handleDateSelect(evt);
            }, ref: el => (this.dateSelectRef = el) }, h("ir-custom-button", { key: '16eb722d2b98457a2a0ca5b8db730ac6c8596112', slot: "trigger", id: "fd-dates-navigation_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('calendar') }, h("wa-icon", { key: '9aecbd4c6adabca57c818bca0732b1c9c3fe2364', style: { fontSize: '1.5rem' }, name: "calendar", variant: "regular", label: locales.entries.Lcz_Navigate, "aria-label": locales.entries.Lcz_Navigate })), h("div", { key: '2b59ca8ea24b8c6bbd3b44531fbcdc29ba873af6', class: "fd-dates__actions" }, h("wa-divider", { key: '84336de139b45eb3665cb8b45547847456926ef1' }), h("ir-custom-button", { key: '01b48681e021ebbd6e69177ebe9c5f5a16c81ee3', variant: "neutral", appearance: "outlined", onClickHandler: () => {
                this.handleOptionEvent('gotoToday');
                this.dateSelectRef.hide();
            } }, "Today"))), h(Fragment, { key: '68c13227ca0a02dbd22ad0be69771f03941587d6' }, h("wa-tooltip", { key: '3f98425d4673a36b8293bc4f33e09737a2593b56', for: "fd-new-booking_btn" }, locales.entries.Lcz_CreateNewBooking), h("ir-custom-button", { key: '559b612e9bff4b4c800669f44113809cfc548e96', slot: "trigger", id: "fd-new-booking_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('add', this.getNewBookingModel()) }, h("wa-icon", { key: 'e0d810d7349f13ab481d3737a4004e13fa9c6a75', style: { fontSize: '1.5rem' }, name: "plus", label: locales.entries.Lcz_CreateNewBooking, "aria-label": locales.entries.Lcz_CreateNewBooking }))), h(Fragment, { key: 'd5a6542f56e54fda9f792603d2cd7d488d9fcd4c' }, h("wa-tooltip", { key: '54e5c1c8ffc2458f207f1c55c54c50537f9c70c4', for: "fd-stop-open-sale_btn" }, locales.entries.Lcz_StopOpenSale), h("ir-custom-button", { key: '89412c191bd66021e9a63873bff7bd7f230acc0d', slot: "trigger", id: "fd-stop-open-sale_btn", variant: "neutral", appearance: "plain", onClickHandler: () => this.handleOptionEvent('bulk', this.getNewBookingModel()) }, h("wa-icon", { key: 'cfb852fb5b6f19f73aca2d6358290904ea6eae3c', variant: "regular", style: { fontSize: '1.5rem' }, name: "calendar-xmark", label: locales.entries.Lcz_StopOpenSale, "aria-label": locales.entries.Lcz_StopOpenSale })))), h("div", { key: 'b75c82284e00fabc82c6d5a9ea267e6d37522944', class: "searchContiner" }, h("ir-picker", { key: '5fe422e7be37e94a3f1372cf50df557aaae7e15e', size: "small", "onCombobox-select": e => {
                this.handleScrollToRoom(Number(e.detail.item.value));
            } }, this.roomsList.map(room => (h("ir-picker-item", { label: room.name, value: room.id }, room.name))))))), h("div", { key: 'dd4e5bcb75b25d588f05809e188a3d3ebfeb176c', class: "stickyCell headersContainer" }, h("div", { key: 'a38667c6edd664c0e7d19f9170bef6a500f6aca0', class: "monthsContainer" }, this.calendarData.monthsInfo.map(monthInfo => (h("div", { class: "monthCell", style: { width: monthInfo.daysCount * 58 + 'px' } }, h("div", { class: "monthTitle" }, monthInfo.monthName))))), this.calendarData.days.map(dayInfo => {
