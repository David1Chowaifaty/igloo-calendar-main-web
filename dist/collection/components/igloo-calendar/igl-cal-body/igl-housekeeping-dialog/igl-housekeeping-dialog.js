...
export class IglHousekeepingDialog {
    ...
    render() {
        return (h("ir-dialog", { key: 'ae93742e933bcd65cfe83d7e4ea979cb65c8bbfd', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, h("p", { key: 'aff583120287937cbd221a1f9dc68a4c45ccec1b', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), h("div", { key: 'a279e5d6d64d811e160600fa282b0decdca100e6', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '0107c677c87e5626bf12e84927f68a0aed2bdf07', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: '049322ab6641ce77f9ce23a715e967ddfa4d1041', value: "hk-toggle-clean-dirty", size: "medium", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), h("ir-custom-button", { key: '5d1e3ef5f47bc6d1e97dad87dbc01f9c7b83fe82', value: "hk-clean-inspect", size: "medium", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
