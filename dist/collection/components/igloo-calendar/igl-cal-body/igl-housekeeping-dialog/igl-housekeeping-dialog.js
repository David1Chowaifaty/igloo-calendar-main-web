...
export class IglHousekeepingDialog {
    ...
    render() {
        return (h("ir-dialog", { key: '81940964c7e7d0b1d4fa31157def5e1bbe58b6c9', ref: el => (this.dialogRef = el), open: this.open, label: "Housekeeping Update", onIrDialogAfterHide: () => this.irAfterClose.emit() }, h("p", { key: 'df28b7a126f8f6e0eb69081483361fef080c0a83', style: { margin: '0' } }, `${this.selectedRoom?.name} is currently marked as ${this.getStatusLabel()}.`), h("div", { key: '4b3bfe550a10f1285b868439479184e59a90fc18', slot: "footer", class: "ir-dialog__footer" }, h("ir-custom-button", { key: '9e96767f92574bb54f563f0a66a58cbbc61cccc2', "data-dialog": "close", size: "medium", variant: "neutral", appearance: "filled" }, "Cancel"), h("ir-custom-button", { key: '60e4fb023f918c521ea43d7d3fa548897dc373db', value: "hk-toggle-clean-dirty", size: "medium", variant: "brand", appearance: "outlined", loading: this.isLoading === 'hk-toggle-clean-dirty', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '002' ? '001' : '002') }, this.middleButtonLabel()), h("ir-custom-button", { key: 'e4a14dc1cc71b72036c1fbb37789475ae21b1873', value: "hk-clean-inspect", size: "medium", variant: "brand", appearance: "accent", loading: this.isLoading === 'hk-clean-inspect', onClickHandler: e => this.updateHousekeeping(e, this.selectedRoom.hk_status === '004' ? '001' : '004') }, this.rightButtonLabel()))));
    }
