...
export class IglCalBody {
    ...
    render() {
        var _a, _b, _c;
        return (h(Host, { key: '9bbde77353a132d3ca35daf8b3ac2c69c43eb775' }, h("div", { key: '382207bc194eb16b076b84f2f50762e165d49e92', class: "bodyContainer" }, this.getRoomRows(), h("div", { key: '6ab04eddae9b825fbc1bc5fb7078dfbb12001e84', class: "bookingEventsContainer preventPageScroll" }, (_a = this.getBookingData()) === null || _a === void 0 ? void 0 : _a.map(bookingEvent => {
            var _a, _b, _c;
