...
export class IglHkIssuesDialog {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: 'e6d6378173a7d276168baa87763d2bc100f15f54', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), h("div", { key: '7e898eeafcb846c1649b998999f465eae6f50e54', slot: "footer", class: "dialog-footer" }, h("ir-custom-button", { key: '5f93d868fc0989a50689d5293a795e828a4b023d', variant: "neutral", size: "medium", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), h("ir-custom-button", { key: 'a0bf92a943202c6edba325ee474130f5533e321a', variant: "brand", size: "medium", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
