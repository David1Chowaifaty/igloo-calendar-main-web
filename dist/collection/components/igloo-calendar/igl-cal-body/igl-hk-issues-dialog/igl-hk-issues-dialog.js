...
export class IglHkIssuesDialog {
    ...
    render() {
        ...
        return (h("ir-dialog", { key: '20bc537bcb125f070ec6e13fb52dbc8fbacfe01e', ref: el => (this.dialogRef = el), label: `Reported ${count > 1 ? 'Issues' : 'Issue'}: ${this.unitName}`, onIrDialogAfterHide: () => this.irAfterClose.emit() }, this.renderContent(), h("div", { key: '7e37f6e97eb0b4034ea8d7f263810429aecd0e77', slot: "footer", class: "dialog-footer" }, h("ir-custom-button", { key: '88023d57850c4cc7a5fbcce19fe97f8e4bcc7e6a', variant: "neutral", size: "m", appearance: "filled", onClickHandler: () => this.dialogRef?.closeModal(), disabled: this.isResolving }, "Close"), h("ir-custom-button", { key: 'fc8cba21e9c5724c586065cda2ab7040d505c566', variant: "brand", size: "m", appearance: "accent", onClickHandler: this.handleResolve, disabled: selectedCount === 0, loading: this.isResolving }, "Mark as Resolved"))));
    }
