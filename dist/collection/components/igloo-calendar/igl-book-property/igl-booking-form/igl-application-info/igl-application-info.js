...
export class IglApplicationInfo {
    ...
    render() {
        ...
        return (h(Host, { key: '724d64a6da6dc27e973decfc64554a1643507850', class: 'my-2' }, h("div", { key: '7a1178298bb416a332bbf0690591e6d59b8a8fe0', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: '55a9c74b437ab7131ba7abcd82e14dd873287c44', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: '250be3f0f1a54928df41ff129e83ab37f7558887', class: "booking-details-container" }, h("div", { key: 'cc06e6b5d9c1b5f07c0ac31119196d851ebde36f', class: "booking-rateplan" }, h("p", { key: '25d49b9c68fe7e6166b6fa351522ce76f37f4e0d', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: '7035933b3767564371fcbec32eea8803d8685eaf', class: 'non-ref-span' }, "Non Refundable")), h("ir-tooltip", { key: '86bd6aae27b55c8353d0fdec869895491b89de87', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: '40a4ca7225d25d80452b28d920ab1c98f684b93a', class: "booking-variation", innerHTML: formattedVariation })), h("p", { key: '4da53b25af568723f579219b3043c3d7dee9af23', class: "booking-price" }, formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), h("div", { key: '83ebec750c4cfc41580c698ee39fc60945b4d738', class: "booking-footer" }, h("div", { key: 'e064cbc3c46114f16a89e96a4f09787bc7ef8536', class: "booking-rateplan" }, h("p", { key: 'd9e56a4e77fd3f9d62338496c148d4869977530a', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("ir-tooltip", { key: '2571571b8e63314bddd39e2999819d3034913848', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: '64f87e604ac8764f9a757135f49b1e1b0ce9ce74', class: "booking-variation", innerHTML: formattedVariation })), h("div", { key: 'bac305e6dcbaa04387eedaf64684886b1845df7a', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, h("div", { key: 'f577755e653dbec6aa14c025d363f7ff85ba87e2', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, h("input", { key: '911758dad935be831e4dbaa5a44f385da8a3cac2', id: v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ first_name: name });
                if (booking_store.event_type.type === 'EDIT_BOOKING') {
                    modifyBookingStore('guest', Object.assign(Object.assign({}, booking_store.guest), { name }));
                }
            }, required: true, value: (_d = this.guestInfo) === null || _d === void 0 ? void 0 : _d.first_name })), h("div", { key: 'd46a97dc01bd831ca1d2d542e6612040c6098b6c', class: "mr-md-1 flex-fill guest-info-container" }, h("input", { key: '540adddcd70e04ed4fa1b53e5d87812bd967eded', id: v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_e = this.guestInfo) === null || _e === void 0 ? void 0 : _e.last_name) === '' && 'border-danger'}`, placeholder: (_f = locales.entries['Lcz_GuestLastname']) !== null && _f !== void 0 ? _f : 'Guest last name', name: "guestLastName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ last_name: name });
                if (booking_store.event_type.type === 'EDIT_BOOKING') {
                    modifyBookingStore('guest', Object.assign(Object.assign({}, booking_store.guest), { name }));
                }
            }, required: true, value: (_g = this.guestInfo) === null || _g === void 0 ? void 0 : _g.last_name })), h("div", { key: '61c3a0f345603774e3fd5d2c627b242df13fdb73', class: "my-1 my-md-0 d-flex align-items-center flex-fill" }, calendar_data.is_frontdesk_enabled &&
            !isSingleUnit(this.rateplanSelection.roomtype.id) &&
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("div", { key: '4070fe25555301259c2a5274796652ffa0e7521c', class: "mr-md-1 p-0 flex-fill preference-select-container" }, h("select", { key: '37fde5921c0cd8d325f0064a62dbb954e09996ac', class: "form-control input-sm pr-0", id: v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, h("option", { key: '077b1d2f2c5382d7163366ae6c209ad1626738f5', value: "", selected: ((_h = this.guestInfo) === null || _h === void 0 ? void 0 : _h.unit) === '' }, locales.entries.Lcz_Assignunits), filteredRoomList === null || filteredRoomList === void 0 ? void 0 :
            filteredRoomList.map(room => {
                var _a;
                return (h("option", { value: room.id, selected: ((_a = this.guestInfo) === null || _a === void 0 ? void 0 : _a.unit) === room.id.toString() }, room.name));
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (h("div", { key: 'e9b886d6746cbfac456437ccc4242988b90d1feb', class: "mr-md-1 flex-fill" }, h("select", { key: 'a84c08b1ea13dcabe6fc3bd81d290f0f1a409ad7', class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, h("option", { key: '69d7d7a40f06b7fa27e6f5ac98ce563c1c3edffb', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), h("p", { key: '391647c127e4c1f1e09567071d63fa2c1ab1232f', class: "rate_amount" }, formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: '3443a9cdcb37f67686eecbb3d8bbfd64ca71e2f3', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, h("p", { key: '036d7b74f23ee1a71c286cee57100ac5bbd103bd', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), h("div", { key: '1d1a665415f36419236c0abee85f52bf9c6bed6e', class: "mr-1 flex-fill" }, h("select", { key: '1cff2d9ce60a247186725ef75eb8850b2455f8ab', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, h("option", { key: '413daddee406126d3bcf4eed39446dffbe6358f2', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
