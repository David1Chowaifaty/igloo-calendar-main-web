...
export class IglApplicationInfo {
    ...
    render() {
        ...
        return (h(Host, { key: 'd98046081c7037a42d21fd8781a594243464bf96', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, h("div", { key: '9ccdc181217ecfbe223f803803e7d6739e802c03', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: '7b97b12665ec4674306efc8bad1b99ff64708b51', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: '377c6a3cd04fe831d6d1e8d5d48ad38d2b8ea813', class: "fd-application-info__details" }, h("div", { key: 'a2987c482429ec73cec449a2e61a0ee621d91c44', class: "fd-application-info__rateplan" }, h("p", { key: '5eaa35d5899412815cc22ad5eabbf1d7b934e8a4', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: '9faaebb71b24b4b95338c69a308543f1bd7e41a7', class: "fd-application-info__non-refundable" }, "Non Refundable")), h("wa-tooltip", { key: '204303ab5e7d56406a6a2f6a3b2ec48167ce50fb', for: this.tooltipId }, h("span", { key: 'a49e2d0a1543ea8c1c7a4a447515d3a83d3d6552', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '84669ab8c1822996f251a42e3bc2ba4587ebfadb', name: "circle-info", id: this.tooltipId })), h("p", { key: 'bfa1c1a875e2ee1342ead6cbadbe33cdb6fd406a', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("p", { key: '4dd5fde042404b5028da2e73aecda65a1d506861', class: "fd-application-info__price" }, h("span", { key: '3e3730cf9046f2db6d27968ca122b1e6ed1dced1', class: "ir-price" }, formatAmount(this.currency?.symbol, this.amount), "/", locales.entries.Lcz_Stay), h("p", { key: 'd598874be846cd4b09afe15a37b1d27a9c70ed99', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), h("div", { key: '0f732b3e7baabd25ee4826de9febbd070289faa9', class: "fd-application-info__footer" }, h("div", { key: 'f9f377960eca7dd9aaf6082c55b4894e27c0374a', class: "fd-application-info__rateplan" }, h("p", { key: '0f92c4bdd1b470d3fac9e56a5d7478b245c1b217', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("wa-tooltip", { key: '5a933e8921c5046274f3fe69746c452e61a61b93', for: `mobile-${this.tooltipId}` }, h("span", { key: '2dd7d16baab2f6096878fe83a465eb68bddfa89b', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: 'bdfab173dde2b8591e74f41cdaaefb7b6ee12359', name: "circle-info", id: `mobile-${this.tooltipId}` })), h("p", { key: '4d5bc2d2a87ae2536fb6ffbf899d1e99439d287b', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("div", { key: 'ed240452b9e98c46706fb32111b6099f98806e20', class: "fd-application-info__form" }, h("ir-validator", { key: '07644eff1f1446018d0432f04068eb2249d9c21b', value: this.guestInfo?.first_name, schema: GuestCredentials.shape.first_name }, h("ir-input", { key: 'ee158a4f1feb41b4eeeb9251d4b17eec485fb46b', class: "fd-application-info__input",
            ...
            } })), h("ir-validator", { key: '27d7d93c9aceab8ba0e0206dbfc388137fa6c845', value: this.guestInfo?.last_name, schema: GuestCredentials.shape.last_name }, h("ir-input", { key: 'd867e3673a1b78c50183168cc1fd452142b2a395', class: "fd-application-info__input", type: "text",
            ...
            }) }, this.bedPreferenceType.map(data => (h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), h("p", { key: '058c32cba1605f88cefe061b0a17f5952451d76a', class: "fd-application-info__price-inline" }, h("span", { key: '8ff097e07e0ad6f4ed37f61555b996ca01f044e4', class: "ir-price" }, formatAmount(this.currency?.symbol, this.amount), "/", locales.entries.Lcz_Stay), h("p", { key: '9583cabad90b8f3fa94f6f6d30813287c9d29e3e', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: 'e8b217239ec6a0b879c489d19f83407a45a21c8f', class: "fd-application-info__infant" }, h("p", { key: '4685fc0a54e116b8a3d3f992ae4fb19285b1eb77', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), h("wa-select", { key: 'bc3a3090608165cec971a85df7d58be2cc43e1fc', size: "small", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => {
                this.updateGuest({
