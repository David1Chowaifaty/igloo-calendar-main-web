...
export class IglApplicationInfo {
    ...
    render() {
        ...
        return (h(Host, { key: '18e3ada62f431004baed5457e10fcbbb9c10a190', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, h("div", { key: 'f2305ceb8069aaec11e6d929c9ff25878938e2e4', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: '220410da480e7e2584e680aa1494f31c4574dd21', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: '6fcd68338cd1485d4e890f6cdf7163b4790526e0', class: "fd-application-info__details" }, h("div", { key: 'c20655b7fc4bd5056190632b4094aec3a8a6a145', class: "fd-application-info__rateplan" }, h("p", { key: 'b529a67db1f75715e065feb4fb5311509d854fbb', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: '623f27db0c4a828599e64b0a94e593a078a113fd', class: "fd-application-info__non-refundable" }, "Non Refundable")), h("wa-tooltip", { key: 'c6f2ba32d6de24d3a21c7c2bfe21345a0a4572e1', for: this.tooltipId }, h("span", { key: '4df02592bfd8eb600f8eca112018207cdda0859e', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '76e83d401784bbcf8f783806c6217480a4577248', name: "circle-info", id: this.tooltipId })), h("p", { key: 'de9fff1a1b34502add6a15dca5f791888728893f', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("p", { key: '91405ea9fab4c76ed5b9c7aa826e7493b789af15', class: "fd-application-info__price" }, h("span", { key: '9db5ce257734c581afbcea6a17277d91dc1fa095', class: "ir-price" }, formatAmount(this.currency?.symbol, this.amount), "/", locales.entries.Lcz_Stay), h("p", { key: '93008751cfd9b36939ef04e4d991e59b644f46c9', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), h("div", { key: '9314a62ef661fad7801766d8cb3ef68f7c014b41', class: "fd-application-info__footer" }, h("div", { key: '00b8614134f0e3bd0b7aa0017df5a2d801fd0f3c', class: "fd-application-info__rateplan" }, h("p", { key: '413fa253de170d2b97ff35e41575df06c3fdc7bd', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("wa-tooltip", { key: '8f63a9ea355dd4e405a6b3d91eb55a9d506c6f25', for: `mobile-${this.tooltipId}` }, h("span", { key: 'c8ccbd990125990a8b2b7d84435d5bf949c969d9', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: 'a0f7a3acc5ff4f8c080ec4c06f9437da00654f37', name: "circle-info", id: `mobile-${this.tooltipId}` })), h("p", { key: 'f7c6599ddb5ef72f56f4234065df42ea4df23e33', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("div", { key: '9f004528ffb3c57c1a0af081130ed54814d9b880', class: "fd-application-info__form" }, h("ir-validator", { key: '6debb49116d80cb3cad0ae3b4b655235d56c33e5', value: this.guestInfo?.first_name, schema: GuestCredentials.shape.first_name }, h("ir-input", { key: '77397f09859b2e1f1bc46b0f6c4c89edd72d0cf5', class: "fd-application-info__input",
            ...
            } })), h("ir-validator", { key: '2d038c63eef0e6d25f44302b41ba57c4cf5c4887', value: this.guestInfo?.last_name, schema: GuestCredentials.shape.last_name }, h("ir-input", { key: 'e9520560a718e8bf87bebc12db6c33e8d310dcae', class: "fd-application-info__input", type: "text",
            ...
            }) }, this.bedPreferenceType.map(data => (h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), h("p", { key: 'e16e4bbcc44ffb1b34afef952271b40719dce381', class: "fd-application-info__price-inline" }, h("span", { key: 'b9b77380aa9811cb9161f51d36620aa4e34958b4', class: "ir-price" }, formatAmount(this.currency?.symbol, this.amount), "/", locales.entries.Lcz_Stay), h("p", { key: '128552ed42f349c87552e49229676d7fc4425a1b', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: '75b5f64969c4b0846b87a1e2120378cf6e97776d', class: "fd-application-info__infant" }, h("p", { key: '06c26a73d47933329e47915d519fe9435a3df88f', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), h("wa-select", { key: 'c534770ce4fb8b22ff93a9ebfa43d24a4abf47ca', size: "s", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => {
                this.updateGuest({
