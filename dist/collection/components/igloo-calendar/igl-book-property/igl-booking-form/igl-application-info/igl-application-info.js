...
export class IglApplicationInfo {
    ...
    render() {
        ...
        return (h(Host, { key: 'd47f538cc65ed308296811cfafb41028146db66b', class: "fd-application-info", "data-testid": `room_info_${this.rateplanSelection.ratePlan.id}` }, h("div", { key: 'e0ec46a242a0730d74ef3c9577b85c51c67f0682', class: "fd-application-info__header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: 'd9aab542890d6d6b0d4fb45a2a12ee630f482de6', class: "fd-application-info__roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: 'f1029909dad659c4686166b13607801ec5ca736c', class: "fd-application-info__details" }, h("div", { key: '35af862115c01b5a1e4c902d9cd9bda1cea40662', class: "fd-application-info__rateplan" }, h("p", { key: '3861258d6f6dcbf377e9eb115575f818c0df44a9', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name, this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: 'fa043f4f5caf6038d40d7ad134a34d7d305b7403', class: "fd-application-info__non-refundable" }, "Non Refundable")), h("wa-tooltip", { key: '8f31ed8dfedb66bf904e73b66c8672fdb62d6202', for: this.tooltipId }, h("span", { key: '852ff552f5cb7fc3100c69061a25d89a976b174b', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: 'bd04cd4bb4825a5ca7708ed21e8f7ab4de548819', name: "circle-info", id: this.tooltipId })), h("p", { key: 'b0c5021c37dfa884eb670ab701b30960f98fbbc8', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("p", { key: '70abb4b8f08f7df2c3bedcd16b6b1c59badce402', class: "fd-application-info__price" }, h("span", { key: '6a7acfc1505be03ebe48a38f89575f0c0b88bb50', class: "ir-price" }, formatAmount(this.currency?.symbol, this.amount), "/", locales.entries.Lcz_Stay), h("p", { key: '3f53bd81b10e5c7c38984a860040f2b5b70fca1f', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), h("div", { key: '21ec031dfd79571b8f0df969bf2ee05ec8044d38', class: "fd-application-info__footer" }, h("div", { key: '497d52500aba18a6e8b36b31f3b6947b712ab966', class: "fd-application-info__rateplan" }, h("p", { key: '1f97204bcb4ea186254ab30912d7ccba349b7aae', class: "fd-application-info__rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("wa-tooltip", { key: '0a5cc3e371d257212317276cdc83f3c7509073ad', for: `mobile-${this.tooltipId}` }, h("span", { key: 'e6889176515f2a511e9846e43348abfba334bea8', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: '276db05b85c787fe3e102da2050b710972f7f7bd', name: "circle-info", id: `mobile-${this.tooltipId}` })), h("p", { key: 'c30c17d9985e4352156f81bc050c7b13a36d882b', class: "fd-application-info__variation", innerHTML: formattedVariation })), h("div", { key: '118da16097fd67b82ecc47780968585987cb3ba6', class: "fd-application-info__form" }, h("ir-validator", { key: '3e2abf3aae4eb08911b6a8a863642790262cd90f', value: this.guestInfo?.first_name, schema: GuestCredentials.shape.first_name }, h("ir-input", { key: '5b326742666e89dfe2b36de94b77ef718a01006c', class: "fd-application-info__input",
            ...
            } })), h("ir-validator", { key: '2e248fe955164058a7def8d999955aa9816bd4c8', value: this.guestInfo?.last_name, schema: GuestCredentials.shape.last_name }, h("ir-input", { key: '11e7a6bf78f18d7433eb12adf54deba57a5e0002', class: "fd-application-info__input", type: "text",
            ...
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("wa-select", { key: 'cf896cce2f20bd4d3c4b92551914ccd386dc82be', "with-clear": true, size: "s", class: "fd-application-info__select", placeholder: locales.entries.Lcz_Assignunits, "data-testid": "unit", value: this.guestInfo?.unit, defaultValue: this.guestInfo?.unit, onchange: event => this.updateGuest({
                unit: event.target.value,
            }) }, filteredRoomList.map(room => (h("wa-option", { value: room.id.toString(), selected: this.guestInfo?.unit === room.id.toString() }, room.name))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (h("ir-validator", { key: '7dce6bd3620460b5749e831ea9d6cf31092bce41', value: this.guestInfo?.bed_preference, schema: z.string().nonempty() }, h("wa-select", { key: '96d9f651030ca80cda655df285ae47154f097c1f', "with-clear": true, size: "s", class: "fd-application-info__select", placeholder: locales.entries.Lcz_BedConfiguration, "data-testid": "bed_configuration", value: this.guestInfo?.bed_preference, defaultValue: this.guestInfo?.bed_preference,
            ...
            }) }, this.bedPreferenceType.map(data => (h("wa-option", { value: data.CODE_NAME, selected: this.guestInfo?.bed_preference === data.CODE_NAME }, data.CODE_VALUE_EN)))))), h("p", { key: '541a46ca0119a2aa747a3bb80adaaddc0d139c6b', class: "fd-application-info__price-inline" }, h("span", { key: 'fac2ae116c47a5af1c8a5cd7845981c7fb4b9a19', class: "ir-price" }, formatAmount(this.currency?.symbol, this.amount), "/", locales.entries.Lcz_Stay), h("p", { key: '278524efcf7243f1cfd373884f6dc83c5e3bfeb2', style: { margin: '0', padding: '0', fontSize: '0.75rem' } }, "Including taxes and fees"))), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: '119dca6aff4d50042b6d04dd7be71a453156358d', class: "fd-application-info__infant" }, h("p", { key: '49837162c3bf5ccef973662b1c4186f1f8b4fe5e', class: "fd-application-info__infant-label" }, "Any of the children below 3 years?"), h("wa-select", { key: 'e9ef56a4378ece52b61b597d95af2250c9f87535', size: "s", class: "fd-application-info__select fd-application-info__select--inline", placeholder: locales.entries['No'] || 'No', value: this.guestInfo?.infant_nbr?.toString(), defaultValue: this.guestInfo?.infant_nbr?.toString(), onchange: event => {
                this.updateGuest({
