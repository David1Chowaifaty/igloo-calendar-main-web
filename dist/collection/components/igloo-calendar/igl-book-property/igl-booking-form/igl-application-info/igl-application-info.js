...
export class IglApplicationInfo {
    ...
    render() {
        ...
        return (h(Host, { key: '37dbfdd73c261d3d99ee7a5c263d7c0a00dc973b', class: 'my-2' }, h("div", { key: '7cc2729f27c3e8859a7a252c134060b8b9f7803f', class: "booking-header" }, (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("span", { key: '2a77719908d8948f98eb4e59da9e9253f36989f4', class: "booking-roomtype-title" }, this.rateplanSelection.roomtype.name)), h("div", { key: 'cb54b188e47c3e34ada1a76241371501829a9e70', class: "booking-details-container" }, h("div", { key: '0f77d59b492e3fa388a4fb4dd73bf28415765221', class: "booking-rateplan" }, h("p", { key: 'c5b1e975640d698d111d3deaac1a872eec8de926', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name, " ", this.rateplanSelection.ratePlan.is_non_refundable && h("span", { key: 'fd266b7fce893ad1d6b21fdf4e306d22e811884e', class: 'non-ref-span' }, "Non Refundable")), h("ir-tooltip", { key: '64efdca99527709643dc97e29f2ff866dbbbf16a', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: '7c5df2088aee2fe7c53b12e185fb1d880361dc6b', class: "booking-variation", innerHTML: formattedVariation })), h("p", { key: 'a9c99649f24eee942c7001d15200369ba108e0bc', class: "booking-price" }, formatAmount((_a = this.currency) === null || _a === void 0 ? void 0 : _a.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), h("div", { key: '45055989309780362be4d549cab0d6aa0e24d4ba', class: "booking-footer" }, h("div", { key: '4212cde10f502166774c4790f66774ead68afe74', class: "booking-rateplan" }, h("p", { key: '8885d0201c79a74707ef9dedb4d9c73594422f5e', class: "booking-rateplan-name" }, this.rateplanSelection.ratePlan.short_name), h("ir-tooltip", { key: 'f8f11272944d6f7798b08eb585e99fc93a4c1542', class: "booking-tooltip", message: this.getTooltipMessages() })), h("p", { key: 'a7f4f8e3fab3455303a17fab2d20c6b2f086dc67', class: "booking-variation", innerHTML: formattedVariation })), h("div", { key: '610b5fe4d21242fe33f527dbb3f7d96b2a8ec221', class: "d-flex flex-column flex-md-row  p-0 align-items-md-center aplicationInfoContainer" }, h("div", { key: 'd0ec31931f5ec7cb9571ae7306d7e2a56f4b651e', class: "mr-md-1 mb-1 mb-md-0 flex-fill guest-info-container" }, h("input", { key: '4c85de9d6ea9c558fb72cb81eaf3b119e2117d94', id: v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_b = this.guestInfo) === null || _b === void 0 ? void 0 : _b.first_name) === '' && 'border-danger'}`, placeholder: (_c = locales.entries['Lcz_GuestFirstname']) !== null && _c !== void 0 ? _c : 'Guest first name', name: "guestFirstName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ first_name: name });
                if (booking_store.event_type.type === 'EDIT_BOOKING') {
                    modifyBookingStore('guest', Object.assign(Object.assign({}, booking_store.guest), { name }));
                }
            }, required: true, value: (_d = this.guestInfo) === null || _d === void 0 ? void 0 : _d.first_name })), h("div", { key: '393d1179cbc1a824f22cbc085438406c980844a3', class: "mr-md-1 flex-fill guest-info-container" }, h("input", { key: 'fd686fb8489928d494b7bce33634323819e19a97', id: v4(), type: "text", class: `form-control ${this.isButtonPressed && ((_e = this.guestInfo) === null || _e === void 0 ? void 0 : _e.last_name) === '' && 'border-danger'}`, placeholder: (_f = locales.entries['Lcz_GuestLastname']) !== null && _f !== void 0 ? _f : 'Guest last name', name: "guestLastName", onInput: event => {
                const name = event.target.value;
                this.updateGuest({ last_name: name });
                if (booking_store.event_type.type === 'EDIT_BOOKING') {
                    modifyBookingStore('guest', Object.assign(Object.assign({}, booking_store.guest), { name }));
                }
            }, required: true, value: (_g = this.guestInfo) === null || _g === void 0 ? void 0 : _g.last_name })), h("div", { key: '1eac53088d2d4a7bfbb59934fd094826ccbfce8a', class: "my-1 my-md-0 d-flex align-items-center flex-fill" }, calendar_data.is_frontdesk_enabled &&
            !isSingleUnit(this.rateplanSelection.roomtype.id) &&
            (this.bookingType === 'PLUS_BOOKING' || this.bookingType === 'ADD_ROOM' || this.bookingType === 'EDIT_BOOKING') && (h("div", { key: '7bf8cd53ac5aeae11e977ab001ee67b38a74873b', class: "mr-md-1 p-0 flex-fill preference-select-container" }, h("select", { key: 'a1659814c8d79e614ae4f8b8c9887e5413fee051', class: "form-control input-sm pr-0", id: v4(), onChange: event => this.updateGuest({ unit: event.target.value }) }, h("option", { key: '3997713a0a8e08a6277d030ff8c512b543306891', value: "", selected: ((_h = this.guestInfo) === null || _h === void 0 ? void 0 : _h.unit) === '' }, locales.entries.Lcz_Assignunits), filteredRoomList === null || filteredRoomList === void 0 ? void 0 :
            filteredRoomList.map(room => {
                var _a;
                return (h("option", { value: room.id, selected: ((_a = this.guestInfo) === null || _a === void 0 ? void 0 : _a.unit) === room.id.toString() }, room.name));
            }))))), this.rateplanSelection.roomtype.is_bed_configuration_enabled && (h("div", { key: '998916a971aa6ff871dd4a46469ac5ba22cb77a5', class: "mr-md-1 flex-fill" }, h("select", { key: '55a7631d88ae49c21633af13d93740325ddf2fe3', class: `form-control input-sm ${this.isButtonPressed && ((_j = this.guestInfo) === null || _j === void 0 ? void 0 : _j.bed_preference) === '' && 'border-danger'}`, id: v4(), onChange: event => this.updateGuest({ bed_preference: event.target.value }) }, h("option", { key: '2bbdb2812d17a6c99a31828af9420e0df03556dd', value: "", selected: ((_k = this.guestInfo) === null || _k === void 0 ? void 0 : _k.bed_preference) === '' }, locales.entries.Lcz_BedConfiguration), this.bedPreferenceType.map(data => {
            var _a;
        ...
        })))), h("p", { key: '98811013dc015f2ad635d246507737652026f5b4', class: "rate_amount" }, formatAmount((_l = this.currency) === null || _l === void 0 ? void 0 : _l.symbol, this.getAmount()), "/", locales.entries.Lcz_Stay)), this.rateplanSelection.selected_variation.child_nbr > 0 && (h("div", { key: '1c53082641cf11e164128906788a177c8ff3ea7e', style: { gap: '0.5rem', marginTop: '0.5rem' }, class: "d-flex  flex-row  p-0 align-items-center aplicationInfoContainer" }, h("p", { key: 'a722b3e7ca1c43d4dffd003b152b54d02a50c3df', class: 'm-0 p-0 text-danger' }, "Any of the children below 3 years?"), h("div", { key: '70112270599cfe56a63e85f72e4699c24e396095', class: "mr-1 flex-fill" }, h("select", { key: '22b12b1ecd00068b6ba24900f4389dfdcdeb4e0e', class: `form-control input-sm ${this.isButtonPressed && ((_m = this.guestInfo) === null || _m === void 0 ? void 0 : _m.bed_preference) === '' && 'border-danger'}`, id: v4(), style: { width: 'max-content' }, onChange: event => this.updateGuest({ infant_nbr: Number(event.target.value) }) }, h("option", { key: '2310d5d36a5d0e8c9a8ae511c6cf474fcb948885', value: "", selected: Number((_o = this.guestInfo) === null || _o === void 0 ? void 0 : _o.infant_nbr) === 0 }, locales.entries['No'] || 'No'), Array.from({ length: this.rateplanSelection.selected_variation.child_nbr }, (_, i) => i + 1).map(item => {
            var _a;
