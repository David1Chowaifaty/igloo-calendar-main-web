...
export class IglRatePlan {
    ...
    render() {
        ...
        //   return null;
        // }
        return (h(Host, { key: '1574d8c2df70985658c73005f84a821c14ade6c5', "data-testid": `rp-${this.ratePlan.id}` }, h("div", { key: '90d268ece26ed9b65796d5224f582ea30f678ba2', class: `rate-plan ${isAvailableToBook ? 'rate-plan--available' : 'rate-plan--unavailable'}` }, h("div", { key: 'c2dec86a072ed145646ea170d5ef68bac850b650', "data-testid": 'rp_name', class: "rateplan-name-container" }, h("div", { key: 'f6da18dd3ec52ddf90c06a238e415a4f39904bb4' }, bookingType === 'BAR_BOOKING' ? (h(Fragment, null, h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))) : (h(Fragment, null, h("span", { class: 'rateplan-name' }, ratePlan.short_name, " "), ratePlan.is_non_refundable && h("span", { class: "non-ref-span" }, "Non Refundable"))), ratePlan.custom_text && h("span", { key: 'eeb43b5aec597a07c7e76c8f411b893d4e040adb', class: "custom-text-span" }, ratePlan.custom_text)), isAvailableToBook && (h(Fragment, { key: '0d9c7d36b59a8a3911599e080eb2ba2bbff6879d' }, h("wa-tooltip", { key: '53d56e9057622806b5a2d70dccef0a898f7166d6', for: `rateplan-${this.ratePlan.id}` }, h("span", { key: '1850ba66a40db7a630e81bc04a32c2ca25129e0d', innerHTML: this.getTooltipMessages() })), h("wa-icon", { key: 'cf4ef55b66b1988d6556578ab4ce004744a97ef5', name: "circle-info", id: `rateplan-${this.ratePlan.id}` }))), this.unavailableRatePlanIds.has(this.ratePlan.id) && (h(Fragment, { key: '3335b9cb264bb31d8556856314a83887fbff8f37' }, h("wa-tooltip", { key: 'bd6ed91ba1c8f18ed3220b3683e646470c74f898', for: `rateplan-warning-${this.ratePlan.id}` }, "You are forcing a stop-sale restriction."), h("wa-icon", { key: '449cce91a5c768f171f3b3cdbefd8693488a5499', name: "triangle-exclamation", style: { color: 'var(--wa-color-warning-fill-loud)' }, id: `rateplan-warning-${this.ratePlan.id}` })))), isAvailableToBook ? (h("div", { class: "rateplan-container" }, h("wa-select", { size: "s", disabled: disableForm, "data-testid": "adult-child-offering", onchange: evt => this.handleDataChange('adult_child_offering', evt), "onwa-hide": e => {
