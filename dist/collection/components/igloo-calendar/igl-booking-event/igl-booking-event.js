...
export class IglBookingEvent {
    ...
    render() {
        ...
        return (h(Host, { key: '8c4ab92dd013c5b75f2bfd8b5aa7f31eece4702c', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, h("div", { key: '8271041cf92d9b8366ae0aaefdfdba3cb235a644', class: `bookingEventBase  ${!this.isNewEvent() && moment(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
