...
export class IglBookingEvent {
    ...
    render() {
        ...
        return (h(Host, { key: 'ea652009076a8192c0d4d046db55103a157f3a69', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, h("div", { key: '8bd168aad500978ceadb58114aa3be35f1492008', class: `bookingEventBase  ${!this.isNewEvent() && moment(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
