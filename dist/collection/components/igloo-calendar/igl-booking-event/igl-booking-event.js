...
export class IglBookingEvent {
    ...
    render() {
        ...
        return (h(Host, { key: '67fff865a63eb8ee6d6ba7349f36212eddb2e616', class: `bookingEvent  ${this.isNewEvent() || this.isHighlightEventType() ? 'newEvent' : ''} ${legend.clsName} `, style: this.getPosition(), id: 'event_' + this.getBookingId() }, h("div", { key: '2aeb5c955ca82cf7be5da031818cf932ec626b1d', class: `bookingEventBase  ${!this.isNewEvent() && moment(new Date(this.bookingEvent.defaultDates.from_date)).isBefore(new Date(this.bookingEvent.FROM_DATE)) ? 'skewedLeft' : ''}
