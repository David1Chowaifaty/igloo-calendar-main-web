...
export class IrPropertySwitcherDialogContent {
    ...
    render() {
        return (h(Host, { key: '3adf5bf0746c1f322bb0bb509aed013e50904457' }, h("ir-input", { key: '348da14ea7786912801864d2ceb82fe15561b2d0', autoFocus: true, ref: el => (this.inputRef = el), placeholder: "Find property", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), h("div", { key: '9e27ee9e2c101fbc712f42c0bdf4cd7e41a16b5c', tabIndex: -1, class: "property-switcher__results" }, this.isLoading && this.renderStatus('Loading properties...'), !this.isLoading && this.error && this.renderStatus(this.error), !this.isLoading && !this.error && this.filteredProperties.length === 0 && this.renderStatus('No properties found'), !this.isLoading &&
            !this.error &&
