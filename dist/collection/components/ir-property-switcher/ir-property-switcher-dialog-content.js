...
export class IrPropertySwitcherDialogContent {
    ...
    render() {
        return (h(Host, { key: '5153c3a169907dbb209165ce71640cb6b9190bd6' }, h("ir-input", { key: '806c951aed51dafbbf7ffe589988a8bf75615c9b', autoFocus: true, ref: el => (this.inputRef = el), placeholder: "Find property", class: "property-switcher__search-input", value: this.searchTerm, "onText-change": this.handleSearchChange, onKeyDown: this.handleKeyDown, withClear: true }), h("div", { key: '544fce9fc194d29cf3723f19c01ee8a0873f5af2', tabIndex: -1, class: "property-switcher__results" }, this.isLoading && this.renderStatus('Loading properties...'), !this.isLoading && this.error && this.renderStatus(this.error), !this.isLoading && !this.error && this.filteredProperties.length === 0 && this.renderStatus('No properties found'), !this.isLoading &&
            !this.error &&
