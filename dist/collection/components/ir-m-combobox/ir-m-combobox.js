...
export class IrMCombobox {
    ...
    render() {
        var _a;
        return (h(Host, { key: '5fe0538b71e2c5b6a6de276be48466fa8af62f56', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, h("div", { key: '4f84b6d7b22d1549deb8a0778e9323bd801de529', class: "input-wrapper" }, h("span", { key: '08881972c581f62a3baec4ca2bd409f5b14c1555', class: "prefix-container", "aria-hidden": !this.hasPrefix }, h("slot", { key: 'd218fe31e7e73bfd5a187e491583956db34bc441', name: "prefix", ref: el => (this.prefixSlotRef = el) })), h("input", { key: 'b4658d6c03ae03fe5f3bd16785158e042546d65a', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: ((_a = this.selectedOption) === null || _a === void 0 ? void 0 : _a.label) || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), h("span", { key: '94d987d45e1e28eb65c402391cc0de0bc9c9a9b6', class: "suffix-container", "aria-hidden": !this.hasSuffix }, h("slot", { key: '9d333ecfea991c3925dcfb20bf4b6588b1433ab2', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), h("div", { key: '0d7caaf6291b11a63f02fafe374d586ba0cf9666', class: `dropdown ${this.isOpen ? 'show' : ''}` }, h("div", { key: '2922e564a3e871ef9878fd301db9b5000e8d502d', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (h("slot", null)) : this.useSlot ? (h("slot", { name: "dropdown-content" })) : ([
