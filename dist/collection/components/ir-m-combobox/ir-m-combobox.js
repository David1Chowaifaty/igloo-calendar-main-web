...
export class IrMCombobox {
    ...
    render() {
        return (h(Host, { key: 'cd8d2168f1ec87240a064f42a27e562e0096fe47', class: { 'has-prefix': this.hasPrefix, 'has-suffix': this.hasSuffix } }, h("div", { key: '8c76ae45f9b3bb51853665780145d4238f2aee8e', class: "input-wrapper" }, h("span", { key: 'af9e43926f68bfbb76016dc895f01b5d1ea56ee5', class: "prefix-container", "aria-hidden": !this.hasPrefix }, h("slot", { key: '8be39be57f8a778698baa37327020bd94c7210fd', name: "prefix", ref: el => (this.prefixSlotRef = el) })), h("input", { key: 'c6e7002890026ba3f55d58286fdd335eae50d8a0', ref: el => (this.inputRef = el), type: "text", class: "form-control", role: "combobox", id: this.id, value: this.selectedOption?.label || '', placeholder: this.placeholder, "aria-expanded": String(this.isOpen), "aria-autocomplete": "list", "aria-controls": this.dropdownId, "data-reference": "parent", "aria-haspopup": "listbox", "aria-activedescendant": this.focusedIndex >= 0 ? `${this.dropdownId}-option-${this.focusedIndex}` : null, "aria-label": "Combobox", "aria-required": true, onKeyDown: this.handleKeyDown, onInput: this.handleInput }), h("span", { key: '565d0c2f735e27e1fe353bd6f9a256be40f3bc57', class: "suffix-container", "aria-hidden": !this.hasSuffix }, h("slot", { key: '13d9bae5df7b301d038c65a6912187718a4f8c04', name: "suffix", ref: el => (this.suffixSlotRef = el) }))), h("div", { key: '5608c4c60a541dd332b421b9fa286bac9194e3df', class: `dropdown ${this.isOpen ? 'show' : ''}` }, h("div", { key: 'b6ed99540c0abaf5e205467fcdb2e2b97b430a30', ref: el => (this.dropdownRef = el), class: `dropdown-menu ${this.isOpen ? 'show' : ''}`, id: this.dropdownId, role: "listbox", "aria-expanded": String(this.isOpen) }, this.isCompositionMode ? (h("slot", null)) : this.useSlot ? (h("slot", { name: "dropdown-content" })) : ([
