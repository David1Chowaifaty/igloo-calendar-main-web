...
export class IrCustomInput {
    ...
    render() {
        return (h(Host, { key: 'bb22a4960686583672f0186c6b6a542c5f07bdbc' }, h("wa-input", { key: 'f9afa291e859e05b2dbd2f3ad12144387c5ece12', type: this.type, value: this.value, ref: el => (this.inputRef = el), defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, "aria-invalid": String(!this.isValid), label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, autocapitalize: this.autocapitalize, autocorrect: this.autocorrect, autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, onchange: this.handleChange, "onwa-clear": this.handleClear, onblur: this.handleBlur, onfocus: this.handleFocus }, h("slot", { key: '203f63dff320c8e32b0aa74234ae1c9288ed717a', name: "label", slot: "label" }), h("slot", { key: '57c51eba4732667a4d7aeac43872241aec7ce1df', name: "start", slot: "start" }), h("slot", { key: '8fac9f7cd4ae37cfea714057c30230a8e0b08c18', name: "end", slot: "end" }), h("slot", { key: '1e2a54c52093a2bfd41f291f5e9a31af4e0ef9dc', name: "clear-icon", slot: "clear-icon" }), h("slot", { key: 'd2c6adb34767dd2e22b14767f68547cf1e7cd583', name: "hide-password-icon", slot: "hide-password-icon" }), h("slot", { key: '23ae3914d7740a5a71b5949a0a18ace18b8107db', name: "show-password-icon", slot: "show-password-icon" }), h("slot", { key: '16fcd99b6d02795e2dfb379191cd230711c0f635', name: "hint", slot: "hint" }))));
    }
    static get is() { return "ir-custom-input"; }
    static get originalStyleUrls() {
        return {
            "$": ["ir-custom-input.css", "../../../global/app.css"]
        };
    }
