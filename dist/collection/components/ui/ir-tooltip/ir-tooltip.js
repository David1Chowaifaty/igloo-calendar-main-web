...
export class IrTooltip {
    ...
    render() {
        return (h(Host, { key: '78db064d18267ab522b79a71a4199880d10e98dd', class: "m-0 p-0" }, h("span", { key: '984caf81ddf6563408941d84515f8e1d5df9441d', style: this.containerStyle, class: 'm-0 p-0 d-flex align-items-center justify-content-center', onMouseEnter: () => this.toggleOpen(true), onMouseLeave: () => this.toggleOpen(false) }, !this.customSlot ? (
        ...
        //   />
        // </svg>
        h("svg", { xmlns: "http://www.w3.org/2000/svg", class: 'm-0 p-0', height: "16", width: "16", viewBox: "0 0 512 512" }, h("path", { fill: "#6b6f82", d: "M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336l24 0 0-64-24 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l48 0c13.3 0 24 10.7 24 24l0 88 8 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z" }))) : (h("slot", { name: "tooltip-trigger" }))), this.open && (h("div", { key: 'a0c118ce27fb2bdd6f000785e849c3a0568ce671', class: "tooltip bottom show position-absolute", role: "tooltip" }, h("div", { key: '5718ac594288b04eb47447823e2472a0951256b7', class: "tooltip-arrow" }), h("div", { key: '0bdba9039f8d3bb8e5995d90489b5985a8963d2a', class: `tooltip-inner fit ${this.customSlot && 'tooltip-inner-custom'}` }, h("span", { key: 'e022801771040d6eacf7e4bbfbfbfef6ccb9485b', innerHTML: this.message }))))));
    }
