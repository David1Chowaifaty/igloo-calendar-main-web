...
export class IrPhoneInput {
    ...
    render() {
        var _a, _b;
        return (h(Host, { key: '845a69245940f5df1acf422cc9a0c55822baefe0' }, h("div", { key: '7d08bf9d34688ffecb6382f42b13b2620eb43226', class: "form-group mr-0" }, h("div", { key: '9b0694b9b48630e86e2c0cfd9096488d16da1727', class: "input-group row m-0 p-0 position-relative" }, this.label && (h("div", { key: 'a66362345b7e6a1a97d748608e191d54fe012591', class: `input-group-prepend col-3 p-0 text-dark border-none` }, h("label", { key: 'cae4028fbf06ac8c1d7d537b60c286b47c4bd942', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), h("div", { key: '6ad60e0d62bd49387dd85b4697718474fcab2f7d', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, h("button", { key: '90a7f8c618185f6cc50569ce500684eb4f586be2', type: "button", onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, this.currentCountry ? h("img", { src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }) : h("p", { class: "p-0 m-0 " }, locales.entries.Lcz_Select), h("svg", { key: '88d0a02eca8a57e948e1d56480e5fb5bcfc13194', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: 'f365025461fe71c0cacf073c5964cbce357f5630', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), h("p", { key: '98e961eed1baff17126b97a9b2b39b51227ba9f3', class: 'phone_prefix_label' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), h("input", { key: '5e6b1ad505a3cc8c68b8784df34a4850a5367524', "data-testid": this.testId, maxLength: 14, type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), this.isDropdownVisible && (h("div", { key: 'bd93b525baf02bfee21bc2492ca313eecaaff159', class: "ir-dropdown-container" }, h("ir-combobox", { key: '826f0c7ca30b48574a0f77959cab61c881658944', onComboboxValueChange: e => {
