...
export class IrCountryPicker {
    ...
    render() {
        ...
        return (h("form", { key: '76288609b9b97a97642dc0664503e9b034aff1d8', class: "dropdown m-0 p-0" }, h("ir-input-text", { key: '8b935dff76787e0a16a20febfccca345b41cfc08', onTextChange: e => {
                if (!this.searching) {
                    this.searching = true;
                }
                this.inputValue = e.detail;
                this.filterCountries();
            }, label: this.label, error: this.error, placeholder: "", class: "m-0 p-0", value: this.inputValue, id: "dropdownMenuCombobox", LabelAvailable: !!this.label, "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false", onInputFocus: () => this.scrollToSelected(), onInputBlur: () => (this.searching = false) }), h("div", { key: 'e94b8080c5913b457f7b6be2b6acc7db5c7ea5ce', class: "dropdown-menu combobox-menu", "aria-labelledby": "dropdownMenuCombobox" }, shouldShowPropertyCountry && (h(Fragment, { key: '5d0337e241529e7afce78c1eecbb735b14c25812' }, h("button", { key: '78f68e3a067b81f46c44978f3de2f47696a49dd3', type: "button", class: `dropdown-item d-flex align-items-center ${((_a = this.selectedCountry) === null || _a === void 0 ? void 0 : _a.id) === this.propertyCountry.id ? 'active' : ''}`, onClick: () => {
                this.selectCountry(this.propertyCountry);
            } }, h("img", { key: 'ec2ec9bd8e44248a1bd9819281e1f9582b198a86', src: this.propertyCountry.flag, alt: this.propertyCountry.name, style: { aspectRatio: '1', height: '15px', borderRadius: '4px' } }), h("p", { key: '79361bac273bda5fc8da0822b62ba53b8d139782', class: "pl-1 m-0" }, this.propertyCountry.name)), h("div", { key: 'ab9b69e9355eb1bacd4fd02a6ac414739cc6c55f', class: "dropdown-divider" }))), (_b = this.filteredCountries) === null || _b === void 0 ? void 0 :
            _b.map(c => {
                var _a;
            ...
            }), ((_c = this.filteredCountries) === null || _c === void 0 ? void 0 : _c.length) === 0 && h("p", { key: 'c283ed9e2b5ddf94581b9bb75d6d09ab022e9f6d', class: "dropdown-item-text" }, "Invalid Country"))));
    }
