...
export class IrModal {
    ...
    render() {
        return [
            h("div", { key: '97a40537454e45a129c768ca2a2d8f00b9c0d497', class: `backdropModal ${this.isOpen ? 'active' : ''}`, onClick: () => {
                    this.cancelModal.emit();
                    if (this.autoClose && !this.isLoading) {
                        this.closeModal();
                    }
                } }),
            h("div", { key: 'd7315c4b0bb1912ba52bd6204924c86bd7270e2e', "data-state": this.isOpen ? 'opened' : 'closed', class: `ir-modal`, tabindex: "-1" }, h("div", { key: 'e9ee7832aa2cdbb70aaacd51db645af3089c7252', class: `ir-alert-content p-2` }, this.showTitle && (h("div", { key: '1aa111ae3510bf486bc9e2ad228bdadf1d5c15e7', class: `ir-alert-header` }, h("p", { key: '7c7d908fdcaa075192e729246c0921a07ec4b2f8' }, this.modalTitle))), h("div", { key: '2b9e310cbb27cb56fafd42c6fd09b3ad290f8fa0', class: "modal-body text-left p-0 mb-2" }, h("div", { key: '2b734556ef527d78e93864ad584990dd5b956f02' }, this.modalBody)), h("div", { key: 'a5b0f7ac58318b74401eb7fc3b8dab25d6f5f5c9', class: `ir-alert-footer border-0  d-flex justify-content-${this.btnPosition === 'center' ? 'center' : this.btnPosition === 'left' ? 'start' : 'end'}` }, this.leftBtnActive && h("ir-button", { key: '45c30ba1b71133f6e523847c4715f68806fab75b', btn_disabled: this.isLoading, btn_color: this.leftBtnColor, btn_block: true, text: this.leftBtnText, name: this.leftBtnText }), this.middleBtnActive && (h("ir-button", { key: 'f427b3144294038b6cc01aad48bbd8fa17a4cb66', btn_disabled: this.isMiddleButtonLoading, btn_color: this.middleBtnColor, btn_block: true, text: this.middleBtnText, isLoading: this.isMiddleButtonLoading, name: this.middleBtnText })), this.rightBtnActive && (h("ir-button", { key: '0486f69c561462bb5e59307dc804a084194dd3c1', btn_color: this.rightBtnColor, btn_disabled: this.isLoading, isLoading: this.isLoading, btn_block: true, text: this.rightBtnText, name: this.rightBtnText }))))),
        ];
    }
