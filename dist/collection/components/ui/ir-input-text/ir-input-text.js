    ...
    static get properties() {
        return {
            ...
            "type": {
                ...
                "complexType": {
                    "original": "| 'text'\n    | 'password'\n    | 'email'\n    | 'number'\n    | 'tel'\n    | 'url'\n    | 'search'\n    | 'date'\n    | 'datetime-local'\n    | 'month'\n    | 'week'\n    | 'time'\n    | 'color'\n    | 'file'\n    | 'hidden'\n    | 'checkbox'\n    | 'radio'\n    | 'range'\n    | 'button'\n    | 'reset'\n    | 'submit'\n    | 'image'",
                    "resolved": "\"number\" | \"search\" | \"file\" | \"email\" | \"date\" | \"password\" | \"text\" | \"month\" | \"week\" | \"button\" | \"time\" | \"reset\" | \"color\" | \"url\" | \"hidden\" | \"image\" | \"submit\" | \"tel\" | \"datetime-local\" | \"checkbox\" | \"range\" | \"radio\"",
                    "references": {}
                },
                "required": false,
                "optional": false,
