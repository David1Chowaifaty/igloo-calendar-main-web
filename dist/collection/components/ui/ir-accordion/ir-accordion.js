...
export class IrAccordion {
    ...
    render() {
        ...
        return (h(Host, { key: 'af72dc9a98af42efb02397dad6bb00da0a3de862' }, h("div", { key: '147df2d0d3f4de6d7f50176c1442c6b856389985', part: "base", class: "ir-accordion", "data-open": isOpen ? 'true' : 'false' }, h("button", { key: '660e74083fdcf4a858d638af7ef0c7acaa68a3db', type: "button", class: "ir-accordion__trigger", "aria-expanded": isOpen ? 'true' : 'false', "aria-controls": this.contentId, "aria-busy": this.isAnimating ? 'true' : 'false', onClick: this.onTriggerClick, onKeyDown: this.onTriggerKeyDown, disabled: this.isAnimating, part: "trigger" }, this.caret && h("ir-icons", { key: '7533268778bd96e601b9308ab7c6f67ab4eb126b', name: 'angle-down', class: `ir-accordion__caret ${isOpen ? 'is-open' : ''}`, "aria-hidden": "true" }), h("div", { key: '1fd5683547fa3f14e45471751d70937d7c6d19e6', class: "ir-accordion__trigger-content" }, h("slot", { key: 'fbb669fccb1128e13df59ae86071a993e2714628', name: "trigger" }))), h("div", { key: '0bb02833155c0247a50a0822a90d8aded2a64f3f', class: "ir-accordion__content", id: this.contentId, ref: el => (this.detailsEl = el), "data-expanded": isOpen ? 'true' : null, role: "region", "aria-hidden": isOpen ? 'false' : 'true' }, h("div", { key: '35fcf82f55fc582d4b134badac18e3a15f7c151b', class: "ir-accordion__content-inner", part: "content", ref: el => (this.contentEl = el) }, h("slot", { key: '80bf5b8b0103f92d847a0b0e65c8f107855832b3' }))))));
    }
