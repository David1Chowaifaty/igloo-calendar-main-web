...
export class IrValidator {
    ...
    render() {
        return (h(Host, { key: '67f072aade4128ba85e6ebac7271ad5c17e37aca' }, h("slot", { key: 'd2030b8cf805530120ce93e243950c1771c6b2a9' }), !this.isValid && this.showErrorMessage && (h("span", { key: '9f152641b8f20c792924f736323c3e312996676b', part: "error-message", class: "error-message" }, this.errorMessage))));
    }
