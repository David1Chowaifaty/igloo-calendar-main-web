...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '094a628b5fb4ce473166ee1bbb4ad0a49276a2f6', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '95e1c6a069697c858443a5b2c07665833c7bf113', class: "input-group row m-0" }, label, h("select", { key: 'fe037bb8e13845c4389a76e1ea035b9b4e84aff7', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '13a92f37821adb35987ffd5f9b6fa24ff4199a98', value: '' }, this.firstOption), this.data.map(item => {
