...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '1ed286b8187b4cfe758812b4f1c8923354ce9a5d', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '3eef1c44db2279c7c1ef6885a6912b9ec0dc8014', class: "input-group row m-0" }, label, h("select", { key: 'a6638ff6b8864f7bf878fa331875806c51ed7e71', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'bf9f12df7753cddb08c777b8047a412e221c53fc', value: '' }, this.firstOption), this.data.map(item => {
