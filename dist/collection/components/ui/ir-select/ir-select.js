...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '32ceee4244a818525ec6765a0e3b1d8e790d0990', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '55defcdf40670ce63b6e654d7cbd25fe0d32c3ef', class: "input-group row m-0" }, label, h("select", { key: 'f5b88cead1cea2862584dcb8d1b141cc831d1f17', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '6957007be13394acb35ee4fecbc851578332a21d', value: '' }, this.firstOption), this.data.map(item => {
