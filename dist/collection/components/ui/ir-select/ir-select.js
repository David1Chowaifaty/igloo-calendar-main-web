...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '8559e78705aabcc60f368f094baecb2ff9ee2d28', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '5da93f720111d8f46d218b85e6c10acf2f8ea97a', class: "input-group row m-0" }, label, h("select", { key: '357bbba670c381e85d50d77cf73b2f05c21caafe', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'de7d093a4006f5af4e2a907900aea0134a64e16a', value: '' }, this.firstOption), this.data.map(item => {
