...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: 'eb9e05941efa7a94faf66857d9d2af52332a3051', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '8175f0a2403b20f7b67dd308ef17456d796c4b9c', class: "input-group row m-0" }, label, h("select", { key: 'b6bf09dfd1e2cc3052bb9d43027cc72774c51f9d', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '031a4906e5daafbe07df7e6a522541cc2ee9719a', value: '' }, this.firstOption), this.data.map(item => {
