...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '9c100e4696adefbf79a735fd4d9c7932f0c37e43', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'dd51aea45cd43144d367fa9317ac84296fe4d141', class: "input-group row m-0" }, label, h("select", { key: 'dc514fc1e5223a904b0dd6d0c6b51e1f07f2585b', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '28d764b0512f02c3622e5de3e132b006b101a977', value: '' }, this.firstOption), this.data.map(item => {
