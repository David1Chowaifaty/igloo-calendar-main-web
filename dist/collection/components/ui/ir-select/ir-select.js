...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '5d365771bb9a91045b41ba65a8d8f6811dfee651', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'b0ce79044ffb162fe49c35e1841cc3273b79f4bc', class: "input-group row m-0" }, label, h("select", { key: 'e1caadd48d55806fc0ef452d73d3d9ce2a388abf', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '594033aa2ebc7abe6b2bed1ac6764a4ba3d05630', value: '' }, this.firstOption), this.data.map(item => {
