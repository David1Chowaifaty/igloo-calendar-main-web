...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: 'b145c0fcc452d6cd4efb11cb47db5ec756110289', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'e8ce100c031110bc9e32e877ad1016fdea0faa9a', class: "input-group row m-0" }, label, h("select", { key: '578837cb3fb01cff3aa7dada34fe4bc689a73287', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '1c9c4033fb6c645c00d1a4df988f05708ee922b7', value: '' }, this.firstOption), this.data.map(item => {
