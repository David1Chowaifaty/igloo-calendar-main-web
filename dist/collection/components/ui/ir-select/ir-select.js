...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '829db9ca4636934c9f63583e23690fe199ed3348', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'f24a872fff556f481793722a123ae278cccb354b', class: "input-group row m-0" }, label, h("select", { key: 'b9d8421c3ce10cbe21fff6f83524a6d921413324', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '439335b4cc2fa8b328a812a8bfdb182330d57824', value: '' }, this.firstOption), this.data.map(item => {
