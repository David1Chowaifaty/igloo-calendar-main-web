...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '1f076cc7bebb7f3164a974cf0df4a257939679ab', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '6d694addc9779ee256061d83ff2bc9bba76ba668', class: "input-group row m-0" }, label, h("select", { key: 'd0fea72119cd77ea1da5a2b40f6f3fb44c110a9a', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '229f4dc7612dfa097d878dc4d813c1bde359de58', value: '' }, this.firstOption), this.data.map(item => {
