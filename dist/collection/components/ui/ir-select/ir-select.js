...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '2cf8010cb85ebc70ccc9efdda7d9cd11d4ea644f', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: 'cd79863b4f1ece2e189b0970370a5f371a976768', class: "input-group row m-0" }, label, h("select", { key: 'c077ce70987eca226c5cdb507dad91e8885db82d', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: '2a63a1ed8a6fdaf8d008df0d9f46e50e8e311200', value: '' }, this.firstOption), this.data.map(item => {
