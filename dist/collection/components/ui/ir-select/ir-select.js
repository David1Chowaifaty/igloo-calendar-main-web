...
export class IrSelect {
    ...
    render() {
        ...
        return (h("div", { key: '0e777c9667dfe35d41d5ed365f4fc024213fb6bc', class: `form-group m-0 ${this.selectContainerStyle}` }, h("div", { key: '8d30149ace0c5cce0b7336f2e9eda69f571bfd6d', class: "input-group row m-0" }, label, h("select", { key: 'd573ea6781d5a723e9afab1c46cd7951ab2b823b', disabled: this.disabled, "aria-invalid": this.error ? 'true' : 'false', "data-testid": this.testId, style: this.selectForcedStyles, ref: el => (this.selectEl = el), id: this.selectId, class: `${this.selectStyles} ${this.error ? 'border-danger' : ''} ${className.join(' ')} form-control-${this.size} text-${this.textSize} `, onInput: this.handleSelectChange.bind(this), required: this.required }, this.showFirstOption && h("option", { key: 'db704f07fb5015fa35b67bad1ea107237304565f', value: '' }, this.firstOption), this.data.map(item => {
