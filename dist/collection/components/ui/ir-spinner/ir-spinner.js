...
export class IrSpinner {
    ...
    render() {
        return (h(Host, { key: 'b2fa3cdf7d1654f1d346574cd398c211a51a74ef' }, h("wa-spinner", { key: '43814f3bd2bc07e8aab1217614a58d62f511313f', style: { 'fontSize': '2rem', '--track-width': '3px' } })));
    }
