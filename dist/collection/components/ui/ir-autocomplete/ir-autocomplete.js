...
export class IrAutocomplete {
    ...
    render() {
        return (h(Host, { key: '1ab25fa09451956f2187744021f8a7c85718c397' }, h("wa-popup", { key: '8a4b195602cfde31943490ecd5614b446310c55e', active: this.open, flip: true, shift: true, sync: "width", "auto-size": "vertical", "auto-size-padding": 10, placement: this.placement, exportparts: "popup, arrow, hover-bridge" }, h("ir-input", { key: 'e522a16eac39219f07353320fc49712f01b160d2', slot: "anchor", ref: el => (this.inputRef = el), onKeyDown: this.handleKeydownChange, "onText-change": this.handleTextChange, onClick: this.handleClick, name: this.name, value: this.value, type: this.type, defaultValue: this.defaultValue, size: this.size, appearance: this.appearance, pill: this.pill, label: this.label, hint: this.hint, withClear: this.withClear, placeholder: this.placeholder, readonly: this.readonly, passwordToggle: this.passwordToggle, passwordVisible: this.passwordVisible, withoutSpinButtons: this.withoutSpinButtons, form: this.form, required: this.required, pattern: this.pattern, minlength: this.minlength, maxlength: this.maxlength, min: this.min, max: this.max, step: this.step, inputClass: this.inputClass, autocapitalize: this.autocapitalize,
            // autocorrect={this.autocorrect}
            autocomplete: this.autocomplete, autofocus: this.autofocus, enterkeyhint: this.enterkeyhint, spellcheck: this.spellcheck, inputmode: this.inputmode, withLabel: this.withLabel, withHint: this.withHint, mask: this.mask, returnMaskedValue: this.returnMaskedValue, disabled: this.disabled, exportparts: "base, hint, label, input, start, end, clear-button, password-toggle-button" }, this.multiple && this.selectedOptions.length > 0 && (h("div", { key: '976689c58d4241b95203499e92b64daaa8bb4b02', slot: "start", class: "selected-tags", part: "tags" }, this.selectedOptions.map(option => (h("wa-tag", { key: this.getOptionValue(option), size: "s", "with-remove": true, "onwa-remove": (e) => {
                e.stopPropagation();
                this.removeOption(option);
            } }, this.getOptionLabel(option)))))), this.withExpandIcon && (h("div", { key: '137bc86f9ee4492b9846c99a9c9d1418d9b10bbe', slot: "end", class: `expand-icon${this.open ? ' expand-icon--open' : ''}`, onClick: this.handleExpandIconClick }, h("wa-icon", { key: '646adb499f45638edf483042fc5c954019bcab86', library: "system", variant: "solid", name: "chevron-down" }))), this.slotManager.hasSlot('label') && h("slot", { key: 'e19b489a7b5a389a832843fcbd7ec2c416cf9a33', name: "label", slot: "label" }), this.slotManager.hasSlot('start') && h("slot", { key: '8cd0f491d57589dc5edf7b1c4e403cd1745791fa', name: "start", slot: "start" }), this.slotManager.hasSlot('end') && h("slot", { key: '2461c9559bf7cee68aa46b5539e255c80fc874a8', name: "end", slot: "end" }), this.slotManager.hasSlot('clear-icon') && h("slot", { key: '012a88c298cf65c62563f476278bbdd4dca8c287', name: "clear-icon", slot: "clear-icon" }), this.slotManager.hasSlot('hint') && h("slot", { key: '77ce026b5ad639ad521608793e1e95d36da54504', name: "hint", slot: "hint" })), h("div", { key: '4728d4928dac58acf20e5921d144c13095d14cd1', id: "listbox", ref: el => (this.listboxRef = el), role: "listbox", "aria-expanded": this.open ? 'true' : 'false', "aria-multiselectable": this.multiple ? 'true' : 'false', "aria-labelledby": "label", part: "listbox", class: "listbox", tabindex: "-1", hidden: !this.open, onKeyDown: this.handleKeydownChange }, h("slot", { key: '3a20bb1602d407e30cdd828065267913414848bf', onSlotchange: this.handleOptionsSlotChange })))));
    }
